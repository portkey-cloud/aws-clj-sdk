...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper1479354 input] (clojure.core/let [rawinput1479353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479355 {"Certificate" (rawinput1479353 "Certificate"), "CertificateChain" (rawinput1479353 "CertificateChain")}] (clojure.core/cond-> {} (letvar1479355 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1479355 ["Certificate"]))) (letvar1479355 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1479355 ["CertificateChain"])))))))

(clojure.core/defn- response-import-certificate-response ([input] (response-import-certificate-response nil input)) ([resultWrapper1479357 input] (clojure.core/let [rawinput1479356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479358 {"CertificateArn" (rawinput1479356 "CertificateArn")}] (clojure.core/cond-> {} (letvar1479358 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar1479358 ["CertificateArn"])))))))

(clojure.core/defn- response-request-certificate-response ([input] (response-request-certificate-response nil input)) ([resultWrapper1479360 input] (clojure.core/let [rawinput1479359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479361 {"CertificateArn" (rawinput1479359 "CertificateArn")}] (clojure.core/cond-> {} (letvar1479361 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar1479361 ["CertificateArn"])))))))

(clojure.core/defn- response-list-certificates-response ([input] (response-list-certificates-response nil input)) ([resultWrapper1479363 input] (clojure.core/let [rawinput1479362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479364 {"NextToken" (rawinput1479362 "NextToken"), "CertificateSummaryList" (rawinput1479362 "CertificateSummaryList")}] (clojure.core/cond-> {} (letvar1479364 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1479364 ["NextToken"]))) (letvar1479364 "CertificateSummaryList") (clojure.core/assoc :certificate-summary-list (deser-certificate-summary-list (clojure.core/get-in letvar1479364 ["CertificateSummaryList"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1479366 input] (clojure.core/let [rawinput1479365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479367 {"message" (rawinput1479365 "message")}] (clojure.core/cond-> {} (letvar1479367 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479367 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1479369 input] (clojure.core/let [rawinput1479368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479370 {"message" (rawinput1479368 "message")}] (clojure.core/cond-> {} (letvar1479370 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479370 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper1479372 input] (clojure.core/let [rawinput1479371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479373 {"message" (rawinput1479371 "message")}] (clojure.core/cond-> {} (letvar1479373 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479373 ["message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1479375 input] (clojure.core/let [rawinput1479374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479376 {"message" (rawinput1479374 "message")}] (clojure.core/cond-> {} (letvar1479376 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479376 ["message"])))))))

(clojure.core/defn- response-invalid-domain-validation-options-exception ([input] (response-invalid-domain-validation-options-exception nil input)) ([resultWrapper1479378 input] (clojure.core/let [rawinput1479377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479379 {"message" (rawinput1479377 "message")}] (clojure.core/cond-> {} (letvar1479379 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479379 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper1479381 input] (clojure.core/let [rawinput1479380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479382 {"message" (rawinput1479380 "message")}] (clojure.core/cond-> {} (letvar1479382 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479382 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1479384 input] (clojure.core/let [rawinput1479383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479385 {"message" (rawinput1479383 "message")}] (clojure.core/cond-> {} (letvar1479385 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479385 ["message"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper1479387 input] (clojure.core/let [rawinput1479386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479388 {"message" (rawinput1479386 "message")}] (clojure.core/cond-> {} (letvar1479388 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479388 ["message"])))))))

(clojure.core/defn- response-describe-certificate-response ([input] (response-describe-certificate-response nil input)) ([resultWrapper1479390 input] (clojure.core/let [rawinput1479389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479391 {"Certificate" (rawinput1479389 "Certificate")}] (clojure.core/cond-> {} (letvar1479391 "Certificate") (clojure.core/assoc :certificate (deser-certificate-detail (clojure.core/get-in letvar1479391 ["Certificate"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper1479393 input] (clojure.core/let [rawinput1479392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479394 {"message" (rawinput1479392 "message")}] (clojure.core/cond-> {} (letvar1479394 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1479394 ["message"])))))))

(clojure.core/defn- response-list-tags-for-certificate-response ([input] (response-list-tags-for-certificate-response nil input)) ([resultWrapper1479396 input] (clojure.core/let [rawinput1479395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479397 {"Tags" (rawinput1479395 "Tags")}] (clojure.core/cond-> {} (letvar1479397 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1479397 ["Tags"])))))))

(clojure.core/defn- response-export-certificate-response ([input] (response-export-certificate-response nil input)) ([resultWrapper1479399 input] (clojure.core/let [rawinput1479398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1479400 {"Certificate" (rawinput1479398 "Certificate"), "CertificateChain" (rawinput1479398 "CertificateChain"), "PrivateKey" (rawinput1479398 "PrivateKey")}] (clojure.core/cond-> {} (letvar1479400 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1479400 ["Certificate"]))) (letvar1479400 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1479400 ["CertificateChain"]))) (letvar1479400 "PrivateKey") (clojure.core/assoc :private-key (deser-private-key (clojure.core/get-in letvar1479400 ["PrivateKey"])))))))
