...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper33929 input] (clojure.core/let [rawinput33928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33930 {"Certificate" (rawinput33928 "Certificate"), "CertificateChain" (rawinput33928 "CertificateChain")}] (clojure.core/cond-> {} (letvar33930 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar33930 ["Certificate"]))) (letvar33930 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar33930 ["CertificateChain"])))))))

(clojure.core/defn- response-import-certificate-response ([input] (response-import-certificate-response nil input)) ([resultWrapper33932 input] (clojure.core/let [rawinput33931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33933 {"CertificateArn" (rawinput33931 "CertificateArn")}] (clojure.core/cond-> {} (letvar33933 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar33933 ["CertificateArn"])))))))

(clojure.core/defn- response-request-certificate-response ([input] (response-request-certificate-response nil input)) ([resultWrapper33935 input] (clojure.core/let [rawinput33934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33936 {"CertificateArn" (rawinput33934 "CertificateArn")}] (clojure.core/cond-> {} (letvar33936 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar33936 ["CertificateArn"])))))))

(clojure.core/defn- response-list-certificates-response ([input] (response-list-certificates-response nil input)) ([resultWrapper33938 input] (clojure.core/let [rawinput33937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33939 {"NextToken" (rawinput33937 "NextToken"), "CertificateSummaryList" (rawinput33937 "CertificateSummaryList")}] (clojure.core/cond-> {} (letvar33939 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar33939 ["NextToken"]))) (letvar33939 "CertificateSummaryList") (clojure.core/assoc :certificate-summary-list (deser-certificate-summary-list (clojure.core/get-in letvar33939 ["CertificateSummaryList"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper33941 input] (clojure.core/let [rawinput33940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33942 {"message" (rawinput33940 "message")}] (clojure.core/cond-> {} (letvar33942 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33942 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper33944 input] (clojure.core/let [rawinput33943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33945 {"message" (rawinput33943 "message")}] (clojure.core/cond-> {} (letvar33945 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33945 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper33947 input] (clojure.core/let [rawinput33946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33948 {"message" (rawinput33946 "message")}] (clojure.core/cond-> {} (letvar33948 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33948 ["message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper33950 input] (clojure.core/let [rawinput33949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33951 {"message" (rawinput33949 "message")}] (clojure.core/cond-> {} (letvar33951 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33951 ["message"])))))))

(clojure.core/defn- response-invalid-domain-validation-options-exception ([input] (response-invalid-domain-validation-options-exception nil input)) ([resultWrapper33953 input] (clojure.core/let [rawinput33952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33954 {"message" (rawinput33952 "message")}] (clojure.core/cond-> {} (letvar33954 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33954 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper33956 input] (clojure.core/let [rawinput33955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33957 {"message" (rawinput33955 "message")}] (clojure.core/cond-> {} (letvar33957 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33957 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper33959 input] (clojure.core/let [rawinput33958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33960 {"message" (rawinput33958 "message")}] (clojure.core/cond-> {} (letvar33960 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33960 ["message"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper33962 input] (clojure.core/let [rawinput33961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33963 {"message" (rawinput33961 "message")}] (clojure.core/cond-> {} (letvar33963 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33963 ["message"])))))))

(clojure.core/defn- response-describe-certificate-response ([input] (response-describe-certificate-response nil input)) ([resultWrapper33965 input] (clojure.core/let [rawinput33964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33966 {"Certificate" (rawinput33964 "Certificate")}] (clojure.core/cond-> {} (letvar33966 "Certificate") (clojure.core/assoc :certificate (deser-certificate-detail (clojure.core/get-in letvar33966 ["Certificate"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper33968 input] (clojure.core/let [rawinput33967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33969 {"message" (rawinput33967 "message")}] (clojure.core/cond-> {} (letvar33969 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar33969 ["message"])))))))

(clojure.core/defn- response-list-tags-for-certificate-response ([input] (response-list-tags-for-certificate-response nil input)) ([resultWrapper33971 input] (clojure.core/let [rawinput33970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33972 {"Tags" (rawinput33970 "Tags")}] (clojure.core/cond-> {} (letvar33972 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar33972 ["Tags"])))))))

(clojure.core/defn- response-export-certificate-response ([input] (response-export-certificate-response nil input)) ([resultWrapper33974 input] (clojure.core/let [rawinput33973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar33975 {"Certificate" (rawinput33973 "Certificate"), "CertificateChain" (rawinput33973 "CertificateChain"), "PrivateKey" (rawinput33973 "PrivateKey")}] (clojure.core/cond-> {} (letvar33975 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar33975 ["Certificate"]))) (letvar33975 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar33975 ["CertificateChain"]))) (letvar33975 "PrivateKey") (clojure.core/assoc :private-key (deser-private-key (clojure.core/get-in letvar33975 ["PrivateKey"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm/private-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 524288)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"-{5}BEGIN PRIVATE KEY-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END PRIVATE KEY-{5}(\u000D?\u000A)?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 320)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.acm/certificate-chain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2097152)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}\u000D?\u000A)*-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/domain-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 253)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(\*\.)?(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/certificate-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32768)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__21078__auto__))))
