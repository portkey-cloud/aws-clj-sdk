...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper1417296 input] (clojure.core/let [rawinput1417295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417297 {"Certificate" (rawinput1417295 "Certificate"), "CertificateChain" (rawinput1417295 "CertificateChain")}] (clojure.core/cond-> {} (letvar1417297 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1417297 ["Certificate"]))) (letvar1417297 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1417297 ["CertificateChain"])))))))

(clojure.core/defn- response-import-certificate-response ([input] (response-import-certificate-response nil input)) ([resultWrapper1417299 input] (clojure.core/let [rawinput1417298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417300 {"CertificateArn" (rawinput1417298 "CertificateArn")}] (clojure.core/cond-> {} (letvar1417300 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar1417300 ["CertificateArn"])))))))

(clojure.core/defn- response-request-certificate-response ([input] (response-request-certificate-response nil input)) ([resultWrapper1417302 input] (clojure.core/let [rawinput1417301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417303 {"CertificateArn" (rawinput1417301 "CertificateArn")}] (clojure.core/cond-> {} (letvar1417303 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar1417303 ["CertificateArn"])))))))

(clojure.core/defn- response-list-certificates-response ([input] (response-list-certificates-response nil input)) ([resultWrapper1417305 input] (clojure.core/let [rawinput1417304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417306 {"NextToken" (rawinput1417304 "NextToken"), "CertificateSummaryList" (rawinput1417304 "CertificateSummaryList")}] (clojure.core/cond-> {} (letvar1417306 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1417306 ["NextToken"]))) (letvar1417306 "CertificateSummaryList") (clojure.core/assoc :certificate-summary-list (deser-certificate-summary-list (clojure.core/get-in letvar1417306 ["CertificateSummaryList"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1417308 input] (clojure.core/let [rawinput1417307 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417309 {"message" (rawinput1417307 "message")}] (clojure.core/cond-> {} (letvar1417309 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417309 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1417311 input] (clojure.core/let [rawinput1417310 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417312 {"message" (rawinput1417310 "message")}] (clojure.core/cond-> {} (letvar1417312 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417312 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper1417314 input] (clojure.core/let [rawinput1417313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417315 {"message" (rawinput1417313 "message")}] (clojure.core/cond-> {} (letvar1417315 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417315 ["message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1417317 input] (clojure.core/let [rawinput1417316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417318 {"message" (rawinput1417316 "message")}] (clojure.core/cond-> {} (letvar1417318 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417318 ["message"])))))))

(clojure.core/defn- response-invalid-domain-validation-options-exception ([input] (response-invalid-domain-validation-options-exception nil input)) ([resultWrapper1417320 input] (clojure.core/let [rawinput1417319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417321 {"message" (rawinput1417319 "message")}] (clojure.core/cond-> {} (letvar1417321 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417321 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper1417323 input] (clojure.core/let [rawinput1417322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417324 {"message" (rawinput1417322 "message")}] (clojure.core/cond-> {} (letvar1417324 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417324 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1417326 input] (clojure.core/let [rawinput1417325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417327 {"message" (rawinput1417325 "message")}] (clojure.core/cond-> {} (letvar1417327 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417327 ["message"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper1417329 input] (clojure.core/let [rawinput1417328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417330 {"message" (rawinput1417328 "message")}] (clojure.core/cond-> {} (letvar1417330 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417330 ["message"])))))))

(clojure.core/defn- response-describe-certificate-response ([input] (response-describe-certificate-response nil input)) ([resultWrapper1417332 input] (clojure.core/let [rawinput1417331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417333 {"Certificate" (rawinput1417331 "Certificate")}] (clojure.core/cond-> {} (letvar1417333 "Certificate") (clojure.core/assoc :certificate (deser-certificate-detail (clojure.core/get-in letvar1417333 ["Certificate"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper1417335 input] (clojure.core/let [rawinput1417334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417336 {"message" (rawinput1417334 "message")}] (clojure.core/cond-> {} (letvar1417336 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1417336 ["message"])))))))

(clojure.core/defn- response-list-tags-for-certificate-response ([input] (response-list-tags-for-certificate-response nil input)) ([resultWrapper1417338 input] (clojure.core/let [rawinput1417337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417339 {"Tags" (rawinput1417337 "Tags")}] (clojure.core/cond-> {} (letvar1417339 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1417339 ["Tags"])))))))

(clojure.core/defn- response-export-certificate-response ([input] (response-export-certificate-response nil input)) ([resultWrapper1417341 input] (clojure.core/let [rawinput1417340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1417342 {"Certificate" (rawinput1417340 "Certificate"), "CertificateChain" (rawinput1417340 "CertificateChain"), "PrivateKey" (rawinput1417340 "PrivateKey")}] (clojure.core/cond-> {} (letvar1417342 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1417342 ["Certificate"]))) (letvar1417342 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1417342 ["CertificateChain"]))) (letvar1417342 "PrivateKey") (clojure.core/assoc :private-key (deser-private-key (clojure.core/get-in letvar1417342 ["PrivateKey"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm/private-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 524288)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"-{5}BEGIN PRIVATE KEY-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END PRIVATE KEY-{5}(\u000D?\u000A)?" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 320)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.acm/certificate-chain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2097152)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}\u000D?\u000A)*-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/domain-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 253)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(\*\.)?(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm/certificate-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32768)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__1410940__auto__))))
...
(clojure.core/defn remove-tags-from-certificate "Remove one or more tags from an ACM certificate. A tag consists of a key-value\npair. If you do not specify the value portion of the tag when calling this\nfunction, the tag will be removed regardless of value. If you specify a value,\nthe tag is removed only if it is associated with the specified value.\n To add tags to a certificate, use the AddTagsToCertificate action. To view all\nof the tags that have been applied to a specific ACM certificate, use the\nListTagsForCertificate action." ([remove-tags-from-certificate-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-remove-tags-from-certificate-request remove-tags-from-certificate-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.acm/endpoints, :http.request.configuration/target-prefix "CertificateManager", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-12-08", :http.request.configuration/service-id "ACM", :http.request.spec/input-spec :portkey.aws.acm/remove-tags-from-certificate-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "RemoveTagsFromCertificate", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.acm/resource-not-found-exception, "InvalidArnException" :portkey.aws.acm/invalid-arn-exception, "InvalidTagException" :portkey.aws.acm/invalid-tag-exception}})))))
...
(clojure.core/defn update-certificate-options "Updates a certificate. Currently, you can use this function to specify whether\nto opt in to or out of recording your certificate in a certificate transparency\nlog. For more information, see Opting Out of Certificate Transparency Logging\n(http://docs.aws.amazon.com/acm/latest/userguide/acm-bestpractices.html#best-practices-transparency)." ([update-certificate-options-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-update-certificate-options-request update-certificate-options-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.acm/endpoints, :http.request.configuration/target-prefix "CertificateManager", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-12-08", :http.request.configuration/service-id "ACM", :http.request.spec/input-spec :portkey.aws.acm/update-certificate-options-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateCertificateOptions", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.acm/resource-not-found-exception, "LimitExceededException" :portkey.aws.acm/limit-exceeded-exception, "InvalidStateException" :portkey.aws.acm/invalid-state-exception, "InvalidArnException" :portkey.aws.acm/invalid-arn-exception}})))))
