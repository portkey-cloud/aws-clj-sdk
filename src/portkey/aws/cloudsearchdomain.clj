...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain/query-parser (clojure.spec.alpha/conformer (clojure.core/let [m__36525__auto__ {"simple" "simple", :simple "simple", "structured" "structured", :structured "structured", "lucene" "lucene", :lucene "lucene", "dismax" "dismax", :dismax "dismax"}] (clojure.core/fn [s__36526__auto__] (m__36525__auto__ s__36526__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.core/defn search ([input__36693__auto__] (search input__36693__auto__ portkey.aws/*http-client*)) ([input37719 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/search?format=sdk&pretty=true", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/SearchRequest input37719)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"partial" "partial", "expr" "expr", "fq" "filterQuery", "q" "query", "return" "return", "sort" "sort", "q.options" "queryOptions", "start" "start", "cursor" "cursor", "q.parser" "queryParser", "facet" "facet", "size" "size", "highlight" "highlight", "stats" "stats"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/search?format=sdk&pretty=true", :body body__36697__auto__} (clojure.core/fn [response37718] (clojure.core/let [errors__36698__auto__ {"SearchException" :portkey.aws.cloudsearchdomain/search-exception}] (if (clojure.core/= nil (:status response37718)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/search-response (:body response37718)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37718 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37718)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37718}))))))))))

(clojure.core/defn suggest ([input__36693__auto__] (suggest input__36693__auto__ portkey.aws/*http-client*)) ([input37721 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/suggest?format=sdk&pretty=true", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/SuggestRequest input37721)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"q" "query", "suggester" "suggester", "size" "size"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/suggest?format=sdk&pretty=true", :body body__36697__auto__} (clojure.core/fn [response37720] (clojure.core/let [errors__36698__auto__ {"SearchException" :portkey.aws.cloudsearchdomain/search-exception}] (if (clojure.core/= nil (:status response37720)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/suggest-response (:body response37720)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37720 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37720)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37720}))))))))))

(clojure.core/defn upload-documents ([input__36693__auto__] (upload-documents input__36693__auto__ portkey.aws/*http-client*)) ([input37723 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "POST", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/documents/batch?format=sdk", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/UploadDocumentsRequest input37723)} (portkey.awsgen/params-to-header {"contentType" ["Content-Type" nil]}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {}) (portkey.awsgen/params-to-payload "documents") (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "POST", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/documents/batch?format=sdk", :body body__36697__auto__} (clojure.core/fn [response37722] (clojure.core/let [errors__36698__auto__ {"DocumentServiceException" :portkey.aws.cloudsearchdomain/document-service-exception}] (if (clojure.core/= nil (:status response37722)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain/upload-documents-response (:body response37722)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37722 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37722)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37722}))))))))))
