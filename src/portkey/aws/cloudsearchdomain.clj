...
(clojure.core/defn suggest ([suggest-request] (portkey.aws/-rest-json-call portkey.aws.cloudsearchdomain/endpoints "GET" "/2013-01-01/suggest?format=sdk&pretty=true" suggest-request :portkey.aws.cloudsearchdomain/suggest-request {:payload nil, :headers {}, :uri {}, :querystring {"q" "query", "suggester" "suggester", "size" "size"}} nil :portkey.aws.cloudsearchdomain/suggest-response {"SearchException" :portkey.aws.cloudsearchdomain/search-exception})))
...
(clojure.core/defn upload-documents ([upload-documents-request] (portkey.aws/-rest-json-call portkey.aws.cloudsearchdomain/endpoints "POST" "/2013-01-01/documents/batch?format=sdk" upload-documents-request :portkey.aws.cloudsearchdomain/upload-documents-request {:payload "documents", :headers {"contentType" ["Content-Type" nil]}, :uri {}, :querystring {}} nil :portkey.aws.cloudsearchdomain/upload-documents-response {"DocumentServiceException" :portkey.aws.cloudsearchdomain/document-service-exception})))
