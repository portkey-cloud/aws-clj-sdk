...
(clojure.core/defn- response-document-service-exception ([input] (response-document-service-exception nil input)) ([resultWrapper370591 input] (clojure.core/let [rawinput370590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar370592 {"status" (rawinput370590 "status"), "message" (rawinput370590 "message")}] (clojure.core/cond-> {} (letvar370592 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar370592 ["status"]))) (letvar370592 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar370592 ["message"])))))))

(clojure.core/defn- response-suggest-response ([input] (response-suggest-response nil input)) ([resultWrapper370594 input] (clojure.core/let [rawinput370593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar370595 {"status" (rawinput370593 "status"), "suggest" (rawinput370593 "suggest")}] (clojure.core/cond-> {} (letvar370595 "status") (clojure.core/assoc :status (deser-suggest-status (clojure.core/get-in letvar370595 ["status"]))) (letvar370595 "suggest") (clojure.core/assoc :suggest (deser-suggest-model (clojure.core/get-in letvar370595 ["suggest"])))))))

(clojure.core/defn- response-search-exception ([input] (response-search-exception nil input)) ([resultWrapper370597 input] (clojure.core/let [rawinput370596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar370598 {"message" (rawinput370596 "message")}] (clojure.core/cond-> {} (letvar370598 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar370598 ["message"])))))))

(clojure.core/defn- response-upload-documents-response ([input] (response-upload-documents-response nil input)) ([resultWrapper370600 input] (clojure.core/let [rawinput370599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar370601 {"status" (rawinput370599 "status"), "adds" (rawinput370599 "adds"), "deletes" (rawinput370599 "deletes"), "warnings" (rawinput370599 "warnings")}] (clojure.core/cond-> {} (letvar370601 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar370601 ["status"]))) (letvar370601 "adds") (clojure.core/assoc :adds (deser-adds (clojure.core/get-in letvar370601 ["adds"]))) (letvar370601 "deletes") (clojure.core/assoc :deletes (deser-deletes (clojure.core/get-in letvar370601 ["deletes"]))) (letvar370601 "warnings") (clojure.core/assoc :warnings (deser-document-service-warnings (clojure.core/get-in letvar370601 ["warnings"])))))))

(clojure.core/defn- response-search-response ([input] (response-search-response nil input)) ([resultWrapper370603 input] (clojure.core/let [rawinput370602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar370604 {"status" (rawinput370602 "status"), "hits" (rawinput370602 "hits"), "facets" (rawinput370602 "facets"), "stats" (rawinput370602 "stats")}] (clojure.core/cond-> {} (letvar370604 "status") (clojure.core/assoc :status (deser-search-status (clojure.core/get-in letvar370604 ["status"]))) (letvar370604 "hits") (clojure.core/assoc :hits (deser-hits (clojure.core/get-in letvar370604 ["hits"]))) (letvar370604 "facets") (clojure.core/assoc :facets (deser-facets (clojure.core/get-in letvar370604 ["facets"]))) (letvar370604 "stats") (clojure.core/assoc :stats (deser-stats (clojure.core/get-in letvar370604 ["stats"])))))))
