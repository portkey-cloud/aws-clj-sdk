...
(clojure.core/defn- response-describe-log-groups-response ([input] (response-describe-log-groups-response nil input)) ([resultWrapper1907560 input] (clojure.core/let [rawinput1907559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907561 {"logGroups" (rawinput1907559 "logGroups"), "nextToken" (rawinput1907559 "nextToken")}] (clojure.core/cond-> {} (letvar1907561 "logGroups") (clojure.core/assoc :log-groups (deser-log-groups (clojure.core/get-in letvar1907561 ["logGroups"]))) (letvar1907561 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907561 ["nextToken"])))))))

(clojure.core/defn- response-get-query-results-response ([input] (response-get-query-results-response nil input)) ([resultWrapper1907563 input] (clojure.core/let [rawinput1907562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907564 {"results" (rawinput1907562 "results"), "statistics" (rawinput1907562 "statistics"), "status" (rawinput1907562 "status")}] (clojure.core/cond-> {} (letvar1907564 "results") (clojure.core/assoc :results (deser-query-results (clojure.core/get-in letvar1907564 ["results"]))) (letvar1907564 "statistics") (clojure.core/assoc :statistics (deser-query-statistics (clojure.core/get-in letvar1907564 ["statistics"]))) (letvar1907564 "status") (clojure.core/assoc :status (deser-query-status (clojure.core/get-in letvar1907564 ["status"])))))))

(clojure.core/defn- response-list-tags-log-group-response ([input] (response-list-tags-log-group-response nil input)) ([resultWrapper1907566 input] (clojure.core/let [rawinput1907565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907567 {"tags" (rawinput1907565 "tags")}] (clojure.core/cond-> {} (letvar1907567 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1907567 ["tags"])))))))

(clojure.core/defn- response-put-destination-response ([input] (response-put-destination-response nil input)) ([resultWrapper1907569 input] (clojure.core/let [rawinput1907568 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907570 {"destination" (rawinput1907568 "destination")}] (clojure.core/cond-> {} (letvar1907570 "destination") (clojure.core/assoc :destination (deser-destination (clojure.core/get-in letvar1907570 ["destination"])))))))

(clojure.core/defn- response-get-log-events-response ([input] (response-get-log-events-response nil input)) ([resultWrapper1907572 input] (clojure.core/let [rawinput1907571 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907573 {"events" (rawinput1907571 "events"), "nextForwardToken" (rawinput1907571 "nextForwardToken"), "nextBackwardToken" (rawinput1907571 "nextBackwardToken")}] (clojure.core/cond-> {} (letvar1907573 "events") (clojure.core/assoc :events (deser-output-log-events (clojure.core/get-in letvar1907573 ["events"]))) (letvar1907573 "nextForwardToken") (clojure.core/assoc :next-forward-token (deser-next-token (clojure.core/get-in letvar1907573 ["nextForwardToken"]))) (letvar1907573 "nextBackwardToken") (clojure.core/assoc :next-backward-token (deser-next-token (clojure.core/get-in letvar1907573 ["nextBackwardToken"])))))))

(clojure.core/defn- response-get-log-record-response ([input] (response-get-log-record-response nil input)) ([resultWrapper1907575 input] (clojure.core/let [rawinput1907574 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907576 {"logRecord" (rawinput1907574 "logRecord")}] (clojure.core/cond-> {} (letvar1907576 "logRecord") (clojure.core/assoc :log-record (deser-log-record (clojure.core/get-in letvar1907576 ["logRecord"])))))))

(clojure.core/defn- response-malformed-query-exception ([input] (response-malformed-query-exception nil input)) ([resultWrapper1907578 input] (clojure.core/let [rawinput1907577 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907579 {"queryCompileError" (rawinput1907577 "queryCompileError")}] (clojure.core/cond-> {} (letvar1907579 "queryCompileError") (clojure.core/assoc :query-compile-error (deser-query-compile-error (clojure.core/get-in letvar1907579 ["queryCompileError"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1907581 input] (clojure.core/let [rawinput1907580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907582 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1907584 input] (clojure.core/let [rawinput1907583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907585 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1907587 input] (clojure.core/let [rawinput1907586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907588 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1907590 input] (clojure.core/let [rawinput1907589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907591 {"exportTasks" (rawinput1907589 "exportTasks"), "nextToken" (rawinput1907589 "nextToken")}] (clojure.core/cond-> {} (letvar1907591 "exportTasks") (clojure.core/assoc :export-tasks (deser-export-tasks (clojure.core/get-in letvar1907591 ["exportTasks"]))) (letvar1907591 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907591 ["nextToken"])))))))

(clojure.core/defn- response-operation-aborted-exception ([input] (response-operation-aborted-exception nil input)) ([resultWrapper1907593 input] (clojure.core/let [rawinput1907592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907594 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-log-events-response ([input] (response-put-log-events-response nil input)) ([resultWrapper1907596 input] (clojure.core/let [rawinput1907595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907597 {"nextSequenceToken" (rawinput1907595 "nextSequenceToken"), "rejectedLogEventsInfo" (rawinput1907595 "rejectedLogEventsInfo")}] (clojure.core/cond-> {} (letvar1907597 "nextSequenceToken") (clojure.core/assoc :next-sequence-token (deser-sequence-token (clojure.core/get-in letvar1907597 ["nextSequenceToken"]))) (letvar1907597 "rejectedLogEventsInfo") (clojure.core/assoc :rejected-log-events-info (deser-rejected-log-events-info (clojure.core/get-in letvar1907597 ["rejectedLogEventsInfo"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1907599 input] (clojure.core/let [rawinput1907598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907600 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unrecognized-client-exception ([input] (response-unrecognized-client-exception nil input)) ([resultWrapper1907602 input] (clojure.core/let [rawinput1907601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907603 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1907605 input] (clojure.core/let [rawinput1907604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907606 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-log-group-fields-response ([input] (response-get-log-group-fields-response nil input)) ([resultWrapper1907608 input] (clojure.core/let [rawinput1907607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907609 {"logGroupFields" (rawinput1907607 "logGroupFields")}] (clojure.core/cond-> {} (letvar1907609 "logGroupFields") (clojure.core/assoc :log-group-fields (deser-log-group-field-list (clojure.core/get-in letvar1907609 ["logGroupFields"])))))))

(clojure.core/defn- response-describe-subscription-filters-response ([input] (response-describe-subscription-filters-response nil input)) ([resultWrapper1907611 input] (clojure.core/let [rawinput1907610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907612 {"subscriptionFilters" (rawinput1907610 "subscriptionFilters"), "nextToken" (rawinput1907610 "nextToken")}] (clojure.core/cond-> {} (letvar1907612 "subscriptionFilters") (clojure.core/assoc :subscription-filters (deser-subscription-filters (clojure.core/get-in letvar1907612 ["subscriptionFilters"]))) (letvar1907612 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907612 ["nextToken"])))))))

(clojure.core/defn- response-describe-destinations-response ([input] (response-describe-destinations-response nil input)) ([resultWrapper1907614 input] (clojure.core/let [rawinput1907613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907615 {"destinations" (rawinput1907613 "destinations"), "nextToken" (rawinput1907613 "nextToken")}] (clojure.core/cond-> {} (letvar1907615 "destinations") (clojure.core/assoc :destinations (deser-destinations (clojure.core/get-in letvar1907615 ["destinations"]))) (letvar1907615 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907615 ["nextToken"])))))))

(clojure.core/defn- response-test-metric-filter-response ([input] (response-test-metric-filter-response nil input)) ([resultWrapper1907617 input] (clojure.core/let [rawinput1907616 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907618 {"matches" (rawinput1907616 "matches")}] (clojure.core/cond-> {} (letvar1907618 "matches") (clojure.core/assoc :matches (deser-metric-filter-matches (clojure.core/get-in letvar1907618 ["matches"])))))))

(clojure.core/defn- response-start-query-response ([input] (response-start-query-response nil input)) ([resultWrapper1907620 input] (clojure.core/let [rawinput1907619 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907621 {"queryId" (rawinput1907619 "queryId")}] (clojure.core/cond-> {} (letvar1907621 "queryId") (clojure.core/assoc :query-id (deser-query-id (clojure.core/get-in letvar1907621 ["queryId"])))))))

(clojure.core/defn- response-put-resource-policy-response ([input] (response-put-resource-policy-response nil input)) ([resultWrapper1907623 input] (clojure.core/let [rawinput1907622 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907624 {"resourcePolicy" (rawinput1907622 "resourcePolicy")}] (clojure.core/cond-> {} (letvar1907624 "resourcePolicy") (clojure.core/assoc :resource-policy (deser-resource-policy (clojure.core/get-in letvar1907624 ["resourcePolicy"])))))))

(clojure.core/defn- response-describe-resource-policies-response ([input] (response-describe-resource-policies-response nil input)) ([resultWrapper1907626 input] (clojure.core/let [rawinput1907625 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907627 {"resourcePolicies" (rawinput1907625 "resourcePolicies"), "nextToken" (rawinput1907625 "nextToken")}] (clojure.core/cond-> {} (letvar1907627 "resourcePolicies") (clojure.core/assoc :resource-policies (deser-resource-policies (clojure.core/get-in letvar1907627 ["resourcePolicies"]))) (letvar1907627 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907627 ["nextToken"])))))))

(clojure.core/defn- response-describe-queries-response ([input] (response-describe-queries-response nil input)) ([resultWrapper1907629 input] (clojure.core/let [rawinput1907628 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907630 {"queries" (rawinput1907628 "queries"), "nextToken" (rawinput1907628 "nextToken")}] (clojure.core/cond-> {} (letvar1907630 "queries") (clojure.core/assoc :queries (deser-query-info-list (clojure.core/get-in letvar1907630 ["queries"]))) (letvar1907630 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907630 ["nextToken"])))))))

(clojure.core/defn- response-describe-log-streams-response ([input] (response-describe-log-streams-response nil input)) ([resultWrapper1907632 input] (clojure.core/let [rawinput1907631 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907633 {"logStreams" (rawinput1907631 "logStreams"), "nextToken" (rawinput1907631 "nextToken")}] (clojure.core/cond-> {} (letvar1907633 "logStreams") (clojure.core/assoc :log-streams (deser-log-streams (clojure.core/get-in letvar1907633 ["logStreams"]))) (letvar1907633 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907633 ["nextToken"])))))))

(clojure.core/defn- response-data-already-accepted-exception ([input] (response-data-already-accepted-exception nil input)) ([resultWrapper1907635 input] (clojure.core/let [rawinput1907634 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907636 {"expectedSequenceToken" (rawinput1907634 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1907636 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1907636 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-filter-log-events-response ([input] (response-filter-log-events-response nil input)) ([resultWrapper1907638 input] (clojure.core/let [rawinput1907637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907639 {"events" (rawinput1907637 "events"), "searchedLogStreams" (rawinput1907637 "searchedLogStreams"), "nextToken" (rawinput1907637 "nextToken")}] (clojure.core/cond-> {} (letvar1907639 "events") (clojure.core/assoc :events (deser-filtered-log-events (clojure.core/get-in letvar1907639 ["events"]))) (letvar1907639 "searchedLogStreams") (clojure.core/assoc :searched-log-streams (deser-searched-log-streams (clojure.core/get-in letvar1907639 ["searchedLogStreams"]))) (letvar1907639 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907639 ["nextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1907641 input] (clojure.core/let [rawinput1907640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907642 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-sequence-token-exception ([input] (response-invalid-sequence-token-exception nil input)) ([resultWrapper1907644 input] (clojure.core/let [rawinput1907643 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907645 {"expectedSequenceToken" (rawinput1907643 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1907645 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1907645 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-stop-query-response ([input] (response-stop-query-response nil input)) ([resultWrapper1907647 input] (clojure.core/let [rawinput1907646 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907648 {"success" (rawinput1907646 "success")}] (clojure.core/cond-> {} (letvar1907648 "success") (clojure.core/assoc :success (deser-success (clojure.core/get-in letvar1907648 ["success"])))))))

(clojure.core/defn- response-describe-metric-filters-response ([input] (response-describe-metric-filters-response nil input)) ([resultWrapper1907650 input] (clojure.core/let [rawinput1907649 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907651 {"metricFilters" (rawinput1907649 "metricFilters"), "nextToken" (rawinput1907649 "nextToken")}] (clojure.core/cond-> {} (letvar1907651 "metricFilters") (clojure.core/assoc :metric-filters (deser-metric-filters (clojure.core/get-in letvar1907651 ["metricFilters"]))) (letvar1907651 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1907651 ["nextToken"])))))))

(clojure.core/defn- response-create-export-task-response ([input] (response-create-export-task-response nil input)) ([resultWrapper1907653 input] (clojure.core/let [rawinput1907652 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1907654 {"taskId" (rawinput1907652 "taskId")}] (clojure.core/cond-> {} (letvar1907654 "taskId") (clojure.core/assoc :task-id (deser-export-task-id (clojure.core/get-in letvar1907654 ["taskId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/event-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/filter-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))

(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/export-task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/query-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/access-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/destination-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/policy-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 5120))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/export-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/metric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/sequence-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:*$]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/metric-namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:*$]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/destination-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:*]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:*]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs.-2014-03-28/export-destination-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
