...
(clojure.core/defn- response-report-limit-reached-exception ([input] (response-report-limit-reached-exception nil input)) ([resultWrapper1644637 input] (clojure.core/let [rawinput1644636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644638 {"Message" (rawinput1644636 "Message")}] (clojure.core/cond-> {} (letvar1644638 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1644638 ["Message"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1644640 input] (clojure.core/let [rawinput1644639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644641 {"Message" (rawinput1644639 "Message")}] (clojure.core/cond-> {} (letvar1644641 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1644641 ["Message"])))))))

(clojure.core/defn- response-put-report-definition-response ([input] (response-put-report-definition-response nil input)) ([resultWrapper1644643 input] (clojure.core/let [rawinput1644642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644644 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-report-definitions-response ([input] (response-describe-report-definitions-response nil input)) ([resultWrapper1644646 input] (clojure.core/let [rawinput1644645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644647 {"ReportDefinitions" (rawinput1644645 "ReportDefinitions"), "NextToken" (rawinput1644645 "NextToken")}] (clojure.core/cond-> {} (letvar1644647 "ReportDefinitions") (clojure.core/assoc :report-definitions (deser-report-definition-list (clojure.core/get-in letvar1644647 ["ReportDefinitions"]))) (letvar1644647 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1644647 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1644649 input] (clojure.core/let [rawinput1644648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644650 {"Message" (rawinput1644648 "Message")}] (clojure.core/cond-> {} (letvar1644650 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1644650 ["Message"])))))))

(clojure.core/defn- response-duplicate-report-name-exception ([input] (response-duplicate-report-name-exception nil input)) ([resultWrapper1644652 input] (clojure.core/let [rawinput1644651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644653 {"Message" (rawinput1644651 "Message")}] (clojure.core/cond-> {} (letvar1644653 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1644653 ["Message"])))))))

(clojure.core/defn- response-delete-report-definition-response ([input] (response-delete-report-definition-response nil input)) ([resultWrapper1644655 input] (clojure.core/let [rawinput1644654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1644656 {"ResponseMessage" (rawinput1644654 "ResponseMessage")}] (clojure.core/cond-> {} (letvar1644656 "ResponseMessage") (clojure.core/assoc :response-message (deser-delete-response-message (clojure.core/get-in letvar1644656 ["ResponseMessage"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cur/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__1467903__auto__))))
