...
(clojure.spec.alpha/def :portkey.aws.cur/compression-format #{"GZIP" "ZIP" :gzip :zip})
...
(clojure.spec.alpha/def :portkey.aws.cur/aws-region #{:apnortheast-1 "ap-northeast-1" "eu-west-1" :useast-1 :apsoutheast-2 "ap-southeast-2" "ap-southeast-1" "eu-central-1" :uswest-1 :eucentral-1 :apsoutheast-1 "us-west-2" "us-east-1" "us-west-1" :euwest-1 :uswest-2})
...
(clojure.spec.alpha/def :portkey.aws.cur/report-format #{:text-o-rcsv "textORcsv"})

(clojure.spec.alpha/def :portkey.aws.cur/generic-string (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cur/additional-artifact #{:quicksight :redshift "QUICKSIGHT" "REDSHIFT"})
...
(clojure.spec.alpha/def :portkey.aws.cur/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 256)) (clojure.core/fn [s__27967__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__27967__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 256)) (clojure.core/fn [s__27967__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__27967__auto__))))
...
(clojure.core/defn delete-report-definition ([] (delete-report-definition {})) ([delete-report-definition-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-report-definition-request delete-report-definition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.cur/endpoints, :http.request.spec/output-spec :portkey.aws.cur/delete-report-definition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-06", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cur/delete-report-definition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteReportDefinition", :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.cur/internal-error-exception, "ValidationException" :portkey.aws.cur/validation-exception}})))))
...
(clojure.core/defn describe-report-definitions ([] (describe-report-definitions {})) ([describe-report-definitions-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-describe-report-definitions-request describe-report-definitions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.cur/endpoints, :http.request.spec/output-spec :portkey.aws.cur/describe-report-definitions-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-06", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cur/describe-report-definitions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeReportDefinitions", :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.cur/internal-error-exception}})))))
