...
(clojure.core/defn- response-report-limit-reached-exception ([input] (response-report-limit-reached-exception nil input)) ([resultWrapper1600859 input] (clojure.core/let [rawinput1600858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600860 {"Message" (rawinput1600858 "Message")}] (clojure.core/cond-> {} (letvar1600860 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1600860 ["Message"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1600862 input] (clojure.core/let [rawinput1600861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600863 {"Message" (rawinput1600861 "Message")}] (clojure.core/cond-> {} (letvar1600863 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1600863 ["Message"])))))))

(clojure.core/defn- response-put-report-definition-response ([input] (response-put-report-definition-response nil input)) ([resultWrapper1600865 input] (clojure.core/let [rawinput1600864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600866 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-report-definitions-response ([input] (response-describe-report-definitions-response nil input)) ([resultWrapper1600868 input] (clojure.core/let [rawinput1600867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600869 {"ReportDefinitions" (rawinput1600867 "ReportDefinitions"), "NextToken" (rawinput1600867 "NextToken")}] (clojure.core/cond-> {} (letvar1600869 "ReportDefinitions") (clojure.core/assoc :report-definitions (deser-report-definition-list (clojure.core/get-in letvar1600869 ["ReportDefinitions"]))) (letvar1600869 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1600869 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1600871 input] (clojure.core/let [rawinput1600870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600872 {"Message" (rawinput1600870 "Message")}] (clojure.core/cond-> {} (letvar1600872 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1600872 ["Message"])))))))

(clojure.core/defn- response-duplicate-report-name-exception ([input] (response-duplicate-report-name-exception nil input)) ([resultWrapper1600874 input] (clojure.core/let [rawinput1600873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600875 {"Message" (rawinput1600873 "Message")}] (clojure.core/cond-> {} (letvar1600875 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1600875 ["Message"])))))))

(clojure.core/defn- response-delete-report-definition-response ([input] (response-delete-report-definition-response nil input)) ([resultWrapper1600877 input] (clojure.core/let [rawinput1600876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1600878 {"ResponseMessage" (rawinput1600876 "ResponseMessage")}] (clojure.core/cond-> {} (letvar1600878 "ResponseMessage") (clojure.core/assoc :response-message (deser-delete-response-message (clojure.core/get-in letvar1600878 ["ResponseMessage"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cur/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__1410940__auto__))))
