...
(clojure.core/defn describe-job-definitions ([] (describe-job-definitions {})) ([describe-job-definitions-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobdefinitions" describe-job-definitions-request :portkey.aws.batch/describe-job-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-definitions-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn register-job-definition ([register-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/registerjobdefinition" register-job-definition-request :portkey.aws.batch/register-job-definition-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/register-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-compute-environments ([] (describe-compute-environments {})) ([describe-compute-environments-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describecomputeenvironments" describe-compute-environments-request :portkey.aws.batch/describe-compute-environments-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-compute-environments-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn delete-job-queue ([delete-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deletejobqueue" delete-job-queue-request :portkey.aws.batch/delete-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/delete-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn update-job-queue ([update-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/updatejobqueue" update-job-queue-request :portkey.aws.batch/update-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/update-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn terminate-job ([terminate-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/terminatejob" terminate-job-request :portkey.aws.batch/terminate-job-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/terminate-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-job-queues ([] (describe-job-queues {})) ([describe-job-queues-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobqueues" describe-job-queues-request :portkey.aws.batch/describe-job-queues-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-queues-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn deregister-job-definition ([deregister-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deregisterjobdefinition" deregister-job-definition-request :portkey.aws.batch/deregister-job-definition-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/deregister-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-jobs ([describe-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobs" describe-jobs-request :portkey.aws.batch/describe-jobs-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn create-job-queue ([create-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/createjobqueue" create-job-queue-request :portkey.aws.batch/create-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/create-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn list-jobs ([list-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/listjobs" list-jobs-request :portkey.aws.batch/list-jobs-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/list-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn cancel-job ([cancel-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/canceljob" cancel-job-request :portkey.aws.batch/cancel-job-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/cancel-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
