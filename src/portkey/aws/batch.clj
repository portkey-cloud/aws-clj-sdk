...
(clojure.core/defn describe-job-definitions "Describes a list of job definitions. You can specify a status (such as ACTIVE) to only return job definitions that match that status.\n" ([] (describe-job-definitions {})) ([describe-job-definitions-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobdefinitions" describe-job-definitions-request :portkey.aws.batch/describe-job-definitions-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-definitions-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn register-job-definition "Registers an AWS Batch job definition. \n" ([register-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/registerjobdefinition" register-job-definition-request :portkey.aws.batch/register-job-definition-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/register-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-compute-environments "Describes one or more of your compute environments.\n If you are using an unmanaged compute environment, you can use the DescribeComputeEnvironment operation to determine the ecsClusterArn that you should launch your Amazon ECS container instances into.\n" ([] (describe-compute-environments {})) ([describe-compute-environments-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describecomputeenvironments" describe-compute-environments-request :portkey.aws.batch/describe-compute-environments-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-compute-environments-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn delete-job-queue "Deletes the specified job queue. You must first disable submissions for a queue with the UpdateJobQueue operation. All jobs in the queue are terminated when you delete a job queue.\n It is not necessary to disassociate compute environments from a queue before submitting a DeleteJobQueue request. \n" ([delete-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deletejobqueue" delete-job-queue-request :portkey.aws.batch/delete-job-queue-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/delete-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn update-job-queue "Updates a job queue.\n" ([update-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/updatejobqueue" update-job-queue-request :portkey.aws.batch/update-job-queue-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/update-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn terminate-job "Terminates a job in a job queue. Jobs that are in the STARTING or RUNNING state are terminated, which causes them to transition to FAILED. Jobs that have not progressed to the STARTING state are cancelled.\n" ([terminate-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/terminatejob" terminate-job-request :portkey.aws.batch/terminate-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/terminate-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn submit-job "Submits an AWS Batch job from a job definition. Parameters specified during SubmitJob override parameters defined in the job definition. \n" ([submit-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/submitjob" submit-job-request :portkey.aws.batch/submit-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/submit-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn deregister-job-definition "Deregisters an AWS Batch job definition.\n" ([deregister-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deregisterjobdefinition" deregister-job-definition-request :portkey.aws.batch/deregister-job-definition-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/deregister-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-jobs "Describes a list of AWS Batch jobs.\n" ([describe-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobs" describe-jobs-request :portkey.aws.batch/describe-jobs-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn list-jobs "Returns a list of task jobs for a specified job queue. You can filter the results by job status with the jobStatus parameter. If you do not specify a status, only RUNNING jobs are returned.\n" ([] (list-jobs {})) ([list-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/listjobs" list-jobs-request :portkey.aws.batch/list-jobs-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/list-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn cancel-job "Cancels a job in an AWS Batch job queue. Jobs that are in the SUBMITTED, PENDING, or RUNNABLE state are cancelled. Jobs that have progressed to STARTING or RUNNING are not cancelled (but the API operation still succeeds, even if no job is cancelled); these jobs must be terminated with the TerminateJob operation.\n" ([cancel-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/canceljob" cancel-job-request :portkey.aws.batch/cancel-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/cancel-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
