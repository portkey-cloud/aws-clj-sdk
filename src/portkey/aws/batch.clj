...
(clojure.spec.alpha/def :portkey.aws.batch/job-definition (portkey.aws/json-keys :req-un [:portkey.aws.batch.job-definition/jobDefinitionName :portkey.aws.batch.job-definition/jobDefinitionArn :portkey.aws.batch.job-definition/revision :portkey.aws.batch.job-definition/type] :opt-un [:portkey.aws.batch.job-definition/status :portkey.aws.batch.job-definition/parameters :portkey.aws.batch.job-definition/retryStrategy :portkey.aws.batch.job-definition/containerProperties] :locations {}))
...
(clojure.core/defn describe-job-definitions "<p>Describes a list of job definitions. You can specify a <code>status</code> (such as <code>ACTIVE</code>) to only return job definitions that match that status.</p>" ([] (describe-job-definitions {})) ([describe-job-definitions-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobdefinitions" describe-job-definitions-request :portkey.aws.batch/describe-job-definitions-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-definitions-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn register-job-definition "<p>Registers an AWS Batch job definition. </p>" ([register-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/registerjobdefinition" register-job-definition-request :portkey.aws.batch/register-job-definition-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/register-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-compute-environments "<p>Describes one or more of your compute environments.</p> <p>If you are using an unmanaged compute environment, you can use the <code>DescribeComputeEnvironment</code> operation to determine the <code>ecsClusterArn</code> that you should launch your Amazon ECS container instances into.</p>" ([] (describe-compute-environments {})) ([describe-compute-environments-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describecomputeenvironments" describe-compute-environments-request :portkey.aws.batch/describe-compute-environments-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-compute-environments-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn delete-job-queue "<p>Deletes the specified job queue. You must first disable submissions for a queue with the <a>UpdateJobQueue</a> operation. All jobs in the queue are terminated when you delete a job queue.</p> <p>It is not necessary to disassociate compute environments from a queue before submitting a <code>DeleteJobQueue</code> request. </p>" ([delete-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deletejobqueue" delete-job-queue-request :portkey.aws.batch/delete-job-queue-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/delete-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn update-job-queue "<p>Updates a job queue.</p>" ([update-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/updatejobqueue" update-job-queue-request :portkey.aws.batch/update-job-queue-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/update-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn terminate-job "<p>Terminates a job in a job queue. Jobs that are in the <code>STARTING</code> or <code>RUNNING</code> state are terminated, which causes them to transition to <code>FAILED</code>. Jobs that have not progressed to the <code>STARTING</code> state are cancelled.</p>" ([terminate-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/terminatejob" terminate-job-request :portkey.aws.batch/terminate-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/terminate-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn submit-job "<p>Submits an AWS Batch job from a job definition. Parameters specified during <a>SubmitJob</a> override parameters defined in the job definition. </p>" ([submit-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/submitjob" submit-job-request :portkey.aws.batch/submit-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/submit-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn deregister-job-definition "<p>Deregisters an AWS Batch job definition.</p>" ([deregister-job-definition-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deregisterjobdefinition" deregister-job-definition-request :portkey.aws.batch/deregister-job-definition-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/deregister-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn describe-jobs "<p>Describes a list of AWS Batch jobs.</p>" ([describe-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobs" describe-jobs-request :portkey.aws.batch/describe-jobs-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn create-job-queue "<p>Creates an AWS Batch job queue. When you create a job queue, you associate one or more compute environments to the queue and assign an order of preference for the compute environments.</p> <p>You also set a priority to the job queue that determines the order in which the AWS Batch scheduler places jobs onto its associated compute environments. For example, if a compute environment is associated with more than one job queue, the job queue with a higher priority is given preference for scheduling jobs to that compute environment.</p>" ([create-job-queue-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/createjobqueue" create-job-queue-request :portkey.aws.batch/create-job-queue-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/create-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn list-jobs "<p>Returns a list of task jobs for a specified job queue. You can filter the results by job status with the <code>jobStatus</code> parameter. If you do not specify a status, only <code>RUNNING</code> jobs are returned.</p>" ([] (list-jobs {})) ([list-jobs-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/listjobs" list-jobs-request :portkey.aws.batch/list-jobs-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/list-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
...
(clojure.core/defn cancel-job "<p>Cancels a job in an AWS Batch job queue. Jobs that are in the <code>SUBMITTED</code>, <code>PENDING</code>, or <code>RUNNABLE</code> state are cancelled. Jobs that have progressed to <code>STARTING</code> or <code>RUNNING</code> are not cancelled (but the API operation still succeeds, even if no job is cancelled); these jobs must be terminated with the <a>TerminateJob</a> operation.</p>" ([cancel-job-request] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/canceljob" cancel-job-request :portkey.aws.batch/cancel-job-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/cancel-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception})))
