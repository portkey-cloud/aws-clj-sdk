...
(clojure.spec.alpha/def :portkey.aws.batch/delete-compute-environment-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-compute-environments-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-compute-environments-request/computeEnvironments :portkey.aws.batch.describe-compute-environments-request/maxResults :portkey.aws.batch.describe-compute-environments-request/nextToken]))

(clojure.spec.alpha/def :portkey.aws.batch/string-list (clojure.spec.alpha/coll-of :portkey.aws.batch/string :max-count nil))

(clojure.spec.alpha/def :portkey.aws.batch/job-definition-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"container" "container", :container "container"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/create-job-queue-response (portkey.aws/json-keys :req-un [:portkey.aws.batch.create-job-queue-response/jobQueueName :portkey.aws.batch.create-job-queue-response/jobQueueArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/compute-environment-order (portkey.aws/json-keys :req-un [:portkey.aws.batch.compute-environment-order/order :portkey.aws.batch.compute-environment-order/computeEnvironment] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/jqstate (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"ENABLED" "ENABLED", :enabled "ENABLED", "DISABLED" "DISABLED", :disabled "DISABLED"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/mount-point (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.mount-point/containerPath :portkey.aws.batch.mount-point/readOnly :portkey.aws.batch.mount-point/sourceVolume]))

(clojure.spec.alpha/def :portkey.aws.batch/cancel-job-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.batch.client-exception/message (clojure.spec.alpha/and :portkey.aws.batch/string))
(clojure.spec.alpha/def :portkey.aws.batch/client-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.client-exception/message]))

(clojure.spec.alpha/def :portkey.aws.batch/job-status (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"RUNNABLE" "RUNNABLE", :starting "STARTING", :pending "PENDING", "PENDING" "PENDING", :submitted "SUBMITTED", "SUBMITTED" "SUBMITTED", :running "RUNNING", "SUCCEEDED" "SUCCEEDED", "STARTING" "STARTING", :runnable "RUNNABLE", "FAILED" "FAILED", :failed "FAILED", "RUNNING" "RUNNING", :succeeded "SUCCEEDED"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-compute-environments-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-compute-environments-response/computeEnvironments :portkey.aws.batch.describe-compute-environments-response/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/volume (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.volume/host :portkey.aws.batch.volume/name]))

(clojure.spec.alpha/def :portkey.aws.batch/delete-job-queue-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.batch/deregister-job-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/create-compute-environment-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.create-compute-environment-response/computeEnvironmentName :portkey.aws.batch.create-compute-environment-response/computeEnvironmentArn]))
...
(clojure.spec.alpha/def :portkey.aws.batch/list-jobs-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.list-jobs-request/jobQueue] :opt-un [:portkey.aws.batch.list-jobs-request/jobStatus :portkey.aws.batch.list-jobs-request/maxResults :portkey.aws.batch.list-jobs-request/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/compute-resource-update (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.compute-resource-update/minvCpus :portkey.aws.batch.compute-resource-update/maxvCpus :portkey.aws.batch.compute-resource-update/desiredvCpus]))
...
(clojure.spec.alpha/def :portkey.aws.batch/deregister-job-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.deregister-job-definition-request/jobDefinition] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.batch/jqstatus (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:valid "VALID", :deleted "DELETED", :creating "CREATING", "UPDATING" "UPDATING", :invalid "INVALID", :deleting "DELETING", "INVALID" "INVALID", "DELETING" "DELETING", "CREATING" "CREATING", :updating "UPDATING", "DELETED" "DELETED", "VALID" "VALID"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-job-queues-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-job-queues-request/jobQueues :portkey.aws.batch.describe-job-queues-request/maxResults :portkey.aws.batch.describe-job-queues-request/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/terminate-job-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/cancel-job-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.cancel-job-request/jobId :portkey.aws.batch.cancel-job-request/reason] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-job-queues-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-job-queues-response/jobQueues :portkey.aws.batch.describe-job-queues-response/nextToken]))

(clojure.spec.alpha/def :portkey.aws.batch.job-dependency/job-id (clojure.spec.alpha/and :portkey.aws.batch/string))
(clojure.spec.alpha/def :portkey.aws.batch/job-dependency (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.job-dependency/jobId]))
...
(clojure.spec.alpha/def :portkey.aws.batch/compute-resource (portkey.aws/json-keys :req-un [:portkey.aws.batch.compute-resource/type :portkey.aws.batch.compute-resource/minvCpus :portkey.aws.batch.compute-resource/maxvCpus :portkey.aws.batch.compute-resource/instanceTypes :portkey.aws.batch.compute-resource/subnets :portkey.aws.batch.compute-resource/securityGroupIds :portkey.aws.batch.compute-resource/instanceRole] :opt-un [:portkey.aws.batch.compute-resource/ec2KeyPair :portkey.aws.batch.compute-resource/spotIamFleetRole :portkey.aws.batch.compute-resource/bidPercentage :portkey.aws.batch.compute-resource/tags :portkey.aws.batch.compute-resource/imageId :portkey.aws.batch.compute-resource/desiredvCpus]))
...
(clojure.spec.alpha/def :portkey.aws.batch/terminate-job-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.terminate-job-request/jobId :portkey.aws.batch.terminate-job-request/reason] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/crtype (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"EC2" "EC2", :ec2 "EC2", "SPOT" "SPOT", :spot "SPOT"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/delete-job-queue-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.delete-job-queue-request/jobQueue] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/update-compute-environment-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.update-compute-environment-response/computeEnvironmentName :portkey.aws.batch.update-compute-environment-response/computeEnvironmentArn]))
...
(clojure.spec.alpha/def :portkey.aws.batch/attempt-detail (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.attempt-detail/container :portkey.aws.batch.attempt-detail/startedAt :portkey.aws.batch.attempt-detail/stoppedAt :portkey.aws.batch.attempt-detail/statusReason]))
...
(clojure.spec.alpha/def :portkey.aws.batch/submit-job-response (portkey.aws/json-keys :req-un [:portkey.aws.batch.submit-job-response/jobName :portkey.aws.batch.submit-job-response/jobId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-jobs-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-jobs-response/jobs]))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-job-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-job-definitions-response/jobDefinitions :portkey.aws.batch.describe-job-definitions-response/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/cestatus (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:valid "VALID", :deleted "DELETED", :creating "CREATING", "UPDATING" "UPDATING", :invalid "INVALID", :deleting "DELETING", "INVALID" "INVALID", "DELETING" "DELETING", "CREATING" "CREATING", :updating "UPDATING", "DELETED" "DELETED", "VALID" "VALID"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/server-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.server-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.batch/container-overrides (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.container-overrides/vcpus :portkey.aws.batch.container-overrides/memory :portkey.aws.batch.container-overrides/command :portkey.aws.batch.container-overrides/environment]))

(clojure.spec.alpha/def :portkey.aws.batch.describe-jobs-request/jobs (clojure.spec.alpha/and :portkey.aws.batch/string-list))
(clojure.spec.alpha/def :portkey.aws.batch/describe-jobs-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.describe-jobs-request/jobs] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/ulimit (portkey.aws/json-keys :req-un [:portkey.aws.batch.ulimit/hardLimit :portkey.aws.batch.ulimit/name :portkey.aws.batch.ulimit/softLimit] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/cestate (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"ENABLED" "ENABLED", :enabled "ENABLED", "DISABLED" "DISABLED", :disabled "DISABLED"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.batch/attempt-container-detail (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.attempt-container-detail/containerInstanceArn :portkey.aws.batch.attempt-container-detail/taskArn :portkey.aws.batch.attempt-container-detail/exitCode :portkey.aws.batch.attempt-container-detail/reason :portkey.aws.batch.attempt-container-detail/logStreamName]))
...
(clojure.spec.alpha/def :portkey.aws.batch/describe-job-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.describe-job-definitions-request/jobDefinitions :portkey.aws.batch.describe-job-definitions-request/maxResults :portkey.aws.batch.describe-job-definitions-request/jobDefinitionName :portkey.aws.batch.describe-job-definitions-request/status :portkey.aws.batch.describe-job-definitions-request/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/list-jobs-response (portkey.aws/json-keys :req-un [:portkey.aws.batch.list-jobs-response/jobSummaryList] :opt-un [:portkey.aws.batch.list-jobs-response/nextToken]))
...
(clojure.spec.alpha/def :portkey.aws.batch/job-summary (portkey.aws/json-keys :req-un [:portkey.aws.batch.job-summary/jobId :portkey.aws.batch.job-summary/jobName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/update-job-queue-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.update-job-queue-response/jobQueueName :portkey.aws.batch.update-job-queue-response/jobQueueArn]))

(clojure.spec.alpha/def :portkey.aws.batch.host/source-path (clojure.spec.alpha/and :portkey.aws.batch/string))
(clojure.spec.alpha/def :portkey.aws.batch/host (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.host/sourcePath]))
...
(clojure.spec.alpha/def :portkey.aws.batch/delete-compute-environment-request (portkey.aws/json-keys :req-un [:portkey.aws.batch.delete-compute-environment-request/computeEnvironment] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.batch/retry-strategy (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.retry-strategy/attempts]))
...
(clojure.spec.alpha/def :portkey.aws.batch/key-value-pair (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.batch.key-value-pair/name :portkey.aws.batch.key-value-pair/value]))

(clojure.core/defn describe-job-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobdefinitions" input__8278__auto__ :portkey.aws.batch/describe-job-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-definitions-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
(clojure.spec.alpha/fdef describe-job-definitions :args (clojure.spec.alpha/tuple :portkey.aws.batch/describe-job-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.batch/describe-job-definitions-response))

(clojure.core/defn register-job-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/registerjobdefinition" input__8278__auto__ :portkey.aws.batch/register-job-definition-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/register-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn describe-compute-environments [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describecomputeenvironments" input__8278__auto__ :portkey.aws.batch/describe-compute-environments-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-compute-environments-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
(clojure.spec.alpha/fdef describe-compute-environments :args (clojure.spec.alpha/tuple :portkey.aws.batch/describe-compute-environments-request) :ret (clojure.spec.alpha/and :portkey.aws.batch/describe-compute-environments-response))

(clojure.core/defn update-compute-environment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/updatecomputeenvironment" input__8278__auto__ :portkey.aws.batch/update-compute-environment-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/update-compute-environment-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn delete-job-queue [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deletejobqueue" input__8278__auto__ :portkey.aws.batch/delete-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/delete-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn create-compute-environment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/createcomputeenvironment" input__8278__auto__ :portkey.aws.batch/create-compute-environment-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/create-compute-environment-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn update-job-queue [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/updatejobqueue" input__8278__auto__ :portkey.aws.batch/update-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/update-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn terminate-job [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/terminatejob" input__8278__auto__ :portkey.aws.batch/terminate-job-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/terminate-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn describe-job-queues [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobqueues" input__8278__auto__ :portkey.aws.batch/describe-job-queues-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-job-queues-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
(clojure.spec.alpha/fdef describe-job-queues :args (clojure.spec.alpha/tuple :portkey.aws.batch/describe-job-queues-request) :ret (clojure.spec.alpha/and :portkey.aws.batch/describe-job-queues-response))

(clojure.core/defn submit-job [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/submitjob" input__8278__auto__ :portkey.aws.batch/submit-job-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/submit-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn delete-compute-environment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deletecomputeenvironment" input__8278__auto__ :portkey.aws.batch/delete-compute-environment-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/delete-compute-environment-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn deregister-job-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/deregisterjobdefinition" input__8278__auto__ :portkey.aws.batch/deregister-job-definition-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/deregister-job-definition-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn describe-jobs [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/describejobs" input__8278__auto__ :portkey.aws.batch/describe-jobs-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/describe-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn create-job-queue [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/createjobqueue" input__8278__auto__ :portkey.aws.batch/create-job-queue-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/create-job-queue-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn list-jobs [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/listjobs" input__8278__auto__ :portkey.aws.batch/list-jobs-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/list-jobs-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
...
(clojure.core/defn cancel-job [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.batch/endpoints "POST" "/v1/canceljob" input__8278__auto__ :portkey.aws.batch/cancel-job-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.batch/cancel-job-response {"ClientException" :portkey.aws.batch/client-exception, "ServerException" :portkey.aws.batch/server-exception}))
