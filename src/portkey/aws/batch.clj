...
(clojure.core/defn- response-delete-compute-environment-response ([input] (response-delete-compute-environment-response nil input)) ([resultWrapper73821 input] (clojure.core/let [rawinput73820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73822 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-job-queue-response ([input] (response-create-job-queue-response nil input)) ([resultWrapper73824 input] (clojure.core/let [rawinput73823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73825 {"jobQueueName" (rawinput73823 "jobQueueName"), "jobQueueArn" (rawinput73823 "jobQueueArn")}] (clojure.core/cond-> {:job-queue-name (deser-string (clojure.core/get-in letvar73825 ["jobQueueName"])), :job-queue-arn (deser-string (clojure.core/get-in letvar73825 ["jobQueueArn"]))}))))

(clojure.core/defn- response-cancel-job-response ([input] (response-cancel-job-response nil input)) ([resultWrapper73827 input] (clojure.core/let [rawinput73826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73828 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper73830 input] (clojure.core/let [rawinput73829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73831 {"message" (rawinput73829 "message")}] (clojure.core/cond-> {} (letvar73831 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar73831 ["message"])))))))

(clojure.core/defn- response-describe-compute-environments-response ([input] (response-describe-compute-environments-response nil input)) ([resultWrapper73833 input] (clojure.core/let [rawinput73832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73834 {"computeEnvironments" (rawinput73832 "computeEnvironments"), "nextToken" (rawinput73832 "nextToken")}] (clojure.core/cond-> {} (letvar73834 "computeEnvironments") (clojure.core/assoc :compute-environments (deser-compute-environment-detail-list (clojure.core/get-in letvar73834 ["computeEnvironments"]))) (letvar73834 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar73834 ["nextToken"])))))))

(clojure.core/defn- response-delete-job-queue-response ([input] (response-delete-job-queue-response nil input)) ([resultWrapper73836 input] (clojure.core/let [rawinput73835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73837 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deregister-job-definition-response ([input] (response-deregister-job-definition-response nil input)) ([resultWrapper73839 input] (clojure.core/let [rawinput73838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73840 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compute-environment-response ([input] (response-create-compute-environment-response nil input)) ([resultWrapper73842 input] (clojure.core/let [rawinput73841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73843 {"computeEnvironmentName" (rawinput73841 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput73841 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar73843 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar73843 ["computeEnvironmentName"]))) (letvar73843 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar73843 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-terminate-job-response ([input] (response-terminate-job-response nil input)) ([resultWrapper73845 input] (clojure.core/let [rawinput73844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73846 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-queues-response ([input] (response-describe-job-queues-response nil input)) ([resultWrapper73848 input] (clojure.core/let [rawinput73847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73849 {"jobQueues" (rawinput73847 "jobQueues"), "nextToken" (rawinput73847 "nextToken")}] (clojure.core/cond-> {} (letvar73849 "jobQueues") (clojure.core/assoc :job-queues (deser-job-queue-detail-list (clojure.core/get-in letvar73849 ["jobQueues"]))) (letvar73849 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar73849 ["nextToken"])))))))

(clojure.core/defn- response-update-compute-environment-response ([input] (response-update-compute-environment-response nil input)) ([resultWrapper73851 input] (clojure.core/let [rawinput73850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73852 {"computeEnvironmentName" (rawinput73850 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput73850 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar73852 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar73852 ["computeEnvironmentName"]))) (letvar73852 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar73852 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-submit-job-response ([input] (response-submit-job-response nil input)) ([resultWrapper73854 input] (clojure.core/let [rawinput73853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73855 {"jobName" (rawinput73853 "jobName"), "jobId" (rawinput73853 "jobId")}] (clojure.core/cond-> {:job-name (deser-string (clojure.core/get-in letvar73855 ["jobName"])), :job-id (deser-string (clojure.core/get-in letvar73855 ["jobId"]))}))))

(clojure.core/defn- response-describe-jobs-response ([input] (response-describe-jobs-response nil input)) ([resultWrapper73857 input] (clojure.core/let [rawinput73856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73858 {"jobs" (rawinput73856 "jobs")}] (clojure.core/cond-> {} (letvar73858 "jobs") (clojure.core/assoc :jobs (deser-job-detail-list (clojure.core/get-in letvar73858 ["jobs"])))))))

(clojure.core/defn- response-register-job-definition-response ([input] (response-register-job-definition-response nil input)) ([resultWrapper73860 input] (clojure.core/let [rawinput73859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73861 {"jobDefinitionName" (rawinput73859 "jobDefinitionName"), "jobDefinitionArn" (rawinput73859 "jobDefinitionArn"), "revision" (rawinput73859 "revision")}] (clojure.core/cond-> {:job-definition-name (deser-string (clojure.core/get-in letvar73861 ["jobDefinitionName"])), :job-definition-arn (deser-string (clojure.core/get-in letvar73861 ["jobDefinitionArn"])), :revision (deser-integer (clojure.core/get-in letvar73861 ["revision"]))}))))

(clojure.core/defn- response-describe-job-definitions-response ([input] (response-describe-job-definitions-response nil input)) ([resultWrapper73863 input] (clojure.core/let [rawinput73862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73864 {"jobDefinitions" (rawinput73862 "jobDefinitions"), "nextToken" (rawinput73862 "nextToken")}] (clojure.core/cond-> {} (letvar73864 "jobDefinitions") (clojure.core/assoc :job-definitions (deser-job-definition-list (clojure.core/get-in letvar73864 ["jobDefinitions"]))) (letvar73864 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar73864 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper73866 input] (clojure.core/let [rawinput73865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73867 {"message" (rawinput73865 "message")}] (clojure.core/cond-> {} (letvar73867 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar73867 ["message"])))))))

(clojure.core/defn- response-list-jobs-response ([input] (response-list-jobs-response nil input)) ([resultWrapper73869 input] (clojure.core/let [rawinput73868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73870 {"jobSummaryList" (rawinput73868 "jobSummaryList"), "nextToken" (rawinput73868 "nextToken")}] (clojure.core/cond-> {:job-summary-list (deser-job-summary-list (clojure.core/get-in letvar73870 ["jobSummaryList"]))} (letvar73870 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar73870 ["nextToken"])))))))

(clojure.core/defn- response-update-job-queue-response ([input] (response-update-job-queue-response nil input)) ([resultWrapper73872 input] (clojure.core/let [rawinput73871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar73873 {"jobQueueName" (rawinput73871 "jobQueueName"), "jobQueueArn" (rawinput73871 "jobQueueArn")}] (clojure.core/cond-> {} (letvar73873 "jobQueueName") (clojure.core/assoc :job-queue-name (deser-string (clojure.core/get-in letvar73873 ["jobQueueName"]))) (letvar73873 "jobQueueArn") (clojure.core/assoc :job-queue-arn (deser-string (clojure.core/get-in letvar73873 ["jobQueueArn"])))))))
