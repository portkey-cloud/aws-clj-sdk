...
(clojure.core/defn- response-delete-compute-environment-response ([input] (response-delete-compute-environment-response nil input)) ([resultWrapper1066818 input] (clojure.core/let [rawinput1066817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066819 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-job-queue-response ([input] (response-create-job-queue-response nil input)) ([resultWrapper1066821 input] (clojure.core/let [rawinput1066820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066822 {"jobQueueName" (rawinput1066820 "jobQueueName"), "jobQueueArn" (rawinput1066820 "jobQueueArn")}] (clojure.core/cond-> {:job-queue-name (deser-string (clojure.core/get-in letvar1066822 ["jobQueueName"])), :job-queue-arn (deser-string (clojure.core/get-in letvar1066822 ["jobQueueArn"]))}))))

(clojure.core/defn- response-cancel-job-response ([input] (response-cancel-job-response nil input)) ([resultWrapper1066824 input] (clojure.core/let [rawinput1066823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066825 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper1066827 input] (clojure.core/let [rawinput1066826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066828 {"message" (rawinput1066826 "message")}] (clojure.core/cond-> {} (letvar1066828 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1066828 ["message"])))))))

(clojure.core/defn- response-describe-compute-environments-response ([input] (response-describe-compute-environments-response nil input)) ([resultWrapper1066830 input] (clojure.core/let [rawinput1066829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066831 {"computeEnvironments" (rawinput1066829 "computeEnvironments"), "nextToken" (rawinput1066829 "nextToken")}] (clojure.core/cond-> {} (letvar1066831 "computeEnvironments") (clojure.core/assoc :compute-environments (deser-compute-environment-detail-list (clojure.core/get-in letvar1066831 ["computeEnvironments"]))) (letvar1066831 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1066831 ["nextToken"])))))))

(clojure.core/defn- response-delete-job-queue-response ([input] (response-delete-job-queue-response nil input)) ([resultWrapper1066833 input] (clojure.core/let [rawinput1066832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066834 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deregister-job-definition-response ([input] (response-deregister-job-definition-response nil input)) ([resultWrapper1066836 input] (clojure.core/let [rawinput1066835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066837 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compute-environment-response ([input] (response-create-compute-environment-response nil input)) ([resultWrapper1066839 input] (clojure.core/let [rawinput1066838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066840 {"computeEnvironmentName" (rawinput1066838 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput1066838 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar1066840 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar1066840 ["computeEnvironmentName"]))) (letvar1066840 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar1066840 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-terminate-job-response ([input] (response-terminate-job-response nil input)) ([resultWrapper1066842 input] (clojure.core/let [rawinput1066841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066843 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-queues-response ([input] (response-describe-job-queues-response nil input)) ([resultWrapper1066845 input] (clojure.core/let [rawinput1066844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066846 {"jobQueues" (rawinput1066844 "jobQueues"), "nextToken" (rawinput1066844 "nextToken")}] (clojure.core/cond-> {} (letvar1066846 "jobQueues") (clojure.core/assoc :job-queues (deser-job-queue-detail-list (clojure.core/get-in letvar1066846 ["jobQueues"]))) (letvar1066846 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1066846 ["nextToken"])))))))

(clojure.core/defn- response-update-compute-environment-response ([input] (response-update-compute-environment-response nil input)) ([resultWrapper1066848 input] (clojure.core/let [rawinput1066847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066849 {"computeEnvironmentName" (rawinput1066847 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput1066847 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar1066849 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar1066849 ["computeEnvironmentName"]))) (letvar1066849 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar1066849 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-submit-job-response ([input] (response-submit-job-response nil input)) ([resultWrapper1066851 input] (clojure.core/let [rawinput1066850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066852 {"jobName" (rawinput1066850 "jobName"), "jobId" (rawinput1066850 "jobId")}] (clojure.core/cond-> {:job-name (deser-string (clojure.core/get-in letvar1066852 ["jobName"])), :job-id (deser-string (clojure.core/get-in letvar1066852 ["jobId"]))}))))

(clojure.core/defn- response-describe-jobs-response ([input] (response-describe-jobs-response nil input)) ([resultWrapper1066854 input] (clojure.core/let [rawinput1066853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066855 {"jobs" (rawinput1066853 "jobs")}] (clojure.core/cond-> {} (letvar1066855 "jobs") (clojure.core/assoc :jobs (deser-job-detail-list (clojure.core/get-in letvar1066855 ["jobs"])))))))

(clojure.core/defn- response-register-job-definition-response ([input] (response-register-job-definition-response nil input)) ([resultWrapper1066857 input] (clojure.core/let [rawinput1066856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066858 {"jobDefinitionName" (rawinput1066856 "jobDefinitionName"), "jobDefinitionArn" (rawinput1066856 "jobDefinitionArn"), "revision" (rawinput1066856 "revision")}] (clojure.core/cond-> {:job-definition-name (deser-string (clojure.core/get-in letvar1066858 ["jobDefinitionName"])), :job-definition-arn (deser-string (clojure.core/get-in letvar1066858 ["jobDefinitionArn"])), :revision (deser-integer (clojure.core/get-in letvar1066858 ["revision"]))}))))

(clojure.core/defn- response-describe-job-definitions-response ([input] (response-describe-job-definitions-response nil input)) ([resultWrapper1066860 input] (clojure.core/let [rawinput1066859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066861 {"jobDefinitions" (rawinput1066859 "jobDefinitions"), "nextToken" (rawinput1066859 "nextToken")}] (clojure.core/cond-> {} (letvar1066861 "jobDefinitions") (clojure.core/assoc :job-definitions (deser-job-definition-list (clojure.core/get-in letvar1066861 ["jobDefinitions"]))) (letvar1066861 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1066861 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper1066863 input] (clojure.core/let [rawinput1066862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066864 {"message" (rawinput1066862 "message")}] (clojure.core/cond-> {} (letvar1066864 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1066864 ["message"])))))))

(clojure.core/defn- response-list-jobs-response ([input] (response-list-jobs-response nil input)) ([resultWrapper1066866 input] (clojure.core/let [rawinput1066865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066867 {"jobSummaryList" (rawinput1066865 "jobSummaryList"), "nextToken" (rawinput1066865 "nextToken")}] (clojure.core/cond-> {:job-summary-list (deser-job-summary-list (clojure.core/get-in letvar1066867 ["jobSummaryList"]))} (letvar1066867 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1066867 ["nextToken"])))))))

(clojure.core/defn- response-update-job-queue-response ([input] (response-update-job-queue-response nil input)) ([resultWrapper1066869 input] (clojure.core/let [rawinput1066868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1066870 {"jobQueueName" (rawinput1066868 "jobQueueName"), "jobQueueArn" (rawinput1066868 "jobQueueArn")}] (clojure.core/cond-> {} (letvar1066870 "jobQueueName") (clojure.core/assoc :job-queue-name (deser-string (clojure.core/get-in letvar1066870 ["jobQueueName"]))) (letvar1066870 "jobQueueArn") (clojure.core/assoc :job-queue-arn (deser-string (clojure.core/get-in letvar1066870 ["jobQueueArn"])))))))
