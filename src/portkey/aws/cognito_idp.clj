...
(clojure.core/defn- response-user-pool-add-on-not-enabled-exception ([input] (response-user-pool-add-on-not-enabled-exception nil input)) ([resultWrapper1606618 input] (clojure.core/let [rawinput1606617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606619 {"message" (rawinput1606617 "message")}] (clojure.core/cond-> {} (letvar1606619 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606619 ["message"])))))))

(clojure.core/defn- response-list-identity-providers-response ([input] (response-list-identity-providers-response nil input)) ([resultWrapper1606621 input] (clojure.core/let [rawinput1606620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606622 {"Providers" (rawinput1606620 "Providers"), "NextToken" (rawinput1606620 "NextToken")}] (clojure.core/cond-> {:providers (deser-providers-list-type (clojure.core/get-in letvar1606622 ["Providers"]))} (letvar1606622 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1606622 ["NextToken"])))))))

(clojure.core/defn- response-admin-update-user-attributes-response ([input] (response-admin-update-user-attributes-response nil input)) ([resultWrapper1606624 input] (clojure.core/let [rawinput1606623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606625 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-group-exists-exception ([input] (response-group-exists-exception nil input)) ([resultWrapper1606627 input] (clojure.core/let [rawinput1606626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606628 {"message" (rawinput1606626 "message")}] (clojure.core/cond-> {} (letvar1606628 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606628 ["message"])))))))

(clojure.core/defn- response-duplicate-provider-exception ([input] (response-duplicate-provider-exception nil input)) ([resultWrapper1606630 input] (clojure.core/let [rawinput1606629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606631 {"message" (rawinput1606629 "message")}] (clojure.core/cond-> {} (letvar1606631 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606631 ["message"])))))))

(clojure.core/defn- response-create-identity-provider-response ([input] (response-create-identity-provider-response nil input)) ([resultWrapper1606633 input] (clojure.core/let [rawinput1606632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606634 {"IdentityProvider" (rawinput1606632 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1606634 ["IdentityProvider"]))}))))

(clojure.core/defn- response-change-password-response ([input] (response-change-password-response nil input)) ([resultWrapper1606636 input] (clojure.core/let [rawinput1606635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606637 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-user-import-job-response ([input] (response-start-user-import-job-response nil input)) ([resultWrapper1606639 input] (clojure.core/let [rawinput1606638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606640 {"UserImportJob" (rawinput1606638 "UserImportJob")}] (clojure.core/cond-> {} (letvar1606640 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1606640 ["UserImportJob"])))))))

(clojure.core/defn- response-set-ui-customization-response ([input] (response-set-ui-customization-response nil input)) ([resultWrapper1606642 input] (clojure.core/let [rawinput1606641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606643 {"UICustomization" (rawinput1606641 "UICustomization")}] (clojure.core/cond-> {:ui-customization (deser-ui-customization-type (clojure.core/get-in letvar1606643 ["UICustomization"]))}))))

(clojure.core/defn- response-sign-up-response ([input] (response-sign-up-response nil input)) ([resultWrapper1606645 input] (clojure.core/let [rawinput1606644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606646 {"UserConfirmed" (rawinput1606644 "UserConfirmed"), "CodeDeliveryDetails" (rawinput1606644 "CodeDeliveryDetails"), "UserSub" (rawinput1606644 "UserSub")}] (clojure.core/cond-> {:user-confirmed (deser-boolean-type (clojure.core/get-in letvar1606646 ["UserConfirmed"])), :user-sub (deser-string-type (clojure.core/get-in letvar1606646 ["UserSub"]))} (letvar1606646 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1606646 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-set-user-settings-response ([input] (response-set-user-settings-response nil input)) ([resultWrapper1606648 input] (clojure.core/let [rawinput1606647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606649 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-initiate-auth-response ([input] (response-admin-initiate-auth-response nil input)) ([resultWrapper1606651 input] (clojure.core/let [rawinput1606650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606652 {"ChallengeName" (rawinput1606650 "ChallengeName"), "Session" (rawinput1606650 "Session"), "ChallengeParameters" (rawinput1606650 "ChallengeParameters"), "AuthenticationResult" (rawinput1606650 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1606652 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1606652 ["ChallengeName"]))) (letvar1606652 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606652 ["Session"]))) (letvar1606652 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1606652 ["ChallengeParameters"]))) (letvar1606652 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1606652 ["AuthenticationResult"])))))))

(clojure.core/defn- response-update-auth-event-feedback-response ([input] (response-update-auth-event-feedback-response nil input)) ([resultWrapper1606654 input] (clojure.core/let [rawinput1606653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606655 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-import-jobs-response ([input] (response-list-user-import-jobs-response nil input)) ([resultWrapper1606657 input] (clojure.core/let [rawinput1606656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606658 {"UserImportJobs" (rawinput1606656 "UserImportJobs"), "PaginationToken" (rawinput1606656 "PaginationToken")}] (clojure.core/cond-> {} (letvar1606658 "UserImportJobs") (clojure.core/assoc :user-import-jobs (deser-user-import-jobs-list-type (clojure.core/get-in letvar1606658 ["UserImportJobs"]))) (letvar1606658 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-key-type (clojure.core/get-in letvar1606658 ["PaginationToken"])))))))

(clojure.core/defn- response-create-user-pool-domain-response ([input] (response-create-user-pool-domain-response nil input)) ([resultWrapper1606660 input] (clojure.core/let [rawinput1606659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606661 {"CloudFrontDomain" (rawinput1606659 "CloudFrontDomain")}] (clojure.core/cond-> {} (letvar1606661 "CloudFrontDomain") (clojure.core/assoc :cloud-front-domain (deser-domain-type (clojure.core/get-in letvar1606661 ["CloudFrontDomain"])))))))

(clojure.core/defn- response-admin-confirm-sign-up-response ([input] (response-admin-confirm-sign-up-response nil input)) ([resultWrapper1606663 input] (clojure.core/let [rawinput1606662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606664 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resend-confirmation-code-response ([input] (response-resend-confirmation-code-response nil input)) ([resultWrapper1606666 input] (clojure.core/let [rawinput1606665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606667 {"CodeDeliveryDetails" (rawinput1606665 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1606667 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1606667 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-admin-list-user-auth-events-response ([input] (response-admin-list-user-auth-events-response nil input)) ([resultWrapper1606669 input] (clojure.core/let [rawinput1606668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606670 {"AuthEvents" (rawinput1606668 "AuthEvents"), "NextToken" (rawinput1606668 "NextToken")}] (clojure.core/cond-> {} (letvar1606670 "AuthEvents") (clojure.core/assoc :auth-events (deser-auth-events-type (clojure.core/get-in letvar1606670 ["AuthEvents"]))) (letvar1606670 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1606670 ["NextToken"])))))))

(clojure.core/defn- response-expired-code-exception ([input] (response-expired-code-exception nil input)) ([resultWrapper1606672 input] (clojure.core/let [rawinput1606671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606673 {"message" (rawinput1606671 "message")}] (clojure.core/cond-> {} (letvar1606673 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606673 ["message"])))))))

(clojure.core/defn- response-delete-user-pool-domain-response ([input] (response-delete-user-pool-domain-response nil input)) ([resultWrapper1606675 input] (clojure.core/let [rawinput1606674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606676 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-device-response ([input] (response-get-device-response nil input)) ([resultWrapper1606678 input] (clojure.core/let [rawinput1606677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606679 {"Device" (rawinput1606677 "Device")}] (clojure.core/cond-> {:device (deser-device-type (clojure.core/get-in letvar1606679 ["Device"]))}))))

(clojure.core/defn- response-set-user-pool-mfa-config-response ([input] (response-set-user-pool-mfa-config-response nil input)) ([resultWrapper1606681 input] (clojure.core/let [rawinput1606680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606682 {"SmsMfaConfiguration" (rawinput1606680 "SmsMfaConfiguration"), "SoftwareTokenMfaConfiguration" (rawinput1606680 "SoftwareTokenMfaConfiguration"), "MfaConfiguration" (rawinput1606680 "MfaConfiguration")}] (clojure.core/cond-> {} (letvar1606682 "SmsMfaConfiguration") (clojure.core/assoc :sms-mfa-configuration (deser-sms-mfa-config-type (clojure.core/get-in letvar1606682 ["SmsMfaConfiguration"]))) (letvar1606682 "SoftwareTokenMfaConfiguration") (clojure.core/assoc :software-token-mfa-configuration (deser-software-token-mfa-config-type (clojure.core/get-in letvar1606682 ["SoftwareTokenMfaConfiguration"]))) (letvar1606682 "MfaConfiguration") (clojure.core/assoc :mfa-configuration (deser-user-pool-mfa-type (clojure.core/get-in letvar1606682 ["MfaConfiguration"])))))))

(clojure.core/defn- response-invalid-sms-role-access-policy-exception ([input] (response-invalid-sms-role-access-policy-exception nil input)) ([resultWrapper1606684 input] (clojure.core/let [rawinput1606683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606685 {"message" (rawinput1606683 "message")}] (clojure.core/cond-> {} (letvar1606685 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606685 ["message"])))))))

(clojure.core/defn- response-enable-software-token-mfa-exception ([input] (response-enable-software-token-mfa-exception nil input)) ([resultWrapper1606687 input] (clojure.core/let [rawinput1606686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606688 {"message" (rawinput1606686 "message")}] (clojure.core/cond-> {} (letvar1606688 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606688 ["message"])))))))

(clojure.core/defn- response-update-user-pool-domain-response ([input] (response-update-user-pool-domain-response nil input)) ([resultWrapper1606690 input] (clojure.core/let [rawinput1606689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606691 {"CloudFrontDomain" (rawinput1606689 "CloudFrontDomain")}] (clojure.core/cond-> {} (letvar1606691 "CloudFrontDomain") (clojure.core/assoc :cloud-front-domain (deser-domain-type (clojure.core/get-in letvar1606691 ["CloudFrontDomain"])))))))

(clojure.core/defn- response-get-user-attribute-verification-code-response ([input] (response-get-user-attribute-verification-code-response nil input)) ([resultWrapper1606693 input] (clojure.core/let [rawinput1606692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606694 {"CodeDeliveryDetails" (rawinput1606692 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1606694 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1606694 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-get-user-pool-mfa-config-response ([input] (response-get-user-pool-mfa-config-response nil input)) ([resultWrapper1606696 input] (clojure.core/let [rawinput1606695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606697 {"SmsMfaConfiguration" (rawinput1606695 "SmsMfaConfiguration"), "SoftwareTokenMfaConfiguration" (rawinput1606695 "SoftwareTokenMfaConfiguration"), "MfaConfiguration" (rawinput1606695 "MfaConfiguration")}] (clojure.core/cond-> {} (letvar1606697 "SmsMfaConfiguration") (clojure.core/assoc :sms-mfa-configuration (deser-sms-mfa-config-type (clojure.core/get-in letvar1606697 ["SmsMfaConfiguration"]))) (letvar1606697 "SoftwareTokenMfaConfiguration") (clojure.core/assoc :software-token-mfa-configuration (deser-software-token-mfa-config-type (clojure.core/get-in letvar1606697 ["SoftwareTokenMfaConfiguration"]))) (letvar1606697 "MfaConfiguration") (clojure.core/assoc :mfa-configuration (deser-user-pool-mfa-type (clojure.core/get-in letvar1606697 ["MfaConfiguration"])))))))

(clojure.core/defn- response-list-user-pools-response ([input] (response-list-user-pools-response nil input)) ([resultWrapper1606699 input] (clojure.core/let [rawinput1606698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606700 {"UserPools" (rawinput1606698 "UserPools"), "NextToken" (rawinput1606698 "NextToken")}] (clojure.core/cond-> {} (letvar1606700 "UserPools") (clojure.core/assoc :user-pools (deser-user-pool-list-type (clojure.core/get-in letvar1606700 ["UserPools"]))) (letvar1606700 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1606700 ["NextToken"])))))))

(clojure.core/defn- response-update-user-pool-response ([input] (response-update-user-pool-response nil input)) ([resultWrapper1606702 input] (clojure.core/let [rawinput1606701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606703 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-identity-provider-response ([input] (response-describe-identity-provider-response nil input)) ([resultWrapper1606705 input] (clojure.core/let [rawinput1606704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606706 {"IdentityProvider" (rawinput1606704 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1606706 ["IdentityProvider"]))}))))

(clojure.core/defn- response-get-group-response ([input] (response-get-group-response nil input)) ([resultWrapper1606708 input] (clojure.core/let [rawinput1606707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606709 {"Group" (rawinput1606707 "Group")}] (clojure.core/cond-> {} (letvar1606709 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1606709 ["Group"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1606711 input] (clojure.core/let [rawinput1606710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606712 {"message" (rawinput1606710 "message")}] (clojure.core/cond-> {} (letvar1606712 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606712 ["message"])))))))

(clojure.core/defn- response-invalid-lambda-response-exception ([input] (response-invalid-lambda-response-exception nil input)) ([resultWrapper1606714 input] (clojure.core/let [rawinput1606713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606715 {"message" (rawinput1606713 "message")}] (clojure.core/cond-> {} (letvar1606715 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606715 ["message"])))))))

(clojure.core/defn- response-update-group-response ([input] (response-update-group-response nil input)) ([resultWrapper1606717 input] (clojure.core/let [rawinput1606716 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606718 {"Group" (rawinput1606716 "Group")}] (clojure.core/cond-> {} (letvar1606718 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1606718 ["Group"])))))))

(clojure.core/defn- response-list-groups-response ([input] (response-list-groups-response nil input)) ([resultWrapper1606720 input] (clojure.core/let [rawinput1606719 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606721 {"Groups" (rawinput1606719 "Groups"), "NextToken" (rawinput1606719 "NextToken")}] (clojure.core/cond-> {} (letvar1606721 "Groups") (clojure.core/assoc :groups (deser-group-list-type (clojure.core/get-in letvar1606721 ["Groups"]))) (letvar1606721 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1606721 ["NextToken"])))))))

(clojure.core/defn- response-invalid-user-pool-configuration-exception ([input] (response-invalid-user-pool-configuration-exception nil input)) ([resultWrapper1606723 input] (clojure.core/let [rawinput1606722 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606724 {"message" (rawinput1606722 "message")}] (clojure.core/cond-> {} (letvar1606724 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606724 ["message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1606726 input] (clojure.core/let [rawinput1606725 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606727 {"message" (rawinput1606725 "message")}] (clojure.core/cond-> {} (letvar1606727 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606727 ["message"])))))))

(clojure.core/defn- response-admin-set-user-mfa-preference-response ([input] (response-admin-set-user-mfa-preference-response nil input)) ([resultWrapper1606729 input] (clojure.core/let [rawinput1606728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606730 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-initiate-auth-response ([input] (response-initiate-auth-response nil input)) ([resultWrapper1606732 input] (clojure.core/let [rawinput1606731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606733 {"ChallengeName" (rawinput1606731 "ChallengeName"), "Session" (rawinput1606731 "Session"), "ChallengeParameters" (rawinput1606731 "ChallengeParameters"), "AuthenticationResult" (rawinput1606731 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1606733 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1606733 ["ChallengeName"]))) (letvar1606733 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606733 ["Session"]))) (letvar1606733 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1606733 ["ChallengeParameters"]))) (letvar1606733 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1606733 ["AuthenticationResult"])))))))

(clojure.core/defn- response-admin-respond-to-auth-challenge-response ([input] (response-admin-respond-to-auth-challenge-response nil input)) ([resultWrapper1606735 input] (clojure.core/let [rawinput1606734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606736 {"ChallengeName" (rawinput1606734 "ChallengeName"), "Session" (rawinput1606734 "Session"), "ChallengeParameters" (rawinput1606734 "ChallengeParameters"), "AuthenticationResult" (rawinput1606734 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1606736 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1606736 ["ChallengeName"]))) (letvar1606736 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606736 ["Session"]))) (letvar1606736 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1606736 ["ChallengeParameters"]))) (letvar1606736 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1606736 ["AuthenticationResult"])))))))

(clojure.core/defn- response-password-reset-required-exception ([input] (response-password-reset-required-exception nil input)) ([resultWrapper1606738 input] (clojure.core/let [rawinput1606737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606739 {"message" (rawinput1606737 "message")}] (clojure.core/cond-> {} (letvar1606739 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606739 ["message"])))))))

(clojure.core/defn- response-list-users-in-group-response ([input] (response-list-users-in-group-response nil input)) ([resultWrapper1606741 input] (clojure.core/let [rawinput1606740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606742 {"Users" (rawinput1606740 "Users"), "NextToken" (rawinput1606740 "NextToken")}] (clojure.core/cond-> {} (letvar1606742 "Users") (clojure.core/assoc :users (deser-users-list-type (clojure.core/get-in letvar1606742 ["Users"]))) (letvar1606742 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1606742 ["NextToken"])))))))

(clojure.core/defn- response-invalid-password-exception ([input] (response-invalid-password-exception nil input)) ([resultWrapper1606744 input] (clojure.core/let [rawinput1606743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606745 {"message" (rawinput1606743 "message")}] (clojure.core/cond-> {} (letvar1606745 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606745 ["message"])))))))

(clojure.core/defn- response-user-pool-tagging-exception ([input] (response-user-pool-tagging-exception nil input)) ([resultWrapper1606747 input] (clojure.core/let [rawinput1606746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606748 {"message" (rawinput1606746 "message")}] (clojure.core/cond-> {} (letvar1606748 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606748 ["message"])))))))

(clojure.core/defn- response-respond-to-auth-challenge-response ([input] (response-respond-to-auth-challenge-response nil input)) ([resultWrapper1606750 input] (clojure.core/let [rawinput1606749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606751 {"ChallengeName" (rawinput1606749 "ChallengeName"), "Session" (rawinput1606749 "Session"), "ChallengeParameters" (rawinput1606749 "ChallengeParameters"), "AuthenticationResult" (rawinput1606749 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1606751 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1606751 ["ChallengeName"]))) (letvar1606751 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606751 ["Session"]))) (letvar1606751 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1606751 ["ChallengeParameters"]))) (letvar1606751 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1606751 ["AuthenticationResult"])))))))

(clojure.core/defn- response-admin-link-provider-for-user-response ([input] (response-admin-link-provider-for-user-response nil input)) ([resultWrapper1606753 input] (clojure.core/let [rawinput1606752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606754 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-email-role-access-policy-exception ([input] (response-invalid-email-role-access-policy-exception nil input)) ([resultWrapper1606756 input] (clojure.core/let [rawinput1606755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606757 {"message" (rawinput1606755 "message")}] (clojure.core/cond-> {} (letvar1606757 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606757 ["message"])))))))

(clojure.core/defn- response-admin-create-user-response ([input] (response-admin-create-user-response nil input)) ([resultWrapper1606759 input] (clojure.core/let [rawinput1606758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606760 {"User" (rawinput1606758 "User")}] (clojure.core/cond-> {} (letvar1606760 "User") (clojure.core/assoc :user (deser-user-type (clojure.core/get-in letvar1606760 ["User"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1606762 input] (clojure.core/let [rawinput1606761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606763 {"message" (rawinput1606761 "message")}] (clojure.core/cond-> {} (letvar1606763 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606763 ["message"])))))))

(clojure.core/defn- response-username-exists-exception ([input] (response-username-exists-exception nil input)) ([resultWrapper1606765 input] (clojure.core/let [rawinput1606764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606766 {"message" (rawinput1606764 "message")}] (clojure.core/cond-> {} (letvar1606766 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606766 ["message"])))))))

(clojure.core/defn- response-verify-software-token-response ([input] (response-verify-software-token-response nil input)) ([resultWrapper1606768 input] (clojure.core/let [rawinput1606767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606769 {"Status" (rawinput1606767 "Status"), "Session" (rawinput1606767 "Session")}] (clojure.core/cond-> {} (letvar1606769 "Status") (clojure.core/assoc :status (deser-verify-software-token-response-type (clojure.core/get-in letvar1606769 ["Status"]))) (letvar1606769 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606769 ["Session"])))))))

(clojure.core/defn- response-global-sign-out-response ([input] (response-global-sign-out-response nil input)) ([resultWrapper1606771 input] (clojure.core/let [rawinput1606770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606772 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1606774 input] (clojure.core/let [rawinput1606773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606775 {"message" (rawinput1606773 "message")}] (clojure.core/cond-> {} (letvar1606775 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606775 ["message"])))))))

(clojure.core/defn- response-update-identity-provider-response ([input] (response-update-identity-provider-response nil input)) ([resultWrapper1606777 input] (clojure.core/let [rawinput1606776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606778 {"IdentityProvider" (rawinput1606776 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1606778 ["IdentityProvider"]))}))))

(clojure.core/defn- response-code-delivery-failure-exception ([input] (response-code-delivery-failure-exception nil input)) ([resultWrapper1606780 input] (clojure.core/let [rawinput1606779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606781 {"message" (rawinput1606779 "message")}] (clojure.core/cond-> {} (letvar1606781 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606781 ["message"])))))))

(clojure.core/defn- response-code-mismatch-exception ([input] (response-code-mismatch-exception nil input)) ([resultWrapper1606783 input] (clojure.core/let [rawinput1606782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606784 {"message" (rawinput1606782 "message")}] (clojure.core/cond-> {} (letvar1606784 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606784 ["message"])))))))

(clojure.core/defn- response-admin-enable-user-response ([input] (response-admin-enable-user-response nil input)) ([resultWrapper1606786 input] (clojure.core/let [rawinput1606785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606787 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-scope-does-not-exist-exception ([input] (response-scope-does-not-exist-exception nil input)) ([resultWrapper1606789 input] (clojure.core/let [rawinput1606788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606790 {"message" (rawinput1606788 "message")}] (clojure.core/cond-> {} (letvar1606790 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606790 ["message"])))))))

(clojure.core/defn- response-admin-get-device-response ([input] (response-admin-get-device-response nil input)) ([resultWrapper1606792 input] (clojure.core/let [rawinput1606791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606793 {"Device" (rawinput1606791 "Device")}] (clojure.core/cond-> {:device (deser-device-type (clojure.core/get-in letvar1606793 ["Device"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1606795 input] (clojure.core/let [rawinput1606794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606796 {"message" (rawinput1606794 "message")}] (clojure.core/cond-> {} (letvar1606796 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606796 ["message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper1606798 input] (clojure.core/let [rawinput1606797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606799 {"message" (rawinput1606797 "message")}] (clojure.core/cond-> {} (letvar1606799 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606799 ["message"])))))))

(clojure.core/defn- response-verify-user-attribute-response ([input] (response-verify-user-attribute-response nil input)) ([resultWrapper1606801 input] (clojure.core/let [rawinput1606800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606802 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-device-status-response ([input] (response-update-device-status-response nil input)) ([resultWrapper1606804 input] (clojure.core/let [rawinput1606803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606805 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-attributes-response ([input] (response-delete-user-attributes-response nil input)) ([resultWrapper1606807 input] (clojure.core/let [rawinput1606806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606808 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-user-state-exception ([input] (response-unsupported-user-state-exception nil input)) ([resultWrapper1606810 input] (clojure.core/let [rawinput1606809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606811 {"message" (rawinput1606809 "message")}] (clojure.core/cond-> {} (letvar1606811 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606811 ["message"])))))))

(clojure.core/defn- response-unexpected-lambda-exception ([input] (response-unexpected-lambda-exception nil input)) ([resultWrapper1606813 input] (clojure.core/let [rawinput1606812 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606814 {"message" (rawinput1606812 "message")}] (clojure.core/cond-> {} (letvar1606814 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606814 ["message"])))))))

(clojure.core/defn- response-create-user-import-job-response ([input] (response-create-user-import-job-response nil input)) ([resultWrapper1606816 input] (clojure.core/let [rawinput1606815 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606817 {"UserImportJob" (rawinput1606815 "UserImportJob")}] (clojure.core/cond-> {} (letvar1606817 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1606817 ["UserImportJob"])))))))

(clojure.core/defn- response-create-user-pool-client-response ([input] (response-create-user-pool-client-response nil input)) ([resultWrapper1606819 input] (clojure.core/let [rawinput1606818 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606820 {"UserPoolClient" (rawinput1606818 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1606820 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1606820 ["UserPoolClient"])))))))

(clojure.core/defn- response-list-user-pool-clients-response ([input] (response-list-user-pool-clients-response nil input)) ([resultWrapper1606822 input] (clojure.core/let [rawinput1606821 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606823 {"UserPoolClients" (rawinput1606821 "UserPoolClients"), "NextToken" (rawinput1606821 "NextToken")}] (clojure.core/cond-> {} (letvar1606823 "UserPoolClients") (clojure.core/assoc :user-pool-clients (deser-user-pool-client-list-type (clojure.core/get-in letvar1606823 ["UserPoolClients"]))) (letvar1606823 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1606823 ["NextToken"])))))))

(clojure.core/defn- response-stop-user-import-job-response ([input] (response-stop-user-import-job-response nil input)) ([resultWrapper1606825 input] (clojure.core/let [rawinput1606824 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606826 {"UserImportJob" (rawinput1606824 "UserImportJob")}] (clojure.core/cond-> {} (letvar1606826 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1606826 ["UserImportJob"])))))))

(clojure.core/defn- response-admin-list-groups-for-user-response ([input] (response-admin-list-groups-for-user-response nil input)) ([resultWrapper1606828 input] (clojure.core/let [rawinput1606827 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606829 {"Groups" (rawinput1606827 "Groups"), "NextToken" (rawinput1606827 "NextToken")}] (clojure.core/cond-> {} (letvar1606829 "Groups") (clojure.core/assoc :groups (deser-group-list-type (clojure.core/get-in letvar1606829 ["Groups"]))) (letvar1606829 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1606829 ["NextToken"])))))))

(clojure.core/defn- response-add-custom-attributes-response ([input] (response-add-custom-attributes-response nil input)) ([resultWrapper1606831 input] (clojure.core/let [rawinput1606830 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606832 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-pool-domain-response ([input] (response-describe-user-pool-domain-response nil input)) ([resultWrapper1606834 input] (clojure.core/let [rawinput1606833 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606835 {"DomainDescription" (rawinput1606833 "DomainDescription")}] (clojure.core/cond-> {} (letvar1606835 "DomainDescription") (clojure.core/assoc :domain-description (deser-domain-description-type (clojure.core/get-in letvar1606835 ["DomainDescription"])))))))

(clojure.core/defn- response-mfa-method-not-found-exception ([input] (response-mfa-method-not-found-exception nil input)) ([resultWrapper1606837 input] (clojure.core/let [rawinput1606836 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606838 {"message" (rawinput1606836 "message")}] (clojure.core/cond-> {} (letvar1606838 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606838 ["message"])))))))

(clojure.core/defn- response-unsupported-identity-provider-exception ([input] (response-unsupported-identity-provider-exception nil input)) ([resultWrapper1606840 input] (clojure.core/let [rawinput1606839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606841 {"message" (rawinput1606839 "message")}] (clojure.core/cond-> {} (letvar1606841 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606841 ["message"])))))))

(clojure.core/defn- response-admin-get-user-response ([input] (response-admin-get-user-response nil input)) ([resultWrapper1606843 input] (clojure.core/let [rawinput1606842 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606844 {"Username" (rawinput1606842 "Username"), "MFAOptions" (rawinput1606842 "MFAOptions"), "Enabled" (rawinput1606842 "Enabled"), "UserCreateDate" (rawinput1606842 "UserCreateDate"), "PreferredMfaSetting" (rawinput1606842 "PreferredMfaSetting"), "UserMFASettingList" (rawinput1606842 "UserMFASettingList"), "UserAttributes" (rawinput1606842 "UserAttributes"), "UserLastModifiedDate" (rawinput1606842 "UserLastModifiedDate"), "UserStatus" (rawinput1606842 "UserStatus")}] (clojure.core/cond-> {:username (deser-username-type (clojure.core/get-in letvar1606844 ["Username"]))} (letvar1606844 "MFAOptions") (clojure.core/assoc :mfa-options (deser-mfa-option-list-type (clojure.core/get-in letvar1606844 ["MFAOptions"]))) (letvar1606844 "Enabled") (clojure.core/assoc :enabled (deser-boolean-type (clojure.core/get-in letvar1606844 ["Enabled"]))) (letvar1606844 "UserCreateDate") (clojure.core/assoc :user-create-date (deser-date-type (clojure.core/get-in letvar1606844 ["UserCreateDate"]))) (letvar1606844 "PreferredMfaSetting") (clojure.core/assoc :preferred-mfa-setting (deser-string-type (clojure.core/get-in letvar1606844 ["PreferredMfaSetting"]))) (letvar1606844 "UserMFASettingList") (clojure.core/assoc :user-mfa-setting-list (deser-user-mfa-setting-list-type (clojure.core/get-in letvar1606844 ["UserMFASettingList"]))) (letvar1606844 "UserAttributes") (clojure.core/assoc :user-attributes (deser-attribute-list-type (clojure.core/get-in letvar1606844 ["UserAttributes"]))) (letvar1606844 "UserLastModifiedDate") (clojure.core/assoc :user-last-modified-date (deser-date-type (clojure.core/get-in letvar1606844 ["UserLastModifiedDate"]))) (letvar1606844 "UserStatus") (clojure.core/assoc :user-status (deser-user-status-type (clojure.core/get-in letvar1606844 ["UserStatus"])))))))

(clojure.core/defn- response-get-identity-provider-by-identifier-response ([input] (response-get-identity-provider-by-identifier-response nil input)) ([resultWrapper1606846 input] (clojure.core/let [rawinput1606845 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606847 {"IdentityProvider" (rawinput1606845 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1606847 ["IdentityProvider"]))}))))

(clojure.core/defn- response-user-import-in-progress-exception ([input] (response-user-import-in-progress-exception nil input)) ([resultWrapper1606849 input] (clojure.core/let [rawinput1606848 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606850 {"message" (rawinput1606848 "message")}] (clojure.core/cond-> {} (letvar1606850 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606850 ["message"])))))))

(clojure.core/defn- response-alias-exists-exception ([input] (response-alias-exists-exception nil input)) ([resultWrapper1606852 input] (clojure.core/let [rawinput1606851 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606853 {"message" (rawinput1606851 "message")}] (clojure.core/cond-> {} (letvar1606853 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606853 ["message"])))))))

(clojure.core/defn- response-get-ui-customization-response ([input] (response-get-ui-customization-response nil input)) ([resultWrapper1606855 input] (clojure.core/let [rawinput1606854 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606856 {"UICustomization" (rawinput1606854 "UICustomization")}] (clojure.core/cond-> {:ui-customization (deser-ui-customization-type (clojure.core/get-in letvar1606856 ["UICustomization"]))}))))

(clojure.core/defn- response-too-many-failed-attempts-exception ([input] (response-too-many-failed-attempts-exception nil input)) ([resultWrapper1606858 input] (clojure.core/let [rawinput1606857 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606859 {"message" (rawinput1606857 "message")}] (clojure.core/cond-> {} (letvar1606859 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606859 ["message"])))))))

(clojure.core/defn- response-admin-reset-user-password-response ([input] (response-admin-reset-user-password-response nil input)) ([resultWrapper1606861 input] (clojure.core/let [rawinput1606860 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606862 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-precondition-not-met-exception ([input] (response-precondition-not-met-exception nil input)) ([resultWrapper1606864 input] (clojure.core/let [rawinput1606863 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606865 {"message" (rawinput1606863 "message")}] (clojure.core/cond-> {} (letvar1606865 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606865 ["message"])))))))

(clojure.core/defn- response-user-lambda-validation-exception ([input] (response-user-lambda-validation-exception nil input)) ([resultWrapper1606867 input] (clojure.core/let [rawinput1606866 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606868 {"message" (rawinput1606866 "message")}] (clojure.core/cond-> {} (letvar1606868 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606868 ["message"])))))))

(clojure.core/defn- response-user-not-confirmed-exception ([input] (response-user-not-confirmed-exception nil input)) ([resultWrapper1606870 input] (clojure.core/let [rawinput1606869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606871 {"message" (rawinput1606869 "message")}] (clojure.core/cond-> {} (letvar1606871 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606871 ["message"])))))))

(clojure.core/defn- response-create-group-response ([input] (response-create-group-response nil input)) ([resultWrapper1606873 input] (clojure.core/let [rawinput1606872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606874 {"Group" (rawinput1606872 "Group")}] (clojure.core/cond-> {} (letvar1606874 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1606874 ["Group"])))))))

(clojure.core/defn- response-update-user-attributes-response ([input] (response-update-user-attributes-response nil input)) ([resultWrapper1606876 input] (clojure.core/let [rawinput1606875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606877 {"CodeDeliveryDetailsList" (rawinput1606875 "CodeDeliveryDetailsList")}] (clojure.core/cond-> {} (letvar1606877 "CodeDeliveryDetailsList") (clojure.core/assoc :code-delivery-details-list (deser-code-delivery-details-list-type (clojure.core/get-in letvar1606877 ["CodeDeliveryDetailsList"])))))))

(clojure.core/defn- response-admin-set-user-settings-response ([input] (response-admin-set-user-settings-response nil input)) ([resultWrapper1606879 input] (clojure.core/let [rawinput1606878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606880 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-csv-header-response ([input] (response-get-csv-header-response nil input)) ([resultWrapper1606882 input] (clojure.core/let [rawinput1606881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606883 {"UserPoolId" (rawinput1606881 "UserPoolId"), "CSVHeader" (rawinput1606881 "CSVHeader")}] (clojure.core/cond-> {} (letvar1606883 "UserPoolId") (clojure.core/assoc :user-pool-id (deser-user-pool-id-type (clojure.core/get-in letvar1606883 ["UserPoolId"]))) (letvar1606883 "CSVHeader") (clojure.core/assoc :csv-header (deser-list-of-string-types (clojure.core/get-in letvar1606883 ["CSVHeader"])))))))

(clojure.core/defn- response-list-resource-servers-response ([input] (response-list-resource-servers-response nil input)) ([resultWrapper1606885 input] (clojure.core/let [rawinput1606884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606886 {"ResourceServers" (rawinput1606884 "ResourceServers"), "NextToken" (rawinput1606884 "NextToken")}] (clojure.core/cond-> {:resource-servers (deser-resource-servers-list-type (clojure.core/get-in letvar1606886 ["ResourceServers"]))} (letvar1606886 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1606886 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-pool-client-response ([input] (response-describe-user-pool-client-response nil input)) ([resultWrapper1606888 input] (clojure.core/let [rawinput1606887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606889 {"UserPoolClient" (rawinput1606887 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1606889 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1606889 ["UserPoolClient"])))))))

(clojure.core/defn- response-confirm-device-response ([input] (response-confirm-device-response nil input)) ([resultWrapper1606891 input] (clojure.core/let [rawinput1606890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606892 {"UserConfirmationNecessary" (rawinput1606890 "UserConfirmationNecessary")}] (clojure.core/cond-> {} (letvar1606892 "UserConfirmationNecessary") (clojure.core/assoc :user-confirmation-necessary (deser-boolean-type (clojure.core/get-in letvar1606892 ["UserConfirmationNecessary"])))))))

(clojure.core/defn- response-confirm-forgot-password-response ([input] (response-confirm-forgot-password-response nil input)) ([resultWrapper1606894 input] (clojure.core/let [rawinput1606893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606895 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-software-token-response ([input] (response-associate-software-token-response nil input)) ([resultWrapper1606897 input] (clojure.core/let [rawinput1606896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606898 {"SecretCode" (rawinput1606896 "SecretCode"), "Session" (rawinput1606896 "Session")}] (clojure.core/cond-> {} (letvar1606898 "SecretCode") (clojure.core/assoc :secret-code (deser-secret-code-type (clojure.core/get-in letvar1606898 ["SecretCode"]))) (letvar1606898 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1606898 ["Session"])))))))

(clojure.core/defn- response-admin-disable-provider-for-user-response ([input] (response-admin-disable-provider-for-user-response nil input)) ([resultWrapper1606900 input] (clojure.core/let [rawinput1606899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606901 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-set-risk-configuration-response ([input] (response-set-risk-configuration-response nil input)) ([resultWrapper1606903 input] (clojure.core/let [rawinput1606902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606904 {"RiskConfiguration" (rawinput1606902 "RiskConfiguration")}] (clojure.core/cond-> {:risk-configuration (deser-risk-configuration-type (clojure.core/get-in letvar1606904 ["RiskConfiguration"]))}))))

(clojure.core/defn- response-admin-update-device-status-response ([input] (response-admin-update-device-status-response nil input)) ([resultWrapper1606906 input] (clojure.core/let [rawinput1606905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606907 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forgot-password-response ([input] (response-forgot-password-response nil input)) ([resultWrapper1606909 input] (clojure.core/let [rawinput1606908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606910 {"CodeDeliveryDetails" (rawinput1606908 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1606910 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1606910 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-set-user-mfa-preference-response ([input] (response-set-user-mfa-preference-response nil input)) ([resultWrapper1606912 input] (clojure.core/let [rawinput1606911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606913 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-o-auth-flow-exception ([input] (response-invalid-o-auth-flow-exception nil input)) ([resultWrapper1606915 input] (clojure.core/let [rawinput1606914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606916 {"message" (rawinput1606914 "message")}] (clojure.core/cond-> {} (letvar1606916 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606916 ["message"])))))))

(clojure.core/defn- response-confirm-sign-up-response ([input] (response-confirm-sign-up-response nil input)) ([resultWrapper1606918 input] (clojure.core/let [rawinput1606917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606919 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-user-global-sign-out-response ([input] (response-admin-user-global-sign-out-response nil input)) ([resultWrapper1606921 input] (clojure.core/let [rawinput1606920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606922 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1606924 input] (clojure.core/let [rawinput1606923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606925 {"message" (rawinput1606923 "message")}] (clojure.core/cond-> {} (letvar1606925 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606925 ["message"])))))))

(clojure.core/defn- response-update-user-pool-client-response ([input] (response-update-user-pool-client-response nil input)) ([resultWrapper1606927 input] (clojure.core/let [rawinput1606926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606928 {"UserPoolClient" (rawinput1606926 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1606928 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1606928 ["UserPoolClient"])))))))

(clojure.core/defn- response-describe-risk-configuration-response ([input] (response-describe-risk-configuration-response nil input)) ([resultWrapper1606930 input] (clojure.core/let [rawinput1606929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606931 {"RiskConfiguration" (rawinput1606929 "RiskConfiguration")}] (clojure.core/cond-> {:risk-configuration (deser-risk-configuration-type (clojure.core/get-in letvar1606931 ["RiskConfiguration"]))}))))

(clojure.core/defn- response-invalid-sms-role-trust-relationship-exception ([input] (response-invalid-sms-role-trust-relationship-exception nil input)) ([resultWrapper1606933 input] (clojure.core/let [rawinput1606932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606934 {"message" (rawinput1606932 "message")}] (clojure.core/cond-> {} (letvar1606934 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606934 ["message"])))))))

(clojure.core/defn- response-describe-resource-server-response ([input] (response-describe-resource-server-response nil input)) ([resultWrapper1606936 input] (clojure.core/let [rawinput1606935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606937 {"ResourceServer" (rawinput1606935 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1606937 ["ResourceServer"]))}))))

(clojure.core/defn- response-software-token-mfa-not-found-exception ([input] (response-software-token-mfa-not-found-exception nil input)) ([resultWrapper1606939 input] (clojure.core/let [rawinput1606938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606940 {"message" (rawinput1606938 "message")}] (clojure.core/cond-> {} (letvar1606940 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606940 ["message"])))))))

(clojure.core/defn- response-get-signing-certificate-response ([input] (response-get-signing-certificate-response nil input)) ([resultWrapper1606942 input] (clojure.core/let [rawinput1606941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606943 {"Certificate" (rawinput1606941 "Certificate")}] (clojure.core/cond-> {} (letvar1606943 "Certificate") (clojure.core/assoc :certificate (deser-string-type (clojure.core/get-in letvar1606943 ["Certificate"])))))))

(clojure.core/defn- response-admin-disable-user-response ([input] (response-admin-disable-user-response nil input)) ([resultWrapper1606945 input] (clojure.core/let [rawinput1606944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606946 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1606948 input] (clojure.core/let [rawinput1606947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606949 {"message" (rawinput1606947 "message")}] (clojure.core/cond-> {} (letvar1606949 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1606949 ["message"])))))))

(clojure.core/defn- response-describe-user-import-job-response ([input] (response-describe-user-import-job-response nil input)) ([resultWrapper1606951 input] (clojure.core/let [rawinput1606950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606952 {"UserImportJob" (rawinput1606950 "UserImportJob")}] (clojure.core/cond-> {} (letvar1606952 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1606952 ["UserImportJob"])))))))

(clojure.core/defn- response-create-user-pool-response ([input] (response-create-user-pool-response nil input)) ([resultWrapper1606954 input] (clojure.core/let [rawinput1606953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606955 {"UserPool" (rawinput1606953 "UserPool")}] (clojure.core/cond-> {} (letvar1606955 "UserPool") (clojure.core/assoc :user-pool (deser-user-pool-type (clojure.core/get-in letvar1606955 ["UserPool"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1606957 input] (clojure.core/let [rawinput1606956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606958 {"Users" (rawinput1606956 "Users"), "PaginationToken" (rawinput1606956 "PaginationToken")}] (clojure.core/cond-> {} (letvar1606958 "Users") (clojure.core/assoc :users (deser-users-list-type (clojure.core/get-in letvar1606958 ["Users"]))) (letvar1606958 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1606958 ["PaginationToken"])))))))

(clojure.core/defn- response-update-resource-server-response ([input] (response-update-resource-server-response nil input)) ([resultWrapper1606960 input] (clojure.core/let [rawinput1606959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606961 {"ResourceServer" (rawinput1606959 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1606961 ["ResourceServer"]))}))))

(clojure.core/defn- response-admin-delete-user-attributes-response ([input] (response-admin-delete-user-attributes-response nil input)) ([resultWrapper1606963 input] (clojure.core/let [rawinput1606962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606964 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-resource-server-response ([input] (response-create-resource-server-response nil input)) ([resultWrapper1606966 input] (clojure.core/let [rawinput1606965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606967 {"ResourceServer" (rawinput1606965 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1606967 ["ResourceServer"]))}))))

(clojure.core/defn- response-list-devices-response ([input] (response-list-devices-response nil input)) ([resultWrapper1606969 input] (clojure.core/let [rawinput1606968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606970 {"Devices" (rawinput1606968 "Devices"), "PaginationToken" (rawinput1606968 "PaginationToken")}] (clojure.core/cond-> {} (letvar1606970 "Devices") (clojure.core/assoc :devices (deser-device-list-type (clojure.core/get-in letvar1606970 ["Devices"]))) (letvar1606970 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1606970 ["PaginationToken"])))))))

(clojure.core/defn- response-get-user-response ([input] (response-get-user-response nil input)) ([resultWrapper1606972 input] (clojure.core/let [rawinput1606971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606973 {"Username" (rawinput1606971 "Username"), "UserAttributes" (rawinput1606971 "UserAttributes"), "MFAOptions" (rawinput1606971 "MFAOptions"), "PreferredMfaSetting" (rawinput1606971 "PreferredMfaSetting"), "UserMFASettingList" (rawinput1606971 "UserMFASettingList")}] (clojure.core/cond-> {:username (deser-username-type (clojure.core/get-in letvar1606973 ["Username"])), :user-attributes (deser-attribute-list-type (clojure.core/get-in letvar1606973 ["UserAttributes"]))} (letvar1606973 "MFAOptions") (clojure.core/assoc :mfa-options (deser-mfa-option-list-type (clojure.core/get-in letvar1606973 ["MFAOptions"]))) (letvar1606973 "PreferredMfaSetting") (clojure.core/assoc :preferred-mfa-setting (deser-string-type (clojure.core/get-in letvar1606973 ["PreferredMfaSetting"]))) (letvar1606973 "UserMFASettingList") (clojure.core/assoc :user-mfa-setting-list (deser-user-mfa-setting-list-type (clojure.core/get-in letvar1606973 ["UserMFASettingList"])))))))

(clojure.core/defn- response-admin-update-auth-event-feedback-response ([input] (response-admin-update-auth-event-feedback-response nil input)) ([resultWrapper1606975 input] (clojure.core/let [rawinput1606974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606976 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-list-devices-response ([input] (response-admin-list-devices-response nil input)) ([resultWrapper1606978 input] (clojure.core/let [rawinput1606977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606979 {"Devices" (rawinput1606977 "Devices"), "PaginationToken" (rawinput1606977 "PaginationToken")}] (clojure.core/cond-> {} (letvar1606979 "Devices") (clojure.core/assoc :devices (deser-device-list-type (clojure.core/get-in letvar1606979 ["Devices"]))) (letvar1606979 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1606979 ["PaginationToken"])))))))

(clojure.core/defn- response-describe-user-pool-response ([input] (response-describe-user-pool-response nil input)) ([resultWrapper1606981 input] (clojure.core/let [rawinput1606980 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1606982 {"UserPool" (rawinput1606980 "UserPool")}] (clojure.core/cond-> {} (letvar1606982 "UserPool") (clojure.core/assoc :user-pool (deser-user-pool-type (clojure.core/get-in letvar1606982 ["UserPool"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/redirect-url-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/domain-version-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/provider-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/event-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w+-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/arn-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:([\w+=/,.@-]*)?:[0-9]+:[\w+=/,.@-]+(:[\w+=/,.@-]+)?(:[\w+=/,.@-]+)?" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pagination-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\S]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/device-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-message-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20000)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*\{####\}[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/hex-string-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[0-9a-fA-F]+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-pool-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-identifier-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\x21\x23-\x5B\x5D-\x7E]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/provider-name-type-v-1 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^_][\p{L}\p{M}\p{S}\p{N}\p{P}][^_]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-address-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+@[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/search-pagination-token-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\S]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-scope-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\x21\x23-\x2E\x30-\x5B\x5D-\x7E]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-permission-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-message-by-link-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20000)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*\{##[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*##\}[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/token-model-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[A-Za-z0-9-_=.]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/username-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-notification-body-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20000)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/secret-code-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 16 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[A-Za-z0-9]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/group-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pagination-key-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\S]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-import-job-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/software-token-mfa-user-code-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 6)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-secret-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w+]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-import-job-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 55)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"import-[0-9a-zA-Z-]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/password-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\S]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/date-type clojure.core/inst?)

(clojure.spec.alpha/def :portkey.aws.cognito-idp/sms-verification-message-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 140)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\{####\}.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/secret-hash-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w+=/]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/scope-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\x21\x23-\x5B\x5D-\x7E]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-scope-description-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-mapping-key-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-filter-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/domain-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 63)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[a-z0-9](?:[a-z0-9\-]{0,61}[a-z0-9])?$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/s-3-bucket-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-value-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/confirmation-code-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\S]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/description-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-subject-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 140)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-subject-by-link-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 140)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w+]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/idp-identifier-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 40)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w\s+=.@-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/custom-attribute-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pre-signed-url-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/session-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-notification-subject-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 140)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/device-key-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 55)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-f-]+" s__1467903__auto__))))
...
(clojure.core/defn delete-user-pool-client ([delete-user-pool-client-requestinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-user-pool-client-request delete-user-pool-client-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-user-pool-client-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteUserPoolClient", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-user-pool ([delete-user-pool-requestinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-user-pool-request delete-user-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-user-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteUserPool", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "UserImportInProgressException" :portkey.aws.cognito-idp/user-import-in-progress-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-resource-server ([delete-resource-server-requestinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-resource-server-request delete-resource-server-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-resource-server-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteResourceServer", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
