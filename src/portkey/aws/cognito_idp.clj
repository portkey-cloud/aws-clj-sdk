...
(clojure.core/defn- response-user-pool-add-on-not-enabled-exception ([input] (response-user-pool-add-on-not-enabled-exception nil input)) ([resultWrapper1558700 input] (clojure.core/let [rawinput1558699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558701 {"message" (rawinput1558699 "message")}] (clojure.core/cond-> {} (letvar1558701 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558701 ["message"])))))))

(clojure.core/defn- response-list-identity-providers-response ([input] (response-list-identity-providers-response nil input)) ([resultWrapper1558703 input] (clojure.core/let [rawinput1558702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558704 {"Providers" (rawinput1558702 "Providers"), "NextToken" (rawinput1558702 "NextToken")}] (clojure.core/cond-> {:providers (deser-providers-list-type (clojure.core/get-in letvar1558704 ["Providers"]))} (letvar1558704 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1558704 ["NextToken"])))))))

(clojure.core/defn- response-admin-update-user-attributes-response ([input] (response-admin-update-user-attributes-response nil input)) ([resultWrapper1558706 input] (clojure.core/let [rawinput1558705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558707 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-group-exists-exception ([input] (response-group-exists-exception nil input)) ([resultWrapper1558709 input] (clojure.core/let [rawinput1558708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558710 {"message" (rawinput1558708 "message")}] (clojure.core/cond-> {} (letvar1558710 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558710 ["message"])))))))

(clojure.core/defn- response-duplicate-provider-exception ([input] (response-duplicate-provider-exception nil input)) ([resultWrapper1558712 input] (clojure.core/let [rawinput1558711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558713 {"message" (rawinput1558711 "message")}] (clojure.core/cond-> {} (letvar1558713 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558713 ["message"])))))))

(clojure.core/defn- response-create-identity-provider-response ([input] (response-create-identity-provider-response nil input)) ([resultWrapper1558715 input] (clojure.core/let [rawinput1558714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558716 {"IdentityProvider" (rawinput1558714 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1558716 ["IdentityProvider"]))}))))

(clojure.core/defn- response-change-password-response ([input] (response-change-password-response nil input)) ([resultWrapper1558718 input] (clojure.core/let [rawinput1558717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558719 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-user-import-job-response ([input] (response-start-user-import-job-response nil input)) ([resultWrapper1558721 input] (clojure.core/let [rawinput1558720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558722 {"UserImportJob" (rawinput1558720 "UserImportJob")}] (clojure.core/cond-> {} (letvar1558722 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1558722 ["UserImportJob"])))))))

(clojure.core/defn- response-set-ui-customization-response ([input] (response-set-ui-customization-response nil input)) ([resultWrapper1558724 input] (clojure.core/let [rawinput1558723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558725 {"UICustomization" (rawinput1558723 "UICustomization")}] (clojure.core/cond-> {:ui-customization (deser-ui-customization-type (clojure.core/get-in letvar1558725 ["UICustomization"]))}))))

(clojure.core/defn- response-sign-up-response ([input] (response-sign-up-response nil input)) ([resultWrapper1558727 input] (clojure.core/let [rawinput1558726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558728 {"UserConfirmed" (rawinput1558726 "UserConfirmed"), "CodeDeliveryDetails" (rawinput1558726 "CodeDeliveryDetails"), "UserSub" (rawinput1558726 "UserSub")}] (clojure.core/cond-> {:user-confirmed (deser-boolean-type (clojure.core/get-in letvar1558728 ["UserConfirmed"])), :user-sub (deser-string-type (clojure.core/get-in letvar1558728 ["UserSub"]))} (letvar1558728 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1558728 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-set-user-settings-response ([input] (response-set-user-settings-response nil input)) ([resultWrapper1558730 input] (clojure.core/let [rawinput1558729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558731 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-initiate-auth-response ([input] (response-admin-initiate-auth-response nil input)) ([resultWrapper1558733 input] (clojure.core/let [rawinput1558732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558734 {"ChallengeName" (rawinput1558732 "ChallengeName"), "Session" (rawinput1558732 "Session"), "ChallengeParameters" (rawinput1558732 "ChallengeParameters"), "AuthenticationResult" (rawinput1558732 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1558734 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1558734 ["ChallengeName"]))) (letvar1558734 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558734 ["Session"]))) (letvar1558734 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1558734 ["ChallengeParameters"]))) (letvar1558734 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1558734 ["AuthenticationResult"])))))))

(clojure.core/defn- response-update-auth-event-feedback-response ([input] (response-update-auth-event-feedback-response nil input)) ([resultWrapper1558736 input] (clojure.core/let [rawinput1558735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558737 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-import-jobs-response ([input] (response-list-user-import-jobs-response nil input)) ([resultWrapper1558739 input] (clojure.core/let [rawinput1558738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558740 {"UserImportJobs" (rawinput1558738 "UserImportJobs"), "PaginationToken" (rawinput1558738 "PaginationToken")}] (clojure.core/cond-> {} (letvar1558740 "UserImportJobs") (clojure.core/assoc :user-import-jobs (deser-user-import-jobs-list-type (clojure.core/get-in letvar1558740 ["UserImportJobs"]))) (letvar1558740 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-key-type (clojure.core/get-in letvar1558740 ["PaginationToken"])))))))

(clojure.core/defn- response-create-user-pool-domain-response ([input] (response-create-user-pool-domain-response nil input)) ([resultWrapper1558742 input] (clojure.core/let [rawinput1558741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558743 {"CloudFrontDomain" (rawinput1558741 "CloudFrontDomain")}] (clojure.core/cond-> {} (letvar1558743 "CloudFrontDomain") (clojure.core/assoc :cloud-front-domain (deser-domain-type (clojure.core/get-in letvar1558743 ["CloudFrontDomain"])))))))

(clojure.core/defn- response-admin-confirm-sign-up-response ([input] (response-admin-confirm-sign-up-response nil input)) ([resultWrapper1558745 input] (clojure.core/let [rawinput1558744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558746 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resend-confirmation-code-response ([input] (response-resend-confirmation-code-response nil input)) ([resultWrapper1558748 input] (clojure.core/let [rawinput1558747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558749 {"CodeDeliveryDetails" (rawinput1558747 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1558749 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1558749 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-admin-list-user-auth-events-response ([input] (response-admin-list-user-auth-events-response nil input)) ([resultWrapper1558751 input] (clojure.core/let [rawinput1558750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558752 {"AuthEvents" (rawinput1558750 "AuthEvents"), "NextToken" (rawinput1558750 "NextToken")}] (clojure.core/cond-> {} (letvar1558752 "AuthEvents") (clojure.core/assoc :auth-events (deser-auth-events-type (clojure.core/get-in letvar1558752 ["AuthEvents"]))) (letvar1558752 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1558752 ["NextToken"])))))))

(clojure.core/defn- response-expired-code-exception ([input] (response-expired-code-exception nil input)) ([resultWrapper1558754 input] (clojure.core/let [rawinput1558753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558755 {"message" (rawinput1558753 "message")}] (clojure.core/cond-> {} (letvar1558755 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558755 ["message"])))))))

(clojure.core/defn- response-delete-user-pool-domain-response ([input] (response-delete-user-pool-domain-response nil input)) ([resultWrapper1558757 input] (clojure.core/let [rawinput1558756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558758 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-device-response ([input] (response-get-device-response nil input)) ([resultWrapper1558760 input] (clojure.core/let [rawinput1558759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558761 {"Device" (rawinput1558759 "Device")}] (clojure.core/cond-> {:device (deser-device-type (clojure.core/get-in letvar1558761 ["Device"]))}))))

(clojure.core/defn- response-set-user-pool-mfa-config-response ([input] (response-set-user-pool-mfa-config-response nil input)) ([resultWrapper1558763 input] (clojure.core/let [rawinput1558762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558764 {"SmsMfaConfiguration" (rawinput1558762 "SmsMfaConfiguration"), "SoftwareTokenMfaConfiguration" (rawinput1558762 "SoftwareTokenMfaConfiguration"), "MfaConfiguration" (rawinput1558762 "MfaConfiguration")}] (clojure.core/cond-> {} (letvar1558764 "SmsMfaConfiguration") (clojure.core/assoc :sms-mfa-configuration (deser-sms-mfa-config-type (clojure.core/get-in letvar1558764 ["SmsMfaConfiguration"]))) (letvar1558764 "SoftwareTokenMfaConfiguration") (clojure.core/assoc :software-token-mfa-configuration (deser-software-token-mfa-config-type (clojure.core/get-in letvar1558764 ["SoftwareTokenMfaConfiguration"]))) (letvar1558764 "MfaConfiguration") (clojure.core/assoc :mfa-configuration (deser-user-pool-mfa-type (clojure.core/get-in letvar1558764 ["MfaConfiguration"])))))))

(clojure.core/defn- response-invalid-sms-role-access-policy-exception ([input] (response-invalid-sms-role-access-policy-exception nil input)) ([resultWrapper1558766 input] (clojure.core/let [rawinput1558765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558767 {"message" (rawinput1558765 "message")}] (clojure.core/cond-> {} (letvar1558767 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558767 ["message"])))))))

(clojure.core/defn- response-enable-software-token-mfa-exception ([input] (response-enable-software-token-mfa-exception nil input)) ([resultWrapper1558769 input] (clojure.core/let [rawinput1558768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558770 {"message" (rawinput1558768 "message")}] (clojure.core/cond-> {} (letvar1558770 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558770 ["message"])))))))

(clojure.core/defn- response-update-user-pool-domain-response ([input] (response-update-user-pool-domain-response nil input)) ([resultWrapper1558772 input] (clojure.core/let [rawinput1558771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558773 {"CloudFrontDomain" (rawinput1558771 "CloudFrontDomain")}] (clojure.core/cond-> {} (letvar1558773 "CloudFrontDomain") (clojure.core/assoc :cloud-front-domain (deser-domain-type (clojure.core/get-in letvar1558773 ["CloudFrontDomain"])))))))

(clojure.core/defn- response-get-user-attribute-verification-code-response ([input] (response-get-user-attribute-verification-code-response nil input)) ([resultWrapper1558775 input] (clojure.core/let [rawinput1558774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558776 {"CodeDeliveryDetails" (rawinput1558774 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1558776 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1558776 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-get-user-pool-mfa-config-response ([input] (response-get-user-pool-mfa-config-response nil input)) ([resultWrapper1558778 input] (clojure.core/let [rawinput1558777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558779 {"SmsMfaConfiguration" (rawinput1558777 "SmsMfaConfiguration"), "SoftwareTokenMfaConfiguration" (rawinput1558777 "SoftwareTokenMfaConfiguration"), "MfaConfiguration" (rawinput1558777 "MfaConfiguration")}] (clojure.core/cond-> {} (letvar1558779 "SmsMfaConfiguration") (clojure.core/assoc :sms-mfa-configuration (deser-sms-mfa-config-type (clojure.core/get-in letvar1558779 ["SmsMfaConfiguration"]))) (letvar1558779 "SoftwareTokenMfaConfiguration") (clojure.core/assoc :software-token-mfa-configuration (deser-software-token-mfa-config-type (clojure.core/get-in letvar1558779 ["SoftwareTokenMfaConfiguration"]))) (letvar1558779 "MfaConfiguration") (clojure.core/assoc :mfa-configuration (deser-user-pool-mfa-type (clojure.core/get-in letvar1558779 ["MfaConfiguration"])))))))

(clojure.core/defn- response-list-user-pools-response ([input] (response-list-user-pools-response nil input)) ([resultWrapper1558781 input] (clojure.core/let [rawinput1558780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558782 {"UserPools" (rawinput1558780 "UserPools"), "NextToken" (rawinput1558780 "NextToken")}] (clojure.core/cond-> {} (letvar1558782 "UserPools") (clojure.core/assoc :user-pools (deser-user-pool-list-type (clojure.core/get-in letvar1558782 ["UserPools"]))) (letvar1558782 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1558782 ["NextToken"])))))))

(clojure.core/defn- response-update-user-pool-response ([input] (response-update-user-pool-response nil input)) ([resultWrapper1558784 input] (clojure.core/let [rawinput1558783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558785 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-identity-provider-response ([input] (response-describe-identity-provider-response nil input)) ([resultWrapper1558787 input] (clojure.core/let [rawinput1558786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558788 {"IdentityProvider" (rawinput1558786 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1558788 ["IdentityProvider"]))}))))

(clojure.core/defn- response-get-group-response ([input] (response-get-group-response nil input)) ([resultWrapper1558790 input] (clojure.core/let [rawinput1558789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558791 {"Group" (rawinput1558789 "Group")}] (clojure.core/cond-> {} (letvar1558791 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1558791 ["Group"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1558793 input] (clojure.core/let [rawinput1558792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558794 {"message" (rawinput1558792 "message")}] (clojure.core/cond-> {} (letvar1558794 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558794 ["message"])))))))

(clojure.core/defn- response-invalid-lambda-response-exception ([input] (response-invalid-lambda-response-exception nil input)) ([resultWrapper1558796 input] (clojure.core/let [rawinput1558795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558797 {"message" (rawinput1558795 "message")}] (clojure.core/cond-> {} (letvar1558797 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558797 ["message"])))))))

(clojure.core/defn- response-update-group-response ([input] (response-update-group-response nil input)) ([resultWrapper1558799 input] (clojure.core/let [rawinput1558798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558800 {"Group" (rawinput1558798 "Group")}] (clojure.core/cond-> {} (letvar1558800 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1558800 ["Group"])))))))

(clojure.core/defn- response-list-groups-response ([input] (response-list-groups-response nil input)) ([resultWrapper1558802 input] (clojure.core/let [rawinput1558801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558803 {"Groups" (rawinput1558801 "Groups"), "NextToken" (rawinput1558801 "NextToken")}] (clojure.core/cond-> {} (letvar1558803 "Groups") (clojure.core/assoc :groups (deser-group-list-type (clojure.core/get-in letvar1558803 ["Groups"]))) (letvar1558803 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1558803 ["NextToken"])))))))

(clojure.core/defn- response-invalid-user-pool-configuration-exception ([input] (response-invalid-user-pool-configuration-exception nil input)) ([resultWrapper1558805 input] (clojure.core/let [rawinput1558804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558806 {"message" (rawinput1558804 "message")}] (clojure.core/cond-> {} (letvar1558806 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558806 ["message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1558808 input] (clojure.core/let [rawinput1558807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558809 {"message" (rawinput1558807 "message")}] (clojure.core/cond-> {} (letvar1558809 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558809 ["message"])))))))

(clojure.core/defn- response-admin-set-user-mfa-preference-response ([input] (response-admin-set-user-mfa-preference-response nil input)) ([resultWrapper1558811 input] (clojure.core/let [rawinput1558810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558812 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-initiate-auth-response ([input] (response-initiate-auth-response nil input)) ([resultWrapper1558814 input] (clojure.core/let [rawinput1558813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558815 {"ChallengeName" (rawinput1558813 "ChallengeName"), "Session" (rawinput1558813 "Session"), "ChallengeParameters" (rawinput1558813 "ChallengeParameters"), "AuthenticationResult" (rawinput1558813 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1558815 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1558815 ["ChallengeName"]))) (letvar1558815 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558815 ["Session"]))) (letvar1558815 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1558815 ["ChallengeParameters"]))) (letvar1558815 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1558815 ["AuthenticationResult"])))))))

(clojure.core/defn- response-admin-respond-to-auth-challenge-response ([input] (response-admin-respond-to-auth-challenge-response nil input)) ([resultWrapper1558817 input] (clojure.core/let [rawinput1558816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558818 {"ChallengeName" (rawinput1558816 "ChallengeName"), "Session" (rawinput1558816 "Session"), "ChallengeParameters" (rawinput1558816 "ChallengeParameters"), "AuthenticationResult" (rawinput1558816 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1558818 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1558818 ["ChallengeName"]))) (letvar1558818 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558818 ["Session"]))) (letvar1558818 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1558818 ["ChallengeParameters"]))) (letvar1558818 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1558818 ["AuthenticationResult"])))))))

(clojure.core/defn- response-password-reset-required-exception ([input] (response-password-reset-required-exception nil input)) ([resultWrapper1558820 input] (clojure.core/let [rawinput1558819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558821 {"message" (rawinput1558819 "message")}] (clojure.core/cond-> {} (letvar1558821 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558821 ["message"])))))))

(clojure.core/defn- response-list-users-in-group-response ([input] (response-list-users-in-group-response nil input)) ([resultWrapper1558823 input] (clojure.core/let [rawinput1558822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558824 {"Users" (rawinput1558822 "Users"), "NextToken" (rawinput1558822 "NextToken")}] (clojure.core/cond-> {} (letvar1558824 "Users") (clojure.core/assoc :users (deser-users-list-type (clojure.core/get-in letvar1558824 ["Users"]))) (letvar1558824 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1558824 ["NextToken"])))))))

(clojure.core/defn- response-invalid-password-exception ([input] (response-invalid-password-exception nil input)) ([resultWrapper1558826 input] (clojure.core/let [rawinput1558825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558827 {"message" (rawinput1558825 "message")}] (clojure.core/cond-> {} (letvar1558827 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558827 ["message"])))))))

(clojure.core/defn- response-user-pool-tagging-exception ([input] (response-user-pool-tagging-exception nil input)) ([resultWrapper1558829 input] (clojure.core/let [rawinput1558828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558830 {"message" (rawinput1558828 "message")}] (clojure.core/cond-> {} (letvar1558830 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558830 ["message"])))))))

(clojure.core/defn- response-respond-to-auth-challenge-response ([input] (response-respond-to-auth-challenge-response nil input)) ([resultWrapper1558832 input] (clojure.core/let [rawinput1558831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558833 {"ChallengeName" (rawinput1558831 "ChallengeName"), "Session" (rawinput1558831 "Session"), "ChallengeParameters" (rawinput1558831 "ChallengeParameters"), "AuthenticationResult" (rawinput1558831 "AuthenticationResult")}] (clojure.core/cond-> {} (letvar1558833 "ChallengeName") (clojure.core/assoc :challenge-name (deser-challenge-name-type (clojure.core/get-in letvar1558833 ["ChallengeName"]))) (letvar1558833 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558833 ["Session"]))) (letvar1558833 "ChallengeParameters") (clojure.core/assoc :challenge-parameters (deser-challenge-parameters-type (clojure.core/get-in letvar1558833 ["ChallengeParameters"]))) (letvar1558833 "AuthenticationResult") (clojure.core/assoc :authentication-result (deser-authentication-result-type (clojure.core/get-in letvar1558833 ["AuthenticationResult"])))))))

(clojure.core/defn- response-admin-link-provider-for-user-response ([input] (response-admin-link-provider-for-user-response nil input)) ([resultWrapper1558835 input] (clojure.core/let [rawinput1558834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558836 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-email-role-access-policy-exception ([input] (response-invalid-email-role-access-policy-exception nil input)) ([resultWrapper1558838 input] (clojure.core/let [rawinput1558837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558839 {"message" (rawinput1558837 "message")}] (clojure.core/cond-> {} (letvar1558839 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558839 ["message"])))))))

(clojure.core/defn- response-admin-create-user-response ([input] (response-admin-create-user-response nil input)) ([resultWrapper1558841 input] (clojure.core/let [rawinput1558840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558842 {"User" (rawinput1558840 "User")}] (clojure.core/cond-> {} (letvar1558842 "User") (clojure.core/assoc :user (deser-user-type (clojure.core/get-in letvar1558842 ["User"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1558844 input] (clojure.core/let [rawinput1558843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558845 {"message" (rawinput1558843 "message")}] (clojure.core/cond-> {} (letvar1558845 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558845 ["message"])))))))

(clojure.core/defn- response-username-exists-exception ([input] (response-username-exists-exception nil input)) ([resultWrapper1558847 input] (clojure.core/let [rawinput1558846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558848 {"message" (rawinput1558846 "message")}] (clojure.core/cond-> {} (letvar1558848 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558848 ["message"])))))))

(clojure.core/defn- response-verify-software-token-response ([input] (response-verify-software-token-response nil input)) ([resultWrapper1558850 input] (clojure.core/let [rawinput1558849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558851 {"Status" (rawinput1558849 "Status"), "Session" (rawinput1558849 "Session")}] (clojure.core/cond-> {} (letvar1558851 "Status") (clojure.core/assoc :status (deser-verify-software-token-response-type (clojure.core/get-in letvar1558851 ["Status"]))) (letvar1558851 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558851 ["Session"])))))))

(clojure.core/defn- response-global-sign-out-response ([input] (response-global-sign-out-response nil input)) ([resultWrapper1558853 input] (clojure.core/let [rawinput1558852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558854 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1558856 input] (clojure.core/let [rawinput1558855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558857 {"message" (rawinput1558855 "message")}] (clojure.core/cond-> {} (letvar1558857 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558857 ["message"])))))))

(clojure.core/defn- response-update-identity-provider-response ([input] (response-update-identity-provider-response nil input)) ([resultWrapper1558859 input] (clojure.core/let [rawinput1558858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558860 {"IdentityProvider" (rawinput1558858 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1558860 ["IdentityProvider"]))}))))

(clojure.core/defn- response-code-delivery-failure-exception ([input] (response-code-delivery-failure-exception nil input)) ([resultWrapper1558862 input] (clojure.core/let [rawinput1558861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558863 {"message" (rawinput1558861 "message")}] (clojure.core/cond-> {} (letvar1558863 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558863 ["message"])))))))

(clojure.core/defn- response-code-mismatch-exception ([input] (response-code-mismatch-exception nil input)) ([resultWrapper1558865 input] (clojure.core/let [rawinput1558864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558866 {"message" (rawinput1558864 "message")}] (clojure.core/cond-> {} (letvar1558866 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558866 ["message"])))))))

(clojure.core/defn- response-admin-enable-user-response ([input] (response-admin-enable-user-response nil input)) ([resultWrapper1558868 input] (clojure.core/let [rawinput1558867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558869 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-scope-does-not-exist-exception ([input] (response-scope-does-not-exist-exception nil input)) ([resultWrapper1558871 input] (clojure.core/let [rawinput1558870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558872 {"message" (rawinput1558870 "message")}] (clojure.core/cond-> {} (letvar1558872 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558872 ["message"])))))))

(clojure.core/defn- response-admin-get-device-response ([input] (response-admin-get-device-response nil input)) ([resultWrapper1558874 input] (clojure.core/let [rawinput1558873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558875 {"Device" (rawinput1558873 "Device")}] (clojure.core/cond-> {:device (deser-device-type (clojure.core/get-in letvar1558875 ["Device"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1558877 input] (clojure.core/let [rawinput1558876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558878 {"message" (rawinput1558876 "message")}] (clojure.core/cond-> {} (letvar1558878 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558878 ["message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper1558880 input] (clojure.core/let [rawinput1558879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558881 {"message" (rawinput1558879 "message")}] (clojure.core/cond-> {} (letvar1558881 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558881 ["message"])))))))

(clojure.core/defn- response-verify-user-attribute-response ([input] (response-verify-user-attribute-response nil input)) ([resultWrapper1558883 input] (clojure.core/let [rawinput1558882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558884 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-device-status-response ([input] (response-update-device-status-response nil input)) ([resultWrapper1558886 input] (clojure.core/let [rawinput1558885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558887 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-attributes-response ([input] (response-delete-user-attributes-response nil input)) ([resultWrapper1558889 input] (clojure.core/let [rawinput1558888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558890 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-user-state-exception ([input] (response-unsupported-user-state-exception nil input)) ([resultWrapper1558892 input] (clojure.core/let [rawinput1558891 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558893 {"message" (rawinput1558891 "message")}] (clojure.core/cond-> {} (letvar1558893 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558893 ["message"])))))))

(clojure.core/defn- response-unexpected-lambda-exception ([input] (response-unexpected-lambda-exception nil input)) ([resultWrapper1558895 input] (clojure.core/let [rawinput1558894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558896 {"message" (rawinput1558894 "message")}] (clojure.core/cond-> {} (letvar1558896 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558896 ["message"])))))))

(clojure.core/defn- response-create-user-import-job-response ([input] (response-create-user-import-job-response nil input)) ([resultWrapper1558898 input] (clojure.core/let [rawinput1558897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558899 {"UserImportJob" (rawinput1558897 "UserImportJob")}] (clojure.core/cond-> {} (letvar1558899 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1558899 ["UserImportJob"])))))))

(clojure.core/defn- response-create-user-pool-client-response ([input] (response-create-user-pool-client-response nil input)) ([resultWrapper1558901 input] (clojure.core/let [rawinput1558900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558902 {"UserPoolClient" (rawinput1558900 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1558902 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1558902 ["UserPoolClient"])))))))

(clojure.core/defn- response-list-user-pool-clients-response ([input] (response-list-user-pool-clients-response nil input)) ([resultWrapper1558904 input] (clojure.core/let [rawinput1558903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558905 {"UserPoolClients" (rawinput1558903 "UserPoolClients"), "NextToken" (rawinput1558903 "NextToken")}] (clojure.core/cond-> {} (letvar1558905 "UserPoolClients") (clojure.core/assoc :user-pool-clients (deser-user-pool-client-list-type (clojure.core/get-in letvar1558905 ["UserPoolClients"]))) (letvar1558905 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1558905 ["NextToken"])))))))

(clojure.core/defn- response-stop-user-import-job-response ([input] (response-stop-user-import-job-response nil input)) ([resultWrapper1558907 input] (clojure.core/let [rawinput1558906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558908 {"UserImportJob" (rawinput1558906 "UserImportJob")}] (clojure.core/cond-> {} (letvar1558908 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1558908 ["UserImportJob"])))))))

(clojure.core/defn- response-admin-list-groups-for-user-response ([input] (response-admin-list-groups-for-user-response nil input)) ([resultWrapper1558910 input] (clojure.core/let [rawinput1558909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558911 {"Groups" (rawinput1558909 "Groups"), "NextToken" (rawinput1558909 "NextToken")}] (clojure.core/cond-> {} (letvar1558911 "Groups") (clojure.core/assoc :groups (deser-group-list-type (clojure.core/get-in letvar1558911 ["Groups"]))) (letvar1558911 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1558911 ["NextToken"])))))))

(clojure.core/defn- response-add-custom-attributes-response ([input] (response-add-custom-attributes-response nil input)) ([resultWrapper1558913 input] (clojure.core/let [rawinput1558912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558914 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-pool-domain-response ([input] (response-describe-user-pool-domain-response nil input)) ([resultWrapper1558916 input] (clojure.core/let [rawinput1558915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558917 {"DomainDescription" (rawinput1558915 "DomainDescription")}] (clojure.core/cond-> {} (letvar1558917 "DomainDescription") (clojure.core/assoc :domain-description (deser-domain-description-type (clojure.core/get-in letvar1558917 ["DomainDescription"])))))))

(clojure.core/defn- response-mfa-method-not-found-exception ([input] (response-mfa-method-not-found-exception nil input)) ([resultWrapper1558919 input] (clojure.core/let [rawinput1558918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558920 {"message" (rawinput1558918 "message")}] (clojure.core/cond-> {} (letvar1558920 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558920 ["message"])))))))

(clojure.core/defn- response-unsupported-identity-provider-exception ([input] (response-unsupported-identity-provider-exception nil input)) ([resultWrapper1558922 input] (clojure.core/let [rawinput1558921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558923 {"message" (rawinput1558921 "message")}] (clojure.core/cond-> {} (letvar1558923 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558923 ["message"])))))))

(clojure.core/defn- response-admin-get-user-response ([input] (response-admin-get-user-response nil input)) ([resultWrapper1558925 input] (clojure.core/let [rawinput1558924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558926 {"Username" (rawinput1558924 "Username"), "MFAOptions" (rawinput1558924 "MFAOptions"), "Enabled" (rawinput1558924 "Enabled"), "UserCreateDate" (rawinput1558924 "UserCreateDate"), "PreferredMfaSetting" (rawinput1558924 "PreferredMfaSetting"), "UserMFASettingList" (rawinput1558924 "UserMFASettingList"), "UserAttributes" (rawinput1558924 "UserAttributes"), "UserLastModifiedDate" (rawinput1558924 "UserLastModifiedDate"), "UserStatus" (rawinput1558924 "UserStatus")}] (clojure.core/cond-> {:username (deser-username-type (clojure.core/get-in letvar1558926 ["Username"]))} (letvar1558926 "MFAOptions") (clojure.core/assoc :mfa-options (deser-mfa-option-list-type (clojure.core/get-in letvar1558926 ["MFAOptions"]))) (letvar1558926 "Enabled") (clojure.core/assoc :enabled (deser-boolean-type (clojure.core/get-in letvar1558926 ["Enabled"]))) (letvar1558926 "UserCreateDate") (clojure.core/assoc :user-create-date (deser-date-type (clojure.core/get-in letvar1558926 ["UserCreateDate"]))) (letvar1558926 "PreferredMfaSetting") (clojure.core/assoc :preferred-mfa-setting (deser-string-type (clojure.core/get-in letvar1558926 ["PreferredMfaSetting"]))) (letvar1558926 "UserMFASettingList") (clojure.core/assoc :user-mfa-setting-list (deser-user-mfa-setting-list-type (clojure.core/get-in letvar1558926 ["UserMFASettingList"]))) (letvar1558926 "UserAttributes") (clojure.core/assoc :user-attributes (deser-attribute-list-type (clojure.core/get-in letvar1558926 ["UserAttributes"]))) (letvar1558926 "UserLastModifiedDate") (clojure.core/assoc :user-last-modified-date (deser-date-type (clojure.core/get-in letvar1558926 ["UserLastModifiedDate"]))) (letvar1558926 "UserStatus") (clojure.core/assoc :user-status (deser-user-status-type (clojure.core/get-in letvar1558926 ["UserStatus"])))))))

(clojure.core/defn- response-get-identity-provider-by-identifier-response ([input] (response-get-identity-provider-by-identifier-response nil input)) ([resultWrapper1558928 input] (clojure.core/let [rawinput1558927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558929 {"IdentityProvider" (rawinput1558927 "IdentityProvider")}] (clojure.core/cond-> {:identity-provider (deser-identity-provider-type (clojure.core/get-in letvar1558929 ["IdentityProvider"]))}))))

(clojure.core/defn- response-user-import-in-progress-exception ([input] (response-user-import-in-progress-exception nil input)) ([resultWrapper1558931 input] (clojure.core/let [rawinput1558930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558932 {"message" (rawinput1558930 "message")}] (clojure.core/cond-> {} (letvar1558932 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558932 ["message"])))))))

(clojure.core/defn- response-alias-exists-exception ([input] (response-alias-exists-exception nil input)) ([resultWrapper1558934 input] (clojure.core/let [rawinput1558933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558935 {"message" (rawinput1558933 "message")}] (clojure.core/cond-> {} (letvar1558935 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558935 ["message"])))))))

(clojure.core/defn- response-get-ui-customization-response ([input] (response-get-ui-customization-response nil input)) ([resultWrapper1558937 input] (clojure.core/let [rawinput1558936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558938 {"UICustomization" (rawinput1558936 "UICustomization")}] (clojure.core/cond-> {:ui-customization (deser-ui-customization-type (clojure.core/get-in letvar1558938 ["UICustomization"]))}))))

(clojure.core/defn- response-too-many-failed-attempts-exception ([input] (response-too-many-failed-attempts-exception nil input)) ([resultWrapper1558940 input] (clojure.core/let [rawinput1558939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558941 {"message" (rawinput1558939 "message")}] (clojure.core/cond-> {} (letvar1558941 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558941 ["message"])))))))

(clojure.core/defn- response-admin-reset-user-password-response ([input] (response-admin-reset-user-password-response nil input)) ([resultWrapper1558943 input] (clojure.core/let [rawinput1558942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558944 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-precondition-not-met-exception ([input] (response-precondition-not-met-exception nil input)) ([resultWrapper1558946 input] (clojure.core/let [rawinput1558945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558947 {"message" (rawinput1558945 "message")}] (clojure.core/cond-> {} (letvar1558947 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558947 ["message"])))))))

(clojure.core/defn- response-user-lambda-validation-exception ([input] (response-user-lambda-validation-exception nil input)) ([resultWrapper1558949 input] (clojure.core/let [rawinput1558948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558950 {"message" (rawinput1558948 "message")}] (clojure.core/cond-> {} (letvar1558950 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558950 ["message"])))))))

(clojure.core/defn- response-user-not-confirmed-exception ([input] (response-user-not-confirmed-exception nil input)) ([resultWrapper1558952 input] (clojure.core/let [rawinput1558951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558953 {"message" (rawinput1558951 "message")}] (clojure.core/cond-> {} (letvar1558953 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558953 ["message"])))))))

(clojure.core/defn- response-create-group-response ([input] (response-create-group-response nil input)) ([resultWrapper1558955 input] (clojure.core/let [rawinput1558954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558956 {"Group" (rawinput1558954 "Group")}] (clojure.core/cond-> {} (letvar1558956 "Group") (clojure.core/assoc :group (deser-group-type (clojure.core/get-in letvar1558956 ["Group"])))))))

(clojure.core/defn- response-update-user-attributes-response ([input] (response-update-user-attributes-response nil input)) ([resultWrapper1558958 input] (clojure.core/let [rawinput1558957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558959 {"CodeDeliveryDetailsList" (rawinput1558957 "CodeDeliveryDetailsList")}] (clojure.core/cond-> {} (letvar1558959 "CodeDeliveryDetailsList") (clojure.core/assoc :code-delivery-details-list (deser-code-delivery-details-list-type (clojure.core/get-in letvar1558959 ["CodeDeliveryDetailsList"])))))))

(clojure.core/defn- response-admin-set-user-settings-response ([input] (response-admin-set-user-settings-response nil input)) ([resultWrapper1558961 input] (clojure.core/let [rawinput1558960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558962 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-csv-header-response ([input] (response-get-csv-header-response nil input)) ([resultWrapper1558964 input] (clojure.core/let [rawinput1558963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558965 {"UserPoolId" (rawinput1558963 "UserPoolId"), "CSVHeader" (rawinput1558963 "CSVHeader")}] (clojure.core/cond-> {} (letvar1558965 "UserPoolId") (clojure.core/assoc :user-pool-id (deser-user-pool-id-type (clojure.core/get-in letvar1558965 ["UserPoolId"]))) (letvar1558965 "CSVHeader") (clojure.core/assoc :csv-header (deser-list-of-string-types (clojure.core/get-in letvar1558965 ["CSVHeader"])))))))

(clojure.core/defn- response-list-resource-servers-response ([input] (response-list-resource-servers-response nil input)) ([resultWrapper1558967 input] (clojure.core/let [rawinput1558966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558968 {"ResourceServers" (rawinput1558966 "ResourceServers"), "NextToken" (rawinput1558966 "NextToken")}] (clojure.core/cond-> {:resource-servers (deser-resource-servers-list-type (clojure.core/get-in letvar1558968 ["ResourceServers"]))} (letvar1558968 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key-type (clojure.core/get-in letvar1558968 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-pool-client-response ([input] (response-describe-user-pool-client-response nil input)) ([resultWrapper1558970 input] (clojure.core/let [rawinput1558969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558971 {"UserPoolClient" (rawinput1558969 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1558971 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1558971 ["UserPoolClient"])))))))

(clojure.core/defn- response-confirm-device-response ([input] (response-confirm-device-response nil input)) ([resultWrapper1558973 input] (clojure.core/let [rawinput1558972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558974 {"UserConfirmationNecessary" (rawinput1558972 "UserConfirmationNecessary")}] (clojure.core/cond-> {} (letvar1558974 "UserConfirmationNecessary") (clojure.core/assoc :user-confirmation-necessary (deser-boolean-type (clojure.core/get-in letvar1558974 ["UserConfirmationNecessary"])))))))

(clojure.core/defn- response-confirm-forgot-password-response ([input] (response-confirm-forgot-password-response nil input)) ([resultWrapper1558976 input] (clojure.core/let [rawinput1558975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558977 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-software-token-response ([input] (response-associate-software-token-response nil input)) ([resultWrapper1558979 input] (clojure.core/let [rawinput1558978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558980 {"SecretCode" (rawinput1558978 "SecretCode"), "Session" (rawinput1558978 "Session")}] (clojure.core/cond-> {} (letvar1558980 "SecretCode") (clojure.core/assoc :secret-code (deser-secret-code-type (clojure.core/get-in letvar1558980 ["SecretCode"]))) (letvar1558980 "Session") (clojure.core/assoc :session (deser-session-type (clojure.core/get-in letvar1558980 ["Session"])))))))

(clojure.core/defn- response-admin-disable-provider-for-user-response ([input] (response-admin-disable-provider-for-user-response nil input)) ([resultWrapper1558982 input] (clojure.core/let [rawinput1558981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558983 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-set-risk-configuration-response ([input] (response-set-risk-configuration-response nil input)) ([resultWrapper1558985 input] (clojure.core/let [rawinput1558984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558986 {"RiskConfiguration" (rawinput1558984 "RiskConfiguration")}] (clojure.core/cond-> {:risk-configuration (deser-risk-configuration-type (clojure.core/get-in letvar1558986 ["RiskConfiguration"]))}))))

(clojure.core/defn- response-admin-update-device-status-response ([input] (response-admin-update-device-status-response nil input)) ([resultWrapper1558988 input] (clojure.core/let [rawinput1558987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558989 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forgot-password-response ([input] (response-forgot-password-response nil input)) ([resultWrapper1558991 input] (clojure.core/let [rawinput1558990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558992 {"CodeDeliveryDetails" (rawinput1558990 "CodeDeliveryDetails")}] (clojure.core/cond-> {} (letvar1558992 "CodeDeliveryDetails") (clojure.core/assoc :code-delivery-details (deser-code-delivery-details-type (clojure.core/get-in letvar1558992 ["CodeDeliveryDetails"])))))))

(clojure.core/defn- response-set-user-mfa-preference-response ([input] (response-set-user-mfa-preference-response nil input)) ([resultWrapper1558994 input] (clojure.core/let [rawinput1558993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558995 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-o-auth-flow-exception ([input] (response-invalid-o-auth-flow-exception nil input)) ([resultWrapper1558997 input] (clojure.core/let [rawinput1558996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1558998 {"message" (rawinput1558996 "message")}] (clojure.core/cond-> {} (letvar1558998 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1558998 ["message"])))))))

(clojure.core/defn- response-confirm-sign-up-response ([input] (response-confirm-sign-up-response nil input)) ([resultWrapper1559000 input] (clojure.core/let [rawinput1558999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559001 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-user-global-sign-out-response ([input] (response-admin-user-global-sign-out-response nil input)) ([resultWrapper1559003 input] (clojure.core/let [rawinput1559002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559004 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1559006 input] (clojure.core/let [rawinput1559005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559007 {"message" (rawinput1559005 "message")}] (clojure.core/cond-> {} (letvar1559007 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1559007 ["message"])))))))

(clojure.core/defn- response-update-user-pool-client-response ([input] (response-update-user-pool-client-response nil input)) ([resultWrapper1559009 input] (clojure.core/let [rawinput1559008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559010 {"UserPoolClient" (rawinput1559008 "UserPoolClient")}] (clojure.core/cond-> {} (letvar1559010 "UserPoolClient") (clojure.core/assoc :user-pool-client (deser-user-pool-client-type (clojure.core/get-in letvar1559010 ["UserPoolClient"])))))))

(clojure.core/defn- response-describe-risk-configuration-response ([input] (response-describe-risk-configuration-response nil input)) ([resultWrapper1559012 input] (clojure.core/let [rawinput1559011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559013 {"RiskConfiguration" (rawinput1559011 "RiskConfiguration")}] (clojure.core/cond-> {:risk-configuration (deser-risk-configuration-type (clojure.core/get-in letvar1559013 ["RiskConfiguration"]))}))))

(clojure.core/defn- response-invalid-sms-role-trust-relationship-exception ([input] (response-invalid-sms-role-trust-relationship-exception nil input)) ([resultWrapper1559015 input] (clojure.core/let [rawinput1559014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559016 {"message" (rawinput1559014 "message")}] (clojure.core/cond-> {} (letvar1559016 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1559016 ["message"])))))))

(clojure.core/defn- response-describe-resource-server-response ([input] (response-describe-resource-server-response nil input)) ([resultWrapper1559018 input] (clojure.core/let [rawinput1559017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559019 {"ResourceServer" (rawinput1559017 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1559019 ["ResourceServer"]))}))))

(clojure.core/defn- response-software-token-mfa-not-found-exception ([input] (response-software-token-mfa-not-found-exception nil input)) ([resultWrapper1559021 input] (clojure.core/let [rawinput1559020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559022 {"message" (rawinput1559020 "message")}] (clojure.core/cond-> {} (letvar1559022 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1559022 ["message"])))))))

(clojure.core/defn- response-get-signing-certificate-response ([input] (response-get-signing-certificate-response nil input)) ([resultWrapper1559024 input] (clojure.core/let [rawinput1559023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559025 {"Certificate" (rawinput1559023 "Certificate")}] (clojure.core/cond-> {} (letvar1559025 "Certificate") (clojure.core/assoc :certificate (deser-string-type (clojure.core/get-in letvar1559025 ["Certificate"])))))))

(clojure.core/defn- response-admin-disable-user-response ([input] (response-admin-disable-user-response nil input)) ([resultWrapper1559027 input] (clojure.core/let [rawinput1559026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559028 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1559030 input] (clojure.core/let [rawinput1559029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559031 {"message" (rawinput1559029 "message")}] (clojure.core/cond-> {} (letvar1559031 "message") (clojure.core/assoc :message (deser-message-type (clojure.core/get-in letvar1559031 ["message"])))))))

(clojure.core/defn- response-describe-user-import-job-response ([input] (response-describe-user-import-job-response nil input)) ([resultWrapper1559033 input] (clojure.core/let [rawinput1559032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559034 {"UserImportJob" (rawinput1559032 "UserImportJob")}] (clojure.core/cond-> {} (letvar1559034 "UserImportJob") (clojure.core/assoc :user-import-job (deser-user-import-job-type (clojure.core/get-in letvar1559034 ["UserImportJob"])))))))

(clojure.core/defn- response-create-user-pool-response ([input] (response-create-user-pool-response nil input)) ([resultWrapper1559036 input] (clojure.core/let [rawinput1559035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559037 {"UserPool" (rawinput1559035 "UserPool")}] (clojure.core/cond-> {} (letvar1559037 "UserPool") (clojure.core/assoc :user-pool (deser-user-pool-type (clojure.core/get-in letvar1559037 ["UserPool"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1559039 input] (clojure.core/let [rawinput1559038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559040 {"Users" (rawinput1559038 "Users"), "PaginationToken" (rawinput1559038 "PaginationToken")}] (clojure.core/cond-> {} (letvar1559040 "Users") (clojure.core/assoc :users (deser-users-list-type (clojure.core/get-in letvar1559040 ["Users"]))) (letvar1559040 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1559040 ["PaginationToken"])))))))

(clojure.core/defn- response-update-resource-server-response ([input] (response-update-resource-server-response nil input)) ([resultWrapper1559042 input] (clojure.core/let [rawinput1559041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559043 {"ResourceServer" (rawinput1559041 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1559043 ["ResourceServer"]))}))))

(clojure.core/defn- response-admin-delete-user-attributes-response ([input] (response-admin-delete-user-attributes-response nil input)) ([resultWrapper1559045 input] (clojure.core/let [rawinput1559044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559046 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-resource-server-response ([input] (response-create-resource-server-response nil input)) ([resultWrapper1559048 input] (clojure.core/let [rawinput1559047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559049 {"ResourceServer" (rawinput1559047 "ResourceServer")}] (clojure.core/cond-> {:resource-server (deser-resource-server-type (clojure.core/get-in letvar1559049 ["ResourceServer"]))}))))

(clojure.core/defn- response-list-devices-response ([input] (response-list-devices-response nil input)) ([resultWrapper1559051 input] (clojure.core/let [rawinput1559050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559052 {"Devices" (rawinput1559050 "Devices"), "PaginationToken" (rawinput1559050 "PaginationToken")}] (clojure.core/cond-> {} (letvar1559052 "Devices") (clojure.core/assoc :devices (deser-device-list-type (clojure.core/get-in letvar1559052 ["Devices"]))) (letvar1559052 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1559052 ["PaginationToken"])))))))

(clojure.core/defn- response-get-user-response ([input] (response-get-user-response nil input)) ([resultWrapper1559054 input] (clojure.core/let [rawinput1559053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559055 {"Username" (rawinput1559053 "Username"), "UserAttributes" (rawinput1559053 "UserAttributes"), "MFAOptions" (rawinput1559053 "MFAOptions"), "PreferredMfaSetting" (rawinput1559053 "PreferredMfaSetting"), "UserMFASettingList" (rawinput1559053 "UserMFASettingList")}] (clojure.core/cond-> {:username (deser-username-type (clojure.core/get-in letvar1559055 ["Username"])), :user-attributes (deser-attribute-list-type (clojure.core/get-in letvar1559055 ["UserAttributes"]))} (letvar1559055 "MFAOptions") (clojure.core/assoc :mfa-options (deser-mfa-option-list-type (clojure.core/get-in letvar1559055 ["MFAOptions"]))) (letvar1559055 "PreferredMfaSetting") (clojure.core/assoc :preferred-mfa-setting (deser-string-type (clojure.core/get-in letvar1559055 ["PreferredMfaSetting"]))) (letvar1559055 "UserMFASettingList") (clojure.core/assoc :user-mfa-setting-list (deser-user-mfa-setting-list-type (clojure.core/get-in letvar1559055 ["UserMFASettingList"])))))))

(clojure.core/defn- response-admin-update-auth-event-feedback-response ([input] (response-admin-update-auth-event-feedback-response nil input)) ([resultWrapper1559057 input] (clojure.core/let [rawinput1559056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559058 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-admin-list-devices-response ([input] (response-admin-list-devices-response nil input)) ([resultWrapper1559060 input] (clojure.core/let [rawinput1559059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559061 {"Devices" (rawinput1559059 "Devices"), "PaginationToken" (rawinput1559059 "PaginationToken")}] (clojure.core/cond-> {} (letvar1559061 "Devices") (clojure.core/assoc :devices (deser-device-list-type (clojure.core/get-in letvar1559061 ["Devices"]))) (letvar1559061 "PaginationToken") (clojure.core/assoc :pagination-token (deser-search-pagination-token-type (clojure.core/get-in letvar1559061 ["PaginationToken"])))))))

(clojure.core/defn- response-describe-user-pool-response ([input] (response-describe-user-pool-response nil input)) ([resultWrapper1559063 input] (clojure.core/let [rawinput1559062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1559064 {"UserPool" (rawinput1559062 "UserPool")}] (clojure.core/cond-> {} (letvar1559064 "UserPool") (clojure.core/assoc :user-pool (deser-user-pool-type (clojure.core/get-in letvar1559064 ["UserPool"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/redirect-url-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/domain-version-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-pool-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/provider-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/event-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/arn-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:([\w+=/,.@-]*)?:[0-9]+:[\w+=/,.@-]+(:[\w+=/,.@-]+)?(:[\w+=/,.@-]+)?" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pagination-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/device-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-message-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20000)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*\{####\}[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/hex-string-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9a-fA-F]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-pool-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-identifier-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\x21\x23-\x5B\x5D-\x7E]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/provider-name-type-v-1 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^_][\p{L}\p{M}\p{S}\p{N}\p{P}][^_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-address-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+@[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/search-pagination-token-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-scope-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\x21\x23-\x2E\x30-\x5B\x5D-\x7E]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-permission-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-message-by-link-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20000)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*\{##[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*##\}[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/completion-message-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/token-model-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z0-9-_=.]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/username-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-notification-body-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20000)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s*]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/secret-code-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 16 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z0-9]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/group-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pagination-key-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-import-job-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-secret-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-import-job-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"import-[0-9a-zA-Z-]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/password-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-idp/date-type clojure.core/inst?)

(clojure.spec.alpha/def :portkey.aws.cognito-idp/sms-verification-message-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 140)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*\{####\}.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/secret-hash-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+=/]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/scope-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\x21\x23-\x5B\x5D-\x7E]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/resource-server-scope-description-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-mapping-key-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/user-filter-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/s-3-bucket-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-value-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/confirmation-code-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/attribute-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/description-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-subject-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 140)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-verification-subject-by-link-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 140)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w\s+=,.@-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/client-id-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/idp-identifier-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 40)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w\s+=.@-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/custom-attribute-name-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/pre-signed-url-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/session-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-idp/email-notification-subject-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 140)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}\s]+" s__1410940__auto__))))
...
(clojure.core/defn delete-group "Deletes a group. Currently only groups with no members can be deleted.\n Requires developer credentials." ([delete-group-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-group-request delete-group-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-group-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteGroup", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-user "Allows a user to delete himself or herself." ([delete-user-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-user-request delete-user-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-user-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteUser", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "PasswordResetRequiredException" :portkey.aws.cognito-idp/password-reset-required-exception, "UserNotFoundException" :portkey.aws.cognito-idp/user-not-found-exception, "UserNotConfirmedException" :portkey.aws.cognito-idp/user-not-confirmed-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-user-pool-client "Allows the developer to delete the user pool client." ([delete-user-pool-client-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-user-pool-client-request delete-user-pool-client-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-user-pool-client-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteUserPoolClient", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-user-pool "Deletes the specified Amazon Cognito user pool." ([delete-user-pool-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-user-pool-request delete-user-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-user-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteUserPool", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "UserImportInProgressException" :portkey.aws.cognito-idp/user-import-in-progress-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
...
(clojure.core/defn delete-identity-provider "Deletes an identity provider for a user pool." ([delete-identity-provider-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-identity-provider-request delete-identity-provider-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.cognito-idp/endpoints, :http.request.configuration/target-prefix "AWSCognitoIdentityProviderService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-04-18", :http.request.configuration/service-id "Cognito Identity Provider", :http.request.spec/input-spec :portkey.aws.cognito-idp/delete-identity-provider-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteIdentityProvider", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1411980__auto__] {}), :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.cognito-idp/invalid-parameter-exception, "UnsupportedIdentityProviderException" :portkey.aws.cognito-idp/unsupported-identity-provider-exception, "ResourceNotFoundException" :portkey.aws.cognito-idp/resource-not-found-exception, "NotAuthorizedException" :portkey.aws.cognito-idp/not-authorized-exception, "TooManyRequestsException" :portkey.aws.cognito-idp/too-many-requests-exception, "InternalErrorException" :portkey.aws.cognito-idp/internal-error-exception}})))))
