...
(clojure.core/defn- response-invoke-device-method-response ([input] (response-invoke-device-method-response nil input)) ([resultWrapper239777 input] (clojure.core/let [rawinput239776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239778 {"deviceMethodResponse" (rawinput239776 "deviceMethodResponse")}] (clojure.core/cond-> {} (letvar239778 "deviceMethodResponse") (clojure.core/assoc :device-method-response (deser-string (clojure.core/get-in letvar239778 ["deviceMethodResponse"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper239780 input] (clojure.core/let [rawinput239779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239781 {"code" (rawinput239779 "code"), "message" (rawinput239779 "message")}] (clojure.core/cond-> {} (letvar239781 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239781 ["code"]))) (letvar239781 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239781 ["message"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper239783 input] (clojure.core/let [rawinput239782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239784 {"code" (rawinput239782 "code"), "message" (rawinput239782 "message")}] (clojure.core/cond-> {} (letvar239784 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239784 ["code"]))) (letvar239784 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239784 ["message"])))))))

(clojure.core/defn- response-get-device-methods-response ([input] (response-get-device-methods-response nil input)) ([resultWrapper239786 input] (clojure.core/let [rawinput239785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239787 {"deviceMethods" (rawinput239785 "deviceMethods")}] (clojure.core/cond-> {} (letvar239787 "deviceMethods") (clojure.core/assoc :device-methods (deser-list-of-device-method (clojure.core/get-in letvar239787 ["deviceMethods"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper239789 input] (clojure.core/let [rawinput239788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239790 {"code" (rawinput239788 "code"), "message" (rawinput239788 "message")}] (clojure.core/cond-> {} (letvar239790 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239790 ["code"]))) (letvar239790 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239790 ["message"])))))))

(clojure.core/defn- response-initiate-device-claim-response ([input] (response-initiate-device-claim-response nil input)) ([resultWrapper239792 input] (clojure.core/let [rawinput239791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239793 {"state" (rawinput239791 "state")}] (clojure.core/cond-> {} (letvar239793 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar239793 ["state"])))))))

(clojure.core/defn- response-update-device-state-response ([input] (response-update-device-state-response nil input)) ([resultWrapper239795 input] (clojure.core/let [rawinput239794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239796 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper239798 input] (clojure.core/let [rawinput239797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239799 {"code" (rawinput239797 "code"), "message" (rawinput239797 "message")}] (clojure.core/cond-> {} (letvar239799 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239799 ["code"]))) (letvar239799 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239799 ["message"])))))))

(clojure.core/defn- response-describe-device-response ([input] (response-describe-device-response nil input)) ([resultWrapper239801 input] (clojure.core/let [rawinput239800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239802 {"deviceDescription" (rawinput239800 "deviceDescription")}] (clojure.core/cond-> {} (letvar239802 "deviceDescription") (clojure.core/assoc :device-description (deser-device-description (clojure.core/get-in letvar239802 ["deviceDescription"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper239804 input] (clojure.core/let [rawinput239803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239805 {"code" (rawinput239803 "code"), "message" (rawinput239803 "message")}] (clojure.core/cond-> {} (letvar239805 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239805 ["code"]))) (letvar239805 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239805 ["message"])))))))

(clojure.core/defn- response-claim-devices-by-claim-code-response ([input] (response-claim-devices-by-claim-code-response nil input)) ([resultWrapper239807 input] (clojure.core/let [rawinput239806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239808 {"claimCode" (rawinput239806 "claimCode"), "total" (rawinput239806 "total")}] (clojure.core/cond-> {} (letvar239808 "claimCode") (clojure.core/assoc :claim-code (deser-string-min-12-max-40 (clojure.core/get-in letvar239808 ["claimCode"]))) (letvar239808 "total") (clojure.core/assoc :total (deser-integer (clojure.core/get-in letvar239808 ["total"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper239810 input] (clojure.core/let [rawinput239809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239811 {"code" (rawinput239809 "code"), "message" (rawinput239809 "message")}] (clojure.core/cond-> {} (letvar239811 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239811 ["code"]))) (letvar239811 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239811 ["message"])))))))

(clojure.core/defn- response-list-device-events-response ([input] (response-list-device-events-response nil input)) ([resultWrapper239813 input] (clojure.core/let [rawinput239812 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239814 {"events" (rawinput239812 "events"), "nextToken" (rawinput239812 "nextToken")}] (clojure.core/cond-> {} (letvar239814 "events") (clojure.core/assoc :events (deser-list-of-device-event (clojure.core/get-in letvar239814 ["events"]))) (letvar239814 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar239814 ["nextToken"])))))))

(clojure.core/defn- response-range-not-satisfiable-exception ([input] (response-range-not-satisfiable-exception nil input)) ([resultWrapper239816 input] (clojure.core/let [rawinput239815 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239817 {"code" (rawinput239815 "code"), "message" (rawinput239815 "message")}] (clojure.core/cond-> {} (letvar239817 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar239817 ["code"]))) (letvar239817 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar239817 ["message"])))))))

(clojure.core/defn- response-unclaim-device-response ([input] (response-unclaim-device-response nil input)) ([resultWrapper239819 input] (clojure.core/let [rawinput239818 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239820 {"state" (rawinput239818 "state")}] (clojure.core/cond-> {} (letvar239820 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar239820 ["state"])))))))

(clojure.core/defn- response-finalize-device-claim-response ([input] (response-finalize-device-claim-response nil input)) ([resultWrapper239822 input] (clojure.core/let [rawinput239821 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239823 {"state" (rawinput239821 "state")}] (clojure.core/cond-> {} (letvar239823 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar239823 ["state"])))))))

(clojure.core/defn- response-list-devices-response ([input] (response-list-devices-response nil input)) ([resultWrapper239825 input] (clojure.core/let [rawinput239824 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239826 {"devices" (rawinput239824 "devices"), "nextToken" (rawinput239824 "nextToken")}] (clojure.core/cond-> {} (letvar239826 "devices") (clojure.core/assoc :devices (deser-list-of-device-description (clojure.core/get-in letvar239826 ["devices"]))) (letvar239826 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar239826 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-devices/string-min-12-max-40 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 12 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 40))))
