...
(clojure.core/defn- response-invoke-endpoint-output ([input] (response-invoke-endpoint-output nil input)) ([resultWrapper451944 input] (clojure.core/let [rawinput451943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451945 {"Body" (rawinput451943 "Body"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-Amzn-Invoked-Production-Variant" (clojure.core/get-in input [:headers "x-Amzn-Invoked-Production-Variant"]), "X-Amzn-SageMaker-Custom-Attributes" (clojure.core/get-in input [:headers "X-Amzn-SageMaker-Custom-Attributes"])}] (clojure.core/cond-> {:body (deser-body-blob (clojure.core/get-in letvar451945 ["Body"]))} (letvar451945 "Content-Type") (clojure.core/assoc :content-type (deser-header (clojure.core/get-in letvar451945 ["Content-Type"]))) (letvar451945 "x-Amzn-Invoked-Production-Variant") (clojure.core/assoc :invoked-production-variant (deser-header (clojure.core/get-in letvar451945 ["x-Amzn-Invoked-Production-Variant"]))) (letvar451945 "X-Amzn-SageMaker-Custom-Attributes") (clojure.core/assoc :custom-attributes (deser-custom-attributes-header (clojure.core/get-in letvar451945 ["X-Amzn-SageMaker-Custom-Attributes"])))))))

(clojure.core/defn- response-validation-error ([input] (response-validation-error nil input)) ([resultWrapper451947 input] (clojure.core/let [rawinput451946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451948 {"Message" (rawinput451946 "Message")}] (clojure.core/cond-> {} (letvar451948 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar451948 ["Message"])))))))

(clojure.core/defn- response-service-unavailable ([input] (response-service-unavailable nil input)) ([resultWrapper451950 input] (clojure.core/let [rawinput451949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451951 {"Message" (rawinput451949 "Message")}] (clojure.core/cond-> {} (letvar451951 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar451951 ["Message"])))))))

(clojure.core/defn- response-model-error ([input] (response-model-error nil input)) ([resultWrapper451953 input] (clojure.core/let [rawinput451952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451954 {"Message" (rawinput451952 "Message"), "OriginalStatusCode" (rawinput451952 "OriginalStatusCode"), "OriginalMessage" (rawinput451952 "OriginalMessage"), "LogStreamArn" (rawinput451952 "LogStreamArn")}] (clojure.core/cond-> {} (letvar451954 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar451954 ["Message"]))) (letvar451954 "OriginalStatusCode") (clojure.core/assoc :original-status-code (deser-status-code (clojure.core/get-in letvar451954 ["OriginalStatusCode"]))) (letvar451954 "OriginalMessage") (clojure.core/assoc :original-message (deser-message (clojure.core/get-in letvar451954 ["OriginalMessage"]))) (letvar451954 "LogStreamArn") (clojure.core/assoc :log-stream-arn (deser-log-stream-arn (clojure.core/get-in letvar451954 ["LogStreamArn"])))))))

(clojure.core/defn- response-internal-failure ([input] (response-internal-failure nil input)) ([resultWrapper451956 input] (clojure.core/let [rawinput451955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451957 {"Message" (rawinput451955 "Message")}] (clojure.core/cond-> {} (letvar451957 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar451957 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker/custom-attributes-header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker/header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker/endpoint-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 63)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
