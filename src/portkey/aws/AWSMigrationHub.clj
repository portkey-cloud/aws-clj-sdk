...
(clojure.core/defn- response-dry-run-operation ([input] (response-dry-run-operation nil input)) ([resultWrapper30291 input] (clojure.core/let [rawinput30290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30292 {"Message" (rawinput30290 "Message")}] (clojure.core/cond-> {} (letvar30292 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30292 ["Message"])))))))

(clojure.core/defn- response-describe-migration-task-result ([input] (response-describe-migration-task-result nil input)) ([resultWrapper30294 input] (clojure.core/let [rawinput30293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30295 {"MigrationTask" (rawinput30293 "MigrationTask")}] (clojure.core/cond-> {} (letvar30295 "MigrationTask") (clojure.core/assoc :migration-task (deser-migration-task (clojure.core/get-in letvar30295 ["MigrationTask"])))))))

(clojure.core/defn- response-list-migration-tasks-result ([input] (response-list-migration-tasks-result nil input)) ([resultWrapper30297 input] (clojure.core/let [rawinput30296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30298 {"NextToken" (rawinput30296 "NextToken"), "MigrationTaskSummaryList" (rawinput30296 "MigrationTaskSummaryList")}] (clojure.core/cond-> {} (letvar30298 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar30298 ["NextToken"]))) (letvar30298 "MigrationTaskSummaryList") (clojure.core/assoc :migration-task-summary-list (deser-migration-task-summary-list (clojure.core/get-in letvar30298 ["MigrationTaskSummaryList"])))))))

(clojure.core/defn- response-list-discovered-resources-result ([input] (response-list-discovered-resources-result nil input)) ([resultWrapper30300 input] (clojure.core/let [rawinput30299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30301 {"NextToken" (rawinput30299 "NextToken"), "DiscoveredResourceList" (rawinput30299 "DiscoveredResourceList")}] (clojure.core/cond-> {} (letvar30301 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar30301 ["NextToken"]))) (letvar30301 "DiscoveredResourceList") (clojure.core/assoc :discovered-resource-list (deser-discovered-resource-list (clojure.core/get-in letvar30301 ["DiscoveredResourceList"])))))))

(clojure.core/defn- response-notify-migration-task-state-result ([input] (response-notify-migration-task-state-result nil input)) ([resultWrapper30303 input] (clojure.core/let [rawinput30302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30304 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper30306 input] (clojure.core/let [rawinput30305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30307 {"Message" (rawinput30305 "Message")}] (clojure.core/cond-> {} (letvar30307 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30307 ["Message"])))))))

(clojure.core/defn- response-unauthorized-operation ([input] (response-unauthorized-operation nil input)) ([resultWrapper30309 input] (clojure.core/let [rawinput30308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30310 {"Message" (rawinput30308 "Message")}] (clojure.core/cond-> {} (letvar30310 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30310 ["Message"])))))))

(clojure.core/defn- response-put-resource-attributes-result ([input] (response-put-resource-attributes-result nil input)) ([resultWrapper30312 input] (clojure.core/let [rawinput30311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30313 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-created-artifact-result ([input] (response-disassociate-created-artifact-result nil input)) ([resultWrapper30315 input] (clojure.core/let [rawinput30314 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30316 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-progress-update-stream-result ([input] (response-delete-progress-update-stream-result nil input)) ([resultWrapper30318 input] (clojure.core/let [rawinput30317 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30319 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-policy-error-exception ([input] (response-policy-error-exception nil input)) ([resultWrapper30321 input] (clojure.core/let [rawinput30320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30322 {"Message" (rawinput30320 "Message")}] (clojure.core/cond-> {} (letvar30322 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30322 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper30324 input] (clojure.core/let [rawinput30323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30325 {"Message" (rawinput30323 "Message")}] (clojure.core/cond-> {} (letvar30325 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30325 ["Message"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper30327 input] (clojure.core/let [rawinput30326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30328 {"Message" (rawinput30326 "Message")}] (clojure.core/cond-> {} (letvar30328 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30328 ["Message"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper30330 input] (clojure.core/let [rawinput30329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30331 {"Message" (rawinput30329 "Message")}] (clojure.core/cond-> {} (letvar30331 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30331 ["Message"])))))))

(clojure.core/defn- response-notify-application-state-result ([input] (response-notify-application-state-result nil input)) ([resultWrapper30333 input] (clojure.core/let [rawinput30332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30334 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-created-artifact-result ([input] (response-associate-created-artifact-result nil input)) ([resultWrapper30336 input] (clojure.core/let [rawinput30335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30337 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-discovered-resource-result ([input] (response-disassociate-discovered-resource-result nil input)) ([resultWrapper30339 input] (clojure.core/let [rawinput30338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30340 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-progress-update-streams-result ([input] (response-list-progress-update-streams-result nil input)) ([resultWrapper30342 input] (clojure.core/let [rawinput30341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30343 {"ProgressUpdateStreamSummaryList" (rawinput30341 "ProgressUpdateStreamSummaryList"), "NextToken" (rawinput30341 "NextToken")}] (clojure.core/cond-> {} (letvar30343 "ProgressUpdateStreamSummaryList") (clojure.core/assoc :progress-update-stream-summary-list (deser-progress-update-stream-summary-list (clojure.core/get-in letvar30343 ["ProgressUpdateStreamSummaryList"]))) (letvar30343 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar30343 ["NextToken"])))))))

(clojure.core/defn- response-describe-application-state-result ([input] (response-describe-application-state-result nil input)) ([resultWrapper30345 input] (clojure.core/let [rawinput30344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30346 {"ApplicationStatus" (rawinput30344 "ApplicationStatus"), "LastUpdatedTime" (rawinput30344 "LastUpdatedTime")}] (clojure.core/cond-> {} (letvar30346 "ApplicationStatus") (clojure.core/assoc :application-status (deser-application-status (clojure.core/get-in letvar30346 ["ApplicationStatus"]))) (letvar30346 "LastUpdatedTime") (clojure.core/assoc :last-updated-time (deser-update-date-time (clojure.core/get-in letvar30346 ["LastUpdatedTime"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper30348 input] (clojure.core/let [rawinput30347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30349 {"Message" (rawinput30347 "Message")}] (clojure.core/cond-> {} (letvar30349 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar30349 ["Message"])))))))

(clojure.core/defn- response-import-migration-task-result ([input] (response-import-migration-task-result nil input)) ([resultWrapper30351 input] (clojure.core/let [rawinput30350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30352 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-discovered-resource-result ([input] (response-associate-discovered-resource-result nil input)) ([resultWrapper30354 input] (clojure.core/let [rawinput30353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30355 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-created-artifacts-result ([input] (response-list-created-artifacts-result nil input)) ([resultWrapper30357 input] (clojure.core/let [rawinput30356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30358 {"NextToken" (rawinput30356 "NextToken"), "CreatedArtifactList" (rawinput30356 "CreatedArtifactList")}] (clojure.core/cond-> {} (letvar30358 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar30358 ["NextToken"]))) (letvar30358 "CreatedArtifactList") (clojure.core/assoc :created-artifact-list (deser-created-artifact-list (clojure.core/get-in letvar30358 ["CreatedArtifactList"])))))))

(clojure.core/defn- response-create-progress-update-stream-result ([input] (response-create-progress-update-stream-result nil input)) ([resultWrapper30360 input] (clojure.core/let [rawinput30359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar30361 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/migration-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:|]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/dry-run clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/discovered-resource-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/created-artifact-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/configuration-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/status-detail (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/application-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/resource-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/progress-update-stream (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^/:|\000-\037]+" s__21078__auto__))))
