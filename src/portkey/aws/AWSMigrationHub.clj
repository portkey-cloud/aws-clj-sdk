...
(clojure.core/defn- deser-dry-run-operation [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-describe-migration-task-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "MigrationTask") (clojure.core/assoc :migration-task (deser-migration-task (input "MigrationTask")))))

(clojure.core/defn- deser-list-migration-tasks-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken"))) (clojure.core/contains? input "MigrationTaskSummaryList") (clojure.core/assoc :migration-task-summary-list (deser-migration-task-summary-list (input "MigrationTaskSummaryList")))))

(clojure.core/defn- deser-list-discovered-resources-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken"))) (clojure.core/contains? input "DiscoveredResourceList") (clojure.core/assoc :discovered-resource-list (deser-discovered-resource-list (input "DiscoveredResourceList")))))

(clojure.core/defn- deser-notify-migration-task-state-result [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-unauthorized-operation [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-put-resource-attributes-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-disassociate-created-artifact-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-progress-update-stream-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-policy-error-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))
...
(clojure.core/defn- deser-access-denied-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-notify-application-state-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-associate-created-artifact-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-disassociate-discovered-resource-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-progress-update-streams-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ProgressUpdateStreamSummaryList") (clojure.core/assoc :progress-update-stream-summary-list (deser-progress-update-stream-summary-list (input "ProgressUpdateStreamSummaryList"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-describe-application-state-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ApplicationStatus") (clojure.core/assoc :application-status (deser-application-status (input "ApplicationStatus"))) (clojure.core/contains? input "LastUpdatedTime") (clojure.core/assoc :last-updated-time (deser-update-date-time (input "LastUpdatedTime")))))
...
(clojure.core/defn- deser-import-migration-task-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-associate-discovered-resource-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-created-artifacts-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken"))) (clojure.core/contains? input "CreatedArtifactList") (clojure.core/assoc :created-artifact-list (deser-created-artifact-list (input "CreatedArtifactList")))))

(clojure.core/defn- deser-create-progress-update-stream-result [input] (clojure.core/cond-> {}))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/created-artifact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1600)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:[a-z-]+:[a-z0-9-]+:(?:[a-z0-9-]+|):(?:[0-9]{12}|):.*" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/migration-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[^:|]+" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/dry-run clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/discovered-resource-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/created-artifact-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/configuration-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/status-detail (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/application-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/resource-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub/progress-update-stream (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 50)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[^/:|\000-\037]+" s__27881__auto__))))
