...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-update-object-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-object-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-object-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-rule-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-rule-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-to-index-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.attach-to-index-request/DirectoryArn :portkey.aws.clouddirectory.attach-to-index-request/IndexReference :portkey.aws.clouddirectory.attach-to-index-request/TargetReference] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 64)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-directory-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.create-directory-request/Name :portkey.aws.clouddirectory.create-directory-request/SchemaArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-write-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-write-exception/Index :portkey.aws.clouddirectory.batch-write-exception/Type :portkey.aws.clouddirectory.batch-write-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-incoming-typed-links-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-incoming-typed-links-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory.list-incoming-typed-links-request/FilterAttributeRanges :portkey.aws.clouddirectory.list-incoming-typed-links-request/FilterTypedLink :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-incoming-typed-links-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-children-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-object-children-response/Children :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/policy-attachment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.policy-attachment/PolicyId :portkey.aws.clouddirectory/ObjectIdentifier :portkey.aws.clouddirectory/PolicyType]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-parents-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-object-parents-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-object-parents-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-not-detached-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.object-not-detached-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-typed-link-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/TypedLinkSpecifier]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/put-schema-from-json-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/Arn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-facet (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.schema-facet/SchemaArn :portkey.aws.clouddirectory/FacetName]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-index-response/IndexAttachments :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-attached-indices-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-attached-indices-response/IndexAttachments :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-attributes (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-object-attributes/MaxResults :portkey.aws.clouddirectory.batch-list-object-attributes/FacetFilter]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.facet-attribute/Name] :opt-un [:portkey.aws.clouddirectory.facet-attribute/AttributeDefinition :portkey.aws.clouddirectory.facet-attribute/AttributeReference :portkey.aws.clouddirectory.facet-attribute/RequiredBehavior]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-attribute-update (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.object-attribute-update/ObjectAttributeKey :portkey.aws.clouddirectory/ObjectAttributeAction]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-facet-update-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-facet-update-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-from-index-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.detach-from-index-request/DirectoryArn :portkey.aws.clouddirectory.detach-from-index-request/IndexReference :portkey.aws.clouddirectory.detach-from-index-request/TargetReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-definition (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.facet-attribute-definition/Type] :opt-un [:portkey.aws.clouddirectory.facet-attribute-definition/DefaultValue :portkey.aws.clouddirectory.facet-attribute-definition/IsImmutable :portkey.aws.clouddirectory.facet-attribute-definition/Rules]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/validation-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.validation-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-index-response/IndexAttachments :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-object-information-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.get-object-information-response/SchemaFacets :portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-parents-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-object-parents-response/Parents :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-directory-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-directory-request/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-tags-for-resource-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-tags-for-resource-response/Tags :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-facet-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-facet-request/SchemaArn :portkey.aws.clouddirectory.get-facet-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-policies-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-object-policies-response/AttachedPolicyIds :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-attribute-range (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/AttributeKey :portkey.aws.clouddirectory.object-attribute-range/Range]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-attribute-action (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.object-attribute-action/ObjectAttributeActionType :portkey.aws.clouddirectory.object-attribute-action/ObjectAttributeUpdateValue]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-not-enabled-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.directory-not-enabled-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-children-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-object-children-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-object-children-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-typed-link-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-typed-link-facet-names-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-typed-link-facet-names-response/FacetNames :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 64)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/required-attribute-behavior (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"REQUIRED_ALWAYS" "REQUIRED_ALWAYS", :required-always "REQUIRED_ALWAYS", "NOT_REQUIRED" "NOT_REQUIRED", :not-required "NOT_REQUIRED"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/unsupported-index-type-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.unsupported-index-type-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-add-facet-to-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/SchemaFacet :portkey.aws.clouddirectory.batch-add-facet-to-object/ObjectAttributeList :portkey.aws.clouddirectory/ObjectReference] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-facet-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/Facet]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-attributes-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-object-attributes-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-object-attributes-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel :portkey.aws.clouddirectory.list-object-attributes-request/FacetFilter]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-tags-for-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-tags-for-resource-request/ResourceArn] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-tags-for-resource-request/MaxResults]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/publish-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.publish-schema-response/PublishedSchemaArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-policy-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.attach-policy-request/PolicyReference :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory.attach-policy-request/DirectoryArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-update-object-attributes (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference :portkey.aws.clouddirectory.batch-update-object-attributes/AttributeUpdates] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-directory-response (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-directory-response/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.update-schema-request/SchemaArn :portkey.aws.clouddirectory.update-schema-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.create-schema-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-policies (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-object-policies/MaxResults]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-remove-facet-from-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/SchemaFacet :portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-read-exception/Type :portkey.aws.clouddirectory.batch-read-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-outgoing-typed-links-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-outgoing-typed-links-response/TypedLinkSpecifiers :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-typed-link (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-attach-typed-link/SourceObjectReference :portkey.aws.clouddirectory.batch-attach-typed-link/TargetObjectReference :portkey.aws.clouddirectory.batch-attach-typed-link/TypedLinkFacet :portkey.aws.clouddirectory.batch-attach-typed-link/Attributes] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-read-request/DirectoryArn :portkey.aws.clouddirectory.batch-read-request/Operations] :opt-un [:portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/enable-directory-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.enable-directory-request/DirectoryArn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-parent-paths-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/PathToObjectIdentifiersList :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-object-attributes-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.update-object-attributes-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference :portkey.aws.clouddirectory.update-object-attributes-request/AttributeUpdates] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-get-object-information (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-delete-object-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-to-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.attach-to-index-response/AttachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-schema-doc-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-schema-doc-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/tag-key (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-action-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"CREATE_OR_UPDATE" "CREATE_OR_UPDATE", :create-or-update "CREATE_OR_UPDATE", "DELETE" "DELETE", :delete "DELETE"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:binary "BINARY", :number "NUMBER", "NUMBER" "NUMBER", :string "STRING", "STRING" "STRING", :datetime "DATETIME", "DATETIME" "DATETIME", :boolean "BOOLEAN", "BOOLEAN" "BOOLEAN", "BINARY" "BINARY"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-children (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-object-children/MaxResults]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-typed-link-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/TypedLinkSpecifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/link-name-already-in-use-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.link-name-already-in-use-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/limit-exceeded-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.limit-exceeded-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-in-use-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet-in-use-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-parent-paths-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/PathToObjectIdentifiersList :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-policy (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-attach-policy/PolicyReference :portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-tagging-request-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-tagging-request-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/selector-object-reference (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-from-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.detach-from-index-response/DetachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-typed-link-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-to-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-attach-to-index-response/AttachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-write-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-write-response/Responses]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-not-disabled-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.directory-not-disabled-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/remove-facet-from-object-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.remove-facet-from-object-request/DirectoryArn :portkey.aws.clouddirectory/SchemaFacet :portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-parent-paths (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-object-parent-paths/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-object-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.detach-object-request/DirectoryArn :portkey.aws.clouddirectory.detach-object-request/ParentReference :portkey.aws.clouddirectory/LinkName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-development-schema-arns-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-development-schema-arns-response/SchemaArns :portkey.aws.clouddirectory/NextToken]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/next-token (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/tag-resource-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-outgoing-typed-links (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory.batch-list-outgoing-typed-links/FilterAttributeRanges :portkey.aws.clouddirectory.batch-list-outgoing-typed-links/FilterTypedLink :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-outgoing-typed-links/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-incoming-typed-links (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory.batch-list-incoming-typed-links/FilterAttributeRanges :portkey.aws.clouddirectory.batch-list-incoming-typed-links/FilterTypedLink :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-incoming-typed-links/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-attribute-range (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.typed-link-attribute-range/Range] :opt-un [:portkey.aws.clouddirectory/AttributeName]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-next-token-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-next-token-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.update-schema-response/SchemaArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-outgoing-typed-links-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-outgoing-typed-links-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory.list-outgoing-typed-links-request/FilterAttributeRanges :portkey.aws.clouddirectory.list-outgoing-typed-links-request/FilterTypedLink :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-outgoing-typed-links-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-deleted-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.directory-deleted-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.directory/Name :portkey.aws.clouddirectory/DirectoryArn :portkey.aws.clouddirectory.directory/State :portkey.aws.clouddirectory.directory/CreationDateTime]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-facet-names-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-facet-names-request/SchemaArn] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-facet-names-request/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-directories-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-directories-request/MaxResults :portkey.aws.clouddirectory.list-directories-request/state]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/policy-to-path (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.policy-to-path/Path :portkey.aws.clouddirectory.policy-to-path/Policies]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-object-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.detach-object-response/DetachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-facet (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.typed-link-facet/Name :portkey.aws.clouddirectory.typed-link-facet/Attributes :portkey.aws.clouddirectory.typed-link-facet/IdentityAttributeOrder] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-arn-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-arn-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-not-found-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet-not-found-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/not-policy-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.not-policy-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/tag-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.tag-resource-request/ResourceArn :portkey.aws.clouddirectory.tag-resource-request/Tags] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-object-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.attach-object-response/AttachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-object-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-attach-object-response/attachedObjectIdentifier]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/range-mode (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:exclusive "EXCLUSIVE", "LAST" "LAST", :inclusive "INCLUSIVE", :last-before-missing-values "LAST_BEFORE_MISSING_VALUES", "EXCLUSIVE" "EXCLUSIVE", :first "FIRST", "INCLUSIVE" "INCLUSIVE", :last "LAST", "FIRST" "FIRST", "LAST_BEFORE_MISSING_VALUES" "LAST_BEFORE_MISSING_VALUES"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/cannot-list-parent-of-root-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.cannot-list-parent-of-root-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-facet-names-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-facet-names-response/FacetNames :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-children-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-object-children-response/Children :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-policies-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-object-policies-response/AttachedPolicyIds :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-attached-indices-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-attached-indices-request/DirectoryArn :portkey.aws.clouddirectory.list-attached-indices-request/TargetReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-attached-indices-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-policy-attachments-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-policy-attachments-response/ObjectIdentifiers :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-add-facet-to-object-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.create-schema-response/SchemaArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/apply-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.apply-schema-response/AppliedSchemaArn :portkey.aws.clouddirectory.apply-schema-response/DirectoryArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/resource-not-found-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.resource-not-found-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-typed-link (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/TypedLinkSpecifier] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/lookup-policy-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.lookup-policy-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.lookup-policy-request/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-schema-as-json-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-schema-as-json-request/SchemaArn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-policy-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-policies-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-object-policies-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-object-policies-request/MaxResults :portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-already-exists-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.schema-already-exists-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-validation-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet-validation-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-already-published-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.schema-already-published-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-name-and-value (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/AttributeName :portkey.aws.clouddirectory.attribute-name-and-value/Value] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-policy-attachments (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-list-policy-attachments/PolicyReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-policy-attachments/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet/Name :portkey.aws.clouddirectory/ObjectType]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-typed-link-facet-information-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-typed-link-facet-information-request/SchemaArn :portkey.aws.clouddirectory.get-typed-link-facet-information-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-incoming-typed-links-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-incoming-typed-links-response/LinkSpecifiers :portkey.aws.clouddirectory/NextToken]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/exception-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-directory-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-reference (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.object-reference/Selector]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-key (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.attribute-key/SchemaArn :portkey.aws.clouddirectory/FacetName :portkey.aws.clouddirectory.attribute-key/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-to-index (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-attach-to-index/IndexReference :portkey.aws.clouddirectory.batch-attach-to-index/TargetReference] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-typed-link-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/put-schema-from-json-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.put-schema-from-json-request/SchemaArn :portkey.aws.clouddirectory.put-schema-from-json-request/Document] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-typed-link-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/access-denied-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.access-denied-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-attached-indices-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-attached-indices-response/IndexAttachments :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-development-schema-arns-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-development-schema-arns-request/MaxResults]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/remove-facet-from-object-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/publish-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.publish-schema-request/DevelopmentSchemaArn :portkey.aws.clouddirectory/Version] :opt-un [:portkey.aws.clouddirectory.publish-schema-request/Name]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-create-object-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-from-index (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-detach-from-index/IndexReference :portkey.aws.clouddirectory.batch-detach-from-index/TargetReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-from-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-detach-from-index-response/DetachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-facet-attribute-update (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.typed-link-facet-attribute-update/Attribute :portkey.aws.clouddirectory.typed-link-facet-attribute-update/Action] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.delete-schema-response/SchemaArn]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/create-typed-link-facet-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.create-typed-link-facet-request/SchemaArn :portkey.aws.clouddirectory.create-typed-link-facet-request/Facet] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-remove-facet-from-object-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-policy-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-incoming-typed-links-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-incoming-typed-links-response/LinkSpecifiers :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-update (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet-attribute-update/Attribute :portkey.aws.clouddirectory.facet-attribute-update/Action]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-facet-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-facet-attributes-response/Attributes :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/index-attachment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.index-attachment/IndexedAttributes :portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/not-index-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.not-index-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-schema-and-facet-name (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.typed-link-schema-and-facet-name/SchemaArn :portkey.aws.clouddirectory/TypedLinkName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-policy-attachments-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-policy-attachments-response/ObjectIdentifiers :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-write-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-write-request/DirectoryArn :portkey.aws.clouddirectory.batch-write-request/Operations] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/rule (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.rule/Type :portkey.aws.clouddirectory.rule/Parameters]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-attach-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-attach-object/ParentReference :portkey.aws.clouddirectory.batch-attach-object/ChildReference :portkey.aws.clouddirectory/LinkName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-delete-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/path-to-object-identifiers (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.path-to-object-identifiers/Path :portkey.aws.clouddirectory.path-to-object-identifiers/ObjectIdentifiers]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-create-index-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-lookup-policy (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-lookup-policy/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-schema-request/SchemaArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/apply-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.apply-schema-request/PublishedSchemaArn :portkey.aws.clouddirectory.apply-schema-request/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-object-information-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-object-information-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/ConsistencyLevel]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/not-node-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.not-node-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-typed-link-facet-information-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.get-typed-link-facet-information-response/IdentityAttributeOrder]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-typed-link-facet-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-typed-link-facet-request/SchemaArn :portkey.aws.clouddirectory.delete-typed-link-facet-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-create-index (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-create-index/OrderedIndexedAttributeList :portkey.aws.clouddirectory.batch-create-index/IsUnique] :opt-un [:portkey.aws.clouddirectory.batch-create-index/ParentReference :portkey.aws.clouddirectory/LinkName :portkey.aws.clouddirectory/BatchReferenceName]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-exception-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:cannot-list-parent-of-root-exception "CannotListParentOfRootException", :not-policy-exception "NotPolicyException", "ValidationException" "ValidationException", :internal-service-exception "InternalServiceException", :not-index-exception "NotIndexException", "DirectoryNotEnabledException" "DirectoryNotEnabledException", :resource-not-found-exception "ResourceNotFoundException", :limit-exceeded-exception "LimitExceededException", "LimitExceededException" "LimitExceededException", "InvalidNextTokenException" "InvalidNextTokenException", "InvalidArnException" "InvalidArnException", "NotPolicyException" "NotPolicyException", "CannotListParentOfRootException" "CannotListParentOfRootException", "ResourceNotFoundException" "ResourceNotFoundException", "FacetValidationException" "FacetValidationException", "AccessDeniedException" "AccessDeniedException", :validation-exception "ValidationException", "NotIndexException" "NotIndexException", :facet-validation-exception "FacetValidationException", "NotNodeException" "NotNodeException", :invalid-next-token-exception "InvalidNextTokenException", :directory-not-enabled-exception "DirectoryNotEnabledException", :access-denied-exception "AccessDeniedException", :not-node-exception "NotNodeException", "InternalServiceException" "InternalServiceException", :invalid-arn-exception "InvalidArnException"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/link-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 64)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"[^\/\[\]\(\):\{\}#@!?\s\\;]+" s__8151__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/number-results (clojure.spec.alpha/and clojure.core/int? (fn* [p1__8188__8189__auto__] (clojure.core/<= 1 p1__8188__8189__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-directories-response (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-directories-response/Directories] :opt-un [:portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/indexed-attribute-missing-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.indexed-attribute-missing-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/tags-number-results (clojure.spec.alpha/and clojure.core/int? (fn* [p1__8188__8189__auto__] (clojure.core/<= 50 p1__8188__8189__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-policy (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-detach-policy/PolicyReference :portkey.aws.clouddirectory/ObjectReference] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-state (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"ENABLED" "ENABLED", :enabled "ENABLED", "DISABLED" "DISABLED", :disabled "DISABLED", "DELETED" "DELETED", :deleted "DELETED"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/rule-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 64)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"NODE" "NODE", :node "NODE", "LEAF_NODE" "LEAF_NODE", :leaf-node "LEAF_NODE", "POLICY" "POLICY", :policy "POLICY", "INDEX" "INDEX", :index "INDEX"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/retryable-conflict-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.retryable-conflict-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/consistency-level (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"SERIALIZABLE" "SERIALIZABLE", :serializable "SERIALIZABLE", "EVENTUAL" "EVENTUAL", :eventual "EVENTUAL"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 64)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-policy-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.detach-policy-request/DirectoryArn :portkey.aws.clouddirectory.detach-policy-request/PolicyReference :portkey.aws.clouddirectory/ObjectReference] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/tag (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.tag/Key :portkey.aws.clouddirectory.tag/Value]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 10)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-create-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-create-object/SchemaFacet :portkey.aws.clouddirectory.batch-create-object/ObjectAttributeList :portkey.aws.clouddirectory.batch-create-object/ParentReference :portkey.aws.clouddirectory/LinkName :portkey.aws.clouddirectory/BatchReferenceName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-typed-link-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.detach-typed-link-request/DirectoryArn :portkey.aws.clouddirectory/TypedLinkSpecifier] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-already-exists-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.directory-already-exists-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/disable-directory-response (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.disable-directory-response/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/invalid-attachment-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.invalid-attachment-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-already-detached-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.object-already-detached-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/disable-directory-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.disable-directory-request/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-read-response/Responses]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-detach-object/ParentReference :portkey.aws.clouddirectory/LinkName :portkey.aws.clouddirectory/BatchReferenceName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-operation-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-read-operation-response/SuccessfulResponse :portkey.aws.clouddirectory.batch-read-operation-response/ExceptionResponse]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 32)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-attribute-definition (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.typed-link-attribute-definition/Name :portkey.aws.clouddirectory.typed-link-attribute-definition/Type :portkey.aws.clouddirectory.typed-link-attribute-definition/RequiredBehavior] :opt-un [:portkey.aws.clouddirectory.typed-link-attribute-definition/DefaultValue :portkey.aws.clouddirectory.typed-link-attribute-definition/IsImmutable :portkey.aws.clouddirectory.typed-link-attribute-definition/Rules]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-outgoing-typed-links-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-outgoing-typed-links-response/TypedLinkSpecifiers :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-object-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-detach-object-response/detachedObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-policy-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-key-and-value (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.attribute-key-and-value/Key :portkey.aws.clouddirectory.attribute-key-and-value/Value] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-applied-schema-arns-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-applied-schema-arns-response/SchemaArns :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-attached-indices (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-list-attached-indices/TargetReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.batch-list-attached-indices/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-list-object-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-list-object-attributes-response/Attributes :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/still-contains-links-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.still-contains-links-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/policy-type (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/add-facet-to-object-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-object-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-already-exists-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.facet-already-exists-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-schema-as-json-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.get-schema-as-json-response/Name :portkey.aws.clouddirectory.get-schema-as-json-response/Document]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/internal-service-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.internal-service-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-get-object-information-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-get-object-information-response/SchemaFacets :portkey.aws.clouddirectory/ObjectIdentifier]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-typed-link-facet-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-typed-link-facet-attributes-response/Attributes :portkey.aws.clouddirectory/NextToken]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/untag-resource-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/delete-facet-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.delete-facet-request/SchemaArn :portkey.aws.clouddirectory.delete-facet-request/Name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-published-schema-arns-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-published-schema-arns-request/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-applied-schema-arns-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-applied-schema-arns-request/DirectoryArn] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-applied-schema-arns-request/MaxResults]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-object-parent-paths-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-object-parent-paths-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference] :opt-un [:portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-object-parent-paths-request/MaxResults]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/update-facet-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-reference (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.facet-attribute-reference/TargetFacetName :portkey.aws.clouddirectory.facet-attribute-reference/TargetAttributeName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/untag-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.untag-resource-request/ResourceArn :portkey.aws.clouddirectory.untag-resource-request/TagKeys] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-lookup-policy-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory/PolicyToPathList :portkey.aws.clouddirectory/NextToken]))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/detach-policy-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-published-schema-arns-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-published-schema-arns-response/SchemaArns :portkey.aws.clouddirectory/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/enable-directory-response (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.enable-directory-response/DirectoryArn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-directory-response (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/Directory] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/rule-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"BINARY_LENGTH" "BINARY_LENGTH", :binary-length "BINARY_LENGTH", "NUMBER_COMPARISON" "NUMBER_COMPARISON", :number-comparison "NUMBER_COMPARISON", "STRING_FROM_SET" "STRING_FROM_SET", :string-from-set "STRING_FROM_SET", "STRING_LENGTH" "STRING_LENGTH", :string-length "STRING_LENGTH"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.core/defn tag-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/tags/add" input__8278__auto__ :portkey.aws.clouddirectory/tag-resource-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/tag-resource-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidTaggingRequestException" :portkey.aws.clouddirectory/invalid-tagging-request-exception}))
...
(clojure.core/defn list-object-parent-paths [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/object/parentpaths" input__8278__auto__ :portkey.aws.clouddirectory/list-object-parent-paths-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-object-parent-paths-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn put-schema-from-json [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/json" input__8278__auto__ :portkey.aws.clouddirectory/put-schema-from-json-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/put-schema-from-json-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "InvalidSchemaDocException" :portkey.aws.clouddirectory/invalid-schema-doc-exception, "InvalidRuleException" :portkey.aws.clouddirectory/invalid-rule-exception}))
...
(clojure.core/defn create-object [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object" input__8278__auto__ :portkey.aws.clouddirectory/create-object-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/create-object-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "UnsupportedIndexTypeException" :portkey.aws.clouddirectory/unsupported-index-type-exception, "LinkNameAlreadyInUseException" :portkey.aws.clouddirectory/link-name-already-in-use-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn detach-policy [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/policy/detach" input__8278__auto__ :portkey.aws.clouddirectory/detach-policy-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/detach-policy-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "NotPolicyException" :portkey.aws.clouddirectory/not-policy-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn delete-directory [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/directory" input__8278__auto__ :portkey.aws.clouddirectory/delete-directory-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/delete-directory-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "DirectoryNotDisabledException" :portkey.aws.clouddirectory/directory-not-disabled-exception, "DirectoryDeletedException" :portkey.aws.clouddirectory/directory-deleted-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn list-incoming-typed-links [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/typedlink/incoming" input__8278__auto__ :portkey.aws.clouddirectory/list-incoming-typed-links-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-incoming-typed-links-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn list-development-schema-arns [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/schema/development" input__8278__auto__ :portkey.aws.clouddirectory/list-development-schema-arns-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-development-schema-arns-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception}))
(clojure.spec.alpha/fdef list-development-schema-arns :args (clojure.spec.alpha/tuple :portkey.aws.clouddirectory/list-development-schema-arns-request) :ret (clojure.spec.alpha/and :portkey.aws.clouddirectory/list-development-schema-arns-response))

(clojure.core/defn delete-schema [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema" input__8278__auto__ :portkey.aws.clouddirectory/delete-schema-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/delete-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "StillContainsLinksException" :portkey.aws.clouddirectory/still-contains-links-exception}))
...
(clojure.core/defn delete-typed-link-facet [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/typedlink/facet/delete" input__8278__auto__ :portkey.aws.clouddirectory/delete-typed-link-facet-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/delete-typed-link-facet-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception}))
...
(clojure.core/defn publish-schema [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/publish" input__8278__auto__ :portkey.aws.clouddirectory/publish-schema-request {:payload nil, :headers {"DevelopmentSchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/publish-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "SchemaAlreadyPublishedException" :portkey.aws.clouddirectory/schema-already-published-exception}))
...
(clojure.core/defn create-facet [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/facet/create" input__8278__auto__ :portkey.aws.clouddirectory/create-facet-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/create-facet-response {"InvalidRuleException" :portkey.aws.clouddirectory/invalid-rule-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "FacetAlreadyExistsException" :portkey.aws.clouddirectory/facet-already-exists-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn detach-object [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/detach" input__8278__auto__ :portkey.aws.clouddirectory/detach-object-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/detach-object-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception}))
...
(clojure.core/defn list-facet-names [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/facet/list" input__8278__auto__ :portkey.aws.clouddirectory/list-facet-names-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-facet-names-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception}))
...
(clojure.core/defn detach-from-index [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/index/detach" input__8278__auto__ :portkey.aws.clouddirectory/detach-from-index-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/detach-from-index-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "NotIndexException" :portkey.aws.clouddirectory/not-index-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ObjectAlreadyDetachedException" :portkey.aws.clouddirectory/object-already-detached-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn list-tags-for-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/tags" input__8278__auto__ :portkey.aws.clouddirectory/list-tags-for-resource-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-tags-for-resource-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidTaggingRequestException" :portkey.aws.clouddirectory/invalid-tagging-request-exception}))
...
(clojure.core/defn apply-schema [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/apply" input__8278__auto__ :portkey.aws.clouddirectory/apply-schema-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/apply-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidAttachmentException" :portkey.aws.clouddirectory/invalid-attachment-exception}))
...
(clojure.core/defn list-outgoing-typed-links [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/typedlink/outgoing" input__8278__auto__ :portkey.aws.clouddirectory/list-outgoing-typed-links-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-outgoing-typed-links-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn get-facet [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/facet" input__8278__auto__ :portkey.aws.clouddirectory/get-facet-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-facet-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception}))
...
(clojure.core/defn list-facet-attributes [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/facet/attributes" input__8278__auto__ :portkey.aws.clouddirectory/list-facet-attributes-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-facet-attributes-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn attach-to-index [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/index/attach" input__8278__auto__ :portkey.aws.clouddirectory/attach-to-index-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/attach-to-index-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LinkNameAlreadyInUseException" :portkey.aws.clouddirectory/link-name-already-in-use-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "NotIndexException" :portkey.aws.clouddirectory/not-index-exception, "IndexedAttributeMissingException" :portkey.aws.clouddirectory/indexed-attribute-missing-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn list-directories [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/directory/list" input__8278__auto__ :portkey.aws.clouddirectory/list-directories-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-directories-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception}))
(clojure.spec.alpha/fdef list-directories :args (clojure.spec.alpha/tuple :portkey.aws.clouddirectory/list-directories-request) :ret (clojure.spec.alpha/and :portkey.aws.clouddirectory/list-directories-response))

(clojure.core/defn list-object-attributes [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/object/attributes" input__8278__auto__ :portkey.aws.clouddirectory/list-object-attributes-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil], "ConsistencyLevel" ["x-amz-consistency-level" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-object-attributes-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn attach-typed-link [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/typedlink/attach" input__8278__auto__ :portkey.aws.clouddirectory/attach-typed-link-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/attach-typed-link-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InvalidAttachmentException" :portkey.aws.clouddirectory/invalid-attachment-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn detach-typed-link [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/typedlink/detach" input__8278__auto__ :portkey.aws.clouddirectory/detach-typed-link-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 nil {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
(clojure.spec.alpha/fdef detach-typed-link :args (clojure.spec.alpha/tuple :portkey.aws.clouddirectory/detach-typed-link-request))

(clojure.core/defn list-object-children [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/object/children" input__8278__auto__ :portkey.aws.clouddirectory/list-object-children-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil], "ConsistencyLevel" ["x-amz-consistency-level" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-object-children-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "NotNodeException" :portkey.aws.clouddirectory/not-node-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn add-facet-to-object [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/facets" input__8278__auto__ :portkey.aws.clouddirectory/add-facet-to-object-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/add-facet-to-object-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn create-schema [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/create" input__8278__auto__ :portkey.aws.clouddirectory/create-schema-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/create-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "SchemaAlreadyExistsException" :portkey.aws.clouddirectory/schema-already-exists-exception}))
...
(clojure.core/defn update-object-attributes [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/update" input__8278__auto__ :portkey.aws.clouddirectory/update-object-attributes-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/update-object-attributes-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn delete-object [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/delete" input__8278__auto__ :portkey.aws.clouddirectory/delete-object-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/delete-object-response {"ObjectNotDetachedException" :portkey.aws.clouddirectory/object-not-detached-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn update-schema [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/update" input__8278__auto__ :portkey.aws.clouddirectory/update-schema-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/update-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception}))
...
(clojure.core/defn untag-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/tags/remove" input__8278__auto__ :portkey.aws.clouddirectory/untag-resource-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/untag-resource-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidTaggingRequestException" :portkey.aws.clouddirectory/invalid-tagging-request-exception}))
...
(clojure.core/defn update-facet [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/facet" input__8278__auto__ :portkey.aws.clouddirectory/update-facet-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/update-facet-response {"InvalidRuleException" :portkey.aws.clouddirectory/invalid-rule-exception, "InvalidFacetUpdateException" :portkey.aws.clouddirectory/invalid-facet-update-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn list-applied-schema-arns [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/schema/applied" input__8278__auto__ :portkey.aws.clouddirectory/list-applied-schema-arns-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-applied-schema-arns-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception}))
...
(clojure.core/defn create-directory [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/directory/create" input__8278__auto__ :portkey.aws.clouddirectory/create-directory-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/create-directory-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "DirectoryAlreadyExistsException" :portkey.aws.clouddirectory/directory-already-exists-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception}))
...
(clojure.core/defn get-schema-as-json [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/schema/json" input__8278__auto__ :portkey.aws.clouddirectory/get-schema-as-json-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-schema-as-json-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception}))
...
(clojure.core/defn attach-policy [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/policy/attach" input__8278__auto__ :portkey.aws.clouddirectory/attach-policy-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/attach-policy-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "NotPolicyException" :portkey.aws.clouddirectory/not-policy-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn get-typed-link-facet-information [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/typedlink/facet/get" input__8278__auto__ :portkey.aws.clouddirectory/get-typed-link-facet-information-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-typed-link-facet-information-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn lookup-policy [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/policy/lookup" input__8278__auto__ :portkey.aws.clouddirectory/lookup-policy-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/lookup-policy-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn get-directory [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/directory/get" input__8278__auto__ :portkey.aws.clouddirectory/get-directory-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-directory-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception}))
...
(clojure.core/defn list-published-schema-arns [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/schema/published" input__8278__auto__ :portkey.aws.clouddirectory/list-published-schema-arns-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-published-schema-arns-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception}))
(clojure.spec.alpha/fdef list-published-schema-arns :args (clojure.spec.alpha/tuple :portkey.aws.clouddirectory/list-published-schema-arns-request) :ret (clojure.spec.alpha/and :portkey.aws.clouddirectory/list-published-schema-arns-response))

(clojure.core/defn list-typed-link-facet-attributes [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/typedlink/facet/attributes" input__8278__auto__ :portkey.aws.clouddirectory/list-typed-link-facet-attributes-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/list-typed-link-facet-attributes-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidNextTokenException" :portkey.aws.clouddirectory/invalid-next-token-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn enable-directory [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/directory/enable" input__8278__auto__ :portkey.aws.clouddirectory/enable-directory-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/enable-directory-response {"ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "DirectoryDeletedException" :portkey.aws.clouddirectory/directory-deleted-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception}))
...
(clojure.core/defn delete-facet [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/facet/delete" input__8278__auto__ :portkey.aws.clouddirectory/delete-facet-request {:payload nil, :headers {"SchemaArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/delete-facet-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "FacetInUseException" :portkey.aws.clouddirectory/facet-in-use-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "FacetNotFoundException" :portkey.aws.clouddirectory/facet-not-found-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
...
(clojure.core/defn remove-facet-from-object [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/facets/delete" input__8278__auto__ :portkey.aws.clouddirectory/remove-facet-from-object-request {:payload nil, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/remove-facet-from-object-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception}))
