...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-get-object-attributes (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory/ObjectReference :portkey.aws.clouddirectory/SchemaFacet :portkey.aws.clouddirectory.batch-get-object-attributes/AttributeNames] :opt-un [] :locations {}))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-successful-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-read-successful-response/ListObjectPolicies :portkey.aws.clouddirectory.batch-read-successful-response/ListObjectParentPaths :portkey.aws.clouddirectory.batch-read-successful-response/ListIncomingTypedLinks :portkey.aws.clouddirectory.batch-read-successful-response/GetObjectAttributes :portkey.aws.clouddirectory.batch-read-successful-response/GetObjectInformation :portkey.aws.clouddirectory.batch-read-successful-response/ListPolicyAttachments :portkey.aws.clouddirectory.batch-read-successful-response/ListOutgoingTypedLinks :portkey.aws.clouddirectory.batch-read-successful-response/ListObjectAttributes :portkey.aws.clouddirectory.batch-read-successful-response/ListIndex :portkey.aws.clouddirectory.batch-read-successful-response/ListObjectChildren :portkey.aws.clouddirectory.batch-read-successful-response/ListAttachedIndices :portkey.aws.clouddirectory.batch-read-successful-response/LookupPolicy] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/facet-attribute) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-operation (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-read-operation/ListObjectPolicies :portkey.aws.clouddirectory.batch-read-operation/ListObjectParentPaths :portkey.aws.clouddirectory.batch-read-operation/ListIncomingTypedLinks :portkey.aws.clouddirectory.batch-read-operation/GetObjectAttributes :portkey.aws.clouddirectory.batch-read-operation/GetObjectInformation :portkey.aws.clouddirectory.batch-read-operation/ListPolicyAttachments :portkey.aws.clouddirectory.batch-read-operation/ListOutgoingTypedLinks :portkey.aws.clouddirectory.batch-read-operation/ListObjectAttributes :portkey.aws.clouddirectory.batch-read-operation/ListIndex :portkey.aws.clouddirectory.batch-read-operation/ListObjectChildren :portkey.aws.clouddirectory.batch-read-operation/ListAttachedIndices :portkey.aws.clouddirectory.batch-read-operation/LookupPolicy] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-attribute-range-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/typed-link-attribute-range) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/required-attribute-behavior (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"REQUIRED_ALWAYS" "REQUIRED_ALWAYS", :required-always "REQUIRED_ALWAYS", "NOT_REQUIRED" "NOT_REQUIRED", :not-required "NOT_REQUIRED"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-object-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.get-object-attributes-response/Attributes] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attach-policy-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.attach-policy-request/DirectoryArn :portkey.aws.clouddirectory.attach-policy-request/PolicyReference :portkey.aws.clouddirectory/ObjectReference] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-write-operation-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/batch-write-operation) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-attribute-definition-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/typed-link-attribute-definition) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/policy-attachment-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/policy-attachment) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-key-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/attribute-key) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-name-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/typed-link-name) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-operation-response-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/batch-read-operation-response) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/upgrade-published-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.upgrade-published-schema-response/UpgradedSchemaArn] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/arns (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/arn) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-applied-schema-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.get-applied-schema-version-response/AppliedSchemaArn] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-key-and-value-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/attribute-key-and-value) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-get-object-attributes-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.batch-get-object-attributes-response/Attributes] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-attribute-range-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/object-attribute-range) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/typed-link-specifier-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/typed-link-specifier) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/tag-key-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/tag-key) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-applied-schema-version-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-applied-schema-version-request/SchemaArn] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-operation-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/batch-read-operation) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/path-to-object-identifiers-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/path-to-object-identifiers) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-attribute-update-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/object-attribute-update) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-name-and-value-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/attribute-name-and-value) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-attribute-update-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/facet-attribute-update) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/attribute-name-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/attribute-name) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/upgrade-applied-schema-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.upgrade-applied-schema-response/UpgradedSchemaArn :portkey.aws.clouddirectory.upgrade-applied-schema-response/DirectoryArn] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/publish-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.publish-schema-request/DevelopmentSchemaArn :portkey.aws.clouddirectory/Version] :opt-un [:portkey.aws.clouddirectory.publish-schema-request/MinorVersion :portkey.aws.clouddirectory.publish-schema-request/Name] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/policy-to-path-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/policy-to-path) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/directory) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-read-exception-type (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {:cannot-list-parent-of-root-exception "CannotListParentOfRootException", :not-policy-exception "NotPolicyException", "ValidationException" "ValidationException", :internal-service-exception "InternalServiceException", :not-index-exception "NotIndexException", "DirectoryNotEnabledException" "DirectoryNotEnabledException", :resource-not-found-exception "ResourceNotFoundException", :limit-exceeded-exception "LimitExceededException", "LimitExceededException" "LimitExceededException", "InvalidNextTokenException" "InvalidNextTokenException", "InvalidArnException" "InvalidArnException", "NotPolicyException" "NotPolicyException", "CannotListParentOfRootException" "CannotListParentOfRootException", "ResourceNotFoundException" "ResourceNotFoundException", "FacetValidationException" "FacetValidationException", "AccessDeniedException" "AccessDeniedException", :validation-exception "ValidationException", "NotIndexException" "NotIndexException", :facet-validation-exception "FacetValidationException", "NotNodeException" "NotNodeException", :invalid-next-token-exception "InvalidNextTokenException", :directory-not-enabled-exception "DirectoryNotEnabledException", :access-denied-exception "AccessDeniedException", :not-node-exception "NotNodeException", "InternalServiceException" "InternalServiceException", :invalid-arn-exception "InvalidArnException"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/link-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[^\/\[\]\(\):\{\}#@!?\s\\;]+" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/number-results (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30692__30693__auto__] (clojure.core/<= 1 p1__30692__30693__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/tags-number-results (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30692__30693__auto__] (clojure.core/<= 50 p1__30692__30693__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-state (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"ENABLED" "ENABLED", :enabled "ENABLED", "DISABLED" "DISABLED", :disabled "DISABLED", "DELETED" "DELETED", :deleted "DELETED"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/rule-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-type (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"NODE" "NODE", :node "NODE", "LEAF_NODE" "LEAF_NODE", :leaf-node "LEAF_NODE", "POLICY" "POLICY", :policy "POLICY", "INDEX" "INDEX", :index "INDEX"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/incompatible-schema-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.incompatible-schema-exception/Message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/object-identifier-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/object-identifier) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/consistency-level (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"SERIALIZABLE" "SERIALIZABLE", :serializable "SERIALIZABLE", "EVENTUAL" "EVENTUAL", :eventual "EVENTUAL"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.clouddirectory/directory-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 10)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-create-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-create-object/SchemaFacet :portkey.aws.clouddirectory.batch-create-object/ObjectAttributeList] :opt-un [:portkey.aws.clouddirectory.batch-create-object/ParentReference :portkey.aws.clouddirectory/LinkName :portkey.aws.clouddirectory/BatchReferenceName] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/batch-detach-object (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.batch-detach-object/ParentReference :portkey.aws.clouddirectory/LinkName] :opt-un [:portkey.aws.clouddirectory/BatchReferenceName] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 32)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9._-]*$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/get-object-attributes-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.get-object-attributes-request/DirectoryArn :portkey.aws.clouddirectory/ObjectReference :portkey.aws.clouddirectory/SchemaFacet :portkey.aws.clouddirectory.get-object-attributes-request/AttributeNames] :opt-un [:portkey.aws.clouddirectory/ConsistencyLevel] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/schema-facet-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/schema-facet) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/upgrade-applied-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.upgrade-applied-schema-request/PublishedSchemaArn :portkey.aws.clouddirectory.upgrade-applied-schema-request/DirectoryArn] :opt-un [:portkey.aws.clouddirectory.upgrade-applied-schema-request/DryRun] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-published-schema-arns-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.clouddirectory.list-published-schema-arns-request/SchemaArn :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-published-schema-arns-request/MaxResults] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/upgrade-published-schema-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.upgrade-published-schema-request/DevelopmentSchemaArn :portkey.aws.clouddirectory.upgrade-published-schema-request/PublishedSchemaArn :portkey.aws.clouddirectory.upgrade-published-schema-request/MinorVersion] :opt-un [:portkey.aws.clouddirectory.upgrade-published-schema-request/DryRun] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/list-applied-schema-arns-request (portkey.aws/json-keys :req-un [:portkey.aws.clouddirectory.list-applied-schema-arns-request/DirectoryArn] :opt-un [:portkey.aws.clouddirectory.list-applied-schema-arns-request/SchemaArn :portkey.aws.clouddirectory/NextToken :portkey.aws.clouddirectory.list-applied-schema-arns-request/MaxResults] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/facet-name-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.clouddirectory/facet-name) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.clouddirectory/rule-type (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"BINARY_LENGTH" "BINARY_LENGTH", :binary-length "BINARY_LENGTH", "NUMBER_COMPARISON" "NUMBER_COMPARISON", :number-comparison "NUMBER_COMPARISON", "STRING_FROM_SET" "STRING_FROM_SET", :string-from-set "STRING_FROM_SET", "STRING_LENGTH" "STRING_LENGTH", :string-length "STRING_LENGTH"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.core/defn upgrade-applied-schema ([upgrade-applied-schema-request] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/upgradeapplied" upgrade-applied-schema-request :portkey.aws.clouddirectory/upgrade-applied-schema-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/upgrade-applied-schema-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "IncompatibleSchemaException" :portkey.aws.clouddirectory/incompatible-schema-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "InvalidAttachmentException" :portkey.aws.clouddirectory/invalid-attachment-exception})))
...
(clojure.core/defn get-object-attributes ([get-object-attributes-request] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/object/attributes/get" get-object-attributes-request :portkey.aws.clouddirectory/get-object-attributes-request {:payload nil, :move {}, :headers {"DirectoryArn" ["x-amz-data-partition" nil], "ConsistencyLevel" ["x-amz-consistency-level" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-object-attributes-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "FacetValidationException" :portkey.aws.clouddirectory/facet-validation-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception})))
...
(clojure.core/defn detach-object ([detach-object-request] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/object/detach" detach-object-request :portkey.aws.clouddirectory/detach-object-request {:payload nil, :move {}, :headers {"DirectoryArn" ["x-amz-data-partition" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/detach-object-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "DirectoryNotEnabledException" :portkey.aws.clouddirectory/directory-not-enabled-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "NotNodeException" :portkey.aws.clouddirectory/not-node-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception})))
...
(clojure.core/defn upgrade-published-schema ([upgrade-published-schema-request] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "PUT" "/amazonclouddirectory/2017-01-11/schema/upgradepublished" upgrade-published-schema-request :portkey.aws.clouddirectory/upgrade-published-schema-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/upgrade-published-schema-response {"ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "IncompatibleSchemaException" :portkey.aws.clouddirectory/incompatible-schema-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "InvalidAttachmentException" :portkey.aws.clouddirectory/invalid-attachment-exception, "InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception})))
...
(clojure.core/defn get-applied-schema-version ([get-applied-schema-version-request] (portkey.aws/-rest-json-call portkey.aws.clouddirectory/endpoints "POST" "/amazonclouddirectory/2017-01-11/schema/getappliedschema" get-applied-schema-version-request :portkey.aws.clouddirectory/get-applied-schema-version-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.clouddirectory/get-applied-schema-version-response {"InternalServiceException" :portkey.aws.clouddirectory/internal-service-exception, "InvalidArnException" :portkey.aws.clouddirectory/invalid-arn-exception, "RetryableConflictException" :portkey.aws.clouddirectory/retryable-conflict-exception, "ValidationException" :portkey.aws.clouddirectory/validation-exception, "LimitExceededException" :portkey.aws.clouddirectory/limit-exceeded-exception, "AccessDeniedException" :portkey.aws.clouddirectory/access-denied-exception, "ResourceNotFoundException" :portkey.aws.clouddirectory/resource-not-found-exception})))
