...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper1057341 input] (clojure.core/let [rawinput1057340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057342 {"unprocessedAccounts" (rawinput1057340 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057342 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057342 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1057344 input] (clojure.core/let [rawinput1057343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057345 {"message" (rawinput1057343 "message"), "__type" (rawinput1057343 "__type")}] (clojure.core/cond-> {} (letvar1057345 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1057345 ["message"]))) (letvar1057345 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1057345 ["__type"])))))))

(clojure.core/defn- response-delete-detector-response ([input] (response-delete-detector-response nil input)) ([resultWrapper1057347 input] (clojure.core/let [rawinput1057346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057348 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper1057350 input] (clojure.core/let [rawinput1057349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057351 {"master" (rawinput1057349 "master")}] (clojure.core/cond-> {} (letvar1057351 "master") (clojure.core/assoc :master (deser-master (clojure.core/get-in letvar1057351 ["master"])))))))

(clojure.core/defn- response-create-detector-response ([input] (response-create-detector-response nil input)) ([resultWrapper1057353 input] (clojure.core/let [rawinput1057352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057354 {"detectorId" (rawinput1057352 "detectorId")}] (clojure.core/cond-> {} (letvar1057354 "detectorId") (clojure.core/assoc :detector-id (deser-detector-id (clojure.core/get-in letvar1057354 ["detectorId"])))))))

(clojure.core/defn- response-update-threat-intel-set-response ([input] (response-update-threat-intel-set-response nil input)) ([resultWrapper1057356 input] (clojure.core/let [rawinput1057355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057357 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper1057359 input] (clojure.core/let [rawinput1057358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057360 {"unprocessedAccounts" (rawinput1057358 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057360 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057360 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1057362 input] (clojure.core/let [rawinput1057361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057363 {"message" (rawinput1057361 "message"), "__type" (rawinput1057361 "__type")}] (clojure.core/cond-> {} (letvar1057363 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1057363 ["message"]))) (letvar1057363 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1057363 ["__type"])))))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper1057365 input] (clojure.core/let [rawinput1057364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057366 {"unprocessedAccounts" (rawinput1057364 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057366 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057366 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper1057368 input] (clojure.core/let [rawinput1057367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057369 {"unprocessedAccounts" (rawinput1057367 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057369 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057369 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper1057371 input] (clojure.core/let [rawinput1057370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057372 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper1057374 input] (clojure.core/let [rawinput1057373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057375 {"members" (rawinput1057373 "members"), "unprocessedAccounts" (rawinput1057373 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057375 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar1057375 ["members"]))) (letvar1057375 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057375 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-threat-intel-set-response ([input] (response-get-threat-intel-set-response nil input)) ([resultWrapper1057377 input] (clojure.core/let [rawinput1057376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057378 {"format" (rawinput1057376 "format"), "location" (rawinput1057376 "location"), "name" (rawinput1057376 "name"), "status" (rawinput1057376 "status")}] (clojure.core/cond-> {} (letvar1057378 "format") (clojure.core/assoc :format (deser-threat-intel-set-format (clojure.core/get-in letvar1057378 ["format"]))) (letvar1057378 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar1057378 ["location"]))) (letvar1057378 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1057378 ["name"]))) (letvar1057378 "status") (clojure.core/assoc :status (deser-threat-intel-set-status (clojure.core/get-in letvar1057378 ["status"])))))))

(clojure.core/defn- response-delete-filter-response ([input] (response-delete-filter-response nil input)) ([resultWrapper1057380 input] (clojure.core/let [rawinput1057379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057381 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-archive-findings-response ([input] (response-archive-findings-response nil input)) ([resultWrapper1057383 input] (clojure.core/let [rawinput1057382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057384 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-threat-intel-set-response ([input] (response-delete-threat-intel-set-response nil input)) ([resultWrapper1057386 input] (clojure.core/let [rawinput1057385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057387 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-ip-set-response ([input] (response-update-ip-set-response nil input)) ([resultWrapper1057389 input] (clojure.core/let [rawinput1057388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057390 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper1057392 input] (clojure.core/let [rawinput1057391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057393 {"invitations" (rawinput1057391 "invitations"), "nextToken" (rawinput1057391 "nextToken")}] (clojure.core/cond-> {} (letvar1057393 "invitations") (clojure.core/assoc :invitations (deser-invitations (clojure.core/get-in letvar1057393 ["invitations"]))) (letvar1057393 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057393 ["nextToken"])))))))

(clojure.core/defn- response-list-detectors-response ([input] (response-list-detectors-response nil input)) ([resultWrapper1057395 input] (clojure.core/let [rawinput1057394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057396 {"detectorIds" (rawinput1057394 "detectorIds"), "nextToken" (rawinput1057394 "nextToken")}] (clojure.core/cond-> {} (letvar1057396 "detectorIds") (clojure.core/assoc :detector-ids (deser-detector-ids (clojure.core/get-in letvar1057396 ["detectorIds"]))) (letvar1057396 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057396 ["nextToken"])))))))

(clojure.core/defn- response-stop-monitoring-members-response ([input] (response-stop-monitoring-members-response nil input)) ([resultWrapper1057398 input] (clojure.core/let [rawinput1057397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057399 {"unprocessedAccounts" (rawinput1057397 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057399 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057399 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-ip-set-response ([input] (response-get-ip-set-response nil input)) ([resultWrapper1057401 input] (clojure.core/let [rawinput1057400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057402 {"format" (rawinput1057400 "format"), "location" (rawinput1057400 "location"), "name" (rawinput1057400 "name"), "status" (rawinput1057400 "status")}] (clojure.core/cond-> {} (letvar1057402 "format") (clojure.core/assoc :format (deser-ip-set-format (clojure.core/get-in letvar1057402 ["format"]))) (letvar1057402 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar1057402 ["location"]))) (letvar1057402 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1057402 ["name"]))) (letvar1057402 "status") (clojure.core/assoc :status (deser-ip-set-status (clojure.core/get-in letvar1057402 ["status"])))))))

(clojure.core/defn- response-update-filter-response ([input] (response-update-filter-response nil input)) ([resultWrapper1057404 input] (clojure.core/let [rawinput1057403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057405 {"name" (rawinput1057403 "name")}] (clojure.core/cond-> {} (letvar1057405 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1057405 ["name"])))))))

(clojure.core/defn- response-delete-ip-set-response ([input] (response-delete-ip-set-response nil input)) ([resultWrapper1057407 input] (clojure.core/let [rawinput1057406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057408 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-feedback-response ([input] (response-update-findings-feedback-response nil input)) ([resultWrapper1057410 input] (clojure.core/let [rawinput1057409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057411 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-filter-response ([input] (response-create-filter-response nil input)) ([resultWrapper1057413 input] (clojure.core/let [rawinput1057412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057414 {"name" (rawinput1057412 "name")}] (clojure.core/cond-> {} (letvar1057414 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1057414 ["name"])))))))

(clojure.core/defn- response-unarchive-findings-response ([input] (response-unarchive-findings-response nil input)) ([resultWrapper1057416 input] (clojure.core/let [rawinput1057415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057417 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper1057419 input] (clojure.core/let [rawinput1057418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057420 {"invitationsCount" (rawinput1057418 "invitationsCount")}] (clojure.core/cond-> {} (letvar1057420 "invitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar1057420 ["invitationsCount"])))))))

(clojure.core/defn- response-get-detector-response ([input] (response-get-detector-response nil input)) ([resultWrapper1057422 input] (clojure.core/let [rawinput1057421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057423 {"createdAt" (rawinput1057421 "createdAt"), "findingPublishingFrequency" (rawinput1057421 "findingPublishingFrequency"), "serviceRole" (rawinput1057421 "serviceRole"), "status" (rawinput1057421 "status"), "updatedAt" (rawinput1057421 "updatedAt")}] (clojure.core/cond-> {} (letvar1057423 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar1057423 ["createdAt"]))) (letvar1057423 "findingPublishingFrequency") (clojure.core/assoc :finding-publishing-frequency (deser-finding-publishing-frequency (clojure.core/get-in letvar1057423 ["findingPublishingFrequency"]))) (letvar1057423 "serviceRole") (clojure.core/assoc :service-role (deser-service-role (clojure.core/get-in letvar1057423 ["serviceRole"]))) (letvar1057423 "status") (clojure.core/assoc :status (deser-detector-status (clojure.core/get-in letvar1057423 ["status"]))) (letvar1057423 "updatedAt") (clojure.core/assoc :updated-at (deser-updated-at (clojure.core/get-in letvar1057423 ["updatedAt"])))))))

(clojure.core/defn- response-start-monitoring-members-response ([input] (response-start-monitoring-members-response nil input)) ([resultWrapper1057425 input] (clojure.core/let [rawinput1057424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057426 {"unprocessedAccounts" (rawinput1057424 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057426 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057426 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-findings-statistics-response ([input] (response-get-findings-statistics-response nil input)) ([resultWrapper1057428 input] (clojure.core/let [rawinput1057427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057429 {"findingStatistics" (rawinput1057427 "findingStatistics")}] (clojure.core/cond-> {} (letvar1057429 "findingStatistics") (clojure.core/assoc :finding-statistics (deser-finding-statistics (clojure.core/get-in letvar1057429 ["findingStatistics"])))))))

(clojure.core/defn- response-create-threat-intel-set-response ([input] (response-create-threat-intel-set-response nil input)) ([resultWrapper1057431 input] (clojure.core/let [rawinput1057430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057432 {"threatIntelSetId" (rawinput1057430 "threatIntelSetId")}] (clojure.core/cond-> {} (letvar1057432 "threatIntelSetId") (clojure.core/assoc :threat-intel-set-id (deser-threat-intel-set-id (clojure.core/get-in letvar1057432 ["threatIntelSetId"])))))))

(clojure.core/defn- response-list-findings-response ([input] (response-list-findings-response nil input)) ([resultWrapper1057434 input] (clojure.core/let [rawinput1057433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057435 {"findingIds" (rawinput1057433 "findingIds"), "nextToken" (rawinput1057433 "nextToken")}] (clojure.core/cond-> {} (letvar1057435 "findingIds") (clojure.core/assoc :finding-ids (deser-finding-ids (clojure.core/get-in letvar1057435 ["findingIds"]))) (letvar1057435 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057435 ["nextToken"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper1057437 input] (clojure.core/let [rawinput1057436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057438 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper1057440 input] (clojure.core/let [rawinput1057439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057441 {"findings" (rawinput1057439 "findings")}] (clojure.core/cond-> {} (letvar1057441 "findings") (clojure.core/assoc :findings (deser-findings (clojure.core/get-in letvar1057441 ["findings"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper1057443 input] (clojure.core/let [rawinput1057442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057444 {"unprocessedAccounts" (rawinput1057442 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057444 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057444 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-list-threat-intel-sets-response ([input] (response-list-threat-intel-sets-response nil input)) ([resultWrapper1057446 input] (clojure.core/let [rawinput1057445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057447 {"nextToken" (rawinput1057445 "nextToken"), "threatIntelSetIds" (rawinput1057445 "threatIntelSetIds")}] (clojure.core/cond-> {} (letvar1057447 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057447 ["nextToken"]))) (letvar1057447 "threatIntelSetIds") (clojure.core/assoc :threat-intel-set-ids (deser-threat-intel-set-ids (clojure.core/get-in letvar1057447 ["threatIntelSetIds"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper1057449 input] (clojure.core/let [rawinput1057448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057450 {"unprocessedAccounts" (rawinput1057448 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1057450 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1057450 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-create-sample-findings-response ([input] (response-create-sample-findings-response nil input)) ([resultWrapper1057452 input] (clojure.core/let [rawinput1057451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057453 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-filters-response ([input] (response-list-filters-response nil input)) ([resultWrapper1057455 input] (clojure.core/let [rawinput1057454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057456 {"filterNames" (rawinput1057454 "filterNames"), "nextToken" (rawinput1057454 "nextToken")}] (clojure.core/cond-> {} (letvar1057456 "filterNames") (clojure.core/assoc :filter-names (deser-filter-names (clojure.core/get-in letvar1057456 ["filterNames"]))) (letvar1057456 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057456 ["nextToken"])))))))

(clojure.core/defn- response-get-filter-response ([input] (response-get-filter-response nil input)) ([resultWrapper1057458 input] (clojure.core/let [rawinput1057457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057459 {"action" (rawinput1057457 "action"), "description" (rawinput1057457 "description"), "findingCriteria" (rawinput1057457 "findingCriteria"), "name" (rawinput1057457 "name"), "rank" (rawinput1057457 "rank")}] (clojure.core/cond-> {} (letvar1057459 "action") (clojure.core/assoc :action (deser-filter-action (clojure.core/get-in letvar1057459 ["action"]))) (letvar1057459 "description") (clojure.core/assoc :description (deser-filter-description (clojure.core/get-in letvar1057459 ["description"]))) (letvar1057459 "findingCriteria") (clojure.core/assoc :finding-criteria (deser-finding-criteria (clojure.core/get-in letvar1057459 ["findingCriteria"]))) (letvar1057459 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1057459 ["name"]))) (letvar1057459 "rank") (clojure.core/assoc :rank (deser-filter-rank (clojure.core/get-in letvar1057459 ["rank"])))))))

(clojure.core/defn- response-update-detector-response ([input] (response-update-detector-response nil input)) ([resultWrapper1057461 input] (clojure.core/let [rawinput1057460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057462 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-ip-set-response ([input] (response-create-ip-set-response nil input)) ([resultWrapper1057464 input] (clojure.core/let [rawinput1057463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057465 {"ipSetId" (rawinput1057463 "ipSetId")}] (clojure.core/cond-> {} (letvar1057465 "ipSetId") (clojure.core/assoc :ip-set-id (deser-ip-set-id (clojure.core/get-in letvar1057465 ["ipSetId"])))))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper1057467 input] (clojure.core/let [rawinput1057466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057468 {"members" (rawinput1057466 "members"), "nextToken" (rawinput1057466 "nextToken")}] (clojure.core/cond-> {} (letvar1057468 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar1057468 ["members"]))) (letvar1057468 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057468 ["nextToken"])))))))

(clojure.core/defn- response-list-ip-sets-response ([input] (response-list-ip-sets-response nil input)) ([resultWrapper1057470 input] (clojure.core/let [rawinput1057469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1057471 {"ipSetIds" (rawinput1057469 "ipSetIds"), "nextToken" (rawinput1057469 "nextToken")}] (clojure.core/cond-> {} (letvar1057471 "ipSetIds") (clojure.core/assoc :ip-set-ids (deser-ip-set-ids (clojure.core/get-in letvar1057471 ["ipSetIds"]))) (letvar1057471 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1057471 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.guardduty.-2017-11-28/string-min-0-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
