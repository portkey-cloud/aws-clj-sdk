...
(clojure.core/defn- response-join-domain-output ([input] (response-join-domain-output nil input)) ([resultWrapper2096561 input] (clojure.core/let [rawinput2096560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096562 {"GatewayARN" (rawinput2096560 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096562 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096562 ["GatewayARN"])))))))

(clojure.core/defn- response-activate-gateway-output ([input] (response-activate-gateway-output nil input)) ([resultWrapper2096564 input] (clojure.core/let [rawinput2096563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096565 {"GatewayARN" (rawinput2096563 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096565 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096565 ["GatewayARN"])))))))

(clojure.core/defn- response-list-volume-initiators-output ([input] (response-list-volume-initiators-output nil input)) ([resultWrapper2096567 input] (clojure.core/let [rawinput2096566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096568 {"Initiators" (rawinput2096566 "Initiators")}] (clojure.core/cond-> {} (letvar2096568 "Initiators") (clojure.core/assoc :initiators (deser-initiators (clojure.core/get-in letvar2096568 ["Initiators"])))))))

(clojure.core/defn- response-describe-bandwidth-rate-limit-output ([input] (response-describe-bandwidth-rate-limit-output nil input)) ([resultWrapper2096570 input] (clojure.core/let [rawinput2096569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096571 {"GatewayARN" (rawinput2096569 "GatewayARN"), "AverageUploadRateLimitInBitsPerSec" (rawinput2096569 "AverageUploadRateLimitInBitsPerSec"), "AverageDownloadRateLimitInBitsPerSec" (rawinput2096569 "AverageDownloadRateLimitInBitsPerSec")}] (clojure.core/cond-> {} (letvar2096571 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096571 ["GatewayARN"]))) (letvar2096571 "AverageUploadRateLimitInBitsPerSec") (clojure.core/assoc :average-upload-rate-limit-in-bits-per-sec (deser-bandwidth-upload-rate-limit (clojure.core/get-in letvar2096571 ["AverageUploadRateLimitInBitsPerSec"]))) (letvar2096571 "AverageDownloadRateLimitInBitsPerSec") (clojure.core/assoc :average-download-rate-limit-in-bits-per-sec (deser-bandwidth-download-rate-limit (clojure.core/get-in letvar2096571 ["AverageDownloadRateLimitInBitsPerSec"])))))))

(clojure.core/defn- response-list-volume-recovery-points-output ([input] (response-list-volume-recovery-points-output nil input)) ([resultWrapper2096573 input] (clojure.core/let [rawinput2096572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096574 {"GatewayARN" (rawinput2096572 "GatewayARN"), "VolumeRecoveryPointInfos" (rawinput2096572 "VolumeRecoveryPointInfos")}] (clojure.core/cond-> {} (letvar2096574 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096574 ["GatewayARN"]))) (letvar2096574 "VolumeRecoveryPointInfos") (clojure.core/assoc :volume-recovery-point-infos (deser-volume-recovery-point-infos (clojure.core/get-in letvar2096574 ["VolumeRecoveryPointInfos"])))))))

(clojure.core/defn- response-describe-tape-recovery-points-output ([input] (response-describe-tape-recovery-points-output nil input)) ([resultWrapper2096576 input] (clojure.core/let [rawinput2096575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096577 {"GatewayARN" (rawinput2096575 "GatewayARN"), "TapeRecoveryPointInfos" (rawinput2096575 "TapeRecoveryPointInfos"), "Marker" (rawinput2096575 "Marker")}] (clojure.core/cond-> {} (letvar2096577 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096577 ["GatewayARN"]))) (letvar2096577 "TapeRecoveryPointInfos") (clojure.core/assoc :tape-recovery-point-infos (deser-tape-recovery-point-infos (clojure.core/get-in letvar2096577 ["TapeRecoveryPointInfos"]))) (letvar2096577 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096577 ["Marker"])))))))

(clojure.core/defn- response-update-gateway-software-now-output ([input] (response-update-gateway-software-now-output nil input)) ([resultWrapper2096579 input] (clojure.core/let [rawinput2096578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096580 {"GatewayARN" (rawinput2096578 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096580 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096580 ["GatewayARN"])))))))

(clojure.core/defn- response-start-gateway-output ([input] (response-start-gateway-output nil input)) ([resultWrapper2096582 input] (clojure.core/let [rawinput2096581 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096583 {"GatewayARN" (rawinput2096581 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096583 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096583 ["GatewayARN"])))))))

(clojure.core/defn- response-create-storedi-scsi-volume-output ([input] (response-create-storedi-scsi-volume-output nil input)) ([resultWrapper2096585 input] (clojure.core/let [rawinput2096584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096586 {"VolumeARN" (rawinput2096584 "VolumeARN"), "VolumeSizeInBytes" (rawinput2096584 "VolumeSizeInBytes"), "TargetARN" (rawinput2096584 "TargetARN")}] (clojure.core/cond-> {} (letvar2096586 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096586 ["VolumeARN"]))) (letvar2096586 "VolumeSizeInBytes") (clojure.core/assoc :volume-size-in-bytes (deserlong (clojure.core/get-in letvar2096586 ["VolumeSizeInBytes"]))) (letvar2096586 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096586 ["TargetARN"])))))))

(clojure.core/defn- response-delete-tape-archive-output ([input] (response-delete-tape-archive-output nil input)) ([resultWrapper2096588 input] (clojure.core/let [rawinput2096587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096589 {"TapeARN" (rawinput2096587 "TapeARN")}] (clojure.core/cond-> {} (letvar2096589 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096589 ["TapeARN"])))))))

(clojure.core/defn- response-describe-cache-output ([input] (response-describe-cache-output nil input)) ([resultWrapper2096591 input] (clojure.core/let [rawinput2096590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096592 {"GatewayARN" (rawinput2096590 "GatewayARN"), "DiskIds" (rawinput2096590 "DiskIds"), "CacheAllocatedInBytes" (rawinput2096590 "CacheAllocatedInBytes"), "CacheUsedPercentage" (rawinput2096590 "CacheUsedPercentage"), "CacheDirtyPercentage" (rawinput2096590 "CacheDirtyPercentage"), "CacheHitPercentage" (rawinput2096590 "CacheHitPercentage"), "CacheMissPercentage" (rawinput2096590 "CacheMissPercentage")}] (clojure.core/cond-> {} (letvar2096592 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096592 ["GatewayARN"]))) (letvar2096592 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096592 ["DiskIds"]))) (letvar2096592 "CacheAllocatedInBytes") (clojure.core/assoc :cache-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096592 ["CacheAllocatedInBytes"]))) (letvar2096592 "CacheUsedPercentage") (clojure.core/assoc :cache-used-percentage (deserdouble (clojure.core/get-in letvar2096592 ["CacheUsedPercentage"]))) (letvar2096592 "CacheDirtyPercentage") (clojure.core/assoc :cache-dirty-percentage (deserdouble (clojure.core/get-in letvar2096592 ["CacheDirtyPercentage"]))) (letvar2096592 "CacheHitPercentage") (clojure.core/assoc :cache-hit-percentage (deserdouble (clojure.core/get-in letvar2096592 ["CacheHitPercentage"]))) (letvar2096592 "CacheMissPercentage") (clojure.core/assoc :cache-miss-percentage (deserdouble (clojure.core/get-in letvar2096592 ["CacheMissPercentage"])))))))

(clojure.core/defn- response-describe-upload-buffer-output ([input] (response-describe-upload-buffer-output nil input)) ([resultWrapper2096594 input] (clojure.core/let [rawinput2096593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096595 {"GatewayARN" (rawinput2096593 "GatewayARN"), "DiskIds" (rawinput2096593 "DiskIds"), "UploadBufferUsedInBytes" (rawinput2096593 "UploadBufferUsedInBytes"), "UploadBufferAllocatedInBytes" (rawinput2096593 "UploadBufferAllocatedInBytes")}] (clojure.core/cond-> {} (letvar2096595 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096595 ["GatewayARN"]))) (letvar2096595 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096595 ["DiskIds"]))) (letvar2096595 "UploadBufferUsedInBytes") (clojure.core/assoc :upload-buffer-used-in-bytes (deserlong (clojure.core/get-in letvar2096595 ["UploadBufferUsedInBytes"]))) (letvar2096595 "UploadBufferAllocatedInBytes") (clojure.core/assoc :upload-buffer-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096595 ["UploadBufferAllocatedInBytes"])))))))

(clojure.core/defn- response-describe-tape-archives-output ([input] (response-describe-tape-archives-output nil input)) ([resultWrapper2096597 input] (clojure.core/let [rawinput2096596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096598 {"TapeArchives" (rawinput2096596 "TapeArchives"), "Marker" (rawinput2096596 "Marker")}] (clojure.core/cond-> {} (letvar2096598 "TapeArchives") (clojure.core/assoc :tape-archives (deser-tape-archives (clojure.core/get-in letvar2096598 ["TapeArchives"]))) (letvar2096598 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096598 ["Marker"])))))))

(clojure.core/defn- response-cancel-archival-output ([input] (response-cancel-archival-output nil input)) ([resultWrapper2096600 input] (clojure.core/let [rawinput2096599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096601 {"TapeARN" (rawinput2096599 "TapeARN")}] (clojure.core/cond-> {} (letvar2096601 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096601 ["TapeARN"])))))))

(clojure.core/defn- response-shutdown-gateway-output ([input] (response-shutdown-gateway-output nil input)) ([resultWrapper2096603 input] (clojure.core/let [rawinput2096602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096604 {"GatewayARN" (rawinput2096602 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096604 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096604 ["GatewayARN"])))))))

(clojure.core/defn- response-update-vtl-device-type-output ([input] (response-update-vtl-device-type-output nil input)) ([resultWrapper2096606 input] (clojure.core/let [rawinput2096605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096607 {"VTLDeviceARN" (rawinput2096605 "VTLDeviceARN")}] (clojure.core/cond-> {} (letvar2096607 "VTLDeviceARN") (clojure.core/assoc :vtl-device-arn (deser-vtl-device-arn (clojure.core/get-in letvar2096607 ["VTLDeviceARN"])))))))

(clojure.core/defn- response-update-bandwidth-rate-limit-output ([input] (response-update-bandwidth-rate-limit-output nil input)) ([resultWrapper2096609 input] (clojure.core/let [rawinput2096608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096610 {"GatewayARN" (rawinput2096608 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096610 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096610 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-chap-credentials-output ([input] (response-delete-chap-credentials-output nil input)) ([resultWrapper2096612 input] (clojure.core/let [rawinput2096611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096613 {"TargetARN" (rawinput2096611 "TargetARN"), "InitiatorName" (rawinput2096611 "InitiatorName")}] (clojure.core/cond-> {} (letvar2096613 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096613 ["TargetARN"]))) (letvar2096613 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar2096613 ["InitiatorName"])))))))

(clojure.core/defn- response-describe-chap-credentials-output ([input] (response-describe-chap-credentials-output nil input)) ([resultWrapper2096615 input] (clojure.core/let [rawinput2096614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096616 {"ChapCredentials" (rawinput2096614 "ChapCredentials")}] (clojure.core/cond-> {} (letvar2096616 "ChapCredentials") (clojure.core/assoc :chap-credentials (deser-chap-credentials (clojure.core/get-in letvar2096616 ["ChapCredentials"])))))))

(clojure.core/defn- response-refresh-cache-output ([input] (response-refresh-cache-output nil input)) ([resultWrapper2096618 input] (clojure.core/let [rawinput2096617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096619 {"FileShareARN" (rawinput2096617 "FileShareARN"), "NotificationId" (rawinput2096617 "NotificationId")}] (clojure.core/cond-> {} (letvar2096619 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096619 ["FileShareARN"]))) (letvar2096619 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar2096619 ["NotificationId"])))))))

(clojure.core/defn- response-add-cache-output ([input] (response-add-cache-output nil input)) ([resultWrapper2096621 input] (clojure.core/let [rawinput2096620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096622 {"GatewayARN" (rawinput2096620 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096622 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096622 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-maintenance-start-time-output ([input] (response-describe-maintenance-start-time-output nil input)) ([resultWrapper2096624 input] (clojure.core/let [rawinput2096623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096625 {"GatewayARN" (rawinput2096623 "GatewayARN"), "HourOfDay" (rawinput2096623 "HourOfDay"), "MinuteOfHour" (rawinput2096623 "MinuteOfHour"), "DayOfWeek" (rawinput2096623 "DayOfWeek"), "Timezone" (rawinput2096623 "Timezone")}] (clojure.core/cond-> {} (letvar2096625 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096625 ["GatewayARN"]))) (letvar2096625 "HourOfDay") (clojure.core/assoc :hour-of-day (deser-hour-of-day (clojure.core/get-in letvar2096625 ["HourOfDay"]))) (letvar2096625 "MinuteOfHour") (clojure.core/assoc :minute-of-hour (deser-minute-of-hour (clojure.core/get-in letvar2096625 ["MinuteOfHour"]))) (letvar2096625 "DayOfWeek") (clojure.core/assoc :day-of-week (deser-day-of-week (clojure.core/get-in letvar2096625 ["DayOfWeek"]))) (letvar2096625 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar2096625 ["Timezone"])))))))

(clojure.core/defn- response-create-tapes-output ([input] (response-create-tapes-output nil input)) ([resultWrapper2096627 input] (clojure.core/let [rawinput2096626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096628 {"TapeARNs" (rawinput2096626 "TapeARNs")}] (clojure.core/cond-> {} (letvar2096628 "TapeARNs") (clojure.core/assoc :tape-ar-ns (deser-tape-ar-ns (clojure.core/get-in letvar2096628 ["TapeARNs"])))))))

(clojure.core/defn- response-set-smb-guest-password-output ([input] (response-set-smb-guest-password-output nil input)) ([resultWrapper2096630 input] (clojure.core/let [rawinput2096629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096631 {"GatewayARN" (rawinput2096629 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096631 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096631 ["GatewayARN"])))))))

(clojure.core/defn- response-create-snapshot-from-volume-recovery-point-output ([input] (response-create-snapshot-from-volume-recovery-point-output nil input)) ([resultWrapper2096633 input] (clojure.core/let [rawinput2096632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096634 {"SnapshotId" (rawinput2096632 "SnapshotId"), "VolumeARN" (rawinput2096632 "VolumeARN"), "VolumeRecoveryPointTime" (rawinput2096632 "VolumeRecoveryPointTime")}] (clojure.core/cond-> {} (letvar2096634 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar2096634 ["SnapshotId"]))) (letvar2096634 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096634 ["VolumeARN"]))) (letvar2096634 "VolumeRecoveryPointTime") (clojure.core/assoc :volume-recovery-point-time (deserstring (clojure.core/get-in letvar2096634 ["VolumeRecoveryPointTime"])))))))

(clojure.core/defn- response-cancel-retrieval-output ([input] (response-cancel-retrieval-output nil input)) ([resultWrapper2096636 input] (clojure.core/let [rawinput2096635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096637 {"TapeARN" (rawinput2096635 "TapeARN")}] (clojure.core/cond-> {} (letvar2096637 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096637 ["TapeARN"])))))))

(clojure.core/defn- response-list-local-disks-output ([input] (response-list-local-disks-output nil input)) ([resultWrapper2096639 input] (clojure.core/let [rawinput2096638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096640 {"GatewayARN" (rawinput2096638 "GatewayARN"), "Disks" (rawinput2096638 "Disks")}] (clojure.core/cond-> {} (letvar2096640 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096640 ["GatewayARN"]))) (letvar2096640 "Disks") (clojure.core/assoc :disks (deser-disks (clojure.core/get-in letvar2096640 ["Disks"])))))))

(clojure.core/defn- response-create-snapshot-output ([input] (response-create-snapshot-output nil input)) ([resultWrapper2096642 input] (clojure.core/let [rawinput2096641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096643 {"VolumeARN" (rawinput2096641 "VolumeARN"), "SnapshotId" (rawinput2096641 "SnapshotId")}] (clojure.core/cond-> {} (letvar2096643 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096643 ["VolumeARN"]))) (letvar2096643 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar2096643 ["SnapshotId"])))))))

(clojure.core/defn- response-describe-gateway-information-output ([input] (response-describe-gateway-information-output nil input)) ([resultWrapper2096645 input] (clojure.core/let [rawinput2096644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096646 {"LastSoftwareUpdate" (rawinput2096644 "LastSoftwareUpdate"), "NextUpdateAvailabilityDate" (rawinput2096644 "NextUpdateAvailabilityDate"), "GatewayNetworkInterfaces" (rawinput2096644 "GatewayNetworkInterfaces"), "Tags" (rawinput2096644 "Tags"), "GatewayName" (rawinput2096644 "GatewayName"), "GatewayId" (rawinput2096644 "GatewayId"), "GatewayState" (rawinput2096644 "GatewayState"), "GatewayType" (rawinput2096644 "GatewayType"), "GatewayTimezone" (rawinput2096644 "GatewayTimezone"), "GatewayARN" (rawinput2096644 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096646 "LastSoftwareUpdate") (clojure.core/assoc :last-software-update (deser-last-software-update (clojure.core/get-in letvar2096646 ["LastSoftwareUpdate"]))) (letvar2096646 "NextUpdateAvailabilityDate") (clojure.core/assoc :next-update-availability-date (deser-next-update-availability-date (clojure.core/get-in letvar2096646 ["NextUpdateAvailabilityDate"]))) (letvar2096646 "GatewayNetworkInterfaces") (clojure.core/assoc :gateway-network-interfaces (deser-gateway-network-interfaces (clojure.core/get-in letvar2096646 ["GatewayNetworkInterfaces"]))) (letvar2096646 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2096646 ["Tags"]))) (letvar2096646 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar2096646 ["GatewayName"]))) (letvar2096646 "GatewayId") (clojure.core/assoc :gateway-id (deser-gateway-id (clojure.core/get-in letvar2096646 ["GatewayId"]))) (letvar2096646 "GatewayState") (clojure.core/assoc :gateway-state (deser-gateway-state (clojure.core/get-in letvar2096646 ["GatewayState"]))) (letvar2096646 "GatewayType") (clojure.core/assoc :gateway-type (deser-gateway-type (clojure.core/get-in letvar2096646 ["GatewayType"]))) (letvar2096646 "GatewayTimezone") (clojure.core/assoc :gateway-timezone (deser-gateway-timezone (clojure.core/get-in letvar2096646 ["GatewayTimezone"]))) (letvar2096646 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096646 ["GatewayARN"])))))))

(clojure.core/defn- response-create-smb-file-share-output ([input] (response-create-smb-file-share-output nil input)) ([resultWrapper2096648 input] (clojure.core/let [rawinput2096647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096649 {"FileShareARN" (rawinput2096647 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096649 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096649 ["FileShareARN"])))))))

(clojure.core/defn- response-add-upload-buffer-output ([input] (response-add-upload-buffer-output nil input)) ([resultWrapper2096651 input] (clojure.core/let [rawinput2096650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096652 {"GatewayARN" (rawinput2096650 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096652 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096652 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-storedi-scsi-volumes-output ([input] (response-describe-storedi-scsi-volumes-output nil input)) ([resultWrapper2096654 input] (clojure.core/let [rawinput2096653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096655 {"StorediSCSIVolumes" (rawinput2096653 "StorediSCSIVolumes")}] (clojure.core/cond-> {} (letvar2096655 "StorediSCSIVolumes") (clojure.core/assoc :storedi-scsi-volumes (deser-storedi-scsi-volumes (clojure.core/get-in letvar2096655 ["StorediSCSIVolumes"])))))))

(clojure.core/defn- response-list-volumes-output ([input] (response-list-volumes-output nil input)) ([resultWrapper2096657 input] (clojure.core/let [rawinput2096656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096658 {"GatewayARN" (rawinput2096656 "GatewayARN"), "Marker" (rawinput2096656 "Marker"), "VolumeInfos" (rawinput2096656 "VolumeInfos")}] (clojure.core/cond-> {} (letvar2096658 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096658 ["GatewayARN"]))) (letvar2096658 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096658 ["Marker"]))) (letvar2096658 "VolumeInfos") (clojure.core/assoc :volume-infos (deser-volume-infos (clojure.core/get-in letvar2096658 ["VolumeInfos"])))))))

(clojure.core/defn- response-disable-gateway-output ([input] (response-disable-gateway-output nil input)) ([resultWrapper2096660 input] (clojure.core/let [rawinput2096659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096661 {"GatewayARN" (rawinput2096659 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096661 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096661 ["GatewayARN"])))))))

(clojure.core/defn- response-list-file-shares-output ([input] (response-list-file-shares-output nil input)) ([resultWrapper2096663 input] (clojure.core/let [rawinput2096662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096664 {"Marker" (rawinput2096662 "Marker"), "NextMarker" (rawinput2096662 "NextMarker"), "FileShareInfoList" (rawinput2096662 "FileShareInfoList")}] (clojure.core/cond-> {} (letvar2096664 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096664 ["Marker"]))) (letvar2096664 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar2096664 ["NextMarker"]))) (letvar2096664 "FileShareInfoList") (clojure.core/assoc :file-share-info-list (deser-file-share-info-list (clojure.core/get-in letvar2096664 ["FileShareInfoList"])))))))

(clojure.core/defn- response-remove-tags-from-resource-output ([input] (response-remove-tags-from-resource-output nil input)) ([resultWrapper2096666 input] (clojure.core/let [rawinput2096665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096667 {"ResourceARN" (rawinput2096665 "ResourceARN")}] (clojure.core/cond-> {} (letvar2096667 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096667 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-snapshot-schedule-output ([input] (response-delete-snapshot-schedule-output nil input)) ([resultWrapper2096669 input] (clojure.core/let [rawinput2096668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096670 {"VolumeARN" (rawinput2096668 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096670 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096670 ["VolumeARN"])))))))

(clojure.core/defn- response-describe-smb-settings-output ([input] (response-describe-smb-settings-output nil input)) ([resultWrapper2096672 input] (clojure.core/let [rawinput2096671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096673 {"GatewayARN" (rawinput2096671 "GatewayARN"), "DomainName" (rawinput2096671 "DomainName"), "SMBGuestPasswordSet" (rawinput2096671 "SMBGuestPasswordSet")}] (clojure.core/cond-> {} (letvar2096673 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096673 ["GatewayARN"]))) (letvar2096673 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar2096673 ["DomainName"]))) (letvar2096673 "SMBGuestPasswordSet") (clojure.core/assoc :smb-guest-password-set (deser-boolean (clojure.core/get-in letvar2096673 ["SMBGuestPasswordSet"])))))))

(clojure.core/defn- response-delete-bandwidth-rate-limit-output ([input] (response-delete-bandwidth-rate-limit-output nil input)) ([resultWrapper2096675 input] (clojure.core/let [rawinput2096674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096676 {"GatewayARN" (rawinput2096674 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096676 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096676 ["GatewayARN"])))))))

(clojure.core/defn- response-update-maintenance-start-time-output ([input] (response-update-maintenance-start-time-output nil input)) ([resultWrapper2096678 input] (clojure.core/let [rawinput2096677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096679 {"GatewayARN" (rawinput2096677 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096679 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096679 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-gateway-output ([input] (response-delete-gateway-output nil input)) ([resultWrapper2096681 input] (clojure.core/let [rawinput2096680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096682 {"GatewayARN" (rawinput2096680 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096682 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096682 ["GatewayARN"])))))))

(clojure.core/defn- response-list-gateways-output ([input] (response-list-gateways-output nil input)) ([resultWrapper2096684 input] (clojure.core/let [rawinput2096683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096685 {"Gateways" (rawinput2096683 "Gateways"), "Marker" (rawinput2096683 "Marker")}] (clojure.core/cond-> {} (letvar2096685 "Gateways") (clojure.core/assoc :gateways (deser-gateways (clojure.core/get-in letvar2096685 ["Gateways"]))) (letvar2096685 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096685 ["Marker"])))))))

(clojure.core/defn- response-update-nfs-file-share-output ([input] (response-update-nfs-file-share-output nil input)) ([resultWrapper2096687 input] (clojure.core/let [rawinput2096686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096688 {"FileShareARN" (rawinput2096686 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096688 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096688 ["FileShareARN"])))))))

(clojure.core/defn- response-update-gateway-information-output ([input] (response-update-gateway-information-output nil input)) ([resultWrapper2096690 input] (clojure.core/let [rawinput2096689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096691 {"GatewayARN" (rawinput2096689 "GatewayARN"), "GatewayName" (rawinput2096689 "GatewayName")}] (clojure.core/cond-> {} (letvar2096691 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096691 ["GatewayARN"]))) (letvar2096691 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar2096691 ["GatewayName"])))))))

(clojure.core/defn- response-service-unavailable-error ([input] (response-service-unavailable-error nil input)) ([resultWrapper2096693 input] (clojure.core/let [rawinput2096692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096694 {"message" (rawinput2096692 "message"), "error" (rawinput2096692 "error")}] (clojure.core/cond-> {} (letvar2096694 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096694 ["message"]))) (letvar2096694 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096694 ["error"])))))))

(clojure.core/defn- response-describe-nfs-file-shares-output ([input] (response-describe-nfs-file-shares-output nil input)) ([resultWrapper2096696 input] (clojure.core/let [rawinput2096695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096697 {"NFSFileShareInfoList" (rawinput2096695 "NFSFileShareInfoList")}] (clojure.core/cond-> {} (letvar2096697 "NFSFileShareInfoList") (clojure.core/assoc :nfs-file-share-info-list (deser-nfs-file-share-info-list (clojure.core/get-in letvar2096697 ["NFSFileShareInfoList"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper2096699 input] (clojure.core/let [rawinput2096698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096700 {"ResourceARN" (rawinput2096698 "ResourceARN"), "Marker" (rawinput2096698 "Marker"), "Tags" (rawinput2096698 "Tags")}] (clojure.core/cond-> {} (letvar2096700 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096700 ["ResourceARN"]))) (letvar2096700 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096700 ["Marker"]))) (letvar2096700 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2096700 ["Tags"])))))))

(clojure.core/defn- response-attach-volume-output ([input] (response-attach-volume-output nil input)) ([resultWrapper2096702 input] (clojure.core/let [rawinput2096701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096703 {"VolumeARN" (rawinput2096701 "VolumeARN"), "TargetARN" (rawinput2096701 "TargetARN")}] (clojure.core/cond-> {} (letvar2096703 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096703 ["VolumeARN"]))) (letvar2096703 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096703 ["TargetARN"])))))))

(clojure.core/defn- response-reset-cache-output ([input] (response-reset-cache-output nil input)) ([resultWrapper2096705 input] (clojure.core/let [rawinput2096704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096706 {"GatewayARN" (rawinput2096704 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096706 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096706 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-snapshot-schedule-output ([input] (response-describe-snapshot-schedule-output nil input)) ([resultWrapper2096708 input] (clojure.core/let [rawinput2096707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096709 {"VolumeARN" (rawinput2096707 "VolumeARN"), "StartAt" (rawinput2096707 "StartAt"), "RecurrenceInHours" (rawinput2096707 "RecurrenceInHours"), "Description" (rawinput2096707 "Description"), "Timezone" (rawinput2096707 "Timezone")}] (clojure.core/cond-> {} (letvar2096709 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096709 ["VolumeARN"]))) (letvar2096709 "StartAt") (clojure.core/assoc :start-at (deser-hour-of-day (clojure.core/get-in letvar2096709 ["StartAt"]))) (letvar2096709 "RecurrenceInHours") (clojure.core/assoc :recurrence-in-hours (deser-recurrence-in-hours (clojure.core/get-in letvar2096709 ["RecurrenceInHours"]))) (letvar2096709 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar2096709 ["Description"]))) (letvar2096709 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar2096709 ["Timezone"])))))))

(clojure.core/defn- response-retrieve-tape-archive-output ([input] (response-retrieve-tape-archive-output nil input)) ([resultWrapper2096711 input] (clojure.core/let [rawinput2096710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096712 {"TapeARN" (rawinput2096710 "TapeARN")}] (clojure.core/cond-> {} (letvar2096712 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096712 ["TapeARN"])))))))

(clojure.core/defn- response-describe-vtl-devices-output ([input] (response-describe-vtl-devices-output nil input)) ([resultWrapper2096714 input] (clojure.core/let [rawinput2096713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096715 {"GatewayARN" (rawinput2096713 "GatewayARN"), "VTLDevices" (rawinput2096713 "VTLDevices"), "Marker" (rawinput2096713 "Marker")}] (clojure.core/cond-> {} (letvar2096715 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096715 ["GatewayARN"]))) (letvar2096715 "VTLDevices") (clojure.core/assoc :vtl-devices (deser-vtl-devices (clojure.core/get-in letvar2096715 ["VTLDevices"]))) (letvar2096715 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096715 ["Marker"])))))))

(clojure.core/defn- response-add-tags-to-resource-output ([input] (response-add-tags-to-resource-output nil input)) ([resultWrapper2096717 input] (clojure.core/let [rawinput2096716 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096718 {"ResourceARN" (rawinput2096716 "ResourceARN")}] (clojure.core/cond-> {} (letvar2096718 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096718 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-tape-output ([input] (response-delete-tape-output nil input)) ([resultWrapper2096720 input] (clojure.core/let [rawinput2096719 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096721 {"TapeARN" (rawinput2096719 "TapeARN")}] (clojure.core/cond-> {} (letvar2096721 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096721 ["TapeARN"])))))))

(clojure.core/defn- response-retrieve-tape-recovery-point-output ([input] (response-retrieve-tape-recovery-point-output nil input)) ([resultWrapper2096723 input] (clojure.core/let [rawinput2096722 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096724 {"TapeARN" (rawinput2096722 "TapeARN")}] (clojure.core/cond-> {} (letvar2096724 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096724 ["TapeARN"])))))))

(clojure.core/defn- response-notify-when-uploaded-output ([input] (response-notify-when-uploaded-output nil input)) ([resultWrapper2096726 input] (clojure.core/let [rawinput2096725 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096727 {"FileShareARN" (rawinput2096725 "FileShareARN"), "NotificationId" (rawinput2096725 "NotificationId")}] (clojure.core/cond-> {} (letvar2096727 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096727 ["FileShareARN"]))) (letvar2096727 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar2096727 ["NotificationId"])))))))

(clojure.core/defn- response-delete-file-share-output ([input] (response-delete-file-share-output nil input)) ([resultWrapper2096729 input] (clojure.core/let [rawinput2096728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096730 {"FileShareARN" (rawinput2096728 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096730 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096730 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-cachedi-scsi-volumes-output ([input] (response-describe-cachedi-scsi-volumes-output nil input)) ([resultWrapper2096732 input] (clojure.core/let [rawinput2096731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096733 {"CachediSCSIVolumes" (rawinput2096731 "CachediSCSIVolumes")}] (clojure.core/cond-> {} (letvar2096733 "CachediSCSIVolumes") (clojure.core/assoc :cachedi-scsi-volumes (deser-cachedi-scsi-volumes (clojure.core/get-in letvar2096733 ["CachediSCSIVolumes"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2096735 input] (clojure.core/let [rawinput2096734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096736 {"message" (rawinput2096734 "message"), "error" (rawinput2096734 "error")}] (clojure.core/cond-> {} (letvar2096736 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096736 ["message"]))) (letvar2096736 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096736 ["error"])))))))

(clojure.core/defn- response-list-tapes-output ([input] (response-list-tapes-output nil input)) ([resultWrapper2096738 input] (clojure.core/let [rawinput2096737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096739 {"TapeInfos" (rawinput2096737 "TapeInfos"), "Marker" (rawinput2096737 "Marker")}] (clojure.core/cond-> {} (letvar2096739 "TapeInfos") (clojure.core/assoc :tape-infos (deser-tape-infos (clojure.core/get-in letvar2096739 ["TapeInfos"]))) (letvar2096739 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096739 ["Marker"])))))))

(clojure.core/defn- response-update-smb-file-share-output ([input] (response-update-smb-file-share-output nil input)) ([resultWrapper2096741 input] (clojure.core/let [rawinput2096740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096742 {"FileShareARN" (rawinput2096740 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096742 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096742 ["FileShareARN"])))))))

(clojure.core/defn- response-update-chap-credentials-output ([input] (response-update-chap-credentials-output nil input)) ([resultWrapper2096744 input] (clojure.core/let [rawinput2096743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096745 {"TargetARN" (rawinput2096743 "TargetARN"), "InitiatorName" (rawinput2096743 "InitiatorName")}] (clojure.core/cond-> {} (letvar2096745 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096745 ["TargetARN"]))) (letvar2096745 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar2096745 ["InitiatorName"])))))))

(clojure.core/defn- response-update-snapshot-schedule-output ([input] (response-update-snapshot-schedule-output nil input)) ([resultWrapper2096747 input] (clojure.core/let [rawinput2096746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096748 {"VolumeARN" (rawinput2096746 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096748 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096748 ["VolumeARN"])))))))

(clojure.core/defn- response-delete-volume-output ([input] (response-delete-volume-output nil input)) ([resultWrapper2096750 input] (clojure.core/let [rawinput2096749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096751 {"VolumeARN" (rawinput2096749 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096751 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096751 ["VolumeARN"])))))))

(clojure.core/defn- response-add-working-storage-output ([input] (response-add-working-storage-output nil input)) ([resultWrapper2096753 input] (clojure.core/let [rawinput2096752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096754 {"GatewayARN" (rawinput2096752 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096754 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096754 ["GatewayARN"])))))))

(clojure.core/defn- response-create-tape-with-barcode-output ([input] (response-create-tape-with-barcode-output nil input)) ([resultWrapper2096756 input] (clojure.core/let [rawinput2096755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096757 {"TapeARN" (rawinput2096755 "TapeARN")}] (clojure.core/cond-> {} (letvar2096757 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096757 ["TapeARN"])))))))

(clojure.core/defn- response-invalid-gateway-request-exception ([input] (response-invalid-gateway-request-exception nil input)) ([resultWrapper2096759 input] (clojure.core/let [rawinput2096758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096760 {"message" (rawinput2096758 "message"), "error" (rawinput2096758 "error")}] (clojure.core/cond-> {} (letvar2096760 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096760 ["message"]))) (letvar2096760 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096760 ["error"])))))))

(clojure.core/defn- response-describe-smb-file-shares-output ([input] (response-describe-smb-file-shares-output nil input)) ([resultWrapper2096762 input] (clojure.core/let [rawinput2096761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096763 {"SMBFileShareInfoList" (rawinput2096761 "SMBFileShareInfoList")}] (clojure.core/cond-> {} (letvar2096763 "SMBFileShareInfoList") (clojure.core/assoc :smb-file-share-info-list (deser-smb-file-share-info-list (clojure.core/get-in letvar2096763 ["SMBFileShareInfoList"])))))))

(clojure.core/defn- response-describe-tapes-output ([input] (response-describe-tapes-output nil input)) ([resultWrapper2096765 input] (clojure.core/let [rawinput2096764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096766 {"Tapes" (rawinput2096764 "Tapes"), "Marker" (rawinput2096764 "Marker")}] (clojure.core/cond-> {} (letvar2096766 "Tapes") (clojure.core/assoc :tapes (deser-tapes (clojure.core/get-in letvar2096766 ["Tapes"]))) (letvar2096766 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096766 ["Marker"])))))))

(clojure.core/defn- response-create-cachedi-scsi-volume-output ([input] (response-create-cachedi-scsi-volume-output nil input)) ([resultWrapper2096768 input] (clojure.core/let [rawinput2096767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096769 {"VolumeARN" (rawinput2096767 "VolumeARN"), "TargetARN" (rawinput2096767 "TargetARN")}] (clojure.core/cond-> {} (letvar2096769 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096769 ["VolumeARN"]))) (letvar2096769 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096769 ["TargetARN"])))))))

(clojure.core/defn- response-set-local-console-password-output ([input] (response-set-local-console-password-output nil input)) ([resultWrapper2096771 input] (clojure.core/let [rawinput2096770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096772 {"GatewayARN" (rawinput2096770 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096772 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096772 ["GatewayARN"])))))))

(clojure.core/defn- response-create-nfs-file-share-output ([input] (response-create-nfs-file-share-output nil input)) ([resultWrapper2096774 input] (clojure.core/let [rawinput2096773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096775 {"FileShareARN" (rawinput2096773 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096775 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096775 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-working-storage-output ([input] (response-describe-working-storage-output nil input)) ([resultWrapper2096777 input] (clojure.core/let [rawinput2096776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096778 {"GatewayARN" (rawinput2096776 "GatewayARN"), "DiskIds" (rawinput2096776 "DiskIds"), "WorkingStorageUsedInBytes" (rawinput2096776 "WorkingStorageUsedInBytes"), "WorkingStorageAllocatedInBytes" (rawinput2096776 "WorkingStorageAllocatedInBytes")}] (clojure.core/cond-> {} (letvar2096778 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096778 ["GatewayARN"]))) (letvar2096778 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096778 ["DiskIds"]))) (letvar2096778 "WorkingStorageUsedInBytes") (clojure.core/assoc :working-storage-used-in-bytes (deserlong (clojure.core/get-in letvar2096778 ["WorkingStorageUsedInBytes"]))) (letvar2096778 "WorkingStorageAllocatedInBytes") (clojure.core/assoc :working-storage-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096778 ["WorkingStorageAllocatedInBytes"])))))))

(clojure.core/defn- response-detach-volume-output ([input] (response-detach-volume-output nil input)) ([resultWrapper2096780 input] (clojure.core/let [rawinput2096779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096781 {"VolumeARN" (rawinput2096779 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096781 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096781 ["VolumeARN"])))))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-allocation-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/notification-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/last-software-update (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/bandwidth-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-attachment-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/location-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 16 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 310))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/next-update-availability-date (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/folder (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 12 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/network-interface-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\A(25[0-5]|2[0-4]\d|[0-1]?\d?\d)(\.(25[0-5]|2[0-4]\d|[0-1]?\d?\d)){3}\z" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 300))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/medium-changer-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/permission-mode (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 4)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[0-7]{4}$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/snapshot-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/kms-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 7 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-status (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/activation-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[ -\.0-\[\]-~]*[!-\.0-\[\]-~][ -\.0-\[\]-~]*$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/ipv-4-address-cidr (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([0-9]|[1-2][0-9]|3[0-2]))?$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-operational-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-drive-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/chap-secret (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 12 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/authentication (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 5 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 15))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/region-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/target-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 200)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[-\.;a-z0-9]+$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/local-console-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 12 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/vtl-device-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 25))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,}$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/storage-class (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 5 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 20))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-timezone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-user (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-user-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/initiator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/organizational-unit (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 50 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/smb-guest-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^(([a-zA-Z0-9\-]*[a-zA-Z0-9])\.)*([A-Za-z0-9\-]*[A-Za-z0-9])(:(\d+))?$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-attribute (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 5 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^\w[\w\.\- ]*$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/snapshot-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\Asnap-([0-9A-Fa-f]{8}|[0-9A-Fa-f]{17})\z" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/squash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 5 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 15))))
