...
(clojure.core/defn- response-join-domain-output ([input] (response-join-domain-output nil input)) ([resultWrapper1817347 input] (clojure.core/let [rawinput1817346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817348 {"GatewayARN" (rawinput1817346 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817348 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817348 ["GatewayARN"])))))))

(clojure.core/defn- response-activate-gateway-output ([input] (response-activate-gateway-output nil input)) ([resultWrapper1817350 input] (clojure.core/let [rawinput1817349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817351 {"GatewayARN" (rawinput1817349 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817351 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817351 ["GatewayARN"])))))))

(clojure.core/defn- response-list-volume-initiators-output ([input] (response-list-volume-initiators-output nil input)) ([resultWrapper1817353 input] (clojure.core/let [rawinput1817352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817354 {"Initiators" (rawinput1817352 "Initiators")}] (clojure.core/cond-> {} (letvar1817354 "Initiators") (clojure.core/assoc :initiators (deser-initiators (clojure.core/get-in letvar1817354 ["Initiators"])))))))

(clojure.core/defn- response-describe-bandwidth-rate-limit-output ([input] (response-describe-bandwidth-rate-limit-output nil input)) ([resultWrapper1817356 input] (clojure.core/let [rawinput1817355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817357 {"GatewayARN" (rawinput1817355 "GatewayARN"), "AverageUploadRateLimitInBitsPerSec" (rawinput1817355 "AverageUploadRateLimitInBitsPerSec"), "AverageDownloadRateLimitInBitsPerSec" (rawinput1817355 "AverageDownloadRateLimitInBitsPerSec")}] (clojure.core/cond-> {} (letvar1817357 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817357 ["GatewayARN"]))) (letvar1817357 "AverageUploadRateLimitInBitsPerSec") (clojure.core/assoc :average-upload-rate-limit-in-bits-per-sec (deser-bandwidth-upload-rate-limit (clojure.core/get-in letvar1817357 ["AverageUploadRateLimitInBitsPerSec"]))) (letvar1817357 "AverageDownloadRateLimitInBitsPerSec") (clojure.core/assoc :average-download-rate-limit-in-bits-per-sec (deser-bandwidth-download-rate-limit (clojure.core/get-in letvar1817357 ["AverageDownloadRateLimitInBitsPerSec"])))))))

(clojure.core/defn- response-list-volume-recovery-points-output ([input] (response-list-volume-recovery-points-output nil input)) ([resultWrapper1817359 input] (clojure.core/let [rawinput1817358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817360 {"GatewayARN" (rawinput1817358 "GatewayARN"), "VolumeRecoveryPointInfos" (rawinput1817358 "VolumeRecoveryPointInfos")}] (clojure.core/cond-> {} (letvar1817360 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817360 ["GatewayARN"]))) (letvar1817360 "VolumeRecoveryPointInfos") (clojure.core/assoc :volume-recovery-point-infos (deser-volume-recovery-point-infos (clojure.core/get-in letvar1817360 ["VolumeRecoveryPointInfos"])))))))

(clojure.core/defn- response-describe-tape-recovery-points-output ([input] (response-describe-tape-recovery-points-output nil input)) ([resultWrapper1817362 input] (clojure.core/let [rawinput1817361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817363 {"GatewayARN" (rawinput1817361 "GatewayARN"), "TapeRecoveryPointInfos" (rawinput1817361 "TapeRecoveryPointInfos"), "Marker" (rawinput1817361 "Marker")}] (clojure.core/cond-> {} (letvar1817363 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817363 ["GatewayARN"]))) (letvar1817363 "TapeRecoveryPointInfos") (clojure.core/assoc :tape-recovery-point-infos (deser-tape-recovery-point-infos (clojure.core/get-in letvar1817363 ["TapeRecoveryPointInfos"]))) (letvar1817363 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817363 ["Marker"])))))))

(clojure.core/defn- response-update-gateway-software-now-output ([input] (response-update-gateway-software-now-output nil input)) ([resultWrapper1817365 input] (clojure.core/let [rawinput1817364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817366 {"GatewayARN" (rawinput1817364 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817366 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817366 ["GatewayARN"])))))))

(clojure.core/defn- response-start-gateway-output ([input] (response-start-gateway-output nil input)) ([resultWrapper1817368 input] (clojure.core/let [rawinput1817367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817369 {"GatewayARN" (rawinput1817367 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817369 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817369 ["GatewayARN"])))))))

(clojure.core/defn- response-create-storedi-scsi-volume-output ([input] (response-create-storedi-scsi-volume-output nil input)) ([resultWrapper1817371 input] (clojure.core/let [rawinput1817370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817372 {"VolumeARN" (rawinput1817370 "VolumeARN"), "VolumeSizeInBytes" (rawinput1817370 "VolumeSizeInBytes"), "TargetARN" (rawinput1817370 "TargetARN")}] (clojure.core/cond-> {} (letvar1817372 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817372 ["VolumeARN"]))) (letvar1817372 "VolumeSizeInBytes") (clojure.core/assoc :volume-size-in-bytes (deserlong (clojure.core/get-in letvar1817372 ["VolumeSizeInBytes"]))) (letvar1817372 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar1817372 ["TargetARN"])))))))

(clojure.core/defn- response-delete-tape-archive-output ([input] (response-delete-tape-archive-output nil input)) ([resultWrapper1817374 input] (clojure.core/let [rawinput1817373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817375 {"TapeARN" (rawinput1817373 "TapeARN")}] (clojure.core/cond-> {} (letvar1817375 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817375 ["TapeARN"])))))))

(clojure.core/defn- response-describe-cache-output ([input] (response-describe-cache-output nil input)) ([resultWrapper1817377 input] (clojure.core/let [rawinput1817376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817378 {"GatewayARN" (rawinput1817376 "GatewayARN"), "DiskIds" (rawinput1817376 "DiskIds"), "CacheAllocatedInBytes" (rawinput1817376 "CacheAllocatedInBytes"), "CacheUsedPercentage" (rawinput1817376 "CacheUsedPercentage"), "CacheDirtyPercentage" (rawinput1817376 "CacheDirtyPercentage"), "CacheHitPercentage" (rawinput1817376 "CacheHitPercentage"), "CacheMissPercentage" (rawinput1817376 "CacheMissPercentage")}] (clojure.core/cond-> {} (letvar1817378 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817378 ["GatewayARN"]))) (letvar1817378 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar1817378 ["DiskIds"]))) (letvar1817378 "CacheAllocatedInBytes") (clojure.core/assoc :cache-allocated-in-bytes (deserlong (clojure.core/get-in letvar1817378 ["CacheAllocatedInBytes"]))) (letvar1817378 "CacheUsedPercentage") (clojure.core/assoc :cache-used-percentage (deserdouble (clojure.core/get-in letvar1817378 ["CacheUsedPercentage"]))) (letvar1817378 "CacheDirtyPercentage") (clojure.core/assoc :cache-dirty-percentage (deserdouble (clojure.core/get-in letvar1817378 ["CacheDirtyPercentage"]))) (letvar1817378 "CacheHitPercentage") (clojure.core/assoc :cache-hit-percentage (deserdouble (clojure.core/get-in letvar1817378 ["CacheHitPercentage"]))) (letvar1817378 "CacheMissPercentage") (clojure.core/assoc :cache-miss-percentage (deserdouble (clojure.core/get-in letvar1817378 ["CacheMissPercentage"])))))))

(clojure.core/defn- response-describe-upload-buffer-output ([input] (response-describe-upload-buffer-output nil input)) ([resultWrapper1817380 input] (clojure.core/let [rawinput1817379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817381 {"GatewayARN" (rawinput1817379 "GatewayARN"), "DiskIds" (rawinput1817379 "DiskIds"), "UploadBufferUsedInBytes" (rawinput1817379 "UploadBufferUsedInBytes"), "UploadBufferAllocatedInBytes" (rawinput1817379 "UploadBufferAllocatedInBytes")}] (clojure.core/cond-> {} (letvar1817381 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817381 ["GatewayARN"]))) (letvar1817381 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar1817381 ["DiskIds"]))) (letvar1817381 "UploadBufferUsedInBytes") (clojure.core/assoc :upload-buffer-used-in-bytes (deserlong (clojure.core/get-in letvar1817381 ["UploadBufferUsedInBytes"]))) (letvar1817381 "UploadBufferAllocatedInBytes") (clojure.core/assoc :upload-buffer-allocated-in-bytes (deserlong (clojure.core/get-in letvar1817381 ["UploadBufferAllocatedInBytes"])))))))

(clojure.core/defn- response-describe-tape-archives-output ([input] (response-describe-tape-archives-output nil input)) ([resultWrapper1817383 input] (clojure.core/let [rawinput1817382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817384 {"TapeArchives" (rawinput1817382 "TapeArchives"), "Marker" (rawinput1817382 "Marker")}] (clojure.core/cond-> {} (letvar1817384 "TapeArchives") (clojure.core/assoc :tape-archives (deser-tape-archives (clojure.core/get-in letvar1817384 ["TapeArchives"]))) (letvar1817384 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817384 ["Marker"])))))))

(clojure.core/defn- response-cancel-archival-output ([input] (response-cancel-archival-output nil input)) ([resultWrapper1817386 input] (clojure.core/let [rawinput1817385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817387 {"TapeARN" (rawinput1817385 "TapeARN")}] (clojure.core/cond-> {} (letvar1817387 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817387 ["TapeARN"])))))))

(clojure.core/defn- response-shutdown-gateway-output ([input] (response-shutdown-gateway-output nil input)) ([resultWrapper1817389 input] (clojure.core/let [rawinput1817388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817390 {"GatewayARN" (rawinput1817388 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817390 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817390 ["GatewayARN"])))))))

(clojure.core/defn- response-update-vtl-device-type-output ([input] (response-update-vtl-device-type-output nil input)) ([resultWrapper1817392 input] (clojure.core/let [rawinput1817391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817393 {"VTLDeviceARN" (rawinput1817391 "VTLDeviceARN")}] (clojure.core/cond-> {} (letvar1817393 "VTLDeviceARN") (clojure.core/assoc :vtl-device-arn (deser-vtl-device-arn (clojure.core/get-in letvar1817393 ["VTLDeviceARN"])))))))

(clojure.core/defn- response-update-bandwidth-rate-limit-output ([input] (response-update-bandwidth-rate-limit-output nil input)) ([resultWrapper1817395 input] (clojure.core/let [rawinput1817394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817396 {"GatewayARN" (rawinput1817394 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817396 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817396 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-chap-credentials-output ([input] (response-delete-chap-credentials-output nil input)) ([resultWrapper1817398 input] (clojure.core/let [rawinput1817397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817399 {"TargetARN" (rawinput1817397 "TargetARN"), "InitiatorName" (rawinput1817397 "InitiatorName")}] (clojure.core/cond-> {} (letvar1817399 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar1817399 ["TargetARN"]))) (letvar1817399 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar1817399 ["InitiatorName"])))))))

(clojure.core/defn- response-describe-chap-credentials-output ([input] (response-describe-chap-credentials-output nil input)) ([resultWrapper1817401 input] (clojure.core/let [rawinput1817400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817402 {"ChapCredentials" (rawinput1817400 "ChapCredentials")}] (clojure.core/cond-> {} (letvar1817402 "ChapCredentials") (clojure.core/assoc :chap-credentials (deser-chap-credentials (clojure.core/get-in letvar1817402 ["ChapCredentials"])))))))

(clojure.core/defn- response-refresh-cache-output ([input] (response-refresh-cache-output nil input)) ([resultWrapper1817404 input] (clojure.core/let [rawinput1817403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817405 {"FileShareARN" (rawinput1817403 "FileShareARN"), "NotificationId" (rawinput1817403 "NotificationId")}] (clojure.core/cond-> {} (letvar1817405 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817405 ["FileShareARN"]))) (letvar1817405 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar1817405 ["NotificationId"])))))))

(clojure.core/defn- response-add-cache-output ([input] (response-add-cache-output nil input)) ([resultWrapper1817407 input] (clojure.core/let [rawinput1817406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817408 {"GatewayARN" (rawinput1817406 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817408 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817408 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-maintenance-start-time-output ([input] (response-describe-maintenance-start-time-output nil input)) ([resultWrapper1817410 input] (clojure.core/let [rawinput1817409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817411 {"GatewayARN" (rawinput1817409 "GatewayARN"), "HourOfDay" (rawinput1817409 "HourOfDay"), "MinuteOfHour" (rawinput1817409 "MinuteOfHour"), "DayOfWeek" (rawinput1817409 "DayOfWeek"), "Timezone" (rawinput1817409 "Timezone")}] (clojure.core/cond-> {} (letvar1817411 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817411 ["GatewayARN"]))) (letvar1817411 "HourOfDay") (clojure.core/assoc :hour-of-day (deser-hour-of-day (clojure.core/get-in letvar1817411 ["HourOfDay"]))) (letvar1817411 "MinuteOfHour") (clojure.core/assoc :minute-of-hour (deser-minute-of-hour (clojure.core/get-in letvar1817411 ["MinuteOfHour"]))) (letvar1817411 "DayOfWeek") (clojure.core/assoc :day-of-week (deser-day-of-week (clojure.core/get-in letvar1817411 ["DayOfWeek"]))) (letvar1817411 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar1817411 ["Timezone"])))))))

(clojure.core/defn- response-create-tapes-output ([input] (response-create-tapes-output nil input)) ([resultWrapper1817413 input] (clojure.core/let [rawinput1817412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817414 {"TapeARNs" (rawinput1817412 "TapeARNs")}] (clojure.core/cond-> {} (letvar1817414 "TapeARNs") (clojure.core/assoc :tape-ar-ns (deser-tape-ar-ns (clojure.core/get-in letvar1817414 ["TapeARNs"])))))))

(clojure.core/defn- response-set-smb-guest-password-output ([input] (response-set-smb-guest-password-output nil input)) ([resultWrapper1817416 input] (clojure.core/let [rawinput1817415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817417 {"GatewayARN" (rawinput1817415 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817417 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817417 ["GatewayARN"])))))))

(clojure.core/defn- response-create-snapshot-from-volume-recovery-point-output ([input] (response-create-snapshot-from-volume-recovery-point-output nil input)) ([resultWrapper1817419 input] (clojure.core/let [rawinput1817418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817420 {"SnapshotId" (rawinput1817418 "SnapshotId"), "VolumeARN" (rawinput1817418 "VolumeARN"), "VolumeRecoveryPointTime" (rawinput1817418 "VolumeRecoveryPointTime")}] (clojure.core/cond-> {} (letvar1817420 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1817420 ["SnapshotId"]))) (letvar1817420 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817420 ["VolumeARN"]))) (letvar1817420 "VolumeRecoveryPointTime") (clojure.core/assoc :volume-recovery-point-time (deserstring (clojure.core/get-in letvar1817420 ["VolumeRecoveryPointTime"])))))))

(clojure.core/defn- response-cancel-retrieval-output ([input] (response-cancel-retrieval-output nil input)) ([resultWrapper1817422 input] (clojure.core/let [rawinput1817421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817423 {"TapeARN" (rawinput1817421 "TapeARN")}] (clojure.core/cond-> {} (letvar1817423 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817423 ["TapeARN"])))))))

(clojure.core/defn- response-list-local-disks-output ([input] (response-list-local-disks-output nil input)) ([resultWrapper1817425 input] (clojure.core/let [rawinput1817424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817426 {"GatewayARN" (rawinput1817424 "GatewayARN"), "Disks" (rawinput1817424 "Disks")}] (clojure.core/cond-> {} (letvar1817426 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817426 ["GatewayARN"]))) (letvar1817426 "Disks") (clojure.core/assoc :disks (deser-disks (clojure.core/get-in letvar1817426 ["Disks"])))))))

(clojure.core/defn- response-create-snapshot-output ([input] (response-create-snapshot-output nil input)) ([resultWrapper1817428 input] (clojure.core/let [rawinput1817427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817429 {"VolumeARN" (rawinput1817427 "VolumeARN"), "SnapshotId" (rawinput1817427 "SnapshotId")}] (clojure.core/cond-> {} (letvar1817429 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817429 ["VolumeARN"]))) (letvar1817429 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1817429 ["SnapshotId"])))))))

(clojure.core/defn- response-describe-gateway-information-output ([input] (response-describe-gateway-information-output nil input)) ([resultWrapper1817431 input] (clojure.core/let [rawinput1817430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817432 {"LastSoftwareUpdate" (rawinput1817430 "LastSoftwareUpdate"), "NextUpdateAvailabilityDate" (rawinput1817430 "NextUpdateAvailabilityDate"), "GatewayNetworkInterfaces" (rawinput1817430 "GatewayNetworkInterfaces"), "Tags" (rawinput1817430 "Tags"), "GatewayName" (rawinput1817430 "GatewayName"), "GatewayId" (rawinput1817430 "GatewayId"), "GatewayState" (rawinput1817430 "GatewayState"), "GatewayType" (rawinput1817430 "GatewayType"), "GatewayTimezone" (rawinput1817430 "GatewayTimezone"), "GatewayARN" (rawinput1817430 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817432 "LastSoftwareUpdate") (clojure.core/assoc :last-software-update (deser-last-software-update (clojure.core/get-in letvar1817432 ["LastSoftwareUpdate"]))) (letvar1817432 "NextUpdateAvailabilityDate") (clojure.core/assoc :next-update-availability-date (deser-next-update-availability-date (clojure.core/get-in letvar1817432 ["NextUpdateAvailabilityDate"]))) (letvar1817432 "GatewayNetworkInterfaces") (clojure.core/assoc :gateway-network-interfaces (deser-gateway-network-interfaces (clojure.core/get-in letvar1817432 ["GatewayNetworkInterfaces"]))) (letvar1817432 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1817432 ["Tags"]))) (letvar1817432 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar1817432 ["GatewayName"]))) (letvar1817432 "GatewayId") (clojure.core/assoc :gateway-id (deser-gateway-id (clojure.core/get-in letvar1817432 ["GatewayId"]))) (letvar1817432 "GatewayState") (clojure.core/assoc :gateway-state (deser-gateway-state (clojure.core/get-in letvar1817432 ["GatewayState"]))) (letvar1817432 "GatewayType") (clojure.core/assoc :gateway-type (deser-gateway-type (clojure.core/get-in letvar1817432 ["GatewayType"]))) (letvar1817432 "GatewayTimezone") (clojure.core/assoc :gateway-timezone (deser-gateway-timezone (clojure.core/get-in letvar1817432 ["GatewayTimezone"]))) (letvar1817432 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817432 ["GatewayARN"])))))))

(clojure.core/defn- response-create-smb-file-share-output ([input] (response-create-smb-file-share-output nil input)) ([resultWrapper1817434 input] (clojure.core/let [rawinput1817433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817435 {"FileShareARN" (rawinput1817433 "FileShareARN")}] (clojure.core/cond-> {} (letvar1817435 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817435 ["FileShareARN"])))))))

(clojure.core/defn- response-add-upload-buffer-output ([input] (response-add-upload-buffer-output nil input)) ([resultWrapper1817437 input] (clojure.core/let [rawinput1817436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817438 {"GatewayARN" (rawinput1817436 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817438 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817438 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-storedi-scsi-volumes-output ([input] (response-describe-storedi-scsi-volumes-output nil input)) ([resultWrapper1817440 input] (clojure.core/let [rawinput1817439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817441 {"StorediSCSIVolumes" (rawinput1817439 "StorediSCSIVolumes")}] (clojure.core/cond-> {} (letvar1817441 "StorediSCSIVolumes") (clojure.core/assoc :storedi-scsi-volumes (deser-storedi-scsi-volumes (clojure.core/get-in letvar1817441 ["StorediSCSIVolumes"])))))))

(clojure.core/defn- response-list-volumes-output ([input] (response-list-volumes-output nil input)) ([resultWrapper1817443 input] (clojure.core/let [rawinput1817442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817444 {"GatewayARN" (rawinput1817442 "GatewayARN"), "Marker" (rawinput1817442 "Marker"), "VolumeInfos" (rawinput1817442 "VolumeInfos")}] (clojure.core/cond-> {} (letvar1817444 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817444 ["GatewayARN"]))) (letvar1817444 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817444 ["Marker"]))) (letvar1817444 "VolumeInfos") (clojure.core/assoc :volume-infos (deser-volume-infos (clojure.core/get-in letvar1817444 ["VolumeInfos"])))))))

(clojure.core/defn- response-disable-gateway-output ([input] (response-disable-gateway-output nil input)) ([resultWrapper1817446 input] (clojure.core/let [rawinput1817445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817447 {"GatewayARN" (rawinput1817445 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817447 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817447 ["GatewayARN"])))))))

(clojure.core/defn- response-list-file-shares-output ([input] (response-list-file-shares-output nil input)) ([resultWrapper1817449 input] (clojure.core/let [rawinput1817448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817450 {"Marker" (rawinput1817448 "Marker"), "NextMarker" (rawinput1817448 "NextMarker"), "FileShareInfoList" (rawinput1817448 "FileShareInfoList")}] (clojure.core/cond-> {} (letvar1817450 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817450 ["Marker"]))) (letvar1817450 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar1817450 ["NextMarker"]))) (letvar1817450 "FileShareInfoList") (clojure.core/assoc :file-share-info-list (deser-file-share-info-list (clojure.core/get-in letvar1817450 ["FileShareInfoList"])))))))

(clojure.core/defn- response-remove-tags-from-resource-output ([input] (response-remove-tags-from-resource-output nil input)) ([resultWrapper1817452 input] (clojure.core/let [rawinput1817451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817453 {"ResourceARN" (rawinput1817451 "ResourceARN")}] (clojure.core/cond-> {} (letvar1817453 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar1817453 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-snapshot-schedule-output ([input] (response-delete-snapshot-schedule-output nil input)) ([resultWrapper1817455 input] (clojure.core/let [rawinput1817454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817456 {"VolumeARN" (rawinput1817454 "VolumeARN")}] (clojure.core/cond-> {} (letvar1817456 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817456 ["VolumeARN"])))))))

(clojure.core/defn- response-describe-smb-settings-output ([input] (response-describe-smb-settings-output nil input)) ([resultWrapper1817458 input] (clojure.core/let [rawinput1817457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817459 {"GatewayARN" (rawinput1817457 "GatewayARN"), "DomainName" (rawinput1817457 "DomainName"), "SMBGuestPasswordSet" (rawinput1817457 "SMBGuestPasswordSet")}] (clojure.core/cond-> {} (letvar1817459 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817459 ["GatewayARN"]))) (letvar1817459 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1817459 ["DomainName"]))) (letvar1817459 "SMBGuestPasswordSet") (clojure.core/assoc :smb-guest-password-set (deser-boolean (clojure.core/get-in letvar1817459 ["SMBGuestPasswordSet"])))))))

(clojure.core/defn- response-delete-bandwidth-rate-limit-output ([input] (response-delete-bandwidth-rate-limit-output nil input)) ([resultWrapper1817461 input] (clojure.core/let [rawinput1817460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817462 {"GatewayARN" (rawinput1817460 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817462 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817462 ["GatewayARN"])))))))

(clojure.core/defn- response-update-maintenance-start-time-output ([input] (response-update-maintenance-start-time-output nil input)) ([resultWrapper1817464 input] (clojure.core/let [rawinput1817463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817465 {"GatewayARN" (rawinput1817463 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817465 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817465 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-gateway-output ([input] (response-delete-gateway-output nil input)) ([resultWrapper1817467 input] (clojure.core/let [rawinput1817466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817468 {"GatewayARN" (rawinput1817466 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817468 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817468 ["GatewayARN"])))))))

(clojure.core/defn- response-list-gateways-output ([input] (response-list-gateways-output nil input)) ([resultWrapper1817470 input] (clojure.core/let [rawinput1817469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817471 {"Gateways" (rawinput1817469 "Gateways"), "Marker" (rawinput1817469 "Marker")}] (clojure.core/cond-> {} (letvar1817471 "Gateways") (clojure.core/assoc :gateways (deser-gateways (clojure.core/get-in letvar1817471 ["Gateways"]))) (letvar1817471 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817471 ["Marker"])))))))

(clojure.core/defn- response-update-nfs-file-share-output ([input] (response-update-nfs-file-share-output nil input)) ([resultWrapper1817473 input] (clojure.core/let [rawinput1817472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817474 {"FileShareARN" (rawinput1817472 "FileShareARN")}] (clojure.core/cond-> {} (letvar1817474 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817474 ["FileShareARN"])))))))

(clojure.core/defn- response-update-gateway-information-output ([input] (response-update-gateway-information-output nil input)) ([resultWrapper1817476 input] (clojure.core/let [rawinput1817475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817477 {"GatewayARN" (rawinput1817475 "GatewayARN"), "GatewayName" (rawinput1817475 "GatewayName")}] (clojure.core/cond-> {} (letvar1817477 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817477 ["GatewayARN"]))) (letvar1817477 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar1817477 ["GatewayName"])))))))

(clojure.core/defn- response-service-unavailable-error ([input] (response-service-unavailable-error nil input)) ([resultWrapper1817479 input] (clojure.core/let [rawinput1817478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817480 {"message" (rawinput1817478 "message"), "error" (rawinput1817478 "error")}] (clojure.core/cond-> {} (letvar1817480 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1817480 ["message"]))) (letvar1817480 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar1817480 ["error"])))))))

(clojure.core/defn- response-describe-nfs-file-shares-output ([input] (response-describe-nfs-file-shares-output nil input)) ([resultWrapper1817482 input] (clojure.core/let [rawinput1817481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817483 {"NFSFileShareInfoList" (rawinput1817481 "NFSFileShareInfoList")}] (clojure.core/cond-> {} (letvar1817483 "NFSFileShareInfoList") (clojure.core/assoc :nfs-file-share-info-list (deser-nfs-file-share-info-list (clojure.core/get-in letvar1817483 ["NFSFileShareInfoList"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper1817485 input] (clojure.core/let [rawinput1817484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817486 {"ResourceARN" (rawinput1817484 "ResourceARN"), "Marker" (rawinput1817484 "Marker"), "Tags" (rawinput1817484 "Tags")}] (clojure.core/cond-> {} (letvar1817486 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar1817486 ["ResourceARN"]))) (letvar1817486 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817486 ["Marker"]))) (letvar1817486 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1817486 ["Tags"])))))))

(clojure.core/defn- response-attach-volume-output ([input] (response-attach-volume-output nil input)) ([resultWrapper1817488 input] (clojure.core/let [rawinput1817487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817489 {"VolumeARN" (rawinput1817487 "VolumeARN"), "TargetARN" (rawinput1817487 "TargetARN")}] (clojure.core/cond-> {} (letvar1817489 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817489 ["VolumeARN"]))) (letvar1817489 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar1817489 ["TargetARN"])))))))

(clojure.core/defn- response-reset-cache-output ([input] (response-reset-cache-output nil input)) ([resultWrapper1817491 input] (clojure.core/let [rawinput1817490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817492 {"GatewayARN" (rawinput1817490 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817492 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817492 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-snapshot-schedule-output ([input] (response-describe-snapshot-schedule-output nil input)) ([resultWrapper1817494 input] (clojure.core/let [rawinput1817493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817495 {"VolumeARN" (rawinput1817493 "VolumeARN"), "StartAt" (rawinput1817493 "StartAt"), "RecurrenceInHours" (rawinput1817493 "RecurrenceInHours"), "Description" (rawinput1817493 "Description"), "Timezone" (rawinput1817493 "Timezone")}] (clojure.core/cond-> {} (letvar1817495 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817495 ["VolumeARN"]))) (letvar1817495 "StartAt") (clojure.core/assoc :start-at (deser-hour-of-day (clojure.core/get-in letvar1817495 ["StartAt"]))) (letvar1817495 "RecurrenceInHours") (clojure.core/assoc :recurrence-in-hours (deser-recurrence-in-hours (clojure.core/get-in letvar1817495 ["RecurrenceInHours"]))) (letvar1817495 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1817495 ["Description"]))) (letvar1817495 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar1817495 ["Timezone"])))))))

(clojure.core/defn- response-retrieve-tape-archive-output ([input] (response-retrieve-tape-archive-output nil input)) ([resultWrapper1817497 input] (clojure.core/let [rawinput1817496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817498 {"TapeARN" (rawinput1817496 "TapeARN")}] (clojure.core/cond-> {} (letvar1817498 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817498 ["TapeARN"])))))))

(clojure.core/defn- response-describe-vtl-devices-output ([input] (response-describe-vtl-devices-output nil input)) ([resultWrapper1817500 input] (clojure.core/let [rawinput1817499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817501 {"GatewayARN" (rawinput1817499 "GatewayARN"), "VTLDevices" (rawinput1817499 "VTLDevices"), "Marker" (rawinput1817499 "Marker")}] (clojure.core/cond-> {} (letvar1817501 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817501 ["GatewayARN"]))) (letvar1817501 "VTLDevices") (clojure.core/assoc :vtl-devices (deser-vtl-devices (clojure.core/get-in letvar1817501 ["VTLDevices"]))) (letvar1817501 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817501 ["Marker"])))))))

(clojure.core/defn- response-add-tags-to-resource-output ([input] (response-add-tags-to-resource-output nil input)) ([resultWrapper1817503 input] (clojure.core/let [rawinput1817502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817504 {"ResourceARN" (rawinput1817502 "ResourceARN")}] (clojure.core/cond-> {} (letvar1817504 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar1817504 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-tape-output ([input] (response-delete-tape-output nil input)) ([resultWrapper1817506 input] (clojure.core/let [rawinput1817505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817507 {"TapeARN" (rawinput1817505 "TapeARN")}] (clojure.core/cond-> {} (letvar1817507 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817507 ["TapeARN"])))))))

(clojure.core/defn- response-retrieve-tape-recovery-point-output ([input] (response-retrieve-tape-recovery-point-output nil input)) ([resultWrapper1817509 input] (clojure.core/let [rawinput1817508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817510 {"TapeARN" (rawinput1817508 "TapeARN")}] (clojure.core/cond-> {} (letvar1817510 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817510 ["TapeARN"])))))))

(clojure.core/defn- response-notify-when-uploaded-output ([input] (response-notify-when-uploaded-output nil input)) ([resultWrapper1817512 input] (clojure.core/let [rawinput1817511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817513 {"FileShareARN" (rawinput1817511 "FileShareARN"), "NotificationId" (rawinput1817511 "NotificationId")}] (clojure.core/cond-> {} (letvar1817513 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817513 ["FileShareARN"]))) (letvar1817513 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar1817513 ["NotificationId"])))))))

(clojure.core/defn- response-delete-file-share-output ([input] (response-delete-file-share-output nil input)) ([resultWrapper1817515 input] (clojure.core/let [rawinput1817514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817516 {"FileShareARN" (rawinput1817514 "FileShareARN")}] (clojure.core/cond-> {} (letvar1817516 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817516 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-cachedi-scsi-volumes-output ([input] (response-describe-cachedi-scsi-volumes-output nil input)) ([resultWrapper1817518 input] (clojure.core/let [rawinput1817517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817519 {"CachediSCSIVolumes" (rawinput1817517 "CachediSCSIVolumes")}] (clojure.core/cond-> {} (letvar1817519 "CachediSCSIVolumes") (clojure.core/assoc :cachedi-scsi-volumes (deser-cachedi-scsi-volumes (clojure.core/get-in letvar1817519 ["CachediSCSIVolumes"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1817521 input] (clojure.core/let [rawinput1817520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817522 {"message" (rawinput1817520 "message"), "error" (rawinput1817520 "error")}] (clojure.core/cond-> {} (letvar1817522 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1817522 ["message"]))) (letvar1817522 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar1817522 ["error"])))))))

(clojure.core/defn- response-list-tapes-output ([input] (response-list-tapes-output nil input)) ([resultWrapper1817524 input] (clojure.core/let [rawinput1817523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817525 {"TapeInfos" (rawinput1817523 "TapeInfos"), "Marker" (rawinput1817523 "Marker")}] (clojure.core/cond-> {} (letvar1817525 "TapeInfos") (clojure.core/assoc :tape-infos (deser-tape-infos (clojure.core/get-in letvar1817525 ["TapeInfos"]))) (letvar1817525 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817525 ["Marker"])))))))

(clojure.core/defn- response-update-smb-file-share-output ([input] (response-update-smb-file-share-output nil input)) ([resultWrapper1817527 input] (clojure.core/let [rawinput1817526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817528 {"FileShareARN" (rawinput1817526 "FileShareARN")}] (clojure.core/cond-> {} (letvar1817528 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817528 ["FileShareARN"])))))))

(clojure.core/defn- response-update-chap-credentials-output ([input] (response-update-chap-credentials-output nil input)) ([resultWrapper1817530 input] (clojure.core/let [rawinput1817529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817531 {"TargetARN" (rawinput1817529 "TargetARN"), "InitiatorName" (rawinput1817529 "InitiatorName")}] (clojure.core/cond-> {} (letvar1817531 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar1817531 ["TargetARN"]))) (letvar1817531 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar1817531 ["InitiatorName"])))))))

(clojure.core/defn- response-update-snapshot-schedule-output ([input] (response-update-snapshot-schedule-output nil input)) ([resultWrapper1817533 input] (clojure.core/let [rawinput1817532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817534 {"VolumeARN" (rawinput1817532 "VolumeARN")}] (clojure.core/cond-> {} (letvar1817534 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817534 ["VolumeARN"])))))))

(clojure.core/defn- response-delete-volume-output ([input] (response-delete-volume-output nil input)) ([resultWrapper1817536 input] (clojure.core/let [rawinput1817535 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817537 {"VolumeARN" (rawinput1817535 "VolumeARN")}] (clojure.core/cond-> {} (letvar1817537 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817537 ["VolumeARN"])))))))

(clojure.core/defn- response-add-working-storage-output ([input] (response-add-working-storage-output nil input)) ([resultWrapper1817539 input] (clojure.core/let [rawinput1817538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817540 {"GatewayARN" (rawinput1817538 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817540 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817540 ["GatewayARN"])))))))

(clojure.core/defn- response-create-tape-with-barcode-output ([input] (response-create-tape-with-barcode-output nil input)) ([resultWrapper1817542 input] (clojure.core/let [rawinput1817541 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817543 {"TapeARN" (rawinput1817541 "TapeARN")}] (clojure.core/cond-> {} (letvar1817543 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar1817543 ["TapeARN"])))))))

(clojure.core/defn- response-invalid-gateway-request-exception ([input] (response-invalid-gateway-request-exception nil input)) ([resultWrapper1817545 input] (clojure.core/let [rawinput1817544 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817546 {"message" (rawinput1817544 "message"), "error" (rawinput1817544 "error")}] (clojure.core/cond-> {} (letvar1817546 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1817546 ["message"]))) (letvar1817546 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar1817546 ["error"])))))))

(clojure.core/defn- response-describe-smb-file-shares-output ([input] (response-describe-smb-file-shares-output nil input)) ([resultWrapper1817548 input] (clojure.core/let [rawinput1817547 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817549 {"SMBFileShareInfoList" (rawinput1817547 "SMBFileShareInfoList")}] (clojure.core/cond-> {} (letvar1817549 "SMBFileShareInfoList") (clojure.core/assoc :smb-file-share-info-list (deser-smb-file-share-info-list (clojure.core/get-in letvar1817549 ["SMBFileShareInfoList"])))))))

(clojure.core/defn- response-describe-tapes-output ([input] (response-describe-tapes-output nil input)) ([resultWrapper1817551 input] (clojure.core/let [rawinput1817550 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817552 {"Tapes" (rawinput1817550 "Tapes"), "Marker" (rawinput1817550 "Marker")}] (clojure.core/cond-> {} (letvar1817552 "Tapes") (clojure.core/assoc :tapes (deser-tapes (clojure.core/get-in letvar1817552 ["Tapes"]))) (letvar1817552 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1817552 ["Marker"])))))))

(clojure.core/defn- response-create-cachedi-scsi-volume-output ([input] (response-create-cachedi-scsi-volume-output nil input)) ([resultWrapper1817554 input] (clojure.core/let [rawinput1817553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817555 {"VolumeARN" (rawinput1817553 "VolumeARN"), "TargetARN" (rawinput1817553 "TargetARN")}] (clojure.core/cond-> {} (letvar1817555 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817555 ["VolumeARN"]))) (letvar1817555 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar1817555 ["TargetARN"])))))))

(clojure.core/defn- response-set-local-console-password-output ([input] (response-set-local-console-password-output nil input)) ([resultWrapper1817557 input] (clojure.core/let [rawinput1817556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817558 {"GatewayARN" (rawinput1817556 "GatewayARN")}] (clojure.core/cond-> {} (letvar1817558 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817558 ["GatewayARN"])))))))

(clojure.core/defn- response-create-nfs-file-share-output ([input] (response-create-nfs-file-share-output nil input)) ([resultWrapper1817560 input] (clojure.core/let [rawinput1817559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817561 {"FileShareARN" (rawinput1817559 "FileShareARN")}] (clojure.core/cond-> {} (letvar1817561 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar1817561 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-working-storage-output ([input] (response-describe-working-storage-output nil input)) ([resultWrapper1817563 input] (clojure.core/let [rawinput1817562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817564 {"GatewayARN" (rawinput1817562 "GatewayARN"), "DiskIds" (rawinput1817562 "DiskIds"), "WorkingStorageUsedInBytes" (rawinput1817562 "WorkingStorageUsedInBytes"), "WorkingStorageAllocatedInBytes" (rawinput1817562 "WorkingStorageAllocatedInBytes")}] (clojure.core/cond-> {} (letvar1817564 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar1817564 ["GatewayARN"]))) (letvar1817564 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar1817564 ["DiskIds"]))) (letvar1817564 "WorkingStorageUsedInBytes") (clojure.core/assoc :working-storage-used-in-bytes (deserlong (clojure.core/get-in letvar1817564 ["WorkingStorageUsedInBytes"]))) (letvar1817564 "WorkingStorageAllocatedInBytes") (clojure.core/assoc :working-storage-allocated-in-bytes (deserlong (clojure.core/get-in letvar1817564 ["WorkingStorageAllocatedInBytes"])))))))

(clojure.core/defn- response-detach-volume-output ([input] (response-detach-volume-output nil input)) ([resultWrapper1817566 input] (clojure.core/let [rawinput1817565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1817567 {"VolumeARN" (rawinput1817565 "VolumeARN")}] (clojure.core/cond-> {} (letvar1817567 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar1817567 ["VolumeARN"])))))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-allocation-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/notification-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/last-software-update (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/bandwidth-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-attachment-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/location-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 16 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 310))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/next-update-availability-date (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/folder (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/network-interface-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\A(25[0-5]|2[0-4]\d|[0-1]?\d?\d)(\.(25[0-5]|2[0-4]\d|[0-1]?\d?\d)){3}\z" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 300))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/medium-changer-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/permission-mode (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 4)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-7]{4}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/snapshot-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/kms-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 7 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-status (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/activation-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[ -\.0-\[\]-~]*[!-\.0-\[\]-~][ -\.0-\[\]-~]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/ipv-4-address-cidr (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([0-9]|[1-2][0-9]|3[0-2]))?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn|aws-us-gov):storagegateway:[a-z\-0-9]+:[0-9]+:tape\/[0-9A-Z]{7,16}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-operational-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/iqn-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9a-z:.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-drive-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/tape-barcode (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 7 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[A-Z0-9]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/chap-secret (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/authentication (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 15))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/region-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/target-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[-\.;a-z0-9]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/local-console-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 6 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[ -~]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/vtl-device-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/storage-class (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-timezone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/file-share-user (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-user-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[ -~]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/initiator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/volume-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/organizational-unit (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/gateway-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 50 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/smb-guest-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 6 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[ -~]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(([a-zA-Z0-9\-]*[a-zA-Z0-9])\.)*([A-Za-z0-9\-]*[A-Za-z0-9])(:(\d+))?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/disk-attribute (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/domain-user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\w[\w\.\- ]*$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/snapshot-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\Asnap-([0-9A-Fa-f]{8}|[0-9A-Fa-f]{17})\z" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway.-2013-06-30/squash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 15))))
