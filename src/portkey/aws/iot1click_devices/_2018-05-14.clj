...
(clojure.core/defn- response-invoke-device-method-response ([input] (response-invoke-device-method-response nil input)) ([resultWrapper1142063 input] (clojure.core/let [rawinput1142062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142064 {"deviceMethodResponse" (rawinput1142062 "deviceMethodResponse")}] (clojure.core/cond-> {} (letvar1142064 "deviceMethodResponse") (clojure.core/assoc :device-method-response (deser-string (clojure.core/get-in letvar1142064 ["deviceMethodResponse"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper1142066 input] (clojure.core/let [rawinput1142065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142067 {"code" (rawinput1142065 "code"), "message" (rawinput1142065 "message")}] (clojure.core/cond-> {} (letvar1142067 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142067 ["code"]))) (letvar1142067 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142067 ["message"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1142069 input] (clojure.core/let [rawinput1142068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142070 {"code" (rawinput1142068 "code"), "message" (rawinput1142068 "message")}] (clojure.core/cond-> {} (letvar1142070 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142070 ["code"]))) (letvar1142070 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142070 ["message"])))))))

(clojure.core/defn- response-get-device-methods-response ([input] (response-get-device-methods-response nil input)) ([resultWrapper1142072 input] (clojure.core/let [rawinput1142071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142073 {"deviceMethods" (rawinput1142071 "deviceMethods")}] (clojure.core/cond-> {} (letvar1142073 "deviceMethods") (clojure.core/assoc :device-methods (deser-list-of-device-method (clojure.core/get-in letvar1142073 ["deviceMethods"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1142075 input] (clojure.core/let [rawinput1142074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142076 {"code" (rawinput1142074 "code"), "message" (rawinput1142074 "message")}] (clojure.core/cond-> {} (letvar1142076 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142076 ["code"]))) (letvar1142076 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142076 ["message"])))))))

(clojure.core/defn- response-initiate-device-claim-response ([input] (response-initiate-device-claim-response nil input)) ([resultWrapper1142078 input] (clojure.core/let [rawinput1142077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142079 {"state" (rawinput1142077 "state")}] (clojure.core/cond-> {} (letvar1142079 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1142079 ["state"])))))))

(clojure.core/defn- response-update-device-state-response ([input] (response-update-device-state-response nil input)) ([resultWrapper1142081 input] (clojure.core/let [rawinput1142080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142082 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1142084 input] (clojure.core/let [rawinput1142083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142085 {"code" (rawinput1142083 "code"), "message" (rawinput1142083 "message")}] (clojure.core/cond-> {} (letvar1142085 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142085 ["code"]))) (letvar1142085 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142085 ["message"])))))))

(clojure.core/defn- response-describe-device-response ([input] (response-describe-device-response nil input)) ([resultWrapper1142087 input] (clojure.core/let [rawinput1142086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142088 {"deviceDescription" (rawinput1142086 "deviceDescription")}] (clojure.core/cond-> {} (letvar1142088 "deviceDescription") (clojure.core/assoc :device-description (deser-device-description (clojure.core/get-in letvar1142088 ["deviceDescription"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1142090 input] (clojure.core/let [rawinput1142089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142091 {"code" (rawinput1142089 "code"), "message" (rawinput1142089 "message")}] (clojure.core/cond-> {} (letvar1142091 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142091 ["code"]))) (letvar1142091 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142091 ["message"])))))))

(clojure.core/defn- response-claim-devices-by-claim-code-response ([input] (response-claim-devices-by-claim-code-response nil input)) ([resultWrapper1142093 input] (clojure.core/let [rawinput1142092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142094 {"claimCode" (rawinput1142092 "claimCode"), "total" (rawinput1142092 "total")}] (clojure.core/cond-> {} (letvar1142094 "claimCode") (clojure.core/assoc :claim-code (deser-string-min-12-max-40 (clojure.core/get-in letvar1142094 ["claimCode"]))) (letvar1142094 "total") (clojure.core/assoc :total (deser-integer (clojure.core/get-in letvar1142094 ["total"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1142096 input] (clojure.core/let [rawinput1142095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142097 {"code" (rawinput1142095 "code"), "message" (rawinput1142095 "message")}] (clojure.core/cond-> {} (letvar1142097 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142097 ["code"]))) (letvar1142097 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142097 ["message"])))))))

(clojure.core/defn- response-list-device-events-response ([input] (response-list-device-events-response nil input)) ([resultWrapper1142099 input] (clojure.core/let [rawinput1142098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142100 {"events" (rawinput1142098 "events"), "nextToken" (rawinput1142098 "nextToken")}] (clojure.core/cond-> {} (letvar1142100 "events") (clojure.core/assoc :events (deser-list-of-device-event (clojure.core/get-in letvar1142100 ["events"]))) (letvar1142100 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1142100 ["nextToken"])))))))

(clojure.core/defn- response-range-not-satisfiable-exception ([input] (response-range-not-satisfiable-exception nil input)) ([resultWrapper1142102 input] (clojure.core/let [rawinput1142101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142103 {"code" (rawinput1142101 "code"), "message" (rawinput1142101 "message")}] (clojure.core/cond-> {} (letvar1142103 "code") (clojure.core/assoc :code (deser-string (clojure.core/get-in letvar1142103 ["code"]))) (letvar1142103 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1142103 ["message"])))))))

(clojure.core/defn- response-unclaim-device-response ([input] (response-unclaim-device-response nil input)) ([resultWrapper1142105 input] (clojure.core/let [rawinput1142104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142106 {"state" (rawinput1142104 "state")}] (clojure.core/cond-> {} (letvar1142106 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1142106 ["state"])))))))

(clojure.core/defn- response-finalize-device-claim-response ([input] (response-finalize-device-claim-response nil input)) ([resultWrapper1142108 input] (clojure.core/let [rawinput1142107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142109 {"state" (rawinput1142107 "state")}] (clojure.core/cond-> {} (letvar1142109 "state") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1142109 ["state"])))))))

(clojure.core/defn- response-list-devices-response ([input] (response-list-devices-response nil input)) ([resultWrapper1142111 input] (clojure.core/let [rawinput1142110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1142112 {"devices" (rawinput1142110 "devices"), "nextToken" (rawinput1142110 "nextToken")}] (clojure.core/cond-> {} (letvar1142112 "devices") (clojure.core/assoc :devices (deser-list-of-device-description (clojure.core/get-in letvar1142112 ["devices"]))) (letvar1142112 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1142112 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-devices.-2018-05-14/string-min-12-max-40 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 40))))
