...
(clojure.spec.alpha/def :portkey.aws.organizations/child-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(\d{12})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/generic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::.+:.+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-target-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(r-[0-9a-z]{4,32})|(\d{12})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/role-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\w+=,.@-]{1,64}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-notes (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/parent-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(r-[0-9a-z]{4,32})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^o-[a-z0-9]{10,32}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1000000))))

(clojure.spec.alpha/def :portkey.aws.organizations/create-account-request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^car-[a-z0-9]{8,32}$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/service-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^p-[0-9a-zA-Z_]{8,128}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:root\/o-[a-z0-9]{10,32}\/r-[0-9a-z]{4,32}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^r-[0-9a-z]{4,32}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^h-[0-9a-z]{8,32}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:account\/o-[a-z0-9]{10,32}\/\d{12}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^\d{12}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(arn:aws:organizations::\d{12}:policy\/o-[a-z0-9]{10,32}\/[0-9a-z_]+\/p-[0-9a-z]{10,32})|(arn:aws:organizations::aws:policy\/[0-9a-z_]+\/p-[0-9a-zA-Z_]{10,128})" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 50)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\u007E]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organization-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:organization\/o-[a-z0-9]{10,32}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/target-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^ou-[0-9a-z]{4,32}-[a-z0-9]{8,32}$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-type #{:service-control-policy "SERVICE_CONTROL_POLICY"})

(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:ou\/o-[a-z0-9]{10,32}\/ou-[0-9a-z]{4,32}-[0-9a-z]{8,32}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-party-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:handshake\/o-[a-z0-9]{10,32}\/[a-z_]{1,32}\/h-[0-9a-z]{8,32}" s__27881__auto__))))
...
(clojure.core/defn decline-handshake ([decline-handshake-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-decline-handshake-request decline-handshake-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.organizations/endpoints, :http.request.configuration/target-prefix "AWSOrganizationsV20161128", :http.request.spec/output-spec :portkey.aws.organizations/decline-handshake-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-11-28", :http.request.configuration/service-id "Organizations", :http.request.spec/input-spec :portkey.aws.organizations/decline-handshake-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeclineHandshake", :http.request.configuration/output-deser-fn deser-decline-handshake-response, :http.request.spec/error-spec {"AccessDeniedException" :portkey.aws.organizations/access-denied-exception, "ConcurrentModificationException" :portkey.aws.organizations/concurrent-modification-exception, "HandshakeNotFoundException" :portkey.aws.organizations/handshake-not-found-exception, "InvalidHandshakeTransitionException" :portkey.aws.organizations/invalid-handshake-transition-exception, "HandshakeAlreadyInStateException" :portkey.aws.organizations/handshake-already-in-state-exception, "InvalidInputException" :portkey.aws.organizations/invalid-input-exception, "ServiceException" :portkey.aws.organizations/service-exception, "TooManyRequestsException" :portkey.aws.organizations/too-many-requests-exception}})))))
...
(clojure.core/defn cancel-handshake ([cancel-handshake-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-cancel-handshake-request cancel-handshake-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.organizations/endpoints, :http.request.configuration/target-prefix "AWSOrganizationsV20161128", :http.request.spec/output-spec :portkey.aws.organizations/cancel-handshake-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-11-28", :http.request.configuration/service-id "Organizations", :http.request.spec/input-spec :portkey.aws.organizations/cancel-handshake-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CancelHandshake", :http.request.configuration/output-deser-fn deser-cancel-handshake-response, :http.request.spec/error-spec {"AccessDeniedException" :portkey.aws.organizations/access-denied-exception, "ConcurrentModificationException" :portkey.aws.organizations/concurrent-modification-exception, "HandshakeNotFoundException" :portkey.aws.organizations/handshake-not-found-exception, "InvalidHandshakeTransitionException" :portkey.aws.organizations/invalid-handshake-transition-exception, "HandshakeAlreadyInStateException" :portkey.aws.organizations/handshake-already-in-state-exception, "InvalidInputException" :portkey.aws.organizations/invalid-input-exception, "ServiceException" :portkey.aws.organizations/service-exception, "TooManyRequestsException" :portkey.aws.organizations/too-many-requests-exception}})))))
