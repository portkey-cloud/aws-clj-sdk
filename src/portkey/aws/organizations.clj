...
(clojure.core/defn- response-organization-not-empty-exception ([input] (response-organization-not-empty-exception nil input)) ([resultWrapper1930299 input] (clojure.core/let [rawinput1930298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930300 {"Message" (rawinput1930298 "Message")}] (clojure.core/cond-> {} (letvar1930300 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930300 ["Message"])))))))

(clojure.core/defn- response-disable-policy-type-response ([input] (response-disable-policy-type-response nil input)) ([resultWrapper1930302 input] (clojure.core/let [rawinput1930301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930303 {"Root" (rawinput1930301 "Root")}] (clojure.core/cond-> {} (letvar1930303 "Root") (clojure.core/assoc :root (deser-root (clojure.core/get-in letvar1930303 ["Root"])))))))

(clojure.core/defn- response-handshake-not-found-exception ([input] (response-handshake-not-found-exception nil input)) ([resultWrapper1930305 input] (clojure.core/let [rawinput1930304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930306 {"Message" (rawinput1930304 "Message")}] (clojure.core/cond-> {} (letvar1930306 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930306 ["Message"])))))))

(clojure.core/defn- response-list-targets-for-policy-response ([input] (response-list-targets-for-policy-response nil input)) ([resultWrapper1930308 input] (clojure.core/let [rawinput1930307 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930309 {"Targets" (rawinput1930307 "Targets"), "NextToken" (rawinput1930307 "NextToken")}] (clojure.core/cond-> {} (letvar1930309 "Targets") (clojure.core/assoc :targets (deser-policy-targets (clojure.core/get-in letvar1930309 ["Targets"]))) (letvar1930309 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930309 ["NextToken"])))))))

(clojure.core/defn- response-handshake-already-in-state-exception ([input] (response-handshake-already-in-state-exception nil input)) ([resultWrapper1930311 input] (clojure.core/let [rawinput1930310 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930312 {"Message" (rawinput1930310 "Message")}] (clojure.core/cond-> {} (letvar1930312 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930312 ["Message"])))))))

(clojure.core/defn- response-list-aws-service-access-for-organization-response ([input] (response-list-aws-service-access-for-organization-response nil input)) ([resultWrapper1930314 input] (clojure.core/let [rawinput1930313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930315 {"EnabledServicePrincipals" (rawinput1930313 "EnabledServicePrincipals"), "NextToken" (rawinput1930313 "NextToken")}] (clojure.core/cond-> {} (letvar1930315 "EnabledServicePrincipals") (clojure.core/assoc :enabled-service-principals (deser-enabled-service-principals (clojure.core/get-in letvar1930315 ["EnabledServicePrincipals"]))) (letvar1930315 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930315 ["NextToken"])))))))

(clojure.core/defn- response-list-create-account-status-response ([input] (response-list-create-account-status-response nil input)) ([resultWrapper1930317 input] (clojure.core/let [rawinput1930316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930318 {"CreateAccountStatuses" (rawinput1930316 "CreateAccountStatuses"), "NextToken" (rawinput1930316 "NextToken")}] (clojure.core/cond-> {} (letvar1930318 "CreateAccountStatuses") (clojure.core/assoc :create-account-statuses (deser-create-account-statuses (clojure.core/get-in letvar1930318 ["CreateAccountStatuses"]))) (letvar1930318 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930318 ["NextToken"])))))))

(clojure.core/defn- response-accept-handshake-response ([input] (response-accept-handshake-response nil input)) ([resultWrapper1930320 input] (clojure.core/let [rawinput1930319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930321 {"Handshake" (rawinput1930319 "Handshake")}] (clojure.core/cond-> {} (letvar1930321 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930321 ["Handshake"])))))))

(clojure.core/defn- response-describe-policy-response ([input] (response-describe-policy-response nil input)) ([resultWrapper1930323 input] (clojure.core/let [rawinput1930322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930324 {"Policy" (rawinput1930322 "Policy")}] (clojure.core/cond-> {} (letvar1930324 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1930324 ["Policy"])))))))

(clojure.core/defn- response-update-policy-response ([input] (response-update-policy-response nil input)) ([resultWrapper1930326 input] (clojure.core/let [rawinput1930325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930327 {"Policy" (rawinput1930325 "Policy")}] (clojure.core/cond-> {} (letvar1930327 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1930327 ["Policy"])))))))

(clojure.core/defn- response-finalizing-organization-exception ([input] (response-finalizing-organization-exception nil input)) ([resultWrapper1930329 input] (clojure.core/let [rawinput1930328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930330 {"Message" (rawinput1930328 "Message")}] (clojure.core/cond-> {} (letvar1930330 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930330 ["Message"])))))))

(clojure.core/defn- response-list-parents-response ([input] (response-list-parents-response nil input)) ([resultWrapper1930332 input] (clojure.core/let [rawinput1930331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930333 {"Parents" (rawinput1930331 "Parents"), "NextToken" (rawinput1930331 "NextToken")}] (clojure.core/cond-> {} (letvar1930333 "Parents") (clojure.core/assoc :parents (deser-parents (clojure.core/get-in letvar1930333 ["Parents"]))) (letvar1930333 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930333 ["NextToken"])))))))

(clojure.core/defn- response-list-policies-for-target-response ([input] (response-list-policies-for-target-response nil input)) ([resultWrapper1930335 input] (clojure.core/let [rawinput1930334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930336 {"Policies" (rawinput1930334 "Policies"), "NextToken" (rawinput1930334 "NextToken")}] (clojure.core/cond-> {} (letvar1930336 "Policies") (clojure.core/assoc :policies (deser-policies (clojure.core/get-in letvar1930336 ["Policies"]))) (letvar1930336 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930336 ["NextToken"])))))))

(clojure.core/defn- response-describe-create-account-status-response ([input] (response-describe-create-account-status-response nil input)) ([resultWrapper1930338 input] (clojure.core/let [rawinput1930337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930339 {"CreateAccountStatus" (rawinput1930337 "CreateAccountStatus")}] (clojure.core/cond-> {} (letvar1930339 "CreateAccountStatus") (clojure.core/assoc :create-account-status (deser-create-account-status (clojure.core/get-in letvar1930339 ["CreateAccountStatus"])))))))

(clojure.core/defn- response-list-accounts-for-parent-response ([input] (response-list-accounts-for-parent-response nil input)) ([resultWrapper1930341 input] (clojure.core/let [rawinput1930340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930342 {"Accounts" (rawinput1930340 "Accounts"), "NextToken" (rawinput1930340 "NextToken")}] (clojure.core/cond-> {} (letvar1930342 "Accounts") (clojure.core/assoc :accounts (deser-accounts (clojure.core/get-in letvar1930342 ["Accounts"]))) (letvar1930342 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930342 ["NextToken"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1930344 input] (clojure.core/let [rawinput1930343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930345 {"Message" (rawinput1930343 "Message")}] (clojure.core/cond-> {} (letvar1930345 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930345 ["Message"])))))))

(clojure.core/defn- response-list-organizational-units-for-parent-response ([input] (response-list-organizational-units-for-parent-response nil input)) ([resultWrapper1930347 input] (clojure.core/let [rawinput1930346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930348 {"OrganizationalUnits" (rawinput1930346 "OrganizationalUnits"), "NextToken" (rawinput1930346 "NextToken")}] (clojure.core/cond-> {} (letvar1930348 "OrganizationalUnits") (clojure.core/assoc :organizational-units (deser-organizational-units (clojure.core/get-in letvar1930348 ["OrganizationalUnits"]))) (letvar1930348 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930348 ["NextToken"])))))))

(clojure.core/defn- response-decline-handshake-response ([input] (response-decline-handshake-response nil input)) ([resultWrapper1930350 input] (clojure.core/let [rawinput1930349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930351 {"Handshake" (rawinput1930349 "Handshake")}] (clojure.core/cond-> {} (letvar1930351 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930351 ["Handshake"])))))))

(clojure.core/defn- response-destination-parent-not-found-exception ([input] (response-destination-parent-not-found-exception nil input)) ([resultWrapper1930353 input] (clojure.core/let [rawinput1930352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930354 {"Message" (rawinput1930352 "Message")}] (clojure.core/cond-> {} (letvar1930354 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930354 ["Message"])))))))

(clojure.core/defn- response-enable-all-features-response ([input] (response-enable-all-features-response nil input)) ([resultWrapper1930356 input] (clojure.core/let [rawinput1930355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930357 {"Handshake" (rawinput1930355 "Handshake")}] (clojure.core/cond-> {} (letvar1930357 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930357 ["Handshake"])))))))

(clojure.core/defn- response-list-accounts-response ([input] (response-list-accounts-response nil input)) ([resultWrapper1930359 input] (clojure.core/let [rawinput1930358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930360 {"Accounts" (rawinput1930358 "Accounts"), "NextToken" (rawinput1930358 "NextToken")}] (clojure.core/cond-> {} (letvar1930360 "Accounts") (clojure.core/assoc :accounts (deser-accounts (clojure.core/get-in letvar1930360 ["Accounts"]))) (letvar1930360 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930360 ["NextToken"])))))))

(clojure.core/defn- response-account-owner-not-verified-exception ([input] (response-account-owner-not-verified-exception nil input)) ([resultWrapper1930362 input] (clojure.core/let [rawinput1930361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930363 {"Message" (rawinput1930361 "Message")}] (clojure.core/cond-> {} (letvar1930363 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930363 ["Message"])))))))

(clojure.core/defn- response-policy-not-attached-exception ([input] (response-policy-not-attached-exception nil input)) ([resultWrapper1930365 input] (clojure.core/let [rawinput1930364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930366 {"Message" (rawinput1930364 "Message")}] (clojure.core/cond-> {} (letvar1930366 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930366 ["Message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1930368 input] (clojure.core/let [rawinput1930367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930369 {"Type" (rawinput1930367 "Type"), "Message" (rawinput1930367 "Message")}] (clojure.core/cond-> {} (letvar1930369 "Type") (clojure.core/assoc :type (deser-exception-type (clojure.core/get-in letvar1930369 ["Type"]))) (letvar1930369 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930369 ["Message"])))))))

(clojure.core/defn- response-list-children-response ([input] (response-list-children-response nil input)) ([resultWrapper1930371 input] (clojure.core/let [rawinput1930370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930372 {"Children" (rawinput1930370 "Children"), "NextToken" (rawinput1930370 "NextToken")}] (clojure.core/cond-> {} (letvar1930372 "Children") (clojure.core/assoc :children (deser-children (clojure.core/get-in letvar1930372 ["Children"]))) (letvar1930372 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930372 ["NextToken"])))))))

(clojure.core/defn- response-describe-handshake-response ([input] (response-describe-handshake-response nil input)) ([resultWrapper1930374 input] (clojure.core/let [rawinput1930373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930375 {"Handshake" (rawinput1930373 "Handshake")}] (clojure.core/cond-> {} (letvar1930375 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930375 ["Handshake"])))))))

(clojure.core/defn- response-child-not-found-exception ([input] (response-child-not-found-exception nil input)) ([resultWrapper1930377 input] (clojure.core/let [rawinput1930376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930378 {"Message" (rawinput1930376 "Message")}] (clojure.core/cond-> {} (letvar1930378 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930378 ["Message"])))))))

(clojure.core/defn- response-root-not-found-exception ([input] (response-root-not-found-exception nil input)) ([resultWrapper1930380 input] (clojure.core/let [rawinput1930379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930381 {"Message" (rawinput1930379 "Message")}] (clojure.core/cond-> {} (letvar1930381 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930381 ["Message"])))))))

(clojure.core/defn- response-list-roots-response ([input] (response-list-roots-response nil input)) ([resultWrapper1930383 input] (clojure.core/let [rawinput1930382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930384 {"Roots" (rawinput1930382 "Roots"), "NextToken" (rawinput1930382 "NextToken")}] (clojure.core/cond-> {} (letvar1930384 "Roots") (clojure.core/assoc :roots (deser-roots (clojure.core/get-in letvar1930384 ["Roots"]))) (letvar1930384 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930384 ["NextToken"])))))))

(clojure.core/defn- response-create-account-response ([input] (response-create-account-response nil input)) ([resultWrapper1930386 input] (clojure.core/let [rawinput1930385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930387 {"CreateAccountStatus" (rawinput1930385 "CreateAccountStatus")}] (clojure.core/cond-> {} (letvar1930387 "CreateAccountStatus") (clojure.core/assoc :create-account-status (deser-create-account-status (clojure.core/get-in letvar1930387 ["CreateAccountStatus"])))))))

(clojure.core/defn- response-describe-organization-response ([input] (response-describe-organization-response nil input)) ([resultWrapper1930389 input] (clojure.core/let [rawinput1930388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930390 {"Organization" (rawinput1930388 "Organization")}] (clojure.core/cond-> {} (letvar1930390 "Organization") (clojure.core/assoc :organization (deser-organization (clojure.core/get-in letvar1930390 ["Organization"])))))))

(clojure.core/defn- response-create-organization-response ([input] (response-create-organization-response nil input)) ([resultWrapper1930392 input] (clojure.core/let [rawinput1930391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930393 {"Organization" (rawinput1930391 "Organization")}] (clojure.core/cond-> {} (letvar1930393 "Organization") (clojure.core/assoc :organization (deser-organization (clojure.core/get-in letvar1930393 ["Organization"])))))))

(clojure.core/defn- response-enable-policy-type-response ([input] (response-enable-policy-type-response nil input)) ([resultWrapper1930395 input] (clojure.core/let [rawinput1930394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930396 {"Root" (rawinput1930394 "Root")}] (clojure.core/cond-> {} (letvar1930396 "Root") (clojure.core/assoc :root (deser-root (clojure.core/get-in letvar1930396 ["Root"])))))))

(clojure.core/defn- response-update-organizational-unit-response ([input] (response-update-organizational-unit-response nil input)) ([resultWrapper1930398 input] (clojure.core/let [rawinput1930397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930399 {"OrganizationalUnit" (rawinput1930397 "OrganizationalUnit")}] (clojure.core/cond-> {} (letvar1930399 "OrganizationalUnit") (clojure.core/assoc :organizational-unit (deser-organizational-unit (clojure.core/get-in letvar1930399 ["OrganizationalUnit"])))))))

(clojure.core/defn- response-policy-not-found-exception ([input] (response-policy-not-found-exception nil input)) ([resultWrapper1930401 input] (clojure.core/let [rawinput1930400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930402 {"Message" (rawinput1930400 "Message")}] (clojure.core/cond-> {} (letvar1930402 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930402 ["Message"])))))))

(clojure.core/defn- response-duplicate-organizational-unit-exception ([input] (response-duplicate-organizational-unit-exception nil input)) ([resultWrapper1930404 input] (clojure.core/let [rawinput1930403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930405 {"Message" (rawinput1930403 "Message")}] (clojure.core/cond-> {} (letvar1930405 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930405 ["Message"])))))))

(clojure.core/defn- response-malformed-policy-document-exception ([input] (response-malformed-policy-document-exception nil input)) ([resultWrapper1930407 input] (clojure.core/let [rawinput1930406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930408 {"Message" (rawinput1930406 "Message")}] (clojure.core/cond-> {} (letvar1930408 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930408 ["Message"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1930410 input] (clojure.core/let [rawinput1930409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930411 {"Message" (rawinput1930409 "Message"), "Reason" (rawinput1930409 "Reason")}] (clojure.core/cond-> {} (letvar1930411 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930411 ["Message"]))) (letvar1930411 "Reason") (clojure.core/assoc :reason (deser-invalid-input-exception-reason (clojure.core/get-in letvar1930411 ["Reason"])))))))

(clojure.core/defn- response-create-policy-response ([input] (response-create-policy-response nil input)) ([resultWrapper1930413 input] (clojure.core/let [rawinput1930412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930414 {"Policy" (rawinput1930412 "Policy")}] (clojure.core/cond-> {} (letvar1930414 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1930414 ["Policy"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1930416 input] (clojure.core/let [rawinput1930415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930417 {"Message" (rawinput1930415 "Message")}] (clojure.core/cond-> {} (letvar1930417 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930417 ["Message"])))))))

(clojure.core/defn- response-list-handshakes-for-organization-response ([input] (response-list-handshakes-for-organization-response nil input)) ([resultWrapper1930419 input] (clojure.core/let [rawinput1930418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930420 {"Handshakes" (rawinput1930418 "Handshakes"), "NextToken" (rawinput1930418 "NextToken")}] (clojure.core/cond-> {} (letvar1930420 "Handshakes") (clojure.core/assoc :handshakes (deser-handshakes (clojure.core/get-in letvar1930420 ["Handshakes"]))) (letvar1930420 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930420 ["NextToken"])))))))

(clojure.core/defn- response-duplicate-policy-attachment-exception ([input] (response-duplicate-policy-attachment-exception nil input)) ([resultWrapper1930422 input] (clojure.core/let [rawinput1930421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930423 {"Message" (rawinput1930421 "Message")}] (clojure.core/cond-> {} (letvar1930423 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930423 ["Message"])))))))

(clojure.core/defn- response-duplicate-policy-exception ([input] (response-duplicate-policy-exception nil input)) ([resultWrapper1930425 input] (clojure.core/let [rawinput1930424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930426 {"Message" (rawinput1930424 "Message")}] (clojure.core/cond-> {} (letvar1930426 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930426 ["Message"])))))))

(clojure.core/defn- response-describe-organizational-unit-response ([input] (response-describe-organizational-unit-response nil input)) ([resultWrapper1930428 input] (clojure.core/let [rawinput1930427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930429 {"OrganizationalUnit" (rawinput1930427 "OrganizationalUnit")}] (clojure.core/cond-> {} (letvar1930429 "OrganizationalUnit") (clojure.core/assoc :organizational-unit (deser-organizational-unit (clojure.core/get-in letvar1930429 ["OrganizationalUnit"])))))))

(clojure.core/defn- response-describe-account-response ([input] (response-describe-account-response nil input)) ([resultWrapper1930431 input] (clojure.core/let [rawinput1930430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930432 {"Account" (rawinput1930430 "Account")}] (clojure.core/cond-> {} (letvar1930432 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar1930432 ["Account"])))))))

(clojure.core/defn- response-aws-organizations-not-in-use-exception ([input] (response-aws-organizations-not-in-use-exception nil input)) ([resultWrapper1930434 input] (clojure.core/let [rawinput1930433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930435 {"Message" (rawinput1930433 "Message")}] (clojure.core/cond-> {} (letvar1930435 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930435 ["Message"])))))))

(clojure.core/defn- response-organizational-unit-not-found-exception ([input] (response-organizational-unit-not-found-exception nil input)) ([resultWrapper1930437 input] (clojure.core/let [rawinput1930436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930438 {"Message" (rawinput1930436 "Message")}] (clojure.core/cond-> {} (letvar1930438 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930438 ["Message"])))))))

(clojure.core/defn- response-account-not-found-exception ([input] (response-account-not-found-exception nil input)) ([resultWrapper1930440 input] (clojure.core/let [rawinput1930439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930441 {"Message" (rawinput1930439 "Message")}] (clojure.core/cond-> {} (letvar1930441 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930441 ["Message"])))))))

(clojure.core/defn- response-constraint-violation-exception ([input] (response-constraint-violation-exception nil input)) ([resultWrapper1930443 input] (clojure.core/let [rawinput1930442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930444 {"Message" (rawinput1930442 "Message"), "Reason" (rawinput1930442 "Reason")}] (clojure.core/cond-> {} (letvar1930444 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930444 ["Message"]))) (letvar1930444 "Reason") (clojure.core/assoc :reason (deser-constraint-violation-exception-reason (clojure.core/get-in letvar1930444 ["Reason"])))))))

(clojure.core/defn- response-parent-not-found-exception ([input] (response-parent-not-found-exception nil input)) ([resultWrapper1930446 input] (clojure.core/let [rawinput1930445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930447 {"Message" (rawinput1930445 "Message")}] (clojure.core/cond-> {} (letvar1930447 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930447 ["Message"])))))))

(clojure.core/defn- response-create-organizational-unit-response ([input] (response-create-organizational-unit-response nil input)) ([resultWrapper1930449 input] (clojure.core/let [rawinput1930448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930450 {"OrganizationalUnit" (rawinput1930448 "OrganizationalUnit")}] (clojure.core/cond-> {} (letvar1930450 "OrganizationalUnit") (clojure.core/assoc :organizational-unit (deser-organizational-unit (clojure.core/get-in letvar1930450 ["OrganizationalUnit"])))))))

(clojure.core/defn- response-access-denied-for-dependency-exception ([input] (response-access-denied-for-dependency-exception nil input)) ([resultWrapper1930452 input] (clojure.core/let [rawinput1930451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930453 {"Message" (rawinput1930451 "Message"), "Reason" (rawinput1930451 "Reason")}] (clojure.core/cond-> {} (letvar1930453 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930453 ["Message"]))) (letvar1930453 "Reason") (clojure.core/assoc :reason (deser-access-denied-for-dependency-exception-reason (clojure.core/get-in letvar1930453 ["Reason"])))))))

(clojure.core/defn- response-source-parent-not-found-exception ([input] (response-source-parent-not-found-exception nil input)) ([resultWrapper1930455 input] (clojure.core/let [rawinput1930454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930456 {"Message" (rawinput1930454 "Message")}] (clojure.core/cond-> {} (letvar1930456 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930456 ["Message"])))))))

(clojure.core/defn- response-policy-type-not-available-for-organization-exception ([input] (response-policy-type-not-available-for-organization-exception nil input)) ([resultWrapper1930458 input] (clojure.core/let [rawinput1930457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930459 {"Message" (rawinput1930457 "Message")}] (clojure.core/cond-> {} (letvar1930459 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930459 ["Message"])))))))

(clojure.core/defn- response-target-not-found-exception ([input] (response-target-not-found-exception nil input)) ([resultWrapper1930461 input] (clojure.core/let [rawinput1930460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930462 {"Message" (rawinput1930460 "Message")}] (clojure.core/cond-> {} (letvar1930462 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930462 ["Message"])))))))

(clojure.core/defn- response-create-account-status-not-found-exception ([input] (response-create-account-status-not-found-exception nil input)) ([resultWrapper1930464 input] (clojure.core/let [rawinput1930463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930465 {"Message" (rawinput1930463 "Message")}] (clojure.core/cond-> {} (letvar1930465 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930465 ["Message"])))))))

(clojure.core/defn- response-list-policies-response ([input] (response-list-policies-response nil input)) ([resultWrapper1930467 input] (clojure.core/let [rawinput1930466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930468 {"Policies" (rawinput1930466 "Policies"), "NextToken" (rawinput1930466 "NextToken")}] (clojure.core/cond-> {} (letvar1930468 "Policies") (clojure.core/assoc :policies (deser-policies (clojure.core/get-in letvar1930468 ["Policies"]))) (letvar1930468 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930468 ["NextToken"])))))))

(clojure.core/defn- response-already-in-organization-exception ([input] (response-already-in-organization-exception nil input)) ([resultWrapper1930470 input] (clojure.core/let [rawinput1930469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930471 {"Message" (rawinput1930469 "Message")}] (clojure.core/cond-> {} (letvar1930471 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930471 ["Message"])))))))

(clojure.core/defn- response-handshake-constraint-violation-exception ([input] (response-handshake-constraint-violation-exception nil input)) ([resultWrapper1930473 input] (clojure.core/let [rawinput1930472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930474 {"Message" (rawinput1930472 "Message"), "Reason" (rawinput1930472 "Reason")}] (clojure.core/cond-> {} (letvar1930474 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930474 ["Message"]))) (letvar1930474 "Reason") (clojure.core/assoc :reason (deser-handshake-constraint-violation-exception-reason (clojure.core/get-in letvar1930474 ["Reason"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1930476 input] (clojure.core/let [rawinput1930475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930477 {"Message" (rawinput1930475 "Message")}] (clojure.core/cond-> {} (letvar1930477 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930477 ["Message"])))))))

(clojure.core/defn- response-list-handshakes-for-account-response ([input] (response-list-handshakes-for-account-response nil input)) ([resultWrapper1930479 input] (clojure.core/let [rawinput1930478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930480 {"Handshakes" (rawinput1930478 "Handshakes"), "NextToken" (rawinput1930478 "NextToken")}] (clojure.core/cond-> {} (letvar1930480 "Handshakes") (clojure.core/assoc :handshakes (deser-handshakes (clojure.core/get-in letvar1930480 ["Handshakes"]))) (letvar1930480 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1930480 ["NextToken"])))))))

(clojure.core/defn- response-organizational-unit-not-empty-exception ([input] (response-organizational-unit-not-empty-exception nil input)) ([resultWrapper1930482 input] (clojure.core/let [rawinput1930481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930483 {"Message" (rawinput1930481 "Message")}] (clojure.core/cond-> {} (letvar1930483 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930483 ["Message"])))))))

(clojure.core/defn- response-invalid-handshake-transition-exception ([input] (response-invalid-handshake-transition-exception nil input)) ([resultWrapper1930485 input] (clojure.core/let [rawinput1930484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930486 {"Message" (rawinput1930484 "Message")}] (clojure.core/cond-> {} (letvar1930486 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930486 ["Message"])))))))

(clojure.core/defn- response-master-cannot-leave-organization-exception ([input] (response-master-cannot-leave-organization-exception nil input)) ([resultWrapper1930488 input] (clojure.core/let [rawinput1930487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930489 {"Message" (rawinput1930487 "Message")}] (clojure.core/cond-> {} (letvar1930489 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930489 ["Message"])))))))

(clojure.core/defn- response-policy-type-already-enabled-exception ([input] (response-policy-type-already-enabled-exception nil input)) ([resultWrapper1930491 input] (clojure.core/let [rawinput1930490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930492 {"Message" (rawinput1930490 "Message")}] (clojure.core/cond-> {} (letvar1930492 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930492 ["Message"])))))))

(clojure.core/defn- response-duplicate-handshake-exception ([input] (response-duplicate-handshake-exception nil input)) ([resultWrapper1930494 input] (clojure.core/let [rawinput1930493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930495 {"Message" (rawinput1930493 "Message")}] (clojure.core/cond-> {} (letvar1930495 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930495 ["Message"])))))))

(clojure.core/defn- response-invite-account-to-organization-response ([input] (response-invite-account-to-organization-response nil input)) ([resultWrapper1930497 input] (clojure.core/let [rawinput1930496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930498 {"Handshake" (rawinput1930496 "Handshake")}] (clojure.core/cond-> {} (letvar1930498 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930498 ["Handshake"])))))))

(clojure.core/defn- response-duplicate-account-exception ([input] (response-duplicate-account-exception nil input)) ([resultWrapper1930500 input] (clojure.core/let [rawinput1930499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930501 {"Message" (rawinput1930499 "Message")}] (clojure.core/cond-> {} (letvar1930501 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930501 ["Message"])))))))

(clojure.core/defn- response-policy-in-use-exception ([input] (response-policy-in-use-exception nil input)) ([resultWrapper1930503 input] (clojure.core/let [rawinput1930502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930504 {"Message" (rawinput1930502 "Message")}] (clojure.core/cond-> {} (letvar1930504 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930504 ["Message"])))))))

(clojure.core/defn- response-cancel-handshake-response ([input] (response-cancel-handshake-response nil input)) ([resultWrapper1930506 input] (clojure.core/let [rawinput1930505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930507 {"Handshake" (rawinput1930505 "Handshake")}] (clojure.core/cond-> {} (letvar1930507 "Handshake") (clojure.core/assoc :handshake (deser-handshake (clojure.core/get-in letvar1930507 ["Handshake"])))))))

(clojure.core/defn- response-policy-type-not-enabled-exception ([input] (response-policy-type-not-enabled-exception nil input)) ([resultWrapper1930509 input] (clojure.core/let [rawinput1930508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1930510 {"Message" (rawinput1930508 "Message")}] (clojure.core/cond-> {} (letvar1930510 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1930510 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/child-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(\d{12})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/generic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::.+:.+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^\s@]+@[^\s@]+\.[^\s@]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-target-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(r-[0-9a-z]{4,32})|(\d{12})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/role-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+=,.@-]{1,64}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-notes (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/parent-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(r-[0-9a-z]{4,32})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^o-[a-z0-9]{10,32}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000000))))

(clojure.spec.alpha/def :portkey.aws.organizations/create-account-request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^car-[a-z0-9]{8,32}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/service-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^p-[0-9a-zA-Z_]{8,128}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:root\/o-[a-z0-9]{10,32}\/r-[0-9a-z]{4,32}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/root-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^r-[0-9a-z]{4,32}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^h-[0-9a-z]{8,32}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:account\/o-[a-z0-9]{10,32}\/\d{12}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\d{12}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/policy-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(arn:aws:organizations::\d{12}:policy\/o-[a-z0-9]{10,32}\/[0-9a-z_]+\/p-[0-9a-z]{10,32})|(arn:aws:organizations::aws:policy\/[0-9a-z_]+\/p-[0-9a-zA-Z_]{10,128})" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\u007E]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organization-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:organization\/o-[a-z0-9]{10,32}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/target-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^ou-[0-9a-z]{4,32}-[a-z0-9]{8,32}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.organizations/policy-type #{:service-control-policy "SERVICE_CONTROL_POLICY"})

(clojure.spec.alpha/def :portkey.aws.organizations/organizational-unit-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:ou\/o-[a-z0-9]{10,32}\/ou-[0-9a-z]{4,32}-[0-9a-z]{8,32}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-party-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.organizations/handshake-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:organizations::\d{12}:handshake\/o-[a-z0-9]{10,32}\/[a-z_]{1,32}\/h-[0-9a-z]{8,32}" s__1410940__auto__))))
