...
(clojure.core/defn- response-lookup-developer-identity-response ([input] (response-lookup-developer-identity-response nil input)) ([resultWrapper1549361 input] (clojure.core/let [rawinput1549360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549362 {"IdentityId" (rawinput1549360 "IdentityId"), "DeveloperUserIdentifierList" (rawinput1549360 "DeveloperUserIdentifierList"), "NextToken" (rawinput1549360 "NextToken")}] (clojure.core/cond-> {} (letvar1549362 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549362 ["IdentityId"]))) (letvar1549362 "DeveloperUserIdentifierList") (clojure.core/assoc :developer-user-identifier-list (deser-developer-user-identifier-list (clojure.core/get-in letvar1549362 ["DeveloperUserIdentifierList"]))) (letvar1549362 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1549362 ["NextToken"])))))))

(clojure.core/defn- response-get-open-id-token-response ([input] (response-get-open-id-token-response nil input)) ([resultWrapper1549364 input] (clojure.core/let [rawinput1549363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549365 {"IdentityId" (rawinput1549363 "IdentityId"), "Token" (rawinput1549363 "Token")}] (clojure.core/cond-> {} (letvar1549365 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549365 ["IdentityId"]))) (letvar1549365 "Token") (clojure.core/assoc :token (deser-oidc-token (clojure.core/get-in letvar1549365 ["Token"])))))))

(clojure.core/defn- response-get-id-response ([input] (response-get-id-response nil input)) ([resultWrapper1549367 input] (clojure.core/let [rawinput1549366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549368 {"IdentityId" (rawinput1549366 "IdentityId")}] (clojure.core/cond-> {} (letvar1549368 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549368 ["IdentityId"])))))))

(clojure.core/defn- response-delete-identities-response ([input] (response-delete-identities-response nil input)) ([resultWrapper1549370 input] (clojure.core/let [rawinput1549369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549371 {"UnprocessedIdentityIds" (rawinput1549369 "UnprocessedIdentityIds")}] (clojure.core/cond-> {} (letvar1549371 "UnprocessedIdentityIds") (clojure.core/assoc :unprocessed-identity-ids (deser-unprocessed-identity-id-list (clojure.core/get-in letvar1549371 ["UnprocessedIdentityIds"])))))))

(clojure.core/defn- response-invalid-identity-pool-configuration-exception ([input] (response-invalid-identity-pool-configuration-exception nil input)) ([resultWrapper1549373 input] (clojure.core/let [rawinput1549372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549374 {"message" (rawinput1549372 "message")}] (clojure.core/cond-> {} (letvar1549374 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549374 ["message"])))))))

(clojure.core/defn- response-developer-user-already-registered-exception ([input] (response-developer-user-already-registered-exception nil input)) ([resultWrapper1549376 input] (clojure.core/let [rawinput1549375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549377 {"message" (rawinput1549375 "message")}] (clojure.core/cond-> {} (letvar1549377 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549377 ["message"])))))))

(clojure.core/defn- response-get-credentials-for-identity-response ([input] (response-get-credentials-for-identity-response nil input)) ([resultWrapper1549379 input] (clojure.core/let [rawinput1549378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549380 {"IdentityId" (rawinput1549378 "IdentityId"), "Credentials" (rawinput1549378 "Credentials")}] (clojure.core/cond-> {} (letvar1549380 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549380 ["IdentityId"]))) (letvar1549380 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar1549380 ["Credentials"])))))))

(clojure.core/defn- response-get-open-id-token-for-developer-identity-response ([input] (response-get-open-id-token-for-developer-identity-response nil input)) ([resultWrapper1549382 input] (clojure.core/let [rawinput1549381 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549383 {"IdentityId" (rawinput1549381 "IdentityId"), "Token" (rawinput1549381 "Token")}] (clojure.core/cond-> {} (letvar1549383 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549383 ["IdentityId"]))) (letvar1549383 "Token") (clojure.core/assoc :token (deser-oidc-token (clojure.core/get-in letvar1549383 ["Token"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1549385 input] (clojure.core/let [rawinput1549384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549386 {"message" (rawinput1549384 "message")}] (clojure.core/cond-> {} (letvar1549386 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549386 ["message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1549388 input] (clojure.core/let [rawinput1549387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549389 {"message" (rawinput1549387 "message")}] (clojure.core/cond-> {} (letvar1549389 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549389 ["message"])))))))

(clojure.core/defn- response-identity-description ([input] (response-identity-description nil input)) ([resultWrapper1549391 input] (clojure.core/let [rawinput1549390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549392 {"IdentityId" (rawinput1549390 "IdentityId"), "Logins" (rawinput1549390 "Logins"), "CreationDate" (rawinput1549390 "CreationDate"), "LastModifiedDate" (rawinput1549390 "LastModifiedDate")}] (clojure.core/cond-> {} (letvar1549392 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549392 ["IdentityId"]))) (letvar1549392 "Logins") (clojure.core/assoc :logins (deser-logins-list (clojure.core/get-in letvar1549392 ["Logins"]))) (letvar1549392 "CreationDate") (clojure.core/assoc :creation-date (deser-date-type (clojure.core/get-in letvar1549392 ["CreationDate"]))) (letvar1549392 "LastModifiedDate") (clojure.core/assoc :last-modified-date (deser-date-type (clojure.core/get-in letvar1549392 ["LastModifiedDate"])))))))

(clojure.core/defn- response-list-identity-pools-response ([input] (response-list-identity-pools-response nil input)) ([resultWrapper1549394 input] (clojure.core/let [rawinput1549393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549395 {"IdentityPools" (rawinput1549393 "IdentityPools"), "NextToken" (rawinput1549393 "NextToken")}] (clojure.core/cond-> {} (letvar1549395 "IdentityPools") (clojure.core/assoc :identity-pools (deser-identity-pools-list (clojure.core/get-in letvar1549395 ["IdentityPools"]))) (letvar1549395 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1549395 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1549397 input] (clojure.core/let [rawinput1549396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549398 {"message" (rawinput1549396 "message")}] (clojure.core/cond-> {} (letvar1549398 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549398 ["message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1549400 input] (clojure.core/let [rawinput1549399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549401 {"message" (rawinput1549399 "message")}] (clojure.core/cond-> {} (letvar1549401 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549401 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1549403 input] (clojure.core/let [rawinput1549402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549404 {"message" (rawinput1549402 "message")}] (clojure.core/cond-> {} (letvar1549404 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549404 ["message"])))))))

(clojure.core/defn- response-identity-pool ([input] (response-identity-pool nil input)) ([resultWrapper1549406 input] (clojure.core/let [rawinput1549405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549407 {"IdentityPoolId" (rawinput1549405 "IdentityPoolId"), "IdentityPoolName" (rawinput1549405 "IdentityPoolName"), "AllowUnauthenticatedIdentities" (rawinput1549405 "AllowUnauthenticatedIdentities"), "SupportedLoginProviders" (rawinput1549405 "SupportedLoginProviders"), "DeveloperProviderName" (rawinput1549405 "DeveloperProviderName"), "OpenIdConnectProviderARNs" (rawinput1549405 "OpenIdConnectProviderARNs"), "CognitoIdentityProviders" (rawinput1549405 "CognitoIdentityProviders"), "SamlProviderARNs" (rawinput1549405 "SamlProviderARNs")}] (clojure.core/cond-> {:identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1549407 ["IdentityPoolId"])), :identity-pool-name (deser-identity-pool-name (clojure.core/get-in letvar1549407 ["IdentityPoolName"])), :allow-unauthenticated-identities (deser-identity-pool-unauthenticated (clojure.core/get-in letvar1549407 ["AllowUnauthenticatedIdentities"]))} (letvar1549407 "SupportedLoginProviders") (clojure.core/assoc :supported-login-providers (deser-identity-providers (clojure.core/get-in letvar1549407 ["SupportedLoginProviders"]))) (letvar1549407 "DeveloperProviderName") (clojure.core/assoc :developer-provider-name (deser-developer-provider-name (clojure.core/get-in letvar1549407 ["DeveloperProviderName"]))) (letvar1549407 "OpenIdConnectProviderARNs") (clojure.core/assoc :open-id-connect-provider-ar-ns (deser-oidc-provider-list (clojure.core/get-in letvar1549407 ["OpenIdConnectProviderARNs"]))) (letvar1549407 "CognitoIdentityProviders") (clojure.core/assoc :cognito-identity-providers (deser-cognito-identity-provider-list (clojure.core/get-in letvar1549407 ["CognitoIdentityProviders"]))) (letvar1549407 "SamlProviderARNs") (clojure.core/assoc :saml-provider-ar-ns (deser-saml-provider-list (clojure.core/get-in letvar1549407 ["SamlProviderARNs"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1549409 input] (clojure.core/let [rawinput1549408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549410 {"message" (rawinput1549408 "message")}] (clojure.core/cond-> {} (letvar1549410 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549410 ["message"])))))))

(clojure.core/defn- response-list-identities-response ([input] (response-list-identities-response nil input)) ([resultWrapper1549412 input] (clojure.core/let [rawinput1549411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549413 {"IdentityPoolId" (rawinput1549411 "IdentityPoolId"), "Identities" (rawinput1549411 "Identities"), "NextToken" (rawinput1549411 "NextToken")}] (clojure.core/cond-> {} (letvar1549413 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1549413 ["IdentityPoolId"]))) (letvar1549413 "Identities") (clojure.core/assoc :identities (deser-identities-list (clojure.core/get-in letvar1549413 ["Identities"]))) (letvar1549413 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1549413 ["NextToken"])))))))

(clojure.core/defn- response-external-service-exception ([input] (response-external-service-exception nil input)) ([resultWrapper1549415 input] (clojure.core/let [rawinput1549414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549416 {"message" (rawinput1549414 "message")}] (clojure.core/cond-> {} (letvar1549416 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549416 ["message"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1549418 input] (clojure.core/let [rawinput1549417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549419 {"message" (rawinput1549417 "message")}] (clojure.core/cond-> {} (letvar1549419 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549419 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1549421 input] (clojure.core/let [rawinput1549420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549422 {"message" (rawinput1549420 "message")}] (clojure.core/cond-> {} (letvar1549422 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1549422 ["message"])))))))

(clojure.core/defn- response-merge-developer-identities-response ([input] (response-merge-developer-identities-response nil input)) ([resultWrapper1549424 input] (clojure.core/let [rawinput1549423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549425 {"IdentityId" (rawinput1549423 "IdentityId")}] (clojure.core/cond-> {} (letvar1549425 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1549425 ["IdentityId"])))))))

(clojure.core/defn- response-get-identity-pool-roles-response ([input] (response-get-identity-pool-roles-response nil input)) ([resultWrapper1549427 input] (clojure.core/let [rawinput1549426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1549428 {"IdentityPoolId" (rawinput1549426 "IdentityPoolId"), "Roles" (rawinput1549426 "Roles"), "RoleMappings" (rawinput1549426 "RoleMappings")}] (clojure.core/cond-> {} (letvar1549428 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1549428 ["IdentityPoolId"]))) (letvar1549428 "Roles") (clojure.core/assoc :roles (deser-roles-map (clojure.core/get-in letvar1549428 ["Roles"]))) (letvar1549428 "RoleMappings") (clojure.core/assoc :role-mappings (deser-role-mapping-map (clojure.core/get-in letvar1549428 ["RoleMappings"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/pagination-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/claim-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/query-limit (clojure.spec.alpha/int-in 1 60))

(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/developer-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w._-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/claim-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/cognito-identity-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w._:/-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/cognito-identity-provider-client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-pool-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w ]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-provider-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w.;_/-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\d+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/arn-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/identity-provider-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50000))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/developer-user-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity.-2014-06-30/role-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(un)?authenticated" s__1410940__auto__))))
