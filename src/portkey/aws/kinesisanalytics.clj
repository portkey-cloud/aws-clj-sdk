...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1855314 input] (clojure.core/let [rawinput1855313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855315 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1855317 input] (clojure.core/let [rawinput1855316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855318 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1855320 input] (clojure.core/let [rawinput1855319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855321 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1855323 input] (clojure.core/let [rawinput1855322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855324 {"message" (rawinput1855322 "message")}] (clojure.core/cond-> {} (letvar1855324 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855324 ["message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1855326 input] (clojure.core/let [rawinput1855325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855327 {"InputSchema" (rawinput1855325 "InputSchema"), "ParsedInputRecords" (rawinput1855325 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1855325 "ProcessedInputRecords"), "RawInputRecords" (rawinput1855325 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1855327 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1855327 ["InputSchema"]))) (letvar1855327 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1855327 ["ParsedInputRecords"]))) (letvar1855327 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1855327 ["ProcessedInputRecords"]))) (letvar1855327 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1855327 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1855329 input] (clojure.core/let [rawinput1855328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855330 {"message" (rawinput1855328 "message"), "RawInputRecords" (rawinput1855328 "RawInputRecords"), "ProcessedInputRecords" (rawinput1855328 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1855330 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855330 ["message"]))) (letvar1855330 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1855330 ["RawInputRecords"]))) (letvar1855330 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1855330 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1855332 input] (clojure.core/let [rawinput1855331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855333 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1855335 input] (clojure.core/let [rawinput1855334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855336 {"ApplicationDetail" (rawinput1855334 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1855336 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1855338 input] (clojure.core/let [rawinput1855337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855339 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1855341 input] (clojure.core/let [rawinput1855340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855342 {"message" (rawinput1855340 "message")}] (clojure.core/cond-> {} (letvar1855342 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855342 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1855344 input] (clojure.core/let [rawinput1855343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855345 {"message" (rawinput1855343 "message")}] (clojure.core/cond-> {} (letvar1855345 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855345 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1855347 input] (clojure.core/let [rawinput1855346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855348 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1855350 input] (clojure.core/let [rawinput1855349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855351 {"message" (rawinput1855349 "message")}] (clojure.core/cond-> {} (letvar1855351 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855351 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1855353 input] (clojure.core/let [rawinput1855352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855354 {"message" (rawinput1855352 "message")}] (clojure.core/cond-> {} (letvar1855354 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855354 ["message"])))))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1855356 input] (clojure.core/let [rawinput1855355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855357 {"message" (rawinput1855355 "message")}] (clojure.core/cond-> {} (letvar1855357 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855357 ["message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1855359 input] (clojure.core/let [rawinput1855358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855360 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1855362 input] (clojure.core/let [rawinput1855361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855363 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1855365 input] (clojure.core/let [rawinput1855364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855366 {"message" (rawinput1855364 "message")}] (clojure.core/cond-> {} (letvar1855366 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855366 ["message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1855368 input] (clojure.core/let [rawinput1855367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855369 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1855371 input] (clojure.core/let [rawinput1855370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855372 {"ApplicationSummary" (rawinput1855370 "ApplicationSummary")}] (clojure.core/cond-> {:application-summary (deser-application-summary (clojure.core/get-in letvar1855372 ["ApplicationSummary"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1855374 input] (clojure.core/let [rawinput1855373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855375 {"message" (rawinput1855373 "message")}] (clojure.core/cond-> {} (letvar1855375 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855375 ["message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1855377 input] (clojure.core/let [rawinput1855376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855378 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1855380 input] (clojure.core/let [rawinput1855379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855381 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1855383 input] (clojure.core/let [rawinput1855382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855384 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1855386 input] (clojure.core/let [rawinput1855385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855387 {"message" (rawinput1855385 "message")}] (clojure.core/cond-> {} (letvar1855387 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855387 ["message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1855389 input] (clojure.core/let [rawinput1855388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855390 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1855392 input] (clojure.core/let [rawinput1855391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855393 {"ApplicationSummaries" (rawinput1855391 "ApplicationSummaries"), "HasMoreApplications" (rawinput1855391 "HasMoreApplications")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1855393 ["ApplicationSummaries"])), :has-more-applications (deser-boolean-object (clojure.core/get-in letvar1855393 ["HasMoreApplications"]))}))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1855395 input] (clojure.core/let [rawinput1855394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1855396 {"message" (rawinput1855394 "message")}] (clojure.core/cond-> {} (letvar1855396 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1855396 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/application-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"UTF-8" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
