...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1834056 input] (clojure.core/let [rawinput1834055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834057 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1834059 input] (clojure.core/let [rawinput1834058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834060 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1834062 input] (clojure.core/let [rawinput1834061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834063 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1834065 input] (clojure.core/let [rawinput1834064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834066 {"message" (rawinput1834064 "message")}] (clojure.core/cond-> {} (letvar1834066 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834066 ["message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1834068 input] (clojure.core/let [rawinput1834067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834069 {"InputSchema" (rawinput1834067 "InputSchema"), "ParsedInputRecords" (rawinput1834067 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1834067 "ProcessedInputRecords"), "RawInputRecords" (rawinput1834067 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1834069 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1834069 ["InputSchema"]))) (letvar1834069 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1834069 ["ParsedInputRecords"]))) (letvar1834069 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1834069 ["ProcessedInputRecords"]))) (letvar1834069 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1834069 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1834071 input] (clojure.core/let [rawinput1834070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834072 {"message" (rawinput1834070 "message"), "RawInputRecords" (rawinput1834070 "RawInputRecords"), "ProcessedInputRecords" (rawinput1834070 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1834072 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834072 ["message"]))) (letvar1834072 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1834072 ["RawInputRecords"]))) (letvar1834072 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1834072 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1834074 input] (clojure.core/let [rawinput1834073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834075 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1834077 input] (clojure.core/let [rawinput1834076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834078 {"ApplicationDetail" (rawinput1834076 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1834078 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1834080 input] (clojure.core/let [rawinput1834079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834081 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1834083 input] (clojure.core/let [rawinput1834082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834084 {"message" (rawinput1834082 "message")}] (clojure.core/cond-> {} (letvar1834084 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834084 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1834086 input] (clojure.core/let [rawinput1834085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834087 {"message" (rawinput1834085 "message")}] (clojure.core/cond-> {} (letvar1834087 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834087 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1834089 input] (clojure.core/let [rawinput1834088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834090 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1834092 input] (clojure.core/let [rawinput1834091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834093 {"message" (rawinput1834091 "message")}] (clojure.core/cond-> {} (letvar1834093 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834093 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1834095 input] (clojure.core/let [rawinput1834094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834096 {"message" (rawinput1834094 "message")}] (clojure.core/cond-> {} (letvar1834096 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834096 ["message"])))))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1834098 input] (clojure.core/let [rawinput1834097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834099 {"message" (rawinput1834097 "message")}] (clojure.core/cond-> {} (letvar1834099 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834099 ["message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1834101 input] (clojure.core/let [rawinput1834100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834102 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1834104 input] (clojure.core/let [rawinput1834103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834105 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1834107 input] (clojure.core/let [rawinput1834106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834108 {"message" (rawinput1834106 "message")}] (clojure.core/cond-> {} (letvar1834108 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834108 ["message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1834110 input] (clojure.core/let [rawinput1834109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834111 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1834113 input] (clojure.core/let [rawinput1834112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834114 {"ApplicationSummary" (rawinput1834112 "ApplicationSummary")}] (clojure.core/cond-> {:application-summary (deser-application-summary (clojure.core/get-in letvar1834114 ["ApplicationSummary"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1834116 input] (clojure.core/let [rawinput1834115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834117 {"message" (rawinput1834115 "message")}] (clojure.core/cond-> {} (letvar1834117 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834117 ["message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1834119 input] (clojure.core/let [rawinput1834118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834120 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1834122 input] (clojure.core/let [rawinput1834121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834123 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1834125 input] (clojure.core/let [rawinput1834124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834126 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1834128 input] (clojure.core/let [rawinput1834127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834129 {"message" (rawinput1834127 "message")}] (clojure.core/cond-> {} (letvar1834129 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834129 ["message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1834131 input] (clojure.core/let [rawinput1834130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834132 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1834134 input] (clojure.core/let [rawinput1834133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834135 {"ApplicationSummaries" (rawinput1834133 "ApplicationSummaries"), "HasMoreApplications" (rawinput1834133 "HasMoreApplications")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1834135 ["ApplicationSummaries"])), :has-more-applications (deser-boolean-object (clojure.core/get-in letvar1834135 ["HasMoreApplications"]))}))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1834137 input] (clojure.core/let [rawinput1834136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1834138 {"message" (rawinput1834136 "message")}] (clojure.core/cond-> {} (letvar1834138 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1834138 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/log-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/in-app-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/application-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"UTF-8" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
