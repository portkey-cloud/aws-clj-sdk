...
(clojure.core/defn- response-invalid-revision-exception ([input] (response-invalid-revision-exception nil input)) ([resultWrapper1566338 input] (clojure.core/let [rawinput1566337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566339 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-instance-status-exception ([input] (response-invalid-instance-status-exception nil input)) ([resultWrapper1566341 input] (clojure.core/let [rawinput1566340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566342 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-deployment-config-output ([input] (response-get-deployment-config-output nil input)) ([resultWrapper1566344 input] (clojure.core/let [rawinput1566343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566345 {"deploymentConfigInfo" (rawinput1566343 "deploymentConfigInfo")}] (clojure.core/cond-> {} (letvar1566345 "deploymentConfigInfo") (clojure.core/assoc :deployment-config-info (deser-deployment-config-info (clojure.core/get-in letvar1566345 ["deploymentConfigInfo"])))))))

(clojure.core/defn- response-deployment-already-completed-exception ([input] (response-deployment-already-completed-exception nil input)) ([resultWrapper1566347 input] (clojure.core/let [rawinput1566346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566348 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-git-hub-account-token-output ([input] (response-delete-git-hub-account-token-output nil input)) ([resultWrapper1566350 input] (clojure.core/let [rawinput1566349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566351 {"tokenName" (rawinput1566349 "tokenName")}] (clojure.core/cond-> {} (letvar1566351 "tokenName") (clojure.core/assoc :token-name (deser-git-hub-account-token-name (clojure.core/get-in letvar1566351 ["tokenName"])))))))

(clojure.core/defn- response-create-application-output ([input] (response-create-application-output nil input)) ([resultWrapper1566353 input] (clojure.core/let [rawinput1566352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566354 {"applicationId" (rawinput1566352 "applicationId")}] (clojure.core/cond-> {} (letvar1566354 "applicationId") (clojure.core/assoc :application-id (deser-application-id (clojure.core/get-in letvar1566354 ["applicationId"])))))))

(clojure.core/defn- response-invalid-sort-by-exception ([input] (response-invalid-sort-by-exception nil input)) ([resultWrapper1566356 input] (clojure.core/let [rawinput1566355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566357 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-deployment-group-output ([input] (response-get-deployment-group-output nil input)) ([resultWrapper1566359 input] (clojure.core/let [rawinput1566358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566360 {"deploymentGroupInfo" (rawinput1566358 "deploymentGroupInfo")}] (clojure.core/cond-> {} (letvar1566360 "deploymentGroupInfo") (clojure.core/assoc :deployment-group-info (deser-deployment-group-info (clojure.core/get-in letvar1566360 ["deploymentGroupInfo"])))))))

(clojure.core/defn- response-invalid-deployment-status-exception ([input] (response-invalid-deployment-status-exception nil input)) ([resultWrapper1566362 input] (clojure.core/let [rawinput1566361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566363 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-target-group-pair-exception ([input] (response-invalid-target-group-pair-exception nil input)) ([resultWrapper1566365 input] (clojure.core/let [rawinput1566364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566366 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-revision-required-exception ([input] (response-revision-required-exception nil input)) ([resultWrapper1566368 input] (clojure.core/let [rawinput1566367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566369 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-target-list-size-exceeded-exception ([input] (response-deployment-target-list-size-exceeded-exception nil input)) ([resultWrapper1566371 input] (clojure.core/let [rawinput1566370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566372 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-config-already-exists-exception ([input] (response-deployment-config-already-exists-exception nil input)) ([resultWrapper1566374 input] (clojure.core/let [rawinput1566373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566375 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-lifecycle-event-hook-execution-status-exception ([input] (response-invalid-lifecycle-event-hook-execution-status-exception nil input)) ([resultWrapper1566377 input] (clojure.core/let [rawinput1566376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566378 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-wait-type-exception ([input] (response-invalid-deployment-wait-type-exception nil input)) ([resultWrapper1566380 input] (clojure.core/let [rawinput1566379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566381 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-instance-not-registered-exception ([input] (response-instance-not-registered-exception nil input)) ([resultWrapper1566383 input] (clojure.core/let [rawinput1566382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566384 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-group-already-exists-exception ([input] (response-deployment-group-already-exists-exception nil input)) ([resultWrapper1566386 input] (clojure.core/let [rawinput1566385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566387 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-group-name-exception ([input] (response-invalid-deployment-group-name-exception nil input)) ([resultWrapper1566389 input] (clojure.core/let [rawinput1566388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566390 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-compute-platform-exception ([input] (response-invalid-compute-platform-exception nil input)) ([resultWrapper1566392 input] (clojure.core/let [rawinput1566391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566393 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-iam-user-arn-already-registered-exception ([input] (response-iam-user-arn-already-registered-exception nil input)) ([resultWrapper1566395 input] (clojure.core/let [rawinput1566394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566396 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-role-exception ([input] (response-invalid-role-exception nil input)) ([resultWrapper1566398 input] (clojure.core/let [rawinput1566397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566399 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-trigger-config-exception ([input] (response-invalid-trigger-config-exception nil input)) ([resultWrapper1566401 input] (clojure.core/let [rawinput1566400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566402 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-on-premises-tag-combination-exception ([input] (response-invalid-on-premises-tag-combination-exception nil input)) ([resultWrapper1566404 input] (clojure.core/let [rawinput1566403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566405 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-git-hub-account-token-name-exception ([input] (response-invalid-git-hub-account-token-name-exception nil input)) ([resultWrapper1566407 input] (clojure.core/let [rawinput1566406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566408 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-limit-exceeded-exception ([input] (response-batch-limit-exceeded-exception nil input)) ([resultWrapper1566410 input] (clojure.core/let [rawinput1566409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566411 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-deployment-targets-output ([input] (response-batch-get-deployment-targets-output nil input)) ([resultWrapper1566413 input] (clojure.core/let [rawinput1566412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566414 {"deploymentTargets" (rawinput1566412 "deploymentTargets")}] (clojure.core/cond-> {} (letvar1566414 "deploymentTargets") (clojure.core/assoc :deployment-targets (deser-deployment-target-list (clojure.core/get-in letvar1566414 ["deploymentTargets"])))))))

(clojure.core/defn- response-deployment-not-started-exception ([input] (response-deployment-not-started-exception nil input)) ([resultWrapper1566416 input] (clojure.core/let [rawinput1566415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566417 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-ec-2-tag-exception ([input] (response-invalid-ec-2-tag-exception nil input)) ([resultWrapper1566419 input] (clojure.core/let [rawinput1566418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566420 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-style-exception ([input] (response-invalid-deployment-style-exception nil input)) ([resultWrapper1566422 input] (clojure.core/let [rawinput1566421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-bucket-name-filter-exception ([input] (response-invalid-bucket-name-filter-exception nil input)) ([resultWrapper1566425 input] (clojure.core/let [rawinput1566424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566426 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-iam-user-arn-exception ([input] (response-invalid-iam-user-arn-exception nil input)) ([resultWrapper1566428 input] (clojure.core/let [rawinput1566427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566429 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-application-output ([input] (response-get-application-output nil input)) ([resultWrapper1566431 input] (clojure.core/let [rawinput1566430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566432 {"application" (rawinput1566430 "application")}] (clojure.core/cond-> {} (letvar1566432 "application") (clojure.core/assoc :application (deser-application-info (clojure.core/get-in letvar1566432 ["application"])))))))

(clojure.core/defn- response-lifecycle-hook-limit-exceeded-exception ([input] (response-lifecycle-hook-limit-exceeded-exception nil input)) ([resultWrapper1566434 input] (clojure.core/let [rawinput1566433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566435 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-trigger-targets-limit-exceeded-exception ([input] (response-trigger-targets-limit-exceeded-exception nil input)) ([resultWrapper1566437 input] (clojure.core/let [rawinput1566436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566438 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-git-hub-account-token-exception ([input] (response-invalid-git-hub-account-token-exception nil input)) ([resultWrapper1566440 input] (clojure.core/let [rawinput1566439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566441 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-iam-arn-required-exception ([input] (response-iam-arn-required-exception nil input)) ([resultWrapper1566443 input] (clojure.core/let [rawinput1566442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566444 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-config-name-exception ([input] (response-invalid-deployment-config-name-exception nil input)) ([resultWrapper1566446 input] (clojure.core/let [rawinput1566445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566447 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-limit-exceeded-exception ([input] (response-deployment-limit-exceeded-exception nil input)) ([resultWrapper1566449 input] (clojure.core/let [rawinput1566448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566450 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-deployment-groups-output ([input] (response-batch-get-deployment-groups-output nil input)) ([resultWrapper1566452 input] (clojure.core/let [rawinput1566451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566453 {"deploymentGroupsInfo" (rawinput1566451 "deploymentGroupsInfo"), "errorMessage" (rawinput1566451 "errorMessage")}] (clojure.core/cond-> {} (letvar1566453 "deploymentGroupsInfo") (clojure.core/assoc :deployment-groups-info (deser-deployment-group-info-list (clojure.core/get-in letvar1566453 ["deploymentGroupsInfo"]))) (letvar1566453 "errorMessage") (clojure.core/assoc :error-message (deser-error-message (clojure.core/get-in letvar1566453 ["errorMessage"])))))))

(clojure.core/defn- response-deployment-does-not-exist-exception ([input] (response-deployment-does-not-exist-exception nil input)) ([resultWrapper1566455 input] (clojure.core/let [rawinput1566454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566456 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-target-filter-name-exception ([input] (response-invalid-target-filter-name-exception nil input)) ([resultWrapper1566458 input] (clojure.core/let [rawinput1566457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566459 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-group-does-not-exist-exception ([input] (response-deployment-group-does-not-exist-exception nil input)) ([resultWrapper1566461 input] (clojure.core/let [rawinput1566460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566462 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-deployment-output ([input] (response-stop-deployment-output nil input)) ([resultWrapper1566464 input] (clojure.core/let [rawinput1566463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566465 {"status" (rawinput1566463 "status"), "statusMessage" (rawinput1566463 "statusMessage")}] (clojure.core/cond-> {} (letvar1566465 "status") (clojure.core/assoc :status (deser-stop-status (clojure.core/get-in letvar1566465 ["status"]))) (letvar1566465 "statusMessage") (clojure.core/assoc :status-message (deser-message (clojure.core/get-in letvar1566465 ["statusMessage"])))))))

(clojure.core/defn- response-update-deployment-group-output ([input] (response-update-deployment-group-output nil input)) ([resultWrapper1566467 input] (clojure.core/let [rawinput1566466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566468 {"hooksNotCleanedUp" (rawinput1566466 "hooksNotCleanedUp")}] (clojure.core/cond-> {} (letvar1566468 "hooksNotCleanedUp") (clojure.core/assoc :hooks-not-cleaned-up (deser-auto-scaling-group-list (clojure.core/get-in letvar1566468 ["hooksNotCleanedUp"])))))))

(clojure.core/defn- response-batch-get-application-revisions-output ([input] (response-batch-get-application-revisions-output nil input)) ([resultWrapper1566470 input] (clojure.core/let [rawinput1566469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566471 {"applicationName" (rawinput1566469 "applicationName"), "errorMessage" (rawinput1566469 "errorMessage"), "revisions" (rawinput1566469 "revisions")}] (clojure.core/cond-> {} (letvar1566471 "applicationName") (clojure.core/assoc :application-name (deser-application-name (clojure.core/get-in letvar1566471 ["applicationName"]))) (letvar1566471 "errorMessage") (clojure.core/assoc :error-message (deser-error-message (clojure.core/get-in letvar1566471 ["errorMessage"]))) (letvar1566471 "revisions") (clojure.core/assoc :revisions (deser-revision-info-list (clojure.core/get-in letvar1566471 ["revisions"])))))))

(clojure.core/defn- response-get-deployment-output ([input] (response-get-deployment-output nil input)) ([resultWrapper1566473 input] (clojure.core/let [rawinput1566472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566474 {"deploymentInfo" (rawinput1566472 "deploymentInfo")}] (clojure.core/cond-> {} (letvar1566474 "deploymentInfo") (clojure.core/assoc :deployment-info (deser-deployment-info (clojure.core/get-in letvar1566474 ["deploymentInfo"])))))))

(clojure.core/defn- response-git-hub-account-token-does-not-exist-exception ([input] (response-git-hub-account-token-does-not-exist-exception nil input)) ([resultWrapper1566476 input] (clojure.core/let [rawinput1566475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566477 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-group-limit-exceeded-exception ([input] (response-deployment-group-limit-exceeded-exception nil input)) ([resultWrapper1566479 input] (clojure.core/let [rawinput1566478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566480 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-lifecycle-event-hook-execution-id-exception ([input] (response-invalid-lifecycle-event-hook-execution-id-exception nil input)) ([resultWrapper1566482 input] (clojure.core/let [rawinput1566481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566483 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-deployment-group-output ([input] (response-delete-deployment-group-output nil input)) ([resultWrapper1566485 input] (clojure.core/let [rawinput1566484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566486 {"hooksNotCleanedUp" (rawinput1566484 "hooksNotCleanedUp")}] (clojure.core/cond-> {} (letvar1566486 "hooksNotCleanedUp") (clojure.core/assoc :hooks-not-cleaned-up (deser-auto-scaling-group-list (clojure.core/get-in letvar1566486 ["hooksNotCleanedUp"])))))))

(clojure.core/defn- response-tag-limit-exceeded-exception ([input] (response-tag-limit-exceeded-exception nil input)) ([resultWrapper1566488 input] (clojure.core/let [rawinput1566487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566489 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-target-does-not-exist-exception ([input] (response-deployment-target-does-not-exist-exception nil input)) ([resultWrapper1566491 input] (clojure.core/let [rawinput1566490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566492 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-deployment-groups-output ([input] (response-list-deployment-groups-output nil input)) ([resultWrapper1566494 input] (clojure.core/let [rawinput1566493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566495 {"applicationName" (rawinput1566493 "applicationName"), "deploymentGroups" (rawinput1566493 "deploymentGroups"), "nextToken" (rawinput1566493 "nextToken")}] (clojure.core/cond-> {} (letvar1566495 "applicationName") (clojure.core/assoc :application-name (deser-application-name (clojure.core/get-in letvar1566495 ["applicationName"]))) (letvar1566495 "deploymentGroups") (clojure.core/assoc :deployment-groups (deser-deployment-groups-list (clojure.core/get-in letvar1566495 ["deploymentGroups"]))) (letvar1566495 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566495 ["nextToken"])))))))

(clojure.core/defn- response-bucket-name-filter-required-exception ([input] (response-bucket-name-filter-required-exception nil input)) ([resultWrapper1566497 input] (clojure.core/let [rawinput1566496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566498 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-deployment-instance-output ([input] (response-get-deployment-instance-output nil input)) ([resultWrapper1566500 input] (clojure.core/let [rawinput1566499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566501 {"instanceSummary" (rawinput1566499 "instanceSummary")}] (clojure.core/cond-> {} (letvar1566501 "instanceSummary") (clojure.core/assoc :instance-summary (deser-instance-summary (clojure.core/get-in letvar1566501 ["instanceSummary"])))))))

(clojure.core/defn- response-revision-does-not-exist-exception ([input] (response-revision-does-not-exist-exception nil input)) ([resultWrapper1566503 input] (clojure.core/let [rawinput1566502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566504 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-deployment-instances-output ([input] (response-batch-get-deployment-instances-output nil input)) ([resultWrapper1566506 input] (clojure.core/let [rawinput1566505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566507 {"instancesSummary" (rawinput1566505 "instancesSummary"), "errorMessage" (rawinput1566505 "errorMessage")}] (clojure.core/cond-> {} (letvar1566507 "instancesSummary") (clojure.core/assoc :instances-summary (deser-instance-summary-list (clojure.core/get-in letvar1566507 ["instancesSummary"]))) (letvar1566507 "errorMessage") (clojure.core/assoc :error-message (deser-error-message (clojure.core/get-in letvar1566507 ["errorMessage"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1566509 input] (clojure.core/let [rawinput1566508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566510 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-ec-2-tag-combination-exception ([input] (response-invalid-ec-2-tag-combination-exception nil input)) ([resultWrapper1566512 input] (clojure.core/let [rawinput1566511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566513 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-config-name-required-exception ([input] (response-deployment-config-name-required-exception nil input)) ([resultWrapper1566515 input] (clojure.core/let [rawinput1566514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566516 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployed-state-filter-exception ([input] (response-invalid-deployed-state-filter-exception nil input)) ([resultWrapper1566518 input] (clojure.core/let [rawinput1566517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566519 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-on-premises-instances-output ([input] (response-list-on-premises-instances-output nil input)) ([resultWrapper1566521 input] (clojure.core/let [rawinput1566520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566522 {"instanceNames" (rawinput1566520 "instanceNames"), "nextToken" (rawinput1566520 "nextToken")}] (clojure.core/cond-> {} (letvar1566522 "instanceNames") (clojure.core/assoc :instance-names (deser-instance-name-list (clojure.core/get-in letvar1566522 ["instanceNames"]))) (letvar1566522 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566522 ["nextToken"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1566524 input] (clojure.core/let [rawinput1566523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566525 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-iam-user-arn-required-exception ([input] (response-iam-user-arn-required-exception nil input)) ([resultWrapper1566527 input] (clojure.core/let [rawinput1566526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566528 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-application-revisions-output ([input] (response-list-application-revisions-output nil input)) ([resultWrapper1566530 input] (clojure.core/let [rawinput1566529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566531 {"revisions" (rawinput1566529 "revisions"), "nextToken" (rawinput1566529 "nextToken")}] (clojure.core/cond-> {} (letvar1566531 "revisions") (clojure.core/assoc :revisions (deser-revision-location-list (clojure.core/get-in letvar1566531 ["revisions"]))) (letvar1566531 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566531 ["nextToken"])))))))

(clojure.core/defn- response-application-limit-exceeded-exception ([input] (response-application-limit-exceeded-exception nil input)) ([resultWrapper1566533 input] (clojure.core/let [rawinput1566532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566534 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-instance-name-exception ([input] (response-invalid-instance-name-exception nil input)) ([resultWrapper1566536 input] (clojure.core/let [rawinput1566535 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566537 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-applications-output ([input] (response-list-applications-output nil input)) ([resultWrapper1566539 input] (clojure.core/let [rawinput1566538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566540 {"applications" (rawinput1566538 "applications"), "nextToken" (rawinput1566538 "nextToken")}] (clojure.core/cond-> {} (letvar1566540 "applications") (clojure.core/assoc :applications (deser-applications-list (clojure.core/get-in letvar1566540 ["applications"]))) (letvar1566540 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566540 ["nextToken"])))))))

(clojure.core/defn- response-create-deployment-output ([input] (response-create-deployment-output nil input)) ([resultWrapper1566542 input] (clojure.core/let [rawinput1566541 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566543 {"deploymentId" (rawinput1566541 "deploymentId")}] (clojure.core/cond-> {} (letvar1566543 "deploymentId") (clojure.core/assoc :deployment-id (deser-deployment-id (clojure.core/get-in letvar1566543 ["deploymentId"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1566545 input] (clojure.core/let [rawinput1566544 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566546 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-application-does-not-exist-exception ([input] (response-application-does-not-exist-exception nil input)) ([resultWrapper1566548 input] (clojure.core/let [rawinput1566547 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566549 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-file-exists-behavior-exception ([input] (response-invalid-file-exists-behavior-exception nil input)) ([resultWrapper1566551 input] (clojure.core/let [rawinput1566550 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566552 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-deployment-configs-output ([input] (response-list-deployment-configs-output nil input)) ([resultWrapper1566554 input] (clojure.core/let [rawinput1566553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566555 {"deploymentConfigsList" (rawinput1566553 "deploymentConfigsList"), "nextToken" (rawinput1566553 "nextToken")}] (clojure.core/cond-> {} (letvar1566555 "deploymentConfigsList") (clojure.core/assoc :deployment-configs-list (deser-deployment-configs-list (clojure.core/get-in letvar1566555 ["deploymentConfigsList"]))) (letvar1566555 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566555 ["nextToken"])))))))

(clojure.core/defn- response-batch-get-deployments-output ([input] (response-batch-get-deployments-output nil input)) ([resultWrapper1566557 input] (clojure.core/let [rawinput1566556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566558 {"deploymentsInfo" (rawinput1566556 "deploymentsInfo")}] (clojure.core/cond-> {} (letvar1566558 "deploymentsInfo") (clojure.core/assoc :deployments-info (deser-deployments-info-list (clojure.core/get-in letvar1566558 ["deploymentsInfo"])))))))

(clojure.core/defn- response-application-name-required-exception ([input] (response-application-name-required-exception nil input)) ([resultWrapper1566560 input] (clojure.core/let [rawinput1566559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566561 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-instance-name-required-exception ([input] (response-instance-name-required-exception nil input)) ([resultWrapper1566563 input] (clojure.core/let [rawinput1566562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566564 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-target-id-exception ([input] (response-invalid-deployment-target-id-exception nil input)) ([resultWrapper1566566 input] (clojure.core/let [rawinput1566565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566567 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-ecs-service-mapping-limit-exceeded-exception ([input] (response-ecs-service-mapping-limit-exceeded-exception nil input)) ([resultWrapper1566569 input] (clojure.core/let [rawinput1566568 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566570 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-id-required-exception ([input] (response-deployment-id-required-exception nil input)) ([resultWrapper1566572 input] (clojure.core/let [rawinput1566571 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566573 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1566575 input] (clojure.core/let [rawinput1566574 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566576 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-iam-session-arn-already-registered-exception ([input] (response-iam-session-arn-already-registered-exception nil input)) ([resultWrapper1566578 input] (clojure.core/let [rawinput1566577 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566579 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-update-outdated-instances-only-value-exception ([input] (response-invalid-update-outdated-instances-only-value-exception nil input)) ([resultWrapper1566581 input] (clojure.core/let [rawinput1566580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566582 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-config-in-use-exception ([input] (response-deployment-config-in-use-exception nil input)) ([resultWrapper1566584 input] (clojure.core/let [rawinput1566583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566585 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-description-too-long-exception ([input] (response-description-too-long-exception nil input)) ([resultWrapper1566587 input] (clojure.core/let [rawinput1566586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566588 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-not-supported-exception ([input] (response-operation-not-supported-exception nil input)) ([resultWrapper1566590 input] (clojure.core/let [rawinput1566589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566591 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-deployment-targets-output ([input] (response-list-deployment-targets-output nil input)) ([resultWrapper1566593 input] (clojure.core/let [rawinput1566592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566594 {"targetIds" (rawinput1566592 "targetIds"), "nextToken" (rawinput1566592 "nextToken")}] (clojure.core/cond-> {} (letvar1566594 "targetIds") (clojure.core/assoc :target-ids (deser-target-id-list (clojure.core/get-in letvar1566594 ["targetIds"]))) (letvar1566594 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566594 ["nextToken"])))))))

(clojure.core/defn- response-invalid-key-prefix-filter-exception ([input] (response-invalid-key-prefix-filter-exception nil input)) ([resultWrapper1566596 input] (clojure.core/let [rawinput1566595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566597 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-sort-order-exception ([input] (response-invalid-sort-order-exception nil input)) ([resultWrapper1566599 input] (clojure.core/let [rawinput1566598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566600 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-set-list-limit-exceeded-exception ([input] (response-tag-set-list-limit-exceeded-exception nil input)) ([resultWrapper1566602 input] (clojure.core/let [rawinput1566601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566603 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-deployment-config-output ([input] (response-create-deployment-config-output nil input)) ([resultWrapper1566605 input] (clojure.core/let [rawinput1566604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566606 {"deploymentConfigId" (rawinput1566604 "deploymentConfigId")}] (clojure.core/cond-> {} (letvar1566606 "deploymentConfigId") (clojure.core/assoc :deployment-config-id (deser-deployment-config-id (clojure.core/get-in letvar1566606 ["deploymentConfigId"])))))))

(clojure.core/defn- response-invalid-registration-status-exception ([input] (response-invalid-registration-status-exception nil input)) ([resultWrapper1566608 input] (clojure.core/let [rawinput1566607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566609 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-instance-id-required-exception ([input] (response-instance-id-required-exception nil input)) ([resultWrapper1566611 input] (clojure.core/let [rawinput1566610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566612 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-required-exception ([input] (response-tag-required-exception nil input)) ([resultWrapper1566614 input] (clojure.core/let [rawinput1566613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566615 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-on-premises-instance-output ([input] (response-get-on-premises-instance-output nil input)) ([resultWrapper1566617 input] (clojure.core/let [rawinput1566616 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566618 {"instanceInfo" (rawinput1566616 "instanceInfo")}] (clojure.core/cond-> {} (letvar1566618 "instanceInfo") (clojure.core/assoc :instance-info (deser-instance-info (clojure.core/get-in letvar1566618 ["instanceInfo"])))))))

(clojure.core/defn- response-batch-get-on-premises-instances-output ([input] (response-batch-get-on-premises-instances-output nil input)) ([resultWrapper1566620 input] (clojure.core/let [rawinput1566619 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566621 {"instanceInfos" (rawinput1566619 "instanceInfos")}] (clojure.core/cond-> {} (letvar1566621 "instanceInfos") (clojure.core/assoc :instance-infos (deser-instance-info-list (clojure.core/get-in letvar1566621 ["instanceInfos"])))))))

(clojure.core/defn- response-invalid-iam-session-arn-exception ([input] (response-invalid-iam-session-arn-exception nil input)) ([resultWrapper1566623 input] (clojure.core/let [rawinput1566622 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566624 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-application-name-exception ([input] (response-invalid-application-name-exception nil input)) ([resultWrapper1566626 input] (clojure.core/let [rawinput1566625 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566627 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-id-exception ([input] (response-invalid-deployment-id-exception nil input)) ([resultWrapper1566629 input] (clojure.core/let [rawinput1566628 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566630 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-application-revision-output ([input] (response-get-application-revision-output nil input)) ([resultWrapper1566632 input] (clojure.core/let [rawinput1566631 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566633 {"applicationName" (rawinput1566631 "applicationName"), "revision" (rawinput1566631 "revision"), "revisionInfo" (rawinput1566631 "revisionInfo")}] (clojure.core/cond-> {} (letvar1566633 "applicationName") (clojure.core/assoc :application-name (deser-application-name (clojure.core/get-in letvar1566633 ["applicationName"]))) (letvar1566633 "revision") (clojure.core/assoc :revision (deser-revision-location (clojure.core/get-in letvar1566633 ["revision"]))) (letvar1566633 "revisionInfo") (clojure.core/assoc :revision-info (deser-generic-revision-info (clojure.core/get-in letvar1566633 ["revisionInfo"])))))))

(clojure.core/defn- response-get-deployment-target-output ([input] (response-get-deployment-target-output nil input)) ([resultWrapper1566635 input] (clojure.core/let [rawinput1566634 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566636 {"deploymentTarget" (rawinput1566634 "deploymentTarget")}] (clojure.core/cond-> {} (letvar1566636 "deploymentTarget") (clojure.core/assoc :deployment-target (deser-deployment-target (clojure.core/get-in letvar1566636 ["deploymentTarget"])))))))

(clojure.core/defn- response-invalid-instance-type-exception ([input] (response-invalid-instance-type-exception nil input)) ([resultWrapper1566638 input] (clojure.core/let [rawinput1566637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566639 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-target-id-required-exception ([input] (response-deployment-target-id-required-exception nil input)) ([resultWrapper1566641 input] (clojure.core/let [rawinput1566640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566642 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-blue-green-deployment-configuration-exception ([input] (response-invalid-blue-green-deployment-configuration-exception nil input)) ([resultWrapper1566644 input] (clojure.core/let [rawinput1566643 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566645 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-deployment-instance-type-exception ([input] (response-invalid-deployment-instance-type-exception nil input)) ([resultWrapper1566647 input] (clojure.core/let [rawinput1566646 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566648 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-deployment-instances-output ([input] (response-list-deployment-instances-output nil input)) ([resultWrapper1566650 input] (clojure.core/let [rawinput1566649 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566651 {"instancesList" (rawinput1566649 "instancesList"), "nextToken" (rawinput1566649 "nextToken")}] (clojure.core/cond-> {} (letvar1566651 "instancesList") (clojure.core/assoc :instances-list (deser-instances-list (clojure.core/get-in letvar1566651 ["instancesList"]))) (letvar1566651 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566651 ["nextToken"])))))))

(clojure.core/defn- response-deployment-is-not-in-ready-state-exception ([input] (response-deployment-is-not-in-ready-state-exception nil input)) ([resultWrapper1566653 input] (clojure.core/let [rawinput1566652 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566654 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-multiple-iam-arns-provided-exception ([input] (response-multiple-iam-arns-provided-exception nil input)) ([resultWrapper1566656 input] (clojure.core/let [rawinput1566655 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566657 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-load-balancer-info-exception ([input] (response-invalid-load-balancer-info-exception nil input)) ([resultWrapper1566659 input] (clojure.core/let [rawinput1566658 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566660 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-ignore-application-stop-failures-value-exception ([input] (response-invalid-ignore-application-stop-failures-value-exception nil input)) ([resultWrapper1566662 input] (clojure.core/let [rawinput1566661 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566663 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-applications-output ([input] (response-batch-get-applications-output nil input)) ([resultWrapper1566665 input] (clojure.core/let [rawinput1566664 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566666 {"applicationsInfo" (rawinput1566664 "applicationsInfo")}] (clojure.core/cond-> {} (letvar1566666 "applicationsInfo") (clojure.core/assoc :applications-info (deser-applications-info-list (clojure.core/get-in letvar1566666 ["applicationsInfo"])))))))

(clojure.core/defn- response-invalid-auto-rollback-config-exception ([input] (response-invalid-auto-rollback-config-exception nil input)) ([resultWrapper1566668 input] (clojure.core/let [rawinput1566667 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566669 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-instance-does-not-exist-exception ([input] (response-instance-does-not-exist-exception nil input)) ([resultWrapper1566671 input] (clojure.core/let [rawinput1566670 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566672 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-lifecycle-event-hook-execution-status-output ([input] (response-put-lifecycle-event-hook-execution-status-output nil input)) ([resultWrapper1566674 input] (clojure.core/let [rawinput1566673 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566675 {"lifecycleEventHookExecutionId" (rawinput1566673 "lifecycleEventHookExecutionId")}] (clojure.core/cond-> {} (letvar1566675 "lifecycleEventHookExecutionId") (clojure.core/assoc :lifecycle-event-hook-execution-id (deser-lifecycle-event-hook-execution-id (clojure.core/get-in letvar1566675 ["lifecycleEventHookExecutionId"])))))))

(clojure.core/defn- response-invalid-ecs-service-exception ([input] (response-invalid-ecs-service-exception nil input)) ([resultWrapper1566677 input] (clojure.core/let [rawinput1566676 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566678 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1566680 input] (clojure.core/let [rawinput1566679 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566681 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-minimum-healthy-host-value-exception ([input] (response-invalid-minimum-healthy-host-value-exception nil input)) ([resultWrapper1566683 input] (clojure.core/let [rawinput1566682 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566684 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-config-does-not-exist-exception ([input] (response-deployment-config-does-not-exist-exception nil input)) ([resultWrapper1566686 input] (clojure.core/let [rawinput1566685 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566687 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-git-hub-account-token-name-required-exception ([input] (response-git-hub-account-token-name-required-exception nil input)) ([resultWrapper1566689 input] (clojure.core/let [rawinput1566688 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566690 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-config-limit-exceeded-exception ([input] (response-deployment-config-limit-exceeded-exception nil input)) ([resultWrapper1566692 input] (clojure.core/let [rawinput1566691 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566693 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-auto-scaling-group-exception ([input] (response-invalid-auto-scaling-group-exception nil input)) ([resultWrapper1566695 input] (clojure.core/let [rawinput1566694 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566696 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-traffic-routing-configuration-exception ([input] (response-invalid-traffic-routing-configuration-exception nil input)) ([resultWrapper1566698 input] (clojure.core/let [rawinput1566697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566699 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deployment-group-name-required-exception ([input] (response-deployment-group-name-required-exception nil input)) ([resultWrapper1566701 input] (clojure.core/let [rawinput1566700 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566702 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-tag-filter-exception ([input] (response-invalid-tag-filter-exception nil input)) ([resultWrapper1566704 input] (clojure.core/let [rawinput1566703 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566705 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-role-required-exception ([input] (response-role-required-exception nil input)) ([resultWrapper1566707 input] (clojure.core/let [rawinput1566706 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566708 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-deployments-output ([input] (response-list-deployments-output nil input)) ([resultWrapper1566710 input] (clojure.core/let [rawinput1566709 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566711 {"deployments" (rawinput1566709 "deployments"), "nextToken" (rawinput1566709 "nextToken")}] (clojure.core/cond-> {} (letvar1566711 "deployments") (clojure.core/assoc :deployments (deser-deployments-list (clojure.core/get-in letvar1566711 ["deployments"]))) (letvar1566711 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566711 ["nextToken"])))))))

(clojure.core/defn- response-instance-name-already-registered-exception ([input] (response-instance-name-already-registered-exception nil input)) ([resultWrapper1566713 input] (clojure.core/let [rawinput1566712 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566714 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-alarm-config-exception ([input] (response-invalid-alarm-config-exception nil input)) ([resultWrapper1566716 input] (clojure.core/let [rawinput1566715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566717 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-instance-limit-exceeded-exception ([input] (response-instance-limit-exceeded-exception nil input)) ([resultWrapper1566719 input] (clojure.core/let [rawinput1566718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566720 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-alarms-limit-exceeded-exception ([input] (response-alarms-limit-exceeded-exception nil input)) ([resultWrapper1566722 input] (clojure.core/let [rawinput1566721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566723 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-time-range-exception ([input] (response-invalid-time-range-exception nil input)) ([resultWrapper1566725 input] (clojure.core/let [rawinput1566724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566726 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-deployment-group-output ([input] (response-create-deployment-group-output nil input)) ([resultWrapper1566728 input] (clojure.core/let [rawinput1566727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566729 {"deploymentGroupId" (rawinput1566727 "deploymentGroupId")}] (clojure.core/cond-> {} (letvar1566729 "deploymentGroupId") (clojure.core/assoc :deployment-group-id (deser-deployment-group-id (clojure.core/get-in letvar1566729 ["deploymentGroupId"])))))))

(clojure.core/defn- response-application-already-exists-exception ([input] (response-application-already-exists-exception nil input)) ([resultWrapper1566731 input] (clojure.core/let [rawinput1566730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566732 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-target-instances-exception ([input] (response-invalid-target-instances-exception nil input)) ([resultWrapper1566734 input] (clojure.core/let [rawinput1566733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566735 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-git-hub-account-token-names-output ([input] (response-list-git-hub-account-token-names-output nil input)) ([resultWrapper1566737 input] (clojure.core/let [rawinput1566736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566738 {"tokenNameList" (rawinput1566736 "tokenNameList"), "nextToken" (rawinput1566736 "nextToken")}] (clojure.core/cond-> {} (letvar1566738 "tokenNameList") (clojure.core/assoc :token-name-list (deser-git-hub-account-token-name-list (clojure.core/get-in letvar1566738 ["tokenNameList"]))) (letvar1566738 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1566738 ["nextToken"])))))))

(clojure.core/defn- response-resource-validation-exception ([input] (response-resource-validation-exception nil input)) ([resultWrapper1566740 input] (clojure.core/let [rawinput1566739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566741 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-lifecycle-event-already-completed-exception ([input] (response-lifecycle-event-already-completed-exception nil input)) ([resultWrapper1566743 input] (clojure.core/let [rawinput1566742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566744 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-action-for-deployment-type-exception ([input] (response-unsupported-action-for-deployment-type-exception nil input)) ([resultWrapper1566746 input] (clojure.core/let [rawinput1566745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1566747 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.codedeploy/deployment-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.codedeploy/deployment-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.codedeploy/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.core/defn deregister-on-premises-instance ([deregister-on-premises-instance-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-deregister-on-premises-instance-input deregister-on-premises-instance-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codedeploy/endpoints, :http.request.configuration/target-prefix "CodeDeploy_20141006", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2014-10-06", :http.request.configuration/service-id "CodeDeploy", :http.request.spec/input-spec :portkey.aws.codedeploy/deregister-on-premises-instance-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeregisterOnPremisesInstance", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"InstanceNameRequiredException" :portkey.aws.codedeploy/instance-name-required-exception, "InvalidInstanceNameException" :portkey.aws.codedeploy/invalid-instance-name-exception}})))))
