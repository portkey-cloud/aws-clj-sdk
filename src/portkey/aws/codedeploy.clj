...
(clojure.spec.alpha/def :portkey.aws.codedeploy/deployment-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.codedeploy/deployment-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.codedeploy/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 100))))
...
(clojure.core/defn list-deployment-configs ([] (list-deployment-configs {})) ([list-deployment-configs-inputinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-deployment-configs-input list-deployment-configs-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.codedeploy/endpoints, :http.request.spec/output-spec :portkey.aws.codedeploy/list-deployment-configs-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2014-10-06", :http.request.configuration/service-id "CodeDeploy", :http.request.spec/input-spec :portkey.aws.codedeploy/list-deployment-configs-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListDeploymentConfigs", :http.request.spec/error-spec {"InvalidNextTokenException" :portkey.aws.codedeploy/invalid-next-token-exception}})))))
...
(clojure.core/defn list-applications ([] (list-applications {})) ([list-applications-inputinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-applications-input list-applications-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.codedeploy/endpoints, :http.request.spec/output-spec :portkey.aws.codedeploy/list-applications-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2014-10-06", :http.request.configuration/service-id "CodeDeploy", :http.request.spec/input-spec :portkey.aws.codedeploy/list-applications-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListApplications", :http.request.spec/error-spec {"InvalidNextTokenException" :portkey.aws.codedeploy/invalid-next-token-exception}})))))
...
(clojure.core/defn get-application ([get-application-inputinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-application-input get-application-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.codedeploy/endpoints, :http.request.spec/output-spec :portkey.aws.codedeploy/get-application-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2014-10-06", :http.request.configuration/service-id "CodeDeploy", :http.request.spec/input-spec :portkey.aws.codedeploy/get-application-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetApplication", :http.request.spec/error-spec {"ApplicationNameRequiredException" :portkey.aws.codedeploy/application-name-required-exception, "InvalidApplicationNameException" :portkey.aws.codedeploy/invalid-application-name-exception, "ApplicationDoesNotExistException" :portkey.aws.codedeploy/application-does-not-exist-exception}})))))
