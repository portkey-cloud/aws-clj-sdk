...
(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper475818 input] (clojure.core/let [rawinput475817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475819 {"Message" (rawinput475817 "Message")}] (clojure.core/cond-> {} (letvar475819 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475819 ["Message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper475821 input] (clojure.core/let [rawinput475820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475822 {"Message" (rawinput475820 "Message")}] (clojure.core/cond-> {} (letvar475822 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475822 ["Message"])))))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper475824 input] (clojure.core/let [rawinput475823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475825 {"EventDestinations" (rawinput475823 "EventDestinations")}] (clojure.core/cond-> {} (letvar475825 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar475825 ["EventDestinations"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper475827 input] (clojure.core/let [rawinput475826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475828 {"Message" (rawinput475826 "Message")}] (clojure.core/cond-> {} (letvar475828 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475828 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper475830 input] (clojure.core/let [rawinput475829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475831 {"Message" (rawinput475829 "Message")}] (clojure.core/cond-> {} (letvar475831 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475831 ["Message"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper475833 input] (clojure.core/let [rawinput475832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475834 {"ConfigurationSets" (rawinput475832 "ConfigurationSets"), "NextToken" (rawinput475832 "NextToken")}] (clojure.core/cond-> {} (letvar475834 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-sets (clojure.core/get-in letvar475834 ["ConfigurationSets"]))) (letvar475834 "NextToken") (clojure.core/assoc :next-token (deser-next-token-string (clojure.core/get-in letvar475834 ["NextToken"])))))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper475836 input] (clojure.core/let [rawinput475835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475837 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper475839 input] (clojure.core/let [rawinput475838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475840 {"Message" (rawinput475838 "Message")}] (clojure.core/cond-> {} (letvar475840 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475840 ["Message"])))))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper475842 input] (clojure.core/let [rawinput475841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475843 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper475845 input] (clojure.core/let [rawinput475844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475846 {"Message" (rawinput475844 "Message")}] (clojure.core/cond-> {} (letvar475846 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar475846 ["Message"])))))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper475848 input] (clojure.core/let [rawinput475847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475849 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-voice-message-response ([input] (response-send-voice-message-response nil input)) ([resultWrapper475851 input] (clojure.core/let [rawinput475850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475852 {"MessageId" (rawinput475850 "MessageId")}] (clojure.core/cond-> {} (letvar475852 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar475852 ["MessageId"])))))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper475854 input] (clojure.core/let [rawinput475853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475855 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper475857 input] (clojure.core/let [rawinput475856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar475858 {}] (clojure.core/cond-> {}))))
