...
(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper1745615 input] (clojure.core/let [rawinput1745614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745616 {"Message" (rawinput1745614 "Message")}] (clojure.core/cond-> {} (letvar1745616 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745616 ["Message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1745618 input] (clojure.core/let [rawinput1745617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745619 {"Message" (rawinput1745617 "Message")}] (clojure.core/cond-> {} (letvar1745619 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745619 ["Message"])))))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper1745621 input] (clojure.core/let [rawinput1745620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745622 {"EventDestinations" (rawinput1745620 "EventDestinations")}] (clojure.core/cond-> {} (letvar1745622 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar1745622 ["EventDestinations"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1745624 input] (clojure.core/let [rawinput1745623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745625 {"Message" (rawinput1745623 "Message")}] (clojure.core/cond-> {} (letvar1745625 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745625 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1745627 input] (clojure.core/let [rawinput1745626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745628 {"Message" (rawinput1745626 "Message")}] (clojure.core/cond-> {} (letvar1745628 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745628 ["Message"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper1745630 input] (clojure.core/let [rawinput1745629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745631 {"ConfigurationSets" (rawinput1745629 "ConfigurationSets"), "NextToken" (rawinput1745629 "NextToken")}] (clojure.core/cond-> {} (letvar1745631 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-sets (clojure.core/get-in letvar1745631 ["ConfigurationSets"]))) (letvar1745631 "NextToken") (clojure.core/assoc :next-token (deser-next-token-string (clojure.core/get-in letvar1745631 ["NextToken"])))))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper1745633 input] (clojure.core/let [rawinput1745632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745634 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1745636 input] (clojure.core/let [rawinput1745635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745637 {"Message" (rawinput1745635 "Message")}] (clojure.core/cond-> {} (letvar1745637 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745637 ["Message"])))))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper1745639 input] (clojure.core/let [rawinput1745638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745640 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1745642 input] (clojure.core/let [rawinput1745641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745643 {"Message" (rawinput1745641 "Message")}] (clojure.core/cond-> {} (letvar1745643 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1745643 ["Message"])))))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper1745645 input] (clojure.core/let [rawinput1745644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745646 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-voice-message-response ([input] (response-send-voice-message-response nil input)) ([resultWrapper1745648 input] (clojure.core/let [rawinput1745647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745649 {"MessageId" (rawinput1745647 "MessageId")}] (clojure.core/cond-> {} (letvar1745649 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar1745649 ["MessageId"])))))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper1745651 input] (clojure.core/let [rawinput1745650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745652 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper1745654 input] (clojure.core/let [rawinput1745653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1745655 {}] (clojure.core/cond-> {}))))
