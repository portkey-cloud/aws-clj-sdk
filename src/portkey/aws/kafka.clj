...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1254218 input] (clojure.core/let [rawinput1254217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254219 {"invalidParameter" (rawinput1254217 "invalidParameter"), "message" (rawinput1254217 "message")}] (clojure.core/cond-> {} (letvar1254219 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254219 ["invalidParameter"]))) (letvar1254219 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254219 ["message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1254221 input] (clojure.core/let [rawinput1254220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254222 {"invalidParameter" (rawinput1254220 "invalidParameter"), "message" (rawinput1254220 "message")}] (clojure.core/cond-> {} (letvar1254222 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254222 ["invalidParameter"]))) (letvar1254222 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254222 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1254224 input] (clojure.core/let [rawinput1254223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254225 {"invalidParameter" (rawinput1254223 "invalidParameter"), "message" (rawinput1254223 "message")}] (clojure.core/cond-> {} (letvar1254225 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254225 ["invalidParameter"]))) (letvar1254225 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254225 ["message"])))))))

(clojure.core/defn- response-list-clusters-response ([input] (response-list-clusters-response nil input)) ([resultWrapper1254227 input] (clojure.core/let [rawinput1254226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254228 {"clusterInfoList" (rawinput1254226 "clusterInfoList"), "nextToken" (rawinput1254226 "nextToken")}] (clojure.core/cond-> {} (letvar1254228 "clusterInfoList") (clojure.core/assoc :cluster-info-list (deser-list-of-cluster-info (clojure.core/get-in letvar1254228 ["clusterInfoList"]))) (letvar1254228 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1254228 ["nextToken"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1254230 input] (clojure.core/let [rawinput1254229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254231 {"invalidParameter" (rawinput1254229 "invalidParameter"), "message" (rawinput1254229 "message")}] (clojure.core/cond-> {} (letvar1254231 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254231 ["invalidParameter"]))) (letvar1254231 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254231 ["message"])))))))

(clojure.core/defn- response-describe-cluster-response ([input] (response-describe-cluster-response nil input)) ([resultWrapper1254233 input] (clojure.core/let [rawinput1254232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254234 {"clusterInfo" (rawinput1254232 "clusterInfo")}] (clojure.core/cond-> {} (letvar1254234 "clusterInfo") (clojure.core/assoc :cluster-info (deser-cluster-info (clojure.core/get-in letvar1254234 ["clusterInfo"])))))))

(clojure.core/defn- response-get-bootstrap-brokers-response ([input] (response-get-bootstrap-brokers-response nil input)) ([resultWrapper1254236 input] (clojure.core/let [rawinput1254235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254237 {"bootstrapBrokerString" (rawinput1254235 "bootstrapBrokerString")}] (clojure.core/cond-> {} (letvar1254237 "bootstrapBrokerString") (clojure.core/assoc :bootstrap-broker-string (deser-string (clojure.core/get-in letvar1254237 ["bootstrapBrokerString"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1254239 input] (clojure.core/let [rawinput1254238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254240 {"invalidParameter" (rawinput1254238 "invalidParameter"), "message" (rawinput1254238 "message")}] (clojure.core/cond-> {} (letvar1254240 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254240 ["invalidParameter"]))) (letvar1254240 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254240 ["message"])))))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper1254242 input] (clojure.core/let [rawinput1254241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254243 {"clusterArn" (rawinput1254241 "clusterArn"), "state" (rawinput1254241 "state")}] (clojure.core/cond-> {} (letvar1254243 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1254243 ["clusterArn"]))) (letvar1254243 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1254243 ["state"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1254245 input] (clojure.core/let [rawinput1254244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254246 {"invalidParameter" (rawinput1254244 "invalidParameter"), "message" (rawinput1254244 "message")}] (clojure.core/cond-> {} (letvar1254246 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254246 ["invalidParameter"]))) (letvar1254246 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254246 ["message"])))))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper1254248 input] (clojure.core/let [rawinput1254247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254249 {"clusterArn" (rawinput1254247 "clusterArn"), "clusterName" (rawinput1254247 "clusterName"), "state" (rawinput1254247 "state")}] (clojure.core/cond-> {} (letvar1254249 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1254249 ["clusterArn"]))) (letvar1254249 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar1254249 ["clusterName"]))) (letvar1254249 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1254249 ["state"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1254251 input] (clojure.core/let [rawinput1254250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254252 {"invalidParameter" (rawinput1254250 "invalidParameter"), "message" (rawinput1254250 "message")}] (clojure.core/cond-> {} (letvar1254252 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254252 ["invalidParameter"]))) (letvar1254252 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254252 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1254254 input] (clojure.core/let [rawinput1254253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254255 {"invalidParameter" (rawinput1254253 "invalidParameter"), "message" (rawinput1254253 "message")}] (clojure.core/cond-> {} (letvar1254255 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1254255 ["invalidParameter"]))) (letvar1254255 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1254255 ["message"])))))))

(clojure.core/defn- response-list-nodes-response ([input] (response-list-nodes-response nil input)) ([resultWrapper1254257 input] (clojure.core/let [rawinput1254256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1254258 {"nextToken" (rawinput1254256 "nextToken"), "nodeInfoList" (rawinput1254256 "nodeInfoList")}] (clojure.core/cond-> {} (letvar1254258 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1254258 ["nextToken"]))) (letvar1254258 "nodeInfoList") (clojure.core/assoc :node-info-list (deser-list-of-node-info (clojure.core/get-in letvar1254258 ["nodeInfoList"])))))))

(clojure.spec.alpha/def :portkey.aws.kafka/string-min-1-max-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kafka/string-min-1-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.kafka/string-min-5-max-32 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 5 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))
