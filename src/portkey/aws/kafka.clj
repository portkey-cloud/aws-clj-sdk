...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1162659 input] (clojure.core/let [rawinput1162658 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162660 {"invalidParameter" (rawinput1162658 "invalidParameter"), "message" (rawinput1162658 "message")}] (clojure.core/cond-> {} (letvar1162660 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162660 ["invalidParameter"]))) (letvar1162660 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162660 ["message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1162662 input] (clojure.core/let [rawinput1162661 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162663 {"invalidParameter" (rawinput1162661 "invalidParameter"), "message" (rawinput1162661 "message")}] (clojure.core/cond-> {} (letvar1162663 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162663 ["invalidParameter"]))) (letvar1162663 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162663 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1162665 input] (clojure.core/let [rawinput1162664 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162666 {"invalidParameter" (rawinput1162664 "invalidParameter"), "message" (rawinput1162664 "message")}] (clojure.core/cond-> {} (letvar1162666 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162666 ["invalidParameter"]))) (letvar1162666 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162666 ["message"])))))))

(clojure.core/defn- response-list-clusters-response ([input] (response-list-clusters-response nil input)) ([resultWrapper1162668 input] (clojure.core/let [rawinput1162667 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162669 {"clusterInfoList" (rawinput1162667 "clusterInfoList"), "nextToken" (rawinput1162667 "nextToken")}] (clojure.core/cond-> {} (letvar1162669 "clusterInfoList") (clojure.core/assoc :cluster-info-list (deser-list-of-cluster-info (clojure.core/get-in letvar1162669 ["clusterInfoList"]))) (letvar1162669 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1162669 ["nextToken"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1162671 input] (clojure.core/let [rawinput1162670 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162672 {"invalidParameter" (rawinput1162670 "invalidParameter"), "message" (rawinput1162670 "message")}] (clojure.core/cond-> {} (letvar1162672 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162672 ["invalidParameter"]))) (letvar1162672 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162672 ["message"])))))))

(clojure.core/defn- response-describe-cluster-response ([input] (response-describe-cluster-response nil input)) ([resultWrapper1162674 input] (clojure.core/let [rawinput1162673 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162675 {"clusterInfo" (rawinput1162673 "clusterInfo")}] (clojure.core/cond-> {} (letvar1162675 "clusterInfo") (clojure.core/assoc :cluster-info (deser-cluster-info (clojure.core/get-in letvar1162675 ["clusterInfo"])))))))

(clojure.core/defn- response-get-bootstrap-brokers-response ([input] (response-get-bootstrap-brokers-response nil input)) ([resultWrapper1162677 input] (clojure.core/let [rawinput1162676 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162678 {"bootstrapBrokerString" (rawinput1162676 "bootstrapBrokerString")}] (clojure.core/cond-> {} (letvar1162678 "bootstrapBrokerString") (clojure.core/assoc :bootstrap-broker-string (deser-string (clojure.core/get-in letvar1162678 ["bootstrapBrokerString"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1162680 input] (clojure.core/let [rawinput1162679 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162681 {"invalidParameter" (rawinput1162679 "invalidParameter"), "message" (rawinput1162679 "message")}] (clojure.core/cond-> {} (letvar1162681 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162681 ["invalidParameter"]))) (letvar1162681 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162681 ["message"])))))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper1162683 input] (clojure.core/let [rawinput1162682 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162684 {"clusterArn" (rawinput1162682 "clusterArn"), "state" (rawinput1162682 "state")}] (clojure.core/cond-> {} (letvar1162684 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1162684 ["clusterArn"]))) (letvar1162684 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1162684 ["state"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1162686 input] (clojure.core/let [rawinput1162685 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162687 {"invalidParameter" (rawinput1162685 "invalidParameter"), "message" (rawinput1162685 "message")}] (clojure.core/cond-> {} (letvar1162687 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162687 ["invalidParameter"]))) (letvar1162687 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162687 ["message"])))))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper1162689 input] (clojure.core/let [rawinput1162688 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162690 {"clusterArn" (rawinput1162688 "clusterArn"), "clusterName" (rawinput1162688 "clusterName"), "state" (rawinput1162688 "state")}] (clojure.core/cond-> {} (letvar1162690 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1162690 ["clusterArn"]))) (letvar1162690 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar1162690 ["clusterName"]))) (letvar1162690 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1162690 ["state"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1162692 input] (clojure.core/let [rawinput1162691 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162693 {"invalidParameter" (rawinput1162691 "invalidParameter"), "message" (rawinput1162691 "message")}] (clojure.core/cond-> {} (letvar1162693 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162693 ["invalidParameter"]))) (letvar1162693 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162693 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1162695 input] (clojure.core/let [rawinput1162694 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162696 {"invalidParameter" (rawinput1162694 "invalidParameter"), "message" (rawinput1162694 "message")}] (clojure.core/cond-> {} (letvar1162696 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1162696 ["invalidParameter"]))) (letvar1162696 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1162696 ["message"])))))))

(clojure.core/defn- response-list-nodes-response ([input] (response-list-nodes-response nil input)) ([resultWrapper1162698 input] (clojure.core/let [rawinput1162697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1162699 {"nextToken" (rawinput1162697 "nextToken"), "nodeInfoList" (rawinput1162697 "nodeInfoList")}] (clojure.core/cond-> {} (letvar1162699 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1162699 ["nextToken"]))) (letvar1162699 "nodeInfoList") (clojure.core/assoc :node-info-list (deser-list-of-node-info (clojure.core/get-in letvar1162699 ["nodeInfoList"])))))))

(clojure.spec.alpha/def :portkey.aws.kafka/string-min-1-max-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kafka/string-min-1-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.kafka/string-min-5-max-32 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
