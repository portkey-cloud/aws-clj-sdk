...
(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1377832 input] (clojure.core/let [rawinput1377831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1377833 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1377835 input] (clojure.core/let [rawinput1377834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1377836 {"tags" (rawinput1377834 "tags")}] (clojure.core/cond-> {} (letvar1377836 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar1377836 ["tags"])))))))

(clojure.core/defn- response-list-playback-configurations-response ([input] (response-list-playback-configurations-response nil input)) ([resultWrapper1377838 input] (clojure.core/let [rawinput1377837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1377839 {"Items" (rawinput1377837 "Items"), "NextToken" (rawinput1377837 "NextToken")}] (clojure.core/cond-> {} (letvar1377839 "Items") (clojure.core/assoc :items (deser-list-of-playback-configurations (clojure.core/get-in letvar1377839 ["Items"]))) (letvar1377839 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1377839 ["NextToken"])))))))

(clojure.core/defn- response-put-playback-configuration-response ([input] (response-put-playback-configuration-response nil input)) ([resultWrapper1377841 input] (clojure.core/let [rawinput1377840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1377842 {"HlsConfiguration" (rawinput1377840 "HlsConfiguration"), "tags" (rawinput1377840 "tags"), "DashConfiguration" (rawinput1377840 "DashConfiguration"), "CdnConfiguration" (rawinput1377840 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput1377840 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput1377840 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput1377840 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput1377840 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput1377840 "SlateAdUrl"), "Name" (rawinput1377840 "Name"), "SessionInitializationEndpointPrefix" (rawinput1377840 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput1377840 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar1377842 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar1377842 ["HlsConfiguration"]))) (letvar1377842 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar1377842 ["tags"]))) (letvar1377842 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar1377842 ["DashConfiguration"]))) (letvar1377842 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar1377842 ["CdnConfiguration"]))) (letvar1377842 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar1377842 ["VideoContentSourceUrl"]))) (letvar1377842 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar1377842 ["PlaybackEndpointPrefix"]))) (letvar1377842 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar1377842 ["AdDecisionServerUrl"]))) (letvar1377842 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar1377842 ["PlaybackConfigurationArn"]))) (letvar1377842 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar1377842 ["SlateAdUrl"]))) (letvar1377842 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1377842 ["Name"]))) (letvar1377842 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar1377842 ["SessionInitializationEndpointPrefix"]))) (letvar1377842 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar1377842 ["TranscodeProfileName"])))))))

(clojure.core/defn- response-get-playback-configuration-response ([input] (response-get-playback-configuration-response nil input)) ([resultWrapper1377844 input] (clojure.core/let [rawinput1377843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1377845 {"HlsConfiguration" (rawinput1377843 "HlsConfiguration"), "tags" (rawinput1377843 "tags"), "DashConfiguration" (rawinput1377843 "DashConfiguration"), "CdnConfiguration" (rawinput1377843 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput1377843 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput1377843 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput1377843 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput1377843 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput1377843 "SlateAdUrl"), "Name" (rawinput1377843 "Name"), "SessionInitializationEndpointPrefix" (rawinput1377843 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput1377843 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar1377845 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar1377845 ["HlsConfiguration"]))) (letvar1377845 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar1377845 ["tags"]))) (letvar1377845 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar1377845 ["DashConfiguration"]))) (letvar1377845 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar1377845 ["CdnConfiguration"]))) (letvar1377845 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar1377845 ["VideoContentSourceUrl"]))) (letvar1377845 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar1377845 ["PlaybackEndpointPrefix"]))) (letvar1377845 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar1377845 ["AdDecisionServerUrl"]))) (letvar1377845 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar1377845 ["PlaybackConfigurationArn"]))) (letvar1377845 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar1377845 ["SlateAdUrl"]))) (letvar1377845 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1377845 ["Name"]))) (letvar1377845 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar1377845 ["SessionInitializationEndpointPrefix"]))) (letvar1377845 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar1377845 ["TranscodeProfileName"])))))))
