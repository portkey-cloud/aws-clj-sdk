...
(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper384835 input] (clojure.core/let [rawinput384834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384836 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper384838 input] (clojure.core/let [rawinput384837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384839 {"tags" (rawinput384837 "tags")}] (clojure.core/cond-> {} (letvar384839 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar384839 ["tags"])))))))

(clojure.core/defn- response-list-playback-configurations-response ([input] (response-list-playback-configurations-response nil input)) ([resultWrapper384841 input] (clojure.core/let [rawinput384840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384842 {"Items" (rawinput384840 "Items"), "NextToken" (rawinput384840 "NextToken")}] (clojure.core/cond-> {} (letvar384842 "Items") (clojure.core/assoc :items (deser-list-of-playback-configurations (clojure.core/get-in letvar384842 ["Items"]))) (letvar384842 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar384842 ["NextToken"])))))))

(clojure.core/defn- response-put-playback-configuration-response ([input] (response-put-playback-configuration-response nil input)) ([resultWrapper384844 input] (clojure.core/let [rawinput384843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384845 {"HlsConfiguration" (rawinput384843 "HlsConfiguration"), "tags" (rawinput384843 "tags"), "DashConfiguration" (rawinput384843 "DashConfiguration"), "CdnConfiguration" (rawinput384843 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput384843 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput384843 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput384843 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput384843 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput384843 "SlateAdUrl"), "Name" (rawinput384843 "Name"), "SessionInitializationEndpointPrefix" (rawinput384843 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput384843 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar384845 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar384845 ["HlsConfiguration"]))) (letvar384845 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar384845 ["tags"]))) (letvar384845 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar384845 ["DashConfiguration"]))) (letvar384845 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar384845 ["CdnConfiguration"]))) (letvar384845 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar384845 ["VideoContentSourceUrl"]))) (letvar384845 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar384845 ["PlaybackEndpointPrefix"]))) (letvar384845 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar384845 ["AdDecisionServerUrl"]))) (letvar384845 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar384845 ["PlaybackConfigurationArn"]))) (letvar384845 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar384845 ["SlateAdUrl"]))) (letvar384845 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar384845 ["Name"]))) (letvar384845 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar384845 ["SessionInitializationEndpointPrefix"]))) (letvar384845 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar384845 ["TranscodeProfileName"])))))))

(clojure.core/defn- response-get-playback-configuration-response ([input] (response-get-playback-configuration-response nil input)) ([resultWrapper384847 input] (clojure.core/let [rawinput384846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384848 {"HlsConfiguration" (rawinput384846 "HlsConfiguration"), "tags" (rawinput384846 "tags"), "DashConfiguration" (rawinput384846 "DashConfiguration"), "CdnConfiguration" (rawinput384846 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput384846 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput384846 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput384846 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput384846 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput384846 "SlateAdUrl"), "Name" (rawinput384846 "Name"), "SessionInitializationEndpointPrefix" (rawinput384846 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput384846 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar384848 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar384848 ["HlsConfiguration"]))) (letvar384848 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar384848 ["tags"]))) (letvar384848 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar384848 ["DashConfiguration"]))) (letvar384848 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar384848 ["CdnConfiguration"]))) (letvar384848 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar384848 ["VideoContentSourceUrl"]))) (letvar384848 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar384848 ["PlaybackEndpointPrefix"]))) (letvar384848 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar384848 ["AdDecisionServerUrl"]))) (letvar384848 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar384848 ["PlaybackConfigurationArn"]))) (letvar384848 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar384848 ["SlateAdUrl"]))) (letvar384848 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar384848 ["Name"]))) (letvar384848 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar384848 ["SessionInitializationEndpointPrefix"]))) (letvar384848 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar384848 ["TranscodeProfileName"])))))))
