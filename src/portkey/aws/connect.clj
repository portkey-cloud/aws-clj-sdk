...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper1118870 input] (clojure.core/let [rawinput1118869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118871 {"UserId" (rawinput1118869 "UserId"), "UserArn" (rawinput1118869 "UserArn")}] (clojure.core/cond-> {} (letvar1118871 "UserId") (clojure.core/assoc :user-id (deser-user-id (clojure.core/get-in letvar1118871 ["UserId"]))) (letvar1118871 "UserArn") (clojure.core/assoc :user-arn (deser-arn (clojure.core/get-in letvar1118871 ["UserArn"])))))))

(clojure.core/defn- response-get-current-metric-data-response ([input] (response-get-current-metric-data-response nil input)) ([resultWrapper1118873 input] (clojure.core/let [rawinput1118872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118874 {"NextToken" (rawinput1118872 "NextToken"), "MetricResults" (rawinput1118872 "MetricResults"), "DataSnapshotTime" (rawinput1118872 "DataSnapshotTime")}] (clojure.core/cond-> {} (letvar1118874 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118874 ["NextToken"]))) (letvar1118874 "MetricResults") (clojure.core/assoc :metric-results (deser-current-metric-results (clojure.core/get-in letvar1118874 ["MetricResults"]))) (letvar1118874 "DataSnapshotTime") (clojure.core/assoc :data-snapshot-time (desertimestamp (clojure.core/get-in letvar1118874 ["DataSnapshotTime"])))))))

(clojure.core/defn- response-get-metric-data-response ([input] (response-get-metric-data-response nil input)) ([resultWrapper1118876 input] (clojure.core/let [rawinput1118875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118877 {"NextToken" (rawinput1118875 "NextToken"), "MetricResults" (rawinput1118875 "MetricResults")}] (clojure.core/cond-> {} (letvar1118877 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118877 ["NextToken"]))) (letvar1118877 "MetricResults") (clojure.core/assoc :metric-results (deser-historical-metric-results (clojure.core/get-in letvar1118877 ["MetricResults"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1118879 input] (clojure.core/let [rawinput1118878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118880 {"Message" (rawinput1118878 "Message")}] (clojure.core/cond-> {} (letvar1118880 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118880 ["Message"])))))))

(clojure.core/defn- response-update-contact-attributes-response ([input] (response-update-contact-attributes-response nil input)) ([resultWrapper1118882 input] (clojure.core/let [rawinput1118881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118883 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-hierarchy-structure-response ([input] (response-describe-user-hierarchy-structure-response nil input)) ([resultWrapper1118885 input] (clojure.core/let [rawinput1118884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118886 {"HierarchyStructure" (rawinput1118884 "HierarchyStructure")}] (clojure.core/cond-> {} (letvar1118886 "HierarchyStructure") (clojure.core/assoc :hierarchy-structure (deser-hierarchy-structure (clojure.core/get-in letvar1118886 ["HierarchyStructure"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1118888 input] (clojure.core/let [rawinput1118887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118889 {"Message" (rawinput1118887 "Message")}] (clojure.core/cond-> {} (letvar1118889 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118889 ["Message"])))))))

(clojure.core/defn- response-destination-not-allowed-exception ([input] (response-destination-not-allowed-exception nil input)) ([resultWrapper1118891 input] (clojure.core/let [rawinput1118890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118892 {"Message" (rawinput1118890 "Message")}] (clojure.core/cond-> {} (letvar1118892 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118892 ["Message"])))))))

(clojure.core/defn- response-list-security-profiles-response ([input] (response-list-security-profiles-response nil input)) ([resultWrapper1118894 input] (clojure.core/let [rawinput1118893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118895 {"SecurityProfileSummaryList" (rawinput1118893 "SecurityProfileSummaryList"), "NextToken" (rawinput1118893 "NextToken")}] (clojure.core/cond-> {} (letvar1118895 "SecurityProfileSummaryList") (clojure.core/assoc :security-profile-summary-list (deser-security-profile-summary-list (clojure.core/get-in letvar1118895 ["SecurityProfileSummaryList"]))) (letvar1118895 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118895 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper1118897 input] (clojure.core/let [rawinput1118896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118898 {"User" (rawinput1118896 "User")}] (clojure.core/cond-> {} (letvar1118898 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar1118898 ["User"])))))))

(clojure.core/defn- response-outbound-contact-not-permitted-exception ([input] (response-outbound-contact-not-permitted-exception nil input)) ([resultWrapper1118900 input] (clojure.core/let [rawinput1118899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118901 {"Message" (rawinput1118899 "Message")}] (clojure.core/cond-> {} (letvar1118901 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118901 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1118903 input] (clojure.core/let [rawinput1118902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118904 {"Message" (rawinput1118902 "Message")}] (clojure.core/cond-> {} (letvar1118904 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118904 ["Message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper1118906 input] (clojure.core/let [rawinput1118905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118907 {"Message" (rawinput1118905 "Message")}] (clojure.core/cond-> {} (letvar1118907 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118907 ["Message"])))))))

(clojure.core/defn- response-get-federation-token-response ([input] (response-get-federation-token-response nil input)) ([resultWrapper1118909 input] (clojure.core/let [rawinput1118908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118910 {"Credentials" (rawinput1118908 "Credentials")}] (clojure.core/cond-> {} (letvar1118910 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar1118910 ["Credentials"])))))))

(clojure.core/defn- response-contact-not-found-exception ([input] (response-contact-not-found-exception nil input)) ([resultWrapper1118912 input] (clojure.core/let [rawinput1118911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118913 {"Message" (rawinput1118911 "Message")}] (clojure.core/cond-> {} (letvar1118913 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118913 ["Message"])))))))

(clojure.core/defn- response-get-contact-attributes-response ([input] (response-get-contact-attributes-response nil input)) ([resultWrapper1118915 input] (clojure.core/let [rawinput1118914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118916 {"Attributes" (rawinput1118914 "Attributes")}] (clojure.core/cond-> {} (letvar1118916 "Attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar1118916 ["Attributes"])))))))

(clojure.core/defn- response-list-routing-profiles-response ([input] (response-list-routing-profiles-response nil input)) ([resultWrapper1118918 input] (clojure.core/let [rawinput1118917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118919 {"RoutingProfileSummaryList" (rawinput1118917 "RoutingProfileSummaryList"), "NextToken" (rawinput1118917 "NextToken")}] (clojure.core/cond-> {} (letvar1118919 "RoutingProfileSummaryList") (clojure.core/assoc :routing-profile-summary-list (deser-routing-profile-summary-list (clojure.core/get-in letvar1118919 ["RoutingProfileSummaryList"]))) (letvar1118919 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118919 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-hierarchy-group-response ([input] (response-describe-user-hierarchy-group-response nil input)) ([resultWrapper1118921 input] (clojure.core/let [rawinput1118920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118922 {"HierarchyGroup" (rawinput1118920 "HierarchyGroup")}] (clojure.core/cond-> {} (letvar1118922 "HierarchyGroup") (clojure.core/assoc :hierarchy-group (deser-hierarchy-group (clojure.core/get-in letvar1118922 ["HierarchyGroup"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1118924 input] (clojure.core/let [rawinput1118923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118925 {"Message" (rawinput1118923 "Message")}] (clojure.core/cond-> {} (letvar1118925 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118925 ["Message"])))))))

(clojure.core/defn- response-stop-contact-response ([input] (response-stop-contact-response nil input)) ([resultWrapper1118927 input] (clojure.core/let [rawinput1118926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118928 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-hierarchy-groups-response ([input] (response-list-user-hierarchy-groups-response nil input)) ([resultWrapper1118930 input] (clojure.core/let [rawinput1118929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118931 {"UserHierarchyGroupSummaryList" (rawinput1118929 "UserHierarchyGroupSummaryList"), "NextToken" (rawinput1118929 "NextToken")}] (clojure.core/cond-> {} (letvar1118931 "UserHierarchyGroupSummaryList") (clojure.core/assoc :user-hierarchy-group-summary-list (deser-hierarchy-group-summary-list (clojure.core/get-in letvar1118931 ["UserHierarchyGroupSummaryList"]))) (letvar1118931 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118931 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1118933 input] (clojure.core/let [rawinput1118932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118934 {"Message" (rawinput1118932 "Message")}] (clojure.core/cond-> {} (letvar1118934 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118934 ["Message"])))))))

(clojure.core/defn- response-start-outbound-voice-contact-response ([input] (response-start-outbound-voice-contact-response nil input)) ([resultWrapper1118936 input] (clojure.core/let [rawinput1118935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118937 {"ContactId" (rawinput1118935 "ContactId")}] (clojure.core/cond-> {} (letvar1118937 "ContactId") (clojure.core/assoc :contact-id (deser-contact-id (clojure.core/get-in letvar1118937 ["ContactId"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1118939 input] (clojure.core/let [rawinput1118938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118940 {"Message" (rawinput1118938 "Message")}] (clojure.core/cond-> {} (letvar1118940 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118940 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1118942 input] (clojure.core/let [rawinput1118941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118943 {"UserSummaryList" (rawinput1118941 "UserSummaryList"), "NextToken" (rawinput1118941 "NextToken")}] (clojure.core/cond-> {} (letvar1118943 "UserSummaryList") (clojure.core/assoc :user-summary-list (deser-user-summary-list (clojure.core/get-in letvar1118943 ["UserSummaryList"]))) (letvar1118943 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1118943 ["NextToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper1118945 input] (clojure.core/let [rawinput1118944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1118946 {"Message" (rawinput1118944 "Message")}] (clojure.core/cond-> {} (letvar1118946 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1118946 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.connect/instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/contact-flow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.connect/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\S]{8,64}$/" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.connect/agent-first-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.connect/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect/agent-last-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/routing-profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/contact-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.connect/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect/agent-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 20)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\_\-\.]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.connect/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
