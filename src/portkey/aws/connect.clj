...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper125873 input] (clojure.core/let [rawinput125872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125874 {"UserId" (rawinput125872 "UserId"), "UserArn" (rawinput125872 "UserArn")}] (clojure.core/cond-> {} (letvar125874 "UserId") (clojure.core/assoc :user-id (deser-user-id (clojure.core/get-in letvar125874 ["UserId"]))) (letvar125874 "UserArn") (clojure.core/assoc :user-arn (deser-arn (clojure.core/get-in letvar125874 ["UserArn"])))))))

(clojure.core/defn- response-get-current-metric-data-response ([input] (response-get-current-metric-data-response nil input)) ([resultWrapper125876 input] (clojure.core/let [rawinput125875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125877 {"NextToken" (rawinput125875 "NextToken"), "MetricResults" (rawinput125875 "MetricResults"), "DataSnapshotTime" (rawinput125875 "DataSnapshotTime")}] (clojure.core/cond-> {} (letvar125877 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125877 ["NextToken"]))) (letvar125877 "MetricResults") (clojure.core/assoc :metric-results (deser-current-metric-results (clojure.core/get-in letvar125877 ["MetricResults"]))) (letvar125877 "DataSnapshotTime") (clojure.core/assoc :data-snapshot-time (desertimestamp (clojure.core/get-in letvar125877 ["DataSnapshotTime"])))))))

(clojure.core/defn- response-get-metric-data-response ([input] (response-get-metric-data-response nil input)) ([resultWrapper125879 input] (clojure.core/let [rawinput125878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125880 {"NextToken" (rawinput125878 "NextToken"), "MetricResults" (rawinput125878 "MetricResults")}] (clojure.core/cond-> {} (letvar125880 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125880 ["NextToken"]))) (letvar125880 "MetricResults") (clojure.core/assoc :metric-results (deser-historical-metric-results (clojure.core/get-in letvar125880 ["MetricResults"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper125882 input] (clojure.core/let [rawinput125881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125883 {"Message" (rawinput125881 "Message")}] (clojure.core/cond-> {} (letvar125883 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125883 ["Message"])))))))

(clojure.core/defn- response-update-contact-attributes-response ([input] (response-update-contact-attributes-response nil input)) ([resultWrapper125885 input] (clojure.core/let [rawinput125884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125886 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-hierarchy-structure-response ([input] (response-describe-user-hierarchy-structure-response nil input)) ([resultWrapper125888 input] (clojure.core/let [rawinput125887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125889 {"HierarchyStructure" (rawinput125887 "HierarchyStructure")}] (clojure.core/cond-> {} (letvar125889 "HierarchyStructure") (clojure.core/assoc :hierarchy-structure (deser-hierarchy-structure (clojure.core/get-in letvar125889 ["HierarchyStructure"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper125891 input] (clojure.core/let [rawinput125890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125892 {"Message" (rawinput125890 "Message")}] (clojure.core/cond-> {} (letvar125892 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125892 ["Message"])))))))

(clojure.core/defn- response-destination-not-allowed-exception ([input] (response-destination-not-allowed-exception nil input)) ([resultWrapper125894 input] (clojure.core/let [rawinput125893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125895 {"Message" (rawinput125893 "Message")}] (clojure.core/cond-> {} (letvar125895 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125895 ["Message"])))))))

(clojure.core/defn- response-list-security-profiles-response ([input] (response-list-security-profiles-response nil input)) ([resultWrapper125897 input] (clojure.core/let [rawinput125896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125898 {"SecurityProfileSummaryList" (rawinput125896 "SecurityProfileSummaryList"), "NextToken" (rawinput125896 "NextToken")}] (clojure.core/cond-> {} (letvar125898 "SecurityProfileSummaryList") (clojure.core/assoc :security-profile-summary-list (deser-security-profile-summary-list (clojure.core/get-in letvar125898 ["SecurityProfileSummaryList"]))) (letvar125898 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125898 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper125900 input] (clojure.core/let [rawinput125899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125901 {"User" (rawinput125899 "User")}] (clojure.core/cond-> {} (letvar125901 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar125901 ["User"])))))))

(clojure.core/defn- response-outbound-contact-not-permitted-exception ([input] (response-outbound-contact-not-permitted-exception nil input)) ([resultWrapper125903 input] (clojure.core/let [rawinput125902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125904 {"Message" (rawinput125902 "Message")}] (clojure.core/cond-> {} (letvar125904 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125904 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper125906 input] (clojure.core/let [rawinput125905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125907 {"Message" (rawinput125905 "Message")}] (clojure.core/cond-> {} (letvar125907 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125907 ["Message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper125909 input] (clojure.core/let [rawinput125908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125910 {"Message" (rawinput125908 "Message")}] (clojure.core/cond-> {} (letvar125910 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125910 ["Message"])))))))

(clojure.core/defn- response-get-federation-token-response ([input] (response-get-federation-token-response nil input)) ([resultWrapper125912 input] (clojure.core/let [rawinput125911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125913 {"Credentials" (rawinput125911 "Credentials")}] (clojure.core/cond-> {} (letvar125913 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar125913 ["Credentials"])))))))

(clojure.core/defn- response-contact-not-found-exception ([input] (response-contact-not-found-exception nil input)) ([resultWrapper125915 input] (clojure.core/let [rawinput125914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125916 {"Message" (rawinput125914 "Message")}] (clojure.core/cond-> {} (letvar125916 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125916 ["Message"])))))))

(clojure.core/defn- response-get-contact-attributes-response ([input] (response-get-contact-attributes-response nil input)) ([resultWrapper125918 input] (clojure.core/let [rawinput125917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125919 {"Attributes" (rawinput125917 "Attributes")}] (clojure.core/cond-> {} (letvar125919 "Attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar125919 ["Attributes"])))))))

(clojure.core/defn- response-list-routing-profiles-response ([input] (response-list-routing-profiles-response nil input)) ([resultWrapper125921 input] (clojure.core/let [rawinput125920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125922 {"RoutingProfileSummaryList" (rawinput125920 "RoutingProfileSummaryList"), "NextToken" (rawinput125920 "NextToken")}] (clojure.core/cond-> {} (letvar125922 "RoutingProfileSummaryList") (clojure.core/assoc :routing-profile-summary-list (deser-routing-profile-summary-list (clojure.core/get-in letvar125922 ["RoutingProfileSummaryList"]))) (letvar125922 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125922 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-hierarchy-group-response ([input] (response-describe-user-hierarchy-group-response nil input)) ([resultWrapper125924 input] (clojure.core/let [rawinput125923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125925 {"HierarchyGroup" (rawinput125923 "HierarchyGroup")}] (clojure.core/cond-> {} (letvar125925 "HierarchyGroup") (clojure.core/assoc :hierarchy-group (deser-hierarchy-group (clojure.core/get-in letvar125925 ["HierarchyGroup"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper125927 input] (clojure.core/let [rawinput125926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125928 {"Message" (rawinput125926 "Message")}] (clojure.core/cond-> {} (letvar125928 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125928 ["Message"])))))))

(clojure.core/defn- response-stop-contact-response ([input] (response-stop-contact-response nil input)) ([resultWrapper125930 input] (clojure.core/let [rawinput125929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125931 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-hierarchy-groups-response ([input] (response-list-user-hierarchy-groups-response nil input)) ([resultWrapper125933 input] (clojure.core/let [rawinput125932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125934 {"UserHierarchyGroupSummaryList" (rawinput125932 "UserHierarchyGroupSummaryList"), "NextToken" (rawinput125932 "NextToken")}] (clojure.core/cond-> {} (letvar125934 "UserHierarchyGroupSummaryList") (clojure.core/assoc :user-hierarchy-group-summary-list (deser-hierarchy-group-summary-list (clojure.core/get-in letvar125934 ["UserHierarchyGroupSummaryList"]))) (letvar125934 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125934 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper125936 input] (clojure.core/let [rawinput125935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125937 {"Message" (rawinput125935 "Message")}] (clojure.core/cond-> {} (letvar125937 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125937 ["Message"])))))))

(clojure.core/defn- response-start-outbound-voice-contact-response ([input] (response-start-outbound-voice-contact-response nil input)) ([resultWrapper125939 input] (clojure.core/let [rawinput125938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125940 {"ContactId" (rawinput125938 "ContactId")}] (clojure.core/cond-> {} (letvar125940 "ContactId") (clojure.core/assoc :contact-id (deser-contact-id (clojure.core/get-in letvar125940 ["ContactId"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper125942 input] (clojure.core/let [rawinput125941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125943 {"Message" (rawinput125941 "Message")}] (clojure.core/cond-> {} (letvar125943 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125943 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper125945 input] (clojure.core/let [rawinput125944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125946 {"UserSummaryList" (rawinput125944 "UserSummaryList"), "NextToken" (rawinput125944 "NextToken")}] (clojure.core/cond-> {} (letvar125946 "UserSummaryList") (clojure.core/assoc :user-summary-list (deser-user-summary-list (clojure.core/get-in letvar125946 ["UserSummaryList"]))) (letvar125946 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar125946 ["NextToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper125948 input] (clojure.core/let [rawinput125947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar125949 {"Message" (rawinput125947 "Message")}] (clojure.core/cond-> {} (letvar125949 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar125949 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.connect/instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/contact-flow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.connect/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\S]{8,64}$/" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.connect/agent-first-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.connect/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect/agent-last-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/routing-profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect/contact-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.connect/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect/agent-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 20)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\_\-\.]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.connect/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
