...
(clojure.core/defn- response-insufficient-cluster-capacity-fault ([input] (response-insufficient-cluster-capacity-fault nil input)) ([resultWrapper1613477 input] (clojure.core/let [rawinput1613476 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613478 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-not-found-fault ([input] (response-node-not-found-fault nil input)) ([resultWrapper1613480 input] (clojure.core/let [rawinput1613479 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613481 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-quota-for-customer-exceeded-fault ([input] (response-cluster-quota-for-customer-exceeded-fault nil input)) ([resultWrapper1613483 input] (clojure.core/let [rawinput1613482 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613484 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-arn-fault ([input] (response-invalid-arn-fault nil input)) ([resultWrapper1613486 input] (clojure.core/let [rawinput1613485 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613487 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reboot-node-response ([input] (response-reboot-node-response nil input)) ([resultWrapper1613489 input] (clojure.core/let [rawinput1613488 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613490 {"Cluster" (rawinput1613488 "Cluster")}] (clojure.core/cond-> {} (letvar1613490 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613490 ["Cluster"])))))))

(clojure.core/defn- response-parameter-group-quota-exceeded-fault ([input] (response-parameter-group-quota-exceeded-fault nil input)) ([resultWrapper1613492 input] (clojure.core/let [rawinput1613491 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613493 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-already-exists-fault ([input] (response-cluster-already-exists-fault nil input)) ([resultWrapper1613495 input] (clojure.core/let [rawinput1613494 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613496 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1613498 input] (clojure.core/let [rawinput1613497 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613499 {"Tags" (rawinput1613497 "Tags"), "NextToken" (rawinput1613497 "NextToken")}] (clojure.core/cond-> {} (letvar1613499 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1613499 ["Tags"]))) (letvar1613499 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613499 ["NextToken"])))))))

(clojure.core/defn- response-invalid-vpc-network-state-fault ([input] (response-invalid-vpc-network-state-fault nil input)) ([resultWrapper1613501 input] (clojure.core/let [rawinput1613500 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613502 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-clusters-response ([input] (response-describe-clusters-response nil input)) ([resultWrapper1613504 input] (clojure.core/let [rawinput1613503 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613505 {"NextToken" (rawinput1613503 "NextToken"), "Clusters" (rawinput1613503 "Clusters")}] (clojure.core/cond-> {} (letvar1613505 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613505 ["NextToken"]))) (letvar1613505 "Clusters") (clojure.core/assoc :clusters (deser-cluster-list (clojure.core/get-in letvar1613505 ["Clusters"])))))))

(clojure.core/defn- response-parameter-group-not-found-fault ([input] (response-parameter-group-not-found-fault nil input)) ([resultWrapper1613507 input] (clojure.core/let [rawinput1613506 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613508 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-quota-per-resource-exceeded ([input] (response-tag-quota-per-resource-exceeded nil input)) ([resultWrapper1613510 input] (clojure.core/let [rawinput1613509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613511 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper1613513 input] (clojure.core/let [rawinput1613512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613514 {"Cluster" (rawinput1613512 "Cluster")}] (clojure.core/cond-> {} (letvar1613514 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613514 ["Cluster"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1613516 input] (clojure.core/let [rawinput1613515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613517 {"Tags" (rawinput1613515 "Tags")}] (clojure.core/cond-> {} (letvar1613517 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1613517 ["Tags"])))))))

(clojure.core/defn- response-describe-parameters-response ([input] (response-describe-parameters-response nil input)) ([resultWrapper1613519 input] (clojure.core/let [rawinput1613518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613520 {"NextToken" (rawinput1613518 "NextToken"), "Parameters" (rawinput1613518 "Parameters")}] (clojure.core/cond-> {} (letvar1613520 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613520 ["NextToken"]))) (letvar1613520 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar1613520 ["Parameters"])))))))

(clojure.core/defn- response-service-linked-role-not-found-fault ([input] (response-service-linked-role-not-found-fault nil input)) ([resultWrapper1613522 input] (clojure.core/let [rawinput1613521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613523 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper1613525 input] (clojure.core/let [rawinput1613524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613526 {"Cluster" (rawinput1613524 "Cluster")}] (clojure.core/cond-> {} (letvar1613526 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613526 ["Cluster"])))))))

(clojure.core/defn- response-subnet-quota-exceeded-fault ([input] (response-subnet-quota-exceeded-fault nil input)) ([resultWrapper1613528 input] (clojure.core/let [rawinput1613527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613529 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-subnet ([input] (response-invalid-subnet nil input)) ([resultWrapper1613531 input] (clojure.core/let [rawinput1613530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613532 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-subnet-group-response ([input] (response-delete-subnet-group-response nil input)) ([resultWrapper1613534 input] (clojure.core/let [rawinput1613533 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613535 {"DeletionMessage" (rawinput1613533 "DeletionMessage")}] (clojure.core/cond-> {} (letvar1613535 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar1613535 ["DeletionMessage"])))))))

(clojure.core/defn- response-subnet-in-use ([input] (response-subnet-in-use nil input)) ([resultWrapper1613537 input] (clojure.core/let [rawinput1613536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613538 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-increase-replication-factor-response ([input] (response-increase-replication-factor-response nil input)) ([resultWrapper1613540 input] (clojure.core/let [rawinput1613539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613541 {"Cluster" (rawinput1613539 "Cluster")}] (clojure.core/cond-> {} (letvar1613541 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613541 ["Cluster"])))))))

(clojure.core/defn- response-describe-subnet-groups-response ([input] (response-describe-subnet-groups-response nil input)) ([resultWrapper1613543 input] (clojure.core/let [rawinput1613542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613544 {"NextToken" (rawinput1613542 "NextToken"), "SubnetGroups" (rawinput1613542 "SubnetGroups")}] (clojure.core/cond-> {} (letvar1613544 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613544 ["NextToken"]))) (letvar1613544 "SubnetGroups") (clojure.core/assoc :subnet-groups (deser-subnet-group-list (clojure.core/get-in letvar1613544 ["SubnetGroups"])))))))

(clojure.core/defn- response-subnet-group-already-exists-fault ([input] (response-subnet-group-already-exists-fault nil input)) ([resultWrapper1613546 input] (clojure.core/let [rawinput1613545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613547 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-not-found-fault ([input] (response-subnet-group-not-found-fault nil input)) ([resultWrapper1613549 input] (clojure.core/let [rawinput1613548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613550 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-parameter-group-already-exists-fault ([input] (response-parameter-group-already-exists-fault nil input)) ([resultWrapper1613552 input] (clojure.core/let [rawinput1613551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613553 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-customer-exceeded-fault ([input] (response-node-quota-for-customer-exceeded-fault nil input)) ([resultWrapper1613555 input] (clojure.core/let [rawinput1613554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613556 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decrease-replication-factor-response ([input] (response-decrease-replication-factor-response nil input)) ([resultWrapper1613558 input] (clojure.core/let [rawinput1613557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613559 {"Cluster" (rawinput1613557 "Cluster")}] (clojure.core/cond-> {} (letvar1613559 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613559 ["Cluster"])))))))

(clojure.core/defn- response-create-subnet-group-response ([input] (response-create-subnet-group-response nil input)) ([resultWrapper1613561 input] (clojure.core/let [rawinput1613560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613562 {"SubnetGroup" (rawinput1613560 "SubnetGroup")}] (clojure.core/cond-> {} (letvar1613562 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar1613562 ["SubnetGroup"])))))))

(clojure.core/defn- response-update-cluster-response ([input] (response-update-cluster-response nil input)) ([resultWrapper1613564 input] (clojure.core/let [rawinput1613563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613565 {"Cluster" (rawinput1613563 "Cluster")}] (clojure.core/cond-> {} (letvar1613565 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1613565 ["Cluster"])))))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper1613567 input] (clojure.core/let [rawinput1613566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613568 {"message" (rawinput1613566 "message")}] (clojure.core/cond-> {} (letvar1613568 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar1613568 ["message"])))))))

(clojure.core/defn- response-describe-default-parameters-response ([input] (response-describe-default-parameters-response nil input)) ([resultWrapper1613570 input] (clojure.core/let [rawinput1613569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613571 {"NextToken" (rawinput1613569 "NextToken"), "Parameters" (rawinput1613569 "Parameters")}] (clojure.core/cond-> {} (letvar1613571 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613571 ["NextToken"]))) (letvar1613571 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar1613571 ["Parameters"])))))))

(clojure.core/defn- response-update-parameter-group-response ([input] (response-update-parameter-group-response nil input)) ([resultWrapper1613573 input] (clojure.core/let [rawinput1613572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613574 {"ParameterGroup" (rawinput1613572 "ParameterGroup")}] (clojure.core/cond-> {} (letvar1613574 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar1613574 ["ParameterGroup"])))))))

(clojure.core/defn- response-invalid-cluster-state-fault ([input] (response-invalid-cluster-state-fault nil input)) ([resultWrapper1613576 input] (clojure.core/let [rawinput1613575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613577 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-cluster-exceeded-fault ([input] (response-node-quota-for-cluster-exceeded-fault nil input)) ([resultWrapper1613579 input] (clojure.core/let [rawinput1613578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613580 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-not-found-fault ([input] (response-cluster-not-found-fault nil input)) ([resultWrapper1613582 input] (clojure.core/let [rawinput1613581 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613583 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-in-use-fault ([input] (response-subnet-group-in-use-fault nil input)) ([resultWrapper1613585 input] (clojure.core/let [rawinput1613584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613586 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-parameter-groups-response ([input] (response-describe-parameter-groups-response nil input)) ([resultWrapper1613588 input] (clojure.core/let [rawinput1613587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613589 {"NextToken" (rawinput1613587 "NextToken"), "ParameterGroups" (rawinput1613587 "ParameterGroups")}] (clojure.core/cond-> {} (letvar1613589 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613589 ["NextToken"]))) (letvar1613589 "ParameterGroups") (clojure.core/assoc :parameter-groups (deser-parameter-group-list (clojure.core/get-in letvar1613589 ["ParameterGroups"])))))))

(clojure.core/defn- response-subnet-group-quota-exceeded-fault ([input] (response-subnet-group-quota-exceeded-fault nil input)) ([resultWrapper1613591 input] (clojure.core/let [rawinput1613590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613592 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-not-found-fault ([input] (response-tag-not-found-fault nil input)) ([resultWrapper1613594 input] (clojure.core/let [rawinput1613593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613595 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subnet-group-response ([input] (response-update-subnet-group-response nil input)) ([resultWrapper1613597 input] (clojure.core/let [rawinput1613596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613598 {"SubnetGroup" (rawinput1613596 "SubnetGroup")}] (clojure.core/cond-> {} (letvar1613598 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar1613598 ["SubnetGroup"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1613600 input] (clojure.core/let [rawinput1613599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613601 {"message" (rawinput1613599 "message")}] (clojure.core/cond-> {} (letvar1613601 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar1613601 ["message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1613603 input] (clojure.core/let [rawinput1613602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613604 {"Tags" (rawinput1613602 "Tags")}] (clojure.core/cond-> {} (letvar1613604 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1613604 ["Tags"])))))))

(clojure.core/defn- response-delete-parameter-group-response ([input] (response-delete-parameter-group-response nil input)) ([resultWrapper1613606 input] (clojure.core/let [rawinput1613605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613607 {"DeletionMessage" (rawinput1613605 "DeletionMessage")}] (clojure.core/cond-> {} (letvar1613607 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar1613607 ["DeletionMessage"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1613609 input] (clojure.core/let [rawinput1613608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613610 {"NextToken" (rawinput1613608 "NextToken"), "Events" (rawinput1613608 "Events")}] (clojure.core/cond-> {} (letvar1613610 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1613610 ["NextToken"]))) (letvar1613610 "Events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1613610 ["Events"])))))))

(clojure.core/defn- response-invalid-parameter-group-state-fault ([input] (response-invalid-parameter-group-state-fault nil input)) ([resultWrapper1613612 input] (clojure.core/let [rawinput1613611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613613 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-parameter-group-response ([input] (response-create-parameter-group-response nil input)) ([resultWrapper1613615 input] (clojure.core/let [rawinput1613614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1613616 {"ParameterGroup" (rawinput1613614 "ParameterGroup")}] (clojure.core/cond-> {} (letvar1613616 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar1613616 ["ParameterGroup"])))))))
