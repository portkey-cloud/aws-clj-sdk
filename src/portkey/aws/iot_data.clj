...
(clojure.core/defn- response-method-not-allowed-exception ([input] (response-method-not-allowed-exception nil input)) ([resultWrapper237716 input] (clojure.core/let [rawinput237715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237717 {"message" (rawinput237715 "message")}] (clojure.core/cond-> {} (letvar237717 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar237717 ["message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper237719 input] (clojure.core/let [rawinput237718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237720 {"message" (rawinput237718 "message")}] (clojure.core/cond-> {} (letvar237720 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237720 ["message"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper237722 input] (clojure.core/let [rawinput237721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237723 {"message" (rawinput237721 "message")}] (clojure.core/cond-> {} (letvar237723 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237723 ["message"])))))))

(clojure.core/defn- response-get-thing-shadow-response ([input] (response-get-thing-shadow-response nil input)) ([resultWrapper237725 input] (clojure.core/let [rawinput237724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237726 {"payload" (rawinput237724 "payload")}] (clojure.core/cond-> {} (letvar237726 "payload") (clojure.core/assoc :payload (deser-json-document (clojure.core/get-in letvar237726 ["payload"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper237728 input] (clojure.core/let [rawinput237727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237729 {"message" (rawinput237727 "message")}] (clojure.core/cond-> {} (letvar237729 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237729 ["message"])))))))

(clojure.core/defn- response-request-entity-too-large-exception ([input] (response-request-entity-too-large-exception nil input)) ([resultWrapper237731 input] (clojure.core/let [rawinput237730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237732 {"message" (rawinput237730 "message")}] (clojure.core/cond-> {} (letvar237732 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar237732 ["message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper237734 input] (clojure.core/let [rawinput237733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237735 {"message" (rawinput237733 "message")}] (clojure.core/cond-> {} (letvar237735 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237735 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper237737 input] (clojure.core/let [rawinput237736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237738 {"message" (rawinput237736 "message")}] (clojure.core/cond-> {} (letvar237738 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237738 ["message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper237740 input] (clojure.core/let [rawinput237739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237741 {"message" (rawinput237739 "message")}] (clojure.core/cond-> {} (letvar237741 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar237741 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper237743 input] (clojure.core/let [rawinput237742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237744 {"message" (rawinput237742 "message")}] (clojure.core/cond-> {} (letvar237744 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237744 ["message"])))))))

(clojure.core/defn- response-update-thing-shadow-response ([input] (response-update-thing-shadow-response nil input)) ([resultWrapper237746 input] (clojure.core/let [rawinput237745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237747 {"payload" (rawinput237745 "payload")}] (clojure.core/cond-> {} (letvar237747 "payload") (clojure.core/assoc :payload (deser-json-document (clojure.core/get-in letvar237747 ["payload"])))))))

(clojure.core/defn- response-unsupported-document-encoding-exception ([input] (response-unsupported-document-encoding-exception nil input)) ([resultWrapper237749 input] (clojure.core/let [rawinput237748 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237750 {"message" (rawinput237748 "message")}] (clojure.core/cond-> {} (letvar237750 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar237750 ["message"])))))))

(clojure.core/defn- response-delete-thing-shadow-response ([input] (response-delete-thing-shadow-response nil input)) ([resultWrapper237752 input] (clojure.core/let [rawinput237751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar237753 {"payload" (rawinput237751 "payload")}] (clojure.core/cond-> {:payload (deser-json-document (clojure.core/get-in letvar237753 ["payload"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.iot-data/thing-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+" s__21112__auto__))))
