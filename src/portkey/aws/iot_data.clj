...
(clojure.core/defn get-thing-shadow [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.iot-data/endpoints "GET" "/things/{thingName}/shadow" input__8278__auto__ :portkey.aws.iot-data/get-thing-shadow-request {:payload nil, :headers {}, :uri {"thingName" "thingName"}, :querystring {}} nil :portkey.aws.iot-data/get-thing-shadow-response {"InvalidRequestException" :portkey.aws.iot-data/invalid-request-exception, "ResourceNotFoundException" :portkey.aws.iot-data/resource-not-found-exception, "ThrottlingException" :portkey.aws.iot-data/throttling-exception, "UnauthorizedException" :portkey.aws.iot-data/unauthorized-exception, "ServiceUnavailableException" :portkey.aws.iot-data/service-unavailable-exception, "InternalFailureException" :portkey.aws.iot-data/internal-failure-exception, "MethodNotAllowedException" :portkey.aws.iot-data/method-not-allowed-exception, "UnsupportedDocumentEncodingException" :portkey.aws.iot-data/unsupported-document-encoding-exception}))
...
(clojure.core/defn publish [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.iot-data/endpoints "POST" "/topics/{topic}" input__8278__auto__ :portkey.aws.iot-data/publish-request {:payload "payload", :headers {}, :uri {"topic" "topic"}, :querystring {"qos" "qos"}} nil nil {"InternalFailureException" :portkey.aws.iot-data/internal-failure-exception, "InvalidRequestException" :portkey.aws.iot-data/invalid-request-exception, "UnauthorizedException" :portkey.aws.iot-data/unauthorized-exception, "MethodNotAllowedException" :portkey.aws.iot-data/method-not-allowed-exception}))
(clojure.spec.alpha/fdef publish :args (clojure.spec.alpha/tuple :portkey.aws.iot-data/publish-request))

(clojure.core/defn update-thing-shadow [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.iot-data/endpoints "POST" "/things/{thingName}/shadow" input__8278__auto__ :portkey.aws.iot-data/update-thing-shadow-request {:payload "payload", :headers {}, :uri {"thingName" "thingName"}, :querystring {}} nil :portkey.aws.iot-data/update-thing-shadow-response {"MethodNotAllowedException" :portkey.aws.iot-data/method-not-allowed-exception, "UnauthorizedException" :portkey.aws.iot-data/unauthorized-exception, "InvalidRequestException" :portkey.aws.iot-data/invalid-request-exception, "ServiceUnavailableException" :portkey.aws.iot-data/service-unavailable-exception, "RequestEntityTooLargeException" :portkey.aws.iot-data/request-entity-too-large-exception, "InternalFailureException" :portkey.aws.iot-data/internal-failure-exception, "ConflictException" :portkey.aws.iot-data/conflict-exception, "ThrottlingException" :portkey.aws.iot-data/throttling-exception, "UnsupportedDocumentEncodingException" :portkey.aws.iot-data/unsupported-document-encoding-exception}))
