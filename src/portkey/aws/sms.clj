...
(clojure.core/defn- response-delete-server-catalog-response ([input] (response-delete-server-catalog-response nil input)) ([resultWrapper1738941 input] (clojure.core/let [rawinput1738940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738942 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-app-response ([input] (response-create-app-response nil input)) ([resultWrapper1738944 input] (clojure.core/let [rawinput1738943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738945 {"appSummary" (rawinput1738943 "appSummary"), "serverGroups" (rawinput1738943 "serverGroups"), "tags" (rawinput1738943 "tags")}] (clojure.core/cond-> {} (letvar1738945 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar1738945 ["appSummary"]))) (letvar1738945 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar1738945 ["serverGroups"]))) (letvar1738945 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1738945 ["tags"])))))))

(clojure.core/defn- response-put-app-replication-configuration-response ([input] (response-put-app-replication-configuration-response nil input)) ([resultWrapper1738947 input] (clojure.core/let [rawinput1738946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738948 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1738950 input] (clojure.core/let [rawinput1738949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738951 {"message" (rawinput1738949 "message")}] (clojure.core/cond-> {} (letvar1738951 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1738951 ["message"])))))))

(clojure.core/defn- response-missing-required-parameter-exception ([input] (response-missing-required-parameter-exception nil input)) ([resultWrapper1738953 input] (clojure.core/let [rawinput1738952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738954 {"message" (rawinput1738952 "message")}] (clojure.core/cond-> {} (letvar1738954 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1738954 ["message"])))))))

(clojure.core/defn- response-disassociate-connector-response ([input] (response-disassociate-connector-response nil input)) ([resultWrapper1738956 input] (clojure.core/let [rawinput1738955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738957 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-replication-configuration-response ([input] (response-delete-app-replication-configuration-response nil input)) ([resultWrapper1738959 input] (clojure.core/let [rawinput1738958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738960 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-app-response ([input] (response-get-app-response nil input)) ([resultWrapper1738962 input] (clojure.core/let [rawinput1738961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738963 {"appSummary" (rawinput1738961 "appSummary"), "serverGroups" (rawinput1738961 "serverGroups"), "tags" (rawinput1738961 "tags")}] (clojure.core/cond-> {} (letvar1738963 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar1738963 ["appSummary"]))) (letvar1738963 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar1738963 ["serverGroups"]))) (letvar1738963 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1738963 ["tags"])))))))

(clojure.core/defn- response-launch-app-response ([input] (response-launch-app-response nil input)) ([resultWrapper1738965 input] (clojure.core/let [rawinput1738964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738966 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-servers-response ([input] (response-get-servers-response nil input)) ([resultWrapper1738968 input] (clojure.core/let [rawinput1738967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738969 {"lastModifiedOn" (rawinput1738967 "lastModifiedOn"), "serverCatalogStatus" (rawinput1738967 "serverCatalogStatus"), "serverList" (rawinput1738967 "serverList"), "nextToken" (rawinput1738967 "nextToken")}] (clojure.core/cond-> {} (letvar1738969 "lastModifiedOn") (clojure.core/assoc :last-modified-on (deser-timestamp (clojure.core/get-in letvar1738969 ["lastModifiedOn"]))) (letvar1738969 "serverCatalogStatus") (clojure.core/assoc :server-catalog-status (deser-server-catalog-status (clojure.core/get-in letvar1738969 ["serverCatalogStatus"]))) (letvar1738969 "serverList") (clojure.core/assoc :server-list (deser-server-list (clojure.core/get-in letvar1738969 ["serverList"]))) (letvar1738969 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1738969 ["nextToken"])))))))

(clojure.core/defn- response-internal-error ([input] (response-internal-error nil input)) ([resultWrapper1738971 input] (clojure.core/let [rawinput1738970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738972 {"message" (rawinput1738970 "message")}] (clojure.core/cond-> {} (letvar1738972 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1738972 ["message"])))))))

(clojure.core/defn- response-generate-change-set-response ([input] (response-generate-change-set-response nil input)) ([resultWrapper1738974 input] (clojure.core/let [rawinput1738973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738975 {"s3Location" (rawinput1738973 "s3Location")}] (clojure.core/cond-> {} (letvar1738975 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar1738975 ["s3Location"])))))))

(clojure.core/defn- response-list-apps-response ([input] (response-list-apps-response nil input)) ([resultWrapper1738977 input] (clojure.core/let [rawinput1738976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738978 {"apps" (rawinput1738976 "apps"), "nextToken" (rawinput1738976 "nextToken")}] (clojure.core/cond-> {} (letvar1738978 "apps") (clojure.core/assoc :apps (deser-apps (clojure.core/get-in letvar1738978 ["apps"]))) (letvar1738978 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1738978 ["nextToken"])))))))

(clojure.core/defn- response-start-on-demand-replication-run-response ([input] (response-start-on-demand-replication-run-response nil input)) ([resultWrapper1738980 input] (clojure.core/let [rawinput1738979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738981 {"replicationRunId" (rawinput1738979 "replicationRunId")}] (clojure.core/cond-> {} (letvar1738981 "replicationRunId") (clojure.core/assoc :replication-run-id (deser-replication-run-id (clojure.core/get-in letvar1738981 ["replicationRunId"])))))))

(clojure.core/defn- response-start-app-replication-response ([input] (response-start-app-replication-response nil input)) ([resultWrapper1738983 input] (clojure.core/let [rawinput1738982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738984 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-generate-template-response ([input] (response-generate-template-response nil input)) ([resultWrapper1738986 input] (clojure.core/let [rawinput1738985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738987 {"s3Location" (rawinput1738985 "s3Location")}] (clojure.core/cond-> {} (letvar1738987 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar1738987 ["s3Location"])))))))

(clojure.core/defn- response-update-app-response ([input] (response-update-app-response nil input)) ([resultWrapper1738989 input] (clojure.core/let [rawinput1738988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738990 {"appSummary" (rawinput1738988 "appSummary"), "serverGroups" (rawinput1738988 "serverGroups"), "tags" (rawinput1738988 "tags")}] (clojure.core/cond-> {} (letvar1738990 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar1738990 ["appSummary"]))) (letvar1738990 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar1738990 ["serverGroups"]))) (letvar1738990 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1738990 ["tags"])))))))

(clojure.core/defn- response-update-replication-job-response ([input] (response-update-replication-job-response nil input)) ([resultWrapper1738992 input] (clojure.core/let [rawinput1738991 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738993 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-server-catalog-response ([input] (response-import-server-catalog-response nil input)) ([resultWrapper1738995 input] (clojure.core/let [rawinput1738994 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738996 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-server-cannot-be-replicated-exception ([input] (response-server-cannot-be-replicated-exception nil input)) ([resultWrapper1738998 input] (clojure.core/let [rawinput1738997 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1738999 {"message" (rawinput1738997 "message")}] (clojure.core/cond-> {} (letvar1738999 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1738999 ["message"])))))))

(clojure.core/defn- response-temporarily-unavailable-exception ([input] (response-temporarily-unavailable-exception nil input)) ([resultWrapper1739001 input] (clojure.core/let [rawinput1739000 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739002 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-response ([input] (response-delete-app-response nil input)) ([resultWrapper1739004 input] (clojure.core/let [rawinput1739003 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739005 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-replication-job-response ([input] (response-delete-replication-job-response nil input)) ([resultWrapper1739007 input] (clojure.core/let [rawinput1739006 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739008 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-replication-job-response ([input] (response-create-replication-job-response nil input)) ([resultWrapper1739010 input] (clojure.core/let [rawinput1739009 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739011 {"replicationJobId" (rawinput1739009 "replicationJobId")}] (clojure.core/cond-> {} (letvar1739011 "replicationJobId") (clojure.core/assoc :replication-job-id (deser-replication-job-id (clojure.core/get-in letvar1739011 ["replicationJobId"])))))))

(clojure.core/defn- response-no-connectors-available-exception ([input] (response-no-connectors-available-exception nil input)) ([resultWrapper1739013 input] (clojure.core/let [rawinput1739012 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739014 {"message" (rawinput1739012 "message")}] (clojure.core/cond-> {} (letvar1739014 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739014 ["message"])))))))

(clojure.core/defn- response-get-app-replication-configuration-response ([input] (response-get-app-replication-configuration-response nil input)) ([resultWrapper1739016 input] (clojure.core/let [rawinput1739015 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739017 {"serverGroupReplicationConfigurations" (rawinput1739015 "serverGroupReplicationConfigurations")}] (clojure.core/cond-> {} (letvar1739017 "serverGroupReplicationConfigurations") (clojure.core/assoc :server-group-replication-configurations (deser-server-group-replication-configurations (clojure.core/get-in letvar1739017 ["serverGroupReplicationConfigurations"])))))))

(clojure.core/defn- response-unauthorized-operation-exception ([input] (response-unauthorized-operation-exception nil input)) ([resultWrapper1739019 input] (clojure.core/let [rawinput1739018 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739020 {"message" (rawinput1739018 "message")}] (clojure.core/cond-> {} (letvar1739020 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739020 ["message"])))))))

(clojure.core/defn- response-replication-job-already-exists-exception ([input] (response-replication-job-already-exists-exception nil input)) ([resultWrapper1739022 input] (clojure.core/let [rawinput1739021 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739023 {"message" (rawinput1739021 "message")}] (clojure.core/cond-> {} (letvar1739023 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739023 ["message"])))))))

(clojure.core/defn- response-put-app-launch-configuration-response ([input] (response-put-app-launch-configuration-response nil input)) ([resultWrapper1739025 input] (clojure.core/let [rawinput1739024 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739026 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-launch-configuration-response ([input] (response-delete-app-launch-configuration-response nil input)) ([resultWrapper1739028 input] (clojure.core/let [rawinput1739027 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739029 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-replication-jobs-response ([input] (response-get-replication-jobs-response nil input)) ([resultWrapper1739031 input] (clojure.core/let [rawinput1739030 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739032 {"replicationJobList" (rawinput1739030 "replicationJobList"), "nextToken" (rawinput1739030 "nextToken")}] (clojure.core/cond-> {} (letvar1739032 "replicationJobList") (clojure.core/assoc :replication-job-list (deser-replication-job-list (clojure.core/get-in letvar1739032 ["replicationJobList"]))) (letvar1739032 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1739032 ["nextToken"])))))))

(clojure.core/defn- response-get-replication-runs-response ([input] (response-get-replication-runs-response nil input)) ([resultWrapper1739034 input] (clojure.core/let [rawinput1739033 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739035 {"replicationJob" (rawinput1739033 "replicationJob"), "replicationRunList" (rawinput1739033 "replicationRunList"), "nextToken" (rawinput1739033 "nextToken")}] (clojure.core/cond-> {} (letvar1739035 "replicationJob") (clojure.core/assoc :replication-job (deser-replication-job (clojure.core/get-in letvar1739035 ["replicationJob"]))) (letvar1739035 "replicationRunList") (clojure.core/assoc :replication-run-list (deser-replication-run-list (clojure.core/get-in letvar1739035 ["replicationRunList"]))) (letvar1739035 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1739035 ["nextToken"])))))))

(clojure.core/defn- response-terminate-app-response ([input] (response-terminate-app-response nil input)) ([resultWrapper1739037 input] (clojure.core/let [rawinput1739036 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739038 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-connectors-response ([input] (response-get-connectors-response nil input)) ([resultWrapper1739040 input] (clojure.core/let [rawinput1739039 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739041 {"connectorList" (rawinput1739039 "connectorList"), "nextToken" (rawinput1739039 "nextToken")}] (clojure.core/cond-> {} (letvar1739041 "connectorList") (clojure.core/assoc :connector-list (deser-connector-list (clojure.core/get-in letvar1739041 ["connectorList"]))) (letvar1739041 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1739041 ["nextToken"])))))))

(clojure.core/defn- response-replication-run-limit-exceeded-exception ([input] (response-replication-run-limit-exceeded-exception nil input)) ([resultWrapper1739043 input] (clojure.core/let [rawinput1739042 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739044 {"message" (rawinput1739042 "message")}] (clojure.core/cond-> {} (letvar1739044 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739044 ["message"])))))))

(clojure.core/defn- response-stop-app-replication-response ([input] (response-stop-app-replication-response nil input)) ([resultWrapper1739046 input] (clojure.core/let [rawinput1739045 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739047 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1739049 input] (clojure.core/let [rawinput1739048 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739050 {"message" (rawinput1739048 "message")}] (clojure.core/cond-> {} (letvar1739050 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739050 ["message"])))))))

(clojure.core/defn- response-replication-job-not-found-exception ([input] (response-replication-job-not-found-exception nil input)) ([resultWrapper1739052 input] (clojure.core/let [rawinput1739051 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739053 {"message" (rawinput1739051 "message")}] (clojure.core/cond-> {} (letvar1739053 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1739053 ["message"])))))))

(clojure.core/defn- response-get-app-launch-configuration-response ([input] (response-get-app-launch-configuration-response nil input)) ([resultWrapper1739055 input] (clojure.core/let [rawinput1739054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1739056 {"appId" (rawinput1739054 "appId"), "roleName" (rawinput1739054 "roleName"), "serverGroupLaunchConfigurations" (rawinput1739054 "serverGroupLaunchConfigurations")}] (clojure.core/cond-> {} (letvar1739056 "appId") (clojure.core/assoc :app-id (deser-app-id (clojure.core/get-in letvar1739056 ["appId"]))) (letvar1739056 "roleName") (clojure.core/assoc :role-name (deser-role-name (clojure.core/get-in letvar1739056 ["roleName"]))) (letvar1739056 "serverGroupLaunchConfigurations") (clojure.core/assoc :server-group-launch-configurations (deser-server-group-launch-configurations (clojure.core/get-in letvar1739056 ["serverGroupLaunchConfigurations"])))))))
