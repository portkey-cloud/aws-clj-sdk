...
(clojure.core/defn get-connectors ([] (get-connectors {})) ([get-connectors-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-connectors-request get-connectors-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.sms/endpoints, :http.request.spec/output-spec :portkey.aws.sms/get-connectors-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-24", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.sms/get-connectors-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetConnectors", :http.request.spec/error-spec {"UnauthorizedOperationException" :portkey.aws.sms/unauthorized-operation-exception}})))))
...
(clojure.core/defn get-servers ([] (get-servers {})) ([get-servers-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-servers-request get-servers-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.sms/endpoints, :http.request.spec/output-spec :portkey.aws.sms/get-servers-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-24", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.sms/get-servers-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetServers", :http.request.spec/error-spec {"UnauthorizedOperationException" :portkey.aws.sms/unauthorized-operation-exception}})))))
