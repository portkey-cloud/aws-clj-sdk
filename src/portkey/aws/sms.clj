...
(clojure.core/defn- response-delete-server-catalog-response ([input] (response-delete-server-catalog-response nil input)) ([resultWrapper2035139 input] (clojure.core/let [rawinput2035138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035140 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-app-response ([input] (response-create-app-response nil input)) ([resultWrapper2035142 input] (clojure.core/let [rawinput2035141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035143 {"appSummary" (rawinput2035141 "appSummary"), "serverGroups" (rawinput2035141 "serverGroups"), "tags" (rawinput2035141 "tags")}] (clojure.core/cond-> {} (letvar2035143 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2035143 ["appSummary"]))) (letvar2035143 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2035143 ["serverGroups"]))) (letvar2035143 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2035143 ["tags"])))))))

(clojure.core/defn- response-put-app-replication-configuration-response ([input] (response-put-app-replication-configuration-response nil input)) ([resultWrapper2035145 input] (clojure.core/let [rawinput2035144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035146 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper2035148 input] (clojure.core/let [rawinput2035147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035149 {"message" (rawinput2035147 "message")}] (clojure.core/cond-> {} (letvar2035149 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035149 ["message"])))))))

(clojure.core/defn- response-missing-required-parameter-exception ([input] (response-missing-required-parameter-exception nil input)) ([resultWrapper2035151 input] (clojure.core/let [rawinput2035150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035152 {"message" (rawinput2035150 "message")}] (clojure.core/cond-> {} (letvar2035152 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035152 ["message"])))))))

(clojure.core/defn- response-disassociate-connector-response ([input] (response-disassociate-connector-response nil input)) ([resultWrapper2035154 input] (clojure.core/let [rawinput2035153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035155 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-replication-configuration-response ([input] (response-delete-app-replication-configuration-response nil input)) ([resultWrapper2035157 input] (clojure.core/let [rawinput2035156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035158 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-app-response ([input] (response-get-app-response nil input)) ([resultWrapper2035160 input] (clojure.core/let [rawinput2035159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035161 {"appSummary" (rawinput2035159 "appSummary"), "serverGroups" (rawinput2035159 "serverGroups"), "tags" (rawinput2035159 "tags")}] (clojure.core/cond-> {} (letvar2035161 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2035161 ["appSummary"]))) (letvar2035161 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2035161 ["serverGroups"]))) (letvar2035161 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2035161 ["tags"])))))))

(clojure.core/defn- response-launch-app-response ([input] (response-launch-app-response nil input)) ([resultWrapper2035163 input] (clojure.core/let [rawinput2035162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035164 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-servers-response ([input] (response-get-servers-response nil input)) ([resultWrapper2035166 input] (clojure.core/let [rawinput2035165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035167 {"lastModifiedOn" (rawinput2035165 "lastModifiedOn"), "serverCatalogStatus" (rawinput2035165 "serverCatalogStatus"), "serverList" (rawinput2035165 "serverList"), "nextToken" (rawinput2035165 "nextToken")}] (clojure.core/cond-> {} (letvar2035167 "lastModifiedOn") (clojure.core/assoc :last-modified-on (deser-timestamp (clojure.core/get-in letvar2035167 ["lastModifiedOn"]))) (letvar2035167 "serverCatalogStatus") (clojure.core/assoc :server-catalog-status (deser-server-catalog-status (clojure.core/get-in letvar2035167 ["serverCatalogStatus"]))) (letvar2035167 "serverList") (clojure.core/assoc :server-list (deser-server-list (clojure.core/get-in letvar2035167 ["serverList"]))) (letvar2035167 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2035167 ["nextToken"])))))))

(clojure.core/defn- response-internal-error ([input] (response-internal-error nil input)) ([resultWrapper2035169 input] (clojure.core/let [rawinput2035168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035170 {"message" (rawinput2035168 "message")}] (clojure.core/cond-> {} (letvar2035170 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035170 ["message"])))))))

(clojure.core/defn- response-generate-change-set-response ([input] (response-generate-change-set-response nil input)) ([resultWrapper2035172 input] (clojure.core/let [rawinput2035171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035173 {"s3Location" (rawinput2035171 "s3Location")}] (clojure.core/cond-> {} (letvar2035173 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2035173 ["s3Location"])))))))

(clojure.core/defn- response-list-apps-response ([input] (response-list-apps-response nil input)) ([resultWrapper2035175 input] (clojure.core/let [rawinput2035174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035176 {"apps" (rawinput2035174 "apps"), "nextToken" (rawinput2035174 "nextToken")}] (clojure.core/cond-> {} (letvar2035176 "apps") (clojure.core/assoc :apps (deser-apps (clojure.core/get-in letvar2035176 ["apps"]))) (letvar2035176 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2035176 ["nextToken"])))))))

(clojure.core/defn- response-start-on-demand-replication-run-response ([input] (response-start-on-demand-replication-run-response nil input)) ([resultWrapper2035178 input] (clojure.core/let [rawinput2035177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035179 {"replicationRunId" (rawinput2035177 "replicationRunId")}] (clojure.core/cond-> {} (letvar2035179 "replicationRunId") (clojure.core/assoc :replication-run-id (deser-replication-run-id (clojure.core/get-in letvar2035179 ["replicationRunId"])))))))

(clojure.core/defn- response-start-app-replication-response ([input] (response-start-app-replication-response nil input)) ([resultWrapper2035181 input] (clojure.core/let [rawinput2035180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035182 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-generate-template-response ([input] (response-generate-template-response nil input)) ([resultWrapper2035184 input] (clojure.core/let [rawinput2035183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035185 {"s3Location" (rawinput2035183 "s3Location")}] (clojure.core/cond-> {} (letvar2035185 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2035185 ["s3Location"])))))))

(clojure.core/defn- response-update-app-response ([input] (response-update-app-response nil input)) ([resultWrapper2035187 input] (clojure.core/let [rawinput2035186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035188 {"appSummary" (rawinput2035186 "appSummary"), "serverGroups" (rawinput2035186 "serverGroups"), "tags" (rawinput2035186 "tags")}] (clojure.core/cond-> {} (letvar2035188 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2035188 ["appSummary"]))) (letvar2035188 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2035188 ["serverGroups"]))) (letvar2035188 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2035188 ["tags"])))))))

(clojure.core/defn- response-update-replication-job-response ([input] (response-update-replication-job-response nil input)) ([resultWrapper2035190 input] (clojure.core/let [rawinput2035189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035191 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-server-catalog-response ([input] (response-import-server-catalog-response nil input)) ([resultWrapper2035193 input] (clojure.core/let [rawinput2035192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035194 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-server-cannot-be-replicated-exception ([input] (response-server-cannot-be-replicated-exception nil input)) ([resultWrapper2035196 input] (clojure.core/let [rawinput2035195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035197 {"message" (rawinput2035195 "message")}] (clojure.core/cond-> {} (letvar2035197 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035197 ["message"])))))))

(clojure.core/defn- response-temporarily-unavailable-exception ([input] (response-temporarily-unavailable-exception nil input)) ([resultWrapper2035199 input] (clojure.core/let [rawinput2035198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035200 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-response ([input] (response-delete-app-response nil input)) ([resultWrapper2035202 input] (clojure.core/let [rawinput2035201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035203 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-replication-job-response ([input] (response-delete-replication-job-response nil input)) ([resultWrapper2035205 input] (clojure.core/let [rawinput2035204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035206 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-replication-job-response ([input] (response-create-replication-job-response nil input)) ([resultWrapper2035208 input] (clojure.core/let [rawinput2035207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035209 {"replicationJobId" (rawinput2035207 "replicationJobId")}] (clojure.core/cond-> {} (letvar2035209 "replicationJobId") (clojure.core/assoc :replication-job-id (deser-replication-job-id (clojure.core/get-in letvar2035209 ["replicationJobId"])))))))

(clojure.core/defn- response-no-connectors-available-exception ([input] (response-no-connectors-available-exception nil input)) ([resultWrapper2035211 input] (clojure.core/let [rawinput2035210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035212 {"message" (rawinput2035210 "message")}] (clojure.core/cond-> {} (letvar2035212 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035212 ["message"])))))))

(clojure.core/defn- response-get-app-replication-configuration-response ([input] (response-get-app-replication-configuration-response nil input)) ([resultWrapper2035214 input] (clojure.core/let [rawinput2035213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035215 {"serverGroupReplicationConfigurations" (rawinput2035213 "serverGroupReplicationConfigurations")}] (clojure.core/cond-> {} (letvar2035215 "serverGroupReplicationConfigurations") (clojure.core/assoc :server-group-replication-configurations (deser-server-group-replication-configurations (clojure.core/get-in letvar2035215 ["serverGroupReplicationConfigurations"])))))))

(clojure.core/defn- response-unauthorized-operation-exception ([input] (response-unauthorized-operation-exception nil input)) ([resultWrapper2035217 input] (clojure.core/let [rawinput2035216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035218 {"message" (rawinput2035216 "message")}] (clojure.core/cond-> {} (letvar2035218 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035218 ["message"])))))))

(clojure.core/defn- response-replication-job-already-exists-exception ([input] (response-replication-job-already-exists-exception nil input)) ([resultWrapper2035220 input] (clojure.core/let [rawinput2035219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035221 {"message" (rawinput2035219 "message")}] (clojure.core/cond-> {} (letvar2035221 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035221 ["message"])))))))

(clojure.core/defn- response-put-app-launch-configuration-response ([input] (response-put-app-launch-configuration-response nil input)) ([resultWrapper2035223 input] (clojure.core/let [rawinput2035222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035224 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-launch-configuration-response ([input] (response-delete-app-launch-configuration-response nil input)) ([resultWrapper2035226 input] (clojure.core/let [rawinput2035225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035227 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-replication-jobs-response ([input] (response-get-replication-jobs-response nil input)) ([resultWrapper2035229 input] (clojure.core/let [rawinput2035228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035230 {"replicationJobList" (rawinput2035228 "replicationJobList"), "nextToken" (rawinput2035228 "nextToken")}] (clojure.core/cond-> {} (letvar2035230 "replicationJobList") (clojure.core/assoc :replication-job-list (deser-replication-job-list (clojure.core/get-in letvar2035230 ["replicationJobList"]))) (letvar2035230 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2035230 ["nextToken"])))))))

(clojure.core/defn- response-get-replication-runs-response ([input] (response-get-replication-runs-response nil input)) ([resultWrapper2035232 input] (clojure.core/let [rawinput2035231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035233 {"replicationJob" (rawinput2035231 "replicationJob"), "replicationRunList" (rawinput2035231 "replicationRunList"), "nextToken" (rawinput2035231 "nextToken")}] (clojure.core/cond-> {} (letvar2035233 "replicationJob") (clojure.core/assoc :replication-job (deser-replication-job (clojure.core/get-in letvar2035233 ["replicationJob"]))) (letvar2035233 "replicationRunList") (clojure.core/assoc :replication-run-list (deser-replication-run-list (clojure.core/get-in letvar2035233 ["replicationRunList"]))) (letvar2035233 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2035233 ["nextToken"])))))))

(clojure.core/defn- response-terminate-app-response ([input] (response-terminate-app-response nil input)) ([resultWrapper2035235 input] (clojure.core/let [rawinput2035234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035236 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-connectors-response ([input] (response-get-connectors-response nil input)) ([resultWrapper2035238 input] (clojure.core/let [rawinput2035237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035239 {"connectorList" (rawinput2035237 "connectorList"), "nextToken" (rawinput2035237 "nextToken")}] (clojure.core/cond-> {} (letvar2035239 "connectorList") (clojure.core/assoc :connector-list (deser-connector-list (clojure.core/get-in letvar2035239 ["connectorList"]))) (letvar2035239 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2035239 ["nextToken"])))))))

(clojure.core/defn- response-replication-run-limit-exceeded-exception ([input] (response-replication-run-limit-exceeded-exception nil input)) ([resultWrapper2035241 input] (clojure.core/let [rawinput2035240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035242 {"message" (rawinput2035240 "message")}] (clojure.core/cond-> {} (letvar2035242 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035242 ["message"])))))))

(clojure.core/defn- response-stop-app-replication-response ([input] (response-stop-app-replication-response nil input)) ([resultWrapper2035244 input] (clojure.core/let [rawinput2035243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035245 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2035247 input] (clojure.core/let [rawinput2035246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035248 {"message" (rawinput2035246 "message")}] (clojure.core/cond-> {} (letvar2035248 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035248 ["message"])))))))

(clojure.core/defn- response-replication-job-not-found-exception ([input] (response-replication-job-not-found-exception nil input)) ([resultWrapper2035250 input] (clojure.core/let [rawinput2035249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035251 {"message" (rawinput2035249 "message")}] (clojure.core/cond-> {} (letvar2035251 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2035251 ["message"])))))))

(clojure.core/defn- response-get-app-launch-configuration-response ([input] (response-get-app-launch-configuration-response nil input)) ([resultWrapper2035253 input] (clojure.core/let [rawinput2035252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2035254 {"appId" (rawinput2035252 "appId"), "roleName" (rawinput2035252 "roleName"), "serverGroupLaunchConfigurations" (rawinput2035252 "serverGroupLaunchConfigurations")}] (clojure.core/cond-> {} (letvar2035254 "appId") (clojure.core/assoc :app-id (deser-app-id (clojure.core/get-in letvar2035254 ["appId"]))) (letvar2035254 "roleName") (clojure.core/assoc :role-name (deser-role-name (clojure.core/get-in letvar2035254 ["roleName"]))) (letvar2035254 "serverGroupLaunchConfigurations") (clojure.core/assoc :server-group-launch-configurations (deser-server-group-launch-configurations (clojure.core/get-in letvar2035254 ["serverGroupLaunchConfigurations"])))))))
