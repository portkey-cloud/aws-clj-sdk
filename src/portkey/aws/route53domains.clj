...
(clojure.core/defn- response-domain-limit-exceeded ([input] (response-domain-limit-exceeded nil input)) ([resultWrapper1962624 input] (clojure.core/let [rawinput1962623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962625 {"message" (rawinput1962623 "message")}] (clojure.core/cond-> {} (letvar1962625 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962625 ["message"])))))))

(clojure.core/defn- response-get-domain-suggestions-response ([input] (response-get-domain-suggestions-response nil input)) ([resultWrapper1962627 input] (clojure.core/let [rawinput1962626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962628 {"SuggestionsList" (rawinput1962626 "SuggestionsList")}] (clojure.core/cond-> {} (letvar1962628 "SuggestionsList") (clojure.core/assoc :suggestions-list (deser-domain-suggestions-list (clojure.core/get-in letvar1962628 ["SuggestionsList"])))))))

(clojure.core/defn- response-update-domain-contact-response ([input] (response-update-domain-contact-response nil input)) ([resultWrapper1962630 input] (clojure.core/let [rawinput1962629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962631 {"OperationId" (rawinput1962629 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962631 ["OperationId"]))}))))

(clojure.core/defn- response-get-domain-detail-response ([input] (response-get-domain-detail-response nil input)) ([resultWrapper1962633 input] (clojure.core/let [rawinput1962632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962634 {"WhoIsServer" (rawinput1962632 "WhoIsServer"), "DnsSec" (rawinput1962632 "DnsSec"), "AdminContact" (rawinput1962632 "AdminContact"), "AdminPrivacy" (rawinput1962632 "AdminPrivacy"), "TechContact" (rawinput1962632 "TechContact"), "RegistryDomainId" (rawinput1962632 "RegistryDomainId"), "RegistrantPrivacy" (rawinput1962632 "RegistrantPrivacy"), "RegistrantContact" (rawinput1962632 "RegistrantContact"), "ExpirationDate" (rawinput1962632 "ExpirationDate"), "Nameservers" (rawinput1962632 "Nameservers"), "AbuseContactEmail" (rawinput1962632 "AbuseContactEmail"), "AutoRenew" (rawinput1962632 "AutoRenew"), "UpdatedDate" (rawinput1962632 "UpdatedDate"), "RegistrarUrl" (rawinput1962632 "RegistrarUrl"), "RegistrarName" (rawinput1962632 "RegistrarName"), "TechPrivacy" (rawinput1962632 "TechPrivacy"), "CreationDate" (rawinput1962632 "CreationDate"), "DomainName" (rawinput1962632 "DomainName"), "Reseller" (rawinput1962632 "Reseller"), "StatusList" (rawinput1962632 "StatusList"), "AbuseContactPhone" (rawinput1962632 "AbuseContactPhone")}] (clojure.core/cond-> {:domain-name (deser-domain-name (clojure.core/get-in letvar1962634 ["DomainName"])), :nameservers (deser-nameserver-list (clojure.core/get-in letvar1962634 ["Nameservers"])), :admin-contact (deser-contact-detail (clojure.core/get-in letvar1962634 ["AdminContact"])), :registrant-contact (deser-contact-detail (clojure.core/get-in letvar1962634 ["RegistrantContact"])), :tech-contact (deser-contact-detail (clojure.core/get-in letvar1962634 ["TechContact"]))} (letvar1962634 "WhoIsServer") (clojure.core/assoc :who-is-server (deser-registrar-who-is-server (clojure.core/get-in letvar1962634 ["WhoIsServer"]))) (letvar1962634 "DnsSec") (clojure.core/assoc :dns-sec (deser-dns-sec (clojure.core/get-in letvar1962634 ["DnsSec"]))) (letvar1962634 "AdminPrivacy") (clojure.core/assoc :admin-privacy (deser-boolean (clojure.core/get-in letvar1962634 ["AdminPrivacy"]))) (letvar1962634 "RegistryDomainId") (clojure.core/assoc :registry-domain-id (deser-registry-domain-id (clojure.core/get-in letvar1962634 ["RegistryDomainId"]))) (letvar1962634 "RegistrantPrivacy") (clojure.core/assoc :registrant-privacy (deser-boolean (clojure.core/get-in letvar1962634 ["RegistrantPrivacy"]))) (letvar1962634 "ExpirationDate") (clojure.core/assoc :expiration-date (deser-timestamp (clojure.core/get-in letvar1962634 ["ExpirationDate"]))) (letvar1962634 "AbuseContactEmail") (clojure.core/assoc :abuse-contact-email (deser-email (clojure.core/get-in letvar1962634 ["AbuseContactEmail"]))) (letvar1962634 "AutoRenew") (clojure.core/assoc :auto-renew (deser-boolean (clojure.core/get-in letvar1962634 ["AutoRenew"]))) (letvar1962634 "UpdatedDate") (clojure.core/assoc :updated-date (deser-timestamp (clojure.core/get-in letvar1962634 ["UpdatedDate"]))) (letvar1962634 "RegistrarUrl") (clojure.core/assoc :registrar-url (deser-registrar-url (clojure.core/get-in letvar1962634 ["RegistrarUrl"]))) (letvar1962634 "RegistrarName") (clojure.core/assoc :registrar-name (deser-registrar-name (clojure.core/get-in letvar1962634 ["RegistrarName"]))) (letvar1962634 "TechPrivacy") (clojure.core/assoc :tech-privacy (deser-boolean (clojure.core/get-in letvar1962634 ["TechPrivacy"]))) (letvar1962634 "CreationDate") (clojure.core/assoc :creation-date (deser-timestamp (clojure.core/get-in letvar1962634 ["CreationDate"]))) (letvar1962634 "Reseller") (clojure.core/assoc :reseller (deser-reseller (clojure.core/get-in letvar1962634 ["Reseller"]))) (letvar1962634 "StatusList") (clojure.core/assoc :status-list (deser-domain-status-list (clojure.core/get-in letvar1962634 ["StatusList"]))) (letvar1962634 "AbuseContactPhone") (clojure.core/assoc :abuse-contact-phone (deser-contact-number (clojure.core/get-in letvar1962634 ["AbuseContactPhone"])))))))

(clojure.core/defn- response-update-tags-for-domain-response ([input] (response-update-tags-for-domain-response nil input)) ([resultWrapper1962636 input] (clojure.core/let [rawinput1962635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962637 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-operations-response ([input] (response-list-operations-response nil input)) ([resultWrapper1962639 input] (clojure.core/let [rawinput1962638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962640 {"Operations" (rawinput1962638 "Operations"), "NextPageMarker" (rawinput1962638 "NextPageMarker")}] (clojure.core/cond-> {:operations (deser-operation-summary-list (clojure.core/get-in letvar1962640 ["Operations"]))} (letvar1962640 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1962640 ["NextPageMarker"])))))))

(clojure.core/defn- response-resend-contact-reachability-email-response ([input] (response-resend-contact-reachability-email-response nil input)) ([resultWrapper1962642 input] (clojure.core/let [rawinput1962641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962643 {"domainName" (rawinput1962641 "domainName"), "emailAddress" (rawinput1962641 "emailAddress"), "isAlreadyVerified" (rawinput1962641 "isAlreadyVerified")}] (clojure.core/cond-> {} (letvar1962643 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1962643 ["domainName"]))) (letvar1962643 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1962643 ["emailAddress"]))) (letvar1962643 "isAlreadyVerified") (clojure.core/assoc :is-already-verified (deser-boolean (clojure.core/get-in letvar1962643 ["isAlreadyVerified"])))))))

(clojure.core/defn- response-view-billing-response ([input] (response-view-billing-response nil input)) ([resultWrapper1962645 input] (clojure.core/let [rawinput1962644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962646 {"NextPageMarker" (rawinput1962644 "NextPageMarker"), "BillingRecords" (rawinput1962644 "BillingRecords")}] (clojure.core/cond-> {} (letvar1962646 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1962646 ["NextPageMarker"]))) (letvar1962646 "BillingRecords") (clojure.core/assoc :billing-records (deser-billing-records (clojure.core/get-in letvar1962646 ["BillingRecords"])))))))

(clojure.core/defn- response-check-domain-availability-response ([input] (response-check-domain-availability-response nil input)) ([resultWrapper1962648 input] (clojure.core/let [rawinput1962647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962649 {"Availability" (rawinput1962647 "Availability")}] (clojure.core/cond-> {:availability (deser-domain-availability (clojure.core/get-in letvar1962649 ["Availability"]))}))))

(clojure.core/defn- response-register-domain-response ([input] (response-register-domain-response nil input)) ([resultWrapper1962651 input] (clojure.core/let [rawinput1962650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962652 {"OperationId" (rawinput1962650 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962652 ["OperationId"]))}))))

(clojure.core/defn- response-get-contact-reachability-status-response ([input] (response-get-contact-reachability-status-response nil input)) ([resultWrapper1962654 input] (clojure.core/let [rawinput1962653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962655 {"domainName" (rawinput1962653 "domainName"), "status" (rawinput1962653 "status")}] (clojure.core/cond-> {} (letvar1962655 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1962655 ["domainName"]))) (letvar1962655 "status") (clojure.core/assoc :status (deser-reachability-status (clojure.core/get-in letvar1962655 ["status"])))))))

(clojure.core/defn- response-invalid-input ([input] (response-invalid-input nil input)) ([resultWrapper1962657 input] (clojure.core/let [rawinput1962656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962658 {"message" (rawinput1962656 "message")}] (clojure.core/cond-> {} (letvar1962658 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962658 ["message"])))))))

(clojure.core/defn- response-disable-domain-transfer-lock-response ([input] (response-disable-domain-transfer-lock-response nil input)) ([resultWrapper1962660 input] (clojure.core/let [rawinput1962659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962661 {"OperationId" (rawinput1962659 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962661 ["OperationId"]))}))))

(clojure.core/defn- response-disable-domain-auto-renew-response ([input] (response-disable-domain-auto-renew-response nil input)) ([resultWrapper1962663 input] (clojure.core/let [rawinput1962662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962664 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-domain-contact-privacy-response ([input] (response-update-domain-contact-privacy-response nil input)) ([resultWrapper1962666 input] (clojure.core/let [rawinput1962665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962667 {"OperationId" (rawinput1962665 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962667 ["OperationId"]))}))))

(clojure.core/defn- response-enable-domain-transfer-lock-response ([input] (response-enable-domain-transfer-lock-response nil input)) ([resultWrapper1962669 input] (clojure.core/let [rawinput1962668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962670 {"OperationId" (rawinput1962668 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962670 ["OperationId"]))}))))

(clojure.core/defn- response-renew-domain-response ([input] (response-renew-domain-response nil input)) ([resultWrapper1962672 input] (clojure.core/let [rawinput1962671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962673 {"OperationId" (rawinput1962671 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962673 ["OperationId"]))}))))

(clojure.core/defn- response-list-domains-response ([input] (response-list-domains-response nil input)) ([resultWrapper1962675 input] (clojure.core/let [rawinput1962674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962676 {"Domains" (rawinput1962674 "Domains"), "NextPageMarker" (rawinput1962674 "NextPageMarker")}] (clojure.core/cond-> {:domains (deser-domain-summary-list (clojure.core/get-in letvar1962676 ["Domains"]))} (letvar1962676 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1962676 ["NextPageMarker"])))))))

(clojure.core/defn- response-check-domain-transferability-response ([input] (response-check-domain-transferability-response nil input)) ([resultWrapper1962678 input] (clojure.core/let [rawinput1962677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962679 {"Transferability" (rawinput1962677 "Transferability")}] (clojure.core/cond-> {:transferability (deser-domain-transferability (clojure.core/get-in letvar1962679 ["Transferability"]))}))))

(clojure.core/defn- response-enable-domain-auto-renew-response ([input] (response-enable-domain-auto-renew-response nil input)) ([resultWrapper1962681 input] (clojure.core/let [rawinput1962680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962682 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-tags-for-domain-response ([input] (response-delete-tags-for-domain-response nil input)) ([resultWrapper1962684 input] (clojure.core/let [rawinput1962683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962685 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tld-rules-violation ([input] (response-tld-rules-violation nil input)) ([resultWrapper1962687 input] (clojure.core/let [rawinput1962686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962688 {"message" (rawinput1962686 "message")}] (clojure.core/cond-> {} (letvar1962688 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962688 ["message"])))))))

(clojure.core/defn- response-list-tags-for-domain-response ([input] (response-list-tags-for-domain-response nil input)) ([resultWrapper1962690 input] (clojure.core/let [rawinput1962689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962691 {"TagList" (rawinput1962689 "TagList")}] (clojure.core/cond-> {:tag-list (deser-tag-list (clojure.core/get-in letvar1962691 ["TagList"]))}))))

(clojure.core/defn- response-unsupported-tld ([input] (response-unsupported-tld nil input)) ([resultWrapper1962693 input] (clojure.core/let [rawinput1962692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962694 {"message" (rawinput1962692 "message")}] (clojure.core/cond-> {} (letvar1962694 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962694 ["message"])))))))

(clojure.core/defn- response-retrieve-domain-auth-code-response ([input] (response-retrieve-domain-auth-code-response nil input)) ([resultWrapper1962696 input] (clojure.core/let [rawinput1962695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962697 {"AuthCode" (rawinput1962695 "AuthCode")}] (clojure.core/cond-> {:auth-code (deser-domain-auth-code (clojure.core/get-in letvar1962697 ["AuthCode"]))}))))

(clojure.core/defn- response-operation-limit-exceeded ([input] (response-operation-limit-exceeded nil input)) ([resultWrapper1962699 input] (clojure.core/let [rawinput1962698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962700 {"message" (rawinput1962698 "message")}] (clojure.core/cond-> {} (letvar1962700 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962700 ["message"])))))))

(clojure.core/defn- response-transfer-domain-response ([input] (response-transfer-domain-response nil input)) ([resultWrapper1962702 input] (clojure.core/let [rawinput1962701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962703 {"OperationId" (rawinput1962701 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962703 ["OperationId"]))}))))

(clojure.core/defn- response-get-operation-detail-response ([input] (response-get-operation-detail-response nil input)) ([resultWrapper1962705 input] (clojure.core/let [rawinput1962704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962706 {"OperationId" (rawinput1962704 "OperationId"), "Status" (rawinput1962704 "Status"), "Message" (rawinput1962704 "Message"), "DomainName" (rawinput1962704 "DomainName"), "Type" (rawinput1962704 "Type"), "SubmittedDate" (rawinput1962704 "SubmittedDate")}] (clojure.core/cond-> {} (letvar1962706 "OperationId") (clojure.core/assoc :operation-id (deser-operation-id (clojure.core/get-in letvar1962706 ["OperationId"]))) (letvar1962706 "Status") (clojure.core/assoc :status (deser-operation-status (clojure.core/get-in letvar1962706 ["Status"]))) (letvar1962706 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962706 ["Message"]))) (letvar1962706 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1962706 ["DomainName"]))) (letvar1962706 "Type") (clojure.core/assoc :type (deser-operation-type (clojure.core/get-in letvar1962706 ["Type"]))) (letvar1962706 "SubmittedDate") (clojure.core/assoc :submitted-date (deser-timestamp (clojure.core/get-in letvar1962706 ["SubmittedDate"])))))))

(clojure.core/defn- response-update-domain-nameservers-response ([input] (response-update-domain-nameservers-response nil input)) ([resultWrapper1962708 input] (clojure.core/let [rawinput1962707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962709 {"OperationId" (rawinput1962707 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1962709 ["OperationId"]))}))))

(clojure.core/defn- response-duplicate-request ([input] (response-duplicate-request nil input)) ([resultWrapper1962711 input] (clojure.core/let [rawinput1962710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1962712 {"message" (rawinput1962710 "message")}] (clojure.core/cond-> {} (letvar1962712 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1962712 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/contact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/zip-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/extra-param-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/lang-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53domains/contact-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/operation-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/address-line (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/glue-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 45))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/city (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53domains/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-auth-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/host-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\-.]*" s__1467903__auto__))))
