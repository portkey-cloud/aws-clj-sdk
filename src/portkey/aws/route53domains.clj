...
(clojure.core/defn- response-domain-limit-exceeded ([input] (response-domain-limit-exceeded nil input)) ([resultWrapper1953206 input] (clojure.core/let [rawinput1953205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953207 {"message" (rawinput1953205 "message")}] (clojure.core/cond-> {} (letvar1953207 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953207 ["message"])))))))

(clojure.core/defn- response-get-domain-suggestions-response ([input] (response-get-domain-suggestions-response nil input)) ([resultWrapper1953209 input] (clojure.core/let [rawinput1953208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953210 {"SuggestionsList" (rawinput1953208 "SuggestionsList")}] (clojure.core/cond-> {} (letvar1953210 "SuggestionsList") (clojure.core/assoc :suggestions-list (deser-domain-suggestions-list (clojure.core/get-in letvar1953210 ["SuggestionsList"])))))))

(clojure.core/defn- response-update-domain-contact-response ([input] (response-update-domain-contact-response nil input)) ([resultWrapper1953212 input] (clojure.core/let [rawinput1953211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953213 {"OperationId" (rawinput1953211 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953213 ["OperationId"]))}))))

(clojure.core/defn- response-get-domain-detail-response ([input] (response-get-domain-detail-response nil input)) ([resultWrapper1953215 input] (clojure.core/let [rawinput1953214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953216 {"WhoIsServer" (rawinput1953214 "WhoIsServer"), "DnsSec" (rawinput1953214 "DnsSec"), "AdminContact" (rawinput1953214 "AdminContact"), "AdminPrivacy" (rawinput1953214 "AdminPrivacy"), "TechContact" (rawinput1953214 "TechContact"), "RegistryDomainId" (rawinput1953214 "RegistryDomainId"), "RegistrantPrivacy" (rawinput1953214 "RegistrantPrivacy"), "RegistrantContact" (rawinput1953214 "RegistrantContact"), "ExpirationDate" (rawinput1953214 "ExpirationDate"), "Nameservers" (rawinput1953214 "Nameservers"), "AbuseContactEmail" (rawinput1953214 "AbuseContactEmail"), "AutoRenew" (rawinput1953214 "AutoRenew"), "UpdatedDate" (rawinput1953214 "UpdatedDate"), "RegistrarUrl" (rawinput1953214 "RegistrarUrl"), "RegistrarName" (rawinput1953214 "RegistrarName"), "TechPrivacy" (rawinput1953214 "TechPrivacy"), "CreationDate" (rawinput1953214 "CreationDate"), "DomainName" (rawinput1953214 "DomainName"), "Reseller" (rawinput1953214 "Reseller"), "StatusList" (rawinput1953214 "StatusList"), "AbuseContactPhone" (rawinput1953214 "AbuseContactPhone")}] (clojure.core/cond-> {:domain-name (deser-domain-name (clojure.core/get-in letvar1953216 ["DomainName"])), :nameservers (deser-nameserver-list (clojure.core/get-in letvar1953216 ["Nameservers"])), :admin-contact (deser-contact-detail (clojure.core/get-in letvar1953216 ["AdminContact"])), :registrant-contact (deser-contact-detail (clojure.core/get-in letvar1953216 ["RegistrantContact"])), :tech-contact (deser-contact-detail (clojure.core/get-in letvar1953216 ["TechContact"]))} (letvar1953216 "WhoIsServer") (clojure.core/assoc :who-is-server (deser-registrar-who-is-server (clojure.core/get-in letvar1953216 ["WhoIsServer"]))) (letvar1953216 "DnsSec") (clojure.core/assoc :dns-sec (deser-dns-sec (clojure.core/get-in letvar1953216 ["DnsSec"]))) (letvar1953216 "AdminPrivacy") (clojure.core/assoc :admin-privacy (deser-boolean (clojure.core/get-in letvar1953216 ["AdminPrivacy"]))) (letvar1953216 "RegistryDomainId") (clojure.core/assoc :registry-domain-id (deser-registry-domain-id (clojure.core/get-in letvar1953216 ["RegistryDomainId"]))) (letvar1953216 "RegistrantPrivacy") (clojure.core/assoc :registrant-privacy (deser-boolean (clojure.core/get-in letvar1953216 ["RegistrantPrivacy"]))) (letvar1953216 "ExpirationDate") (clojure.core/assoc :expiration-date (deser-timestamp (clojure.core/get-in letvar1953216 ["ExpirationDate"]))) (letvar1953216 "AbuseContactEmail") (clojure.core/assoc :abuse-contact-email (deser-email (clojure.core/get-in letvar1953216 ["AbuseContactEmail"]))) (letvar1953216 "AutoRenew") (clojure.core/assoc :auto-renew (deser-boolean (clojure.core/get-in letvar1953216 ["AutoRenew"]))) (letvar1953216 "UpdatedDate") (clojure.core/assoc :updated-date (deser-timestamp (clojure.core/get-in letvar1953216 ["UpdatedDate"]))) (letvar1953216 "RegistrarUrl") (clojure.core/assoc :registrar-url (deser-registrar-url (clojure.core/get-in letvar1953216 ["RegistrarUrl"]))) (letvar1953216 "RegistrarName") (clojure.core/assoc :registrar-name (deser-registrar-name (clojure.core/get-in letvar1953216 ["RegistrarName"]))) (letvar1953216 "TechPrivacy") (clojure.core/assoc :tech-privacy (deser-boolean (clojure.core/get-in letvar1953216 ["TechPrivacy"]))) (letvar1953216 "CreationDate") (clojure.core/assoc :creation-date (deser-timestamp (clojure.core/get-in letvar1953216 ["CreationDate"]))) (letvar1953216 "Reseller") (clojure.core/assoc :reseller (deser-reseller (clojure.core/get-in letvar1953216 ["Reseller"]))) (letvar1953216 "StatusList") (clojure.core/assoc :status-list (deser-domain-status-list (clojure.core/get-in letvar1953216 ["StatusList"]))) (letvar1953216 "AbuseContactPhone") (clojure.core/assoc :abuse-contact-phone (deser-contact-number (clojure.core/get-in letvar1953216 ["AbuseContactPhone"])))))))

(clojure.core/defn- response-update-tags-for-domain-response ([input] (response-update-tags-for-domain-response nil input)) ([resultWrapper1953218 input] (clojure.core/let [rawinput1953217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953219 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-operations-response ([input] (response-list-operations-response nil input)) ([resultWrapper1953221 input] (clojure.core/let [rawinput1953220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953222 {"Operations" (rawinput1953220 "Operations"), "NextPageMarker" (rawinput1953220 "NextPageMarker")}] (clojure.core/cond-> {:operations (deser-operation-summary-list (clojure.core/get-in letvar1953222 ["Operations"]))} (letvar1953222 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1953222 ["NextPageMarker"])))))))

(clojure.core/defn- response-resend-contact-reachability-email-response ([input] (response-resend-contact-reachability-email-response nil input)) ([resultWrapper1953224 input] (clojure.core/let [rawinput1953223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953225 {"domainName" (rawinput1953223 "domainName"), "emailAddress" (rawinput1953223 "emailAddress"), "isAlreadyVerified" (rawinput1953223 "isAlreadyVerified")}] (clojure.core/cond-> {} (letvar1953225 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1953225 ["domainName"]))) (letvar1953225 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1953225 ["emailAddress"]))) (letvar1953225 "isAlreadyVerified") (clojure.core/assoc :is-already-verified (deser-boolean (clojure.core/get-in letvar1953225 ["isAlreadyVerified"])))))))

(clojure.core/defn- response-view-billing-response ([input] (response-view-billing-response nil input)) ([resultWrapper1953227 input] (clojure.core/let [rawinput1953226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953228 {"NextPageMarker" (rawinput1953226 "NextPageMarker"), "BillingRecords" (rawinput1953226 "BillingRecords")}] (clojure.core/cond-> {} (letvar1953228 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1953228 ["NextPageMarker"]))) (letvar1953228 "BillingRecords") (clojure.core/assoc :billing-records (deser-billing-records (clojure.core/get-in letvar1953228 ["BillingRecords"])))))))

(clojure.core/defn- response-check-domain-availability-response ([input] (response-check-domain-availability-response nil input)) ([resultWrapper1953230 input] (clojure.core/let [rawinput1953229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953231 {"Availability" (rawinput1953229 "Availability")}] (clojure.core/cond-> {:availability (deser-domain-availability (clojure.core/get-in letvar1953231 ["Availability"]))}))))

(clojure.core/defn- response-register-domain-response ([input] (response-register-domain-response nil input)) ([resultWrapper1953233 input] (clojure.core/let [rawinput1953232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953234 {"OperationId" (rawinput1953232 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953234 ["OperationId"]))}))))

(clojure.core/defn- response-get-contact-reachability-status-response ([input] (response-get-contact-reachability-status-response nil input)) ([resultWrapper1953236 input] (clojure.core/let [rawinput1953235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953237 {"domainName" (rawinput1953235 "domainName"), "status" (rawinput1953235 "status")}] (clojure.core/cond-> {} (letvar1953237 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1953237 ["domainName"]))) (letvar1953237 "status") (clojure.core/assoc :status (deser-reachability-status (clojure.core/get-in letvar1953237 ["status"])))))))

(clojure.core/defn- response-invalid-input ([input] (response-invalid-input nil input)) ([resultWrapper1953239 input] (clojure.core/let [rawinput1953238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953240 {"message" (rawinput1953238 "message")}] (clojure.core/cond-> {} (letvar1953240 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953240 ["message"])))))))

(clojure.core/defn- response-disable-domain-transfer-lock-response ([input] (response-disable-domain-transfer-lock-response nil input)) ([resultWrapper1953242 input] (clojure.core/let [rawinput1953241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953243 {"OperationId" (rawinput1953241 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953243 ["OperationId"]))}))))

(clojure.core/defn- response-disable-domain-auto-renew-response ([input] (response-disable-domain-auto-renew-response nil input)) ([resultWrapper1953245 input] (clojure.core/let [rawinput1953244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953246 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-domain-contact-privacy-response ([input] (response-update-domain-contact-privacy-response nil input)) ([resultWrapper1953248 input] (clojure.core/let [rawinput1953247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953249 {"OperationId" (rawinput1953247 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953249 ["OperationId"]))}))))

(clojure.core/defn- response-enable-domain-transfer-lock-response ([input] (response-enable-domain-transfer-lock-response nil input)) ([resultWrapper1953251 input] (clojure.core/let [rawinput1953250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953252 {"OperationId" (rawinput1953250 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953252 ["OperationId"]))}))))

(clojure.core/defn- response-renew-domain-response ([input] (response-renew-domain-response nil input)) ([resultWrapper1953254 input] (clojure.core/let [rawinput1953253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953255 {"OperationId" (rawinput1953253 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953255 ["OperationId"]))}))))

(clojure.core/defn- response-list-domains-response ([input] (response-list-domains-response nil input)) ([resultWrapper1953257 input] (clojure.core/let [rawinput1953256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953258 {"Domains" (rawinput1953256 "Domains"), "NextPageMarker" (rawinput1953256 "NextPageMarker")}] (clojure.core/cond-> {:domains (deser-domain-summary-list (clojure.core/get-in letvar1953258 ["Domains"]))} (letvar1953258 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1953258 ["NextPageMarker"])))))))

(clojure.core/defn- response-check-domain-transferability-response ([input] (response-check-domain-transferability-response nil input)) ([resultWrapper1953260 input] (clojure.core/let [rawinput1953259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953261 {"Transferability" (rawinput1953259 "Transferability")}] (clojure.core/cond-> {:transferability (deser-domain-transferability (clojure.core/get-in letvar1953261 ["Transferability"]))}))))

(clojure.core/defn- response-enable-domain-auto-renew-response ([input] (response-enable-domain-auto-renew-response nil input)) ([resultWrapper1953263 input] (clojure.core/let [rawinput1953262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953264 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-tags-for-domain-response ([input] (response-delete-tags-for-domain-response nil input)) ([resultWrapper1953266 input] (clojure.core/let [rawinput1953265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953267 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tld-rules-violation ([input] (response-tld-rules-violation nil input)) ([resultWrapper1953269 input] (clojure.core/let [rawinput1953268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953270 {"message" (rawinput1953268 "message")}] (clojure.core/cond-> {} (letvar1953270 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953270 ["message"])))))))

(clojure.core/defn- response-list-tags-for-domain-response ([input] (response-list-tags-for-domain-response nil input)) ([resultWrapper1953272 input] (clojure.core/let [rawinput1953271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953273 {"TagList" (rawinput1953271 "TagList")}] (clojure.core/cond-> {:tag-list (deser-tag-list (clojure.core/get-in letvar1953273 ["TagList"]))}))))

(clojure.core/defn- response-unsupported-tld ([input] (response-unsupported-tld nil input)) ([resultWrapper1953275 input] (clojure.core/let [rawinput1953274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953276 {"message" (rawinput1953274 "message")}] (clojure.core/cond-> {} (letvar1953276 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953276 ["message"])))))))

(clojure.core/defn- response-retrieve-domain-auth-code-response ([input] (response-retrieve-domain-auth-code-response nil input)) ([resultWrapper1953278 input] (clojure.core/let [rawinput1953277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953279 {"AuthCode" (rawinput1953277 "AuthCode")}] (clojure.core/cond-> {:auth-code (deser-domain-auth-code (clojure.core/get-in letvar1953279 ["AuthCode"]))}))))

(clojure.core/defn- response-operation-limit-exceeded ([input] (response-operation-limit-exceeded nil input)) ([resultWrapper1953281 input] (clojure.core/let [rawinput1953280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953282 {"message" (rawinput1953280 "message")}] (clojure.core/cond-> {} (letvar1953282 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953282 ["message"])))))))

(clojure.core/defn- response-transfer-domain-response ([input] (response-transfer-domain-response nil input)) ([resultWrapper1953284 input] (clojure.core/let [rawinput1953283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953285 {"OperationId" (rawinput1953283 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953285 ["OperationId"]))}))))

(clojure.core/defn- response-get-operation-detail-response ([input] (response-get-operation-detail-response nil input)) ([resultWrapper1953287 input] (clojure.core/let [rawinput1953286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953288 {"OperationId" (rawinput1953286 "OperationId"), "Status" (rawinput1953286 "Status"), "Message" (rawinput1953286 "Message"), "DomainName" (rawinput1953286 "DomainName"), "Type" (rawinput1953286 "Type"), "SubmittedDate" (rawinput1953286 "SubmittedDate")}] (clojure.core/cond-> {} (letvar1953288 "OperationId") (clojure.core/assoc :operation-id (deser-operation-id (clojure.core/get-in letvar1953288 ["OperationId"]))) (letvar1953288 "Status") (clojure.core/assoc :status (deser-operation-status (clojure.core/get-in letvar1953288 ["Status"]))) (letvar1953288 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953288 ["Message"]))) (letvar1953288 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1953288 ["DomainName"]))) (letvar1953288 "Type") (clojure.core/assoc :type (deser-operation-type (clojure.core/get-in letvar1953288 ["Type"]))) (letvar1953288 "SubmittedDate") (clojure.core/assoc :submitted-date (deser-timestamp (clojure.core/get-in letvar1953288 ["SubmittedDate"])))))))

(clojure.core/defn- response-update-domain-nameservers-response ([input] (response-update-domain-nameservers-response nil input)) ([resultWrapper1953290 input] (clojure.core/let [rawinput1953289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953291 {"OperationId" (rawinput1953289 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1953291 ["OperationId"]))}))))

(clojure.core/defn- response-duplicate-request ([input] (response-duplicate-request nil input)) ([resultWrapper1953293 input] (clojure.core/let [rawinput1953292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1953294 {"message" (rawinput1953292 "message")}] (clojure.core/cond-> {} (letvar1953294 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1953294 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/contact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/zip-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/extra-param-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/lang-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53domains/contact-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/operation-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/address-line (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/glue-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 45))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/city (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53domains/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-auth-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/host-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\-.]*" s__1410940__auto__))))
