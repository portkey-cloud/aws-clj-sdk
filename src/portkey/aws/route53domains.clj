...
(clojure.core/defn- deser-domain-limit-exceeded [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))

(clojure.core/defn- deser-get-domain-suggestions-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SuggestionsList") (clojure.core/assoc :suggestions-list (deser-domain-suggestions-list (input "SuggestionsList")))))

(clojure.core/defn- deser-update-domain-contact-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-get-domain-detail-response [input] (clojure.core/cond-> {:domain-name (deser-domain-name (input "DomainName")), :nameservers (deser-nameserver-list (input "Nameservers")), :admin-contact (deser-contact-detail (input "AdminContact")), :registrant-contact (deser-contact-detail (input "RegistrantContact")), :tech-contact (deser-contact-detail (input "TechContact"))} (clojure.core/contains? input "WhoIsServer") (clojure.core/assoc :who-is-server (deser-registrar-who-is-server (input "WhoIsServer"))) (clojure.core/contains? input "DnsSec") (clojure.core/assoc :dns-sec (deser-dns-sec (input "DnsSec"))) (clojure.core/contains? input "AdminPrivacy") (clojure.core/assoc :admin-privacy (deser-boolean (input "AdminPrivacy"))) (clojure.core/contains? input "RegistryDomainId") (clojure.core/assoc :registry-domain-id (deser-registry-domain-id (input "RegistryDomainId"))) (clojure.core/contains? input "RegistrantPrivacy") (clojure.core/assoc :registrant-privacy (deser-boolean (input "RegistrantPrivacy"))) (clojure.core/contains? input "ExpirationDate") (clojure.core/assoc :expiration-date (deser-timestamp (input "ExpirationDate"))) (clojure.core/contains? input "AbuseContactEmail") (clojure.core/assoc :abuse-contact-email (deser-email (input "AbuseContactEmail"))) (clojure.core/contains? input "AutoRenew") (clojure.core/assoc :auto-renew (deser-boolean (input "AutoRenew"))) (clojure.core/contains? input "UpdatedDate") (clojure.core/assoc :updated-date (deser-timestamp (input "UpdatedDate"))) (clojure.core/contains? input "RegistrarUrl") (clojure.core/assoc :registrar-url (deser-registrar-url (input "RegistrarUrl"))) (clojure.core/contains? input "RegistrarName") (clojure.core/assoc :registrar-name (deser-registrar-name (input "RegistrarName"))) (clojure.core/contains? input "TechPrivacy") (clojure.core/assoc :tech-privacy (deser-boolean (input "TechPrivacy"))) (clojure.core/contains? input "CreationDate") (clojure.core/assoc :creation-date (deser-timestamp (input "CreationDate"))) (clojure.core/contains? input "Reseller") (clojure.core/assoc :reseller (deser-reseller (input "Reseller"))) (clojure.core/contains? input "StatusList") (clojure.core/assoc :status-list (deser-domain-status-list (input "StatusList"))) (clojure.core/contains? input "AbuseContactPhone") (clojure.core/assoc :abuse-contact-phone (deser-contact-number (input "AbuseContactPhone")))))

(clojure.core/defn- deser-update-tags-for-domain-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-operations-response [input] (clojure.core/cond-> {:operations (deser-operation-summary-list (input "Operations"))} (clojure.core/contains? input "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (input "NextPageMarker")))))

(clojure.core/defn- deser-resend-contact-reachability-email-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "domainName") (clojure.core/assoc :domain-name (deser-domain-name (input "domainName"))) (clojure.core/contains? input "emailAddress") (clojure.core/assoc :email-address (deser-email (input "emailAddress"))) (clojure.core/contains? input "isAlreadyVerified") (clojure.core/assoc :is-already-verified (deser-boolean (input "isAlreadyVerified")))))

(clojure.core/defn- deser-view-billing-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (input "NextPageMarker"))) (clojure.core/contains? input "BillingRecords") (clojure.core/assoc :billing-records (deser-billing-records (input "BillingRecords")))))

(clojure.core/defn- deser-check-domain-availability-response [input] (clojure.core/cond-> {:availability (deser-domain-availability (input "Availability"))}))

(clojure.core/defn- deser-register-domain-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-get-contact-reachability-status-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "domainName") (clojure.core/assoc :domain-name (deser-domain-name (input "domainName"))) (clojure.core/contains? input "status") (clojure.core/assoc :status (deser-reachability-status (input "status")))))

(clojure.core/defn- deser-invalid-input [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))

(clojure.core/defn- deser-disable-domain-transfer-lock-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-disable-domain-auto-renew-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-domain-contact-privacy-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-enable-domain-transfer-lock-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-renew-domain-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-list-domains-response [input] (clojure.core/cond-> {:domains (deser-domain-summary-list (input "Domains"))} (clojure.core/contains? input "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (input "NextPageMarker")))))

(clojure.core/defn- deser-check-domain-transferability-response [input] (clojure.core/cond-> {:transferability (deser-domain-transferability (input "Transferability"))}))

(clojure.core/defn- deser-enable-domain-auto-renew-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-tags-for-domain-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tld-rules-violation [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))

(clojure.core/defn- deser-list-tags-for-domain-response [input] (clojure.core/cond-> {:tag-list (deser-tag-list (input "TagList"))}))

(clojure.core/defn- deser-unsupported-tld [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))

(clojure.core/defn- deser-retrieve-domain-auth-code-response [input] (clojure.core/cond-> {:auth-code (deser-domain-auth-code (input "AuthCode"))}))

(clojure.core/defn- deser-operation-limit-exceeded [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))

(clojure.core/defn- deser-transfer-domain-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-get-operation-detail-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "OperationId") (clojure.core/assoc :operation-id (deser-operation-id (input "OperationId"))) (clojure.core/contains? input "Status") (clojure.core/assoc :status (deser-operation-status (input "Status"))) (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message"))) (clojure.core/contains? input "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (input "DomainName"))) (clojure.core/contains? input "Type") (clojure.core/assoc :type (deser-operation-type (input "Type"))) (clojure.core/contains? input "SubmittedDate") (clojure.core/assoc :submitted-date (deser-timestamp (input "SubmittedDate")))))

(clojure.core/defn- deser-update-domain-nameservers-response [input] (clojure.core/cond-> {:operation-id (deser-operation-id (input "OperationId"))}))

(clojure.core/defn- deser-duplicate-request [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-error-message (input "message")))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/contact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/zip-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/extra-param-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/lang-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53domains/contact-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/operation-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/address-line (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/glue-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 45))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/city (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53domains/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-auth-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains/host-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\-.]*" s__27881__auto__))))
