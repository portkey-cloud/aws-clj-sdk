...
(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper465278 input] (clojure.core/let [rawinput465277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465279 {"message" (rawinput465277 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465279 ["message"]))}))))

(clojure.core/defn- response-describe-identity-pool-usage-response ([input] (response-describe-identity-pool-usage-response nil input)) ([resultWrapper465281 input] (clojure.core/let [rawinput465280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465282 {"IdentityPoolUsage" (rawinput465280 "IdentityPoolUsage")}] (clojure.core/cond-> {} (letvar465282 "IdentityPoolUsage") (clojure.core/assoc :identity-pool-usage (deser-identity-pool-usage (clojure.core/get-in letvar465282 ["IdentityPoolUsage"])))))))

(clojure.core/defn- response-describe-identity-usage-response ([input] (response-describe-identity-usage-response nil input)) ([resultWrapper465284 input] (clojure.core/let [rawinput465283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465285 {"IdentityUsage" (rawinput465283 "IdentityUsage")}] (clojure.core/cond-> {} (letvar465285 "IdentityUsage") (clojure.core/assoc :identity-usage (deser-identity-usage (clojure.core/get-in letvar465285 ["IdentityUsage"])))))))

(clojure.core/defn- response-unsubscribe-from-dataset-response ([input] (response-unsubscribe-from-dataset-response nil input)) ([resultWrapper465287 input] (clojure.core/let [rawinput465286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465288 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-set-identity-pool-configuration-response ([input] (response-set-identity-pool-configuration-response nil input)) ([resultWrapper465290 input] (clojure.core/let [rawinput465289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465291 {"IdentityPoolId" (rawinput465289 "IdentityPoolId"), "PushSync" (rawinput465289 "PushSync"), "CognitoStreams" (rawinput465289 "CognitoStreams")}] (clojure.core/cond-> {} (letvar465291 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar465291 ["IdentityPoolId"]))) (letvar465291 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar465291 ["PushSync"]))) (letvar465291 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar465291 ["CognitoStreams"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper465293 input] (clojure.core/let [rawinput465292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465294 {"message" (rawinput465292 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465294 ["message"]))}))))

(clojure.core/defn- response-already-streamed-exception ([input] (response-already-streamed-exception nil input)) ([resultWrapper465296 input] (clojure.core/let [rawinput465295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465297 {"message" (rawinput465295 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465297 ["message"]))}))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper465299 input] (clojure.core/let [rawinput465298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465300 {"message" (rawinput465298 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465300 ["message"]))}))))

(clojure.core/defn- response-update-records-response ([input] (response-update-records-response nil input)) ([resultWrapper465302 input] (clojure.core/let [rawinput465301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465303 {"Records" (rawinput465301 "Records")}] (clojure.core/cond-> {} (letvar465303 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar465303 ["Records"])))))))

(clojure.core/defn- response-delete-dataset-response ([input] (response-delete-dataset-response nil input)) ([resultWrapper465305 input] (clojure.core/let [rawinput465304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465306 {"Dataset" (rawinput465304 "Dataset")}] (clojure.core/cond-> {} (letvar465306 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar465306 ["Dataset"])))))))

(clojure.core/defn- response-get-bulk-publish-details-response ([input] (response-get-bulk-publish-details-response nil input)) ([resultWrapper465308 input] (clojure.core/let [rawinput465307 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465309 {"IdentityPoolId" (rawinput465307 "IdentityPoolId"), "BulkPublishStartTime" (rawinput465307 "BulkPublishStartTime"), "BulkPublishCompleteTime" (rawinput465307 "BulkPublishCompleteTime"), "BulkPublishStatus" (rawinput465307 "BulkPublishStatus"), "FailureMessage" (rawinput465307 "FailureMessage")}] (clojure.core/cond-> {} (letvar465309 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar465309 ["IdentityPoolId"]))) (letvar465309 "BulkPublishStartTime") (clojure.core/assoc :bulk-publish-start-time (deser-date (clojure.core/get-in letvar465309 ["BulkPublishStartTime"]))) (letvar465309 "BulkPublishCompleteTime") (clojure.core/assoc :bulk-publish-complete-time (deser-date (clojure.core/get-in letvar465309 ["BulkPublishCompleteTime"]))) (letvar465309 "BulkPublishStatus") (clojure.core/assoc :bulk-publish-status (deser-bulk-publish-status (clojure.core/get-in letvar465309 ["BulkPublishStatus"]))) (letvar465309 "FailureMessage") (clojure.core/assoc :failure-message (deser-string (clojure.core/get-in letvar465309 ["FailureMessage"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper465311 input] (clojure.core/let [rawinput465310 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465312 {"message" (rawinput465310 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465312 ["message"]))}))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper465314 input] (clojure.core/let [rawinput465313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465315 {"message" (rawinput465313 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465315 ["message"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper465317 input] (clojure.core/let [rawinput465316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465318 {"message" (rawinput465316 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465318 ["message"]))}))))

(clojure.core/defn- response-get-cognito-events-response ([input] (response-get-cognito-events-response nil input)) ([resultWrapper465320 input] (clojure.core/let [rawinput465319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465321 {"Events" (rawinput465319 "Events")}] (clojure.core/cond-> {} (letvar465321 "Events") (clojure.core/assoc :events (deser-events (clojure.core/get-in letvar465321 ["Events"])))))))

(clojure.core/defn- response-lambda-throttled-exception ([input] (response-lambda-throttled-exception nil input)) ([resultWrapper465323 input] (clojure.core/let [rawinput465322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465324 {"message" (rawinput465322 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465324 ["message"]))}))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper465326 input] (clojure.core/let [rawinput465325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465327 {"Dataset" (rawinput465325 "Dataset")}] (clojure.core/cond-> {} (letvar465327 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar465327 ["Dataset"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper465329 input] (clojure.core/let [rawinput465328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465330 {"message" (rawinput465328 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465330 ["message"]))}))))

(clojure.core/defn- response-invalid-lambda-function-output-exception ([input] (response-invalid-lambda-function-output-exception nil input)) ([resultWrapper465332 input] (clojure.core/let [rawinput465331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465333 {"message" (rawinput465331 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465333 ["message"]))}))))

(clojure.core/defn- response-get-identity-pool-configuration-response ([input] (response-get-identity-pool-configuration-response nil input)) ([resultWrapper465335 input] (clojure.core/let [rawinput465334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465336 {"IdentityPoolId" (rawinput465334 "IdentityPoolId"), "PushSync" (rawinput465334 "PushSync"), "CognitoStreams" (rawinput465334 "CognitoStreams")}] (clojure.core/cond-> {} (letvar465336 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar465336 ["IdentityPoolId"]))) (letvar465336 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar465336 ["PushSync"]))) (letvar465336 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar465336 ["CognitoStreams"])))))))

(clojure.core/defn- response-list-records-response ([input] (response-list-records-response nil input)) ([resultWrapper465338 input] (clojure.core/let [rawinput465337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465339 {"SyncSessionToken" (rawinput465337 "SyncSessionToken"), "DatasetSyncCount" (rawinput465337 "DatasetSyncCount"), "Count" (rawinput465337 "Count"), "NextToken" (rawinput465337 "NextToken"), "DatasetExists" (rawinput465337 "DatasetExists"), "DatasetDeletedAfterRequestedSyncCount" (rawinput465337 "DatasetDeletedAfterRequestedSyncCount"), "MergedDatasetNames" (rawinput465337 "MergedDatasetNames"), "Records" (rawinput465337 "Records"), "LastModifiedBy" (rawinput465337 "LastModifiedBy")}] (clojure.core/cond-> {} (letvar465339 "SyncSessionToken") (clojure.core/assoc :sync-session-token (deser-string (clojure.core/get-in letvar465339 ["SyncSessionToken"]))) (letvar465339 "DatasetSyncCount") (clojure.core/assoc :dataset-sync-count (deser-long (clojure.core/get-in letvar465339 ["DatasetSyncCount"]))) (letvar465339 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar465339 ["Count"]))) (letvar465339 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar465339 ["NextToken"]))) (letvar465339 "DatasetExists") (clojure.core/assoc :dataset-exists (deser-boolean (clojure.core/get-in letvar465339 ["DatasetExists"]))) (letvar465339 "DatasetDeletedAfterRequestedSyncCount") (clojure.core/assoc :dataset-deleted-after-requested-sync-count (deser-boolean (clojure.core/get-in letvar465339 ["DatasetDeletedAfterRequestedSyncCount"]))) (letvar465339 "MergedDatasetNames") (clojure.core/assoc :merged-dataset-names (deser-merged-dataset-name-list (clojure.core/get-in letvar465339 ["MergedDatasetNames"]))) (letvar465339 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar465339 ["Records"]))) (letvar465339 "LastModifiedBy") (clojure.core/assoc :last-modified-by (deser-string (clojure.core/get-in letvar465339 ["LastModifiedBy"])))))))

(clojure.core/defn- response-subscribe-to-dataset-response ([input] (response-subscribe-to-dataset-response nil input)) ([resultWrapper465341 input] (clojure.core/let [rawinput465340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465342 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bulk-publish-response ([input] (response-bulk-publish-response nil input)) ([resultWrapper465344 input] (clojure.core/let [rawinput465343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465345 {"IdentityPoolId" (rawinput465343 "IdentityPoolId")}] (clojure.core/cond-> {} (letvar465345 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar465345 ["IdentityPoolId"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper465347 input] (clojure.core/let [rawinput465346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465348 {"message" (rawinput465346 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar465348 ["message"]))}))))

(clojure.core/defn- response-list-identity-pool-usage-response ([input] (response-list-identity-pool-usage-response nil input)) ([resultWrapper465350 input] (clojure.core/let [rawinput465349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465351 {"IdentityPoolUsages" (rawinput465349 "IdentityPoolUsages"), "MaxResults" (rawinput465349 "MaxResults"), "Count" (rawinput465349 "Count"), "NextToken" (rawinput465349 "NextToken")}] (clojure.core/cond-> {} (letvar465351 "IdentityPoolUsages") (clojure.core/assoc :identity-pool-usages (deser-identity-pool-usage-list (clojure.core/get-in letvar465351 ["IdentityPoolUsages"]))) (letvar465351 "MaxResults") (clojure.core/assoc :max-results (deser-integer (clojure.core/get-in letvar465351 ["MaxResults"]))) (letvar465351 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar465351 ["Count"]))) (letvar465351 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar465351 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper465353 input] (clojure.core/let [rawinput465352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465354 {"message" (rawinput465352 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465354 ["message"]))}))))

(clojure.core/defn- response-register-device-response ([input] (response-register-device-response nil input)) ([resultWrapper465356 input] (clojure.core/let [rawinput465355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465357 {"DeviceId" (rawinput465355 "DeviceId")}] (clojure.core/cond-> {} (letvar465357 "DeviceId") (clojure.core/assoc :device-id (deser-device-id (clojure.core/get-in letvar465357 ["DeviceId"])))))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper465359 input] (clojure.core/let [rawinput465358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465360 {"Datasets" (rawinput465358 "Datasets"), "Count" (rawinput465358 "Count"), "NextToken" (rawinput465358 "NextToken")}] (clojure.core/cond-> {} (letvar465360 "Datasets") (clojure.core/assoc :datasets (deser-dataset-list (clojure.core/get-in letvar465360 ["Datasets"]))) (letvar465360 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar465360 ["Count"]))) (letvar465360 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar465360 ["NextToken"])))))))

(clojure.core/defn- response-invalid-configuration-exception ([input] (response-invalid-configuration-exception nil input)) ([resultWrapper465362 input] (clojure.core/let [rawinput465361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar465363 {"message" (rawinput465361 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar465363 ["message"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/record-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/application-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:sns:[-0-9a-z]+:\d+:app/[A-Z_]+/[a-zA-Z0-9_.-]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-sync/sync-session-token (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cognito-sync/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.:-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 55)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/identity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 55)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/record-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1048575))))
