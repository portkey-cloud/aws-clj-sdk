...
(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper1113878 input] (clojure.core/let [rawinput1113877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113879 {"message" (rawinput1113877 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113879 ["message"]))}))))

(clojure.core/defn- response-describe-identity-pool-usage-response ([input] (response-describe-identity-pool-usage-response nil input)) ([resultWrapper1113881 input] (clojure.core/let [rawinput1113880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113882 {"IdentityPoolUsage" (rawinput1113880 "IdentityPoolUsage")}] (clojure.core/cond-> {} (letvar1113882 "IdentityPoolUsage") (clojure.core/assoc :identity-pool-usage (deser-identity-pool-usage (clojure.core/get-in letvar1113882 ["IdentityPoolUsage"])))))))

(clojure.core/defn- response-describe-identity-usage-response ([input] (response-describe-identity-usage-response nil input)) ([resultWrapper1113884 input] (clojure.core/let [rawinput1113883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113885 {"IdentityUsage" (rawinput1113883 "IdentityUsage")}] (clojure.core/cond-> {} (letvar1113885 "IdentityUsage") (clojure.core/assoc :identity-usage (deser-identity-usage (clojure.core/get-in letvar1113885 ["IdentityUsage"])))))))

(clojure.core/defn- response-unsubscribe-from-dataset-response ([input] (response-unsubscribe-from-dataset-response nil input)) ([resultWrapper1113887 input] (clojure.core/let [rawinput1113886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113888 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-set-identity-pool-configuration-response ([input] (response-set-identity-pool-configuration-response nil input)) ([resultWrapper1113890 input] (clojure.core/let [rawinput1113889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113891 {"IdentityPoolId" (rawinput1113889 "IdentityPoolId"), "PushSync" (rawinput1113889 "PushSync"), "CognitoStreams" (rawinput1113889 "CognitoStreams")}] (clojure.core/cond-> {} (letvar1113891 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1113891 ["IdentityPoolId"]))) (letvar1113891 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar1113891 ["PushSync"]))) (letvar1113891 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar1113891 ["CognitoStreams"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1113893 input] (clojure.core/let [rawinput1113892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113894 {"message" (rawinput1113892 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113894 ["message"]))}))))

(clojure.core/defn- response-already-streamed-exception ([input] (response-already-streamed-exception nil input)) ([resultWrapper1113896 input] (clojure.core/let [rawinput1113895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113897 {"message" (rawinput1113895 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113897 ["message"]))}))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1113899 input] (clojure.core/let [rawinput1113898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113900 {"message" (rawinput1113898 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113900 ["message"]))}))))

(clojure.core/defn- response-update-records-response ([input] (response-update-records-response nil input)) ([resultWrapper1113902 input] (clojure.core/let [rawinput1113901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113903 {"Records" (rawinput1113901 "Records")}] (clojure.core/cond-> {} (letvar1113903 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar1113903 ["Records"])))))))

(clojure.core/defn- response-delete-dataset-response ([input] (response-delete-dataset-response nil input)) ([resultWrapper1113905 input] (clojure.core/let [rawinput1113904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113906 {"Dataset" (rawinput1113904 "Dataset")}] (clojure.core/cond-> {} (letvar1113906 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar1113906 ["Dataset"])))))))

(clojure.core/defn- response-get-bulk-publish-details-response ([input] (response-get-bulk-publish-details-response nil input)) ([resultWrapper1113908 input] (clojure.core/let [rawinput1113907 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113909 {"IdentityPoolId" (rawinput1113907 "IdentityPoolId"), "BulkPublishStartTime" (rawinput1113907 "BulkPublishStartTime"), "BulkPublishCompleteTime" (rawinput1113907 "BulkPublishCompleteTime"), "BulkPublishStatus" (rawinput1113907 "BulkPublishStatus"), "FailureMessage" (rawinput1113907 "FailureMessage")}] (clojure.core/cond-> {} (letvar1113909 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1113909 ["IdentityPoolId"]))) (letvar1113909 "BulkPublishStartTime") (clojure.core/assoc :bulk-publish-start-time (deser-date (clojure.core/get-in letvar1113909 ["BulkPublishStartTime"]))) (letvar1113909 "BulkPublishCompleteTime") (clojure.core/assoc :bulk-publish-complete-time (deser-date (clojure.core/get-in letvar1113909 ["BulkPublishCompleteTime"]))) (letvar1113909 "BulkPublishStatus") (clojure.core/assoc :bulk-publish-status (deser-bulk-publish-status (clojure.core/get-in letvar1113909 ["BulkPublishStatus"]))) (letvar1113909 "FailureMessage") (clojure.core/assoc :failure-message (deser-string (clojure.core/get-in letvar1113909 ["FailureMessage"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1113911 input] (clojure.core/let [rawinput1113910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113912 {"message" (rawinput1113910 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113912 ["message"]))}))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1113914 input] (clojure.core/let [rawinput1113913 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113915 {"message" (rawinput1113913 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113915 ["message"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1113917 input] (clojure.core/let [rawinput1113916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113918 {"message" (rawinput1113916 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113918 ["message"]))}))))

(clojure.core/defn- response-get-cognito-events-response ([input] (response-get-cognito-events-response nil input)) ([resultWrapper1113920 input] (clojure.core/let [rawinput1113919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113921 {"Events" (rawinput1113919 "Events")}] (clojure.core/cond-> {} (letvar1113921 "Events") (clojure.core/assoc :events (deser-events (clojure.core/get-in letvar1113921 ["Events"])))))))

(clojure.core/defn- response-lambda-throttled-exception ([input] (response-lambda-throttled-exception nil input)) ([resultWrapper1113923 input] (clojure.core/let [rawinput1113922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113924 {"message" (rawinput1113922 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113924 ["message"]))}))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper1113926 input] (clojure.core/let [rawinput1113925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113927 {"Dataset" (rawinput1113925 "Dataset")}] (clojure.core/cond-> {} (letvar1113927 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar1113927 ["Dataset"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1113929 input] (clojure.core/let [rawinput1113928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113930 {"message" (rawinput1113928 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113930 ["message"]))}))))

(clojure.core/defn- response-invalid-lambda-function-output-exception ([input] (response-invalid-lambda-function-output-exception nil input)) ([resultWrapper1113932 input] (clojure.core/let [rawinput1113931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113933 {"message" (rawinput1113931 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113933 ["message"]))}))))

(clojure.core/defn- response-get-identity-pool-configuration-response ([input] (response-get-identity-pool-configuration-response nil input)) ([resultWrapper1113935 input] (clojure.core/let [rawinput1113934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113936 {"IdentityPoolId" (rawinput1113934 "IdentityPoolId"), "PushSync" (rawinput1113934 "PushSync"), "CognitoStreams" (rawinput1113934 "CognitoStreams")}] (clojure.core/cond-> {} (letvar1113936 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1113936 ["IdentityPoolId"]))) (letvar1113936 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar1113936 ["PushSync"]))) (letvar1113936 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar1113936 ["CognitoStreams"])))))))

(clojure.core/defn- response-list-records-response ([input] (response-list-records-response nil input)) ([resultWrapper1113938 input] (clojure.core/let [rawinput1113937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113939 {"SyncSessionToken" (rawinput1113937 "SyncSessionToken"), "DatasetSyncCount" (rawinput1113937 "DatasetSyncCount"), "Count" (rawinput1113937 "Count"), "NextToken" (rawinput1113937 "NextToken"), "DatasetExists" (rawinput1113937 "DatasetExists"), "DatasetDeletedAfterRequestedSyncCount" (rawinput1113937 "DatasetDeletedAfterRequestedSyncCount"), "MergedDatasetNames" (rawinput1113937 "MergedDatasetNames"), "Records" (rawinput1113937 "Records"), "LastModifiedBy" (rawinput1113937 "LastModifiedBy")}] (clojure.core/cond-> {} (letvar1113939 "SyncSessionToken") (clojure.core/assoc :sync-session-token (deser-string (clojure.core/get-in letvar1113939 ["SyncSessionToken"]))) (letvar1113939 "DatasetSyncCount") (clojure.core/assoc :dataset-sync-count (deser-long (clojure.core/get-in letvar1113939 ["DatasetSyncCount"]))) (letvar1113939 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar1113939 ["Count"]))) (letvar1113939 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1113939 ["NextToken"]))) (letvar1113939 "DatasetExists") (clojure.core/assoc :dataset-exists (deser-boolean (clojure.core/get-in letvar1113939 ["DatasetExists"]))) (letvar1113939 "DatasetDeletedAfterRequestedSyncCount") (clojure.core/assoc :dataset-deleted-after-requested-sync-count (deser-boolean (clojure.core/get-in letvar1113939 ["DatasetDeletedAfterRequestedSyncCount"]))) (letvar1113939 "MergedDatasetNames") (clojure.core/assoc :merged-dataset-names (deser-merged-dataset-name-list (clojure.core/get-in letvar1113939 ["MergedDatasetNames"]))) (letvar1113939 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar1113939 ["Records"]))) (letvar1113939 "LastModifiedBy") (clojure.core/assoc :last-modified-by (deser-string (clojure.core/get-in letvar1113939 ["LastModifiedBy"])))))))

(clojure.core/defn- response-subscribe-to-dataset-response ([input] (response-subscribe-to-dataset-response nil input)) ([resultWrapper1113941 input] (clojure.core/let [rawinput1113940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113942 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bulk-publish-response ([input] (response-bulk-publish-response nil input)) ([resultWrapper1113944 input] (clojure.core/let [rawinput1113943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113945 {"IdentityPoolId" (rawinput1113943 "IdentityPoolId")}] (clojure.core/cond-> {} (letvar1113945 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1113945 ["IdentityPoolId"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1113947 input] (clojure.core/let [rawinput1113946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113948 {"message" (rawinput1113946 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1113948 ["message"]))}))))

(clojure.core/defn- response-list-identity-pool-usage-response ([input] (response-list-identity-pool-usage-response nil input)) ([resultWrapper1113950 input] (clojure.core/let [rawinput1113949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113951 {"IdentityPoolUsages" (rawinput1113949 "IdentityPoolUsages"), "MaxResults" (rawinput1113949 "MaxResults"), "Count" (rawinput1113949 "Count"), "NextToken" (rawinput1113949 "NextToken")}] (clojure.core/cond-> {} (letvar1113951 "IdentityPoolUsages") (clojure.core/assoc :identity-pool-usages (deser-identity-pool-usage-list (clojure.core/get-in letvar1113951 ["IdentityPoolUsages"]))) (letvar1113951 "MaxResults") (clojure.core/assoc :max-results (deser-integer (clojure.core/get-in letvar1113951 ["MaxResults"]))) (letvar1113951 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar1113951 ["Count"]))) (letvar1113951 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1113951 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1113953 input] (clojure.core/let [rawinput1113952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113954 {"message" (rawinput1113952 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113954 ["message"]))}))))

(clojure.core/defn- response-register-device-response ([input] (response-register-device-response nil input)) ([resultWrapper1113956 input] (clojure.core/let [rawinput1113955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113957 {"DeviceId" (rawinput1113955 "DeviceId")}] (clojure.core/cond-> {} (letvar1113957 "DeviceId") (clojure.core/assoc :device-id (deser-device-id (clojure.core/get-in letvar1113957 ["DeviceId"])))))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper1113959 input] (clojure.core/let [rawinput1113958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113960 {"Datasets" (rawinput1113958 "Datasets"), "Count" (rawinput1113958 "Count"), "NextToken" (rawinput1113958 "NextToken")}] (clojure.core/cond-> {} (letvar1113960 "Datasets") (clojure.core/assoc :datasets (deser-dataset-list (clojure.core/get-in letvar1113960 ["Datasets"]))) (letvar1113960 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar1113960 ["Count"]))) (letvar1113960 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1113960 ["NextToken"])))))))

(clojure.core/defn- response-invalid-configuration-exception ([input] (response-invalid-configuration-exception nil input)) ([resultWrapper1113962 input] (clojure.core/let [rawinput1113961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1113963 {"message" (rawinput1113961 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1113963 ["message"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/record-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/application-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"arn:aws:sns:[-0-9a-z]+:\d+:app/[A-Z_]+/[a-zA-Z0-9_.-]+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-sync/sync-session-token (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cognito-sync/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.:-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 55)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/identity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 55)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync/record-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1048575))))
