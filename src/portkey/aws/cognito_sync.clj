...
(clojure.core/defn list-records "Gets paginated records, optionally changed after a particular sync count for a dataset and identity. With Amazon Cognito Sync, each identity has access only to its own data. Thus, the credentials used to make this API call need to have access to the identity data.\n ListRecords can be called with temporary user credentials provided by Cognito Identity or with developer credentials. You should use Cognito Identity credentials to make this API call.\n" ([list-records-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/records" list-records-request :portkey.aws.cognito-sync/list-records-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId", "IdentityId" "IdentityId", "DatasetName" "DatasetName"}, :querystring {"lastSyncCount" "LastSyncCount", "nextToken" "NextToken", "maxResults" "MaxResults", "syncSessionToken" "SyncSessionToken"}} 200 :portkey.aws.cognito-sync/list-records-response {"InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception})))
...
(clojure.core/defn describe-dataset "Gets meta data about a dataset by identity and dataset name. With Amazon Cognito Sync, each identity has access only to its own data. Thus, the credentials used to make this API call need to have access to the identity data.\n This API can be called with temporary user credentials provided by Cognito Identity or with developer credentials. You should use Cognito Identity credentials to make this API call.\n" ([describe-dataset-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}" describe-dataset-request :portkey.aws.cognito-sync/describe-dataset-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId", "IdentityId" "IdentityId", "DatasetName" "DatasetName"}, :querystring {}} 200 :portkey.aws.cognito-sync/describe-dataset-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn get-cognito-events "Gets the events and the corresponding Lambda functions associated with an identity pool.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([get-cognito-events-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools/{IdentityPoolId}/events" get-cognito-events-request :portkey.aws.cognito-sync/get-cognito-events-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 :portkey.aws.cognito-sync/get-cognito-events-response {"InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn list-identity-pool-usage "Gets a list of identity pools registered with Cognito.\n ListIdentityPoolUsage can only be called with developer credentials. You cannot make this API call with the temporary user credentials provided by Cognito Identity.\n" ([] (list-identity-pool-usage {})) ([list-identity-pool-usage-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools" list-identity-pool-usage-request :portkey.aws.cognito-sync/list-identity-pool-usage-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"nextToken" "NextToken", "maxResults" "MaxResults"}} 200 :portkey.aws.cognito-sync/list-identity-pool-usage-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn describe-identity-pool-usage "Gets usage details (for example, data storage) about a particular identity pool.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([describe-identity-pool-usage-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools/{IdentityPoolId}" describe-identity-pool-usage-request :portkey.aws.cognito-sync/describe-identity-pool-usage-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 :portkey.aws.cognito-sync/describe-identity-pool-usage-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn subscribe-to-dataset "Subscribes to receive notifications when a dataset is modified by another device.\n This API can only be called with temporary credentials provided by Cognito Identity. You cannot call this API with developer credentials.\n" ([subscribe-to-dataset-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "POST" "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}" subscribe-to-dataset-request :portkey.aws.cognito-sync/subscribe-to-dataset-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId", "IdentityId" "IdentityId", "DatasetName" "DatasetName", "DeviceId" "DeviceId"}, :querystring {}} 200 :portkey.aws.cognito-sync/subscribe-to-dataset-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "InvalidConfigurationException" :portkey.aws.cognito-sync/invalid-configuration-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn get-identity-pool-configuration "Gets the configuration settings of an identity pool.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([get-identity-pool-configuration-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "GET" "/identitypools/{IdentityPoolId}/configuration" get-identity-pool-configuration-request :portkey.aws.cognito-sync/get-identity-pool-configuration-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 :portkey.aws.cognito-sync/get-identity-pool-configuration-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn set-cognito-events "Sets the AWS Lambda function for a given event type for an identity pool. This request only updates the key/value pair specified. Other key/values pairs are not updated. To remove a key value pair, pass a empty value for the particular key.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([set-cognito-events-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "POST" "/identitypools/{IdentityPoolId}/events" set-cognito-events-request :portkey.aws.cognito-sync/set-cognito-events-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 nil {"InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception})))
...
(clojure.core/defn set-identity-pool-configuration "Sets the necessary configuration for push sync.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([set-identity-pool-configuration-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "POST" "/identitypools/{IdentityPoolId}/configuration" set-identity-pool-configuration-request :portkey.aws.cognito-sync/set-identity-pool-configuration-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 :portkey.aws.cognito-sync/set-identity-pool-configuration-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception, "ConcurrentModificationException" :portkey.aws.cognito-sync/concurrent-modification-exception})))
...
(clojure.core/defn update-records "Posts updates to records and adds and deletes records for a dataset and user.\n The sync count in the record patch is your last known sync count for that record. The server will reject an UpdateRecords request with a ResourceConflictException if you try to patch a record with a new value but a stale sync count.\n For example, if the sync count on the server is 5 for a key called highScore and you try and submit a new highScore with sync count of 4, the request will be rejected. To obtain the current sync count for a record, call ListRecords. On a successful update of the record, the response returns the new sync count for that record. You should present that sync count the next time you try to update that same record. When the record does not exist, specify the sync count as 0.\n This API can be called with temporary user credentials provided by Cognito Identity or with developer credentials.\n" ([update-records-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "POST" "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}" update-records-request :portkey.aws.cognito-sync/update-records-request {:payload nil, :move {}, :headers {"ClientContext" ["x-amz-Client-Context" nil]}, :uri {"IdentityPoolId" "IdentityPoolId", "IdentityId" "IdentityId", "DatasetName" "DatasetName"}, :querystring {}} 200 :portkey.aws.cognito-sync/update-records-response {"LimitExceededException" :portkey.aws.cognito-sync/limit-exceeded-exception, "NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "TooManyRequestsException" :portkey.aws.cognito-sync/too-many-requests-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "LambdaThrottledException" :portkey.aws.cognito-sync/lambda-throttled-exception, "ResourceConflictException" :portkey.aws.cognito-sync/resource-conflict-exception, "InvalidLambdaFunctionOutputException" :portkey.aws.cognito-sync/invalid-lambda-function-output-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception})))
...
(clojure.core/defn bulk-publish "Initiates a bulk publish of all existing datasets for an Identity Pool to the configured stream. Customers are limited to one successful bulk publish per 24 hours. Bulk publish is an asynchronous request, customers can see the status of the request via the GetBulkPublishDetails operation.\n This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.\n" ([bulk-publish-request] (portkey.aws/-rest-json-call portkey.aws.cognito-sync/endpoints "POST" "/identitypools/{IdentityPoolId}/bulkpublish" bulk-publish-request :portkey.aws.cognito-sync/bulk-publish-request {:payload nil, :move {}, :headers {}, :uri {"IdentityPoolId" "IdentityPoolId"}, :querystring {}} 200 :portkey.aws.cognito-sync/bulk-publish-response {"NotAuthorizedException" :portkey.aws.cognito-sync/not-authorized-exception, "InvalidParameterException" :portkey.aws.cognito-sync/invalid-parameter-exception, "ResourceNotFoundException" :portkey.aws.cognito-sync/resource-not-found-exception, "InternalErrorException" :portkey.aws.cognito-sync/internal-error-exception, "DuplicateRequestException" :portkey.aws.cognito-sync/duplicate-request-exception, "AlreadyStreamedException" :portkey.aws.cognito-sync/already-streamed-exception})))
