...
(clojure.core/defn- response-list-tasks-response ([input] (response-list-tasks-response nil input)) ([resultWrapper1611023 input] (clojure.core/let [rawinput1611022 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611024 {"Tasks" (rawinput1611022 "Tasks"), "NextToken" (rawinput1611022 "NextToken")}] (clojure.core/cond-> {} (letvar1611024 "Tasks") (clojure.core/assoc :tasks (deser-task-list (clojure.core/get-in letvar1611024 ["Tasks"]))) (letvar1611024 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1611024 ["NextToken"])))))))

(clojure.core/defn- response-describe-task-response ([input] (response-describe-task-response nil input)) ([resultWrapper1611026 input] (clojure.core/let [rawinput1611025 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611027 {"CloudWatchLogGroupArn" (rawinput1611025 "CloudWatchLogGroupArn"), "CurrentTaskExecutionArn" (rawinput1611025 "CurrentTaskExecutionArn"), "Status" (rawinput1611025 "Status"), "ErrorDetail" (rawinput1611025 "ErrorDetail"), "TaskArn" (rawinput1611025 "TaskArn"), "ErrorCode" (rawinput1611025 "ErrorCode"), "CreationTime" (rawinput1611025 "CreationTime"), "SourceLocationArn" (rawinput1611025 "SourceLocationArn"), "DestinationLocationArn" (rawinput1611025 "DestinationLocationArn"), "Name" (rawinput1611025 "Name"), "Options" (rawinput1611025 "Options")}] (clojure.core/cond-> {} (letvar1611027 "CloudWatchLogGroupArn") (clojure.core/assoc :cloud-watch-log-group-arn (deser-log-group-arn (clojure.core/get-in letvar1611027 ["CloudWatchLogGroupArn"]))) (letvar1611027 "CurrentTaskExecutionArn") (clojure.core/assoc :current-task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar1611027 ["CurrentTaskExecutionArn"]))) (letvar1611027 "Status") (clojure.core/assoc :status (deser-task-status (clojure.core/get-in letvar1611027 ["Status"]))) (letvar1611027 "ErrorDetail") (clojure.core/assoc :error-detail (deserstring (clojure.core/get-in letvar1611027 ["ErrorDetail"]))) (letvar1611027 "TaskArn") (clojure.core/assoc :task-arn (deser-task-arn (clojure.core/get-in letvar1611027 ["TaskArn"]))) (letvar1611027 "ErrorCode") (clojure.core/assoc :error-code (deserstring (clojure.core/get-in letvar1611027 ["ErrorCode"]))) (letvar1611027 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar1611027 ["CreationTime"]))) (letvar1611027 "SourceLocationArn") (clojure.core/assoc :source-location-arn (deser-location-arn (clojure.core/get-in letvar1611027 ["SourceLocationArn"]))) (letvar1611027 "DestinationLocationArn") (clojure.core/assoc :destination-location-arn (deser-location-arn (clojure.core/get-in letvar1611027 ["DestinationLocationArn"]))) (letvar1611027 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar1611027 ["Name"]))) (letvar1611027 "Options") (clojure.core/assoc :options (deser-options (clojure.core/get-in letvar1611027 ["Options"])))))))

(clojure.core/defn- response-describe-agent-response ([input] (response-describe-agent-response nil input)) ([resultWrapper1611029 input] (clojure.core/let [rawinput1611028 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611030 {"AgentArn" (rawinput1611028 "AgentArn"), "Name" (rawinput1611028 "Name"), "Status" (rawinput1611028 "Status"), "LastConnectionTime" (rawinput1611028 "LastConnectionTime"), "CreationTime" (rawinput1611028 "CreationTime")}] (clojure.core/cond-> {} (letvar1611030 "AgentArn") (clojure.core/assoc :agent-arn (deser-agent-arn (clojure.core/get-in letvar1611030 ["AgentArn"]))) (letvar1611030 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar1611030 ["Name"]))) (letvar1611030 "Status") (clojure.core/assoc :status (deser-agent-status (clojure.core/get-in letvar1611030 ["Status"]))) (letvar1611030 "LastConnectionTime") (clojure.core/assoc :last-connection-time (deser-time (clojure.core/get-in letvar1611030 ["LastConnectionTime"]))) (letvar1611030 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar1611030 ["CreationTime"])))))))

(clojure.core/defn- response-cancel-task-execution-response ([input] (response-cancel-task-execution-response nil input)) ([resultWrapper1611032 input] (clojure.core/let [rawinput1611031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611033 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-task-execution-response ([input] (response-describe-task-execution-response nil input)) ([resultWrapper1611035 input] (clojure.core/let [rawinput1611034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611036 {"BytesTransferred" (rawinput1611034 "BytesTransferred"), "StartTime" (rawinput1611034 "StartTime"), "TaskExecutionArn" (rawinput1611034 "TaskExecutionArn"), "Result" (rawinput1611034 "Result"), "Status" (rawinput1611034 "Status"), "BytesWritten" (rawinput1611034 "BytesWritten"), "EstimatedFilesToTransfer" (rawinput1611034 "EstimatedFilesToTransfer"), "EstimatedBytesToTransfer" (rawinput1611034 "EstimatedBytesToTransfer"), "FilesTransferred" (rawinput1611034 "FilesTransferred"), "Options" (rawinput1611034 "Options")}] (clojure.core/cond-> {} (letvar1611036 "BytesTransferred") (clojure.core/assoc :bytes-transferred (deserlong (clojure.core/get-in letvar1611036 ["BytesTransferred"]))) (letvar1611036 "StartTime") (clojure.core/assoc :start-time (deser-time (clojure.core/get-in letvar1611036 ["StartTime"]))) (letvar1611036 "TaskExecutionArn") (clojure.core/assoc :task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar1611036 ["TaskExecutionArn"]))) (letvar1611036 "Result") (clojure.core/assoc :result (deser-task-execution-result-detail (clojure.core/get-in letvar1611036 ["Result"]))) (letvar1611036 "Status") (clojure.core/assoc :status (deser-task-execution-status (clojure.core/get-in letvar1611036 ["Status"]))) (letvar1611036 "BytesWritten") (clojure.core/assoc :bytes-written (deserlong (clojure.core/get-in letvar1611036 ["BytesWritten"]))) (letvar1611036 "EstimatedFilesToTransfer") (clojure.core/assoc :estimated-files-to-transfer (deserlong (clojure.core/get-in letvar1611036 ["EstimatedFilesToTransfer"]))) (letvar1611036 "EstimatedBytesToTransfer") (clojure.core/assoc :estimated-bytes-to-transfer (deserlong (clojure.core/get-in letvar1611036 ["EstimatedBytesToTransfer"]))) (letvar1611036 "FilesTransferred") (clojure.core/assoc :files-transferred (deserlong (clojure.core/get-in letvar1611036 ["FilesTransferred"]))) (letvar1611036 "Options") (clojure.core/assoc :options (deser-options (clojure.core/get-in letvar1611036 ["Options"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1611038 input] (clojure.core/let [rawinput1611037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611039 {"message" (rawinput1611037 "message"), "errorCode" (rawinput1611037 "errorCode")}] (clojure.core/cond-> {} (letvar1611039 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1611039 ["message"]))) (letvar1611039 "errorCode") (clojure.core/assoc :error-code (deserstring (clojure.core/get-in letvar1611039 ["errorCode"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1611041 input] (clojure.core/let [rawinput1611040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611042 {"Tags" (rawinput1611040 "Tags"), "NextToken" (rawinput1611040 "NextToken")}] (clojure.core/cond-> {} (letvar1611042 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1611042 ["Tags"]))) (letvar1611042 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1611042 ["NextToken"])))))))

(clojure.core/defn- response-describe-location-efs-response ([input] (response-describe-location-efs-response nil input)) ([resultWrapper1611044 input] (clojure.core/let [rawinput1611043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611045 {"LocationArn" (rawinput1611043 "LocationArn"), "LocationUri" (rawinput1611043 "LocationUri"), "Ec2Config" (rawinput1611043 "Ec2Config"), "CreationTime" (rawinput1611043 "CreationTime")}] (clojure.core/cond-> {} (letvar1611045 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611045 ["LocationArn"]))) (letvar1611045 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar1611045 ["LocationUri"]))) (letvar1611045 "Ec2Config") (clojure.core/assoc :ec-2-config (deser-ec-2-config (clojure.core/get-in letvar1611045 ["Ec2Config"]))) (letvar1611045 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar1611045 ["CreationTime"])))))))

(clojure.core/defn- response-create-agent-response ([input] (response-create-agent-response nil input)) ([resultWrapper1611047 input] (clojure.core/let [rawinput1611046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611048 {"AgentArn" (rawinput1611046 "AgentArn")}] (clojure.core/cond-> {} (letvar1611048 "AgentArn") (clojure.core/assoc :agent-arn (deser-agent-arn (clojure.core/get-in letvar1611048 ["AgentArn"])))))))

(clojure.core/defn- response-list-locations-response ([input] (response-list-locations-response nil input)) ([resultWrapper1611050 input] (clojure.core/let [rawinput1611049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611051 {"Locations" (rawinput1611049 "Locations"), "NextToken" (rawinput1611049 "NextToken")}] (clojure.core/cond-> {} (letvar1611051 "Locations") (clojure.core/assoc :locations (deser-location-list (clojure.core/get-in letvar1611051 ["Locations"]))) (letvar1611051 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1611051 ["NextToken"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1611053 input] (clojure.core/let [rawinput1611052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611054 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-location-s-3-response ([input] (response-describe-location-s-3-response nil input)) ([resultWrapper1611056 input] (clojure.core/let [rawinput1611055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611057 {"LocationArn" (rawinput1611055 "LocationArn"), "LocationUri" (rawinput1611055 "LocationUri"), "S3Config" (rawinput1611055 "S3Config"), "CreationTime" (rawinput1611055 "CreationTime")}] (clojure.core/cond-> {} (letvar1611057 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611057 ["LocationArn"]))) (letvar1611057 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar1611057 ["LocationUri"]))) (letvar1611057 "S3Config") (clojure.core/assoc :s-3-config (deser-s-3-config (clojure.core/get-in letvar1611057 ["S3Config"]))) (letvar1611057 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar1611057 ["CreationTime"])))))))

(clojure.core/defn- response-update-agent-response ([input] (response-update-agent-response nil input)) ([resultWrapper1611059 input] (clojure.core/let [rawinput1611058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611060 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-task-response ([input] (response-update-task-response nil input)) ([resultWrapper1611062 input] (clojure.core/let [rawinput1611061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611063 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-task-execution-response ([input] (response-start-task-execution-response nil input)) ([resultWrapper1611065 input] (clojure.core/let [rawinput1611064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611066 {"TaskExecutionArn" (rawinput1611064 "TaskExecutionArn")}] (clojure.core/cond-> {} (letvar1611066 "TaskExecutionArn") (clojure.core/assoc :task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar1611066 ["TaskExecutionArn"])))))))

(clojure.core/defn- response-create-task-response ([input] (response-create-task-response nil input)) ([resultWrapper1611068 input] (clojure.core/let [rawinput1611067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611069 {"TaskArn" (rawinput1611067 "TaskArn")}] (clojure.core/cond-> {} (letvar1611069 "TaskArn") (clojure.core/assoc :task-arn (deser-task-arn (clojure.core/get-in letvar1611069 ["TaskArn"])))))))

(clojure.core/defn- response-delete-agent-response ([input] (response-delete-agent-response nil input)) ([resultWrapper1611071 input] (clojure.core/let [rawinput1611070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611072 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-location-response ([input] (response-delete-location-response nil input)) ([resultWrapper1611074 input] (clojure.core/let [rawinput1611073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611075 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-task-executions-response ([input] (response-list-task-executions-response nil input)) ([resultWrapper1611077 input] (clojure.core/let [rawinput1611076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611078 {"TaskExecutions" (rawinput1611076 "TaskExecutions"), "NextToken" (rawinput1611076 "NextToken")}] (clojure.core/cond-> {} (letvar1611078 "TaskExecutions") (clojure.core/assoc :task-executions (deser-task-execution-list (clojure.core/get-in letvar1611078 ["TaskExecutions"]))) (letvar1611078 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1611078 ["NextToken"])))))))

(clojure.core/defn- response-delete-task-response ([input] (response-delete-task-response nil input)) ([resultWrapper1611080 input] (clojure.core/let [rawinput1611079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611081 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-agents-response ([input] (response-list-agents-response nil input)) ([resultWrapper1611083 input] (clojure.core/let [rawinput1611082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611084 {"Agents" (rawinput1611082 "Agents"), "NextToken" (rawinput1611082 "NextToken")}] (clojure.core/cond-> {} (letvar1611084 "Agents") (clojure.core/assoc :agents (deser-agent-list (clojure.core/get-in letvar1611084 ["Agents"]))) (letvar1611084 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1611084 ["NextToken"])))))))

(clojure.core/defn- response-create-location-s-3-response ([input] (response-create-location-s-3-response nil input)) ([resultWrapper1611086 input] (clojure.core/let [rawinput1611085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611087 {"LocationArn" (rawinput1611085 "LocationArn")}] (clojure.core/cond-> {} (letvar1611087 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611087 ["LocationArn"])))))))

(clojure.core/defn- response-describe-location-nfs-response ([input] (response-describe-location-nfs-response nil input)) ([resultWrapper1611089 input] (clojure.core/let [rawinput1611088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611090 {"LocationArn" (rawinput1611088 "LocationArn"), "LocationUri" (rawinput1611088 "LocationUri"), "OnPremConfig" (rawinput1611088 "OnPremConfig"), "CreationTime" (rawinput1611088 "CreationTime")}] (clojure.core/cond-> {} (letvar1611090 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611090 ["LocationArn"]))) (letvar1611090 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar1611090 ["LocationUri"]))) (letvar1611090 "OnPremConfig") (clojure.core/assoc :on-prem-config (deser-on-prem-config (clojure.core/get-in letvar1611090 ["OnPremConfig"]))) (letvar1611090 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar1611090 ["CreationTime"])))))))

(clojure.core/defn- response-create-location-nfs-response ([input] (response-create-location-nfs-response nil input)) ([resultWrapper1611092 input] (clojure.core/let [rawinput1611091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611093 {"LocationArn" (rawinput1611091 "LocationArn")}] (clojure.core/cond-> {} (letvar1611093 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611093 ["LocationArn"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1611095 input] (clojure.core/let [rawinput1611094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611096 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-location-efs-response ([input] (response-create-location-efs-response nil input)) ([resultWrapper1611098 input] (clojure.core/let [rawinput1611097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1611099 {"LocationArn" (rawinput1611097 "LocationArn")}] (clojure.core/cond-> {} (letvar1611099 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar1611099 ["LocationArn"])))))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/ec-2-subnet-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):ec2:[a-z\-0-9]*:[0-9]{12}:subnet/.*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/location-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]+:[0-9]{12}:location/loc-[0-9a-z]{17}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/subdirectory (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-\./]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/task-execution-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]*:[0-9]{12}:task/task-[0-9a-f]{17}/execution/exec-[0-9a-f]{17}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9\s+=._:/-]{1,128}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/log-group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 562)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):logs:[a-z\-0-9]*:[0-9]{12}:log-group:([^:\*]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 93)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=_-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/activation-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 29)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Z0-9]{5}(-[A-Z0-9]{5}){4}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/task-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]*:[0-9]{12}:task/task-[0-9a-f]{17}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9\s+=._:/-]{1,256}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/agent-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]+:[0-9]{12}:agent/agent-[0-9a-z]{17}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/s-3-bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 76)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):s3:::([^/]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/location-uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(efs|nfs|s3)://[a-zA-Z0-9.\-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/taggable-resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]+:[0-9]{12}:(agent|task|location)/(agent|task|loc)-[0-9a-z]{17}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync.-2018-11-09/ec-2-security-group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):ec2:[a-z\-0-9]*:[0-9]{12}:security-group/.*$" s__1410940__auto__))))
