...
(clojure.core/defn- response-invalid-token-exception ([input] (response-invalid-token-exception nil input)) ([resultWrapper1368829 input] (clojure.core/let [rawinput1368828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368830 {"message" (rawinput1368828 "message")}] (clojure.core/cond-> {} (letvar1368830 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368830 ["message"])))))))

(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper1368832 input] (clojure.core/let [rawinput1368831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368833 {"message" (rawinput1368831 "message")}] (clojure.core/cond-> {} (letvar1368833 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368833 ["message"])))))))

(clojure.core/defn- response-invalid-product-code-exception ([input] (response-invalid-product-code-exception nil input)) ([resultWrapper1368835 input] (clojure.core/let [rawinput1368834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368836 {"message" (rawinput1368834 "message")}] (clojure.core/cond-> {} (letvar1368836 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368836 ["message"])))))))

(clojure.core/defn- response-customer-not-entitled-exception ([input] (response-customer-not-entitled-exception nil input)) ([resultWrapper1368838 input] (clojure.core/let [rawinput1368837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368839 {"message" (rawinput1368837 "message")}] (clojure.core/cond-> {} (letvar1368839 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368839 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1368841 input] (clojure.core/let [rawinput1368840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368842 {"message" (rawinput1368840 "message")}] (clojure.core/cond-> {} (letvar1368842 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368842 ["message"])))))))

(clojure.core/defn- response-invalid-usage-dimension-exception ([input] (response-invalid-usage-dimension-exception nil input)) ([resultWrapper1368844 input] (clojure.core/let [rawinput1368843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368845 {"message" (rawinput1368843 "message")}] (clojure.core/cond-> {} (letvar1368845 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368845 ["message"])))))))

(clojure.core/defn- response-platform-not-supported-exception ([input] (response-platform-not-supported-exception nil input)) ([resultWrapper1368847 input] (clojure.core/let [rawinput1368846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368848 {"message" (rawinput1368846 "message")}] (clojure.core/cond-> {} (letvar1368848 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368848 ["message"])))))))

(clojure.core/defn- response-disabled-api-exception ([input] (response-disabled-api-exception nil input)) ([resultWrapper1368850 input] (clojure.core/let [rawinput1368849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368851 {"message" (rawinput1368849 "message")}] (clojure.core/cond-> {} (letvar1368851 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368851 ["message"])))))))

(clojure.core/defn- response-invalid-customer-identifier-exception ([input] (response-invalid-customer-identifier-exception nil input)) ([resultWrapper1368853 input] (clojure.core/let [rawinput1368852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368854 {"message" (rawinput1368852 "message")}] (clojure.core/cond-> {} (letvar1368854 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368854 ["message"])))))))

(clojure.core/defn- response-batch-meter-usage-result ([input] (response-batch-meter-usage-result nil input)) ([resultWrapper1368856 input] (clojure.core/let [rawinput1368855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368857 {"Results" (rawinput1368855 "Results"), "UnprocessedRecords" (rawinput1368855 "UnprocessedRecords")}] (clojure.core/cond-> {} (letvar1368857 "Results") (clojure.core/assoc :results (deser-usage-record-result-list (clojure.core/get-in letvar1368857 ["Results"]))) (letvar1368857 "UnprocessedRecords") (clojure.core/assoc :unprocessed-records (deser-usage-record-list (clojure.core/get-in letvar1368857 ["UnprocessedRecords"])))))))

(clojure.core/defn- response-resolve-customer-result ([input] (response-resolve-customer-result nil input)) ([resultWrapper1368859 input] (clojure.core/let [rawinput1368858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368860 {"CustomerIdentifier" (rawinput1368858 "CustomerIdentifier"), "ProductCode" (rawinput1368858 "ProductCode")}] (clojure.core/cond-> {} (letvar1368860 "CustomerIdentifier") (clojure.core/assoc :customer-identifier (deser-customer-identifier (clojure.core/get-in letvar1368860 ["CustomerIdentifier"]))) (letvar1368860 "ProductCode") (clojure.core/assoc :product-code (deser-product-code (clojure.core/get-in letvar1368860 ["ProductCode"])))))))

(clojure.core/defn- response-register-usage-result ([input] (response-register-usage-result nil input)) ([resultWrapper1368862 input] (clojure.core/let [rawinput1368861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368863 {"PublicKeyRotationTimestamp" (rawinput1368861 "PublicKeyRotationTimestamp"), "Signature" (rawinput1368861 "Signature")}] (clojure.core/cond-> {} (letvar1368863 "PublicKeyRotationTimestamp") (clojure.core/assoc :public-key-rotation-timestamp (deser-timestamp (clojure.core/get-in letvar1368863 ["PublicKeyRotationTimestamp"]))) (letvar1368863 "Signature") (clojure.core/assoc :signature (deser-non-empty-string (clojure.core/get-in letvar1368863 ["Signature"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1368865 input] (clojure.core/let [rawinput1368864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368866 {"message" (rawinput1368864 "message")}] (clojure.core/cond-> {} (letvar1368866 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368866 ["message"])))))))

(clojure.core/defn- response-meter-usage-result ([input] (response-meter-usage-result nil input)) ([resultWrapper1368868 input] (clojure.core/let [rawinput1368867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368869 {"MeteringRecordId" (rawinput1368867 "MeteringRecordId")}] (clojure.core/cond-> {} (letvar1368869 "MeteringRecordId") (clojure.core/assoc :metering-record-id (deser-string (clojure.core/get-in letvar1368869 ["MeteringRecordId"])))))))

(clojure.core/defn- response-invalid-region-exception ([input] (response-invalid-region-exception nil input)) ([resultWrapper1368871 input] (clojure.core/let [rawinput1368870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368872 {"message" (rawinput1368870 "message")}] (clojure.core/cond-> {} (letvar1368872 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368872 ["message"])))))))

(clojure.core/defn- response-expired-token-exception ([input] (response-expired-token-exception nil input)) ([resultWrapper1368874 input] (clojure.core/let [rawinput1368873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368875 {"message" (rawinput1368873 "message")}] (clojure.core/cond-> {} (letvar1368875 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368875 ["message"])))))))

(clojure.core/defn- response-invalid-public-key-version-exception ([input] (response-invalid-public-key-version-exception nil input)) ([resultWrapper1368877 input] (clojure.core/let [rawinput1368876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368878 {"message" (rawinput1368876 "message")}] (clojure.core/cond-> {} (letvar1368878 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368878 ["message"])))))))

(clojure.core/defn- response-invalid-endpoint-region-exception ([input] (response-invalid-endpoint-region-exception nil input)) ([resultWrapper1368880 input] (clojure.core/let [rawinput1368879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368881 {"message" (rawinput1368879 "message")}] (clojure.core/cond-> {} (letvar1368881 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368881 ["message"])))))))

(clojure.core/defn- response-timestamp-out-of-bounds-exception ([input] (response-timestamp-out-of-bounds-exception nil input)) ([resultWrapper1368883 input] (clojure.core/let [rawinput1368882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1368884 {"message" (rawinput1368882 "message")}] (clojure.core/cond-> {} (letvar1368884 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1368884 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\S+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace/usage-dimension (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.meteringmarketplace/customer-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace/nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
