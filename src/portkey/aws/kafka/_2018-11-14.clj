...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1164221 input] (clojure.core/let [rawinput1164220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164222 {"invalidParameter" (rawinput1164220 "invalidParameter"), "message" (rawinput1164220 "message")}] (clojure.core/cond-> {} (letvar1164222 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164222 ["invalidParameter"]))) (letvar1164222 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164222 ["message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1164224 input] (clojure.core/let [rawinput1164223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164225 {"invalidParameter" (rawinput1164223 "invalidParameter"), "message" (rawinput1164223 "message")}] (clojure.core/cond-> {} (letvar1164225 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164225 ["invalidParameter"]))) (letvar1164225 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164225 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1164227 input] (clojure.core/let [rawinput1164226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164228 {"invalidParameter" (rawinput1164226 "invalidParameter"), "message" (rawinput1164226 "message")}] (clojure.core/cond-> {} (letvar1164228 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164228 ["invalidParameter"]))) (letvar1164228 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164228 ["message"])))))))

(clojure.core/defn- response-list-clusters-response ([input] (response-list-clusters-response nil input)) ([resultWrapper1164230 input] (clojure.core/let [rawinput1164229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164231 {"clusterInfoList" (rawinput1164229 "clusterInfoList"), "nextToken" (rawinput1164229 "nextToken")}] (clojure.core/cond-> {} (letvar1164231 "clusterInfoList") (clojure.core/assoc :cluster-info-list (deser-list-of-cluster-info (clojure.core/get-in letvar1164231 ["clusterInfoList"]))) (letvar1164231 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1164231 ["nextToken"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1164233 input] (clojure.core/let [rawinput1164232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164234 {"invalidParameter" (rawinput1164232 "invalidParameter"), "message" (rawinput1164232 "message")}] (clojure.core/cond-> {} (letvar1164234 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164234 ["invalidParameter"]))) (letvar1164234 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164234 ["message"])))))))

(clojure.core/defn- response-describe-cluster-response ([input] (response-describe-cluster-response nil input)) ([resultWrapper1164236 input] (clojure.core/let [rawinput1164235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164237 {"clusterInfo" (rawinput1164235 "clusterInfo")}] (clojure.core/cond-> {} (letvar1164237 "clusterInfo") (clojure.core/assoc :cluster-info (deser-cluster-info (clojure.core/get-in letvar1164237 ["clusterInfo"])))))))

(clojure.core/defn- response-get-bootstrap-brokers-response ([input] (response-get-bootstrap-brokers-response nil input)) ([resultWrapper1164239 input] (clojure.core/let [rawinput1164238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164240 {"bootstrapBrokerString" (rawinput1164238 "bootstrapBrokerString")}] (clojure.core/cond-> {} (letvar1164240 "bootstrapBrokerString") (clojure.core/assoc :bootstrap-broker-string (deser-string (clojure.core/get-in letvar1164240 ["bootstrapBrokerString"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1164242 input] (clojure.core/let [rawinput1164241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164243 {"invalidParameter" (rawinput1164241 "invalidParameter"), "message" (rawinput1164241 "message")}] (clojure.core/cond-> {} (letvar1164243 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164243 ["invalidParameter"]))) (letvar1164243 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164243 ["message"])))))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper1164245 input] (clojure.core/let [rawinput1164244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164246 {"clusterArn" (rawinput1164244 "clusterArn"), "state" (rawinput1164244 "state")}] (clojure.core/cond-> {} (letvar1164246 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1164246 ["clusterArn"]))) (letvar1164246 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1164246 ["state"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1164248 input] (clojure.core/let [rawinput1164247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164249 {"invalidParameter" (rawinput1164247 "invalidParameter"), "message" (rawinput1164247 "message")}] (clojure.core/cond-> {} (letvar1164249 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164249 ["invalidParameter"]))) (letvar1164249 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164249 ["message"])))))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper1164251 input] (clojure.core/let [rawinput1164250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164252 {"clusterArn" (rawinput1164250 "clusterArn"), "clusterName" (rawinput1164250 "clusterName"), "state" (rawinput1164250 "state")}] (clojure.core/cond-> {} (letvar1164252 "clusterArn") (clojure.core/assoc :cluster-arn (deser-string (clojure.core/get-in letvar1164252 ["clusterArn"]))) (letvar1164252 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar1164252 ["clusterName"]))) (letvar1164252 "state") (clojure.core/assoc :state (deser-cluster-state (clojure.core/get-in letvar1164252 ["state"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1164254 input] (clojure.core/let [rawinput1164253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164255 {"invalidParameter" (rawinput1164253 "invalidParameter"), "message" (rawinput1164253 "message")}] (clojure.core/cond-> {} (letvar1164255 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164255 ["invalidParameter"]))) (letvar1164255 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164255 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1164257 input] (clojure.core/let [rawinput1164256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164258 {"invalidParameter" (rawinput1164256 "invalidParameter"), "message" (rawinput1164256 "message")}] (clojure.core/cond-> {} (letvar1164258 "invalidParameter") (clojure.core/assoc :invalid-parameter (deser-string (clojure.core/get-in letvar1164258 ["invalidParameter"]))) (letvar1164258 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1164258 ["message"])))))))

(clojure.core/defn- response-list-nodes-response ([input] (response-list-nodes-response nil input)) ([resultWrapper1164260 input] (clojure.core/let [rawinput1164259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1164261 {"nextToken" (rawinput1164259 "nextToken"), "nodeInfoList" (rawinput1164259 "nodeInfoList")}] (clojure.core/cond-> {} (letvar1164261 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1164261 ["nextToken"]))) (letvar1164261 "nodeInfoList") (clojure.core/assoc :node-info-list (deser-list-of-node-info (clojure.core/get-in letvar1164261 ["nodeInfoList"])))))))

(clojure.spec.alpha/def :portkey.aws.kafka.-2018-11-14/string-min-1-max-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kafka.-2018-11-14/string-min-1-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.kafka.-2018-11-14/string-min-5-max-32 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
