...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1438352 input] (clojure.core/let [rawinput1438351 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438353 {"Message" (rawinput1438351 "Message")}] (clojure.core/cond-> {} (letvar1438353 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438353 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-policy-response ([input] (response-delete-scaling-policy-response nil input)) ([resultWrapper1438355 input] (clojure.core/let [rawinput1438354 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438356 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-scheduled-action-response ([input] (response-put-scheduled-action-response nil input)) ([resultWrapper1438358 input] (clojure.core/let [rawinput1438357 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438359 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-policies-response ([input] (response-describe-scaling-policies-response nil input)) ([resultWrapper1438361 input] (clojure.core/let [rawinput1438360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438362 {"ScalingPolicies" (rawinput1438360 "ScalingPolicies"), "NextToken" (rawinput1438360 "NextToken")}] (clojure.core/cond-> {} (letvar1438362 "ScalingPolicies") (clojure.core/assoc :scaling-policies (deser-scaling-policies (clojure.core/get-in letvar1438362 ["ScalingPolicies"]))) (letvar1438362 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1438362 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1438364 input] (clojure.core/let [rawinput1438363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438365 {"Message" (rawinput1438363 "Message")}] (clojure.core/cond-> {} (letvar1438365 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438365 ["Message"])))))))

(clojure.core/defn- response-failed-resource-access-exception ([input] (response-failed-resource-access-exception nil input)) ([resultWrapper1438367 input] (clojure.core/let [rawinput1438366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438368 {"Message" (rawinput1438366 "Message")}] (clojure.core/cond-> {} (letvar1438368 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438368 ["Message"])))))))

(clojure.core/defn- response-register-scalable-target-response ([input] (response-register-scalable-target-response nil input)) ([resultWrapper1438370 input] (clojure.core/let [rawinput1438369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438371 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1438373 input] (clojure.core/let [rawinput1438372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438374 {"Message" (rawinput1438372 "Message")}] (clojure.core/cond-> {} (letvar1438374 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438374 ["Message"])))))))

(clojure.core/defn- response-describe-scheduled-actions-response ([input] (response-describe-scheduled-actions-response nil input)) ([resultWrapper1438376 input] (clojure.core/let [rawinput1438375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438377 {"ScheduledActions" (rawinput1438375 "ScheduledActions"), "NextToken" (rawinput1438375 "NextToken")}] (clojure.core/cond-> {} (letvar1438377 "ScheduledActions") (clojure.core/assoc :scheduled-actions (deser-scheduled-actions (clojure.core/get-in letvar1438377 ["ScheduledActions"]))) (letvar1438377 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1438377 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper1438379 input] (clojure.core/let [rawinput1438378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438380 {"Message" (rawinput1438378 "Message")}] (clojure.core/cond-> {} (letvar1438380 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438380 ["Message"])))))))

(clojure.core/defn- response-delete-scheduled-action-response ([input] (response-delete-scheduled-action-response nil input)) ([resultWrapper1438382 input] (clojure.core/let [rawinput1438381 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438383 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-activities-response ([input] (response-describe-scaling-activities-response nil input)) ([resultWrapper1438385 input] (clojure.core/let [rawinput1438384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438386 {"ScalingActivities" (rawinput1438384 "ScalingActivities"), "NextToken" (rawinput1438384 "NextToken")}] (clojure.core/cond-> {} (letvar1438386 "ScalingActivities") (clojure.core/assoc :scaling-activities (deser-scaling-activities (clojure.core/get-in letvar1438386 ["ScalingActivities"]))) (letvar1438386 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1438386 ["NextToken"])))))))

(clojure.core/defn- response-describe-scalable-targets-response ([input] (response-describe-scalable-targets-response nil input)) ([resultWrapper1438388 input] (clojure.core/let [rawinput1438387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438389 {"ScalableTargets" (rawinput1438387 "ScalableTargets"), "NextToken" (rawinput1438387 "NextToken")}] (clojure.core/cond-> {} (letvar1438389 "ScalableTargets") (clojure.core/assoc :scalable-targets (deser-scalable-targets (clojure.core/get-in letvar1438389 ["ScalableTargets"]))) (letvar1438389 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1438389 ["NextToken"])))))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1438391 input] (clojure.core/let [rawinput1438390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438392 {"Message" (rawinput1438390 "Message")}] (clojure.core/cond-> {} (letvar1438392 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438392 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1438394 input] (clojure.core/let [rawinput1438393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438395 {"Message" (rawinput1438393 "Message")}] (clojure.core/cond-> {} (letvar1438395 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1438395 ["Message"])))))))

(clojure.core/defn- response-deregister-scalable-target-response ([input] (response-deregister-scalable-target-response nil input)) ([resultWrapper1438397 input] (clojure.core/let [rawinput1438396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438398 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-scaling-policy-response ([input] (response-put-scaling-policy-response nil input)) ([resultWrapper1438400 input] (clojure.core/let [rawinput1438399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1438401 {"PolicyARN" (rawinput1438399 "PolicyARN"), "Alarms" (rawinput1438399 "Alarms")}] (clojure.core/cond-> {:policy-arn (deser-resource-id-max-len-1600 (clojure.core/get-in letvar1438401 ["PolicyARN"]))} (letvar1438401 "Alarms") (clojure.core/assoc :alarms (deser-alarms (clojure.core/get-in letvar1438401 ["Alarms"])))))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\p{Print}+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/scheduled-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(?!((^[ ]+.*)|(.*([\u0000-\u001f]|[\u007f-\u009f]|[:/|])+.*)|(.*[ ]+$))).+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1023))))
