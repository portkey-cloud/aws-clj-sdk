...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1498390 input] (clojure.core/let [rawinput1498389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498391 {"Message" (rawinput1498389 "Message")}] (clojure.core/cond-> {} (letvar1498391 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498391 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-policy-response ([input] (response-delete-scaling-policy-response nil input)) ([resultWrapper1498393 input] (clojure.core/let [rawinput1498392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498394 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-scheduled-action-response ([input] (response-put-scheduled-action-response nil input)) ([resultWrapper1498396 input] (clojure.core/let [rawinput1498395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498397 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-policies-response ([input] (response-describe-scaling-policies-response nil input)) ([resultWrapper1498399 input] (clojure.core/let [rawinput1498398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498400 {"ScalingPolicies" (rawinput1498398 "ScalingPolicies"), "NextToken" (rawinput1498398 "NextToken")}] (clojure.core/cond-> {} (letvar1498400 "ScalingPolicies") (clojure.core/assoc :scaling-policies (deser-scaling-policies (clojure.core/get-in letvar1498400 ["ScalingPolicies"]))) (letvar1498400 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1498400 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1498402 input] (clojure.core/let [rawinput1498401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498403 {"Message" (rawinput1498401 "Message")}] (clojure.core/cond-> {} (letvar1498403 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498403 ["Message"])))))))

(clojure.core/defn- response-failed-resource-access-exception ([input] (response-failed-resource-access-exception nil input)) ([resultWrapper1498405 input] (clojure.core/let [rawinput1498404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498406 {"Message" (rawinput1498404 "Message")}] (clojure.core/cond-> {} (letvar1498406 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498406 ["Message"])))))))

(clojure.core/defn- response-register-scalable-target-response ([input] (response-register-scalable-target-response nil input)) ([resultWrapper1498408 input] (clojure.core/let [rawinput1498407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498409 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1498411 input] (clojure.core/let [rawinput1498410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498412 {"Message" (rawinput1498410 "Message")}] (clojure.core/cond-> {} (letvar1498412 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498412 ["Message"])))))))

(clojure.core/defn- response-describe-scheduled-actions-response ([input] (response-describe-scheduled-actions-response nil input)) ([resultWrapper1498414 input] (clojure.core/let [rawinput1498413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498415 {"ScheduledActions" (rawinput1498413 "ScheduledActions"), "NextToken" (rawinput1498413 "NextToken")}] (clojure.core/cond-> {} (letvar1498415 "ScheduledActions") (clojure.core/assoc :scheduled-actions (deser-scheduled-actions (clojure.core/get-in letvar1498415 ["ScheduledActions"]))) (letvar1498415 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1498415 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper1498417 input] (clojure.core/let [rawinput1498416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498418 {"Message" (rawinput1498416 "Message")}] (clojure.core/cond-> {} (letvar1498418 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498418 ["Message"])))))))

(clojure.core/defn- response-delete-scheduled-action-response ([input] (response-delete-scheduled-action-response nil input)) ([resultWrapper1498420 input] (clojure.core/let [rawinput1498419 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498421 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-activities-response ([input] (response-describe-scaling-activities-response nil input)) ([resultWrapper1498423 input] (clojure.core/let [rawinput1498422 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498424 {"ScalingActivities" (rawinput1498422 "ScalingActivities"), "NextToken" (rawinput1498422 "NextToken")}] (clojure.core/cond-> {} (letvar1498424 "ScalingActivities") (clojure.core/assoc :scaling-activities (deser-scaling-activities (clojure.core/get-in letvar1498424 ["ScalingActivities"]))) (letvar1498424 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1498424 ["NextToken"])))))))

(clojure.core/defn- response-describe-scalable-targets-response ([input] (response-describe-scalable-targets-response nil input)) ([resultWrapper1498426 input] (clojure.core/let [rawinput1498425 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498427 {"ScalableTargets" (rawinput1498425 "ScalableTargets"), "NextToken" (rawinput1498425 "NextToken")}] (clojure.core/cond-> {} (letvar1498427 "ScalableTargets") (clojure.core/assoc :scalable-targets (deser-scalable-targets (clojure.core/get-in letvar1498427 ["ScalableTargets"]))) (letvar1498427 "NextToken") (clojure.core/assoc :next-token (deser-xml-string (clojure.core/get-in letvar1498427 ["NextToken"])))))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1498429 input] (clojure.core/let [rawinput1498428 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498430 {"Message" (rawinput1498428 "Message")}] (clojure.core/cond-> {} (letvar1498430 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498430 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1498432 input] (clojure.core/let [rawinput1498431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498433 {"Message" (rawinput1498431 "Message")}] (clojure.core/cond-> {} (letvar1498433 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1498433 ["Message"])))))))

(clojure.core/defn- response-deregister-scalable-target-response ([input] (response-deregister-scalable-target-response nil input)) ([resultWrapper1498435 input] (clojure.core/let [rawinput1498434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498436 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-scaling-policy-response ([input] (response-put-scaling-policy-response nil input)) ([resultWrapper1498438 input] (clojure.core/let [rawinput1498437 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1498439 {"PolicyARN" (rawinput1498437 "PolicyARN"), "Alarms" (rawinput1498437 "Alarms")}] (clojure.core/cond-> {:policy-arn (deser-resource-id-max-len-1600 (clojure.core/get-in letvar1498439 ["PolicyARN"]))} (letvar1498439 "Alarms") (clojure.core/assoc :alarms (deser-alarms (clojure.core/get-in letvar1498439 ["Alarms"])))))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/scheduled-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"(?!((^[ ]+.*)|(.*([\u0000-\u001f]|[\u007f-\u009f]|[:/|])+.*)|(.*[ ]+$))).+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.application-autoscaling/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1023))))
