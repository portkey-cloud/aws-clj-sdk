...
(clojure.core/defn- response-invalid-endpoint-exception ([input] (response-invalid-endpoint-exception nil input)) ([resultWrapper264514 input] (clojure.core/let [rawinput264513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264515 {"Message" (rawinput264513 "Message")}] (clojure.core/cond-> {} (letvar264515 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264515 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper264517 input] (clojure.core/let [rawinput264516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264518 {"Message" (rawinput264516 "Message")}] (clojure.core/cond-> {} (letvar264518 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264518 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper264520 input] (clojure.core/let [rawinput264519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264521 {"Message" (rawinput264519 "Message")}] (clojure.core/cond-> {} (letvar264521 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264521 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper264523 input] (clojure.core/let [rawinput264522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264524 {"Message" (rawinput264522 "Message")}] (clojure.core/cond-> {} (letvar264524 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264524 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper264526 input] (clojure.core/let [rawinput264525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264527 {"Message" (rawinput264525 "Message")}] (clojure.core/cond-> {} (letvar264527 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264527 ["Message"])))))))

(clojure.core/defn- response-connection-limit-exceeded-exception ([input] (response-connection-limit-exceeded-exception nil input)) ([resultWrapper264529 input] (clojure.core/let [rawinput264528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264530 {"Message" (rawinput264528 "Message")}] (clojure.core/cond-> {} (letvar264530 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264530 ["Message"])))))))

(clojure.core/defn- response-get-media-output ([input] (response-get-media-output nil input)) ([resultWrapper264532 input] (clojure.core/let [rawinput264531 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264533 {"Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Payload" (rawinput264531 "Payload")}] (clojure.core/cond-> {} (letvar264533 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar264533 ["Content-Type"]))) (letvar264533 "Payload") (clojure.core/assoc :payload (deser-payload (clojure.core/get-in letvar264533 ["Payload"])))))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-media/fragment-number-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9]+$" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-media/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-media/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-media/continuation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-media/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__21112__auto__))))
