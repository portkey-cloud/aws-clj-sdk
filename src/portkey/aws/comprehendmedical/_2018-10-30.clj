...
(clojure.core/defn- response-detect-phi-response ([input] (response-detect-phi-response nil input)) ([resultWrapper1585338 input] (clojure.core/let [rawinput1585337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585339 {"Entities" (rawinput1585337 "Entities"), "PaginationToken" (rawinput1585337 "PaginationToken")}] (clojure.core/cond-> {:entities (deser-entity-list (clojure.core/get-in letvar1585339 ["Entities"]))} (letvar1585339 "PaginationToken") (clojure.core/assoc :pagination-token (deser-string (clojure.core/get-in letvar1585339 ["PaginationToken"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1585341 input] (clojure.core/let [rawinput1585340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585342 {"Message" (rawinput1585340 "Message")}] (clojure.core/cond-> {} (letvar1585342 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585342 ["Message"])))))))

(clojure.core/defn- response-text-size-limit-exceeded-exception ([input] (response-text-size-limit-exceeded-exception nil input)) ([resultWrapper1585344 input] (clojure.core/let [rawinput1585343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585345 {"Message" (rawinput1585343 "Message")}] (clojure.core/cond-> {} (letvar1585345 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585345 ["Message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1585347 input] (clojure.core/let [rawinput1585346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585348 {"Message" (rawinput1585346 "Message")}] (clojure.core/cond-> {} (letvar1585348 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585348 ["Message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1585350 input] (clojure.core/let [rawinput1585349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585351 {"Message" (rawinput1585349 "Message")}] (clojure.core/cond-> {} (letvar1585351 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585351 ["Message"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1585353 input] (clojure.core/let [rawinput1585352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585354 {"Message" (rawinput1585352 "Message")}] (clojure.core/cond-> {} (letvar1585354 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585354 ["Message"])))))))

(clojure.core/defn- response-invalid-encoding-exception ([input] (response-invalid-encoding-exception nil input)) ([resultWrapper1585356 input] (clojure.core/let [rawinput1585355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585357 {"Message" (rawinput1585355 "Message")}] (clojure.core/cond-> {} (letvar1585357 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1585357 ["Message"])))))))

(clojure.core/defn- response-detect-entities-response ([input] (response-detect-entities-response nil input)) ([resultWrapper1585359 input] (clojure.core/let [rawinput1585358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1585360 {"Entities" (rawinput1585358 "Entities"), "UnmappedAttributes" (rawinput1585358 "UnmappedAttributes"), "PaginationToken" (rawinput1585358 "PaginationToken")}] (clojure.core/cond-> {:entities (deser-entity-list (clojure.core/get-in letvar1585360 ["Entities"]))} (letvar1585360 "UnmappedAttributes") (clojure.core/assoc :unmapped-attributes (deser-unmapped-attribute-list (clojure.core/get-in letvar1585360 ["UnmappedAttributes"]))) (letvar1585360 "PaginationToken") (clojure.core/assoc :pagination-token (deser-string (clojure.core/get-in letvar1585360 ["PaginationToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.comprehendmedical.-2018-10-30/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.comprehendmedical.-2018-10-30/bounded-length-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20000))))
