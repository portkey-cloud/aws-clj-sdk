...
(clojure.core/defn- response-create-budget-response ([input] (response-create-budget-response nil input)) ([resultWrapper1521763 input] (clojure.core/let [rawinput1521762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521764 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-creation-limit-exceeded-exception ([input] (response-creation-limit-exceeded-exception nil input)) ([resultWrapper1521766 input] (clojure.core/let [rawinput1521765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521767 {"Message" (rawinput1521765 "Message")}] (clojure.core/cond-> {} (letvar1521767 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521767 ["Message"])))))))

(clojure.core/defn- response-describe-budget-performance-history-response ([input] (response-describe-budget-performance-history-response nil input)) ([resultWrapper1521769 input] (clojure.core/let [rawinput1521768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521770 {"BudgetPerformanceHistory" (rawinput1521768 "BudgetPerformanceHistory"), "NextToken" (rawinput1521768 "NextToken")}] (clojure.core/cond-> {} (letvar1521770 "BudgetPerformanceHistory") (clojure.core/assoc :budget-performance-history (deser-budget-performance-history (clojure.core/get-in letvar1521770 ["BudgetPerformanceHistory"]))) (letvar1521770 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1521770 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribers-for-notification-response ([input] (response-describe-subscribers-for-notification-response nil input)) ([resultWrapper1521772 input] (clojure.core/let [rawinput1521771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521773 {"Subscribers" (rawinput1521771 "Subscribers"), "NextToken" (rawinput1521771 "NextToken")}] (clojure.core/cond-> {} (letvar1521773 "Subscribers") (clojure.core/assoc :subscribers (deser-subscribers (clojure.core/get-in letvar1521773 ["Subscribers"]))) (letvar1521773 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1521773 ["NextToken"])))))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1521775 input] (clojure.core/let [rawinput1521774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521776 {"Message" (rawinput1521774 "Message")}] (clojure.core/cond-> {} (letvar1521776 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521776 ["Message"])))))))

(clojure.core/defn- response-delete-subscriber-response ([input] (response-delete-subscriber-response nil input)) ([resultWrapper1521778 input] (clojure.core/let [rawinput1521777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521779 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-notification-response ([input] (response-update-notification-response nil input)) ([resultWrapper1521781 input] (clojure.core/let [rawinput1521780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521782 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-budget-response ([input] (response-delete-budget-response nil input)) ([resultWrapper1521784 input] (clojure.core/let [rawinput1521783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521785 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1521787 input] (clojure.core/let [rawinput1521786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521788 {"Message" (rawinput1521786 "Message")}] (clojure.core/cond-> {} (letvar1521788 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521788 ["Message"])))))))

(clojure.core/defn- response-describe-budgets-response ([input] (response-describe-budgets-response nil input)) ([resultWrapper1521790 input] (clojure.core/let [rawinput1521789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521791 {"Budgets" (rawinput1521789 "Budgets"), "NextToken" (rawinput1521789 "NextToken")}] (clojure.core/cond-> {} (letvar1521791 "Budgets") (clojure.core/assoc :budgets (deser-budgets (clojure.core/get-in letvar1521791 ["Budgets"]))) (letvar1521791 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1521791 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1521793 input] (clojure.core/let [rawinput1521792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521794 {"Message" (rawinput1521792 "Message")}] (clojure.core/cond-> {} (letvar1521794 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521794 ["Message"])))))))

(clojure.core/defn- response-update-budget-response ([input] (response-update-budget-response nil input)) ([resultWrapper1521796 input] (clojure.core/let [rawinput1521795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521797 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-duplicate-record-exception ([input] (response-duplicate-record-exception nil input)) ([resultWrapper1521799 input] (clojure.core/let [rawinput1521798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521800 {"Message" (rawinput1521798 "Message")}] (clojure.core/cond-> {} (letvar1521800 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521800 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1521802 input] (clojure.core/let [rawinput1521801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521803 {"Message" (rawinput1521801 "Message")}] (clojure.core/cond-> {} (letvar1521803 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521803 ["Message"])))))))

(clojure.core/defn- response-create-notification-response ([input] (response-create-notification-response nil input)) ([resultWrapper1521805 input] (clojure.core/let [rawinput1521804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521806 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-budget-response ([input] (response-describe-budget-response nil input)) ([resultWrapper1521808 input] (clojure.core/let [rawinput1521807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521809 {"Budget" (rawinput1521807 "Budget")}] (clojure.core/cond-> {} (letvar1521809 "Budget") (clojure.core/assoc :budget (deser-budget (clojure.core/get-in letvar1521809 ["Budget"])))))))

(clojure.core/defn- response-delete-notification-response ([input] (response-delete-notification-response nil input)) ([resultWrapper1521811 input] (clojure.core/let [rawinput1521810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521812 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subscriber-response ([input] (response-update-subscriber-response nil input)) ([resultWrapper1521814 input] (clojure.core/let [rawinput1521813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521815 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1521817 input] (clojure.core/let [rawinput1521816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521818 {"Message" (rawinput1521816 "Message")}] (clojure.core/cond-> {} (letvar1521818 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1521818 ["Message"])))))))

(clojure.core/defn- response-create-subscriber-response ([input] (response-create-subscriber-response nil input)) ([resultWrapper1521820 input] (clojure.core/let [rawinput1521819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521821 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-notifications-for-budget-response ([input] (response-describe-notifications-for-budget-response nil input)) ([resultWrapper1521823 input] (clojure.core/let [rawinput1521822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1521824 {"Notifications" (rawinput1521822 "Notifications"), "NextToken" (rawinput1521822 "NextToken")}] (clojure.core/cond-> {} (letvar1521824 "Notifications") (clojure.core/assoc :notifications (deser-notifications (clojure.core/get-in letvar1521824 ["Notifications"]))) (letvar1521824 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1521824 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*" s__1467903__auto__))))
