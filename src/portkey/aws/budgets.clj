...
(clojure.core/defn- response-create-budget-response ([input] (response-create-budget-response nil input)) ([resultWrapper1464385 input] (clojure.core/let [rawinput1464384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464386 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-creation-limit-exceeded-exception ([input] (response-creation-limit-exceeded-exception nil input)) ([resultWrapper1464388 input] (clojure.core/let [rawinput1464387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464389 {"Message" (rawinput1464387 "Message")}] (clojure.core/cond-> {} (letvar1464389 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464389 ["Message"])))))))

(clojure.core/defn- response-describe-budget-performance-history-response ([input] (response-describe-budget-performance-history-response nil input)) ([resultWrapper1464391 input] (clojure.core/let [rawinput1464390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464392 {"BudgetPerformanceHistory" (rawinput1464390 "BudgetPerformanceHistory"), "NextToken" (rawinput1464390 "NextToken")}] (clojure.core/cond-> {} (letvar1464392 "BudgetPerformanceHistory") (clojure.core/assoc :budget-performance-history (deser-budget-performance-history (clojure.core/get-in letvar1464392 ["BudgetPerformanceHistory"]))) (letvar1464392 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1464392 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribers-for-notification-response ([input] (response-describe-subscribers-for-notification-response nil input)) ([resultWrapper1464394 input] (clojure.core/let [rawinput1464393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464395 {"Subscribers" (rawinput1464393 "Subscribers"), "NextToken" (rawinput1464393 "NextToken")}] (clojure.core/cond-> {} (letvar1464395 "Subscribers") (clojure.core/assoc :subscribers (deser-subscribers (clojure.core/get-in letvar1464395 ["Subscribers"]))) (letvar1464395 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1464395 ["NextToken"])))))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1464397 input] (clojure.core/let [rawinput1464396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464398 {"Message" (rawinput1464396 "Message")}] (clojure.core/cond-> {} (letvar1464398 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464398 ["Message"])))))))

(clojure.core/defn- response-delete-subscriber-response ([input] (response-delete-subscriber-response nil input)) ([resultWrapper1464400 input] (clojure.core/let [rawinput1464399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464401 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-notification-response ([input] (response-update-notification-response nil input)) ([resultWrapper1464403 input] (clojure.core/let [rawinput1464402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464404 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-budget-response ([input] (response-delete-budget-response nil input)) ([resultWrapper1464406 input] (clojure.core/let [rawinput1464405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464407 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1464409 input] (clojure.core/let [rawinput1464408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464410 {"Message" (rawinput1464408 "Message")}] (clojure.core/cond-> {} (letvar1464410 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464410 ["Message"])))))))

(clojure.core/defn- response-describe-budgets-response ([input] (response-describe-budgets-response nil input)) ([resultWrapper1464412 input] (clojure.core/let [rawinput1464411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464413 {"Budgets" (rawinput1464411 "Budgets"), "NextToken" (rawinput1464411 "NextToken")}] (clojure.core/cond-> {} (letvar1464413 "Budgets") (clojure.core/assoc :budgets (deser-budgets (clojure.core/get-in letvar1464413 ["Budgets"]))) (letvar1464413 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1464413 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1464415 input] (clojure.core/let [rawinput1464414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464416 {"Message" (rawinput1464414 "Message")}] (clojure.core/cond-> {} (letvar1464416 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464416 ["Message"])))))))

(clojure.core/defn- response-update-budget-response ([input] (response-update-budget-response nil input)) ([resultWrapper1464418 input] (clojure.core/let [rawinput1464417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464419 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-duplicate-record-exception ([input] (response-duplicate-record-exception nil input)) ([resultWrapper1464421 input] (clojure.core/let [rawinput1464420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464422 {"Message" (rawinput1464420 "Message")}] (clojure.core/cond-> {} (letvar1464422 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464422 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1464424 input] (clojure.core/let [rawinput1464423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464425 {"Message" (rawinput1464423 "Message")}] (clojure.core/cond-> {} (letvar1464425 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464425 ["Message"])))))))

(clojure.core/defn- response-create-notification-response ([input] (response-create-notification-response nil input)) ([resultWrapper1464427 input] (clojure.core/let [rawinput1464426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464428 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-budget-response ([input] (response-describe-budget-response nil input)) ([resultWrapper1464430 input] (clojure.core/let [rawinput1464429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464431 {"Budget" (rawinput1464429 "Budget")}] (clojure.core/cond-> {} (letvar1464431 "Budget") (clojure.core/assoc :budget (deser-budget (clojure.core/get-in letvar1464431 ["Budget"])))))))

(clojure.core/defn- response-delete-notification-response ([input] (response-delete-notification-response nil input)) ([resultWrapper1464433 input] (clojure.core/let [rawinput1464432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464434 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subscriber-response ([input] (response-update-subscriber-response nil input)) ([resultWrapper1464436 input] (clojure.core/let [rawinput1464435 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464437 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1464439 input] (clojure.core/let [rawinput1464438 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464440 {"Message" (rawinput1464438 "Message")}] (clojure.core/cond-> {} (letvar1464440 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1464440 ["Message"])))))))

(clojure.core/defn- response-create-subscriber-response ([input] (response-create-subscriber-response nil input)) ([resultWrapper1464442 input] (clojure.core/let [rawinput1464441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464443 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-notifications-for-budget-response ([input] (response-describe-notifications-for-budget-response nil input)) ([resultWrapper1464445 input] (clojure.core/let [rawinput1464444 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1464446 {"Notifications" (rawinput1464444 "Notifications"), "NextToken" (rawinput1464444 "NextToken")}] (clojure.core/cond-> {} (letvar1464446 "Notifications") (clojure.core/assoc :notifications (deser-notifications (clojure.core/get-in letvar1464446 ["Notifications"]))) (letvar1464446 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1464446 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 12)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\d{12}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:\\]+" s__1410940__auto__))))
