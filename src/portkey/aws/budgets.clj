...
(clojure.spec.alpha/def :portkey.aws.budgets/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 12 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 12))))
...
(clojure.spec.alpha/def :portkey.aws.budgets/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__27882__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 100)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[^:\\]+" s__27882__auto__))))
