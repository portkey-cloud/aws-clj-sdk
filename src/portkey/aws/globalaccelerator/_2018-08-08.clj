...
(clojure.core/defn- response-endpoint-group-not-found-exception ([input] (response-endpoint-group-not-found-exception nil input)) ([resultWrapper1778356 input] (clojure.core/let [rawinput1778355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778357 {"Message" (rawinput1778355 "Message")}] (clojure.core/cond-> {} (letvar1778357 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778357 ["Message"])))))))

(clojure.core/defn- response-associated-listener-found-exception ([input] (response-associated-listener-found-exception nil input)) ([resultWrapper1778359 input] (clojure.core/let [rawinput1778358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778360 {"Message" (rawinput1778358 "Message")}] (clojure.core/cond-> {} (letvar1778360 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778360 ["Message"])))))))

(clojure.core/defn- response-endpoint-group-already-exists-exception ([input] (response-endpoint-group-already-exists-exception nil input)) ([resultWrapper1778362 input] (clojure.core/let [rawinput1778361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778363 {"Message" (rawinput1778361 "Message")}] (clojure.core/cond-> {} (letvar1778363 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778363 ["Message"])))))))

(clojure.core/defn- response-update-accelerator-response ([input] (response-update-accelerator-response nil input)) ([resultWrapper1778365 input] (clojure.core/let [rawinput1778364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778366 {"Accelerator" (rawinput1778364 "Accelerator")}] (clojure.core/cond-> {} (letvar1778366 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1778366 ["Accelerator"])))))))

(clojure.core/defn- response-describe-accelerator-attributes-response ([input] (response-describe-accelerator-attributes-response nil input)) ([resultWrapper1778368 input] (clojure.core/let [rawinput1778367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778369 {"AcceleratorAttributes" (rawinput1778367 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1778369 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1778369 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-list-listeners-response ([input] (response-list-listeners-response nil input)) ([resultWrapper1778371 input] (clojure.core/let [rawinput1778370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778372 {"Listeners" (rawinput1778370 "Listeners"), "NextToken" (rawinput1778370 "NextToken")}] (clojure.core/cond-> {} (letvar1778372 "Listeners") (clojure.core/assoc :listeners (deser-listeners (clojure.core/get-in letvar1778372 ["Listeners"]))) (letvar1778372 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1778372 ["NextToken"])))))))

(clojure.core/defn- response-update-accelerator-attributes-response ([input] (response-update-accelerator-attributes-response nil input)) ([resultWrapper1778374 input] (clojure.core/let [rawinput1778373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778375 {"AcceleratorAttributes" (rawinput1778373 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1778375 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1778375 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1778377 input] (clojure.core/let [rawinput1778376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778378 {"Message" (rawinput1778376 "Message")}] (clojure.core/cond-> {} (letvar1778378 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778378 ["Message"])))))))

(clojure.core/defn- response-describe-listener-response ([input] (response-describe-listener-response nil input)) ([resultWrapper1778380 input] (clojure.core/let [rawinput1778379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778381 {"Listener" (rawinput1778379 "Listener")}] (clojure.core/cond-> {} (letvar1778381 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1778381 ["Listener"])))))))

(clojure.core/defn- response-update-endpoint-group-response ([input] (response-update-endpoint-group-response nil input)) ([resultWrapper1778383 input] (clojure.core/let [rawinput1778382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778384 {"EndpointGroup" (rawinput1778382 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1778384 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1778384 ["EndpointGroup"])))))))

(clojure.core/defn- response-associated-endpoint-group-found-exception ([input] (response-associated-endpoint-group-found-exception nil input)) ([resultWrapper1778386 input] (clojure.core/let [rawinput1778385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778387 {"Message" (rawinput1778385 "Message")}] (clojure.core/cond-> {} (letvar1778387 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778387 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1778389 input] (clojure.core/let [rawinput1778388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778390 {"Message" (rawinput1778388 "Message")}] (clojure.core/cond-> {} (letvar1778390 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778390 ["Message"])))))))

(clojure.core/defn- response-list-endpoint-groups-response ([input] (response-list-endpoint-groups-response nil input)) ([resultWrapper1778392 input] (clojure.core/let [rawinput1778391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778393 {"EndpointGroups" (rawinput1778391 "EndpointGroups"), "NextToken" (rawinput1778391 "NextToken")}] (clojure.core/cond-> {} (letvar1778393 "EndpointGroups") (clojure.core/assoc :endpoint-groups (deser-endpoint-groups (clojure.core/get-in letvar1778393 ["EndpointGroups"]))) (letvar1778393 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1778393 ["NextToken"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1778395 input] (clojure.core/let [rawinput1778394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778396 {"Message" (rawinput1778394 "Message")}] (clojure.core/cond-> {} (letvar1778396 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778396 ["Message"])))))))

(clojure.core/defn- response-describe-accelerator-response ([input] (response-describe-accelerator-response nil input)) ([resultWrapper1778398 input] (clojure.core/let [rawinput1778397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778399 {"Accelerator" (rawinput1778397 "Accelerator")}] (clojure.core/cond-> {} (letvar1778399 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1778399 ["Accelerator"])))))))

(clojure.core/defn- response-update-listener-response ([input] (response-update-listener-response nil input)) ([resultWrapper1778401 input] (clojure.core/let [rawinput1778400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778402 {"Listener" (rawinput1778400 "Listener")}] (clojure.core/cond-> {} (letvar1778402 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1778402 ["Listener"])))))))

(clojure.core/defn- response-create-accelerator-response ([input] (response-create-accelerator-response nil input)) ([resultWrapper1778404 input] (clojure.core/let [rawinput1778403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778405 {"Accelerator" (rawinput1778403 "Accelerator")}] (clojure.core/cond-> {} (letvar1778405 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1778405 ["Accelerator"])))))))

(clojure.core/defn- response-accelerator-not-disabled-exception ([input] (response-accelerator-not-disabled-exception nil input)) ([resultWrapper1778407 input] (clojure.core/let [rawinput1778406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778408 {"Message" (rawinput1778406 "Message")}] (clojure.core/cond-> {} (letvar1778408 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778408 ["Message"])))))))

(clojure.core/defn- response-describe-endpoint-group-response ([input] (response-describe-endpoint-group-response nil input)) ([resultWrapper1778410 input] (clojure.core/let [rawinput1778409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778411 {"EndpointGroup" (rawinput1778409 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1778411 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1778411 ["EndpointGroup"])))))))

(clojure.core/defn- response-accelerator-not-found-exception ([input] (response-accelerator-not-found-exception nil input)) ([resultWrapper1778413 input] (clojure.core/let [rawinput1778412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778414 {"Message" (rawinput1778412 "Message")}] (clojure.core/cond-> {} (letvar1778414 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778414 ["Message"])))))))

(clojure.core/defn- response-create-listener-response ([input] (response-create-listener-response nil input)) ([resultWrapper1778416 input] (clojure.core/let [rawinput1778415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778417 {"Listener" (rawinput1778415 "Listener")}] (clojure.core/cond-> {} (letvar1778417 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1778417 ["Listener"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1778419 input] (clojure.core/let [rawinput1778418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778420 {"Message" (rawinput1778418 "Message")}] (clojure.core/cond-> {} (letvar1778420 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778420 ["Message"])))))))

(clojure.core/defn- response-invalid-port-range-exception ([input] (response-invalid-port-range-exception nil input)) ([resultWrapper1778422 input] (clojure.core/let [rawinput1778421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778423 {"Message" (rawinput1778421 "Message")}] (clojure.core/cond-> {} (letvar1778423 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778423 ["Message"])))))))

(clojure.core/defn- response-list-accelerators-response ([input] (response-list-accelerators-response nil input)) ([resultWrapper1778425 input] (clojure.core/let [rawinput1778424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778426 {"Accelerators" (rawinput1778424 "Accelerators"), "NextToken" (rawinput1778424 "NextToken")}] (clojure.core/cond-> {} (letvar1778426 "Accelerators") (clojure.core/assoc :accelerators (deser-accelerators (clojure.core/get-in letvar1778426 ["Accelerators"]))) (letvar1778426 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1778426 ["NextToken"])))))))

(clojure.core/defn- response-listener-not-found-exception ([input] (response-listener-not-found-exception nil input)) ([resultWrapper1778428 input] (clojure.core/let [rawinput1778427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778429 {"Message" (rawinput1778427 "Message")}] (clojure.core/cond-> {} (letvar1778429 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1778429 ["Message"])))))))

(clojure.core/defn- response-create-endpoint-group-response ([input] (response-create-endpoint-group-response nil input)) ([resultWrapper1778431 input] (clojure.core/let [rawinput1778430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1778432 {"EndpointGroup" (rawinput1778430 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1778432 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1778432 ["EndpointGroup"])))))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator.-2018-08-08/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator.-2018-08-08/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
