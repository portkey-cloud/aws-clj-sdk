...
(clojure.core/defn- response-unsupported-locale ([input] (response-unsupported-locale nil input)) ([resultWrapper1833968 input] (clojure.core/let [rawinput1833967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833969 {"message" (rawinput1833967 "message")}] (clojure.core/cond-> {} (letvar1833969 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1833969 ["message"])))))))

(clojure.core/defn- response-invalid-pagination-token ([input] (response-invalid-pagination-token nil input)) ([resultWrapper1833971 input] (clojure.core/let [rawinput1833970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833972 {"message" (rawinput1833970 "message")}] (clojure.core/cond-> {} (letvar1833972 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1833972 ["message"])))))))

(clojure.core/defn- response-describe-entity-aggregates-response ([input] (response-describe-entity-aggregates-response nil input)) ([resultWrapper1833974 input] (clojure.core/let [rawinput1833973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833975 {"entityAggregates" (rawinput1833973 "entityAggregates")}] (clojure.core/cond-> {} (letvar1833975 "entityAggregates") (clojure.core/assoc :entity-aggregates (deser-entity-aggregate-list (clojure.core/get-in letvar1833975 ["entityAggregates"])))))))

(clojure.core/defn- response-describe-event-aggregates-response ([input] (response-describe-event-aggregates-response nil input)) ([resultWrapper1833977 input] (clojure.core/let [rawinput1833976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833978 {"eventAggregates" (rawinput1833976 "eventAggregates"), "nextToken" (rawinput1833976 "nextToken")}] (clojure.core/cond-> {} (letvar1833978 "eventAggregates") (clojure.core/assoc :event-aggregates (deser-event-aggregate-list (clojure.core/get-in letvar1833978 ["eventAggregates"]))) (letvar1833978 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1833978 ["nextToken"])))))))

(clojure.core/defn- response-describe-affected-entities-response ([input] (response-describe-affected-entities-response nil input)) ([resultWrapper1833980 input] (clojure.core/let [rawinput1833979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833981 {"entities" (rawinput1833979 "entities"), "nextToken" (rawinput1833979 "nextToken")}] (clojure.core/cond-> {} (letvar1833981 "entities") (clojure.core/assoc :entities (deser-entity-list (clojure.core/get-in letvar1833981 ["entities"]))) (letvar1833981 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1833981 ["nextToken"])))))))

(clojure.core/defn- response-describe-event-details-response ([input] (response-describe-event-details-response nil input)) ([resultWrapper1833983 input] (clojure.core/let [rawinput1833982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833984 {"successfulSet" (rawinput1833982 "successfulSet"), "failedSet" (rawinput1833982 "failedSet")}] (clojure.core/cond-> {} (letvar1833984 "successfulSet") (clojure.core/assoc :successful-set (deser-describe-event-details-successful-set (clojure.core/get-in letvar1833984 ["successfulSet"]))) (letvar1833984 "failedSet") (clojure.core/assoc :failed-set (deser-describe-event-details-failed-set (clojure.core/get-in letvar1833984 ["failedSet"])))))))

(clojure.core/defn- response-describe-event-types-response ([input] (response-describe-event-types-response nil input)) ([resultWrapper1833986 input] (clojure.core/let [rawinput1833985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833987 {"eventTypes" (rawinput1833985 "eventTypes"), "nextToken" (rawinput1833985 "nextToken")}] (clojure.core/cond-> {} (letvar1833987 "eventTypes") (clojure.core/assoc :event-types (deser-event-type-list (clojure.core/get-in letvar1833987 ["eventTypes"]))) (letvar1833987 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1833987 ["nextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1833989 input] (clojure.core/let [rawinput1833988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1833990 {"events" (rawinput1833988 "events"), "nextToken" (rawinput1833988 "nextToken")}] (clojure.core/cond-> {} (letvar1833990 "events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1833990 ["events"]))) (letvar1833990 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1833990 ["nextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9]{12}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){3}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"https?://.+\.(amazon\.com|amazonaws\.com|amazonaws\.cn|c2s\.ic\.gov|sc2s\.sgov\.gov|amazonaws-us-gov.com)/.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 127))))
