...
(clojure.core/defn- response-unsupported-locale ([input] (response-unsupported-locale nil input)) ([resultWrapper1062244 input] (clojure.core/let [rawinput1062243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062245 {"message" (rawinput1062243 "message")}] (clojure.core/cond-> {} (letvar1062245 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1062245 ["message"])))))))

(clojure.core/defn- response-invalid-pagination-token ([input] (response-invalid-pagination-token nil input)) ([resultWrapper1062247 input] (clojure.core/let [rawinput1062246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062248 {"message" (rawinput1062246 "message")}] (clojure.core/cond-> {} (letvar1062248 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1062248 ["message"])))))))

(clojure.core/defn- response-describe-entity-aggregates-response ([input] (response-describe-entity-aggregates-response nil input)) ([resultWrapper1062250 input] (clojure.core/let [rawinput1062249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062251 {"entityAggregates" (rawinput1062249 "entityAggregates")}] (clojure.core/cond-> {} (letvar1062251 "entityAggregates") (clojure.core/assoc :entity-aggregates (deser-entity-aggregate-list (clojure.core/get-in letvar1062251 ["entityAggregates"])))))))

(clojure.core/defn- response-describe-event-aggregates-response ([input] (response-describe-event-aggregates-response nil input)) ([resultWrapper1062253 input] (clojure.core/let [rawinput1062252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062254 {"eventAggregates" (rawinput1062252 "eventAggregates"), "nextToken" (rawinput1062252 "nextToken")}] (clojure.core/cond-> {} (letvar1062254 "eventAggregates") (clojure.core/assoc :event-aggregates (deser-event-aggregate-list (clojure.core/get-in letvar1062254 ["eventAggregates"]))) (letvar1062254 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1062254 ["nextToken"])))))))

(clojure.core/defn- response-describe-affected-entities-response ([input] (response-describe-affected-entities-response nil input)) ([resultWrapper1062256 input] (clojure.core/let [rawinput1062255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062257 {"entities" (rawinput1062255 "entities"), "nextToken" (rawinput1062255 "nextToken")}] (clojure.core/cond-> {} (letvar1062257 "entities") (clojure.core/assoc :entities (deser-entity-list (clojure.core/get-in letvar1062257 ["entities"]))) (letvar1062257 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1062257 ["nextToken"])))))))

(clojure.core/defn- response-describe-event-details-response ([input] (response-describe-event-details-response nil input)) ([resultWrapper1062259 input] (clojure.core/let [rawinput1062258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062260 {"successfulSet" (rawinput1062258 "successfulSet"), "failedSet" (rawinput1062258 "failedSet")}] (clojure.core/cond-> {} (letvar1062260 "successfulSet") (clojure.core/assoc :successful-set (deser-describe-event-details-successful-set (clojure.core/get-in letvar1062260 ["successfulSet"]))) (letvar1062260 "failedSet") (clojure.core/assoc :failed-set (deser-describe-event-details-failed-set (clojure.core/get-in letvar1062260 ["failedSet"])))))))

(clojure.core/defn- response-describe-event-types-response ([input] (response-describe-event-types-response nil input)) ([resultWrapper1062262 input] (clojure.core/let [rawinput1062261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062263 {"eventTypes" (rawinput1062261 "eventTypes"), "nextToken" (rawinput1062261 "nextToken")}] (clojure.core/cond-> {} (letvar1062263 "eventTypes") (clojure.core/assoc :event-types (deser-event-type-list (clojure.core/get-in letvar1062263 ["eventTypes"]))) (letvar1062263 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1062263 ["nextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1062265 input] (clojure.core/let [rawinput1062264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1062266 {"events" (rawinput1062264 "events"), "nextToken" (rawinput1062264 "nextToken")}] (clojure.core/cond-> {} (letvar1062266 "events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1062266 ["events"]))) (letvar1062266 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1062266 ["nextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]{12}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){3}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"https?://.+\.(amazon\.com|amazonaws\.com|amazonaws\.cn|c2s\.ic\.gov|sc2s\.sgov\.gov|amazonaws-us-gov.com)/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 127))))
