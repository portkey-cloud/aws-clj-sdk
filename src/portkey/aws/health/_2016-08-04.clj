...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[0-9]{12}" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 3 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 1600)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){1}((?:/[\w-]+){2})?" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__27882__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 2 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__27882__auto__))))

(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 3 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 2 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health.-2016-08-04/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 127))))
