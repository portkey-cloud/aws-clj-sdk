...
(clojure.core/defn- deser-delete-message-batch-result-entry [input] (clojure.core/let [letvar1758088 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-string (clojure.core/get-in letvar1758088 ["Id" :content]))})))
...
(clojure.core/defn- deser-message-attribute-value [input] (clojure.core/let [letvar1758267 {"StringValue" (portkey.aws/search-for-tag input "StringValue" :flattened? nil :xmlAttribute? nil), "BinaryValue" (portkey.aws/search-for-tag input "BinaryValue" :flattened? nil :xmlAttribute? nil), "StringListValue" (portkey.aws/search-for-tag input "StringListValue" :flattened? nil :xmlAttribute? nil), "BinaryListValue" (portkey.aws/search-for-tag input "BinaryListValue" :flattened? nil :xmlAttribute? nil), "DataType" (portkey.aws/search-for-tag input "DataType" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {:data-type (deser-string (clojure.core/get-in letvar1758267 ["DataType" :content]))} (letvar1758267 "StringValue") (clojure.core/assoc :string-value (deser-string (clojure.core/get-in letvar1758267 ["StringValue" :content]))) (letvar1758267 "BinaryValue") (clojure.core/assoc :binary-value (deser-binary (clojure.core/get-in letvar1758267 ["BinaryValue" :content]))) (letvar1758267 "StringListValue") (clojure.core/assoc :string-list-values (deser-string-list (clojure.core/get-in letvar1758267 ["StringListValue" :content]))) (letvar1758267 "BinaryListValue") (clojure.core/assoc :binary-list-values (deser-binary-list (clojure.core/get-in letvar1758267 ["BinaryListValue" :content]))))))

(clojure.core/defn- deser-message [input] (clojure.core/let [letvar1758375 {"MessageId" (portkey.aws/search-for-tag input "MessageId" :flattened? nil :xmlAttribute? nil), "ReceiptHandle" (portkey.aws/search-for-tag input "ReceiptHandle" :flattened? nil :xmlAttribute? nil), "MD5OfBody" (portkey.aws/search-for-tag input "MD5OfBody" :flattened? nil :xmlAttribute? nil), "Body" (portkey.aws/search-for-tag input "Body" :flattened? nil :xmlAttribute? nil), "Attribute" (portkey.aws/search-for-tag input "Attribute" :flattened? true :xmlAttribute? nil), "MD5OfMessageAttributes" (portkey.aws/search-for-tag input "MD5OfMessageAttributes" :flattened? nil :xmlAttribute? nil), "MessageAttribute" (portkey.aws/search-for-tag input "MessageAttribute" :flattened? true :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar1758375 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar1758375 ["MessageId" :content]))) (letvar1758375 "ReceiptHandle") (clojure.core/assoc :receipt-handle (deser-string (clojure.core/get-in letvar1758375 ["ReceiptHandle" :content]))) (letvar1758375 "MD5OfBody") (clojure.core/assoc :md-5-of-body (deser-string (clojure.core/get-in letvar1758375 ["MD5OfBody" :content]))) (letvar1758375 "Body") (clojure.core/assoc :body (deser-string (clojure.core/get-in letvar1758375 ["Body" :content]))) (letvar1758375 "Attribute") (clojure.core/assoc :attributes (deser-message-system-attribute-map (clojure.core/get-in letvar1758375 ["Attribute"]))) (letvar1758375 "MD5OfMessageAttributes") (clojure.core/assoc :md-5-of-message-attributes (deser-string (clojure.core/get-in letvar1758375 ["MD5OfMessageAttributes" :content]))) (letvar1758375 "MessageAttribute") (clojure.core/assoc :message-attributes (deser-message-body-attribute-map (clojure.core/get-in letvar1758375 ["MessageAttribute"]))))))
...
(clojure.core/defn- deser-change-message-visibility-batch-result-entry [input] (clojure.core/let [letvar1758528 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-string (clojure.core/get-in letvar1758528 ["Id" :content]))})))

(clojure.core/defn- deser-send-message-batch-result-entry [input] (clojure.core/let [letvar1758636 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? nil :xmlAttribute? nil), "MessageId" (portkey.aws/search-for-tag input "MessageId" :flattened? nil :xmlAttribute? nil), "MD5OfMessageBody" (portkey.aws/search-for-tag input "MD5OfMessageBody" :flattened? nil :xmlAttribute? nil), "MD5OfMessageAttributes" (portkey.aws/search-for-tag input "MD5OfMessageAttributes" :flattened? nil :xmlAttribute? nil), "SequenceNumber" (portkey.aws/search-for-tag input "SequenceNumber" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-string (clojure.core/get-in letvar1758636 ["Id" :content])), :message-id (deser-string (clojure.core/get-in letvar1758636 ["MessageId" :content])), :md-5-of-message-body (deser-string (clojure.core/get-in letvar1758636 ["MD5OfMessageBody" :content]))} (letvar1758636 "MD5OfMessageAttributes") (clojure.core/assoc :md-5-of-message-attributes (deser-string (clojure.core/get-in letvar1758636 ["MD5OfMessageAttributes" :content]))) (letvar1758636 "SequenceNumber") (clojure.core/assoc :sequence-number (deser-string (clojure.core/get-in letvar1758636 ["SequenceNumber" :content]))))))
...
(clojure.core/defn- deser-batch-result-error-entry [input] (clojure.core/let [letvar1758826 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? nil :xmlAttribute? nil), "SenderFault" (portkey.aws/search-for-tag input "SenderFault" :flattened? nil :xmlAttribute? nil), "Code" (portkey.aws/search-for-tag input "Code" :flattened? nil :xmlAttribute? nil), "Message" (portkey.aws/search-for-tag input "Message" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-string (clojure.core/get-in letvar1758826 ["Id" :content])), :sender-fault (deser-boolean (clojure.core/get-in letvar1758826 ["SenderFault" :content])), :code (deser-string (clojure.core/get-in letvar1758826 ["Code" :content]))} (letvar1758826 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1758826 ["Message" :content]))))))
...
(clojure.core/defn- response-message-not-inflight ([input] (response-message-not-inflight nil input)) ([resultWrapper1758830 input] (clojure.core/let [rawinput1758829 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758831 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-operation ([input] (response-unsupported-operation nil input)) ([resultWrapper1758833 input] (clojure.core/let [rawinput1758832 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758834 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-receive-message-result ([input] (response-receive-message-result nil input)) ([resultWrapper1758836 input] (clojure.core/let [rawinput1758835 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758837 {"Message" (portkey.aws/search-for-tag rawinput1758835 "Message" :flattened? true :result-wrapper resultWrapper1758836)}] (clojure.core/cond-> {} (letvar1758837 "Message") (clojure.core/assoc :messages (deser-message-list (clojure.core/get-in letvar1758837 ["Message"])))))))

(clojure.core/defn- response-purge-queue-in-progress ([input] (response-purge-queue-in-progress nil input)) ([resultWrapper1758839 input] (clojure.core/let [rawinput1758838 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758840 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-change-message-visibility-batch-result ([input] (response-change-message-visibility-batch-result nil input)) ([resultWrapper1758842 input] (clojure.core/let [rawinput1758841 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758843 {"ChangeMessageVisibilityBatchResultEntry" (portkey.aws/search-for-tag rawinput1758841 "ChangeMessageVisibilityBatchResultEntry" :flattened? true :result-wrapper resultWrapper1758842), "BatchResultErrorEntry" (portkey.aws/search-for-tag rawinput1758841 "BatchResultErrorEntry" :flattened? true :result-wrapper resultWrapper1758842)}] (clojure.core/cond-> {:successful (deser-change-message-visibility-batch-result-entry-list (clojure.core/get-in letvar1758843 ["ChangeMessageVisibilityBatchResultEntry"])), :failed (deser-batch-result-error-entry-list (clojure.core/get-in letvar1758843 ["BatchResultErrorEntry"]))}))))

(clojure.core/defn- response-create-queue-result ([input] (response-create-queue-result nil input)) ([resultWrapper1758845 input] (clojure.core/let [rawinput1758844 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758846 {"QueueUrl" (portkey.aws/search-for-tag rawinput1758844 "QueueUrl" :flattened? nil :result-wrapper resultWrapper1758845)}] (clojure.core/cond-> {} (letvar1758846 "QueueUrl") (clojure.core/assoc :queue-url (deser-string (clojure.core/get-in letvar1758846 ["QueueUrl" :content])))))))

(clojure.core/defn- response-invalid-id-format ([input] (response-invalid-id-format nil input)) ([resultWrapper1758848 input] (clojure.core/let [rawinput1758847 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758849 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-empty-batch-request ([input] (response-empty-batch-request nil input)) ([resultWrapper1758851 input] (clojure.core/let [rawinput1758850 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758852 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-queue-url-result ([input] (response-get-queue-url-result nil input)) ([resultWrapper1758854 input] (clojure.core/let [rawinput1758853 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758855 {"QueueUrl" (portkey.aws/search-for-tag rawinput1758853 "QueueUrl" :flattened? nil :result-wrapper resultWrapper1758854)}] (clojure.core/cond-> {} (letvar1758855 "QueueUrl") (clojure.core/assoc :queue-url (deser-string (clojure.core/get-in letvar1758855 ["QueueUrl" :content])))))))

(clojure.core/defn- response-list-queue-tags-result ([input] (response-list-queue-tags-result nil input)) ([resultWrapper1758857 input] (clojure.core/let [rawinput1758856 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758858 {"Tag" (portkey.aws/search-for-tag rawinput1758856 "Tag" :flattened? true :result-wrapper resultWrapper1758857)}] (clojure.core/cond-> {} (letvar1758858 "Tag") (clojure.core/assoc :tags (deser-tag-map (clojure.core/get-in letvar1758858 ["Tag"])))))))

(clojure.core/defn- response-queue-deleted-recently ([input] (response-queue-deleted-recently nil input)) ([resultWrapper1758860 input] (clojure.core/let [rawinput1758859 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758861 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-dead-letter-source-queues-result ([input] (response-list-dead-letter-source-queues-result nil input)) ([resultWrapper1758863 input] (clojure.core/let [rawinput1758862 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758864 {"QueueUrl" (portkey.aws/search-for-tag rawinput1758862 "QueueUrl" :flattened? true :result-wrapper resultWrapper1758863)}] (clojure.core/cond-> {:queue-urls (deser-queue-url-list (clojure.core/get-in letvar1758864 ["QueueUrl"]))}))))

(clojure.core/defn- response-over-limit ([input] (response-over-limit nil input)) ([resultWrapper1758866 input] (clojure.core/let [rawinput1758865 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758867 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-message-contents ([input] (response-invalid-message-contents nil input)) ([resultWrapper1758869 input] (clojure.core/let [rawinput1758868 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758870 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-queue-does-not-exist ([input] (response-queue-does-not-exist nil input)) ([resultWrapper1758872 input] (clojure.core/let [rawinput1758871 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758873 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-entries-in-batch-request ([input] (response-too-many-entries-in-batch-request nil input)) ([resultWrapper1758875 input] (clojure.core/let [rawinput1758874 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758876 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-queues-result ([input] (response-list-queues-result nil input)) ([resultWrapper1758878 input] (clojure.core/let [rawinput1758877 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758879 {"QueueUrl" (portkey.aws/search-for-tag rawinput1758877 "QueueUrl" :flattened? true :result-wrapper resultWrapper1758878)}] (clojure.core/cond-> {} (letvar1758879 "QueueUrl") (clojure.core/assoc :queue-urls (deser-queue-url-list (clojure.core/get-in letvar1758879 ["QueueUrl"])))))))

(clojure.core/defn- response-delete-message-batch-result ([input] (response-delete-message-batch-result nil input)) ([resultWrapper1758881 input] (clojure.core/let [rawinput1758880 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758882 {"DeleteMessageBatchResultEntry" (portkey.aws/search-for-tag rawinput1758880 "DeleteMessageBatchResultEntry" :flattened? true :result-wrapper resultWrapper1758881), "BatchResultErrorEntry" (portkey.aws/search-for-tag rawinput1758880 "BatchResultErrorEntry" :flattened? true :result-wrapper resultWrapper1758881)}] (clojure.core/cond-> {:successful (deser-delete-message-batch-result-entry-list (clojure.core/get-in letvar1758882 ["DeleteMessageBatchResultEntry"])), :failed (deser-batch-result-error-entry-list (clojure.core/get-in letvar1758882 ["BatchResultErrorEntry"]))}))))

(clojure.core/defn- response-batch-request-too-long ([input] (response-batch-request-too-long nil input)) ([resultWrapper1758884 input] (clojure.core/let [rawinput1758883 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758885 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-attribute-name ([input] (response-invalid-attribute-name nil input)) ([resultWrapper1758887 input] (clojure.core/let [rawinput1758886 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758888 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-queue-name-exists ([input] (response-queue-name-exists nil input)) ([resultWrapper1758890 input] (clojure.core/let [rawinput1758889 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758891 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-message-batch-result ([input] (response-send-message-batch-result nil input)) ([resultWrapper1758893 input] (clojure.core/let [rawinput1758892 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758894 {"SendMessageBatchResultEntry" (portkey.aws/search-for-tag rawinput1758892 "SendMessageBatchResultEntry" :flattened? true :result-wrapper resultWrapper1758893), "BatchResultErrorEntry" (portkey.aws/search-for-tag rawinput1758892 "BatchResultErrorEntry" :flattened? true :result-wrapper resultWrapper1758893)}] (clojure.core/cond-> {:successful (deser-send-message-batch-result-entry-list (clojure.core/get-in letvar1758894 ["SendMessageBatchResultEntry"])), :failed (deser-batch-result-error-entry-list (clojure.core/get-in letvar1758894 ["BatchResultErrorEntry"]))}))))

(clojure.core/defn- response-send-message-result ([input] (response-send-message-result nil input)) ([resultWrapper1758896 input] (clojure.core/let [rawinput1758895 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758897 {"MD5OfMessageBody" (portkey.aws/search-for-tag rawinput1758895 "MD5OfMessageBody" :flattened? nil :result-wrapper resultWrapper1758896), "MD5OfMessageAttributes" (portkey.aws/search-for-tag rawinput1758895 "MD5OfMessageAttributes" :flattened? nil :result-wrapper resultWrapper1758896), "MessageId" (portkey.aws/search-for-tag rawinput1758895 "MessageId" :flattened? nil :result-wrapper resultWrapper1758896), "SequenceNumber" (portkey.aws/search-for-tag rawinput1758895 "SequenceNumber" :flattened? nil :result-wrapper resultWrapper1758896)}] (clojure.core/cond-> {} (letvar1758897 "MD5OfMessageBody") (clojure.core/assoc :md-5-of-message-body (deser-string (clojure.core/get-in letvar1758897 ["MD5OfMessageBody" :content]))) (letvar1758897 "MD5OfMessageAttributes") (clojure.core/assoc :md-5-of-message-attributes (deser-string (clojure.core/get-in letvar1758897 ["MD5OfMessageAttributes" :content]))) (letvar1758897 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar1758897 ["MessageId" :content]))) (letvar1758897 "SequenceNumber") (clojure.core/assoc :sequence-number (deser-string (clojure.core/get-in letvar1758897 ["SequenceNumber" :content])))))))

(clojure.core/defn- response-invalid-batch-entry-id ([input] (response-invalid-batch-entry-id nil input)) ([resultWrapper1758899 input] (clojure.core/let [rawinput1758898 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758900 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-entry-ids-not-distinct ([input] (response-batch-entry-ids-not-distinct nil input)) ([resultWrapper1758902 input] (clojure.core/let [rawinput1758901 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758903 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-receipt-handle-is-invalid ([input] (response-receipt-handle-is-invalid nil input)) ([resultWrapper1758905 input] (clojure.core/let [rawinput1758904 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758906 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-queue-attributes-result ([input] (response-get-queue-attributes-result nil input)) ([resultWrapper1758908 input] (clojure.core/let [rawinput1758907 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1758909 {"Attribute" (portkey.aws/search-for-tag rawinput1758907 "Attribute" :flattened? true :result-wrapper resultWrapper1758908)}] (clojure.core/cond-> {} (letvar1758909 "Attribute") (clojure.core/assoc :attributes (deser-queue-attribute-map (clojure.core/get-in letvar1758909 ["Attribute"])))))))
