...
(clojure.spec.alpha/def :portkey.aws.apigateway/create-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.create-resource-request/restApiId :portkey.aws.apigateway.create-resource-request/parentId :portkey.aws.apigateway.create-resource-request/pathPart] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-part-location-status-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"^([1-5]\d\d|\*|\s*)$" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-stages-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-stages-request/restApiId] :opt-un [:portkey.aws.apigateway.get-stages-request/deploymentId]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-domain-name-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-domain-name-request/domainName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-resource-request/restApiId :portkey.aws.apigateway.delete-resource-request/resourceId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-usage-plan-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-usage-plan-request/usagePlanId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/unauthorized-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.unauthorized-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-resources-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-resources-request/restApiId] :opt-un [:portkey.aws.apigateway.get-resources-request/position :portkey.aws.apigateway.get-resources-request/limit :portkey.aws.apigateway.get-resources-request/embed]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/api-key-ids (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.api-key-ids/ids :portkey.aws.apigateway.api-key-ids/warnings]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-sdk-type-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-sdk-type-request/id] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-sdk-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-sdk-request/restApiId :portkey.aws.apigateway.get-sdk-request/stageName :portkey.aws.apigateway.get-sdk-request/sdkType] :opt-un [:portkey.aws.apigateway.get-sdk-request/parameters]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/bad-request-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.bad-request-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-stage-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-stage-request/restApiId :portkey.aws.apigateway.update-stage-request/stageName] :opt-un [:portkey.aws.apigateway.update-stage-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-stage-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-stage-request/restApiId :portkey.aws.apigateway.delete-stage-request/stageName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-documentation-part-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-documentation-part-request/restApiId :portkey.aws.apigateway.delete-documentation-part-request/documentationPartId] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.apigateway/status-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"[1-5]\d\d" s__8151__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/api-stage (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.api-stage/apiId :portkey.aws.apigateway.api-stage/stage]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-part (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.documentation-part/id :portkey.aws.apigateway.documentation-part/location :portkey.aws.apigateway.documentation-part/properties]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-resource-request/restApiId :portkey.aws.apigateway.get-resource-request/resourceId] :opt-un [:portkey.aws.apigateway.get-resource-request/embed]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-usage-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-usage-request/usagePlanId :portkey.aws.apigateway.get-usage-request/startDate :portkey.aws.apigateway.get-usage-request/endDate] :opt-un [:portkey.aws.apigateway.get-usage-request/keyId :portkey.aws.apigateway.get-usage-request/position :portkey.aws.apigateway.get-usage-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/method-snapshot (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.method-snapshot/authorizationType :portkey.aws.apigateway.method-snapshot/apiKeyRequired]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-base-path-mapping-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-base-path-mapping-request/domainName :portkey.aws.apigateway.update-base-path-mapping-request/basePath] :opt-un [:portkey.aws.apigateway.update-base-path-mapping-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-sdk-types-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-sdk-types-request/position :portkey.aws.apigateway.get-sdk-types-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/generate-client-certificate-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.generate-client-certificate-request/description]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/rest-apis (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.rest-apis/position :portkey.aws.apigateway.rest-apis/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-client-certificate-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-client-certificate-request/clientCertificateId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/base-path-mappings (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.base-path-mappings/position :portkey.aws.apigateway.base-path-mappings/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-deployment-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-deployment-request/restApiId :portkey.aws.apigateway.update-deployment-request/deploymentId] :opt-un [:portkey.aws.apigateway.update-deployment-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-versions (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.documentation-versions/position :portkey.aws.apigateway.documentation-versions/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-usage-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-usage-request/usagePlanId :portkey.aws.apigateway.update-usage-request/keyId] :opt-un [:portkey.aws.apigateway.update-usage-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-api-key-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-api-key-request/apiKey] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-documentation-part-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-documentation-part-request/restApiId :portkey.aws.apigateway.get-documentation-part-request/documentationPartId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/patch-operation (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.patch-operation/op :portkey.aws.apigateway.patch-operation/path :portkey.aws.apigateway.patch-operation/value :portkey.aws.apigateway.patch-operation/from]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-base-path-mappings-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-base-path-mappings-request/domainName] :opt-un [:portkey.aws.apigateway.get-base-path-mappings-request/position :portkey.aws.apigateway.get-base-path-mappings-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/stages (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.stages/item]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-authorizer-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-authorizer-request/restApiId :portkey.aws.apigateway.get-authorizer-request/authorizerId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/template (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.template/value]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/limit-exceeded-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.limit-exceeded-exception/retryAfterSeconds :portkey.aws.apigateway.limit-exceeded-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-client-certificate-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-client-certificate-request/clientCertificateId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/method-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.method-response/statusCode :portkey.aws.apigateway.method-response/responseParameters :portkey.aws.apigateway.method-response/responseModels]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-model-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-model-request/restApiId :portkey.aws.apigateway.get-model-request/modelName] :opt-un [:portkey.aws.apigateway.get-model-request/flatten]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-request-validators-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-request-validators-request/restApiId] :opt-un [:portkey.aws.apigateway.get-request-validators-request/position :portkey.aws.apigateway.get-request-validators-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/create-usage-plan-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.create-usage-plan-request/name] :opt-un [:portkey.aws.apigateway.create-usage-plan-request/description :portkey.aws.apigateway.create-usage-plan-request/apiStages :portkey.aws.apigateway.create-usage-plan-request/throttle :portkey.aws.apigateway.create-usage-plan-request/quota]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/sdk-type (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.sdk-type/id :portkey.aws.apigateway.sdk-type/friendlyName :portkey.aws.apigateway.sdk-type/description :portkey.aws.apigateway.sdk-type/configurationProperties]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/service-unavailable-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.service-unavailable-exception/retryAfterSeconds :portkey.aws.apigateway.service-unavailable-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/client-certificates (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.client-certificates/position :portkey.aws.apigateway.client-certificates/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/flush-stage-cache-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.flush-stage-cache-request/restApiId :portkey.aws.apigateway.flush-stage-cache-request/stageName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-resource-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-resource-request/restApiId :portkey.aws.apigateway.update-resource-request/resourceId] :opt-un [:portkey.aws.apigateway.update-resource-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/quota-period-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"DAY" "DAY", :day "DAY", "WEEK" "WEEK", :week "WEEK", "MONTH" "MONTH", :month "MONTH"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.apigateway/put-mode (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"merge" "merge", :merge "merge", "overwrite" "overwrite", :overwrite "overwrite"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/request-validators (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.request-validators/position :portkey.aws.apigateway.request-validators/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-method-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-method-request/restApiId :portkey.aws.apigateway.get-method-request/resourceId :portkey.aws.apigateway.get-method-request/httpMethod] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/usage-plan-keys (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.usage-plan-keys/position :portkey.aws.apigateway.usage-plan-keys/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/too-many-requests-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.too-many-requests-exception/retryAfterSeconds :portkey.aws.apigateway.too-many-requests-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-rest-api-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-rest-api-request/restApiId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-account-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.update-account-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-rest-apis-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-rest-apis-request/position :portkey.aws.apigateway.get-rest-apis-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-model-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-model-request/restApiId :portkey.aws.apigateway.delete-model-request/modelName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/throttle-settings (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.throttle-settings/burstLimit :portkey.aws.apigateway.throttle-settings/rateLimit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-model-template-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-model-template-request/restApiId :portkey.aws.apigateway.get-model-template-request/modelName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/integration-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:aws "AWS", "AWS" "AWS", :aws-proxy "AWS_PROXY", "MOCK" "MOCK", "AWS_PROXY" "AWS_PROXY", "HTTP_PROXY" "HTTP_PROXY", :http "HTTP", :http-proxy "HTTP_PROXY", "HTTP" "HTTP", :mock "MOCK"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/base-path-mapping (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.base-path-mapping/basePath :portkey.aws.apigateway.base-path-mapping/restApiId :portkey.aws.apigateway.base-path-mapping/stage]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-request-validator-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-request-validator-request/restApiId :portkey.aws.apigateway.get-request-validator-request/requestValidatorId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/op (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:remove "remove", :copy "copy", "copy" "copy", :replace "replace", :move "move", "replace" "replace", "remove" "remove", "move" "move", "add" "add", :add "add", :test "test", "test" "test"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-part-ids (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.documentation-part-ids/ids :portkey.aws.apigateway.documentation-part-ids/warnings]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-authorizers-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-authorizers-request/restApiId] :opt-un [:portkey.aws.apigateway.get-authorizers-request/position :portkey.aws.apigateway.get-authorizers-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/model (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.model/id :portkey.aws.apigateway.model/name :portkey.aws.apigateway.model/description :portkey.aws.apigateway.model/schema :portkey.aws.apigateway.model/contentType]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-domain-name-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-domain-name-request/domainName] :opt-un [:portkey.aws.apigateway.update-domain-name-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-usage-plan-key-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-usage-plan-key-request/usagePlanId :portkey.aws.apigateway.delete-usage-plan-key-request/keyId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-base-path-mapping-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-base-path-mapping-request/domainName :portkey.aws.apigateway.get-base-path-mapping-request/basePath] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.apigateway/authorizer-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"TOKEN" "TOKEN", :token "TOKEN", "COGNITO_USER_POOLS" "COGNITO_USER_POOLS", :cognito-user-pools "COGNITO_USER_POOLS"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/domain-names (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.domain-names/position :portkey.aws.apigateway.domain-names/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/conflict-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.conflict-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-domain-name-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-domain-name-request/domainName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/account (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.account/cloudwatchRoleArn :portkey.aws.apigateway.account/throttleSettings :portkey.aws.apigateway.account/features :portkey.aws.apigateway.account/apiKeyVersion]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-usage-plan-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-usage-plan-request/usagePlanId] :opt-un [:portkey.aws.apigateway.update-usage-plan-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-gateway-responses-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-gateway-responses-request/restApiId] :opt-un [:portkey.aws.apigateway.get-gateway-responses-request/position :portkey.aws.apigateway.get-gateway-responses-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/create-deployment-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.create-deployment-request/restApiId] :opt-un [:portkey.aws.apigateway.create-deployment-request/stageName :portkey.aws.apigateway.create-deployment-request/stageDescription :portkey.aws.apigateway.create-deployment-request/description :portkey.aws.apigateway.create-deployment-request/cacheClusterEnabled :portkey.aws.apigateway.create-deployment-request/cacheClusterSize :portkey.aws.apigateway.create-deployment-request/variables]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/resources (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.resources/position :portkey.aws.apigateway.resources/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-documentation-version-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-documentation-version-request/restApiId :portkey.aws.apigateway.get-documentation-version-request/documentationVersion] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/stage-key (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.stage-key/restApiId :portkey.aws.apigateway.stage-key/stageName]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-api-keys-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-api-keys-request/position :portkey.aws.apigateway.get-api-keys-request/limit :portkey.aws.apigateway.get-api-keys-request/nameQuery :portkey.aws.apigateway.get-api-keys-request/customerId :portkey.aws.apigateway.get-api-keys-request/includeValues]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-usage-plan-keys-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-usage-plan-keys-request/usagePlanId] :opt-un [:portkey.aws.apigateway.get-usage-plan-keys-request/position :portkey.aws.apigateway.get-usage-plan-keys-request/limit :portkey.aws.apigateway.get-usage-plan-keys-request/nameQuery]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/not-found-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.not-found-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-client-certificate-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-client-certificate-request/clientCertificateId] :opt-un [:portkey.aws.apigateway.update-client-certificate-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-deployment-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-deployment-request/restApiId :portkey.aws.apigateway.get-deployment-request/deploymentId] :opt-un [:portkey.aws.apigateway.get-deployment-request/embed]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/sdk-types (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.sdk-types/position :portkey.aws.apigateway.sdk-types/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-documentation-version-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-documentation-version-request/restApiId :portkey.aws.apigateway.delete-documentation-version-request/documentationVersion] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-client-certificates-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-client-certificates-request/position :portkey.aws.apigateway.get-client-certificates-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-base-path-mapping-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-base-path-mapping-request/domainName :portkey.aws.apigateway.delete-base-path-mapping-request/basePath] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-model-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-model-request/restApiId :portkey.aws.apigateway.update-model-request/modelName] :opt-un [:portkey.aws.apigateway.update-model-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/quota-settings (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.quota-settings/limit :portkey.aws.apigateway.quota-settings/offset :portkey.aws.apigateway.quota-settings/period]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-stage-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-stage-request/restApiId :portkey.aws.apigateway.get-stage-request/stageName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/usage-plan-key (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.usage-plan-key/id :portkey.aws.apigateway.usage-plan-key/type :portkey.aws.apigateway.usage-plan-key/value :portkey.aws.apigateway.usage-plan-key/name]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-gateway-response-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-gateway-response-request/restApiId :portkey.aws.apigateway.delete-gateway-response-request/responseType] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-gateway-response-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-gateway-response-request/restApiId :portkey.aws.apigateway.get-gateway-response-request/responseType] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-domain-names-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-domain-names-request/position :portkey.aws.apigateway.get-domain-names-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/create-base-path-mapping-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.create-base-path-mapping-request/domainName :portkey.aws.apigateway.create-base-path-mapping-request/restApiId] :opt-un [:portkey.aws.apigateway.create-base-path-mapping-request/basePath :portkey.aws.apigateway.create-base-path-mapping-request/stage]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/client-certificate (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.client-certificate/clientCertificateId :portkey.aws.apigateway.client-certificate/description :portkey.aws.apigateway.client-certificate/pemEncodedCertificate :portkey.aws.apigateway.client-certificate/createdDate :portkey.aws.apigateway.client-certificate/expirationDate]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/api-keys (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.api-keys/warnings :portkey.aws.apigateway.api-keys/position :portkey.aws.apigateway.api-keys/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/usage-plans (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.usage-plans/position :portkey.aws.apigateway.usage-plans/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/authorizers (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.authorizers/position :portkey.aws.apigateway.authorizers/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-models-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-models-request/restApiId] :opt-un [:portkey.aws.apigateway.get-models-request/position :portkey.aws.apigateway.get-models-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-api-key-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-api-key-request/apiKey] :opt-un [:portkey.aws.apigateway.update-api-key-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/usage (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.usage/usagePlanId :portkey.aws.apigateway.usage/startDate :portkey.aws.apigateway.usage/endDate :portkey.aws.apigateway.usage/position :portkey.aws.apigateway.usage/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-rest-api-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-rest-api-request/restApiId] :opt-un [:portkey.aws.apigateway.update-rest-api-request/patchOperations]))

(clojure.spec.alpha/def :portkey.aws.apigateway/api-keys-format (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"csv" "csv", :csv "csv"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-documentation-versions-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-documentation-versions-request/restApiId] :opt-un [:portkey.aws.apigateway.get-documentation-versions-request/position :portkey.aws.apigateway.get-documentation-versions-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-deployments-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-deployments-request/restApiId] :opt-un [:portkey.aws.apigateway.get-deployments-request/position :portkey.aws.apigateway.get-deployments-request/limit]))

(clojure.spec.alpha/def :portkey.aws.apigateway/get-account-request (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/import-api-keys-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.import-api-keys-request/body :portkey.aws.apigateway.import-api-keys-request/format] :opt-un [:portkey.aws.apigateway.import-api-keys-request/failOnWarnings]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/resource (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.resource/id :portkey.aws.apigateway.resource/parentId :portkey.aws.apigateway.resource/pathPart :portkey.aws.apigateway.resource/path :portkey.aws.apigateway.resource/resourceMethods]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/create-usage-plan-key-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.create-usage-plan-key-request/usagePlanId :portkey.aws.apigateway.create-usage-plan-key-request/keyId :portkey.aws.apigateway.create-usage-plan-key-request/keyType] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-integration-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-integration-request/restApiId :portkey.aws.apigateway.delete-integration-request/resourceId :portkey.aws.apigateway.delete-integration-request/httpMethod] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/sdk-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.sdk-response/contentType :portkey.aws.apigateway.sdk-response/contentDisposition :portkey.aws.apigateway.sdk-response/body]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/import-rest-api-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.import-rest-api-request/body] :opt-un [:portkey.aws.apigateway.import-rest-api-request/failOnWarnings :portkey.aws.apigateway.import-rest-api-request/parameters]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/api-key (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.api-key/createdDate :portkey.aws.apigateway.api-key/enabled :portkey.aws.apigateway.api-key/id :portkey.aws.apigateway.api-key/stageKeys :portkey.aws.apigateway.api-key/customerId :portkey.aws.apigateway.api-key/name :portkey.aws.apigateway.api-key/value :portkey.aws.apigateway.api-key/lastUpdatedDate :portkey.aws.apigateway.api-key/description]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-integration-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-integration-request/restApiId :portkey.aws.apigateway.get-integration-request/resourceId :portkey.aws.apigateway.get-integration-request/httpMethod] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-parts (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.documentation-parts/position :portkey.aws.apigateway.documentation-parts/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/export-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.export-response/contentType :portkey.aws.apigateway.export-response/contentDisposition :portkey.aws.apigateway.export-response/body]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-method-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-method-request/restApiId :portkey.aws.apigateway.delete-method-request/resourceId :portkey.aws.apigateway.delete-method-request/httpMethod] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-api-key-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-api-key-request/apiKey] :opt-un [:portkey.aws.apigateway.get-api-key-request/includeValue]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/gateway-responses (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.gateway-responses/position :portkey.aws.apigateway.gateway-responses/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/flush-stage-authorizers-cache-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.flush-stage-authorizers-cache-request/restApiId :portkey.aws.apigateway.flush-stage-authorizers-cache-request/stageName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/documentation-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.documentation-version/version :portkey.aws.apigateway.documentation-version/createdDate :portkey.aws.apigateway.documentation-version/description]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-usage-plan-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-usage-plan-request/usagePlanId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-deployment-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-deployment-request/restApiId :portkey.aws.apigateway.delete-deployment-request/deploymentId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-rest-api-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.get-rest-api-request/restApiId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/models (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.models/position :portkey.aws.apigateway.models/items]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-authorizer-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-authorizer-request/restApiId :portkey.aws.apigateway.delete-authorizer-request/authorizerId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/update-authorizer-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.update-authorizer-request/restApiId :portkey.aws.apigateway.update-authorizer-request/authorizerId] :opt-un [:portkey.aws.apigateway.update-authorizer-request/patchOperations]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/delete-request-validator-request (portkey.aws/json-keys :req-un [:portkey.aws.apigateway.delete-request-validator-request/restApiId :portkey.aws.apigateway.delete-request-validator-request/requestValidatorId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/get-usage-plans-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.get-usage-plans-request/position :portkey.aws.apigateway.get-usage-plans-request/keyId :portkey.aws.apigateway.get-usage-plans-request/limit]))
...
(clojure.spec.alpha/def :portkey.aws.apigateway/deployments (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.apigateway.deployments/position :portkey.aws.apigateway.deployments/items]))

(clojure.spec.alpha/def :portkey.aws.apigateway/boolean clojure.core/boolean?)

(clojure.core/defn flush-stage-cache [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/stages/{stage_name}/cache/data" input__8278__auto__ :portkey.aws.apigateway/flush-stage-cache-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef flush-stage-cache :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/flush-stage-cache-request))

(clojure.core/defn get-usage-plan [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/usageplans/{usageplanId}" input__8278__auto__ :portkey.aws.apigateway/get-usage-plan-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId"}, :querystring {}} nil :portkey.aws.apigateway/usage-plan {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-account [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/account" input__8278__auto__ :portkey.aws.apigateway/update-account-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.apigateway/account {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef update-account :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/update-account-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/account))

(clojure.core/defn delete-rest-api [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}" input__8278__auto__ :portkey.aws.apigateway/delete-rest-api-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception}))
(clojure.spec.alpha/fdef delete-rest-api :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-rest-api-request))

(clojure.core/defn delete-method [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}" input__8278__auto__ :portkey.aws.apigateway/delete-method-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} 204 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-method :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-method-request))

(clojure.core/defn update-authorizer [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/authorizers/{authorizer_id}" input__8278__auto__ :portkey.aws.apigateway/update-authorizer-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "authorizer_id" "authorizerId"}, :querystring {}} nil :portkey.aws.apigateway/authorizer {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-sdk-type [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/sdktypes/{sdktype_id}" input__8278__auto__ :portkey.aws.apigateway/get-sdk-type-request {:payload nil, :headers {}, :uri {"sdktype_id" "id"}, :querystring {}} nil :portkey.aws.apigateway/sdk-type {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-domain-name [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/domainnames/{domain_name}" input__8278__auto__ :portkey.aws.apigateway/update-domain-name-request {:payload nil, :headers {}, :uri {"domain_name" "domainName"}, :querystring {}} nil :portkey.aws.apigateway/domain-name {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-gateway-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/gatewayresponses/{response_type}" input__8278__auto__ :portkey.aws.apigateway/update-gateway-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "response_type" "responseType"}, :querystring {}} nil :portkey.aws.apigateway/gateway-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-rest-apis [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis" input__8278__auto__ :portkey.aws.apigateway/get-rest-apis-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/rest-apis {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-rest-apis :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-rest-apis-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/rest-apis))

(clojure.core/defn get-documentation-parts [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/documentation/parts" input__8278__auto__ :portkey.aws.apigateway/get-documentation-parts-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"type" "type", "name" "nameQuery", "path" "path", "position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/documentation-parts {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-deployment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/deployments/{deployment_id}" input__8278__auto__ :portkey.aws.apigateway/get-deployment-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "deployment_id" "deploymentId"}, :querystring {"embed" "embed"}} nil :portkey.aws.apigateway/deployment {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ServiceUnavailableException" :portkey.aws.apigateway/service-unavailable-exception}))
...
(clojure.core/defn create-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/resources/{parent_id}" input__8278__auto__ :portkey.aws.apigateway/create-resource-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "parent_id" "parentId"}, :querystring {}} 201 :portkey.aws.apigateway/resource {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-documentation-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/documentation/versions/{doc_version}" input__8278__auto__ :portkey.aws.apigateway/delete-documentation-version-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "doc_version" "documentationVersion"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-documentation-version :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-documentation-version-request))

(clojure.core/defn delete-usage-plan [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/usageplans/{usageplanId}" input__8278__auto__ :portkey.aws.apigateway/delete-usage-plan-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
(clojure.spec.alpha/fdef delete-usage-plan :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-usage-plan-request))

(clojure.core/defn get-stages [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/stages" input__8278__auto__ :portkey.aws.apigateway/get-stages-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"deploymentId" "deploymentId"}} nil :portkey.aws.apigateway/stages {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources/{resource_id}" input__8278__auto__ :portkey.aws.apigateway/get-resource-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId"}, :querystring {"embed" "embed"}} nil :portkey.aws.apigateway/resource {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-documentation-part [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/documentation/parts/{part_id}" input__8278__auto__ :portkey.aws.apigateway/update-documentation-part-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "part_id" "documentationPartId"}, :querystring {}} nil :portkey.aws.apigateway/documentation-part {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-client-certificate [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/clientcertificates/{clientcertificate_id}" input__8278__auto__ :portkey.aws.apigateway/get-client-certificate-request {:payload nil, :headers {}, :uri {"clientcertificate_id" "clientCertificateId"}, :querystring {}} nil :portkey.aws.apigateway/client-certificate {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-gateway-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/gatewayresponses/{response_type}" input__8278__auto__ :portkey.aws.apigateway/get-gateway-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "response_type" "responseType"}, :querystring {}} nil :portkey.aws.apigateway/gateway-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-deployments [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/deployments" input__8278__auto__ :portkey.aws.apigateway/get-deployments-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/deployments {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ServiceUnavailableException" :portkey.aws.apigateway/service-unavailable-exception}))
...
(clojure.core/defn update-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/resources/{resource_id}" input__8278__auto__ :portkey.aws.apigateway/update-resource-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId"}, :querystring {}} nil :portkey.aws.apigateway/resource {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-authorizers [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/authorizers" input__8278__auto__ :portkey.aws.apigateway/get-authorizers-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/authorizers {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-base-path-mapping [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/domainnames/{domain_name}/basepathmappings/{base_path}" input__8278__auto__ :portkey.aws.apigateway/get-base-path-mapping-request {:payload nil, :headers {}, :uri {"domain_name" "domainName", "base_path" "basePath"}, :querystring {}} nil :portkey.aws.apigateway/base-path-mapping {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-integration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration" input__8278__auto__ :portkey.aws.apigateway/delete-integration-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} 204 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-integration :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-integration-request))

(clojure.core/defn get-request-validators [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/requestvalidators" input__8278__auto__ :portkey.aws.apigateway/get-request-validators-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/request-validators {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-domain-name [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/domainnames" input__8278__auto__ :portkey.aws.apigateway/create-domain-name-request {:payload nil, :headers {}, :uri {}, :querystring {}} 201 :portkey.aws.apigateway/domain-name {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-usage-plan [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/usageplans" input__8278__auto__ :portkey.aws.apigateway/create-usage-plan-request {:payload nil, :headers {}, :uri {}, :querystring {}} 201 :portkey.aws.apigateway/usage-plan {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
...
(clojure.core/defn create-api-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/apikeys" input__8278__auto__ :portkey.aws.apigateway/create-api-key-request {:payload nil, :headers {}, :uri {}, :querystring {}} 201 :portkey.aws.apigateway/api-key {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef create-api-key :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/create-api-key-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/api-key))

(clojure.core/defn import-rest-api [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis?mode=import" input__8278__auto__ :portkey.aws.apigateway/import-rest-api-request {:payload "body", :headers {}, :uri {}, :querystring {"failonwarnings" "failOnWarnings", nil "parameters"}} 201 :portkey.aws.apigateway/rest-api {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
...
(clojure.core/defn delete-api-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/apikeys/{api_Key}" input__8278__auto__ :portkey.aws.apigateway/delete-api-key-request {:payload nil, :headers {}, :uri {"api_Key" "apiKey"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-api-key :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-api-key-request))

(clojure.core/defn get-integration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration" input__8278__auto__ :portkey.aws.apigateway/get-integration-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} nil :portkey.aws.apigateway/integration {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-stage [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/stages/{stage_name}" input__8278__auto__ :portkey.aws.apigateway/delete-stage-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception}))
(clojure.spec.alpha/fdef delete-stage :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-stage-request))

(clojure.core/defn delete-request-validator [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/requestvalidators/{requestvalidator_id}" input__8278__auto__ :portkey.aws.apigateway/delete-request-validator-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "requestvalidator_id" "requestValidatorId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-request-validator :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-request-validator-request))

(clojure.core/defn get-gateway-responses [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/gatewayresponses" input__8278__auto__ :portkey.aws.apigateway/get-gateway-responses-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/gateway-responses {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn put-method-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/put-method-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} 201 :portkey.aws.apigateway/method-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-model [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/models" input__8278__auto__ :portkey.aws.apigateway/create-model-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/model {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-api-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/apikeys/{api_Key}" input__8278__auto__ :portkey.aws.apigateway/update-api-key-request {:payload nil, :headers {}, :uri {"api_Key" "apiKey"}, :querystring {}} nil :portkey.aws.apigateway/api-key {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
...
(clojure.core/defn create-deployment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/deployments" input__8278__auto__ :portkey.aws.apigateway/create-deployment-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/deployment {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ServiceUnavailableException" :portkey.aws.apigateway/service-unavailable-exception}))
...
(clojure.core/defn update-method [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}" input__8278__auto__ :portkey.aws.apigateway/update-method-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} nil :portkey.aws.apigateway/method {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-documentation-part [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/documentation/parts" input__8278__auto__ :portkey.aws.apigateway/create-documentation-part-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/documentation-part {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-stage [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/stages/{stage_name}" input__8278__auto__ :portkey.aws.apigateway/update-stage-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName"}, :querystring {}} nil :portkey.aws.apigateway/stage {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-sdk-types [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/sdktypes" input__8278__auto__ :portkey.aws.apigateway/get-sdk-types-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/sdk-types {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-sdk-types :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-sdk-types-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/sdk-types))

(clojure.core/defn update-client-certificate [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/clientcertificates/{clientcertificate_id}" input__8278__auto__ :portkey.aws.apigateway/update-client-certificate-request {:payload nil, :headers {}, :uri {"clientcertificate_id" "clientCertificateId"}, :querystring {}} nil :portkey.aws.apigateway/client-certificate {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
...
(clojure.core/defn update-model [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/models/{model_name}" input__8278__auto__ :portkey.aws.apigateway/update-model-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "model_name" "modelName"}, :querystring {}} nil :portkey.aws.apigateway/model {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-documentation-versions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/documentation/versions" input__8278__auto__ :portkey.aws.apigateway/get-documentation-versions-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/documentation-versions {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-usage [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/usageplans/{usageplanId}/keys/{keyId}/usage" input__8278__auto__ :portkey.aws.apigateway/update-usage-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId", "keyId" "keyId"}, :querystring {}} nil :portkey.aws.apigateway/usage {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
...
(clojure.core/defn put-integration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration" input__8278__auto__ :portkey.aws.apigateway/put-integration-request {:payload nil, :headers {}, :uri {"resource_id" "resourceId", "http_method" "httpMethod", "restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/integration {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-documentation-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/documentation/versions/{doc_version}" input__8278__auto__ :portkey.aws.apigateway/update-documentation-version-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "doc_version" "documentationVersion"}, :querystring {}} nil :portkey.aws.apigateway/documentation-version {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-stage [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/stages/{stage_name}" input__8278__auto__ :portkey.aws.apigateway/get-stage-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName"}, :querystring {}} nil :portkey.aws.apigateway/stage {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-method-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/update-method-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} 201 :portkey.aws.apigateway/method-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-base-path-mapping [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/domainnames/{domain_name}/basepathmappings" input__8278__auto__ :portkey.aws.apigateway/create-base-path-mapping-request {:payload nil, :headers {}, :uri {"domain_name" "domainName"}, :querystring {}} 201 :portkey.aws.apigateway/base-path-mapping {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-documentation-part [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/documentation/parts/{part_id}" input__8278__auto__ :portkey.aws.apigateway/get-documentation-part-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "part_id" "documentationPartId"}, :querystring {}} nil :portkey.aws.apigateway/documentation-part {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-model [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/models/{model_name}" input__8278__auto__ :portkey.aws.apigateway/delete-model-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "model_name" "modelName"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-model :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-model-request))

(clojure.core/defn import-documentation-parts [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}/documentation/parts" input__8278__auto__ :portkey.aws.apigateway/import-documentation-parts-request {:payload "body", :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"mode" "mode", "failonwarnings" "failOnWarnings"}} nil :portkey.aws.apigateway/documentation-part-ids {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-method-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/delete-method-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} 204 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-method-response :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-method-response-request))

(clojure.core/defn get-client-certificates [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/clientcertificates" input__8278__auto__ :portkey.aws.apigateway/get-client-certificates-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/client-certificates {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-client-certificates :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-client-certificates-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/client-certificates))

(clojure.core/defn get-api-keys [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/apikeys" input__8278__auto__ :portkey.aws.apigateway/get-api-keys-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "limit" "limit", "name" "nameQuery", "customerId" "customerId", "includeValues" "includeValues"}} nil :portkey.aws.apigateway/api-keys {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-api-keys :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-api-keys-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/api-keys))

(clojure.core/defn update-deployment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/deployments/{deployment_id}" input__8278__auto__ :portkey.aws.apigateway/update-deployment-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "deployment_id" "deploymentId"}, :querystring {}} nil :portkey.aws.apigateway/deployment {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ServiceUnavailableException" :portkey.aws.apigateway/service-unavailable-exception}))
...
(clojure.core/defn delete-domain-name [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/domainnames/{domain_name}" input__8278__auto__ :portkey.aws.apigateway/delete-domain-name-request {:payload nil, :headers {}, :uri {"domain_name" "domainName"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-domain-name :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-domain-name-request))

(clojure.core/defn create-rest-api [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis" input__8278__auto__ :portkey.aws.apigateway/create-rest-api-request {:payload nil, :headers {}, :uri {}, :querystring {}} 201 :portkey.aws.apigateway/rest-api {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-authorizer [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/authorizers/{authorizer_id}" input__8278__auto__ :portkey.aws.apigateway/delete-authorizer-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "authorizer_id" "authorizerId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-authorizer :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-authorizer-request))

(clojure.core/defn get-usage-plan-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/usageplans/{usageplanId}/keys/{keyId}" input__8278__auto__ :portkey.aws.apigateway/get-usage-plan-key-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId", "keyId" "keyId"}, :querystring {}} 200 :portkey.aws.apigateway/usage-plan-key {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-resource [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/resources/{resource_id}" input__8278__auto__ :portkey.aws.apigateway/delete-resource-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-resource :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-resource-request))

(clojure.core/defn test-invoke-method [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}" input__8278__auto__ :portkey.aws.apigateway/test-invoke-method-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} nil :portkey.aws.apigateway/test-invoke-method-response {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-method-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/get-method-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} nil :portkey.aws.apigateway/method-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-authorizer [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/authorizers/{authorizer_id}" input__8278__auto__ :portkey.aws.apigateway/get-authorizer-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "authorizer_id" "authorizerId"}, :querystring {}} nil :portkey.aws.apigateway/authorizer {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-base-path-mappings [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/domainnames/{domain_name}/basepathmappings" input__8278__auto__ :portkey.aws.apigateway/get-base-path-mappings-request {:payload nil, :headers {}, :uri {"domain_name" "domainName"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/base-path-mappings {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-base-path-mapping [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/domainnames/{domain_name}/basepathmappings/{base_path}" input__8278__auto__ :portkey.aws.apigateway/delete-base-path-mapping-request {:payload nil, :headers {}, :uri {"domain_name" "domainName", "base_path" "basePath"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-base-path-mapping :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-base-path-mapping-request))

(clojure.core/defn get-account [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/account" input__8278__auto__ :portkey.aws.apigateway/get-account-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.apigateway/account {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-account :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-account-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/account))

(clojure.core/defn get-integration-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/get-integration-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} nil :portkey.aws.apigateway/integration-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-model-template [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/models/{model_name}/default_template" input__8278__auto__ :portkey.aws.apigateway/get-model-template-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "model_name" "modelName"}, :querystring {}} nil :portkey.aws.apigateway/template {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-rest-api [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}" input__8278__auto__ :portkey.aws.apigateway/get-rest-api-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} nil :portkey.aws.apigateway/rest-api {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-integration-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/delete-integration-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} 204 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-integration-response :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-integration-response-request))

(clojure.core/defn delete-usage-plan-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/usageplans/{usageplanId}/keys/{keyId}" input__8278__auto__ :portkey.aws.apigateway/delete-usage-plan-key-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId", "keyId" "keyId"}, :querystring {}} 202 nil {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-usage-plan-key :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-usage-plan-key-request))

(clojure.core/defn delete-documentation-part [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/documentation/parts/{part_id}" input__8278__auto__ :portkey.aws.apigateway/delete-documentation-part-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "part_id" "documentationPartId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception}))
(clojure.spec.alpha/fdef delete-documentation-part :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-documentation-part-request))

(clojure.core/defn generate-client-certificate [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/clientcertificates" input__8278__auto__ :portkey.aws.apigateway/generate-client-certificate-request {:payload nil, :headers {}, :uri {}, :querystring {}} 201 :portkey.aws.apigateway/client-certificate {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception}))
(clojure.spec.alpha/fdef generate-client-certificate :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/generate-client-certificate-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/client-certificate))

(clojure.core/defn get-method [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}" input__8278__auto__ :portkey.aws.apigateway/get-method-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} nil :portkey.aws.apigateway/method {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-models [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/models" input__8278__auto__ :portkey.aws.apigateway/get-models-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/models {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-documentation-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/documentation/versions/{doc_version}" input__8278__auto__ :portkey.aws.apigateway/get-documentation-version-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "doc_version" "documentationVersion"}, :querystring {}} nil :portkey.aws.apigateway/documentation-version {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-documentation-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/documentation/versions" input__8278__auto__ :portkey.aws.apigateway/create-documentation-version-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/documentation-version {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-resources [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/resources" input__8278__auto__ :portkey.aws.apigateway/get-resources-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"position" "position", "limit" "limit", "embed" "embed"}} nil :portkey.aws.apigateway/resources {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-api-key [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/apikeys/{api_Key}" input__8278__auto__ :portkey.aws.apigateway/get-api-key-request {:payload nil, :headers {}, :uri {"api_Key" "apiKey"}, :querystring {"includeValue" "includeValue"}} nil :portkey.aws.apigateway/api-key {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn create-stage [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/stages" input__8278__auto__ :portkey.aws.apigateway/create-stage-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/stage {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-gateway-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/gatewayresponses/{response_type}" input__8278__auto__ :portkey.aws.apigateway/delete-gateway-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "response_type" "responseType"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
(clojure.spec.alpha/fdef delete-gateway-response :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-gateway-response-request))

(clojure.core/defn update-integration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration" input__8278__auto__ :portkey.aws.apigateway/update-integration-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod"}, :querystring {}} nil :portkey.aws.apigateway/integration {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
...
(clojure.core/defn flush-stage-authorizers-cache [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/stages/{stage_name}/cache/authorizers" input__8278__auto__ :portkey.aws.apigateway/flush-stage-authorizers-cache-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef flush-stage-authorizers-cache :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/flush-stage-authorizers-cache-request))

(clojure.core/defn delete-client-certificate [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/clientcertificates/{clientcertificate_id}" input__8278__auto__ :portkey.aws.apigateway/delete-client-certificate-request {:payload nil, :headers {}, :uri {"clientcertificate_id" "clientCertificateId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
(clojure.spec.alpha/fdef delete-client-certificate :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-client-certificate-request))

(clojure.core/defn put-gateway-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}/gatewayresponses/{response_type}" input__8278__auto__ :portkey.aws.apigateway/put-gateway-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "response_type" "responseType"}, :querystring {}} 201 :portkey.aws.apigateway/gateway-response {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-domain-name [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/domainnames/{domain_name}" input__8278__auto__ :portkey.aws.apigateway/get-domain-name-request {:payload nil, :headers {}, :uri {"domain_name" "domainName"}, :querystring {}} nil :portkey.aws.apigateway/domain-name {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ServiceUnavailableException" :portkey.aws.apigateway/service-unavailable-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-base-path-mapping [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/domainnames/{domain_name}/basepathmappings/{base_path}" input__8278__auto__ :portkey.aws.apigateway/update-base-path-mapping-request {:payload nil, :headers {}, :uri {"domain_name" "domainName", "base_path" "basePath"}, :querystring {}} nil :portkey.aws.apigateway/base-path-mapping {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-usage-plans [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/usageplans" input__8278__auto__ :portkey.aws.apigateway/get-usage-plans-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "keyId" "keyId", "limit" "limit"}} nil :portkey.aws.apigateway/usage-plans {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception}))
(clojure.spec.alpha/fdef get-usage-plans :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-usage-plans-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/usage-plans))

(clojure.core/defn update-usage-plan [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/usageplans/{usageplanId}" input__8278__auto__ :portkey.aws.apigateway/update-usage-plan-request {:payload nil, :headers {}, :uri {"usageplanId" "usagePlanId"}, :querystring {}} nil :portkey.aws.apigateway/usage-plan {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
...
(clojure.core/defn get-sdk [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/restapis/{restapi_id}/stages/{stage_name}/sdks/{sdk_type}" input__8278__auto__ :portkey.aws.apigateway/get-sdk-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "stage_name" "stageName", "sdk_type" "sdkType"}, :querystring {nil "parameters"}} 200 :portkey.aws.apigateway/sdk-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn put-method [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}" input__8278__auto__ :portkey.aws.apigateway/put-method-request {:payload nil, :headers {}, :uri {"resource_id" "resourceId", "http_method" "httpMethod", "restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/method {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn update-integration-response [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PATCH" "/restapis/{restapi_id}/resources/{resource_id}/methods/{http_method}/integration/responses/{status_code}" input__8278__auto__ :portkey.aws.apigateway/update-integration-response-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "resource_id" "resourceId", "http_method" "httpMethod", "status_code" "statusCode"}, :querystring {}} nil :portkey.aws.apigateway/integration-response {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn get-domain-names [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "GET" "/domainnames" input__8278__auto__ :portkey.aws.apigateway/get-domain-names-request {:payload nil, :headers {}, :uri {}, :querystring {"position" "position", "limit" "limit"}} nil :portkey.aws.apigateway/domain-names {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef get-domain-names :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/get-domain-names-request) :ret (clojure.spec.alpha/and :portkey.aws.apigateway/domain-names))

(clojure.core/defn put-rest-api [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "PUT" "/restapis/{restapi_id}" input__8278__auto__ :portkey.aws.apigateway/put-rest-api-request {:payload "body", :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {"mode" "mode", "failonwarnings" "failOnWarnings", nil "parameters"}} nil :portkey.aws.apigateway/rest-api {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception, "ConflictException" :portkey.aws.apigateway/conflict-exception}))
...
(clojure.core/defn create-request-validator [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "POST" "/restapis/{restapi_id}/requestvalidators" input__8278__auto__ :portkey.aws.apigateway/create-request-validator-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId"}, :querystring {}} 201 :portkey.aws.apigateway/request-validator {"BadRequestException" :portkey.aws.apigateway/bad-request-exception, "UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "LimitExceededException" :portkey.aws.apigateway/limit-exceeded-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
...
(clojure.core/defn delete-deployment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.apigateway/endpoints "DELETE" "/restapis/{restapi_id}/deployments/{deployment_id}" input__8278__auto__ :portkey.aws.apigateway/delete-deployment-request {:payload nil, :headers {}, :uri {"restapi_id" "restApiId", "deployment_id" "deploymentId"}, :querystring {}} 202 nil {"UnauthorizedException" :portkey.aws.apigateway/unauthorized-exception, "NotFoundException" :portkey.aws.apigateway/not-found-exception, "BadRequestException" :portkey.aws.apigateway/bad-request-exception, "TooManyRequestsException" :portkey.aws.apigateway/too-many-requests-exception}))
(clojure.spec.alpha/fdef delete-deployment :args (clojure.spec.alpha/tuple :portkey.aws.apigateway/delete-deployment-request))
