...
(clojure.spec.alpha/def :portkey.aws.greengrass/device-definition-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.device-definition-version/Devices]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-function-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-function-definition-request/FunctionDefinitionId] :opt-un [:portkey.aws.greengrass.update-function-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-core-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-core-definition-version-response/Arn :portkey.aws.greengrass.get-core-definition-version-response/CreationTimestamp :portkey.aws.greengrass.get-core-definition-version-response/Definition :portkey.aws.greengrass.get-core-definition-version-response/Id :portkey.aws.greengrass.get-core-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/internal-server-error-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass/ErrorDetails :portkey.aws.greengrass.internal-server-error-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/group-certificate-authority-properties (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.group-certificate-authority-properties/GroupCertificateAuthorityArn :portkey.aws.greengrass.group-certificate-authority-properties/GroupCertificateAuthorityId]))

(clojure.spec.alpha/def :portkey.aws.greengrass/empty (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-core-definition-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-core-definition-request/AmznClientToken :portkey.aws.greengrass.create-core-definition-request/InitialVersion :portkey.aws.greengrass.create-core-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/definition-information (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.definition-information/Arn :portkey.aws.greengrass.definition-information/CreationTimestamp :portkey.aws.greengrass.definition-information/Id :portkey.aws.greengrass.definition-information/LastUpdatedTimestamp :portkey.aws.greengrass.definition-information/LatestVersion :portkey.aws.greengrass.definition-information/LatestVersionArn :portkey.aws.greengrass.definition-information/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-core-definition-versions-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.list-core-definition-versions-request/CoreDefinitionId] :opt-un [:portkey.aws.greengrass.list-core-definition-versions-request/MaxResults :portkey.aws.greengrass.list-core-definition-versions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-device-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-device-definition-version-response/Arn :portkey.aws.greengrass.create-device-definition-version-response/CreationTimestamp :portkey.aws.greengrass.create-device-definition-version-response/Id :portkey.aws.greengrass.create-device-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-function-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-function-definition-version-response/Arn :portkey.aws.greengrass.get-function-definition-version-response/CreationTimestamp :portkey.aws.greengrass.get-function-definition-version-response/Definition :portkey.aws.greengrass.get-function-definition-version-response/Id :portkey.aws.greengrass.get-function-definition-version-response/Version]))

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-logger-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-function-definition-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-function-definition-versions-response/NextToken :portkey.aws.greengrass.list-function-definition-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-core-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.create-core-definition-version-request/CoreDefinitionId] :opt-un [:portkey.aws.greengrass.create-core-definition-version-request/AmznClientToken :portkey.aws.greengrass.create-core-definition-version-request/Cores]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/associate-role-to-group-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.associate-role-to-group-request/GroupId] :opt-un [:portkey.aws.greengrass.associate-role-to-group-request/RoleArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/deployment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.deployment/CreatedAt :portkey.aws.greengrass.deployment/DeploymentArn :portkey.aws.greengrass.deployment/DeploymentId :portkey.aws.greengrass.deployment/GroupArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/bad-request-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass/ErrorDetails :portkey.aws.greengrass.bad-request-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-device-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-device-definition-request/DeviceDefinitionId] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.greengrass/deployment-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"NewDeployment" "NewDeployment", :new-deployment "NewDeployment", "Redeployment" "Redeployment", :redeployment "Redeployment"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-subscription-definition-versions-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.list-subscription-definition-versions-request/SubscriptionDefinitionId] :opt-un [:portkey.aws.greengrass.list-subscription-definition-versions-request/MaxResults :portkey.aws.greengrass.list-subscription-definition-versions-request/NextToken]))

(clojure.spec.alpha/def :portkey.aws.greengrass/logger-level (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {:warn "WARN", "WARN" "WARN", :debug "DEBUG", "ERROR" "ERROR", :fatal "FATAL", "DEBUG" "DEBUG", "FATAL" "FATAL", :info "INFO", :error "ERROR", "INFO" "INFO"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.greengrass/get-service-role-for-account-request (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/connectivity-info (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.connectivity-info/HostAddress :portkey.aws.greengrass.connectivity-info/Id :portkey.aws.greengrass.connectivity-info/Metadata :portkey.aws.greengrass.connectivity-info/PortNumber]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/associate-service-role-to-account-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.associate-service-role-to-account-request/RoleArn]))

(clojure.spec.alpha/def :portkey.aws.greengrass/update-logger-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-subscription-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-subscription-definition-version-request/SubscriptionDefinitionId :portkey.aws.greengrass.get-subscription-definition-version-request/SubscriptionDefinitionVersionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-function-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-function-definitions-response/Definitions :portkey.aws.greengrass.list-function-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-core-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-core-definitions-request/MaxResults :portkey.aws.greengrass.list-core-definitions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/associate-service-role-to-account-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.associate-service-role-to-account-response/AssociatedAt]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-associated-role-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-associated-role-response/AssociatedAt :portkey.aws.greengrass.get-associated-role-response/RoleArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-group-certificate-authority-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.create-group-certificate-authority-request/GroupId] :opt-un [:portkey.aws.greengrass.create-group-certificate-authority-request/AmznClientToken]))

(clojure.spec.alpha/def :portkey.aws.greengrass/update-function-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-certificate-authority-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-group-certificate-authority-response/GroupCertificateAuthorityArn :portkey.aws.greengrass.get-group-certificate-authority-response/GroupCertificateAuthorityId :portkey.aws.greengrass.get-group-certificate-authority-response/PemEncodedCertificate]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-core-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-core-definitions-response/Definitions :portkey.aws.greengrass.list-core-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/disassociate-role-from-group-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.disassociate-role-from-group-response/DisassociatedAt]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-function-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-function-definition-version-request/FunctionDefinitionId :portkey.aws.greengrass.get-function-definition-version-request/FunctionDefinitionVersionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-associated-role-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-associated-role-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-device-definition-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-device-definition-versions-response/NextToken :portkey.aws.greengrass.list-device-definition-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/function-definition-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.function-definition-version/Functions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/logger-definition-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.logger-definition-version/Loggers]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-subscription-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-subscription-definition-request/SubscriptionDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-device-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-device-definition-version-request/DeviceDefinitionVersionId :portkey.aws.greengrass.get-device-definition-version-request/DeviceDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-subscription-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-subscription-definitions-request/MaxResults :portkey.aws.greengrass.list-subscription-definitions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-subscription-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-subscription-definition-request/SubscriptionDefinitionId] :opt-un [:portkey.aws.greengrass.update-subscription-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-group-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/disassociate-role-from-group-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.disassociate-role-from-group-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-group-versions-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.list-group-versions-request/GroupId] :opt-un [:portkey.aws.greengrass.list-group-versions-request/MaxResults :portkey.aws.greengrass.list-group-versions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-groups-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-groups-response/Groups :portkey.aws.greengrass.list-groups-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/group-certificate-configuration (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.group-certificate-configuration/CertificateAuthorityExpiryInMilliseconds :portkey.aws.greengrass.group-certificate-configuration/CertificateExpiryInMilliseconds :portkey.aws.greengrass.group-certificate-configuration/GroupId]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-device-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-device-definitions-request/MaxResults :portkey.aws.greengrass.list-device-definitions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-subscription-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-subscription-definition-version-response/Arn :portkey.aws.greengrass.create-subscription-definition-version-response/CreationTimestamp :portkey.aws.greengrass.create-subscription-definition-version-response/Id :portkey.aws.greengrass.create-subscription-definition-version-response/Version]))

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-group-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/associate-role-to-group-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.associate-role-to-group-response/AssociatedAt]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-connectivity-info-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-connectivity-info-request/ThingName] :opt-un [:portkey.aws.greengrass.update-connectivity-info-request/ConnectivityInfo]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/version-information (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.version-information/Arn :portkey.aws.greengrass.version-information/CreationTimestamp :portkey.aws.greengrass.version-information/Id :portkey.aws.greengrass.version-information/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-function-definition-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-function-definition-request/AmznClientToken :portkey.aws.greengrass.create-function-definition-request/InitialVersion :portkey.aws.greengrass.create-function-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-logger-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-logger-definitions-request/MaxResults :portkey.aws.greengrass.list-logger-definitions-request/NextToken]))

(clojure.spec.alpha/def :portkey.aws.greengrass/update-core-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.greengrass/update-device-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-device-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-device-definitions-response/Definitions :portkey.aws.greengrass.list-device-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/group-information (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.group-information/Arn :portkey.aws.greengrass.group-information/CreationTimestamp :portkey.aws.greengrass.group-information/Id :portkey.aws.greengrass.group-information/LastUpdatedTimestamp :portkey.aws.greengrass.group-information/LatestVersion :portkey.aws.greengrass.group-information/LatestVersionArn :portkey.aws.greengrass.group-information/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-function-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-function-definition-request/FunctionDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/error-detail (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.error-detail/DetailedErrorCode :portkey.aws.greengrass.error-detail/DetailedErrorMessage]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-subscription-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-subscription-definition-version-response/Arn :portkey.aws.greengrass.get-subscription-definition-version-response/CreationTimestamp :portkey.aws.greengrass.get-subscription-definition-version-response/Definition :portkey.aws.greengrass.get-subscription-definition-version-response/Id :portkey.aws.greengrass.get-subscription-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-logger-definition-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-logger-definition-versions-response/NextToken :portkey.aws.greengrass.list-logger-definition-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-logger-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-logger-definition-version-request/LoggerDefinitionVersionId :portkey.aws.greengrass.get-logger-definition-version-request/LoggerDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-logger-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-logger-definitions-response/Definitions :portkey.aws.greengrass.list-logger-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-service-role-for-account-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-service-role-for-account-response/AssociatedAt :portkey.aws.greengrass.get-service-role-for-account-response/RoleArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-group-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-group-versions-response/NextToken :portkey.aws.greengrass.list-group-versions-response/Versions]))

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-function-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-connectivity-info-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-connectivity-info-response/ConnectivityInfo :portkey.aws.greengrass.get-connectivity-info-response/Message]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-deployments-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.list-deployments-request/GroupId] :opt-un [:portkey.aws.greengrass.list-deployments-request/MaxResults :portkey.aws.greengrass.list-deployments-request/NextToken]))

(clojure.spec.alpha/def :portkey.aws.greengrass/--boolean clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-core-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/disassociate-service-role-from-account-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.disassociate-service-role-from-account-response/DisassociatedAt]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-group-certificate-authorities-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-group-certificate-authorities-response/GroupCertificateAuthorities]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/core-definition-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.core-definition-version/Cores]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-deployment-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.create-deployment-request/GroupId] :opt-un [:portkey.aws.greengrass.create-deployment-request/AmznClientToken :portkey.aws.greengrass.create-deployment-request/DeploymentId :portkey.aws.greengrass/DeploymentType :portkey.aws.greengrass.create-deployment-request/GroupVersionId]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-versions-response/NextToken :portkey.aws.greengrass.list-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/subscription-definition-version (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.subscription-definition-version/Subscriptions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-group-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-group-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-subscription-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-subscription-definition-request/SubscriptionDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-group-certificate-authorities-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.list-group-certificate-authorities-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-core-definition-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-core-definition-versions-response/NextToken :portkey.aws.greengrass.list-core-definition-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-group-certificate-authority-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-group-certificate-authority-response/GroupCertificateAuthorityArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-logger-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-logger-definition-request/LoggerDefinitionId] :opt-un [:portkey.aws.greengrass.update-logger-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-core-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-core-definition-version-response/Arn :portkey.aws.greengrass.create-core-definition-version-response/CreationTimestamp :portkey.aws.greengrass.create-core-definition-version-response/Id :portkey.aws.greengrass.create-core-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-core-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-core-definition-request/CoreDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-deployment-status-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-deployment-status-request/GroupId :portkey.aws.greengrass.get-deployment-status-request/DeploymentId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-core-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-core-definition-request/CoreDefinitionId] :opt-un [:portkey.aws.greengrass.update-core-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-subscription-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-subscription-definitions-response/Definitions :portkey.aws.greengrass.list-subscription-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-group-version-response/Arn :portkey.aws.greengrass.get-group-version-response/CreationTimestamp :portkey.aws.greengrass.get-group-version-response/Definition :portkey.aws.greengrass.get-group-version-response/Id :portkey.aws.greengrass.get-group-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-core-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-core-definition-version-request/CoreDefinitionId :portkey.aws.greengrass.get-core-definition-version-request/CoreDefinitionVersionId] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.greengrass/update-subscription-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-device-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.get-device-definition-version-response/Arn :portkey.aws.greengrass.get-device-definition-version-response/CreationTimestamp :portkey.aws.greengrass.get-device-definition-version-response/Definition :portkey.aws.greengrass.get-device-definition-version-response/Id :portkey.aws.greengrass.get-device-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-function-definition-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-function-definition-version-response/Arn :portkey.aws.greengrass.create-function-definition-version-response/CreationTimestamp :portkey.aws.greengrass.create-function-definition-version-response/Id :portkey.aws.greengrass.create-function-definition-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-groups-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-groups-request/MaxResults :portkey.aws.greengrass.list-groups-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-subscription-definition-versions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-subscription-definition-versions-response/NextToken :portkey.aws.greengrass.list-subscription-definition-versions-response/Versions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/function-configuration-environment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.function-configuration-environment/Variables]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-function-definitions-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-function-definitions-request/MaxResults :portkey.aws.greengrass.list-function-definitions-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-logger-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-logger-definition-request/LoggerDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/subscription (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.subscription/Id :portkey.aws.greengrass.subscription/Source :portkey.aws.greengrass.subscription/Subject :portkey.aws.greengrass.subscription/Target]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-group-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-group-request/AmznClientToken :portkey.aws.greengrass.create-group-request/InitialVersion :portkey.aws.greengrass.create-group-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/core (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.core/CertificateArn :portkey.aws.greengrass.core/Id :portkey.aws.greengrass.core/SyncShadow :portkey.aws.greengrass.core/ThingArn]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-group-version-request/GroupVersionId :portkey.aws.greengrass.get-group-version-request/GroupId] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.greengrass/disassociate-service-role-from-account-request (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-subscription-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.create-subscription-definition-version-request/SubscriptionDefinitionId] :opt-un [:portkey.aws.greengrass.create-subscription-definition-version-request/AmznClientToken :portkey.aws.greengrass.create-subscription-definition-version-request/Subscriptions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-certificate-configuration-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-group-certificate-configuration-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-deployments-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass/Deployments :portkey.aws.greengrass.list-deployments-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-function-definition-version-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.create-function-definition-version-request/FunctionDefinitionId] :opt-un [:portkey.aws.greengrass.create-function-definition-version-request/AmznClientToken :portkey.aws.greengrass.create-function-definition-version-request/Functions]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-group-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/function (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.function/FunctionArn :portkey.aws.greengrass/FunctionConfiguration :portkey.aws.greengrass.function/Id]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-deployment-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-deployment-response/DeploymentArn :portkey.aws.greengrass.create-deployment-response/DeploymentId]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-logger-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-logger-definition-request/LoggerDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/delete-device-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.delete-device-definition-request/DeviceDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-subscription-definition-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-subscription-definition-request/AmznClientToken :portkey.aws.greengrass.create-subscription-definition-request/InitialVersion :portkey.aws.greengrass.create-subscription-definition-request/Name]))

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-subscription-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-device-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-device-definition-request/DeviceDefinitionId] :opt-un [:portkey.aws.greengrass.update-device-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-core-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-core-definition-request/CoreDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-group-certificate-authority-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-group-certificate-authority-request/CertificateAuthorityId :portkey.aws.greengrass.get-group-certificate-authority-request/GroupId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/device (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.device/CertificateArn :portkey.aws.greengrass.device/Id :portkey.aws.greengrass.device/SyncShadow :portkey.aws.greengrass.device/ThingArn]))

(clojure.spec.alpha/def :portkey.aws.greengrass/logger-component (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"GreengrassSystem" "GreengrassSystem", :greengrass-system "GreengrassSystem", "Lambda" "Lambda", :lambda "Lambda"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-function-definition-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-function-definition-request/FunctionDefinitionId] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-device-definition-request (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-device-definition-request/AmznClientToken :portkey.aws.greengrass.create-device-definition-request/InitialVersion :portkey.aws.greengrass.create-device-definition-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/get-connectivity-info-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.get-connectivity-info-request/ThingName] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/create-group-version-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.create-group-version-response/Arn :portkey.aws.greengrass.create-group-version-response/CreationTimestamp :portkey.aws.greengrass.create-group-version-response/Id :portkey.aws.greengrass.create-group-version-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/list-definitions-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.list-definitions-response/Definitions :portkey.aws.greengrass.list-definitions-response/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/general-error (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass/ErrorDetails :portkey.aws.greengrass.general-error/Message]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-connectivity-info-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.update-connectivity-info-response/Message :portkey.aws.greengrass.update-connectivity-info-response/Version]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/update-group-request (portkey.aws/json-keys :req-un [:portkey.aws.greengrass.update-group-request/GroupId] :opt-un [:portkey.aws.greengrass.update-group-request/Name]))
...
(clojure.spec.alpha/def :portkey.aws.greengrass/logger (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.greengrass.logger/Component :portkey.aws.greengrass.logger/Id :portkey.aws.greengrass.logger/Level :portkey.aws.greengrass.logger/Space :portkey.aws.greengrass.logger/Type]))

(clojure.spec.alpha/def :portkey.aws.greengrass/delete-device-definition-response (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.core/defn create-device-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/devices" input__8278__auto__ :portkey.aws.greengrass/create-device-definition-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-device-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-device-definition :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-device-definition-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-device-definition-response))

(clojure.core/defn get-function-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/functions/{FunctionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/get-function-definition-request {:payload nil, :headers {}, :uri {"FunctionDefinitionId" "FunctionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-function-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn delete-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/groups/{GroupId}" input__8278__auto__ :portkey.aws.greengrass/delete-group-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn create-device-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/devices/{DeviceDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-device-definition-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"DeviceDefinitionId" "DeviceDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/create-device-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-logger-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/loggers" input__8278__auto__ :portkey.aws.greengrass/list-logger-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-logger-definitions-response {}))
(clojure.spec.alpha/fdef list-logger-definitions :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-logger-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-logger-definitions-response))

(clojure.core/defn list-function-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/functions" input__8278__auto__ :portkey.aws.greengrass/list-function-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-function-definitions-response {}))
(clojure.spec.alpha/fdef list-function-definitions :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-function-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-function-definitions-response))

(clojure.core/defn create-function-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/functions" input__8278__auto__ :portkey.aws.greengrass/create-function-definition-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-function-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-function-definition :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-function-definition-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-function-definition-response))

(clojure.core/defn create-core-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/cores" input__8278__auto__ :portkey.aws.greengrass/create-core-definition-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-core-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-core-definition :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-core-definition-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-core-definition-response))

(clojure.core/defn list-groups [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups" input__8278__auto__ :portkey.aws.greengrass/list-groups-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-groups-response {}))
(clojure.spec.alpha/fdef list-groups :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-groups-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-groups-response))

(clojure.core/defn create-logger-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/loggers" input__8278__auto__ :portkey.aws.greengrass/create-logger-definition-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-logger-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-logger-definition :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-logger-definition-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-logger-definition-response))

(clojure.core/defn get-subscription-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}/versions/{SubscriptionDefinitionVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-subscription-definition-version-request {:payload nil, :headers {}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId", "SubscriptionDefinitionVersionId" "SubscriptionDefinitionVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-subscription-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-logger-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/definition/loggers/{LoggerDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/update-logger-definition-request {:payload nil, :headers {}, :uri {"LoggerDefinitionId" "LoggerDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/update-logger-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn disassociate-service-role-from-account [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/servicerole" input__8278__auto__ :portkey.aws.greengrass/disassociate-service-role-from-account-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/disassociate-service-role-from-account-response {"InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
(clojure.spec.alpha/fdef disassociate-service-role-from-account :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/disassociate-service-role-from-account-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/disassociate-service-role-from-account-response))

(clojure.core/defn create-subscription-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-subscription-definition-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/create-subscription-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn delete-subscription-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/delete-subscription-definition-request {:payload nil, :headers {}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-subscription-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn create-logger-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/loggers/{LoggerDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-logger-definition-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"LoggerDefinitionId" "LoggerDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/create-logger-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn delete-logger-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/definition/loggers/{LoggerDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/delete-logger-definition-request {:payload nil, :headers {}, :uri {"LoggerDefinitionId" "LoggerDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-logger-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-subscription-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/get-subscription-definition-request {:payload nil, :headers {}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-subscription-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-group-certificate-configuration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/groups/{GroupId}/certificateauthorities/configuration/expiry" input__8278__auto__ :portkey.aws.greengrass/update-group-certificate-configuration-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/update-group-certificate-configuration-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn create-deployment [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/groups/{GroupId}/deployments" input__8278__auto__ :portkey.aws.greengrass/create-deployment-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/create-deployment-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn delete-device-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/definition/devices/{DeviceDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/delete-device-definition-request {:payload nil, :headers {}, :uri {"DeviceDefinitionId" "DeviceDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-device-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-subscription-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/subscriptions" input__8278__auto__ :portkey.aws.greengrass/list-subscription-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-subscription-definitions-response {}))
(clojure.spec.alpha/fdef list-subscription-definitions :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-subscription-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-subscription-definitions-response))

(clojure.core/defn list-group-versions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/versions" input__8278__auto__ :portkey.aws.greengrass/list-group-versions-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-group-versions-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-subscription-definition-versions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/list-subscription-definition-versions-request {:payload nil, :headers {}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId"}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-subscription-definition-versions-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-associated-role [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/role" input__8278__auto__ :portkey.aws.greengrass/get-associated-role-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/get-associated-role-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn get-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}" input__8278__auto__ :portkey.aws.greengrass/get-group-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/get-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/groups/{GroupId}" input__8278__auto__ :portkey.aws.greengrass/update-group-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/update-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-group-certificate-authority [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/certificateauthorities/{CertificateAuthorityId}" input__8278__auto__ :portkey.aws.greengrass/get-group-certificate-authority-request {:payload nil, :headers {}, :uri {"CertificateAuthorityId" "CertificateAuthorityId", "GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/get-group-certificate-authority-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn get-core-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/cores/{CoreDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/get-core-definition-request {:payload nil, :headers {}, :uri {"CoreDefinitionId" "CoreDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-core-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-core-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/cores" input__8278__auto__ :portkey.aws.greengrass/list-core-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-core-definitions-response {}))
(clojure.spec.alpha/fdef list-core-definitions :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-core-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-core-definitions-response))

(clojure.core/defn get-deployment-status [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/deployments/{DeploymentId}/status" input__8278__auto__ :portkey.aws.greengrass/get-deployment-status-request {:payload nil, :headers {}, :uri {"DeploymentId" "DeploymentId", "GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/get-deployment-status-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-connectivity-info [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/things/{ThingName}/connectivityInfo" input__8278__auto__ :portkey.aws.greengrass/get-connectivity-info-request {:payload nil, :headers {}, :uri {"ThingName" "ThingName"}, :querystring {}} 200 :portkey.aws.greengrass/get-connectivity-info-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn get-device-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/devices/{DeviceDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/get-device-definition-request {:payload nil, :headers {}, :uri {"DeviceDefinitionId" "DeviceDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-device-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-deployments [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/deployments" input__8278__auto__ :portkey.aws.greengrass/list-deployments-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-deployments-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn create-group-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/groups/{GroupId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-group-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/create-group-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-device-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/devices/{DeviceDefinitionId}/versions/{DeviceDefinitionVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-device-definition-version-request {:payload nil, :headers {}, :uri {"DeviceDefinitionId" "DeviceDefinitionId", "DeviceDefinitionVersionId" "DeviceDefinitionVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-device-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-function-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/definition/functions/{FunctionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/update-function-definition-request {:payload nil, :headers {}, :uri {"FunctionDefinitionId" "FunctionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/update-function-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn delete-function-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/definition/functions/{FunctionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/delete-function-definition-request {:payload nil, :headers {}, :uri {"FunctionDefinitionId" "FunctionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-function-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-core-definition-versions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/cores/{CoreDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/list-core-definition-versions-request {:payload nil, :headers {}, :uri {"CoreDefinitionId" "CoreDefinitionId"}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-core-definition-versions-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-group-certificate-authorities [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/certificateauthorities" input__8278__auto__ :portkey.aws.greengrass/list-group-certificate-authorities-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/list-group-certificate-authorities-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn get-logger-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/loggers/{LoggerDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/get-logger-definition-request {:payload nil, :headers {}, :uri {"LoggerDefinitionId" "LoggerDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-logger-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-device-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/definition/devices/{DeviceDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/update-device-definition-request {:payload nil, :headers {}, :uri {"DeviceDefinitionId" "DeviceDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/update-device-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn create-group-certificate-authority [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/groups/{GroupId}/certificateauthorities" input__8278__auto__ :portkey.aws.greengrass/create-group-certificate-authority-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/create-group-certificate-authority-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn create-function-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/functions/{FunctionDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-function-definition-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"FunctionDefinitionId" "FunctionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/create-function-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-core-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/cores/{CoreDefinitionId}/versions/{CoreDefinitionVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-core-definition-version-request {:payload nil, :headers {}, :uri {"CoreDefinitionId" "CoreDefinitionId", "CoreDefinitionVersionId" "CoreDefinitionVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-core-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-function-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/functions/{FunctionDefinitionId}/versions/{FunctionDefinitionVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-function-definition-version-request {:payload nil, :headers {}, :uri {"FunctionDefinitionId" "FunctionDefinitionId", "FunctionDefinitionVersionId" "FunctionDefinitionVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-function-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-core-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/definition/cores/{CoreDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/update-core-definition-request {:payload nil, :headers {}, :uri {"CoreDefinitionId" "CoreDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/update-core-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn associate-role-to-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/groups/{GroupId}/role" input__8278__auto__ :portkey.aws.greengrass/associate-role-to-group-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/associate-role-to-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn associate-service-role-to-account [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/servicerole" input__8278__auto__ :portkey.aws.greengrass/associate-service-role-to-account-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/associate-service-role-to-account-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
(clojure.spec.alpha/fdef associate-service-role-to-account :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/associate-service-role-to-account-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/associate-service-role-to-account-response))

(clojure.core/defn update-subscription-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/definition/subscriptions/{SubscriptionDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/update-subscription-definition-request {:payload nil, :headers {}, :uri {"SubscriptionDefinitionId" "SubscriptionDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/update-subscription-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn update-connectivity-info [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "PUT" "/greengrass/things/{ThingName}/connectivityInfo" input__8278__auto__ :portkey.aws.greengrass/update-connectivity-info-request {:payload nil, :headers {}, :uri {"ThingName" "ThingName"}, :querystring {}} 200 :portkey.aws.greengrass/update-connectivity-info-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn create-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/groups" input__8278__auto__ :portkey.aws.greengrass/create-group-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-group :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-group-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-group-response))

(clojure.core/defn create-subscription-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/subscriptions" input__8278__auto__ :portkey.aws.greengrass/create-subscription-definition-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/create-subscription-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
(clojure.spec.alpha/fdef create-subscription-definition :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/create-subscription-definition-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/create-subscription-definition-response))

(clojure.core/defn get-group-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/versions/{GroupVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-group-version-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId", "GroupVersionId" "GroupVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-group-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-service-role-for-account [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/servicerole" input__8278__auto__ :portkey.aws.greengrass/get-service-role-for-account-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.greengrass/get-service-role-for-account-response {"InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
(clojure.spec.alpha/fdef get-service-role-for-account :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/get-service-role-for-account-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/get-service-role-for-account-response))

(clojure.core/defn get-group-certificate-configuration [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/groups/{GroupId}/certificateauthorities/configuration/expiry" input__8278__auto__ :portkey.aws.greengrass/get-group-certificate-configuration-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/get-group-certificate-configuration-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn delete-core-definition [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/definition/cores/{CoreDefinitionId}" input__8278__auto__ :portkey.aws.greengrass/delete-core-definition-request {:payload nil, :headers {}, :uri {"CoreDefinitionId" "CoreDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/delete-core-definition-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn get-logger-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/loggers/{LoggerDefinitionId}/versions/{LoggerDefinitionVersionId}" input__8278__auto__ :portkey.aws.greengrass/get-logger-definition-version-request {:payload nil, :headers {}, :uri {"LoggerDefinitionId" "LoggerDefinitionId", "LoggerDefinitionVersionId" "LoggerDefinitionVersionId"}, :querystring {}} 200 :portkey.aws.greengrass/get-logger-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn list-device-definition-versions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/devices/{DeviceDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/list-device-definition-versions-request {:payload nil, :headers {}, :uri {"DeviceDefinitionId" "DeviceDefinitionId"}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-device-definition-versions-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn create-core-definition-version [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "POST" "/greengrass/definition/cores/{CoreDefinitionId}/versions" input__8278__auto__ :portkey.aws.greengrass/create-core-definition-version-request {:payload nil, :headers {"AmznClientToken" ["X-Amzn-Client-Token" nil]}, :uri {"CoreDefinitionId" "CoreDefinitionId"}, :querystring {}} 200 :portkey.aws.greengrass/create-core-definition-version-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception}))
...
(clojure.core/defn disassociate-role-from-group [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "DELETE" "/greengrass/groups/{GroupId}/role" input__8278__auto__ :portkey.aws.greengrass/disassociate-role-from-group-request {:payload nil, :headers {}, :uri {"GroupId" "GroupId"}, :querystring {}} 200 :portkey.aws.greengrass/disassociate-role-from-group-response {"BadRequestException" :portkey.aws.greengrass/bad-request-exception, "InternalServerErrorException" :portkey.aws.greengrass/internal-server-error-exception}))
...
(clojure.core/defn list-device-definitions [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.greengrass/endpoints "GET" "/greengrass/definition/devices" input__8278__auto__ :portkey.aws.greengrass/list-device-definitions-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxResults" "MaxResults", "NextToken" "NextToken"}} 200 :portkey.aws.greengrass/list-device-definitions-response {}))
(clojure.spec.alpha/fdef list-device-definitions :args (clojure.spec.alpha/tuple :portkey.aws.greengrass/list-device-definitions-request) :ret (clojure.spec.alpha/and :portkey.aws.greengrass/list-device-definitions-response))
