...
(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper1632083 input] (clojure.core/let [rawinput1632082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632084 {"resourceTags" (rawinput1632082 "resourceTags")}] (clojure.core/cond-> {} (letvar1632084 "resourceTags") (clojure.core/assoc :resource-tags (deser-resource-tag-list (clojure.core/get-in letvar1632084 ["resourceTags"])))))))

(clojure.core/defn- response-direct-connect-server-exception ([input] (response-direct-connect-server-exception nil input)) ([resultWrapper1632086 input] (clojure.core/let [rawinput1632085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632087 {"message" (rawinput1632085 "message")}] (clojure.core/cond-> {} (letvar1632087 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1632087 ["message"])))))))

(clojure.core/defn- response-describe-direct-connect-gateway-attachments-result ([input] (response-describe-direct-connect-gateway-attachments-result nil input)) ([resultWrapper1632089 input] (clojure.core/let [rawinput1632088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632090 {"directConnectGatewayAttachments" (rawinput1632088 "directConnectGatewayAttachments"), "nextToken" (rawinput1632088 "nextToken")}] (clojure.core/cond-> {} (letvar1632090 "directConnectGatewayAttachments") (clojure.core/assoc :direct-connect-gateway-attachments (deser-direct-connect-gateway-attachment-list (clojure.core/get-in letvar1632090 ["directConnectGatewayAttachments"]))) (letvar1632090 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1632090 ["nextToken"])))))))

(clojure.core/defn- response-confirm-connection-response ([input] (response-confirm-connection-response nil input)) ([resultWrapper1632092 input] (clojure.core/let [rawinput1632091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632093 {"connectionState" (rawinput1632091 "connectionState")}] (clojure.core/cond-> {} (letvar1632093 "connectionState") (clojure.core/assoc :connection-state (deser-connection-state (clojure.core/get-in letvar1632093 ["connectionState"])))))))

(clojure.core/defn- response-describe-connection-loa-response ([input] (response-describe-connection-loa-response nil input)) ([resultWrapper1632095 input] (clojure.core/let [rawinput1632094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632096 {"loa" (rawinput1632094 "loa")}] (clojure.core/cond-> {} (letvar1632096 "loa") (clojure.core/assoc :loa (deser-loa (clojure.core/get-in letvar1632096 ["loa"])))))))

(clojure.core/defn- response-confirm-public-virtual-interface-response ([input] (response-confirm-public-virtual-interface-response nil input)) ([resultWrapper1632098 input] (clojure.core/let [rawinput1632097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632099 {"virtualInterfaceState" (rawinput1632097 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1632099 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1632099 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-describe-direct-connect-gateways-result ([input] (response-describe-direct-connect-gateways-result nil input)) ([resultWrapper1632101 input] (clojure.core/let [rawinput1632100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632102 {"directConnectGateways" (rawinput1632100 "directConnectGateways"), "nextToken" (rawinput1632100 "nextToken")}] (clojure.core/cond-> {} (letvar1632102 "directConnectGateways") (clojure.core/assoc :direct-connect-gateways (deser-direct-connect-gateway-list (clojure.core/get-in letvar1632102 ["directConnectGateways"]))) (letvar1632102 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1632102 ["nextToken"])))))))

(clojure.core/defn- response-interconnect ([input] (response-interconnect nil input)) ([resultWrapper1632104 input] (clojure.core/let [rawinput1632103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632105 {"jumboFrameCapable" (rawinput1632103 "jumboFrameCapable"), "awsDeviceV2" (rawinput1632103 "awsDeviceV2"), "awsDevice" (rawinput1632103 "awsDevice"), "interconnectName" (rawinput1632103 "interconnectName"), "bandwidth" (rawinput1632103 "bandwidth"), "interconnectState" (rawinput1632103 "interconnectState"), "lagId" (rawinput1632103 "lagId"), "location" (rawinput1632103 "location"), "region" (rawinput1632103 "region"), "loaIssueTime" (rawinput1632103 "loaIssueTime"), "hasLogicalRedundancy" (rawinput1632103 "hasLogicalRedundancy"), "interconnectId" (rawinput1632103 "interconnectId")}] (clojure.core/cond-> {} (letvar1632105 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1632105 ["jumboFrameCapable"]))) (letvar1632105 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1632105 ["awsDeviceV2"]))) (letvar1632105 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1632105 ["awsDevice"]))) (letvar1632105 "interconnectName") (clojure.core/assoc :interconnect-name (deser-interconnect-name (clojure.core/get-in letvar1632105 ["interconnectName"]))) (letvar1632105 "bandwidth") (clojure.core/assoc :bandwidth (deser-bandwidth (clojure.core/get-in letvar1632105 ["bandwidth"]))) (letvar1632105 "interconnectState") (clojure.core/assoc :interconnect-state (deser-interconnect-state (clojure.core/get-in letvar1632105 ["interconnectState"]))) (letvar1632105 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1632105 ["lagId"]))) (letvar1632105 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1632105 ["location"]))) (letvar1632105 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1632105 ["region"]))) (letvar1632105 "loaIssueTime") (clojure.core/assoc :loa-issue-time (deser-loa-issue-time (clojure.core/get-in letvar1632105 ["loaIssueTime"]))) (letvar1632105 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1632105 ["hasLogicalRedundancy"]))) (letvar1632105 "interconnectId") (clojure.core/assoc :interconnect-id (deser-interconnect-id (clojure.core/get-in letvar1632105 ["interconnectId"])))))))

(clojure.core/defn- response-virtual-interfaces ([input] (response-virtual-interfaces nil input)) ([resultWrapper1632107 input] (clojure.core/let [rawinput1632106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632108 {"virtualInterfaces" (rawinput1632106 "virtualInterfaces")}] (clojure.core/cond-> {} (letvar1632108 "virtualInterfaces") (clojure.core/assoc :virtual-interfaces (deser-virtual-interface-list (clojure.core/get-in letvar1632108 ["virtualInterfaces"])))))))

(clojure.core/defn- response-create-direct-connect-gateway-result ([input] (response-create-direct-connect-gateway-result nil input)) ([resultWrapper1632110 input] (clojure.core/let [rawinput1632109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632111 {"directConnectGateway" (rawinput1632109 "directConnectGateway")}] (clojure.core/cond-> {} (letvar1632111 "directConnectGateway") (clojure.core/assoc :direct-connect-gateway (deser-direct-connect-gateway (clojure.core/get-in letvar1632111 ["directConnectGateway"])))))))

(clojure.core/defn- response-create-bgp-peer-response ([input] (response-create-bgp-peer-response nil input)) ([resultWrapper1632113 input] (clojure.core/let [rawinput1632112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632114 {"virtualInterface" (rawinput1632112 "virtualInterface")}] (clojure.core/cond-> {} (letvar1632114 "virtualInterface") (clojure.core/assoc :virtual-interface (deser-virtual-interface (clojure.core/get-in letvar1632114 ["virtualInterface"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1632116 input] (clojure.core/let [rawinput1632115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632117 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-bgp-peer-response ([input] (response-delete-bgp-peer-response nil input)) ([resultWrapper1632119 input] (clojure.core/let [rawinput1632118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632120 {"virtualInterface" (rawinput1632118 "virtualInterface")}] (clojure.core/cond-> {} (letvar1632120 "virtualInterface") (clojure.core/assoc :virtual-interface (deser-virtual-interface (clojure.core/get-in letvar1632120 ["virtualInterface"])))))))

(clojure.core/defn- response-connections ([input] (response-connections nil input)) ([resultWrapper1632122 input] (clojure.core/let [rawinput1632121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632123 {"connections" (rawinput1632121 "connections")}] (clojure.core/cond-> {} (letvar1632123 "connections") (clojure.core/assoc :connections (deser-connection-list (clojure.core/get-in letvar1632123 ["connections"])))))))

(clojure.core/defn- response-duplicate-tag-keys-exception ([input] (response-duplicate-tag-keys-exception nil input)) ([resultWrapper1632125 input] (clojure.core/let [rawinput1632124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632126 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-locations ([input] (response-locations nil input)) ([resultWrapper1632128 input] (clojure.core/let [rawinput1632127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632129 {"locations" (rawinput1632127 "locations")}] (clojure.core/cond-> {} (letvar1632129 "locations") (clojure.core/assoc :locations (deser-location-list (clojure.core/get-in letvar1632129 ["locations"])))))))

(clojure.core/defn- response-lag ([input] (response-lag nil input)) ([resultWrapper1632131 input] (clojure.core/let [rawinput1632130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632132 {"allowsHostedConnections" (rawinput1632130 "allowsHostedConnections"), "numberOfConnections" (rawinput1632130 "numberOfConnections"), "jumboFrameCapable" (rawinput1632130 "jumboFrameCapable"), "awsDeviceV2" (rawinput1632130 "awsDeviceV2"), "awsDevice" (rawinput1632130 "awsDevice"), "minimumLinks" (rawinput1632130 "minimumLinks"), "ownerAccount" (rawinput1632130 "ownerAccount"), "lagName" (rawinput1632130 "lagName"), "connectionsBandwidth" (rawinput1632130 "connectionsBandwidth"), "lagId" (rawinput1632130 "lagId"), "location" (rawinput1632130 "location"), "region" (rawinput1632130 "region"), "lagState" (rawinput1632130 "lagState"), "hasLogicalRedundancy" (rawinput1632130 "hasLogicalRedundancy"), "connections" (rawinput1632130 "connections")}] (clojure.core/cond-> {} (letvar1632132 "allowsHostedConnections") (clojure.core/assoc :allows-hosted-connections (deser-boolean-flag (clojure.core/get-in letvar1632132 ["allowsHostedConnections"]))) (letvar1632132 "numberOfConnections") (clojure.core/assoc :number-of-connections (deser-count (clojure.core/get-in letvar1632132 ["numberOfConnections"]))) (letvar1632132 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1632132 ["jumboFrameCapable"]))) (letvar1632132 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1632132 ["awsDeviceV2"]))) (letvar1632132 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1632132 ["awsDevice"]))) (letvar1632132 "minimumLinks") (clojure.core/assoc :minimum-links (deser-count (clojure.core/get-in letvar1632132 ["minimumLinks"]))) (letvar1632132 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1632132 ["ownerAccount"]))) (letvar1632132 "lagName") (clojure.core/assoc :lag-name (deser-lag-name (clojure.core/get-in letvar1632132 ["lagName"]))) (letvar1632132 "connectionsBandwidth") (clojure.core/assoc :connections-bandwidth (deser-bandwidth (clojure.core/get-in letvar1632132 ["connectionsBandwidth"]))) (letvar1632132 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1632132 ["lagId"]))) (letvar1632132 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1632132 ["location"]))) (letvar1632132 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1632132 ["region"]))) (letvar1632132 "lagState") (clojure.core/assoc :lag-state (deser-lag-state (clojure.core/get-in letvar1632132 ["lagState"]))) (letvar1632132 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1632132 ["hasLogicalRedundancy"]))) (letvar1632132 "connections") (clojure.core/assoc :connections (deser-connection-list (clojure.core/get-in letvar1632132 ["connections"])))))))

(clojure.core/defn- response-delete-interconnect-response ([input] (response-delete-interconnect-response nil input)) ([resultWrapper1632134 input] (clojure.core/let [rawinput1632133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632135 {"interconnectState" (rawinput1632133 "interconnectState")}] (clojure.core/cond-> {} (letvar1632135 "interconnectState") (clojure.core/assoc :interconnect-state (deser-interconnect-state (clojure.core/get-in letvar1632135 ["interconnectState"])))))))

(clojure.core/defn- response-create-direct-connect-gateway-association-result ([input] (response-create-direct-connect-gateway-association-result nil input)) ([resultWrapper1632137 input] (clojure.core/let [rawinput1632136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632138 {"directConnectGatewayAssociation" (rawinput1632136 "directConnectGatewayAssociation")}] (clojure.core/cond-> {} (letvar1632138 "directConnectGatewayAssociation") (clojure.core/assoc :direct-connect-gateway-association (deser-direct-connect-gateway-association (clojure.core/get-in letvar1632138 ["directConnectGatewayAssociation"])))))))

(clojure.core/defn- response-describe-interconnect-loa-response ([input] (response-describe-interconnect-loa-response nil input)) ([resultWrapper1632140 input] (clojure.core/let [rawinput1632139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632141 {"loa" (rawinput1632139 "loa")}] (clojure.core/cond-> {} (letvar1632141 "loa") (clojure.core/assoc :loa (deser-loa (clojure.core/get-in letvar1632141 ["loa"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper1632143 input] (clojure.core/let [rawinput1632142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632144 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-direct-connect-client-exception ([input] (response-direct-connect-client-exception nil input)) ([resultWrapper1632146 input] (clojure.core/let [rawinput1632145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632147 {"message" (rawinput1632145 "message")}] (clojure.core/cond-> {} (letvar1632147 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1632147 ["message"])))))))

(clojure.core/defn- response-loa ([input] (response-loa nil input)) ([resultWrapper1632149 input] (clojure.core/let [rawinput1632148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632150 {"loaContent" (rawinput1632148 "loaContent"), "loaContentType" (rawinput1632148 "loaContentType")}] (clojure.core/cond-> {} (letvar1632150 "loaContent") (clojure.core/assoc :loa-content (deser-loa-content (clojure.core/get-in letvar1632150 ["loaContent"]))) (letvar1632150 "loaContentType") (clojure.core/assoc :loa-content-type (deser-loa-content-type (clojure.core/get-in letvar1632150 ["loaContentType"])))))))

(clojure.core/defn- response-connection ([input] (response-connection nil input)) ([resultWrapper1632152 input] (clojure.core/let [rawinput1632151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632153 {"partnerName" (rawinput1632151 "partnerName"), "jumboFrameCapable" (rawinput1632151 "jumboFrameCapable"), "connectionName" (rawinput1632151 "connectionName"), "awsDeviceV2" (rawinput1632151 "awsDeviceV2"), "awsDevice" (rawinput1632151 "awsDevice"), "connectionId" (rawinput1632151 "connectionId"), "connectionState" (rawinput1632151 "connectionState"), "bandwidth" (rawinput1632151 "bandwidth"), "ownerAccount" (rawinput1632151 "ownerAccount"), "lagId" (rawinput1632151 "lagId"), "location" (rawinput1632151 "location"), "region" (rawinput1632151 "region"), "loaIssueTime" (rawinput1632151 "loaIssueTime"), "hasLogicalRedundancy" (rawinput1632151 "hasLogicalRedundancy"), "vlan" (rawinput1632151 "vlan")}] (clojure.core/cond-> {} (letvar1632153 "partnerName") (clojure.core/assoc :partner-name (deser-partner-name (clojure.core/get-in letvar1632153 ["partnerName"]))) (letvar1632153 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1632153 ["jumboFrameCapable"]))) (letvar1632153 "connectionName") (clojure.core/assoc :connection-name (deser-connection-name (clojure.core/get-in letvar1632153 ["connectionName"]))) (letvar1632153 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1632153 ["awsDeviceV2"]))) (letvar1632153 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1632153 ["awsDevice"]))) (letvar1632153 "connectionId") (clojure.core/assoc :connection-id (deser-connection-id (clojure.core/get-in letvar1632153 ["connectionId"]))) (letvar1632153 "connectionState") (clojure.core/assoc :connection-state (deser-connection-state (clojure.core/get-in letvar1632153 ["connectionState"]))) (letvar1632153 "bandwidth") (clojure.core/assoc :bandwidth (deser-bandwidth (clojure.core/get-in letvar1632153 ["bandwidth"]))) (letvar1632153 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1632153 ["ownerAccount"]))) (letvar1632153 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1632153 ["lagId"]))) (letvar1632153 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1632153 ["location"]))) (letvar1632153 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1632153 ["region"]))) (letvar1632153 "loaIssueTime") (clojure.core/assoc :loa-issue-time (deser-loa-issue-time (clojure.core/get-in letvar1632153 ["loaIssueTime"]))) (letvar1632153 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1632153 ["hasLogicalRedundancy"]))) (letvar1632153 "vlan") (clojure.core/assoc :vlan (deser-vlan (clojure.core/get-in letvar1632153 ["vlan"])))))))

(clojure.core/defn- response-delete-direct-connect-gateway-result ([input] (response-delete-direct-connect-gateway-result nil input)) ([resultWrapper1632155 input] (clojure.core/let [rawinput1632154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632156 {"directConnectGateway" (rawinput1632154 "directConnectGateway")}] (clojure.core/cond-> {} (letvar1632156 "directConnectGateway") (clojure.core/assoc :direct-connect-gateway (deser-direct-connect-gateway (clojure.core/get-in letvar1632156 ["directConnectGateway"])))))))

(clojure.core/defn- response-interconnects ([input] (response-interconnects nil input)) ([resultWrapper1632158 input] (clojure.core/let [rawinput1632157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632159 {"interconnects" (rawinput1632157 "interconnects")}] (clojure.core/cond-> {} (letvar1632159 "interconnects") (clojure.core/assoc :interconnects (deser-interconnect-list (clojure.core/get-in letvar1632159 ["interconnects"])))))))

(clojure.core/defn- response-confirm-private-virtual-interface-response ([input] (response-confirm-private-virtual-interface-response nil input)) ([resultWrapper1632161 input] (clojure.core/let [rawinput1632160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632162 {"virtualInterfaceState" (rawinput1632160 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1632162 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1632162 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-virtual-gateways ([input] (response-virtual-gateways nil input)) ([resultWrapper1632164 input] (clojure.core/let [rawinput1632163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632165 {"virtualGateways" (rawinput1632163 "virtualGateways")}] (clojure.core/cond-> {} (letvar1632165 "virtualGateways") (clojure.core/assoc :virtual-gateways (deser-virtual-gateway-list (clojure.core/get-in letvar1632165 ["virtualGateways"])))))))

(clojure.core/defn- response-delete-virtual-interface-response ([input] (response-delete-virtual-interface-response nil input)) ([resultWrapper1632167 input] (clojure.core/let [rawinput1632166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632168 {"virtualInterfaceState" (rawinput1632166 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1632168 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1632168 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-virtual-interface ([input] (response-virtual-interface nil input)) ([resultWrapper1632170 input] (clojure.core/let [rawinput1632169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632171 {"virtualInterfaceId" (rawinput1632169 "virtualInterfaceId"), "bgpPeers" (rawinput1632169 "bgpPeers"), "amazonSideAsn" (rawinput1632169 "amazonSideAsn"), "jumboFrameCapable" (rawinput1632169 "jumboFrameCapable"), "awsDeviceV2" (rawinput1632169 "awsDeviceV2"), "connectionId" (rawinput1632169 "connectionId"), "virtualInterfaceState" (rawinput1632169 "virtualInterfaceState"), "addressFamily" (rawinput1632169 "addressFamily"), "ownerAccount" (rawinput1632169 "ownerAccount"), "directConnectGatewayId" (rawinput1632169 "directConnectGatewayId"), "customerAddress" (rawinput1632169 "customerAddress"), "mtu" (rawinput1632169 "mtu"), "location" (rawinput1632169 "location"), "virtualInterfaceName" (rawinput1632169 "virtualInterfaceName"), "region" (rawinput1632169 "region"), "virtualGatewayId" (rawinput1632169 "virtualGatewayId"), "virtualInterfaceType" (rawinput1632169 "virtualInterfaceType"), "amazonAddress" (rawinput1632169 "amazonAddress"), "vlan" (rawinput1632169 "vlan"), "customerRouterConfig" (rawinput1632169 "customerRouterConfig"), "authKey" (rawinput1632169 "authKey"), "routeFilterPrefixes" (rawinput1632169 "routeFilterPrefixes"), "asn" (rawinput1632169 "asn")}] (clojure.core/cond-> {} (letvar1632171 "virtualInterfaceId") (clojure.core/assoc :virtual-interface-id (deser-virtual-interface-id (clojure.core/get-in letvar1632171 ["virtualInterfaceId"]))) (letvar1632171 "bgpPeers") (clojure.core/assoc :bgp-peers (deser-bgp-peer-list (clojure.core/get-in letvar1632171 ["bgpPeers"]))) (letvar1632171 "amazonSideAsn") (clojure.core/assoc :amazon-side-asn (deser-long-asn (clojure.core/get-in letvar1632171 ["amazonSideAsn"]))) (letvar1632171 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1632171 ["jumboFrameCapable"]))) (letvar1632171 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1632171 ["awsDeviceV2"]))) (letvar1632171 "connectionId") (clojure.core/assoc :connection-id (deser-connection-id (clojure.core/get-in letvar1632171 ["connectionId"]))) (letvar1632171 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1632171 ["virtualInterfaceState"]))) (letvar1632171 "addressFamily") (clojure.core/assoc :address-family (deser-address-family (clojure.core/get-in letvar1632171 ["addressFamily"]))) (letvar1632171 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1632171 ["ownerAccount"]))) (letvar1632171 "directConnectGatewayId") (clojure.core/assoc :direct-connect-gateway-id (deser-direct-connect-gateway-id (clojure.core/get-in letvar1632171 ["directConnectGatewayId"]))) (letvar1632171 "customerAddress") (clojure.core/assoc :customer-address (deser-customer-address (clojure.core/get-in letvar1632171 ["customerAddress"]))) (letvar1632171 "mtu") (clojure.core/assoc :mtu (deser-mtu (clojure.core/get-in letvar1632171 ["mtu"]))) (letvar1632171 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1632171 ["location"]))) (letvar1632171 "virtualInterfaceName") (clojure.core/assoc :virtual-interface-name (deser-virtual-interface-name (clojure.core/get-in letvar1632171 ["virtualInterfaceName"]))) (letvar1632171 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1632171 ["region"]))) (letvar1632171 "virtualGatewayId") (clojure.core/assoc :virtual-gateway-id (deser-virtual-gateway-id (clojure.core/get-in letvar1632171 ["virtualGatewayId"]))) (letvar1632171 "virtualInterfaceType") (clojure.core/assoc :virtual-interface-type (deser-virtual-interface-type (clojure.core/get-in letvar1632171 ["virtualInterfaceType"]))) (letvar1632171 "amazonAddress") (clojure.core/assoc :amazon-address (deser-amazon-address (clojure.core/get-in letvar1632171 ["amazonAddress"]))) (letvar1632171 "vlan") (clojure.core/assoc :vlan (deser-vlan (clojure.core/get-in letvar1632171 ["vlan"]))) (letvar1632171 "customerRouterConfig") (clojure.core/assoc :customer-router-config (deser-router-config (clojure.core/get-in letvar1632171 ["customerRouterConfig"]))) (letvar1632171 "authKey") (clojure.core/assoc :auth-key (deser-bgp-auth-key (clojure.core/get-in letvar1632171 ["authKey"]))) (letvar1632171 "routeFilterPrefixes") (clojure.core/assoc :route-filter-prefixes (deser-route-filter-prefix-list (clojure.core/get-in letvar1632171 ["routeFilterPrefixes"]))) (letvar1632171 "asn") (clojure.core/assoc :asn (deser-asn (clojure.core/get-in letvar1632171 ["asn"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1632173 input] (clojure.core/let [rawinput1632172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632174 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-direct-connect-gateway-associations-result ([input] (response-describe-direct-connect-gateway-associations-result nil input)) ([resultWrapper1632176 input] (clojure.core/let [rawinput1632175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632177 {"directConnectGatewayAssociations" (rawinput1632175 "directConnectGatewayAssociations"), "nextToken" (rawinput1632175 "nextToken")}] (clojure.core/cond-> {} (letvar1632177 "directConnectGatewayAssociations") (clojure.core/assoc :direct-connect-gateway-associations (deser-direct-connect-gateway-association-list (clojure.core/get-in letvar1632177 ["directConnectGatewayAssociations"]))) (letvar1632177 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1632177 ["nextToken"])))))))

(clojure.core/defn- response-delete-direct-connect-gateway-association-result ([input] (response-delete-direct-connect-gateway-association-result nil input)) ([resultWrapper1632179 input] (clojure.core/let [rawinput1632178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632180 {"directConnectGatewayAssociation" (rawinput1632178 "directConnectGatewayAssociation")}] (clojure.core/cond-> {} (letvar1632180 "directConnectGatewayAssociation") (clojure.core/assoc :direct-connect-gateway-association (deser-direct-connect-gateway-association (clojure.core/get-in letvar1632180 ["directConnectGatewayAssociation"])))))))

(clojure.core/defn- response-lags ([input] (response-lags nil input)) ([resultWrapper1632182 input] (clojure.core/let [rawinput1632181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1632183 {"lags" (rawinput1632181 "lags")}] (clojure.core/cond-> {} (letvar1632183 "lags") (clojure.core/assoc :lags (deser-lag-list (clojure.core/get-in letvar1632183 ["lags"])))))))
...
(clojure.spec.alpha/def :portkey.aws.directconnect/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.directconnect/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
