...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27967__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__27967__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 200)) (clojure.core/fn [s__27967__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27967__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 1 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 200)) (clojure.core/fn [s__27967__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27967__auto__))))
...
(clojure.core/defn get-transcription-job ([get-transcription-job-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-transcription-job-request get-transcription-job-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.transcribe.-2017-10-26/endpoints, :http.request.spec/output-spec :portkey.aws.transcribe.-2017-10-26/get-transcription-job-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-10-26", :http.request.configuration/service-id "Transcribe", :http.request.spec/input-spec :portkey.aws.transcribe.-2017-10-26/get-transcription-job-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetTranscriptionJob", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.transcribe.-2017-10-26/bad-request-exception, "LimitExceededException" :portkey.aws.transcribe.-2017-10-26/limit-exceeded-exception, "InternalFailureException" :portkey.aws.transcribe.-2017-10-26/internal-failure-exception, "NotFoundException" :portkey.aws.transcribe.-2017-10-26/not-found-exception}})))))
...
(clojure.core/defn list-vocabularies ([] (list-vocabularies {})) ([list-vocabularies-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-vocabularies-request list-vocabularies-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.transcribe.-2017-10-26/endpoints, :http.request.spec/output-spec :portkey.aws.transcribe.-2017-10-26/list-vocabularies-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-10-26", :http.request.configuration/service-id "Transcribe", :http.request.spec/input-spec :portkey.aws.transcribe.-2017-10-26/list-vocabularies-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListVocabularies", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.transcribe.-2017-10-26/bad-request-exception, "LimitExceededException" :portkey.aws.transcribe.-2017-10-26/limit-exceeded-exception, "InternalFailureException" :portkey.aws.transcribe.-2017-10-26/internal-failure-exception}})))))
...
(clojure.core/defn start-transcription-job ([start-transcription-job-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-start-transcription-job-request start-transcription-job-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.transcribe.-2017-10-26/endpoints, :http.request.spec/output-spec :portkey.aws.transcribe.-2017-10-26/start-transcription-job-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-10-26", :http.request.configuration/service-id "Transcribe", :http.request.spec/input-spec :portkey.aws.transcribe.-2017-10-26/start-transcription-job-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "StartTranscriptionJob", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.transcribe.-2017-10-26/bad-request-exception, "LimitExceededException" :portkey.aws.transcribe.-2017-10-26/limit-exceeded-exception, "InternalFailureException" :portkey.aws.transcribe.-2017-10-26/internal-failure-exception, "ConflictException" :portkey.aws.transcribe.-2017-10-26/conflict-exception}})))))
