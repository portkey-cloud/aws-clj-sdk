...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 0 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 200)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 200)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27882__auto__))))
