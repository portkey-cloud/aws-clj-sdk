...
(clojure.core/defn- response-list-vocabularies-response ([input] (response-list-vocabularies-response nil input)) ([resultWrapper1851538 input] (clojure.core/let [rawinput1851537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851539 {"Status" (rawinput1851537 "Status"), "NextToken" (rawinput1851537 "NextToken"), "Vocabularies" (rawinput1851537 "Vocabularies")}] (clojure.core/cond-> {} (letvar1851539 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar1851539 ["Status"]))) (letvar1851539 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1851539 ["NextToken"]))) (letvar1851539 "Vocabularies") (clojure.core/assoc :vocabularies (deser-vocabularies (clojure.core/get-in letvar1851539 ["Vocabularies"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1851541 input] (clojure.core/let [rawinput1851540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851542 {"Message" (rawinput1851540 "Message")}] (clojure.core/cond-> {} (letvar1851542 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1851542 ["Message"])))))))

(clojure.core/defn- response-get-transcription-job-response ([input] (response-get-transcription-job-response nil input)) ([resultWrapper1851544 input] (clojure.core/let [rawinput1851543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851545 {"TranscriptionJob" (rawinput1851543 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar1851545 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar1851545 ["TranscriptionJob"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1851547 input] (clojure.core/let [rawinput1851546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851548 {"Message" (rawinput1851546 "Message")}] (clojure.core/cond-> {} (letvar1851548 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1851548 ["Message"])))))))

(clojure.core/defn- response-get-vocabulary-response ([input] (response-get-vocabulary-response nil input)) ([resultWrapper1851550 input] (clojure.core/let [rawinput1851549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851551 {"VocabularyName" (rawinput1851549 "VocabularyName"), "LanguageCode" (rawinput1851549 "LanguageCode"), "VocabularyState" (rawinput1851549 "VocabularyState"), "LastModifiedTime" (rawinput1851549 "LastModifiedTime"), "FailureReason" (rawinput1851549 "FailureReason"), "DownloadUri" (rawinput1851549 "DownloadUri")}] (clojure.core/cond-> {} (letvar1851551 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1851551 ["VocabularyName"]))) (letvar1851551 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1851551 ["LanguageCode"]))) (letvar1851551 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1851551 ["VocabularyState"]))) (letvar1851551 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1851551 ["LastModifiedTime"]))) (letvar1851551 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1851551 ["FailureReason"]))) (letvar1851551 "DownloadUri") (clojure.core/assoc :download-uri (deser-uri (clojure.core/get-in letvar1851551 ["DownloadUri"])))))))

(clojure.core/defn- response-update-vocabulary-response ([input] (response-update-vocabulary-response nil input)) ([resultWrapper1851553 input] (clojure.core/let [rawinput1851552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851554 {"VocabularyName" (rawinput1851552 "VocabularyName"), "LanguageCode" (rawinput1851552 "LanguageCode"), "LastModifiedTime" (rawinput1851552 "LastModifiedTime"), "VocabularyState" (rawinput1851552 "VocabularyState")}] (clojure.core/cond-> {} (letvar1851554 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1851554 ["VocabularyName"]))) (letvar1851554 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1851554 ["LanguageCode"]))) (letvar1851554 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1851554 ["LastModifiedTime"]))) (letvar1851554 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1851554 ["VocabularyState"])))))))

(clojure.core/defn- response-list-transcription-jobs-response ([input] (response-list-transcription-jobs-response nil input)) ([resultWrapper1851556 input] (clojure.core/let [rawinput1851555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851557 {"Status" (rawinput1851555 "Status"), "NextToken" (rawinput1851555 "NextToken"), "TranscriptionJobSummaries" (rawinput1851555 "TranscriptionJobSummaries")}] (clojure.core/cond-> {} (letvar1851557 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar1851557 ["Status"]))) (letvar1851557 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1851557 ["NextToken"]))) (letvar1851557 "TranscriptionJobSummaries") (clojure.core/assoc :transcription-job-summaries (deser-transcription-job-summaries (clojure.core/get-in letvar1851557 ["TranscriptionJobSummaries"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1851559 input] (clojure.core/let [rawinput1851558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851560 {"Message" (rawinput1851558 "Message")}] (clojure.core/cond-> {} (letvar1851560 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1851560 ["Message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1851562 input] (clojure.core/let [rawinput1851561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851563 {"Message" (rawinput1851561 "Message")}] (clojure.core/cond-> {} (letvar1851563 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1851563 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1851565 input] (clojure.core/let [rawinput1851564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851566 {"Message" (rawinput1851564 "Message")}] (clojure.core/cond-> {} (letvar1851566 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1851566 ["Message"])))))))

(clojure.core/defn- response-create-vocabulary-response ([input] (response-create-vocabulary-response nil input)) ([resultWrapper1851568 input] (clojure.core/let [rawinput1851567 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851569 {"VocabularyName" (rawinput1851567 "VocabularyName"), "LanguageCode" (rawinput1851567 "LanguageCode"), "VocabularyState" (rawinput1851567 "VocabularyState"), "LastModifiedTime" (rawinput1851567 "LastModifiedTime"), "FailureReason" (rawinput1851567 "FailureReason")}] (clojure.core/cond-> {} (letvar1851569 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1851569 ["VocabularyName"]))) (letvar1851569 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1851569 ["LanguageCode"]))) (letvar1851569 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1851569 ["VocabularyState"]))) (letvar1851569 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1851569 ["LastModifiedTime"]))) (letvar1851569 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1851569 ["FailureReason"])))))))

(clojure.core/defn- response-start-transcription-job-response ([input] (response-start-transcription-job-response nil input)) ([resultWrapper1851571 input] (clojure.core/let [rawinput1851570 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1851572 {"TranscriptionJob" (rawinput1851570 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar1851572 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar1851572 ["TranscriptionJob"])))))))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/media-sample-rate-hertz (clojure.spec.alpha/int-in 8000 48000))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__21078__auto__))))
