...
(clojure.core/defn- deser-language-code [input] (clojure.core/get {"en-US" :en-us, "es-US" :es-us} input))
...
(clojure.core/defn- deser-list-vocabularies-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Status") (clojure.core/assoc :status (deser-transcription-job-status (input "Status"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken"))) (clojure.core/contains? input "Vocabularies") (clojure.core/assoc :vocabularies (deser-vocabularies (input "Vocabularies")))))

(clojure.core/defn- deser-bad-request-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-failure-reason (input "Message")))))

(clojure.core/defn- deser-get-transcription-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (input "TranscriptionJob")))))
...
(clojure.core/defn- deser-get-vocabulary-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (input "VocabularyName"))) (clojure.core/contains? input "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (input "LanguageCode"))) (clojure.core/contains? input "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (input "VocabularyState"))) (clojure.core/contains? input "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (input "LastModifiedTime"))) (clojure.core/contains? input "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (input "FailureReason"))) (clojure.core/contains? input "DownloadUri") (clojure.core/assoc :download-uri (deser-uri (input "DownloadUri")))))

(clojure.core/defn- deser-update-vocabulary-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (input "VocabularyName"))) (clojure.core/contains? input "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (input "LanguageCode"))) (clojure.core/contains? input "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (input "LastModifiedTime"))) (clojure.core/contains? input "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (input "VocabularyState")))))

(clojure.core/defn- deser-list-transcription-jobs-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Status") (clojure.core/assoc :status (deser-transcription-job-status (input "Status"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken"))) (clojure.core/contains? input "TranscriptionJobSummaries") (clojure.core/assoc :transcription-job-summaries (deser-transcription-job-summaries (input "TranscriptionJobSummaries")))))

(clojure.core/defn- deser-internal-failure-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-string (input "Message")))))

(clojure.core/defn- deser-conflict-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-string (input "Message")))))

(clojure.core/defn- deser-not-found-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-string (input "Message")))))

(clojure.core/defn- deser-create-vocabulary-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (input "VocabularyName"))) (clojure.core/contains? input "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (input "LanguageCode"))) (clojure.core/contains? input "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (input "VocabularyState"))) (clojure.core/contains? input "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (input "LastModifiedTime"))) (clojure.core/contains? input "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (input "FailureReason")))))

(clojure.core/defn- deser-start-transcription-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (input "TranscriptionJob")))))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/media-sample-rate-hertz (clojure.spec.alpha/int-in 8000 48000))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/language-code #{"es-US" "en-US" :en-us :es-us})
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 200)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 200)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__27881__auto__))))
