...
(clojure.core/defn- response-list-vocabularies-response ([input] (response-list-vocabularies-response nil input)) ([resultWrapper2134118 input] (clojure.core/let [rawinput2134117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134119 {"Status" (rawinput2134117 "Status"), "NextToken" (rawinput2134117 "NextToken"), "Vocabularies" (rawinput2134117 "Vocabularies")}] (clojure.core/cond-> {} (letvar2134119 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar2134119 ["Status"]))) (letvar2134119 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2134119 ["NextToken"]))) (letvar2134119 "Vocabularies") (clojure.core/assoc :vocabularies (deser-vocabularies (clojure.core/get-in letvar2134119 ["Vocabularies"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper2134121 input] (clojure.core/let [rawinput2134120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134122 {"Message" (rawinput2134120 "Message")}] (clojure.core/cond-> {} (letvar2134122 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar2134122 ["Message"])))))))

(clojure.core/defn- response-get-transcription-job-response ([input] (response-get-transcription-job-response nil input)) ([resultWrapper2134124 input] (clojure.core/let [rawinput2134123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134125 {"TranscriptionJob" (rawinput2134123 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar2134125 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar2134125 ["TranscriptionJob"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2134127 input] (clojure.core/let [rawinput2134126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134128 {"Message" (rawinput2134126 "Message")}] (clojure.core/cond-> {} (letvar2134128 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2134128 ["Message"])))))))

(clojure.core/defn- response-get-vocabulary-response ([input] (response-get-vocabulary-response nil input)) ([resultWrapper2134130 input] (clojure.core/let [rawinput2134129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134131 {"VocabularyName" (rawinput2134129 "VocabularyName"), "LanguageCode" (rawinput2134129 "LanguageCode"), "VocabularyState" (rawinput2134129 "VocabularyState"), "LastModifiedTime" (rawinput2134129 "LastModifiedTime"), "FailureReason" (rawinput2134129 "FailureReason"), "DownloadUri" (rawinput2134129 "DownloadUri")}] (clojure.core/cond-> {} (letvar2134131 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2134131 ["VocabularyName"]))) (letvar2134131 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2134131 ["LanguageCode"]))) (letvar2134131 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2134131 ["VocabularyState"]))) (letvar2134131 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2134131 ["LastModifiedTime"]))) (letvar2134131 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar2134131 ["FailureReason"]))) (letvar2134131 "DownloadUri") (clojure.core/assoc :download-uri (deser-uri (clojure.core/get-in letvar2134131 ["DownloadUri"])))))))

(clojure.core/defn- response-update-vocabulary-response ([input] (response-update-vocabulary-response nil input)) ([resultWrapper2134133 input] (clojure.core/let [rawinput2134132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134134 {"VocabularyName" (rawinput2134132 "VocabularyName"), "LanguageCode" (rawinput2134132 "LanguageCode"), "LastModifiedTime" (rawinput2134132 "LastModifiedTime"), "VocabularyState" (rawinput2134132 "VocabularyState")}] (clojure.core/cond-> {} (letvar2134134 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2134134 ["VocabularyName"]))) (letvar2134134 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2134134 ["LanguageCode"]))) (letvar2134134 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2134134 ["LastModifiedTime"]))) (letvar2134134 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2134134 ["VocabularyState"])))))))

(clojure.core/defn- response-list-transcription-jobs-response ([input] (response-list-transcription-jobs-response nil input)) ([resultWrapper2134136 input] (clojure.core/let [rawinput2134135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134137 {"Status" (rawinput2134135 "Status"), "NextToken" (rawinput2134135 "NextToken"), "TranscriptionJobSummaries" (rawinput2134135 "TranscriptionJobSummaries")}] (clojure.core/cond-> {} (letvar2134137 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar2134137 ["Status"]))) (letvar2134137 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2134137 ["NextToken"]))) (letvar2134137 "TranscriptionJobSummaries") (clojure.core/assoc :transcription-job-summaries (deser-transcription-job-summaries (clojure.core/get-in letvar2134137 ["TranscriptionJobSummaries"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper2134139 input] (clojure.core/let [rawinput2134138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134140 {"Message" (rawinput2134138 "Message")}] (clojure.core/cond-> {} (letvar2134140 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2134140 ["Message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper2134142 input] (clojure.core/let [rawinput2134141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134143 {"Message" (rawinput2134141 "Message")}] (clojure.core/cond-> {} (letvar2134143 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2134143 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper2134145 input] (clojure.core/let [rawinput2134144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134146 {"Message" (rawinput2134144 "Message")}] (clojure.core/cond-> {} (letvar2134146 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2134146 ["Message"])))))))

(clojure.core/defn- response-create-vocabulary-response ([input] (response-create-vocabulary-response nil input)) ([resultWrapper2134148 input] (clojure.core/let [rawinput2134147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134149 {"VocabularyName" (rawinput2134147 "VocabularyName"), "LanguageCode" (rawinput2134147 "LanguageCode"), "VocabularyState" (rawinput2134147 "VocabularyState"), "LastModifiedTime" (rawinput2134147 "LastModifiedTime"), "FailureReason" (rawinput2134147 "FailureReason")}] (clojure.core/cond-> {} (letvar2134149 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2134149 ["VocabularyName"]))) (letvar2134149 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2134149 ["LanguageCode"]))) (letvar2134149 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2134149 ["VocabularyState"]))) (letvar2134149 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2134149 ["LastModifiedTime"]))) (letvar2134149 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar2134149 ["FailureReason"])))))))

(clojure.core/defn- response-start-transcription-job-response ([input] (response-start-transcription-job-response nil input)) ([resultWrapper2134151 input] (clojure.core/let [rawinput2134150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2134152 {"TranscriptionJob" (rawinput2134150 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar2134152 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar2134152 ["TranscriptionJob"])))))))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/media-sample-rate-hertz (clojure.spec.alpha/int-in 8000 48000))

(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe.-2017-10-26/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__1410940__auto__))))
