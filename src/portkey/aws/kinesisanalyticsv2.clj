...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1869779 input] (clojure.core/let [rawinput1869778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869780 {"ApplicationARN" (rawinput1869778 "ApplicationARN"), "ApplicationVersionId" (rawinput1869778 "ApplicationVersionId"), "InputDescriptions" (rawinput1869778 "InputDescriptions")}] (clojure.core/cond-> {} (letvar1869780 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869780 ["ApplicationARN"]))) (letvar1869780 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869780 ["ApplicationVersionId"]))) (letvar1869780 "InputDescriptions") (clojure.core/assoc :input-descriptions (deser-input-descriptions (clojure.core/get-in letvar1869780 ["InputDescriptions"])))))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1869782 input] (clojure.core/let [rawinput1869781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869783 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1869785 input] (clojure.core/let [rawinput1869784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869786 {"ApplicationARN" (rawinput1869784 "ApplicationARN"), "ApplicationVersionId" (rawinput1869784 "ApplicationVersionId"), "ReferenceDataSourceDescriptions" (rawinput1869784 "ReferenceDataSourceDescriptions")}] (clojure.core/cond-> {} (letvar1869786 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869786 ["ApplicationARN"]))) (letvar1869786 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869786 ["ApplicationVersionId"]))) (letvar1869786 "ReferenceDataSourceDescriptions") (clojure.core/assoc :reference-data-source-descriptions (deser-reference-data-source-descriptions (clojure.core/get-in letvar1869786 ["ReferenceDataSourceDescriptions"])))))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1869788 input] (clojure.core/let [rawinput1869787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869789 {"Message" (rawinput1869787 "Message")}] (clojure.core/cond-> {} (letvar1869789 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869789 ["Message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1869791 input] (clojure.core/let [rawinput1869790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869792 {"InputSchema" (rawinput1869790 "InputSchema"), "ParsedInputRecords" (rawinput1869790 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1869790 "ProcessedInputRecords"), "RawInputRecords" (rawinput1869790 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1869792 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1869792 ["InputSchema"]))) (letvar1869792 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1869792 ["ParsedInputRecords"]))) (letvar1869792 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1869792 ["ProcessedInputRecords"]))) (letvar1869792 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1869792 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1869794 input] (clojure.core/let [rawinput1869793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869795 {"Message" (rawinput1869793 "Message"), "RawInputRecords" (rawinput1869793 "RawInputRecords"), "ProcessedInputRecords" (rawinput1869793 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1869795 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869795 ["Message"]))) (letvar1869795 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1869795 ["RawInputRecords"]))) (letvar1869795 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1869795 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1869797 input] (clojure.core/let [rawinput1869796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869798 {"ApplicationARN" (rawinput1869796 "ApplicationARN"), "ApplicationVersionId" (rawinput1869796 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1869798 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869798 ["ApplicationARN"]))) (letvar1869798 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869798 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1869800 input] (clojure.core/let [rawinput1869799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869801 {"Message" (rawinput1869799 "Message")}] (clojure.core/cond-> {} (letvar1869801 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869801 ["Message"])))))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1869803 input] (clojure.core/let [rawinput1869802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869804 {"ApplicationDetail" (rawinput1869802 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1869804 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1869806 input] (clojure.core/let [rawinput1869805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869807 {"ApplicationARN" (rawinput1869805 "ApplicationARN"), "ApplicationVersionId" (rawinput1869805 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1869807 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869807 ["ApplicationARN"]))) (letvar1869807 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869807 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1869809 input] (clojure.core/let [rawinput1869808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869810 {"Message" (rawinput1869808 "Message")}] (clojure.core/cond-> {} (letvar1869810 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869810 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1869812 input] (clojure.core/let [rawinput1869811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869813 {"Message" (rawinput1869811 "Message")}] (clojure.core/cond-> {} (letvar1869813 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869813 ["Message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1869815 input] (clojure.core/let [rawinput1869814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869816 {"ApplicationDetail" (rawinput1869814 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1869816 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1869818 input] (clojure.core/let [rawinput1869817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869819 {"Message" (rawinput1869817 "Message")}] (clojure.core/cond-> {} (letvar1869819 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869819 ["Message"])))))))

(clojure.core/defn- response-delete-application-snapshot-response ([input] (response-delete-application-snapshot-response nil input)) ([resultWrapper1869821 input] (clojure.core/let [rawinput1869820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869822 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-snapshot-response ([input] (response-describe-application-snapshot-response nil input)) ([resultWrapper1869824 input] (clojure.core/let [rawinput1869823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869825 {"SnapshotDetails" (rawinput1869823 "SnapshotDetails")}] (clojure.core/cond-> {:snapshot-details (deser-snapshot-details (clojure.core/get-in letvar1869825 ["SnapshotDetails"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1869827 input] (clojure.core/let [rawinput1869826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869828 {"Message" (rawinput1869826 "Message")}] (clojure.core/cond-> {} (letvar1869828 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869828 ["Message"])))))))

(clojure.core/defn- response-create-application-snapshot-response ([input] (response-create-application-snapshot-response nil input)) ([resultWrapper1869830 input] (clojure.core/let [rawinput1869829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869831 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1869833 input] (clojure.core/let [rawinput1869832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869834 {"Message" (rawinput1869832 "Message")}] (clojure.core/cond-> {} (letvar1869834 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869834 ["Message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1869836 input] (clojure.core/let [rawinput1869835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869837 {"ApplicationARN" (rawinput1869835 "ApplicationARN"), "ApplicationVersionId" (rawinput1869835 "ApplicationVersionId"), "InputId" (rawinput1869835 "InputId"), "InputProcessingConfigurationDescription" (rawinput1869835 "InputProcessingConfigurationDescription")}] (clojure.core/cond-> {} (letvar1869837 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869837 ["ApplicationARN"]))) (letvar1869837 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869837 ["ApplicationVersionId"]))) (letvar1869837 "InputId") (clojure.core/assoc :input-id (deser-id (clojure.core/get-in letvar1869837 ["InputId"]))) (letvar1869837 "InputProcessingConfigurationDescription") (clojure.core/assoc :input-processing-configuration-description (deser-input-processing-configuration-description (clojure.core/get-in letvar1869837 ["InputProcessingConfigurationDescription"])))))))

(clojure.core/defn- response-list-application-snapshots-response ([input] (response-list-application-snapshots-response nil input)) ([resultWrapper1869839 input] (clojure.core/let [rawinput1869838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869840 {"SnapshotSummaries" (rawinput1869838 "SnapshotSummaries"), "NextToken" (rawinput1869838 "NextToken")}] (clojure.core/cond-> {} (letvar1869840 "SnapshotSummaries") (clojure.core/assoc :snapshot-summaries (deser-snapshot-summaries (clojure.core/get-in letvar1869840 ["SnapshotSummaries"]))) (letvar1869840 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1869840 ["NextToken"])))))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1869842 input] (clojure.core/let [rawinput1869841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869843 {"ApplicationARN" (rawinput1869841 "ApplicationARN"), "ApplicationVersionId" (rawinput1869841 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1869843 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869843 ["ApplicationARN"]))) (letvar1869843 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869843 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1869845 input] (clojure.core/let [rawinput1869844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869846 {"Message" (rawinput1869844 "Message")}] (clojure.core/cond-> {} (letvar1869846 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869846 ["Message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1869848 input] (clojure.core/let [rawinput1869847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869849 {"ApplicationARN" (rawinput1869847 "ApplicationARN"), "ApplicationVersionId" (rawinput1869847 "ApplicationVersionId"), "OutputDescriptions" (rawinput1869847 "OutputDescriptions")}] (clojure.core/cond-> {} (letvar1869849 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869849 ["ApplicationARN"]))) (letvar1869849 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869849 ["ApplicationVersionId"]))) (letvar1869849 "OutputDescriptions") (clojure.core/assoc :output-descriptions (deser-output-descriptions (clojure.core/get-in letvar1869849 ["OutputDescriptions"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1869851 input] (clojure.core/let [rawinput1869850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869852 {"ApplicationDetail" (rawinput1869850 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1869852 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1869854 input] (clojure.core/let [rawinput1869853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869855 {"Message" (rawinput1869853 "Message")}] (clojure.core/cond-> {} (letvar1869855 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869855 ["Message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1869857 input] (clojure.core/let [rawinput1869856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869858 {"ApplicationARN" (rawinput1869856 "ApplicationARN"), "ApplicationVersionId" (rawinput1869856 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1869856 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1869858 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869858 ["ApplicationARN"]))) (letvar1869858 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869858 ["ApplicationVersionId"]))) (letvar1869858 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1869858 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1869860 input] (clojure.core/let [rawinput1869859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869861 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1869863 input] (clojure.core/let [rawinput1869862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869864 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1869866 input] (clojure.core/let [rawinput1869865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869867 {"Message" (rawinput1869865 "Message")}] (clojure.core/cond-> {} (letvar1869867 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869867 ["Message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1869869 input] (clojure.core/let [rawinput1869868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869870 {"ApplicationARN" (rawinput1869868 "ApplicationARN"), "ApplicationVersionId" (rawinput1869868 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1869868 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1869870 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1869870 ["ApplicationARN"]))) (letvar1869870 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1869870 ["ApplicationVersionId"]))) (letvar1869870 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1869870 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1869872 input] (clojure.core/let [rawinput1869871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869873 {"ApplicationSummaries" (rawinput1869871 "ApplicationSummaries"), "NextToken" (rawinput1869871 "NextToken")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1869873 ["ApplicationSummaries"]))} (letvar1869873 "NextToken") (clojure.core/assoc :next-token (deser-application-name (clojure.core/get-in letvar1869873 ["NextToken"])))))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1869875 input] (clojure.core/let [rawinput1869874 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1869876 {"Message" (rawinput1869874 "Message")}] (clojure.core/cond-> {} (letvar1869876 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1869876 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/code-md-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 128 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/property-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/property-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"UTF-8" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/text-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/snapshot-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
