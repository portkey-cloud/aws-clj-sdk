...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1193691 input] (clojure.core/let [rawinput1193690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193692 {"ApplicationARN" (rawinput1193690 "ApplicationARN"), "ApplicationVersionId" (rawinput1193690 "ApplicationVersionId"), "InputDescriptions" (rawinput1193690 "InputDescriptions")}] (clojure.core/cond-> {} (letvar1193692 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193692 ["ApplicationARN"]))) (letvar1193692 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193692 ["ApplicationVersionId"]))) (letvar1193692 "InputDescriptions") (clojure.core/assoc :input-descriptions (deser-input-descriptions (clojure.core/get-in letvar1193692 ["InputDescriptions"])))))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1193694 input] (clojure.core/let [rawinput1193693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193695 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1193697 input] (clojure.core/let [rawinput1193696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193698 {"ApplicationARN" (rawinput1193696 "ApplicationARN"), "ApplicationVersionId" (rawinput1193696 "ApplicationVersionId"), "ReferenceDataSourceDescriptions" (rawinput1193696 "ReferenceDataSourceDescriptions")}] (clojure.core/cond-> {} (letvar1193698 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193698 ["ApplicationARN"]))) (letvar1193698 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193698 ["ApplicationVersionId"]))) (letvar1193698 "ReferenceDataSourceDescriptions") (clojure.core/assoc :reference-data-source-descriptions (deser-reference-data-source-descriptions (clojure.core/get-in letvar1193698 ["ReferenceDataSourceDescriptions"])))))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1193700 input] (clojure.core/let [rawinput1193699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193701 {"Message" (rawinput1193699 "Message")}] (clojure.core/cond-> {} (letvar1193701 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193701 ["Message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1193703 input] (clojure.core/let [rawinput1193702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193704 {"InputSchema" (rawinput1193702 "InputSchema"), "ParsedInputRecords" (rawinput1193702 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1193702 "ProcessedInputRecords"), "RawInputRecords" (rawinput1193702 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1193704 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1193704 ["InputSchema"]))) (letvar1193704 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1193704 ["ParsedInputRecords"]))) (letvar1193704 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1193704 ["ProcessedInputRecords"]))) (letvar1193704 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1193704 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1193706 input] (clojure.core/let [rawinput1193705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193707 {"Message" (rawinput1193705 "Message"), "RawInputRecords" (rawinput1193705 "RawInputRecords"), "ProcessedInputRecords" (rawinput1193705 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1193707 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193707 ["Message"]))) (letvar1193707 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1193707 ["RawInputRecords"]))) (letvar1193707 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1193707 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1193709 input] (clojure.core/let [rawinput1193708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193710 {"ApplicationARN" (rawinput1193708 "ApplicationARN"), "ApplicationVersionId" (rawinput1193708 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1193710 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193710 ["ApplicationARN"]))) (letvar1193710 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193710 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1193712 input] (clojure.core/let [rawinput1193711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193713 {"Message" (rawinput1193711 "Message")}] (clojure.core/cond-> {} (letvar1193713 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193713 ["Message"])))))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1193715 input] (clojure.core/let [rawinput1193714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193716 {"ApplicationDetail" (rawinput1193714 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1193716 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1193718 input] (clojure.core/let [rawinput1193717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193719 {"ApplicationARN" (rawinput1193717 "ApplicationARN"), "ApplicationVersionId" (rawinput1193717 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1193719 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193719 ["ApplicationARN"]))) (letvar1193719 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193719 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1193721 input] (clojure.core/let [rawinput1193720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193722 {"Message" (rawinput1193720 "Message")}] (clojure.core/cond-> {} (letvar1193722 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193722 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1193724 input] (clojure.core/let [rawinput1193723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193725 {"Message" (rawinput1193723 "Message")}] (clojure.core/cond-> {} (letvar1193725 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193725 ["Message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1193727 input] (clojure.core/let [rawinput1193726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193728 {"ApplicationDetail" (rawinput1193726 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1193728 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1193730 input] (clojure.core/let [rawinput1193729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193731 {"Message" (rawinput1193729 "Message")}] (clojure.core/cond-> {} (letvar1193731 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193731 ["Message"])))))))

(clojure.core/defn- response-delete-application-snapshot-response ([input] (response-delete-application-snapshot-response nil input)) ([resultWrapper1193733 input] (clojure.core/let [rawinput1193732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193734 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-snapshot-response ([input] (response-describe-application-snapshot-response nil input)) ([resultWrapper1193736 input] (clojure.core/let [rawinput1193735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193737 {"SnapshotDetails" (rawinput1193735 "SnapshotDetails")}] (clojure.core/cond-> {:snapshot-details (deser-snapshot-details (clojure.core/get-in letvar1193737 ["SnapshotDetails"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1193739 input] (clojure.core/let [rawinput1193738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193740 {"Message" (rawinput1193738 "Message")}] (clojure.core/cond-> {} (letvar1193740 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193740 ["Message"])))))))

(clojure.core/defn- response-create-application-snapshot-response ([input] (response-create-application-snapshot-response nil input)) ([resultWrapper1193742 input] (clojure.core/let [rawinput1193741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193743 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1193745 input] (clojure.core/let [rawinput1193744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193746 {"Message" (rawinput1193744 "Message")}] (clojure.core/cond-> {} (letvar1193746 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193746 ["Message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1193748 input] (clojure.core/let [rawinput1193747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193749 {"ApplicationARN" (rawinput1193747 "ApplicationARN"), "ApplicationVersionId" (rawinput1193747 "ApplicationVersionId"), "InputId" (rawinput1193747 "InputId"), "InputProcessingConfigurationDescription" (rawinput1193747 "InputProcessingConfigurationDescription")}] (clojure.core/cond-> {} (letvar1193749 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193749 ["ApplicationARN"]))) (letvar1193749 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193749 ["ApplicationVersionId"]))) (letvar1193749 "InputId") (clojure.core/assoc :input-id (deser-id (clojure.core/get-in letvar1193749 ["InputId"]))) (letvar1193749 "InputProcessingConfigurationDescription") (clojure.core/assoc :input-processing-configuration-description (deser-input-processing-configuration-description (clojure.core/get-in letvar1193749 ["InputProcessingConfigurationDescription"])))))))

(clojure.core/defn- response-list-application-snapshots-response ([input] (response-list-application-snapshots-response nil input)) ([resultWrapper1193751 input] (clojure.core/let [rawinput1193750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193752 {"SnapshotSummaries" (rawinput1193750 "SnapshotSummaries"), "NextToken" (rawinput1193750 "NextToken")}] (clojure.core/cond-> {} (letvar1193752 "SnapshotSummaries") (clojure.core/assoc :snapshot-summaries (deser-snapshot-summaries (clojure.core/get-in letvar1193752 ["SnapshotSummaries"]))) (letvar1193752 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1193752 ["NextToken"])))))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1193754 input] (clojure.core/let [rawinput1193753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193755 {"ApplicationARN" (rawinput1193753 "ApplicationARN"), "ApplicationVersionId" (rawinput1193753 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1193755 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193755 ["ApplicationARN"]))) (letvar1193755 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193755 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1193757 input] (clojure.core/let [rawinput1193756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193758 {"Message" (rawinput1193756 "Message")}] (clojure.core/cond-> {} (letvar1193758 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193758 ["Message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1193760 input] (clojure.core/let [rawinput1193759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193761 {"ApplicationARN" (rawinput1193759 "ApplicationARN"), "ApplicationVersionId" (rawinput1193759 "ApplicationVersionId"), "OutputDescriptions" (rawinput1193759 "OutputDescriptions")}] (clojure.core/cond-> {} (letvar1193761 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193761 ["ApplicationARN"]))) (letvar1193761 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193761 ["ApplicationVersionId"]))) (letvar1193761 "OutputDescriptions") (clojure.core/assoc :output-descriptions (deser-output-descriptions (clojure.core/get-in letvar1193761 ["OutputDescriptions"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1193763 input] (clojure.core/let [rawinput1193762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193764 {"ApplicationDetail" (rawinput1193762 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1193764 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1193766 input] (clojure.core/let [rawinput1193765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193767 {"Message" (rawinput1193765 "Message")}] (clojure.core/cond-> {} (letvar1193767 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193767 ["Message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1193769 input] (clojure.core/let [rawinput1193768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193770 {"ApplicationARN" (rawinput1193768 "ApplicationARN"), "ApplicationVersionId" (rawinput1193768 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1193768 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1193770 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193770 ["ApplicationARN"]))) (letvar1193770 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193770 ["ApplicationVersionId"]))) (letvar1193770 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1193770 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1193772 input] (clojure.core/let [rawinput1193771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193773 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1193775 input] (clojure.core/let [rawinput1193774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193776 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1193778 input] (clojure.core/let [rawinput1193777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193779 {"Message" (rawinput1193777 "Message")}] (clojure.core/cond-> {} (letvar1193779 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193779 ["Message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1193781 input] (clojure.core/let [rawinput1193780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193782 {"ApplicationARN" (rawinput1193780 "ApplicationARN"), "ApplicationVersionId" (rawinput1193780 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1193780 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1193782 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1193782 ["ApplicationARN"]))) (letvar1193782 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1193782 ["ApplicationVersionId"]))) (letvar1193782 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1193782 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1193784 input] (clojure.core/let [rawinput1193783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193785 {"ApplicationSummaries" (rawinput1193783 "ApplicationSummaries"), "NextToken" (rawinput1193783 "NextToken")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1193785 ["ApplicationSummaries"]))} (letvar1193785 "NextToken") (clojure.core/assoc :next-token (deser-application-name (clojure.core/get-in letvar1193785 ["NextToken"])))))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1193787 input] (clojure.core/let [rawinput1193786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1193788 {"Message" (rawinput1193786 "Message")}] (clojure.core/cond-> {} (letvar1193788 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1193788 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/log-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/in-app-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/code-md-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 128 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/property-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/property-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"UTF-8" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/text-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/snapshot-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
