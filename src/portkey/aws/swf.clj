...
(clojure.core/defn- response-workflow-type-detail ([input] (response-workflow-type-detail nil input)) ([resultWrapper1835741 input] (clojure.core/let [rawinput1835740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835742 {"typeInfo" (rawinput1835740 "typeInfo"), "configuration" (rawinput1835740 "configuration")}] (clojure.core/cond-> {:type-info (deser-workflow-type-info (clojure.core/get-in letvar1835742 ["typeInfo"])), :configuration (deser-workflow-type-configuration (clojure.core/get-in letvar1835742 ["configuration"]))}))))

(clojure.core/defn- response-run ([input] (response-run nil input)) ([resultWrapper1835744 input] (clojure.core/let [rawinput1835743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835745 {"runId" (rawinput1835743 "runId")}] (clojure.core/cond-> {} (letvar1835745 "runId") (clojure.core/assoc :run-id (deser-workflow-run-id (clojure.core/get-in letvar1835745 ["runId"])))))))

(clojure.core/defn- response-workflow-type-infos ([input] (response-workflow-type-infos nil input)) ([resultWrapper1835747 input] (clojure.core/let [rawinput1835746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835748 {"typeInfos" (rawinput1835746 "typeInfos"), "nextPageToken" (rawinput1835746 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-workflow-type-info-list (clojure.core/get-in letvar1835748 ["typeInfos"]))} (letvar1835748 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835748 ["nextPageToken"])))))))

(clojure.core/defn- response-operation-not-permitted-fault ([input] (response-operation-not-permitted-fault nil input)) ([resultWrapper1835750 input] (clojure.core/let [rawinput1835749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835751 {"message" (rawinput1835749 "message")}] (clojure.core/cond-> {} (letvar1835751 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835751 ["message"])))))))

(clojure.core/defn- response-default-undefined-fault ([input] (response-default-undefined-fault nil input)) ([resultWrapper1835753 input] (clojure.core/let [rawinput1835752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835754 {"message" (rawinput1835752 "message")}] (clojure.core/cond-> {} (letvar1835754 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835754 ["message"])))))))

(clojure.core/defn- response-activity-task ([input] (response-activity-task nil input)) ([resultWrapper1835756 input] (clojure.core/let [rawinput1835755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835757 {"taskToken" (rawinput1835755 "taskToken"), "activityId" (rawinput1835755 "activityId"), "startedEventId" (rawinput1835755 "startedEventId"), "workflowExecution" (rawinput1835755 "workflowExecution"), "activityType" (rawinput1835755 "activityType"), "input" (rawinput1835755 "input")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar1835757 ["taskToken"])), :activity-id (deser-activity-id (clojure.core/get-in letvar1835757 ["activityId"])), :started-event-id (deser-event-id (clojure.core/get-in letvar1835757 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar1835757 ["workflowExecution"])), :activity-type (deser-activity-type (clojure.core/get-in letvar1835757 ["activityType"]))} (letvar1835757 "input") (clojure.core/assoc :input (deser-data (clojure.core/get-in letvar1835757 ["input"])))))))

(clojure.core/defn- response-decision-task ([input] (response-decision-task nil input)) ([resultWrapper1835759 input] (clojure.core/let [rawinput1835758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835760 {"taskToken" (rawinput1835758 "taskToken"), "startedEventId" (rawinput1835758 "startedEventId"), "workflowExecution" (rawinput1835758 "workflowExecution"), "workflowType" (rawinput1835758 "workflowType"), "events" (rawinput1835758 "events"), "nextPageToken" (rawinput1835758 "nextPageToken"), "previousStartedEventId" (rawinput1835758 "previousStartedEventId")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar1835760 ["taskToken"])), :started-event-id (deser-event-id (clojure.core/get-in letvar1835760 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar1835760 ["workflowExecution"])), :workflow-type (deser-workflow-type (clojure.core/get-in letvar1835760 ["workflowType"])), :events (deser-history-event-list (clojure.core/get-in letvar1835760 ["events"]))} (letvar1835760 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835760 ["nextPageToken"]))) (letvar1835760 "previousStartedEventId") (clojure.core/assoc :previous-started-event-id (deser-event-id (clojure.core/get-in letvar1835760 ["previousStartedEventId"])))))))

(clojure.core/defn- response-domain-infos ([input] (response-domain-infos nil input)) ([resultWrapper1835762 input] (clojure.core/let [rawinput1835761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835763 {"domainInfos" (rawinput1835761 "domainInfos"), "nextPageToken" (rawinput1835761 "nextPageToken")}] (clojure.core/cond-> {:domain-infos (deser-domain-info-list (clojure.core/get-in letvar1835763 ["domainInfos"]))} (letvar1835763 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835763 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-deprecated-fault ([input] (response-domain-deprecated-fault nil input)) ([resultWrapper1835765 input] (clojure.core/let [rawinput1835764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835766 {"message" (rawinput1835764 "message")}] (clojure.core/cond-> {} (letvar1835766 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835766 ["message"])))))))

(clojure.core/defn- response-history ([input] (response-history nil input)) ([resultWrapper1835768 input] (clojure.core/let [rawinput1835767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835769 {"events" (rawinput1835767 "events"), "nextPageToken" (rawinput1835767 "nextPageToken")}] (clojure.core/cond-> {:events (deser-history-event-list (clojure.core/get-in letvar1835769 ["events"]))} (letvar1835769 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835769 ["nextPageToken"])))))))

(clojure.core/defn- response-pending-task-count ([input] (response-pending-task-count nil input)) ([resultWrapper1835771 input] (clojure.core/let [rawinput1835770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835772 {"count" (rawinput1835770 "count"), "truncated" (rawinput1835770 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar1835772 ["count"]))} (letvar1835772 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar1835772 ["truncated"])))))))

(clojure.core/defn- response-workflow-execution-count ([input] (response-workflow-execution-count nil input)) ([resultWrapper1835774 input] (clojure.core/let [rawinput1835773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835775 {"count" (rawinput1835773 "count"), "truncated" (rawinput1835773 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar1835775 ["count"]))} (letvar1835775 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar1835775 ["truncated"])))))))

(clojure.core/defn- response-limit-exceeded-fault ([input] (response-limit-exceeded-fault nil input)) ([resultWrapper1835777 input] (clojure.core/let [rawinput1835776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835778 {"message" (rawinput1835776 "message")}] (clojure.core/cond-> {} (letvar1835778 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835778 ["message"])))))))

(clojure.core/defn- response-type-already-exists-fault ([input] (response-type-already-exists-fault nil input)) ([resultWrapper1835780 input] (clojure.core/let [rawinput1835779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835781 {"message" (rawinput1835779 "message")}] (clojure.core/cond-> {} (letvar1835781 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835781 ["message"])))))))

(clojure.core/defn- response-activity-type-detail ([input] (response-activity-type-detail nil input)) ([resultWrapper1835783 input] (clojure.core/let [rawinput1835782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835784 {"typeInfo" (rawinput1835782 "typeInfo"), "configuration" (rawinput1835782 "configuration")}] (clojure.core/cond-> {:type-info (deser-activity-type-info (clojure.core/get-in letvar1835784 ["typeInfo"])), :configuration (deser-activity-type-configuration (clojure.core/get-in letvar1835784 ["configuration"]))}))))

(clojure.core/defn- response-unknown-resource-fault ([input] (response-unknown-resource-fault nil input)) ([resultWrapper1835786 input] (clojure.core/let [rawinput1835785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835787 {"message" (rawinput1835785 "message")}] (clojure.core/cond-> {} (letvar1835787 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835787 ["message"])))))))

(clojure.core/defn- response-workflow-execution-detail ([input] (response-workflow-execution-detail nil input)) ([resultWrapper1835789 input] (clojure.core/let [rawinput1835788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835790 {"executionInfo" (rawinput1835788 "executionInfo"), "executionConfiguration" (rawinput1835788 "executionConfiguration"), "openCounts" (rawinput1835788 "openCounts"), "latestActivityTaskTimestamp" (rawinput1835788 "latestActivityTaskTimestamp"), "latestExecutionContext" (rawinput1835788 "latestExecutionContext")}] (clojure.core/cond-> {:execution-info (deser-workflow-execution-info (clojure.core/get-in letvar1835790 ["executionInfo"])), :execution-configuration (deser-workflow-execution-configuration (clojure.core/get-in letvar1835790 ["executionConfiguration"])), :open-counts (deser-workflow-execution-open-counts (clojure.core/get-in letvar1835790 ["openCounts"]))} (letvar1835790 "latestActivityTaskTimestamp") (clojure.core/assoc :latest-activity-task-timestamp (deser-timestamp (clojure.core/get-in letvar1835790 ["latestActivityTaskTimestamp"]))) (letvar1835790 "latestExecutionContext") (clojure.core/assoc :latest-execution-context (deser-data (clojure.core/get-in letvar1835790 ["latestExecutionContext"])))))))

(clojure.core/defn- response-workflow-execution-already-started-fault ([input] (response-workflow-execution-already-started-fault nil input)) ([resultWrapper1835792 input] (clojure.core/let [rawinput1835791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835793 {"message" (rawinput1835791 "message")}] (clojure.core/cond-> {} (letvar1835793 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835793 ["message"])))))))

(clojure.core/defn- response-domain-detail ([input] (response-domain-detail nil input)) ([resultWrapper1835795 input] (clojure.core/let [rawinput1835794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835796 {"domainInfo" (rawinput1835794 "domainInfo"), "configuration" (rawinput1835794 "configuration")}] (clojure.core/cond-> {:domain-info (deser-domain-info (clojure.core/get-in letvar1835796 ["domainInfo"])), :configuration (deser-domain-configuration (clojure.core/get-in letvar1835796 ["configuration"]))}))))

(clojure.core/defn- response-workflow-execution-infos ([input] (response-workflow-execution-infos nil input)) ([resultWrapper1835798 input] (clojure.core/let [rawinput1835797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835799 {"executionInfos" (rawinput1835797 "executionInfos"), "nextPageToken" (rawinput1835797 "nextPageToken")}] (clojure.core/cond-> {:execution-infos (deser-workflow-execution-info-list (clojure.core/get-in letvar1835799 ["executionInfos"]))} (letvar1835799 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835799 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-already-exists-fault ([input] (response-domain-already-exists-fault nil input)) ([resultWrapper1835801 input] (clojure.core/let [rawinput1835800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835802 {"message" (rawinput1835800 "message")}] (clojure.core/cond-> {} (letvar1835802 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835802 ["message"])))))))

(clojure.core/defn- response-type-deprecated-fault ([input] (response-type-deprecated-fault nil input)) ([resultWrapper1835804 input] (clojure.core/let [rawinput1835803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835805 {"message" (rawinput1835803 "message")}] (clojure.core/cond-> {} (letvar1835805 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1835805 ["message"])))))))

(clojure.core/defn- response-activity-task-status ([input] (response-activity-task-status nil input)) ([resultWrapper1835807 input] (clojure.core/let [rawinput1835806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835808 {"cancelRequested" (rawinput1835806 "cancelRequested")}] (clojure.core/cond-> {:cancel-requested (deser-canceled (clojure.core/get-in letvar1835808 ["cancelRequested"]))}))))

(clojure.core/defn- response-activity-type-infos ([input] (response-activity-type-infos nil input)) ([resultWrapper1835810 input] (clojure.core/let [rawinput1835809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1835811 {"typeInfos" (rawinput1835809 "typeInfos"), "nextPageToken" (rawinput1835809 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-activity-type-info-list (clojure.core/get-in letvar1835811 ["typeInfos"]))} (letvar1835811 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar1835811 ["nextPageToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.swf/workflow-run-id-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/limited-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.swf/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/cause-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1728))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-days (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/workflow-run-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-seconds (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-seconds-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/activity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf/failure-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/version-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/marker-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/canceled clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.swf/function-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/timer-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf/identity (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.swf/tag (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/task-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/function-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf/signal-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/terminate-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/workflow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/page-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
