...
(clojure.core/defn- response-workflow-type-detail ([input] (response-workflow-type-detail nil input)) ([resultWrapper2118321 input] (clojure.core/let [rawinput2118320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118322 {"typeInfo" (rawinput2118320 "typeInfo"), "configuration" (rawinput2118320 "configuration")}] (clojure.core/cond-> {:type-info (deser-workflow-type-info (clojure.core/get-in letvar2118322 ["typeInfo"])), :configuration (deser-workflow-type-configuration (clojure.core/get-in letvar2118322 ["configuration"]))}))))

(clojure.core/defn- response-run ([input] (response-run nil input)) ([resultWrapper2118324 input] (clojure.core/let [rawinput2118323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118325 {"runId" (rawinput2118323 "runId")}] (clojure.core/cond-> {} (letvar2118325 "runId") (clojure.core/assoc :run-id (deser-workflow-run-id (clojure.core/get-in letvar2118325 ["runId"])))))))

(clojure.core/defn- response-workflow-type-infos ([input] (response-workflow-type-infos nil input)) ([resultWrapper2118327 input] (clojure.core/let [rawinput2118326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118328 {"typeInfos" (rawinput2118326 "typeInfos"), "nextPageToken" (rawinput2118326 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-workflow-type-info-list (clojure.core/get-in letvar2118328 ["typeInfos"]))} (letvar2118328 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118328 ["nextPageToken"])))))))

(clojure.core/defn- response-operation-not-permitted-fault ([input] (response-operation-not-permitted-fault nil input)) ([resultWrapper2118330 input] (clojure.core/let [rawinput2118329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118331 {"message" (rawinput2118329 "message")}] (clojure.core/cond-> {} (letvar2118331 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118331 ["message"])))))))

(clojure.core/defn- response-default-undefined-fault ([input] (response-default-undefined-fault nil input)) ([resultWrapper2118333 input] (clojure.core/let [rawinput2118332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118334 {"message" (rawinput2118332 "message")}] (clojure.core/cond-> {} (letvar2118334 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118334 ["message"])))))))

(clojure.core/defn- response-activity-task ([input] (response-activity-task nil input)) ([resultWrapper2118336 input] (clojure.core/let [rawinput2118335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118337 {"taskToken" (rawinput2118335 "taskToken"), "activityId" (rawinput2118335 "activityId"), "startedEventId" (rawinput2118335 "startedEventId"), "workflowExecution" (rawinput2118335 "workflowExecution"), "activityType" (rawinput2118335 "activityType"), "input" (rawinput2118335 "input")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar2118337 ["taskToken"])), :activity-id (deser-activity-id (clojure.core/get-in letvar2118337 ["activityId"])), :started-event-id (deser-event-id (clojure.core/get-in letvar2118337 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar2118337 ["workflowExecution"])), :activity-type (deser-activity-type (clojure.core/get-in letvar2118337 ["activityType"]))} (letvar2118337 "input") (clojure.core/assoc :input (deser-data (clojure.core/get-in letvar2118337 ["input"])))))))

(clojure.core/defn- response-decision-task ([input] (response-decision-task nil input)) ([resultWrapper2118339 input] (clojure.core/let [rawinput2118338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118340 {"taskToken" (rawinput2118338 "taskToken"), "startedEventId" (rawinput2118338 "startedEventId"), "workflowExecution" (rawinput2118338 "workflowExecution"), "workflowType" (rawinput2118338 "workflowType"), "events" (rawinput2118338 "events"), "nextPageToken" (rawinput2118338 "nextPageToken"), "previousStartedEventId" (rawinput2118338 "previousStartedEventId")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar2118340 ["taskToken"])), :started-event-id (deser-event-id (clojure.core/get-in letvar2118340 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar2118340 ["workflowExecution"])), :workflow-type (deser-workflow-type (clojure.core/get-in letvar2118340 ["workflowType"])), :events (deser-history-event-list (clojure.core/get-in letvar2118340 ["events"]))} (letvar2118340 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118340 ["nextPageToken"]))) (letvar2118340 "previousStartedEventId") (clojure.core/assoc :previous-started-event-id (deser-event-id (clojure.core/get-in letvar2118340 ["previousStartedEventId"])))))))

(clojure.core/defn- response-domain-infos ([input] (response-domain-infos nil input)) ([resultWrapper2118342 input] (clojure.core/let [rawinput2118341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118343 {"domainInfos" (rawinput2118341 "domainInfos"), "nextPageToken" (rawinput2118341 "nextPageToken")}] (clojure.core/cond-> {:domain-infos (deser-domain-info-list (clojure.core/get-in letvar2118343 ["domainInfos"]))} (letvar2118343 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118343 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-deprecated-fault ([input] (response-domain-deprecated-fault nil input)) ([resultWrapper2118345 input] (clojure.core/let [rawinput2118344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118346 {"message" (rawinput2118344 "message")}] (clojure.core/cond-> {} (letvar2118346 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118346 ["message"])))))))

(clojure.core/defn- response-history ([input] (response-history nil input)) ([resultWrapper2118348 input] (clojure.core/let [rawinput2118347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118349 {"events" (rawinput2118347 "events"), "nextPageToken" (rawinput2118347 "nextPageToken")}] (clojure.core/cond-> {:events (deser-history-event-list (clojure.core/get-in letvar2118349 ["events"]))} (letvar2118349 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118349 ["nextPageToken"])))))))

(clojure.core/defn- response-pending-task-count ([input] (response-pending-task-count nil input)) ([resultWrapper2118351 input] (clojure.core/let [rawinput2118350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118352 {"count" (rawinput2118350 "count"), "truncated" (rawinput2118350 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar2118352 ["count"]))} (letvar2118352 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar2118352 ["truncated"])))))))

(clojure.core/defn- response-workflow-execution-count ([input] (response-workflow-execution-count nil input)) ([resultWrapper2118354 input] (clojure.core/let [rawinput2118353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118355 {"count" (rawinput2118353 "count"), "truncated" (rawinput2118353 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar2118355 ["count"]))} (letvar2118355 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar2118355 ["truncated"])))))))

(clojure.core/defn- response-limit-exceeded-fault ([input] (response-limit-exceeded-fault nil input)) ([resultWrapper2118357 input] (clojure.core/let [rawinput2118356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118358 {"message" (rawinput2118356 "message")}] (clojure.core/cond-> {} (letvar2118358 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118358 ["message"])))))))

(clojure.core/defn- response-type-already-exists-fault ([input] (response-type-already-exists-fault nil input)) ([resultWrapper2118360 input] (clojure.core/let [rawinput2118359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118361 {"message" (rawinput2118359 "message")}] (clojure.core/cond-> {} (letvar2118361 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118361 ["message"])))))))

(clojure.core/defn- response-activity-type-detail ([input] (response-activity-type-detail nil input)) ([resultWrapper2118363 input] (clojure.core/let [rawinput2118362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118364 {"typeInfo" (rawinput2118362 "typeInfo"), "configuration" (rawinput2118362 "configuration")}] (clojure.core/cond-> {:type-info (deser-activity-type-info (clojure.core/get-in letvar2118364 ["typeInfo"])), :configuration (deser-activity-type-configuration (clojure.core/get-in letvar2118364 ["configuration"]))}))))

(clojure.core/defn- response-unknown-resource-fault ([input] (response-unknown-resource-fault nil input)) ([resultWrapper2118366 input] (clojure.core/let [rawinput2118365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118367 {"message" (rawinput2118365 "message")}] (clojure.core/cond-> {} (letvar2118367 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118367 ["message"])))))))

(clojure.core/defn- response-workflow-execution-detail ([input] (response-workflow-execution-detail nil input)) ([resultWrapper2118369 input] (clojure.core/let [rawinput2118368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118370 {"executionInfo" (rawinput2118368 "executionInfo"), "executionConfiguration" (rawinput2118368 "executionConfiguration"), "openCounts" (rawinput2118368 "openCounts"), "latestActivityTaskTimestamp" (rawinput2118368 "latestActivityTaskTimestamp"), "latestExecutionContext" (rawinput2118368 "latestExecutionContext")}] (clojure.core/cond-> {:execution-info (deser-workflow-execution-info (clojure.core/get-in letvar2118370 ["executionInfo"])), :execution-configuration (deser-workflow-execution-configuration (clojure.core/get-in letvar2118370 ["executionConfiguration"])), :open-counts (deser-workflow-execution-open-counts (clojure.core/get-in letvar2118370 ["openCounts"]))} (letvar2118370 "latestActivityTaskTimestamp") (clojure.core/assoc :latest-activity-task-timestamp (deser-timestamp (clojure.core/get-in letvar2118370 ["latestActivityTaskTimestamp"]))) (letvar2118370 "latestExecutionContext") (clojure.core/assoc :latest-execution-context (deser-data (clojure.core/get-in letvar2118370 ["latestExecutionContext"])))))))

(clojure.core/defn- response-workflow-execution-already-started-fault ([input] (response-workflow-execution-already-started-fault nil input)) ([resultWrapper2118372 input] (clojure.core/let [rawinput2118371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118373 {"message" (rawinput2118371 "message")}] (clojure.core/cond-> {} (letvar2118373 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118373 ["message"])))))))

(clojure.core/defn- response-domain-detail ([input] (response-domain-detail nil input)) ([resultWrapper2118375 input] (clojure.core/let [rawinput2118374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118376 {"domainInfo" (rawinput2118374 "domainInfo"), "configuration" (rawinput2118374 "configuration")}] (clojure.core/cond-> {:domain-info (deser-domain-info (clojure.core/get-in letvar2118376 ["domainInfo"])), :configuration (deser-domain-configuration (clojure.core/get-in letvar2118376 ["configuration"]))}))))

(clojure.core/defn- response-workflow-execution-infos ([input] (response-workflow-execution-infos nil input)) ([resultWrapper2118378 input] (clojure.core/let [rawinput2118377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118379 {"executionInfos" (rawinput2118377 "executionInfos"), "nextPageToken" (rawinput2118377 "nextPageToken")}] (clojure.core/cond-> {:execution-infos (deser-workflow-execution-info-list (clojure.core/get-in letvar2118379 ["executionInfos"]))} (letvar2118379 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118379 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-already-exists-fault ([input] (response-domain-already-exists-fault nil input)) ([resultWrapper2118381 input] (clojure.core/let [rawinput2118380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118382 {"message" (rawinput2118380 "message")}] (clojure.core/cond-> {} (letvar2118382 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118382 ["message"])))))))

(clojure.core/defn- response-type-deprecated-fault ([input] (response-type-deprecated-fault nil input)) ([resultWrapper2118384 input] (clojure.core/let [rawinput2118383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118385 {"message" (rawinput2118383 "message")}] (clojure.core/cond-> {} (letvar2118385 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118385 ["message"])))))))

(clojure.core/defn- response-activity-task-status ([input] (response-activity-task-status nil input)) ([resultWrapper2118387 input] (clojure.core/let [rawinput2118386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118388 {"cancelRequested" (rawinput2118386 "cancelRequested")}] (clojure.core/cond-> {:cancel-requested (deser-canceled (clojure.core/get-in letvar2118388 ["cancelRequested"]))}))))

(clojure.core/defn- response-activity-type-infos ([input] (response-activity-type-infos nil input)) ([resultWrapper2118390 input] (clojure.core/let [rawinput2118389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118391 {"typeInfos" (rawinput2118389 "typeInfos"), "nextPageToken" (rawinput2118389 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-activity-type-info-list (clojure.core/get-in letvar2118391 ["typeInfos"]))} (letvar2118391 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118391 ["nextPageToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.swf/workflow-run-id-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/limited-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.swf/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/cause-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1728))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-days (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/workflow-run-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-seconds (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/duration-in-seconds-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf/activity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf/failure-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/version-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/marker-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/canceled clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.swf/function-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/timer-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf/identity (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.swf/tag (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf/task-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/function-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf/signal-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/terminate-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf/workflow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf/page-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
