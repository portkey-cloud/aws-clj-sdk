...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar1144429 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1144429 ["Quantity" :content]))} (letvar1144429 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar1144429 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile [input] (clojure.core/let [letvar1144513 {"Format" (portkey.aws/getback-xml-elem-with-tag "Format" input), "ProfileId" (portkey.aws/getback-xml-elem-with-tag "ProfileId" input), "ContentType" (portkey.aws/getback-xml-elem-with-tag "ContentType" input)}] (clojure.core/cond-> {:format (deser-format (clojure.core/get-in letvar1144513 ["Format" :content])), :content-type (deserstring (clojure.core/get-in letvar1144513 ["ContentType" :content]))} (letvar1144513 "ProfileId") (clojure.core/assoc :profile-id (deserstring (clojure.core/get-in letvar1144513 ["ProfileId" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar1144597 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "IncludeCookies" (portkey.aws/getback-xml-elem-with-tag "IncludeCookies" input), "Bucket" (portkey.aws/getback-xml-elem-with-tag "Bucket" input), "Prefix" (portkey.aws/getback-xml-elem-with-tag "Prefix" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1144597 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar1144597 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar1144597 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar1144597 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar1144681 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "CreateTime" (portkey.aws/getback-xml-elem-with-tag "CreateTime" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1144681 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar1144681 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar1144681 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar1144782 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "CreateTime" (portkey.aws/getback-xml-elem-with-tag "CreateTime" input), "InvalidationBatch" (portkey.aws/getback-xml-elem-with-tag "InvalidationBatch" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1144782 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar1144782 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar1144782 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar1144782 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-field-patterns [input] (clojure.core/let [letvar1144905 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1144905 ["Quantity" :content]))} (letvar1144905 "Items") (clojure.core/assoc :items (deser-field-pattern-list (clojure.core/get-in letvar1144905 ["Items" :content]))))))

(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar1144989 {"GeoRestriction" (portkey.aws/getback-xml-elem-with-tag "GeoRestriction" input)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar1144989 ["GeoRestriction" :content]))})))

(clojure.core/defn- deser-field-level-encryption-profile-config [input] (clojure.core/let [letvar1145073 {"Name" (portkey.aws/getback-xml-elem-with-tag "Name" input), "CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "EncryptionEntities" (portkey.aws/getback-xml-elem-with-tag "EncryptionEntities" input)}] (clojure.core/cond-> {:name (deserstring (clojure.core/get-in letvar1145073 ["Name" :content])), :caller-reference (deserstring (clojure.core/get-in letvar1145073 ["CallerReference" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar1145073 ["EncryptionEntities" :content]))} (letvar1145073 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1145073 ["Comment" :content]))))))

(clojure.core/defn- deserstring [input] (clojure.core/first input))

(clojure.core/defn- deser-field-level-encryption-config [input] (clojure.core/let [letvar1145162 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "QueryArgProfileConfig" (portkey.aws/getback-xml-elem-with-tag "QueryArgProfileConfig" input), "ContentTypeProfileConfig" (portkey.aws/getback-xml-elem-with-tag "ContentTypeProfileConfig" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1145162 ["CallerReference" :content]))} (letvar1145162 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1145162 ["Comment" :content]))) (letvar1145162 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar1145162 ["QueryArgProfileConfig" :content]))) (letvar1145162 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar1145162 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile [input] (clojure.core/let [letvar1145246 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "FieldLevelEncryptionProfileConfig" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfileConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1145246 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1145246 ["LastModifiedTime" :content])), :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar1145246 ["FieldLevelEncryptionProfileConfig" :content]))})))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar1145330 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "ARN" (portkey.aws/getback-xml-elem-with-tag "ARN" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "InProgressInvalidationBatches" (portkey.aws/getback-xml-elem-with-tag "InProgressInvalidationBatches" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "ActiveTrustedSigners" (portkey.aws/getback-xml-elem-with-tag "ActiveTrustedSigners" input), "DistributionConfig" (portkey.aws/getback-xml-elem-with-tag "DistributionConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1145330 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar1145330 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar1145330 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1145330 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar1145330 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar1145330 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar1145330 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar1145330 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar1145414 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1145414 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1145414 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1145414 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1145414 ["Quantity" :content]))} (letvar1145414 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1145414 ["NextMarker" :content]))) (letvar1145414 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar1145414 ["Items" :content]))))))

(clojure.core/defn- deser-query-arg-profile [input] (clojure.core/let [letvar1145498 {"QueryArg" (portkey.aws/getback-xml-elem-with-tag "QueryArg" input), "ProfileId" (portkey.aws/getback-xml-elem-with-tag "ProfileId" input)}] (clojure.core/cond-> {:query-arg (deserstring (clojure.core/get-in letvar1145498 ["QueryArg" :content])), :profile-id (deserstring (clojure.core/get-in letvar1145498 ["ProfileId" :content]))})))

(clojure.core/defn- deser-lambda-function-association [input] (clojure.core/let [letvar1145582 {"LambdaFunctionARN" (portkey.aws/getback-xml-elem-with-tag "LambdaFunctionARN" input), "EventType" (portkey.aws/getback-xml-elem-with-tag "EventType" input)}] (clojure.core/cond-> {:lambda-function-arn (deser-lambda-function-arn (clojure.core/get-in letvar1145582 ["LambdaFunctionARN" :content])), :event-type (deser-event-type (clojure.core/get-in letvar1145582 ["EventType" :content]))})))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar1145666 {"QueryString" (portkey.aws/getback-xml-elem-with-tag "QueryString" input), "Cookies" (portkey.aws/getback-xml-elem-with-tag "Cookies" input), "Headers" (portkey.aws/getback-xml-elem-with-tag "Headers" input), "QueryStringCacheKeys" (portkey.aws/getback-xml-elem-with-tag "QueryStringCacheKeys" input)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar1145666 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar1145666 ["Cookies" :content]))} (letvar1145666 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar1145666 ["Headers" :content]))) (letvar1145666 "QueryStringCacheKeys") (clojure.core/assoc :query-string-cache-keys (deser-query-string-cache-keys (clojure.core/get-in letvar1145666 ["QueryStringCacheKeys" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar1145750 {"Paths" (portkey.aws/getback-xml-elem-with-tag "Paths" input), "CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar1145750 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar1145750 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar1145868 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1145868 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1145868 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1145868 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1145868 ["Quantity" :content]))} (letvar1145868 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1145868 ["NextMarker" :content]))) (letvar1145868 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar1145868 ["Items" :content]))))))

(clojure.core/defn- deser-public-key-config [input] (clojure.core/let [letvar1145952 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Name" (portkey.aws/getback-xml-elem-with-tag "Name" input), "EncodedKey" (portkey.aws/getback-xml-elem-with-tag "EncodedKey" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1145952 ["CallerReference" :content])), :name (deserstring (clojure.core/get-in letvar1145952 ["Name" :content])), :encoded-key (deserstring (clojure.core/get-in letvar1145952 ["EncodedKey" :content]))} (letvar1145952 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1145952 ["Comment" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar1146058 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "ARN" (portkey.aws/getback-xml-elem-with-tag "ARN" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "ActiveTrustedSigners" (portkey.aws/getback-xml-elem-with-tag "ActiveTrustedSigners" input), "StreamingDistributionConfig" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1146058 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar1146058 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar1146058 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar1146058 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar1146058 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar1146058 ["StreamingDistributionConfig" :content]))} (letvar1146058 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar1146058 ["LastModifiedTime" :content]))))))

(clojure.core/defn- deser-lambda-function-associations [input] (clojure.core/let [letvar1146142 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1146142 ["Quantity" :content]))} (letvar1146142 "Items") (clojure.core/assoc :items (deser-lambda-function-association-list (clojure.core/get-in letvar1146142 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entities [input] (clojure.core/let [letvar1146226 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1146226 ["Quantity" :content]))} (letvar1146226 "Items") (clojure.core/assoc :items (deser-encryption-entity-list (clojure.core/get-in letvar1146226 ["Items" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-summary [input] (clojure.core/let [letvar1146315 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "Name" (portkey.aws/getback-xml-elem-with-tag "Name" input), "EncryptionEntities" (portkey.aws/getback-xml-elem-with-tag "EncryptionEntities" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1146315 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1146315 ["LastModifiedTime" :content])), :name (deserstring (clojure.core/get-in letvar1146315 ["Name" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar1146315 ["EncryptionEntities" :content]))} (letvar1146315 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1146315 ["Comment" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar1146416 {"ErrorCode" (portkey.aws/getback-xml-elem-with-tag "ErrorCode" input), "ResponsePagePath" (portkey.aws/getback-xml-elem-with-tag "ResponsePagePath" input), "ResponseCode" (portkey.aws/getback-xml-elem-with-tag "ResponseCode" input), "ErrorCachingMinTTL" (portkey.aws/getback-xml-elem-with-tag "ErrorCachingMinTTL" input)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar1146416 ["ErrorCode" :content]))} (letvar1146416 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar1146416 ["ResponsePagePath" :content]))) (letvar1146416 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar1146416 ["ResponseCode" :content]))) (letvar1146416 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar1146416 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar1146517 {"AwsAccountNumber" (portkey.aws/getback-xml-elem-with-tag "AwsAccountNumber" input), "KeyPairIds" (portkey.aws/getback-xml-elem-with-tag "KeyPairIds" input)}] (clojure.core/cond-> {} (letvar1146517 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar1146517 ["AwsAccountNumber" :content]))) (letvar1146517 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar1146517 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-list [input] (clojure.core/let [letvar1146620 {"NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar1146620 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar1146620 ["Quantity" :content]))} (letvar1146620 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1146620 ["NextMarker" :content]))) (letvar1146620 "Items") (clojure.core/assoc :items (deser-field-level-encryption-profile-summary-list (clojure.core/get-in letvar1146620 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile-config [input] (clojure.core/let [letvar1146704 {"ForwardWhenContentTypeIsUnknown" (portkey.aws/getback-xml-elem-with-tag "ForwardWhenContentTypeIsUnknown" input), "ContentTypeProfiles" (portkey.aws/getback-xml-elem-with-tag "ContentTypeProfiles" input)}] (clojure.core/cond-> {:forward-when-content-type-is-unknown (deserboolean (clojure.core/get-in letvar1146704 ["ForwardWhenContentTypeIsUnknown" :content]))} (letvar1146704 "ContentTypeProfiles") (clojure.core/assoc :content-type-profiles (deser-content-type-profiles (clojure.core/get-in letvar1146704 ["ContentTypeProfiles" :content]))))))

(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar1146788 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1146788 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar1146788 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (clojure.core/first input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar1146877 {"Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {} (letvar1146877 "Items") (clojure.core/assoc :items (deser-tag-list (clojure.core/get-in letvar1146877 ["Items" :content]))))))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar1146995 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1146995 ["Quantity" :content]))} (letvar1146995 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar1146995 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar1147079 {"SmoothStreaming" (portkey.aws/getback-xml-elem-with-tag "SmoothStreaming" input), "FieldLevelEncryptionId" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionId" input), "Compress" (portkey.aws/getback-xml-elem-with-tag "Compress" input), "ForwardedValues" (portkey.aws/getback-xml-elem-with-tag "ForwardedValues" input), "TargetOriginId" (portkey.aws/getback-xml-elem-with-tag "TargetOriginId" input), "LambdaFunctionAssociations" (portkey.aws/getback-xml-elem-with-tag "LambdaFunctionAssociations" input), "ViewerProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "ViewerProtocolPolicy" input), "MinTTL" (portkey.aws/getback-xml-elem-with-tag "MinTTL" input), "PathPattern" (portkey.aws/getback-xml-elem-with-tag "PathPattern" input), "MaxTTL" (portkey.aws/getback-xml-elem-with-tag "MaxTTL" input), "AllowedMethods" (portkey.aws/getback-xml-elem-with-tag "AllowedMethods" input), "DefaultTTL" (portkey.aws/getback-xml-elem-with-tag "DefaultTTL" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar1147079 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar1147079 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar1147079 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1147079 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar1147079 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar1147079 ["MinTTL" :content]))} (letvar1147079 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar1147079 ["SmoothStreaming" :content]))) (letvar1147079 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar1147079 ["FieldLevelEncryptionId" :content]))) (letvar1147079 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar1147079 ["Compress" :content]))) (letvar1147079 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar1147079 ["LambdaFunctionAssociations" :content]))) (letvar1147079 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar1147079 ["MaxTTL" :content]))) (letvar1147079 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar1147079 ["AllowedMethods" :content]))) (letvar1147079 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar1147079 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar1147163 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1147163 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar1147163 ["Quantity" :content]))} (letvar1147163 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar1147163 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar1147247 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "OriginPath" (portkey.aws/getback-xml-elem-with-tag "OriginPath" input), "CustomHeaders" (portkey.aws/getback-xml-elem-with-tag "CustomHeaders" input), "S3OriginConfig" (portkey.aws/getback-xml-elem-with-tag "S3OriginConfig" input), "CustomOriginConfig" (portkey.aws/getback-xml-elem-with-tag "CustomOriginConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1147247 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar1147247 ["DomainName" :content]))} (letvar1147247 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar1147247 ["OriginPath" :content]))) (letvar1147247 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar1147247 ["CustomHeaders" :content]))) (letvar1147247 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar1147247 ["S3OriginConfig" :content]))) (letvar1147247 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar1147247 ["CustomOriginConfig" :content]))))))
...
(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar1147338 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1147338 ["Quantity" :content]))} (letvar1147338 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar1147338 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar1147422 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1147422 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1147422 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1147422 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1147422 ["Quantity" :content]))} (letvar1147422 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1147422 ["NextMarker" :content]))) (letvar1147422 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar1147422 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar1147506 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1147506 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar1147506 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar1147590 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1147590 ["Quantity" :content]))} (letvar1147590 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar1147590 ["Items" :content]))))))
...
(clojure.core/defn- deser-content-type-profiles [input] (clojure.core/let [letvar1147679 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1147679 ["Quantity" :content]))} (letvar1147679 "Items") (clojure.core/assoc :items (deser-content-type-profile-list (clojure.core/get-in letvar1147679 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entity [input] (clojure.core/let [letvar1147763 {"PublicKeyId" (portkey.aws/getback-xml-elem-with-tag "PublicKeyId" input), "ProviderId" (portkey.aws/getback-xml-elem-with-tag "ProviderId" input), "FieldPatterns" (portkey.aws/getback-xml-elem-with-tag "FieldPatterns" input)}] (clojure.core/cond-> {:public-key-id (deserstring (clojure.core/get-in letvar1147763 ["PublicKeyId" :content])), :provider-id (deserstring (clojure.core/get-in letvar1147763 ["ProviderId" :content])), :field-patterns (deser-field-patterns (clojure.core/get-in letvar1147763 ["FieldPatterns" :content]))})))

(clojure.core/defn- deser-lambda-function-arn [input] (clojure.core/first input))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar1147852 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input), "CachedMethods" (portkey.aws/getback-xml-elem-with-tag "CachedMethods" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1147852 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar1147852 ["Items" :content]))} (letvar1147852 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar1147852 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar1147941 {"HTTPPort" (portkey.aws/getback-xml-elem-with-tag "HTTPPort" input), "HTTPSPort" (portkey.aws/getback-xml-elem-with-tag "HTTPSPort" input), "OriginProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "OriginProtocolPolicy" input), "OriginSslProtocols" (portkey.aws/getback-xml-elem-with-tag "OriginSslProtocols" input), "OriginReadTimeout" (portkey.aws/getback-xml-elem-with-tag "OriginReadTimeout" input), "OriginKeepaliveTimeout" (portkey.aws/getback-xml-elem-with-tag "OriginKeepaliveTimeout" input)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar1147941 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar1147941 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar1147941 ["OriginProtocolPolicy" :content]))} (letvar1147941 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar1147941 ["OriginSslProtocols" :content]))) (letvar1147941 "OriginReadTimeout") (clojure.core/assoc :origin-read-timeout (deserinteger (clojure.core/get-in letvar1147941 ["OriginReadTimeout" :content]))) (letvar1147941 "OriginKeepaliveTimeout") (clojure.core/assoc :origin-keepalive-timeout (deserinteger (clojure.core/get-in letvar1147941 ["OriginKeepaliveTimeout" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar1148025 {"DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "OriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "OriginAccessIdentity" input)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar1148025 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar1148025 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar1148109 {"Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "ARN" (portkey.aws/getback-xml-elem-with-tag "ARN" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "S3Origin" (portkey.aws/getback-xml-elem-with-tag "S3Origin" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar1148109 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar1148109 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar1148109 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar1148109 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1148109 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar1148109 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar1148109 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar1148109 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1148109 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar1148109 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar1148109 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar1148193 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "S3CanonicalUserId" (portkey.aws/getback-xml-elem-with-tag "S3CanonicalUserId" input), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1148193 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar1148193 ["S3CanonicalUserId" :content]))} (letvar1148193 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar1148193 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption [input] (clojure.core/let [letvar1148294 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "FieldLevelEncryptionConfig" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1148294 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1148294 ["LastModifiedTime" :content])), :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar1148294 ["FieldLevelEncryptionConfig" :content]))})))

(clojure.core/defn- deser-tag-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser-tag coll))) input))

(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar1148395 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1148395 ["Quantity" :content]))} (letvar1148395 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar1148395 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar1148479 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1148479 ["Quantity" :content]))} (letvar1148479 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar1148479 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar1148563 {"DefaultRootObject" (portkey.aws/getback-xml-elem-with-tag "DefaultRootObject" input), "CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "IsIPV6Enabled" (portkey.aws/getback-xml-elem-with-tag "IsIPV6Enabled" input), "Restrictions" (portkey.aws/getback-xml-elem-with-tag "Restrictions" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "WebACLId" (portkey.aws/getback-xml-elem-with-tag "WebACLId" input), "Logging" (portkey.aws/getback-xml-elem-with-tag "Logging" input), "CacheBehaviors" (portkey.aws/getback-xml-elem-with-tag "CacheBehaviors" input), "CustomErrorResponses" (portkey.aws/getback-xml-elem-with-tag "CustomErrorResponses" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "Origins" (portkey.aws/getback-xml-elem-with-tag "Origins" input), "HttpVersion" (portkey.aws/getback-xml-elem-with-tag "HttpVersion" input), "DefaultCacheBehavior" (portkey.aws/getback-xml-elem-with-tag "DefaultCacheBehavior" input), "ViewerCertificate" (portkey.aws/getback-xml-elem-with-tag "ViewerCertificate" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1148563 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar1148563 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar1148563 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar1148563 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar1148563 ["Enabled" :content]))} (letvar1148563 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar1148563 ["DefaultRootObject" :content]))) (letvar1148563 "IsIPV6Enabled") (clojure.core/assoc :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar1148563 ["IsIPV6Enabled" :content]))) (letvar1148563 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar1148563 ["Restrictions" :content]))) (letvar1148563 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar1148563 ["WebACLId" :content]))) (letvar1148563 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar1148563 ["Logging" :content]))) (letvar1148563 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar1148563 ["CacheBehaviors" :content]))) (letvar1148563 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar1148563 ["CustomErrorResponses" :content]))) (letvar1148563 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar1148563 ["Aliases" :content]))) (letvar1148563 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar1148563 ["PriceClass" :content]))) (letvar1148563 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar1148563 ["HttpVersion" :content]))) (letvar1148563 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar1148563 ["ViewerCertificate" :content]))))))

(clojure.core/defn- deser-public-key-summary [input] (clojure.core/let [letvar1148647 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "Name" (portkey.aws/getback-xml-elem-with-tag "Name" input), "CreatedTime" (portkey.aws/getback-xml-elem-with-tag "CreatedTime" input), "EncodedKey" (portkey.aws/getback-xml-elem-with-tag "EncodedKey" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1148647 ["Id" :content])), :name (deserstring (clojure.core/get-in letvar1148647 ["Name" :content])), :created-time (desertimestamp (clojure.core/get-in letvar1148647 ["CreatedTime" :content])), :encoded-key (deserstring (clojure.core/get-in letvar1148647 ["EncodedKey" :content]))} (letvar1148647 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1148647 ["Comment" :content]))))))
...
(clojure.core/defn- deser-query-arg-profile-config [input] (clojure.core/let [letvar1148809 {"ForwardWhenQueryArgProfileIsUnknown" (portkey.aws/getback-xml-elem-with-tag "ForwardWhenQueryArgProfileIsUnknown" input), "QueryArgProfiles" (portkey.aws/getback-xml-elem-with-tag "QueryArgProfiles" input)}] (clojure.core/cond-> {:forward-when-query-arg-profile-is-unknown (deserboolean (clojure.core/get-in letvar1148809 ["ForwardWhenQueryArgProfileIsUnknown" :content]))} (letvar1148809 "QueryArgProfiles") (clojure.core/assoc :query-arg-profiles (deser-query-arg-profiles (clojure.core/get-in letvar1148809 ["QueryArgProfiles" :content]))))))
...
(clojure.core/defn- deser-query-arg-profiles [input] (clojure.core/let [letvar1148915 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1148915 ["Quantity" :content]))} (letvar1148915 "Items") (clojure.core/assoc :items (deser-query-arg-profile-list (clojure.core/get-in letvar1148915 ["Items" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar1149021 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1149021 ["Quantity" :content]))} (letvar1149021 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar1149021 ["Items" :content]))))))
...
(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar1149124 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "S3CanonicalUserId" (portkey.aws/getback-xml-elem-with-tag "S3CanonicalUserId" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1149124 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar1149124 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar1149124 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar1149225 {"HeaderName" (portkey.aws/getback-xml-elem-with-tag "HeaderName" input), "HeaderValue" (portkey.aws/getback-xml-elem-with-tag "HeaderValue" input)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar1149225 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar1149225 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar1149309 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "S3Origin" (portkey.aws/getback-xml-elem-with-tag "S3Origin" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "Logging" (portkey.aws/getback-xml-elem-with-tag "Logging" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1149309 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar1149309 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar1149309 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1149309 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar1149309 ["Enabled" :content]))} (letvar1149309 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar1149309 ["Aliases" :content]))) (letvar1149309 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar1149309 ["Logging" :content]))) (letvar1149309 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar1149309 ["PriceClass" :content]))))))
...
(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar1149427 {"OriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "OriginAccessIdentity" input)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar1149427 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar1149528 {"Key" (portkey.aws/getback-xml-elem-with-tag "Key" input), "Value" (portkey.aws/getback-xml-elem-with-tag "Value" input)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar1149528 ["Key" :content]))} (letvar1149528 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar1149528 ["Value" :content]))))))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar1149612 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Bucket" (portkey.aws/getback-xml-elem-with-tag "Bucket" input), "Prefix" (portkey.aws/getback-xml-elem-with-tag "Prefix" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1149612 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar1149612 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar1149612 ["Prefix" :content]))})))

(clojure.core/defn- deser-field-level-encryption-summary [input] (clojure.core/let [letvar1149696 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "QueryArgProfileConfig" (portkey.aws/getback-xml-elem-with-tag "QueryArgProfileConfig" input), "ContentTypeProfileConfig" (portkey.aws/getback-xml-elem-with-tag "ContentTypeProfileConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1149696 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1149696 ["LastModifiedTime" :content]))} (letvar1149696 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar1149696 ["Comment" :content]))) (letvar1149696 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar1149696 ["QueryArgProfileConfig" :content]))) (letvar1149696 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar1149696 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar1149780 {"IsIPV6Enabled" (portkey.aws/getback-xml-elem-with-tag "IsIPV6Enabled" input), "Restrictions" (portkey.aws/getback-xml-elem-with-tag "Restrictions" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "WebACLId" (portkey.aws/getback-xml-elem-with-tag "WebACLId" input), "ARN" (portkey.aws/getback-xml-elem-with-tag "ARN" input), "CacheBehaviors" (portkey.aws/getback-xml-elem-with-tag "CacheBehaviors" input), "CustomErrorResponses" (portkey.aws/getback-xml-elem-with-tag "CustomErrorResponses" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "Origins" (portkey.aws/getback-xml-elem-with-tag "Origins" input), "HttpVersion" (portkey.aws/getback-xml-elem-with-tag "HttpVersion" input), "Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "DefaultCacheBehavior" (portkey.aws/getback-xml-elem-with-tag "DefaultCacheBehavior" input), "ViewerCertificate" (portkey.aws/getback-xml-elem-with-tag "ViewerCertificate" input)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar1149780 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar1149780 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar1149780 ["WebACLId" :content])), :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar1149780 ["IsIPV6Enabled" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar1149780 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar1149780 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar1149780 ["ViewerCertificate" :content])), :http-version (deser-http-version (clojure.core/get-in letvar1149780 ["HttpVersion" :content])), :domain-name (deserstring (clojure.core/get-in letvar1149780 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar1149780 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar1149780 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar1149780 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar1149780 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar1149780 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar1149780 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1149780 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar1149780 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar1149780 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar1149886 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1149886 ["Quantity" :content]))} (letvar1149886 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar1149886 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar1149975 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1149975 ["Quantity" :content]))} (letvar1149975 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar1149975 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar1150076 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1150076 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1150076 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1150076 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1150076 ["Quantity" :content]))} (letvar1150076 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1150076 ["NextMarker" :content]))) (letvar1150076 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar1150076 ["Items" :content]))))))
...
(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar1150170 {"Forward" (portkey.aws/getback-xml-elem-with-tag "Forward" input), "WhitelistedNames" (portkey.aws/getback-xml-elem-with-tag "WhitelistedNames" input)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar1150170 ["Forward" :content]))} (letvar1150170 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar1150170 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar1150254 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1150254 ["Quantity" :content]))} (letvar1150254 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar1150254 ["Items" :content]))))))
...
(clojure.core/defn- deser-public-key-list [input] (clojure.core/let [letvar1150355 {"NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar1150355 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar1150355 ["Quantity" :content]))} (letvar1150355 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1150355 ["NextMarker" :content]))) (letvar1150355 "Items") (clojure.core/assoc :items (deser-public-key-summary-list (clojure.core/get-in letvar1150355 ["Items" :content]))))))

(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar1150439 {"SmoothStreaming" (portkey.aws/getback-xml-elem-with-tag "SmoothStreaming" input), "FieldLevelEncryptionId" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionId" input), "Compress" (portkey.aws/getback-xml-elem-with-tag "Compress" input), "ForwardedValues" (portkey.aws/getback-xml-elem-with-tag "ForwardedValues" input), "TargetOriginId" (portkey.aws/getback-xml-elem-with-tag "TargetOriginId" input), "LambdaFunctionAssociations" (portkey.aws/getback-xml-elem-with-tag "LambdaFunctionAssociations" input), "ViewerProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "ViewerProtocolPolicy" input), "MinTTL" (portkey.aws/getback-xml-elem-with-tag "MinTTL" input), "MaxTTL" (portkey.aws/getback-xml-elem-with-tag "MaxTTL" input), "AllowedMethods" (portkey.aws/getback-xml-elem-with-tag "AllowedMethods" input), "DefaultTTL" (portkey.aws/getback-xml-elem-with-tag "DefaultTTL" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar1150439 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar1150439 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1150439 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar1150439 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar1150439 ["MinTTL" :content]))} (letvar1150439 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar1150439 ["SmoothStreaming" :content]))) (letvar1150439 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar1150439 ["FieldLevelEncryptionId" :content]))) (letvar1150439 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar1150439 ["Compress" :content]))) (letvar1150439 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar1150439 ["LambdaFunctionAssociations" :content]))) (letvar1150439 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar1150439 ["MaxTTL" :content]))) (letvar1150439 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar1150439 ["AllowedMethods" :content]))) (letvar1150439 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar1150439 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar1150523 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1150523 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar1150523 ["Quantity" :content]))} (letvar1150523 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar1150523 ["Items" :content]))))))

(clojure.core/defn- deser-field-level-encryption-list [input] (clojure.core/let [letvar1150607 {"NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar1150607 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar1150607 ["Quantity" :content]))} (letvar1150607 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1150607 ["NextMarker" :content]))) (letvar1150607 "Items") (clojure.core/assoc :items (deser-field-level-encryption-summary-list (clojure.core/get-in letvar1150607 ["Items" :content]))))))

(clojure.core/defn- deser-public-key [input] (clojure.core/let [letvar1150691 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "CreatedTime" (portkey.aws/getback-xml-elem-with-tag "CreatedTime" input), "PublicKeyConfig" (portkey.aws/getback-xml-elem-with-tag "PublicKeyConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1150691 ["Id" :content])), :created-time (desertimestamp (clojure.core/get-in letvar1150691 ["CreatedTime" :content])), :public-key-config (deser-public-key-config (clojure.core/get-in letvar1150691 ["PublicKeyConfig" :content]))})))
...
(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar1150792 {"CloudFrontDefaultCertificate" (portkey.aws/getback-xml-elem-with-tag "CloudFrontDefaultCertificate" input), "IAMCertificateId" (portkey.aws/getback-xml-elem-with-tag "IAMCertificateId" input), "ACMCertificateArn" (portkey.aws/getback-xml-elem-with-tag "ACMCertificateArn" input), "SSLSupportMethod" (portkey.aws/getback-xml-elem-with-tag "SSLSupportMethod" input), "MinimumProtocolVersion" (portkey.aws/getback-xml-elem-with-tag "MinimumProtocolVersion" input), "Certificate" (portkey.aws/getback-xml-elem-with-tag "Certificate" input), "CertificateSource" (portkey.aws/getback-xml-elem-with-tag "CertificateSource" input)}] (clojure.core/cond-> {} (letvar1150792 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar1150792 ["CloudFrontDefaultCertificate" :content]))) (letvar1150792 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar1150792 ["IAMCertificateId" :content]))) (letvar1150792 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar1150792 ["ACMCertificateArn" :content]))) (letvar1150792 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar1150792 ["SSLSupportMethod" :content]))) (letvar1150792 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar1150792 ["MinimumProtocolVersion" :content]))) (letvar1150792 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar1150792 ["Certificate" :content]))) (letvar1150792 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar1150792 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar1150876 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1150876 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar1150876 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar1150960 {"RestrictionType" (portkey.aws/getback-xml-elem-with-tag "RestrictionType" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar1150960 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar1150960 ["Quantity" :content]))} (letvar1150960 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar1150960 ["Items" :content]))))))

(clojure.core/defn- deser-list-tags-for-resource-result [input] (clojure.core/let [letvar1151044 {"Tags" (portkey.aws/getback-xml-elem-with-tag "Tags" input)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar1151044 ["Tags" :content]))})))

(clojure.core/defn- deser-too-many-distributions-with-lambda-associations [input] (clojure.core/let [letvar1151128 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151128 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151128 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-origin [input] (clojure.core/let [letvar1151212 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151212 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151212 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-protocol-settings [input] (clojure.core/let [letvar1151296 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151296 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151296 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cookie-names-in-white-list [input] (clojure.core/let [letvar1151380 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151380 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151380 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cache-behaviors [input] (clojure.core/let [letvar1151464 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151464 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151464 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-origin-custom-headers [input] (clojure.core/let [letvar1151548 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151548 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151548 ["Message" :content]))))))

(clojure.core/defn- deser-create-field-level-encryption-config-result [input] (clojure.core/let [letvar1151632 {"FieldLevelEncryption" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryption" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1151632 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar1151632 ["FieldLevelEncryption" :content]))) (letvar1151632 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1151632 ["Location" :content]))) (letvar1151632 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1151632 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-streaming-distributions [input] (clojure.core/let [letvar1151716 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151716 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151716 ["Message" :content]))))))

(clojure.core/defn- deser-get-streaming-distribution-result [input] (clojure.core/let [letvar1151800 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1151800 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1151800 ["StreamingDistribution" :content]))) (letvar1151800 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1151800 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [letvar1151884 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151884 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151884 ["Message" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile-already-exists [input] (clojure.core/let [letvar1151968 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1151968 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1151968 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-viewer-certificate [input] (clojure.core/let [letvar1152052 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152052 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152052 ["Message" :content]))))))

(clojure.core/defn- deser-get-public-key-config-result [input] (clojure.core/let [letvar1152136 {"PublicKeyConfig" (portkey.aws/getback-xml-elem-with-tag "PublicKeyConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1152136 "PublicKeyConfig") (clojure.core/assoc :public-key-config (deser-public-key-config (clojure.core/get-in letvar1152136 ["PublicKeyConfig" :content]))) (letvar1152136 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1152136 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-argument [input] (clojure.core/let [letvar1152220 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152220 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152220 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-public-key [input] (clojure.core/let [letvar1152304 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152304 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152304 ["Message" :content]))))))

(clojure.core/defn- deser-streaming-distribution-not-disabled [input] (clojure.core/let [letvar1152388 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152388 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152388 ["Message" :content]))))))

(clojure.core/defn- deser-illegal-field-level-encryption-config-association-with-cache-behavior [input] (clojure.core/let [letvar1152472 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152472 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152472 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-certificates [input] (clojure.core/let [letvar1152556 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152556 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152556 ["Message" :content]))))))

(clojure.core/defn- deser-access-denied [input] (clojure.core/let [letvar1152640 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152640 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152640 ["Message" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [letvar1152724 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152724 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152724 ["Message" :content]))))))

(clojure.core/defn- deser-cannot-change-immutable-public-key-fields [input] (clojure.core/let [letvar1152808 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152808 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152808 ["Message" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile-size-exceeded [input] (clojure.core/let [letvar1152892 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152892 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152892 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-lambda-function-association [input] (clojure.core/let [letvar1152976 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1152976 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1152976 ["Message" :content]))))))

(clojure.core/defn- deser-create-field-level-encryption-profile-result [input] (clojure.core/let [letvar1153060 {"FieldLevelEncryptionProfile" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfile" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1153060 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar1153060 ["FieldLevelEncryptionProfile" :content]))) (letvar1153060 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1153060 ["Location" :content]))) (letvar1153060 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1153060 ["ETag" :content]))))))

(clojure.core/defn- deser-get-field-level-encryption-profile-result [input] (clojure.core/let [letvar1153144 {"FieldLevelEncryptionProfile" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfile" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1153144 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar1153144 ["FieldLevelEncryptionProfile" :content]))) (letvar1153144 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1153144 ["ETag" :content]))))))

(clojure.core/defn- deser-no-such-resource [input] (clojure.core/let [letvar1153228 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153228 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153228 ["Message" :content]))))))

(clojure.core/defn- deser-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1153312 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1153312 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1153312 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1153312 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1153312 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-error-code [input] (clojure.core/let [letvar1153396 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153396 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153396 ["Message" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile-in-use [input] (clojure.core/let [letvar1153480 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153480 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153480 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-lambda-function-associations [input] (clojure.core/let [letvar1153564 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153564 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153564 ["Message" :content]))))))

(clojure.core/defn- deser-create-streaming-distribution-result [input] (clojure.core/let [letvar1153648 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1153648 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1153648 ["StreamingDistribution" :content]))) (letvar1153648 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1153648 ["Location" :content]))) (letvar1153648 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1153648 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-profiles [input] (clojure.core/let [letvar1153732 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153732 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153732 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-field-level-encryption-profile [input] (clojure.core/let [letvar1153816 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153816 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153816 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-relative-path [input] (clojure.core/let [letvar1153900 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1153900 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1153900 ["Message" :content]))))))

(clojure.core/defn- deser-create-public-key-result [input] (clojure.core/let [letvar1153984 {"PublicKey" (portkey.aws/getback-xml-elem-with-tag "PublicKey" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1153984 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar1153984 ["PublicKey" :content]))) (letvar1153984 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1153984 ["Location" :content]))) (letvar1153984 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1153984 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-location-code [input] (clojure.core/let [letvar1154068 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154068 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154068 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-web-acl-id [input] (clojure.core/let [letvar1154152 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154152 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154152 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin [input] (clojure.core/let [letvar1154236 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154236 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154236 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [letvar1154320 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154320 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154320 ["Message" :content]))))))

(clojure.core/defn- deser-field-level-encryption-config-already-exists [input] (clojure.core/let [letvar1154404 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154404 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154404 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-field-level-encryption-config [input] (clojure.core/let [letvar1154488 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154488 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154488 ["Message" :content]))))))

(clojure.core/defn- deser-update-distribution-result [input] (clojure.core/let [letvar1154572 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1154572 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1154572 ["Distribution" :content]))) (letvar1154572 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1154572 ["ETag" :content]))))))

(clojure.core/defn- deser-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1154656 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1154656 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1154656 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1154656 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1154656 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-encryption-entities [input] (clojure.core/let [letvar1154740 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154740 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154740 ["Message" :content]))))))

(clojure.core/defn- deser-get-field-level-encryption-result [input] (clojure.core/let [letvar1154824 {"FieldLevelEncryption" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryption" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1154824 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar1154824 ["FieldLevelEncryption" :content]))) (letvar1154824 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1154824 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-query-string-parameters [input] (clojure.core/let [letvar1154908 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154908 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154908 ["Message" :content]))))))

(clojure.core/defn- deser-public-key-already-exists [input] (clojure.core/let [letvar1154992 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1154992 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1154992 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-origins [input] (clojure.core/let [letvar1155076 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155076 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155076 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-ttl-order [input] (clojure.core/let [letvar1155160 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155160 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155160 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-streaming-distribution [input] (clojure.core/let [letvar1155244 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155244 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155244 ["Message" :content]))))))

(clojure.core/defn- deser-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1155328 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1155328 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1155328 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1155328 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1155328 ["Location" :content]))) (letvar1155328 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1155328 ["ETag" :content]))))))

(clojure.core/defn- deser-cname-already-exists [input] (clojure.core/let [letvar1155412 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155412 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155412 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-default-root-object [input] (clojure.core/let [letvar1155496 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155496 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155496 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-response-code [input] (clojure.core/let [letvar1155580 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155580 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155580 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-invalidation [input] (clojure.core/let [letvar1155664 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155664 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155664 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-invalidations-in-progress [input] (clojure.core/let [letvar1155748 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155748 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155748 ["Message" :content]))))))

(clojure.core/defn- deser-get-public-key-result [input] (clojure.core/let [letvar1155832 {"PublicKey" (portkey.aws/getback-xml-elem-with-tag "PublicKey" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1155832 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar1155832 ["PublicKey" :content]))) (letvar1155832 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1155832 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-distributions-associated-to-field-level-encryption-config [input] (clojure.core/let [letvar1155916 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1155916 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1155916 ["Message" :content]))))))

(clojure.core/defn- deser-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [letvar1156000 {"CloudFrontOriginAccessIdentityList" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityList" input)}] (clojure.core/cond-> {} (letvar1156000 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar1156000 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- deser-update-public-key-result [input] (clojure.core/let [letvar1156084 {"PublicKey" (portkey.aws/getback-xml-elem-with-tag "PublicKey" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156084 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar1156084 ["PublicKey" :content]))) (letvar1156084 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156084 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-forward-cookies [input] (clojure.core/let [letvar1156168 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1156168 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1156168 ["Message" :content]))))))

(clojure.core/defn- deser-get-distribution-config-result [input] (clojure.core/let [letvar1156252 {"DistributionConfig" (portkey.aws/getback-xml-elem-with-tag "DistributionConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156252 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar1156252 ["DistributionConfig" :content]))) (letvar1156252 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156252 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-required-protocol [input] (clojure.core/let [letvar1156336 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1156336 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1156336 ["Message" :content]))))))

(clojure.core/defn- deser-update-field-level-encryption-config-result [input] (clojure.core/let [letvar1156420 {"FieldLevelEncryption" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryption" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156420 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar1156420 ["FieldLevelEncryption" :content]))) (letvar1156420 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156420 ["ETag" :content]))))))

(clojure.core/defn- deser-get-distribution-result [input] (clojure.core/let [letvar1156504 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156504 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1156504 ["Distribution" :content]))) (letvar1156504 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156504 ["ETag" :content]))))))

(clojure.core/defn- deser-update-field-level-encryption-profile-result [input] (clojure.core/let [letvar1156588 {"FieldLevelEncryptionProfile" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfile" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156588 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar1156588 ["FieldLevelEncryptionProfile" :content]))) (letvar1156588 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156588 ["ETag" :content]))))))

(clojure.core/defn- deser-get-streaming-distribution-config-result [input] (clojure.core/let [letvar1156672 {"StreamingDistributionConfig" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156672 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar1156672 ["StreamingDistributionConfig" :content]))) (letvar1156672 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156672 ["ETag" :content]))))))

(clojure.core/defn- deser-list-public-keys-result [input] (clojure.core/let [letvar1156756 {"PublicKeyList" (portkey.aws/getback-xml-elem-with-tag "PublicKeyList" input)}] (clojure.core/cond-> {} (letvar1156756 "PublicKeyList") (clojure.core/assoc :public-key-list (deser-public-key-list (clojure.core/get-in letvar1156756 ["PublicKeyList" :content]))))))

(clojure.core/defn- deser-invalid-headers-for-s-3-origin [input] (clojure.core/let [letvar1156840 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1156840 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1156840 ["Message" :content]))))))

(clojure.core/defn- deser-get-field-level-encryption-config-result [input] (clojure.core/let [letvar1156924 {"FieldLevelEncryptionConfig" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1156924 "FieldLevelEncryptionConfig") (clojure.core/assoc :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar1156924 ["FieldLevelEncryptionConfig" :content]))) (letvar1156924 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1156924 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-configs [input] (clojure.core/let [letvar1157008 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157008 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157008 ["Message" :content]))))))

(clojure.core/defn- deser-field-level-encryption-config-in-use [input] (clojure.core/let [letvar1157092 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157092 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157092 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-distribution-cnam-es [input] (clojure.core/let [letvar1157176 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157176 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157176 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-geo-restriction-parameter [input] (clojure.core/let [letvar1157260 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157260 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157260 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [letvar1157344 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157344 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157344 ["Message" :content]))))))

(clojure.core/defn- deser-list-invalidations-result [input] (clojure.core/let [letvar1157428 {"InvalidationList" (portkey.aws/getback-xml-elem-with-tag "InvalidationList" input)}] (clojure.core/cond-> {} (letvar1157428 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar1157428 ["InvalidationList" :content]))))))

(clojure.core/defn- deser-batch-too-large [input] (clojure.core/let [letvar1157512 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157512 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157512 ["Message" :content]))))))

(clojure.core/defn- deser-create-distribution-with-tags-result [input] (clojure.core/let [letvar1157596 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1157596 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1157596 ["Distribution" :content]))) (letvar1157596 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1157596 ["Location" :content]))) (letvar1157596 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1157596 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-query-arg-profiles [input] (clojure.core/let [letvar1157680 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1157680 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1157680 ["Message" :content]))))))

(clojure.core/defn- deser-list-streaming-distributions-result [input] (clojure.core/let [letvar1157764 {"StreamingDistributionList" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionList" input)}] (clojure.core/cond-> {} (letvar1157764 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar1157764 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- deser-create-streaming-distribution-with-tags-result [input] (clojure.core/let [letvar1157848 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1157848 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1157848 ["StreamingDistribution" :content]))) (letvar1157848 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1157848 ["Location" :content]))) (letvar1157848 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1157848 ["ETag" :content]))))))

(clojure.core/defn- deser-create-invalidation-result [input] (clojure.core/let [letvar1157932 {"Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "Invalidation" (portkey.aws/getback-xml-elem-with-tag "Invalidation" input)}] (clojure.core/cond-> {} (letvar1157932 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1157932 ["Location" :content]))) (letvar1157932 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar1157932 ["Invalidation" :content]))))))

(clojure.core/defn- deser-missing-body [input] (clojure.core/let [letvar1158016 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158016 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158016 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin-read-timeout [input] (clojure.core/let [letvar1158100 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158100 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158100 ["Message" :content]))))))

(clojure.core/defn- deser-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [letvar1158184 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1158184 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar1158184 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar1158184 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1158184 ["ETag" :content]))))))

(clojure.core/defn- deser-distribution-not-disabled [input] (clojure.core/let [letvar1158268 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158268 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158268 ["Message" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [letvar1158352 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158352 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158352 ["Message" :content]))))))

(clojure.core/defn- deser-precondition-failed [input] (clojure.core/let [letvar1158436 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158436 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158436 ["Message" :content]))))))

(clojure.core/defn- deser-distribution-already-exists [input] (clojure.core/let [letvar1158520 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158520 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158520 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin-access-identity [input] (clojure.core/let [letvar1158604 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158604 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158604 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-trusted-signers [input] (clojure.core/let [letvar1158688 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158688 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158688 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-public-keys [input] (clojure.core/let [letvar1158772 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158772 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158772 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-minimum-protocol-version [input] (clojure.core/let [letvar1158856 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158856 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158856 ["Message" :content]))))))

(clojure.core/defn- deser-streaming-distribution-already-exists [input] (clojure.core/let [letvar1158940 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1158940 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1158940 ["Message" :content]))))))

(clojure.core/defn- deser-public-key-in-use [input] (clojure.core/let [letvar1159024 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159024 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159024 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-if-match-version [input] (clojure.core/let [letvar1159108 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159108 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159108 ["Message" :content]))))))

(clojure.core/defn- deser-list-field-level-encryption-profiles-result [input] (clojure.core/let [letvar1159192 {"FieldLevelEncryptionProfileList" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfileList" input)}] (clojure.core/cond-> {} (letvar1159192 "FieldLevelEncryptionProfileList") (clojure.core/assoc :field-level-encryption-profile-list (deser-field-level-encryption-profile-list (clojure.core/get-in letvar1159192 ["FieldLevelEncryptionProfileList" :content]))))))

(clojure.core/defn- deser-create-distribution-result [input] (clojure.core/let [letvar1159276 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1159276 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1159276 ["Distribution" :content]))) (letvar1159276 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1159276 ["Location" :content]))) (letvar1159276 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1159276 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-distributions [input] (clojure.core/let [letvar1159360 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159360 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159360 ["Message" :content]))))))

(clojure.core/defn- deser-list-field-level-encryption-configs-result [input] (clojure.core/let [letvar1159444 {"FieldLevelEncryptionList" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionList" input)}] (clojure.core/cond-> {} (letvar1159444 "FieldLevelEncryptionList") (clojure.core/assoc :field-level-encryption-list (deser-field-level-encryption-list (clojure.core/get-in letvar1159444 ["FieldLevelEncryptionList" :content]))))))

(clojure.core/defn- deser-no-such-distribution [input] (clojure.core/let [letvar1159528 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159528 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159528 ["Message" :content]))))))

(clojure.core/defn- deser-query-arg-profile-empty [input] (clojure.core/let [letvar1159612 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159612 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159612 ["Message" :content]))))))

(clojure.core/defn- deser-update-streaming-distribution-result [input] (clojure.core/let [letvar1159696 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1159696 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1159696 ["StreamingDistribution" :content]))) (letvar1159696 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1159696 ["ETag" :content]))))))

(clojure.core/defn- deser-illegal-update [input] (clojure.core/let [letvar1159780 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159780 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159780 ["Message" :content]))))))

(clojure.core/defn- deser-get-field-level-encryption-profile-config-result [input] (clojure.core/let [letvar1159864 {"FieldLevelEncryptionProfileConfig" (portkey.aws/getback-xml-elem-with-tag "FieldLevelEncryptionProfileConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1159864 "FieldLevelEncryptionProfileConfig") (clojure.core/assoc :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar1159864 ["FieldLevelEncryptionProfileConfig" :content]))) (letvar1159864 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1159864 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-content-type-profiles [input] (clojure.core/let [letvar1159948 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1159948 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1159948 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin-keepalive-timeout [input] (clojure.core/let [letvar1160032 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160032 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160032 ["Message" :content]))))))

(clojure.core/defn- deser-inconsistent-quantities [input] (clojure.core/let [letvar1160116 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160116 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160116 ["Message" :content]))))))

(clojure.core/defn- deser-list-distributions-by-web-acl-id-result [input] (clojure.core/let [letvar1160200 {"DistributionList" (portkey.aws/getback-xml-elem-with-tag "DistributionList" input)}] (clojure.core/cond-> {} (letvar1160200 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar1160200 ["DistributionList" :content]))))))

(clojure.core/defn- deser-too-many-query-string-parameters [input] (clojure.core/let [letvar1160284 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160284 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160284 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-tagging [input] (clojure.core/let [letvar1160368 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160368 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160368 ["Message" :content]))))))

(clojure.core/defn- deser-list-distributions-result [input] (clojure.core/let [letvar1160452 {"DistributionList" (portkey.aws/getback-xml-elem-with-tag "DistributionList" input)}] (clojure.core/cond-> {} (letvar1160452 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar1160452 ["DistributionList" :content]))))))

(clojure.core/defn- deser-trusted-signer-does-not-exist [input] (clojure.core/let [letvar1160536 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160536 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160536 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-field-level-encryption-field-patterns [input] (clojure.core/let [letvar1160620 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160620 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160620 ["Message" :content]))))))

(clojure.core/defn- deser-get-invalidation-result [input] (clojure.core/let [letvar1160704 {"Invalidation" (portkey.aws/getback-xml-elem-with-tag "Invalidation" input)}] (clojure.core/cond-> {} (letvar1160704 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar1160704 ["Invalidation" :content]))))))

(clojure.core/defn- deser-too-many-headers-in-forwarded-values [input] (clojure.core/let [letvar1160788 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1160788 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1160788 ["Message" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1008244__auto__] (clojure.core/<= 1 (clojure.core/count s__1008244__auto__))) (clojure.core/fn [s__1008245__auto__] (clojure.core/< (clojure.core/count s__1008245__auto__) 128)) (clojure.core/fn [s__1008246__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1008246__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1008244__auto__] (clojure.core/<= 0 (clojure.core/count s__1008244__auto__))) (clojure.core/fn [s__1008245__auto__] (clojure.core/< (clojure.core/count s__1008245__auto__) 256)) (clojure.core/fn [s__1008246__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1008246__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1008246__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__1008246__auto__))))
...
(clojure.core/defn create-distribution-2017-10-30 ([create-distribution-requestinput] (clojure.core/let [request-function-result__1009048__auto__ (req-create-distribution-request create-distribution-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1009048__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2017-10-30/endpoints, :http.request.configuration/target-prefix nil, :http.request.spec/output-spec :portkey.aws.cloudfront.-2017-10-30/create-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2017-10-30/distribution", :http.request.configuration/version "2017-10-30", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2017-10-30/create-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.configuration/action "CreateDistribution2017_10_30", :http.request.configuration/output-deser-fn deser-create-distribution-result, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront.-2017-10-30/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2017-10-30/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2017-10-30/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2017-10-30/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2017-10-30/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2017-10-30/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2017-10-30/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront.-2017-10-30/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront.-2017-10-30/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2017-10-30/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront.-2017-10-30/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront.-2017-10-30/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront.-2017-10-30/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront.-2017-10-30/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2017-10-30/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2017-10-30/invalid-web-acl-id, "InvalidOrigin" :portkey.aws.cloudfront.-2017-10-30/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2017-10-30/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2017-10-30/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2017-10-30/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2017-10-30/invalid-ttl-order, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2017-10-30/cname-already-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2017-10-30/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2017-10-30/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront.-2017-10-30/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2017-10-30/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2017-10-30/invalid-headers-for-s-3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2017-10-30/too-many-distribution-cnam-es, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2017-10-30/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2017-10-30/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2017-10-30/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2017-10-30/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2017-10-30/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront.-2017-10-30/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2017-10-30/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2017-10-30/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2017-10-30/too-many-headers-in-forwarded-values}})))))
