...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar121074 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar121074 ["Quantity" :content]))} (letvar121074 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar121074 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile [input] (clojure.core/let [letvar121170 {"Format" (portkey.aws/search-for-tag input "Format" :flattened? false :xmlAttribute? nil), "ProfileId" (portkey.aws/search-for-tag input "ProfileId" :flattened? false :xmlAttribute? nil), "ContentType" (portkey.aws/search-for-tag input "ContentType" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:format (deser-format (clojure.core/get-in letvar121170 ["Format" :content])), :content-type (deserstring (clojure.core/get-in letvar121170 ["ContentType" :content]))} (letvar121170 "ProfileId") (clojure.core/assoc :profile-id (deserstring (clojure.core/get-in letvar121170 ["ProfileId" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar121266 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "IncludeCookies" (portkey.aws/search-for-tag input "IncludeCookies" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar121266 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar121266 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar121266 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar121266 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar121362 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar121362 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar121362 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar121362 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar121475 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "InvalidationBatch" (portkey.aws/search-for-tag input "InvalidationBatch" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar121475 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar121475 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar121475 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar121475 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-field-patterns [input] (clojure.core/let [letvar121610 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar121610 ["Quantity" :content]))} (letvar121610 "Items") (clojure.core/assoc :items (deser-field-pattern-list (clojure.core/get-in letvar121610 ["Items" :content]))))))

(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar121706 {"GeoRestriction" (portkey.aws/search-for-tag input "GeoRestriction" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar121706 ["GeoRestriction" :content]))})))

(clojure.core/defn- deser-field-level-encryption-profile-config [input] (clojure.core/let [letvar121802 {"Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "EncryptionEntities" (portkey.aws/search-for-tag input "EncryptionEntities" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name (deserstring (clojure.core/get-in letvar121802 ["Name" :content])), :caller-reference (deserstring (clojure.core/get-in letvar121802 ["CallerReference" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar121802 ["EncryptionEntities" :content]))} (letvar121802 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar121802 ["Comment" :content]))))))

(clojure.core/defn- deserstring [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-field-level-encryption-config [input] (clojure.core/let [letvar121903 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "QueryArgProfileConfig" (portkey.aws/search-for-tag input "QueryArgProfileConfig" :flattened? false :xmlAttribute? nil), "ContentTypeProfileConfig" (portkey.aws/search-for-tag input "ContentTypeProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar121903 ["CallerReference" :content]))} (letvar121903 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar121903 ["Comment" :content]))) (letvar121903 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar121903 ["QueryArgProfileConfig" :content]))) (letvar121903 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar121903 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile [input] (clojure.core/let [letvar121999 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionProfileConfig" (portkey.aws/search-for-tag input "FieldLevelEncryptionProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar121999 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar121999 ["LastModifiedTime" :content])), :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar121999 ["FieldLevelEncryptionProfileConfig" :content]))})))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar122095 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "InProgressInvalidationBatches" (portkey.aws/search-for-tag input "InProgressInvalidationBatches" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "DistributionConfig" (portkey.aws/search-for-tag input "DistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar122095 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar122095 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar122095 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar122095 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar122095 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar122095 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar122095 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar122095 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar122191 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar122191 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar122191 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar122191 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar122191 ["Quantity" :content]))} (letvar122191 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar122191 ["NextMarker" :content]))) (letvar122191 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar122191 ["Items" :content]))))))

(clojure.core/defn- deser-query-arg-profile [input] (clojure.core/let [letvar122287 {"QueryArg" (portkey.aws/search-for-tag input "QueryArg" :flattened? false :xmlAttribute? nil), "ProfileId" (portkey.aws/search-for-tag input "ProfileId" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-arg (deserstring (clojure.core/get-in letvar122287 ["QueryArg" :content])), :profile-id (deserstring (clojure.core/get-in letvar122287 ["ProfileId" :content]))})))

(clojure.core/defn- deser-lambda-function-association [input] (clojure.core/let [letvar122383 {"LambdaFunctionARN" (portkey.aws/search-for-tag input "LambdaFunctionARN" :flattened? false :xmlAttribute? nil), "EventType" (portkey.aws/search-for-tag input "EventType" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:lambda-function-arn (deser-lambda-function-arn (clojure.core/get-in letvar122383 ["LambdaFunctionARN" :content])), :event-type (deser-event-type (clojure.core/get-in letvar122383 ["EventType" :content]))})))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar122479 {"QueryString" (portkey.aws/search-for-tag input "QueryString" :flattened? false :xmlAttribute? nil), "Cookies" (portkey.aws/search-for-tag input "Cookies" :flattened? false :xmlAttribute? nil), "Headers" (portkey.aws/search-for-tag input "Headers" :flattened? false :xmlAttribute? nil), "QueryStringCacheKeys" (portkey.aws/search-for-tag input "QueryStringCacheKeys" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar122479 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar122479 ["Cookies" :content]))} (letvar122479 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar122479 ["Headers" :content]))) (letvar122479 "QueryStringCacheKeys") (clojure.core/assoc :query-string-cache-keys (deser-query-string-cache-keys (clojure.core/get-in letvar122479 ["QueryStringCacheKeys" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar122575 {"Paths" (portkey.aws/search-for-tag input "Paths" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar122575 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar122575 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar122705 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar122705 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar122705 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar122705 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar122705 ["Quantity" :content]))} (letvar122705 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar122705 ["NextMarker" :content]))) (letvar122705 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar122705 ["Items" :content]))))))

(clojure.core/defn- deser-public-key-config [input] (clojure.core/let [letvar122801 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "EncodedKey" (portkey.aws/search-for-tag input "EncodedKey" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar122801 ["CallerReference" :content])), :name (deserstring (clojure.core/get-in letvar122801 ["Name" :content])), :encoded-key (deserstring (clojure.core/get-in letvar122801 ["EncodedKey" :content]))} (letvar122801 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar122801 ["Comment" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar122919 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "StreamingDistributionConfig" (portkey.aws/search-for-tag input "StreamingDistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar122919 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar122919 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar122919 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar122919 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar122919 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar122919 ["StreamingDistributionConfig" :content]))} (letvar122919 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar122919 ["LastModifiedTime" :content]))))))

(clojure.core/defn- deser-lambda-function-associations [input] (clojure.core/let [letvar123015 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar123015 ["Quantity" :content]))} (letvar123015 "Items") (clojure.core/assoc :items (deser-lambda-function-association-list (clojure.core/get-in letvar123015 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entities [input] (clojure.core/let [letvar123111 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar123111 ["Quantity" :content]))} (letvar123111 "Items") (clojure.core/assoc :items (deser-encryption-entity-list (clojure.core/get-in letvar123111 ["Items" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-summary [input] (clojure.core/let [letvar123212 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "EncryptionEntities" (portkey.aws/search-for-tag input "EncryptionEntities" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar123212 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar123212 ["LastModifiedTime" :content])), :name (deserstring (clojure.core/get-in letvar123212 ["Name" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar123212 ["EncryptionEntities" :content]))} (letvar123212 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar123212 ["Comment" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar123325 {"ErrorCode" (portkey.aws/search-for-tag input "ErrorCode" :flattened? false :xmlAttribute? nil), "ResponsePagePath" (portkey.aws/search-for-tag input "ResponsePagePath" :flattened? false :xmlAttribute? nil), "ResponseCode" (portkey.aws/search-for-tag input "ResponseCode" :flattened? false :xmlAttribute? nil), "ErrorCachingMinTTL" (portkey.aws/search-for-tag input "ErrorCachingMinTTL" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar123325 ["ErrorCode" :content]))} (letvar123325 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar123325 ["ResponsePagePath" :content]))) (letvar123325 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar123325 ["ResponseCode" :content]))) (letvar123325 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar123325 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar123438 {"AwsAccountNumber" (portkey.aws/search-for-tag input "AwsAccountNumber" :flattened? false :xmlAttribute? nil), "KeyPairIds" (portkey.aws/search-for-tag input "KeyPairIds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar123438 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar123438 ["AwsAccountNumber" :content]))) (letvar123438 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar123438 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-list [input] (clojure.core/let [letvar123553 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar123553 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar123553 ["Quantity" :content]))} (letvar123553 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar123553 ["NextMarker" :content]))) (letvar123553 "Items") (clojure.core/assoc :items (deser-field-level-encryption-profile-summary-list (clojure.core/get-in letvar123553 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile-config [input] (clojure.core/let [letvar123649 {"ForwardWhenContentTypeIsUnknown" (portkey.aws/search-for-tag input "ForwardWhenContentTypeIsUnknown" :flattened? false :xmlAttribute? nil), "ContentTypeProfiles" (portkey.aws/search-for-tag input "ContentTypeProfiles" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward-when-content-type-is-unknown (deserboolean (clojure.core/get-in letvar123649 ["ForwardWhenContentTypeIsUnknown" :content]))} (letvar123649 "ContentTypeProfiles") (clojure.core/assoc :content-type-profiles (deser-content-type-profiles (clojure.core/get-in letvar123649 ["ContentTypeProfiles" :content]))))))

(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar123745 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar123745 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar123745 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar123846 {"Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar123846 "Items") (clojure.core/assoc :items (deser-tag-list (clojure.core/get-in letvar123846 ["Items" :content]))))))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar123976 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar123976 ["Quantity" :content]))} (letvar123976 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar123976 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar124072 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionId" (portkey.aws/search-for-tag input "FieldLevelEncryptionId" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "PathPattern" (portkey.aws/search-for-tag input "PathPattern" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar124072 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar124072 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar124072 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar124072 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar124072 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar124072 ["MinTTL" :content]))} (letvar124072 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar124072 ["SmoothStreaming" :content]))) (letvar124072 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar124072 ["FieldLevelEncryptionId" :content]))) (letvar124072 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar124072 ["Compress" :content]))) (letvar124072 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar124072 ["LambdaFunctionAssociations" :content]))) (letvar124072 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar124072 ["MaxTTL" :content]))) (letvar124072 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar124072 ["AllowedMethods" :content]))) (letvar124072 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar124072 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar124168 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar124168 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar124168 ["Quantity" :content]))} (letvar124168 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar124168 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar124264 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginPath" (portkey.aws/search-for-tag input "OriginPath" :flattened? false :xmlAttribute? nil), "CustomHeaders" (portkey.aws/search-for-tag input "CustomHeaders" :flattened? false :xmlAttribute? nil), "S3OriginConfig" (portkey.aws/search-for-tag input "S3OriginConfig" :flattened? false :xmlAttribute? nil), "CustomOriginConfig" (portkey.aws/search-for-tag input "CustomOriginConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar124264 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar124264 ["DomainName" :content]))} (letvar124264 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar124264 ["OriginPath" :content]))) (letvar124264 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar124264 ["CustomHeaders" :content]))) (letvar124264 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar124264 ["S3OriginConfig" :content]))) (letvar124264 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar124264 ["CustomOriginConfig" :content]))))))
...
(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar124367 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar124367 ["Quantity" :content]))} (letvar124367 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar124367 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar124463 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar124463 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar124463 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar124463 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar124463 ["Quantity" :content]))} (letvar124463 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar124463 ["NextMarker" :content]))) (letvar124463 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar124463 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar124559 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar124559 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar124559 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar124655 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar124655 ["Quantity" :content]))} (letvar124655 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar124655 ["Items" :content]))))))
...
(clojure.core/defn- deser-content-type-profiles [input] (clojure.core/let [letvar124756 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar124756 ["Quantity" :content]))} (letvar124756 "Items") (clojure.core/assoc :items (deser-content-type-profile-list (clojure.core/get-in letvar124756 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entity [input] (clojure.core/let [letvar124852 {"PublicKeyId" (portkey.aws/search-for-tag input "PublicKeyId" :flattened? false :xmlAttribute? nil), "ProviderId" (portkey.aws/search-for-tag input "ProviderId" :flattened? false :xmlAttribute? nil), "FieldPatterns" (portkey.aws/search-for-tag input "FieldPatterns" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:public-key-id (deserstring (clojure.core/get-in letvar124852 ["PublicKeyId" :content])), :provider-id (deserstring (clojure.core/get-in letvar124852 ["ProviderId" :content])), :field-patterns (deser-field-patterns (clojure.core/get-in letvar124852 ["FieldPatterns" :content]))})))

(clojure.core/defn- deser-lambda-function-arn [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar124953 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil), "CachedMethods" (portkey.aws/search-for-tag input "CachedMethods" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar124953 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar124953 ["Items" :content]))} (letvar124953 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar124953 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar125054 {"HTTPPort" (portkey.aws/search-for-tag input "HTTPPort" :flattened? false :xmlAttribute? nil), "HTTPSPort" (portkey.aws/search-for-tag input "HTTPSPort" :flattened? false :xmlAttribute? nil), "OriginProtocolPolicy" (portkey.aws/search-for-tag input "OriginProtocolPolicy" :flattened? false :xmlAttribute? nil), "OriginSslProtocols" (portkey.aws/search-for-tag input "OriginSslProtocols" :flattened? false :xmlAttribute? nil), "OriginReadTimeout" (portkey.aws/search-for-tag input "OriginReadTimeout" :flattened? false :xmlAttribute? nil), "OriginKeepaliveTimeout" (portkey.aws/search-for-tag input "OriginKeepaliveTimeout" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar125054 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar125054 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar125054 ["OriginProtocolPolicy" :content]))} (letvar125054 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar125054 ["OriginSslProtocols" :content]))) (letvar125054 "OriginReadTimeout") (clojure.core/assoc :origin-read-timeout (deserinteger (clojure.core/get-in letvar125054 ["OriginReadTimeout" :content]))) (letvar125054 "OriginKeepaliveTimeout") (clojure.core/assoc :origin-keepalive-timeout (deserinteger (clojure.core/get-in letvar125054 ["OriginKeepaliveTimeout" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar125150 {"DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar125150 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar125150 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar125246 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar125246 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar125246 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar125246 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar125246 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar125246 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar125246 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar125246 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar125246 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar125246 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar125246 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar125246 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar125342 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag input "CloudFrontOriginAccessIdentityConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar125342 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar125342 ["S3CanonicalUserId" :content]))} (letvar125342 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar125342 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption [input] (clojure.core/let [letvar125455 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionConfig" (portkey.aws/search-for-tag input "FieldLevelEncryptionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar125455 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar125455 ["LastModifiedTime" :content])), :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar125455 ["FieldLevelEncryptionConfig" :content]))})))

(clojure.core/defn- deser-tag-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser-tag coll))) input))

(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar125568 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar125568 ["Quantity" :content]))} (letvar125568 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar125568 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar125664 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar125664 ["Quantity" :content]))} (letvar125664 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar125664 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar125760 {"DefaultRootObject" (portkey.aws/search-for-tag input "DefaultRootObject" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar125760 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar125760 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar125760 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar125760 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar125760 ["Enabled" :content]))} (letvar125760 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar125760 ["DefaultRootObject" :content]))) (letvar125760 "IsIPV6Enabled") (clojure.core/assoc :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar125760 ["IsIPV6Enabled" :content]))) (letvar125760 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar125760 ["Restrictions" :content]))) (letvar125760 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar125760 ["WebACLId" :content]))) (letvar125760 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar125760 ["Logging" :content]))) (letvar125760 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar125760 ["CacheBehaviors" :content]))) (letvar125760 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar125760 ["CustomErrorResponses" :content]))) (letvar125760 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar125760 ["Aliases" :content]))) (letvar125760 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar125760 ["PriceClass" :content]))) (letvar125760 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar125760 ["HttpVersion" :content]))) (letvar125760 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar125760 ["ViewerCertificate" :content]))))))

(clojure.core/defn- deser-public-key-summary [input] (clojure.core/let [letvar125856 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CreatedTime" (portkey.aws/search-for-tag input "CreatedTime" :flattened? false :xmlAttribute? nil), "EncodedKey" (portkey.aws/search-for-tag input "EncodedKey" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar125856 ["Id" :content])), :name (deserstring (clojure.core/get-in letvar125856 ["Name" :content])), :created-time (desertimestamp (clojure.core/get-in letvar125856 ["CreatedTime" :content])), :encoded-key (deserstring (clojure.core/get-in letvar125856 ["EncodedKey" :content]))} (letvar125856 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar125856 ["Comment" :content]))))))
...
(clojure.core/defn- deser-query-arg-profile-config [input] (clojure.core/let [letvar126030 {"ForwardWhenQueryArgProfileIsUnknown" (portkey.aws/search-for-tag input "ForwardWhenQueryArgProfileIsUnknown" :flattened? false :xmlAttribute? nil), "QueryArgProfiles" (portkey.aws/search-for-tag input "QueryArgProfiles" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward-when-query-arg-profile-is-unknown (deserboolean (clojure.core/get-in letvar126030 ["ForwardWhenQueryArgProfileIsUnknown" :content]))} (letvar126030 "QueryArgProfiles") (clojure.core/assoc :query-arg-profiles (deser-query-arg-profiles (clojure.core/get-in letvar126030 ["QueryArgProfiles" :content]))))))
...
(clojure.core/defn- deser-query-arg-profiles [input] (clojure.core/let [letvar126148 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar126148 ["Quantity" :content]))} (letvar126148 "Items") (clojure.core/assoc :items (deser-query-arg-profile-list (clojure.core/get-in letvar126148 ["Items" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar126266 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar126266 ["Quantity" :content]))} (letvar126266 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar126266 ["Items" :content]))))))
...
(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar126381 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar126381 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar126381 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar126381 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar126494 {"HeaderName" (portkey.aws/search-for-tag input "HeaderName" :flattened? false :xmlAttribute? nil), "HeaderValue" (portkey.aws/search-for-tag input "HeaderValue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar126494 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar126494 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar126590 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar126590 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar126590 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar126590 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar126590 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar126590 ["Enabled" :content]))} (letvar126590 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar126590 ["Aliases" :content]))) (letvar126590 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar126590 ["Logging" :content]))) (letvar126590 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar126590 ["PriceClass" :content]))))))
...
(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar126720 {"OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar126720 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar126833 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar126833 ["Key" :content]))} (letvar126833 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar126833 ["Value" :content]))))))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar126929 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar126929 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar126929 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar126929 ["Prefix" :content]))})))

(clojure.core/defn- deser-field-level-encryption-summary [input] (clojure.core/let [letvar127025 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "QueryArgProfileConfig" (portkey.aws/search-for-tag input "QueryArgProfileConfig" :flattened? false :xmlAttribute? nil), "ContentTypeProfileConfig" (portkey.aws/search-for-tag input "ContentTypeProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar127025 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar127025 ["LastModifiedTime" :content]))} (letvar127025 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar127025 ["Comment" :content]))) (letvar127025 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar127025 ["QueryArgProfileConfig" :content]))) (letvar127025 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar127025 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar127121 {"IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar127121 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar127121 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar127121 ["WebACLId" :content])), :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar127121 ["IsIPV6Enabled" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar127121 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar127121 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar127121 ["ViewerCertificate" :content])), :http-version (deser-http-version (clojure.core/get-in letvar127121 ["HttpVersion" :content])), :domain-name (deserstring (clojure.core/get-in letvar127121 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar127121 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar127121 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar127121 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar127121 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar127121 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar127121 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar127121 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar127121 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar127121 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar127239 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar127239 ["Quantity" :content]))} (letvar127239 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar127239 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar127340 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar127340 ["Quantity" :content]))} (letvar127340 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar127340 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar127453 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar127453 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar127453 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar127453 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar127453 ["Quantity" :content]))} (letvar127453 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar127453 ["NextMarker" :content]))) (letvar127453 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar127453 ["Items" :content]))))))
...
(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar127559 {"Forward" (portkey.aws/search-for-tag input "Forward" :flattened? false :xmlAttribute? nil), "WhitelistedNames" (portkey.aws/search-for-tag input "WhitelistedNames" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar127559 ["Forward" :content]))} (letvar127559 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar127559 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar127655 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar127655 ["Quantity" :content]))} (letvar127655 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar127655 ["Items" :content]))))))
...
(clojure.core/defn- deser-public-key-list [input] (clojure.core/let [letvar127768 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar127768 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar127768 ["Quantity" :content]))} (letvar127768 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar127768 ["NextMarker" :content]))) (letvar127768 "Items") (clojure.core/assoc :items (deser-public-key-summary-list (clojure.core/get-in letvar127768 ["Items" :content]))))))

(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar127864 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionId" (portkey.aws/search-for-tag input "FieldLevelEncryptionId" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar127864 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar127864 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar127864 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar127864 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar127864 ["MinTTL" :content]))} (letvar127864 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar127864 ["SmoothStreaming" :content]))) (letvar127864 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar127864 ["FieldLevelEncryptionId" :content]))) (letvar127864 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar127864 ["Compress" :content]))) (letvar127864 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar127864 ["LambdaFunctionAssociations" :content]))) (letvar127864 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar127864 ["MaxTTL" :content]))) (letvar127864 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar127864 ["AllowedMethods" :content]))) (letvar127864 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar127864 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar127960 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar127960 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar127960 ["Quantity" :content]))} (letvar127960 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar127960 ["Items" :content]))))))

(clojure.core/defn- deser-field-level-encryption-list [input] (clojure.core/let [letvar128056 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar128056 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar128056 ["Quantity" :content]))} (letvar128056 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar128056 ["NextMarker" :content]))) (letvar128056 "Items") (clojure.core/assoc :items (deser-field-level-encryption-summary-list (clojure.core/get-in letvar128056 ["Items" :content]))))))

(clojure.core/defn- deser-public-key [input] (clojure.core/let [letvar128152 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreatedTime" (portkey.aws/search-for-tag input "CreatedTime" :flattened? false :xmlAttribute? nil), "PublicKeyConfig" (portkey.aws/search-for-tag input "PublicKeyConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar128152 ["Id" :content])), :created-time (desertimestamp (clojure.core/get-in letvar128152 ["CreatedTime" :content])), :public-key-config (deser-public-key-config (clojure.core/get-in letvar128152 ["PublicKeyConfig" :content]))})))
...
(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar128265 {"CloudFrontDefaultCertificate" (portkey.aws/search-for-tag input "CloudFrontDefaultCertificate" :flattened? false :xmlAttribute? nil), "IAMCertificateId" (portkey.aws/search-for-tag input "IAMCertificateId" :flattened? false :xmlAttribute? nil), "ACMCertificateArn" (portkey.aws/search-for-tag input "ACMCertificateArn" :flattened? false :xmlAttribute? nil), "SSLSupportMethod" (portkey.aws/search-for-tag input "SSLSupportMethod" :flattened? false :xmlAttribute? nil), "MinimumProtocolVersion" (portkey.aws/search-for-tag input "MinimumProtocolVersion" :flattened? false :xmlAttribute? nil), "Certificate" (portkey.aws/search-for-tag input "Certificate" :flattened? false :xmlAttribute? nil), "CertificateSource" (portkey.aws/search-for-tag input "CertificateSource" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar128265 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar128265 ["CloudFrontDefaultCertificate" :content]))) (letvar128265 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar128265 ["IAMCertificateId" :content]))) (letvar128265 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar128265 ["ACMCertificateArn" :content]))) (letvar128265 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar128265 ["SSLSupportMethod" :content]))) (letvar128265 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar128265 ["MinimumProtocolVersion" :content]))) (letvar128265 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar128265 ["Certificate" :content]))) (letvar128265 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar128265 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar128361 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar128361 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar128361 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar128457 {"RestrictionType" (portkey.aws/search-for-tag input "RestrictionType" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar128457 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar128457 ["Quantity" :content]))} (letvar128457 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar128457 ["Items" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-result [input] (clojure.core/let [rawinput128458 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128459 {"Tags" (portkey.aws/search-for-tag rawinput128458 "Tags" :flattened? false)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar128459 ["Tags" :content]))})))

(clojure.core/defn- response-too-many-distributions-with-lambda-associations [input] (clojure.core/let [rawinput128460 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128461 {"Message" (portkey.aws/search-for-tag rawinput128460 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128461 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128461 ["Message" :content]))))))

(clojure.core/defn- response-no-such-origin [input] (clojure.core/let [rawinput128462 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128463 {"Message" (portkey.aws/search-for-tag rawinput128462 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128463 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128463 ["Message" :content]))))))

(clojure.core/defn- response-invalid-protocol-settings [input] (clojure.core/let [rawinput128464 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128465 {"Message" (portkey.aws/search-for-tag rawinput128464 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128465 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128465 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cookie-names-in-white-list [input] (clojure.core/let [rawinput128466 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128467 {"Message" (portkey.aws/search-for-tag rawinput128466 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128467 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128467 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cache-behaviors [input] (clojure.core/let [rawinput128468 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128469 {"Message" (portkey.aws/search-for-tag rawinput128468 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128469 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128469 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origin-custom-headers [input] (clojure.core/let [rawinput128470 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128471 {"Message" (portkey.aws/search-for-tag rawinput128470 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128471 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128471 ["Message" :content]))))))

(clojure.core/defn- response-create-field-level-encryption-config-result [input] (clojure.core/let [rawinput128472 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128473 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput128472 "FieldLevelEncryption" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128473 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar128473 ["FieldLevelEncryption" :content]))) (letvar128473 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128473 ["Location"]))) (letvar128473 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128473 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distributions [input] (clojure.core/let [rawinput128474 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128475 {"Message" (portkey.aws/search-for-tag rawinput128474 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128475 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128475 ["Message" :content]))))))

(clojure.core/defn- response-get-streaming-distribution-result [input] (clojure.core/let [rawinput128476 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128477 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput128476 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128477 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar128477 ["StreamingDistribution" :content]))) (letvar128477 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128477 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [rawinput128478 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128479 {"Message" (portkey.aws/search-for-tag rawinput128478 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128479 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128479 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-already-exists [input] (clojure.core/let [rawinput128480 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128481 {"Message" (portkey.aws/search-for-tag rawinput128480 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128481 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128481 ["Message" :content]))))))

(clojure.core/defn- response-invalid-viewer-certificate [input] (clojure.core/let [rawinput128482 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128483 {"Message" (portkey.aws/search-for-tag rawinput128482 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128483 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128483 ["Message" :content]))))))

(clojure.core/defn- response-get-public-key-config-result [input] (clojure.core/let [rawinput128484 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128485 {"PublicKeyConfig" (portkey.aws/search-for-tag rawinput128484 "PublicKeyConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128485 "PublicKeyConfig") (clojure.core/assoc :public-key-config (deser-public-key-config (clojure.core/get-in letvar128485 ["PublicKeyConfig" :content]))) (letvar128485 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128485 ["ETag"]))))))

(clojure.core/defn- response-invalid-argument [input] (clojure.core/let [rawinput128486 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128487 {"Message" (portkey.aws/search-for-tag rawinput128486 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128487 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128487 ["Message" :content]))))))

(clojure.core/defn- response-no-such-public-key [input] (clojure.core/let [rawinput128488 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128489 {"Message" (portkey.aws/search-for-tag rawinput128488 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128489 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128489 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-not-disabled [input] (clojure.core/let [rawinput128490 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128491 {"Message" (portkey.aws/search-for-tag rawinput128490 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128491 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128491 ["Message" :content]))))))

(clojure.core/defn- response-illegal-field-level-encryption-config-association-with-cache-behavior [input] (clojure.core/let [rawinput128492 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128493 {"Message" (portkey.aws/search-for-tag rawinput128492 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128493 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128493 ["Message" :content]))))))

(clojure.core/defn- response-too-many-certificates [input] (clojure.core/let [rawinput128494 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128495 {"Message" (portkey.aws/search-for-tag rawinput128494 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128495 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128495 ["Message" :content]))))))

(clojure.core/defn- response-access-denied [input] (clojure.core/let [rawinput128496 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128497 {"Message" (portkey.aws/search-for-tag rawinput128496 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128497 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128497 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [rawinput128498 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128499 {"Message" (portkey.aws/search-for-tag rawinput128498 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128499 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128499 ["Message" :content]))))))

(clojure.core/defn- response-cannot-change-immutable-public-key-fields [input] (clojure.core/let [rawinput128500 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128501 {"Message" (portkey.aws/search-for-tag rawinput128500 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128501 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128501 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-size-exceeded [input] (clojure.core/let [rawinput128502 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128503 {"Message" (portkey.aws/search-for-tag rawinput128502 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128503 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128503 ["Message" :content]))))))

(clojure.core/defn- response-invalid-lambda-function-association [input] (clojure.core/let [rawinput128504 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128505 {"Message" (portkey.aws/search-for-tag rawinput128504 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128505 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128505 ["Message" :content]))))))

(clojure.core/defn- response-create-field-level-encryption-profile-result [input] (clojure.core/let [rawinput128506 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128507 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput128506 "FieldLevelEncryptionProfile" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128507 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar128507 ["FieldLevelEncryptionProfile" :content]))) (letvar128507 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128507 ["Location"]))) (letvar128507 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128507 ["ETag"]))))))

(clojure.core/defn- response-get-field-level-encryption-profile-result [input] (clojure.core/let [rawinput128508 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128509 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput128508 "FieldLevelEncryptionProfile" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128509 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar128509 ["FieldLevelEncryptionProfile" :content]))) (letvar128509 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128509 ["ETag"]))))))

(clojure.core/defn- response-no-such-resource [input] (clojure.core/let [rawinput128510 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128511 {"Message" (portkey.aws/search-for-tag rawinput128510 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128511 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128511 ["Message" :content]))))))

(clojure.core/defn- response-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput128512 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128513 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput128512 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128513 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar128513 ["CloudFrontOriginAccessIdentity" :content]))) (letvar128513 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128513 ["ETag"]))))))

(clojure.core/defn- response-invalid-error-code [input] (clojure.core/let [rawinput128514 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128515 {"Message" (portkey.aws/search-for-tag rawinput128514 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128515 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128515 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-in-use [input] (clojure.core/let [rawinput128516 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128517 {"Message" (portkey.aws/search-for-tag rawinput128516 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128517 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128517 ["Message" :content]))))))

(clojure.core/defn- response-too-many-lambda-function-associations [input] (clojure.core/let [rawinput128518 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128519 {"Message" (portkey.aws/search-for-tag rawinput128518 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128519 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128519 ["Message" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-result [input] (clojure.core/let [rawinput128520 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128521 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput128520 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128521 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar128521 ["StreamingDistribution" :content]))) (letvar128521 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128521 ["Location"]))) (letvar128521 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128521 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-profiles [input] (clojure.core/let [rawinput128522 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128523 {"Message" (portkey.aws/search-for-tag rawinput128522 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128523 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128523 ["Message" :content]))))))

(clojure.core/defn- response-no-such-field-level-encryption-profile [input] (clojure.core/let [rawinput128524 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128525 {"Message" (portkey.aws/search-for-tag rawinput128524 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128525 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128525 ["Message" :content]))))))

(clojure.core/defn- response-invalid-relative-path [input] (clojure.core/let [rawinput128526 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128527 {"Message" (portkey.aws/search-for-tag rawinput128526 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128527 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128527 ["Message" :content]))))))

(clojure.core/defn- response-create-public-key-result [input] (clojure.core/let [rawinput128528 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128529 {"PublicKey" (portkey.aws/search-for-tag rawinput128528 "PublicKey" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128529 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar128529 ["PublicKey" :content]))) (letvar128529 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128529 ["Location"]))) (letvar128529 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128529 ["ETag"]))))))

(clojure.core/defn- response-invalid-location-code [input] (clojure.core/let [rawinput128530 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128531 {"Message" (portkey.aws/search-for-tag rawinput128530 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128531 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128531 ["Message" :content]))))))

(clojure.core/defn- response-invalid-web-acl-id [input] (clojure.core/let [rawinput128532 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128533 {"Message" (portkey.aws/search-for-tag rawinput128532 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128533 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128533 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin [input] (clojure.core/let [rawinput128534 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128535 {"Message" (portkey.aws/search-for-tag rawinput128534 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128535 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128535 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [rawinput128536 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128537 {"Message" (portkey.aws/search-for-tag rawinput128536 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128537 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128537 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-config-already-exists [input] (clojure.core/let [rawinput128538 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128539 {"Message" (portkey.aws/search-for-tag rawinput128538 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128539 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128539 ["Message" :content]))))))

(clojure.core/defn- response-no-such-field-level-encryption-config [input] (clojure.core/let [rawinput128540 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128541 {"Message" (portkey.aws/search-for-tag rawinput128540 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128541 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128541 ["Message" :content]))))))

(clojure.core/defn- response-update-distribution-result [input] (clojure.core/let [rawinput128542 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128543 {"Distribution" (portkey.aws/search-for-tag rawinput128542 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128543 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar128543 ["Distribution" :content]))) (letvar128543 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128543 ["ETag"]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput128544 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128545 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput128544 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128545 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar128545 ["CloudFrontOriginAccessIdentity" :content]))) (letvar128545 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128545 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-encryption-entities [input] (clojure.core/let [rawinput128546 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128547 {"Message" (portkey.aws/search-for-tag rawinput128546 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128547 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128547 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-result [input] (clojure.core/let [rawinput128548 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128549 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput128548 "FieldLevelEncryption" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128549 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar128549 ["FieldLevelEncryption" :content]))) (letvar128549 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128549 ["ETag"]))))))

(clojure.core/defn- response-invalid-query-string-parameters [input] (clojure.core/let [rawinput128550 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128551 {"Message" (portkey.aws/search-for-tag rawinput128550 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128551 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128551 ["Message" :content]))))))

(clojure.core/defn- response-public-key-already-exists [input] (clojure.core/let [rawinput128552 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128553 {"Message" (portkey.aws/search-for-tag rawinput128552 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128553 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128553 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origins [input] (clojure.core/let [rawinput128554 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128555 {"Message" (portkey.aws/search-for-tag rawinput128554 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128555 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128555 ["Message" :content]))))))

(clojure.core/defn- response-invalid-ttl-order [input] (clojure.core/let [rawinput128556 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128557 {"Message" (portkey.aws/search-for-tag rawinput128556 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128557 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128557 ["Message" :content]))))))

(clojure.core/defn- response-no-such-streaming-distribution [input] (clojure.core/let [rawinput128558 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128559 {"Message" (portkey.aws/search-for-tag rawinput128558 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128559 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128559 ["Message" :content]))))))

(clojure.core/defn- response-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput128560 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128561 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput128560 "CloudFrontOriginAccessIdentity" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128561 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar128561 ["CloudFrontOriginAccessIdentity" :content]))) (letvar128561 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128561 ["Location"]))) (letvar128561 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128561 ["ETag"]))))))

(clojure.core/defn- response-cname-already-exists [input] (clojure.core/let [rawinput128562 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128563 {"Message" (portkey.aws/search-for-tag rawinput128562 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128563 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128563 ["Message" :content]))))))

(clojure.core/defn- response-invalid-default-root-object [input] (clojure.core/let [rawinput128564 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128565 {"Message" (portkey.aws/search-for-tag rawinput128564 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128565 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128565 ["Message" :content]))))))

(clojure.core/defn- response-invalid-response-code [input] (clojure.core/let [rawinput128566 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128567 {"Message" (portkey.aws/search-for-tag rawinput128566 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128567 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128567 ["Message" :content]))))))

(clojure.core/defn- response-no-such-invalidation [input] (clojure.core/let [rawinput128568 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128569 {"Message" (portkey.aws/search-for-tag rawinput128568 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128569 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128569 ["Message" :content]))))))

(clojure.core/defn- response-too-many-invalidations-in-progress [input] (clojure.core/let [rawinput128570 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128571 {"Message" (portkey.aws/search-for-tag rawinput128570 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128571 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128571 ["Message" :content]))))))

(clojure.core/defn- response-get-public-key-result [input] (clojure.core/let [rawinput128572 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128573 {"PublicKey" (portkey.aws/search-for-tag rawinput128572 "PublicKey" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128573 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar128573 ["PublicKey" :content]))) (letvar128573 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128573 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions-associated-to-field-level-encryption-config [input] (clojure.core/let [rawinput128574 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128575 {"Message" (portkey.aws/search-for-tag rawinput128574 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128575 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128575 ["Message" :content]))))))

(clojure.core/defn- response-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [rawinput128576 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128577 {"CloudFrontOriginAccessIdentityList" (portkey.aws/search-for-tag rawinput128576 "CloudFrontOriginAccessIdentityList" :flattened? false)}] (clojure.core/cond-> {} (letvar128577 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar128577 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- response-update-public-key-result [input] (clojure.core/let [rawinput128578 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128579 {"PublicKey" (portkey.aws/search-for-tag rawinput128578 "PublicKey" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128579 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar128579 ["PublicKey" :content]))) (letvar128579 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128579 ["ETag"]))))))

(clojure.core/defn- response-invalid-forward-cookies [input] (clojure.core/let [rawinput128580 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128581 {"Message" (portkey.aws/search-for-tag rawinput128580 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128581 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128581 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-config-result [input] (clojure.core/let [rawinput128582 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128583 {"DistributionConfig" (portkey.aws/search-for-tag rawinput128582 "DistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128583 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar128583 ["DistributionConfig" :content]))) (letvar128583 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128583 ["ETag"]))))))

(clojure.core/defn- response-invalid-required-protocol [input] (clojure.core/let [rawinput128584 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128585 {"Message" (portkey.aws/search-for-tag rawinput128584 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128585 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128585 ["Message" :content]))))))

(clojure.core/defn- response-update-field-level-encryption-config-result [input] (clojure.core/let [rawinput128586 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128587 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput128586 "FieldLevelEncryption" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128587 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar128587 ["FieldLevelEncryption" :content]))) (letvar128587 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128587 ["ETag"]))))))

(clojure.core/defn- response-get-distribution-result [input] (clojure.core/let [rawinput128588 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128589 {"Distribution" (portkey.aws/search-for-tag rawinput128588 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128589 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar128589 ["Distribution" :content]))) (letvar128589 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128589 ["ETag"]))))))

(clojure.core/defn- response-update-field-level-encryption-profile-result [input] (clojure.core/let [rawinput128590 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128591 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput128590 "FieldLevelEncryptionProfile" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128591 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar128591 ["FieldLevelEncryptionProfile" :content]))) (letvar128591 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128591 ["ETag"]))))))

(clojure.core/defn- response-get-streaming-distribution-config-result [input] (clojure.core/let [rawinput128592 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128593 {"StreamingDistributionConfig" (portkey.aws/search-for-tag rawinput128592 "StreamingDistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128593 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar128593 ["StreamingDistributionConfig" :content]))) (letvar128593 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128593 ["ETag"]))))))

(clojure.core/defn- response-list-public-keys-result [input] (clojure.core/let [rawinput128594 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128595 {"PublicKeyList" (portkey.aws/search-for-tag rawinput128594 "PublicKeyList" :flattened? false)}] (clojure.core/cond-> {} (letvar128595 "PublicKeyList") (clojure.core/assoc :public-key-list (deser-public-key-list (clojure.core/get-in letvar128595 ["PublicKeyList" :content]))))))

(clojure.core/defn- response-invalid-headers-for-s-3-origin [input] (clojure.core/let [rawinput128596 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128597 {"Message" (portkey.aws/search-for-tag rawinput128596 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128597 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128597 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-config-result [input] (clojure.core/let [rawinput128598 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128599 {"FieldLevelEncryptionConfig" (portkey.aws/search-for-tag rawinput128598 "FieldLevelEncryptionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128599 "FieldLevelEncryptionConfig") (clojure.core/assoc :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar128599 ["FieldLevelEncryptionConfig" :content]))) (letvar128599 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128599 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-configs [input] (clojure.core/let [rawinput128600 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128601 {"Message" (portkey.aws/search-for-tag rawinput128600 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128601 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128601 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-config-in-use [input] (clojure.core/let [rawinput128602 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128603 {"Message" (portkey.aws/search-for-tag rawinput128602 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128603 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128603 ["Message" :content]))))))

(clojure.core/defn- response-too-many-distribution-cnam-es [input] (clojure.core/let [rawinput128604 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128605 {"Message" (portkey.aws/search-for-tag rawinput128604 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128605 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128605 ["Message" :content]))))))

(clojure.core/defn- response-invalid-geo-restriction-parameter [input] (clojure.core/let [rawinput128606 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128607 {"Message" (portkey.aws/search-for-tag rawinput128606 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128607 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128607 ["Message" :content]))))))

(clojure.core/defn- response-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [rawinput128608 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128609 {"Message" (portkey.aws/search-for-tag rawinput128608 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128609 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128609 ["Message" :content]))))))

(clojure.core/defn- response-list-invalidations-result [input] (clojure.core/let [rawinput128610 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128611 {"InvalidationList" (portkey.aws/search-for-tag rawinput128610 "InvalidationList" :flattened? false)}] (clojure.core/cond-> {} (letvar128611 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar128611 ["InvalidationList" :content]))))))

(clojure.core/defn- response-batch-too-large [input] (clojure.core/let [rawinput128612 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128613 {"Message" (portkey.aws/search-for-tag rawinput128612 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128613 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128613 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-with-tags-result [input] (clojure.core/let [rawinput128614 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128615 {"Distribution" (portkey.aws/search-for-tag rawinput128614 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128615 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar128615 ["Distribution" :content]))) (letvar128615 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128615 ["Location"]))) (letvar128615 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128615 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-query-arg-profiles [input] (clojure.core/let [rawinput128616 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128617 {"Message" (portkey.aws/search-for-tag rawinput128616 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128617 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128617 ["Message" :content]))))))

(clojure.core/defn- response-list-streaming-distributions-result [input] (clojure.core/let [rawinput128618 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128619 {"StreamingDistributionList" (portkey.aws/search-for-tag rawinput128618 "StreamingDistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar128619 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar128619 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-with-tags-result [input] (clojure.core/let [rawinput128620 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128621 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput128620 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128621 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar128621 ["StreamingDistribution" :content]))) (letvar128621 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128621 ["Location"]))) (letvar128621 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128621 ["ETag"]))))))

(clojure.core/defn- response-create-invalidation-result [input] (clojure.core/let [rawinput128622 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128623 {"Location" (clojure.core/get-in input [:headers "Location"]), "Invalidation" (portkey.aws/search-for-tag rawinput128622 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar128623 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128623 ["Location"]))) (letvar128623 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar128623 ["Invalidation" :content]))))))

(clojure.core/defn- response-missing-body [input] (clojure.core/let [rawinput128624 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128625 {"Message" (portkey.aws/search-for-tag rawinput128624 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128625 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128625 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-read-timeout [input] (clojure.core/let [rawinput128626 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128627 {"Message" (portkey.aws/search-for-tag rawinput128626 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128627 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128627 ["Message" :content]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [rawinput128628 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128629 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag rawinput128628 "CloudFrontOriginAccessIdentityConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128629 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar128629 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar128629 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128629 ["ETag"]))))))

(clojure.core/defn- response-distribution-not-disabled [input] (clojure.core/let [rawinput128630 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128631 {"Message" (portkey.aws/search-for-tag rawinput128630 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128631 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128631 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [rawinput128632 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128633 {"Message" (portkey.aws/search-for-tag rawinput128632 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128633 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128633 ["Message" :content]))))))

(clojure.core/defn- response-precondition-failed [input] (clojure.core/let [rawinput128634 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128635 {"Message" (portkey.aws/search-for-tag rawinput128634 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128635 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128635 ["Message" :content]))))))

(clojure.core/defn- response-distribution-already-exists [input] (clojure.core/let [rawinput128636 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128637 {"Message" (portkey.aws/search-for-tag rawinput128636 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128637 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128637 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-access-identity [input] (clojure.core/let [rawinput128638 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128639 {"Message" (portkey.aws/search-for-tag rawinput128638 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128639 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128639 ["Message" :content]))))))

(clojure.core/defn- response-too-many-trusted-signers [input] (clojure.core/let [rawinput128640 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128641 {"Message" (portkey.aws/search-for-tag rawinput128640 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128641 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128641 ["Message" :content]))))))

(clojure.core/defn- response-too-many-public-keys [input] (clojure.core/let [rawinput128642 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128643 {"Message" (portkey.aws/search-for-tag rawinput128642 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128643 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128643 ["Message" :content]))))))

(clojure.core/defn- response-invalid-minimum-protocol-version [input] (clojure.core/let [rawinput128644 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128645 {"Message" (portkey.aws/search-for-tag rawinput128644 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128645 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128645 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-already-exists [input] (clojure.core/let [rawinput128646 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128647 {"Message" (portkey.aws/search-for-tag rawinput128646 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128647 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128647 ["Message" :content]))))))

(clojure.core/defn- response-public-key-in-use [input] (clojure.core/let [rawinput128648 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128649 {"Message" (portkey.aws/search-for-tag rawinput128648 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128649 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128649 ["Message" :content]))))))

(clojure.core/defn- response-invalid-if-match-version [input] (clojure.core/let [rawinput128650 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128651 {"Message" (portkey.aws/search-for-tag rawinput128650 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128651 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128651 ["Message" :content]))))))

(clojure.core/defn- response-list-field-level-encryption-profiles-result [input] (clojure.core/let [rawinput128652 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128653 {"FieldLevelEncryptionProfileList" (portkey.aws/search-for-tag rawinput128652 "FieldLevelEncryptionProfileList" :flattened? false)}] (clojure.core/cond-> {} (letvar128653 "FieldLevelEncryptionProfileList") (clojure.core/assoc :field-level-encryption-profile-list (deser-field-level-encryption-profile-list (clojure.core/get-in letvar128653 ["FieldLevelEncryptionProfileList" :content]))))))

(clojure.core/defn- response-create-distribution-result [input] (clojure.core/let [rawinput128654 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128655 {"Distribution" (portkey.aws/search-for-tag rawinput128654 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128655 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar128655 ["Distribution" :content]))) (letvar128655 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar128655 ["Location"]))) (letvar128655 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128655 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions [input] (clojure.core/let [rawinput128656 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128657 {"Message" (portkey.aws/search-for-tag rawinput128656 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128657 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128657 ["Message" :content]))))))

(clojure.core/defn- response-list-field-level-encryption-configs-result [input] (clojure.core/let [rawinput128658 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128659 {"FieldLevelEncryptionList" (portkey.aws/search-for-tag rawinput128658 "FieldLevelEncryptionList" :flattened? false)}] (clojure.core/cond-> {} (letvar128659 "FieldLevelEncryptionList") (clojure.core/assoc :field-level-encryption-list (deser-field-level-encryption-list (clojure.core/get-in letvar128659 ["FieldLevelEncryptionList" :content]))))))

(clojure.core/defn- response-no-such-distribution [input] (clojure.core/let [rawinput128660 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128661 {"Message" (portkey.aws/search-for-tag rawinput128660 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128661 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128661 ["Message" :content]))))))

(clojure.core/defn- response-query-arg-profile-empty [input] (clojure.core/let [rawinput128662 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128663 {"Message" (portkey.aws/search-for-tag rawinput128662 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128663 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128663 ["Message" :content]))))))

(clojure.core/defn- response-update-streaming-distribution-result [input] (clojure.core/let [rawinput128664 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128665 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput128664 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128665 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar128665 ["StreamingDistribution" :content]))) (letvar128665 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128665 ["ETag"]))))))

(clojure.core/defn- response-illegal-update [input] (clojure.core/let [rawinput128666 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128667 {"Message" (portkey.aws/search-for-tag rawinput128666 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128667 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128667 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-profile-config-result [input] (clojure.core/let [rawinput128668 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128669 {"FieldLevelEncryptionProfileConfig" (portkey.aws/search-for-tag rawinput128668 "FieldLevelEncryptionProfileConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar128669 "FieldLevelEncryptionProfileConfig") (clojure.core/assoc :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar128669 ["FieldLevelEncryptionProfileConfig" :content]))) (letvar128669 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar128669 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-content-type-profiles [input] (clojure.core/let [rawinput128670 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128671 {"Message" (portkey.aws/search-for-tag rawinput128670 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128671 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128671 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-keepalive-timeout [input] (clojure.core/let [rawinput128672 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128673 {"Message" (portkey.aws/search-for-tag rawinput128672 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128673 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128673 ["Message" :content]))))))

(clojure.core/defn- response-inconsistent-quantities [input] (clojure.core/let [rawinput128674 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128675 {"Message" (portkey.aws/search-for-tag rawinput128674 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128675 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128675 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-by-web-acl-id-result [input] (clojure.core/let [rawinput128676 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128677 {"DistributionList" (portkey.aws/search-for-tag rawinput128676 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar128677 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar128677 ["DistributionList" :content]))))))

(clojure.core/defn- response-too-many-query-string-parameters [input] (clojure.core/let [rawinput128678 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128679 {"Message" (portkey.aws/search-for-tag rawinput128678 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128679 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128679 ["Message" :content]))))))

(clojure.core/defn- response-invalid-tagging [input] (clojure.core/let [rawinput128680 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128681 {"Message" (portkey.aws/search-for-tag rawinput128680 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128681 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128681 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-result [input] (clojure.core/let [rawinput128682 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128683 {"DistributionList" (portkey.aws/search-for-tag rawinput128682 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar128683 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar128683 ["DistributionList" :content]))))))

(clojure.core/defn- response-trusted-signer-does-not-exist [input] (clojure.core/let [rawinput128684 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128685 {"Message" (portkey.aws/search-for-tag rawinput128684 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128685 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128685 ["Message" :content]))))))

(clojure.core/defn- response-too-many-field-level-encryption-field-patterns [input] (clojure.core/let [rawinput128686 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128687 {"Message" (portkey.aws/search-for-tag rawinput128686 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128687 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128687 ["Message" :content]))))))

(clojure.core/defn- response-get-invalidation-result [input] (clojure.core/let [rawinput128688 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128689 {"Invalidation" (portkey.aws/search-for-tag rawinput128688 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar128689 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar128689 ["Invalidation" :content]))))))

(clojure.core/defn- response-too-many-headers-in-forwarded-values [input] (clojure.core/let [rawinput128690 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar128691 {"Message" (portkey.aws/search-for-tag rawinput128690 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar128691 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar128691 ["Message" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 1 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 128)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 0 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 256)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-10-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__22929__auto__))))
...
(clojure.core/defn create-distribution-2017-10-30 ([create-distribution-requestinput] (clojure.core/let [request-function-result__23835__auto__ (req-create-distribution-request create-distribution-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__23835__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2017-10-30/endpoints, :http.request.configuration/target-prefix nil, :http.request.spec/output-spec :portkey.aws.cloudfront.-2017-10-30/create-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2017-10-30/distribution", :http.request.configuration/version "2017-10-30", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2017-10-30/create-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.configuration/action "CreateDistribution2017_10_30", :http.request.configuration/output-deser-fn response-create-distribution-result, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront.-2017-10-30/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2017-10-30/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2017-10-30/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2017-10-30/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2017-10-30/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2017-10-30/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2017-10-30/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront.-2017-10-30/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront.-2017-10-30/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2017-10-30/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront.-2017-10-30/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront.-2017-10-30/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront.-2017-10-30/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront.-2017-10-30/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2017-10-30/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2017-10-30/invalid-web-acl-id, "InvalidOrigin" :portkey.aws.cloudfront.-2017-10-30/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2017-10-30/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2017-10-30/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2017-10-30/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2017-10-30/invalid-ttl-order, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2017-10-30/cname-already-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2017-10-30/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2017-10-30/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront.-2017-10-30/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2017-10-30/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2017-10-30/invalid-headers-for-s-3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2017-10-30/too-many-distribution-cnam-es, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2017-10-30/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2017-10-30/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2017-10-30/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2017-10-30/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2017-10-30/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2017-10-30/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront.-2017-10-30/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront.-2017-10-30/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2017-10-30/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2017-10-30/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2017-10-30/too-many-headers-in-forwarded-values}})))))
