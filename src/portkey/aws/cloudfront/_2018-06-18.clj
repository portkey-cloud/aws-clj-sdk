...
(clojure.core/declare ser-lambda-functionarn)
...
(clojure.core/defn- ser-field-level-encryption-profile-config [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:name input)) #:http.request.field{:name "Name", :shape "string"}) (clojure.core/into (ser-string (:caller-reference input)) #:http.request.field{:name "CallerReference", :shape "string"}) (clojure.core/into (ser-encryption-entities (:encryption-entities input)) #:http.request.field{:name "EncryptionEntities", :shape "EncryptionEntities"})], :shape "FieldLevelEncryptionProfileConfig", :type "structure"} (clojure.core/contains? input :comment) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-string (input :comment)) #:http.request.field{:name "Comment", :shape "string"}))))

(clojure.core/defn- ser-string [input] #:http.request.field{:value input, :shape "string"})

(clojure.core/defn- ser-field-level-encryption-config [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:caller-reference input)) #:http.request.field{:name "CallerReference", :shape "string"})], :shape "FieldLevelEncryptionConfig", :type "structure"} (clojure.core/contains? input :comment) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-string (input :comment)) #:http.request.field{:name "Comment", :shape "string"})) (clojure.core/contains? input :query-arg-profile-config) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-query-arg-profile-config (input :query-arg-profile-config)) #:http.request.field{:name "QueryArgProfileConfig", :shape "QueryArgProfileConfig"})) (clojure.core/contains? input :content-type-profile-config) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-content-type-profile-config (input :content-type-profile-config)) #:http.request.field{:name "ContentTypeProfileConfig", :shape "ContentTypeProfileConfig"}))))

(clojure.core/defn- ser-query-arg-profile [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:query-arg input)) #:http.request.field{:name "QueryArg", :shape "string"}) (clojure.core/into (ser-string (:profile-id input)) #:http.request.field{:name "ProfileId", :shape "string"})], :shape "QueryArgProfile", :type "structure"}))

(clojure.core/defn- ser-lambda-function-association [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-lambda-functionarn (:lambda-functionarn input)) #:http.request.field{:name "LambdaFunctionARN", :shape "LambdaFunctionARN"}) (clojure.core/into (ser-event-type (:event-type input)) #:http.request.field{:name "EventType", :shape "EventType"})], :shape "LambdaFunctionAssociation", :type "structure"} (clojure.core/contains? input :include-body) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-boolean (input :include-body)) #:http.request.field{:name "IncludeBody", :shape "boolean"}))))
...
(clojure.core/defn- ser-public-key-config [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:caller-reference input)) #:http.request.field{:name "CallerReference", :shape "string"}) (clojure.core/into (ser-string (:name input)) #:http.request.field{:name "Name", :shape "string"}) (clojure.core/into (ser-string (:encoded-key input)) #:http.request.field{:name "EncodedKey", :shape "string"})], :shape "PublicKeyConfig", :type "structure"} (clojure.core/contains? input :comment) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-string (input :comment)) #:http.request.field{:name "Comment", :shape "string"}))))
...
(clojure.core/defn- ser-format [input] #:http.request.field{:value (clojure.core/get {"URLEncoded" "URLEncoded", :urlencoded "URLEncoded"} input), :shape "Format"})
...
(clojure.core/defn- ser-content-type-profiles [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-integer (:quantity input)) #:http.request.field{:name "Quantity", :shape "integer"})], :shape "ContentTypeProfiles", :type "structure"} (clojure.core/contains? input :items) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-content-type-profile-list (input :items)) #:http.request.field{:name "Items", :shape "ContentTypeProfileList"}))))

(clojure.core/defn- ser-encryption-entity [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:public-key-id input)) #:http.request.field{:name "PublicKeyId", :shape "string"}) (clojure.core/into (ser-string (:provider-id input)) #:http.request.field{:name "ProviderId", :shape "string"}) (clojure.core/into (ser-field-patterns (:field-patterns input)) #:http.request.field{:name "FieldPatterns", :shape "FieldPatterns"})], :shape "EncryptionEntity", :type "structure"}))

(clojure.core/defn- ser-lambda-functionarn [input] #:http.request.field{:value input, :shape "LambdaFunctionARN"})
...
(clojure.core/defn- ser-custom-origin-config [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-integer (:httpport input)) #:http.request.field{:name "HTTPPort", :shape "integer"}) (clojure.core/into (ser-integer (:httpsport input)) #:http.request.field{:name "HTTPSPort", :shape "integer"}) (clojure.core/into (ser-origin-protocol-policy (:origin-protocol-policy input)) #:http.request.field{:name "OriginProtocolPolicy", :shape "OriginProtocolPolicy"})], :shape "CustomOriginConfig", :type "structure"} (clojure.core/contains? input :origin-ssl-protocols) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-origin-ssl-protocols (input :origin-ssl-protocols)) #:http.request.field{:name "OriginSslProtocols", :shape "OriginSslProtocols"})) (clojure.core/contains? input :origin-read-timeout) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-integer (input :origin-read-timeout)) #:http.request.field{:name "OriginReadTimeout", :shape "integer"})) (clojure.core/contains? input :origin-keepalive-timeout) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-integer (input :origin-keepalive-timeout)) #:http.request.field{:name "OriginKeepaliveTimeout", :shape "integer"}))))
...
(clojure.core/defn- ser-query-arg-profile-config [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-boolean (:forward-when-query-arg-profile-is-unknown input)) #:http.request.field{:name "ForwardWhenQueryArgProfileIsUnknown", :shape "boolean"})], :shape "QueryArgProfileConfig", :type "structure"} (clojure.core/contains? input :query-arg-profiles) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-query-arg-profiles (input :query-arg-profiles)) #:http.request.field{:name "QueryArgProfiles", :shape "QueryArgProfiles"}))))
...
(clojure.core/defn- ser-query-arg-profiles [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-integer (:quantity input)) #:http.request.field{:name "Quantity", :shape "integer"})], :shape "QueryArgProfiles", :type "structure"} (clojure.core/contains? input :items) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-query-arg-profile-list (input :items)) #:http.request.field{:name "Items", :shape "QueryArgProfileList"}))))
...
(clojure.core/defn- ser-field-pattern-list [input] #:http.request.field{:value (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (clojure.core/merge (ser-string coll) #:http.request.field{:shape "string", :location-name "FieldPattern"}))) input), :shape "FieldPatternList", :type "list"})
...
(clojure.core/defn- ser-minimum-protocol-version [input] #:http.request.field{:value (clojure.core/get {:sslv3 "SSLv3", :tlsv1.2-2018 "TLSv1.2_2018", "TLSv1" "TLSv1", "TLSv1_2016" "TLSv1_2016", :tlsv1.1-2016 "TLSv1.1_2016", "TLSv1.2_2018" "TLSv1.2_2018", "SSLv3" "SSLv3", :tlsv1 "TLSv1", "TLSv1.1_2016" "TLSv1.1_2016", :tlsv1-2016 "TLSv1_2016"} input), :shape "MinimumProtocolVersion"})
...
(clojure.core/defn- ser-default-cache-behavior [input] (clojure.core/cond-> #:http.request.field{:value [(clojure.core/into (ser-string (:target-origin-id input)) #:http.request.field{:name "TargetOriginId", :shape "string"}) (clojure.core/into (ser-forwarded-values (:forwarded-values input)) #:http.request.field{:name "ForwardedValues", :shape "ForwardedValues"}) (clojure.core/into (ser-trusted-signers (:trusted-signers input)) #:http.request.field{:name "TrustedSigners", :shape "TrustedSigners"}) (clojure.core/into (ser-viewer-protocol-policy (:viewer-protocol-policy input)) #:http.request.field{:name "ViewerProtocolPolicy", :shape "ViewerProtocolPolicy"}) (clojure.core/into (ser-long (:minttl input)) #:http.request.field{:name "MinTTL", :shape "long"})], :shape "DefaultCacheBehavior", :type "structure"} (clojure.core/contains? input :smooth-streaming) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-boolean (input :smooth-streaming)) #:http.request.field{:name "SmoothStreaming", :shape "boolean"})) (clojure.core/contains? input :field-level-encryption-id) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-string (input :field-level-encryption-id)) #:http.request.field{:name "FieldLevelEncryptionId", :shape "string"})) (clojure.core/contains? input :compress) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-boolean (input :compress)) #:http.request.field{:name "Compress", :shape "boolean"})) (clojure.core/contains? input :lambda-function-associations) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-lambda-function-associations (input :lambda-function-associations)) #:http.request.field{:name "LambdaFunctionAssociations", :shape "LambdaFunctionAssociations"})) (clojure.core/contains? input :maxttl) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-long (input :maxttl)) #:http.request.field{:name "MaxTTL", :shape "long"})) (clojure.core/contains? input :allowed-methods) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-allowed-methods (input :allowed-methods)) #:http.request.field{:name "AllowedMethods", :shape "AllowedMethods"})) (clojure.core/contains? input :defaultttl) (clojure.core/update-in [:http.request.field/value] (clojure.core/fnil clojure.core/conj []) (clojure.core/into (ser-long (input :defaultttl)) #:http.request.field{:name "DefaultTTL", :shape "long"}))))
...
(clojure.core/defn- req<-get-public-key-config-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))
...
(clojure.core/defn- req<-get-field-level-encryption-config-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))

(clojure.core/defn- req<-get-public-key-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))
...
(clojure.core/defn- req<-get-field-level-encryption-profile-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))
...
(clojure.core/defn- req<-get-field-level-encryption-profile-config-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))
...
(clojure.core/defn- req<-get-field-level-encryption-request [input] (clojure.core/cond-> #:http.request.configuration{:uri [(clojure.core/into (ser-string (input :id)) #:http.request.field{:name "Id", :shape "string", :location "uri", :location-name "Id"})]}))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/marker (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/max-items (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-request (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/webaclid] :opt-un [:portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/marker :portkey.aws.cloudfront.-2018-06-18.list-distributions-by-webaclid-request/max-items]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-config-result/location :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/streaming-distribution :portkey.aws.cloudfront.-2018-06-18.get-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.too-many-streaming-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.too-many-streaming-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-public-key-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-public-key-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/public-key-config :portkey.aws.cloudfront.-2018-06-18.get-public-key-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/lambda-function-association (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18/lambda-functionarn :portkey.aws.cloudfront.-2018-06-18/event-type] :opt-un [:portkey.aws.cloudfront.-2018-06-18.lambda-function-association/include-body]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.list-tags-for-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/viewer-protocol-policy #{"allow-all" :https-only :redirect-to-https :allow-all "https-only" "redirect-to-https"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-profile-result/location :portkey.aws.cloudfront.-2018-06-18.create-field-level-encryption-profile-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-profile-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2018-06-18.update-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 1 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 128)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/streaming-distribution :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-result/location :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cache-behavior/maxttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cache-behavior/defaultttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/cache-behavior (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.cache-behavior/path-pattern :portkey.aws.cloudfront.-2018-06-18.cache-behavior/target-origin-id :portkey.aws.cloudfront.-2018-06-18/forwarded-values :portkey.aws.cloudfront.-2018-06-18/trusted-signers :portkey.aws.cloudfront.-2018-06-18/viewer-protocol-policy :portkey.aws.cloudfront.-2018-06-18.cache-behavior/minttl] :opt-un [:portkey.aws.cloudfront.-2018-06-18.cache-behavior/smooth-streaming :portkey.aws.cloudfront.-2018-06-18.cache-behavior/field-level-encryption-id :portkey.aws.cloudfront.-2018-06-18.cache-behavior/compress :portkey.aws.cloudfront.-2018-06-18/lambda-function-associations :portkey.aws.cloudfront.-2018-06-18.cache-behavior/maxttl :portkey.aws.cloudfront.-2018-06-18/allowed-methods :portkey.aws.cloudfront.-2018-06-18.cache-behavior/defaultttl]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/public-key :portkey.aws.cloudfront.-2018-06-18.create-public-key-result/location :portkey.aws.cloudfront.-2018-06-18.create-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/origin (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.origin/id :portkey.aws.cloudfront.-2018-06-18.origin/domain-name] :opt-un [:portkey.aws.cloudfront.-2018-06-18.origin/origin-path :portkey.aws.cloudfront.-2018-06-18/custom-headers :portkey.aws.cloudfront.-2018-06-18/s3-origin-config :portkey.aws.cloudfront.-2018-06-18/custom-origin-config]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.invalid-webaclid/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/invalid-webaclid (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.invalid-webaclid/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/format #{:urlencoded "URLEncoded"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/event-type #{:origin-response :viewer-request "viewer-response" :viewer-response "origin-response" "origin-request" "viewer-request" :origin-request})

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution :portkey.aws.cloudfront.-2018-06-18.update-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/lambda-functionarn (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2018-06-18.get-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.custom-origin-config/httpport (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/integer))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.custom-origin-config/httpsport (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/integer))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.invalidttlorder/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/invalidttlorder (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.invalidttlorder/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.s3-origin/domain-name (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.s3-origin/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/s3-origin (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.s3-origin/domain-name :portkey.aws.cloudfront.-2018-06-18.s3-origin/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2018-06-18.create-cloud-front-origin-access-identity-result/location :portkey.aws.cloudfront.-2018-06-18.create-cloud-front-origin-access-identity-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cnamealready-exists/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.cnamealready-exists/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/streaming-distribution-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/id :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/arn :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/status :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/last-modified-time :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/domain-name :portkey.aws.cloudfront.-2018-06-18/s3-origin :portkey.aws.cloudfront.-2018-06-18/aliases :portkey.aws.cloudfront.-2018-06-18/trusted-signers :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/comment :portkey.aws.cloudfront.-2018-06-18/price-class :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-summary/enabled] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity/id :portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity/s3-canonical-user-id] :opt-un [:portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity-config]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.tag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.distribution-config/isipv6-enabled (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/boolean))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.distribution-config/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/distribution-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.distribution-config/caller-reference :portkey.aws.cloudfront.-2018-06-18/origins :portkey.aws.cloudfront.-2018-06-18/default-cache-behavior :portkey.aws.cloudfront.-2018-06-18.distribution-config/comment :portkey.aws.cloudfront.-2018-06-18.distribution-config/enabled] :opt-un [:portkey.aws.cloudfront.-2018-06-18.distribution-config/default-root-object :portkey.aws.cloudfront.-2018-06-18.distribution-config/isipv6-enabled :portkey.aws.cloudfront.-2018-06-18/restrictions :portkey.aws.cloudfront.-2018-06-18.distribution-config/webaclid :portkey.aws.cloudfront.-2018-06-18.distribution-config/logging :portkey.aws.cloudfront.-2018-06-18/cache-behaviors :portkey.aws.cloudfront.-2018-06-18/custom-error-responses :portkey.aws.cloudfront.-2018-06-18/aliases :portkey.aws.cloudfront.-2018-06-18/price-class :portkey.aws.cloudfront.-2018-06-18/http-version :portkey.aws.cloudfront.-2018-06-18/viewer-certificate]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/public-key :portkey.aws.cloudfront.-2018-06-18.get-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/public-key :portkey.aws.cloudfront.-2018-06-18.update-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution-config :portkey.aws.cloudfront.-2018-06-18.get-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption :portkey.aws.cloudfront.-2018-06-18.update-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 0 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 256)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution :portkey.aws.cloudfront.-2018-06-18.get-distribution-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile :portkey.aws.cloudfront.-2018-06-18.update-field-level-encryption-profile-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-streaming-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/streaming-distribution-config :portkey.aws.cloudfront.-2018-06-18.get-streaming-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/origin-protocol-policy #{"match-viewer" :https-only "https-only" :match-viewer "http-only" :http-only})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.invalid-headers-fors3-origin/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/invalid-headers-fors3-origin (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.invalid-headers-fors3-origin/message]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption-config :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.too-many-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/too-many-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.too-many-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution :portkey.aws.cloudfront.-2018-06-18.create-distribution-with-tags-result/location :portkey.aws.cloudfront.-2018-06-18.create-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/streaming-distribution :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-with-tags-result/location :portkey.aws.cloudfront.-2018-06-18.create-streaming-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity-summary/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity-summary/id :portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity-summary/s3-canonical-user-id :portkey.aws.cloudfront.-2018-06-18.cloud-front-origin-access-identity-summary/comment] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-cloud-front-origin-access-identity-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity-config :portkey.aws.cloudfront.-2018-06-18.get-cloud-front-origin-access-identity-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/streaming-distribution-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.streaming-distribution-config/caller-reference :portkey.aws.cloudfront.-2018-06-18/s3-origin :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-config/comment :portkey.aws.cloudfront.-2018-06-18/trusted-signers :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-config/enabled] :opt-un [:portkey.aws.cloudfront.-2018-06-18/aliases :portkey.aws.cloudfront.-2018-06-18.streaming-distribution-config/logging :portkey.aws.cloudfront.-2018-06-18/price-class]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.s3-origin-config/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/s3-origin-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.s3-origin-config/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.distribution-summary/isipv6-enabled (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/boolean))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.distribution-summary/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/distribution-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.distribution-summary/id :portkey.aws.cloudfront.-2018-06-18.distribution-summary/arn :portkey.aws.cloudfront.-2018-06-18.distribution-summary/status :portkey.aws.cloudfront.-2018-06-18.distribution-summary/last-modified-time :portkey.aws.cloudfront.-2018-06-18.distribution-summary/domain-name :portkey.aws.cloudfront.-2018-06-18/aliases :portkey.aws.cloudfront.-2018-06-18/origins :portkey.aws.cloudfront.-2018-06-18/default-cache-behavior :portkey.aws.cloudfront.-2018-06-18/cache-behaviors :portkey.aws.cloudfront.-2018-06-18/custom-error-responses :portkey.aws.cloudfront.-2018-06-18.distribution-summary/comment :portkey.aws.cloudfront.-2018-06-18/price-class :portkey.aws.cloudfront.-2018-06-18.distribution-summary/enabled :portkey.aws.cloudfront.-2018-06-18/viewer-certificate :portkey.aws.cloudfront.-2018-06-18/restrictions :portkey.aws.cloudfront.-2018-06-18.distribution-summary/webaclid :portkey.aws.cloudfront.-2018-06-18/http-version :portkey.aws.cloudfront.-2018-06-18.distribution-summary/isipv6-enabled] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/ssl-protocol #{:sslv3 "TLSv1" "TLSv1.2" "SSLv3" :tlsv1.1 :tlsv1.2 :tlsv1 "TLSv1.1"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/minimum-protocol-version #{:sslv3 :tlsv1.2-2018 "TLSv1" "TLSv1_2016" :tlsv1.1-2016 "TLSv1.2_2018" "SSLv3" :tlsv1 "TLSv1.1_2016" :tlsv1-2016})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.create-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/create-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution :portkey.aws.cloudfront.-2018-06-18.create-distribution-result/location :portkey.aws.cloudfront.-2018-06-18.create-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/resourcearn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.update-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/update-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/streaming-distribution :portkey.aws.cloudfront.-2018-06-18.update-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/sslsupport-method #{"sni-only" :sni-only :vip "vip"})

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-profile-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-config :portkey.aws.cloudfront.-2018-06-18.get-field-level-encryption-profile-config-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/http-version #{"http2" :http1.1 :http2 "http1.1"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18/distribution-list]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.untag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/maxttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/defaultttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/default-cache-behavior (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/target-origin-id :portkey.aws.cloudfront.-2018-06-18/forwarded-values :portkey.aws.cloudfront.-2018-06-18/trusted-signers :portkey.aws.cloudfront.-2018-06-18/viewer-protocol-policy :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/minttl] :opt-un [:portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/smooth-streaming :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/field-level-encryption-id :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/compress :portkey.aws.cloudfront.-2018-06-18/lambda-function-associations :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/maxttl :portkey.aws.cloudfront.-2018-06-18/allowed-methods :portkey.aws.cloudfront.-2018-06-18.default-cache-behavior/defaultttl]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.viewer-certificate/iamcertificate-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18.viewer-certificate/acmcertificate-arn (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-06-18/viewer-certificate (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2018-06-18.viewer-certificate/cloud-front-default-certificate :portkey.aws.cloudfront.-2018-06-18.viewer-certificate/iamcertificate-id :portkey.aws.cloudfront.-2018-06-18.viewer-certificate/acmcertificate-arn :portkey.aws.cloudfront.-2018-06-18/sslsupport-method :portkey.aws.cloudfront.-2018-06-18/minimum-protocol-version :portkey.aws.cloudfront.-2018-06-18.viewer-certificate/certificate :portkey.aws.cloudfront.-2018-06-18/certificate-source]))
...
(clojure.core/defn tag-resource2018-06-18 ([tag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-tag-resource-request tag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging?Operation=Tag", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/tag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2018-06-18/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2018-06-18/no-such-resource}})))))
(clojure.spec.alpha/fdef tag-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/tag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-distribution2018-06-18 ([get-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-request get-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-distribution-result))

(clojure.core/defn get-public-key2018-06-18 ([get-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-public-key-request get-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key}})))))
(clojure.spec.alpha/fdef get-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-public-key-result))

(clojure.core/defn create-streaming-distribution-with-tags2018-06-18 ([create-streaming-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-with-tags-request create-streaming-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution?WithTags", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidOrigin" :portkey.aws.cloudfront.-2018-06-18/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "InvalidTagging" :portkey.aws.cloudfront.-2018-06-18/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution-with-tags2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-with-tags-result))

(clojure.core/defn update-distribution2018-06-18 ([update-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-distribution-request update-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront.-2018-06-18/no-such-origin, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2018-06-18/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2018-06-18/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2018-06-18/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2018-06-18/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront.-2018-06-18/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront.-2018-06-18/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront.-2018-06-18/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront.-2018-06-18/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront.-2018-06-18/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2018-06-18/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2018-06-18/invalid-webaclid, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2018-06-18/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2018-06-18/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2018-06-18/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2018-06-18/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront.-2018-06-18/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2018-06-18/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2018-06-18/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2018-06-18/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-read-timeout, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-minimum-protocol-version, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2018-06-18/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef update-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-distribution-result))

(clojure.core/defn update-field-level-encryption-profile2018-06-18 ([update-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-field-level-encryption-profile-request update-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"FieldLevelEncryptionProfileAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-already-exists, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "FieldLevelEncryptionProfileSizeExceeded" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-size-exceeded, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile, "TooManyFieldLevelEncryptionEncryptionEntities" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-encryption-entities, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TooManyFieldLevelEncryptionFieldPatterns" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-field-patterns}})))))
(clojure.spec.alpha/fdef update-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-profile-result))

(clojure.core/defn delete-streaming-distribution2018-06-18 ([delete-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-streaming-distribution-request delete-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "StreamingDistributionNotDisabled" :portkey.aws.cloudfront.-2018-06-18/streaming-distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-streaming-distribution, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-streaming-distribution-request) :ret clojure.core/true?)

(clojure.core/defn delete-cloud-front-origin-access-identity2018-06-18 ([delete-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-cloud-front-origin-access-identity-request delete-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "CloudFrontOriginAccessIdentityInUse" :portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity-in-use}})))))
(clojure.spec.alpha/fdef delete-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-cloud-front-origin-access-identity-request) :ret clojure.core/true?)

(clojure.core/defn create-distribution-with-tags2018-06-18 ([create-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-with-tags-request create-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution?WithTags", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront.-2018-06-18/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2018-06-18/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2018-06-18/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2018-06-18/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2018-06-18/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2018-06-18/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront.-2018-06-18/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront.-2018-06-18/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront.-2018-06-18/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront.-2018-06-18/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront.-2018-06-18/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2018-06-18/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2018-06-18/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront.-2018-06-18/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2018-06-18/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2018-06-18/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2018-06-18/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2018-06-18/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront.-2018-06-18/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2018-06-18/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2018-06-18/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2018-06-18/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/too-many-query-string-parameters, "InvalidTagging" :portkey.aws.cloudfront.-2018-06-18/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2018-06-18/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution-with-tags2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-distribution-with-tags-result))

(clojure.core/defn delete-field-level-encryption-profile2018-06-18 ([delete-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-field-level-encryption-profile-request delete-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "FieldLevelEncryptionProfileInUse" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-in-use}})))))
(clojure.spec.alpha/fdef delete-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-field-level-encryption-profile-request) :ret clojure.core/true?)

(clojure.core/defn get-invalidation2018-06-18 ([get-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-invalidation-request get-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchInvalidation" :portkey.aws.cloudfront.-2018-06-18/no-such-invalidation, "NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-invalidation2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-invalidation-result))

(clojure.core/defn list-field-level-encryption-profiles2018-06-18 ([] (list-field-level-encryption-profiles2018-06-18 {})) ([list-field-level-encryption-profiles-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-field-level-encryption-profiles-request list-field-level-encryption-profiles-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-profiles-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-profiles-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-field-level-encryption-profiles2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-profiles-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-profiles-result))

(clojure.core/defn create-field-level-encryption-profile2018-06-18 ([create-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-field-level-encryption-profile-request create-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key, "FieldLevelEncryptionProfileAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-already-exists, "FieldLevelEncryptionProfileSizeExceeded" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-profile-size-exceeded, "TooManyFieldLevelEncryptionProfiles" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-profiles, "TooManyFieldLevelEncryptionEncryptionEntities" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-encryption-entities, "TooManyFieldLevelEncryptionFieldPatterns" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-field-patterns}})))))
(clojure.spec.alpha/fdef create-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-profile-result))

(clojure.core/defn create-streaming-distribution2018-06-18 ([create-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-request create-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidOrigin" :portkey.aws.cloudfront.-2018-06-18/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-streaming-distribution-result))

(clojure.core/defn get-field-level-encryption-profile2018-06-18 ([get-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-profile-request get-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-result))

(clojure.core/defn list-field-level-encryption-configs2018-06-18 ([] (list-field-level-encryption-configs2018-06-18 {})) ([list-field-level-encryption-configs-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-field-level-encryption-configs-request list-field-level-encryption-configs-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-configs-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-configs-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-field-level-encryption-configs2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-configs-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-field-level-encryption-configs-result))

(clojure.core/defn list-tags-for-resource2018-06-18 ([list-tags-for-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-tags-for-resource-request list-tags-for-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-tags-for-resource-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-tags-for-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2018-06-18/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2018-06-18/no-such-resource}})))))
(clojure.spec.alpha/fdef list-tags-for-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/list-tags-for-resource-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-tags-for-resource-result))

(clojure.core/defn get-streaming-distribution2018-06-18 ([get-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-request get-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-result))

(clojure.core/defn get-field-level-encryption2018-06-18 ([get-field-level-encryption-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-request get-field-level-encryption-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config}})))))
(clojure.spec.alpha/fdef get-field-level-encryption2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-result))

(clojure.core/defn create-distribution2018-06-18 ([create-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-request create-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront.-2018-06-18/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2018-06-18/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2018-06-18/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2018-06-18/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2018-06-18/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2018-06-18/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront.-2018-06-18/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront.-2018-06-18/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront.-2018-06-18/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront.-2018-06-18/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront.-2018-06-18/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront.-2018-06-18/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2018-06-18/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2018-06-18/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront.-2018-06-18/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2018-06-18/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2018-06-18/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2018-06-18/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2018-06-18/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront.-2018-06-18/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2018-06-18/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2018-06-18/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2018-06-18/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2018-06-18/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2018-06-18/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2018-06-18/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-distribution-result))

(clojure.core/defn create-field-level-encryption-config2018-06-18 ([create-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-field-level-encryption-config-request create-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile, "FieldLevelEncryptionConfigAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-config-already-exists, "TooManyFieldLevelEncryptionConfigs" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-configs, "TooManyFieldLevelEncryptionQueryArgProfiles" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-query-arg-profiles, "TooManyFieldLevelEncryptionContentTypeProfiles" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-content-type-profiles, "QueryArgProfileEmpty" :portkey.aws.cloudfront.-2018-06-18/query-arg-profile-empty}})))))
(clojure.spec.alpha/fdef create-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-field-level-encryption-config-result))

(clojure.core/defn get-streaming-distribution-config2018-06-18 ([get-streaming-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-config-request get-streaming-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-streaming-distribution-config-result))

(clojure.core/defn update-field-level-encryption-config2018-06-18 ([update-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-field-level-encryption-config-request update-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config, "TooManyFieldLevelEncryptionQueryArgProfiles" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-query-arg-profiles, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "QueryArgProfileEmpty" :portkey.aws.cloudfront.-2018-06-18/query-arg-profile-empty, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "TooManyFieldLevelEncryptionContentTypeProfiles" :portkey.aws.cloudfront.-2018-06-18/too-many-field-level-encryption-content-type-profiles, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef update-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-field-level-encryption-config-result))

(clojure.core/defn list-distributions2018-06-18 ([] (list-distributions2018-06-18 {})) ([list-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-request list-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-distributions2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-distributions-result))

(clojure.core/defn list-public-keys2018-06-18 ([] (list-public-keys2018-06-18 {})) ([list-public-keys-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-public-keys-request list-public-keys-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-public-keys-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-public-keys-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-public-keys2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-public-keys-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-public-keys-result))

(clojure.core/defn create-public-key2018-06-18 ([create-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-public-key-request create-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"PublicKeyAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/public-key-already-exists, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "TooManyPublicKeys" :portkey.aws.cloudfront.-2018-06-18/too-many-public-keys}})))))
(clojure.spec.alpha/fdef create-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-public-key-result))

(clojure.core/defn get-field-level-encryption-profile-config2018-06-18 ([get-field-level-encryption-profile-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-profile-config-request get-field-level-encryption-profile-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-profile}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-profile-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-profile-config-result))

(clojure.core/defn get-cloud-front-origin-access-identity-config2018-06-18 ([get-cloud-front-origin-access-identity-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-config-request get-cloud-front-origin-access-identity-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-config-result))

(clojure.core/defn list-invalidations2018-06-18 ([list-invalidations-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-invalidations-request list-invalidations-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-invalidations-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-invalidations-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef list-invalidations2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/list-invalidations-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-invalidations-result))

(clojure.core/defn delete-public-key2018-06-18 ([delete-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-public-key-request delete-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "PublicKeyInUse" :portkey.aws.cloudfront.-2018-06-18/public-key-in-use, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-public-key-request) :ret clojure.core/true?)

(clojure.core/defn untag-resource2018-06-18 ([untag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-untag-resource-request untag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging?Operation=Untag", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/untag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2018-06-18/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2018-06-18/no-such-resource}})))))
(clojure.spec.alpha/fdef untag-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/untag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-cloud-front-origin-access-identity2018-06-18 ([get-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-request get-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-cloud-front-origin-access-identity-result))

(clojure.core/defn update-cloud-front-origin-access-identity2018-06-18 ([update-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-cloud-front-origin-access-identity-request update-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef update-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-cloud-front-origin-access-identity-result))

(clojure.core/defn update-streaming-distribution2018-06-18 ([update-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-streaming-distribution-request update-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2018-06-18/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-streaming-distribution, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2018-06-18/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2018-06-18/too-many-trusted-signers, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2018-06-18/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef update-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-streaming-distribution-result))

(clojure.core/defn get-distribution-config2018-06-18 ([get-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-config-request get-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-distribution-config-result))

(clojure.core/defn get-public-key-config2018-06-18 ([get-public-key-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-public-key-config-request get-public-key-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-public-key-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-public-key-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key}})))))
(clojure.spec.alpha/fdef get-public-key-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-public-key-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-public-key-config-result))

(clojure.core/defn list-cloud-front-origin-access-identities2018-06-18 ([] (list-cloud-front-origin-access-identities2018-06-18 {})) ([list-cloud-front-origin-access-identities-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-cloud-front-origin-access-identities-request list-cloud-front-origin-access-identities-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-cloud-front-origin-access-identities-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-cloud-front-origin-access-identities-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-cloud-front-origin-access-identities2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-cloud-front-origin-access-identities-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-cloud-front-origin-access-identities-result))

(clojure.core/defn list-streaming-distributions2018-06-18 ([] (list-streaming-distributions2018-06-18 {})) ([list-streaming-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-streaming-distributions-request list-streaming-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-streaming-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-streaming-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument}})))))
(clojure.spec.alpha/fdef list-streaming-distributions2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2018-06-18/list-streaming-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-streaming-distributions-result))

(clojure.core/defn update-public-key2018-06-18 ([update-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-public-key-request update-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/update-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/update-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "CannotChangeImmutablePublicKeyFields" :portkey.aws.cloudfront.-2018-06-18/cannot-change-immutable-public-key-fields, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront.-2018-06-18/illegal-update, "NoSuchPublicKey" :portkey.aws.cloudfront.-2018-06-18/no-such-public-key, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed}})))))
(clojure.spec.alpha/fdef update-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/update-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/update-public-key-result))

(clojure.core/defn get-field-level-encryption-config2018-06-18 ([get-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-config-request get-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/get-field-level-encryption-config-result))

(clojure.core/defn delete-distribution2018-06-18 ([delete-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-distribution-request delete-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "DistributionNotDisabled" :portkey.aws.cloudfront.-2018-06-18/distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-distribution-request) :ret clojure.core/true?)

(clojure.core/defn create-invalidation2018-06-18 ([create-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-invalidation-request create-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront.-2018-06-18/no-such-distribution, "BatchTooLarge" :portkey.aws.cloudfront.-2018-06-18/batch-too-large, "TooManyInvalidationsInProgress" :portkey.aws.cloudfront.-2018-06-18/too-many-invalidations-in-progress, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-invalidation2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-invalidation-result))

(clojure.core/defn delete-field-level-encryption-config2018-06-18 ([delete-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-field-level-encryption-config-request delete-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/delete-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2018-06-18/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2018-06-18/invalid-if-match-version, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront.-2018-06-18/no-such-field-level-encryption-config, "PreconditionFailed" :portkey.aws.cloudfront.-2018-06-18/precondition-failed, "FieldLevelEncryptionConfigInUse" :portkey.aws.cloudfront.-2018-06-18/field-level-encryption-config-in-use}})))))
(clojure.spec.alpha/fdef delete-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/delete-field-level-encryption-config-request) :ret clojure.core/true?)

(clojure.core/defn list-distributions-by-webaclid2018-06-18 ([list-distributions-by-webaclid-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-by-webaclid-request list-distributions-by-webaclid-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distributionsByWebACLId/{WebACLId}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InvalidWebACLId" :portkey.aws.cloudfront.-2018-06-18/invalid-webaclid}})))))
(clojure.spec.alpha/fdef list-distributions-by-webaclid2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/list-distributions-by-webaclid-result))

(clojure.core/defn create-cloud-front-origin-access-identity2018-06-18 ([create-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-cloud-front-origin-access-identity-request create-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2018-06-18/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2018-06-18/create-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront.-2018-06-18/create-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"CloudFrontOriginAccessIdentityAlreadyExists" :portkey.aws.cloudfront.-2018-06-18/cloud-front-origin-access-identity-already-exists, "MissingBody" :portkey.aws.cloudfront.-2018-06-18/missing-body, "TooManyCloudFrontOriginAccessIdentities" :portkey.aws.cloudfront.-2018-06-18/too-many-cloud-front-origin-access-identities, "InvalidArgument" :portkey.aws.cloudfront.-2018-06-18/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront.-2018-06-18/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2018-06-18/create-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2018-06-18/create-cloud-front-origin-access-identity-result))
