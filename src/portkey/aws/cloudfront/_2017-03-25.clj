...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar109837 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar109837 ["Quantity" :content]))} (letvar109837 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar109837 ["Items" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar109933 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "IncludeCookies" (portkey.aws/search-for-tag input "IncludeCookies" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar109933 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar109933 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar109933 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar109933 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar110029 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar110029 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar110029 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar110029 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar110142 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "InvalidationBatch" (portkey.aws/search-for-tag input "InvalidationBatch" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar110142 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar110142 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar110142 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar110142 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar110277 {"GeoRestriction" (portkey.aws/search-for-tag input "GeoRestriction" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar110277 ["GeoRestriction" :content]))})))

(clojure.core/defn- deserstring [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar110378 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "InProgressInvalidationBatches" (portkey.aws/search-for-tag input "InProgressInvalidationBatches" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "DistributionConfig" (portkey.aws/search-for-tag input "DistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar110378 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar110378 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar110378 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar110378 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar110378 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar110378 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar110378 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar110378 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar110474 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar110474 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar110474 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar110474 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar110474 ["Quantity" :content]))} (letvar110474 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar110474 ["NextMarker" :content]))) (letvar110474 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar110474 ["Items" :content]))))))

(clojure.core/defn- deser-lambda-function-association [input] (clojure.core/let [letvar110570 {"LambdaFunctionARN" (portkey.aws/search-for-tag input "LambdaFunctionARN" :flattened? false :xmlAttribute? nil), "EventType" (portkey.aws/search-for-tag input "EventType" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar110570 "LambdaFunctionARN") (clojure.core/assoc :lambda-function-arn (deserstring (clojure.core/get-in letvar110570 ["LambdaFunctionARN" :content]))) (letvar110570 "EventType") (clojure.core/assoc :event-type (deser-event-type (clojure.core/get-in letvar110570 ["EventType" :content]))))))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar110666 {"QueryString" (portkey.aws/search-for-tag input "QueryString" :flattened? false :xmlAttribute? nil), "Cookies" (portkey.aws/search-for-tag input "Cookies" :flattened? false :xmlAttribute? nil), "Headers" (portkey.aws/search-for-tag input "Headers" :flattened? false :xmlAttribute? nil), "QueryStringCacheKeys" (portkey.aws/search-for-tag input "QueryStringCacheKeys" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar110666 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar110666 ["Cookies" :content]))} (letvar110666 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar110666 ["Headers" :content]))) (letvar110666 "QueryStringCacheKeys") (clojure.core/assoc :query-string-cache-keys (deser-query-string-cache-keys (clojure.core/get-in letvar110666 ["QueryStringCacheKeys" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar110762 {"Paths" (portkey.aws/search-for-tag input "Paths" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar110762 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar110762 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar110892 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar110892 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar110892 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar110892 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar110892 ["Quantity" :content]))} (letvar110892 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar110892 ["NextMarker" :content]))) (letvar110892 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar110892 ["Items" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar110993 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "StreamingDistributionConfig" (portkey.aws/search-for-tag input "StreamingDistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar110993 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar110993 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar110993 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar110993 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar110993 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar110993 ["StreamingDistributionConfig" :content]))} (letvar110993 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar110993 ["LastModifiedTime" :content]))))))

(clojure.core/defn- deser-lambda-function-associations [input] (clojure.core/let [letvar111089 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar111089 ["Quantity" :content]))} (letvar111089 "Items") (clojure.core/assoc :items (deser-lambda-function-association-list (clojure.core/get-in letvar111089 ["Items" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar111190 {"ErrorCode" (portkey.aws/search-for-tag input "ErrorCode" :flattened? false :xmlAttribute? nil), "ResponsePagePath" (portkey.aws/search-for-tag input "ResponsePagePath" :flattened? false :xmlAttribute? nil), "ResponseCode" (portkey.aws/search-for-tag input "ResponseCode" :flattened? false :xmlAttribute? nil), "ErrorCachingMinTTL" (portkey.aws/search-for-tag input "ErrorCachingMinTTL" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar111190 ["ErrorCode" :content]))} (letvar111190 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar111190 ["ResponsePagePath" :content]))) (letvar111190 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar111190 ["ResponseCode" :content]))) (letvar111190 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar111190 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar111303 {"AwsAccountNumber" (portkey.aws/search-for-tag input "AwsAccountNumber" :flattened? false :xmlAttribute? nil), "KeyPairIds" (portkey.aws/search-for-tag input "KeyPairIds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar111303 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar111303 ["AwsAccountNumber" :content]))) (letvar111303 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar111303 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar111418 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar111418 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar111418 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar111519 {"Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar111519 "Items") (clojure.core/assoc :items (deser-tag-list (clojure.core/get-in letvar111519 ["Items" :content]))))))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar111632 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar111632 ["Quantity" :content]))} (letvar111632 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar111632 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar111728 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "PathPattern" (portkey.aws/search-for-tag input "PathPattern" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar111728 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar111728 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar111728 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar111728 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar111728 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar111728 ["MinTTL" :content]))} (letvar111728 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar111728 ["SmoothStreaming" :content]))) (letvar111728 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar111728 ["Compress" :content]))) (letvar111728 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar111728 ["LambdaFunctionAssociations" :content]))) (letvar111728 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar111728 ["MaxTTL" :content]))) (letvar111728 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar111728 ["AllowedMethods" :content]))) (letvar111728 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar111728 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar111824 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar111824 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar111824 ["Quantity" :content]))} (letvar111824 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar111824 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar111920 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginPath" (portkey.aws/search-for-tag input "OriginPath" :flattened? false :xmlAttribute? nil), "CustomHeaders" (portkey.aws/search-for-tag input "CustomHeaders" :flattened? false :xmlAttribute? nil), "S3OriginConfig" (portkey.aws/search-for-tag input "S3OriginConfig" :flattened? false :xmlAttribute? nil), "CustomOriginConfig" (portkey.aws/search-for-tag input "CustomOriginConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar111920 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar111920 ["DomainName" :content]))} (letvar111920 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar111920 ["OriginPath" :content]))) (letvar111920 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar111920 ["CustomHeaders" :content]))) (letvar111920 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar111920 ["S3OriginConfig" :content]))) (letvar111920 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar111920 ["CustomOriginConfig" :content]))))))

(clojure.core/defn- desertimestamp [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar112018 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar112018 ["Quantity" :content]))} (letvar112018 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar112018 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar112114 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar112114 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar112114 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar112114 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar112114 ["Quantity" :content]))} (letvar112114 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar112114 ["NextMarker" :content]))) (letvar112114 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar112114 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar112210 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar112210 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar112210 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar112306 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar112306 ["Quantity" :content]))} (letvar112306 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar112306 ["Items" :content]))))))
...
(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar112407 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil), "CachedMethods" (portkey.aws/search-for-tag input "CachedMethods" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar112407 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar112407 ["Items" :content]))} (letvar112407 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar112407 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar112508 {"HTTPPort" (portkey.aws/search-for-tag input "HTTPPort" :flattened? false :xmlAttribute? nil), "HTTPSPort" (portkey.aws/search-for-tag input "HTTPSPort" :flattened? false :xmlAttribute? nil), "OriginProtocolPolicy" (portkey.aws/search-for-tag input "OriginProtocolPolicy" :flattened? false :xmlAttribute? nil), "OriginSslProtocols" (portkey.aws/search-for-tag input "OriginSslProtocols" :flattened? false :xmlAttribute? nil), "OriginReadTimeout" (portkey.aws/search-for-tag input "OriginReadTimeout" :flattened? false :xmlAttribute? nil), "OriginKeepaliveTimeout" (portkey.aws/search-for-tag input "OriginKeepaliveTimeout" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar112508 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar112508 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar112508 ["OriginProtocolPolicy" :content]))} (letvar112508 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar112508 ["OriginSslProtocols" :content]))) (letvar112508 "OriginReadTimeout") (clojure.core/assoc :origin-read-timeout (deserinteger (clojure.core/get-in letvar112508 ["OriginReadTimeout" :content]))) (letvar112508 "OriginKeepaliveTimeout") (clojure.core/assoc :origin-keepalive-timeout (deserinteger (clojure.core/get-in letvar112508 ["OriginKeepaliveTimeout" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar112604 {"DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar112604 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar112604 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar112700 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar112700 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar112700 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar112700 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar112700 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar112700 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar112700 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar112700 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar112700 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar112700 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar112700 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar112700 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar112796 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag input "CloudFrontOriginAccessIdentityConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar112796 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar112796 ["S3CanonicalUserId" :content]))} (letvar112796 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar112796 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar112926 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar112926 ["Quantity" :content]))} (letvar112926 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar112926 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar113022 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar113022 ["Quantity" :content]))} (letvar113022 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar113022 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar113118 {"DefaultRootObject" (portkey.aws/search-for-tag input "DefaultRootObject" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar113118 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar113118 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar113118 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar113118 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar113118 ["Enabled" :content]))} (letvar113118 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar113118 ["DefaultRootObject" :content]))) (letvar113118 "IsIPV6Enabled") (clojure.core/assoc :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar113118 ["IsIPV6Enabled" :content]))) (letvar113118 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar113118 ["Restrictions" :content]))) (letvar113118 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar113118 ["WebACLId" :content]))) (letvar113118 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar113118 ["Logging" :content]))) (letvar113118 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar113118 ["CacheBehaviors" :content]))) (letvar113118 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar113118 ["CustomErrorResponses" :content]))) (letvar113118 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar113118 ["Aliases" :content]))) (letvar113118 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar113118 ["PriceClass" :content]))) (letvar113118 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar113118 ["HttpVersion" :content]))) (letvar113118 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar113118 ["ViewerCertificate" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar113336 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar113336 ["Quantity" :content]))} (letvar113336 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar113336 ["Items" :content]))))))

(clojure.core/defn- deserinteger [input] (java.lang.Integer. (if (clojure.core/seq? input) (clojure.core/first input) input)))

(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar113434 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar113434 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar113434 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar113434 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar113547 {"HeaderName" (portkey.aws/search-for-tag input "HeaderName" :flattened? false :xmlAttribute? nil), "HeaderValue" (portkey.aws/search-for-tag input "HeaderValue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar113547 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar113547 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar113643 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar113643 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar113643 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar113643 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar113643 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar113643 ["Enabled" :content]))} (letvar113643 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar113643 ["Aliases" :content]))) (letvar113643 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar113643 ["Logging" :content]))) (letvar113643 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar113643 ["PriceClass" :content]))))))

(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar113739 {"OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar113739 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar113852 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar113852 ["Key" :content]))} (letvar113852 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar113852 ["Value" :content]))))))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar113948 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar113948 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar113948 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar113948 ["Prefix" :content]))})))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar114044 {"IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar114044 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar114044 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar114044 ["WebACLId" :content])), :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar114044 ["IsIPV6Enabled" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar114044 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar114044 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar114044 ["ViewerCertificate" :content])), :http-version (deser-http-version (clojure.core/get-in letvar114044 ["HttpVersion" :content])), :domain-name (deserstring (clojure.core/get-in letvar114044 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar114044 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar114044 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar114044 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar114044 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar114044 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar114044 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar114044 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar114044 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar114044 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar114162 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar114162 ["Quantity" :content]))} (letvar114162 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar114162 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar114263 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar114263 ["Quantity" :content]))} (letvar114263 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar114263 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar114376 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar114376 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar114376 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar114376 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar114376 ["Quantity" :content]))} (letvar114376 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar114376 ["NextMarker" :content]))) (letvar114376 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar114376 ["Items" :content]))))))
...
(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar114482 {"Forward" (portkey.aws/search-for-tag input "Forward" :flattened? false :xmlAttribute? nil), "WhitelistedNames" (portkey.aws/search-for-tag input "WhitelistedNames" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar114482 ["Forward" :content]))} (letvar114482 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar114482 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar114578 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar114578 ["Quantity" :content]))} (letvar114578 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar114578 ["Items" :content]))))))
...
(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar114691 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar114691 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar114691 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar114691 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar114691 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar114691 ["MinTTL" :content]))} (letvar114691 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar114691 ["SmoothStreaming" :content]))) (letvar114691 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar114691 ["Compress" :content]))) (letvar114691 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar114691 ["LambdaFunctionAssociations" :content]))) (letvar114691 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar114691 ["MaxTTL" :content]))) (letvar114691 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar114691 ["AllowedMethods" :content]))) (letvar114691 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar114691 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar114787 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar114787 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar114787 ["Quantity" :content]))} (letvar114787 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar114787 ["Items" :content]))))))

(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar114883 {"CloudFrontDefaultCertificate" (portkey.aws/search-for-tag input "CloudFrontDefaultCertificate" :flattened? false :xmlAttribute? nil), "IAMCertificateId" (portkey.aws/search-for-tag input "IAMCertificateId" :flattened? false :xmlAttribute? nil), "ACMCertificateArn" (portkey.aws/search-for-tag input "ACMCertificateArn" :flattened? false :xmlAttribute? nil), "SSLSupportMethod" (portkey.aws/search-for-tag input "SSLSupportMethod" :flattened? false :xmlAttribute? nil), "MinimumProtocolVersion" (portkey.aws/search-for-tag input "MinimumProtocolVersion" :flattened? false :xmlAttribute? nil), "Certificate" (portkey.aws/search-for-tag input "Certificate" :flattened? false :xmlAttribute? nil), "CertificateSource" (portkey.aws/search-for-tag input "CertificateSource" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar114883 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar114883 ["CloudFrontDefaultCertificate" :content]))) (letvar114883 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar114883 ["IAMCertificateId" :content]))) (letvar114883 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar114883 ["ACMCertificateArn" :content]))) (letvar114883 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar114883 ["SSLSupportMethod" :content]))) (letvar114883 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar114883 ["MinimumProtocolVersion" :content]))) (letvar114883 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar114883 ["Certificate" :content]))) (letvar114883 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar114883 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar114979 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar114979 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar114979 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar115075 {"RestrictionType" (portkey.aws/search-for-tag input "RestrictionType" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar115075 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar115075 ["Quantity" :content]))} (letvar115075 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar115075 ["Items" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-result [input] (clojure.core/let [rawinput115076 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115077 {"Tags" (portkey.aws/search-for-tag rawinput115076 "Tags" :flattened? false)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar115077 ["Tags" :content]))})))

(clojure.core/defn- response-too-many-distributions-with-lambda-associations [input] (clojure.core/let [rawinput115078 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115079 {"Message" (portkey.aws/search-for-tag rawinput115078 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115079 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115079 ["Message" :content]))))))

(clojure.core/defn- response-no-such-origin [input] (clojure.core/let [rawinput115080 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115081 {"Message" (portkey.aws/search-for-tag rawinput115080 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115081 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115081 ["Message" :content]))))))

(clojure.core/defn- response-invalid-protocol-settings [input] (clojure.core/let [rawinput115082 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115083 {"Message" (portkey.aws/search-for-tag rawinput115082 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115083 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115083 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cookie-names-in-white-list [input] (clojure.core/let [rawinput115084 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115085 {"Message" (portkey.aws/search-for-tag rawinput115084 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115085 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115085 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cache-behaviors [input] (clojure.core/let [rawinput115086 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115087 {"Message" (portkey.aws/search-for-tag rawinput115086 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115087 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115087 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origin-custom-headers [input] (clojure.core/let [rawinput115088 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115089 {"Message" (portkey.aws/search-for-tag rawinput115088 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115089 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115089 ["Message" :content]))))))

(clojure.core/defn- response-too-many-streaming-distributions [input] (clojure.core/let [rawinput115090 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115091 {"Message" (portkey.aws/search-for-tag rawinput115090 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115091 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115091 ["Message" :content]))))))

(clojure.core/defn- response-get-streaming-distribution-result [input] (clojure.core/let [rawinput115092 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115093 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput115092 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115093 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar115093 ["StreamingDistribution" :content]))) (letvar115093 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115093 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [rawinput115094 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115095 {"Message" (portkey.aws/search-for-tag rawinput115094 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115095 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115095 ["Message" :content]))))))

(clojure.core/defn- response-invalid-viewer-certificate [input] (clojure.core/let [rawinput115096 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115097 {"Message" (portkey.aws/search-for-tag rawinput115096 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115097 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115097 ["Message" :content]))))))

(clojure.core/defn- response-invalid-argument [input] (clojure.core/let [rawinput115098 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115099 {"Message" (portkey.aws/search-for-tag rawinput115098 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115099 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115099 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-not-disabled [input] (clojure.core/let [rawinput115100 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115101 {"Message" (portkey.aws/search-for-tag rawinput115100 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115101 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115101 ["Message" :content]))))))

(clojure.core/defn- response-too-many-certificates [input] (clojure.core/let [rawinput115102 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115103 {"Message" (portkey.aws/search-for-tag rawinput115102 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115103 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115103 ["Message" :content]))))))

(clojure.core/defn- response-access-denied [input] (clojure.core/let [rawinput115104 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115105 {"Message" (portkey.aws/search-for-tag rawinput115104 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115105 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115105 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [rawinput115106 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115107 {"Message" (portkey.aws/search-for-tag rawinput115106 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115107 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115107 ["Message" :content]))))))

(clojure.core/defn- response-invalid-lambda-function-association [input] (clojure.core/let [rawinput115108 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115109 {"Message" (portkey.aws/search-for-tag rawinput115108 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115109 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115109 ["Message" :content]))))))

(clojure.core/defn- response-no-such-resource [input] (clojure.core/let [rawinput115110 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115111 {"Message" (portkey.aws/search-for-tag rawinput115110 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115111 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115111 ["Message" :content]))))))

(clojure.core/defn- response-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput115112 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115113 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput115112 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115113 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar115113 ["CloudFrontOriginAccessIdentity" :content]))) (letvar115113 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115113 ["ETag"]))))))

(clojure.core/defn- response-invalid-error-code [input] (clojure.core/let [rawinput115114 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115115 {"Message" (portkey.aws/search-for-tag rawinput115114 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115115 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115115 ["Message" :content]))))))

(clojure.core/defn- response-too-many-lambda-function-associations [input] (clojure.core/let [rawinput115116 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115117 {"Message" (portkey.aws/search-for-tag rawinput115116 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115117 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115117 ["Message" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-result [input] (clojure.core/let [rawinput115118 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115119 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput115118 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115119 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar115119 ["StreamingDistribution" :content]))) (letvar115119 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115119 ["Location"]))) (letvar115119 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115119 ["ETag"]))))))

(clojure.core/defn- response-invalid-relative-path [input] (clojure.core/let [rawinput115120 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115121 {"Message" (portkey.aws/search-for-tag rawinput115120 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115121 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115121 ["Message" :content]))))))

(clojure.core/defn- response-invalid-location-code [input] (clojure.core/let [rawinput115122 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115123 {"Message" (portkey.aws/search-for-tag rawinput115122 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115123 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115123 ["Message" :content]))))))

(clojure.core/defn- response-invalid-web-acl-id [input] (clojure.core/let [rawinput115124 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115125 {"Message" (portkey.aws/search-for-tag rawinput115124 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115125 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115125 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin [input] (clojure.core/let [rawinput115126 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115127 {"Message" (portkey.aws/search-for-tag rawinput115126 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115127 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115127 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [rawinput115128 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115129 {"Message" (portkey.aws/search-for-tag rawinput115128 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115129 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115129 ["Message" :content]))))))

(clojure.core/defn- response-update-distribution-result [input] (clojure.core/let [rawinput115130 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115131 {"Distribution" (portkey.aws/search-for-tag rawinput115130 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115131 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar115131 ["Distribution" :content]))) (letvar115131 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115131 ["ETag"]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput115132 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115133 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput115132 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115133 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar115133 ["CloudFrontOriginAccessIdentity" :content]))) (letvar115133 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115133 ["ETag"]))))))

(clojure.core/defn- response-invalid-query-string-parameters [input] (clojure.core/let [rawinput115134 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115135 {"Message" (portkey.aws/search-for-tag rawinput115134 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115135 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115135 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origins [input] (clojure.core/let [rawinput115136 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115137 {"Message" (portkey.aws/search-for-tag rawinput115136 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115137 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115137 ["Message" :content]))))))

(clojure.core/defn- response-invalid-ttl-order [input] (clojure.core/let [rawinput115138 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115139 {"Message" (portkey.aws/search-for-tag rawinput115138 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115139 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115139 ["Message" :content]))))))

(clojure.core/defn- response-no-such-streaming-distribution [input] (clojure.core/let [rawinput115140 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115141 {"Message" (portkey.aws/search-for-tag rawinput115140 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115141 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115141 ["Message" :content]))))))

(clojure.core/defn- response-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput115142 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115143 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput115142 "CloudFrontOriginAccessIdentity" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115143 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar115143 ["CloudFrontOriginAccessIdentity" :content]))) (letvar115143 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115143 ["Location"]))) (letvar115143 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115143 ["ETag"]))))))

(clojure.core/defn- response-cname-already-exists [input] (clojure.core/let [rawinput115144 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115145 {"Message" (portkey.aws/search-for-tag rawinput115144 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115145 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115145 ["Message" :content]))))))

(clojure.core/defn- response-invalid-default-root-object [input] (clojure.core/let [rawinput115146 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115147 {"Message" (portkey.aws/search-for-tag rawinput115146 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115147 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115147 ["Message" :content]))))))

(clojure.core/defn- response-invalid-response-code [input] (clojure.core/let [rawinput115148 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115149 {"Message" (portkey.aws/search-for-tag rawinput115148 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115149 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115149 ["Message" :content]))))))

(clojure.core/defn- response-no-such-invalidation [input] (clojure.core/let [rawinput115150 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115151 {"Message" (portkey.aws/search-for-tag rawinput115150 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115151 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115151 ["Message" :content]))))))

(clojure.core/defn- response-too-many-invalidations-in-progress [input] (clojure.core/let [rawinput115152 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115153 {"Message" (portkey.aws/search-for-tag rawinput115152 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115153 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115153 ["Message" :content]))))))

(clojure.core/defn- response-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [rawinput115154 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115155 {"CloudFrontOriginAccessIdentityList" (portkey.aws/search-for-tag rawinput115154 "CloudFrontOriginAccessIdentityList" :flattened? false)}] (clojure.core/cond-> {} (letvar115155 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar115155 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- response-invalid-forward-cookies [input] (clojure.core/let [rawinput115156 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115157 {"Message" (portkey.aws/search-for-tag rawinput115156 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115157 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115157 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-config-result [input] (clojure.core/let [rawinput115158 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115159 {"DistributionConfig" (portkey.aws/search-for-tag rawinput115158 "DistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115159 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar115159 ["DistributionConfig" :content]))) (letvar115159 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115159 ["ETag"]))))))

(clojure.core/defn- response-invalid-required-protocol [input] (clojure.core/let [rawinput115160 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115161 {"Message" (portkey.aws/search-for-tag rawinput115160 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115161 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115161 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-result [input] (clojure.core/let [rawinput115162 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115163 {"Distribution" (portkey.aws/search-for-tag rawinput115162 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115163 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar115163 ["Distribution" :content]))) (letvar115163 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115163 ["ETag"]))))))

(clojure.core/defn- response-get-streaming-distribution-config-result [input] (clojure.core/let [rawinput115164 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115165 {"StreamingDistributionConfig" (portkey.aws/search-for-tag rawinput115164 "StreamingDistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115165 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar115165 ["StreamingDistributionConfig" :content]))) (letvar115165 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115165 ["ETag"]))))))

(clojure.core/defn- response-invalid-headers-for-s-3-origin [input] (clojure.core/let [rawinput115166 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115167 {"Message" (portkey.aws/search-for-tag rawinput115166 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115167 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115167 ["Message" :content]))))))

(clojure.core/defn- response-too-many-distribution-cnam-es [input] (clojure.core/let [rawinput115168 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115169 {"Message" (portkey.aws/search-for-tag rawinput115168 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115169 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115169 ["Message" :content]))))))

(clojure.core/defn- response-invalid-geo-restriction-parameter [input] (clojure.core/let [rawinput115170 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115171 {"Message" (portkey.aws/search-for-tag rawinput115170 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115171 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115171 ["Message" :content]))))))

(clojure.core/defn- response-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [rawinput115172 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115173 {"Message" (portkey.aws/search-for-tag rawinput115172 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115173 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115173 ["Message" :content]))))))

(clojure.core/defn- response-list-invalidations-result [input] (clojure.core/let [rawinput115174 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115175 {"InvalidationList" (portkey.aws/search-for-tag rawinput115174 "InvalidationList" :flattened? false)}] (clojure.core/cond-> {} (letvar115175 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar115175 ["InvalidationList" :content]))))))

(clojure.core/defn- response-batch-too-large [input] (clojure.core/let [rawinput115176 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115177 {"Message" (portkey.aws/search-for-tag rawinput115176 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115177 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115177 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-with-tags-result [input] (clojure.core/let [rawinput115178 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115179 {"Distribution" (portkey.aws/search-for-tag rawinput115178 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115179 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar115179 ["Distribution" :content]))) (letvar115179 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115179 ["Location"]))) (letvar115179 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115179 ["ETag"]))))))

(clojure.core/defn- response-list-streaming-distributions-result [input] (clojure.core/let [rawinput115180 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115181 {"StreamingDistributionList" (portkey.aws/search-for-tag rawinput115180 "StreamingDistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar115181 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar115181 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-with-tags-result [input] (clojure.core/let [rawinput115182 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115183 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput115182 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115183 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar115183 ["StreamingDistribution" :content]))) (letvar115183 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115183 ["Location"]))) (letvar115183 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115183 ["ETag"]))))))

(clojure.core/defn- response-create-invalidation-result [input] (clojure.core/let [rawinput115184 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115185 {"Location" (clojure.core/get-in input [:headers "Location"]), "Invalidation" (portkey.aws/search-for-tag rawinput115184 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar115185 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115185 ["Location"]))) (letvar115185 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar115185 ["Invalidation" :content]))))))

(clojure.core/defn- response-missing-body [input] (clojure.core/let [rawinput115186 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115187 {"Message" (portkey.aws/search-for-tag rawinput115186 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115187 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115187 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-read-timeout [input] (clojure.core/let [rawinput115188 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115189 {"Message" (portkey.aws/search-for-tag rawinput115188 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115189 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115189 ["Message" :content]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [rawinput115190 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115191 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag rawinput115190 "CloudFrontOriginAccessIdentityConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115191 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar115191 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar115191 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115191 ["ETag"]))))))

(clojure.core/defn- response-distribution-not-disabled [input] (clojure.core/let [rawinput115192 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115193 {"Message" (portkey.aws/search-for-tag rawinput115192 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115193 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115193 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [rawinput115194 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115195 {"Message" (portkey.aws/search-for-tag rawinput115194 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115195 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115195 ["Message" :content]))))))

(clojure.core/defn- response-precondition-failed [input] (clojure.core/let [rawinput115196 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115197 {"Message" (portkey.aws/search-for-tag rawinput115196 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115197 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115197 ["Message" :content]))))))

(clojure.core/defn- response-distribution-already-exists [input] (clojure.core/let [rawinput115198 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115199 {"Message" (portkey.aws/search-for-tag rawinput115198 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115199 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115199 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-access-identity [input] (clojure.core/let [rawinput115200 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115201 {"Message" (portkey.aws/search-for-tag rawinput115200 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115201 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115201 ["Message" :content]))))))

(clojure.core/defn- response-too-many-trusted-signers [input] (clojure.core/let [rawinput115202 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115203 {"Message" (portkey.aws/search-for-tag rawinput115202 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115203 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115203 ["Message" :content]))))))

(clojure.core/defn- response-invalid-minimum-protocol-version [input] (clojure.core/let [rawinput115204 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115205 {"Message" (portkey.aws/search-for-tag rawinput115204 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115205 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115205 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-already-exists [input] (clojure.core/let [rawinput115206 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115207 {"Message" (portkey.aws/search-for-tag rawinput115206 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115207 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115207 ["Message" :content]))))))

(clojure.core/defn- response-invalid-if-match-version [input] (clojure.core/let [rawinput115208 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115209 {"Message" (portkey.aws/search-for-tag rawinput115208 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115209 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115209 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-result [input] (clojure.core/let [rawinput115210 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115211 {"Distribution" (portkey.aws/search-for-tag rawinput115210 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115211 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar115211 ["Distribution" :content]))) (letvar115211 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar115211 ["Location"]))) (letvar115211 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115211 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions [input] (clojure.core/let [rawinput115212 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115213 {"Message" (portkey.aws/search-for-tag rawinput115212 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115213 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115213 ["Message" :content]))))))

(clojure.core/defn- response-no-such-distribution [input] (clojure.core/let [rawinput115214 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115215 {"Message" (portkey.aws/search-for-tag rawinput115214 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115215 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115215 ["Message" :content]))))))

(clojure.core/defn- response-update-streaming-distribution-result [input] (clojure.core/let [rawinput115216 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115217 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput115216 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar115217 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar115217 ["StreamingDistribution" :content]))) (letvar115217 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar115217 ["ETag"]))))))

(clojure.core/defn- response-illegal-update [input] (clojure.core/let [rawinput115218 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115219 {"Message" (portkey.aws/search-for-tag rawinput115218 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115219 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115219 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-keepalive-timeout [input] (clojure.core/let [rawinput115220 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115221 {"Message" (portkey.aws/search-for-tag rawinput115220 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115221 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115221 ["Message" :content]))))))

(clojure.core/defn- response-inconsistent-quantities [input] (clojure.core/let [rawinput115222 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115223 {"Message" (portkey.aws/search-for-tag rawinput115222 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115223 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115223 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-by-web-acl-id-result [input] (clojure.core/let [rawinput115224 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115225 {"DistributionList" (portkey.aws/search-for-tag rawinput115224 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar115225 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar115225 ["DistributionList" :content]))))))

(clojure.core/defn- response-too-many-query-string-parameters [input] (clojure.core/let [rawinput115226 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115227 {"Message" (portkey.aws/search-for-tag rawinput115226 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115227 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115227 ["Message" :content]))))))

(clojure.core/defn- response-invalid-tagging [input] (clojure.core/let [rawinput115228 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115229 {"Message" (portkey.aws/search-for-tag rawinput115228 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115229 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115229 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-result [input] (clojure.core/let [rawinput115230 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115231 {"DistributionList" (portkey.aws/search-for-tag rawinput115230 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar115231 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar115231 ["DistributionList" :content]))))))

(clojure.core/defn- response-trusted-signer-does-not-exist [input] (clojure.core/let [rawinput115232 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115233 {"Message" (portkey.aws/search-for-tag rawinput115232 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115233 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115233 ["Message" :content]))))))

(clojure.core/defn- response-resource-in-use [input] (clojure.core/let [rawinput115234 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115235 {"Message" (portkey.aws/search-for-tag rawinput115234 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115235 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115235 ["Message" :content]))))))

(clojure.core/defn- response-get-invalidation-result [input] (clojure.core/let [rawinput115236 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115237 {"Invalidation" (portkey.aws/search-for-tag rawinput115236 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar115237 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar115237 ["Invalidation" :content]))))))

(clojure.core/defn- response-too-many-headers-in-forwarded-values [input] (clojure.core/let [rawinput115238 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar115239 {"Message" (portkey.aws/search-for-tag rawinput115238 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar115239 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar115239 ["Message" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-03-25/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 1 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 128)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-03-25/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 0 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 256)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2017-03-25/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__22929__auto__))))
