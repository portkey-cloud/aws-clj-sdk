...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/marker (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/max-items (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-request (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/webaclid] :opt-un [:portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/marker :portkey.aws.cloudfront.-2016-09-07.list-distributions-by-webaclid-request/max-items]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/streaming-distribution :portkey.aws.cloudfront.-2016-09-07.get-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.too-many-streaming-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.too-many-streaming-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.list-tags-for-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/viewer-protocol-policy #{"allow-all" :https-only :redirect-to-https :allow-all "https-only" "redirect-to-https"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.update-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/update-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2016-09-07.update-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 1 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 128)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/streaming-distribution :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-result/location :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/long))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.invalid-webaclid/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/invalid-webaclid (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.invalid-webaclid/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.update-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/update-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution :portkey.aws.cloudfront.-2016-09-07.update-distribution-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2016-09-07.get-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.custom-origin-config/httpport (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/integer))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.custom-origin-config/httpsport (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/integer))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/custom-origin-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.custom-origin-config/httpport :portkey.aws.cloudfront.-2016-09-07.custom-origin-config/httpsport :portkey.aws.cloudfront.-2016-09-07/origin-protocol-policy] :opt-un [:portkey.aws.cloudfront.-2016-09-07/origin-ssl-protocols]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.invalidttlorder/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/invalidttlorder (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.invalidttlorder/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.s3-origin/domain-name (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.s3-origin/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/s3-origin (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.s3-origin/domain-name :portkey.aws.cloudfront.-2016-09-07.s3-origin/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.create-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/create-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity :portkey.aws.cloudfront.-2016-09-07.create-cloud-front-origin-access-identity-result/location :portkey.aws.cloudfront.-2016-09-07.create-cloud-front-origin-access-identity-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.cnamealready-exists/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.cnamealready-exists/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/streaming-distribution-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/id :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/arn :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/status :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/last-modified-time :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/domain-name :portkey.aws.cloudfront.-2016-09-07/s3-origin :portkey.aws.cloudfront.-2016-09-07/aliases :portkey.aws.cloudfront.-2016-09-07/trusted-signers :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/comment :portkey.aws.cloudfront.-2016-09-07/price-class :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-summary/enabled] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity/id :portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity/s3-canonical-user-id] :opt-un [:portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity-config]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.tag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.distribution-config/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/distribution-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.distribution-config/caller-reference :portkey.aws.cloudfront.-2016-09-07/origins :portkey.aws.cloudfront.-2016-09-07/default-cache-behavior :portkey.aws.cloudfront.-2016-09-07.distribution-config/comment :portkey.aws.cloudfront.-2016-09-07.distribution-config/enabled] :opt-un [:portkey.aws.cloudfront.-2016-09-07.distribution-config/default-root-object :portkey.aws.cloudfront.-2016-09-07/restrictions :portkey.aws.cloudfront.-2016-09-07.distribution-config/webaclid :portkey.aws.cloudfront.-2016-09-07.distribution-config/logging :portkey.aws.cloudfront.-2016-09-07/cache-behaviors :portkey.aws.cloudfront.-2016-09-07/custom-error-responses :portkey.aws.cloudfront.-2016-09-07/aliases :portkey.aws.cloudfront.-2016-09-07/price-class :portkey.aws.cloudfront.-2016-09-07/http-version :portkey.aws.cloudfront.-2016-09-07/viewer-certificate]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution-config :portkey.aws.cloudfront.-2016-09-07.get-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 0 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 256)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution :portkey.aws.cloudfront.-2016-09-07.get-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-streaming-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/streaming-distribution-config :portkey.aws.cloudfront.-2016-09-07.get-streaming-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/origin-protocol-policy #{"match-viewer" :https-only "https-only" :match-viewer "http-only" :http-only})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.invalid-headers-fors3-origin/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/invalid-headers-fors3-origin (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.invalid-headers-fors3-origin/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.too-many-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/too-many-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.too-many-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.create-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/create-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution :portkey.aws.cloudfront.-2016-09-07.create-distribution-with-tags-result/location :portkey.aws.cloudfront.-2016-09-07.create-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/streaming-distribution :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-with-tags-result/location :portkey.aws.cloudfront.-2016-09-07.create-streaming-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity-summary/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity-summary/id :portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity-summary/s3-canonical-user-id :portkey.aws.cloudfront.-2016-09-07.cloud-front-origin-access-identity-summary/comment] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.get-cloud-front-origin-access-identity-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity-config :portkey.aws.cloudfront.-2016-09-07.get-cloud-front-origin-access-identity-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/streaming-distribution-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.streaming-distribution-config/caller-reference :portkey.aws.cloudfront.-2016-09-07/s3-origin :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-config/comment :portkey.aws.cloudfront.-2016-09-07/trusted-signers :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-config/enabled] :opt-un [:portkey.aws.cloudfront.-2016-09-07/aliases :portkey.aws.cloudfront.-2016-09-07.streaming-distribution-config/logging :portkey.aws.cloudfront.-2016-09-07/price-class]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.s3-origin-config/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/s3-origin-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.s3-origin-config/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.distribution-summary/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/minimum-protocol-version #{:sslv3 "TLSv1" "SSLv3" :tlsv1})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.create-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/create-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution :portkey.aws.cloudfront.-2016-09-07.create-distribution-result/location :portkey.aws.cloudfront.-2016-09-07.create-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/resourcearn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.update-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/update-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/streaming-distribution :portkey.aws.cloudfront.-2016-09-07.update-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/sslsupport-method #{"sni-only" :sni-only :vip "vip"})

(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/http-version #{"http2" :http1.1 :http2 "http1.1"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07/distribution-list]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.untag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/maxttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/defaultttl (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/default-cache-behavior (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/target-origin-id :portkey.aws.cloudfront.-2016-09-07/forwarded-values :portkey.aws.cloudfront.-2016-09-07/trusted-signers :portkey.aws.cloudfront.-2016-09-07/viewer-protocol-policy :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/minttl] :opt-un [:portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/smooth-streaming :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/compress :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/maxttl :portkey.aws.cloudfront.-2016-09-07/allowed-methods :portkey.aws.cloudfront.-2016-09-07.default-cache-behavior/defaultttl]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.viewer-certificate/iamcertificate-id (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07.viewer-certificate/acmcertificate-arn (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/viewer-certificate (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.-2016-09-07.viewer-certificate/cloud-front-default-certificate :portkey.aws.cloudfront.-2016-09-07.viewer-certificate/iamcertificate-id :portkey.aws.cloudfront.-2016-09-07.viewer-certificate/acmcertificate-arn :portkey.aws.cloudfront.-2016-09-07/sslsupport-method :portkey.aws.cloudfront.-2016-09-07/minimum-protocol-version :portkey.aws.cloudfront.-2016-09-07.viewer-certificate/certificate :portkey.aws.cloudfront.-2016-09-07/certificate-source]))
...
(clojure.core/defn tag-resource2016-09-07 ([tag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-tag-resource-request tag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/tagging?Operation=Tag", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/tag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2016-09-07/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2016-09-07/no-such-resource}})))))
(clojure.spec.alpha/fdef tag-resource2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/tag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-distribution2016-09-07 ([get-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-request get-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-distribution-result))

(clojure.core/defn create-streaming-distribution-with-tags2016-09-07 ([create-streaming-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-with-tags-request create-streaming-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution?WithTags", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidOrigin" :portkey.aws.cloudfront.-2016-09-07/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "InvalidTagging" :portkey.aws.cloudfront.-2016-09-07/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution-with-tags2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-with-tags-result))

(clojure.core/defn update-distribution2016-09-07 ([update-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-distribution-request update-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/update-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/update-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchOrigin" :portkey.aws.cloudfront.-2016-09-07/no-such-origin, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2016-09-07/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2016-09-07/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2016-09-07/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2016-09-07/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "TooManyCertificates" :portkey.aws.cloudfront.-2016-09-07/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidErrorCode" :portkey.aws.cloudfront.-2016-09-07/invalid-error-code, "InvalidRelativePath" :portkey.aws.cloudfront.-2016-09-07/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2016-09-07/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2016-09-07/invalid-webaclid, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2016-09-07/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2016-09-07/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2016-09-07/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2016-09-07/invalid-response-code, "InvalidForwardCookies" :portkey.aws.cloudfront.-2016-09-07/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2016-09-07/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2016-09-07/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2016-09-07/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-minimum-protocol-version, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "IllegalUpdate" :portkey.aws.cloudfront.-2016-09-07/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2016-09-07/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef update-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/update-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/update-distribution-result))

(clojure.core/defn delete-streaming-distribution2016-09-07 ([delete-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-streaming-distribution-request delete-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/delete-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "StreamingDistributionNotDisabled" :portkey.aws.cloudfront.-2016-09-07/streaming-distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-streaming-distribution, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-streaming-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/delete-streaming-distribution-request) :ret clojure.core/true?)

(clojure.core/defn delete-cloud-front-origin-access-identity2016-09-07 ([delete-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-cloud-front-origin-access-identity-request delete-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/delete-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed, "CloudFrontOriginAccessIdentityInUse" :portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity-in-use}})))))
(clojure.spec.alpha/fdef delete-cloud-front-origin-access-identity2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/delete-cloud-front-origin-access-identity-request) :ret clojure.core/true?)

(clojure.core/defn create-distribution-with-tags2016-09-07 ([create-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-with-tags-request create-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution?WithTags", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"NoSuchOrigin" :portkey.aws.cloudfront.-2016-09-07/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2016-09-07/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2016-09-07/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2016-09-07/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2016-09-07/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2016-09-07/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "TooManyCertificates" :portkey.aws.cloudfront.-2016-09-07/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidErrorCode" :portkey.aws.cloudfront.-2016-09-07/invalid-error-code, "InvalidRelativePath" :portkey.aws.cloudfront.-2016-09-07/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2016-09-07/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2016-09-07/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront.-2016-09-07/invalid-origin, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2016-09-07/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2016-09-07/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2016-09-07/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2016-09-07/invalid-response-code, "InvalidForwardCookies" :portkey.aws.cloudfront.-2016-09-07/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2016-09-07/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2016-09-07/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2016-09-07/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2016-09-07/too-many-distributions, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/too-many-query-string-parameters, "InvalidTagging" :portkey.aws.cloudfront.-2016-09-07/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2016-09-07/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution-with-tags2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-distribution-with-tags-result))

(clojure.core/defn get-invalidation2016-09-07 ([get-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-invalidation-request get-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{DistributionId}/invalidation/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchInvalidation" :portkey.aws.cloudfront.-2016-09-07/no-such-invalidation, "NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-invalidation2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-invalidation-result))

(clojure.core/defn create-streaming-distribution2016-09-07 ([create-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-request create-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidOrigin" :portkey.aws.cloudfront.-2016-09-07/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-streaming-distribution-result))

(clojure.core/defn list-tags-for-resource2016-09-07 ([list-tags-for-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-tags-for-resource-request list-tags-for-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-tags-for-resource-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/tagging", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-tags-for-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2016-09-07/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2016-09-07/no-such-resource}})))))
(clojure.spec.alpha/fdef list-tags-for-resource2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/list-tags-for-resource-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-tags-for-resource-result))

(clojure.core/defn get-streaming-distribution2016-09-07 ([get-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-request get-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-result))

(clojure.core/defn create-distribution2016-09-07 ([create-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-request create-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"NoSuchOrigin" :portkey.aws.cloudfront.-2016-09-07/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront.-2016-09-07/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront.-2016-09-07/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront.-2016-09-07/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront.-2016-09-07/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront.-2016-09-07/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "TooManyCertificates" :portkey.aws.cloudfront.-2016-09-07/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidErrorCode" :portkey.aws.cloudfront.-2016-09-07/invalid-error-code, "InvalidRelativePath" :portkey.aws.cloudfront.-2016-09-07/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront.-2016-09-07/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront.-2016-09-07/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront.-2016-09-07/invalid-origin, "InvalidQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront.-2016-09-07/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront.-2016-09-07/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront.-2016-09-07/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront.-2016-09-07/invalid-response-code, "InvalidForwardCookies" :portkey.aws.cloudfront.-2016-09-07/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront.-2016-09-07/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront.-2016-09-07/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront.-2016-09-07/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "DistributionAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront.-2016-09-07/too-many-distributions, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront.-2016-09-07/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront.-2016-09-07/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-distribution-result))

(clojure.core/defn get-streaming-distribution-config2016-09-07 ([get-streaming-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-config-request get-streaming-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution-config2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-streaming-distribution-config-result))

(clojure.core/defn list-distributions2016-09-07 ([] (list-distributions2016-09-07 {})) ([list-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-request list-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument}})))))
(clojure.spec.alpha/fdef list-distributions2016-09-07 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2016-09-07/list-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-distributions-result))

(clojure.core/defn get-cloud-front-origin-access-identity-config2016-09-07 ([get-cloud-front-origin-access-identity-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-config-request get-cloud-front-origin-access-identity-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity-config2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-config-result))

(clojure.core/defn list-invalidations2016-09-07 ([list-invalidations-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-invalidations-request list-invalidations-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-invalidations-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-invalidations-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef list-invalidations2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/list-invalidations-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-invalidations-result))

(clojure.core/defn untag-resource2016-09-07 ([untag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-untag-resource-request untag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/tagging?Operation=Untag", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/untag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront.-2016-09-07/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront.-2016-09-07/no-such-resource}})))))
(clojure.spec.alpha/fdef untag-resource2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/untag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-cloud-front-origin-access-identity2016-09-07 ([get-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-request get-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-cloud-front-origin-access-identity-result))

(clojure.core/defn update-cloud-front-origin-access-identity2016-09-07 ([update-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-cloud-front-origin-access-identity-request update-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/update-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/update-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "IllegalUpdate" :portkey.aws.cloudfront.-2016-09-07/illegal-update, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef update-cloud-front-origin-access-identity2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/update-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/update-cloud-front-origin-access-identity-result))

(clojure.core/defn update-streaming-distribution2016-09-07 ([update-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-streaming-distribution-request update-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/update-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/update-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront.-2016-09-07/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "NoSuchStreamingDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-streaming-distribution, "CNAMEAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront.-2016-09-07/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront.-2016-09-07/too-many-trusted-signers, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront.-2016-09-07/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront.-2016-09-07/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef update-streaming-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/update-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/update-streaming-distribution-result))

(clojure.core/defn get-distribution-config2016-09-07 ([get-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-config-request get-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/get-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{Id}/config", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/get-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution-config2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/get-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/get-distribution-config-result))

(clojure.core/defn list-cloud-front-origin-access-identities2016-09-07 ([] (list-cloud-front-origin-access-identities2016-09-07 {})) ([list-cloud-front-origin-access-identities-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-cloud-front-origin-access-identities-request list-cloud-front-origin-access-identities-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-cloud-front-origin-access-identities-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-cloud-front-origin-access-identities-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument}})))))
(clojure.spec.alpha/fdef list-cloud-front-origin-access-identities2016-09-07 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2016-09-07/list-cloud-front-origin-access-identities-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-cloud-front-origin-access-identities-result))

(clojure.core/defn list-streaming-distributions2016-09-07 ([] (list-streaming-distributions2016-09-07 {})) ([list-streaming-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-streaming-distributions-request list-streaming-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-streaming-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/streaming-distribution", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-streaming-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument}})))))
(clojure.spec.alpha/fdef list-streaming-distributions2016-09-07 :args (clojure.spec.alpha/? :portkey.aws.cloudfront.-2016-09-07/list-streaming-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-streaming-distributions-result))

(clojure.core/defn delete-distribution2016-09-07 ([delete-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-distribution-request delete-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{Id}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/delete-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "DistributionNotDisabled" :portkey.aws.cloudfront.-2016-09-07/distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront.-2016-09-07/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "PreconditionFailed" :portkey.aws.cloudfront.-2016-09-07/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-distribution2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/delete-distribution-request) :ret clojure.core/true?)

(clojure.core/defn create-invalidation2016-09-07 ([create-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-invalidation-request create-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront.-2016-09-07/access-denied, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront.-2016-09-07/no-such-distribution, "BatchTooLarge" :portkey.aws.cloudfront.-2016-09-07/batch-too-large, "TooManyInvalidationsInProgress" :portkey.aws.cloudfront.-2016-09-07/too-many-invalidations-in-progress, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-invalidation2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-invalidation-result))

(clojure.core/defn list-distributions-by-webaclid2016-09-07 ([list-distributions-by-webaclid-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-by-webaclid-request list-distributions-by-webaclid-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/distributionsByWebACLId/{WebACLId}", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InvalidWebACLId" :portkey.aws.cloudfront.-2016-09-07/invalid-webaclid}})))))
(clojure.spec.alpha/fdef list-distributions-by-webaclid2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/list-distributions-by-webaclid-result))

(clojure.core/defn create-cloud-front-origin-access-identity2016-09-07 ([create-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-cloud-front-origin-access-identity-request create-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront.-2016-09-07/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront.-2016-09-07/create-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2016-09-07/origin-access-identity/cloudfront", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloudfront.-2016-09-07/create-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"CloudFrontOriginAccessIdentityAlreadyExists" :portkey.aws.cloudfront.-2016-09-07/cloud-front-origin-access-identity-already-exists, "MissingBody" :portkey.aws.cloudfront.-2016-09-07/missing-body, "TooManyCloudFrontOriginAccessIdentities" :portkey.aws.cloudfront.-2016-09-07/too-many-cloud-front-origin-access-identities, "InvalidArgument" :portkey.aws.cloudfront.-2016-09-07/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront.-2016-09-07/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-cloud-front-origin-access-identity2016-09-07 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront.-2016-09-07/create-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront.-2016-09-07/create-cloud-front-origin-access-identity-result))
