...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar79828 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar79828 ["Quantity" :content]))} (letvar79828 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar79828 ["Items" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar79924 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "IncludeCookies" (portkey.aws/search-for-tag input "IncludeCookies" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar79924 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar79924 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar79924 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar79924 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar80020 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar80020 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar80020 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar80020 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar80133 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "InvalidationBatch" (portkey.aws/search-for-tag input "InvalidationBatch" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar80133 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar80133 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar80133 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar80133 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar80268 {"GeoRestriction" (portkey.aws/search-for-tag input "GeoRestriction" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar80268 ["GeoRestriction" :content]))})))

(clojure.core/defn- deserstring [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar80369 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "InProgressInvalidationBatches" (portkey.aws/search-for-tag input "InProgressInvalidationBatches" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "DistributionConfig" (portkey.aws/search-for-tag input "DistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar80369 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar80369 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar80369 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar80369 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar80369 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar80369 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar80369 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar80369 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar80465 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar80465 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar80465 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar80465 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar80465 ["Quantity" :content]))} (letvar80465 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar80465 ["NextMarker" :content]))) (letvar80465 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar80465 ["Items" :content]))))))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar80561 {"QueryString" (portkey.aws/search-for-tag input "QueryString" :flattened? false :xmlAttribute? nil), "Cookies" (portkey.aws/search-for-tag input "Cookies" :flattened? false :xmlAttribute? nil), "Headers" (portkey.aws/search-for-tag input "Headers" :flattened? false :xmlAttribute? nil), "QueryStringCacheKeys" (portkey.aws/search-for-tag input "QueryStringCacheKeys" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar80561 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar80561 ["Cookies" :content]))} (letvar80561 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar80561 ["Headers" :content]))) (letvar80561 "QueryStringCacheKeys") (clojure.core/assoc :query-string-cache-keys (deser-query-string-cache-keys (clojure.core/get-in letvar80561 ["QueryStringCacheKeys" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar80657 {"Paths" (portkey.aws/search-for-tag input "Paths" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar80657 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar80657 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar80787 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar80787 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar80787 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar80787 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar80787 ["Quantity" :content]))} (letvar80787 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar80787 ["NextMarker" :content]))) (letvar80787 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar80787 ["Items" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar80888 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "StreamingDistributionConfig" (portkey.aws/search-for-tag input "StreamingDistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar80888 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar80888 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar80888 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar80888 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar80888 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar80888 ["StreamingDistributionConfig" :content]))} (letvar80888 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar80888 ["LastModifiedTime" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar80989 {"ErrorCode" (portkey.aws/search-for-tag input "ErrorCode" :flattened? false :xmlAttribute? nil), "ResponsePagePath" (portkey.aws/search-for-tag input "ResponsePagePath" :flattened? false :xmlAttribute? nil), "ResponseCode" (portkey.aws/search-for-tag input "ResponseCode" :flattened? false :xmlAttribute? nil), "ErrorCachingMinTTL" (portkey.aws/search-for-tag input "ErrorCachingMinTTL" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar80989 ["ErrorCode" :content]))} (letvar80989 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar80989 ["ResponsePagePath" :content]))) (letvar80989 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar80989 ["ResponseCode" :content]))) (letvar80989 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar80989 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar81102 {"AwsAccountNumber" (portkey.aws/search-for-tag input "AwsAccountNumber" :flattened? false :xmlAttribute? nil), "KeyPairIds" (portkey.aws/search-for-tag input "KeyPairIds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar81102 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar81102 ["AwsAccountNumber" :content]))) (letvar81102 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar81102 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar81217 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar81217 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar81217 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar81318 {"Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar81318 "Items") (clojure.core/assoc :items (deser-tag-list (clojure.core/get-in letvar81318 ["Items" :content]))))))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar81431 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar81431 ["Quantity" :content]))} (letvar81431 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar81431 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar81527 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "PathPattern" (portkey.aws/search-for-tag input "PathPattern" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar81527 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar81527 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar81527 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar81527 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar81527 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar81527 ["MinTTL" :content]))} (letvar81527 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar81527 ["SmoothStreaming" :content]))) (letvar81527 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar81527 ["Compress" :content]))) (letvar81527 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar81527 ["MaxTTL" :content]))) (letvar81527 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar81527 ["AllowedMethods" :content]))) (letvar81527 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar81527 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar81623 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar81623 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar81623 ["Quantity" :content]))} (letvar81623 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar81623 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar81719 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginPath" (portkey.aws/search-for-tag input "OriginPath" :flattened? false :xmlAttribute? nil), "CustomHeaders" (portkey.aws/search-for-tag input "CustomHeaders" :flattened? false :xmlAttribute? nil), "S3OriginConfig" (portkey.aws/search-for-tag input "S3OriginConfig" :flattened? false :xmlAttribute? nil), "CustomOriginConfig" (portkey.aws/search-for-tag input "CustomOriginConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar81719 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar81719 ["DomainName" :content]))} (letvar81719 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar81719 ["OriginPath" :content]))) (letvar81719 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar81719 ["CustomHeaders" :content]))) (letvar81719 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar81719 ["S3OriginConfig" :content]))) (letvar81719 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar81719 ["CustomOriginConfig" :content]))))))

(clojure.core/defn- desertimestamp [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar81817 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar81817 ["Quantity" :content]))} (letvar81817 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar81817 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar81913 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar81913 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar81913 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar81913 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar81913 ["Quantity" :content]))} (letvar81913 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar81913 ["NextMarker" :content]))) (letvar81913 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar81913 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar82009 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar82009 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar82009 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar82105 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar82105 ["Quantity" :content]))} (letvar82105 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar82105 ["Items" :content]))))))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar82201 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil), "CachedMethods" (portkey.aws/search-for-tag input "CachedMethods" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar82201 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar82201 ["Items" :content]))} (letvar82201 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar82201 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar82302 {"HTTPPort" (portkey.aws/search-for-tag input "HTTPPort" :flattened? false :xmlAttribute? nil), "HTTPSPort" (portkey.aws/search-for-tag input "HTTPSPort" :flattened? false :xmlAttribute? nil), "OriginProtocolPolicy" (portkey.aws/search-for-tag input "OriginProtocolPolicy" :flattened? false :xmlAttribute? nil), "OriginSslProtocols" (portkey.aws/search-for-tag input "OriginSslProtocols" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar82302 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar82302 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar82302 ["OriginProtocolPolicy" :content]))} (letvar82302 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar82302 ["OriginSslProtocols" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar82398 {"DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar82398 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar82398 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar82494 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar82494 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar82494 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar82494 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar82494 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar82494 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar82494 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar82494 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar82494 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar82494 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar82494 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar82494 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar82590 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag input "CloudFrontOriginAccessIdentityConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar82590 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar82590 ["S3CanonicalUserId" :content]))} (letvar82590 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar82590 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar82720 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar82720 ["Quantity" :content]))} (letvar82720 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar82720 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar82816 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar82816 ["Quantity" :content]))} (letvar82816 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar82816 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar82912 {"DefaultRootObject" (portkey.aws/search-for-tag input "DefaultRootObject" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar82912 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar82912 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar82912 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar82912 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar82912 ["Enabled" :content]))} (letvar82912 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar82912 ["DefaultRootObject" :content]))) (letvar82912 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar82912 ["Restrictions" :content]))) (letvar82912 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar82912 ["WebACLId" :content]))) (letvar82912 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar82912 ["Logging" :content]))) (letvar82912 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar82912 ["CacheBehaviors" :content]))) (letvar82912 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar82912 ["CustomErrorResponses" :content]))) (letvar82912 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar82912 ["Aliases" :content]))) (letvar82912 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar82912 ["PriceClass" :content]))) (letvar82912 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar82912 ["HttpVersion" :content]))) (letvar82912 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar82912 ["ViewerCertificate" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar83130 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar83130 ["Quantity" :content]))} (letvar83130 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar83130 ["Items" :content]))))))

(clojure.core/defn- deserinteger [input] (java.lang.Integer. (if (clojure.core/seq? input) (clojure.core/first input) input)))

(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar83228 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar83228 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar83228 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar83228 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar83341 {"HeaderName" (portkey.aws/search-for-tag input "HeaderName" :flattened? false :xmlAttribute? nil), "HeaderValue" (portkey.aws/search-for-tag input "HeaderValue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar83341 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar83341 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar83437 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar83437 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar83437 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar83437 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar83437 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar83437 ["Enabled" :content]))} (letvar83437 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar83437 ["Aliases" :content]))) (letvar83437 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar83437 ["Logging" :content]))) (letvar83437 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar83437 ["PriceClass" :content]))))))

(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar83533 {"OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar83533 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar83646 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar83646 ["Key" :content]))} (letvar83646 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar83646 ["Value" :content]))))))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar83742 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar83742 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar83742 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar83742 ["Prefix" :content]))})))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar83838 {"Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar83838 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar83838 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar83838 ["WebACLId" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar83838 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar83838 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar83838 ["ViewerCertificate" :content])), :http-version (deser-http-version (clojure.core/get-in letvar83838 ["HttpVersion" :content])), :domain-name (deserstring (clojure.core/get-in letvar83838 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar83838 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar83838 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar83838 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar83838 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar83838 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar83838 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar83838 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar83838 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar83838 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar83939 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar83939 ["Quantity" :content]))} (letvar83939 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar83939 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar84040 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar84040 ["Quantity" :content]))} (letvar84040 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar84040 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar84153 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar84153 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar84153 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar84153 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar84153 ["Quantity" :content]))} (letvar84153 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar84153 ["NextMarker" :content]))) (letvar84153 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar84153 ["Items" :content]))))))
...
(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar84259 {"Forward" (portkey.aws/search-for-tag input "Forward" :flattened? false :xmlAttribute? nil), "WhitelistedNames" (portkey.aws/search-for-tag input "WhitelistedNames" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar84259 ["Forward" :content]))} (letvar84259 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar84259 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar84355 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar84355 ["Quantity" :content]))} (letvar84355 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar84355 ["Items" :content]))))))
...
(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar84468 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar84468 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar84468 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar84468 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar84468 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar84468 ["MinTTL" :content]))} (letvar84468 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar84468 ["SmoothStreaming" :content]))) (letvar84468 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar84468 ["Compress" :content]))) (letvar84468 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar84468 ["MaxTTL" :content]))) (letvar84468 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar84468 ["AllowedMethods" :content]))) (letvar84468 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar84468 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar84564 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar84564 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar84564 ["Quantity" :content]))} (letvar84564 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar84564 ["Items" :content]))))))

(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar84660 {"CloudFrontDefaultCertificate" (portkey.aws/search-for-tag input "CloudFrontDefaultCertificate" :flattened? false :xmlAttribute? nil), "IAMCertificateId" (portkey.aws/search-for-tag input "IAMCertificateId" :flattened? false :xmlAttribute? nil), "ACMCertificateArn" (portkey.aws/search-for-tag input "ACMCertificateArn" :flattened? false :xmlAttribute? nil), "SSLSupportMethod" (portkey.aws/search-for-tag input "SSLSupportMethod" :flattened? false :xmlAttribute? nil), "MinimumProtocolVersion" (portkey.aws/search-for-tag input "MinimumProtocolVersion" :flattened? false :xmlAttribute? nil), "Certificate" (portkey.aws/search-for-tag input "Certificate" :flattened? false :xmlAttribute? nil), "CertificateSource" (portkey.aws/search-for-tag input "CertificateSource" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar84660 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar84660 ["CloudFrontDefaultCertificate" :content]))) (letvar84660 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar84660 ["IAMCertificateId" :content]))) (letvar84660 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar84660 ["ACMCertificateArn" :content]))) (letvar84660 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar84660 ["SSLSupportMethod" :content]))) (letvar84660 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar84660 ["MinimumProtocolVersion" :content]))) (letvar84660 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar84660 ["Certificate" :content]))) (letvar84660 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar84660 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar84756 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar84756 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar84756 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar84852 {"RestrictionType" (portkey.aws/search-for-tag input "RestrictionType" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar84852 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar84852 ["Quantity" :content]))} (letvar84852 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar84852 ["Items" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-result [input] (clojure.core/let [rawinput84853 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84854 {"Tags" (portkey.aws/search-for-tag rawinput84853 "Tags" :flattened? false)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar84854 ["Tags" :content]))})))

(clojure.core/defn- response-no-such-origin [input] (clojure.core/let [rawinput84855 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84856 {"Message" (portkey.aws/search-for-tag rawinput84855 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84856 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84856 ["Message" :content]))))))

(clojure.core/defn- response-invalid-protocol-settings [input] (clojure.core/let [rawinput84857 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84858 {"Message" (portkey.aws/search-for-tag rawinput84857 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84858 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84858 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cookie-names-in-white-list [input] (clojure.core/let [rawinput84859 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84860 {"Message" (portkey.aws/search-for-tag rawinput84859 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84860 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84860 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cache-behaviors [input] (clojure.core/let [rawinput84861 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84862 {"Message" (portkey.aws/search-for-tag rawinput84861 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84862 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84862 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origin-custom-headers [input] (clojure.core/let [rawinput84863 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84864 {"Message" (portkey.aws/search-for-tag rawinput84863 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84864 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84864 ["Message" :content]))))))

(clojure.core/defn- response-too-many-streaming-distributions [input] (clojure.core/let [rawinput84865 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84866 {"Message" (portkey.aws/search-for-tag rawinput84865 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84866 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84866 ["Message" :content]))))))

(clojure.core/defn- response-get-streaming-distribution-result [input] (clojure.core/let [rawinput84867 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84868 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput84867 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84868 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar84868 ["StreamingDistribution" :content]))) (letvar84868 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84868 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [rawinput84869 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84870 {"Message" (portkey.aws/search-for-tag rawinput84869 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84870 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84870 ["Message" :content]))))))

(clojure.core/defn- response-invalid-viewer-certificate [input] (clojure.core/let [rawinput84871 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84872 {"Message" (portkey.aws/search-for-tag rawinput84871 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84872 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84872 ["Message" :content]))))))

(clojure.core/defn- response-invalid-argument [input] (clojure.core/let [rawinput84873 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84874 {"Message" (portkey.aws/search-for-tag rawinput84873 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84874 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84874 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-not-disabled [input] (clojure.core/let [rawinput84875 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84876 {"Message" (portkey.aws/search-for-tag rawinput84875 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84876 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84876 ["Message" :content]))))))

(clojure.core/defn- response-too-many-certificates [input] (clojure.core/let [rawinput84877 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84878 {"Message" (portkey.aws/search-for-tag rawinput84877 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84878 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84878 ["Message" :content]))))))

(clojure.core/defn- response-access-denied [input] (clojure.core/let [rawinput84879 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84880 {"Message" (portkey.aws/search-for-tag rawinput84879 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84880 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84880 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [rawinput84881 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84882 {"Message" (portkey.aws/search-for-tag rawinput84881 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84882 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84882 ["Message" :content]))))))

(clojure.core/defn- response-no-such-resource [input] (clojure.core/let [rawinput84883 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84884 {"Message" (portkey.aws/search-for-tag rawinput84883 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84884 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84884 ["Message" :content]))))))

(clojure.core/defn- response-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput84885 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84886 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput84885 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84886 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar84886 ["CloudFrontOriginAccessIdentity" :content]))) (letvar84886 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84886 ["ETag"]))))))

(clojure.core/defn- response-invalid-error-code [input] (clojure.core/let [rawinput84887 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84888 {"Message" (portkey.aws/search-for-tag rawinput84887 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84888 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84888 ["Message" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-result [input] (clojure.core/let [rawinput84889 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84890 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput84889 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84890 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar84890 ["StreamingDistribution" :content]))) (letvar84890 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84890 ["Location"]))) (letvar84890 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84890 ["ETag"]))))))

(clojure.core/defn- response-invalid-relative-path [input] (clojure.core/let [rawinput84891 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84892 {"Message" (portkey.aws/search-for-tag rawinput84891 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84892 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84892 ["Message" :content]))))))

(clojure.core/defn- response-invalid-location-code [input] (clojure.core/let [rawinput84893 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84894 {"Message" (portkey.aws/search-for-tag rawinput84893 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84894 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84894 ["Message" :content]))))))

(clojure.core/defn- response-invalid-web-acl-id [input] (clojure.core/let [rawinput84895 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84896 {"Message" (portkey.aws/search-for-tag rawinput84895 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84896 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84896 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin [input] (clojure.core/let [rawinput84897 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84898 {"Message" (portkey.aws/search-for-tag rawinput84897 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84898 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84898 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [rawinput84899 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84900 {"Message" (portkey.aws/search-for-tag rawinput84899 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84900 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84900 ["Message" :content]))))))

(clojure.core/defn- response-update-distribution-result [input] (clojure.core/let [rawinput84901 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84902 {"Distribution" (portkey.aws/search-for-tag rawinput84901 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84902 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar84902 ["Distribution" :content]))) (letvar84902 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84902 ["ETag"]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput84903 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84904 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput84903 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84904 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar84904 ["CloudFrontOriginAccessIdentity" :content]))) (letvar84904 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84904 ["ETag"]))))))

(clojure.core/defn- response-invalid-query-string-parameters [input] (clojure.core/let [rawinput84905 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84906 {"Message" (portkey.aws/search-for-tag rawinput84905 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84906 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84906 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origins [input] (clojure.core/let [rawinput84907 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84908 {"Message" (portkey.aws/search-for-tag rawinput84907 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84908 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84908 ["Message" :content]))))))

(clojure.core/defn- response-invalid-ttl-order [input] (clojure.core/let [rawinput84909 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84910 {"Message" (portkey.aws/search-for-tag rawinput84909 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84910 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84910 ["Message" :content]))))))

(clojure.core/defn- response-no-such-streaming-distribution [input] (clojure.core/let [rawinput84911 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84912 {"Message" (portkey.aws/search-for-tag rawinput84911 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84912 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84912 ["Message" :content]))))))

(clojure.core/defn- response-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput84913 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84914 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput84913 "CloudFrontOriginAccessIdentity" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84914 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar84914 ["CloudFrontOriginAccessIdentity" :content]))) (letvar84914 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84914 ["Location"]))) (letvar84914 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84914 ["ETag"]))))))

(clojure.core/defn- response-cname-already-exists [input] (clojure.core/let [rawinput84915 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84916 {"Message" (portkey.aws/search-for-tag rawinput84915 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84916 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84916 ["Message" :content]))))))

(clojure.core/defn- response-invalid-default-root-object [input] (clojure.core/let [rawinput84917 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84918 {"Message" (portkey.aws/search-for-tag rawinput84917 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84918 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84918 ["Message" :content]))))))

(clojure.core/defn- response-invalid-response-code [input] (clojure.core/let [rawinput84919 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84920 {"Message" (portkey.aws/search-for-tag rawinput84919 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84920 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84920 ["Message" :content]))))))

(clojure.core/defn- response-no-such-invalidation [input] (clojure.core/let [rawinput84921 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84922 {"Message" (portkey.aws/search-for-tag rawinput84921 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84922 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84922 ["Message" :content]))))))

(clojure.core/defn- response-too-many-invalidations-in-progress [input] (clojure.core/let [rawinput84923 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84924 {"Message" (portkey.aws/search-for-tag rawinput84923 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84924 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84924 ["Message" :content]))))))

(clojure.core/defn- response-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [rawinput84925 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84926 {"CloudFrontOriginAccessIdentityList" (portkey.aws/search-for-tag rawinput84925 "CloudFrontOriginAccessIdentityList" :flattened? false)}] (clojure.core/cond-> {} (letvar84926 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar84926 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- response-invalid-forward-cookies [input] (clojure.core/let [rawinput84927 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84928 {"Message" (portkey.aws/search-for-tag rawinput84927 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84928 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84928 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-config-result [input] (clojure.core/let [rawinput84929 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84930 {"DistributionConfig" (portkey.aws/search-for-tag rawinput84929 "DistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84930 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar84930 ["DistributionConfig" :content]))) (letvar84930 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84930 ["ETag"]))))))

(clojure.core/defn- response-invalid-required-protocol [input] (clojure.core/let [rawinput84931 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84932 {"Message" (portkey.aws/search-for-tag rawinput84931 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84932 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84932 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-result [input] (clojure.core/let [rawinput84933 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84934 {"Distribution" (portkey.aws/search-for-tag rawinput84933 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84934 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar84934 ["Distribution" :content]))) (letvar84934 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84934 ["ETag"]))))))

(clojure.core/defn- response-get-streaming-distribution-config-result [input] (clojure.core/let [rawinput84935 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84936 {"StreamingDistributionConfig" (portkey.aws/search-for-tag rawinput84935 "StreamingDistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84936 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar84936 ["StreamingDistributionConfig" :content]))) (letvar84936 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84936 ["ETag"]))))))

(clojure.core/defn- response-invalid-headers-for-s-3-origin [input] (clojure.core/let [rawinput84937 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84938 {"Message" (portkey.aws/search-for-tag rawinput84937 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84938 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84938 ["Message" :content]))))))

(clojure.core/defn- response-too-many-distribution-cnam-es [input] (clojure.core/let [rawinput84939 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84940 {"Message" (portkey.aws/search-for-tag rawinput84939 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84940 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84940 ["Message" :content]))))))

(clojure.core/defn- response-invalid-geo-restriction-parameter [input] (clojure.core/let [rawinput84941 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84942 {"Message" (portkey.aws/search-for-tag rawinput84941 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84942 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84942 ["Message" :content]))))))

(clojure.core/defn- response-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [rawinput84943 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84944 {"Message" (portkey.aws/search-for-tag rawinput84943 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84944 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84944 ["Message" :content]))))))

(clojure.core/defn- response-list-invalidations-result [input] (clojure.core/let [rawinput84945 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84946 {"InvalidationList" (portkey.aws/search-for-tag rawinput84945 "InvalidationList" :flattened? false)}] (clojure.core/cond-> {} (letvar84946 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar84946 ["InvalidationList" :content]))))))

(clojure.core/defn- response-batch-too-large [input] (clojure.core/let [rawinput84947 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84948 {"Message" (portkey.aws/search-for-tag rawinput84947 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84948 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84948 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-with-tags-result [input] (clojure.core/let [rawinput84949 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84950 {"Distribution" (portkey.aws/search-for-tag rawinput84949 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84950 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar84950 ["Distribution" :content]))) (letvar84950 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84950 ["Location"]))) (letvar84950 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84950 ["ETag"]))))))

(clojure.core/defn- response-list-streaming-distributions-result [input] (clojure.core/let [rawinput84951 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84952 {"StreamingDistributionList" (portkey.aws/search-for-tag rawinput84951 "StreamingDistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar84952 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar84952 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-with-tags-result [input] (clojure.core/let [rawinput84953 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84954 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput84953 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84954 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar84954 ["StreamingDistribution" :content]))) (letvar84954 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84954 ["Location"]))) (letvar84954 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84954 ["ETag"]))))))

(clojure.core/defn- response-create-invalidation-result [input] (clojure.core/let [rawinput84955 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84956 {"Location" (clojure.core/get-in input [:headers "Location"]), "Invalidation" (portkey.aws/search-for-tag rawinput84955 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar84956 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84956 ["Location"]))) (letvar84956 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar84956 ["Invalidation" :content]))))))

(clojure.core/defn- response-missing-body [input] (clojure.core/let [rawinput84957 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84958 {"Message" (portkey.aws/search-for-tag rawinput84957 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84958 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84958 ["Message" :content]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [rawinput84959 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84960 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag rawinput84959 "CloudFrontOriginAccessIdentityConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84960 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar84960 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar84960 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84960 ["ETag"]))))))

(clojure.core/defn- response-distribution-not-disabled [input] (clojure.core/let [rawinput84961 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84962 {"Message" (portkey.aws/search-for-tag rawinput84961 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84962 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84962 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [rawinput84963 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84964 {"Message" (portkey.aws/search-for-tag rawinput84963 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84964 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84964 ["Message" :content]))))))

(clojure.core/defn- response-precondition-failed [input] (clojure.core/let [rawinput84965 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84966 {"Message" (portkey.aws/search-for-tag rawinput84965 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84966 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84966 ["Message" :content]))))))

(clojure.core/defn- response-distribution-already-exists [input] (clojure.core/let [rawinput84967 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84968 {"Message" (portkey.aws/search-for-tag rawinput84967 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84968 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84968 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-access-identity [input] (clojure.core/let [rawinput84969 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84970 {"Message" (portkey.aws/search-for-tag rawinput84969 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84970 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84970 ["Message" :content]))))))

(clojure.core/defn- response-too-many-trusted-signers [input] (clojure.core/let [rawinput84971 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84972 {"Message" (portkey.aws/search-for-tag rawinput84971 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84972 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84972 ["Message" :content]))))))

(clojure.core/defn- response-invalid-minimum-protocol-version [input] (clojure.core/let [rawinput84973 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84974 {"Message" (portkey.aws/search-for-tag rawinput84973 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84974 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84974 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-already-exists [input] (clojure.core/let [rawinput84975 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84976 {"Message" (portkey.aws/search-for-tag rawinput84975 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84976 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84976 ["Message" :content]))))))

(clojure.core/defn- response-invalid-if-match-version [input] (clojure.core/let [rawinput84977 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84978 {"Message" (portkey.aws/search-for-tag rawinput84977 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84978 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84978 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-result [input] (clojure.core/let [rawinput84979 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84980 {"Distribution" (portkey.aws/search-for-tag rawinput84979 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84980 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar84980 ["Distribution" :content]))) (letvar84980 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar84980 ["Location"]))) (letvar84980 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84980 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions [input] (clojure.core/let [rawinput84981 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84982 {"Message" (portkey.aws/search-for-tag rawinput84981 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84982 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84982 ["Message" :content]))))))

(clojure.core/defn- response-no-such-distribution [input] (clojure.core/let [rawinput84983 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84984 {"Message" (portkey.aws/search-for-tag rawinput84983 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84984 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84984 ["Message" :content]))))))

(clojure.core/defn- response-update-streaming-distribution-result [input] (clojure.core/let [rawinput84985 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84986 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput84985 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar84986 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar84986 ["StreamingDistribution" :content]))) (letvar84986 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar84986 ["ETag"]))))))

(clojure.core/defn- response-illegal-update [input] (clojure.core/let [rawinput84987 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84988 {"Message" (portkey.aws/search-for-tag rawinput84987 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84988 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84988 ["Message" :content]))))))

(clojure.core/defn- response-inconsistent-quantities [input] (clojure.core/let [rawinput84989 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84990 {"Message" (portkey.aws/search-for-tag rawinput84989 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84990 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84990 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-by-web-acl-id-result [input] (clojure.core/let [rawinput84991 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84992 {"DistributionList" (portkey.aws/search-for-tag rawinput84991 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar84992 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar84992 ["DistributionList" :content]))))))

(clojure.core/defn- response-too-many-query-string-parameters [input] (clojure.core/let [rawinput84993 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84994 {"Message" (portkey.aws/search-for-tag rawinput84993 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84994 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84994 ["Message" :content]))))))

(clojure.core/defn- response-invalid-tagging [input] (clojure.core/let [rawinput84995 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84996 {"Message" (portkey.aws/search-for-tag rawinput84995 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar84996 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar84996 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-result [input] (clojure.core/let [rawinput84997 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar84998 {"DistributionList" (portkey.aws/search-for-tag rawinput84997 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar84998 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar84998 ["DistributionList" :content]))))))

(clojure.core/defn- response-trusted-signer-does-not-exist [input] (clojure.core/let [rawinput84999 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar85000 {"Message" (portkey.aws/search-for-tag rawinput84999 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar85000 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar85000 ["Message" :content]))))))

(clojure.core/defn- response-get-invalidation-result [input] (clojure.core/let [rawinput85001 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar85002 {"Invalidation" (portkey.aws/search-for-tag rawinput85001 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar85002 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar85002 ["Invalidation" :content]))))))

(clojure.core/defn- response-too-many-headers-in-forwarded-values [input] (clojure.core/let [rawinput85003 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar85004 {"Message" (portkey.aws/search-for-tag rawinput85003 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar85004 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar85004 ["Message" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 1 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 128)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 0 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 256)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2016-09-07/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__22929__auto__))))
