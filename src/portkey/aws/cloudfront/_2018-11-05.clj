...
(clojure.core/defn- ser-origin-group-member [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "OriginGroupMember"}))
...
(clojure.core/defn- ser-content-type-profiles [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "ContentTypeProfiles"}))
...
(clojure.core/defn- ser-query-string-cache-keys [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "QueryStringCacheKeys"}))
...
(clojure.core/defn- ser-tag-key-list [input] #:http.request.field{:value (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (clojure.core/merge (ser coll) {}))) input), :shape "TagKeyList"})
...
(clojure.core/defn- ser-query-arg-profile-config [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "QueryArgProfileConfig"}))
...
(clojure.core/defn- ser-query-arg-profiles [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "QueryArgProfiles"}))
...
(clojure.core/defn- ser-origin-group-member-list [input] #:http.request.field{:value (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (clojure.core/merge (ser coll) {}))) input), :shape "OriginGroupMemberList"})
...
(clojure.core/defn- ser-tag [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "Tag"}))
...
(clojure.core/defn- ser-distribution-config-with-tags [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "DistributionConfigWithTags"}))
...
(clojure.core/defn- ser-origin-groups [input] (clojure.core/cond-> #:http.request.field{:value [], :shape "OriginGroups"}))
...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar151823 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar151823 ["Quantity" :content]))} (letvar151823 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar151823 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile [input] (clojure.core/let [letvar151991 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar152183 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "IncludeCookies" (portkey.aws/search-for-tag input "IncludeCookies" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar152183 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar152183 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar152183 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar152183 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar152379 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar152379 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar152379 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar152379 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar152597 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "InvalidationBatch" (portkey.aws/search-for-tag input "InvalidationBatch" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar152597 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar152597 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar152597 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar152597 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-field-patterns [input] (clojure.core/let [letvar152889 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar153067 {"GeoRestriction" (portkey.aws/search-for-tag input "GeoRestriction" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar153067 ["GeoRestriction" :content]))})))

(clojure.core/defn- deser-field-level-encryption-profile-config [input] (clojure.core/let [letvar153243 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deserstring [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-field-level-encryption-config [input] (clojure.core/let [letvar153436 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-field-level-encryption-profile [input] (clojure.core/let [letvar153654 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar153846 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "InProgressInvalidationBatches" (portkey.aws/search-for-tag input "InProgressInvalidationBatches" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "DistributionConfig" (portkey.aws/search-for-tag input "DistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar153846 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar153846 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar153846 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar153846 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar153846 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar153846 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar153846 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar153846 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar154049 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar154049 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar154049 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar154049 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar154049 ["Quantity" :content]))} (letvar154049 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar154049 ["NextMarker" :content]))) (letvar154049 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar154049 ["Items" :content]))))))

(clojure.core/defn- deser-query-arg-profile [input] (clojure.core/let [letvar154239 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-lambda-function-association [input] (clojure.core/let [letvar154425 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar154602 {"QueryString" (portkey.aws/search-for-tag input "QueryString" :flattened? false :xmlAttribute? nil), "Cookies" (portkey.aws/search-for-tag input "Cookies" :flattened? false :xmlAttribute? nil), "Headers" (portkey.aws/search-for-tag input "Headers" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar154602 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar154602 ["Cookies" :content]))} (letvar154602 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar154602 ["Headers" :content]))))))

(clojure.core/defn- deser-origin-group-members [input] (clojure.core/let [letvar154792 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar154972 {"Paths" (portkey.aws/search-for-tag input "Paths" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar154972 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar154972 ["CallerReference" :content]))})))

(clojure.core/defn- deser-origin-group-failover-criteria [input] (clojure.core/let [letvar155160 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar155434 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar155434 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar155434 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar155434 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar155434 ["Quantity" :content]))} (letvar155434 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar155434 ["NextMarker" :content]))) (letvar155434 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar155434 ["Items" :content]))))))

(clojure.core/defn- deser-public-key-config [input] (clojure.core/let [letvar155630 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-encryption-entity-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser coll))) input))

(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar155860 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "StreamingDistributionConfig" (portkey.aws/search-for-tag input "StreamingDistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar155860 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar155860 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar155860 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar155860 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar155860 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar155860 ["StreamingDistributionConfig" :content]))} (letvar155860 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar155860 ["LastModifiedTime" :content]))))))

(clojure.core/defn- deser-lambda-function-associations [input] (clojure.core/let [letvar156056 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-encryption-entities [input] (clojure.core/let [letvar156247 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-field-level-encryption-profile-summary [input] (clojure.core/let [letvar156445 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-content-type-profile-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser coll))) input))

(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar156655 {"ErrorCode" (portkey.aws/search-for-tag input "ErrorCode" :flattened? false :xmlAttribute? nil), "ResponsePagePath" (portkey.aws/search-for-tag input "ResponsePagePath" :flattened? false :xmlAttribute? nil), "ResponseCode" (portkey.aws/search-for-tag input "ResponseCode" :flattened? false :xmlAttribute? nil), "ErrorCachingMinTTL" (portkey.aws/search-for-tag input "ErrorCachingMinTTL" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar156655 ["ErrorCode" :content]))} (letvar156655 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar156655 ["ResponsePagePath" :content]))) (letvar156655 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar156655 ["ResponseCode" :content]))) (letvar156655 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar156655 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar156881 {"AwsAccountNumber" (portkey.aws/search-for-tag input "AwsAccountNumber" :flattened? false :xmlAttribute? nil), "KeyPairIds" (portkey.aws/search-for-tag input "KeyPairIds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar156881 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar156881 ["AwsAccountNumber" :content]))) (letvar156881 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar156881 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-list [input] (clojure.core/let [letvar157108 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-content-type-profile-config [input] (clojure.core/let [letvar157267 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar157448 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar157448 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar157448 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar157653 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar157938 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar157938 ["Quantity" :content]))} (letvar157938 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar157938 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar158130 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "PathPattern" (portkey.aws/search-for-tag input "PathPattern" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar158130 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar158130 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar158130 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar158130 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar158130 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar158130 ["MinTTL" :content]))} (letvar158130 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar158130 ["SmoothStreaming" :content]))) (letvar158130 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar158130 ["Compress" :content]))) (letvar158130 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar158130 ["MaxTTL" :content]))) (letvar158130 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar158130 ["AllowedMethods" :content]))) (letvar158130 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar158130 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar158322 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar158322 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar158322 ["Quantity" :content]))} (letvar158322 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar158322 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar158530 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginPath" (portkey.aws/search-for-tag input "OriginPath" :flattened? false :xmlAttribute? nil), "CustomHeaders" (portkey.aws/search-for-tag input "CustomHeaders" :flattened? false :xmlAttribute? nil), "S3OriginConfig" (portkey.aws/search-for-tag input "S3OriginConfig" :flattened? false :xmlAttribute? nil), "CustomOriginConfig" (portkey.aws/search-for-tag input "CustomOriginConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar158530 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar158530 ["DomainName" :content]))} (letvar158530 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar158530 ["OriginPath" :content]))) (letvar158530 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar158530 ["CustomHeaders" :content]))) (letvar158530 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar158530 ["S3OriginConfig" :content]))) (letvar158530 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar158530 ["CustomOriginConfig" :content]))))))

(clojure.core/defn- desertimestamp [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-format [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar158731 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar158731 ["Quantity" :content]))} (letvar158731 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar158731 ["Items" :content]))))))

(clojure.core/defn- deser-origin-group-member [input] (clojure.core/let [letvar158926 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar159103 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar159103 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar159103 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar159103 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar159103 ["Quantity" :content]))} (letvar159103 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar159103 ["NextMarker" :content]))) (letvar159103 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar159103 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar159296 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar159296 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar159296 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar159473 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar159473 ["Quantity" :content]))} (letvar159473 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar159473 ["Items" :content]))))))
...
(clojure.core/defn- deser-content-type-profiles [input] (clojure.core/let [letvar159685 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-encryption-entity [input] (clojure.core/let [letvar159861 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-lambda-function-arn [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar160056 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil), "CachedMethods" (portkey.aws/search-for-tag input "CachedMethods" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar160056 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar160056 ["Items" :content]))} (letvar160056 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar160056 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar160272 {"HTTPPort" (portkey.aws/search-for-tag input "HTTPPort" :flattened? false :xmlAttribute? nil), "HTTPSPort" (portkey.aws/search-for-tag input "HTTPSPort" :flattened? false :xmlAttribute? nil), "OriginProtocolPolicy" (portkey.aws/search-for-tag input "OriginProtocolPolicy" :flattened? false :xmlAttribute? nil), "OriginSslProtocols" (portkey.aws/search-for-tag input "OriginSslProtocols" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar160272 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar160272 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar160272 ["OriginProtocolPolicy" :content]))} (letvar160272 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar160272 ["OriginSslProtocols" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar160461 {"DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar160461 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar160461 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar160651 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar160651 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar160651 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar160651 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar160651 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar160651 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar160651 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar160651 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar160651 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar160651 ["LastModifiedTime" :content])), :price-class (deser-price-class (clojure.core/get-in letvar160651 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar160895 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag input "CloudFrontOriginAccessIdentityConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar160895 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar160895 ["S3CanonicalUserId" :content]))} (letvar160895 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar160895 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption [input] (clojure.core/let [letvar161203 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionConfig" (portkey.aws/search-for-tag input "FieldLevelEncryptionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar161203 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar161203 ["LastModifiedTime" :content])), :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar161203 ["FieldLevelEncryptionConfig" :content]))})))

(clojure.core/defn- deser-tag-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser-tag coll))) input))

(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar161435 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar161435 ["Quantity" :content]))} (letvar161435 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar161435 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar161623 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar161623 ["Quantity" :content]))} (letvar161623 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar161623 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar161809 {"DefaultRootObject" (portkey.aws/search-for-tag input "DefaultRootObject" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "OriginGroups" (portkey.aws/search-for-tag input "OriginGroups" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar161809 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar161809 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar161809 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar161809 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar161809 ["Enabled" :content]))} (letvar161809 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar161809 ["DefaultRootObject" :content]))) (letvar161809 "IsIPV6Enabled") (clojure.core/assoc :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar161809 ["IsIPV6Enabled" :content]))) (letvar161809 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar161809 ["Restrictions" :content]))) (letvar161809 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar161809 ["WebACLId" :content]))) (letvar161809 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar161809 ["Logging" :content]))) (letvar161809 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar161809 ["CacheBehaviors" :content]))) (letvar161809 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar161809 ["CustomErrorResponses" :content]))) (letvar161809 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar161809 ["Aliases" :content]))) (letvar161809 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar161809 ["PriceClass" :content]))) (letvar161809 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar161809 ["HttpVersion" :content]))) (letvar161809 "OriginGroups") (clojure.core/assoc :origin-groups (deser-origin-groups (clojure.core/get-in letvar161809 ["OriginGroups" :content]))) (letvar161809 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar161809 ["ViewerCertificate" :content]))))))

(clojure.core/defn- deser-public-key-summary [input] (clojure.core/let [letvar162006 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CreatedTime" (portkey.aws/search-for-tag input "CreatedTime" :flattened? false :xmlAttribute? nil), "EncodedKey" (portkey.aws/search-for-tag input "EncodedKey" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar162006 ["Id" :content])), :name (deserstring (clojure.core/get-in letvar162006 ["Name" :content])), :created-time (desertimestamp (clojure.core/get-in letvar162006 ["CreatedTime" :content])), :encoded-key (deserstring (clojure.core/get-in letvar162006 ["EncodedKey" :content]))} (letvar162006 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar162006 ["Comment" :content]))))))
...
(clojure.core/defn- deser-query-arg-profile-config [input] (clojure.core/let [letvar162374 {"ForwardWhenQueryArgProfileIsUnknown" (portkey.aws/search-for-tag input "ForwardWhenQueryArgProfileIsUnknown" :flattened? false :xmlAttribute? nil), "QueryArgProfiles" (portkey.aws/search-for-tag input "QueryArgProfiles" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward-when-query-arg-profile-is-unknown (deserboolean (clojure.core/get-in letvar162374 ["ForwardWhenQueryArgProfileIsUnknown" :content]))} (letvar162374 "QueryArgProfiles") (clojure.core/assoc :query-arg-profiles (deser-query-arg-profiles (clojure.core/get-in letvar162374 ["QueryArgProfiles" :content]))))))
...
(clojure.core/defn- deser-query-arg-profiles [input] (clojure.core/let [letvar162609 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar162609 ["Quantity" :content]))} (letvar162609 "Items") (clojure.core/assoc :items (deser-query-arg-profile-list (clojure.core/get-in letvar162609 ["Items" :content]))))))
...
(clojure.core/defn- deser-status-codes [input] (clojure.core/let [letvar162888 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar162888 ["Quantity" :content])), :items (deser-status-code-list (clojure.core/get-in letvar162888 ["Items" :content]))})))

(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar163081 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar163081 ["Quantity" :content]))} (letvar163081 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar163081 ["Items" :content]))))))
...
(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar163309 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar163309 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar163309 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar163309 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar163496 {"HeaderName" (portkey.aws/search-for-tag input "HeaderName" :flattened? false :xmlAttribute? nil), "HeaderValue" (portkey.aws/search-for-tag input "HeaderValue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar163496 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar163496 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar163592 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar163592 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar163592 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar163592 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar163592 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar163592 ["Enabled" :content]))} (letvar163592 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar163592 ["Aliases" :content]))) (letvar163592 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar163592 ["Logging" :content]))) (letvar163592 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar163592 ["PriceClass" :content]))))))
...
(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar163739 {"OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar163739 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar163895 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar163895 ["Key" :content]))} (letvar163895 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar163895 ["Value" :content]))))))

(clojure.core/defn- deser-origin-group [input] (clojure.core/let [letvar164091 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar164260 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar164260 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar164260 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar164260 ["Prefix" :content]))})))

(clojure.core/defn- deser-field-level-encryption-summary [input] (clojure.core/let [letvar164455 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar164648 {"Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar164648 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar164648 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar164648 ["WebACLId" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar164648 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar164648 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar164648 ["ViewerCertificate" :content])), :domain-name (deserstring (clojure.core/get-in letvar164648 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar164648 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar164648 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar164648 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar164648 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar164648 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar164648 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar164648 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar164648 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar164648 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-lambda-function-association-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser coll))) input))

(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar164878 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar164878 ["Quantity" :content]))} (letvar164878 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar164878 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar165087 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar165087 ["Quantity" :content]))} (letvar165087 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar165087 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar165318 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar165318 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar165318 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar165318 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar165318 ["Quantity" :content]))} (letvar165318 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar165318 ["NextMarker" :content]))) (letvar165318 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar165318 ["Items" :content]))))))
...
(clojure.core/defn- deser-http-version [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar165525 {"Forward" (portkey.aws/search-for-tag input "Forward" :flattened? false :xmlAttribute? nil), "WhitelistedNames" (portkey.aws/search-for-tag input "WhitelistedNames" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar165525 ["Forward" :content]))} (letvar165525 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar165525 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar165721 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar165721 ["Quantity" :content]))} (letvar165721 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar165721 ["Items" :content]))))))

(clojure.core/defn- deser-origin-groups [input] (clojure.core/let [letvar165905 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-public-key-list [input] (clojure.core/let [letvar166115 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar166316 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar166316 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar166316 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar166316 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar166316 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar166316 ["MinTTL" :content]))} (letvar166316 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar166316 ["SmoothStreaming" :content]))) (letvar166316 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar166316 ["Compress" :content]))) (letvar166316 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar166316 ["MaxTTL" :content]))) (letvar166316 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar166316 ["AllowedMethods" :content]))) (letvar166316 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar166316 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar166494 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar166494 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar166494 ["Quantity" :content]))} (letvar166494 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar166494 ["Items" :content]))))))

(clojure.core/defn- deser-field-level-encryption-list [input] (clojure.core/let [letvar166675 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-public-key [input] (clojure.core/let [letvar166862 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar167083 {"CloudFrontDefaultCertificate" (portkey.aws/search-for-tag input "CloudFrontDefaultCertificate" :flattened? false :xmlAttribute? nil), "IAMCertificateId" (portkey.aws/search-for-tag input "IAMCertificateId" :flattened? false :xmlAttribute? nil), "ACMCertificateArn" (portkey.aws/search-for-tag input "ACMCertificateArn" :flattened? false :xmlAttribute? nil), "SSLSupportMethod" (portkey.aws/search-for-tag input "SSLSupportMethod" :flattened? false :xmlAttribute? nil), "MinimumProtocolVersion" (portkey.aws/search-for-tag input "MinimumProtocolVersion" :flattened? false :xmlAttribute? nil), "Certificate" (portkey.aws/search-for-tag input "Certificate" :flattened? false :xmlAttribute? nil), "CertificateSource" (portkey.aws/search-for-tag input "CertificateSource" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167083 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar167083 ["CloudFrontDefaultCertificate" :content]))) (letvar167083 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar167083 ["IAMCertificateId" :content]))) (letvar167083 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar167083 ["ACMCertificateArn" :content]))) (letvar167083 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar167083 ["SSLSupportMethod" :content]))) (letvar167083 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar167083 ["MinimumProtocolVersion" :content]))) (letvar167083 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar167083 ["Certificate" :content]))) (letvar167083 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar167083 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar167268 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar167268 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar167268 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar167456 {"RestrictionType" (portkey.aws/search-for-tag input "RestrictionType" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar167456 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar167456 ["Quantity" :content]))} (letvar167456 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar167456 ["Items" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-result ([input] (response-list-tags-for-resource-result nil input)) ([resultWrapper167459 input] (clojure.core/let [rawinput167458 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167460 {"Tags" (portkey.aws/search-for-tag rawinput167458 "Tags" :flattened? false :result-wrapper resultWrapper167459)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar167460 ["Tags" :content]))}))))

(clojure.core/defn- response-too-many-distributions-with-lambda-associations ([input] (response-too-many-distributions-with-lambda-associations nil input)) ([resultWrapper167463 input] (clojure.core/let [rawinput167462 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167465 {"Message" (portkey.aws/search-for-tag rawinput167462 "Message" :flattened? false :result-wrapper resultWrapper167463)}] (clojure.core/cond-> {} (letvar167465 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167465 ["Message" :content])))))))

(clojure.core/defn- response-no-such-origin ([input] (response-no-such-origin nil input)) ([resultWrapper167468 input] (clojure.core/let [rawinput167467 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167469 {"Message" (portkey.aws/search-for-tag rawinput167467 "Message" :flattened? false :result-wrapper resultWrapper167468)}] (clojure.core/cond-> {} (letvar167469 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167469 ["Message" :content])))))))

(clojure.core/defn- response-invalid-protocol-settings ([input] (response-invalid-protocol-settings nil input)) ([resultWrapper167472 input] (clojure.core/let [rawinput167471 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167473 {"Message" (portkey.aws/search-for-tag rawinput167471 "Message" :flattened? false :result-wrapper resultWrapper167472)}] (clojure.core/cond-> {} (letvar167473 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167473 ["Message" :content])))))))

(clojure.core/defn- response-too-many-cookie-names-in-white-list ([input] (response-too-many-cookie-names-in-white-list nil input)) ([resultWrapper167475 input] (clojure.core/let [rawinput167474 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167476 {"Message" (portkey.aws/search-for-tag rawinput167474 "Message" :flattened? false :result-wrapper resultWrapper167475)}] (clojure.core/cond-> {} (letvar167476 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167476 ["Message" :content])))))))

(clojure.core/defn- response-too-many-cache-behaviors ([input] (response-too-many-cache-behaviors nil input)) ([resultWrapper167478 input] (clojure.core/let [rawinput167477 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167479 {"Message" (portkey.aws/search-for-tag rawinput167477 "Message" :flattened? false :result-wrapper resultWrapper167478)}] (clojure.core/cond-> {} (letvar167479 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167479 ["Message" :content])))))))

(clojure.core/defn- response-too-many-origin-custom-headers ([input] (response-too-many-origin-custom-headers nil input)) ([resultWrapper167481 input] (clojure.core/let [rawinput167480 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167482 {"Message" (portkey.aws/search-for-tag rawinput167480 "Message" :flattened? false :result-wrapper resultWrapper167481)}] (clojure.core/cond-> {} (letvar167482 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167482 ["Message" :content])))))))

(clojure.core/defn- response-create-field-level-encryption-config-result ([input] (response-create-field-level-encryption-config-result nil input)) ([resultWrapper167484 input] (clojure.core/let [rawinput167483 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167485 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput167483 "FieldLevelEncryption" :flattened? false :result-wrapper resultWrapper167484), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167485 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar167485 ["FieldLevelEncryption" :content]))) (letvar167485 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167485 ["Location"]))) (letvar167485 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167485 ["ETag"])))))))

(clojure.core/defn- response-too-many-streaming-distributions ([input] (response-too-many-streaming-distributions nil input)) ([resultWrapper167487 input] (clojure.core/let [rawinput167486 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167488 {"Message" (portkey.aws/search-for-tag rawinput167486 "Message" :flattened? false :result-wrapper resultWrapper167487)}] (clojure.core/cond-> {} (letvar167488 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167488 ["Message" :content])))))))

(clojure.core/defn- response-get-streaming-distribution-result ([input] (response-get-streaming-distribution-result nil input)) ([resultWrapper167491 input] (clojure.core/let [rawinput167490 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167492 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput167490 "StreamingDistribution" :flattened? false :result-wrapper resultWrapper167491), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167492 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar167492 ["StreamingDistribution" :content]))) (letvar167492 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167492 ["ETag"])))))))

(clojure.core/defn- response-too-many-streaming-distribution-cnam-es ([input] (response-too-many-streaming-distribution-cnam-es nil input)) ([resultWrapper167494 input] (clojure.core/let [rawinput167493 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167497 {"Message" (portkey.aws/search-for-tag rawinput167493 "Message" :flattened? false :result-wrapper resultWrapper167494)}] (clojure.core/cond-> {} (letvar167497 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167497 ["Message" :content])))))))

(clojure.core/defn- response-field-level-encryption-profile-already-exists ([input] (response-field-level-encryption-profile-already-exists nil input)) ([resultWrapper167502 input] (clojure.core/let [rawinput167501 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167503 {"Message" (portkey.aws/search-for-tag rawinput167501 "Message" :flattened? false :result-wrapper resultWrapper167502)}] (clojure.core/cond-> {} (letvar167503 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167503 ["Message" :content])))))))

(clojure.core/defn- response-invalid-viewer-certificate ([input] (response-invalid-viewer-certificate nil input)) ([resultWrapper167506 input] (clojure.core/let [rawinput167505 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167507 {"Message" (portkey.aws/search-for-tag rawinput167505 "Message" :flattened? false :result-wrapper resultWrapper167506)}] (clojure.core/cond-> {} (letvar167507 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167507 ["Message" :content])))))))

(clojure.core/defn- response-get-public-key-config-result ([input] (response-get-public-key-config-result nil input)) ([resultWrapper167509 input] (clojure.core/let [rawinput167508 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167510 {"PublicKeyConfig" (portkey.aws/search-for-tag rawinput167508 "PublicKeyConfig" :flattened? false :result-wrapper resultWrapper167509), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167510 "PublicKeyConfig") (clojure.core/assoc :public-key-config (deser-public-key-config (clojure.core/get-in letvar167510 ["PublicKeyConfig" :content]))) (letvar167510 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167510 ["ETag"])))))))

(clojure.core/defn- response-invalid-argument ([input] (response-invalid-argument nil input)) ([resultWrapper167517 input] (clojure.core/let [rawinput167516 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167518 {"Message" (portkey.aws/search-for-tag rawinput167516 "Message" :flattened? false :result-wrapper resultWrapper167517)}] (clojure.core/cond-> {} (letvar167518 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167518 ["Message" :content])))))))

(clojure.core/defn- response-no-such-public-key ([input] (response-no-such-public-key nil input)) ([resultWrapper167521 input] (clojure.core/let [rawinput167520 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167522 {"Message" (portkey.aws/search-for-tag rawinput167520 "Message" :flattened? false :result-wrapper resultWrapper167521)}] (clojure.core/cond-> {} (letvar167522 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167522 ["Message" :content])))))))

(clojure.core/defn- response-streaming-distribution-not-disabled ([input] (response-streaming-distribution-not-disabled nil input)) ([resultWrapper167526 input] (clojure.core/let [rawinput167525 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167527 {"Message" (portkey.aws/search-for-tag rawinput167525 "Message" :flattened? false :result-wrapper resultWrapper167526)}] (clojure.core/cond-> {} (letvar167527 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167527 ["Message" :content])))))))

(clojure.core/defn- response-illegal-field-level-encryption-config-association-with-cache-behavior ([input] (response-illegal-field-level-encryption-config-association-with-cache-behavior nil input)) ([resultWrapper167531 input] (clojure.core/let [rawinput167530 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167532 {"Message" (portkey.aws/search-for-tag rawinput167530 "Message" :flattened? false :result-wrapper resultWrapper167531)}] (clojure.core/cond-> {} (letvar167532 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167532 ["Message" :content])))))))

(clojure.core/defn- response-too-many-certificates ([input] (response-too-many-certificates nil input)) ([resultWrapper167535 input] (clojure.core/let [rawinput167534 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167536 {"Message" (portkey.aws/search-for-tag rawinput167534 "Message" :flattened? false :result-wrapper resultWrapper167535)}] (clojure.core/cond-> {} (letvar167536 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167536 ["Message" :content])))))))

(clojure.core/defn- response-access-denied ([input] (response-access-denied nil input)) ([resultWrapper167538 input] (clojure.core/let [rawinput167537 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167539 {"Message" (portkey.aws/search-for-tag rawinput167537 "Message" :flattened? false :result-wrapper resultWrapper167538)}] (clojure.core/cond-> {} (letvar167539 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167539 ["Message" :content])))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-in-use ([input] (response-cloud-front-origin-access-identity-in-use nil input)) ([resultWrapper167541 input] (clojure.core/let [rawinput167540 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167542 {"Message" (portkey.aws/search-for-tag rawinput167540 "Message" :flattened? false :result-wrapper resultWrapper167541)}] (clojure.core/cond-> {} (letvar167542 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167542 ["Message" :content])))))))

(clojure.core/defn- response-cannot-change-immutable-public-key-fields ([input] (response-cannot-change-immutable-public-key-fields nil input)) ([resultWrapper167545 input] (clojure.core/let [rawinput167544 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167546 {"Message" (portkey.aws/search-for-tag rawinput167544 "Message" :flattened? false :result-wrapper resultWrapper167545)}] (clojure.core/cond-> {} (letvar167546 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167546 ["Message" :content])))))))

(clojure.core/defn- response-field-level-encryption-profile-size-exceeded ([input] (response-field-level-encryption-profile-size-exceeded nil input)) ([resultWrapper167548 input] (clojure.core/let [rawinput167547 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167549 {"Message" (portkey.aws/search-for-tag rawinput167547 "Message" :flattened? false :result-wrapper resultWrapper167548)}] (clojure.core/cond-> {} (letvar167549 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167549 ["Message" :content])))))))

(clojure.core/defn- response-invalid-lambda-function-association ([input] (response-invalid-lambda-function-association nil input)) ([resultWrapper167551 input] (clojure.core/let [rawinput167550 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167552 {"Message" (portkey.aws/search-for-tag rawinput167550 "Message" :flattened? false :result-wrapper resultWrapper167551)}] (clojure.core/cond-> {} (letvar167552 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167552 ["Message" :content])))))))

(clojure.core/defn- response-create-field-level-encryption-profile-result ([input] (response-create-field-level-encryption-profile-result nil input)) ([resultWrapper167556 input] (clojure.core/let [rawinput167555 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167560 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput167555 "FieldLevelEncryptionProfile" :flattened? false :result-wrapper resultWrapper167556), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167560 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar167560 ["FieldLevelEncryptionProfile" :content]))) (letvar167560 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167560 ["Location"]))) (letvar167560 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167560 ["ETag"])))))))

(clojure.core/defn- response-get-field-level-encryption-profile-result ([input] (response-get-field-level-encryption-profile-result nil input)) ([resultWrapper167563 input] (clojure.core/let [rawinput167562 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167564 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput167562 "FieldLevelEncryptionProfile" :flattened? false :result-wrapper resultWrapper167563), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167564 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar167564 ["FieldLevelEncryptionProfile" :content]))) (letvar167564 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167564 ["ETag"])))))))

(clojure.core/defn- response-no-such-resource ([input] (response-no-such-resource nil input)) ([resultWrapper167567 input] (clojure.core/let [rawinput167566 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167568 {"Message" (portkey.aws/search-for-tag rawinput167566 "Message" :flattened? false :result-wrapper resultWrapper167567)}] (clojure.core/cond-> {} (letvar167568 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167568 ["Message" :content])))))))

(clojure.core/defn- response-update-cloud-front-origin-access-identity-result ([input] (response-update-cloud-front-origin-access-identity-result nil input)) ([resultWrapper167570 input] (clojure.core/let [rawinput167569 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167571 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput167569 "CloudFrontOriginAccessIdentity" :flattened? false :result-wrapper resultWrapper167570), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167571 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar167571 ["CloudFrontOriginAccessIdentity" :content]))) (letvar167571 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167571 ["ETag"])))))))

(clojure.core/defn- response-invalid-error-code ([input] (response-invalid-error-code nil input)) ([resultWrapper167578 input] (clojure.core/let [rawinput167577 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167580 {"Message" (portkey.aws/search-for-tag rawinput167577 "Message" :flattened? false :result-wrapper resultWrapper167578)}] (clojure.core/cond-> {} (letvar167580 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167580 ["Message" :content])))))))

(clojure.core/defn- response-field-level-encryption-profile-in-use ([input] (response-field-level-encryption-profile-in-use nil input)) ([resultWrapper167582 input] (clojure.core/let [rawinput167581 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167583 {"Message" (portkey.aws/search-for-tag rawinput167581 "Message" :flattened? false :result-wrapper resultWrapper167582)}] (clojure.core/cond-> {} (letvar167583 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167583 ["Message" :content])))))))

(clojure.core/defn- response-too-many-lambda-function-associations ([input] (response-too-many-lambda-function-associations nil input)) ([resultWrapper167586 input] (clojure.core/let [rawinput167585 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167587 {"Message" (portkey.aws/search-for-tag rawinput167585 "Message" :flattened? false :result-wrapper resultWrapper167586)}] (clojure.core/cond-> {} (letvar167587 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167587 ["Message" :content])))))))

(clojure.core/defn- response-create-streaming-distribution-result ([input] (response-create-streaming-distribution-result nil input)) ([resultWrapper167591 input] (clojure.core/let [rawinput167590 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167592 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput167590 "StreamingDistribution" :flattened? false :result-wrapper resultWrapper167591), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167592 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar167592 ["StreamingDistribution" :content]))) (letvar167592 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167592 ["Location"]))) (letvar167592 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167592 ["ETag"])))))))

(clojure.core/defn- response-too-many-field-level-encryption-profiles ([input] (response-too-many-field-level-encryption-profiles nil input)) ([resultWrapper167597 input] (clojure.core/let [rawinput167596 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167598 {"Message" (portkey.aws/search-for-tag rawinput167596 "Message" :flattened? false :result-wrapper resultWrapper167597)}] (clojure.core/cond-> {} (letvar167598 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167598 ["Message" :content])))))))

(clojure.core/defn- response-no-such-field-level-encryption-profile ([input] (response-no-such-field-level-encryption-profile nil input)) ([resultWrapper167601 input] (clojure.core/let [rawinput167600 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167603 {"Message" (portkey.aws/search-for-tag rawinput167600 "Message" :flattened? false :result-wrapper resultWrapper167601)}] (clojure.core/cond-> {} (letvar167603 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167603 ["Message" :content])))))))

(clojure.core/defn- response-invalid-relative-path ([input] (response-invalid-relative-path nil input)) ([resultWrapper167608 input] (clojure.core/let [rawinput167607 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167609 {"Message" (portkey.aws/search-for-tag rawinput167607 "Message" :flattened? false :result-wrapper resultWrapper167608)}] (clojure.core/cond-> {} (letvar167609 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167609 ["Message" :content])))))))

(clojure.core/defn- response-create-public-key-result ([input] (response-create-public-key-result nil input)) ([resultWrapper167612 input] (clojure.core/let [rawinput167611 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167613 {"PublicKey" (portkey.aws/search-for-tag rawinput167611 "PublicKey" :flattened? false :result-wrapper resultWrapper167612), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167613 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar167613 ["PublicKey" :content]))) (letvar167613 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167613 ["Location"]))) (letvar167613 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167613 ["ETag"])))))))

(clojure.core/defn- response-invalid-location-code ([input] (response-invalid-location-code nil input)) ([resultWrapper167615 input] (clojure.core/let [rawinput167614 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167616 {"Message" (portkey.aws/search-for-tag rawinput167614 "Message" :flattened? false :result-wrapper resultWrapper167615)}] (clojure.core/cond-> {} (letvar167616 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167616 ["Message" :content])))))))

(clojure.core/defn- response-invalid-web-acl-id ([input] (response-invalid-web-acl-id nil input)) ([resultWrapper167618 input] (clojure.core/let [rawinput167617 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167619 {"Message" (portkey.aws/search-for-tag rawinput167617 "Message" :flattened? false :result-wrapper resultWrapper167618)}] (clojure.core/cond-> {} (letvar167619 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167619 ["Message" :content])))))))

(clojure.core/defn- response-invalid-origin ([input] (response-invalid-origin nil input)) ([resultWrapper167626 input] (clojure.core/let [rawinput167625 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167627 {"Message" (portkey.aws/search-for-tag rawinput167625 "Message" :flattened? false :result-wrapper resultWrapper167626)}] (clojure.core/cond-> {} (letvar167627 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167627 ["Message" :content])))))))

(clojure.core/defn- response-too-many-cloud-front-origin-access-identities ([input] (response-too-many-cloud-front-origin-access-identities nil input)) ([resultWrapper167630 input] (clojure.core/let [rawinput167629 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167631 {"Message" (portkey.aws/search-for-tag rawinput167629 "Message" :flattened? false :result-wrapper resultWrapper167630)}] (clojure.core/cond-> {} (letvar167631 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167631 ["Message" :content])))))))

(clojure.core/defn- response-field-level-encryption-config-already-exists ([input] (response-field-level-encryption-config-already-exists nil input)) ([resultWrapper167633 input] (clojure.core/let [rawinput167632 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167634 {"Message" (portkey.aws/search-for-tag rawinput167632 "Message" :flattened? false :result-wrapper resultWrapper167633)}] (clojure.core/cond-> {} (letvar167634 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167634 ["Message" :content])))))))

(clojure.core/defn- response-no-such-field-level-encryption-config ([input] (response-no-such-field-level-encryption-config nil input)) ([resultWrapper167636 input] (clojure.core/let [rawinput167635 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167637 {"Message" (portkey.aws/search-for-tag rawinput167635 "Message" :flattened? false :result-wrapper resultWrapper167636)}] (clojure.core/cond-> {} (letvar167637 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167637 ["Message" :content])))))))

(clojure.core/defn- response-update-distribution-result ([input] (response-update-distribution-result nil input)) ([resultWrapper167639 input] (clojure.core/let [rawinput167638 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167644 {"Distribution" (portkey.aws/search-for-tag rawinput167638 "Distribution" :flattened? false :result-wrapper resultWrapper167639), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167644 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar167644 ["Distribution" :content]))) (letvar167644 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167644 ["ETag"])))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-result ([input] (response-get-cloud-front-origin-access-identity-result nil input)) ([resultWrapper167646 input] (clojure.core/let [rawinput167645 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167647 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput167645 "CloudFrontOriginAccessIdentity" :flattened? false :result-wrapper resultWrapper167646), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167647 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar167647 ["CloudFrontOriginAccessIdentity" :content]))) (letvar167647 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167647 ["ETag"])))))))

(clojure.core/defn- response-too-many-field-level-encryption-encryption-entities ([input] (response-too-many-field-level-encryption-encryption-entities nil input)) ([resultWrapper167649 input] (clojure.core/let [rawinput167648 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167652 {"Message" (portkey.aws/search-for-tag rawinput167648 "Message" :flattened? false :result-wrapper resultWrapper167649)}] (clojure.core/cond-> {} (letvar167652 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167652 ["Message" :content])))))))

(clojure.core/defn- response-get-field-level-encryption-result ([input] (response-get-field-level-encryption-result nil input)) ([resultWrapper167658 input] (clojure.core/let [rawinput167657 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167659 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput167657 "FieldLevelEncryption" :flattened? false :result-wrapper resultWrapper167658), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167659 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar167659 ["FieldLevelEncryption" :content]))) (letvar167659 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167659 ["ETag"])))))))

(clojure.core/defn- response-invalid-query-string-parameters ([input] (response-invalid-query-string-parameters nil input)) ([resultWrapper167661 input] (clojure.core/let [rawinput167660 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167662 {"Message" (portkey.aws/search-for-tag rawinput167660 "Message" :flattened? false :result-wrapper resultWrapper167661)}] (clojure.core/cond-> {} (letvar167662 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167662 ["Message" :content])))))))

(clojure.core/defn- response-public-key-already-exists ([input] (response-public-key-already-exists nil input)) ([resultWrapper167664 input] (clojure.core/let [rawinput167663 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167666 {"Message" (portkey.aws/search-for-tag rawinput167663 "Message" :flattened? false :result-wrapper resultWrapper167664)}] (clojure.core/cond-> {} (letvar167666 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167666 ["Message" :content])))))))

(clojure.core/defn- response-too-many-origins ([input] (response-too-many-origins nil input)) ([resultWrapper167668 input] (clojure.core/let [rawinput167667 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167670 {"Message" (portkey.aws/search-for-tag rawinput167667 "Message" :flattened? false :result-wrapper resultWrapper167668)}] (clojure.core/cond-> {} (letvar167670 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167670 ["Message" :content])))))))

(clojure.core/defn- response-invalid-ttl-order ([input] (response-invalid-ttl-order nil input)) ([resultWrapper167673 input] (clojure.core/let [rawinput167672 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167674 {"Message" (portkey.aws/search-for-tag rawinput167672 "Message" :flattened? false :result-wrapper resultWrapper167673)}] (clojure.core/cond-> {} (letvar167674 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167674 ["Message" :content])))))))

(clojure.core/defn- response-no-such-streaming-distribution ([input] (response-no-such-streaming-distribution nil input)) ([resultWrapper167676 input] (clojure.core/let [rawinput167675 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167677 {"Message" (portkey.aws/search-for-tag rawinput167675 "Message" :flattened? false :result-wrapper resultWrapper167676)}] (clojure.core/cond-> {} (letvar167677 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167677 ["Message" :content])))))))

(clojure.core/defn- response-create-cloud-front-origin-access-identity-result ([input] (response-create-cloud-front-origin-access-identity-result nil input)) ([resultWrapper167680 input] (clojure.core/let [rawinput167679 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167681 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput167679 "CloudFrontOriginAccessIdentity" :flattened? false :result-wrapper resultWrapper167680), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167681 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar167681 ["CloudFrontOriginAccessIdentity" :content]))) (letvar167681 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167681 ["Location"]))) (letvar167681 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167681 ["ETag"])))))))

(clojure.core/defn- response-cname-already-exists ([input] (response-cname-already-exists nil input)) ([resultWrapper167685 input] (clojure.core/let [rawinput167684 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167686 {"Message" (portkey.aws/search-for-tag rawinput167684 "Message" :flattened? false :result-wrapper resultWrapper167685)}] (clojure.core/cond-> {} (letvar167686 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167686 ["Message" :content])))))))

(clojure.core/defn- response-invalid-default-root-object ([input] (response-invalid-default-root-object nil input)) ([resultWrapper167692 input] (clojure.core/let [rawinput167691 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167693 {"Message" (portkey.aws/search-for-tag rawinput167691 "Message" :flattened? false :result-wrapper resultWrapper167692)}] (clojure.core/cond-> {} (letvar167693 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167693 ["Message" :content])))))))

(clojure.core/defn- response-invalid-response-code ([input] (response-invalid-response-code nil input)) ([resultWrapper167695 input] (clojure.core/let [rawinput167694 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167696 {"Message" (portkey.aws/search-for-tag rawinput167694 "Message" :flattened? false :result-wrapper resultWrapper167695)}] (clojure.core/cond-> {} (letvar167696 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167696 ["Message" :content])))))))

(clojure.core/defn- response-no-such-invalidation ([input] (response-no-such-invalidation nil input)) ([resultWrapper167699 input] (clojure.core/let [rawinput167698 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167700 {"Message" (portkey.aws/search-for-tag rawinput167698 "Message" :flattened? false :result-wrapper resultWrapper167699)}] (clojure.core/cond-> {} (letvar167700 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167700 ["Message" :content])))))))

(clojure.core/defn- response-too-many-invalidations-in-progress ([input] (response-too-many-invalidations-in-progress nil input)) ([resultWrapper167702 input] (clojure.core/let [rawinput167701 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167703 {"Message" (portkey.aws/search-for-tag rawinput167701 "Message" :flattened? false :result-wrapper resultWrapper167702)}] (clojure.core/cond-> {} (letvar167703 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167703 ["Message" :content])))))))

(clojure.core/defn- response-get-public-key-result ([input] (response-get-public-key-result nil input)) ([resultWrapper167705 input] (clojure.core/let [rawinput167704 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167706 {"PublicKey" (portkey.aws/search-for-tag rawinput167704 "PublicKey" :flattened? false :result-wrapper resultWrapper167705), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167706 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar167706 ["PublicKey" :content]))) (letvar167706 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167706 ["ETag"])))))))

(clojure.core/defn- response-too-many-distributions-associated-to-field-level-encryption-config ([input] (response-too-many-distributions-associated-to-field-level-encryption-config nil input)) ([resultWrapper167708 input] (clojure.core/let [rawinput167707 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167709 {"Message" (portkey.aws/search-for-tag rawinput167707 "Message" :flattened? false :result-wrapper resultWrapper167708)}] (clojure.core/cond-> {} (letvar167709 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167709 ["Message" :content])))))))

(clojure.core/defn- response-list-cloud-front-origin-access-identities-result ([input] (response-list-cloud-front-origin-access-identities-result nil input)) ([resultWrapper167711 input] (clojure.core/let [rawinput167710 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167712 {"CloudFrontOriginAccessIdentityList" (portkey.aws/search-for-tag rawinput167710 "CloudFrontOriginAccessIdentityList" :flattened? false :result-wrapper resultWrapper167711)}] (clojure.core/cond-> {} (letvar167712 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar167712 ["CloudFrontOriginAccessIdentityList" :content])))))))

(clojure.core/defn- response-update-public-key-result ([input] (response-update-public-key-result nil input)) ([resultWrapper167714 input] (clojure.core/let [rawinput167713 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167715 {"PublicKey" (portkey.aws/search-for-tag rawinput167713 "PublicKey" :flattened? false :result-wrapper resultWrapper167714), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167715 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar167715 ["PublicKey" :content]))) (letvar167715 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167715 ["ETag"])))))))

(clojure.core/defn- response-invalid-forward-cookies ([input] (response-invalid-forward-cookies nil input)) ([resultWrapper167717 input] (clojure.core/let [rawinput167716 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167718 {"Message" (portkey.aws/search-for-tag rawinput167716 "Message" :flattened? false :result-wrapper resultWrapper167717)}] (clojure.core/cond-> {} (letvar167718 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167718 ["Message" :content])))))))

(clojure.core/defn- response-get-distribution-config-result ([input] (response-get-distribution-config-result nil input)) ([resultWrapper167720 input] (clojure.core/let [rawinput167719 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167721 {"DistributionConfig" (portkey.aws/search-for-tag rawinput167719 "DistributionConfig" :flattened? false :result-wrapper resultWrapper167720), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167721 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar167721 ["DistributionConfig" :content]))) (letvar167721 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167721 ["ETag"])))))))

(clojure.core/defn- response-invalid-required-protocol ([input] (response-invalid-required-protocol nil input)) ([resultWrapper167723 input] (clojure.core/let [rawinput167722 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167724 {"Message" (portkey.aws/search-for-tag rawinput167722 "Message" :flattened? false :result-wrapper resultWrapper167723)}] (clojure.core/cond-> {} (letvar167724 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167724 ["Message" :content])))))))

(clojure.core/defn- response-update-field-level-encryption-config-result ([input] (response-update-field-level-encryption-config-result nil input)) ([resultWrapper167726 input] (clojure.core/let [rawinput167725 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167727 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput167725 "FieldLevelEncryption" :flattened? false :result-wrapper resultWrapper167726), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167727 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar167727 ["FieldLevelEncryption" :content]))) (letvar167727 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167727 ["ETag"])))))))

(clojure.core/defn- response-get-distribution-result ([input] (response-get-distribution-result nil input)) ([resultWrapper167729 input] (clojure.core/let [rawinput167728 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167730 {"Distribution" (portkey.aws/search-for-tag rawinput167728 "Distribution" :flattened? false :result-wrapper resultWrapper167729), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167730 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar167730 ["Distribution" :content]))) (letvar167730 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167730 ["ETag"])))))))

(clojure.core/defn- response-update-field-level-encryption-profile-result ([input] (response-update-field-level-encryption-profile-result nil input)) ([resultWrapper167732 input] (clojure.core/let [rawinput167731 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167733 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput167731 "FieldLevelEncryptionProfile" :flattened? false :result-wrapper resultWrapper167732), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167733 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar167733 ["FieldLevelEncryptionProfile" :content]))) (letvar167733 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167733 ["ETag"])))))))

(clojure.core/defn- response-get-streaming-distribution-config-result ([input] (response-get-streaming-distribution-config-result nil input)) ([resultWrapper167735 input] (clojure.core/let [rawinput167734 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167736 {"StreamingDistributionConfig" (portkey.aws/search-for-tag rawinput167734 "StreamingDistributionConfig" :flattened? false :result-wrapper resultWrapper167735), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167736 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar167736 ["StreamingDistributionConfig" :content]))) (letvar167736 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167736 ["ETag"])))))))

(clojure.core/defn- response-too-many-origin-groups-per-distribution ([input] (response-too-many-origin-groups-per-distribution nil input)) ([resultWrapper167738 input] (clojure.core/let [rawinput167737 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167739 {"Message" (portkey.aws/search-for-tag rawinput167737 "Message" :flattened? false :result-wrapper resultWrapper167738)}] (clojure.core/cond-> {} (letvar167739 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167739 ["Message" :content])))))))

(clojure.core/defn- response-list-public-keys-result ([input] (response-list-public-keys-result nil input)) ([resultWrapper167741 input] (clojure.core/let [rawinput167740 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167742 {"PublicKeyList" (portkey.aws/search-for-tag rawinput167740 "PublicKeyList" :flattened? false :result-wrapper resultWrapper167741)}] (clojure.core/cond-> {} (letvar167742 "PublicKeyList") (clojure.core/assoc :public-key-list (deser-public-key-list (clojure.core/get-in letvar167742 ["PublicKeyList" :content])))))))

(clojure.core/defn- response-invalid-headers-for-s-3-origin ([input] (response-invalid-headers-for-s-3-origin nil input)) ([resultWrapper167744 input] (clojure.core/let [rawinput167743 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167745 {"Message" (portkey.aws/search-for-tag rawinput167743 "Message" :flattened? false :result-wrapper resultWrapper167744)}] (clojure.core/cond-> {} (letvar167745 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167745 ["Message" :content])))))))

(clojure.core/defn- response-get-field-level-encryption-config-result ([input] (response-get-field-level-encryption-config-result nil input)) ([resultWrapper167747 input] (clojure.core/let [rawinput167746 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167748 {"FieldLevelEncryptionConfig" (portkey.aws/search-for-tag rawinput167746 "FieldLevelEncryptionConfig" :flattened? false :result-wrapper resultWrapper167747), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167748 "FieldLevelEncryptionConfig") (clojure.core/assoc :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar167748 ["FieldLevelEncryptionConfig" :content]))) (letvar167748 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167748 ["ETag"])))))))

(clojure.core/defn- response-too-many-field-level-encryption-configs ([input] (response-too-many-field-level-encryption-configs nil input)) ([resultWrapper167750 input] (clojure.core/let [rawinput167749 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167751 {"Message" (portkey.aws/search-for-tag rawinput167749 "Message" :flattened? false :result-wrapper resultWrapper167750)}] (clojure.core/cond-> {} (letvar167751 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167751 ["Message" :content])))))))

(clojure.core/defn- response-field-level-encryption-config-in-use ([input] (response-field-level-encryption-config-in-use nil input)) ([resultWrapper167753 input] (clojure.core/let [rawinput167752 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167755 {"Message" (portkey.aws/search-for-tag rawinput167752 "Message" :flattened? false :result-wrapper resultWrapper167753)}] (clojure.core/cond-> {} (letvar167755 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167755 ["Message" :content])))))))

(clojure.core/defn- response-too-many-distribution-cnam-es ([input] (response-too-many-distribution-cnam-es nil input)) ([resultWrapper167758 input] (clojure.core/let [rawinput167757 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167759 {"Message" (portkey.aws/search-for-tag rawinput167757 "Message" :flattened? false :result-wrapper resultWrapper167758)}] (clojure.core/cond-> {} (letvar167759 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167759 ["Message" :content])))))))

(clojure.core/defn- response-invalid-geo-restriction-parameter ([input] (response-invalid-geo-restriction-parameter nil input)) ([resultWrapper167761 input] (clojure.core/let [rawinput167760 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167762 {"Message" (portkey.aws/search-for-tag rawinput167760 "Message" :flattened? false :result-wrapper resultWrapper167761)}] (clojure.core/cond-> {} (letvar167762 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167762 ["Message" :content])))))))

(clojure.core/defn- response-no-such-cloud-front-origin-access-identity ([input] (response-no-such-cloud-front-origin-access-identity nil input)) ([resultWrapper167764 input] (clojure.core/let [rawinput167763 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167765 {"Message" (portkey.aws/search-for-tag rawinput167763 "Message" :flattened? false :result-wrapper resultWrapper167764)}] (clojure.core/cond-> {} (letvar167765 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167765 ["Message" :content])))))))

(clojure.core/defn- response-list-invalidations-result ([input] (response-list-invalidations-result nil input)) ([resultWrapper167767 input] (clojure.core/let [rawinput167766 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167768 {"InvalidationList" (portkey.aws/search-for-tag rawinput167766 "InvalidationList" :flattened? false :result-wrapper resultWrapper167767)}] (clojure.core/cond-> {} (letvar167768 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar167768 ["InvalidationList" :content])))))))

(clojure.core/defn- response-batch-too-large ([input] (response-batch-too-large nil input)) ([resultWrapper167770 input] (clojure.core/let [rawinput167769 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167771 {"Message" (portkey.aws/search-for-tag rawinput167769 "Message" :flattened? false :result-wrapper resultWrapper167770)}] (clojure.core/cond-> {} (letvar167771 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167771 ["Message" :content])))))))

(clojure.core/defn- response-create-distribution-with-tags-result ([input] (response-create-distribution-with-tags-result nil input)) ([resultWrapper167774 input] (clojure.core/let [rawinput167773 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167777 {"Distribution" (portkey.aws/search-for-tag rawinput167773 "Distribution" :flattened? false :result-wrapper resultWrapper167774), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167777 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar167777 ["Distribution" :content]))) (letvar167777 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167777 ["Location"]))) (letvar167777 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167777 ["ETag"])))))))

(clojure.core/defn- response-too-many-field-level-encryption-query-arg-profiles ([input] (response-too-many-field-level-encryption-query-arg-profiles nil input)) ([resultWrapper167781 input] (clojure.core/let [rawinput167780 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167782 {"Message" (portkey.aws/search-for-tag rawinput167780 "Message" :flattened? false :result-wrapper resultWrapper167781)}] (clojure.core/cond-> {} (letvar167782 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167782 ["Message" :content])))))))

(clojure.core/defn- response-list-streaming-distributions-result ([input] (response-list-streaming-distributions-result nil input)) ([resultWrapper167787 input] (clojure.core/let [rawinput167786 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167789 {"StreamingDistributionList" (portkey.aws/search-for-tag rawinput167786 "StreamingDistributionList" :flattened? false :result-wrapper resultWrapper167787)}] (clojure.core/cond-> {} (letvar167789 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar167789 ["StreamingDistributionList" :content])))))))

(clojure.core/defn- response-create-streaming-distribution-with-tags-result ([input] (response-create-streaming-distribution-with-tags-result nil input)) ([resultWrapper167791 input] (clojure.core/let [rawinput167790 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167792 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput167790 "StreamingDistribution" :flattened? false :result-wrapper resultWrapper167791), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167792 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar167792 ["StreamingDistribution" :content]))) (letvar167792 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167792 ["Location"]))) (letvar167792 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167792 ["ETag"])))))))

(clojure.core/defn- response-create-invalidation-result ([input] (response-create-invalidation-result nil input)) ([resultWrapper167799 input] (clojure.core/let [rawinput167798 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167801 {"Location" (clojure.core/get-in input [:headers "Location"]), "Invalidation" (portkey.aws/search-for-tag rawinput167798 "Invalidation" :flattened? false :result-wrapper resultWrapper167799)}] (clojure.core/cond-> {} (letvar167801 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167801 ["Location"]))) (letvar167801 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar167801 ["Invalidation" :content])))))))

(clojure.core/defn- response-missing-body ([input] (response-missing-body nil input)) ([resultWrapper167803 input] (clojure.core/let [rawinput167802 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167804 {"Message" (portkey.aws/search-for-tag rawinput167802 "Message" :flattened? false :result-wrapper resultWrapper167803)}] (clojure.core/cond-> {} (letvar167804 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167804 ["Message" :content])))))))

(clojure.core/defn- response-invalid-origin-read-timeout ([input] (response-invalid-origin-read-timeout nil input)) ([resultWrapper167806 input] (clojure.core/let [rawinput167805 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167807 {"Message" (portkey.aws/search-for-tag rawinput167805 "Message" :flattened? false :result-wrapper resultWrapper167806)}] (clojure.core/cond-> {} (letvar167807 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167807 ["Message" :content])))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-config-result ([input] (response-get-cloud-front-origin-access-identity-config-result nil input)) ([resultWrapper167809 input] (clojure.core/let [rawinput167808 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167810 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag rawinput167808 "CloudFrontOriginAccessIdentityConfig" :flattened? false :result-wrapper resultWrapper167809), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167810 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar167810 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar167810 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167810 ["ETag"])))))))

(clojure.core/defn- response-distribution-not-disabled ([input] (response-distribution-not-disabled nil input)) ([resultWrapper167817 input] (clojure.core/let [rawinput167816 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167819 {"Message" (portkey.aws/search-for-tag rawinput167816 "Message" :flattened? false :result-wrapper resultWrapper167817)}] (clojure.core/cond-> {} (letvar167819 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167819 ["Message" :content])))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-already-exists ([input] (response-cloud-front-origin-access-identity-already-exists nil input)) ([resultWrapper167821 input] (clojure.core/let [rawinput167820 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167822 {"Message" (portkey.aws/search-for-tag rawinput167820 "Message" :flattened? false :result-wrapper resultWrapper167821)}] (clojure.core/cond-> {} (letvar167822 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167822 ["Message" :content])))))))

(clojure.core/defn- response-precondition-failed ([input] (response-precondition-failed nil input)) ([resultWrapper167824 input] (clojure.core/let [rawinput167823 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167827 {"Message" (portkey.aws/search-for-tag rawinput167823 "Message" :flattened? false :result-wrapper resultWrapper167824)}] (clojure.core/cond-> {} (letvar167827 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167827 ["Message" :content])))))))

(clojure.core/defn- response-distribution-already-exists ([input] (response-distribution-already-exists nil input)) ([resultWrapper167832 input] (clojure.core/let [rawinput167831 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167833 {"Message" (portkey.aws/search-for-tag rawinput167831 "Message" :flattened? false :result-wrapper resultWrapper167832)}] (clojure.core/cond-> {} (letvar167833 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167833 ["Message" :content])))))))

(clojure.core/defn- response-invalid-origin-access-identity ([input] (response-invalid-origin-access-identity nil input)) ([resultWrapper167836 input] (clojure.core/let [rawinput167835 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167837 {"Message" (portkey.aws/search-for-tag rawinput167835 "Message" :flattened? false :result-wrapper resultWrapper167836)}] (clojure.core/cond-> {} (letvar167837 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167837 ["Message" :content])))))))

(clojure.core/defn- response-too-many-trusted-signers ([input] (response-too-many-trusted-signers nil input)) ([resultWrapper167839 input] (clojure.core/let [rawinput167838 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167840 {"Message" (portkey.aws/search-for-tag rawinput167838 "Message" :flattened? false :result-wrapper resultWrapper167839)}] (clojure.core/cond-> {} (letvar167840 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167840 ["Message" :content])))))))

(clojure.core/defn- response-too-many-public-keys ([input] (response-too-many-public-keys nil input)) ([resultWrapper167843 input] (clojure.core/let [rawinput167842 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167844 {"Message" (portkey.aws/search-for-tag rawinput167842 "Message" :flattened? false :result-wrapper resultWrapper167843)}] (clojure.core/cond-> {} (letvar167844 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167844 ["Message" :content])))))))

(clojure.core/defn- response-invalid-minimum-protocol-version ([input] (response-invalid-minimum-protocol-version nil input)) ([resultWrapper167847 input] (clojure.core/let [rawinput167846 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167848 {"Message" (portkey.aws/search-for-tag rawinput167846 "Message" :flattened? false :result-wrapper resultWrapper167847)}] (clojure.core/cond-> {} (letvar167848 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167848 ["Message" :content])))))))

(clojure.core/defn- response-streaming-distribution-already-exists ([input] (response-streaming-distribution-already-exists nil input)) ([resultWrapper167850 input] (clojure.core/let [rawinput167849 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167851 {"Message" (portkey.aws/search-for-tag rawinput167849 "Message" :flattened? false :result-wrapper resultWrapper167850)}] (clojure.core/cond-> {} (letvar167851 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167851 ["Message" :content])))))))

(clojure.core/defn- response-public-key-in-use ([input] (response-public-key-in-use nil input)) ([resultWrapper167853 input] (clojure.core/let [rawinput167852 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167854 {"Message" (portkey.aws/search-for-tag rawinput167852 "Message" :flattened? false :result-wrapper resultWrapper167853)}] (clojure.core/cond-> {} (letvar167854 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167854 ["Message" :content])))))))

(clojure.core/defn- response-invalid-if-match-version ([input] (response-invalid-if-match-version nil input)) ([resultWrapper167856 input] (clojure.core/let [rawinput167855 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167857 {"Message" (portkey.aws/search-for-tag rawinput167855 "Message" :flattened? false :result-wrapper resultWrapper167856)}] (clojure.core/cond-> {} (letvar167857 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167857 ["Message" :content])))))))

(clojure.core/defn- response-list-field-level-encryption-profiles-result ([input] (response-list-field-level-encryption-profiles-result nil input)) ([resultWrapper167859 input] (clojure.core/let [rawinput167858 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167860 {"FieldLevelEncryptionProfileList" (portkey.aws/search-for-tag rawinput167858 "FieldLevelEncryptionProfileList" :flattened? false :result-wrapper resultWrapper167859)}] (clojure.core/cond-> {} (letvar167860 "FieldLevelEncryptionProfileList") (clojure.core/assoc :field-level-encryption-profile-list (deser-field-level-encryption-profile-list (clojure.core/get-in letvar167860 ["FieldLevelEncryptionProfileList" :content])))))))

(clojure.core/defn- response-create-distribution-result ([input] (response-create-distribution-result nil input)) ([resultWrapper167862 input] (clojure.core/let [rawinput167861 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167863 {"Distribution" (portkey.aws/search-for-tag rawinput167861 "Distribution" :flattened? false :result-wrapper resultWrapper167862), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167863 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar167863 ["Distribution" :content]))) (letvar167863 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar167863 ["Location"]))) (letvar167863 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167863 ["ETag"])))))))

(clojure.core/defn- response-too-many-distributions ([input] (response-too-many-distributions nil input)) ([resultWrapper167865 input] (clojure.core/let [rawinput167864 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167866 {"Message" (portkey.aws/search-for-tag rawinput167864 "Message" :flattened? false :result-wrapper resultWrapper167865)}] (clojure.core/cond-> {} (letvar167866 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167866 ["Message" :content])))))))

(clojure.core/defn- response-list-field-level-encryption-configs-result ([input] (response-list-field-level-encryption-configs-result nil input)) ([resultWrapper167868 input] (clojure.core/let [rawinput167867 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167869 {"FieldLevelEncryptionList" (portkey.aws/search-for-tag rawinput167867 "FieldLevelEncryptionList" :flattened? false :result-wrapper resultWrapper167868)}] (clojure.core/cond-> {} (letvar167869 "FieldLevelEncryptionList") (clojure.core/assoc :field-level-encryption-list (deser-field-level-encryption-list (clojure.core/get-in letvar167869 ["FieldLevelEncryptionList" :content])))))))

(clojure.core/defn- response-no-such-distribution ([input] (response-no-such-distribution nil input)) ([resultWrapper167871 input] (clojure.core/let [rawinput167870 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167872 {"Message" (portkey.aws/search-for-tag rawinput167870 "Message" :flattened? false :result-wrapper resultWrapper167871)}] (clojure.core/cond-> {} (letvar167872 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167872 ["Message" :content])))))))

(clojure.core/defn- response-query-arg-profile-empty ([input] (response-query-arg-profile-empty nil input)) ([resultWrapper167874 input] (clojure.core/let [rawinput167873 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167875 {"Message" (portkey.aws/search-for-tag rawinput167873 "Message" :flattened? false :result-wrapper resultWrapper167874)}] (clojure.core/cond-> {} (letvar167875 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167875 ["Message" :content])))))))

(clojure.core/defn- response-update-streaming-distribution-result ([input] (response-update-streaming-distribution-result nil input)) ([resultWrapper167877 input] (clojure.core/let [rawinput167876 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167878 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput167876 "StreamingDistribution" :flattened? false :result-wrapper resultWrapper167877), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167878 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar167878 ["StreamingDistribution" :content]))) (letvar167878 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167878 ["ETag"])))))))

(clojure.core/defn- response-illegal-update ([input] (response-illegal-update nil input)) ([resultWrapper167881 input] (clojure.core/let [rawinput167880 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167882 {"Message" (portkey.aws/search-for-tag rawinput167880 "Message" :flattened? false :result-wrapper resultWrapper167881)}] (clojure.core/cond-> {} (letvar167882 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167882 ["Message" :content])))))))

(clojure.core/defn- response-get-field-level-encryption-profile-config-result ([input] (response-get-field-level-encryption-profile-config-result nil input)) ([resultWrapper167884 input] (clojure.core/let [rawinput167883 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167885 {"FieldLevelEncryptionProfileConfig" (portkey.aws/search-for-tag rawinput167883 "FieldLevelEncryptionProfileConfig" :flattened? false :result-wrapper resultWrapper167884), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar167885 "FieldLevelEncryptionProfileConfig") (clojure.core/assoc :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar167885 ["FieldLevelEncryptionProfileConfig" :content]))) (letvar167885 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar167885 ["ETag"])))))))

(clojure.core/defn- response-too-many-field-level-encryption-content-type-profiles ([input] (response-too-many-field-level-encryption-content-type-profiles nil input)) ([resultWrapper167892 input] (clojure.core/let [rawinput167891 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167893 {"Message" (portkey.aws/search-for-tag rawinput167891 "Message" :flattened? false :result-wrapper resultWrapper167892)}] (clojure.core/cond-> {} (letvar167893 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167893 ["Message" :content])))))))

(clojure.core/defn- response-invalid-origin-keepalive-timeout ([input] (response-invalid-origin-keepalive-timeout nil input)) ([resultWrapper167896 input] (clojure.core/let [rawinput167895 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167897 {"Message" (portkey.aws/search-for-tag rawinput167895 "Message" :flattened? false :result-wrapper resultWrapper167896)}] (clojure.core/cond-> {} (letvar167897 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167897 ["Message" :content])))))))

(clojure.core/defn- response-inconsistent-quantities ([input] (response-inconsistent-quantities nil input)) ([resultWrapper167899 input] (clojure.core/let [rawinput167898 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167900 {"Message" (portkey.aws/search-for-tag rawinput167898 "Message" :flattened? false :result-wrapper resultWrapper167899)}] (clojure.core/cond-> {} (letvar167900 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167900 ["Message" :content])))))))

(clojure.core/defn- response-list-distributions-by-web-acl-id-result ([input] (response-list-distributions-by-web-acl-id-result nil input)) ([resultWrapper167904 input] (clojure.core/let [rawinput167903 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167908 {"DistributionList" (portkey.aws/search-for-tag rawinput167903 "DistributionList" :flattened? false :result-wrapper resultWrapper167904)}] (clojure.core/cond-> {} (letvar167908 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar167908 ["DistributionList" :content])))))))

(clojure.core/defn- response-too-many-query-string-parameters ([input] (response-too-many-query-string-parameters nil input)) ([resultWrapper167911 input] (clojure.core/let [rawinput167910 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167912 {"Message" (portkey.aws/search-for-tag rawinput167910 "Message" :flattened? false :result-wrapper resultWrapper167911)}] (clojure.core/cond-> {} (letvar167912 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167912 ["Message" :content])))))))

(clojure.core/defn- response-invalid-tagging ([input] (response-invalid-tagging nil input)) ([resultWrapper167916 input] (clojure.core/let [rawinput167915 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167917 {"Message" (portkey.aws/search-for-tag rawinput167915 "Message" :flattened? false :result-wrapper resultWrapper167916)}] (clojure.core/cond-> {} (letvar167917 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167917 ["Message" :content])))))))

(clojure.core/defn- response-list-distributions-result ([input] (response-list-distributions-result nil input)) ([resultWrapper167921 input] (clojure.core/let [rawinput167920 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167922 {"DistributionList" (portkey.aws/search-for-tag rawinput167920 "DistributionList" :flattened? false :result-wrapper resultWrapper167921)}] (clojure.core/cond-> {} (letvar167922 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar167922 ["DistributionList" :content])))))))

(clojure.core/defn- response-trusted-signer-does-not-exist ([input] (response-trusted-signer-does-not-exist nil input)) ([resultWrapper167925 input] (clojure.core/let [rawinput167924 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167926 {"Message" (portkey.aws/search-for-tag rawinput167924 "Message" :flattened? false :result-wrapper resultWrapper167925)}] (clojure.core/cond-> {} (letvar167926 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167926 ["Message" :content])))))))

(clojure.core/defn- response-too-many-field-level-encryption-field-patterns ([input] (response-too-many-field-level-encryption-field-patterns nil input)) ([resultWrapper167928 input] (clojure.core/let [rawinput167927 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167929 {"Message" (portkey.aws/search-for-tag rawinput167927 "Message" :flattened? false :result-wrapper resultWrapper167928)}] (clojure.core/cond-> {} (letvar167929 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167929 ["Message" :content])))))))

(clojure.core/defn- response-get-invalidation-result ([input] (response-get-invalidation-result nil input)) ([resultWrapper167931 input] (clojure.core/let [rawinput167930 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167932 {"Invalidation" (portkey.aws/search-for-tag rawinput167930 "Invalidation" :flattened? false :result-wrapper resultWrapper167931)}] (clojure.core/cond-> {} (letvar167932 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar167932 ["Invalidation" :content])))))))

(clojure.core/defn- response-too-many-headers-in-forwarded-values ([input] (response-too-many-headers-in-forwarded-values nil input)) ([resultWrapper167935 input] (clojure.core/let [rawinput167934 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar167936 {"Message" (portkey.aws/search-for-tag rawinput167934 "Message" :flattened? false :result-wrapper resultWrapper167935)}] (clojure.core/cond-> {} (letvar167936 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar167936 ["Message" :content])))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-11-05/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21055__auto__] (clojure.core/<= 1 (clojure.core/count s__21055__auto__))) (clojure.core/fn [s__21056__auto__] (clojure.core/< (clojure.core/count s__21056__auto__) 128)) (clojure.core/fn [s__21057__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21057__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-11-05/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21055__auto__] (clojure.core/<= 0 (clojure.core/count s__21055__auto__))) (clojure.core/fn [s__21056__auto__] (clojure.core/< (clojure.core/count s__21056__auto__) 256)) (clojure.core/fn [s__21057__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21057__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.-2018-11-05/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21057__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__21057__auto__))))
