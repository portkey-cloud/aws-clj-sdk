...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar1035060 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1035060 ["Quantity" :content]))} (letvar1035060 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar1035060 ["Items" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar1035144 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "IncludeCookies" (portkey.aws/getback-xml-elem-with-tag "IncludeCookies" input), "Bucket" (portkey.aws/getback-xml-elem-with-tag "Bucket" input), "Prefix" (portkey.aws/getback-xml-elem-with-tag "Prefix" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1035144 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar1035144 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar1035144 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar1035144 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar1035228 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "CreateTime" (portkey.aws/getback-xml-elem-with-tag "CreateTime" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1035228 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar1035228 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar1035228 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar1035329 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "CreateTime" (portkey.aws/getback-xml-elem-with-tag "CreateTime" input), "InvalidationBatch" (portkey.aws/getback-xml-elem-with-tag "InvalidationBatch" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1035329 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar1035329 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar1035329 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar1035329 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar1035452 {"GeoRestriction" (portkey.aws/getback-xml-elem-with-tag "GeoRestriction" input)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar1035452 ["GeoRestriction" :content]))})))

(clojure.core/defn- deserstring [input] (clojure.core/first input))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar1035541 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "InProgressInvalidationBatches" (portkey.aws/getback-xml-elem-with-tag "InProgressInvalidationBatches" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "ActiveTrustedSigners" (portkey.aws/getback-xml-elem-with-tag "ActiveTrustedSigners" input), "DistributionConfig" (portkey.aws/getback-xml-elem-with-tag "DistributionConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1035541 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar1035541 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1035541 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar1035541 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar1035541 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar1035541 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar1035541 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar1035625 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1035625 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1035625 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1035625 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1035625 ["Quantity" :content]))} (letvar1035625 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1035625 ["NextMarker" :content]))) (letvar1035625 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar1035625 ["Items" :content]))))))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar1035709 {"QueryString" (portkey.aws/getback-xml-elem-with-tag "QueryString" input), "Cookies" (portkey.aws/getback-xml-elem-with-tag "Cookies" input), "Headers" (portkey.aws/getback-xml-elem-with-tag "Headers" input)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar1035709 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar1035709 ["Cookies" :content]))} (letvar1035709 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar1035709 ["Headers" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar1035793 {"Paths" (portkey.aws/getback-xml-elem-with-tag "Paths" input), "CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar1035793 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar1035793 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar1035894 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1035894 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1035894 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1035894 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1035894 ["Quantity" :content]))} (letvar1035894 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1035894 ["NextMarker" :content]))) (letvar1035894 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar1035894 ["Items" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar1035983 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "ActiveTrustedSigners" (portkey.aws/getback-xml-elem-with-tag "ActiveTrustedSigners" input), "StreamingDistributionConfig" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1035983 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar1035983 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar1035983 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar1035983 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar1035983 ["StreamingDistributionConfig" :content]))} (letvar1035983 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar1035983 ["LastModifiedTime" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar1036072 {"ErrorCode" (portkey.aws/getback-xml-elem-with-tag "ErrorCode" input), "ResponsePagePath" (portkey.aws/getback-xml-elem-with-tag "ResponsePagePath" input), "ResponseCode" (portkey.aws/getback-xml-elem-with-tag "ResponseCode" input), "ErrorCachingMinTTL" (portkey.aws/getback-xml-elem-with-tag "ErrorCachingMinTTL" input)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar1036072 ["ErrorCode" :content]))} (letvar1036072 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar1036072 ["ResponsePagePath" :content]))) (letvar1036072 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar1036072 ["ResponseCode" :content]))) (letvar1036072 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar1036072 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar1036173 {"AwsAccountNumber" (portkey.aws/getback-xml-elem-with-tag "AwsAccountNumber" input), "KeyPairIds" (portkey.aws/getback-xml-elem-with-tag "KeyPairIds" input)}] (clojure.core/cond-> {} (letvar1036173 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar1036173 ["AwsAccountNumber" :content]))) (letvar1036173 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar1036173 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar1036276 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1036276 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar1036276 ["Items" :content]))})))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar1036377 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1036377 ["Quantity" :content]))} (letvar1036377 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar1036377 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar1036461 {"SmoothStreaming" (portkey.aws/getback-xml-elem-with-tag "SmoothStreaming" input), "Compress" (portkey.aws/getback-xml-elem-with-tag "Compress" input), "ForwardedValues" (portkey.aws/getback-xml-elem-with-tag "ForwardedValues" input), "TargetOriginId" (portkey.aws/getback-xml-elem-with-tag "TargetOriginId" input), "ViewerProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "ViewerProtocolPolicy" input), "MinTTL" (portkey.aws/getback-xml-elem-with-tag "MinTTL" input), "PathPattern" (portkey.aws/getback-xml-elem-with-tag "PathPattern" input), "MaxTTL" (portkey.aws/getback-xml-elem-with-tag "MaxTTL" input), "AllowedMethods" (portkey.aws/getback-xml-elem-with-tag "AllowedMethods" input), "DefaultTTL" (portkey.aws/getback-xml-elem-with-tag "DefaultTTL" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar1036461 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar1036461 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar1036461 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1036461 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar1036461 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar1036461 ["MinTTL" :content]))} (letvar1036461 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar1036461 ["SmoothStreaming" :content]))) (letvar1036461 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar1036461 ["Compress" :content]))) (letvar1036461 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar1036461 ["MaxTTL" :content]))) (letvar1036461 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar1036461 ["AllowedMethods" :content]))) (letvar1036461 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar1036461 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar1036545 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1036545 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar1036545 ["Quantity" :content]))} (letvar1036545 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar1036545 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar1036629 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "OriginPath" (portkey.aws/getback-xml-elem-with-tag "OriginPath" input), "CustomHeaders" (portkey.aws/getback-xml-elem-with-tag "CustomHeaders" input), "S3OriginConfig" (portkey.aws/getback-xml-elem-with-tag "S3OriginConfig" input), "CustomOriginConfig" (portkey.aws/getback-xml-elem-with-tag "CustomOriginConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1036629 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar1036629 ["DomainName" :content]))} (letvar1036629 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar1036629 ["OriginPath" :content]))) (letvar1036629 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar1036629 ["CustomHeaders" :content]))) (letvar1036629 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar1036629 ["S3OriginConfig" :content]))) (letvar1036629 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar1036629 ["CustomOriginConfig" :content]))))))

(clojure.core/defn- desertimestamp [input] (clojure.core/first input))

(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar1036715 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1036715 ["Quantity" :content]))} (letvar1036715 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar1036715 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar1036799 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1036799 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1036799 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1036799 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1036799 ["Quantity" :content]))} (letvar1036799 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1036799 ["NextMarker" :content]))) (letvar1036799 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar1036799 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar1036883 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1036883 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar1036883 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar1036967 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1036967 ["Quantity" :content]))} (letvar1036967 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar1036967 ["Items" :content]))))))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar1037051 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input), "CachedMethods" (portkey.aws/getback-xml-elem-with-tag "CachedMethods" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1037051 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar1037051 ["Items" :content]))} (letvar1037051 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar1037051 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar1037140 {"HTTPPort" (portkey.aws/getback-xml-elem-with-tag "HTTPPort" input), "HTTPSPort" (portkey.aws/getback-xml-elem-with-tag "HTTPSPort" input), "OriginProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "OriginProtocolPolicy" input), "OriginSslProtocols" (portkey.aws/getback-xml-elem-with-tag "OriginSslProtocols" input)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar1037140 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar1037140 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar1037140 ["OriginProtocolPolicy" :content]))} (letvar1037140 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar1037140 ["OriginSslProtocols" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar1037224 {"DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "OriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "OriginAccessIdentity" input)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar1037224 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar1037224 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar1037308 {"Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "S3Origin" (portkey.aws/getback-xml-elem-with-tag "S3Origin" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar1037308 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar1037308 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar1037308 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar1037308 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1037308 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar1037308 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar1037308 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar1037308 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1037308 ["LastModifiedTime" :content])), :price-class (deser-price-class (clojure.core/get-in letvar1037308 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar1037392 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "S3CanonicalUserId" (portkey.aws/getback-xml-elem-with-tag "S3CanonicalUserId" input), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityConfig" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1037392 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar1037392 ["S3CanonicalUserId" :content]))} (letvar1037392 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar1037392 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar1037493 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1037493 ["Quantity" :content]))} (letvar1037493 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar1037493 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar1037577 {"DefaultRootObject" (portkey.aws/getback-xml-elem-with-tag "DefaultRootObject" input), "CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Restrictions" (portkey.aws/getback-xml-elem-with-tag "Restrictions" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "WebACLId" (portkey.aws/getback-xml-elem-with-tag "WebACLId" input), "Logging" (portkey.aws/getback-xml-elem-with-tag "Logging" input), "CacheBehaviors" (portkey.aws/getback-xml-elem-with-tag "CacheBehaviors" input), "CustomErrorResponses" (portkey.aws/getback-xml-elem-with-tag "CustomErrorResponses" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "Origins" (portkey.aws/getback-xml-elem-with-tag "Origins" input), "DefaultCacheBehavior" (portkey.aws/getback-xml-elem-with-tag "DefaultCacheBehavior" input), "ViewerCertificate" (portkey.aws/getback-xml-elem-with-tag "ViewerCertificate" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1037577 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar1037577 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar1037577 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar1037577 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar1037577 ["Enabled" :content]))} (letvar1037577 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar1037577 ["DefaultRootObject" :content]))) (letvar1037577 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar1037577 ["Restrictions" :content]))) (letvar1037577 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar1037577 ["WebACLId" :content]))) (letvar1037577 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar1037577 ["Logging" :content]))) (letvar1037577 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar1037577 ["CacheBehaviors" :content]))) (letvar1037577 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar1037577 ["CustomErrorResponses" :content]))) (letvar1037577 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar1037577 ["Aliases" :content]))) (letvar1037577 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar1037577 ["PriceClass" :content]))) (letvar1037577 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar1037577 ["ViewerCertificate" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar1037778 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1037778 ["Quantity" :content]))} (letvar1037778 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar1037778 ["Items" :content]))))))

(clojure.core/defn- deserinteger [input] (java.lang.Integer. (clojure.core/first input)))

(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar1037864 {"Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "S3CanonicalUserId" (portkey.aws/getback-xml-elem-with-tag "S3CanonicalUserId" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar1037864 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar1037864 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar1037864 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar1037965 {"HeaderName" (portkey.aws/getback-xml-elem-with-tag "HeaderName" input), "HeaderValue" (portkey.aws/getback-xml-elem-with-tag "HeaderValue" input)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar1037965 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar1037965 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar1038049 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "S3Origin" (portkey.aws/getback-xml-elem-with-tag "S3Origin" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "Logging" (portkey.aws/getback-xml-elem-with-tag "Logging" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1038049 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar1038049 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar1038049 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1038049 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar1038049 ["Enabled" :content]))} (letvar1038049 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar1038049 ["Aliases" :content]))) (letvar1038049 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar1038049 ["Logging" :content]))) (letvar1038049 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar1038049 ["PriceClass" :content]))))))

(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar1038133 {"OriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "OriginAccessIdentity" input)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar1038133 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar1038234 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Bucket" (portkey.aws/getback-xml-elem-with-tag "Bucket" input), "Prefix" (portkey.aws/getback-xml-elem-with-tag "Prefix" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1038234 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar1038234 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar1038234 ["Prefix" :content]))})))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar1038318 {"Restrictions" (portkey.aws/getback-xml-elem-with-tag "Restrictions" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input), "WebACLId" (portkey.aws/getback-xml-elem-with-tag "WebACLId" input), "CacheBehaviors" (portkey.aws/getback-xml-elem-with-tag "CacheBehaviors" input), "CustomErrorResponses" (portkey.aws/getback-xml-elem-with-tag "CustomErrorResponses" input), "Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Status" (portkey.aws/getback-xml-elem-with-tag "Status" input), "Aliases" (portkey.aws/getback-xml-elem-with-tag "Aliases" input), "PriceClass" (portkey.aws/getback-xml-elem-with-tag "PriceClass" input), "LastModifiedTime" (portkey.aws/getback-xml-elem-with-tag "LastModifiedTime" input), "DomainName" (portkey.aws/getback-xml-elem-with-tag "DomainName" input), "Origins" (portkey.aws/getback-xml-elem-with-tag "Origins" input), "Id" (portkey.aws/getback-xml-elem-with-tag "Id" input), "DefaultCacheBehavior" (portkey.aws/getback-xml-elem-with-tag "DefaultCacheBehavior" input), "ViewerCertificate" (portkey.aws/getback-xml-elem-with-tag "ViewerCertificate" input)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar1038318 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar1038318 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar1038318 ["WebACLId" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar1038318 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar1038318 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar1038318 ["ViewerCertificate" :content])), :domain-name (deserstring (clojure.core/get-in letvar1038318 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar1038318 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar1038318 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar1038318 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar1038318 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar1038318 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar1038318 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar1038318 ["LastModifiedTime" :content])), :price-class (deser-price-class (clojure.core/get-in letvar1038318 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar1038407 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1038407 ["Quantity" :content]))} (letvar1038407 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar1038407 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar1038496 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1038496 ["Quantity" :content]))} (letvar1038496 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar1038496 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar1038597 {"Marker" (portkey.aws/getback-xml-elem-with-tag "Marker" input), "NextMarker" (portkey.aws/getback-xml-elem-with-tag "NextMarker" input), "MaxItems" (portkey.aws/getback-xml-elem-with-tag "MaxItems" input), "IsTruncated" (portkey.aws/getback-xml-elem-with-tag "IsTruncated" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar1038597 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar1038597 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar1038597 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar1038597 ["Quantity" :content]))} (letvar1038597 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar1038597 ["NextMarker" :content]))) (letvar1038597 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar1038597 ["Items" :content]))))))

(clojure.core/defn- deser-ssl-support-method [input] (clojure.core/get {"sni-only" :snionly, "vip" :vip} (clojure.core/first input)))

(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar1038686 {"Forward" (portkey.aws/getback-xml-elem-with-tag "Forward" input), "WhitelistedNames" (portkey.aws/getback-xml-elem-with-tag "WhitelistedNames" input)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar1038686 ["Forward" :content]))} (letvar1038686 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar1038686 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar1038770 {"Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar1038770 ["Quantity" :content]))} (letvar1038770 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar1038770 ["Items" :content]))))))
...
(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar1038871 {"SmoothStreaming" (portkey.aws/getback-xml-elem-with-tag "SmoothStreaming" input), "Compress" (portkey.aws/getback-xml-elem-with-tag "Compress" input), "ForwardedValues" (portkey.aws/getback-xml-elem-with-tag "ForwardedValues" input), "TargetOriginId" (portkey.aws/getback-xml-elem-with-tag "TargetOriginId" input), "ViewerProtocolPolicy" (portkey.aws/getback-xml-elem-with-tag "ViewerProtocolPolicy" input), "MinTTL" (portkey.aws/getback-xml-elem-with-tag "MinTTL" input), "MaxTTL" (portkey.aws/getback-xml-elem-with-tag "MaxTTL" input), "AllowedMethods" (portkey.aws/getback-xml-elem-with-tag "AllowedMethods" input), "DefaultTTL" (portkey.aws/getback-xml-elem-with-tag "DefaultTTL" input), "TrustedSigners" (portkey.aws/getback-xml-elem-with-tag "TrustedSigners" input)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar1038871 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar1038871 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar1038871 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar1038871 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar1038871 ["MinTTL" :content]))} (letvar1038871 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar1038871 ["SmoothStreaming" :content]))) (letvar1038871 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar1038871 ["Compress" :content]))) (letvar1038871 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar1038871 ["MaxTTL" :content]))) (letvar1038871 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar1038871 ["AllowedMethods" :content]))) (letvar1038871 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar1038871 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar1038955 {"Enabled" (portkey.aws/getback-xml-elem-with-tag "Enabled" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar1038955 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar1038955 ["Quantity" :content]))} (letvar1038955 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar1038955 ["Items" :content]))))))

(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar1039039 {"CloudFrontDefaultCertificate" (portkey.aws/getback-xml-elem-with-tag "CloudFrontDefaultCertificate" input), "IAMCertificateId" (portkey.aws/getback-xml-elem-with-tag "IAMCertificateId" input), "ACMCertificateArn" (portkey.aws/getback-xml-elem-with-tag "ACMCertificateArn" input), "SSLSupportMethod" (portkey.aws/getback-xml-elem-with-tag "SSLSupportMethod" input), "MinimumProtocolVersion" (portkey.aws/getback-xml-elem-with-tag "MinimumProtocolVersion" input), "Certificate" (portkey.aws/getback-xml-elem-with-tag "Certificate" input), "CertificateSource" (portkey.aws/getback-xml-elem-with-tag "CertificateSource" input)}] (clojure.core/cond-> {} (letvar1039039 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar1039039 ["CloudFrontDefaultCertificate" :content]))) (letvar1039039 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar1039039 ["IAMCertificateId" :content]))) (letvar1039039 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar1039039 ["ACMCertificateArn" :content]))) (letvar1039039 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar1039039 ["SSLSupportMethod" :content]))) (letvar1039039 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar1039039 ["MinimumProtocolVersion" :content]))) (letvar1039039 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar1039039 ["Certificate" :content]))) (letvar1039039 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar1039039 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar1039123 {"CallerReference" (portkey.aws/getback-xml-elem-with-tag "CallerReference" input), "Comment" (portkey.aws/getback-xml-elem-with-tag "Comment" input)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar1039123 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar1039123 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar1039207 {"RestrictionType" (portkey.aws/getback-xml-elem-with-tag "RestrictionType" input), "Quantity" (portkey.aws/getback-xml-elem-with-tag "Quantity" input), "Items" (portkey.aws/getback-xml-elem-with-tag "Items" input)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar1039207 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar1039207 ["Quantity" :content]))} (letvar1039207 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar1039207 ["Items" :content]))))))

(clojure.core/defn- deser-no-such-origin [input] (clojure.core/let [letvar1039291 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039291 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039291 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-protocol-settings [input] (clojure.core/let [letvar1039375 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039375 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039375 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cookie-names-in-white-list [input] (clojure.core/let [letvar1039459 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039459 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039459 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cache-behaviors [input] (clojure.core/let [letvar1039543 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039543 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039543 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-origin-custom-headers [input] (clojure.core/let [letvar1039627 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039627 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039627 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-streaming-distributions [input] (clojure.core/let [letvar1039711 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039711 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039711 ["Message" :content]))))))

(clojure.core/defn- deser-get-streaming-distribution-result [input] (clojure.core/let [letvar1039795 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1039795 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1039795 ["StreamingDistribution" :content]))) (letvar1039795 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1039795 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [letvar1039879 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039879 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039879 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-viewer-certificate [input] (clojure.core/let [letvar1039963 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1039963 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1039963 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-argument [input] (clojure.core/let [letvar1040047 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040047 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040047 ["Message" :content]))))))

(clojure.core/defn- deser-streaming-distribution-not-disabled [input] (clojure.core/let [letvar1040131 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040131 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040131 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-certificates [input] (clojure.core/let [letvar1040215 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040215 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040215 ["Message" :content]))))))

(clojure.core/defn- deser-access-denied [input] (clojure.core/let [letvar1040299 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040299 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040299 ["Message" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [letvar1040383 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040383 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040383 ["Message" :content]))))))

(clojure.core/defn- deser-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1040467 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1040467 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1040467 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1040467 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1040467 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-error-code [input] (clojure.core/let [letvar1040551 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040551 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040551 ["Message" :content]))))))

(clojure.core/defn- deser-create-streaming-distribution-result [input] (clojure.core/let [letvar1040635 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1040635 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1040635 ["StreamingDistribution" :content]))) (letvar1040635 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1040635 ["Location" :content]))) (letvar1040635 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1040635 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-relative-path [input] (clojure.core/let [letvar1040719 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040719 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040719 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-location-code [input] (clojure.core/let [letvar1040803 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040803 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040803 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-web-acl-id [input] (clojure.core/let [letvar1040887 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040887 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040887 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin [input] (clojure.core/let [letvar1040971 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1040971 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1040971 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [letvar1041055 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041055 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041055 ["Message" :content]))))))

(clojure.core/defn- deser-update-distribution-result [input] (clojure.core/let [letvar1041139 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1041139 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1041139 ["Distribution" :content]))) (letvar1041139 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1041139 ["ETag" :content]))))))

(clojure.core/defn- deser-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1041223 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1041223 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1041223 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1041223 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1041223 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-origins [input] (clojure.core/let [letvar1041307 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041307 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041307 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-ttl-order [input] (clojure.core/let [letvar1041391 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041391 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041391 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-streaming-distribution [input] (clojure.core/let [letvar1041475 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041475 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041475 ["Message" :content]))))))

(clojure.core/defn- deser-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [letvar1041559 {"CloudFrontOriginAccessIdentity" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentity" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1041559 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar1041559 ["CloudFrontOriginAccessIdentity" :content]))) (letvar1041559 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1041559 ["Location" :content]))) (letvar1041559 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1041559 ["ETag" :content]))))))

(clojure.core/defn- deser-cname-already-exists [input] (clojure.core/let [letvar1041643 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041643 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041643 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-default-root-object [input] (clojure.core/let [letvar1041727 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041727 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041727 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-response-code [input] (clojure.core/let [letvar1041811 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041811 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041811 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-invalidation [input] (clojure.core/let [letvar1041895 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041895 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041895 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-invalidations-in-progress [input] (clojure.core/let [letvar1041979 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1041979 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1041979 ["Message" :content]))))))

(clojure.core/defn- deser-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [letvar1042063 {"CloudFrontOriginAccessIdentityList" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityList" input)}] (clojure.core/cond-> {} (letvar1042063 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar1042063 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- deser-invalid-forward-cookies [input] (clojure.core/let [letvar1042147 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042147 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042147 ["Message" :content]))))))

(clojure.core/defn- deser-get-distribution-config-result [input] (clojure.core/let [letvar1042231 {"DistributionConfig" (portkey.aws/getback-xml-elem-with-tag "DistributionConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1042231 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar1042231 ["DistributionConfig" :content]))) (letvar1042231 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1042231 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-required-protocol [input] (clojure.core/let [letvar1042315 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042315 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042315 ["Message" :content]))))))

(clojure.core/defn- deser-get-distribution-result [input] (clojure.core/let [letvar1042399 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1042399 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1042399 ["Distribution" :content]))) (letvar1042399 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1042399 ["ETag" :content]))))))

(clojure.core/defn- deser-get-streaming-distribution-config-result [input] (clojure.core/let [letvar1042483 {"StreamingDistributionConfig" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1042483 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar1042483 ["StreamingDistributionConfig" :content]))) (letvar1042483 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1042483 ["ETag" :content]))))))

(clojure.core/defn- deser-invalid-headers-for-s-3-origin [input] (clojure.core/let [letvar1042567 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042567 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042567 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-distribution-cnam-es [input] (clojure.core/let [letvar1042651 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042651 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042651 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-geo-restriction-parameter [input] (clojure.core/let [letvar1042735 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042735 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042735 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [letvar1042819 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042819 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042819 ["Message" :content]))))))

(clojure.core/defn- deser-list-invalidations-result [input] (clojure.core/let [letvar1042903 {"InvalidationList" (portkey.aws/getback-xml-elem-with-tag "InvalidationList" input)}] (clojure.core/cond-> {} (letvar1042903 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar1042903 ["InvalidationList" :content]))))))

(clojure.core/defn- deser-batch-too-large [input] (clojure.core/let [letvar1042987 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1042987 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1042987 ["Message" :content]))))))

(clojure.core/defn- deser-list-streaming-distributions-result [input] (clojure.core/let [letvar1043071 {"StreamingDistributionList" (portkey.aws/getback-xml-elem-with-tag "StreamingDistributionList" input)}] (clojure.core/cond-> {} (letvar1043071 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar1043071 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- deser-create-invalidation-result [input] (clojure.core/let [letvar1043155 {"Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "Invalidation" (portkey.aws/getback-xml-elem-with-tag "Invalidation" input)}] (clojure.core/cond-> {} (letvar1043155 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1043155 ["Location" :content]))) (letvar1043155 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar1043155 ["Invalidation" :content]))))))

(clojure.core/defn- deser-missing-body [input] (clojure.core/let [letvar1043239 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043239 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043239 ["Message" :content]))))))

(clojure.core/defn- deser-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [letvar1043323 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/getback-xml-elem-with-tag "CloudFrontOriginAccessIdentityConfig" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1043323 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar1043323 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar1043323 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1043323 ["ETag" :content]))))))

(clojure.core/defn- deser-distribution-not-disabled [input] (clojure.core/let [letvar1043407 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043407 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043407 ["Message" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [letvar1043491 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043491 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043491 ["Message" :content]))))))

(clojure.core/defn- deser-precondition-failed [input] (clojure.core/let [letvar1043575 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043575 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043575 ["Message" :content]))))))

(clojure.core/defn- deser-distribution-already-exists [input] (clojure.core/let [letvar1043659 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043659 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043659 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-origin-access-identity [input] (clojure.core/let [letvar1043743 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043743 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043743 ["Message" :content]))))))

(clojure.core/defn- deser-too-many-trusted-signers [input] (clojure.core/let [letvar1043827 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043827 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043827 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-minimum-protocol-version [input] (clojure.core/let [letvar1043911 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043911 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043911 ["Message" :content]))))))

(clojure.core/defn- deser-streaming-distribution-already-exists [input] (clojure.core/let [letvar1043995 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1043995 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1043995 ["Message" :content]))))))

(clojure.core/defn- deser-invalid-if-match-version [input] (clojure.core/let [letvar1044079 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044079 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044079 ["Message" :content]))))))

(clojure.core/defn- deser-create-distribution-result [input] (clojure.core/let [letvar1044163 {"Distribution" (portkey.aws/getback-xml-elem-with-tag "Distribution" input), "Location" (portkey.aws/getback-xml-elem-with-tag "Location" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1044163 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar1044163 ["Distribution" :content]))) (letvar1044163 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar1044163 ["Location" :content]))) (letvar1044163 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1044163 ["ETag" :content]))))))

(clojure.core/defn- deser-too-many-distributions [input] (clojure.core/let [letvar1044247 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044247 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044247 ["Message" :content]))))))

(clojure.core/defn- deser-no-such-distribution [input] (clojure.core/let [letvar1044331 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044331 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044331 ["Message" :content]))))))

(clojure.core/defn- deser-update-streaming-distribution-result [input] (clojure.core/let [letvar1044415 {"StreamingDistribution" (portkey.aws/getback-xml-elem-with-tag "StreamingDistribution" input), "ETag" (portkey.aws/getback-xml-elem-with-tag "ETag" input)}] (clojure.core/cond-> {} (letvar1044415 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar1044415 ["StreamingDistribution" :content]))) (letvar1044415 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar1044415 ["ETag" :content]))))))

(clojure.core/defn- deser-illegal-update [input] (clojure.core/let [letvar1044499 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044499 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044499 ["Message" :content]))))))

(clojure.core/defn- deser-inconsistent-quantities [input] (clojure.core/let [letvar1044583 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044583 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044583 ["Message" :content]))))))

(clojure.core/defn- deser-list-distributions-by-web-acl-id-result [input] (clojure.core/let [letvar1044667 {"DistributionList" (portkey.aws/getback-xml-elem-with-tag "DistributionList" input)}] (clojure.core/cond-> {} (letvar1044667 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar1044667 ["DistributionList" :content]))))))

(clojure.core/defn- deser-list-distributions-result [input] (clojure.core/let [letvar1044751 {"DistributionList" (portkey.aws/getback-xml-elem-with-tag "DistributionList" input)}] (clojure.core/cond-> {} (letvar1044751 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar1044751 ["DistributionList" :content]))))))

(clojure.core/defn- deser-trusted-signer-does-not-exist [input] (clojure.core/let [letvar1044835 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1044835 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1044835 ["Message" :content]))))))

(clojure.core/defn- deser-get-invalidation-result [input] (clojure.core/let [letvar1044919 {"Invalidation" (portkey.aws/getback-xml-elem-with-tag "Invalidation" input)}] (clojure.core/cond-> {} (letvar1044919 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar1044919 ["Invalidation" :content]))))))

(clojure.core/defn- deser-too-many-headers-in-forwarded-values [input] (clojure.core/let [letvar1045003 {"Message" (portkey.aws/getback-xml-elem-with-tag "Message" input)}] (clojure.core/cond-> {} (letvar1045003 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1045003 ["Message" :content]))))))
