...
(clojure.core/defn- response-get-entitlements-result ([input] (response-get-entitlements-result nil input)) ([resultWrapper1762283 input] (clojure.core/let [rawinput1762282 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762284 {"Entitlements" (rawinput1762282 "Entitlements"), "NextToken" (rawinput1762282 "NextToken")}] (clojure.core/cond-> {} (letvar1762284 "Entitlements") (clojure.core/assoc :entitlements (deser-entitlement-list (clojure.core/get-in letvar1762284 ["Entitlements"]))) (letvar1762284 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1762284 ["NextToken"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1762286 input] (clojure.core/let [rawinput1762285 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762287 {"message" (rawinput1762285 "message")}] (clojure.core/cond-> {} (letvar1762287 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762287 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1762289 input] (clojure.core/let [rawinput1762288 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762290 {"message" (rawinput1762288 "message")}] (clojure.core/cond-> {} (letvar1762290 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762290 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1762292 input] (clojure.core/let [rawinput1762291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762293 {"message" (rawinput1762291 "message")}] (clojure.core/cond-> {} (letvar1762293 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762293 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
