...
(clojure.core/defn- response-get-entitlements-result ([input] (response-get-entitlements-result nil input)) ([resultWrapper939607 input] (clojure.core/let [rawinput939606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939608 {"Entitlements" (rawinput939606 "Entitlements"), "NextToken" (rawinput939606 "NextToken")}] (clojure.core/cond-> {} (letvar939608 "Entitlements") (clojure.core/assoc :entitlements (deser-entitlement-list (clojure.core/get-in letvar939608 ["Entitlements"]))) (letvar939608 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar939608 ["NextToken"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper939610 input] (clojure.core/let [rawinput939609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939611 {"message" (rawinput939609 "message")}] (clojure.core/cond-> {} (letvar939611 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939611 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper939613 input] (clojure.core/let [rawinput939612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939614 {"message" (rawinput939612 "message")}] (clojure.core/cond-> {} (letvar939614 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939614 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper939616 input] (clojure.core/let [rawinput939615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939617 {"message" (rawinput939615 "message")}] (clojure.core/cond-> {} (letvar939617 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939617 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\S+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
