...
(clojure.core/defn- response-container-not-found-exception ([input] (response-container-not-found-exception nil input)) ([resultWrapper1376735 input] (clojure.core/let [rawinput1376734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376736 {"Message" (rawinput1376734 "Message")}] (clojure.core/cond-> {} (letvar1376736 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1376736 ["Message"])))))))

(clojure.core/defn- response-get-object-response ([input] (response-get-object-response nil input)) ([resultWrapper1376738 input] (clojure.core/let [rawinput1376737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376739 {"Body" (rawinput1376737 "Body"), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Content-Range" (clojure.core/get-in input [:headers "Content-Range"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"]), "StatusCode" (clojure.core/get-in input [:status "StatusCode"])}] (clojure.core/cond-> {:status-code (deserstatus-code (clojure.core/get-in letvar1376739 ["StatusCode"]))} (letvar1376739 "Body") (clojure.core/assoc :body (deser-payload-blob (clojure.core/get-in letvar1376739 ["Body"]))) (letvar1376739 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar1376739 ["Cache-Control"]))) (letvar1376739 "Content-Range") (clojure.core/assoc :content-range (deser-content-range-pattern (clojure.core/get-in letvar1376739 ["Content-Range"]))) (letvar1376739 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar1376739 ["Content-Length"]))) (letvar1376739 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1376739 ["Content-Type"]))) (letvar1376739 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1376739 ["ETag"]))) (letvar1376739 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar1376739 ["Last-Modified"])))))))

(clojure.core/defn- response-requested-range-not-satisfiable-exception ([input] (response-requested-range-not-satisfiable-exception nil input)) ([resultWrapper1376741 input] (clojure.core/let [rawinput1376740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376742 {"Message" (rawinput1376740 "Message")}] (clojure.core/cond-> {} (letvar1376742 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1376742 ["Message"])))))))

(clojure.core/defn- response-put-object-response ([input] (response-put-object-response nil input)) ([resultWrapper1376744 input] (clojure.core/let [rawinput1376743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376745 {"ContentSHA256" (rawinput1376743 "ContentSHA256"), "ETag" (rawinput1376743 "ETag"), "StorageClass" (rawinput1376743 "StorageClass")}] (clojure.core/cond-> {} (letvar1376745 "ContentSHA256") (clojure.core/assoc :content-sha-256 (deser-sha-256-hash (clojure.core/get-in letvar1376745 ["ContentSHA256"]))) (letvar1376745 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1376745 ["ETag"]))) (letvar1376745 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar1376745 ["StorageClass"])))))))

(clojure.core/defn- response-list-items-response ([input] (response-list-items-response nil input)) ([resultWrapper1376747 input] (clojure.core/let [rawinput1376746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376748 {"Items" (rawinput1376746 "Items"), "NextToken" (rawinput1376746 "NextToken")}] (clojure.core/cond-> {} (letvar1376748 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar1376748 ["Items"]))) (letvar1376748 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1376748 ["NextToken"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1376750 input] (clojure.core/let [rawinput1376749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376751 {"Message" (rawinput1376749 "Message")}] (clojure.core/cond-> {} (letvar1376751 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1376751 ["Message"])))))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1376753 input] (clojure.core/let [rawinput1376752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376754 {"Message" (rawinput1376752 "Message")}] (clojure.core/cond-> {} (letvar1376754 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1376754 ["Message"])))))))

(clojure.core/defn- response-delete-object-response ([input] (response-delete-object-response nil input)) ([resultWrapper1376756 input] (clojure.core/let [rawinput1376755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376757 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-object-response ([input] (response-describe-object-response nil input)) ([resultWrapper1376759 input] (clojure.core/let [rawinput1376758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1376760 {"ETag" (clojure.core/get-in input [:headers "ETag"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"])}] (clojure.core/cond-> {} (letvar1376760 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1376760 ["ETag"]))) (letvar1376760 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1376760 ["Content-Type"]))) (letvar1376760 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar1376760 ["Content-Length"]))) (letvar1376760 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar1376760 ["Cache-Control"]))) (letvar1376760 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar1376760 ["Last-Modified"])))))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/sha-256-hash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 64 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[0-9A-Fa-f]{64}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 255)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[\w\-\/\.\+]{1,255}$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 900)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 900)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__1012854__auto__))))
