...
(clojure.core/defn- response-container-not-found-exception ([input] (response-container-not-found-exception nil input)) ([resultWrapper1366506 input] (clojure.core/let [rawinput1366505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366507 {"Message" (rawinput1366505 "Message")}] (clojure.core/cond-> {} (letvar1366507 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1366507 ["Message"])))))))

(clojure.core/defn- response-get-object-response ([input] (response-get-object-response nil input)) ([resultWrapper1366509 input] (clojure.core/let [rawinput1366508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366510 {"Body" (rawinput1366508 "Body"), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Content-Range" (clojure.core/get-in input [:headers "Content-Range"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"]), "StatusCode" (clojure.core/get-in input [:status "StatusCode"])}] (clojure.core/cond-> {:status-code (deserstatus-code (clojure.core/get-in letvar1366510 ["StatusCode"]))} (letvar1366510 "Body") (clojure.core/assoc :body (deser-payload-blob (clojure.core/get-in letvar1366510 ["Body"]))) (letvar1366510 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar1366510 ["Cache-Control"]))) (letvar1366510 "Content-Range") (clojure.core/assoc :content-range (deser-content-range-pattern (clojure.core/get-in letvar1366510 ["Content-Range"]))) (letvar1366510 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar1366510 ["Content-Length"]))) (letvar1366510 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1366510 ["Content-Type"]))) (letvar1366510 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1366510 ["ETag"]))) (letvar1366510 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar1366510 ["Last-Modified"])))))))

(clojure.core/defn- response-requested-range-not-satisfiable-exception ([input] (response-requested-range-not-satisfiable-exception nil input)) ([resultWrapper1366512 input] (clojure.core/let [rawinput1366511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366513 {"Message" (rawinput1366511 "Message")}] (clojure.core/cond-> {} (letvar1366513 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1366513 ["Message"])))))))

(clojure.core/defn- response-put-object-response ([input] (response-put-object-response nil input)) ([resultWrapper1366515 input] (clojure.core/let [rawinput1366514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366516 {"ContentSHA256" (rawinput1366514 "ContentSHA256"), "ETag" (rawinput1366514 "ETag"), "StorageClass" (rawinput1366514 "StorageClass")}] (clojure.core/cond-> {} (letvar1366516 "ContentSHA256") (clojure.core/assoc :content-sha-256 (deser-sha-256-hash (clojure.core/get-in letvar1366516 ["ContentSHA256"]))) (letvar1366516 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1366516 ["ETag"]))) (letvar1366516 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar1366516 ["StorageClass"])))))))

(clojure.core/defn- response-list-items-response ([input] (response-list-items-response nil input)) ([resultWrapper1366518 input] (clojure.core/let [rawinput1366517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366519 {"Items" (rawinput1366517 "Items"), "NextToken" (rawinput1366517 "NextToken")}] (clojure.core/cond-> {} (letvar1366519 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar1366519 ["Items"]))) (letvar1366519 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1366519 ["NextToken"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1366521 input] (clojure.core/let [rawinput1366520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366522 {"Message" (rawinput1366520 "Message")}] (clojure.core/cond-> {} (letvar1366522 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1366522 ["Message"])))))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1366524 input] (clojure.core/let [rawinput1366523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366525 {"Message" (rawinput1366523 "Message")}] (clojure.core/cond-> {} (letvar1366525 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1366525 ["Message"])))))))

(clojure.core/defn- response-delete-object-response ([input] (response-delete-object-response nil input)) ([resultWrapper1366527 input] (clojure.core/let [rawinput1366526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366528 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-object-response ([input] (response-describe-object-response nil input)) ([resultWrapper1366530 input] (clojure.core/let [rawinput1366529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1366531 {"ETag" (clojure.core/get-in input [:headers "ETag"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"])}] (clojure.core/cond-> {} (letvar1366531 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar1366531 ["ETag"]))) (letvar1366531 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1366531 ["Content-Type"]))) (letvar1366531 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar1366531 ["Content-Length"]))) (letvar1366531 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar1366531 ["Cache-Control"]))) (letvar1366531 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar1366531 ["Last-Modified"])))))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/sha-256-hash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 64 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Fa-f]{64}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[\w\-\/\.\+]{1,255}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 900)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 900)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__21078__auto__))))
