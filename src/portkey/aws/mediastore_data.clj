...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__16144__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/list-limit (clojure.spec.alpha/and clojure.core/int? (fn* [p1__16202__16203__auto__] (clojure.core/<= 1 p1__16202__16203__auto__)) (fn* [p1__16204__16205__auto__] (clojure.core/<= p1__16204__16205__auto__ 1000))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16142__auto__] (clojure.core/<= 1 (clojure.core/count s__16142__auto__))) (clojure.core/fn [s__16143__auto__] (clojure.core/< (clojure.core/count s__16143__auto__) 255)) (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__16144__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__16144__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"^[\w\-\/\.]{1,255}$" s__16144__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/item-type (clojure.spec.alpha/conformer (clojure.core/let [m__16140__auto__ {"OBJECT" "OBJECT", :object "OBJECT", "FOLDER" "FOLDER", :folder "FOLDER"}] (clojure.core/fn [s__16141__auto__] (m__16140__auto__ s__16141__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16142__auto__] (clojure.core/<= 1 (clojure.core/count s__16142__auto__))) (clojure.core/fn [s__16143__auto__] (clojure.core/< (clojure.core/count s__16143__auto__) 900)) (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__16144__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__16144__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/storage-class (clojure.spec.alpha/conformer (clojure.core/let [m__16140__auto__ {"TEMPORAL" "TEMPORAL", :temporal "TEMPORAL"}] (clojure.core/fn [s__16141__auto__] (m__16140__auto__ s__16141__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__16142__auto__] (clojure.core/<= 0 (clojure.core/count s__16142__auto__))) (clojure.core/fn [s__16143__auto__] (clojure.core/< (clojure.core/count s__16143__auto__) 900)) (clojure.core/fn [s__16144__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__16144__auto__))))
...
(clojure.core/defn delete-object "Deletes an object at the specified path." ([delete-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data/endpoints "DELETE" "/{Path+}" delete-object-request :portkey.aws.mediastore-data/delete-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data/delete-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data/object-not-found-exception, "InternalServerError" :portkey.aws.mediastore-data/internal-server-error})))
...
(clojure.core/defn describe-object "Gets the headers for an object at the specified path." ([describe-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data/endpoints "HEAD" "/{Path+}" describe-object-request :portkey.aws.mediastore-data/describe-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data/describe-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data/object-not-found-exception, "InternalServerError" :portkey.aws.mediastore-data/internal-server-error})))
...
(clojure.core/defn get-object "Downloads the object at the specified path." ([get-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data/endpoints "GET" "/{Path+}" get-object-request :portkey.aws.mediastore-data/get-object-request {:payload nil, :move {}, :headers {"Range" ["Range" nil]}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data/get-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data/object-not-found-exception, "RequestedRangeNotSatisfiableException" :portkey.aws.mediastore-data/requested-range-not-satisfiable-exception, "InternalServerError" :portkey.aws.mediastore-data/internal-server-error})))
