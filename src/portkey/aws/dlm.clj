...
(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper544602 input] (clojure.core/let [rawinput544601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544603 {"Message" (rawinput544601 "Message"), "Code" (rawinput544601 "Code"), "RequiredParameters" (rawinput544601 "RequiredParameters"), "MutuallyExclusiveParameters" (rawinput544601 "MutuallyExclusiveParameters")}] (clojure.core/cond-> {} (letvar544603 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar544603 ["Message"]))) (letvar544603 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar544603 ["Code"]))) (letvar544603 "RequiredParameters") (clojure.core/assoc :required-parameters (deser-parameter-list (clojure.core/get-in letvar544603 ["RequiredParameters"]))) (letvar544603 "MutuallyExclusiveParameters") (clojure.core/assoc :mutually-exclusive-parameters (deser-parameter-list (clojure.core/get-in letvar544603 ["MutuallyExclusiveParameters"])))))))

(clojure.core/defn- response-update-lifecycle-policy-response ([input] (response-update-lifecycle-policy-response nil input)) ([resultWrapper544605 input] (clojure.core/let [rawinput544604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544606 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lifecycle-policy-response ([input] (response-delete-lifecycle-policy-response nil input)) ([resultWrapper544608 input] (clojure.core/let [rawinput544607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544609 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper544611 input] (clojure.core/let [rawinput544610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544612 {"Message" (rawinput544610 "Message"), "Code" (rawinput544610 "Code"), "ResourceType" (rawinput544610 "ResourceType")}] (clojure.core/cond-> {} (letvar544612 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar544612 ["Message"]))) (letvar544612 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar544612 ["Code"]))) (letvar544612 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar544612 ["ResourceType"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper544614 input] (clojure.core/let [rawinput544613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544615 {"Message" (rawinput544613 "Message"), "Code" (rawinput544613 "Code"), "ResourceType" (rawinput544613 "ResourceType"), "ResourceIds" (rawinput544613 "ResourceIds")}] (clojure.core/cond-> {} (letvar544615 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar544615 ["Message"]))) (letvar544615 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar544615 ["Code"]))) (letvar544615 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar544615 ["ResourceType"]))) (letvar544615 "ResourceIds") (clojure.core/assoc :resource-ids (deser-policy-id-list (clojure.core/get-in letvar544615 ["ResourceIds"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper544617 input] (clojure.core/let [rawinput544616 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544618 {"Message" (rawinput544616 "Message"), "Code" (rawinput544616 "Code")}] (clojure.core/cond-> {} (letvar544618 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar544618 ["Message"]))) (letvar544618 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar544618 ["Code"])))))))

(clojure.core/defn- response-get-lifecycle-policies-response ([input] (response-get-lifecycle-policies-response nil input)) ([resultWrapper544620 input] (clojure.core/let [rawinput544619 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544621 {"Policies" (rawinput544619 "Policies")}] (clojure.core/cond-> {} (letvar544621 "Policies") (clojure.core/assoc :policies (deser-lifecycle-policy-summary-list (clojure.core/get-in letvar544621 ["Policies"])))))))

(clojure.core/defn- response-get-lifecycle-policy-response ([input] (response-get-lifecycle-policy-response nil input)) ([resultWrapper544623 input] (clojure.core/let [rawinput544622 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544624 {"Policy" (rawinput544622 "Policy")}] (clojure.core/cond-> {} (letvar544624 "Policy") (clojure.core/assoc :policy (deser-lifecycle-policy (clojure.core/get-in letvar544624 ["Policy"])))))))

(clojure.core/defn- response-create-lifecycle-policy-response ([input] (response-create-lifecycle-policy-response nil input)) ([resultWrapper544626 input] (clojure.core/let [rawinput544625 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar544627 {"PolicyId" (rawinput544625 "PolicyId")}] (clojure.core/cond-> {} (letvar544627 "PolicyId") (clojure.core/assoc :policy-id (deser-policy-id (clojure.core/get-in letvar544627 ["PolicyId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.dlm/policy-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.dlm/time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.dlm/schedule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
