...
(clojure.spec.alpha/def :portkey.aws.dlm/policy-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 0 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.dlm/time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42949__auto__] (clojure.core/re-matches #"^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" s__42949__auto__))))

(clojure.spec.alpha/def :portkey.aws.dlm/schedule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 0 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 500))))
...
(clojure.core/defn delete-lifecycle-policy ([delete-lifecycle-policy-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-delete-lifecycle-policy-request delete-lifecycle-policy-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.dlm/endpoints, :http.request.spec/output-spec :portkey.aws.dlm/delete-lifecycle-policy-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/policies/{policyId}/", :http.request.configuration/version "2018-01-12", :http.request.configuration/service-id "DLM", :http.request.spec/input-spec :portkey.aws.dlm/delete-lifecycle-policy-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteLifecyclePolicy", :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.dlm/resource-not-found-exception, "InternalServerException" :portkey.aws.dlm/internal-server-exception, "LimitExceededException" :portkey.aws.dlm/limit-exceeded-exception}})))))
...
(clojure.core/defn get-lifecycle-policy ([get-lifecycle-policy-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-get-lifecycle-policy-request get-lifecycle-policy-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.dlm/endpoints, :http.request.spec/output-spec :portkey.aws.dlm/get-lifecycle-policy-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/policies/{policyId}/", :http.request.configuration/version "2018-01-12", :http.request.configuration/service-id "DLM", :http.request.spec/input-spec :portkey.aws.dlm/get-lifecycle-policy-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.configuration/action "GetLifecyclePolicy", :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.dlm/resource-not-found-exception, "InternalServerException" :portkey.aws.dlm/internal-server-exception, "LimitExceededException" :portkey.aws.dlm/limit-exceeded-exception}})))))
...
(clojure.core/defn update-lifecycle-policy ([update-lifecycle-policy-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-update-lifecycle-policy-request update-lifecycle-policy-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.dlm/endpoints, :http.request.spec/output-spec :portkey.aws.dlm/update-lifecycle-policy-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/policies/{policyId}", :http.request.configuration/version "2018-01-12", :http.request.configuration/service-id "DLM", :http.request.spec/input-spec :portkey.aws.dlm/update-lifecycle-policy-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :patch, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateLifecyclePolicy", :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.dlm/resource-not-found-exception, "InvalidRequestException" :portkey.aws.dlm/invalid-request-exception, "InternalServerException" :portkey.aws.dlm/internal-server-exception, "LimitExceededException" :portkey.aws.dlm/limit-exceeded-exception}})))))
