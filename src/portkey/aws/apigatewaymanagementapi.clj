...
(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper40408 input] (clojure.core/let [rawinput40407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40409 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper40411 input] (clojure.core/let [rawinput40410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40412 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-payload-too-large-exception ([input] (response-payload-too-large-exception nil input)) ([resultWrapper40414 input] (clojure.core/let [rawinput40413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40415 {"message" (rawinput40413 "message")}] (clojure.core/cond-> {} (letvar40415 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar40415 ["message"])))))))

(clojure.core/defn- response-gone-exception ([input] (response-gone-exception nil input)) ([resultWrapper40417 input] (clojure.core/let [rawinput40416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40418 {}] (clojure.core/cond-> {}))))
