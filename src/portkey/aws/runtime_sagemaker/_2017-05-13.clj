...
(clojure.core/defn- response-invoke-endpoint-output ([input] (response-invoke-endpoint-output nil input)) ([resultWrapper452049 input] (clojure.core/let [rawinput452048 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar452050 {"Body" (rawinput452048 "Body"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-Amzn-Invoked-Production-Variant" (clojure.core/get-in input [:headers "x-Amzn-Invoked-Production-Variant"]), "X-Amzn-SageMaker-Custom-Attributes" (clojure.core/get-in input [:headers "X-Amzn-SageMaker-Custom-Attributes"])}] (clojure.core/cond-> {:body (deser-body-blob (clojure.core/get-in letvar452050 ["Body"]))} (letvar452050 "Content-Type") (clojure.core/assoc :content-type (deser-header (clojure.core/get-in letvar452050 ["Content-Type"]))) (letvar452050 "x-Amzn-Invoked-Production-Variant") (clojure.core/assoc :invoked-production-variant (deser-header (clojure.core/get-in letvar452050 ["x-Amzn-Invoked-Production-Variant"]))) (letvar452050 "X-Amzn-SageMaker-Custom-Attributes") (clojure.core/assoc :custom-attributes (deser-custom-attributes-header (clojure.core/get-in letvar452050 ["X-Amzn-SageMaker-Custom-Attributes"])))))))

(clojure.core/defn- response-validation-error ([input] (response-validation-error nil input)) ([resultWrapper452052 input] (clojure.core/let [rawinput452051 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar452053 {"Message" (rawinput452051 "Message")}] (clojure.core/cond-> {} (letvar452053 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar452053 ["Message"])))))))

(clojure.core/defn- response-service-unavailable ([input] (response-service-unavailable nil input)) ([resultWrapper452055 input] (clojure.core/let [rawinput452054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar452056 {"Message" (rawinput452054 "Message")}] (clojure.core/cond-> {} (letvar452056 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar452056 ["Message"])))))))

(clojure.core/defn- response-model-error ([input] (response-model-error nil input)) ([resultWrapper452058 input] (clojure.core/let [rawinput452057 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar452059 {"Message" (rawinput452057 "Message"), "OriginalStatusCode" (rawinput452057 "OriginalStatusCode"), "OriginalMessage" (rawinput452057 "OriginalMessage"), "LogStreamArn" (rawinput452057 "LogStreamArn")}] (clojure.core/cond-> {} (letvar452059 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar452059 ["Message"]))) (letvar452059 "OriginalStatusCode") (clojure.core/assoc :original-status-code (deser-status-code (clojure.core/get-in letvar452059 ["OriginalStatusCode"]))) (letvar452059 "OriginalMessage") (clojure.core/assoc :original-message (deser-message (clojure.core/get-in letvar452059 ["OriginalMessage"]))) (letvar452059 "LogStreamArn") (clojure.core/assoc :log-stream-arn (deser-log-stream-arn (clojure.core/get-in letvar452059 ["LogStreamArn"])))))))

(clojure.core/defn- response-internal-failure ([input] (response-internal-failure nil input)) ([resultWrapper452061 input] (clojure.core/let [rawinput452060 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar452062 {"Message" (rawinput452060 "Message")}] (clojure.core/cond-> {} (letvar452062 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar452062 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/custom-attributes-header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/endpoint-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 63)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
