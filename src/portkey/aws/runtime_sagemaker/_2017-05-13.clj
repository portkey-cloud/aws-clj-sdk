...
(clojure.core/defn- response-invoke-endpoint-output ([input] (response-invoke-endpoint-output nil input)) ([resultWrapper1445046 input] (clojure.core/let [rawinput1445045 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445047 {"Body" (rawinput1445045 "Body"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-Amzn-Invoked-Production-Variant" (clojure.core/get-in input [:headers "x-Amzn-Invoked-Production-Variant"]), "X-Amzn-SageMaker-Custom-Attributes" (clojure.core/get-in input [:headers "X-Amzn-SageMaker-Custom-Attributes"])}] (clojure.core/cond-> {:body (deser-body-blob (clojure.core/get-in letvar1445047 ["Body"]))} (letvar1445047 "Content-Type") (clojure.core/assoc :content-type (deser-header (clojure.core/get-in letvar1445047 ["Content-Type"]))) (letvar1445047 "x-Amzn-Invoked-Production-Variant") (clojure.core/assoc :invoked-production-variant (deser-header (clojure.core/get-in letvar1445047 ["x-Amzn-Invoked-Production-Variant"]))) (letvar1445047 "X-Amzn-SageMaker-Custom-Attributes") (clojure.core/assoc :custom-attributes (deser-custom-attributes-header (clojure.core/get-in letvar1445047 ["X-Amzn-SageMaker-Custom-Attributes"])))))))

(clojure.core/defn- response-validation-error ([input] (response-validation-error nil input)) ([resultWrapper1445049 input] (clojure.core/let [rawinput1445048 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445050 {"Message" (rawinput1445048 "Message")}] (clojure.core/cond-> {} (letvar1445050 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1445050 ["Message"])))))))

(clojure.core/defn- response-service-unavailable ([input] (response-service-unavailable nil input)) ([resultWrapper1445052 input] (clojure.core/let [rawinput1445051 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445053 {"Message" (rawinput1445051 "Message")}] (clojure.core/cond-> {} (letvar1445053 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1445053 ["Message"])))))))

(clojure.core/defn- response-model-error ([input] (response-model-error nil input)) ([resultWrapper1445055 input] (clojure.core/let [rawinput1445054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445056 {"Message" (rawinput1445054 "Message"), "OriginalStatusCode" (rawinput1445054 "OriginalStatusCode"), "OriginalMessage" (rawinput1445054 "OriginalMessage"), "LogStreamArn" (rawinput1445054 "LogStreamArn")}] (clojure.core/cond-> {} (letvar1445056 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1445056 ["Message"]))) (letvar1445056 "OriginalStatusCode") (clojure.core/assoc :original-status-code (deser-status-code (clojure.core/get-in letvar1445056 ["OriginalStatusCode"]))) (letvar1445056 "OriginalMessage") (clojure.core/assoc :original-message (deser-message (clojure.core/get-in letvar1445056 ["OriginalMessage"]))) (letvar1445056 "LogStreamArn") (clojure.core/assoc :log-stream-arn (deser-log-stream-arn (clojure.core/get-in letvar1445056 ["LogStreamArn"])))))))

(clojure.core/defn- response-internal-failure ([input] (response-internal-failure nil input)) ([resultWrapper1445058 input] (clojure.core/let [rawinput1445057 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445059 {"Message" (rawinput1445057 "Message")}] (clojure.core/cond-> {} (letvar1445059 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1445059 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/custom-attributes-header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/endpoint-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 63)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-sagemaker.-2017-05-13/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
