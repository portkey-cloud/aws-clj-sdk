...
(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper40463 input] (clojure.core/let [rawinput40462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40464 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper40466 input] (clojure.core/let [rawinput40465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40467 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-payload-too-large-exception ([input] (response-payload-too-large-exception nil input)) ([resultWrapper40469 input] (clojure.core/let [rawinput40468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40470 {"message" (rawinput40468 "message")}] (clojure.core/cond-> {} (letvar40470 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar40470 ["message"])))))))

(clojure.core/defn- response-gone-exception ([input] (response-gone-exception nil input)) ([resultWrapper40472 input] (clojure.core/let [rawinput40471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar40473 {}] (clojure.core/cond-> {}))))
