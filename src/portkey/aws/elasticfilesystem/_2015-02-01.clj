...
(clojure.core/defn- response-unsupported-availability-zone ([input] (response-unsupported-availability-zone nil input)) ([resultWrapper137496 input] (clojure.core/let [rawinput137495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137497 {"ErrorCode" (rawinput137495 "ErrorCode"), "Message" (rawinput137495 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137497 ["ErrorCode"]))} (letvar137497 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137497 ["Message"])))))))

(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper137499 input] (clojure.core/let [rawinput137498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137500 {"Marker" (rawinput137498 "Marker"), "Tags" (rawinput137498 "Tags"), "NextMarker" (rawinput137498 "NextMarker")}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar137500 ["Tags"]))} (letvar137500 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar137500 ["Marker"]))) (letvar137500 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar137500 ["NextMarker"])))))))

(clojure.core/defn- response-bad-request ([input] (response-bad-request nil input)) ([resultWrapper137502 input] (clojure.core/let [rawinput137501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137503 {"ErrorCode" (rawinput137501 "ErrorCode"), "Message" (rawinput137501 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137503 ["ErrorCode"]))} (letvar137503 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137503 ["Message"])))))))

(clojure.core/defn- response-lifecycle-configuration-description ([input] (response-lifecycle-configuration-description nil input)) ([resultWrapper137505 input] (clojure.core/let [rawinput137504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137506 {"LifecyclePolicies" (rawinput137504 "LifecyclePolicies")}] (clojure.core/cond-> {} (letvar137506 "LifecyclePolicies") (clojure.core/assoc :lifecycle-policies (deser-lifecycle-policies (clojure.core/get-in letvar137506 ["LifecyclePolicies"])))))))

(clojure.core/defn- response-ip-address-in-use ([input] (response-ip-address-in-use nil input)) ([resultWrapper137508 input] (clojure.core/let [rawinput137507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137509 {"ErrorCode" (rawinput137507 "ErrorCode"), "Message" (rawinput137507 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137509 ["ErrorCode"]))} (letvar137509 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137509 ["Message"])))))))

(clojure.core/defn- response-file-system-limit-exceeded ([input] (response-file-system-limit-exceeded nil input)) ([resultWrapper137511 input] (clojure.core/let [rawinput137510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137512 {"ErrorCode" (rawinput137510 "ErrorCode"), "Message" (rawinput137510 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137512 ["ErrorCode"]))} (letvar137512 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137512 ["Message"])))))))

(clojure.core/defn- response-file-system-description ([input] (response-file-system-description nil input)) ([resultWrapper137514 input] (clojure.core/let [rawinput137513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137515 {"ThroughputMode" (rawinput137513 "ThroughputMode"), "ProvisionedThroughputInMibps" (rawinput137513 "ProvisionedThroughputInMibps"), "LifeCycleState" (rawinput137513 "LifeCycleState"), "OwnerId" (rawinput137513 "OwnerId"), "Encrypted" (rawinput137513 "Encrypted"), "SizeInBytes" (rawinput137513 "SizeInBytes"), "Tags" (rawinput137513 "Tags"), "NumberOfMountTargets" (rawinput137513 "NumberOfMountTargets"), "FileSystemId" (rawinput137513 "FileSystemId"), "KmsKeyId" (rawinput137513 "KmsKeyId"), "CreationTime" (rawinput137513 "CreationTime"), "Name" (rawinput137513 "Name"), "CreationToken" (rawinput137513 "CreationToken"), "PerformanceMode" (rawinput137513 "PerformanceMode")}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar137515 ["Tags"])), :creation-token (deser-creation-token (clojure.core/get-in letvar137515 ["CreationToken"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar137515 ["FileSystemId"])), :performance-mode (deser-performance-mode (clojure.core/get-in letvar137515 ["PerformanceMode"])), :size-in-bytes (deser-file-system-size (clojure.core/get-in letvar137515 ["SizeInBytes"])), :number-of-mount-targets (deser-mount-target-count (clojure.core/get-in letvar137515 ["NumberOfMountTargets"])), :owner-id (deser-aws-account-id (clojure.core/get-in letvar137515 ["OwnerId"])), :creation-time (deser-timestamp (clojure.core/get-in letvar137515 ["CreationTime"])), :life-cycle-state (deser-life-cycle-state (clojure.core/get-in letvar137515 ["LifeCycleState"]))} (letvar137515 "ThroughputMode") (clojure.core/assoc :throughput-mode (deser-throughput-mode (clojure.core/get-in letvar137515 ["ThroughputMode"]))) (letvar137515 "ProvisionedThroughputInMibps") (clojure.core/assoc :provisioned-throughput-in-mibps (deser-provisioned-throughput-in-mibps (clojure.core/get-in letvar137515 ["ProvisionedThroughputInMibps"]))) (letvar137515 "Encrypted") (clojure.core/assoc :encrypted (deser-encrypted (clojure.core/get-in letvar137515 ["Encrypted"]))) (letvar137515 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar137515 ["KmsKeyId"]))) (letvar137515 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar137515 ["Name"])))))))

(clojure.core/defn- response-mount-target-conflict ([input] (response-mount-target-conflict nil input)) ([resultWrapper137517 input] (clojure.core/let [rawinput137516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137518 {"ErrorCode" (rawinput137516 "ErrorCode"), "Message" (rawinput137516 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137518 ["ErrorCode"]))} (letvar137518 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137518 ["Message"])))))))

(clojure.core/defn- response-describe-file-systems-response ([input] (response-describe-file-systems-response nil input)) ([resultWrapper137520 input] (clojure.core/let [rawinput137519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137521 {"Marker" (rawinput137519 "Marker"), "FileSystems" (rawinput137519 "FileSystems"), "NextMarker" (rawinput137519 "NextMarker")}] (clojure.core/cond-> {} (letvar137521 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar137521 ["Marker"]))) (letvar137521 "FileSystems") (clojure.core/assoc :file-systems (deser-file-system-descriptions (clojure.core/get-in letvar137521 ["FileSystems"]))) (letvar137521 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar137521 ["NextMarker"])))))))

(clojure.core/defn- response-security-group-limit-exceeded ([input] (response-security-group-limit-exceeded nil input)) ([resultWrapper137523 input] (clojure.core/let [rawinput137522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137524 {"ErrorCode" (rawinput137522 "ErrorCode"), "Message" (rawinput137522 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137524 ["ErrorCode"]))} (letvar137524 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137524 ["Message"])))))))

(clojure.core/defn- response-mount-target-not-found ([input] (response-mount-target-not-found nil input)) ([resultWrapper137526 input] (clojure.core/let [rawinput137525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137527 {"ErrorCode" (rawinput137525 "ErrorCode"), "Message" (rawinput137525 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137527 ["ErrorCode"]))} (letvar137527 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137527 ["Message"])))))))

(clojure.core/defn- response-incorrect-mount-target-state ([input] (response-incorrect-mount-target-state nil input)) ([resultWrapper137529 input] (clojure.core/let [rawinput137528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137530 {"ErrorCode" (rawinput137528 "ErrorCode"), "Message" (rawinput137528 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137530 ["ErrorCode"]))} (letvar137530 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137530 ["Message"])))))))

(clojure.core/defn- response-subnet-not-found ([input] (response-subnet-not-found nil input)) ([resultWrapper137532 input] (clojure.core/let [rawinput137531 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137533 {"ErrorCode" (rawinput137531 "ErrorCode"), "Message" (rawinput137531 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137533 ["ErrorCode"]))} (letvar137533 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137533 ["Message"])))))))

(clojure.core/defn- response-describe-mount-targets-response ([input] (response-describe-mount-targets-response nil input)) ([resultWrapper137535 input] (clojure.core/let [rawinput137534 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137536 {"Marker" (rawinput137534 "Marker"), "MountTargets" (rawinput137534 "MountTargets"), "NextMarker" (rawinput137534 "NextMarker")}] (clojure.core/cond-> {} (letvar137536 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar137536 ["Marker"]))) (letvar137536 "MountTargets") (clojure.core/assoc :mount-targets (deser-mount-target-descriptions (clojure.core/get-in letvar137536 ["MountTargets"]))) (letvar137536 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar137536 ["NextMarker"])))))))

(clojure.core/defn- response-file-system-not-found ([input] (response-file-system-not-found nil input)) ([resultWrapper137538 input] (clojure.core/let [rawinput137537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137539 {"ErrorCode" (rawinput137537 "ErrorCode"), "Message" (rawinput137537 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137539 ["ErrorCode"]))} (letvar137539 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137539 ["Message"])))))))

(clojure.core/defn- response-dependency-timeout ([input] (response-dependency-timeout nil input)) ([resultWrapper137541 input] (clojure.core/let [rawinput137540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137542 {"ErrorCode" (rawinput137540 "ErrorCode"), "Message" (rawinput137540 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137542 ["ErrorCode"]))} (letvar137542 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137542 ["Message"])))))))

(clojure.core/defn- response-describe-mount-target-security-groups-response ([input] (response-describe-mount-target-security-groups-response nil input)) ([resultWrapper137544 input] (clojure.core/let [rawinput137543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137545 {"SecurityGroups" (rawinput137543 "SecurityGroups")}] (clojure.core/cond-> {:security-groups (deser-security-groups (clojure.core/get-in letvar137545 ["SecurityGroups"]))}))))

(clojure.core/defn- response-file-system-in-use ([input] (response-file-system-in-use nil input)) ([resultWrapper137547 input] (clojure.core/let [rawinput137546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137548 {"ErrorCode" (rawinput137546 "ErrorCode"), "Message" (rawinput137546 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137548 ["ErrorCode"]))} (letvar137548 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137548 ["Message"])))))))

(clojure.core/defn- response-insufficient-throughput-capacity ([input] (response-insufficient-throughput-capacity nil input)) ([resultWrapper137550 input] (clojure.core/let [rawinput137549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137551 {"ErrorCode" (rawinput137549 "ErrorCode"), "Message" (rawinput137549 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137551 ["ErrorCode"]))} (letvar137551 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137551 ["Message"])))))))

(clojure.core/defn- response-mount-target-description ([input] (response-mount-target-description nil input)) ([resultWrapper137553 input] (clojure.core/let [rawinput137552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137554 {"OwnerId" (rawinput137552 "OwnerId"), "MountTargetId" (rawinput137552 "MountTargetId"), "FileSystemId" (rawinput137552 "FileSystemId"), "SubnetId" (rawinput137552 "SubnetId"), "LifeCycleState" (rawinput137552 "LifeCycleState"), "IpAddress" (rawinput137552 "IpAddress"), "NetworkInterfaceId" (rawinput137552 "NetworkInterfaceId")}] (clojure.core/cond-> {:mount-target-id (deser-mount-target-id (clojure.core/get-in letvar137554 ["MountTargetId"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar137554 ["FileSystemId"])), :subnet-id (deser-subnet-id (clojure.core/get-in letvar137554 ["SubnetId"])), :life-cycle-state (deser-life-cycle-state (clojure.core/get-in letvar137554 ["LifeCycleState"]))} (letvar137554 "OwnerId") (clojure.core/assoc :owner-id (deser-aws-account-id (clojure.core/get-in letvar137554 ["OwnerId"]))) (letvar137554 "IpAddress") (clojure.core/assoc :ip-address (deser-ip-address (clojure.core/get-in letvar137554 ["IpAddress"]))) (letvar137554 "NetworkInterfaceId") (clojure.core/assoc :network-interface-id (deser-network-interface-id (clojure.core/get-in letvar137554 ["NetworkInterfaceId"])))))))

(clojure.core/defn- response-file-system-already-exists ([input] (response-file-system-already-exists nil input)) ([resultWrapper137556 input] (clojure.core/let [rawinput137555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137557 {"ErrorCode" (rawinput137555 "ErrorCode"), "Message" (rawinput137555 "Message"), "FileSystemId" (rawinput137555 "FileSystemId")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137557 ["ErrorCode"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar137557 ["FileSystemId"]))} (letvar137557 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137557 ["Message"])))))))

(clojure.core/defn- response-incorrect-file-system-life-cycle-state ([input] (response-incorrect-file-system-life-cycle-state nil input)) ([resultWrapper137559 input] (clojure.core/let [rawinput137558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137560 {"ErrorCode" (rawinput137558 "ErrorCode"), "Message" (rawinput137558 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137560 ["ErrorCode"]))} (letvar137560 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137560 ["Message"])))))))

(clojure.core/defn- response-too-many-requests ([input] (response-too-many-requests nil input)) ([resultWrapper137562 input] (clojure.core/let [rawinput137561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137563 {"ErrorCode" (rawinput137561 "ErrorCode"), "Message" (rawinput137561 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137563 ["ErrorCode"]))} (letvar137563 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137563 ["Message"])))))))

(clojure.core/defn- response-throughput-limit-exceeded ([input] (response-throughput-limit-exceeded nil input)) ([resultWrapper137565 input] (clojure.core/let [rawinput137564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137566 {"ErrorCode" (rawinput137564 "ErrorCode"), "Message" (rawinput137564 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137566 ["ErrorCode"]))} (letvar137566 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137566 ["Message"])))))))

(clojure.core/defn- response-security-group-not-found ([input] (response-security-group-not-found nil input)) ([resultWrapper137568 input] (clojure.core/let [rawinput137567 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137569 {"ErrorCode" (rawinput137567 "ErrorCode"), "Message" (rawinput137567 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137569 ["ErrorCode"]))} (letvar137569 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137569 ["Message"])))))))

(clojure.core/defn- response-network-interface-limit-exceeded ([input] (response-network-interface-limit-exceeded nil input)) ([resultWrapper137571 input] (clojure.core/let [rawinput137570 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137572 {"ErrorCode" (rawinput137570 "ErrorCode"), "Message" (rawinput137570 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137572 ["ErrorCode"]))} (letvar137572 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137572 ["Message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper137574 input] (clojure.core/let [rawinput137573 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137575 {"ErrorCode" (rawinput137573 "ErrorCode"), "Message" (rawinput137573 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137575 ["ErrorCode"]))} (letvar137575 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137575 ["Message"])))))))

(clojure.core/defn- response-no-free-addresses-in-subnet ([input] (response-no-free-addresses-in-subnet nil input)) ([resultWrapper137577 input] (clojure.core/let [rawinput137576 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar137578 {"ErrorCode" (rawinput137576 "ErrorCode"), "Message" (rawinput137576 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar137578 ["ErrorCode"]))} (letvar137578 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar137578 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem.-2015-02-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem.-2015-02-01/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem.-2015-02-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem.-2015-02-01/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem.-2015-02-01/creation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
