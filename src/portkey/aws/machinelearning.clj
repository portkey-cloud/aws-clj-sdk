...
(clojure.core/defn- response-delete-tags-output ([input] (response-delete-tags-output nil input)) ([resultWrapper1256767 input] (clojure.core/let [rawinput1256766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256768 {"ResourceId" (rawinput1256766 "ResourceId"), "ResourceType" (rawinput1256766 "ResourceType")}] (clojure.core/cond-> {} (letvar1256768 "ResourceId") (clojure.core/assoc :resource-id (deser-entity-id (clojure.core/get-in letvar1256768 ["ResourceId"]))) (letvar1256768 "ResourceType") (clojure.core/assoc :resource-type (deser-taggable-resource-type (clojure.core/get-in letvar1256768 ["ResourceType"])))))))

(clojure.core/defn- response-update-evaluation-output ([input] (response-update-evaluation-output nil input)) ([resultWrapper1256770 input] (clojure.core/let [rawinput1256769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256771 {"EvaluationId" (rawinput1256769 "EvaluationId")}] (clojure.core/cond-> {} (letvar1256771 "EvaluationId") (clojure.core/assoc :evaluation-id (deser-entity-id (clojure.core/get-in letvar1256771 ["EvaluationId"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1256773 input] (clojure.core/let [rawinput1256772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256774 {"ResourceId" (rawinput1256772 "ResourceId"), "ResourceType" (rawinput1256772 "ResourceType")}] (clojure.core/cond-> {} (letvar1256774 "ResourceId") (clojure.core/assoc :resource-id (deser-entity-id (clojure.core/get-in letvar1256774 ["ResourceId"]))) (letvar1256774 "ResourceType") (clojure.core/assoc :resource-type (deser-taggable-resource-type (clojure.core/get-in letvar1256774 ["ResourceType"])))))))

(clojure.core/defn- response-get-batch-prediction-output ([input] (response-get-batch-prediction-output nil input)) ([resultWrapper1256776 input] (clojure.core/let [rawinput1256775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256777 {"MLModelId" (rawinput1256775 "MLModelId"), "CreatedByIamUser" (rawinput1256775 "CreatedByIamUser"), "FinishedAt" (rawinput1256775 "FinishedAt"), "LogUri" (rawinput1256775 "LogUri"), "BatchPredictionDataSourceId" (rawinput1256775 "BatchPredictionDataSourceId"), "Status" (rawinput1256775 "Status"), "LastUpdatedAt" (rawinput1256775 "LastUpdatedAt"), "OutputUri" (rawinput1256775 "OutputUri"), "InvalidRecordCount" (rawinput1256775 "InvalidRecordCount"), "Message" (rawinput1256775 "Message"), "ComputeTime" (rawinput1256775 "ComputeTime"), "BatchPredictionId" (rawinput1256775 "BatchPredictionId"), "CreatedAt" (rawinput1256775 "CreatedAt"), "TotalRecordCount" (rawinput1256775 "TotalRecordCount"), "Name" (rawinput1256775 "Name"), "InputDataLocationS3" (rawinput1256775 "InputDataLocationS3"), "StartedAt" (rawinput1256775 "StartedAt")}] (clojure.core/cond-> {} (letvar1256777 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256777 ["MLModelId"]))) (letvar1256777 "CreatedByIamUser") (clojure.core/assoc :created-by-iam-user (deser-aws-user-arn (clojure.core/get-in letvar1256777 ["CreatedByIamUser"]))) (letvar1256777 "FinishedAt") (clojure.core/assoc :finished-at (deser-epoch-time (clojure.core/get-in letvar1256777 ["FinishedAt"]))) (letvar1256777 "LogUri") (clojure.core/assoc :log-uri (deser-presigned-s-3-url (clojure.core/get-in letvar1256777 ["LogUri"]))) (letvar1256777 "BatchPredictionDataSourceId") (clojure.core/assoc :batch-prediction-data-source-id (deser-entity-id (clojure.core/get-in letvar1256777 ["BatchPredictionDataSourceId"]))) (letvar1256777 "Status") (clojure.core/assoc :status (deser-entity-status (clojure.core/get-in letvar1256777 ["Status"]))) (letvar1256777 "LastUpdatedAt") (clojure.core/assoc :last-updated-at (deser-epoch-time (clojure.core/get-in letvar1256777 ["LastUpdatedAt"]))) (letvar1256777 "OutputUri") (clojure.core/assoc :output-uri (deser-s-3-url (clojure.core/get-in letvar1256777 ["OutputUri"]))) (letvar1256777 "InvalidRecordCount") (clojure.core/assoc :invalid-record-count (deser-long-type (clojure.core/get-in letvar1256777 ["InvalidRecordCount"]))) (letvar1256777 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1256777 ["Message"]))) (letvar1256777 "ComputeTime") (clojure.core/assoc :compute-time (deser-long-type (clojure.core/get-in letvar1256777 ["ComputeTime"]))) (letvar1256777 "BatchPredictionId") (clojure.core/assoc :batch-prediction-id (deser-entity-id (clojure.core/get-in letvar1256777 ["BatchPredictionId"]))) (letvar1256777 "CreatedAt") (clojure.core/assoc :created-at (deser-epoch-time (clojure.core/get-in letvar1256777 ["CreatedAt"]))) (letvar1256777 "TotalRecordCount") (clojure.core/assoc :total-record-count (deser-long-type (clojure.core/get-in letvar1256777 ["TotalRecordCount"]))) (letvar1256777 "Name") (clojure.core/assoc :name (deser-entity-name (clojure.core/get-in letvar1256777 ["Name"]))) (letvar1256777 "InputDataLocationS3") (clojure.core/assoc :input-data-location-s-3 (deser-s-3-url (clojure.core/get-in letvar1256777 ["InputDataLocationS3"]))) (letvar1256777 "StartedAt") (clojure.core/assoc :started-at (deser-epoch-time (clojure.core/get-in letvar1256777 ["StartedAt"])))))))

(clojure.core/defn- response-create-ml-model-output ([input] (response-create-ml-model-output nil input)) ([resultWrapper1256779 input] (clojure.core/let [rawinput1256778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256780 {"MLModelId" (rawinput1256778 "MLModelId")}] (clojure.core/cond-> {} (letvar1256780 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256780 ["MLModelId"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1256782 input] (clojure.core/let [rawinput1256781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256783 {"message" (rawinput1256781 "message"), "code" (rawinput1256781 "code")}] (clojure.core/cond-> {} (letvar1256783 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256783 ["message"]))) (letvar1256783 "code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar1256783 ["code"])))))))

(clojure.core/defn- response-get-ml-model-output ([input] (response-get-ml-model-output nil input)) ([resultWrapper1256785 input] (clojure.core/let [rawinput1256784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256786 {"MLModelId" (rawinput1256784 "MLModelId"), "MLModelType" (rawinput1256784 "MLModelType"), "Schema" (rawinput1256784 "Schema"), "CreatedByIamUser" (rawinput1256784 "CreatedByIamUser"), "FinishedAt" (rawinput1256784 "FinishedAt"), "LogUri" (rawinput1256784 "LogUri"), "SizeInBytes" (rawinput1256784 "SizeInBytes"), "Status" (rawinput1256784 "Status"), "LastUpdatedAt" (rawinput1256784 "LastUpdatedAt"), "TrainingParameters" (rawinput1256784 "TrainingParameters"), "TrainingDataSourceId" (rawinput1256784 "TrainingDataSourceId"), "Message" (rawinput1256784 "Message"), "ComputeTime" (rawinput1256784 "ComputeTime"), "Recipe" (rawinput1256784 "Recipe"), "CreatedAt" (rawinput1256784 "CreatedAt"), "ScoreThresholdLastUpdatedAt" (rawinput1256784 "ScoreThresholdLastUpdatedAt"), "EndpointInfo" (rawinput1256784 "EndpointInfo"), "Name" (rawinput1256784 "Name"), "InputDataLocationS3" (rawinput1256784 "InputDataLocationS3"), "ScoreThreshold" (rawinput1256784 "ScoreThreshold"), "StartedAt" (rawinput1256784 "StartedAt")}] (clojure.core/cond-> {} (letvar1256786 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256786 ["MLModelId"]))) (letvar1256786 "MLModelType") (clojure.core/assoc :ml-model-type (deser-ml-model-type (clojure.core/get-in letvar1256786 ["MLModelType"]))) (letvar1256786 "Schema") (clojure.core/assoc :schema (deser-data-schema (clojure.core/get-in letvar1256786 ["Schema"]))) (letvar1256786 "CreatedByIamUser") (clojure.core/assoc :created-by-iam-user (deser-aws-user-arn (clojure.core/get-in letvar1256786 ["CreatedByIamUser"]))) (letvar1256786 "FinishedAt") (clojure.core/assoc :finished-at (deser-epoch-time (clojure.core/get-in letvar1256786 ["FinishedAt"]))) (letvar1256786 "LogUri") (clojure.core/assoc :log-uri (deser-presigned-s-3-url (clojure.core/get-in letvar1256786 ["LogUri"]))) (letvar1256786 "SizeInBytes") (clojure.core/assoc :size-in-bytes (deser-long-type (clojure.core/get-in letvar1256786 ["SizeInBytes"]))) (letvar1256786 "Status") (clojure.core/assoc :status (deser-entity-status (clojure.core/get-in letvar1256786 ["Status"]))) (letvar1256786 "LastUpdatedAt") (clojure.core/assoc :last-updated-at (deser-epoch-time (clojure.core/get-in letvar1256786 ["LastUpdatedAt"]))) (letvar1256786 "TrainingParameters") (clojure.core/assoc :training-parameters (deser-training-parameters (clojure.core/get-in letvar1256786 ["TrainingParameters"]))) (letvar1256786 "TrainingDataSourceId") (clojure.core/assoc :training-data-source-id (deser-entity-id (clojure.core/get-in letvar1256786 ["TrainingDataSourceId"]))) (letvar1256786 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1256786 ["Message"]))) (letvar1256786 "ComputeTime") (clojure.core/assoc :compute-time (deser-long-type (clojure.core/get-in letvar1256786 ["ComputeTime"]))) (letvar1256786 "Recipe") (clojure.core/assoc :recipe (deser-recipe (clojure.core/get-in letvar1256786 ["Recipe"]))) (letvar1256786 "CreatedAt") (clojure.core/assoc :created-at (deser-epoch-time (clojure.core/get-in letvar1256786 ["CreatedAt"]))) (letvar1256786 "ScoreThresholdLastUpdatedAt") (clojure.core/assoc :score-threshold-last-updated-at (deser-epoch-time (clojure.core/get-in letvar1256786 ["ScoreThresholdLastUpdatedAt"]))) (letvar1256786 "EndpointInfo") (clojure.core/assoc :endpoint-info (deser-realtime-endpoint-info (clojure.core/get-in letvar1256786 ["EndpointInfo"]))) (letvar1256786 "Name") (clojure.core/assoc :name (deser-ml-model-name (clojure.core/get-in letvar1256786 ["Name"]))) (letvar1256786 "InputDataLocationS3") (clojure.core/assoc :input-data-location-s-3 (deser-s-3-url (clojure.core/get-in letvar1256786 ["InputDataLocationS3"]))) (letvar1256786 "ScoreThreshold") (clojure.core/assoc :score-threshold (deser-score-threshold (clojure.core/get-in letvar1256786 ["ScoreThreshold"]))) (letvar1256786 "StartedAt") (clojure.core/assoc :started-at (deser-epoch-time (clojure.core/get-in letvar1256786 ["StartedAt"])))))))

(clojure.core/defn- response-tag-limit-exceeded-exception ([input] (response-tag-limit-exceeded-exception nil input)) ([resultWrapper1256788 input] (clojure.core/let [rawinput1256787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256789 {"message" (rawinput1256787 "message")}] (clojure.core/cond-> {} (letvar1256789 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256789 ["message"])))))))

(clojure.core/defn- response-update-ml-model-output ([input] (response-update-ml-model-output nil input)) ([resultWrapper1256791 input] (clojure.core/let [rawinput1256790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256792 {"MLModelId" (rawinput1256790 "MLModelId")}] (clojure.core/cond-> {} (letvar1256792 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256792 ["MLModelId"])))))))

(clojure.core/defn- response-describe-batch-predictions-output ([input] (response-describe-batch-predictions-output nil input)) ([resultWrapper1256794 input] (clojure.core/let [rawinput1256793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256795 {"Results" (rawinput1256793 "Results"), "NextToken" (rawinput1256793 "NextToken")}] (clojure.core/cond-> {} (letvar1256795 "Results") (clojure.core/assoc :results (deser-batch-predictions (clojure.core/get-in letvar1256795 ["Results"]))) (letvar1256795 "NextToken") (clojure.core/assoc :next-token (deser-string-type (clojure.core/get-in letvar1256795 ["NextToken"])))))))

(clojure.core/defn- response-update-batch-prediction-output ([input] (response-update-batch-prediction-output nil input)) ([resultWrapper1256797 input] (clojure.core/let [rawinput1256796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256798 {"BatchPredictionId" (rawinput1256796 "BatchPredictionId")}] (clojure.core/cond-> {} (letvar1256798 "BatchPredictionId") (clojure.core/assoc :batch-prediction-id (deser-entity-id (clojure.core/get-in letvar1256798 ["BatchPredictionId"])))))))

(clojure.core/defn- response-get-evaluation-output ([input] (response-get-evaluation-output nil input)) ([resultWrapper1256800 input] (clojure.core/let [rawinput1256799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256801 {"MLModelId" (rawinput1256799 "MLModelId"), "CreatedByIamUser" (rawinput1256799 "CreatedByIamUser"), "FinishedAt" (rawinput1256799 "FinishedAt"), "LogUri" (rawinput1256799 "LogUri"), "Status" (rawinput1256799 "Status"), "LastUpdatedAt" (rawinput1256799 "LastUpdatedAt"), "Message" (rawinput1256799 "Message"), "ComputeTime" (rawinput1256799 "ComputeTime"), "EvaluationId" (rawinput1256799 "EvaluationId"), "CreatedAt" (rawinput1256799 "CreatedAt"), "EvaluationDataSourceId" (rawinput1256799 "EvaluationDataSourceId"), "Name" (rawinput1256799 "Name"), "InputDataLocationS3" (rawinput1256799 "InputDataLocationS3"), "PerformanceMetrics" (rawinput1256799 "PerformanceMetrics"), "StartedAt" (rawinput1256799 "StartedAt")}] (clojure.core/cond-> {} (letvar1256801 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256801 ["MLModelId"]))) (letvar1256801 "CreatedByIamUser") (clojure.core/assoc :created-by-iam-user (deser-aws-user-arn (clojure.core/get-in letvar1256801 ["CreatedByIamUser"]))) (letvar1256801 "FinishedAt") (clojure.core/assoc :finished-at (deser-epoch-time (clojure.core/get-in letvar1256801 ["FinishedAt"]))) (letvar1256801 "LogUri") (clojure.core/assoc :log-uri (deser-presigned-s-3-url (clojure.core/get-in letvar1256801 ["LogUri"]))) (letvar1256801 "Status") (clojure.core/assoc :status (deser-entity-status (clojure.core/get-in letvar1256801 ["Status"]))) (letvar1256801 "LastUpdatedAt") (clojure.core/assoc :last-updated-at (deser-epoch-time (clojure.core/get-in letvar1256801 ["LastUpdatedAt"]))) (letvar1256801 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1256801 ["Message"]))) (letvar1256801 "ComputeTime") (clojure.core/assoc :compute-time (deser-long-type (clojure.core/get-in letvar1256801 ["ComputeTime"]))) (letvar1256801 "EvaluationId") (clojure.core/assoc :evaluation-id (deser-entity-id (clojure.core/get-in letvar1256801 ["EvaluationId"]))) (letvar1256801 "CreatedAt") (clojure.core/assoc :created-at (deser-epoch-time (clojure.core/get-in letvar1256801 ["CreatedAt"]))) (letvar1256801 "EvaluationDataSourceId") (clojure.core/assoc :evaluation-data-source-id (deser-entity-id (clojure.core/get-in letvar1256801 ["EvaluationDataSourceId"]))) (letvar1256801 "Name") (clojure.core/assoc :name (deser-entity-name (clojure.core/get-in letvar1256801 ["Name"]))) (letvar1256801 "InputDataLocationS3") (clojure.core/assoc :input-data-location-s-3 (deser-s-3-url (clojure.core/get-in letvar1256801 ["InputDataLocationS3"]))) (letvar1256801 "PerformanceMetrics") (clojure.core/assoc :performance-metrics (deser-performance-metrics (clojure.core/get-in letvar1256801 ["PerformanceMetrics"]))) (letvar1256801 "StartedAt") (clojure.core/assoc :started-at (deser-epoch-time (clojure.core/get-in letvar1256801 ["StartedAt"])))))))

(clojure.core/defn- response-update-data-source-output ([input] (response-update-data-source-output nil input)) ([resultWrapper1256803 input] (clojure.core/let [rawinput1256802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256804 {"DataSourceId" (rawinput1256802 "DataSourceId")}] (clojure.core/cond-> {} (letvar1256804 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256804 ["DataSourceId"])))))))

(clojure.core/defn- response-create-data-source-from-redshift-output ([input] (response-create-data-source-from-redshift-output nil input)) ([resultWrapper1256806 input] (clojure.core/let [rawinput1256805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256807 {"DataSourceId" (rawinput1256805 "DataSourceId")}] (clojure.core/cond-> {} (letvar1256807 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256807 ["DataSourceId"])))))))

(clojure.core/defn- response-create-data-source-from-s-3-output ([input] (response-create-data-source-from-s-3-output nil input)) ([resultWrapper1256809 input] (clojure.core/let [rawinput1256808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256810 {"DataSourceId" (rawinput1256808 "DataSourceId")}] (clojure.core/cond-> {} (letvar1256810 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256810 ["DataSourceId"])))))))

(clojure.core/defn- response-describe-ml-models-output ([input] (response-describe-ml-models-output nil input)) ([resultWrapper1256812 input] (clojure.core/let [rawinput1256811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256813 {"Results" (rawinput1256811 "Results"), "NextToken" (rawinput1256811 "NextToken")}] (clojure.core/cond-> {} (letvar1256813 "Results") (clojure.core/assoc :results (deser-ml-models (clojure.core/get-in letvar1256813 ["Results"]))) (letvar1256813 "NextToken") (clojure.core/assoc :next-token (deser-string-type (clojure.core/get-in letvar1256813 ["NextToken"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1256815 input] (clojure.core/let [rawinput1256814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256816 {"message" (rawinput1256814 "message")}] (clojure.core/cond-> {} (letvar1256816 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256816 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1256818 input] (clojure.core/let [rawinput1256817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256819 {"message" (rawinput1256817 "message"), "code" (rawinput1256817 "code")}] (clojure.core/cond-> {} (letvar1256819 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256819 ["message"]))) (letvar1256819 "code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar1256819 ["code"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1256821 input] (clojure.core/let [rawinput1256820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256822 {"message" (rawinput1256820 "message"), "code" (rawinput1256820 "code")}] (clojure.core/cond-> {} (letvar1256822 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256822 ["message"]))) (letvar1256822 "code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar1256822 ["code"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper1256824 input] (clojure.core/let [rawinput1256823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256825 {"message" (rawinput1256823 "message"), "code" (rawinput1256823 "code")}] (clojure.core/cond-> {} (letvar1256825 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256825 ["message"]))) (letvar1256825 "code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar1256825 ["code"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1256827 input] (clojure.core/let [rawinput1256826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256828 {"message" (rawinput1256826 "message"), "code" (rawinput1256826 "code")}] (clojure.core/cond-> {} (letvar1256828 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256828 ["message"]))) (letvar1256828 "code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar1256828 ["code"])))))))

(clojure.core/defn- response-delete-batch-prediction-output ([input] (response-delete-batch-prediction-output nil input)) ([resultWrapper1256830 input] (clojure.core/let [rawinput1256829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256831 {"BatchPredictionId" (rawinput1256829 "BatchPredictionId")}] (clojure.core/cond-> {} (letvar1256831 "BatchPredictionId") (clojure.core/assoc :batch-prediction-id (deser-entity-id (clojure.core/get-in letvar1256831 ["BatchPredictionId"])))))))

(clojure.core/defn- response-create-data-source-from-rds-output ([input] (response-create-data-source-from-rds-output nil input)) ([resultWrapper1256833 input] (clojure.core/let [rawinput1256832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256834 {"DataSourceId" (rawinput1256832 "DataSourceId")}] (clojure.core/cond-> {} (letvar1256834 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256834 ["DataSourceId"])))))))

(clojure.core/defn- response-describe-tags-output ([input] (response-describe-tags-output nil input)) ([resultWrapper1256836 input] (clojure.core/let [rawinput1256835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256837 {"ResourceId" (rawinput1256835 "ResourceId"), "ResourceType" (rawinput1256835 "ResourceType"), "Tags" (rawinput1256835 "Tags")}] (clojure.core/cond-> {} (letvar1256837 "ResourceId") (clojure.core/assoc :resource-id (deser-entity-id (clojure.core/get-in letvar1256837 ["ResourceId"]))) (letvar1256837 "ResourceType") (clojure.core/assoc :resource-type (deser-taggable-resource-type (clojure.core/get-in letvar1256837 ["ResourceType"]))) (letvar1256837 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1256837 ["Tags"])))))))

(clojure.core/defn- response-create-batch-prediction-output ([input] (response-create-batch-prediction-output nil input)) ([resultWrapper1256839 input] (clojure.core/let [rawinput1256838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256840 {"BatchPredictionId" (rawinput1256838 "BatchPredictionId")}] (clojure.core/cond-> {} (letvar1256840 "BatchPredictionId") (clojure.core/assoc :batch-prediction-id (deser-entity-id (clojure.core/get-in letvar1256840 ["BatchPredictionId"])))))))

(clojure.core/defn- response-delete-data-source-output ([input] (response-delete-data-source-output nil input)) ([resultWrapper1256842 input] (clojure.core/let [rawinput1256841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256843 {"DataSourceId" (rawinput1256841 "DataSourceId")}] (clojure.core/cond-> {} (letvar1256843 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256843 ["DataSourceId"])))))))

(clojure.core/defn- response-create-evaluation-output ([input] (response-create-evaluation-output nil input)) ([resultWrapper1256845 input] (clojure.core/let [rawinput1256844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256846 {"EvaluationId" (rawinput1256844 "EvaluationId")}] (clojure.core/cond-> {} (letvar1256846 "EvaluationId") (clojure.core/assoc :evaluation-id (deser-entity-id (clojure.core/get-in letvar1256846 ["EvaluationId"])))))))

(clojure.core/defn- response-describe-evaluations-output ([input] (response-describe-evaluations-output nil input)) ([resultWrapper1256848 input] (clojure.core/let [rawinput1256847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256849 {"Results" (rawinput1256847 "Results"), "NextToken" (rawinput1256847 "NextToken")}] (clojure.core/cond-> {} (letvar1256849 "Results") (clojure.core/assoc :results (deser-evaluations (clojure.core/get-in letvar1256849 ["Results"]))) (letvar1256849 "NextToken") (clojure.core/assoc :next-token (deser-string-type (clojure.core/get-in letvar1256849 ["NextToken"])))))))

(clojure.core/defn- response-delete-ml-model-output ([input] (response-delete-ml-model-output nil input)) ([resultWrapper1256851 input] (clojure.core/let [rawinput1256850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256852 {"MLModelId" (rawinput1256850 "MLModelId")}] (clojure.core/cond-> {} (letvar1256852 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256852 ["MLModelId"])))))))

(clojure.core/defn- response-delete-evaluation-output ([input] (response-delete-evaluation-output nil input)) ([resultWrapper1256854 input] (clojure.core/let [rawinput1256853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256855 {"EvaluationId" (rawinput1256853 "EvaluationId")}] (clojure.core/cond-> {} (letvar1256855 "EvaluationId") (clojure.core/assoc :evaluation-id (deser-entity-id (clojure.core/get-in letvar1256855 ["EvaluationId"])))))))

(clojure.core/defn- response-delete-realtime-endpoint-output ([input] (response-delete-realtime-endpoint-output nil input)) ([resultWrapper1256857 input] (clojure.core/let [rawinput1256856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256858 {"MLModelId" (rawinput1256856 "MLModelId"), "RealtimeEndpointInfo" (rawinput1256856 "RealtimeEndpointInfo")}] (clojure.core/cond-> {} (letvar1256858 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256858 ["MLModelId"]))) (letvar1256858 "RealtimeEndpointInfo") (clojure.core/assoc :realtime-endpoint-info (deser-realtime-endpoint-info (clojure.core/get-in letvar1256858 ["RealtimeEndpointInfo"])))))))

(clojure.core/defn- response-predict-output ([input] (response-predict-output nil input)) ([resultWrapper1256860 input] (clojure.core/let [rawinput1256859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256861 {"Prediction" (rawinput1256859 "Prediction")}] (clojure.core/cond-> {} (letvar1256861 "Prediction") (clojure.core/assoc :prediction (deser-prediction (clojure.core/get-in letvar1256861 ["Prediction"])))))))

(clojure.core/defn- response-create-realtime-endpoint-output ([input] (response-create-realtime-endpoint-output nil input)) ([resultWrapper1256863 input] (clojure.core/let [rawinput1256862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256864 {"MLModelId" (rawinput1256862 "MLModelId"), "RealtimeEndpointInfo" (rawinput1256862 "RealtimeEndpointInfo")}] (clojure.core/cond-> {} (letvar1256864 "MLModelId") (clojure.core/assoc :ml-model-id (deser-entity-id (clojure.core/get-in letvar1256864 ["MLModelId"]))) (letvar1256864 "RealtimeEndpointInfo") (clojure.core/assoc :realtime-endpoint-info (deser-realtime-endpoint-info (clojure.core/get-in letvar1256864 ["RealtimeEndpointInfo"])))))))

(clojure.core/defn- response-describe-data-sources-output ([input] (response-describe-data-sources-output nil input)) ([resultWrapper1256866 input] (clojure.core/let [rawinput1256865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256867 {"Results" (rawinput1256865 "Results"), "NextToken" (rawinput1256865 "NextToken")}] (clojure.core/cond-> {} (letvar1256867 "Results") (clojure.core/assoc :results (deser-data-sources (clojure.core/get-in letvar1256867 ["Results"]))) (letvar1256867 "NextToken") (clojure.core/assoc :next-token (deser-string-type (clojure.core/get-in letvar1256867 ["NextToken"])))))))

(clojure.core/defn- response-predictor-not-mounted-exception ([input] (response-predictor-not-mounted-exception nil input)) ([resultWrapper1256869 input] (clojure.core/let [rawinput1256868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256870 {"message" (rawinput1256868 "message")}] (clojure.core/cond-> {} (letvar1256870 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1256870 ["message"])))))))

(clojure.core/defn- response-get-data-source-output ([input] (response-get-data-source-output nil input)) ([resultWrapper1256872 input] (clojure.core/let [rawinput1256871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1256873 {"CreatedByIamUser" (rawinput1256871 "CreatedByIamUser"), "ComputeStatistics" (rawinput1256871 "ComputeStatistics"), "DataSourceSchema" (rawinput1256871 "DataSourceSchema"), "RoleARN" (rawinput1256871 "RoleARN"), "FinishedAt" (rawinput1256871 "FinishedAt"), "LogUri" (rawinput1256871 "LogUri"), "DataRearrangement" (rawinput1256871 "DataRearrangement"), "RDSMetadata" (rawinput1256871 "RDSMetadata"), "DataSourceId" (rawinput1256871 "DataSourceId"), "Status" (rawinput1256871 "Status"), "LastUpdatedAt" (rawinput1256871 "LastUpdatedAt"), "DataLocationS3" (rawinput1256871 "DataLocationS3"), "Message" (rawinput1256871 "Message"), "ComputeTime" (rawinput1256871 "ComputeTime"), "NumberOfFiles" (rawinput1256871 "NumberOfFiles"), "CreatedAt" (rawinput1256871 "CreatedAt"), "RedshiftMetadata" (rawinput1256871 "RedshiftMetadata"), "Name" (rawinput1256871 "Name"), "DataSizeInBytes" (rawinput1256871 "DataSizeInBytes"), "StartedAt" (rawinput1256871 "StartedAt")}] (clojure.core/cond-> {} (letvar1256873 "CreatedByIamUser") (clojure.core/assoc :created-by-iam-user (deser-aws-user-arn (clojure.core/get-in letvar1256873 ["CreatedByIamUser"]))) (letvar1256873 "ComputeStatistics") (clojure.core/assoc :compute-statistics (deser-compute-statistics (clojure.core/get-in letvar1256873 ["ComputeStatistics"]))) (letvar1256873 "DataSourceSchema") (clojure.core/assoc :data-source-schema (deser-data-schema (clojure.core/get-in letvar1256873 ["DataSourceSchema"]))) (letvar1256873 "RoleARN") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1256873 ["RoleARN"]))) (letvar1256873 "FinishedAt") (clojure.core/assoc :finished-at (deser-epoch-time (clojure.core/get-in letvar1256873 ["FinishedAt"]))) (letvar1256873 "LogUri") (clojure.core/assoc :log-uri (deser-presigned-s-3-url (clojure.core/get-in letvar1256873 ["LogUri"]))) (letvar1256873 "DataRearrangement") (clojure.core/assoc :data-rearrangement (deser-data-rearrangement (clojure.core/get-in letvar1256873 ["DataRearrangement"]))) (letvar1256873 "RDSMetadata") (clojure.core/assoc :rds-metadata (deser-rds-metadata (clojure.core/get-in letvar1256873 ["RDSMetadata"]))) (letvar1256873 "DataSourceId") (clojure.core/assoc :data-source-id (deser-entity-id (clojure.core/get-in letvar1256873 ["DataSourceId"]))) (letvar1256873 "Status") (clojure.core/assoc :status (deser-entity-status (clojure.core/get-in letvar1256873 ["Status"]))) (letvar1256873 "LastUpdatedAt") (clojure.core/assoc :last-updated-at (deser-epoch-time (clojure.core/get-in letvar1256873 ["LastUpdatedAt"]))) (letvar1256873 "DataLocationS3") (clojure.core/assoc :data-location-s-3 (deser-s-3-url (clojure.core/get-in letvar1256873 ["DataLocationS3"]))) (letvar1256873 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1256873 ["Message"]))) (letvar1256873 "ComputeTime") (clojure.core/assoc :compute-time (deser-long-type (clojure.core/get-in letvar1256873 ["ComputeTime"]))) (letvar1256873 "NumberOfFiles") (clojure.core/assoc :number-of-files (deser-long-type (clojure.core/get-in letvar1256873 ["NumberOfFiles"]))) (letvar1256873 "CreatedAt") (clojure.core/assoc :created-at (deser-epoch-time (clojure.core/get-in letvar1256873 ["CreatedAt"]))) (letvar1256873 "RedshiftMetadata") (clojure.core/assoc :redshift-metadata (deser-redshift-metadata (clojure.core/get-in letvar1256873 ["RedshiftMetadata"]))) (letvar1256873 "Name") (clojure.core/assoc :name (deser-entity-name (clojure.core/get-in letvar1256873 ["Name"]))) (letvar1256873 "DataSizeInBytes") (clojure.core/assoc :data-size-in-bytes (deser-long-type (clojure.core/get-in letvar1256873 ["DataSizeInBytes"]))) (letvar1256873 "StartedAt") (clojure.core/assoc :started-at (deser-epoch-time (clojure.core/get-in letvar1256873 ["StartedAt"])))))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/redshift-database-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/edp-pipeline-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/rds-database-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 110))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/entity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*|^$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/edp-resource-role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/data-schema (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 131071))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/aws-user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]+:((user/.+)|(root))" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/comparator-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*|^$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/redshift-select-sql-query (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16777216))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/redshift-database-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/edp-security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/ml-model-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/recipe (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 131071))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/edp-service-role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/details-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/redshift-cluster-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/edp-subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/rds-database-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 8 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/s-3-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"s3://([^/]+)(/.*)?" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.machinelearning/rds-select-sql-query (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16777216))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/redshift-database-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 8 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/rds-instance-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/entity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/vip-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"https://[a-zA-Z0-9-.]*\.amazon(aws)?\.com[/]?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.machinelearning/rds-database-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
