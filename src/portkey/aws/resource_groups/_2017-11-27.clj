...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1433961 input] (clojure.core/let [rawinput1433960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433962 {"Message" (rawinput1433960 "Message")}] (clojure.core/cond-> {} (letvar1433962 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433962 ["Message"])))))))

(clojure.core/defn- response-method-not-allowed-exception ([input] (response-method-not-allowed-exception nil input)) ([resultWrapper1433964 input] (clojure.core/let [rawinput1433963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433965 {"Message" (rawinput1433963 "Message")}] (clojure.core/cond-> {} (letvar1433965 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433965 ["Message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1433967 input] (clojure.core/let [rawinput1433966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433968 {"Message" (rawinput1433966 "Message")}] (clojure.core/cond-> {} (letvar1433968 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433968 ["Message"])))))))

(clojure.core/defn- response-update-group-output ([input] (response-update-group-output nil input)) ([resultWrapper1433970 input] (clojure.core/let [rawinput1433969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433971 {"Group" (rawinput1433969 "Group")}] (clojure.core/cond-> {} (letvar1433971 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1433971 ["Group"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1433973 input] (clojure.core/let [rawinput1433972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433974 {"Message" (rawinput1433972 "Message")}] (clojure.core/cond-> {} (letvar1433974 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433974 ["Message"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1433976 input] (clojure.core/let [rawinput1433975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433977 {"Message" (rawinput1433975 "Message")}] (clojure.core/cond-> {} (letvar1433977 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433977 ["Message"])))))))

(clojure.core/defn- response-update-group-query-output ([input] (response-update-group-query-output nil input)) ([resultWrapper1433979 input] (clojure.core/let [rawinput1433978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433980 {"GroupQuery" (rawinput1433978 "GroupQuery")}] (clojure.core/cond-> {} (letvar1433980 "GroupQuery") (clojure.core/assoc :group-query (deser-group-query (clojure.core/get-in letvar1433980 ["GroupQuery"])))))))

(clojure.core/defn- response-untag-output ([input] (response-untag-output nil input)) ([resultWrapper1433982 input] (clojure.core/let [rawinput1433981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433983 {"Arn" (rawinput1433981 "Arn"), "Keys" (rawinput1433981 "Keys")}] (clojure.core/cond-> {} (letvar1433983 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar1433983 ["Arn"]))) (letvar1433983 "Keys") (clojure.core/assoc :keys (deser-tag-key-list (clojure.core/get-in letvar1433983 ["Keys"])))))))

(clojure.core/defn- response-list-group-resources-output ([input] (response-list-group-resources-output nil input)) ([resultWrapper1433985 input] (clojure.core/let [rawinput1433984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433986 {"ResourceIdentifiers" (rawinput1433984 "ResourceIdentifiers"), "NextToken" (rawinput1433984 "NextToken"), "QueryErrors" (rawinput1433984 "QueryErrors")}] (clojure.core/cond-> {} (letvar1433986 "ResourceIdentifiers") (clojure.core/assoc :resource-identifiers (deser-resource-identifier-list (clojure.core/get-in letvar1433986 ["ResourceIdentifiers"]))) (letvar1433986 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1433986 ["NextToken"]))) (letvar1433986 "QueryErrors") (clojure.core/assoc :query-errors (deser-query-error-list (clojure.core/get-in letvar1433986 ["QueryErrors"])))))))

(clojure.core/defn- response-list-groups-output ([input] (response-list-groups-output nil input)) ([resultWrapper1433988 input] (clojure.core/let [rawinput1433987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433989 {"GroupIdentifiers" (rawinput1433987 "GroupIdentifiers"), "Groups" (rawinput1433987 "Groups"), "NextToken" (rawinput1433987 "NextToken")}] (clojure.core/cond-> {} (letvar1433989 "GroupIdentifiers") (clojure.core/assoc :group-identifiers (deser-group-identifier-list (clojure.core/get-in letvar1433989 ["GroupIdentifiers"]))) (letvar1433989 "Groups") (clojure.core/assoc :groups (deser-group-list (clojure.core/get-in letvar1433989 ["Groups"]))) (letvar1433989 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1433989 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1433991 input] (clojure.core/let [rawinput1433990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433992 {"Message" (rawinput1433990 "Message")}] (clojure.core/cond-> {} (letvar1433992 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1433992 ["Message"])))))))

(clojure.core/defn- response-tag-output ([input] (response-tag-output nil input)) ([resultWrapper1433994 input] (clojure.core/let [rawinput1433993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433995 {"Arn" (rawinput1433993 "Arn"), "Tags" (rawinput1433993 "Tags")}] (clojure.core/cond-> {} (letvar1433995 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar1433995 ["Arn"]))) (letvar1433995 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1433995 ["Tags"])))))))

(clojure.core/defn- response-search-resources-output ([input] (response-search-resources-output nil input)) ([resultWrapper1433997 input] (clojure.core/let [rawinput1433996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1433998 {"ResourceIdentifiers" (rawinput1433996 "ResourceIdentifiers"), "NextToken" (rawinput1433996 "NextToken"), "QueryErrors" (rawinput1433996 "QueryErrors")}] (clojure.core/cond-> {} (letvar1433998 "ResourceIdentifiers") (clojure.core/assoc :resource-identifiers (deser-resource-identifier-list (clojure.core/get-in letvar1433998 ["ResourceIdentifiers"]))) (letvar1433998 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1433998 ["NextToken"]))) (letvar1433998 "QueryErrors") (clojure.core/assoc :query-errors (deser-query-error-list (clojure.core/get-in letvar1433998 ["QueryErrors"])))))))

(clojure.core/defn- response-get-group-output ([input] (response-get-group-output nil input)) ([resultWrapper1434000 input] (clojure.core/let [rawinput1433999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434001 {"Group" (rawinput1433999 "Group")}] (clojure.core/cond-> {} (letvar1434001 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1434001 ["Group"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1434003 input] (clojure.core/let [rawinput1434002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434004 {"Message" (rawinput1434002 "Message")}] (clojure.core/cond-> {} (letvar1434004 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1434004 ["Message"])))))))

(clojure.core/defn- response-create-group-output ([input] (response-create-group-output nil input)) ([resultWrapper1434006 input] (clojure.core/let [rawinput1434005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434007 {"Group" (rawinput1434005 "Group"), "ResourceQuery" (rawinput1434005 "ResourceQuery"), "Tags" (rawinput1434005 "Tags")}] (clojure.core/cond-> {} (letvar1434007 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1434007 ["Group"]))) (letvar1434007 "ResourceQuery") (clojure.core/assoc :resource-query (deser-resource-query (clojure.core/get-in letvar1434007 ["ResourceQuery"]))) (letvar1434007 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1434007 ["Tags"])))))))

(clojure.core/defn- response-get-tags-output ([input] (response-get-tags-output nil input)) ([resultWrapper1434009 input] (clojure.core/let [rawinput1434008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434010 {"Arn" (rawinput1434008 "Arn"), "Tags" (rawinput1434008 "Tags")}] (clojure.core/cond-> {} (letvar1434010 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar1434010 ["Arn"]))) (letvar1434010 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1434010 ["Tags"])))))))

(clojure.core/defn- response-get-group-query-output ([input] (response-get-group-query-output nil input)) ([resultWrapper1434012 input] (clojure.core/let [rawinput1434011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434013 {"GroupQuery" (rawinput1434011 "GroupQuery")}] (clojure.core/cond-> {} (letvar1434013 "GroupQuery") (clojure.core/assoc :group-query (deser-group-query (clojure.core/get-in letvar1434013 ["GroupQuery"])))))))

(clojure.core/defn- response-delete-group-output ([input] (response-delete-group-output nil input)) ([resultWrapper1434015 input] (clojure.core/let [rawinput1434014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1434016 {"Group" (rawinput1434014 "Group")}] (clojure.core/cond-> {} (letvar1434016 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1434016 ["Group"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/query (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/group-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/group-filter-name #{:resourcetype "resource-type"})

(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"AWS::[a-zA-Z0-9]+::\w+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"arn:aws:[a-z0-9\-]*:([a-z]{2}-[a-z]+-\d{1})?:([0-9]{12})?:.+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/resource-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"AWS::[a-zA-Z0-9]+::[a-zA-Z0-9]+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"arn:aws:resource-groups:[a-z]{2}-[a-z]+-\d{1}:[0-9]{12}:group/[a-zA-Z0-9_\.-]{1,128}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups.-2017-11-27/group-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 512)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\sa-zA-Z0-9_\.-]*" s__1012854__auto__))))
