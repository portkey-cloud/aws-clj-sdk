...
(clojure.core/defn- response-domain-limit-exceeded ([input] (response-domain-limit-exceeded nil input)) ([resultWrapper1955444 input] (clojure.core/let [rawinput1955443 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955445 {"message" (rawinput1955443 "message")}] (clojure.core/cond-> {} (letvar1955445 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955445 ["message"])))))))

(clojure.core/defn- response-get-domain-suggestions-response ([input] (response-get-domain-suggestions-response nil input)) ([resultWrapper1955447 input] (clojure.core/let [rawinput1955446 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955448 {"SuggestionsList" (rawinput1955446 "SuggestionsList")}] (clojure.core/cond-> {} (letvar1955448 "SuggestionsList") (clojure.core/assoc :suggestions-list (deser-domain-suggestions-list (clojure.core/get-in letvar1955448 ["SuggestionsList"])))))))

(clojure.core/defn- response-update-domain-contact-response ([input] (response-update-domain-contact-response nil input)) ([resultWrapper1955450 input] (clojure.core/let [rawinput1955449 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955451 {"OperationId" (rawinput1955449 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955451 ["OperationId"]))}))))

(clojure.core/defn- response-get-domain-detail-response ([input] (response-get-domain-detail-response nil input)) ([resultWrapper1955453 input] (clojure.core/let [rawinput1955452 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955454 {"WhoIsServer" (rawinput1955452 "WhoIsServer"), "DnsSec" (rawinput1955452 "DnsSec"), "AdminContact" (rawinput1955452 "AdminContact"), "AdminPrivacy" (rawinput1955452 "AdminPrivacy"), "TechContact" (rawinput1955452 "TechContact"), "RegistryDomainId" (rawinput1955452 "RegistryDomainId"), "RegistrantPrivacy" (rawinput1955452 "RegistrantPrivacy"), "RegistrantContact" (rawinput1955452 "RegistrantContact"), "ExpirationDate" (rawinput1955452 "ExpirationDate"), "Nameservers" (rawinput1955452 "Nameservers"), "AbuseContactEmail" (rawinput1955452 "AbuseContactEmail"), "AutoRenew" (rawinput1955452 "AutoRenew"), "UpdatedDate" (rawinput1955452 "UpdatedDate"), "RegistrarUrl" (rawinput1955452 "RegistrarUrl"), "RegistrarName" (rawinput1955452 "RegistrarName"), "TechPrivacy" (rawinput1955452 "TechPrivacy"), "CreationDate" (rawinput1955452 "CreationDate"), "DomainName" (rawinput1955452 "DomainName"), "Reseller" (rawinput1955452 "Reseller"), "StatusList" (rawinput1955452 "StatusList"), "AbuseContactPhone" (rawinput1955452 "AbuseContactPhone")}] (clojure.core/cond-> {:domain-name (deser-domain-name (clojure.core/get-in letvar1955454 ["DomainName"])), :nameservers (deser-nameserver-list (clojure.core/get-in letvar1955454 ["Nameservers"])), :admin-contact (deser-contact-detail (clojure.core/get-in letvar1955454 ["AdminContact"])), :registrant-contact (deser-contact-detail (clojure.core/get-in letvar1955454 ["RegistrantContact"])), :tech-contact (deser-contact-detail (clojure.core/get-in letvar1955454 ["TechContact"]))} (letvar1955454 "WhoIsServer") (clojure.core/assoc :who-is-server (deser-registrar-who-is-server (clojure.core/get-in letvar1955454 ["WhoIsServer"]))) (letvar1955454 "DnsSec") (clojure.core/assoc :dns-sec (deser-dns-sec (clojure.core/get-in letvar1955454 ["DnsSec"]))) (letvar1955454 "AdminPrivacy") (clojure.core/assoc :admin-privacy (deser-boolean (clojure.core/get-in letvar1955454 ["AdminPrivacy"]))) (letvar1955454 "RegistryDomainId") (clojure.core/assoc :registry-domain-id (deser-registry-domain-id (clojure.core/get-in letvar1955454 ["RegistryDomainId"]))) (letvar1955454 "RegistrantPrivacy") (clojure.core/assoc :registrant-privacy (deser-boolean (clojure.core/get-in letvar1955454 ["RegistrantPrivacy"]))) (letvar1955454 "ExpirationDate") (clojure.core/assoc :expiration-date (deser-timestamp (clojure.core/get-in letvar1955454 ["ExpirationDate"]))) (letvar1955454 "AbuseContactEmail") (clojure.core/assoc :abuse-contact-email (deser-email (clojure.core/get-in letvar1955454 ["AbuseContactEmail"]))) (letvar1955454 "AutoRenew") (clojure.core/assoc :auto-renew (deser-boolean (clojure.core/get-in letvar1955454 ["AutoRenew"]))) (letvar1955454 "UpdatedDate") (clojure.core/assoc :updated-date (deser-timestamp (clojure.core/get-in letvar1955454 ["UpdatedDate"]))) (letvar1955454 "RegistrarUrl") (clojure.core/assoc :registrar-url (deser-registrar-url (clojure.core/get-in letvar1955454 ["RegistrarUrl"]))) (letvar1955454 "RegistrarName") (clojure.core/assoc :registrar-name (deser-registrar-name (clojure.core/get-in letvar1955454 ["RegistrarName"]))) (letvar1955454 "TechPrivacy") (clojure.core/assoc :tech-privacy (deser-boolean (clojure.core/get-in letvar1955454 ["TechPrivacy"]))) (letvar1955454 "CreationDate") (clojure.core/assoc :creation-date (deser-timestamp (clojure.core/get-in letvar1955454 ["CreationDate"]))) (letvar1955454 "Reseller") (clojure.core/assoc :reseller (deser-reseller (clojure.core/get-in letvar1955454 ["Reseller"]))) (letvar1955454 "StatusList") (clojure.core/assoc :status-list (deser-domain-status-list (clojure.core/get-in letvar1955454 ["StatusList"]))) (letvar1955454 "AbuseContactPhone") (clojure.core/assoc :abuse-contact-phone (deser-contact-number (clojure.core/get-in letvar1955454 ["AbuseContactPhone"])))))))

(clojure.core/defn- response-update-tags-for-domain-response ([input] (response-update-tags-for-domain-response nil input)) ([resultWrapper1955456 input] (clojure.core/let [rawinput1955455 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955457 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-operations-response ([input] (response-list-operations-response nil input)) ([resultWrapper1955459 input] (clojure.core/let [rawinput1955458 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955460 {"Operations" (rawinput1955458 "Operations"), "NextPageMarker" (rawinput1955458 "NextPageMarker")}] (clojure.core/cond-> {:operations (deser-operation-summary-list (clojure.core/get-in letvar1955460 ["Operations"]))} (letvar1955460 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1955460 ["NextPageMarker"])))))))

(clojure.core/defn- response-resend-contact-reachability-email-response ([input] (response-resend-contact-reachability-email-response nil input)) ([resultWrapper1955462 input] (clojure.core/let [rawinput1955461 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955463 {"domainName" (rawinput1955461 "domainName"), "emailAddress" (rawinput1955461 "emailAddress"), "isAlreadyVerified" (rawinput1955461 "isAlreadyVerified")}] (clojure.core/cond-> {} (letvar1955463 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1955463 ["domainName"]))) (letvar1955463 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1955463 ["emailAddress"]))) (letvar1955463 "isAlreadyVerified") (clojure.core/assoc :is-already-verified (deser-boolean (clojure.core/get-in letvar1955463 ["isAlreadyVerified"])))))))

(clojure.core/defn- response-view-billing-response ([input] (response-view-billing-response nil input)) ([resultWrapper1955465 input] (clojure.core/let [rawinput1955464 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955466 {"NextPageMarker" (rawinput1955464 "NextPageMarker"), "BillingRecords" (rawinput1955464 "BillingRecords")}] (clojure.core/cond-> {} (letvar1955466 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1955466 ["NextPageMarker"]))) (letvar1955466 "BillingRecords") (clojure.core/assoc :billing-records (deser-billing-records (clojure.core/get-in letvar1955466 ["BillingRecords"])))))))

(clojure.core/defn- response-check-domain-availability-response ([input] (response-check-domain-availability-response nil input)) ([resultWrapper1955468 input] (clojure.core/let [rawinput1955467 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955469 {"Availability" (rawinput1955467 "Availability")}] (clojure.core/cond-> {:availability (deser-domain-availability (clojure.core/get-in letvar1955469 ["Availability"]))}))))

(clojure.core/defn- response-register-domain-response ([input] (response-register-domain-response nil input)) ([resultWrapper1955471 input] (clojure.core/let [rawinput1955470 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955472 {"OperationId" (rawinput1955470 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955472 ["OperationId"]))}))))

(clojure.core/defn- response-get-contact-reachability-status-response ([input] (response-get-contact-reachability-status-response nil input)) ([resultWrapper1955474 input] (clojure.core/let [rawinput1955473 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955475 {"domainName" (rawinput1955473 "domainName"), "status" (rawinput1955473 "status")}] (clojure.core/cond-> {} (letvar1955475 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1955475 ["domainName"]))) (letvar1955475 "status") (clojure.core/assoc :status (deser-reachability-status (clojure.core/get-in letvar1955475 ["status"])))))))

(clojure.core/defn- response-invalid-input ([input] (response-invalid-input nil input)) ([resultWrapper1955477 input] (clojure.core/let [rawinput1955476 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955478 {"message" (rawinput1955476 "message")}] (clojure.core/cond-> {} (letvar1955478 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955478 ["message"])))))))

(clojure.core/defn- response-disable-domain-transfer-lock-response ([input] (response-disable-domain-transfer-lock-response nil input)) ([resultWrapper1955480 input] (clojure.core/let [rawinput1955479 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955481 {"OperationId" (rawinput1955479 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955481 ["OperationId"]))}))))

(clojure.core/defn- response-disable-domain-auto-renew-response ([input] (response-disable-domain-auto-renew-response nil input)) ([resultWrapper1955483 input] (clojure.core/let [rawinput1955482 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955484 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-domain-contact-privacy-response ([input] (response-update-domain-contact-privacy-response nil input)) ([resultWrapper1955486 input] (clojure.core/let [rawinput1955485 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955487 {"OperationId" (rawinput1955485 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955487 ["OperationId"]))}))))

(clojure.core/defn- response-enable-domain-transfer-lock-response ([input] (response-enable-domain-transfer-lock-response nil input)) ([resultWrapper1955489 input] (clojure.core/let [rawinput1955488 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955490 {"OperationId" (rawinput1955488 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955490 ["OperationId"]))}))))

(clojure.core/defn- response-renew-domain-response ([input] (response-renew-domain-response nil input)) ([resultWrapper1955492 input] (clojure.core/let [rawinput1955491 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955493 {"OperationId" (rawinput1955491 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955493 ["OperationId"]))}))))

(clojure.core/defn- response-list-domains-response ([input] (response-list-domains-response nil input)) ([resultWrapper1955495 input] (clojure.core/let [rawinput1955494 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955496 {"Domains" (rawinput1955494 "Domains"), "NextPageMarker" (rawinput1955494 "NextPageMarker")}] (clojure.core/cond-> {:domains (deser-domain-summary-list (clojure.core/get-in letvar1955496 ["Domains"]))} (letvar1955496 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1955496 ["NextPageMarker"])))))))

(clojure.core/defn- response-check-domain-transferability-response ([input] (response-check-domain-transferability-response nil input)) ([resultWrapper1955498 input] (clojure.core/let [rawinput1955497 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955499 {"Transferability" (rawinput1955497 "Transferability")}] (clojure.core/cond-> {:transferability (deser-domain-transferability (clojure.core/get-in letvar1955499 ["Transferability"]))}))))

(clojure.core/defn- response-enable-domain-auto-renew-response ([input] (response-enable-domain-auto-renew-response nil input)) ([resultWrapper1955501 input] (clojure.core/let [rawinput1955500 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955502 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-tags-for-domain-response ([input] (response-delete-tags-for-domain-response nil input)) ([resultWrapper1955504 input] (clojure.core/let [rawinput1955503 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955505 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tld-rules-violation ([input] (response-tld-rules-violation nil input)) ([resultWrapper1955507 input] (clojure.core/let [rawinput1955506 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955508 {"message" (rawinput1955506 "message")}] (clojure.core/cond-> {} (letvar1955508 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955508 ["message"])))))))

(clojure.core/defn- response-list-tags-for-domain-response ([input] (response-list-tags-for-domain-response nil input)) ([resultWrapper1955510 input] (clojure.core/let [rawinput1955509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955511 {"TagList" (rawinput1955509 "TagList")}] (clojure.core/cond-> {:tag-list (deser-tag-list (clojure.core/get-in letvar1955511 ["TagList"]))}))))

(clojure.core/defn- response-unsupported-tld ([input] (response-unsupported-tld nil input)) ([resultWrapper1955513 input] (clojure.core/let [rawinput1955512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955514 {"message" (rawinput1955512 "message")}] (clojure.core/cond-> {} (letvar1955514 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955514 ["message"])))))))

(clojure.core/defn- response-retrieve-domain-auth-code-response ([input] (response-retrieve-domain-auth-code-response nil input)) ([resultWrapper1955516 input] (clojure.core/let [rawinput1955515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955517 {"AuthCode" (rawinput1955515 "AuthCode")}] (clojure.core/cond-> {:auth-code (deser-domain-auth-code (clojure.core/get-in letvar1955517 ["AuthCode"]))}))))

(clojure.core/defn- response-operation-limit-exceeded ([input] (response-operation-limit-exceeded nil input)) ([resultWrapper1955519 input] (clojure.core/let [rawinput1955518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955520 {"message" (rawinput1955518 "message")}] (clojure.core/cond-> {} (letvar1955520 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955520 ["message"])))))))

(clojure.core/defn- response-transfer-domain-response ([input] (response-transfer-domain-response nil input)) ([resultWrapper1955522 input] (clojure.core/let [rawinput1955521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955523 {"OperationId" (rawinput1955521 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955523 ["OperationId"]))}))))

(clojure.core/defn- response-get-operation-detail-response ([input] (response-get-operation-detail-response nil input)) ([resultWrapper1955525 input] (clojure.core/let [rawinput1955524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955526 {"OperationId" (rawinput1955524 "OperationId"), "Status" (rawinput1955524 "Status"), "Message" (rawinput1955524 "Message"), "DomainName" (rawinput1955524 "DomainName"), "Type" (rawinput1955524 "Type"), "SubmittedDate" (rawinput1955524 "SubmittedDate")}] (clojure.core/cond-> {} (letvar1955526 "OperationId") (clojure.core/assoc :operation-id (deser-operation-id (clojure.core/get-in letvar1955526 ["OperationId"]))) (letvar1955526 "Status") (clojure.core/assoc :status (deser-operation-status (clojure.core/get-in letvar1955526 ["Status"]))) (letvar1955526 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955526 ["Message"]))) (letvar1955526 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1955526 ["DomainName"]))) (letvar1955526 "Type") (clojure.core/assoc :type (deser-operation-type (clojure.core/get-in letvar1955526 ["Type"]))) (letvar1955526 "SubmittedDate") (clojure.core/assoc :submitted-date (deser-timestamp (clojure.core/get-in letvar1955526 ["SubmittedDate"])))))))

(clojure.core/defn- response-update-domain-nameservers-response ([input] (response-update-domain-nameservers-response nil input)) ([resultWrapper1955528 input] (clojure.core/let [rawinput1955527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955529 {"OperationId" (rawinput1955527 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1955529 ["OperationId"]))}))))

(clojure.core/defn- response-duplicate-request ([input] (response-duplicate-request nil input)) ([resultWrapper1955531 input] (clojure.core/let [rawinput1955530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1955532 {"message" (rawinput1955530 "message")}] (clojure.core/cond-> {} (letvar1955532 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1955532 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/contact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/zip-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/extra-param-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/lang-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/contact-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/operation-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/address-line (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/glue-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 45))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/city (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/domain-auth-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/host-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\-.]*" s__1410940__auto__))))
