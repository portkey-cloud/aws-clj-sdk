...
(clojure.core/defn- response-domain-limit-exceeded ([input] (response-domain-limit-exceeded nil input)) ([resultWrapper1592018 input] (clojure.core/let [rawinput1592017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592019 {"message" (rawinput1592017 "message")}] (clojure.core/cond-> {} (letvar1592019 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592019 ["message"])))))))

(clojure.core/defn- response-get-domain-suggestions-response ([input] (response-get-domain-suggestions-response nil input)) ([resultWrapper1592021 input] (clojure.core/let [rawinput1592020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592022 {"SuggestionsList" (rawinput1592020 "SuggestionsList")}] (clojure.core/cond-> {} (letvar1592022 "SuggestionsList") (clojure.core/assoc :suggestions-list (deser-domain-suggestions-list (clojure.core/get-in letvar1592022 ["SuggestionsList"])))))))

(clojure.core/defn- response-update-domain-contact-response ([input] (response-update-domain-contact-response nil input)) ([resultWrapper1592024 input] (clojure.core/let [rawinput1592023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592025 {"OperationId" (rawinput1592023 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592025 ["OperationId"]))}))))

(clojure.core/defn- response-get-domain-detail-response ([input] (response-get-domain-detail-response nil input)) ([resultWrapper1592027 input] (clojure.core/let [rawinput1592026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592028 {"WhoIsServer" (rawinput1592026 "WhoIsServer"), "DnsSec" (rawinput1592026 "DnsSec"), "AdminContact" (rawinput1592026 "AdminContact"), "AdminPrivacy" (rawinput1592026 "AdminPrivacy"), "TechContact" (rawinput1592026 "TechContact"), "RegistryDomainId" (rawinput1592026 "RegistryDomainId"), "RegistrantPrivacy" (rawinput1592026 "RegistrantPrivacy"), "RegistrantContact" (rawinput1592026 "RegistrantContact"), "ExpirationDate" (rawinput1592026 "ExpirationDate"), "Nameservers" (rawinput1592026 "Nameservers"), "AbuseContactEmail" (rawinput1592026 "AbuseContactEmail"), "AutoRenew" (rawinput1592026 "AutoRenew"), "UpdatedDate" (rawinput1592026 "UpdatedDate"), "RegistrarUrl" (rawinput1592026 "RegistrarUrl"), "RegistrarName" (rawinput1592026 "RegistrarName"), "TechPrivacy" (rawinput1592026 "TechPrivacy"), "CreationDate" (rawinput1592026 "CreationDate"), "DomainName" (rawinput1592026 "DomainName"), "Reseller" (rawinput1592026 "Reseller"), "StatusList" (rawinput1592026 "StatusList"), "AbuseContactPhone" (rawinput1592026 "AbuseContactPhone")}] (clojure.core/cond-> {:domain-name (deser-domain-name (clojure.core/get-in letvar1592028 ["DomainName"])), :nameservers (deser-nameserver-list (clojure.core/get-in letvar1592028 ["Nameservers"])), :admin-contact (deser-contact-detail (clojure.core/get-in letvar1592028 ["AdminContact"])), :registrant-contact (deser-contact-detail (clojure.core/get-in letvar1592028 ["RegistrantContact"])), :tech-contact (deser-contact-detail (clojure.core/get-in letvar1592028 ["TechContact"]))} (letvar1592028 "WhoIsServer") (clojure.core/assoc :who-is-server (deser-registrar-who-is-server (clojure.core/get-in letvar1592028 ["WhoIsServer"]))) (letvar1592028 "DnsSec") (clojure.core/assoc :dns-sec (deser-dns-sec (clojure.core/get-in letvar1592028 ["DnsSec"]))) (letvar1592028 "AdminPrivacy") (clojure.core/assoc :admin-privacy (deser-boolean (clojure.core/get-in letvar1592028 ["AdminPrivacy"]))) (letvar1592028 "RegistryDomainId") (clojure.core/assoc :registry-domain-id (deser-registry-domain-id (clojure.core/get-in letvar1592028 ["RegistryDomainId"]))) (letvar1592028 "RegistrantPrivacy") (clojure.core/assoc :registrant-privacy (deser-boolean (clojure.core/get-in letvar1592028 ["RegistrantPrivacy"]))) (letvar1592028 "ExpirationDate") (clojure.core/assoc :expiration-date (deser-timestamp (clojure.core/get-in letvar1592028 ["ExpirationDate"]))) (letvar1592028 "AbuseContactEmail") (clojure.core/assoc :abuse-contact-email (deser-email (clojure.core/get-in letvar1592028 ["AbuseContactEmail"]))) (letvar1592028 "AutoRenew") (clojure.core/assoc :auto-renew (deser-boolean (clojure.core/get-in letvar1592028 ["AutoRenew"]))) (letvar1592028 "UpdatedDate") (clojure.core/assoc :updated-date (deser-timestamp (clojure.core/get-in letvar1592028 ["UpdatedDate"]))) (letvar1592028 "RegistrarUrl") (clojure.core/assoc :registrar-url (deser-registrar-url (clojure.core/get-in letvar1592028 ["RegistrarUrl"]))) (letvar1592028 "RegistrarName") (clojure.core/assoc :registrar-name (deser-registrar-name (clojure.core/get-in letvar1592028 ["RegistrarName"]))) (letvar1592028 "TechPrivacy") (clojure.core/assoc :tech-privacy (deser-boolean (clojure.core/get-in letvar1592028 ["TechPrivacy"]))) (letvar1592028 "CreationDate") (clojure.core/assoc :creation-date (deser-timestamp (clojure.core/get-in letvar1592028 ["CreationDate"]))) (letvar1592028 "Reseller") (clojure.core/assoc :reseller (deser-reseller (clojure.core/get-in letvar1592028 ["Reseller"]))) (letvar1592028 "StatusList") (clojure.core/assoc :status-list (deser-domain-status-list (clojure.core/get-in letvar1592028 ["StatusList"]))) (letvar1592028 "AbuseContactPhone") (clojure.core/assoc :abuse-contact-phone (deser-contact-number (clojure.core/get-in letvar1592028 ["AbuseContactPhone"])))))))

(clojure.core/defn- response-update-tags-for-domain-response ([input] (response-update-tags-for-domain-response nil input)) ([resultWrapper1592030 input] (clojure.core/let [rawinput1592029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592031 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-operations-response ([input] (response-list-operations-response nil input)) ([resultWrapper1592033 input] (clojure.core/let [rawinput1592032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592034 {"Operations" (rawinput1592032 "Operations"), "NextPageMarker" (rawinput1592032 "NextPageMarker")}] (clojure.core/cond-> {:operations (deser-operation-summary-list (clojure.core/get-in letvar1592034 ["Operations"]))} (letvar1592034 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1592034 ["NextPageMarker"])))))))

(clojure.core/defn- response-resend-contact-reachability-email-response ([input] (response-resend-contact-reachability-email-response nil input)) ([resultWrapper1592036 input] (clojure.core/let [rawinput1592035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592037 {"domainName" (rawinput1592035 "domainName"), "emailAddress" (rawinput1592035 "emailAddress"), "isAlreadyVerified" (rawinput1592035 "isAlreadyVerified")}] (clojure.core/cond-> {} (letvar1592037 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1592037 ["domainName"]))) (letvar1592037 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1592037 ["emailAddress"]))) (letvar1592037 "isAlreadyVerified") (clojure.core/assoc :is-already-verified (deser-boolean (clojure.core/get-in letvar1592037 ["isAlreadyVerified"])))))))

(clojure.core/defn- response-view-billing-response ([input] (response-view-billing-response nil input)) ([resultWrapper1592039 input] (clojure.core/let [rawinput1592038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592040 {"NextPageMarker" (rawinput1592038 "NextPageMarker"), "BillingRecords" (rawinput1592038 "BillingRecords")}] (clojure.core/cond-> {} (letvar1592040 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1592040 ["NextPageMarker"]))) (letvar1592040 "BillingRecords") (clojure.core/assoc :billing-records (deser-billing-records (clojure.core/get-in letvar1592040 ["BillingRecords"])))))))

(clojure.core/defn- response-check-domain-availability-response ([input] (response-check-domain-availability-response nil input)) ([resultWrapper1592042 input] (clojure.core/let [rawinput1592041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592043 {"Availability" (rawinput1592041 "Availability")}] (clojure.core/cond-> {:availability (deser-domain-availability (clojure.core/get-in letvar1592043 ["Availability"]))}))))

(clojure.core/defn- response-register-domain-response ([input] (response-register-domain-response nil input)) ([resultWrapper1592045 input] (clojure.core/let [rawinput1592044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592046 {"OperationId" (rawinput1592044 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592046 ["OperationId"]))}))))

(clojure.core/defn- response-get-contact-reachability-status-response ([input] (response-get-contact-reachability-status-response nil input)) ([resultWrapper1592048 input] (clojure.core/let [rawinput1592047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592049 {"domainName" (rawinput1592047 "domainName"), "status" (rawinput1592047 "status")}] (clojure.core/cond-> {} (letvar1592049 "domainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1592049 ["domainName"]))) (letvar1592049 "status") (clojure.core/assoc :status (deser-reachability-status (clojure.core/get-in letvar1592049 ["status"])))))))

(clojure.core/defn- response-invalid-input ([input] (response-invalid-input nil input)) ([resultWrapper1592051 input] (clojure.core/let [rawinput1592050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592052 {"message" (rawinput1592050 "message")}] (clojure.core/cond-> {} (letvar1592052 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592052 ["message"])))))))

(clojure.core/defn- response-disable-domain-transfer-lock-response ([input] (response-disable-domain-transfer-lock-response nil input)) ([resultWrapper1592054 input] (clojure.core/let [rawinput1592053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592055 {"OperationId" (rawinput1592053 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592055 ["OperationId"]))}))))

(clojure.core/defn- response-disable-domain-auto-renew-response ([input] (response-disable-domain-auto-renew-response nil input)) ([resultWrapper1592057 input] (clojure.core/let [rawinput1592056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592058 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-domain-contact-privacy-response ([input] (response-update-domain-contact-privacy-response nil input)) ([resultWrapper1592060 input] (clojure.core/let [rawinput1592059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592061 {"OperationId" (rawinput1592059 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592061 ["OperationId"]))}))))

(clojure.core/defn- response-enable-domain-transfer-lock-response ([input] (response-enable-domain-transfer-lock-response nil input)) ([resultWrapper1592063 input] (clojure.core/let [rawinput1592062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592064 {"OperationId" (rawinput1592062 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592064 ["OperationId"]))}))))

(clojure.core/defn- response-renew-domain-response ([input] (response-renew-domain-response nil input)) ([resultWrapper1592066 input] (clojure.core/let [rawinput1592065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592067 {"OperationId" (rawinput1592065 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592067 ["OperationId"]))}))))

(clojure.core/defn- response-list-domains-response ([input] (response-list-domains-response nil input)) ([resultWrapper1592069 input] (clojure.core/let [rawinput1592068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592070 {"Domains" (rawinput1592068 "Domains"), "NextPageMarker" (rawinput1592068 "NextPageMarker")}] (clojure.core/cond-> {:domains (deser-domain-summary-list (clojure.core/get-in letvar1592070 ["Domains"]))} (letvar1592070 "NextPageMarker") (clojure.core/assoc :next-page-marker (deser-page-marker (clojure.core/get-in letvar1592070 ["NextPageMarker"])))))))

(clojure.core/defn- response-check-domain-transferability-response ([input] (response-check-domain-transferability-response nil input)) ([resultWrapper1592072 input] (clojure.core/let [rawinput1592071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592073 {"Transferability" (rawinput1592071 "Transferability")}] (clojure.core/cond-> {:transferability (deser-domain-transferability (clojure.core/get-in letvar1592073 ["Transferability"]))}))))

(clojure.core/defn- response-enable-domain-auto-renew-response ([input] (response-enable-domain-auto-renew-response nil input)) ([resultWrapper1592075 input] (clojure.core/let [rawinput1592074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592076 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-tags-for-domain-response ([input] (response-delete-tags-for-domain-response nil input)) ([resultWrapper1592078 input] (clojure.core/let [rawinput1592077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592079 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tld-rules-violation ([input] (response-tld-rules-violation nil input)) ([resultWrapper1592081 input] (clojure.core/let [rawinput1592080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592082 {"message" (rawinput1592080 "message")}] (clojure.core/cond-> {} (letvar1592082 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592082 ["message"])))))))

(clojure.core/defn- response-list-tags-for-domain-response ([input] (response-list-tags-for-domain-response nil input)) ([resultWrapper1592084 input] (clojure.core/let [rawinput1592083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592085 {"TagList" (rawinput1592083 "TagList")}] (clojure.core/cond-> {:tag-list (deser-tag-list (clojure.core/get-in letvar1592085 ["TagList"]))}))))

(clojure.core/defn- response-unsupported-tld ([input] (response-unsupported-tld nil input)) ([resultWrapper1592087 input] (clojure.core/let [rawinput1592086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592088 {"message" (rawinput1592086 "message")}] (clojure.core/cond-> {} (letvar1592088 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592088 ["message"])))))))

(clojure.core/defn- response-retrieve-domain-auth-code-response ([input] (response-retrieve-domain-auth-code-response nil input)) ([resultWrapper1592090 input] (clojure.core/let [rawinput1592089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592091 {"AuthCode" (rawinput1592089 "AuthCode")}] (clojure.core/cond-> {:auth-code (deser-domain-auth-code (clojure.core/get-in letvar1592091 ["AuthCode"]))}))))

(clojure.core/defn- response-operation-limit-exceeded ([input] (response-operation-limit-exceeded nil input)) ([resultWrapper1592093 input] (clojure.core/let [rawinput1592092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592094 {"message" (rawinput1592092 "message")}] (clojure.core/cond-> {} (letvar1592094 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592094 ["message"])))))))

(clojure.core/defn- response-transfer-domain-response ([input] (response-transfer-domain-response nil input)) ([resultWrapper1592096 input] (clojure.core/let [rawinput1592095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592097 {"OperationId" (rawinput1592095 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592097 ["OperationId"]))}))))

(clojure.core/defn- response-get-operation-detail-response ([input] (response-get-operation-detail-response nil input)) ([resultWrapper1592099 input] (clojure.core/let [rawinput1592098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592100 {"OperationId" (rawinput1592098 "OperationId"), "Status" (rawinput1592098 "Status"), "Message" (rawinput1592098 "Message"), "DomainName" (rawinput1592098 "DomainName"), "Type" (rawinput1592098 "Type"), "SubmittedDate" (rawinput1592098 "SubmittedDate")}] (clojure.core/cond-> {} (letvar1592100 "OperationId") (clojure.core/assoc :operation-id (deser-operation-id (clojure.core/get-in letvar1592100 ["OperationId"]))) (letvar1592100 "Status") (clojure.core/assoc :status (deser-operation-status (clojure.core/get-in letvar1592100 ["Status"]))) (letvar1592100 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592100 ["Message"]))) (letvar1592100 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1592100 ["DomainName"]))) (letvar1592100 "Type") (clojure.core/assoc :type (deser-operation-type (clojure.core/get-in letvar1592100 ["Type"]))) (letvar1592100 "SubmittedDate") (clojure.core/assoc :submitted-date (deser-timestamp (clojure.core/get-in letvar1592100 ["SubmittedDate"])))))))

(clojure.core/defn- response-update-domain-nameservers-response ([input] (response-update-domain-nameservers-response nil input)) ([resultWrapper1592102 input] (clojure.core/let [rawinput1592101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592103 {"OperationId" (rawinput1592101 "OperationId")}] (clojure.core/cond-> {:operation-id (deser-operation-id (clojure.core/get-in letvar1592103 ["OperationId"]))}))))

(clojure.core/defn- response-duplicate-request ([input] (response-duplicate-request nil input)) ([resultWrapper1592105 input] (clojure.core/let [rawinput1592104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1592106 {"message" (rawinput1592104 "message")}] (clojure.core/cond-> {} (letvar1592106 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1592106 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/contact-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/zip-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/extra-param-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/lang-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/contact-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/operation-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/address-line (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/glue-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 45))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/city (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/domain-auth-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53domains.-2014-05-15/host-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\-.]*" s__21078__auto__))))
