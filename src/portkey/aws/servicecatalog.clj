...
(clojure.core/defn- response-list-service-actions-output ([input] (response-list-service-actions-output nil input)) ([resultWrapper2009605 input] (clojure.core/let [rawinput2009604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009606 {"ServiceActionSummaries" (rawinput2009604 "ServiceActionSummaries"), "NextPageToken" (rawinput2009604 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009606 "ServiceActionSummaries") (clojure.core/assoc :service-action-summaries (deser-service-action-summaries (clojure.core/get-in letvar2009606 ["ServiceActionSummaries"]))) (letvar2009606 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009606 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-view-output ([input] (response-describe-product-view-output nil input)) ([resultWrapper2009608 input] (clojure.core/let [rawinput2009607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009609 {"ProductViewSummary" (rawinput2009607 "ProductViewSummary"), "ProvisioningArtifacts" (rawinput2009607 "ProvisioningArtifacts")}] (clojure.core/cond-> {} (letvar2009609 "ProductViewSummary") (clojure.core/assoc :product-view-summary (deser-product-view-summary (clojure.core/get-in letvar2009609 ["ProductViewSummary"]))) (letvar2009609 "ProvisioningArtifacts") (clojure.core/assoc :provisioning-artifacts (deser-provisioning-artifacts (clojure.core/get-in letvar2009609 ["ProvisioningArtifacts"])))))))

(clojure.core/defn- response-execute-provisioned-product-plan-output ([input] (response-execute-provisioned-product-plan-output nil input)) ([resultWrapper2009611 input] (clojure.core/let [rawinput2009610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009612 {"RecordDetail" (rawinput2009610 "RecordDetail")}] (clojure.core/cond-> {} (letvar2009612 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009612 ["RecordDetail"])))))))

(clojure.core/defn- response-describe-provisioned-product-plan-output ([input] (response-describe-provisioned-product-plan-output nil input)) ([resultWrapper2009614 input] (clojure.core/let [rawinput2009613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009615 {"ProvisionedProductPlanDetails" (rawinput2009613 "ProvisionedProductPlanDetails"), "ResourceChanges" (rawinput2009613 "ResourceChanges"), "NextPageToken" (rawinput2009613 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009615 "ProvisionedProductPlanDetails") (clojure.core/assoc :provisioned-product-plan-details (deser-provisioned-product-plan-details (clojure.core/get-in letvar2009615 ["ProvisionedProductPlanDetails"]))) (letvar2009615 "ResourceChanges") (clojure.core/assoc :resource-changes (deser-resource-changes (clojure.core/get-in letvar2009615 ["ResourceChanges"]))) (letvar2009615 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009615 ["NextPageToken"])))))))

(clojure.core/defn- response-update-provisioned-product-output ([input] (response-update-provisioned-product-output nil input)) ([resultWrapper2009617 input] (clojure.core/let [rawinput2009616 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009618 {"RecordDetail" (rawinput2009616 "RecordDetail")}] (clojure.core/cond-> {} (letvar2009618 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009618 ["RecordDetail"])))))))

(clojure.core/defn- response-associate-product-with-portfolio-output ([input] (response-associate-product-with-portfolio-output nil input)) ([resultWrapper2009620 input] (clojure.core/let [rawinput2009619 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009621 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-tag-option-from-resource-output ([input] (response-disassociate-tag-option-from-resource-output nil input)) ([resultWrapper2009623 input] (clojure.core/let [rawinput2009622 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009624 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-provision-product-output ([input] (response-provision-product-output nil input)) ([resultWrapper2009626 input] (clojure.core/let [rawinput2009625 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009627 {"RecordDetail" (rawinput2009625 "RecordDetail")}] (clojure.core/cond-> {} (letvar2009627 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009627 ["RecordDetail"])))))))

(clojure.core/defn- response-accept-portfolio-share-output ([input] (response-accept-portfolio-share-output nil input)) ([resultWrapper2009629 input] (clojure.core/let [rawinput2009628 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009630 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-portfolios-output ([input] (response-list-portfolios-output nil input)) ([resultWrapper2009632 input] (clojure.core/let [rawinput2009631 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009633 {"PortfolioDetails" (rawinput2009631 "PortfolioDetails"), "NextPageToken" (rawinput2009631 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009633 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2009633 ["PortfolioDetails"]))) (letvar2009633 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009633 ["NextPageToken"])))))))

(clojure.core/defn- response-create-tag-option-output ([input] (response-create-tag-option-output nil input)) ([resultWrapper2009635 input] (clojure.core/let [rawinput2009634 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009636 {"TagOptionDetail" (rawinput2009634 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2009636 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2009636 ["TagOptionDetail"])))))))

(clojure.core/defn- response-disassociate-product-from-portfolio-output ([input] (response-disassociate-product-from-portfolio-output nil input)) ([resultWrapper2009638 input] (clojure.core/let [rawinput2009637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009639 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-terminate-provisioned-product-output ([input] (response-terminate-provisioned-product-output nil input)) ([resultWrapper2009641 input] (clojure.core/let [rawinput2009640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009642 {"RecordDetail" (rawinput2009640 "RecordDetail")}] (clojure.core/cond-> {} (letvar2009642 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009642 ["RecordDetail"])))))))

(clojure.core/defn- response-search-provisioned-products-output ([input] (response-search-provisioned-products-output nil input)) ([resultWrapper2009644 input] (clojure.core/let [rawinput2009643 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009645 {"ProvisionedProducts" (rawinput2009643 "ProvisionedProducts"), "TotalResultsCount" (rawinput2009643 "TotalResultsCount"), "NextPageToken" (rawinput2009643 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009645 "ProvisionedProducts") (clojure.core/assoc :provisioned-products (deser-provisioned-product-attributes (clojure.core/get-in letvar2009645 ["ProvisionedProducts"]))) (letvar2009645 "TotalResultsCount") (clojure.core/assoc :total-results-count (deser-total-results-count (clojure.core/get-in letvar2009645 ["TotalResultsCount"]))) (letvar2009645 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009645 ["NextPageToken"])))))))

(clojure.core/defn- response-create-portfolio-share-output ([input] (response-create-portfolio-share-output nil input)) ([resultWrapper2009647 input] (clojure.core/let [rawinput2009646 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009648 {"PortfolioShareToken" (rawinput2009646 "PortfolioShareToken")}] (clojure.core/cond-> {} (letvar2009648 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2009648 ["PortfolioShareToken"])))))))

(clojure.core/defn- response-update-tag-option-output ([input] (response-update-tag-option-output nil input)) ([resultWrapper2009650 input] (clojure.core/let [rawinput2009649 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009651 {"TagOptionDetail" (rawinput2009649 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2009651 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2009651 ["TagOptionDetail"])))))))

(clojure.core/defn- response-get-aws-organizations-access-status-output ([input] (response-get-aws-organizations-access-status-output nil input)) ([resultWrapper2009653 input] (clojure.core/let [rawinput2009652 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009654 {"AccessStatus" (rawinput2009652 "AccessStatus")}] (clojure.core/cond-> {} (letvar2009654 "AccessStatus") (clojure.core/assoc :access-status (deser-access-status (clojure.core/get-in letvar2009654 ["AccessStatus"])))))))

(clojure.core/defn- response-delete-product-output ([input] (response-delete-product-output nil input)) ([resultWrapper2009656 input] (clojure.core/let [rawinput2009655 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009657 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-constraint-output ([input] (response-update-constraint-output nil input)) ([resultWrapper2009659 input] (clojure.core/let [rawinput2009658 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009660 {"ConstraintDetail" (rawinput2009658 "ConstraintDetail"), "ConstraintParameters" (rawinput2009658 "ConstraintParameters"), "Status" (rawinput2009658 "Status")}] (clojure.core/cond-> {} (letvar2009660 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2009660 ["ConstraintDetail"]))) (letvar2009660 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2009660 ["ConstraintParameters"]))) (letvar2009660 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009660 ["Status"])))))))

(clojure.core/defn- response-list-constraints-for-portfolio-output ([input] (response-list-constraints-for-portfolio-output nil input)) ([resultWrapper2009662 input] (clojure.core/let [rawinput2009661 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009663 {"ConstraintDetails" (rawinput2009661 "ConstraintDetails"), "NextPageToken" (rawinput2009661 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009663 "ConstraintDetails") (clojure.core/assoc :constraint-details (deser-constraint-details (clojure.core/get-in letvar2009663 ["ConstraintDetails"]))) (letvar2009663 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009663 ["NextPageToken"])))))))

(clojure.core/defn- response-list-tag-options-output ([input] (response-list-tag-options-output nil input)) ([resultWrapper2009665 input] (clojure.core/let [rawinput2009664 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009666 {"TagOptionDetails" (rawinput2009664 "TagOptionDetails"), "PageToken" (rawinput2009664 "PageToken")}] (clojure.core/cond-> {} (letvar2009666 "TagOptionDetails") (clojure.core/assoc :tag-option-details (deser-tag-option-details (clojure.core/get-in letvar2009666 ["TagOptionDetails"]))) (letvar2009666 "PageToken") (clojure.core/assoc :page-token (deser-page-token (clojure.core/get-in letvar2009666 ["PageToken"])))))))

(clojure.core/defn- response-list-accepted-portfolio-shares-output ([input] (response-list-accepted-portfolio-shares-output nil input)) ([resultWrapper2009668 input] (clojure.core/let [rawinput2009667 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009669 {"PortfolioDetails" (rawinput2009667 "PortfolioDetails"), "NextPageToken" (rawinput2009667 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009669 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2009669 ["PortfolioDetails"]))) (letvar2009669 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009669 ["NextPageToken"])))))))

(clojure.core/defn- response-delete-service-action-output ([input] (response-delete-service-action-output nil input)) ([resultWrapper2009671 input] (clojure.core/let [rawinput2009670 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009672 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-principals-for-portfolio-output ([input] (response-list-principals-for-portfolio-output nil input)) ([resultWrapper2009674 input] (clojure.core/let [rawinput2009673 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009675 {"Principals" (rawinput2009673 "Principals"), "NextPageToken" (rawinput2009673 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009675 "Principals") (clojure.core/assoc :principals (deser-principals (clojure.core/get-in letvar2009675 ["Principals"]))) (letvar2009675 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009675 ["NextPageToken"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper2009677 input] (clojure.core/let [rawinput2009676 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009678 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-principal-from-portfolio-output ([input] (response-disassociate-principal-from-portfolio-output nil input)) ([resultWrapper2009680 input] (clojure.core/let [rawinput2009679 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009681 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2009683 input] (clojure.core/let [rawinput2009682 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009684 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-provisioning-artifacts-for-service-action-output ([input] (response-list-provisioning-artifacts-for-service-action-output nil input)) ([resultWrapper2009686 input] (clojure.core/let [rawinput2009685 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009687 {"ProvisioningArtifactViews" (rawinput2009685 "ProvisioningArtifactViews"), "NextPageToken" (rawinput2009685 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009687 "ProvisioningArtifactViews") (clojure.core/assoc :provisioning-artifact-views (deser-provisioning-artifact-views (clojure.core/get-in letvar2009687 ["ProvisioningArtifactViews"]))) (letvar2009687 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009687 ["NextPageToken"])))))))

(clojure.core/defn- response-search-products-as-admin-output ([input] (response-search-products-as-admin-output nil input)) ([resultWrapper2009689 input] (clojure.core/let [rawinput2009688 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009690 {"ProductViewDetails" (rawinput2009688 "ProductViewDetails"), "NextPageToken" (rawinput2009688 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009690 "ProductViewDetails") (clojure.core/assoc :product-view-details (deser-product-view-details (clojure.core/get-in letvar2009690 ["ProductViewDetails"]))) (letvar2009690 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009690 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-tag-option-output ([input] (response-describe-tag-option-output nil input)) ([resultWrapper2009692 input] (clojure.core/let [rawinput2009691 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009693 {"TagOptionDetail" (rawinput2009691 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2009693 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2009693 ["TagOptionDetail"])))))))

(clojure.core/defn- response-delete-tag-option-output ([input] (response-delete-tag-option-output nil input)) ([resultWrapper2009695 input] (clojure.core/let [rawinput2009694 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009696 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-principal-with-portfolio-output ([input] (response-associate-principal-with-portfolio-output nil input)) ([resultWrapper2009698 input] (clojure.core/let [rawinput2009697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009699 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disable-aws-organizations-access-output ([input] (response-disable-aws-organizations-access-output nil input)) ([resultWrapper2009701 input] (clojure.core/let [rawinput2009700 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009702 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-provisioning-artifact-output ([input] (response-update-provisioning-artifact-output nil input)) ([resultWrapper2009704 input] (clojure.core/let [rawinput2009703 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009705 {"ProvisioningArtifactDetail" (rawinput2009703 "ProvisioningArtifactDetail"), "Info" (rawinput2009703 "Info"), "Status" (rawinput2009703 "Status")}] (clojure.core/cond-> {} (letvar2009705 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2009705 ["ProvisioningArtifactDetail"]))) (letvar2009705 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2009705 ["Info"]))) (letvar2009705 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009705 ["Status"])))))))

(clojure.core/defn- response-invalid-parameters-exception ([input] (response-invalid-parameters-exception nil input)) ([resultWrapper2009707 input] (clojure.core/let [rawinput2009706 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009708 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-service-action-with-provisioning-artifact-output ([input] (response-associate-service-action-with-provisioning-artifact-output nil input)) ([resultWrapper2009710 input] (clojure.core/let [rawinput2009709 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009711 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-provisioned-product-plan-output ([input] (response-create-provisioned-product-plan-output nil input)) ([resultWrapper2009713 input] (clojure.core/let [rawinput2009712 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009714 {"PlanName" (rawinput2009712 "PlanName"), "PlanId" (rawinput2009712 "PlanId"), "ProvisionProductId" (rawinput2009712 "ProvisionProductId"), "ProvisionedProductName" (rawinput2009712 "ProvisionedProductName"), "ProvisioningArtifactId" (rawinput2009712 "ProvisioningArtifactId")}] (clojure.core/cond-> {} (letvar2009714 "PlanName") (clojure.core/assoc :plan-name (deser-provisioned-product-plan-name (clojure.core/get-in letvar2009714 ["PlanName"]))) (letvar2009714 "PlanId") (clojure.core/assoc :plan-id (deser-id (clojure.core/get-in letvar2009714 ["PlanId"]))) (letvar2009714 "ProvisionProductId") (clojure.core/assoc :provision-product-id (deser-id (clojure.core/get-in letvar2009714 ["ProvisionProductId"]))) (letvar2009714 "ProvisionedProductName") (clojure.core/assoc :provisioned-product-name (deser-provisioned-product-name (clojure.core/get-in letvar2009714 ["ProvisionedProductName"]))) (letvar2009714 "ProvisioningArtifactId") (clojure.core/assoc :provisioning-artifact-id (deser-id (clojure.core/get-in letvar2009714 ["ProvisioningArtifactId"])))))))

(clojure.core/defn- response-create-product-output ([input] (response-create-product-output nil input)) ([resultWrapper2009716 input] (clojure.core/let [rawinput2009715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009717 {"ProductViewDetail" (rawinput2009715 "ProductViewDetail"), "ProvisioningArtifactDetail" (rawinput2009715 "ProvisioningArtifactDetail"), "Tags" (rawinput2009715 "Tags")}] (clojure.core/cond-> {} (letvar2009717 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2009717 ["ProductViewDetail"]))) (letvar2009717 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2009717 ["ProvisioningArtifactDetail"]))) (letvar2009717 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009717 ["Tags"])))))))

(clojure.core/defn- response-list-record-history-output ([input] (response-list-record-history-output nil input)) ([resultWrapper2009719 input] (clojure.core/let [rawinput2009718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009720 {"RecordDetails" (rawinput2009718 "RecordDetails"), "NextPageToken" (rawinput2009718 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009720 "RecordDetails") (clojure.core/assoc :record-details (deser-record-details (clojure.core/get-in letvar2009720 ["RecordDetails"]))) (letvar2009720 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009720 ["NextPageToken"])))))))

(clojure.core/defn- response-delete-portfolio-output ([input] (response-delete-portfolio-output nil input)) ([resultWrapper2009722 input] (clojure.core/let [rawinput2009721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009723 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-service-action-output ([input] (response-describe-service-action-output nil input)) ([resultWrapper2009725 input] (clojure.core/let [rawinput2009724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009726 {"ServiceActionDetail" (rawinput2009724 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2009726 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2009726 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-delete-portfolio-share-output ([input] (response-delete-portfolio-share-output nil input)) ([resultWrapper2009728 input] (clojure.core/let [rawinput2009727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009729 {"PortfolioShareToken" (rawinput2009727 "PortfolioShareToken")}] (clojure.core/cond-> {} (letvar2009729 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2009729 ["PortfolioShareToken"])))))))

(clojure.core/defn- response-describe-provisioning-artifact-output ([input] (response-describe-provisioning-artifact-output nil input)) ([resultWrapper2009731 input] (clojure.core/let [rawinput2009730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009732 {"ProvisioningArtifactDetail" (rawinput2009730 "ProvisioningArtifactDetail"), "Info" (rawinput2009730 "Info"), "Status" (rawinput2009730 "Status")}] (clojure.core/cond-> {} (letvar2009732 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2009732 ["ProvisioningArtifactDetail"]))) (letvar2009732 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2009732 ["Info"]))) (letvar2009732 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009732 ["Status"])))))))

(clojure.core/defn- response-enable-aws-organizations-access-output ([input] (response-enable-aws-organizations-access-output nil input)) ([resultWrapper2009734 input] (clojure.core/let [rawinput2009733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009735 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-portfolio-output ([input] (response-create-portfolio-output nil input)) ([resultWrapper2009737 input] (clojure.core/let [rawinput2009736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009738 {"PortfolioDetail" (rawinput2009736 "PortfolioDetail"), "Tags" (rawinput2009736 "Tags")}] (clojure.core/cond-> {} (letvar2009738 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2009738 ["PortfolioDetail"]))) (letvar2009738 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009738 ["Tags"])))))))

(clojure.core/defn- response-describe-copy-product-status-output ([input] (response-describe-copy-product-status-output nil input)) ([resultWrapper2009740 input] (clojure.core/let [rawinput2009739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009741 {"CopyProductStatus" (rawinput2009739 "CopyProductStatus"), "TargetProductId" (rawinput2009739 "TargetProductId"), "StatusDetail" (rawinput2009739 "StatusDetail")}] (clojure.core/cond-> {} (letvar2009741 "CopyProductStatus") (clojure.core/assoc :copy-product-status (deser-copy-product-status (clojure.core/get-in letvar2009741 ["CopyProductStatus"]))) (letvar2009741 "TargetProductId") (clojure.core/assoc :target-product-id (deser-id (clojure.core/get-in letvar2009741 ["TargetProductId"]))) (letvar2009741 "StatusDetail") (clojure.core/assoc :status-detail (deser-status-detail (clojure.core/get-in letvar2009741 ["StatusDetail"])))))))

(clojure.core/defn- response-delete-constraint-output ([input] (response-delete-constraint-output nil input)) ([resultWrapper2009743 input] (clojure.core/let [rawinput2009742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009744 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-service-actions-for-provisioning-artifact-output ([input] (response-list-service-actions-for-provisioning-artifact-output nil input)) ([resultWrapper2009746 input] (clojure.core/let [rawinput2009745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009747 {"ServiceActionSummaries" (rawinput2009745 "ServiceActionSummaries"), "NextPageToken" (rawinput2009745 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009747 "ServiceActionSummaries") (clojure.core/assoc :service-action-summaries (deser-service-action-summaries (clojure.core/get-in letvar2009747 ["ServiceActionSummaries"]))) (letvar2009747 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009747 ["NextPageToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2009749 input] (clojure.core/let [rawinput2009748 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009750 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-product-output ([input] (response-update-product-output nil input)) ([resultWrapper2009752 input] (clojure.core/let [rawinput2009751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009753 {"ProductViewDetail" (rawinput2009751 "ProductViewDetail"), "Tags" (rawinput2009751 "Tags")}] (clojure.core/cond-> {} (letvar2009753 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2009753 ["ProductViewDetail"]))) (letvar2009753 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009753 ["Tags"])))))))

(clojure.core/defn- response-delete-provisioning-artifact-output ([input] (response-delete-provisioning-artifact-output nil input)) ([resultWrapper2009755 input] (clojure.core/let [rawinput2009754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009756 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resources-for-tag-option-output ([input] (response-list-resources-for-tag-option-output nil input)) ([resultWrapper2009758 input] (clojure.core/let [rawinput2009757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009759 {"ResourceDetails" (rawinput2009757 "ResourceDetails"), "PageToken" (rawinput2009757 "PageToken")}] (clojure.core/cond-> {} (letvar2009759 "ResourceDetails") (clojure.core/assoc :resource-details (deser-resource-details (clojure.core/get-in letvar2009759 ["ResourceDetails"]))) (letvar2009759 "PageToken") (clojure.core/assoc :page-token (deser-page-token (clojure.core/get-in letvar2009759 ["PageToken"])))))))

(clojure.core/defn- response-list-portfolio-access-output ([input] (response-list-portfolio-access-output nil input)) ([resultWrapper2009761 input] (clojure.core/let [rawinput2009760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009762 {"AccountIds" (rawinput2009760 "AccountIds"), "NextPageToken" (rawinput2009760 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009762 "AccountIds") (clojure.core/assoc :account-ids (deser-account-ids (clojure.core/get-in letvar2009762 ["AccountIds"]))) (letvar2009762 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009762 ["NextPageToken"])))))))

(clojure.core/defn- response-list-provisioned-product-plans-output ([input] (response-list-provisioned-product-plans-output nil input)) ([resultWrapper2009764 input] (clojure.core/let [rawinput2009763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009765 {"ProvisionedProductPlans" (rawinput2009763 "ProvisionedProductPlans"), "NextPageToken" (rawinput2009763 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009765 "ProvisionedProductPlans") (clojure.core/assoc :provisioned-product-plans (deser-provisioned-product-plans (clojure.core/get-in letvar2009765 ["ProvisionedProductPlans"]))) (letvar2009765 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009765 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-portfolio-share-status-output ([input] (response-describe-portfolio-share-status-output nil input)) ([resultWrapper2009767 input] (clojure.core/let [rawinput2009766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009768 {"PortfolioShareToken" (rawinput2009766 "PortfolioShareToken"), "PortfolioId" (rawinput2009766 "PortfolioId"), "OrganizationNodeValue" (rawinput2009766 "OrganizationNodeValue"), "Status" (rawinput2009766 "Status"), "ShareDetails" (rawinput2009766 "ShareDetails")}] (clojure.core/cond-> {} (letvar2009768 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2009768 ["PortfolioShareToken"]))) (letvar2009768 "PortfolioId") (clojure.core/assoc :portfolio-id (deser-id (clojure.core/get-in letvar2009768 ["PortfolioId"]))) (letvar2009768 "OrganizationNodeValue") (clojure.core/assoc :organization-node-value (deser-organization-node-value (clojure.core/get-in letvar2009768 ["OrganizationNodeValue"]))) (letvar2009768 "Status") (clojure.core/assoc :status (deser-share-status (clojure.core/get-in letvar2009768 ["Status"]))) (letvar2009768 "ShareDetails") (clojure.core/assoc :share-details (deser-share-details (clojure.core/get-in letvar2009768 ["ShareDetails"])))))))

(clojure.core/defn- response-reject-portfolio-share-output ([input] (response-reject-portfolio-share-output nil input)) ([resultWrapper2009770 input] (clojure.core/let [rawinput2009769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009771 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-constraint-output ([input] (response-create-constraint-output nil input)) ([resultWrapper2009773 input] (clojure.core/let [rawinput2009772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009774 {"ConstraintDetail" (rawinput2009772 "ConstraintDetail"), "ConstraintParameters" (rawinput2009772 "ConstraintParameters"), "Status" (rawinput2009772 "Status")}] (clojure.core/cond-> {} (letvar2009774 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2009774 ["ConstraintDetail"]))) (letvar2009774 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2009774 ["ConstraintParameters"]))) (letvar2009774 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009774 ["Status"])))))))

(clojure.core/defn- response-batch-associate-service-action-with-provisioning-artifact-output ([input] (response-batch-associate-service-action-with-provisioning-artifact-output nil input)) ([resultWrapper2009776 input] (clojure.core/let [rawinput2009775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009777 {"FailedServiceActionAssociations" (rawinput2009775 "FailedServiceActionAssociations")}] (clojure.core/cond-> {} (letvar2009777 "FailedServiceActionAssociations") (clojure.core/assoc :failed-service-action-associations (deser-failed-service-action-associations (clojure.core/get-in letvar2009777 ["FailedServiceActionAssociations"])))))))

(clojure.core/defn- response-operation-not-supported-exception ([input] (response-operation-not-supported-exception nil input)) ([resultWrapper2009779 input] (clojure.core/let [rawinput2009778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009780 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-portfolios-for-product-output ([input] (response-list-portfolios-for-product-output nil input)) ([resultWrapper2009782 input] (clojure.core/let [rawinput2009781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009783 {"PortfolioDetails" (rawinput2009781 "PortfolioDetails"), "NextPageToken" (rawinput2009781 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009783 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2009783 ["PortfolioDetails"]))) (letvar2009783 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009783 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-provisioning-parameters-output ([input] (response-describe-provisioning-parameters-output nil input)) ([resultWrapper2009785 input] (clojure.core/let [rawinput2009784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009786 {"ProvisioningArtifactParameters" (rawinput2009784 "ProvisioningArtifactParameters"), "ConstraintSummaries" (rawinput2009784 "ConstraintSummaries"), "UsageInstructions" (rawinput2009784 "UsageInstructions"), "TagOptions" (rawinput2009784 "TagOptions"), "ProvisioningArtifactPreferences" (rawinput2009784 "ProvisioningArtifactPreferences")}] (clojure.core/cond-> {} (letvar2009786 "ProvisioningArtifactParameters") (clojure.core/assoc :provisioning-artifact-parameters (deser-provisioning-artifact-parameters (clojure.core/get-in letvar2009786 ["ProvisioningArtifactParameters"]))) (letvar2009786 "ConstraintSummaries") (clojure.core/assoc :constraint-summaries (deser-constraint-summaries (clojure.core/get-in letvar2009786 ["ConstraintSummaries"]))) (letvar2009786 "UsageInstructions") (clojure.core/assoc :usage-instructions (deser-usage-instructions (clojure.core/get-in letvar2009786 ["UsageInstructions"]))) (letvar2009786 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-summaries (clojure.core/get-in letvar2009786 ["TagOptions"]))) (letvar2009786 "ProvisioningArtifactPreferences") (clojure.core/assoc :provisioning-artifact-preferences (deser-provisioning-artifact-preferences (clojure.core/get-in letvar2009786 ["ProvisioningArtifactPreferences"])))))))

(clojure.core/defn- response-execute-provisioned-product-service-action-output ([input] (response-execute-provisioned-product-service-action-output nil input)) ([resultWrapper2009788 input] (clojure.core/let [rawinput2009787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009789 {"RecordDetail" (rawinput2009787 "RecordDetail")}] (clojure.core/cond-> {} (letvar2009789 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009789 ["RecordDetail"])))))))

(clojure.core/defn- response-list-launch-paths-output ([input] (response-list-launch-paths-output nil input)) ([resultWrapper2009791 input] (clojure.core/let [rawinput2009790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009792 {"LaunchPathSummaries" (rawinput2009790 "LaunchPathSummaries"), "NextPageToken" (rawinput2009790 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009792 "LaunchPathSummaries") (clojure.core/assoc :launch-path-summaries (deser-launch-path-summaries (clojure.core/get-in letvar2009792 ["LaunchPathSummaries"]))) (letvar2009792 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009792 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-as-admin-output ([input] (response-describe-product-as-admin-output nil input)) ([resultWrapper2009794 input] (clojure.core/let [rawinput2009793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009795 {"ProductViewDetail" (rawinput2009793 "ProductViewDetail"), "ProvisioningArtifactSummaries" (rawinput2009793 "ProvisioningArtifactSummaries"), "Tags" (rawinput2009793 "Tags"), "TagOptions" (rawinput2009793 "TagOptions")}] (clojure.core/cond-> {} (letvar2009795 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2009795 ["ProductViewDetail"]))) (letvar2009795 "ProvisioningArtifactSummaries") (clojure.core/assoc :provisioning-artifact-summaries (deser-provisioning-artifact-summaries (clojure.core/get-in letvar2009795 ["ProvisioningArtifactSummaries"]))) (letvar2009795 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009795 ["Tags"]))) (letvar2009795 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-details (clojure.core/get-in letvar2009795 ["TagOptions"])))))))

(clojure.core/defn- response-copy-product-output ([input] (response-copy-product-output nil input)) ([resultWrapper2009797 input] (clojure.core/let [rawinput2009796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009798 {"CopyProductToken" (rawinput2009796 "CopyProductToken")}] (clojure.core/cond-> {} (letvar2009798 "CopyProductToken") (clojure.core/assoc :copy-product-token (deser-id (clojure.core/get-in letvar2009798 ["CopyProductToken"])))))))

(clojure.core/defn- response-describe-portfolio-output ([input] (response-describe-portfolio-output nil input)) ([resultWrapper2009800 input] (clojure.core/let [rawinput2009799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009801 {"PortfolioDetail" (rawinput2009799 "PortfolioDetail"), "Tags" (rawinput2009799 "Tags"), "TagOptions" (rawinput2009799 "TagOptions")}] (clojure.core/cond-> {} (letvar2009801 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2009801 ["PortfolioDetail"]))) (letvar2009801 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009801 ["Tags"]))) (letvar2009801 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-details (clojure.core/get-in letvar2009801 ["TagOptions"])))))))

(clojure.core/defn- response-describe-provisioned-product-output ([input] (response-describe-provisioned-product-output nil input)) ([resultWrapper2009803 input] (clojure.core/let [rawinput2009802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009804 {"ProvisionedProductDetail" (rawinput2009802 "ProvisionedProductDetail"), "CloudWatchDashboards" (rawinput2009802 "CloudWatchDashboards")}] (clojure.core/cond-> {} (letvar2009804 "ProvisionedProductDetail") (clojure.core/assoc :provisioned-product-detail (deser-provisioned-product-detail (clojure.core/get-in letvar2009804 ["ProvisionedProductDetail"]))) (letvar2009804 "CloudWatchDashboards") (clojure.core/assoc :cloud-watch-dashboards (deser-cloud-watch-dashboards (clojure.core/get-in letvar2009804 ["CloudWatchDashboards"])))))))

(clojure.core/defn- response-batch-disassociate-service-action-from-provisioning-artifact-output ([input] (response-batch-disassociate-service-action-from-provisioning-artifact-output nil input)) ([resultWrapper2009806 input] (clojure.core/let [rawinput2009805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009807 {"FailedServiceActionAssociations" (rawinput2009805 "FailedServiceActionAssociations")}] (clojure.core/cond-> {} (letvar2009807 "FailedServiceActionAssociations") (clojure.core/assoc :failed-service-action-associations (deser-failed-service-action-associations (clojure.core/get-in letvar2009807 ["FailedServiceActionAssociations"])))))))

(clojure.core/defn- response-list-organization-portfolio-access-output ([input] (response-list-organization-portfolio-access-output nil input)) ([resultWrapper2009809 input] (clojure.core/let [rawinput2009808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009810 {"OrganizationNodes" (rawinput2009808 "OrganizationNodes"), "NextPageToken" (rawinput2009808 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009810 "OrganizationNodes") (clojure.core/assoc :organization-nodes (deser-organization-nodes (clojure.core/get-in letvar2009810 ["OrganizationNodes"]))) (letvar2009810 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009810 ["NextPageToken"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper2009812 input] (clojure.core/let [rawinput2009811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009813 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-tag-option-with-resource-output ([input] (response-associate-tag-option-with-resource-output nil input)) ([resultWrapper2009815 input] (clojure.core/let [rawinput2009814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009816 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-service-action-output ([input] (response-update-service-action-output nil input)) ([resultWrapper2009818 input] (clojure.core/let [rawinput2009817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009819 {"ServiceActionDetail" (rawinput2009817 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2009819 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2009819 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-delete-provisioned-product-plan-output ([input] (response-delete-provisioned-product-plan-output nil input)) ([resultWrapper2009821 input] (clojure.core/let [rawinput2009820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009822 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-record-output ([input] (response-describe-record-output nil input)) ([resultWrapper2009824 input] (clojure.core/let [rawinput2009823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009825 {"RecordDetail" (rawinput2009823 "RecordDetail"), "RecordOutputs" (rawinput2009823 "RecordOutputs"), "NextPageToken" (rawinput2009823 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009825 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2009825 ["RecordDetail"]))) (letvar2009825 "RecordOutputs") (clojure.core/assoc :record-outputs (deser-record-outputs (clojure.core/get-in letvar2009825 ["RecordOutputs"]))) (letvar2009825 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009825 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-output ([input] (response-describe-product-output nil input)) ([resultWrapper2009827 input] (clojure.core/let [rawinput2009826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009828 {"ProductViewSummary" (rawinput2009826 "ProductViewSummary"), "ProvisioningArtifacts" (rawinput2009826 "ProvisioningArtifacts")}] (clojure.core/cond-> {} (letvar2009828 "ProductViewSummary") (clojure.core/assoc :product-view-summary (deser-product-view-summary (clojure.core/get-in letvar2009828 ["ProductViewSummary"]))) (letvar2009828 "ProvisioningArtifacts") (clojure.core/assoc :provisioning-artifacts (deser-provisioning-artifacts (clojure.core/get-in letvar2009828 ["ProvisioningArtifacts"])))))))

(clojure.core/defn- response-search-products-output ([input] (response-search-products-output nil input)) ([resultWrapper2009830 input] (clojure.core/let [rawinput2009829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009831 {"ProductViewSummaries" (rawinput2009829 "ProductViewSummaries"), "ProductViewAggregations" (rawinput2009829 "ProductViewAggregations"), "NextPageToken" (rawinput2009829 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009831 "ProductViewSummaries") (clojure.core/assoc :product-view-summaries (deser-product-view-summaries (clojure.core/get-in letvar2009831 ["ProductViewSummaries"]))) (letvar2009831 "ProductViewAggregations") (clojure.core/assoc :product-view-aggregations (deser-product-view-aggregations (clojure.core/get-in letvar2009831 ["ProductViewAggregations"]))) (letvar2009831 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009831 ["NextPageToken"])))))))

(clojure.core/defn- response-create-provisioning-artifact-output ([input] (response-create-provisioning-artifact-output nil input)) ([resultWrapper2009833 input] (clojure.core/let [rawinput2009832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009834 {"ProvisioningArtifactDetail" (rawinput2009832 "ProvisioningArtifactDetail"), "Info" (rawinput2009832 "Info"), "Status" (rawinput2009832 "Status")}] (clojure.core/cond-> {} (letvar2009834 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2009834 ["ProvisioningArtifactDetail"]))) (letvar2009834 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2009834 ["Info"]))) (letvar2009834 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009834 ["Status"])))))))

(clojure.core/defn- response-disassociate-service-action-from-provisioning-artifact-output ([input] (response-disassociate-service-action-from-provisioning-artifact-output nil input)) ([resultWrapper2009836 input] (clojure.core/let [rawinput2009835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009837 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-provisioning-artifacts-output ([input] (response-list-provisioning-artifacts-output nil input)) ([resultWrapper2009839 input] (clojure.core/let [rawinput2009838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009840 {"ProvisioningArtifactDetails" (rawinput2009838 "ProvisioningArtifactDetails"), "NextPageToken" (rawinput2009838 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009840 "ProvisioningArtifactDetails") (clojure.core/assoc :provisioning-artifact-details (deser-provisioning-artifact-details (clojure.core/get-in letvar2009840 ["ProvisioningArtifactDetails"]))) (letvar2009840 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009840 ["NextPageToken"])))))))

(clojure.core/defn- response-create-service-action-output ([input] (response-create-service-action-output nil input)) ([resultWrapper2009842 input] (clojure.core/let [rawinput2009841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009843 {"ServiceActionDetail" (rawinput2009841 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2009843 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2009843 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-update-portfolio-output ([input] (response-update-portfolio-output nil input)) ([resultWrapper2009845 input] (clojure.core/let [rawinput2009844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009846 {"PortfolioDetail" (rawinput2009844 "PortfolioDetail"), "Tags" (rawinput2009844 "Tags")}] (clojure.core/cond-> {} (letvar2009846 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2009846 ["PortfolioDetail"]))) (letvar2009846 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2009846 ["Tags"])))))))

(clojure.core/defn- response-tag-option-not-migrated-exception ([input] (response-tag-option-not-migrated-exception nil input)) ([resultWrapper2009848 input] (clojure.core/let [rawinput2009847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009849 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-scan-provisioned-products-output ([input] (response-scan-provisioned-products-output nil input)) ([resultWrapper2009851 input] (clojure.core/let [rawinput2009850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009852 {"ProvisionedProducts" (rawinput2009850 "ProvisionedProducts"), "NextPageToken" (rawinput2009850 "NextPageToken")}] (clojure.core/cond-> {} (letvar2009852 "ProvisionedProducts") (clojure.core/assoc :provisioned-products (deser-provisioned-product-details (clojure.core/get-in letvar2009852 ["ProvisionedProducts"]))) (letvar2009852 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2009852 ["NextPageToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper2009854 input] (clojure.core/let [rawinput2009853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009855 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-constraint-output ([input] (response-describe-constraint-output nil input)) ([resultWrapper2009857 input] (clojure.core/let [rawinput2009856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2009858 {"ConstraintDetail" (rawinput2009856 "ConstraintDetail"), "ConstraintParameters" (rawinput2009856 "ConstraintParameters"), "Status" (rawinput2009856 "Status")}] (clojure.core/cond-> {} (letvar2009858 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2009858 ["ConstraintDetail"]))) (letvar2009858 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2009858 ["ConstraintParameters"]))) (letvar2009858 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2009858 ["Status"])))))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/support-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/product-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/provisioned-product-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9][a-zA-Z0-9._-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/product-view-short-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/status-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000a\u000d\u0020-\uD7FF\uE000-\uFFFD]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/tag-option-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/organization-node-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(^[0-9]{12}$)|(^arn:aws:organizations::\d{12}:organization\/o-[a-z0-9]{10,32})|(^o-[a-z0-9]{10,32}$)|(^arn:aws:organizations::\d{12}:ou\/o-[a-z0-9]{10,32}\/ou-[0-9a-z]{4,32}-[0-9a-z]{8,32}$)|(^ou-[0-9a-z]{4,32}-[a-z0-9]{8,32}$)" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/principal-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/tag-option-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog/access-level-filter-key #{:role "User" "Role" :account "Account" :user})

(clojure.spec.alpha/def :portkey.aws.servicecatalog/service-action-association-error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/accept-language (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/service-action-definition-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/portfolio-display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/product-view-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog/record-tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-%@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/portfolio-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/service-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-.]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9]{12}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/notification-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/tag-option-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/product-view-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/provisioned-product-name-or-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9][a-zA-Z0-9._-]{0,127}|arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/constraint-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/support-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2083))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/plan-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 150))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/service-action-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/page-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000a\u000d\u0020-\uD7FF\uE000-\uFFFD]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog/region (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.servicecatalog/support-email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/constraint-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/record-tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-%@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog/parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096))))
