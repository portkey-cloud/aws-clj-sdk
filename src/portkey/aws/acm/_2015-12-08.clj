...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper35878 input] (clojure.core/let [rawinput35877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35879 {"Certificate" (rawinput35877 "Certificate"), "CertificateChain" (rawinput35877 "CertificateChain")}] (clojure.core/cond-> {} (letvar35879 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar35879 ["Certificate"]))) (letvar35879 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar35879 ["CertificateChain"])))))))

(clojure.core/defn- response-import-certificate-response ([input] (response-import-certificate-response nil input)) ([resultWrapper35881 input] (clojure.core/let [rawinput35880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35882 {"CertificateArn" (rawinput35880 "CertificateArn")}] (clojure.core/cond-> {} (letvar35882 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar35882 ["CertificateArn"])))))))

(clojure.core/defn- response-request-certificate-response ([input] (response-request-certificate-response nil input)) ([resultWrapper35884 input] (clojure.core/let [rawinput35883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35885 {"CertificateArn" (rawinput35883 "CertificateArn")}] (clojure.core/cond-> {} (letvar35885 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar35885 ["CertificateArn"])))))))

(clojure.core/defn- response-list-certificates-response ([input] (response-list-certificates-response nil input)) ([resultWrapper35887 input] (clojure.core/let [rawinput35886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35888 {"NextToken" (rawinput35886 "NextToken"), "CertificateSummaryList" (rawinput35886 "CertificateSummaryList")}] (clojure.core/cond-> {} (letvar35888 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar35888 ["NextToken"]))) (letvar35888 "CertificateSummaryList") (clojure.core/assoc :certificate-summary-list (deser-certificate-summary-list (clojure.core/get-in letvar35888 ["CertificateSummaryList"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper35890 input] (clojure.core/let [rawinput35889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35891 {"message" (rawinput35889 "message")}] (clojure.core/cond-> {} (letvar35891 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35891 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper35893 input] (clojure.core/let [rawinput35892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35894 {"message" (rawinput35892 "message")}] (clojure.core/cond-> {} (letvar35894 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35894 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper35896 input] (clojure.core/let [rawinput35895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35897 {"message" (rawinput35895 "message")}] (clojure.core/cond-> {} (letvar35897 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35897 ["message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper35899 input] (clojure.core/let [rawinput35898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35900 {"message" (rawinput35898 "message")}] (clojure.core/cond-> {} (letvar35900 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35900 ["message"])))))))

(clojure.core/defn- response-invalid-domain-validation-options-exception ([input] (response-invalid-domain-validation-options-exception nil input)) ([resultWrapper35902 input] (clojure.core/let [rawinput35901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35903 {"message" (rawinput35901 "message")}] (clojure.core/cond-> {} (letvar35903 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35903 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper35905 input] (clojure.core/let [rawinput35904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35906 {"message" (rawinput35904 "message")}] (clojure.core/cond-> {} (letvar35906 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35906 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper35908 input] (clojure.core/let [rawinput35907 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35909 {"message" (rawinput35907 "message")}] (clojure.core/cond-> {} (letvar35909 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35909 ["message"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper35911 input] (clojure.core/let [rawinput35910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35912 {"message" (rawinput35910 "message")}] (clojure.core/cond-> {} (letvar35912 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35912 ["message"])))))))

(clojure.core/defn- response-describe-certificate-response ([input] (response-describe-certificate-response nil input)) ([resultWrapper35914 input] (clojure.core/let [rawinput35913 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35915 {"Certificate" (rawinput35913 "Certificate")}] (clojure.core/cond-> {} (letvar35915 "Certificate") (clojure.core/assoc :certificate (deser-certificate-detail (clojure.core/get-in letvar35915 ["Certificate"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper35917 input] (clojure.core/let [rawinput35916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35918 {"message" (rawinput35916 "message")}] (clojure.core/cond-> {} (letvar35918 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar35918 ["message"])))))))

(clojure.core/defn- response-list-tags-for-certificate-response ([input] (response-list-tags-for-certificate-response nil input)) ([resultWrapper35920 input] (clojure.core/let [rawinput35919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35921 {"Tags" (rawinput35919 "Tags")}] (clojure.core/cond-> {} (letvar35921 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar35921 ["Tags"])))))))

(clojure.core/defn- response-export-certificate-response ([input] (response-export-certificate-response nil input)) ([resultWrapper35923 input] (clojure.core/let [rawinput35922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar35924 {"Certificate" (rawinput35922 "Certificate"), "CertificateChain" (rawinput35922 "CertificateChain"), "PrivateKey" (rawinput35922 "PrivateKey")}] (clojure.core/cond-> {} (letvar35924 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar35924 ["Certificate"]))) (letvar35924 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar35924 ["CertificateChain"]))) (letvar35924 "PrivateKey") (clojure.core/assoc :private-key (deser-private-key (clojure.core/get-in letvar35924 ["PrivateKey"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/private-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 524288)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"-{5}BEGIN PRIVATE KEY-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END PRIVATE KEY-{5}(\u000D?\u000A)?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{Z}\p{N}_.:\/=+\-@]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/certificate-chain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2097152)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}\u000D?\u000A)*-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/domain-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 253)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(\*\.)?(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm.-2015-12-08/certificate-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32768)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"-{5}BEGIN CERTIFICATE-{5}\u000D?\u000A([A-Za-z0-9/+]{64}\u000D?\u000A)*[A-Za-z0-9/+]{1,64}={0,2}\u000D?\u000A-{5}END CERTIFICATE-{5}(\u000D?\u000A)?" s__21078__auto__))))
