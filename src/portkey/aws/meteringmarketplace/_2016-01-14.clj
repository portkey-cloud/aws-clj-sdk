...
(clojure.core/defn- response-invalid-token-exception ([input] (response-invalid-token-exception nil input)) ([resultWrapper1919589 input] (clojure.core/let [rawinput1919588 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919590 {"message" (rawinput1919588 "message")}] (clojure.core/cond-> {} (letvar1919590 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919590 ["message"])))))))

(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper1919592 input] (clojure.core/let [rawinput1919591 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919593 {"message" (rawinput1919591 "message")}] (clojure.core/cond-> {} (letvar1919593 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919593 ["message"])))))))

(clojure.core/defn- response-invalid-product-code-exception ([input] (response-invalid-product-code-exception nil input)) ([resultWrapper1919595 input] (clojure.core/let [rawinput1919594 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919596 {"message" (rawinput1919594 "message")}] (clojure.core/cond-> {} (letvar1919596 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919596 ["message"])))))))

(clojure.core/defn- response-customer-not-entitled-exception ([input] (response-customer-not-entitled-exception nil input)) ([resultWrapper1919598 input] (clojure.core/let [rawinput1919597 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919599 {"message" (rawinput1919597 "message")}] (clojure.core/cond-> {} (letvar1919599 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919599 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1919601 input] (clojure.core/let [rawinput1919600 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919602 {"message" (rawinput1919600 "message")}] (clojure.core/cond-> {} (letvar1919602 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919602 ["message"])))))))

(clojure.core/defn- response-invalid-usage-dimension-exception ([input] (response-invalid-usage-dimension-exception nil input)) ([resultWrapper1919604 input] (clojure.core/let [rawinput1919603 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919605 {"message" (rawinput1919603 "message")}] (clojure.core/cond-> {} (letvar1919605 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919605 ["message"])))))))

(clojure.core/defn- response-platform-not-supported-exception ([input] (response-platform-not-supported-exception nil input)) ([resultWrapper1919607 input] (clojure.core/let [rawinput1919606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919608 {"message" (rawinput1919606 "message")}] (clojure.core/cond-> {} (letvar1919608 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919608 ["message"])))))))

(clojure.core/defn- response-disabled-api-exception ([input] (response-disabled-api-exception nil input)) ([resultWrapper1919610 input] (clojure.core/let [rawinput1919609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919611 {"message" (rawinput1919609 "message")}] (clojure.core/cond-> {} (letvar1919611 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919611 ["message"])))))))

(clojure.core/defn- response-invalid-customer-identifier-exception ([input] (response-invalid-customer-identifier-exception nil input)) ([resultWrapper1919613 input] (clojure.core/let [rawinput1919612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919614 {"message" (rawinput1919612 "message")}] (clojure.core/cond-> {} (letvar1919614 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919614 ["message"])))))))

(clojure.core/defn- response-batch-meter-usage-result ([input] (response-batch-meter-usage-result nil input)) ([resultWrapper1919616 input] (clojure.core/let [rawinput1919615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919617 {"Results" (rawinput1919615 "Results"), "UnprocessedRecords" (rawinput1919615 "UnprocessedRecords")}] (clojure.core/cond-> {} (letvar1919617 "Results") (clojure.core/assoc :results (deser-usage-record-result-list (clojure.core/get-in letvar1919617 ["Results"]))) (letvar1919617 "UnprocessedRecords") (clojure.core/assoc :unprocessed-records (deser-usage-record-list (clojure.core/get-in letvar1919617 ["UnprocessedRecords"])))))))

(clojure.core/defn- response-resolve-customer-result ([input] (response-resolve-customer-result nil input)) ([resultWrapper1919619 input] (clojure.core/let [rawinput1919618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919620 {"CustomerIdentifier" (rawinput1919618 "CustomerIdentifier"), "ProductCode" (rawinput1919618 "ProductCode")}] (clojure.core/cond-> {} (letvar1919620 "CustomerIdentifier") (clojure.core/assoc :customer-identifier (deser-customer-identifier (clojure.core/get-in letvar1919620 ["CustomerIdentifier"]))) (letvar1919620 "ProductCode") (clojure.core/assoc :product-code (deser-product-code (clojure.core/get-in letvar1919620 ["ProductCode"])))))))

(clojure.core/defn- response-register-usage-result ([input] (response-register-usage-result nil input)) ([resultWrapper1919622 input] (clojure.core/let [rawinput1919621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919623 {"PublicKeyRotationTimestamp" (rawinput1919621 "PublicKeyRotationTimestamp"), "Signature" (rawinput1919621 "Signature")}] (clojure.core/cond-> {} (letvar1919623 "PublicKeyRotationTimestamp") (clojure.core/assoc :public-key-rotation-timestamp (deser-timestamp (clojure.core/get-in letvar1919623 ["PublicKeyRotationTimestamp"]))) (letvar1919623 "Signature") (clojure.core/assoc :signature (deser-non-empty-string (clojure.core/get-in letvar1919623 ["Signature"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1919625 input] (clojure.core/let [rawinput1919624 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919626 {"message" (rawinput1919624 "message")}] (clojure.core/cond-> {} (letvar1919626 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919626 ["message"])))))))

(clojure.core/defn- response-meter-usage-result ([input] (response-meter-usage-result nil input)) ([resultWrapper1919628 input] (clojure.core/let [rawinput1919627 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919629 {"MeteringRecordId" (rawinput1919627 "MeteringRecordId")}] (clojure.core/cond-> {} (letvar1919629 "MeteringRecordId") (clojure.core/assoc :metering-record-id (deser-string (clojure.core/get-in letvar1919629 ["MeteringRecordId"])))))))

(clojure.core/defn- response-invalid-region-exception ([input] (response-invalid-region-exception nil input)) ([resultWrapper1919631 input] (clojure.core/let [rawinput1919630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919632 {"message" (rawinput1919630 "message")}] (clojure.core/cond-> {} (letvar1919632 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919632 ["message"])))))))

(clojure.core/defn- response-expired-token-exception ([input] (response-expired-token-exception nil input)) ([resultWrapper1919634 input] (clojure.core/let [rawinput1919633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919635 {"message" (rawinput1919633 "message")}] (clojure.core/cond-> {} (letvar1919635 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919635 ["message"])))))))

(clojure.core/defn- response-invalid-public-key-version-exception ([input] (response-invalid-public-key-version-exception nil input)) ([resultWrapper1919637 input] (clojure.core/let [rawinput1919636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919638 {"message" (rawinput1919636 "message")}] (clojure.core/cond-> {} (letvar1919638 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919638 ["message"])))))))

(clojure.core/defn- response-invalid-endpoint-region-exception ([input] (response-invalid-endpoint-region-exception nil input)) ([resultWrapper1919640 input] (clojure.core/let [rawinput1919639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919641 {"message" (rawinput1919639 "message")}] (clojure.core/cond-> {} (letvar1919641 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919641 ["message"])))))))

(clojure.core/defn- response-timestamp-out-of-bounds-exception ([input] (response-timestamp-out-of-bounds-exception nil input)) ([resultWrapper1919643 input] (clojure.core/let [rawinput1919642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1919644 {"message" (rawinput1919642 "message")}] (clojure.core/cond-> {} (letvar1919644 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1919644 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
