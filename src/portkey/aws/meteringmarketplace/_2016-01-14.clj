...
(clojure.core/defn- response-invalid-token-exception ([input] (response-invalid-token-exception nil input)) ([resultWrapper1904631 input] (clojure.core/let [rawinput1904630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904632 {"message" (rawinput1904630 "message")}] (clojure.core/cond-> {} (letvar1904632 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904632 ["message"])))))))

(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper1904634 input] (clojure.core/let [rawinput1904633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904635 {"message" (rawinput1904633 "message")}] (clojure.core/cond-> {} (letvar1904635 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904635 ["message"])))))))

(clojure.core/defn- response-invalid-product-code-exception ([input] (response-invalid-product-code-exception nil input)) ([resultWrapper1904637 input] (clojure.core/let [rawinput1904636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904638 {"message" (rawinput1904636 "message")}] (clojure.core/cond-> {} (letvar1904638 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904638 ["message"])))))))

(clojure.core/defn- response-customer-not-entitled-exception ([input] (response-customer-not-entitled-exception nil input)) ([resultWrapper1904640 input] (clojure.core/let [rawinput1904639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904641 {"message" (rawinput1904639 "message")}] (clojure.core/cond-> {} (letvar1904641 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904641 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1904643 input] (clojure.core/let [rawinput1904642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904644 {"message" (rawinput1904642 "message")}] (clojure.core/cond-> {} (letvar1904644 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904644 ["message"])))))))

(clojure.core/defn- response-invalid-usage-dimension-exception ([input] (response-invalid-usage-dimension-exception nil input)) ([resultWrapper1904646 input] (clojure.core/let [rawinput1904645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904647 {"message" (rawinput1904645 "message")}] (clojure.core/cond-> {} (letvar1904647 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904647 ["message"])))))))

(clojure.core/defn- response-platform-not-supported-exception ([input] (response-platform-not-supported-exception nil input)) ([resultWrapper1904649 input] (clojure.core/let [rawinput1904648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904650 {"message" (rawinput1904648 "message")}] (clojure.core/cond-> {} (letvar1904650 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904650 ["message"])))))))

(clojure.core/defn- response-disabled-api-exception ([input] (response-disabled-api-exception nil input)) ([resultWrapper1904652 input] (clojure.core/let [rawinput1904651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904653 {"message" (rawinput1904651 "message")}] (clojure.core/cond-> {} (letvar1904653 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904653 ["message"])))))))

(clojure.core/defn- response-invalid-customer-identifier-exception ([input] (response-invalid-customer-identifier-exception nil input)) ([resultWrapper1904655 input] (clojure.core/let [rawinput1904654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904656 {"message" (rawinput1904654 "message")}] (clojure.core/cond-> {} (letvar1904656 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904656 ["message"])))))))

(clojure.core/defn- response-batch-meter-usage-result ([input] (response-batch-meter-usage-result nil input)) ([resultWrapper1904658 input] (clojure.core/let [rawinput1904657 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904659 {"Results" (rawinput1904657 "Results"), "UnprocessedRecords" (rawinput1904657 "UnprocessedRecords")}] (clojure.core/cond-> {} (letvar1904659 "Results") (clojure.core/assoc :results (deser-usage-record-result-list (clojure.core/get-in letvar1904659 ["Results"]))) (letvar1904659 "UnprocessedRecords") (clojure.core/assoc :unprocessed-records (deser-usage-record-list (clojure.core/get-in letvar1904659 ["UnprocessedRecords"])))))))

(clojure.core/defn- response-resolve-customer-result ([input] (response-resolve-customer-result nil input)) ([resultWrapper1904661 input] (clojure.core/let [rawinput1904660 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904662 {"CustomerIdentifier" (rawinput1904660 "CustomerIdentifier"), "ProductCode" (rawinput1904660 "ProductCode")}] (clojure.core/cond-> {} (letvar1904662 "CustomerIdentifier") (clojure.core/assoc :customer-identifier (deser-customer-identifier (clojure.core/get-in letvar1904662 ["CustomerIdentifier"]))) (letvar1904662 "ProductCode") (clojure.core/assoc :product-code (deser-product-code (clojure.core/get-in letvar1904662 ["ProductCode"])))))))

(clojure.core/defn- response-register-usage-result ([input] (response-register-usage-result nil input)) ([resultWrapper1904664 input] (clojure.core/let [rawinput1904663 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904665 {"PublicKeyRotationTimestamp" (rawinput1904663 "PublicKeyRotationTimestamp"), "Signature" (rawinput1904663 "Signature")}] (clojure.core/cond-> {} (letvar1904665 "PublicKeyRotationTimestamp") (clojure.core/assoc :public-key-rotation-timestamp (deser-timestamp (clojure.core/get-in letvar1904665 ["PublicKeyRotationTimestamp"]))) (letvar1904665 "Signature") (clojure.core/assoc :signature (deser-non-empty-string (clojure.core/get-in letvar1904665 ["Signature"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1904667 input] (clojure.core/let [rawinput1904666 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904668 {"message" (rawinput1904666 "message")}] (clojure.core/cond-> {} (letvar1904668 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904668 ["message"])))))))

(clojure.core/defn- response-meter-usage-result ([input] (response-meter-usage-result nil input)) ([resultWrapper1904670 input] (clojure.core/let [rawinput1904669 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904671 {"MeteringRecordId" (rawinput1904669 "MeteringRecordId")}] (clojure.core/cond-> {} (letvar1904671 "MeteringRecordId") (clojure.core/assoc :metering-record-id (deser-string (clojure.core/get-in letvar1904671 ["MeteringRecordId"])))))))

(clojure.core/defn- response-invalid-region-exception ([input] (response-invalid-region-exception nil input)) ([resultWrapper1904673 input] (clojure.core/let [rawinput1904672 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904674 {"message" (rawinput1904672 "message")}] (clojure.core/cond-> {} (letvar1904674 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904674 ["message"])))))))

(clojure.core/defn- response-expired-token-exception ([input] (response-expired-token-exception nil input)) ([resultWrapper1904676 input] (clojure.core/let [rawinput1904675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904677 {"message" (rawinput1904675 "message")}] (clojure.core/cond-> {} (letvar1904677 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904677 ["message"])))))))

(clojure.core/defn- response-invalid-public-key-version-exception ([input] (response-invalid-public-key-version-exception nil input)) ([resultWrapper1904679 input] (clojure.core/let [rawinput1904678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904680 {"message" (rawinput1904678 "message")}] (clojure.core/cond-> {} (letvar1904680 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904680 ["message"])))))))

(clojure.core/defn- response-invalid-endpoint-region-exception ([input] (response-invalid-endpoint-region-exception nil input)) ([resultWrapper1904682 input] (clojure.core/let [rawinput1904681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904683 {"message" (rawinput1904681 "message")}] (clojure.core/cond-> {} (letvar1904683 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904683 ["message"])))))))

(clojure.core/defn- response-timestamp-out-of-bounds-exception ([input] (response-timestamp-out-of-bounds-exception nil input)) ([resultWrapper1904685 input] (clojure.core/let [rawinput1904684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1904686 {"message" (rawinput1904684 "message")}] (clojure.core/cond-> {} (letvar1904686 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1904686 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\S+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/usage-dimension (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/customer-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.meteringmarketplace.-2016-01-14/nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
