...
(clojure.core/defn- response-list-compliance-status-response ([input] (response-list-compliance-status-response nil input)) ([resultWrapper974537 input] (clojure.core/let [rawinput974536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974538 {"PolicyComplianceStatusList" (rawinput974536 "PolicyComplianceStatusList"), "NextToken" (rawinput974536 "NextToken")}] (clojure.core/cond-> {} (letvar974538 "PolicyComplianceStatusList") (clojure.core/assoc :policy-compliance-status-list (deser-policy-compliance-status-list (clojure.core/get-in letvar974538 ["PolicyComplianceStatusList"]))) (letvar974538 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar974538 ["NextToken"])))))))

(clojure.core/defn- response-list-member-accounts-response ([input] (response-list-member-accounts-response nil input)) ([resultWrapper974540 input] (clojure.core/let [rawinput974539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974541 {"MemberAccounts" (rawinput974539 "MemberAccounts"), "NextToken" (rawinput974539 "NextToken")}] (clojure.core/cond-> {} (letvar974541 "MemberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar974541 ["MemberAccounts"]))) (letvar974541 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar974541 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper974543 input] (clojure.core/let [rawinput974542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974544 {"Message" (rawinput974542 "Message")}] (clojure.core/cond-> {} (letvar974544 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974544 ["Message"])))))))

(clojure.core/defn- response-get-compliance-detail-response ([input] (response-get-compliance-detail-response nil input)) ([resultWrapper974546 input] (clojure.core/let [rawinput974545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974547 {"PolicyComplianceDetail" (rawinput974545 "PolicyComplianceDetail")}] (clojure.core/cond-> {} (letvar974547 "PolicyComplianceDetail") (clojure.core/assoc :policy-compliance-detail (deser-policy-compliance-detail (clojure.core/get-in letvar974547 ["PolicyComplianceDetail"])))))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper974549 input] (clojure.core/let [rawinput974548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974550 {"Message" (rawinput974548 "Message")}] (clojure.core/cond-> {} (letvar974550 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974550 ["Message"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper974552 input] (clojure.core/let [rawinput974551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974553 {"Message" (rawinput974551 "Message")}] (clojure.core/cond-> {} (letvar974553 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974553 ["Message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper974555 input] (clojure.core/let [rawinput974554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974556 {"Message" (rawinput974554 "Message")}] (clojure.core/cond-> {} (letvar974556 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974556 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper974558 input] (clojure.core/let [rawinput974557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974559 {"Message" (rawinput974557 "Message")}] (clojure.core/cond-> {} (letvar974559 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974559 ["Message"])))))))

(clojure.core/defn- response-get-notification-channel-response ([input] (response-get-notification-channel-response nil input)) ([resultWrapper974561 input] (clojure.core/let [rawinput974560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974562 {"SnsTopicArn" (rawinput974560 "SnsTopicArn"), "SnsRoleName" (rawinput974560 "SnsRoleName")}] (clojure.core/cond-> {} (letvar974562 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-resource-arn (clojure.core/get-in letvar974562 ["SnsTopicArn"]))) (letvar974562 "SnsRoleName") (clojure.core/assoc :sns-role-name (deser-resource-arn (clojure.core/get-in letvar974562 ["SnsRoleName"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper974564 input] (clojure.core/let [rawinput974563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974565 {"Message" (rawinput974563 "Message")}] (clojure.core/cond-> {} (letvar974565 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar974565 ["Message"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper974567 input] (clojure.core/let [rawinput974566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974568 {"Policy" (rawinput974566 "Policy"), "PolicyArn" (rawinput974566 "PolicyArn")}] (clojure.core/cond-> {} (letvar974568 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar974568 ["Policy"]))) (letvar974568 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar974568 ["PolicyArn"])))))))

(clojure.core/defn- response-get-admin-account-response ([input] (response-get-admin-account-response nil input)) ([resultWrapper974570 input] (clojure.core/let [rawinput974569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974571 {"AdminAccount" (rawinput974569 "AdminAccount"), "RoleStatus" (rawinput974569 "RoleStatus")}] (clojure.core/cond-> {} (letvar974571 "AdminAccount") (clojure.core/assoc :admin-account (deser-aws-account-id (clojure.core/get-in letvar974571 ["AdminAccount"]))) (letvar974571 "RoleStatus") (clojure.core/assoc :role-status (deser-account-role-status (clojure.core/get-in letvar974571 ["RoleStatus"])))))))

(clojure.core/defn- response-put-policy-response ([input] (response-put-policy-response nil input)) ([resultWrapper974573 input] (clojure.core/let [rawinput974572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974574 {"Policy" (rawinput974572 "Policy"), "PolicyArn" (rawinput974572 "PolicyArn")}] (clojure.core/cond-> {} (letvar974574 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar974574 ["Policy"]))) (letvar974574 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar974574 ["PolicyArn"])))))))

(clojure.core/defn- response-list-policies-response ([input] (response-list-policies-response nil input)) ([resultWrapper974576 input] (clojure.core/let [rawinput974575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar974577 {"PolicyList" (rawinput974575 "PolicyList"), "NextToken" (rawinput974575 "NextToken")}] (clojure.core/cond-> {} (letvar974577 "PolicyList") (clojure.core/assoc :policy-list (deser-policy-summary-list (clojure.core/get-in letvar974577 ["PolicyList"]))) (letvar974577 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar974577 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 36 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/customer-policy-scope-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/managed-service-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/detailed-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/policy-update-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
