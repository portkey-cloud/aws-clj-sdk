...
(clojure.core/defn- response-list-compliance-status-response ([input] (response-list-compliance-status-response nil input)) ([resultWrapper1784149 input] (clojure.core/let [rawinput1784148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784150 {"PolicyComplianceStatusList" (rawinput1784148 "PolicyComplianceStatusList"), "NextToken" (rawinput1784148 "NextToken")}] (clojure.core/cond-> {} (letvar1784150 "PolicyComplianceStatusList") (clojure.core/assoc :policy-compliance-status-list (deser-policy-compliance-status-list (clojure.core/get-in letvar1784150 ["PolicyComplianceStatusList"]))) (letvar1784150 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1784150 ["NextToken"])))))))

(clojure.core/defn- response-list-member-accounts-response ([input] (response-list-member-accounts-response nil input)) ([resultWrapper1784152 input] (clojure.core/let [rawinput1784151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784153 {"MemberAccounts" (rawinput1784151 "MemberAccounts"), "NextToken" (rawinput1784151 "NextToken")}] (clojure.core/cond-> {} (letvar1784153 "MemberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar1784153 ["MemberAccounts"]))) (letvar1784153 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1784153 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1784155 input] (clojure.core/let [rawinput1784154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784156 {"Message" (rawinput1784154 "Message")}] (clojure.core/cond-> {} (letvar1784156 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784156 ["Message"])))))))

(clojure.core/defn- response-get-compliance-detail-response ([input] (response-get-compliance-detail-response nil input)) ([resultWrapper1784158 input] (clojure.core/let [rawinput1784157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784159 {"PolicyComplianceDetail" (rawinput1784157 "PolicyComplianceDetail")}] (clojure.core/cond-> {} (letvar1784159 "PolicyComplianceDetail") (clojure.core/assoc :policy-compliance-detail (deser-policy-compliance-detail (clojure.core/get-in letvar1784159 ["PolicyComplianceDetail"])))))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper1784161 input] (clojure.core/let [rawinput1784160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784162 {"Message" (rawinput1784160 "Message")}] (clojure.core/cond-> {} (letvar1784162 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784162 ["Message"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1784164 input] (clojure.core/let [rawinput1784163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784165 {"Message" (rawinput1784163 "Message")}] (clojure.core/cond-> {} (letvar1784165 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784165 ["Message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1784167 input] (clojure.core/let [rawinput1784166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784168 {"Message" (rawinput1784166 "Message")}] (clojure.core/cond-> {} (letvar1784168 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784168 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1784170 input] (clojure.core/let [rawinput1784169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784171 {"Message" (rawinput1784169 "Message")}] (clojure.core/cond-> {} (letvar1784171 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784171 ["Message"])))))))

(clojure.core/defn- response-get-notification-channel-response ([input] (response-get-notification-channel-response nil input)) ([resultWrapper1784173 input] (clojure.core/let [rawinput1784172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784174 {"SnsTopicArn" (rawinput1784172 "SnsTopicArn"), "SnsRoleName" (rawinput1784172 "SnsRoleName")}] (clojure.core/cond-> {} (letvar1784174 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-resource-arn (clojure.core/get-in letvar1784174 ["SnsTopicArn"]))) (letvar1784174 "SnsRoleName") (clojure.core/assoc :sns-role-name (deser-resource-arn (clojure.core/get-in letvar1784174 ["SnsRoleName"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1784176 input] (clojure.core/let [rawinput1784175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784177 {"Message" (rawinput1784175 "Message")}] (clojure.core/cond-> {} (letvar1784177 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1784177 ["Message"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1784179 input] (clojure.core/let [rawinput1784178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784180 {"Policy" (rawinput1784178 "Policy"), "PolicyArn" (rawinput1784178 "PolicyArn")}] (clojure.core/cond-> {} (letvar1784180 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1784180 ["Policy"]))) (letvar1784180 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1784180 ["PolicyArn"])))))))

(clojure.core/defn- response-get-admin-account-response ([input] (response-get-admin-account-response nil input)) ([resultWrapper1784182 input] (clojure.core/let [rawinput1784181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784183 {"AdminAccount" (rawinput1784181 "AdminAccount"), "RoleStatus" (rawinput1784181 "RoleStatus")}] (clojure.core/cond-> {} (letvar1784183 "AdminAccount") (clojure.core/assoc :admin-account (deser-aws-account-id (clojure.core/get-in letvar1784183 ["AdminAccount"]))) (letvar1784183 "RoleStatus") (clojure.core/assoc :role-status (deser-account-role-status (clojure.core/get-in letvar1784183 ["RoleStatus"])))))))

(clojure.core/defn- response-put-policy-response ([input] (response-put-policy-response nil input)) ([resultWrapper1784185 input] (clojure.core/let [rawinput1784184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784186 {"Policy" (rawinput1784184 "Policy"), "PolicyArn" (rawinput1784184 "PolicyArn")}] (clojure.core/cond-> {} (letvar1784186 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1784186 ["Policy"]))) (letvar1784186 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1784186 ["PolicyArn"])))))))

(clojure.core/defn- response-list-policies-response ([input] (response-list-policies-response nil input)) ([resultWrapper1784188 input] (clojure.core/let [rawinput1784187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1784189 {"PolicyList" (rawinput1784187 "PolicyList"), "NextToken" (rawinput1784187 "NextToken")}] (clojure.core/cond-> {} (letvar1784189 "PolicyList") (clojure.core/assoc :policy-list (deser-policy-summary-list (clojure.core/get-in letvar1784189 ["PolicyList"]))) (letvar1784189 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1784189 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 36 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/customer-policy-scope-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/managed-service-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/detailed-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms.-2018-01-01/policy-update-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
