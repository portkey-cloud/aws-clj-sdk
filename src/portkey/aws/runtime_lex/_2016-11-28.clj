...
(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper1597869 input] (clojure.core/let [rawinput1597868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597870 {"message" (rawinput1597868 "message")}] (clojure.core/cond-> {} (letvar1597870 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597870 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1597872 input] (clojure.core/let [rawinput1597871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597873 {"message" (rawinput1597871 "message")}] (clojure.core/cond-> {} (letvar1597873 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597873 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1597875 input] (clojure.core/let [rawinput1597874 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597876 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1597874 "message")}] (clojure.core/cond-> {} (letvar1597876 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar1597876 ["Retry-After"]))) (letvar1597876 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597876 ["message"])))))))

(clojure.core/defn- response-loop-detected-exception ([input] (response-loop-detected-exception nil input)) ([resultWrapper1597878 input] (clojure.core/let [rawinput1597877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597879 {"Message" (rawinput1597877 "Message")}] (clojure.core/cond-> {} (letvar1597879 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1597879 ["Message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1597881 input] (clojure.core/let [rawinput1597880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597882 {"message" (rawinput1597880 "message")}] (clojure.core/cond-> {} (letvar1597882 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597882 ["message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1597884 input] (clojure.core/let [rawinput1597883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597885 {"message" (rawinput1597883 "message")}] (clojure.core/cond-> {} (letvar1597885 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597885 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1597887 input] (clojure.core/let [rawinput1597886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597888 {"message" (rawinput1597886 "message")}] (clojure.core/cond-> {} (letvar1597888 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597888 ["message"])))))))

(clojure.core/defn- response-dependency-failed-exception ([input] (response-dependency-failed-exception nil input)) ([resultWrapper1597890 input] (clojure.core/let [rawinput1597889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597891 {"Message" (rawinput1597889 "Message")}] (clojure.core/cond-> {} (letvar1597891 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1597891 ["Message"])))))))

(clojure.core/defn- response-request-timeout-exception ([input] (response-request-timeout-exception nil input)) ([resultWrapper1597893 input] (clojure.core/let [rawinput1597892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597894 {"message" (rawinput1597892 "message")}] (clojure.core/cond-> {} (letvar1597894 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597894 ["message"])))))))

(clojure.core/defn- response-not-acceptable-exception ([input] (response-not-acceptable-exception nil input)) ([resultWrapper1597896 input] (clojure.core/let [rawinput1597895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597897 {"message" (rawinput1597895 "message")}] (clojure.core/cond-> {} (letvar1597897 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1597897 ["message"])))))))

(clojure.core/defn- response-bad-gateway-exception ([input] (response-bad-gateway-exception nil input)) ([resultWrapper1597899 input] (clojure.core/let [rawinput1597898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597900 {"Message" (rawinput1597898 "Message")}] (clojure.core/cond-> {} (letvar1597900 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1597900 ["Message"])))))))

(clojure.core/defn- response-post-text-response ([input] (response-post-text-response nil input)) ([resultWrapper1597902 input] (clojure.core/let [rawinput1597901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597903 {"intentName" (rawinput1597901 "intentName"), "slots" (rawinput1597901 "slots"), "sessionAttributes" (rawinput1597901 "sessionAttributes"), "message" (rawinput1597901 "message"), "messageFormat" (rawinput1597901 "messageFormat"), "dialogState" (rawinput1597901 "dialogState"), "slotToElicit" (rawinput1597901 "slotToElicit"), "responseCard" (rawinput1597901 "responseCard")}] (clojure.core/cond-> {} (letvar1597903 "intentName") (clojure.core/assoc :intent-name (deser-intent-name (clojure.core/get-in letvar1597903 ["intentName"]))) (letvar1597903 "slots") (clojure.core/assoc :slots (deser-string-map (clojure.core/get-in letvar1597903 ["slots"]))) (letvar1597903 "sessionAttributes") (clojure.core/assoc :session-attributes (deser-string-map (clojure.core/get-in letvar1597903 ["sessionAttributes"]))) (letvar1597903 "message") (clojure.core/assoc :message (deser-text (clojure.core/get-in letvar1597903 ["message"]))) (letvar1597903 "messageFormat") (clojure.core/assoc :message-format (deser-message-format-type (clojure.core/get-in letvar1597903 ["messageFormat"]))) (letvar1597903 "dialogState") (clojure.core/assoc :dialog-state (deser-dialog-state (clojure.core/get-in letvar1597903 ["dialogState"]))) (letvar1597903 "slotToElicit") (clojure.core/assoc :slot-to-elicit (deser-string (clojure.core/get-in letvar1597903 ["slotToElicit"]))) (letvar1597903 "responseCard") (clojure.core/assoc :response-card (deser-response-card (clojure.core/get-in letvar1597903 ["responseCard"])))))))

(clojure.core/defn- response-post-content-response ([input] (response-post-content-response nil input)) ([resultWrapper1597905 input] (clojure.core/let [rawinput1597904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1597906 {"x-amz-lex-slots" (clojure.core/get-in input [:headers "x-amz-lex-slots"]), "audioStream" (rawinput1597904 "audioStream"), "x-amz-lex-intent-name" (clojure.core/get-in input [:headers "x-amz-lex-intent-name"]), "x-amz-lex-session-attributes" (clojure.core/get-in input [:headers "x-amz-lex-session-attributes"]), "x-amz-lex-slot-to-elicit" (clojure.core/get-in input [:headers "x-amz-lex-slot-to-elicit"]), "x-amz-lex-message-format" (clojure.core/get-in input [:headers "x-amz-lex-message-format"]), "x-amz-lex-message" (clojure.core/get-in input [:headers "x-amz-lex-message"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amz-lex-dialog-state" (clojure.core/get-in input [:headers "x-amz-lex-dialog-state"]), "x-amz-lex-input-transcript" (clojure.core/get-in input [:headers "x-amz-lex-input-transcript"])}] (clojure.core/cond-> {} (letvar1597906 "x-amz-lex-message") (clojure.core/assoc :message (deser-text (clojure.core/get-in letvar1597906 ["x-amz-lex-message"]))) (letvar1597906 "x-amz-lex-slot-to-elicit") (clojure.core/assoc :slot-to-elicit (deser-string (clojure.core/get-in letvar1597906 ["x-amz-lex-slot-to-elicit"]))) (letvar1597906 "x-amz-lex-slots") (clojure.core/assoc :slots (deser-string (clojure.core/get-in letvar1597906 ["x-amz-lex-slots"]))) (letvar1597906 "audioStream") (clojure.core/assoc :audio-stream (deser-blob-stream (clojure.core/get-in letvar1597906 ["audioStream"]))) (letvar1597906 "x-amz-lex-intent-name") (clojure.core/assoc :intent-name (deser-intent-name (clojure.core/get-in letvar1597906 ["x-amz-lex-intent-name"]))) (letvar1597906 "x-amz-lex-message-format") (clojure.core/assoc :message-format (deser-message-format-type (clojure.core/get-in letvar1597906 ["x-amz-lex-message-format"]))) (letvar1597906 "x-amz-lex-input-transcript") (clojure.core/assoc :input-transcript (deser-string (clojure.core/get-in letvar1597906 ["x-amz-lex-input-transcript"]))) (letvar1597906 "Content-Type") (clojure.core/assoc :content-type (deser-http-content-type (clojure.core/get-in letvar1597906 ["Content-Type"]))) (letvar1597906 "x-amz-lex-dialog-state") (clojure.core/assoc :dialog-state (deser-dialog-state (clojure.core/get-in letvar1597906 ["x-amz-lex-dialog-state"]))) (letvar1597906 "x-amz-lex-session-attributes") (clojure.core/assoc :session-attributes (deser-string (clojure.core/get-in letvar1597906 ["x-amz-lex-session-attributes"])))))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 80))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9a-zA-Z._:-]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/string-url-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/button-text-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 15))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/http-content-type (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/button-value-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex.-2016-11-28/text (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
