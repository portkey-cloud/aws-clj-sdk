...
(clojure.core/defn- response-get-web-acl-response ([input] (response-get-web-acl-response nil input)) ([resultWrapper2162926 input] (clojure.core/let [rawinput2162925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162927 {"WebACL" (rawinput2162925 "WebACL")}] (clojure.core/cond-> {} (letvar2162927 "WebACL") (clojure.core/assoc :web-acl (deser-web-acl (clojure.core/get-in letvar2162927 ["WebACL"])))))))

(clojure.core/defn- response-list-regex-pattern-sets-response ([input] (response-list-regex-pattern-sets-response nil input)) ([resultWrapper2162929 input] (clojure.core/let [rawinput2162928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162930 {"NextMarker" (rawinput2162928 "NextMarker"), "RegexPatternSets" (rawinput2162928 "RegexPatternSets")}] (clojure.core/cond-> {} (letvar2162930 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2162930 ["NextMarker"]))) (letvar2162930 "RegexPatternSets") (clojure.core/assoc :regex-pattern-sets (deser-regex-pattern-set-summaries (clojure.core/get-in letvar2162930 ["RegexPatternSets"])))))))

(clojure.core/defn- response-waf-invalid-parameter-exception ([input] (response-waf-invalid-parameter-exception nil input)) ([resultWrapper2162932 input] (clojure.core/let [rawinput2162931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162933 {"field" (rawinput2162931 "field"), "parameter" (rawinput2162931 "parameter"), "reason" (rawinput2162931 "reason")}] (clojure.core/cond-> {} (letvar2162933 "field") (clojure.core/assoc :field (deser-parameter-exception-field (clojure.core/get-in letvar2162933 ["field"]))) (letvar2162933 "parameter") (clojure.core/assoc :parameter (deser-parameter-exception-parameter (clojure.core/get-in letvar2162933 ["parameter"]))) (letvar2162933 "reason") (clojure.core/assoc :reason (deser-parameter-exception-reason (clojure.core/get-in letvar2162933 ["reason"])))))))

(clojure.core/defn- response-update-regex-match-set-response ([input] (response-update-regex-match-set-response nil input)) ([resultWrapper2162935 input] (clojure.core/let [rawinput2162934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162936 {"ChangeToken" (rawinput2162934 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162936 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162936 ["ChangeToken"])))))))

(clojure.core/defn- response-update-xss-match-set-response ([input] (response-update-xss-match-set-response nil input)) ([resultWrapper2162938 input] (clojure.core/let [rawinput2162937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162939 {"ChangeToken" (rawinput2162937 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162939 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162939 ["ChangeToken"])))))))

(clojure.core/defn- response-create-regex-match-set-response ([input] (response-create-regex-match-set-response nil input)) ([resultWrapper2162941 input] (clojure.core/let [rawinput2162940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162942 {"RegexMatchSet" (rawinput2162940 "RegexMatchSet"), "ChangeToken" (rawinput2162940 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162942 "RegexMatchSet") (clojure.core/assoc :regex-match-set (deser-regex-match-set (clojure.core/get-in letvar2162942 ["RegexMatchSet"]))) (letvar2162942 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162942 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-invalid-account-exception ([input] (response-waf-invalid-account-exception nil input)) ([resultWrapper2162944 input] (clojure.core/let [rawinput2162943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162945 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-rules-response ([input] (response-list-rules-response nil input)) ([resultWrapper2162947 input] (clojure.core/let [rawinput2162946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162948 {"NextMarker" (rawinput2162946 "NextMarker"), "Rules" (rawinput2162946 "Rules")}] (clojure.core/cond-> {} (letvar2162948 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2162948 ["NextMarker"]))) (letvar2162948 "Rules") (clojure.core/assoc :rules (deser-rule-summaries (clojure.core/get-in letvar2162948 ["Rules"])))))))

(clojure.core/defn- response-waf-internal-error-exception ([input] (response-waf-internal-error-exception nil input)) ([resultWrapper2162950 input] (clojure.core/let [rawinput2162949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162951 {"message" (rawinput2162949 "message")}] (clojure.core/cond-> {} (letvar2162951 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2162951 ["message"])))))))

(clojure.core/defn- response-waf-invalid-operation-exception ([input] (response-waf-invalid-operation-exception nil input)) ([resultWrapper2162953 input] (clojure.core/let [rawinput2162952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162954 {"message" (rawinput2162952 "message")}] (clojure.core/cond-> {} (letvar2162954 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2162954 ["message"])))))))

(clojure.core/defn- response-delete-sql-injection-match-set-response ([input] (response-delete-sql-injection-match-set-response nil input)) ([resultWrapper2162956 input] (clojure.core/let [rawinput2162955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162957 {"ChangeToken" (rawinput2162955 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162957 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162957 ["ChangeToken"])))))))

(clojure.core/defn- response-get-xss-match-set-response ([input] (response-get-xss-match-set-response nil input)) ([resultWrapper2162959 input] (clojure.core/let [rawinput2162958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162960 {"XssMatchSet" (rawinput2162958 "XssMatchSet")}] (clojure.core/cond-> {} (letvar2162960 "XssMatchSet") (clojure.core/assoc :xss-match-set (deser-xss-match-set (clojure.core/get-in letvar2162960 ["XssMatchSet"])))))))

(clojure.core/defn- response-update-sql-injection-match-set-response ([input] (response-update-sql-injection-match-set-response nil input)) ([resultWrapper2162962 input] (clojure.core/let [rawinput2162961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162963 {"ChangeToken" (rawinput2162961 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162963 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162963 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-rule-group-response ([input] (response-delete-rule-group-response nil input)) ([resultWrapper2162965 input] (clojure.core/let [rawinput2162964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162966 {"ChangeToken" (rawinput2162964 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162966 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162966 ["ChangeToken"])))))))

(clojure.core/defn- response-list-xss-match-sets-response ([input] (response-list-xss-match-sets-response nil input)) ([resultWrapper2162968 input] (clojure.core/let [rawinput2162967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162969 {"NextMarker" (rawinput2162967 "NextMarker"), "XssMatchSets" (rawinput2162967 "XssMatchSets")}] (clojure.core/cond-> {} (letvar2162969 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2162969 ["NextMarker"]))) (letvar2162969 "XssMatchSets") (clojure.core/assoc :xss-match-sets (deser-xss-match-set-summaries (clojure.core/get-in letvar2162969 ["XssMatchSets"])))))))

(clojure.core/defn- response-waf-service-linked-role-error-exception ([input] (response-waf-service-linked-role-error-exception nil input)) ([resultWrapper2162971 input] (clojure.core/let [rawinput2162970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162972 {"message" (rawinput2162970 "message")}] (clojure.core/cond-> {} (letvar2162972 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2162972 ["message"])))))))

(clojure.core/defn- response-delete-permission-policy-response ([input] (response-delete-permission-policy-response nil input)) ([resultWrapper2162974 input] (clojure.core/let [rawinput2162973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162975 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-sql-injection-match-set-response ([input] (response-create-sql-injection-match-set-response nil input)) ([resultWrapper2162977 input] (clojure.core/let [rawinput2162976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162978 {"SqlInjectionMatchSet" (rawinput2162976 "SqlInjectionMatchSet"), "ChangeToken" (rawinput2162976 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162978 "SqlInjectionMatchSet") (clojure.core/assoc :sql-injection-match-set (deser-sql-injection-match-set (clojure.core/get-in letvar2162978 ["SqlInjectionMatchSet"]))) (letvar2162978 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162978 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-regex-match-set-response ([input] (response-delete-regex-match-set-response nil input)) ([resultWrapper2162980 input] (clojure.core/let [rawinput2162979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162981 {"ChangeToken" (rawinput2162979 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162981 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162981 ["ChangeToken"])))))))

(clojure.core/defn- response-put-permission-policy-response ([input] (response-put-permission-policy-response nil input)) ([resultWrapper2162983 input] (clojure.core/let [rawinput2162982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162984 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-waf-invalid-regex-pattern-exception ([input] (response-waf-invalid-regex-pattern-exception nil input)) ([resultWrapper2162986 input] (clojure.core/let [rawinput2162985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162987 {"message" (rawinput2162985 "message")}] (clojure.core/cond-> {} (letvar2162987 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2162987 ["message"])))))))

(clojure.core/defn- response-update-regex-pattern-set-response ([input] (response-update-regex-pattern-set-response nil input)) ([resultWrapper2162989 input] (clojure.core/let [rawinput2162988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162990 {"ChangeToken" (rawinput2162988 "ChangeToken")}] (clojure.core/cond-> {} (letvar2162990 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2162990 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-logging-configuration-response ([input] (response-delete-logging-configuration-response nil input)) ([resultWrapper2162992 input] (clojure.core/let [rawinput2162991 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162993 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-waf-nonexistent-item-exception ([input] (response-waf-nonexistent-item-exception nil input)) ([resultWrapper2162995 input] (clojure.core/let [rawinput2162994 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162996 {"message" (rawinput2162994 "message")}] (clojure.core/cond-> {} (letvar2162996 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2162996 ["message"])))))))

(clojure.core/defn- response-get-rule-response ([input] (response-get-rule-response nil input)) ([resultWrapper2162998 input] (clojure.core/let [rawinput2162997 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2162999 {"Rule" (rawinput2162997 "Rule")}] (clojure.core/cond-> {} (letvar2162999 "Rule") (clojure.core/assoc :rule (deser-rule (clojure.core/get-in letvar2162999 ["Rule"])))))))

(clojure.core/defn- response-list-geo-match-sets-response ([input] (response-list-geo-match-sets-response nil input)) ([resultWrapper2163001 input] (clojure.core/let [rawinput2163000 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163002 {"NextMarker" (rawinput2163000 "NextMarker"), "GeoMatchSets" (rawinput2163000 "GeoMatchSets")}] (clojure.core/cond-> {} (letvar2163002 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163002 ["NextMarker"]))) (letvar2163002 "GeoMatchSets") (clojure.core/assoc :geo-match-sets (deser-geo-match-set-summaries (clojure.core/get-in letvar2163002 ["GeoMatchSets"])))))))

(clojure.core/defn- response-get-byte-match-set-response ([input] (response-get-byte-match-set-response nil input)) ([resultWrapper2163004 input] (clojure.core/let [rawinput2163003 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163005 {"ByteMatchSet" (rawinput2163003 "ByteMatchSet")}] (clojure.core/cond-> {} (letvar2163005 "ByteMatchSet") (clojure.core/assoc :byte-match-set (deser-byte-match-set (clojure.core/get-in letvar2163005 ["ByteMatchSet"])))))))

(clojure.core/defn- response-waf-nonexistent-container-exception ([input] (response-waf-nonexistent-container-exception nil input)) ([resultWrapper2163007 input] (clojure.core/let [rawinput2163006 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163008 {"message" (rawinput2163006 "message")}] (clojure.core/cond-> {} (letvar2163008 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163008 ["message"])))))))

(clojure.core/defn- response-waf-stale-data-exception ([input] (response-waf-stale-data-exception nil input)) ([resultWrapper2163010 input] (clojure.core/let [rawinput2163009 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163011 {"message" (rawinput2163009 "message")}] (clojure.core/cond-> {} (letvar2163011 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163011 ["message"])))))))

(clojure.core/defn- response-waf-referenced-item-exception ([input] (response-waf-referenced-item-exception nil input)) ([resultWrapper2163013 input] (clojure.core/let [rawinput2163012 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163014 {"message" (rawinput2163012 "message")}] (clojure.core/cond-> {} (letvar2163014 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163014 ["message"])))))))

(clojure.core/defn- response-update-rule-response ([input] (response-update-rule-response nil input)) ([resultWrapper2163016 input] (clojure.core/let [rawinput2163015 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163017 {"ChangeToken" (rawinput2163015 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163017 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163017 ["ChangeToken"])))))))

(clojure.core/defn- response-create-size-constraint-set-response ([input] (response-create-size-constraint-set-response nil input)) ([resultWrapper2163019 input] (clojure.core/let [rawinput2163018 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163020 {"SizeConstraintSet" (rawinput2163018 "SizeConstraintSet"), "ChangeToken" (rawinput2163018 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163020 "SizeConstraintSet") (clojure.core/assoc :size-constraint-set (deser-size-constraint-set (clojure.core/get-in letvar2163020 ["SizeConstraintSet"]))) (letvar2163020 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163020 ["ChangeToken"])))))))

(clojure.core/defn- response-update-ip-set-response ([input] (response-update-ip-set-response nil input)) ([resultWrapper2163022 input] (clojure.core/let [rawinput2163021 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163023 {"ChangeToken" (rawinput2163021 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163023 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163023 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-rule-response ([input] (response-delete-rule-response nil input)) ([resultWrapper2163025 input] (clojure.core/let [rawinput2163024 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163026 {"ChangeToken" (rawinput2163024 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163026 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163026 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-xss-match-set-response ([input] (response-delete-xss-match-set-response nil input)) ([resultWrapper2163028 input] (clojure.core/let [rawinput2163027 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163029 {"ChangeToken" (rawinput2163027 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163029 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163029 ["ChangeToken"])))))))

(clojure.core/defn- response-create-web-acl-response ([input] (response-create-web-acl-response nil input)) ([resultWrapper2163031 input] (clojure.core/let [rawinput2163030 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163032 {"WebACL" (rawinput2163030 "WebACL"), "ChangeToken" (rawinput2163030 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163032 "WebACL") (clojure.core/assoc :web-acl (deser-web-acl (clojure.core/get-in letvar2163032 ["WebACL"]))) (letvar2163032 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163032 ["ChangeToken"])))))))

(clojure.core/defn- response-list-web-ac-ls-response ([input] (response-list-web-ac-ls-response nil input)) ([resultWrapper2163034 input] (clojure.core/let [rawinput2163033 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163035 {"NextMarker" (rawinput2163033 "NextMarker"), "WebACLs" (rawinput2163033 "WebACLs")}] (clojure.core/cond-> {} (letvar2163035 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163035 ["NextMarker"]))) (letvar2163035 "WebACLs") (clojure.core/assoc :web-ac-ls (deser-web-acl-summaries (clojure.core/get-in letvar2163035 ["WebACLs"])))))))

(clojure.core/defn- response-list-sql-injection-match-sets-response ([input] (response-list-sql-injection-match-sets-response nil input)) ([resultWrapper2163037 input] (clojure.core/let [rawinput2163036 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163038 {"NextMarker" (rawinput2163036 "NextMarker"), "SqlInjectionMatchSets" (rawinput2163036 "SqlInjectionMatchSets")}] (clojure.core/cond-> {} (letvar2163038 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163038 ["NextMarker"]))) (letvar2163038 "SqlInjectionMatchSets") (clojure.core/assoc :sql-injection-match-sets (deser-sql-injection-match-set-summaries (clojure.core/get-in letvar2163038 ["SqlInjectionMatchSets"])))))))

(clojure.core/defn- response-list-rule-groups-response ([input] (response-list-rule-groups-response nil input)) ([resultWrapper2163040 input] (clojure.core/let [rawinput2163039 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163041 {"NextMarker" (rawinput2163039 "NextMarker"), "RuleGroups" (rawinput2163039 "RuleGroups")}] (clojure.core/cond-> {} (letvar2163041 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163041 ["NextMarker"]))) (letvar2163041 "RuleGroups") (clojure.core/assoc :rule-groups (deser-rule-group-summaries (clojure.core/get-in letvar2163041 ["RuleGroups"])))))))

(clojure.core/defn- response-waf-non-empty-entity-exception ([input] (response-waf-non-empty-entity-exception nil input)) ([resultWrapper2163043 input] (clojure.core/let [rawinput2163042 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163044 {"message" (rawinput2163042 "message")}] (clojure.core/cond-> {} (letvar2163044 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163044 ["message"])))))))

(clojure.core/defn- response-get-regex-pattern-set-response ([input] (response-get-regex-pattern-set-response nil input)) ([resultWrapper2163046 input] (clojure.core/let [rawinput2163045 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163047 {"RegexPatternSet" (rawinput2163045 "RegexPatternSet")}] (clojure.core/cond-> {} (letvar2163047 "RegexPatternSet") (clojure.core/assoc :regex-pattern-set (deser-regex-pattern-set (clojure.core/get-in letvar2163047 ["RegexPatternSet"])))))))

(clojure.core/defn- response-get-ip-set-response ([input] (response-get-ip-set-response nil input)) ([resultWrapper2163049 input] (clojure.core/let [rawinput2163048 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163050 {"IPSet" (rawinput2163048 "IPSet")}] (clojure.core/cond-> {} (letvar2163050 "IPSet") (clojure.core/assoc :ip-set (deser-ip-set (clojure.core/get-in letvar2163050 ["IPSet"])))))))

(clojure.core/defn- response-delete-web-acl-response ([input] (response-delete-web-acl-response nil input)) ([resultWrapper2163052 input] (clojure.core/let [rawinput2163051 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163053 {"ChangeToken" (rawinput2163051 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163053 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163053 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rate-based-rule-response ([input] (response-get-rate-based-rule-response nil input)) ([resultWrapper2163055 input] (clojure.core/let [rawinput2163054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163056 {"Rule" (rawinput2163054 "Rule")}] (clojure.core/cond-> {} (letvar2163056 "Rule") (clojure.core/assoc :rule (deser-rate-based-rule (clojure.core/get-in letvar2163056 ["Rule"])))))))

(clojure.core/defn- response-list-activated-rules-in-rule-group-response ([input] (response-list-activated-rules-in-rule-group-response nil input)) ([resultWrapper2163058 input] (clojure.core/let [rawinput2163057 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163059 {"NextMarker" (rawinput2163057 "NextMarker"), "ActivatedRules" (rawinput2163057 "ActivatedRules")}] (clojure.core/cond-> {} (letvar2163059 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163059 ["NextMarker"]))) (letvar2163059 "ActivatedRules") (clojure.core/assoc :activated-rules (deser-activated-rules (clojure.core/get-in letvar2163059 ["ActivatedRules"])))))))

(clojure.core/defn- response-put-logging-configuration-response ([input] (response-put-logging-configuration-response nil input)) ([resultWrapper2163061 input] (clojure.core/let [rawinput2163060 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163062 {"LoggingConfiguration" (rawinput2163060 "LoggingConfiguration")}] (clojure.core/cond-> {} (letvar2163062 "LoggingConfiguration") (clojure.core/assoc :logging-configuration (deser-logging-configuration (clojure.core/get-in letvar2163062 ["LoggingConfiguration"])))))))

(clojure.core/defn- response-disassociate-web-acl-response ([input] (response-disassociate-web-acl-response nil input)) ([resultWrapper2163064 input] (clojure.core/let [rawinput2163063 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163065 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-logging-configuration-response ([input] (response-get-logging-configuration-response nil input)) ([resultWrapper2163067 input] (clojure.core/let [rawinput2163066 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163068 {"LoggingConfiguration" (rawinput2163066 "LoggingConfiguration")}] (clojure.core/cond-> {} (letvar2163068 "LoggingConfiguration") (clojure.core/assoc :logging-configuration (deser-logging-configuration (clojure.core/get-in letvar2163068 ["LoggingConfiguration"])))))))

(clojure.core/defn- response-update-byte-match-set-response ([input] (response-update-byte-match-set-response nil input)) ([resultWrapper2163070 input] (clojure.core/let [rawinput2163069 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163071 {"ChangeToken" (rawinput2163069 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163071 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163071 ["ChangeToken"])))))))

(clojure.core/defn- response-list-subscribed-rule-groups-response ([input] (response-list-subscribed-rule-groups-response nil input)) ([resultWrapper2163073 input] (clojure.core/let [rawinput2163072 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163074 {"NextMarker" (rawinput2163072 "NextMarker"), "RuleGroups" (rawinput2163072 "RuleGroups")}] (clojure.core/cond-> {} (letvar2163074 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163074 ["NextMarker"]))) (letvar2163074 "RuleGroups") (clojure.core/assoc :rule-groups (deser-subscribed-rule-group-summaries (clojure.core/get-in letvar2163074 ["RuleGroups"])))))))

(clojure.core/defn- response-update-geo-match-set-response ([input] (response-update-geo-match-set-response nil input)) ([resultWrapper2163076 input] (clojure.core/let [rawinput2163075 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163077 {"ChangeToken" (rawinput2163075 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163077 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163077 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-limits-exceeded-exception ([input] (response-waf-limits-exceeded-exception nil input)) ([resultWrapper2163079 input] (clojure.core/let [rawinput2163078 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163080 {"message" (rawinput2163078 "message")}] (clojure.core/cond-> {} (letvar2163080 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163080 ["message"])))))))

(clojure.core/defn- response-list-rate-based-rules-response ([input] (response-list-rate-based-rules-response nil input)) ([resultWrapper2163082 input] (clojure.core/let [rawinput2163081 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163083 {"NextMarker" (rawinput2163081 "NextMarker"), "Rules" (rawinput2163081 "Rules")}] (clojure.core/cond-> {} (letvar2163083 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163083 ["NextMarker"]))) (letvar2163083 "Rules") (clojure.core/assoc :rules (deser-rule-summaries (clojure.core/get-in letvar2163083 ["Rules"])))))))

(clojure.core/defn- response-create-byte-match-set-response ([input] (response-create-byte-match-set-response nil input)) ([resultWrapper2163085 input] (clojure.core/let [rawinput2163084 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163086 {"ByteMatchSet" (rawinput2163084 "ByteMatchSet"), "ChangeToken" (rawinput2163084 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163086 "ByteMatchSet") (clojure.core/assoc :byte-match-set (deser-byte-match-set (clojure.core/get-in letvar2163086 ["ByteMatchSet"]))) (letvar2163086 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163086 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-ip-set-response ([input] (response-delete-ip-set-response nil input)) ([resultWrapper2163088 input] (clojure.core/let [rawinput2163087 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163089 {"ChangeToken" (rawinput2163087 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163089 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163089 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-subscription-not-found-exception ([input] (response-waf-subscription-not-found-exception nil input)) ([resultWrapper2163091 input] (clojure.core/let [rawinput2163090 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163092 {"message" (rawinput2163090 "message")}] (clojure.core/cond-> {} (letvar2163092 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163092 ["message"])))))))

(clojure.core/defn- response-delete-size-constraint-set-response ([input] (response-delete-size-constraint-set-response nil input)) ([resultWrapper2163094 input] (clojure.core/let [rawinput2163093 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163095 {"ChangeToken" (rawinput2163093 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163095 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163095 ["ChangeToken"])))))))

(clojure.core/defn- response-get-geo-match-set-response ([input] (response-get-geo-match-set-response nil input)) ([resultWrapper2163097 input] (clojure.core/let [rawinput2163096 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163098 {"GeoMatchSet" (rawinput2163096 "GeoMatchSet")}] (clojure.core/cond-> {} (letvar2163098 "GeoMatchSet") (clojure.core/assoc :geo-match-set (deser-geo-match-set (clojure.core/get-in letvar2163098 ["GeoMatchSet"])))))))

(clojure.core/defn- response-create-geo-match-set-response ([input] (response-create-geo-match-set-response nil input)) ([resultWrapper2163100 input] (clojure.core/let [rawinput2163099 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163101 {"GeoMatchSet" (rawinput2163099 "GeoMatchSet"), "ChangeToken" (rawinput2163099 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163101 "GeoMatchSet") (clojure.core/assoc :geo-match-set (deser-geo-match-set (clojure.core/get-in letvar2163101 ["GeoMatchSet"]))) (letvar2163101 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163101 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-byte-match-set-response ([input] (response-delete-byte-match-set-response nil input)) ([resultWrapper2163103 input] (clojure.core/let [rawinput2163102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163104 {"ChangeToken" (rawinput2163102 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163104 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163104 ["ChangeToken"])))))))

(clojure.core/defn- response-update-rule-group-response ([input] (response-update-rule-group-response nil input)) ([resultWrapper2163106 input] (clojure.core/let [rawinput2163105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163107 {"ChangeToken" (rawinput2163105 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163107 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163107 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-invalid-permission-policy-exception ([input] (response-waf-invalid-permission-policy-exception nil input)) ([resultWrapper2163109 input] (clojure.core/let [rawinput2163108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163110 {"message" (rawinput2163108 "message")}] (clojure.core/cond-> {} (letvar2163110 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163110 ["message"])))))))

(clojure.core/defn- response-get-sampled-requests-response ([input] (response-get-sampled-requests-response nil input)) ([resultWrapper2163112 input] (clojure.core/let [rawinput2163111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163113 {"SampledRequests" (rawinput2163111 "SampledRequests"), "PopulationSize" (rawinput2163111 "PopulationSize"), "TimeWindow" (rawinput2163111 "TimeWindow")}] (clojure.core/cond-> {} (letvar2163113 "SampledRequests") (clojure.core/assoc :sampled-requests (deser-sampled-http-requests (clojure.core/get-in letvar2163113 ["SampledRequests"]))) (letvar2163113 "PopulationSize") (clojure.core/assoc :population-size (deser-population-size (clojure.core/get-in letvar2163113 ["PopulationSize"]))) (letvar2163113 "TimeWindow") (clojure.core/assoc :time-window (deser-time-window (clojure.core/get-in letvar2163113 ["TimeWindow"])))))))

(clojure.core/defn- response-create-xss-match-set-response ([input] (response-create-xss-match-set-response nil input)) ([resultWrapper2163115 input] (clojure.core/let [rawinput2163114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163116 {"XssMatchSet" (rawinput2163114 "XssMatchSet"), "ChangeToken" (rawinput2163114 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163116 "XssMatchSet") (clojure.core/assoc :xss-match-set (deser-xss-match-set (clojure.core/get-in letvar2163116 ["XssMatchSet"]))) (letvar2163116 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163116 ["ChangeToken"])))))))

(clojure.core/defn- response-update-rate-based-rule-response ([input] (response-update-rate-based-rule-response nil input)) ([resultWrapper2163118 input] (clojure.core/let [rawinput2163117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163119 {"ChangeToken" (rawinput2163117 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163119 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163119 ["ChangeToken"])))))))

(clojure.core/defn- response-get-size-constraint-set-response ([input] (response-get-size-constraint-set-response nil input)) ([resultWrapper2163121 input] (clojure.core/let [rawinput2163120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163122 {"SizeConstraintSet" (rawinput2163120 "SizeConstraintSet")}] (clojure.core/cond-> {} (letvar2163122 "SizeConstraintSet") (clojure.core/assoc :size-constraint-set (deser-size-constraint-set (clojure.core/get-in letvar2163122 ["SizeConstraintSet"])))))))

(clojure.core/defn- response-waf-unavailable-entity-exception ([input] (response-waf-unavailable-entity-exception nil input)) ([resultWrapper2163124 input] (clojure.core/let [rawinput2163123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163125 {"message" (rawinput2163123 "message")}] (clojure.core/cond-> {} (letvar2163125 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163125 ["message"])))))))

(clojure.core/defn- response-waf-disallowed-name-exception ([input] (response-waf-disallowed-name-exception nil input)) ([resultWrapper2163127 input] (clojure.core/let [rawinput2163126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163128 {"message" (rawinput2163126 "message")}] (clojure.core/cond-> {} (letvar2163128 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2163128 ["message"])))))))

(clojure.core/defn- response-update-size-constraint-set-response ([input] (response-update-size-constraint-set-response nil input)) ([resultWrapper2163130 input] (clojure.core/let [rawinput2163129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163131 {"ChangeToken" (rawinput2163129 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163131 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163131 ["ChangeToken"])))))))

(clojure.core/defn- response-create-regex-pattern-set-response ([input] (response-create-regex-pattern-set-response nil input)) ([resultWrapper2163133 input] (clojure.core/let [rawinput2163132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163134 {"RegexPatternSet" (rawinput2163132 "RegexPatternSet"), "ChangeToken" (rawinput2163132 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163134 "RegexPatternSet") (clojure.core/assoc :regex-pattern-set (deser-regex-pattern-set (clojure.core/get-in letvar2163134 ["RegexPatternSet"]))) (letvar2163134 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163134 ["ChangeToken"])))))))

(clojure.core/defn- response-list-logging-configurations-response ([input] (response-list-logging-configurations-response nil input)) ([resultWrapper2163136 input] (clojure.core/let [rawinput2163135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163137 {"LoggingConfigurations" (rawinput2163135 "LoggingConfigurations"), "NextMarker" (rawinput2163135 "NextMarker")}] (clojure.core/cond-> {} (letvar2163137 "LoggingConfigurations") (clojure.core/assoc :logging-configurations (deser-logging-configurations (clojure.core/get-in letvar2163137 ["LoggingConfigurations"]))) (letvar2163137 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163137 ["NextMarker"])))))))

(clojure.core/defn- response-delete-regex-pattern-set-response ([input] (response-delete-regex-pattern-set-response nil input)) ([resultWrapper2163139 input] (clojure.core/let [rawinput2163138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163140 {"ChangeToken" (rawinput2163138 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163140 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163140 ["ChangeToken"])))))))

(clojure.core/defn- response-create-rate-based-rule-response ([input] (response-create-rate-based-rule-response nil input)) ([resultWrapper2163142 input] (clojure.core/let [rawinput2163141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163143 {"Rule" (rawinput2163141 "Rule"), "ChangeToken" (rawinput2163141 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163143 "Rule") (clojure.core/assoc :rule (deser-rate-based-rule (clojure.core/get-in letvar2163143 ["Rule"]))) (letvar2163143 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163143 ["ChangeToken"])))))))

(clojure.core/defn- response-get-web-acl-for-resource-response ([input] (response-get-web-acl-for-resource-response nil input)) ([resultWrapper2163145 input] (clojure.core/let [rawinput2163144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163146 {"WebACLSummary" (rawinput2163144 "WebACLSummary")}] (clojure.core/cond-> {} (letvar2163146 "WebACLSummary") (clojure.core/assoc :web-acl-summary (deser-web-acl-summary (clojure.core/get-in letvar2163146 ["WebACLSummary"])))))))

(clojure.core/defn- response-list-regex-match-sets-response ([input] (response-list-regex-match-sets-response nil input)) ([resultWrapper2163148 input] (clojure.core/let [rawinput2163147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163149 {"NextMarker" (rawinput2163147 "NextMarker"), "RegexMatchSets" (rawinput2163147 "RegexMatchSets")}] (clojure.core/cond-> {} (letvar2163149 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163149 ["NextMarker"]))) (letvar2163149 "RegexMatchSets") (clojure.core/assoc :regex-match-sets (deser-regex-match-set-summaries (clojure.core/get-in letvar2163149 ["RegexMatchSets"])))))))

(clojure.core/defn- response-get-change-token-status-response ([input] (response-get-change-token-status-response nil input)) ([resultWrapper2163151 input] (clojure.core/let [rawinput2163150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163152 {"ChangeTokenStatus" (rawinput2163150 "ChangeTokenStatus")}] (clojure.core/cond-> {} (letvar2163152 "ChangeTokenStatus") (clojure.core/assoc :change-token-status (deser-change-token-status (clojure.core/get-in letvar2163152 ["ChangeTokenStatus"])))))))

(clojure.core/defn- response-list-byte-match-sets-response ([input] (response-list-byte-match-sets-response nil input)) ([resultWrapper2163154 input] (clojure.core/let [rawinput2163153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163155 {"NextMarker" (rawinput2163153 "NextMarker"), "ByteMatchSets" (rawinput2163153 "ByteMatchSets")}] (clojure.core/cond-> {} (letvar2163155 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163155 ["NextMarker"]))) (letvar2163155 "ByteMatchSets") (clojure.core/assoc :byte-match-sets (deser-byte-match-set-summaries (clojure.core/get-in letvar2163155 ["ByteMatchSets"])))))))

(clojure.core/defn- response-delete-rate-based-rule-response ([input] (response-delete-rate-based-rule-response nil input)) ([resultWrapper2163157 input] (clojure.core/let [rawinput2163156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163158 {"ChangeToken" (rawinput2163156 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163158 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163158 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rate-based-rule-managed-keys-response ([input] (response-get-rate-based-rule-managed-keys-response nil input)) ([resultWrapper2163160 input] (clojure.core/let [rawinput2163159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163161 {"ManagedKeys" (rawinput2163159 "ManagedKeys"), "NextMarker" (rawinput2163159 "NextMarker")}] (clojure.core/cond-> {} (letvar2163161 "ManagedKeys") (clojure.core/assoc :managed-keys (deser-managed-keys (clojure.core/get-in letvar2163161 ["ManagedKeys"]))) (letvar2163161 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163161 ["NextMarker"])))))))

(clojure.core/defn- response-list-size-constraint-sets-response ([input] (response-list-size-constraint-sets-response nil input)) ([resultWrapper2163163 input] (clojure.core/let [rawinput2163162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163164 {"NextMarker" (rawinput2163162 "NextMarker"), "SizeConstraintSets" (rawinput2163162 "SizeConstraintSets")}] (clojure.core/cond-> {} (letvar2163164 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163164 ["NextMarker"]))) (letvar2163164 "SizeConstraintSets") (clojure.core/assoc :size-constraint-sets (deser-size-constraint-set-summaries (clojure.core/get-in letvar2163164 ["SizeConstraintSets"])))))))

(clojure.core/defn- response-get-permission-policy-response ([input] (response-get-permission-policy-response nil input)) ([resultWrapper2163166 input] (clojure.core/let [rawinput2163165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163167 {"Policy" (rawinput2163165 "Policy")}] (clojure.core/cond-> {} (letvar2163167 "Policy") (clojure.core/assoc :policy (deser-policy-string (clojure.core/get-in letvar2163167 ["Policy"])))))))

(clojure.core/defn- response-create-rule-group-response ([input] (response-create-rule-group-response nil input)) ([resultWrapper2163169 input] (clojure.core/let [rawinput2163168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163170 {"RuleGroup" (rawinput2163168 "RuleGroup"), "ChangeToken" (rawinput2163168 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163170 "RuleGroup") (clojure.core/assoc :rule-group (deser-rule-group (clojure.core/get-in letvar2163170 ["RuleGroup"]))) (letvar2163170 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163170 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-geo-match-set-response ([input] (response-delete-geo-match-set-response nil input)) ([resultWrapper2163172 input] (clojure.core/let [rawinput2163171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163173 {"ChangeToken" (rawinput2163171 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163173 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163173 ["ChangeToken"])))))))

(clojure.core/defn- response-get-change-token-response ([input] (response-get-change-token-response nil input)) ([resultWrapper2163175 input] (clojure.core/let [rawinput2163174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163176 {"ChangeToken" (rawinput2163174 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163176 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163176 ["ChangeToken"])))))))

(clojure.core/defn- response-associate-web-acl-response ([input] (response-associate-web-acl-response nil input)) ([resultWrapper2163178 input] (clojure.core/let [rawinput2163177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163179 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-web-acl-response ([input] (response-update-web-acl-response nil input)) ([resultWrapper2163181 input] (clojure.core/let [rawinput2163180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163182 {"ChangeToken" (rawinput2163180 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163182 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163182 ["ChangeToken"])))))))

(clojure.core/defn- response-list-resources-for-web-acl-response ([input] (response-list-resources-for-web-acl-response nil input)) ([resultWrapper2163184 input] (clojure.core/let [rawinput2163183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163185 {"ResourceArns" (rawinput2163183 "ResourceArns")}] (clojure.core/cond-> {} (letvar2163185 "ResourceArns") (clojure.core/assoc :resource-arns (deser-resource-arns (clojure.core/get-in letvar2163185 ["ResourceArns"])))))))

(clojure.core/defn- response-get-sql-injection-match-set-response ([input] (response-get-sql-injection-match-set-response nil input)) ([resultWrapper2163187 input] (clojure.core/let [rawinput2163186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163188 {"SqlInjectionMatchSet" (rawinput2163186 "SqlInjectionMatchSet")}] (clojure.core/cond-> {} (letvar2163188 "SqlInjectionMatchSet") (clojure.core/assoc :sql-injection-match-set (deser-sql-injection-match-set (clojure.core/get-in letvar2163188 ["SqlInjectionMatchSet"])))))))

(clojure.core/defn- response-get-regex-match-set-response ([input] (response-get-regex-match-set-response nil input)) ([resultWrapper2163190 input] (clojure.core/let [rawinput2163189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163191 {"RegexMatchSet" (rawinput2163189 "RegexMatchSet")}] (clojure.core/cond-> {} (letvar2163191 "RegexMatchSet") (clojure.core/assoc :regex-match-set (deser-regex-match-set (clojure.core/get-in letvar2163191 ["RegexMatchSet"])))))))

(clojure.core/defn- response-create-rule-response ([input] (response-create-rule-response nil input)) ([resultWrapper2163193 input] (clojure.core/let [rawinput2163192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163194 {"Rule" (rawinput2163192 "Rule"), "ChangeToken" (rawinput2163192 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163194 "Rule") (clojure.core/assoc :rule (deser-rule (clojure.core/get-in letvar2163194 ["Rule"]))) (letvar2163194 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163194 ["ChangeToken"])))))))

(clojure.core/defn- response-create-ip-set-response ([input] (response-create-ip-set-response nil input)) ([resultWrapper2163196 input] (clojure.core/let [rawinput2163195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163197 {"IPSet" (rawinput2163195 "IPSet"), "ChangeToken" (rawinput2163195 "ChangeToken")}] (clojure.core/cond-> {} (letvar2163197 "IPSet") (clojure.core/assoc :ip-set (deser-ip-set (clojure.core/get-in letvar2163197 ["IPSet"]))) (letvar2163197 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2163197 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rule-group-response ([input] (response-get-rule-group-response nil input)) ([resultWrapper2163199 input] (clojure.core/let [rawinput2163198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163200 {"RuleGroup" (rawinput2163198 "RuleGroup")}] (clojure.core/cond-> {} (letvar2163200 "RuleGroup") (clojure.core/assoc :rule-group (deser-rule-group (clojure.core/get-in letvar2163200 ["RuleGroup"])))))))

(clojure.core/defn- response-list-ip-sets-response ([input] (response-list-ip-sets-response nil input)) ([resultWrapper2163202 input] (clojure.core/let [rawinput2163201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2163203 {"NextMarker" (rawinput2163201 "NextMarker"), "IPSets" (rawinput2163201 "IPSets")}] (clojure.core/cond-> {} (letvar2163203 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2163203 ["NextMarker"]))) (letvar2163203 "IPSets") (clojure.core/assoc :ip-sets (deser-ip-set-summaries (clojure.core/get-in letvar2163203 ["IPSets"])))))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/change-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/regex-pattern-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/policy-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/parameter-exception-parameter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/next-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf-regional/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224))))
