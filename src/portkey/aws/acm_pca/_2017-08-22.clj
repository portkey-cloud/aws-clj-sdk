...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper39305 input] (clojure.core/let [rawinput39304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39306 {"Certificate" (rawinput39304 "Certificate"), "CertificateChain" (rawinput39304 "CertificateChain")}] (clojure.core/cond-> {} (letvar39306 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar39306 ["Certificate"]))) (letvar39306 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar39306 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-audit-report-response ([input] (response-create-certificate-authority-audit-report-response nil input)) ([resultWrapper39308 input] (clojure.core/let [rawinput39307 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39309 {"AuditReportId" (rawinput39307 "AuditReportId"), "S3Key" (rawinput39307 "S3Key")}] (clojure.core/cond-> {} (letvar39309 "AuditReportId") (clojure.core/assoc :audit-report-id (deser-audit-report-id (clojure.core/get-in letvar39309 ["AuditReportId"]))) (letvar39309 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar39309 ["S3Key"])))))))

(clojure.core/defn- response-describe-certificate-authority-audit-report-response ([input] (response-describe-certificate-authority-audit-report-response nil input)) ([resultWrapper39311 input] (clojure.core/let [rawinput39310 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39312 {"AuditReportStatus" (rawinput39310 "AuditReportStatus"), "S3BucketName" (rawinput39310 "S3BucketName"), "S3Key" (rawinput39310 "S3Key"), "CreatedAt" (rawinput39310 "CreatedAt")}] (clojure.core/cond-> {} (letvar39312 "AuditReportStatus") (clojure.core/assoc :audit-report-status (deser-audit-report-status (clojure.core/get-in letvar39312 ["AuditReportStatus"]))) (letvar39312 "S3BucketName") (clojure.core/assoc :s-3-bucket-name (deser-string (clojure.core/get-in letvar39312 ["S3BucketName"]))) (letvar39312 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar39312 ["S3Key"]))) (letvar39312 "CreatedAt") (clojure.core/assoc :created-at (deser-t-stamp (clojure.core/get-in letvar39312 ["CreatedAt"])))))))

(clojure.core/defn- response-malformed-csr-exception ([input] (response-malformed-csr-exception nil input)) ([resultWrapper39314 input] (clojure.core/let [rawinput39313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39315 {"message" (rawinput39313 "message")}] (clojure.core/cond-> {} (letvar39315 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39315 ["message"])))))))

(clojure.core/defn- response-get-certificate-authority-certificate-response ([input] (response-get-certificate-authority-certificate-response nil input)) ([resultWrapper39317 input] (clojure.core/let [rawinput39316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39318 {"Certificate" (rawinput39316 "Certificate"), "CertificateChain" (rawinput39316 "CertificateChain")}] (clojure.core/cond-> {} (letvar39318 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar39318 ["Certificate"]))) (letvar39318 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar39318 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-response ([input] (response-create-certificate-authority-response nil input)) ([resultWrapper39320 input] (clojure.core/let [rawinput39319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39321 {"CertificateAuthorityArn" (rawinput39319 "CertificateAuthorityArn")}] (clojure.core/cond-> {} (letvar39321 "CertificateAuthorityArn") (clojure.core/assoc :certificate-authority-arn (deser-arn (clojure.core/get-in letvar39321 ["CertificateAuthorityArn"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper39323 input] (clojure.core/let [rawinput39322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39324 {"Tags" (rawinput39322 "Tags"), "NextToken" (rawinput39322 "NextToken")}] (clojure.core/cond-> {} (letvar39324 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar39324 ["Tags"]))) (letvar39324 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar39324 ["NextToken"])))))))

(clojure.core/defn- response-malformed-certificate-exception ([input] (response-malformed-certificate-exception nil input)) ([resultWrapper39326 input] (clojure.core/let [rawinput39325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39327 {"message" (rawinput39325 "message")}] (clojure.core/cond-> {} (letvar39327 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39327 ["message"])))))))

(clojure.core/defn- response-list-certificate-authorities-response ([input] (response-list-certificate-authorities-response nil input)) ([resultWrapper39329 input] (clojure.core/let [rawinput39328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39330 {"CertificateAuthorities" (rawinput39328 "CertificateAuthorities"), "NextToken" (rawinput39328 "NextToken")}] (clojure.core/cond-> {} (letvar39330 "CertificateAuthorities") (clojure.core/assoc :certificate-authorities (deser-certificate-authorities (clojure.core/get-in letvar39330 ["CertificateAuthorities"]))) (letvar39330 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar39330 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper39332 input] (clojure.core/let [rawinput39331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39333 {"message" (rawinput39331 "message")}] (clojure.core/cond-> {} (letvar39333 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39333 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper39335 input] (clojure.core/let [rawinput39334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39336 {"message" (rawinput39334 "message")}] (clojure.core/cond-> {} (letvar39336 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39336 ["message"])))))))

(clojure.core/defn- response-certificate-mismatch-exception ([input] (response-certificate-mismatch-exception nil input)) ([resultWrapper39338 input] (clojure.core/let [rawinput39337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39339 {"message" (rawinput39337 "message")}] (clojure.core/cond-> {} (letvar39339 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39339 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper39341 input] (clojure.core/let [rawinput39340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39342 {"message" (rawinput39340 "message")}] (clojure.core/cond-> {} (letvar39342 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39342 ["message"])))))))

(clojure.core/defn- response-describe-certificate-authority-response ([input] (response-describe-certificate-authority-response nil input)) ([resultWrapper39344 input] (clojure.core/let [rawinput39343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39345 {"CertificateAuthority" (rawinput39343 "CertificateAuthority")}] (clojure.core/cond-> {} (letvar39345 "CertificateAuthority") (clojure.core/assoc :certificate-authority (deser-certificate-authority (clojure.core/get-in letvar39345 ["CertificateAuthority"])))))))

(clojure.core/defn- response-get-certificate-authority-csr-response ([input] (response-get-certificate-authority-csr-response nil input)) ([resultWrapper39347 input] (clojure.core/let [rawinput39346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39348 {"Csr" (rawinput39346 "Csr")}] (clojure.core/cond-> {} (letvar39348 "Csr") (clojure.core/assoc :csr (deser-csr-body (clojure.core/get-in letvar39348 ["Csr"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper39350 input] (clojure.core/let [rawinput39349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39351 {"message" (rawinput39349 "message")}] (clojure.core/cond-> {} (letvar39351 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39351 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper39353 input] (clojure.core/let [rawinput39352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39354 {"message" (rawinput39352 "message")}] (clojure.core/cond-> {} (letvar39354 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39354 ["message"])))))))

(clojure.core/defn- response-invalid-args-exception ([input] (response-invalid-args-exception nil input)) ([resultWrapper39356 input] (clojure.core/let [rawinput39355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39357 {"message" (rawinput39355 "message")}] (clojure.core/cond-> {} (letvar39357 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39357 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper39359 input] (clojure.core/let [rawinput39358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39360 {"message" (rawinput39358 "message")}] (clojure.core/cond-> {} (letvar39360 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39360 ["message"])))))))

(clojure.core/defn- response-issue-certificate-response ([input] (response-issue-certificate-response nil input)) ([resultWrapper39362 input] (clojure.core/let [rawinput39361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39363 {"CertificateArn" (rawinput39361 "CertificateArn")}] (clojure.core/cond-> {} (letvar39363 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar39363 ["CertificateArn"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper39365 input] (clojure.core/let [rawinput39364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39366 {"message" (rawinput39364 "message")}] (clojure.core/cond-> {} (letvar39366 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39366 ["message"])))))))

(clojure.core/defn- response-invalid-policy-exception ([input] (response-invalid-policy-exception nil input)) ([resultWrapper39368 input] (clojure.core/let [rawinput39367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39369 {"message" (rawinput39367 "message")}] (clojure.core/cond-> {} (letvar39369 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39369 ["message"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper39371 input] (clojure.core/let [rawinput39370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39372 {"message" (rawinput39370 "message")}] (clojure.core/cond-> {} (letvar39372 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39372 ["message"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper39374 input] (clojure.core/let [rawinput39373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39375 {"message" (rawinput39373 "message")}] (clojure.core/cond-> {} (letvar39375 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39375 ["message"])))))))

(clojure.core/defn- response-request-failed-exception ([input] (response-request-failed-exception nil input)) ([resultWrapper39377 input] (clojure.core/let [rawinput39376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39378 {"message" (rawinput39376 "message")}] (clojure.core/cond-> {} (letvar39378 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39378 ["message"])))))))

(clojure.core/defn- response-request-already-processed-exception ([input] (response-request-already-processed-exception nil input)) ([resultWrapper39380 input] (clojure.core/let [rawinput39379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar39381 {"message" (rawinput39379 "message")}] (clojure.core/cond-> {} (letvar39381 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar39381 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-3-to-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/audit-report-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 36 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-3 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-40 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/country-code-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z]{2}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-253 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 253))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=/,.@-]+)*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-16 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16))))
