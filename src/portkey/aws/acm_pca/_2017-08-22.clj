...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper1422672 input] (clojure.core/let [rawinput1422671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422673 {"Certificate" (rawinput1422671 "Certificate"), "CertificateChain" (rawinput1422671 "CertificateChain")}] (clojure.core/cond-> {} (letvar1422673 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1422673 ["Certificate"]))) (letvar1422673 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1422673 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-audit-report-response ([input] (response-create-certificate-authority-audit-report-response nil input)) ([resultWrapper1422675 input] (clojure.core/let [rawinput1422674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422676 {"AuditReportId" (rawinput1422674 "AuditReportId"), "S3Key" (rawinput1422674 "S3Key")}] (clojure.core/cond-> {} (letvar1422676 "AuditReportId") (clojure.core/assoc :audit-report-id (deser-audit-report-id (clojure.core/get-in letvar1422676 ["AuditReportId"]))) (letvar1422676 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar1422676 ["S3Key"])))))))

(clojure.core/defn- response-describe-certificate-authority-audit-report-response ([input] (response-describe-certificate-authority-audit-report-response nil input)) ([resultWrapper1422678 input] (clojure.core/let [rawinput1422677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422679 {"AuditReportStatus" (rawinput1422677 "AuditReportStatus"), "S3BucketName" (rawinput1422677 "S3BucketName"), "S3Key" (rawinput1422677 "S3Key"), "CreatedAt" (rawinput1422677 "CreatedAt")}] (clojure.core/cond-> {} (letvar1422679 "AuditReportStatus") (clojure.core/assoc :audit-report-status (deser-audit-report-status (clojure.core/get-in letvar1422679 ["AuditReportStatus"]))) (letvar1422679 "S3BucketName") (clojure.core/assoc :s-3-bucket-name (deser-string (clojure.core/get-in letvar1422679 ["S3BucketName"]))) (letvar1422679 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar1422679 ["S3Key"]))) (letvar1422679 "CreatedAt") (clojure.core/assoc :created-at (deser-t-stamp (clojure.core/get-in letvar1422679 ["CreatedAt"])))))))

(clojure.core/defn- response-malformed-csr-exception ([input] (response-malformed-csr-exception nil input)) ([resultWrapper1422681 input] (clojure.core/let [rawinput1422680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422682 {"message" (rawinput1422680 "message")}] (clojure.core/cond-> {} (letvar1422682 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422682 ["message"])))))))

(clojure.core/defn- response-get-certificate-authority-certificate-response ([input] (response-get-certificate-authority-certificate-response nil input)) ([resultWrapper1422684 input] (clojure.core/let [rawinput1422683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422685 {"Certificate" (rawinput1422683 "Certificate"), "CertificateChain" (rawinput1422683 "CertificateChain")}] (clojure.core/cond-> {} (letvar1422685 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar1422685 ["Certificate"]))) (letvar1422685 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar1422685 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-response ([input] (response-create-certificate-authority-response nil input)) ([resultWrapper1422687 input] (clojure.core/let [rawinput1422686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422688 {"CertificateAuthorityArn" (rawinput1422686 "CertificateAuthorityArn")}] (clojure.core/cond-> {} (letvar1422688 "CertificateAuthorityArn") (clojure.core/assoc :certificate-authority-arn (deser-arn (clojure.core/get-in letvar1422688 ["CertificateAuthorityArn"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1422690 input] (clojure.core/let [rawinput1422689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422691 {"Tags" (rawinput1422689 "Tags"), "NextToken" (rawinput1422689 "NextToken")}] (clojure.core/cond-> {} (letvar1422691 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1422691 ["Tags"]))) (letvar1422691 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1422691 ["NextToken"])))))))

(clojure.core/defn- response-malformed-certificate-exception ([input] (response-malformed-certificate-exception nil input)) ([resultWrapper1422693 input] (clojure.core/let [rawinput1422692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422694 {"message" (rawinput1422692 "message")}] (clojure.core/cond-> {} (letvar1422694 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422694 ["message"])))))))

(clojure.core/defn- response-list-certificate-authorities-response ([input] (response-list-certificate-authorities-response nil input)) ([resultWrapper1422696 input] (clojure.core/let [rawinput1422695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422697 {"CertificateAuthorities" (rawinput1422695 "CertificateAuthorities"), "NextToken" (rawinput1422695 "NextToken")}] (clojure.core/cond-> {} (letvar1422697 "CertificateAuthorities") (clojure.core/assoc :certificate-authorities (deser-certificate-authorities (clojure.core/get-in letvar1422697 ["CertificateAuthorities"]))) (letvar1422697 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1422697 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1422699 input] (clojure.core/let [rawinput1422698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422700 {"message" (rawinput1422698 "message")}] (clojure.core/cond-> {} (letvar1422700 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422700 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1422702 input] (clojure.core/let [rawinput1422701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422703 {"message" (rawinput1422701 "message")}] (clojure.core/cond-> {} (letvar1422703 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422703 ["message"])))))))

(clojure.core/defn- response-certificate-mismatch-exception ([input] (response-certificate-mismatch-exception nil input)) ([resultWrapper1422705 input] (clojure.core/let [rawinput1422704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422706 {"message" (rawinput1422704 "message")}] (clojure.core/cond-> {} (letvar1422706 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422706 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper1422708 input] (clojure.core/let [rawinput1422707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422709 {"message" (rawinput1422707 "message")}] (clojure.core/cond-> {} (letvar1422709 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422709 ["message"])))))))

(clojure.core/defn- response-describe-certificate-authority-response ([input] (response-describe-certificate-authority-response nil input)) ([resultWrapper1422711 input] (clojure.core/let [rawinput1422710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422712 {"CertificateAuthority" (rawinput1422710 "CertificateAuthority")}] (clojure.core/cond-> {} (letvar1422712 "CertificateAuthority") (clojure.core/assoc :certificate-authority (deser-certificate-authority (clojure.core/get-in letvar1422712 ["CertificateAuthority"])))))))

(clojure.core/defn- response-get-certificate-authority-csr-response ([input] (response-get-certificate-authority-csr-response nil input)) ([resultWrapper1422714 input] (clojure.core/let [rawinput1422713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422715 {"Csr" (rawinput1422713 "Csr")}] (clojure.core/cond-> {} (letvar1422715 "Csr") (clojure.core/assoc :csr (deser-csr-body (clojure.core/get-in letvar1422715 ["Csr"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1422717 input] (clojure.core/let [rawinput1422716 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422718 {"message" (rawinput1422716 "message")}] (clojure.core/cond-> {} (letvar1422718 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422718 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper1422720 input] (clojure.core/let [rawinput1422719 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422721 {"message" (rawinput1422719 "message")}] (clojure.core/cond-> {} (letvar1422721 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422721 ["message"])))))))

(clojure.core/defn- response-invalid-args-exception ([input] (response-invalid-args-exception nil input)) ([resultWrapper1422723 input] (clojure.core/let [rawinput1422722 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422724 {"message" (rawinput1422722 "message")}] (clojure.core/cond-> {} (letvar1422724 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422724 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1422726 input] (clojure.core/let [rawinput1422725 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422727 {"message" (rawinput1422725 "message")}] (clojure.core/cond-> {} (letvar1422727 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422727 ["message"])))))))

(clojure.core/defn- response-issue-certificate-response ([input] (response-issue-certificate-response nil input)) ([resultWrapper1422729 input] (clojure.core/let [rawinput1422728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422730 {"CertificateArn" (rawinput1422728 "CertificateArn")}] (clojure.core/cond-> {} (letvar1422730 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar1422730 ["CertificateArn"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper1422732 input] (clojure.core/let [rawinput1422731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422733 {"message" (rawinput1422731 "message")}] (clojure.core/cond-> {} (letvar1422733 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422733 ["message"])))))))

(clojure.core/defn- response-invalid-policy-exception ([input] (response-invalid-policy-exception nil input)) ([resultWrapper1422735 input] (clojure.core/let [rawinput1422734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422736 {"message" (rawinput1422734 "message")}] (clojure.core/cond-> {} (letvar1422736 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422736 ["message"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper1422738 input] (clojure.core/let [rawinput1422737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422739 {"message" (rawinput1422737 "message")}] (clojure.core/cond-> {} (letvar1422739 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422739 ["message"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1422741 input] (clojure.core/let [rawinput1422740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422742 {"message" (rawinput1422740 "message")}] (clojure.core/cond-> {} (letvar1422742 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422742 ["message"])))))))

(clojure.core/defn- response-request-failed-exception ([input] (response-request-failed-exception nil input)) ([resultWrapper1422744 input] (clojure.core/let [rawinput1422743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422745 {"message" (rawinput1422743 "message")}] (clojure.core/cond-> {} (letvar1422745 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422745 ["message"])))))))

(clojure.core/defn- response-request-already-processed-exception ([input] (response-request-already-processed-exception nil input)) ([resultWrapper1422747 input] (clojure.core/let [rawinput1422746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1422748 {"message" (rawinput1422746 "message")}] (clojure.core/cond-> {} (letvar1422748 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1422748 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-3-to-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/audit-report-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 36 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 36)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/distinguished-name-qualifier-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9'()+-.?:/= ]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-3 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-40 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/country-code-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z]{2}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-253 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 253))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 5))))

(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=/,.@-]+)*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca.-2017-08-22/string-16 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 16))))
