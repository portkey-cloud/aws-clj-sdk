...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper167320 input] (clojure.core/let [rawinput167319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167321 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-environments-result ([input] (response-list-environments-result nil input)) ([resultWrapper167323 input] (clojure.core/let [rawinput167322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167324 {"nextToken" (rawinput167322 "nextToken"), "environmentIds" (rawinput167322 "environmentIds")}] (clojure.core/cond-> {} (letvar167324 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar167324 ["nextToken"]))) (letvar167324 "environmentIds") (clojure.core/assoc :environment-ids (deser-environment-id-list (clojure.core/get-in letvar167324 ["environmentIds"])))))))

(clojure.core/defn- response-describe-environment-memberships-result ([input] (response-describe-environment-memberships-result nil input)) ([resultWrapper167326 input] (clojure.core/let [rawinput167325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167327 {"memberships" (rawinput167325 "memberships"), "nextToken" (rawinput167325 "nextToken")}] (clojure.core/cond-> {} (letvar167327 "memberships") (clojure.core/assoc :memberships (deser-environment-members-list (clojure.core/get-in letvar167327 ["memberships"]))) (letvar167327 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar167327 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper167329 input] (clojure.core/let [rawinput167328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167330 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-environment-result ([input] (response-delete-environment-result nil input)) ([resultWrapper167332 input] (clojure.core/let [rawinput167331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167333 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-ec-2-result ([input] (response-create-environment-ec-2-result nil input)) ([resultWrapper167335 input] (clojure.core/let [rawinput167334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167336 {"environmentId" (rawinput167334 "environmentId")}] (clojure.core/cond-> {} (letvar167336 "environmentId") (clojure.core/assoc :environment-id (deser-environment-id (clojure.core/get-in letvar167336 ["environmentId"])))))))

(clojure.core/defn- response-update-environment-result ([input] (response-update-environment-result nil input)) ([resultWrapper167338 input] (clojure.core/let [rawinput167337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167339 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper167341 input] (clojure.core/let [rawinput167340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167342 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper167344 input] (clojure.core/let [rawinput167343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167345 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environment-status-result ([input] (response-describe-environment-status-result nil input)) ([resultWrapper167347 input] (clojure.core/let [rawinput167346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167348 {"status" (rawinput167346 "status"), "message" (rawinput167346 "message")}] (clojure.core/cond-> {} (letvar167348 "status") (clojure.core/assoc :status (deser-environment-status (clojure.core/get-in letvar167348 ["status"]))) (letvar167348 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar167348 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper167350 input] (clojure.core/let [rawinput167349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167351 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-environment-membership-result ([input] (response-update-environment-membership-result nil input)) ([resultWrapper167353 input] (clojure.core/let [rawinput167352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167354 {"membership" (rawinput167352 "membership")}] (clojure.core/cond-> {} (letvar167354 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar167354 ["membership"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper167356 input] (clojure.core/let [rawinput167355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167357 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper167359 input] (clojure.core/let [rawinput167358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167360 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-membership-result ([input] (response-create-environment-membership-result nil input)) ([resultWrapper167362 input] (clojure.core/let [rawinput167361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167363 {"membership" (rawinput167361 "membership")}] (clojure.core/cond-> {} (letvar167363 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar167363 ["membership"])))))))

(clojure.core/defn- response-delete-environment-membership-result ([input] (response-delete-environment-membership-result nil input)) ([resultWrapper167365 input] (clojure.core/let [rawinput167364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167366 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environments-result ([input] (response-describe-environments-result nil input)) ([resultWrapper167368 input] (clojure.core/let [rawinput167367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar167369 {"environments" (rawinput167367 "environments")}] (clojure.core/cond-> {} (letvar167369 "environments") (clojure.core/assoc :environments (deser-environment-list (clojure.core/get-in letvar167369 ["environments"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:(root|user|federated-user|assumed-role)\/?\S*" s__21078__auto__))))
