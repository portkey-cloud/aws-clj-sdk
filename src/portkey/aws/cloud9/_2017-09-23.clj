...
(clojure.core/defn- deser-internal-server-error-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-environments-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-string (input "nextToken"))) (clojure.core/contains? input "environmentIds") (clojure.core/assoc :environment-ids (deser-environment-id-list (input "environmentIds")))))

(clojure.core/defn- deser-describe-environment-memberships-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "memberships") (clojure.core/assoc :memberships (deser-environment-members-list (input "memberships"))) (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-string (input "nextToken")))))

(clojure.core/defn- deser-bad-request-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-environment-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-environment-ec-2-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "environmentId") (clojure.core/assoc :environment-id (deser-environment-id (input "environmentId")))))

(clojure.core/defn- deser-update-environment-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-forbidden-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-limit-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-environment-status-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "status") (clojure.core/assoc :status (deser-environment-status (input "status"))) (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-string (input "message")))))

(clojure.core/defn- deser-too-many-requests-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-environment-membership-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "membership") (clojure.core/assoc :membership (deser-environment-member (input "membership")))))

(clojure.core/defn- deser-conflict-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-not-found-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-environment-membership-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "membership") (clojure.core/assoc :membership (deser-environment-member (input "membership")))))

(clojure.core/defn- deser-delete-environment-membership-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-environments-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "environments") (clojure.core/assoc :environments (deser-environment-list (input "environments")))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 5 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/instance-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 5 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 20)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[a-z][1-9][.][a-z0-9]+$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloud9.-2017-09-23.environment/id :portkey.aws.cloud9.-2017-09-23.environment/name :portkey.aws.cloud9.-2017-09-23.environment/description :portkey.aws.cloud9.-2017-09-23.environment/type :portkey.aws.cloud9.-2017-09-23.environment/arn :portkey.aws.cloud9.-2017-09-23.environment/owner-arn]))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:\S+" s__27881__auto__))))
...
(clojure.core/defn update-environment ([update-environment-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-environment-request update-environment-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/update-environment-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/update-environment-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateEnvironment", :http.request.configuration/output-deser-fn deser-update-environment-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn describe-environment-status ([describe-environment-status-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-environment-status-request describe-environment-status-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/describe-environment-status-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/describe-environment-status-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeEnvironmentStatus", :http.request.configuration/output-deser-fn deser-describe-environment-status-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn create-environment-ec-2 ([create-environment-ec-2-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-environment-ec-2-request create-environment-ec-2-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/create-environment-ec-2-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/create-environment-ec-2-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateEnvironmentEC2", :http.request.configuration/output-deser-fn deser-create-environment-ec-2-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn list-environments ([] (list-environments {})) ([list-environments-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-list-environments-request list-environments-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/list-environments-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/list-environments-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListEnvironments", :http.request.configuration/output-deser-fn deser-list-environments-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn delete-environment ([delete-environment-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-environment-request delete-environment-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/delete-environment-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/delete-environment-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteEnvironment", :http.request.configuration/output-deser-fn deser-delete-environment-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn describe-environments ([describe-environments-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-environments-request describe-environments-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/describe-environments-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/describe-environments-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeEnvironments", :http.request.configuration/output-deser-fn deser-describe-environments-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn describe-environment-memberships ([] (describe-environment-memberships {})) ([describe-environment-memberships-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-environment-memberships-request describe-environment-memberships-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/describe-environment-memberships-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/describe-environment-memberships-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeEnvironmentMemberships", :http.request.configuration/output-deser-fn deser-describe-environment-memberships-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn update-environment-membership ([update-environment-membership-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-environment-membership-request update-environment-membership-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/update-environment-membership-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/update-environment-membership-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateEnvironmentMembership", :http.request.configuration/output-deser-fn deser-update-environment-membership-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn delete-environment-membership ([delete-environment-membership-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-environment-membership-request delete-environment-membership-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/delete-environment-membership-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/delete-environment-membership-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteEnvironmentMembership", :http.request.configuration/output-deser-fn deser-delete-environment-membership-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
...
(clojure.core/defn create-environment-membership ([create-environment-membership-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-environment-membership-request create-environment-membership-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cloud9.-2017-09-23/endpoints, :http.request.configuration/target-prefix "AWSCloud9WorkspaceManagementService", :http.request.spec/output-spec :portkey.aws.cloud9.-2017-09-23/create-environment-membership-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-09-23", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cloud9.-2017-09-23/create-environment-membership-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateEnvironmentMembership", :http.request.configuration/output-deser-fn deser-create-environment-membership-result, :http.request.spec/error-spec {"BadRequestException" :portkey.aws.cloud9.-2017-09-23/bad-request-exception, "ConflictException" :portkey.aws.cloud9.-2017-09-23/conflict-exception, "NotFoundException" :portkey.aws.cloud9.-2017-09-23/not-found-exception, "ForbiddenException" :portkey.aws.cloud9.-2017-09-23/forbidden-exception, "TooManyRequestsException" :portkey.aws.cloud9.-2017-09-23/too-many-requests-exception, "LimitExceededException" :portkey.aws.cloud9.-2017-09-23/limit-exceeded-exception, "InternalServerErrorException" :portkey.aws.cloud9.-2017-09-23/internal-server-error-exception}})))))
