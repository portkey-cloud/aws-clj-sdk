...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1475901 input] (clojure.core/let [rawinput1475900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475902 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-environments-result ([input] (response-list-environments-result nil input)) ([resultWrapper1475904 input] (clojure.core/let [rawinput1475903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475905 {"nextToken" (rawinput1475903 "nextToken"), "environmentIds" (rawinput1475903 "environmentIds")}] (clojure.core/cond-> {} (letvar1475905 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1475905 ["nextToken"]))) (letvar1475905 "environmentIds") (clojure.core/assoc :environment-ids (deser-environment-id-list (clojure.core/get-in letvar1475905 ["environmentIds"])))))))

(clojure.core/defn- response-describe-environment-memberships-result ([input] (response-describe-environment-memberships-result nil input)) ([resultWrapper1475907 input] (clojure.core/let [rawinput1475906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475908 {"memberships" (rawinput1475906 "memberships"), "nextToken" (rawinput1475906 "nextToken")}] (clojure.core/cond-> {} (letvar1475908 "memberships") (clojure.core/assoc :memberships (deser-environment-members-list (clojure.core/get-in letvar1475908 ["memberships"]))) (letvar1475908 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1475908 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1475910 input] (clojure.core/let [rawinput1475909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475911 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-environment-result ([input] (response-delete-environment-result nil input)) ([resultWrapper1475913 input] (clojure.core/let [rawinput1475912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475914 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-ec-2-result ([input] (response-create-environment-ec-2-result nil input)) ([resultWrapper1475916 input] (clojure.core/let [rawinput1475915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475917 {"environmentId" (rawinput1475915 "environmentId")}] (clojure.core/cond-> {} (letvar1475917 "environmentId") (clojure.core/assoc :environment-id (deser-environment-id (clojure.core/get-in letvar1475917 ["environmentId"])))))))

(clojure.core/defn- response-update-environment-result ([input] (response-update-environment-result nil input)) ([resultWrapper1475919 input] (clojure.core/let [rawinput1475918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475920 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1475922 input] (clojure.core/let [rawinput1475921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475923 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1475925 input] (clojure.core/let [rawinput1475924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475926 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environment-status-result ([input] (response-describe-environment-status-result nil input)) ([resultWrapper1475928 input] (clojure.core/let [rawinput1475927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475929 {"status" (rawinput1475927 "status"), "message" (rawinput1475927 "message")}] (clojure.core/cond-> {} (letvar1475929 "status") (clojure.core/assoc :status (deser-environment-status (clojure.core/get-in letvar1475929 ["status"]))) (letvar1475929 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1475929 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1475931 input] (clojure.core/let [rawinput1475930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475932 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-environment-membership-result ([input] (response-update-environment-membership-result nil input)) ([resultWrapper1475934 input] (clojure.core/let [rawinput1475933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475935 {"membership" (rawinput1475933 "membership")}] (clojure.core/cond-> {} (letvar1475935 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1475935 ["membership"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1475937 input] (clojure.core/let [rawinput1475936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475938 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1475940 input] (clojure.core/let [rawinput1475939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475941 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-membership-result ([input] (response-create-environment-membership-result nil input)) ([resultWrapper1475943 input] (clojure.core/let [rawinput1475942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475944 {"membership" (rawinput1475942 "membership")}] (clojure.core/cond-> {} (letvar1475944 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1475944 ["membership"])))))))

(clojure.core/defn- response-delete-environment-membership-result ([input] (response-delete-environment-membership-result nil input)) ([resultWrapper1475946 input] (clojure.core/let [rawinput1475945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475947 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environments-result ([input] (response-describe-environments-result nil input)) ([resultWrapper1475949 input] (clojure.core/let [rawinput1475948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475950 {"environments" (rawinput1475948 "environments")}] (clojure.core/cond-> {} (letvar1475950 "environments") (clojure.core/assoc :environments (deser-environment-list (clojure.core/get-in letvar1475950 ["environments"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/instance-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-z][1-9][.][a-z0-9]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9.-2017-09-23/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:(root|user|federated-user|assumed-role)\/?\S*" s__1410940__auto__))))
