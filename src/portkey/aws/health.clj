...
(clojure.core/defn- response-unsupported-locale ([input] (response-unsupported-locale nil input)) ([resultWrapper1808263 input] (clojure.core/let [rawinput1808262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808264 {"message" (rawinput1808262 "message")}] (clojure.core/cond-> {} (letvar1808264 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1808264 ["message"])))))))

(clojure.core/defn- response-invalid-pagination-token ([input] (response-invalid-pagination-token nil input)) ([resultWrapper1808266 input] (clojure.core/let [rawinput1808265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808267 {"message" (rawinput1808265 "message")}] (clojure.core/cond-> {} (letvar1808267 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1808267 ["message"])))))))

(clojure.core/defn- response-describe-entity-aggregates-response ([input] (response-describe-entity-aggregates-response nil input)) ([resultWrapper1808269 input] (clojure.core/let [rawinput1808268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808270 {"entityAggregates" (rawinput1808268 "entityAggregates")}] (clojure.core/cond-> {} (letvar1808270 "entityAggregates") (clojure.core/assoc :entity-aggregates (deser-entity-aggregate-list (clojure.core/get-in letvar1808270 ["entityAggregates"])))))))

(clojure.core/defn- response-describe-event-aggregates-response ([input] (response-describe-event-aggregates-response nil input)) ([resultWrapper1808272 input] (clojure.core/let [rawinput1808271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808273 {"eventAggregates" (rawinput1808271 "eventAggregates"), "nextToken" (rawinput1808271 "nextToken")}] (clojure.core/cond-> {} (letvar1808273 "eventAggregates") (clojure.core/assoc :event-aggregates (deser-event-aggregate-list (clojure.core/get-in letvar1808273 ["eventAggregates"]))) (letvar1808273 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1808273 ["nextToken"])))))))

(clojure.core/defn- response-describe-affected-entities-response ([input] (response-describe-affected-entities-response nil input)) ([resultWrapper1808275 input] (clojure.core/let [rawinput1808274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808276 {"entities" (rawinput1808274 "entities"), "nextToken" (rawinput1808274 "nextToken")}] (clojure.core/cond-> {} (letvar1808276 "entities") (clojure.core/assoc :entities (deser-entity-list (clojure.core/get-in letvar1808276 ["entities"]))) (letvar1808276 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1808276 ["nextToken"])))))))

(clojure.core/defn- response-describe-event-details-response ([input] (response-describe-event-details-response nil input)) ([resultWrapper1808278 input] (clojure.core/let [rawinput1808277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808279 {"successfulSet" (rawinput1808277 "successfulSet"), "failedSet" (rawinput1808277 "failedSet")}] (clojure.core/cond-> {} (letvar1808279 "successfulSet") (clojure.core/assoc :successful-set (deser-describe-event-details-successful-set (clojure.core/get-in letvar1808279 ["successfulSet"]))) (letvar1808279 "failedSet") (clojure.core/assoc :failed-set (deser-describe-event-details-failed-set (clojure.core/get-in letvar1808279 ["failedSet"])))))))

(clojure.core/defn- response-describe-event-types-response ([input] (response-describe-event-types-response nil input)) ([resultWrapper1808281 input] (clojure.core/let [rawinput1808280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808282 {"eventTypes" (rawinput1808280 "eventTypes"), "nextToken" (rawinput1808280 "nextToken")}] (clojure.core/cond-> {} (letvar1808282 "eventTypes") (clojure.core/assoc :event-types (deser-event-type-list (clojure.core/get-in letvar1808282 ["eventTypes"]))) (letvar1808282 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1808282 ["nextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1808284 input] (clojure.core/let [rawinput1808283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1808285 {"events" (rawinput1808283 "events"), "nextToken" (rawinput1808283 "nextToken")}] (clojure.core/cond-> {} (letvar1808285 "events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1808285 ["events"]))) (letvar1808285 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1808285 ["nextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.health/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9]{12}" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/event-type-list (clojure.spec.alpha/coll-of :portkey.aws.health/event-type))

(clojure.spec.alpha/def :portkey.aws.health/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){3}" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.health/entity-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"https?://.+\.(amazon\.com|amazonaws\.com|amazonaws\.cn|c2s\.ic\.gov|sc2s\.sgov\.gov|amazonaws-us-gov.com)/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
