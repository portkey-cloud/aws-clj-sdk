...
(clojure.core/defn- response-unsupported-locale ([input] (response-unsupported-locale nil input)) ([resultWrapper1832061 input] (clojure.core/let [rawinput1832060 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832062 {"message" (rawinput1832060 "message")}] (clojure.core/cond-> {} (letvar1832062 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1832062 ["message"])))))))

(clojure.core/defn- response-invalid-pagination-token ([input] (response-invalid-pagination-token nil input)) ([resultWrapper1832064 input] (clojure.core/let [rawinput1832063 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832065 {"message" (rawinput1832063 "message")}] (clojure.core/cond-> {} (letvar1832065 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1832065 ["message"])))))))

(clojure.core/defn- response-describe-entity-aggregates-response ([input] (response-describe-entity-aggregates-response nil input)) ([resultWrapper1832067 input] (clojure.core/let [rawinput1832066 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832068 {"entityAggregates" (rawinput1832066 "entityAggregates")}] (clojure.core/cond-> {} (letvar1832068 "entityAggregates") (clojure.core/assoc :entity-aggregates (deser-entity-aggregate-list (clojure.core/get-in letvar1832068 ["entityAggregates"])))))))

(clojure.core/defn- response-describe-event-aggregates-response ([input] (response-describe-event-aggregates-response nil input)) ([resultWrapper1832070 input] (clojure.core/let [rawinput1832069 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832071 {"eventAggregates" (rawinput1832069 "eventAggregates"), "nextToken" (rawinput1832069 "nextToken")}] (clojure.core/cond-> {} (letvar1832071 "eventAggregates") (clojure.core/assoc :event-aggregates (deser-event-aggregate-list (clojure.core/get-in letvar1832071 ["eventAggregates"]))) (letvar1832071 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1832071 ["nextToken"])))))))

(clojure.core/defn- response-describe-affected-entities-response ([input] (response-describe-affected-entities-response nil input)) ([resultWrapper1832073 input] (clojure.core/let [rawinput1832072 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832074 {"entities" (rawinput1832072 "entities"), "nextToken" (rawinput1832072 "nextToken")}] (clojure.core/cond-> {} (letvar1832074 "entities") (clojure.core/assoc :entities (deser-entity-list (clojure.core/get-in letvar1832074 ["entities"]))) (letvar1832074 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1832074 ["nextToken"])))))))

(clojure.core/defn- response-describe-event-details-response ([input] (response-describe-event-details-response nil input)) ([resultWrapper1832076 input] (clojure.core/let [rawinput1832075 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832077 {"successfulSet" (rawinput1832075 "successfulSet"), "failedSet" (rawinput1832075 "failedSet")}] (clojure.core/cond-> {} (letvar1832077 "successfulSet") (clojure.core/assoc :successful-set (deser-describe-event-details-successful-set (clojure.core/get-in letvar1832077 ["successfulSet"]))) (letvar1832077 "failedSet") (clojure.core/assoc :failed-set (deser-describe-event-details-failed-set (clojure.core/get-in letvar1832077 ["failedSet"])))))))

(clojure.core/defn- response-describe-event-types-response ([input] (response-describe-event-types-response nil input)) ([resultWrapper1832079 input] (clojure.core/let [rawinput1832078 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832080 {"eventTypes" (rawinput1832078 "eventTypes"), "nextToken" (rawinput1832078 "nextToken")}] (clojure.core/cond-> {} (letvar1832080 "eventTypes") (clojure.core/assoc :event-types (deser-event-type-list (clojure.core/get-in letvar1832080 ["eventTypes"]))) (letvar1832080 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1832080 ["nextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1832082 input] (clojure.core/let [rawinput1832081 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1832083 {"events" (rawinput1832081 "events"), "nextToken" (rawinput1832081 "nextToken")}] (clojure.core/cond-> {} (letvar1832083 "events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1832083 ["events"]))) (letvar1832083 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1832083 ["nextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.health/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9]{12}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/event-type-list (clojure.spec.alpha/coll-of :portkey.aws.health/event-type))

(clojure.spec.alpha/def :portkey.aws.health/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){3}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.health/entity-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"https?://.+\.(amazon\.com|amazonaws\.com|amazonaws\.cn|c2s\.ic\.gov|sc2s\.sgov\.gov|amazonaws-us-gov.com)/.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 3 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.health/affected-entity (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.health/entity-arn :portkey.aws.health/event-arn :portkey.aws.health/entity-value :portkey.aws.health/entity-url :portkey.aws.health.affected-entity/aws-account-id :portkey.aws.health.affected-entity/last-updated-time :portkey.aws.health.affected-entity/status-code :portkey.aws.health.affected-entity/tags]))
