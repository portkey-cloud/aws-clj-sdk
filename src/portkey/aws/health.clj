...
(clojure.core/defn- response-unsupported-locale ([input] (response-unsupported-locale nil input)) ([resultWrapper1060177 input] (clojure.core/let [rawinput1060176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060178 {"message" (rawinput1060176 "message")}] (clojure.core/cond-> {} (letvar1060178 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1060178 ["message"])))))))

(clojure.core/defn- response-invalid-pagination-token ([input] (response-invalid-pagination-token nil input)) ([resultWrapper1060180 input] (clojure.core/let [rawinput1060179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060181 {"message" (rawinput1060179 "message")}] (clojure.core/cond-> {} (letvar1060181 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar1060181 ["message"])))))))

(clojure.core/defn- response-describe-entity-aggregates-response ([input] (response-describe-entity-aggregates-response nil input)) ([resultWrapper1060183 input] (clojure.core/let [rawinput1060182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060184 {"entityAggregates" (rawinput1060182 "entityAggregates")}] (clojure.core/cond-> {} (letvar1060184 "entityAggregates") (clojure.core/assoc :entity-aggregates (deser-entity-aggregate-list (clojure.core/get-in letvar1060184 ["entityAggregates"])))))))

(clojure.core/defn- response-describe-event-aggregates-response ([input] (response-describe-event-aggregates-response nil input)) ([resultWrapper1060186 input] (clojure.core/let [rawinput1060185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060187 {"eventAggregates" (rawinput1060185 "eventAggregates"), "nextToken" (rawinput1060185 "nextToken")}] (clojure.core/cond-> {} (letvar1060187 "eventAggregates") (clojure.core/assoc :event-aggregates (deser-event-aggregate-list (clojure.core/get-in letvar1060187 ["eventAggregates"]))) (letvar1060187 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1060187 ["nextToken"])))))))

(clojure.core/defn- response-describe-affected-entities-response ([input] (response-describe-affected-entities-response nil input)) ([resultWrapper1060189 input] (clojure.core/let [rawinput1060188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060190 {"entities" (rawinput1060188 "entities"), "nextToken" (rawinput1060188 "nextToken")}] (clojure.core/cond-> {} (letvar1060190 "entities") (clojure.core/assoc :entities (deser-entity-list (clojure.core/get-in letvar1060190 ["entities"]))) (letvar1060190 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1060190 ["nextToken"])))))))

(clojure.core/defn- response-describe-event-details-response ([input] (response-describe-event-details-response nil input)) ([resultWrapper1060192 input] (clojure.core/let [rawinput1060191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060193 {"successfulSet" (rawinput1060191 "successfulSet"), "failedSet" (rawinput1060191 "failedSet")}] (clojure.core/cond-> {} (letvar1060193 "successfulSet") (clojure.core/assoc :successful-set (deser-describe-event-details-successful-set (clojure.core/get-in letvar1060193 ["successfulSet"]))) (letvar1060193 "failedSet") (clojure.core/assoc :failed-set (deser-describe-event-details-failed-set (clojure.core/get-in letvar1060193 ["failedSet"])))))))

(clojure.core/defn- response-describe-event-types-response ([input] (response-describe-event-types-response nil input)) ([resultWrapper1060195 input] (clojure.core/let [rawinput1060194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060196 {"eventTypes" (rawinput1060194 "eventTypes"), "nextToken" (rawinput1060194 "nextToken")}] (clojure.core/cond-> {} (letvar1060196 "eventTypes") (clojure.core/assoc :event-types (deser-event-type-list (clojure.core/get-in letvar1060196 ["eventTypes"]))) (letvar1060196 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1060196 ["nextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1060198 input] (clojure.core/let [rawinput1060197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1060199 {"events" (rawinput1060197 "events"), "nextToken" (rawinput1060197 "nextToken")}] (clojure.core/cond-> {} (letvar1060199 "events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1060199 ["events"]))) (letvar1060199 "nextToken") (clojure.core/assoc :next-token (desernext-token (clojure.core/get-in letvar1060199 ["nextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.health/entity-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/metadata-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.health/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]{12}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/event-type-list (clojure.spec.alpha/coll-of :portkey.aws.health/event-type))

(clojure.spec.alpha/def :portkey.aws.health/entity-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:health:[^:]*:[^:]*:event(?:/[\w-]+){3}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.health/entity-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"https?://.+\.(amazon\.com|amazonaws\.com|amazonaws\.cn|c2s\.ic\.gov|sc2s\.sgov\.gov|amazonaws-us-gov.com)/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.health/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=/+_.-]{4,512}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/locale (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.health/region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:/]{2,25}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.health/availability-zone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z]{2}\-[0-9a-z\-]{4,16}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.health/event-type-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.health/service (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.health/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 127))))
