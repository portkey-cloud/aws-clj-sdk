...
(clojure.core/defn- response-endpoint-group-not-found-exception ([input] (response-endpoint-group-not-found-exception nil input)) ([resultWrapper1803381 input] (clojure.core/let [rawinput1803380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803382 {"Message" (rawinput1803380 "Message")}] (clojure.core/cond-> {} (letvar1803382 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803382 ["Message"])))))))

(clojure.core/defn- response-associated-listener-found-exception ([input] (response-associated-listener-found-exception nil input)) ([resultWrapper1803384 input] (clojure.core/let [rawinput1803383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803385 {"Message" (rawinput1803383 "Message")}] (clojure.core/cond-> {} (letvar1803385 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803385 ["Message"])))))))

(clojure.core/defn- response-endpoint-group-already-exists-exception ([input] (response-endpoint-group-already-exists-exception nil input)) ([resultWrapper1803387 input] (clojure.core/let [rawinput1803386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803388 {"Message" (rawinput1803386 "Message")}] (clojure.core/cond-> {} (letvar1803388 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803388 ["Message"])))))))

(clojure.core/defn- response-update-accelerator-response ([input] (response-update-accelerator-response nil input)) ([resultWrapper1803390 input] (clojure.core/let [rawinput1803389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803391 {"Accelerator" (rawinput1803389 "Accelerator")}] (clojure.core/cond-> {} (letvar1803391 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1803391 ["Accelerator"])))))))

(clojure.core/defn- response-describe-accelerator-attributes-response ([input] (response-describe-accelerator-attributes-response nil input)) ([resultWrapper1803393 input] (clojure.core/let [rawinput1803392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803394 {"AcceleratorAttributes" (rawinput1803392 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1803394 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1803394 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-list-listeners-response ([input] (response-list-listeners-response nil input)) ([resultWrapper1803396 input] (clojure.core/let [rawinput1803395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803397 {"Listeners" (rawinput1803395 "Listeners"), "NextToken" (rawinput1803395 "NextToken")}] (clojure.core/cond-> {} (letvar1803397 "Listeners") (clojure.core/assoc :listeners (deser-listeners (clojure.core/get-in letvar1803397 ["Listeners"]))) (letvar1803397 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1803397 ["NextToken"])))))))

(clojure.core/defn- response-update-accelerator-attributes-response ([input] (response-update-accelerator-attributes-response nil input)) ([resultWrapper1803399 input] (clojure.core/let [rawinput1803398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803400 {"AcceleratorAttributes" (rawinput1803398 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1803400 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1803400 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1803402 input] (clojure.core/let [rawinput1803401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803403 {"Message" (rawinput1803401 "Message")}] (clojure.core/cond-> {} (letvar1803403 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803403 ["Message"])))))))

(clojure.core/defn- response-describe-listener-response ([input] (response-describe-listener-response nil input)) ([resultWrapper1803405 input] (clojure.core/let [rawinput1803404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803406 {"Listener" (rawinput1803404 "Listener")}] (clojure.core/cond-> {} (letvar1803406 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1803406 ["Listener"])))))))

(clojure.core/defn- response-update-endpoint-group-response ([input] (response-update-endpoint-group-response nil input)) ([resultWrapper1803408 input] (clojure.core/let [rawinput1803407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803409 {"EndpointGroup" (rawinput1803407 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1803409 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1803409 ["EndpointGroup"])))))))

(clojure.core/defn- response-associated-endpoint-group-found-exception ([input] (response-associated-endpoint-group-found-exception nil input)) ([resultWrapper1803411 input] (clojure.core/let [rawinput1803410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803412 {"Message" (rawinput1803410 "Message")}] (clojure.core/cond-> {} (letvar1803412 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803412 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1803414 input] (clojure.core/let [rawinput1803413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803415 {"Message" (rawinput1803413 "Message")}] (clojure.core/cond-> {} (letvar1803415 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803415 ["Message"])))))))

(clojure.core/defn- response-list-endpoint-groups-response ([input] (response-list-endpoint-groups-response nil input)) ([resultWrapper1803417 input] (clojure.core/let [rawinput1803416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803418 {"EndpointGroups" (rawinput1803416 "EndpointGroups"), "NextToken" (rawinput1803416 "NextToken")}] (clojure.core/cond-> {} (letvar1803418 "EndpointGroups") (clojure.core/assoc :endpoint-groups (deser-endpoint-groups (clojure.core/get-in letvar1803418 ["EndpointGroups"]))) (letvar1803418 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1803418 ["NextToken"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1803420 input] (clojure.core/let [rawinput1803419 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803421 {"Message" (rawinput1803419 "Message")}] (clojure.core/cond-> {} (letvar1803421 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803421 ["Message"])))))))

(clojure.core/defn- response-describe-accelerator-response ([input] (response-describe-accelerator-response nil input)) ([resultWrapper1803423 input] (clojure.core/let [rawinput1803422 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803424 {"Accelerator" (rawinput1803422 "Accelerator")}] (clojure.core/cond-> {} (letvar1803424 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1803424 ["Accelerator"])))))))

(clojure.core/defn- response-update-listener-response ([input] (response-update-listener-response nil input)) ([resultWrapper1803426 input] (clojure.core/let [rawinput1803425 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803427 {"Listener" (rawinput1803425 "Listener")}] (clojure.core/cond-> {} (letvar1803427 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1803427 ["Listener"])))))))

(clojure.core/defn- response-create-accelerator-response ([input] (response-create-accelerator-response nil input)) ([resultWrapper1803429 input] (clojure.core/let [rawinput1803428 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803430 {"Accelerator" (rawinput1803428 "Accelerator")}] (clojure.core/cond-> {} (letvar1803430 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1803430 ["Accelerator"])))))))

(clojure.core/defn- response-accelerator-not-disabled-exception ([input] (response-accelerator-not-disabled-exception nil input)) ([resultWrapper1803432 input] (clojure.core/let [rawinput1803431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803433 {"Message" (rawinput1803431 "Message")}] (clojure.core/cond-> {} (letvar1803433 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803433 ["Message"])))))))

(clojure.core/defn- response-describe-endpoint-group-response ([input] (response-describe-endpoint-group-response nil input)) ([resultWrapper1803435 input] (clojure.core/let [rawinput1803434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803436 {"EndpointGroup" (rawinput1803434 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1803436 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1803436 ["EndpointGroup"])))))))

(clojure.core/defn- response-accelerator-not-found-exception ([input] (response-accelerator-not-found-exception nil input)) ([resultWrapper1803438 input] (clojure.core/let [rawinput1803437 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803439 {"Message" (rawinput1803437 "Message")}] (clojure.core/cond-> {} (letvar1803439 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803439 ["Message"])))))))

(clojure.core/defn- response-create-listener-response ([input] (response-create-listener-response nil input)) ([resultWrapper1803441 input] (clojure.core/let [rawinput1803440 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803442 {"Listener" (rawinput1803440 "Listener")}] (clojure.core/cond-> {} (letvar1803442 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1803442 ["Listener"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1803444 input] (clojure.core/let [rawinput1803443 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803445 {"Message" (rawinput1803443 "Message")}] (clojure.core/cond-> {} (letvar1803445 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803445 ["Message"])))))))

(clojure.core/defn- response-invalid-port-range-exception ([input] (response-invalid-port-range-exception nil input)) ([resultWrapper1803447 input] (clojure.core/let [rawinput1803446 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803448 {"Message" (rawinput1803446 "Message")}] (clojure.core/cond-> {} (letvar1803448 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803448 ["Message"])))))))

(clojure.core/defn- response-list-accelerators-response ([input] (response-list-accelerators-response nil input)) ([resultWrapper1803450 input] (clojure.core/let [rawinput1803449 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803451 {"Accelerators" (rawinput1803449 "Accelerators"), "NextToken" (rawinput1803449 "NextToken")}] (clojure.core/cond-> {} (letvar1803451 "Accelerators") (clojure.core/assoc :accelerators (deser-accelerators (clojure.core/get-in letvar1803451 ["Accelerators"]))) (letvar1803451 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1803451 ["NextToken"])))))))

(clojure.core/defn- response-listener-not-found-exception ([input] (response-listener-not-found-exception nil input)) ([resultWrapper1803453 input] (clojure.core/let [rawinput1803452 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803454 {"Message" (rawinput1803452 "Message")}] (clojure.core/cond-> {} (letvar1803454 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1803454 ["Message"])))))))

(clojure.core/defn- response-create-endpoint-group-response ([input] (response-create-endpoint-group-response nil input)) ([resultWrapper1803456 input] (clojure.core/let [rawinput1803455 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1803457 {"EndpointGroup" (rawinput1803455 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1803457 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1803457 ["EndpointGroup"])))))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
