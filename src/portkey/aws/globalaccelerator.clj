...
(clojure.core/defn- response-endpoint-group-not-found-exception ([input] (response-endpoint-group-not-found-exception nil input)) ([resultWrapper1003943 input] (clojure.core/let [rawinput1003942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003944 {"Message" (rawinput1003942 "Message")}] (clojure.core/cond-> {} (letvar1003944 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003944 ["Message"])))))))

(clojure.core/defn- response-associated-listener-found-exception ([input] (response-associated-listener-found-exception nil input)) ([resultWrapper1003946 input] (clojure.core/let [rawinput1003945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003947 {"Message" (rawinput1003945 "Message")}] (clojure.core/cond-> {} (letvar1003947 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003947 ["Message"])))))))

(clojure.core/defn- response-endpoint-group-already-exists-exception ([input] (response-endpoint-group-already-exists-exception nil input)) ([resultWrapper1003949 input] (clojure.core/let [rawinput1003948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003950 {"Message" (rawinput1003948 "Message")}] (clojure.core/cond-> {} (letvar1003950 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003950 ["Message"])))))))

(clojure.core/defn- response-update-accelerator-response ([input] (response-update-accelerator-response nil input)) ([resultWrapper1003952 input] (clojure.core/let [rawinput1003951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003953 {"Accelerator" (rawinput1003951 "Accelerator")}] (clojure.core/cond-> {} (letvar1003953 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1003953 ["Accelerator"])))))))

(clojure.core/defn- response-describe-accelerator-attributes-response ([input] (response-describe-accelerator-attributes-response nil input)) ([resultWrapper1003955 input] (clojure.core/let [rawinput1003954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003956 {"AcceleratorAttributes" (rawinput1003954 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1003956 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1003956 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-list-listeners-response ([input] (response-list-listeners-response nil input)) ([resultWrapper1003958 input] (clojure.core/let [rawinput1003957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003959 {"Listeners" (rawinput1003957 "Listeners"), "NextToken" (rawinput1003957 "NextToken")}] (clojure.core/cond-> {} (letvar1003959 "Listeners") (clojure.core/assoc :listeners (deser-listeners (clojure.core/get-in letvar1003959 ["Listeners"]))) (letvar1003959 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1003959 ["NextToken"])))))))

(clojure.core/defn- response-update-accelerator-attributes-response ([input] (response-update-accelerator-attributes-response nil input)) ([resultWrapper1003961 input] (clojure.core/let [rawinput1003960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003962 {"AcceleratorAttributes" (rawinput1003960 "AcceleratorAttributes")}] (clojure.core/cond-> {} (letvar1003962 "AcceleratorAttributes") (clojure.core/assoc :accelerator-attributes (deser-accelerator-attributes (clojure.core/get-in letvar1003962 ["AcceleratorAttributes"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1003964 input] (clojure.core/let [rawinput1003963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003965 {"Message" (rawinput1003963 "Message")}] (clojure.core/cond-> {} (letvar1003965 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003965 ["Message"])))))))

(clojure.core/defn- response-describe-listener-response ([input] (response-describe-listener-response nil input)) ([resultWrapper1003967 input] (clojure.core/let [rawinput1003966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003968 {"Listener" (rawinput1003966 "Listener")}] (clojure.core/cond-> {} (letvar1003968 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1003968 ["Listener"])))))))

(clojure.core/defn- response-update-endpoint-group-response ([input] (response-update-endpoint-group-response nil input)) ([resultWrapper1003970 input] (clojure.core/let [rawinput1003969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003971 {"EndpointGroup" (rawinput1003969 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1003971 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1003971 ["EndpointGroup"])))))))

(clojure.core/defn- response-associated-endpoint-group-found-exception ([input] (response-associated-endpoint-group-found-exception nil input)) ([resultWrapper1003973 input] (clojure.core/let [rawinput1003972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003974 {"Message" (rawinput1003972 "Message")}] (clojure.core/cond-> {} (letvar1003974 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003974 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1003976 input] (clojure.core/let [rawinput1003975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003977 {"Message" (rawinput1003975 "Message")}] (clojure.core/cond-> {} (letvar1003977 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003977 ["Message"])))))))

(clojure.core/defn- response-list-endpoint-groups-response ([input] (response-list-endpoint-groups-response nil input)) ([resultWrapper1003979 input] (clojure.core/let [rawinput1003978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003980 {"EndpointGroups" (rawinput1003978 "EndpointGroups"), "NextToken" (rawinput1003978 "NextToken")}] (clojure.core/cond-> {} (letvar1003980 "EndpointGroups") (clojure.core/assoc :endpoint-groups (deser-endpoint-groups (clojure.core/get-in letvar1003980 ["EndpointGroups"]))) (letvar1003980 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1003980 ["NextToken"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1003982 input] (clojure.core/let [rawinput1003981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003983 {"Message" (rawinput1003981 "Message")}] (clojure.core/cond-> {} (letvar1003983 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003983 ["Message"])))))))

(clojure.core/defn- response-describe-accelerator-response ([input] (response-describe-accelerator-response nil input)) ([resultWrapper1003985 input] (clojure.core/let [rawinput1003984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003986 {"Accelerator" (rawinput1003984 "Accelerator")}] (clojure.core/cond-> {} (letvar1003986 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1003986 ["Accelerator"])))))))

(clojure.core/defn- response-update-listener-response ([input] (response-update-listener-response nil input)) ([resultWrapper1003988 input] (clojure.core/let [rawinput1003987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003989 {"Listener" (rawinput1003987 "Listener")}] (clojure.core/cond-> {} (letvar1003989 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1003989 ["Listener"])))))))

(clojure.core/defn- response-create-accelerator-response ([input] (response-create-accelerator-response nil input)) ([resultWrapper1003991 input] (clojure.core/let [rawinput1003990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003992 {"Accelerator" (rawinput1003990 "Accelerator")}] (clojure.core/cond-> {} (letvar1003992 "Accelerator") (clojure.core/assoc :accelerator (deser-accelerator (clojure.core/get-in letvar1003992 ["Accelerator"])))))))

(clojure.core/defn- response-accelerator-not-disabled-exception ([input] (response-accelerator-not-disabled-exception nil input)) ([resultWrapper1003994 input] (clojure.core/let [rawinput1003993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003995 {"Message" (rawinput1003993 "Message")}] (clojure.core/cond-> {} (letvar1003995 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1003995 ["Message"])))))))

(clojure.core/defn- response-describe-endpoint-group-response ([input] (response-describe-endpoint-group-response nil input)) ([resultWrapper1003997 input] (clojure.core/let [rawinput1003996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1003998 {"EndpointGroup" (rawinput1003996 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1003998 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1003998 ["EndpointGroup"])))))))

(clojure.core/defn- response-accelerator-not-found-exception ([input] (response-accelerator-not-found-exception nil input)) ([resultWrapper1004000 input] (clojure.core/let [rawinput1003999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004001 {"Message" (rawinput1003999 "Message")}] (clojure.core/cond-> {} (letvar1004001 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1004001 ["Message"])))))))

(clojure.core/defn- response-create-listener-response ([input] (response-create-listener-response nil input)) ([resultWrapper1004003 input] (clojure.core/let [rawinput1004002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004004 {"Listener" (rawinput1004002 "Listener")}] (clojure.core/cond-> {} (letvar1004004 "Listener") (clojure.core/assoc :listener (deser-listener (clojure.core/get-in letvar1004004 ["Listener"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1004006 input] (clojure.core/let [rawinput1004005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004007 {"Message" (rawinput1004005 "Message")}] (clojure.core/cond-> {} (letvar1004007 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1004007 ["Message"])))))))

(clojure.core/defn- response-invalid-port-range-exception ([input] (response-invalid-port-range-exception nil input)) ([resultWrapper1004009 input] (clojure.core/let [rawinput1004008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004010 {"Message" (rawinput1004008 "Message")}] (clojure.core/cond-> {} (letvar1004010 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1004010 ["Message"])))))))

(clojure.core/defn- response-list-accelerators-response ([input] (response-list-accelerators-response nil input)) ([resultWrapper1004012 input] (clojure.core/let [rawinput1004011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004013 {"Accelerators" (rawinput1004011 "Accelerators"), "NextToken" (rawinput1004011 "NextToken")}] (clojure.core/cond-> {} (letvar1004013 "Accelerators") (clojure.core/assoc :accelerators (deser-accelerators (clojure.core/get-in letvar1004013 ["Accelerators"]))) (letvar1004013 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1004013 ["NextToken"])))))))

(clojure.core/defn- response-listener-not-found-exception ([input] (response-listener-not-found-exception nil input)) ([resultWrapper1004015 input] (clojure.core/let [rawinput1004014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004016 {"Message" (rawinput1004014 "Message")}] (clojure.core/cond-> {} (letvar1004016 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1004016 ["Message"])))))))

(clojure.core/defn- response-create-endpoint-group-response ([input] (response-create-endpoint-group-response nil input)) ([resultWrapper1004018 input] (clojure.core/let [rawinput1004017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1004019 {"EndpointGroup" (rawinput1004017 "EndpointGroup")}] (clojure.core/cond-> {} (letvar1004019 "EndpointGroup") (clojure.core/assoc :endpoint-group (deser-endpoint-group (clojure.core/get-in letvar1004019 ["EndpointGroup"])))))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.globalaccelerator/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
