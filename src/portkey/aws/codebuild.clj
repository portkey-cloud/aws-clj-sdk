...
(clojure.core/defn- response-update-webhook-output ([input] (response-update-webhook-output nil input)) ([resultWrapper1544032 input] (clojure.core/let [rawinput1544031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544033 {"webhook" (rawinput1544031 "webhook")}] (clojure.core/cond-> {} (letvar1544033 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1544033 ["webhook"])))))))

(clojure.core/defn- response-start-build-output ([input] (response-start-build-output nil input)) ([resultWrapper1544035 input] (clojure.core/let [rawinput1544034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544036 {"build" (rawinput1544034 "build")}] (clojure.core/cond-> {} (letvar1544036 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1544036 ["build"])))))))

(clojure.core/defn- response-create-project-output ([input] (response-create-project-output nil input)) ([resultWrapper1544038 input] (clojure.core/let [rawinput1544037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544039 {"project" (rawinput1544037 "project")}] (clojure.core/cond-> {} (letvar1544039 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1544039 ["project"])))))))

(clojure.core/defn- response-list-curated-environment-images-output ([input] (response-list-curated-environment-images-output nil input)) ([resultWrapper1544041 input] (clojure.core/let [rawinput1544040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544042 {"platforms" (rawinput1544040 "platforms")}] (clojure.core/cond-> {} (letvar1544042 "platforms") (clojure.core/assoc :platforms (deser-environment-platforms (clojure.core/get-in letvar1544042 ["platforms"])))))))

(clojure.core/defn- response-invalidate-project-cache-output ([input] (response-invalidate-project-cache-output nil input)) ([resultWrapper1544044 input] (clojure.core/let [rawinput1544043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544045 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-delete-builds-output ([input] (response-batch-delete-builds-output nil input)) ([resultWrapper1544047 input] (clojure.core/let [rawinput1544046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544048 {"buildsDeleted" (rawinput1544046 "buildsDeleted"), "buildsNotDeleted" (rawinput1544046 "buildsNotDeleted")}] (clojure.core/cond-> {} (letvar1544048 "buildsDeleted") (clojure.core/assoc :builds-deleted (deser-build-ids (clojure.core/get-in letvar1544048 ["buildsDeleted"]))) (letvar1544048 "buildsNotDeleted") (clojure.core/assoc :builds-not-deleted (deser-builds-not-deleted (clojure.core/get-in letvar1544048 ["buildsNotDeleted"])))))))

(clojure.core/defn- response-account-limit-exceeded-exception ([input] (response-account-limit-exceeded-exception nil input)) ([resultWrapper1544050 input] (clojure.core/let [rawinput1544049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544051 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-projects-output ([input] (response-batch-get-projects-output nil input)) ([resultWrapper1544053 input] (clojure.core/let [rawinput1544052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544054 {"projects" (rawinput1544052 "projects"), "projectsNotFound" (rawinput1544052 "projectsNotFound")}] (clojure.core/cond-> {} (letvar1544054 "projects") (clojure.core/assoc :projects (deser-projects (clojure.core/get-in letvar1544054 ["projects"]))) (letvar1544054 "projectsNotFound") (clojure.core/assoc :projects-not-found (deser-project-names (clojure.core/get-in letvar1544054 ["projectsNotFound"])))))))

(clojure.core/defn- response-list-source-credentials-output ([input] (response-list-source-credentials-output nil input)) ([resultWrapper1544056 input] (clojure.core/let [rawinput1544055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544057 {"sourceCredentialsInfos" (rawinput1544055 "sourceCredentialsInfos")}] (clojure.core/cond-> {} (letvar1544057 "sourceCredentialsInfos") (clojure.core/assoc :source-credentials-infos (deser-source-credentials-infos (clojure.core/get-in letvar1544057 ["sourceCredentialsInfos"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1544059 input] (clojure.core/let [rawinput1544058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544060 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-source-credentials-output ([input] (response-delete-source-credentials-output nil input)) ([resultWrapper1544062 input] (clojure.core/let [rawinput1544061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544063 {"arn" (rawinput1544061 "arn")}] (clojure.core/cond-> {} (letvar1544063 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1544063 ["arn"])))))))

(clojure.core/defn- response-batch-get-builds-output ([input] (response-batch-get-builds-output nil input)) ([resultWrapper1544065 input] (clojure.core/let [rawinput1544064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544066 {"builds" (rawinput1544064 "builds"), "buildsNotFound" (rawinput1544064 "buildsNotFound")}] (clojure.core/cond-> {} (letvar1544066 "builds") (clojure.core/assoc :builds (deser-builds (clojure.core/get-in letvar1544066 ["builds"]))) (letvar1544066 "buildsNotFound") (clojure.core/assoc :builds-not-found (deser-build-ids (clojure.core/get-in letvar1544066 ["buildsNotFound"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper1544068 input] (clojure.core/let [rawinput1544067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544069 {"ids" (rawinput1544067 "ids"), "nextToken" (rawinput1544067 "nextToken")}] (clojure.core/cond-> {} (letvar1544069 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1544069 ["ids"]))) (letvar1544069 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1544069 ["nextToken"])))))))

(clojure.core/defn- response-list-projects-output ([input] (response-list-projects-output nil input)) ([resultWrapper1544071 input] (clojure.core/let [rawinput1544070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544072 {"nextToken" (rawinput1544070 "nextToken"), "projects" (rawinput1544070 "projects")}] (clojure.core/cond-> {} (letvar1544072 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1544072 ["nextToken"]))) (letvar1544072 "projects") (clojure.core/assoc :projects (deser-project-names (clojure.core/get-in letvar1544072 ["projects"])))))))

(clojure.core/defn- response-import-source-credentials-output ([input] (response-import-source-credentials-output nil input)) ([resultWrapper1544074 input] (clojure.core/let [rawinput1544073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544075 {"arn" (rawinput1544073 "arn")}] (clojure.core/cond-> {} (letvar1544075 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1544075 ["arn"])))))))

(clojure.core/defn- response-o-auth-provider-exception ([input] (response-o-auth-provider-exception nil input)) ([resultWrapper1544077 input] (clojure.core/let [rawinput1544076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544078 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1544080 input] (clojure.core/let [rawinput1544079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544081 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-webhook-output ([input] (response-delete-webhook-output nil input)) ([resultWrapper1544083 input] (clojure.core/let [rawinput1544082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544084 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1544086 input] (clojure.core/let [rawinput1544085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544087 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-output ([input] (response-delete-project-output nil input)) ([resultWrapper1544089 input] (clojure.core/let [rawinput1544088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544090 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-webhook-output ([input] (response-create-webhook-output nil input)) ([resultWrapper1544092 input] (clojure.core/let [rawinput1544091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544093 {"webhook" (rawinput1544091 "webhook")}] (clojure.core/cond-> {} (letvar1544093 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1544093 ["webhook"])))))))

(clojure.core/defn- response-list-builds-for-project-output ([input] (response-list-builds-for-project-output nil input)) ([resultWrapper1544095 input] (clojure.core/let [rawinput1544094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544096 {"ids" (rawinput1544094 "ids"), "nextToken" (rawinput1544094 "nextToken")}] (clojure.core/cond-> {} (letvar1544096 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1544096 ["ids"]))) (letvar1544096 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1544096 ["nextToken"])))))))

(clojure.core/defn- response-update-project-output ([input] (response-update-project-output nil input)) ([resultWrapper1544098 input] (clojure.core/let [rawinput1544097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544099 {"project" (rawinput1544097 "project")}] (clojure.core/cond-> {} (letvar1544099 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1544099 ["project"])))))))

(clojure.core/defn- response-stop-build-output ([input] (response-stop-build-output nil input)) ([resultWrapper1544101 input] (clojure.core/let [rawinput1544100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544102 {"build" (rawinput1544100 "build")}] (clojure.core/cond-> {} (letvar1544102 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1544102 ["build"])))))))

(clojure.spec.alpha/def :portkey.aws.codebuild.webhook-filter/type (clojure.spec.alpha/and :portkey.aws.codebuild/webhook-filter-type))
(clojure.spec.alpha/def :portkey.aws.codebuild.webhook-filter/pattern (clojure.spec.alpha/and :portkey.aws.codebuild/string))
(clojure.spec.alpha/def :portkey.aws.codebuild.webhook-filter/exclude-matched-pattern (clojure.spec.alpha/and :portkey.aws.codebuild/wrapper-boolean))
(clojure.spec.alpha/def :portkey.aws.codebuild/webhook-filter (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.webhook-filter/type :portkey.aws.codebuild.webhook-filter/pattern] :opt-un [:portkey.aws.codebuild.webhook-filter/exclude-matched-pattern]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/webhook-filter-type #{"FILE_PATH" :base-ref "BASE_REF" "EVENT" :event "HEAD_REF" :file-path :actor-account-id "ACTOR_ACCOUNT_ID" :head-ref})
...
(clojure.spec.alpha/def :portkey.aws.codebuild.delete-source-credentials-input/arn (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild/delete-source-credentials-input (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.delete-source-credentials-input/arn] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/value-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.create-webhook-input/filter-groups (clojure.spec.alpha/and :portkey.aws.codebuild/filter-groups))
(clojure.spec.alpha/def :portkey.aws.codebuild/create-webhook-input (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.create-webhook-input/project-name] :opt-un [:portkey.aws.codebuild.create-webhook-input/branch-filter :portkey.aws.codebuild.create-webhook-input/filter-groups]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.import-source-credentials-input/username (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild.import-source-credentials-input/token (clojure.spec.alpha/and :portkey.aws.codebuild/sensitive-non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild.import-source-credentials-input/server-type (clojure.spec.alpha/and :portkey.aws.codebuild/server-type))
(clojure.spec.alpha/def :portkey.aws.codebuild.import-source-credentials-input/auth-type (clojure.spec.alpha/and :portkey.aws.codebuild/auth-type))
(clojure.spec.alpha/def :portkey.aws.codebuild/import-source-credentials-input (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.import-source-credentials-input/token :portkey.aws.codebuild.import-source-credentials-input/server-type :portkey.aws.codebuild.import-source-credentials-input/auth-type] :opt-un [:portkey.aws.codebuild.import-source-credentials-input/username]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/server-type #{:github :bitbucket "GITHUB_ENTERPRISE" "BITBUCKET" "GITHUB" :github-enterprise})

(clojure.spec.alpha/def :portkey.aws.codebuild.list-source-credentials-output/source-credentials-infos (clojure.spec.alpha/and :portkey.aws.codebuild/source-credentials-infos))
(clojure.spec.alpha/def :portkey.aws.codebuild/list-source-credentials-output (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.codebuild.list-source-credentials-output/source-credentials-infos]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/list-source-credentials-input (clojure.spec.alpha/keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/credential-provider-type #{:secrets-manager "SECRETS_MANAGER"})

(clojure.spec.alpha/def :portkey.aws.codebuild/time-out (clojure.spec.alpha/int-in 5 480))

(clojure.spec.alpha/def :portkey.aws.codebuild.delete-source-credentials-output/arn (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild/delete-source-credentials-output (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.codebuild.delete-source-credentials-output/arn]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-cache-modes (clojure.spec.alpha/coll-of :portkey.aws.codebuild/cache-mode))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.import-source-credentials-output/arn (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild/import-source-credentials-output (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.codebuild.import-source-credentials-output/arn]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.project-environment/registry-credential (clojure.spec.alpha/and :portkey.aws.codebuild/registry-credential))
(clojure.spec.alpha/def :portkey.aws.codebuild.project-environment/image-pull-credentials-type (clojure.spec.alpha/and :portkey.aws.codebuild/image-pull-credentials-type))
(clojure.spec.alpha/def :portkey.aws.codebuild/project-environment (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.project-environment/type :portkey.aws.codebuild.project-environment/image :portkey.aws.codebuild.project-environment/compute-type] :opt-un [:portkey.aws.codebuild.project-environment/environment-variables :portkey.aws.codebuild.project-environment/privileged-mode :portkey.aws.codebuild.project-environment/certificate :portkey.aws.codebuild.project-environment/registry-credential :portkey.aws.codebuild.project-environment/image-pull-credentials-type]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/image-pull-credentials-type #{:service-role "CODEBUILD" "SERVICE_ROLE" :codebuild})
...
(clojure.spec.alpha/def :portkey.aws.codebuild.update-project-input/queued-timeout-in-minutes (clojure.spec.alpha/and :portkey.aws.codebuild/time-out))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/update-project-input (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.update-project-input/name] :opt-un [:portkey.aws.codebuild.update-project-input/vpc-config :portkey.aws.codebuild.update-project-input/service-role :portkey.aws.codebuild.update-project-input/badge-enabled :portkey.aws.codebuild.update-project-input/artifacts :portkey.aws.codebuild.update-project-input/secondary-sources :portkey.aws.codebuild.update-project-input/tags :portkey.aws.codebuild.update-project-input/cache :portkey.aws.codebuild.update-project-input/encryption-key :portkey.aws.codebuild.update-project-input/source :portkey.aws.codebuild.update-project-input/environment :portkey.aws.codebuild.update-project-input/secondary-artifacts :portkey.aws.codebuild.update-project-input/timeout-in-minutes :portkey.aws.codebuild.update-project-input/logs-config :portkey.aws.codebuild.update-project-input/queued-timeout-in-minutes :portkey.aws.codebuild.update-project-input/description]))

(clojure.spec.alpha/def :portkey.aws.codebuild/o-auth-provider-exception (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.codebuild/sensitive-non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))

(clojure.spec.alpha/def :portkey.aws.codebuild.registry-credential/credential (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild.registry-credential/credential-provider (clojure.spec.alpha/and :portkey.aws.codebuild/credential-provider-type))
(clojure.spec.alpha/def :portkey.aws.codebuild/registry-credential (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.registry-credential/credential :portkey.aws.codebuild.registry-credential/credential-provider] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/language-type #{"BASE" :dotnet "PHP" :golang :node-js "DOTNET" "GOLANG" "JAVA" "DOCKER" :docker :java "PYTHON" :android "NODE_JS" "RUBY" :python :php :base "ANDROID" :ruby})
...
(clojure.spec.alpha/def :portkey.aws.codebuild/key-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 127)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/cache-mode #{:local-docker-layer-cache "LOCAL_SOURCE_CACHE" :local-source-cache "LOCAL_CUSTOM_CACHE" :local-custom-cache "LOCAL_DOCKER_LAYER_CACHE"})
...
(clojure.spec.alpha/def :portkey.aws.codebuild.start-build-input/image-pull-credentials-type-override (clojure.spec.alpha/and :portkey.aws.codebuild/image-pull-credentials-type))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.start-build-input/registry-credential-override (clojure.spec.alpha/and :portkey.aws.codebuild/registry-credential))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.start-build-input/queued-timeout-in-minutes-override (clojure.spec.alpha/and :portkey.aws.codebuild/time-out))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.build/queued-timeout-in-minutes (clojure.spec.alpha/and :portkey.aws.codebuild/wrapper-int))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.project/queued-timeout-in-minutes (clojure.spec.alpha/and :portkey.aws.codebuild/time-out))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.project-cache/modes (clojure.spec.alpha/and :portkey.aws.codebuild/project-cache-modes))
(clojure.spec.alpha/def :portkey.aws.codebuild/project-cache (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.project-cache/type] :opt-un [:portkey.aws.codebuild.project-cache/location :portkey.aws.codebuild.project-cache/modes]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/cache-type #{:s-3 "NO_CACHE" "LOCAL" :no-cache "S3" :local})
...
(clojure.spec.alpha/def :portkey.aws.codebuild/filter-groups (clojure.spec.alpha/coll-of :portkey.aws.codebuild/filter-group))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.create-project-input/queued-timeout-in-minutes (clojure.spec.alpha/and :portkey.aws.codebuild/time-out))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.update-webhook-input/filter-groups (clojure.spec.alpha/and :portkey.aws.codebuild/filter-groups))
(clojure.spec.alpha/def :portkey.aws.codebuild/update-webhook-input (clojure.spec.alpha/keys :req-un [:portkey.aws.codebuild.update-webhook-input/project-name] :opt-un [:portkey.aws.codebuild.update-webhook-input/branch-filter :portkey.aws.codebuild.update-webhook-input/rotate-secret :portkey.aws.codebuild.update-webhook-input/filter-groups]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/build-phase-type #{:finalizing "COMPLETED" :install "POST_BUILD" :post-build :pre-build :upload-artifacts :completed "PROVISIONING" :download-source :submitted "SUBMITTED" :queued "UPLOAD_ARTIFACTS" :build "QUEUED" "BUILD" :provisioning "DOWNLOAD_SOURCE" "INSTALL" "FINALIZING" "PRE_BUILD"})

(clojure.spec.alpha/def :portkey.aws.codebuild/auth-type #{"BASIC_AUTH" "OAUTH" :oauth :personal-access-token "PERSONAL_ACCESS_TOKEN" :basic-auth})
...
(clojure.spec.alpha/def :portkey.aws.codebuild/filter-group (clojure.spec.alpha/coll-of :portkey.aws.codebuild/webhook-filter))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[A-Za-z0-9][A-Za-z0-9\-_]{1,254}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.source-credentials-info/arn (clojure.spec.alpha/and :portkey.aws.codebuild/non-empty-string))
(clojure.spec.alpha/def :portkey.aws.codebuild.source-credentials-info/server-type (clojure.spec.alpha/and :portkey.aws.codebuild/server-type))
(clojure.spec.alpha/def :portkey.aws.codebuild.source-credentials-info/auth-type (clojure.spec.alpha/and :portkey.aws.codebuild/auth-type))
(clojure.spec.alpha/def :portkey.aws.codebuild/source-credentials-info (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.codebuild.source-credentials-info/arn :portkey.aws.codebuild.source-credentials-info/server-type :portkey.aws.codebuild.source-credentials-info/auth-type]))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.webhook/filter-groups (clojure.spec.alpha/and :portkey.aws.codebuild/filter-groups))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/webhook (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.codebuild.webhook/url :portkey.aws.codebuild.webhook/payload-url :portkey.aws.codebuild.webhook/secret :portkey.aws.codebuild.webhook/branch-filter :portkey.aws.codebuild.webhook/filter-groups :portkey.aws.codebuild.webhook/last-modified-secret]))

(clojure.spec.alpha/def :portkey.aws.codebuild/source-credentials-infos (clojure.spec.alpha/coll-of :portkey.aws.codebuild/source-credentials-info))

(clojure.core/defn start-build ([start-build-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-start-build-input start-build-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/start-build-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/start-build-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StartBuild", :http.request.configuration/output-deser-fn response-start-build-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception, "ResourceNotFoundException" :portkey.aws.codebuild/resource-not-found-exception, "AccountLimitExceededException" :portkey.aws.codebuild/account-limit-exceeded-exception}})))))
...
(clojure.core/defn delete-source-credentials ([delete-source-credentials-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-source-credentials-input delete-source-credentials-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/delete-source-credentials-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/delete-source-credentials-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteSourceCredentials", :http.request.configuration/output-deser-fn response-delete-source-credentials-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception, "ResourceNotFoundException" :portkey.aws.codebuild/resource-not-found-exception}})))))
(clojure.spec.alpha/fdef delete-source-credentials :args (clojure.spec.alpha/tuple :portkey.aws.codebuild/delete-source-credentials-input) :ret (clojure.spec.alpha/and :portkey.aws.codebuild/delete-source-credentials-output))

(clojure.core/defn batch-delete-builds ([batch-delete-builds-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-batch-delete-builds-input batch-delete-builds-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/batch-delete-builds-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/batch-delete-builds-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "BatchDeleteBuilds", :http.request.configuration/output-deser-fn response-batch-delete-builds-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception}})))))
...
(clojure.core/defn create-webhook ([create-webhook-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-webhook-input create-webhook-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/create-webhook-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/create-webhook-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateWebhook", :http.request.configuration/output-deser-fn response-create-webhook-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception, "OAuthProviderException" :portkey.aws.codebuild/o-auth-provider-exception, "ResourceAlreadyExistsException" :portkey.aws.codebuild/resource-already-exists-exception, "ResourceNotFoundException" :portkey.aws.codebuild/resource-not-found-exception}})))))
...
(clojure.core/defn import-source-credentials ([import-source-credentials-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-import-source-credentials-input import-source-credentials-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/import-source-credentials-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/import-source-credentials-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ImportSourceCredentials", :http.request.configuration/output-deser-fn response-import-source-credentials-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception, "AccountLimitExceededException" :portkey.aws.codebuild/account-limit-exceeded-exception}})))))
(clojure.spec.alpha/fdef import-source-credentials :args (clojure.spec.alpha/tuple :portkey.aws.codebuild/import-source-credentials-input) :ret (clojure.spec.alpha/and :portkey.aws.codebuild/import-source-credentials-output))

(clojure.core/defn create-project ([create-project-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-project-input create-project-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.codebuild/endpoints, :http.request.configuration/target-prefix "CodeBuild_20161006", :http.request.spec/output-spec :portkey.aws.codebuild/create-project-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-06", :http.request.configuration/service-id "CodeBuild", :http.request.spec/input-spec :portkey.aws.codebuild/create-project-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateProject", :http.request.configuration/output-deser-fn response-create-project-output, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.codebuild/invalid-input-exception, "ResourceAlreadyExistsException" :portkey.aws.codebuild/resource-already-exists-exception, "AccountLimitExceededException" :portkey.aws.codebuild/account-limit-exceeded-exception}})))))
