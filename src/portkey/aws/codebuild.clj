...
(clojure.core/defn- response-update-webhook-output ([input] (response-update-webhook-output nil input)) ([resultWrapper1489234 input] (clojure.core/let [rawinput1489233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489235 {"webhook" (rawinput1489233 "webhook")}] (clojure.core/cond-> {} (letvar1489235 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1489235 ["webhook"])))))))

(clojure.core/defn- response-start-build-output ([input] (response-start-build-output nil input)) ([resultWrapper1489237 input] (clojure.core/let [rawinput1489236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489238 {"build" (rawinput1489236 "build")}] (clojure.core/cond-> {} (letvar1489238 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1489238 ["build"])))))))

(clojure.core/defn- response-create-project-output ([input] (response-create-project-output nil input)) ([resultWrapper1489240 input] (clojure.core/let [rawinput1489239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489241 {"project" (rawinput1489239 "project")}] (clojure.core/cond-> {} (letvar1489241 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1489241 ["project"])))))))

(clojure.core/defn- response-list-curated-environment-images-output ([input] (response-list-curated-environment-images-output nil input)) ([resultWrapper1489243 input] (clojure.core/let [rawinput1489242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489244 {"platforms" (rawinput1489242 "platforms")}] (clojure.core/cond-> {} (letvar1489244 "platforms") (clojure.core/assoc :platforms (deser-environment-platforms (clojure.core/get-in letvar1489244 ["platforms"])))))))

(clojure.core/defn- response-invalidate-project-cache-output ([input] (response-invalidate-project-cache-output nil input)) ([resultWrapper1489246 input] (clojure.core/let [rawinput1489245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489247 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-delete-builds-output ([input] (response-batch-delete-builds-output nil input)) ([resultWrapper1489249 input] (clojure.core/let [rawinput1489248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489250 {"buildsDeleted" (rawinput1489248 "buildsDeleted"), "buildsNotDeleted" (rawinput1489248 "buildsNotDeleted")}] (clojure.core/cond-> {} (letvar1489250 "buildsDeleted") (clojure.core/assoc :builds-deleted (deser-build-ids (clojure.core/get-in letvar1489250 ["buildsDeleted"]))) (letvar1489250 "buildsNotDeleted") (clojure.core/assoc :builds-not-deleted (deser-builds-not-deleted (clojure.core/get-in letvar1489250 ["buildsNotDeleted"])))))))

(clojure.core/defn- response-account-limit-exceeded-exception ([input] (response-account-limit-exceeded-exception nil input)) ([resultWrapper1489252 input] (clojure.core/let [rawinput1489251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489253 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-projects-output ([input] (response-batch-get-projects-output nil input)) ([resultWrapper1489255 input] (clojure.core/let [rawinput1489254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489256 {"projects" (rawinput1489254 "projects"), "projectsNotFound" (rawinput1489254 "projectsNotFound")}] (clojure.core/cond-> {} (letvar1489256 "projects") (clojure.core/assoc :projects (deser-projects (clojure.core/get-in letvar1489256 ["projects"]))) (letvar1489256 "projectsNotFound") (clojure.core/assoc :projects-not-found (deser-project-names (clojure.core/get-in letvar1489256 ["projectsNotFound"])))))))

(clojure.core/defn- response-list-source-credentials-output ([input] (response-list-source-credentials-output nil input)) ([resultWrapper1489258 input] (clojure.core/let [rawinput1489257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489259 {"sourceCredentialsInfos" (rawinput1489257 "sourceCredentialsInfos")}] (clojure.core/cond-> {} (letvar1489259 "sourceCredentialsInfos") (clojure.core/assoc :source-credentials-infos (deser-source-credentials-infos (clojure.core/get-in letvar1489259 ["sourceCredentialsInfos"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1489261 input] (clojure.core/let [rawinput1489260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489262 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-source-credentials-output ([input] (response-delete-source-credentials-output nil input)) ([resultWrapper1489264 input] (clojure.core/let [rawinput1489263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489265 {"arn" (rawinput1489263 "arn")}] (clojure.core/cond-> {} (letvar1489265 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1489265 ["arn"])))))))

(clojure.core/defn- response-batch-get-builds-output ([input] (response-batch-get-builds-output nil input)) ([resultWrapper1489267 input] (clojure.core/let [rawinput1489266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489268 {"builds" (rawinput1489266 "builds"), "buildsNotFound" (rawinput1489266 "buildsNotFound")}] (clojure.core/cond-> {} (letvar1489268 "builds") (clojure.core/assoc :builds (deser-builds (clojure.core/get-in letvar1489268 ["builds"]))) (letvar1489268 "buildsNotFound") (clojure.core/assoc :builds-not-found (deser-build-ids (clojure.core/get-in letvar1489268 ["buildsNotFound"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper1489270 input] (clojure.core/let [rawinput1489269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489271 {"ids" (rawinput1489269 "ids"), "nextToken" (rawinput1489269 "nextToken")}] (clojure.core/cond-> {} (letvar1489271 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1489271 ["ids"]))) (letvar1489271 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1489271 ["nextToken"])))))))

(clojure.core/defn- response-list-projects-output ([input] (response-list-projects-output nil input)) ([resultWrapper1489273 input] (clojure.core/let [rawinput1489272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489274 {"nextToken" (rawinput1489272 "nextToken"), "projects" (rawinput1489272 "projects")}] (clojure.core/cond-> {} (letvar1489274 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1489274 ["nextToken"]))) (letvar1489274 "projects") (clojure.core/assoc :projects (deser-project-names (clojure.core/get-in letvar1489274 ["projects"])))))))

(clojure.core/defn- response-import-source-credentials-output ([input] (response-import-source-credentials-output nil input)) ([resultWrapper1489276 input] (clojure.core/let [rawinput1489275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489277 {"arn" (rawinput1489275 "arn")}] (clojure.core/cond-> {} (letvar1489277 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1489277 ["arn"])))))))

(clojure.core/defn- response-o-auth-provider-exception ([input] (response-o-auth-provider-exception nil input)) ([resultWrapper1489279 input] (clojure.core/let [rawinput1489278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489280 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1489282 input] (clojure.core/let [rawinput1489281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489283 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-webhook-output ([input] (response-delete-webhook-output nil input)) ([resultWrapper1489285 input] (clojure.core/let [rawinput1489284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489286 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1489288 input] (clojure.core/let [rawinput1489287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489289 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-output ([input] (response-delete-project-output nil input)) ([resultWrapper1489291 input] (clojure.core/let [rawinput1489290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489292 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-webhook-output ([input] (response-create-webhook-output nil input)) ([resultWrapper1489294 input] (clojure.core/let [rawinput1489293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489295 {"webhook" (rawinput1489293 "webhook")}] (clojure.core/cond-> {} (letvar1489295 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1489295 ["webhook"])))))))

(clojure.core/defn- response-list-builds-for-project-output ([input] (response-list-builds-for-project-output nil input)) ([resultWrapper1489297 input] (clojure.core/let [rawinput1489296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489298 {"ids" (rawinput1489296 "ids"), "nextToken" (rawinput1489296 "nextToken")}] (clojure.core/cond-> {} (letvar1489298 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1489298 ["ids"]))) (letvar1489298 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1489298 ["nextToken"])))))))

(clojure.core/defn- response-update-project-output ([input] (response-update-project-output nil input)) ([resultWrapper1489300 input] (clojure.core/let [rawinput1489299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489301 {"project" (rawinput1489299 "project")}] (clojure.core/cond-> {} (letvar1489301 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1489301 ["project"])))))))

(clojure.core/defn- response-stop-build-output ([input] (response-stop-build-output nil input)) ([resultWrapper1489303 input] (clojure.core/let [rawinput1489302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1489304 {"build" (rawinput1489302 "build")}] (clojure.core/cond-> {} (letvar1489304 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1489304 ["build"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/value-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/sensitive-non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/key-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z0-9][A-Za-z0-9\-_]{1,254}" s__1410940__auto__))))
