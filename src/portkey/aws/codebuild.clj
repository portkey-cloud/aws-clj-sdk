...
(clojure.core/defn- response-update-webhook-output ([input] (response-update-webhook-output nil input)) ([resultWrapper380103 input] (clojure.core/let [rawinput380102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380104 {"webhook" (rawinput380102 "webhook")}] (clojure.core/cond-> {} (letvar380104 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar380104 ["webhook"])))))))

(clojure.core/defn- response-start-build-output ([input] (response-start-build-output nil input)) ([resultWrapper380106 input] (clojure.core/let [rawinput380105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380107 {"build" (rawinput380105 "build")}] (clojure.core/cond-> {} (letvar380107 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar380107 ["build"])))))))

(clojure.core/defn- response-create-project-output ([input] (response-create-project-output nil input)) ([resultWrapper380109 input] (clojure.core/let [rawinput380108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380110 {"project" (rawinput380108 "project")}] (clojure.core/cond-> {} (letvar380110 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar380110 ["project"])))))))

(clojure.core/defn- response-list-curated-environment-images-output ([input] (response-list-curated-environment-images-output nil input)) ([resultWrapper380112 input] (clojure.core/let [rawinput380111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380113 {"platforms" (rawinput380111 "platforms")}] (clojure.core/cond-> {} (letvar380113 "platforms") (clojure.core/assoc :platforms (deser-environment-platforms (clojure.core/get-in letvar380113 ["platforms"])))))))

(clojure.core/defn- response-invalidate-project-cache-output ([input] (response-invalidate-project-cache-output nil input)) ([resultWrapper380115 input] (clojure.core/let [rawinput380114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380116 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-delete-builds-output ([input] (response-batch-delete-builds-output nil input)) ([resultWrapper380118 input] (clojure.core/let [rawinput380117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380119 {"buildsDeleted" (rawinput380117 "buildsDeleted"), "buildsNotDeleted" (rawinput380117 "buildsNotDeleted")}] (clojure.core/cond-> {} (letvar380119 "buildsDeleted") (clojure.core/assoc :builds-deleted (deser-build-ids (clojure.core/get-in letvar380119 ["buildsDeleted"]))) (letvar380119 "buildsNotDeleted") (clojure.core/assoc :builds-not-deleted (deser-builds-not-deleted (clojure.core/get-in letvar380119 ["buildsNotDeleted"])))))))

(clojure.core/defn- response-account-limit-exceeded-exception ([input] (response-account-limit-exceeded-exception nil input)) ([resultWrapper380121 input] (clojure.core/let [rawinput380120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380122 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-projects-output ([input] (response-batch-get-projects-output nil input)) ([resultWrapper380124 input] (clojure.core/let [rawinput380123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380125 {"projects" (rawinput380123 "projects"), "projectsNotFound" (rawinput380123 "projectsNotFound")}] (clojure.core/cond-> {} (letvar380125 "projects") (clojure.core/assoc :projects (deser-projects (clojure.core/get-in letvar380125 ["projects"]))) (letvar380125 "projectsNotFound") (clojure.core/assoc :projects-not-found (deser-project-names (clojure.core/get-in letvar380125 ["projectsNotFound"])))))))

(clojure.core/defn- response-list-source-credentials-output ([input] (response-list-source-credentials-output nil input)) ([resultWrapper380127 input] (clojure.core/let [rawinput380126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380128 {"sourceCredentialsInfos" (rawinput380126 "sourceCredentialsInfos")}] (clojure.core/cond-> {} (letvar380128 "sourceCredentialsInfos") (clojure.core/assoc :source-credentials-infos (deser-source-credentials-infos (clojure.core/get-in letvar380128 ["sourceCredentialsInfos"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper380130 input] (clojure.core/let [rawinput380129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380131 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-source-credentials-output ([input] (response-delete-source-credentials-output nil input)) ([resultWrapper380133 input] (clojure.core/let [rawinput380132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380134 {"arn" (rawinput380132 "arn")}] (clojure.core/cond-> {} (letvar380134 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar380134 ["arn"])))))))

(clojure.core/defn- response-batch-get-builds-output ([input] (response-batch-get-builds-output nil input)) ([resultWrapper380136 input] (clojure.core/let [rawinput380135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380137 {"builds" (rawinput380135 "builds"), "buildsNotFound" (rawinput380135 "buildsNotFound")}] (clojure.core/cond-> {} (letvar380137 "builds") (clojure.core/assoc :builds (deser-builds (clojure.core/get-in letvar380137 ["builds"]))) (letvar380137 "buildsNotFound") (clojure.core/assoc :builds-not-found (deser-build-ids (clojure.core/get-in letvar380137 ["buildsNotFound"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper380139 input] (clojure.core/let [rawinput380138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380140 {"ids" (rawinput380138 "ids"), "nextToken" (rawinput380138 "nextToken")}] (clojure.core/cond-> {} (letvar380140 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar380140 ["ids"]))) (letvar380140 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar380140 ["nextToken"])))))))

(clojure.core/defn- response-list-projects-output ([input] (response-list-projects-output nil input)) ([resultWrapper380142 input] (clojure.core/let [rawinput380141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380143 {"nextToken" (rawinput380141 "nextToken"), "projects" (rawinput380141 "projects")}] (clojure.core/cond-> {} (letvar380143 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar380143 ["nextToken"]))) (letvar380143 "projects") (clojure.core/assoc :projects (deser-project-names (clojure.core/get-in letvar380143 ["projects"])))))))

(clojure.core/defn- response-import-source-credentials-output ([input] (response-import-source-credentials-output nil input)) ([resultWrapper380145 input] (clojure.core/let [rawinput380144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380146 {"arn" (rawinput380144 "arn")}] (clojure.core/cond-> {} (letvar380146 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar380146 ["arn"])))))))

(clojure.core/defn- response-o-auth-provider-exception ([input] (response-o-auth-provider-exception nil input)) ([resultWrapper380148 input] (clojure.core/let [rawinput380147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380149 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper380151 input] (clojure.core/let [rawinput380150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380152 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-webhook-output ([input] (response-delete-webhook-output nil input)) ([resultWrapper380154 input] (clojure.core/let [rawinput380153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380155 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper380157 input] (clojure.core/let [rawinput380156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380158 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-output ([input] (response-delete-project-output nil input)) ([resultWrapper380160 input] (clojure.core/let [rawinput380159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380161 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-webhook-output ([input] (response-create-webhook-output nil input)) ([resultWrapper380163 input] (clojure.core/let [rawinput380162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380164 {"webhook" (rawinput380162 "webhook")}] (clojure.core/cond-> {} (letvar380164 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar380164 ["webhook"])))))))

(clojure.core/defn- response-list-builds-for-project-output ([input] (response-list-builds-for-project-output nil input)) ([resultWrapper380166 input] (clojure.core/let [rawinput380165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380167 {"ids" (rawinput380165 "ids"), "nextToken" (rawinput380165 "nextToken")}] (clojure.core/cond-> {} (letvar380167 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar380167 ["ids"]))) (letvar380167 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar380167 ["nextToken"])))))))

(clojure.core/defn- response-update-project-output ([input] (response-update-project-output nil input)) ([resultWrapper380169 input] (clojure.core/let [rawinput380168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380170 {"project" (rawinput380168 "project")}] (clojure.core/cond-> {} (letvar380170 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar380170 ["project"])))))))

(clojure.core/defn- response-stop-build-output ([input] (response-stop-build-output nil input)) ([resultWrapper380172 input] (clojure.core/let [rawinput380171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar380173 {"build" (rawinput380171 "build")}] (clojure.core/cond-> {} (letvar380173 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar380173 ["build"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/value-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/sensitive-non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/key-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 127)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z0-9][A-Za-z0-9\-_]{1,254}" s__21078__auto__))))
