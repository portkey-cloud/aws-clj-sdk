...
(clojure.core/defn- response-cancel-pipeline-reprocessing-response ([input] (response-cancel-pipeline-reprocessing-response nil input)) ([resultWrapper1251796 input] (clojure.core/let [rawinput1251795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251797 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-pipeline-response ([input] (response-create-pipeline-response nil input)) ([resultWrapper1251799 input] (clojure.core/let [rawinput1251798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251800 {"pipelineName" (rawinput1251798 "pipelineName"), "pipelineArn" (rawinput1251798 "pipelineArn")}] (clojure.core/cond-> {} (letvar1251800 "pipelineName") (clojure.core/assoc :pipeline-name (deser-pipeline-name (clojure.core/get-in letvar1251800 ["pipelineName"]))) (letvar1251800 "pipelineArn") (clojure.core/assoc :pipeline-arn (deser-pipeline-arn (clojure.core/get-in letvar1251800 ["pipelineArn"])))))))

(clojure.core/defn- response-create-datastore-response ([input] (response-create-datastore-response nil input)) ([resultWrapper1251802 input] (clojure.core/let [rawinput1251801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251803 {"datastoreName" (rawinput1251801 "datastoreName"), "datastoreArn" (rawinput1251801 "datastoreArn"), "retentionPeriod" (rawinput1251801 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1251803 "datastoreName") (clojure.core/assoc :datastore-name (deser-datastore-name (clojure.core/get-in letvar1251803 ["datastoreName"]))) (letvar1251803 "datastoreArn") (clojure.core/assoc :datastore-arn (deser-datastore-arn (clojure.core/get-in letvar1251803 ["datastoreArn"]))) (letvar1251803 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1251803 ["retentionPeriod"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1251805 input] (clojure.core/let [rawinput1251804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251806 {"message" (rawinput1251804 "message")}] (clojure.core/cond-> {} (letvar1251806 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251806 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1251808 input] (clojure.core/let [rawinput1251807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251809 {"tags" (rawinput1251807 "tags")}] (clojure.core/cond-> {} (letvar1251809 "tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1251809 ["tags"])))))))

(clojure.core/defn- response-start-pipeline-reprocessing-response ([input] (response-start-pipeline-reprocessing-response nil input)) ([resultWrapper1251811 input] (clojure.core/let [rawinput1251810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251812 {"reprocessingId" (rawinput1251810 "reprocessingId")}] (clojure.core/cond-> {} (letvar1251812 "reprocessingId") (clojure.core/assoc :reprocessing-id (deser-reprocessing-id (clojure.core/get-in letvar1251812 ["reprocessingId"])))))))

(clojure.core/defn- response-run-pipeline-activity-response ([input] (response-run-pipeline-activity-response nil input)) ([resultWrapper1251814 input] (clojure.core/let [rawinput1251813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251815 {"payloads" (rawinput1251813 "payloads"), "logResult" (rawinput1251813 "logResult")}] (clojure.core/cond-> {} (letvar1251815 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1251815 ["payloads"]))) (letvar1251815 "logResult") (clojure.core/assoc :log-result (deser-log-result (clojure.core/get-in letvar1251815 ["logResult"])))))))

(clojure.core/defn- response-list-datastores-response ([input] (response-list-datastores-response nil input)) ([resultWrapper1251817 input] (clojure.core/let [rawinput1251816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251818 {"datastoreSummaries" (rawinput1251816 "datastoreSummaries"), "nextToken" (rawinput1251816 "nextToken")}] (clojure.core/cond-> {} (letvar1251818 "datastoreSummaries") (clojure.core/assoc :datastore-summaries (deser-datastore-summaries (clojure.core/get-in letvar1251818 ["datastoreSummaries"]))) (letvar1251818 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1251818 ["nextToken"])))))))

(clojure.core/defn- response-create-dataset-content-response ([input] (response-create-dataset-content-response nil input)) ([resultWrapper1251820 input] (clojure.core/let [rawinput1251819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251821 {"versionId" (rawinput1251819 "versionId")}] (clojure.core/cond-> {} (letvar1251821 "versionId") (clojure.core/assoc :version-id (deser-dataset-content-version (clojure.core/get-in letvar1251821 ["versionId"])))))))

(clojure.core/defn- response-create-channel-response ([input] (response-create-channel-response nil input)) ([resultWrapper1251823 input] (clojure.core/let [rawinput1251822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251824 {"channelName" (rawinput1251822 "channelName"), "channelArn" (rawinput1251822 "channelArn"), "retentionPeriod" (rawinput1251822 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1251824 "channelName") (clojure.core/assoc :channel-name (deser-channel-name (clojure.core/get-in letvar1251824 ["channelName"]))) (letvar1251824 "channelArn") (clojure.core/assoc :channel-arn (deser-channel-arn (clojure.core/get-in letvar1251824 ["channelArn"]))) (letvar1251824 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1251824 ["retentionPeriod"])))))))

(clojure.core/defn- response-describe-datastore-response ([input] (response-describe-datastore-response nil input)) ([resultWrapper1251826 input] (clojure.core/let [rawinput1251825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251827 {"datastore" (rawinput1251825 "datastore"), "statistics" (rawinput1251825 "statistics")}] (clojure.core/cond-> {} (letvar1251827 "datastore") (clojure.core/assoc :datastore (deser-datastore (clojure.core/get-in letvar1251827 ["datastore"]))) (letvar1251827 "statistics") (clojure.core/assoc :statistics (deser-datastore-statistics (clojure.core/get-in letvar1251827 ["statistics"])))))))

(clojure.core/defn- response-describe-channel-response ([input] (response-describe-channel-response nil input)) ([resultWrapper1251829 input] (clojure.core/let [rawinput1251828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251830 {"channel" (rawinput1251828 "channel"), "statistics" (rawinput1251828 "statistics")}] (clojure.core/cond-> {} (letvar1251830 "channel") (clojure.core/assoc :channel (deser-channel (clojure.core/get-in letvar1251830 ["channel"]))) (letvar1251830 "statistics") (clojure.core/assoc :statistics (deser-channel-statistics (clojure.core/get-in letvar1251830 ["statistics"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1251832 input] (clojure.core/let [rawinput1251831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251833 {"message" (rawinput1251831 "message")}] (clojure.core/cond-> {} (letvar1251833 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251833 ["message"])))))))

(clojure.core/defn- response-list-dataset-contents-response ([input] (response-list-dataset-contents-response nil input)) ([resultWrapper1251835 input] (clojure.core/let [rawinput1251834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251836 {"datasetContentSummaries" (rawinput1251834 "datasetContentSummaries"), "nextToken" (rawinput1251834 "nextToken")}] (clojure.core/cond-> {} (letvar1251836 "datasetContentSummaries") (clojure.core/assoc :dataset-content-summaries (deser-dataset-content-summaries (clojure.core/get-in letvar1251836 ["datasetContentSummaries"]))) (letvar1251836 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1251836 ["nextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1251838 input] (clojure.core/let [rawinput1251837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251839 {"message" (rawinput1251837 "message"), "resourceId" (rawinput1251837 "resourceId"), "resourceArn" (rawinput1251837 "resourceArn")}] (clojure.core/cond-> {} (letvar1251839 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251839 ["message"]))) (letvar1251839 "resourceId") (clojure.core/assoc :resource-id (deserresource-id (clojure.core/get-in letvar1251839 ["resourceId"]))) (letvar1251839 "resourceArn") (clojure.core/assoc :resource-arn (deserresource-arn (clojure.core/get-in letvar1251839 ["resourceArn"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1251841 input] (clojure.core/let [rawinput1251840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251842 {"message" (rawinput1251840 "message")}] (clojure.core/cond-> {} (letvar1251842 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251842 ["message"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1251844 input] (clojure.core/let [rawinput1251843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251845 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-dataset-response ([input] (response-create-dataset-response nil input)) ([resultWrapper1251847 input] (clojure.core/let [rawinput1251846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251848 {"datasetName" (rawinput1251846 "datasetName"), "datasetArn" (rawinput1251846 "datasetArn"), "retentionPeriod" (rawinput1251846 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1251848 "datasetName") (clojure.core/assoc :dataset-name (deser-dataset-name (clojure.core/get-in letvar1251848 ["datasetName"]))) (letvar1251848 "datasetArn") (clojure.core/assoc :dataset-arn (deser-dataset-arn (clojure.core/get-in letvar1251848 ["datasetArn"]))) (letvar1251848 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1251848 ["retentionPeriod"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1251850 input] (clojure.core/let [rawinput1251849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251851 {"message" (rawinput1251849 "message")}] (clojure.core/cond-> {} (letvar1251851 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251851 ["message"])))))))

(clojure.core/defn- response-list-channels-response ([input] (response-list-channels-response nil input)) ([resultWrapper1251853 input] (clojure.core/let [rawinput1251852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251854 {"channelSummaries" (rawinput1251852 "channelSummaries"), "nextToken" (rawinput1251852 "nextToken")}] (clojure.core/cond-> {} (letvar1251854 "channelSummaries") (clojure.core/assoc :channel-summaries (deser-channel-summaries (clojure.core/get-in letvar1251854 ["channelSummaries"]))) (letvar1251854 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1251854 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1251856 input] (clojure.core/let [rawinput1251855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251857 {"message" (rawinput1251855 "message")}] (clojure.core/cond-> {} (letvar1251857 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251857 ["message"])))))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper1251859 input] (clojure.core/let [rawinput1251858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251860 {"dataset" (rawinput1251858 "dataset")}] (clojure.core/cond-> {} (letvar1251860 "dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar1251860 ["dataset"])))))))

(clojure.core/defn- response-describe-logging-options-response ([input] (response-describe-logging-options-response nil input)) ([resultWrapper1251862 input] (clojure.core/let [rawinput1251861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251863 {"loggingOptions" (rawinput1251861 "loggingOptions")}] (clojure.core/cond-> {} (letvar1251863 "loggingOptions") (clojure.core/assoc :logging-options (deser-logging-options (clojure.core/get-in letvar1251863 ["loggingOptions"])))))))

(clojure.core/defn- response-describe-pipeline-response ([input] (response-describe-pipeline-response nil input)) ([resultWrapper1251865 input] (clojure.core/let [rawinput1251864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251866 {"pipeline" (rawinput1251864 "pipeline")}] (clojure.core/cond-> {} (letvar1251866 "pipeline") (clojure.core/assoc :pipeline (deser-pipeline (clojure.core/get-in letvar1251866 ["pipeline"])))))))

(clojure.core/defn- response-list-pipelines-response ([input] (response-list-pipelines-response nil input)) ([resultWrapper1251868 input] (clojure.core/let [rawinput1251867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251869 {"pipelineSummaries" (rawinput1251867 "pipelineSummaries"), "nextToken" (rawinput1251867 "nextToken")}] (clojure.core/cond-> {} (letvar1251869 "pipelineSummaries") (clojure.core/assoc :pipeline-summaries (deser-pipeline-summaries (clojure.core/get-in letvar1251869 ["pipelineSummaries"]))) (letvar1251869 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1251869 ["nextToken"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1251871 input] (clojure.core/let [rawinput1251870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251872 {"message" (rawinput1251870 "message")}] (clojure.core/cond-> {} (letvar1251872 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1251872 ["message"])))))))

(clojure.core/defn- response-get-dataset-content-response ([input] (response-get-dataset-content-response nil input)) ([resultWrapper1251874 input] (clojure.core/let [rawinput1251873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251875 {"entries" (rawinput1251873 "entries"), "timestamp" (rawinput1251873 "timestamp"), "status" (rawinput1251873 "status")}] (clojure.core/cond-> {} (letvar1251875 "entries") (clojure.core/assoc :entries (deser-dataset-entries (clojure.core/get-in letvar1251875 ["entries"]))) (letvar1251875 "timestamp") (clojure.core/assoc :timestamp (deser-timestamp (clojure.core/get-in letvar1251875 ["timestamp"]))) (letvar1251875 "status") (clojure.core/assoc :status (deser-dataset-content-status (clojure.core/get-in letvar1251875 ["status"])))))))

(clojure.core/defn- response-sample-channel-data-response ([input] (response-sample-channel-data-response nil input)) ([resultWrapper1251877 input] (clojure.core/let [rawinput1251876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251878 {"payloads" (rawinput1251876 "payloads")}] (clojure.core/cond-> {} (letvar1251878 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1251878 ["payloads"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1251880 input] (clojure.core/let [rawinput1251879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251881 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper1251883 input] (clojure.core/let [rawinput1251882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251884 {"datasetSummaries" (rawinput1251882 "datasetSummaries"), "nextToken" (rawinput1251882 "nextToken")}] (clojure.core/cond-> {} (letvar1251884 "datasetSummaries") (clojure.core/assoc :dataset-summaries (deser-dataset-summaries (clojure.core/get-in letvar1251884 ["datasetSummaries"]))) (letvar1251884 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1251884 ["nextToken"])))))))

(clojure.core/defn- response-batch-put-message-response ([input] (response-batch-put-message-response nil input)) ([resultWrapper1251886 input] (clojure.core/let [rawinput1251885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1251887 {"batchPutMessageErrorEntries" (rawinput1251885 "batchPutMessageErrorEntries")}] (clojure.core/cond-> {} (letvar1251887 "batchPutMessageErrorEntries") (clojure.core/assoc :batch-put-message-error-entries (deser-batch-put-message-error-entries (clojure.core/get-in letvar1251887 ["batchPutMessageErrorEntries"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-content-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 7 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/message-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/pipeline-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/output-file-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w\.-]{1,255}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/datastore-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 20 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/iot-events-input-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z][a-zA-Z0-9_]*$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/lambda-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 20 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/math-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/activity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
