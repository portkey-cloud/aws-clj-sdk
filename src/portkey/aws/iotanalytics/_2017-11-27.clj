...
(clojure.core/defn- response-cancel-pipeline-reprocessing-response ([input] (response-cancel-pipeline-reprocessing-response nil input)) ([resultWrapper258799 input] (clojure.core/let [rawinput258798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258800 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-pipeline-response ([input] (response-create-pipeline-response nil input)) ([resultWrapper258802 input] (clojure.core/let [rawinput258801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258803 {"pipelineName" (rawinput258801 "pipelineName"), "pipelineArn" (rawinput258801 "pipelineArn")}] (clojure.core/cond-> {} (letvar258803 "pipelineName") (clojure.core/assoc :pipeline-name (deser-pipeline-name (clojure.core/get-in letvar258803 ["pipelineName"]))) (letvar258803 "pipelineArn") (clojure.core/assoc :pipeline-arn (deser-pipeline-arn (clojure.core/get-in letvar258803 ["pipelineArn"])))))))

(clojure.core/defn- response-create-datastore-response ([input] (response-create-datastore-response nil input)) ([resultWrapper258805 input] (clojure.core/let [rawinput258804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258806 {"datastoreName" (rawinput258804 "datastoreName"), "datastoreArn" (rawinput258804 "datastoreArn"), "retentionPeriod" (rawinput258804 "retentionPeriod")}] (clojure.core/cond-> {} (letvar258806 "datastoreName") (clojure.core/assoc :datastore-name (deser-datastore-name (clojure.core/get-in letvar258806 ["datastoreName"]))) (letvar258806 "datastoreArn") (clojure.core/assoc :datastore-arn (deser-datastore-arn (clojure.core/get-in letvar258806 ["datastoreArn"]))) (letvar258806 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar258806 ["retentionPeriod"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper258808 input] (clojure.core/let [rawinput258807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258809 {"message" (rawinput258807 "message")}] (clojure.core/cond-> {} (letvar258809 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258809 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper258811 input] (clojure.core/let [rawinput258810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258812 {"tags" (rawinput258810 "tags")}] (clojure.core/cond-> {} (letvar258812 "tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar258812 ["tags"])))))))

(clojure.core/defn- response-start-pipeline-reprocessing-response ([input] (response-start-pipeline-reprocessing-response nil input)) ([resultWrapper258814 input] (clojure.core/let [rawinput258813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258815 {"reprocessingId" (rawinput258813 "reprocessingId")}] (clojure.core/cond-> {} (letvar258815 "reprocessingId") (clojure.core/assoc :reprocessing-id (deser-reprocessing-id (clojure.core/get-in letvar258815 ["reprocessingId"])))))))

(clojure.core/defn- response-run-pipeline-activity-response ([input] (response-run-pipeline-activity-response nil input)) ([resultWrapper258817 input] (clojure.core/let [rawinput258816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258818 {"payloads" (rawinput258816 "payloads"), "logResult" (rawinput258816 "logResult")}] (clojure.core/cond-> {} (letvar258818 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar258818 ["payloads"]))) (letvar258818 "logResult") (clojure.core/assoc :log-result (deser-log-result (clojure.core/get-in letvar258818 ["logResult"])))))))

(clojure.core/defn- response-list-datastores-response ([input] (response-list-datastores-response nil input)) ([resultWrapper258820 input] (clojure.core/let [rawinput258819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258821 {"datastoreSummaries" (rawinput258819 "datastoreSummaries"), "nextToken" (rawinput258819 "nextToken")}] (clojure.core/cond-> {} (letvar258821 "datastoreSummaries") (clojure.core/assoc :datastore-summaries (deser-datastore-summaries (clojure.core/get-in letvar258821 ["datastoreSummaries"]))) (letvar258821 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar258821 ["nextToken"])))))))

(clojure.core/defn- response-create-dataset-content-response ([input] (response-create-dataset-content-response nil input)) ([resultWrapper258823 input] (clojure.core/let [rawinput258822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258824 {"versionId" (rawinput258822 "versionId")}] (clojure.core/cond-> {} (letvar258824 "versionId") (clojure.core/assoc :version-id (deser-dataset-content-version (clojure.core/get-in letvar258824 ["versionId"])))))))

(clojure.core/defn- response-create-channel-response ([input] (response-create-channel-response nil input)) ([resultWrapper258826 input] (clojure.core/let [rawinput258825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258827 {"channelName" (rawinput258825 "channelName"), "channelArn" (rawinput258825 "channelArn"), "retentionPeriod" (rawinput258825 "retentionPeriod")}] (clojure.core/cond-> {} (letvar258827 "channelName") (clojure.core/assoc :channel-name (deser-channel-name (clojure.core/get-in letvar258827 ["channelName"]))) (letvar258827 "channelArn") (clojure.core/assoc :channel-arn (deser-channel-arn (clojure.core/get-in letvar258827 ["channelArn"]))) (letvar258827 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar258827 ["retentionPeriod"])))))))

(clojure.core/defn- response-describe-datastore-response ([input] (response-describe-datastore-response nil input)) ([resultWrapper258829 input] (clojure.core/let [rawinput258828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258830 {"datastore" (rawinput258828 "datastore"), "statistics" (rawinput258828 "statistics")}] (clojure.core/cond-> {} (letvar258830 "datastore") (clojure.core/assoc :datastore (deser-datastore (clojure.core/get-in letvar258830 ["datastore"]))) (letvar258830 "statistics") (clojure.core/assoc :statistics (deser-datastore-statistics (clojure.core/get-in letvar258830 ["statistics"])))))))

(clojure.core/defn- response-describe-channel-response ([input] (response-describe-channel-response nil input)) ([resultWrapper258832 input] (clojure.core/let [rawinput258831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258833 {"channel" (rawinput258831 "channel"), "statistics" (rawinput258831 "statistics")}] (clojure.core/cond-> {} (letvar258833 "channel") (clojure.core/assoc :channel (deser-channel (clojure.core/get-in letvar258833 ["channel"]))) (letvar258833 "statistics") (clojure.core/assoc :statistics (deser-channel-statistics (clojure.core/get-in letvar258833 ["statistics"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper258835 input] (clojure.core/let [rawinput258834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258836 {"message" (rawinput258834 "message")}] (clojure.core/cond-> {} (letvar258836 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258836 ["message"])))))))

(clojure.core/defn- response-list-dataset-contents-response ([input] (response-list-dataset-contents-response nil input)) ([resultWrapper258838 input] (clojure.core/let [rawinput258837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258839 {"datasetContentSummaries" (rawinput258837 "datasetContentSummaries"), "nextToken" (rawinput258837 "nextToken")}] (clojure.core/cond-> {} (letvar258839 "datasetContentSummaries") (clojure.core/assoc :dataset-content-summaries (deser-dataset-content-summaries (clojure.core/get-in letvar258839 ["datasetContentSummaries"]))) (letvar258839 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar258839 ["nextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper258841 input] (clojure.core/let [rawinput258840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258842 {"message" (rawinput258840 "message"), "resourceId" (rawinput258840 "resourceId"), "resourceArn" (rawinput258840 "resourceArn")}] (clojure.core/cond-> {} (letvar258842 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258842 ["message"]))) (letvar258842 "resourceId") (clojure.core/assoc :resource-id (deserresource-id (clojure.core/get-in letvar258842 ["resourceId"]))) (letvar258842 "resourceArn") (clojure.core/assoc :resource-arn (deserresource-arn (clojure.core/get-in letvar258842 ["resourceArn"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper258844 input] (clojure.core/let [rawinput258843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258845 {"message" (rawinput258843 "message")}] (clojure.core/cond-> {} (letvar258845 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258845 ["message"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper258847 input] (clojure.core/let [rawinput258846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258848 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-dataset-response ([input] (response-create-dataset-response nil input)) ([resultWrapper258850 input] (clojure.core/let [rawinput258849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258851 {"datasetName" (rawinput258849 "datasetName"), "datasetArn" (rawinput258849 "datasetArn"), "retentionPeriod" (rawinput258849 "retentionPeriod")}] (clojure.core/cond-> {} (letvar258851 "datasetName") (clojure.core/assoc :dataset-name (deser-dataset-name (clojure.core/get-in letvar258851 ["datasetName"]))) (letvar258851 "datasetArn") (clojure.core/assoc :dataset-arn (deser-dataset-arn (clojure.core/get-in letvar258851 ["datasetArn"]))) (letvar258851 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar258851 ["retentionPeriod"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper258853 input] (clojure.core/let [rawinput258852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258854 {"message" (rawinput258852 "message")}] (clojure.core/cond-> {} (letvar258854 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258854 ["message"])))))))

(clojure.core/defn- response-list-channels-response ([input] (response-list-channels-response nil input)) ([resultWrapper258856 input] (clojure.core/let [rawinput258855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258857 {"channelSummaries" (rawinput258855 "channelSummaries"), "nextToken" (rawinput258855 "nextToken")}] (clojure.core/cond-> {} (letvar258857 "channelSummaries") (clojure.core/assoc :channel-summaries (deser-channel-summaries (clojure.core/get-in letvar258857 ["channelSummaries"]))) (letvar258857 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar258857 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper258859 input] (clojure.core/let [rawinput258858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258860 {"message" (rawinput258858 "message")}] (clojure.core/cond-> {} (letvar258860 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258860 ["message"])))))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper258862 input] (clojure.core/let [rawinput258861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258863 {"dataset" (rawinput258861 "dataset")}] (clojure.core/cond-> {} (letvar258863 "dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar258863 ["dataset"])))))))

(clojure.core/defn- response-describe-logging-options-response ([input] (response-describe-logging-options-response nil input)) ([resultWrapper258865 input] (clojure.core/let [rawinput258864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258866 {"loggingOptions" (rawinput258864 "loggingOptions")}] (clojure.core/cond-> {} (letvar258866 "loggingOptions") (clojure.core/assoc :logging-options (deser-logging-options (clojure.core/get-in letvar258866 ["loggingOptions"])))))))

(clojure.core/defn- response-describe-pipeline-response ([input] (response-describe-pipeline-response nil input)) ([resultWrapper258868 input] (clojure.core/let [rawinput258867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258869 {"pipeline" (rawinput258867 "pipeline")}] (clojure.core/cond-> {} (letvar258869 "pipeline") (clojure.core/assoc :pipeline (deser-pipeline (clojure.core/get-in letvar258869 ["pipeline"])))))))

(clojure.core/defn- response-list-pipelines-response ([input] (response-list-pipelines-response nil input)) ([resultWrapper258871 input] (clojure.core/let [rawinput258870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258872 {"pipelineSummaries" (rawinput258870 "pipelineSummaries"), "nextToken" (rawinput258870 "nextToken")}] (clojure.core/cond-> {} (letvar258872 "pipelineSummaries") (clojure.core/assoc :pipeline-summaries (deser-pipeline-summaries (clojure.core/get-in letvar258872 ["pipelineSummaries"]))) (letvar258872 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar258872 ["nextToken"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper258874 input] (clojure.core/let [rawinput258873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258875 {"message" (rawinput258873 "message")}] (clojure.core/cond-> {} (letvar258875 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar258875 ["message"])))))))

(clojure.core/defn- response-get-dataset-content-response ([input] (response-get-dataset-content-response nil input)) ([resultWrapper258877 input] (clojure.core/let [rawinput258876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258878 {"entries" (rawinput258876 "entries"), "timestamp" (rawinput258876 "timestamp"), "status" (rawinput258876 "status")}] (clojure.core/cond-> {} (letvar258878 "entries") (clojure.core/assoc :entries (deser-dataset-entries (clojure.core/get-in letvar258878 ["entries"]))) (letvar258878 "timestamp") (clojure.core/assoc :timestamp (deser-timestamp (clojure.core/get-in letvar258878 ["timestamp"]))) (letvar258878 "status") (clojure.core/assoc :status (deser-dataset-content-status (clojure.core/get-in letvar258878 ["status"])))))))

(clojure.core/defn- response-sample-channel-data-response ([input] (response-sample-channel-data-response nil input)) ([resultWrapper258880 input] (clojure.core/let [rawinput258879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258881 {"payloads" (rawinput258879 "payloads")}] (clojure.core/cond-> {} (letvar258881 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar258881 ["payloads"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper258883 input] (clojure.core/let [rawinput258882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258884 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper258886 input] (clojure.core/let [rawinput258885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258887 {"datasetSummaries" (rawinput258885 "datasetSummaries"), "nextToken" (rawinput258885 "nextToken")}] (clojure.core/cond-> {} (letvar258887 "datasetSummaries") (clojure.core/assoc :dataset-summaries (deser-dataset-summaries (clojure.core/get-in letvar258887 ["datasetSummaries"]))) (letvar258887 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar258887 ["nextToken"])))))))

(clojure.core/defn- response-batch-put-message-response ([input] (response-batch-put-message-response nil input)) ([resultWrapper258889 input] (clojure.core/let [rawinput258888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar258890 {"batchPutMessageErrorEntries" (rawinput258888 "batchPutMessageErrorEntries")}] (clojure.core/cond-> {} (letvar258890 "batchPutMessageErrorEntries") (clojure.core/assoc :batch-put-message-error-entries (deser-batch-put-message-error-entries (clojure.core/get-in letvar258890 ["batchPutMessageErrorEntries"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-content-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 7 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/message-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/pipeline-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/output-file-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w\.-]{1,255}" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 20 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/iot-events-input-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z][a-zA-Z0-9_]*$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/dataset-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/lambda-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 20 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/math-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics.-2017-11-27/activity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
