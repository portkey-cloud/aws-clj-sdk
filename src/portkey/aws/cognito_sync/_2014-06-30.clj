...
(clojure.core/defn- response-duplicate-request-exception ([input] (response-duplicate-request-exception nil input)) ([resultWrapper122522 input] (clojure.core/let [rawinput122521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122523 {"message" (rawinput122521 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122523 ["message"]))}))))

(clojure.core/defn- response-describe-identity-pool-usage-response ([input] (response-describe-identity-pool-usage-response nil input)) ([resultWrapper122525 input] (clojure.core/let [rawinput122524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122526 {"IdentityPoolUsage" (rawinput122524 "IdentityPoolUsage")}] (clojure.core/cond-> {} (letvar122526 "IdentityPoolUsage") (clojure.core/assoc :identity-pool-usage (deser-identity-pool-usage (clojure.core/get-in letvar122526 ["IdentityPoolUsage"])))))))

(clojure.core/defn- response-describe-identity-usage-response ([input] (response-describe-identity-usage-response nil input)) ([resultWrapper122528 input] (clojure.core/let [rawinput122527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122529 {"IdentityUsage" (rawinput122527 "IdentityUsage")}] (clojure.core/cond-> {} (letvar122529 "IdentityUsage") (clojure.core/assoc :identity-usage (deser-identity-usage (clojure.core/get-in letvar122529 ["IdentityUsage"])))))))

(clojure.core/defn- response-unsubscribe-from-dataset-response ([input] (response-unsubscribe-from-dataset-response nil input)) ([resultWrapper122531 input] (clojure.core/let [rawinput122530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122532 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-set-identity-pool-configuration-response ([input] (response-set-identity-pool-configuration-response nil input)) ([resultWrapper122534 input] (clojure.core/let [rawinput122533 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122535 {"IdentityPoolId" (rawinput122533 "IdentityPoolId"), "PushSync" (rawinput122533 "PushSync"), "CognitoStreams" (rawinput122533 "CognitoStreams")}] (clojure.core/cond-> {} (letvar122535 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar122535 ["IdentityPoolId"]))) (letvar122535 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar122535 ["PushSync"]))) (letvar122535 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar122535 ["CognitoStreams"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper122537 input] (clojure.core/let [rawinput122536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122538 {"message" (rawinput122536 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122538 ["message"]))}))))

(clojure.core/defn- response-already-streamed-exception ([input] (response-already-streamed-exception nil input)) ([resultWrapper122540 input] (clojure.core/let [rawinput122539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122541 {"message" (rawinput122539 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122541 ["message"]))}))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper122543 input] (clojure.core/let [rawinput122542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122544 {"message" (rawinput122542 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122544 ["message"]))}))))

(clojure.core/defn- response-update-records-response ([input] (response-update-records-response nil input)) ([resultWrapper122546 input] (clojure.core/let [rawinput122545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122547 {"Records" (rawinput122545 "Records")}] (clojure.core/cond-> {} (letvar122547 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar122547 ["Records"])))))))

(clojure.core/defn- response-delete-dataset-response ([input] (response-delete-dataset-response nil input)) ([resultWrapper122549 input] (clojure.core/let [rawinput122548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122550 {"Dataset" (rawinput122548 "Dataset")}] (clojure.core/cond-> {} (letvar122550 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar122550 ["Dataset"])))))))

(clojure.core/defn- response-get-bulk-publish-details-response ([input] (response-get-bulk-publish-details-response nil input)) ([resultWrapper122552 input] (clojure.core/let [rawinput122551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122553 {"IdentityPoolId" (rawinput122551 "IdentityPoolId"), "BulkPublishStartTime" (rawinput122551 "BulkPublishStartTime"), "BulkPublishCompleteTime" (rawinput122551 "BulkPublishCompleteTime"), "BulkPublishStatus" (rawinput122551 "BulkPublishStatus"), "FailureMessage" (rawinput122551 "FailureMessage")}] (clojure.core/cond-> {} (letvar122553 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar122553 ["IdentityPoolId"]))) (letvar122553 "BulkPublishStartTime") (clojure.core/assoc :bulk-publish-start-time (deser-date (clojure.core/get-in letvar122553 ["BulkPublishStartTime"]))) (letvar122553 "BulkPublishCompleteTime") (clojure.core/assoc :bulk-publish-complete-time (deser-date (clojure.core/get-in letvar122553 ["BulkPublishCompleteTime"]))) (letvar122553 "BulkPublishStatus") (clojure.core/assoc :bulk-publish-status (deser-bulk-publish-status (clojure.core/get-in letvar122553 ["BulkPublishStatus"]))) (letvar122553 "FailureMessage") (clojure.core/assoc :failure-message (deser-string (clojure.core/get-in letvar122553 ["FailureMessage"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper122555 input] (clojure.core/let [rawinput122554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122556 {"message" (rawinput122554 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122556 ["message"]))}))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper122558 input] (clojure.core/let [rawinput122557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122559 {"message" (rawinput122557 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122559 ["message"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper122561 input] (clojure.core/let [rawinput122560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122562 {"message" (rawinput122560 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122562 ["message"]))}))))

(clojure.core/defn- response-get-cognito-events-response ([input] (response-get-cognito-events-response nil input)) ([resultWrapper122564 input] (clojure.core/let [rawinput122563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122565 {"Events" (rawinput122563 "Events")}] (clojure.core/cond-> {} (letvar122565 "Events") (clojure.core/assoc :events (deser-events (clojure.core/get-in letvar122565 ["Events"])))))))

(clojure.core/defn- response-lambda-throttled-exception ([input] (response-lambda-throttled-exception nil input)) ([resultWrapper122567 input] (clojure.core/let [rawinput122566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122568 {"message" (rawinput122566 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122568 ["message"]))}))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper122570 input] (clojure.core/let [rawinput122569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122571 {"Dataset" (rawinput122569 "Dataset")}] (clojure.core/cond-> {} (letvar122571 "Dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar122571 ["Dataset"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper122573 input] (clojure.core/let [rawinput122572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122574 {"message" (rawinput122572 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122574 ["message"]))}))))

(clojure.core/defn- response-invalid-lambda-function-output-exception ([input] (response-invalid-lambda-function-output-exception nil input)) ([resultWrapper122576 input] (clojure.core/let [rawinput122575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122577 {"message" (rawinput122575 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122577 ["message"]))}))))

(clojure.core/defn- response-get-identity-pool-configuration-response ([input] (response-get-identity-pool-configuration-response nil input)) ([resultWrapper122579 input] (clojure.core/let [rawinput122578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122580 {"IdentityPoolId" (rawinput122578 "IdentityPoolId"), "PushSync" (rawinput122578 "PushSync"), "CognitoStreams" (rawinput122578 "CognitoStreams")}] (clojure.core/cond-> {} (letvar122580 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar122580 ["IdentityPoolId"]))) (letvar122580 "PushSync") (clojure.core/assoc :push-sync (deser-push-sync (clojure.core/get-in letvar122580 ["PushSync"]))) (letvar122580 "CognitoStreams") (clojure.core/assoc :cognito-streams (deser-cognito-streams (clojure.core/get-in letvar122580 ["CognitoStreams"])))))))

(clojure.core/defn- response-list-records-response ([input] (response-list-records-response nil input)) ([resultWrapper122582 input] (clojure.core/let [rawinput122581 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122583 {"SyncSessionToken" (rawinput122581 "SyncSessionToken"), "DatasetSyncCount" (rawinput122581 "DatasetSyncCount"), "Count" (rawinput122581 "Count"), "NextToken" (rawinput122581 "NextToken"), "DatasetExists" (rawinput122581 "DatasetExists"), "DatasetDeletedAfterRequestedSyncCount" (rawinput122581 "DatasetDeletedAfterRequestedSyncCount"), "MergedDatasetNames" (rawinput122581 "MergedDatasetNames"), "Records" (rawinput122581 "Records"), "LastModifiedBy" (rawinput122581 "LastModifiedBy")}] (clojure.core/cond-> {} (letvar122583 "SyncSessionToken") (clojure.core/assoc :sync-session-token (deser-string (clojure.core/get-in letvar122583 ["SyncSessionToken"]))) (letvar122583 "DatasetSyncCount") (clojure.core/assoc :dataset-sync-count (deser-long (clojure.core/get-in letvar122583 ["DatasetSyncCount"]))) (letvar122583 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar122583 ["Count"]))) (letvar122583 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar122583 ["NextToken"]))) (letvar122583 "DatasetExists") (clojure.core/assoc :dataset-exists (deser-boolean (clojure.core/get-in letvar122583 ["DatasetExists"]))) (letvar122583 "DatasetDeletedAfterRequestedSyncCount") (clojure.core/assoc :dataset-deleted-after-requested-sync-count (deser-boolean (clojure.core/get-in letvar122583 ["DatasetDeletedAfterRequestedSyncCount"]))) (letvar122583 "MergedDatasetNames") (clojure.core/assoc :merged-dataset-names (deser-merged-dataset-name-list (clojure.core/get-in letvar122583 ["MergedDatasetNames"]))) (letvar122583 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar122583 ["Records"]))) (letvar122583 "LastModifiedBy") (clojure.core/assoc :last-modified-by (deser-string (clojure.core/get-in letvar122583 ["LastModifiedBy"])))))))

(clojure.core/defn- response-subscribe-to-dataset-response ([input] (response-subscribe-to-dataset-response nil input)) ([resultWrapper122585 input] (clojure.core/let [rawinput122584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122586 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bulk-publish-response ([input] (response-bulk-publish-response nil input)) ([resultWrapper122588 input] (clojure.core/let [rawinput122587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122589 {"IdentityPoolId" (rawinput122587 "IdentityPoolId")}] (clojure.core/cond-> {} (letvar122589 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar122589 ["IdentityPoolId"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper122591 input] (clojure.core/let [rawinput122590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122592 {"message" (rawinput122590 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar122592 ["message"]))}))))

(clojure.core/defn- response-list-identity-pool-usage-response ([input] (response-list-identity-pool-usage-response nil input)) ([resultWrapper122594 input] (clojure.core/let [rawinput122593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122595 {"IdentityPoolUsages" (rawinput122593 "IdentityPoolUsages"), "MaxResults" (rawinput122593 "MaxResults"), "Count" (rawinput122593 "Count"), "NextToken" (rawinput122593 "NextToken")}] (clojure.core/cond-> {} (letvar122595 "IdentityPoolUsages") (clojure.core/assoc :identity-pool-usages (deser-identity-pool-usage-list (clojure.core/get-in letvar122595 ["IdentityPoolUsages"]))) (letvar122595 "MaxResults") (clojure.core/assoc :max-results (deser-integer (clojure.core/get-in letvar122595 ["MaxResults"]))) (letvar122595 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar122595 ["Count"]))) (letvar122595 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar122595 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper122597 input] (clojure.core/let [rawinput122596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122598 {"message" (rawinput122596 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122598 ["message"]))}))))

(clojure.core/defn- response-register-device-response ([input] (response-register-device-response nil input)) ([resultWrapper122600 input] (clojure.core/let [rawinput122599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122601 {"DeviceId" (rawinput122599 "DeviceId")}] (clojure.core/cond-> {} (letvar122601 "DeviceId") (clojure.core/assoc :device-id (deser-device-id (clojure.core/get-in letvar122601 ["DeviceId"])))))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper122603 input] (clojure.core/let [rawinput122602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122604 {"Datasets" (rawinput122602 "Datasets"), "Count" (rawinput122602 "Count"), "NextToken" (rawinput122602 "NextToken")}] (clojure.core/cond-> {} (letvar122604 "Datasets") (clojure.core/assoc :datasets (deser-dataset-list (clojure.core/get-in letvar122604 ["Datasets"]))) (letvar122604 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar122604 ["Count"]))) (letvar122604 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar122604 ["NextToken"])))))))

(clojure.core/defn- response-invalid-configuration-exception ([input] (response-invalid-configuration-exception nil input)) ([resultWrapper122606 input] (clojure.core/let [rawinput122605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar122607 {"message" (rawinput122605 "message")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar122607 ["message"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/record-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/application-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:sns:[-0-9a-z]+:\d+:app/[A-Z_]+/[a-zA-Z0-9_.-]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/sync-session-token (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.:-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 55)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/identity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 55)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-sync.-2014-06-30/record-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1048575))))
