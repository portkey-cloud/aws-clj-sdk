...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper1181397 input] (clojure.core/let [rawinput1181396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181398 {"unprocessedAccounts" (rawinput1181396 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181398 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181398 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1181400 input] (clojure.core/let [rawinput1181399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181401 {"message" (rawinput1181399 "message"), "__type" (rawinput1181399 "__type")}] (clojure.core/cond-> {} (letvar1181401 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1181401 ["message"]))) (letvar1181401 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1181401 ["__type"])))))))

(clojure.core/defn- response-delete-detector-response ([input] (response-delete-detector-response nil input)) ([resultWrapper1181403 input] (clojure.core/let [rawinput1181402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181404 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper1181406 input] (clojure.core/let [rawinput1181405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181407 {"master" (rawinput1181405 "master")}] (clojure.core/cond-> {} (letvar1181407 "master") (clojure.core/assoc :master (deser-master (clojure.core/get-in letvar1181407 ["master"])))))))

(clojure.core/defn- response-create-detector-response ([input] (response-create-detector-response nil input)) ([resultWrapper1181409 input] (clojure.core/let [rawinput1181408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181410 {"detectorId" (rawinput1181408 "detectorId")}] (clojure.core/cond-> {} (letvar1181410 "detectorId") (clojure.core/assoc :detector-id (deser-detector-id (clojure.core/get-in letvar1181410 ["detectorId"])))))))

(clojure.core/defn- response-update-threat-intel-set-response ([input] (response-update-threat-intel-set-response nil input)) ([resultWrapper1181412 input] (clojure.core/let [rawinput1181411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181413 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper1181415 input] (clojure.core/let [rawinput1181414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181416 {"unprocessedAccounts" (rawinput1181414 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181416 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181416 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1181418 input] (clojure.core/let [rawinput1181417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181419 {"message" (rawinput1181417 "message"), "__type" (rawinput1181417 "__type")}] (clojure.core/cond-> {} (letvar1181419 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1181419 ["message"]))) (letvar1181419 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1181419 ["__type"])))))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper1181421 input] (clojure.core/let [rawinput1181420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181422 {"unprocessedAccounts" (rawinput1181420 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181422 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181422 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper1181424 input] (clojure.core/let [rawinput1181423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181425 {"unprocessedAccounts" (rawinput1181423 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181425 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181425 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper1181427 input] (clojure.core/let [rawinput1181426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181428 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper1181430 input] (clojure.core/let [rawinput1181429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181431 {"members" (rawinput1181429 "members"), "unprocessedAccounts" (rawinput1181429 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181431 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar1181431 ["members"]))) (letvar1181431 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181431 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-threat-intel-set-response ([input] (response-get-threat-intel-set-response nil input)) ([resultWrapper1181433 input] (clojure.core/let [rawinput1181432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181434 {"format" (rawinput1181432 "format"), "location" (rawinput1181432 "location"), "name" (rawinput1181432 "name"), "status" (rawinput1181432 "status")}] (clojure.core/cond-> {} (letvar1181434 "format") (clojure.core/assoc :format (deser-threat-intel-set-format (clojure.core/get-in letvar1181434 ["format"]))) (letvar1181434 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar1181434 ["location"]))) (letvar1181434 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1181434 ["name"]))) (letvar1181434 "status") (clojure.core/assoc :status (deser-threat-intel-set-status (clojure.core/get-in letvar1181434 ["status"])))))))

(clojure.core/defn- response-delete-filter-response ([input] (response-delete-filter-response nil input)) ([resultWrapper1181436 input] (clojure.core/let [rawinput1181435 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181437 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-archive-findings-response ([input] (response-archive-findings-response nil input)) ([resultWrapper1181439 input] (clojure.core/let [rawinput1181438 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181440 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-threat-intel-set-response ([input] (response-delete-threat-intel-set-response nil input)) ([resultWrapper1181442 input] (clojure.core/let [rawinput1181441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181443 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-ip-set-response ([input] (response-update-ip-set-response nil input)) ([resultWrapper1181445 input] (clojure.core/let [rawinput1181444 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181446 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper1181448 input] (clojure.core/let [rawinput1181447 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181449 {"invitations" (rawinput1181447 "invitations"), "nextToken" (rawinput1181447 "nextToken")}] (clojure.core/cond-> {} (letvar1181449 "invitations") (clojure.core/assoc :invitations (deser-invitations (clojure.core/get-in letvar1181449 ["invitations"]))) (letvar1181449 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181449 ["nextToken"])))))))

(clojure.core/defn- response-list-detectors-response ([input] (response-list-detectors-response nil input)) ([resultWrapper1181451 input] (clojure.core/let [rawinput1181450 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181452 {"detectorIds" (rawinput1181450 "detectorIds"), "nextToken" (rawinput1181450 "nextToken")}] (clojure.core/cond-> {} (letvar1181452 "detectorIds") (clojure.core/assoc :detector-ids (deser-detector-ids (clojure.core/get-in letvar1181452 ["detectorIds"]))) (letvar1181452 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181452 ["nextToken"])))))))

(clojure.core/defn- response-stop-monitoring-members-response ([input] (response-stop-monitoring-members-response nil input)) ([resultWrapper1181454 input] (clojure.core/let [rawinput1181453 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181455 {"unprocessedAccounts" (rawinput1181453 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181455 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181455 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-ip-set-response ([input] (response-get-ip-set-response nil input)) ([resultWrapper1181457 input] (clojure.core/let [rawinput1181456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181458 {"format" (rawinput1181456 "format"), "location" (rawinput1181456 "location"), "name" (rawinput1181456 "name"), "status" (rawinput1181456 "status")}] (clojure.core/cond-> {} (letvar1181458 "format") (clojure.core/assoc :format (deser-ip-set-format (clojure.core/get-in letvar1181458 ["format"]))) (letvar1181458 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar1181458 ["location"]))) (letvar1181458 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1181458 ["name"]))) (letvar1181458 "status") (clojure.core/assoc :status (deser-ip-set-status (clojure.core/get-in letvar1181458 ["status"])))))))

(clojure.core/defn- response-update-filter-response ([input] (response-update-filter-response nil input)) ([resultWrapper1181460 input] (clojure.core/let [rawinput1181459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181461 {"name" (rawinput1181459 "name")}] (clojure.core/cond-> {} (letvar1181461 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1181461 ["name"])))))))

(clojure.core/defn- response-delete-ip-set-response ([input] (response-delete-ip-set-response nil input)) ([resultWrapper1181463 input] (clojure.core/let [rawinput1181462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181464 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-feedback-response ([input] (response-update-findings-feedback-response nil input)) ([resultWrapper1181466 input] (clojure.core/let [rawinput1181465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181467 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-filter-response ([input] (response-create-filter-response nil input)) ([resultWrapper1181469 input] (clojure.core/let [rawinput1181468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181470 {"name" (rawinput1181468 "name")}] (clojure.core/cond-> {} (letvar1181470 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1181470 ["name"])))))))

(clojure.core/defn- response-unarchive-findings-response ([input] (response-unarchive-findings-response nil input)) ([resultWrapper1181472 input] (clojure.core/let [rawinput1181471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181473 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper1181475 input] (clojure.core/let [rawinput1181474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181476 {"invitationsCount" (rawinput1181474 "invitationsCount")}] (clojure.core/cond-> {} (letvar1181476 "invitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar1181476 ["invitationsCount"])))))))

(clojure.core/defn- response-get-detector-response ([input] (response-get-detector-response nil input)) ([resultWrapper1181478 input] (clojure.core/let [rawinput1181477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181479 {"createdAt" (rawinput1181477 "createdAt"), "findingPublishingFrequency" (rawinput1181477 "findingPublishingFrequency"), "serviceRole" (rawinput1181477 "serviceRole"), "status" (rawinput1181477 "status"), "updatedAt" (rawinput1181477 "updatedAt")}] (clojure.core/cond-> {} (letvar1181479 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar1181479 ["createdAt"]))) (letvar1181479 "findingPublishingFrequency") (clojure.core/assoc :finding-publishing-frequency (deser-finding-publishing-frequency (clojure.core/get-in letvar1181479 ["findingPublishingFrequency"]))) (letvar1181479 "serviceRole") (clojure.core/assoc :service-role (deser-service-role (clojure.core/get-in letvar1181479 ["serviceRole"]))) (letvar1181479 "status") (clojure.core/assoc :status (deser-detector-status (clojure.core/get-in letvar1181479 ["status"]))) (letvar1181479 "updatedAt") (clojure.core/assoc :updated-at (deser-updated-at (clojure.core/get-in letvar1181479 ["updatedAt"])))))))

(clojure.core/defn- response-start-monitoring-members-response ([input] (response-start-monitoring-members-response nil input)) ([resultWrapper1181481 input] (clojure.core/let [rawinput1181480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181482 {"unprocessedAccounts" (rawinput1181480 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181482 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181482 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-findings-statistics-response ([input] (response-get-findings-statistics-response nil input)) ([resultWrapper1181484 input] (clojure.core/let [rawinput1181483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181485 {"findingStatistics" (rawinput1181483 "findingStatistics")}] (clojure.core/cond-> {} (letvar1181485 "findingStatistics") (clojure.core/assoc :finding-statistics (deser-finding-statistics (clojure.core/get-in letvar1181485 ["findingStatistics"])))))))

(clojure.core/defn- response-create-threat-intel-set-response ([input] (response-create-threat-intel-set-response nil input)) ([resultWrapper1181487 input] (clojure.core/let [rawinput1181486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181488 {"threatIntelSetId" (rawinput1181486 "threatIntelSetId")}] (clojure.core/cond-> {} (letvar1181488 "threatIntelSetId") (clojure.core/assoc :threat-intel-set-id (deser-threat-intel-set-id (clojure.core/get-in letvar1181488 ["threatIntelSetId"])))))))

(clojure.core/defn- response-list-findings-response ([input] (response-list-findings-response nil input)) ([resultWrapper1181490 input] (clojure.core/let [rawinput1181489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181491 {"findingIds" (rawinput1181489 "findingIds"), "nextToken" (rawinput1181489 "nextToken")}] (clojure.core/cond-> {} (letvar1181491 "findingIds") (clojure.core/assoc :finding-ids (deser-finding-ids (clojure.core/get-in letvar1181491 ["findingIds"]))) (letvar1181491 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181491 ["nextToken"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper1181493 input] (clojure.core/let [rawinput1181492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181494 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper1181496 input] (clojure.core/let [rawinput1181495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181497 {"findings" (rawinput1181495 "findings")}] (clojure.core/cond-> {} (letvar1181497 "findings") (clojure.core/assoc :findings (deser-findings (clojure.core/get-in letvar1181497 ["findings"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper1181499 input] (clojure.core/let [rawinput1181498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181500 {"unprocessedAccounts" (rawinput1181498 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181500 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181500 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-list-threat-intel-sets-response ([input] (response-list-threat-intel-sets-response nil input)) ([resultWrapper1181502 input] (clojure.core/let [rawinput1181501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181503 {"nextToken" (rawinput1181501 "nextToken"), "threatIntelSetIds" (rawinput1181501 "threatIntelSetIds")}] (clojure.core/cond-> {} (letvar1181503 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181503 ["nextToken"]))) (letvar1181503 "threatIntelSetIds") (clojure.core/assoc :threat-intel-set-ids (deser-threat-intel-set-ids (clojure.core/get-in letvar1181503 ["threatIntelSetIds"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper1181505 input] (clojure.core/let [rawinput1181504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181506 {"unprocessedAccounts" (rawinput1181504 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar1181506 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar1181506 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-create-sample-findings-response ([input] (response-create-sample-findings-response nil input)) ([resultWrapper1181508 input] (clojure.core/let [rawinput1181507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181509 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-filters-response ([input] (response-list-filters-response nil input)) ([resultWrapper1181511 input] (clojure.core/let [rawinput1181510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181512 {"filterNames" (rawinput1181510 "filterNames"), "nextToken" (rawinput1181510 "nextToken")}] (clojure.core/cond-> {} (letvar1181512 "filterNames") (clojure.core/assoc :filter-names (deser-filter-names (clojure.core/get-in letvar1181512 ["filterNames"]))) (letvar1181512 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181512 ["nextToken"])))))))

(clojure.core/defn- response-get-filter-response ([input] (response-get-filter-response nil input)) ([resultWrapper1181514 input] (clojure.core/let [rawinput1181513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181515 {"action" (rawinput1181513 "action"), "description" (rawinput1181513 "description"), "findingCriteria" (rawinput1181513 "findingCriteria"), "name" (rawinput1181513 "name"), "rank" (rawinput1181513 "rank")}] (clojure.core/cond-> {} (letvar1181515 "action") (clojure.core/assoc :action (deser-filter-action (clojure.core/get-in letvar1181515 ["action"]))) (letvar1181515 "description") (clojure.core/assoc :description (deser-filter-description (clojure.core/get-in letvar1181515 ["description"]))) (letvar1181515 "findingCriteria") (clojure.core/assoc :finding-criteria (deser-finding-criteria (clojure.core/get-in letvar1181515 ["findingCriteria"]))) (letvar1181515 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar1181515 ["name"]))) (letvar1181515 "rank") (clojure.core/assoc :rank (deser-filter-rank (clojure.core/get-in letvar1181515 ["rank"])))))))

(clojure.core/defn- response-update-detector-response ([input] (response-update-detector-response nil input)) ([resultWrapper1181517 input] (clojure.core/let [rawinput1181516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181518 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-ip-set-response ([input] (response-create-ip-set-response nil input)) ([resultWrapper1181520 input] (clojure.core/let [rawinput1181519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181521 {"ipSetId" (rawinput1181519 "ipSetId")}] (clojure.core/cond-> {} (letvar1181521 "ipSetId") (clojure.core/assoc :ip-set-id (deser-ip-set-id (clojure.core/get-in letvar1181521 ["ipSetId"])))))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper1181523 input] (clojure.core/let [rawinput1181522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181524 {"members" (rawinput1181522 "members"), "nextToken" (rawinput1181522 "nextToken")}] (clojure.core/cond-> {} (letvar1181524 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar1181524 ["members"]))) (letvar1181524 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181524 ["nextToken"])))))))

(clojure.core/defn- response-list-ip-sets-response ([input] (response-list-ip-sets-response nil input)) ([resultWrapper1181526 input] (clojure.core/let [rawinput1181525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1181527 {"ipSetIds" (rawinput1181525 "ipSetIds"), "nextToken" (rawinput1181525 "nextToken")}] (clojure.core/cond-> {} (letvar1181527 "ipSetIds") (clojure.core/assoc :ip-set-ids (deser-ip-set-ids (clojure.core/get-in letvar1181527 ["ipSetIds"]))) (letvar1181527 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1181527 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.guardduty/string-min-0-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
