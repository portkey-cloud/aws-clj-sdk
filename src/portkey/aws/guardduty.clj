...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper188400 input] (clojure.core/let [rawinput188399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188401 {"unprocessedAccounts" (rawinput188399 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188401 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188401 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper188403 input] (clojure.core/let [rawinput188402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188404 {"message" (rawinput188402 "message"), "__type" (rawinput188402 "__type")}] (clojure.core/cond-> {} (letvar188404 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar188404 ["message"]))) (letvar188404 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar188404 ["__type"])))))))

(clojure.core/defn- response-delete-detector-response ([input] (response-delete-detector-response nil input)) ([resultWrapper188406 input] (clojure.core/let [rawinput188405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188407 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper188409 input] (clojure.core/let [rawinput188408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188410 {"master" (rawinput188408 "master")}] (clojure.core/cond-> {} (letvar188410 "master") (clojure.core/assoc :master (deser-master (clojure.core/get-in letvar188410 ["master"])))))))

(clojure.core/defn- response-create-detector-response ([input] (response-create-detector-response nil input)) ([resultWrapper188412 input] (clojure.core/let [rawinput188411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188413 {"detectorId" (rawinput188411 "detectorId")}] (clojure.core/cond-> {} (letvar188413 "detectorId") (clojure.core/assoc :detector-id (deser-detector-id (clojure.core/get-in letvar188413 ["detectorId"])))))))

(clojure.core/defn- response-update-threat-intel-set-response ([input] (response-update-threat-intel-set-response nil input)) ([resultWrapper188415 input] (clojure.core/let [rawinput188414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188416 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper188418 input] (clojure.core/let [rawinput188417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188419 {"unprocessedAccounts" (rawinput188417 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188419 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188419 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper188421 input] (clojure.core/let [rawinput188420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188422 {"message" (rawinput188420 "message"), "__type" (rawinput188420 "__type")}] (clojure.core/cond-> {} (letvar188422 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar188422 ["message"]))) (letvar188422 "__type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar188422 ["__type"])))))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper188424 input] (clojure.core/let [rawinput188423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188425 {"unprocessedAccounts" (rawinput188423 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188425 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188425 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper188427 input] (clojure.core/let [rawinput188426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188428 {"unprocessedAccounts" (rawinput188426 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188428 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188428 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper188430 input] (clojure.core/let [rawinput188429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188431 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper188433 input] (clojure.core/let [rawinput188432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188434 {"members" (rawinput188432 "members"), "unprocessedAccounts" (rawinput188432 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188434 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar188434 ["members"]))) (letvar188434 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188434 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-threat-intel-set-response ([input] (response-get-threat-intel-set-response nil input)) ([resultWrapper188436 input] (clojure.core/let [rawinput188435 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188437 {"format" (rawinput188435 "format"), "location" (rawinput188435 "location"), "name" (rawinput188435 "name"), "status" (rawinput188435 "status")}] (clojure.core/cond-> {} (letvar188437 "format") (clojure.core/assoc :format (deser-threat-intel-set-format (clojure.core/get-in letvar188437 ["format"]))) (letvar188437 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar188437 ["location"]))) (letvar188437 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar188437 ["name"]))) (letvar188437 "status") (clojure.core/assoc :status (deser-threat-intel-set-status (clojure.core/get-in letvar188437 ["status"])))))))

(clojure.core/defn- response-delete-filter-response ([input] (response-delete-filter-response nil input)) ([resultWrapper188439 input] (clojure.core/let [rawinput188438 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188440 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-archive-findings-response ([input] (response-archive-findings-response nil input)) ([resultWrapper188442 input] (clojure.core/let [rawinput188441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188443 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-threat-intel-set-response ([input] (response-delete-threat-intel-set-response nil input)) ([resultWrapper188445 input] (clojure.core/let [rawinput188444 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188446 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-ip-set-response ([input] (response-update-ip-set-response nil input)) ([resultWrapper188448 input] (clojure.core/let [rawinput188447 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188449 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper188451 input] (clojure.core/let [rawinput188450 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188452 {"invitations" (rawinput188450 "invitations"), "nextToken" (rawinput188450 "nextToken")}] (clojure.core/cond-> {} (letvar188452 "invitations") (clojure.core/assoc :invitations (deser-invitations (clojure.core/get-in letvar188452 ["invitations"]))) (letvar188452 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188452 ["nextToken"])))))))

(clojure.core/defn- response-list-detectors-response ([input] (response-list-detectors-response nil input)) ([resultWrapper188454 input] (clojure.core/let [rawinput188453 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188455 {"detectorIds" (rawinput188453 "detectorIds"), "nextToken" (rawinput188453 "nextToken")}] (clojure.core/cond-> {} (letvar188455 "detectorIds") (clojure.core/assoc :detector-ids (deser-detector-ids (clojure.core/get-in letvar188455 ["detectorIds"]))) (letvar188455 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188455 ["nextToken"])))))))

(clojure.core/defn- response-stop-monitoring-members-response ([input] (response-stop-monitoring-members-response nil input)) ([resultWrapper188457 input] (clojure.core/let [rawinput188456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188458 {"unprocessedAccounts" (rawinput188456 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188458 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188458 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-ip-set-response ([input] (response-get-ip-set-response nil input)) ([resultWrapper188460 input] (clojure.core/let [rawinput188459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188461 {"format" (rawinput188459 "format"), "location" (rawinput188459 "location"), "name" (rawinput188459 "name"), "status" (rawinput188459 "status")}] (clojure.core/cond-> {} (letvar188461 "format") (clojure.core/assoc :format (deser-ip-set-format (clojure.core/get-in letvar188461 ["format"]))) (letvar188461 "location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar188461 ["location"]))) (letvar188461 "name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar188461 ["name"]))) (letvar188461 "status") (clojure.core/assoc :status (deser-ip-set-status (clojure.core/get-in letvar188461 ["status"])))))))

(clojure.core/defn- response-update-filter-response ([input] (response-update-filter-response nil input)) ([resultWrapper188463 input] (clojure.core/let [rawinput188462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188464 {"name" (rawinput188462 "name")}] (clojure.core/cond-> {} (letvar188464 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar188464 ["name"])))))))

(clojure.core/defn- response-delete-ip-set-response ([input] (response-delete-ip-set-response nil input)) ([resultWrapper188466 input] (clojure.core/let [rawinput188465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188467 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-feedback-response ([input] (response-update-findings-feedback-response nil input)) ([resultWrapper188469 input] (clojure.core/let [rawinput188468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188470 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-filter-response ([input] (response-create-filter-response nil input)) ([resultWrapper188472 input] (clojure.core/let [rawinput188471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188473 {"name" (rawinput188471 "name")}] (clojure.core/cond-> {} (letvar188473 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar188473 ["name"])))))))

(clojure.core/defn- response-unarchive-findings-response ([input] (response-unarchive-findings-response nil input)) ([resultWrapper188475 input] (clojure.core/let [rawinput188474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188476 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper188478 input] (clojure.core/let [rawinput188477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188479 {"invitationsCount" (rawinput188477 "invitationsCount")}] (clojure.core/cond-> {} (letvar188479 "invitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar188479 ["invitationsCount"])))))))

(clojure.core/defn- response-get-detector-response ([input] (response-get-detector-response nil input)) ([resultWrapper188481 input] (clojure.core/let [rawinput188480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188482 {"createdAt" (rawinput188480 "createdAt"), "findingPublishingFrequency" (rawinput188480 "findingPublishingFrequency"), "serviceRole" (rawinput188480 "serviceRole"), "status" (rawinput188480 "status"), "updatedAt" (rawinput188480 "updatedAt")}] (clojure.core/cond-> {} (letvar188482 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar188482 ["createdAt"]))) (letvar188482 "findingPublishingFrequency") (clojure.core/assoc :finding-publishing-frequency (deser-finding-publishing-frequency (clojure.core/get-in letvar188482 ["findingPublishingFrequency"]))) (letvar188482 "serviceRole") (clojure.core/assoc :service-role (deser-service-role (clojure.core/get-in letvar188482 ["serviceRole"]))) (letvar188482 "status") (clojure.core/assoc :status (deser-detector-status (clojure.core/get-in letvar188482 ["status"]))) (letvar188482 "updatedAt") (clojure.core/assoc :updated-at (deser-updated-at (clojure.core/get-in letvar188482 ["updatedAt"])))))))

(clojure.core/defn- response-start-monitoring-members-response ([input] (response-start-monitoring-members-response nil input)) ([resultWrapper188484 input] (clojure.core/let [rawinput188483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188485 {"unprocessedAccounts" (rawinput188483 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188485 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188485 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-get-findings-statistics-response ([input] (response-get-findings-statistics-response nil input)) ([resultWrapper188487 input] (clojure.core/let [rawinput188486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188488 {"findingStatistics" (rawinput188486 "findingStatistics")}] (clojure.core/cond-> {} (letvar188488 "findingStatistics") (clojure.core/assoc :finding-statistics (deser-finding-statistics (clojure.core/get-in letvar188488 ["findingStatistics"])))))))

(clojure.core/defn- response-create-threat-intel-set-response ([input] (response-create-threat-intel-set-response nil input)) ([resultWrapper188490 input] (clojure.core/let [rawinput188489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188491 {"threatIntelSetId" (rawinput188489 "threatIntelSetId")}] (clojure.core/cond-> {} (letvar188491 "threatIntelSetId") (clojure.core/assoc :threat-intel-set-id (deser-threat-intel-set-id (clojure.core/get-in letvar188491 ["threatIntelSetId"])))))))

(clojure.core/defn- response-list-findings-response ([input] (response-list-findings-response nil input)) ([resultWrapper188493 input] (clojure.core/let [rawinput188492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188494 {"findingIds" (rawinput188492 "findingIds"), "nextToken" (rawinput188492 "nextToken")}] (clojure.core/cond-> {} (letvar188494 "findingIds") (clojure.core/assoc :finding-ids (deser-finding-ids (clojure.core/get-in letvar188494 ["findingIds"]))) (letvar188494 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188494 ["nextToken"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper188496 input] (clojure.core/let [rawinput188495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188497 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper188499 input] (clojure.core/let [rawinput188498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188500 {"findings" (rawinput188498 "findings")}] (clojure.core/cond-> {} (letvar188500 "findings") (clojure.core/assoc :findings (deser-findings (clojure.core/get-in letvar188500 ["findings"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper188502 input] (clojure.core/let [rawinput188501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188503 {"unprocessedAccounts" (rawinput188501 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188503 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188503 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-list-threat-intel-sets-response ([input] (response-list-threat-intel-sets-response nil input)) ([resultWrapper188505 input] (clojure.core/let [rawinput188504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188506 {"nextToken" (rawinput188504 "nextToken"), "threatIntelSetIds" (rawinput188504 "threatIntelSetIds")}] (clojure.core/cond-> {} (letvar188506 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188506 ["nextToken"]))) (letvar188506 "threatIntelSetIds") (clojure.core/assoc :threat-intel-set-ids (deser-threat-intel-set-ids (clojure.core/get-in letvar188506 ["threatIntelSetIds"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper188508 input] (clojure.core/let [rawinput188507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188509 {"unprocessedAccounts" (rawinput188507 "unprocessedAccounts")}] (clojure.core/cond-> {} (letvar188509 "unprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-unprocessed-accounts (clojure.core/get-in letvar188509 ["unprocessedAccounts"])))))))

(clojure.core/defn- response-create-sample-findings-response ([input] (response-create-sample-findings-response nil input)) ([resultWrapper188511 input] (clojure.core/let [rawinput188510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188512 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-filters-response ([input] (response-list-filters-response nil input)) ([resultWrapper188514 input] (clojure.core/let [rawinput188513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188515 {"filterNames" (rawinput188513 "filterNames"), "nextToken" (rawinput188513 "nextToken")}] (clojure.core/cond-> {} (letvar188515 "filterNames") (clojure.core/assoc :filter-names (deser-filter-names (clojure.core/get-in letvar188515 ["filterNames"]))) (letvar188515 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188515 ["nextToken"])))))))

(clojure.core/defn- response-get-filter-response ([input] (response-get-filter-response nil input)) ([resultWrapper188517 input] (clojure.core/let [rawinput188516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188518 {"action" (rawinput188516 "action"), "description" (rawinput188516 "description"), "findingCriteria" (rawinput188516 "findingCriteria"), "name" (rawinput188516 "name"), "rank" (rawinput188516 "rank")}] (clojure.core/cond-> {} (letvar188518 "action") (clojure.core/assoc :action (deser-filter-action (clojure.core/get-in letvar188518 ["action"]))) (letvar188518 "description") (clojure.core/assoc :description (deser-filter-description (clojure.core/get-in letvar188518 ["description"]))) (letvar188518 "findingCriteria") (clojure.core/assoc :finding-criteria (deser-finding-criteria (clojure.core/get-in letvar188518 ["findingCriteria"]))) (letvar188518 "name") (clojure.core/assoc :name (deser-filter-name (clojure.core/get-in letvar188518 ["name"]))) (letvar188518 "rank") (clojure.core/assoc :rank (deser-filter-rank (clojure.core/get-in letvar188518 ["rank"])))))))

(clojure.core/defn- response-update-detector-response ([input] (response-update-detector-response nil input)) ([resultWrapper188520 input] (clojure.core/let [rawinput188519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188521 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-ip-set-response ([input] (response-create-ip-set-response nil input)) ([resultWrapper188523 input] (clojure.core/let [rawinput188522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188524 {"ipSetId" (rawinput188522 "ipSetId")}] (clojure.core/cond-> {} (letvar188524 "ipSetId") (clojure.core/assoc :ip-set-id (deser-ip-set-id (clojure.core/get-in letvar188524 ["ipSetId"])))))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper188526 input] (clojure.core/let [rawinput188525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188527 {"members" (rawinput188525 "members"), "nextToken" (rawinput188525 "nextToken")}] (clojure.core/cond-> {} (letvar188527 "members") (clojure.core/assoc :members (deser-members (clojure.core/get-in letvar188527 ["members"]))) (letvar188527 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188527 ["nextToken"])))))))

(clojure.core/defn- response-list-ip-sets-response ([input] (response-list-ip-sets-response nil input)) ([resultWrapper188529 input] (clojure.core/let [rawinput188528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar188530 {"ipSetIds" (rawinput188528 "ipSetIds"), "nextToken" (rawinput188528 "nextToken")}] (clojure.core/cond-> {} (letvar188530 "ipSetIds") (clojure.core/assoc :ip-set-ids (deser-ip-set-ids (clojure.core/get-in letvar188530 ["ipSetIds"]))) (letvar188530 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar188530 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.guardduty/string-min-0-max-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
