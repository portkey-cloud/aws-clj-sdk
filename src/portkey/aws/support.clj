...
(clojure.core/defn- response-describe-trusted-advisor-check-summaries-response ([input] (response-describe-trusted-advisor-check-summaries-response nil input)) ([resultWrapper2102069 input] (clojure.core/let [rawinput2102068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102070 {"summaries" (rawinput2102068 "summaries")}] (clojure.core/cond-> {:summaries (deser-trusted-advisor-check-summary-list (clojure.core/get-in letvar2102070 ["summaries"]))}))))

(clojure.core/defn- response-add-attachments-to-set-response ([input] (response-add-attachments-to-set-response nil input)) ([resultWrapper2102072 input] (clojure.core/let [rawinput2102071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102073 {"attachmentSetId" (rawinput2102071 "attachmentSetId"), "expiryTime" (rawinput2102071 "expiryTime")}] (clojure.core/cond-> {} (letvar2102073 "attachmentSetId") (clojure.core/assoc :attachment-set-id (deser-attachment-set-id (clojure.core/get-in letvar2102073 ["attachmentSetId"]))) (letvar2102073 "expiryTime") (clojure.core/assoc :expiry-time (deser-expiry-time (clojure.core/get-in letvar2102073 ["expiryTime"])))))))

(clojure.core/defn- response-add-communication-to-case-response ([input] (response-add-communication-to-case-response nil input)) ([resultWrapper2102075 input] (clojure.core/let [rawinput2102074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102076 {"result" (rawinput2102074 "result")}] (clojure.core/cond-> {} (letvar2102076 "result") (clojure.core/assoc :result (deser-result (clojure.core/get-in letvar2102076 ["result"])))))))

(clojure.core/defn- response-attachment-set-size-limit-exceeded ([input] (response-attachment-set-size-limit-exceeded nil input)) ([resultWrapper2102078 input] (clojure.core/let [rawinput2102077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102079 {"message" (rawinput2102077 "message")}] (clojure.core/cond-> {} (letvar2102079 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102079 ["message"])))))))

(clojure.core/defn- response-describe-attachment-limit-exceeded ([input] (response-describe-attachment-limit-exceeded nil input)) ([resultWrapper2102081 input] (clojure.core/let [rawinput2102080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102082 {"message" (rawinput2102080 "message")}] (clojure.core/cond-> {} (letvar2102082 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102082 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-checks-response ([input] (response-describe-trusted-advisor-checks-response nil input)) ([resultWrapper2102084 input] (clojure.core/let [rawinput2102083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102085 {"checks" (rawinput2102083 "checks")}] (clojure.core/cond-> {:checks (deser-trusted-advisor-check-list (clojure.core/get-in letvar2102085 ["checks"]))}))))

(clojure.core/defn- response-create-case-response ([input] (response-create-case-response nil input)) ([resultWrapper2102087 input] (clojure.core/let [rawinput2102086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102088 {"caseId" (rawinput2102086 "caseId")}] (clojure.core/cond-> {} (letvar2102088 "caseId") (clojure.core/assoc :case-id (deser-case-id (clojure.core/get-in letvar2102088 ["caseId"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-refresh-statuses-response ([input] (response-describe-trusted-advisor-check-refresh-statuses-response nil input)) ([resultWrapper2102090 input] (clojure.core/let [rawinput2102089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102091 {"statuses" (rawinput2102089 "statuses")}] (clojure.core/cond-> {:statuses (deser-trusted-advisor-check-refresh-status-list (clojure.core/get-in letvar2102091 ["statuses"]))}))))

(clojure.core/defn- response-attachment-set-expired ([input] (response-attachment-set-expired nil input)) ([resultWrapper2102093 input] (clojure.core/let [rawinput2102092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102094 {"message" (rawinput2102092 "message")}] (clojure.core/cond-> {} (letvar2102094 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102094 ["message"])))))))

(clojure.core/defn- response-describe-services-response ([input] (response-describe-services-response nil input)) ([resultWrapper2102096 input] (clojure.core/let [rawinput2102095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102097 {"services" (rawinput2102095 "services")}] (clojure.core/cond-> {} (letvar2102097 "services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar2102097 ["services"])))))))

(clojure.core/defn- response-refresh-trusted-advisor-check-response ([input] (response-refresh-trusted-advisor-check-response nil input)) ([resultWrapper2102099 input] (clojure.core/let [rawinput2102098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102100 {"status" (rawinput2102098 "status")}] (clojure.core/cond-> {:status (deser-trusted-advisor-check-refresh-status (clojure.core/get-in letvar2102100 ["status"]))}))))

(clojure.core/defn- response-case-id-not-found ([input] (response-case-id-not-found nil input)) ([resultWrapper2102102 input] (clojure.core/let [rawinput2102101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102103 {"message" (rawinput2102101 "message")}] (clojure.core/cond-> {} (letvar2102103 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102103 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-result-response ([input] (response-describe-trusted-advisor-check-result-response nil input)) ([resultWrapper2102105 input] (clojure.core/let [rawinput2102104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102106 {"result" (rawinput2102104 "result")}] (clojure.core/cond-> {} (letvar2102106 "result") (clojure.core/assoc :result (deser-trusted-advisor-check-result (clojure.core/get-in letvar2102106 ["result"])))))))

(clojure.core/defn- response-describe-communications-response ([input] (response-describe-communications-response nil input)) ([resultWrapper2102108 input] (clojure.core/let [rawinput2102107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102109 {"communications" (rawinput2102107 "communications"), "nextToken" (rawinput2102107 "nextToken")}] (clojure.core/cond-> {} (letvar2102109 "communications") (clojure.core/assoc :communications (deser-communication-list (clojure.core/get-in letvar2102109 ["communications"]))) (letvar2102109 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2102109 ["nextToken"])))))))

(clojure.core/defn- response-attachment-id-not-found ([input] (response-attachment-id-not-found nil input)) ([resultWrapper2102111 input] (clojure.core/let [rawinput2102110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102112 {"message" (rawinput2102110 "message")}] (clojure.core/cond-> {} (letvar2102112 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102112 ["message"])))))))

(clojure.core/defn- response-resolve-case-response ([input] (response-resolve-case-response nil input)) ([resultWrapper2102114 input] (clojure.core/let [rawinput2102113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102115 {"initialCaseStatus" (rawinput2102113 "initialCaseStatus"), "finalCaseStatus" (rawinput2102113 "finalCaseStatus")}] (clojure.core/cond-> {} (letvar2102115 "initialCaseStatus") (clojure.core/assoc :initial-case-status (deser-case-status (clojure.core/get-in letvar2102115 ["initialCaseStatus"]))) (letvar2102115 "finalCaseStatus") (clojure.core/assoc :final-case-status (deser-case-status (clojure.core/get-in letvar2102115 ["finalCaseStatus"])))))))

(clojure.core/defn- response-attachment-limit-exceeded ([input] (response-attachment-limit-exceeded nil input)) ([resultWrapper2102117 input] (clojure.core/let [rawinput2102116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102118 {"message" (rawinput2102116 "message")}] (clojure.core/cond-> {} (letvar2102118 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102118 ["message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2102120 input] (clojure.core/let [rawinput2102119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102121 {"message" (rawinput2102119 "message")}] (clojure.core/cond-> {} (letvar2102121 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102121 ["message"])))))))

(clojure.core/defn- response-describe-severity-levels-response ([input] (response-describe-severity-levels-response nil input)) ([resultWrapper2102123 input] (clojure.core/let [rawinput2102122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102124 {"severityLevels" (rawinput2102122 "severityLevels")}] (clojure.core/cond-> {} (letvar2102124 "severityLevels") (clojure.core/assoc :severity-levels (deser-severity-levels-list (clojure.core/get-in letvar2102124 ["severityLevels"])))))))

(clojure.core/defn- response-describe-cases-response ([input] (response-describe-cases-response nil input)) ([resultWrapper2102126 input] (clojure.core/let [rawinput2102125 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102127 {"cases" (rawinput2102125 "cases"), "nextToken" (rawinput2102125 "nextToken")}] (clojure.core/cond-> {} (letvar2102127 "cases") (clojure.core/assoc :cases (deser-case-list (clojure.core/get-in letvar2102127 ["cases"]))) (letvar2102127 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2102127 ["nextToken"])))))))

(clojure.core/defn- response-describe-attachment-response ([input] (response-describe-attachment-response nil input)) ([resultWrapper2102129 input] (clojure.core/let [rawinput2102128 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102130 {"attachment" (rawinput2102128 "attachment")}] (clojure.core/cond-> {} (letvar2102130 "attachment") (clojure.core/assoc :attachment (deser-attachment (clojure.core/get-in letvar2102130 ["attachment"])))))))

(clojure.core/defn- response-attachment-set-id-not-found ([input] (response-attachment-set-id-not-found nil input)) ([resultWrapper2102132 input] (clojure.core/let [rawinput2102131 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102133 {"message" (rawinput2102131 "message")}] (clojure.core/cond-> {} (letvar2102133 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102133 ["message"])))))))

(clojure.core/defn- response-case-creation-limit-exceeded ([input] (response-case-creation-limit-exceeded nil input)) ([resultWrapper2102135 input] (clojure.core/let [rawinput2102134 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2102136 {"message" (rawinput2102134 "message")}] (clojure.core/cond-> {} (letvar2102136 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2102136 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.support/communication-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8000))))
