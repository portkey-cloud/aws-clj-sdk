...
(clojure.core/defn- response-describe-trusted-advisor-check-summaries-response ([input] (response-describe-trusted-advisor-check-summaries-response nil input)) ([resultWrapper1825171 input] (clojure.core/let [rawinput1825170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825172 {"summaries" (rawinput1825170 "summaries")}] (clojure.core/cond-> {:summaries (deser-trusted-advisor-check-summary-list (clojure.core/get-in letvar1825172 ["summaries"]))}))))

(clojure.core/defn- response-add-attachments-to-set-response ([input] (response-add-attachments-to-set-response nil input)) ([resultWrapper1825174 input] (clojure.core/let [rawinput1825173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825175 {"attachmentSetId" (rawinput1825173 "attachmentSetId"), "expiryTime" (rawinput1825173 "expiryTime")}] (clojure.core/cond-> {} (letvar1825175 "attachmentSetId") (clojure.core/assoc :attachment-set-id (deser-attachment-set-id (clojure.core/get-in letvar1825175 ["attachmentSetId"]))) (letvar1825175 "expiryTime") (clojure.core/assoc :expiry-time (deser-expiry-time (clojure.core/get-in letvar1825175 ["expiryTime"])))))))

(clojure.core/defn- response-add-communication-to-case-response ([input] (response-add-communication-to-case-response nil input)) ([resultWrapper1825177 input] (clojure.core/let [rawinput1825176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825178 {"result" (rawinput1825176 "result")}] (clojure.core/cond-> {} (letvar1825178 "result") (clojure.core/assoc :result (deser-result (clojure.core/get-in letvar1825178 ["result"])))))))

(clojure.core/defn- response-attachment-set-size-limit-exceeded ([input] (response-attachment-set-size-limit-exceeded nil input)) ([resultWrapper1825180 input] (clojure.core/let [rawinput1825179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825181 {"message" (rawinput1825179 "message")}] (clojure.core/cond-> {} (letvar1825181 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825181 ["message"])))))))

(clojure.core/defn- response-describe-attachment-limit-exceeded ([input] (response-describe-attachment-limit-exceeded nil input)) ([resultWrapper1825183 input] (clojure.core/let [rawinput1825182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825184 {"message" (rawinput1825182 "message")}] (clojure.core/cond-> {} (letvar1825184 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825184 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-checks-response ([input] (response-describe-trusted-advisor-checks-response nil input)) ([resultWrapper1825186 input] (clojure.core/let [rawinput1825185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825187 {"checks" (rawinput1825185 "checks")}] (clojure.core/cond-> {:checks (deser-trusted-advisor-check-list (clojure.core/get-in letvar1825187 ["checks"]))}))))

(clojure.core/defn- response-create-case-response ([input] (response-create-case-response nil input)) ([resultWrapper1825189 input] (clojure.core/let [rawinput1825188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825190 {"caseId" (rawinput1825188 "caseId")}] (clojure.core/cond-> {} (letvar1825190 "caseId") (clojure.core/assoc :case-id (deser-case-id (clojure.core/get-in letvar1825190 ["caseId"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-refresh-statuses-response ([input] (response-describe-trusted-advisor-check-refresh-statuses-response nil input)) ([resultWrapper1825192 input] (clojure.core/let [rawinput1825191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825193 {"statuses" (rawinput1825191 "statuses")}] (clojure.core/cond-> {:statuses (deser-trusted-advisor-check-refresh-status-list (clojure.core/get-in letvar1825193 ["statuses"]))}))))

(clojure.core/defn- response-attachment-set-expired ([input] (response-attachment-set-expired nil input)) ([resultWrapper1825195 input] (clojure.core/let [rawinput1825194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825196 {"message" (rawinput1825194 "message")}] (clojure.core/cond-> {} (letvar1825196 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825196 ["message"])))))))

(clojure.core/defn- response-describe-services-response ([input] (response-describe-services-response nil input)) ([resultWrapper1825198 input] (clojure.core/let [rawinput1825197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825199 {"services" (rawinput1825197 "services")}] (clojure.core/cond-> {} (letvar1825199 "services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1825199 ["services"])))))))

(clojure.core/defn- response-refresh-trusted-advisor-check-response ([input] (response-refresh-trusted-advisor-check-response nil input)) ([resultWrapper1825201 input] (clojure.core/let [rawinput1825200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825202 {"status" (rawinput1825200 "status")}] (clojure.core/cond-> {:status (deser-trusted-advisor-check-refresh-status (clojure.core/get-in letvar1825202 ["status"]))}))))

(clojure.core/defn- response-case-id-not-found ([input] (response-case-id-not-found nil input)) ([resultWrapper1825204 input] (clojure.core/let [rawinput1825203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825205 {"message" (rawinput1825203 "message")}] (clojure.core/cond-> {} (letvar1825205 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825205 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-result-response ([input] (response-describe-trusted-advisor-check-result-response nil input)) ([resultWrapper1825207 input] (clojure.core/let [rawinput1825206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825208 {"result" (rawinput1825206 "result")}] (clojure.core/cond-> {} (letvar1825208 "result") (clojure.core/assoc :result (deser-trusted-advisor-check-result (clojure.core/get-in letvar1825208 ["result"])))))))

(clojure.core/defn- response-describe-communications-response ([input] (response-describe-communications-response nil input)) ([resultWrapper1825210 input] (clojure.core/let [rawinput1825209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825211 {"communications" (rawinput1825209 "communications"), "nextToken" (rawinput1825209 "nextToken")}] (clojure.core/cond-> {} (letvar1825211 "communications") (clojure.core/assoc :communications (deser-communication-list (clojure.core/get-in letvar1825211 ["communications"]))) (letvar1825211 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1825211 ["nextToken"])))))))

(clojure.core/defn- response-attachment-id-not-found ([input] (response-attachment-id-not-found nil input)) ([resultWrapper1825213 input] (clojure.core/let [rawinput1825212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825214 {"message" (rawinput1825212 "message")}] (clojure.core/cond-> {} (letvar1825214 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825214 ["message"])))))))

(clojure.core/defn- response-resolve-case-response ([input] (response-resolve-case-response nil input)) ([resultWrapper1825216 input] (clojure.core/let [rawinput1825215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825217 {"initialCaseStatus" (rawinput1825215 "initialCaseStatus"), "finalCaseStatus" (rawinput1825215 "finalCaseStatus")}] (clojure.core/cond-> {} (letvar1825217 "initialCaseStatus") (clojure.core/assoc :initial-case-status (deser-case-status (clojure.core/get-in letvar1825217 ["initialCaseStatus"]))) (letvar1825217 "finalCaseStatus") (clojure.core/assoc :final-case-status (deser-case-status (clojure.core/get-in letvar1825217 ["finalCaseStatus"])))))))

(clojure.core/defn- response-attachment-limit-exceeded ([input] (response-attachment-limit-exceeded nil input)) ([resultWrapper1825219 input] (clojure.core/let [rawinput1825218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825220 {"message" (rawinput1825218 "message")}] (clojure.core/cond-> {} (letvar1825220 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825220 ["message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1825222 input] (clojure.core/let [rawinput1825221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825223 {"message" (rawinput1825221 "message")}] (clojure.core/cond-> {} (letvar1825223 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825223 ["message"])))))))

(clojure.core/defn- response-describe-severity-levels-response ([input] (response-describe-severity-levels-response nil input)) ([resultWrapper1825225 input] (clojure.core/let [rawinput1825224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825226 {"severityLevels" (rawinput1825224 "severityLevels")}] (clojure.core/cond-> {} (letvar1825226 "severityLevels") (clojure.core/assoc :severity-levels (deser-severity-levels-list (clojure.core/get-in letvar1825226 ["severityLevels"])))))))

(clojure.core/defn- response-describe-cases-response ([input] (response-describe-cases-response nil input)) ([resultWrapper1825228 input] (clojure.core/let [rawinput1825227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825229 {"cases" (rawinput1825227 "cases"), "nextToken" (rawinput1825227 "nextToken")}] (clojure.core/cond-> {} (letvar1825229 "cases") (clojure.core/assoc :cases (deser-case-list (clojure.core/get-in letvar1825229 ["cases"]))) (letvar1825229 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1825229 ["nextToken"])))))))

(clojure.core/defn- response-describe-attachment-response ([input] (response-describe-attachment-response nil input)) ([resultWrapper1825231 input] (clojure.core/let [rawinput1825230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825232 {"attachment" (rawinput1825230 "attachment")}] (clojure.core/cond-> {} (letvar1825232 "attachment") (clojure.core/assoc :attachment (deser-attachment (clojure.core/get-in letvar1825232 ["attachment"])))))))

(clojure.core/defn- response-attachment-set-id-not-found ([input] (response-attachment-set-id-not-found nil input)) ([resultWrapper1825234 input] (clojure.core/let [rawinput1825233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825235 {"message" (rawinput1825233 "message")}] (clojure.core/cond-> {} (letvar1825235 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825235 ["message"])))))))

(clojure.core/defn- response-case-creation-limit-exceeded ([input] (response-case-creation-limit-exceeded nil input)) ([resultWrapper1825237 input] (clojure.core/let [rawinput1825236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1825238 {"message" (rawinput1825236 "message")}] (clojure.core/cond-> {} (letvar1825238 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1825238 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.support/communication-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8000))))
