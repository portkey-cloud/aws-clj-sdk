...
(clojure.core/defn- response-insufficient-cluster-capacity-fault ([input] (response-insufficient-cluster-capacity-fault nil input)) ([resultWrapper1658389 input] (clojure.core/let [rawinput1658388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658390 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-not-found-fault ([input] (response-node-not-found-fault nil input)) ([resultWrapper1658392 input] (clojure.core/let [rawinput1658391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658393 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-quota-for-customer-exceeded-fault ([input] (response-cluster-quota-for-customer-exceeded-fault nil input)) ([resultWrapper1658395 input] (clojure.core/let [rawinput1658394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658396 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-arn-fault ([input] (response-invalid-arn-fault nil input)) ([resultWrapper1658398 input] (clojure.core/let [rawinput1658397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658399 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reboot-node-response ([input] (response-reboot-node-response nil input)) ([resultWrapper1658401 input] (clojure.core/let [rawinput1658400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658402 {"Cluster" (rawinput1658400 "Cluster")}] (clojure.core/cond-> {} (letvar1658402 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658402 ["Cluster"])))))))

(clojure.core/defn- response-parameter-group-quota-exceeded-fault ([input] (response-parameter-group-quota-exceeded-fault nil input)) ([resultWrapper1658404 input] (clojure.core/let [rawinput1658403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658405 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-already-exists-fault ([input] (response-cluster-already-exists-fault nil input)) ([resultWrapper1658407 input] (clojure.core/let [rawinput1658406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658408 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1658410 input] (clojure.core/let [rawinput1658409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658411 {"Tags" (rawinput1658409 "Tags"), "NextToken" (rawinput1658409 "NextToken")}] (clojure.core/cond-> {} (letvar1658411 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1658411 ["Tags"]))) (letvar1658411 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658411 ["NextToken"])))))))

(clojure.core/defn- response-invalid-vpc-network-state-fault ([input] (response-invalid-vpc-network-state-fault nil input)) ([resultWrapper1658413 input] (clojure.core/let [rawinput1658412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658414 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-clusters-response ([input] (response-describe-clusters-response nil input)) ([resultWrapper1658416 input] (clojure.core/let [rawinput1658415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658417 {"NextToken" (rawinput1658415 "NextToken"), "Clusters" (rawinput1658415 "Clusters")}] (clojure.core/cond-> {} (letvar1658417 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658417 ["NextToken"]))) (letvar1658417 "Clusters") (clojure.core/assoc :clusters (deser-cluster-list (clojure.core/get-in letvar1658417 ["Clusters"])))))))

(clojure.core/defn- response-parameter-group-not-found-fault ([input] (response-parameter-group-not-found-fault nil input)) ([resultWrapper1658419 input] (clojure.core/let [rawinput1658418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658420 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-quota-per-resource-exceeded ([input] (response-tag-quota-per-resource-exceeded nil input)) ([resultWrapper1658422 input] (clojure.core/let [rawinput1658421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper1658425 input] (clojure.core/let [rawinput1658424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658426 {"Cluster" (rawinput1658424 "Cluster")}] (clojure.core/cond-> {} (letvar1658426 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658426 ["Cluster"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1658428 input] (clojure.core/let [rawinput1658427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658429 {"Tags" (rawinput1658427 "Tags")}] (clojure.core/cond-> {} (letvar1658429 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1658429 ["Tags"])))))))

(clojure.core/defn- response-describe-parameters-response ([input] (response-describe-parameters-response nil input)) ([resultWrapper1658431 input] (clojure.core/let [rawinput1658430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658432 {"NextToken" (rawinput1658430 "NextToken"), "Parameters" (rawinput1658430 "Parameters")}] (clojure.core/cond-> {} (letvar1658432 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658432 ["NextToken"]))) (letvar1658432 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar1658432 ["Parameters"])))))))

(clojure.core/defn- response-service-linked-role-not-found-fault ([input] (response-service-linked-role-not-found-fault nil input)) ([resultWrapper1658434 input] (clojure.core/let [rawinput1658433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658435 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper1658437 input] (clojure.core/let [rawinput1658436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658438 {"Cluster" (rawinput1658436 "Cluster")}] (clojure.core/cond-> {} (letvar1658438 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658438 ["Cluster"])))))))

(clojure.core/defn- response-subnet-quota-exceeded-fault ([input] (response-subnet-quota-exceeded-fault nil input)) ([resultWrapper1658440 input] (clojure.core/let [rawinput1658439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658441 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-subnet ([input] (response-invalid-subnet nil input)) ([resultWrapper1658443 input] (clojure.core/let [rawinput1658442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658444 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-subnet-group-response ([input] (response-delete-subnet-group-response nil input)) ([resultWrapper1658446 input] (clojure.core/let [rawinput1658445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658447 {"DeletionMessage" (rawinput1658445 "DeletionMessage")}] (clojure.core/cond-> {} (letvar1658447 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar1658447 ["DeletionMessage"])))))))

(clojure.core/defn- response-subnet-in-use ([input] (response-subnet-in-use nil input)) ([resultWrapper1658449 input] (clojure.core/let [rawinput1658448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658450 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-increase-replication-factor-response ([input] (response-increase-replication-factor-response nil input)) ([resultWrapper1658452 input] (clojure.core/let [rawinput1658451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658453 {"Cluster" (rawinput1658451 "Cluster")}] (clojure.core/cond-> {} (letvar1658453 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658453 ["Cluster"])))))))

(clojure.core/defn- response-describe-subnet-groups-response ([input] (response-describe-subnet-groups-response nil input)) ([resultWrapper1658455 input] (clojure.core/let [rawinput1658454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658456 {"NextToken" (rawinput1658454 "NextToken"), "SubnetGroups" (rawinput1658454 "SubnetGroups")}] (clojure.core/cond-> {} (letvar1658456 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658456 ["NextToken"]))) (letvar1658456 "SubnetGroups") (clojure.core/assoc :subnet-groups (deser-subnet-group-list (clojure.core/get-in letvar1658456 ["SubnetGroups"])))))))

(clojure.core/defn- response-subnet-group-already-exists-fault ([input] (response-subnet-group-already-exists-fault nil input)) ([resultWrapper1658458 input] (clojure.core/let [rawinput1658457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658459 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-not-found-fault ([input] (response-subnet-group-not-found-fault nil input)) ([resultWrapper1658461 input] (clojure.core/let [rawinput1658460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658462 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-parameter-group-already-exists-fault ([input] (response-parameter-group-already-exists-fault nil input)) ([resultWrapper1658464 input] (clojure.core/let [rawinput1658463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658465 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-customer-exceeded-fault ([input] (response-node-quota-for-customer-exceeded-fault nil input)) ([resultWrapper1658467 input] (clojure.core/let [rawinput1658466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658468 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decrease-replication-factor-response ([input] (response-decrease-replication-factor-response nil input)) ([resultWrapper1658470 input] (clojure.core/let [rawinput1658469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658471 {"Cluster" (rawinput1658469 "Cluster")}] (clojure.core/cond-> {} (letvar1658471 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658471 ["Cluster"])))))))

(clojure.core/defn- response-create-subnet-group-response ([input] (response-create-subnet-group-response nil input)) ([resultWrapper1658473 input] (clojure.core/let [rawinput1658472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658474 {"SubnetGroup" (rawinput1658472 "SubnetGroup")}] (clojure.core/cond-> {} (letvar1658474 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar1658474 ["SubnetGroup"])))))))

(clojure.core/defn- response-update-cluster-response ([input] (response-update-cluster-response nil input)) ([resultWrapper1658476 input] (clojure.core/let [rawinput1658475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658477 {"Cluster" (rawinput1658475 "Cluster")}] (clojure.core/cond-> {} (letvar1658477 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1658477 ["Cluster"])))))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper1658479 input] (clojure.core/let [rawinput1658478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658480 {"message" (rawinput1658478 "message")}] (clojure.core/cond-> {} (letvar1658480 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar1658480 ["message"])))))))

(clojure.core/defn- response-describe-default-parameters-response ([input] (response-describe-default-parameters-response nil input)) ([resultWrapper1658482 input] (clojure.core/let [rawinput1658481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658483 {"NextToken" (rawinput1658481 "NextToken"), "Parameters" (rawinput1658481 "Parameters")}] (clojure.core/cond-> {} (letvar1658483 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658483 ["NextToken"]))) (letvar1658483 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar1658483 ["Parameters"])))))))

(clojure.core/defn- response-update-parameter-group-response ([input] (response-update-parameter-group-response nil input)) ([resultWrapper1658485 input] (clojure.core/let [rawinput1658484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658486 {"ParameterGroup" (rawinput1658484 "ParameterGroup")}] (clojure.core/cond-> {} (letvar1658486 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar1658486 ["ParameterGroup"])))))))

(clojure.core/defn- response-invalid-cluster-state-fault ([input] (response-invalid-cluster-state-fault nil input)) ([resultWrapper1658488 input] (clojure.core/let [rawinput1658487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658489 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-cluster-exceeded-fault ([input] (response-node-quota-for-cluster-exceeded-fault nil input)) ([resultWrapper1658491 input] (clojure.core/let [rawinput1658490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658492 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-not-found-fault ([input] (response-cluster-not-found-fault nil input)) ([resultWrapper1658494 input] (clojure.core/let [rawinput1658493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658495 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-in-use-fault ([input] (response-subnet-group-in-use-fault nil input)) ([resultWrapper1658497 input] (clojure.core/let [rawinput1658496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658498 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-parameter-groups-response ([input] (response-describe-parameter-groups-response nil input)) ([resultWrapper1658500 input] (clojure.core/let [rawinput1658499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658501 {"NextToken" (rawinput1658499 "NextToken"), "ParameterGroups" (rawinput1658499 "ParameterGroups")}] (clojure.core/cond-> {} (letvar1658501 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658501 ["NextToken"]))) (letvar1658501 "ParameterGroups") (clojure.core/assoc :parameter-groups (deser-parameter-group-list (clojure.core/get-in letvar1658501 ["ParameterGroups"])))))))

(clojure.core/defn- response-subnet-group-quota-exceeded-fault ([input] (response-subnet-group-quota-exceeded-fault nil input)) ([resultWrapper1658503 input] (clojure.core/let [rawinput1658502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658504 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-not-found-fault ([input] (response-tag-not-found-fault nil input)) ([resultWrapper1658506 input] (clojure.core/let [rawinput1658505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658507 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subnet-group-response ([input] (response-update-subnet-group-response nil input)) ([resultWrapper1658509 input] (clojure.core/let [rawinput1658508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658510 {"SubnetGroup" (rawinput1658508 "SubnetGroup")}] (clojure.core/cond-> {} (letvar1658510 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar1658510 ["SubnetGroup"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1658512 input] (clojure.core/let [rawinput1658511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658513 {"message" (rawinput1658511 "message")}] (clojure.core/cond-> {} (letvar1658513 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar1658513 ["message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1658515 input] (clojure.core/let [rawinput1658514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658516 {"Tags" (rawinput1658514 "Tags")}] (clojure.core/cond-> {} (letvar1658516 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1658516 ["Tags"])))))))

(clojure.core/defn- response-delete-parameter-group-response ([input] (response-delete-parameter-group-response nil input)) ([resultWrapper1658518 input] (clojure.core/let [rawinput1658517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658519 {"DeletionMessage" (rawinput1658517 "DeletionMessage")}] (clojure.core/cond-> {} (letvar1658519 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar1658519 ["DeletionMessage"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1658521 input] (clojure.core/let [rawinput1658520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658522 {"NextToken" (rawinput1658520 "NextToken"), "Events" (rawinput1658520 "Events")}] (clojure.core/cond-> {} (letvar1658522 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1658522 ["NextToken"]))) (letvar1658522 "Events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1658522 ["Events"])))))))

(clojure.core/defn- response-invalid-parameter-group-state-fault ([input] (response-invalid-parameter-group-state-fault nil input)) ([resultWrapper1658524 input] (clojure.core/let [rawinput1658523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658525 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-parameter-group-response ([input] (response-create-parameter-group-response nil input)) ([resultWrapper1658527 input] (clojure.core/let [rawinput1658526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658528 {"ParameterGroup" (rawinput1658526 "ParameterGroup")}] (clojure.core/cond-> {} (letvar1658528 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar1658528 ["ParameterGroup"])))))))
