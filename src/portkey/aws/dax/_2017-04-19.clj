...
(clojure.core/defn list-tags ([list-tags-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-tags-request list-tags-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/list-tags-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/list-tags-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListTags", :http.request.spec/error-spec {"ClusterNotFoundFault" :portkey.aws.dax.-2017-04-19/cluster-not-found-fault, "InvalidARNFault" :portkey.aws.dax.-2017-04-19/invalid-arn-fault, "InvalidClusterStateFault" :portkey.aws.dax.-2017-04-19/invalid-cluster-state-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault, "InvalidParameterValueException" :portkey.aws.dax.-2017-04-19/invalid-parameter-value-exception, "InvalidParameterCombinationException" :portkey.aws.dax.-2017-04-19/invalid-parameter-combination-exception}})))))
...
(clojure.core/defn describe-subnet-groups ([] (describe-subnet-groups {})) ([describe-subnet-groups-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-describe-subnet-groups-request describe-subnet-groups-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/describe-subnet-groups-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/describe-subnet-groups-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeSubnetGroups", :http.request.spec/error-spec {"SubnetGroupNotFoundFault" :portkey.aws.dax.-2017-04-19/subnet-group-not-found-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault}})))))
