...
(clojure.core/defn- deser-insufficient-cluster-capacity-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-node-not-found-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-cluster-quota-for-customer-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-arn-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-reboot-node-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Cluster") (clojure.core/assoc :cluster (deser-cluster (input "Cluster")))))

(clojure.core/defn- deser-parameter-group-quota-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-cluster-already-exists-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-tags-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Tags") (clojure.core/assoc :tags (deser-tag-list (input "Tags"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-invalid-vpc-network-state-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-clusters-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "Clusters") (clojure.core/assoc :clusters (deser-cluster-list (input "Clusters")))))

(clojure.core/defn- deser-parameter-group-not-found-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tag-quota-per-resource-exceeded [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-tag-resource-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Tags") (clojure.core/assoc :tags (deser-tag-list (input "Tags")))))

(clojure.core/defn- deser-describe-parameters-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (input "Parameters")))))

(clojure.core/defn- deser-service-linked-role-not-found-fault [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-subnet-quota-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-subnet [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-subnet-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (input "DeletionMessage")))))

(clojure.core/defn- deser-subnet-in-use [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-increase-replication-factor-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Cluster") (clojure.core/assoc :cluster (deser-cluster (input "Cluster")))))

(clojure.core/defn- deser-describe-subnet-groups-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "SubnetGroups") (clojure.core/assoc :subnet-groups (deser-subnet-group-list (input "SubnetGroups")))))

(clojure.core/defn- deser-subnet-group-already-exists-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-subnet-group-not-found-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-parameter-group-already-exists-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-node-quota-for-customer-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-decrease-replication-factor-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Cluster") (clojure.core/assoc :cluster (deser-cluster (input "Cluster")))))

(clojure.core/defn- deser-create-subnet-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (input "SubnetGroup")))))

(clojure.core/defn- deser-update-cluster-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Cluster") (clojure.core/assoc :cluster (deser-cluster (input "Cluster")))))

(clojure.core/defn- deser-invalid-parameter-combination-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-aws-query-error-message (input "message")))))

(clojure.core/defn- deser-describe-default-parameters-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (input "Parameters")))))

(clojure.core/defn- deser-update-parameter-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (input "ParameterGroup")))))

(clojure.core/defn- deser-invalid-cluster-state-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-node-quota-for-cluster-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-cluster-not-found-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-subnet-group-in-use-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-parameter-groups-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "ParameterGroups") (clojure.core/assoc :parameter-groups (deser-parameter-group-list (input "ParameterGroups")))))

(clojure.core/defn- deser-subnet-group-quota-exceeded-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tag-not-found-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-subnet-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (input "SubnetGroup")))))

(clojure.core/defn- deser-invalid-parameter-value-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-aws-query-error-message (input "message")))))

(clojure.core/defn- deser-untag-resource-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Tags") (clojure.core/assoc :tags (deser-tag-list (input "Tags")))))

(clojure.core/defn- deser-delete-parameter-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (input "DeletionMessage")))))

(clojure.core/defn- deser-describe-events-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken"))) (clojure.core/contains? input "Events") (clojure.core/assoc :events (deser-event-list (input "Events")))))

(clojure.core/defn- deser-invalid-parameter-group-state-fault [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-parameter-group-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (input "ParameterGroup")))))
...
(clojure.core/defn describe-parameter-groups ([] (describe-parameter-groups {})) ([describe-parameter-groups-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-parameter-groups-request describe-parameter-groups-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.configuration/target-prefix "AmazonDAXV3", :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/describe-parameter-groups-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/describe-parameter-groups-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeParameterGroups", :http.request.configuration/output-deser-fn deser-describe-parameter-groups-response, :http.request.spec/error-spec {"ParameterGroupNotFoundFault" :portkey.aws.dax.-2017-04-19/parameter-group-not-found-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault, "InvalidParameterValueException" :portkey.aws.dax.-2017-04-19/invalid-parameter-value-exception, "InvalidParameterCombinationException" :portkey.aws.dax.-2017-04-19/invalid-parameter-combination-exception}})))))
...
(clojure.core/defn reboot-node ([reboot-node-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-reboot-node-request reboot-node-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.configuration/target-prefix "AmazonDAXV3", :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/reboot-node-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/reboot-node-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "RebootNode", :http.request.configuration/output-deser-fn deser-reboot-node-response, :http.request.spec/error-spec {"ClusterNotFoundFault" :portkey.aws.dax.-2017-04-19/cluster-not-found-fault, "NodeNotFoundFault" :portkey.aws.dax.-2017-04-19/node-not-found-fault, "InvalidClusterStateFault" :portkey.aws.dax.-2017-04-19/invalid-cluster-state-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault, "InvalidParameterValueException" :portkey.aws.dax.-2017-04-19/invalid-parameter-value-exception, "InvalidParameterCombinationException" :portkey.aws.dax.-2017-04-19/invalid-parameter-combination-exception}})))))
...
(clojure.core/defn update-parameter-group ([update-parameter-group-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-parameter-group-request update-parameter-group-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.configuration/target-prefix "AmazonDAXV3", :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/update-parameter-group-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/update-parameter-group-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateParameterGroup", :http.request.configuration/output-deser-fn deser-update-parameter-group-response, :http.request.spec/error-spec {"InvalidParameterGroupStateFault" :portkey.aws.dax.-2017-04-19/invalid-parameter-group-state-fault, "ParameterGroupNotFoundFault" :portkey.aws.dax.-2017-04-19/parameter-group-not-found-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault, "InvalidParameterValueException" :portkey.aws.dax.-2017-04-19/invalid-parameter-value-exception, "InvalidParameterCombinationException" :portkey.aws.dax.-2017-04-19/invalid-parameter-combination-exception}})))))
...
(clojure.core/defn decrease-replication-factor ([decrease-replication-factor-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-decrease-replication-factor-request decrease-replication-factor-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.configuration/target-prefix "AmazonDAXV3", :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/decrease-replication-factor-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/decrease-replication-factor-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DecreaseReplicationFactor", :http.request.configuration/output-deser-fn deser-decrease-replication-factor-response, :http.request.spec/error-spec {"ClusterNotFoundFault" :portkey.aws.dax.-2017-04-19/cluster-not-found-fault, "NodeNotFoundFault" :portkey.aws.dax.-2017-04-19/node-not-found-fault, "InvalidClusterStateFault" :portkey.aws.dax.-2017-04-19/invalid-cluster-state-fault, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault, "InvalidParameterValueException" :portkey.aws.dax.-2017-04-19/invalid-parameter-value-exception, "InvalidParameterCombinationException" :portkey.aws.dax.-2017-04-19/invalid-parameter-combination-exception}})))))
...
(clojure.core/defn create-subnet-group ([create-subnet-group-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-subnet-group-request create-subnet-group-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.dax.-2017-04-19/endpoints, :http.request.configuration/target-prefix "AmazonDAXV3", :http.request.spec/output-spec :portkey.aws.dax.-2017-04-19/create-subnet-group-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-04-19", :http.request.configuration/service-id "DAX", :http.request.spec/input-spec :portkey.aws.dax.-2017-04-19/create-subnet-group-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateSubnetGroup", :http.request.configuration/output-deser-fn deser-create-subnet-group-response, :http.request.spec/error-spec {"SubnetGroupAlreadyExistsFault" :portkey.aws.dax.-2017-04-19/subnet-group-already-exists-fault, "SubnetGroupQuotaExceededFault" :portkey.aws.dax.-2017-04-19/subnet-group-quota-exceeded-fault, "SubnetQuotaExceededFault" :portkey.aws.dax.-2017-04-19/subnet-quota-exceeded-fault, "InvalidSubnet" :portkey.aws.dax.-2017-04-19/invalid-subnet, "ServiceLinkedRoleNotFoundFault" :portkey.aws.dax.-2017-04-19/service-linked-role-not-found-fault}})))))
