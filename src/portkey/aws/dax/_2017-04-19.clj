...
(clojure.core/defn- response-insufficient-cluster-capacity-fault ([input] (response-insufficient-cluster-capacity-fault nil input)) ([resultWrapper517104 input] (clojure.core/let [rawinput517103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517105 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-not-found-fault ([input] (response-node-not-found-fault nil input)) ([resultWrapper517107 input] (clojure.core/let [rawinput517106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517108 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-quota-for-customer-exceeded-fault ([input] (response-cluster-quota-for-customer-exceeded-fault nil input)) ([resultWrapper517110 input] (clojure.core/let [rawinput517109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517111 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-arn-fault ([input] (response-invalid-arn-fault nil input)) ([resultWrapper517113 input] (clojure.core/let [rawinput517112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517114 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reboot-node-response ([input] (response-reboot-node-response nil input)) ([resultWrapper517116 input] (clojure.core/let [rawinput517115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517117 {"Cluster" (rawinput517115 "Cluster")}] (clojure.core/cond-> {} (letvar517117 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517117 ["Cluster"])))))))

(clojure.core/defn- response-parameter-group-quota-exceeded-fault ([input] (response-parameter-group-quota-exceeded-fault nil input)) ([resultWrapper517119 input] (clojure.core/let [rawinput517118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517120 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-already-exists-fault ([input] (response-cluster-already-exists-fault nil input)) ([resultWrapper517122 input] (clojure.core/let [rawinput517121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517123 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper517125 input] (clojure.core/let [rawinput517124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517126 {"Tags" (rawinput517124 "Tags"), "NextToken" (rawinput517124 "NextToken")}] (clojure.core/cond-> {} (letvar517126 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar517126 ["Tags"]))) (letvar517126 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517126 ["NextToken"])))))))

(clojure.core/defn- response-invalid-vpc-network-state-fault ([input] (response-invalid-vpc-network-state-fault nil input)) ([resultWrapper517128 input] (clojure.core/let [rawinput517127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517129 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-clusters-response ([input] (response-describe-clusters-response nil input)) ([resultWrapper517131 input] (clojure.core/let [rawinput517130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517132 {"NextToken" (rawinput517130 "NextToken"), "Clusters" (rawinput517130 "Clusters")}] (clojure.core/cond-> {} (letvar517132 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517132 ["NextToken"]))) (letvar517132 "Clusters") (clojure.core/assoc :clusters (deser-cluster-list (clojure.core/get-in letvar517132 ["Clusters"])))))))

(clojure.core/defn- response-parameter-group-not-found-fault ([input] (response-parameter-group-not-found-fault nil input)) ([resultWrapper517134 input] (clojure.core/let [rawinput517133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517135 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-quota-per-resource-exceeded ([input] (response-tag-quota-per-resource-exceeded nil input)) ([resultWrapper517137 input] (clojure.core/let [rawinput517136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517138 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper517140 input] (clojure.core/let [rawinput517139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517141 {"Cluster" (rawinput517139 "Cluster")}] (clojure.core/cond-> {} (letvar517141 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517141 ["Cluster"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper517143 input] (clojure.core/let [rawinput517142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517144 {"Tags" (rawinput517142 "Tags")}] (clojure.core/cond-> {} (letvar517144 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar517144 ["Tags"])))))))

(clojure.core/defn- response-describe-parameters-response ([input] (response-describe-parameters-response nil input)) ([resultWrapper517146 input] (clojure.core/let [rawinput517145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517147 {"NextToken" (rawinput517145 "NextToken"), "Parameters" (rawinput517145 "Parameters")}] (clojure.core/cond-> {} (letvar517147 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517147 ["NextToken"]))) (letvar517147 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar517147 ["Parameters"])))))))

(clojure.core/defn- response-service-linked-role-not-found-fault ([input] (response-service-linked-role-not-found-fault nil input)) ([resultWrapper517149 input] (clojure.core/let [rawinput517148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517150 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper517152 input] (clojure.core/let [rawinput517151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517153 {"Cluster" (rawinput517151 "Cluster")}] (clojure.core/cond-> {} (letvar517153 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517153 ["Cluster"])))))))

(clojure.core/defn- response-subnet-quota-exceeded-fault ([input] (response-subnet-quota-exceeded-fault nil input)) ([resultWrapper517155 input] (clojure.core/let [rawinput517154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517156 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-subnet ([input] (response-invalid-subnet nil input)) ([resultWrapper517158 input] (clojure.core/let [rawinput517157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517159 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-subnet-group-response ([input] (response-delete-subnet-group-response nil input)) ([resultWrapper517161 input] (clojure.core/let [rawinput517160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517162 {"DeletionMessage" (rawinput517160 "DeletionMessage")}] (clojure.core/cond-> {} (letvar517162 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar517162 ["DeletionMessage"])))))))

(clojure.core/defn- response-subnet-in-use ([input] (response-subnet-in-use nil input)) ([resultWrapper517164 input] (clojure.core/let [rawinput517163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517165 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-increase-replication-factor-response ([input] (response-increase-replication-factor-response nil input)) ([resultWrapper517167 input] (clojure.core/let [rawinput517166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517168 {"Cluster" (rawinput517166 "Cluster")}] (clojure.core/cond-> {} (letvar517168 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517168 ["Cluster"])))))))

(clojure.core/defn- response-describe-subnet-groups-response ([input] (response-describe-subnet-groups-response nil input)) ([resultWrapper517170 input] (clojure.core/let [rawinput517169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517171 {"NextToken" (rawinput517169 "NextToken"), "SubnetGroups" (rawinput517169 "SubnetGroups")}] (clojure.core/cond-> {} (letvar517171 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517171 ["NextToken"]))) (letvar517171 "SubnetGroups") (clojure.core/assoc :subnet-groups (deser-subnet-group-list (clojure.core/get-in letvar517171 ["SubnetGroups"])))))))

(clojure.core/defn- response-subnet-group-already-exists-fault ([input] (response-subnet-group-already-exists-fault nil input)) ([resultWrapper517173 input] (clojure.core/let [rawinput517172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517174 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-not-found-fault ([input] (response-subnet-group-not-found-fault nil input)) ([resultWrapper517176 input] (clojure.core/let [rawinput517175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517177 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-parameter-group-already-exists-fault ([input] (response-parameter-group-already-exists-fault nil input)) ([resultWrapper517179 input] (clojure.core/let [rawinput517178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517180 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-customer-exceeded-fault ([input] (response-node-quota-for-customer-exceeded-fault nil input)) ([resultWrapper517182 input] (clojure.core/let [rawinput517181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517183 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decrease-replication-factor-response ([input] (response-decrease-replication-factor-response nil input)) ([resultWrapper517185 input] (clojure.core/let [rawinput517184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517186 {"Cluster" (rawinput517184 "Cluster")}] (clojure.core/cond-> {} (letvar517186 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517186 ["Cluster"])))))))

(clojure.core/defn- response-create-subnet-group-response ([input] (response-create-subnet-group-response nil input)) ([resultWrapper517188 input] (clojure.core/let [rawinput517187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517189 {"SubnetGroup" (rawinput517187 "SubnetGroup")}] (clojure.core/cond-> {} (letvar517189 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar517189 ["SubnetGroup"])))))))

(clojure.core/defn- response-update-cluster-response ([input] (response-update-cluster-response nil input)) ([resultWrapper517191 input] (clojure.core/let [rawinput517190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517192 {"Cluster" (rawinput517190 "Cluster")}] (clojure.core/cond-> {} (letvar517192 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar517192 ["Cluster"])))))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper517194 input] (clojure.core/let [rawinput517193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517195 {"message" (rawinput517193 "message")}] (clojure.core/cond-> {} (letvar517195 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar517195 ["message"])))))))

(clojure.core/defn- response-describe-default-parameters-response ([input] (response-describe-default-parameters-response nil input)) ([resultWrapper517197 input] (clojure.core/let [rawinput517196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517198 {"NextToken" (rawinput517196 "NextToken"), "Parameters" (rawinput517196 "Parameters")}] (clojure.core/cond-> {} (letvar517198 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517198 ["NextToken"]))) (letvar517198 "Parameters") (clojure.core/assoc :parameters (deser-parameter-list (clojure.core/get-in letvar517198 ["Parameters"])))))))

(clojure.core/defn- response-update-parameter-group-response ([input] (response-update-parameter-group-response nil input)) ([resultWrapper517200 input] (clojure.core/let [rawinput517199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517201 {"ParameterGroup" (rawinput517199 "ParameterGroup")}] (clojure.core/cond-> {} (letvar517201 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar517201 ["ParameterGroup"])))))))

(clojure.core/defn- response-invalid-cluster-state-fault ([input] (response-invalid-cluster-state-fault nil input)) ([resultWrapper517203 input] (clojure.core/let [rawinput517202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517204 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-node-quota-for-cluster-exceeded-fault ([input] (response-node-quota-for-cluster-exceeded-fault nil input)) ([resultWrapper517206 input] (clojure.core/let [rawinput517205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517207 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-not-found-fault ([input] (response-cluster-not-found-fault nil input)) ([resultWrapper517209 input] (clojure.core/let [rawinput517208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517210 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-subnet-group-in-use-fault ([input] (response-subnet-group-in-use-fault nil input)) ([resultWrapper517212 input] (clojure.core/let [rawinput517211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517213 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-parameter-groups-response ([input] (response-describe-parameter-groups-response nil input)) ([resultWrapper517215 input] (clojure.core/let [rawinput517214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517216 {"NextToken" (rawinput517214 "NextToken"), "ParameterGroups" (rawinput517214 "ParameterGroups")}] (clojure.core/cond-> {} (letvar517216 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517216 ["NextToken"]))) (letvar517216 "ParameterGroups") (clojure.core/assoc :parameter-groups (deser-parameter-group-list (clojure.core/get-in letvar517216 ["ParameterGroups"])))))))

(clojure.core/defn- response-subnet-group-quota-exceeded-fault ([input] (response-subnet-group-quota-exceeded-fault nil input)) ([resultWrapper517218 input] (clojure.core/let [rawinput517217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517219 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-not-found-fault ([input] (response-tag-not-found-fault nil input)) ([resultWrapper517221 input] (clojure.core/let [rawinput517220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517222 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subnet-group-response ([input] (response-update-subnet-group-response nil input)) ([resultWrapper517224 input] (clojure.core/let [rawinput517223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517225 {"SubnetGroup" (rawinput517223 "SubnetGroup")}] (clojure.core/cond-> {} (letvar517225 "SubnetGroup") (clojure.core/assoc :subnet-group (deser-subnet-group (clojure.core/get-in letvar517225 ["SubnetGroup"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper517227 input] (clojure.core/let [rawinput517226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517228 {"message" (rawinput517226 "message")}] (clojure.core/cond-> {} (letvar517228 "message") (clojure.core/assoc :message (deser-aws-query-error-message (clojure.core/get-in letvar517228 ["message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper517230 input] (clojure.core/let [rawinput517229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517231 {"Tags" (rawinput517229 "Tags")}] (clojure.core/cond-> {} (letvar517231 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar517231 ["Tags"])))))))

(clojure.core/defn- response-delete-parameter-group-response ([input] (response-delete-parameter-group-response nil input)) ([resultWrapper517233 input] (clojure.core/let [rawinput517232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517234 {"DeletionMessage" (rawinput517232 "DeletionMessage")}] (clojure.core/cond-> {} (letvar517234 "DeletionMessage") (clojure.core/assoc :deletion-message (deser-string (clojure.core/get-in letvar517234 ["DeletionMessage"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper517236 input] (clojure.core/let [rawinput517235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517237 {"NextToken" (rawinput517235 "NextToken"), "Events" (rawinput517235 "Events")}] (clojure.core/cond-> {} (letvar517237 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar517237 ["NextToken"]))) (letvar517237 "Events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar517237 ["Events"])))))))

(clojure.core/defn- response-invalid-parameter-group-state-fault ([input] (response-invalid-parameter-group-state-fault nil input)) ([resultWrapper517239 input] (clojure.core/let [rawinput517238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517240 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-parameter-group-response ([input] (response-create-parameter-group-response nil input)) ([resultWrapper517242 input] (clojure.core/let [rawinput517241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar517243 {"ParameterGroup" (rawinput517241 "ParameterGroup")}] (clojure.core/cond-> {} (letvar517243 "ParameterGroup") (clojure.core/assoc :parameter-group (deser-parameter-group (clojure.core/get-in letvar517243 ["ParameterGroup"])))))))
