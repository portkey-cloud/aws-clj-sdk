...
(clojure.core/defn- response-delete-compute-environment-response ([input] (response-delete-compute-environment-response nil input)) ([resultWrapper151032 input] (clojure.core/let [rawinput151031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151033 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-job-queue-response ([input] (response-create-job-queue-response nil input)) ([resultWrapper151035 input] (clojure.core/let [rawinput151034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151036 {"jobQueueName" (rawinput151034 "jobQueueName"), "jobQueueArn" (rawinput151034 "jobQueueArn")}] (clojure.core/cond-> {:job-queue-name (deser-string (clojure.core/get-in letvar151036 ["jobQueueName"])), :job-queue-arn (deser-string (clojure.core/get-in letvar151036 ["jobQueueArn"]))}))))

(clojure.core/defn- response-cancel-job-response ([input] (response-cancel-job-response nil input)) ([resultWrapper151038 input] (clojure.core/let [rawinput151037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151039 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper151041 input] (clojure.core/let [rawinput151040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151042 {"message" (rawinput151040 "message")}] (clojure.core/cond-> {} (letvar151042 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar151042 ["message"])))))))

(clojure.core/defn- response-describe-compute-environments-response ([input] (response-describe-compute-environments-response nil input)) ([resultWrapper151044 input] (clojure.core/let [rawinput151043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151045 {"computeEnvironments" (rawinput151043 "computeEnvironments"), "nextToken" (rawinput151043 "nextToken")}] (clojure.core/cond-> {} (letvar151045 "computeEnvironments") (clojure.core/assoc :compute-environments (deser-compute-environment-detail-list (clojure.core/get-in letvar151045 ["computeEnvironments"]))) (letvar151045 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar151045 ["nextToken"])))))))

(clojure.core/defn- response-delete-job-queue-response ([input] (response-delete-job-queue-response nil input)) ([resultWrapper151047 input] (clojure.core/let [rawinput151046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151048 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deregister-job-definition-response ([input] (response-deregister-job-definition-response nil input)) ([resultWrapper151050 input] (clojure.core/let [rawinput151049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151051 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compute-environment-response ([input] (response-create-compute-environment-response nil input)) ([resultWrapper151053 input] (clojure.core/let [rawinput151052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151054 {"computeEnvironmentName" (rawinput151052 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput151052 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar151054 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar151054 ["computeEnvironmentName"]))) (letvar151054 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar151054 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-terminate-job-response ([input] (response-terminate-job-response nil input)) ([resultWrapper151056 input] (clojure.core/let [rawinput151055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151057 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-queues-response ([input] (response-describe-job-queues-response nil input)) ([resultWrapper151059 input] (clojure.core/let [rawinput151058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151060 {"jobQueues" (rawinput151058 "jobQueues"), "nextToken" (rawinput151058 "nextToken")}] (clojure.core/cond-> {} (letvar151060 "jobQueues") (clojure.core/assoc :job-queues (deser-job-queue-detail-list (clojure.core/get-in letvar151060 ["jobQueues"]))) (letvar151060 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar151060 ["nextToken"])))))))

(clojure.core/defn- response-update-compute-environment-response ([input] (response-update-compute-environment-response nil input)) ([resultWrapper151062 input] (clojure.core/let [rawinput151061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151063 {"computeEnvironmentName" (rawinput151061 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput151061 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar151063 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar151063 ["computeEnvironmentName"]))) (letvar151063 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar151063 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-submit-job-response ([input] (response-submit-job-response nil input)) ([resultWrapper151065 input] (clojure.core/let [rawinput151064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151066 {"jobName" (rawinput151064 "jobName"), "jobId" (rawinput151064 "jobId")}] (clojure.core/cond-> {:job-name (deser-string (clojure.core/get-in letvar151066 ["jobName"])), :job-id (deser-string (clojure.core/get-in letvar151066 ["jobId"]))}))))

(clojure.core/defn- response-describe-jobs-response ([input] (response-describe-jobs-response nil input)) ([resultWrapper151068 input] (clojure.core/let [rawinput151067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151069 {"jobs" (rawinput151067 "jobs")}] (clojure.core/cond-> {} (letvar151069 "jobs") (clojure.core/assoc :jobs (deser-job-detail-list (clojure.core/get-in letvar151069 ["jobs"])))))))

(clojure.core/defn- response-register-job-definition-response ([input] (response-register-job-definition-response nil input)) ([resultWrapper151071 input] (clojure.core/let [rawinput151070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151072 {"jobDefinitionName" (rawinput151070 "jobDefinitionName"), "jobDefinitionArn" (rawinput151070 "jobDefinitionArn"), "revision" (rawinput151070 "revision")}] (clojure.core/cond-> {:job-definition-name (deser-string (clojure.core/get-in letvar151072 ["jobDefinitionName"])), :job-definition-arn (deser-string (clojure.core/get-in letvar151072 ["jobDefinitionArn"])), :revision (deser-integer (clojure.core/get-in letvar151072 ["revision"]))}))))

(clojure.core/defn- response-describe-job-definitions-response ([input] (response-describe-job-definitions-response nil input)) ([resultWrapper151074 input] (clojure.core/let [rawinput151073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151075 {"jobDefinitions" (rawinput151073 "jobDefinitions"), "nextToken" (rawinput151073 "nextToken")}] (clojure.core/cond-> {} (letvar151075 "jobDefinitions") (clojure.core/assoc :job-definitions (deser-job-definition-list (clojure.core/get-in letvar151075 ["jobDefinitions"]))) (letvar151075 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar151075 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper151077 input] (clojure.core/let [rawinput151076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151078 {"message" (rawinput151076 "message")}] (clojure.core/cond-> {} (letvar151078 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar151078 ["message"])))))))

(clojure.core/defn- response-list-jobs-response ([input] (response-list-jobs-response nil input)) ([resultWrapper151080 input] (clojure.core/let [rawinput151079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151081 {"jobSummaryList" (rawinput151079 "jobSummaryList"), "nextToken" (rawinput151079 "nextToken")}] (clojure.core/cond-> {:job-summary-list (deser-job-summary-list (clojure.core/get-in letvar151081 ["jobSummaryList"]))} (letvar151081 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar151081 ["nextToken"])))))))

(clojure.core/defn- response-update-job-queue-response ([input] (response-update-job-queue-response nil input)) ([resultWrapper151083 input] (clojure.core/let [rawinput151082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar151084 {"jobQueueName" (rawinput151082 "jobQueueName"), "jobQueueArn" (rawinput151082 "jobQueueArn")}] (clojure.core/cond-> {} (letvar151084 "jobQueueName") (clojure.core/assoc :job-queue-name (deser-string (clojure.core/get-in letvar151084 ["jobQueueName"]))) (letvar151084 "jobQueueArn") (clojure.core/assoc :job-queue-arn (deser-string (clojure.core/get-in letvar151084 ["jobQueueArn"])))))))
