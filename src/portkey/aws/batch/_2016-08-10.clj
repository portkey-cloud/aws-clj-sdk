...
(clojure.core/defn- response-delete-compute-environment-response ([input] (response-delete-compute-environment-response nil input)) ([resultWrapper78779 input] (clojure.core/let [rawinput78778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78780 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-job-queue-response ([input] (response-create-job-queue-response nil input)) ([resultWrapper78782 input] (clojure.core/let [rawinput78781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78783 {"jobQueueName" (rawinput78781 "jobQueueName"), "jobQueueArn" (rawinput78781 "jobQueueArn")}] (clojure.core/cond-> {:job-queue-name (deser-string (clojure.core/get-in letvar78783 ["jobQueueName"])), :job-queue-arn (deser-string (clojure.core/get-in letvar78783 ["jobQueueArn"]))}))))

(clojure.core/defn- response-cancel-job-response ([input] (response-cancel-job-response nil input)) ([resultWrapper78785 input] (clojure.core/let [rawinput78784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78786 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper78788 input] (clojure.core/let [rawinput78787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78789 {"message" (rawinput78787 "message")}] (clojure.core/cond-> {} (letvar78789 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar78789 ["message"])))))))

(clojure.core/defn- response-describe-compute-environments-response ([input] (response-describe-compute-environments-response nil input)) ([resultWrapper78791 input] (clojure.core/let [rawinput78790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78792 {"computeEnvironments" (rawinput78790 "computeEnvironments"), "nextToken" (rawinput78790 "nextToken")}] (clojure.core/cond-> {} (letvar78792 "computeEnvironments") (clojure.core/assoc :compute-environments (deser-compute-environment-detail-list (clojure.core/get-in letvar78792 ["computeEnvironments"]))) (letvar78792 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar78792 ["nextToken"])))))))

(clojure.core/defn- response-delete-job-queue-response ([input] (response-delete-job-queue-response nil input)) ([resultWrapper78794 input] (clojure.core/let [rawinput78793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78795 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-deregister-job-definition-response ([input] (response-deregister-job-definition-response nil input)) ([resultWrapper78797 input] (clojure.core/let [rawinput78796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78798 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compute-environment-response ([input] (response-create-compute-environment-response nil input)) ([resultWrapper78800 input] (clojure.core/let [rawinput78799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78801 {"computeEnvironmentName" (rawinput78799 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput78799 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar78801 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar78801 ["computeEnvironmentName"]))) (letvar78801 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar78801 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-terminate-job-response ([input] (response-terminate-job-response nil input)) ([resultWrapper78803 input] (clojure.core/let [rawinput78802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78804 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-queues-response ([input] (response-describe-job-queues-response nil input)) ([resultWrapper78806 input] (clojure.core/let [rawinput78805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78807 {"jobQueues" (rawinput78805 "jobQueues"), "nextToken" (rawinput78805 "nextToken")}] (clojure.core/cond-> {} (letvar78807 "jobQueues") (clojure.core/assoc :job-queues (deser-job-queue-detail-list (clojure.core/get-in letvar78807 ["jobQueues"]))) (letvar78807 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar78807 ["nextToken"])))))))

(clojure.core/defn- response-update-compute-environment-response ([input] (response-update-compute-environment-response nil input)) ([resultWrapper78809 input] (clojure.core/let [rawinput78808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78810 {"computeEnvironmentName" (rawinput78808 "computeEnvironmentName"), "computeEnvironmentArn" (rawinput78808 "computeEnvironmentArn")}] (clojure.core/cond-> {} (letvar78810 "computeEnvironmentName") (clojure.core/assoc :compute-environment-name (deser-string (clojure.core/get-in letvar78810 ["computeEnvironmentName"]))) (letvar78810 "computeEnvironmentArn") (clojure.core/assoc :compute-environment-arn (deser-string (clojure.core/get-in letvar78810 ["computeEnvironmentArn"])))))))

(clojure.core/defn- response-submit-job-response ([input] (response-submit-job-response nil input)) ([resultWrapper78812 input] (clojure.core/let [rawinput78811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78813 {"jobName" (rawinput78811 "jobName"), "jobId" (rawinput78811 "jobId")}] (clojure.core/cond-> {:job-name (deser-string (clojure.core/get-in letvar78813 ["jobName"])), :job-id (deser-string (clojure.core/get-in letvar78813 ["jobId"]))}))))

(clojure.core/defn- response-describe-jobs-response ([input] (response-describe-jobs-response nil input)) ([resultWrapper78815 input] (clojure.core/let [rawinput78814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78816 {"jobs" (rawinput78814 "jobs")}] (clojure.core/cond-> {} (letvar78816 "jobs") (clojure.core/assoc :jobs (deser-job-detail-list (clojure.core/get-in letvar78816 ["jobs"])))))))

(clojure.core/defn- response-register-job-definition-response ([input] (response-register-job-definition-response nil input)) ([resultWrapper78818 input] (clojure.core/let [rawinput78817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78819 {"jobDefinitionName" (rawinput78817 "jobDefinitionName"), "jobDefinitionArn" (rawinput78817 "jobDefinitionArn"), "revision" (rawinput78817 "revision")}] (clojure.core/cond-> {:job-definition-name (deser-string (clojure.core/get-in letvar78819 ["jobDefinitionName"])), :job-definition-arn (deser-string (clojure.core/get-in letvar78819 ["jobDefinitionArn"])), :revision (deser-integer (clojure.core/get-in letvar78819 ["revision"]))}))))

(clojure.core/defn- response-describe-job-definitions-response ([input] (response-describe-job-definitions-response nil input)) ([resultWrapper78821 input] (clojure.core/let [rawinput78820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78822 {"jobDefinitions" (rawinput78820 "jobDefinitions"), "nextToken" (rawinput78820 "nextToken")}] (clojure.core/cond-> {} (letvar78822 "jobDefinitions") (clojure.core/assoc :job-definitions (deser-job-definition-list (clojure.core/get-in letvar78822 ["jobDefinitions"]))) (letvar78822 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar78822 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper78824 input] (clojure.core/let [rawinput78823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78825 {"message" (rawinput78823 "message")}] (clojure.core/cond-> {} (letvar78825 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar78825 ["message"])))))))

(clojure.core/defn- response-list-jobs-response ([input] (response-list-jobs-response nil input)) ([resultWrapper78827 input] (clojure.core/let [rawinput78826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78828 {"jobSummaryList" (rawinput78826 "jobSummaryList"), "nextToken" (rawinput78826 "nextToken")}] (clojure.core/cond-> {:job-summary-list (deser-job-summary-list (clojure.core/get-in letvar78828 ["jobSummaryList"]))} (letvar78828 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar78828 ["nextToken"])))))))

(clojure.core/defn- response-update-job-queue-response ([input] (response-update-job-queue-response nil input)) ([resultWrapper78830 input] (clojure.core/let [rawinput78829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar78831 {"jobQueueName" (rawinput78829 "jobQueueName"), "jobQueueArn" (rawinput78829 "jobQueueArn")}] (clojure.core/cond-> {} (letvar78831 "jobQueueName") (clojure.core/assoc :job-queue-name (deser-string (clojure.core/get-in letvar78831 ["jobQueueName"]))) (letvar78831 "jobQueueArn") (clojure.core/assoc :job-queue-arn (deser-string (clojure.core/get-in letvar78831 ["jobQueueArn"])))))))
