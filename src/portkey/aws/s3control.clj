(ns portkey.aws.s3control (:require [portkey.aws]))
...
(clojure.core/defn- deser-public-access-block-configuration [input] (clojure.core/let [letvar1641740 {"BlockPublicAcls" (portkey.aws/search-for-tag input "BlockPublicAcls" :flattened? nil :xmlAttribute? nil), "IgnorePublicAcls" (portkey.aws/search-for-tag input "IgnorePublicAcls" :flattened? nil :xmlAttribute? nil), "BlockPublicPolicy" (portkey.aws/search-for-tag input "BlockPublicPolicy" :flattened? nil :xmlAttribute? nil), "RestrictPublicBuckets" (portkey.aws/search-for-tag input "RestrictPublicBuckets" :flattened? nil :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar1641740 "BlockPublicAcls") (clojure.core/assoc :block-public-acls (deser-setting (clojure.core/get-in letvar1641740 ["BlockPublicAcls" :content]))) (letvar1641740 "IgnorePublicAcls") (clojure.core/assoc :ignore-public-acls (deser-setting (clojure.core/get-in letvar1641740 ["IgnorePublicAcls" :content]))) (letvar1641740 "BlockPublicPolicy") (clojure.core/assoc :block-public-policy (deser-setting (clojure.core/get-in letvar1641740 ["BlockPublicPolicy" :content]))) (letvar1641740 "RestrictPublicBuckets") (clojure.core/assoc :restrict-public-buckets (deser-setting (clojure.core/get-in letvar1641740 ["RestrictPublicBuckets" :content]))))))
...
(clojure.core/defn- response-no-such-public-access-block-configuration ([input] (response-no-such-public-access-block-configuration nil input)) ([resultWrapper1641747 input] (clojure.core/let [rawinput1641746 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1641748 {"Message" (portkey.aws/search-for-tag rawinput1641746 "Message" :flattened? nil :result-wrapper resultWrapper1641747)}] (clojure.core/cond-> {} (letvar1641748 "Message") (clojure.core/assoc :message (deser-no-such-public-access-block-configuration-message (clojure.core/get-in letvar1641748 ["Message" :content])))))))

(clojure.core/defn- response-get-public-access-block-output ([input] (response-get-public-access-block-output nil input)) ([resultWrapper1641750 input] (clojure.core/let [rawinput1641749 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar1641751 {"PublicAccessBlockConfiguration" (portkey.aws/search-for-tag rawinput1641749 "PublicAccessBlockConfiguration" :flattened? nil :result-wrapper resultWrapper1641750)}] (clojure.core/cond-> {} (letvar1641751 "PublicAccessBlockConfiguration") (clojure.core/assoc :public-access-block-configuration (deser-public-access-block-configuration (clojure.core/get-in letvar1641751 ["PublicAccessBlockConfiguration" :content])))))))

(clojure.spec.alpha/def :portkey.aws.s3control/setting clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.s3control.no-such-public-access-block-configuration/message (clojure.spec.alpha/and :portkey.aws.s3control/no-such-public-access-block-configuration-message))
(clojure.spec.alpha/def :portkey.aws.s3control/no-such-public-access-block-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.s3control.no-such-public-access-block-configuration/message]))

(clojure.spec.alpha/def :portkey.aws.s3control.public-access-block-configuration/block-public-acls (clojure.spec.alpha/and :portkey.aws.s3control/setting))
(clojure.spec.alpha/def :portkey.aws.s3control.public-access-block-configuration/ignore-public-acls (clojure.spec.alpha/and :portkey.aws.s3control/setting))
(clojure.spec.alpha/def :portkey.aws.s3control.public-access-block-configuration/block-public-policy (clojure.spec.alpha/and :portkey.aws.s3control/setting))
(clojure.spec.alpha/def :portkey.aws.s3control.public-access-block-configuration/restrict-public-buckets (clojure.spec.alpha/and :portkey.aws.s3control/setting))
(clojure.spec.alpha/def :portkey.aws.s3control/public-access-block-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.s3control.public-access-block-configuration/block-public-acls :portkey.aws.s3control.public-access-block-configuration/ignore-public-acls :portkey.aws.s3control.public-access-block-configuration/block-public-policy :portkey.aws.s3control.public-access-block-configuration/restrict-public-buckets]))

(clojure.spec.alpha/def :portkey.aws.s3control/delete-public-access-block-request (clojure.spec.alpha/keys :req-un [:portkey.aws.s3control/account-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.s3control/get-public-access-block-request (clojure.spec.alpha/keys :req-un [:portkey.aws.s3control/account-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.s3control/account-id (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.s3control/put-public-access-block-request (clojure.spec.alpha/keys :req-un [:portkey.aws.s3control/public-access-block-configuration :portkey.aws.s3control/account-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.s3control/no-such-public-access-block-configuration-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.s3control/get-public-access-block-output (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.s3control/public-access-block-configuration]))

(clojure.core/defn delete-public-access-block "Removes the Public Access Block configuration for an Amazon Web Services\naccount." ([delete-public-access-block-requestinput] (clojure.core/let [request-function-result__22119__auto__ (req-delete-public-access-block-request delete-public-access-block-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__22119__auto__ {:http.request.configuration/endpoints portkey.aws.s3control/endpoints, :http.request.configuration/target-prefix nil, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/v20180820/configuration/publicAccessBlock", :http.request.configuration/version "2018-08-20", :http.request.configuration/service-id "S3 Control", :http.request.spec/input-spec :portkey.aws.s3control/delete-public-access-block-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeletePublicAccessBlock", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__22118__auto__] {}), :http.request.spec/error-spec {}})))))
(clojure.spec.alpha/fdef delete-public-access-block :args (clojure.spec.alpha/tuple :portkey.aws.s3control/delete-public-access-block-request) :ret clojure.core/true?)

(clojure.core/defn get-public-access-block "Retrieves the Public Access Block configuration for an Amazon Web Services\naccount." ([get-public-access-block-requestinput] (clojure.core/let [request-function-result__22119__auto__ (req-get-public-access-block-request get-public-access-block-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__22119__auto__ {:http.request.configuration/endpoints portkey.aws.s3control/endpoints, :http.request.configuration/target-prefix nil, :http.request.spec/output-spec :portkey.aws.s3control/get-public-access-block-output, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/v20180820/configuration/publicAccessBlock", :http.request.configuration/version "2018-08-20", :http.request.configuration/service-id "S3 Control", :http.request.spec/input-spec :portkey.aws.s3control/get-public-access-block-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetPublicAccessBlock", :http.request.configuration/output-deser-fn response-get-public-access-block-output, :http.request.spec/error-spec {"NoSuchPublicAccessBlockConfiguration" :portkey.aws.s3control/no-such-public-access-block-configuration}})))))
(clojure.spec.alpha/fdef get-public-access-block :args (clojure.spec.alpha/tuple :portkey.aws.s3control/get-public-access-block-request) :ret (clojure.spec.alpha/and :portkey.aws.s3control/get-public-access-block-output))

(clojure.core/defn put-public-access-block "Creates or modifies the Public Access Block configuration for an Amazon Web\nServices account." ([put-public-access-block-requestinput] (clojure.core/let [request-function-result__22119__auto__ (req-put-public-access-block-request put-public-access-block-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__22119__auto__ {:http.request.configuration/endpoints portkey.aws.s3control/endpoints, :http.request.configuration/target-prefix nil, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/v20180820/configuration/publicAccessBlock", :http.request.configuration/version "2018-08-20", :http.request.configuration/service-id "S3 Control", :http.request.spec/input-spec :portkey.aws.s3control/put-public-access-block-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "PutPublicAccessBlock", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__22118__auto__] {}), :http.request.spec/error-spec {}})))))
(clojure.spec.alpha/fdef put-public-access-block :args (clojure.spec.alpha/tuple :portkey.aws.s3control/put-public-access-block-request) :ret clojure.core/true?)
