...
(clojure.core/defn- deser-health-check [input] (clojure.core/let [letvar44094 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "LinkedService" (portkey.aws/search-for-tag input "LinkedService" :flattened? false :xmlAttribute? nil), "HealthCheckConfig" (portkey.aws/search-for-tag input "HealthCheckConfig" :flattened? false :xmlAttribute? nil), "HealthCheckVersion" (portkey.aws/search-for-tag input "HealthCheckVersion" :flattened? false :xmlAttribute? nil), "CloudWatchAlarmConfiguration" (portkey.aws/search-for-tag input "CloudWatchAlarmConfiguration" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-health-check-id (clojure.core/get-in letvar44094 ["Id" :content])), :caller-reference (deser-health-check-nonce (clojure.core/get-in letvar44094 ["CallerReference" :content])), :health-check-config (deser-health-check-config (clojure.core/get-in letvar44094 ["HealthCheckConfig" :content])), :health-check-version (deser-health-check-version (clojure.core/get-in letvar44094 ["HealthCheckVersion" :content]))} (letvar44094 "LinkedService") (clojure.core/assoc :linked-service (deser-linked-service (clojure.core/get-in letvar44094 ["LinkedService" :content]))) (letvar44094 "CloudWatchAlarmConfiguration") (clojure.core/assoc :cloud-watch-alarm-configuration (deser-cloud-watch-alarm-configuration (clojure.core/get-in letvar44094 ["CloudWatchAlarmConfiguration" :content]))))))
...
(clojure.core/defn- deser-resource-tag-set [input] (clojure.core/let [letvar44221 {"ResourceType" (portkey.aws/search-for-tag input "ResourceType" :flattened? false :xmlAttribute? nil), "ResourceId" (portkey.aws/search-for-tag input "ResourceId" :flattened? false :xmlAttribute? nil), "Tags" (portkey.aws/search-for-tag input "Tags" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar44221 "ResourceType") (clojure.core/assoc :resource-type (deser-tag-resource-type (clojure.core/get-in letvar44221 ["ResourceType" :content]))) (letvar44221 "ResourceId") (clojure.core/assoc :resource-id (deser-tag-resource-id (clojure.core/get-in letvar44221 ["ResourceId" :content]))) (letvar44221 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar44221 ["Tags" :content]))))))
...
(clojure.core/defn- deser-alias-target [input] (clojure.core/let [letvar44327 {"HostedZoneId" (portkey.aws/search-for-tag input "HostedZoneId" :flattened? false :xmlAttribute? nil), "DNSName" (portkey.aws/search-for-tag input "DNSName" :flattened? false :xmlAttribute? nil), "EvaluateTargetHealth" (portkey.aws/search-for-tag input "EvaluateTargetHealth" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:hosted-zone-id (deser-resource-id (clojure.core/get-in letvar44327 ["HostedZoneId" :content])), :dns-name (deser-dns-name (clojure.core/get-in letvar44327 ["DNSName" :content])), :evaluate-target-health (deser-alias-health-enabled (clojure.core/get-in letvar44327 ["EvaluateTargetHealth" :content]))})))
...
(clojure.core/defn- deser-traffic-policy [input] (clojure.core/let [letvar44501 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Version" (portkey.aws/search-for-tag input "Version" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "Document" (portkey.aws/search-for-tag input "Document" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-traffic-policy-id (clojure.core/get-in letvar44501 ["Id" :content])), :version (deser-traffic-policy-version (clojure.core/get-in letvar44501 ["Version" :content])), :name (deser-traffic-policy-name (clojure.core/get-in letvar44501 ["Name" :content])), :type (deser-rr-type (clojure.core/get-in letvar44501 ["Type" :content])), :document (deser-traffic-policy-document (clojure.core/get-in letvar44501 ["Document" :content]))} (letvar44501 "Comment") (clojure.core/assoc :comment (deser-traffic-policy-comment (clojure.core/get-in letvar44501 ["Comment" :content]))))))
...
(clojure.core/defn- deser-dimension [input] (clojure.core/let [letvar44689 {"Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name (deser-dimension-field (clojure.core/get-in letvar44689 ["Name" :content])), :value (deser-dimension-field (clojure.core/get-in letvar44689 ["Value" :content]))})))
...
(clojure.core/defn- deser-linked-service [input] (clojure.core/let [letvar44812 {"ServicePrincipal" (portkey.aws/search-for-tag input "ServicePrincipal" :flattened? false :xmlAttribute? nil), "Description" (portkey.aws/search-for-tag input "Description" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar44812 "ServicePrincipal") (clojure.core/assoc :service-principal (deser-service-principal (clojure.core/get-in letvar44812 ["ServicePrincipal" :content]))) (letvar44812 "Description") (clojure.core/assoc :description (deser-resource-description (clojure.core/get-in letvar44812 ["Description" :content]))))))
...
(clojure.core/defn- deser-hosted-zone [input] (clojure.core/let [letvar44937 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Config" (portkey.aws/search-for-tag input "Config" :flattened? false :xmlAttribute? nil), "ResourceRecordSetCount" (portkey.aws/search-for-tag input "ResourceRecordSetCount" :flattened? false :xmlAttribute? nil), "LinkedService" (portkey.aws/search-for-tag input "LinkedService" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-resource-id (clojure.core/get-in letvar44937 ["Id" :content])), :name (deser-dns-name (clojure.core/get-in letvar44937 ["Name" :content])), :caller-reference (deser-nonce (clojure.core/get-in letvar44937 ["CallerReference" :content]))} (letvar44937 "Config") (clojure.core/assoc :config (deser-hosted-zone-config (clojure.core/get-in letvar44937 ["Config" :content]))) (letvar44937 "ResourceRecordSetCount") (clojure.core/assoc :resource-record-set-count (deser-hosted-zone-rr-set-count (clojure.core/get-in letvar44937 ["ResourceRecordSetCount" :content]))) (letvar44937 "LinkedService") (clojure.core/assoc :linked-service (deser-linked-service (clojure.core/get-in letvar44937 ["LinkedService" :content]))))))
...
(clojure.core/defn- deser-geo-location [input] (clojure.core/let [letvar45057 {"ContinentCode" (portkey.aws/search-for-tag input "ContinentCode" :flattened? false :xmlAttribute? nil), "CountryCode" (portkey.aws/search-for-tag input "CountryCode" :flattened? false :xmlAttribute? nil), "SubdivisionCode" (portkey.aws/search-for-tag input "SubdivisionCode" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar45057 "ContinentCode") (clojure.core/assoc :continent-code (deser-geo-location-continent-code (clojure.core/get-in letvar45057 ["ContinentCode" :content]))) (letvar45057 "CountryCode") (clojure.core/assoc :country-code (deser-geo-location-country-code (clojure.core/get-in letvar45057 ["CountryCode" :content]))) (letvar45057 "SubdivisionCode") (clojure.core/assoc :subdivision-code (deser-geo-location-subdivision-code (clojure.core/get-in letvar45057 ["SubdivisionCode" :content]))))))

(clojure.core/defn- deser-ip-address-cidr [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-health-check-config [input] (clojure.core/let [letvar45158 {"InsufficientDataHealthStatus" (portkey.aws/search-for-tag input "InsufficientDataHealthStatus" :flattened? false :xmlAttribute? nil), "SearchString" (portkey.aws/search-for-tag input "SearchString" :flattened? false :xmlAttribute? nil), "Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "FailureThreshold" (portkey.aws/search-for-tag input "FailureThreshold" :flattened? false :xmlAttribute? nil), "ChildHealthChecks" (portkey.aws/search-for-tag input "ChildHealthChecks" :flattened? false :xmlAttribute? nil), "Regions" (portkey.aws/search-for-tag input "Regions" :flattened? false :xmlAttribute? nil), "Port" (portkey.aws/search-for-tag input "Port" :flattened? false :xmlAttribute? nil), "IPAddress" (portkey.aws/search-for-tag input "IPAddress" :flattened? false :xmlAttribute? nil), "ResourcePath" (portkey.aws/search-for-tag input "ResourcePath" :flattened? false :xmlAttribute? nil), "AlarmIdentifier" (portkey.aws/search-for-tag input "AlarmIdentifier" :flattened? false :xmlAttribute? nil), "EnableSNI" (portkey.aws/search-for-tag input "EnableSNI" :flattened? false :xmlAttribute? nil), "MeasureLatency" (portkey.aws/search-for-tag input "MeasureLatency" :flattened? false :xmlAttribute? nil), "HealthThreshold" (portkey.aws/search-for-tag input "HealthThreshold" :flattened? false :xmlAttribute? nil), "RequestInterval" (portkey.aws/search-for-tag input "RequestInterval" :flattened? false :xmlAttribute? nil), "FullyQualifiedDomainName" (portkey.aws/search-for-tag input "FullyQualifiedDomainName" :flattened? false :xmlAttribute? nil), "Inverted" (portkey.aws/search-for-tag input "Inverted" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:type (deser-health-check-type (clojure.core/get-in letvar45158 ["Type" :content]))} (letvar45158 "InsufficientDataHealthStatus") (clojure.core/assoc :insufficient-data-health-status (deser-insufficient-data-health-status (clojure.core/get-in letvar45158 ["InsufficientDataHealthStatus" :content]))) (letvar45158 "SearchString") (clojure.core/assoc :search-string (deser-search-string (clojure.core/get-in letvar45158 ["SearchString" :content]))) (letvar45158 "FailureThreshold") (clojure.core/assoc :failure-threshold (deser-failure-threshold (clojure.core/get-in letvar45158 ["FailureThreshold" :content]))) (letvar45158 "ChildHealthChecks") (clojure.core/assoc :child-health-checks (deser-child-health-check-list (clojure.core/get-in letvar45158 ["ChildHealthChecks" :content]))) (letvar45158 "Regions") (clojure.core/assoc :regions (deser-health-check-region-list (clojure.core/get-in letvar45158 ["Regions" :content]))) (letvar45158 "Port") (clojure.core/assoc :port (deser-port (clojure.core/get-in letvar45158 ["Port" :content]))) (letvar45158 "IPAddress") (clojure.core/assoc :ip-address (deser-ip-address (clojure.core/get-in letvar45158 ["IPAddress" :content]))) (letvar45158 "ResourcePath") (clojure.core/assoc :resource-path (deser-resource-path (clojure.core/get-in letvar45158 ["ResourcePath" :content]))) (letvar45158 "AlarmIdentifier") (clojure.core/assoc :alarm-identifier (deser-alarm-identifier (clojure.core/get-in letvar45158 ["AlarmIdentifier" :content]))) (letvar45158 "EnableSNI") (clojure.core/assoc :enable-sni (deser-enable-sni (clojure.core/get-in letvar45158 ["EnableSNI" :content]))) (letvar45158 "MeasureLatency") (clojure.core/assoc :measure-latency (deser-measure-latency (clojure.core/get-in letvar45158 ["MeasureLatency" :content]))) (letvar45158 "HealthThreshold") (clojure.core/assoc :health-threshold (deser-health-threshold (clojure.core/get-in letvar45158 ["HealthThreshold" :content]))) (letvar45158 "RequestInterval") (clojure.core/assoc :request-interval (deser-request-interval (clojure.core/get-in letvar45158 ["RequestInterval" :content]))) (letvar45158 "FullyQualifiedDomainName") (clojure.core/assoc :fully-qualified-domain-name (deser-fully-qualified-domain-name (clojure.core/get-in letvar45158 ["FullyQualifiedDomainName" :content]))) (letvar45158 "Inverted") (clojure.core/assoc :inverted (deser-inverted (clojure.core/get-in letvar45158 ["Inverted" :content]))))))

(clojure.core/defn- deser-change-info [input] (clojure.core/let [letvar45254 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "SubmittedAt" (portkey.aws/search-for-tag input "SubmittedAt" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-resource-id (clojure.core/get-in letvar45254 ["Id" :content])), :status (deser-change-status (clojure.core/get-in letvar45254 ["Status" :content])), :submitted-at (deser-time-stamp (clojure.core/get-in letvar45254 ["SubmittedAt" :content]))} (letvar45254 "Comment") (clojure.core/assoc :comment (deser-resource-description (clojure.core/get-in letvar45254 ["Comment" :content]))))))
...
(clojure.core/defn- deser-geo-location-details [input] (clojure.core/let [letvar45384 {"ContinentCode" (portkey.aws/search-for-tag input "ContinentCode" :flattened? false :xmlAttribute? nil), "ContinentName" (portkey.aws/search-for-tag input "ContinentName" :flattened? false :xmlAttribute? nil), "CountryCode" (portkey.aws/search-for-tag input "CountryCode" :flattened? false :xmlAttribute? nil), "CountryName" (portkey.aws/search-for-tag input "CountryName" :flattened? false :xmlAttribute? nil), "SubdivisionCode" (portkey.aws/search-for-tag input "SubdivisionCode" :flattened? false :xmlAttribute? nil), "SubdivisionName" (portkey.aws/search-for-tag input "SubdivisionName" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar45384 "ContinentCode") (clojure.core/assoc :continent-code (deser-geo-location-continent-code (clojure.core/get-in letvar45384 ["ContinentCode" :content]))) (letvar45384 "ContinentName") (clojure.core/assoc :continent-name (deser-geo-location-continent-name (clojure.core/get-in letvar45384 ["ContinentName" :content]))) (letvar45384 "CountryCode") (clojure.core/assoc :country-code (deser-geo-location-country-code (clojure.core/get-in letvar45384 ["CountryCode" :content]))) (letvar45384 "CountryName") (clojure.core/assoc :country-name (deser-geo-location-country-name (clojure.core/get-in letvar45384 ["CountryName" :content]))) (letvar45384 "SubdivisionCode") (clojure.core/assoc :subdivision-code (deser-geo-location-subdivision-code (clojure.core/get-in letvar45384 ["SubdivisionCode" :content]))) (letvar45384 "SubdivisionName") (clojure.core/assoc :subdivision-name (deser-geo-location-subdivision-name (clojure.core/get-in letvar45384 ["SubdivisionName" :content]))))))
...
(clojure.core/defn- deser-health-check-observation [input] (clojure.core/let [letvar45545 {"Region" (portkey.aws/search-for-tag input "Region" :flattened? false :xmlAttribute? nil), "IPAddress" (portkey.aws/search-for-tag input "IPAddress" :flattened? false :xmlAttribute? nil), "StatusReport" (portkey.aws/search-for-tag input "StatusReport" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar45545 "Region") (clojure.core/assoc :region (deser-health-check-region (clojure.core/get-in letvar45545 ["Region" :content]))) (letvar45545 "IPAddress") (clojure.core/assoc :ip-address (deser-ip-address (clojure.core/get-in letvar45545 ["IPAddress" :content]))) (letvar45545 "StatusReport") (clojure.core/assoc :status-report (deser-status-report (clojure.core/get-in letvar45545 ["StatusReport" :content]))))))
...
(clojure.core/defn- deser-reusable-delegation-set-limit [input] (clojure.core/let [letvar45668 {"Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:type (deser-reusable-delegation-set-limit-type (clojure.core/get-in letvar45668 ["Type" :content])), :value (deser-limit-value (clojure.core/get-in letvar45668 ["Value" :content]))})))
...
(clojure.core/defn- deser-hosted-zone-limit [input] (clojure.core/let [letvar45796 {"Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:type (deser-hosted-zone-limit-type (clojure.core/get-in letvar45796 ["Type" :content])), :value (deser-limit-value (clojure.core/get-in letvar45796 ["Value" :content]))})))

(clojure.core/defn- deser-account-limit [input] (clojure.core/let [letvar45892 {"Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:type (deser-account-limit-type (clojure.core/get-in letvar45892 ["Type" :content])), :value (deser-limit-value (clojure.core/get-in letvar45892 ["Value" :content]))})))

(clojure.core/defn- deser-query-logging-config-id [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-query-logging-config [input] (clojure.core/let [letvar45993 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "HostedZoneId" (portkey.aws/search-for-tag input "HostedZoneId" :flattened? false :xmlAttribute? nil), "CloudWatchLogsLogGroupArn" (portkey.aws/search-for-tag input "CloudWatchLogsLogGroupArn" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-query-logging-config-id (clojure.core/get-in letvar45993 ["Id" :content])), :hosted-zone-id (deser-resource-id (clojure.core/get-in letvar45993 ["HostedZoneId" :content])), :cloud-watch-logs-log-group-arn (deser-cloud-watch-logs-log-group-arn (clojure.core/get-in letvar45993 ["CloudWatchLogsLogGroupArn" :content]))})))

(clojure.core/defn- deser-tag-value [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-delegation-set [input] (clojure.core/let [letvar46094 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "NameServers" (portkey.aws/search-for-tag input "NameServers" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name-servers (deser-delegation-set-name-servers (clojure.core/get-in letvar46094 ["NameServers" :content]))} (letvar46094 "Id") (clojure.core/assoc :id (deser-resource-id (clojure.core/get-in letvar46094 ["Id" :content]))) (letvar46094 "CallerReference") (clojure.core/assoc :caller-reference (deser-nonce (clojure.core/get-in letvar46094 ["CallerReference" :content]))))))
...
(clojure.core/defn- deser-traffic-policy-summary [input] (clojure.core/let [letvar46229 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "LatestVersion" (portkey.aws/search-for-tag input "LatestVersion" :flattened? false :xmlAttribute? nil), "TrafficPolicyCount" (portkey.aws/search-for-tag input "TrafficPolicyCount" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-traffic-policy-id (clojure.core/get-in letvar46229 ["Id" :content])), :name (deser-traffic-policy-name (clojure.core/get-in letvar46229 ["Name" :content])), :type (deser-rr-type (clojure.core/get-in letvar46229 ["Type" :content])), :latest-version (deser-traffic-policy-version (clojure.core/get-in letvar46229 ["LatestVersion" :content])), :traffic-policy-count (deser-traffic-policy-version (clojure.core/get-in letvar46229 ["TrafficPolicyCount" :content]))})))

(clojure.core/defn- deser-traffic-policy-instance [input] (clojure.core/let [letvar46325 {"TrafficPolicyVersion" (portkey.aws/search-for-tag input "TrafficPolicyVersion" :flattened? false :xmlAttribute? nil), "TTL" (portkey.aws/search-for-tag input "TTL" :flattened? false :xmlAttribute? nil), "TrafficPolicyType" (portkey.aws/search-for-tag input "TrafficPolicyType" :flattened? false :xmlAttribute? nil), "HostedZoneId" (portkey.aws/search-for-tag input "HostedZoneId" :flattened? false :xmlAttribute? nil), "TrafficPolicyId" (portkey.aws/search-for-tag input "TrafficPolicyId" :flattened? false :xmlAttribute? nil), "Message" (portkey.aws/search-for-tag input "Message" :flattened? false :xmlAttribute? nil), "State" (portkey.aws/search-for-tag input "State" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name (deser-dns-name (clojure.core/get-in letvar46325 ["Name" :content])), :traffic-policy-version (deser-traffic-policy-version (clojure.core/get-in letvar46325 ["TrafficPolicyVersion" :content])), :traffic-policy-id (deser-traffic-policy-id (clojure.core/get-in letvar46325 ["TrafficPolicyId" :content])), :state (deser-traffic-policy-instance-state (clojure.core/get-in letvar46325 ["State" :content])), :traffic-policy-type (deser-rr-type (clojure.core/get-in letvar46325 ["TrafficPolicyType" :content])), :ttl (deser-ttl (clojure.core/get-in letvar46325 ["TTL" :content])), :id (deser-traffic-policy-instance-id (clojure.core/get-in letvar46325 ["Id" :content])), :message (deser-message (clojure.core/get-in letvar46325 ["Message" :content])), :hosted-zone-id (deser-resource-id (clojure.core/get-in letvar46325 ["HostedZoneId" :content]))})))

(clojure.core/defn- deser-geo-location-country-name [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-resource-record [input] (clojure.core/let [letvar46426 {"Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:value (deser-r-data (clojure.core/get-in letvar46426 ["Value" :content]))})))
...
(clojure.core/defn- deser-hosted-zone-config [input] (clojure.core/let [letvar46529 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "PrivateZone" (portkey.aws/search-for-tag input "PrivateZone" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar46529 "Comment") (clojure.core/assoc :comment (deser-resource-description (clojure.core/get-in letvar46529 ["Comment" :content]))) (letvar46529 "PrivateZone") (clojure.core/assoc :private-zone (deser-is-private-zone (clojure.core/get-in letvar46529 ["PrivateZone" :content]))))))
...
(clojure.core/defn- deser-alarm-identifier [input] (clojure.core/let [letvar46669 {"Region" (portkey.aws/search-for-tag input "Region" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:region (deser-cloud-watch-region (clojure.core/get-in letvar46669 ["Region" :content])), :name (deser-alarm-name (clojure.core/get-in letvar46669 ["Name" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar46820 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar46820 "Key") (clojure.core/assoc :key (deser-tag-key (clojure.core/get-in letvar46820 ["Key" :content]))) (letvar46820 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar46820 ["Value" :content]))))))
...
(clojure.core/defn- deser-resource-record-set [input] (clojure.core/let [letvar46976 {"AliasTarget" (portkey.aws/search-for-tag input "AliasTarget" :flattened? false :xmlAttribute? nil), "Type" (portkey.aws/search-for-tag input "Type" :flattened? false :xmlAttribute? nil), "GeoLocation" (portkey.aws/search-for-tag input "GeoLocation" :flattened? false :xmlAttribute? nil), "TTL" (portkey.aws/search-for-tag input "TTL" :flattened? false :xmlAttribute? nil), "SetIdentifier" (portkey.aws/search-for-tag input "SetIdentifier" :flattened? false :xmlAttribute? nil), "Weight" (portkey.aws/search-for-tag input "Weight" :flattened? false :xmlAttribute? nil), "HealthCheckId" (portkey.aws/search-for-tag input "HealthCheckId" :flattened? false :xmlAttribute? nil), "MultiValueAnswer" (portkey.aws/search-for-tag input "MultiValueAnswer" :flattened? false :xmlAttribute? nil), "ResourceRecords" (portkey.aws/search-for-tag input "ResourceRecords" :flattened? false :xmlAttribute? nil), "Failover" (portkey.aws/search-for-tag input "Failover" :flattened? false :xmlAttribute? nil), "TrafficPolicyInstanceId" (portkey.aws/search-for-tag input "TrafficPolicyInstanceId" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Region" (portkey.aws/search-for-tag input "Region" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name (deser-dns-name (clojure.core/get-in letvar46976 ["Name" :content])), :type (deser-rr-type (clojure.core/get-in letvar46976 ["Type" :content]))} (letvar46976 "AliasTarget") (clojure.core/assoc :alias-target (deser-alias-target (clojure.core/get-in letvar46976 ["AliasTarget" :content]))) (letvar46976 "GeoLocation") (clojure.core/assoc :geo-location (deser-geo-location (clojure.core/get-in letvar46976 ["GeoLocation" :content]))) (letvar46976 "TTL") (clojure.core/assoc :ttl (deser-ttl (clojure.core/get-in letvar46976 ["TTL" :content]))) (letvar46976 "SetIdentifier") (clojure.core/assoc :set-identifier (deser-resource-record-set-identifier (clojure.core/get-in letvar46976 ["SetIdentifier" :content]))) (letvar46976 "Weight") (clojure.core/assoc :weight (deser-resource-record-set-weight (clojure.core/get-in letvar46976 ["Weight" :content]))) (letvar46976 "HealthCheckId") (clojure.core/assoc :health-check-id (deser-health-check-id (clojure.core/get-in letvar46976 ["HealthCheckId" :content]))) (letvar46976 "MultiValueAnswer") (clojure.core/assoc :multi-value-answer (deser-resource-record-set-multi-value-answer (clojure.core/get-in letvar46976 ["MultiValueAnswer" :content]))) (letvar46976 "ResourceRecords") (clojure.core/assoc :resource-records (deser-resource-records (clojure.core/get-in letvar46976 ["ResourceRecords" :content]))) (letvar46976 "Failover") (clojure.core/assoc :failover (deser-resource-record-set-failover (clojure.core/get-in letvar46976 ["Failover" :content]))) (letvar46976 "TrafficPolicyInstanceId") (clojure.core/assoc :traffic-policy-instance-id (deser-traffic-policy-instance-id (clojure.core/get-in letvar46976 ["TrafficPolicyInstanceId" :content]))) (letvar46976 "Region") (clojure.core/assoc :region (deser-resource-record-set-region (clojure.core/get-in letvar46976 ["Region" :content]))))))
...
(clojure.core/defn- deser-cloud-watch-alarm-configuration [input] (clojure.core/let [letvar47081 {"EvaluationPeriods" (portkey.aws/search-for-tag input "EvaluationPeriods" :flattened? false :xmlAttribute? nil), "Threshold" (portkey.aws/search-for-tag input "Threshold" :flattened? false :xmlAttribute? nil), "ComparisonOperator" (portkey.aws/search-for-tag input "ComparisonOperator" :flattened? false :xmlAttribute? nil), "Period" (portkey.aws/search-for-tag input "Period" :flattened? false :xmlAttribute? nil), "MetricName" (portkey.aws/search-for-tag input "MetricName" :flattened? false :xmlAttribute? nil), "Namespace" (portkey.aws/search-for-tag input "Namespace" :flattened? false :xmlAttribute? nil), "Statistic" (portkey.aws/search-for-tag input "Statistic" :flattened? false :xmlAttribute? nil), "Dimensions" (portkey.aws/search-for-tag input "Dimensions" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:evaluation-periods (deser-evaluation-periods (clojure.core/get-in letvar47081 ["EvaluationPeriods" :content])), :threshold (deser-threshold (clojure.core/get-in letvar47081 ["Threshold" :content])), :comparison-operator (deser-comparison-operator (clojure.core/get-in letvar47081 ["ComparisonOperator" :content])), :period (deser-period (clojure.core/get-in letvar47081 ["Period" :content])), :metric-name (deser-metric-name (clojure.core/get-in letvar47081 ["MetricName" :content])), :namespace (deser-namespace (clojure.core/get-in letvar47081 ["Namespace" :content])), :statistic (deser-statistic (clojure.core/get-in letvar47081 ["Statistic" :content]))} (letvar47081 "Dimensions") (clojure.core/assoc :dimensions (deser-dimension-list (clojure.core/get-in letvar47081 ["Dimensions" :content]))))))
...
(clojure.core/defn- deser-status-report [input] (clojure.core/let [letvar47187 {"Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CheckedTime" (portkey.aws/search-for-tag input "CheckedTime" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar47187 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar47187 ["Status" :content]))) (letvar47187 "CheckedTime") (clojure.core/assoc :checked-time (deser-time-stamp (clojure.core/get-in letvar47187 ["CheckedTime" :content]))))))

(clojure.core/defn- deser-vpc [input] (clojure.core/let [letvar47283 {"VPCRegion" (portkey.aws/search-for-tag input "VPCRegion" :flattened? false :xmlAttribute? nil), "VPCId" (portkey.aws/search-for-tag input "VPCId" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar47283 "VPCRegion") (clojure.core/assoc :vpc-region (deser-vpc-region (clojure.core/get-in letvar47283 ["VPCRegion" :content]))) (letvar47283 "VPCId") (clojure.core/assoc :vpc-id (deser-vpc-id (clojure.core/get-in letvar47283 ["VPCId" :content]))))))
...
(clojure.core/defn- response-get-hosted-zone-limit-response [input] (clojure.core/let [rawinput47298 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47299 {"Limit" (portkey.aws/search-for-tag rawinput47298 "Limit" :flattened? false), "Count" (portkey.aws/search-for-tag rawinput47298 "Count" :flattened? false)}] (clojure.core/cond-> {:limit (deser-hosted-zone-limit (clojure.core/get-in letvar47299 ["Limit" :content])), :count (deser-usage-count (clojure.core/get-in letvar47299 ["Count" :content]))})))

(clojure.core/defn- response-invalid-pagination-token [input] (clojure.core/let [rawinput47300 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47301 {"message" (portkey.aws/search-for-tag rawinput47300 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47301 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47301 ["message" :content]))))))

(clojure.core/defn- response-delete-reusable-delegation-set-response [input] (clojure.core/let [rawinput47302 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47303 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-health-check-last-failure-reason-response [input] (clojure.core/let [rawinput47304 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47305 {"HealthCheckObservations" (portkey.aws/search-for-tag rawinput47304 "HealthCheckObservations" :flattened? false)}] (clojure.core/cond-> {:health-check-observations (deser-health-check-observations (clojure.core/get-in letvar47305 ["HealthCheckObservations" :content]))})))

(clojure.core/defn- response-last-vpc-association [input] (clojure.core/let [rawinput47306 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47307 {"message" (portkey.aws/search-for-tag rawinput47306 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47307 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47307 ["message" :content]))))))

(clojure.core/defn- response-query-logging-config-already-exists [input] (clojure.core/let [rawinput47308 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47309 {"message" (portkey.aws/search-for-tag rawinput47308 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47309 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47309 ["message" :content]))))))

(clojure.core/defn- response-too-many-health-checks [input] (clojure.core/let [rawinput47310 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47311 {"message" (portkey.aws/search-for-tag rawinput47310 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47311 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47311 ["message" :content]))))))

(clojure.core/defn- response-list-hosted-zones-by-name-response [input] (clojure.core/let [rawinput47312 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47313 {"HostedZones" (portkey.aws/search-for-tag rawinput47312 "HostedZones" :flattened? false), "DNSName" (portkey.aws/search-for-tag rawinput47312 "DNSName" :flattened? false), "HostedZoneId" (portkey.aws/search-for-tag rawinput47312 "HostedZoneId" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47312 "IsTruncated" :flattened? false), "NextDNSName" (portkey.aws/search-for-tag rawinput47312 "NextDNSName" :flattened? false), "NextHostedZoneId" (portkey.aws/search-for-tag rawinput47312 "NextHostedZoneId" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47312 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:hosted-zones (deser-hosted-zones (clojure.core/get-in letvar47313 ["HostedZones" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47313 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47313 ["MaxItems" :content]))} (letvar47313 "DNSName") (clojure.core/assoc :dns-name (deser-dns-name (clojure.core/get-in letvar47313 ["DNSName" :content]))) (letvar47313 "HostedZoneId") (clojure.core/assoc :hosted-zone-id (deser-resource-id (clojure.core/get-in letvar47313 ["HostedZoneId" :content]))) (letvar47313 "NextDNSName") (clojure.core/assoc :next-dns-name (deser-dns-name (clojure.core/get-in letvar47313 ["NextDNSName" :content]))) (letvar47313 "NextHostedZoneId") (clojure.core/assoc :next-hosted-zone-id (deser-resource-id (clojure.core/get-in letvar47313 ["NextHostedZoneId" :content]))))))

(clojure.core/defn- response-list-health-checks-response [input] (clojure.core/let [rawinput47314 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47315 {"HealthChecks" (portkey.aws/search-for-tag rawinput47314 "HealthChecks" :flattened? false), "Marker" (portkey.aws/search-for-tag rawinput47314 "Marker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47314 "IsTruncated" :flattened? false), "NextMarker" (portkey.aws/search-for-tag rawinput47314 "NextMarker" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47314 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:health-checks (deser-health-checks (clojure.core/get-in letvar47315 ["HealthChecks" :content])), :marker (deser-page-marker (clojure.core/get-in letvar47315 ["Marker" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47315 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47315 ["MaxItems" :content]))} (letvar47315 "NextMarker") (clojure.core/assoc :next-marker (deser-page-marker (clojure.core/get-in letvar47315 ["NextMarker" :content]))))))

(clojure.core/defn- response-invalid-argument [input] (clojure.core/let [rawinput47316 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47317 {"message" (portkey.aws/search-for-tag rawinput47316 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47317 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47317 ["message" :content]))))))

(clojure.core/defn- response-incompatible-version [input] (clojure.core/let [rawinput47318 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47319 {"message" (portkey.aws/search-for-tag rawinput47318 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47319 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47319 ["message" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-response [input] (clojure.core/let [rawinput47320 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47321 {"ResourceTagSet" (portkey.aws/search-for-tag rawinput47320 "ResourceTagSet" :flattened? false)}] (clojure.core/cond-> {:resource-tag-set (deser-resource-tag-set (clojure.core/get-in letvar47321 ["ResourceTagSet" :content]))})))

(clojure.core/defn- response-get-hosted-zone-response [input] (clojure.core/let [rawinput47322 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47323 {"HostedZone" (portkey.aws/search-for-tag rawinput47322 "HostedZone" :flattened? false), "DelegationSet" (portkey.aws/search-for-tag rawinput47322 "DelegationSet" :flattened? false), "VPCs" (portkey.aws/search-for-tag rawinput47322 "VPCs" :flattened? false)}] (clojure.core/cond-> {:hosted-zone (deser-hosted-zone (clojure.core/get-in letvar47323 ["HostedZone" :content]))} (letvar47323 "DelegationSet") (clojure.core/assoc :delegation-set (deser-delegation-set (clojure.core/get-in letvar47323 ["DelegationSet" :content]))) (letvar47323 "VPCs") (clojure.core/assoc :vp-cs (deser-vp-cs (clojure.core/get-in letvar47323 ["VPCs" :content]))))))

(clojure.core/defn- response-list-traffic-policy-versions-response [input] (clojure.core/let [rawinput47324 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47325 {"TrafficPolicies" (portkey.aws/search-for-tag rawinput47324 "TrafficPolicies" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47324 "IsTruncated" :flattened? false), "TrafficPolicyVersionMarker" (portkey.aws/search-for-tag rawinput47324 "TrafficPolicyVersionMarker" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47324 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:traffic-policies (deser-traffic-policies (clojure.core/get-in letvar47325 ["TrafficPolicies" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47325 ["IsTruncated" :content])), :traffic-policy-version-marker (deser-traffic-policy-version-marker (clojure.core/get-in letvar47325 ["TrafficPolicyVersionMarker" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47325 ["MaxItems" :content]))})))

(clojure.core/defn- response-hosted-zone-not-private [input] (clojure.core/let [rawinput47326 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47327 {"message" (portkey.aws/search-for-tag rawinput47326 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47327 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47327 ["message" :content]))))))

(clojure.core/defn- response-get-health-check-status-response [input] (clojure.core/let [rawinput47328 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47329 {"HealthCheckObservations" (portkey.aws/search-for-tag rawinput47328 "HealthCheckObservations" :flattened? false)}] (clojure.core/cond-> {:health-check-observations (deser-health-check-observations (clojure.core/get-in letvar47329 ["HealthCheckObservations" :content]))})))

(clojure.core/defn- response-list-vpc-association-authorizations-response [input] (clojure.core/let [rawinput47330 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47331 {"HostedZoneId" (portkey.aws/search-for-tag rawinput47330 "HostedZoneId" :flattened? false), "NextToken" (portkey.aws/search-for-tag rawinput47330 "NextToken" :flattened? false), "VPCs" (portkey.aws/search-for-tag rawinput47330 "VPCs" :flattened? false)}] (clojure.core/cond-> {:hosted-zone-id (deser-resource-id (clojure.core/get-in letvar47331 ["HostedZoneId" :content])), :vp-cs (deser-vp-cs (clojure.core/get-in letvar47331 ["VPCs" :content]))} (letvar47331 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar47331 ["NextToken" :content]))))))

(clojure.core/defn- response-no-such-geo-location [input] (clojure.core/let [rawinput47332 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47333 {"message" (portkey.aws/search-for-tag rawinput47332 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47333 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47333 ["message" :content]))))))

(clojure.core/defn- response-limits-exceeded [input] (clojure.core/let [rawinput47334 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47335 {"message" (portkey.aws/search-for-tag rawinput47334 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47335 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47335 ["message" :content]))))))

(clojure.core/defn- response-public-zone-vpc-association [input] (clojure.core/let [rawinput47336 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47337 {"message" (portkey.aws/search-for-tag rawinput47336 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47337 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47337 ["message" :content]))))))

(clojure.core/defn- response-prior-request-not-complete [input] (clojure.core/let [rawinput47338 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47339 {"message" (portkey.aws/search-for-tag rawinput47338 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47339 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47339 ["message" :content]))))))

(clojure.core/defn- response-create-traffic-policy-response [input] (clojure.core/let [rawinput47340 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47341 {"TrafficPolicy" (portkey.aws/search-for-tag rawinput47340 "TrafficPolicy" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:traffic-policy (deser-traffic-policy (clojure.core/get-in letvar47341 ["TrafficPolicy" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47341 ["Location"]))})))

(clojure.core/defn- response-too-many-vpc-association-authorizations [input] (clojure.core/let [rawinput47342 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47343 {"message" (portkey.aws/search-for-tag rawinput47342 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47343 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47343 ["message" :content]))))))

(clojure.core/defn- response-create-traffic-policy-version-response [input] (clojure.core/let [rawinput47344 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47345 {"TrafficPolicy" (portkey.aws/search-for-tag rawinput47344 "TrafficPolicy" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:traffic-policy (deser-traffic-policy (clojure.core/get-in letvar47345 ["TrafficPolicy" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47345 ["Location"]))})))

(clojure.core/defn- response-delete-hosted-zone-response [input] (clojure.core/let [rawinput47346 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47347 {"ChangeInfo" (portkey.aws/search-for-tag rawinput47346 "ChangeInfo" :flattened? false)}] (clojure.core/cond-> {:change-info (deser-change-info (clojure.core/get-in letvar47347 ["ChangeInfo" :content]))})))

(clojure.core/defn- response-test-dns-answer-response [input] (clojure.core/let [rawinput47348 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47349 {"Nameserver" (portkey.aws/search-for-tag rawinput47348 "Nameserver" :flattened? false), "RecordName" (portkey.aws/search-for-tag rawinput47348 "RecordName" :flattened? false), "RecordType" (portkey.aws/search-for-tag rawinput47348 "RecordType" :flattened? false), "RecordData" (portkey.aws/search-for-tag rawinput47348 "RecordData" :flattened? false), "ResponseCode" (portkey.aws/search-for-tag rawinput47348 "ResponseCode" :flattened? false), "Protocol" (portkey.aws/search-for-tag rawinput47348 "Protocol" :flattened? false)}] (clojure.core/cond-> {:nameserver (deser-nameserver (clojure.core/get-in letvar47349 ["Nameserver" :content])), :record-name (deser-dns-name (clojure.core/get-in letvar47349 ["RecordName" :content])), :record-type (deser-rr-type (clojure.core/get-in letvar47349 ["RecordType" :content])), :record-data (deser-record-data (clojure.core/get-in letvar47349 ["RecordData" :content])), :response-code (deser-dnsr-code (clojure.core/get-in letvar47349 ["ResponseCode" :content])), :protocol (deser-transport-protocol (clojure.core/get-in letvar47349 ["Protocol" :content]))})))

(clojure.core/defn- response-delete-query-logging-config-response [input] (clojure.core/let [rawinput47350 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47351 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-checker-ip-ranges-response [input] (clojure.core/let [rawinput47352 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47353 {"CheckerIpRanges" (portkey.aws/search-for-tag rawinput47352 "CheckerIpRanges" :flattened? false)}] (clojure.core/cond-> {:checker-ip-ranges (deser-checker-ip-ranges (clojure.core/get-in letvar47353 ["CheckerIpRanges" :content]))})))

(clojure.core/defn- response-create-vpc-association-authorization-response [input] (clojure.core/let [rawinput47354 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47355 {"HostedZoneId" (portkey.aws/search-for-tag rawinput47354 "HostedZoneId" :flattened? false), "VPC" (portkey.aws/search-for-tag rawinput47354 "VPC" :flattened? false)}] (clojure.core/cond-> {:hosted-zone-id (deser-resource-id (clojure.core/get-in letvar47355 ["HostedZoneId" :content])), :vpc (deser-vpc (clojure.core/get-in letvar47355 ["VPC" :content]))})))

(clojure.core/defn- response-delegation-set-not-reusable [input] (clojure.core/let [rawinput47356 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47357 {"message" (portkey.aws/search-for-tag rawinput47356 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47357 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47357 ["message" :content]))))))

(clojure.core/defn- response-insufficient-cloud-watch-logs-resource-policy [input] (clojure.core/let [rawinput47358 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47359 {"message" (portkey.aws/search-for-tag rawinput47358 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47359 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47359 ["message" :content]))))))

(clojure.core/defn- response-too-many-traffic-policy-instances [input] (clojure.core/let [rawinput47360 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47361 {"message" (portkey.aws/search-for-tag rawinput47360 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47361 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47361 ["message" :content]))))))

(clojure.core/defn- response-no-such-health-check [input] (clojure.core/let [rawinput47362 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47363 {"message" (portkey.aws/search-for-tag rawinput47362 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47363 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47363 ["message" :content]))))))

(clojure.core/defn- response-no-such-traffic-policy [input] (clojure.core/let [rawinput47364 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47365 {"message" (portkey.aws/search-for-tag rawinput47364 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47365 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47365 ["message" :content]))))))

(clojure.core/defn- response-associate-vpc-with-hosted-zone-response [input] (clojure.core/let [rawinput47366 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47367 {"ChangeInfo" (portkey.aws/search-for-tag rawinput47366 "ChangeInfo" :flattened? false)}] (clojure.core/cond-> {:change-info (deser-change-info (clojure.core/get-in letvar47367 ["ChangeInfo" :content]))})))

(clojure.core/defn- response-create-traffic-policy-instance-response [input] (clojure.core/let [rawinput47368 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47369 {"TrafficPolicyInstance" (portkey.aws/search-for-tag rawinput47368 "TrafficPolicyInstance" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:traffic-policy-instance (deser-traffic-policy-instance (clojure.core/get-in letvar47369 ["TrafficPolicyInstance" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47369 ["Location"]))})))

(clojure.core/defn- response-not-authorized-exception [input] (clojure.core/let [rawinput47370 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47371 {"message" (portkey.aws/search-for-tag rawinput47370 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47371 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47371 ["message" :content]))))))

(clojure.core/defn- response-get-query-logging-config-response [input] (clojure.core/let [rawinput47372 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47373 {"QueryLoggingConfig" (portkey.aws/search-for-tag rawinput47372 "QueryLoggingConfig" :flattened? false)}] (clojure.core/cond-> {:query-logging-config (deser-query-logging-config (clojure.core/get-in letvar47373 ["QueryLoggingConfig" :content]))})))

(clojure.core/defn- response-invalid-domain-name [input] (clojure.core/let [rawinput47374 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47375 {"message" (portkey.aws/search-for-tag rawinput47374 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47375 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47375 ["message" :content]))))))

(clojure.core/defn- response-list-reusable-delegation-sets-response [input] (clojure.core/let [rawinput47376 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47377 {"DelegationSets" (portkey.aws/search-for-tag rawinput47376 "DelegationSets" :flattened? false), "Marker" (portkey.aws/search-for-tag rawinput47376 "Marker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47376 "IsTruncated" :flattened? false), "NextMarker" (portkey.aws/search-for-tag rawinput47376 "NextMarker" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47376 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:delegation-sets (deser-delegation-sets (clojure.core/get-in letvar47377 ["DelegationSets" :content])), :marker (deser-page-marker (clojure.core/get-in letvar47377 ["Marker" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47377 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47377 ["MaxItems" :content]))} (letvar47377 "NextMarker") (clojure.core/assoc :next-marker (deser-page-marker (clojure.core/get-in letvar47377 ["NextMarker" :content]))))))

(clojure.core/defn- response-no-such-change [input] (clojure.core/let [rawinput47378 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47379 {"message" (portkey.aws/search-for-tag rawinput47378 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47379 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47379 ["message" :content]))))))

(clojure.core/defn- response-invalid-change-batch [input] (clojure.core/let [rawinput47380 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47381 {"messages" (portkey.aws/search-for-tag rawinput47380 "messages" :flattened? false), "message" (portkey.aws/search-for-tag rawinput47380 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47381 "messages") (clojure.core/assoc :messages (deser-error-messages (clojure.core/get-in letvar47381 ["messages" :content]))) (letvar47381 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47381 ["message" :content]))))))

(clojure.core/defn- response-invalid-input [input] (clojure.core/let [rawinput47382 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47383 {"message" (portkey.aws/search-for-tag rawinput47382 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47383 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47383 ["message" :content]))))))

(clojure.core/defn- response-get-reusable-delegation-set-response [input] (clojure.core/let [rawinput47384 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47385 {"DelegationSet" (portkey.aws/search-for-tag rawinput47384 "DelegationSet" :flattened? false)}] (clojure.core/cond-> {:delegation-set (deser-delegation-set (clojure.core/get-in letvar47385 ["DelegationSet" :content]))})))

(clojure.core/defn- response-get-traffic-policy-instance-response [input] (clojure.core/let [rawinput47386 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47387 {"TrafficPolicyInstance" (portkey.aws/search-for-tag rawinput47386 "TrafficPolicyInstance" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instance (deser-traffic-policy-instance (clojure.core/get-in letvar47387 ["TrafficPolicyInstance" :content]))})))

(clojure.core/defn- response-hosted-zone-not-found [input] (clojure.core/let [rawinput47388 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47389 {"message" (portkey.aws/search-for-tag rawinput47388 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47389 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47389 ["message" :content]))))))

(clojure.core/defn- response-invalid-vpc-id [input] (clojure.core/let [rawinput47390 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47391 {"message" (portkey.aws/search-for-tag rawinput47390 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47391 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47391 ["message" :content]))))))

(clojure.core/defn- response-no-such-delegation-set [input] (clojure.core/let [rawinput47392 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47393 {"message" (portkey.aws/search-for-tag rawinput47392 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47393 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47393 ["message" :content]))))))

(clojure.core/defn- response-too-many-traffic-policy-versions-for-current-policy [input] (clojure.core/let [rawinput47394 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47395 {"message" (portkey.aws/search-for-tag rawinput47394 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47395 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47395 ["message" :content]))))))

(clojure.core/defn- response-get-traffic-policy-response [input] (clojure.core/let [rawinput47396 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47397 {"TrafficPolicy" (portkey.aws/search-for-tag rawinput47396 "TrafficPolicy" :flattened? false)}] (clojure.core/cond-> {:traffic-policy (deser-traffic-policy (clojure.core/get-in letvar47397 ["TrafficPolicy" :content]))})))

(clojure.core/defn- response-update-traffic-policy-comment-response [input] (clojure.core/let [rawinput47398 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47399 {"TrafficPolicy" (portkey.aws/search-for-tag rawinput47398 "TrafficPolicy" :flattened? false)}] (clojure.core/cond-> {:traffic-policy (deser-traffic-policy (clojure.core/get-in letvar47399 ["TrafficPolicy" :content]))})))

(clojure.core/defn- response-disassociate-vpc-from-hosted-zone-response [input] (clojure.core/let [rawinput47400 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47401 {"ChangeInfo" (portkey.aws/search-for-tag rawinput47400 "ChangeInfo" :flattened? false)}] (clojure.core/cond-> {:change-info (deser-change-info (clojure.core/get-in letvar47401 ["ChangeInfo" :content]))})))

(clojure.core/defn- response-conflicting-domain-exists [input] (clojure.core/let [rawinput47402 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47403 {"message" (portkey.aws/search-for-tag rawinput47402 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47403 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47403 ["message" :content]))))))

(clojure.core/defn- response-concurrent-modification [input] (clojure.core/let [rawinput47404 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47405 {"message" (portkey.aws/search-for-tag rawinput47404 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47405 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47405 ["message" :content]))))))

(clojure.core/defn- response-delegation-set-in-use [input] (clojure.core/let [rawinput47406 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47407 {"message" (portkey.aws/search-for-tag rawinput47406 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47407 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47407 ["message" :content]))))))

(clojure.core/defn- response-list-query-logging-configs-response [input] (clojure.core/let [rawinput47408 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47409 {"QueryLoggingConfigs" (portkey.aws/search-for-tag rawinput47408 "QueryLoggingConfigs" :flattened? false), "NextToken" (portkey.aws/search-for-tag rawinput47408 "NextToken" :flattened? false)}] (clojure.core/cond-> {:query-logging-configs (deser-query-logging-configs (clojure.core/get-in letvar47409 ["QueryLoggingConfigs" :content]))} (letvar47409 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar47409 ["NextToken" :content]))))))

(clojure.core/defn- response-list-hosted-zones-response [input] (clojure.core/let [rawinput47410 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47411 {"HostedZones" (portkey.aws/search-for-tag rawinput47410 "HostedZones" :flattened? false), "Marker" (portkey.aws/search-for-tag rawinput47410 "Marker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47410 "IsTruncated" :flattened? false), "NextMarker" (portkey.aws/search-for-tag rawinput47410 "NextMarker" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47410 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:hosted-zones (deser-hosted-zones (clojure.core/get-in letvar47411 ["HostedZones" :content])), :marker (deser-page-marker (clojure.core/get-in letvar47411 ["Marker" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47411 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47411 ["MaxItems" :content]))} (letvar47411 "NextMarker") (clojure.core/assoc :next-marker (deser-page-marker (clojure.core/get-in letvar47411 ["NextMarker" :content]))))))

(clojure.core/defn- response-create-hosted-zone-response [input] (clojure.core/let [rawinput47412 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47413 {"HostedZone" (portkey.aws/search-for-tag rawinput47412 "HostedZone" :flattened? false), "ChangeInfo" (portkey.aws/search-for-tag rawinput47412 "ChangeInfo" :flattened? false), "DelegationSet" (portkey.aws/search-for-tag rawinput47412 "DelegationSet" :flattened? false), "VPC" (portkey.aws/search-for-tag rawinput47412 "VPC" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:hosted-zone (deser-hosted-zone (clojure.core/get-in letvar47413 ["HostedZone" :content])), :change-info (deser-change-info (clojure.core/get-in letvar47413 ["ChangeInfo" :content])), :delegation-set (deser-delegation-set (clojure.core/get-in letvar47413 ["DelegationSet" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47413 ["Location"]))} (letvar47413 "VPC") (clojure.core/assoc :vpc (deser-vpc (clojure.core/get-in letvar47413 ["VPC" :content]))))))

(clojure.core/defn- response-health-check-in-use [input] (clojure.core/let [rawinput47414 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47415 {"message" (portkey.aws/search-for-tag rawinput47414 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47415 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47415 ["message" :content]))))))

(clojure.core/defn- response-delete-health-check-response [input] (clojure.core/let [rawinput47416 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47417 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-update-traffic-policy-instance-response [input] (clojure.core/let [rawinput47418 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47419 {"TrafficPolicyInstance" (portkey.aws/search-for-tag rawinput47418 "TrafficPolicyInstance" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instance (deser-traffic-policy-instance (clojure.core/get-in letvar47419 ["TrafficPolicyInstance" :content]))})))

(clojure.core/defn- response-too-many-traffic-policies [input] (clojure.core/let [rawinput47420 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47421 {"message" (portkey.aws/search-for-tag rawinput47420 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47421 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47421 ["message" :content]))))))

(clojure.core/defn- response-create-query-logging-config-response [input] (clojure.core/let [rawinput47422 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47423 {"QueryLoggingConfig" (portkey.aws/search-for-tag rawinput47422 "QueryLoggingConfig" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:query-logging-config (deser-query-logging-config (clojure.core/get-in letvar47423 ["QueryLoggingConfig" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47423 ["Location"]))})))

(clojure.core/defn- response-traffic-policy-instance-already-exists [input] (clojure.core/let [rawinput47424 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47425 {"message" (portkey.aws/search-for-tag rawinput47424 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47425 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47425 ["message" :content]))))))

(clojure.core/defn- response-hosted-zone-already-exists [input] (clojure.core/let [rawinput47426 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47427 {"message" (portkey.aws/search-for-tag rawinput47426 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47427 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47427 ["message" :content]))))))

(clojure.core/defn- response-create-reusable-delegation-set-response [input] (clojure.core/let [rawinput47428 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47429 {"DelegationSet" (portkey.aws/search-for-tag rawinput47428 "DelegationSet" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:delegation-set (deser-delegation-set (clojure.core/get-in letvar47429 ["DelegationSet" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47429 ["Location"]))})))

(clojure.core/defn- response-list-resource-record-sets-response [input] (clojure.core/let [rawinput47430 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47431 {"ResourceRecordSets" (portkey.aws/search-for-tag rawinput47430 "ResourceRecordSets" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47430 "IsTruncated" :flattened? false), "NextRecordName" (portkey.aws/search-for-tag rawinput47430 "NextRecordName" :flattened? false), "NextRecordType" (portkey.aws/search-for-tag rawinput47430 "NextRecordType" :flattened? false), "NextRecordIdentifier" (portkey.aws/search-for-tag rawinput47430 "NextRecordIdentifier" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47430 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:resource-record-sets (deser-resource-record-sets (clojure.core/get-in letvar47431 ["ResourceRecordSets" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47431 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47431 ["MaxItems" :content]))} (letvar47431 "NextRecordName") (clojure.core/assoc :next-record-name (deser-dns-name (clojure.core/get-in letvar47431 ["NextRecordName" :content]))) (letvar47431 "NextRecordType") (clojure.core/assoc :next-record-type (deser-rr-type (clojure.core/get-in letvar47431 ["NextRecordType" :content]))) (letvar47431 "NextRecordIdentifier") (clojure.core/assoc :next-record-identifier (deser-resource-record-set-identifier (clojure.core/get-in letvar47431 ["NextRecordIdentifier" :content]))))))

(clojure.core/defn- response-invalid-traffic-policy-document [input] (clojure.core/let [rawinput47432 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47433 {"message" (portkey.aws/search-for-tag rawinput47432 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47433 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47433 ["message" :content]))))))

(clojure.core/defn- response-get-health-check-response [input] (clojure.core/let [rawinput47434 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47435 {"HealthCheck" (portkey.aws/search-for-tag rawinput47434 "HealthCheck" :flattened? false)}] (clojure.core/cond-> {:health-check (deser-health-check (clojure.core/get-in letvar47435 ["HealthCheck" :content]))})))

(clojure.core/defn- response-get-traffic-policy-instance-count-response [input] (clojure.core/let [rawinput47436 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47437 {"TrafficPolicyInstanceCount" (portkey.aws/search-for-tag rawinput47436 "TrafficPolicyInstanceCount" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instance-count (deser-traffic-policy-instance-count (clojure.core/get-in letvar47437 ["TrafficPolicyInstanceCount" :content]))})))

(clojure.core/defn- response-no-such-hosted-zone [input] (clojure.core/let [rawinput47438 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47439 {"message" (portkey.aws/search-for-tag rawinput47438 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47439 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47439 ["message" :content]))))))

(clojure.core/defn- response-list-geo-locations-response [input] (clojure.core/let [rawinput47440 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47441 {"GeoLocationDetailsList" (portkey.aws/search-for-tag rawinput47440 "GeoLocationDetailsList" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47440 "IsTruncated" :flattened? false), "NextContinentCode" (portkey.aws/search-for-tag rawinput47440 "NextContinentCode" :flattened? false), "NextCountryCode" (portkey.aws/search-for-tag rawinput47440 "NextCountryCode" :flattened? false), "NextSubdivisionCode" (portkey.aws/search-for-tag rawinput47440 "NextSubdivisionCode" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47440 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:geo-location-details-list (deser-geo-location-details-list (clojure.core/get-in letvar47441 ["GeoLocationDetailsList" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47441 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47441 ["MaxItems" :content]))} (letvar47441 "NextContinentCode") (clojure.core/assoc :next-continent-code (deser-geo-location-continent-code (clojure.core/get-in letvar47441 ["NextContinentCode" :content]))) (letvar47441 "NextCountryCode") (clojure.core/assoc :next-country-code (deser-geo-location-country-code (clojure.core/get-in letvar47441 ["NextCountryCode" :content]))) (letvar47441 "NextSubdivisionCode") (clojure.core/assoc :next-subdivision-code (deser-geo-location-subdivision-code (clojure.core/get-in letvar47441 ["NextSubdivisionCode" :content]))))))

(clojure.core/defn- response-conflicting-types [input] (clojure.core/let [rawinput47442 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47443 {"message" (portkey.aws/search-for-tag rawinput47442 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47443 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47443 ["message" :content]))))))

(clojure.core/defn- response-delete-traffic-policy-instance-response [input] (clojure.core/let [rawinput47444 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47445 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-traffic-policy-already-exists [input] (clojure.core/let [rawinput47446 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47447 {"message" (portkey.aws/search-for-tag rawinput47446 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47447 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47447 ["message" :content]))))))

(clojure.core/defn- response-delegation-set-already-reusable [input] (clojure.core/let [rawinput47448 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47449 {"message" (portkey.aws/search-for-tag rawinput47448 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47449 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47449 ["message" :content]))))))

(clojure.core/defn- response-vpc-association-not-found [input] (clojure.core/let [rawinput47450 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47451 {"message" (portkey.aws/search-for-tag rawinput47450 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47451 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47451 ["message" :content]))))))

(clojure.core/defn- response-health-check-version-mismatch [input] (clojure.core/let [rawinput47452 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47453 {"message" (portkey.aws/search-for-tag rawinput47452 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47453 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47453 ["message" :content]))))))

(clojure.core/defn- response-get-change-response [input] (clojure.core/let [rawinput47454 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47455 {"ChangeInfo" (portkey.aws/search-for-tag rawinput47454 "ChangeInfo" :flattened? false)}] (clojure.core/cond-> {:change-info (deser-change-info (clojure.core/get-in letvar47455 ["ChangeInfo" :content]))})))

(clojure.core/defn- response-list-traffic-policies-response [input] (clojure.core/let [rawinput47456 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47457 {"TrafficPolicySummaries" (portkey.aws/search-for-tag rawinput47456 "TrafficPolicySummaries" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47456 "IsTruncated" :flattened? false), "TrafficPolicyIdMarker" (portkey.aws/search-for-tag rawinput47456 "TrafficPolicyIdMarker" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47456 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-summaries (deser-traffic-policy-summaries (clojure.core/get-in letvar47457 ["TrafficPolicySummaries" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47457 ["IsTruncated" :content])), :traffic-policy-id-marker (deser-traffic-policy-id (clojure.core/get-in letvar47457 ["TrafficPolicyIdMarker" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47457 ["MaxItems" :content]))})))

(clojure.core/defn- response-get-geo-location-response [input] (clojure.core/let [rawinput47458 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47459 {"GeoLocationDetails" (portkey.aws/search-for-tag rawinput47458 "GeoLocationDetails" :flattened? false)}] (clojure.core/cond-> {:geo-location-details (deser-geo-location-details (clojure.core/get-in letvar47459 ["GeoLocationDetails" :content]))})))

(clojure.core/defn- response-list-traffic-policy-instances-response [input] (clojure.core/let [rawinput47460 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47461 {"TrafficPolicyInstances" (portkey.aws/search-for-tag rawinput47460 "TrafficPolicyInstances" :flattened? false), "HostedZoneIdMarker" (portkey.aws/search-for-tag rawinput47460 "HostedZoneIdMarker" :flattened? false), "TrafficPolicyInstanceNameMarker" (portkey.aws/search-for-tag rawinput47460 "TrafficPolicyInstanceNameMarker" :flattened? false), "TrafficPolicyInstanceTypeMarker" (portkey.aws/search-for-tag rawinput47460 "TrafficPolicyInstanceTypeMarker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47460 "IsTruncated" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47460 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instances (deser-traffic-policy-instances (clojure.core/get-in letvar47461 ["TrafficPolicyInstances" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47461 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47461 ["MaxItems" :content]))} (letvar47461 "HostedZoneIdMarker") (clojure.core/assoc :hosted-zone-id-marker (deser-resource-id (clojure.core/get-in letvar47461 ["HostedZoneIdMarker" :content]))) (letvar47461 "TrafficPolicyInstanceNameMarker") (clojure.core/assoc :traffic-policy-instance-name-marker (deser-dns-name (clojure.core/get-in letvar47461 ["TrafficPolicyInstanceNameMarker" :content]))) (letvar47461 "TrafficPolicyInstanceTypeMarker") (clojure.core/assoc :traffic-policy-instance-type-marker (deser-rr-type (clojure.core/get-in letvar47461 ["TrafficPolicyInstanceTypeMarker" :content]))))))

(clojure.core/defn- response-get-health-check-count-response [input] (clojure.core/let [rawinput47462 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47463 {"HealthCheckCount" (portkey.aws/search-for-tag rawinput47462 "HealthCheckCount" :flattened? false)}] (clojure.core/cond-> {:health-check-count (deser-health-check-count (clojure.core/get-in letvar47463 ["HealthCheckCount" :content]))})))

(clojure.core/defn- response-delete-vpc-association-authorization-response [input] (clojure.core/let [rawinput47464 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47465 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-too-many-hosted-zones [input] (clojure.core/let [rawinput47466 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47467 {"message" (portkey.aws/search-for-tag rawinput47466 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47467 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47467 ["message" :content]))))))

(clojure.core/defn- response-throttling-exception [input] (clojure.core/let [rawinput47468 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47469 {"message" (portkey.aws/search-for-tag rawinput47468 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47469 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47469 ["message" :content]))))))

(clojure.core/defn- response-change-tags-for-resource-response [input] (clojure.core/let [rawinput47470 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47471 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-hosted-zone-count-response [input] (clojure.core/let [rawinput47472 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47473 {"HostedZoneCount" (portkey.aws/search-for-tag rawinput47472 "HostedZoneCount" :flattened? false)}] (clojure.core/cond-> {:hosted-zone-count (deser-hosted-zone-count (clojure.core/get-in letvar47473 ["HostedZoneCount" :content]))})))

(clojure.core/defn- response-no-such-query-logging-config [input] (clojure.core/let [rawinput47474 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47475 {"message" (portkey.aws/search-for-tag rawinput47474 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47475 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47475 ["message" :content]))))))

(clojure.core/defn- response-update-health-check-response [input] (clojure.core/let [rawinput47476 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47477 {"HealthCheck" (portkey.aws/search-for-tag rawinput47476 "HealthCheck" :flattened? false)}] (clojure.core/cond-> {:health-check (deser-health-check (clojure.core/get-in letvar47477 ["HealthCheck" :content]))})))

(clojure.core/defn- response-traffic-policy-in-use [input] (clojure.core/let [rawinput47478 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47479 {"message" (portkey.aws/search-for-tag rawinput47478 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47479 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47479 ["message" :content]))))))

(clojure.core/defn- response-health-check-already-exists [input] (clojure.core/let [rawinput47480 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47481 {"message" (portkey.aws/search-for-tag rawinput47480 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47481 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47481 ["message" :content]))))))

(clojure.core/defn- response-delegation-set-not-available [input] (clojure.core/let [rawinput47482 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47483 {"message" (portkey.aws/search-for-tag rawinput47482 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47483 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47483 ["message" :content]))))))

(clojure.core/defn- response-list-tags-for-resources-response [input] (clojure.core/let [rawinput47484 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47485 {"ResourceTagSets" (portkey.aws/search-for-tag rawinput47484 "ResourceTagSets" :flattened? false)}] (clojure.core/cond-> {:resource-tag-sets (deser-resource-tag-set-list (clojure.core/get-in letvar47485 ["ResourceTagSets" :content]))})))

(clojure.core/defn- response-get-account-limit-response [input] (clojure.core/let [rawinput47486 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47487 {"Limit" (portkey.aws/search-for-tag rawinput47486 "Limit" :flattened? false), "Count" (portkey.aws/search-for-tag rawinput47486 "Count" :flattened? false)}] (clojure.core/cond-> {:limit (deser-account-limit (clojure.core/get-in letvar47487 ["Limit" :content])), :count (deser-usage-count (clojure.core/get-in letvar47487 ["Count" :content]))})))

(clojure.core/defn- response-vpc-association-authorization-not-found [input] (clojure.core/let [rawinput47488 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47489 {"message" (portkey.aws/search-for-tag rawinput47488 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47489 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47489 ["message" :content]))))))

(clojure.core/defn- response-no-such-traffic-policy-instance [input] (clojure.core/let [rawinput47490 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47491 {"message" (portkey.aws/search-for-tag rawinput47490 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47491 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47491 ["message" :content]))))))

(clojure.core/defn- response-update-hosted-zone-comment-response [input] (clojure.core/let [rawinput47492 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47493 {"HostedZone" (portkey.aws/search-for-tag rawinput47492 "HostedZone" :flattened? false)}] (clojure.core/cond-> {:hosted-zone (deser-hosted-zone (clojure.core/get-in letvar47493 ["HostedZone" :content]))})))

(clojure.core/defn- response-list-traffic-policy-instances-by-hosted-zone-response [input] (clojure.core/let [rawinput47494 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47495 {"TrafficPolicyInstances" (portkey.aws/search-for-tag rawinput47494 "TrafficPolicyInstances" :flattened? false), "TrafficPolicyInstanceNameMarker" (portkey.aws/search-for-tag rawinput47494 "TrafficPolicyInstanceNameMarker" :flattened? false), "TrafficPolicyInstanceTypeMarker" (portkey.aws/search-for-tag rawinput47494 "TrafficPolicyInstanceTypeMarker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47494 "IsTruncated" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47494 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instances (deser-traffic-policy-instances (clojure.core/get-in letvar47495 ["TrafficPolicyInstances" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47495 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47495 ["MaxItems" :content]))} (letvar47495 "TrafficPolicyInstanceNameMarker") (clojure.core/assoc :traffic-policy-instance-name-marker (deser-dns-name (clojure.core/get-in letvar47495 ["TrafficPolicyInstanceNameMarker" :content]))) (letvar47495 "TrafficPolicyInstanceTypeMarker") (clojure.core/assoc :traffic-policy-instance-type-marker (deser-rr-type (clojure.core/get-in letvar47495 ["TrafficPolicyInstanceTypeMarker" :content]))))))

(clojure.core/defn- response-no-such-cloud-watch-logs-log-group [input] (clojure.core/let [rawinput47496 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47497 {"message" (portkey.aws/search-for-tag rawinput47496 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47497 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47497 ["message" :content]))))))

(clojure.core/defn- response-list-traffic-policy-instances-by-policy-response [input] (clojure.core/let [rawinput47498 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47499 {"TrafficPolicyInstances" (portkey.aws/search-for-tag rawinput47498 "TrafficPolicyInstances" :flattened? false), "HostedZoneIdMarker" (portkey.aws/search-for-tag rawinput47498 "HostedZoneIdMarker" :flattened? false), "TrafficPolicyInstanceNameMarker" (portkey.aws/search-for-tag rawinput47498 "TrafficPolicyInstanceNameMarker" :flattened? false), "TrafficPolicyInstanceTypeMarker" (portkey.aws/search-for-tag rawinput47498 "TrafficPolicyInstanceTypeMarker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput47498 "IsTruncated" :flattened? false), "MaxItems" (portkey.aws/search-for-tag rawinput47498 "MaxItems" :flattened? false)}] (clojure.core/cond-> {:traffic-policy-instances (deser-traffic-policy-instances (clojure.core/get-in letvar47499 ["TrafficPolicyInstances" :content])), :is-truncated (deser-page-truncated (clojure.core/get-in letvar47499 ["IsTruncated" :content])), :max-items (deser-page-max-items (clojure.core/get-in letvar47499 ["MaxItems" :content]))} (letvar47499 "HostedZoneIdMarker") (clojure.core/assoc :hosted-zone-id-marker (deser-resource-id (clojure.core/get-in letvar47499 ["HostedZoneIdMarker" :content]))) (letvar47499 "TrafficPolicyInstanceNameMarker") (clojure.core/assoc :traffic-policy-instance-name-marker (deser-dns-name (clojure.core/get-in letvar47499 ["TrafficPolicyInstanceNameMarker" :content]))) (letvar47499 "TrafficPolicyInstanceTypeMarker") (clojure.core/assoc :traffic-policy-instance-type-marker (deser-rr-type (clojure.core/get-in letvar47499 ["TrafficPolicyInstanceTypeMarker" :content]))))))

(clojure.core/defn- response-create-health-check-response [input] (clojure.core/let [rawinput47500 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47501 {"HealthCheck" (portkey.aws/search-for-tag rawinput47500 "HealthCheck" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {:health-check (deser-health-check (clojure.core/get-in letvar47501 ["HealthCheck" :content])), :location (deser-resource-uri (clojure.core/get-in letvar47501 ["Location"]))})))

(clojure.core/defn- response-delete-traffic-policy-response [input] (clojure.core/let [rawinput47502 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47503 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-reusable-delegation-set-limit-response [input] (clojure.core/let [rawinput47504 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47505 {"Limit" (portkey.aws/search-for-tag rawinput47504 "Limit" :flattened? false), "Count" (portkey.aws/search-for-tag rawinput47504 "Count" :flattened? false)}] (clojure.core/cond-> {:limit (deser-reusable-delegation-set-limit (clojure.core/get-in letvar47505 ["Limit" :content])), :count (deser-usage-count (clojure.core/get-in letvar47505 ["Count" :content]))})))

(clojure.core/defn- response-delegation-set-already-created [input] (clojure.core/let [rawinput47506 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47507 {"message" (portkey.aws/search-for-tag rawinput47506 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47507 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47507 ["message" :content]))))))

(clojure.core/defn- response-hosted-zone-not-empty [input] (clojure.core/let [rawinput47508 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47509 {"message" (portkey.aws/search-for-tag rawinput47508 "message" :flattened? false)}] (clojure.core/cond-> {} (letvar47509 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar47509 ["message" :content]))))))

(clojure.core/defn- response-change-resource-record-sets-response [input] (clojure.core/let [rawinput47510 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar47511 {"ChangeInfo" (portkey.aws/search-for-tag rawinput47510 "ChangeInfo" :flattened? false)}] (clojure.core/cond-> {:change-info (deser-change-info (clojure.core/get-in letvar47511 ["ChangeInfo" :content]))})))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-subdivision-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/health-check-nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/search-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-country-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 2))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-version-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 4))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/subnet-mask (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 0 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/dimension-field (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/nameserver (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 0 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/resource-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-continent-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 2 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 2))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-continent-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/tag-resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/service-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/record-data-entry (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 0 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/health-check-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/dns-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/resource-uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/query-logging-config-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/resource-record-set-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-subdivision-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/ip-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 45)) (clojure.core/fn [s__33656__auto__] (clojure.core/re-matches #"(^((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))$|^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$)" s__33656__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/geo-location-country-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/alarm-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/resource-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/traffic-policy-comment (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/r-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33654__auto__] (clojure.core/<= 1 (clojure.core/count s__33654__auto__))) (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/vpc-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53.-2013-04-01/fully-qualified-domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__33655__auto__] (clojure.core/< (clojure.core/count s__33655__auto__) 255))))
