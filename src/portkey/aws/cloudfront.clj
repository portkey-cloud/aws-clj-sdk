...
(clojure.spec.alpha/def :portkey.aws.cloudfront.list-distributions-by-webaclid-request/marker (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.list-distributions-by-webaclid-request/max-items (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.list-distributions-by-webaclid-request/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/list-distributions-by-webaclid-request (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.list-distributions-by-webaclid-request/webaclid] :opt-un [:portkey.aws.cloudfront.list-distributions-by-webaclid-request/marker :portkey.aws.cloudfront.list-distributions-by-webaclid-request/max-items]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption :portkey.aws.cloudfront.create-field-level-encryption-config-result/location :portkey.aws.cloudfront.create-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/streaming-distribution :portkey.aws.cloudfront.get-streaming-distribution-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront/key-pair-id-list (clojure.spec.alpha/coll-of :portkey.aws.cloudfront/string))

(clojure.spec.alpha/def :portkey.aws.cloudfront.too-many-streaming-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/too-many-streaming-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.too-many-streaming-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-public-key-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-public-key-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/public-key-config :portkey.aws.cloudfront.get-public-key-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/lambda-function-association (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront/lambda-functionarn :portkey.aws.cloudfront/event-type] :opt-un [:portkey.aws.cloudfront.lambda-function-association/include-body]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.list-tags-for-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/viewer-protocol-policy #{"allow-all" :https-only :redirect-to-https :allow-all "https-only" "redirect-to-https"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption-profile :portkey.aws.cloudfront.create-field-level-encryption-profile-result/location :portkey.aws.cloudfront.create-field-level-encryption-profile-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption-profile :portkey.aws.cloudfront.get-field-level-encryption-profile-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.update-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/cloud-front-origin-access-identity :portkey.aws.cloudfront.update-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 1 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 128)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/streaming-distribution :portkey.aws.cloudfront.create-streaming-distribution-result/location :portkey.aws.cloudfront.create-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.cache-behavior/maxttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.cache-behavior/defaultttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront/cache-behavior (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.cache-behavior/path-pattern :portkey.aws.cloudfront.cache-behavior/target-origin-id :portkey.aws.cloudfront/forwarded-values :portkey.aws.cloudfront/trusted-signers :portkey.aws.cloudfront/viewer-protocol-policy :portkey.aws.cloudfront.cache-behavior/minttl] :opt-un [:portkey.aws.cloudfront.cache-behavior/smooth-streaming :portkey.aws.cloudfront.cache-behavior/field-level-encryption-id :portkey.aws.cloudfront.cache-behavior/compress :portkey.aws.cloudfront/lambda-function-associations :portkey.aws.cloudfront.cache-behavior/maxttl :portkey.aws.cloudfront/allowed-methods :portkey.aws.cloudfront.cache-behavior/defaultttl]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/public-key :portkey.aws.cloudfront.create-public-key-result/location :portkey.aws.cloudfront.create-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/origin (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.origin/id :portkey.aws.cloudfront.origin/domain-name] :opt-un [:portkey.aws.cloudfront.origin/origin-path :portkey.aws.cloudfront/custom-headers :portkey.aws.cloudfront/s3-origin-config :portkey.aws.cloudfront/custom-origin-config]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.invalid-webaclid/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/invalid-webaclid (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.invalid-webaclid/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/format #{:urlencoded "URLEncoded"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/event-type #{:origin-response :viewer-request "viewer-response" :viewer-response "origin-response" "origin-request" "viewer-request" :origin-request})

(clojure.spec.alpha/def :portkey.aws.cloudfront.update-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution :portkey.aws.cloudfront.update-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/lambda-functionarn (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.cloudfront.get-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/cloud-front-origin-access-identity :portkey.aws.cloudfront.get-cloud-front-origin-access-identity-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-field-level-encryption-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-field-level-encryption-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption :portkey.aws.cloudfront.get-field-level-encryption-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.custom-origin-config/httpport (clojure.spec.alpha/and :portkey.aws.cloudfront/integer))
(clojure.spec.alpha/def :portkey.aws.cloudfront.custom-origin-config/httpsport (clojure.spec.alpha/and :portkey.aws.cloudfront/integer))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.invalidttlorder/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/invalidttlorder (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.invalidttlorder/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.s3-origin/domain-name (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.s3-origin/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/s3-origin (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.s3-origin/domain-name :portkey.aws.cloudfront.s3-origin/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-cloud-front-origin-access-identity-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-cloud-front-origin-access-identity-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/cloud-front-origin-access-identity :portkey.aws.cloudfront.create-cloud-front-origin-access-identity-result/location :portkey.aws.cloudfront.create-cloud-front-origin-access-identity-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.cnamealready-exists/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/cnamealready-exists (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.cnamealready-exists/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.cloud-front-origin-access-identity/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/cloud-front-origin-access-identity (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.cloud-front-origin-access-identity/id :portkey.aws.cloudfront.cloud-front-origin-access-identity/s3-canonical-user-id] :opt-un [:portkey.aws.cloudfront/cloud-front-origin-access-identity-config]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.tag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.distribution-config/isipv6-enabled (clojure.spec.alpha/and :portkey.aws.cloudfront/boolean))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.distribution-config/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/distribution-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.distribution-config/caller-reference :portkey.aws.cloudfront/origins :portkey.aws.cloudfront/default-cache-behavior :portkey.aws.cloudfront.distribution-config/comment :portkey.aws.cloudfront.distribution-config/enabled] :opt-un [:portkey.aws.cloudfront.distribution-config/default-root-object :portkey.aws.cloudfront.distribution-config/isipv6-enabled :portkey.aws.cloudfront/restrictions :portkey.aws.cloudfront.distribution-config/webaclid :portkey.aws.cloudfront.distribution-config/logging :portkey.aws.cloudfront/cache-behaviors :portkey.aws.cloudfront/custom-error-responses :portkey.aws.cloudfront/aliases :portkey.aws.cloudfront/price-class :portkey.aws.cloudfront/http-version :portkey.aws.cloudfront/viewer-certificate]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/public-key :portkey.aws.cloudfront.get-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.update-public-key-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-public-key-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/public-key :portkey.aws.cloudfront.update-public-key-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution-config :portkey.aws.cloudfront.get-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.update-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption :portkey.aws.cloudfront.update-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306236__auto__] (clojure.core/<= 0 (clojure.core/count s__306236__auto__))) (clojure.core/fn [s__306237__auto__] (clojure.core/< (clojure.core/count s__306237__auto__) 256)) (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.get-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution :portkey.aws.cloudfront.get-distribution-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.update-field-level-encryption-profile-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-field-level-encryption-profile-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption-profile :portkey.aws.cloudfront.update-field-level-encryption-profile-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront/alias-list (clojure.spec.alpha/coll-of :portkey.aws.cloudfront/string))

(clojure.spec.alpha/def :portkey.aws.cloudfront.get-streaming-distribution-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-streaming-distribution-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/streaming-distribution-config :portkey.aws.cloudfront.get-streaming-distribution-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/origin-protocol-policy #{"match-viewer" :https-only "https-only" :match-viewer "http-only" :http-only})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.invalid-headers-fors3-origin/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/invalid-headers-fors3-origin (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.invalid-headers-fors3-origin/message]))

(clojure.spec.alpha/def :portkey.aws.cloudfront.get-field-level-encryption-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-field-level-encryption-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption-config :portkey.aws.cloudfront.get-field-level-encryption-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.too-many-distributioncnames/message (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/too-many-distributioncnames (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.too-many-distributioncnames/message]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution :portkey.aws.cloudfront.create-distribution-with-tags-result/location :portkey.aws.cloudfront.create-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-streaming-distribution-with-tags-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-streaming-distribution-with-tags-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/streaming-distribution :portkey.aws.cloudfront.create-streaming-distribution-with-tags-result/location :portkey.aws.cloudfront.create-streaming-distribution-with-tags-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.cloud-front-origin-access-identity-summary/s3-canonical-user-id (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/cloud-front-origin-access-identity-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.cloud-front-origin-access-identity-summary/id :portkey.aws.cloudfront.cloud-front-origin-access-identity-summary/s3-canonical-user-id :portkey.aws.cloudfront.cloud-front-origin-access-identity-summary/comment] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.cloudfront.get-cloud-front-origin-access-identity-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/cloud-front-origin-access-identity-config :portkey.aws.cloudfront.get-cloud-front-origin-access-identity-config-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.s3-origin-config/origin-access-identity (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/s3-origin-config (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.s3-origin-config/origin-access-identity] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.distribution-summary/isipv6-enabled (clojure.spec.alpha/and :portkey.aws.cloudfront/boolean))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.distribution-summary/webaclid (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/distribution-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.distribution-summary/id :portkey.aws.cloudfront.distribution-summary/arn :portkey.aws.cloudfront.distribution-summary/status :portkey.aws.cloudfront.distribution-summary/last-modified-time :portkey.aws.cloudfront.distribution-summary/domain-name :portkey.aws.cloudfront/aliases :portkey.aws.cloudfront/origins :portkey.aws.cloudfront/default-cache-behavior :portkey.aws.cloudfront/cache-behaviors :portkey.aws.cloudfront/custom-error-responses :portkey.aws.cloudfront.distribution-summary/comment :portkey.aws.cloudfront/price-class :portkey.aws.cloudfront.distribution-summary/enabled :portkey.aws.cloudfront/viewer-certificate :portkey.aws.cloudfront/restrictions :portkey.aws.cloudfront.distribution-summary/webaclid :portkey.aws.cloudfront/http-version :portkey.aws.cloudfront.distribution-summary/isipv6-enabled] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.cloudfront/ssl-protocol #{:sslv3 "TLSv1" "TLSv1.2" "SSLv3" :tlsv1.1 :tlsv1.2 :tlsv1 "TLSv1.1"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/minimum-protocol-version #{:sslv3 :tlsv1.2-2018 "TLSv1" "TLSv1_2016" :tlsv1.1-2016 "TLSv1.2_2018" "SSLv3" :tlsv1 "TLSv1.1_2016" :tlsv1-2016})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.create-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/create-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution :portkey.aws.cloudfront.create-distribution-result/location :portkey.aws.cloudfront.create-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/resourcearn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__306238__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__306238__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.update-streaming-distribution-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/update-streaming-distribution-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/streaming-distribution :portkey.aws.cloudfront.update-streaming-distribution-result/etag]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/sslsupport-method #{"sni-only" :sni-only :vip "vip"})

(clojure.spec.alpha/def :portkey.aws.cloudfront.get-field-level-encryption-profile-config-result/etag (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront/get-field-level-encryption-profile-config-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/field-level-encryption-profile-config :portkey.aws.cloudfront.get-field-level-encryption-profile-config-result/etag]))

(clojure.spec.alpha/def :portkey.aws.cloudfront/http-version #{"http2" :http1.1 :http2 "http1.1"})
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/list-distributions-by-webaclid-result (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront/distribution-list]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.untag-resource-request/resource (clojure.spec.alpha/and :portkey.aws.cloudfront/resourcearn))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.default-cache-behavior/minttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.default-cache-behavior/maxttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront.default-cache-behavior/defaultttl (clojure.spec.alpha/and :portkey.aws.cloudfront/long))
(clojure.spec.alpha/def :portkey.aws.cloudfront/default-cache-behavior (clojure.spec.alpha/keys :req-un [:portkey.aws.cloudfront.default-cache-behavior/target-origin-id :portkey.aws.cloudfront/forwarded-values :portkey.aws.cloudfront/trusted-signers :portkey.aws.cloudfront/viewer-protocol-policy :portkey.aws.cloudfront.default-cache-behavior/minttl] :opt-un [:portkey.aws.cloudfront.default-cache-behavior/smooth-streaming :portkey.aws.cloudfront.default-cache-behavior/field-level-encryption-id :portkey.aws.cloudfront.default-cache-behavior/compress :portkey.aws.cloudfront/lambda-function-associations :portkey.aws.cloudfront.default-cache-behavior/maxttl :portkey.aws.cloudfront/allowed-methods :portkey.aws.cloudfront.default-cache-behavior/defaultttl]))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront.viewer-certificate/iamcertificate-id (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
(clojure.spec.alpha/def :portkey.aws.cloudfront.viewer-certificate/acmcertificate-arn (clojure.spec.alpha/and :portkey.aws.cloudfront/string))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/viewer-certificate (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.cloudfront.viewer-certificate/cloud-front-default-certificate :portkey.aws.cloudfront.viewer-certificate/iamcertificate-id :portkey.aws.cloudfront.viewer-certificate/acmcertificate-arn :portkey.aws.cloudfront/sslsupport-method :portkey.aws.cloudfront/minimum-protocol-version :portkey.aws.cloudfront.viewer-certificate/certificate :portkey.aws.cloudfront/certificate-source]))
...
(clojure.core/defn tag-resource2018-06-18 ([tag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-tag-resource-request tag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging?Operation=Tag", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/tag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront/no-such-resource}})))))
(clojure.spec.alpha/fdef tag-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/tag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-distribution2018-06-18 ([get-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-request get-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-distribution-result))

(clojure.core/defn get-public-key2018-06-18 ([get-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-public-key-request get-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key}})))))
(clojure.spec.alpha/fdef get-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-public-key-result))

(clojure.core/defn create-streaming-distribution-with-tags2018-06-18 ([create-streaming-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-with-tags-request create-streaming-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-streaming-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution?WithTags", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-streaming-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidOrigin" :portkey.aws.cloudfront/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "InvalidTagging" :portkey.aws.cloudfront/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution-with-tags2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-streaming-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-streaming-distribution-with-tags-result))

(clojure.core/defn update-distribution2018-06-18 ([update-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-distribution-request update-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront/no-such-origin, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront/invalid-webaclid, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront/invalid-origin-read-timeout, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront/invalid-minimum-protocol-version, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef update-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-distribution-result))

(clojure.core/defn update-field-level-encryption-profile2018-06-18 ([update-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-field-level-encryption-profile-request update-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"FieldLevelEncryptionProfileAlreadyExists" :portkey.aws.cloudfront/field-level-encryption-profile-already-exists, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key, "AccessDenied" :portkey.aws.cloudfront/access-denied, "FieldLevelEncryptionProfileSizeExceeded" :portkey.aws.cloudfront/field-level-encryption-profile-size-exceeded, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile, "TooManyFieldLevelEncryptionEncryptionEntities" :portkey.aws.cloudfront/too-many-field-level-encryption-encryption-entities, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TooManyFieldLevelEncryptionFieldPatterns" :portkey.aws.cloudfront/too-many-field-level-encryption-field-patterns}})))))
(clojure.spec.alpha/fdef update-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-field-level-encryption-profile-result))

(clojure.core/defn delete-streaming-distribution2018-06-18 ([delete-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-streaming-distribution-request delete-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "StreamingDistributionNotDisabled" :portkey.aws.cloudfront/streaming-distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchStreamingDistribution" :portkey.aws.cloudfront/no-such-streaming-distribution, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-streaming-distribution-request) :ret clojure.core/true?)

(clojure.core/defn delete-cloud-front-origin-access-identity2018-06-18 ([delete-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-cloud-front-origin-access-identity-request delete-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "CloudFrontOriginAccessIdentityInUse" :portkey.aws.cloudfront/cloud-front-origin-access-identity-in-use}})))))
(clojure.spec.alpha/fdef delete-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-cloud-front-origin-access-identity-request) :ret clojure.core/true?)

(clojure.core/defn create-distribution-with-tags2018-06-18 ([create-distribution-with-tags-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-with-tags-request create-distribution-with-tags-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-distribution-with-tags-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution?WithTags", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-distribution-with-tags-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront/too-many-query-string-parameters, "InvalidTagging" :portkey.aws.cloudfront/invalid-tagging, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution-with-tags2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-distribution-with-tags-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-distribution-with-tags-result))

(clojure.core/defn delete-field-level-encryption-profile2018-06-18 ([delete-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-field-level-encryption-profile-request delete-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "FieldLevelEncryptionProfileInUse" :portkey.aws.cloudfront/field-level-encryption-profile-in-use}})))))
(clojure.spec.alpha/fdef delete-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-field-level-encryption-profile-request) :ret clojure.core/true?)

(clojure.core/defn get-invalidation2018-06-18 ([get-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-invalidation-request get-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchInvalidation" :portkey.aws.cloudfront/no-such-invalidation, "NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-invalidation2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-invalidation-result))

(clojure.core/defn list-field-level-encryption-profiles2018-06-18 ([] (list-field-level-encryption-profiles2018-06-18 {})) ([list-field-level-encryption-profiles-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-field-level-encryption-profiles-request list-field-level-encryption-profiles-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-field-level-encryption-profiles-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-field-level-encryption-profiles-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-field-level-encryption-profiles2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-field-level-encryption-profiles-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-field-level-encryption-profiles-result))

(clojure.core/defn create-field-level-encryption-profile2018-06-18 ([create-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-field-level-encryption-profile-request create-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key, "FieldLevelEncryptionProfileAlreadyExists" :portkey.aws.cloudfront/field-level-encryption-profile-already-exists, "FieldLevelEncryptionProfileSizeExceeded" :portkey.aws.cloudfront/field-level-encryption-profile-size-exceeded, "TooManyFieldLevelEncryptionProfiles" :portkey.aws.cloudfront/too-many-field-level-encryption-profiles, "TooManyFieldLevelEncryptionEncryptionEntities" :portkey.aws.cloudfront/too-many-field-level-encryption-encryption-entities, "TooManyFieldLevelEncryptionFieldPatterns" :portkey.aws.cloudfront/too-many-field-level-encryption-field-patterns}})))))
(clojure.spec.alpha/fdef create-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-field-level-encryption-profile-result))

(clojure.core/defn create-streaming-distribution2018-06-18 ([create-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-streaming-distribution-request create-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyStreamingDistributions" :portkey.aws.cloudfront/too-many-streaming-distributions, "TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidOrigin" :portkey.aws.cloudfront/invalid-origin, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "StreamingDistributionAlreadyExists" :portkey.aws.cloudfront/streaming-distribution-already-exists, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef create-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-streaming-distribution-result))

(clojure.core/defn get-field-level-encryption-profile2018-06-18 ([get-field-level-encryption-profile-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-profile-request get-field-level-encryption-profile-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-field-level-encryption-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-field-level-encryption-profile-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-profile2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-field-level-encryption-profile-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-field-level-encryption-profile-result))

(clojure.core/defn list-field-level-encryption-configs2018-06-18 ([] (list-field-level-encryption-configs2018-06-18 {})) ([list-field-level-encryption-configs-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-field-level-encryption-configs-request list-field-level-encryption-configs-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-field-level-encryption-configs-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-field-level-encryption-configs-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-field-level-encryption-configs2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-field-level-encryption-configs-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-field-level-encryption-configs-result))

(clojure.core/defn list-tags-for-resource2018-06-18 ([list-tags-for-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-tags-for-resource-request list-tags-for-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-tags-for-resource-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-tags-for-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront/no-such-resource}})))))
(clojure.spec.alpha/fdef list-tags-for-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/list-tags-for-resource-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-tags-for-resource-result))

(clojure.core/defn get-streaming-distribution2018-06-18 ([get-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-request get-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-streaming-distribution-result))

(clojure.core/defn get-field-level-encryption2018-06-18 ([get-field-level-encryption-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-request get-field-level-encryption-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-field-level-encryption-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-field-level-encryption-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config}})))))
(clojure.spec.alpha/fdef get-field-level-encryption2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-field-level-encryption-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-field-level-encryption-result))

(clojure.core/defn create-distribution2018-06-18 ([create-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-distribution-request create-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyDistributionsWithLambdaAssociations" :portkey.aws.cloudfront/too-many-distributions-with-lambda-associations, "NoSuchOrigin" :portkey.aws.cloudfront/no-such-origin, "InvalidProtocolSettings" :portkey.aws.cloudfront/invalid-protocol-settings, "TooManyCookieNamesInWhiteList" :portkey.aws.cloudfront/too-many-cookie-names-in-white-list, "TooManyCacheBehaviors" :portkey.aws.cloudfront/too-many-cache-behaviors, "TooManyOriginCustomHeaders" :portkey.aws.cloudfront/too-many-origin-custom-headers, "InvalidViewerCertificate" :portkey.aws.cloudfront/invalid-viewer-certificate, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "IllegalFieldLevelEncryptionConfigAssociationWithCacheBehavior" :portkey.aws.cloudfront/illegal-field-level-encryption-config-association-with-cache-behavior, "TooManyCertificates" :portkey.aws.cloudfront/too-many-certificates, "AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidLambdaFunctionAssociation" :portkey.aws.cloudfront/invalid-lambda-function-association, "InvalidErrorCode" :portkey.aws.cloudfront/invalid-error-code, "TooManyLambdaFunctionAssociations" :portkey.aws.cloudfront/too-many-lambda-function-associations, "InvalidRelativePath" :portkey.aws.cloudfront/invalid-relative-path, "InvalidLocationCode" :portkey.aws.cloudfront/invalid-location-code, "InvalidWebACLId" :portkey.aws.cloudfront/invalid-webaclid, "InvalidOrigin" :portkey.aws.cloudfront/invalid-origin, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config, "InvalidQueryStringParameters" :portkey.aws.cloudfront/invalid-query-string-parameters, "TooManyOrigins" :portkey.aws.cloudfront/too-many-origins, "InvalidTTLOrder" :portkey.aws.cloudfront/invalidttlorder, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "InvalidDefaultRootObject" :portkey.aws.cloudfront/invalid-default-root-object, "InvalidResponseCode" :portkey.aws.cloudfront/invalid-response-code, "TooManyDistributionsAssociatedToFieldLevelEncryptionConfig" :portkey.aws.cloudfront/too-many-distributions-associated-to-field-level-encryption-config, "InvalidForwardCookies" :portkey.aws.cloudfront/invalid-forward-cookies, "InvalidRequiredProtocol" :portkey.aws.cloudfront/invalid-required-protocol, "InvalidHeadersForS3Origin" :portkey.aws.cloudfront/invalid-headers-fors3-origin, "TooManyDistributionCNAMEs" :portkey.aws.cloudfront/too-many-distributioncnames, "InvalidGeoRestrictionParameter" :portkey.aws.cloudfront/invalid-geo-restriction-parameter, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidOriginReadTimeout" :portkey.aws.cloudfront/invalid-origin-read-timeout, "DistributionAlreadyExists" :portkey.aws.cloudfront/distribution-already-exists, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "InvalidMinimumProtocolVersion" :portkey.aws.cloudfront/invalid-minimum-protocol-version, "TooManyDistributions" :portkey.aws.cloudfront/too-many-distributions, "InvalidOriginKeepaliveTimeout" :portkey.aws.cloudfront/invalid-origin-keepalive-timeout, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TooManyQueryStringParameters" :portkey.aws.cloudfront/too-many-query-string-parameters, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist, "TooManyHeadersInForwardedValues" :portkey.aws.cloudfront/too-many-headers-in-forwarded-values}})))))
(clojure.spec.alpha/fdef create-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-distribution-result))

(clojure.core/defn create-field-level-encryption-config2018-06-18 ([create-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-field-level-encryption-config-request create-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile, "FieldLevelEncryptionConfigAlreadyExists" :portkey.aws.cloudfront/field-level-encryption-config-already-exists, "TooManyFieldLevelEncryptionConfigs" :portkey.aws.cloudfront/too-many-field-level-encryption-configs, "TooManyFieldLevelEncryptionQueryArgProfiles" :portkey.aws.cloudfront/too-many-field-level-encryption-query-arg-profiles, "TooManyFieldLevelEncryptionContentTypeProfiles" :portkey.aws.cloudfront/too-many-field-level-encryption-content-type-profiles, "QueryArgProfileEmpty" :portkey.aws.cloudfront/query-arg-profile-empty}})))))
(clojure.spec.alpha/fdef create-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-field-level-encryption-config-result))

(clojure.core/defn get-streaming-distribution-config2018-06-18 ([get-streaming-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-streaming-distribution-config-request get-streaming-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-streaming-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-streaming-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchStreamingDistribution" :portkey.aws.cloudfront/no-such-streaming-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-streaming-distribution-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-streaming-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-streaming-distribution-config-result))

(clojure.core/defn update-field-level-encryption-config2018-06-18 ([update-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-field-level-encryption-config-request update-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config, "TooManyFieldLevelEncryptionQueryArgProfiles" :portkey.aws.cloudfront/too-many-field-level-encryption-query-arg-profiles, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "QueryArgProfileEmpty" :portkey.aws.cloudfront/query-arg-profile-empty, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "TooManyFieldLevelEncryptionContentTypeProfiles" :portkey.aws.cloudfront/too-many-field-level-encryption-content-type-profiles, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef update-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-field-level-encryption-config-result))

(clojure.core/defn list-distributions2018-06-18 ([] (list-distributions2018-06-18 {})) ([list-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-request list-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-distributions2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-distributions-result))

(clojure.core/defn list-public-keys2018-06-18 ([] (list-public-keys2018-06-18 {})) ([list-public-keys-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-public-keys-request list-public-keys-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-public-keys-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-public-keys-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-public-keys2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-public-keys-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-public-keys-result))

(clojure.core/defn create-public-key2018-06-18 ([create-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-public-key-request create-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"PublicKeyAlreadyExists" :portkey.aws.cloudfront/public-key-already-exists, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "TooManyPublicKeys" :portkey.aws.cloudfront/too-many-public-keys}})))))
(clojure.spec.alpha/fdef create-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-public-key-result))

(clojure.core/defn get-field-level-encryption-profile-config2018-06-18 ([get-field-level-encryption-profile-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-profile-config-request get-field-level-encryption-profile-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-field-level-encryption-profile-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption-profile/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-field-level-encryption-profile-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchFieldLevelEncryptionProfile" :portkey.aws.cloudfront/no-such-field-level-encryption-profile}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-profile-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-field-level-encryption-profile-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-field-level-encryption-profile-config-result))

(clojure.core/defn get-cloud-front-origin-access-identity-config2018-06-18 ([get-cloud-front-origin-access-identity-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-config-request get-cloud-front-origin-access-identity-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-config-result))

(clojure.core/defn list-invalidations2018-06-18 ([list-invalidations-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-invalidations-request list-invalidations-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-invalidations-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-invalidations-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef list-invalidations2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/list-invalidations-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-invalidations-result))

(clojure.core/defn delete-public-key2018-06-18 ([delete-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-public-key-request delete-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "PublicKeyInUse" :portkey.aws.cloudfront/public-key-in-use, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-public-key-request) :ret clojure.core/true?)

(clojure.core/defn untag-resource2018-06-18 ([untag-resource-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-untag-resource-request untag-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/tagging?Operation=Untag", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/untag-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InvalidTagging" :portkey.aws.cloudfront/invalid-tagging, "NoSuchResource" :portkey.aws.cloudfront/no-such-resource}})))))
(clojure.spec.alpha/fdef untag-resource2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/untag-resource-request) :ret clojure.core/true?)

(clojure.core/defn get-cloud-front-origin-access-identity2018-06-18 ([get-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-cloud-front-origin-access-identity-request get-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront/no-such-cloud-front-origin-access-identity, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-cloud-front-origin-access-identity-result))

(clojure.core/defn update-cloud-front-origin-access-identity2018-06-18 ([update-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-cloud-front-origin-access-identity-request update-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "MissingBody" :portkey.aws.cloudfront/missing-body, "NoSuchCloudFrontOriginAccessIdentity" :portkey.aws.cloudfront/no-such-cloud-front-origin-access-identity, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef update-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-cloud-front-origin-access-identity-result))

(clojure.core/defn update-streaming-distribution2018-06-18 ([update-streaming-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-streaming-distribution-request update-streaming-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-streaming-distribution-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-streaming-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"TooManyStreamingDistributionCNAMEs" :portkey.aws.cloudfront/too-many-streaming-distributioncnames, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchStreamingDistribution" :portkey.aws.cloudfront/no-such-streaming-distribution, "CNAMEAlreadyExists" :portkey.aws.cloudfront/cnamealready-exists, "MissingBody" :portkey.aws.cloudfront/missing-body, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "InvalidOriginAccessIdentity" :portkey.aws.cloudfront/invalid-origin-access-identity, "TooManyTrustedSigners" :portkey.aws.cloudfront/too-many-trusted-signers, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities, "TrustedSignerDoesNotExist" :portkey.aws.cloudfront/trusted-signer-does-not-exist}})))))
(clojure.spec.alpha/fdef update-streaming-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-streaming-distribution-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-streaming-distribution-result))

(clojure.core/defn get-distribution-config2018-06-18 ([get-distribution-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-distribution-config-request get-distribution-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-distribution-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-distribution-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "AccessDenied" :portkey.aws.cloudfront/access-denied}})))))
(clojure.spec.alpha/fdef get-distribution-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-distribution-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-distribution-config-result))

(clojure.core/defn get-public-key-config2018-06-18 ([get-public-key-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-public-key-config-request get-public-key-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-public-key-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-public-key-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key}})))))
(clojure.spec.alpha/fdef get-public-key-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-public-key-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-public-key-config-result))

(clojure.core/defn list-cloud-front-origin-access-identities2018-06-18 ([] (list-cloud-front-origin-access-identities2018-06-18 {})) ([list-cloud-front-origin-access-identities-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-cloud-front-origin-access-identities-request list-cloud-front-origin-access-identities-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-cloud-front-origin-access-identities-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-cloud-front-origin-access-identities-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-cloud-front-origin-access-identities2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-cloud-front-origin-access-identities-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-cloud-front-origin-access-identities-result))

(clojure.core/defn list-streaming-distributions2018-06-18 ([] (list-streaming-distributions2018-06-18 {})) ([list-streaming-distributions-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-streaming-distributions-request list-streaming-distributions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-streaming-distributions-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/streaming-distribution", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-streaming-distributions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument}})))))
(clojure.spec.alpha/fdef list-streaming-distributions2018-06-18 :args (clojure.spec.alpha/? :portkey.aws.cloudfront/list-streaming-distributions-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-streaming-distributions-result))

(clojure.core/defn update-public-key2018-06-18 ([update-public-key-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-update-public-key-request update-public-key-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/update-public-key-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/public-key/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/update-public-key-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :put, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "CannotChangeImmutablePublicKeyFields" :portkey.aws.cloudfront/cannot-change-immutable-public-key-fields, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "IllegalUpdate" :portkey.aws.cloudfront/illegal-update, "NoSuchPublicKey" :portkey.aws.cloudfront/no-such-public-key, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed}})))))
(clojure.spec.alpha/fdef update-public-key2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/update-public-key-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/update-public-key-result))

(clojure.core/defn get-field-level-encryption-config2018-06-18 ([get-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-get-field-level-encryption-config-request get-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/get-field-level-encryption-config-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}/config", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/get-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config}})))))
(clojure.spec.alpha/fdef get-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/get-field-level-encryption-config-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/get-field-level-encryption-config-result))

(clojure.core/defn delete-distribution2018-06-18 ([delete-distribution-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-distribution-request delete-distribution-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-distribution-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "DistributionNotDisabled" :portkey.aws.cloudfront/distribution-not-disabled, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed}})))))
(clojure.spec.alpha/fdef delete-distribution2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-distribution-request) :ret clojure.core/true?)

(clojure.core/defn create-invalidation2018-06-18 ([create-invalidation-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-invalidation-request create-invalidation-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-invalidation-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distribution/{DistributionId}/invalidation", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-invalidation-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "MissingBody" :portkey.aws.cloudfront/missing-body, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "NoSuchDistribution" :portkey.aws.cloudfront/no-such-distribution, "BatchTooLarge" :portkey.aws.cloudfront/batch-too-large, "TooManyInvalidationsInProgress" :portkey.aws.cloudfront/too-many-invalidations-in-progress, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-invalidation2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-invalidation-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-invalidation-result))

(clojure.core/defn delete-field-level-encryption-config2018-06-18 ([delete-field-level-encryption-config-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-delete-field-level-encryption-config-request delete-field-level-encryption-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/field-level-encryption/{Id}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/delete-field-level-encryption-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code 204, :http.request.spec/error-spec {"AccessDenied" :portkey.aws.cloudfront/access-denied, "InvalidIfMatchVersion" :portkey.aws.cloudfront/invalid-if-match-version, "NoSuchFieldLevelEncryptionConfig" :portkey.aws.cloudfront/no-such-field-level-encryption-config, "PreconditionFailed" :portkey.aws.cloudfront/precondition-failed, "FieldLevelEncryptionConfigInUse" :portkey.aws.cloudfront/field-level-encryption-config-in-use}})))))
(clojure.spec.alpha/fdef delete-field-level-encryption-config2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/delete-field-level-encryption-config-request) :ret clojure.core/true?)

(clojure.core/defn list-distributions-by-webaclid2018-06-18 ([list-distributions-by-webaclid-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-list-distributions-by-webaclid-request list-distributions-by-webaclid-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/list-distributions-by-webaclid-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/distributionsByWebACLId/{WebACLId}", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/list-distributions-by-webaclid-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InvalidWebACLId" :portkey.aws.cloudfront/invalid-webaclid}})))))
(clojure.spec.alpha/fdef list-distributions-by-webaclid2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/list-distributions-by-webaclid-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/list-distributions-by-webaclid-result))

(clojure.core/defn create-cloud-front-origin-access-identity2018-06-18 ([create-cloud-front-origin-access-identity-request-input] (clojure.core/let [request-function-result__306690__auto__ (req<-create-cloud-front-origin-access-identity-request create-cloud-front-origin-access-identity-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__306690__auto__ {:http.request.configuration/endpoints portkey.aws.cloudfront/endpoints, :http.request.spec/output-spec :portkey.aws.cloudfront/create-cloud-front-origin-access-identity-result, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2018-06-18/origin-access-identity/cloudfront", :http.request.configuration/service-id "CloudFront", :http.request.spec/input-spec :portkey.aws.cloudfront/create-cloud-front-origin-access-identity-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"CloudFrontOriginAccessIdentityAlreadyExists" :portkey.aws.cloudfront/cloud-front-origin-access-identity-already-exists, "MissingBody" :portkey.aws.cloudfront/missing-body, "TooManyCloudFrontOriginAccessIdentities" :portkey.aws.cloudfront/too-many-cloud-front-origin-access-identities, "InvalidArgument" :portkey.aws.cloudfront/invalid-argument, "InconsistentQuantities" :portkey.aws.cloudfront/inconsistent-quantities}})))))
(clojure.spec.alpha/fdef create-cloud-front-origin-access-identity2018-06-18 :args (clojure.spec.alpha/tuple :portkey.aws.cloudfront/create-cloud-front-origin-access-identity-request) :ret (clojure.spec.alpha/and :portkey.aws.cloudfront/create-cloud-front-origin-access-identity-result))
