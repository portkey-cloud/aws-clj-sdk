...
(clojure.core/defn- deser-cookie-names [input] (clojure.core/let [letvar38870 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar38870 ["Quantity" :content]))} (letvar38870 "Items") (clojure.core/assoc :items (deser-cookie-name-list (clojure.core/get-in letvar38870 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile [input] (clojure.core/let [letvar38966 {"Format" (portkey.aws/search-for-tag input "Format" :flattened? false :xmlAttribute? nil), "ProfileId" (portkey.aws/search-for-tag input "ProfileId" :flattened? false :xmlAttribute? nil), "ContentType" (portkey.aws/search-for-tag input "ContentType" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:format (deser-format (clojure.core/get-in letvar38966 ["Format" :content])), :content-type (deserstring (clojure.core/get-in letvar38966 ["ContentType" :content]))} (letvar38966 "ProfileId") (clojure.core/assoc :profile-id (deserstring (clojure.core/get-in letvar38966 ["ProfileId" :content]))))))

(clojure.core/defn- deser-logging-config [input] (clojure.core/let [letvar39062 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "IncludeCookies" (portkey.aws/search-for-tag input "IncludeCookies" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar39062 ["Enabled" :content])), :include-cookies (deserboolean (clojure.core/get-in letvar39062 ["IncludeCookies" :content])), :bucket (deserstring (clojure.core/get-in letvar39062 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar39062 ["Prefix" :content]))})))

(clojure.core/defn- deser-invalidation-summary [input] (clojure.core/let [letvar39158 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar39158 ["Id" :content])), :create-time (desertimestamp (clojure.core/get-in letvar39158 ["CreateTime" :content])), :status (deserstring (clojure.core/get-in letvar39158 ["Status" :content]))})))
...
(clojure.core/defn- deser-invalidation [input] (clojure.core/let [letvar39271 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "CreateTime" (portkey.aws/search-for-tag input "CreateTime" :flattened? false :xmlAttribute? nil), "InvalidationBatch" (portkey.aws/search-for-tag input "InvalidationBatch" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar39271 ["Id" :content])), :status (deserstring (clojure.core/get-in letvar39271 ["Status" :content])), :create-time (desertimestamp (clojure.core/get-in letvar39271 ["CreateTime" :content])), :invalidation-batch (deser-invalidation-batch (clojure.core/get-in letvar39271 ["InvalidationBatch" :content]))})))
...
(clojure.core/defn- deser-field-patterns [input] (clojure.core/let [letvar39406 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar39406 ["Quantity" :content]))} (letvar39406 "Items") (clojure.core/assoc :items (deser-field-pattern-list (clojure.core/get-in letvar39406 ["Items" :content]))))))

(clojure.core/defn- deser-restrictions [input] (clojure.core/let [letvar39502 {"GeoRestriction" (portkey.aws/search-for-tag input "GeoRestriction" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:geo-restriction (deser-geo-restriction (clojure.core/get-in letvar39502 ["GeoRestriction" :content]))})))

(clojure.core/defn- deser-field-level-encryption-profile-config [input] (clojure.core/let [letvar39598 {"Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "EncryptionEntities" (portkey.aws/search-for-tag input "EncryptionEntities" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:name (deserstring (clojure.core/get-in letvar39598 ["Name" :content])), :caller-reference (deserstring (clojure.core/get-in letvar39598 ["CallerReference" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar39598 ["EncryptionEntities" :content]))} (letvar39598 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar39598 ["Comment" :content]))))))

(clojure.core/defn- deserstring [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-field-level-encryption-config [input] (clojure.core/let [letvar39699 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "QueryArgProfileConfig" (portkey.aws/search-for-tag input "QueryArgProfileConfig" :flattened? false :xmlAttribute? nil), "ContentTypeProfileConfig" (portkey.aws/search-for-tag input "ContentTypeProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar39699 ["CallerReference" :content]))} (letvar39699 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar39699 ["Comment" :content]))) (letvar39699 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar39699 ["QueryArgProfileConfig" :content]))) (letvar39699 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar39699 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-field-level-encryption-profile [input] (clojure.core/let [letvar39795 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionProfileConfig" (portkey.aws/search-for-tag input "FieldLevelEncryptionProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar39795 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar39795 ["LastModifiedTime" :content])), :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar39795 ["FieldLevelEncryptionProfileConfig" :content]))})))

(clojure.core/defn- deser-distribution [input] (clojure.core/let [letvar39891 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "InProgressInvalidationBatches" (portkey.aws/search-for-tag input "InProgressInvalidationBatches" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "DistributionConfig" (portkey.aws/search-for-tag input "DistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar39891 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar39891 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar39891 ["Status" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar39891 ["LastModifiedTime" :content])), :in-progress-invalidation-batches (deserinteger (clojure.core/get-in letvar39891 ["InProgressInvalidationBatches" :content])), :domain-name (deserstring (clojure.core/get-in letvar39891 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar39891 ["ActiveTrustedSigners" :content])), :distribution-config (deser-distribution-config (clojure.core/get-in letvar39891 ["DistributionConfig" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity-list [input] (clojure.core/let [letvar39987 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar39987 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar39987 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar39987 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar39987 ["Quantity" :content]))} (letvar39987 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar39987 ["NextMarker" :content]))) (letvar39987 "Items") (clojure.core/assoc :items (deser-cloud-front-origin-access-identity-summary-list (clojure.core/get-in letvar39987 ["Items" :content]))))))

(clojure.core/defn- deser-query-arg-profile [input] (clojure.core/let [letvar40083 {"QueryArg" (portkey.aws/search-for-tag input "QueryArg" :flattened? false :xmlAttribute? nil), "ProfileId" (portkey.aws/search-for-tag input "ProfileId" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-arg (deserstring (clojure.core/get-in letvar40083 ["QueryArg" :content])), :profile-id (deserstring (clojure.core/get-in letvar40083 ["ProfileId" :content]))})))

(clojure.core/defn- deser-lambda-function-association [input] (clojure.core/let [letvar40179 {"LambdaFunctionARN" (portkey.aws/search-for-tag input "LambdaFunctionARN" :flattened? false :xmlAttribute? nil), "EventType" (portkey.aws/search-for-tag input "EventType" :flattened? false :xmlAttribute? nil), "IncludeBody" (portkey.aws/search-for-tag input "IncludeBody" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:lambda-function-arn (deser-lambda-function-arn (clojure.core/get-in letvar40179 ["LambdaFunctionARN" :content])), :event-type (deser-event-type (clojure.core/get-in letvar40179 ["EventType" :content]))} (letvar40179 "IncludeBody") (clojure.core/assoc :include-body (deserboolean (clojure.core/get-in letvar40179 ["IncludeBody" :content]))))))

(clojure.core/defn- deser-forwarded-values [input] (clojure.core/let [letvar40275 {"QueryString" (portkey.aws/search-for-tag input "QueryString" :flattened? false :xmlAttribute? nil), "Cookies" (portkey.aws/search-for-tag input "Cookies" :flattened? false :xmlAttribute? nil), "Headers" (portkey.aws/search-for-tag input "Headers" :flattened? false :xmlAttribute? nil), "QueryStringCacheKeys" (portkey.aws/search-for-tag input "QueryStringCacheKeys" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:query-string (deserboolean (clojure.core/get-in letvar40275 ["QueryString" :content])), :cookies (deser-cookie-preference (clojure.core/get-in letvar40275 ["Cookies" :content]))} (letvar40275 "Headers") (clojure.core/assoc :headers (deser-headers (clojure.core/get-in letvar40275 ["Headers" :content]))) (letvar40275 "QueryStringCacheKeys") (clojure.core/assoc :query-string-cache-keys (deser-query-string-cache-keys (clojure.core/get-in letvar40275 ["QueryStringCacheKeys" :content]))))))

(clojure.core/defn- deser-invalidation-batch [input] (clojure.core/let [letvar40371 {"Paths" (portkey.aws/search-for-tag input "Paths" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:paths (deser-paths (clojure.core/get-in letvar40371 ["Paths" :content])), :caller-reference (deserstring (clojure.core/get-in letvar40371 ["CallerReference" :content]))})))
...
(clojure.core/defn- deser-streaming-distribution-list [input] (clojure.core/let [letvar40501 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar40501 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar40501 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar40501 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar40501 ["Quantity" :content]))} (letvar40501 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar40501 ["NextMarker" :content]))) (letvar40501 "Items") (clojure.core/assoc :items (deser-streaming-distribution-summary-list (clojure.core/get-in letvar40501 ["Items" :content]))))))

(clojure.core/defn- deser-public-key-config [input] (clojure.core/let [letvar40597 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "EncodedKey" (portkey.aws/search-for-tag input "EncodedKey" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar40597 ["CallerReference" :content])), :name (deserstring (clojure.core/get-in letvar40597 ["Name" :content])), :encoded-key (deserstring (clojure.core/get-in letvar40597 ["EncodedKey" :content]))} (letvar40597 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar40597 ["Comment" :content]))))))
...
(clojure.core/defn- deser-streaming-distribution [input] (clojure.core/let [letvar40715 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "ActiveTrustedSigners" (portkey.aws/search-for-tag input "ActiveTrustedSigners" :flattened? false :xmlAttribute? nil), "StreamingDistributionConfig" (portkey.aws/search-for-tag input "StreamingDistributionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar40715 ["Id" :content])), :arn (deserstring (clojure.core/get-in letvar40715 ["ARN" :content])), :status (deserstring (clojure.core/get-in letvar40715 ["Status" :content])), :domain-name (deserstring (clojure.core/get-in letvar40715 ["DomainName" :content])), :active-trusted-signers (deser-active-trusted-signers (clojure.core/get-in letvar40715 ["ActiveTrustedSigners" :content])), :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar40715 ["StreamingDistributionConfig" :content]))} (letvar40715 "LastModifiedTime") (clojure.core/assoc :last-modified-time (desertimestamp (clojure.core/get-in letvar40715 ["LastModifiedTime" :content]))))))

(clojure.core/defn- deser-lambda-function-associations [input] (clojure.core/let [letvar40811 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar40811 ["Quantity" :content]))} (letvar40811 "Items") (clojure.core/assoc :items (deser-lambda-function-association-list (clojure.core/get-in letvar40811 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entities [input] (clojure.core/let [letvar40907 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar40907 ["Quantity" :content]))} (letvar40907 "Items") (clojure.core/assoc :items (deser-encryption-entity-list (clojure.core/get-in letvar40907 ["Items" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-summary [input] (clojure.core/let [letvar41008 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "EncryptionEntities" (portkey.aws/search-for-tag input "EncryptionEntities" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar41008 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar41008 ["LastModifiedTime" :content])), :name (deserstring (clojure.core/get-in letvar41008 ["Name" :content])), :encryption-entities (deser-encryption-entities (clojure.core/get-in letvar41008 ["EncryptionEntities" :content]))} (letvar41008 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar41008 ["Comment" :content]))))))
...
(clojure.core/defn- deser-custom-error-response [input] (clojure.core/let [letvar41121 {"ErrorCode" (portkey.aws/search-for-tag input "ErrorCode" :flattened? false :xmlAttribute? nil), "ResponsePagePath" (portkey.aws/search-for-tag input "ResponsePagePath" :flattened? false :xmlAttribute? nil), "ResponseCode" (portkey.aws/search-for-tag input "ResponseCode" :flattened? false :xmlAttribute? nil), "ErrorCachingMinTTL" (portkey.aws/search-for-tag input "ErrorCachingMinTTL" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:error-code (deserinteger (clojure.core/get-in letvar41121 ["ErrorCode" :content]))} (letvar41121 "ResponsePagePath") (clojure.core/assoc :response-page-path (deserstring (clojure.core/get-in letvar41121 ["ResponsePagePath" :content]))) (letvar41121 "ResponseCode") (clojure.core/assoc :response-code (deserstring (clojure.core/get-in letvar41121 ["ResponseCode" :content]))) (letvar41121 "ErrorCachingMinTTL") (clojure.core/assoc :error-caching-min-ttl (deserlong (clojure.core/get-in letvar41121 ["ErrorCachingMinTTL" :content]))))))
...
(clojure.core/defn- deser-signer [input] (clojure.core/let [letvar41234 {"AwsAccountNumber" (portkey.aws/search-for-tag input "AwsAccountNumber" :flattened? false :xmlAttribute? nil), "KeyPairIds" (portkey.aws/search-for-tag input "KeyPairIds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar41234 "AwsAccountNumber") (clojure.core/assoc :aws-account-number (deserstring (clojure.core/get-in letvar41234 ["AwsAccountNumber" :content]))) (letvar41234 "KeyPairIds") (clojure.core/assoc :key-pair-ids (deser-key-pair-ids (clojure.core/get-in letvar41234 ["KeyPairIds" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption-profile-list [input] (clojure.core/let [letvar41349 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar41349 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar41349 ["Quantity" :content]))} (letvar41349 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar41349 ["NextMarker" :content]))) (letvar41349 "Items") (clojure.core/assoc :items (deser-field-level-encryption-profile-summary-list (clojure.core/get-in letvar41349 ["Items" :content]))))))

(clojure.core/defn- deser-content-type-profile-config [input] (clojure.core/let [letvar41445 {"ForwardWhenContentTypeIsUnknown" (portkey.aws/search-for-tag input "ForwardWhenContentTypeIsUnknown" :flattened? false :xmlAttribute? nil), "ContentTypeProfiles" (portkey.aws/search-for-tag input "ContentTypeProfiles" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward-when-content-type-is-unknown (deserboolean (clojure.core/get-in letvar41445 ["ForwardWhenContentTypeIsUnknown" :content]))} (letvar41445 "ContentTypeProfiles") (clojure.core/assoc :content-type-profiles (deser-content-type-profiles (clojure.core/get-in letvar41445 ["ContentTypeProfiles" :content]))))))

(clojure.core/defn- deser-cached-methods [input] (clojure.core/let [letvar41541 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar41541 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar41541 ["Items" :content]))})))

(clojure.core/defn- deser-tag-key [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-tags [input] (clojure.core/let [letvar41642 {"Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar41642 "Items") (clojure.core/assoc :items (deser-tag-list (clojure.core/get-in letvar41642 ["Items" :content]))))))
...
(clojure.core/defn- deser-cache-behaviors [input] (clojure.core/let [letvar41772 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar41772 ["Quantity" :content]))} (letvar41772 "Items") (clojure.core/assoc :items (deser-cache-behavior-list (clojure.core/get-in letvar41772 ["Items" :content]))))))

(clojure.core/defn- deser-cache-behavior [input] (clojure.core/let [letvar41868 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionId" (portkey.aws/search-for-tag input "FieldLevelEncryptionId" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "PathPattern" (portkey.aws/search-for-tag input "PathPattern" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:path-pattern (deserstring (clojure.core/get-in letvar41868 ["PathPattern" :content])), :target-origin-id (deserstring (clojure.core/get-in letvar41868 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar41868 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar41868 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar41868 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar41868 ["MinTTL" :content]))} (letvar41868 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar41868 ["SmoothStreaming" :content]))) (letvar41868 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar41868 ["FieldLevelEncryptionId" :content]))) (letvar41868 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar41868 ["Compress" :content]))) (letvar41868 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar41868 ["LambdaFunctionAssociations" :content]))) (letvar41868 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar41868 ["MaxTTL" :content]))) (letvar41868 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar41868 ["AllowedMethods" :content]))) (letvar41868 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar41868 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-active-trusted-signers [input] (clojure.core/let [letvar41964 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar41964 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar41964 ["Quantity" :content]))} (letvar41964 "Items") (clojure.core/assoc :items (deser-signer-list (clojure.core/get-in letvar41964 ["Items" :content]))))))

(clojure.core/defn- deser-origin [input] (clojure.core/let [letvar42060 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginPath" (portkey.aws/search-for-tag input "OriginPath" :flattened? false :xmlAttribute? nil), "CustomHeaders" (portkey.aws/search-for-tag input "CustomHeaders" :flattened? false :xmlAttribute? nil), "S3OriginConfig" (portkey.aws/search-for-tag input "S3OriginConfig" :flattened? false :xmlAttribute? nil), "CustomOriginConfig" (portkey.aws/search-for-tag input "CustomOriginConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar42060 ["Id" :content])), :domain-name (deserstring (clojure.core/get-in letvar42060 ["DomainName" :content]))} (letvar42060 "OriginPath") (clojure.core/assoc :origin-path (deserstring (clojure.core/get-in letvar42060 ["OriginPath" :content]))) (letvar42060 "CustomHeaders") (clojure.core/assoc :custom-headers (deser-custom-headers (clojure.core/get-in letvar42060 ["CustomHeaders" :content]))) (letvar42060 "S3OriginConfig") (clojure.core/assoc :s-3-origin-config (deser-s-3-origin-config (clojure.core/get-in letvar42060 ["S3OriginConfig" :content]))) (letvar42060 "CustomOriginConfig") (clojure.core/assoc :custom-origin-config (deser-custom-origin-config (clojure.core/get-in letvar42060 ["CustomOriginConfig" :content]))))))
...
(clojure.core/defn- deser-custom-error-responses [input] (clojure.core/let [letvar42163 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar42163 ["Quantity" :content]))} (letvar42163 "Items") (clojure.core/assoc :items (deser-custom-error-response-list (clojure.core/get-in letvar42163 ["Items" :content]))))))

(clojure.core/defn- deser-invalidation-list [input] (clojure.core/let [letvar42259 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar42259 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar42259 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar42259 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar42259 ["Quantity" :content]))} (letvar42259 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar42259 ["NextMarker" :content]))) (letvar42259 "Items") (clojure.core/assoc :items (deser-invalidation-summary-list (clojure.core/get-in letvar42259 ["Items" :content]))))))

(clojure.core/defn- deser-origin-ssl-protocols [input] (clojure.core/let [letvar42355 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar42355 ["Quantity" :content])), :items (deser-ssl-protocols-list (clojure.core/get-in letvar42355 ["Items" :content]))})))

(clojure.core/defn- deser-aliases [input] (clojure.core/let [letvar42451 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar42451 ["Quantity" :content]))} (letvar42451 "Items") (clojure.core/assoc :items (deser-alias-list (clojure.core/get-in letvar42451 ["Items" :content]))))))
...
(clojure.core/defn- deser-content-type-profiles [input] (clojure.core/let [letvar42552 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar42552 ["Quantity" :content]))} (letvar42552 "Items") (clojure.core/assoc :items (deser-content-type-profile-list (clojure.core/get-in letvar42552 ["Items" :content]))))))

(clojure.core/defn- deser-encryption-entity [input] (clojure.core/let [letvar42648 {"PublicKeyId" (portkey.aws/search-for-tag input "PublicKeyId" :flattened? false :xmlAttribute? nil), "ProviderId" (portkey.aws/search-for-tag input "ProviderId" :flattened? false :xmlAttribute? nil), "FieldPatterns" (portkey.aws/search-for-tag input "FieldPatterns" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:public-key-id (deserstring (clojure.core/get-in letvar42648 ["PublicKeyId" :content])), :provider-id (deserstring (clojure.core/get-in letvar42648 ["ProviderId" :content])), :field-patterns (deser-field-patterns (clojure.core/get-in letvar42648 ["FieldPatterns" :content]))})))

(clojure.core/defn- deser-lambda-function-arn [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-allowed-methods [input] (clojure.core/let [letvar42749 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil), "CachedMethods" (portkey.aws/search-for-tag input "CachedMethods" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar42749 ["Quantity" :content])), :items (deser-methods-list (clojure.core/get-in letvar42749 ["Items" :content]))} (letvar42749 "CachedMethods") (clojure.core/assoc :cached-methods (deser-cached-methods (clojure.core/get-in letvar42749 ["CachedMethods" :content]))))))
...
(clojure.core/defn- deser-custom-origin-config [input] (clojure.core/let [letvar42850 {"HTTPPort" (portkey.aws/search-for-tag input "HTTPPort" :flattened? false :xmlAttribute? nil), "HTTPSPort" (portkey.aws/search-for-tag input "HTTPSPort" :flattened? false :xmlAttribute? nil), "OriginProtocolPolicy" (portkey.aws/search-for-tag input "OriginProtocolPolicy" :flattened? false :xmlAttribute? nil), "OriginSslProtocols" (portkey.aws/search-for-tag input "OriginSslProtocols" :flattened? false :xmlAttribute? nil), "OriginReadTimeout" (portkey.aws/search-for-tag input "OriginReadTimeout" :flattened? false :xmlAttribute? nil), "OriginKeepaliveTimeout" (portkey.aws/search-for-tag input "OriginKeepaliveTimeout" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:http-port (deserinteger (clojure.core/get-in letvar42850 ["HTTPPort" :content])), :https-port (deserinteger (clojure.core/get-in letvar42850 ["HTTPSPort" :content])), :origin-protocol-policy (deser-origin-protocol-policy (clojure.core/get-in letvar42850 ["OriginProtocolPolicy" :content]))} (letvar42850 "OriginSslProtocols") (clojure.core/assoc :origin-ssl-protocols (deser-origin-ssl-protocols (clojure.core/get-in letvar42850 ["OriginSslProtocols" :content]))) (letvar42850 "OriginReadTimeout") (clojure.core/assoc :origin-read-timeout (deserinteger (clojure.core/get-in letvar42850 ["OriginReadTimeout" :content]))) (letvar42850 "OriginKeepaliveTimeout") (clojure.core/assoc :origin-keepalive-timeout (deserinteger (clojure.core/get-in letvar42850 ["OriginKeepaliveTimeout" :content]))))))

(clojure.core/defn- deser-s-3-origin [input] (clojure.core/let [letvar42946 {"DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar42946 ["DomainName" :content])), :origin-access-identity (deserstring (clojure.core/get-in letvar42946 ["OriginAccessIdentity" :content]))})))

(clojure.core/defn- deser-streaming-distribution-summary [input] (clojure.core/let [letvar43042 {"Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:domain-name (deserstring (clojure.core/get-in letvar43042 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar43042 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar43042 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar43042 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar43042 ["TrustedSigners" :content])), :aliases (deser-aliases (clojure.core/get-in letvar43042 ["Aliases" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar43042 ["S3Origin" :content])), :enabled (deserboolean (clojure.core/get-in letvar43042 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar43042 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar43042 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar43042 ["PriceClass" :content]))})))

(clojure.core/defn- deser-cloud-front-origin-access-identity [input] (clojure.core/let [letvar43138 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag input "CloudFrontOriginAccessIdentityConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar43138 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar43138 ["S3CanonicalUserId" :content]))} (letvar43138 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar43138 ["CloudFrontOriginAccessIdentityConfig" :content]))))))
...
(clojure.core/defn- deser-field-level-encryption [input] (clojure.core/let [letvar43251 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionConfig" (portkey.aws/search-for-tag input "FieldLevelEncryptionConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar43251 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar43251 ["LastModifiedTime" :content])), :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar43251 ["FieldLevelEncryptionConfig" :content]))})))

(clojure.core/defn- deser-tag-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deser-tag coll))) input))

(clojure.core/defn- deser-query-string-cache-keys [input] (clojure.core/let [letvar43364 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar43364 ["Quantity" :content]))} (letvar43364 "Items") (clojure.core/assoc :items (deser-query-string-cache-keys-list (clojure.core/get-in letvar43364 ["Items" :content]))))))

(clojure.core/defn- deser-key-pair-ids [input] (clojure.core/let [letvar43460 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar43460 ["Quantity" :content]))} (letvar43460 "Items") (clojure.core/assoc :items (deser-key-pair-id-list (clojure.core/get-in letvar43460 ["Items" :content]))))))

(clojure.core/defn- deser-distribution-config [input] (clojure.core/let [letvar43556 {"DefaultRootObject" (portkey.aws/search-for-tag input "DefaultRootObject" :flattened? false :xmlAttribute? nil), "CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar43556 ["CallerReference" :content])), :origins (deser-origins (clojure.core/get-in letvar43556 ["Origins" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar43556 ["DefaultCacheBehavior" :content])), :comment (deserstring (clojure.core/get-in letvar43556 ["Comment" :content])), :enabled (deserboolean (clojure.core/get-in letvar43556 ["Enabled" :content]))} (letvar43556 "DefaultRootObject") (clojure.core/assoc :default-root-object (deserstring (clojure.core/get-in letvar43556 ["DefaultRootObject" :content]))) (letvar43556 "IsIPV6Enabled") (clojure.core/assoc :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar43556 ["IsIPV6Enabled" :content]))) (letvar43556 "Restrictions") (clojure.core/assoc :restrictions (deser-restrictions (clojure.core/get-in letvar43556 ["Restrictions" :content]))) (letvar43556 "WebACLId") (clojure.core/assoc :web-acl-id (deserstring (clojure.core/get-in letvar43556 ["WebACLId" :content]))) (letvar43556 "Logging") (clojure.core/assoc :logging (deser-logging-config (clojure.core/get-in letvar43556 ["Logging" :content]))) (letvar43556 "CacheBehaviors") (clojure.core/assoc :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar43556 ["CacheBehaviors" :content]))) (letvar43556 "CustomErrorResponses") (clojure.core/assoc :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar43556 ["CustomErrorResponses" :content]))) (letvar43556 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar43556 ["Aliases" :content]))) (letvar43556 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar43556 ["PriceClass" :content]))) (letvar43556 "HttpVersion") (clojure.core/assoc :http-version (deser-http-version (clojure.core/get-in letvar43556 ["HttpVersion" :content]))) (letvar43556 "ViewerCertificate") (clojure.core/assoc :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar43556 ["ViewerCertificate" :content]))))))

(clojure.core/defn- deser-public-key-summary [input] (clojure.core/let [letvar43652 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CreatedTime" (portkey.aws/search-for-tag input "CreatedTime" :flattened? false :xmlAttribute? nil), "EncodedKey" (portkey.aws/search-for-tag input "EncodedKey" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar43652 ["Id" :content])), :name (deserstring (clojure.core/get-in letvar43652 ["Name" :content])), :created-time (desertimestamp (clojure.core/get-in letvar43652 ["CreatedTime" :content])), :encoded-key (deserstring (clojure.core/get-in letvar43652 ["EncodedKey" :content]))} (letvar43652 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar43652 ["Comment" :content]))))))
...
(clojure.core/defn- deser-query-arg-profile-config [input] (clojure.core/let [letvar43826 {"ForwardWhenQueryArgProfileIsUnknown" (portkey.aws/search-for-tag input "ForwardWhenQueryArgProfileIsUnknown" :flattened? false :xmlAttribute? nil), "QueryArgProfiles" (portkey.aws/search-for-tag input "QueryArgProfiles" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward-when-query-arg-profile-is-unknown (deserboolean (clojure.core/get-in letvar43826 ["ForwardWhenQueryArgProfileIsUnknown" :content]))} (letvar43826 "QueryArgProfiles") (clojure.core/assoc :query-arg-profiles (deser-query-arg-profiles (clojure.core/get-in letvar43826 ["QueryArgProfiles" :content]))))))
...
(clojure.core/defn- deser-query-arg-profiles [input] (clojure.core/let [letvar43944 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar43944 ["Quantity" :content]))} (letvar43944 "Items") (clojure.core/assoc :items (deser-query-arg-profile-list (clojure.core/get-in letvar43944 ["Items" :content]))))))
...
(clojure.core/defn- deser-paths [input] (clojure.core/let [letvar44062 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar44062 ["Quantity" :content]))} (letvar44062 "Items") (clojure.core/assoc :items (deser-path-list (clojure.core/get-in letvar44062 ["Items" :content]))))))
...
(clojure.core/defn- deser-cloud-front-origin-access-identity-summary [input] (clojure.core/let [letvar44177 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "S3CanonicalUserId" (portkey.aws/search-for-tag input "S3CanonicalUserId" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar44177 ["Id" :content])), :s-3-canonical-user-id (deserstring (clojure.core/get-in letvar44177 ["S3CanonicalUserId" :content])), :comment (deserstring (clojure.core/get-in letvar44177 ["Comment" :content]))})))
...
(clojure.core/defn- deser-origin-custom-header [input] (clojure.core/let [letvar44290 {"HeaderName" (portkey.aws/search-for-tag input "HeaderName" :flattened? false :xmlAttribute? nil), "HeaderValue" (portkey.aws/search-for-tag input "HeaderValue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:header-name (deserstring (clojure.core/get-in letvar44290 ["HeaderName" :content])), :header-value (deserstring (clojure.core/get-in letvar44290 ["HeaderValue" :content]))})))

(clojure.core/defn- deser-streaming-distribution-config [input] (clojure.core/let [letvar44386 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "S3Origin" (portkey.aws/search-for-tag input "S3Origin" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "Logging" (portkey.aws/search-for-tag input "Logging" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar44386 ["CallerReference" :content])), :s-3-origin (deser-s-3-origin (clojure.core/get-in letvar44386 ["S3Origin" :content])), :comment (deserstring (clojure.core/get-in letvar44386 ["Comment" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar44386 ["TrustedSigners" :content])), :enabled (deserboolean (clojure.core/get-in letvar44386 ["Enabled" :content]))} (letvar44386 "Aliases") (clojure.core/assoc :aliases (deser-aliases (clojure.core/get-in letvar44386 ["Aliases" :content]))) (letvar44386 "Logging") (clojure.core/assoc :logging (deser-streaming-logging-config (clojure.core/get-in letvar44386 ["Logging" :content]))) (letvar44386 "PriceClass") (clojure.core/assoc :price-class (deser-price-class (clojure.core/get-in letvar44386 ["PriceClass" :content]))))))
...
(clojure.core/defn- deser-s-3-origin-config [input] (clojure.core/let [letvar44516 {"OriginAccessIdentity" (portkey.aws/search-for-tag input "OriginAccessIdentity" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origin-access-identity (deserstring (clojure.core/get-in letvar44516 ["OriginAccessIdentity" :content]))})))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar44629 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-tag-key (clojure.core/get-in letvar44629 ["Key" :content]))} (letvar44629 "Value") (clojure.core/assoc :value (deser-tag-value (clojure.core/get-in letvar44629 ["Value" :content]))))))

(clojure.core/defn- deser-streaming-logging-config [input] (clojure.core/let [letvar44725 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar44725 ["Enabled" :content])), :bucket (deserstring (clojure.core/get-in letvar44725 ["Bucket" :content])), :prefix (deserstring (clojure.core/get-in letvar44725 ["Prefix" :content]))})))

(clojure.core/defn- deser-field-level-encryption-summary [input] (clojure.core/let [letvar44821 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "QueryArgProfileConfig" (portkey.aws/search-for-tag input "QueryArgProfileConfig" :flattened? false :xmlAttribute? nil), "ContentTypeProfileConfig" (portkey.aws/search-for-tag input "ContentTypeProfileConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar44821 ["Id" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar44821 ["LastModifiedTime" :content]))} (letvar44821 "Comment") (clojure.core/assoc :comment (deserstring (clojure.core/get-in letvar44821 ["Comment" :content]))) (letvar44821 "QueryArgProfileConfig") (clojure.core/assoc :query-arg-profile-config (deser-query-arg-profile-config (clojure.core/get-in letvar44821 ["QueryArgProfileConfig" :content]))) (letvar44821 "ContentTypeProfileConfig") (clojure.core/assoc :content-type-profile-config (deser-content-type-profile-config (clojure.core/get-in letvar44821 ["ContentTypeProfileConfig" :content]))))))

(clojure.core/defn- deser-distribution-summary [input] (clojure.core/let [letvar44917 {"IsIPV6Enabled" (portkey.aws/search-for-tag input "IsIPV6Enabled" :flattened? false :xmlAttribute? nil), "Restrictions" (portkey.aws/search-for-tag input "Restrictions" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil), "WebACLId" (portkey.aws/search-for-tag input "WebACLId" :flattened? false :xmlAttribute? nil), "ARN" (portkey.aws/search-for-tag input "ARN" :flattened? false :xmlAttribute? nil), "CacheBehaviors" (portkey.aws/search-for-tag input "CacheBehaviors" :flattened? false :xmlAttribute? nil), "CustomErrorResponses" (portkey.aws/search-for-tag input "CustomErrorResponses" :flattened? false :xmlAttribute? nil), "Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Aliases" (portkey.aws/search-for-tag input "Aliases" :flattened? false :xmlAttribute? nil), "PriceClass" (portkey.aws/search-for-tag input "PriceClass" :flattened? false :xmlAttribute? nil), "LastModifiedTime" (portkey.aws/search-for-tag input "LastModifiedTime" :flattened? false :xmlAttribute? nil), "DomainName" (portkey.aws/search-for-tag input "DomainName" :flattened? false :xmlAttribute? nil), "Origins" (portkey.aws/search-for-tag input "Origins" :flattened? false :xmlAttribute? nil), "HttpVersion" (portkey.aws/search-for-tag input "HttpVersion" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "DefaultCacheBehavior" (portkey.aws/search-for-tag input "DefaultCacheBehavior" :flattened? false :xmlAttribute? nil), "ViewerCertificate" (portkey.aws/search-for-tag input "ViewerCertificate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:origins (deser-origins (clojure.core/get-in letvar44917 ["Origins" :content])), :restrictions (deser-restrictions (clojure.core/get-in letvar44917 ["Restrictions" :content])), :web-acl-id (deserstring (clojure.core/get-in letvar44917 ["WebACLId" :content])), :is-ipv-6-enabled (deserboolean (clojure.core/get-in letvar44917 ["IsIPV6Enabled" :content])), :cache-behaviors (deser-cache-behaviors (clojure.core/get-in letvar44917 ["CacheBehaviors" :content])), :default-cache-behavior (deser-default-cache-behavior (clojure.core/get-in letvar44917 ["DefaultCacheBehavior" :content])), :viewer-certificate (deser-viewer-certificate (clojure.core/get-in letvar44917 ["ViewerCertificate" :content])), :http-version (deser-http-version (clojure.core/get-in letvar44917 ["HttpVersion" :content])), :domain-name (deserstring (clojure.core/get-in letvar44917 ["DomainName" :content])), :status (deserstring (clojure.core/get-in letvar44917 ["Status" :content])), :id (deserstring (clojure.core/get-in letvar44917 ["Id" :content])), :comment (deserstring (clojure.core/get-in letvar44917 ["Comment" :content])), :aliases (deser-aliases (clojure.core/get-in letvar44917 ["Aliases" :content])), :custom-error-responses (deser-custom-error-responses (clojure.core/get-in letvar44917 ["CustomErrorResponses" :content])), :enabled (deserboolean (clojure.core/get-in letvar44917 ["Enabled" :content])), :last-modified-time (desertimestamp (clojure.core/get-in letvar44917 ["LastModifiedTime" :content])), :arn (deserstring (clojure.core/get-in letvar44917 ["ARN" :content])), :price-class (deser-price-class (clojure.core/get-in letvar44917 ["PriceClass" :content]))})))
...
(clojure.core/defn- deser-headers [input] (clojure.core/let [letvar45035 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar45035 ["Quantity" :content]))} (letvar45035 "Items") (clojure.core/assoc :items (deser-header-list (clojure.core/get-in letvar45035 ["Items" :content]))))))
...
(clojure.core/defn- deser-origins [input] (clojure.core/let [letvar45136 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar45136 ["Quantity" :content]))} (letvar45136 "Items") (clojure.core/assoc :items (deser-origin-list (clojure.core/get-in letvar45136 ["Items" :content]))))))

(clojure.core/defn- deser-header-list [input] (clojure.core/into [] (clojure.core/map (clojure.core/fn [coll] (deserstring coll))) input))

(clojure.core/defn- deser-distribution-list [input] (clojure.core/let [letvar45249 {"Marker" (portkey.aws/search-for-tag input "Marker" :flattened? false :xmlAttribute? nil), "NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "IsTruncated" (portkey.aws/search-for-tag input "IsTruncated" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:marker (deserstring (clojure.core/get-in letvar45249 ["Marker" :content])), :max-items (deserinteger (clojure.core/get-in letvar45249 ["MaxItems" :content])), :is-truncated (deserboolean (clojure.core/get-in letvar45249 ["IsTruncated" :content])), :quantity (deserinteger (clojure.core/get-in letvar45249 ["Quantity" :content]))} (letvar45249 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar45249 ["NextMarker" :content]))) (letvar45249 "Items") (clojure.core/assoc :items (deser-distribution-summary-list (clojure.core/get-in letvar45249 ["Items" :content]))))))
...
(clojure.core/defn- deser-cookie-preference [input] (clojure.core/let [letvar45355 {"Forward" (portkey.aws/search-for-tag input "Forward" :flattened? false :xmlAttribute? nil), "WhitelistedNames" (portkey.aws/search-for-tag input "WhitelistedNames" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:forward (deser-item-selection (clojure.core/get-in letvar45355 ["Forward" :content]))} (letvar45355 "WhitelistedNames") (clojure.core/assoc :whitelisted-names (deser-cookie-names (clojure.core/get-in letvar45355 ["WhitelistedNames" :content]))))))

(clojure.core/defn- deser-custom-headers [input] (clojure.core/let [letvar45451 {"Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:quantity (deserinteger (clojure.core/get-in letvar45451 ["Quantity" :content]))} (letvar45451 "Items") (clojure.core/assoc :items (deser-origin-custom-headers-list (clojure.core/get-in letvar45451 ["Items" :content]))))))
...
(clojure.core/defn- deser-public-key-list [input] (clojure.core/let [letvar45564 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar45564 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar45564 ["Quantity" :content]))} (letvar45564 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar45564 ["NextMarker" :content]))) (letvar45564 "Items") (clojure.core/assoc :items (deser-public-key-summary-list (clojure.core/get-in letvar45564 ["Items" :content]))))))

(clojure.core/defn- deser-default-cache-behavior [input] (clojure.core/let [letvar45660 {"SmoothStreaming" (portkey.aws/search-for-tag input "SmoothStreaming" :flattened? false :xmlAttribute? nil), "FieldLevelEncryptionId" (portkey.aws/search-for-tag input "FieldLevelEncryptionId" :flattened? false :xmlAttribute? nil), "Compress" (portkey.aws/search-for-tag input "Compress" :flattened? false :xmlAttribute? nil), "ForwardedValues" (portkey.aws/search-for-tag input "ForwardedValues" :flattened? false :xmlAttribute? nil), "TargetOriginId" (portkey.aws/search-for-tag input "TargetOriginId" :flattened? false :xmlAttribute? nil), "LambdaFunctionAssociations" (portkey.aws/search-for-tag input "LambdaFunctionAssociations" :flattened? false :xmlAttribute? nil), "ViewerProtocolPolicy" (portkey.aws/search-for-tag input "ViewerProtocolPolicy" :flattened? false :xmlAttribute? nil), "MinTTL" (portkey.aws/search-for-tag input "MinTTL" :flattened? false :xmlAttribute? nil), "MaxTTL" (portkey.aws/search-for-tag input "MaxTTL" :flattened? false :xmlAttribute? nil), "AllowedMethods" (portkey.aws/search-for-tag input "AllowedMethods" :flattened? false :xmlAttribute? nil), "DefaultTTL" (portkey.aws/search-for-tag input "DefaultTTL" :flattened? false :xmlAttribute? nil), "TrustedSigners" (portkey.aws/search-for-tag input "TrustedSigners" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-origin-id (deserstring (clojure.core/get-in letvar45660 ["TargetOriginId" :content])), :forwarded-values (deser-forwarded-values (clojure.core/get-in letvar45660 ["ForwardedValues" :content])), :trusted-signers (deser-trusted-signers (clojure.core/get-in letvar45660 ["TrustedSigners" :content])), :viewer-protocol-policy (deser-viewer-protocol-policy (clojure.core/get-in letvar45660 ["ViewerProtocolPolicy" :content])), :min-ttl (deserlong (clojure.core/get-in letvar45660 ["MinTTL" :content]))} (letvar45660 "SmoothStreaming") (clojure.core/assoc :smooth-streaming (deserboolean (clojure.core/get-in letvar45660 ["SmoothStreaming" :content]))) (letvar45660 "FieldLevelEncryptionId") (clojure.core/assoc :field-level-encryption-id (deserstring (clojure.core/get-in letvar45660 ["FieldLevelEncryptionId" :content]))) (letvar45660 "Compress") (clojure.core/assoc :compress (deserboolean (clojure.core/get-in letvar45660 ["Compress" :content]))) (letvar45660 "LambdaFunctionAssociations") (clojure.core/assoc :lambda-function-associations (deser-lambda-function-associations (clojure.core/get-in letvar45660 ["LambdaFunctionAssociations" :content]))) (letvar45660 "MaxTTL") (clojure.core/assoc :max-ttl (deserlong (clojure.core/get-in letvar45660 ["MaxTTL" :content]))) (letvar45660 "AllowedMethods") (clojure.core/assoc :allowed-methods (deser-allowed-methods (clojure.core/get-in letvar45660 ["AllowedMethods" :content]))) (letvar45660 "DefaultTTL") (clojure.core/assoc :default-ttl (deserlong (clojure.core/get-in letvar45660 ["DefaultTTL" :content]))))))

(clojure.core/defn- deser-trusted-signers [input] (clojure.core/let [letvar45756 {"Enabled" (portkey.aws/search-for-tag input "Enabled" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:enabled (deserboolean (clojure.core/get-in letvar45756 ["Enabled" :content])), :quantity (deserinteger (clojure.core/get-in letvar45756 ["Quantity" :content]))} (letvar45756 "Items") (clojure.core/assoc :items (deser-aws-account-number-list (clojure.core/get-in letvar45756 ["Items" :content]))))))

(clojure.core/defn- deser-field-level-encryption-list [input] (clojure.core/let [letvar45852 {"NextMarker" (portkey.aws/search-for-tag input "NextMarker" :flattened? false :xmlAttribute? nil), "MaxItems" (portkey.aws/search-for-tag input "MaxItems" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:max-items (deserinteger (clojure.core/get-in letvar45852 ["MaxItems" :content])), :quantity (deserinteger (clojure.core/get-in letvar45852 ["Quantity" :content]))} (letvar45852 "NextMarker") (clojure.core/assoc :next-marker (deserstring (clojure.core/get-in letvar45852 ["NextMarker" :content]))) (letvar45852 "Items") (clojure.core/assoc :items (deser-field-level-encryption-summary-list (clojure.core/get-in letvar45852 ["Items" :content]))))))

(clojure.core/defn- deser-public-key [input] (clojure.core/let [letvar45948 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CreatedTime" (portkey.aws/search-for-tag input "CreatedTime" :flattened? false :xmlAttribute? nil), "PublicKeyConfig" (portkey.aws/search-for-tag input "PublicKeyConfig" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deserstring (clojure.core/get-in letvar45948 ["Id" :content])), :created-time (desertimestamp (clojure.core/get-in letvar45948 ["CreatedTime" :content])), :public-key-config (deser-public-key-config (clojure.core/get-in letvar45948 ["PublicKeyConfig" :content]))})))
...
(clojure.core/defn- deser-viewer-certificate [input] (clojure.core/let [letvar46061 {"CloudFrontDefaultCertificate" (portkey.aws/search-for-tag input "CloudFrontDefaultCertificate" :flattened? false :xmlAttribute? nil), "IAMCertificateId" (portkey.aws/search-for-tag input "IAMCertificateId" :flattened? false :xmlAttribute? nil), "ACMCertificateArn" (portkey.aws/search-for-tag input "ACMCertificateArn" :flattened? false :xmlAttribute? nil), "SSLSupportMethod" (portkey.aws/search-for-tag input "SSLSupportMethod" :flattened? false :xmlAttribute? nil), "MinimumProtocolVersion" (portkey.aws/search-for-tag input "MinimumProtocolVersion" :flattened? false :xmlAttribute? nil), "Certificate" (portkey.aws/search-for-tag input "Certificate" :flattened? false :xmlAttribute? nil), "CertificateSource" (portkey.aws/search-for-tag input "CertificateSource" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar46061 "CloudFrontDefaultCertificate") (clojure.core/assoc :cloud-front-default-certificate (deserboolean (clojure.core/get-in letvar46061 ["CloudFrontDefaultCertificate" :content]))) (letvar46061 "IAMCertificateId") (clojure.core/assoc :iam-certificate-id (deserstring (clojure.core/get-in letvar46061 ["IAMCertificateId" :content]))) (letvar46061 "ACMCertificateArn") (clojure.core/assoc :acm-certificate-arn (deserstring (clojure.core/get-in letvar46061 ["ACMCertificateArn" :content]))) (letvar46061 "SSLSupportMethod") (clojure.core/assoc :ssl-support-method (deser-ssl-support-method (clojure.core/get-in letvar46061 ["SSLSupportMethod" :content]))) (letvar46061 "MinimumProtocolVersion") (clojure.core/assoc :minimum-protocol-version (deser-minimum-protocol-version (clojure.core/get-in letvar46061 ["MinimumProtocolVersion" :content]))) (letvar46061 "Certificate") (clojure.core/assoc :certificate (deserstring (clojure.core/get-in letvar46061 ["Certificate" :content]))) (letvar46061 "CertificateSource") (clojure.core/assoc :certificate-source (deser-certificate-source (clojure.core/get-in letvar46061 ["CertificateSource" :content]))))))

(clojure.core/defn- deser-cloud-front-origin-access-identity-config [input] (clojure.core/let [letvar46157 {"CallerReference" (portkey.aws/search-for-tag input "CallerReference" :flattened? false :xmlAttribute? nil), "Comment" (portkey.aws/search-for-tag input "Comment" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:caller-reference (deserstring (clojure.core/get-in letvar46157 ["CallerReference" :content])), :comment (deserstring (clojure.core/get-in letvar46157 ["Comment" :content]))})))

(clojure.core/defn- deser-geo-restriction [input] (clojure.core/let [letvar46253 {"RestrictionType" (portkey.aws/search-for-tag input "RestrictionType" :flattened? false :xmlAttribute? nil), "Quantity" (portkey.aws/search-for-tag input "Quantity" :flattened? false :xmlAttribute? nil), "Items" (portkey.aws/search-for-tag input "Items" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:restriction-type (deser-geo-restriction-type (clojure.core/get-in letvar46253 ["RestrictionType" :content])), :quantity (deserinteger (clojure.core/get-in letvar46253 ["Quantity" :content]))} (letvar46253 "Items") (clojure.core/assoc :items (deser-location-list (clojure.core/get-in letvar46253 ["Items" :content]))))))

(clojure.core/defn- response-list-tags-for-resource-result [input] (clojure.core/let [rawinput46254 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46255 {"Tags" (portkey.aws/search-for-tag rawinput46254 "Tags" :flattened? false)}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar46255 ["Tags" :content]))})))

(clojure.core/defn- response-too-many-distributions-with-lambda-associations [input] (clojure.core/let [rawinput46256 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46257 {"Message" (portkey.aws/search-for-tag rawinput46256 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46257 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46257 ["Message" :content]))))))

(clojure.core/defn- response-no-such-origin [input] (clojure.core/let [rawinput46258 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46259 {"Message" (portkey.aws/search-for-tag rawinput46258 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46259 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46259 ["Message" :content]))))))

(clojure.core/defn- response-invalid-protocol-settings [input] (clojure.core/let [rawinput46260 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46261 {"Message" (portkey.aws/search-for-tag rawinput46260 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46261 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46261 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cookie-names-in-white-list [input] (clojure.core/let [rawinput46262 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46263 {"Message" (portkey.aws/search-for-tag rawinput46262 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46263 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46263 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cache-behaviors [input] (clojure.core/let [rawinput46264 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46265 {"Message" (portkey.aws/search-for-tag rawinput46264 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46265 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46265 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origin-custom-headers [input] (clojure.core/let [rawinput46266 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46267 {"Message" (portkey.aws/search-for-tag rawinput46266 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46267 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46267 ["Message" :content]))))))

(clojure.core/defn- response-create-field-level-encryption-config-result [input] (clojure.core/let [rawinput46268 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46269 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput46268 "FieldLevelEncryption" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46269 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar46269 ["FieldLevelEncryption" :content]))) (letvar46269 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46269 ["Location"]))) (letvar46269 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46269 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distributions [input] (clojure.core/let [rawinput46270 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46271 {"Message" (portkey.aws/search-for-tag rawinput46270 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46271 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46271 ["Message" :content]))))))

(clojure.core/defn- response-get-streaming-distribution-result [input] (clojure.core/let [rawinput46272 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46273 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput46272 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46273 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar46273 ["StreamingDistribution" :content]))) (letvar46273 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46273 ["ETag"]))))))

(clojure.core/defn- response-too-many-streaming-distribution-cnam-es [input] (clojure.core/let [rawinput46274 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46275 {"Message" (portkey.aws/search-for-tag rawinput46274 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46275 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46275 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-already-exists [input] (clojure.core/let [rawinput46276 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46277 {"Message" (portkey.aws/search-for-tag rawinput46276 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46277 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46277 ["Message" :content]))))))

(clojure.core/defn- response-invalid-viewer-certificate [input] (clojure.core/let [rawinput46278 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46279 {"Message" (portkey.aws/search-for-tag rawinput46278 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46279 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46279 ["Message" :content]))))))

(clojure.core/defn- response-get-public-key-config-result [input] (clojure.core/let [rawinput46280 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46281 {"PublicKeyConfig" (portkey.aws/search-for-tag rawinput46280 "PublicKeyConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46281 "PublicKeyConfig") (clojure.core/assoc :public-key-config (deser-public-key-config (clojure.core/get-in letvar46281 ["PublicKeyConfig" :content]))) (letvar46281 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46281 ["ETag"]))))))

(clojure.core/defn- response-invalid-argument [input] (clojure.core/let [rawinput46282 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46283 {"Message" (portkey.aws/search-for-tag rawinput46282 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46283 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46283 ["Message" :content]))))))

(clojure.core/defn- response-no-such-public-key [input] (clojure.core/let [rawinput46284 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46285 {"Message" (portkey.aws/search-for-tag rawinput46284 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46285 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46285 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-not-disabled [input] (clojure.core/let [rawinput46286 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46287 {"Message" (portkey.aws/search-for-tag rawinput46286 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46287 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46287 ["Message" :content]))))))

(clojure.core/defn- response-illegal-field-level-encryption-config-association-with-cache-behavior [input] (clojure.core/let [rawinput46288 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46289 {"Message" (portkey.aws/search-for-tag rawinput46288 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46289 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46289 ["Message" :content]))))))

(clojure.core/defn- response-too-many-certificates [input] (clojure.core/let [rawinput46290 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46291 {"Message" (portkey.aws/search-for-tag rawinput46290 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46291 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46291 ["Message" :content]))))))

(clojure.core/defn- response-access-denied [input] (clojure.core/let [rawinput46292 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46293 {"Message" (portkey.aws/search-for-tag rawinput46292 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46293 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46293 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-in-use [input] (clojure.core/let [rawinput46294 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46295 {"Message" (portkey.aws/search-for-tag rawinput46294 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46295 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46295 ["Message" :content]))))))

(clojure.core/defn- response-cannot-change-immutable-public-key-fields [input] (clojure.core/let [rawinput46296 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46297 {"Message" (portkey.aws/search-for-tag rawinput46296 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46297 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46297 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-size-exceeded [input] (clojure.core/let [rawinput46298 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46299 {"Message" (portkey.aws/search-for-tag rawinput46298 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46299 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46299 ["Message" :content]))))))

(clojure.core/defn- response-invalid-lambda-function-association [input] (clojure.core/let [rawinput46300 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46301 {"Message" (portkey.aws/search-for-tag rawinput46300 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46301 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46301 ["Message" :content]))))))

(clojure.core/defn- response-create-field-level-encryption-profile-result [input] (clojure.core/let [rawinput46302 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46303 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput46302 "FieldLevelEncryptionProfile" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46303 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar46303 ["FieldLevelEncryptionProfile" :content]))) (letvar46303 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46303 ["Location"]))) (letvar46303 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46303 ["ETag"]))))))

(clojure.core/defn- response-get-field-level-encryption-profile-result [input] (clojure.core/let [rawinput46304 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46305 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput46304 "FieldLevelEncryptionProfile" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46305 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar46305 ["FieldLevelEncryptionProfile" :content]))) (letvar46305 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46305 ["ETag"]))))))

(clojure.core/defn- response-no-such-resource [input] (clojure.core/let [rawinput46306 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46307 {"Message" (portkey.aws/search-for-tag rawinput46306 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46307 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46307 ["Message" :content]))))))

(clojure.core/defn- response-update-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput46308 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46309 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput46308 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46309 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar46309 ["CloudFrontOriginAccessIdentity" :content]))) (letvar46309 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46309 ["ETag"]))))))

(clojure.core/defn- response-invalid-error-code [input] (clojure.core/let [rawinput46310 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46311 {"Message" (portkey.aws/search-for-tag rawinput46310 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46311 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46311 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-profile-in-use [input] (clojure.core/let [rawinput46312 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46313 {"Message" (portkey.aws/search-for-tag rawinput46312 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46313 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46313 ["Message" :content]))))))

(clojure.core/defn- response-too-many-lambda-function-associations [input] (clojure.core/let [rawinput46314 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46315 {"Message" (portkey.aws/search-for-tag rawinput46314 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46315 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46315 ["Message" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-result [input] (clojure.core/let [rawinput46316 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46317 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput46316 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46317 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar46317 ["StreamingDistribution" :content]))) (letvar46317 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46317 ["Location"]))) (letvar46317 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46317 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-profiles [input] (clojure.core/let [rawinput46318 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46319 {"Message" (portkey.aws/search-for-tag rawinput46318 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46319 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46319 ["Message" :content]))))))

(clojure.core/defn- response-no-such-field-level-encryption-profile [input] (clojure.core/let [rawinput46320 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46321 {"Message" (portkey.aws/search-for-tag rawinput46320 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46321 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46321 ["Message" :content]))))))

(clojure.core/defn- response-invalid-relative-path [input] (clojure.core/let [rawinput46322 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46323 {"Message" (portkey.aws/search-for-tag rawinput46322 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46323 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46323 ["Message" :content]))))))

(clojure.core/defn- response-create-public-key-result [input] (clojure.core/let [rawinput46324 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46325 {"PublicKey" (portkey.aws/search-for-tag rawinput46324 "PublicKey" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46325 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar46325 ["PublicKey" :content]))) (letvar46325 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46325 ["Location"]))) (letvar46325 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46325 ["ETag"]))))))

(clojure.core/defn- response-invalid-location-code [input] (clojure.core/let [rawinput46326 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46327 {"Message" (portkey.aws/search-for-tag rawinput46326 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46327 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46327 ["Message" :content]))))))

(clojure.core/defn- response-invalid-web-acl-id [input] (clojure.core/let [rawinput46328 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46329 {"Message" (portkey.aws/search-for-tag rawinput46328 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46329 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46329 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin [input] (clojure.core/let [rawinput46330 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46331 {"Message" (portkey.aws/search-for-tag rawinput46330 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46331 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46331 ["Message" :content]))))))

(clojure.core/defn- response-too-many-cloud-front-origin-access-identities [input] (clojure.core/let [rawinput46332 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46333 {"Message" (portkey.aws/search-for-tag rawinput46332 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46333 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46333 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-config-already-exists [input] (clojure.core/let [rawinput46334 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46335 {"Message" (portkey.aws/search-for-tag rawinput46334 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46335 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46335 ["Message" :content]))))))

(clojure.core/defn- response-no-such-field-level-encryption-config [input] (clojure.core/let [rawinput46336 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46337 {"Message" (portkey.aws/search-for-tag rawinput46336 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46337 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46337 ["Message" :content]))))))

(clojure.core/defn- response-update-distribution-result [input] (clojure.core/let [rawinput46338 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46339 {"Distribution" (portkey.aws/search-for-tag rawinput46338 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46339 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar46339 ["Distribution" :content]))) (letvar46339 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46339 ["ETag"]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput46340 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46341 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput46340 "CloudFrontOriginAccessIdentity" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46341 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar46341 ["CloudFrontOriginAccessIdentity" :content]))) (letvar46341 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46341 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-encryption-entities [input] (clojure.core/let [rawinput46342 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46343 {"Message" (portkey.aws/search-for-tag rawinput46342 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46343 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46343 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-result [input] (clojure.core/let [rawinput46344 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46345 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput46344 "FieldLevelEncryption" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46345 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar46345 ["FieldLevelEncryption" :content]))) (letvar46345 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46345 ["ETag"]))))))

(clojure.core/defn- response-invalid-query-string-parameters [input] (clojure.core/let [rawinput46346 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46347 {"Message" (portkey.aws/search-for-tag rawinput46346 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46347 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46347 ["Message" :content]))))))

(clojure.core/defn- response-public-key-already-exists [input] (clojure.core/let [rawinput46348 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46349 {"Message" (portkey.aws/search-for-tag rawinput46348 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46349 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46349 ["Message" :content]))))))

(clojure.core/defn- response-too-many-origins [input] (clojure.core/let [rawinput46350 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46351 {"Message" (portkey.aws/search-for-tag rawinput46350 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46351 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46351 ["Message" :content]))))))

(clojure.core/defn- response-invalid-ttl-order [input] (clojure.core/let [rawinput46352 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46353 {"Message" (portkey.aws/search-for-tag rawinput46352 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46353 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46353 ["Message" :content]))))))

(clojure.core/defn- response-no-such-streaming-distribution [input] (clojure.core/let [rawinput46354 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46355 {"Message" (portkey.aws/search-for-tag rawinput46354 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46355 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46355 ["Message" :content]))))))

(clojure.core/defn- response-create-cloud-front-origin-access-identity-result [input] (clojure.core/let [rawinput46356 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46357 {"CloudFrontOriginAccessIdentity" (portkey.aws/search-for-tag rawinput46356 "CloudFrontOriginAccessIdentity" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46357 "CloudFrontOriginAccessIdentity") (clojure.core/assoc :cloud-front-origin-access-identity (deser-cloud-front-origin-access-identity (clojure.core/get-in letvar46357 ["CloudFrontOriginAccessIdentity" :content]))) (letvar46357 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46357 ["Location"]))) (letvar46357 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46357 ["ETag"]))))))

(clojure.core/defn- response-cname-already-exists [input] (clojure.core/let [rawinput46358 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46359 {"Message" (portkey.aws/search-for-tag rawinput46358 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46359 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46359 ["Message" :content]))))))

(clojure.core/defn- response-invalid-default-root-object [input] (clojure.core/let [rawinput46360 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46361 {"Message" (portkey.aws/search-for-tag rawinput46360 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46361 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46361 ["Message" :content]))))))

(clojure.core/defn- response-invalid-response-code [input] (clojure.core/let [rawinput46362 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46363 {"Message" (portkey.aws/search-for-tag rawinput46362 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46363 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46363 ["Message" :content]))))))

(clojure.core/defn- response-no-such-invalidation [input] (clojure.core/let [rawinput46364 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46365 {"Message" (portkey.aws/search-for-tag rawinput46364 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46365 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46365 ["Message" :content]))))))

(clojure.core/defn- response-too-many-invalidations-in-progress [input] (clojure.core/let [rawinput46366 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46367 {"Message" (portkey.aws/search-for-tag rawinput46366 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46367 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46367 ["Message" :content]))))))

(clojure.core/defn- response-get-public-key-result [input] (clojure.core/let [rawinput46368 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46369 {"PublicKey" (portkey.aws/search-for-tag rawinput46368 "PublicKey" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46369 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar46369 ["PublicKey" :content]))) (letvar46369 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46369 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions-associated-to-field-level-encryption-config [input] (clojure.core/let [rawinput46370 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46371 {"Message" (portkey.aws/search-for-tag rawinput46370 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46371 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46371 ["Message" :content]))))))

(clojure.core/defn- response-list-cloud-front-origin-access-identities-result [input] (clojure.core/let [rawinput46372 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46373 {"CloudFrontOriginAccessIdentityList" (portkey.aws/search-for-tag rawinput46372 "CloudFrontOriginAccessIdentityList" :flattened? false)}] (clojure.core/cond-> {} (letvar46373 "CloudFrontOriginAccessIdentityList") (clojure.core/assoc :cloud-front-origin-access-identity-list (deser-cloud-front-origin-access-identity-list (clojure.core/get-in letvar46373 ["CloudFrontOriginAccessIdentityList" :content]))))))

(clojure.core/defn- response-update-public-key-result [input] (clojure.core/let [rawinput46374 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46375 {"PublicKey" (portkey.aws/search-for-tag rawinput46374 "PublicKey" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46375 "PublicKey") (clojure.core/assoc :public-key (deser-public-key (clojure.core/get-in letvar46375 ["PublicKey" :content]))) (letvar46375 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46375 ["ETag"]))))))

(clojure.core/defn- response-invalid-forward-cookies [input] (clojure.core/let [rawinput46376 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46377 {"Message" (portkey.aws/search-for-tag rawinput46376 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46377 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46377 ["Message" :content]))))))

(clojure.core/defn- response-get-distribution-config-result [input] (clojure.core/let [rawinput46378 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46379 {"DistributionConfig" (portkey.aws/search-for-tag rawinput46378 "DistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46379 "DistributionConfig") (clojure.core/assoc :distribution-config (deser-distribution-config (clojure.core/get-in letvar46379 ["DistributionConfig" :content]))) (letvar46379 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46379 ["ETag"]))))))

(clojure.core/defn- response-invalid-required-protocol [input] (clojure.core/let [rawinput46380 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46381 {"Message" (portkey.aws/search-for-tag rawinput46380 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46381 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46381 ["Message" :content]))))))

(clojure.core/defn- response-update-field-level-encryption-config-result [input] (clojure.core/let [rawinput46382 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46383 {"FieldLevelEncryption" (portkey.aws/search-for-tag rawinput46382 "FieldLevelEncryption" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46383 "FieldLevelEncryption") (clojure.core/assoc :field-level-encryption (deser-field-level-encryption (clojure.core/get-in letvar46383 ["FieldLevelEncryption" :content]))) (letvar46383 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46383 ["ETag"]))))))

(clojure.core/defn- response-get-distribution-result [input] (clojure.core/let [rawinput46384 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46385 {"Distribution" (portkey.aws/search-for-tag rawinput46384 "Distribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46385 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar46385 ["Distribution" :content]))) (letvar46385 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46385 ["ETag"]))))))

(clojure.core/defn- response-update-field-level-encryption-profile-result [input] (clojure.core/let [rawinput46386 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46387 {"FieldLevelEncryptionProfile" (portkey.aws/search-for-tag rawinput46386 "FieldLevelEncryptionProfile" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46387 "FieldLevelEncryptionProfile") (clojure.core/assoc :field-level-encryption-profile (deser-field-level-encryption-profile (clojure.core/get-in letvar46387 ["FieldLevelEncryptionProfile" :content]))) (letvar46387 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46387 ["ETag"]))))))

(clojure.core/defn- response-get-streaming-distribution-config-result [input] (clojure.core/let [rawinput46388 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46389 {"StreamingDistributionConfig" (portkey.aws/search-for-tag rawinput46388 "StreamingDistributionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46389 "StreamingDistributionConfig") (clojure.core/assoc :streaming-distribution-config (deser-streaming-distribution-config (clojure.core/get-in letvar46389 ["StreamingDistributionConfig" :content]))) (letvar46389 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46389 ["ETag"]))))))

(clojure.core/defn- response-list-public-keys-result [input] (clojure.core/let [rawinput46390 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46391 {"PublicKeyList" (portkey.aws/search-for-tag rawinput46390 "PublicKeyList" :flattened? false)}] (clojure.core/cond-> {} (letvar46391 "PublicKeyList") (clojure.core/assoc :public-key-list (deser-public-key-list (clojure.core/get-in letvar46391 ["PublicKeyList" :content]))))))

(clojure.core/defn- response-invalid-headers-for-s-3-origin [input] (clojure.core/let [rawinput46392 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46393 {"Message" (portkey.aws/search-for-tag rawinput46392 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46393 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46393 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-config-result [input] (clojure.core/let [rawinput46394 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46395 {"FieldLevelEncryptionConfig" (portkey.aws/search-for-tag rawinput46394 "FieldLevelEncryptionConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46395 "FieldLevelEncryptionConfig") (clojure.core/assoc :field-level-encryption-config (deser-field-level-encryption-config (clojure.core/get-in letvar46395 ["FieldLevelEncryptionConfig" :content]))) (letvar46395 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46395 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-configs [input] (clojure.core/let [rawinput46396 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46397 {"Message" (portkey.aws/search-for-tag rawinput46396 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46397 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46397 ["Message" :content]))))))

(clojure.core/defn- response-field-level-encryption-config-in-use [input] (clojure.core/let [rawinput46398 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46399 {"Message" (portkey.aws/search-for-tag rawinput46398 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46399 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46399 ["Message" :content]))))))

(clojure.core/defn- response-too-many-distribution-cnam-es [input] (clojure.core/let [rawinput46400 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46401 {"Message" (portkey.aws/search-for-tag rawinput46400 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46401 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46401 ["Message" :content]))))))

(clojure.core/defn- response-invalid-geo-restriction-parameter [input] (clojure.core/let [rawinput46402 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46403 {"Message" (portkey.aws/search-for-tag rawinput46402 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46403 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46403 ["Message" :content]))))))

(clojure.core/defn- response-no-such-cloud-front-origin-access-identity [input] (clojure.core/let [rawinput46404 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46405 {"Message" (portkey.aws/search-for-tag rawinput46404 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46405 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46405 ["Message" :content]))))))

(clojure.core/defn- response-list-invalidations-result [input] (clojure.core/let [rawinput46406 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46407 {"InvalidationList" (portkey.aws/search-for-tag rawinput46406 "InvalidationList" :flattened? false)}] (clojure.core/cond-> {} (letvar46407 "InvalidationList") (clojure.core/assoc :invalidation-list (deser-invalidation-list (clojure.core/get-in letvar46407 ["InvalidationList" :content]))))))

(clojure.core/defn- response-batch-too-large [input] (clojure.core/let [rawinput46408 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46409 {"Message" (portkey.aws/search-for-tag rawinput46408 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46409 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46409 ["Message" :content]))))))

(clojure.core/defn- response-create-distribution-with-tags-result [input] (clojure.core/let [rawinput46410 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46411 {"Distribution" (portkey.aws/search-for-tag rawinput46410 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46411 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar46411 ["Distribution" :content]))) (letvar46411 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46411 ["Location"]))) (letvar46411 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46411 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-query-arg-profiles [input] (clojure.core/let [rawinput46412 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46413 {"Message" (portkey.aws/search-for-tag rawinput46412 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46413 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46413 ["Message" :content]))))))

(clojure.core/defn- response-list-streaming-distributions-result [input] (clojure.core/let [rawinput46414 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46415 {"StreamingDistributionList" (portkey.aws/search-for-tag rawinput46414 "StreamingDistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar46415 "StreamingDistributionList") (clojure.core/assoc :streaming-distribution-list (deser-streaming-distribution-list (clojure.core/get-in letvar46415 ["StreamingDistributionList" :content]))))))

(clojure.core/defn- response-create-streaming-distribution-with-tags-result [input] (clojure.core/let [rawinput46416 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46417 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput46416 "StreamingDistribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46417 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar46417 ["StreamingDistribution" :content]))) (letvar46417 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46417 ["Location"]))) (letvar46417 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46417 ["ETag"]))))))

(clojure.core/defn- response-create-invalidation-result [input] (clojure.core/let [rawinput46418 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46419 {"Location" (clojure.core/get-in input [:headers "Location"]), "Invalidation" (portkey.aws/search-for-tag rawinput46418 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar46419 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46419 ["Location"]))) (letvar46419 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar46419 ["Invalidation" :content]))))))

(clojure.core/defn- response-missing-body [input] (clojure.core/let [rawinput46420 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46421 {"Message" (portkey.aws/search-for-tag rawinput46420 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46421 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46421 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-read-timeout [input] (clojure.core/let [rawinput46422 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46423 {"Message" (portkey.aws/search-for-tag rawinput46422 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46423 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46423 ["Message" :content]))))))

(clojure.core/defn- response-get-cloud-front-origin-access-identity-config-result [input] (clojure.core/let [rawinput46424 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46425 {"CloudFrontOriginAccessIdentityConfig" (portkey.aws/search-for-tag rawinput46424 "CloudFrontOriginAccessIdentityConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46425 "CloudFrontOriginAccessIdentityConfig") (clojure.core/assoc :cloud-front-origin-access-identity-config (deser-cloud-front-origin-access-identity-config (clojure.core/get-in letvar46425 ["CloudFrontOriginAccessIdentityConfig" :content]))) (letvar46425 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46425 ["ETag"]))))))

(clojure.core/defn- response-distribution-not-disabled [input] (clojure.core/let [rawinput46426 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46427 {"Message" (portkey.aws/search-for-tag rawinput46426 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46427 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46427 ["Message" :content]))))))

(clojure.core/defn- response-cloud-front-origin-access-identity-already-exists [input] (clojure.core/let [rawinput46428 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46429 {"Message" (portkey.aws/search-for-tag rawinput46428 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46429 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46429 ["Message" :content]))))))

(clojure.core/defn- response-precondition-failed [input] (clojure.core/let [rawinput46430 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46431 {"Message" (portkey.aws/search-for-tag rawinput46430 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46431 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46431 ["Message" :content]))))))

(clojure.core/defn- response-distribution-already-exists [input] (clojure.core/let [rawinput46432 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46433 {"Message" (portkey.aws/search-for-tag rawinput46432 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46433 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46433 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-access-identity [input] (clojure.core/let [rawinput46434 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46435 {"Message" (portkey.aws/search-for-tag rawinput46434 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46435 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46435 ["Message" :content]))))))

(clojure.core/defn- response-too-many-trusted-signers [input] (clojure.core/let [rawinput46436 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46437 {"Message" (portkey.aws/search-for-tag rawinput46436 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46437 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46437 ["Message" :content]))))))

(clojure.core/defn- response-too-many-public-keys [input] (clojure.core/let [rawinput46438 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46439 {"Message" (portkey.aws/search-for-tag rawinput46438 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46439 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46439 ["Message" :content]))))))

(clojure.core/defn- response-invalid-minimum-protocol-version [input] (clojure.core/let [rawinput46440 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46441 {"Message" (portkey.aws/search-for-tag rawinput46440 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46441 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46441 ["Message" :content]))))))

(clojure.core/defn- response-streaming-distribution-already-exists [input] (clojure.core/let [rawinput46442 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46443 {"Message" (portkey.aws/search-for-tag rawinput46442 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46443 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46443 ["Message" :content]))))))

(clojure.core/defn- response-public-key-in-use [input] (clojure.core/let [rawinput46444 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46445 {"Message" (portkey.aws/search-for-tag rawinput46444 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46445 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46445 ["Message" :content]))))))

(clojure.core/defn- response-invalid-if-match-version [input] (clojure.core/let [rawinput46446 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46447 {"Message" (portkey.aws/search-for-tag rawinput46446 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46447 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46447 ["Message" :content]))))))

(clojure.core/defn- response-list-field-level-encryption-profiles-result [input] (clojure.core/let [rawinput46448 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46449 {"FieldLevelEncryptionProfileList" (portkey.aws/search-for-tag rawinput46448 "FieldLevelEncryptionProfileList" :flattened? false)}] (clojure.core/cond-> {} (letvar46449 "FieldLevelEncryptionProfileList") (clojure.core/assoc :field-level-encryption-profile-list (deser-field-level-encryption-profile-list (clojure.core/get-in letvar46449 ["FieldLevelEncryptionProfileList" :content]))))))

(clojure.core/defn- response-create-distribution-result [input] (clojure.core/let [rawinput46450 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46451 {"Distribution" (portkey.aws/search-for-tag rawinput46450 "Distribution" :flattened? false), "Location" (clojure.core/get-in input [:headers "Location"]), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46451 "Distribution") (clojure.core/assoc :distribution (deser-distribution (clojure.core/get-in letvar46451 ["Distribution" :content]))) (letvar46451 "Location") (clojure.core/assoc :location (deserstring (clojure.core/get-in letvar46451 ["Location"]))) (letvar46451 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46451 ["ETag"]))))))

(clojure.core/defn- response-too-many-distributions [input] (clojure.core/let [rawinput46452 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46453 {"Message" (portkey.aws/search-for-tag rawinput46452 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46453 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46453 ["Message" :content]))))))

(clojure.core/defn- response-list-field-level-encryption-configs-result [input] (clojure.core/let [rawinput46454 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46455 {"FieldLevelEncryptionList" (portkey.aws/search-for-tag rawinput46454 "FieldLevelEncryptionList" :flattened? false)}] (clojure.core/cond-> {} (letvar46455 "FieldLevelEncryptionList") (clojure.core/assoc :field-level-encryption-list (deser-field-level-encryption-list (clojure.core/get-in letvar46455 ["FieldLevelEncryptionList" :content]))))))

(clojure.core/defn- response-no-such-distribution [input] (clojure.core/let [rawinput46456 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46457 {"Message" (portkey.aws/search-for-tag rawinput46456 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46457 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46457 ["Message" :content]))))))

(clojure.core/defn- response-query-arg-profile-empty [input] (clojure.core/let [rawinput46458 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46459 {"Message" (portkey.aws/search-for-tag rawinput46458 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46459 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46459 ["Message" :content]))))))

(clojure.core/defn- response-update-streaming-distribution-result [input] (clojure.core/let [rawinput46460 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46461 {"StreamingDistribution" (portkey.aws/search-for-tag rawinput46460 "StreamingDistribution" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46461 "StreamingDistribution") (clojure.core/assoc :streaming-distribution (deser-streaming-distribution (clojure.core/get-in letvar46461 ["StreamingDistribution" :content]))) (letvar46461 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46461 ["ETag"]))))))

(clojure.core/defn- response-illegal-update [input] (clojure.core/let [rawinput46462 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46463 {"Message" (portkey.aws/search-for-tag rawinput46462 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46463 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46463 ["Message" :content]))))))

(clojure.core/defn- response-get-field-level-encryption-profile-config-result [input] (clojure.core/let [rawinput46464 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46465 {"FieldLevelEncryptionProfileConfig" (portkey.aws/search-for-tag rawinput46464 "FieldLevelEncryptionProfileConfig" :flattened? false), "ETag" (clojure.core/get-in input [:headers "ETag"])}] (clojure.core/cond-> {} (letvar46465 "FieldLevelEncryptionProfileConfig") (clojure.core/assoc :field-level-encryption-profile-config (deser-field-level-encryption-profile-config (clojure.core/get-in letvar46465 ["FieldLevelEncryptionProfileConfig" :content]))) (letvar46465 "ETag") (clojure.core/assoc :e-tag (deserstring (clojure.core/get-in letvar46465 ["ETag"]))))))

(clojure.core/defn- response-too-many-field-level-encryption-content-type-profiles [input] (clojure.core/let [rawinput46466 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46467 {"Message" (portkey.aws/search-for-tag rawinput46466 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46467 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46467 ["Message" :content]))))))

(clojure.core/defn- response-invalid-origin-keepalive-timeout [input] (clojure.core/let [rawinput46468 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46469 {"Message" (portkey.aws/search-for-tag rawinput46468 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46469 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46469 ["Message" :content]))))))

(clojure.core/defn- response-inconsistent-quantities [input] (clojure.core/let [rawinput46470 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46471 {"Message" (portkey.aws/search-for-tag rawinput46470 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46471 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46471 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-by-web-acl-id-result [input] (clojure.core/let [rawinput46472 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46473 {"DistributionList" (portkey.aws/search-for-tag rawinput46472 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar46473 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar46473 ["DistributionList" :content]))))))

(clojure.core/defn- response-too-many-query-string-parameters [input] (clojure.core/let [rawinput46474 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46475 {"Message" (portkey.aws/search-for-tag rawinput46474 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46475 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46475 ["Message" :content]))))))

(clojure.core/defn- response-invalid-tagging [input] (clojure.core/let [rawinput46476 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46477 {"Message" (portkey.aws/search-for-tag rawinput46476 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46477 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46477 ["Message" :content]))))))

(clojure.core/defn- response-list-distributions-result [input] (clojure.core/let [rawinput46478 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46479 {"DistributionList" (portkey.aws/search-for-tag rawinput46478 "DistributionList" :flattened? false)}] (clojure.core/cond-> {} (letvar46479 "DistributionList") (clojure.core/assoc :distribution-list (deser-distribution-list (clojure.core/get-in letvar46479 ["DistributionList" :content]))))))

(clojure.core/defn- response-trusted-signer-does-not-exist [input] (clojure.core/let [rawinput46480 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46481 {"Message" (portkey.aws/search-for-tag rawinput46480 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46481 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46481 ["Message" :content]))))))

(clojure.core/defn- response-too-many-field-level-encryption-field-patterns [input] (clojure.core/let [rawinput46482 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46483 {"Message" (portkey.aws/search-for-tag rawinput46482 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46483 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46483 ["Message" :content]))))))

(clojure.core/defn- response-get-invalidation-result [input] (clojure.core/let [rawinput46484 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46485 {"Invalidation" (portkey.aws/search-for-tag rawinput46484 "Invalidation" :flattened? false)}] (clojure.core/cond-> {} (letvar46485 "Invalidation") (clojure.core/assoc :invalidation (deser-invalidation (clojure.core/get-in letvar46485 ["Invalidation" :content]))))))

(clojure.core/defn- response-too-many-headers-in-forwarded-values [input] (clojure.core/let [rawinput46486 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar46487 {"Message" (portkey.aws/search-for-tag rawinput46486 "Message" :flattened? false)}] (clojure.core/cond-> {} (letvar46487 "Message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar46487 ["Message" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 1 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 128)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 0 (clojure.core/count s__22927__auto__))) (clojure.core/fn [s__22928__auto__] (clojure.core/< (clojure.core/count s__22928__auto__) 256)) (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__22929__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloudfront/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"arn:aws:cloudfront::[0-9]+:.*" s__22929__auto__))))
