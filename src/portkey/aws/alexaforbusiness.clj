...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper44619 input] (clojure.core/let [rawinput44618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44620 {"UserArn" (rawinput44618 "UserArn")}] (clojure.core/cond-> {} (letvar44620 "UserArn") (clojure.core/assoc :user-arn (deser-arn (clojure.core/get-in letvar44620 ["UserArn"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper44622 input] (clojure.core/let [rawinput44621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44623 {"Message" (rawinput44621 "Message")}] (clojure.core/cond-> {} (letvar44623 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44623 ["Message"])))))))

(clojure.core/defn- response-update-contact-response ([input] (response-update-contact-response nil input)) ([resultWrapper44625 input] (clojure.core/let [rawinput44624 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44626 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-address-book-response ([input] (response-create-address-book-response nil input)) ([resultWrapper44628 input] (clojure.core/let [rawinput44627 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44629 {"AddressBookArn" (rawinput44627 "AddressBookArn")}] (clojure.core/cond-> {} (letvar44629 "AddressBookArn") (clojure.core/assoc :address-book-arn (deser-arn (clojure.core/get-in letvar44629 ["AddressBookArn"])))))))

(clojure.core/defn- response-associate-contact-with-address-book-response ([input] (response-associate-contact-with-address-book-response nil input)) ([resultWrapper44631 input] (clojure.core/let [rawinput44630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44632 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper44634 input] (clojure.core/let [rawinput44633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44635 {"Message" (rawinput44633 "Message")}] (clojure.core/cond-> {} (letvar44635 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44635 ["Message"])))))))

(clojure.core/defn- response-associate-device-with-room-response ([input] (response-associate-device-with-room-response nil input)) ([resultWrapper44637 input] (clojure.core/let [rawinput44636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44638 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-name-in-use-exception ([input] (response-name-in-use-exception nil input)) ([resultWrapper44640 input] (clojure.core/let [rawinput44639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44641 {"Message" (rawinput44639 "Message")}] (clojure.core/cond-> {} (letvar44641 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44641 ["Message"])))))))

(clojure.core/defn- response-put-conference-preference-response ([input] (response-put-conference-preference-response nil input)) ([resultWrapper44643 input] (clojure.core/let [rawinput44642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44644 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-contact-response ([input] (response-create-contact-response nil input)) ([resultWrapper44646 input] (clojure.core/let [rawinput44645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44647 {"ContactArn" (rawinput44645 "ContactArn")}] (clojure.core/cond-> {} (letvar44647 "ContactArn") (clojure.core/assoc :contact-arn (deser-arn (clojure.core/get-in letvar44647 ["ContactArn"])))))))

(clojure.core/defn- response-create-conference-provider-response ([input] (response-create-conference-provider-response nil input)) ([resultWrapper44649 input] (clojure.core/let [rawinput44648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44650 {"ConferenceProviderArn" (rawinput44648 "ConferenceProviderArn")}] (clojure.core/cond-> {} (letvar44650 "ConferenceProviderArn") (clojure.core/assoc :conference-provider-arn (deser-arn (clojure.core/get-in letvar44650 ["ConferenceProviderArn"])))))))

(clojure.core/defn- response-put-invitation-configuration-response ([input] (response-put-invitation-configuration-response nil input)) ([resultWrapper44652 input] (clojure.core/let [rawinput44651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44653 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-conference-preference-response ([input] (response-get-conference-preference-response nil input)) ([resultWrapper44655 input] (clojure.core/let [rawinput44654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44656 {"Preference" (rawinput44654 "Preference")}] (clojure.core/cond-> {} (letvar44656 "Preference") (clojure.core/assoc :preference (deser-conference-preference (clojure.core/get-in letvar44656 ["Preference"])))))))

(clojure.core/defn- response-get-address-book-response ([input] (response-get-address-book-response nil input)) ([resultWrapper44658 input] (clojure.core/let [rawinput44657 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44659 {"AddressBook" (rawinput44657 "AddressBook")}] (clojure.core/cond-> {} (letvar44659 "AddressBook") (clojure.core/assoc :address-book (deser-address-book (clojure.core/get-in letvar44659 ["AddressBook"])))))))

(clojure.core/defn- response-delete-profile-response ([input] (response-delete-profile-response nil input)) ([resultWrapper44661 input] (clojure.core/let [rawinput44660 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44662 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-skill-with-users-response ([input] (response-associate-skill-with-users-response nil input)) ([resultWrapper44664 input] (clojure.core/let [rawinput44663 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44665 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-room-response ([input] (response-delete-room-response nil input)) ([resultWrapper44667 input] (clojure.core/let [rawinput44666 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44668 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-device-response ([input] (response-get-device-response nil input)) ([resultWrapper44670 input] (clojure.core/let [rawinput44669 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44671 {"Device" (rawinput44669 "Device")}] (clojure.core/cond-> {} (letvar44671 "Device") (clojure.core/assoc :device (deser-device (clojure.core/get-in letvar44671 ["Device"])))))))

(clojure.core/defn- response-search-users-response ([input] (response-search-users-response nil input)) ([resultWrapper44673 input] (clojure.core/let [rawinput44672 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44674 {"Users" (rawinput44672 "Users"), "NextToken" (rawinput44672 "NextToken"), "TotalCount" (rawinput44672 "TotalCount")}] (clojure.core/cond-> {} (letvar44674 "Users") (clojure.core/assoc :users (deser-user-data-list (clojure.core/get-in letvar44674 ["Users"]))) (letvar44674 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44674 ["NextToken"]))) (letvar44674 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44674 ["TotalCount"])))))))

(clojure.core/defn- response-reject-skill-response ([input] (response-reject-skill-response nil input)) ([resultWrapper44676 input] (clojure.core/let [rawinput44675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44677 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-business-report-schedule-response ([input] (response-create-business-report-schedule-response nil input)) ([resultWrapper44679 input] (clojure.core/let [rawinput44678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44680 {"ScheduleArn" (rawinput44678 "ScheduleArn")}] (clojure.core/cond-> {} (letvar44680 "ScheduleArn") (clojure.core/assoc :schedule-arn (deser-arn (clojure.core/get-in letvar44680 ["ScheduleArn"])))))))

(clojure.core/defn- response-update-conference-provider-response ([input] (response-update-conference-provider-response nil input)) ([resultWrapper44682 input] (clojure.core/let [rawinput44681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44683 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-smart-home-appliance-discovery-response ([input] (response-start-smart-home-appliance-discovery-response nil input)) ([resultWrapper44685 input] (clojure.core/let [rawinput44684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44686 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-skill-not-linked-exception ([input] (response-skill-not-linked-exception nil input)) ([resultWrapper44688 input] (clojure.core/let [rawinput44687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44689 {"Message" (rawinput44687 "Message")}] (clojure.core/cond-> {} (letvar44689 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44689 ["Message"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper44691 input] (clojure.core/let [rawinput44690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44692 {"Tags" (rawinput44690 "Tags"), "NextToken" (rawinput44690 "NextToken")}] (clojure.core/cond-> {} (letvar44692 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar44692 ["Tags"]))) (letvar44692 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44692 ["NextToken"])))))))

(clojure.core/defn- response-approve-skill-response ([input] (response-approve-skill-response nil input)) ([resultWrapper44694 input] (clojure.core/let [rawinput44693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44695 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-search-contacts-response ([input] (response-search-contacts-response nil input)) ([resultWrapper44697 input] (clojure.core/let [rawinput44696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44698 {"Contacts" (rawinput44696 "Contacts"), "NextToken" (rawinput44696 "NextToken"), "TotalCount" (rawinput44696 "TotalCount")}] (clojure.core/cond-> {} (letvar44698 "Contacts") (clojure.core/assoc :contacts (deser-contact-data-list (clojure.core/get-in letvar44698 ["Contacts"]))) (letvar44698 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44698 ["NextToken"]))) (letvar44698 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44698 ["TotalCount"])))))))

(clojure.core/defn- response-search-address-books-response ([input] (response-search-address-books-response nil input)) ([resultWrapper44700 input] (clojure.core/let [rawinput44699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44701 {"AddressBooks" (rawinput44699 "AddressBooks"), "NextToken" (rawinput44699 "NextToken"), "TotalCount" (rawinput44699 "TotalCount")}] (clojure.core/cond-> {} (letvar44701 "AddressBooks") (clojure.core/assoc :address-books (deser-address-book-data-list (clojure.core/get-in letvar44701 ["AddressBooks"]))) (letvar44701 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44701 ["NextToken"]))) (letvar44701 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44701 ["TotalCount"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper44703 input] (clojure.core/let [rawinput44702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44704 {"Message" (rawinput44702 "Message"), "ClientRequestToken" (rawinput44702 "ClientRequestToken")}] (clojure.core/cond-> {} (letvar44704 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44704 ["Message"]))) (letvar44704 "ClientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar44704 ["ClientRequestToken"])))))))

(clojure.core/defn- response-search-profiles-response ([input] (response-search-profiles-response nil input)) ([resultWrapper44706 input] (clojure.core/let [rawinput44705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44707 {"Profiles" (rawinput44705 "Profiles"), "NextToken" (rawinput44705 "NextToken"), "TotalCount" (rawinput44705 "TotalCount")}] (clojure.core/cond-> {} (letvar44707 "Profiles") (clojure.core/assoc :profiles (deser-profile-data-list (clojure.core/get-in letvar44707 ["Profiles"]))) (letvar44707 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44707 ["NextToken"]))) (letvar44707 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44707 ["TotalCount"])))))))

(clojure.core/defn- response-search-devices-response ([input] (response-search-devices-response nil input)) ([resultWrapper44709 input] (clojure.core/let [rawinput44708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44710 {"Devices" (rawinput44708 "Devices"), "NextToken" (rawinput44708 "NextToken"), "TotalCount" (rawinput44708 "TotalCount")}] (clojure.core/cond-> {} (letvar44710 "Devices") (clojure.core/assoc :devices (deser-device-data-list (clojure.core/get-in letvar44710 ["Devices"]))) (letvar44710 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44710 ["NextToken"]))) (letvar44710 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44710 ["TotalCount"])))))))

(clojure.core/defn- response-invalid-certificate-authority-exception ([input] (response-invalid-certificate-authority-exception nil input)) ([resultWrapper44712 input] (clojure.core/let [rawinput44711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44713 {"Message" (rawinput44711 "Message")}] (clojure.core/cond-> {} (letvar44713 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44713 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper44715 input] (clojure.core/let [rawinput44714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44716 {"Message" (rawinput44714 "Message")}] (clojure.core/cond-> {} (letvar44716 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44716 ["Message"])))))))

(clojure.core/defn- response-resolve-room-response ([input] (response-resolve-room-response nil input)) ([resultWrapper44718 input] (clojure.core/let [rawinput44717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44719 {"RoomArn" (rawinput44717 "RoomArn"), "RoomName" (rawinput44717 "RoomName"), "RoomSkillParameters" (rawinput44717 "RoomSkillParameters")}] (clojure.core/cond-> {} (letvar44719 "RoomArn") (clojure.core/assoc :room-arn (deser-arn (clojure.core/get-in letvar44719 ["RoomArn"]))) (letvar44719 "RoomName") (clojure.core/assoc :room-name (deser-room-name (clojure.core/get-in letvar44719 ["RoomName"]))) (letvar44719 "RoomSkillParameters") (clojure.core/assoc :room-skill-parameters (deser-room-skill-parameters (clojure.core/get-in letvar44719 ["RoomSkillParameters"])))))))

(clojure.core/defn- response-invalid-user-status-exception ([input] (response-invalid-user-status-exception nil input)) ([resultWrapper44721 input] (clojure.core/let [rawinput44720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44722 {"Message" (rawinput44720 "Message")}] (clojure.core/cond-> {} (letvar44722 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44722 ["Message"])))))))

(clojure.core/defn- response-update-profile-response ([input] (response-update-profile-response nil input)) ([resultWrapper44724 input] (clojure.core/let [rawinput44723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44725 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-contact-from-address-book-response ([input] (response-disassociate-contact-from-address-book-response nil input)) ([resultWrapper44727 input] (clojure.core/let [rawinput44726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44728 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-device-response ([input] (response-update-device-response nil input)) ([resultWrapper44730 input] (clojure.core/let [rawinput44729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44731 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-device-from-room-response ([input] (response-disassociate-device-from-room-response nil input)) ([resultWrapper44733 input] (clojure.core/let [rawinput44732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44734 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-skill-from-skill-group-response ([input] (response-disassociate-skill-from-skill-group-response nil input)) ([resultWrapper44736 input] (clojure.core/let [rawinput44735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44737 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-room-skill-parameter-response ([input] (response-put-room-skill-parameter-response nil input)) ([resultWrapper44739 input] (clojure.core/let [rawinput44738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44740 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-skill-group-response ([input] (response-update-skill-group-response nil input)) ([resultWrapper44742 input] (clojure.core/let [rawinput44741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44743 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper44745 input] (clojure.core/let [rawinput44744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44746 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-response ([input] (response-delete-user-response nil input)) ([resultWrapper44748 input] (clojure.core/let [rawinput44747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44749 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-skill-authorization-response ([input] (response-delete-skill-authorization-response nil input)) ([resultWrapper44751 input] (clojure.core/let [rawinput44750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44752 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-business-report-schedule-response ([input] (response-update-business-report-schedule-response nil input)) ([resultWrapper44754 input] (clojure.core/let [rawinput44753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44755 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-invitation-response ([input] (response-send-invitation-response nil input)) ([resultWrapper44757 input] (clojure.core/let [rawinput44756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44758 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-room-response ([input] (response-get-room-response nil input)) ([resultWrapper44760 input] (clojure.core/let [rawinput44759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44761 {"Room" (rawinput44759 "Room")}] (clojure.core/cond-> {} (letvar44761 "Room") (clojure.core/assoc :room (deser-room (clojure.core/get-in letvar44761 ["Room"])))))))

(clojure.core/defn- response-disassociate-skill-group-from-room-response ([input] (response-disassociate-skill-group-from-room-response nil input)) ([resultWrapper44763 input] (clojure.core/let [rawinput44762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44764 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forget-smart-home-appliances-response ([input] (response-forget-smart-home-appliances-response nil input)) ([resultWrapper44766 input] (clojure.core/let [rawinput44765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44767 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-invitation-configuration-response ([input] (response-get-invitation-configuration-response nil input)) ([resultWrapper44769 input] (clojure.core/let [rawinput44768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44770 {"OrganizationName" (rawinput44768 "OrganizationName"), "ContactEmail" (rawinput44768 "ContactEmail"), "PrivateSkillIds" (rawinput44768 "PrivateSkillIds")}] (clojure.core/cond-> {} (letvar44770 "OrganizationName") (clojure.core/assoc :organization-name (deser-organization-name (clojure.core/get-in letvar44770 ["OrganizationName"]))) (letvar44770 "ContactEmail") (clojure.core/assoc :contact-email (deser-email (clojure.core/get-in letvar44770 ["ContactEmail"]))) (letvar44770 "PrivateSkillIds") (clojure.core/assoc :private-skill-ids (deser-short-skill-id-list (clojure.core/get-in letvar44770 ["PrivateSkillIds"])))))))

(clojure.core/defn- response-revoke-invitation-response ([input] (response-revoke-invitation-response nil input)) ([resultWrapper44772 input] (clojure.core/let [rawinput44771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44773 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-conference-provider-response ([input] (response-get-conference-provider-response nil input)) ([resultWrapper44775 input] (clojure.core/let [rawinput44774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44776 {"ConferenceProvider" (rawinput44774 "ConferenceProvider")}] (clojure.core/cond-> {} (letvar44776 "ConferenceProvider") (clojure.core/assoc :conference-provider (deser-conference-provider (clojure.core/get-in letvar44776 ["ConferenceProvider"])))))))

(clojure.core/defn- response-device-not-registered-exception ([input] (response-device-not-registered-exception nil input)) ([resultWrapper44778 input] (clojure.core/let [rawinput44777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44779 {"Message" (rawinput44777 "Message")}] (clojure.core/cond-> {} (letvar44779 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44779 ["Message"])))))))

(clojure.core/defn- response-invalid-device-exception ([input] (response-invalid-device-exception nil input)) ([resultWrapper44781 input] (clojure.core/let [rawinput44780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44782 {"Message" (rawinput44780 "Message")}] (clojure.core/cond-> {} (letvar44782 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44782 ["Message"])))))))

(clojure.core/defn- response-associate-skill-with-skill-group-response ([input] (response-associate-skill-with-skill-group-response nil input)) ([resultWrapper44784 input] (clojure.core/let [rawinput44783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44785 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper44787 input] (clojure.core/let [rawinput44786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44788 {"Message" (rawinput44786 "Message")}] (clojure.core/cond-> {} (letvar44788 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44788 ["Message"])))))))

(clojure.core/defn- response-get-contact-response ([input] (response-get-contact-response nil input)) ([resultWrapper44790 input] (clojure.core/let [rawinput44789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44791 {"Contact" (rawinput44789 "Contact")}] (clojure.core/cond-> {} (letvar44791 "Contact") (clojure.core/assoc :contact (deser-contact (clojure.core/get-in letvar44791 ["Contact"])))))))

(clojure.core/defn- response-list-skills-store-categories-response ([input] (response-list-skills-store-categories-response nil input)) ([resultWrapper44793 input] (clojure.core/let [rawinput44792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44794 {"CategoryList" (rawinput44792 "CategoryList"), "NextToken" (rawinput44792 "NextToken")}] (clojure.core/cond-> {} (letvar44794 "CategoryList") (clojure.core/assoc :category-list (deser-category-list (clojure.core/get-in letvar44794 ["CategoryList"]))) (letvar44794 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44794 ["NextToken"])))))))

(clojure.core/defn- response-delete-address-book-response ([input] (response-delete-address-book-response nil input)) ([resultWrapper44796 input] (clojure.core/let [rawinput44795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44797 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-skill-authorization-response ([input] (response-put-skill-authorization-response nil input)) ([resultWrapper44799 input] (clojure.core/let [rawinput44798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44800 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-search-skill-groups-response ([input] (response-search-skill-groups-response nil input)) ([resultWrapper44802 input] (clojure.core/let [rawinput44801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44803 {"SkillGroups" (rawinput44801 "SkillGroups"), "NextToken" (rawinput44801 "NextToken"), "TotalCount" (rawinput44801 "TotalCount")}] (clojure.core/cond-> {} (letvar44803 "SkillGroups") (clojure.core/assoc :skill-groups (deser-skill-group-data-list (clojure.core/get-in letvar44803 ["SkillGroups"]))) (letvar44803 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44803 ["NextToken"]))) (letvar44803 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44803 ["TotalCount"])))))))

(clojure.core/defn- response-update-room-response ([input] (response-update-room-response nil input)) ([resultWrapper44805 input] (clojure.core/let [rawinput44804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44806 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-address-book-response ([input] (response-update-address-book-response nil input)) ([resultWrapper44808 input] (clojure.core/let [rawinput44807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44809 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-skill-group-response ([input] (response-create-skill-group-response nil input)) ([resultWrapper44811 input] (clojure.core/let [rawinput44810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44812 {"SkillGroupArn" (rawinput44810 "SkillGroupArn")}] (clojure.core/cond-> {} (letvar44812 "SkillGroupArn") (clojure.core/assoc :skill-group-arn (deser-arn (clojure.core/get-in letvar44812 ["SkillGroupArn"])))))))

(clojure.core/defn- response-get-room-skill-parameter-response ([input] (response-get-room-skill-parameter-response nil input)) ([resultWrapper44814 input] (clojure.core/let [rawinput44813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44815 {"RoomSkillParameter" (rawinput44813 "RoomSkillParameter")}] (clojure.core/cond-> {} (letvar44815 "RoomSkillParameter") (clojure.core/assoc :room-skill-parameter (deser-room-skill-parameter (clojure.core/get-in letvar44815 ["RoomSkillParameter"])))))))

(clojure.core/defn- response-list-device-events-response ([input] (response-list-device-events-response nil input)) ([resultWrapper44817 input] (clojure.core/let [rawinput44816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44818 {"DeviceEvents" (rawinput44816 "DeviceEvents"), "NextToken" (rawinput44816 "NextToken")}] (clojure.core/cond-> {} (letvar44818 "DeviceEvents") (clojure.core/assoc :device-events (deser-device-event-list (clojure.core/get-in letvar44818 ["DeviceEvents"]))) (letvar44818 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44818 ["NextToken"])))))))

(clojure.core/defn- response-create-profile-response ([input] (response-create-profile-response nil input)) ([resultWrapper44820 input] (clojure.core/let [rawinput44819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44821 {"ProfileArn" (rawinput44819 "ProfileArn")}] (clojure.core/cond-> {} (letvar44821 "ProfileArn") (clojure.core/assoc :profile-arn (deser-arn (clojure.core/get-in letvar44821 ["ProfileArn"])))))))

(clojure.core/defn- response-start-device-sync-response ([input] (response-start-device-sync-response nil input)) ([resultWrapper44823 input] (clojure.core/let [rawinput44822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44824 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-skill-from-users-response ([input] (response-disassociate-skill-from-users-response nil input)) ([resultWrapper44826 input] (clojure.core/let [rawinput44825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44827 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-contact-response ([input] (response-delete-contact-response nil input)) ([resultWrapper44829 input] (clojure.core/let [rawinput44828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44830 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-room-skill-parameter-response ([input] (response-delete-room-skill-parameter-response nil input)) ([resultWrapper44832 input] (clojure.core/let [rawinput44831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44833 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-room-response ([input] (response-create-room-response nil input)) ([resultWrapper44835 input] (clojure.core/let [rawinput44834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44836 {"RoomArn" (rawinput44834 "RoomArn")}] (clojure.core/cond-> {} (letvar44836 "RoomArn") (clojure.core/assoc :room-arn (deser-arn (clojure.core/get-in letvar44836 ["RoomArn"])))))))

(clojure.core/defn- response-list-skills-store-skills-by-category-response ([input] (response-list-skills-store-skills-by-category-response nil input)) ([resultWrapper44838 input] (clojure.core/let [rawinput44837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44839 {"SkillsStoreSkills" (rawinput44837 "SkillsStoreSkills"), "NextToken" (rawinput44837 "NextToken")}] (clojure.core/cond-> {} (letvar44839 "SkillsStoreSkills") (clojure.core/assoc :skills-store-skills (deser-skills-store-skill-list (clojure.core/get-in letvar44839 ["SkillsStoreSkills"]))) (letvar44839 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44839 ["NextToken"])))))))

(clojure.core/defn- response-get-skill-group-response ([input] (response-get-skill-group-response nil input)) ([resultWrapper44841 input] (clojure.core/let [rawinput44840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44842 {"SkillGroup" (rawinput44840 "SkillGroup")}] (clojure.core/cond-> {} (letvar44842 "SkillGroup") (clojure.core/assoc :skill-group (deser-skill-group (clojure.core/get-in letvar44842 ["SkillGroup"])))))))

(clojure.core/defn- response-get-profile-response ([input] (response-get-profile-response nil input)) ([resultWrapper44844 input] (clojure.core/let [rawinput44843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44845 {"Profile" (rawinput44843 "Profile")}] (clojure.core/cond-> {} (letvar44845 "Profile") (clojure.core/assoc :profile (deser-profile (clojure.core/get-in letvar44845 ["Profile"])))))))

(clojure.core/defn- response-list-skills-response ([input] (response-list-skills-response nil input)) ([resultWrapper44847 input] (clojure.core/let [rawinput44846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44848 {"SkillSummaries" (rawinput44846 "SkillSummaries"), "NextToken" (rawinput44846 "NextToken")}] (clojure.core/cond-> {} (letvar44848 "SkillSummaries") (clojure.core/assoc :skill-summaries (deser-skill-summary-list (clojure.core/get-in letvar44848 ["SkillSummaries"]))) (letvar44848 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44848 ["NextToken"])))))))

(clojure.core/defn- response-list-business-report-schedules-response ([input] (response-list-business-report-schedules-response nil input)) ([resultWrapper44850 input] (clojure.core/let [rawinput44849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44851 {"BusinessReportSchedules" (rawinput44849 "BusinessReportSchedules"), "NextToken" (rawinput44849 "NextToken")}] (clojure.core/cond-> {} (letvar44851 "BusinessReportSchedules") (clojure.core/assoc :business-report-schedules (deser-business-report-schedule-list (clojure.core/get-in letvar44851 ["BusinessReportSchedules"]))) (letvar44851 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44851 ["NextToken"])))))))

(clojure.core/defn- response-delete-device-response ([input] (response-delete-device-response nil input)) ([resultWrapper44853 input] (clojure.core/let [rawinput44852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44854 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-skill-group-response ([input] (response-delete-skill-group-response nil input)) ([resultWrapper44856 input] (clojure.core/let [rawinput44855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44857 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-conference-providers-response ([input] (response-list-conference-providers-response nil input)) ([resultWrapper44859 input] (clojure.core/let [rawinput44858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44860 {"ConferenceProviders" (rawinput44858 "ConferenceProviders"), "NextToken" (rawinput44858 "NextToken")}] (clojure.core/cond-> {} (letvar44860 "ConferenceProviders") (clojure.core/assoc :conference-providers (deser-conference-providers-list (clojure.core/get-in letvar44860 ["ConferenceProviders"]))) (letvar44860 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44860 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper44862 input] (clojure.core/let [rawinput44861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44863 {"Message" (rawinput44861 "Message")}] (clojure.core/cond-> {} (letvar44863 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar44863 ["Message"])))))))

(clojure.core/defn- response-delete-business-report-schedule-response ([input] (response-delete-business-report-schedule-response nil input)) ([resultWrapper44865 input] (clojure.core/let [rawinput44864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44866 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-register-avs-device-response ([input] (response-register-avs-device-response nil input)) ([resultWrapper44868 input] (clojure.core/let [rawinput44867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44869 {"DeviceArn" (rawinput44867 "DeviceArn")}] (clojure.core/cond-> {} (letvar44869 "DeviceArn") (clojure.core/assoc :device-arn (deser-arn (clojure.core/get-in letvar44869 ["DeviceArn"])))))))

(clojure.core/defn- response-associate-skill-group-with-room-response ([input] (response-associate-skill-group-with-room-response nil input)) ([resultWrapper44871 input] (clojure.core/let [rawinput44870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44872 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper44874 input] (clojure.core/let [rawinput44873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44875 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-search-rooms-response ([input] (response-search-rooms-response nil input)) ([resultWrapper44877 input] (clojure.core/let [rawinput44876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44878 {"Rooms" (rawinput44876 "Rooms"), "NextToken" (rawinput44876 "NextToken"), "TotalCount" (rawinput44876 "TotalCount")}] (clojure.core/cond-> {} (letvar44878 "Rooms") (clojure.core/assoc :rooms (deser-room-data-list (clojure.core/get-in letvar44878 ["Rooms"]))) (letvar44878 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44878 ["NextToken"]))) (letvar44878 "TotalCount") (clojure.core/assoc :total-count (deser-total-count (clojure.core/get-in letvar44878 ["TotalCount"])))))))

(clojure.core/defn- response-list-smart-home-appliances-response ([input] (response-list-smart-home-appliances-response nil input)) ([resultWrapper44880 input] (clojure.core/let [rawinput44879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44881 {"SmartHomeAppliances" (rawinput44879 "SmartHomeAppliances"), "NextToken" (rawinput44879 "NextToken")}] (clojure.core/cond-> {} (letvar44881 "SmartHomeAppliances") (clojure.core/assoc :smart-home-appliances (deser-smart-home-appliance-list (clojure.core/get-in letvar44881 ["SmartHomeAppliances"]))) (letvar44881 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar44881 ["NextToken"])))))))

(clojure.core/defn- response-delete-conference-provider-response ([input] (response-delete-conference-provider-response nil input)) ([resultWrapper44883 input] (clojure.core/let [rawinput44882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar44884 {}] (clojure.core/cond-> {}))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/skill-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/sort-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/device-serial-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]{1,200}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 10 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 150)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9][a-zA-Z0-9_-]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/provider-calendar-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/enrollment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/user-user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9@_+.-]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/user-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/address-book-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"amzn1\.[A-Za-z0-9+-\/=.]{1,300}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/device-serial-number-for-avs (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{1,50}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/amazon-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]{1,18}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/business-report-schedule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/country-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{1,3}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/skill-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/organization-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([A-Za-z\-' 0-9._]|\p{IsLetter})*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/date (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/conference-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/address-book-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/outbound-phone-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{10}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/filter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/timezone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/one-click-pin-delay (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/user-first-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([A-Za-z\-' 0-9._]|\p{IsLetter})*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]{1,200}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/customer-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9-\.]{3,63}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/one-click-id-delay (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/room-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/room-skill-parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S+{1,256}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/s-3-key-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z0-9!_\-\.\*'()/]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/product-description (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/endpoint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/user-last-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([A-Za-z\-' 0-9._]|\p{IsLetter})*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/device-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/room-skill-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/e-164-phone-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\+\d{8,}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/product-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]{1,256}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/skill-group-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/room-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/skill-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(^amzn1\.ask\.skill\.[0-9a-f\-]{1,200})|(^amzn1\.echo-sdk-ams\.app\.[0-9a-f\-]{1,200})" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u007E\u0085\u00A0-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.alexaforbusiness/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
