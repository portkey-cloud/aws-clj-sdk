...
(clojure.core/defn- response-dry-run-operation ([input] (response-dry-run-operation nil input)) ([resultWrapper1415271 input] (clojure.core/let [rawinput1415270 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415272 {"Message" (rawinput1415270 "Message")}] (clojure.core/cond-> {} (letvar1415272 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415272 ["Message"])))))))

(clojure.core/defn- response-describe-migration-task-result ([input] (response-describe-migration-task-result nil input)) ([resultWrapper1415274 input] (clojure.core/let [rawinput1415273 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415275 {"MigrationTask" (rawinput1415273 "MigrationTask")}] (clojure.core/cond-> {} (letvar1415275 "MigrationTask") (clojure.core/assoc :migration-task (deser-migration-task (clojure.core/get-in letvar1415275 ["MigrationTask"])))))))

(clojure.core/defn- response-list-migration-tasks-result ([input] (response-list-migration-tasks-result nil input)) ([resultWrapper1415277 input] (clojure.core/let [rawinput1415276 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415278 {"NextToken" (rawinput1415276 "NextToken"), "MigrationTaskSummaryList" (rawinput1415276 "MigrationTaskSummaryList")}] (clojure.core/cond-> {} (letvar1415278 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1415278 ["NextToken"]))) (letvar1415278 "MigrationTaskSummaryList") (clojure.core/assoc :migration-task-summary-list (deser-migration-task-summary-list (clojure.core/get-in letvar1415278 ["MigrationTaskSummaryList"])))))))

(clojure.core/defn- response-list-discovered-resources-result ([input] (response-list-discovered-resources-result nil input)) ([resultWrapper1415280 input] (clojure.core/let [rawinput1415279 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415281 {"NextToken" (rawinput1415279 "NextToken"), "DiscoveredResourceList" (rawinput1415279 "DiscoveredResourceList")}] (clojure.core/cond-> {} (letvar1415281 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1415281 ["NextToken"]))) (letvar1415281 "DiscoveredResourceList") (clojure.core/assoc :discovered-resource-list (deser-discovered-resource-list (clojure.core/get-in letvar1415281 ["DiscoveredResourceList"])))))))

(clojure.core/defn- response-notify-migration-task-state-result ([input] (response-notify-migration-task-state-result nil input)) ([resultWrapper1415283 input] (clojure.core/let [rawinput1415282 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415284 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1415286 input] (clojure.core/let [rawinput1415285 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415287 {"Message" (rawinput1415285 "Message")}] (clojure.core/cond-> {} (letvar1415287 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415287 ["Message"])))))))

(clojure.core/defn- response-unauthorized-operation ([input] (response-unauthorized-operation nil input)) ([resultWrapper1415289 input] (clojure.core/let [rawinput1415288 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415290 {"Message" (rawinput1415288 "Message")}] (clojure.core/cond-> {} (letvar1415290 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415290 ["Message"])))))))

(clojure.core/defn- response-put-resource-attributes-result ([input] (response-put-resource-attributes-result nil input)) ([resultWrapper1415292 input] (clojure.core/let [rawinput1415291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415293 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-created-artifact-result ([input] (response-disassociate-created-artifact-result nil input)) ([resultWrapper1415295 input] (clojure.core/let [rawinput1415294 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415296 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-progress-update-stream-result ([input] (response-delete-progress-update-stream-result nil input)) ([resultWrapper1415298 input] (clojure.core/let [rawinput1415297 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415299 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-policy-error-exception ([input] (response-policy-error-exception nil input)) ([resultWrapper1415301 input] (clojure.core/let [rawinput1415300 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415302 {"Message" (rawinput1415300 "Message")}] (clojure.core/cond-> {} (letvar1415302 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415302 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1415304 input] (clojure.core/let [rawinput1415303 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415305 {"Message" (rawinput1415303 "Message")}] (clojure.core/cond-> {} (letvar1415305 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415305 ["Message"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1415307 input] (clojure.core/let [rawinput1415306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415308 {"Message" (rawinput1415306 "Message")}] (clojure.core/cond-> {} (letvar1415308 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415308 ["Message"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1415310 input] (clojure.core/let [rawinput1415309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415311 {"Message" (rawinput1415309 "Message")}] (clojure.core/cond-> {} (letvar1415311 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415311 ["Message"])))))))

(clojure.core/defn- response-notify-application-state-result ([input] (response-notify-application-state-result nil input)) ([resultWrapper1415313 input] (clojure.core/let [rawinput1415312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415314 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-created-artifact-result ([input] (response-associate-created-artifact-result nil input)) ([resultWrapper1415316 input] (clojure.core/let [rawinput1415315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415317 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-discovered-resource-result ([input] (response-disassociate-discovered-resource-result nil input)) ([resultWrapper1415319 input] (clojure.core/let [rawinput1415318 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415320 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-progress-update-streams-result ([input] (response-list-progress-update-streams-result nil input)) ([resultWrapper1415322 input] (clojure.core/let [rawinput1415321 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415323 {"ProgressUpdateStreamSummaryList" (rawinput1415321 "ProgressUpdateStreamSummaryList"), "NextToken" (rawinput1415321 "NextToken")}] (clojure.core/cond-> {} (letvar1415323 "ProgressUpdateStreamSummaryList") (clojure.core/assoc :progress-update-stream-summary-list (deser-progress-update-stream-summary-list (clojure.core/get-in letvar1415323 ["ProgressUpdateStreamSummaryList"]))) (letvar1415323 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1415323 ["NextToken"])))))))

(clojure.core/defn- response-describe-application-state-result ([input] (response-describe-application-state-result nil input)) ([resultWrapper1415325 input] (clojure.core/let [rawinput1415324 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415326 {"ApplicationStatus" (rawinput1415324 "ApplicationStatus"), "LastUpdatedTime" (rawinput1415324 "LastUpdatedTime")}] (clojure.core/cond-> {} (letvar1415326 "ApplicationStatus") (clojure.core/assoc :application-status (deser-application-status (clojure.core/get-in letvar1415326 ["ApplicationStatus"]))) (letvar1415326 "LastUpdatedTime") (clojure.core/assoc :last-updated-time (deser-update-date-time (clojure.core/get-in letvar1415326 ["LastUpdatedTime"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1415328 input] (clojure.core/let [rawinput1415327 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415329 {"Message" (rawinput1415327 "Message")}] (clojure.core/cond-> {} (letvar1415329 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1415329 ["Message"])))))))

(clojure.core/defn- response-import-migration-task-result ([input] (response-import-migration-task-result nil input)) ([resultWrapper1415331 input] (clojure.core/let [rawinput1415330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415332 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-discovered-resource-result ([input] (response-associate-discovered-resource-result nil input)) ([resultWrapper1415334 input] (clojure.core/let [rawinput1415333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415335 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-created-artifacts-result ([input] (response-list-created-artifacts-result nil input)) ([resultWrapper1415337 input] (clojure.core/let [rawinput1415336 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415338 {"NextToken" (rawinput1415336 "NextToken"), "CreatedArtifactList" (rawinput1415336 "CreatedArtifactList")}] (clojure.core/cond-> {} (letvar1415338 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1415338 ["NextToken"]))) (letvar1415338 "CreatedArtifactList") (clojure.core/assoc :created-artifact-list (deser-created-artifact-list (clojure.core/get-in letvar1415338 ["CreatedArtifactList"])))))))

(clojure.core/defn- response-create-progress-update-stream-result ([input] (response-create-progress-update-stream-result nil input)) ([resultWrapper1415340 input] (clojure.core/let [rawinput1415339 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1415341 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/migration-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:|]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/dry-run clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/discovered-resource-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/created-artifact-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/configuration-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/status-detail (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/application-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/resource-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.AWSMigrationHub.-2017-05-31/progress-update-stream (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^/:|\000-\037]+" s__1410940__auto__))))
