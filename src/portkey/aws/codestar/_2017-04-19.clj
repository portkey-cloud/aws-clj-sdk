...
(clojure.core/defn- response-describe-project-result ([input] (response-describe-project-result nil input)) ([resultWrapper1544731 input] (clojure.core/let [rawinput1544730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544732 {"stackId" (rawinput1544730 "stackId"), "arn" (rawinput1544730 "arn"), "projectTemplateId" (rawinput1544730 "projectTemplateId"), "createdTimeStamp" (rawinput1544730 "createdTimeStamp"), "id" (rawinput1544730 "id"), "clientRequestToken" (rawinput1544730 "clientRequestToken"), "name" (rawinput1544730 "name"), "status" (rawinput1544730 "status"), "description" (rawinput1544730 "description")}] (clojure.core/cond-> {} (letvar1544732 "stackId") (clojure.core/assoc :stack-id (deser-stack-id (clojure.core/get-in letvar1544732 ["stackId"]))) (letvar1544732 "arn") (clojure.core/assoc :arn (deser-project-arn (clojure.core/get-in letvar1544732 ["arn"]))) (letvar1544732 "projectTemplateId") (clojure.core/assoc :project-template-id (deser-project-template-id (clojure.core/get-in letvar1544732 ["projectTemplateId"]))) (letvar1544732 "createdTimeStamp") (clojure.core/assoc :created-time-stamp (deser-created-timestamp (clojure.core/get-in letvar1544732 ["createdTimeStamp"]))) (letvar1544732 "id") (clojure.core/assoc :id (deser-project-id (clojure.core/get-in letvar1544732 ["id"]))) (letvar1544732 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar1544732 ["clientRequestToken"]))) (letvar1544732 "name") (clojure.core/assoc :name (deser-project-name (clojure.core/get-in letvar1544732 ["name"]))) (letvar1544732 "status") (clojure.core/assoc :status (deser-project-status (clojure.core/get-in letvar1544732 ["status"]))) (letvar1544732 "description") (clojure.core/assoc :description (deser-project-description (clojure.core/get-in letvar1544732 ["description"])))))))

(clojure.core/defn- response-list-projects-result ([input] (response-list-projects-result nil input)) ([resultWrapper1544734 input] (clojure.core/let [rawinput1544733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544735 {"projects" (rawinput1544733 "projects"), "nextToken" (rawinput1544733 "nextToken")}] (clojure.core/cond-> {:projects (deser-projects-list (clojure.core/get-in letvar1544735 ["projects"]))} (letvar1544735 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1544735 ["nextToken"])))))))

(clojure.core/defn- response-update-project-result ([input] (response-update-project-result nil input)) ([resultWrapper1544737 input] (clojure.core/let [rawinput1544736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544738 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1544740 input] (clojure.core/let [rawinput1544739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544741 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-project-creation-failed-exception ([input] (response-project-creation-failed-exception nil input)) ([resultWrapper1544743 input] (clojure.core/let [rawinput1544742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544744 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-team-member-already-associated-exception ([input] (response-team-member-already-associated-exception nil input)) ([resultWrapper1544746 input] (clojure.core/let [rawinput1544745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544747 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-profiles-result ([input] (response-list-user-profiles-result nil input)) ([resultWrapper1544749 input] (clojure.core/let [rawinput1544748 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544750 {"userProfiles" (rawinput1544748 "userProfiles"), "nextToken" (rawinput1544748 "nextToken")}] (clojure.core/cond-> {:user-profiles (deser-user-profiles-list (clojure.core/get-in letvar1544750 ["userProfiles"]))} (letvar1544750 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1544750 ["nextToken"])))))))

(clojure.core/defn- response-user-profile-not-found-exception ([input] (response-user-profile-not-found-exception nil input)) ([resultWrapper1544752 input] (clojure.core/let [rawinput1544751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544753 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1544755 input] (clojure.core/let [rawinput1544754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544756 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-service-role-exception ([input] (response-invalid-service-role-exception nil input)) ([resultWrapper1544758 input] (clojure.core/let [rawinput1544757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544759 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-team-member-result ([input] (response-disassociate-team-member-result nil input)) ([resultWrapper1544761 input] (clojure.core/let [rawinput1544760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544762 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1544764 input] (clojure.core/let [rawinput1544763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544765 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-project-result ([input] (response-tag-project-result nil input)) ([resultWrapper1544767 input] (clojure.core/let [rawinput1544766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544768 {"tags" (rawinput1544766 "tags")}] (clojure.core/cond-> {} (letvar1544768 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1544768 ["tags"])))))))

(clojure.core/defn- response-untag-project-result ([input] (response-untag-project-result nil input)) ([resultWrapper1544770 input] (clojure.core/let [rawinput1544769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544771 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-project-result ([input] (response-create-project-result nil input)) ([resultWrapper1544773 input] (clojure.core/let [rawinput1544772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544774 {"id" (rawinput1544772 "id"), "arn" (rawinput1544772 "arn"), "clientRequestToken" (rawinput1544772 "clientRequestToken"), "projectTemplateId" (rawinput1544772 "projectTemplateId")}] (clojure.core/cond-> {:id (deser-project-id (clojure.core/get-in letvar1544774 ["id"])), :arn (deser-project-arn (clojure.core/get-in letvar1544774 ["arn"]))} (letvar1544774 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar1544774 ["clientRequestToken"]))) (letvar1544774 "projectTemplateId") (clojure.core/assoc :project-template-id (deser-project-template-id (clojure.core/get-in letvar1544774 ["projectTemplateId"])))))))

(clojure.core/defn- response-user-profile-already-exists-exception ([input] (response-user-profile-already-exists-exception nil input)) ([resultWrapper1544776 input] (clojure.core/let [rawinput1544775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544777 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resources-result ([input] (response-list-resources-result nil input)) ([resultWrapper1544779 input] (clojure.core/let [rawinput1544778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544780 {"resources" (rawinput1544778 "resources"), "nextToken" (rawinput1544778 "nextToken")}] (clojure.core/cond-> {} (letvar1544780 "resources") (clojure.core/assoc :resources (deser-resources-result (clojure.core/get-in letvar1544780 ["resources"]))) (letvar1544780 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1544780 ["nextToken"])))))))

(clojure.core/defn- response-project-already-exists-exception ([input] (response-project-already-exists-exception nil input)) ([resultWrapper1544782 input] (clojure.core/let [rawinput1544781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544783 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-team-member-not-found-exception ([input] (response-team-member-not-found-exception nil input)) ([resultWrapper1544785 input] (clojure.core/let [rawinput1544784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544786 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-profile-result ([input] (response-describe-user-profile-result nil input)) ([resultWrapper1544788 input] (clojure.core/let [rawinput1544787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544789 {"userArn" (rawinput1544787 "userArn"), "displayName" (rawinput1544787 "displayName"), "emailAddress" (rawinput1544787 "emailAddress"), "sshPublicKey" (rawinput1544787 "sshPublicKey"), "createdTimestamp" (rawinput1544787 "createdTimestamp"), "lastModifiedTimestamp" (rawinput1544787 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar1544789 ["userArn"])), :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar1544789 ["createdTimestamp"])), :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar1544789 ["lastModifiedTimestamp"]))} (letvar1544789 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar1544789 ["displayName"]))) (letvar1544789 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1544789 ["emailAddress"]))) (letvar1544789 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar1544789 ["sshPublicKey"])))))))

(clojure.core/defn- response-delete-project-result ([input] (response-delete-project-result nil input)) ([resultWrapper1544791 input] (clojure.core/let [rawinput1544790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544792 {"stackId" (rawinput1544790 "stackId"), "projectArn" (rawinput1544790 "projectArn")}] (clojure.core/cond-> {} (letvar1544792 "stackId") (clojure.core/assoc :stack-id (deser-stack-id (clojure.core/get-in letvar1544792 ["stackId"]))) (letvar1544792 "projectArn") (clojure.core/assoc :project-arn (deser-project-arn (clojure.core/get-in letvar1544792 ["projectArn"])))))))

(clojure.core/defn- response-associate-team-member-result ([input] (response-associate-team-member-result nil input)) ([resultWrapper1544794 input] (clojure.core/let [rawinput1544793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544795 {"clientRequestToken" (rawinput1544793 "clientRequestToken")}] (clojure.core/cond-> {} (letvar1544795 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar1544795 ["clientRequestToken"])))))))

(clojure.core/defn- response-update-team-member-result ([input] (response-update-team-member-result nil input)) ([resultWrapper1544797 input] (clojure.core/let [rawinput1544796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544798 {"userArn" (rawinput1544796 "userArn"), "projectRole" (rawinput1544796 "projectRole"), "remoteAccessAllowed" (rawinput1544796 "remoteAccessAllowed")}] (clojure.core/cond-> {} (letvar1544798 "userArn") (clojure.core/assoc :user-arn (deser-user-arn (clojure.core/get-in letvar1544798 ["userArn"]))) (letvar1544798 "projectRole") (clojure.core/assoc :project-role (deser-role (clojure.core/get-in letvar1544798 ["projectRole"]))) (letvar1544798 "remoteAccessAllowed") (clojure.core/assoc :remote-access-allowed (deser-remote-access-allowed (clojure.core/get-in letvar1544798 ["remoteAccessAllowed"])))))))

(clojure.core/defn- response-create-user-profile-result ([input] (response-create-user-profile-result nil input)) ([resultWrapper1544800 input] (clojure.core/let [rawinput1544799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544801 {"userArn" (rawinput1544799 "userArn"), "displayName" (rawinput1544799 "displayName"), "emailAddress" (rawinput1544799 "emailAddress"), "sshPublicKey" (rawinput1544799 "sshPublicKey"), "createdTimestamp" (rawinput1544799 "createdTimestamp"), "lastModifiedTimestamp" (rawinput1544799 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar1544801 ["userArn"]))} (letvar1544801 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar1544801 ["displayName"]))) (letvar1544801 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1544801 ["emailAddress"]))) (letvar1544801 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar1544801 ["sshPublicKey"]))) (letvar1544801 "createdTimestamp") (clojure.core/assoc :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar1544801 ["createdTimestamp"]))) (letvar1544801 "lastModifiedTimestamp") (clojure.core/assoc :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar1544801 ["lastModifiedTimestamp"])))))))

(clojure.core/defn- response-list-tags-for-project-result ([input] (response-list-tags-for-project-result nil input)) ([resultWrapper1544803 input] (clojure.core/let [rawinput1544802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544804 {"tags" (rawinput1544802 "tags"), "nextToken" (rawinput1544802 "nextToken")}] (clojure.core/cond-> {} (letvar1544804 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1544804 ["tags"]))) (letvar1544804 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1544804 ["nextToken"])))))))

(clojure.core/defn- response-list-team-members-result ([input] (response-list-team-members-result nil input)) ([resultWrapper1544806 input] (clojure.core/let [rawinput1544805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544807 {"teamMembers" (rawinput1544805 "teamMembers"), "nextToken" (rawinput1544805 "nextToken")}] (clojure.core/cond-> {:team-members (deser-team-member-result (clojure.core/get-in letvar1544807 ["teamMembers"]))} (letvar1544807 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1544807 ["nextToken"])))))))

(clojure.core/defn- response-project-not-found-exception ([input] (response-project-not-found-exception nil input)) ([resultWrapper1544809 input] (clojure.core/let [rawinput1544808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544810 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1544812 input] (clojure.core/let [rawinput1544811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544813 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-project-configuration-exception ([input] (response-project-configuration-exception nil input)) ([resultWrapper1544815 input] (clojure.core/let [rawinput1544814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544816 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-profile-result ([input] (response-delete-user-profile-result nil input)) ([resultWrapper1544818 input] (clojure.core/let [rawinput1544817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544819 {"userArn" (rawinput1544817 "userArn")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar1544819 ["userArn"]))}))))

(clojure.core/defn- response-update-user-profile-result ([input] (response-update-user-profile-result nil input)) ([resultWrapper1544821 input] (clojure.core/let [rawinput1544820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1544822 {"userArn" (rawinput1544820 "userArn"), "displayName" (rawinput1544820 "displayName"), "emailAddress" (rawinput1544820 "emailAddress"), "sshPublicKey" (rawinput1544820 "sshPublicKey"), "createdTimestamp" (rawinput1544820 "createdTimestamp"), "lastModifiedTimestamp" (rawinput1544820 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar1544822 ["userArn"]))} (letvar1544822 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar1544822 ["displayName"]))) (letvar1544822 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar1544822 ["emailAddress"]))) (letvar1544822 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar1544822 ["sshPublicKey"]))) (letvar1544822 "createdTimestamp") (clojure.core/assoc :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar1544822 ["createdTimestamp"]))) (letvar1544822 "lastModifiedTimestamp") (clojure.core/assoc :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar1544822 ["lastModifiedTimestamp"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/repository-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/template-parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\w:/-]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/project-template-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]{0,5}:codestar:[^:\s]+::project-template(\/(github|codecommit))?\/[a-z0-9-]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/repository-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S[\w.-]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/ssh-public-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 16384)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\t\r\n\u0020-\u00FF]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/user-profile-display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/repository-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(user|organization|User|Organization)$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\w/+=]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/project-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]*:codestar:[^:\s]+:[0-9]{12}:project\/[a-z]([a-z0-9|-])+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 11 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn\:aws\:\S.*\:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/untag-project-result (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(Owner|Viewer|Contributor)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/git-hub-personal-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/stack-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]*:cloudformation:[^:\s]+:[0-9]{12}:stack\/[^:\s]+\/[^:\s]+$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^$|^\S(.*\S)?$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/template-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/repository-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/project-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-z][a-z0-9-]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(CreateInProgress|CreateComplete|CreateFailed|DeleteComplete|DeleteFailed|DeleteInProgress|UpdateComplete|UpdateInProgress|UpdateFailed|Unknown)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^$|^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.codestar.-2017-04-19/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 32 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 95)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:iam::\d{12}:user(?:(\u002F)|(\u002F[\u0021-\u007E]+\u002F))[\w+=,.@-]+$" s__1410940__auto__))))
