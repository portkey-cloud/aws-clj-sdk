...
(clojure.core/defn- response-lookup-developer-identity-response ([input] (response-lookup-developer-identity-response nil input)) ([resultWrapper1547122 input] (clojure.core/let [rawinput1547121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547123 {"IdentityId" (rawinput1547121 "IdentityId"), "DeveloperUserIdentifierList" (rawinput1547121 "DeveloperUserIdentifierList"), "NextToken" (rawinput1547121 "NextToken")}] (clojure.core/cond-> {} (letvar1547123 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547123 ["IdentityId"]))) (letvar1547123 "DeveloperUserIdentifierList") (clojure.core/assoc :developer-user-identifier-list (deser-developer-user-identifier-list (clojure.core/get-in letvar1547123 ["DeveloperUserIdentifierList"]))) (letvar1547123 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1547123 ["NextToken"])))))))

(clojure.core/defn- response-get-open-id-token-response ([input] (response-get-open-id-token-response nil input)) ([resultWrapper1547125 input] (clojure.core/let [rawinput1547124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547126 {"IdentityId" (rawinput1547124 "IdentityId"), "Token" (rawinput1547124 "Token")}] (clojure.core/cond-> {} (letvar1547126 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547126 ["IdentityId"]))) (letvar1547126 "Token") (clojure.core/assoc :token (deser-oidc-token (clojure.core/get-in letvar1547126 ["Token"])))))))

(clojure.core/defn- response-get-id-response ([input] (response-get-id-response nil input)) ([resultWrapper1547128 input] (clojure.core/let [rawinput1547127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547129 {"IdentityId" (rawinput1547127 "IdentityId")}] (clojure.core/cond-> {} (letvar1547129 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547129 ["IdentityId"])))))))

(clojure.core/defn- response-delete-identities-response ([input] (response-delete-identities-response nil input)) ([resultWrapper1547131 input] (clojure.core/let [rawinput1547130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547132 {"UnprocessedIdentityIds" (rawinput1547130 "UnprocessedIdentityIds")}] (clojure.core/cond-> {} (letvar1547132 "UnprocessedIdentityIds") (clojure.core/assoc :unprocessed-identity-ids (deser-unprocessed-identity-id-list (clojure.core/get-in letvar1547132 ["UnprocessedIdentityIds"])))))))

(clojure.core/defn- response-invalid-identity-pool-configuration-exception ([input] (response-invalid-identity-pool-configuration-exception nil input)) ([resultWrapper1547134 input] (clojure.core/let [rawinput1547133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547135 {"message" (rawinput1547133 "message")}] (clojure.core/cond-> {} (letvar1547135 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547135 ["message"])))))))

(clojure.core/defn- response-developer-user-already-registered-exception ([input] (response-developer-user-already-registered-exception nil input)) ([resultWrapper1547137 input] (clojure.core/let [rawinput1547136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547138 {"message" (rawinput1547136 "message")}] (clojure.core/cond-> {} (letvar1547138 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547138 ["message"])))))))

(clojure.core/defn- response-get-credentials-for-identity-response ([input] (response-get-credentials-for-identity-response nil input)) ([resultWrapper1547140 input] (clojure.core/let [rawinput1547139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547141 {"IdentityId" (rawinput1547139 "IdentityId"), "Credentials" (rawinput1547139 "Credentials")}] (clojure.core/cond-> {} (letvar1547141 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547141 ["IdentityId"]))) (letvar1547141 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar1547141 ["Credentials"])))))))

(clojure.core/defn- response-get-open-id-token-for-developer-identity-response ([input] (response-get-open-id-token-for-developer-identity-response nil input)) ([resultWrapper1547143 input] (clojure.core/let [rawinput1547142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547144 {"IdentityId" (rawinput1547142 "IdentityId"), "Token" (rawinput1547142 "Token")}] (clojure.core/cond-> {} (letvar1547144 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547144 ["IdentityId"]))) (letvar1547144 "Token") (clojure.core/assoc :token (deser-oidc-token (clojure.core/get-in letvar1547144 ["Token"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1547146 input] (clojure.core/let [rawinput1547145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547147 {"message" (rawinput1547145 "message")}] (clojure.core/cond-> {} (letvar1547147 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547147 ["message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1547149 input] (clojure.core/let [rawinput1547148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547150 {"message" (rawinput1547148 "message")}] (clojure.core/cond-> {} (letvar1547150 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547150 ["message"])))))))

(clojure.core/defn- response-identity-description ([input] (response-identity-description nil input)) ([resultWrapper1547152 input] (clojure.core/let [rawinput1547151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547153 {"IdentityId" (rawinput1547151 "IdentityId"), "Logins" (rawinput1547151 "Logins"), "CreationDate" (rawinput1547151 "CreationDate"), "LastModifiedDate" (rawinput1547151 "LastModifiedDate")}] (clojure.core/cond-> {} (letvar1547153 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547153 ["IdentityId"]))) (letvar1547153 "Logins") (clojure.core/assoc :logins (deser-logins-list (clojure.core/get-in letvar1547153 ["Logins"]))) (letvar1547153 "CreationDate") (clojure.core/assoc :creation-date (deser-date-type (clojure.core/get-in letvar1547153 ["CreationDate"]))) (letvar1547153 "LastModifiedDate") (clojure.core/assoc :last-modified-date (deser-date-type (clojure.core/get-in letvar1547153 ["LastModifiedDate"])))))))

(clojure.core/defn- response-list-identity-pools-response ([input] (response-list-identity-pools-response nil input)) ([resultWrapper1547155 input] (clojure.core/let [rawinput1547154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547156 {"IdentityPools" (rawinput1547154 "IdentityPools"), "NextToken" (rawinput1547154 "NextToken")}] (clojure.core/cond-> {} (letvar1547156 "IdentityPools") (clojure.core/assoc :identity-pools (deser-identity-pools-list (clojure.core/get-in letvar1547156 ["IdentityPools"]))) (letvar1547156 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1547156 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1547158 input] (clojure.core/let [rawinput1547157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547159 {"message" (rawinput1547157 "message")}] (clojure.core/cond-> {} (letvar1547159 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547159 ["message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1547161 input] (clojure.core/let [rawinput1547160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547162 {"message" (rawinput1547160 "message")}] (clojure.core/cond-> {} (letvar1547162 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547162 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1547164 input] (clojure.core/let [rawinput1547163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547165 {"message" (rawinput1547163 "message")}] (clojure.core/cond-> {} (letvar1547165 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547165 ["message"])))))))

(clojure.core/defn- response-identity-pool ([input] (response-identity-pool nil input)) ([resultWrapper1547167 input] (clojure.core/let [rawinput1547166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547168 {"IdentityPoolId" (rawinput1547166 "IdentityPoolId"), "IdentityPoolName" (rawinput1547166 "IdentityPoolName"), "AllowUnauthenticatedIdentities" (rawinput1547166 "AllowUnauthenticatedIdentities"), "SupportedLoginProviders" (rawinput1547166 "SupportedLoginProviders"), "DeveloperProviderName" (rawinput1547166 "DeveloperProviderName"), "OpenIdConnectProviderARNs" (rawinput1547166 "OpenIdConnectProviderARNs"), "CognitoIdentityProviders" (rawinput1547166 "CognitoIdentityProviders"), "SamlProviderARNs" (rawinput1547166 "SamlProviderARNs")}] (clojure.core/cond-> {:identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1547168 ["IdentityPoolId"])), :identity-pool-name (deser-identity-pool-name (clojure.core/get-in letvar1547168 ["IdentityPoolName"])), :allow-unauthenticated-identities (deser-identity-pool-unauthenticated (clojure.core/get-in letvar1547168 ["AllowUnauthenticatedIdentities"]))} (letvar1547168 "SupportedLoginProviders") (clojure.core/assoc :supported-login-providers (deser-identity-providers (clojure.core/get-in letvar1547168 ["SupportedLoginProviders"]))) (letvar1547168 "DeveloperProviderName") (clojure.core/assoc :developer-provider-name (deser-developer-provider-name (clojure.core/get-in letvar1547168 ["DeveloperProviderName"]))) (letvar1547168 "OpenIdConnectProviderARNs") (clojure.core/assoc :open-id-connect-provider-ar-ns (deser-oidc-provider-list (clojure.core/get-in letvar1547168 ["OpenIdConnectProviderARNs"]))) (letvar1547168 "CognitoIdentityProviders") (clojure.core/assoc :cognito-identity-providers (deser-cognito-identity-provider-list (clojure.core/get-in letvar1547168 ["CognitoIdentityProviders"]))) (letvar1547168 "SamlProviderARNs") (clojure.core/assoc :saml-provider-ar-ns (deser-saml-provider-list (clojure.core/get-in letvar1547168 ["SamlProviderARNs"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1547170 input] (clojure.core/let [rawinput1547169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547171 {"message" (rawinput1547169 "message")}] (clojure.core/cond-> {} (letvar1547171 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547171 ["message"])))))))

(clojure.core/defn- response-list-identities-response ([input] (response-list-identities-response nil input)) ([resultWrapper1547173 input] (clojure.core/let [rawinput1547172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547174 {"IdentityPoolId" (rawinput1547172 "IdentityPoolId"), "Identities" (rawinput1547172 "Identities"), "NextToken" (rawinput1547172 "NextToken")}] (clojure.core/cond-> {} (letvar1547174 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1547174 ["IdentityPoolId"]))) (letvar1547174 "Identities") (clojure.core/assoc :identities (deser-identities-list (clojure.core/get-in letvar1547174 ["Identities"]))) (letvar1547174 "NextToken") (clojure.core/assoc :next-token (deser-pagination-key (clojure.core/get-in letvar1547174 ["NextToken"])))))))

(clojure.core/defn- response-external-service-exception ([input] (response-external-service-exception nil input)) ([resultWrapper1547176 input] (clojure.core/let [rawinput1547175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547177 {"message" (rawinput1547175 "message")}] (clojure.core/cond-> {} (letvar1547177 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547177 ["message"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1547179 input] (clojure.core/let [rawinput1547178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547180 {"message" (rawinput1547178 "message")}] (clojure.core/cond-> {} (letvar1547180 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547180 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1547182 input] (clojure.core/let [rawinput1547181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547183 {"message" (rawinput1547181 "message")}] (clojure.core/cond-> {} (letvar1547183 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1547183 ["message"])))))))

(clojure.core/defn- response-merge-developer-identities-response ([input] (response-merge-developer-identities-response nil input)) ([resultWrapper1547185 input] (clojure.core/let [rawinput1547184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547186 {"IdentityId" (rawinput1547184 "IdentityId")}] (clojure.core/cond-> {} (letvar1547186 "IdentityId") (clojure.core/assoc :identity-id (deser-identity-id (clojure.core/get-in letvar1547186 ["IdentityId"])))))))

(clojure.core/defn- response-get-identity-pool-roles-response ([input] (response-get-identity-pool-roles-response nil input)) ([resultWrapper1547188 input] (clojure.core/let [rawinput1547187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1547189 {"IdentityPoolId" (rawinput1547187 "IdentityPoolId"), "Roles" (rawinput1547187 "Roles"), "RoleMappings" (rawinput1547187 "RoleMappings")}] (clojure.core/cond-> {} (letvar1547189 "IdentityPoolId") (clojure.core/assoc :identity-pool-id (deser-identity-pool-id (clojure.core/get-in letvar1547189 ["IdentityPoolId"]))) (letvar1547189 "Roles") (clojure.core/assoc :roles (deser-roles-map (clojure.core/get-in letvar1547189 ["Roles"]))) (letvar1547189 "RoleMappings") (clojure.core/assoc :role-mappings (deser-role-mapping-map (clojure.core/get-in letvar1547189 ["RoleMappings"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/pagination-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/claim-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.cognito-identity/query-limit (clojure.spec.alpha/int-in 1 60))

(clojure.spec.alpha/def :portkey.aws.cognito-identity/developer-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w._-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/claim-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/cognito-identity-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w._:/-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/cognito-identity-provider-client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-pool-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w ]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-provider-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w.;_/-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\d+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/arn-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/identity-provider-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50000))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/developer-user-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.cognito-identity/role-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(un)?authenticated" s__1410940__auto__))))
