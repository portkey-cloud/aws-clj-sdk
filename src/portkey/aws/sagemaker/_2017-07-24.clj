...
(clojure.core/defn- response-create-workteam-response ([input] (response-create-workteam-response nil input)) ([resultWrapper1997516 input] (clojure.core/let [rawinput1997515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997517 {"WorkteamArn" (rawinput1997515 "WorkteamArn")}] (clojure.core/cond-> {} (letvar1997517 "WorkteamArn") (clojure.core/assoc :workteam-arn (deser-workteam-arn (clojure.core/get-in letvar1997517 ["WorkteamArn"])))))))

(clojure.core/defn- response-create-labeling-job-response ([input] (response-create-labeling-job-response nil input)) ([resultWrapper1997519 input] (clojure.core/let [rawinput1997518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997520 {"LabelingJobArn" (rawinput1997518 "LabelingJobArn")}] (clojure.core/cond-> {:labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1997520 ["LabelingJobArn"]))}))))

(clojure.core/defn- response-list-endpoint-configs-output ([input] (response-list-endpoint-configs-output nil input)) ([resultWrapper1997522 input] (clojure.core/let [rawinput1997521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997523 {"EndpointConfigs" (rawinput1997521 "EndpointConfigs"), "NextToken" (rawinput1997521 "NextToken")}] (clojure.core/cond-> {:endpoint-configs (deser-endpoint-config-summary-list (clojure.core/get-in letvar1997523 ["EndpointConfigs"]))} (letvar1997523 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1997523 ["NextToken"])))))))

(clojure.core/defn- response-describe-algorithm-output ([input] (response-describe-algorithm-output nil input)) ([resultWrapper1997525 input] (clojure.core/let [rawinput1997524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997526 {"CertifyForMarketplace" (rawinput1997524 "CertifyForMarketplace"), "AlgorithmName" (rawinput1997524 "AlgorithmName"), "AlgorithmStatus" (rawinput1997524 "AlgorithmStatus"), "InferenceSpecification" (rawinput1997524 "InferenceSpecification"), "TrainingSpecification" (rawinput1997524 "TrainingSpecification"), "CreationTime" (rawinput1997524 "CreationTime"), "AlgorithmStatusDetails" (rawinput1997524 "AlgorithmStatusDetails"), "ValidationSpecification" (rawinput1997524 "ValidationSpecification"), "ProductId" (rawinput1997524 "ProductId"), "AlgorithmDescription" (rawinput1997524 "AlgorithmDescription"), "AlgorithmArn" (rawinput1997524 "AlgorithmArn")}] (clojure.core/cond-> {:algorithm-name (deser-entity-name (clojure.core/get-in letvar1997526 ["AlgorithmName"])), :algorithm-arn (deser-algorithm-arn (clojure.core/get-in letvar1997526 ["AlgorithmArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1997526 ["CreationTime"])), :training-specification (deser-training-specification (clojure.core/get-in letvar1997526 ["TrainingSpecification"])), :algorithm-status (deser-algorithm-status (clojure.core/get-in letvar1997526 ["AlgorithmStatus"])), :algorithm-status-details (deser-algorithm-status-details (clojure.core/get-in letvar1997526 ["AlgorithmStatusDetails"]))} (letvar1997526 "CertifyForMarketplace") (clojure.core/assoc :certify-for-marketplace (deser-certify-for-marketplace (clojure.core/get-in letvar1997526 ["CertifyForMarketplace"]))) (letvar1997526 "InferenceSpecification") (clojure.core/assoc :inference-specification (deser-inference-specification (clojure.core/get-in letvar1997526 ["InferenceSpecification"]))) (letvar1997526 "ValidationSpecification") (clojure.core/assoc :validation-specification (deser-algorithm-validation-specification (clojure.core/get-in letvar1997526 ["ValidationSpecification"]))) (letvar1997526 "ProductId") (clojure.core/assoc :product-id (deser-product-id (clojure.core/get-in letvar1997526 ["ProductId"]))) (letvar1997526 "AlgorithmDescription") (clojure.core/assoc :algorithm-description (deser-entity-description (clojure.core/get-in letvar1997526 ["AlgorithmDescription"])))))))

(clojure.core/defn- response-create-notebook-instance-lifecycle-config-output ([input] (response-create-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1997528 input] (clojure.core/let [rawinput1997527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997529 {"NotebookInstanceLifecycleConfigArn" (rawinput1997527 "NotebookInstanceLifecycleConfigArn")}] (clojure.core/cond-> {} (letvar1997529 "NotebookInstanceLifecycleConfigArn") (clojure.core/assoc :notebook-instance-lifecycle-config-arn (deser-notebook-instance-lifecycle-config-arn (clojure.core/get-in letvar1997529 ["NotebookInstanceLifecycleConfigArn"])))))))

(clojure.core/defn- response-list-transform-jobs-response ([input] (response-list-transform-jobs-response nil input)) ([resultWrapper1997531 input] (clojure.core/let [rawinput1997530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997532 {"TransformJobSummaries" (rawinput1997530 "TransformJobSummaries"), "NextToken" (rawinput1997530 "NextToken")}] (clojure.core/cond-> {:transform-job-summaries (deser-transform-job-summaries (clojure.core/get-in letvar1997532 ["TransformJobSummaries"]))} (letvar1997532 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997532 ["NextToken"])))))))

(clojure.core/defn- response-list-models-output ([input] (response-list-models-output nil input)) ([resultWrapper1997534 input] (clojure.core/let [rawinput1997533 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997535 {"Models" (rawinput1997533 "Models"), "NextToken" (rawinput1997533 "NextToken")}] (clojure.core/cond-> {:models (deser-model-summary-list (clojure.core/get-in letvar1997535 ["Models"]))} (letvar1997535 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1997535 ["NextToken"])))))))

(clojure.core/defn- response-create-presigned-notebook-instance-url-output ([input] (response-create-presigned-notebook-instance-url-output nil input)) ([resultWrapper1997537 input] (clojure.core/let [rawinput1997536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997538 {"AuthorizedUrl" (rawinput1997536 "AuthorizedUrl")}] (clojure.core/cond-> {} (letvar1997538 "AuthorizedUrl") (clojure.core/assoc :authorized-url (deser-notebook-instance-url (clojure.core/get-in letvar1997538 ["AuthorizedUrl"])))))))

(clojure.core/defn- response-list-code-repositories-output ([input] (response-list-code-repositories-output nil input)) ([resultWrapper1997540 input] (clojure.core/let [rawinput1997539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997541 {"CodeRepositorySummaryList" (rawinput1997539 "CodeRepositorySummaryList"), "NextToken" (rawinput1997539 "NextToken")}] (clojure.core/cond-> {:code-repository-summary-list (deser-code-repository-summary-list (clojure.core/get-in letvar1997541 ["CodeRepositorySummaryList"]))} (letvar1997541 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997541 ["NextToken"])))))))

(clojure.core/defn- response-describe-hyper-parameter-tuning-job-response ([input] (response-describe-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1997543 input] (clojure.core/let [rawinput1997542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997544 {"HyperParameterTuningJobStatus" (rawinput1997542 "HyperParameterTuningJobStatus"), "HyperParameterTuningJobConfig" (rawinput1997542 "HyperParameterTuningJobConfig"), "ObjectiveStatusCounters" (rawinput1997542 "ObjectiveStatusCounters"), "HyperParameterTuningEndTime" (rawinput1997542 "HyperParameterTuningEndTime"), "HyperParameterTuningJobArn" (rawinput1997542 "HyperParameterTuningJobArn"), "WarmStartConfig" (rawinput1997542 "WarmStartConfig"), "BestTrainingJob" (rawinput1997542 "BestTrainingJob"), "FailureReason" (rawinput1997542 "FailureReason"), "TrainingJobStatusCounters" (rawinput1997542 "TrainingJobStatusCounters"), "TrainingJobDefinition" (rawinput1997542 "TrainingJobDefinition"), "CreationTime" (rawinput1997542 "CreationTime"), "HyperParameterTuningJobName" (rawinput1997542 "HyperParameterTuningJobName"), "LastModifiedTime" (rawinput1997542 "LastModifiedTime"), "OverallBestTrainingJob" (rawinput1997542 "OverallBestTrainingJob")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-name (deser-hyper-parameter-tuning-job-name (clojure.core/get-in letvar1997544 ["HyperParameterTuningJobName"])), :hyper-parameter-tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1997544 ["HyperParameterTuningJobArn"])), :hyper-parameter-tuning-job-config (deser-hyper-parameter-tuning-job-config (clojure.core/get-in letvar1997544 ["HyperParameterTuningJobConfig"])), :training-job-definition (deser-hyper-parameter-training-job-definition (clojure.core/get-in letvar1997544 ["TrainingJobDefinition"])), :hyper-parameter-tuning-job-status (deser-hyper-parameter-tuning-job-status (clojure.core/get-in letvar1997544 ["HyperParameterTuningJobStatus"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997544 ["CreationTime"])), :training-job-status-counters (deser-training-job-status-counters (clojure.core/get-in letvar1997544 ["TrainingJobStatusCounters"])), :objective-status-counters (deser-objective-status-counters (clojure.core/get-in letvar1997544 ["ObjectiveStatusCounters"]))} (letvar1997544 "HyperParameterTuningEndTime") (clojure.core/assoc :hyper-parameter-tuning-end-time (deser-timestamp (clojure.core/get-in letvar1997544 ["HyperParameterTuningEndTime"]))) (letvar1997544 "WarmStartConfig") (clojure.core/assoc :warm-start-config (deser-hyper-parameter-tuning-job-warm-start-config (clojure.core/get-in letvar1997544 ["WarmStartConfig"]))) (letvar1997544 "BestTrainingJob") (clojure.core/assoc :best-training-job (deser-hyper-parameter-training-job-summary (clojure.core/get-in letvar1997544 ["BestTrainingJob"]))) (letvar1997544 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997544 ["FailureReason"]))) (letvar1997544 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-timestamp (clojure.core/get-in letvar1997544 ["LastModifiedTime"]))) (letvar1997544 "OverallBestTrainingJob") (clojure.core/assoc :overall-best-training-job (deser-hyper-parameter-training-job-summary (clojure.core/get-in letvar1997544 ["OverallBestTrainingJob"])))))))

(clojure.core/defn- response-create-hyper-parameter-tuning-job-response ([input] (response-create-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1997546 input] (clojure.core/let [rawinput1997545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997547 {"HyperParameterTuningJobArn" (rawinput1997545 "HyperParameterTuningJobArn")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1997547 ["HyperParameterTuningJobArn"]))}))))

(clojure.core/defn- response-describe-transform-job-response ([input] (response-describe-transform-job-response nil input)) ([resultWrapper1997549 input] (clojure.core/let [rawinput1997548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997550 {"LabelingJobArn" (rawinput1997548 "LabelingJobArn"), "TransformEndTime" (rawinput1997548 "TransformEndTime"), "ModelName" (rawinput1997548 "ModelName"), "MaxPayloadInMB" (rawinput1997548 "MaxPayloadInMB"), "TransformResources" (rawinput1997548 "TransformResources"), "MaxConcurrentTransforms" (rawinput1997548 "MaxConcurrentTransforms"), "TransformInput" (rawinput1997548 "TransformInput"), "TransformStartTime" (rawinput1997548 "TransformStartTime"), "FailureReason" (rawinput1997548 "FailureReason"), "TransformJobName" (rawinput1997548 "TransformJobName"), "TransformJobArn" (rawinput1997548 "TransformJobArn"), "BatchStrategy" (rawinput1997548 "BatchStrategy"), "Environment" (rawinput1997548 "Environment"), "CreationTime" (rawinput1997548 "CreationTime"), "TransformJobStatus" (rawinput1997548 "TransformJobStatus"), "TransformOutput" (rawinput1997548 "TransformOutput")}] (clojure.core/cond-> {:transform-job-name (deser-transform-job-name (clojure.core/get-in letvar1997550 ["TransformJobName"])), :transform-job-arn (deser-transform-job-arn (clojure.core/get-in letvar1997550 ["TransformJobArn"])), :transform-job-status (deser-transform-job-status (clojure.core/get-in letvar1997550 ["TransformJobStatus"])), :model-name (deser-model-name (clojure.core/get-in letvar1997550 ["ModelName"])), :transform-input (deser-transform-input (clojure.core/get-in letvar1997550 ["TransformInput"])), :transform-resources (deser-transform-resources (clojure.core/get-in letvar1997550 ["TransformResources"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997550 ["CreationTime"]))} (letvar1997550 "LabelingJobArn") (clojure.core/assoc :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1997550 ["LabelingJobArn"]))) (letvar1997550 "TransformEndTime") (clojure.core/assoc :transform-end-time (deser-timestamp (clojure.core/get-in letvar1997550 ["TransformEndTime"]))) (letvar1997550 "MaxPayloadInMB") (clojure.core/assoc :max-payload-in-mb (deser-max-payload-in-mb (clojure.core/get-in letvar1997550 ["MaxPayloadInMB"]))) (letvar1997550 "MaxConcurrentTransforms") (clojure.core/assoc :max-concurrent-transforms (deser-max-concurrent-transforms (clojure.core/get-in letvar1997550 ["MaxConcurrentTransforms"]))) (letvar1997550 "TransformStartTime") (clojure.core/assoc :transform-start-time (deser-timestamp (clojure.core/get-in letvar1997550 ["TransformStartTime"]))) (letvar1997550 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997550 ["FailureReason"]))) (letvar1997550 "BatchStrategy") (clojure.core/assoc :batch-strategy (deser-batch-strategy (clojure.core/get-in letvar1997550 ["BatchStrategy"]))) (letvar1997550 "Environment") (clojure.core/assoc :environment (deser-transform-environment-map (clojure.core/get-in letvar1997550 ["Environment"]))) (letvar1997550 "TransformOutput") (clojure.core/assoc :transform-output (deser-transform-output (clojure.core/get-in letvar1997550 ["TransformOutput"])))))))

(clojure.core/defn- response-delete-workteam-response ([input] (response-delete-workteam-response nil input)) ([resultWrapper1997552 input] (clojure.core/let [rawinput1997551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997553 {"Success" (rawinput1997551 "Success")}] (clojure.core/cond-> {:success (deser-success (clojure.core/get-in letvar1997553 ["Success"]))}))))

(clojure.core/defn- response-update-code-repository-output ([input] (response-update-code-repository-output nil input)) ([resultWrapper1997555 input] (clojure.core/let [rawinput1997554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997556 {"CodeRepositoryArn" (rawinput1997554 "CodeRepositoryArn")}] (clojure.core/cond-> {:code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1997556 ["CodeRepositoryArn"]))}))))

(clojure.core/defn- response-delete-tags-output ([input] (response-delete-tags-output nil input)) ([resultWrapper1997558 input] (clojure.core/let [rawinput1997557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997559 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-labeling-jobs-for-workteam-response ([input] (response-list-labeling-jobs-for-workteam-response nil input)) ([resultWrapper1997561 input] (clojure.core/let [rawinput1997560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997562 {"LabelingJobSummaryList" (rawinput1997560 "LabelingJobSummaryList"), "NextToken" (rawinput1997560 "NextToken")}] (clojure.core/cond-> {:labeling-job-summary-list (deser-labeling-job-for-workteam-summary-list (clojure.core/get-in letvar1997562 ["LabelingJobSummaryList"]))} (letvar1997562 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997562 ["NextToken"])))))))

(clojure.core/defn- response-describe-code-repository-output ([input] (response-describe-code-repository-output nil input)) ([resultWrapper1997564 input] (clojure.core/let [rawinput1997563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997565 {"CodeRepositoryName" (rawinput1997563 "CodeRepositoryName"), "CodeRepositoryArn" (rawinput1997563 "CodeRepositoryArn"), "CreationTime" (rawinput1997563 "CreationTime"), "LastModifiedTime" (rawinput1997563 "LastModifiedTime"), "GitConfig" (rawinput1997563 "GitConfig")}] (clojure.core/cond-> {:code-repository-name (deser-entity-name (clojure.core/get-in letvar1997565 ["CodeRepositoryName"])), :code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1997565 ["CodeRepositoryArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1997565 ["CreationTime"])), :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1997565 ["LastModifiedTime"]))} (letvar1997565 "GitConfig") (clojure.core/assoc :git-config (deser-git-config (clojure.core/get-in letvar1997565 ["GitConfig"])))))))

(clojure.core/defn- response-describe-compilation-job-response ([input] (response-describe-compilation-job-response nil input)) ([resultWrapper1997567 input] (clojure.core/let [rawinput1997566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997568 {"InputConfig" (rawinput1997566 "InputConfig"), "RoleArn" (rawinput1997566 "RoleArn"), "StoppingCondition" (rawinput1997566 "StoppingCondition"), "CompilationJobArn" (rawinput1997566 "CompilationJobArn"), "CompilationEndTime" (rawinput1997566 "CompilationEndTime"), "FailureReason" (rawinput1997566 "FailureReason"), "CreationTime" (rawinput1997566 "CreationTime"), "CompilationJobName" (rawinput1997566 "CompilationJobName"), "ModelArtifacts" (rawinput1997566 "ModelArtifacts"), "LastModifiedTime" (rawinput1997566 "LastModifiedTime"), "CompilationJobStatus" (rawinput1997566 "CompilationJobStatus"), "OutputConfig" (rawinput1997566 "OutputConfig"), "CompilationStartTime" (rawinput1997566 "CompilationStartTime")}] (clojure.core/cond-> {:compilation-job-name (deser-entity-name (clojure.core/get-in letvar1997568 ["CompilationJobName"])), :stopping-condition (deser-stopping-condition (clojure.core/get-in letvar1997568 ["StoppingCondition"])), :output-config (deser-output-config (clojure.core/get-in letvar1997568 ["OutputConfig"])), :compilation-job-status (deser-compilation-job-status (clojure.core/get-in letvar1997568 ["CompilationJobStatus"])), :model-artifacts (deser-model-artifacts (clojure.core/get-in letvar1997568 ["ModelArtifacts"])), :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997568 ["FailureReason"])), :role-arn (deser-role-arn (clojure.core/get-in letvar1997568 ["RoleArn"])), :input-config (deser-input-config (clojure.core/get-in letvar1997568 ["InputConfig"])), :compilation-job-arn (deser-compilation-job-arn (clojure.core/get-in letvar1997568 ["CompilationJobArn"])), :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1997568 ["LastModifiedTime"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1997568 ["CreationTime"]))} (letvar1997568 "CompilationEndTime") (clojure.core/assoc :compilation-end-time (deser-timestamp (clojure.core/get-in letvar1997568 ["CompilationEndTime"]))) (letvar1997568 "CompilationStartTime") (clojure.core/assoc :compilation-start-time (deser-timestamp (clojure.core/get-in letvar1997568 ["CompilationStartTime"])))))))

(clojure.core/defn- response-describe-model-output ([input] (response-describe-model-output nil input)) ([resultWrapper1997570 input] (clojure.core/let [rawinput1997569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997571 {"ModelName" (rawinput1997569 "ModelName"), "PrimaryContainer" (rawinput1997569 "PrimaryContainer"), "Containers" (rawinput1997569 "Containers"), "ExecutionRoleArn" (rawinput1997569 "ExecutionRoleArn"), "VpcConfig" (rawinput1997569 "VpcConfig"), "CreationTime" (rawinput1997569 "CreationTime"), "ModelArn" (rawinput1997569 "ModelArn"), "EnableNetworkIsolation" (rawinput1997569 "EnableNetworkIsolation")}] (clojure.core/cond-> {:model-name (deser-model-name (clojure.core/get-in letvar1997571 ["ModelName"])), :execution-role-arn (deser-role-arn (clojure.core/get-in letvar1997571 ["ExecutionRoleArn"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997571 ["CreationTime"])), :model-arn (deser-model-arn (clojure.core/get-in letvar1997571 ["ModelArn"]))} (letvar1997571 "PrimaryContainer") (clojure.core/assoc :primary-container (deser-container-definition (clojure.core/get-in letvar1997571 ["PrimaryContainer"]))) (letvar1997571 "Containers") (clojure.core/assoc :containers (deser-container-definition-list (clojure.core/get-in letvar1997571 ["Containers"]))) (letvar1997571 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config (clojure.core/get-in letvar1997571 ["VpcConfig"]))) (letvar1997571 "EnableNetworkIsolation") (clojure.core/assoc :enable-network-isolation (deser-boolean (clojure.core/get-in letvar1997571 ["EnableNetworkIsolation"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1997573 input] (clojure.core/let [rawinput1997572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997574 {"Tags" (rawinput1997572 "Tags")}] (clojure.core/cond-> {} (letvar1997574 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1997574 ["Tags"])))))))

(clojure.core/defn- response-list-model-packages-output ([input] (response-list-model-packages-output nil input)) ([resultWrapper1997576 input] (clojure.core/let [rawinput1997575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997577 {"ModelPackageSummaryList" (rawinput1997575 "ModelPackageSummaryList"), "NextToken" (rawinput1997575 "NextToken")}] (clojure.core/cond-> {:model-package-summary-list (deser-model-package-summary-list (clojure.core/get-in letvar1997577 ["ModelPackageSummaryList"]))} (letvar1997577 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997577 ["NextToken"])))))))

(clojure.core/defn- response-list-subscribed-workteams-response ([input] (response-list-subscribed-workteams-response nil input)) ([resultWrapper1997579 input] (clojure.core/let [rawinput1997578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997580 {"SubscribedWorkteams" (rawinput1997578 "SubscribedWorkteams"), "NextToken" (rawinput1997578 "NextToken")}] (clojure.core/cond-> {:subscribed-workteams (deser-subscribed-workteams (clojure.core/get-in letvar1997580 ["SubscribedWorkteams"]))} (letvar1997580 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997580 ["NextToken"])))))))

(clojure.core/defn- response-list-workteams-response ([input] (response-list-workteams-response nil input)) ([resultWrapper1997582 input] (clojure.core/let [rawinput1997581 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997583 {"Workteams" (rawinput1997581 "Workteams"), "NextToken" (rawinput1997581 "NextToken")}] (clojure.core/cond-> {:workteams (deser-workteams (clojure.core/get-in letvar1997583 ["Workteams"]))} (letvar1997583 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997583 ["NextToken"])))))))

(clojure.core/defn- response-create-model-output ([input] (response-create-model-output nil input)) ([resultWrapper1997585 input] (clojure.core/let [rawinput1997584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997586 {"ModelArn" (rawinput1997584 "ModelArn")}] (clojure.core/cond-> {:model-arn (deser-model-arn (clojure.core/get-in letvar1997586 ["ModelArn"]))}))))

(clojure.core/defn- response-list-notebook-instances-output ([input] (response-list-notebook-instances-output nil input)) ([resultWrapper1997588 input] (clojure.core/let [rawinput1997587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997589 {"NextToken" (rawinput1997587 "NextToken"), "NotebookInstances" (rawinput1997587 "NotebookInstances")}] (clojure.core/cond-> {} (letvar1997589 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997589 ["NextToken"]))) (letvar1997589 "NotebookInstances") (clojure.core/assoc :notebook-instances (deser-notebook-instance-summary-list (clojure.core/get-in letvar1997589 ["NotebookInstances"])))))))

(clojure.core/defn- response-describe-workteam-response ([input] (response-describe-workteam-response nil input)) ([resultWrapper1997591 input] (clojure.core/let [rawinput1997590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997592 {"Workteam" (rawinput1997590 "Workteam")}] (clojure.core/cond-> {:workteam (deser-workteam (clojure.core/get-in letvar1997592 ["Workteam"]))}))))

(clojure.core/defn- response-list-labeling-jobs-response ([input] (response-list-labeling-jobs-response nil input)) ([resultWrapper1997594 input] (clojure.core/let [rawinput1997593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997595 {"LabelingJobSummaryList" (rawinput1997593 "LabelingJobSummaryList"), "NextToken" (rawinput1997593 "NextToken")}] (clojure.core/cond-> {} (letvar1997595 "LabelingJobSummaryList") (clojure.core/assoc :labeling-job-summary-list (deser-labeling-job-summary-list (clojure.core/get-in letvar1997595 ["LabelingJobSummaryList"]))) (letvar1997595 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997595 ["NextToken"])))))))

(clojure.core/defn- response-describe-notebook-instance-output ([input] (response-describe-notebook-instance-output nil input)) ([resultWrapper1997597 input] (clojure.core/let [rawinput1997596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997598 {"VolumeSizeInGB" (rawinput1997596 "VolumeSizeInGB"), "NotebookInstanceArn" (rawinput1997596 "NotebookInstanceArn"), "SubnetId" (rawinput1997596 "SubnetId"), "SecurityGroups" (rawinput1997596 "SecurityGroups"), "InstanceType" (rawinput1997596 "InstanceType"), "RoleArn" (rawinput1997596 "RoleArn"), "AcceleratorTypes" (rawinput1997596 "AcceleratorTypes"), "NetworkInterfaceId" (rawinput1997596 "NetworkInterfaceId"), "NotebookInstanceLifecycleConfigName" (rawinput1997596 "NotebookInstanceLifecycleConfigName"), "NotebookInstanceStatus" (rawinput1997596 "NotebookInstanceStatus"), "DefaultCodeRepository" (rawinput1997596 "DefaultCodeRepository"), "DirectInternetAccess" (rawinput1997596 "DirectInternetAccess"), "Url" (rawinput1997596 "Url"), "AdditionalCodeRepositories" (rawinput1997596 "AdditionalCodeRepositories"), "FailureReason" (rawinput1997596 "FailureReason"), "KmsKeyId" (rawinput1997596 "KmsKeyId"), "CreationTime" (rawinput1997596 "CreationTime"), "LastModifiedTime" (rawinput1997596 "LastModifiedTime"), "NotebookInstanceName" (rawinput1997596 "NotebookInstanceName")}] (clojure.core/cond-> {} (letvar1997598 "VolumeSizeInGB") (clojure.core/assoc :volume-size-in-gb (deser-notebook-instance-volume-size-in-gb (clojure.core/get-in letvar1997598 ["VolumeSizeInGB"]))) (letvar1997598 "NotebookInstanceArn") (clojure.core/assoc :notebook-instance-arn (deser-notebook-instance-arn (clojure.core/get-in letvar1997598 ["NotebookInstanceArn"]))) (letvar1997598 "SubnetId") (clojure.core/assoc :subnet-id (deser-subnet-id (clojure.core/get-in letvar1997598 ["SubnetId"]))) (letvar1997598 "SecurityGroups") (clojure.core/assoc :security-groups (deser-security-group-ids (clojure.core/get-in letvar1997598 ["SecurityGroups"]))) (letvar1997598 "InstanceType") (clojure.core/assoc :instance-type (deser-instance-type (clojure.core/get-in letvar1997598 ["InstanceType"]))) (letvar1997598 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1997598 ["RoleArn"]))) (letvar1997598 "AcceleratorTypes") (clojure.core/assoc :accelerator-types (deser-notebook-instance-accelerator-types (clojure.core/get-in letvar1997598 ["AcceleratorTypes"]))) (letvar1997598 "NetworkInterfaceId") (clojure.core/assoc :network-interface-id (deser-network-interface-id (clojure.core/get-in letvar1997598 ["NetworkInterfaceId"]))) (letvar1997598 "NotebookInstanceLifecycleConfigName") (clojure.core/assoc :notebook-instance-lifecycle-config-name (deser-notebook-instance-lifecycle-config-name (clojure.core/get-in letvar1997598 ["NotebookInstanceLifecycleConfigName"]))) (letvar1997598 "NotebookInstanceStatus") (clojure.core/assoc :notebook-instance-status (deser-notebook-instance-status (clojure.core/get-in letvar1997598 ["NotebookInstanceStatus"]))) (letvar1997598 "DefaultCodeRepository") (clojure.core/assoc :default-code-repository (deser-code-repository-name-or-url (clojure.core/get-in letvar1997598 ["DefaultCodeRepository"]))) (letvar1997598 "DirectInternetAccess") (clojure.core/assoc :direct-internet-access (deser-direct-internet-access (clojure.core/get-in letvar1997598 ["DirectInternetAccess"]))) (letvar1997598 "Url") (clojure.core/assoc :url (deser-notebook-instance-url (clojure.core/get-in letvar1997598 ["Url"]))) (letvar1997598 "AdditionalCodeRepositories") (clojure.core/assoc :additional-code-repositories (deser-additional-code-repository-names-or-urls (clojure.core/get-in letvar1997598 ["AdditionalCodeRepositories"]))) (letvar1997598 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997598 ["FailureReason"]))) (letvar1997598 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar1997598 ["KmsKeyId"]))) (letvar1997598 "CreationTime") (clojure.core/assoc :creation-time (deser-creation-time (clojure.core/get-in letvar1997598 ["CreationTime"]))) (letvar1997598 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1997598 ["LastModifiedTime"]))) (letvar1997598 "NotebookInstanceName") (clojure.core/assoc :notebook-instance-name (deser-notebook-instance-name (clojure.core/get-in letvar1997598 ["NotebookInstanceName"])))))))

(clojure.core/defn- response-list-training-jobs-for-hyper-parameter-tuning-job-response ([input] (response-list-training-jobs-for-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1997600 input] (clojure.core/let [rawinput1997599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997601 {"TrainingJobSummaries" (rawinput1997599 "TrainingJobSummaries"), "NextToken" (rawinput1997599 "NextToken")}] (clojure.core/cond-> {:training-job-summaries (deser-hyper-parameter-training-job-summaries (clojure.core/get-in letvar1997601 ["TrainingJobSummaries"]))} (letvar1997601 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997601 ["NextToken"])))))))

(clojure.core/defn- response-get-search-suggestions-response ([input] (response-get-search-suggestions-response nil input)) ([resultWrapper1997603 input] (clojure.core/let [rawinput1997602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997604 {"PropertyNameSuggestions" (rawinput1997602 "PropertyNameSuggestions")}] (clojure.core/cond-> {} (letvar1997604 "PropertyNameSuggestions") (clojure.core/assoc :property-name-suggestions (deser-property-name-suggestion-list (clojure.core/get-in letvar1997604 ["PropertyNameSuggestions"])))))))

(clojure.core/defn- response-list-training-jobs-response ([input] (response-list-training-jobs-response nil input)) ([resultWrapper1997606 input] (clojure.core/let [rawinput1997605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997607 {"TrainingJobSummaries" (rawinput1997605 "TrainingJobSummaries"), "NextToken" (rawinput1997605 "NextToken")}] (clojure.core/cond-> {:training-job-summaries (deser-training-job-summaries (clojure.core/get-in letvar1997607 ["TrainingJobSummaries"]))} (letvar1997607 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997607 ["NextToken"])))))))

(clojure.core/defn- response-describe-labeling-job-response ([input] (response-describe-labeling-job-response nil input)) ([resultWrapper1997609 input] (clojure.core/let [rawinput1997608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997610 {"LabelingJobArn" (rawinput1997608 "LabelingJobArn"), "LabelCounters" (rawinput1997608 "LabelCounters"), "InputConfig" (rawinput1997608 "InputConfig"), "LabelingJobOutput" (rawinput1997608 "LabelingJobOutput"), "RoleArn" (rawinput1997608 "RoleArn"), "Tags" (rawinput1997608 "Tags"), "HumanTaskConfig" (rawinput1997608 "HumanTaskConfig"), "LabelAttributeName" (rawinput1997608 "LabelAttributeName"), "FailureReason" (rawinput1997608 "FailureReason"), "CreationTime" (rawinput1997608 "CreationTime"), "StoppingConditions" (rawinput1997608 "StoppingConditions"), "LabelingJobName" (rawinput1997608 "LabelingJobName"), "LabelCategoryConfigS3Uri" (rawinput1997608 "LabelCategoryConfigS3Uri"), "JobReferenceCode" (rawinput1997608 "JobReferenceCode"), "LastModifiedTime" (rawinput1997608 "LastModifiedTime"), "LabelingJobStatus" (rawinput1997608 "LabelingJobStatus"), "LabelingJobAlgorithmsConfig" (rawinput1997608 "LabelingJobAlgorithmsConfig"), "OutputConfig" (rawinput1997608 "OutputConfig")}] (clojure.core/cond-> {:labeling-job-name (deser-labeling-job-name (clojure.core/get-in letvar1997610 ["LabelingJobName"])), :output-config (deser-labeling-job-output-config (clojure.core/get-in letvar1997610 ["OutputConfig"])), :human-task-config (deser-human-task-config (clojure.core/get-in letvar1997610 ["HumanTaskConfig"])), :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1997610 ["LabelingJobArn"])), :labeling-job-status (deser-labeling-job-status (clojure.core/get-in letvar1997610 ["LabelingJobStatus"])), :role-arn (deser-role-arn (clojure.core/get-in letvar1997610 ["RoleArn"])), :job-reference-code (deser-job-reference-code (clojure.core/get-in letvar1997610 ["JobReferenceCode"])), :input-config (deser-labeling-job-input-config (clojure.core/get-in letvar1997610 ["InputConfig"])), :last-modified-time (deser-timestamp (clojure.core/get-in letvar1997610 ["LastModifiedTime"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997610 ["CreationTime"])), :label-counters (deser-label-counters (clojure.core/get-in letvar1997610 ["LabelCounters"]))} (letvar1997610 "LabelingJobOutput") (clojure.core/assoc :labeling-job-output (deser-labeling-job-output (clojure.core/get-in letvar1997610 ["LabelingJobOutput"]))) (letvar1997610 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1997610 ["Tags"]))) (letvar1997610 "LabelAttributeName") (clojure.core/assoc :label-attribute-name (deser-label-attribute-name (clojure.core/get-in letvar1997610 ["LabelAttributeName"]))) (letvar1997610 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997610 ["FailureReason"]))) (letvar1997610 "StoppingConditions") (clojure.core/assoc :stopping-conditions (deser-labeling-job-stopping-conditions (clojure.core/get-in letvar1997610 ["StoppingConditions"]))) (letvar1997610 "LabelCategoryConfigS3Uri") (clojure.core/assoc :label-category-config-s-3-uri (deser-s-3-uri (clojure.core/get-in letvar1997610 ["LabelCategoryConfigS3Uri"]))) (letvar1997610 "LabelingJobAlgorithmsConfig") (clojure.core/assoc :labeling-job-algorithms-config (deser-labeling-job-algorithms-config (clojure.core/get-in letvar1997610 ["LabelingJobAlgorithmsConfig"])))))))

(clojure.core/defn- response-update-endpoint-weights-and-capacities-output ([input] (response-update-endpoint-weights-and-capacities-output nil input)) ([resultWrapper1997612 input] (clojure.core/let [rawinput1997611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997613 {"EndpointArn" (rawinput1997611 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1997613 ["EndpointArn"]))}))))

(clojure.core/defn- response-create-transform-job-response ([input] (response-create-transform-job-response nil input)) ([resultWrapper1997615 input] (clojure.core/let [rawinput1997614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997616 {"TransformJobArn" (rawinput1997614 "TransformJobArn")}] (clojure.core/cond-> {:transform-job-arn (deser-transform-job-arn (clojure.core/get-in letvar1997616 ["TransformJobArn"]))}))))

(clojure.core/defn- response-describe-endpoint-config-output ([input] (response-describe-endpoint-config-output nil input)) ([resultWrapper1997618 input] (clojure.core/let [rawinput1997617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997619 {"EndpointConfigName" (rawinput1997617 "EndpointConfigName"), "EndpointConfigArn" (rawinput1997617 "EndpointConfigArn"), "ProductionVariants" (rawinput1997617 "ProductionVariants"), "KmsKeyId" (rawinput1997617 "KmsKeyId"), "CreationTime" (rawinput1997617 "CreationTime")}] (clojure.core/cond-> {:endpoint-config-name (deser-endpoint-config-name (clojure.core/get-in letvar1997619 ["EndpointConfigName"])), :endpoint-config-arn (deser-endpoint-config-arn (clojure.core/get-in letvar1997619 ["EndpointConfigArn"])), :production-variants (deser-production-variant-list (clojure.core/get-in letvar1997619 ["ProductionVariants"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997619 ["CreationTime"]))} (letvar1997619 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar1997619 ["KmsKeyId"])))))))

(clojure.core/defn- response-create-code-repository-output ([input] (response-create-code-repository-output nil input)) ([resultWrapper1997621 input] (clojure.core/let [rawinput1997620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997622 {"CodeRepositoryArn" (rawinput1997620 "CodeRepositoryArn")}] (clojure.core/cond-> {:code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1997622 ["CodeRepositoryArn"]))}))))

(clojure.core/defn- response-create-algorithm-output ([input] (response-create-algorithm-output nil input)) ([resultWrapper1997624 input] (clojure.core/let [rawinput1997623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997625 {"AlgorithmArn" (rawinput1997623 "AlgorithmArn")}] (clojure.core/cond-> {:algorithm-arn (deser-algorithm-arn (clojure.core/get-in letvar1997625 ["AlgorithmArn"]))}))))

(clojure.core/defn- response-update-notebook-instance-lifecycle-config-output ([input] (response-update-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1997627 input] (clojure.core/let [rawinput1997626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997628 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-training-job-response ([input] (response-describe-training-job-response nil input)) ([resultWrapper1997630 input] (clojure.core/let [rawinput1997629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997631 {"EnableNetworkIsolation" (rawinput1997629 "EnableNetworkIsolation"), "ResourceConfig" (rawinput1997629 "ResourceConfig"), "InputDataConfig" (rawinput1997629 "InputDataConfig"), "LabelingJobArn" (rawinput1997629 "LabelingJobArn"), "TrainingEndTime" (rawinput1997629 "TrainingEndTime"), "OutputDataConfig" (rawinput1997629 "OutputDataConfig"), "HyperParameters" (rawinput1997629 "HyperParameters"), "RoleArn" (rawinput1997629 "RoleArn"), "TrainingJobArn" (rawinput1997629 "TrainingJobArn"), "StoppingCondition" (rawinput1997629 "StoppingCondition"), "SecondaryStatus" (rawinput1997629 "SecondaryStatus"), "FailureReason" (rawinput1997629 "FailureReason"), "CreationTime" (rawinput1997629 "CreationTime"), "VpcConfig" (rawinput1997629 "VpcConfig"), "TrainingJobName" (rawinput1997629 "TrainingJobName"), "TuningJobArn" (rawinput1997629 "TuningJobArn"), "ModelArtifacts" (rawinput1997629 "ModelArtifacts"), "FinalMetricDataList" (rawinput1997629 "FinalMetricDataList"), "TrainingStartTime" (rawinput1997629 "TrainingStartTime"), "LastModifiedTime" (rawinput1997629 "LastModifiedTime"), "EnableInterContainerTrafficEncryption" (rawinput1997629 "EnableInterContainerTrafficEncryption"), "TrainingJobStatus" (rawinput1997629 "TrainingJobStatus"), "AlgorithmSpecification" (rawinput1997629 "AlgorithmSpecification"), "SecondaryStatusTransitions" (rawinput1997629 "SecondaryStatusTransitions")}] (clojure.core/cond-> {:stopping-condition (deser-stopping-condition (clojure.core/get-in letvar1997631 ["StoppingCondition"])), :model-artifacts (deser-model-artifacts (clojure.core/get-in letvar1997631 ["ModelArtifacts"])), :training-job-status (deser-training-job-status (clojure.core/get-in letvar1997631 ["TrainingJobStatus"])), :resource-config (deser-resource-config (clojure.core/get-in letvar1997631 ["ResourceConfig"])), :training-job-name (deser-training-job-name (clojure.core/get-in letvar1997631 ["TrainingJobName"])), :secondary-status (deser-secondary-status (clojure.core/get-in letvar1997631 ["SecondaryStatus"])), :training-job-arn (deser-training-job-arn (clojure.core/get-in letvar1997631 ["TrainingJobArn"])), :algorithm-specification (deser-algorithm-specification (clojure.core/get-in letvar1997631 ["AlgorithmSpecification"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997631 ["CreationTime"]))} (letvar1997631 "EnableNetworkIsolation") (clojure.core/assoc :enable-network-isolation (deser-boolean (clojure.core/get-in letvar1997631 ["EnableNetworkIsolation"]))) (letvar1997631 "InputDataConfig") (clojure.core/assoc :input-data-config (deser-input-data-config (clojure.core/get-in letvar1997631 ["InputDataConfig"]))) (letvar1997631 "LabelingJobArn") (clojure.core/assoc :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1997631 ["LabelingJobArn"]))) (letvar1997631 "TrainingEndTime") (clojure.core/assoc :training-end-time (deser-timestamp (clojure.core/get-in letvar1997631 ["TrainingEndTime"]))) (letvar1997631 "OutputDataConfig") (clojure.core/assoc :output-data-config (deser-output-data-config (clojure.core/get-in letvar1997631 ["OutputDataConfig"]))) (letvar1997631 "HyperParameters") (clojure.core/assoc :hyper-parameters (deser-hyper-parameters (clojure.core/get-in letvar1997631 ["HyperParameters"]))) (letvar1997631 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1997631 ["RoleArn"]))) (letvar1997631 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997631 ["FailureReason"]))) (letvar1997631 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config (clojure.core/get-in letvar1997631 ["VpcConfig"]))) (letvar1997631 "TuningJobArn") (clojure.core/assoc :tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1997631 ["TuningJobArn"]))) (letvar1997631 "FinalMetricDataList") (clojure.core/assoc :final-metric-data-list (deser-final-metric-data-list (clojure.core/get-in letvar1997631 ["FinalMetricDataList"]))) (letvar1997631 "TrainingStartTime") (clojure.core/assoc :training-start-time (deser-timestamp (clojure.core/get-in letvar1997631 ["TrainingStartTime"]))) (letvar1997631 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-timestamp (clojure.core/get-in letvar1997631 ["LastModifiedTime"]))) (letvar1997631 "EnableInterContainerTrafficEncryption") (clojure.core/assoc :enable-inter-container-traffic-encryption (deser-boolean (clojure.core/get-in letvar1997631 ["EnableInterContainerTrafficEncryption"]))) (letvar1997631 "SecondaryStatusTransitions") (clojure.core/assoc :secondary-status-transitions (deser-secondary-status-transitions (clojure.core/get-in letvar1997631 ["SecondaryStatusTransitions"])))))))

(clojure.core/defn- response-create-model-package-output ([input] (response-create-model-package-output nil input)) ([resultWrapper1997633 input] (clojure.core/let [rawinput1997632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997634 {"ModelPackageArn" (rawinput1997632 "ModelPackageArn")}] (clojure.core/cond-> {:model-package-arn (deser-model-package-arn (clojure.core/get-in letvar1997634 ["ModelPackageArn"]))}))))

(clojure.core/defn- response-describe-model-package-output ([input] (response-describe-model-package-output nil input)) ([resultWrapper1997636 input] (clojure.core/let [rawinput1997635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997637 {"CertifyForMarketplace" (rawinput1997635 "CertifyForMarketplace"), "ModelPackageName" (rawinput1997635 "ModelPackageName"), "ModelPackageStatus" (rawinput1997635 "ModelPackageStatus"), "InferenceSpecification" (rawinput1997635 "InferenceSpecification"), "ModelPackageStatusDetails" (rawinput1997635 "ModelPackageStatusDetails"), "SourceAlgorithmSpecification" (rawinput1997635 "SourceAlgorithmSpecification"), "CreationTime" (rawinput1997635 "CreationTime"), "ModelPackageArn" (rawinput1997635 "ModelPackageArn"), "ValidationSpecification" (rawinput1997635 "ValidationSpecification"), "ModelPackageDescription" (rawinput1997635 "ModelPackageDescription")}] (clojure.core/cond-> {:model-package-name (deser-entity-name (clojure.core/get-in letvar1997637 ["ModelPackageName"])), :model-package-arn (deser-model-package-arn (clojure.core/get-in letvar1997637 ["ModelPackageArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1997637 ["CreationTime"])), :model-package-status (deser-model-package-status (clojure.core/get-in letvar1997637 ["ModelPackageStatus"])), :model-package-status-details (deser-model-package-status-details (clojure.core/get-in letvar1997637 ["ModelPackageStatusDetails"]))} (letvar1997637 "CertifyForMarketplace") (clojure.core/assoc :certify-for-marketplace (deser-certify-for-marketplace (clojure.core/get-in letvar1997637 ["CertifyForMarketplace"]))) (letvar1997637 "InferenceSpecification") (clojure.core/assoc :inference-specification (deser-inference-specification (clojure.core/get-in letvar1997637 ["InferenceSpecification"]))) (letvar1997637 "SourceAlgorithmSpecification") (clojure.core/assoc :source-algorithm-specification (deser-source-algorithm-specification (clojure.core/get-in letvar1997637 ["SourceAlgorithmSpecification"]))) (letvar1997637 "ValidationSpecification") (clojure.core/assoc :validation-specification (deser-model-package-validation-specification (clojure.core/get-in letvar1997637 ["ValidationSpecification"]))) (letvar1997637 "ModelPackageDescription") (clojure.core/assoc :model-package-description (deser-entity-description (clojure.core/get-in letvar1997637 ["ModelPackageDescription"])))))))

(clojure.core/defn- response-update-notebook-instance-output ([input] (response-update-notebook-instance-output nil input)) ([resultWrapper1997639 input] (clojure.core/let [rawinput1997638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997640 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compilation-job-response ([input] (response-create-compilation-job-response nil input)) ([resultWrapper1997642 input] (clojure.core/let [rawinput1997641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997643 {"CompilationJobArn" (rawinput1997641 "CompilationJobArn")}] (clojure.core/cond-> {:compilation-job-arn (deser-compilation-job-arn (clojure.core/get-in letvar1997643 ["CompilationJobArn"]))}))))

(clojure.core/defn- response-create-training-job-response ([input] (response-create-training-job-response nil input)) ([resultWrapper1997645 input] (clojure.core/let [rawinput1997644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997646 {"TrainingJobArn" (rawinput1997644 "TrainingJobArn")}] (clojure.core/cond-> {:training-job-arn (deser-training-job-arn (clojure.core/get-in letvar1997646 ["TrainingJobArn"]))}))))

(clojure.core/defn- response-update-workteam-response ([input] (response-update-workteam-response nil input)) ([resultWrapper1997648 input] (clojure.core/let [rawinput1997647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997649 {"Workteam" (rawinput1997647 "Workteam")}] (clojure.core/cond-> {:workteam (deser-workteam (clojure.core/get-in letvar1997649 ["Workteam"]))}))))

(clojure.core/defn- response-resource-limit-exceeded ([input] (response-resource-limit-exceeded nil input)) ([resultWrapper1997651 input] (clojure.core/let [rawinput1997650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997652 {"Message" (rawinput1997650 "Message")}] (clojure.core/cond-> {} (letvar1997652 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1997652 ["Message"])))))))

(clojure.core/defn- response-update-endpoint-output ([input] (response-update-endpoint-output nil input)) ([resultWrapper1997654 input] (clojure.core/let [rawinput1997653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997655 {"EndpointArn" (rawinput1997653 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1997655 ["EndpointArn"]))}))))

(clojure.core/defn- response-create-endpoint-output ([input] (response-create-endpoint-output nil input)) ([resultWrapper1997657 input] (clojure.core/let [rawinput1997656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997658 {"EndpointArn" (rawinput1997656 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1997658 ["EndpointArn"]))}))))

(clojure.core/defn- response-resource-not-found ([input] (response-resource-not-found nil input)) ([resultWrapper1997660 input] (clojure.core/let [rawinput1997659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997661 {"Message" (rawinput1997659 "Message")}] (clojure.core/cond-> {} (letvar1997661 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1997661 ["Message"])))))))

(clojure.core/defn- response-list-hyper-parameter-tuning-jobs-response ([input] (response-list-hyper-parameter-tuning-jobs-response nil input)) ([resultWrapper1997663 input] (clojure.core/let [rawinput1997662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997664 {"HyperParameterTuningJobSummaries" (rawinput1997662 "HyperParameterTuningJobSummaries"), "NextToken" (rawinput1997662 "NextToken")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-summaries (deser-hyper-parameter-tuning-job-summaries (clojure.core/get-in letvar1997664 ["HyperParameterTuningJobSummaries"]))} (letvar1997664 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997664 ["NextToken"])))))))

(clojure.core/defn- response-list-algorithms-output ([input] (response-list-algorithms-output nil input)) ([resultWrapper1997666 input] (clojure.core/let [rawinput1997665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997667 {"AlgorithmSummaryList" (rawinput1997665 "AlgorithmSummaryList"), "NextToken" (rawinput1997665 "NextToken")}] (clojure.core/cond-> {:algorithm-summary-list (deser-algorithm-summary-list (clojure.core/get-in letvar1997667 ["AlgorithmSummaryList"]))} (letvar1997667 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997667 ["NextToken"])))))))

(clojure.core/defn- response-list-endpoints-output ([input] (response-list-endpoints-output nil input)) ([resultWrapper1997669 input] (clojure.core/let [rawinput1997668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997670 {"Endpoints" (rawinput1997668 "Endpoints"), "NextToken" (rawinput1997668 "NextToken")}] (clojure.core/cond-> {:endpoints (deser-endpoint-summary-list (clojure.core/get-in letvar1997670 ["Endpoints"]))} (letvar1997670 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1997670 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribed-workteam-response ([input] (response-describe-subscribed-workteam-response nil input)) ([resultWrapper1997672 input] (clojure.core/let [rawinput1997671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997673 {"SubscribedWorkteam" (rawinput1997671 "SubscribedWorkteam")}] (clojure.core/cond-> {:subscribed-workteam (deser-subscribed-workteam (clojure.core/get-in letvar1997673 ["SubscribedWorkteam"]))}))))

(clojure.core/defn- response-create-notebook-instance-output ([input] (response-create-notebook-instance-output nil input)) ([resultWrapper1997675 input] (clojure.core/let [rawinput1997674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997676 {"NotebookInstanceArn" (rawinput1997674 "NotebookInstanceArn")}] (clojure.core/cond-> {} (letvar1997676 "NotebookInstanceArn") (clojure.core/assoc :notebook-instance-arn (deser-notebook-instance-arn (clojure.core/get-in letvar1997676 ["NotebookInstanceArn"])))))))

(clojure.core/defn- response-list-tags-output ([input] (response-list-tags-output nil input)) ([resultWrapper1997678 input] (clojure.core/let [rawinput1997677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997679 {"Tags" (rawinput1997677 "Tags"), "NextToken" (rawinput1997677 "NextToken")}] (clojure.core/cond-> {} (letvar1997679 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1997679 ["Tags"]))) (letvar1997679 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997679 ["NextToken"])))))))

(clojure.core/defn- response-render-ui-template-response ([input] (response-render-ui-template-response nil input)) ([resultWrapper1997681 input] (clojure.core/let [rawinput1997680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997682 {"RenderedContent" (rawinput1997680 "RenderedContent"), "Errors" (rawinput1997680 "Errors")}] (clojure.core/cond-> {:rendered-content (deser-string (clojure.core/get-in letvar1997682 ["RenderedContent"])), :errors (deser-rendering-error-list (clojure.core/get-in letvar1997682 ["Errors"]))}))))

(clojure.core/defn- response-describe-endpoint-output ([input] (response-describe-endpoint-output nil input)) ([resultWrapper1997684 input] (clojure.core/let [rawinput1997683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997685 {"EndpointName" (rawinput1997683 "EndpointName"), "EndpointArn" (rawinput1997683 "EndpointArn"), "EndpointConfigName" (rawinput1997683 "EndpointConfigName"), "ProductionVariants" (rawinput1997683 "ProductionVariants"), "EndpointStatus" (rawinput1997683 "EndpointStatus"), "FailureReason" (rawinput1997683 "FailureReason"), "CreationTime" (rawinput1997683 "CreationTime"), "LastModifiedTime" (rawinput1997683 "LastModifiedTime")}] (clojure.core/cond-> {:endpoint-name (deser-endpoint-name (clojure.core/get-in letvar1997685 ["EndpointName"])), :endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1997685 ["EndpointArn"])), :endpoint-config-name (deser-endpoint-config-name (clojure.core/get-in letvar1997685 ["EndpointConfigName"])), :endpoint-status (deser-endpoint-status (clojure.core/get-in letvar1997685 ["EndpointStatus"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1997685 ["CreationTime"])), :last-modified-time (deser-timestamp (clojure.core/get-in letvar1997685 ["LastModifiedTime"]))} (letvar1997685 "ProductionVariants") (clojure.core/assoc :production-variants (deser-production-variant-summary-list (clojure.core/get-in letvar1997685 ["ProductionVariants"]))) (letvar1997685 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1997685 ["FailureReason"])))))))

(clojure.core/defn- response-resource-in-use ([input] (response-resource-in-use nil input)) ([resultWrapper1997687 input] (clojure.core/let [rawinput1997686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997688 {"Message" (rawinput1997686 "Message")}] (clojure.core/cond-> {} (letvar1997688 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1997688 ["Message"])))))))

(clojure.core/defn- response-describe-notebook-instance-lifecycle-config-output ([input] (response-describe-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1997690 input] (clojure.core/let [rawinput1997689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997691 {"NotebookInstanceLifecycleConfigArn" (rawinput1997689 "NotebookInstanceLifecycleConfigArn"), "NotebookInstanceLifecycleConfigName" (rawinput1997689 "NotebookInstanceLifecycleConfigName"), "OnCreate" (rawinput1997689 "OnCreate"), "OnStart" (rawinput1997689 "OnStart"), "LastModifiedTime" (rawinput1997689 "LastModifiedTime"), "CreationTime" (rawinput1997689 "CreationTime")}] (clojure.core/cond-> {} (letvar1997691 "NotebookInstanceLifecycleConfigArn") (clojure.core/assoc :notebook-instance-lifecycle-config-arn (deser-notebook-instance-lifecycle-config-arn (clojure.core/get-in letvar1997691 ["NotebookInstanceLifecycleConfigArn"]))) (letvar1997691 "NotebookInstanceLifecycleConfigName") (clojure.core/assoc :notebook-instance-lifecycle-config-name (deser-notebook-instance-lifecycle-config-name (clojure.core/get-in letvar1997691 ["NotebookInstanceLifecycleConfigName"]))) (letvar1997691 "OnCreate") (clojure.core/assoc :on-create (deser-notebook-instance-lifecycle-config-list (clojure.core/get-in letvar1997691 ["OnCreate"]))) (letvar1997691 "OnStart") (clojure.core/assoc :on-start (deser-notebook-instance-lifecycle-config-list (clojure.core/get-in letvar1997691 ["OnStart"]))) (letvar1997691 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1997691 ["LastModifiedTime"]))) (letvar1997691 "CreationTime") (clojure.core/assoc :creation-time (deser-creation-time (clojure.core/get-in letvar1997691 ["CreationTime"])))))))

(clojure.core/defn- response-list-compilation-jobs-response ([input] (response-list-compilation-jobs-response nil input)) ([resultWrapper1997693 input] (clojure.core/let [rawinput1997692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997694 {"CompilationJobSummaries" (rawinput1997692 "CompilationJobSummaries"), "NextToken" (rawinput1997692 "NextToken")}] (clojure.core/cond-> {:compilation-job-summaries (deser-compilation-job-summaries (clojure.core/get-in letvar1997694 ["CompilationJobSummaries"]))} (letvar1997694 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997694 ["NextToken"])))))))

(clojure.core/defn- response-search-response ([input] (response-search-response nil input)) ([resultWrapper1997696 input] (clojure.core/let [rawinput1997695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997697 {"Results" (rawinput1997695 "Results"), "NextToken" (rawinput1997695 "NextToken")}] (clojure.core/cond-> {} (letvar1997697 "Results") (clojure.core/assoc :results (deser-search-results-list (clojure.core/get-in letvar1997697 ["Results"]))) (letvar1997697 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997697 ["NextToken"])))))))

(clojure.core/defn- response-create-endpoint-config-output ([input] (response-create-endpoint-config-output nil input)) ([resultWrapper1997699 input] (clojure.core/let [rawinput1997698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997700 {"EndpointConfigArn" (rawinput1997698 "EndpointConfigArn")}] (clojure.core/cond-> {:endpoint-config-arn (deser-endpoint-config-arn (clojure.core/get-in letvar1997700 ["EndpointConfigArn"]))}))))

(clojure.core/defn- response-list-notebook-instance-lifecycle-configs-output ([input] (response-list-notebook-instance-lifecycle-configs-output nil input)) ([resultWrapper1997702 input] (clojure.core/let [rawinput1997701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1997703 {"NextToken" (rawinput1997701 "NextToken"), "NotebookInstanceLifecycleConfigs" (rawinput1997701 "NotebookInstanceLifecycleConfigs")}] (clojure.core/cond-> {} (letvar1997703 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1997703 ["NextToken"]))) (letvar1997703 "NotebookInstanceLifecycleConfigs") (clojure.core/assoc :notebook-instance-lifecycle-configs (deser-notebook-instance-lifecycle-config-summary-list (clojure.core/get-in letvar1997703 ["NotebookInstanceLifecycleConfigs"])))))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/labeling-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:labeling-job/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/arn-or-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 170)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:[a-z\-]*\/)?([a-zA-Z0-9]([a-zA-Z0-9-]){0,62})(?<!-)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/metric-regex (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/model-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/parameter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/variant-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/cognito-user-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/template-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128000))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/image-digest (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 72)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[Ss][Hh][Aa]256:[0-9a-fA-F]{64}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/branch (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/notebook-instance-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/property-name-hint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/workteam-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/response-mime-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/status-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/model-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/entity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/container-hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/data-input-config (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/s-3-uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(https|s3)://([^/]+)/?(.*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/task-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/secret-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:secretsmanager:[a-z0-9\-]*:[0-9]{12}:secret:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/notebook-instance-lifecycle-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/workteam-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:workteam/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/task-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128000))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/training-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:training-job/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/endpoint-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/code-repository-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:code-repository/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/labeling-job-algorithm-specification-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/endpoint-config-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/transform-environment-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/entity-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{Z}\p{S}\p{N}\p{P}]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/notebook-instance-lifecycle-config-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/code-repository-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/environment-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/git-config-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^https://([^/]+)/?(.*)$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/cognito-user-pool (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 55)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/compilation-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:compilation-job/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/transform-environment-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/label-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/string-200 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z0-9\.\-_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/hyper-parameter-tuning-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:hyper-parameter-tuning-job/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(https|s3)://([^/]+)/?(.*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/notebook-instance-lifecycle-config-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 16384))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/resource-property-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/lambda-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/failure-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/cognito-client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/transform-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/transform-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:transform-job/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/task-keyword (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[A-Za-z0-9]+( [A-Za-z0-9]+)*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\d+$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/dollars (clojure.spec.alpha/int-in 0 1))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/environment-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/hyper-parameter-tuning-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/training-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/endpoint-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/labeling-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/job-reference-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/model-package-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:model-package/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/algorithm-image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/task-time-limit-in-seconds (clojure.spec.alpha/int-in 1 3600))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/task-title (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\t\n\r -\uD7FF\uE000-\uFFFD]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\S]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/accept (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/endpoint-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/notebook-instance-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/code-repository-name-or-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^https://([^/]+)/?(.*)$|^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/algorithm-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:algorithm/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/endpoint-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker.-2017-07-24/model-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
