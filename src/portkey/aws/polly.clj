...
(clojure.core/defn delete-lexicon "<p>Deletes the specified pronunciation lexicon stored in an AWS Region. A lexicon which has been deleted is not available for speech synthesis, nor is it possible to retrieve it using either the <code>GetLexicon</code> or <code>ListLexicon</code> APIs.</p> <p>For more information, see <a href=\"http://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html\">Managing Lexicons</a>.</p>" ([delete-lexicon-input] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "DELETE" "/v1/lexicons/{LexiconName}" delete-lexicon-input :portkey.aws.polly/delete-lexicon-input {:payload nil, :move {}, :headers {}, :uri {"LexiconName" "Name"}, :querystring {}} 200 :portkey.aws.polly/delete-lexicon-output {"LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception})))
...
(clojure.core/defn describe-voices "<p>Returns the list of voices that are available for use when requesting speech synthesis. Each voice speaks a specified language, is either male or female, and is identified by an ID, which is the ASCII version of the voice name. </p> <p>When synthesizing speech ( <code>SynthesizeSpeech</code> ), you provide the voice ID for the voice you want from the list of voices returned by <code>DescribeVoices</code>.</p> <p>For example, you want your news reader application to read news in a specific language, but giving a user the option to choose the voice. Using the <code>DescribeVoices</code> operation you can provide the user with a list of available voices to select from.</p> <p> You can optionally specify a language code to filter the available voices. For example, if you specify <code>en-US</code>, the operation returns a list of all available US English voices. </p> <p>This operation requires permissions to perform the <code>polly:DescribeVoices</code> action.</p>" ([] (describe-voices {})) ([describe-voices-input] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "GET" "/v1/voices" describe-voices-input :portkey.aws.polly/describe-voices-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"LanguageCode" "LanguageCode", "NextToken" "NextToken"}} 200 :portkey.aws.polly/describe-voices-output {"InvalidNextTokenException" :portkey.aws.polly/invalid-next-token-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception})))
...
(clojure.core/defn get-lexicon "<p>Returns the content of the specified pronunciation lexicon stored in an AWS Region. For more information, see <a href=\"http://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html\">Managing Lexicons</a>.</p>" ([get-lexicon-input] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "GET" "/v1/lexicons/{LexiconName}" get-lexicon-input :portkey.aws.polly/get-lexicon-input {:payload nil, :move {}, :headers {}, :uri {"LexiconName" "Name"}, :querystring {}} 200 :portkey.aws.polly/get-lexicon-output {"LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception})))
...
(clojure.core/defn list-lexicons "<p>Returns a list of pronunciation lexicons stored in an AWS Region. For more information, see <a href=\"http://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html\">Managing Lexicons</a>.</p>" ([] (list-lexicons {})) ([list-lexicons-input] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "GET" "/v1/lexicons" list-lexicons-input :portkey.aws.polly/list-lexicons-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"NextToken" "NextToken"}} 200 :portkey.aws.polly/list-lexicons-output {"InvalidNextTokenException" :portkey.aws.polly/invalid-next-token-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception})))
...
(clojure.core/defn synthesize-speech "<p>Synthesizes UTF-8 input, plain text or SSML, to a stream of bytes. SSML input must be valid, well-formed SSML. Some alphabets might not be available with all the voices (for example, Cyrillic might not be read at all by English voices) unless phoneme mapping is used. For more information, see <a href=\"http://docs.aws.amazon.com/polly/latest/dg/how-text-to-speech-works.html\">How it Works</a>.</p>" ([synthesize-speech-input] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "POST" "/v1/speech" synthesize-speech-input :portkey.aws.polly/synthesize-speech-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.polly/synthesize-speech-output {"TextLengthExceededException" :portkey.aws.polly/text-length-exceeded-exception, "InvalidSampleRateException" :portkey.aws.polly/invalid-sample-rate-exception, "InvalidSsmlException" :portkey.aws.polly/invalid-ssml-exception, "LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception, "MarksNotSupportedForFormatException" :portkey.aws.polly/marks-not-supported-for-format-exception, "SsmlMarksNotSupportedForTextTypeException" :portkey.aws.polly/ssml-marks-not-supported-for-text-type-exception})))
