...
(clojure.core/defn- response-list-lexicons-output ([input] (response-list-lexicons-output nil input)) ([resultWrapper430232 input] (clojure.core/let [rawinput430231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430233 {"Lexicons" (rawinput430231 "Lexicons"), "NextToken" (rawinput430231 "NextToken")}] (clojure.core/cond-> {} (letvar430233 "Lexicons") (clojure.core/assoc :lexicons (deser-lexicon-description-list (clojure.core/get-in letvar430233 ["Lexicons"]))) (letvar430233 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar430233 ["NextToken"])))))))

(clojure.core/defn- response-max-lexeme-length-exceeded-exception ([input] (response-max-lexeme-length-exceeded-exception nil input)) ([resultWrapper430235 input] (clojure.core/let [rawinput430234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430236 {"message" (rawinput430234 "message")}] (clojure.core/cond-> {} (letvar430236 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430236 ["message"])))))))

(clojure.core/defn- response-invalid-ssml-exception ([input] (response-invalid-ssml-exception nil input)) ([resultWrapper430238 input] (clojure.core/let [rawinput430237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430239 {"message" (rawinput430237 "message")}] (clojure.core/cond-> {} (letvar430239 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430239 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-alphabet-exception ([input] (response-unsupported-pls-alphabet-exception nil input)) ([resultWrapper430241 input] (clojure.core/let [rawinput430240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430242 {"message" (rawinput430240 "message")}] (clojure.core/cond-> {} (letvar430242 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430242 ["message"])))))))

(clojure.core/defn- response-invalid-sns-topic-arn-exception ([input] (response-invalid-sns-topic-arn-exception nil input)) ([resultWrapper430244 input] (clojure.core/let [rawinput430243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430245 {"message" (rawinput430243 "message")}] (clojure.core/cond-> {} (letvar430245 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430245 ["message"])))))))

(clojure.core/defn- response-list-speech-synthesis-tasks-output ([input] (response-list-speech-synthesis-tasks-output nil input)) ([resultWrapper430247 input] (clojure.core/let [rawinput430246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430248 {"NextToken" (rawinput430246 "NextToken"), "SynthesisTasks" (rawinput430246 "SynthesisTasks")}] (clojure.core/cond-> {} (letvar430248 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar430248 ["NextToken"]))) (letvar430248 "SynthesisTasks") (clojure.core/assoc :synthesis-tasks (deser-synthesis-tasks (clojure.core/get-in letvar430248 ["SynthesisTasks"])))))))

(clojure.core/defn- response-get-lexicon-output ([input] (response-get-lexicon-output nil input)) ([resultWrapper430250 input] (clojure.core/let [rawinput430249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430251 {"Lexicon" (rawinput430249 "Lexicon"), "LexiconAttributes" (rawinput430249 "LexiconAttributes")}] (clojure.core/cond-> {} (letvar430251 "Lexicon") (clojure.core/assoc :lexicon (deser-lexicon (clojure.core/get-in letvar430251 ["Lexicon"]))) (letvar430251 "LexiconAttributes") (clojure.core/assoc :lexicon-attributes (deser-lexicon-attributes (clojure.core/get-in letvar430251 ["LexiconAttributes"])))))))

(clojure.core/defn- response-describe-voices-output ([input] (response-describe-voices-output nil input)) ([resultWrapper430253 input] (clojure.core/let [rawinput430252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430254 {"Voices" (rawinput430252 "Voices"), "NextToken" (rawinput430252 "NextToken")}] (clojure.core/cond-> {} (letvar430254 "Voices") (clojure.core/assoc :voices (deser-voice-list (clojure.core/get-in letvar430254 ["Voices"]))) (letvar430254 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar430254 ["NextToken"])))))))

(clojure.core/defn- response-ssml-marks-not-supported-for-text-type-exception ([input] (response-ssml-marks-not-supported-for-text-type-exception nil input)) ([resultWrapper430256 input] (clojure.core/let [rawinput430255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430257 {"message" (rawinput430255 "message")}] (clojure.core/cond-> {} (letvar430257 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430257 ["message"])))))))

(clojure.core/defn- response-max-lexicons-number-exceeded-exception ([input] (response-max-lexicons-number-exceeded-exception nil input)) ([resultWrapper430259 input] (clojure.core/let [rawinput430258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430260 {"message" (rawinput430258 "message")}] (clojure.core/cond-> {} (letvar430260 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430260 ["message"])))))))

(clojure.core/defn- response-synthesize-speech-output ([input] (response-synthesize-speech-output nil input)) ([resultWrapper430262 input] (clojure.core/let [rawinput430261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430263 {"AudioStream" (rawinput430261 "AudioStream"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amzn-RequestCharacters" (clojure.core/get-in input [:headers "x-amzn-RequestCharacters"])}] (clojure.core/cond-> {} (letvar430263 "AudioStream") (clojure.core/assoc :audio-stream (deser-audio-stream (clojure.core/get-in letvar430263 ["AudioStream"]))) (letvar430263 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar430263 ["Content-Type"]))) (letvar430263 "x-amzn-RequestCharacters") (clojure.core/assoc :request-characters (deser-request-characters (clojure.core/get-in letvar430263 ["x-amzn-RequestCharacters"])))))))

(clojure.core/defn- response-invalid-s-3-bucket-exception ([input] (response-invalid-s-3-bucket-exception nil input)) ([resultWrapper430265 input] (clojure.core/let [rawinput430264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430266 {"message" (rawinput430264 "message")}] (clojure.core/cond-> {} (letvar430266 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430266 ["message"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper430268 input] (clojure.core/let [rawinput430267 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430269 {"message" (rawinput430267 "message")}] (clojure.core/cond-> {} (letvar430269 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430269 ["message"])))))))

(clojure.core/defn- response-text-length-exceeded-exception ([input] (response-text-length-exceeded-exception nil input)) ([resultWrapper430271 input] (clojure.core/let [rawinput430270 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430272 {"message" (rawinput430270 "message")}] (clojure.core/cond-> {} (letvar430272 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430272 ["message"])))))))

(clojure.core/defn- response-invalid-sample-rate-exception ([input] (response-invalid-sample-rate-exception nil input)) ([resultWrapper430274 input] (clojure.core/let [rawinput430273 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430275 {"message" (rawinput430273 "message")}] (clojure.core/cond-> {} (letvar430275 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430275 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper430277 input] (clojure.core/let [rawinput430276 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430278 {"message" (rawinput430276 "message")}] (clojure.core/cond-> {} (letvar430278 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430278 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-language-exception ([input] (response-unsupported-pls-language-exception nil input)) ([resultWrapper430280 input] (clojure.core/let [rawinput430279 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430281 {"message" (rawinput430279 "message")}] (clojure.core/cond-> {} (letvar430281 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430281 ["message"])))))))

(clojure.core/defn- response-synthesis-task-not-found-exception ([input] (response-synthesis-task-not-found-exception nil input)) ([resultWrapper430283 input] (clojure.core/let [rawinput430282 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430284 {"message" (rawinput430282 "message")}] (clojure.core/cond-> {} (letvar430284 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430284 ["message"])))))))

(clojure.core/defn- response-language-not-supported-exception ([input] (response-language-not-supported-exception nil input)) ([resultWrapper430286 input] (clojure.core/let [rawinput430285 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430287 {"message" (rawinput430285 "message")}] (clojure.core/cond-> {} (letvar430287 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430287 ["message"])))))))

(clojure.core/defn- response-put-lexicon-output ([input] (response-put-lexicon-output nil input)) ([resultWrapper430289 input] (clojure.core/let [rawinput430288 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430290 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lexicon-output ([input] (response-delete-lexicon-output nil input)) ([resultWrapper430292 input] (clojure.core/let [rawinput430291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430293 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-s-3-key-exception ([input] (response-invalid-s-3-key-exception nil input)) ([resultWrapper430295 input] (clojure.core/let [rawinput430294 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430296 {"message" (rawinput430294 "message")}] (clojure.core/cond-> {} (letvar430296 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430296 ["message"])))))))

(clojure.core/defn- response-invalid-task-id-exception ([input] (response-invalid-task-id-exception nil input)) ([resultWrapper430298 input] (clojure.core/let [rawinput430297 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430299 {"message" (rawinput430297 "message")}] (clojure.core/cond-> {} (letvar430299 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430299 ["message"])))))))

(clojure.core/defn- response-lexicon-not-found-exception ([input] (response-lexicon-not-found-exception nil input)) ([resultWrapper430301 input] (clojure.core/let [rawinput430300 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430302 {"message" (rawinput430300 "message")}] (clojure.core/cond-> {} (letvar430302 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430302 ["message"])))))))

(clojure.core/defn- response-invalid-lexicon-exception ([input] (response-invalid-lexicon-exception nil input)) ([resultWrapper430304 input] (clojure.core/let [rawinput430303 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430305 {"message" (rawinput430303 "message")}] (clojure.core/cond-> {} (letvar430305 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430305 ["message"])))))))

(clojure.core/defn- response-lexicon-size-exceeded-exception ([input] (response-lexicon-size-exceeded-exception nil input)) ([resultWrapper430307 input] (clojure.core/let [rawinput430306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430308 {"message" (rawinput430306 "message")}] (clojure.core/cond-> {} (letvar430308 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430308 ["message"])))))))

(clojure.core/defn- response-marks-not-supported-for-format-exception ([input] (response-marks-not-supported-for-format-exception nil input)) ([resultWrapper430310 input] (clojure.core/let [rawinput430309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430311 {"message" (rawinput430309 "message")}] (clojure.core/cond-> {} (letvar430311 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar430311 ["message"])))))))

(clojure.core/defn- response-start-speech-synthesis-task-output ([input] (response-start-speech-synthesis-task-output nil input)) ([resultWrapper430313 input] (clojure.core/let [rawinput430312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430314 {"SynthesisTask" (rawinput430312 "SynthesisTask")}] (clojure.core/cond-> {} (letvar430314 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar430314 ["SynthesisTask"])))))))

(clojure.core/defn- response-get-speech-synthesis-task-output ([input] (response-get-speech-synthesis-task-output nil input)) ([resultWrapper430316 input] (clojure.core/let [rawinput430315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar430317 {"SynthesisTask" (rawinput430315 "SynthesisTask")}] (clojure.core/cond-> {} (letvar430317 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar430317 ["SynthesisTask"])))))))
...
(clojure.spec.alpha/def :portkey.aws.polly/output-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.polly/lexicon-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[0-9A-Za-z]{1,20}" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^arn:aws(-(cn|iso(-b)?|us-gov))?:sns:.*:\w{12}:.+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/output-s-3-key-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z\/\!\-_\.\*\'\(\)]{0,800}$" s__21112__auto__))))
