...
(clojure.core/defn delete-lexicon [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "DELETE" "/v1/lexicons/{LexiconName}" input__8278__auto__ :portkey.aws.polly/delete-lexicon-input {:payload nil, :headers {}, :uri {"LexiconName" "Name"}, :querystring {}} 200 :portkey.aws.polly/delete-lexicon-output {"LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception}))
...
(clojure.core/defn describe-voices [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "GET" "/v1/voices" input__8278__auto__ :portkey.aws.polly/describe-voices-input {:payload nil, :headers {}, :uri {}, :querystring {"LanguageCode" "LanguageCode", "NextToken" "NextToken"}} 200 :portkey.aws.polly/describe-voices-output {"InvalidNextTokenException" :portkey.aws.polly/invalid-next-token-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception}))
(clojure.spec.alpha/fdef describe-voices :args (clojure.spec.alpha/tuple :portkey.aws.polly/describe-voices-input) :ret (clojure.spec.alpha/and :portkey.aws.polly/describe-voices-output))

(clojure.core/defn get-lexicon [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "GET" "/v1/lexicons/{LexiconName}" input__8278__auto__ :portkey.aws.polly/get-lexicon-input {:payload nil, :headers {}, :uri {"LexiconName" "Name"}, :querystring {}} 200 :portkey.aws.polly/get-lexicon-output {"LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception}))
...
(clojure.core/defn synthesize-speech [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.polly/endpoints "POST" "/v1/speech" input__8278__auto__ :portkey.aws.polly/synthesize-speech-input {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.polly/synthesize-speech-output {"TextLengthExceededException" :portkey.aws.polly/text-length-exceeded-exception, "InvalidSampleRateException" :portkey.aws.polly/invalid-sample-rate-exception, "InvalidSsmlException" :portkey.aws.polly/invalid-ssml-exception, "LexiconNotFoundException" :portkey.aws.polly/lexicon-not-found-exception, "ServiceFailureException" :portkey.aws.polly/service-failure-exception, "MarksNotSupportedForFormatException" :portkey.aws.polly/marks-not-supported-for-format-exception, "SsmlMarksNotSupportedForTextTypeException" :portkey.aws.polly/ssml-marks-not-supported-for-text-type-exception}))
