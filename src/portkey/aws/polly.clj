...
(clojure.core/defn- response-list-lexicons-output ([input] (response-list-lexicons-output nil input)) ([resultWrapper1423229 input] (clojure.core/let [rawinput1423228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423230 {"Lexicons" (rawinput1423228 "Lexicons"), "NextToken" (rawinput1423228 "NextToken")}] (clojure.core/cond-> {} (letvar1423230 "Lexicons") (clojure.core/assoc :lexicons (deser-lexicon-description-list (clojure.core/get-in letvar1423230 ["Lexicons"]))) (letvar1423230 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1423230 ["NextToken"])))))))

(clojure.core/defn- response-max-lexeme-length-exceeded-exception ([input] (response-max-lexeme-length-exceeded-exception nil input)) ([resultWrapper1423232 input] (clojure.core/let [rawinput1423231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423233 {"message" (rawinput1423231 "message")}] (clojure.core/cond-> {} (letvar1423233 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423233 ["message"])))))))

(clojure.core/defn- response-invalid-ssml-exception ([input] (response-invalid-ssml-exception nil input)) ([resultWrapper1423235 input] (clojure.core/let [rawinput1423234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423236 {"message" (rawinput1423234 "message")}] (clojure.core/cond-> {} (letvar1423236 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423236 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-alphabet-exception ([input] (response-unsupported-pls-alphabet-exception nil input)) ([resultWrapper1423238 input] (clojure.core/let [rawinput1423237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423239 {"message" (rawinput1423237 "message")}] (clojure.core/cond-> {} (letvar1423239 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423239 ["message"])))))))

(clojure.core/defn- response-invalid-sns-topic-arn-exception ([input] (response-invalid-sns-topic-arn-exception nil input)) ([resultWrapper1423241 input] (clojure.core/let [rawinput1423240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423242 {"message" (rawinput1423240 "message")}] (clojure.core/cond-> {} (letvar1423242 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423242 ["message"])))))))

(clojure.core/defn- response-list-speech-synthesis-tasks-output ([input] (response-list-speech-synthesis-tasks-output nil input)) ([resultWrapper1423244 input] (clojure.core/let [rawinput1423243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423245 {"NextToken" (rawinput1423243 "NextToken"), "SynthesisTasks" (rawinput1423243 "SynthesisTasks")}] (clojure.core/cond-> {} (letvar1423245 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1423245 ["NextToken"]))) (letvar1423245 "SynthesisTasks") (clojure.core/assoc :synthesis-tasks (deser-synthesis-tasks (clojure.core/get-in letvar1423245 ["SynthesisTasks"])))))))

(clojure.core/defn- response-get-lexicon-output ([input] (response-get-lexicon-output nil input)) ([resultWrapper1423247 input] (clojure.core/let [rawinput1423246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423248 {"Lexicon" (rawinput1423246 "Lexicon"), "LexiconAttributes" (rawinput1423246 "LexiconAttributes")}] (clojure.core/cond-> {} (letvar1423248 "Lexicon") (clojure.core/assoc :lexicon (deser-lexicon (clojure.core/get-in letvar1423248 ["Lexicon"]))) (letvar1423248 "LexiconAttributes") (clojure.core/assoc :lexicon-attributes (deser-lexicon-attributes (clojure.core/get-in letvar1423248 ["LexiconAttributes"])))))))

(clojure.core/defn- response-describe-voices-output ([input] (response-describe-voices-output nil input)) ([resultWrapper1423250 input] (clojure.core/let [rawinput1423249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423251 {"Voices" (rawinput1423249 "Voices"), "NextToken" (rawinput1423249 "NextToken")}] (clojure.core/cond-> {} (letvar1423251 "Voices") (clojure.core/assoc :voices (deser-voice-list (clojure.core/get-in letvar1423251 ["Voices"]))) (letvar1423251 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1423251 ["NextToken"])))))))

(clojure.core/defn- response-ssml-marks-not-supported-for-text-type-exception ([input] (response-ssml-marks-not-supported-for-text-type-exception nil input)) ([resultWrapper1423253 input] (clojure.core/let [rawinput1423252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423254 {"message" (rawinput1423252 "message")}] (clojure.core/cond-> {} (letvar1423254 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423254 ["message"])))))))

(clojure.core/defn- response-max-lexicons-number-exceeded-exception ([input] (response-max-lexicons-number-exceeded-exception nil input)) ([resultWrapper1423256 input] (clojure.core/let [rawinput1423255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423257 {"message" (rawinput1423255 "message")}] (clojure.core/cond-> {} (letvar1423257 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423257 ["message"])))))))

(clojure.core/defn- response-synthesize-speech-output ([input] (response-synthesize-speech-output nil input)) ([resultWrapper1423259 input] (clojure.core/let [rawinput1423258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423260 {"AudioStream" (rawinput1423258 "AudioStream"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amzn-RequestCharacters" (clojure.core/get-in input [:headers "x-amzn-RequestCharacters"])}] (clojure.core/cond-> {} (letvar1423260 "AudioStream") (clojure.core/assoc :audio-stream (deser-audio-stream (clojure.core/get-in letvar1423260 ["AudioStream"]))) (letvar1423260 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1423260 ["Content-Type"]))) (letvar1423260 "x-amzn-RequestCharacters") (clojure.core/assoc :request-characters (deser-request-characters (clojure.core/get-in letvar1423260 ["x-amzn-RequestCharacters"])))))))

(clojure.core/defn- response-invalid-s-3-bucket-exception ([input] (response-invalid-s-3-bucket-exception nil input)) ([resultWrapper1423262 input] (clojure.core/let [rawinput1423261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423263 {"message" (rawinput1423261 "message")}] (clojure.core/cond-> {} (letvar1423263 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423263 ["message"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper1423265 input] (clojure.core/let [rawinput1423264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423266 {"message" (rawinput1423264 "message")}] (clojure.core/cond-> {} (letvar1423266 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423266 ["message"])))))))

(clojure.core/defn- response-text-length-exceeded-exception ([input] (response-text-length-exceeded-exception nil input)) ([resultWrapper1423268 input] (clojure.core/let [rawinput1423267 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423269 {"message" (rawinput1423267 "message")}] (clojure.core/cond-> {} (letvar1423269 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423269 ["message"])))))))

(clojure.core/defn- response-invalid-sample-rate-exception ([input] (response-invalid-sample-rate-exception nil input)) ([resultWrapper1423271 input] (clojure.core/let [rawinput1423270 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423272 {"message" (rawinput1423270 "message")}] (clojure.core/cond-> {} (letvar1423272 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423272 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1423274 input] (clojure.core/let [rawinput1423273 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423275 {"message" (rawinput1423273 "message")}] (clojure.core/cond-> {} (letvar1423275 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423275 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-language-exception ([input] (response-unsupported-pls-language-exception nil input)) ([resultWrapper1423277 input] (clojure.core/let [rawinput1423276 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423278 {"message" (rawinput1423276 "message")}] (clojure.core/cond-> {} (letvar1423278 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423278 ["message"])))))))

(clojure.core/defn- response-synthesis-task-not-found-exception ([input] (response-synthesis-task-not-found-exception nil input)) ([resultWrapper1423280 input] (clojure.core/let [rawinput1423279 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423281 {"message" (rawinput1423279 "message")}] (clojure.core/cond-> {} (letvar1423281 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423281 ["message"])))))))

(clojure.core/defn- response-language-not-supported-exception ([input] (response-language-not-supported-exception nil input)) ([resultWrapper1423283 input] (clojure.core/let [rawinput1423282 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423284 {"message" (rawinput1423282 "message")}] (clojure.core/cond-> {} (letvar1423284 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423284 ["message"])))))))

(clojure.core/defn- response-put-lexicon-output ([input] (response-put-lexicon-output nil input)) ([resultWrapper1423286 input] (clojure.core/let [rawinput1423285 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423287 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lexicon-output ([input] (response-delete-lexicon-output nil input)) ([resultWrapper1423289 input] (clojure.core/let [rawinput1423288 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423290 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-s-3-key-exception ([input] (response-invalid-s-3-key-exception nil input)) ([resultWrapper1423292 input] (clojure.core/let [rawinput1423291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423293 {"message" (rawinput1423291 "message")}] (clojure.core/cond-> {} (letvar1423293 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423293 ["message"])))))))

(clojure.core/defn- response-invalid-task-id-exception ([input] (response-invalid-task-id-exception nil input)) ([resultWrapper1423295 input] (clojure.core/let [rawinput1423294 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423296 {"message" (rawinput1423294 "message")}] (clojure.core/cond-> {} (letvar1423296 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423296 ["message"])))))))

(clojure.core/defn- response-lexicon-not-found-exception ([input] (response-lexicon-not-found-exception nil input)) ([resultWrapper1423298 input] (clojure.core/let [rawinput1423297 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423299 {"message" (rawinput1423297 "message")}] (clojure.core/cond-> {} (letvar1423299 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423299 ["message"])))))))

(clojure.core/defn- response-invalid-lexicon-exception ([input] (response-invalid-lexicon-exception nil input)) ([resultWrapper1423301 input] (clojure.core/let [rawinput1423300 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423302 {"message" (rawinput1423300 "message")}] (clojure.core/cond-> {} (letvar1423302 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423302 ["message"])))))))

(clojure.core/defn- response-lexicon-size-exceeded-exception ([input] (response-lexicon-size-exceeded-exception nil input)) ([resultWrapper1423304 input] (clojure.core/let [rawinput1423303 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423305 {"message" (rawinput1423303 "message")}] (clojure.core/cond-> {} (letvar1423305 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423305 ["message"])))))))

(clojure.core/defn- response-marks-not-supported-for-format-exception ([input] (response-marks-not-supported-for-format-exception nil input)) ([resultWrapper1423307 input] (clojure.core/let [rawinput1423306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423308 {"message" (rawinput1423306 "message")}] (clojure.core/cond-> {} (letvar1423308 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1423308 ["message"])))))))

(clojure.core/defn- response-start-speech-synthesis-task-output ([input] (response-start-speech-synthesis-task-output nil input)) ([resultWrapper1423310 input] (clojure.core/let [rawinput1423309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423311 {"SynthesisTask" (rawinput1423309 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1423311 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1423311 ["SynthesisTask"])))))))

(clojure.core/defn- response-get-speech-synthesis-task-output ([input] (response-get-speech-synthesis-task-output nil input)) ([resultWrapper1423313 input] (clojure.core/let [rawinput1423312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1423314 {"SynthesisTask" (rawinput1423312 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1423314 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1423314 ["SynthesisTask"])))))))
...
(clojure.spec.alpha/def :portkey.aws.polly/output-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.polly/lexicon-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[0-9A-Za-z]{1,20}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^arn:aws(-(cn|iso(-b)?|us-gov))?:sns:.*:\w{12}:.+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly/output-s-3-key-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z\/\!\-_\.\*\'\(\)]{0,800}$" s__1012854__auto__))))
