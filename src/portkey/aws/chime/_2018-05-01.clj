...
(clojure.core/defn- response-logout-user-response ([input] (response-logout-user-response nil input)) ([resultWrapper81454 input] (clojure.core/let [rawinput81453 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81455 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper81457 input] (clojure.core/let [rawinput81456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81458 {"Code" (rawinput81456 "Code"), "Message" (rawinput81456 "Message")}] (clojure.core/cond-> {} (letvar81458 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81458 ["Code"]))) (letvar81458 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81458 ["Message"])))))))

(clojure.core/defn- response-delete-account-response ([input] (response-delete-account-response nil input)) ([resultWrapper81460 input] (clojure.core/let [rawinput81459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81461 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-account-settings-response ([input] (response-update-account-settings-response nil input)) ([resultWrapper81463 input] (clojure.core/let [rawinput81462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81464 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper81466 input] (clojure.core/let [rawinput81465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81467 {"Code" (rawinput81465 "Code"), "Message" (rawinput81465 "Message")}] (clojure.core/cond-> {} (letvar81467 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81467 ["Code"]))) (letvar81467 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81467 ["Message"])))))))

(clojure.core/defn- response-update-account-response ([input] (response-update-account-response nil input)) ([resultWrapper81469 input] (clojure.core/let [rawinput81468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81470 {"Account" (rawinput81468 "Account")}] (clojure.core/cond-> {} (letvar81470 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar81470 ["Account"])))))))

(clojure.core/defn- response-unprocessable-entity-exception ([input] (response-unprocessable-entity-exception nil input)) ([resultWrapper81472 input] (clojure.core/let [rawinput81471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81473 {"Code" (rawinput81471 "Code"), "Message" (rawinput81471 "Message")}] (clojure.core/cond-> {} (letvar81473 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81473 ["Code"]))) (letvar81473 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81473 ["Message"])))))))

(clojure.core/defn- response-get-account-response ([input] (response-get-account-response nil input)) ([resultWrapper81475 input] (clojure.core/let [rawinput81474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81476 {"Account" (rawinput81474 "Account")}] (clojure.core/cond-> {} (letvar81476 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar81476 ["Account"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper81478 input] (clojure.core/let [rawinput81477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81479 {"Code" (rawinput81477 "Code"), "Message" (rawinput81477 "Message")}] (clojure.core/cond-> {} (letvar81479 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81479 ["Code"]))) (letvar81479 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81479 ["Message"])))))))

(clojure.core/defn- response-list-accounts-response ([input] (response-list-accounts-response nil input)) ([resultWrapper81481 input] (clojure.core/let [rawinput81480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81482 {"Accounts" (rawinput81480 "Accounts"), "NextToken" (rawinput81480 "NextToken")}] (clojure.core/cond-> {} (letvar81482 "Accounts") (clojure.core/assoc :accounts (deser-account-list (clojure.core/get-in letvar81482 ["Accounts"]))) (letvar81482 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar81482 ["NextToken"])))))))

(clojure.core/defn- response-batch-unsuspend-user-response ([input] (response-batch-unsuspend-user-response nil input)) ([resultWrapper81484 input] (clojure.core/let [rawinput81483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81485 {"UserErrors" (rawinput81483 "UserErrors")}] (clojure.core/cond-> {} (letvar81485 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar81485 ["UserErrors"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper81487 input] (clojure.core/let [rawinput81486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81488 {"Code" (rawinput81486 "Code"), "Message" (rawinput81486 "Message")}] (clojure.core/cond-> {} (letvar81488 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81488 ["Code"]))) (letvar81488 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81488 ["Message"])))))))

(clojure.core/defn- response-update-user-response ([input] (response-update-user-response nil input)) ([resultWrapper81490 input] (clojure.core/let [rawinput81489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81491 {"User" (rawinput81489 "User")}] (clojure.core/cond-> {} (letvar81491 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar81491 ["User"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper81493 input] (clojure.core/let [rawinput81492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81494 {"AccountSettings" (rawinput81492 "AccountSettings")}] (clojure.core/cond-> {} (letvar81494 "AccountSettings") (clojure.core/assoc :account-settings (deser-account-settings (clojure.core/get-in letvar81494 ["AccountSettings"])))))))

(clojure.core/defn- response-create-account-response ([input] (response-create-account-response nil input)) ([resultWrapper81496 input] (clojure.core/let [rawinput81495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81497 {"Account" (rawinput81495 "Account")}] (clojure.core/cond-> {} (letvar81497 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar81497 ["Account"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper81499 input] (clojure.core/let [rawinput81498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81500 {"Code" (rawinput81498 "Code"), "Message" (rawinput81498 "Message")}] (clojure.core/cond-> {} (letvar81500 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81500 ["Code"]))) (letvar81500 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81500 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper81502 input] (clojure.core/let [rawinput81501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81503 {"Code" (rawinput81501 "Code"), "Message" (rawinput81501 "Message")}] (clojure.core/cond-> {} (letvar81503 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81503 ["Code"]))) (letvar81503 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81503 ["Message"])))))))

(clojure.core/defn- response-unauthorized-client-exception ([input] (response-unauthorized-client-exception nil input)) ([resultWrapper81505 input] (clojure.core/let [rawinput81504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81506 {"Code" (rawinput81504 "Code"), "Message" (rawinput81504 "Message")}] (clojure.core/cond-> {} (letvar81506 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81506 ["Code"]))) (letvar81506 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81506 ["Message"])))))))

(clojure.core/defn- response-batch-suspend-user-response ([input] (response-batch-suspend-user-response nil input)) ([resultWrapper81508 input] (clojure.core/let [rawinput81507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81509 {"UserErrors" (rawinput81507 "UserErrors")}] (clojure.core/cond-> {} (letvar81509 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar81509 ["UserErrors"])))))))

(clojure.core/defn- response-invite-users-response ([input] (response-invite-users-response nil input)) ([resultWrapper81511 input] (clojure.core/let [rawinput81510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81512 {"Invites" (rawinput81510 "Invites")}] (clojure.core/cond-> {} (letvar81512 "Invites") (clojure.core/assoc :invites (deser-invite-list (clojure.core/get-in letvar81512 ["Invites"])))))))

(clojure.core/defn- response-reset-personal-pin-response ([input] (response-reset-personal-pin-response nil input)) ([resultWrapper81514 input] (clojure.core/let [rawinput81513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81515 {"User" (rawinput81513 "User")}] (clojure.core/cond-> {} (letvar81515 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar81515 ["User"])))))))

(clojure.core/defn- response-throttled-client-exception ([input] (response-throttled-client-exception nil input)) ([resultWrapper81517 input] (clojure.core/let [rawinput81516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81518 {"Code" (rawinput81516 "Code"), "Message" (rawinput81516 "Message")}] (clojure.core/cond-> {} (letvar81518 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar81518 ["Code"]))) (letvar81518 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar81518 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper81520 input] (clojure.core/let [rawinput81519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81521 {"Users" (rawinput81519 "Users"), "NextToken" (rawinput81519 "NextToken")}] (clojure.core/cond-> {} (letvar81521 "Users") (clojure.core/assoc :users (deser-user-list (clojure.core/get-in letvar81521 ["Users"]))) (letvar81521 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar81521 ["NextToken"])))))))

(clojure.core/defn- response-batch-update-user-response ([input] (response-batch-update-user-response nil input)) ([resultWrapper81523 input] (clojure.core/let [rawinput81522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81524 {"UserErrors" (rawinput81522 "UserErrors")}] (clojure.core/cond-> {} (letvar81524 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar81524 ["UserErrors"])))))))

(clojure.core/defn- response-get-user-response ([input] (response-get-user-response nil input)) ([resultWrapper81526 input] (clojure.core/let [rawinput81525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar81527 {"User" (rawinput81525 "User")}] (clojure.core/cond-> {} (letvar81527 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar81527 ["User"])))))))
...
(clojure.spec.alpha/def :portkey.aws.chime.-2018-05-01/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #".*\S.*" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.chime.-2018-05-01/email-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #".+@.+\..+" s__21112__auto__))))
