...
(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper1641368 input] (clojure.core/let [rawinput1641367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641369 {"tags" (rawinput1641367 "tags"), "nextToken" (rawinput1641367 "nextToken")}] (clojure.core/cond-> {} (letvar1641369 "tags") (clojure.core/assoc :tags (deser-configuration-tag-set (clojure.core/get-in letvar1641369 ["tags"]))) (letvar1641369 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641369 ["nextToken"])))))))

(clojure.core/defn- response-delete-tags-response ([input] (response-delete-tags-response nil input)) ([resultWrapper1641371 input] (clojure.core/let [rawinput1641370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641372 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-import-tasks-response ([input] (response-describe-import-tasks-response nil input)) ([resultWrapper1641374 input] (clojure.core/let [rawinput1641373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641375 {"nextToken" (rawinput1641373 "nextToken"), "tasks" (rawinput1641373 "tasks")}] (clojure.core/cond-> {} (letvar1641375 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641375 ["nextToken"]))) (letvar1641375 "tasks") (clojure.core/assoc :tasks (deser-import-task-list (clojure.core/get-in letvar1641375 ["tasks"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1641377 input] (clojure.core/let [rawinput1641376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641378 {"message" (rawinput1641376 "message")}] (clojure.core/cond-> {} (letvar1641378 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641378 ["message"])))))))

(clojure.core/defn- response-disassociate-configuration-items-from-application-response ([input] (response-disassociate-configuration-items-from-application-response nil input)) ([resultWrapper1641380 input] (clojure.core/let [rawinput1641379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641381 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-configurations-response ([input] (response-describe-configurations-response nil input)) ([resultWrapper1641383 input] (clojure.core/let [rawinput1641382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641384 {"configurations" (rawinput1641382 "configurations")}] (clojure.core/cond-> {} (letvar1641384 "configurations") (clojure.core/assoc :configurations (deser-describe-configurations-attributes (clojure.core/get-in letvar1641384 ["configurations"])))))))

(clojure.core/defn- response-list-configurations-response ([input] (response-list-configurations-response nil input)) ([resultWrapper1641386 input] (clojure.core/let [rawinput1641385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641387 {"configurations" (rawinput1641385 "configurations"), "nextToken" (rawinput1641385 "nextToken")}] (clojure.core/cond-> {} (letvar1641387 "configurations") (clojure.core/assoc :configurations (deser-configurations (clojure.core/get-in letvar1641387 ["configurations"]))) (letvar1641387 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641387 ["nextToken"])))))))

(clojure.core/defn- response-server-internal-error-exception ([input] (response-server-internal-error-exception nil input)) ([resultWrapper1641389 input] (clojure.core/let [rawinput1641388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641390 {"message" (rawinput1641388 "message")}] (clojure.core/cond-> {} (letvar1641390 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641390 ["message"])))))))

(clojure.core/defn- response-describe-agents-response ([input] (response-describe-agents-response nil input)) ([resultWrapper1641392 input] (clojure.core/let [rawinput1641391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641393 {"agentsInfo" (rawinput1641391 "agentsInfo"), "nextToken" (rawinput1641391 "nextToken")}] (clojure.core/cond-> {} (letvar1641393 "agentsInfo") (clojure.core/assoc :agents-info (deser-agents-info (clojure.core/get-in letvar1641393 ["agentsInfo"]))) (letvar1641393 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641393 ["nextToken"])))))))

(clojure.core/defn- response-associate-configuration-items-to-application-response ([input] (response-associate-configuration-items-to-application-response nil input)) ([resultWrapper1641395 input] (clojure.core/let [rawinput1641394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641396 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1641398 input] (clojure.core/let [rawinput1641397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641399 {"message" (rawinput1641397 "message")}] (clojure.core/cond-> {} (letvar1641399 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641399 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1641401 input] (clojure.core/let [rawinput1641400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641402 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-export-configurations-response ([input] (response-export-configurations-response nil input)) ([resultWrapper1641404 input] (clojure.core/let [rawinput1641403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641405 {"exportId" (rawinput1641403 "exportId")}] (clojure.core/cond-> {} (letvar1641405 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1641405 ["exportId"])))))))

(clojure.core/defn- response-describe-continuous-exports-response ([input] (response-describe-continuous-exports-response nil input)) ([resultWrapper1641407 input] (clojure.core/let [rawinput1641406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641408 {"descriptions" (rawinput1641406 "descriptions"), "nextToken" (rawinput1641406 "nextToken")}] (clojure.core/cond-> {} (letvar1641408 "descriptions") (clojure.core/assoc :descriptions (deser-continuous-export-descriptions (clojure.core/get-in letvar1641408 ["descriptions"]))) (letvar1641408 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641408 ["nextToken"])))))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1641410 input] (clojure.core/let [rawinput1641409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641411 {"exportsInfo" (rawinput1641409 "exportsInfo"), "nextToken" (rawinput1641409 "nextToken")}] (clojure.core/cond-> {} (letvar1641411 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1641411 ["exportsInfo"]))) (letvar1641411 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641411 ["nextToken"])))))))

(clojure.core/defn- response-get-discovery-summary-response ([input] (response-get-discovery-summary-response nil input)) ([resultWrapper1641413 input] (clojure.core/let [rawinput1641412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641414 {"servers" (rawinput1641412 "servers"), "applications" (rawinput1641412 "applications"), "serversMappedToApplications" (rawinput1641412 "serversMappedToApplications"), "serversMappedtoTags" (rawinput1641412 "serversMappedtoTags"), "agentSummary" (rawinput1641412 "agentSummary"), "connectorSummary" (rawinput1641412 "connectorSummary")}] (clojure.core/cond-> {} (letvar1641414 "servers") (clojure.core/assoc :servers (deser-long (clojure.core/get-in letvar1641414 ["servers"]))) (letvar1641414 "applications") (clojure.core/assoc :applications (deser-long (clojure.core/get-in letvar1641414 ["applications"]))) (letvar1641414 "serversMappedToApplications") (clojure.core/assoc :servers-mapped-to-applications (deser-long (clojure.core/get-in letvar1641414 ["serversMappedToApplications"]))) (letvar1641414 "serversMappedtoTags") (clojure.core/assoc :servers-mappedto-tags (deser-long (clojure.core/get-in letvar1641414 ["serversMappedtoTags"]))) (letvar1641414 "agentSummary") (clojure.core/assoc :agent-summary (deser-customer-agent-info (clojure.core/get-in letvar1641414 ["agentSummary"]))) (letvar1641414 "connectorSummary") (clojure.core/assoc :connector-summary (deser-customer-connector-info (clojure.core/get-in letvar1641414 ["connectorSummary"])))))))

(clojure.core/defn- response-list-server-neighbors-response ([input] (response-list-server-neighbors-response nil input)) ([resultWrapper1641416 input] (clojure.core/let [rawinput1641415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641417 {"neighbors" (rawinput1641415 "neighbors"), "nextToken" (rawinput1641415 "nextToken"), "knownDependencyCount" (rawinput1641415 "knownDependencyCount")}] (clojure.core/cond-> {:neighbors (deser-neighbor-details-list (clojure.core/get-in letvar1641417 ["neighbors"]))} (letvar1641417 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1641417 ["nextToken"]))) (letvar1641417 "knownDependencyCount") (clojure.core/assoc :known-dependency-count (deser-long (clojure.core/get-in letvar1641417 ["knownDependencyCount"])))))))

(clojure.core/defn- response-start-data-collection-by-agent-ids-response ([input] (response-start-data-collection-by-agent-ids-response nil input)) ([resultWrapper1641419 input] (clojure.core/let [rawinput1641418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641420 {"agentsConfigurationStatus" (rawinput1641418 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1641420 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1641420 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-create-tags-response ([input] (response-create-tags-response nil input)) ([resultWrapper1641422 input] (clojure.core/let [rawinput1641421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1641425 input] (clojure.core/let [rawinput1641424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641426 {"message" (rawinput1641424 "message")}] (clojure.core/cond-> {} (letvar1641426 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641426 ["message"])))))))

(clojure.core/defn- response-batch-delete-import-data-response ([input] (response-batch-delete-import-data-response nil input)) ([resultWrapper1641428 input] (clojure.core/let [rawinput1641427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641429 {"errors" (rawinput1641427 "errors")}] (clojure.core/cond-> {} (letvar1641429 "errors") (clojure.core/assoc :errors (deser-batch-delete-import-data-error-list (clojure.core/get-in letvar1641429 ["errors"])))))))

(clojure.core/defn- response-describe-export-configurations-response ([input] (response-describe-export-configurations-response nil input)) ([resultWrapper1641431 input] (clojure.core/let [rawinput1641430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641432 {"exportsInfo" (rawinput1641430 "exportsInfo"), "nextToken" (rawinput1641430 "nextToken")}] (clojure.core/cond-> {} (letvar1641432 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1641432 ["exportsInfo"]))) (letvar1641432 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1641432 ["nextToken"])))))))

(clojure.core/defn- response-start-continuous-export-response ([input] (response-start-continuous-export-response nil input)) ([resultWrapper1641434 input] (clojure.core/let [rawinput1641433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641435 {"exportId" (rawinput1641433 "exportId"), "s3Bucket" (rawinput1641433 "s3Bucket"), "startTime" (rawinput1641433 "startTime"), "dataSource" (rawinput1641433 "dataSource"), "schemaStorageConfig" (rawinput1641433 "schemaStorageConfig")}] (clojure.core/cond-> {} (letvar1641435 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1641435 ["exportId"]))) (letvar1641435 "s3Bucket") (clojure.core/assoc :s-3-bucket (deser-s-3-bucket (clojure.core/get-in letvar1641435 ["s3Bucket"]))) (letvar1641435 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1641435 ["startTime"]))) (letvar1641435 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1641435 ["dataSource"]))) (letvar1641435 "schemaStorageConfig") (clojure.core/assoc :schema-storage-config (deser-schema-storage-config (clojure.core/get-in letvar1641435 ["schemaStorageConfig"])))))))

(clojure.core/defn- response-start-import-task-response ([input] (response-start-import-task-response nil input)) ([resultWrapper1641437 input] (clojure.core/let [rawinput1641436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641438 {"task" (rawinput1641436 "task")}] (clojure.core/cond-> {} (letvar1641438 "task") (clojure.core/assoc :task (deser-import-task (clojure.core/get-in letvar1641438 ["task"])))))))

(clojure.core/defn- response-authorization-error-exception ([input] (response-authorization-error-exception nil input)) ([resultWrapper1641440 input] (clojure.core/let [rawinput1641439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641441 {"message" (rawinput1641439 "message")}] (clojure.core/cond-> {} (letvar1641441 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641441 ["message"])))))))

(clojure.core/defn- response-start-export-task-response ([input] (response-start-export-task-response nil input)) ([resultWrapper1641443 input] (clojure.core/let [rawinput1641442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641444 {"exportId" (rawinput1641442 "exportId")}] (clojure.core/cond-> {} (letvar1641444 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1641444 ["exportId"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1641446 input] (clojure.core/let [rawinput1641445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641447 {"configurationId" (rawinput1641445 "configurationId")}] (clojure.core/cond-> {} (letvar1641447 "configurationId") (clojure.core/assoc :configuration-id (deser-string (clojure.core/get-in letvar1641447 ["configurationId"])))))))

(clojure.core/defn- response-delete-applications-response ([input] (response-delete-applications-response nil input)) ([resultWrapper1641449 input] (clojure.core/let [rawinput1641448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641450 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-conflict-error-exception ([input] (response-conflict-error-exception nil input)) ([resultWrapper1641452 input] (clojure.core/let [rawinput1641451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641453 {"message" (rawinput1641451 "message")}] (clojure.core/cond-> {} (letvar1641453 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641453 ["message"])))))))

(clojure.core/defn- response-stop-data-collection-by-agent-ids-response ([input] (response-stop-data-collection-by-agent-ids-response nil input)) ([resultWrapper1641455 input] (clojure.core/let [rawinput1641454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641456 {"agentsConfigurationStatus" (rawinput1641454 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1641456 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1641456 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1641458 input] (clojure.core/let [rawinput1641457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641459 {"message" (rawinput1641457 "message")}] (clojure.core/cond-> {} (letvar1641459 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641459 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1641461 input] (clojure.core/let [rawinput1641460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641462 {"message" (rawinput1641460 "message")}] (clojure.core/cond-> {} (letvar1641462 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1641462 ["message"])))))))

(clojure.core/defn- response-stop-continuous-export-response ([input] (response-stop-continuous-export-response nil input)) ([resultWrapper1641464 input] (clojure.core/let [rawinput1641463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1641465 {"startTime" (rawinput1641463 "startTime"), "stopTime" (rawinput1641463 "stopTime")}] (clojure.core/cond-> {} (letvar1641465 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1641465 ["startTime"]))) (letvar1641465 "stopTime") (clojure.core/assoc :stop-time (deser-time-stamp (clojure.core/get-in letvar1641465 ["stopTime"])))))))
...
(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/database-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 252))))
...
(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/import-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/import-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/import-task-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.discovery.-2015-11-01/string-max-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
