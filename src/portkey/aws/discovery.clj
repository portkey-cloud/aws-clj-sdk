...
(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper1678432 input] (clojure.core/let [rawinput1678431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678433 {"tags" (rawinput1678431 "tags"), "nextToken" (rawinput1678431 "nextToken")}] (clojure.core/cond-> {} (letvar1678433 "tags") (clojure.core/assoc :tags (deser-configuration-tag-set (clojure.core/get-in letvar1678433 ["tags"]))) (letvar1678433 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678433 ["nextToken"])))))))

(clojure.core/defn- response-delete-tags-response ([input] (response-delete-tags-response nil input)) ([resultWrapper1678435 input] (clojure.core/let [rawinput1678434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678436 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-import-tasks-response ([input] (response-describe-import-tasks-response nil input)) ([resultWrapper1678438 input] (clojure.core/let [rawinput1678437 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678439 {"nextToken" (rawinput1678437 "nextToken"), "tasks" (rawinput1678437 "tasks")}] (clojure.core/cond-> {} (letvar1678439 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678439 ["nextToken"]))) (letvar1678439 "tasks") (clojure.core/assoc :tasks (deser-import-task-list (clojure.core/get-in letvar1678439 ["tasks"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1678441 input] (clojure.core/let [rawinput1678440 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678442 {"message" (rawinput1678440 "message")}] (clojure.core/cond-> {} (letvar1678442 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678442 ["message"])))))))

(clojure.core/defn- response-disassociate-configuration-items-from-application-response ([input] (response-disassociate-configuration-items-from-application-response nil input)) ([resultWrapper1678444 input] (clojure.core/let [rawinput1678443 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678445 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-configurations-response ([input] (response-describe-configurations-response nil input)) ([resultWrapper1678447 input] (clojure.core/let [rawinput1678446 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678448 {"configurations" (rawinput1678446 "configurations")}] (clojure.core/cond-> {} (letvar1678448 "configurations") (clojure.core/assoc :configurations (deser-describe-configurations-attributes (clojure.core/get-in letvar1678448 ["configurations"])))))))

(clojure.core/defn- response-list-configurations-response ([input] (response-list-configurations-response nil input)) ([resultWrapper1678450 input] (clojure.core/let [rawinput1678449 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678451 {"configurations" (rawinput1678449 "configurations"), "nextToken" (rawinput1678449 "nextToken")}] (clojure.core/cond-> {} (letvar1678451 "configurations") (clojure.core/assoc :configurations (deser-configurations (clojure.core/get-in letvar1678451 ["configurations"]))) (letvar1678451 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678451 ["nextToken"])))))))

(clojure.core/defn- response-server-internal-error-exception ([input] (response-server-internal-error-exception nil input)) ([resultWrapper1678453 input] (clojure.core/let [rawinput1678452 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678454 {"message" (rawinput1678452 "message")}] (clojure.core/cond-> {} (letvar1678454 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678454 ["message"])))))))

(clojure.core/defn- response-describe-agents-response ([input] (response-describe-agents-response nil input)) ([resultWrapper1678456 input] (clojure.core/let [rawinput1678455 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678457 {"agentsInfo" (rawinput1678455 "agentsInfo"), "nextToken" (rawinput1678455 "nextToken")}] (clojure.core/cond-> {} (letvar1678457 "agentsInfo") (clojure.core/assoc :agents-info (deser-agents-info (clojure.core/get-in letvar1678457 ["agentsInfo"]))) (letvar1678457 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678457 ["nextToken"])))))))

(clojure.core/defn- response-associate-configuration-items-to-application-response ([input] (response-associate-configuration-items-to-application-response nil input)) ([resultWrapper1678459 input] (clojure.core/let [rawinput1678458 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678460 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1678462 input] (clojure.core/let [rawinput1678461 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678463 {"message" (rawinput1678461 "message")}] (clojure.core/cond-> {} (letvar1678463 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678463 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1678465 input] (clojure.core/let [rawinput1678464 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678466 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-export-configurations-response ([input] (response-export-configurations-response nil input)) ([resultWrapper1678468 input] (clojure.core/let [rawinput1678467 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678469 {"exportId" (rawinput1678467 "exportId")}] (clojure.core/cond-> {} (letvar1678469 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1678469 ["exportId"])))))))

(clojure.core/defn- response-describe-continuous-exports-response ([input] (response-describe-continuous-exports-response nil input)) ([resultWrapper1678471 input] (clojure.core/let [rawinput1678470 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678472 {"descriptions" (rawinput1678470 "descriptions"), "nextToken" (rawinput1678470 "nextToken")}] (clojure.core/cond-> {} (letvar1678472 "descriptions") (clojure.core/assoc :descriptions (deser-continuous-export-descriptions (clojure.core/get-in letvar1678472 ["descriptions"]))) (letvar1678472 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678472 ["nextToken"])))))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1678474 input] (clojure.core/let [rawinput1678473 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678475 {"exportsInfo" (rawinput1678473 "exportsInfo"), "nextToken" (rawinput1678473 "nextToken")}] (clojure.core/cond-> {} (letvar1678475 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1678475 ["exportsInfo"]))) (letvar1678475 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678475 ["nextToken"])))))))

(clojure.core/defn- response-get-discovery-summary-response ([input] (response-get-discovery-summary-response nil input)) ([resultWrapper1678477 input] (clojure.core/let [rawinput1678476 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678478 {"servers" (rawinput1678476 "servers"), "applications" (rawinput1678476 "applications"), "serversMappedToApplications" (rawinput1678476 "serversMappedToApplications"), "serversMappedtoTags" (rawinput1678476 "serversMappedtoTags"), "agentSummary" (rawinput1678476 "agentSummary"), "connectorSummary" (rawinput1678476 "connectorSummary")}] (clojure.core/cond-> {} (letvar1678478 "servers") (clojure.core/assoc :servers (deser-long (clojure.core/get-in letvar1678478 ["servers"]))) (letvar1678478 "applications") (clojure.core/assoc :applications (deser-long (clojure.core/get-in letvar1678478 ["applications"]))) (letvar1678478 "serversMappedToApplications") (clojure.core/assoc :servers-mapped-to-applications (deser-long (clojure.core/get-in letvar1678478 ["serversMappedToApplications"]))) (letvar1678478 "serversMappedtoTags") (clojure.core/assoc :servers-mappedto-tags (deser-long (clojure.core/get-in letvar1678478 ["serversMappedtoTags"]))) (letvar1678478 "agentSummary") (clojure.core/assoc :agent-summary (deser-customer-agent-info (clojure.core/get-in letvar1678478 ["agentSummary"]))) (letvar1678478 "connectorSummary") (clojure.core/assoc :connector-summary (deser-customer-connector-info (clojure.core/get-in letvar1678478 ["connectorSummary"])))))))

(clojure.core/defn- response-list-server-neighbors-response ([input] (response-list-server-neighbors-response nil input)) ([resultWrapper1678480 input] (clojure.core/let [rawinput1678479 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678481 {"neighbors" (rawinput1678479 "neighbors"), "nextToken" (rawinput1678479 "nextToken"), "knownDependencyCount" (rawinput1678479 "knownDependencyCount")}] (clojure.core/cond-> {:neighbors (deser-neighbor-details-list (clojure.core/get-in letvar1678481 ["neighbors"]))} (letvar1678481 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1678481 ["nextToken"]))) (letvar1678481 "knownDependencyCount") (clojure.core/assoc :known-dependency-count (deser-long (clojure.core/get-in letvar1678481 ["knownDependencyCount"])))))))

(clojure.core/defn- response-start-data-collection-by-agent-ids-response ([input] (response-start-data-collection-by-agent-ids-response nil input)) ([resultWrapper1678483 input] (clojure.core/let [rawinput1678482 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678484 {"agentsConfigurationStatus" (rawinput1678482 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1678484 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1678484 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-create-tags-response ([input] (response-create-tags-response nil input)) ([resultWrapper1678486 input] (clojure.core/let [rawinput1678485 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678487 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1678489 input] (clojure.core/let [rawinput1678488 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678490 {"message" (rawinput1678488 "message")}] (clojure.core/cond-> {} (letvar1678490 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678490 ["message"])))))))

(clojure.core/defn- response-batch-delete-import-data-response ([input] (response-batch-delete-import-data-response nil input)) ([resultWrapper1678492 input] (clojure.core/let [rawinput1678491 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678493 {"errors" (rawinput1678491 "errors")}] (clojure.core/cond-> {} (letvar1678493 "errors") (clojure.core/assoc :errors (deser-batch-delete-import-data-error-list (clojure.core/get-in letvar1678493 ["errors"])))))))

(clojure.core/defn- response-describe-export-configurations-response ([input] (response-describe-export-configurations-response nil input)) ([resultWrapper1678495 input] (clojure.core/let [rawinput1678494 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678496 {"exportsInfo" (rawinput1678494 "exportsInfo"), "nextToken" (rawinput1678494 "nextToken")}] (clojure.core/cond-> {} (letvar1678496 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1678496 ["exportsInfo"]))) (letvar1678496 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1678496 ["nextToken"])))))))

(clojure.core/defn- response-start-continuous-export-response ([input] (response-start-continuous-export-response nil input)) ([resultWrapper1678498 input] (clojure.core/let [rawinput1678497 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678499 {"exportId" (rawinput1678497 "exportId"), "s3Bucket" (rawinput1678497 "s3Bucket"), "startTime" (rawinput1678497 "startTime"), "dataSource" (rawinput1678497 "dataSource"), "schemaStorageConfig" (rawinput1678497 "schemaStorageConfig")}] (clojure.core/cond-> {} (letvar1678499 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1678499 ["exportId"]))) (letvar1678499 "s3Bucket") (clojure.core/assoc :s-3-bucket (deser-s-3-bucket (clojure.core/get-in letvar1678499 ["s3Bucket"]))) (letvar1678499 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1678499 ["startTime"]))) (letvar1678499 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1678499 ["dataSource"]))) (letvar1678499 "schemaStorageConfig") (clojure.core/assoc :schema-storage-config (deser-schema-storage-config (clojure.core/get-in letvar1678499 ["schemaStorageConfig"])))))))

(clojure.core/defn- response-start-import-task-response ([input] (response-start-import-task-response nil input)) ([resultWrapper1678501 input] (clojure.core/let [rawinput1678500 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678502 {"task" (rawinput1678500 "task")}] (clojure.core/cond-> {} (letvar1678502 "task") (clojure.core/assoc :task (deser-import-task (clojure.core/get-in letvar1678502 ["task"])))))))

(clojure.core/defn- response-authorization-error-exception ([input] (response-authorization-error-exception nil input)) ([resultWrapper1678504 input] (clojure.core/let [rawinput1678503 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678505 {"message" (rawinput1678503 "message")}] (clojure.core/cond-> {} (letvar1678505 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678505 ["message"])))))))

(clojure.core/defn- response-start-export-task-response ([input] (response-start-export-task-response nil input)) ([resultWrapper1678507 input] (clojure.core/let [rawinput1678506 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678508 {"exportId" (rawinput1678506 "exportId")}] (clojure.core/cond-> {} (letvar1678508 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1678508 ["exportId"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1678510 input] (clojure.core/let [rawinput1678509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678511 {"configurationId" (rawinput1678509 "configurationId")}] (clojure.core/cond-> {} (letvar1678511 "configurationId") (clojure.core/assoc :configuration-id (deser-string (clojure.core/get-in letvar1678511 ["configurationId"])))))))

(clojure.core/defn- response-delete-applications-response ([input] (response-delete-applications-response nil input)) ([resultWrapper1678513 input] (clojure.core/let [rawinput1678512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678514 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-conflict-error-exception ([input] (response-conflict-error-exception nil input)) ([resultWrapper1678516 input] (clojure.core/let [rawinput1678515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678517 {"message" (rawinput1678515 "message")}] (clojure.core/cond-> {} (letvar1678517 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678517 ["message"])))))))

(clojure.core/defn- response-stop-data-collection-by-agent-ids-response ([input] (response-stop-data-collection-by-agent-ids-response nil input)) ([resultWrapper1678519 input] (clojure.core/let [rawinput1678518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678520 {"agentsConfigurationStatus" (rawinput1678518 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1678520 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1678520 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1678522 input] (clojure.core/let [rawinput1678521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678523 {"message" (rawinput1678521 "message")}] (clojure.core/cond-> {} (letvar1678523 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678523 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1678525 input] (clojure.core/let [rawinput1678524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678526 {"message" (rawinput1678524 "message")}] (clojure.core/cond-> {} (letvar1678526 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1678526 ["message"])))))))

(clojure.core/defn- response-stop-continuous-export-response ([input] (response-stop-continuous-export-response nil input)) ([resultWrapper1678528 input] (clojure.core/let [rawinput1678527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1678529 {"startTime" (rawinput1678527 "startTime"), "stopTime" (rawinput1678527 "stopTime")}] (clojure.core/cond-> {} (letvar1678529 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1678529 ["startTime"]))) (letvar1678529 "stopTime") (clojure.core/assoc :stop-time (deser-time-stamp (clojure.core/get-in letvar1678529 ["stopTime"])))))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/database-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 252))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-task-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.discovery/string-max-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
