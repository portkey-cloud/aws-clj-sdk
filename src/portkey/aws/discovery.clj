...
(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper1638374 input] (clojure.core/let [rawinput1638373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638375 {"tags" (rawinput1638373 "tags"), "nextToken" (rawinput1638373 "nextToken")}] (clojure.core/cond-> {} (letvar1638375 "tags") (clojure.core/assoc :tags (deser-configuration-tag-set (clojure.core/get-in letvar1638375 ["tags"]))) (letvar1638375 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638375 ["nextToken"])))))))

(clojure.core/defn- response-delete-tags-response ([input] (response-delete-tags-response nil input)) ([resultWrapper1638377 input] (clojure.core/let [rawinput1638376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638378 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-import-tasks-response ([input] (response-describe-import-tasks-response nil input)) ([resultWrapper1638380 input] (clojure.core/let [rawinput1638379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638381 {"nextToken" (rawinput1638379 "nextToken"), "tasks" (rawinput1638379 "tasks")}] (clojure.core/cond-> {} (letvar1638381 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638381 ["nextToken"]))) (letvar1638381 "tasks") (clojure.core/assoc :tasks (deser-import-task-list (clojure.core/get-in letvar1638381 ["tasks"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1638383 input] (clojure.core/let [rawinput1638382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638384 {"message" (rawinput1638382 "message")}] (clojure.core/cond-> {} (letvar1638384 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638384 ["message"])))))))

(clojure.core/defn- response-disassociate-configuration-items-from-application-response ([input] (response-disassociate-configuration-items-from-application-response nil input)) ([resultWrapper1638386 input] (clojure.core/let [rawinput1638385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638387 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-configurations-response ([input] (response-describe-configurations-response nil input)) ([resultWrapper1638389 input] (clojure.core/let [rawinput1638388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638390 {"configurations" (rawinput1638388 "configurations")}] (clojure.core/cond-> {} (letvar1638390 "configurations") (clojure.core/assoc :configurations (deser-describe-configurations-attributes (clojure.core/get-in letvar1638390 ["configurations"])))))))

(clojure.core/defn- response-list-configurations-response ([input] (response-list-configurations-response nil input)) ([resultWrapper1638392 input] (clojure.core/let [rawinput1638391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638393 {"configurations" (rawinput1638391 "configurations"), "nextToken" (rawinput1638391 "nextToken")}] (clojure.core/cond-> {} (letvar1638393 "configurations") (clojure.core/assoc :configurations (deser-configurations (clojure.core/get-in letvar1638393 ["configurations"]))) (letvar1638393 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638393 ["nextToken"])))))))

(clojure.core/defn- response-server-internal-error-exception ([input] (response-server-internal-error-exception nil input)) ([resultWrapper1638395 input] (clojure.core/let [rawinput1638394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638396 {"message" (rawinput1638394 "message")}] (clojure.core/cond-> {} (letvar1638396 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638396 ["message"])))))))

(clojure.core/defn- response-describe-agents-response ([input] (response-describe-agents-response nil input)) ([resultWrapper1638398 input] (clojure.core/let [rawinput1638397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638399 {"agentsInfo" (rawinput1638397 "agentsInfo"), "nextToken" (rawinput1638397 "nextToken")}] (clojure.core/cond-> {} (letvar1638399 "agentsInfo") (clojure.core/assoc :agents-info (deser-agents-info (clojure.core/get-in letvar1638399 ["agentsInfo"]))) (letvar1638399 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638399 ["nextToken"])))))))

(clojure.core/defn- response-associate-configuration-items-to-application-response ([input] (response-associate-configuration-items-to-application-response nil input)) ([resultWrapper1638401 input] (clojure.core/let [rawinput1638400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638402 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1638404 input] (clojure.core/let [rawinput1638403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638405 {"message" (rawinput1638403 "message")}] (clojure.core/cond-> {} (letvar1638405 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638405 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1638407 input] (clojure.core/let [rawinput1638406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638408 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-export-configurations-response ([input] (response-export-configurations-response nil input)) ([resultWrapper1638410 input] (clojure.core/let [rawinput1638409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638411 {"exportId" (rawinput1638409 "exportId")}] (clojure.core/cond-> {} (letvar1638411 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1638411 ["exportId"])))))))

(clojure.core/defn- response-describe-continuous-exports-response ([input] (response-describe-continuous-exports-response nil input)) ([resultWrapper1638413 input] (clojure.core/let [rawinput1638412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638414 {"descriptions" (rawinput1638412 "descriptions"), "nextToken" (rawinput1638412 "nextToken")}] (clojure.core/cond-> {} (letvar1638414 "descriptions") (clojure.core/assoc :descriptions (deser-continuous-export-descriptions (clojure.core/get-in letvar1638414 ["descriptions"]))) (letvar1638414 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638414 ["nextToken"])))))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1638416 input] (clojure.core/let [rawinput1638415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638417 {"exportsInfo" (rawinput1638415 "exportsInfo"), "nextToken" (rawinput1638415 "nextToken")}] (clojure.core/cond-> {} (letvar1638417 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1638417 ["exportsInfo"]))) (letvar1638417 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638417 ["nextToken"])))))))

(clojure.core/defn- response-get-discovery-summary-response ([input] (response-get-discovery-summary-response nil input)) ([resultWrapper1638419 input] (clojure.core/let [rawinput1638418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638420 {"servers" (rawinput1638418 "servers"), "applications" (rawinput1638418 "applications"), "serversMappedToApplications" (rawinput1638418 "serversMappedToApplications"), "serversMappedtoTags" (rawinput1638418 "serversMappedtoTags"), "agentSummary" (rawinput1638418 "agentSummary"), "connectorSummary" (rawinput1638418 "connectorSummary")}] (clojure.core/cond-> {} (letvar1638420 "servers") (clojure.core/assoc :servers (deser-long (clojure.core/get-in letvar1638420 ["servers"]))) (letvar1638420 "applications") (clojure.core/assoc :applications (deser-long (clojure.core/get-in letvar1638420 ["applications"]))) (letvar1638420 "serversMappedToApplications") (clojure.core/assoc :servers-mapped-to-applications (deser-long (clojure.core/get-in letvar1638420 ["serversMappedToApplications"]))) (letvar1638420 "serversMappedtoTags") (clojure.core/assoc :servers-mappedto-tags (deser-long (clojure.core/get-in letvar1638420 ["serversMappedtoTags"]))) (letvar1638420 "agentSummary") (clojure.core/assoc :agent-summary (deser-customer-agent-info (clojure.core/get-in letvar1638420 ["agentSummary"]))) (letvar1638420 "connectorSummary") (clojure.core/assoc :connector-summary (deser-customer-connector-info (clojure.core/get-in letvar1638420 ["connectorSummary"])))))))

(clojure.core/defn- response-list-server-neighbors-response ([input] (response-list-server-neighbors-response nil input)) ([resultWrapper1638422 input] (clojure.core/let [rawinput1638421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638423 {"neighbors" (rawinput1638421 "neighbors"), "nextToken" (rawinput1638421 "nextToken"), "knownDependencyCount" (rawinput1638421 "knownDependencyCount")}] (clojure.core/cond-> {:neighbors (deser-neighbor-details-list (clojure.core/get-in letvar1638423 ["neighbors"]))} (letvar1638423 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1638423 ["nextToken"]))) (letvar1638423 "knownDependencyCount") (clojure.core/assoc :known-dependency-count (deser-long (clojure.core/get-in letvar1638423 ["knownDependencyCount"])))))))

(clojure.core/defn- response-start-data-collection-by-agent-ids-response ([input] (response-start-data-collection-by-agent-ids-response nil input)) ([resultWrapper1638425 input] (clojure.core/let [rawinput1638424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638426 {"agentsConfigurationStatus" (rawinput1638424 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1638426 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1638426 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-create-tags-response ([input] (response-create-tags-response nil input)) ([resultWrapper1638428 input] (clojure.core/let [rawinput1638427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638429 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1638431 input] (clojure.core/let [rawinput1638430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638432 {"message" (rawinput1638430 "message")}] (clojure.core/cond-> {} (letvar1638432 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638432 ["message"])))))))

(clojure.core/defn- response-batch-delete-import-data-response ([input] (response-batch-delete-import-data-response nil input)) ([resultWrapper1638434 input] (clojure.core/let [rawinput1638433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638435 {"errors" (rawinput1638433 "errors")}] (clojure.core/cond-> {} (letvar1638435 "errors") (clojure.core/assoc :errors (deser-batch-delete-import-data-error-list (clojure.core/get-in letvar1638435 ["errors"])))))))

(clojure.core/defn- response-describe-export-configurations-response ([input] (response-describe-export-configurations-response nil input)) ([resultWrapper1638437 input] (clojure.core/let [rawinput1638436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638438 {"exportsInfo" (rawinput1638436 "exportsInfo"), "nextToken" (rawinput1638436 "nextToken")}] (clojure.core/cond-> {} (letvar1638438 "exportsInfo") (clojure.core/assoc :exports-info (deser-exports-info (clojure.core/get-in letvar1638438 ["exportsInfo"]))) (letvar1638438 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1638438 ["nextToken"])))))))

(clojure.core/defn- response-start-continuous-export-response ([input] (response-start-continuous-export-response nil input)) ([resultWrapper1638440 input] (clojure.core/let [rawinput1638439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638441 {"exportId" (rawinput1638439 "exportId"), "s3Bucket" (rawinput1638439 "s3Bucket"), "startTime" (rawinput1638439 "startTime"), "dataSource" (rawinput1638439 "dataSource"), "schemaStorageConfig" (rawinput1638439 "schemaStorageConfig")}] (clojure.core/cond-> {} (letvar1638441 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1638441 ["exportId"]))) (letvar1638441 "s3Bucket") (clojure.core/assoc :s-3-bucket (deser-s-3-bucket (clojure.core/get-in letvar1638441 ["s3Bucket"]))) (letvar1638441 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1638441 ["startTime"]))) (letvar1638441 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1638441 ["dataSource"]))) (letvar1638441 "schemaStorageConfig") (clojure.core/assoc :schema-storage-config (deser-schema-storage-config (clojure.core/get-in letvar1638441 ["schemaStorageConfig"])))))))

(clojure.core/defn- response-start-import-task-response ([input] (response-start-import-task-response nil input)) ([resultWrapper1638443 input] (clojure.core/let [rawinput1638442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638444 {"task" (rawinput1638442 "task")}] (clojure.core/cond-> {} (letvar1638444 "task") (clojure.core/assoc :task (deser-import-task (clojure.core/get-in letvar1638444 ["task"])))))))

(clojure.core/defn- response-authorization-error-exception ([input] (response-authorization-error-exception nil input)) ([resultWrapper1638446 input] (clojure.core/let [rawinput1638445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638447 {"message" (rawinput1638445 "message")}] (clojure.core/cond-> {} (letvar1638447 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638447 ["message"])))))))

(clojure.core/defn- response-start-export-task-response ([input] (response-start-export-task-response nil input)) ([resultWrapper1638449 input] (clojure.core/let [rawinput1638448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638450 {"exportId" (rawinput1638448 "exportId")}] (clojure.core/cond-> {} (letvar1638450 "exportId") (clojure.core/assoc :export-id (deser-configurations-export-id (clojure.core/get-in letvar1638450 ["exportId"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1638452 input] (clojure.core/let [rawinput1638451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638453 {"configurationId" (rawinput1638451 "configurationId")}] (clojure.core/cond-> {} (letvar1638453 "configurationId") (clojure.core/assoc :configuration-id (deser-string (clojure.core/get-in letvar1638453 ["configurationId"])))))))

(clojure.core/defn- response-delete-applications-response ([input] (response-delete-applications-response nil input)) ([resultWrapper1638455 input] (clojure.core/let [rawinput1638454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638456 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-conflict-error-exception ([input] (response-conflict-error-exception nil input)) ([resultWrapper1638458 input] (clojure.core/let [rawinput1638457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638459 {"message" (rawinput1638457 "message")}] (clojure.core/cond-> {} (letvar1638459 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638459 ["message"])))))))

(clojure.core/defn- response-stop-data-collection-by-agent-ids-response ([input] (response-stop-data-collection-by-agent-ids-response nil input)) ([resultWrapper1638461 input] (clojure.core/let [rawinput1638460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638462 {"agentsConfigurationStatus" (rawinput1638460 "agentsConfigurationStatus")}] (clojure.core/cond-> {} (letvar1638462 "agentsConfigurationStatus") (clojure.core/assoc :agents-configuration-status (deser-agent-configuration-status-list (clojure.core/get-in letvar1638462 ["agentsConfigurationStatus"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1638464 input] (clojure.core/let [rawinput1638463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638465 {"message" (rawinput1638463 "message")}] (clojure.core/cond-> {} (letvar1638465 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638465 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1638467 input] (clojure.core/let [rawinput1638466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638468 {"message" (rawinput1638466 "message")}] (clojure.core/cond-> {} (letvar1638468 "message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1638468 ["message"])))))))

(clojure.core/defn- response-stop-continuous-export-response ([input] (response-stop-continuous-export-response nil input)) ([resultWrapper1638470 input] (clojure.core/let [rawinput1638469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1638471 {"startTime" (rawinput1638469 "startTime"), "stopTime" (rawinput1638469 "stopTime")}] (clojure.core/cond-> {} (letvar1638471 "startTime") (clojure.core/assoc :start-time (deser-time-stamp (clojure.core/get-in letvar1638471 ["startTime"]))) (letvar1638471 "stopTime") (clojure.core/assoc :stop-time (deser-time-stamp (clojure.core/get-in letvar1638471 ["stopTime"])))))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/database-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 252))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.discovery/import-task-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.discovery/string-max-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
