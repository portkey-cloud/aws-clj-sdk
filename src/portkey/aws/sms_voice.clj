...
(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper1467575 input] (clojure.core/let [rawinput1467574 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467576 {"Message" (rawinput1467574 "Message")}] (clojure.core/cond-> {} (letvar1467576 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467576 ["Message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1467578 input] (clojure.core/let [rawinput1467577 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467579 {"Message" (rawinput1467577 "Message")}] (clojure.core/cond-> {} (letvar1467579 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467579 ["Message"])))))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper1467581 input] (clojure.core/let [rawinput1467580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467582 {"EventDestinations" (rawinput1467580 "EventDestinations")}] (clojure.core/cond-> {} (letvar1467582 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar1467582 ["EventDestinations"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1467584 input] (clojure.core/let [rawinput1467583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467585 {"Message" (rawinput1467583 "Message")}] (clojure.core/cond-> {} (letvar1467585 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467585 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1467587 input] (clojure.core/let [rawinput1467586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467588 {"Message" (rawinput1467586 "Message")}] (clojure.core/cond-> {} (letvar1467588 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467588 ["Message"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper1467590 input] (clojure.core/let [rawinput1467589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467591 {"ConfigurationSets" (rawinput1467589 "ConfigurationSets"), "NextToken" (rawinput1467589 "NextToken")}] (clojure.core/cond-> {} (letvar1467591 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-sets (clojure.core/get-in letvar1467591 ["ConfigurationSets"]))) (letvar1467591 "NextToken") (clojure.core/assoc :next-token (deser-next-token-string (clojure.core/get-in letvar1467591 ["NextToken"])))))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper1467593 input] (clojure.core/let [rawinput1467592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467594 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1467596 input] (clojure.core/let [rawinput1467595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467597 {"Message" (rawinput1467595 "Message")}] (clojure.core/cond-> {} (letvar1467597 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467597 ["Message"])))))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper1467599 input] (clojure.core/let [rawinput1467598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467600 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1467602 input] (clojure.core/let [rawinput1467601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467603 {"Message" (rawinput1467601 "Message")}] (clojure.core/cond-> {} (letvar1467603 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1467603 ["Message"])))))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper1467605 input] (clojure.core/let [rawinput1467604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467606 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-voice-message-response ([input] (response-send-voice-message-response nil input)) ([resultWrapper1467608 input] (clojure.core/let [rawinput1467607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467609 {"MessageId" (rawinput1467607 "MessageId")}] (clojure.core/cond-> {} (letvar1467609 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar1467609 ["MessageId"])))))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper1467611 input] (clojure.core/let [rawinput1467610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467612 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper1467614 input] (clojure.core/let [rawinput1467613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1467615 {}] (clojure.core/cond-> {}))))
