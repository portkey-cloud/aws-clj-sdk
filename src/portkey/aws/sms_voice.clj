...
(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper1744375 input] (clojure.core/let [rawinput1744374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744376 {"Message" (rawinput1744374 "Message")}] (clojure.core/cond-> {} (letvar1744376 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744376 ["Message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1744378 input] (clojure.core/let [rawinput1744377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744379 {"Message" (rawinput1744377 "Message")}] (clojure.core/cond-> {} (letvar1744379 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744379 ["Message"])))))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper1744381 input] (clojure.core/let [rawinput1744380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744382 {"EventDestinations" (rawinput1744380 "EventDestinations")}] (clojure.core/cond-> {} (letvar1744382 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar1744382 ["EventDestinations"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1744384 input] (clojure.core/let [rawinput1744383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744385 {"Message" (rawinput1744383 "Message")}] (clojure.core/cond-> {} (letvar1744385 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744385 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1744387 input] (clojure.core/let [rawinput1744386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744388 {"Message" (rawinput1744386 "Message")}] (clojure.core/cond-> {} (letvar1744388 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744388 ["Message"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper1744390 input] (clojure.core/let [rawinput1744389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744391 {"ConfigurationSets" (rawinput1744389 "ConfigurationSets"), "NextToken" (rawinput1744389 "NextToken")}] (clojure.core/cond-> {} (letvar1744391 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-sets (clojure.core/get-in letvar1744391 ["ConfigurationSets"]))) (letvar1744391 "NextToken") (clojure.core/assoc :next-token (deser-next-token-string (clojure.core/get-in letvar1744391 ["NextToken"])))))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper1744393 input] (clojure.core/let [rawinput1744392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744394 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1744396 input] (clojure.core/let [rawinput1744395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744397 {"Message" (rawinput1744395 "Message")}] (clojure.core/cond-> {} (letvar1744397 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744397 ["Message"])))))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper1744399 input] (clojure.core/let [rawinput1744398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744400 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1744402 input] (clojure.core/let [rawinput1744401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744403 {"Message" (rawinput1744401 "Message")}] (clojure.core/cond-> {} (letvar1744403 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1744403 ["Message"])))))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper1744405 input] (clojure.core/let [rawinput1744404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744406 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-send-voice-message-response ([input] (response-send-voice-message-response nil input)) ([resultWrapper1744408 input] (clojure.core/let [rawinput1744407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744409 {"MessageId" (rawinput1744407 "MessageId")}] (clojure.core/cond-> {} (letvar1744409 "MessageId") (clojure.core/assoc :message-id (deser-string (clojure.core/get-in letvar1744409 ["MessageId"])))))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper1744411 input] (clojure.core/let [rawinput1744410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744412 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper1744414 input] (clojure.core/let [rawinput1744413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744415 {}] (clojure.core/cond-> {}))))
