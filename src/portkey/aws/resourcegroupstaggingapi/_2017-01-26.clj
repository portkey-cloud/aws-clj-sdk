...
(clojure.core/defn- response-tag-resources-output ([input] (response-tag-resources-output nil input)) ([resultWrapper1951409 input] (clojure.core/let [rawinput1951408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951410 {"FailedResourcesMap" (rawinput1951408 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1951410 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1951410 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-values-output ([input] (response-get-tag-values-output nil input)) ([resultWrapper1951412 input] (clojure.core/let [rawinput1951411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951413 {"PaginationToken" (rawinput1951411 "PaginationToken"), "TagValues" (rawinput1951411 "TagValues")}] (clojure.core/cond-> {} (letvar1951413 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1951413 ["PaginationToken"]))) (letvar1951413 "TagValues") (clojure.core/assoc :tag-values (deser-tag-values-output-list (clojure.core/get-in letvar1951413 ["TagValues"])))))))

(clojure.core/defn- response-pagination-token-expired-exception ([input] (response-pagination-token-expired-exception nil input)) ([resultWrapper1951415 input] (clojure.core/let [rawinput1951414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951416 {"Message" (rawinput1951414 "Message")}] (clojure.core/cond-> {} (letvar1951416 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1951416 ["Message"])))))))

(clojure.core/defn- response-untag-resources-output ([input] (response-untag-resources-output nil input)) ([resultWrapper1951418 input] (clojure.core/let [rawinput1951417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951419 {"FailedResourcesMap" (rawinput1951417 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1951419 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1951419 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-keys-output ([input] (response-get-tag-keys-output nil input)) ([resultWrapper1951421 input] (clojure.core/let [rawinput1951420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951422 {"PaginationToken" (rawinput1951420 "PaginationToken"), "TagKeys" (rawinput1951420 "TagKeys")}] (clojure.core/cond-> {} (letvar1951422 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1951422 ["PaginationToken"]))) (letvar1951422 "TagKeys") (clojure.core/assoc :tag-keys (deser-tag-key-list (clojure.core/get-in letvar1951422 ["TagKeys"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1951424 input] (clojure.core/let [rawinput1951423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951425 {"Message" (rawinput1951423 "Message")}] (clojure.core/cond-> {} (letvar1951425 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1951425 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1951427 input] (clojure.core/let [rawinput1951426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951428 {"Message" (rawinput1951426 "Message")}] (clojure.core/cond-> {} (letvar1951428 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1951428 ["Message"])))))))

(clojure.core/defn- response-get-resources-output ([input] (response-get-resources-output nil input)) ([resultWrapper1951430 input] (clojure.core/let [rawinput1951429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951431 {"PaginationToken" (rawinput1951429 "PaginationToken"), "ResourceTagMappingList" (rawinput1951429 "ResourceTagMappingList")}] (clojure.core/cond-> {} (letvar1951431 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1951431 ["PaginationToken"]))) (letvar1951431 "ResourceTagMappingList") (clojure.core/assoc :resource-tag-mapping-list (deser-resource-tag-mapping-list (clojure.core/get-in letvar1951431 ["ResourceTagMappingList"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1951433 input] (clojure.core/let [rawinput1951432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1951434 {"Message" (rawinput1951432 "Message")}] (clojure.core/cond-> {} (letvar1951434 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1951434 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/amazon-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
