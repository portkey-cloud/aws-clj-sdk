...
(clojure.core/defn- response-tag-resources-output ([input] (response-tag-resources-output nil input)) ([resultWrapper1961007 input] (clojure.core/let [rawinput1961006 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961008 {"FailedResourcesMap" (rawinput1961006 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1961008 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1961008 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-values-output ([input] (response-get-tag-values-output nil input)) ([resultWrapper1961010 input] (clojure.core/let [rawinput1961009 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961011 {"PaginationToken" (rawinput1961009 "PaginationToken"), "TagValues" (rawinput1961009 "TagValues")}] (clojure.core/cond-> {} (letvar1961011 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1961011 ["PaginationToken"]))) (letvar1961011 "TagValues") (clojure.core/assoc :tag-values (deser-tag-values-output-list (clojure.core/get-in letvar1961011 ["TagValues"])))))))

(clojure.core/defn- response-pagination-token-expired-exception ([input] (response-pagination-token-expired-exception nil input)) ([resultWrapper1961013 input] (clojure.core/let [rawinput1961012 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961014 {"Message" (rawinput1961012 "Message")}] (clojure.core/cond-> {} (letvar1961014 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1961014 ["Message"])))))))

(clojure.core/defn- response-untag-resources-output ([input] (response-untag-resources-output nil input)) ([resultWrapper1961016 input] (clojure.core/let [rawinput1961015 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961017 {"FailedResourcesMap" (rawinput1961015 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1961017 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1961017 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-keys-output ([input] (response-get-tag-keys-output nil input)) ([resultWrapper1961019 input] (clojure.core/let [rawinput1961018 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961020 {"PaginationToken" (rawinput1961018 "PaginationToken"), "TagKeys" (rawinput1961018 "TagKeys")}] (clojure.core/cond-> {} (letvar1961020 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1961020 ["PaginationToken"]))) (letvar1961020 "TagKeys") (clojure.core/assoc :tag-keys (deser-tag-key-list (clojure.core/get-in letvar1961020 ["TagKeys"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1961022 input] (clojure.core/let [rawinput1961021 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961023 {"Message" (rawinput1961021 "Message")}] (clojure.core/cond-> {} (letvar1961023 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1961023 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1961025 input] (clojure.core/let [rawinput1961024 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961026 {"Message" (rawinput1961024 "Message")}] (clojure.core/cond-> {} (letvar1961026 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1961026 ["Message"])))))))

(clojure.core/defn- response-get-resources-output ([input] (response-get-resources-output nil input)) ([resultWrapper1961028 input] (clojure.core/let [rawinput1961027 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961029 {"PaginationToken" (rawinput1961027 "PaginationToken"), "ResourceTagMappingList" (rawinput1961027 "ResourceTagMappingList")}] (clojure.core/cond-> {} (letvar1961029 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1961029 ["PaginationToken"]))) (letvar1961029 "ResourceTagMappingList") (clojure.core/assoc :resource-tag-mapping-list (deser-resource-tag-mapping-list (clojure.core/get-in letvar1961029 ["ResourceTagMappingList"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1961031 input] (clojure.core/let [rawinput1961030 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1961032 {"Message" (rawinput1961030 "Message")}] (clojure.core/cond-> {} (letvar1961032 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1961032 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/amazon-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi.-2017-01-26/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
