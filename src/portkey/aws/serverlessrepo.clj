...
(clojure.core/defn delete-application ([delete-application-request] (portkey.aws/-rest-json-call portkey.aws.serverlessrepo/endpoints "DELETE" "/applications/{applicationId}" delete-application-request :portkey.aws.serverlessrepo/delete-application-request {:payload nil, :move {}, :headers {}, :uri {"applicationId" "ApplicationId"}, :querystring {}} 204 nil {"BadRequestException" :portkey.aws.serverlessrepo/bad-request-exception, "InternalServerErrorException" :portkey.aws.serverlessrepo/internal-server-error-exception, "ForbiddenException" :portkey.aws.serverlessrepo/forbidden-exception, "NotFoundException" :portkey.aws.serverlessrepo/not-found-exception, "TooManyRequestsException" :portkey.aws.serverlessrepo/too-many-requests-exception, "ConflictException" :portkey.aws.serverlessrepo/conflict-exception})))
...
(clojure.core/defn update-application ([update-application-request] (portkey.aws/-rest-json-call portkey.aws.serverlessrepo/endpoints "PATCH" "/applications/{applicationId}" update-application-request :portkey.aws.serverlessrepo/update-application-request {:payload nil, :move {"author" "Author", "description" "Description", "homePageUrl" "HomePageUrl", "labels" "Labels", "readmeBody" "ReadmeBody", "readmeUrl" "ReadmeUrl"}, :headers {}, :uri {"applicationId" "ApplicationId"}, :querystring {}} 200 :portkey.aws.serverlessrepo/update-application-response {"BadRequestException" :portkey.aws.serverlessrepo/bad-request-exception, "InternalServerErrorException" :portkey.aws.serverlessrepo/internal-server-error-exception, "ForbiddenException" :portkey.aws.serverlessrepo/forbidden-exception, "NotFoundException" :portkey.aws.serverlessrepo/not-found-exception, "TooManyRequestsException" :portkey.aws.serverlessrepo/too-many-requests-exception, "ConflictException" :portkey.aws.serverlessrepo/conflict-exception})))
...
(clojure.core/defn create-cloud-formation-change-set ([create-cloud-formation-change-set-request] (portkey.aws/-rest-json-call portkey.aws.serverlessrepo/endpoints "POST" "/applications/{applicationId}/changesets" create-cloud-formation-change-set-request :portkey.aws.serverlessrepo/create-cloud-formation-change-set-request {:payload nil, :move {"parameterOverrides" "ParameterOverrides", "semanticVersion" "SemanticVersion", "stackName" "StackName"}, :headers {}, :uri {"applicationId" "ApplicationId"}, :querystring {}} 201 :portkey.aws.serverlessrepo/create-cloud-formation-change-set-response {"TooManyRequestsException" :portkey.aws.serverlessrepo/too-many-requests-exception, "BadRequestException" :portkey.aws.serverlessrepo/bad-request-exception, "InternalServerErrorException" :portkey.aws.serverlessrepo/internal-server-error-exception, "ForbiddenException" :portkey.aws.serverlessrepo/forbidden-exception})))
...
(clojure.core/defn put-application-policy ([put-application-policy-request] (portkey.aws/-rest-json-call portkey.aws.serverlessrepo/endpoints "PUT" "/applications/{applicationId}/policy" put-application-policy-request :portkey.aws.serverlessrepo/put-application-policy-request {:payload nil, :move {"statements" "Statements"}, :headers {}, :uri {"applicationId" "ApplicationId"}, :querystring {}} 200 :portkey.aws.serverlessrepo/put-application-policy-response {"NotFoundException" :portkey.aws.serverlessrepo/not-found-exception, "TooManyRequestsException" :portkey.aws.serverlessrepo/too-many-requests-exception, "BadRequestException" :portkey.aws.serverlessrepo/bad-request-exception, "InternalServerErrorException" :portkey.aws.serverlessrepo/internal-server-error-exception, "ForbiddenException" :portkey.aws.serverlessrepo/forbidden-exception})))
...
(clojure.core/defn get-application-policy ([get-application-policy-request] (portkey.aws/-rest-json-call portkey.aws.serverlessrepo/endpoints "GET" "/applications/{applicationId}/policy" get-application-policy-request :portkey.aws.serverlessrepo/get-application-policy-request {:payload nil, :move {}, :headers {}, :uri {"applicationId" "ApplicationId"}, :querystring {}} 200 :portkey.aws.serverlessrepo/get-application-policy-response {"NotFoundException" :portkey.aws.serverlessrepo/not-found-exception, "TooManyRequestsException" :portkey.aws.serverlessrepo/too-many-requests-exception, "BadRequestException" :portkey.aws.serverlessrepo/bad-request-exception, "InternalServerErrorException" :portkey.aws.serverlessrepo/internal-server-error-exception, "ForbiddenException" :portkey.aws.serverlessrepo/forbidden-exception})))
