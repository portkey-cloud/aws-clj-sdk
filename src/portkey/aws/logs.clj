...
(clojure.core/defn- response-describe-log-groups-response ([input] (response-describe-log-groups-response nil input)) ([resultWrapper1249946 input] (clojure.core/let [rawinput1249945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249947 {"logGroups" (rawinput1249945 "logGroups"), "nextToken" (rawinput1249945 "nextToken")}] (clojure.core/cond-> {} (letvar1249947 "logGroups") (clojure.core/assoc :log-groups (deser-log-groups (clojure.core/get-in letvar1249947 ["logGroups"]))) (letvar1249947 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1249947 ["nextToken"])))))))

(clojure.core/defn- response-get-query-results-response ([input] (response-get-query-results-response nil input)) ([resultWrapper1249949 input] (clojure.core/let [rawinput1249948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249950 {"results" (rawinput1249948 "results"), "statistics" (rawinput1249948 "statistics"), "status" (rawinput1249948 "status")}] (clojure.core/cond-> {} (letvar1249950 "results") (clojure.core/assoc :results (deser-query-results (clojure.core/get-in letvar1249950 ["results"]))) (letvar1249950 "statistics") (clojure.core/assoc :statistics (deser-query-statistics (clojure.core/get-in letvar1249950 ["statistics"]))) (letvar1249950 "status") (clojure.core/assoc :status (deser-query-status (clojure.core/get-in letvar1249950 ["status"])))))))

(clojure.core/defn- response-list-tags-log-group-response ([input] (response-list-tags-log-group-response nil input)) ([resultWrapper1249952 input] (clojure.core/let [rawinput1249951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249953 {"tags" (rawinput1249951 "tags")}] (clojure.core/cond-> {} (letvar1249953 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1249953 ["tags"])))))))

(clojure.core/defn- response-put-destination-response ([input] (response-put-destination-response nil input)) ([resultWrapper1249955 input] (clojure.core/let [rawinput1249954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249956 {"destination" (rawinput1249954 "destination")}] (clojure.core/cond-> {} (letvar1249956 "destination") (clojure.core/assoc :destination (deser-destination (clojure.core/get-in letvar1249956 ["destination"])))))))

(clojure.core/defn- response-get-log-events-response ([input] (response-get-log-events-response nil input)) ([resultWrapper1249958 input] (clojure.core/let [rawinput1249957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249959 {"events" (rawinput1249957 "events"), "nextForwardToken" (rawinput1249957 "nextForwardToken"), "nextBackwardToken" (rawinput1249957 "nextBackwardToken")}] (clojure.core/cond-> {} (letvar1249959 "events") (clojure.core/assoc :events (deser-output-log-events (clojure.core/get-in letvar1249959 ["events"]))) (letvar1249959 "nextForwardToken") (clojure.core/assoc :next-forward-token (deser-next-token (clojure.core/get-in letvar1249959 ["nextForwardToken"]))) (letvar1249959 "nextBackwardToken") (clojure.core/assoc :next-backward-token (deser-next-token (clojure.core/get-in letvar1249959 ["nextBackwardToken"])))))))

(clojure.core/defn- response-get-log-record-response ([input] (response-get-log-record-response nil input)) ([resultWrapper1249961 input] (clojure.core/let [rawinput1249960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249962 {"logRecord" (rawinput1249960 "logRecord")}] (clojure.core/cond-> {} (letvar1249962 "logRecord") (clojure.core/assoc :log-record (deser-log-record (clojure.core/get-in letvar1249962 ["logRecord"])))))))

(clojure.core/defn- response-malformed-query-exception ([input] (response-malformed-query-exception nil input)) ([resultWrapper1249964 input] (clojure.core/let [rawinput1249963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249965 {"queryCompileError" (rawinput1249963 "queryCompileError")}] (clojure.core/cond-> {} (letvar1249965 "queryCompileError") (clojure.core/assoc :query-compile-error (deser-query-compile-error (clojure.core/get-in letvar1249965 ["queryCompileError"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1249967 input] (clojure.core/let [rawinput1249966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249968 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1249970 input] (clojure.core/let [rawinput1249969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249971 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1249973 input] (clojure.core/let [rawinput1249972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249974 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1249976 input] (clojure.core/let [rawinput1249975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249977 {"exportTasks" (rawinput1249975 "exportTasks"), "nextToken" (rawinput1249975 "nextToken")}] (clojure.core/cond-> {} (letvar1249977 "exportTasks") (clojure.core/assoc :export-tasks (deser-export-tasks (clojure.core/get-in letvar1249977 ["exportTasks"]))) (letvar1249977 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1249977 ["nextToken"])))))))

(clojure.core/defn- response-operation-aborted-exception ([input] (response-operation-aborted-exception nil input)) ([resultWrapper1249979 input] (clojure.core/let [rawinput1249978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249980 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-log-events-response ([input] (response-put-log-events-response nil input)) ([resultWrapper1249982 input] (clojure.core/let [rawinput1249981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249983 {"nextSequenceToken" (rawinput1249981 "nextSequenceToken"), "rejectedLogEventsInfo" (rawinput1249981 "rejectedLogEventsInfo")}] (clojure.core/cond-> {} (letvar1249983 "nextSequenceToken") (clojure.core/assoc :next-sequence-token (deser-sequence-token (clojure.core/get-in letvar1249983 ["nextSequenceToken"]))) (letvar1249983 "rejectedLogEventsInfo") (clojure.core/assoc :rejected-log-events-info (deser-rejected-log-events-info (clojure.core/get-in letvar1249983 ["rejectedLogEventsInfo"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1249985 input] (clojure.core/let [rawinput1249984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249986 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unrecognized-client-exception ([input] (response-unrecognized-client-exception nil input)) ([resultWrapper1249988 input] (clojure.core/let [rawinput1249987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249989 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1249991 input] (clojure.core/let [rawinput1249990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249992 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-log-group-fields-response ([input] (response-get-log-group-fields-response nil input)) ([resultWrapper1249994 input] (clojure.core/let [rawinput1249993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249995 {"logGroupFields" (rawinput1249993 "logGroupFields")}] (clojure.core/cond-> {} (letvar1249995 "logGroupFields") (clojure.core/assoc :log-group-fields (deser-log-group-field-list (clojure.core/get-in letvar1249995 ["logGroupFields"])))))))

(clojure.core/defn- response-describe-subscription-filters-response ([input] (response-describe-subscription-filters-response nil input)) ([resultWrapper1249997 input] (clojure.core/let [rawinput1249996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1249998 {"subscriptionFilters" (rawinput1249996 "subscriptionFilters"), "nextToken" (rawinput1249996 "nextToken")}] (clojure.core/cond-> {} (letvar1249998 "subscriptionFilters") (clojure.core/assoc :subscription-filters (deser-subscription-filters (clojure.core/get-in letvar1249998 ["subscriptionFilters"]))) (letvar1249998 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1249998 ["nextToken"])))))))

(clojure.core/defn- response-describe-destinations-response ([input] (response-describe-destinations-response nil input)) ([resultWrapper1250000 input] (clojure.core/let [rawinput1249999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250001 {"destinations" (rawinput1249999 "destinations"), "nextToken" (rawinput1249999 "nextToken")}] (clojure.core/cond-> {} (letvar1250001 "destinations") (clojure.core/assoc :destinations (deser-destinations (clojure.core/get-in letvar1250001 ["destinations"]))) (letvar1250001 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250001 ["nextToken"])))))))

(clojure.core/defn- response-test-metric-filter-response ([input] (response-test-metric-filter-response nil input)) ([resultWrapper1250003 input] (clojure.core/let [rawinput1250002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250004 {"matches" (rawinput1250002 "matches")}] (clojure.core/cond-> {} (letvar1250004 "matches") (clojure.core/assoc :matches (deser-metric-filter-matches (clojure.core/get-in letvar1250004 ["matches"])))))))

(clojure.core/defn- response-start-query-response ([input] (response-start-query-response nil input)) ([resultWrapper1250006 input] (clojure.core/let [rawinput1250005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250007 {"queryId" (rawinput1250005 "queryId")}] (clojure.core/cond-> {} (letvar1250007 "queryId") (clojure.core/assoc :query-id (deser-query-id (clojure.core/get-in letvar1250007 ["queryId"])))))))

(clojure.core/defn- response-put-resource-policy-response ([input] (response-put-resource-policy-response nil input)) ([resultWrapper1250009 input] (clojure.core/let [rawinput1250008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250010 {"resourcePolicy" (rawinput1250008 "resourcePolicy")}] (clojure.core/cond-> {} (letvar1250010 "resourcePolicy") (clojure.core/assoc :resource-policy (deser-resource-policy (clojure.core/get-in letvar1250010 ["resourcePolicy"])))))))

(clojure.core/defn- response-describe-resource-policies-response ([input] (response-describe-resource-policies-response nil input)) ([resultWrapper1250012 input] (clojure.core/let [rawinput1250011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250013 {"resourcePolicies" (rawinput1250011 "resourcePolicies"), "nextToken" (rawinput1250011 "nextToken")}] (clojure.core/cond-> {} (letvar1250013 "resourcePolicies") (clojure.core/assoc :resource-policies (deser-resource-policies (clojure.core/get-in letvar1250013 ["resourcePolicies"]))) (letvar1250013 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250013 ["nextToken"])))))))

(clojure.core/defn- response-describe-queries-response ([input] (response-describe-queries-response nil input)) ([resultWrapper1250015 input] (clojure.core/let [rawinput1250014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250016 {"queries" (rawinput1250014 "queries"), "nextToken" (rawinput1250014 "nextToken")}] (clojure.core/cond-> {} (letvar1250016 "queries") (clojure.core/assoc :queries (deser-query-info-list (clojure.core/get-in letvar1250016 ["queries"]))) (letvar1250016 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250016 ["nextToken"])))))))

(clojure.core/defn- response-describe-log-streams-response ([input] (response-describe-log-streams-response nil input)) ([resultWrapper1250018 input] (clojure.core/let [rawinput1250017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250019 {"logStreams" (rawinput1250017 "logStreams"), "nextToken" (rawinput1250017 "nextToken")}] (clojure.core/cond-> {} (letvar1250019 "logStreams") (clojure.core/assoc :log-streams (deser-log-streams (clojure.core/get-in letvar1250019 ["logStreams"]))) (letvar1250019 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250019 ["nextToken"])))))))

(clojure.core/defn- response-data-already-accepted-exception ([input] (response-data-already-accepted-exception nil input)) ([resultWrapper1250021 input] (clojure.core/let [rawinput1250020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250022 {"expectedSequenceToken" (rawinput1250020 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1250022 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1250022 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-filter-log-events-response ([input] (response-filter-log-events-response nil input)) ([resultWrapper1250024 input] (clojure.core/let [rawinput1250023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250025 {"events" (rawinput1250023 "events"), "searchedLogStreams" (rawinput1250023 "searchedLogStreams"), "nextToken" (rawinput1250023 "nextToken")}] (clojure.core/cond-> {} (letvar1250025 "events") (clojure.core/assoc :events (deser-filtered-log-events (clojure.core/get-in letvar1250025 ["events"]))) (letvar1250025 "searchedLogStreams") (clojure.core/assoc :searched-log-streams (deser-searched-log-streams (clojure.core/get-in letvar1250025 ["searchedLogStreams"]))) (letvar1250025 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250025 ["nextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1250027 input] (clojure.core/let [rawinput1250026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250028 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-sequence-token-exception ([input] (response-invalid-sequence-token-exception nil input)) ([resultWrapper1250030 input] (clojure.core/let [rawinput1250029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250031 {"expectedSequenceToken" (rawinput1250029 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1250031 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1250031 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-stop-query-response ([input] (response-stop-query-response nil input)) ([resultWrapper1250033 input] (clojure.core/let [rawinput1250032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250034 {"success" (rawinput1250032 "success")}] (clojure.core/cond-> {} (letvar1250034 "success") (clojure.core/assoc :success (deser-success (clojure.core/get-in letvar1250034 ["success"])))))))

(clojure.core/defn- response-describe-metric-filters-response ([input] (response-describe-metric-filters-response nil input)) ([resultWrapper1250036 input] (clojure.core/let [rawinput1250035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250037 {"metricFilters" (rawinput1250035 "metricFilters"), "nextToken" (rawinput1250035 "nextToken")}] (clojure.core/cond-> {} (letvar1250037 "metricFilters") (clojure.core/assoc :metric-filters (deser-metric-filters (clojure.core/get-in letvar1250037 ["metricFilters"]))) (letvar1250037 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1250037 ["nextToken"])))))))

(clojure.core/defn- response-create-export-task-response ([input] (response-create-export-task-response nil input)) ([resultWrapper1250039 input] (clojure.core/let [rawinput1250038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1250040 {"taskId" (rawinput1250038 "taskId")}] (clojure.core/cond-> {} (letvar1250040 "taskId") (clojure.core/assoc :task-id (deser-export-task-id (clojure.core/get-in letvar1250040 ["taskId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.logs/event-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/filter-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.logs/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))

(clojure.spec.alpha/def :portkey.aws.logs/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]+)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))

(clojure.spec.alpha/def :portkey.aws.logs/log-groups (clojure.spec.alpha/coll-of :portkey.aws.logs/log-group))

(clojure.spec.alpha/def :portkey.aws.logs/query-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.logs/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.logs/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/access-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/destination-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/log-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:*]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.logs/policy-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5120))))
...
(clojure.spec.alpha/def :portkey.aws.logs/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.logs/log-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\.\-_/#A-Za-z0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.logs/sequence-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:*$]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:*$]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/destination-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:*]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^:*]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-destination-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
