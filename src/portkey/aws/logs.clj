...
(clojure.core/defn- response-describe-log-groups-response ([input] (response-describe-log-groups-response nil input)) ([resultWrapper1888119 input] (clojure.core/let [rawinput1888118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888120 {"logGroups" (rawinput1888118 "logGroups"), "nextToken" (rawinput1888118 "nextToken")}] (clojure.core/cond-> {} (letvar1888120 "logGroups") (clojure.core/assoc :log-groups (deser-log-groups (clojure.core/get-in letvar1888120 ["logGroups"]))) (letvar1888120 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888120 ["nextToken"])))))))

(clojure.core/defn- response-get-query-results-response ([input] (response-get-query-results-response nil input)) ([resultWrapper1888122 input] (clojure.core/let [rawinput1888121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888123 {"results" (rawinput1888121 "results"), "statistics" (rawinput1888121 "statistics"), "status" (rawinput1888121 "status")}] (clojure.core/cond-> {} (letvar1888123 "results") (clojure.core/assoc :results (deser-query-results (clojure.core/get-in letvar1888123 ["results"]))) (letvar1888123 "statistics") (clojure.core/assoc :statistics (deser-query-statistics (clojure.core/get-in letvar1888123 ["statistics"]))) (letvar1888123 "status") (clojure.core/assoc :status (deser-query-status (clojure.core/get-in letvar1888123 ["status"])))))))

(clojure.core/defn- response-list-tags-log-group-response ([input] (response-list-tags-log-group-response nil input)) ([resultWrapper1888125 input] (clojure.core/let [rawinput1888124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888126 {"tags" (rawinput1888124 "tags")}] (clojure.core/cond-> {} (letvar1888126 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1888126 ["tags"])))))))

(clojure.core/defn- response-put-destination-response ([input] (response-put-destination-response nil input)) ([resultWrapper1888128 input] (clojure.core/let [rawinput1888127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888129 {"destination" (rawinput1888127 "destination")}] (clojure.core/cond-> {} (letvar1888129 "destination") (clojure.core/assoc :destination (deser-destination (clojure.core/get-in letvar1888129 ["destination"])))))))

(clojure.core/defn- response-get-log-events-response ([input] (response-get-log-events-response nil input)) ([resultWrapper1888131 input] (clojure.core/let [rawinput1888130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888132 {"events" (rawinput1888130 "events"), "nextForwardToken" (rawinput1888130 "nextForwardToken"), "nextBackwardToken" (rawinput1888130 "nextBackwardToken")}] (clojure.core/cond-> {} (letvar1888132 "events") (clojure.core/assoc :events (deser-output-log-events (clojure.core/get-in letvar1888132 ["events"]))) (letvar1888132 "nextForwardToken") (clojure.core/assoc :next-forward-token (deser-next-token (clojure.core/get-in letvar1888132 ["nextForwardToken"]))) (letvar1888132 "nextBackwardToken") (clojure.core/assoc :next-backward-token (deser-next-token (clojure.core/get-in letvar1888132 ["nextBackwardToken"])))))))

(clojure.core/defn- response-get-log-record-response ([input] (response-get-log-record-response nil input)) ([resultWrapper1888134 input] (clojure.core/let [rawinput1888133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888135 {"logRecord" (rawinput1888133 "logRecord")}] (clojure.core/cond-> {} (letvar1888135 "logRecord") (clojure.core/assoc :log-record (deser-log-record (clojure.core/get-in letvar1888135 ["logRecord"])))))))

(clojure.core/defn- response-malformed-query-exception ([input] (response-malformed-query-exception nil input)) ([resultWrapper1888137 input] (clojure.core/let [rawinput1888136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888138 {"queryCompileError" (rawinput1888136 "queryCompileError")}] (clojure.core/cond-> {} (letvar1888138 "queryCompileError") (clojure.core/assoc :query-compile-error (deser-query-compile-error (clojure.core/get-in letvar1888138 ["queryCompileError"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1888140 input] (clojure.core/let [rawinput1888139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888141 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1888143 input] (clojure.core/let [rawinput1888142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888144 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1888146 input] (clojure.core/let [rawinput1888145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888147 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-export-tasks-response ([input] (response-describe-export-tasks-response nil input)) ([resultWrapper1888149 input] (clojure.core/let [rawinput1888148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888150 {"exportTasks" (rawinput1888148 "exportTasks"), "nextToken" (rawinput1888148 "nextToken")}] (clojure.core/cond-> {} (letvar1888150 "exportTasks") (clojure.core/assoc :export-tasks (deser-export-tasks (clojure.core/get-in letvar1888150 ["exportTasks"]))) (letvar1888150 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888150 ["nextToken"])))))))

(clojure.core/defn- response-operation-aborted-exception ([input] (response-operation-aborted-exception nil input)) ([resultWrapper1888152 input] (clojure.core/let [rawinput1888151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888153 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-log-events-response ([input] (response-put-log-events-response nil input)) ([resultWrapper1888155 input] (clojure.core/let [rawinput1888154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888156 {"nextSequenceToken" (rawinput1888154 "nextSequenceToken"), "rejectedLogEventsInfo" (rawinput1888154 "rejectedLogEventsInfo")}] (clojure.core/cond-> {} (letvar1888156 "nextSequenceToken") (clojure.core/assoc :next-sequence-token (deser-sequence-token (clojure.core/get-in letvar1888156 ["nextSequenceToken"]))) (letvar1888156 "rejectedLogEventsInfo") (clojure.core/assoc :rejected-log-events-info (deser-rejected-log-events-info (clojure.core/get-in letvar1888156 ["rejectedLogEventsInfo"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1888158 input] (clojure.core/let [rawinput1888157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888159 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unrecognized-client-exception ([input] (response-unrecognized-client-exception nil input)) ([resultWrapper1888161 input] (clojure.core/let [rawinput1888160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888162 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1888164 input] (clojure.core/let [rawinput1888163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888165 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-log-group-fields-response ([input] (response-get-log-group-fields-response nil input)) ([resultWrapper1888167 input] (clojure.core/let [rawinput1888166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888168 {"logGroupFields" (rawinput1888166 "logGroupFields")}] (clojure.core/cond-> {} (letvar1888168 "logGroupFields") (clojure.core/assoc :log-group-fields (deser-log-group-field-list (clojure.core/get-in letvar1888168 ["logGroupFields"])))))))

(clojure.core/defn- response-describe-subscription-filters-response ([input] (response-describe-subscription-filters-response nil input)) ([resultWrapper1888170 input] (clojure.core/let [rawinput1888169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888171 {"subscriptionFilters" (rawinput1888169 "subscriptionFilters"), "nextToken" (rawinput1888169 "nextToken")}] (clojure.core/cond-> {} (letvar1888171 "subscriptionFilters") (clojure.core/assoc :subscription-filters (deser-subscription-filters (clojure.core/get-in letvar1888171 ["subscriptionFilters"]))) (letvar1888171 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888171 ["nextToken"])))))))

(clojure.core/defn- response-describe-destinations-response ([input] (response-describe-destinations-response nil input)) ([resultWrapper1888173 input] (clojure.core/let [rawinput1888172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888174 {"destinations" (rawinput1888172 "destinations"), "nextToken" (rawinput1888172 "nextToken")}] (clojure.core/cond-> {} (letvar1888174 "destinations") (clojure.core/assoc :destinations (deser-destinations (clojure.core/get-in letvar1888174 ["destinations"]))) (letvar1888174 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888174 ["nextToken"])))))))

(clojure.core/defn- response-test-metric-filter-response ([input] (response-test-metric-filter-response nil input)) ([resultWrapper1888176 input] (clojure.core/let [rawinput1888175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888177 {"matches" (rawinput1888175 "matches")}] (clojure.core/cond-> {} (letvar1888177 "matches") (clojure.core/assoc :matches (deser-metric-filter-matches (clojure.core/get-in letvar1888177 ["matches"])))))))

(clojure.core/defn- response-start-query-response ([input] (response-start-query-response nil input)) ([resultWrapper1888179 input] (clojure.core/let [rawinput1888178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888180 {"queryId" (rawinput1888178 "queryId")}] (clojure.core/cond-> {} (letvar1888180 "queryId") (clojure.core/assoc :query-id (deser-query-id (clojure.core/get-in letvar1888180 ["queryId"])))))))

(clojure.core/defn- response-put-resource-policy-response ([input] (response-put-resource-policy-response nil input)) ([resultWrapper1888182 input] (clojure.core/let [rawinput1888181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888183 {"resourcePolicy" (rawinput1888181 "resourcePolicy")}] (clojure.core/cond-> {} (letvar1888183 "resourcePolicy") (clojure.core/assoc :resource-policy (deser-resource-policy (clojure.core/get-in letvar1888183 ["resourcePolicy"])))))))

(clojure.core/defn- response-describe-resource-policies-response ([input] (response-describe-resource-policies-response nil input)) ([resultWrapper1888185 input] (clojure.core/let [rawinput1888184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888186 {"resourcePolicies" (rawinput1888184 "resourcePolicies"), "nextToken" (rawinput1888184 "nextToken")}] (clojure.core/cond-> {} (letvar1888186 "resourcePolicies") (clojure.core/assoc :resource-policies (deser-resource-policies (clojure.core/get-in letvar1888186 ["resourcePolicies"]))) (letvar1888186 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888186 ["nextToken"])))))))

(clojure.core/defn- response-describe-queries-response ([input] (response-describe-queries-response nil input)) ([resultWrapper1888188 input] (clojure.core/let [rawinput1888187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888189 {"queries" (rawinput1888187 "queries"), "nextToken" (rawinput1888187 "nextToken")}] (clojure.core/cond-> {} (letvar1888189 "queries") (clojure.core/assoc :queries (deser-query-info-list (clojure.core/get-in letvar1888189 ["queries"]))) (letvar1888189 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888189 ["nextToken"])))))))

(clojure.core/defn- response-describe-log-streams-response ([input] (response-describe-log-streams-response nil input)) ([resultWrapper1888191 input] (clojure.core/let [rawinput1888190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888192 {"logStreams" (rawinput1888190 "logStreams"), "nextToken" (rawinput1888190 "nextToken")}] (clojure.core/cond-> {} (letvar1888192 "logStreams") (clojure.core/assoc :log-streams (deser-log-streams (clojure.core/get-in letvar1888192 ["logStreams"]))) (letvar1888192 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888192 ["nextToken"])))))))

(clojure.core/defn- response-data-already-accepted-exception ([input] (response-data-already-accepted-exception nil input)) ([resultWrapper1888194 input] (clojure.core/let [rawinput1888193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888195 {"expectedSequenceToken" (rawinput1888193 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1888195 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1888195 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-filter-log-events-response ([input] (response-filter-log-events-response nil input)) ([resultWrapper1888197 input] (clojure.core/let [rawinput1888196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888198 {"events" (rawinput1888196 "events"), "searchedLogStreams" (rawinput1888196 "searchedLogStreams"), "nextToken" (rawinput1888196 "nextToken")}] (clojure.core/cond-> {} (letvar1888198 "events") (clojure.core/assoc :events (deser-filtered-log-events (clojure.core/get-in letvar1888198 ["events"]))) (letvar1888198 "searchedLogStreams") (clojure.core/assoc :searched-log-streams (deser-searched-log-streams (clojure.core/get-in letvar1888198 ["searchedLogStreams"]))) (letvar1888198 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888198 ["nextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1888200 input] (clojure.core/let [rawinput1888199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888201 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-sequence-token-exception ([input] (response-invalid-sequence-token-exception nil input)) ([resultWrapper1888203 input] (clojure.core/let [rawinput1888202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888204 {"expectedSequenceToken" (rawinput1888202 "expectedSequenceToken")}] (clojure.core/cond-> {} (letvar1888204 "expectedSequenceToken") (clojure.core/assoc :expected-sequence-token (deser-sequence-token (clojure.core/get-in letvar1888204 ["expectedSequenceToken"])))))))

(clojure.core/defn- response-stop-query-response ([input] (response-stop-query-response nil input)) ([resultWrapper1888206 input] (clojure.core/let [rawinput1888205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888207 {"success" (rawinput1888205 "success")}] (clojure.core/cond-> {} (letvar1888207 "success") (clojure.core/assoc :success (deser-success (clojure.core/get-in letvar1888207 ["success"])))))))

(clojure.core/defn- response-describe-metric-filters-response ([input] (response-describe-metric-filters-response nil input)) ([resultWrapper1888209 input] (clojure.core/let [rawinput1888208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888210 {"metricFilters" (rawinput1888208 "metricFilters"), "nextToken" (rawinput1888208 "nextToken")}] (clojure.core/cond-> {} (letvar1888210 "metricFilters") (clojure.core/assoc :metric-filters (deser-metric-filters (clojure.core/get-in letvar1888210 ["metricFilters"]))) (letvar1888210 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1888210 ["nextToken"])))))))

(clojure.core/defn- response-create-export-task-response ([input] (response-create-export-task-response nil input)) ([resultWrapper1888212 input] (clojure.core/let [rawinput1888211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1888213 {"taskId" (rawinput1888211 "taskId")}] (clojure.core/cond-> {} (letvar1888213 "taskId") (clojure.core/assoc :task-id (deser-export-task-id (clojure.core/get-in letvar1888213 ["taskId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.logs/event-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/filter-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.logs/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.logs/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]+)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))

(clojure.spec.alpha/def :portkey.aws.logs/log-groups (clojure.spec.alpha/coll-of :portkey.aws.logs/log-group))

(clojure.spec.alpha/def :portkey.aws.logs/query-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.logs/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.logs/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/access-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/destination-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/log-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.logs/policy-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 5120))))
...
(clojure.spec.alpha/def :portkey.aws.logs/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-task-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.logs/log-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\.\-_/#A-Za-z0-9]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.logs/sequence-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*$]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/metric-namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*$]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/destination-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.logs/export-destination-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
