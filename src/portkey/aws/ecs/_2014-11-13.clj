...
(clojure.core/defn- response-cluster-not-found-exception ([input] (response-cluster-not-found-exception nil input)) ([resultWrapper828577 input] (clojure.core/let [rawinput828576 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828578 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-tasks-response ([input] (response-describe-tasks-response nil input)) ([resultWrapper828580 input] (clojure.core/let [rawinput828579 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828581 {"tasks" (rawinput828579 "tasks"), "failures" (rawinput828579 "failures")}] (clojure.core/cond-> {} (letvar828581 "tasks") (clojure.core/assoc :tasks (deser-tasks (clojure.core/get-in letvar828581 ["tasks"]))) (letvar828581 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828581 ["failures"])))))))

(clojure.core/defn- response-list-tasks-response ([input] (response-list-tasks-response nil input)) ([resultWrapper828583 input] (clojure.core/let [rawinput828582 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828584 {"taskArns" (rawinput828582 "taskArns"), "nextToken" (rawinput828582 "nextToken")}] (clojure.core/cond-> {} (letvar828584 "taskArns") (clojure.core/assoc :task-arns (deser-string-list (clojure.core/get-in letvar828584 ["taskArns"]))) (letvar828584 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828584 ["nextToken"])))))))

(clojure.core/defn- response-update-container-agent-response ([input] (response-update-container-agent-response nil input)) ([resultWrapper828586 input] (clojure.core/let [rawinput828585 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828587 {"containerInstance" (rawinput828585 "containerInstance")}] (clojure.core/cond-> {} (letvar828587 "containerInstance") (clojure.core/assoc :container-instance (deser-container-instance (clojure.core/get-in letvar828587 ["containerInstance"])))))))

(clojure.core/defn- response-no-update-available-exception ([input] (response-no-update-available-exception nil input)) ([resultWrapper828589 input] (clojure.core/let [rawinput828588 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828590 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-container-instances-response ([input] (response-describe-container-instances-response nil input)) ([resultWrapper828592 input] (clojure.core/let [rawinput828591 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828593 {"containerInstances" (rawinput828591 "containerInstances"), "failures" (rawinput828591 "failures")}] (clojure.core/cond-> {} (letvar828593 "containerInstances") (clojure.core/assoc :container-instances (deser-container-instances (clojure.core/get-in letvar828593 ["containerInstances"]))) (letvar828593 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828593 ["failures"])))))))

(clojure.core/defn- response-deregister-container-instance-response ([input] (response-deregister-container-instance-response nil input)) ([resultWrapper828595 input] (clojure.core/let [rawinput828594 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828596 {"containerInstance" (rawinput828594 "containerInstance")}] (clojure.core/cond-> {} (letvar828596 "containerInstance") (clojure.core/assoc :container-instance (deser-container-instance (clojure.core/get-in letvar828596 ["containerInstance"])))))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper828598 input] (clojure.core/let [rawinput828597 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828599 {"message" (rawinput828597 "message")}] (clojure.core/cond-> {} (letvar828599 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar828599 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper828601 input] (clojure.core/let [rawinput828600 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828602 {"tags" (rawinput828600 "tags")}] (clojure.core/cond-> {} (letvar828602 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar828602 ["tags"])))))))

(clojure.core/defn- response-register-container-instance-response ([input] (response-register-container-instance-response nil input)) ([resultWrapper828604 input] (clojure.core/let [rawinput828603 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828605 {"containerInstance" (rawinput828603 "containerInstance")}] (clojure.core/cond-> {} (letvar828605 "containerInstance") (clojure.core/assoc :container-instance (deser-container-instance (clojure.core/get-in letvar828605 ["containerInstance"])))))))

(clojure.core/defn- response-list-clusters-response ([input] (response-list-clusters-response nil input)) ([resultWrapper828607 input] (clojure.core/let [rawinput828606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828608 {"clusterArns" (rawinput828606 "clusterArns"), "nextToken" (rawinput828606 "nextToken")}] (clojure.core/cond-> {} (letvar828608 "clusterArns") (clojure.core/assoc :cluster-arns (deser-string-list (clojure.core/get-in letvar828608 ["clusterArns"]))) (letvar828608 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828608 ["nextToken"])))))))

(clojure.core/defn- response-stop-task-response ([input] (response-stop-task-response nil input)) ([resultWrapper828610 input] (clojure.core/let [rawinput828609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828611 {"task" (rawinput828609 "task")}] (clojure.core/cond-> {} (letvar828611 "task") (clojure.core/assoc :task (deser-task (clojure.core/get-in letvar828611 ["task"])))))))

(clojure.core/defn- response-describe-clusters-response ([input] (response-describe-clusters-response nil input)) ([resultWrapper828613 input] (clojure.core/let [rawinput828612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828614 {"clusters" (rawinput828612 "clusters"), "failures" (rawinput828612 "failures")}] (clojure.core/cond-> {} (letvar828614 "clusters") (clojure.core/assoc :clusters (deser-clusters (clojure.core/get-in letvar828614 ["clusters"]))) (letvar828614 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828614 ["failures"])))))))

(clojure.core/defn- response-run-task-response ([input] (response-run-task-response nil input)) ([resultWrapper828616 input] (clojure.core/let [rawinput828615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828617 {"tasks" (rawinput828615 "tasks"), "failures" (rawinput828615 "failures")}] (clojure.core/cond-> {} (letvar828617 "tasks") (clojure.core/assoc :tasks (deser-tasks (clojure.core/get-in letvar828617 ["tasks"]))) (letvar828617 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828617 ["failures"])))))))

(clojure.core/defn- response-delete-service-response ([input] (response-delete-service-response nil input)) ([resultWrapper828619 input] (clojure.core/let [rawinput828618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828620 {"service" (rawinput828618 "service")}] (clojure.core/cond-> {} (letvar828620 "service") (clojure.core/assoc :service (deser-service (clojure.core/get-in letvar828620 ["service"])))))))

(clojure.core/defn- response-blocked-exception ([input] (response-blocked-exception nil input)) ([resultWrapper828622 input] (clojure.core/let [rawinput828621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828623 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-attributes-response ([input] (response-delete-attributes-response nil input)) ([resultWrapper828625 input] (clojure.core/let [rawinput828624 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828626 {"attributes" (rawinput828624 "attributes")}] (clojure.core/cond-> {} (letvar828626 "attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar828626 ["attributes"])))))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper828628 input] (clojure.core/let [rawinput828627 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828629 {"cluster" (rawinput828627 "cluster")}] (clojure.core/cond-> {} (letvar828629 "cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar828629 ["cluster"])))))))

(clojure.core/defn- response-service-not-active-exception ([input] (response-service-not-active-exception nil input)) ([resultWrapper828631 input] (clojure.core/let [rawinput828630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828632 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-attributes-response ([input] (response-list-attributes-response nil input)) ([resultWrapper828634 input] (clojure.core/let [rawinput828633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828635 {"attributes" (rawinput828633 "attributes"), "nextToken" (rawinput828633 "nextToken")}] (clojure.core/cond-> {} (letvar828635 "attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar828635 ["attributes"]))) (letvar828635 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828635 ["nextToken"])))))))

(clojure.core/defn- response-unsupported-feature-exception ([input] (response-unsupported-feature-exception nil input)) ([resultWrapper828637 input] (clojure.core/let [rawinput828636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828638 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-not-found-exception ([input] (response-service-not-found-exception nil input)) ([resultWrapper828640 input] (clojure.core/let [rawinput828639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828641 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-platform-unknown-exception ([input] (response-platform-unknown-exception nil input)) ([resultWrapper828643 input] (clojure.core/let [rawinput828642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828644 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper828646 input] (clojure.core/let [rawinput828645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828647 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-task-definitions-response ([input] (response-list-task-definitions-response nil input)) ([resultWrapper828649 input] (clojure.core/let [rawinput828648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828650 {"taskDefinitionArns" (rawinput828648 "taskDefinitionArns"), "nextToken" (rawinput828648 "nextToken")}] (clojure.core/cond-> {} (letvar828650 "taskDefinitionArns") (clojure.core/assoc :task-definition-arns (deser-string-list (clojure.core/get-in letvar828650 ["taskDefinitionArns"]))) (letvar828650 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828650 ["nextToken"])))))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper828652 input] (clojure.core/let [rawinput828651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828653 {"cluster" (rawinput828651 "cluster")}] (clojure.core/cond-> {} (letvar828653 "cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar828653 ["cluster"])))))))

(clojure.core/defn- response-describe-task-definition-response ([input] (response-describe-task-definition-response nil input)) ([resultWrapper828655 input] (clojure.core/let [rawinput828654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828656 {"taskDefinition" (rawinput828654 "taskDefinition"), "tags" (rawinput828654 "tags")}] (clojure.core/cond-> {} (letvar828656 "taskDefinition") (clojure.core/assoc :task-definition (deser-task-definition (clojure.core/get-in letvar828656 ["taskDefinition"]))) (letvar828656 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar828656 ["tags"])))))))

(clojure.core/defn- response-delete-account-setting-response ([input] (response-delete-account-setting-response nil input)) ([resultWrapper828658 input] (clojure.core/let [rawinput828657 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828659 {"setting" (rawinput828657 "setting")}] (clojure.core/cond-> {} (letvar828659 "setting") (clojure.core/assoc :setting (deser-setting (clojure.core/get-in letvar828659 ["setting"])))))))

(clojure.core/defn- response-deregister-task-definition-response ([input] (response-deregister-task-definition-response nil input)) ([resultWrapper828661 input] (clojure.core/let [rawinput828660 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828662 {"taskDefinition" (rawinput828660 "taskDefinition")}] (clojure.core/cond-> {} (letvar828662 "taskDefinition") (clojure.core/assoc :task-definition (deser-task-definition (clojure.core/get-in letvar828662 ["taskDefinition"])))))))

(clojure.core/defn- response-describe-services-response ([input] (response-describe-services-response nil input)) ([resultWrapper828664 input] (clojure.core/let [rawinput828663 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828665 {"services" (rawinput828663 "services"), "failures" (rawinput828663 "failures")}] (clojure.core/cond-> {} (letvar828665 "services") (clojure.core/assoc :services (deser-services (clojure.core/get-in letvar828665 ["services"]))) (letvar828665 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828665 ["failures"])))))))

(clojure.core/defn- response-put-account-setting-response ([input] (response-put-account-setting-response nil input)) ([resultWrapper828667 input] (clojure.core/let [rawinput828666 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828668 {"setting" (rawinput828666 "setting")}] (clojure.core/cond-> {} (letvar828668 "setting") (clojure.core/assoc :setting (deser-setting (clojure.core/get-in letvar828668 ["setting"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper828670 input] (clojure.core/let [rawinput828669 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828671 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-container-instances-response ([input] (response-list-container-instances-response nil input)) ([resultWrapper828673 input] (clojure.core/let [rawinput828672 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828674 {"containerInstanceArns" (rawinput828672 "containerInstanceArns"), "nextToken" (rawinput828672 "nextToken")}] (clojure.core/cond-> {} (letvar828674 "containerInstanceArns") (clojure.core/assoc :container-instance-arns (deser-string-list (clojure.core/get-in letvar828674 ["containerInstanceArns"]))) (letvar828674 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828674 ["nextToken"])))))))

(clojure.core/defn- response-missing-version-exception ([input] (response-missing-version-exception nil input)) ([resultWrapper828676 input] (clojure.core/let [rawinput828675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828677 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-attribute-limit-exceeded-exception ([input] (response-attribute-limit-exceeded-exception nil input)) ([resultWrapper828679 input] (clojure.core/let [rawinput828678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828680 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-discover-poll-endpoint-response ([input] (response-discover-poll-endpoint-response nil input)) ([resultWrapper828682 input] (clojure.core/let [rawinput828681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828683 {"endpoint" (rawinput828681 "endpoint"), "telemetryEndpoint" (rawinput828681 "telemetryEndpoint")}] (clojure.core/cond-> {} (letvar828683 "endpoint") (clojure.core/assoc :endpoint (deser-string (clojure.core/get-in letvar828683 ["endpoint"]))) (letvar828683 "telemetryEndpoint") (clojure.core/assoc :telemetry-endpoint (deser-string (clojure.core/get-in letvar828683 ["telemetryEndpoint"])))))))

(clojure.core/defn- response-submit-task-state-change-response ([input] (response-submit-task-state-change-response nil input)) ([resultWrapper828685 input] (clojure.core/let [rawinput828684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828686 {"acknowledgment" (rawinput828684 "acknowledgment")}] (clojure.core/cond-> {} (letvar828686 "acknowledgment") (clojure.core/assoc :acknowledgment (deser-string (clojure.core/get-in letvar828686 ["acknowledgment"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper828688 input] (clojure.core/let [rawinput828687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828689 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cluster-contains-container-instances-exception ([input] (response-cluster-contains-container-instances-exception nil input)) ([resultWrapper828691 input] (clojure.core/let [rawinput828690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828692 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-platform-task-definition-incompatibility-exception ([input] (response-platform-task-definition-incompatibility-exception nil input)) ([resultWrapper828694 input] (clojure.core/let [rawinput828693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828695 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-services-response ([input] (response-list-services-response nil input)) ([resultWrapper828697 input] (clojure.core/let [rawinput828696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828698 {"serviceArns" (rawinput828696 "serviceArns"), "nextToken" (rawinput828696 "nextToken")}] (clojure.core/cond-> {} (letvar828698 "serviceArns") (clojure.core/assoc :service-arns (deser-string-list (clojure.core/get-in letvar828698 ["serviceArns"]))) (letvar828698 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828698 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper828700 input] (clojure.core/let [rawinput828699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828701 {"message" (rawinput828699 "message")}] (clojure.core/cond-> {} (letvar828701 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar828701 ["message"])))))))

(clojure.core/defn- response-list-account-settings-response ([input] (response-list-account-settings-response nil input)) ([resultWrapper828703 input] (clojure.core/let [rawinput828702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828704 {"settings" (rawinput828702 "settings"), "nextToken" (rawinput828702 "nextToken")}] (clojure.core/cond-> {} (letvar828704 "settings") (clojure.core/assoc :settings (deser-settings (clojure.core/get-in letvar828704 ["settings"]))) (letvar828704 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828704 ["nextToken"])))))))

(clojure.core/defn- response-update-service-response ([input] (response-update-service-response nil input)) ([resultWrapper828706 input] (clojure.core/let [rawinput828705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828707 {"service" (rawinput828705 "service")}] (clojure.core/cond-> {} (letvar828707 "service") (clojure.core/assoc :service (deser-service (clojure.core/get-in letvar828707 ["service"])))))))

(clojure.core/defn- response-cluster-contains-tasks-exception ([input] (response-cluster-contains-tasks-exception nil input)) ([resultWrapper828709 input] (clojure.core/let [rawinput828708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828710 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-task-response ([input] (response-start-task-response nil input)) ([resultWrapper828712 input] (clojure.core/let [rawinput828711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828713 {"tasks" (rawinput828711 "tasks"), "failures" (rawinput828711 "failures")}] (clojure.core/cond-> {} (letvar828713 "tasks") (clojure.core/assoc :tasks (deser-tasks (clojure.core/get-in letvar828713 ["tasks"]))) (letvar828713 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828713 ["failures"])))))))

(clojure.core/defn- response-register-task-definition-response ([input] (response-register-task-definition-response nil input)) ([resultWrapper828715 input] (clojure.core/let [rawinput828714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828716 {"taskDefinition" (rawinput828714 "taskDefinition"), "tags" (rawinput828714 "tags")}] (clojure.core/cond-> {} (letvar828716 "taskDefinition") (clojure.core/assoc :task-definition (deser-task-definition (clojure.core/get-in letvar828716 ["taskDefinition"]))) (letvar828716 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar828716 ["tags"])))))))

(clojure.core/defn- response-create-service-response ([input] (response-create-service-response nil input)) ([resultWrapper828718 input] (clojure.core/let [rawinput828717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828719 {"service" (rawinput828717 "service")}] (clojure.core/cond-> {} (letvar828719 "service") (clojure.core/assoc :service (deser-service (clojure.core/get-in letvar828719 ["service"])))))))

(clojure.core/defn- response-submit-container-state-change-response ([input] (response-submit-container-state-change-response nil input)) ([resultWrapper828721 input] (clojure.core/let [rawinput828720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828722 {"acknowledgment" (rawinput828720 "acknowledgment")}] (clojure.core/cond-> {} (letvar828722 "acknowledgment") (clojure.core/assoc :acknowledgment (deser-string (clojure.core/get-in letvar828722 ["acknowledgment"])))))))

(clojure.core/defn- response-target-not-found-exception ([input] (response-target-not-found-exception nil input)) ([resultWrapper828724 input] (clojure.core/let [rawinput828723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828725 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-task-definition-families-response ([input] (response-list-task-definition-families-response nil input)) ([resultWrapper828727 input] (clojure.core/let [rawinput828726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828728 {"families" (rawinput828726 "families"), "nextToken" (rawinput828726 "nextToken")}] (clojure.core/cond-> {} (letvar828728 "families") (clojure.core/assoc :families (deser-string-list (clojure.core/get-in letvar828728 ["families"]))) (letvar828728 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar828728 ["nextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper828730 input] (clojure.core/let [rawinput828729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828731 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper828733 input] (clojure.core/let [rawinput828732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828734 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-attributes-response ([input] (response-put-attributes-response nil input)) ([resultWrapper828736 input] (clojure.core/let [rawinput828735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828737 {"attributes" (rawinput828735 "attributes")}] (clojure.core/cond-> {} (letvar828737 "attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar828737 ["attributes"])))))))

(clojure.core/defn- response-cluster-contains-services-exception ([input] (response-cluster-contains-services-exception nil input)) ([resultWrapper828739 input] (clojure.core/let [rawinput828738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828740 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-in-progress-exception ([input] (response-update-in-progress-exception nil input)) ([resultWrapper828742 input] (clojure.core/let [rawinput828741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828743 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-account-setting-default-response ([input] (response-put-account-setting-default-response nil input)) ([resultWrapper828745 input] (clojure.core/let [rawinput828744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828746 {"setting" (rawinput828744 "setting")}] (clojure.core/cond-> {} (letvar828746 "setting") (clojure.core/assoc :setting (deser-setting (clojure.core/get-in letvar828746 ["setting"])))))))

(clojure.core/defn- response-update-container-instances-state-response ([input] (response-update-container-instances-state-response nil input)) ([resultWrapper828748 input] (clojure.core/let [rawinput828747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar828749 {"containerInstances" (rawinput828747 "containerInstances"), "failures" (rawinput828747 "failures")}] (clojure.core/cond-> {} (letvar828749 "containerInstances") (clojure.core/assoc :container-instances (deser-container-instances (clojure.core/get-in letvar828749 ["containerInstances"]))) (letvar828749 "failures") (clojure.core/assoc :failures (deser-failures (clojure.core/get-in letvar828749 ["failures"])))))))
...
(clojure.spec.alpha/def :portkey.aws.ecs.-2014-11-13/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ecs.-2014-11-13/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
