...
(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1228917 input] (clojure.core/let [rawinput1228916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228918 {"Tags" (rawinput1228916 "Tags")}] (clojure.core/cond-> {} (letvar1228918 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1228918 ["Tags"])))))))

(clojure.core/defn- response-update-license-specifications-for-resource-response ([input] (response-update-license-specifications-for-resource-response nil input)) ([resultWrapper1228920 input] (clojure.core/let [rawinput1228919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228921 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-authorization-exception ([input] (response-authorization-exception nil input)) ([resultWrapper1228923 input] (clojure.core/let [rawinput1228922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228924 {"Message" (rawinput1228922 "Message")}] (clojure.core/cond-> {} (letvar1228924 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228924 ["Message"])))))))

(clojure.core/defn- response-list-associations-for-license-configuration-response ([input] (response-list-associations-for-license-configuration-response nil input)) ([resultWrapper1228926 input] (clojure.core/let [rawinput1228925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228927 {"LicenseConfigurationAssociations" (rawinput1228925 "LicenseConfigurationAssociations"), "NextToken" (rawinput1228925 "NextToken")}] (clojure.core/cond-> {} (letvar1228927 "LicenseConfigurationAssociations") (clojure.core/assoc :license-configuration-associations (deser-license-configuration-associations (clojure.core/get-in letvar1228927 ["LicenseConfigurationAssociations"]))) (letvar1228927 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1228927 ["NextToken"])))))))

(clojure.core/defn- response-failed-dependency-exception ([input] (response-failed-dependency-exception nil input)) ([resultWrapper1228929 input] (clojure.core/let [rawinput1228928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228930 {"Message" (rawinput1228928 "Message")}] (clojure.core/cond-> {} (letvar1228930 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228930 ["Message"])))))))

(clojure.core/defn- response-get-service-settings-response ([input] (response-get-service-settings-response nil input)) ([resultWrapper1228932 input] (clojure.core/let [rawinput1228931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228933 {"S3BucketArn" (rawinput1228931 "S3BucketArn"), "SnsTopicArn" (rawinput1228931 "SnsTopicArn"), "OrganizationConfiguration" (rawinput1228931 "OrganizationConfiguration"), "EnableCrossAccountsDiscovery" (rawinput1228931 "EnableCrossAccountsDiscovery")}] (clojure.core/cond-> {} (letvar1228933 "S3BucketArn") (clojure.core/assoc :s-3-bucket-arn (deser-string (clojure.core/get-in letvar1228933 ["S3BucketArn"]))) (letvar1228933 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-string (clojure.core/get-in letvar1228933 ["SnsTopicArn"]))) (letvar1228933 "OrganizationConfiguration") (clojure.core/assoc :organization-configuration (deser-organization-configuration (clojure.core/get-in letvar1228933 ["OrganizationConfiguration"]))) (letvar1228933 "EnableCrossAccountsDiscovery") (clojure.core/assoc :enable-cross-accounts-discovery (deser-box-boolean (clojure.core/get-in letvar1228933 ["EnableCrossAccountsDiscovery"])))))))

(clojure.core/defn- response-list-license-configurations-response ([input] (response-list-license-configurations-response nil input)) ([resultWrapper1228935 input] (clojure.core/let [rawinput1228934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228936 {"LicenseConfigurations" (rawinput1228934 "LicenseConfigurations"), "NextToken" (rawinput1228934 "NextToken")}] (clojure.core/cond-> {} (letvar1228936 "LicenseConfigurations") (clojure.core/assoc :license-configurations (deser-license-configurations (clojure.core/get-in letvar1228936 ["LicenseConfigurations"]))) (letvar1228936 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1228936 ["NextToken"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1228938 input] (clojure.core/let [rawinput1228937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228939 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-filter-limit-exceeded-exception ([input] (response-filter-limit-exceeded-exception nil input)) ([resultWrapper1228941 input] (clojure.core/let [rawinput1228940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228942 {"Message" (rawinput1228940 "Message")}] (clojure.core/cond-> {} (letvar1228942 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228942 ["Message"])))))))

(clojure.core/defn- response-get-license-configuration-response ([input] (response-get-license-configuration-response nil input)) ([resultWrapper1228944 input] (clojure.core/let [rawinput1228943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228945 {"LicenseCount" (rawinput1228943 "LicenseCount"), "OwnerAccountId" (rawinput1228943 "OwnerAccountId"), "ManagedResourceSummaryList" (rawinput1228943 "ManagedResourceSummaryList"), "Tags" (rawinput1228943 "Tags"), "Status" (rawinput1228943 "Status"), "ConsumedLicenseSummaryList" (rawinput1228943 "ConsumedLicenseSummaryList"), "Description" (rawinput1228943 "Description"), "LicenseCountHardLimit" (rawinput1228943 "LicenseCountHardLimit"), "LicenseConfigurationArn" (rawinput1228943 "LicenseConfigurationArn"), "LicenseCountingType" (rawinput1228943 "LicenseCountingType"), "Name" (rawinput1228943 "Name"), "LicenseConfigurationId" (rawinput1228943 "LicenseConfigurationId"), "LicenseRules" (rawinput1228943 "LicenseRules"), "ConsumedLicenses" (rawinput1228943 "ConsumedLicenses")}] (clojure.core/cond-> {} (letvar1228945 "LicenseCount") (clojure.core/assoc :license-count (deser-box-long (clojure.core/get-in letvar1228945 ["LicenseCount"]))) (letvar1228945 "OwnerAccountId") (clojure.core/assoc :owner-account-id (deser-string (clojure.core/get-in letvar1228945 ["OwnerAccountId"]))) (letvar1228945 "ManagedResourceSummaryList") (clojure.core/assoc :managed-resource-summary-list (deser-managed-resource-summary-list (clojure.core/get-in letvar1228945 ["ManagedResourceSummaryList"]))) (letvar1228945 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1228945 ["Tags"]))) (letvar1228945 "Status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar1228945 ["Status"]))) (letvar1228945 "ConsumedLicenseSummaryList") (clojure.core/assoc :consumed-license-summary-list (deser-consumed-license-summary-list (clojure.core/get-in letvar1228945 ["ConsumedLicenseSummaryList"]))) (letvar1228945 "Description") (clojure.core/assoc :description (deser-string (clojure.core/get-in letvar1228945 ["Description"]))) (letvar1228945 "LicenseCountHardLimit") (clojure.core/assoc :license-count-hard-limit (deser-box-boolean (clojure.core/get-in letvar1228945 ["LicenseCountHardLimit"]))) (letvar1228945 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1228945 ["LicenseConfigurationArn"]))) (letvar1228945 "LicenseCountingType") (clojure.core/assoc :license-counting-type (deser-license-counting-type (clojure.core/get-in letvar1228945 ["LicenseCountingType"]))) (letvar1228945 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1228945 ["Name"]))) (letvar1228945 "LicenseConfigurationId") (clojure.core/assoc :license-configuration-id (deser-string (clojure.core/get-in letvar1228945 ["LicenseConfigurationId"]))) (letvar1228945 "LicenseRules") (clojure.core/assoc :license-rules (deser-string-list (clojure.core/get-in letvar1228945 ["LicenseRules"]))) (letvar1228945 "ConsumedLicenses") (clojure.core/assoc :consumed-licenses (deser-box-long (clojure.core/get-in letvar1228945 ["ConsumedLicenses"])))))))

(clojure.core/defn- response-rate-limit-exceeded-exception ([input] (response-rate-limit-exceeded-exception nil input)) ([resultWrapper1228947 input] (clojure.core/let [rawinput1228946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228948 {"Message" (rawinput1228946 "Message")}] (clojure.core/cond-> {} (letvar1228948 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228948 ["Message"])))))))

(clojure.core/defn- response-update-service-settings-response ([input] (response-update-service-settings-response nil input)) ([resultWrapper1228950 input] (clojure.core/let [rawinput1228949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228951 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1228953 input] (clojure.core/let [rawinput1228952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228954 {"Message" (rawinput1228952 "Message")}] (clojure.core/cond-> {} (letvar1228954 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228954 ["Message"])))))))

(clojure.core/defn- response-create-license-configuration-response ([input] (response-create-license-configuration-response nil input)) ([resultWrapper1228956 input] (clojure.core/let [rawinput1228955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228957 {"LicenseConfigurationArn" (rawinput1228955 "LicenseConfigurationArn")}] (clojure.core/cond-> {} (letvar1228957 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1228957 ["LicenseConfigurationArn"])))))))

(clojure.core/defn- response-delete-license-configuration-response ([input] (response-delete-license-configuration-response nil input)) ([resultWrapper1228959 input] (clojure.core/let [rawinput1228958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228960 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-usage-for-license-configuration-response ([input] (response-list-usage-for-license-configuration-response nil input)) ([resultWrapper1228962 input] (clojure.core/let [rawinput1228961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228963 {"LicenseConfigurationUsageList" (rawinput1228961 "LicenseConfigurationUsageList"), "NextToken" (rawinput1228961 "NextToken")}] (clojure.core/cond-> {} (letvar1228963 "LicenseConfigurationUsageList") (clojure.core/assoc :license-configuration-usage-list (deser-license-configuration-usage-list (clojure.core/get-in letvar1228963 ["LicenseConfigurationUsageList"]))) (letvar1228963 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1228963 ["NextToken"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper1228965 input] (clojure.core/let [rawinput1228964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228966 {"Message" (rawinput1228964 "Message")}] (clojure.core/cond-> {} (letvar1228966 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228966 ["Message"])))))))

(clojure.core/defn- response-invalid-resource-state-exception ([input] (response-invalid-resource-state-exception nil input)) ([resultWrapper1228968 input] (clojure.core/let [rawinput1228967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228969 {"Message" (rawinput1228967 "Message")}] (clojure.core/cond-> {} (letvar1228969 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228969 ["Message"])))))))

(clojure.core/defn- response-list-license-specifications-for-resource-response ([input] (response-list-license-specifications-for-resource-response nil input)) ([resultWrapper1228971 input] (clojure.core/let [rawinput1228970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228972 {"LicenseSpecifications" (rawinput1228970 "LicenseSpecifications"), "NextToken" (rawinput1228970 "NextToken")}] (clojure.core/cond-> {} (letvar1228972 "LicenseSpecifications") (clojure.core/assoc :license-specifications (deser-license-specifications (clojure.core/get-in letvar1228972 ["LicenseSpecifications"]))) (letvar1228972 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1228972 ["NextToken"])))))))

(clojure.core/defn- response-license-usage-exception ([input] (response-license-usage-exception nil input)) ([resultWrapper1228974 input] (clojure.core/let [rawinput1228973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228975 {"Message" (rawinput1228973 "Message")}] (clojure.core/cond-> {} (letvar1228975 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228975 ["Message"])))))))

(clojure.core/defn- response-server-internal-exception ([input] (response-server-internal-exception nil input)) ([resultWrapper1228977 input] (clojure.core/let [rawinput1228976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228978 {"Message" (rawinput1228976 "Message")}] (clojure.core/cond-> {} (letvar1228978 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228978 ["Message"])))))))

(clojure.core/defn- response-update-license-configuration-response ([input] (response-update-license-configuration-response nil input)) ([resultWrapper1228980 input] (clojure.core/let [rawinput1228979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228981 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1228983 input] (clojure.core/let [rawinput1228982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228984 {"Message" (rawinput1228982 "Message")}] (clojure.core/cond-> {} (letvar1228984 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1228984 ["Message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1228986 input] (clojure.core/let [rawinput1228985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228987 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resource-inventory-response ([input] (response-list-resource-inventory-response nil input)) ([resultWrapper1228989 input] (clojure.core/let [rawinput1228988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1228990 {"ResourceInventoryList" (rawinput1228988 "ResourceInventoryList"), "NextToken" (rawinput1228988 "NextToken")}] (clojure.core/cond-> {} (letvar1228990 "ResourceInventoryList") (clojure.core/assoc :resource-inventory-list (deser-resource-inventory-list (clojure.core/get-in letvar1228990 ["ResourceInventoryList"]))) (letvar1228990 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1228990 ["NextToken"])))))))
