...
(clojure.core/defn- response-describe-account-result ([input] (response-describe-account-result nil input)) ([resultWrapper2181240 input] (clojure.core/let [rawinput2181239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181241 {"DedicatedTenancySupport" (rawinput2181239 "DedicatedTenancySupport"), "DedicatedTenancyManagementCidrRange" (rawinput2181239 "DedicatedTenancyManagementCidrRange")}] (clojure.core/cond-> {} (letvar2181241 "DedicatedTenancySupport") (clojure.core/assoc :dedicated-tenancy-support (deser-dedicated-tenancy-support-result-enum (clojure.core/get-in letvar2181241 ["DedicatedTenancySupport"]))) (letvar2181241 "DedicatedTenancyManagementCidrRange") (clojure.core/assoc :dedicated-tenancy-management-cidr-range (deser-dedicated-tenancy-management-cidr-range (clojure.core/get-in letvar2181241 ["DedicatedTenancyManagementCidrRange"])))))))

(clojure.core/defn- response-update-rules-of-ip-group-result ([input] (response-update-rules-of-ip-group-result nil input)) ([resultWrapper2181243 input] (clojure.core/let [rawinput2181242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181244 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-values-exception ([input] (response-invalid-parameter-values-exception nil input)) ([resultWrapper2181246 input] (clojure.core/let [rawinput2181245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181247 {"message" (rawinput2181245 "message")}] (clojure.core/cond-> {} (letvar2181247 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181247 ["message"])))))))

(clojure.core/defn- response-delete-tags-result ([input] (response-delete-tags-result nil input)) ([resultWrapper2181249 input] (clojure.core/let [rawinput2181248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181250 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-workspaces-connection-status-result ([input] (response-describe-workspaces-connection-status-result nil input)) ([resultWrapper2181252 input] (clojure.core/let [rawinput2181251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181253 {"WorkspacesConnectionStatus" (rawinput2181251 "WorkspacesConnectionStatus"), "NextToken" (rawinput2181251 "NextToken")}] (clojure.core/cond-> {} (letvar2181253 "WorkspacesConnectionStatus") (clojure.core/assoc :workspaces-connection-status (deser-workspace-connection-status-list (clojure.core/get-in letvar2181253 ["WorkspacesConnectionStatus"]))) (letvar2181253 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181253 ["NextToken"])))))))

(clojure.core/defn- response-associate-ip-groups-result ([input] (response-associate-ip-groups-result nil input)) ([resultWrapper2181255 input] (clojure.core/let [rawinput2181254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181256 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-terminate-workspaces-result ([input] (response-terminate-workspaces-result nil input)) ([resultWrapper2181258 input] (clojure.core/let [rawinput2181257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181259 {"FailedRequests" (rawinput2181257 "FailedRequests")}] (clojure.core/cond-> {} (letvar2181259 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-terminate-workspace-requests (clojure.core/get-in letvar2181259 ["FailedRequests"])))))))

(clojure.core/defn- response-resource-creation-failed-exception ([input] (response-resource-creation-failed-exception nil input)) ([resultWrapper2181261 input] (clojure.core/let [rawinput2181260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181262 {"message" (rawinput2181260 "message")}] (clojure.core/cond-> {} (letvar2181262 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181262 ["message"])))))))

(clojure.core/defn- response-describe-workspace-bundles-result ([input] (response-describe-workspace-bundles-result nil input)) ([resultWrapper2181264 input] (clojure.core/let [rawinput2181263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181265 {"Bundles" (rawinput2181263 "Bundles"), "NextToken" (rawinput2181263 "NextToken")}] (clojure.core/cond-> {} (letvar2181265 "Bundles") (clojure.core/assoc :bundles (deser-bundle-list (clojure.core/get-in letvar2181265 ["Bundles"]))) (letvar2181265 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181265 ["NextToken"])))))))

(clojure.core/defn- response-operation-in-progress-exception ([input] (response-operation-in-progress-exception nil input)) ([resultWrapper2181267 input] (clojure.core/let [rawinput2181266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181268 {"message" (rawinput2181266 "message")}] (clojure.core/cond-> {} (letvar2181268 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181268 ["message"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper2181270 input] (clojure.core/let [rawinput2181269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181271 {"message" (rawinput2181269 "message")}] (clojure.core/cond-> {} (letvar2181271 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181271 ["message"])))))))

(clojure.core/defn- response-delete-ip-group-result ([input] (response-delete-ip-group-result nil input)) ([resultWrapper2181273 input] (clojure.core/let [rawinput2181272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181274 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-revoke-ip-rules-result ([input] (response-revoke-ip-rules-result nil input)) ([resultWrapper2181276 input] (clojure.core/let [rawinput2181275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181277 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-workspace-image-result ([input] (response-import-workspace-image-result nil input)) ([resultWrapper2181279 input] (clojure.core/let [rawinput2181278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181280 {"ImageId" (rawinput2181278 "ImageId")}] (clojure.core/cond-> {} (letvar2181280 "ImageId") (clojure.core/assoc :image-id (deser-workspace-image-id (clojure.core/get-in letvar2181280 ["ImageId"])))))))

(clojure.core/defn- response-describe-tags-result ([input] (response-describe-tags-result nil input)) ([resultWrapper2181282 input] (clojure.core/let [rawinput2181281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181283 {"TagList" (rawinput2181281 "TagList")}] (clojure.core/cond-> {} (letvar2181283 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar2181283 ["TagList"])))))))

(clojure.core/defn- response-rebuild-workspaces-result ([input] (response-rebuild-workspaces-result nil input)) ([resultWrapper2181285 input] (clojure.core/let [rawinput2181284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181286 {"FailedRequests" (rawinput2181284 "FailedRequests")}] (clojure.core/cond-> {} (letvar2181286 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-rebuild-workspace-requests (clojure.core/get-in letvar2181286 ["FailedRequests"])))))))

(clojure.core/defn- response-describe-account-modifications-result ([input] (response-describe-account-modifications-result nil input)) ([resultWrapper2181288 input] (clojure.core/let [rawinput2181287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181289 {"AccountModifications" (rawinput2181287 "AccountModifications"), "NextToken" (rawinput2181287 "NextToken")}] (clojure.core/cond-> {} (letvar2181289 "AccountModifications") (clojure.core/assoc :account-modifications (deser-account-modification-list (clojure.core/get-in letvar2181289 ["AccountModifications"]))) (letvar2181289 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181289 ["NextToken"])))))))

(clojure.core/defn- response-stop-workspaces-result ([input] (response-stop-workspaces-result nil input)) ([resultWrapper2181291 input] (clojure.core/let [rawinput2181290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181292 {"FailedRequests" (rawinput2181290 "FailedRequests")}] (clojure.core/cond-> {} (letvar2181292 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-stop-workspace-requests (clojure.core/get-in letvar2181292 ["FailedRequests"])))))))

(clojure.core/defn- response-modify-client-properties-result ([input] (response-modify-client-properties-result nil input)) ([resultWrapper2181294 input] (clojure.core/let [rawinput2181293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181295 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-associated-exception ([input] (response-resource-associated-exception nil input)) ([resultWrapper2181297 input] (clojure.core/let [rawinput2181296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181298 {"message" (rawinput2181296 "message")}] (clojure.core/cond-> {} (letvar2181298 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181298 ["message"])))))))

(clojure.core/defn- response-describe-workspace-images-result ([input] (response-describe-workspace-images-result nil input)) ([resultWrapper2181300 input] (clojure.core/let [rawinput2181299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181301 {"Images" (rawinput2181299 "Images"), "NextToken" (rawinput2181299 "NextToken")}] (clojure.core/cond-> {} (letvar2181301 "Images") (clojure.core/assoc :images (deser-workspace-image-list (clojure.core/get-in letvar2181301 ["Images"]))) (letvar2181301 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181301 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2181303 input] (clojure.core/let [rawinput2181302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181304 {"message" (rawinput2181302 "message"), "ResourceId" (rawinput2181302 "ResourceId")}] (clojure.core/cond-> {} (letvar2181304 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181304 ["message"]))) (letvar2181304 "ResourceId") (clojure.core/assoc :resource-id (deser-non-empty-string (clojure.core/get-in letvar2181304 ["ResourceId"])))))))

(clojure.core/defn- response-delete-workspace-image-result ([input] (response-delete-workspace-image-result nil input)) ([resultWrapper2181306 input] (clojure.core/let [rawinput2181305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181307 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reboot-workspaces-result ([input] (response-reboot-workspaces-result nil input)) ([resultWrapper2181309 input] (clojure.core/let [rawinput2181308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181310 {"FailedRequests" (rawinput2181308 "FailedRequests")}] (clojure.core/cond-> {} (letvar2181310 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-reboot-workspace-requests (clojure.core/get-in letvar2181310 ["FailedRequests"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2181312 input] (clojure.core/let [rawinput2181311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181313 {"message" (rawinput2181311 "message")}] (clojure.core/cond-> {} (letvar2181313 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181313 ["message"])))))))

(clojure.core/defn- response-operation-not-supported-exception ([input] (response-operation-not-supported-exception nil input)) ([resultWrapper2181315 input] (clojure.core/let [rawinput2181314 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181316 {"message" (rawinput2181314 "message")}] (clojure.core/cond-> {} (letvar2181316 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181316 ["message"])))))))

(clojure.core/defn- response-create-tags-result ([input] (response-create-tags-result nil input)) ([resultWrapper2181318 input] (clojure.core/let [rawinput2181317 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181319 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-workspaces-result ([input] (response-start-workspaces-result nil input)) ([resultWrapper2181321 input] (clojure.core/let [rawinput2181320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181322 {"FailedRequests" (rawinput2181320 "FailedRequests")}] (clojure.core/cond-> {} (letvar2181322 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-start-workspace-requests (clojure.core/get-in letvar2181322 ["FailedRequests"])))))))

(clojure.core/defn- response-create-workspaces-result ([input] (response-create-workspaces-result nil input)) ([resultWrapper2181324 input] (clojure.core/let [rawinput2181323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181325 {"FailedRequests" (rawinput2181323 "FailedRequests"), "PendingRequests" (rawinput2181323 "PendingRequests")}] (clojure.core/cond-> {} (letvar2181325 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-create-workspace-requests (clojure.core/get-in letvar2181325 ["FailedRequests"]))) (letvar2181325 "PendingRequests") (clojure.core/assoc :pending-requests (deser-workspace-list (clojure.core/get-in letvar2181325 ["PendingRequests"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper2181327 input] (clojure.core/let [rawinput2181326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181328 {"message" (rawinput2181326 "message")}] (clojure.core/cond-> {} (letvar2181328 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181328 ["message"])))))))

(clojure.core/defn- response-describe-workspace-directories-result ([input] (response-describe-workspace-directories-result nil input)) ([resultWrapper2181330 input] (clojure.core/let [rawinput2181329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181331 {"Directories" (rawinput2181329 "Directories"), "NextToken" (rawinput2181329 "NextToken")}] (clojure.core/cond-> {} (letvar2181331 "Directories") (clojure.core/assoc :directories (deser-directory-list (clojure.core/get-in letvar2181331 ["Directories"]))) (letvar2181331 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181331 ["NextToken"])))))))

(clojure.core/defn- response-invalid-resource-state-exception ([input] (response-invalid-resource-state-exception nil input)) ([resultWrapper2181333 input] (clojure.core/let [rawinput2181332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181334 {"message" (rawinput2181332 "message")}] (clojure.core/cond-> {} (letvar2181334 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181334 ["message"])))))))

(clojure.core/defn- response-create-ip-group-result ([input] (response-create-ip-group-result nil input)) ([resultWrapper2181336 input] (clojure.core/let [rawinput2181335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181337 {"GroupId" (rawinput2181335 "GroupId")}] (clojure.core/cond-> {} (letvar2181337 "GroupId") (clojure.core/assoc :group-id (deser-ip-group-id (clojure.core/get-in letvar2181337 ["GroupId"])))))))

(clojure.core/defn- response-describe-client-properties-result ([input] (response-describe-client-properties-result nil input)) ([resultWrapper2181339 input] (clojure.core/let [rawinput2181338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181340 {"ClientPropertiesList" (rawinput2181338 "ClientPropertiesList")}] (clojure.core/cond-> {} (letvar2181340 "ClientPropertiesList") (clojure.core/assoc :client-properties-list (deser-client-properties-list (clojure.core/get-in letvar2181340 ["ClientPropertiesList"])))))))

(clojure.core/defn- response-disassociate-ip-groups-result ([input] (response-disassociate-ip-groups-result nil input)) ([resultWrapper2181342 input] (clojure.core/let [rawinput2181341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181343 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-available-management-cidr-ranges-result ([input] (response-list-available-management-cidr-ranges-result nil input)) ([resultWrapper2181345 input] (clojure.core/let [rawinput2181344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181346 {"ManagementCidrRanges" (rawinput2181344 "ManagementCidrRanges"), "NextToken" (rawinput2181344 "NextToken")}] (clojure.core/cond-> {} (letvar2181346 "ManagementCidrRanges") (clojure.core/assoc :management-cidr-ranges (deser-dedicated-tenancy-cidr-range-list (clojure.core/get-in letvar2181346 ["ManagementCidrRanges"]))) (letvar2181346 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181346 ["NextToken"])))))))

(clojure.core/defn- response-describe-workspaces-result ([input] (response-describe-workspaces-result nil input)) ([resultWrapper2181348 input] (clojure.core/let [rawinput2181347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181349 {"Workspaces" (rawinput2181347 "Workspaces"), "NextToken" (rawinput2181347 "NextToken")}] (clojure.core/cond-> {} (letvar2181349 "Workspaces") (clojure.core/assoc :workspaces (deser-workspace-list (clojure.core/get-in letvar2181349 ["Workspaces"]))) (letvar2181349 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181349 ["NextToken"])))))))

(clojure.core/defn- response-unsupported-workspace-configuration-exception ([input] (response-unsupported-workspace-configuration-exception nil input)) ([resultWrapper2181351 input] (clojure.core/let [rawinput2181350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181352 {"message" (rawinput2181350 "message")}] (clojure.core/cond-> {} (letvar2181352 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181352 ["message"])))))))

(clojure.core/defn- response-modify-workspace-properties-result ([input] (response-modify-workspace-properties-result nil input)) ([resultWrapper2181354 input] (clojure.core/let [rawinput2181353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181355 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-unavailable-exception ([input] (response-resource-unavailable-exception nil input)) ([resultWrapper2181357 input] (clojure.core/let [rawinput2181356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181358 {"message" (rawinput2181356 "message"), "ResourceId" (rawinput2181356 "ResourceId")}] (clojure.core/cond-> {} (letvar2181358 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2181358 ["message"]))) (letvar2181358 "ResourceId") (clojure.core/assoc :resource-id (deser-non-empty-string (clojure.core/get-in letvar2181358 ["ResourceId"])))))))

(clojure.core/defn- response-modify-account-result ([input] (response-modify-account-result nil input)) ([resultWrapper2181360 input] (clojure.core/let [rawinput2181359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181361 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-ip-groups-result ([input] (response-describe-ip-groups-result nil input)) ([resultWrapper2181363 input] (clojure.core/let [rawinput2181362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181364 {"Result" (rawinput2181362 "Result"), "NextToken" (rawinput2181362 "NextToken")}] (clojure.core/cond-> {} (letvar2181364 "Result") (clojure.core/assoc :result (deser-workspaces-ip-groups-list (clojure.core/get-in letvar2181364 ["Result"]))) (letvar2181364 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2181364 ["NextToken"])))))))

(clojure.core/defn- response-authorize-ip-rules-result ([input] (response-authorize-ip-rules-result nil input)) ([resultWrapper2181366 input] (clojure.core/let [rawinput2181365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181367 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-modify-workspace-state-result ([input] (response-modify-workspace-state-result nil input)) ([resultWrapper2181369 input] (clojure.core/let [rawinput2181368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2181370 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/workspace-image-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"wsi-[0-9a-z]{9,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/management-cidr-range-constraint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/(3[0-2]|[1-2][0-9]|[0-9]))$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.workspaces/workspace-image-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_./() -]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63))))

(clojure.spec.alpha/def :portkey.aws.workspaces/ec-2-image-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^ami\-([a-f0-9]{8}|[a-f0-9]{17})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-za-z0-9_/.-]{0,62}:[A-za-z0-9_/.-]{0,63}:[A-za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-za-z0-9_/.-]{0,127}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/workspace-image-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_./()\\-]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/bundle-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^wsb-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/ip-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"wsipg-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/dedicated-tenancy-management-cidr-range (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(^([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.0\.0)(\/(16$))$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/workspace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^ws-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces/registration-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20))))
