...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/job-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/thing-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 128)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/details-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 128)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/describe-job-execution-job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+|^\$next" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+" s__30634__auto__))))
...
(clojure.core/defn get-pending-job-executions ([get-pending-job-executions-request] (portkey.aws/-rest-json-call portkey.aws.iot-jobs-data.-2017-09-29/endpoints "GET" "/things/{thingName}/jobs" get-pending-job-executions-request :portkey.aws.iot-jobs-data.-2017-09-29/get-pending-job-executions-request {:payload nil, :move {}, :headers {}, :uri {"thingName" "thingName"}, :querystring {}} nil :portkey.aws.iot-jobs-data.-2017-09-29/get-pending-job-executions-response {"InvalidRequestException" :portkey.aws.iot-jobs-data.-2017-09-29/invalid-request-exception, "ResourceNotFoundException" :portkey.aws.iot-jobs-data.-2017-09-29/resource-not-found-exception, "ThrottlingException" :portkey.aws.iot-jobs-data.-2017-09-29/throttling-exception, "ServiceUnavailableException" :portkey.aws.iot-jobs-data.-2017-09-29/service-unavailable-exception, "CertificateValidationException" :portkey.aws.iot-jobs-data.-2017-09-29/certificate-validation-exception})))
