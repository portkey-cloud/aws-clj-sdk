...
(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper239030 input] (clojure.core/let [rawinput239029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239031 {"message" (rawinput239029 "message")}] (clojure.core/cond-> {} (letvar239031 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239031 ["message"])))))))

(clojure.core/defn- response-certificate-validation-exception ([input] (response-certificate-validation-exception nil input)) ([resultWrapper239033 input] (clojure.core/let [rawinput239032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239034 {"message" (rawinput239032 "message")}] (clojure.core/cond-> {} (letvar239034 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239034 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper239036 input] (clojure.core/let [rawinput239035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239037 {"message" (rawinput239035 "message")}] (clojure.core/cond-> {} (letvar239037 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239037 ["message"])))))))

(clojure.core/defn- response-get-pending-job-executions-response ([input] (response-get-pending-job-executions-response nil input)) ([resultWrapper239039 input] (clojure.core/let [rawinput239038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239040 {"inProgressJobs" (rawinput239038 "inProgressJobs"), "queuedJobs" (rawinput239038 "queuedJobs")}] (clojure.core/cond-> {} (letvar239040 "inProgressJobs") (clojure.core/assoc :in-progress-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar239040 ["inProgressJobs"]))) (letvar239040 "queuedJobs") (clojure.core/assoc :queued-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar239040 ["queuedJobs"])))))))

(clojure.core/defn- response-terminal-state-exception ([input] (response-terminal-state-exception nil input)) ([resultWrapper239042 input] (clojure.core/let [rawinput239041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239043 {"message" (rawinput239041 "message")}] (clojure.core/cond-> {} (letvar239043 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239043 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper239045 input] (clojure.core/let [rawinput239044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239046 {"message" (rawinput239044 "message")}] (clojure.core/cond-> {} (letvar239046 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239046 ["message"])))))))

(clojure.core/defn- response-describe-job-execution-response ([input] (response-describe-job-execution-response nil input)) ([resultWrapper239048 input] (clojure.core/let [rawinput239047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239049 {"execution" (rawinput239047 "execution")}] (clojure.core/cond-> {} (letvar239049 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar239049 ["execution"])))))))

(clojure.core/defn- response-invalid-state-transition-exception ([input] (response-invalid-state-transition-exception nil input)) ([resultWrapper239051 input] (clojure.core/let [rawinput239050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239052 {"message" (rawinput239050 "message")}] (clojure.core/cond-> {} (letvar239052 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239052 ["message"])))))))

(clojure.core/defn- response-update-job-execution-response ([input] (response-update-job-execution-response nil input)) ([resultWrapper239054 input] (clojure.core/let [rawinput239053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239055 {"executionState" (rawinput239053 "executionState"), "jobDocument" (rawinput239053 "jobDocument")}] (clojure.core/cond-> {} (letvar239055 "executionState") (clojure.core/assoc :execution-state (deser-job-execution-state (clojure.core/get-in letvar239055 ["executionState"]))) (letvar239055 "jobDocument") (clojure.core/assoc :job-document (deser-job-document (clojure.core/get-in letvar239055 ["jobDocument"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper239057 input] (clojure.core/let [rawinput239056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239058 {"message" (rawinput239056 "message"), "payload" (rawinput239056 "payload")}] (clojure.core/cond-> {} (letvar239058 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar239058 ["message"]))) (letvar239058 "payload") (clojure.core/assoc :payload (deser-binary-blob (clojure.core/get-in letvar239058 ["payload"])))))))

(clojure.core/defn- response-start-next-pending-job-execution-response ([input] (response-start-next-pending-job-execution-response nil input)) ([resultWrapper239060 input] (clojure.core/let [rawinput239059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar239061 {"execution" (rawinput239059 "execution")}] (clojure.core/cond-> {} (letvar239061 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar239061 ["execution"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/job-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/thing-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/details-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/describe-job-execution-job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+|^\$next" s__21112__auto__))))
