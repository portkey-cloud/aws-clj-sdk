...
(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1232027 input] (clojure.core/let [rawinput1232026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232028 {"message" (rawinput1232026 "message")}] (clojure.core/cond-> {} (letvar1232028 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232028 ["message"])))))))

(clojure.core/defn- response-certificate-validation-exception ([input] (response-certificate-validation-exception nil input)) ([resultWrapper1232030 input] (clojure.core/let [rawinput1232029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232031 {"message" (rawinput1232029 "message")}] (clojure.core/cond-> {} (letvar1232031 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232031 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1232033 input] (clojure.core/let [rawinput1232032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232034 {"message" (rawinput1232032 "message")}] (clojure.core/cond-> {} (letvar1232034 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232034 ["message"])))))))

(clojure.core/defn- response-get-pending-job-executions-response ([input] (response-get-pending-job-executions-response nil input)) ([resultWrapper1232036 input] (clojure.core/let [rawinput1232035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232037 {"inProgressJobs" (rawinput1232035 "inProgressJobs"), "queuedJobs" (rawinput1232035 "queuedJobs")}] (clojure.core/cond-> {} (letvar1232037 "inProgressJobs") (clojure.core/assoc :in-progress-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar1232037 ["inProgressJobs"]))) (letvar1232037 "queuedJobs") (clojure.core/assoc :queued-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar1232037 ["queuedJobs"])))))))

(clojure.core/defn- response-terminal-state-exception ([input] (response-terminal-state-exception nil input)) ([resultWrapper1232039 input] (clojure.core/let [rawinput1232038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232040 {"message" (rawinput1232038 "message")}] (clojure.core/cond-> {} (letvar1232040 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232040 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1232042 input] (clojure.core/let [rawinput1232041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232043 {"message" (rawinput1232041 "message")}] (clojure.core/cond-> {} (letvar1232043 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232043 ["message"])))))))

(clojure.core/defn- response-describe-job-execution-response ([input] (response-describe-job-execution-response nil input)) ([resultWrapper1232045 input] (clojure.core/let [rawinput1232044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232046 {"execution" (rawinput1232044 "execution")}] (clojure.core/cond-> {} (letvar1232046 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar1232046 ["execution"])))))))

(clojure.core/defn- response-invalid-state-transition-exception ([input] (response-invalid-state-transition-exception nil input)) ([resultWrapper1232048 input] (clojure.core/let [rawinput1232047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232049 {"message" (rawinput1232047 "message")}] (clojure.core/cond-> {} (letvar1232049 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232049 ["message"])))))))

(clojure.core/defn- response-update-job-execution-response ([input] (response-update-job-execution-response nil input)) ([resultWrapper1232051 input] (clojure.core/let [rawinput1232050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232052 {"executionState" (rawinput1232050 "executionState"), "jobDocument" (rawinput1232050 "jobDocument")}] (clojure.core/cond-> {} (letvar1232052 "executionState") (clojure.core/assoc :execution-state (deser-job-execution-state (clojure.core/get-in letvar1232052 ["executionState"]))) (letvar1232052 "jobDocument") (clojure.core/assoc :job-document (deser-job-document (clojure.core/get-in letvar1232052 ["jobDocument"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1232054 input] (clojure.core/let [rawinput1232053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232055 {"message" (rawinput1232053 "message"), "payload" (rawinput1232053 "payload")}] (clojure.core/cond-> {} (letvar1232055 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1232055 ["message"]))) (letvar1232055 "payload") (clojure.core/assoc :payload (deser-binary-blob (clojure.core/get-in letvar1232055 ["payload"])))))))

(clojure.core/defn- response-start-next-pending-job-execution-response ([input] (response-start-next-pending-job-execution-response nil input)) ([resultWrapper1232057 input] (clojure.core/let [rawinput1232056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1232058 {"execution" (rawinput1232056 "execution")}] (clojure.core/cond-> {} (letvar1232058 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar1232058 ["execution"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/job-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/thing-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/details-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.iot-jobs-data.-2017-09-29/describe-job-execution-job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+|^\$next" s__1012854__auto__))))
