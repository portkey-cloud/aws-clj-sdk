...
(clojure.core/defn- response-describe-project-result ([input] (response-describe-project-result nil input)) ([resultWrapper1380050 input] (clojure.core/let [rawinput1380049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380051 {"details" (rawinput1380049 "details")}] (clojure.core/cond-> {} (letvar1380051 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1380051 ["details"])))))))

(clojure.core/defn- response-list-projects-result ([input] (response-list-projects-result nil input)) ([resultWrapper1380053 input] (clojure.core/let [rawinput1380052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380054 {"projects" (rawinput1380052 "projects"), "nextToken" (rawinput1380052 "nextToken")}] (clojure.core/cond-> {} (letvar1380054 "projects") (clojure.core/assoc :projects (deser-project-summaries (clojure.core/get-in letvar1380054 ["projects"]))) (letvar1380054 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1380054 ["nextToken"])))))))

(clojure.core/defn- response-update-project-result ([input] (response-update-project-result nil input)) ([resultWrapper1380056 input] (clojure.core/let [rawinput1380055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380057 {"details" (rawinput1380055 "details")}] (clojure.core/cond-> {} (letvar1380057 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1380057 ["details"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1380059 input] (clojure.core/let [rawinput1380058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380060 {"message" (rawinput1380058 "message")}] (clojure.core/cond-> {} (letvar1380060 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380060 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1380062 input] (clojure.core/let [rawinput1380061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380063 {"message" (rawinput1380061 "message")}] (clojure.core/cond-> {} (letvar1380063 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380063 ["message"])))))))

(clojure.core/defn- response-export-bundle-result ([input] (response-export-bundle-result nil input)) ([resultWrapper1380065 input] (clojure.core/let [rawinput1380064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380066 {"downloadUrl" (rawinput1380064 "downloadUrl")}] (clojure.core/cond-> {} (letvar1380066 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar1380066 ["downloadUrl"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1380068 input] (clojure.core/let [rawinput1380067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380069 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1380067 "message")}] (clojure.core/cond-> {} (letvar1380069 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1380069 ["Retry-After"]))) (letvar1380069 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380069 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1380071 input] (clojure.core/let [rawinput1380070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380072 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1380070 "message")}] (clojure.core/cond-> {} (letvar1380072 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1380072 ["Retry-After"]))) (letvar1380072 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380072 ["message"])))))))

(clojure.core/defn- response-describe-bundle-result ([input] (response-describe-bundle-result nil input)) ([resultWrapper1380074 input] (clojure.core/let [rawinput1380073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380075 {"details" (rawinput1380073 "details")}] (clojure.core/cond-> {} (letvar1380075 "details") (clojure.core/assoc :details (deser-bundle-details (clojure.core/get-in letvar1380075 ["details"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1380077 input] (clojure.core/let [rawinput1380076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380078 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1380076 "message")}] (clojure.core/cond-> {} (letvar1380078 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1380078 ["Retry-After"]))) (letvar1380078 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380078 ["message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1380080 input] (clojure.core/let [rawinput1380079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380081 {"message" (rawinput1380079 "message")}] (clojure.core/cond-> {} (letvar1380081 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380081 ["message"])))))))

(clojure.core/defn- response-create-project-result ([input] (response-create-project-result nil input)) ([resultWrapper1380083 input] (clojure.core/let [rawinput1380082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380084 {"details" (rawinput1380082 "details")}] (clojure.core/cond-> {} (letvar1380084 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1380084 ["details"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1380086 input] (clojure.core/let [rawinput1380085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380087 {"message" (rawinput1380085 "message")}] (clojure.core/cond-> {} (letvar1380087 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380087 ["message"])))))))

(clojure.core/defn- response-delete-project-result ([input] (response-delete-project-result nil input)) ([resultWrapper1380089 input] (clojure.core/let [rawinput1380088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380090 {"deletedResources" (rawinput1380088 "deletedResources"), "orphanedResources" (rawinput1380088 "orphanedResources")}] (clojure.core/cond-> {} (letvar1380090 "deletedResources") (clojure.core/assoc :deleted-resources (deser-resources (clojure.core/get-in letvar1380090 ["deletedResources"]))) (letvar1380090 "orphanedResources") (clojure.core/assoc :orphaned-resources (deser-resources (clojure.core/get-in letvar1380090 ["orphanedResources"])))))))

(clojure.core/defn- response-export-project-result ([input] (response-export-project-result nil input)) ([resultWrapper1380092 input] (clojure.core/let [rawinput1380091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380093 {"downloadUrl" (rawinput1380091 "downloadUrl"), "shareUrl" (rawinput1380091 "shareUrl"), "snapshotId" (rawinput1380091 "snapshotId")}] (clojure.core/cond-> {} (letvar1380093 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar1380093 ["downloadUrl"]))) (letvar1380093 "shareUrl") (clojure.core/assoc :share-url (deser-share-url (clojure.core/get-in letvar1380093 ["shareUrl"]))) (letvar1380093 "snapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1380093 ["snapshotId"])))))))

(clojure.core/defn- response-account-action-required-exception ([input] (response-account-action-required-exception nil input)) ([resultWrapper1380095 input] (clojure.core/let [rawinput1380094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380096 {"message" (rawinput1380094 "message")}] (clojure.core/cond-> {} (letvar1380096 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1380096 ["message"])))))))

(clojure.core/defn- response-list-bundles-result ([input] (response-list-bundles-result nil input)) ([resultWrapper1380098 input] (clojure.core/let [rawinput1380097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1380099 {"bundleList" (rawinput1380097 "bundleList"), "nextToken" (rawinput1380097 "nextToken")}] (clojure.core/cond-> {} (letvar1380099 "bundleList") (clojure.core/assoc :bundle-list (deser-bundle-list (clojure.core/get-in letvar1380099 ["bundleList"]))) (letvar1380099 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1380099 ["nextToken"])))))))
