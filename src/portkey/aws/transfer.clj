...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper1852792 input] (clojure.core/let [rawinput1852791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852793 {"ServerId" (rawinput1852791 "ServerId"), "UserName" (rawinput1852791 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852793 ["ServerId"])), :user-name (deser-user-name (clojure.core/get-in letvar1852793 ["UserName"]))}))))

(clojure.core/defn- response-list-servers-response ([input] (response-list-servers-response nil input)) ([resultWrapper1852795 input] (clojure.core/let [rawinput1852794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852796 {"NextToken" (rawinput1852794 "NextToken"), "Servers" (rawinput1852794 "Servers")}] (clojure.core/cond-> {:servers (deser-listed-servers (clojure.core/get-in letvar1852796 ["Servers"]))} (letvar1852796 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1852796 ["NextToken"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1852798 input] (clojure.core/let [rawinput1852797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852799 {"Message" (rawinput1852797 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1852799 ["Message"]))}))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1852801 input] (clojure.core/let [rawinput1852800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852802 {"Arn" (rawinput1852800 "Arn"), "NextToken" (rawinput1852800 "NextToken"), "Tags" (rawinput1852800 "Tags")}] (clojure.core/cond-> {} (letvar1852802 "Arn") (clojure.core/assoc :arn (deser-arn (clojure.core/get-in letvar1852802 ["Arn"]))) (letvar1852802 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1852802 ["NextToken"]))) (letvar1852802 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1852802 ["Tags"])))))))

(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1852804 input] (clojure.core/let [rawinput1852803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852805 {"Message" (rawinput1852803 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1852805 ["Message"]))}))))

(clojure.core/defn- response-resource-exists-exception ([input] (response-resource-exists-exception nil input)) ([resultWrapper1852807 input] (clojure.core/let [rawinput1852806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852808 {"Message" (rawinput1852806 "Message"), "Resource" (rawinput1852806 "Resource"), "ResourceType" (rawinput1852806 "ResourceType")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1852808 ["Message"])), :resource (deser-resource (clojure.core/get-in letvar1852808 ["Resource"])), :resource-type (deser-resource-type (clojure.core/get-in letvar1852808 ["ResourceType"]))}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1852810 input] (clojure.core/let [rawinput1852809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852811 {"Message" (rawinput1852809 "Message")}] (clojure.core/cond-> {} (letvar1852811 "Message") (clojure.core/assoc :message (deser-service-error-message (clojure.core/get-in letvar1852811 ["Message"])))))))

(clojure.core/defn- response-update-user-response ([input] (response-update-user-response nil input)) ([resultWrapper1852813 input] (clojure.core/let [rawinput1852812 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852814 {"ServerId" (rawinput1852812 "ServerId"), "UserName" (rawinput1852812 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852814 ["ServerId"])), :user-name (deser-user-name (clojure.core/get-in letvar1852814 ["UserName"]))}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1852816 input] (clojure.core/let [rawinput1852815 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852817 {"Message" (rawinput1852815 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1852817 ["Message"]))}))))

(clojure.core/defn- response-update-server-response ([input] (response-update-server-response nil input)) ([resultWrapper1852819 input] (clojure.core/let [rawinput1852818 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852820 {"ServerId" (rawinput1852818 "ServerId")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852820 ["ServerId"]))}))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper1852822 input] (clojure.core/let [rawinput1852821 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852823 {"ServerId" (rawinput1852821 "ServerId"), "User" (rawinput1852821 "User")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852823 ["ServerId"])), :user (deser-described-user (clojure.core/get-in letvar1852823 ["User"]))}))))

(clojure.core/defn- response-import-ssh-public-key-response ([input] (response-import-ssh-public-key-response nil input)) ([resultWrapper1852825 input] (clojure.core/let [rawinput1852824 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852826 {"ServerId" (rawinput1852824 "ServerId"), "SshPublicKeyId" (rawinput1852824 "SshPublicKeyId"), "UserName" (rawinput1852824 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852826 ["ServerId"])), :ssh-public-key-id (deser-ssh-public-key-id (clojure.core/get-in letvar1852826 ["SshPublicKeyId"])), :user-name (deser-user-name (clojure.core/get-in letvar1852826 ["UserName"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1852828 input] (clojure.core/let [rawinput1852827 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852829 {"Message" (rawinput1852827 "Message"), "Resource" (rawinput1852827 "Resource"), "ResourceType" (rawinput1852827 "ResourceType")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1852829 ["Message"])), :resource (deser-resource (clojure.core/get-in letvar1852829 ["Resource"])), :resource-type (deser-resource-type (clojure.core/get-in letvar1852829 ["ResourceType"]))}))))

(clojure.core/defn- response-describe-server-response ([input] (response-describe-server-response nil input)) ([resultWrapper1852831 input] (clojure.core/let [rawinput1852830 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852832 {"Server" (rawinput1852830 "Server")}] (clojure.core/cond-> {:server (deser-described-server (clojure.core/get-in letvar1852832 ["Server"]))}))))

(clojure.core/defn- response-create-server-response ([input] (response-create-server-response nil input)) ([resultWrapper1852834 input] (clojure.core/let [rawinput1852833 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852835 {"ServerId" (rawinput1852833 "ServerId")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852835 ["ServerId"]))}))))

(clojure.core/defn- response-test-identity-provider-response ([input] (response-test-identity-provider-response nil input)) ([resultWrapper1852837 input] (clojure.core/let [rawinput1852836 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852838 {"Message" (rawinput1852836 "Message"), "StatusCode" (rawinput1852836 "StatusCode"), "Url" (rawinput1852836 "Url")}] (clojure.core/cond-> {:status-code (deser-status-code (clojure.core/get-in letvar1852838 ["StatusCode"])), :url (deser-url (clojure.core/get-in letvar1852838 ["Url"]))} (letvar1852838 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1852838 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1852840 input] (clojure.core/let [rawinput1852839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1852841 {"NextToken" (rawinput1852839 "NextToken"), "ServerId" (rawinput1852839 "ServerId"), "Users" (rawinput1852839 "Users")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1852841 ["ServerId"])), :users (deser-listed-users (clojure.core/get-in letvar1852841 ["Users"]))} (letvar1852841 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1852841 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/ssh-public-key-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^ssh-rsa\s+[A-Za-z0-9+/]+[=]{0,3}(\s+.+)?\s*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/nullable-role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|arn:.*role/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/home-directory (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 6144))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-z0-9]{3,32}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/ssh-public-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^key-[0-9a-f]{17}$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.transfer/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*role/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.transfer/server-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^s-([0-9a-f]{17})$" s__21078__auto__))))
