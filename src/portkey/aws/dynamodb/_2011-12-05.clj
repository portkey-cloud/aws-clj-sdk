...
(clojure.core/defn- response-update-item-output ([input] (response-update-item-output nil input)) ([resultWrapper588712 input] (clojure.core/let [rawinput588711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588713 {"Attributes" (rawinput588711 "Attributes"), "ConsumedCapacityUnits" (rawinput588711 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588713 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar588713 ["Attributes"]))) (letvar588713 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588713 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-delete-item-output ([input] (response-delete-item-output nil input)) ([resultWrapper588715 input] (clojure.core/let [rawinput588714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588716 {"Attributes" (rawinput588714 "Attributes"), "ConsumedCapacityUnits" (rawinput588714 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588716 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar588716 ["Attributes"]))) (letvar588716 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588716 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-get-item-output ([input] (response-get-item-output nil input)) ([resultWrapper588718 input] (clojure.core/let [rawinput588717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588719 {"Item" (rawinput588717 "Item"), "ConsumedCapacityUnits" (rawinput588717 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588719 "Item") (clojure.core/assoc :item (deser-attribute-map (clojure.core/get-in letvar588719 ["Item"]))) (letvar588719 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588719 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-update-table-output ([input] (response-update-table-output nil input)) ([resultWrapper588721 input] (clojure.core/let [rawinput588720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588722 {"TableDescription" (rawinput588720 "TableDescription")}] (clojure.core/cond-> {} (letvar588722 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar588722 ["TableDescription"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper588724 input] (clojure.core/let [rawinput588723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588725 {"message" (rawinput588723 "message")}] (clojure.core/cond-> {} (letvar588725 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588725 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper588727 input] (clojure.core/let [rawinput588726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588728 {"message" (rawinput588726 "message")}] (clojure.core/cond-> {} (letvar588728 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588728 ["message"])))))))

(clojure.core/defn- response-describe-table-output ([input] (response-describe-table-output nil input)) ([resultWrapper588730 input] (clojure.core/let [rawinput588729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588731 {"Table" (rawinput588729 "Table")}] (clojure.core/cond-> {} (letvar588731 "Table") (clojure.core/assoc :table (deser-table-description (clojure.core/get-in letvar588731 ["Table"])))))))

(clojure.core/defn- response-query-output ([input] (response-query-output nil input)) ([resultWrapper588733 input] (clojure.core/let [rawinput588732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588734 {"Items" (rawinput588732 "Items"), "Count" (rawinput588732 "Count"), "LastEvaluatedKey" (rawinput588732 "LastEvaluatedKey"), "ConsumedCapacityUnits" (rawinput588732 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588734 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar588734 ["Items"]))) (letvar588734 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar588734 ["Count"]))) (letvar588734 "LastEvaluatedKey") (clojure.core/assoc :last-evaluated-key (deser-key (clojure.core/get-in letvar588734 ["LastEvaluatedKey"]))) (letvar588734 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588734 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper588736 input] (clojure.core/let [rawinput588735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588737 {"message" (rawinput588735 "message")}] (clojure.core/cond-> {} (letvar588737 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588737 ["message"])))))))

(clojure.core/defn- response-list-tables-output ([input] (response-list-tables-output nil input)) ([resultWrapper588739 input] (clojure.core/let [rawinput588738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588740 {"TableNames" (rawinput588738 "TableNames"), "LastEvaluatedTableName" (rawinput588738 "LastEvaluatedTableName")}] (clojure.core/cond-> {} (letvar588740 "TableNames") (clojure.core/assoc :table-names (deser-table-name-list (clojure.core/get-in letvar588740 ["TableNames"]))) (letvar588740 "LastEvaluatedTableName") (clojure.core/assoc :last-evaluated-table-name (deser-table-name (clojure.core/get-in letvar588740 ["LastEvaluatedTableName"])))))))

(clojure.core/defn- response-batch-get-item-output ([input] (response-batch-get-item-output nil input)) ([resultWrapper588742 input] (clojure.core/let [rawinput588741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588743 {"Responses" (rawinput588741 "Responses"), "UnprocessedKeys" (rawinput588741 "UnprocessedKeys")}] (clojure.core/cond-> {} (letvar588743 "Responses") (clojure.core/assoc :responses (deser-batch-get-response-map (clojure.core/get-in letvar588743 ["Responses"]))) (letvar588743 "UnprocessedKeys") (clojure.core/assoc :unprocessed-keys (deser-batch-get-request-map (clojure.core/get-in letvar588743 ["UnprocessedKeys"])))))))

(clojure.core/defn- response-put-item-output ([input] (response-put-item-output nil input)) ([resultWrapper588745 input] (clojure.core/let [rawinput588744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588746 {"Attributes" (rawinput588744 "Attributes"), "ConsumedCapacityUnits" (rawinput588744 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588746 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar588746 ["Attributes"]))) (letvar588746 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588746 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-delete-table-output ([input] (response-delete-table-output nil input)) ([resultWrapper588748 input] (clojure.core/let [rawinput588747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588749 {"TableDescription" (rawinput588747 "TableDescription")}] (clojure.core/cond-> {} (letvar588749 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar588749 ["TableDescription"])))))))

(clojure.core/defn- response-batch-write-item-output ([input] (response-batch-write-item-output nil input)) ([resultWrapper588751 input] (clojure.core/let [rawinput588750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588752 {"Responses" (rawinput588750 "Responses"), "UnprocessedItems" (rawinput588750 "UnprocessedItems")}] (clojure.core/cond-> {} (letvar588752 "Responses") (clojure.core/assoc :responses (deser-batch-write-response-map (clojure.core/get-in letvar588752 ["Responses"]))) (letvar588752 "UnprocessedItems") (clojure.core/assoc :unprocessed-items (deser-batch-write-item-request-map (clojure.core/get-in letvar588752 ["UnprocessedItems"])))))))

(clojure.core/defn- response-scan-output ([input] (response-scan-output nil input)) ([resultWrapper588754 input] (clojure.core/let [rawinput588753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588755 {"Items" (rawinput588753 "Items"), "Count" (rawinput588753 "Count"), "ScannedCount" (rawinput588753 "ScannedCount"), "LastEvaluatedKey" (rawinput588753 "LastEvaluatedKey"), "ConsumedCapacityUnits" (rawinput588753 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar588755 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar588755 ["Items"]))) (letvar588755 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar588755 ["Count"]))) (letvar588755 "ScannedCount") (clojure.core/assoc :scanned-count (deser-integer (clojure.core/get-in letvar588755 ["ScannedCount"]))) (letvar588755 "LastEvaluatedKey") (clojure.core/assoc :last-evaluated-key (deser-key (clojure.core/get-in letvar588755 ["LastEvaluatedKey"]))) (letvar588755 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar588755 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-conditional-check-failed-exception ([input] (response-conditional-check-failed-exception nil input)) ([resultWrapper588757 input] (clojure.core/let [rawinput588756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588758 {"message" (rawinput588756 "message")}] (clojure.core/cond-> {} (letvar588758 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588758 ["message"])))))))

(clojure.core/defn- response-create-table-output ([input] (response-create-table-output nil input)) ([resultWrapper588760 input] (clojure.core/let [rawinput588759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588761 {"TableDescription" (rawinput588759 "TableDescription")}] (clojure.core/cond-> {} (letvar588761 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar588761 ["TableDescription"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper588763 input] (clojure.core/let [rawinput588762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588764 {"message" (rawinput588762 "message")}] (clojure.core/cond-> {} (letvar588764 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588764 ["message"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper588766 input] (clojure.core/let [rawinput588765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar588767 {"message" (rawinput588765 "message")}] (clojure.core/cond-> {} (letvar588767 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar588767 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 65535))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
