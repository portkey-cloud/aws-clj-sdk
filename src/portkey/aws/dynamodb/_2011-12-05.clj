...
(clojure.core/defn- response-update-item-output ([input] (response-update-item-output nil input)) ([resultWrapper1674171 input] (clojure.core/let [rawinput1674170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674172 {"Attributes" (rawinput1674170 "Attributes"), "ConsumedCapacityUnits" (rawinput1674170 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674172 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar1674172 ["Attributes"]))) (letvar1674172 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674172 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-delete-item-output ([input] (response-delete-item-output nil input)) ([resultWrapper1674174 input] (clojure.core/let [rawinput1674173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674175 {"Attributes" (rawinput1674173 "Attributes"), "ConsumedCapacityUnits" (rawinput1674173 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674175 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar1674175 ["Attributes"]))) (letvar1674175 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674175 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-get-item-output ([input] (response-get-item-output nil input)) ([resultWrapper1674177 input] (clojure.core/let [rawinput1674176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674178 {"Item" (rawinput1674176 "Item"), "ConsumedCapacityUnits" (rawinput1674176 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674178 "Item") (clojure.core/assoc :item (deser-attribute-map (clojure.core/get-in letvar1674178 ["Item"]))) (letvar1674178 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674178 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-update-table-output ([input] (response-update-table-output nil input)) ([resultWrapper1674180 input] (clojure.core/let [rawinput1674179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674181 {"TableDescription" (rawinput1674179 "TableDescription")}] (clojure.core/cond-> {} (letvar1674181 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar1674181 ["TableDescription"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1674183 input] (clojure.core/let [rawinput1674182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674184 {"message" (rawinput1674182 "message")}] (clojure.core/cond-> {} (letvar1674184 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674184 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1674186 input] (clojure.core/let [rawinput1674185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674187 {"message" (rawinput1674185 "message")}] (clojure.core/cond-> {} (letvar1674187 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674187 ["message"])))))))

(clojure.core/defn- response-describe-table-output ([input] (response-describe-table-output nil input)) ([resultWrapper1674189 input] (clojure.core/let [rawinput1674188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674190 {"Table" (rawinput1674188 "Table")}] (clojure.core/cond-> {} (letvar1674190 "Table") (clojure.core/assoc :table (deser-table-description (clojure.core/get-in letvar1674190 ["Table"])))))))

(clojure.core/defn- response-query-output ([input] (response-query-output nil input)) ([resultWrapper1674192 input] (clojure.core/let [rawinput1674191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674193 {"Items" (rawinput1674191 "Items"), "Count" (rawinput1674191 "Count"), "LastEvaluatedKey" (rawinput1674191 "LastEvaluatedKey"), "ConsumedCapacityUnits" (rawinput1674191 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674193 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar1674193 ["Items"]))) (letvar1674193 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar1674193 ["Count"]))) (letvar1674193 "LastEvaluatedKey") (clojure.core/assoc :last-evaluated-key (deser-key (clojure.core/get-in letvar1674193 ["LastEvaluatedKey"]))) (letvar1674193 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674193 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1674195 input] (clojure.core/let [rawinput1674194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674196 {"message" (rawinput1674194 "message")}] (clojure.core/cond-> {} (letvar1674196 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674196 ["message"])))))))

(clojure.core/defn- response-list-tables-output ([input] (response-list-tables-output nil input)) ([resultWrapper1674198 input] (clojure.core/let [rawinput1674197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674199 {"TableNames" (rawinput1674197 "TableNames"), "LastEvaluatedTableName" (rawinput1674197 "LastEvaluatedTableName")}] (clojure.core/cond-> {} (letvar1674199 "TableNames") (clojure.core/assoc :table-names (deser-table-name-list (clojure.core/get-in letvar1674199 ["TableNames"]))) (letvar1674199 "LastEvaluatedTableName") (clojure.core/assoc :last-evaluated-table-name (deser-table-name (clojure.core/get-in letvar1674199 ["LastEvaluatedTableName"])))))))

(clojure.core/defn- response-batch-get-item-output ([input] (response-batch-get-item-output nil input)) ([resultWrapper1674201 input] (clojure.core/let [rawinput1674200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674202 {"Responses" (rawinput1674200 "Responses"), "UnprocessedKeys" (rawinput1674200 "UnprocessedKeys")}] (clojure.core/cond-> {} (letvar1674202 "Responses") (clojure.core/assoc :responses (deser-batch-get-response-map (clojure.core/get-in letvar1674202 ["Responses"]))) (letvar1674202 "UnprocessedKeys") (clojure.core/assoc :unprocessed-keys (deser-batch-get-request-map (clojure.core/get-in letvar1674202 ["UnprocessedKeys"])))))))

(clojure.core/defn- response-put-item-output ([input] (response-put-item-output nil input)) ([resultWrapper1674204 input] (clojure.core/let [rawinput1674203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674205 {"Attributes" (rawinput1674203 "Attributes"), "ConsumedCapacityUnits" (rawinput1674203 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674205 "Attributes") (clojure.core/assoc :attributes (deser-attribute-map (clojure.core/get-in letvar1674205 ["Attributes"]))) (letvar1674205 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674205 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-delete-table-output ([input] (response-delete-table-output nil input)) ([resultWrapper1674207 input] (clojure.core/let [rawinput1674206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674208 {"TableDescription" (rawinput1674206 "TableDescription")}] (clojure.core/cond-> {} (letvar1674208 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar1674208 ["TableDescription"])))))))

(clojure.core/defn- response-batch-write-item-output ([input] (response-batch-write-item-output nil input)) ([resultWrapper1674210 input] (clojure.core/let [rawinput1674209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674211 {"Responses" (rawinput1674209 "Responses"), "UnprocessedItems" (rawinput1674209 "UnprocessedItems")}] (clojure.core/cond-> {} (letvar1674211 "Responses") (clojure.core/assoc :responses (deser-batch-write-response-map (clojure.core/get-in letvar1674211 ["Responses"]))) (letvar1674211 "UnprocessedItems") (clojure.core/assoc :unprocessed-items (deser-batch-write-item-request-map (clojure.core/get-in letvar1674211 ["UnprocessedItems"])))))))

(clojure.core/defn- response-scan-output ([input] (response-scan-output nil input)) ([resultWrapper1674213 input] (clojure.core/let [rawinput1674212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674214 {"Items" (rawinput1674212 "Items"), "Count" (rawinput1674212 "Count"), "ScannedCount" (rawinput1674212 "ScannedCount"), "LastEvaluatedKey" (rawinput1674212 "LastEvaluatedKey"), "ConsumedCapacityUnits" (rawinput1674212 "ConsumedCapacityUnits")}] (clojure.core/cond-> {} (letvar1674214 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar1674214 ["Items"]))) (letvar1674214 "Count") (clojure.core/assoc :count (deser-integer (clojure.core/get-in letvar1674214 ["Count"]))) (letvar1674214 "ScannedCount") (clojure.core/assoc :scanned-count (deser-integer (clojure.core/get-in letvar1674214 ["ScannedCount"]))) (letvar1674214 "LastEvaluatedKey") (clojure.core/assoc :last-evaluated-key (deser-key (clojure.core/get-in letvar1674214 ["LastEvaluatedKey"]))) (letvar1674214 "ConsumedCapacityUnits") (clojure.core/assoc :consumed-capacity-units (deser-consumed-capacity-units (clojure.core/get-in letvar1674214 ["ConsumedCapacityUnits"])))))))

(clojure.core/defn- response-conditional-check-failed-exception ([input] (response-conditional-check-failed-exception nil input)) ([resultWrapper1674216 input] (clojure.core/let [rawinput1674215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674217 {"message" (rawinput1674215 "message")}] (clojure.core/cond-> {} (letvar1674217 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674217 ["message"])))))))

(clojure.core/defn- response-create-table-output ([input] (response-create-table-output nil input)) ([resultWrapper1674219 input] (clojure.core/let [rawinput1674218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674220 {"TableDescription" (rawinput1674218 "TableDescription")}] (clojure.core/cond-> {} (letvar1674220 "TableDescription") (clojure.core/assoc :table-description (deser-table-description (clojure.core/get-in letvar1674220 ["TableDescription"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1674222 input] (clojure.core/let [rawinput1674221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674223 {"message" (rawinput1674221 "message")}] (clojure.core/cond-> {} (letvar1674223 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674223 ["message"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1674225 input] (clojure.core/let [rawinput1674224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1674226 {"message" (rawinput1674224 "message")}] (clojure.core/cond-> {} (letvar1674226 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1674226 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 65535))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.dynamodb.-2011-12-05/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
