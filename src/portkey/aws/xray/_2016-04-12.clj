...
(clojure.core/defn- response-rule-limit-exceeded-exception ([input] (response-rule-limit-exceeded-exception nil input)) ([resultWrapper1923449 input] (clojure.core/let [rawinput1923448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923450 {"Message" (rawinput1923448 "Message")}] (clojure.core/cond-> {} (letvar1923450 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1923450 ["Message"])))))))

(clojure.core/defn- response-get-sampling-rules-result ([input] (response-get-sampling-rules-result nil input)) ([resultWrapper1923452 input] (clojure.core/let [rawinput1923451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923453 {"SamplingRuleRecords" (rawinput1923451 "SamplingRuleRecords"), "NextToken" (rawinput1923451 "NextToken")}] (clojure.core/cond-> {} (letvar1923453 "SamplingRuleRecords") (clojure.core/assoc :sampling-rule-records (deser-sampling-rule-record-list (clojure.core/get-in letvar1923453 ["SamplingRuleRecords"]))) (letvar1923453 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923453 ["NextToken"])))))))

(clojure.core/defn- response-update-group-result ([input] (response-update-group-result nil input)) ([resultWrapper1923455 input] (clojure.core/let [rawinput1923454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923456 {"Group" (rawinput1923454 "Group")}] (clojure.core/cond-> {} (letvar1923456 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1923456 ["Group"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1923458 input] (clojure.core/let [rawinput1923457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923459 {"Message" (rawinput1923457 "Message")}] (clojure.core/cond-> {} (letvar1923459 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1923459 ["Message"])))))))

(clojure.core/defn- response-get-group-result ([input] (response-get-group-result nil input)) ([resultWrapper1923461 input] (clojure.core/let [rawinput1923460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923462 {"Group" (rawinput1923460 "Group")}] (clojure.core/cond-> {} (letvar1923462 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1923462 ["Group"])))))))

(clojure.core/defn- response-get-encryption-config-result ([input] (response-get-encryption-config-result nil input)) ([resultWrapper1923464 input] (clojure.core/let [rawinput1923463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923465 {"EncryptionConfig" (rawinput1923463 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1923465 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1923465 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-telemetry-records-result ([input] (response-put-telemetry-records-result nil input)) ([resultWrapper1923467 input] (clojure.core/let [rawinput1923466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923468 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-trace-summaries-result ([input] (response-get-trace-summaries-result nil input)) ([resultWrapper1923470 input] (clojure.core/let [rawinput1923469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923471 {"TraceSummaries" (rawinput1923469 "TraceSummaries"), "ApproximateTime" (rawinput1923469 "ApproximateTime"), "TracesProcessedCount" (rawinput1923469 "TracesProcessedCount"), "NextToken" (rawinput1923469 "NextToken")}] (clojure.core/cond-> {} (letvar1923471 "TraceSummaries") (clojure.core/assoc :trace-summaries (deser-trace-summary-list (clojure.core/get-in letvar1923471 ["TraceSummaries"]))) (letvar1923471 "ApproximateTime") (clojure.core/assoc :approximate-time (deser-timestamp (clojure.core/get-in letvar1923471 ["ApproximateTime"]))) (letvar1923471 "TracesProcessedCount") (clojure.core/assoc :traces-processed-count (deser-nullable-long (clojure.core/get-in letvar1923471 ["TracesProcessedCount"]))) (letvar1923471 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923471 ["NextToken"])))))))

(clojure.core/defn- response-update-sampling-rule-result ([input] (response-update-sampling-rule-result nil input)) ([resultWrapper1923473 input] (clojure.core/let [rawinput1923472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923474 {"SamplingRuleRecord" (rawinput1923472 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1923474 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1923474 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-put-encryption-config-result ([input] (response-put-encryption-config-result nil input)) ([resultWrapper1923476 input] (clojure.core/let [rawinput1923475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923477 {"EncryptionConfig" (rawinput1923475 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1923477 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1923477 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-trace-segments-result ([input] (response-put-trace-segments-result nil input)) ([resultWrapper1923479 input] (clojure.core/let [rawinput1923478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923480 {"UnprocessedTraceSegments" (rawinput1923478 "UnprocessedTraceSegments")}] (clojure.core/cond-> {} (letvar1923480 "UnprocessedTraceSegments") (clojure.core/assoc :unprocessed-trace-segments (deser-unprocessed-trace-segment-list (clojure.core/get-in letvar1923480 ["UnprocessedTraceSegments"])))))))

(clojure.core/defn- response-get-trace-graph-result ([input] (response-get-trace-graph-result nil input)) ([resultWrapper1923482 input] (clojure.core/let [rawinput1923481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923483 {"Services" (rawinput1923481 "Services"), "NextToken" (rawinput1923481 "NextToken")}] (clojure.core/cond-> {} (letvar1923483 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1923483 ["Services"]))) (letvar1923483 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923483 ["NextToken"])))))))

(clojure.core/defn- response-create-group-result ([input] (response-create-group-result nil input)) ([resultWrapper1923485 input] (clojure.core/let [rawinput1923484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923486 {"Group" (rawinput1923484 "Group")}] (clojure.core/cond-> {} (letvar1923486 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1923486 ["Group"])))))))

(clojure.core/defn- response-get-sampling-statistic-summaries-result ([input] (response-get-sampling-statistic-summaries-result nil input)) ([resultWrapper1923488 input] (clojure.core/let [rawinput1923487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923489 {"SamplingStatisticSummaries" (rawinput1923487 "SamplingStatisticSummaries"), "NextToken" (rawinput1923487 "NextToken")}] (clojure.core/cond-> {} (letvar1923489 "SamplingStatisticSummaries") (clojure.core/assoc :sampling-statistic-summaries (deser-sampling-statistic-summary-list (clojure.core/get-in letvar1923489 ["SamplingStatisticSummaries"]))) (letvar1923489 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923489 ["NextToken"])))))))

(clojure.core/defn- response-create-sampling-rule-result ([input] (response-create-sampling-rule-result nil input)) ([resultWrapper1923491 input] (clojure.core/let [rawinput1923490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923492 {"SamplingRuleRecord" (rawinput1923490 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1923492 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1923492 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-sampling-rule-result ([input] (response-delete-sampling-rule-result nil input)) ([resultWrapper1923494 input] (clojure.core/let [rawinput1923493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923495 {"SamplingRuleRecord" (rawinput1923493 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1923495 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1923495 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-group-result ([input] (response-delete-group-result nil input)) ([resultWrapper1923497 input] (clojure.core/let [rawinput1923496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923498 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-sampling-targets-result ([input] (response-get-sampling-targets-result nil input)) ([resultWrapper1923500 input] (clojure.core/let [rawinput1923499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923501 {"SamplingTargetDocuments" (rawinput1923499 "SamplingTargetDocuments"), "LastRuleModification" (rawinput1923499 "LastRuleModification"), "UnprocessedStatistics" (rawinput1923499 "UnprocessedStatistics")}] (clojure.core/cond-> {} (letvar1923501 "SamplingTargetDocuments") (clojure.core/assoc :sampling-target-documents (deser-sampling-target-document-list (clojure.core/get-in letvar1923501 ["SamplingTargetDocuments"]))) (letvar1923501 "LastRuleModification") (clojure.core/assoc :last-rule-modification (deser-timestamp (clojure.core/get-in letvar1923501 ["LastRuleModification"]))) (letvar1923501 "UnprocessedStatistics") (clojure.core/assoc :unprocessed-statistics (deser-unprocessed-statistics-list (clojure.core/get-in letvar1923501 ["UnprocessedStatistics"])))))))

(clojure.core/defn- response-get-groups-result ([input] (response-get-groups-result nil input)) ([resultWrapper1923503 input] (clojure.core/let [rawinput1923502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923504 {"Groups" (rawinput1923502 "Groups"), "NextToken" (rawinput1923502 "NextToken")}] (clojure.core/cond-> {} (letvar1923504 "Groups") (clojure.core/assoc :groups (deser-group-summary-list (clojure.core/get-in letvar1923504 ["Groups"]))) (letvar1923504 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923504 ["NextToken"])))))))

(clojure.core/defn- response-get-service-graph-result ([input] (response-get-service-graph-result nil input)) ([resultWrapper1923506 input] (clojure.core/let [rawinput1923505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923507 {"StartTime" (rawinput1923505 "StartTime"), "EndTime" (rawinput1923505 "EndTime"), "Services" (rawinput1923505 "Services"), "ContainsOldGroupVersions" (rawinput1923505 "ContainsOldGroupVersions"), "NextToken" (rawinput1923505 "NextToken")}] (clojure.core/cond-> {} (letvar1923507 "StartTime") (clojure.core/assoc :start-time (deser-timestamp (clojure.core/get-in letvar1923507 ["StartTime"]))) (letvar1923507 "EndTime") (clojure.core/assoc :end-time (deser-timestamp (clojure.core/get-in letvar1923507 ["EndTime"]))) (letvar1923507 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1923507 ["Services"]))) (letvar1923507 "ContainsOldGroupVersions") (clojure.core/assoc :contains-old-group-versions (deser-boolean (clojure.core/get-in letvar1923507 ["ContainsOldGroupVersions"]))) (letvar1923507 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923507 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-traces-result ([input] (response-batch-get-traces-result nil input)) ([resultWrapper1923509 input] (clojure.core/let [rawinput1923508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923510 {"Traces" (rawinput1923508 "Traces"), "UnprocessedTraceIds" (rawinput1923508 "UnprocessedTraceIds"), "NextToken" (rawinput1923508 "NextToken")}] (clojure.core/cond-> {} (letvar1923510 "Traces") (clojure.core/assoc :traces (deser-trace-list (clojure.core/get-in letvar1923510 ["Traces"]))) (letvar1923510 "UnprocessedTraceIds") (clojure.core/assoc :unprocessed-trace-ids (deser-unprocessed-trace-id-list (clojure.core/get-in letvar1923510 ["UnprocessedTraceIds"]))) (letvar1923510 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1923510 ["NextToken"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1923512 input] (clojure.core/let [rawinput1923511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1923513 {"Message" (rawinput1923511 "Message")}] (clojure.core/cond-> {} (letvar1923513 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1923513 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/service-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/rule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/encryption-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3000))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/url-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/attribute-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/ec-2-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 24 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 24))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/service-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/get-groups-next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 400))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/http-method (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10))))
