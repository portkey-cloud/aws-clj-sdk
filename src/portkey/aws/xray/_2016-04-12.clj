...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/error-statistics (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.error-statistics/ThrottleCount :portkey.aws.xray.-2016-04-12.error-statistics/OtherCount :portkey.aws.xray.-2016-04-12.error-statistics/TotalCount]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/annotation-value (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.annotation-value/NumberValue :portkey.aws.xray.-2016-04-12.annotation-value/BooleanValue :portkey.aws.xray.-2016-04-12.annotation-value/StringValue]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/invalid-request-exception (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/trace (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.trace/Id :portkey.aws.xray.-2016-04-12.trace/Duration :portkey.aws.xray.-2016-04-12.trace/Segments]))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/put-telemetry-records-result (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/trace-user (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.trace-user/UserName :portkey.aws.xray.-2016-04-12/ServiceIds]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 35 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/alias (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.alias/Name :portkey.aws.xray.-2016-04-12.alias/Names :portkey.aws.xray.-2016-04-12.alias/Type]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/unprocessed-trace-segment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.unprocessed-trace-segment/Id :portkey.aws.xray.-2016-04-12.unprocessed-trace-segment/ErrorCode :portkey.aws.xray.-2016-04-12.unprocessed-trace-segment/Message]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 0 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/segment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.segment/Id :portkey.aws.xray.-2016-04-12.segment/Document]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/fault-statistics (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.fault-statistics/OtherCount :portkey.aws.xray.-2016-04-12.fault-statistics/TotalCount]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/service-id (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.service-id/Name :portkey.aws.xray.-2016-04-12.service-id/Names :portkey.aws.xray.-2016-04-12.service-id/AccountId :portkey.aws.xray.-2016-04-12.service-id/Type]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/put-trace-segments-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.-2016-04-12.put-trace-segments-request/TraceSegmentDocuments] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/value-with-service-ids (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12/AnnotationValue :portkey.aws.xray.-2016-04-12/ServiceIds]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/http (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.http/HttpURL :portkey.aws.xray.-2016-04-12.http/HttpStatus :portkey.aws.xray.-2016-04-12.http/HttpMethod :portkey.aws.xray.-2016-04-12.http/UserAgent :portkey.aws.xray.-2016-04-12.http/ClientIp]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/batch-get-traces-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.-2016-04-12.batch-get-traces-request/TraceIds] :opt-un [:portkey.aws.xray.-2016-04-12.batch-get-traces-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/put-trace-segments-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.put-trace-segments-result/UnprocessedTraceSegments]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/get-trace-graph-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.get-trace-graph-result/Services :portkey.aws.xray.-2016-04-12.get-trace-graph-result/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/segment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 16 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 16))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/throttled-exception (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/get-trace-graph-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.-2016-04-12.get-trace-graph-request/TraceIds] :opt-un [:portkey.aws.xray.-2016-04-12.get-trace-graph-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/histogram-entry (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.-2016-04-12.histogram-entry/Value :portkey.aws.xray.-2016-04-12.histogram-entry/Count]))

(clojure.core/defn batch-get-traces [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/Traces" input__8278__auto__ :portkey.aws.xray.-2016-04-12/batch-get-traces-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/batch-get-traces-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
...
(clojure.core/defn get-service-graph [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/ServiceGraph" input__8278__auto__ :portkey.aws.xray.-2016-04-12/get-service-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/get-service-graph-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
...
(clojure.core/defn get-trace-graph [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/TraceGraph" input__8278__auto__ :portkey.aws.xray.-2016-04-12/get-trace-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/get-trace-graph-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
...
(clojure.core/defn get-trace-summaries [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/TraceSummaries" input__8278__auto__ :portkey.aws.xray.-2016-04-12/get-trace-summaries-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/get-trace-summaries-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
...
(clojure.core/defn put-telemetry-records [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/TelemetryRecords" input__8278__auto__ :portkey.aws.xray.-2016-04-12/put-telemetry-records-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/put-telemetry-records-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
...
(clojure.core/defn put-trace-segments [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray.-2016-04-12/endpoints "POST" "/TraceSegments" input__8278__auto__ :portkey.aws.xray.-2016-04-12/put-trace-segments-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray.-2016-04-12/put-trace-segments-result {"InvalidRequestException" :portkey.aws.xray.-2016-04-12/invalid-request-exception, "ThrottledException" :portkey.aws.xray.-2016-04-12/throttled-exception}))
