...
(clojure.core/defn- response-rule-limit-exceeded-exception ([input] (response-rule-limit-exceeded-exception nil input)) ([resultWrapper495316 input] (clojure.core/let [rawinput495315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495317 {"Message" (rawinput495315 "Message")}] (clojure.core/cond-> {} (letvar495317 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar495317 ["Message"])))))))

(clojure.core/defn- response-get-sampling-rules-result ([input] (response-get-sampling-rules-result nil input)) ([resultWrapper495319 input] (clojure.core/let [rawinput495318 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495320 {"SamplingRuleRecords" (rawinput495318 "SamplingRuleRecords"), "NextToken" (rawinput495318 "NextToken")}] (clojure.core/cond-> {} (letvar495320 "SamplingRuleRecords") (clojure.core/assoc :sampling-rule-records (deser-sampling-rule-record-list (clojure.core/get-in letvar495320 ["SamplingRuleRecords"]))) (letvar495320 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495320 ["NextToken"])))))))

(clojure.core/defn- response-update-group-result ([input] (response-update-group-result nil input)) ([resultWrapper495322 input] (clojure.core/let [rawinput495321 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495323 {"Group" (rawinput495321 "Group")}] (clojure.core/cond-> {} (letvar495323 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar495323 ["Group"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper495325 input] (clojure.core/let [rawinput495324 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495326 {"Message" (rawinput495324 "Message")}] (clojure.core/cond-> {} (letvar495326 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar495326 ["Message"])))))))

(clojure.core/defn- response-get-group-result ([input] (response-get-group-result nil input)) ([resultWrapper495328 input] (clojure.core/let [rawinput495327 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495329 {"Group" (rawinput495327 "Group")}] (clojure.core/cond-> {} (letvar495329 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar495329 ["Group"])))))))

(clojure.core/defn- response-get-encryption-config-result ([input] (response-get-encryption-config-result nil input)) ([resultWrapper495331 input] (clojure.core/let [rawinput495330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495332 {"EncryptionConfig" (rawinput495330 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar495332 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar495332 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-telemetry-records-result ([input] (response-put-telemetry-records-result nil input)) ([resultWrapper495334 input] (clojure.core/let [rawinput495333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495335 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-trace-summaries-result ([input] (response-get-trace-summaries-result nil input)) ([resultWrapper495337 input] (clojure.core/let [rawinput495336 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495338 {"TraceSummaries" (rawinput495336 "TraceSummaries"), "ApproximateTime" (rawinput495336 "ApproximateTime"), "TracesProcessedCount" (rawinput495336 "TracesProcessedCount"), "NextToken" (rawinput495336 "NextToken")}] (clojure.core/cond-> {} (letvar495338 "TraceSummaries") (clojure.core/assoc :trace-summaries (deser-trace-summary-list (clojure.core/get-in letvar495338 ["TraceSummaries"]))) (letvar495338 "ApproximateTime") (clojure.core/assoc :approximate-time (deser-timestamp (clojure.core/get-in letvar495338 ["ApproximateTime"]))) (letvar495338 "TracesProcessedCount") (clojure.core/assoc :traces-processed-count (deser-nullable-long (clojure.core/get-in letvar495338 ["TracesProcessedCount"]))) (letvar495338 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495338 ["NextToken"])))))))

(clojure.core/defn- response-update-sampling-rule-result ([input] (response-update-sampling-rule-result nil input)) ([resultWrapper495340 input] (clojure.core/let [rawinput495339 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495341 {"SamplingRuleRecord" (rawinput495339 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar495341 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar495341 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-put-encryption-config-result ([input] (response-put-encryption-config-result nil input)) ([resultWrapper495343 input] (clojure.core/let [rawinput495342 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495344 {"EncryptionConfig" (rawinput495342 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar495344 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar495344 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-trace-segments-result ([input] (response-put-trace-segments-result nil input)) ([resultWrapper495346 input] (clojure.core/let [rawinput495345 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495347 {"UnprocessedTraceSegments" (rawinput495345 "UnprocessedTraceSegments")}] (clojure.core/cond-> {} (letvar495347 "UnprocessedTraceSegments") (clojure.core/assoc :unprocessed-trace-segments (deser-unprocessed-trace-segment-list (clojure.core/get-in letvar495347 ["UnprocessedTraceSegments"])))))))

(clojure.core/defn- response-get-trace-graph-result ([input] (response-get-trace-graph-result nil input)) ([resultWrapper495349 input] (clojure.core/let [rawinput495348 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495350 {"Services" (rawinput495348 "Services"), "NextToken" (rawinput495348 "NextToken")}] (clojure.core/cond-> {} (letvar495350 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar495350 ["Services"]))) (letvar495350 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495350 ["NextToken"])))))))

(clojure.core/defn- response-create-group-result ([input] (response-create-group-result nil input)) ([resultWrapper495352 input] (clojure.core/let [rawinput495351 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495353 {"Group" (rawinput495351 "Group")}] (clojure.core/cond-> {} (letvar495353 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar495353 ["Group"])))))))

(clojure.core/defn- response-get-sampling-statistic-summaries-result ([input] (response-get-sampling-statistic-summaries-result nil input)) ([resultWrapper495355 input] (clojure.core/let [rawinput495354 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495356 {"SamplingStatisticSummaries" (rawinput495354 "SamplingStatisticSummaries"), "NextToken" (rawinput495354 "NextToken")}] (clojure.core/cond-> {} (letvar495356 "SamplingStatisticSummaries") (clojure.core/assoc :sampling-statistic-summaries (deser-sampling-statistic-summary-list (clojure.core/get-in letvar495356 ["SamplingStatisticSummaries"]))) (letvar495356 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495356 ["NextToken"])))))))

(clojure.core/defn- response-create-sampling-rule-result ([input] (response-create-sampling-rule-result nil input)) ([resultWrapper495358 input] (clojure.core/let [rawinput495357 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495359 {"SamplingRuleRecord" (rawinput495357 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar495359 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar495359 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-sampling-rule-result ([input] (response-delete-sampling-rule-result nil input)) ([resultWrapper495361 input] (clojure.core/let [rawinput495360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495362 {"SamplingRuleRecord" (rawinput495360 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar495362 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar495362 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-group-result ([input] (response-delete-group-result nil input)) ([resultWrapper495364 input] (clojure.core/let [rawinput495363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495365 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-sampling-targets-result ([input] (response-get-sampling-targets-result nil input)) ([resultWrapper495367 input] (clojure.core/let [rawinput495366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495368 {"SamplingTargetDocuments" (rawinput495366 "SamplingTargetDocuments"), "LastRuleModification" (rawinput495366 "LastRuleModification"), "UnprocessedStatistics" (rawinput495366 "UnprocessedStatistics")}] (clojure.core/cond-> {} (letvar495368 "SamplingTargetDocuments") (clojure.core/assoc :sampling-target-documents (deser-sampling-target-document-list (clojure.core/get-in letvar495368 ["SamplingTargetDocuments"]))) (letvar495368 "LastRuleModification") (clojure.core/assoc :last-rule-modification (deser-timestamp (clojure.core/get-in letvar495368 ["LastRuleModification"]))) (letvar495368 "UnprocessedStatistics") (clojure.core/assoc :unprocessed-statistics (deser-unprocessed-statistics-list (clojure.core/get-in letvar495368 ["UnprocessedStatistics"])))))))

(clojure.core/defn- response-get-groups-result ([input] (response-get-groups-result nil input)) ([resultWrapper495370 input] (clojure.core/let [rawinput495369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495371 {"Groups" (rawinput495369 "Groups"), "NextToken" (rawinput495369 "NextToken")}] (clojure.core/cond-> {} (letvar495371 "Groups") (clojure.core/assoc :groups (deser-group-summary-list (clojure.core/get-in letvar495371 ["Groups"]))) (letvar495371 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495371 ["NextToken"])))))))

(clojure.core/defn- response-get-service-graph-result ([input] (response-get-service-graph-result nil input)) ([resultWrapper495373 input] (clojure.core/let [rawinput495372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495374 {"StartTime" (rawinput495372 "StartTime"), "EndTime" (rawinput495372 "EndTime"), "Services" (rawinput495372 "Services"), "ContainsOldGroupVersions" (rawinput495372 "ContainsOldGroupVersions"), "NextToken" (rawinput495372 "NextToken")}] (clojure.core/cond-> {} (letvar495374 "StartTime") (clojure.core/assoc :start-time (deser-timestamp (clojure.core/get-in letvar495374 ["StartTime"]))) (letvar495374 "EndTime") (clojure.core/assoc :end-time (deser-timestamp (clojure.core/get-in letvar495374 ["EndTime"]))) (letvar495374 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar495374 ["Services"]))) (letvar495374 "ContainsOldGroupVersions") (clojure.core/assoc :contains-old-group-versions (deser-boolean (clojure.core/get-in letvar495374 ["ContainsOldGroupVersions"]))) (letvar495374 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495374 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-traces-result ([input] (response-batch-get-traces-result nil input)) ([resultWrapper495376 input] (clojure.core/let [rawinput495375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495377 {"Traces" (rawinput495375 "Traces"), "UnprocessedTraceIds" (rawinput495375 "UnprocessedTraceIds"), "NextToken" (rawinput495375 "NextToken")}] (clojure.core/cond-> {} (letvar495377 "Traces") (clojure.core/assoc :traces (deser-trace-list (clojure.core/get-in letvar495377 ["Traces"]))) (letvar495377 "UnprocessedTraceIds") (clojure.core/assoc :unprocessed-trace-ids (deser-unprocessed-trace-id-list (clojure.core/get-in letvar495377 ["UnprocessedTraceIds"]))) (letvar495377 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar495377 ["NextToken"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper495379 input] (clojure.core/let [rawinput495378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar495380 {"Message" (rawinput495378 "Message")}] (clojure.core/cond-> {} (letvar495380 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar495380 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/service-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/rule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/encryption-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 3000))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/url-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/attribute-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/ec-2-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 24 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 24))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/service-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/get-groups-next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 400))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__)))))

(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray.-2016-04-12/http-method (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 10))))
