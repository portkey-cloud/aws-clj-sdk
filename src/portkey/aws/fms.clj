...
(clojure.core/defn- response-list-compliance-status-response ([input] (response-list-compliance-status-response nil input)) ([resultWrapper1753958 input] (clojure.core/let [rawinput1753957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753959 {"PolicyComplianceStatusList" (rawinput1753957 "PolicyComplianceStatusList"), "NextToken" (rawinput1753957 "NextToken")}] (clojure.core/cond-> {} (letvar1753959 "PolicyComplianceStatusList") (clojure.core/assoc :policy-compliance-status-list (deser-policy-compliance-status-list (clojure.core/get-in letvar1753959 ["PolicyComplianceStatusList"]))) (letvar1753959 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1753959 ["NextToken"])))))))

(clojure.core/defn- response-list-member-accounts-response ([input] (response-list-member-accounts-response nil input)) ([resultWrapper1753961 input] (clojure.core/let [rawinput1753960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753962 {"MemberAccounts" (rawinput1753960 "MemberAccounts"), "NextToken" (rawinput1753960 "NextToken")}] (clojure.core/cond-> {} (letvar1753962 "MemberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar1753962 ["MemberAccounts"]))) (letvar1753962 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1753962 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1753964 input] (clojure.core/let [rawinput1753963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753965 {"Message" (rawinput1753963 "Message")}] (clojure.core/cond-> {} (letvar1753965 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753965 ["Message"])))))))

(clojure.core/defn- response-get-compliance-detail-response ([input] (response-get-compliance-detail-response nil input)) ([resultWrapper1753967 input] (clojure.core/let [rawinput1753966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753968 {"PolicyComplianceDetail" (rawinput1753966 "PolicyComplianceDetail")}] (clojure.core/cond-> {} (letvar1753968 "PolicyComplianceDetail") (clojure.core/assoc :policy-compliance-detail (deser-policy-compliance-detail (clojure.core/get-in letvar1753968 ["PolicyComplianceDetail"])))))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper1753970 input] (clojure.core/let [rawinput1753969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753971 {"Message" (rawinput1753969 "Message")}] (clojure.core/cond-> {} (letvar1753971 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753971 ["Message"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1753973 input] (clojure.core/let [rawinput1753972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753974 {"Message" (rawinput1753972 "Message")}] (clojure.core/cond-> {} (letvar1753974 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753974 ["Message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1753976 input] (clojure.core/let [rawinput1753975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753977 {"Message" (rawinput1753975 "Message")}] (clojure.core/cond-> {} (letvar1753977 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753977 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1753979 input] (clojure.core/let [rawinput1753978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753980 {"Message" (rawinput1753978 "Message")}] (clojure.core/cond-> {} (letvar1753980 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753980 ["Message"])))))))

(clojure.core/defn- response-get-notification-channel-response ([input] (response-get-notification-channel-response nil input)) ([resultWrapper1753982 input] (clojure.core/let [rawinput1753981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753983 {"SnsTopicArn" (rawinput1753981 "SnsTopicArn"), "SnsRoleName" (rawinput1753981 "SnsRoleName")}] (clojure.core/cond-> {} (letvar1753983 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-resource-arn (clojure.core/get-in letvar1753983 ["SnsTopicArn"]))) (letvar1753983 "SnsRoleName") (clojure.core/assoc :sns-role-name (deser-resource-arn (clojure.core/get-in letvar1753983 ["SnsRoleName"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1753985 input] (clojure.core/let [rawinput1753984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753986 {"Message" (rawinput1753984 "Message")}] (clojure.core/cond-> {} (letvar1753986 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1753986 ["Message"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1753988 input] (clojure.core/let [rawinput1753987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753989 {"Policy" (rawinput1753987 "Policy"), "PolicyArn" (rawinput1753987 "PolicyArn")}] (clojure.core/cond-> {} (letvar1753989 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1753989 ["Policy"]))) (letvar1753989 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1753989 ["PolicyArn"])))))))

(clojure.core/defn- response-get-admin-account-response ([input] (response-get-admin-account-response nil input)) ([resultWrapper1753991 input] (clojure.core/let [rawinput1753990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753992 {"AdminAccount" (rawinput1753990 "AdminAccount"), "RoleStatus" (rawinput1753990 "RoleStatus")}] (clojure.core/cond-> {} (letvar1753992 "AdminAccount") (clojure.core/assoc :admin-account (deser-aws-account-id (clojure.core/get-in letvar1753992 ["AdminAccount"]))) (letvar1753992 "RoleStatus") (clojure.core/assoc :role-status (deser-account-role-status (clojure.core/get-in letvar1753992 ["RoleStatus"])))))))

(clojure.core/defn- response-put-policy-response ([input] (response-put-policy-response nil input)) ([resultWrapper1753994 input] (clojure.core/let [rawinput1753993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753995 {"Policy" (rawinput1753993 "Policy"), "PolicyArn" (rawinput1753993 "PolicyArn")}] (clojure.core/cond-> {} (letvar1753995 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1753995 ["Policy"]))) (letvar1753995 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1753995 ["PolicyArn"])))))))

(clojure.core/defn- response-list-policies-response ([input] (response-list-policies-response nil input)) ([resultWrapper1753997 input] (clojure.core/let [rawinput1753996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1753998 {"PolicyList" (rawinput1753996 "PolicyList"), "NextToken" (rawinput1753996 "NextToken")}] (clojure.core/cond-> {} (letvar1753998 "PolicyList") (clojure.core/assoc :policy-list (deser-policy-summary-list (clojure.core/get-in letvar1753998 ["PolicyList"]))) (letvar1753998 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1753998 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fms/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.fms/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fms/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 36 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.fms/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms/customer-policy-scope-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/managed-service-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.fms/detailed-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/policy-update-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
