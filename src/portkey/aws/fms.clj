...
(clojure.core/defn- response-list-compliance-status-response ([input] (response-list-compliance-status-response nil input)) ([resultWrapper1782676 input] (clojure.core/let [rawinput1782675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782677 {"PolicyComplianceStatusList" (rawinput1782675 "PolicyComplianceStatusList"), "NextToken" (rawinput1782675 "NextToken")}] (clojure.core/cond-> {} (letvar1782677 "PolicyComplianceStatusList") (clojure.core/assoc :policy-compliance-status-list (deser-policy-compliance-status-list (clojure.core/get-in letvar1782677 ["PolicyComplianceStatusList"]))) (letvar1782677 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1782677 ["NextToken"])))))))

(clojure.core/defn- response-list-member-accounts-response ([input] (response-list-member-accounts-response nil input)) ([resultWrapper1782679 input] (clojure.core/let [rawinput1782678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782680 {"MemberAccounts" (rawinput1782678 "MemberAccounts"), "NextToken" (rawinput1782678 "NextToken")}] (clojure.core/cond-> {} (letvar1782680 "MemberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar1782680 ["MemberAccounts"]))) (letvar1782680 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1782680 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1782682 input] (clojure.core/let [rawinput1782681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782683 {"Message" (rawinput1782681 "Message")}] (clojure.core/cond-> {} (letvar1782683 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782683 ["Message"])))))))

(clojure.core/defn- response-get-compliance-detail-response ([input] (response-get-compliance-detail-response nil input)) ([resultWrapper1782685 input] (clojure.core/let [rawinput1782684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782686 {"PolicyComplianceDetail" (rawinput1782684 "PolicyComplianceDetail")}] (clojure.core/cond-> {} (letvar1782686 "PolicyComplianceDetail") (clojure.core/assoc :policy-compliance-detail (deser-policy-compliance-detail (clojure.core/get-in letvar1782686 ["PolicyComplianceDetail"])))))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper1782688 input] (clojure.core/let [rawinput1782687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782689 {"Message" (rawinput1782687 "Message")}] (clojure.core/cond-> {} (letvar1782689 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782689 ["Message"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1782691 input] (clojure.core/let [rawinput1782690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782692 {"Message" (rawinput1782690 "Message")}] (clojure.core/cond-> {} (letvar1782692 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782692 ["Message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1782694 input] (clojure.core/let [rawinput1782693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782695 {"Message" (rawinput1782693 "Message")}] (clojure.core/cond-> {} (letvar1782695 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782695 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1782697 input] (clojure.core/let [rawinput1782696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782698 {"Message" (rawinput1782696 "Message")}] (clojure.core/cond-> {} (letvar1782698 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782698 ["Message"])))))))

(clojure.core/defn- response-get-notification-channel-response ([input] (response-get-notification-channel-response nil input)) ([resultWrapper1782700 input] (clojure.core/let [rawinput1782699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782701 {"SnsTopicArn" (rawinput1782699 "SnsTopicArn"), "SnsRoleName" (rawinput1782699 "SnsRoleName")}] (clojure.core/cond-> {} (letvar1782701 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-resource-arn (clojure.core/get-in letvar1782701 ["SnsTopicArn"]))) (letvar1782701 "SnsRoleName") (clojure.core/assoc :sns-role-name (deser-resource-arn (clojure.core/get-in letvar1782701 ["SnsRoleName"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1782703 input] (clojure.core/let [rawinput1782702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782704 {"Message" (rawinput1782702 "Message")}] (clojure.core/cond-> {} (letvar1782704 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1782704 ["Message"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1782706 input] (clojure.core/let [rawinput1782705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782707 {"Policy" (rawinput1782705 "Policy"), "PolicyArn" (rawinput1782705 "PolicyArn")}] (clojure.core/cond-> {} (letvar1782707 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1782707 ["Policy"]))) (letvar1782707 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1782707 ["PolicyArn"])))))))

(clojure.core/defn- response-get-admin-account-response ([input] (response-get-admin-account-response nil input)) ([resultWrapper1782709 input] (clojure.core/let [rawinput1782708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782710 {"AdminAccount" (rawinput1782708 "AdminAccount"), "RoleStatus" (rawinput1782708 "RoleStatus")}] (clojure.core/cond-> {} (letvar1782710 "AdminAccount") (clojure.core/assoc :admin-account (deser-aws-account-id (clojure.core/get-in letvar1782710 ["AdminAccount"]))) (letvar1782710 "RoleStatus") (clojure.core/assoc :role-status (deser-account-role-status (clojure.core/get-in letvar1782710 ["RoleStatus"])))))))

(clojure.core/defn- response-put-policy-response ([input] (response-put-policy-response nil input)) ([resultWrapper1782712 input] (clojure.core/let [rawinput1782711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782713 {"Policy" (rawinput1782711 "Policy"), "PolicyArn" (rawinput1782711 "PolicyArn")}] (clojure.core/cond-> {} (letvar1782713 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar1782713 ["Policy"]))) (letvar1782713 "PolicyArn") (clojure.core/assoc :policy-arn (deser-resource-arn (clojure.core/get-in letvar1782713 ["PolicyArn"])))))))

(clojure.core/defn- response-list-policies-response ([input] (response-list-policies-response nil input)) ([resultWrapper1782715 input] (clojure.core/let [rawinput1782714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1782716 {"PolicyList" (rawinput1782714 "PolicyList"), "NextToken" (rawinput1782714 "NextToken")}] (clojure.core/cond-> {} (letvar1782716 "PolicyList") (clojure.core/assoc :policy-list (deser-policy-summary-list (clojure.core/get-in letvar1782716 ["PolicyList"]))) (letvar1782716 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1782716 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fms/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.fms/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fms/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 36 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.fms/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fms/customer-policy-scope-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/managed-service-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.fms/detailed-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.fms/policy-update-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
