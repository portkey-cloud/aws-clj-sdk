...
(clojure.core/defn- response-list-lexicons-output ([input] (response-list-lexicons-output nil input)) ([resultWrapper1468055 input] (clojure.core/let [rawinput1468054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468056 {"Lexicons" (rawinput1468054 "Lexicons"), "NextToken" (rawinput1468054 "NextToken")}] (clojure.core/cond-> {} (letvar1468056 "Lexicons") (clojure.core/assoc :lexicons (deser-lexicon-description-list (clojure.core/get-in letvar1468056 ["Lexicons"]))) (letvar1468056 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1468056 ["NextToken"])))))))

(clojure.core/defn- response-max-lexeme-length-exceeded-exception ([input] (response-max-lexeme-length-exceeded-exception nil input)) ([resultWrapper1468058 input] (clojure.core/let [rawinput1468057 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468059 {"message" (rawinput1468057 "message")}] (clojure.core/cond-> {} (letvar1468059 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468059 ["message"])))))))

(clojure.core/defn- response-invalid-ssml-exception ([input] (response-invalid-ssml-exception nil input)) ([resultWrapper1468061 input] (clojure.core/let [rawinput1468060 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468062 {"message" (rawinput1468060 "message")}] (clojure.core/cond-> {} (letvar1468062 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468062 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-alphabet-exception ([input] (response-unsupported-pls-alphabet-exception nil input)) ([resultWrapper1468064 input] (clojure.core/let [rawinput1468063 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468065 {"message" (rawinput1468063 "message")}] (clojure.core/cond-> {} (letvar1468065 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468065 ["message"])))))))

(clojure.core/defn- response-invalid-sns-topic-arn-exception ([input] (response-invalid-sns-topic-arn-exception nil input)) ([resultWrapper1468067 input] (clojure.core/let [rawinput1468066 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468068 {"message" (rawinput1468066 "message")}] (clojure.core/cond-> {} (letvar1468068 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468068 ["message"])))))))

(clojure.core/defn- response-list-speech-synthesis-tasks-output ([input] (response-list-speech-synthesis-tasks-output nil input)) ([resultWrapper1468070 input] (clojure.core/let [rawinput1468069 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468071 {"NextToken" (rawinput1468069 "NextToken"), "SynthesisTasks" (rawinput1468069 "SynthesisTasks")}] (clojure.core/cond-> {} (letvar1468071 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1468071 ["NextToken"]))) (letvar1468071 "SynthesisTasks") (clojure.core/assoc :synthesis-tasks (deser-synthesis-tasks (clojure.core/get-in letvar1468071 ["SynthesisTasks"])))))))

(clojure.core/defn- response-get-lexicon-output ([input] (response-get-lexicon-output nil input)) ([resultWrapper1468073 input] (clojure.core/let [rawinput1468072 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468074 {"Lexicon" (rawinput1468072 "Lexicon"), "LexiconAttributes" (rawinput1468072 "LexiconAttributes")}] (clojure.core/cond-> {} (letvar1468074 "Lexicon") (clojure.core/assoc :lexicon (deser-lexicon (clojure.core/get-in letvar1468074 ["Lexicon"]))) (letvar1468074 "LexiconAttributes") (clojure.core/assoc :lexicon-attributes (deser-lexicon-attributes (clojure.core/get-in letvar1468074 ["LexiconAttributes"])))))))

(clojure.core/defn- response-describe-voices-output ([input] (response-describe-voices-output nil input)) ([resultWrapper1468076 input] (clojure.core/let [rawinput1468075 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468077 {"Voices" (rawinput1468075 "Voices"), "NextToken" (rawinput1468075 "NextToken")}] (clojure.core/cond-> {} (letvar1468077 "Voices") (clojure.core/assoc :voices (deser-voice-list (clojure.core/get-in letvar1468077 ["Voices"]))) (letvar1468077 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1468077 ["NextToken"])))))))

(clojure.core/defn- response-ssml-marks-not-supported-for-text-type-exception ([input] (response-ssml-marks-not-supported-for-text-type-exception nil input)) ([resultWrapper1468079 input] (clojure.core/let [rawinput1468078 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468080 {"message" (rawinput1468078 "message")}] (clojure.core/cond-> {} (letvar1468080 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468080 ["message"])))))))

(clojure.core/defn- response-max-lexicons-number-exceeded-exception ([input] (response-max-lexicons-number-exceeded-exception nil input)) ([resultWrapper1468082 input] (clojure.core/let [rawinput1468081 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468083 {"message" (rawinput1468081 "message")}] (clojure.core/cond-> {} (letvar1468083 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468083 ["message"])))))))

(clojure.core/defn- response-synthesize-speech-output ([input] (response-synthesize-speech-output nil input)) ([resultWrapper1468085 input] (clojure.core/let [rawinput1468084 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468086 {"AudioStream" (rawinput1468084 "AudioStream"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amzn-RequestCharacters" (clojure.core/get-in input [:headers "x-amzn-RequestCharacters"])}] (clojure.core/cond-> {} (letvar1468086 "AudioStream") (clojure.core/assoc :audio-stream (deser-audio-stream (clojure.core/get-in letvar1468086 ["AudioStream"]))) (letvar1468086 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1468086 ["Content-Type"]))) (letvar1468086 "x-amzn-RequestCharacters") (clojure.core/assoc :request-characters (deser-request-characters (clojure.core/get-in letvar1468086 ["x-amzn-RequestCharacters"])))))))

(clojure.core/defn- response-invalid-s-3-bucket-exception ([input] (response-invalid-s-3-bucket-exception nil input)) ([resultWrapper1468088 input] (clojure.core/let [rawinput1468087 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468089 {"message" (rawinput1468087 "message")}] (clojure.core/cond-> {} (letvar1468089 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468089 ["message"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper1468091 input] (clojure.core/let [rawinput1468090 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468092 {"message" (rawinput1468090 "message")}] (clojure.core/cond-> {} (letvar1468092 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468092 ["message"])))))))

(clojure.core/defn- response-text-length-exceeded-exception ([input] (response-text-length-exceeded-exception nil input)) ([resultWrapper1468094 input] (clojure.core/let [rawinput1468093 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468095 {"message" (rawinput1468093 "message")}] (clojure.core/cond-> {} (letvar1468095 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468095 ["message"])))))))

(clojure.core/defn- response-invalid-sample-rate-exception ([input] (response-invalid-sample-rate-exception nil input)) ([resultWrapper1468097 input] (clojure.core/let [rawinput1468096 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468098 {"message" (rawinput1468096 "message")}] (clojure.core/cond-> {} (letvar1468098 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468098 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1468100 input] (clojure.core/let [rawinput1468099 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468101 {"message" (rawinput1468099 "message")}] (clojure.core/cond-> {} (letvar1468101 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468101 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-language-exception ([input] (response-unsupported-pls-language-exception nil input)) ([resultWrapper1468103 input] (clojure.core/let [rawinput1468102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468104 {"message" (rawinput1468102 "message")}] (clojure.core/cond-> {} (letvar1468104 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468104 ["message"])))))))

(clojure.core/defn- response-synthesis-task-not-found-exception ([input] (response-synthesis-task-not-found-exception nil input)) ([resultWrapper1468106 input] (clojure.core/let [rawinput1468105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468107 {"message" (rawinput1468105 "message")}] (clojure.core/cond-> {} (letvar1468107 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468107 ["message"])))))))

(clojure.core/defn- response-language-not-supported-exception ([input] (response-language-not-supported-exception nil input)) ([resultWrapper1468109 input] (clojure.core/let [rawinput1468108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468110 {"message" (rawinput1468108 "message")}] (clojure.core/cond-> {} (letvar1468110 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468110 ["message"])))))))

(clojure.core/defn- response-put-lexicon-output ([input] (response-put-lexicon-output nil input)) ([resultWrapper1468112 input] (clojure.core/let [rawinput1468111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468113 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lexicon-output ([input] (response-delete-lexicon-output nil input)) ([resultWrapper1468115 input] (clojure.core/let [rawinput1468114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468116 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-s-3-key-exception ([input] (response-invalid-s-3-key-exception nil input)) ([resultWrapper1468118 input] (clojure.core/let [rawinput1468117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468119 {"message" (rawinput1468117 "message")}] (clojure.core/cond-> {} (letvar1468119 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468119 ["message"])))))))

(clojure.core/defn- response-invalid-task-id-exception ([input] (response-invalid-task-id-exception nil input)) ([resultWrapper1468121 input] (clojure.core/let [rawinput1468120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468122 {"message" (rawinput1468120 "message")}] (clojure.core/cond-> {} (letvar1468122 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468122 ["message"])))))))

(clojure.core/defn- response-lexicon-not-found-exception ([input] (response-lexicon-not-found-exception nil input)) ([resultWrapper1468124 input] (clojure.core/let [rawinput1468123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468125 {"message" (rawinput1468123 "message")}] (clojure.core/cond-> {} (letvar1468125 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468125 ["message"])))))))

(clojure.core/defn- response-invalid-lexicon-exception ([input] (response-invalid-lexicon-exception nil input)) ([resultWrapper1468127 input] (clojure.core/let [rawinput1468126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468128 {"message" (rawinput1468126 "message")}] (clojure.core/cond-> {} (letvar1468128 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468128 ["message"])))))))

(clojure.core/defn- response-lexicon-size-exceeded-exception ([input] (response-lexicon-size-exceeded-exception nil input)) ([resultWrapper1468130 input] (clojure.core/let [rawinput1468129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468131 {"message" (rawinput1468129 "message")}] (clojure.core/cond-> {} (letvar1468131 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468131 ["message"])))))))

(clojure.core/defn- response-marks-not-supported-for-format-exception ([input] (response-marks-not-supported-for-format-exception nil input)) ([resultWrapper1468133 input] (clojure.core/let [rawinput1468132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468134 {"message" (rawinput1468132 "message")}] (clojure.core/cond-> {} (letvar1468134 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1468134 ["message"])))))))

(clojure.core/defn- response-start-speech-synthesis-task-output ([input] (response-start-speech-synthesis-task-output nil input)) ([resultWrapper1468136 input] (clojure.core/let [rawinput1468135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468137 {"SynthesisTask" (rawinput1468135 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1468137 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1468137 ["SynthesisTask"])))))))

(clojure.core/defn- response-get-speech-synthesis-task-output ([input] (response-get-speech-synthesis-task-output nil input)) ([resultWrapper1468139 input] (clojure.core/let [rawinput1468138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1468140 {"SynthesisTask" (rawinput1468138 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1468140 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1468140 ["SynthesisTask"])))))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/output-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/lexicon-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Za-z]{1,20}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws(-(cn|iso(-b)?|us-gov))?:sns:.*:\w{12}:.+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/output-s-3-key-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z\/\!\-_\.\*\'\(\)]{0,800}$" s__21078__auto__))))
