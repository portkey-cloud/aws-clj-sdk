...
(clojure.core/defn- response-list-lexicons-output ([input] (response-list-lexicons-output nil input)) ([resultWrapper1424358 input] (clojure.core/let [rawinput1424357 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424359 {"Lexicons" (rawinput1424357 "Lexicons"), "NextToken" (rawinput1424357 "NextToken")}] (clojure.core/cond-> {} (letvar1424359 "Lexicons") (clojure.core/assoc :lexicons (deser-lexicon-description-list (clojure.core/get-in letvar1424359 ["Lexicons"]))) (letvar1424359 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1424359 ["NextToken"])))))))

(clojure.core/defn- response-max-lexeme-length-exceeded-exception ([input] (response-max-lexeme-length-exceeded-exception nil input)) ([resultWrapper1424361 input] (clojure.core/let [rawinput1424360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424362 {"message" (rawinput1424360 "message")}] (clojure.core/cond-> {} (letvar1424362 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424362 ["message"])))))))

(clojure.core/defn- response-invalid-ssml-exception ([input] (response-invalid-ssml-exception nil input)) ([resultWrapper1424364 input] (clojure.core/let [rawinput1424363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424365 {"message" (rawinput1424363 "message")}] (clojure.core/cond-> {} (letvar1424365 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424365 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-alphabet-exception ([input] (response-unsupported-pls-alphabet-exception nil input)) ([resultWrapper1424367 input] (clojure.core/let [rawinput1424366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424368 {"message" (rawinput1424366 "message")}] (clojure.core/cond-> {} (letvar1424368 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424368 ["message"])))))))

(clojure.core/defn- response-invalid-sns-topic-arn-exception ([input] (response-invalid-sns-topic-arn-exception nil input)) ([resultWrapper1424370 input] (clojure.core/let [rawinput1424369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424371 {"message" (rawinput1424369 "message")}] (clojure.core/cond-> {} (letvar1424371 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424371 ["message"])))))))

(clojure.core/defn- response-list-speech-synthesis-tasks-output ([input] (response-list-speech-synthesis-tasks-output nil input)) ([resultWrapper1424373 input] (clojure.core/let [rawinput1424372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424374 {"NextToken" (rawinput1424372 "NextToken"), "SynthesisTasks" (rawinput1424372 "SynthesisTasks")}] (clojure.core/cond-> {} (letvar1424374 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1424374 ["NextToken"]))) (letvar1424374 "SynthesisTasks") (clojure.core/assoc :synthesis-tasks (deser-synthesis-tasks (clojure.core/get-in letvar1424374 ["SynthesisTasks"])))))))

(clojure.core/defn- response-get-lexicon-output ([input] (response-get-lexicon-output nil input)) ([resultWrapper1424376 input] (clojure.core/let [rawinput1424375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424377 {"Lexicon" (rawinput1424375 "Lexicon"), "LexiconAttributes" (rawinput1424375 "LexiconAttributes")}] (clojure.core/cond-> {} (letvar1424377 "Lexicon") (clojure.core/assoc :lexicon (deser-lexicon (clojure.core/get-in letvar1424377 ["Lexicon"]))) (letvar1424377 "LexiconAttributes") (clojure.core/assoc :lexicon-attributes (deser-lexicon-attributes (clojure.core/get-in letvar1424377 ["LexiconAttributes"])))))))

(clojure.core/defn- response-describe-voices-output ([input] (response-describe-voices-output nil input)) ([resultWrapper1424379 input] (clojure.core/let [rawinput1424378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424380 {"Voices" (rawinput1424378 "Voices"), "NextToken" (rawinput1424378 "NextToken")}] (clojure.core/cond-> {} (letvar1424380 "Voices") (clojure.core/assoc :voices (deser-voice-list (clojure.core/get-in letvar1424380 ["Voices"]))) (letvar1424380 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1424380 ["NextToken"])))))))

(clojure.core/defn- response-ssml-marks-not-supported-for-text-type-exception ([input] (response-ssml-marks-not-supported-for-text-type-exception nil input)) ([resultWrapper1424382 input] (clojure.core/let [rawinput1424381 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424383 {"message" (rawinput1424381 "message")}] (clojure.core/cond-> {} (letvar1424383 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424383 ["message"])))))))

(clojure.core/defn- response-max-lexicons-number-exceeded-exception ([input] (response-max-lexicons-number-exceeded-exception nil input)) ([resultWrapper1424385 input] (clojure.core/let [rawinput1424384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424386 {"message" (rawinput1424384 "message")}] (clojure.core/cond-> {} (letvar1424386 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424386 ["message"])))))))

(clojure.core/defn- response-synthesize-speech-output ([input] (response-synthesize-speech-output nil input)) ([resultWrapper1424388 input] (clojure.core/let [rawinput1424387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424389 {"AudioStream" (rawinput1424387 "AudioStream"), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amzn-RequestCharacters" (clojure.core/get-in input [:headers "x-amzn-RequestCharacters"])}] (clojure.core/cond-> {} (letvar1424389 "AudioStream") (clojure.core/assoc :audio-stream (deser-audio-stream (clojure.core/get-in letvar1424389 ["AudioStream"]))) (letvar1424389 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1424389 ["Content-Type"]))) (letvar1424389 "x-amzn-RequestCharacters") (clojure.core/assoc :request-characters (deser-request-characters (clojure.core/get-in letvar1424389 ["x-amzn-RequestCharacters"])))))))

(clojure.core/defn- response-invalid-s-3-bucket-exception ([input] (response-invalid-s-3-bucket-exception nil input)) ([resultWrapper1424391 input] (clojure.core/let [rawinput1424390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424392 {"message" (rawinput1424390 "message")}] (clojure.core/cond-> {} (letvar1424392 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424392 ["message"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper1424394 input] (clojure.core/let [rawinput1424393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424395 {"message" (rawinput1424393 "message")}] (clojure.core/cond-> {} (letvar1424395 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424395 ["message"])))))))

(clojure.core/defn- response-text-length-exceeded-exception ([input] (response-text-length-exceeded-exception nil input)) ([resultWrapper1424397 input] (clojure.core/let [rawinput1424396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424398 {"message" (rawinput1424396 "message")}] (clojure.core/cond-> {} (letvar1424398 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424398 ["message"])))))))

(clojure.core/defn- response-invalid-sample-rate-exception ([input] (response-invalid-sample-rate-exception nil input)) ([resultWrapper1424400 input] (clojure.core/let [rawinput1424399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424401 {"message" (rawinput1424399 "message")}] (clojure.core/cond-> {} (letvar1424401 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424401 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1424403 input] (clojure.core/let [rawinput1424402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424404 {"message" (rawinput1424402 "message")}] (clojure.core/cond-> {} (letvar1424404 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424404 ["message"])))))))

(clojure.core/defn- response-unsupported-pls-language-exception ([input] (response-unsupported-pls-language-exception nil input)) ([resultWrapper1424406 input] (clojure.core/let [rawinput1424405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424407 {"message" (rawinput1424405 "message")}] (clojure.core/cond-> {} (letvar1424407 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424407 ["message"])))))))

(clojure.core/defn- response-synthesis-task-not-found-exception ([input] (response-synthesis-task-not-found-exception nil input)) ([resultWrapper1424409 input] (clojure.core/let [rawinput1424408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424410 {"message" (rawinput1424408 "message")}] (clojure.core/cond-> {} (letvar1424410 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424410 ["message"])))))))

(clojure.core/defn- response-language-not-supported-exception ([input] (response-language-not-supported-exception nil input)) ([resultWrapper1424412 input] (clojure.core/let [rawinput1424411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424413 {"message" (rawinput1424411 "message")}] (clojure.core/cond-> {} (letvar1424413 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424413 ["message"])))))))

(clojure.core/defn- response-put-lexicon-output ([input] (response-put-lexicon-output nil input)) ([resultWrapper1424415 input] (clojure.core/let [rawinput1424414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424416 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lexicon-output ([input] (response-delete-lexicon-output nil input)) ([resultWrapper1424418 input] (clojure.core/let [rawinput1424417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424419 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-s-3-key-exception ([input] (response-invalid-s-3-key-exception nil input)) ([resultWrapper1424421 input] (clojure.core/let [rawinput1424420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424422 {"message" (rawinput1424420 "message")}] (clojure.core/cond-> {} (letvar1424422 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424422 ["message"])))))))

(clojure.core/defn- response-invalid-task-id-exception ([input] (response-invalid-task-id-exception nil input)) ([resultWrapper1424424 input] (clojure.core/let [rawinput1424423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424425 {"message" (rawinput1424423 "message")}] (clojure.core/cond-> {} (letvar1424425 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424425 ["message"])))))))

(clojure.core/defn- response-lexicon-not-found-exception ([input] (response-lexicon-not-found-exception nil input)) ([resultWrapper1424427 input] (clojure.core/let [rawinput1424426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424428 {"message" (rawinput1424426 "message")}] (clojure.core/cond-> {} (letvar1424428 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424428 ["message"])))))))

(clojure.core/defn- response-invalid-lexicon-exception ([input] (response-invalid-lexicon-exception nil input)) ([resultWrapper1424430 input] (clojure.core/let [rawinput1424429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424431 {"message" (rawinput1424429 "message")}] (clojure.core/cond-> {} (letvar1424431 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424431 ["message"])))))))

(clojure.core/defn- response-lexicon-size-exceeded-exception ([input] (response-lexicon-size-exceeded-exception nil input)) ([resultWrapper1424433 input] (clojure.core/let [rawinput1424432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424434 {"message" (rawinput1424432 "message")}] (clojure.core/cond-> {} (letvar1424434 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424434 ["message"])))))))

(clojure.core/defn- response-marks-not-supported-for-format-exception ([input] (response-marks-not-supported-for-format-exception nil input)) ([resultWrapper1424436 input] (clojure.core/let [rawinput1424435 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424437 {"message" (rawinput1424435 "message")}] (clojure.core/cond-> {} (letvar1424437 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1424437 ["message"])))))))

(clojure.core/defn- response-start-speech-synthesis-task-output ([input] (response-start-speech-synthesis-task-output nil input)) ([resultWrapper1424439 input] (clojure.core/let [rawinput1424438 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424440 {"SynthesisTask" (rawinput1424438 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1424440 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1424440 ["SynthesisTask"])))))))

(clojure.core/defn- response-get-speech-synthesis-task-output ([input] (response-get-speech-synthesis-task-output nil input)) ([resultWrapper1424442 input] (clojure.core/let [rawinput1424441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1424443 {"SynthesisTask" (rawinput1424441 "SynthesisTask")}] (clojure.core/cond-> {} (letvar1424443 "SynthesisTask") (clojure.core/assoc :synthesis-task (deser-synthesis-task (clojure.core/get-in letvar1424443 ["SynthesisTask"])))))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/output-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/lexicon-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[0-9A-Za-z]{1,20}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^arn:aws(-(cn|iso(-b)?|us-gov))?:sns:.*:\w{12}:.+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.polly.-2016-06-10/output-s-3-key-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z\/\!\-_\.\*\'\(\)]{0,800}$" s__1012854__auto__))))
