...
(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1427256 input] (clojure.core/let [rawinput1427255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1427257 {"Message" (rawinput1427255 "Message")}] (clojure.core/cond-> {} (letvar1427257 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1427257 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1427259 input] (clojure.core/let [rawinput1427258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1427260 {"Message" (rawinput1427258 "Message")}] (clojure.core/cond-> {} (letvar1427260 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1427260 ["Message"])))))))

(clojure.core/defn- response-describe-dimension-keys-response ([input] (response-describe-dimension-keys-response nil input)) ([resultWrapper1427262 input] (clojure.core/let [rawinput1427261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1427263 {"AlignedStartTime" (rawinput1427261 "AlignedStartTime"), "AlignedEndTime" (rawinput1427261 "AlignedEndTime"), "PartitionKeys" (rawinput1427261 "PartitionKeys"), "Keys" (rawinput1427261 "Keys"), "NextToken" (rawinput1427261 "NextToken")}] (clojure.core/cond-> {} (letvar1427263 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1427263 ["AlignedStartTime"]))) (letvar1427263 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1427263 ["AlignedEndTime"]))) (letvar1427263 "PartitionKeys") (clojure.core/assoc :partition-keys (deser-response-partition-key-list (clojure.core/get-in letvar1427263 ["PartitionKeys"]))) (letvar1427263 "Keys") (clojure.core/assoc :keys (deser-dimension-key-description-list (clojure.core/get-in letvar1427263 ["Keys"]))) (letvar1427263 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1427263 ["NextToken"])))))))

(clojure.core/defn- response-get-resource-metrics-response ([input] (response-get-resource-metrics-response nil input)) ([resultWrapper1427265 input] (clojure.core/let [rawinput1427264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1427266 {"AlignedStartTime" (rawinput1427264 "AlignedStartTime"), "AlignedEndTime" (rawinput1427264 "AlignedEndTime"), "Identifier" (rawinput1427264 "Identifier"), "MetricList" (rawinput1427264 "MetricList"), "NextToken" (rawinput1427264 "NextToken")}] (clojure.core/cond-> {} (letvar1427266 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1427266 ["AlignedStartTime"]))) (letvar1427266 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1427266 ["AlignedEndTime"]))) (letvar1427266 "Identifier") (clojure.core/assoc :identifier (deser-string (clojure.core/get-in letvar1427266 ["Identifier"]))) (letvar1427266 "MetricList") (clojure.core/assoc :metric-list (deser-metric-key-data-points-list (clojure.core/get-in letvar1427266 ["MetricList"]))) (letvar1427266 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1427266 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1427268 input] (clojure.core/let [rawinput1427267 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1427269 {"Message" (rawinput1427267 "Message")}] (clojure.core/cond-> {} (letvar1427269 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1427269 ["Message"])))))))
