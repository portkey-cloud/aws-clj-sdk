...
(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1935245 input] (clojure.core/let [rawinput1935244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1935246 {"Message" (rawinput1935244 "Message")}] (clojure.core/cond-> {} (letvar1935246 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1935246 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1935248 input] (clojure.core/let [rawinput1935247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1935249 {"Message" (rawinput1935247 "Message")}] (clojure.core/cond-> {} (letvar1935249 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1935249 ["Message"])))))))

(clojure.core/defn- response-describe-dimension-keys-response ([input] (response-describe-dimension-keys-response nil input)) ([resultWrapper1935251 input] (clojure.core/let [rawinput1935250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1935252 {"AlignedStartTime" (rawinput1935250 "AlignedStartTime"), "AlignedEndTime" (rawinput1935250 "AlignedEndTime"), "PartitionKeys" (rawinput1935250 "PartitionKeys"), "Keys" (rawinput1935250 "Keys"), "NextToken" (rawinput1935250 "NextToken")}] (clojure.core/cond-> {} (letvar1935252 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1935252 ["AlignedStartTime"]))) (letvar1935252 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1935252 ["AlignedEndTime"]))) (letvar1935252 "PartitionKeys") (clojure.core/assoc :partition-keys (deser-response-partition-key-list (clojure.core/get-in letvar1935252 ["PartitionKeys"]))) (letvar1935252 "Keys") (clojure.core/assoc :keys (deser-dimension-key-description-list (clojure.core/get-in letvar1935252 ["Keys"]))) (letvar1935252 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1935252 ["NextToken"])))))))

(clojure.core/defn- response-get-resource-metrics-response ([input] (response-get-resource-metrics-response nil input)) ([resultWrapper1935254 input] (clojure.core/let [rawinput1935253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1935255 {"AlignedStartTime" (rawinput1935253 "AlignedStartTime"), "AlignedEndTime" (rawinput1935253 "AlignedEndTime"), "Identifier" (rawinput1935253 "Identifier"), "MetricList" (rawinput1935253 "MetricList"), "NextToken" (rawinput1935253 "NextToken")}] (clojure.core/cond-> {} (letvar1935255 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1935255 ["AlignedStartTime"]))) (letvar1935255 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1935255 ["AlignedEndTime"]))) (letvar1935255 "Identifier") (clojure.core/assoc :identifier (deser-string (clojure.core/get-in letvar1935255 ["Identifier"]))) (letvar1935255 "MetricList") (clojure.core/assoc :metric-list (deser-metric-key-data-points-list (clojure.core/get-in letvar1935255 ["MetricList"]))) (letvar1935255 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1935255 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1935257 input] (clojure.core/let [rawinput1935256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1935258 {"Message" (rawinput1935256 "Message")}] (clojure.core/cond-> {} (letvar1935258 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1935258 ["Message"])))))))
