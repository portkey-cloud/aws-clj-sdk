...
(clojure.core/defn- response-container-not-found-exception ([input] (response-container-not-found-exception nil input)) ([resultWrapper384096 input] (clojure.core/let [rawinput384095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384097 {"Message" (rawinput384095 "Message")}] (clojure.core/cond-> {} (letvar384097 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar384097 ["Message"])))))))

(clojure.core/defn- response-get-object-response ([input] (response-get-object-response nil input)) ([resultWrapper384099 input] (clojure.core/let [rawinput384098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384100 {"Body" (rawinput384098 "Body"), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Content-Range" (clojure.core/get-in input [:headers "Content-Range"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"]), "StatusCode" (clojure.core/get-in input [:status "StatusCode"])}] (clojure.core/cond-> {:status-code (deserstatus-code (clojure.core/get-in letvar384100 ["StatusCode"]))} (letvar384100 "Body") (clojure.core/assoc :body (deser-payload-blob (clojure.core/get-in letvar384100 ["Body"]))) (letvar384100 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar384100 ["Cache-Control"]))) (letvar384100 "Content-Range") (clojure.core/assoc :content-range (deser-content-range-pattern (clojure.core/get-in letvar384100 ["Content-Range"]))) (letvar384100 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar384100 ["Content-Length"]))) (letvar384100 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar384100 ["Content-Type"]))) (letvar384100 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar384100 ["ETag"]))) (letvar384100 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar384100 ["Last-Modified"])))))))

(clojure.core/defn- response-requested-range-not-satisfiable-exception ([input] (response-requested-range-not-satisfiable-exception nil input)) ([resultWrapper384102 input] (clojure.core/let [rawinput384101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384103 {"Message" (rawinput384101 "Message")}] (clojure.core/cond-> {} (letvar384103 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar384103 ["Message"])))))))

(clojure.core/defn- response-put-object-response ([input] (response-put-object-response nil input)) ([resultWrapper384105 input] (clojure.core/let [rawinput384104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384106 {"ContentSHA256" (rawinput384104 "ContentSHA256"), "ETag" (rawinput384104 "ETag"), "StorageClass" (rawinput384104 "StorageClass")}] (clojure.core/cond-> {} (letvar384106 "ContentSHA256") (clojure.core/assoc :content-sha-256 (deser-sha-256-hash (clojure.core/get-in letvar384106 ["ContentSHA256"]))) (letvar384106 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar384106 ["ETag"]))) (letvar384106 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar384106 ["StorageClass"])))))))

(clojure.core/defn- response-list-items-response ([input] (response-list-items-response nil input)) ([resultWrapper384108 input] (clojure.core/let [rawinput384107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384109 {"Items" (rawinput384107 "Items"), "NextToken" (rawinput384107 "NextToken")}] (clojure.core/cond-> {} (letvar384109 "Items") (clojure.core/assoc :items (deser-item-list (clojure.core/get-in letvar384109 ["Items"]))) (letvar384109 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar384109 ["NextToken"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper384111 input] (clojure.core/let [rawinput384110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384112 {"Message" (rawinput384110 "Message")}] (clojure.core/cond-> {} (letvar384112 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar384112 ["Message"])))))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper384114 input] (clojure.core/let [rawinput384113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384115 {"Message" (rawinput384113 "Message")}] (clojure.core/cond-> {} (letvar384115 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar384115 ["Message"])))))))

(clojure.core/defn- response-delete-object-response ([input] (response-delete-object-response nil input)) ([resultWrapper384117 input] (clojure.core/let [rawinput384116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384118 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-object-response ([input] (response-describe-object-response nil input)) ([resultWrapper384120 input] (clojure.core/let [rawinput384119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384121 {"ETag" (clojure.core/get-in input [:headers "ETag"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"])}] (clojure.core/cond-> {} (letvar384121 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar384121 ["ETag"]))) (letvar384121 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar384121 ["Content-Type"]))) (letvar384121 "Content-Length") (clojure.core/assoc :content-length (deser-non-negative-long (clojure.core/get-in letvar384121 ["Content-Length"]))) (letvar384121 "Cache-Control") (clojure.core/assoc :cache-control (deser-string-primitive (clojure.core/get-in letvar384121 ["Cache-Control"]))) (letvar384121 "Last-Modified") (clojure.core/assoc :last-modified (deser-time-stamp (clojure.core/get-in letvar384121 ["Last-Modified"])))))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/sha-256-hash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 64 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[0-9A-Fa-f]{64}" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 255)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[\w\-\/\.\+]{1,255}$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 900)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 900)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__21112__auto__))))
