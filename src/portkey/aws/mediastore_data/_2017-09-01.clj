...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/list-limit (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30692__30693__auto__] (clojure.core/<= 1 p1__30692__30693__auto__)) (fn* [p1__30694__30695__auto__] (clojure.core/<= p1__30694__30695__auto__ 1000))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/sha256-hash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 64 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 64)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[0-9A-Fa-f]{64}" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.mediastore-data.-2017-09-01/item) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__30551__30552__auto__] (if (clojure.core/sequential? p1__30551__30552__auto__) p1__30551__30552__auto__ [p1__30551__30552__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 255)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^[\w\-\/\.]{1,255}$" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-type (clojure.spec.alpha/conformer (clojure.core/let [m__30630__auto__ {"OBJECT" "OBJECT", :object "OBJECT", "FOLDER" "FOLDER", :folder "FOLDER"}] (clojure.core/fn [s__30631__auto__] (m__30630__auto__ s__30631__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 1 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 900)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__30634__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__30634__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30632__auto__] (clojure.core/<= 0 (clojure.core/count s__30632__auto__))) (clojure.core/fn [s__30633__auto__] (clojure.core/< (clojure.core/count s__30633__auto__) 900)) (clojure.core/fn [s__30634__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__30634__auto__))))
...
(clojure.core/defn delete-object ([delete-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data.-2017-09-01/endpoints "DELETE" "/{Path+}" delete-object-request :portkey.aws.mediastore-data.-2017-09-01/delete-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data.-2017-09-01/delete-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/object-not-found-exception, "InternalServerError" :portkey.aws.mediastore-data.-2017-09-01/internal-server-error})))
...
(clojure.core/defn describe-object ([describe-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data.-2017-09-01/endpoints "HEAD" "/{Path+}" describe-object-request :portkey.aws.mediastore-data.-2017-09-01/describe-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data.-2017-09-01/describe-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/object-not-found-exception, "InternalServerError" :portkey.aws.mediastore-data.-2017-09-01/internal-server-error})))
...
(clojure.core/defn get-object ([get-object-request] (portkey.aws/-rest-json-call portkey.aws.mediastore-data.-2017-09-01/endpoints "GET" "/{Path+}" get-object-request :portkey.aws.mediastore-data.-2017-09-01/get-object-request {:payload nil, :move {}, :headers {"Range" ["Range" nil]}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.mediastore-data.-2017-09-01/get-object-response {"ContainerNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.mediastore-data.-2017-09-01/object-not-found-exception, "RequestedRangeNotSatisfiableException" :portkey.aws.mediastore-data.-2017-09-01/requested-range-not-satisfiable-exception, "InternalServerError" :portkey.aws.mediastore-data.-2017-09-01/internal-server-error})))
