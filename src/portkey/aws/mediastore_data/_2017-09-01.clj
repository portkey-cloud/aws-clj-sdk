...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"^bytes=\d+\-\d+/\d+$" s__13963__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/list-limit (clojure.spec.alpha/and clojure.core/int? (fn* [p1__14021__14022__auto__] (clojure.core/<= 1 p1__14021__14022__auto__)) (fn* [p1__14023__14024__auto__] (clojure.core/<= p1__14023__14024__auto__ 1000))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.mediastore-data.-2017-09-01/item) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__13880__13881__auto__] (if (clojure.core/sequential? p1__13880__13881__auto__) p1__13880__13881__auto__ [p1__13880__13881__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"[A-Za-z0-9_\.\-\~]+" s__13963__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"^[\w\-\/\.]{1,255}$" s__13963__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/item-type (clojure.spec.alpha/conformer (clojure.core/let [m__13959__auto__ {"OBJECT" "OBJECT", :object "OBJECT", "FOLDER" "FOLDER", :folder "FOLDER"}] (clojure.core/fn [s__13960__auto__] (m__13959__auto__ s__13960__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13961__auto__] (clojure.core/<= 1 (clojure.core/count s__13961__auto__))) (clojure.core/fn [s__13962__auto__] (clojure.core/< (clojure.core/count s__13962__auto__) 900)) (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"(?:[A-Za-z0-9_\.\-\~]+/){0,10}[A-Za-z0-9_\.\-\~]+" s__13963__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/range-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"^bytes=(?:\d+\-\d*|\d*\-\d+)$" s__13963__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore-data.-2017-09-01/list-path-naming (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__13961__auto__] (clojure.core/<= 0 (clojure.core/count s__13961__auto__))) (clojure.core/fn [s__13962__auto__] (clojure.core/< (clojure.core/count s__13962__auto__) 900)) (clojure.core/fn [s__13963__auto__] (clojure.core/re-matches #"/?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?" s__13963__auto__))))
