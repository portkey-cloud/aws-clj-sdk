...
(clojure.core/defn- deser-get-file-output [input] (clojure.core/cond-> {:commit-id (deser-object-id (input "commitId")), :blob-id (deser-object-id (input "blobId")), :file-path (deser-path (input "filePath")), :file-mode (deser-file-mode-type-enum (input "fileMode")), :file-size (deser-object-size (input "fileSize")), :file-content (deser-file-content (input "fileContent"))}))

(clojure.core/defn- deser-file-too-large-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-blob-id-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-actor-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-sort-by-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-commit-output [input] (clojure.core/cond-> {:commit (deser-commit (input "commit"))}))

(clojure.core/defn- deser-comment-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-encryption-key-not-found-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-file-position-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-pull-request-status-output [input] (clojure.core/cond-> {:pull-request (deser-pull-request (input "pullRequest"))}))

(clojure.core/defn- deser-maximum-repository-triggers-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-deletion-parameter-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-file-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-client-request-token-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-blob-output [input] (clojure.core/cond-> {:content (deserblob (input "content"))}))

(clojure.core/defn- deser-maximum-open-pull-requests-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-reference-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-file-name-conflicts-with-directory-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-pull-request-status-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-pull-request-id-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-repository-description-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-pull-request-already-closed-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-repository-trigger-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-path-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-encryption-integrity-checks-failed-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-commit-message-length-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-title-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-encryption-key-access-denied-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-client-request-token-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-branch-name-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-comment-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-path-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-source-commit-specifier-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-folder-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-trigger-branch-name-list-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-branch-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-target-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-parent-commit-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-branch-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "deletedBranch") (clojure.core/assoc :deleted-branch (deser-branch-info (input "deletedBranch")))))

(clojure.core/defn- deser-update-pull-request-title-output [input] (clojure.core/cond-> {:pull-request (deser-pull-request (input "pullRequest"))}))

(clojure.core/defn- deser-invalid-file-mode-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-file-output [input] (clojure.core/cond-> {:commit-id (deser-object-id (input "commitId")), :blob-id (deser-object-id (input "blobId")), :tree-id (deser-object-id (input "treeId")), :file-path (deser-path (input "filePath"))}))

(clojure.core/defn- deser-invalid-max-results-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-pull-request-id-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-put-repository-triggers-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "configurationId") (clojure.core/assoc :configuration-id (deser-repository-triggers-configuration-id (input "configurationId")))))

(clojure.core/defn- deser-invalid-continuation-token-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-encryption-key-unavailable-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-parent-commit-id-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-branches-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "branches") (clojure.core/assoc :branches (deser-branch-name-list (input "branches"))) (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-reference-name-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-default-branch-cannot-be-deleted-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-idempotency-parameter-mismatch-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-put-file-output [input] (clojure.core/cond-> {:commit-id (deser-object-id (input "commitId")), :blob-id (deser-object-id (input "blobId")), :tree-id (deser-object-id (input "treeId"))}))

(clojure.core/defn- deser-repository-trigger-destination-arn-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tip-of-source-reference-is-different-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-name-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-pull-request-status-update-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-author-arn-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-commit-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-email-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-repository-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositoryMetadata") (clojure.core/assoc :repository-metadata (deser-repository-metadata (input "repositoryMetadata")))))

(clojure.core/defn- deser-merge-pull-request-by-fast-forward-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "pullRequest") (clojure.core/assoc :pull-request (deser-pull-request (input "pullRequest")))))

(clojure.core/defn- deser-post-comment-reply-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-directory-name-conflicts-with-file-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-repository-triggers-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "configurationId") (clojure.core/assoc :configuration-id (deser-repository-triggers-configuration-id (input "configurationId"))) (clojure.core/contains? input "triggers") (clojure.core/assoc :triggers (deser-repository-triggers-list (input "triggers")))))

(clojure.core/defn- deser-invalid-repository-trigger-region-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-reference-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-comment-id-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-merge-option-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-before-commit-id-and-after-commit-id-are-same-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-post-comment-for-pull-request-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositoryName") (clojure.core/assoc :repository-name (deser-repository-name (input "repositoryName"))) (clojure.core/contains? input "pullRequestId") (clojure.core/assoc :pull-request-id (deser-pull-request-id (input "pullRequestId"))) (clojure.core/contains? input "beforeCommitId") (clojure.core/assoc :before-commit-id (deser-commit-id (input "beforeCommitId"))) (clojure.core/contains? input "afterCommitId") (clojure.core/assoc :after-commit-id (deser-commit-id (input "afterCommitId"))) (clojure.core/contains? input "beforeBlobId") (clojure.core/assoc :before-blob-id (deser-object-id (input "beforeBlobId"))) (clojure.core/contains? input "afterBlobId") (clojure.core/assoc :after-blob-id (deser-object-id (input "afterBlobId"))) (clojure.core/contains? input "location") (clojure.core/assoc :location (deser-location (input "location"))) (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-get-comments-for-compared-commit-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "commentsForComparedCommitData") (clojure.core/assoc :comments-for-compared-commit-data (deser-comments-for-compared-commit-data (input "commentsForComparedCommitData"))) (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-comment-deleted-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-pull-request-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-repositories-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositories") (clojure.core/assoc :repositories (deser-repository-name-id-pair-list (input "repositories"))) (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-blob-id-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-comment-content-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-names-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-maximum-branches-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-limit-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-pull-request-description-output [input] (clojure.core/cond-> {:pull-request (deser-pull-request (input "pullRequest"))}))

(clojure.core/defn- deser-parent-commit-id-outdated-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-blob-id-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-multiple-repositories-in-pull-request-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-file-content-size-limit-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-branch-name-is-tag-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-name-exists-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-branch-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-relative-file-version-enum-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-comment-content-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-comment-not-created-by-caller-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-folder-output [input] (clojure.core/cond-> {:commit-id (deser-object-id (input "commitId")), :folder-path (deser-path (input "folderPath"))} (clojure.core/contains? input "treeId") (clojure.core/assoc :tree-id (deser-object-id (input "treeId"))) (clojure.core/contains? input "subFolders") (clojure.core/assoc :sub-folders (deser-folder-list (input "subFolders"))) (clojure.core/contains? input "files") (clojure.core/assoc :files (deser-file-list (input "files"))) (clojure.core/contains? input "symbolicLinks") (clojure.core/assoc :symbolic-links (deser-symbolic-link-list (input "symbolicLinks"))) (clojure.core/contains? input "subModules") (clojure.core/assoc :sub-modules (deser-sub-module-list (input "subModules")))))

(clojure.core/defn- deser-path-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-pull-request-event-type-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-repository-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositoryId") (clojure.core/assoc :repository-id (deser-repository-id (input "repositoryId")))))

(clojure.core/defn- deser-invalid-parent-commit-id-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-actor-arn-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-targets-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-repository-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-repository-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositoryMetadata") (clojure.core/assoc :repository-metadata (deser-repository-metadata (input "repositoryMetadata")))))

(clojure.core/defn- deser-describe-pull-request-events-output [input] (clojure.core/cond-> {:pull-request-events (deser-pull-request-event-list (input "pullRequestEvents"))} (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-invalid-order-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-pull-requests-output [input] (clojure.core/cond-> {:pull-request-ids (deser-pull-request-id-list (input "pullRequestIds"))} (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-update-comment-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-invalid-description-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-manual-merge-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-repository-trigger-destination-arn-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-same-file-content-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-maximum-repository-names-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-comment-id-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-commit-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-pull-request-output [input] (clojure.core/cond-> {:pull-request (deser-pull-request (input "pullRequest"))}))

(clojure.core/defn- deser-commit-id-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-commit-id-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-targets-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-title-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-commit-id-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-comment-content-size-limit-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tips-divergence-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-file-content-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-trigger-name-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-author-does-not-exist-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-reference-type-not-supported-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-destination-commit-specifier-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-trigger-events-list-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-pull-request-output [input] (clojure.core/cond-> {:pull-request (deser-pull-request (input "pullRequest"))}))

(clojure.core/defn- deser-pull-request-status-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-test-repository-triggers-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "successfulExecutions") (clojure.core/assoc :successful-executions (deser-repository-trigger-name-list (input "successfulExecutions"))) (clojure.core/contains? input "failedExecutions") (clojure.core/assoc :failed-executions (deser-repository-trigger-execution-failure-list (input "failedExecutions")))))

(clojure.core/defn- deser-invalid-repository-trigger-events-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-file-location-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-branch-name-exists-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-merge-option-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-target-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-repository-triggers-list-required-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-comments-for-pull-request-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "commentsForPullRequestData") (clojure.core/assoc :comments-for-pull-request-data (deser-comments-for-pull-request-data (input "commentsForPullRequestData"))) (clojure.core/contains? input "nextToken") (clojure.core/assoc :next-token (deser-next-token (input "nextToken")))))

(clojure.core/defn- deser-get-merge-conflicts-output [input] (clojure.core/cond-> {:mergeable (deser-is-mergeable (input "mergeable")), :destination-commit-id (deser-commit-id (input "destinationCommitId")), :source-commit-id (deser-commit-id (input "sourceCommitId"))}))

(clojure.core/defn- deser-post-comment-for-compared-commit-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositoryName") (clojure.core/assoc :repository-name (deser-repository-name (input "repositoryName"))) (clojure.core/contains? input "beforeCommitId") (clojure.core/assoc :before-commit-id (deser-commit-id (input "beforeCommitId"))) (clojure.core/contains? input "afterCommitId") (clojure.core/assoc :after-commit-id (deser-commit-id (input "afterCommitId"))) (clojure.core/contains? input "beforeBlobId") (clojure.core/assoc :before-blob-id (deser-object-id (input "beforeBlobId"))) (clojure.core/contains? input "afterBlobId") (clojure.core/assoc :after-blob-id (deser-object-id (input "afterBlobId"))) (clojure.core/contains? input "location") (clojure.core/assoc :location (deser-location (input "location"))) (clojure.core/contains? input "comment") (clojure.core/assoc :comment (deser-comment (input "comment")))))

(clojure.core/defn- deser-get-differences-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "differences") (clojure.core/assoc :differences (deser-difference-list (input "differences"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-source-and-destination-are-same-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-branch-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "branch") (clojure.core/assoc :branch (deser-branch-info (input "branch")))))

(clojure.core/defn- deser-repository-not-associated-with-pull-request-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-repository-trigger-branch-name-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-commit-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-batch-get-repositories-output [input] (clojure.core/cond-> {} (clojure.core/contains? input "repositories") (clojure.core/assoc :repositories (deser-repository-metadata-list (input "repositories"))) (clojure.core/contains? input "repositoriesNotFound") (clojure.core/assoc :repositories-not-found (deser-repository-not-found-list (input "repositoriesNotFound")))))

(clojure.core/defn- deser-invalid-repository-trigger-custom-data-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-name-length-exceeded-exception [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-encryption-key-disabled-exception [input] (clojure.core/cond-> {}))
...
(clojure.spec.alpha/def :portkey.aws.codecommit/repository-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 100)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\w\.-]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codecommit/branch-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.codecommit/title (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 150))))
...
(clojure.spec.alpha/def :portkey.aws.codecommit/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.codecommit/repository-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1000))))
...
(clojure.core/defn update-repository-name ([update-repository-name-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-repository-name-input update-repository-name-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/update-repository-name-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateRepositoryName", :http.request.configuration/output-deser-fn deser, :http.request.spec/error-spec {"RepositoryDoesNotExistException" :portkey.aws.codecommit/repository-does-not-exist-exception, "RepositoryNameExistsException" :portkey.aws.codecommit/repository-name-exists-exception, "RepositoryNameRequiredException" :portkey.aws.codecommit/repository-name-required-exception, "InvalidRepositoryNameException" :portkey.aws.codecommit/invalid-repository-name-exception}})))))
...
(clojure.core/defn update-pull-request-description ([update-pull-request-description-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-pull-request-description-input update-pull-request-description-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec :portkey.aws.codecommit/update-pull-request-description-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/update-pull-request-description-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdatePullRequestDescription", :http.request.configuration/output-deser-fn deser-update-pull-request-description-output, :http.request.spec/error-spec {"PullRequestDoesNotExistException" :portkey.aws.codecommit/pull-request-does-not-exist-exception, "InvalidPullRequestIdException" :portkey.aws.codecommit/invalid-pull-request-id-exception, "PullRequestIdRequiredException" :portkey.aws.codecommit/pull-request-id-required-exception, "InvalidDescriptionException" :portkey.aws.codecommit/invalid-description-exception, "PullRequestAlreadyClosedException" :portkey.aws.codecommit/pull-request-already-closed-exception}})))))
...
(clojure.core/defn get-pull-request ([get-pull-request-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-pull-request-input get-pull-request-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec :portkey.aws.codecommit/get-pull-request-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/get-pull-request-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetPullRequest", :http.request.configuration/output-deser-fn deser-get-pull-request-output, :http.request.spec/error-spec {"PullRequestDoesNotExistException" :portkey.aws.codecommit/pull-request-does-not-exist-exception, "InvalidPullRequestIdException" :portkey.aws.codecommit/invalid-pull-request-id-exception, "PullRequestIdRequiredException" :portkey.aws.codecommit/pull-request-id-required-exception, "EncryptionIntegrityChecksFailedException" :portkey.aws.codecommit/encryption-integrity-checks-failed-exception, "EncryptionKeyAccessDeniedException" :portkey.aws.codecommit/encryption-key-access-denied-exception, "EncryptionKeyDisabledException" :portkey.aws.codecommit/encryption-key-disabled-exception, "EncryptionKeyNotFoundException" :portkey.aws.codecommit/encryption-key-not-found-exception, "EncryptionKeyUnavailableException" :portkey.aws.codecommit/encryption-key-unavailable-exception}})))))
...
(clojure.core/defn update-default-branch ([update-default-branch-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-default-branch-input update-default-branch-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/update-default-branch-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDefaultBranch", :http.request.configuration/output-deser-fn deser, :http.request.spec/error-spec {"EncryptionKeyNotFoundException" :portkey.aws.codecommit/encryption-key-not-found-exception, "EncryptionIntegrityChecksFailedException" :portkey.aws.codecommit/encryption-integrity-checks-failed-exception, "EncryptionKeyAccessDeniedException" :portkey.aws.codecommit/encryption-key-access-denied-exception, "BranchNameRequiredException" :portkey.aws.codecommit/branch-name-required-exception, "BranchDoesNotExistException" :portkey.aws.codecommit/branch-does-not-exist-exception, "EncryptionKeyUnavailableException" :portkey.aws.codecommit/encryption-key-unavailable-exception, "RepositoryNameRequiredException" :portkey.aws.codecommit/repository-name-required-exception, "InvalidBranchNameException" :portkey.aws.codecommit/invalid-branch-name-exception, "InvalidRepositoryNameException" :portkey.aws.codecommit/invalid-repository-name-exception, "RepositoryDoesNotExistException" :portkey.aws.codecommit/repository-does-not-exist-exception, "EncryptionKeyDisabledException" :portkey.aws.codecommit/encryption-key-disabled-exception}})))))
...
(clojure.core/defn update-repository-description ([update-repository-description-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-repository-description-input update-repository-description-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/update-repository-description-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateRepositoryDescription", :http.request.configuration/output-deser-fn deser, :http.request.spec/error-spec {"EncryptionKeyNotFoundException" :portkey.aws.codecommit/encryption-key-not-found-exception, "InvalidRepositoryDescriptionException" :portkey.aws.codecommit/invalid-repository-description-exception, "EncryptionIntegrityChecksFailedException" :portkey.aws.codecommit/encryption-integrity-checks-failed-exception, "EncryptionKeyAccessDeniedException" :portkey.aws.codecommit/encryption-key-access-denied-exception, "EncryptionKeyUnavailableException" :portkey.aws.codecommit/encryption-key-unavailable-exception, "RepositoryNameRequiredException" :portkey.aws.codecommit/repository-name-required-exception, "InvalidRepositoryNameException" :portkey.aws.codecommit/invalid-repository-name-exception, "RepositoryDoesNotExistException" :portkey.aws.codecommit/repository-does-not-exist-exception, "EncryptionKeyDisabledException" :portkey.aws.codecommit/encryption-key-disabled-exception}})))))
...
(clojure.core/defn update-pull-request-title ([update-pull-request-title-inputinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-pull-request-title-input update-pull-request-title-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.codecommit/endpoints, :http.request.configuration/target-prefix "CodeCommit_20150413", :http.request.spec/output-spec :portkey.aws.codecommit/update-pull-request-title-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-04-13", :http.request.configuration/service-id "CodeCommit", :http.request.spec/input-spec :portkey.aws.codecommit/update-pull-request-title-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdatePullRequestTitle", :http.request.configuration/output-deser-fn deser-update-pull-request-title-output, :http.request.spec/error-spec {"PullRequestDoesNotExistException" :portkey.aws.codecommit/pull-request-does-not-exist-exception, "InvalidPullRequestIdException" :portkey.aws.codecommit/invalid-pull-request-id-exception, "PullRequestIdRequiredException" :portkey.aws.codecommit/pull-request-id-required-exception, "TitleRequiredException" :portkey.aws.codecommit/title-required-exception, "InvalidTitleException" :portkey.aws.codecommit/invalid-title-exception, "PullRequestAlreadyClosedException" :portkey.aws.codecommit/pull-request-already-closed-exception}})))))
