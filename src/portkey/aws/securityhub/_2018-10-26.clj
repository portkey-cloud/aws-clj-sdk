...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper464752 input] (clojure.core/let [rawinput464751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464753 {"UnprocessedAccounts" (rawinput464751 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464753 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464753 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper464755 input] (clojure.core/let [rawinput464754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464756 {"Master" (rawinput464754 "Master")}] (clojure.core/cond-> {} (letvar464756 "Master") (clojure.core/assoc :master (deser-invitation (clojure.core/get-in letvar464756 ["Master"])))))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper464758 input] (clojure.core/let [rawinput464757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464759 {"UnprocessedAccounts" (rawinput464757 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464759 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464759 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disable-import-findings-for-product-response ([input] (response-disable-import-findings-for-product-response nil input)) ([resultWrapper464761 input] (clojure.core/let [rawinput464760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464762 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper464764 input] (clojure.core/let [rawinput464763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464765 {"UnprocessedAccounts" (rawinput464763 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464765 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464765 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper464767 input] (clojure.core/let [rawinput464766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464768 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper464770 input] (clojure.core/let [rawinput464769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464771 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper464773 input] (clojure.core/let [rawinput464772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464774 {"Members" (rawinput464772 "Members"), "UnprocessedAccounts" (rawinput464772 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464774 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar464774 ["Members"]))) (letvar464774 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464774 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-batch-enable-standards-response ([input] (response-batch-enable-standards-response nil input)) ([resultWrapper464776 input] (clojure.core/let [rawinput464775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464777 {"StandardsSubscriptions" (rawinput464775 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar464777 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar464777 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-enabled-standards-response ([input] (response-get-enabled-standards-response nil input)) ([resultWrapper464779 input] (clojure.core/let [rawinput464778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464780 {"StandardsSubscriptions" (rawinput464778 "StandardsSubscriptions"), "NextToken" (rawinput464778 "NextToken")}] (clojure.core/cond-> {} (letvar464780 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar464780 ["StandardsSubscriptions"]))) (letvar464780 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar464780 ["NextToken"])))))))

(clojure.core/defn- response-get-insight-results-response ([input] (response-get-insight-results-response nil input)) ([resultWrapper464782 input] (clojure.core/let [rawinput464781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464783 {"InsightResults" (rawinput464781 "InsightResults")}] (clojure.core/cond-> {:insight-results (deser-insight-results (clojure.core/get-in letvar464783 ["InsightResults"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper464785 input] (clojure.core/let [rawinput464784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464786 {"Message" (rawinput464784 "Message"), "Code" (rawinput464784 "Code")}] (clojure.core/cond-> {} (letvar464786 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar464786 ["Message"]))) (letvar464786 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar464786 ["Code"])))))))

(clojure.core/defn- response-batch-import-findings-response ([input] (response-batch-import-findings-response nil input)) ([resultWrapper464788 input] (clojure.core/let [rawinput464787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464789 {"FailedCount" (rawinput464787 "FailedCount"), "SuccessCount" (rawinput464787 "SuccessCount"), "FailedFindings" (rawinput464787 "FailedFindings")}] (clojure.core/cond-> {:failed-count (deser-integer (clojure.core/get-in letvar464789 ["FailedCount"])), :success-count (deser-integer (clojure.core/get-in letvar464789 ["SuccessCount"]))} (letvar464789 "FailedFindings") (clojure.core/assoc :failed-findings (deser-import-findings-error-list (clojure.core/get-in letvar464789 ["FailedFindings"])))))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper464791 input] (clojure.core/let [rawinput464790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464792 {"Invitations" (rawinput464790 "Invitations"), "NextToken" (rawinput464790 "NextToken")}] (clojure.core/cond-> {} (letvar464792 "Invitations") (clojure.core/assoc :invitations (deser-invitation-list (clojure.core/get-in letvar464792 ["Invitations"]))) (letvar464792 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar464792 ["NextToken"])))))))

(clojure.core/defn- response-enable-import-findings-for-product-response ([input] (response-enable-import-findings-for-product-response nil input)) ([resultWrapper464794 input] (clojure.core/let [rawinput464793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464795 {"ProductSubscriptionArn" (rawinput464793 "ProductSubscriptionArn")}] (clojure.core/cond-> {} (letvar464795 "ProductSubscriptionArn") (clojure.core/assoc :product-subscription-arn (deser-non-empty-string (clojure.core/get-in letvar464795 ["ProductSubscriptionArn"])))))))

(clojure.core/defn- response-batch-disable-standards-response ([input] (response-batch-disable-standards-response nil input)) ([resultWrapper464797 input] (clojure.core/let [rawinput464796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464798 {"StandardsSubscriptions" (rawinput464796 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar464798 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar464798 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-insights-response ([input] (response-get-insights-response nil input)) ([resultWrapper464800 input] (clojure.core/let [rawinput464799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464801 {"Insights" (rawinput464799 "Insights"), "NextToken" (rawinput464799 "NextToken")}] (clojure.core/cond-> {:insights (deser-insight-list (clojure.core/get-in letvar464801 ["Insights"]))} (letvar464801 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar464801 ["NextToken"])))))))

(clojure.core/defn- response-disable-security-hub-response ([input] (response-disable-security-hub-response nil input)) ([resultWrapper464803 input] (clojure.core/let [rawinput464802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464804 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-enable-security-hub-response ([input] (response-enable-security-hub-response nil input)) ([resultWrapper464806 input] (clojure.core/let [rawinput464805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464807 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-response ([input] (response-update-findings-response nil input)) ([resultWrapper464809 input] (clojure.core/let [rawinput464808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464810 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper464812 input] (clojure.core/let [rawinput464811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464813 {"Message" (rawinput464811 "Message"), "Code" (rawinput464811 "Code")}] (clojure.core/cond-> {} (letvar464813 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar464813 ["Message"]))) (letvar464813 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar464813 ["Code"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper464815 input] (clojure.core/let [rawinput464814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464816 {"Message" (rawinput464814 "Message"), "Code" (rawinput464814 "Code")}] (clojure.core/cond-> {} (letvar464816 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar464816 ["Message"]))) (letvar464816 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar464816 ["Code"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper464818 input] (clojure.core/let [rawinput464817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464819 {"Message" (rawinput464817 "Message"), "Code" (rawinput464817 "Code")}] (clojure.core/cond-> {} (letvar464819 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar464819 ["Message"]))) (letvar464819 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar464819 ["Code"])))))))

(clojure.core/defn- response-delete-insight-response ([input] (response-delete-insight-response nil input)) ([resultWrapper464821 input] (clojure.core/let [rawinput464820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464822 {"InsightArn" (rawinput464820 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar464822 ["InsightArn"]))}))))

(clojure.core/defn- response-list-enabled-products-for-import-response ([input] (response-list-enabled-products-for-import-response nil input)) ([resultWrapper464824 input] (clojure.core/let [rawinput464823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464825 {"ProductSubscriptions" (rawinput464823 "ProductSubscriptions"), "NextToken" (rawinput464823 "NextToken")}] (clojure.core/cond-> {} (letvar464825 "ProductSubscriptions") (clojure.core/assoc :product-subscriptions (deser-product-subscription-arn-list (clojure.core/get-in letvar464825 ["ProductSubscriptions"]))) (letvar464825 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar464825 ["NextToken"])))))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper464827 input] (clojure.core/let [rawinput464826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464828 {"InvitationsCount" (rawinput464826 "InvitationsCount")}] (clojure.core/cond-> {} (letvar464828 "InvitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar464828 ["InvitationsCount"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper464830 input] (clojure.core/let [rawinput464829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464831 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper464833 input] (clojure.core/let [rawinput464832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464834 {"Findings" (rawinput464832 "Findings"), "NextToken" (rawinput464832 "NextToken")}] (clojure.core/cond-> {:findings (deser-aws-security-finding-list (clojure.core/get-in letvar464834 ["Findings"]))} (letvar464834 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar464834 ["NextToken"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper464836 input] (clojure.core/let [rawinput464835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464837 {"UnprocessedAccounts" (rawinput464835 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464837 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464837 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper464839 input] (clojure.core/let [rawinput464838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464840 {"UnprocessedAccounts" (rawinput464838 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar464840 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar464840 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-update-insight-response ([input] (response-update-insight-response nil input)) ([resultWrapper464842 input] (clojure.core/let [rawinput464841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464843 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-insight-response ([input] (response-create-insight-response nil input)) ([resultWrapper464845 input] (clojure.core/let [rawinput464844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464846 {"InsightArn" (rawinput464844 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar464846 ["InsightArn"]))}))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper464848 input] (clojure.core/let [rawinput464847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar464849 {"Members" (rawinput464847 "Members"), "NextToken" (rawinput464847 "NextToken")}] (clojure.core/cond-> {} (letvar464849 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar464849 ["Members"]))) (letvar464849 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar464849 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.securityhub.-2018-10-26/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #".*\S.*" s__21112__auto__))))
