...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper1700249 input] (clojure.core/let [rawinput1700248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700250 {"UnprocessedAccounts" (rawinput1700248 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700250 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700250 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper1700252 input] (clojure.core/let [rawinput1700251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700253 {"Master" (rawinput1700251 "Master")}] (clojure.core/cond-> {} (letvar1700253 "Master") (clojure.core/assoc :master (deser-invitation (clojure.core/get-in letvar1700253 ["Master"])))))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper1700255 input] (clojure.core/let [rawinput1700254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700256 {"UnprocessedAccounts" (rawinput1700254 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700256 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700256 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disable-import-findings-for-product-response ([input] (response-disable-import-findings-for-product-response nil input)) ([resultWrapper1700258 input] (clojure.core/let [rawinput1700257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700259 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper1700261 input] (clojure.core/let [rawinput1700260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700262 {"UnprocessedAccounts" (rawinput1700260 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700262 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700262 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper1700264 input] (clojure.core/let [rawinput1700263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700265 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper1700267 input] (clojure.core/let [rawinput1700266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700268 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper1700270 input] (clojure.core/let [rawinput1700269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700271 {"Members" (rawinput1700269 "Members"), "UnprocessedAccounts" (rawinput1700269 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700271 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar1700271 ["Members"]))) (letvar1700271 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700271 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-batch-enable-standards-response ([input] (response-batch-enable-standards-response nil input)) ([resultWrapper1700273 input] (clojure.core/let [rawinput1700272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700274 {"StandardsSubscriptions" (rawinput1700272 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar1700274 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1700274 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-enabled-standards-response ([input] (response-get-enabled-standards-response nil input)) ([resultWrapper1700276 input] (clojure.core/let [rawinput1700275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700277 {"StandardsSubscriptions" (rawinput1700275 "StandardsSubscriptions"), "NextToken" (rawinput1700275 "NextToken")}] (clojure.core/cond-> {} (letvar1700277 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1700277 ["StandardsSubscriptions"]))) (letvar1700277 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1700277 ["NextToken"])))))))

(clojure.core/defn- response-get-insight-results-response ([input] (response-get-insight-results-response nil input)) ([resultWrapper1700279 input] (clojure.core/let [rawinput1700278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700280 {"InsightResults" (rawinput1700278 "InsightResults")}] (clojure.core/cond-> {:insight-results (deser-insight-results (clojure.core/get-in letvar1700280 ["InsightResults"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1700282 input] (clojure.core/let [rawinput1700281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700283 {"Message" (rawinput1700281 "Message"), "Code" (rawinput1700281 "Code")}] (clojure.core/cond-> {} (letvar1700283 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1700283 ["Message"]))) (letvar1700283 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1700283 ["Code"])))))))

(clojure.core/defn- response-batch-import-findings-response ([input] (response-batch-import-findings-response nil input)) ([resultWrapper1700285 input] (clojure.core/let [rawinput1700284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700286 {"FailedCount" (rawinput1700284 "FailedCount"), "SuccessCount" (rawinput1700284 "SuccessCount"), "FailedFindings" (rawinput1700284 "FailedFindings")}] (clojure.core/cond-> {:failed-count (deser-integer (clojure.core/get-in letvar1700286 ["FailedCount"])), :success-count (deser-integer (clojure.core/get-in letvar1700286 ["SuccessCount"]))} (letvar1700286 "FailedFindings") (clojure.core/assoc :failed-findings (deser-import-findings-error-list (clojure.core/get-in letvar1700286 ["FailedFindings"])))))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper1700288 input] (clojure.core/let [rawinput1700287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700289 {"Invitations" (rawinput1700287 "Invitations"), "NextToken" (rawinput1700287 "NextToken")}] (clojure.core/cond-> {} (letvar1700289 "Invitations") (clojure.core/assoc :invitations (deser-invitation-list (clojure.core/get-in letvar1700289 ["Invitations"]))) (letvar1700289 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1700289 ["NextToken"])))))))

(clojure.core/defn- response-enable-import-findings-for-product-response ([input] (response-enable-import-findings-for-product-response nil input)) ([resultWrapper1700291 input] (clojure.core/let [rawinput1700290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700292 {"ProductSubscriptionArn" (rawinput1700290 "ProductSubscriptionArn")}] (clojure.core/cond-> {} (letvar1700292 "ProductSubscriptionArn") (clojure.core/assoc :product-subscription-arn (deser-non-empty-string (clojure.core/get-in letvar1700292 ["ProductSubscriptionArn"])))))))

(clojure.core/defn- response-batch-disable-standards-response ([input] (response-batch-disable-standards-response nil input)) ([resultWrapper1700294 input] (clojure.core/let [rawinput1700293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700295 {"StandardsSubscriptions" (rawinput1700293 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar1700295 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1700295 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-insights-response ([input] (response-get-insights-response nil input)) ([resultWrapper1700297 input] (clojure.core/let [rawinput1700296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700298 {"Insights" (rawinput1700296 "Insights"), "NextToken" (rawinput1700296 "NextToken")}] (clojure.core/cond-> {:insights (deser-insight-list (clojure.core/get-in letvar1700298 ["Insights"]))} (letvar1700298 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1700298 ["NextToken"])))))))

(clojure.core/defn- response-disable-security-hub-response ([input] (response-disable-security-hub-response nil input)) ([resultWrapper1700300 input] (clojure.core/let [rawinput1700299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700301 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-enable-security-hub-response ([input] (response-enable-security-hub-response nil input)) ([resultWrapper1700303 input] (clojure.core/let [rawinput1700302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700304 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-response ([input] (response-update-findings-response nil input)) ([resultWrapper1700306 input] (clojure.core/let [rawinput1700305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700307 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1700309 input] (clojure.core/let [rawinput1700308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700310 {"Message" (rawinput1700308 "Message"), "Code" (rawinput1700308 "Code")}] (clojure.core/cond-> {} (letvar1700310 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1700310 ["Message"]))) (letvar1700310 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1700310 ["Code"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1700312 input] (clojure.core/let [rawinput1700311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700313 {"Message" (rawinput1700311 "Message"), "Code" (rawinput1700311 "Code")}] (clojure.core/cond-> {} (letvar1700313 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1700313 ["Message"]))) (letvar1700313 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1700313 ["Code"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1700315 input] (clojure.core/let [rawinput1700314 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700316 {"Message" (rawinput1700314 "Message"), "Code" (rawinput1700314 "Code")}] (clojure.core/cond-> {} (letvar1700316 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1700316 ["Message"]))) (letvar1700316 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1700316 ["Code"])))))))

(clojure.core/defn- response-delete-insight-response ([input] (response-delete-insight-response nil input)) ([resultWrapper1700318 input] (clojure.core/let [rawinput1700317 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700319 {"InsightArn" (rawinput1700317 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar1700319 ["InsightArn"]))}))))

(clojure.core/defn- response-list-enabled-products-for-import-response ([input] (response-list-enabled-products-for-import-response nil input)) ([resultWrapper1700321 input] (clojure.core/let [rawinput1700320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700322 {"ProductSubscriptions" (rawinput1700320 "ProductSubscriptions"), "NextToken" (rawinput1700320 "NextToken")}] (clojure.core/cond-> {} (letvar1700322 "ProductSubscriptions") (clojure.core/assoc :product-subscriptions (deser-product-subscription-arn-list (clojure.core/get-in letvar1700322 ["ProductSubscriptions"]))) (letvar1700322 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1700322 ["NextToken"])))))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper1700324 input] (clojure.core/let [rawinput1700323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700325 {"InvitationsCount" (rawinput1700323 "InvitationsCount")}] (clojure.core/cond-> {} (letvar1700325 "InvitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar1700325 ["InvitationsCount"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper1700327 input] (clojure.core/let [rawinput1700326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700328 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper1700330 input] (clojure.core/let [rawinput1700329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700331 {"Findings" (rawinput1700329 "Findings"), "NextToken" (rawinput1700329 "NextToken")}] (clojure.core/cond-> {:findings (deser-aws-security-finding-list (clojure.core/get-in letvar1700331 ["Findings"]))} (letvar1700331 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1700331 ["NextToken"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper1700333 input] (clojure.core/let [rawinput1700332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700334 {"UnprocessedAccounts" (rawinput1700332 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700334 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700334 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper1700336 input] (clojure.core/let [rawinput1700335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700337 {"UnprocessedAccounts" (rawinput1700335 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1700337 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1700337 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-update-insight-response ([input] (response-update-insight-response nil input)) ([resultWrapper1700339 input] (clojure.core/let [rawinput1700338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700340 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-insight-response ([input] (response-create-insight-response nil input)) ([resultWrapper1700342 input] (clojure.core/let [rawinput1700341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700343 {"InsightArn" (rawinput1700341 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar1700343 ["InsightArn"]))}))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper1700345 input] (clojure.core/let [rawinput1700344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1700346 {"Members" (rawinput1700344 "Members"), "NextToken" (rawinput1700344 "NextToken")}] (clojure.core/cond-> {} (letvar1700346 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar1700346 ["Members"]))) (letvar1700346 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1700346 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.securityhub.-2018-10-26/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
