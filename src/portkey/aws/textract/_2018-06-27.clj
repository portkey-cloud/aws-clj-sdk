...
(clojure.core/defn- response-invalid-s-3-object-exception ([input] (response-invalid-s-3-object-exception nil input)) ([resultWrapper2122911 input] (clojure.core/let [rawinput2122910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122912 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-analysis-response ([input] (response-get-document-analysis-response nil input)) ([resultWrapper2122914 input] (clojure.core/let [rawinput2122913 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122915 {"DocumentMetadata" (rawinput2122913 "DocumentMetadata"), "JobStatus" (rawinput2122913 "JobStatus"), "NextToken" (rawinput2122913 "NextToken"), "Blocks" (rawinput2122913 "Blocks"), "Warnings" (rawinput2122913 "Warnings"), "StatusMessage" (rawinput2122913 "StatusMessage")}] (clojure.core/cond-> {} (letvar2122915 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2122915 ["DocumentMetadata"]))) (letvar2122915 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar2122915 ["JobStatus"]))) (letvar2122915 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2122915 ["NextToken"]))) (letvar2122915 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2122915 ["Blocks"]))) (letvar2122915 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar2122915 ["Warnings"]))) (letvar2122915 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar2122915 ["StatusMessage"])))))))

(clojure.core/defn- response-analyze-document-response ([input] (response-analyze-document-response nil input)) ([resultWrapper2122917 input] (clojure.core/let [rawinput2122916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122918 {"DocumentMetadata" (rawinput2122916 "DocumentMetadata"), "Blocks" (rawinput2122916 "Blocks")}] (clojure.core/cond-> {} (letvar2122918 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2122918 ["DocumentMetadata"]))) (letvar2122918 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2122918 ["Blocks"])))))))

(clojure.core/defn- response-document-too-large-exception ([input] (response-document-too-large-exception nil input)) ([resultWrapper2122920 input] (clojure.core/let [rawinput2122919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122921 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2122923 input] (clojure.core/let [rawinput2122922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122924 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-job-id-exception ([input] (response-invalid-job-id-exception nil input)) ([resultWrapper2122926 input] (clojure.core/let [rawinput2122925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122927 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-document-exception ([input] (response-bad-document-exception nil input)) ([resultWrapper2122929 input] (clojure.core/let [rawinput2122928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122930 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-analysis-response ([input] (response-start-document-analysis-response nil input)) ([resultWrapper2122932 input] (clojure.core/let [rawinput2122931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122933 {"JobId" (rawinput2122931 "JobId")}] (clojure.core/cond-> {} (letvar2122933 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar2122933 ["JobId"])))))))

(clojure.core/defn- response-detect-document-text-response ([input] (response-detect-document-text-response nil input)) ([resultWrapper2122935 input] (clojure.core/let [rawinput2122934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122936 {"DocumentMetadata" (rawinput2122934 "DocumentMetadata"), "Blocks" (rawinput2122934 "Blocks")}] (clojure.core/cond-> {} (letvar2122936 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2122936 ["DocumentMetadata"]))) (letvar2122936 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2122936 ["Blocks"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper2122938 input] (clojure.core/let [rawinput2122937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122939 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2122941 input] (clojure.core/let [rawinput2122940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122942 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-text-detection-response ([input] (response-start-document-text-detection-response nil input)) ([resultWrapper2122944 input] (clojure.core/let [rawinput2122943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122945 {"JobId" (rawinput2122943 "JobId")}] (clojure.core/cond-> {} (letvar2122945 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar2122945 ["JobId"])))))))

(clojure.core/defn- response-unsupported-document-exception ([input] (response-unsupported-document-exception nil input)) ([resultWrapper2122947 input] (clojure.core/let [rawinput2122946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122948 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper2122950 input] (clojure.core/let [rawinput2122949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122951 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2122953 input] (clojure.core/let [rawinput2122952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122954 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2122956 input] (clojure.core/let [rawinput2122955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122957 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-text-detection-response ([input] (response-get-document-text-detection-response nil input)) ([resultWrapper2122959 input] (clojure.core/let [rawinput2122958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122960 {"DocumentMetadata" (rawinput2122958 "DocumentMetadata"), "JobStatus" (rawinput2122958 "JobStatus"), "NextToken" (rawinput2122958 "NextToken"), "Blocks" (rawinput2122958 "Blocks"), "Warnings" (rawinput2122958 "Warnings"), "StatusMessage" (rawinput2122958 "StatusMessage")}] (clojure.core/cond-> {} (letvar2122960 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2122960 ["DocumentMetadata"]))) (letvar2122960 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar2122960 ["JobStatus"]))) (letvar2122960 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2122960 ["NextToken"]))) (letvar2122960 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2122960 ["Blocks"]))) (letvar2122960 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar2122960 ["Warnings"]))) (letvar2122960 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar2122960 ["StatusMessage"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper2122962 input] (clojure.core/let [rawinput2122961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2122963 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:([a-z\d-]+):iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/s-3-object-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"(^arn:([a-z\d-]+):sns:[a-zA-Z\d-]{1,20}:\w{12}:.+$)" s__1467903__auto__))))
