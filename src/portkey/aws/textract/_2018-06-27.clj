...
(clojure.core/defn- response-invalid-s-3-object-exception ([input] (response-invalid-s-3-object-exception nil input)) ([resultWrapper1849333 input] (clojure.core/let [rawinput1849332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849334 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-analysis-response ([input] (response-get-document-analysis-response nil input)) ([resultWrapper1849336 input] (clojure.core/let [rawinput1849335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849337 {"DocumentMetadata" (rawinput1849335 "DocumentMetadata"), "JobStatus" (rawinput1849335 "JobStatus"), "NextToken" (rawinput1849335 "NextToken"), "Blocks" (rawinput1849335 "Blocks"), "Warnings" (rawinput1849335 "Warnings"), "StatusMessage" (rawinput1849335 "StatusMessage")}] (clojure.core/cond-> {} (letvar1849337 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1849337 ["DocumentMetadata"]))) (letvar1849337 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar1849337 ["JobStatus"]))) (letvar1849337 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1849337 ["NextToken"]))) (letvar1849337 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1849337 ["Blocks"]))) (letvar1849337 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar1849337 ["Warnings"]))) (letvar1849337 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar1849337 ["StatusMessage"])))))))

(clojure.core/defn- response-analyze-document-response ([input] (response-analyze-document-response nil input)) ([resultWrapper1849339 input] (clojure.core/let [rawinput1849338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849340 {"DocumentMetadata" (rawinput1849338 "DocumentMetadata"), "Blocks" (rawinput1849338 "Blocks")}] (clojure.core/cond-> {} (letvar1849340 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1849340 ["DocumentMetadata"]))) (letvar1849340 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1849340 ["Blocks"])))))))

(clojure.core/defn- response-document-too-large-exception ([input] (response-document-too-large-exception nil input)) ([resultWrapper1849342 input] (clojure.core/let [rawinput1849341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849343 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1849345 input] (clojure.core/let [rawinput1849344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849346 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-job-id-exception ([input] (response-invalid-job-id-exception nil input)) ([resultWrapper1849348 input] (clojure.core/let [rawinput1849347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849349 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-document-exception ([input] (response-bad-document-exception nil input)) ([resultWrapper1849351 input] (clojure.core/let [rawinput1849350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849352 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-analysis-response ([input] (response-start-document-analysis-response nil input)) ([resultWrapper1849354 input] (clojure.core/let [rawinput1849353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849355 {"JobId" (rawinput1849353 "JobId")}] (clojure.core/cond-> {} (letvar1849355 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1849355 ["JobId"])))))))

(clojure.core/defn- response-detect-document-text-response ([input] (response-detect-document-text-response nil input)) ([resultWrapper1849357 input] (clojure.core/let [rawinput1849356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849358 {"DocumentMetadata" (rawinput1849356 "DocumentMetadata"), "Blocks" (rawinput1849356 "Blocks")}] (clojure.core/cond-> {} (letvar1849358 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1849358 ["DocumentMetadata"]))) (letvar1849358 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1849358 ["Blocks"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper1849360 input] (clojure.core/let [rawinput1849359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849361 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1849363 input] (clojure.core/let [rawinput1849362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849364 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-text-detection-response ([input] (response-start-document-text-detection-response nil input)) ([resultWrapper1849366 input] (clojure.core/let [rawinput1849365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849367 {"JobId" (rawinput1849365 "JobId")}] (clojure.core/cond-> {} (letvar1849367 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1849367 ["JobId"])))))))

(clojure.core/defn- response-unsupported-document-exception ([input] (response-unsupported-document-exception nil input)) ([resultWrapper1849369 input] (clojure.core/let [rawinput1849368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849370 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1849372 input] (clojure.core/let [rawinput1849371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849373 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1849375 input] (clojure.core/let [rawinput1849374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849376 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1849378 input] (clojure.core/let [rawinput1849377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849379 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-text-detection-response ([input] (response-get-document-text-detection-response nil input)) ([resultWrapper1849381 input] (clojure.core/let [rawinput1849380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849382 {"DocumentMetadata" (rawinput1849380 "DocumentMetadata"), "JobStatus" (rawinput1849380 "JobStatus"), "NextToken" (rawinput1849380 "NextToken"), "Blocks" (rawinput1849380 "Blocks"), "Warnings" (rawinput1849380 "Warnings"), "StatusMessage" (rawinput1849380 "StatusMessage")}] (clojure.core/cond-> {} (letvar1849382 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1849382 ["DocumentMetadata"]))) (letvar1849382 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar1849382 ["JobStatus"]))) (letvar1849382 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1849382 ["NextToken"]))) (letvar1849382 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1849382 ["Blocks"]))) (letvar1849382 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar1849382 ["Warnings"]))) (letvar1849382 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar1849382 ["StatusMessage"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1849384 input] (clojure.core/let [rawinput1849383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1849385 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9-_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/s-3-object-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(^arn:([a-z\d-]+):sns:[a-zA-Z\d-]{1,20}:\w{12}:.+$)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract.-2018-06-27/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Za-z\.\-_]*" s__21078__auto__))))
