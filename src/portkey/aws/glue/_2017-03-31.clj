...
(clojure.core/defn- deser-data-catalog-encryption-settings [input] (clojure.core/cond-> {} (clojure.core/contains? input "EncryptionAtRest") (clojure.core/assoc :encryption-at-rest (deser-encryption-at-rest (input "EncryptionAtRest")))))
...
(clojure.core/defn- deser-connection-property-key [input] (clojure.core/get {"JDBC_CONNECTION_URL" :jdbc-connection-url, "USERNAME" :username, "INSTANCE_ID" :instance-id, "JDBC_DRIVER_JAR_URI" :jdbc-driver-jar-uri, "CONFIG_FILES" :config-files, "JDBC_ENGINE_VERSION" :jdbc-engine-version, "PASSWORD" :password, "HOST" :host, "JDBC_ENGINE" :jdbc-engine, "JDBC_ENFORCE_SSL" :jdbc-enforce-ssl, "PORT" :port, "JDBC_DRIVER_CLASS_NAME" :jdbc-driver-class-name} input))
...
(clojure.core/defn- deser-update-table-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Job") (clojure.core/assoc :job (deser-job (input "Job")))))

(clojure.core/defn- deser-get-table-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Table") (clojure.core/assoc :table (deser-table (input "Table")))))

(clojure.core/defn- deser-get-partitions-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Partitions") (clojure.core/assoc :partitions (deser-partition-list (input "Partitions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-crawler-running-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-delete-database-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-already-exists-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-no-schedule-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-delete-crawler-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-validation-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-update-classifier-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-version-mismatch-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-delete-connection-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-user-defined-functions-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "UserDefinedFunctions") (clojure.core/assoc :user-defined-functions (deser-user-defined-function-list (input "UserDefinedFunctions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-batch-get-partition-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Partitions") (clojure.core/assoc :partitions (deser-partition-list (input "Partitions"))) (clojure.core/contains? input "UnprocessedKeys") (clojure.core/assoc :unprocessed-keys (deser-batch-get-partition-value-list (input "UnprocessedKeys")))))

(clojure.core/defn- deser-update-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobName") (clojure.core/assoc :job-name (deser-name-string (input "JobName")))))

(clojure.core/defn- deser-reset-job-bookmark-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobBookmarkEntry") (clojure.core/assoc :job-bookmark-entry (deser-job-bookmark-entry (input "JobBookmarkEntry")))))

(clojure.core/defn- deser-delete-dev-endpoint-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-partition-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-job-runs-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobRuns") (clojure.core/assoc :job-runs (deser-job-run-list (input "JobRuns"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-get-mapping-response [input] (clojure.core/cond-> {:mapping (deser-mapping-list (input "Mapping"))}))

(clojure.core/defn- deser-batch-delete-partition-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-partition-errors (input "Errors")))))

(clojure.core/defn- deser-create-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name")))))

(clojure.core/defn- deser-batch-create-partition-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-partition-errors (input "Errors")))))

(clojure.core/defn- deser-batch-delete-connection-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Succeeded") (clojure.core/assoc :succeeded (deser-name-string-list (input "Succeeded"))) (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-error-by-name (input "Errors")))))

(clojure.core/defn- deser-import-catalog-to-glue-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-dev-endpoints-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DevEndpoints") (clojure.core/assoc :dev-endpoints (deser-dev-endpoint-list (input "DevEndpoints"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-get-crawlers-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Crawlers") (clojure.core/assoc :crawlers (deser-crawler-list (input "Crawlers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-stop-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name")))))

(clojure.core/defn- deser-get-database-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Database") (clojure.core/assoc :database (deser-database (input "Database")))))

(clojure.core/defn- deser-get-classifiers-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Classifiers") (clojure.core/assoc :classifiers (deser-classifier-list (input "Classifiers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-get-connection-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Connection") (clojure.core/assoc :connection (deser-connection (input "Connection")))))

(clojure.core/defn- deser-get-dev-endpoint-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DevEndpoint") (clojure.core/assoc :dev-endpoint (deser-dev-endpoint (input "DevEndpoint")))))

(clojure.core/defn- deser-batch-delete-table-version-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-table-version-errors (input "Errors")))))

(clojure.core/defn- deser-get-triggers-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Triggers") (clojure.core/assoc :triggers (deser-trigger-list (input "Triggers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-get-job-run-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobRun") (clojure.core/assoc :job-run (deser-job-run (input "JobRun")))))

(clojure.core/defn- deser-create-script-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "PythonScript") (clojure.core/assoc :python-script (deser-python-script (input "PythonScript"))) (clojure.core/contains? input "ScalaCode") (clojure.core/assoc :scala-code (deser-scala-code (input "ScalaCode")))))

(clojure.core/defn- deser-get-security-configurations-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (input "SecurityConfigurations"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-batch-delete-table-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-table-errors (input "Errors")))))

(clojure.core/defn- deser-update-connection-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-table-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-classifier-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-partition-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Partition") (clojure.core/assoc :partition (deser-partition (input "Partition")))))

(clojure.core/defn- deser-get-tables-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "TableList") (clojure.core/assoc :table-list (deser-table-list (input "TableList"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-scheduler-not-running-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-crawler-not-running-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-get-crawler-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Crawler") (clojure.core/assoc :crawler (deser-crawler (input "Crawler")))))

(clojure.core/defn- deser-scheduler-transitioning-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-update-user-defined-function-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-user-defined-function-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-idempotent-parameter-mismatch-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-invalid-input-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-update-partition-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-user-defined-function-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "UserDefinedFunction") (clojure.core/assoc :user-defined-function (deser-user-defined-function (input "UserDefinedFunction")))))

(clojure.core/defn- deser-stop-crawler-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-crawler-metrics-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "CrawlerMetricsList") (clojure.core/assoc :crawler-metrics-list (deser-crawler-metrics-list (input "CrawlerMetricsList"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-resource-number-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-access-denied-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-update-database-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-classifier-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Classifier") (clojure.core/assoc :classifier (deser-classifier (input "Classifier")))))

(clojure.core/defn- deser-create-security-configuration-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name"))) (clojure.core/contains? input "CreatedTimestamp") (clojure.core/assoc :created-timestamp (deser-timestamp-value (input "CreatedTimestamp")))))

(clojure.core/defn- deser-update-dev-endpoint-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-start-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name")))))

(clojure.core/defn- deser-get-table-version-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "TableVersion") (clojure.core/assoc :table-version (deser-table-version (input "TableVersion")))))

(clojure.core/defn- deser-update-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Trigger") (clojure.core/assoc :trigger (deser-trigger (input "Trigger")))))

(clojure.core/defn- deser-get-jobs-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Jobs") (clojure.core/assoc :jobs (deser-job-list (input "Jobs"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-delete-job-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobName") (clojure.core/assoc :job-name (deser-name-string (input "JobName")))))

(clojure.core/defn- deser-start-job-run-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "JobRunId") (clojure.core/assoc :job-run-id (deser-id-string (input "JobRunId")))))

(clojure.core/defn- deser-create-dev-endpoint-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ZeppelinRemoteSparkInterpreterPort") (clojure.core/assoc :zeppelin-remote-spark-interpreter-port (deser-integer-value (input "ZeppelinRemoteSparkInterpreterPort"))) (clojure.core/contains? input "CreatedTimestamp") (clojure.core/assoc :created-timestamp (deser-timestamp-value (input "CreatedTimestamp"))) (clojure.core/contains? input "SecurityGroupIds") (clojure.core/assoc :security-group-ids (deser-string-list (input "SecurityGroupIds"))) (clojure.core/contains? input "YarnEndpointAddress") (clojure.core/assoc :yarn-endpoint-address (deser-generic-string (input "YarnEndpointAddress"))) (clojure.core/contains? input "SubnetId") (clojure.core/assoc :subnet-id (deser-generic-string (input "SubnetId"))) (clojure.core/contains? input "ExtraJarsS3Path") (clojure.core/assoc :extra-jars-s-3-path (deser-generic-string (input "ExtraJarsS3Path"))) (clojure.core/contains? input "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (input "RoleArn"))) (clojure.core/contains? input "NumberOfNodes") (clojure.core/assoc :number-of-nodes (deser-integer-value (input "NumberOfNodes"))) (clojure.core/contains? input "AvailabilityZone") (clojure.core/assoc :availability-zone (deser-generic-string (input "AvailabilityZone"))) (clojure.core/contains? input "Status") (clojure.core/assoc :status (deser-generic-string (input "Status"))) (clojure.core/contains? input "EndpointName") (clojure.core/assoc :endpoint-name (deser-generic-string (input "EndpointName"))) (clojure.core/contains? input "VpcId") (clojure.core/assoc :vpc-id (deser-generic-string (input "VpcId"))) (clojure.core/contains? input "FailureReason") (clojure.core/assoc :failure-reason (deser-generic-string (input "FailureReason"))) (clojure.core/contains? input "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-name-string (input "SecurityConfiguration"))) (clojure.core/contains? input "ExtraPythonLibsS3Path") (clojure.core/assoc :extra-python-libs-s-3-path (deser-generic-string (input "ExtraPythonLibsS3Path")))))

(clojure.core/defn- deser-update-crawler-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-table-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-security-configuration-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name")))))

(clojure.core/defn- deser-get-data-catalog-encryption-settings-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DataCatalogEncryptionSettings") (clojure.core/assoc :data-catalog-encryption-settings (deser-data-catalog-encryption-settings (input "DataCatalogEncryptionSettings")))))

(clojure.core/defn- deser-create-crawler-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-operation-timeout-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-get-databases-response [input] (clojure.core/cond-> {:database-list (deser-database-list (input "DatabaseList"))} (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-delete-table-version-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-user-defined-function-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-crawler-schedule-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-plan-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "PythonScript") (clojure.core/assoc :python-script (deser-python-script (input "PythonScript"))) (clojure.core/contains? input "ScalaCode") (clojure.core/assoc :scala-code (deser-scala-code (input "ScalaCode")))))

(clojure.core/defn- deser-get-security-configuration-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-security-configuration (input "SecurityConfiguration")))))

(clojure.core/defn- deser-delete-classifier-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-connection-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name-string (input "Name")))))

(clojure.core/defn- deser-concurrent-modification-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-get-trigger-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Trigger") (clojure.core/assoc :trigger (deser-trigger (input "Trigger")))))

(clojure.core/defn- deser-get-dataflow-graph-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DagNodes") (clojure.core/assoc :dag-nodes (deser-dag-nodes (input "DagNodes"))) (clojure.core/contains? input "DagEdges") (clojure.core/assoc :dag-edges (deser-dag-edges (input "DagEdges")))))

(clojure.core/defn- deser-create-database-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-concurrent-runs-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-crawler-stopping-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-put-data-catalog-encryption-settings-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-catalog-import-status-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImportStatus") (clojure.core/assoc :import-status (deser-catalog-import-status (input "ImportStatus")))))

(clojure.core/defn- deser-internal-service-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-entity-not-found-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-get-table-versions-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "TableVersions") (clojure.core/assoc :table-versions (deser-get-table-versions-list (input "TableVersions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-scheduler-running-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-glue-encryption-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-message-string (input "Message")))))

(clojure.core/defn- deser-get-connections-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ConnectionList") (clojure.core/assoc :connection-list (deser-connection-list (input "ConnectionList"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-token (input "NextToken")))))

(clojure.core/defn- deser-start-crawler-schedule-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-stop-crawler-schedule-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-partition-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-start-crawler-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-batch-stop-job-run-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "SuccessfulSubmissions") (clojure.core/assoc :successful-submissions (deser-batch-stop-job-run-successful-submission-list (input "SuccessfulSubmissions"))) (clojure.core/contains? input "Errors") (clojure.core/assoc :errors (deser-batch-stop-job-run-error-list (input "Errors")))))

(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/message-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/parameters-map-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512000))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/code-gen-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[A-Za-z_][A-Za-z0-9_]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/location-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2056)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/format-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/view-text-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 409600))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/.*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/predicate-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:aws:kms:.*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/crawler-security-configuration (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/version-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/value-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/comment-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/key-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/filter-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/catalog-id-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/description-string-removable (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/table-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/id-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/log-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\.\-_/#A-Za-z0-9]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/log-stream (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[^:*]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/custom-patterns (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 16000)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/table-type-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1024)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/column-type-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 131072)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue.-2017-03-31/grok-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2048)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\t]*" s__27881__auto__))))
...
(clojure.core/defn get-user-defined-function ([get-user-defined-function-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-user-defined-function-request get-user-defined-function-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-user-defined-function-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-user-defined-function-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetUserDefinedFunction", :http.request.configuration/output-deser-fn deser-get-user-defined-function-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-connections ([] (get-connections {})) ([get-connections-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-connections-request get-connections-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-connections-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-connections-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetConnections", :http.request.configuration/output-deser-fn deser-get-connections-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-triggers ([] (get-triggers {})) ([get-triggers-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-triggers-request get-triggers-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-triggers-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-triggers-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetTriggers", :http.request.configuration/output-deser-fn deser-get-triggers-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn update-table ([update-table-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-table-request update-table-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-table-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-table-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateTable", :http.request.configuration/output-deser-fn deser-update-table-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "ConcurrentModificationException" :portkey.aws.glue.-2017-03-31/concurrent-modification-exception, "ResourceNumberLimitExceededException" :portkey.aws.glue.-2017-03-31/resource-number-limit-exceeded-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn update-partition ([update-partition-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-partition-request update-partition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-partition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-partition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdatePartition", :http.request.configuration/output-deser-fn deser-update-partition-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-tables ([get-tables-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-tables-request get-tables-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-tables-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-tables-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetTables", :http.request.configuration/output-deser-fn deser-get-tables-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn update-user-defined-function ([update-user-defined-function-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-user-defined-function-request update-user-defined-function-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-user-defined-function-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-user-defined-function-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateUserDefinedFunction", :http.request.configuration/output-deser-fn deser-update-user-defined-function-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn update-connection ([update-connection-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-connection-request update-connection-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-connection-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-connection-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateConnection", :http.request.configuration/output-deser-fn deser-update-connection-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn batch-get-partition ([batch-get-partition-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-batch-get-partition-request batch-get-partition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/batch-get-partition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/batch-get-partition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "BatchGetPartition", :http.request.configuration/output-deser-fn deser-batch-get-partition-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn delete-dev-endpoint ([delete-dev-endpoint-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-dev-endpoint-request delete-dev-endpoint-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/delete-dev-endpoint-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/delete-dev-endpoint-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteDevEndpoint", :http.request.configuration/output-deser-fn deser-delete-dev-endpoint-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception}})))))
...
(clojure.core/defn create-dev-endpoint ([create-dev-endpoint-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-dev-endpoint-request create-dev-endpoint-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/create-dev-endpoint-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/create-dev-endpoint-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateDevEndpoint", :http.request.configuration/output-deser-fn deser-create-dev-endpoint-response, :http.request.spec/error-spec {"AccessDeniedException" :portkey.aws.glue.-2017-03-31/access-denied-exception, "AlreadyExistsException" :portkey.aws.glue.-2017-03-31/already-exists-exception, "IdempotentParameterMismatchException" :portkey.aws.glue.-2017-03-31/idempotent-parameter-mismatch-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "ValidationException" :portkey.aws.glue.-2017-03-31/validation-exception, "ResourceNumberLimitExceededException" :portkey.aws.glue.-2017-03-31/resource-number-limit-exceeded-exception}})))))
...
(clojure.core/defn get-dev-endpoint ([get-dev-endpoint-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-dev-endpoint-request get-dev-endpoint-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-dev-endpoint-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-dev-endpoint-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDevEndpoint", :http.request.configuration/output-deser-fn deser-get-dev-endpoint-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception}})))))
...
(clojure.core/defn update-dev-endpoint ([update-dev-endpoint-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-dev-endpoint-request update-dev-endpoint-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-dev-endpoint-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-dev-endpoint-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDevEndpoint", :http.request.configuration/output-deser-fn deser-update-dev-endpoint-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "ValidationException" :portkey.aws.glue.-2017-03-31/validation-exception}})))))
...
(clojure.core/defn update-crawler-schedule ([update-crawler-schedule-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-crawler-schedule-request update-crawler-schedule-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-crawler-schedule-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-crawler-schedule-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateCrawlerSchedule", :http.request.configuration/output-deser-fn deser-update-crawler-schedule-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "VersionMismatchException" :portkey.aws.glue.-2017-03-31/version-mismatch-exception, "SchedulerTransitioningException" :portkey.aws.glue.-2017-03-31/scheduler-transitioning-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-job-runs ([get-job-runs-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-job-runs-request get-job-runs-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-job-runs-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-job-runs-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetJobRuns", :http.request.configuration/output-deser-fn deser-get-job-runs-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-partition ([get-partition-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-partition-request get-partition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-partition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-partition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetPartition", :http.request.configuration/output-deser-fn deser-get-partition-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-database ([get-database-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-database-request get-database-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-database-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-database-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDatabase", :http.request.configuration/output-deser-fn deser-get-database-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-dev-endpoints ([] (get-dev-endpoints {})) ([get-dev-endpoints-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-dev-endpoints-request get-dev-endpoints-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-dev-endpoints-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-dev-endpoints-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDevEndpoints", :http.request.configuration/output-deser-fn deser-get-dev-endpoints-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception}})))))
...
(clojure.core/defn get-table ([get-table-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-table-request get-table-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-table-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-table-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetTable", :http.request.configuration/output-deser-fn deser-get-table-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn create-crawler ([create-crawler-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-crawler-request create-crawler-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/create-crawler-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/create-crawler-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateCrawler", :http.request.configuration/output-deser-fn deser-create-crawler-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "AlreadyExistsException" :portkey.aws.glue.-2017-03-31/already-exists-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "ResourceNumberLimitExceededException" :portkey.aws.glue.-2017-03-31/resource-number-limit-exceeded-exception}})))))
...
(clojure.core/defn batch-delete-table ([batch-delete-table-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-batch-delete-table-request batch-delete-table-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/batch-delete-table-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/batch-delete-table-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "BatchDeleteTable", :http.request.configuration/output-deser-fn deser-batch-delete-table-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-user-defined-functions ([get-user-defined-functions-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-user-defined-functions-request get-user-defined-functions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-user-defined-functions-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-user-defined-functions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetUserDefinedFunctions", :http.request.configuration/output-deser-fn deser-get-user-defined-functions-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn get-partitions ([get-partitions-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-partitions-request get-partitions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-partitions-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-partitions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetPartitions", :http.request.configuration/output-deser-fn deser-get-partitions-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn delete-database ([delete-database-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-database-request delete-database-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/delete-database-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/delete-database-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteDatabase", :http.request.configuration/output-deser-fn deser-delete-database-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-job-run ([get-job-run-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-job-run-request get-job-run-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-job-run-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-job-run-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetJobRun", :http.request.configuration/output-deser-fn deser-get-job-run-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn create-user-defined-function ([create-user-defined-function-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-create-user-defined-function-request create-user-defined-function-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/create-user-defined-function-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/create-user-defined-function-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateUserDefinedFunction", :http.request.configuration/output-deser-fn deser-create-user-defined-function-response, :http.request.spec/error-spec {"AlreadyExistsException" :portkey.aws.glue.-2017-03-31/already-exists-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "ResourceNumberLimitExceededException" :portkey.aws.glue.-2017-03-31/resource-number-limit-exceeded-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn delete-user-defined-function ([delete-user-defined-function-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-user-defined-function-request delete-user-defined-function-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/delete-user-defined-function-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/delete-user-defined-function-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteUserDefinedFunction", :http.request.configuration/output-deser-fn deser-delete-user-defined-function-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-security-configurations ([] (get-security-configurations {})) ([get-security-configurations-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-security-configurations-request get-security-configurations-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-security-configurations-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-security-configurations-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetSecurityConfigurations", :http.request.configuration/output-deser-fn deser-get-security-configurations-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn update-database ([update-database-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-database-request update-database-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-database-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-database-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDatabase", :http.request.configuration/output-deser-fn deser-update-database-response, :http.request.spec/error-spec {"EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
...
(clojure.core/defn update-classifier ([] (update-classifier {})) ([update-classifier-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-classifier-request update-classifier-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/update-classifier-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/update-classifier-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateClassifier", :http.request.configuration/output-deser-fn deser-update-classifier-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "VersionMismatchException" :portkey.aws.glue.-2017-03-31/version-mismatch-exception, "EntityNotFoundException" :portkey.aws.glue.-2017-03-31/entity-not-found-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception}})))))
...
(clojure.core/defn get-databases ([] (get-databases {})) ([get-databases-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-get-databases-request get-databases-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.glue.-2017-03-31/endpoints, :http.request.configuration/target-prefix "AWSGlue", :http.request.spec/output-spec :portkey.aws.glue.-2017-03-31/get-databases-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-03-31", :http.request.configuration/service-id "Glue", :http.request.spec/input-spec :portkey.aws.glue.-2017-03-31/get-databases-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDatabases", :http.request.configuration/output-deser-fn deser-get-databases-response, :http.request.spec/error-spec {"InvalidInputException" :portkey.aws.glue.-2017-03-31/invalid-input-exception, "InternalServiceException" :portkey.aws.glue.-2017-03-31/internal-service-exception, "OperationTimeoutException" :portkey.aws.glue.-2017-03-31/operation-timeout-exception, "GlueEncryptionException" :portkey.aws.glue.-2017-03-31/glue-encryption-exception}})))))
