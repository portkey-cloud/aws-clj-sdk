...
(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper1635288 input] (clojure.core/let [rawinput1635287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635289 {"resourceTags" (rawinput1635287 "resourceTags")}] (clojure.core/cond-> {} (letvar1635289 "resourceTags") (clojure.core/assoc :resource-tags (deser-resource-tag-list (clojure.core/get-in letvar1635289 ["resourceTags"])))))))

(clojure.core/defn- response-direct-connect-server-exception ([input] (response-direct-connect-server-exception nil input)) ([resultWrapper1635291 input] (clojure.core/let [rawinput1635290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635292 {"message" (rawinput1635290 "message")}] (clojure.core/cond-> {} (letvar1635292 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1635292 ["message"])))))))

(clojure.core/defn- response-describe-direct-connect-gateway-attachments-result ([input] (response-describe-direct-connect-gateway-attachments-result nil input)) ([resultWrapper1635294 input] (clojure.core/let [rawinput1635293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635295 {"directConnectGatewayAttachments" (rawinput1635293 "directConnectGatewayAttachments"), "nextToken" (rawinput1635293 "nextToken")}] (clojure.core/cond-> {} (letvar1635295 "directConnectGatewayAttachments") (clojure.core/assoc :direct-connect-gateway-attachments (deser-direct-connect-gateway-attachment-list (clojure.core/get-in letvar1635295 ["directConnectGatewayAttachments"]))) (letvar1635295 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1635295 ["nextToken"])))))))

(clojure.core/defn- response-confirm-connection-response ([input] (response-confirm-connection-response nil input)) ([resultWrapper1635297 input] (clojure.core/let [rawinput1635296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635298 {"connectionState" (rawinput1635296 "connectionState")}] (clojure.core/cond-> {} (letvar1635298 "connectionState") (clojure.core/assoc :connection-state (deser-connection-state (clojure.core/get-in letvar1635298 ["connectionState"])))))))

(clojure.core/defn- response-describe-connection-loa-response ([input] (response-describe-connection-loa-response nil input)) ([resultWrapper1635300 input] (clojure.core/let [rawinput1635299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635301 {"loa" (rawinput1635299 "loa")}] (clojure.core/cond-> {} (letvar1635301 "loa") (clojure.core/assoc :loa (deser-loa (clojure.core/get-in letvar1635301 ["loa"])))))))

(clojure.core/defn- response-confirm-public-virtual-interface-response ([input] (response-confirm-public-virtual-interface-response nil input)) ([resultWrapper1635303 input] (clojure.core/let [rawinput1635302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635304 {"virtualInterfaceState" (rawinput1635302 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1635304 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1635304 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-describe-direct-connect-gateways-result ([input] (response-describe-direct-connect-gateways-result nil input)) ([resultWrapper1635306 input] (clojure.core/let [rawinput1635305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635307 {"directConnectGateways" (rawinput1635305 "directConnectGateways"), "nextToken" (rawinput1635305 "nextToken")}] (clojure.core/cond-> {} (letvar1635307 "directConnectGateways") (clojure.core/assoc :direct-connect-gateways (deser-direct-connect-gateway-list (clojure.core/get-in letvar1635307 ["directConnectGateways"]))) (letvar1635307 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1635307 ["nextToken"])))))))

(clojure.core/defn- response-interconnect ([input] (response-interconnect nil input)) ([resultWrapper1635309 input] (clojure.core/let [rawinput1635308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635310 {"jumboFrameCapable" (rawinput1635308 "jumboFrameCapable"), "awsDeviceV2" (rawinput1635308 "awsDeviceV2"), "awsDevice" (rawinput1635308 "awsDevice"), "interconnectName" (rawinput1635308 "interconnectName"), "bandwidth" (rawinput1635308 "bandwidth"), "interconnectState" (rawinput1635308 "interconnectState"), "lagId" (rawinput1635308 "lagId"), "location" (rawinput1635308 "location"), "region" (rawinput1635308 "region"), "loaIssueTime" (rawinput1635308 "loaIssueTime"), "hasLogicalRedundancy" (rawinput1635308 "hasLogicalRedundancy"), "interconnectId" (rawinput1635308 "interconnectId")}] (clojure.core/cond-> {} (letvar1635310 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1635310 ["jumboFrameCapable"]))) (letvar1635310 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1635310 ["awsDeviceV2"]))) (letvar1635310 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1635310 ["awsDevice"]))) (letvar1635310 "interconnectName") (clojure.core/assoc :interconnect-name (deser-interconnect-name (clojure.core/get-in letvar1635310 ["interconnectName"]))) (letvar1635310 "bandwidth") (clojure.core/assoc :bandwidth (deser-bandwidth (clojure.core/get-in letvar1635310 ["bandwidth"]))) (letvar1635310 "interconnectState") (clojure.core/assoc :interconnect-state (deser-interconnect-state (clojure.core/get-in letvar1635310 ["interconnectState"]))) (letvar1635310 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1635310 ["lagId"]))) (letvar1635310 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1635310 ["location"]))) (letvar1635310 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1635310 ["region"]))) (letvar1635310 "loaIssueTime") (clojure.core/assoc :loa-issue-time (deser-loa-issue-time (clojure.core/get-in letvar1635310 ["loaIssueTime"]))) (letvar1635310 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1635310 ["hasLogicalRedundancy"]))) (letvar1635310 "interconnectId") (clojure.core/assoc :interconnect-id (deser-interconnect-id (clojure.core/get-in letvar1635310 ["interconnectId"])))))))

(clojure.core/defn- response-virtual-interfaces ([input] (response-virtual-interfaces nil input)) ([resultWrapper1635312 input] (clojure.core/let [rawinput1635311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635313 {"virtualInterfaces" (rawinput1635311 "virtualInterfaces")}] (clojure.core/cond-> {} (letvar1635313 "virtualInterfaces") (clojure.core/assoc :virtual-interfaces (deser-virtual-interface-list (clojure.core/get-in letvar1635313 ["virtualInterfaces"])))))))

(clojure.core/defn- response-create-direct-connect-gateway-result ([input] (response-create-direct-connect-gateway-result nil input)) ([resultWrapper1635315 input] (clojure.core/let [rawinput1635314 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635316 {"directConnectGateway" (rawinput1635314 "directConnectGateway")}] (clojure.core/cond-> {} (letvar1635316 "directConnectGateway") (clojure.core/assoc :direct-connect-gateway (deser-direct-connect-gateway (clojure.core/get-in letvar1635316 ["directConnectGateway"])))))))

(clojure.core/defn- response-create-bgp-peer-response ([input] (response-create-bgp-peer-response nil input)) ([resultWrapper1635318 input] (clojure.core/let [rawinput1635317 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635319 {"virtualInterface" (rawinput1635317 "virtualInterface")}] (clojure.core/cond-> {} (letvar1635319 "virtualInterface") (clojure.core/assoc :virtual-interface (deser-virtual-interface (clojure.core/get-in letvar1635319 ["virtualInterface"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1635321 input] (clojure.core/let [rawinput1635320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635322 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-bgp-peer-response ([input] (response-delete-bgp-peer-response nil input)) ([resultWrapper1635324 input] (clojure.core/let [rawinput1635323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635325 {"virtualInterface" (rawinput1635323 "virtualInterface")}] (clojure.core/cond-> {} (letvar1635325 "virtualInterface") (clojure.core/assoc :virtual-interface (deser-virtual-interface (clojure.core/get-in letvar1635325 ["virtualInterface"])))))))

(clojure.core/defn- response-connections ([input] (response-connections nil input)) ([resultWrapper1635327 input] (clojure.core/let [rawinput1635326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635328 {"connections" (rawinput1635326 "connections")}] (clojure.core/cond-> {} (letvar1635328 "connections") (clojure.core/assoc :connections (deser-connection-list (clojure.core/get-in letvar1635328 ["connections"])))))))

(clojure.core/defn- response-duplicate-tag-keys-exception ([input] (response-duplicate-tag-keys-exception nil input)) ([resultWrapper1635330 input] (clojure.core/let [rawinput1635329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635331 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-locations ([input] (response-locations nil input)) ([resultWrapper1635333 input] (clojure.core/let [rawinput1635332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635334 {"locations" (rawinput1635332 "locations")}] (clojure.core/cond-> {} (letvar1635334 "locations") (clojure.core/assoc :locations (deser-location-list (clojure.core/get-in letvar1635334 ["locations"])))))))

(clojure.core/defn- response-lag ([input] (response-lag nil input)) ([resultWrapper1635336 input] (clojure.core/let [rawinput1635335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635337 {"allowsHostedConnections" (rawinput1635335 "allowsHostedConnections"), "numberOfConnections" (rawinput1635335 "numberOfConnections"), "jumboFrameCapable" (rawinput1635335 "jumboFrameCapable"), "awsDeviceV2" (rawinput1635335 "awsDeviceV2"), "awsDevice" (rawinput1635335 "awsDevice"), "minimumLinks" (rawinput1635335 "minimumLinks"), "ownerAccount" (rawinput1635335 "ownerAccount"), "lagName" (rawinput1635335 "lagName"), "connectionsBandwidth" (rawinput1635335 "connectionsBandwidth"), "lagId" (rawinput1635335 "lagId"), "location" (rawinput1635335 "location"), "region" (rawinput1635335 "region"), "lagState" (rawinput1635335 "lagState"), "hasLogicalRedundancy" (rawinput1635335 "hasLogicalRedundancy"), "connections" (rawinput1635335 "connections")}] (clojure.core/cond-> {} (letvar1635337 "allowsHostedConnections") (clojure.core/assoc :allows-hosted-connections (deser-boolean-flag (clojure.core/get-in letvar1635337 ["allowsHostedConnections"]))) (letvar1635337 "numberOfConnections") (clojure.core/assoc :number-of-connections (deser-count (clojure.core/get-in letvar1635337 ["numberOfConnections"]))) (letvar1635337 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1635337 ["jumboFrameCapable"]))) (letvar1635337 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1635337 ["awsDeviceV2"]))) (letvar1635337 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1635337 ["awsDevice"]))) (letvar1635337 "minimumLinks") (clojure.core/assoc :minimum-links (deser-count (clojure.core/get-in letvar1635337 ["minimumLinks"]))) (letvar1635337 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1635337 ["ownerAccount"]))) (letvar1635337 "lagName") (clojure.core/assoc :lag-name (deser-lag-name (clojure.core/get-in letvar1635337 ["lagName"]))) (letvar1635337 "connectionsBandwidth") (clojure.core/assoc :connections-bandwidth (deser-bandwidth (clojure.core/get-in letvar1635337 ["connectionsBandwidth"]))) (letvar1635337 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1635337 ["lagId"]))) (letvar1635337 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1635337 ["location"]))) (letvar1635337 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1635337 ["region"]))) (letvar1635337 "lagState") (clojure.core/assoc :lag-state (deser-lag-state (clojure.core/get-in letvar1635337 ["lagState"]))) (letvar1635337 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1635337 ["hasLogicalRedundancy"]))) (letvar1635337 "connections") (clojure.core/assoc :connections (deser-connection-list (clojure.core/get-in letvar1635337 ["connections"])))))))

(clojure.core/defn- response-delete-interconnect-response ([input] (response-delete-interconnect-response nil input)) ([resultWrapper1635339 input] (clojure.core/let [rawinput1635338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635340 {"interconnectState" (rawinput1635338 "interconnectState")}] (clojure.core/cond-> {} (letvar1635340 "interconnectState") (clojure.core/assoc :interconnect-state (deser-interconnect-state (clojure.core/get-in letvar1635340 ["interconnectState"])))))))

(clojure.core/defn- response-create-direct-connect-gateway-association-result ([input] (response-create-direct-connect-gateway-association-result nil input)) ([resultWrapper1635342 input] (clojure.core/let [rawinput1635341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635343 {"directConnectGatewayAssociation" (rawinput1635341 "directConnectGatewayAssociation")}] (clojure.core/cond-> {} (letvar1635343 "directConnectGatewayAssociation") (clojure.core/assoc :direct-connect-gateway-association (deser-direct-connect-gateway-association (clojure.core/get-in letvar1635343 ["directConnectGatewayAssociation"])))))))

(clojure.core/defn- response-describe-interconnect-loa-response ([input] (response-describe-interconnect-loa-response nil input)) ([resultWrapper1635345 input] (clojure.core/let [rawinput1635344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635346 {"loa" (rawinput1635344 "loa")}] (clojure.core/cond-> {} (letvar1635346 "loa") (clojure.core/assoc :loa (deser-loa (clojure.core/get-in letvar1635346 ["loa"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper1635348 input] (clojure.core/let [rawinput1635347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635349 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-direct-connect-client-exception ([input] (response-direct-connect-client-exception nil input)) ([resultWrapper1635351 input] (clojure.core/let [rawinput1635350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635352 {"message" (rawinput1635350 "message")}] (clojure.core/cond-> {} (letvar1635352 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1635352 ["message"])))))))

(clojure.core/defn- response-loa ([input] (response-loa nil input)) ([resultWrapper1635354 input] (clojure.core/let [rawinput1635353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635355 {"loaContent" (rawinput1635353 "loaContent"), "loaContentType" (rawinput1635353 "loaContentType")}] (clojure.core/cond-> {} (letvar1635355 "loaContent") (clojure.core/assoc :loa-content (deser-loa-content (clojure.core/get-in letvar1635355 ["loaContent"]))) (letvar1635355 "loaContentType") (clojure.core/assoc :loa-content-type (deser-loa-content-type (clojure.core/get-in letvar1635355 ["loaContentType"])))))))

(clojure.core/defn- response-connection ([input] (response-connection nil input)) ([resultWrapper1635357 input] (clojure.core/let [rawinput1635356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635358 {"partnerName" (rawinput1635356 "partnerName"), "jumboFrameCapable" (rawinput1635356 "jumboFrameCapable"), "connectionName" (rawinput1635356 "connectionName"), "awsDeviceV2" (rawinput1635356 "awsDeviceV2"), "awsDevice" (rawinput1635356 "awsDevice"), "connectionId" (rawinput1635356 "connectionId"), "connectionState" (rawinput1635356 "connectionState"), "bandwidth" (rawinput1635356 "bandwidth"), "ownerAccount" (rawinput1635356 "ownerAccount"), "lagId" (rawinput1635356 "lagId"), "location" (rawinput1635356 "location"), "region" (rawinput1635356 "region"), "loaIssueTime" (rawinput1635356 "loaIssueTime"), "hasLogicalRedundancy" (rawinput1635356 "hasLogicalRedundancy"), "vlan" (rawinput1635356 "vlan")}] (clojure.core/cond-> {} (letvar1635358 "partnerName") (clojure.core/assoc :partner-name (deser-partner-name (clojure.core/get-in letvar1635358 ["partnerName"]))) (letvar1635358 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1635358 ["jumboFrameCapable"]))) (letvar1635358 "connectionName") (clojure.core/assoc :connection-name (deser-connection-name (clojure.core/get-in letvar1635358 ["connectionName"]))) (letvar1635358 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1635358 ["awsDeviceV2"]))) (letvar1635358 "awsDevice") (clojure.core/assoc :aws-device (deser-aws-device (clojure.core/get-in letvar1635358 ["awsDevice"]))) (letvar1635358 "connectionId") (clojure.core/assoc :connection-id (deser-connection-id (clojure.core/get-in letvar1635358 ["connectionId"]))) (letvar1635358 "connectionState") (clojure.core/assoc :connection-state (deser-connection-state (clojure.core/get-in letvar1635358 ["connectionState"]))) (letvar1635358 "bandwidth") (clojure.core/assoc :bandwidth (deser-bandwidth (clojure.core/get-in letvar1635358 ["bandwidth"]))) (letvar1635358 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1635358 ["ownerAccount"]))) (letvar1635358 "lagId") (clojure.core/assoc :lag-id (deser-lag-id (clojure.core/get-in letvar1635358 ["lagId"]))) (letvar1635358 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1635358 ["location"]))) (letvar1635358 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1635358 ["region"]))) (letvar1635358 "loaIssueTime") (clojure.core/assoc :loa-issue-time (deser-loa-issue-time (clojure.core/get-in letvar1635358 ["loaIssueTime"]))) (letvar1635358 "hasLogicalRedundancy") (clojure.core/assoc :has-logical-redundancy (deser-has-logical-redundancy (clojure.core/get-in letvar1635358 ["hasLogicalRedundancy"]))) (letvar1635358 "vlan") (clojure.core/assoc :vlan (deser-vlan (clojure.core/get-in letvar1635358 ["vlan"])))))))

(clojure.core/defn- response-delete-direct-connect-gateway-result ([input] (response-delete-direct-connect-gateway-result nil input)) ([resultWrapper1635360 input] (clojure.core/let [rawinput1635359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635361 {"directConnectGateway" (rawinput1635359 "directConnectGateway")}] (clojure.core/cond-> {} (letvar1635361 "directConnectGateway") (clojure.core/assoc :direct-connect-gateway (deser-direct-connect-gateway (clojure.core/get-in letvar1635361 ["directConnectGateway"])))))))

(clojure.core/defn- response-interconnects ([input] (response-interconnects nil input)) ([resultWrapper1635363 input] (clojure.core/let [rawinput1635362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635364 {"interconnects" (rawinput1635362 "interconnects")}] (clojure.core/cond-> {} (letvar1635364 "interconnects") (clojure.core/assoc :interconnects (deser-interconnect-list (clojure.core/get-in letvar1635364 ["interconnects"])))))))

(clojure.core/defn- response-confirm-private-virtual-interface-response ([input] (response-confirm-private-virtual-interface-response nil input)) ([resultWrapper1635366 input] (clojure.core/let [rawinput1635365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635367 {"virtualInterfaceState" (rawinput1635365 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1635367 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1635367 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-virtual-gateways ([input] (response-virtual-gateways nil input)) ([resultWrapper1635369 input] (clojure.core/let [rawinput1635368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635370 {"virtualGateways" (rawinput1635368 "virtualGateways")}] (clojure.core/cond-> {} (letvar1635370 "virtualGateways") (clojure.core/assoc :virtual-gateways (deser-virtual-gateway-list (clojure.core/get-in letvar1635370 ["virtualGateways"])))))))

(clojure.core/defn- response-delete-virtual-interface-response ([input] (response-delete-virtual-interface-response nil input)) ([resultWrapper1635372 input] (clojure.core/let [rawinput1635371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635373 {"virtualInterfaceState" (rawinput1635371 "virtualInterfaceState")}] (clojure.core/cond-> {} (letvar1635373 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1635373 ["virtualInterfaceState"])))))))

(clojure.core/defn- response-virtual-interface ([input] (response-virtual-interface nil input)) ([resultWrapper1635375 input] (clojure.core/let [rawinput1635374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635376 {"virtualInterfaceId" (rawinput1635374 "virtualInterfaceId"), "bgpPeers" (rawinput1635374 "bgpPeers"), "amazonSideAsn" (rawinput1635374 "amazonSideAsn"), "jumboFrameCapable" (rawinput1635374 "jumboFrameCapable"), "awsDeviceV2" (rawinput1635374 "awsDeviceV2"), "connectionId" (rawinput1635374 "connectionId"), "virtualInterfaceState" (rawinput1635374 "virtualInterfaceState"), "addressFamily" (rawinput1635374 "addressFamily"), "ownerAccount" (rawinput1635374 "ownerAccount"), "directConnectGatewayId" (rawinput1635374 "directConnectGatewayId"), "customerAddress" (rawinput1635374 "customerAddress"), "mtu" (rawinput1635374 "mtu"), "location" (rawinput1635374 "location"), "virtualInterfaceName" (rawinput1635374 "virtualInterfaceName"), "region" (rawinput1635374 "region"), "virtualGatewayId" (rawinput1635374 "virtualGatewayId"), "virtualInterfaceType" (rawinput1635374 "virtualInterfaceType"), "amazonAddress" (rawinput1635374 "amazonAddress"), "vlan" (rawinput1635374 "vlan"), "customerRouterConfig" (rawinput1635374 "customerRouterConfig"), "authKey" (rawinput1635374 "authKey"), "routeFilterPrefixes" (rawinput1635374 "routeFilterPrefixes"), "asn" (rawinput1635374 "asn")}] (clojure.core/cond-> {} (letvar1635376 "virtualInterfaceId") (clojure.core/assoc :virtual-interface-id (deser-virtual-interface-id (clojure.core/get-in letvar1635376 ["virtualInterfaceId"]))) (letvar1635376 "bgpPeers") (clojure.core/assoc :bgp-peers (deser-bgp-peer-list (clojure.core/get-in letvar1635376 ["bgpPeers"]))) (letvar1635376 "amazonSideAsn") (clojure.core/assoc :amazon-side-asn (deser-long-asn (clojure.core/get-in letvar1635376 ["amazonSideAsn"]))) (letvar1635376 "jumboFrameCapable") (clojure.core/assoc :jumbo-frame-capable (deser-jumbo-frame-capable (clojure.core/get-in letvar1635376 ["jumboFrameCapable"]))) (letvar1635376 "awsDeviceV2") (clojure.core/assoc :aws-device-v-2 (deser-aws-device-v-2 (clojure.core/get-in letvar1635376 ["awsDeviceV2"]))) (letvar1635376 "connectionId") (clojure.core/assoc :connection-id (deser-connection-id (clojure.core/get-in letvar1635376 ["connectionId"]))) (letvar1635376 "virtualInterfaceState") (clojure.core/assoc :virtual-interface-state (deser-virtual-interface-state (clojure.core/get-in letvar1635376 ["virtualInterfaceState"]))) (letvar1635376 "addressFamily") (clojure.core/assoc :address-family (deser-address-family (clojure.core/get-in letvar1635376 ["addressFamily"]))) (letvar1635376 "ownerAccount") (clojure.core/assoc :owner-account (deser-owner-account (clojure.core/get-in letvar1635376 ["ownerAccount"]))) (letvar1635376 "directConnectGatewayId") (clojure.core/assoc :direct-connect-gateway-id (deser-direct-connect-gateway-id (clojure.core/get-in letvar1635376 ["directConnectGatewayId"]))) (letvar1635376 "customerAddress") (clojure.core/assoc :customer-address (deser-customer-address (clojure.core/get-in letvar1635376 ["customerAddress"]))) (letvar1635376 "mtu") (clojure.core/assoc :mtu (deser-mtu (clojure.core/get-in letvar1635376 ["mtu"]))) (letvar1635376 "location") (clojure.core/assoc :location (deser-location-code (clojure.core/get-in letvar1635376 ["location"]))) (letvar1635376 "virtualInterfaceName") (clojure.core/assoc :virtual-interface-name (deser-virtual-interface-name (clojure.core/get-in letvar1635376 ["virtualInterfaceName"]))) (letvar1635376 "region") (clojure.core/assoc :region (deser-region (clojure.core/get-in letvar1635376 ["region"]))) (letvar1635376 "virtualGatewayId") (clojure.core/assoc :virtual-gateway-id (deser-virtual-gateway-id (clojure.core/get-in letvar1635376 ["virtualGatewayId"]))) (letvar1635376 "virtualInterfaceType") (clojure.core/assoc :virtual-interface-type (deser-virtual-interface-type (clojure.core/get-in letvar1635376 ["virtualInterfaceType"]))) (letvar1635376 "amazonAddress") (clojure.core/assoc :amazon-address (deser-amazon-address (clojure.core/get-in letvar1635376 ["amazonAddress"]))) (letvar1635376 "vlan") (clojure.core/assoc :vlan (deser-vlan (clojure.core/get-in letvar1635376 ["vlan"]))) (letvar1635376 "customerRouterConfig") (clojure.core/assoc :customer-router-config (deser-router-config (clojure.core/get-in letvar1635376 ["customerRouterConfig"]))) (letvar1635376 "authKey") (clojure.core/assoc :auth-key (deser-bgp-auth-key (clojure.core/get-in letvar1635376 ["authKey"]))) (letvar1635376 "routeFilterPrefixes") (clojure.core/assoc :route-filter-prefixes (deser-route-filter-prefix-list (clojure.core/get-in letvar1635376 ["routeFilterPrefixes"]))) (letvar1635376 "asn") (clojure.core/assoc :asn (deser-asn (clojure.core/get-in letvar1635376 ["asn"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1635378 input] (clojure.core/let [rawinput1635377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635379 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-direct-connect-gateway-associations-result ([input] (response-describe-direct-connect-gateway-associations-result nil input)) ([resultWrapper1635381 input] (clojure.core/let [rawinput1635380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635382 {"directConnectGatewayAssociations" (rawinput1635380 "directConnectGatewayAssociations"), "nextToken" (rawinput1635380 "nextToken")}] (clojure.core/cond-> {} (letvar1635382 "directConnectGatewayAssociations") (clojure.core/assoc :direct-connect-gateway-associations (deser-direct-connect-gateway-association-list (clojure.core/get-in letvar1635382 ["directConnectGatewayAssociations"]))) (letvar1635382 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1635382 ["nextToken"])))))))

(clojure.core/defn- response-delete-direct-connect-gateway-association-result ([input] (response-delete-direct-connect-gateway-association-result nil input)) ([resultWrapper1635384 input] (clojure.core/let [rawinput1635383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635385 {"directConnectGatewayAssociation" (rawinput1635383 "directConnectGatewayAssociation")}] (clojure.core/cond-> {} (letvar1635385 "directConnectGatewayAssociation") (clojure.core/assoc :direct-connect-gateway-association (deser-direct-connect-gateway-association (clojure.core/get-in letvar1635385 ["directConnectGatewayAssociation"])))))))

(clojure.core/defn- response-lags ([input] (response-lags nil input)) ([resultWrapper1635387 input] (clojure.core/let [rawinput1635386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1635388 {"lags" (rawinput1635386 "lags")}] (clojure.core/cond-> {} (letvar1635388 "lags") (clojure.core/assoc :lags (deser-lag-list (clojure.core/get-in letvar1635388 ["lags"])))))))
...
(clojure.spec.alpha/def :portkey.aws.directconnect.-2012-10-25/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.directconnect.-2012-10-25/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
