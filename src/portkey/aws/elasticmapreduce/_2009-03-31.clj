...
(clojure.core/defn- response-add-job-flow-steps-output ([input] (response-add-job-flow-steps-output nil input)) ([resultWrapper1729937 input] (clojure.core/let [rawinput1729936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729938 {"StepIds" (rawinput1729936 "StepIds")}] (clojure.core/cond-> {} (letvar1729938 "StepIds") (clojure.core/assoc :step-ids (deser-step-ids-list (clojure.core/get-in letvar1729938 ["StepIds"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1729940 input] (clojure.core/let [rawinput1729939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729941 {"ErrorCode" (rawinput1729939 "ErrorCode"), "Message" (rawinput1729939 "Message")}] (clojure.core/cond-> {} (letvar1729941 "ErrorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1729941 ["ErrorCode"]))) (letvar1729941 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1729941 ["Message"])))))))

(clojure.core/defn- response-describe-security-configuration-output ([input] (response-describe-security-configuration-output nil input)) ([resultWrapper1729943 input] (clojure.core/let [rawinput1729942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729944 {"Name" (rawinput1729942 "Name"), "SecurityConfiguration" (rawinput1729942 "SecurityConfiguration"), "CreationDateTime" (rawinput1729942 "CreationDateTime")}] (clojure.core/cond-> {} (letvar1729944 "Name") (clojure.core/assoc :name (deser-xml-string (clojure.core/get-in letvar1729944 ["Name"]))) (letvar1729944 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-string (clojure.core/get-in letvar1729944 ["SecurityConfiguration"]))) (letvar1729944 "CreationDateTime") (clojure.core/assoc :creation-date-time (deser-date (clojure.core/get-in letvar1729944 ["CreationDateTime"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1729946 input] (clojure.core/let [rawinput1729945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729947 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-security-configurations-output ([input] (response-list-security-configurations-output nil input)) ([resultWrapper1729949 input] (clojure.core/let [rawinput1729948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729950 {"SecurityConfigurations" (rawinput1729948 "SecurityConfigurations"), "Marker" (rawinput1729948 "Marker")}] (clojure.core/cond-> {} (letvar1729950 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar1729950 ["SecurityConfigurations"]))) (letvar1729950 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729950 ["Marker"])))))))

(clojure.core/defn- response-create-security-configuration-output ([input] (response-create-security-configuration-output nil input)) ([resultWrapper1729952 input] (clojure.core/let [rawinput1729951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729953 {"Name" (rawinput1729951 "Name"), "CreationDateTime" (rawinput1729951 "CreationDateTime")}] (clojure.core/cond-> {:name (deser-xml-string (clojure.core/get-in letvar1729953 ["Name"])), :creation-date-time (deser-date (clojure.core/get-in letvar1729953 ["CreationDateTime"]))}))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1729955 input] (clojure.core/let [rawinput1729954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729956 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-bootstrap-actions-output ([input] (response-list-bootstrap-actions-output nil input)) ([resultWrapper1729958 input] (clojure.core/let [rawinput1729957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729959 {"BootstrapActions" (rawinput1729957 "BootstrapActions"), "Marker" (rawinput1729957 "Marker")}] (clojure.core/cond-> {} (letvar1729959 "BootstrapActions") (clojure.core/assoc :bootstrap-actions (deser-command-list (clojure.core/get-in letvar1729959 ["BootstrapActions"]))) (letvar1729959 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729959 ["Marker"])))))))

(clojure.core/defn- response-list-steps-output ([input] (response-list-steps-output nil input)) ([resultWrapper1729961 input] (clojure.core/let [rawinput1729960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729962 {"Steps" (rawinput1729960 "Steps"), "Marker" (rawinput1729960 "Marker")}] (clojure.core/cond-> {} (letvar1729962 "Steps") (clojure.core/assoc :steps (deser-step-summary-list (clojure.core/get-in letvar1729962 ["Steps"]))) (letvar1729962 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729962 ["Marker"])))))))

(clojure.core/defn- response-describe-step-output ([input] (response-describe-step-output nil input)) ([resultWrapper1729964 input] (clojure.core/let [rawinput1729963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729965 {"Step" (rawinput1729963 "Step")}] (clojure.core/cond-> {} (letvar1729965 "Step") (clojure.core/assoc :step (deser-step (clojure.core/get-in letvar1729965 ["Step"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1729967 input] (clojure.core/let [rawinput1729966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729968 {"Message" (rawinput1729966 "Message")}] (clojure.core/cond-> {} (letvar1729968 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1729968 ["Message"])))))))

(clojure.core/defn- response-run-job-flow-output ([input] (response-run-job-flow-output nil input)) ([resultWrapper1729970 input] (clojure.core/let [rawinput1729969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729971 {"JobFlowId" (rawinput1729969 "JobFlowId")}] (clojure.core/cond-> {} (letvar1729971 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1729971 ["JobFlowId"])))))))

(clojure.core/defn- response-list-instances-output ([input] (response-list-instances-output nil input)) ([resultWrapper1729973 input] (clojure.core/let [rawinput1729972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729974 {"Instances" (rawinput1729972 "Instances"), "Marker" (rawinput1729972 "Marker")}] (clojure.core/cond-> {} (letvar1729974 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar1729974 ["Instances"]))) (letvar1729974 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729974 ["Marker"])))))))

(clojure.core/defn- response-add-instance-fleet-output ([input] (response-add-instance-fleet-output nil input)) ([resultWrapper1729976 input] (clojure.core/let [rawinput1729975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729977 {"ClusterId" (rawinput1729975 "ClusterId"), "InstanceFleetId" (rawinput1729975 "InstanceFleetId")}] (clojure.core/cond-> {} (letvar1729977 "ClusterId") (clojure.core/assoc :cluster-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1729977 ["ClusterId"]))) (letvar1729977 "InstanceFleetId") (clojure.core/assoc :instance-fleet-id (deser-instance-fleet-id (clojure.core/get-in letvar1729977 ["InstanceFleetId"])))))))

(clojure.core/defn- response-delete-security-configuration-output ([input] (response-delete-security-configuration-output nil input)) ([resultWrapper1729979 input] (clojure.core/let [rawinput1729978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729980 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-instance-fleets-output ([input] (response-list-instance-fleets-output nil input)) ([resultWrapper1729982 input] (clojure.core/let [rawinput1729981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729983 {"InstanceFleets" (rawinput1729981 "InstanceFleets"), "Marker" (rawinput1729981 "Marker")}] (clojure.core/cond-> {} (letvar1729983 "InstanceFleets") (clojure.core/assoc :instance-fleets (deser-instance-fleet-list (clojure.core/get-in letvar1729983 ["InstanceFleets"]))) (letvar1729983 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729983 ["Marker"])))))))

(clojure.core/defn- response-list-instance-groups-output ([input] (response-list-instance-groups-output nil input)) ([resultWrapper1729985 input] (clojure.core/let [rawinput1729984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729986 {"InstanceGroups" (rawinput1729984 "InstanceGroups"), "Marker" (rawinput1729984 "Marker")}] (clojure.core/cond-> {} (letvar1729986 "InstanceGroups") (clojure.core/assoc :instance-groups (deser-instance-group-list (clojure.core/get-in letvar1729986 ["InstanceGroups"]))) (letvar1729986 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1729986 ["Marker"])))))))

(clojure.core/defn- response-add-instance-groups-output ([input] (response-add-instance-groups-output nil input)) ([resultWrapper1729988 input] (clojure.core/let [rawinput1729987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729989 {"JobFlowId" (rawinput1729987 "JobFlowId"), "InstanceGroupIds" (rawinput1729987 "InstanceGroupIds")}] (clojure.core/cond-> {} (letvar1729989 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1729989 ["JobFlowId"]))) (letvar1729989 "InstanceGroupIds") (clojure.core/assoc :instance-group-ids (deser-instance-group-ids-list (clojure.core/get-in letvar1729989 ["InstanceGroupIds"])))))))

(clojure.core/defn- response-cancel-steps-output ([input] (response-cancel-steps-output nil input)) ([resultWrapper1729991 input] (clojure.core/let [rawinput1729990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729992 {"CancelStepsInfoList" (rawinput1729990 "CancelStepsInfoList")}] (clojure.core/cond-> {} (letvar1729992 "CancelStepsInfoList") (clojure.core/assoc :cancel-steps-info-list (deser-cancel-steps-info-list (clojure.core/get-in letvar1729992 ["CancelStepsInfoList"])))))))

(clojure.core/defn- response-describe-cluster-output ([input] (response-describe-cluster-output nil input)) ([resultWrapper1729994 input] (clojure.core/let [rawinput1729993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729995 {"Cluster" (rawinput1729993 "Cluster")}] (clojure.core/cond-> {} (letvar1729995 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1729995 ["Cluster"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1729997 input] (clojure.core/let [rawinput1729996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1729998 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-clusters-output ([input] (response-list-clusters-output nil input)) ([resultWrapper1730000 input] (clojure.core/let [rawinput1729999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1730001 {"Clusters" (rawinput1729999 "Clusters"), "Marker" (rawinput1729999 "Marker")}] (clojure.core/cond-> {} (letvar1730001 "Clusters") (clojure.core/assoc :clusters (deser-cluster-summary-list (clojure.core/get-in letvar1730001 ["Clusters"]))) (letvar1730001 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1730001 ["Marker"])))))))

(clojure.core/defn- response-put-auto-scaling-policy-output ([input] (response-put-auto-scaling-policy-output nil input)) ([resultWrapper1730003 input] (clojure.core/let [rawinput1730002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1730004 {"ClusterId" (rawinput1730002 "ClusterId"), "InstanceGroupId" (rawinput1730002 "InstanceGroupId"), "AutoScalingPolicy" (rawinput1730002 "AutoScalingPolicy")}] (clojure.core/cond-> {} (letvar1730004 "ClusterId") (clojure.core/assoc :cluster-id (deser-cluster-id (clojure.core/get-in letvar1730004 ["ClusterId"]))) (letvar1730004 "InstanceGroupId") (clojure.core/assoc :instance-group-id (deser-instance-group-id (clojure.core/get-in letvar1730004 ["InstanceGroupId"]))) (letvar1730004 "AutoScalingPolicy") (clojure.core/assoc :auto-scaling-policy (deser-auto-scaling-policy-description (clojure.core/get-in letvar1730004 ["AutoScalingPolicy"])))))))

(clojure.core/defn- response-remove-auto-scaling-policy-output ([input] (response-remove-auto-scaling-policy-output nil input)) ([resultWrapper1730006 input] (clojure.core/let [rawinput1730005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1730007 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-flows-output ([input] (response-describe-job-flows-output nil input)) ([resultWrapper1730009 input] (clojure.core/let [rawinput1730008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1730010 {"JobFlows" (rawinput1730008 "JobFlows")}] (clojure.core/cond-> {} (letvar1730010 "JobFlows") (clojure.core/assoc :job-flows (deser-job-flow-detail-list (clojure.core/get-in letvar1730010 ["JobFlows"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10280)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
