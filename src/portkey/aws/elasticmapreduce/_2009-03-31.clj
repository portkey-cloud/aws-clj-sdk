...
(clojure.core/defn- response-add-job-flow-steps-output ([input] (response-add-job-flow-steps-output nil input)) ([resultWrapper1760895 input] (clojure.core/let [rawinput1760894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760896 {"StepIds" (rawinput1760894 "StepIds")}] (clojure.core/cond-> {} (letvar1760896 "StepIds") (clojure.core/assoc :step-ids (deser-step-ids-list (clojure.core/get-in letvar1760896 ["StepIds"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1760898 input] (clojure.core/let [rawinput1760897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760899 {"ErrorCode" (rawinput1760897 "ErrorCode"), "Message" (rawinput1760897 "Message")}] (clojure.core/cond-> {} (letvar1760899 "ErrorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1760899 ["ErrorCode"]))) (letvar1760899 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1760899 ["Message"])))))))

(clojure.core/defn- response-describe-security-configuration-output ([input] (response-describe-security-configuration-output nil input)) ([resultWrapper1760901 input] (clojure.core/let [rawinput1760900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760902 {"Name" (rawinput1760900 "Name"), "SecurityConfiguration" (rawinput1760900 "SecurityConfiguration"), "CreationDateTime" (rawinput1760900 "CreationDateTime")}] (clojure.core/cond-> {} (letvar1760902 "Name") (clojure.core/assoc :name (deser-xml-string (clojure.core/get-in letvar1760902 ["Name"]))) (letvar1760902 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-string (clojure.core/get-in letvar1760902 ["SecurityConfiguration"]))) (letvar1760902 "CreationDateTime") (clojure.core/assoc :creation-date-time (deser-date (clojure.core/get-in letvar1760902 ["CreationDateTime"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1760904 input] (clojure.core/let [rawinput1760903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760905 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-security-configurations-output ([input] (response-list-security-configurations-output nil input)) ([resultWrapper1760907 input] (clojure.core/let [rawinput1760906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760908 {"SecurityConfigurations" (rawinput1760906 "SecurityConfigurations"), "Marker" (rawinput1760906 "Marker")}] (clojure.core/cond-> {} (letvar1760908 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar1760908 ["SecurityConfigurations"]))) (letvar1760908 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760908 ["Marker"])))))))

(clojure.core/defn- response-create-security-configuration-output ([input] (response-create-security-configuration-output nil input)) ([resultWrapper1760910 input] (clojure.core/let [rawinput1760909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760911 {"Name" (rawinput1760909 "Name"), "CreationDateTime" (rawinput1760909 "CreationDateTime")}] (clojure.core/cond-> {:name (deser-xml-string (clojure.core/get-in letvar1760911 ["Name"])), :creation-date-time (deser-date (clojure.core/get-in letvar1760911 ["CreationDateTime"]))}))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1760913 input] (clojure.core/let [rawinput1760912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760914 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-bootstrap-actions-output ([input] (response-list-bootstrap-actions-output nil input)) ([resultWrapper1760916 input] (clojure.core/let [rawinput1760915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760917 {"BootstrapActions" (rawinput1760915 "BootstrapActions"), "Marker" (rawinput1760915 "Marker")}] (clojure.core/cond-> {} (letvar1760917 "BootstrapActions") (clojure.core/assoc :bootstrap-actions (deser-command-list (clojure.core/get-in letvar1760917 ["BootstrapActions"]))) (letvar1760917 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760917 ["Marker"])))))))

(clojure.core/defn- response-list-steps-output ([input] (response-list-steps-output nil input)) ([resultWrapper1760919 input] (clojure.core/let [rawinput1760918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760920 {"Steps" (rawinput1760918 "Steps"), "Marker" (rawinput1760918 "Marker")}] (clojure.core/cond-> {} (letvar1760920 "Steps") (clojure.core/assoc :steps (deser-step-summary-list (clojure.core/get-in letvar1760920 ["Steps"]))) (letvar1760920 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760920 ["Marker"])))))))

(clojure.core/defn- response-describe-step-output ([input] (response-describe-step-output nil input)) ([resultWrapper1760922 input] (clojure.core/let [rawinput1760921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760923 {"Step" (rawinput1760921 "Step")}] (clojure.core/cond-> {} (letvar1760923 "Step") (clojure.core/assoc :step (deser-step (clojure.core/get-in letvar1760923 ["Step"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1760925 input] (clojure.core/let [rawinput1760924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760926 {"Message" (rawinput1760924 "Message")}] (clojure.core/cond-> {} (letvar1760926 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1760926 ["Message"])))))))

(clojure.core/defn- response-run-job-flow-output ([input] (response-run-job-flow-output nil input)) ([resultWrapper1760928 input] (clojure.core/let [rawinput1760927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760929 {"JobFlowId" (rawinput1760927 "JobFlowId")}] (clojure.core/cond-> {} (letvar1760929 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1760929 ["JobFlowId"])))))))

(clojure.core/defn- response-list-instances-output ([input] (response-list-instances-output nil input)) ([resultWrapper1760931 input] (clojure.core/let [rawinput1760930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760932 {"Instances" (rawinput1760930 "Instances"), "Marker" (rawinput1760930 "Marker")}] (clojure.core/cond-> {} (letvar1760932 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar1760932 ["Instances"]))) (letvar1760932 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760932 ["Marker"])))))))

(clojure.core/defn- response-add-instance-fleet-output ([input] (response-add-instance-fleet-output nil input)) ([resultWrapper1760934 input] (clojure.core/let [rawinput1760933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760935 {"ClusterId" (rawinput1760933 "ClusterId"), "InstanceFleetId" (rawinput1760933 "InstanceFleetId")}] (clojure.core/cond-> {} (letvar1760935 "ClusterId") (clojure.core/assoc :cluster-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1760935 ["ClusterId"]))) (letvar1760935 "InstanceFleetId") (clojure.core/assoc :instance-fleet-id (deser-instance-fleet-id (clojure.core/get-in letvar1760935 ["InstanceFleetId"])))))))

(clojure.core/defn- response-delete-security-configuration-output ([input] (response-delete-security-configuration-output nil input)) ([resultWrapper1760937 input] (clojure.core/let [rawinput1760936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760938 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-instance-fleets-output ([input] (response-list-instance-fleets-output nil input)) ([resultWrapper1760940 input] (clojure.core/let [rawinput1760939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760941 {"InstanceFleets" (rawinput1760939 "InstanceFleets"), "Marker" (rawinput1760939 "Marker")}] (clojure.core/cond-> {} (letvar1760941 "InstanceFleets") (clojure.core/assoc :instance-fleets (deser-instance-fleet-list (clojure.core/get-in letvar1760941 ["InstanceFleets"]))) (letvar1760941 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760941 ["Marker"])))))))

(clojure.core/defn- response-list-instance-groups-output ([input] (response-list-instance-groups-output nil input)) ([resultWrapper1760943 input] (clojure.core/let [rawinput1760942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760944 {"InstanceGroups" (rawinput1760942 "InstanceGroups"), "Marker" (rawinput1760942 "Marker")}] (clojure.core/cond-> {} (letvar1760944 "InstanceGroups") (clojure.core/assoc :instance-groups (deser-instance-group-list (clojure.core/get-in letvar1760944 ["InstanceGroups"]))) (letvar1760944 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760944 ["Marker"])))))))

(clojure.core/defn- response-add-instance-groups-output ([input] (response-add-instance-groups-output nil input)) ([resultWrapper1760946 input] (clojure.core/let [rawinput1760945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760947 {"JobFlowId" (rawinput1760945 "JobFlowId"), "InstanceGroupIds" (rawinput1760945 "InstanceGroupIds")}] (clojure.core/cond-> {} (letvar1760947 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1760947 ["JobFlowId"]))) (letvar1760947 "InstanceGroupIds") (clojure.core/assoc :instance-group-ids (deser-instance-group-ids-list (clojure.core/get-in letvar1760947 ["InstanceGroupIds"])))))))

(clojure.core/defn- response-cancel-steps-output ([input] (response-cancel-steps-output nil input)) ([resultWrapper1760949 input] (clojure.core/let [rawinput1760948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760950 {"CancelStepsInfoList" (rawinput1760948 "CancelStepsInfoList")}] (clojure.core/cond-> {} (letvar1760950 "CancelStepsInfoList") (clojure.core/assoc :cancel-steps-info-list (deser-cancel-steps-info-list (clojure.core/get-in letvar1760950 ["CancelStepsInfoList"])))))))

(clojure.core/defn- response-describe-cluster-output ([input] (response-describe-cluster-output nil input)) ([resultWrapper1760952 input] (clojure.core/let [rawinput1760951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760953 {"Cluster" (rawinput1760951 "Cluster")}] (clojure.core/cond-> {} (letvar1760953 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1760953 ["Cluster"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1760955 input] (clojure.core/let [rawinput1760954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760956 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-clusters-output ([input] (response-list-clusters-output nil input)) ([resultWrapper1760958 input] (clojure.core/let [rawinput1760957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760959 {"Clusters" (rawinput1760957 "Clusters"), "Marker" (rawinput1760957 "Marker")}] (clojure.core/cond-> {} (letvar1760959 "Clusters") (clojure.core/assoc :clusters (deser-cluster-summary-list (clojure.core/get-in letvar1760959 ["Clusters"]))) (letvar1760959 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1760959 ["Marker"])))))))

(clojure.core/defn- response-put-auto-scaling-policy-output ([input] (response-put-auto-scaling-policy-output nil input)) ([resultWrapper1760961 input] (clojure.core/let [rawinput1760960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760962 {"ClusterId" (rawinput1760960 "ClusterId"), "InstanceGroupId" (rawinput1760960 "InstanceGroupId"), "AutoScalingPolicy" (rawinput1760960 "AutoScalingPolicy")}] (clojure.core/cond-> {} (letvar1760962 "ClusterId") (clojure.core/assoc :cluster-id (deser-cluster-id (clojure.core/get-in letvar1760962 ["ClusterId"]))) (letvar1760962 "InstanceGroupId") (clojure.core/assoc :instance-group-id (deser-instance-group-id (clojure.core/get-in letvar1760962 ["InstanceGroupId"]))) (letvar1760962 "AutoScalingPolicy") (clojure.core/assoc :auto-scaling-policy (deser-auto-scaling-policy-description (clojure.core/get-in letvar1760962 ["AutoScalingPolicy"])))))))

(clojure.core/defn- response-remove-auto-scaling-policy-output ([input] (response-remove-auto-scaling-policy-output nil input)) ([resultWrapper1760964 input] (clojure.core/let [rawinput1760963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760965 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-flows-output ([input] (response-describe-job-flows-output nil input)) ([resultWrapper1760967 input] (clojure.core/let [rawinput1760966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1760968 {"JobFlows" (rawinput1760966 "JobFlows")}] (clojure.core/cond-> {} (letvar1760968 "JobFlows") (clojure.core/assoc :job-flows (deser-job-flow-detail-list (clojure.core/get-in letvar1760968 ["JobFlows"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10280)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce.-2009-03-31/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
