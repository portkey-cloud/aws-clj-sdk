...
(clojure.core/defn- response-delete-elasticsearch-domain-response ([input] (response-delete-elasticsearch-domain-response nil input)) ([resultWrapper155139 input] (clojure.core/let [rawinput155138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155140 {"DomainStatus" (rawinput155138 "DomainStatus")}] (clojure.core/cond-> {} (letvar155140 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar155140 ["DomainStatus"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper155142 input] (clojure.core/let [rawinput155141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155143 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-elasticsearch-domain-response ([input] (response-describe-elasticsearch-domain-response nil input)) ([resultWrapper155145 input] (clojure.core/let [rawinput155144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155146 {"DomainStatus" (rawinput155144 "DomainStatus")}] (clojure.core/cond-> {:domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar155146 ["DomainStatus"]))}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper155148 input] (clojure.core/let [rawinput155147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155149 {"TagList" (rawinput155147 "TagList")}] (clojure.core/cond-> {} (letvar155149 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar155149 ["TagList"])))))))

(clojure.core/defn- response-get-compatible-elasticsearch-versions-response ([input] (response-get-compatible-elasticsearch-versions-response nil input)) ([resultWrapper155151 input] (clojure.core/let [rawinput155150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155152 {"CompatibleElasticsearchVersions" (rawinput155150 "CompatibleElasticsearchVersions")}] (clojure.core/cond-> {} (letvar155152 "CompatibleElasticsearchVersions") (clojure.core/assoc :compatible-elasticsearch-versions (deser-compatible-elasticsearch-versions-list (clojure.core/get-in letvar155152 ["CompatibleElasticsearchVersions"])))))))

(clojure.core/defn- response-list-elasticsearch-versions-response ([input] (response-list-elasticsearch-versions-response nil input)) ([resultWrapper155154 input] (clojure.core/let [rawinput155153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155155 {"ElasticsearchVersions" (rawinput155153 "ElasticsearchVersions"), "NextToken" (rawinput155153 "NextToken")}] (clojure.core/cond-> {} (letvar155155 "ElasticsearchVersions") (clojure.core/assoc :elasticsearch-versions (deser-elasticsearch-version-list (clojure.core/get-in letvar155155 ["ElasticsearchVersions"]))) (letvar155155 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar155155 ["NextToken"])))))))

(clojure.core/defn- response-cancel-elasticsearch-service-software-update-response ([input] (response-cancel-elasticsearch-service-software-update-response nil input)) ([resultWrapper155157 input] (clojure.core/let [rawinput155156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155158 {"ServiceSoftwareOptions" (rawinput155156 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar155158 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar155158 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-start-elasticsearch-service-software-update-response ([input] (response-start-elasticsearch-service-software-update-response nil input)) ([resultWrapper155160 input] (clojure.core/let [rawinput155159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155161 {"ServiceSoftwareOptions" (rawinput155159 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar155161 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar155161 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper155163 input] (clojure.core/let [rawinput155162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155164 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper155166 input] (clojure.core/let [rawinput155165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155167 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper155169 input] (clojure.core/let [rawinput155168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155170 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-upgrade-status-response ([input] (response-get-upgrade-status-response nil input)) ([resultWrapper155172 input] (clojure.core/let [rawinput155171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155173 {"UpgradeStep" (rawinput155171 "UpgradeStep"), "StepStatus" (rawinput155171 "StepStatus"), "UpgradeName" (rawinput155171 "UpgradeName")}] (clojure.core/cond-> {} (letvar155173 "UpgradeStep") (clojure.core/assoc :upgrade-step (deser-upgrade-step (clojure.core/get-in letvar155173 ["UpgradeStep"]))) (letvar155173 "StepStatus") (clojure.core/assoc :step-status (deser-upgrade-status (clojure.core/get-in letvar155173 ["StepStatus"]))) (letvar155173 "UpgradeName") (clojure.core/assoc :upgrade-name (deser-upgrade-name (clojure.core/get-in letvar155173 ["UpgradeName"])))))))

(clojure.core/defn- response-update-elasticsearch-domain-config-response ([input] (response-update-elasticsearch-domain-config-response nil input)) ([resultWrapper155175 input] (clojure.core/let [rawinput155174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155176 {"DomainConfig" (rawinput155174 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar155176 ["DomainConfig"]))}))))

(clojure.core/defn- response-disabled-operation-exception ([input] (response-disabled-operation-exception nil input)) ([resultWrapper155178 input] (clojure.core/let [rawinput155177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155179 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-domain-names-response ([input] (response-list-domain-names-response nil input)) ([resultWrapper155181 input] (clojure.core/let [rawinput155180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155182 {"DomainNames" (rawinput155180 "DomainNames")}] (clojure.core/cond-> {} (letvar155182 "DomainNames") (clojure.core/assoc :domain-names (deser-domain-info-list (clojure.core/get-in letvar155182 ["DomainNames"])))))))

(clojure.core/defn- response-purchase-reserved-elasticsearch-instance-offering-response ([input] (response-purchase-reserved-elasticsearch-instance-offering-response nil input)) ([resultWrapper155184 input] (clojure.core/let [rawinput155183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155185 {"ReservedElasticsearchInstanceId" (rawinput155183 "ReservedElasticsearchInstanceId"), "ReservationName" (rawinput155183 "ReservationName")}] (clojure.core/cond-> {} (letvar155185 "ReservedElasticsearchInstanceId") (clojure.core/assoc :reserved-elasticsearch-instance-id (deser-guid (clojure.core/get-in letvar155185 ["ReservedElasticsearchInstanceId"]))) (letvar155185 "ReservationName") (clojure.core/assoc :reservation-name (deser-reservation-token (clojure.core/get-in letvar155185 ["ReservationName"])))))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instances-response ([input] (response-describe-reserved-elasticsearch-instances-response nil input)) ([resultWrapper155187 input] (clojure.core/let [rawinput155186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155188 {"NextToken" (rawinput155186 "NextToken"), "ReservedElasticsearchInstances" (rawinput155186 "ReservedElasticsearchInstances")}] (clojure.core/cond-> {} (letvar155188 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar155188 ["NextToken"]))) (letvar155188 "ReservedElasticsearchInstances") (clojure.core/assoc :reserved-elasticsearch-instances (deser-reserved-elasticsearch-instance-list (clojure.core/get-in letvar155188 ["ReservedElasticsearchInstances"])))))))

(clojure.core/defn- response-list-elasticsearch-instance-types-response ([input] (response-list-elasticsearch-instance-types-response nil input)) ([resultWrapper155190 input] (clojure.core/let [rawinput155189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155191 {"ElasticsearchInstanceTypes" (rawinput155189 "ElasticsearchInstanceTypes"), "NextToken" (rawinput155189 "NextToken")}] (clojure.core/cond-> {} (letvar155191 "ElasticsearchInstanceTypes") (clojure.core/assoc :elasticsearch-instance-types (deser-elasticsearch-instance-type-list (clojure.core/get-in letvar155191 ["ElasticsearchInstanceTypes"]))) (letvar155191 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar155191 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper155193 input] (clojure.core/let [rawinput155192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155194 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instance-offerings-response ([input] (response-describe-reserved-elasticsearch-instance-offerings-response nil input)) ([resultWrapper155196 input] (clojure.core/let [rawinput155195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155197 {"NextToken" (rawinput155195 "NextToken"), "ReservedElasticsearchInstanceOfferings" (rawinput155195 "ReservedElasticsearchInstanceOfferings")}] (clojure.core/cond-> {} (letvar155197 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar155197 ["NextToken"]))) (letvar155197 "ReservedElasticsearchInstanceOfferings") (clojure.core/assoc :reserved-elasticsearch-instance-offerings (deser-reserved-elasticsearch-instance-offering-list (clojure.core/get-in letvar155197 ["ReservedElasticsearchInstanceOfferings"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper155199 input] (clojure.core/let [rawinput155198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155200 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-upgrade-elasticsearch-domain-response ([input] (response-upgrade-elasticsearch-domain-response nil input)) ([resultWrapper155202 input] (clojure.core/let [rawinput155201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155203 {"DomainName" (rawinput155201 "DomainName"), "TargetVersion" (rawinput155201 "TargetVersion"), "PerformCheckOnly" (rawinput155201 "PerformCheckOnly")}] (clojure.core/cond-> {} (letvar155203 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar155203 ["DomainName"]))) (letvar155203 "TargetVersion") (clojure.core/assoc :target-version (deser-elasticsearch-version-string (clojure.core/get-in letvar155203 ["TargetVersion"]))) (letvar155203 "PerformCheckOnly") (clojure.core/assoc :perform-check-only (deser-boolean (clojure.core/get-in letvar155203 ["PerformCheckOnly"])))))))

(clojure.core/defn- response-describe-elasticsearch-domains-response ([input] (response-describe-elasticsearch-domains-response nil input)) ([resultWrapper155205 input] (clojure.core/let [rawinput155204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155206 {"DomainStatusList" (rawinput155204 "DomainStatusList")}] (clojure.core/cond-> {:domain-status-list (deser-elasticsearch-domain-status-list (clojure.core/get-in letvar155206 ["DomainStatusList"]))}))))

(clojure.core/defn- response-base-exception ([input] (response-base-exception nil input)) ([resultWrapper155208 input] (clojure.core/let [rawinput155207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155209 {"message" (rawinput155207 "message")}] (clojure.core/cond-> {} (letvar155209 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar155209 ["message"])))))))

(clojure.core/defn- response-describe-elasticsearch-instance-type-limits-response ([input] (response-describe-elasticsearch-instance-type-limits-response nil input)) ([resultWrapper155211 input] (clojure.core/let [rawinput155210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155212 {"LimitsByRole" (rawinput155210 "LimitsByRole")}] (clojure.core/cond-> {} (letvar155212 "LimitsByRole") (clojure.core/assoc :limits-by-role (deser-limits-by-role (clojure.core/get-in letvar155212 ["LimitsByRole"])))))))

(clojure.core/defn- response-create-elasticsearch-domain-response ([input] (response-create-elasticsearch-domain-response nil input)) ([resultWrapper155214 input] (clojure.core/let [rawinput155213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155215 {"DomainStatus" (rawinput155213 "DomainStatus")}] (clojure.core/cond-> {} (letvar155215 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar155215 ["DomainStatus"])))))))

(clojure.core/defn- response-get-upgrade-history-response ([input] (response-get-upgrade-history-response nil input)) ([resultWrapper155217 input] (clojure.core/let [rawinput155216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155218 {"UpgradeHistories" (rawinput155216 "UpgradeHistories"), "NextToken" (rawinput155216 "NextToken")}] (clojure.core/cond-> {} (letvar155218 "UpgradeHistories") (clojure.core/assoc :upgrade-histories (deser-upgrade-history-list (clojure.core/get-in letvar155218 ["UpgradeHistories"]))) (letvar155218 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar155218 ["NextToken"])))))))

(clojure.core/defn- response-describe-elasticsearch-domain-config-response ([input] (response-describe-elasticsearch-domain-config-response nil input)) ([resultWrapper155220 input] (clojure.core/let [rawinput155219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar155221 {"DomainConfig" (rawinput155219 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar155221 ["DomainConfig"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.es/reservation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 5 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 20 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.es/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.es/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 55)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/user-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 55)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.es/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.es/domain-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 3 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 28)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-z][a-z0-9\-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/guid (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"\p{XDigit}{8}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{12}" s__21112__auto__))))
