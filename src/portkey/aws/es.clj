...
(clojure.core/defn remove-tags ([remove-tags-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "POST" "/2015-01-01/tags-removal" remove-tags-request :portkey.aws.es/remove-tags-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil nil {"BaseException" :portkey.aws.es/base-exception, "ValidationException" :portkey.aws.es/validation-exception, "InternalException" :portkey.aws.es/internal-exception})))
...
(clojure.core/defn list-domain-names ([] (list-domain-names {})) ([_] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/domain" _ nil {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.es/list-domain-names-response {"BaseException" :portkey.aws.es/base-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn describe-elasticsearch-domain-config ([describe-elasticsearch-domain-config-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/es/domain/{DomainName}/config" describe-elasticsearch-domain-config-request :portkey.aws.es/describe-elasticsearch-domain-config-request {:payload nil, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/describe-elasticsearch-domain-config-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn list-tags ([list-tags-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/tags/" list-tags-request :portkey.aws.es/list-tags-request {:payload nil, :headers {}, :uri {}, :querystring {"arn" "ARN"}} nil :portkey.aws.es/list-tags-response {"BaseException" :portkey.aws.es/base-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception, "InternalException" :portkey.aws.es/internal-exception})))
...
(clojure.core/defn describe-elasticsearch-domain ([describe-elasticsearch-domain-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/es/domain/{DomainName}" describe-elasticsearch-domain-request :portkey.aws.es/describe-elasticsearch-domain-request {:payload nil, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/describe-elasticsearch-domain-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn describe-elasticsearch-domains ([describe-elasticsearch-domains-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "POST" "/2015-01-01/es/domain-info" describe-elasticsearch-domains-request :portkey.aws.es/describe-elasticsearch-domains-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.es/describe-elasticsearch-domains-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn delete-elasticsearch-domain ([delete-elasticsearch-domain-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "DELETE" "/2015-01-01/es/domain/{DomainName}" delete-elasticsearch-domain-request :portkey.aws.es/delete-elasticsearch-domain-request {:payload nil, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/delete-elasticsearch-domain-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn add-tags ([add-tags-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "POST" "/2015-01-01/tags" add-tags-request :portkey.aws.es/add-tags-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil nil {"BaseException" :portkey.aws.es/base-exception, "LimitExceededException" :portkey.aws.es/limit-exceeded-exception, "ValidationException" :portkey.aws.es/validation-exception, "InternalException" :portkey.aws.es/internal-exception})))
