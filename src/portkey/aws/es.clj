...
(clojure.core/defn- response-delete-elasticsearch-domain-response ([input] (response-delete-elasticsearch-domain-response nil input)) ([resultWrapper1148136 input] (clojure.core/let [rawinput1148135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148137 {"DomainStatus" (rawinput1148135 "DomainStatus")}] (clojure.core/cond-> {} (letvar1148137 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar1148137 ["DomainStatus"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1148139 input] (clojure.core/let [rawinput1148138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148140 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-elasticsearch-domain-response ([input] (response-describe-elasticsearch-domain-response nil input)) ([resultWrapper1148142 input] (clojure.core/let [rawinput1148141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148143 {"DomainStatus" (rawinput1148141 "DomainStatus")}] (clojure.core/cond-> {:domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar1148143 ["DomainStatus"]))}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1148145 input] (clojure.core/let [rawinput1148144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148146 {"TagList" (rawinput1148144 "TagList")}] (clojure.core/cond-> {} (letvar1148146 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar1148146 ["TagList"])))))))

(clojure.core/defn- response-get-compatible-elasticsearch-versions-response ([input] (response-get-compatible-elasticsearch-versions-response nil input)) ([resultWrapper1148148 input] (clojure.core/let [rawinput1148147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148149 {"CompatibleElasticsearchVersions" (rawinput1148147 "CompatibleElasticsearchVersions")}] (clojure.core/cond-> {} (letvar1148149 "CompatibleElasticsearchVersions") (clojure.core/assoc :compatible-elasticsearch-versions (deser-compatible-elasticsearch-versions-list (clojure.core/get-in letvar1148149 ["CompatibleElasticsearchVersions"])))))))

(clojure.core/defn- response-list-elasticsearch-versions-response ([input] (response-list-elasticsearch-versions-response nil input)) ([resultWrapper1148151 input] (clojure.core/let [rawinput1148150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148152 {"ElasticsearchVersions" (rawinput1148150 "ElasticsearchVersions"), "NextToken" (rawinput1148150 "NextToken")}] (clojure.core/cond-> {} (letvar1148152 "ElasticsearchVersions") (clojure.core/assoc :elasticsearch-versions (deser-elasticsearch-version-list (clojure.core/get-in letvar1148152 ["ElasticsearchVersions"]))) (letvar1148152 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1148152 ["NextToken"])))))))

(clojure.core/defn- response-cancel-elasticsearch-service-software-update-response ([input] (response-cancel-elasticsearch-service-software-update-response nil input)) ([resultWrapper1148154 input] (clojure.core/let [rawinput1148153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148155 {"ServiceSoftwareOptions" (rawinput1148153 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar1148155 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar1148155 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-start-elasticsearch-service-software-update-response ([input] (response-start-elasticsearch-service-software-update-response nil input)) ([resultWrapper1148157 input] (clojure.core/let [rawinput1148156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148158 {"ServiceSoftwareOptions" (rawinput1148156 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar1148158 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar1148158 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1148160 input] (clojure.core/let [rawinput1148159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148161 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1148163 input] (clojure.core/let [rawinput1148162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148164 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper1148166 input] (clojure.core/let [rawinput1148165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148167 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-upgrade-status-response ([input] (response-get-upgrade-status-response nil input)) ([resultWrapper1148169 input] (clojure.core/let [rawinput1148168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148170 {"UpgradeStep" (rawinput1148168 "UpgradeStep"), "StepStatus" (rawinput1148168 "StepStatus"), "UpgradeName" (rawinput1148168 "UpgradeName")}] (clojure.core/cond-> {} (letvar1148170 "UpgradeStep") (clojure.core/assoc :upgrade-step (deser-upgrade-step (clojure.core/get-in letvar1148170 ["UpgradeStep"]))) (letvar1148170 "StepStatus") (clojure.core/assoc :step-status (deser-upgrade-status (clojure.core/get-in letvar1148170 ["StepStatus"]))) (letvar1148170 "UpgradeName") (clojure.core/assoc :upgrade-name (deser-upgrade-name (clojure.core/get-in letvar1148170 ["UpgradeName"])))))))

(clojure.core/defn- response-update-elasticsearch-domain-config-response ([input] (response-update-elasticsearch-domain-config-response nil input)) ([resultWrapper1148172 input] (clojure.core/let [rawinput1148171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148173 {"DomainConfig" (rawinput1148171 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar1148173 ["DomainConfig"]))}))))

(clojure.core/defn- response-disabled-operation-exception ([input] (response-disabled-operation-exception nil input)) ([resultWrapper1148175 input] (clojure.core/let [rawinput1148174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148176 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-domain-names-response ([input] (response-list-domain-names-response nil input)) ([resultWrapper1148178 input] (clojure.core/let [rawinput1148177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148179 {"DomainNames" (rawinput1148177 "DomainNames")}] (clojure.core/cond-> {} (letvar1148179 "DomainNames") (clojure.core/assoc :domain-names (deser-domain-info-list (clojure.core/get-in letvar1148179 ["DomainNames"])))))))

(clojure.core/defn- response-purchase-reserved-elasticsearch-instance-offering-response ([input] (response-purchase-reserved-elasticsearch-instance-offering-response nil input)) ([resultWrapper1148181 input] (clojure.core/let [rawinput1148180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148182 {"ReservedElasticsearchInstanceId" (rawinput1148180 "ReservedElasticsearchInstanceId"), "ReservationName" (rawinput1148180 "ReservationName")}] (clojure.core/cond-> {} (letvar1148182 "ReservedElasticsearchInstanceId") (clojure.core/assoc :reserved-elasticsearch-instance-id (deser-guid (clojure.core/get-in letvar1148182 ["ReservedElasticsearchInstanceId"]))) (letvar1148182 "ReservationName") (clojure.core/assoc :reservation-name (deser-reservation-token (clojure.core/get-in letvar1148182 ["ReservationName"])))))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instances-response ([input] (response-describe-reserved-elasticsearch-instances-response nil input)) ([resultWrapper1148184 input] (clojure.core/let [rawinput1148183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148185 {"NextToken" (rawinput1148183 "NextToken"), "ReservedElasticsearchInstances" (rawinput1148183 "ReservedElasticsearchInstances")}] (clojure.core/cond-> {} (letvar1148185 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1148185 ["NextToken"]))) (letvar1148185 "ReservedElasticsearchInstances") (clojure.core/assoc :reserved-elasticsearch-instances (deser-reserved-elasticsearch-instance-list (clojure.core/get-in letvar1148185 ["ReservedElasticsearchInstances"])))))))

(clojure.core/defn- response-list-elasticsearch-instance-types-response ([input] (response-list-elasticsearch-instance-types-response nil input)) ([resultWrapper1148187 input] (clojure.core/let [rawinput1148186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148188 {"ElasticsearchInstanceTypes" (rawinput1148186 "ElasticsearchInstanceTypes"), "NextToken" (rawinput1148186 "NextToken")}] (clojure.core/cond-> {} (letvar1148188 "ElasticsearchInstanceTypes") (clojure.core/assoc :elasticsearch-instance-types (deser-elasticsearch-instance-type-list (clojure.core/get-in letvar1148188 ["ElasticsearchInstanceTypes"]))) (letvar1148188 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1148188 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1148190 input] (clojure.core/let [rawinput1148189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148191 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instance-offerings-response ([input] (response-describe-reserved-elasticsearch-instance-offerings-response nil input)) ([resultWrapper1148193 input] (clojure.core/let [rawinput1148192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148194 {"NextToken" (rawinput1148192 "NextToken"), "ReservedElasticsearchInstanceOfferings" (rawinput1148192 "ReservedElasticsearchInstanceOfferings")}] (clojure.core/cond-> {} (letvar1148194 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1148194 ["NextToken"]))) (letvar1148194 "ReservedElasticsearchInstanceOfferings") (clojure.core/assoc :reserved-elasticsearch-instance-offerings (deser-reserved-elasticsearch-instance-offering-list (clojure.core/get-in letvar1148194 ["ReservedElasticsearchInstanceOfferings"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1148196 input] (clojure.core/let [rawinput1148195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148197 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-upgrade-elasticsearch-domain-response ([input] (response-upgrade-elasticsearch-domain-response nil input)) ([resultWrapper1148199 input] (clojure.core/let [rawinput1148198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148200 {"DomainName" (rawinput1148198 "DomainName"), "TargetVersion" (rawinput1148198 "TargetVersion"), "PerformCheckOnly" (rawinput1148198 "PerformCheckOnly")}] (clojure.core/cond-> {} (letvar1148200 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar1148200 ["DomainName"]))) (letvar1148200 "TargetVersion") (clojure.core/assoc :target-version (deser-elasticsearch-version-string (clojure.core/get-in letvar1148200 ["TargetVersion"]))) (letvar1148200 "PerformCheckOnly") (clojure.core/assoc :perform-check-only (deser-boolean (clojure.core/get-in letvar1148200 ["PerformCheckOnly"])))))))

(clojure.core/defn- response-describe-elasticsearch-domains-response ([input] (response-describe-elasticsearch-domains-response nil input)) ([resultWrapper1148202 input] (clojure.core/let [rawinput1148201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148203 {"DomainStatusList" (rawinput1148201 "DomainStatusList")}] (clojure.core/cond-> {:domain-status-list (deser-elasticsearch-domain-status-list (clojure.core/get-in letvar1148203 ["DomainStatusList"]))}))))

(clojure.core/defn- response-base-exception ([input] (response-base-exception nil input)) ([resultWrapper1148205 input] (clojure.core/let [rawinput1148204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148206 {"message" (rawinput1148204 "message")}] (clojure.core/cond-> {} (letvar1148206 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1148206 ["message"])))))))

(clojure.core/defn- response-describe-elasticsearch-instance-type-limits-response ([input] (response-describe-elasticsearch-instance-type-limits-response nil input)) ([resultWrapper1148208 input] (clojure.core/let [rawinput1148207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148209 {"LimitsByRole" (rawinput1148207 "LimitsByRole")}] (clojure.core/cond-> {} (letvar1148209 "LimitsByRole") (clojure.core/assoc :limits-by-role (deser-limits-by-role (clojure.core/get-in letvar1148209 ["LimitsByRole"])))))))

(clojure.core/defn- response-create-elasticsearch-domain-response ([input] (response-create-elasticsearch-domain-response nil input)) ([resultWrapper1148211 input] (clojure.core/let [rawinput1148210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148212 {"DomainStatus" (rawinput1148210 "DomainStatus")}] (clojure.core/cond-> {} (letvar1148212 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar1148212 ["DomainStatus"])))))))

(clojure.core/defn- response-get-upgrade-history-response ([input] (response-get-upgrade-history-response nil input)) ([resultWrapper1148214 input] (clojure.core/let [rawinput1148213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148215 {"UpgradeHistories" (rawinput1148213 "UpgradeHistories"), "NextToken" (rawinput1148213 "NextToken")}] (clojure.core/cond-> {} (letvar1148215 "UpgradeHistories") (clojure.core/assoc :upgrade-histories (deser-upgrade-history-list (clojure.core/get-in letvar1148215 ["UpgradeHistories"]))) (letvar1148215 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1148215 ["NextToken"])))))))

(clojure.core/defn- response-describe-elasticsearch-domain-config-response ([input] (response-describe-elasticsearch-domain-config-response nil input)) ([resultWrapper1148217 input] (clojure.core/let [rawinput1148216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1148218 {"DomainConfig" (rawinput1148216 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar1148218 ["DomainConfig"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.es/reservation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 5 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 20 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.es/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.es/identity-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 55)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w-]+:[0-9a-f-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/user-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 55)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.es/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.es/domain-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 3 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 28)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-z][a-z0-9\-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es/guid (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"\p{XDigit}{8}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{12}" s__1012854__auto__))))
