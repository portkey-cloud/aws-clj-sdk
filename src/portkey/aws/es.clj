...
(clojure.core/defn delete-elasticsearch-service-role "<p>Deletes the service-linked role that Elasticsearch Service uses to manage and maintain VPC domains. Role deletion will fail if any existing VPC domains use the role. You must delete any such Elasticsearch domains before deleting the role. See <a href=\"http://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-vpc.html#es-enabling-slr\" target=\"_blank\">Deleting Elasticsearch Service Role</a> in <i>VPC Endpoints for Amazon Elasticsearch Service Domains</i>.</p>" ([] (delete-elasticsearch-service-role {})) ([_] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "DELETE" "/2015-01-01/es/role" _ nil {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil nil {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ValidationException" :portkey.aws.es/validation-exception})))
(clojure.spec.alpha/fdef delete-elasticsearch-service-role :args clojure.core/empty? :ret clojure.core/true?)

(clojure.core/defn remove-tags "<p>Removes the specified set of tags from the specified Elasticsearch domain.</p>" ([remove-tags-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "POST" "/2015-01-01/tags-removal" remove-tags-request :portkey.aws.es/remove-tags-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil nil {"BaseException" :portkey.aws.es/base-exception, "ValidationException" :portkey.aws.es/validation-exception, "InternalException" :portkey.aws.es/internal-exception})))
...
(clojure.core/defn list-domain-names "<p>Returns the name of all Elasticsearch domains owned by the current user's account. </p>" ([] (list-domain-names {})) ([_] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/domain" _ nil {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.es/list-domain-names-response {"BaseException" :portkey.aws.es/base-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn describe-elasticsearch-domain-config "<p>Provides cluster configuration information about the specified Elasticsearch domain, such as the state, creation date, update version, and update date for cluster options.</p>" ([describe-elasticsearch-domain-config-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/es/domain/{DomainName}/config" describe-elasticsearch-domain-config-request :portkey.aws.es/describe-elasticsearch-domain-config-request {:payload nil, :move {}, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/describe-elasticsearch-domain-config-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn list-tags "<p>Returns all tags for the given Elasticsearch domain.</p>" ([list-tags-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/tags/" list-tags-request :portkey.aws.es/list-tags-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"arn" "ARN"}} nil :portkey.aws.es/list-tags-response {"BaseException" :portkey.aws.es/base-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception, "InternalException" :portkey.aws.es/internal-exception})))
...
(clojure.core/defn describe-elasticsearch-domain "<p>Returns domain configuration information about the specified Elasticsearch domain, including the domain ID, domain endpoint, and domain ARN.</p>" ([describe-elasticsearch-domain-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "GET" "/2015-01-01/es/domain/{DomainName}" describe-elasticsearch-domain-request :portkey.aws.es/describe-elasticsearch-domain-request {:payload nil, :move {}, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/describe-elasticsearch-domain-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
...
(clojure.core/defn delete-elasticsearch-domain "<p>Permanently deletes the specified Elasticsearch domain and all of its data. Once a domain is deleted, it cannot be recovered.</p>" ([delete-elasticsearch-domain-request] (portkey.aws/-rest-json-call portkey.aws.es/endpoints "DELETE" "/2015-01-01/es/domain/{DomainName}" delete-elasticsearch-domain-request :portkey.aws.es/delete-elasticsearch-domain-request {:payload nil, :move {}, :headers {}, :uri {"DomainName" "DomainName"}, :querystring {}} nil :portkey.aws.es/delete-elasticsearch-domain-response {"BaseException" :portkey.aws.es/base-exception, "InternalException" :portkey.aws.es/internal-exception, "ResourceNotFoundException" :portkey.aws.es/resource-not-found-exception, "ValidationException" :portkey.aws.es/validation-exception})))
