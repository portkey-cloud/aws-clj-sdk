...
(clojure.core/defn- response-describe-trusted-advisor-check-summaries-response ([input] (response-describe-trusted-advisor-check-summaries-response nil input)) ([resultWrapper2110183 input] (clojure.core/let [rawinput2110182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110184 {"summaries" (rawinput2110182 "summaries")}] (clojure.core/cond-> {:summaries (deser-trusted-advisor-check-summary-list (clojure.core/get-in letvar2110184 ["summaries"]))}))))

(clojure.core/defn- response-add-attachments-to-set-response ([input] (response-add-attachments-to-set-response nil input)) ([resultWrapper2110186 input] (clojure.core/let [rawinput2110185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110187 {"attachmentSetId" (rawinput2110185 "attachmentSetId"), "expiryTime" (rawinput2110185 "expiryTime")}] (clojure.core/cond-> {} (letvar2110187 "attachmentSetId") (clojure.core/assoc :attachment-set-id (deser-attachment-set-id (clojure.core/get-in letvar2110187 ["attachmentSetId"]))) (letvar2110187 "expiryTime") (clojure.core/assoc :expiry-time (deser-expiry-time (clojure.core/get-in letvar2110187 ["expiryTime"])))))))

(clojure.core/defn- response-add-communication-to-case-response ([input] (response-add-communication-to-case-response nil input)) ([resultWrapper2110189 input] (clojure.core/let [rawinput2110188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110190 {"result" (rawinput2110188 "result")}] (clojure.core/cond-> {} (letvar2110190 "result") (clojure.core/assoc :result (deser-result (clojure.core/get-in letvar2110190 ["result"])))))))

(clojure.core/defn- response-attachment-set-size-limit-exceeded ([input] (response-attachment-set-size-limit-exceeded nil input)) ([resultWrapper2110192 input] (clojure.core/let [rawinput2110191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110193 {"message" (rawinput2110191 "message")}] (clojure.core/cond-> {} (letvar2110193 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110193 ["message"])))))))

(clojure.core/defn- response-describe-attachment-limit-exceeded ([input] (response-describe-attachment-limit-exceeded nil input)) ([resultWrapper2110195 input] (clojure.core/let [rawinput2110194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110196 {"message" (rawinput2110194 "message")}] (clojure.core/cond-> {} (letvar2110196 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110196 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-checks-response ([input] (response-describe-trusted-advisor-checks-response nil input)) ([resultWrapper2110198 input] (clojure.core/let [rawinput2110197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110199 {"checks" (rawinput2110197 "checks")}] (clojure.core/cond-> {:checks (deser-trusted-advisor-check-list (clojure.core/get-in letvar2110199 ["checks"]))}))))

(clojure.core/defn- response-create-case-response ([input] (response-create-case-response nil input)) ([resultWrapper2110201 input] (clojure.core/let [rawinput2110200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110202 {"caseId" (rawinput2110200 "caseId")}] (clojure.core/cond-> {} (letvar2110202 "caseId") (clojure.core/assoc :case-id (deser-case-id (clojure.core/get-in letvar2110202 ["caseId"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-refresh-statuses-response ([input] (response-describe-trusted-advisor-check-refresh-statuses-response nil input)) ([resultWrapper2110204 input] (clojure.core/let [rawinput2110203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110205 {"statuses" (rawinput2110203 "statuses")}] (clojure.core/cond-> {:statuses (deser-trusted-advisor-check-refresh-status-list (clojure.core/get-in letvar2110205 ["statuses"]))}))))

(clojure.core/defn- response-attachment-set-expired ([input] (response-attachment-set-expired nil input)) ([resultWrapper2110207 input] (clojure.core/let [rawinput2110206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110208 {"message" (rawinput2110206 "message")}] (clojure.core/cond-> {} (letvar2110208 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110208 ["message"])))))))

(clojure.core/defn- response-describe-services-response ([input] (response-describe-services-response nil input)) ([resultWrapper2110210 input] (clojure.core/let [rawinput2110209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110211 {"services" (rawinput2110209 "services")}] (clojure.core/cond-> {} (letvar2110211 "services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar2110211 ["services"])))))))

(clojure.core/defn- response-refresh-trusted-advisor-check-response ([input] (response-refresh-trusted-advisor-check-response nil input)) ([resultWrapper2110213 input] (clojure.core/let [rawinput2110212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110214 {"status" (rawinput2110212 "status")}] (clojure.core/cond-> {:status (deser-trusted-advisor-check-refresh-status (clojure.core/get-in letvar2110214 ["status"]))}))))

(clojure.core/defn- response-case-id-not-found ([input] (response-case-id-not-found nil input)) ([resultWrapper2110216 input] (clojure.core/let [rawinput2110215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110217 {"message" (rawinput2110215 "message")}] (clojure.core/cond-> {} (letvar2110217 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110217 ["message"])))))))

(clojure.core/defn- response-describe-trusted-advisor-check-result-response ([input] (response-describe-trusted-advisor-check-result-response nil input)) ([resultWrapper2110219 input] (clojure.core/let [rawinput2110218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110220 {"result" (rawinput2110218 "result")}] (clojure.core/cond-> {} (letvar2110220 "result") (clojure.core/assoc :result (deser-trusted-advisor-check-result (clojure.core/get-in letvar2110220 ["result"])))))))

(clojure.core/defn- response-describe-communications-response ([input] (response-describe-communications-response nil input)) ([resultWrapper2110222 input] (clojure.core/let [rawinput2110221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110223 {"communications" (rawinput2110221 "communications"), "nextToken" (rawinput2110221 "nextToken")}] (clojure.core/cond-> {} (letvar2110223 "communications") (clojure.core/assoc :communications (deser-communication-list (clojure.core/get-in letvar2110223 ["communications"]))) (letvar2110223 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2110223 ["nextToken"])))))))

(clojure.core/defn- response-attachment-id-not-found ([input] (response-attachment-id-not-found nil input)) ([resultWrapper2110225 input] (clojure.core/let [rawinput2110224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110226 {"message" (rawinput2110224 "message")}] (clojure.core/cond-> {} (letvar2110226 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110226 ["message"])))))))

(clojure.core/defn- response-resolve-case-response ([input] (response-resolve-case-response nil input)) ([resultWrapper2110228 input] (clojure.core/let [rawinput2110227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110229 {"initialCaseStatus" (rawinput2110227 "initialCaseStatus"), "finalCaseStatus" (rawinput2110227 "finalCaseStatus")}] (clojure.core/cond-> {} (letvar2110229 "initialCaseStatus") (clojure.core/assoc :initial-case-status (deser-case-status (clojure.core/get-in letvar2110229 ["initialCaseStatus"]))) (letvar2110229 "finalCaseStatus") (clojure.core/assoc :final-case-status (deser-case-status (clojure.core/get-in letvar2110229 ["finalCaseStatus"])))))))

(clojure.core/defn- response-attachment-limit-exceeded ([input] (response-attachment-limit-exceeded nil input)) ([resultWrapper2110231 input] (clojure.core/let [rawinput2110230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110232 {"message" (rawinput2110230 "message")}] (clojure.core/cond-> {} (letvar2110232 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110232 ["message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2110234 input] (clojure.core/let [rawinput2110233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110235 {"message" (rawinput2110233 "message")}] (clojure.core/cond-> {} (letvar2110235 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110235 ["message"])))))))

(clojure.core/defn- response-describe-severity-levels-response ([input] (response-describe-severity-levels-response nil input)) ([resultWrapper2110237 input] (clojure.core/let [rawinput2110236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110238 {"severityLevels" (rawinput2110236 "severityLevels")}] (clojure.core/cond-> {} (letvar2110238 "severityLevels") (clojure.core/assoc :severity-levels (deser-severity-levels-list (clojure.core/get-in letvar2110238 ["severityLevels"])))))))

(clojure.core/defn- response-describe-cases-response ([input] (response-describe-cases-response nil input)) ([resultWrapper2110240 input] (clojure.core/let [rawinput2110239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110241 {"cases" (rawinput2110239 "cases"), "nextToken" (rawinput2110239 "nextToken")}] (clojure.core/cond-> {} (letvar2110241 "cases") (clojure.core/assoc :cases (deser-case-list (clojure.core/get-in letvar2110241 ["cases"]))) (letvar2110241 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2110241 ["nextToken"])))))))

(clojure.core/defn- response-describe-attachment-response ([input] (response-describe-attachment-response nil input)) ([resultWrapper2110243 input] (clojure.core/let [rawinput2110242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110244 {"attachment" (rawinput2110242 "attachment")}] (clojure.core/cond-> {} (letvar2110244 "attachment") (clojure.core/assoc :attachment (deser-attachment (clojure.core/get-in letvar2110244 ["attachment"])))))))

(clojure.core/defn- response-attachment-set-id-not-found ([input] (response-attachment-set-id-not-found nil input)) ([resultWrapper2110246 input] (clojure.core/let [rawinput2110245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110247 {"message" (rawinput2110245 "message")}] (clojure.core/cond-> {} (letvar2110247 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110247 ["message"])))))))

(clojure.core/defn- response-case-creation-limit-exceeded ([input] (response-case-creation-limit-exceeded nil input)) ([resultWrapper2110249 input] (clojure.core/let [rawinput2110248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2110250 {"message" (rawinput2110248 "message")}] (clojure.core/cond-> {} (letvar2110250 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2110250 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.support.-2013-04-15/communication-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8000))))
