...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper439449 input] (clojure.core/let [rawinput439448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439450 {"Message" (rawinput439448 "Message")}] (clojure.core/cond-> {} (letvar439450 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439450 ["Message"])))))))

(clojure.core/defn- response-method-not-allowed-exception ([input] (response-method-not-allowed-exception nil input)) ([resultWrapper439452 input] (clojure.core/let [rawinput439451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439453 {"Message" (rawinput439451 "Message")}] (clojure.core/cond-> {} (letvar439453 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439453 ["Message"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper439455 input] (clojure.core/let [rawinput439454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439456 {"Message" (rawinput439454 "Message")}] (clojure.core/cond-> {} (letvar439456 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439456 ["Message"])))))))

(clojure.core/defn- response-update-group-output ([input] (response-update-group-output nil input)) ([resultWrapper439458 input] (clojure.core/let [rawinput439457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439459 {"Group" (rawinput439457 "Group")}] (clojure.core/cond-> {} (letvar439459 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar439459 ["Group"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper439461 input] (clojure.core/let [rawinput439460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439462 {"Message" (rawinput439460 "Message")}] (clojure.core/cond-> {} (letvar439462 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439462 ["Message"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper439464 input] (clojure.core/let [rawinput439463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439465 {"Message" (rawinput439463 "Message")}] (clojure.core/cond-> {} (letvar439465 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439465 ["Message"])))))))

(clojure.core/defn- response-update-group-query-output ([input] (response-update-group-query-output nil input)) ([resultWrapper439467 input] (clojure.core/let [rawinput439466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439468 {"GroupQuery" (rawinput439466 "GroupQuery")}] (clojure.core/cond-> {} (letvar439468 "GroupQuery") (clojure.core/assoc :group-query (deser-group-query (clojure.core/get-in letvar439468 ["GroupQuery"])))))))

(clojure.core/defn- response-untag-output ([input] (response-untag-output nil input)) ([resultWrapper439470 input] (clojure.core/let [rawinput439469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439471 {"Arn" (rawinput439469 "Arn"), "Keys" (rawinput439469 "Keys")}] (clojure.core/cond-> {} (letvar439471 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar439471 ["Arn"]))) (letvar439471 "Keys") (clojure.core/assoc :keys (deser-tag-key-list (clojure.core/get-in letvar439471 ["Keys"])))))))

(clojure.core/defn- response-list-group-resources-output ([input] (response-list-group-resources-output nil input)) ([resultWrapper439473 input] (clojure.core/let [rawinput439472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439474 {"ResourceIdentifiers" (rawinput439472 "ResourceIdentifiers"), "NextToken" (rawinput439472 "NextToken"), "QueryErrors" (rawinput439472 "QueryErrors")}] (clojure.core/cond-> {} (letvar439474 "ResourceIdentifiers") (clojure.core/assoc :resource-identifiers (deser-resource-identifier-list (clojure.core/get-in letvar439474 ["ResourceIdentifiers"]))) (letvar439474 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar439474 ["NextToken"]))) (letvar439474 "QueryErrors") (clojure.core/assoc :query-errors (deser-query-error-list (clojure.core/get-in letvar439474 ["QueryErrors"])))))))

(clojure.core/defn- response-list-groups-output ([input] (response-list-groups-output nil input)) ([resultWrapper439476 input] (clojure.core/let [rawinput439475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439477 {"GroupIdentifiers" (rawinput439475 "GroupIdentifiers"), "Groups" (rawinput439475 "Groups"), "NextToken" (rawinput439475 "NextToken")}] (clojure.core/cond-> {} (letvar439477 "GroupIdentifiers") (clojure.core/assoc :group-identifiers (deser-group-identifier-list (clojure.core/get-in letvar439477 ["GroupIdentifiers"]))) (letvar439477 "Groups") (clojure.core/assoc :groups (deser-group-list (clojure.core/get-in letvar439477 ["Groups"]))) (letvar439477 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar439477 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper439479 input] (clojure.core/let [rawinput439478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439480 {"Message" (rawinput439478 "Message")}] (clojure.core/cond-> {} (letvar439480 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439480 ["Message"])))))))

(clojure.core/defn- response-tag-output ([input] (response-tag-output nil input)) ([resultWrapper439482 input] (clojure.core/let [rawinput439481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439483 {"Arn" (rawinput439481 "Arn"), "Tags" (rawinput439481 "Tags")}] (clojure.core/cond-> {} (letvar439483 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar439483 ["Arn"]))) (letvar439483 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar439483 ["Tags"])))))))

(clojure.core/defn- response-search-resources-output ([input] (response-search-resources-output nil input)) ([resultWrapper439485 input] (clojure.core/let [rawinput439484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439486 {"ResourceIdentifiers" (rawinput439484 "ResourceIdentifiers"), "NextToken" (rawinput439484 "NextToken"), "QueryErrors" (rawinput439484 "QueryErrors")}] (clojure.core/cond-> {} (letvar439486 "ResourceIdentifiers") (clojure.core/assoc :resource-identifiers (deser-resource-identifier-list (clojure.core/get-in letvar439486 ["ResourceIdentifiers"]))) (letvar439486 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar439486 ["NextToken"]))) (letvar439486 "QueryErrors") (clojure.core/assoc :query-errors (deser-query-error-list (clojure.core/get-in letvar439486 ["QueryErrors"])))))))

(clojure.core/defn- response-get-group-output ([input] (response-get-group-output nil input)) ([resultWrapper439488 input] (clojure.core/let [rawinput439487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439489 {"Group" (rawinput439487 "Group")}] (clojure.core/cond-> {} (letvar439489 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar439489 ["Group"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper439491 input] (clojure.core/let [rawinput439490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439492 {"Message" (rawinput439490 "Message")}] (clojure.core/cond-> {} (letvar439492 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar439492 ["Message"])))))))

(clojure.core/defn- response-create-group-output ([input] (response-create-group-output nil input)) ([resultWrapper439494 input] (clojure.core/let [rawinput439493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439495 {"Group" (rawinput439493 "Group"), "ResourceQuery" (rawinput439493 "ResourceQuery"), "Tags" (rawinput439493 "Tags")}] (clojure.core/cond-> {} (letvar439495 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar439495 ["Group"]))) (letvar439495 "ResourceQuery") (clojure.core/assoc :resource-query (deser-resource-query (clojure.core/get-in letvar439495 ["ResourceQuery"]))) (letvar439495 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar439495 ["Tags"])))))))

(clojure.core/defn- response-get-tags-output ([input] (response-get-tags-output nil input)) ([resultWrapper439497 input] (clojure.core/let [rawinput439496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439498 {"Arn" (rawinput439496 "Arn"), "Tags" (rawinput439496 "Tags")}] (clojure.core/cond-> {} (letvar439498 "Arn") (clojure.core/assoc :arn (deser-group-arn (clojure.core/get-in letvar439498 ["Arn"]))) (letvar439498 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar439498 ["Tags"])))))))

(clojure.core/defn- response-get-group-query-output ([input] (response-get-group-query-output nil input)) ([resultWrapper439500 input] (clojure.core/let [rawinput439499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439501 {"GroupQuery" (rawinput439499 "GroupQuery")}] (clojure.core/cond-> {} (letvar439501 "GroupQuery") (clojure.core/assoc :group-query (deser-group-query (clojure.core/get-in letvar439501 ["GroupQuery"])))))))

(clojure.core/defn- response-delete-group-output ([input] (response-delete-group-output nil input)) ([resultWrapper439503 input] (clojure.core/let [rawinput439502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar439504 {"Group" (rawinput439502 "Group")}] (clojure.core/cond-> {} (letvar439504 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar439504 ["Group"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_\.-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/query (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/group-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.resource-groups/group-filter-name #{:resourcetype "resource-type"})

(clojure.spec.alpha/def :portkey.aws.resource-groups/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"AWS::[a-zA-Z0-9]+::\w+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:[a-z0-9\-]*:([a-z]{2}-[a-z]+-\d{1})?:([0-9]{12})?:.+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.resource-groups/resource-filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"AWS::[a-zA-Z0-9]+::[a-zA-Z0-9]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.resource-groups/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:resource-groups:[a-z]{2}-[a-z]+-\d{1}:[0-9]{12}:group/[a-zA-Z0-9_\.-]{1,128}" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.resource-groups/group-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 512)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\sa-zA-Z0-9_\.-]*" s__21112__auto__))))
