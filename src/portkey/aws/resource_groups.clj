...
(clojure.core/defn get-tags "<p>Returns a list of tags that are associated with a resource, specified by an ARN.</p>" ([get-tags-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "GET" "/resources/{Arn}/tags" get-tags-input :portkey.aws.resource-groups/get-tags-input {:payload nil, :move {}, :headers {}, :uri {"Arn" "Arn"}, :querystring {}} nil :portkey.aws.resource-groups/get-tags-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn update-group-query "<p>Updates the resource query of a group.</p>" ([update-group-query-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "PUT" "/groups/{GroupName}/query" update-group-query-input :portkey.aws.resource-groups/update-group-query-input {:payload nil, :move {}, :headers {}, :uri {"GroupName" "GroupName"}, :querystring {}} nil :portkey.aws.resource-groups/update-group-query-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn get-group "<p>Returns information about a specified resource group.</p>" ([get-group-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "GET" "/groups/{GroupName}" get-group-input :portkey.aws.resource-groups/get-group-input {:payload nil, :move {}, :headers {}, :uri {"GroupName" "GroupName"}, :querystring {}} nil :portkey.aws.resource-groups/get-group-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn update-group "<p>Updates an existing group with a new or changed description. You cannot update the name of a resource group.</p>" ([update-group-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "PUT" "/groups/{GroupName}" update-group-input :portkey.aws.resource-groups/update-group-input {:payload nil, :move {}, :headers {}, :uri {"GroupName" "GroupName"}, :querystring {}} nil :portkey.aws.resource-groups/update-group-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn get-group-query "<p>Returns the resource query associated with the specified resource group.</p>" ([get-group-query-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "GET" "/groups/{GroupName}/query" get-group-query-input :portkey.aws.resource-groups/get-group-query-input {:payload nil, :move {}, :headers {}, :uri {"GroupName" "GroupName"}, :querystring {}} nil :portkey.aws.resource-groups/get-group-query-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn search-resources "<p>Returns a list of AWS resource identifiers that matches a specified query. The query uses the same format as a resource query in a CreateGroup or UpdateGroupQuery operation.</p>" ([search-resources-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "POST" "/resources/search" search-resources-input :portkey.aws.resource-groups/search-resources-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.resource-groups/search-resources-output {"UnauthorizedException" :portkey.aws.resource-groups/unauthorized-exception, "BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn tag "<p>Adds specified tags to a resource with the specified ARN. Existing tags on a resource are not changed if they are not specified in the request parameters.</p>" ([tag-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "PUT" "/resources/{Arn}/tags" tag-input :portkey.aws.resource-groups/tag-input {:payload nil, :move {}, :headers {}, :uri {"Arn" "Arn"}, :querystring {}} nil :portkey.aws.resource-groups/tag-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "NotFoundException" :portkey.aws.resource-groups/not-found-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
...
(clojure.core/defn create-group "<p>Creates a group with a specified name, description, and resource query.</p>" ([create-group-input] (portkey.aws/-rest-json-call portkey.aws.resource-groups/endpoints "POST" "/groups" create-group-input :portkey.aws.resource-groups/create-group-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.resource-groups/create-group-output {"BadRequestException" :portkey.aws.resource-groups/bad-request-exception, "ForbiddenException" :portkey.aws.resource-groups/forbidden-exception, "MethodNotAllowedException" :portkey.aws.resource-groups/method-not-allowed-exception, "TooManyRequestsException" :portkey.aws.resource-groups/too-many-requests-exception, "InternalServerErrorException" :portkey.aws.resource-groups/internal-server-error-exception})))
