...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1840269 input] (clojure.core/let [rawinput1840268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840270 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1840272 input] (clojure.core/let [rawinput1840271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840273 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1840275 input] (clojure.core/let [rawinput1840274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840276 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1840278 input] (clojure.core/let [rawinput1840277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840279 {"message" (rawinput1840277 "message")}] (clojure.core/cond-> {} (letvar1840279 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840279 ["message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1840281 input] (clojure.core/let [rawinput1840280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840282 {"InputSchema" (rawinput1840280 "InputSchema"), "ParsedInputRecords" (rawinput1840280 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1840280 "ProcessedInputRecords"), "RawInputRecords" (rawinput1840280 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1840282 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1840282 ["InputSchema"]))) (letvar1840282 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1840282 ["ParsedInputRecords"]))) (letvar1840282 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1840282 ["ProcessedInputRecords"]))) (letvar1840282 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1840282 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1840284 input] (clojure.core/let [rawinput1840283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840285 {"message" (rawinput1840283 "message"), "RawInputRecords" (rawinput1840283 "RawInputRecords"), "ProcessedInputRecords" (rawinput1840283 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1840285 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840285 ["message"]))) (letvar1840285 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1840285 ["RawInputRecords"]))) (letvar1840285 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1840285 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1840287 input] (clojure.core/let [rawinput1840286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840288 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1840290 input] (clojure.core/let [rawinput1840289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840291 {"ApplicationDetail" (rawinput1840289 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1840291 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1840293 input] (clojure.core/let [rawinput1840292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840294 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1840296 input] (clojure.core/let [rawinput1840295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840297 {"message" (rawinput1840295 "message")}] (clojure.core/cond-> {} (letvar1840297 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840297 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1840299 input] (clojure.core/let [rawinput1840298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840300 {"message" (rawinput1840298 "message")}] (clojure.core/cond-> {} (letvar1840300 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840300 ["message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1840302 input] (clojure.core/let [rawinput1840301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840303 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1840305 input] (clojure.core/let [rawinput1840304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840306 {"message" (rawinput1840304 "message")}] (clojure.core/cond-> {} (letvar1840306 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840306 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1840308 input] (clojure.core/let [rawinput1840307 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840309 {"message" (rawinput1840307 "message")}] (clojure.core/cond-> {} (letvar1840309 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840309 ["message"])))))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1840311 input] (clojure.core/let [rawinput1840310 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840312 {"message" (rawinput1840310 "message")}] (clojure.core/cond-> {} (letvar1840312 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840312 ["message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1840314 input] (clojure.core/let [rawinput1840313 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840315 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1840317 input] (clojure.core/let [rawinput1840316 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840318 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1840320 input] (clojure.core/let [rawinput1840319 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840321 {"message" (rawinput1840319 "message")}] (clojure.core/cond-> {} (letvar1840321 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840321 ["message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1840323 input] (clojure.core/let [rawinput1840322 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840324 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1840326 input] (clojure.core/let [rawinput1840325 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840327 {"ApplicationSummary" (rawinput1840325 "ApplicationSummary")}] (clojure.core/cond-> {:application-summary (deser-application-summary (clojure.core/get-in letvar1840327 ["ApplicationSummary"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1840329 input] (clojure.core/let [rawinput1840328 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840330 {"message" (rawinput1840328 "message")}] (clojure.core/cond-> {} (letvar1840330 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840330 ["message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1840332 input] (clojure.core/let [rawinput1840331 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840333 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1840335 input] (clojure.core/let [rawinput1840334 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840336 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1840338 input] (clojure.core/let [rawinput1840337 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840339 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1840341 input] (clojure.core/let [rawinput1840340 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840342 {"message" (rawinput1840340 "message")}] (clojure.core/cond-> {} (letvar1840342 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840342 ["message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1840344 input] (clojure.core/let [rawinput1840343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840345 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1840347 input] (clojure.core/let [rawinput1840346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840348 {"ApplicationSummaries" (rawinput1840346 "ApplicationSummaries"), "HasMoreApplications" (rawinput1840346 "HasMoreApplications")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1840348 ["ApplicationSummaries"])), :has-more-applications (deser-boolean-object (clojure.core/get-in letvar1840348 ["HasMoreApplications"]))}))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1840350 input] (clojure.core/let [rawinput1840349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1840351 {"message" (rawinput1840349 "message")}] (clojure.core/cond-> {} (letvar1840351 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1840351 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/log-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/in-app-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"UTF-8" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalytics.-2015-08-14/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
