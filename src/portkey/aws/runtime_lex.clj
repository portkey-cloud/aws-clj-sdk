...
(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper451060 input] (clojure.core/let [rawinput451059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451061 {"message" (rawinput451059 "message")}] (clojure.core/cond-> {} (letvar451061 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451061 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper451063 input] (clojure.core/let [rawinput451062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451064 {"message" (rawinput451062 "message")}] (clojure.core/cond-> {} (letvar451064 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451064 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper451066 input] (clojure.core/let [rawinput451065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451067 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput451065 "message")}] (clojure.core/cond-> {} (letvar451067 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar451067 ["Retry-After"]))) (letvar451067 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451067 ["message"])))))))

(clojure.core/defn- response-loop-detected-exception ([input] (response-loop-detected-exception nil input)) ([resultWrapper451069 input] (clojure.core/let [rawinput451068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451070 {"Message" (rawinput451068 "Message")}] (clojure.core/cond-> {} (letvar451070 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar451070 ["Message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper451072 input] (clojure.core/let [rawinput451071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451073 {"message" (rawinput451071 "message")}] (clojure.core/cond-> {} (letvar451073 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451073 ["message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper451075 input] (clojure.core/let [rawinput451074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451076 {"message" (rawinput451074 "message")}] (clojure.core/cond-> {} (letvar451076 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451076 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper451078 input] (clojure.core/let [rawinput451077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451079 {"message" (rawinput451077 "message")}] (clojure.core/cond-> {} (letvar451079 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451079 ["message"])))))))

(clojure.core/defn- response-dependency-failed-exception ([input] (response-dependency-failed-exception nil input)) ([resultWrapper451081 input] (clojure.core/let [rawinput451080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451082 {"Message" (rawinput451080 "Message")}] (clojure.core/cond-> {} (letvar451082 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar451082 ["Message"])))))))

(clojure.core/defn- response-request-timeout-exception ([input] (response-request-timeout-exception nil input)) ([resultWrapper451084 input] (clojure.core/let [rawinput451083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451085 {"message" (rawinput451083 "message")}] (clojure.core/cond-> {} (letvar451085 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451085 ["message"])))))))

(clojure.core/defn- response-not-acceptable-exception ([input] (response-not-acceptable-exception nil input)) ([resultWrapper451087 input] (clojure.core/let [rawinput451086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451088 {"message" (rawinput451086 "message")}] (clojure.core/cond-> {} (letvar451088 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar451088 ["message"])))))))

(clojure.core/defn- response-bad-gateway-exception ([input] (response-bad-gateway-exception nil input)) ([resultWrapper451090 input] (clojure.core/let [rawinput451089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451091 {"Message" (rawinput451089 "Message")}] (clojure.core/cond-> {} (letvar451091 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar451091 ["Message"])))))))

(clojure.core/defn- response-post-text-response ([input] (response-post-text-response nil input)) ([resultWrapper451093 input] (clojure.core/let [rawinput451092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451094 {"intentName" (rawinput451092 "intentName"), "slots" (rawinput451092 "slots"), "sessionAttributes" (rawinput451092 "sessionAttributes"), "message" (rawinput451092 "message"), "messageFormat" (rawinput451092 "messageFormat"), "dialogState" (rawinput451092 "dialogState"), "slotToElicit" (rawinput451092 "slotToElicit"), "responseCard" (rawinput451092 "responseCard")}] (clojure.core/cond-> {} (letvar451094 "intentName") (clojure.core/assoc :intent-name (deser-intent-name (clojure.core/get-in letvar451094 ["intentName"]))) (letvar451094 "slots") (clojure.core/assoc :slots (deser-string-map (clojure.core/get-in letvar451094 ["slots"]))) (letvar451094 "sessionAttributes") (clojure.core/assoc :session-attributes (deser-string-map (clojure.core/get-in letvar451094 ["sessionAttributes"]))) (letvar451094 "message") (clojure.core/assoc :message (deser-text (clojure.core/get-in letvar451094 ["message"]))) (letvar451094 "messageFormat") (clojure.core/assoc :message-format (deser-message-format-type (clojure.core/get-in letvar451094 ["messageFormat"]))) (letvar451094 "dialogState") (clojure.core/assoc :dialog-state (deser-dialog-state (clojure.core/get-in letvar451094 ["dialogState"]))) (letvar451094 "slotToElicit") (clojure.core/assoc :slot-to-elicit (deser-string (clojure.core/get-in letvar451094 ["slotToElicit"]))) (letvar451094 "responseCard") (clojure.core/assoc :response-card (deser-response-card (clojure.core/get-in letvar451094 ["responseCard"])))))))

(clojure.core/defn- response-post-content-response ([input] (response-post-content-response nil input)) ([resultWrapper451096 input] (clojure.core/let [rawinput451095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar451097 {"x-amz-lex-slots" (clojure.core/get-in input [:headers "x-amz-lex-slots"]), "audioStream" (rawinput451095 "audioStream"), "x-amz-lex-intent-name" (clojure.core/get-in input [:headers "x-amz-lex-intent-name"]), "x-amz-lex-session-attributes" (clojure.core/get-in input [:headers "x-amz-lex-session-attributes"]), "x-amz-lex-slot-to-elicit" (clojure.core/get-in input [:headers "x-amz-lex-slot-to-elicit"]), "x-amz-lex-message-format" (clojure.core/get-in input [:headers "x-amz-lex-message-format"]), "x-amz-lex-message" (clojure.core/get-in input [:headers "x-amz-lex-message"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amz-lex-dialog-state" (clojure.core/get-in input [:headers "x-amz-lex-dialog-state"]), "x-amz-lex-input-transcript" (clojure.core/get-in input [:headers "x-amz-lex-input-transcript"])}] (clojure.core/cond-> {} (letvar451097 "x-amz-lex-message") (clojure.core/assoc :message (deser-text (clojure.core/get-in letvar451097 ["x-amz-lex-message"]))) (letvar451097 "x-amz-lex-slot-to-elicit") (clojure.core/assoc :slot-to-elicit (deser-string (clojure.core/get-in letvar451097 ["x-amz-lex-slot-to-elicit"]))) (letvar451097 "x-amz-lex-slots") (clojure.core/assoc :slots (deser-string (clojure.core/get-in letvar451097 ["x-amz-lex-slots"]))) (letvar451097 "audioStream") (clojure.core/assoc :audio-stream (deser-blob-stream (clojure.core/get-in letvar451097 ["audioStream"]))) (letvar451097 "x-amz-lex-intent-name") (clojure.core/assoc :intent-name (deser-intent-name (clojure.core/get-in letvar451097 ["x-amz-lex-intent-name"]))) (letvar451097 "x-amz-lex-message-format") (clojure.core/assoc :message-format (deser-message-format-type (clojure.core/get-in letvar451097 ["x-amz-lex-message-format"]))) (letvar451097 "x-amz-lex-input-transcript") (clojure.core/assoc :input-transcript (deser-string (clojure.core/get-in letvar451097 ["x-amz-lex-input-transcript"]))) (letvar451097 "Content-Type") (clojure.core/assoc :content-type (deser-http-content-type (clojure.core/get-in letvar451097 ["Content-Type"]))) (letvar451097 "x-amz-lex-dialog-state") (clojure.core/assoc :dialog-state (deser-dialog-state (clojure.core/get-in letvar451097 ["x-amz-lex-dialog-state"]))) (letvar451097 "x-amz-lex-session-attributes") (clojure.core/assoc :session-attributes (deser-string (clojure.core/get-in letvar451097 ["x-amz-lex-session-attributes"])))))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 80))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 2 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[0-9a-zA-Z._:-]+" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/string-url-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/button-text-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 15))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/http-content-type (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/button-value-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/text (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
