...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/unsupported-media-type-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.unsupported-media-type-exception/message]))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 80))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/bad-request-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.bad-request-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/button (portkey.aws/json-keys :req-un [:portkey.aws.runtime-lex.button/text :portkey.aws.runtime-lex.button/value] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/generic-attachment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.generic-attachment/title :portkey.aws.runtime-lex.generic-attachment/subTitle :portkey.aws.runtime-lex.generic-attachment/attachmentLinkUrl :portkey.aws.runtime-lex.generic-attachment/imageUrl :portkey.aws.runtime-lex.generic-attachment/buttons]))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/bot-alias (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 2 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 100)) (clojure.core/fn [s__8151__auto__] (clojure.core/re-matches #"[0-9a-zA-Z._:-]+" s__8151__auto__))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/string-url-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/limit-exceeded-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.limit-exceeded-exception/retryAfterSeconds :portkey.aws.runtime-lex.limit-exceeded-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/response-card (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.response-card/version :portkey.aws.runtime-lex.response-card/contentType :portkey.aws.runtime-lex.response-card/genericAttachments]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/loop-detected-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.loop-detected-exception/Message]))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/error-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/dialog-state (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"Fulfilled" "Fulfilled", "Failed" "Failed", "ConfirmIntent" "ConfirmIntent", "ReadyForFulfillment" "ReadyForFulfillment", :elicit-slot "ElicitSlot", :elicit-intent "ElicitIntent", "ElicitSlot" "ElicitSlot", "ElicitIntent" "ElicitIntent", :fulfilled "Fulfilled", :confirm-intent "ConfirmIntent", :ready-for-fulfillment "ReadyForFulfillment", :failed "Failed"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/content-type (clojure.spec.alpha/conformer (clojure.core/let [m__8147__auto__ {"application/vnd.amazonaws.card.generic" "application/vnd.amazonaws.card.generic", :application/vnd.amazonaws.card.generic "application/vnd.amazonaws.card.generic"}] (clojure.core/fn [s__8148__auto__] (m__8147__auto__ s__8148__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/internal-failure-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.internal-failure-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/conflict-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.conflict-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/not-found-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.not-found-exception/message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/dependency-failed-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.dependency-failed-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/request-timeout-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.request-timeout-exception/message]))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/button-text-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 15))))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/http-content-type (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/button-value-string-with-length (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/not-acceptable-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.not-acceptable-exception/message]))

(clojure.spec.alpha/def :portkey.aws.runtime-lex/text (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/bad-gateway-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.bad-gateway-exception/Message]))
...
(clojure.spec.alpha/def :portkey.aws.runtime-lex/post-text-response (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.runtime-lex.post-text-response/intentName :portkey.aws.runtime-lex.post-text-response/slots :portkey.aws.runtime-lex.post-text-response/sessionAttributes :portkey.aws.runtime-lex.post-text-response/message :portkey.aws.runtime-lex.post-text-response/dialogState :portkey.aws.runtime-lex.post-text-response/slotToElicit :portkey.aws.runtime-lex.post-text-response/responseCard]))
