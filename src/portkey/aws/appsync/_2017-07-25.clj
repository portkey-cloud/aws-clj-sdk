...
(clojure.core/defn- response-list-graphql-apis-response ([input] (response-list-graphql-apis-response nil input)) ([resultWrapper1055077 input] (clojure.core/let [rawinput1055076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055078 {"graphqlApis" (rawinput1055076 "graphqlApis"), "nextToken" (rawinput1055076 "nextToken")}] (clojure.core/cond-> {} (letvar1055078 "graphqlApis") (clojure.core/assoc :graphql-apis (deser-graphql-apis (clojure.core/get-in letvar1055078 ["graphqlApis"]))) (letvar1055078 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055078 ["nextToken"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1055080 input] (clojure.core/let [rawinput1055079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055081 {"message" (rawinput1055079 "message")}] (clojure.core/cond-> {} (letvar1055081 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055081 ["message"])))))))

(clojure.core/defn- response-delete-type-response ([input] (response-delete-type-response nil input)) ([resultWrapper1055083 input] (clojure.core/let [rawinput1055082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055084 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-graphql-api-response ([input] (response-delete-graphql-api-response nil input)) ([resultWrapper1055086 input] (clojure.core/let [rawinput1055085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055087 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1055089 input] (clojure.core/let [rawinput1055088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055090 {"message" (rawinput1055088 "message")}] (clojure.core/cond-> {} (letvar1055090 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1055090 ["message"])))))))

(clojure.core/defn- response-update-function-response ([input] (response-update-function-response nil input)) ([resultWrapper1055092 input] (clojure.core/let [rawinput1055091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055093 {"functionConfiguration" (rawinput1055091 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1055093 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1055093 ["functionConfiguration"])))))))

(clojure.core/defn- response-api-limit-exceeded-exception ([input] (response-api-limit-exceeded-exception nil input)) ([resultWrapper1055095 input] (clojure.core/let [rawinput1055094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055096 {"message" (rawinput1055094 "message")}] (clojure.core/cond-> {} (letvar1055096 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055096 ["message"])))))))

(clojure.core/defn- response-create-function-response ([input] (response-create-function-response nil input)) ([resultWrapper1055098 input] (clojure.core/let [rawinput1055097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055099 {"functionConfiguration" (rawinput1055097 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1055099 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1055099 ["functionConfiguration"])))))))

(clojure.core/defn- response-list-resolvers-by-function-response ([input] (response-list-resolvers-by-function-response nil input)) ([resultWrapper1055101 input] (clojure.core/let [rawinput1055100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055102 {"resolvers" (rawinput1055100 "resolvers"), "nextToken" (rawinput1055100 "nextToken")}] (clojure.core/cond-> {} (letvar1055102 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar1055102 ["resolvers"]))) (letvar1055102 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055102 ["nextToken"])))))))

(clojure.core/defn- response-update-resolver-response ([input] (response-update-resolver-response nil input)) ([resultWrapper1055104 input] (clojure.core/let [rawinput1055103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055105 {"resolver" (rawinput1055103 "resolver")}] (clojure.core/cond-> {} (letvar1055105 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1055105 ["resolver"])))))))

(clojure.core/defn- response-list-api-keys-response ([input] (response-list-api-keys-response nil input)) ([resultWrapper1055107 input] (clojure.core/let [rawinput1055106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055108 {"apiKeys" (rawinput1055106 "apiKeys"), "nextToken" (rawinput1055106 "nextToken")}] (clojure.core/cond-> {} (letvar1055108 "apiKeys") (clojure.core/assoc :api-keys (deser-api-keys (clojure.core/get-in letvar1055108 ["apiKeys"]))) (letvar1055108 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055108 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1055110 input] (clojure.core/let [rawinput1055109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055111 {"message" (rawinput1055109 "message")}] (clojure.core/cond-> {} (letvar1055111 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055111 ["message"])))))))

(clojure.core/defn- response-list-types-response ([input] (response-list-types-response nil input)) ([resultWrapper1055113 input] (clojure.core/let [rawinput1055112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055114 {"types" (rawinput1055112 "types"), "nextToken" (rawinput1055112 "nextToken")}] (clojure.core/cond-> {} (letvar1055114 "types") (clojure.core/assoc :types (deser-type-list (clojure.core/get-in letvar1055114 ["types"]))) (letvar1055114 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055114 ["nextToken"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1055116 input] (clojure.core/let [rawinput1055115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055117 {"functions" (rawinput1055115 "functions"), "nextToken" (rawinput1055115 "nextToken")}] (clojure.core/cond-> {} (letvar1055117 "functions") (clojure.core/assoc :functions (deser-functions (clojure.core/get-in letvar1055117 ["functions"]))) (letvar1055117 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055117 ["nextToken"])))))))

(clojure.core/defn- response-delete-resolver-response ([input] (response-delete-resolver-response nil input)) ([resultWrapper1055119 input] (clojure.core/let [rawinput1055118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055120 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resolvers-response ([input] (response-list-resolvers-response nil input)) ([resultWrapper1055122 input] (clojure.core/let [rawinput1055121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055123 {"resolvers" (rawinput1055121 "resolvers"), "nextToken" (rawinput1055121 "nextToken")}] (clojure.core/cond-> {} (letvar1055123 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar1055123 ["resolvers"]))) (letvar1055123 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055123 ["nextToken"])))))))

(clojure.core/defn- response-graph-ql-schema-exception ([input] (response-graph-ql-schema-exception nil input)) ([resultWrapper1055125 input] (clojure.core/let [rawinput1055124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055126 {"message" (rawinput1055124 "message")}] (clojure.core/cond-> {} (letvar1055126 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1055126 ["message"])))))))

(clojure.core/defn- response-create-data-source-response ([input] (response-create-data-source-response nil input)) ([resultWrapper1055128 input] (clojure.core/let [rawinput1055127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055129 {"dataSource" (rawinput1055127 "dataSource")}] (clojure.core/cond-> {} (letvar1055129 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1055129 ["dataSource"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1055131 input] (clojure.core/let [rawinput1055130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055132 {"functionConfiguration" (rawinput1055130 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1055132 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1055132 ["functionConfiguration"])))))))

(clojure.core/defn- response-create-api-key-response ([input] (response-create-api-key-response nil input)) ([resultWrapper1055134 input] (clojure.core/let [rawinput1055133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055135 {"apiKey" (rawinput1055133 "apiKey")}] (clojure.core/cond-> {} (letvar1055135 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar1055135 ["apiKey"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1055137 input] (clojure.core/let [rawinput1055136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055138 {"message" (rawinput1055136 "message")}] (clojure.core/cond-> {} (letvar1055138 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055138 ["message"])))))))

(clojure.core/defn- response-delete-api-key-response ([input] (response-delete-api-key-response nil input)) ([resultWrapper1055140 input] (clojure.core/let [rawinput1055139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055141 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-function-response ([input] (response-delete-function-response nil input)) ([resultWrapper1055143 input] (clojure.core/let [rawinput1055142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055144 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-data-source-response ([input] (response-update-data-source-response nil input)) ([resultWrapper1055146 input] (clojure.core/let [rawinput1055145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055147 {"dataSource" (rawinput1055145 "dataSource")}] (clojure.core/cond-> {} (letvar1055147 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1055147 ["dataSource"])))))))

(clojure.core/defn- response-get-introspection-schema-response ([input] (response-get-introspection-schema-response nil input)) ([resultWrapper1055149 input] (clojure.core/let [rawinput1055148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055150 {"schema" (rawinput1055148 "schema")}] (clojure.core/cond-> {} (letvar1055150 "schema") (clojure.core/assoc :schema (deser-blob (clojure.core/get-in letvar1055150 ["schema"])))))))

(clojure.core/defn- response-get-graphql-api-response ([input] (response-get-graphql-api-response nil input)) ([resultWrapper1055152 input] (clojure.core/let [rawinput1055151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055153 {"graphqlApi" (rawinput1055151 "graphqlApi")}] (clojure.core/cond-> {} (letvar1055153 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1055153 ["graphqlApi"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1055155 input] (clojure.core/let [rawinput1055154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055156 {"message" (rawinput1055154 "message")}] (clojure.core/cond-> {} (letvar1055156 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055156 ["message"])))))))

(clojure.core/defn- response-update-api-key-response ([input] (response-update-api-key-response nil input)) ([resultWrapper1055158 input] (clojure.core/let [rawinput1055157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055159 {"apiKey" (rawinput1055157 "apiKey")}] (clojure.core/cond-> {} (letvar1055159 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar1055159 ["apiKey"])))))))

(clojure.core/defn- response-api-key-limit-exceeded-exception ([input] (response-api-key-limit-exceeded-exception nil input)) ([resultWrapper1055161 input] (clojure.core/let [rawinput1055160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055162 {"message" (rawinput1055160 "message")}] (clojure.core/cond-> {} (letvar1055162 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055162 ["message"])))))))

(clojure.core/defn- response-get-resolver-response ([input] (response-get-resolver-response nil input)) ([resultWrapper1055164 input] (clojure.core/let [rawinput1055163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055165 {"resolver" (rawinput1055163 "resolver")}] (clojure.core/cond-> {} (letvar1055165 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1055165 ["resolver"])))))))

(clojure.core/defn- response-start-schema-creation-response ([input] (response-start-schema-creation-response nil input)) ([resultWrapper1055167 input] (clojure.core/let [rawinput1055166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055168 {"status" (rawinput1055166 "status")}] (clojure.core/cond-> {} (letvar1055168 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar1055168 ["status"])))))))

(clojure.core/defn- response-create-graphql-api-response ([input] (response-create-graphql-api-response nil input)) ([resultWrapper1055170 input] (clojure.core/let [rawinput1055169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055171 {"graphqlApi" (rawinput1055169 "graphqlApi")}] (clojure.core/cond-> {} (letvar1055171 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1055171 ["graphqlApi"])))))))

(clojure.core/defn- response-create-resolver-response ([input] (response-create-resolver-response nil input)) ([resultWrapper1055173 input] (clojure.core/let [rawinput1055172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055174 {"resolver" (rawinput1055172 "resolver")}] (clojure.core/cond-> {} (letvar1055174 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1055174 ["resolver"])))))))

(clojure.core/defn- response-create-type-response ([input] (response-create-type-response nil input)) ([resultWrapper1055176 input] (clojure.core/let [rawinput1055175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055177 {"type" (rawinput1055175 "type")}] (clojure.core/cond-> {} (letvar1055177 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1055177 ["type"])))))))

(clojure.core/defn- response-delete-data-source-response ([input] (response-delete-data-source-response nil input)) ([resultWrapper1055179 input] (clojure.core/let [rawinput1055178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055180 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-api-key-validity-out-of-bounds-exception ([input] (response-api-key-validity-out-of-bounds-exception nil input)) ([resultWrapper1055182 input] (clojure.core/let [rawinput1055181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055183 {"message" (rawinput1055181 "message")}] (clojure.core/cond-> {} (letvar1055183 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1055183 ["message"])))))))

(clojure.core/defn- response-list-data-sources-response ([input] (response-list-data-sources-response nil input)) ([resultWrapper1055185 input] (clojure.core/let [rawinput1055184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055186 {"dataSources" (rawinput1055184 "dataSources"), "nextToken" (rawinput1055184 "nextToken")}] (clojure.core/cond-> {} (letvar1055186 "dataSources") (clojure.core/assoc :data-sources (deser-data-sources (clojure.core/get-in letvar1055186 ["dataSources"]))) (letvar1055186 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1055186 ["nextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1055188 input] (clojure.core/let [rawinput1055187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055189 {"message" (rawinput1055187 "message")}] (clojure.core/cond-> {} (letvar1055189 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1055189 ["message"])))))))

(clojure.core/defn- response-get-schema-creation-status-response ([input] (response-get-schema-creation-status-response nil input)) ([resultWrapper1055191 input] (clojure.core/let [rawinput1055190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055192 {"status" (rawinput1055190 "status"), "details" (rawinput1055190 "details")}] (clojure.core/cond-> {} (letvar1055192 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar1055192 ["status"]))) (letvar1055192 "details") (clojure.core/assoc :details (deser-string (clojure.core/get-in letvar1055192 ["details"])))))))

(clojure.core/defn- response-get-data-source-response ([input] (response-get-data-source-response nil input)) ([resultWrapper1055194 input] (clojure.core/let [rawinput1055193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055195 {"dataSource" (rawinput1055193 "dataSource")}] (clojure.core/cond-> {} (letvar1055195 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1055195 ["dataSource"])))))))

(clojure.core/defn- response-update-type-response ([input] (response-update-type-response nil input)) ([resultWrapper1055197 input] (clojure.core/let [rawinput1055196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055198 {"type" (rawinput1055196 "type")}] (clojure.core/cond-> {} (letvar1055198 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1055198 ["type"])))))))

(clojure.core/defn- response-get-type-response ([input] (response-get-type-response nil input)) ([resultWrapper1055200 input] (clojure.core/let [rawinput1055199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055201 {"type" (rawinput1055199 "type")}] (clojure.core/cond-> {} (letvar1055201 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1055201 ["type"])))))))

(clojure.core/defn- response-update-graphql-api-response ([input] (response-update-graphql-api-response nil input)) ([resultWrapper1055203 input] (clojure.core/let [rawinput1055202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1055204 {"graphqlApi" (rawinput1055202 "graphqlApi")}] (clojure.core/cond-> {} (letvar1055204 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1055204 ["graphqlApi"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\\S]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[_A-Za-z][_0-9A-Za-z]*" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/mapping-template (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 65536))))
