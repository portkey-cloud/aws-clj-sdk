...
(clojure.core/defn- response-list-graphql-apis-response ([input] (response-list-graphql-apis-response nil input)) ([resultWrapper107307 input] (clojure.core/let [rawinput107306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107308 {"graphqlApis" (rawinput107306 "graphqlApis"), "nextToken" (rawinput107306 "nextToken")}] (clojure.core/cond-> {} (letvar107308 "graphqlApis") (clojure.core/assoc :graphql-apis (deser-graphql-apis (clojure.core/get-in letvar107308 ["graphqlApis"]))) (letvar107308 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107308 ["nextToken"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper107310 input] (clojure.core/let [rawinput107309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107311 {"message" (rawinput107309 "message")}] (clojure.core/cond-> {} (letvar107311 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107311 ["message"])))))))

(clojure.core/defn- response-delete-type-response ([input] (response-delete-type-response nil input)) ([resultWrapper107313 input] (clojure.core/let [rawinput107312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107314 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-graphql-api-response ([input] (response-delete-graphql-api-response nil input)) ([resultWrapper107316 input] (clojure.core/let [rawinput107315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107317 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper107319 input] (clojure.core/let [rawinput107318 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107320 {"message" (rawinput107318 "message")}] (clojure.core/cond-> {} (letvar107320 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar107320 ["message"])))))))

(clojure.core/defn- response-update-function-response ([input] (response-update-function-response nil input)) ([resultWrapper107322 input] (clojure.core/let [rawinput107321 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107323 {"functionConfiguration" (rawinput107321 "functionConfiguration")}] (clojure.core/cond-> {} (letvar107323 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar107323 ["functionConfiguration"])))))))

(clojure.core/defn- response-api-limit-exceeded-exception ([input] (response-api-limit-exceeded-exception nil input)) ([resultWrapper107325 input] (clojure.core/let [rawinput107324 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107326 {"message" (rawinput107324 "message")}] (clojure.core/cond-> {} (letvar107326 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107326 ["message"])))))))

(clojure.core/defn- response-create-function-response ([input] (response-create-function-response nil input)) ([resultWrapper107328 input] (clojure.core/let [rawinput107327 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107329 {"functionConfiguration" (rawinput107327 "functionConfiguration")}] (clojure.core/cond-> {} (letvar107329 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar107329 ["functionConfiguration"])))))))

(clojure.core/defn- response-list-resolvers-by-function-response ([input] (response-list-resolvers-by-function-response nil input)) ([resultWrapper107331 input] (clojure.core/let [rawinput107330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107332 {"resolvers" (rawinput107330 "resolvers"), "nextToken" (rawinput107330 "nextToken")}] (clojure.core/cond-> {} (letvar107332 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar107332 ["resolvers"]))) (letvar107332 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107332 ["nextToken"])))))))

(clojure.core/defn- response-update-resolver-response ([input] (response-update-resolver-response nil input)) ([resultWrapper107334 input] (clojure.core/let [rawinput107333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107335 {"resolver" (rawinput107333 "resolver")}] (clojure.core/cond-> {} (letvar107335 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar107335 ["resolver"])))))))

(clojure.core/defn- response-list-api-keys-response ([input] (response-list-api-keys-response nil input)) ([resultWrapper107337 input] (clojure.core/let [rawinput107336 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107338 {"apiKeys" (rawinput107336 "apiKeys"), "nextToken" (rawinput107336 "nextToken")}] (clojure.core/cond-> {} (letvar107338 "apiKeys") (clojure.core/assoc :api-keys (deser-api-keys (clojure.core/get-in letvar107338 ["apiKeys"]))) (letvar107338 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107338 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper107340 input] (clojure.core/let [rawinput107339 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107341 {"message" (rawinput107339 "message")}] (clojure.core/cond-> {} (letvar107341 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107341 ["message"])))))))

(clojure.core/defn- response-list-types-response ([input] (response-list-types-response nil input)) ([resultWrapper107343 input] (clojure.core/let [rawinput107342 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107344 {"types" (rawinput107342 "types"), "nextToken" (rawinput107342 "nextToken")}] (clojure.core/cond-> {} (letvar107344 "types") (clojure.core/assoc :types (deser-type-list (clojure.core/get-in letvar107344 ["types"]))) (letvar107344 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107344 ["nextToken"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper107346 input] (clojure.core/let [rawinput107345 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107347 {"functions" (rawinput107345 "functions"), "nextToken" (rawinput107345 "nextToken")}] (clojure.core/cond-> {} (letvar107347 "functions") (clojure.core/assoc :functions (deser-functions (clojure.core/get-in letvar107347 ["functions"]))) (letvar107347 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107347 ["nextToken"])))))))

(clojure.core/defn- response-delete-resolver-response ([input] (response-delete-resolver-response nil input)) ([resultWrapper107349 input] (clojure.core/let [rawinput107348 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107350 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resolvers-response ([input] (response-list-resolvers-response nil input)) ([resultWrapper107352 input] (clojure.core/let [rawinput107351 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107353 {"resolvers" (rawinput107351 "resolvers"), "nextToken" (rawinput107351 "nextToken")}] (clojure.core/cond-> {} (letvar107353 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar107353 ["resolvers"]))) (letvar107353 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107353 ["nextToken"])))))))

(clojure.core/defn- response-graph-ql-schema-exception ([input] (response-graph-ql-schema-exception nil input)) ([resultWrapper107355 input] (clojure.core/let [rawinput107354 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107356 {"message" (rawinput107354 "message")}] (clojure.core/cond-> {} (letvar107356 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar107356 ["message"])))))))

(clojure.core/defn- response-create-data-source-response ([input] (response-create-data-source-response nil input)) ([resultWrapper107358 input] (clojure.core/let [rawinput107357 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107359 {"dataSource" (rawinput107357 "dataSource")}] (clojure.core/cond-> {} (letvar107359 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar107359 ["dataSource"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper107361 input] (clojure.core/let [rawinput107360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107362 {"functionConfiguration" (rawinput107360 "functionConfiguration")}] (clojure.core/cond-> {} (letvar107362 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar107362 ["functionConfiguration"])))))))

(clojure.core/defn- response-create-api-key-response ([input] (response-create-api-key-response nil input)) ([resultWrapper107364 input] (clojure.core/let [rawinput107363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107365 {"apiKey" (rawinput107363 "apiKey")}] (clojure.core/cond-> {} (letvar107365 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar107365 ["apiKey"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper107367 input] (clojure.core/let [rawinput107366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107368 {"message" (rawinput107366 "message")}] (clojure.core/cond-> {} (letvar107368 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107368 ["message"])))))))

(clojure.core/defn- response-delete-api-key-response ([input] (response-delete-api-key-response nil input)) ([resultWrapper107370 input] (clojure.core/let [rawinput107369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107371 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-function-response ([input] (response-delete-function-response nil input)) ([resultWrapper107373 input] (clojure.core/let [rawinput107372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107374 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-data-source-response ([input] (response-update-data-source-response nil input)) ([resultWrapper107376 input] (clojure.core/let [rawinput107375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107377 {"dataSource" (rawinput107375 "dataSource")}] (clojure.core/cond-> {} (letvar107377 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar107377 ["dataSource"])))))))

(clojure.core/defn- response-get-introspection-schema-response ([input] (response-get-introspection-schema-response nil input)) ([resultWrapper107379 input] (clojure.core/let [rawinput107378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107380 {"schema" (rawinput107378 "schema")}] (clojure.core/cond-> {} (letvar107380 "schema") (clojure.core/assoc :schema (deser-blob (clojure.core/get-in letvar107380 ["schema"])))))))

(clojure.core/defn- response-get-graphql-api-response ([input] (response-get-graphql-api-response nil input)) ([resultWrapper107382 input] (clojure.core/let [rawinput107381 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107383 {"graphqlApi" (rawinput107381 "graphqlApi")}] (clojure.core/cond-> {} (letvar107383 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar107383 ["graphqlApi"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper107385 input] (clojure.core/let [rawinput107384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107386 {"message" (rawinput107384 "message")}] (clojure.core/cond-> {} (letvar107386 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107386 ["message"])))))))

(clojure.core/defn- response-update-api-key-response ([input] (response-update-api-key-response nil input)) ([resultWrapper107388 input] (clojure.core/let [rawinput107387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107389 {"apiKey" (rawinput107387 "apiKey")}] (clojure.core/cond-> {} (letvar107389 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar107389 ["apiKey"])))))))

(clojure.core/defn- response-api-key-limit-exceeded-exception ([input] (response-api-key-limit-exceeded-exception nil input)) ([resultWrapper107391 input] (clojure.core/let [rawinput107390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107392 {"message" (rawinput107390 "message")}] (clojure.core/cond-> {} (letvar107392 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107392 ["message"])))))))

(clojure.core/defn- response-get-resolver-response ([input] (response-get-resolver-response nil input)) ([resultWrapper107394 input] (clojure.core/let [rawinput107393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107395 {"resolver" (rawinput107393 "resolver")}] (clojure.core/cond-> {} (letvar107395 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar107395 ["resolver"])))))))

(clojure.core/defn- response-start-schema-creation-response ([input] (response-start-schema-creation-response nil input)) ([resultWrapper107397 input] (clojure.core/let [rawinput107396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107398 {"status" (rawinput107396 "status")}] (clojure.core/cond-> {} (letvar107398 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar107398 ["status"])))))))

(clojure.core/defn- response-create-graphql-api-response ([input] (response-create-graphql-api-response nil input)) ([resultWrapper107400 input] (clojure.core/let [rawinput107399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107401 {"graphqlApi" (rawinput107399 "graphqlApi")}] (clojure.core/cond-> {} (letvar107401 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar107401 ["graphqlApi"])))))))

(clojure.core/defn- response-create-resolver-response ([input] (response-create-resolver-response nil input)) ([resultWrapper107403 input] (clojure.core/let [rawinput107402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107404 {"resolver" (rawinput107402 "resolver")}] (clojure.core/cond-> {} (letvar107404 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar107404 ["resolver"])))))))

(clojure.core/defn- response-create-type-response ([input] (response-create-type-response nil input)) ([resultWrapper107406 input] (clojure.core/let [rawinput107405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107407 {"type" (rawinput107405 "type")}] (clojure.core/cond-> {} (letvar107407 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar107407 ["type"])))))))

(clojure.core/defn- response-delete-data-source-response ([input] (response-delete-data-source-response nil input)) ([resultWrapper107409 input] (clojure.core/let [rawinput107408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107410 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-api-key-validity-out-of-bounds-exception ([input] (response-api-key-validity-out-of-bounds-exception nil input)) ([resultWrapper107412 input] (clojure.core/let [rawinput107411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107413 {"message" (rawinput107411 "message")}] (clojure.core/cond-> {} (letvar107413 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar107413 ["message"])))))))

(clojure.core/defn- response-list-data-sources-response ([input] (response-list-data-sources-response nil input)) ([resultWrapper107415 input] (clojure.core/let [rawinput107414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107416 {"dataSources" (rawinput107414 "dataSources"), "nextToken" (rawinput107414 "nextToken")}] (clojure.core/cond-> {} (letvar107416 "dataSources") (clojure.core/assoc :data-sources (deser-data-sources (clojure.core/get-in letvar107416 ["dataSources"]))) (letvar107416 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar107416 ["nextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper107418 input] (clojure.core/let [rawinput107417 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107419 {"message" (rawinput107417 "message")}] (clojure.core/cond-> {} (letvar107419 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar107419 ["message"])))))))

(clojure.core/defn- response-get-schema-creation-status-response ([input] (response-get-schema-creation-status-response nil input)) ([resultWrapper107421 input] (clojure.core/let [rawinput107420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107422 {"status" (rawinput107420 "status"), "details" (rawinput107420 "details")}] (clojure.core/cond-> {} (letvar107422 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar107422 ["status"]))) (letvar107422 "details") (clojure.core/assoc :details (deser-string (clojure.core/get-in letvar107422 ["details"])))))))

(clojure.core/defn- response-get-data-source-response ([input] (response-get-data-source-response nil input)) ([resultWrapper107424 input] (clojure.core/let [rawinput107423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107425 {"dataSource" (rawinput107423 "dataSource")}] (clojure.core/cond-> {} (letvar107425 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar107425 ["dataSource"])))))))

(clojure.core/defn- response-update-type-response ([input] (response-update-type-response nil input)) ([resultWrapper107427 input] (clojure.core/let [rawinput107426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107428 {"type" (rawinput107426 "type")}] (clojure.core/cond-> {} (letvar107428 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar107428 ["type"])))))))

(clojure.core/defn- response-get-type-response ([input] (response-get-type-response nil input)) ([resultWrapper107430 input] (clojure.core/let [rawinput107429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107431 {"type" (rawinput107429 "type")}] (clojure.core/cond-> {} (letvar107431 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar107431 ["type"])))))))

(clojure.core/defn- response-update-graphql-api-response ([input] (response-update-graphql-api-response nil input)) ([resultWrapper107433 input] (clojure.core/let [rawinput107432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar107434 {"graphqlApi" (rawinput107432 "graphqlApi")}] (clojure.core/cond-> {} (letvar107434 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar107434 ["graphqlApi"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\\S]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[_A-Za-z][_0-9A-Za-z]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync.-2017-07-25/mapping-template (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 65536))))
