...
(clojure.core/defn- response-describe-refresh-schemas-status-response ([input] (response-describe-refresh-schemas-status-response nil input)) ([resultWrapper550138 input] (clojure.core/let [rawinput550137 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550139 {"RefreshSchemasStatus" (rawinput550137 "RefreshSchemasStatus")}] (clojure.core/cond-> {} (letvar550139 "RefreshSchemasStatus") (clojure.core/assoc :refresh-schemas-status (deser-refresh-schemas-status (clojure.core/get-in letvar550139 ["RefreshSchemasStatus"])))))))

(clojure.core/defn- response-describe-connections-response ([input] (response-describe-connections-response nil input)) ([resultWrapper550141 input] (clojure.core/let [rawinput550140 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550142 {"Marker" (rawinput550140 "Marker"), "Connections" (rawinput550140 "Connections")}] (clojure.core/cond-> {} (letvar550142 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550142 ["Marker"]))) (letvar550142 "Connections") (clojure.core/assoc :connections (deser-connection-list (clojure.core/get-in letvar550142 ["Connections"])))))))

(clojure.core/defn- response-stop-replication-task-response ([input] (response-stop-replication-task-response nil input)) ([resultWrapper550144 input] (clojure.core/let [rawinput550143 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550145 {"ReplicationTask" (rawinput550143 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550145 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550145 ["ReplicationTask"])))))))

(clojure.core/defn- response-create-replication-task-response ([input] (response-create-replication-task-response nil input)) ([resultWrapper550147 input] (clojure.core/let [rawinput550146 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550148 {"ReplicationTask" (rawinput550146 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550148 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550148 ["ReplicationTask"])))))))

(clojure.core/defn- response-describe-table-statistics-response ([input] (response-describe-table-statistics-response nil input)) ([resultWrapper550150 input] (clojure.core/let [rawinput550149 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550151 {"ReplicationTaskArn" (rawinput550149 "ReplicationTaskArn"), "TableStatistics" (rawinput550149 "TableStatistics"), "Marker" (rawinput550149 "Marker")}] (clojure.core/cond-> {} (letvar550151 "ReplicationTaskArn") (clojure.core/assoc :replication-task-arn (deser-string (clojure.core/get-in letvar550151 ["ReplicationTaskArn"]))) (letvar550151 "TableStatistics") (clojure.core/assoc :table-statistics (deser-table-statistics-list (clojure.core/get-in letvar550151 ["TableStatistics"]))) (letvar550151 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550151 ["Marker"])))))))

(clojure.core/defn- response-modify-endpoint-response ([input] (response-modify-endpoint-response nil input)) ([resultWrapper550153 input] (clojure.core/let [rawinput550152 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550154 {"Endpoint" (rawinput550152 "Endpoint")}] (clojure.core/cond-> {} (letvar550154 "Endpoint") (clojure.core/assoc :endpoint (deser-endpoint (clojure.core/get-in letvar550154 ["Endpoint"])))))))

(clojure.core/defn- response-start-replication-task-assessment-response ([input] (response-start-replication-task-assessment-response nil input)) ([resultWrapper550156 input] (clojure.core/let [rawinput550155 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550157 {"ReplicationTask" (rawinput550155 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550157 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550157 ["ReplicationTask"])))))))

(clojure.core/defn- response-insufficient-resource-capacity-fault ([input] (response-insufficient-resource-capacity-fault nil input)) ([resultWrapper550159 input] (clojure.core/let [rawinput550158 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550160 {"message" (rawinput550158 "message")}] (clojure.core/cond-> {} (letvar550160 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550160 ["message"])))))))

(clojure.core/defn- response-create-replication-subnet-group-response ([input] (response-create-replication-subnet-group-response nil input)) ([resultWrapper550162 input] (clojure.core/let [rawinput550161 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550163 {"ReplicationSubnetGroup" (rawinput550161 "ReplicationSubnetGroup")}] (clojure.core/cond-> {} (letvar550163 "ReplicationSubnetGroup") (clojure.core/assoc :replication-subnet-group (deser-replication-subnet-group (clojure.core/get-in letvar550163 ["ReplicationSubnetGroup"])))))))

(clojure.core/defn- response-sns-no-authorization-fault ([input] (response-sns-no-authorization-fault nil input)) ([resultWrapper550165 input] (clojure.core/let [rawinput550164 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550166 {"message" (rawinput550164 "message")}] (clojure.core/cond-> {} (letvar550166 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550166 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper550168 input] (clojure.core/let [rawinput550167 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550169 {"TagList" (rawinput550167 "TagList")}] (clojure.core/cond-> {} (letvar550169 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar550169 ["TagList"])))))))

(clojure.core/defn- response-describe-replication-instance-task-logs-response ([input] (response-describe-replication-instance-task-logs-response nil input)) ([resultWrapper550171 input] (clojure.core/let [rawinput550170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550172 {"ReplicationInstanceArn" (rawinput550170 "ReplicationInstanceArn"), "ReplicationInstanceTaskLogs" (rawinput550170 "ReplicationInstanceTaskLogs"), "Marker" (rawinput550170 "Marker")}] (clojure.core/cond-> {} (letvar550172 "ReplicationInstanceArn") (clojure.core/assoc :replication-instance-arn (deser-string (clojure.core/get-in letvar550172 ["ReplicationInstanceArn"]))) (letvar550172 "ReplicationInstanceTaskLogs") (clojure.core/assoc :replication-instance-task-logs (deser-replication-instance-task-logs-list (clojure.core/get-in letvar550172 ["ReplicationInstanceTaskLogs"]))) (letvar550172 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550172 ["Marker"])))))))

(clojure.core/defn- response-import-certificate-response ([input] (response-import-certificate-response nil input)) ([resultWrapper550174 input] (clojure.core/let [rawinput550173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550175 {"Certificate" (rawinput550173 "Certificate")}] (clojure.core/cond-> {} (letvar550175 "Certificate") (clojure.core/assoc :certificate (deser-certificate (clojure.core/get-in letvar550175 ["Certificate"])))))))

(clojure.core/defn- response-resource-already-exists-fault ([input] (response-resource-already-exists-fault nil input)) ([resultWrapper550177 input] (clojure.core/let [rawinput550176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550178 {"message" (rawinput550176 "message")}] (clojure.core/cond-> {} (letvar550178 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550178 ["message"])))))))

(clojure.core/defn- response-delete-replication-subnet-group-response ([input] (response-delete-replication-subnet-group-response nil input)) ([resultWrapper550180 input] (clojure.core/let [rawinput550179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550181 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-replication-instances-response ([input] (response-describe-replication-instances-response nil input)) ([resultWrapper550183 input] (clojure.core/let [rawinput550182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550184 {"Marker" (rawinput550182 "Marker"), "ReplicationInstances" (rawinput550182 "ReplicationInstances")}] (clojure.core/cond-> {} (letvar550184 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550184 ["Marker"]))) (letvar550184 "ReplicationInstances") (clojure.core/assoc :replication-instances (deser-replication-instance-list (clojure.core/get-in letvar550184 ["ReplicationInstances"])))))))

(clojure.core/defn- response-modify-replication-instance-response ([input] (response-modify-replication-instance-response nil input)) ([resultWrapper550186 input] (clojure.core/let [rawinput550185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550187 {"ReplicationInstance" (rawinput550185 "ReplicationInstance")}] (clojure.core/cond-> {} (letvar550187 "ReplicationInstance") (clojure.core/assoc :replication-instance (deser-replication-instance (clojure.core/get-in letvar550187 ["ReplicationInstance"])))))))

(clojure.core/defn- response-create-replication-instance-response ([input] (response-create-replication-instance-response nil input)) ([resultWrapper550189 input] (clojure.core/let [rawinput550188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550190 {"ReplicationInstance" (rawinput550188 "ReplicationInstance")}] (clojure.core/cond-> {} (letvar550190 "ReplicationInstance") (clojure.core/assoc :replication-instance (deser-replication-instance (clojure.core/get-in letvar550190 ["ReplicationInstance"])))))))

(clojure.core/defn- response-reload-tables-response ([input] (response-reload-tables-response nil input)) ([resultWrapper550192 input] (clojure.core/let [rawinput550191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550193 {"ReplicationTaskArn" (rawinput550191 "ReplicationTaskArn")}] (clojure.core/cond-> {} (letvar550193 "ReplicationTaskArn") (clojure.core/assoc :replication-task-arn (deser-string (clojure.core/get-in letvar550193 ["ReplicationTaskArn"])))))))

(clojure.core/defn- response-start-replication-task-response ([input] (response-start-replication-task-response nil input)) ([resultWrapper550195 input] (clojure.core/let [rawinput550194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550196 {"ReplicationTask" (rawinput550194 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550196 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550196 ["ReplicationTask"])))))))

(clojure.core/defn- response-create-endpoint-response ([input] (response-create-endpoint-response nil input)) ([resultWrapper550198 input] (clojure.core/let [rawinput550197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550199 {"Endpoint" (rawinput550197 "Endpoint")}] (clojure.core/cond-> {} (letvar550199 "Endpoint") (clojure.core/assoc :endpoint (deser-endpoint (clojure.core/get-in letvar550199 ["Endpoint"])))))))

(clojure.core/defn- response-delete-certificate-response ([input] (response-delete-certificate-response nil input)) ([resultWrapper550201 input] (clojure.core/let [rawinput550200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550202 {"Certificate" (rawinput550200 "Certificate")}] (clojure.core/cond-> {} (letvar550202 "Certificate") (clojure.core/assoc :certificate (deser-certificate (clojure.core/get-in letvar550202 ["Certificate"])))))))

(clojure.core/defn- response-delete-replication-task-response ([input] (response-delete-replication-task-response nil input)) ([resultWrapper550204 input] (clojure.core/let [rawinput550203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550205 {"ReplicationTask" (rawinput550203 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550205 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550205 ["ReplicationTask"])))))))

(clojure.core/defn- response-describe-replication-subnet-groups-response ([input] (response-describe-replication-subnet-groups-response nil input)) ([resultWrapper550207 input] (clojure.core/let [rawinput550206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550208 {"Marker" (rawinput550206 "Marker"), "ReplicationSubnetGroups" (rawinput550206 "ReplicationSubnetGroups")}] (clojure.core/cond-> {} (letvar550208 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550208 ["Marker"]))) (letvar550208 "ReplicationSubnetGroups") (clojure.core/assoc :replication-subnet-groups (deser-replication-subnet-groups (clojure.core/get-in letvar550208 ["ReplicationSubnetGroups"])))))))

(clojure.core/defn- response-replication-subnet-group-does-not-cover-enough-a-zs ([input] (response-replication-subnet-group-does-not-cover-enough-a-zs nil input)) ([resultWrapper550210 input] (clojure.core/let [rawinput550209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550211 {"message" (rawinput550209 "message")}] (clojure.core/cond-> {} (letvar550211 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550211 ["message"])))))))

(clojure.core/defn- response-reboot-replication-instance-response ([input] (response-reboot-replication-instance-response nil input)) ([resultWrapper550213 input] (clojure.core/let [rawinput550212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550214 {"ReplicationInstance" (rawinput550212 "ReplicationInstance")}] (clojure.core/cond-> {} (letvar550214 "ReplicationInstance") (clojure.core/assoc :replication-instance (deser-replication-instance (clojure.core/get-in letvar550214 ["ReplicationInstance"])))))))

(clojure.core/defn- response-delete-replication-instance-response ([input] (response-delete-replication-instance-response nil input)) ([resultWrapper550216 input] (clojure.core/let [rawinput550215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550217 {"ReplicationInstance" (rawinput550215 "ReplicationInstance")}] (clojure.core/cond-> {} (letvar550217 "ReplicationInstance") (clojure.core/assoc :replication-instance (deser-replication-instance (clojure.core/get-in letvar550217 ["ReplicationInstance"])))))))

(clojure.core/defn- response-subnet-already-in-use ([input] (response-subnet-already-in-use nil input)) ([resultWrapper550219 input] (clojure.core/let [rawinput550218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550220 {"message" (rawinput550218 "message")}] (clojure.core/cond-> {} (letvar550220 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550220 ["message"])))))))

(clojure.core/defn- response-invalid-subnet ([input] (response-invalid-subnet nil input)) ([resultWrapper550222 input] (clojure.core/let [rawinput550221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550223 {"message" (rawinput550221 "message")}] (clojure.core/cond-> {} (letvar550223 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550223 ["message"])))))))

(clojure.core/defn- response-create-event-subscription-response ([input] (response-create-event-subscription-response nil input)) ([resultWrapper550225 input] (clojure.core/let [rawinput550224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550226 {"EventSubscription" (rawinput550224 "EventSubscription")}] (clojure.core/cond-> {} (letvar550226 "EventSubscription") (clojure.core/assoc :event-subscription (deser-event-subscription (clojure.core/get-in letvar550226 ["EventSubscription"])))))))

(clojure.core/defn- response-invalid-certificate-fault ([input] (response-invalid-certificate-fault nil input)) ([resultWrapper550228 input] (clojure.core/let [rawinput550227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550229 {"message" (rawinput550227 "message")}] (clojure.core/cond-> {} (letvar550229 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550229 ["message"])))))))

(clojure.core/defn- response-describe-event-subscriptions-response ([input] (response-describe-event-subscriptions-response nil input)) ([resultWrapper550231 input] (clojure.core/let [rawinput550230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550232 {"Marker" (rawinput550230 "Marker"), "EventSubscriptionsList" (rawinput550230 "EventSubscriptionsList")}] (clojure.core/cond-> {} (letvar550232 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550232 ["Marker"]))) (letvar550232 "EventSubscriptionsList") (clojure.core/assoc :event-subscriptions-list (deser-event-subscriptions-list (clojure.core/get-in letvar550232 ["EventSubscriptionsList"])))))))

(clojure.core/defn- response-describe-endpoints-response ([input] (response-describe-endpoints-response nil input)) ([resultWrapper550234 input] (clojure.core/let [rawinput550233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550235 {"Marker" (rawinput550233 "Marker"), "Endpoints" (rawinput550233 "Endpoints")}] (clojure.core/cond-> {} (letvar550235 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550235 ["Marker"]))) (letvar550235 "Endpoints") (clojure.core/assoc :endpoints (deser-endpoint-list (clojure.core/get-in letvar550235 ["Endpoints"])))))))

(clojure.core/defn- response-describe-endpoint-types-response ([input] (response-describe-endpoint-types-response nil input)) ([resultWrapper550237 input] (clojure.core/let [rawinput550236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550238 {"Marker" (rawinput550236 "Marker"), "SupportedEndpointTypes" (rawinput550236 "SupportedEndpointTypes")}] (clojure.core/cond-> {} (letvar550238 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550238 ["Marker"]))) (letvar550238 "SupportedEndpointTypes") (clojure.core/assoc :supported-endpoint-types (deser-supported-endpoint-type-list (clojure.core/get-in letvar550238 ["SupportedEndpointTypes"])))))))

(clojure.core/defn- response-describe-replication-tasks-response ([input] (response-describe-replication-tasks-response nil input)) ([resultWrapper550240 input] (clojure.core/let [rawinput550239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550241 {"Marker" (rawinput550239 "Marker"), "ReplicationTasks" (rawinput550239 "ReplicationTasks")}] (clojure.core/cond-> {} (letvar550241 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550241 ["Marker"]))) (letvar550241 "ReplicationTasks") (clojure.core/assoc :replication-tasks (deser-replication-task-list (clojure.core/get-in letvar550241 ["ReplicationTasks"])))))))

(clojure.core/defn- response-delete-endpoint-response ([input] (response-delete-endpoint-response nil input)) ([resultWrapper550243 input] (clojure.core/let [rawinput550242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550244 {"Endpoint" (rawinput550242 "Endpoint")}] (clojure.core/cond-> {} (letvar550244 "Endpoint") (clojure.core/assoc :endpoint (deser-endpoint (clojure.core/get-in letvar550244 ["Endpoint"])))))))

(clojure.core/defn- response-modify-replication-task-response ([input] (response-modify-replication-task-response nil input)) ([resultWrapper550246 input] (clojure.core/let [rawinput550245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550247 {"ReplicationTask" (rawinput550245 "ReplicationTask")}] (clojure.core/cond-> {} (letvar550247 "ReplicationTask") (clojure.core/assoc :replication-task (deser-replication-task (clojure.core/get-in letvar550247 ["ReplicationTask"])))))))

(clojure.core/defn- response-resource-not-found-fault ([input] (response-resource-not-found-fault nil input)) ([resultWrapper550249 input] (clojure.core/let [rawinput550248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550250 {"message" (rawinput550248 "message")}] (clojure.core/cond-> {} (letvar550250 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550250 ["message"])))))))

(clojure.core/defn- response-add-tags-to-resource-response ([input] (response-add-tags-to-resource-response nil input)) ([resultWrapper550252 input] (clojure.core/let [rawinput550251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550253 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-fault ([input] (response-access-denied-fault nil input)) ([resultWrapper550255 input] (clojure.core/let [rawinput550254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550256 {"message" (rawinput550254 "message")}] (clojure.core/cond-> {} (letvar550256 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550256 ["message"])))))))

(clojure.core/defn- response-invalid-resource-state-fault ([input] (response-invalid-resource-state-fault nil input)) ([resultWrapper550258 input] (clojure.core/let [rawinput550257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550259 {"message" (rawinput550257 "message")}] (clojure.core/cond-> {} (letvar550259 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550259 ["message"])))))))

(clojure.core/defn- response-upgrade-dependency-failure-fault ([input] (response-upgrade-dependency-failure-fault nil input)) ([resultWrapper550261 input] (clojure.core/let [rawinput550260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550262 {"message" (rawinput550260 "message")}] (clojure.core/cond-> {} (letvar550262 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550262 ["message"])))))))

(clojure.core/defn- response-modify-event-subscription-response ([input] (response-modify-event-subscription-response nil input)) ([resultWrapper550264 input] (clojure.core/let [rawinput550263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550265 {"EventSubscription" (rawinput550263 "EventSubscription")}] (clojure.core/cond-> {} (letvar550265 "EventSubscription") (clojure.core/assoc :event-subscription (deser-event-subscription (clojure.core/get-in letvar550265 ["EventSubscription"])))))))

(clojure.core/defn- response-kms-key-not-accessible-fault ([input] (response-kms-key-not-accessible-fault nil input)) ([resultWrapper550267 input] (clojure.core/let [rawinput550266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550268 {"message" (rawinput550266 "message")}] (clojure.core/cond-> {} (letvar550268 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550268 ["message"])))))))

(clojure.core/defn- response-modify-replication-subnet-group-response ([input] (response-modify-replication-subnet-group-response nil input)) ([resultWrapper550270 input] (clojure.core/let [rawinput550269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550271 {"ReplicationSubnetGroup" (rawinput550269 "ReplicationSubnetGroup")}] (clojure.core/cond-> {} (letvar550271 "ReplicationSubnetGroup") (clojure.core/assoc :replication-subnet-group (deser-replication-subnet-group (clojure.core/get-in letvar550271 ["ReplicationSubnetGroup"])))))))

(clojure.core/defn- response-resource-quota-exceeded-fault ([input] (response-resource-quota-exceeded-fault nil input)) ([resultWrapper550273 input] (clojure.core/let [rawinput550272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550274 {"message" (rawinput550272 "message")}] (clojure.core/cond-> {} (letvar550274 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550274 ["message"])))))))

(clojure.core/defn- response-storage-quota-exceeded-fault ([input] (response-storage-quota-exceeded-fault nil input)) ([resultWrapper550276 input] (clojure.core/let [rawinput550275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550277 {"message" (rawinput550275 "message")}] (clojure.core/cond-> {} (letvar550277 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550277 ["message"])))))))

(clojure.core/defn- response-describe-replication-task-assessment-results-response ([input] (response-describe-replication-task-assessment-results-response nil input)) ([resultWrapper550279 input] (clojure.core/let [rawinput550278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550280 {"Marker" (rawinput550278 "Marker"), "BucketName" (rawinput550278 "BucketName"), "ReplicationTaskAssessmentResults" (rawinput550278 "ReplicationTaskAssessmentResults")}] (clojure.core/cond-> {} (letvar550280 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550280 ["Marker"]))) (letvar550280 "BucketName") (clojure.core/assoc :bucket-name (deser-string (clojure.core/get-in letvar550280 ["BucketName"]))) (letvar550280 "ReplicationTaskAssessmentResults") (clojure.core/assoc :replication-task-assessment-results (deser-replication-task-assessment-result-list (clojure.core/get-in letvar550280 ["ReplicationTaskAssessmentResults"])))))))

(clojure.core/defn- response-describe-account-attributes-response ([input] (response-describe-account-attributes-response nil input)) ([resultWrapper550282 input] (clojure.core/let [rawinput550281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550283 {"AccountQuotas" (rawinput550281 "AccountQuotas")}] (clojure.core/cond-> {} (letvar550283 "AccountQuotas") (clojure.core/assoc :account-quotas (deser-account-quota-list (clojure.core/get-in letvar550283 ["AccountQuotas"])))))))

(clojure.core/defn- response-remove-tags-from-resource-response ([input] (response-remove-tags-from-resource-response nil input)) ([resultWrapper550285 input] (clojure.core/let [rawinput550284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550286 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-refresh-schemas-response ([input] (response-refresh-schemas-response nil input)) ([resultWrapper550288 input] (clojure.core/let [rawinput550287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550289 {"RefreshSchemasStatus" (rawinput550287 "RefreshSchemasStatus")}] (clojure.core/cond-> {} (letvar550289 "RefreshSchemasStatus") (clojure.core/assoc :refresh-schemas-status (deser-refresh-schemas-status (clojure.core/get-in letvar550289 ["RefreshSchemasStatus"])))))))

(clojure.core/defn- response-describe-orderable-replication-instances-response ([input] (response-describe-orderable-replication-instances-response nil input)) ([resultWrapper550291 input] (clojure.core/let [rawinput550290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550292 {"OrderableReplicationInstances" (rawinput550290 "OrderableReplicationInstances"), "Marker" (rawinput550290 "Marker")}] (clojure.core/cond-> {} (letvar550292 "OrderableReplicationInstances") (clojure.core/assoc :orderable-replication-instances (deser-orderable-replication-instance-list (clojure.core/get-in letvar550292 ["OrderableReplicationInstances"]))) (letvar550292 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550292 ["Marker"])))))))

(clojure.core/defn- response-sns-invalid-topic-fault ([input] (response-sns-invalid-topic-fault nil input)) ([resultWrapper550294 input] (clojure.core/let [rawinput550293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550295 {"message" (rawinput550293 "message")}] (clojure.core/cond-> {} (letvar550295 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar550295 ["message"])))))))

(clojure.core/defn- response-delete-event-subscription-response ([input] (response-delete-event-subscription-response nil input)) ([resultWrapper550297 input] (clojure.core/let [rawinput550296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550298 {"EventSubscription" (rawinput550296 "EventSubscription")}] (clojure.core/cond-> {} (letvar550298 "EventSubscription") (clojure.core/assoc :event-subscription (deser-event-subscription (clojure.core/get-in letvar550298 ["EventSubscription"])))))))

(clojure.core/defn- response-describe-event-categories-response ([input] (response-describe-event-categories-response nil input)) ([resultWrapper550300 input] (clojure.core/let [rawinput550299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550301 {"EventCategoryGroupList" (rawinput550299 "EventCategoryGroupList")}] (clojure.core/cond-> {} (letvar550301 "EventCategoryGroupList") (clojure.core/assoc :event-category-group-list (deser-event-category-group-list (clojure.core/get-in letvar550301 ["EventCategoryGroupList"])))))))

(clojure.core/defn- response-test-connection-response ([input] (response-test-connection-response nil input)) ([resultWrapper550303 input] (clojure.core/let [rawinput550302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550304 {"Connection" (rawinput550302 "Connection")}] (clojure.core/cond-> {} (letvar550304 "Connection") (clojure.core/assoc :connection (deser-connection (clojure.core/get-in letvar550304 ["Connection"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper550306 input] (clojure.core/let [rawinput550305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550307 {"Marker" (rawinput550305 "Marker"), "Events" (rawinput550305 "Events")}] (clojure.core/cond-> {} (letvar550307 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550307 ["Marker"]))) (letvar550307 "Events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar550307 ["Events"])))))))

(clojure.core/defn- response-describe-schemas-response ([input] (response-describe-schemas-response nil input)) ([resultWrapper550309 input] (clojure.core/let [rawinput550308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550310 {"Marker" (rawinput550308 "Marker"), "Schemas" (rawinput550308 "Schemas")}] (clojure.core/cond-> {} (letvar550310 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550310 ["Marker"]))) (letvar550310 "Schemas") (clojure.core/assoc :schemas (deser-schema-list (clojure.core/get-in letvar550310 ["Schemas"])))))))

(clojure.core/defn- response-describe-certificates-response ([input] (response-describe-certificates-response nil input)) ([resultWrapper550312 input] (clojure.core/let [rawinput550311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar550313 {"Marker" (rawinput550311 "Marker"), "Certificates" (rawinput550311 "Certificates")}] (clojure.core/cond-> {} (letvar550313 "Marker") (clojure.core/assoc :marker (deser-string (clojure.core/get-in letvar550313 ["Marker"]))) (letvar550313 "Certificates") (clojure.core/assoc :certificates (deser-certificate-list (clojure.core/get-in letvar550313 ["Certificates"])))))))
