...
(clojure.core/defn- response-disable-user-result ([input] (response-disable-user-result nil input)) ([resultWrapper1450083 input] (clojure.core/let [rawinput1450082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450084 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-directory-config-result ([input] (response-delete-directory-config-result nil input)) ([resultWrapper1450086 input] (clojure.core/let [rawinput1450085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450087 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-directory-config-result ([input] (response-update-directory-config-result nil input)) ([resultWrapper1450089 input] (clojure.core/let [rawinput1450088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450090 {"DirectoryConfig" (rawinput1450088 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1450090 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1450090 ["DirectoryConfig"])))))))

(clojure.core/defn- response-enable-user-result ([input] (response-enable-user-result nil input)) ([resultWrapper1450092 input] (clojure.core/let [rawinput1450091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450093 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-sessions-result ([input] (response-describe-sessions-result nil input)) ([resultWrapper1450095 input] (clojure.core/let [rawinput1450094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450096 {"Sessions" (rawinput1450094 "Sessions"), "NextToken" (rawinput1450094 "NextToken")}] (clojure.core/cond-> {} (letvar1450096 "Sessions") (clojure.core/assoc :sessions (deser-session-list (clojure.core/get-in letvar1450096 ["Sessions"]))) (letvar1450096 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450096 ["NextToken"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1450098 input] (clojure.core/let [rawinput1450097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450099 {"Message" (rawinput1450097 "Message")}] (clojure.core/cond-> {} (letvar1450099 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450099 ["Message"])))))))

(clojure.core/defn- response-describe-directory-configs-result ([input] (response-describe-directory-configs-result nil input)) ([resultWrapper1450101 input] (clojure.core/let [rawinput1450100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450102 {"DirectoryConfigs" (rawinput1450100 "DirectoryConfigs"), "NextToken" (rawinput1450100 "NextToken")}] (clojure.core/cond-> {} (letvar1450102 "DirectoryConfigs") (clojure.core/assoc :directory-configs (deser-directory-config-list (clojure.core/get-in letvar1450102 ["DirectoryConfigs"]))) (letvar1450102 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450102 ["NextToken"])))))))

(clojure.core/defn- response-invalid-role-exception ([input] (response-invalid-role-exception nil input)) ([resultWrapper1450104 input] (clojure.core/let [rawinput1450103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450105 {"Message" (rawinput1450103 "Message")}] (clojure.core/cond-> {} (letvar1450105 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450105 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1450107 input] (clojure.core/let [rawinput1450106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450108 {"Tags" (rawinput1450106 "Tags")}] (clojure.core/cond-> {} (letvar1450108 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1450108 ["Tags"])))))))

(clojure.core/defn- response-disassociate-fleet-result ([input] (response-disassociate-fleet-result nil input)) ([resultWrapper1450110 input] (clojure.core/let [rawinput1450109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450111 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-result ([input] (response-delete-user-result nil input)) ([resultWrapper1450113 input] (clojure.core/let [rawinput1450112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450114 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-fleets-result ([input] (response-describe-fleets-result nil input)) ([resultWrapper1450116 input] (clojure.core/let [rawinput1450115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450117 {"Fleets" (rawinput1450115 "Fleets"), "NextToken" (rawinput1450115 "NextToken")}] (clojure.core/cond-> {} (letvar1450117 "Fleets") (clojure.core/assoc :fleets (deser-fleet-list (clojure.core/get-in letvar1450117 ["Fleets"]))) (letvar1450117 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450117 ["NextToken"])))))))

(clojure.core/defn- response-stop-fleet-result ([input] (response-stop-fleet-result nil input)) ([resultWrapper1450119 input] (clojure.core/let [rawinput1450118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450120 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1450122 input] (clojure.core/let [rawinput1450121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450123 {"Message" (rawinput1450121 "Message")}] (clojure.core/cond-> {} (letvar1450123 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450123 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1450125 input] (clojure.core/let [rawinput1450124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450126 {"Message" (rawinput1450124 "Message")}] (clojure.core/cond-> {} (letvar1450126 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450126 ["Message"])))))))

(clojure.core/defn- response-start-image-builder-result ([input] (response-start-image-builder-result nil input)) ([resultWrapper1450128 input] (clojure.core/let [rawinput1450127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450129 {"ImageBuilder" (rawinput1450127 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1450129 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1450129 ["ImageBuilder"])))))))

(clojure.core/defn- response-describe-image-permissions-result ([input] (response-describe-image-permissions-result nil input)) ([resultWrapper1450131 input] (clojure.core/let [rawinput1450130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450132 {"Name" (rawinput1450130 "Name"), "SharedImagePermissionsList" (rawinput1450130 "SharedImagePermissionsList"), "NextToken" (rawinput1450130 "NextToken")}] (clojure.core/cond-> {} (letvar1450132 "Name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1450132 ["Name"]))) (letvar1450132 "SharedImagePermissionsList") (clojure.core/assoc :shared-image-permissions-list (deser-shared-image-permissions-list (clojure.core/get-in letvar1450132 ["SharedImagePermissionsList"]))) (letvar1450132 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450132 ["NextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1450134 input] (clojure.core/let [rawinput1450133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450135 {"Message" (rawinput1450133 "Message")}] (clojure.core/cond-> {} (letvar1450135 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450135 ["Message"])))))))

(clojure.core/defn- response-invalid-account-status-exception ([input] (response-invalid-account-status-exception nil input)) ([resultWrapper1450137 input] (clojure.core/let [rawinput1450136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450138 {"Message" (rawinput1450136 "Message")}] (clojure.core/cond-> {} (letvar1450138 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450138 ["Message"])))))))

(clojure.core/defn- response-start-fleet-result ([input] (response-start-fleet-result nil input)) ([resultWrapper1450140 input] (clojure.core/let [rawinput1450139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450141 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1450143 input] (clojure.core/let [rawinput1450142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450144 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-stack-result ([input] (response-create-stack-result nil input)) ([resultWrapper1450146 input] (clojure.core/let [rawinput1450145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450147 {"Stack" (rawinput1450145 "Stack")}] (clojure.core/cond-> {} (letvar1450147 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1450147 ["Stack"])))))))

(clojure.core/defn- response-describe-images-result ([input] (response-describe-images-result nil input)) ([resultWrapper1450149 input] (clojure.core/let [rawinput1450148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450150 {"Images" (rawinput1450148 "Images"), "NextToken" (rawinput1450148 "NextToken")}] (clojure.core/cond-> {} (letvar1450150 "Images") (clojure.core/assoc :images (deser-image-list (clojure.core/get-in letvar1450150 ["Images"]))) (letvar1450150 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450150 ["NextToken"])))))))

(clojure.core/defn- response-associate-fleet-result ([input] (response-associate-fleet-result nil input)) ([resultWrapper1450152 input] (clojure.core/let [rawinput1450151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450153 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-image-permissions-result ([input] (response-update-image-permissions-result nil input)) ([resultWrapper1450155 input] (clojure.core/let [rawinput1450154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450156 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-image-builder-result ([input] (response-delete-image-builder-result nil input)) ([resultWrapper1450158 input] (clojure.core/let [rawinput1450157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450159 {"ImageBuilder" (rawinput1450157 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1450159 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1450159 ["ImageBuilder"])))))))

(clojure.core/defn- response-create-image-builder-result ([input] (response-create-image-builder-result nil input)) ([resultWrapper1450161 input] (clojure.core/let [rawinput1450160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450162 {"ImageBuilder" (rawinput1450160 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1450162 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1450162 ["ImageBuilder"])))))))

(clojure.core/defn- response-batch-associate-user-stack-result ([input] (response-batch-associate-user-stack-result nil input)) ([resultWrapper1450164 input] (clojure.core/let [rawinput1450163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450165 {"errors" (rawinput1450163 "errors")}] (clojure.core/cond-> {} (letvar1450165 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1450165 ["errors"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1450167 input] (clojure.core/let [rawinput1450166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450168 {"Message" (rawinput1450166 "Message")}] (clojure.core/cond-> {} (letvar1450168 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450168 ["Message"])))))))

(clojure.core/defn- response-delete-stack-result ([input] (response-delete-stack-result nil input)) ([resultWrapper1450170 input] (clojure.core/let [rawinput1450169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450171 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-associated-fleets-result ([input] (response-list-associated-fleets-result nil input)) ([resultWrapper1450173 input] (clojure.core/let [rawinput1450172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450174 {"Names" (rawinput1450172 "Names"), "NextToken" (rawinput1450172 "NextToken")}] (clojure.core/cond-> {} (letvar1450174 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1450174 ["Names"]))) (letvar1450174 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450174 ["NextToken"])))))))

(clojure.core/defn- response-create-image-builder-streaming-url-result ([input] (response-create-image-builder-streaming-url-result nil input)) ([resultWrapper1450176 input] (clojure.core/let [rawinput1450175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450177 {"StreamingURL" (rawinput1450175 "StreamingURL"), "Expires" (rawinput1450175 "Expires")}] (clojure.core/cond-> {} (letvar1450177 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1450177 ["StreamingURL"]))) (letvar1450177 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1450177 ["Expires"])))))))

(clojure.core/defn- response-resource-not-available-exception ([input] (response-resource-not-available-exception nil input)) ([resultWrapper1450179 input] (clojure.core/let [rawinput1450178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450180 {"Message" (rawinput1450178 "Message")}] (clojure.core/cond-> {} (letvar1450180 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450180 ["Message"])))))))

(clojure.core/defn- response-describe-image-builders-result ([input] (response-describe-image-builders-result nil input)) ([resultWrapper1450182 input] (clojure.core/let [rawinput1450181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450183 {"ImageBuilders" (rawinput1450181 "ImageBuilders"), "NextToken" (rawinput1450181 "NextToken")}] (clojure.core/cond-> {} (letvar1450183 "ImageBuilders") (clojure.core/assoc :image-builders (deser-image-builder-list (clojure.core/get-in letvar1450183 ["ImageBuilders"]))) (letvar1450183 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450183 ["NextToken"])))))))

(clojure.core/defn- response-batch-disassociate-user-stack-result ([input] (response-batch-disassociate-user-stack-result nil input)) ([resultWrapper1450185 input] (clojure.core/let [rawinput1450184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450186 {"errors" (rawinput1450184 "errors")}] (clojure.core/cond-> {} (letvar1450186 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1450186 ["errors"])))))))

(clojure.core/defn- response-delete-image-permissions-result ([input] (response-delete-image-permissions-result nil input)) ([resultWrapper1450188 input] (clojure.core/let [rawinput1450187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450189 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper1450191 input] (clojure.core/let [rawinput1450190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450192 {"Message" (rawinput1450190 "Message")}] (clojure.core/cond-> {} (letvar1450192 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450192 ["Message"])))))))

(clojure.core/defn- response-update-fleet-result ([input] (response-update-fleet-result nil input)) ([resultWrapper1450194 input] (clojure.core/let [rawinput1450193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450195 {"Fleet" (rawinput1450193 "Fleet")}] (clojure.core/cond-> {} (letvar1450195 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1450195 ["Fleet"])))))))

(clojure.core/defn- response-describe-user-stack-associations-result ([input] (response-describe-user-stack-associations-result nil input)) ([resultWrapper1450197 input] (clojure.core/let [rawinput1450196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450198 {"UserStackAssociations" (rawinput1450196 "UserStackAssociations"), "NextToken" (rawinput1450196 "NextToken")}] (clojure.core/cond-> {} (letvar1450198 "UserStackAssociations") (clojure.core/assoc :user-stack-associations (deser-user-stack-association-list (clojure.core/get-in letvar1450198 ["UserStackAssociations"]))) (letvar1450198 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450198 ["NextToken"])))))))

(clojure.core/defn- response-stop-image-builder-result ([input] (response-stop-image-builder-result nil input)) ([resultWrapper1450200 input] (clojure.core/let [rawinput1450199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450201 {"ImageBuilder" (rawinput1450199 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1450201 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1450201 ["ImageBuilder"])))))))

(clojure.core/defn- response-update-stack-result ([input] (response-update-stack-result nil input)) ([resultWrapper1450203 input] (clojure.core/let [rawinput1450202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450204 {"Stack" (rawinput1450202 "Stack")}] (clojure.core/cond-> {} (letvar1450204 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1450204 ["Stack"])))))))

(clojure.core/defn- response-create-user-result ([input] (response-create-user-result nil input)) ([resultWrapper1450206 input] (clojure.core/let [rawinput1450205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450207 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-streaming-url-result ([input] (response-create-streaming-url-result nil input)) ([resultWrapper1450209 input] (clojure.core/let [rawinput1450208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450210 {"StreamingURL" (rawinput1450208 "StreamingURL"), "Expires" (rawinput1450208 "Expires")}] (clojure.core/cond-> {} (letvar1450210 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1450210 ["StreamingURL"]))) (letvar1450210 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1450210 ["Expires"])))))))

(clojure.core/defn- response-create-fleet-result ([input] (response-create-fleet-result nil input)) ([resultWrapper1450212 input] (clojure.core/let [rawinput1450211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450213 {"Fleet" (rawinput1450211 "Fleet")}] (clojure.core/cond-> {} (letvar1450213 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1450213 ["Fleet"])))))))

(clojure.core/defn- response-incompatible-image-exception ([input] (response-incompatible-image-exception nil input)) ([resultWrapper1450215 input] (clojure.core/let [rawinput1450214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450216 {"Message" (rawinput1450214 "Message")}] (clojure.core/cond-> {} (letvar1450216 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450216 ["Message"])))))))

(clojure.core/defn- response-describe-users-result ([input] (response-describe-users-result nil input)) ([resultWrapper1450218 input] (clojure.core/let [rawinput1450217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450219 {"Users" (rawinput1450217 "Users"), "NextToken" (rawinput1450217 "NextToken")}] (clojure.core/cond-> {} (letvar1450219 "Users") (clojure.core/assoc :users (deser-user-list (clojure.core/get-in letvar1450219 ["Users"]))) (letvar1450219 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450219 ["NextToken"])))))))

(clojure.core/defn- response-create-directory-config-result ([input] (response-create-directory-config-result nil input)) ([resultWrapper1450221 input] (clojure.core/let [rawinput1450220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450222 {"DirectoryConfig" (rawinput1450220 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1450222 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1450222 ["DirectoryConfig"])))))))

(clojure.core/defn- response-describe-stacks-result ([input] (response-describe-stacks-result nil input)) ([resultWrapper1450224 input] (clojure.core/let [rawinput1450223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450225 {"Stacks" (rawinput1450223 "Stacks"), "NextToken" (rawinput1450223 "NextToken")}] (clojure.core/cond-> {} (letvar1450225 "Stacks") (clojure.core/assoc :stacks (deser-stack-list (clojure.core/get-in letvar1450225 ["Stacks"]))) (letvar1450225 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450225 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1450227 input] (clojure.core/let [rawinput1450226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450228 {"Message" (rawinput1450226 "Message")}] (clojure.core/cond-> {} (letvar1450228 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1450228 ["Message"])))))))

(clojure.core/defn- response-delete-image-result ([input] (response-delete-image-result nil input)) ([resultWrapper1450230 input] (clojure.core/let [rawinput1450229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450231 {"Image" (rawinput1450229 "Image")}] (clojure.core/cond-> {} (letvar1450231 "Image") (clojure.core/assoc :image (deser-image (clojure.core/get-in letvar1450231 ["Image"])))))))

(clojure.core/defn- response-delete-fleet-result ([input] (response-delete-fleet-result nil input)) ([resultWrapper1450233 input] (clojure.core/let [rawinput1450232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450234 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1450236 input] (clojure.core/let [rawinput1450235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450237 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-expire-session-result ([input] (response-expire-session-result nil input)) ([resultWrapper1450239 input] (clojure.core/let [rawinput1450238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450240 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-copy-image-response ([input] (response-copy-image-response nil input)) ([resultWrapper1450242 input] (clojure.core/let [rawinput1450241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450243 {"DestinationImageName" (rawinput1450241 "DestinationImageName")}] (clojure.core/cond-> {} (letvar1450243 "DestinationImageName") (clojure.core/assoc :destination-image-name (deser-name (clojure.core/get-in letvar1450243 ["DestinationImageName"])))))))

(clojure.core/defn- response-list-associated-stacks-result ([input] (response-list-associated-stacks-result nil input)) ([resultWrapper1450245 input] (clojure.core/let [rawinput1450244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450246 {"Names" (rawinput1450244 "Names"), "NextToken" (rawinput1450244 "NextToken")}] (clojure.core/cond-> {} (letvar1450246 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1450246 ["Names"]))) (letvar1450246 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1450246 ["NextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(^(?!aws:).[\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/region-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/account-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/user-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[A-Za-z0-9_\-\s]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/appstream-agent-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\d+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/resource-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-Za-z0-9_/.-]{0,62}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-Za-z0-9:_/+=,@.-]{0,1023}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/feedback-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/long clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/streaming-url-user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/settings-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/organizational-unit-distinguished-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream.-2016-12-01/redirect-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
