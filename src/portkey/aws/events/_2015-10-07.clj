...
(clojure.core/defn- response-list-rules-response ([input] (response-list-rules-response nil input)) ([resultWrapper1768469 input] (clojure.core/let [rawinput1768468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768470 {"Rules" (rawinput1768468 "Rules"), "NextToken" (rawinput1768468 "NextToken")}] (clojure.core/cond-> {} (letvar1768470 "Rules") (clojure.core/assoc :rules (deser-rule-response-list (clojure.core/get-in letvar1768470 ["Rules"]))) (letvar1768470 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1768470 ["NextToken"])))))))

(clojure.core/defn- response-put-targets-response ([input] (response-put-targets-response nil input)) ([resultWrapper1768472 input] (clojure.core/let [rawinput1768471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768473 {"FailedEntryCount" (rawinput1768471 "FailedEntryCount"), "FailedEntries" (rawinput1768471 "FailedEntries")}] (clojure.core/cond-> {} (letvar1768473 "FailedEntryCount") (clojure.core/assoc :failed-entry-count (deser-integer (clojure.core/get-in letvar1768473 ["FailedEntryCount"]))) (letvar1768473 "FailedEntries") (clojure.core/assoc :failed-entries (deser-put-targets-result-entry-list (clojure.core/get-in letvar1768473 ["FailedEntries"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1768475 input] (clojure.core/let [rawinput1768474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768476 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-event-bus-response ([input] (response-describe-event-bus-response nil input)) ([resultWrapper1768478 input] (clojure.core/let [rawinput1768477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768479 {"Name" (rawinput1768477 "Name"), "Arn" (rawinput1768477 "Arn"), "Policy" (rawinput1768477 "Policy")}] (clojure.core/cond-> {} (letvar1768479 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1768479 ["Name"]))) (letvar1768479 "Arn") (clojure.core/assoc :arn (deser-string (clojure.core/get-in letvar1768479 ["Arn"]))) (letvar1768479 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1768479 ["Policy"])))))))

(clojure.core/defn- response-put-events-response ([input] (response-put-events-response nil input)) ([resultWrapper1768481 input] (clojure.core/let [rawinput1768480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768482 {"FailedEntryCount" (rawinput1768480 "FailedEntryCount"), "Entries" (rawinput1768480 "Entries")}] (clojure.core/cond-> {} (letvar1768482 "FailedEntryCount") (clojure.core/assoc :failed-entry-count (deser-integer (clojure.core/get-in letvar1768482 ["FailedEntryCount"]))) (letvar1768482 "Entries") (clojure.core/assoc :entries (deser-put-events-result-entry-list (clojure.core/get-in letvar1768482 ["Entries"])))))))

(clojure.core/defn- response-list-rule-names-by-target-response ([input] (response-list-rule-names-by-target-response nil input)) ([resultWrapper1768484 input] (clojure.core/let [rawinput1768483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768485 {"RuleNames" (rawinput1768483 "RuleNames"), "NextToken" (rawinput1768483 "NextToken")}] (clojure.core/cond-> {} (letvar1768485 "RuleNames") (clojure.core/assoc :rule-names (deser-rule-name-list (clojure.core/get-in letvar1768485 ["RuleNames"]))) (letvar1768485 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1768485 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1768487 input] (clojure.core/let [rawinput1768486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768488 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1768490 input] (clojure.core/let [rawinput1768489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768491 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-event-pattern-exception ([input] (response-invalid-event-pattern-exception nil input)) ([resultWrapper1768493 input] (clojure.core/let [rawinput1768492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768494 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-rule-response ([input] (response-describe-rule-response nil input)) ([resultWrapper1768496 input] (clojure.core/let [rawinput1768495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768497 {"Name" (rawinput1768495 "Name"), "Arn" (rawinput1768495 "Arn"), "EventPattern" (rawinput1768495 "EventPattern"), "ScheduleExpression" (rawinput1768495 "ScheduleExpression"), "State" (rawinput1768495 "State"), "Description" (rawinput1768495 "Description"), "RoleArn" (rawinput1768495 "RoleArn"), "ManagedBy" (rawinput1768495 "ManagedBy")}] (clojure.core/cond-> {} (letvar1768497 "Name") (clojure.core/assoc :name (deser-rule-name (clojure.core/get-in letvar1768497 ["Name"]))) (letvar1768497 "Arn") (clojure.core/assoc :arn (deser-rule-arn (clojure.core/get-in letvar1768497 ["Arn"]))) (letvar1768497 "EventPattern") (clojure.core/assoc :event-pattern (deser-event-pattern (clojure.core/get-in letvar1768497 ["EventPattern"]))) (letvar1768497 "ScheduleExpression") (clojure.core/assoc :schedule-expression (deser-schedule-expression (clojure.core/get-in letvar1768497 ["ScheduleExpression"]))) (letvar1768497 "State") (clojure.core/assoc :state (deser-rule-state (clojure.core/get-in letvar1768497 ["State"]))) (letvar1768497 "Description") (clojure.core/assoc :description (deser-rule-description (clojure.core/get-in letvar1768497 ["Description"]))) (letvar1768497 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1768497 ["RoleArn"]))) (letvar1768497 "ManagedBy") (clojure.core/assoc :managed-by (deser-managed-by (clojure.core/get-in letvar1768497 ["ManagedBy"])))))))

(clojure.core/defn- response-test-event-pattern-response ([input] (response-test-event-pattern-response nil input)) ([resultWrapper1768499 input] (clojure.core/let [rawinput1768498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768500 {"Result" (rawinput1768498 "Result")}] (clojure.core/cond-> {} (letvar1768500 "Result") (clojure.core/assoc :result (deser-boolean (clojure.core/get-in letvar1768500 ["Result"])))))))

(clojure.core/defn- response-policy-length-exceeded-exception ([input] (response-policy-length-exceeded-exception nil input)) ([resultWrapper1768502 input] (clojure.core/let [rawinput1768501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768503 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-targets-by-rule-response ([input] (response-list-targets-by-rule-response nil input)) ([resultWrapper1768505 input] (clojure.core/let [rawinput1768504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768506 {"Targets" (rawinput1768504 "Targets"), "NextToken" (rawinput1768504 "NextToken")}] (clojure.core/cond-> {} (letvar1768506 "Targets") (clojure.core/assoc :targets (deser-target-list (clojure.core/get-in letvar1768506 ["Targets"]))) (letvar1768506 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1768506 ["NextToken"])))))))

(clojure.core/defn- response-managed-rule-exception ([input] (response-managed-rule-exception nil input)) ([resultWrapper1768508 input] (clojure.core/let [rawinput1768507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768509 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-rule-response ([input] (response-put-rule-response nil input)) ([resultWrapper1768511 input] (clojure.core/let [rawinput1768510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768512 {"RuleArn" (rawinput1768510 "RuleArn")}] (clojure.core/cond-> {} (letvar1768512 "RuleArn") (clojure.core/assoc :rule-arn (deser-rule-arn (clojure.core/get-in letvar1768512 ["RuleArn"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1768514 input] (clojure.core/let [rawinput1768513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768515 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-remove-targets-response ([input] (response-remove-targets-response nil input)) ([resultWrapper1768517 input] (clojure.core/let [rawinput1768516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1768518 {"FailedEntryCount" (rawinput1768516 "FailedEntryCount"), "FailedEntries" (rawinput1768516 "FailedEntries")}] (clojure.core/cond-> {} (letvar1768518 "FailedEntryCount") (clojure.core/assoc :failed-entry-count (deser-integer (clojure.core/get-in letvar1768518 ["FailedEntryCount"]))) (letvar1768518 "FailedEntries") (clojure.core/assoc :failed-entries (deser-remove-targets-result-entry-list (clojure.core/get-in letvar1768518 ["FailedEntries"])))))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/rule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\.\-_A-Za-z0-9]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/target-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/rule-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-_]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/rule-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/target-input-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/transformer-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/input-transformer-path-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[A-Za-z0-9\_\-]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/target-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\.\-_A-Za-z0-9]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/schedule-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/managed-by (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"events:[a-zA-Z]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/run-command-target-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.events.-2015-10-07/target-partition-key-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.core/defn remove-permission ([remove-permission-requestinput] (clojure.core/let [request-function-result__1468878__auto__ (req-remove-permission-request remove-permission-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.events.-2015-10-07/endpoints, :http.request.configuration/target-prefix "AWSEvents", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-07", :http.request.configuration/service-id "CloudWatch Events", :http.request.spec/input-spec :portkey.aws.events.-2015-10-07/remove-permission-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "RemovePermission", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.events.-2015-10-07/resource-not-found-exception, "InternalException" :portkey.aws.events.-2015-10-07/internal-exception, "ConcurrentModificationException" :portkey.aws.events.-2015-10-07/concurrent-modification-exception}})))))
...
(clojure.core/defn enable-rule ([enable-rule-requestinput] (clojure.core/let [request-function-result__1468878__auto__ (req-enable-rule-request enable-rule-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.events.-2015-10-07/endpoints, :http.request.configuration/target-prefix "AWSEvents", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-07", :http.request.configuration/service-id "CloudWatch Events", :http.request.spec/input-spec :portkey.aws.events.-2015-10-07/enable-rule-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "EnableRule", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.events.-2015-10-07/resource-not-found-exception, "ConcurrentModificationException" :portkey.aws.events.-2015-10-07/concurrent-modification-exception, "ManagedRuleException" :portkey.aws.events.-2015-10-07/managed-rule-exception, "InternalException" :portkey.aws.events.-2015-10-07/internal-exception}})))))
