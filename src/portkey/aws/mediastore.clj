...
(clojure.core/defn- response-list-containers-output ([input] (response-list-containers-output nil input)) ([resultWrapper1902240 input] (clojure.core/let [rawinput1902239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902241 {"Containers" (rawinput1902239 "Containers"), "NextToken" (rawinput1902239 "NextToken")}] (clojure.core/cond-> {:containers (deser-container-list (clojure.core/get-in letvar1902241 ["Containers"]))} (letvar1902241 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1902241 ["NextToken"])))))))

(clojure.core/defn- response-delete-cors-policy-output ([input] (response-delete-cors-policy-output nil input)) ([resultWrapper1902243 input] (clojure.core/let [rawinput1902242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902244 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lifecycle-policy-output ([input] (response-delete-lifecycle-policy-output nil input)) ([resultWrapper1902246 input] (clojure.core/let [rawinput1902245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902247 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-cors-policy-output ([input] (response-get-cors-policy-output nil input)) ([resultWrapper1902249 input] (clojure.core/let [rawinput1902248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902250 {"CorsPolicy" (rawinput1902248 "CorsPolicy")}] (clojure.core/cond-> {:cors-policy (deser-cors-policy (clojure.core/get-in letvar1902250 ["CorsPolicy"]))}))))

(clojure.core/defn- response-container-not-found-exception ([input] (response-container-not-found-exception nil input)) ([resultWrapper1902252 input] (clojure.core/let [rawinput1902251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902253 {"Message" (rawinput1902251 "Message")}] (clojure.core/cond-> {} (letvar1902253 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902253 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1902255 input] (clojure.core/let [rawinput1902254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902256 {"Message" (rawinput1902254 "Message")}] (clojure.core/cond-> {} (letvar1902256 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902256 ["Message"])))))))

(clojure.core/defn- response-get-container-policy-output ([input] (response-get-container-policy-output nil input)) ([resultWrapper1902258 input] (clojure.core/let [rawinput1902257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902259 {"Policy" (rawinput1902257 "Policy")}] (clojure.core/cond-> {:policy (deser-container-policy (clojure.core/get-in letvar1902259 ["Policy"]))}))))

(clojure.core/defn- response-container-in-use-exception ([input] (response-container-in-use-exception nil input)) ([resultWrapper1902261 input] (clojure.core/let [rawinput1902260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902262 {"Message" (rawinput1902260 "Message")}] (clojure.core/cond-> {} (letvar1902262 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902262 ["Message"])))))))

(clojure.core/defn- response-delete-container-policy-output ([input] (response-delete-container-policy-output nil input)) ([resultWrapper1902264 input] (clojure.core/let [rawinput1902263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902265 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-access-logging-output ([input] (response-stop-access-logging-output nil input)) ([resultWrapper1902267 input] (clojure.core/let [rawinput1902266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902268 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-container-policy-output ([input] (response-put-container-policy-output nil input)) ([resultWrapper1902270 input] (clojure.core/let [rawinput1902269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902271 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-container-output ([input] (response-create-container-output nil input)) ([resultWrapper1902273 input] (clojure.core/let [rawinput1902272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902274 {"Container" (rawinput1902272 "Container")}] (clojure.core/cond-> {:container (deser-container (clojure.core/get-in letvar1902274 ["Container"]))}))))

(clojure.core/defn- response-put-cors-policy-output ([input] (response-put-cors-policy-output nil input)) ([resultWrapper1902276 input] (clojure.core/let [rawinput1902275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902277 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-policy-not-found-exception ([input] (response-policy-not-found-exception nil input)) ([resultWrapper1902279 input] (clojure.core/let [rawinput1902278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902280 {"Message" (rawinput1902278 "Message")}] (clojure.core/cond-> {} (letvar1902280 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902280 ["Message"])))))))

(clojure.core/defn- response-get-lifecycle-policy-output ([input] (response-get-lifecycle-policy-output nil input)) ([resultWrapper1902282 input] (clojure.core/let [rawinput1902281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902283 {"LifecyclePolicy" (rawinput1902281 "LifecyclePolicy")}] (clojure.core/cond-> {:lifecycle-policy (deser-lifecycle-policy (clojure.core/get-in letvar1902283 ["LifecyclePolicy"]))}))))

(clojure.core/defn- response-start-access-logging-output ([input] (response-start-access-logging-output nil input)) ([resultWrapper1902285 input] (clojure.core/let [rawinput1902284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902286 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cors-policy-not-found-exception ([input] (response-cors-policy-not-found-exception nil input)) ([resultWrapper1902288 input] (clojure.core/let [rawinput1902287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902289 {"Message" (rawinput1902287 "Message")}] (clojure.core/cond-> {} (letvar1902289 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902289 ["Message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1902291 input] (clojure.core/let [rawinput1902290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902292 {"Message" (rawinput1902290 "Message")}] (clojure.core/cond-> {} (letvar1902292 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1902292 ["Message"])))))))

(clojure.core/defn- response-delete-container-output ([input] (response-delete-container-output nil input)) ([resultWrapper1902294 input] (clojure.core/let [rawinput1902293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902295 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-container-output ([input] (response-describe-container-output nil input)) ([resultWrapper1902297 input] (clojure.core/let [rawinput1902296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902298 {"Container" (rawinput1902296 "Container")}] (clojure.core/cond-> {} (letvar1902298 "Container") (clojure.core/assoc :container (deser-container (clojure.core/get-in letvar1902298 ["Container"])))))))

(clojure.core/defn- response-put-lifecycle-policy-output ([input] (response-put-lifecycle-policy-output nil input)) ([resultWrapper1902300 input] (clojure.core/let [rawinput1902299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1902301 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9A-Za-z=/+]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/origin (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/container-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.mediastore/start-access-logging-output (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.mediastore/endpoint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore/container-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+" s__1410940__auto__))))
