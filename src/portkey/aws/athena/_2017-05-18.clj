...
(clojure.core/defn- response-stop-query-execution-output ([input] (response-stop-query-execution-output nil input)) ([resultWrapper1456767 input] (clojure.core/let [rawinput1456766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456768 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1456770 input] (clojure.core/let [rawinput1456769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456771 {"AthenaErrorCode" (rawinput1456769 "AthenaErrorCode"), "Message" (rawinput1456769 "Message")}] (clojure.core/cond-> {} (letvar1456771 "AthenaErrorCode") (clojure.core/assoc :athena-error-code (deser-error-code (clojure.core/get-in letvar1456771 ["AthenaErrorCode"]))) (letvar1456771 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1456771 ["Message"])))))))

(clojure.core/defn- response-get-query-execution-output ([input] (response-get-query-execution-output nil input)) ([resultWrapper1456773 input] (clojure.core/let [rawinput1456772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456774 {"QueryExecution" (rawinput1456772 "QueryExecution")}] (clojure.core/cond-> {} (letvar1456774 "QueryExecution") (clojure.core/assoc :query-execution (deser-query-execution (clojure.core/get-in letvar1456774 ["QueryExecution"])))))))

(clojure.core/defn- response-update-work-group-output ([input] (response-update-work-group-output nil input)) ([resultWrapper1456776 input] (clojure.core/let [rawinput1456775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456777 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-work-group-output ([input] (response-create-work-group-output nil input)) ([resultWrapper1456779 input] (clojure.core/let [rawinput1456778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456780 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-output ([input] (response-tag-resource-output nil input)) ([resultWrapper1456782 input] (clojure.core/let [rawinput1456781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456783 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-named-queries-output ([input] (response-list-named-queries-output nil input)) ([resultWrapper1456785 input] (clojure.core/let [rawinput1456784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456786 {"NamedQueryIds" (rawinput1456784 "NamedQueryIds"), "NextToken" (rawinput1456784 "NextToken")}] (clojure.core/cond-> {} (letvar1456786 "NamedQueryIds") (clojure.core/assoc :named-query-ids (deser-named-query-id-list (clojure.core/get-in letvar1456786 ["NamedQueryIds"]))) (letvar1456786 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1456786 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1456788 input] (clojure.core/let [rawinput1456787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456789 {"Message" (rawinput1456787 "Message"), "Reason" (rawinput1456787 "Reason")}] (clojure.core/cond-> {} (letvar1456789 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1456789 ["Message"]))) (letvar1456789 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1456789 ["Reason"])))))))

(clojure.core/defn- response-batch-get-named-query-output ([input] (response-batch-get-named-query-output nil input)) ([resultWrapper1456791 input] (clojure.core/let [rawinput1456790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456792 {"NamedQueries" (rawinput1456790 "NamedQueries"), "UnprocessedNamedQueryIds" (rawinput1456790 "UnprocessedNamedQueryIds")}] (clojure.core/cond-> {} (letvar1456792 "NamedQueries") (clojure.core/assoc :named-queries (deser-named-query-list (clojure.core/get-in letvar1456792 ["NamedQueries"]))) (letvar1456792 "UnprocessedNamedQueryIds") (clojure.core/assoc :unprocessed-named-query-ids (deser-unprocessed-named-query-id-list (clojure.core/get-in letvar1456792 ["UnprocessedNamedQueryIds"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1456794 input] (clojure.core/let [rawinput1456793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456795 {"Message" (rawinput1456793 "Message"), "ResourceName" (rawinput1456793 "ResourceName")}] (clojure.core/cond-> {} (letvar1456795 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1456795 ["Message"]))) (letvar1456795 "ResourceName") (clojure.core/assoc :resource-name (deser-amazon-resource-name (clojure.core/get-in letvar1456795 ["ResourceName"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1456797 input] (clojure.core/let [rawinput1456796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456798 {"Message" (rawinput1456796 "Message")}] (clojure.core/cond-> {} (letvar1456798 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1456798 ["Message"])))))))

(clojure.core/defn- response-create-named-query-output ([input] (response-create-named-query-output nil input)) ([resultWrapper1456800 input] (clojure.core/let [rawinput1456799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456801 {"NamedQueryId" (rawinput1456799 "NamedQueryId")}] (clojure.core/cond-> {} (letvar1456801 "NamedQueryId") (clojure.core/assoc :named-query-id (deser-named-query-id (clojure.core/get-in letvar1456801 ["NamedQueryId"])))))))

(clojure.core/defn- response-start-query-execution-output ([input] (response-start-query-execution-output nil input)) ([resultWrapper1456803 input] (clojure.core/let [rawinput1456802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456804 {"QueryExecutionId" (rawinput1456802 "QueryExecutionId")}] (clojure.core/cond-> {} (letvar1456804 "QueryExecutionId") (clojure.core/assoc :query-execution-id (deser-query-execution-id (clojure.core/get-in letvar1456804 ["QueryExecutionId"])))))))

(clojure.core/defn- response-get-named-query-output ([input] (response-get-named-query-output nil input)) ([resultWrapper1456806 input] (clojure.core/let [rawinput1456805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456807 {"NamedQuery" (rawinput1456805 "NamedQuery")}] (clojure.core/cond-> {} (letvar1456807 "NamedQuery") (clojure.core/assoc :named-query (deser-named-query (clojure.core/get-in letvar1456807 ["NamedQuery"])))))))

(clojure.core/defn- response-delete-named-query-output ([input] (response-delete-named-query-output nil input)) ([resultWrapper1456809 input] (clojure.core/let [rawinput1456808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456810 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-query-execution-output ([input] (response-batch-get-query-execution-output nil input)) ([resultWrapper1456812 input] (clojure.core/let [rawinput1456811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456813 {"QueryExecutions" (rawinput1456811 "QueryExecutions"), "UnprocessedQueryExecutionIds" (rawinput1456811 "UnprocessedQueryExecutionIds")}] (clojure.core/cond-> {} (letvar1456813 "QueryExecutions") (clojure.core/assoc :query-executions (deser-query-execution-list (clojure.core/get-in letvar1456813 ["QueryExecutions"]))) (letvar1456813 "UnprocessedQueryExecutionIds") (clojure.core/assoc :unprocessed-query-execution-ids (deser-unprocessed-query-execution-id-list (clojure.core/get-in letvar1456813 ["UnprocessedQueryExecutionIds"])))))))

(clojure.core/defn- response-list-work-groups-output ([input] (response-list-work-groups-output nil input)) ([resultWrapper1456815 input] (clojure.core/let [rawinput1456814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456816 {"WorkGroups" (rawinput1456814 "WorkGroups"), "NextToken" (rawinput1456814 "NextToken")}] (clojure.core/cond-> {} (letvar1456816 "WorkGroups") (clojure.core/assoc :work-groups (deser-work-groups-list (clojure.core/get-in letvar1456816 ["WorkGroups"]))) (letvar1456816 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1456816 ["NextToken"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper1456818 input] (clojure.core/let [rawinput1456817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456819 {"Tags" (rawinput1456817 "Tags"), "NextToken" (rawinput1456817 "NextToken")}] (clojure.core/cond-> {} (letvar1456819 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1456819 ["Tags"]))) (letvar1456819 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1456819 ["NextToken"])))))))

(clojure.core/defn- response-delete-work-group-output ([input] (response-delete-work-group-output nil input)) ([resultWrapper1456821 input] (clojure.core/let [rawinput1456820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456822 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-output ([input] (response-untag-resource-output nil input)) ([resultWrapper1456824 input] (clojure.core/let [rawinput1456823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456825 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-work-group-output ([input] (response-get-work-group-output nil input)) ([resultWrapper1456827 input] (clojure.core/let [rawinput1456826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456828 {"WorkGroup" (rawinput1456826 "WorkGroup")}] (clojure.core/cond-> {} (letvar1456828 "WorkGroup") (clojure.core/assoc :work-group (deser-work-group (clojure.core/get-in letvar1456828 ["WorkGroup"])))))))

(clojure.core/defn- response-get-query-results-output ([input] (response-get-query-results-output nil input)) ([resultWrapper1456830 input] (clojure.core/let [rawinput1456829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456831 {"UpdateCount" (rawinput1456829 "UpdateCount"), "ResultSet" (rawinput1456829 "ResultSet"), "NextToken" (rawinput1456829 "NextToken")}] (clojure.core/cond-> {} (letvar1456831 "UpdateCount") (clojure.core/assoc :update-count (deser-long (clojure.core/get-in letvar1456831 ["UpdateCount"]))) (letvar1456831 "ResultSet") (clojure.core/assoc :result-set (deser-result-set (clojure.core/get-in letvar1456831 ["ResultSet"]))) (letvar1456831 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1456831 ["NextToken"])))))))

(clojure.core/defn- response-list-query-executions-output ([input] (response-list-query-executions-output nil input)) ([resultWrapper1456833 input] (clojure.core/let [rawinput1456832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1456834 {"QueryExecutionIds" (rawinput1456832 "QueryExecutionIds"), "NextToken" (rawinput1456832 "NextToken")}] (clojure.core/cond-> {} (letvar1456834 "QueryExecutionIds") (clojure.core/assoc :query-execution-ids (deser-query-execution-id-list (clojure.core/get-in letvar1456834 ["QueryExecutionIds"]))) (letvar1456834 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1456834 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/work-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-z0-9._-]{1,128}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/work-group-description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/amazon-resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1011))))

(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-resource-output (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/database-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 262144))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 32 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
