...
(clojure.core/defn- response-stop-query-execution-output ([input] (response-stop-query-execution-output nil input)) ([resultWrapper1514845 input] (clojure.core/let [rawinput1514844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514846 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1514848 input] (clojure.core/let [rawinput1514847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514849 {"AthenaErrorCode" (rawinput1514847 "AthenaErrorCode"), "Message" (rawinput1514847 "Message")}] (clojure.core/cond-> {} (letvar1514849 "AthenaErrorCode") (clojure.core/assoc :athena-error-code (deser-error-code (clojure.core/get-in letvar1514849 ["AthenaErrorCode"]))) (letvar1514849 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1514849 ["Message"])))))))

(clojure.core/defn- response-get-query-execution-output ([input] (response-get-query-execution-output nil input)) ([resultWrapper1514851 input] (clojure.core/let [rawinput1514850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514852 {"QueryExecution" (rawinput1514850 "QueryExecution")}] (clojure.core/cond-> {} (letvar1514852 "QueryExecution") (clojure.core/assoc :query-execution (deser-query-execution (clojure.core/get-in letvar1514852 ["QueryExecution"])))))))

(clojure.core/defn- response-update-work-group-output ([input] (response-update-work-group-output nil input)) ([resultWrapper1514854 input] (clojure.core/let [rawinput1514853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514855 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-work-group-output ([input] (response-create-work-group-output nil input)) ([resultWrapper1514857 input] (clojure.core/let [rawinput1514856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514858 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-output ([input] (response-tag-resource-output nil input)) ([resultWrapper1514860 input] (clojure.core/let [rawinput1514859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514861 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-named-queries-output ([input] (response-list-named-queries-output nil input)) ([resultWrapper1514863 input] (clojure.core/let [rawinput1514862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514864 {"NamedQueryIds" (rawinput1514862 "NamedQueryIds"), "NextToken" (rawinput1514862 "NextToken")}] (clojure.core/cond-> {} (letvar1514864 "NamedQueryIds") (clojure.core/assoc :named-query-ids (deser-named-query-id-list (clojure.core/get-in letvar1514864 ["NamedQueryIds"]))) (letvar1514864 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1514864 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1514866 input] (clojure.core/let [rawinput1514865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514867 {"Message" (rawinput1514865 "Message"), "Reason" (rawinput1514865 "Reason")}] (clojure.core/cond-> {} (letvar1514867 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1514867 ["Message"]))) (letvar1514867 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1514867 ["Reason"])))))))

(clojure.core/defn- response-batch-get-named-query-output ([input] (response-batch-get-named-query-output nil input)) ([resultWrapper1514869 input] (clojure.core/let [rawinput1514868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514870 {"NamedQueries" (rawinput1514868 "NamedQueries"), "UnprocessedNamedQueryIds" (rawinput1514868 "UnprocessedNamedQueryIds")}] (clojure.core/cond-> {} (letvar1514870 "NamedQueries") (clojure.core/assoc :named-queries (deser-named-query-list (clojure.core/get-in letvar1514870 ["NamedQueries"]))) (letvar1514870 "UnprocessedNamedQueryIds") (clojure.core/assoc :unprocessed-named-query-ids (deser-unprocessed-named-query-id-list (clojure.core/get-in letvar1514870 ["UnprocessedNamedQueryIds"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1514872 input] (clojure.core/let [rawinput1514871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514873 {"Message" (rawinput1514871 "Message"), "ResourceName" (rawinput1514871 "ResourceName")}] (clojure.core/cond-> {} (letvar1514873 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1514873 ["Message"]))) (letvar1514873 "ResourceName") (clojure.core/assoc :resource-name (deser-amazon-resource-name (clojure.core/get-in letvar1514873 ["ResourceName"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1514875 input] (clojure.core/let [rawinput1514874 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514876 {"Message" (rawinput1514874 "Message")}] (clojure.core/cond-> {} (letvar1514876 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1514876 ["Message"])))))))

(clojure.core/defn- response-create-named-query-output ([input] (response-create-named-query-output nil input)) ([resultWrapper1514878 input] (clojure.core/let [rawinput1514877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514879 {"NamedQueryId" (rawinput1514877 "NamedQueryId")}] (clojure.core/cond-> {} (letvar1514879 "NamedQueryId") (clojure.core/assoc :named-query-id (deser-named-query-id (clojure.core/get-in letvar1514879 ["NamedQueryId"])))))))

(clojure.core/defn- response-start-query-execution-output ([input] (response-start-query-execution-output nil input)) ([resultWrapper1514881 input] (clojure.core/let [rawinput1514880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514882 {"QueryExecutionId" (rawinput1514880 "QueryExecutionId")}] (clojure.core/cond-> {} (letvar1514882 "QueryExecutionId") (clojure.core/assoc :query-execution-id (deser-query-execution-id (clojure.core/get-in letvar1514882 ["QueryExecutionId"])))))))

(clojure.core/defn- response-get-named-query-output ([input] (response-get-named-query-output nil input)) ([resultWrapper1514884 input] (clojure.core/let [rawinput1514883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514885 {"NamedQuery" (rawinput1514883 "NamedQuery")}] (clojure.core/cond-> {} (letvar1514885 "NamedQuery") (clojure.core/assoc :named-query (deser-named-query (clojure.core/get-in letvar1514885 ["NamedQuery"])))))))

(clojure.core/defn- response-delete-named-query-output ([input] (response-delete-named-query-output nil input)) ([resultWrapper1514887 input] (clojure.core/let [rawinput1514886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514888 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-query-execution-output ([input] (response-batch-get-query-execution-output nil input)) ([resultWrapper1514890 input] (clojure.core/let [rawinput1514889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514891 {"QueryExecutions" (rawinput1514889 "QueryExecutions"), "UnprocessedQueryExecutionIds" (rawinput1514889 "UnprocessedQueryExecutionIds")}] (clojure.core/cond-> {} (letvar1514891 "QueryExecutions") (clojure.core/assoc :query-executions (deser-query-execution-list (clojure.core/get-in letvar1514891 ["QueryExecutions"]))) (letvar1514891 "UnprocessedQueryExecutionIds") (clojure.core/assoc :unprocessed-query-execution-ids (deser-unprocessed-query-execution-id-list (clojure.core/get-in letvar1514891 ["UnprocessedQueryExecutionIds"])))))))

(clojure.core/defn- response-list-work-groups-output ([input] (response-list-work-groups-output nil input)) ([resultWrapper1514893 input] (clojure.core/let [rawinput1514892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514894 {"WorkGroups" (rawinput1514892 "WorkGroups"), "NextToken" (rawinput1514892 "NextToken")}] (clojure.core/cond-> {} (letvar1514894 "WorkGroups") (clojure.core/assoc :work-groups (deser-work-groups-list (clojure.core/get-in letvar1514894 ["WorkGroups"]))) (letvar1514894 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1514894 ["NextToken"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper1514896 input] (clojure.core/let [rawinput1514895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514897 {"Tags" (rawinput1514895 "Tags"), "NextToken" (rawinput1514895 "NextToken")}] (clojure.core/cond-> {} (letvar1514897 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1514897 ["Tags"]))) (letvar1514897 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1514897 ["NextToken"])))))))

(clojure.core/defn- response-delete-work-group-output ([input] (response-delete-work-group-output nil input)) ([resultWrapper1514899 input] (clojure.core/let [rawinput1514898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514900 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-output ([input] (response-untag-resource-output nil input)) ([resultWrapper1514902 input] (clojure.core/let [rawinput1514901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514903 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-work-group-output ([input] (response-get-work-group-output nil input)) ([resultWrapper1514905 input] (clojure.core/let [rawinput1514904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514906 {"WorkGroup" (rawinput1514904 "WorkGroup")}] (clojure.core/cond-> {} (letvar1514906 "WorkGroup") (clojure.core/assoc :work-group (deser-work-group (clojure.core/get-in letvar1514906 ["WorkGroup"])))))))

(clojure.core/defn- response-get-query-results-output ([input] (response-get-query-results-output nil input)) ([resultWrapper1514908 input] (clojure.core/let [rawinput1514907 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514909 {"UpdateCount" (rawinput1514907 "UpdateCount"), "ResultSet" (rawinput1514907 "ResultSet"), "NextToken" (rawinput1514907 "NextToken")}] (clojure.core/cond-> {} (letvar1514909 "UpdateCount") (clojure.core/assoc :update-count (deser-long (clojure.core/get-in letvar1514909 ["UpdateCount"]))) (letvar1514909 "ResultSet") (clojure.core/assoc :result-set (deser-result-set (clojure.core/get-in letvar1514909 ["ResultSet"]))) (letvar1514909 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1514909 ["NextToken"])))))))

(clojure.core/defn- response-list-query-executions-output ([input] (response-list-query-executions-output nil input)) ([resultWrapper1514911 input] (clojure.core/let [rawinput1514910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1514912 {"QueryExecutionIds" (rawinput1514910 "QueryExecutionIds"), "NextToken" (rawinput1514910 "NextToken")}] (clojure.core/cond-> {} (letvar1514912 "QueryExecutionIds") (clojure.core/assoc :query-execution-ids (deser-query-execution-id-list (clojure.core/get-in letvar1514912 ["QueryExecutionIds"]))) (letvar1514912 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1514912 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/work-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-z0-9._-]{1,128}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/amazon-resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1011))))

(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-resource-output (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/database-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 262144))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 32 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena.-2017-05-18/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
