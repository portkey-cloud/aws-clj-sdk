...
(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1794054 input] (clojure.core/let [rawinput1794053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794055 {"Message" (rawinput1794053 "Message")}] (clojure.core/cond-> {} (letvar1794055 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794055 ["Message"])))))))

(clojure.core/defn- response-describe-game-session-details-output ([input] (response-describe-game-session-details-output nil input)) ([resultWrapper1794057 input] (clojure.core/let [rawinput1794056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794058 {"GameSessionDetails" (rawinput1794056 "GameSessionDetails"), "NextToken" (rawinput1794056 "NextToken")}] (clojure.core/cond-> {} (letvar1794058 "GameSessionDetails") (clojure.core/assoc :game-session-details (deser-game-session-detail-list (clojure.core/get-in letvar1794058 ["GameSessionDetails"]))) (letvar1794058 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794058 ["NextToken"])))))))

(clojure.core/defn- response-describe-matchmaking-rule-sets-output ([input] (response-describe-matchmaking-rule-sets-output nil input)) ([resultWrapper1794060 input] (clojure.core/let [rawinput1794059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794061 {"RuleSets" (rawinput1794059 "RuleSets"), "NextToken" (rawinput1794059 "NextToken")}] (clojure.core/cond-> {:rule-sets (deser-matchmaking-rule-set-list (clojure.core/get-in letvar1794061 ["RuleSets"]))} (letvar1794061 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794061 ["NextToken"])))))))

(clojure.core/defn- response-describe-fleet-utilization-output ([input] (response-describe-fleet-utilization-output nil input)) ([resultWrapper1794063 input] (clojure.core/let [rawinput1794062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794064 {"FleetUtilization" (rawinput1794062 "FleetUtilization"), "NextToken" (rawinput1794062 "NextToken")}] (clojure.core/cond-> {} (letvar1794064 "FleetUtilization") (clojure.core/assoc :fleet-utilization (deser-fleet-utilization-list (clojure.core/get-in letvar1794064 ["FleetUtilization"]))) (letvar1794064 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794064 ["NextToken"])))))))

(clojure.core/defn- response-game-session-full-exception ([input] (response-game-session-full-exception nil input)) ([resultWrapper1794066 input] (clojure.core/let [rawinput1794065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794067 {"Message" (rawinput1794065 "Message")}] (clojure.core/cond-> {} (letvar1794067 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794067 ["Message"])))))))

(clojure.core/defn- response-create-player-session-output ([input] (response-create-player-session-output nil input)) ([resultWrapper1794069 input] (clojure.core/let [rawinput1794068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794070 {"PlayerSession" (rawinput1794068 "PlayerSession")}] (clojure.core/cond-> {} (letvar1794070 "PlayerSession") (clojure.core/assoc :player-session (deser-player-session (clojure.core/get-in letvar1794070 ["PlayerSession"])))))))

(clojure.core/defn- response-update-fleet-attributes-output ([input] (response-update-fleet-attributes-output nil input)) ([resultWrapper1794072 input] (clojure.core/let [rawinput1794071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794073 {"FleetId" (rawinput1794071 "FleetId")}] (clojure.core/cond-> {} (letvar1794073 "FleetId") (clojure.core/assoc :fleet-id (deser-fleet-id (clojure.core/get-in letvar1794073 ["FleetId"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1794075 input] (clojure.core/let [rawinput1794074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794076 {"Message" (rawinput1794074 "Message")}] (clojure.core/cond-> {} (letvar1794076 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794076 ["Message"])))))))

(clojure.core/defn- response-update-matchmaking-configuration-output ([input] (response-update-matchmaking-configuration-output nil input)) ([resultWrapper1794078 input] (clojure.core/let [rawinput1794077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794079 {"Configuration" (rawinput1794077 "Configuration")}] (clojure.core/cond-> {} (letvar1794079 "Configuration") (clojure.core/assoc :configuration (deser-matchmaking-configuration (clojure.core/get-in letvar1794079 ["Configuration"])))))))

(clojure.core/defn- response-describe-game-session-placement-output ([input] (response-describe-game-session-placement-output nil input)) ([resultWrapper1794081 input] (clojure.core/let [rawinput1794080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794082 {"GameSessionPlacement" (rawinput1794080 "GameSessionPlacement")}] (clojure.core/cond-> {} (letvar1794082 "GameSessionPlacement") (clojure.core/assoc :game-session-placement (deser-game-session-placement (clojure.core/get-in letvar1794082 ["GameSessionPlacement"])))))))

(clojure.core/defn- response-get-game-session-log-url-output ([input] (response-get-game-session-log-url-output nil input)) ([resultWrapper1794084 input] (clojure.core/let [rawinput1794083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794085 {"PreSignedUrl" (rawinput1794083 "PreSignedUrl")}] (clojure.core/cond-> {} (letvar1794085 "PreSignedUrl") (clojure.core/assoc :pre-signed-url (deser-non-zero-and-max-string (clojure.core/get-in letvar1794085 ["PreSignedUrl"])))))))

(clojure.core/defn- response-create-game-session-queue-output ([input] (response-create-game-session-queue-output nil input)) ([resultWrapper1794087 input] (clojure.core/let [rawinput1794086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794088 {"GameSessionQueue" (rawinput1794086 "GameSessionQueue")}] (clojure.core/cond-> {} (letvar1794088 "GameSessionQueue") (clojure.core/assoc :game-session-queue (deser-game-session-queue (clojure.core/get-in letvar1794088 ["GameSessionQueue"])))))))

(clojure.core/defn- response-terminal-routing-strategy-exception ([input] (response-terminal-routing-strategy-exception nil input)) ([resultWrapper1794090 input] (clojure.core/let [rawinput1794089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794091 {"Message" (rawinput1794089 "Message")}] (clojure.core/cond-> {} (letvar1794091 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794091 ["Message"])))))))

(clojure.core/defn- response-update-game-session-output ([input] (response-update-game-session-output nil input)) ([resultWrapper1794093 input] (clojure.core/let [rawinput1794092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794094 {"GameSession" (rawinput1794092 "GameSession")}] (clojure.core/cond-> {} (letvar1794094 "GameSession") (clojure.core/assoc :game-session (deser-game-session (clojure.core/get-in letvar1794094 ["GameSession"])))))))

(clojure.core/defn- response-create-vpc-peering-connection-output ([input] (response-create-vpc-peering-connection-output nil input)) ([resultWrapper1794096 input] (clojure.core/let [rawinput1794095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794097 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-fleet-output ([input] (response-create-fleet-output nil input)) ([resultWrapper1794099 input] (clojure.core/let [rawinput1794098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794100 {"FleetAttributes" (rawinput1794098 "FleetAttributes")}] (clojure.core/cond-> {} (letvar1794100 "FleetAttributes") (clojure.core/assoc :fleet-attributes (deser-fleet-attributes (clojure.core/get-in letvar1794100 ["FleetAttributes"])))))))

(clojure.core/defn- response-describe-game-session-queues-output ([input] (response-describe-game-session-queues-output nil input)) ([resultWrapper1794102 input] (clojure.core/let [rawinput1794101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794103 {"GameSessionQueues" (rawinput1794101 "GameSessionQueues"), "NextToken" (rawinput1794101 "NextToken")}] (clojure.core/cond-> {} (letvar1794103 "GameSessionQueues") (clojure.core/assoc :game-session-queues (deser-game-session-queue-list (clojure.core/get-in letvar1794103 ["GameSessionQueues"]))) (letvar1794103 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794103 ["NextToken"])))))))

(clojure.core/defn- response-delete-matchmaking-rule-set-output ([input] (response-delete-matchmaking-rule-set-output nil input)) ([resultWrapper1794105 input] (clojure.core/let [rawinput1794104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794106 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-matchmaking-output ([input] (response-start-matchmaking-output nil input)) ([resultWrapper1794108 input] (clojure.core/let [rawinput1794107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794109 {"MatchmakingTicket" (rawinput1794107 "MatchmakingTicket")}] (clojure.core/cond-> {} (letvar1794109 "MatchmakingTicket") (clojure.core/assoc :matchmaking-ticket (deser-matchmaking-ticket (clojure.core/get-in letvar1794109 ["MatchmakingTicket"])))))))

(clojure.core/defn- response-create-player-sessions-output ([input] (response-create-player-sessions-output nil input)) ([resultWrapper1794111 input] (clojure.core/let [rawinput1794110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794112 {"PlayerSessions" (rawinput1794110 "PlayerSessions")}] (clojure.core/cond-> {} (letvar1794112 "PlayerSessions") (clojure.core/assoc :player-sessions (deser-player-session-list (clojure.core/get-in letvar1794112 ["PlayerSessions"])))))))

(clojure.core/defn- response-delete-game-session-queue-output ([input] (response-delete-game-session-queue-output nil input)) ([resultWrapper1794114 input] (clojure.core/let [rawinput1794113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794115 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1794117 input] (clojure.core/let [rawinput1794116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794118 {"Message" (rawinput1794116 "Message")}] (clojure.core/cond-> {} (letvar1794118 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794118 ["Message"])))))))

(clojure.core/defn- response-invalid-game-session-status-exception ([input] (response-invalid-game-session-status-exception nil input)) ([resultWrapper1794120 input] (clojure.core/let [rawinput1794119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794121 {"Message" (rawinput1794119 "Message")}] (clojure.core/cond-> {} (letvar1794121 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794121 ["Message"])))))))

(clojure.core/defn- response-start-match-backfill-output ([input] (response-start-match-backfill-output nil input)) ([resultWrapper1794123 input] (clojure.core/let [rawinput1794122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794124 {"MatchmakingTicket" (rawinput1794122 "MatchmakingTicket")}] (clojure.core/cond-> {} (letvar1794124 "MatchmakingTicket") (clojure.core/assoc :matchmaking-ticket (deser-matchmaking-ticket (clojure.core/get-in letvar1794124 ["MatchmakingTicket"])))))))

(clojure.core/defn- response-describe-alias-output ([input] (response-describe-alias-output nil input)) ([resultWrapper1794126 input] (clojure.core/let [rawinput1794125 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794127 {"Alias" (rawinput1794125 "Alias")}] (clojure.core/cond-> {} (letvar1794127 "Alias") (clojure.core/assoc :alias (deser-alias (clojure.core/get-in letvar1794127 ["Alias"])))))))

(clojure.core/defn- response-update-runtime-configuration-output ([input] (response-update-runtime-configuration-output nil input)) ([resultWrapper1794129 input] (clojure.core/let [rawinput1794128 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794130 {"RuntimeConfiguration" (rawinput1794128 "RuntimeConfiguration")}] (clojure.core/cond-> {} (letvar1794130 "RuntimeConfiguration") (clojure.core/assoc :runtime-configuration (deser-runtime-configuration (clojure.core/get-in letvar1794130 ["RuntimeConfiguration"])))))))

(clojure.core/defn- response-fleet-capacity-exceeded-exception ([input] (response-fleet-capacity-exceeded-exception nil input)) ([resultWrapper1794132 input] (clojure.core/let [rawinput1794131 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794133 {"Message" (rawinput1794131 "Message")}] (clojure.core/cond-> {} (letvar1794133 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794133 ["Message"])))))))

(clojure.core/defn- response-create-matchmaking-configuration-output ([input] (response-create-matchmaking-configuration-output nil input)) ([resultWrapper1794135 input] (clojure.core/let [rawinput1794134 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794136 {"Configuration" (rawinput1794134 "Configuration")}] (clojure.core/cond-> {} (letvar1794136 "Configuration") (clojure.core/assoc :configuration (deser-matchmaking-configuration (clojure.core/get-in letvar1794136 ["Configuration"])))))))

(clojure.core/defn- response-request-upload-credentials-output ([input] (response-request-upload-credentials-output nil input)) ([resultWrapper1794138 input] (clojure.core/let [rawinput1794137 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794139 {"UploadCredentials" (rawinput1794137 "UploadCredentials"), "StorageLocation" (rawinput1794137 "StorageLocation")}] (clojure.core/cond-> {} (letvar1794139 "UploadCredentials") (clojure.core/assoc :upload-credentials (deser-aws-credentials (clojure.core/get-in letvar1794139 ["UploadCredentials"]))) (letvar1794139 "StorageLocation") (clojure.core/assoc :storage-location (deser-s-3-location (clojure.core/get-in letvar1794139 ["StorageLocation"])))))))

(clojure.core/defn- response-update-alias-output ([input] (response-update-alias-output nil input)) ([resultWrapper1794141 input] (clojure.core/let [rawinput1794140 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794142 {"Alias" (rawinput1794140 "Alias")}] (clojure.core/cond-> {} (letvar1794142 "Alias") (clojure.core/assoc :alias (deser-alias (clojure.core/get-in letvar1794142 ["Alias"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper1794144 input] (clojure.core/let [rawinput1794143 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794145 {"Builds" (rawinput1794143 "Builds"), "NextToken" (rawinput1794143 "NextToken")}] (clojure.core/cond-> {} (letvar1794145 "Builds") (clojure.core/assoc :builds (deser-build-list (clojure.core/get-in letvar1794145 ["Builds"]))) (letvar1794145 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1794145 ["NextToken"])))))))

(clojure.core/defn- response-stop-fleet-actions-output ([input] (response-stop-fleet-actions-output nil input)) ([resultWrapper1794147 input] (clojure.core/let [rawinput1794146 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794148 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-game-session-output ([input] (response-create-game-session-output nil input)) ([resultWrapper1794150 input] (clojure.core/let [rawinput1794149 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794151 {"GameSession" (rawinput1794149 "GameSession")}] (clojure.core/cond-> {} (letvar1794151 "GameSession") (clojure.core/assoc :game-session (deser-game-session (clojure.core/get-in letvar1794151 ["GameSession"])))))))

(clojure.core/defn- response-create-alias-output ([input] (response-create-alias-output nil input)) ([resultWrapper1794153 input] (clojure.core/let [rawinput1794152 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794154 {"Alias" (rawinput1794152 "Alias")}] (clojure.core/cond-> {} (letvar1794154 "Alias") (clojure.core/assoc :alias (deser-alias (clojure.core/get-in letvar1794154 ["Alias"])))))))

(clojure.core/defn- response-describe-game-sessions-output ([input] (response-describe-game-sessions-output nil input)) ([resultWrapper1794156 input] (clojure.core/let [rawinput1794155 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794157 {"GameSessions" (rawinput1794155 "GameSessions"), "NextToken" (rawinput1794155 "NextToken")}] (clojure.core/cond-> {} (letvar1794157 "GameSessions") (clojure.core/assoc :game-sessions (deser-game-session-list (clojure.core/get-in letvar1794157 ["GameSessions"]))) (letvar1794157 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794157 ["NextToken"])))))))

(clojure.core/defn- response-update-game-session-queue-output ([input] (response-update-game-session-queue-output nil input)) ([resultWrapper1794159 input] (clojure.core/let [rawinput1794158 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794160 {"GameSessionQueue" (rawinput1794158 "GameSessionQueue")}] (clojure.core/cond-> {} (letvar1794160 "GameSessionQueue") (clojure.core/assoc :game-session-queue (deser-game-session-queue (clojure.core/get-in letvar1794160 ["GameSessionQueue"])))))))

(clojure.core/defn- response-describe-fleet-attributes-output ([input] (response-describe-fleet-attributes-output nil input)) ([resultWrapper1794162 input] (clojure.core/let [rawinput1794161 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794163 {"FleetAttributes" (rawinput1794161 "FleetAttributes"), "NextToken" (rawinput1794161 "NextToken")}] (clojure.core/cond-> {} (letvar1794163 "FleetAttributes") (clojure.core/assoc :fleet-attributes (deser-fleet-attributes-list (clojure.core/get-in letvar1794163 ["FleetAttributes"]))) (letvar1794163 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794163 ["NextToken"])))))))

(clojure.core/defn- response-create-vpc-peering-authorization-output ([input] (response-create-vpc-peering-authorization-output nil input)) ([resultWrapper1794165 input] (clojure.core/let [rawinput1794164 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794166 {"VpcPeeringAuthorization" (rawinput1794164 "VpcPeeringAuthorization")}] (clojure.core/cond-> {} (letvar1794166 "VpcPeeringAuthorization") (clojure.core/assoc :vpc-peering-authorization (deser-vpc-peering-authorization (clojure.core/get-in letvar1794166 ["VpcPeeringAuthorization"])))))))

(clojure.core/defn- response-unsupported-region-exception ([input] (response-unsupported-region-exception nil input)) ([resultWrapper1794168 input] (clojure.core/let [rawinput1794167 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794169 {"Message" (rawinput1794167 "Message")}] (clojure.core/cond-> {} (letvar1794169 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794169 ["Message"])))))))

(clojure.core/defn- response-describe-vpc-peering-authorizations-output ([input] (response-describe-vpc-peering-authorizations-output nil input)) ([resultWrapper1794171 input] (clojure.core/let [rawinput1794170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794172 {"VpcPeeringAuthorizations" (rawinput1794170 "VpcPeeringAuthorizations")}] (clojure.core/cond-> {} (letvar1794172 "VpcPeeringAuthorizations") (clojure.core/assoc :vpc-peering-authorizations (deser-vpc-peering-authorization-list (clojure.core/get-in letvar1794172 ["VpcPeeringAuthorizations"])))))))

(clojure.core/defn- response-stop-matchmaking-output ([input] (response-stop-matchmaking-output nil input)) ([resultWrapper1794174 input] (clojure.core/let [rawinput1794173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794175 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1794177 input] (clojure.core/let [rawinput1794176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794178 {"Message" (rawinput1794176 "Message")}] (clojure.core/cond-> {} (letvar1794178 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794178 ["Message"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper1794180 input] (clojure.core/let [rawinput1794179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794181 {"Message" (rawinput1794179 "Message")}] (clojure.core/cond-> {} (letvar1794181 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794181 ["Message"])))))))

(clojure.core/defn- response-create-matchmaking-rule-set-output ([input] (response-create-matchmaking-rule-set-output nil input)) ([resultWrapper1794183 input] (clojure.core/let [rawinput1794182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794184 {"RuleSet" (rawinput1794182 "RuleSet")}] (clojure.core/cond-> {:rule-set (deser-matchmaking-rule-set (clojure.core/get-in letvar1794184 ["RuleSet"]))}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1794186 input] (clojure.core/let [rawinput1794185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794187 {"Message" (rawinput1794185 "Message")}] (clojure.core/cond-> {} (letvar1794187 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794187 ["Message"])))))))

(clojure.core/defn- response-describe-fleet-events-output ([input] (response-describe-fleet-events-output nil input)) ([resultWrapper1794189 input] (clojure.core/let [rawinput1794188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794190 {"Events" (rawinput1794188 "Events"), "NextToken" (rawinput1794188 "NextToken")}] (clojure.core/cond-> {} (letvar1794190 "Events") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar1794190 ["Events"]))) (letvar1794190 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794190 ["NextToken"])))))))

(clojure.core/defn- response-list-aliases-output ([input] (response-list-aliases-output nil input)) ([resultWrapper1794192 input] (clojure.core/let [rawinput1794191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794193 {"Aliases" (rawinput1794191 "Aliases"), "NextToken" (rawinput1794191 "NextToken")}] (clojure.core/cond-> {} (letvar1794193 "Aliases") (clojure.core/assoc :aliases (deser-alias-list (clojure.core/get-in letvar1794193 ["Aliases"]))) (letvar1794193 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1794193 ["NextToken"])))))))

(clojure.core/defn- response-stop-game-session-placement-output ([input] (response-stop-game-session-placement-output nil input)) ([resultWrapper1794195 input] (clojure.core/let [rawinput1794194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794196 {"GameSessionPlacement" (rawinput1794194 "GameSessionPlacement")}] (clojure.core/cond-> {} (letvar1794196 "GameSessionPlacement") (clojure.core/assoc :game-session-placement (deser-game-session-placement (clojure.core/get-in letvar1794196 ["GameSessionPlacement"])))))))

(clojure.core/defn- response-update-build-output ([input] (response-update-build-output nil input)) ([resultWrapper1794198 input] (clojure.core/let [rawinput1794197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794199 {"Build" (rawinput1794197 "Build")}] (clojure.core/cond-> {} (letvar1794199 "Build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1794199 ["Build"])))))))

(clojure.core/defn- response-delete-matchmaking-configuration-output ([input] (response-delete-matchmaking-configuration-output nil input)) ([resultWrapper1794201 input] (clojure.core/let [rawinput1794200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794202 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-search-game-sessions-output ([input] (response-search-game-sessions-output nil input)) ([resultWrapper1794204 input] (clojure.core/let [rawinput1794203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794205 {"GameSessions" (rawinput1794203 "GameSessions"), "NextToken" (rawinput1794203 "NextToken")}] (clojure.core/cond-> {} (letvar1794205 "GameSessions") (clojure.core/assoc :game-sessions (deser-game-session-list (clojure.core/get-in letvar1794205 ["GameSessions"]))) (letvar1794205 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794205 ["NextToken"])))))))

(clojure.core/defn- response-list-fleets-output ([input] (response-list-fleets-output nil input)) ([resultWrapper1794207 input] (clojure.core/let [rawinput1794206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794208 {"FleetIds" (rawinput1794206 "FleetIds"), "NextToken" (rawinput1794206 "NextToken")}] (clojure.core/cond-> {} (letvar1794208 "FleetIds") (clojure.core/assoc :fleet-ids (deser-fleet-id-list (clojure.core/get-in letvar1794208 ["FleetIds"]))) (letvar1794208 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794208 ["NextToken"])))))))

(clojure.core/defn- response-start-fleet-actions-output ([input] (response-start-fleet-actions-output nil input)) ([resultWrapper1794210 input] (clojure.core/let [rawinput1794209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794211 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-build-output ([input] (response-describe-build-output nil input)) ([resultWrapper1794213 input] (clojure.core/let [rawinput1794212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794214 {"Build" (rawinput1794212 "Build")}] (clojure.core/cond-> {} (letvar1794214 "Build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1794214 ["Build"])))))))

(clojure.core/defn- response-invalid-fleet-status-exception ([input] (response-invalid-fleet-status-exception nil input)) ([resultWrapper1794216 input] (clojure.core/let [rawinput1794215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794217 {"Message" (rawinput1794215 "Message")}] (clojure.core/cond-> {} (letvar1794217 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794217 ["Message"])))))))

(clojure.core/defn- response-describe-matchmaking-output ([input] (response-describe-matchmaking-output nil input)) ([resultWrapper1794219 input] (clojure.core/let [rawinput1794218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794220 {"TicketList" (rawinput1794218 "TicketList")}] (clojure.core/cond-> {} (letvar1794220 "TicketList") (clojure.core/assoc :ticket-list (deser-matchmaking-ticket-list (clojure.core/get-in letvar1794220 ["TicketList"])))))))

(clojure.core/defn- response-delete-vpc-peering-connection-output ([input] (response-delete-vpc-peering-connection-output nil input)) ([resultWrapper1794222 input] (clojure.core/let [rawinput1794221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794223 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-scaling-policy-output ([input] (response-put-scaling-policy-output nil input)) ([resultWrapper1794225 input] (clojure.core/let [rawinput1794224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794226 {"Name" (rawinput1794224 "Name")}] (clojure.core/cond-> {} (letvar1794226 "Name") (clojure.core/assoc :name (deser-non-zero-and-max-string (clojure.core/get-in letvar1794226 ["Name"])))))))

(clojure.core/defn- response-start-game-session-placement-output ([input] (response-start-game-session-placement-output nil input)) ([resultWrapper1794228 input] (clojure.core/let [rawinput1794227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794229 {"GameSessionPlacement" (rawinput1794227 "GameSessionPlacement")}] (clojure.core/cond-> {} (letvar1794229 "GameSessionPlacement") (clojure.core/assoc :game-session-placement (deser-game-session-placement (clojure.core/get-in letvar1794229 ["GameSessionPlacement"])))))))

(clojure.core/defn- response-delete-vpc-peering-authorization-output ([input] (response-delete-vpc-peering-authorization-output nil input)) ([resultWrapper1794231 input] (clojure.core/let [rawinput1794230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794232 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-fleet-port-settings-output ([input] (response-describe-fleet-port-settings-output nil input)) ([resultWrapper1794234 input] (clojure.core/let [rawinput1794233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794235 {"InboundPermissions" (rawinput1794233 "InboundPermissions")}] (clojure.core/cond-> {} (letvar1794235 "InboundPermissions") (clojure.core/assoc :inbound-permissions (deser-ip-permissions-list (clojure.core/get-in letvar1794235 ["InboundPermissions"])))))))

(clojure.core/defn- response-update-fleet-port-settings-output ([input] (response-update-fleet-port-settings-output nil input)) ([resultWrapper1794237 input] (clojure.core/let [rawinput1794236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794238 {"FleetId" (rawinput1794236 "FleetId")}] (clojure.core/cond-> {} (letvar1794238 "FleetId") (clojure.core/assoc :fleet-id (deser-fleet-id (clojure.core/get-in letvar1794238 ["FleetId"])))))))

(clojure.core/defn- response-describe-vpc-peering-connections-output ([input] (response-describe-vpc-peering-connections-output nil input)) ([resultWrapper1794240 input] (clojure.core/let [rawinput1794239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794241 {"VpcPeeringConnections" (rawinput1794239 "VpcPeeringConnections")}] (clojure.core/cond-> {} (letvar1794241 "VpcPeeringConnections") (clojure.core/assoc :vpc-peering-connections (deser-vpc-peering-connection-list (clojure.core/get-in letvar1794241 ["VpcPeeringConnections"])))))))

(clojure.core/defn- response-describe-instances-output ([input] (response-describe-instances-output nil input)) ([resultWrapper1794243 input] (clojure.core/let [rawinput1794242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794244 {"Instances" (rawinput1794242 "Instances"), "NextToken" (rawinput1794242 "NextToken")}] (clojure.core/cond-> {} (letvar1794244 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar1794244 ["Instances"]))) (letvar1794244 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794244 ["NextToken"])))))))

(clojure.core/defn- response-describe-scaling-policies-output ([input] (response-describe-scaling-policies-output nil input)) ([resultWrapper1794246 input] (clojure.core/let [rawinput1794245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794247 {"ScalingPolicies" (rawinput1794245 "ScalingPolicies"), "NextToken" (rawinput1794245 "NextToken")}] (clojure.core/cond-> {} (letvar1794247 "ScalingPolicies") (clojure.core/assoc :scaling-policies (deser-scaling-policy-list (clojure.core/get-in letvar1794247 ["ScalingPolicies"]))) (letvar1794247 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794247 ["NextToken"])))))))

(clojure.core/defn- response-describe-player-sessions-output ([input] (response-describe-player-sessions-output nil input)) ([resultWrapper1794249 input] (clojure.core/let [rawinput1794248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794250 {"PlayerSessions" (rawinput1794248 "PlayerSessions"), "NextToken" (rawinput1794248 "NextToken")}] (clojure.core/cond-> {} (letvar1794250 "PlayerSessions") (clojure.core/assoc :player-sessions (deser-player-session-list (clojure.core/get-in letvar1794250 ["PlayerSessions"]))) (letvar1794250 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794250 ["NextToken"])))))))

(clojure.core/defn- response-get-instance-access-output ([input] (response-get-instance-access-output nil input)) ([resultWrapper1794252 input] (clojure.core/let [rawinput1794251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794253 {"InstanceAccess" (rawinput1794251 "InstanceAccess")}] (clojure.core/cond-> {} (letvar1794253 "InstanceAccess") (clojure.core/assoc :instance-access (deser-instance-access (clojure.core/get-in letvar1794253 ["InstanceAccess"])))))))

(clojure.core/defn- response-resolve-alias-output ([input] (response-resolve-alias-output nil input)) ([resultWrapper1794255 input] (clojure.core/let [rawinput1794254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794256 {"FleetId" (rawinput1794254 "FleetId")}] (clojure.core/cond-> {} (letvar1794256 "FleetId") (clojure.core/assoc :fleet-id (deser-fleet-id (clojure.core/get-in letvar1794256 ["FleetId"])))))))

(clojure.core/defn- response-describe-runtime-configuration-output ([input] (response-describe-runtime-configuration-output nil input)) ([resultWrapper1794258 input] (clojure.core/let [rawinput1794257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794259 {"RuntimeConfiguration" (rawinput1794257 "RuntimeConfiguration")}] (clojure.core/cond-> {} (letvar1794259 "RuntimeConfiguration") (clojure.core/assoc :runtime-configuration (deser-runtime-configuration (clojure.core/get-in letvar1794259 ["RuntimeConfiguration"])))))))

(clojure.core/defn- response-describe-fleet-capacity-output ([input] (response-describe-fleet-capacity-output nil input)) ([resultWrapper1794261 input] (clojure.core/let [rawinput1794260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794262 {"FleetCapacity" (rawinput1794260 "FleetCapacity"), "NextToken" (rawinput1794260 "NextToken")}] (clojure.core/cond-> {} (letvar1794262 "FleetCapacity") (clojure.core/assoc :fleet-capacity (deser-fleet-capacity-list (clojure.core/get-in letvar1794262 ["FleetCapacity"]))) (letvar1794262 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794262 ["NextToken"])))))))

(clojure.core/defn- response-create-build-output ([input] (response-create-build-output nil input)) ([resultWrapper1794264 input] (clojure.core/let [rawinput1794263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794265 {"Build" (rawinput1794263 "Build"), "UploadCredentials" (rawinput1794263 "UploadCredentials"), "StorageLocation" (rawinput1794263 "StorageLocation")}] (clojure.core/cond-> {} (letvar1794265 "Build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1794265 ["Build"]))) (letvar1794265 "UploadCredentials") (clojure.core/assoc :upload-credentials (deser-aws-credentials (clojure.core/get-in letvar1794265 ["UploadCredentials"]))) (letvar1794265 "StorageLocation") (clojure.core/assoc :storage-location (deser-s-3-location (clojure.core/get-in letvar1794265 ["StorageLocation"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1794267 input] (clojure.core/let [rawinput1794266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794268 {"Message" (rawinput1794266 "Message")}] (clojure.core/cond-> {} (letvar1794268 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1794268 ["Message"])))))))

(clojure.core/defn- response-describe-matchmaking-configurations-output ([input] (response-describe-matchmaking-configurations-output nil input)) ([resultWrapper1794270 input] (clojure.core/let [rawinput1794269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794271 {"Configurations" (rawinput1794269 "Configurations"), "NextToken" (rawinput1794269 "NextToken")}] (clojure.core/cond-> {} (letvar1794271 "Configurations") (clojure.core/assoc :configurations (deser-matchmaking-configuration-list (clojure.core/get-in letvar1794271 ["Configurations"]))) (letvar1794271 "NextToken") (clojure.core/assoc :next-token (deser-non-zero-and-max-string (clojure.core/get-in letvar1794271 ["NextToken"])))))))

(clojure.core/defn- response-validate-matchmaking-rule-set-output ([input] (response-validate-matchmaking-rule-set-output nil input)) ([resultWrapper1794273 input] (clojure.core/let [rawinput1794272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794274 {"Valid" (rawinput1794272 "Valid")}] (clojure.core/cond-> {} (letvar1794274 "Valid") (clojure.core/assoc :valid (deser-boolean-model (clojure.core/get-in letvar1794274 ["Valid"])))))))

(clojure.core/defn- response-update-fleet-capacity-output ([input] (response-update-fleet-capacity-output nil input)) ([resultWrapper1794276 input] (clojure.core/let [rawinput1794275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794277 {"FleetId" (rawinput1794275 "FleetId")}] (clojure.core/cond-> {} (letvar1794277 "FleetId") (clojure.core/assoc :fleet-id (deser-fleet-id (clojure.core/get-in letvar1794277 ["FleetId"])))))))

(clojure.core/defn- response-describe-ec-2-instance-limits-output ([input] (response-describe-ec-2-instance-limits-output nil input)) ([resultWrapper1794279 input] (clojure.core/let [rawinput1794278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794280 {"EC2InstanceLimits" (rawinput1794278 "EC2InstanceLimits")}] (clojure.core/cond-> {} (letvar1794280 "EC2InstanceLimits") (clojure.core/assoc :ec-2-instance-limits (deser-ec-2-instance-limit-list (clojure.core/get-in letvar1794280 ["EC2InstanceLimits"])))))))

(clojure.core/defn- response-accept-match-output ([input] (response-accept-match-output nil input)) ([resultWrapper1794282 input] (clojure.core/let [rawinput1794281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1794283 {}] (clojure.core/cond-> {}))))

(clojure.spec.alpha/def :portkey.aws.gamelift/metric-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/non-zero-and-max-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/rule-set-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 65535))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/game-property-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\.-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/game-property-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 96))))

(clojure.spec.alpha/def :portkey.aws.gamelift/double-object clojure.core/double?)

(clojure.spec.alpha/def :portkey.aws.gamelift/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/custom-event-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/player-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/fleet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^fleet-\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/delete-matchmaking-rule-set-output (clojure.spec.alpha/keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/matchmaker-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 390000))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/alias-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^alias-\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/game-session-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 4096))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/player-session-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^psess-\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift.delete-matchmaking-rule-set-input/name (clojure.spec.alpha/and :portkey.aws.gamelift/matchmaking-id-string-model))
(clojure.spec.alpha/def :portkey.aws.gamelift/delete-matchmaking-rule-set-input (clojure.spec.alpha/keys :req-un [:portkey.aws.gamelift.delete-matchmaking-rule-set-input/name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/non-blank-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^\s]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/game-session-queue-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.gamelift/build-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^build-\S+" s__1467903__auto__))))
...
(clojure.core/defn update-runtime-configuration ([update-runtime-configuration-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-update-runtime-configuration-input update-runtime-configuration-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/update-runtime-configuration-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/update-runtime-configuration-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateRuntimeConfiguration", :http.request.configuration/output-deser-fn response-update-runtime-configuration-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "InvalidFleetStatusException" :portkey.aws.gamelift/invalid-fleet-status-exception}})))))
...
(clojure.core/defn list-fleets ([] (list-fleets {})) ([list-fleets-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-fleets-input list-fleets-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/list-fleets-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/list-fleets-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListFleets", :http.request.configuration/output-deser-fn response-list-fleets-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn create-alias ([create-alias-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-alias-input create-alias-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-alias-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-alias-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateAlias", :http.request.configuration/output-deser-fn response-create-alias-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "ConflictException" :portkey.aws.gamelift/conflict-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "LimitExceededException" :portkey.aws.gamelift/limit-exceeded-exception}})))))
...
(clojure.core/defn stop-game-session-placement ([stop-game-session-placement-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-stop-game-session-placement-input stop-game-session-placement-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/stop-game-session-placement-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/stop-game-session-placement-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StopGameSessionPlacement", :http.request.configuration/output-deser-fn response-stop-game-session-placement-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn create-fleet ([create-fleet-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-fleet-input create-fleet-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-fleet-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-fleet-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateFleet", :http.request.configuration/output-deser-fn response-create-fleet-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "ConflictException" :portkey.aws.gamelift/conflict-exception, "LimitExceededException" :portkey.aws.gamelift/limit-exceeded-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn list-builds ([] (list-builds {})) ([list-builds-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-builds-input list-builds-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/list-builds-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/list-builds-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListBuilds", :http.request.configuration/output-deser-fn response-list-builds-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn resolve-alias ([resolve-alias-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-resolve-alias-input resolve-alias-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/resolve-alias-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/resolve-alias-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ResolveAlias", :http.request.configuration/output-deser-fn response-resolve-alias-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn update-build ([update-build-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-update-build-input update-build-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/update-build-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/update-build-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateBuild", :http.request.configuration/output-deser-fn response-update-build-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-game-session-queues ([] (describe-game-session-queues {})) ([describe-game-session-queues-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-game-session-queues-input describe-game-session-queues-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-game-session-queues-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-game-session-queues-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeGameSessionQueues", :http.request.configuration/output-deser-fn response-describe-game-session-queues-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn get-game-session-log-url ([get-game-session-log-url-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-get-game-session-log-url-input get-game-session-log-url-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/get-game-session-log-url-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/get-game-session-log-url-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetGameSessionLogUrl", :http.request.configuration/output-deser-fn response-get-game-session-log-url-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception}})))))
...
(clojure.core/defn update-fleet-port-settings ([update-fleet-port-settings-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-update-fleet-port-settings-input update-fleet-port-settings-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/update-fleet-port-settings-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/update-fleet-port-settings-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateFleetPortSettings", :http.request.configuration/output-deser-fn response-update-fleet-port-settings-output, :http.request.spec/error-spec {"NotFoundException" :portkey.aws.gamelift/not-found-exception, "ConflictException" :portkey.aws.gamelift/conflict-exception, "InvalidFleetStatusException" :portkey.aws.gamelift/invalid-fleet-status-exception, "LimitExceededException" :portkey.aws.gamelift/limit-exceeded-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-scaling-policies ([describe-scaling-policies-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-scaling-policies-input describe-scaling-policies-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-scaling-policies-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-scaling-policies-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeScalingPolicies", :http.request.configuration/output-deser-fn response-describe-scaling-policies-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception}})))))
...
(clojure.core/defn stop-fleet-actions ([stop-fleet-actions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-stop-fleet-actions-input stop-fleet-actions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/stop-fleet-actions-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/stop-fleet-actions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StopFleetActions", :http.request.configuration/output-deser-fn response-stop-fleet-actions-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception}})))))
...
(clojure.core/defn describe-game-session-details ([] (describe-game-session-details {})) ([describe-game-session-details-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-game-session-details-input describe-game-session-details-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-game-session-details-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-game-session-details-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeGameSessionDetails", :http.request.configuration/output-deser-fn response-describe-game-session-details-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception}})))))
...
(clojure.core/defn create-game-session-queue ([create-game-session-queue-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-game-session-queue-input create-game-session-queue-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-game-session-queue-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-game-session-queue-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateGameSessionQueue", :http.request.configuration/output-deser-fn response-create-game-session-queue-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "LimitExceededException" :portkey.aws.gamelift/limit-exceeded-exception}})))))
...
(clojure.core/defn create-vpc-peering-authorization ([create-vpc-peering-authorization-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-vpc-peering-authorization-input create-vpc-peering-authorization-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-vpc-peering-authorization-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-vpc-peering-authorization-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateVpcPeeringAuthorization", :http.request.configuration/output-deser-fn response-create-vpc-peering-authorization-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn create-build ([] (create-build {})) ([create-build-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-build-input create-build-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-build-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-build-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateBuild", :http.request.configuration/output-deser-fn response-create-build-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "ConflictException" :portkey.aws.gamelift/conflict-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-game-session-placement ([describe-game-session-placement-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-game-session-placement-input describe-game-session-placement-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-game-session-placement-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-game-session-placement-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeGameSessionPlacement", :http.request.configuration/output-deser-fn response-describe-game-session-placement-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-game-sessions ([] (describe-game-sessions {})) ([describe-game-sessions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-game-sessions-input describe-game-sessions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-game-sessions-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-game-sessions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeGameSessions", :http.request.configuration/output-deser-fn response-describe-game-sessions-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception}})))))
...
(clojure.core/defn describe-fleet-port-settings ([describe-fleet-port-settings-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-fleet-port-settings-input describe-fleet-port-settings-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-fleet-port-settings-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-fleet-port-settings-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeFleetPortSettings", :http.request.configuration/output-deser-fn response-describe-fleet-port-settings-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-fleet-utilization ([] (describe-fleet-utilization {})) ([describe-fleet-utilization-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-fleet-utilization-input describe-fleet-utilization-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-fleet-utilization-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-fleet-utilization-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeFleetUtilization", :http.request.configuration/output-deser-fn response-describe-fleet-utilization-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-alias ([describe-alias-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-alias-input describe-alias-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-alias-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-alias-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeAlias", :http.request.configuration/output-deser-fn response-describe-alias-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-runtime-configuration ([describe-runtime-configuration-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-runtime-configuration-input describe-runtime-configuration-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-runtime-configuration-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-runtime-configuration-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeRuntimeConfiguration", :http.request.configuration/output-deser-fn response-describe-runtime-configuration-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception}})))))
...
(clojure.core/defn list-aliases ([] (list-aliases {})) ([list-aliases-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-aliases-input list-aliases-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/list-aliases-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/list-aliases-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListAliases", :http.request.configuration/output-deser-fn response-list-aliases-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn delete-game-session-queue ([delete-game-session-queue-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-game-session-queue-input delete-game-session-queue-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/delete-game-session-queue-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/delete-game-session-queue-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteGameSessionQueue", :http.request.configuration/output-deser-fn response-delete-game-session-queue-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn create-player-sessions ([create-player-sessions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-player-sessions-input create-player-sessions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-player-sessions-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-player-sessions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreatePlayerSessions", :http.request.configuration/output-deser-fn response-create-player-sessions-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidGameSessionStatusException" :portkey.aws.gamelift/invalid-game-session-status-exception, "GameSessionFullException" :portkey.aws.gamelift/game-session-full-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception}})))))
...
(clojure.core/defn create-player-session ([create-player-session-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-player-session-input create-player-session-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-player-session-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-player-session-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreatePlayerSession", :http.request.configuration/output-deser-fn response-create-player-session-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidGameSessionStatusException" :portkey.aws.gamelift/invalid-game-session-status-exception, "GameSessionFullException" :portkey.aws.gamelift/game-session-full-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception}})))))
...
(clojure.core/defn delete-alias ([delete-alias-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-alias-input delete-alias-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/delete-alias-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteAlias", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn delete-build ([delete-build-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-build-input delete-build-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/delete-build-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteBuild", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception}})))))
...
(clojure.core/defn update-game-session-queue ([update-game-session-queue-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-update-game-session-queue-input update-game-session-queue-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/update-game-session-queue-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/update-game-session-queue-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateGameSessionQueue", :http.request.configuration/output-deser-fn response-update-game-session-queue-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn start-game-session-placement ([start-game-session-placement-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-start-game-session-placement-input start-game-session-placement-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/start-game-session-placement-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/start-game-session-placement-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StartGameSessionPlacement", :http.request.configuration/output-deser-fn response-start-game-session-placement-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-vpc-peering-authorizations ([] (describe-vpc-peering-authorizations {})) ([describe-vpc-peering-authorizations-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-vpc-peering-authorizations-input describe-vpc-peering-authorizations-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-vpc-peering-authorizations-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-vpc-peering-authorizations-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeVpcPeeringAuthorizations", :http.request.configuration/output-deser-fn response-describe-vpc-peering-authorizations-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-player-sessions ([] (describe-player-sessions {})) ([describe-player-sessions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-player-sessions-input describe-player-sessions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-player-sessions-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-player-sessions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribePlayerSessions", :http.request.configuration/output-deser-fn response-describe-player-sessions-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn get-instance-access ([get-instance-access-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-get-instance-access-input get-instance-access-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/get-instance-access-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/get-instance-access-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetInstanceAccess", :http.request.configuration/output-deser-fn response-get-instance-access-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-fleet-capacity ([] (describe-fleet-capacity {})) ([describe-fleet-capacity-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-fleet-capacity-input describe-fleet-capacity-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-fleet-capacity-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-fleet-capacity-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeFleetCapacity", :http.request.configuration/output-deser-fn response-describe-fleet-capacity-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn describe-vpc-peering-connections ([] (describe-vpc-peering-connections {})) ([describe-vpc-peering-connections-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-vpc-peering-connections-input describe-vpc-peering-connections-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-vpc-peering-connections-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-vpc-peering-connections-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeVpcPeeringConnections", :http.request.configuration/output-deser-fn response-describe-vpc-peering-connections-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-fleet-attributes ([] (describe-fleet-attributes {})) ([describe-fleet-attributes-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-fleet-attributes-input describe-fleet-attributes-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-fleet-attributes-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-fleet-attributes-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeFleetAttributes", :http.request.configuration/output-deser-fn response-describe-fleet-attributes-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception}})))))
...
(clojure.core/defn create-vpc-peering-connection ([create-vpc-peering-connection-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-vpc-peering-connection-input create-vpc-peering-connection-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-vpc-peering-connection-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-vpc-peering-connection-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateVpcPeeringConnection", :http.request.configuration/output-deser-fn response-create-vpc-peering-connection-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn start-fleet-actions ([start-fleet-actions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-start-fleet-actions-input start-fleet-actions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/start-fleet-actions-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/start-fleet-actions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StartFleetActions", :http.request.configuration/output-deser-fn response-start-fleet-actions-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception}})))))
...
(clojure.core/defn delete-vpc-peering-authorization ([delete-vpc-peering-authorization-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-vpc-peering-authorization-input delete-vpc-peering-authorization-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/delete-vpc-peering-authorization-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/delete-vpc-peering-authorization-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteVpcPeeringAuthorization", :http.request.configuration/output-deser-fn response-delete-vpc-peering-authorization-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn validate-matchmaking-rule-set ([validate-matchmaking-rule-set-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-validate-matchmaking-rule-set-input validate-matchmaking-rule-set-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/validate-matchmaking-rule-set-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/validate-matchmaking-rule-set-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ValidateMatchmakingRuleSet", :http.request.configuration/output-deser-fn response-validate-matchmaking-rule-set-output, :http.request.spec/error-spec {"InternalServiceException" :portkey.aws.gamelift/internal-service-exception, "UnsupportedRegionException" :portkey.aws.gamelift/unsupported-region-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception}})))))
...
(clojure.core/defn create-game-session ([create-game-session-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-create-game-session-input create-game-session-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/create-game-session-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/create-game-session-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateGameSession", :http.request.configuration/output-deser-fn response-create-game-session-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "TerminalRoutingStrategyException" :portkey.aws.gamelift/terminal-routing-strategy-exception, "LimitExceededException" :portkey.aws.gamelift/limit-exceeded-exception, "FleetCapacityExceededException" :portkey.aws.gamelift/fleet-capacity-exceeded-exception, "ConflictException" :portkey.aws.gamelift/conflict-exception, "IdempotentParameterMismatchException" :portkey.aws.gamelift/idempotent-parameter-mismatch-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InvalidFleetStatusException" :portkey.aws.gamelift/invalid-fleet-status-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn describe-build ([describe-build-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-build-input describe-build-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/describe-build-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/describe-build-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeBuild", :http.request.configuration/output-deser-fn response-describe-build-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
...
(clojure.core/defn delete-vpc-peering-connection ([delete-vpc-peering-connection-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-delete-vpc-peering-connection-input delete-vpc-peering-connection-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.gamelift/endpoints, :http.request.configuration/target-prefix "GameLift", :http.request.spec/output-spec :portkey.aws.gamelift/delete-vpc-peering-connection-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-10-01", :http.request.configuration/service-id "GameLift", :http.request.spec/input-spec :portkey.aws.gamelift/delete-vpc-peering-connection-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteVpcPeeringConnection", :http.request.configuration/output-deser-fn response-delete-vpc-peering-connection-output, :http.request.spec/error-spec {"UnauthorizedException" :portkey.aws.gamelift/unauthorized-exception, "InvalidRequestException" :portkey.aws.gamelift/invalid-request-exception, "NotFoundException" :portkey.aws.gamelift/not-found-exception, "InternalServiceException" :portkey.aws.gamelift/internal-service-exception}})))))
