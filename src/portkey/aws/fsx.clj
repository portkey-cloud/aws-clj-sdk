...
(clojure.core/defn- response-backup-in-progress ([input] (response-backup-in-progress nil input)) ([resultWrapper1757729 input] (clojure.core/let [rawinput1757728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757730 {"Message" (rawinput1757728 "Message")}] (clojure.core/cond-> {} (letvar1757730 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757730 ["Message"])))))))

(clojure.core/defn- response-create-backup-response ([input] (response-create-backup-response nil input)) ([resultWrapper1757732 input] (clojure.core/let [rawinput1757731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757733 {"Backup" (rawinput1757731 "Backup")}] (clojure.core/cond-> {} (letvar1757733 "Backup") (clojure.core/assoc :backup (deser-backup (clojure.core/get-in letvar1757733 ["Backup"])))))))

(clojure.core/defn- response-bad-request ([input] (response-bad-request nil input)) ([resultWrapper1757735 input] (clojure.core/let [rawinput1757734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757736 {"Message" (rawinput1757734 "Message")}] (clojure.core/cond-> {} (letvar1757736 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757736 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1757738 input] (clojure.core/let [rawinput1757737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757739 {"Tags" (rawinput1757737 "Tags"), "NextToken" (rawinput1757737 "NextToken")}] (clojure.core/cond-> {} (letvar1757739 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1757739 ["Tags"]))) (letvar1757739 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1757739 ["NextToken"])))))))

(clojure.core/defn- response-not-service-resource-error ([input] (response-not-service-resource-error nil input)) ([resultWrapper1757741 input] (clojure.core/let [rawinput1757740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757742 {"ResourceARN" (rawinput1757740 "ResourceARN"), "Message" (rawinput1757740 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar1757742 ["ResourceARN"]))} (letvar1757742 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757742 ["Message"])))))))

(clojure.core/defn- response-service-limit-exceeded ([input] (response-service-limit-exceeded nil input)) ([resultWrapper1757744 input] (clojure.core/let [rawinput1757743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757745 {"Limit" (rawinput1757743 "Limit"), "Message" (rawinput1757743 "Message")}] (clojure.core/cond-> {:limit (deser-service-limit (clojure.core/get-in letvar1757745 ["Limit"]))} (letvar1757745 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757745 ["Message"])))))))

(clojure.core/defn- response-incompatible-parameter-error ([input] (response-incompatible-parameter-error nil input)) ([resultWrapper1757747 input] (clojure.core/let [rawinput1757746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757748 {"Parameter" (rawinput1757746 "Parameter"), "Message" (rawinput1757746 "Message")}] (clojure.core/cond-> {:parameter (deser-parameter (clojure.core/get-in letvar1757748 ["Parameter"]))} (letvar1757748 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757748 ["Message"])))))))

(clojure.core/defn- response-describe-file-systems-response ([input] (response-describe-file-systems-response nil input)) ([resultWrapper1757750 input] (clojure.core/let [rawinput1757749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757751 {"FileSystems" (rawinput1757749 "FileSystems"), "NextToken" (rawinput1757749 "NextToken")}] (clojure.core/cond-> {} (letvar1757751 "FileSystems") (clojure.core/assoc :file-systems (deser-file-systems (clojure.core/get-in letvar1757751 ["FileSystems"]))) (letvar1757751 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1757751 ["NextToken"])))))))

(clojure.core/defn- response-backup-restoring ([input] (response-backup-restoring nil input)) ([resultWrapper1757753 input] (clojure.core/let [rawinput1757752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757754 {"Message" (rawinput1757752 "Message"), "FileSystemId" (rawinput1757752 "FileSystemId")}] (clojure.core/cond-> {} (letvar1757754 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757754 ["Message"]))) (letvar1757754 "FileSystemId") (clojure.core/assoc :file-system-id (deser-file-system-id (clojure.core/get-in letvar1757754 ["FileSystemId"])))))))

(clojure.core/defn- response-delete-backup-response ([input] (response-delete-backup-response nil input)) ([resultWrapper1757756 input] (clojure.core/let [rawinput1757755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757757 {"BackupId" (rawinput1757755 "BackupId"), "Lifecycle" (rawinput1757755 "Lifecycle")}] (clojure.core/cond-> {} (letvar1757757 "BackupId") (clojure.core/assoc :backup-id (deser-backup-id (clojure.core/get-in letvar1757757 ["BackupId"]))) (letvar1757757 "Lifecycle") (clojure.core/assoc :lifecycle (deser-backup-lifecycle (clojure.core/get-in letvar1757757 ["Lifecycle"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1757759 input] (clojure.core/let [rawinput1757758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757760 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-file-system-response ([input] (response-update-file-system-response nil input)) ([resultWrapper1757762 input] (clojure.core/let [rawinput1757761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757763 {"FileSystem" (rawinput1757761 "FileSystem")}] (clojure.core/cond-> {} (letvar1757763 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar1757763 ["FileSystem"])))))))

(clojure.core/defn- response-delete-file-system-response ([input] (response-delete-file-system-response nil input)) ([resultWrapper1757765 input] (clojure.core/let [rawinput1757764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757766 {"FileSystemId" (rawinput1757764 "FileSystemId"), "Lifecycle" (rawinput1757764 "Lifecycle"), "WindowsResponse" (rawinput1757764 "WindowsResponse")}] (clojure.core/cond-> {} (letvar1757766 "FileSystemId") (clojure.core/assoc :file-system-id (deser-file-system-id (clojure.core/get-in letvar1757766 ["FileSystemId"]))) (letvar1757766 "Lifecycle") (clojure.core/assoc :lifecycle (deser-file-system-lifecycle (clojure.core/get-in letvar1757766 ["Lifecycle"]))) (letvar1757766 "WindowsResponse") (clojure.core/assoc :windows-response (deser-delete-file-system-windows-response (clojure.core/get-in letvar1757766 ["WindowsResponse"])))))))

(clojure.core/defn- response-file-system-not-found ([input] (response-file-system-not-found nil input)) ([resultWrapper1757768 input] (clojure.core/let [rawinput1757767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757769 {"Message" (rawinput1757767 "Message")}] (clojure.core/cond-> {} (letvar1757769 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757769 ["Message"])))))))

(clojure.core/defn- response-invalid-network-settings ([input] (response-invalid-network-settings nil input)) ([resultWrapper1757771 input] (clojure.core/let [rawinput1757770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757772 {"Message" (rawinput1757770 "Message"), "InvalidSubnetId" (rawinput1757770 "InvalidSubnetId"), "InvalidSecurityGroupId" (rawinput1757770 "InvalidSecurityGroupId")}] (clojure.core/cond-> {} (letvar1757772 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757772 ["Message"]))) (letvar1757772 "InvalidSubnetId") (clojure.core/assoc :invalid-subnet-id (deser-subnet-id (clojure.core/get-in letvar1757772 ["InvalidSubnetId"]))) (letvar1757772 "InvalidSecurityGroupId") (clojure.core/assoc :invalid-security-group-id (deser-security-group-id (clojure.core/get-in letvar1757772 ["InvalidSecurityGroupId"])))))))

(clojure.core/defn- response-backup-not-found ([input] (response-backup-not-found nil input)) ([resultWrapper1757774 input] (clojure.core/let [rawinput1757773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757775 {"Message" (rawinput1757773 "Message")}] (clojure.core/cond-> {} (letvar1757775 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757775 ["Message"])))))))

(clojure.core/defn- response-active-directory-error ([input] (response-active-directory-error nil input)) ([resultWrapper1757777 input] (clojure.core/let [rawinput1757776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757778 {"ActiveDirectoryId" (rawinput1757776 "ActiveDirectoryId"), "Type" (rawinput1757776 "Type"), "Message" (rawinput1757776 "Message")}] (clojure.core/cond-> {:active-directory-id (deser-directory-id (clojure.core/get-in letvar1757778 ["ActiveDirectoryId"]))} (letvar1757778 "Type") (clojure.core/assoc :type (deser-active-directory-error-type (clojure.core/get-in letvar1757778 ["Type"]))) (letvar1757778 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757778 ["Message"])))))))

(clojure.core/defn- response-create-file-system-response ([input] (response-create-file-system-response nil input)) ([resultWrapper1757780 input] (clojure.core/let [rawinput1757779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757781 {"FileSystem" (rawinput1757779 "FileSystem")}] (clojure.core/cond-> {} (letvar1757781 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar1757781 ["FileSystem"])))))))

(clojure.core/defn- response-resource-does-not-support-tagging ([input] (response-resource-does-not-support-tagging nil input)) ([resultWrapper1757783 input] (clojure.core/let [rawinput1757782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757784 {"ResourceARN" (rawinput1757782 "ResourceARN"), "Message" (rawinput1757782 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar1757784 ["ResourceARN"]))} (letvar1757784 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757784 ["Message"])))))))

(clojure.core/defn- response-create-file-system-from-backup-response ([input] (response-create-file-system-from-backup-response nil input)) ([resultWrapper1757786 input] (clojure.core/let [rawinput1757785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757787 {"FileSystem" (rawinput1757785 "FileSystem")}] (clojure.core/cond-> {} (letvar1757787 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar1757787 ["FileSystem"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1757789 input] (clojure.core/let [rawinput1757788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757790 {"Message" (rawinput1757788 "Message")}] (clojure.core/cond-> {} (letvar1757790 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757790 ["Message"])))))))

(clojure.core/defn- response-invalid-import-path ([input] (response-invalid-import-path nil input)) ([resultWrapper1757792 input] (clojure.core/let [rawinput1757791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757793 {"Message" (rawinput1757791 "Message")}] (clojure.core/cond-> {} (letvar1757793 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757793 ["Message"])))))))

(clojure.core/defn- response-resource-not-found ([input] (response-resource-not-found nil input)) ([resultWrapper1757795 input] (clojure.core/let [rawinput1757794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757796 {"ResourceARN" (rawinput1757794 "ResourceARN"), "Message" (rawinput1757794 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar1757796 ["ResourceARN"]))} (letvar1757796 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757796 ["Message"])))))))

(clojure.core/defn- response-missing-file-system-configuration ([input] (response-missing-file-system-configuration nil input)) ([resultWrapper1757798 input] (clojure.core/let [rawinput1757797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757799 {"Message" (rawinput1757797 "Message")}] (clojure.core/cond-> {} (letvar1757799 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757799 ["Message"])))))))

(clojure.core/defn- response-describe-backups-response ([input] (response-describe-backups-response nil input)) ([resultWrapper1757801 input] (clojure.core/let [rawinput1757800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757802 {"Backups" (rawinput1757800 "Backups"), "NextToken" (rawinput1757800 "NextToken")}] (clojure.core/cond-> {} (letvar1757802 "Backups") (clojure.core/assoc :backups (deser-backups (clojure.core/get-in letvar1757802 ["Backups"]))) (letvar1757802 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1757802 ["NextToken"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1757804 input] (clojure.core/let [rawinput1757803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757805 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-export-path ([input] (response-invalid-export-path nil input)) ([resultWrapper1757807 input] (clojure.core/let [rawinput1757806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1757808 {"Message" (rawinput1757806 "Message")}] (clojure.core/cond-> {} (letvar1757808 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1757808 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/archive-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 900))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/weekly-time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 7 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 7)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[1-7]:([01]\d|2[0-3]):?([0-5]\d)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 15 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 24)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8,})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(backup-[0-9a-f]{8,})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/network-interface-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 21)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(eni-[0-9a-f]{8,})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.fsx/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 12)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\d{12}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 11 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8,})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/vpc-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 21)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(vpc-[0-9a-f]{8,})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[89aAbB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}|arn:aws[a-z-]{0,7}:kms:[a-z]{2}-[a-z-]{4,}-\d+:\d{12}:(key|alias)\/([a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[89aAbB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}|[a-zA-Z0-9:\/_-]+)|alias\/[a-zA-Z0-9:\/_-]+$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.fsx/parameter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 12)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/daily-time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 5)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([01]\d|2[0-3]):?([0-5]\d)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 8 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws[a-z-]{0,7}:[A-Za-z0-9][A-za-z0-9_/.-]{0,62}:[A-za-z0-9_/.-]{0,63}:[A-za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-za-z0-9_/.-]{0,127}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.fsx/untag-resource-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.fsx/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z\*\.\\/\?\-\_]*$" s__1410940__auto__))))
