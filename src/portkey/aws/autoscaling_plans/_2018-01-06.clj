...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1462321 input] (clojure.core/let [rawinput1462320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462322 {"Message" (rawinput1462320 "Message")}] (clojure.core/cond-> {} (letvar1462322 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462322 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-plan-response ([input] (response-delete-scaling-plan-response nil input)) ([resultWrapper1462324 input] (clojure.core/let [rawinput1462323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462325 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-plans-response ([input] (response-describe-scaling-plans-response nil input)) ([resultWrapper1462327 input] (clojure.core/let [rawinput1462326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462328 {"ScalingPlans" (rawinput1462326 "ScalingPlans"), "NextToken" (rawinput1462326 "NextToken")}] (clojure.core/cond-> {} (letvar1462328 "ScalingPlans") (clojure.core/assoc :scaling-plans (deser-scaling-plans (clojure.core/get-in letvar1462328 ["ScalingPlans"]))) (letvar1462328 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1462328 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1462330 input] (clojure.core/let [rawinput1462329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462331 {"Message" (rawinput1462329 "Message")}] (clojure.core/cond-> {} (letvar1462331 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462331 ["Message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1462333 input] (clojure.core/let [rawinput1462332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462334 {"Message" (rawinput1462332 "Message")}] (clojure.core/cond-> {} (letvar1462334 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462334 ["Message"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper1462336 input] (clojure.core/let [rawinput1462335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462337 {"Message" (rawinput1462335 "Message")}] (clojure.core/cond-> {} (letvar1462337 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462337 ["Message"])))))))

(clojure.core/defn- response-describe-scaling-plan-resources-response ([input] (response-describe-scaling-plan-resources-response nil input)) ([resultWrapper1462339 input] (clojure.core/let [rawinput1462338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462340 {"ScalingPlanResources" (rawinput1462338 "ScalingPlanResources"), "NextToken" (rawinput1462338 "NextToken")}] (clojure.core/cond-> {} (letvar1462340 "ScalingPlanResources") (clojure.core/assoc :scaling-plan-resources (deser-scaling-plan-resources (clojure.core/get-in letvar1462340 ["ScalingPlanResources"]))) (letvar1462340 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1462340 ["NextToken"])))))))

(clojure.core/defn- response-create-scaling-plan-response ([input] (response-create-scaling-plan-response nil input)) ([resultWrapper1462342 input] (clojure.core/let [rawinput1462341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462343 {"ScalingPlanVersion" (rawinput1462341 "ScalingPlanVersion")}] (clojure.core/cond-> {:scaling-plan-version (deser-scaling-plan-version (clojure.core/get-in letvar1462343 ["ScalingPlanVersion"]))}))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1462345 input] (clojure.core/let [rawinput1462344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462346 {"Message" (rawinput1462344 "Message")}] (clojure.core/cond-> {} (letvar1462346 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462346 ["Message"])))))))

(clojure.core/defn- response-update-scaling-plan-response ([input] (response-update-scaling-plan-response nil input)) ([resultWrapper1462348 input] (clojure.core/let [rawinput1462347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462349 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1462351 input] (clojure.core/let [rawinput1462350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462352 {"Message" (rawinput1462350 "Message")}] (clojure.core/cond-> {} (letvar1462352 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1462352 ["Message"])))))))

(clojure.core/defn- response-get-scaling-plan-resource-forecast-data-response ([input] (response-get-scaling-plan-resource-forecast-data-response nil input)) ([resultWrapper1462354 input] (clojure.core/let [rawinput1462353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1462355 {"Datapoints" (rawinput1462353 "Datapoints")}] (clojure.core/cond-> {:datapoints (deser-datapoints (clojure.core/get-in letvar1462355 ["Datapoints"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/xml-string-max-len-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/scaling-plan-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{Print}&&[^|:/]]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\p{Print}+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.-2018-01-06/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1023))))
