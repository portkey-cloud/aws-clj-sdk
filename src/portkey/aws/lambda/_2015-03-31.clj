...
(clojure.core/defn- response-list-layers-response ([input] (response-list-layers-response nil input)) ([resultWrapper1540109 input] (clojure.core/let [rawinput1540108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540110 {"NextMarker" (rawinput1540108 "NextMarker"), "Layers" (rawinput1540108 "Layers")}] (clojure.core/cond-> {} (letvar1540110 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540110 ["NextMarker"]))) (letvar1540110 "Layers") (clojure.core/assoc :layers (deser-layers-list (clojure.core/get-in letvar1540110 ["Layers"])))))))

(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper1540112 input] (clojure.core/let [rawinput1540111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540113 {"Type" (rawinput1540111 "Type"), "message" (rawinput1540111 "message")}] (clojure.core/cond-> {} (letvar1540113 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540113 ["Type"]))) (letvar1540113 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540113 ["message"])))))))

(clojure.core/defn- response-request-too-large-exception ([input] (response-request-too-large-exception nil input)) ([resultWrapper1540115 input] (clojure.core/let [rawinput1540114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540116 {"Type" (rawinput1540114 "Type"), "message" (rawinput1540114 "message")}] (clojure.core/cond-> {} (letvar1540116 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540116 ["Type"]))) (letvar1540116 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540116 ["message"])))))))

(clojure.core/defn- response-invalid-subnet-id-exception ([input] (response-invalid-subnet-id-exception nil input)) ([resultWrapper1540118 input] (clojure.core/let [rawinput1540117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540119 {"Type" (rawinput1540117 "Type"), "Message" (rawinput1540117 "Message")}] (clojure.core/cond-> {} (letvar1540119 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540119 ["Type"]))) (letvar1540119 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540119 ["Message"])))))))

(clojure.core/defn- response-list-layer-versions-response ([input] (response-list-layer-versions-response nil input)) ([resultWrapper1540121 input] (clojure.core/let [rawinput1540120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540122 {"NextMarker" (rawinput1540120 "NextMarker"), "LayerVersions" (rawinput1540120 "LayerVersions")}] (clojure.core/cond-> {} (letvar1540122 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540122 ["NextMarker"]))) (letvar1540122 "LayerVersions") (clojure.core/assoc :layer-versions (deser-layer-versions-list (clojure.core/get-in letvar1540122 ["LayerVersions"])))))))

(clojure.core/defn- response-subnet-ip-address-limit-reached-exception ([input] (response-subnet-ip-address-limit-reached-exception nil input)) ([resultWrapper1540124 input] (clojure.core/let [rawinput1540123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540125 {"Type" (rawinput1540123 "Type"), "Message" (rawinput1540123 "Message")}] (clojure.core/cond-> {} (letvar1540125 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540125 ["Type"]))) (letvar1540125 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540125 ["Message"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper1540127 input] (clojure.core/let [rawinput1540126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540128 {"Type" (rawinput1540126 "Type"), "message" (rawinput1540126 "message")}] (clojure.core/cond-> {} (letvar1540128 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540128 ["Type"]))) (letvar1540128 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540128 ["message"])))))))

(clojure.core/defn- response-list-versions-by-function-response ([input] (response-list-versions-by-function-response nil input)) ([resultWrapper1540130 input] (clojure.core/let [rawinput1540129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540131 {"NextMarker" (rawinput1540129 "NextMarker"), "Versions" (rawinput1540129 "Versions")}] (clojure.core/cond-> {} (letvar1540131 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540131 ["NextMarker"]))) (letvar1540131 "Versions") (clojure.core/assoc :versions (deser-function-list (clojure.core/get-in letvar1540131 ["Versions"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1540133 input] (clojure.core/let [rawinput1540132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540134 {"Tags" (rawinput1540132 "Tags")}] (clojure.core/cond-> {} (letvar1540134 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1540134 ["Tags"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1540136 input] (clojure.core/let [rawinput1540135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540137 {"Type" (rawinput1540135 "Type"), "Message" (rawinput1540135 "Message")}] (clojure.core/cond-> {} (letvar1540137 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540137 ["Type"]))) (letvar1540137 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540137 ["Message"])))))))

(clojure.core/defn- response-list-event-source-mappings-response ([input] (response-list-event-source-mappings-response nil input)) ([resultWrapper1540139 input] (clojure.core/let [rawinput1540138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540140 {"NextMarker" (rawinput1540138 "NextMarker"), "EventSourceMappings" (rawinput1540138 "EventSourceMappings")}] (clojure.core/cond-> {} (letvar1540140 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540140 ["NextMarker"]))) (letvar1540140 "EventSourceMappings") (clojure.core/assoc :event-source-mappings (deser-event-source-mappings-list (clojure.core/get-in letvar1540140 ["EventSourceMappings"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1540142 input] (clojure.core/let [rawinput1540141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540143 {"Type" (rawinput1540141 "Type"), "Message" (rawinput1540141 "Message")}] (clojure.core/cond-> {} (letvar1540143 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540143 ["Type"]))) (letvar1540143 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540143 ["Message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1540145 input] (clojure.core/let [rawinput1540144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540146 {"Type" (rawinput1540144 "Type"), "Message" (rawinput1540144 "Message")}] (clojure.core/cond-> {} (letvar1540146 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540146 ["Type"]))) (letvar1540146 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540146 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1540148 input] (clojure.core/let [rawinput1540147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540149 {"Type" (rawinput1540147 "Type"), "Message" (rawinput1540147 "Message")}] (clojure.core/cond-> {} (letvar1540149 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540149 ["Type"]))) (letvar1540149 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540149 ["Message"])))))))

(clojure.core/defn- response-invalid-runtime-exception ([input] (response-invalid-runtime-exception nil input)) ([resultWrapper1540151 input] (clojure.core/let [rawinput1540150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540152 {"Type" (rawinput1540150 "Type"), "Message" (rawinput1540150 "Message")}] (clojure.core/cond-> {} (letvar1540152 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540152 ["Type"]))) (letvar1540152 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540152 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-response ([input] (response-get-layer-version-response nil input)) ([resultWrapper1540154 input] (clojure.core/let [rawinput1540153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540155 {"Content" (rawinput1540153 "Content"), "LayerArn" (rawinput1540153 "LayerArn"), "LayerVersionArn" (rawinput1540153 "LayerVersionArn"), "Description" (rawinput1540153 "Description"), "CreatedDate" (rawinput1540153 "CreatedDate"), "Version" (rawinput1540153 "Version"), "CompatibleRuntimes" (rawinput1540153 "CompatibleRuntimes"), "LicenseInfo" (rawinput1540153 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1540155 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1540155 ["Content"]))) (letvar1540155 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1540155 ["LayerArn"]))) (letvar1540155 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1540155 ["LayerVersionArn"]))) (letvar1540155 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1540155 ["Description"]))) (letvar1540155 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1540155 ["CreatedDate"]))) (letvar1540155 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1540155 ["Version"]))) (letvar1540155 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1540155 ["CompatibleRuntimes"]))) (letvar1540155 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1540155 ["LicenseInfo"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1540157 input] (clojure.core/let [rawinput1540156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540158 {"NextMarker" (rawinput1540156 "NextMarker"), "Functions" (rawinput1540156 "Functions")}] (clojure.core/cond-> {} (letvar1540158 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540158 ["NextMarker"]))) (letvar1540158 "Functions") (clojure.core/assoc :functions (deser-function-list (clojure.core/get-in letvar1540158 ["Functions"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1540160 input] (clojure.core/let [rawinput1540159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540161 {"Type" (rawinput1540159 "Type"), "Message" (rawinput1540159 "Message")}] (clojure.core/cond-> {} (letvar1540161 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540161 ["Type"]))) (letvar1540161 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540161 ["Message"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1540163 input] (clojure.core/let [rawinput1540162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540164 {"Configuration" (rawinput1540162 "Configuration"), "Code" (rawinput1540162 "Code"), "Tags" (rawinput1540162 "Tags"), "Concurrency" (rawinput1540162 "Concurrency")}] (clojure.core/cond-> {} (letvar1540164 "Configuration") (clojure.core/assoc :configuration (deser-function-configuration (clojure.core/get-in letvar1540164 ["Configuration"]))) (letvar1540164 "Code") (clojure.core/assoc :code (deser-function-code-location (clojure.core/get-in letvar1540164 ["Code"]))) (letvar1540164 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1540164 ["Tags"]))) (letvar1540164 "Concurrency") (clojure.core/assoc :concurrency (deser-concurrency (clojure.core/get-in letvar1540164 ["Concurrency"])))))))

(clojure.core/defn- response-code-storage-exceeded-exception ([input] (response-code-storage-exceeded-exception nil input)) ([resultWrapper1540166 input] (clojure.core/let [rawinput1540165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540167 {"Type" (rawinput1540165 "Type"), "message" (rawinput1540165 "message")}] (clojure.core/cond-> {} (letvar1540167 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540167 ["Type"]))) (letvar1540167 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540167 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1540169 input] (clojure.core/let [rawinput1540168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540170 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "Type" (rawinput1540168 "Type"), "message" (rawinput1540168 "message"), "Reason" (rawinput1540168 "Reason")}] (clojure.core/cond-> {} (letvar1540170 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar1540170 ["Retry-After"]))) (letvar1540170 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540170 ["Type"]))) (letvar1540170 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540170 ["message"]))) (letvar1540170 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1540170 ["Reason"])))))))

(clojure.core/defn- response-invalid-request-content-exception ([input] (response-invalid-request-content-exception nil input)) ([resultWrapper1540172 input] (clojure.core/let [rawinput1540171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540173 {"Type" (rawinput1540171 "Type"), "message" (rawinput1540171 "message")}] (clojure.core/cond-> {} (letvar1540173 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540173 ["Type"]))) (letvar1540173 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540173 ["message"])))))))

(clojure.core/defn- response-add-layer-version-permission-response ([input] (response-add-layer-version-permission-response nil input)) ([resultWrapper1540175 input] (clojure.core/let [rawinput1540174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540176 {"Statement" (rawinput1540174 "Statement"), "RevisionId" (rawinput1540174 "RevisionId")}] (clojure.core/cond-> {} (letvar1540176 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1540176 ["Statement"]))) (letvar1540176 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1540176 ["RevisionId"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1540178 input] (clojure.core/let [rawinput1540177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540179 {"Type" (rawinput1540177 "Type"), "Message" (rawinput1540177 "Message")}] (clojure.core/cond-> {} (letvar1540179 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540179 ["Type"]))) (letvar1540179 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540179 ["Message"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper1540181 input] (clojure.core/let [rawinput1540180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540182 {"AccountLimit" (rawinput1540180 "AccountLimit"), "AccountUsage" (rawinput1540180 "AccountUsage")}] (clojure.core/cond-> {} (letvar1540182 "AccountLimit") (clojure.core/assoc :account-limit (deser-account-limit (clojure.core/get-in letvar1540182 ["AccountLimit"]))) (letvar1540182 "AccountUsage") (clojure.core/assoc :account-usage (deser-account-usage (clojure.core/get-in letvar1540182 ["AccountUsage"])))))))

(clojure.core/defn- response-eni-limit-reached-exception ([input] (response-eni-limit-reached-exception nil input)) ([resultWrapper1540184 input] (clojure.core/let [rawinput1540183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540185 {"Type" (rawinput1540183 "Type"), "Message" (rawinput1540183 "Message")}] (clojure.core/cond-> {} (letvar1540185 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540185 ["Type"]))) (letvar1540185 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540185 ["Message"])))))))

(clojure.core/defn- response-concurrency ([input] (response-concurrency nil input)) ([resultWrapper1540187 input] (clojure.core/let [rawinput1540186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540188 {"ReservedConcurrentExecutions" (rawinput1540186 "ReservedConcurrentExecutions")}] (clojure.core/cond-> {} (letvar1540188 "ReservedConcurrentExecutions") (clojure.core/assoc :reserved-concurrent-executions (deser-reserved-concurrent-executions (clojure.core/get-in letvar1540188 ["ReservedConcurrentExecutions"])))))))

(clojure.core/defn- response-add-permission-response ([input] (response-add-permission-response nil input)) ([resultWrapper1540190 input] (clojure.core/let [rawinput1540189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540191 {"Statement" (rawinput1540189 "Statement")}] (clojure.core/cond-> {} (letvar1540191 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1540191 ["Statement"])))))))

(clojure.core/defn- response-invocation-response ([input] (response-invocation-response nil input)) ([resultWrapper1540193 input] (clojure.core/let [rawinput1540192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540194 {"StatusCode" (clojure.core/get-in input [:status "StatusCode"]), "X-Amz-Function-Error" (clojure.core/get-in input [:headers "X-Amz-Function-Error"]), "X-Amz-Log-Result" (clojure.core/get-in input [:headers "X-Amz-Log-Result"]), "Payload" (rawinput1540192 "Payload"), "X-Amz-Executed-Version" (clojure.core/get-in input [:headers "X-Amz-Executed-Version"])}] (clojure.core/cond-> {} (letvar1540194 "StatusCode") (clojure.core/assoc :status-code (deser-integer (clojure.core/get-in letvar1540194 ["StatusCode"]))) (letvar1540194 "X-Amz-Function-Error") (clojure.core/assoc :function-error (deser-string (clojure.core/get-in letvar1540194 ["X-Amz-Function-Error"]))) (letvar1540194 "X-Amz-Log-Result") (clojure.core/assoc :log-result (deser-string (clojure.core/get-in letvar1540194 ["X-Amz-Log-Result"]))) (letvar1540194 "Payload") (clojure.core/assoc :payload (deser-blob (clojure.core/get-in letvar1540194 ["Payload"]))) (letvar1540194 "X-Amz-Executed-Version") (clojure.core/assoc :executed-version (deser-version (clojure.core/get-in letvar1540194 ["X-Amz-Executed-Version"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1540196 input] (clojure.core/let [rawinput1540195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540197 {"Type" (rawinput1540195 "Type"), "Message" (rawinput1540195 "Message")}] (clojure.core/cond-> {} (letvar1540197 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540197 ["Type"]))) (letvar1540197 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540197 ["Message"])))))))

(clojure.core/defn- response-publish-layer-version-response ([input] (response-publish-layer-version-response nil input)) ([resultWrapper1540199 input] (clojure.core/let [rawinput1540198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540200 {"Content" (rawinput1540198 "Content"), "LayerArn" (rawinput1540198 "LayerArn"), "LayerVersionArn" (rawinput1540198 "LayerVersionArn"), "Description" (rawinput1540198 "Description"), "CreatedDate" (rawinput1540198 "CreatedDate"), "Version" (rawinput1540198 "Version"), "CompatibleRuntimes" (rawinput1540198 "CompatibleRuntimes"), "LicenseInfo" (rawinput1540198 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1540200 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1540200 ["Content"]))) (letvar1540200 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1540200 ["LayerArn"]))) (letvar1540200 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1540200 ["LayerVersionArn"]))) (letvar1540200 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1540200 ["Description"]))) (letvar1540200 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1540200 ["CreatedDate"]))) (letvar1540200 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1540200 ["Version"]))) (letvar1540200 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1540200 ["CompatibleRuntimes"]))) (letvar1540200 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1540200 ["LicenseInfo"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1540202 input] (clojure.core/let [rawinput1540201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540203 {"Policy" (rawinput1540201 "Policy"), "RevisionId" (rawinput1540201 "RevisionId")}] (clojure.core/cond-> {} (letvar1540203 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1540203 ["Policy"]))) (letvar1540203 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1540203 ["RevisionId"])))))))

(clojure.core/defn- response-invoke-async-response ([input] (response-invoke-async-response nil input)) ([resultWrapper1540205 input] (clojure.core/let [rawinput1540204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540206 {"Status" (clojure.core/get-in input [:status "Status"])}] (clojure.core/cond-> {} (letvar1540206 "Status") (clojure.core/assoc :status (deser-http-status (clojure.core/get-in letvar1540206 ["Status"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1540208 input] (clojure.core/let [rawinput1540207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540209 {"Type" (rawinput1540207 "Type"), "message" (rawinput1540207 "message")}] (clojure.core/cond-> {} (letvar1540209 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540209 ["Type"]))) (letvar1540209 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540209 ["message"])))))))

(clojure.core/defn- response-invalid-zip-file-exception ([input] (response-invalid-zip-file-exception nil input)) ([resultWrapper1540211 input] (clojure.core/let [rawinput1540210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540212 {"Type" (rawinput1540210 "Type"), "Message" (rawinput1540210 "Message")}] (clojure.core/cond-> {} (letvar1540212 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540212 ["Type"]))) (letvar1540212 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540212 ["Message"])))))))

(clojure.core/defn- response-list-aliases-response ([input] (response-list-aliases-response nil input)) ([resultWrapper1540214 input] (clojure.core/let [rawinput1540213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540215 {"NextMarker" (rawinput1540213 "NextMarker"), "Aliases" (rawinput1540213 "Aliases")}] (clojure.core/cond-> {} (letvar1540215 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1540215 ["NextMarker"]))) (letvar1540215 "Aliases") (clojure.core/assoc :aliases (deser-alias-list (clojure.core/get-in letvar1540215 ["Aliases"])))))))

(clojure.core/defn- response-function-configuration ([input] (response-function-configuration nil input)) ([resultWrapper1540217 input] (clojure.core/let [rawinput1540216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540218 {"TracingConfig" (rawinput1540216 "TracingConfig"), "FunctionArn" (rawinput1540216 "FunctionArn"), "FunctionName" (rawinput1540216 "FunctionName"), "Timeout" (rawinput1540216 "Timeout"), "Layers" (rawinput1540216 "Layers"), "DeadLetterConfig" (rawinput1540216 "DeadLetterConfig"), "Handler" (rawinput1540216 "Handler"), "Runtime" (rawinput1540216 "Runtime"), "MemorySize" (rawinput1540216 "MemorySize"), "Role" (rawinput1540216 "Role"), "KMSKeyArn" (rawinput1540216 "KMSKeyArn"), "Description" (rawinput1540216 "Description"), "LastModified" (rawinput1540216 "LastModified"), "Environment" (rawinput1540216 "Environment"), "CodeSize" (rawinput1540216 "CodeSize"), "VpcConfig" (rawinput1540216 "VpcConfig"), "RevisionId" (rawinput1540216 "RevisionId"), "Version" (rawinput1540216 "Version"), "CodeSha256" (rawinput1540216 "CodeSha256"), "MasterArn" (rawinput1540216 "MasterArn")}] (clojure.core/cond-> {} (letvar1540218 "TracingConfig") (clojure.core/assoc :tracing-config (deser-tracing-config-response (clojure.core/get-in letvar1540218 ["TracingConfig"]))) (letvar1540218 "FunctionArn") (clojure.core/assoc :function-arn (deser-name-spaced-function-arn (clojure.core/get-in letvar1540218 ["FunctionArn"]))) (letvar1540218 "FunctionName") (clojure.core/assoc :function-name (deser-namespaced-function-name (clojure.core/get-in letvar1540218 ["FunctionName"]))) (letvar1540218 "Timeout") (clojure.core/assoc :timeout (deser-timeout (clojure.core/get-in letvar1540218 ["Timeout"]))) (letvar1540218 "Layers") (clojure.core/assoc :layers (deser-layers-reference-list (clojure.core/get-in letvar1540218 ["Layers"]))) (letvar1540218 "DeadLetterConfig") (clojure.core/assoc :dead-letter-config (deser-dead-letter-config (clojure.core/get-in letvar1540218 ["DeadLetterConfig"]))) (letvar1540218 "Handler") (clojure.core/assoc :handler (deser-handler (clojure.core/get-in letvar1540218 ["Handler"]))) (letvar1540218 "Runtime") (clojure.core/assoc :runtime (deser-runtime (clojure.core/get-in letvar1540218 ["Runtime"]))) (letvar1540218 "MemorySize") (clojure.core/assoc :memory-size (deser-memory-size (clojure.core/get-in letvar1540218 ["MemorySize"]))) (letvar1540218 "Role") (clojure.core/assoc :role (deser-role-arn (clojure.core/get-in letvar1540218 ["Role"]))) (letvar1540218 "KMSKeyArn") (clojure.core/assoc :kms-key-arn (deser-kms-key-arn (clojure.core/get-in letvar1540218 ["KMSKeyArn"]))) (letvar1540218 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1540218 ["Description"]))) (letvar1540218 "LastModified") (clojure.core/assoc :last-modified (deser-timestamp (clojure.core/get-in letvar1540218 ["LastModified"]))) (letvar1540218 "Environment") (clojure.core/assoc :environment (deser-environment-response (clojure.core/get-in letvar1540218 ["Environment"]))) (letvar1540218 "CodeSize") (clojure.core/assoc :code-size (deser-long (clojure.core/get-in letvar1540218 ["CodeSize"]))) (letvar1540218 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config-response (clojure.core/get-in letvar1540218 ["VpcConfig"]))) (letvar1540218 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1540218 ["RevisionId"]))) (letvar1540218 "Version") (clojure.core/assoc :version (deser-version (clojure.core/get-in letvar1540218 ["Version"]))) (letvar1540218 "CodeSha256") (clojure.core/assoc :code-sha-256 (deser-string (clojure.core/get-in letvar1540218 ["CodeSha256"]))) (letvar1540218 "MasterArn") (clojure.core/assoc :master-arn (deser-function-arn (clojure.core/get-in letvar1540218 ["MasterArn"])))))))

(clojure.core/defn- response-policy-length-exceeded-exception ([input] (response-policy-length-exceeded-exception nil input)) ([resultWrapper1540220 input] (clojure.core/let [rawinput1540219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540221 {"Type" (rawinput1540219 "Type"), "message" (rawinput1540219 "message")}] (clojure.core/cond-> {} (letvar1540221 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540221 ["Type"]))) (letvar1540221 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540221 ["message"])))))))

(clojure.core/defn- response-alias-configuration ([input] (response-alias-configuration nil input)) ([resultWrapper1540223 input] (clojure.core/let [rawinput1540222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540224 {"AliasArn" (rawinput1540222 "AliasArn"), "Name" (rawinput1540222 "Name"), "FunctionVersion" (rawinput1540222 "FunctionVersion"), "Description" (rawinput1540222 "Description"), "RoutingConfig" (rawinput1540222 "RoutingConfig"), "RevisionId" (rawinput1540222 "RevisionId")}] (clojure.core/cond-> {} (letvar1540224 "AliasArn") (clojure.core/assoc :alias-arn (deser-function-arn (clojure.core/get-in letvar1540224 ["AliasArn"]))) (letvar1540224 "Name") (clojure.core/assoc :name (deser-alias (clojure.core/get-in letvar1540224 ["Name"]))) (letvar1540224 "FunctionVersion") (clojure.core/assoc :function-version (deser-version (clojure.core/get-in letvar1540224 ["FunctionVersion"]))) (letvar1540224 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1540224 ["Description"]))) (letvar1540224 "RoutingConfig") (clojure.core/assoc :routing-config (deser-alias-routing-configuration (clojure.core/get-in letvar1540224 ["RoutingConfig"]))) (letvar1540224 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1540224 ["RevisionId"])))))))

(clojure.core/defn- response-ec-2-throttled-exception ([input] (response-ec-2-throttled-exception nil input)) ([resultWrapper1540226 input] (clojure.core/let [rawinput1540225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540227 {"Type" (rawinput1540225 "Type"), "Message" (rawinput1540225 "Message")}] (clojure.core/cond-> {} (letvar1540227 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540227 ["Type"]))) (letvar1540227 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540227 ["Message"])))))))

(clojure.core/defn- response-ec-2-access-denied-exception ([input] (response-ec-2-access-denied-exception nil input)) ([resultWrapper1540229 input] (clojure.core/let [rawinput1540228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540230 {"Type" (rawinput1540228 "Type"), "Message" (rawinput1540228 "Message")}] (clojure.core/cond-> {} (letvar1540230 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540230 ["Type"]))) (letvar1540230 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540230 ["Message"])))))))

(clojure.core/defn- response-event-source-mapping-configuration ([input] (response-event-source-mapping-configuration nil input)) ([resultWrapper1540232 input] (clojure.core/let [rawinput1540231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540233 {"UUID" (rawinput1540231 "UUID"), "BatchSize" (rawinput1540231 "BatchSize"), "EventSourceArn" (rawinput1540231 "EventSourceArn"), "FunctionArn" (rawinput1540231 "FunctionArn"), "LastModified" (rawinput1540231 "LastModified"), "LastProcessingResult" (rawinput1540231 "LastProcessingResult"), "State" (rawinput1540231 "State"), "StateTransitionReason" (rawinput1540231 "StateTransitionReason")}] (clojure.core/cond-> {} (letvar1540233 "UUID") (clojure.core/assoc :uuid (deser-string (clojure.core/get-in letvar1540233 ["UUID"]))) (letvar1540233 "BatchSize") (clojure.core/assoc :batch-size (deser-batch-size (clojure.core/get-in letvar1540233 ["BatchSize"]))) (letvar1540233 "EventSourceArn") (clojure.core/assoc :event-source-arn (deser-arn (clojure.core/get-in letvar1540233 ["EventSourceArn"]))) (letvar1540233 "FunctionArn") (clojure.core/assoc :function-arn (deser-function-arn (clojure.core/get-in letvar1540233 ["FunctionArn"]))) (letvar1540233 "LastModified") (clojure.core/assoc :last-modified (deser-date (clojure.core/get-in letvar1540233 ["LastModified"]))) (letvar1540233 "LastProcessingResult") (clojure.core/assoc :last-processing-result (deser-string (clojure.core/get-in letvar1540233 ["LastProcessingResult"]))) (letvar1540233 "State") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1540233 ["State"]))) (letvar1540233 "StateTransitionReason") (clojure.core/assoc :state-transition-reason (deser-string (clojure.core/get-in letvar1540233 ["StateTransitionReason"])))))))

(clojure.core/defn- response-ec-2-unexpected-exception ([input] (response-ec-2-unexpected-exception nil input)) ([resultWrapper1540235 input] (clojure.core/let [rawinput1540234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540236 {"Type" (rawinput1540234 "Type"), "Message" (rawinput1540234 "Message"), "EC2ErrorCode" (rawinput1540234 "EC2ErrorCode")}] (clojure.core/cond-> {} (letvar1540236 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540236 ["Type"]))) (letvar1540236 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540236 ["Message"]))) (letvar1540236 "EC2ErrorCode") (clojure.core/assoc :ec-2-error-code (deser-string (clojure.core/get-in letvar1540236 ["EC2ErrorCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1540238 input] (clojure.core/let [rawinput1540237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540239 {"Type" (rawinput1540237 "Type"), "message" (rawinput1540237 "message")}] (clojure.core/cond-> {} (letvar1540239 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540239 ["Type"]))) (letvar1540239 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540239 ["message"])))))))

(clojure.core/defn- response-invalid-security-group-id-exception ([input] (response-invalid-security-group-id-exception nil input)) ([resultWrapper1540241 input] (clojure.core/let [rawinput1540240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540242 {"Type" (rawinput1540240 "Type"), "Message" (rawinput1540240 "Message")}] (clojure.core/cond-> {} (letvar1540242 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1540242 ["Type"]))) (letvar1540242 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1540242 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-policy-response ([input] (response-get-layer-version-policy-response nil input)) ([resultWrapper1540244 input] (clojure.core/let [rawinput1540243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1540245 {"Policy" (rawinput1540243 "Policy"), "RevisionId" (rawinput1540243 "RevisionId")}] (clojure.core/cond-> {} (letvar1540245 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1540245 ["Policy"]))) (letvar1540245 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1540245 ["RevisionId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-permission-allowed-action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"lambda:GetLayerVersion" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[^\s]+" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 170)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"\d{12}" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 100)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"o-[a-z0-9]{10,32}" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[0-9]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 100)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/license-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 0 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/tag-value (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+)|[a-zA-Z0-9-_]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-version-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+:[0-9]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z0-9-]*):([a-zA-Z0-9\-])+:([a-z]{2}(-gov)?-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 3 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 63)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #".*" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-permission-allowed-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"\d{12}|\*|arn:(aws[a-zA-Z-]*):iam::\d{12}:root" s__1531357__auto__))))
