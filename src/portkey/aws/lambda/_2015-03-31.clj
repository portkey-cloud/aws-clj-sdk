...
(clojure.core/defn- response-list-layers-response ([input] (response-list-layers-response nil input)) ([resultWrapper1218112 input] (clojure.core/let [rawinput1218111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218113 {"NextMarker" (rawinput1218111 "NextMarker"), "Layers" (rawinput1218111 "Layers")}] (clojure.core/cond-> {} (letvar1218113 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218113 ["NextMarker"]))) (letvar1218113 "Layers") (clojure.core/assoc :layers (deser-layers-list (clojure.core/get-in letvar1218113 ["Layers"])))))))

(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper1218115 input] (clojure.core/let [rawinput1218114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218116 {"Type" (rawinput1218114 "Type"), "message" (rawinput1218114 "message")}] (clojure.core/cond-> {} (letvar1218116 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218116 ["Type"]))) (letvar1218116 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218116 ["message"])))))))

(clojure.core/defn- response-request-too-large-exception ([input] (response-request-too-large-exception nil input)) ([resultWrapper1218118 input] (clojure.core/let [rawinput1218117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218119 {"Type" (rawinput1218117 "Type"), "message" (rawinput1218117 "message")}] (clojure.core/cond-> {} (letvar1218119 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218119 ["Type"]))) (letvar1218119 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218119 ["message"])))))))

(clojure.core/defn- response-invalid-subnet-id-exception ([input] (response-invalid-subnet-id-exception nil input)) ([resultWrapper1218121 input] (clojure.core/let [rawinput1218120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218122 {"Type" (rawinput1218120 "Type"), "Message" (rawinput1218120 "Message")}] (clojure.core/cond-> {} (letvar1218122 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218122 ["Type"]))) (letvar1218122 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218122 ["Message"])))))))

(clojure.core/defn- response-list-layer-versions-response ([input] (response-list-layer-versions-response nil input)) ([resultWrapper1218124 input] (clojure.core/let [rawinput1218123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218125 {"NextMarker" (rawinput1218123 "NextMarker"), "LayerVersions" (rawinput1218123 "LayerVersions")}] (clojure.core/cond-> {} (letvar1218125 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218125 ["NextMarker"]))) (letvar1218125 "LayerVersions") (clojure.core/assoc :layer-versions (deser-layer-versions-list (clojure.core/get-in letvar1218125 ["LayerVersions"])))))))

(clojure.core/defn- response-subnet-ip-address-limit-reached-exception ([input] (response-subnet-ip-address-limit-reached-exception nil input)) ([resultWrapper1218127 input] (clojure.core/let [rawinput1218126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218128 {"Type" (rawinput1218126 "Type"), "Message" (rawinput1218126 "Message")}] (clojure.core/cond-> {} (letvar1218128 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218128 ["Type"]))) (letvar1218128 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218128 ["Message"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper1218130 input] (clojure.core/let [rawinput1218129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218131 {"Type" (rawinput1218129 "Type"), "message" (rawinput1218129 "message")}] (clojure.core/cond-> {} (letvar1218131 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218131 ["Type"]))) (letvar1218131 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218131 ["message"])))))))

(clojure.core/defn- response-list-versions-by-function-response ([input] (response-list-versions-by-function-response nil input)) ([resultWrapper1218133 input] (clojure.core/let [rawinput1218132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218134 {"NextMarker" (rawinput1218132 "NextMarker"), "Versions" (rawinput1218132 "Versions")}] (clojure.core/cond-> {} (letvar1218134 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218134 ["NextMarker"]))) (letvar1218134 "Versions") (clojure.core/assoc :versions (deser-function-list (clojure.core/get-in letvar1218134 ["Versions"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1218136 input] (clojure.core/let [rawinput1218135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218137 {"Tags" (rawinput1218135 "Tags")}] (clojure.core/cond-> {} (letvar1218137 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1218137 ["Tags"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1218139 input] (clojure.core/let [rawinput1218138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218140 {"Type" (rawinput1218138 "Type"), "Message" (rawinput1218138 "Message")}] (clojure.core/cond-> {} (letvar1218140 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218140 ["Type"]))) (letvar1218140 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218140 ["Message"])))))))

(clojure.core/defn- response-list-event-source-mappings-response ([input] (response-list-event-source-mappings-response nil input)) ([resultWrapper1218142 input] (clojure.core/let [rawinput1218141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218143 {"NextMarker" (rawinput1218141 "NextMarker"), "EventSourceMappings" (rawinput1218141 "EventSourceMappings")}] (clojure.core/cond-> {} (letvar1218143 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218143 ["NextMarker"]))) (letvar1218143 "EventSourceMappings") (clojure.core/assoc :event-source-mappings (deser-event-source-mappings-list (clojure.core/get-in letvar1218143 ["EventSourceMappings"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1218145 input] (clojure.core/let [rawinput1218144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218146 {"Type" (rawinput1218144 "Type"), "Message" (rawinput1218144 "Message")}] (clojure.core/cond-> {} (letvar1218146 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218146 ["Type"]))) (letvar1218146 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218146 ["Message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1218148 input] (clojure.core/let [rawinput1218147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218149 {"Type" (rawinput1218147 "Type"), "Message" (rawinput1218147 "Message")}] (clojure.core/cond-> {} (letvar1218149 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218149 ["Type"]))) (letvar1218149 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218149 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1218151 input] (clojure.core/let [rawinput1218150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218152 {"Type" (rawinput1218150 "Type"), "Message" (rawinput1218150 "Message")}] (clojure.core/cond-> {} (letvar1218152 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218152 ["Type"]))) (letvar1218152 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218152 ["Message"])))))))

(clojure.core/defn- response-invalid-runtime-exception ([input] (response-invalid-runtime-exception nil input)) ([resultWrapper1218154 input] (clojure.core/let [rawinput1218153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218155 {"Type" (rawinput1218153 "Type"), "Message" (rawinput1218153 "Message")}] (clojure.core/cond-> {} (letvar1218155 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218155 ["Type"]))) (letvar1218155 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218155 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-response ([input] (response-get-layer-version-response nil input)) ([resultWrapper1218157 input] (clojure.core/let [rawinput1218156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218158 {"Content" (rawinput1218156 "Content"), "LayerArn" (rawinput1218156 "LayerArn"), "LayerVersionArn" (rawinput1218156 "LayerVersionArn"), "Description" (rawinput1218156 "Description"), "CreatedDate" (rawinput1218156 "CreatedDate"), "Version" (rawinput1218156 "Version"), "CompatibleRuntimes" (rawinput1218156 "CompatibleRuntimes"), "LicenseInfo" (rawinput1218156 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1218158 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1218158 ["Content"]))) (letvar1218158 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1218158 ["LayerArn"]))) (letvar1218158 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1218158 ["LayerVersionArn"]))) (letvar1218158 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1218158 ["Description"]))) (letvar1218158 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1218158 ["CreatedDate"]))) (letvar1218158 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1218158 ["Version"]))) (letvar1218158 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1218158 ["CompatibleRuntimes"]))) (letvar1218158 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1218158 ["LicenseInfo"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1218160 input] (clojure.core/let [rawinput1218159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218161 {"NextMarker" (rawinput1218159 "NextMarker"), "Functions" (rawinput1218159 "Functions")}] (clojure.core/cond-> {} (letvar1218161 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218161 ["NextMarker"]))) (letvar1218161 "Functions") (clojure.core/assoc :functions (deser-function-list (clojure.core/get-in letvar1218161 ["Functions"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1218163 input] (clojure.core/let [rawinput1218162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218164 {"Type" (rawinput1218162 "Type"), "Message" (rawinput1218162 "Message")}] (clojure.core/cond-> {} (letvar1218164 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218164 ["Type"]))) (letvar1218164 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218164 ["Message"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1218166 input] (clojure.core/let [rawinput1218165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218167 {"Configuration" (rawinput1218165 "Configuration"), "Code" (rawinput1218165 "Code"), "Tags" (rawinput1218165 "Tags"), "Concurrency" (rawinput1218165 "Concurrency")}] (clojure.core/cond-> {} (letvar1218167 "Configuration") (clojure.core/assoc :configuration (deser-function-configuration (clojure.core/get-in letvar1218167 ["Configuration"]))) (letvar1218167 "Code") (clojure.core/assoc :code (deser-function-code-location (clojure.core/get-in letvar1218167 ["Code"]))) (letvar1218167 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1218167 ["Tags"]))) (letvar1218167 "Concurrency") (clojure.core/assoc :concurrency (deser-concurrency (clojure.core/get-in letvar1218167 ["Concurrency"])))))))

(clojure.core/defn- response-code-storage-exceeded-exception ([input] (response-code-storage-exceeded-exception nil input)) ([resultWrapper1218169 input] (clojure.core/let [rawinput1218168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218170 {"Type" (rawinput1218168 "Type"), "message" (rawinput1218168 "message")}] (clojure.core/cond-> {} (letvar1218170 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218170 ["Type"]))) (letvar1218170 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218170 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1218172 input] (clojure.core/let [rawinput1218171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218173 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "Type" (rawinput1218171 "Type"), "message" (rawinput1218171 "message"), "Reason" (rawinput1218171 "Reason")}] (clojure.core/cond-> {} (letvar1218173 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar1218173 ["Retry-After"]))) (letvar1218173 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218173 ["Type"]))) (letvar1218173 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218173 ["message"]))) (letvar1218173 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1218173 ["Reason"])))))))

(clojure.core/defn- response-invalid-request-content-exception ([input] (response-invalid-request-content-exception nil input)) ([resultWrapper1218175 input] (clojure.core/let [rawinput1218174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218176 {"Type" (rawinput1218174 "Type"), "message" (rawinput1218174 "message")}] (clojure.core/cond-> {} (letvar1218176 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218176 ["Type"]))) (letvar1218176 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218176 ["message"])))))))

(clojure.core/defn- response-add-layer-version-permission-response ([input] (response-add-layer-version-permission-response nil input)) ([resultWrapper1218178 input] (clojure.core/let [rawinput1218177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218179 {"Statement" (rawinput1218177 "Statement"), "RevisionId" (rawinput1218177 "RevisionId")}] (clojure.core/cond-> {} (letvar1218179 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1218179 ["Statement"]))) (letvar1218179 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1218179 ["RevisionId"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1218181 input] (clojure.core/let [rawinput1218180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218182 {"Type" (rawinput1218180 "Type"), "Message" (rawinput1218180 "Message")}] (clojure.core/cond-> {} (letvar1218182 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218182 ["Type"]))) (letvar1218182 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218182 ["Message"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper1218184 input] (clojure.core/let [rawinput1218183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218185 {"AccountLimit" (rawinput1218183 "AccountLimit"), "AccountUsage" (rawinput1218183 "AccountUsage")}] (clojure.core/cond-> {} (letvar1218185 "AccountLimit") (clojure.core/assoc :account-limit (deser-account-limit (clojure.core/get-in letvar1218185 ["AccountLimit"]))) (letvar1218185 "AccountUsage") (clojure.core/assoc :account-usage (deser-account-usage (clojure.core/get-in letvar1218185 ["AccountUsage"])))))))

(clojure.core/defn- response-eni-limit-reached-exception ([input] (response-eni-limit-reached-exception nil input)) ([resultWrapper1218187 input] (clojure.core/let [rawinput1218186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218188 {"Type" (rawinput1218186 "Type"), "Message" (rawinput1218186 "Message")}] (clojure.core/cond-> {} (letvar1218188 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218188 ["Type"]))) (letvar1218188 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218188 ["Message"])))))))

(clojure.core/defn- response-concurrency ([input] (response-concurrency nil input)) ([resultWrapper1218190 input] (clojure.core/let [rawinput1218189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218191 {"ReservedConcurrentExecutions" (rawinput1218189 "ReservedConcurrentExecutions")}] (clojure.core/cond-> {} (letvar1218191 "ReservedConcurrentExecutions") (clojure.core/assoc :reserved-concurrent-executions (deser-reserved-concurrent-executions (clojure.core/get-in letvar1218191 ["ReservedConcurrentExecutions"])))))))

(clojure.core/defn- response-add-permission-response ([input] (response-add-permission-response nil input)) ([resultWrapper1218193 input] (clojure.core/let [rawinput1218192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218194 {"Statement" (rawinput1218192 "Statement")}] (clojure.core/cond-> {} (letvar1218194 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1218194 ["Statement"])))))))

(clojure.core/defn- response-invocation-response ([input] (response-invocation-response nil input)) ([resultWrapper1218196 input] (clojure.core/let [rawinput1218195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218197 {"StatusCode" (clojure.core/get-in input [:status "StatusCode"]), "X-Amz-Function-Error" (clojure.core/get-in input [:headers "X-Amz-Function-Error"]), "X-Amz-Log-Result" (clojure.core/get-in input [:headers "X-Amz-Log-Result"]), "Payload" (rawinput1218195 "Payload"), "X-Amz-Executed-Version" (clojure.core/get-in input [:headers "X-Amz-Executed-Version"])}] (clojure.core/cond-> {} (letvar1218197 "StatusCode") (clojure.core/assoc :status-code (deser-integer (clojure.core/get-in letvar1218197 ["StatusCode"]))) (letvar1218197 "X-Amz-Function-Error") (clojure.core/assoc :function-error (deser-string (clojure.core/get-in letvar1218197 ["X-Amz-Function-Error"]))) (letvar1218197 "X-Amz-Log-Result") (clojure.core/assoc :log-result (deser-string (clojure.core/get-in letvar1218197 ["X-Amz-Log-Result"]))) (letvar1218197 "Payload") (clojure.core/assoc :payload (deser-blob (clojure.core/get-in letvar1218197 ["Payload"]))) (letvar1218197 "X-Amz-Executed-Version") (clojure.core/assoc :executed-version (deser-version (clojure.core/get-in letvar1218197 ["X-Amz-Executed-Version"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1218199 input] (clojure.core/let [rawinput1218198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218200 {"Type" (rawinput1218198 "Type"), "Message" (rawinput1218198 "Message")}] (clojure.core/cond-> {} (letvar1218200 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218200 ["Type"]))) (letvar1218200 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218200 ["Message"])))))))

(clojure.core/defn- response-publish-layer-version-response ([input] (response-publish-layer-version-response nil input)) ([resultWrapper1218202 input] (clojure.core/let [rawinput1218201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218203 {"Content" (rawinput1218201 "Content"), "LayerArn" (rawinput1218201 "LayerArn"), "LayerVersionArn" (rawinput1218201 "LayerVersionArn"), "Description" (rawinput1218201 "Description"), "CreatedDate" (rawinput1218201 "CreatedDate"), "Version" (rawinput1218201 "Version"), "CompatibleRuntimes" (rawinput1218201 "CompatibleRuntimes"), "LicenseInfo" (rawinput1218201 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1218203 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1218203 ["Content"]))) (letvar1218203 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1218203 ["LayerArn"]))) (letvar1218203 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1218203 ["LayerVersionArn"]))) (letvar1218203 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1218203 ["Description"]))) (letvar1218203 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1218203 ["CreatedDate"]))) (letvar1218203 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1218203 ["Version"]))) (letvar1218203 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1218203 ["CompatibleRuntimes"]))) (letvar1218203 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1218203 ["LicenseInfo"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1218205 input] (clojure.core/let [rawinput1218204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218206 {"Policy" (rawinput1218204 "Policy"), "RevisionId" (rawinput1218204 "RevisionId")}] (clojure.core/cond-> {} (letvar1218206 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1218206 ["Policy"]))) (letvar1218206 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1218206 ["RevisionId"])))))))

(clojure.core/defn- response-invoke-async-response ([input] (response-invoke-async-response nil input)) ([resultWrapper1218208 input] (clojure.core/let [rawinput1218207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218209 {"Status" (clojure.core/get-in input [:status "Status"])}] (clojure.core/cond-> {} (letvar1218209 "Status") (clojure.core/assoc :status (deser-http-status (clojure.core/get-in letvar1218209 ["Status"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1218211 input] (clojure.core/let [rawinput1218210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218212 {"Type" (rawinput1218210 "Type"), "message" (rawinput1218210 "message")}] (clojure.core/cond-> {} (letvar1218212 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218212 ["Type"]))) (letvar1218212 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218212 ["message"])))))))

(clojure.core/defn- response-invalid-zip-file-exception ([input] (response-invalid-zip-file-exception nil input)) ([resultWrapper1218214 input] (clojure.core/let [rawinput1218213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218215 {"Type" (rawinput1218213 "Type"), "Message" (rawinput1218213 "Message")}] (clojure.core/cond-> {} (letvar1218215 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218215 ["Type"]))) (letvar1218215 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218215 ["Message"])))))))

(clojure.core/defn- response-list-aliases-response ([input] (response-list-aliases-response nil input)) ([resultWrapper1218217 input] (clojure.core/let [rawinput1218216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218218 {"NextMarker" (rawinput1218216 "NextMarker"), "Aliases" (rawinput1218216 "Aliases")}] (clojure.core/cond-> {} (letvar1218218 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1218218 ["NextMarker"]))) (letvar1218218 "Aliases") (clojure.core/assoc :aliases (deser-alias-list (clojure.core/get-in letvar1218218 ["Aliases"])))))))

(clojure.core/defn- response-function-configuration ([input] (response-function-configuration nil input)) ([resultWrapper1218220 input] (clojure.core/let [rawinput1218219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218221 {"TracingConfig" (rawinput1218219 "TracingConfig"), "FunctionArn" (rawinput1218219 "FunctionArn"), "FunctionName" (rawinput1218219 "FunctionName"), "Timeout" (rawinput1218219 "Timeout"), "Layers" (rawinput1218219 "Layers"), "DeadLetterConfig" (rawinput1218219 "DeadLetterConfig"), "Handler" (rawinput1218219 "Handler"), "Runtime" (rawinput1218219 "Runtime"), "MemorySize" (rawinput1218219 "MemorySize"), "Role" (rawinput1218219 "Role"), "KMSKeyArn" (rawinput1218219 "KMSKeyArn"), "Description" (rawinput1218219 "Description"), "LastModified" (rawinput1218219 "LastModified"), "Environment" (rawinput1218219 "Environment"), "CodeSize" (rawinput1218219 "CodeSize"), "VpcConfig" (rawinput1218219 "VpcConfig"), "RevisionId" (rawinput1218219 "RevisionId"), "Version" (rawinput1218219 "Version"), "CodeSha256" (rawinput1218219 "CodeSha256"), "MasterArn" (rawinput1218219 "MasterArn")}] (clojure.core/cond-> {} (letvar1218221 "TracingConfig") (clojure.core/assoc :tracing-config (deser-tracing-config-response (clojure.core/get-in letvar1218221 ["TracingConfig"]))) (letvar1218221 "FunctionArn") (clojure.core/assoc :function-arn (deser-name-spaced-function-arn (clojure.core/get-in letvar1218221 ["FunctionArn"]))) (letvar1218221 "FunctionName") (clojure.core/assoc :function-name (deser-namespaced-function-name (clojure.core/get-in letvar1218221 ["FunctionName"]))) (letvar1218221 "Timeout") (clojure.core/assoc :timeout (deser-timeout (clojure.core/get-in letvar1218221 ["Timeout"]))) (letvar1218221 "Layers") (clojure.core/assoc :layers (deser-layers-reference-list (clojure.core/get-in letvar1218221 ["Layers"]))) (letvar1218221 "DeadLetterConfig") (clojure.core/assoc :dead-letter-config (deser-dead-letter-config (clojure.core/get-in letvar1218221 ["DeadLetterConfig"]))) (letvar1218221 "Handler") (clojure.core/assoc :handler (deser-handler (clojure.core/get-in letvar1218221 ["Handler"]))) (letvar1218221 "Runtime") (clojure.core/assoc :runtime (deser-runtime (clojure.core/get-in letvar1218221 ["Runtime"]))) (letvar1218221 "MemorySize") (clojure.core/assoc :memory-size (deser-memory-size (clojure.core/get-in letvar1218221 ["MemorySize"]))) (letvar1218221 "Role") (clojure.core/assoc :role (deser-role-arn (clojure.core/get-in letvar1218221 ["Role"]))) (letvar1218221 "KMSKeyArn") (clojure.core/assoc :kms-key-arn (deser-kms-key-arn (clojure.core/get-in letvar1218221 ["KMSKeyArn"]))) (letvar1218221 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1218221 ["Description"]))) (letvar1218221 "LastModified") (clojure.core/assoc :last-modified (deser-timestamp (clojure.core/get-in letvar1218221 ["LastModified"]))) (letvar1218221 "Environment") (clojure.core/assoc :environment (deser-environment-response (clojure.core/get-in letvar1218221 ["Environment"]))) (letvar1218221 "CodeSize") (clojure.core/assoc :code-size (deser-long (clojure.core/get-in letvar1218221 ["CodeSize"]))) (letvar1218221 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config-response (clojure.core/get-in letvar1218221 ["VpcConfig"]))) (letvar1218221 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1218221 ["RevisionId"]))) (letvar1218221 "Version") (clojure.core/assoc :version (deser-version (clojure.core/get-in letvar1218221 ["Version"]))) (letvar1218221 "CodeSha256") (clojure.core/assoc :code-sha-256 (deser-string (clojure.core/get-in letvar1218221 ["CodeSha256"]))) (letvar1218221 "MasterArn") (clojure.core/assoc :master-arn (deser-function-arn (clojure.core/get-in letvar1218221 ["MasterArn"])))))))

(clojure.core/defn- response-policy-length-exceeded-exception ([input] (response-policy-length-exceeded-exception nil input)) ([resultWrapper1218223 input] (clojure.core/let [rawinput1218222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218224 {"Type" (rawinput1218222 "Type"), "message" (rawinput1218222 "message")}] (clojure.core/cond-> {} (letvar1218224 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218224 ["Type"]))) (letvar1218224 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218224 ["message"])))))))

(clojure.core/defn- response-alias-configuration ([input] (response-alias-configuration nil input)) ([resultWrapper1218226 input] (clojure.core/let [rawinput1218225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218227 {"AliasArn" (rawinput1218225 "AliasArn"), "Name" (rawinput1218225 "Name"), "FunctionVersion" (rawinput1218225 "FunctionVersion"), "Description" (rawinput1218225 "Description"), "RoutingConfig" (rawinput1218225 "RoutingConfig"), "RevisionId" (rawinput1218225 "RevisionId")}] (clojure.core/cond-> {} (letvar1218227 "AliasArn") (clojure.core/assoc :alias-arn (deser-function-arn (clojure.core/get-in letvar1218227 ["AliasArn"]))) (letvar1218227 "Name") (clojure.core/assoc :name (deser-alias (clojure.core/get-in letvar1218227 ["Name"]))) (letvar1218227 "FunctionVersion") (clojure.core/assoc :function-version (deser-version (clojure.core/get-in letvar1218227 ["FunctionVersion"]))) (letvar1218227 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1218227 ["Description"]))) (letvar1218227 "RoutingConfig") (clojure.core/assoc :routing-config (deser-alias-routing-configuration (clojure.core/get-in letvar1218227 ["RoutingConfig"]))) (letvar1218227 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1218227 ["RevisionId"])))))))

(clojure.core/defn- response-ec-2-throttled-exception ([input] (response-ec-2-throttled-exception nil input)) ([resultWrapper1218229 input] (clojure.core/let [rawinput1218228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218230 {"Type" (rawinput1218228 "Type"), "Message" (rawinput1218228 "Message")}] (clojure.core/cond-> {} (letvar1218230 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218230 ["Type"]))) (letvar1218230 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218230 ["Message"])))))))

(clojure.core/defn- response-ec-2-access-denied-exception ([input] (response-ec-2-access-denied-exception nil input)) ([resultWrapper1218232 input] (clojure.core/let [rawinput1218231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218233 {"Type" (rawinput1218231 "Type"), "Message" (rawinput1218231 "Message")}] (clojure.core/cond-> {} (letvar1218233 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218233 ["Type"]))) (letvar1218233 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218233 ["Message"])))))))

(clojure.core/defn- response-event-source-mapping-configuration ([input] (response-event-source-mapping-configuration nil input)) ([resultWrapper1218235 input] (clojure.core/let [rawinput1218234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218236 {"UUID" (rawinput1218234 "UUID"), "BatchSize" (rawinput1218234 "BatchSize"), "EventSourceArn" (rawinput1218234 "EventSourceArn"), "FunctionArn" (rawinput1218234 "FunctionArn"), "LastModified" (rawinput1218234 "LastModified"), "LastProcessingResult" (rawinput1218234 "LastProcessingResult"), "State" (rawinput1218234 "State"), "StateTransitionReason" (rawinput1218234 "StateTransitionReason")}] (clojure.core/cond-> {} (letvar1218236 "UUID") (clojure.core/assoc :uuid (deser-string (clojure.core/get-in letvar1218236 ["UUID"]))) (letvar1218236 "BatchSize") (clojure.core/assoc :batch-size (deser-batch-size (clojure.core/get-in letvar1218236 ["BatchSize"]))) (letvar1218236 "EventSourceArn") (clojure.core/assoc :event-source-arn (deser-arn (clojure.core/get-in letvar1218236 ["EventSourceArn"]))) (letvar1218236 "FunctionArn") (clojure.core/assoc :function-arn (deser-function-arn (clojure.core/get-in letvar1218236 ["FunctionArn"]))) (letvar1218236 "LastModified") (clojure.core/assoc :last-modified (deser-date (clojure.core/get-in letvar1218236 ["LastModified"]))) (letvar1218236 "LastProcessingResult") (clojure.core/assoc :last-processing-result (deser-string (clojure.core/get-in letvar1218236 ["LastProcessingResult"]))) (letvar1218236 "State") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1218236 ["State"]))) (letvar1218236 "StateTransitionReason") (clojure.core/assoc :state-transition-reason (deser-string (clojure.core/get-in letvar1218236 ["StateTransitionReason"])))))))

(clojure.core/defn- response-ec-2-unexpected-exception ([input] (response-ec-2-unexpected-exception nil input)) ([resultWrapper1218238 input] (clojure.core/let [rawinput1218237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218239 {"Type" (rawinput1218237 "Type"), "Message" (rawinput1218237 "Message"), "EC2ErrorCode" (rawinput1218237 "EC2ErrorCode")}] (clojure.core/cond-> {} (letvar1218239 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218239 ["Type"]))) (letvar1218239 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218239 ["Message"]))) (letvar1218239 "EC2ErrorCode") (clojure.core/assoc :ec-2-error-code (deser-string (clojure.core/get-in letvar1218239 ["EC2ErrorCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1218241 input] (clojure.core/let [rawinput1218240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218242 {"Type" (rawinput1218240 "Type"), "message" (rawinput1218240 "message")}] (clojure.core/cond-> {} (letvar1218242 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218242 ["Type"]))) (letvar1218242 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218242 ["message"])))))))

(clojure.core/defn- response-invalid-security-group-id-exception ([input] (response-invalid-security-group-id-exception nil input)) ([resultWrapper1218244 input] (clojure.core/let [rawinput1218243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218245 {"Type" (rawinput1218243 "Type"), "Message" (rawinput1218243 "Message")}] (clojure.core/cond-> {} (letvar1218245 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1218245 ["Type"]))) (letvar1218245 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1218245 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-policy-response ([input] (response-get-layer-version-policy-response nil input)) ([resultWrapper1218247 input] (clojure.core/let [rawinput1218246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1218248 {"Policy" (rawinput1218246 "Policy"), "RevisionId" (rawinput1218246 "RevisionId")}] (clojure.core/cond-> {} (letvar1218248 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1218248 ["Policy"]))) (letvar1218248 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1218248 ["RevisionId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-permission-allowed-action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"lambda:GetLayerVersion" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^\s]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 170)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{12}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"o-[a-z0-9]{10,32}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/license-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/tag-value (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+)|[a-zA-Z0-9-_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-version-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+:[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z0-9-]*):([a-zA-Z0-9\-])+:([a-z]{2}(-gov)?-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda.-2015-03-31/layer-permission-allowed-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{12}|\*|arn:(aws[a-zA-Z-]*):iam::\d{12}:root" s__21078__auto__))))
