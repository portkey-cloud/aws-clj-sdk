...
(clojure.core/defn- response-backup-in-progress ([input] (response-backup-in-progress nil input)) ([resultWrapper979092 input] (clojure.core/let [rawinput979091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979093 {"Message" (rawinput979091 "Message")}] (clojure.core/cond-> {} (letvar979093 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979093 ["Message"])))))))

(clojure.core/defn- response-create-backup-response ([input] (response-create-backup-response nil input)) ([resultWrapper979095 input] (clojure.core/let [rawinput979094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979096 {"Backup" (rawinput979094 "Backup")}] (clojure.core/cond-> {} (letvar979096 "Backup") (clojure.core/assoc :backup (deser-backup (clojure.core/get-in letvar979096 ["Backup"])))))))

(clojure.core/defn- response-bad-request ([input] (response-bad-request nil input)) ([resultWrapper979098 input] (clojure.core/let [rawinput979097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979099 {"Message" (rawinput979097 "Message")}] (clojure.core/cond-> {} (letvar979099 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979099 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper979101 input] (clojure.core/let [rawinput979100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979102 {"Tags" (rawinput979100 "Tags"), "NextToken" (rawinput979100 "NextToken")}] (clojure.core/cond-> {} (letvar979102 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar979102 ["Tags"]))) (letvar979102 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar979102 ["NextToken"])))))))

(clojure.core/defn- response-not-service-resource-error ([input] (response-not-service-resource-error nil input)) ([resultWrapper979104 input] (clojure.core/let [rawinput979103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979105 {"ResourceARN" (rawinput979103 "ResourceARN"), "Message" (rawinput979103 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar979105 ["ResourceARN"]))} (letvar979105 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979105 ["Message"])))))))

(clojure.core/defn- response-service-limit-exceeded ([input] (response-service-limit-exceeded nil input)) ([resultWrapper979107 input] (clojure.core/let [rawinput979106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979108 {"Limit" (rawinput979106 "Limit"), "Message" (rawinput979106 "Message")}] (clojure.core/cond-> {:limit (deser-service-limit (clojure.core/get-in letvar979108 ["Limit"]))} (letvar979108 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979108 ["Message"])))))))

(clojure.core/defn- response-incompatible-parameter-error ([input] (response-incompatible-parameter-error nil input)) ([resultWrapper979110 input] (clojure.core/let [rawinput979109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979111 {"Parameter" (rawinput979109 "Parameter"), "Message" (rawinput979109 "Message")}] (clojure.core/cond-> {:parameter (deser-parameter (clojure.core/get-in letvar979111 ["Parameter"]))} (letvar979111 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979111 ["Message"])))))))

(clojure.core/defn- response-describe-file-systems-response ([input] (response-describe-file-systems-response nil input)) ([resultWrapper979113 input] (clojure.core/let [rawinput979112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979114 {"FileSystems" (rawinput979112 "FileSystems"), "NextToken" (rawinput979112 "NextToken")}] (clojure.core/cond-> {} (letvar979114 "FileSystems") (clojure.core/assoc :file-systems (deser-file-systems (clojure.core/get-in letvar979114 ["FileSystems"]))) (letvar979114 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar979114 ["NextToken"])))))))

(clojure.core/defn- response-backup-restoring ([input] (response-backup-restoring nil input)) ([resultWrapper979116 input] (clojure.core/let [rawinput979115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979117 {"Message" (rawinput979115 "Message"), "FileSystemId" (rawinput979115 "FileSystemId")}] (clojure.core/cond-> {} (letvar979117 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979117 ["Message"]))) (letvar979117 "FileSystemId") (clojure.core/assoc :file-system-id (deser-file-system-id (clojure.core/get-in letvar979117 ["FileSystemId"])))))))

(clojure.core/defn- response-delete-backup-response ([input] (response-delete-backup-response nil input)) ([resultWrapper979119 input] (clojure.core/let [rawinput979118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979120 {"BackupId" (rawinput979118 "BackupId"), "Lifecycle" (rawinput979118 "Lifecycle")}] (clojure.core/cond-> {} (letvar979120 "BackupId") (clojure.core/assoc :backup-id (deser-backup-id (clojure.core/get-in letvar979120 ["BackupId"]))) (letvar979120 "Lifecycle") (clojure.core/assoc :lifecycle (deser-backup-lifecycle (clojure.core/get-in letvar979120 ["Lifecycle"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper979122 input] (clojure.core/let [rawinput979121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979123 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-file-system-response ([input] (response-update-file-system-response nil input)) ([resultWrapper979125 input] (clojure.core/let [rawinput979124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979126 {"FileSystem" (rawinput979124 "FileSystem")}] (clojure.core/cond-> {} (letvar979126 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar979126 ["FileSystem"])))))))

(clojure.core/defn- response-delete-file-system-response ([input] (response-delete-file-system-response nil input)) ([resultWrapper979128 input] (clojure.core/let [rawinput979127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979129 {"FileSystemId" (rawinput979127 "FileSystemId"), "Lifecycle" (rawinput979127 "Lifecycle"), "WindowsResponse" (rawinput979127 "WindowsResponse")}] (clojure.core/cond-> {} (letvar979129 "FileSystemId") (clojure.core/assoc :file-system-id (deser-file-system-id (clojure.core/get-in letvar979129 ["FileSystemId"]))) (letvar979129 "Lifecycle") (clojure.core/assoc :lifecycle (deser-file-system-lifecycle (clojure.core/get-in letvar979129 ["Lifecycle"]))) (letvar979129 "WindowsResponse") (clojure.core/assoc :windows-response (deser-delete-file-system-windows-response (clojure.core/get-in letvar979129 ["WindowsResponse"])))))))

(clojure.core/defn- response-file-system-not-found ([input] (response-file-system-not-found nil input)) ([resultWrapper979131 input] (clojure.core/let [rawinput979130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979132 {"Message" (rawinput979130 "Message")}] (clojure.core/cond-> {} (letvar979132 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979132 ["Message"])))))))

(clojure.core/defn- response-invalid-network-settings ([input] (response-invalid-network-settings nil input)) ([resultWrapper979134 input] (clojure.core/let [rawinput979133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979135 {"Message" (rawinput979133 "Message"), "InvalidSubnetId" (rawinput979133 "InvalidSubnetId"), "InvalidSecurityGroupId" (rawinput979133 "InvalidSecurityGroupId")}] (clojure.core/cond-> {} (letvar979135 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979135 ["Message"]))) (letvar979135 "InvalidSubnetId") (clojure.core/assoc :invalid-subnet-id (deser-subnet-id (clojure.core/get-in letvar979135 ["InvalidSubnetId"]))) (letvar979135 "InvalidSecurityGroupId") (clojure.core/assoc :invalid-security-group-id (deser-security-group-id (clojure.core/get-in letvar979135 ["InvalidSecurityGroupId"])))))))

(clojure.core/defn- response-backup-not-found ([input] (response-backup-not-found nil input)) ([resultWrapper979137 input] (clojure.core/let [rawinput979136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979138 {"Message" (rawinput979136 "Message")}] (clojure.core/cond-> {} (letvar979138 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979138 ["Message"])))))))

(clojure.core/defn- response-active-directory-error ([input] (response-active-directory-error nil input)) ([resultWrapper979140 input] (clojure.core/let [rawinput979139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979141 {"ActiveDirectoryId" (rawinput979139 "ActiveDirectoryId"), "Type" (rawinput979139 "Type"), "Message" (rawinput979139 "Message")}] (clojure.core/cond-> {:active-directory-id (deser-directory-id (clojure.core/get-in letvar979141 ["ActiveDirectoryId"]))} (letvar979141 "Type") (clojure.core/assoc :type (deser-active-directory-error-type (clojure.core/get-in letvar979141 ["Type"]))) (letvar979141 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979141 ["Message"])))))))

(clojure.core/defn- response-create-file-system-response ([input] (response-create-file-system-response nil input)) ([resultWrapper979143 input] (clojure.core/let [rawinput979142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979144 {"FileSystem" (rawinput979142 "FileSystem")}] (clojure.core/cond-> {} (letvar979144 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar979144 ["FileSystem"])))))))

(clojure.core/defn- response-resource-does-not-support-tagging ([input] (response-resource-does-not-support-tagging nil input)) ([resultWrapper979146 input] (clojure.core/let [rawinput979145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979147 {"ResourceARN" (rawinput979145 "ResourceARN"), "Message" (rawinput979145 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar979147 ["ResourceARN"]))} (letvar979147 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979147 ["Message"])))))))

(clojure.core/defn- response-create-file-system-from-backup-response ([input] (response-create-file-system-from-backup-response nil input)) ([resultWrapper979149 input] (clojure.core/let [rawinput979148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979150 {"FileSystem" (rawinput979148 "FileSystem")}] (clojure.core/cond-> {} (letvar979150 "FileSystem") (clojure.core/assoc :file-system (deser-file-system (clojure.core/get-in letvar979150 ["FileSystem"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper979152 input] (clojure.core/let [rawinput979151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979153 {"Message" (rawinput979151 "Message")}] (clojure.core/cond-> {} (letvar979153 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979153 ["Message"])))))))

(clojure.core/defn- response-invalid-import-path ([input] (response-invalid-import-path nil input)) ([resultWrapper979155 input] (clojure.core/let [rawinput979154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979156 {"Message" (rawinput979154 "Message")}] (clojure.core/cond-> {} (letvar979156 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979156 ["Message"])))))))

(clojure.core/defn- response-resource-not-found ([input] (response-resource-not-found nil input)) ([resultWrapper979158 input] (clojure.core/let [rawinput979157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979159 {"ResourceARN" (rawinput979157 "ResourceARN"), "Message" (rawinput979157 "Message")}] (clojure.core/cond-> {:resource-arn (deser-resource-arn (clojure.core/get-in letvar979159 ["ResourceARN"]))} (letvar979159 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979159 ["Message"])))))))

(clojure.core/defn- response-missing-file-system-configuration ([input] (response-missing-file-system-configuration nil input)) ([resultWrapper979161 input] (clojure.core/let [rawinput979160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979162 {"Message" (rawinput979160 "Message")}] (clojure.core/cond-> {} (letvar979162 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979162 ["Message"])))))))

(clojure.core/defn- response-describe-backups-response ([input] (response-describe-backups-response nil input)) ([resultWrapper979164 input] (clojure.core/let [rawinput979163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979165 {"Backups" (rawinput979163 "Backups"), "NextToken" (rawinput979163 "NextToken")}] (clojure.core/cond-> {} (letvar979165 "Backups") (clojure.core/assoc :backups (deser-backups (clojure.core/get-in letvar979165 ["Backups"]))) (letvar979165 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar979165 ["NextToken"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper979167 input] (clojure.core/let [rawinput979166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979168 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-export-path ([input] (response-invalid-export-path nil input)) ([resultWrapper979170 input] (clojure.core/let [rawinput979169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar979171 {"Message" (rawinput979169 "Message")}] (clojure.core/cond-> {} (letvar979171 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar979171 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/archive-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 900))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-za-z0-9_/.-]{0,255}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/weekly-time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 7 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 7)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[1-7]:([01]\d|2[0-3]):?([0-5]\d)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 15 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 24)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8,})$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(backup-[0-9a-f]{8,})$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/network-interface-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 21)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(eni-[0-9a-f]{8,})$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 12)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\d{12}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 11 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8,})$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/vpc-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 21)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(vpc-[0-9a-f]{8,})$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[89aAbB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}|arn:aws[a-z-]{0,7}:kms:[a-z]{2}-[a-z-]{4,}-\d+:\d{12}:(key|alias)\/([a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[89aAbB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}|[a-zA-Z0-9:\/_-]+)|alias\/[a-zA-Z0-9:\/_-]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/parameter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 12)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{10}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.fsx.-2018-03-01/daily-time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([01]\d|2[0-3]):?([0-5]\d)$" s__21078__auto__))))
