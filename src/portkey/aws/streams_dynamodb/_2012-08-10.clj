...
(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper2105617 input] (clojure.core/let [rawinput2105616 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105618 {"StreamDescription" (rawinput2105616 "StreamDescription")}] (clojure.core/cond-> {} (letvar2105618 "StreamDescription") (clojure.core/assoc :stream-description (deser-stream-description (clojure.core/get-in letvar2105618 ["StreamDescription"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2105620 input] (clojure.core/let [rawinput2105619 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105621 {"message" (rawinput2105619 "message")}] (clojure.core/cond-> {} (letvar2105621 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2105621 ["message"])))))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper2105623 input] (clojure.core/let [rawinput2105622 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105624 {"message" (rawinput2105622 "message")}] (clojure.core/cond-> {} (letvar2105624 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2105624 ["message"])))))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper2105626 input] (clojure.core/let [rawinput2105625 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105627 {"Records" (rawinput2105625 "Records"), "NextShardIterator" (rawinput2105625 "NextShardIterator")}] (clojure.core/cond-> {} (letvar2105627 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar2105627 ["Records"]))) (letvar2105627 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2105627 ["NextShardIterator"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2105629 input] (clojure.core/let [rawinput2105628 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105630 {"message" (rawinput2105628 "message")}] (clojure.core/cond-> {} (letvar2105630 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2105630 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper2105632 input] (clojure.core/let [rawinput2105631 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105633 {"Streams" (rawinput2105631 "Streams"), "LastEvaluatedStreamArn" (rawinput2105631 "LastEvaluatedStreamArn")}] (clojure.core/cond-> {} (letvar2105633 "Streams") (clojure.core/assoc :streams (deser-stream-list (clojure.core/get-in letvar2105633 ["Streams"]))) (letvar2105633 "LastEvaluatedStreamArn") (clojure.core/assoc :last-evaluated-stream-arn (deser-stream-arn (clojure.core/get-in letvar2105633 ["LastEvaluatedStreamArn"])))))))

(clojure.core/defn- response-trimmed-data-access-exception ([input] (response-trimmed-data-access-exception nil input)) ([resultWrapper2105635 input] (clojure.core/let [rawinput2105634 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105636 {"message" (rawinput2105634 "message")}] (clojure.core/cond-> {} (letvar2105636 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2105636 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper2105638 input] (clojure.core/let [rawinput2105637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105639 {"ShardIterator" (rawinput2105637 "ShardIterator")}] (clojure.core/cond-> {} (letvar2105639 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2105639 ["ShardIterator"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2105641 input] (clojure.core/let [rawinput2105640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2105642 {"message" (rawinput2105640 "message")}] (clojure.core/cond-> {} (letvar2105642 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2105642 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 65535))))

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/positive-long-object clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 28 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 65))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 21 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 37 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
