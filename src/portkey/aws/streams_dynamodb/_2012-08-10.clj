...
(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper2100255 input] (clojure.core/let [rawinput2100254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100256 {"StreamDescription" (rawinput2100254 "StreamDescription")}] (clojure.core/cond-> {} (letvar2100256 "StreamDescription") (clojure.core/assoc :stream-description (deser-stream-description (clojure.core/get-in letvar2100256 ["StreamDescription"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2100258 input] (clojure.core/let [rawinput2100257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100259 {"message" (rawinput2100257 "message")}] (clojure.core/cond-> {} (letvar2100259 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2100259 ["message"])))))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper2100261 input] (clojure.core/let [rawinput2100260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100262 {"message" (rawinput2100260 "message")}] (clojure.core/cond-> {} (letvar2100262 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2100262 ["message"])))))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper2100264 input] (clojure.core/let [rawinput2100263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100265 {"Records" (rawinput2100263 "Records"), "NextShardIterator" (rawinput2100263 "NextShardIterator")}] (clojure.core/cond-> {} (letvar2100265 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar2100265 ["Records"]))) (letvar2100265 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2100265 ["NextShardIterator"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2100267 input] (clojure.core/let [rawinput2100266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100268 {"message" (rawinput2100266 "message")}] (clojure.core/cond-> {} (letvar2100268 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2100268 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper2100270 input] (clojure.core/let [rawinput2100269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100271 {"Streams" (rawinput2100269 "Streams"), "LastEvaluatedStreamArn" (rawinput2100269 "LastEvaluatedStreamArn")}] (clojure.core/cond-> {} (letvar2100271 "Streams") (clojure.core/assoc :streams (deser-stream-list (clojure.core/get-in letvar2100271 ["Streams"]))) (letvar2100271 "LastEvaluatedStreamArn") (clojure.core/assoc :last-evaluated-stream-arn (deser-stream-arn (clojure.core/get-in letvar2100271 ["LastEvaluatedStreamArn"])))))))

(clojure.core/defn- response-trimmed-data-access-exception ([input] (response-trimmed-data-access-exception nil input)) ([resultWrapper2100273 input] (clojure.core/let [rawinput2100272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100274 {"message" (rawinput2100272 "message")}] (clojure.core/cond-> {} (letvar2100274 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2100274 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper2100276 input] (clojure.core/let [rawinput2100275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100277 {"ShardIterator" (rawinput2100275 "ShardIterator")}] (clojure.core/cond-> {} (letvar2100277 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2100277 ["ShardIterator"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2100279 input] (clojure.core/let [rawinput2100278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2100280 {"message" (rawinput2100278 "message")}] (clojure.core/cond-> {} (letvar2100280 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2100280 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 65535))))

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/positive-long-object clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 28 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 65))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 21 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 37 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb.-2012-08-10/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
