...
(clojure.core/defn- response-create-workteam-response ([input] (response-create-workteam-response nil input)) ([resultWrapper1658971 input] (clojure.core/let [rawinput1658970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658972 {"WorkteamArn" (rawinput1658970 "WorkteamArn")}] (clojure.core/cond-> {} (letvar1658972 "WorkteamArn") (clojure.core/assoc :workteam-arn (deser-workteam-arn (clojure.core/get-in letvar1658972 ["WorkteamArn"])))))))

(clojure.core/defn- response-create-labeling-job-response ([input] (response-create-labeling-job-response nil input)) ([resultWrapper1658974 input] (clojure.core/let [rawinput1658973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658975 {"LabelingJobArn" (rawinput1658973 "LabelingJobArn")}] (clojure.core/cond-> {:labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1658975 ["LabelingJobArn"]))}))))

(clojure.core/defn- response-list-endpoint-configs-output ([input] (response-list-endpoint-configs-output nil input)) ([resultWrapper1658977 input] (clojure.core/let [rawinput1658976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658978 {"EndpointConfigs" (rawinput1658976 "EndpointConfigs"), "NextToken" (rawinput1658976 "NextToken")}] (clojure.core/cond-> {:endpoint-configs (deser-endpoint-config-summary-list (clojure.core/get-in letvar1658978 ["EndpointConfigs"]))} (letvar1658978 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1658978 ["NextToken"])))))))

(clojure.core/defn- response-describe-algorithm-output ([input] (response-describe-algorithm-output nil input)) ([resultWrapper1658980 input] (clojure.core/let [rawinput1658979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658981 {"CertifyForMarketplace" (rawinput1658979 "CertifyForMarketplace"), "AlgorithmName" (rawinput1658979 "AlgorithmName"), "AlgorithmStatus" (rawinput1658979 "AlgorithmStatus"), "InferenceSpecification" (rawinput1658979 "InferenceSpecification"), "TrainingSpecification" (rawinput1658979 "TrainingSpecification"), "CreationTime" (rawinput1658979 "CreationTime"), "AlgorithmStatusDetails" (rawinput1658979 "AlgorithmStatusDetails"), "ValidationSpecification" (rawinput1658979 "ValidationSpecification"), "ProductId" (rawinput1658979 "ProductId"), "AlgorithmDescription" (rawinput1658979 "AlgorithmDescription"), "AlgorithmArn" (rawinput1658979 "AlgorithmArn")}] (clojure.core/cond-> {:algorithm-name (deser-entity-name (clojure.core/get-in letvar1658981 ["AlgorithmName"])), :algorithm-arn (deser-algorithm-arn (clojure.core/get-in letvar1658981 ["AlgorithmArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1658981 ["CreationTime"])), :training-specification (deser-training-specification (clojure.core/get-in letvar1658981 ["TrainingSpecification"])), :algorithm-status (deser-algorithm-status (clojure.core/get-in letvar1658981 ["AlgorithmStatus"])), :algorithm-status-details (deser-algorithm-status-details (clojure.core/get-in letvar1658981 ["AlgorithmStatusDetails"]))} (letvar1658981 "CertifyForMarketplace") (clojure.core/assoc :certify-for-marketplace (deser-certify-for-marketplace (clojure.core/get-in letvar1658981 ["CertifyForMarketplace"]))) (letvar1658981 "InferenceSpecification") (clojure.core/assoc :inference-specification (deser-inference-specification (clojure.core/get-in letvar1658981 ["InferenceSpecification"]))) (letvar1658981 "ValidationSpecification") (clojure.core/assoc :validation-specification (deser-algorithm-validation-specification (clojure.core/get-in letvar1658981 ["ValidationSpecification"]))) (letvar1658981 "ProductId") (clojure.core/assoc :product-id (deser-product-id (clojure.core/get-in letvar1658981 ["ProductId"]))) (letvar1658981 "AlgorithmDescription") (clojure.core/assoc :algorithm-description (deser-entity-description (clojure.core/get-in letvar1658981 ["AlgorithmDescription"])))))))

(clojure.core/defn- response-create-notebook-instance-lifecycle-config-output ([input] (response-create-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1658983 input] (clojure.core/let [rawinput1658982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658984 {"NotebookInstanceLifecycleConfigArn" (rawinput1658982 "NotebookInstanceLifecycleConfigArn")}] (clojure.core/cond-> {} (letvar1658984 "NotebookInstanceLifecycleConfigArn") (clojure.core/assoc :notebook-instance-lifecycle-config-arn (deser-notebook-instance-lifecycle-config-arn (clojure.core/get-in letvar1658984 ["NotebookInstanceLifecycleConfigArn"])))))))

(clojure.core/defn- response-list-transform-jobs-response ([input] (response-list-transform-jobs-response nil input)) ([resultWrapper1658986 input] (clojure.core/let [rawinput1658985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658987 {"TransformJobSummaries" (rawinput1658985 "TransformJobSummaries"), "NextToken" (rawinput1658985 "NextToken")}] (clojure.core/cond-> {:transform-job-summaries (deser-transform-job-summaries (clojure.core/get-in letvar1658987 ["TransformJobSummaries"]))} (letvar1658987 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1658987 ["NextToken"])))))))

(clojure.core/defn- response-list-models-output ([input] (response-list-models-output nil input)) ([resultWrapper1658989 input] (clojure.core/let [rawinput1658988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658990 {"Models" (rawinput1658988 "Models"), "NextToken" (rawinput1658988 "NextToken")}] (clojure.core/cond-> {:models (deser-model-summary-list (clojure.core/get-in letvar1658990 ["Models"]))} (letvar1658990 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1658990 ["NextToken"])))))))

(clojure.core/defn- response-create-presigned-notebook-instance-url-output ([input] (response-create-presigned-notebook-instance-url-output nil input)) ([resultWrapper1658992 input] (clojure.core/let [rawinput1658991 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658993 {"AuthorizedUrl" (rawinput1658991 "AuthorizedUrl")}] (clojure.core/cond-> {} (letvar1658993 "AuthorizedUrl") (clojure.core/assoc :authorized-url (deser-notebook-instance-url (clojure.core/get-in letvar1658993 ["AuthorizedUrl"])))))))

(clojure.core/defn- response-list-code-repositories-output ([input] (response-list-code-repositories-output nil input)) ([resultWrapper1658995 input] (clojure.core/let [rawinput1658994 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658996 {"CodeRepositorySummaryList" (rawinput1658994 "CodeRepositorySummaryList"), "NextToken" (rawinput1658994 "NextToken")}] (clojure.core/cond-> {:code-repository-summary-list (deser-code-repository-summary-list (clojure.core/get-in letvar1658996 ["CodeRepositorySummaryList"]))} (letvar1658996 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1658996 ["NextToken"])))))))

(clojure.core/defn- response-describe-hyper-parameter-tuning-job-response ([input] (response-describe-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1658998 input] (clojure.core/let [rawinput1658997 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1658999 {"HyperParameterTuningJobStatus" (rawinput1658997 "HyperParameterTuningJobStatus"), "HyperParameterTuningJobConfig" (rawinput1658997 "HyperParameterTuningJobConfig"), "ObjectiveStatusCounters" (rawinput1658997 "ObjectiveStatusCounters"), "HyperParameterTuningEndTime" (rawinput1658997 "HyperParameterTuningEndTime"), "HyperParameterTuningJobArn" (rawinput1658997 "HyperParameterTuningJobArn"), "WarmStartConfig" (rawinput1658997 "WarmStartConfig"), "BestTrainingJob" (rawinput1658997 "BestTrainingJob"), "FailureReason" (rawinput1658997 "FailureReason"), "TrainingJobStatusCounters" (rawinput1658997 "TrainingJobStatusCounters"), "TrainingJobDefinition" (rawinput1658997 "TrainingJobDefinition"), "CreationTime" (rawinput1658997 "CreationTime"), "HyperParameterTuningJobName" (rawinput1658997 "HyperParameterTuningJobName"), "LastModifiedTime" (rawinput1658997 "LastModifiedTime"), "OverallBestTrainingJob" (rawinput1658997 "OverallBestTrainingJob")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-name (deser-hyper-parameter-tuning-job-name (clojure.core/get-in letvar1658999 ["HyperParameterTuningJobName"])), :hyper-parameter-tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1658999 ["HyperParameterTuningJobArn"])), :hyper-parameter-tuning-job-config (deser-hyper-parameter-tuning-job-config (clojure.core/get-in letvar1658999 ["HyperParameterTuningJobConfig"])), :training-job-definition (deser-hyper-parameter-training-job-definition (clojure.core/get-in letvar1658999 ["TrainingJobDefinition"])), :hyper-parameter-tuning-job-status (deser-hyper-parameter-tuning-job-status (clojure.core/get-in letvar1658999 ["HyperParameterTuningJobStatus"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1658999 ["CreationTime"])), :training-job-status-counters (deser-training-job-status-counters (clojure.core/get-in letvar1658999 ["TrainingJobStatusCounters"])), :objective-status-counters (deser-objective-status-counters (clojure.core/get-in letvar1658999 ["ObjectiveStatusCounters"]))} (letvar1658999 "HyperParameterTuningEndTime") (clojure.core/assoc :hyper-parameter-tuning-end-time (deser-timestamp (clojure.core/get-in letvar1658999 ["HyperParameterTuningEndTime"]))) (letvar1658999 "WarmStartConfig") (clojure.core/assoc :warm-start-config (deser-hyper-parameter-tuning-job-warm-start-config (clojure.core/get-in letvar1658999 ["WarmStartConfig"]))) (letvar1658999 "BestTrainingJob") (clojure.core/assoc :best-training-job (deser-hyper-parameter-training-job-summary (clojure.core/get-in letvar1658999 ["BestTrainingJob"]))) (letvar1658999 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1658999 ["FailureReason"]))) (letvar1658999 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-timestamp (clojure.core/get-in letvar1658999 ["LastModifiedTime"]))) (letvar1658999 "OverallBestTrainingJob") (clojure.core/assoc :overall-best-training-job (deser-hyper-parameter-training-job-summary (clojure.core/get-in letvar1658999 ["OverallBestTrainingJob"])))))))

(clojure.core/defn- response-create-hyper-parameter-tuning-job-response ([input] (response-create-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1659001 input] (clojure.core/let [rawinput1659000 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659002 {"HyperParameterTuningJobArn" (rawinput1659000 "HyperParameterTuningJobArn")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1659002 ["HyperParameterTuningJobArn"]))}))))

(clojure.core/defn- response-describe-transform-job-response ([input] (response-describe-transform-job-response nil input)) ([resultWrapper1659004 input] (clojure.core/let [rawinput1659003 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659005 {"LabelingJobArn" (rawinput1659003 "LabelingJobArn"), "TransformEndTime" (rawinput1659003 "TransformEndTime"), "ModelName" (rawinput1659003 "ModelName"), "MaxPayloadInMB" (rawinput1659003 "MaxPayloadInMB"), "TransformResources" (rawinput1659003 "TransformResources"), "MaxConcurrentTransforms" (rawinput1659003 "MaxConcurrentTransforms"), "TransformInput" (rawinput1659003 "TransformInput"), "TransformStartTime" (rawinput1659003 "TransformStartTime"), "FailureReason" (rawinput1659003 "FailureReason"), "TransformJobName" (rawinput1659003 "TransformJobName"), "TransformJobArn" (rawinput1659003 "TransformJobArn"), "BatchStrategy" (rawinput1659003 "BatchStrategy"), "Environment" (rawinput1659003 "Environment"), "CreationTime" (rawinput1659003 "CreationTime"), "TransformJobStatus" (rawinput1659003 "TransformJobStatus"), "TransformOutput" (rawinput1659003 "TransformOutput")}] (clojure.core/cond-> {:transform-job-name (deser-transform-job-name (clojure.core/get-in letvar1659005 ["TransformJobName"])), :transform-job-arn (deser-transform-job-arn (clojure.core/get-in letvar1659005 ["TransformJobArn"])), :transform-job-status (deser-transform-job-status (clojure.core/get-in letvar1659005 ["TransformJobStatus"])), :model-name (deser-model-name (clojure.core/get-in letvar1659005 ["ModelName"])), :transform-input (deser-transform-input (clojure.core/get-in letvar1659005 ["TransformInput"])), :transform-resources (deser-transform-resources (clojure.core/get-in letvar1659005 ["TransformResources"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659005 ["CreationTime"]))} (letvar1659005 "LabelingJobArn") (clojure.core/assoc :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1659005 ["LabelingJobArn"]))) (letvar1659005 "TransformEndTime") (clojure.core/assoc :transform-end-time (deser-timestamp (clojure.core/get-in letvar1659005 ["TransformEndTime"]))) (letvar1659005 "MaxPayloadInMB") (clojure.core/assoc :max-payload-in-mb (deser-max-payload-in-mb (clojure.core/get-in letvar1659005 ["MaxPayloadInMB"]))) (letvar1659005 "MaxConcurrentTransforms") (clojure.core/assoc :max-concurrent-transforms (deser-max-concurrent-transforms (clojure.core/get-in letvar1659005 ["MaxConcurrentTransforms"]))) (letvar1659005 "TransformStartTime") (clojure.core/assoc :transform-start-time (deser-timestamp (clojure.core/get-in letvar1659005 ["TransformStartTime"]))) (letvar1659005 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659005 ["FailureReason"]))) (letvar1659005 "BatchStrategy") (clojure.core/assoc :batch-strategy (deser-batch-strategy (clojure.core/get-in letvar1659005 ["BatchStrategy"]))) (letvar1659005 "Environment") (clojure.core/assoc :environment (deser-transform-environment-map (clojure.core/get-in letvar1659005 ["Environment"]))) (letvar1659005 "TransformOutput") (clojure.core/assoc :transform-output (deser-transform-output (clojure.core/get-in letvar1659005 ["TransformOutput"])))))))

(clojure.core/defn- response-delete-workteam-response ([input] (response-delete-workteam-response nil input)) ([resultWrapper1659007 input] (clojure.core/let [rawinput1659006 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659008 {"Success" (rawinput1659006 "Success")}] (clojure.core/cond-> {:success (deser-success (clojure.core/get-in letvar1659008 ["Success"]))}))))

(clojure.core/defn- response-update-code-repository-output ([input] (response-update-code-repository-output nil input)) ([resultWrapper1659010 input] (clojure.core/let [rawinput1659009 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659011 {"CodeRepositoryArn" (rawinput1659009 "CodeRepositoryArn")}] (clojure.core/cond-> {:code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1659011 ["CodeRepositoryArn"]))}))))

(clojure.core/defn- response-delete-tags-output ([input] (response-delete-tags-output nil input)) ([resultWrapper1659013 input] (clojure.core/let [rawinput1659012 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659014 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-labeling-jobs-for-workteam-response ([input] (response-list-labeling-jobs-for-workteam-response nil input)) ([resultWrapper1659016 input] (clojure.core/let [rawinput1659015 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659017 {"LabelingJobSummaryList" (rawinput1659015 "LabelingJobSummaryList"), "NextToken" (rawinput1659015 "NextToken")}] (clojure.core/cond-> {:labeling-job-summary-list (deser-labeling-job-for-workteam-summary-list (clojure.core/get-in letvar1659017 ["LabelingJobSummaryList"]))} (letvar1659017 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659017 ["NextToken"])))))))

(clojure.core/defn- response-describe-code-repository-output ([input] (response-describe-code-repository-output nil input)) ([resultWrapper1659019 input] (clojure.core/let [rawinput1659018 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659020 {"CodeRepositoryName" (rawinput1659018 "CodeRepositoryName"), "CodeRepositoryArn" (rawinput1659018 "CodeRepositoryArn"), "CreationTime" (rawinput1659018 "CreationTime"), "LastModifiedTime" (rawinput1659018 "LastModifiedTime"), "GitConfig" (rawinput1659018 "GitConfig")}] (clojure.core/cond-> {:code-repository-name (deser-entity-name (clojure.core/get-in letvar1659020 ["CodeRepositoryName"])), :code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1659020 ["CodeRepositoryArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1659020 ["CreationTime"])), :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1659020 ["LastModifiedTime"]))} (letvar1659020 "GitConfig") (clojure.core/assoc :git-config (deser-git-config (clojure.core/get-in letvar1659020 ["GitConfig"])))))))

(clojure.core/defn- response-describe-compilation-job-response ([input] (response-describe-compilation-job-response nil input)) ([resultWrapper1659022 input] (clojure.core/let [rawinput1659021 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659023 {"InputConfig" (rawinput1659021 "InputConfig"), "RoleArn" (rawinput1659021 "RoleArn"), "StoppingCondition" (rawinput1659021 "StoppingCondition"), "CompilationJobArn" (rawinput1659021 "CompilationJobArn"), "CompilationEndTime" (rawinput1659021 "CompilationEndTime"), "FailureReason" (rawinput1659021 "FailureReason"), "CreationTime" (rawinput1659021 "CreationTime"), "CompilationJobName" (rawinput1659021 "CompilationJobName"), "ModelArtifacts" (rawinput1659021 "ModelArtifacts"), "LastModifiedTime" (rawinput1659021 "LastModifiedTime"), "CompilationJobStatus" (rawinput1659021 "CompilationJobStatus"), "OutputConfig" (rawinput1659021 "OutputConfig"), "CompilationStartTime" (rawinput1659021 "CompilationStartTime")}] (clojure.core/cond-> {:compilation-job-name (deser-entity-name (clojure.core/get-in letvar1659023 ["CompilationJobName"])), :stopping-condition (deser-stopping-condition (clojure.core/get-in letvar1659023 ["StoppingCondition"])), :output-config (deser-output-config (clojure.core/get-in letvar1659023 ["OutputConfig"])), :compilation-job-status (deser-compilation-job-status (clojure.core/get-in letvar1659023 ["CompilationJobStatus"])), :model-artifacts (deser-model-artifacts (clojure.core/get-in letvar1659023 ["ModelArtifacts"])), :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659023 ["FailureReason"])), :role-arn (deser-role-arn (clojure.core/get-in letvar1659023 ["RoleArn"])), :input-config (deser-input-config (clojure.core/get-in letvar1659023 ["InputConfig"])), :compilation-job-arn (deser-compilation-job-arn (clojure.core/get-in letvar1659023 ["CompilationJobArn"])), :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1659023 ["LastModifiedTime"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1659023 ["CreationTime"]))} (letvar1659023 "CompilationEndTime") (clojure.core/assoc :compilation-end-time (deser-timestamp (clojure.core/get-in letvar1659023 ["CompilationEndTime"]))) (letvar1659023 "CompilationStartTime") (clojure.core/assoc :compilation-start-time (deser-timestamp (clojure.core/get-in letvar1659023 ["CompilationStartTime"])))))))

(clojure.core/defn- response-describe-model-output ([input] (response-describe-model-output nil input)) ([resultWrapper1659025 input] (clojure.core/let [rawinput1659024 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659026 {"ModelName" (rawinput1659024 "ModelName"), "PrimaryContainer" (rawinput1659024 "PrimaryContainer"), "Containers" (rawinput1659024 "Containers"), "ExecutionRoleArn" (rawinput1659024 "ExecutionRoleArn"), "VpcConfig" (rawinput1659024 "VpcConfig"), "CreationTime" (rawinput1659024 "CreationTime"), "ModelArn" (rawinput1659024 "ModelArn"), "EnableNetworkIsolation" (rawinput1659024 "EnableNetworkIsolation")}] (clojure.core/cond-> {:model-name (deser-model-name (clojure.core/get-in letvar1659026 ["ModelName"])), :execution-role-arn (deser-role-arn (clojure.core/get-in letvar1659026 ["ExecutionRoleArn"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659026 ["CreationTime"])), :model-arn (deser-model-arn (clojure.core/get-in letvar1659026 ["ModelArn"]))} (letvar1659026 "PrimaryContainer") (clojure.core/assoc :primary-container (deser-container-definition (clojure.core/get-in letvar1659026 ["PrimaryContainer"]))) (letvar1659026 "Containers") (clojure.core/assoc :containers (deser-container-definition-list (clojure.core/get-in letvar1659026 ["Containers"]))) (letvar1659026 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config (clojure.core/get-in letvar1659026 ["VpcConfig"]))) (letvar1659026 "EnableNetworkIsolation") (clojure.core/assoc :enable-network-isolation (deser-boolean (clojure.core/get-in letvar1659026 ["EnableNetworkIsolation"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1659028 input] (clojure.core/let [rawinput1659027 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659029 {"Tags" (rawinput1659027 "Tags")}] (clojure.core/cond-> {} (letvar1659029 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1659029 ["Tags"])))))))

(clojure.core/defn- response-list-model-packages-output ([input] (response-list-model-packages-output nil input)) ([resultWrapper1659031 input] (clojure.core/let [rawinput1659030 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659032 {"ModelPackageSummaryList" (rawinput1659030 "ModelPackageSummaryList"), "NextToken" (rawinput1659030 "NextToken")}] (clojure.core/cond-> {:model-package-summary-list (deser-model-package-summary-list (clojure.core/get-in letvar1659032 ["ModelPackageSummaryList"]))} (letvar1659032 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659032 ["NextToken"])))))))

(clojure.core/defn- response-list-subscribed-workteams-response ([input] (response-list-subscribed-workteams-response nil input)) ([resultWrapper1659034 input] (clojure.core/let [rawinput1659033 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659035 {"SubscribedWorkteams" (rawinput1659033 "SubscribedWorkteams"), "NextToken" (rawinput1659033 "NextToken")}] (clojure.core/cond-> {:subscribed-workteams (deser-subscribed-workteams (clojure.core/get-in letvar1659035 ["SubscribedWorkteams"]))} (letvar1659035 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659035 ["NextToken"])))))))

(clojure.core/defn- response-list-workteams-response ([input] (response-list-workteams-response nil input)) ([resultWrapper1659037 input] (clojure.core/let [rawinput1659036 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659038 {"Workteams" (rawinput1659036 "Workteams"), "NextToken" (rawinput1659036 "NextToken")}] (clojure.core/cond-> {:workteams (deser-workteams (clojure.core/get-in letvar1659038 ["Workteams"]))} (letvar1659038 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659038 ["NextToken"])))))))

(clojure.core/defn- response-create-model-output ([input] (response-create-model-output nil input)) ([resultWrapper1659040 input] (clojure.core/let [rawinput1659039 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659041 {"ModelArn" (rawinput1659039 "ModelArn")}] (clojure.core/cond-> {:model-arn (deser-model-arn (clojure.core/get-in letvar1659041 ["ModelArn"]))}))))

(clojure.core/defn- response-list-notebook-instances-output ([input] (response-list-notebook-instances-output nil input)) ([resultWrapper1659043 input] (clojure.core/let [rawinput1659042 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659044 {"NextToken" (rawinput1659042 "NextToken"), "NotebookInstances" (rawinput1659042 "NotebookInstances")}] (clojure.core/cond-> {} (letvar1659044 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659044 ["NextToken"]))) (letvar1659044 "NotebookInstances") (clojure.core/assoc :notebook-instances (deser-notebook-instance-summary-list (clojure.core/get-in letvar1659044 ["NotebookInstances"])))))))

(clojure.core/defn- response-describe-workteam-response ([input] (response-describe-workteam-response nil input)) ([resultWrapper1659046 input] (clojure.core/let [rawinput1659045 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659047 {"Workteam" (rawinput1659045 "Workteam")}] (clojure.core/cond-> {:workteam (deser-workteam (clojure.core/get-in letvar1659047 ["Workteam"]))}))))

(clojure.core/defn- response-list-labeling-jobs-response ([input] (response-list-labeling-jobs-response nil input)) ([resultWrapper1659049 input] (clojure.core/let [rawinput1659048 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659050 {"LabelingJobSummaryList" (rawinput1659048 "LabelingJobSummaryList"), "NextToken" (rawinput1659048 "NextToken")}] (clojure.core/cond-> {} (letvar1659050 "LabelingJobSummaryList") (clojure.core/assoc :labeling-job-summary-list (deser-labeling-job-summary-list (clojure.core/get-in letvar1659050 ["LabelingJobSummaryList"]))) (letvar1659050 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659050 ["NextToken"])))))))

(clojure.core/defn- response-describe-notebook-instance-output ([input] (response-describe-notebook-instance-output nil input)) ([resultWrapper1659052 input] (clojure.core/let [rawinput1659051 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659053 {"VolumeSizeInGB" (rawinput1659051 "VolumeSizeInGB"), "NotebookInstanceArn" (rawinput1659051 "NotebookInstanceArn"), "SubnetId" (rawinput1659051 "SubnetId"), "SecurityGroups" (rawinput1659051 "SecurityGroups"), "InstanceType" (rawinput1659051 "InstanceType"), "RoleArn" (rawinput1659051 "RoleArn"), "AcceleratorTypes" (rawinput1659051 "AcceleratorTypes"), "NetworkInterfaceId" (rawinput1659051 "NetworkInterfaceId"), "NotebookInstanceLifecycleConfigName" (rawinput1659051 "NotebookInstanceLifecycleConfigName"), "NotebookInstanceStatus" (rawinput1659051 "NotebookInstanceStatus"), "DefaultCodeRepository" (rawinput1659051 "DefaultCodeRepository"), "DirectInternetAccess" (rawinput1659051 "DirectInternetAccess"), "Url" (rawinput1659051 "Url"), "AdditionalCodeRepositories" (rawinput1659051 "AdditionalCodeRepositories"), "FailureReason" (rawinput1659051 "FailureReason"), "KmsKeyId" (rawinput1659051 "KmsKeyId"), "CreationTime" (rawinput1659051 "CreationTime"), "LastModifiedTime" (rawinput1659051 "LastModifiedTime"), "NotebookInstanceName" (rawinput1659051 "NotebookInstanceName")}] (clojure.core/cond-> {} (letvar1659053 "VolumeSizeInGB") (clojure.core/assoc :volume-size-in-gb (deser-notebook-instance-volume-size-in-gb (clojure.core/get-in letvar1659053 ["VolumeSizeInGB"]))) (letvar1659053 "NotebookInstanceArn") (clojure.core/assoc :notebook-instance-arn (deser-notebook-instance-arn (clojure.core/get-in letvar1659053 ["NotebookInstanceArn"]))) (letvar1659053 "SubnetId") (clojure.core/assoc :subnet-id (deser-subnet-id (clojure.core/get-in letvar1659053 ["SubnetId"]))) (letvar1659053 "SecurityGroups") (clojure.core/assoc :security-groups (deser-security-group-ids (clojure.core/get-in letvar1659053 ["SecurityGroups"]))) (letvar1659053 "InstanceType") (clojure.core/assoc :instance-type (deser-instance-type (clojure.core/get-in letvar1659053 ["InstanceType"]))) (letvar1659053 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1659053 ["RoleArn"]))) (letvar1659053 "AcceleratorTypes") (clojure.core/assoc :accelerator-types (deser-notebook-instance-accelerator-types (clojure.core/get-in letvar1659053 ["AcceleratorTypes"]))) (letvar1659053 "NetworkInterfaceId") (clojure.core/assoc :network-interface-id (deser-network-interface-id (clojure.core/get-in letvar1659053 ["NetworkInterfaceId"]))) (letvar1659053 "NotebookInstanceLifecycleConfigName") (clojure.core/assoc :notebook-instance-lifecycle-config-name (deser-notebook-instance-lifecycle-config-name (clojure.core/get-in letvar1659053 ["NotebookInstanceLifecycleConfigName"]))) (letvar1659053 "NotebookInstanceStatus") (clojure.core/assoc :notebook-instance-status (deser-notebook-instance-status (clojure.core/get-in letvar1659053 ["NotebookInstanceStatus"]))) (letvar1659053 "DefaultCodeRepository") (clojure.core/assoc :default-code-repository (deser-code-repository-name-or-url (clojure.core/get-in letvar1659053 ["DefaultCodeRepository"]))) (letvar1659053 "DirectInternetAccess") (clojure.core/assoc :direct-internet-access (deser-direct-internet-access (clojure.core/get-in letvar1659053 ["DirectInternetAccess"]))) (letvar1659053 "Url") (clojure.core/assoc :url (deser-notebook-instance-url (clojure.core/get-in letvar1659053 ["Url"]))) (letvar1659053 "AdditionalCodeRepositories") (clojure.core/assoc :additional-code-repositories (deser-additional-code-repository-names-or-urls (clojure.core/get-in letvar1659053 ["AdditionalCodeRepositories"]))) (letvar1659053 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659053 ["FailureReason"]))) (letvar1659053 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar1659053 ["KmsKeyId"]))) (letvar1659053 "CreationTime") (clojure.core/assoc :creation-time (deser-creation-time (clojure.core/get-in letvar1659053 ["CreationTime"]))) (letvar1659053 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1659053 ["LastModifiedTime"]))) (letvar1659053 "NotebookInstanceName") (clojure.core/assoc :notebook-instance-name (deser-notebook-instance-name (clojure.core/get-in letvar1659053 ["NotebookInstanceName"])))))))

(clojure.core/defn- response-list-training-jobs-for-hyper-parameter-tuning-job-response ([input] (response-list-training-jobs-for-hyper-parameter-tuning-job-response nil input)) ([resultWrapper1659055 input] (clojure.core/let [rawinput1659054 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659056 {"TrainingJobSummaries" (rawinput1659054 "TrainingJobSummaries"), "NextToken" (rawinput1659054 "NextToken")}] (clojure.core/cond-> {:training-job-summaries (deser-hyper-parameter-training-job-summaries (clojure.core/get-in letvar1659056 ["TrainingJobSummaries"]))} (letvar1659056 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659056 ["NextToken"])))))))

(clojure.core/defn- response-get-search-suggestions-response ([input] (response-get-search-suggestions-response nil input)) ([resultWrapper1659058 input] (clojure.core/let [rawinput1659057 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659059 {"PropertyNameSuggestions" (rawinput1659057 "PropertyNameSuggestions")}] (clojure.core/cond-> {} (letvar1659059 "PropertyNameSuggestions") (clojure.core/assoc :property-name-suggestions (deser-property-name-suggestion-list (clojure.core/get-in letvar1659059 ["PropertyNameSuggestions"])))))))

(clojure.core/defn- response-list-training-jobs-response ([input] (response-list-training-jobs-response nil input)) ([resultWrapper1659061 input] (clojure.core/let [rawinput1659060 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659062 {"TrainingJobSummaries" (rawinput1659060 "TrainingJobSummaries"), "NextToken" (rawinput1659060 "NextToken")}] (clojure.core/cond-> {:training-job-summaries (deser-training-job-summaries (clojure.core/get-in letvar1659062 ["TrainingJobSummaries"]))} (letvar1659062 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659062 ["NextToken"])))))))

(clojure.core/defn- response-describe-labeling-job-response ([input] (response-describe-labeling-job-response nil input)) ([resultWrapper1659064 input] (clojure.core/let [rawinput1659063 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659065 {"LabelingJobArn" (rawinput1659063 "LabelingJobArn"), "LabelCounters" (rawinput1659063 "LabelCounters"), "InputConfig" (rawinput1659063 "InputConfig"), "LabelingJobOutput" (rawinput1659063 "LabelingJobOutput"), "RoleArn" (rawinput1659063 "RoleArn"), "Tags" (rawinput1659063 "Tags"), "HumanTaskConfig" (rawinput1659063 "HumanTaskConfig"), "LabelAttributeName" (rawinput1659063 "LabelAttributeName"), "FailureReason" (rawinput1659063 "FailureReason"), "CreationTime" (rawinput1659063 "CreationTime"), "StoppingConditions" (rawinput1659063 "StoppingConditions"), "LabelingJobName" (rawinput1659063 "LabelingJobName"), "LabelCategoryConfigS3Uri" (rawinput1659063 "LabelCategoryConfigS3Uri"), "JobReferenceCode" (rawinput1659063 "JobReferenceCode"), "LastModifiedTime" (rawinput1659063 "LastModifiedTime"), "LabelingJobStatus" (rawinput1659063 "LabelingJobStatus"), "LabelingJobAlgorithmsConfig" (rawinput1659063 "LabelingJobAlgorithmsConfig"), "OutputConfig" (rawinput1659063 "OutputConfig")}] (clojure.core/cond-> {:labeling-job-name (deser-labeling-job-name (clojure.core/get-in letvar1659065 ["LabelingJobName"])), :output-config (deser-labeling-job-output-config (clojure.core/get-in letvar1659065 ["OutputConfig"])), :human-task-config (deser-human-task-config (clojure.core/get-in letvar1659065 ["HumanTaskConfig"])), :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1659065 ["LabelingJobArn"])), :labeling-job-status (deser-labeling-job-status (clojure.core/get-in letvar1659065 ["LabelingJobStatus"])), :role-arn (deser-role-arn (clojure.core/get-in letvar1659065 ["RoleArn"])), :job-reference-code (deser-job-reference-code (clojure.core/get-in letvar1659065 ["JobReferenceCode"])), :input-config (deser-labeling-job-input-config (clojure.core/get-in letvar1659065 ["InputConfig"])), :last-modified-time (deser-timestamp (clojure.core/get-in letvar1659065 ["LastModifiedTime"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659065 ["CreationTime"])), :label-counters (deser-label-counters (clojure.core/get-in letvar1659065 ["LabelCounters"]))} (letvar1659065 "LabelingJobOutput") (clojure.core/assoc :labeling-job-output (deser-labeling-job-output (clojure.core/get-in letvar1659065 ["LabelingJobOutput"]))) (letvar1659065 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1659065 ["Tags"]))) (letvar1659065 "LabelAttributeName") (clojure.core/assoc :label-attribute-name (deser-label-attribute-name (clojure.core/get-in letvar1659065 ["LabelAttributeName"]))) (letvar1659065 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659065 ["FailureReason"]))) (letvar1659065 "StoppingConditions") (clojure.core/assoc :stopping-conditions (deser-labeling-job-stopping-conditions (clojure.core/get-in letvar1659065 ["StoppingConditions"]))) (letvar1659065 "LabelCategoryConfigS3Uri") (clojure.core/assoc :label-category-config-s-3-uri (deser-s-3-uri (clojure.core/get-in letvar1659065 ["LabelCategoryConfigS3Uri"]))) (letvar1659065 "LabelingJobAlgorithmsConfig") (clojure.core/assoc :labeling-job-algorithms-config (deser-labeling-job-algorithms-config (clojure.core/get-in letvar1659065 ["LabelingJobAlgorithmsConfig"])))))))

(clojure.core/defn- response-update-endpoint-weights-and-capacities-output ([input] (response-update-endpoint-weights-and-capacities-output nil input)) ([resultWrapper1659067 input] (clojure.core/let [rawinput1659066 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659068 {"EndpointArn" (rawinput1659066 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1659068 ["EndpointArn"]))}))))

(clojure.core/defn- response-create-transform-job-response ([input] (response-create-transform-job-response nil input)) ([resultWrapper1659070 input] (clojure.core/let [rawinput1659069 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659071 {"TransformJobArn" (rawinput1659069 "TransformJobArn")}] (clojure.core/cond-> {:transform-job-arn (deser-transform-job-arn (clojure.core/get-in letvar1659071 ["TransformJobArn"]))}))))

(clojure.core/defn- response-describe-endpoint-config-output ([input] (response-describe-endpoint-config-output nil input)) ([resultWrapper1659073 input] (clojure.core/let [rawinput1659072 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659074 {"EndpointConfigName" (rawinput1659072 "EndpointConfigName"), "EndpointConfigArn" (rawinput1659072 "EndpointConfigArn"), "ProductionVariants" (rawinput1659072 "ProductionVariants"), "KmsKeyId" (rawinput1659072 "KmsKeyId"), "CreationTime" (rawinput1659072 "CreationTime")}] (clojure.core/cond-> {:endpoint-config-name (deser-endpoint-config-name (clojure.core/get-in letvar1659074 ["EndpointConfigName"])), :endpoint-config-arn (deser-endpoint-config-arn (clojure.core/get-in letvar1659074 ["EndpointConfigArn"])), :production-variants (deser-production-variant-list (clojure.core/get-in letvar1659074 ["ProductionVariants"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659074 ["CreationTime"]))} (letvar1659074 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar1659074 ["KmsKeyId"])))))))

(clojure.core/defn- response-create-code-repository-output ([input] (response-create-code-repository-output nil input)) ([resultWrapper1659076 input] (clojure.core/let [rawinput1659075 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659077 {"CodeRepositoryArn" (rawinput1659075 "CodeRepositoryArn")}] (clojure.core/cond-> {:code-repository-arn (deser-code-repository-arn (clojure.core/get-in letvar1659077 ["CodeRepositoryArn"]))}))))

(clojure.core/defn- response-create-algorithm-output ([input] (response-create-algorithm-output nil input)) ([resultWrapper1659079 input] (clojure.core/let [rawinput1659078 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659080 {"AlgorithmArn" (rawinput1659078 "AlgorithmArn")}] (clojure.core/cond-> {:algorithm-arn (deser-algorithm-arn (clojure.core/get-in letvar1659080 ["AlgorithmArn"]))}))))

(clojure.core/defn- response-update-notebook-instance-lifecycle-config-output ([input] (response-update-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1659082 input] (clojure.core/let [rawinput1659081 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659083 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-training-job-response ([input] (response-describe-training-job-response nil input)) ([resultWrapper1659085 input] (clojure.core/let [rawinput1659084 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659086 {"EnableNetworkIsolation" (rawinput1659084 "EnableNetworkIsolation"), "ResourceConfig" (rawinput1659084 "ResourceConfig"), "InputDataConfig" (rawinput1659084 "InputDataConfig"), "LabelingJobArn" (rawinput1659084 "LabelingJobArn"), "TrainingEndTime" (rawinput1659084 "TrainingEndTime"), "OutputDataConfig" (rawinput1659084 "OutputDataConfig"), "HyperParameters" (rawinput1659084 "HyperParameters"), "RoleArn" (rawinput1659084 "RoleArn"), "TrainingJobArn" (rawinput1659084 "TrainingJobArn"), "StoppingCondition" (rawinput1659084 "StoppingCondition"), "SecondaryStatus" (rawinput1659084 "SecondaryStatus"), "FailureReason" (rawinput1659084 "FailureReason"), "CreationTime" (rawinput1659084 "CreationTime"), "VpcConfig" (rawinput1659084 "VpcConfig"), "TrainingJobName" (rawinput1659084 "TrainingJobName"), "TuningJobArn" (rawinput1659084 "TuningJobArn"), "ModelArtifacts" (rawinput1659084 "ModelArtifacts"), "FinalMetricDataList" (rawinput1659084 "FinalMetricDataList"), "TrainingStartTime" (rawinput1659084 "TrainingStartTime"), "LastModifiedTime" (rawinput1659084 "LastModifiedTime"), "EnableInterContainerTrafficEncryption" (rawinput1659084 "EnableInterContainerTrafficEncryption"), "TrainingJobStatus" (rawinput1659084 "TrainingJobStatus"), "AlgorithmSpecification" (rawinput1659084 "AlgorithmSpecification"), "SecondaryStatusTransitions" (rawinput1659084 "SecondaryStatusTransitions")}] (clojure.core/cond-> {:stopping-condition (deser-stopping-condition (clojure.core/get-in letvar1659086 ["StoppingCondition"])), :model-artifacts (deser-model-artifacts (clojure.core/get-in letvar1659086 ["ModelArtifacts"])), :training-job-status (deser-training-job-status (clojure.core/get-in letvar1659086 ["TrainingJobStatus"])), :resource-config (deser-resource-config (clojure.core/get-in letvar1659086 ["ResourceConfig"])), :training-job-name (deser-training-job-name (clojure.core/get-in letvar1659086 ["TrainingJobName"])), :secondary-status (deser-secondary-status (clojure.core/get-in letvar1659086 ["SecondaryStatus"])), :training-job-arn (deser-training-job-arn (clojure.core/get-in letvar1659086 ["TrainingJobArn"])), :algorithm-specification (deser-algorithm-specification (clojure.core/get-in letvar1659086 ["AlgorithmSpecification"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659086 ["CreationTime"]))} (letvar1659086 "EnableNetworkIsolation") (clojure.core/assoc :enable-network-isolation (deser-boolean (clojure.core/get-in letvar1659086 ["EnableNetworkIsolation"]))) (letvar1659086 "InputDataConfig") (clojure.core/assoc :input-data-config (deser-input-data-config (clojure.core/get-in letvar1659086 ["InputDataConfig"]))) (letvar1659086 "LabelingJobArn") (clojure.core/assoc :labeling-job-arn (deser-labeling-job-arn (clojure.core/get-in letvar1659086 ["LabelingJobArn"]))) (letvar1659086 "TrainingEndTime") (clojure.core/assoc :training-end-time (deser-timestamp (clojure.core/get-in letvar1659086 ["TrainingEndTime"]))) (letvar1659086 "OutputDataConfig") (clojure.core/assoc :output-data-config (deser-output-data-config (clojure.core/get-in letvar1659086 ["OutputDataConfig"]))) (letvar1659086 "HyperParameters") (clojure.core/assoc :hyper-parameters (deser-hyper-parameters (clojure.core/get-in letvar1659086 ["HyperParameters"]))) (letvar1659086 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1659086 ["RoleArn"]))) (letvar1659086 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659086 ["FailureReason"]))) (letvar1659086 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config (clojure.core/get-in letvar1659086 ["VpcConfig"]))) (letvar1659086 "TuningJobArn") (clojure.core/assoc :tuning-job-arn (deser-hyper-parameter-tuning-job-arn (clojure.core/get-in letvar1659086 ["TuningJobArn"]))) (letvar1659086 "FinalMetricDataList") (clojure.core/assoc :final-metric-data-list (deser-final-metric-data-list (clojure.core/get-in letvar1659086 ["FinalMetricDataList"]))) (letvar1659086 "TrainingStartTime") (clojure.core/assoc :training-start-time (deser-timestamp (clojure.core/get-in letvar1659086 ["TrainingStartTime"]))) (letvar1659086 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-timestamp (clojure.core/get-in letvar1659086 ["LastModifiedTime"]))) (letvar1659086 "EnableInterContainerTrafficEncryption") (clojure.core/assoc :enable-inter-container-traffic-encryption (deser-boolean (clojure.core/get-in letvar1659086 ["EnableInterContainerTrafficEncryption"]))) (letvar1659086 "SecondaryStatusTransitions") (clojure.core/assoc :secondary-status-transitions (deser-secondary-status-transitions (clojure.core/get-in letvar1659086 ["SecondaryStatusTransitions"])))))))

(clojure.core/defn- response-create-model-package-output ([input] (response-create-model-package-output nil input)) ([resultWrapper1659088 input] (clojure.core/let [rawinput1659087 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659089 {"ModelPackageArn" (rawinput1659087 "ModelPackageArn")}] (clojure.core/cond-> {:model-package-arn (deser-model-package-arn (clojure.core/get-in letvar1659089 ["ModelPackageArn"]))}))))

(clojure.core/defn- response-describe-model-package-output ([input] (response-describe-model-package-output nil input)) ([resultWrapper1659091 input] (clojure.core/let [rawinput1659090 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659092 {"CertifyForMarketplace" (rawinput1659090 "CertifyForMarketplace"), "ModelPackageName" (rawinput1659090 "ModelPackageName"), "ModelPackageStatus" (rawinput1659090 "ModelPackageStatus"), "InferenceSpecification" (rawinput1659090 "InferenceSpecification"), "ModelPackageStatusDetails" (rawinput1659090 "ModelPackageStatusDetails"), "SourceAlgorithmSpecification" (rawinput1659090 "SourceAlgorithmSpecification"), "CreationTime" (rawinput1659090 "CreationTime"), "ModelPackageArn" (rawinput1659090 "ModelPackageArn"), "ValidationSpecification" (rawinput1659090 "ValidationSpecification"), "ModelPackageDescription" (rawinput1659090 "ModelPackageDescription")}] (clojure.core/cond-> {:model-package-name (deser-entity-name (clojure.core/get-in letvar1659092 ["ModelPackageName"])), :model-package-arn (deser-model-package-arn (clojure.core/get-in letvar1659092 ["ModelPackageArn"])), :creation-time (deser-creation-time (clojure.core/get-in letvar1659092 ["CreationTime"])), :model-package-status (deser-model-package-status (clojure.core/get-in letvar1659092 ["ModelPackageStatus"])), :model-package-status-details (deser-model-package-status-details (clojure.core/get-in letvar1659092 ["ModelPackageStatusDetails"]))} (letvar1659092 "CertifyForMarketplace") (clojure.core/assoc :certify-for-marketplace (deser-certify-for-marketplace (clojure.core/get-in letvar1659092 ["CertifyForMarketplace"]))) (letvar1659092 "InferenceSpecification") (clojure.core/assoc :inference-specification (deser-inference-specification (clojure.core/get-in letvar1659092 ["InferenceSpecification"]))) (letvar1659092 "SourceAlgorithmSpecification") (clojure.core/assoc :source-algorithm-specification (deser-source-algorithm-specification (clojure.core/get-in letvar1659092 ["SourceAlgorithmSpecification"]))) (letvar1659092 "ValidationSpecification") (clojure.core/assoc :validation-specification (deser-model-package-validation-specification (clojure.core/get-in letvar1659092 ["ValidationSpecification"]))) (letvar1659092 "ModelPackageDescription") (clojure.core/assoc :model-package-description (deser-entity-description (clojure.core/get-in letvar1659092 ["ModelPackageDescription"])))))))

(clojure.core/defn- response-update-notebook-instance-output ([input] (response-update-notebook-instance-output nil input)) ([resultWrapper1659094 input] (clojure.core/let [rawinput1659093 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659095 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-compilation-job-response ([input] (response-create-compilation-job-response nil input)) ([resultWrapper1659097 input] (clojure.core/let [rawinput1659096 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659098 {"CompilationJobArn" (rawinput1659096 "CompilationJobArn")}] (clojure.core/cond-> {:compilation-job-arn (deser-compilation-job-arn (clojure.core/get-in letvar1659098 ["CompilationJobArn"]))}))))

(clojure.core/defn- response-create-training-job-response ([input] (response-create-training-job-response nil input)) ([resultWrapper1659100 input] (clojure.core/let [rawinput1659099 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659101 {"TrainingJobArn" (rawinput1659099 "TrainingJobArn")}] (clojure.core/cond-> {:training-job-arn (deser-training-job-arn (clojure.core/get-in letvar1659101 ["TrainingJobArn"]))}))))

(clojure.core/defn- response-update-workteam-response ([input] (response-update-workteam-response nil input)) ([resultWrapper1659103 input] (clojure.core/let [rawinput1659102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659104 {"Workteam" (rawinput1659102 "Workteam")}] (clojure.core/cond-> {:workteam (deser-workteam (clojure.core/get-in letvar1659104 ["Workteam"]))}))))

(clojure.core/defn- response-resource-limit-exceeded ([input] (response-resource-limit-exceeded nil input)) ([resultWrapper1659106 input] (clojure.core/let [rawinput1659105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659107 {"Message" (rawinput1659105 "Message")}] (clojure.core/cond-> {} (letvar1659107 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1659107 ["Message"])))))))

(clojure.core/defn- response-update-endpoint-output ([input] (response-update-endpoint-output nil input)) ([resultWrapper1659109 input] (clojure.core/let [rawinput1659108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659110 {"EndpointArn" (rawinput1659108 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1659110 ["EndpointArn"]))}))))

(clojure.core/defn- response-create-endpoint-output ([input] (response-create-endpoint-output nil input)) ([resultWrapper1659112 input] (clojure.core/let [rawinput1659111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659113 {"EndpointArn" (rawinput1659111 "EndpointArn")}] (clojure.core/cond-> {:endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1659113 ["EndpointArn"]))}))))

(clojure.core/defn- response-resource-not-found ([input] (response-resource-not-found nil input)) ([resultWrapper1659115 input] (clojure.core/let [rawinput1659114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659116 {"Message" (rawinput1659114 "Message")}] (clojure.core/cond-> {} (letvar1659116 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1659116 ["Message"])))))))

(clojure.core/defn- response-list-hyper-parameter-tuning-jobs-response ([input] (response-list-hyper-parameter-tuning-jobs-response nil input)) ([resultWrapper1659118 input] (clojure.core/let [rawinput1659117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659119 {"HyperParameterTuningJobSummaries" (rawinput1659117 "HyperParameterTuningJobSummaries"), "NextToken" (rawinput1659117 "NextToken")}] (clojure.core/cond-> {:hyper-parameter-tuning-job-summaries (deser-hyper-parameter-tuning-job-summaries (clojure.core/get-in letvar1659119 ["HyperParameterTuningJobSummaries"]))} (letvar1659119 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659119 ["NextToken"])))))))

(clojure.core/defn- response-list-algorithms-output ([input] (response-list-algorithms-output nil input)) ([resultWrapper1659121 input] (clojure.core/let [rawinput1659120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659122 {"AlgorithmSummaryList" (rawinput1659120 "AlgorithmSummaryList"), "NextToken" (rawinput1659120 "NextToken")}] (clojure.core/cond-> {:algorithm-summary-list (deser-algorithm-summary-list (clojure.core/get-in letvar1659122 ["AlgorithmSummaryList"]))} (letvar1659122 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659122 ["NextToken"])))))))

(clojure.core/defn- response-list-endpoints-output ([input] (response-list-endpoints-output nil input)) ([resultWrapper1659124 input] (clojure.core/let [rawinput1659123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659125 {"Endpoints" (rawinput1659123 "Endpoints"), "NextToken" (rawinput1659123 "NextToken")}] (clojure.core/cond-> {:endpoints (deser-endpoint-summary-list (clojure.core/get-in letvar1659125 ["Endpoints"]))} (letvar1659125 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1659125 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribed-workteam-response ([input] (response-describe-subscribed-workteam-response nil input)) ([resultWrapper1659127 input] (clojure.core/let [rawinput1659126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659128 {"SubscribedWorkteam" (rawinput1659126 "SubscribedWorkteam")}] (clojure.core/cond-> {:subscribed-workteam (deser-subscribed-workteam (clojure.core/get-in letvar1659128 ["SubscribedWorkteam"]))}))))

(clojure.core/defn- response-create-notebook-instance-output ([input] (response-create-notebook-instance-output nil input)) ([resultWrapper1659130 input] (clojure.core/let [rawinput1659129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659131 {"NotebookInstanceArn" (rawinput1659129 "NotebookInstanceArn")}] (clojure.core/cond-> {} (letvar1659131 "NotebookInstanceArn") (clojure.core/assoc :notebook-instance-arn (deser-notebook-instance-arn (clojure.core/get-in letvar1659131 ["NotebookInstanceArn"])))))))

(clojure.core/defn- response-list-tags-output ([input] (response-list-tags-output nil input)) ([resultWrapper1659133 input] (clojure.core/let [rawinput1659132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659134 {"Tags" (rawinput1659132 "Tags"), "NextToken" (rawinput1659132 "NextToken")}] (clojure.core/cond-> {} (letvar1659134 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1659134 ["Tags"]))) (letvar1659134 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659134 ["NextToken"])))))))

(clojure.core/defn- response-render-ui-template-response ([input] (response-render-ui-template-response nil input)) ([resultWrapper1659136 input] (clojure.core/let [rawinput1659135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659137 {"RenderedContent" (rawinput1659135 "RenderedContent"), "Errors" (rawinput1659135 "Errors")}] (clojure.core/cond-> {:rendered-content (deser-string (clojure.core/get-in letvar1659137 ["RenderedContent"])), :errors (deser-rendering-error-list (clojure.core/get-in letvar1659137 ["Errors"]))}))))

(clojure.core/defn- response-describe-endpoint-output ([input] (response-describe-endpoint-output nil input)) ([resultWrapper1659139 input] (clojure.core/let [rawinput1659138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659140 {"EndpointName" (rawinput1659138 "EndpointName"), "EndpointArn" (rawinput1659138 "EndpointArn"), "EndpointConfigName" (rawinput1659138 "EndpointConfigName"), "ProductionVariants" (rawinput1659138 "ProductionVariants"), "EndpointStatus" (rawinput1659138 "EndpointStatus"), "FailureReason" (rawinput1659138 "FailureReason"), "CreationTime" (rawinput1659138 "CreationTime"), "LastModifiedTime" (rawinput1659138 "LastModifiedTime")}] (clojure.core/cond-> {:endpoint-name (deser-endpoint-name (clojure.core/get-in letvar1659140 ["EndpointName"])), :endpoint-arn (deser-endpoint-arn (clojure.core/get-in letvar1659140 ["EndpointArn"])), :endpoint-config-name (deser-endpoint-config-name (clojure.core/get-in letvar1659140 ["EndpointConfigName"])), :endpoint-status (deser-endpoint-status (clojure.core/get-in letvar1659140 ["EndpointStatus"])), :creation-time (deser-timestamp (clojure.core/get-in letvar1659140 ["CreationTime"])), :last-modified-time (deser-timestamp (clojure.core/get-in letvar1659140 ["LastModifiedTime"]))} (letvar1659140 "ProductionVariants") (clojure.core/assoc :production-variants (deser-production-variant-summary-list (clojure.core/get-in letvar1659140 ["ProductionVariants"]))) (letvar1659140 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1659140 ["FailureReason"])))))))

(clojure.core/defn- response-resource-in-use ([input] (response-resource-in-use nil input)) ([resultWrapper1659142 input] (clojure.core/let [rawinput1659141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659143 {"Message" (rawinput1659141 "Message")}] (clojure.core/cond-> {} (letvar1659143 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1659143 ["Message"])))))))

(clojure.core/defn- response-describe-notebook-instance-lifecycle-config-output ([input] (response-describe-notebook-instance-lifecycle-config-output nil input)) ([resultWrapper1659145 input] (clojure.core/let [rawinput1659144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659146 {"NotebookInstanceLifecycleConfigArn" (rawinput1659144 "NotebookInstanceLifecycleConfigArn"), "NotebookInstanceLifecycleConfigName" (rawinput1659144 "NotebookInstanceLifecycleConfigName"), "OnCreate" (rawinput1659144 "OnCreate"), "OnStart" (rawinput1659144 "OnStart"), "LastModifiedTime" (rawinput1659144 "LastModifiedTime"), "CreationTime" (rawinput1659144 "CreationTime")}] (clojure.core/cond-> {} (letvar1659146 "NotebookInstanceLifecycleConfigArn") (clojure.core/assoc :notebook-instance-lifecycle-config-arn (deser-notebook-instance-lifecycle-config-arn (clojure.core/get-in letvar1659146 ["NotebookInstanceLifecycleConfigArn"]))) (letvar1659146 "NotebookInstanceLifecycleConfigName") (clojure.core/assoc :notebook-instance-lifecycle-config-name (deser-notebook-instance-lifecycle-config-name (clojure.core/get-in letvar1659146 ["NotebookInstanceLifecycleConfigName"]))) (letvar1659146 "OnCreate") (clojure.core/assoc :on-create (deser-notebook-instance-lifecycle-config-list (clojure.core/get-in letvar1659146 ["OnCreate"]))) (letvar1659146 "OnStart") (clojure.core/assoc :on-start (deser-notebook-instance-lifecycle-config-list (clojure.core/get-in letvar1659146 ["OnStart"]))) (letvar1659146 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-last-modified-time (clojure.core/get-in letvar1659146 ["LastModifiedTime"]))) (letvar1659146 "CreationTime") (clojure.core/assoc :creation-time (deser-creation-time (clojure.core/get-in letvar1659146 ["CreationTime"])))))))

(clojure.core/defn- response-list-compilation-jobs-response ([input] (response-list-compilation-jobs-response nil input)) ([resultWrapper1659148 input] (clojure.core/let [rawinput1659147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659149 {"CompilationJobSummaries" (rawinput1659147 "CompilationJobSummaries"), "NextToken" (rawinput1659147 "NextToken")}] (clojure.core/cond-> {:compilation-job-summaries (deser-compilation-job-summaries (clojure.core/get-in letvar1659149 ["CompilationJobSummaries"]))} (letvar1659149 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659149 ["NextToken"])))))))

(clojure.core/defn- response-search-response ([input] (response-search-response nil input)) ([resultWrapper1659151 input] (clojure.core/let [rawinput1659150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659152 {"Results" (rawinput1659150 "Results"), "NextToken" (rawinput1659150 "NextToken")}] (clojure.core/cond-> {} (letvar1659152 "Results") (clojure.core/assoc :results (deser-search-results-list (clojure.core/get-in letvar1659152 ["Results"]))) (letvar1659152 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659152 ["NextToken"])))))))

(clojure.core/defn- response-create-endpoint-config-output ([input] (response-create-endpoint-config-output nil input)) ([resultWrapper1659154 input] (clojure.core/let [rawinput1659153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659155 {"EndpointConfigArn" (rawinput1659153 "EndpointConfigArn")}] (clojure.core/cond-> {:endpoint-config-arn (deser-endpoint-config-arn (clojure.core/get-in letvar1659155 ["EndpointConfigArn"]))}))))

(clojure.core/defn- response-list-notebook-instance-lifecycle-configs-output ([input] (response-list-notebook-instance-lifecycle-configs-output nil input)) ([resultWrapper1659157 input] (clojure.core/let [rawinput1659156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1659158 {"NextToken" (rawinput1659156 "NextToken"), "NotebookInstanceLifecycleConfigs" (rawinput1659156 "NotebookInstanceLifecycleConfigs")}] (clojure.core/cond-> {} (letvar1659158 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1659158 ["NextToken"]))) (letvar1659158 "NotebookInstanceLifecycleConfigs") (clojure.core/assoc :notebook-instance-lifecycle-configs (deser-notebook-instance-lifecycle-config-summary-list (clojure.core/get-in letvar1659158 ["NotebookInstanceLifecycleConfigs"])))))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/arn-or-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 170)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:[a-z\-]*\/)?([a-zA-Z0-9]([a-zA-Z0-9-]){0,62})(?<!-)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/metric-regex (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/model-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/job-reference-code-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/parameter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/variant-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/cognito-user-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-config-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/template-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128000))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/image-digest (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 72)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[Ss][Hh][Aa]256:[0-9a-fA-F]{64}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/branch (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/property-name-hint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/workteam-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/response-mime-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/status-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.sagemaker/model-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/entity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/container-hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/data-input-config (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/s-3-uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(https|s3)://([^/]+)/?(.*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/task-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/secret-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:secretsmanager:[a-z0-9\-]*:[0-9]{12}:secret:.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-lifecycle-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/code-repository-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/task-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128000))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/code-repository-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:code-repository/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/labeling-job-algorithm-specification-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-config-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/transform-environment-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10240))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/entity-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{Z}\p{S}\p{N}\p{P}]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-lifecycle-config-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/code-repository-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/environment-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/git-config-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^https://([^/]+)/?(.*)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/cognito-user-pool (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 55)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/compilation-job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:compilation-job/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/transform-environment-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/label-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 127)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/string-200 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z0-9\.\-_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(https|s3)://([^/]+)/?(.*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-lifecycle-config-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16384))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/resource-property-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/lambda-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/failure-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/cognito-client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w+]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/transform-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/task-keyword (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[A-Za-z0-9]+( [A-Za-z0-9]+)*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\d+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/dollars (clojure.spec.alpha/int-in 0 1))

(clojure.spec.alpha/def :portkey.aws.sagemaker/environment-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/hyper-parameter-tuning-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/training-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/labeling-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/job-reference-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/model-package-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:model-package/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/algorithm-image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/task-time-limit-in-seconds (clojure.spec.alpha/int-in 1 3600))

(clojure.spec.alpha/def :portkey.aws.sagemaker/task-title (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[\t\n\r -\uD7FF\uE000-\uFFFD]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\S]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/accept (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-name-contains (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/notebook-instance-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/code-repository-name-or-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^https://([^/]+)/?(.*)$|^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.sagemaker/max-percentage-of-input-dataset-labeled (clojure.spec.alpha/int-in 1 100))

(clojure.spec.alpha/def :portkey.aws.sagemaker/algorithm-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:algorithm/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/endpoint-config-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9](-*[a-zA-Z0-9])*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.sagemaker/model-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
