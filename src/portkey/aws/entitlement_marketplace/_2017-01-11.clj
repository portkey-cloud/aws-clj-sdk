...
(clojure.core/defn- response-get-entitlements-result ([input] (response-get-entitlements-result nil input)) ([resultWrapper1762605 input] (clojure.core/let [rawinput1762604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762606 {"Entitlements" (rawinput1762604 "Entitlements"), "NextToken" (rawinput1762604 "NextToken")}] (clojure.core/cond-> {} (letvar1762606 "Entitlements") (clojure.core/assoc :entitlements (deser-entitlement-list (clojure.core/get-in letvar1762606 ["Entitlements"]))) (letvar1762606 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1762606 ["NextToken"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1762608 input] (clojure.core/let [rawinput1762607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762609 {"message" (rawinput1762607 "message")}] (clojure.core/cond-> {} (letvar1762609 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762609 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1762611 input] (clojure.core/let [rawinput1762610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762612 {"message" (rawinput1762610 "message")}] (clojure.core/cond-> {} (letvar1762612 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762612 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1762614 input] (clojure.core/let [rawinput1762613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1762615 {"message" (rawinput1762613 "message")}] (clojure.core/cond-> {} (letvar1762615 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1762615 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\S+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
