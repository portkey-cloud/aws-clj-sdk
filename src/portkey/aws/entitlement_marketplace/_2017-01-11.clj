...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"\S+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
