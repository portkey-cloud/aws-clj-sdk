...
(clojure.core/defn- response-get-entitlements-result ([input] (response-get-entitlements-result nil input)) ([resultWrapper939969 input] (clojure.core/let [rawinput939968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939970 {"Entitlements" (rawinput939968 "Entitlements"), "NextToken" (rawinput939968 "NextToken")}] (clojure.core/cond-> {} (letvar939970 "Entitlements") (clojure.core/assoc :entitlements (deser-entitlement-list (clojure.core/get-in letvar939970 ["Entitlements"]))) (letvar939970 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar939970 ["NextToken"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper939972 input] (clojure.core/let [rawinput939971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939973 {"message" (rawinput939971 "message")}] (clojure.core/cond-> {} (letvar939973 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939973 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper939975 input] (clojure.core/let [rawinput939974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939976 {"message" (rawinput939974 "message")}] (clojure.core/cond-> {} (letvar939976 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939976 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper939978 input] (clojure.core/let [rawinput939977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar939979 {"message" (rawinput939977 "message")}] (clojure.core/cond-> {} (letvar939979 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar939979 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\S+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.core/defn get-entitlements "GetEntitlements retrieves entitlement values for a given product. The results\ncan be filtered based on customer identifier or product dimensions." ([get-entitlements-requestinput] (clojure.core/let [request-function-result__22119__auto__ (req-get-entitlements-request get-entitlements-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__22119__auto__ {:http.request.configuration/endpoints portkey.aws.entitlement-marketplace.-2017-01-11/endpoints, :http.request.configuration/target-prefix "AWSMPEntitlementService", :http.request.spec/output-spec :portkey.aws.entitlement-marketplace.-2017-01-11/get-entitlements-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-11", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.entitlement-marketplace.-2017-01-11/get-entitlements-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetEntitlements", :http.request.configuration/output-deser-fn response-get-entitlements-result, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.entitlement-marketplace.-2017-01-11/invalid-parameter-exception, "ThrottlingException" :portkey.aws.entitlement-marketplace.-2017-01-11/throttling-exception, "InternalServiceErrorException" :portkey.aws.entitlement-marketplace.-2017-01-11/internal-service-error-exception}})))))
