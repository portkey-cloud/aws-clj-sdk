...
(clojure.core/defn- response-get-entitlements-result ([input] (response-get-entitlements-result nil input)) ([resultWrapper1731727 input] (clojure.core/let [rawinput1731726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1731728 {"Entitlements" (rawinput1731726 "Entitlements"), "NextToken" (rawinput1731726 "NextToken")}] (clojure.core/cond-> {} (letvar1731728 "Entitlements") (clojure.core/assoc :entitlements (deser-entitlement-list (clojure.core/get-in letvar1731728 ["Entitlements"]))) (letvar1731728 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1731728 ["NextToken"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1731730 input] (clojure.core/let [rawinput1731729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1731731 {"message" (rawinput1731729 "message")}] (clojure.core/cond-> {} (letvar1731731 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1731731 ["message"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1731733 input] (clojure.core/let [rawinput1731732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1731734 {"message" (rawinput1731732 "message")}] (clojure.core/cond-> {} (letvar1731734 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1731734 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1731736 input] (clojure.core/let [rawinput1731735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1731737 {"message" (rawinput1731735 "message")}] (clojure.core/cond-> {} (letvar1731737 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1731737 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\S+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.entitlement-marketplace.-2017-01-11/product-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
