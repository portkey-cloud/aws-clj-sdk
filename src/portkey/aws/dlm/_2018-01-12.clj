...
(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper133065 input] (clojure.core/let [rawinput133064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133066 {"Message" (rawinput133064 "Message"), "Code" (rawinput133064 "Code"), "RequiredParameters" (rawinput133064 "RequiredParameters"), "MutuallyExclusiveParameters" (rawinput133064 "MutuallyExclusiveParameters")}] (clojure.core/cond-> {} (letvar133066 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar133066 ["Message"]))) (letvar133066 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar133066 ["Code"]))) (letvar133066 "RequiredParameters") (clojure.core/assoc :required-parameters (deser-parameter-list (clojure.core/get-in letvar133066 ["RequiredParameters"]))) (letvar133066 "MutuallyExclusiveParameters") (clojure.core/assoc :mutually-exclusive-parameters (deser-parameter-list (clojure.core/get-in letvar133066 ["MutuallyExclusiveParameters"])))))))

(clojure.core/defn- response-update-lifecycle-policy-response ([input] (response-update-lifecycle-policy-response nil input)) ([resultWrapper133068 input] (clojure.core/let [rawinput133067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133069 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lifecycle-policy-response ([input] (response-delete-lifecycle-policy-response nil input)) ([resultWrapper133071 input] (clojure.core/let [rawinput133070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133072 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper133074 input] (clojure.core/let [rawinput133073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133075 {"Message" (rawinput133073 "Message"), "Code" (rawinput133073 "Code"), "ResourceType" (rawinput133073 "ResourceType")}] (clojure.core/cond-> {} (letvar133075 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar133075 ["Message"]))) (letvar133075 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar133075 ["Code"]))) (letvar133075 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar133075 ["ResourceType"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper133077 input] (clojure.core/let [rawinput133076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133078 {"Message" (rawinput133076 "Message"), "Code" (rawinput133076 "Code"), "ResourceType" (rawinput133076 "ResourceType"), "ResourceIds" (rawinput133076 "ResourceIds")}] (clojure.core/cond-> {} (letvar133078 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar133078 ["Message"]))) (letvar133078 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar133078 ["Code"]))) (letvar133078 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar133078 ["ResourceType"]))) (letvar133078 "ResourceIds") (clojure.core/assoc :resource-ids (deser-policy-id-list (clojure.core/get-in letvar133078 ["ResourceIds"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper133080 input] (clojure.core/let [rawinput133079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133081 {"Message" (rawinput133079 "Message"), "Code" (rawinput133079 "Code")}] (clojure.core/cond-> {} (letvar133081 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar133081 ["Message"]))) (letvar133081 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar133081 ["Code"])))))))

(clojure.core/defn- response-get-lifecycle-policies-response ([input] (response-get-lifecycle-policies-response nil input)) ([resultWrapper133083 input] (clojure.core/let [rawinput133082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133084 {"Policies" (rawinput133082 "Policies")}] (clojure.core/cond-> {} (letvar133084 "Policies") (clojure.core/assoc :policies (deser-lifecycle-policy-summary-list (clojure.core/get-in letvar133084 ["Policies"])))))))

(clojure.core/defn- response-get-lifecycle-policy-response ([input] (response-get-lifecycle-policy-response nil input)) ([resultWrapper133086 input] (clojure.core/let [rawinput133085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133087 {"Policy" (rawinput133085 "Policy")}] (clojure.core/cond-> {} (letvar133087 "Policy") (clojure.core/assoc :policy (deser-lifecycle-policy (clojure.core/get-in letvar133087 ["Policy"])))))))

(clojure.core/defn- response-create-lifecycle-policy-response ([input] (response-create-lifecycle-policy-response nil input)) ([resultWrapper133089 input] (clojure.core/let [rawinput133088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133090 {"PolicyId" (rawinput133088 "PolicyId")}] (clojure.core/cond-> {} (letvar133090 "PolicyId") (clojure.core/assoc :policy-id (deser-policy-id (clojure.core/get-in letvar133090 ["PolicyId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.dlm.-2018-01-12/policy-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.dlm.-2018-01-12/time (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.dlm.-2018-01-12/schedule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
