...
(clojure.core/defn- response-disassociate-node-response ([input] (response-disassociate-node-response nil input)) ([resultWrapper1927938 input] (clojure.core/let [rawinput1927937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927939 {"NodeAssociationStatusToken" (rawinput1927937 "NodeAssociationStatusToken")}] (clojure.core/cond-> {} (letvar1927939 "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (clojure.core/get-in letvar1927939 ["NodeAssociationStatusToken"])))))))

(clojure.core/defn- response-create-backup-response ([input] (response-create-backup-response nil input)) ([resultWrapper1927941 input] (clojure.core/let [rawinput1927940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927942 {"Backup" (rawinput1927940 "Backup")}] (clojure.core/cond-> {} (letvar1927942 "Backup") (clojure.core/assoc :backup (deser-backup (clojure.core/get-in letvar1927942 ["Backup"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1927944 input] (clojure.core/let [rawinput1927943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927945 {"Message" (rawinput1927943 "Message")}] (clojure.core/cond-> {} (letvar1927945 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927945 ["Message"])))))))

(clojure.core/defn- response-start-maintenance-response ([input] (response-start-maintenance-response nil input)) ([resultWrapper1927947 input] (clojure.core/let [rawinput1927946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927948 {"Server" (rawinput1927946 "Server")}] (clojure.core/cond-> {} (letvar1927948 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1927948 ["Server"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1927950 input] (clojure.core/let [rawinput1927949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927951 {"Message" (rawinput1927949 "Message")}] (clojure.core/cond-> {} (letvar1927951 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927951 ["Message"])))))))

(clojure.core/defn- response-export-server-engine-attribute-response ([input] (response-export-server-engine-attribute-response nil input)) ([resultWrapper1927953 input] (clojure.core/let [rawinput1927952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927954 {"EngineAttribute" (rawinput1927952 "EngineAttribute"), "ServerName" (rawinput1927952 "ServerName")}] (clojure.core/cond-> {} (letvar1927954 "EngineAttribute") (clojure.core/assoc :engine-attribute (deser-engine-attribute (clojure.core/get-in letvar1927954 ["EngineAttribute"]))) (letvar1927954 "ServerName") (clojure.core/assoc :server-name (deser-server-name (clojure.core/get-in letvar1927954 ["ServerName"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1927956 input] (clojure.core/let [rawinput1927955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927957 {"Message" (rawinput1927955 "Message")}] (clojure.core/cond-> {} (letvar1927957 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927957 ["Message"])))))))

(clojure.core/defn- response-delete-backup-response ([input] (response-delete-backup-response nil input)) ([resultWrapper1927959 input] (clojure.core/let [rawinput1927958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927960 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-restore-server-response ([input] (response-restore-server-response nil input)) ([resultWrapper1927962 input] (clojure.core/let [rawinput1927961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927963 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-server-response ([input] (response-delete-server-response nil input)) ([resultWrapper1927965 input] (clojure.core/let [rawinput1927964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927966 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1927968 input] (clojure.core/let [rawinput1927967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927969 {"Message" (rawinput1927967 "Message")}] (clojure.core/cond-> {} (letvar1927969 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927969 ["Message"])))))))

(clojure.core/defn- response-describe-servers-response ([input] (response-describe-servers-response nil input)) ([resultWrapper1927971 input] (clojure.core/let [rawinput1927970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927972 {"Servers" (rawinput1927970 "Servers"), "NextToken" (rawinput1927970 "NextToken")}] (clojure.core/cond-> {} (letvar1927972 "Servers") (clojure.core/assoc :servers (deser-servers (clojure.core/get-in letvar1927972 ["Servers"]))) (letvar1927972 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1927972 ["NextToken"])))))))

(clojure.core/defn- response-update-server-response ([input] (response-update-server-response nil input)) ([resultWrapper1927974 input] (clojure.core/let [rawinput1927973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927975 {"Server" (rawinput1927973 "Server")}] (clojure.core/cond-> {} (letvar1927975 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1927975 ["Server"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1927977 input] (clojure.core/let [rawinput1927976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927978 {"Message" (rawinput1927976 "Message")}] (clojure.core/cond-> {} (letvar1927978 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927978 ["Message"])))))))

(clojure.core/defn- response-create-server-response ([input] (response-create-server-response nil input)) ([resultWrapper1927980 input] (clojure.core/let [rawinput1927979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927981 {"Server" (rawinput1927979 "Server")}] (clojure.core/cond-> {} (letvar1927981 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1927981 ["Server"])))))))

(clojure.core/defn- response-associate-node-response ([input] (response-associate-node-response nil input)) ([resultWrapper1927983 input] (clojure.core/let [rawinput1927982 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927984 {"NodeAssociationStatusToken" (rawinput1927982 "NodeAssociationStatusToken")}] (clojure.core/cond-> {} (letvar1927984 "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (clojure.core/get-in letvar1927984 ["NodeAssociationStatusToken"])))))))

(clojure.core/defn- response-update-server-engine-attributes-response ([input] (response-update-server-engine-attributes-response nil input)) ([resultWrapper1927986 input] (clojure.core/let [rawinput1927985 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927987 {"Server" (rawinput1927985 "Server")}] (clojure.core/cond-> {} (letvar1927987 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1927987 ["Server"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper1927989 input] (clojure.core/let [rawinput1927988 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927990 {"Message" (rawinput1927988 "Message")}] (clojure.core/cond-> {} (letvar1927990 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1927990 ["Message"])))))))

(clojure.core/defn- response-describe-account-attributes-response ([input] (response-describe-account-attributes-response nil input)) ([resultWrapper1927992 input] (clojure.core/let [rawinput1927991 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927993 {"Attributes" (rawinput1927991 "Attributes")}] (clojure.core/cond-> {} (letvar1927993 "Attributes") (clojure.core/assoc :attributes (deser-account-attributes (clojure.core/get-in letvar1927993 ["Attributes"])))))))

(clojure.core/defn- response-describe-backups-response ([input] (response-describe-backups-response nil input)) ([resultWrapper1927995 input] (clojure.core/let [rawinput1927994 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927996 {"Backups" (rawinput1927994 "Backups"), "NextToken" (rawinput1927994 "NextToken")}] (clojure.core/cond-> {} (letvar1927996 "Backups") (clojure.core/assoc :backups (deser-backups (clojure.core/get-in letvar1927996 ["Backups"]))) (letvar1927996 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1927996 ["NextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1927998 input] (clojure.core/let [rawinput1927997 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1927999 {"ServerEvents" (rawinput1927997 "ServerEvents"), "NextToken" (rawinput1927997 "NextToken")}] (clojure.core/cond-> {} (letvar1927999 "ServerEvents") (clojure.core/assoc :server-events (deser-server-events (clojure.core/get-in letvar1927999 ["ServerEvents"]))) (letvar1927999 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1927999 ["NextToken"])))))))

(clojure.core/defn- response-describe-node-association-status-response ([input] (response-describe-node-association-status-response nil input)) ([resultWrapper1928001 input] (clojure.core/let [rawinput1928000 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1928002 {"NodeAssociationStatus" (rawinput1928000 "NodeAssociationStatus"), "EngineAttributes" (rawinput1928000 "EngineAttributes")}] (clojure.core/cond-> {} (letvar1928002 "NodeAssociationStatus") (clojure.core/assoc :node-association-status (deser-node-association-status (clojure.core/get-in letvar1928002 ["NodeAssociationStatus"]))) (letvar1928002 "EngineAttributes") (clojure.core/assoc :engine-attributes (deser-engine-attributes (clojure.core/get-in letvar1928002 ["EngineAttributes"])))))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/service-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:role/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Z][A-Z0-9_]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 79))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/instance-profile-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:instance-profile/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/node-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\-\p{Alnum}_:.]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/time-window-definition (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$" s__1410940__auto__))))
