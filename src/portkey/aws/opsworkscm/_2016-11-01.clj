...
(clojure.core/defn- deser-disassociate-node-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (input "NodeAssociationStatusToken")))))

(clojure.core/defn- deser-create-backup-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Backup") (clojure.core/assoc :backup (deser-backup (input "Backup")))))
...
(clojure.core/defn- deser-start-maintenance-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Server") (clojure.core/assoc :server (deser-server (input "Server")))))
...
(clojure.core/defn- deser-export-server-engine-attribute-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "EngineAttribute") (clojure.core/assoc :engine-attribute (deser-engine-attribute (input "EngineAttribute"))) (clojure.core/contains? input "ServerName") (clojure.core/assoc :server-name (deser-server-name (input "ServerName")))))

(clojure.core/defn- deser-resource-already-exists-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-string (input "Message")))))

(clojure.core/defn- deser-delete-backup-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-restore-server-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-server-response [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-describe-servers-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Servers") (clojure.core/assoc :servers (deser-servers (input "Servers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-update-server-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Server") (clojure.core/assoc :server (deser-server (input "Server")))))
...
(clojure.core/defn- deser-create-server-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Server") (clojure.core/assoc :server (deser-server (input "Server")))))

(clojure.core/defn- deser-associate-node-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (input "NodeAssociationStatusToken")))))

(clojure.core/defn- deser-update-server-engine-attributes-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Server") (clojure.core/assoc :server (deser-server (input "Server")))))
...
(clojure.core/defn- deser-describe-account-attributes-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Attributes") (clojure.core/assoc :attributes (deser-account-attributes (input "Attributes")))))

(clojure.core/defn- deser-describe-backups-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Backups") (clojure.core/assoc :backups (deser-backups (input "Backups"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-describe-events-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "ServerEvents") (clojure.core/assoc :server-events (deser-server-events (input "ServerEvents"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-describe-node-association-status-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "NodeAssociationStatus") (clojure.core/assoc :node-association-status (deser-node-association-status (input "NodeAssociationStatus"))) (clojure.core/contains? input "EngineAttributes") (clojure.core/assoc :engine-attributes (deser-engine-attributes (input "EngineAttributes")))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/service-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:role/.*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[A-Z][A-Z0-9_]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 79))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/instance-profile-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:instance-profile/.*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/node-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[\-\p{Alnum}_:.]+$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/time-window-definition (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm.-2016-11-01/server-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 40)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9\-]*" s__27881__auto__))))
