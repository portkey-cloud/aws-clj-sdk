...
(clojure.core/defn- response-missing-codec-private-data-exception ([input] (response-missing-codec-private-data-exception nil input)) ([resultWrapper264216 input] (clojure.core/let [rawinput264215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264217 {"Message" (rawinput264215 "Message")}] (clojure.core/cond-> {} (letvar264217 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264217 ["Message"])))))))

(clojure.core/defn- response-unsupported-stream-media-type-exception ([input] (response-unsupported-stream-media-type-exception nil input)) ([resultWrapper264219 input] (clojure.core/let [rawinput264218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264220 {"Message" (rawinput264218 "Message")}] (clojure.core/cond-> {} (letvar264220 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264220 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper264222 input] (clojure.core/let [rawinput264221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264223 {"Message" (rawinput264221 "Message")}] (clojure.core/cond-> {} (letvar264223 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264223 ["Message"])))))))

(clojure.core/defn- response-no-data-retention-exception ([input] (response-no-data-retention-exception nil input)) ([resultWrapper264225 input] (clojure.core/let [rawinput264224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264226 {"Message" (rawinput264224 "Message")}] (clojure.core/cond-> {} (letvar264226 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264226 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper264228 input] (clojure.core/let [rawinput264227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264229 {"Message" (rawinput264227 "Message")}] (clojure.core/cond-> {} (letvar264229 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264229 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper264231 input] (clojure.core/let [rawinput264230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264232 {"Message" (rawinput264230 "Message")}] (clojure.core/cond-> {} (letvar264232 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264232 ["Message"])))))))

(clojure.core/defn- response-invalid-codec-private-data-exception ([input] (response-invalid-codec-private-data-exception nil input)) ([resultWrapper264234 input] (clojure.core/let [rawinput264233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264235 {"Message" (rawinput264233 "Message")}] (clojure.core/cond-> {} (letvar264235 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264235 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper264237 input] (clojure.core/let [rawinput264236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264238 {"Message" (rawinput264236 "Message")}] (clojure.core/cond-> {} (letvar264238 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar264238 ["Message"])))))))

(clojure.core/defn- response-list-fragments-output ([input] (response-list-fragments-output nil input)) ([resultWrapper264240 input] (clojure.core/let [rawinput264239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264241 {"Fragments" (rawinput264239 "Fragments"), "NextToken" (rawinput264239 "NextToken")}] (clojure.core/cond-> {} (letvar264241 "Fragments") (clojure.core/assoc :fragments (deser-fragment-list (clojure.core/get-in letvar264241 ["Fragments"]))) (letvar264241 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar264241 ["NextToken"])))))))

(clojure.core/defn- response-get-media-for-fragment-list-output ([input] (response-get-media-for-fragment-list-output nil input)) ([resultWrapper264243 input] (clojure.core/let [rawinput264242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264244 {"Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Payload" (rawinput264242 "Payload")}] (clojure.core/cond-> {} (letvar264244 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar264244 ["Content-Type"]))) (letvar264244 "Payload") (clojure.core/assoc :payload (deser-payload (clojure.core/get-in letvar264244 ["Payload"])))))))

(clojure.core/defn- response-get-hls-streaming-session-url-output ([input] (response-get-hls-streaming-session-url-output nil input)) ([resultWrapper264246 input] (clojure.core/let [rawinput264245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar264247 {"HLSStreamingSessionURL" (rawinput264245 "HLSStreamingSessionURL")}] (clojure.core/cond-> {} (letvar264247 "HLSStreamingSessionURL") (clojure.core/assoc :hls-streaming-session-url (deser-hls-streaming-session-url (clojure.core/get-in letvar264247 ["HLSStreamingSessionURL"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/fragment-number-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9]+$" s__21112__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__21112__auto__))))
