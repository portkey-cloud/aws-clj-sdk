...
(clojure.core/defn- response-missing-codec-private-data-exception ([input] (response-missing-codec-private-data-exception nil input)) ([resultWrapper1172190 input] (clojure.core/let [rawinput1172189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172191 {"Message" (rawinput1172189 "Message")}] (clojure.core/cond-> {} (letvar1172191 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172191 ["Message"])))))))

(clojure.core/defn- response-unsupported-stream-media-type-exception ([input] (response-unsupported-stream-media-type-exception nil input)) ([resultWrapper1172193 input] (clojure.core/let [rawinput1172192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172194 {"Message" (rawinput1172192 "Message")}] (clojure.core/cond-> {} (letvar1172194 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172194 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1172196 input] (clojure.core/let [rawinput1172195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172197 {"Message" (rawinput1172195 "Message")}] (clojure.core/cond-> {} (letvar1172197 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172197 ["Message"])))))))

(clojure.core/defn- response-no-data-retention-exception ([input] (response-no-data-retention-exception nil input)) ([resultWrapper1172199 input] (clojure.core/let [rawinput1172198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172200 {"Message" (rawinput1172198 "Message")}] (clojure.core/cond-> {} (letvar1172200 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172200 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1172202 input] (clojure.core/let [rawinput1172201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172203 {"Message" (rawinput1172201 "Message")}] (clojure.core/cond-> {} (letvar1172203 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172203 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper1172205 input] (clojure.core/let [rawinput1172204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172206 {"Message" (rawinput1172204 "Message")}] (clojure.core/cond-> {} (letvar1172206 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172206 ["Message"])))))))

(clojure.core/defn- response-invalid-codec-private-data-exception ([input] (response-invalid-codec-private-data-exception nil input)) ([resultWrapper1172208 input] (clojure.core/let [rawinput1172207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172209 {"Message" (rawinput1172207 "Message")}] (clojure.core/cond-> {} (letvar1172209 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172209 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1172211 input] (clojure.core/let [rawinput1172210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172212 {"Message" (rawinput1172210 "Message")}] (clojure.core/cond-> {} (letvar1172212 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1172212 ["Message"])))))))

(clojure.core/defn- response-list-fragments-output ([input] (response-list-fragments-output nil input)) ([resultWrapper1172214 input] (clojure.core/let [rawinput1172213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172215 {"Fragments" (rawinput1172213 "Fragments"), "NextToken" (rawinput1172213 "NextToken")}] (clojure.core/cond-> {} (letvar1172215 "Fragments") (clojure.core/assoc :fragments (deser-fragment-list (clojure.core/get-in letvar1172215 ["Fragments"]))) (letvar1172215 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1172215 ["NextToken"])))))))

(clojure.core/defn- response-get-media-for-fragment-list-output ([input] (response-get-media-for-fragment-list-output nil input)) ([resultWrapper1172217 input] (clojure.core/let [rawinput1172216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172218 {"Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Payload" (rawinput1172216 "Payload")}] (clojure.core/cond-> {} (letvar1172218 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1172218 ["Content-Type"]))) (letvar1172218 "Payload") (clojure.core/assoc :payload (deser-payload (clojure.core/get-in letvar1172218 ["Payload"])))))))

(clojure.core/defn- response-get-hls-streaming-session-url-output ([input] (response-get-hls-streaming-session-url-output nil input)) ([resultWrapper1172220 input] (clojure.core/let [rawinput1172219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1172221 {"HLSStreamingSessionURL" (rawinput1172219 "HLSStreamingSessionURL")}] (clojure.core/cond-> {} (letvar1172221 "HLSStreamingSessionURL") (clojure.core/assoc :hls-streaming-session-url (deser-hls-streaming-session-url (clojure.core/get-in letvar1172221 ["HLSStreamingSessionURL"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/fragment-number-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__21078__auto__))))
