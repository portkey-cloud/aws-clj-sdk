...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/get-hls-streaming-session-url-input (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesis-video-archived-media.-2017-09-30/stream-name :portkey.aws.kinesis-video-archived-media.-2017-09-30.get-hls-streaming-session-url-input/stream-arn :portkey.aws.kinesis-video-archived-media.-2017-09-30/playback-mode :portkey.aws.kinesis-video-archived-media.-2017-09-30/hls-fragment-selector :portkey.aws.kinesis-video-archived-media.-2017-09-30/discontinuity-mode :portkey.aws.kinesis-video-archived-media.-2017-09-30/expires :portkey.aws.kinesis-video-archived-media.-2017-09-30.get-hls-streaming-session-url-input/max-media-playlist-fragment-results]))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/fragment-number-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 128)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[0-9]+$" s__27882__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 256)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 128)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media.-2017-09-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 1024)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__27882__auto__))))
