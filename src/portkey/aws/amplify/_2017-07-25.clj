...
(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper57360 input] (clojure.core/let [rawinput57359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57361 {"message" (rawinput57359 "message")}] (clojure.core/cond-> {} (letvar57361 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57361 ["message"])))))))

(clojure.core/defn- response-stop-job-result ([input] (response-stop-job-result nil input)) ([resultWrapper57363 input] (clojure.core/let [rawinput57362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57364 {"jobSummary" (rawinput57362 "jobSummary")}] (clojure.core/cond-> {:job-summary (deser-job-summary (clojure.core/get-in letvar57364 ["jobSummary"]))}))))

(clojure.core/defn- response-get-job-result ([input] (response-get-job-result nil input)) ([resultWrapper57366 input] (clojure.core/let [rawinput57365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57367 {"job" (rawinput57365 "job")}] (clojure.core/cond-> {:job (deser-job (clojure.core/get-in letvar57367 ["job"]))}))))

(clojure.core/defn- response-create-domain-association-result ([input] (response-create-domain-association-result nil input)) ([resultWrapper57369 input] (clojure.core/let [rawinput57368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57370 {"domainAssociation" (rawinput57368 "domainAssociation")}] (clojure.core/cond-> {:domain-association (deser-domain-association (clojure.core/get-in letvar57370 ["domainAssociation"]))}))))

(clojure.core/defn- response-update-app-result ([input] (response-update-app-result nil input)) ([resultWrapper57372 input] (clojure.core/let [rawinput57371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57373 {"app" (rawinput57371 "app")}] (clojure.core/cond-> {:app (deser-app (clojure.core/get-in letvar57373 ["app"]))}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper57375 input] (clojure.core/let [rawinput57374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57376 {"message" (rawinput57374 "message")}] (clojure.core/cond-> {} (letvar57376 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57376 ["message"])))))))

(clojure.core/defn- response-create-branch-result ([input] (response-create-branch-result nil input)) ([resultWrapper57378 input] (clojure.core/let [rawinput57377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57379 {"branch" (rawinput57377 "branch")}] (clojure.core/cond-> {:branch (deser-branch (clojure.core/get-in letvar57379 ["branch"]))}))))

(clojure.core/defn- response-get-branch-result ([input] (response-get-branch-result nil input)) ([resultWrapper57381 input] (clojure.core/let [rawinput57380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57382 {"branch" (rawinput57380 "branch")}] (clojure.core/cond-> {:branch (deser-branch (clojure.core/get-in letvar57382 ["branch"]))}))))

(clojure.core/defn- response-delete-job-result ([input] (response-delete-job-result nil input)) ([resultWrapper57384 input] (clojure.core/let [rawinput57383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57385 {"jobSummary" (rawinput57383 "jobSummary")}] (clojure.core/cond-> {:job-summary (deser-job-summary (clojure.core/get-in letvar57385 ["jobSummary"]))}))))

(clojure.core/defn- response-get-app-result ([input] (response-get-app-result nil input)) ([resultWrapper57387 input] (clojure.core/let [rawinput57386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57388 {"app" (rawinput57386 "app")}] (clojure.core/cond-> {:app (deser-app (clojure.core/get-in letvar57388 ["app"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper57390 input] (clojure.core/let [rawinput57389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57391 {"message" (rawinput57389 "message")}] (clojure.core/cond-> {} (letvar57391 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57391 ["message"])))))))

(clojure.core/defn- response-start-job-result ([input] (response-start-job-result nil input)) ([resultWrapper57393 input] (clojure.core/let [rawinput57392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57394 {"jobSummary" (rawinput57392 "jobSummary")}] (clojure.core/cond-> {:job-summary (deser-job-summary (clojure.core/get-in letvar57394 ["jobSummary"]))}))))

(clojure.core/defn- response-update-branch-result ([input] (response-update-branch-result nil input)) ([resultWrapper57396 input] (clojure.core/let [rawinput57395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57397 {"branch" (rawinput57395 "branch")}] (clojure.core/cond-> {:branch (deser-branch (clojure.core/get-in letvar57397 ["branch"]))}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper57399 input] (clojure.core/let [rawinput57398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57400 {"message" (rawinput57398 "message")}] (clojure.core/cond-> {} (letvar57400 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57400 ["message"])))))))

(clojure.core/defn- response-list-branches-result ([input] (response-list-branches-result nil input)) ([resultWrapper57402 input] (clojure.core/let [rawinput57401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57403 {"branches" (rawinput57401 "branches"), "nextToken" (rawinput57401 "nextToken")}] (clojure.core/cond-> {:branches (deser-branches (clojure.core/get-in letvar57403 ["branches"]))} (letvar57403 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar57403 ["nextToken"])))))))

(clojure.core/defn- response-list-domain-associations-result ([input] (response-list-domain-associations-result nil input)) ([resultWrapper57405 input] (clojure.core/let [rawinput57404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57406 {"domainAssociations" (rawinput57404 "domainAssociations"), "nextToken" (rawinput57404 "nextToken")}] (clojure.core/cond-> {:domain-associations (deser-domain-associations (clojure.core/get-in letvar57406 ["domainAssociations"]))} (letvar57406 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar57406 ["nextToken"])))))))

(clojure.core/defn- response-create-app-result ([input] (response-create-app-result nil input)) ([resultWrapper57408 input] (clojure.core/let [rawinput57407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57409 {"app" (rawinput57407 "app")}] (clojure.core/cond-> {:app (deser-app (clojure.core/get-in letvar57409 ["app"]))}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper57411 input] (clojure.core/let [rawinput57410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57412 {"message" (rawinput57410 "message")}] (clojure.core/cond-> {} (letvar57412 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57412 ["message"])))))))

(clojure.core/defn- response-get-domain-association-result ([input] (response-get-domain-association-result nil input)) ([resultWrapper57414 input] (clojure.core/let [rawinput57413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57415 {"domainAssociation" (rawinput57413 "domainAssociation")}] (clojure.core/cond-> {:domain-association (deser-domain-association (clojure.core/get-in letvar57415 ["domainAssociation"]))}))))

(clojure.core/defn- response-delete-app-result ([input] (response-delete-app-result nil input)) ([resultWrapper57417 input] (clojure.core/let [rawinput57416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57418 {"app" (rawinput57416 "app")}] (clojure.core/cond-> {:app (deser-app (clojure.core/get-in letvar57418 ["app"]))}))))

(clojure.core/defn- response-delete-domain-association-result ([input] (response-delete-domain-association-result nil input)) ([resultWrapper57420 input] (clojure.core/let [rawinput57419 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57421 {"domainAssociation" (rawinput57419 "domainAssociation")}] (clojure.core/cond-> {:domain-association (deser-domain-association (clojure.core/get-in letvar57421 ["domainAssociation"]))}))))

(clojure.core/defn- response-list-jobs-result ([input] (response-list-jobs-result nil input)) ([resultWrapper57423 input] (clojure.core/let [rawinput57422 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57424 {"jobSummaries" (rawinput57422 "jobSummaries"), "nextToken" (rawinput57422 "nextToken")}] (clojure.core/cond-> {:job-summaries (deser-job-summaries (clojure.core/get-in letvar57424 ["jobSummaries"]))} (letvar57424 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar57424 ["nextToken"])))))))

(clojure.core/defn- response-dependent-service-failure-exception ([input] (response-dependent-service-failure-exception nil input)) ([resultWrapper57426 input] (clojure.core/let [rawinput57425 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57427 {"message" (rawinput57425 "message")}] (clojure.core/cond-> {} (letvar57427 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar57427 ["message"])))))))

(clojure.core/defn- response-list-apps-result ([input] (response-list-apps-result nil input)) ([resultWrapper57429 input] (clojure.core/let [rawinput57428 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57430 {"apps" (rawinput57428 "apps"), "nextToken" (rawinput57428 "nextToken")}] (clojure.core/cond-> {:apps (deser-apps (clojure.core/get-in letvar57430 ["apps"]))} (letvar57430 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar57430 ["nextToken"])))))))

(clojure.core/defn- response-update-domain-association-result ([input] (response-update-domain-association-result nil input)) ([resultWrapper57432 input] (clojure.core/let [rawinput57431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57433 {"domainAssociation" (rawinput57431 "domainAssociation")}] (clojure.core/cond-> {:domain-association (deser-domain-association (clojure.core/get-in letvar57433 ["domainAssociation"]))}))))

(clojure.core/defn- response-delete-branch-result ([input] (response-delete-branch-result nil input)) ([resultWrapper57435 input] (clojure.core/let [rawinput57434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar57436 {"branch" (rawinput57434 "branch")}] (clojure.core/cond-> {:branch (deser-branch (clojure.core/get-in letvar57436 ["branch"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/oauth-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/thumbnail-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/service-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/basic-auth-credentials (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/domain-association-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/source (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/app-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/branch-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/certificate-verification-dns-record (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/log-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/total-number-of-jobs (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/repository (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/env-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/env-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/artifacts-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/commit-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/status-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/build-spec (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 25000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/framework (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/step-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/app-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/custom-domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/active-job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/branch-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/last-deploy-time clojure.core/inst?)

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/domain-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/dns-record (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/condition (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/target (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/job-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/thumbnail-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))

(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/commit-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/default-domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.amplify.-2017-07-25/job-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000))))
