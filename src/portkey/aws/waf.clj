...
(clojure.core/defn- response-get-web-acl-response ([input] (response-get-web-acl-response nil input)) ([resultWrapper2145772 input] (clojure.core/let [rawinput2145771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145773 {"WebACL" (rawinput2145771 "WebACL")}] (clojure.core/cond-> {} (letvar2145773 "WebACL") (clojure.core/assoc :web-acl (deser-web-acl (clojure.core/get-in letvar2145773 ["WebACL"])))))))

(clojure.core/defn- response-list-regex-pattern-sets-response ([input] (response-list-regex-pattern-sets-response nil input)) ([resultWrapper2145775 input] (clojure.core/let [rawinput2145774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145776 {"NextMarker" (rawinput2145774 "NextMarker"), "RegexPatternSets" (rawinput2145774 "RegexPatternSets")}] (clojure.core/cond-> {} (letvar2145776 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145776 ["NextMarker"]))) (letvar2145776 "RegexPatternSets") (clojure.core/assoc :regex-pattern-sets (deser-regex-pattern-set-summaries (clojure.core/get-in letvar2145776 ["RegexPatternSets"])))))))

(clojure.core/defn- response-waf-invalid-parameter-exception ([input] (response-waf-invalid-parameter-exception nil input)) ([resultWrapper2145778 input] (clojure.core/let [rawinput2145777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145779 {"field" (rawinput2145777 "field"), "parameter" (rawinput2145777 "parameter"), "reason" (rawinput2145777 "reason")}] (clojure.core/cond-> {} (letvar2145779 "field") (clojure.core/assoc :field (deser-parameter-exception-field (clojure.core/get-in letvar2145779 ["field"]))) (letvar2145779 "parameter") (clojure.core/assoc :parameter (deser-parameter-exception-parameter (clojure.core/get-in letvar2145779 ["parameter"]))) (letvar2145779 "reason") (clojure.core/assoc :reason (deser-parameter-exception-reason (clojure.core/get-in letvar2145779 ["reason"])))))))

(clojure.core/defn- response-update-regex-match-set-response ([input] (response-update-regex-match-set-response nil input)) ([resultWrapper2145781 input] (clojure.core/let [rawinput2145780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145782 {"ChangeToken" (rawinput2145780 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145782 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145782 ["ChangeToken"])))))))

(clojure.core/defn- response-update-xss-match-set-response ([input] (response-update-xss-match-set-response nil input)) ([resultWrapper2145784 input] (clojure.core/let [rawinput2145783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145785 {"ChangeToken" (rawinput2145783 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145785 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145785 ["ChangeToken"])))))))

(clojure.core/defn- response-create-regex-match-set-response ([input] (response-create-regex-match-set-response nil input)) ([resultWrapper2145787 input] (clojure.core/let [rawinput2145786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145788 {"RegexMatchSet" (rawinput2145786 "RegexMatchSet"), "ChangeToken" (rawinput2145786 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145788 "RegexMatchSet") (clojure.core/assoc :regex-match-set (deser-regex-match-set (clojure.core/get-in letvar2145788 ["RegexMatchSet"]))) (letvar2145788 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145788 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-invalid-account-exception ([input] (response-waf-invalid-account-exception nil input)) ([resultWrapper2145790 input] (clojure.core/let [rawinput2145789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145791 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-rules-response ([input] (response-list-rules-response nil input)) ([resultWrapper2145793 input] (clojure.core/let [rawinput2145792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145794 {"NextMarker" (rawinput2145792 "NextMarker"), "Rules" (rawinput2145792 "Rules")}] (clojure.core/cond-> {} (letvar2145794 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145794 ["NextMarker"]))) (letvar2145794 "Rules") (clojure.core/assoc :rules (deser-rule-summaries (clojure.core/get-in letvar2145794 ["Rules"])))))))

(clojure.core/defn- response-waf-internal-error-exception ([input] (response-waf-internal-error-exception nil input)) ([resultWrapper2145796 input] (clojure.core/let [rawinput2145795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145797 {"message" (rawinput2145795 "message")}] (clojure.core/cond-> {} (letvar2145797 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145797 ["message"])))))))

(clojure.core/defn- response-waf-invalid-operation-exception ([input] (response-waf-invalid-operation-exception nil input)) ([resultWrapper2145799 input] (clojure.core/let [rawinput2145798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145800 {"message" (rawinput2145798 "message")}] (clojure.core/cond-> {} (letvar2145800 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145800 ["message"])))))))

(clojure.core/defn- response-delete-sql-injection-match-set-response ([input] (response-delete-sql-injection-match-set-response nil input)) ([resultWrapper2145802 input] (clojure.core/let [rawinput2145801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145803 {"ChangeToken" (rawinput2145801 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145803 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145803 ["ChangeToken"])))))))

(clojure.core/defn- response-get-xss-match-set-response ([input] (response-get-xss-match-set-response nil input)) ([resultWrapper2145805 input] (clojure.core/let [rawinput2145804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145806 {"XssMatchSet" (rawinput2145804 "XssMatchSet")}] (clojure.core/cond-> {} (letvar2145806 "XssMatchSet") (clojure.core/assoc :xss-match-set (deser-xss-match-set (clojure.core/get-in letvar2145806 ["XssMatchSet"])))))))

(clojure.core/defn- response-update-sql-injection-match-set-response ([input] (response-update-sql-injection-match-set-response nil input)) ([resultWrapper2145808 input] (clojure.core/let [rawinput2145807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145809 {"ChangeToken" (rawinput2145807 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145809 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145809 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-rule-group-response ([input] (response-delete-rule-group-response nil input)) ([resultWrapper2145811 input] (clojure.core/let [rawinput2145810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145812 {"ChangeToken" (rawinput2145810 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145812 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145812 ["ChangeToken"])))))))

(clojure.core/defn- response-list-xss-match-sets-response ([input] (response-list-xss-match-sets-response nil input)) ([resultWrapper2145814 input] (clojure.core/let [rawinput2145813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145815 {"NextMarker" (rawinput2145813 "NextMarker"), "XssMatchSets" (rawinput2145813 "XssMatchSets")}] (clojure.core/cond-> {} (letvar2145815 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145815 ["NextMarker"]))) (letvar2145815 "XssMatchSets") (clojure.core/assoc :xss-match-sets (deser-xss-match-set-summaries (clojure.core/get-in letvar2145815 ["XssMatchSets"])))))))

(clojure.core/defn- response-waf-service-linked-role-error-exception ([input] (response-waf-service-linked-role-error-exception nil input)) ([resultWrapper2145817 input] (clojure.core/let [rawinput2145816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145818 {"message" (rawinput2145816 "message")}] (clojure.core/cond-> {} (letvar2145818 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145818 ["message"])))))))

(clojure.core/defn- response-delete-permission-policy-response ([input] (response-delete-permission-policy-response nil input)) ([resultWrapper2145820 input] (clojure.core/let [rawinput2145819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145821 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-sql-injection-match-set-response ([input] (response-create-sql-injection-match-set-response nil input)) ([resultWrapper2145823 input] (clojure.core/let [rawinput2145822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145824 {"SqlInjectionMatchSet" (rawinput2145822 "SqlInjectionMatchSet"), "ChangeToken" (rawinput2145822 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145824 "SqlInjectionMatchSet") (clojure.core/assoc :sql-injection-match-set (deser-sql-injection-match-set (clojure.core/get-in letvar2145824 ["SqlInjectionMatchSet"]))) (letvar2145824 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145824 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-regex-match-set-response ([input] (response-delete-regex-match-set-response nil input)) ([resultWrapper2145826 input] (clojure.core/let [rawinput2145825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145827 {"ChangeToken" (rawinput2145825 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145827 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145827 ["ChangeToken"])))))))

(clojure.core/defn- response-put-permission-policy-response ([input] (response-put-permission-policy-response nil input)) ([resultWrapper2145829 input] (clojure.core/let [rawinput2145828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145830 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-waf-invalid-regex-pattern-exception ([input] (response-waf-invalid-regex-pattern-exception nil input)) ([resultWrapper2145832 input] (clojure.core/let [rawinput2145831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145833 {"message" (rawinput2145831 "message")}] (clojure.core/cond-> {} (letvar2145833 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145833 ["message"])))))))

(clojure.core/defn- response-update-regex-pattern-set-response ([input] (response-update-regex-pattern-set-response nil input)) ([resultWrapper2145835 input] (clojure.core/let [rawinput2145834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145836 {"ChangeToken" (rawinput2145834 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145836 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145836 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-logging-configuration-response ([input] (response-delete-logging-configuration-response nil input)) ([resultWrapper2145838 input] (clojure.core/let [rawinput2145837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145839 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-waf-nonexistent-item-exception ([input] (response-waf-nonexistent-item-exception nil input)) ([resultWrapper2145841 input] (clojure.core/let [rawinput2145840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145842 {"message" (rawinput2145840 "message")}] (clojure.core/cond-> {} (letvar2145842 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145842 ["message"])))))))

(clojure.core/defn- response-get-rule-response ([input] (response-get-rule-response nil input)) ([resultWrapper2145844 input] (clojure.core/let [rawinput2145843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145845 {"Rule" (rawinput2145843 "Rule")}] (clojure.core/cond-> {} (letvar2145845 "Rule") (clojure.core/assoc :rule (deser-rule (clojure.core/get-in letvar2145845 ["Rule"])))))))

(clojure.core/defn- response-list-geo-match-sets-response ([input] (response-list-geo-match-sets-response nil input)) ([resultWrapper2145847 input] (clojure.core/let [rawinput2145846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145848 {"NextMarker" (rawinput2145846 "NextMarker"), "GeoMatchSets" (rawinput2145846 "GeoMatchSets")}] (clojure.core/cond-> {} (letvar2145848 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145848 ["NextMarker"]))) (letvar2145848 "GeoMatchSets") (clojure.core/assoc :geo-match-sets (deser-geo-match-set-summaries (clojure.core/get-in letvar2145848 ["GeoMatchSets"])))))))

(clojure.core/defn- response-get-byte-match-set-response ([input] (response-get-byte-match-set-response nil input)) ([resultWrapper2145850 input] (clojure.core/let [rawinput2145849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145851 {"ByteMatchSet" (rawinput2145849 "ByteMatchSet")}] (clojure.core/cond-> {} (letvar2145851 "ByteMatchSet") (clojure.core/assoc :byte-match-set (deser-byte-match-set (clojure.core/get-in letvar2145851 ["ByteMatchSet"])))))))

(clojure.core/defn- response-waf-nonexistent-container-exception ([input] (response-waf-nonexistent-container-exception nil input)) ([resultWrapper2145853 input] (clojure.core/let [rawinput2145852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145854 {"message" (rawinput2145852 "message")}] (clojure.core/cond-> {} (letvar2145854 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145854 ["message"])))))))

(clojure.core/defn- response-waf-stale-data-exception ([input] (response-waf-stale-data-exception nil input)) ([resultWrapper2145856 input] (clojure.core/let [rawinput2145855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145857 {"message" (rawinput2145855 "message")}] (clojure.core/cond-> {} (letvar2145857 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145857 ["message"])))))))

(clojure.core/defn- response-waf-referenced-item-exception ([input] (response-waf-referenced-item-exception nil input)) ([resultWrapper2145859 input] (clojure.core/let [rawinput2145858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145860 {"message" (rawinput2145858 "message")}] (clojure.core/cond-> {} (letvar2145860 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145860 ["message"])))))))

(clojure.core/defn- response-update-rule-response ([input] (response-update-rule-response nil input)) ([resultWrapper2145862 input] (clojure.core/let [rawinput2145861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145863 {"ChangeToken" (rawinput2145861 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145863 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145863 ["ChangeToken"])))))))

(clojure.core/defn- response-create-size-constraint-set-response ([input] (response-create-size-constraint-set-response nil input)) ([resultWrapper2145865 input] (clojure.core/let [rawinput2145864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145866 {"SizeConstraintSet" (rawinput2145864 "SizeConstraintSet"), "ChangeToken" (rawinput2145864 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145866 "SizeConstraintSet") (clojure.core/assoc :size-constraint-set (deser-size-constraint-set (clojure.core/get-in letvar2145866 ["SizeConstraintSet"]))) (letvar2145866 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145866 ["ChangeToken"])))))))

(clojure.core/defn- response-update-ip-set-response ([input] (response-update-ip-set-response nil input)) ([resultWrapper2145868 input] (clojure.core/let [rawinput2145867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145869 {"ChangeToken" (rawinput2145867 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145869 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145869 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-rule-response ([input] (response-delete-rule-response nil input)) ([resultWrapper2145871 input] (clojure.core/let [rawinput2145870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145872 {"ChangeToken" (rawinput2145870 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145872 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145872 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-xss-match-set-response ([input] (response-delete-xss-match-set-response nil input)) ([resultWrapper2145874 input] (clojure.core/let [rawinput2145873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145875 {"ChangeToken" (rawinput2145873 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145875 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145875 ["ChangeToken"])))))))

(clojure.core/defn- response-create-web-acl-response ([input] (response-create-web-acl-response nil input)) ([resultWrapper2145877 input] (clojure.core/let [rawinput2145876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145878 {"WebACL" (rawinput2145876 "WebACL"), "ChangeToken" (rawinput2145876 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145878 "WebACL") (clojure.core/assoc :web-acl (deser-web-acl (clojure.core/get-in letvar2145878 ["WebACL"]))) (letvar2145878 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145878 ["ChangeToken"])))))))

(clojure.core/defn- response-list-web-ac-ls-response ([input] (response-list-web-ac-ls-response nil input)) ([resultWrapper2145880 input] (clojure.core/let [rawinput2145879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145881 {"NextMarker" (rawinput2145879 "NextMarker"), "WebACLs" (rawinput2145879 "WebACLs")}] (clojure.core/cond-> {} (letvar2145881 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145881 ["NextMarker"]))) (letvar2145881 "WebACLs") (clojure.core/assoc :web-ac-ls (deser-web-acl-summaries (clojure.core/get-in letvar2145881 ["WebACLs"])))))))

(clojure.core/defn- response-list-sql-injection-match-sets-response ([input] (response-list-sql-injection-match-sets-response nil input)) ([resultWrapper2145883 input] (clojure.core/let [rawinput2145882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145884 {"NextMarker" (rawinput2145882 "NextMarker"), "SqlInjectionMatchSets" (rawinput2145882 "SqlInjectionMatchSets")}] (clojure.core/cond-> {} (letvar2145884 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145884 ["NextMarker"]))) (letvar2145884 "SqlInjectionMatchSets") (clojure.core/assoc :sql-injection-match-sets (deser-sql-injection-match-set-summaries (clojure.core/get-in letvar2145884 ["SqlInjectionMatchSets"])))))))

(clojure.core/defn- response-list-rule-groups-response ([input] (response-list-rule-groups-response nil input)) ([resultWrapper2145886 input] (clojure.core/let [rawinput2145885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145887 {"NextMarker" (rawinput2145885 "NextMarker"), "RuleGroups" (rawinput2145885 "RuleGroups")}] (clojure.core/cond-> {} (letvar2145887 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145887 ["NextMarker"]))) (letvar2145887 "RuleGroups") (clojure.core/assoc :rule-groups (deser-rule-group-summaries (clojure.core/get-in letvar2145887 ["RuleGroups"])))))))

(clojure.core/defn- response-waf-non-empty-entity-exception ([input] (response-waf-non-empty-entity-exception nil input)) ([resultWrapper2145889 input] (clojure.core/let [rawinput2145888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145890 {"message" (rawinput2145888 "message")}] (clojure.core/cond-> {} (letvar2145890 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145890 ["message"])))))))

(clojure.core/defn- response-get-regex-pattern-set-response ([input] (response-get-regex-pattern-set-response nil input)) ([resultWrapper2145892 input] (clojure.core/let [rawinput2145891 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145893 {"RegexPatternSet" (rawinput2145891 "RegexPatternSet")}] (clojure.core/cond-> {} (letvar2145893 "RegexPatternSet") (clojure.core/assoc :regex-pattern-set (deser-regex-pattern-set (clojure.core/get-in letvar2145893 ["RegexPatternSet"])))))))

(clojure.core/defn- response-get-ip-set-response ([input] (response-get-ip-set-response nil input)) ([resultWrapper2145895 input] (clojure.core/let [rawinput2145894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145896 {"IPSet" (rawinput2145894 "IPSet")}] (clojure.core/cond-> {} (letvar2145896 "IPSet") (clojure.core/assoc :ip-set (deser-ip-set (clojure.core/get-in letvar2145896 ["IPSet"])))))))

(clojure.core/defn- response-delete-web-acl-response ([input] (response-delete-web-acl-response nil input)) ([resultWrapper2145898 input] (clojure.core/let [rawinput2145897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145899 {"ChangeToken" (rawinput2145897 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145899 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145899 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rate-based-rule-response ([input] (response-get-rate-based-rule-response nil input)) ([resultWrapper2145901 input] (clojure.core/let [rawinput2145900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145902 {"Rule" (rawinput2145900 "Rule")}] (clojure.core/cond-> {} (letvar2145902 "Rule") (clojure.core/assoc :rule (deser-rate-based-rule (clojure.core/get-in letvar2145902 ["Rule"])))))))

(clojure.core/defn- response-list-activated-rules-in-rule-group-response ([input] (response-list-activated-rules-in-rule-group-response nil input)) ([resultWrapper2145904 input] (clojure.core/let [rawinput2145903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145905 {"NextMarker" (rawinput2145903 "NextMarker"), "ActivatedRules" (rawinput2145903 "ActivatedRules")}] (clojure.core/cond-> {} (letvar2145905 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145905 ["NextMarker"]))) (letvar2145905 "ActivatedRules") (clojure.core/assoc :activated-rules (deser-activated-rules (clojure.core/get-in letvar2145905 ["ActivatedRules"])))))))

(clojure.core/defn- response-put-logging-configuration-response ([input] (response-put-logging-configuration-response nil input)) ([resultWrapper2145907 input] (clojure.core/let [rawinput2145906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145908 {"LoggingConfiguration" (rawinput2145906 "LoggingConfiguration")}] (clojure.core/cond-> {} (letvar2145908 "LoggingConfiguration") (clojure.core/assoc :logging-configuration (deser-logging-configuration (clojure.core/get-in letvar2145908 ["LoggingConfiguration"])))))))

(clojure.core/defn- response-get-logging-configuration-response ([input] (response-get-logging-configuration-response nil input)) ([resultWrapper2145910 input] (clojure.core/let [rawinput2145909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145911 {"LoggingConfiguration" (rawinput2145909 "LoggingConfiguration")}] (clojure.core/cond-> {} (letvar2145911 "LoggingConfiguration") (clojure.core/assoc :logging-configuration (deser-logging-configuration (clojure.core/get-in letvar2145911 ["LoggingConfiguration"])))))))

(clojure.core/defn- response-update-byte-match-set-response ([input] (response-update-byte-match-set-response nil input)) ([resultWrapper2145913 input] (clojure.core/let [rawinput2145912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145914 {"ChangeToken" (rawinput2145912 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145914 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145914 ["ChangeToken"])))))))

(clojure.core/defn- response-list-subscribed-rule-groups-response ([input] (response-list-subscribed-rule-groups-response nil input)) ([resultWrapper2145916 input] (clojure.core/let [rawinput2145915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145917 {"NextMarker" (rawinput2145915 "NextMarker"), "RuleGroups" (rawinput2145915 "RuleGroups")}] (clojure.core/cond-> {} (letvar2145917 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145917 ["NextMarker"]))) (letvar2145917 "RuleGroups") (clojure.core/assoc :rule-groups (deser-subscribed-rule-group-summaries (clojure.core/get-in letvar2145917 ["RuleGroups"])))))))

(clojure.core/defn- response-update-geo-match-set-response ([input] (response-update-geo-match-set-response nil input)) ([resultWrapper2145919 input] (clojure.core/let [rawinput2145918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145920 {"ChangeToken" (rawinput2145918 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145920 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145920 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-limits-exceeded-exception ([input] (response-waf-limits-exceeded-exception nil input)) ([resultWrapper2145922 input] (clojure.core/let [rawinput2145921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145923 {"message" (rawinput2145921 "message")}] (clojure.core/cond-> {} (letvar2145923 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145923 ["message"])))))))

(clojure.core/defn- response-list-rate-based-rules-response ([input] (response-list-rate-based-rules-response nil input)) ([resultWrapper2145925 input] (clojure.core/let [rawinput2145924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145926 {"NextMarker" (rawinput2145924 "NextMarker"), "Rules" (rawinput2145924 "Rules")}] (clojure.core/cond-> {} (letvar2145926 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145926 ["NextMarker"]))) (letvar2145926 "Rules") (clojure.core/assoc :rules (deser-rule-summaries (clojure.core/get-in letvar2145926 ["Rules"])))))))

(clojure.core/defn- response-create-byte-match-set-response ([input] (response-create-byte-match-set-response nil input)) ([resultWrapper2145928 input] (clojure.core/let [rawinput2145927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145929 {"ByteMatchSet" (rawinput2145927 "ByteMatchSet"), "ChangeToken" (rawinput2145927 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145929 "ByteMatchSet") (clojure.core/assoc :byte-match-set (deser-byte-match-set (clojure.core/get-in letvar2145929 ["ByteMatchSet"]))) (letvar2145929 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145929 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-ip-set-response ([input] (response-delete-ip-set-response nil input)) ([resultWrapper2145931 input] (clojure.core/let [rawinput2145930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145932 {"ChangeToken" (rawinput2145930 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145932 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145932 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-subscription-not-found-exception ([input] (response-waf-subscription-not-found-exception nil input)) ([resultWrapper2145934 input] (clojure.core/let [rawinput2145933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145935 {"message" (rawinput2145933 "message")}] (clojure.core/cond-> {} (letvar2145935 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145935 ["message"])))))))

(clojure.core/defn- response-delete-size-constraint-set-response ([input] (response-delete-size-constraint-set-response nil input)) ([resultWrapper2145937 input] (clojure.core/let [rawinput2145936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145938 {"ChangeToken" (rawinput2145936 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145938 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145938 ["ChangeToken"])))))))

(clojure.core/defn- response-get-geo-match-set-response ([input] (response-get-geo-match-set-response nil input)) ([resultWrapper2145940 input] (clojure.core/let [rawinput2145939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145941 {"GeoMatchSet" (rawinput2145939 "GeoMatchSet")}] (clojure.core/cond-> {} (letvar2145941 "GeoMatchSet") (clojure.core/assoc :geo-match-set (deser-geo-match-set (clojure.core/get-in letvar2145941 ["GeoMatchSet"])))))))

(clojure.core/defn- response-create-geo-match-set-response ([input] (response-create-geo-match-set-response nil input)) ([resultWrapper2145943 input] (clojure.core/let [rawinput2145942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145944 {"GeoMatchSet" (rawinput2145942 "GeoMatchSet"), "ChangeToken" (rawinput2145942 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145944 "GeoMatchSet") (clojure.core/assoc :geo-match-set (deser-geo-match-set (clojure.core/get-in letvar2145944 ["GeoMatchSet"]))) (letvar2145944 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145944 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-byte-match-set-response ([input] (response-delete-byte-match-set-response nil input)) ([resultWrapper2145946 input] (clojure.core/let [rawinput2145945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145947 {"ChangeToken" (rawinput2145945 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145947 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145947 ["ChangeToken"])))))))

(clojure.core/defn- response-update-rule-group-response ([input] (response-update-rule-group-response nil input)) ([resultWrapper2145949 input] (clojure.core/let [rawinput2145948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145950 {"ChangeToken" (rawinput2145948 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145950 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145950 ["ChangeToken"])))))))

(clojure.core/defn- response-waf-invalid-permission-policy-exception ([input] (response-waf-invalid-permission-policy-exception nil input)) ([resultWrapper2145952 input] (clojure.core/let [rawinput2145951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145953 {"message" (rawinput2145951 "message")}] (clojure.core/cond-> {} (letvar2145953 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145953 ["message"])))))))

(clojure.core/defn- response-get-sampled-requests-response ([input] (response-get-sampled-requests-response nil input)) ([resultWrapper2145955 input] (clojure.core/let [rawinput2145954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145956 {"SampledRequests" (rawinput2145954 "SampledRequests"), "PopulationSize" (rawinput2145954 "PopulationSize"), "TimeWindow" (rawinput2145954 "TimeWindow")}] (clojure.core/cond-> {} (letvar2145956 "SampledRequests") (clojure.core/assoc :sampled-requests (deser-sampled-http-requests (clojure.core/get-in letvar2145956 ["SampledRequests"]))) (letvar2145956 "PopulationSize") (clojure.core/assoc :population-size (deser-population-size (clojure.core/get-in letvar2145956 ["PopulationSize"]))) (letvar2145956 "TimeWindow") (clojure.core/assoc :time-window (deser-time-window (clojure.core/get-in letvar2145956 ["TimeWindow"])))))))

(clojure.core/defn- response-create-xss-match-set-response ([input] (response-create-xss-match-set-response nil input)) ([resultWrapper2145958 input] (clojure.core/let [rawinput2145957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145959 {"XssMatchSet" (rawinput2145957 "XssMatchSet"), "ChangeToken" (rawinput2145957 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145959 "XssMatchSet") (clojure.core/assoc :xss-match-set (deser-xss-match-set (clojure.core/get-in letvar2145959 ["XssMatchSet"]))) (letvar2145959 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145959 ["ChangeToken"])))))))

(clojure.core/defn- response-update-rate-based-rule-response ([input] (response-update-rate-based-rule-response nil input)) ([resultWrapper2145961 input] (clojure.core/let [rawinput2145960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145962 {"ChangeToken" (rawinput2145960 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145962 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145962 ["ChangeToken"])))))))

(clojure.core/defn- response-get-size-constraint-set-response ([input] (response-get-size-constraint-set-response nil input)) ([resultWrapper2145964 input] (clojure.core/let [rawinput2145963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145965 {"SizeConstraintSet" (rawinput2145963 "SizeConstraintSet")}] (clojure.core/cond-> {} (letvar2145965 "SizeConstraintSet") (clojure.core/assoc :size-constraint-set (deser-size-constraint-set (clojure.core/get-in letvar2145965 ["SizeConstraintSet"])))))))

(clojure.core/defn- response-waf-disallowed-name-exception ([input] (response-waf-disallowed-name-exception nil input)) ([resultWrapper2145967 input] (clojure.core/let [rawinput2145966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145968 {"message" (rawinput2145966 "message")}] (clojure.core/cond-> {} (letvar2145968 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2145968 ["message"])))))))

(clojure.core/defn- response-update-size-constraint-set-response ([input] (response-update-size-constraint-set-response nil input)) ([resultWrapper2145970 input] (clojure.core/let [rawinput2145969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145971 {"ChangeToken" (rawinput2145969 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145971 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145971 ["ChangeToken"])))))))

(clojure.core/defn- response-create-regex-pattern-set-response ([input] (response-create-regex-pattern-set-response nil input)) ([resultWrapper2145973 input] (clojure.core/let [rawinput2145972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145974 {"RegexPatternSet" (rawinput2145972 "RegexPatternSet"), "ChangeToken" (rawinput2145972 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145974 "RegexPatternSet") (clojure.core/assoc :regex-pattern-set (deser-regex-pattern-set (clojure.core/get-in letvar2145974 ["RegexPatternSet"]))) (letvar2145974 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145974 ["ChangeToken"])))))))

(clojure.core/defn- response-list-logging-configurations-response ([input] (response-list-logging-configurations-response nil input)) ([resultWrapper2145976 input] (clojure.core/let [rawinput2145975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145977 {"LoggingConfigurations" (rawinput2145975 "LoggingConfigurations"), "NextMarker" (rawinput2145975 "NextMarker")}] (clojure.core/cond-> {} (letvar2145977 "LoggingConfigurations") (clojure.core/assoc :logging-configurations (deser-logging-configurations (clojure.core/get-in letvar2145977 ["LoggingConfigurations"]))) (letvar2145977 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145977 ["NextMarker"])))))))

(clojure.core/defn- response-delete-regex-pattern-set-response ([input] (response-delete-regex-pattern-set-response nil input)) ([resultWrapper2145979 input] (clojure.core/let [rawinput2145978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145980 {"ChangeToken" (rawinput2145978 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145980 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145980 ["ChangeToken"])))))))

(clojure.core/defn- response-create-rate-based-rule-response ([input] (response-create-rate-based-rule-response nil input)) ([resultWrapper2145982 input] (clojure.core/let [rawinput2145981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145983 {"Rule" (rawinput2145981 "Rule"), "ChangeToken" (rawinput2145981 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145983 "Rule") (clojure.core/assoc :rule (deser-rate-based-rule (clojure.core/get-in letvar2145983 ["Rule"]))) (letvar2145983 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145983 ["ChangeToken"])))))))

(clojure.core/defn- response-list-regex-match-sets-response ([input] (response-list-regex-match-sets-response nil input)) ([resultWrapper2145985 input] (clojure.core/let [rawinput2145984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145986 {"NextMarker" (rawinput2145984 "NextMarker"), "RegexMatchSets" (rawinput2145984 "RegexMatchSets")}] (clojure.core/cond-> {} (letvar2145986 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145986 ["NextMarker"]))) (letvar2145986 "RegexMatchSets") (clojure.core/assoc :regex-match-sets (deser-regex-match-set-summaries (clojure.core/get-in letvar2145986 ["RegexMatchSets"])))))))

(clojure.core/defn- response-get-change-token-status-response ([input] (response-get-change-token-status-response nil input)) ([resultWrapper2145988 input] (clojure.core/let [rawinput2145987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145989 {"ChangeTokenStatus" (rawinput2145987 "ChangeTokenStatus")}] (clojure.core/cond-> {} (letvar2145989 "ChangeTokenStatus") (clojure.core/assoc :change-token-status (deser-change-token-status (clojure.core/get-in letvar2145989 ["ChangeTokenStatus"])))))))

(clojure.core/defn- response-list-byte-match-sets-response ([input] (response-list-byte-match-sets-response nil input)) ([resultWrapper2145991 input] (clojure.core/let [rawinput2145990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145992 {"NextMarker" (rawinput2145990 "NextMarker"), "ByteMatchSets" (rawinput2145990 "ByteMatchSets")}] (clojure.core/cond-> {} (letvar2145992 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145992 ["NextMarker"]))) (letvar2145992 "ByteMatchSets") (clojure.core/assoc :byte-match-sets (deser-byte-match-set-summaries (clojure.core/get-in letvar2145992 ["ByteMatchSets"])))))))

(clojure.core/defn- response-delete-rate-based-rule-response ([input] (response-delete-rate-based-rule-response nil input)) ([resultWrapper2145994 input] (clojure.core/let [rawinput2145993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145995 {"ChangeToken" (rawinput2145993 "ChangeToken")}] (clojure.core/cond-> {} (letvar2145995 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2145995 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rate-based-rule-managed-keys-response ([input] (response-get-rate-based-rule-managed-keys-response nil input)) ([resultWrapper2145997 input] (clojure.core/let [rawinput2145996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2145998 {"ManagedKeys" (rawinput2145996 "ManagedKeys"), "NextMarker" (rawinput2145996 "NextMarker")}] (clojure.core/cond-> {} (letvar2145998 "ManagedKeys") (clojure.core/assoc :managed-keys (deser-managed-keys (clojure.core/get-in letvar2145998 ["ManagedKeys"]))) (letvar2145998 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2145998 ["NextMarker"])))))))

(clojure.core/defn- response-list-size-constraint-sets-response ([input] (response-list-size-constraint-sets-response nil input)) ([resultWrapper2146000 input] (clojure.core/let [rawinput2145999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146001 {"NextMarker" (rawinput2145999 "NextMarker"), "SizeConstraintSets" (rawinput2145999 "SizeConstraintSets")}] (clojure.core/cond-> {} (letvar2146001 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2146001 ["NextMarker"]))) (letvar2146001 "SizeConstraintSets") (clojure.core/assoc :size-constraint-sets (deser-size-constraint-set-summaries (clojure.core/get-in letvar2146001 ["SizeConstraintSets"])))))))

(clojure.core/defn- response-get-permission-policy-response ([input] (response-get-permission-policy-response nil input)) ([resultWrapper2146003 input] (clojure.core/let [rawinput2146002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146004 {"Policy" (rawinput2146002 "Policy")}] (clojure.core/cond-> {} (letvar2146004 "Policy") (clojure.core/assoc :policy (deser-policy-string (clojure.core/get-in letvar2146004 ["Policy"])))))))

(clojure.core/defn- response-create-rule-group-response ([input] (response-create-rule-group-response nil input)) ([resultWrapper2146006 input] (clojure.core/let [rawinput2146005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146007 {"RuleGroup" (rawinput2146005 "RuleGroup"), "ChangeToken" (rawinput2146005 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146007 "RuleGroup") (clojure.core/assoc :rule-group (deser-rule-group (clojure.core/get-in letvar2146007 ["RuleGroup"]))) (letvar2146007 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146007 ["ChangeToken"])))))))

(clojure.core/defn- response-delete-geo-match-set-response ([input] (response-delete-geo-match-set-response nil input)) ([resultWrapper2146009 input] (clojure.core/let [rawinput2146008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146010 {"ChangeToken" (rawinput2146008 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146010 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146010 ["ChangeToken"])))))))

(clojure.core/defn- response-get-change-token-response ([input] (response-get-change-token-response nil input)) ([resultWrapper2146012 input] (clojure.core/let [rawinput2146011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146013 {"ChangeToken" (rawinput2146011 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146013 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146013 ["ChangeToken"])))))))

(clojure.core/defn- response-update-web-acl-response ([input] (response-update-web-acl-response nil input)) ([resultWrapper2146015 input] (clojure.core/let [rawinput2146014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146016 {"ChangeToken" (rawinput2146014 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146016 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146016 ["ChangeToken"])))))))

(clojure.core/defn- response-get-sql-injection-match-set-response ([input] (response-get-sql-injection-match-set-response nil input)) ([resultWrapper2146018 input] (clojure.core/let [rawinput2146017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146019 {"SqlInjectionMatchSet" (rawinput2146017 "SqlInjectionMatchSet")}] (clojure.core/cond-> {} (letvar2146019 "SqlInjectionMatchSet") (clojure.core/assoc :sql-injection-match-set (deser-sql-injection-match-set (clojure.core/get-in letvar2146019 ["SqlInjectionMatchSet"])))))))

(clojure.core/defn- response-get-regex-match-set-response ([input] (response-get-regex-match-set-response nil input)) ([resultWrapper2146021 input] (clojure.core/let [rawinput2146020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146022 {"RegexMatchSet" (rawinput2146020 "RegexMatchSet")}] (clojure.core/cond-> {} (letvar2146022 "RegexMatchSet") (clojure.core/assoc :regex-match-set (deser-regex-match-set (clojure.core/get-in letvar2146022 ["RegexMatchSet"])))))))

(clojure.core/defn- response-create-rule-response ([input] (response-create-rule-response nil input)) ([resultWrapper2146024 input] (clojure.core/let [rawinput2146023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146025 {"Rule" (rawinput2146023 "Rule"), "ChangeToken" (rawinput2146023 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146025 "Rule") (clojure.core/assoc :rule (deser-rule (clojure.core/get-in letvar2146025 ["Rule"]))) (letvar2146025 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146025 ["ChangeToken"])))))))

(clojure.core/defn- response-create-ip-set-response ([input] (response-create-ip-set-response nil input)) ([resultWrapper2146027 input] (clojure.core/let [rawinput2146026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146028 {"IPSet" (rawinput2146026 "IPSet"), "ChangeToken" (rawinput2146026 "ChangeToken")}] (clojure.core/cond-> {} (letvar2146028 "IPSet") (clojure.core/assoc :ip-set (deser-ip-set (clojure.core/get-in letvar2146028 ["IPSet"]))) (letvar2146028 "ChangeToken") (clojure.core/assoc :change-token (deser-change-token (clojure.core/get-in letvar2146028 ["ChangeToken"])))))))

(clojure.core/defn- response-get-rule-group-response ([input] (response-get-rule-group-response nil input)) ([resultWrapper2146030 input] (clojure.core/let [rawinput2146029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146031 {"RuleGroup" (rawinput2146029 "RuleGroup")}] (clojure.core/cond-> {} (letvar2146031 "RuleGroup") (clojure.core/assoc :rule-group (deser-rule-group (clojure.core/get-in letvar2146031 ["RuleGroup"])))))))

(clojure.core/defn- response-list-ip-sets-response ([input] (response-list-ip-sets-response nil input)) ([resultWrapper2146033 input] (clojure.core/let [rawinput2146032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2146034 {"NextMarker" (rawinput2146032 "NextMarker"), "IPSets" (rawinput2146032 "IPSets")}] (clojure.core/cond-> {} (letvar2146034 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar2146034 ["NextMarker"]))) (letvar2146034 "IPSets") (clojure.core/assoc :ip-sets (deser-ip-set-summaries (clojure.core/get-in letvar2146034 ["IPSets"])))))))
...
(clojure.spec.alpha/def :portkey.aws.waf/change-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf/regex-pattern-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf/policy-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.waf/parameter-exception-parameter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.waf/next-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.waf/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224))))
