...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper51458 input] (clojure.core/let [rawinput51457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51459 {"message" (rawinput51457 "message")}] (clojure.core/cond-> {} (letvar51459 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51459 ["message"])))))))

(clojure.core/defn- response-list-routes-output ([input] (response-list-routes-output nil input)) ([resultWrapper51461 input] (clojure.core/let [rawinput51460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51462 {"nextToken" (rawinput51460 "nextToken"), "routes" (rawinput51460 "routes")}] (clojure.core/cond-> {:routes (deser-route-list (clojure.core/get-in letvar51462 ["routes"]))} (letvar51462 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar51462 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper51464 input] (clojure.core/let [rawinput51463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51465 {"message" (rawinput51463 "message")}] (clojure.core/cond-> {} (letvar51465 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51465 ["message"])))))))

(clojure.core/defn- response-list-meshes-output ([input] (response-list-meshes-output nil input)) ([resultWrapper51467 input] (clojure.core/let [rawinput51466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51468 {"meshes" (rawinput51466 "meshes"), "nextToken" (rawinput51466 "nextToken")}] (clojure.core/cond-> {:meshes (deser-mesh-list (clojure.core/get-in letvar51468 ["meshes"]))} (letvar51468 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar51468 ["nextToken"])))))))

(clojure.core/defn- response-update-route-output ([input] (response-update-route-output nil input)) ([resultWrapper51470 input] (clojure.core/let [rawinput51469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51471 {"route" (rawinput51469 "route")}] (clojure.core/cond-> {} (letvar51471 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar51471 ["route"])))))))

(clojure.core/defn- response-create-virtual-router-output ([input] (response-create-virtual-router-output nil input)) ([resultWrapper51473 input] (clojure.core/let [rawinput51472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51474 {"virtualRouter" (rawinput51472 "virtualRouter")}] (clojure.core/cond-> {} (letvar51474 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar51474 ["virtualRouter"])))))))

(clojure.core/defn- response-delete-virtual-node-output ([input] (response-delete-virtual-node-output nil input)) ([resultWrapper51476 input] (clojure.core/let [rawinput51475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51477 {"virtualNode" (rawinput51475 "virtualNode")}] (clojure.core/cond-> {} (letvar51477 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar51477 ["virtualNode"])))))))

(clojure.core/defn- response-delete-route-output ([input] (response-delete-route-output nil input)) ([resultWrapper51479 input] (clojure.core/let [rawinput51478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51480 {"route" (rawinput51478 "route")}] (clojure.core/cond-> {} (letvar51480 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar51480 ["route"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper51482 input] (clojure.core/let [rawinput51481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51483 {"message" (rawinput51481 "message")}] (clojure.core/cond-> {} (letvar51483 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51483 ["message"])))))))

(clojure.core/defn- response-describe-route-output ([input] (response-describe-route-output nil input)) ([resultWrapper51485 input] (clojure.core/let [rawinput51484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51486 {"route" (rawinput51484 "route")}] (clojure.core/cond-> {} (letvar51486 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar51486 ["route"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper51488 input] (clojure.core/let [rawinput51487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51489 {"message" (rawinput51487 "message")}] (clojure.core/cond-> {} (letvar51489 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51489 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper51491 input] (clojure.core/let [rawinput51490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51492 {"message" (rawinput51490 "message")}] (clojure.core/cond-> {} (letvar51492 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51492 ["message"])))))))

(clojure.core/defn- response-update-virtual-node-output ([input] (response-update-virtual-node-output nil input)) ([resultWrapper51494 input] (clojure.core/let [rawinput51493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51495 {"virtualNode" (rawinput51493 "virtualNode")}] (clojure.core/cond-> {} (letvar51495 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar51495 ["virtualNode"])))))))

(clojure.core/defn- response-update-virtual-router-output ([input] (response-update-virtual-router-output nil input)) ([resultWrapper51497 input] (clojure.core/let [rawinput51496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51498 {"virtualRouter" (rawinput51496 "virtualRouter")}] (clojure.core/cond-> {} (letvar51498 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar51498 ["virtualRouter"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper51500 input] (clojure.core/let [rawinput51499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51501 {"message" (rawinput51499 "message")}] (clojure.core/cond-> {} (letvar51501 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51501 ["message"])))))))

(clojure.core/defn- response-list-virtual-routers-output ([input] (response-list-virtual-routers-output nil input)) ([resultWrapper51503 input] (clojure.core/let [rawinput51502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51504 {"nextToken" (rawinput51502 "nextToken"), "virtualRouters" (rawinput51502 "virtualRouters")}] (clojure.core/cond-> {:virtual-routers (deser-virtual-router-list (clojure.core/get-in letvar51504 ["virtualRouters"]))} (letvar51504 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar51504 ["nextToken"])))))))

(clojure.core/defn- response-create-route-output ([input] (response-create-route-output nil input)) ([resultWrapper51506 input] (clojure.core/let [rawinput51505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51507 {"route" (rawinput51505 "route")}] (clojure.core/cond-> {} (letvar51507 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar51507 ["route"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper51509 input] (clojure.core/let [rawinput51508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51510 {"message" (rawinput51508 "message")}] (clojure.core/cond-> {} (letvar51510 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51510 ["message"])))))))

(clojure.core/defn- response-describe-virtual-node-output ([input] (response-describe-virtual-node-output nil input)) ([resultWrapper51512 input] (clojure.core/let [rawinput51511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51513 {"virtualNode" (rawinput51511 "virtualNode")}] (clojure.core/cond-> {} (letvar51513 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar51513 ["virtualNode"])))))))

(clojure.core/defn- response-describe-virtual-router-output ([input] (response-describe-virtual-router-output nil input)) ([resultWrapper51515 input] (clojure.core/let [rawinput51514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51516 {"virtualRouter" (rawinput51514 "virtualRouter")}] (clojure.core/cond-> {} (letvar51516 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar51516 ["virtualRouter"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper51518 input] (clojure.core/let [rawinput51517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51519 {"message" (rawinput51517 "message")}] (clojure.core/cond-> {} (letvar51519 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51519 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper51521 input] (clojure.core/let [rawinput51520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51522 {"message" (rawinput51520 "message")}] (clojure.core/cond-> {} (letvar51522 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar51522 ["message"])))))))

(clojure.core/defn- response-list-virtual-nodes-output ([input] (response-list-virtual-nodes-output nil input)) ([resultWrapper51524 input] (clojure.core/let [rawinput51523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51525 {"nextToken" (rawinput51523 "nextToken"), "virtualNodes" (rawinput51523 "virtualNodes")}] (clojure.core/cond-> {:virtual-nodes (deser-virtual-node-list (clojure.core/get-in letvar51525 ["virtualNodes"]))} (letvar51525 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar51525 ["nextToken"])))))))

(clojure.core/defn- response-create-mesh-output ([input] (response-create-mesh-output nil input)) ([resultWrapper51527 input] (clojure.core/let [rawinput51526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51528 {"mesh" (rawinput51526 "mesh")}] (clojure.core/cond-> {} (letvar51528 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar51528 ["mesh"])))))))

(clojure.core/defn- response-create-virtual-node-output ([input] (response-create-virtual-node-output nil input)) ([resultWrapper51530 input] (clojure.core/let [rawinput51529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51531 {"virtualNode" (rawinput51529 "virtualNode")}] (clojure.core/cond-> {} (letvar51531 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar51531 ["virtualNode"])))))))

(clojure.core/defn- response-describe-mesh-output ([input] (response-describe-mesh-output nil input)) ([resultWrapper51533 input] (clojure.core/let [rawinput51532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51534 {"mesh" (rawinput51532 "mesh")}] (clojure.core/cond-> {} (letvar51534 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar51534 ["mesh"])))))))

(clojure.core/defn- response-delete-virtual-router-output ([input] (response-delete-virtual-router-output nil input)) ([resultWrapper51536 input] (clojure.core/let [rawinput51535 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51537 {"virtualRouter" (rawinput51535 "virtualRouter")}] (clojure.core/cond-> {} (letvar51537 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar51537 ["virtualRouter"])))))))

(clojure.core/defn- response-delete-mesh-output ([input] (response-delete-mesh-output nil input)) ([resultWrapper51539 input] (clojure.core/let [rawinput51538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar51540 {"mesh" (rawinput51538 "mesh")}] (clojure.core/cond-> {} (letvar51540 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar51540 ["mesh"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appmesh/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 255))))
