...
(clojure.spec.alpha/def :portkey.aws.xray/error-statistics (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.error-statistics/ThrottleCount :portkey.aws.xray.error-statistics/OtherCount :portkey.aws.xray.error-statistics/TotalCount]))
...
(clojure.spec.alpha/def :portkey.aws.xray/annotation-value (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.annotation-value/NumberValue :portkey.aws.xray.annotation-value/BooleanValue :portkey.aws.xray.annotation-value/StringValue]))
...
(clojure.spec.alpha/def :portkey.aws.xray/edge (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.edge/ReferenceId :portkey.aws.xray.edge/StartTime :portkey.aws.xray.edge/EndTime :portkey.aws.xray.edge/SummaryStatistics :portkey.aws.xray.edge/ResponseTimeHistogram :portkey.aws.xray.edge/Aliases]))
...
(clojure.spec.alpha/def :portkey.aws.xray/invalid-request-exception (portkey.aws/json-keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.xray/trace (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.trace/Id :portkey.aws.xray.trace/Duration :portkey.aws.xray.trace/Segments]))

(clojure.spec.alpha/def :portkey.aws.xray/put-telemetry-records-result (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.xray.trace-user/user-name (clojure.spec.alpha/and :portkey.aws.xray/string))
(clojure.spec.alpha/def :portkey.aws.xray/trace-user (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.trace-user/UserName :portkey.aws.xray/ServiceIds]))
...
(clojure.spec.alpha/def :portkey.aws.xray/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 35 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray/alias (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.alias/Name :portkey.aws.xray.alias/Names :portkey.aws.xray.alias/Type]))
...
(clojure.spec.alpha/def :portkey.aws.xray/get-service-graph-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.get-service-graph-request/StartTime :portkey.aws.xray.get-service-graph-request/EndTime] :opt-un [:portkey.aws.xray.get-service-graph-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray/unprocessed-trace-segment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.unprocessed-trace-segment/Id :portkey.aws.xray.unprocessed-trace-segment/ErrorCode :portkey.aws.xray.unprocessed-trace-segment/Message]))
...
(clojure.spec.alpha/def :portkey.aws.xray/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 0 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray/segment (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.segment/Id :portkey.aws.xray.segment/Document]))
...
(clojure.spec.alpha/def :portkey.aws.xray/fault-statistics (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.fault-statistics/OtherCount :portkey.aws.xray.fault-statistics/TotalCount]))
...
(clojure.spec.alpha/def :portkey.aws.xray/service-id (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.service-id/Name :portkey.aws.xray.service-id/Names :portkey.aws.xray.service-id/AccountId :portkey.aws.xray.service-id/Type]))
...
(clojure.spec.alpha/def :portkey.aws.xray/put-trace-segments-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.put-trace-segments-request/TraceSegmentDocuments] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.xray/value-with-service-ids (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray/AnnotationValue :portkey.aws.xray/ServiceIds]))
...
(clojure.spec.alpha/def :portkey.aws.xray/http (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.http/HttpURL :portkey.aws.xray.http/HttpStatus :portkey.aws.xray.http/HttpMethod :portkey.aws.xray.http/UserAgent :portkey.aws.xray.http/ClientIp]))
...
(clojure.spec.alpha/def :portkey.aws.xray/batch-get-traces-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.batch-get-traces-request/TraceIds] :opt-un [:portkey.aws.xray.batch-get-traces-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray/put-trace-segments-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.put-trace-segments-result/UnprocessedTraceSegments]))
...
(clojure.spec.alpha/def :portkey.aws.xray/get-trace-graph-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.get-trace-graph-result/Services :portkey.aws.xray.get-trace-graph-result/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray/segment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 16 (clojure.core/count s__8149__auto__))) (clojure.core/fn [s__8150__auto__] (clojure.core/< (clojure.core/count s__8150__auto__) 16))))
...
(clojure.spec.alpha/def :portkey.aws.xray/batch-get-traces-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.batch-get-traces-result/Traces :portkey.aws.xray.batch-get-traces-result/UnprocessedTraceIds :portkey.aws.xray.batch-get-traces-result/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray/edge-statistics (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.edge-statistics/OkCount :portkey.aws.xray/ErrorStatistics :portkey.aws.xray/FaultStatistics :portkey.aws.xray.edge-statistics/TotalCount :portkey.aws.xray.edge-statistics/TotalResponseTime]))

(clojure.spec.alpha/def :portkey.aws.xray/trace-id-list (clojure.spec.alpha/coll-of :portkey.aws.xray/trace-id :max-count nil))

(clojure.spec.alpha/def :portkey.aws.xray/throttled-exception (portkey.aws/json-keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.xray/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__8149__auto__] (clojure.core/<= 1 (clojure.core/count s__8149__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.xray/get-trace-graph-request (portkey.aws/json-keys :req-un [:portkey.aws.xray.get-trace-graph-request/TraceIds] :opt-un [:portkey.aws.xray.get-trace-graph-request/NextToken]))
...
(clojure.spec.alpha/def :portkey.aws.xray/histogram-entry (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.xray.histogram-entry/Value :portkey.aws.xray.histogram-entry/Count]))

(clojure.core/defn batch-get-traces [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/Traces" input__8278__auto__ :portkey.aws.xray/batch-get-traces-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/batch-get-traces-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
...
(clojure.core/defn get-service-graph [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/ServiceGraph" input__8278__auto__ :portkey.aws.xray/get-service-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-service-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
...
(clojure.core/defn get-trace-graph [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceGraph" input__8278__auto__ :portkey.aws.xray/get-trace-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-trace-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
...
(clojure.core/defn get-trace-summaries [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceSummaries" input__8278__auto__ :portkey.aws.xray/get-trace-summaries-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-trace-summaries-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
...
(clojure.core/defn put-telemetry-records [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TelemetryRecords" input__8278__auto__ :portkey.aws.xray/put-telemetry-records-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/put-telemetry-records-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
...
(clojure.core/defn put-trace-segments [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceSegments" input__8278__auto__ :portkey.aws.xray/put-trace-segments-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/put-trace-segments-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception}))
