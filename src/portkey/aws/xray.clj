...
(clojure.core/defn get-service-graph "<p>Retrieves a document that describes services that process incoming requests, and downstream services that they call as a result. Root services process incoming requests and make calls to downstream services. Root services are applications that use the AWS X-Ray SDK. Downstream services can be other applications, AWS resources, HTTP web APIs, or SQL databases.</p>" ([get-service-graph-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/ServiceGraph" get-service-graph-request :portkey.aws.xray/get-service-graph-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-service-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
...
(clojure.core/defn get-trace-graph "<p>Retrieves a service graph for one or more specific trace IDs.</p>" ([get-trace-graph-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceGraph" get-trace-graph-request :portkey.aws.xray/get-trace-graph-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-trace-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
...
(clojure.core/defn put-telemetry-records "<p>Used by the AWS X-Ray daemon to upload telemetry.</p>" ([put-telemetry-records-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TelemetryRecords" put-telemetry-records-request :portkey.aws.xray/put-telemetry-records-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/put-telemetry-records-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
