...
(clojure.core/defn- response-rule-limit-exceeded-exception ([input] (response-rule-limit-exceeded-exception nil input)) ([resultWrapper1483208 input] (clojure.core/let [rawinput1483207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483209 {"Message" (rawinput1483207 "Message")}] (clojure.core/cond-> {} (letvar1483209 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1483209 ["Message"])))))))

(clojure.core/defn- response-get-sampling-rules-result ([input] (response-get-sampling-rules-result nil input)) ([resultWrapper1483211 input] (clojure.core/let [rawinput1483210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483212 {"SamplingRuleRecords" (rawinput1483210 "SamplingRuleRecords"), "NextToken" (rawinput1483210 "NextToken")}] (clojure.core/cond-> {} (letvar1483212 "SamplingRuleRecords") (clojure.core/assoc :sampling-rule-records (deser-sampling-rule-record-list (clojure.core/get-in letvar1483212 ["SamplingRuleRecords"]))) (letvar1483212 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483212 ["NextToken"])))))))

(clojure.core/defn- response-update-group-result ([input] (response-update-group-result nil input)) ([resultWrapper1483214 input] (clojure.core/let [rawinput1483213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483215 {"Group" (rawinput1483213 "Group")}] (clojure.core/cond-> {} (letvar1483215 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1483215 ["Group"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1483217 input] (clojure.core/let [rawinput1483216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483218 {"Message" (rawinput1483216 "Message")}] (clojure.core/cond-> {} (letvar1483218 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1483218 ["Message"])))))))

(clojure.core/defn- response-get-group-result ([input] (response-get-group-result nil input)) ([resultWrapper1483220 input] (clojure.core/let [rawinput1483219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483221 {"Group" (rawinput1483219 "Group")}] (clojure.core/cond-> {} (letvar1483221 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1483221 ["Group"])))))))

(clojure.core/defn- response-get-encryption-config-result ([input] (response-get-encryption-config-result nil input)) ([resultWrapper1483223 input] (clojure.core/let [rawinput1483222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483224 {"EncryptionConfig" (rawinput1483222 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1483224 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1483224 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-telemetry-records-result ([input] (response-put-telemetry-records-result nil input)) ([resultWrapper1483226 input] (clojure.core/let [rawinput1483225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483227 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-trace-summaries-result ([input] (response-get-trace-summaries-result nil input)) ([resultWrapper1483229 input] (clojure.core/let [rawinput1483228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483230 {"TraceSummaries" (rawinput1483228 "TraceSummaries"), "ApproximateTime" (rawinput1483228 "ApproximateTime"), "TracesProcessedCount" (rawinput1483228 "TracesProcessedCount"), "NextToken" (rawinput1483228 "NextToken")}] (clojure.core/cond-> {} (letvar1483230 "TraceSummaries") (clojure.core/assoc :trace-summaries (deser-trace-summary-list (clojure.core/get-in letvar1483230 ["TraceSummaries"]))) (letvar1483230 "ApproximateTime") (clojure.core/assoc :approximate-time (deser-timestamp (clojure.core/get-in letvar1483230 ["ApproximateTime"]))) (letvar1483230 "TracesProcessedCount") (clojure.core/assoc :traces-processed-count (deser-nullable-long (clojure.core/get-in letvar1483230 ["TracesProcessedCount"]))) (letvar1483230 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483230 ["NextToken"])))))))

(clojure.core/defn- response-update-sampling-rule-result ([input] (response-update-sampling-rule-result nil input)) ([resultWrapper1483232 input] (clojure.core/let [rawinput1483231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483233 {"SamplingRuleRecord" (rawinput1483231 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1483233 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1483233 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-put-encryption-config-result ([input] (response-put-encryption-config-result nil input)) ([resultWrapper1483235 input] (clojure.core/let [rawinput1483234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483236 {"EncryptionConfig" (rawinput1483234 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1483236 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1483236 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-trace-segments-result ([input] (response-put-trace-segments-result nil input)) ([resultWrapper1483238 input] (clojure.core/let [rawinput1483237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483239 {"UnprocessedTraceSegments" (rawinput1483237 "UnprocessedTraceSegments")}] (clojure.core/cond-> {} (letvar1483239 "UnprocessedTraceSegments") (clojure.core/assoc :unprocessed-trace-segments (deser-unprocessed-trace-segment-list (clojure.core/get-in letvar1483239 ["UnprocessedTraceSegments"])))))))

(clojure.core/defn- response-get-trace-graph-result ([input] (response-get-trace-graph-result nil input)) ([resultWrapper1483241 input] (clojure.core/let [rawinput1483240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483242 {"Services" (rawinput1483240 "Services"), "NextToken" (rawinput1483240 "NextToken")}] (clojure.core/cond-> {} (letvar1483242 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1483242 ["Services"]))) (letvar1483242 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483242 ["NextToken"])))))))

(clojure.core/defn- response-create-group-result ([input] (response-create-group-result nil input)) ([resultWrapper1483244 input] (clojure.core/let [rawinput1483243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483245 {"Group" (rawinput1483243 "Group")}] (clojure.core/cond-> {} (letvar1483245 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1483245 ["Group"])))))))

(clojure.core/defn- response-get-sampling-statistic-summaries-result ([input] (response-get-sampling-statistic-summaries-result nil input)) ([resultWrapper1483247 input] (clojure.core/let [rawinput1483246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483248 {"SamplingStatisticSummaries" (rawinput1483246 "SamplingStatisticSummaries"), "NextToken" (rawinput1483246 "NextToken")}] (clojure.core/cond-> {} (letvar1483248 "SamplingStatisticSummaries") (clojure.core/assoc :sampling-statistic-summaries (deser-sampling-statistic-summary-list (clojure.core/get-in letvar1483248 ["SamplingStatisticSummaries"]))) (letvar1483248 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483248 ["NextToken"])))))))

(clojure.core/defn- response-create-sampling-rule-result ([input] (response-create-sampling-rule-result nil input)) ([resultWrapper1483250 input] (clojure.core/let [rawinput1483249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483251 {"SamplingRuleRecord" (rawinput1483249 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1483251 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1483251 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-sampling-rule-result ([input] (response-delete-sampling-rule-result nil input)) ([resultWrapper1483253 input] (clojure.core/let [rawinput1483252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483254 {"SamplingRuleRecord" (rawinput1483252 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1483254 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1483254 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-group-result ([input] (response-delete-group-result nil input)) ([resultWrapper1483256 input] (clojure.core/let [rawinput1483255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483257 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-sampling-targets-result ([input] (response-get-sampling-targets-result nil input)) ([resultWrapper1483259 input] (clojure.core/let [rawinput1483258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483260 {"SamplingTargetDocuments" (rawinput1483258 "SamplingTargetDocuments"), "LastRuleModification" (rawinput1483258 "LastRuleModification"), "UnprocessedStatistics" (rawinput1483258 "UnprocessedStatistics")}] (clojure.core/cond-> {} (letvar1483260 "SamplingTargetDocuments") (clojure.core/assoc :sampling-target-documents (deser-sampling-target-document-list (clojure.core/get-in letvar1483260 ["SamplingTargetDocuments"]))) (letvar1483260 "LastRuleModification") (clojure.core/assoc :last-rule-modification (deser-timestamp (clojure.core/get-in letvar1483260 ["LastRuleModification"]))) (letvar1483260 "UnprocessedStatistics") (clojure.core/assoc :unprocessed-statistics (deser-unprocessed-statistics-list (clojure.core/get-in letvar1483260 ["UnprocessedStatistics"])))))))

(clojure.core/defn- response-get-groups-result ([input] (response-get-groups-result nil input)) ([resultWrapper1483262 input] (clojure.core/let [rawinput1483261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483263 {"Groups" (rawinput1483261 "Groups"), "NextToken" (rawinput1483261 "NextToken")}] (clojure.core/cond-> {} (letvar1483263 "Groups") (clojure.core/assoc :groups (deser-group-summary-list (clojure.core/get-in letvar1483263 ["Groups"]))) (letvar1483263 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483263 ["NextToken"])))))))

(clojure.core/defn- response-get-service-graph-result ([input] (response-get-service-graph-result nil input)) ([resultWrapper1483265 input] (clojure.core/let [rawinput1483264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483266 {"StartTime" (rawinput1483264 "StartTime"), "EndTime" (rawinput1483264 "EndTime"), "Services" (rawinput1483264 "Services"), "ContainsOldGroupVersions" (rawinput1483264 "ContainsOldGroupVersions"), "NextToken" (rawinput1483264 "NextToken")}] (clojure.core/cond-> {} (letvar1483266 "StartTime") (clojure.core/assoc :start-time (deser-timestamp (clojure.core/get-in letvar1483266 ["StartTime"]))) (letvar1483266 "EndTime") (clojure.core/assoc :end-time (deser-timestamp (clojure.core/get-in letvar1483266 ["EndTime"]))) (letvar1483266 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1483266 ["Services"]))) (letvar1483266 "ContainsOldGroupVersions") (clojure.core/assoc :contains-old-group-versions (deser-boolean (clojure.core/get-in letvar1483266 ["ContainsOldGroupVersions"]))) (letvar1483266 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483266 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-traces-result ([input] (response-batch-get-traces-result nil input)) ([resultWrapper1483268 input] (clojure.core/let [rawinput1483267 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483269 {"Traces" (rawinput1483267 "Traces"), "UnprocessedTraceIds" (rawinput1483267 "UnprocessedTraceIds"), "NextToken" (rawinput1483267 "NextToken")}] (clojure.core/cond-> {} (letvar1483269 "Traces") (clojure.core/assoc :traces (deser-trace-list (clojure.core/get-in letvar1483269 ["Traces"]))) (letvar1483269 "UnprocessedTraceIds") (clojure.core/assoc :unprocessed-trace-ids (deser-unprocessed-trace-id-list (clojure.core/get-in letvar1483269 ["UnprocessedTraceIds"]))) (letvar1483269 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1483269 ["NextToken"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1483271 input] (clojure.core/let [rawinput1483270 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1483272 {"Message" (rawinput1483270 "Message")}] (clojure.core/cond-> {} (letvar1483272 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1483272 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.xray/service-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/rule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/encryption-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 3000))))
...
(clojure.spec.alpha/def :portkey.aws.xray/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray/group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.xray/url-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.xray/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.xray/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray/attribute-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/ec-2-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.xray/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 24 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 24))))

(clojure.spec.alpha/def :portkey.aws.xray/service-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/get-groups-next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.xray/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 400))))
...
(clojure.spec.alpha/def :portkey.aws.xray/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.xray/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__)))))

(clojure.spec.alpha/def :portkey.aws.xray/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/http-method (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 10))))
