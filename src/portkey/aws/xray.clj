...
(clojure.core/defn- response-rule-limit-exceeded-exception ([input] (response-rule-limit-exceeded-exception nil input)) ([resultWrapper1918344 input] (clojure.core/let [rawinput1918343 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918345 {"Message" (rawinput1918343 "Message")}] (clojure.core/cond-> {} (letvar1918345 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1918345 ["Message"])))))))

(clojure.core/defn- response-get-sampling-rules-result ([input] (response-get-sampling-rules-result nil input)) ([resultWrapper1918347 input] (clojure.core/let [rawinput1918346 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918348 {"SamplingRuleRecords" (rawinput1918346 "SamplingRuleRecords"), "NextToken" (rawinput1918346 "NextToken")}] (clojure.core/cond-> {} (letvar1918348 "SamplingRuleRecords") (clojure.core/assoc :sampling-rule-records (deser-sampling-rule-record-list (clojure.core/get-in letvar1918348 ["SamplingRuleRecords"]))) (letvar1918348 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918348 ["NextToken"])))))))

(clojure.core/defn- response-update-group-result ([input] (response-update-group-result nil input)) ([resultWrapper1918350 input] (clojure.core/let [rawinput1918349 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918351 {"Group" (rawinput1918349 "Group")}] (clojure.core/cond-> {} (letvar1918351 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1918351 ["Group"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1918353 input] (clojure.core/let [rawinput1918352 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918354 {"Message" (rawinput1918352 "Message")}] (clojure.core/cond-> {} (letvar1918354 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1918354 ["Message"])))))))

(clojure.core/defn- response-get-group-result ([input] (response-get-group-result nil input)) ([resultWrapper1918356 input] (clojure.core/let [rawinput1918355 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918357 {"Group" (rawinput1918355 "Group")}] (clojure.core/cond-> {} (letvar1918357 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1918357 ["Group"])))))))

(clojure.core/defn- response-get-encryption-config-result ([input] (response-get-encryption-config-result nil input)) ([resultWrapper1918359 input] (clojure.core/let [rawinput1918358 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918360 {"EncryptionConfig" (rawinput1918358 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1918360 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1918360 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-telemetry-records-result ([input] (response-put-telemetry-records-result nil input)) ([resultWrapper1918362 input] (clojure.core/let [rawinput1918361 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918363 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-trace-summaries-result ([input] (response-get-trace-summaries-result nil input)) ([resultWrapper1918365 input] (clojure.core/let [rawinput1918364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918366 {"TraceSummaries" (rawinput1918364 "TraceSummaries"), "ApproximateTime" (rawinput1918364 "ApproximateTime"), "TracesProcessedCount" (rawinput1918364 "TracesProcessedCount"), "NextToken" (rawinput1918364 "NextToken")}] (clojure.core/cond-> {} (letvar1918366 "TraceSummaries") (clojure.core/assoc :trace-summaries (deser-trace-summary-list (clojure.core/get-in letvar1918366 ["TraceSummaries"]))) (letvar1918366 "ApproximateTime") (clojure.core/assoc :approximate-time (deser-timestamp (clojure.core/get-in letvar1918366 ["ApproximateTime"]))) (letvar1918366 "TracesProcessedCount") (clojure.core/assoc :traces-processed-count (deser-nullable-long (clojure.core/get-in letvar1918366 ["TracesProcessedCount"]))) (letvar1918366 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918366 ["NextToken"])))))))

(clojure.core/defn- response-update-sampling-rule-result ([input] (response-update-sampling-rule-result nil input)) ([resultWrapper1918368 input] (clojure.core/let [rawinput1918367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918369 {"SamplingRuleRecord" (rawinput1918367 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1918369 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1918369 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-put-encryption-config-result ([input] (response-put-encryption-config-result nil input)) ([resultWrapper1918371 input] (clojure.core/let [rawinput1918370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918372 {"EncryptionConfig" (rawinput1918370 "EncryptionConfig")}] (clojure.core/cond-> {} (letvar1918372 "EncryptionConfig") (clojure.core/assoc :encryption-config (deser-encryption-config (clojure.core/get-in letvar1918372 ["EncryptionConfig"])))))))

(clojure.core/defn- response-put-trace-segments-result ([input] (response-put-trace-segments-result nil input)) ([resultWrapper1918374 input] (clojure.core/let [rawinput1918373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918375 {"UnprocessedTraceSegments" (rawinput1918373 "UnprocessedTraceSegments")}] (clojure.core/cond-> {} (letvar1918375 "UnprocessedTraceSegments") (clojure.core/assoc :unprocessed-trace-segments (deser-unprocessed-trace-segment-list (clojure.core/get-in letvar1918375 ["UnprocessedTraceSegments"])))))))

(clojure.core/defn- response-get-trace-graph-result ([input] (response-get-trace-graph-result nil input)) ([resultWrapper1918377 input] (clojure.core/let [rawinput1918376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918378 {"Services" (rawinput1918376 "Services"), "NextToken" (rawinput1918376 "NextToken")}] (clojure.core/cond-> {} (letvar1918378 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1918378 ["Services"]))) (letvar1918378 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918378 ["NextToken"])))))))

(clojure.core/defn- response-create-group-result ([input] (response-create-group-result nil input)) ([resultWrapper1918380 input] (clojure.core/let [rawinput1918379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918381 {"Group" (rawinput1918379 "Group")}] (clojure.core/cond-> {} (letvar1918381 "Group") (clojure.core/assoc :group (deser-group (clojure.core/get-in letvar1918381 ["Group"])))))))

(clojure.core/defn- response-get-sampling-statistic-summaries-result ([input] (response-get-sampling-statistic-summaries-result nil input)) ([resultWrapper1918383 input] (clojure.core/let [rawinput1918382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918384 {"SamplingStatisticSummaries" (rawinput1918382 "SamplingStatisticSummaries"), "NextToken" (rawinput1918382 "NextToken")}] (clojure.core/cond-> {} (letvar1918384 "SamplingStatisticSummaries") (clojure.core/assoc :sampling-statistic-summaries (deser-sampling-statistic-summary-list (clojure.core/get-in letvar1918384 ["SamplingStatisticSummaries"]))) (letvar1918384 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918384 ["NextToken"])))))))

(clojure.core/defn- response-create-sampling-rule-result ([input] (response-create-sampling-rule-result nil input)) ([resultWrapper1918386 input] (clojure.core/let [rawinput1918385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918387 {"SamplingRuleRecord" (rawinput1918385 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1918387 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1918387 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-sampling-rule-result ([input] (response-delete-sampling-rule-result nil input)) ([resultWrapper1918389 input] (clojure.core/let [rawinput1918388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918390 {"SamplingRuleRecord" (rawinput1918388 "SamplingRuleRecord")}] (clojure.core/cond-> {} (letvar1918390 "SamplingRuleRecord") (clojure.core/assoc :sampling-rule-record (deser-sampling-rule-record (clojure.core/get-in letvar1918390 ["SamplingRuleRecord"])))))))

(clojure.core/defn- response-delete-group-result ([input] (response-delete-group-result nil input)) ([resultWrapper1918392 input] (clojure.core/let [rawinput1918391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918393 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-sampling-targets-result ([input] (response-get-sampling-targets-result nil input)) ([resultWrapper1918395 input] (clojure.core/let [rawinput1918394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918396 {"SamplingTargetDocuments" (rawinput1918394 "SamplingTargetDocuments"), "LastRuleModification" (rawinput1918394 "LastRuleModification"), "UnprocessedStatistics" (rawinput1918394 "UnprocessedStatistics")}] (clojure.core/cond-> {} (letvar1918396 "SamplingTargetDocuments") (clojure.core/assoc :sampling-target-documents (deser-sampling-target-document-list (clojure.core/get-in letvar1918396 ["SamplingTargetDocuments"]))) (letvar1918396 "LastRuleModification") (clojure.core/assoc :last-rule-modification (deser-timestamp (clojure.core/get-in letvar1918396 ["LastRuleModification"]))) (letvar1918396 "UnprocessedStatistics") (clojure.core/assoc :unprocessed-statistics (deser-unprocessed-statistics-list (clojure.core/get-in letvar1918396 ["UnprocessedStatistics"])))))))

(clojure.core/defn- response-get-groups-result ([input] (response-get-groups-result nil input)) ([resultWrapper1918398 input] (clojure.core/let [rawinput1918397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918399 {"Groups" (rawinput1918397 "Groups"), "NextToken" (rawinput1918397 "NextToken")}] (clojure.core/cond-> {} (letvar1918399 "Groups") (clojure.core/assoc :groups (deser-group-summary-list (clojure.core/get-in letvar1918399 ["Groups"]))) (letvar1918399 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918399 ["NextToken"])))))))

(clojure.core/defn- response-get-service-graph-result ([input] (response-get-service-graph-result nil input)) ([resultWrapper1918401 input] (clojure.core/let [rawinput1918400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918402 {"StartTime" (rawinput1918400 "StartTime"), "EndTime" (rawinput1918400 "EndTime"), "Services" (rawinput1918400 "Services"), "ContainsOldGroupVersions" (rawinput1918400 "ContainsOldGroupVersions"), "NextToken" (rawinput1918400 "NextToken")}] (clojure.core/cond-> {} (letvar1918402 "StartTime") (clojure.core/assoc :start-time (deser-timestamp (clojure.core/get-in letvar1918402 ["StartTime"]))) (letvar1918402 "EndTime") (clojure.core/assoc :end-time (deser-timestamp (clojure.core/get-in letvar1918402 ["EndTime"]))) (letvar1918402 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1918402 ["Services"]))) (letvar1918402 "ContainsOldGroupVersions") (clojure.core/assoc :contains-old-group-versions (deser-boolean (clojure.core/get-in letvar1918402 ["ContainsOldGroupVersions"]))) (letvar1918402 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918402 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-traces-result ([input] (response-batch-get-traces-result nil input)) ([resultWrapper1918404 input] (clojure.core/let [rawinput1918403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918405 {"Traces" (rawinput1918403 "Traces"), "UnprocessedTraceIds" (rawinput1918403 "UnprocessedTraceIds"), "NextToken" (rawinput1918403 "NextToken")}] (clojure.core/cond-> {} (letvar1918405 "Traces") (clojure.core/assoc :traces (deser-trace-list (clojure.core/get-in letvar1918405 ["Traces"]))) (letvar1918405 "UnprocessedTraceIds") (clojure.core/assoc :unprocessed-trace-ids (deser-unprocessed-trace-id-list (clojure.core/get-in letvar1918405 ["UnprocessedTraceIds"]))) (letvar1918405 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1918405 ["NextToken"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1918407 input] (clojure.core/let [rawinput1918406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1918408 {"Message" (rawinput1918406 "Message")}] (clojure.core/cond-> {} (letvar1918408 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1918408 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.xray/service-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/rule-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/encryption-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3000))))
...
(clojure.spec.alpha/def :portkey.aws.xray/trace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 35))))
...
(clojure.spec.alpha/def :portkey.aws.xray/group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/hostname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.xray/url-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.xray/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.xray/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.xray/attribute-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.xray/ec-2-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.xray/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 24 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 24))))

(clojure.spec.alpha/def :portkey.aws.xray/service-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/get-groups-next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.xray/group-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 400))))
...
(clojure.spec.alpha/def :portkey.aws.xray/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.xray/segment-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))

(clojure.spec.alpha/def :portkey.aws.xray/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.xray/http-method (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10))))
