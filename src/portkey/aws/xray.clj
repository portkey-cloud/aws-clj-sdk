...
(clojure.core/defn get-service-graph ([get-service-graph-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/ServiceGraph" get-service-graph-request :portkey.aws.xray/get-service-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-service-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
...
(clojure.core/defn get-trace-graph ([get-trace-graph-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceGraph" get-trace-graph-request :portkey.aws.xray/get-trace-graph-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/get-trace-graph-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
...
(clojure.core/defn put-telemetry-records ([put-telemetry-records-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TelemetryRecords" put-telemetry-records-request :portkey.aws.xray/put-telemetry-records-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/put-telemetry-records-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
...
(clojure.core/defn put-trace-segments ([put-trace-segments-request] (portkey.aws/-rest-json-call portkey.aws.xray/endpoints "POST" "/TraceSegments" put-trace-segments-request :portkey.aws.xray/put-trace-segments-request {:payload nil, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.xray/put-trace-segments-result {"InvalidRequestException" :portkey.aws.xray/invalid-request-exception, "ThrottledException" :portkey.aws.xray/throttled-exception})))
