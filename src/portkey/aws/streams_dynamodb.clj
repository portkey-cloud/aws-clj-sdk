...
(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper2099198 input] (clojure.core/let [rawinput2099197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099199 {"StreamDescription" (rawinput2099197 "StreamDescription")}] (clojure.core/cond-> {} (letvar2099199 "StreamDescription") (clojure.core/assoc :stream-description (deser-stream-description (clojure.core/get-in letvar2099199 ["StreamDescription"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2099201 input] (clojure.core/let [rawinput2099200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099202 {"message" (rawinput2099200 "message")}] (clojure.core/cond-> {} (letvar2099202 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2099202 ["message"])))))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper2099204 input] (clojure.core/let [rawinput2099203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099205 {"message" (rawinput2099203 "message")}] (clojure.core/cond-> {} (letvar2099205 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2099205 ["message"])))))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper2099207 input] (clojure.core/let [rawinput2099206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099208 {"Records" (rawinput2099206 "Records"), "NextShardIterator" (rawinput2099206 "NextShardIterator")}] (clojure.core/cond-> {} (letvar2099208 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar2099208 ["Records"]))) (letvar2099208 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2099208 ["NextShardIterator"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2099210 input] (clojure.core/let [rawinput2099209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099211 {"message" (rawinput2099209 "message")}] (clojure.core/cond-> {} (letvar2099211 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2099211 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper2099213 input] (clojure.core/let [rawinput2099212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099214 {"Streams" (rawinput2099212 "Streams"), "LastEvaluatedStreamArn" (rawinput2099212 "LastEvaluatedStreamArn")}] (clojure.core/cond-> {} (letvar2099214 "Streams") (clojure.core/assoc :streams (deser-stream-list (clojure.core/get-in letvar2099214 ["Streams"]))) (letvar2099214 "LastEvaluatedStreamArn") (clojure.core/assoc :last-evaluated-stream-arn (deser-stream-arn (clojure.core/get-in letvar2099214 ["LastEvaluatedStreamArn"])))))))

(clojure.core/defn- response-trimmed-data-access-exception ([input] (response-trimmed-data-access-exception nil input)) ([resultWrapper2099216 input] (clojure.core/let [rawinput2099215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099217 {"message" (rawinput2099215 "message")}] (clojure.core/cond-> {} (letvar2099217 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2099217 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper2099219 input] (clojure.core/let [rawinput2099218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099220 {"ShardIterator" (rawinput2099218 "ShardIterator")}] (clojure.core/cond-> {} (letvar2099220 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2099220 ["ShardIterator"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2099222 input] (clojure.core/let [rawinput2099221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2099223 {"message" (rawinput2099221 "message")}] (clojure.core/cond-> {} (letvar2099223 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2099223 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 65535))))

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/positive-long-object clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 28 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 65))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 21 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 37 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
