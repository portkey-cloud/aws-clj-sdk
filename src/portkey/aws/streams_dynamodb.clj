...
(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper2104380 input] (clojure.core/let [rawinput2104379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104381 {"StreamDescription" (rawinput2104379 "StreamDescription")}] (clojure.core/cond-> {} (letvar2104381 "StreamDescription") (clojure.core/assoc :stream-description (deser-stream-description (clojure.core/get-in letvar2104381 ["StreamDescription"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2104383 input] (clojure.core/let [rawinput2104382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104384 {"message" (rawinput2104382 "message")}] (clojure.core/cond-> {} (letvar2104384 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2104384 ["message"])))))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper2104386 input] (clojure.core/let [rawinput2104385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104387 {"message" (rawinput2104385 "message")}] (clojure.core/cond-> {} (letvar2104387 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2104387 ["message"])))))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper2104389 input] (clojure.core/let [rawinput2104388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104390 {"Records" (rawinput2104388 "Records"), "NextShardIterator" (rawinput2104388 "NextShardIterator")}] (clojure.core/cond-> {} (letvar2104390 "Records") (clojure.core/assoc :records (deser-record-list (clojure.core/get-in letvar2104390 ["Records"]))) (letvar2104390 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2104390 ["NextShardIterator"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2104392 input] (clojure.core/let [rawinput2104391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104393 {"message" (rawinput2104391 "message")}] (clojure.core/cond-> {} (letvar2104393 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2104393 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper2104395 input] (clojure.core/let [rawinput2104394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104396 {"Streams" (rawinput2104394 "Streams"), "LastEvaluatedStreamArn" (rawinput2104394 "LastEvaluatedStreamArn")}] (clojure.core/cond-> {} (letvar2104396 "Streams") (clojure.core/assoc :streams (deser-stream-list (clojure.core/get-in letvar2104396 ["Streams"]))) (letvar2104396 "LastEvaluatedStreamArn") (clojure.core/assoc :last-evaluated-stream-arn (deser-stream-arn (clojure.core/get-in letvar2104396 ["LastEvaluatedStreamArn"])))))))

(clojure.core/defn- response-trimmed-data-access-exception ([input] (response-trimmed-data-access-exception nil input)) ([resultWrapper2104398 input] (clojure.core/let [rawinput2104397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104399 {"message" (rawinput2104397 "message")}] (clojure.core/cond-> {} (letvar2104399 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2104399 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper2104401 input] (clojure.core/let [rawinput2104400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104402 {"ShardIterator" (rawinput2104400 "ShardIterator")}] (clojure.core/cond-> {} (letvar2104402 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar2104402 ["ShardIterator"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2104404 input] (clojure.core/let [rawinput2104403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2104405 {"message" (rawinput2104403 "message")}] (clojure.core/cond-> {} (letvar2104405 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2104405 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 65535))))

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/positive-long-object clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 28 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 65))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 21 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 37 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.streams-dynamodb/key-schema-attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
