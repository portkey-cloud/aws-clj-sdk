...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/service-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:role/.*" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 64)) (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[A-Z][A-Z0-9_]*" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 79))))

(clojure.spec.alpha/def :portkey.aws.opsworkscm/engine-attribute-name (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.opsworkscm/instance-profile-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:instance-profile/.*" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/node-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[\-\p{Alnum}_:.]+$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/time-window-definition (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$" s__27882__auto__))))
