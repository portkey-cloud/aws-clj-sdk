...
(clojure.core/defn- response-disassociate-node-response ([input] (response-disassociate-node-response nil input)) ([resultWrapper1926770 input] (clojure.core/let [rawinput1926769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926771 {"NodeAssociationStatusToken" (rawinput1926769 "NodeAssociationStatusToken")}] (clojure.core/cond-> {} (letvar1926771 "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (clojure.core/get-in letvar1926771 ["NodeAssociationStatusToken"])))))))

(clojure.core/defn- response-create-backup-response ([input] (response-create-backup-response nil input)) ([resultWrapper1926773 input] (clojure.core/let [rawinput1926772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926774 {"Backup" (rawinput1926772 "Backup")}] (clojure.core/cond-> {} (letvar1926774 "Backup") (clojure.core/assoc :backup (deser-backup (clojure.core/get-in letvar1926774 ["Backup"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1926776 input] (clojure.core/let [rawinput1926775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926777 {"Message" (rawinput1926775 "Message")}] (clojure.core/cond-> {} (letvar1926777 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926777 ["Message"])))))))

(clojure.core/defn- response-start-maintenance-response ([input] (response-start-maintenance-response nil input)) ([resultWrapper1926779 input] (clojure.core/let [rawinput1926778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926780 {"Server" (rawinput1926778 "Server")}] (clojure.core/cond-> {} (letvar1926780 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1926780 ["Server"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1926782 input] (clojure.core/let [rawinput1926781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926783 {"Message" (rawinput1926781 "Message")}] (clojure.core/cond-> {} (letvar1926783 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926783 ["Message"])))))))

(clojure.core/defn- response-export-server-engine-attribute-response ([input] (response-export-server-engine-attribute-response nil input)) ([resultWrapper1926785 input] (clojure.core/let [rawinput1926784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926786 {"EngineAttribute" (rawinput1926784 "EngineAttribute"), "ServerName" (rawinput1926784 "ServerName")}] (clojure.core/cond-> {} (letvar1926786 "EngineAttribute") (clojure.core/assoc :engine-attribute (deser-engine-attribute (clojure.core/get-in letvar1926786 ["EngineAttribute"]))) (letvar1926786 "ServerName") (clojure.core/assoc :server-name (deser-server-name (clojure.core/get-in letvar1926786 ["ServerName"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1926788 input] (clojure.core/let [rawinput1926787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926789 {"Message" (rawinput1926787 "Message")}] (clojure.core/cond-> {} (letvar1926789 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926789 ["Message"])))))))

(clojure.core/defn- response-delete-backup-response ([input] (response-delete-backup-response nil input)) ([resultWrapper1926791 input] (clojure.core/let [rawinput1926790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926792 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-restore-server-response ([input] (response-restore-server-response nil input)) ([resultWrapper1926794 input] (clojure.core/let [rawinput1926793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926795 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-server-response ([input] (response-delete-server-response nil input)) ([resultWrapper1926797 input] (clojure.core/let [rawinput1926796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926798 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1926800 input] (clojure.core/let [rawinput1926799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926801 {"Message" (rawinput1926799 "Message")}] (clojure.core/cond-> {} (letvar1926801 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926801 ["Message"])))))))

(clojure.core/defn- response-describe-servers-response ([input] (response-describe-servers-response nil input)) ([resultWrapper1926803 input] (clojure.core/let [rawinput1926802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926804 {"Servers" (rawinput1926802 "Servers"), "NextToken" (rawinput1926802 "NextToken")}] (clojure.core/cond-> {} (letvar1926804 "Servers") (clojure.core/assoc :servers (deser-servers (clojure.core/get-in letvar1926804 ["Servers"]))) (letvar1926804 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1926804 ["NextToken"])))))))

(clojure.core/defn- response-update-server-response ([input] (response-update-server-response nil input)) ([resultWrapper1926806 input] (clojure.core/let [rawinput1926805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926807 {"Server" (rawinput1926805 "Server")}] (clojure.core/cond-> {} (letvar1926807 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1926807 ["Server"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1926809 input] (clojure.core/let [rawinput1926808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926810 {"Message" (rawinput1926808 "Message")}] (clojure.core/cond-> {} (letvar1926810 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926810 ["Message"])))))))

(clojure.core/defn- response-create-server-response ([input] (response-create-server-response nil input)) ([resultWrapper1926812 input] (clojure.core/let [rawinput1926811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926813 {"Server" (rawinput1926811 "Server")}] (clojure.core/cond-> {} (letvar1926813 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1926813 ["Server"])))))))

(clojure.core/defn- response-associate-node-response ([input] (response-associate-node-response nil input)) ([resultWrapper1926815 input] (clojure.core/let [rawinput1926814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926816 {"NodeAssociationStatusToken" (rawinput1926814 "NodeAssociationStatusToken")}] (clojure.core/cond-> {} (letvar1926816 "NodeAssociationStatusToken") (clojure.core/assoc :node-association-status-token (deser-node-association-status-token (clojure.core/get-in letvar1926816 ["NodeAssociationStatusToken"])))))))

(clojure.core/defn- response-update-server-engine-attributes-response ([input] (response-update-server-engine-attributes-response nil input)) ([resultWrapper1926818 input] (clojure.core/let [rawinput1926817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926819 {"Server" (rawinput1926817 "Server")}] (clojure.core/cond-> {} (letvar1926819 "Server") (clojure.core/assoc :server (deser-server (clojure.core/get-in letvar1926819 ["Server"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper1926821 input] (clojure.core/let [rawinput1926820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926822 {"Message" (rawinput1926820 "Message")}] (clojure.core/cond-> {} (letvar1926822 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1926822 ["Message"])))))))

(clojure.core/defn- response-describe-account-attributes-response ([input] (response-describe-account-attributes-response nil input)) ([resultWrapper1926824 input] (clojure.core/let [rawinput1926823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926825 {"Attributes" (rawinput1926823 "Attributes")}] (clojure.core/cond-> {} (letvar1926825 "Attributes") (clojure.core/assoc :attributes (deser-account-attributes (clojure.core/get-in letvar1926825 ["Attributes"])))))))

(clojure.core/defn- response-describe-backups-response ([input] (response-describe-backups-response nil input)) ([resultWrapper1926827 input] (clojure.core/let [rawinput1926826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926828 {"Backups" (rawinput1926826 "Backups"), "NextToken" (rawinput1926826 "NextToken")}] (clojure.core/cond-> {} (letvar1926828 "Backups") (clojure.core/assoc :backups (deser-backups (clojure.core/get-in letvar1926828 ["Backups"]))) (letvar1926828 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1926828 ["NextToken"])))))))

(clojure.core/defn- response-describe-events-response ([input] (response-describe-events-response nil input)) ([resultWrapper1926830 input] (clojure.core/let [rawinput1926829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926831 {"ServerEvents" (rawinput1926829 "ServerEvents"), "NextToken" (rawinput1926829 "NextToken")}] (clojure.core/cond-> {} (letvar1926831 "ServerEvents") (clojure.core/assoc :server-events (deser-server-events (clojure.core/get-in letvar1926831 ["ServerEvents"]))) (letvar1926831 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1926831 ["NextToken"])))))))

(clojure.core/defn- response-describe-node-association-status-response ([input] (response-describe-node-association-status-response nil input)) ([resultWrapper1926833 input] (clojure.core/let [rawinput1926832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1926834 {"NodeAssociationStatus" (rawinput1926832 "NodeAssociationStatus"), "EngineAttributes" (rawinput1926832 "EngineAttributes")}] (clojure.core/cond-> {} (letvar1926834 "NodeAssociationStatus") (clojure.core/assoc :node-association-status (deser-node-association-status (clojure.core/get-in letvar1926834 ["NodeAssociationStatus"]))) (letvar1926834 "EngineAttributes") (clojure.core/assoc :engine-attributes (deser-engine-attributes (clojure.core/get-in letvar1926834 ["EngineAttributes"])))))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/service-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:role/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Z][A-Z0-9_]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/backup-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 79))))

(clojure.spec.alpha/def :portkey.aws.opsworkscm/engine-attribute-name (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.opsworkscm/instance-profile-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:iam::[0-9]{12}:instance-profile/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/node-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[\-\p{Alnum}_:.]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.opsworkscm/time-window-definition (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$" s__1410940__auto__))))
