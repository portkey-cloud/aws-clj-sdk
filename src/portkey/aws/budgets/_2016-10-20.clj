...
(clojure.core/defn- response-create-budget-response ([input] (response-create-budget-response nil input)) ([resultWrapper1523752 input] (clojure.core/let [rawinput1523751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523753 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-creation-limit-exceeded-exception ([input] (response-creation-limit-exceeded-exception nil input)) ([resultWrapper1523755 input] (clojure.core/let [rawinput1523754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523756 {"Message" (rawinput1523754 "Message")}] (clojure.core/cond-> {} (letvar1523756 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523756 ["Message"])))))))

(clojure.core/defn- response-describe-budget-performance-history-response ([input] (response-describe-budget-performance-history-response nil input)) ([resultWrapper1523758 input] (clojure.core/let [rawinput1523757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523759 {"BudgetPerformanceHistory" (rawinput1523757 "BudgetPerformanceHistory"), "NextToken" (rawinput1523757 "NextToken")}] (clojure.core/cond-> {} (letvar1523759 "BudgetPerformanceHistory") (clojure.core/assoc :budget-performance-history (deser-budget-performance-history (clojure.core/get-in letvar1523759 ["BudgetPerformanceHistory"]))) (letvar1523759 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1523759 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribers-for-notification-response ([input] (response-describe-subscribers-for-notification-response nil input)) ([resultWrapper1523761 input] (clojure.core/let [rawinput1523760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523762 {"Subscribers" (rawinput1523760 "Subscribers"), "NextToken" (rawinput1523760 "NextToken")}] (clojure.core/cond-> {} (letvar1523762 "Subscribers") (clojure.core/assoc :subscribers (deser-subscribers (clojure.core/get-in letvar1523762 ["Subscribers"]))) (letvar1523762 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1523762 ["NextToken"])))))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1523764 input] (clojure.core/let [rawinput1523763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523765 {"Message" (rawinput1523763 "Message")}] (clojure.core/cond-> {} (letvar1523765 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523765 ["Message"])))))))

(clojure.core/defn- response-delete-subscriber-response ([input] (response-delete-subscriber-response nil input)) ([resultWrapper1523767 input] (clojure.core/let [rawinput1523766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523768 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-notification-response ([input] (response-update-notification-response nil input)) ([resultWrapper1523770 input] (clojure.core/let [rawinput1523769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523771 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-budget-response ([input] (response-delete-budget-response nil input)) ([resultWrapper1523773 input] (clojure.core/let [rawinput1523772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523774 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1523776 input] (clojure.core/let [rawinput1523775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523777 {"Message" (rawinput1523775 "Message")}] (clojure.core/cond-> {} (letvar1523777 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523777 ["Message"])))))))

(clojure.core/defn- response-describe-budgets-response ([input] (response-describe-budgets-response nil input)) ([resultWrapper1523779 input] (clojure.core/let [rawinput1523778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523780 {"Budgets" (rawinput1523778 "Budgets"), "NextToken" (rawinput1523778 "NextToken")}] (clojure.core/cond-> {} (letvar1523780 "Budgets") (clojure.core/assoc :budgets (deser-budgets (clojure.core/get-in letvar1523780 ["Budgets"]))) (letvar1523780 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1523780 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1523782 input] (clojure.core/let [rawinput1523781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523783 {"Message" (rawinput1523781 "Message")}] (clojure.core/cond-> {} (letvar1523783 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523783 ["Message"])))))))

(clojure.core/defn- response-update-budget-response ([input] (response-update-budget-response nil input)) ([resultWrapper1523785 input] (clojure.core/let [rawinput1523784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523786 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-duplicate-record-exception ([input] (response-duplicate-record-exception nil input)) ([resultWrapper1523788 input] (clojure.core/let [rawinput1523787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523789 {"Message" (rawinput1523787 "Message")}] (clojure.core/cond-> {} (letvar1523789 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523789 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1523791 input] (clojure.core/let [rawinput1523790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523792 {"Message" (rawinput1523790 "Message")}] (clojure.core/cond-> {} (letvar1523792 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523792 ["Message"])))))))

(clojure.core/defn- response-create-notification-response ([input] (response-create-notification-response nil input)) ([resultWrapper1523794 input] (clojure.core/let [rawinput1523793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523795 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-budget-response ([input] (response-describe-budget-response nil input)) ([resultWrapper1523797 input] (clojure.core/let [rawinput1523796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523798 {"Budget" (rawinput1523796 "Budget")}] (clojure.core/cond-> {} (letvar1523798 "Budget") (clojure.core/assoc :budget (deser-budget (clojure.core/get-in letvar1523798 ["Budget"])))))))

(clojure.core/defn- response-delete-notification-response ([input] (response-delete-notification-response nil input)) ([resultWrapper1523800 input] (clojure.core/let [rawinput1523799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523801 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subscriber-response ([input] (response-update-subscriber-response nil input)) ([resultWrapper1523803 input] (clojure.core/let [rawinput1523802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523804 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1523806 input] (clojure.core/let [rawinput1523805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523807 {"Message" (rawinput1523805 "Message")}] (clojure.core/cond-> {} (letvar1523807 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1523807 ["Message"])))))))

(clojure.core/defn- response-create-subscriber-response ([input] (response-create-subscriber-response nil input)) ([resultWrapper1523809 input] (clojure.core/let [rawinput1523808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523810 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-notifications-for-budget-response ([input] (response-describe-notifications-for-budget-response nil input)) ([resultWrapper1523812 input] (clojure.core/let [rawinput1523811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1523813 {"Notifications" (rawinput1523811 "Notifications"), "NextToken" (rawinput1523811 "NextToken")}] (clojure.core/cond-> {} (letvar1523813 "Notifications") (clojure.core/assoc :notifications (deser-notifications (clojure.core/get-in letvar1523813 ["Notifications"]))) (letvar1523813 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1523813 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2147483647)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[^:\\]+" s__1467903__auto__))))
