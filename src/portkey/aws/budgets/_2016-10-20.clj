...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__31194__auto__] (clojure.core/<= 1 (clojure.core/count s__31194__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__31194__auto__] (clojure.core/<= 1 (clojure.core/count s__31194__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__31194__auto__] (clojure.core/<= 12 (clojure.core/count s__31194__auto__))) (clojure.core/fn [s__31195__auto__] (clojure.core/< (clojure.core/count s__31195__auto__) 12))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__31196__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__31196__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__31195__auto__] (clojure.core/< (clojure.core/count s__31195__auto__) 100)) (clojure.core/fn [s__31196__auto__] (clojure.core/re-matches #"[^:\\]+" s__31196__auto__))))
