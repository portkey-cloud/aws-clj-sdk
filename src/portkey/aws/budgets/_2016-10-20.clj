...
(clojure.core/defn- deser-budget [input] (clojure.core/cond-> {:budget-name (deser-budget-name (input "BudgetName")), :time-unit (deser-time-unit (input "TimeUnit")), :budget-type (deser-budget-type (input "BudgetType"))} (clojure.core/contains? input "BudgetLimit") (clojure.core/assoc :budget-limit (deser-spend (input "BudgetLimit"))) (clojure.core/contains? input "CostFilters") (clojure.core/assoc :cost-filters (deser-cost-filters (input "CostFilters"))) (clojure.core/contains? input "CostTypes") (clojure.core/assoc :cost-types (deser-cost-types (input "CostTypes"))) (clojure.core/contains? input "TimePeriod") (clojure.core/assoc :time-period (deser-time-period (input "TimePeriod"))) (clojure.core/contains? input "CalculatedSpend") (clojure.core/assoc :calculated-spend (deser-calculated-spend (input "CalculatedSpend")))))
...
(clojure.core/defn- deser-create-budget-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-creation-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (desererror-message (input "Message")))))

(clojure.core/defn- deser-describe-subscribers-for-notification-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Subscribers") (clojure.core/assoc :subscribers (deser-subscribers (input "Subscribers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))

(clojure.core/defn- deser-expired-next-token-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (desererror-message (input "Message")))))

(clojure.core/defn- deser-delete-subscriber-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-notification-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-budget-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-next-token-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (desererror-message (input "Message")))))

(clojure.core/defn- deser-describe-budgets-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Budgets") (clojure.core/assoc :budgets (deser-budgets (input "Budgets"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))
...
(clojure.core/defn- deser-update-budget-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-duplicate-record-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (desererror-message (input "Message")))))

(clojure.core/defn- deser-not-found-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (desererror-message (input "Message")))))

(clojure.core/defn- deser-create-notification-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-budget-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Budget") (clojure.core/assoc :budget (deser-budget (input "Budget")))))

(clojure.core/defn- deser-delete-notification-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-subscriber-response [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-create-subscriber-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-notifications-for-budget-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Notifications") (clojure.core/assoc :notifications (deser-notifications (input "Notifications"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-generic-string (input "NextToken")))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 12 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 12))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 100)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[^:\\]+" s__27881__auto__))))
...
(clojure.core/defn describe-budget ([describe-budget-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-budget-request describe-budget-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.budgets.-2016-10-20/endpoints, :http.request.configuration/target-prefix "AWSBudgetServiceGateway", :http.request.spec/output-spec :portkey.aws.budgets.-2016-10-20/describe-budget-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-20", :http.request.configuration/service-id "Budgets", :http.request.spec/input-spec :portkey.aws.budgets.-2016-10-20/describe-budget-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeBudget", :http.request.configuration/output-deser-fn deser-describe-budget-response, :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.budgets.-2016-10-20/internal-error-exception, "InvalidParameterException" :portkey.aws.budgets.-2016-10-20/invalid-parameter-exception, "NotFoundException" :portkey.aws.budgets.-2016-10-20/not-found-exception}})))))
...
(clojure.core/defn describe-budgets ([describe-budgets-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-budgets-request describe-budgets-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.budgets.-2016-10-20/endpoints, :http.request.configuration/target-prefix "AWSBudgetServiceGateway", :http.request.spec/output-spec :portkey.aws.budgets.-2016-10-20/describe-budgets-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-20", :http.request.configuration/service-id "Budgets", :http.request.spec/input-spec :portkey.aws.budgets.-2016-10-20/describe-budgets-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeBudgets", :http.request.configuration/output-deser-fn deser-describe-budgets-response, :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.budgets.-2016-10-20/internal-error-exception, "InvalidParameterException" :portkey.aws.budgets.-2016-10-20/invalid-parameter-exception, "NotFoundException" :portkey.aws.budgets.-2016-10-20/not-found-exception, "InvalidNextTokenException" :portkey.aws.budgets.-2016-10-20/invalid-next-token-exception, "ExpiredNextTokenException" :portkey.aws.budgets.-2016-10-20/expired-next-token-exception}})))))
...
(clojure.core/defn describe-subscribers-for-notification ([describe-subscribers-for-notification-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-subscribers-for-notification-request describe-subscribers-for-notification-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.budgets.-2016-10-20/endpoints, :http.request.configuration/target-prefix "AWSBudgetServiceGateway", :http.request.spec/output-spec :portkey.aws.budgets.-2016-10-20/describe-subscribers-for-notification-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-10-20", :http.request.configuration/service-id "Budgets", :http.request.spec/input-spec :portkey.aws.budgets.-2016-10-20/describe-subscribers-for-notification-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeSubscribersForNotification", :http.request.configuration/output-deser-fn deser-describe-subscribers-for-notification-response, :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.budgets.-2016-10-20/internal-error-exception, "NotFoundException" :portkey.aws.budgets.-2016-10-20/not-found-exception, "InvalidParameterException" :portkey.aws.budgets.-2016-10-20/invalid-parameter-exception, "InvalidNextTokenException" :portkey.aws.budgets.-2016-10-20/invalid-next-token-exception, "ExpiredNextTokenException" :portkey.aws.budgets.-2016-10-20/expired-next-token-exception}})))))
