...
(clojure.core/defn- response-create-budget-response ([input] (response-create-budget-response nil input)) ([resultWrapper1466554 input] (clojure.core/let [rawinput1466553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466555 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-creation-limit-exceeded-exception ([input] (response-creation-limit-exceeded-exception nil input)) ([resultWrapper1466557 input] (clojure.core/let [rawinput1466556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466558 {"Message" (rawinput1466556 "Message")}] (clojure.core/cond-> {} (letvar1466558 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466558 ["Message"])))))))

(clojure.core/defn- response-describe-budget-performance-history-response ([input] (response-describe-budget-performance-history-response nil input)) ([resultWrapper1466560 input] (clojure.core/let [rawinput1466559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466561 {"BudgetPerformanceHistory" (rawinput1466559 "BudgetPerformanceHistory"), "NextToken" (rawinput1466559 "NextToken")}] (clojure.core/cond-> {} (letvar1466561 "BudgetPerformanceHistory") (clojure.core/assoc :budget-performance-history (deser-budget-performance-history (clojure.core/get-in letvar1466561 ["BudgetPerformanceHistory"]))) (letvar1466561 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1466561 ["NextToken"])))))))

(clojure.core/defn- response-describe-subscribers-for-notification-response ([input] (response-describe-subscribers-for-notification-response nil input)) ([resultWrapper1466563 input] (clojure.core/let [rawinput1466562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466564 {"Subscribers" (rawinput1466562 "Subscribers"), "NextToken" (rawinput1466562 "NextToken")}] (clojure.core/cond-> {} (letvar1466564 "Subscribers") (clojure.core/assoc :subscribers (deser-subscribers (clojure.core/get-in letvar1466564 ["Subscribers"]))) (letvar1466564 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1466564 ["NextToken"])))))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1466566 input] (clojure.core/let [rawinput1466565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466567 {"Message" (rawinput1466565 "Message")}] (clojure.core/cond-> {} (letvar1466567 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466567 ["Message"])))))))

(clojure.core/defn- response-delete-subscriber-response ([input] (response-delete-subscriber-response nil input)) ([resultWrapper1466569 input] (clojure.core/let [rawinput1466568 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466570 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-notification-response ([input] (response-update-notification-response nil input)) ([resultWrapper1466572 input] (clojure.core/let [rawinput1466571 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466573 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-budget-response ([input] (response-delete-budget-response nil input)) ([resultWrapper1466575 input] (clojure.core/let [rawinput1466574 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466576 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1466578 input] (clojure.core/let [rawinput1466577 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466579 {"Message" (rawinput1466577 "Message")}] (clojure.core/cond-> {} (letvar1466579 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466579 ["Message"])))))))

(clojure.core/defn- response-describe-budgets-response ([input] (response-describe-budgets-response nil input)) ([resultWrapper1466581 input] (clojure.core/let [rawinput1466580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466582 {"Budgets" (rawinput1466580 "Budgets"), "NextToken" (rawinput1466580 "NextToken")}] (clojure.core/cond-> {} (letvar1466582 "Budgets") (clojure.core/assoc :budgets (deser-budgets (clojure.core/get-in letvar1466582 ["Budgets"]))) (letvar1466582 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1466582 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1466584 input] (clojure.core/let [rawinput1466583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466585 {"Message" (rawinput1466583 "Message")}] (clojure.core/cond-> {} (letvar1466585 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466585 ["Message"])))))))

(clojure.core/defn- response-update-budget-response ([input] (response-update-budget-response nil input)) ([resultWrapper1466587 input] (clojure.core/let [rawinput1466586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466588 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-duplicate-record-exception ([input] (response-duplicate-record-exception nil input)) ([resultWrapper1466590 input] (clojure.core/let [rawinput1466589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466591 {"Message" (rawinput1466589 "Message")}] (clojure.core/cond-> {} (letvar1466591 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466591 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1466593 input] (clojure.core/let [rawinput1466592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466594 {"Message" (rawinput1466592 "Message")}] (clojure.core/cond-> {} (letvar1466594 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466594 ["Message"])))))))

(clojure.core/defn- response-create-notification-response ([input] (response-create-notification-response nil input)) ([resultWrapper1466596 input] (clojure.core/let [rawinput1466595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466597 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-budget-response ([input] (response-describe-budget-response nil input)) ([resultWrapper1466599 input] (clojure.core/let [rawinput1466598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466600 {"Budget" (rawinput1466598 "Budget")}] (clojure.core/cond-> {} (letvar1466600 "Budget") (clojure.core/assoc :budget (deser-budget (clojure.core/get-in letvar1466600 ["Budget"])))))))

(clojure.core/defn- response-delete-notification-response ([input] (response-delete-notification-response nil input)) ([resultWrapper1466602 input] (clojure.core/let [rawinput1466601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466603 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-subscriber-response ([input] (response-update-subscriber-response nil input)) ([resultWrapper1466605 input] (clojure.core/let [rawinput1466604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466606 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1466608 input] (clojure.core/let [rawinput1466607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466609 {"Message" (rawinput1466607 "Message")}] (clojure.core/cond-> {} (letvar1466609 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1466609 ["Message"])))))))

(clojure.core/defn- response-create-subscriber-response ([input] (response-create-subscriber-response nil input)) ([resultWrapper1466611 input] (clojure.core/let [rawinput1466610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466612 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-notifications-for-budget-response ([input] (response-describe-notifications-for-budget-response nil input)) ([resultWrapper1466614 input] (clojure.core/let [rawinput1466613 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1466615 {"Notifications" (rawinput1466613 "Notifications"), "NextToken" (rawinput1466613 "NextToken")}] (clojure.core/cond-> {} (letvar1466615 "Notifications") (clojure.core/assoc :notifications (deser-notifications (clojure.core/get-in letvar1466615 ["Notifications"]))) (letvar1466615 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1466615 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/unit-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/subscriber-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/generic-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #".*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 12)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\d{12}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/numeric-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2147483647)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"([0-9]*\.)?[0-9]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.budgets.-2016-10-20/budget-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:\\]+" s__1410940__auto__))))
