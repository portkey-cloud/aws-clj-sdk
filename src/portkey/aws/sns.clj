...
(clojure.core/defn list-topics ([] (list-topics {})) ([list-topics-inputinput] (clojure.core/let [request-function-result__195099__auto__ (req-list-topics-input list-topics-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__195099__auto__ {:http.request.configuration/endpoints portkey.aws.sns/endpoints, :http.request.spec/output-spec :portkey.aws.sns/list-topics-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2010-03-31", :http.request.configuration/service-id "SNS", :http.request.spec/input-spec :portkey.aws.sns/list-topics-input, :http.request.configuration/protocol "query", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListTopics", :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.sns/invalid-parameter-exception, "InternalErrorException" :portkey.aws.sns/internal-error-exception, "AuthorizationErrorException" :portkey.aws.sns/authorization-error-exception}})))))
...
(clojure.core/defn list-phone-numbers-opted-out ([] (list-phone-numbers-opted-out {})) ([list-phone-numbers-opted-out-inputinput] (clojure.core/let [request-function-result__195099__auto__ (req-list-phone-numbers-opted-out-input list-phone-numbers-opted-out-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__195099__auto__ {:http.request.configuration/endpoints portkey.aws.sns/endpoints, :http.request.spec/output-spec :portkey.aws.sns/list-phone-numbers-opted-out-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2010-03-31", :http.request.configuration/service-id "SNS", :http.request.spec/input-spec :portkey.aws.sns/list-phone-numbers-opted-out-input, :http.request.configuration/protocol "query", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListPhoneNumbersOptedOut", :http.request.spec/error-spec {"ThrottledException" :portkey.aws.sns/throttled-exception, "InternalErrorException" :portkey.aws.sns/internal-error-exception, "AuthorizationErrorException" :portkey.aws.sns/authorization-error-exception, "InvalidParameterException" :portkey.aws.sns/invalid-parameter-exception}})))))
