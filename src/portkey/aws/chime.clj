...
(clojure.core/defn- response-logout-user-response ([input] (response-logout-user-response nil input)) ([resultWrapper164455 input] (clojure.core/let [rawinput164454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164456 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper164458 input] (clojure.core/let [rawinput164457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164459 {"Code" (rawinput164457 "Code"), "Message" (rawinput164457 "Message")}] (clojure.core/cond-> {} (letvar164459 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164459 ["Code"]))) (letvar164459 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164459 ["Message"])))))))

(clojure.core/defn- response-delete-account-response ([input] (response-delete-account-response nil input)) ([resultWrapper164461 input] (clojure.core/let [rawinput164460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164462 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-account-settings-response ([input] (response-update-account-settings-response nil input)) ([resultWrapper164464 input] (clojure.core/let [rawinput164463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164465 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper164467 input] (clojure.core/let [rawinput164466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164468 {"Code" (rawinput164466 "Code"), "Message" (rawinput164466 "Message")}] (clojure.core/cond-> {} (letvar164468 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164468 ["Code"]))) (letvar164468 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164468 ["Message"])))))))

(clojure.core/defn- response-update-account-response ([input] (response-update-account-response nil input)) ([resultWrapper164470 input] (clojure.core/let [rawinput164469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164471 {"Account" (rawinput164469 "Account")}] (clojure.core/cond-> {} (letvar164471 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar164471 ["Account"])))))))

(clojure.core/defn- response-unprocessable-entity-exception ([input] (response-unprocessable-entity-exception nil input)) ([resultWrapper164473 input] (clojure.core/let [rawinput164472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164474 {"Code" (rawinput164472 "Code"), "Message" (rawinput164472 "Message")}] (clojure.core/cond-> {} (letvar164474 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164474 ["Code"]))) (letvar164474 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164474 ["Message"])))))))

(clojure.core/defn- response-get-account-response ([input] (response-get-account-response nil input)) ([resultWrapper164476 input] (clojure.core/let [rawinput164475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164477 {"Account" (rawinput164475 "Account")}] (clojure.core/cond-> {} (letvar164477 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar164477 ["Account"])))))))

(clojure.core/defn- response-service-failure-exception ([input] (response-service-failure-exception nil input)) ([resultWrapper164479 input] (clojure.core/let [rawinput164478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164480 {"Code" (rawinput164478 "Code"), "Message" (rawinput164478 "Message")}] (clojure.core/cond-> {} (letvar164480 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164480 ["Code"]))) (letvar164480 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164480 ["Message"])))))))

(clojure.core/defn- response-list-accounts-response ([input] (response-list-accounts-response nil input)) ([resultWrapper164482 input] (clojure.core/let [rawinput164481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164483 {"Accounts" (rawinput164481 "Accounts"), "NextToken" (rawinput164481 "NextToken")}] (clojure.core/cond-> {} (letvar164483 "Accounts") (clojure.core/assoc :accounts (deser-account-list (clojure.core/get-in letvar164483 ["Accounts"]))) (letvar164483 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar164483 ["NextToken"])))))))

(clojure.core/defn- response-batch-unsuspend-user-response ([input] (response-batch-unsuspend-user-response nil input)) ([resultWrapper164485 input] (clojure.core/let [rawinput164484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164486 {"UserErrors" (rawinput164484 "UserErrors")}] (clojure.core/cond-> {} (letvar164486 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar164486 ["UserErrors"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper164488 input] (clojure.core/let [rawinput164487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164489 {"Code" (rawinput164487 "Code"), "Message" (rawinput164487 "Message")}] (clojure.core/cond-> {} (letvar164489 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164489 ["Code"]))) (letvar164489 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164489 ["Message"])))))))

(clojure.core/defn- response-update-user-response ([input] (response-update-user-response nil input)) ([resultWrapper164491 input] (clojure.core/let [rawinput164490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164492 {"User" (rawinput164490 "User")}] (clojure.core/cond-> {} (letvar164492 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar164492 ["User"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper164494 input] (clojure.core/let [rawinput164493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164495 {"AccountSettings" (rawinput164493 "AccountSettings")}] (clojure.core/cond-> {} (letvar164495 "AccountSettings") (clojure.core/assoc :account-settings (deser-account-settings (clojure.core/get-in letvar164495 ["AccountSettings"])))))))

(clojure.core/defn- response-create-account-response ([input] (response-create-account-response nil input)) ([resultWrapper164497 input] (clojure.core/let [rawinput164496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164498 {"Account" (rawinput164496 "Account")}] (clojure.core/cond-> {} (letvar164498 "Account") (clojure.core/assoc :account (deser-account (clojure.core/get-in letvar164498 ["Account"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper164500 input] (clojure.core/let [rawinput164499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164501 {"Code" (rawinput164499 "Code"), "Message" (rawinput164499 "Message")}] (clojure.core/cond-> {} (letvar164501 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164501 ["Code"]))) (letvar164501 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164501 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper164503 input] (clojure.core/let [rawinput164502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164504 {"Code" (rawinput164502 "Code"), "Message" (rawinput164502 "Message")}] (clojure.core/cond-> {} (letvar164504 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164504 ["Code"]))) (letvar164504 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164504 ["Message"])))))))

(clojure.core/defn- response-unauthorized-client-exception ([input] (response-unauthorized-client-exception nil input)) ([resultWrapper164506 input] (clojure.core/let [rawinput164505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164507 {"Code" (rawinput164505 "Code"), "Message" (rawinput164505 "Message")}] (clojure.core/cond-> {} (letvar164507 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164507 ["Code"]))) (letvar164507 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164507 ["Message"])))))))

(clojure.core/defn- response-batch-suspend-user-response ([input] (response-batch-suspend-user-response nil input)) ([resultWrapper164509 input] (clojure.core/let [rawinput164508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164510 {"UserErrors" (rawinput164508 "UserErrors")}] (clojure.core/cond-> {} (letvar164510 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar164510 ["UserErrors"])))))))

(clojure.core/defn- response-invite-users-response ([input] (response-invite-users-response nil input)) ([resultWrapper164512 input] (clojure.core/let [rawinput164511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164513 {"Invites" (rawinput164511 "Invites")}] (clojure.core/cond-> {} (letvar164513 "Invites") (clojure.core/assoc :invites (deser-invite-list (clojure.core/get-in letvar164513 ["Invites"])))))))

(clojure.core/defn- response-reset-personal-pin-response ([input] (response-reset-personal-pin-response nil input)) ([resultWrapper164515 input] (clojure.core/let [rawinput164514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164516 {"User" (rawinput164514 "User")}] (clojure.core/cond-> {} (letvar164516 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar164516 ["User"])))))))

(clojure.core/defn- response-throttled-client-exception ([input] (response-throttled-client-exception nil input)) ([resultWrapper164518 input] (clojure.core/let [rawinput164517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164519 {"Code" (rawinput164517 "Code"), "Message" (rawinput164517 "Message")}] (clojure.core/cond-> {} (letvar164519 "Code") (clojure.core/assoc :code (deser-error-code (clojure.core/get-in letvar164519 ["Code"]))) (letvar164519 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar164519 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper164521 input] (clojure.core/let [rawinput164520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164522 {"Users" (rawinput164520 "Users"), "NextToken" (rawinput164520 "NextToken")}] (clojure.core/cond-> {} (letvar164522 "Users") (clojure.core/assoc :users (deser-user-list (clojure.core/get-in letvar164522 ["Users"]))) (letvar164522 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar164522 ["NextToken"])))))))

(clojure.core/defn- response-batch-update-user-response ([input] (response-batch-update-user-response nil input)) ([resultWrapper164524 input] (clojure.core/let [rawinput164523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164525 {"UserErrors" (rawinput164523 "UserErrors")}] (clojure.core/cond-> {} (letvar164525 "UserErrors") (clojure.core/assoc :user-errors (deser-user-error-list (clojure.core/get-in letvar164525 ["UserErrors"])))))))

(clojure.core/defn- response-get-user-response ([input] (response-get-user-response nil input)) ([resultWrapper164527 input] (clojure.core/let [rawinput164526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar164528 {"User" (rawinput164526 "User")}] (clojure.core/cond-> {} (letvar164528 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar164528 ["User"])))))))
...
(clojure.spec.alpha/def :portkey.aws.chime/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.chime/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.chime/email-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".+@.+\..+" s__21078__auto__))))
