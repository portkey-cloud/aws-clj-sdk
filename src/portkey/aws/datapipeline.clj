...
(clojure.core/defn- response-set-task-status-output ([input] (response-set-task-status-output nil input)) ([resultWrapper1647236 input] (clojure.core/let [rawinput1647235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647237 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1647239 input] (clojure.core/let [rawinput1647238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647240 {"message" (rawinput1647238 "message")}] (clojure.core/cond-> {} (letvar1647240 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1647240 ["message"])))))))

(clojure.core/defn- response-validate-pipeline-definition-output ([input] (response-validate-pipeline-definition-output nil input)) ([resultWrapper1647242 input] (clojure.core/let [rawinput1647241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647243 {"validationErrors" (rawinput1647241 "validationErrors"), "validationWarnings" (rawinput1647241 "validationWarnings"), "errored" (rawinput1647241 "errored")}] (clojure.core/cond-> {:errored (deserboolean (clojure.core/get-in letvar1647243 ["errored"]))} (letvar1647243 "validationErrors") (clojure.core/assoc :validation-errors (deser-validation-errors (clojure.core/get-in letvar1647243 ["validationErrors"]))) (letvar1647243 "validationWarnings") (clojure.core/assoc :validation-warnings (deser-validation-warnings (clojure.core/get-in letvar1647243 ["validationWarnings"])))))))

(clojure.core/defn- response-activate-pipeline-output ([input] (response-activate-pipeline-output nil input)) ([resultWrapper1647245 input] (clojure.core/let [rawinput1647244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647246 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1647248 input] (clojure.core/let [rawinput1647247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647249 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1647251 input] (clojure.core/let [rawinput1647250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647252 {"message" (rawinput1647250 "message")}] (clojure.core/cond-> {} (letvar1647252 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1647252 ["message"])))))))

(clojure.core/defn- response-pipeline-not-found-exception ([input] (response-pipeline-not-found-exception nil input)) ([resultWrapper1647254 input] (clojure.core/let [rawinput1647253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647255 {"message" (rawinput1647253 "message")}] (clojure.core/cond-> {} (letvar1647255 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1647255 ["message"])))))))

(clojure.core/defn- response-deactivate-pipeline-output ([input] (response-deactivate-pipeline-output nil input)) ([resultWrapper1647257 input] (clojure.core/let [rawinput1647256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647258 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-objects-output ([input] (response-describe-objects-output nil input)) ([resultWrapper1647260 input] (clojure.core/let [rawinput1647259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647261 {"pipelineObjects" (rawinput1647259 "pipelineObjects"), "marker" (rawinput1647259 "marker"), "hasMoreResults" (rawinput1647259 "hasMoreResults")}] (clojure.core/cond-> {:pipeline-objects (deser-pipeline-object-list (clojure.core/get-in letvar1647261 ["pipelineObjects"]))} (letvar1647261 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1647261 ["marker"]))) (letvar1647261 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1647261 ["hasMoreResults"])))))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1647263 input] (clojure.core/let [rawinput1647262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647264 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-pipelines-output ([input] (response-list-pipelines-output nil input)) ([resultWrapper1647266 input] (clojure.core/let [rawinput1647265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647267 {"pipelineIdList" (rawinput1647265 "pipelineIdList"), "marker" (rawinput1647265 "marker"), "hasMoreResults" (rawinput1647265 "hasMoreResults")}] (clojure.core/cond-> {:pipeline-id-list (deserpipeline-list (clojure.core/get-in letvar1647267 ["pipelineIdList"]))} (letvar1647267 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1647267 ["marker"]))) (letvar1647267 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1647267 ["hasMoreResults"])))))))

(clojure.core/defn- response-evaluate-expression-output ([input] (response-evaluate-expression-output nil input)) ([resultWrapper1647269 input] (clojure.core/let [rawinput1647268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647270 {"evaluatedExpression" (rawinput1647268 "evaluatedExpression")}] (clojure.core/cond-> {:evaluated-expression (deserlong-string (clojure.core/get-in letvar1647270 ["evaluatedExpression"]))}))))

(clojure.core/defn- response-report-task-progress-output ([input] (response-report-task-progress-output nil input)) ([resultWrapper1647272 input] (clojure.core/let [rawinput1647271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647273 {"canceled" (rawinput1647271 "canceled")}] (clojure.core/cond-> {:canceled (deserboolean (clojure.core/get-in letvar1647273 ["canceled"]))}))))

(clojure.core/defn- response-create-pipeline-output ([input] (response-create-pipeline-output nil input)) ([resultWrapper1647275 input] (clojure.core/let [rawinput1647274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647276 {"pipelineId" (rawinput1647274 "pipelineId")}] (clojure.core/cond-> {:pipeline-id (deserid (clojure.core/get-in letvar1647276 ["pipelineId"]))}))))

(clojure.core/defn- response-task-not-found-exception ([input] (response-task-not-found-exception nil input)) ([resultWrapper1647278 input] (clojure.core/let [rawinput1647277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647279 {"message" (rawinput1647277 "message")}] (clojure.core/cond-> {} (letvar1647279 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1647279 ["message"])))))))

(clojure.core/defn- response-put-pipeline-definition-output ([input] (response-put-pipeline-definition-output nil input)) ([resultWrapper1647281 input] (clojure.core/let [rawinput1647280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647282 {"validationErrors" (rawinput1647280 "validationErrors"), "validationWarnings" (rawinput1647280 "validationWarnings"), "errored" (rawinput1647280 "errored")}] (clojure.core/cond-> {:errored (deserboolean (clojure.core/get-in letvar1647282 ["errored"]))} (letvar1647282 "validationErrors") (clojure.core/assoc :validation-errors (deser-validation-errors (clojure.core/get-in letvar1647282 ["validationErrors"]))) (letvar1647282 "validationWarnings") (clojure.core/assoc :validation-warnings (deser-validation-warnings (clojure.core/get-in letvar1647282 ["validationWarnings"])))))))

(clojure.core/defn- response-poll-for-task-output ([input] (response-poll-for-task-output nil input)) ([resultWrapper1647284 input] (clojure.core/let [rawinput1647283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647285 {"taskObject" (rawinput1647283 "taskObject")}] (clojure.core/cond-> {} (letvar1647285 "taskObject") (clojure.core/assoc :task-object (deser-task-object (clojure.core/get-in letvar1647285 ["taskObject"])))))))

(clojure.core/defn- response-describe-pipelines-output ([input] (response-describe-pipelines-output nil input)) ([resultWrapper1647287 input] (clojure.core/let [rawinput1647286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647288 {"pipelineDescriptionList" (rawinput1647286 "pipelineDescriptionList")}] (clojure.core/cond-> {:pipeline-description-list (deser-pipeline-description-list (clojure.core/get-in letvar1647288 ["pipelineDescriptionList"]))}))))

(clojure.core/defn- response-get-pipeline-definition-output ([input] (response-get-pipeline-definition-output nil input)) ([resultWrapper1647290 input] (clojure.core/let [rawinput1647289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647291 {"pipelineObjects" (rawinput1647289 "pipelineObjects"), "parameterObjects" (rawinput1647289 "parameterObjects"), "parameterValues" (rawinput1647289 "parameterValues")}] (clojure.core/cond-> {} (letvar1647291 "pipelineObjects") (clojure.core/assoc :pipeline-objects (deser-pipeline-object-list (clojure.core/get-in letvar1647291 ["pipelineObjects"]))) (letvar1647291 "parameterObjects") (clojure.core/assoc :parameter-objects (deser-parameter-object-list (clojure.core/get-in letvar1647291 ["parameterObjects"]))) (letvar1647291 "parameterValues") (clojure.core/assoc :parameter-values (deser-parameter-value-list (clojure.core/get-in letvar1647291 ["parameterValues"])))))))

(clojure.core/defn- response-query-objects-output ([input] (response-query-objects-output nil input)) ([resultWrapper1647293 input] (clojure.core/let [rawinput1647292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647294 {"ids" (rawinput1647292 "ids"), "marker" (rawinput1647292 "marker"), "hasMoreResults" (rawinput1647292 "hasMoreResults")}] (clojure.core/cond-> {} (letvar1647294 "ids") (clojure.core/assoc :ids (deserid-list (clojure.core/get-in letvar1647294 ["ids"]))) (letvar1647294 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1647294 ["marker"]))) (letvar1647294 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1647294 ["hasMoreResults"])))))))

(clojure.core/defn- response-pipeline-deleted-exception ([input] (response-pipeline-deleted-exception nil input)) ([resultWrapper1647296 input] (clojure.core/let [rawinput1647295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647297 {"message" (rawinput1647295 "message")}] (clojure.core/cond-> {} (letvar1647297 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1647297 ["message"])))))))

(clojure.core/defn- response-report-task-runner-heartbeat-output ([input] (response-report-task-runner-heartbeat-output nil input)) ([resultWrapper1647299 input] (clojure.core/let [rawinput1647298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1647300 {"terminate" (rawinput1647298 "terminate")}] (clojure.core/cond-> {:terminate (deserboolean (clojure.core/get-in letvar1647300 ["terminate"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/attribute-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/field-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/attribute-value-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10240)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/field-string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10240)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
