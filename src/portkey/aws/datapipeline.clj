...
(clojure.core/defn- response-set-task-status-output ([input] (response-set-task-status-output nil input)) ([resultWrapper1603698 input] (clojure.core/let [rawinput1603697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603699 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1603701 input] (clojure.core/let [rawinput1603700 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603702 {"message" (rawinput1603700 "message")}] (clojure.core/cond-> {} (letvar1603702 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1603702 ["message"])))))))

(clojure.core/defn- response-validate-pipeline-definition-output ([input] (response-validate-pipeline-definition-output nil input)) ([resultWrapper1603704 input] (clojure.core/let [rawinput1603703 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603705 {"validationErrors" (rawinput1603703 "validationErrors"), "validationWarnings" (rawinput1603703 "validationWarnings"), "errored" (rawinput1603703 "errored")}] (clojure.core/cond-> {:errored (deserboolean (clojure.core/get-in letvar1603705 ["errored"]))} (letvar1603705 "validationErrors") (clojure.core/assoc :validation-errors (deser-validation-errors (clojure.core/get-in letvar1603705 ["validationErrors"]))) (letvar1603705 "validationWarnings") (clojure.core/assoc :validation-warnings (deser-validation-warnings (clojure.core/get-in letvar1603705 ["validationWarnings"])))))))

(clojure.core/defn- response-activate-pipeline-output ([input] (response-activate-pipeline-output nil input)) ([resultWrapper1603707 input] (clojure.core/let [rawinput1603706 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603708 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1603710 input] (clojure.core/let [rawinput1603709 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603711 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1603713 input] (clojure.core/let [rawinput1603712 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603714 {"message" (rawinput1603712 "message")}] (clojure.core/cond-> {} (letvar1603714 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1603714 ["message"])))))))

(clojure.core/defn- response-pipeline-not-found-exception ([input] (response-pipeline-not-found-exception nil input)) ([resultWrapper1603716 input] (clojure.core/let [rawinput1603715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603717 {"message" (rawinput1603715 "message")}] (clojure.core/cond-> {} (letvar1603717 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1603717 ["message"])))))))

(clojure.core/defn- response-deactivate-pipeline-output ([input] (response-deactivate-pipeline-output nil input)) ([resultWrapper1603719 input] (clojure.core/let [rawinput1603718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603720 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-objects-output ([input] (response-describe-objects-output nil input)) ([resultWrapper1603722 input] (clojure.core/let [rawinput1603721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603723 {"pipelineObjects" (rawinput1603721 "pipelineObjects"), "marker" (rawinput1603721 "marker"), "hasMoreResults" (rawinput1603721 "hasMoreResults")}] (clojure.core/cond-> {:pipeline-objects (deser-pipeline-object-list (clojure.core/get-in letvar1603723 ["pipelineObjects"]))} (letvar1603723 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1603723 ["marker"]))) (letvar1603723 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1603723 ["hasMoreResults"])))))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1603725 input] (clojure.core/let [rawinput1603724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603726 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-pipelines-output ([input] (response-list-pipelines-output nil input)) ([resultWrapper1603728 input] (clojure.core/let [rawinput1603727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603729 {"pipelineIdList" (rawinput1603727 "pipelineIdList"), "marker" (rawinput1603727 "marker"), "hasMoreResults" (rawinput1603727 "hasMoreResults")}] (clojure.core/cond-> {:pipeline-id-list (deserpipeline-list (clojure.core/get-in letvar1603729 ["pipelineIdList"]))} (letvar1603729 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1603729 ["marker"]))) (letvar1603729 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1603729 ["hasMoreResults"])))))))

(clojure.core/defn- response-evaluate-expression-output ([input] (response-evaluate-expression-output nil input)) ([resultWrapper1603731 input] (clojure.core/let [rawinput1603730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603732 {"evaluatedExpression" (rawinput1603730 "evaluatedExpression")}] (clojure.core/cond-> {:evaluated-expression (deserlong-string (clojure.core/get-in letvar1603732 ["evaluatedExpression"]))}))))

(clojure.core/defn- response-report-task-progress-output ([input] (response-report-task-progress-output nil input)) ([resultWrapper1603734 input] (clojure.core/let [rawinput1603733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603735 {"canceled" (rawinput1603733 "canceled")}] (clojure.core/cond-> {:canceled (deserboolean (clojure.core/get-in letvar1603735 ["canceled"]))}))))

(clojure.core/defn- response-create-pipeline-output ([input] (response-create-pipeline-output nil input)) ([resultWrapper1603737 input] (clojure.core/let [rawinput1603736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603738 {"pipelineId" (rawinput1603736 "pipelineId")}] (clojure.core/cond-> {:pipeline-id (deserid (clojure.core/get-in letvar1603738 ["pipelineId"]))}))))

(clojure.core/defn- response-task-not-found-exception ([input] (response-task-not-found-exception nil input)) ([resultWrapper1603740 input] (clojure.core/let [rawinput1603739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603741 {"message" (rawinput1603739 "message")}] (clojure.core/cond-> {} (letvar1603741 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1603741 ["message"])))))))

(clojure.core/defn- response-put-pipeline-definition-output ([input] (response-put-pipeline-definition-output nil input)) ([resultWrapper1603743 input] (clojure.core/let [rawinput1603742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603744 {"validationErrors" (rawinput1603742 "validationErrors"), "validationWarnings" (rawinput1603742 "validationWarnings"), "errored" (rawinput1603742 "errored")}] (clojure.core/cond-> {:errored (deserboolean (clojure.core/get-in letvar1603744 ["errored"]))} (letvar1603744 "validationErrors") (clojure.core/assoc :validation-errors (deser-validation-errors (clojure.core/get-in letvar1603744 ["validationErrors"]))) (letvar1603744 "validationWarnings") (clojure.core/assoc :validation-warnings (deser-validation-warnings (clojure.core/get-in letvar1603744 ["validationWarnings"])))))))

(clojure.core/defn- response-poll-for-task-output ([input] (response-poll-for-task-output nil input)) ([resultWrapper1603746 input] (clojure.core/let [rawinput1603745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603747 {"taskObject" (rawinput1603745 "taskObject")}] (clojure.core/cond-> {} (letvar1603747 "taskObject") (clojure.core/assoc :task-object (deser-task-object (clojure.core/get-in letvar1603747 ["taskObject"])))))))

(clojure.core/defn- response-describe-pipelines-output ([input] (response-describe-pipelines-output nil input)) ([resultWrapper1603749 input] (clojure.core/let [rawinput1603748 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603750 {"pipelineDescriptionList" (rawinput1603748 "pipelineDescriptionList")}] (clojure.core/cond-> {:pipeline-description-list (deser-pipeline-description-list (clojure.core/get-in letvar1603750 ["pipelineDescriptionList"]))}))))

(clojure.core/defn- response-get-pipeline-definition-output ([input] (response-get-pipeline-definition-output nil input)) ([resultWrapper1603752 input] (clojure.core/let [rawinput1603751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603753 {"pipelineObjects" (rawinput1603751 "pipelineObjects"), "parameterObjects" (rawinput1603751 "parameterObjects"), "parameterValues" (rawinput1603751 "parameterValues")}] (clojure.core/cond-> {} (letvar1603753 "pipelineObjects") (clojure.core/assoc :pipeline-objects (deser-pipeline-object-list (clojure.core/get-in letvar1603753 ["pipelineObjects"]))) (letvar1603753 "parameterObjects") (clojure.core/assoc :parameter-objects (deser-parameter-object-list (clojure.core/get-in letvar1603753 ["parameterObjects"]))) (letvar1603753 "parameterValues") (clojure.core/assoc :parameter-values (deser-parameter-value-list (clojure.core/get-in letvar1603753 ["parameterValues"])))))))

(clojure.core/defn- response-query-objects-output ([input] (response-query-objects-output nil input)) ([resultWrapper1603755 input] (clojure.core/let [rawinput1603754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603756 {"ids" (rawinput1603754 "ids"), "marker" (rawinput1603754 "marker"), "hasMoreResults" (rawinput1603754 "hasMoreResults")}] (clojure.core/cond-> {} (letvar1603756 "ids") (clojure.core/assoc :ids (deserid-list (clojure.core/get-in letvar1603756 ["ids"]))) (letvar1603756 "marker") (clojure.core/assoc :marker (deserstring (clojure.core/get-in letvar1603756 ["marker"]))) (letvar1603756 "hasMoreResults") (clojure.core/assoc :has-more-results (deserboolean (clojure.core/get-in letvar1603756 ["hasMoreResults"])))))))

(clojure.core/defn- response-pipeline-deleted-exception ([input] (response-pipeline-deleted-exception nil input)) ([resultWrapper1603758 input] (clojure.core/let [rawinput1603757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603759 {"message" (rawinput1603757 "message")}] (clojure.core/cond-> {} (letvar1603759 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1603759 ["message"])))))))

(clojure.core/defn- response-report-task-runner-heartbeat-output ([input] (response-report-task-runner-heartbeat-output nil input)) ([resultWrapper1603761 input] (clojure.core/let [rawinput1603760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1603762 {"terminate" (rawinput1603760 "terminate")}] (clojure.core/cond-> {:terminate (deserboolean (clojure.core/get-in letvar1603762 ["terminate"]))}))))

(clojure.spec.alpha/def :portkey.aws.datapipeline/long-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20971520)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/attribute-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/field-name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/task-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/attribute-value-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.datapipeline/field-string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
