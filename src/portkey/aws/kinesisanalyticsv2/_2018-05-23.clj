(ns portkey.aws.kinesisanalyticsv2.-2018-05-23 (:require [portkey.aws]))
...
(clojure.core/defn- response-add-application-input-response ([input] (response-add-application-input-response nil input)) ([resultWrapper1859619 input] (clojure.core/let [rawinput1859618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859620 {"ApplicationARN" (rawinput1859618 "ApplicationARN"), "ApplicationVersionId" (rawinput1859618 "ApplicationVersionId"), "InputDescriptions" (rawinput1859618 "InputDescriptions")}] (clojure.core/cond-> {} (letvar1859620 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859620 ["ApplicationARN"]))) (letvar1859620 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859620 ["ApplicationVersionId"]))) (letvar1859620 "InputDescriptions") (clojure.core/assoc :input-descriptions (deser-input-descriptions (clojure.core/get-in letvar1859620 ["InputDescriptions"])))))))

(clojure.core/defn- response-stop-application-response ([input] (response-stop-application-response nil input)) ([resultWrapper1859622 input] (clojure.core/let [rawinput1859621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859623 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-application-reference-data-source-response ([input] (response-add-application-reference-data-source-response nil input)) ([resultWrapper1859625 input] (clojure.core/let [rawinput1859624 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859626 {"ApplicationARN" (rawinput1859624 "ApplicationARN"), "ApplicationVersionId" (rawinput1859624 "ApplicationVersionId"), "ReferenceDataSourceDescriptions" (rawinput1859624 "ReferenceDataSourceDescriptions")}] (clojure.core/cond-> {} (letvar1859626 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859626 ["ApplicationARN"]))) (letvar1859626 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859626 ["ApplicationVersionId"]))) (letvar1859626 "ReferenceDataSourceDescriptions") (clojure.core/assoc :reference-data-source-descriptions (deser-reference-data-source-descriptions (clojure.core/get-in letvar1859626 ["ReferenceDataSourceDescriptions"])))))))

(clojure.core/defn- response-code-validation-exception ([input] (response-code-validation-exception nil input)) ([resultWrapper1859628 input] (clojure.core/let [rawinput1859627 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859629 {"Message" (rawinput1859627 "Message")}] (clojure.core/cond-> {} (letvar1859629 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859629 ["Message"])))))))

(clojure.core/defn- response-discover-input-schema-response ([input] (response-discover-input-schema-response nil input)) ([resultWrapper1859631 input] (clojure.core/let [rawinput1859630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859632 {"InputSchema" (rawinput1859630 "InputSchema"), "ParsedInputRecords" (rawinput1859630 "ParsedInputRecords"), "ProcessedInputRecords" (rawinput1859630 "ProcessedInputRecords"), "RawInputRecords" (rawinput1859630 "RawInputRecords")}] (clojure.core/cond-> {} (letvar1859632 "InputSchema") (clojure.core/assoc :input-schema (deser-source-schema (clojure.core/get-in letvar1859632 ["InputSchema"]))) (letvar1859632 "ParsedInputRecords") (clojure.core/assoc :parsed-input-records (deser-parsed-input-records (clojure.core/get-in letvar1859632 ["ParsedInputRecords"]))) (letvar1859632 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1859632 ["ProcessedInputRecords"]))) (letvar1859632 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1859632 ["RawInputRecords"])))))))

(clojure.core/defn- response-unable-to-detect-schema-exception ([input] (response-unable-to-detect-schema-exception nil input)) ([resultWrapper1859634 input] (clojure.core/let [rawinput1859633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859635 {"Message" (rawinput1859633 "Message"), "RawInputRecords" (rawinput1859633 "RawInputRecords"), "ProcessedInputRecords" (rawinput1859633 "ProcessedInputRecords")}] (clojure.core/cond-> {} (letvar1859635 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859635 ["Message"]))) (letvar1859635 "RawInputRecords") (clojure.core/assoc :raw-input-records (deser-raw-input-records (clojure.core/get-in letvar1859635 ["RawInputRecords"]))) (letvar1859635 "ProcessedInputRecords") (clojure.core/assoc :processed-input-records (deser-processed-input-records (clojure.core/get-in letvar1859635 ["ProcessedInputRecords"])))))))

(clojure.core/defn- response-delete-application-output-response ([input] (response-delete-application-output-response nil input)) ([resultWrapper1859637 input] (clojure.core/let [rawinput1859636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859638 {"ApplicationARN" (rawinput1859636 "ApplicationARN"), "ApplicationVersionId" (rawinput1859636 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1859638 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859638 ["ApplicationARN"]))) (letvar1859638 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859638 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1859640 input] (clojure.core/let [rawinput1859639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859641 {"Message" (rawinput1859639 "Message")}] (clojure.core/cond-> {} (letvar1859641 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859641 ["Message"])))))))

(clojure.core/defn- response-describe-application-response ([input] (response-describe-application-response nil input)) ([resultWrapper1859643 input] (clojure.core/let [rawinput1859642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859644 {"ApplicationDetail" (rawinput1859642 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1859644 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-delete-application-reference-data-source-response ([input] (response-delete-application-reference-data-source-response nil input)) ([resultWrapper1859646 input] (clojure.core/let [rawinput1859645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859647 {"ApplicationARN" (rawinput1859645 "ApplicationARN"), "ApplicationVersionId" (rawinput1859645 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1859647 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859647 ["ApplicationARN"]))) (letvar1859647 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859647 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1859649 input] (clojure.core/let [rawinput1859648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859650 {"Message" (rawinput1859648 "Message")}] (clojure.core/cond-> {} (letvar1859650 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859650 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1859652 input] (clojure.core/let [rawinput1859651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859653 {"Message" (rawinput1859651 "Message")}] (clojure.core/cond-> {} (letvar1859653 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859653 ["Message"])))))))

(clojure.core/defn- response-update-application-response ([input] (response-update-application-response nil input)) ([resultWrapper1859655 input] (clojure.core/let [rawinput1859654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859656 {"ApplicationDetail" (rawinput1859654 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1859656 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1859658 input] (clojure.core/let [rawinput1859657 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859659 {"Message" (rawinput1859657 "Message")}] (clojure.core/cond-> {} (letvar1859659 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859659 ["Message"])))))))

(clojure.core/defn- response-delete-application-snapshot-response ([input] (response-delete-application-snapshot-response nil input)) ([resultWrapper1859661 input] (clojure.core/let [rawinput1859660 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859662 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-application-snapshot-response ([input] (response-describe-application-snapshot-response nil input)) ([resultWrapper1859664 input] (clojure.core/let [rawinput1859663 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859665 {"SnapshotDetails" (rawinput1859663 "SnapshotDetails")}] (clojure.core/cond-> {:snapshot-details (deser-snapshot-details (clojure.core/get-in letvar1859665 ["SnapshotDetails"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1859667 input] (clojure.core/let [rawinput1859666 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859668 {"Message" (rawinput1859666 "Message")}] (clojure.core/cond-> {} (letvar1859668 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859668 ["Message"])))))))

(clojure.core/defn- response-create-application-snapshot-response ([input] (response-create-application-snapshot-response nil input)) ([resultWrapper1859670 input] (clojure.core/let [rawinput1859669 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859671 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1859673 input] (clojure.core/let [rawinput1859672 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859674 {"Message" (rawinput1859672 "Message")}] (clojure.core/cond-> {} (letvar1859674 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859674 ["Message"])))))))

(clojure.core/defn- response-add-application-input-processing-configuration-response ([input] (response-add-application-input-processing-configuration-response nil input)) ([resultWrapper1859676 input] (clojure.core/let [rawinput1859675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859677 {"ApplicationARN" (rawinput1859675 "ApplicationARN"), "ApplicationVersionId" (rawinput1859675 "ApplicationVersionId"), "InputId" (rawinput1859675 "InputId"), "InputProcessingConfigurationDescription" (rawinput1859675 "InputProcessingConfigurationDescription")}] (clojure.core/cond-> {} (letvar1859677 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859677 ["ApplicationARN"]))) (letvar1859677 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859677 ["ApplicationVersionId"]))) (letvar1859677 "InputId") (clojure.core/assoc :input-id (deser-id (clojure.core/get-in letvar1859677 ["InputId"]))) (letvar1859677 "InputProcessingConfigurationDescription") (clojure.core/assoc :input-processing-configuration-description (deser-input-processing-configuration-description (clojure.core/get-in letvar1859677 ["InputProcessingConfigurationDescription"])))))))

(clojure.core/defn- response-list-application-snapshots-response ([input] (response-list-application-snapshots-response nil input)) ([resultWrapper1859679 input] (clojure.core/let [rawinput1859678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859680 {"SnapshotSummaries" (rawinput1859678 "SnapshotSummaries"), "NextToken" (rawinput1859678 "NextToken")}] (clojure.core/cond-> {} (letvar1859680 "SnapshotSummaries") (clojure.core/assoc :snapshot-summaries (deser-snapshot-summaries (clojure.core/get-in letvar1859680 ["SnapshotSummaries"]))) (letvar1859680 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1859680 ["NextToken"])))))))

(clojure.core/defn- response-delete-application-input-processing-configuration-response ([input] (response-delete-application-input-processing-configuration-response nil input)) ([resultWrapper1859682 input] (clojure.core/let [rawinput1859681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859683 {"ApplicationARN" (rawinput1859681 "ApplicationARN"), "ApplicationVersionId" (rawinput1859681 "ApplicationVersionId")}] (clojure.core/cond-> {} (letvar1859683 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859683 ["ApplicationARN"]))) (letvar1859683 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859683 ["ApplicationVersionId"])))))))

(clojure.core/defn- response-resource-provisioned-throughput-exceeded-exception ([input] (response-resource-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1859685 input] (clojure.core/let [rawinput1859684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859686 {"Message" (rawinput1859684 "Message")}] (clojure.core/cond-> {} (letvar1859686 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859686 ["Message"])))))))

(clojure.core/defn- response-add-application-output-response ([input] (response-add-application-output-response nil input)) ([resultWrapper1859688 input] (clojure.core/let [rawinput1859687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859689 {"ApplicationARN" (rawinput1859687 "ApplicationARN"), "ApplicationVersionId" (rawinput1859687 "ApplicationVersionId"), "OutputDescriptions" (rawinput1859687 "OutputDescriptions")}] (clojure.core/cond-> {} (letvar1859689 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859689 ["ApplicationARN"]))) (letvar1859689 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859689 ["ApplicationVersionId"]))) (letvar1859689 "OutputDescriptions") (clojure.core/assoc :output-descriptions (deser-output-descriptions (clojure.core/get-in letvar1859689 ["OutputDescriptions"])))))))

(clojure.core/defn- response-create-application-response ([input] (response-create-application-response nil input)) ([resultWrapper1859691 input] (clojure.core/let [rawinput1859690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859692 {"ApplicationDetail" (rawinput1859690 "ApplicationDetail")}] (clojure.core/cond-> {:application-detail (deser-application-detail (clojure.core/get-in letvar1859692 ["ApplicationDetail"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1859694 input] (clojure.core/let [rawinput1859693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859695 {"Message" (rawinput1859693 "Message")}] (clojure.core/cond-> {} (letvar1859695 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859695 ["Message"])))))))

(clojure.core/defn- response-add-application-cloud-watch-logging-option-response ([input] (response-add-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1859697 input] (clojure.core/let [rawinput1859696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859698 {"ApplicationARN" (rawinput1859696 "ApplicationARN"), "ApplicationVersionId" (rawinput1859696 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1859696 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1859698 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859698 ["ApplicationARN"]))) (letvar1859698 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859698 ["ApplicationVersionId"]))) (letvar1859698 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1859698 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-start-application-response ([input] (response-start-application-response nil input)) ([resultWrapper1859700 input] (clojure.core/let [rawinput1859699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859701 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-application-response ([input] (response-delete-application-response nil input)) ([resultWrapper1859703 input] (clojure.core/let [rawinput1859702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859704 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1859706 input] (clojure.core/let [rawinput1859705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859707 {"Message" (rawinput1859705 "Message")}] (clojure.core/cond-> {} (letvar1859707 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859707 ["Message"])))))))

(clojure.core/defn- response-delete-application-cloud-watch-logging-option-response ([input] (response-delete-application-cloud-watch-logging-option-response nil input)) ([resultWrapper1859709 input] (clojure.core/let [rawinput1859708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859710 {"ApplicationARN" (rawinput1859708 "ApplicationARN"), "ApplicationVersionId" (rawinput1859708 "ApplicationVersionId"), "CloudWatchLoggingOptionDescriptions" (rawinput1859708 "CloudWatchLoggingOptionDescriptions")}] (clojure.core/cond-> {} (letvar1859710 "ApplicationARN") (clojure.core/assoc :application-arn (deser-resource-arn (clojure.core/get-in letvar1859710 ["ApplicationARN"]))) (letvar1859710 "ApplicationVersionId") (clojure.core/assoc :application-version-id (deser-application-version-id (clojure.core/get-in letvar1859710 ["ApplicationVersionId"]))) (letvar1859710 "CloudWatchLoggingOptionDescriptions") (clojure.core/assoc :cloud-watch-logging-option-descriptions (deser-cloud-watch-logging-option-descriptions (clojure.core/get-in letvar1859710 ["CloudWatchLoggingOptionDescriptions"])))))))

(clojure.core/defn- response-list-applications-response ([input] (response-list-applications-response nil input)) ([resultWrapper1859712 input] (clojure.core/let [rawinput1859711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859713 {"ApplicationSummaries" (rawinput1859711 "ApplicationSummaries"), "NextToken" (rawinput1859711 "NextToken")}] (clojure.core/cond-> {:application-summaries (deser-application-summaries (clojure.core/get-in letvar1859713 ["ApplicationSummaries"]))} (letvar1859713 "NextToken") (clojure.core/assoc :next-token (deser-application-name (clojure.core/get-in letvar1859713 ["NextToken"])))))))

(clojure.core/defn- response-invalid-application-configuration-exception ([input] (response-invalid-application-configuration-exception nil input)) ([resultWrapper1859715 input] (clojure.core/let [rawinput1859714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1859716 {"Message" (rawinput1859714 "Message")}] (clojure.core/cond-> {} (letvar1859716 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1859716 ["Message"])))))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-reference-data-source-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-reference-data-source-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.code-validation-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-validation-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.code-validation-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.discover-input-schema-response/input-schema (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.discover-input-schema-response/input-schema :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-records :portkey.aws.kinesisanalyticsv2.-2018-05-23/processed-input-records :portkey.aws.kinesisanalyticsv2.-2018-05-23/raw-input-records]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-description/cloud-watch-logging-option-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/log-stream-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-description/cloud-watch-logging-option-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-request/reference-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-request/reference-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/text-content :portkey.aws.kinesisanalyticsv2.-2018-05-23/zip-file-content :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-content-location]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/create-timestamp (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/service-execution-role (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/last-update-timestamp (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-detail (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/runtime-environment :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-status :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/create-timestamp :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/service-execution-role :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-detail/last-update-timestamp :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-descriptions :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/log-stream-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.unable-to-detect-schema-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/unable-to-detect-schema-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.unable-to-detect-schema-exception/message :portkey.aws.kinesisanalyticsv2.-2018-05-23/raw-input-records :portkey.aws.kinesisanalyticsv2.-2018-05-23/processed-input-records]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-application-code-location-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/object-version]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.list-application-snapshots-request/limit (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-snapshots-input-limit))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.list-application-snapshots-request/limit :portkey.aws.kinesisanalyticsv2.-2018-05-23/next-token]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-firehose-input-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-firehose-input-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-streams-output-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-streams-output-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-summaries (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-summary))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-updates :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-updates :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-updates]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-request-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-request-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-map (clojure.spec.alpha/map-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-key :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-value))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-request/output-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-output-request/output-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism (clojure.spec.alpha/int-in 1 Long/MAX_VALUE))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-output-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-output-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/output] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.create-application-request/service-execution-role (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/runtime-environment :portkey.aws.kinesisanalyticsv2.-2018-05-23.create-application-request/service-execution-role] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-options]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-records (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-record))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/name-prefix (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/input-schema (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/input-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-names :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/name-prefix :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input-description :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-description/input-schema :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input-description]))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-update/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-update/name-prefix-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-update/input-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-update/name-prefix-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-schema-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-mapping (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-code-configuration-update/code-content-type-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-type))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-code-configuration-update/code-content-type-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/mapping-parameters]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-descriptions (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-description))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/text-content :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-md-5 :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-size :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-application-code-location-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-level #{:warn "WARN" :debug "ERROR" "DEBUG" :info :error "INFO"})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-description/output-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-description/name (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.output-description/output-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-description/name :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/destination-schema]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-record (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-record-field))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/monitoring-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-descriptions (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-description))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-md-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 128 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/monitoring-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/job-plan-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-description/current-parallelism (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-description/auto-scaling-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-per-kpu :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-description/current-parallelism :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-description/auto-scaling-enabled]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-response (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-detail] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-sources (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-update/cloud-watch-logging-option-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-update/log-stream-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-stream-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-update/cloud-watch-logging-option-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.cloud-watch-logging-option-update/log-stream-arn-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-parallelism-update/count-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism-count))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-parallelism-update/count-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-configuration]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-run-configurations (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-run-configuration))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source/table-name (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-table-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source/reference-schema (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source/table-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source/reference-schema] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-cloud-watch-logging-option-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-cloud-watch-logging-option-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-reference-data-source-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/csv-mapping-parameters (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-row-delimiter :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-delimiter] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.discover-input-schema-request/service-execution-role (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.discover-input-schema-request/service-execution-role] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-in-use-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-in-use-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/bucket-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/file-key-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/object-version-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/object-version))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-content-location-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/bucket-arn-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/file-key-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-content-location-update/object-version-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.limit-exceeded-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/limit-exceeded-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.limit-exceeded-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-parallelism/count (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism-count))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-parallelism/count]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.monitoring-configuration-update/configuration-type-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.monitoring-configuration-update/metrics-level-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/metrics-level))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.monitoring-configuration-update/log-level-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-level))
...
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-summary/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-summary (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-summary/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-status :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/runtime-environment] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/inputs :portkey.aws.kinesisanalyticsv2.-2018-05-23/outputs :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-sources]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-response (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-detail] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-names (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-snapshot-request/snapshot-creation-timestamp (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-snapshot-request/snapshot-creation-timestamp] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z_][a-zA-Z0-9_]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-row-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/monitoring-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type :portkey.aws.kinesisanalyticsv2.-2018-05-23/metrics-level :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-level]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism-count (clojure.spec.alpha/int-in 1 64))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.service-unavailable-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/service-unavailable-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.service-unavailable-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/destination-schema (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format-type] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/outputs (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/output))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.environment-property-descriptions/property-group-descriptions (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-groups))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-property-descriptions (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.environment-property-descriptions/property-group-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-properties (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/property-groups] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-request/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-request/input-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/processed-input-records (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/processed-input-record))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration-description :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-property-descriptions :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/json-mapping-parameters (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-row-path] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-description/checkpointing-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-description/checkpointing-enabled :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-interval :portkey.aws.kinesisanalyticsv2.-2018-05-23/min-pause-between-checkpoints]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/configuration-type-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/parallelism-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/parallelism-per-kpu-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-per-kpu))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/auto-scaling-enabled-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/configuration-type-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/parallelism-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/parallelism-per-kpu-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration-update/auto-scaling-enabled-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-options (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/name (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/mapping (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-mapping))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/sql-type (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-sql-type))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/name :portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/sql-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.record-column/mapping]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-lambda-processor-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-lambda-processor-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/min-pause-between-checkpoints clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-run-configurations :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-configuration]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-status #{:ready :creating "READY" :deleting "DELETING" "CREATING" "FAILED" :failed})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-interval clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-content-location (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/object-version]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-description/reference-role-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-description/reference-role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-encoding (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"UTF-8" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.property-group/property-group-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-group (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.property-group/property-group-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-map] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-status #{:ready :starting "UPDATING" "READY" :deleting :running :stopping "STARTING" "DELETING" :updating "STOPPING" "RUNNING"})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-response (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-details] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-not-found-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-not-found-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/reference-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/table-name-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-table-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/reference-schema-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/reference-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/table-name-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-update/reference-schema-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.unsupported-operation-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/unsupported-operation-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.unsupported-operation-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/inputs (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/input))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-response/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-response/input-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/zip-file-content clojure.core/bytes?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/processed-input-record (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-input-limit (clojure.spec.alpha/int-in 1 50))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-streams-input-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-streams-input-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input/name-prefix (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input/input-schema (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input/name-prefix :portkey.aws.kinesisanalyticsv2.-2018-05-23.input/input-schema] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-parallelism]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.run-configuration-description/application-restore-configuration-description (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-configuration))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.run-configuration-description/application-restore-configuration-description]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.code-content-update/text-content-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/text-content))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.code-content-update/zip-file-content-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/zip-file-content))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.code-content-update/text-content-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.code-content-update/zip-file-content-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-content-location-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration-update/snapshots-enabled-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration-update/snapshots-enabled-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration-description (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-descriptions :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-descriptions :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.snapshot-details/snapshot-creation-timestamp (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-details (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-status :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.snapshot-details/snapshot-creation-timestamp]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-summaries :portkey.aws.kinesisanalyticsv2.-2018-05-23/next-token]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-descriptions (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-description))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-input-processing-configuration-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-provisioned-throughput-exceeded-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-provisioned-throughput-exceeded-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.resource-provisioned-throughput-exceeded-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-request/limit (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-input-limit))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-request/next-token (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-request/limit :portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-request/next-token]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/configuration-type-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/checkpointing-enabled-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/checkpoint-interval-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-interval))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/min-pause-between-checkpoints-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/min-pause-between-checkpoints))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/configuration-type-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/checkpointing-enabled-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/checkpoint-interval-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration-update/min-pause-between-checkpoints-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-output-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-output-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column-sql-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-updates (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-update))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/runtime-environment #{:sql-1-0 "FLINK-1_6" "SQL-1_0" :flink-1-6})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-response (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-detail] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-update/bucket-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-update/file-key-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/file-key))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-update/bucket-arn-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.s-3-reference-data-source-update/file-key-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-argument-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-argument-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/output-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/name-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/destination-schema-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/destination-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/output-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/name-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.output-update/destination-schema-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-cloud-watch-logging-option-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-cloud-watch-logging-option-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.sql-run-configuration/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-run-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.sql-run-configuration/input-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position-configuration] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration/snapshots-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration/snapshots-enabled] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-size clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-reference-data-source-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-reference-data-source-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parsed-input-record-field (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/mapping-parameters (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/json-mapping-parameters :portkey.aws.kinesisanalyticsv2.-2018-05-23/csv-mapping-parameters]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-restore-type #{:skip-restore-from-snapshot :restore-from-custom-snapshot "SKIP_RESTORE_FROM_SNAPSHOT" "RESTORE_FROM_CUSTOM_SNAPSHOT" "RESTORE_FROM_LATEST_SNAPSHOT" :restore-from-latest-snapshot})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-request/create-timestamp (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-request/create-timestamp] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-request/cloud-watch-logging-option-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-request/cloud-watch-logging-option-id] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/timestamp clojure.core/inst?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/monitoring-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/metrics-level :portkey.aws.kinesisanalyticsv2.-2018-05-23/log-level]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-descriptions (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-description))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-request/input-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-request/current-application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.add-application-input-processing-configuration-request/input-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z][a-zA-Z0-9_]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-columns (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-column :min-count 1 :max-count 1000))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-format-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-encoding-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-encoding))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-column-updates (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-columns))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-schema-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-format-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-encoding-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.input-schema-update/record-column-updates]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration/checkpointing-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.checkpoint-configuration/checkpointing-enabled :portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-interval :portkey.aws.kinesisanalyticsv2.-2018-05-23/min-pause-between-checkpoints]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/metrics-level #{:parallelism "OPERATOR" :task :application "TASK" "APPLICATION" :operator "PARALLELISM"})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.output/name (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-stream-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/output (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.output/name :portkey.aws.kinesisanalyticsv2.-2018-05-23/destination-schema] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-property-updates (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/property-groups] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/object-version (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-response (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-input-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.concurrent-modification-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.concurrent-modification-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-properties :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-response/application-arn (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.delete-application-cloud-watch-logging-option-response/application-arn :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-descriptions]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration-description/snapshots-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.application-snapshot-configuration-description/snapshots-enabled] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.lambda-output-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/lambda-output-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.lambda-output-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format-type #{"CSV" :csv "JSON" :json})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/job-plan-description (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/reference-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/table-name (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/in-app-table-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/reference-schema (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/reference-id :portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/table-name :portkey.aws.kinesisanalyticsv2.-2018-05-23/s-3-reference-data-source-description] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.reference-data-source-description/reference-schema]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-snapshots-input-limit (clojure.spec.alpha/int-in 1 50))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-per-kpu (clojure.spec.alpha/int-in 1 Long/MAX_VALUE))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/source-schema (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-format :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-columns] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/record-encoding]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration-update (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/sql-application-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-code-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/environment-property-updates :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-snapshot-configuration-update]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor-description (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/flink-application-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/checkpoint-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/monitoring-configuration :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-updates (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-update))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration/auto-scaling-enabled (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-configuration (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism :portkey.aws.kinesisanalyticsv2.-2018-05-23/parallelism-per-kpu :portkey.aws.kinesisanalyticsv2.-2018-05-23.parallelism-configuration/auto-scaling-enabled]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/text-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 102400))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-input (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/record-row-delimiter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-content-type #{:zipfile "ZIPFILE" :plaintext "PLAINTEXT"})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-response/next-token (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-response (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-summaries] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.list-applications-response/next-token]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-summaries (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-details))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.update-application-request/current-application-version-id (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/application-version-id))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.update-application-request/service-execution-role-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/role-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name :portkey.aws.kinesisanalyticsv2.-2018-05-23.update-application-request/current-application-version-id] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23.update-application-request/service-execution-role-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/run-configuration-update :portkey.aws.kinesisanalyticsv2.-2018-05-23/cloud-watch-logging-option-updates]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/raw-input-record (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-streams-output (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/configuration-type #{"CUSTOM" :default :custom "DEFAULT"})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-processing-configuration-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/input-lambda-processor-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-firehose-output-update/resource-arn-update (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-arn))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/kinesis-firehose-output-update (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.kinesis-firehose-output-update/resource-arn-update] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/snapshot-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-updates (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/output-update))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-application-configuration-exception/message (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/error-message))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-application-configuration-exception (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.invalid-application-configuration-exception/message]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-groups (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/property-group :max-count 50))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23.describe-application-request/include-additional-details (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/boolean-object))
(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-request (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23/application-name] :opt-un [:portkey.aws.kinesisanalyticsv2.-2018-05-23.describe-application-request/include-additional-details]))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-updates (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/reference-data-source-update))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/input-starting-position #{"NOW" "TRIM_HORIZON" :now "LAST_STOPPED_POINT" :last-stopped-point :trim-horizon})

(clojure.spec.alpha/def :portkey.aws.kinesisanalyticsv2.-2018-05-23/raw-input-records (clojure.spec.alpha/coll-of :portkey.aws.kinesisanalyticsv2.-2018-05-23/raw-input-record))

(clojure.core/defn list-applications "Returns a list of Amazon Kinesis Data Analytics applications in your account.\nFor each application, the response includes the application name, Amazon\nResource Name (ARN), and status.\n If you want detailed information about a specific application, use\nDescribeApplication." ([] (list-applications {})) ([list-applications-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-list-applications-request list-applications-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListApplications", :http.request.configuration/output-deser-fn response-list-applications-response, :http.request.spec/error-spec {"InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef list-applications :args (clojure.spec.alpha/? :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-applications-response))

(clojure.core/defn delete-application-output "Deletes the output destination configuration from your SQL-based Amazon Kinesis\nData Analytics application's configuration. Kinesis Data Analytics will no\nlonger write data from the corresponding in-application stream to the external\noutput destination." ([delete-application-output-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-output-request delete-application-output-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplicationOutput", :http.request.configuration/output-deser-fn response-delete-application-output-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef delete-application-output :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-output-response))

(clojure.core/defn stop-application "Stops the application from processing data. You can stop an application only if\nit is in the running state. You can use the DescribeApplication operation to\nfind the application state." ([stop-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-stop-application-request stop-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StopApplication", :http.request.configuration/output-deser-fn response-stop-application-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef stop-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/stop-application-response))

(clojure.core/defn delete-application-reference-data-source "Deletes a reference data source configuration from the specified SQL-based\nAmazon Kinesis Data Analytics application's configuration.\n If the application is running, Kinesis Data Analytics immediately removes the\nin-application table that you created using the\nAddApplicationReferenceDataSource operation." ([delete-application-reference-data-source-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-reference-data-source-request delete-application-reference-data-source-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplicationReferenceDataSource", :http.request.configuration/output-deser-fn response-delete-application-reference-data-source-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef delete-application-reference-data-source :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-reference-data-source-response))

(clojure.core/defn delete-application "Deletes the specified application. Kinesis Data Analytics halts application\nexecution and deletes the application." ([delete-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-request delete-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplication", :http.request.configuration/output-deser-fn response-delete-application-response, :http.request.spec/error-spec {"ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef delete-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-response))

(clojure.core/defn delete-application-cloud-watch-logging-option "Deletes an Amazon CloudWatch log stream from an Amazon Kinesis Data Analytics\napplication." ([delete-application-cloud-watch-logging-option-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-cloud-watch-logging-option-request delete-application-cloud-watch-logging-option-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplicationCloudWatchLoggingOption", :http.request.configuration/output-deser-fn response-delete-application-cloud-watch-logging-option-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef delete-application-cloud-watch-logging-option :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-cloud-watch-logging-option-response))

(clojure.core/defn describe-application "Returns information about a specific Amazon Kinesis Data Analytics application.\n If you want to retrieve a list of all applications in your account, use the\nListApplications operation." ([describe-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-describe-application-request describe-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeApplication", :http.request.configuration/output-deser-fn response-describe-application-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef describe-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-response))

(clojure.core/defn delete-application-snapshot "Deletes a snapshot of application state." ([delete-application-snapshot-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-snapshot-request delete-application-snapshot-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplicationSnapshot", :http.request.configuration/output-deser-fn response-delete-application-snapshot-response, :http.request.spec/error-spec {"ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "UnsupportedOperationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/unsupported-operation-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception, "ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception}})))))
(clojure.spec.alpha/fdef delete-application-snapshot :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-snapshot-response))

(clojure.core/defn add-application-input-processing-configuration "Adds an InputProcessingConfiguration to an SQL-based Kinesis Data Analytics\napplication. An input processor pre-processes records on the input stream before\nthe application's SQL code executes. Currently, the only input processor\navailable is AWS Lambda (https://aws.amazon.com/documentation/lambda/)." ([add-application-input-processing-configuration-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-add-application-input-processing-configuration-request add-application-input-processing-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "AddApplicationInputProcessingConfiguration", :http.request.configuration/output-deser-fn response-add-application-input-processing-configuration-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef add-application-input-processing-configuration :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-processing-configuration-response))

(clojure.core/defn add-application-reference-data-source "Adds a reference data source to an existing SQL-based Amazon Kinesis Data\nAnalytics application.\n Kinesis Data Analytics reads reference data (that is, an Amazon S3 object) and\ncreates an in-application table within your application. In the request, you\nprovide the source (S3 bucket name and object key name), name of the\nin-application table to create, and the necessary mapping information that\ndescribes how data in an Amazon S3 object maps to columns in the resulting\nin-application table." ([add-application-reference-data-source-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-add-application-reference-data-source-request add-application-reference-data-source-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "AddApplicationReferenceDataSource", :http.request.configuration/output-deser-fn response-add-application-reference-data-source-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef add-application-reference-data-source :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-reference-data-source-response))

(clojure.core/defn describe-application-snapshot "Returns information about a snapshot of application state data." ([describe-application-snapshot-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-describe-application-snapshot-request describe-application-snapshot-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeApplicationSnapshot", :http.request.configuration/output-deser-fn response-describe-application-snapshot-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "UnsupportedOperationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/unsupported-operation-exception}})))))
(clojure.spec.alpha/fdef describe-application-snapshot :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/describe-application-snapshot-response))

(clojure.core/defn update-application "Updates an existing Amazon Kinesis Data Analytics application. Using this\noperation, you can update application code, input configuration, and output\nconfiguration.\n Kinesis Data Analytics updates the ApplicationVersionId each time you update\nyour application.\n SQL is not enabled for this private beta. Using SQL parameters (such as\nSqlApplicationConfigurationUpdate) will result in an error." ([update-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-update-application-request update-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateApplication", :http.request.configuration/output-deser-fn response-update-application-response, :http.request.spec/error-spec {"CodeValidationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-validation-exception, "ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef update-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/update-application-response))

(clojure.core/defn add-application-cloud-watch-logging-option "Adds an Amazon CloudWatch log stream to monitor application configuration\nerrors." ([add-application-cloud-watch-logging-option-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-add-application-cloud-watch-logging-option-request add-application-cloud-watch-logging-option-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "AddApplicationCloudWatchLoggingOption", :http.request.configuration/output-deser-fn response-add-application-cloud-watch-logging-option-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef add-application-cloud-watch-logging-option :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-cloud-watch-logging-option-response))

(clojure.core/defn create-application "Creates an Amazon Kinesis Data Analytics application. For information about\ncreating a Kinesis Data Analytics application, see Creating an Application\n(https://docs.aws.amazon.com/kinesisanalytics/latest/Java/creating-app.html).\n SQL is not enabled for this private beta release. Using SQL parameters (such as\nSqlApplicationConfiguration) will result in an error." ([create-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-create-application-request create-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateApplication", :http.request.configuration/output-deser-fn response-create-application-response, :http.request.spec/error-spec {"CodeValidationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-validation-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "LimitExceededException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef create-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-response))

(clojure.core/defn add-application-input " Adds a streaming source to your SQL-based Amazon Kinesis Data Analytics\napplication.\n You can add a streaming source when you create an application, or you can use\nthis operation to add a streaming source after you create an application. For\nmore information, see CreateApplication.\n Any configuration update, including adding a streaming source using this\noperation, results in a new version of the application. You can use the\nDescribeApplication operation to find the current application version." ([add-application-input-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-add-application-input-request add-application-input-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "AddApplicationInput", :http.request.configuration/output-deser-fn response-add-application-input-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "CodeValidationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/code-validation-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef add-application-input :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-input-response))

(clojure.core/defn add-application-output "Adds an external destination to your SQL-based Amazon Kinesis Data Analytics\napplication.\n If you want Kinesis Data Analytics to deliver data from an in-application\nstream within your application to an external destination (such as an Kinesis\ndata stream, a Kinesis Data Firehose delivery stream, or an AWS Lambda\nfunction), you add the relevant configuration to your application using this\noperation. You can configure one or more outputs for your application. Each\noutput configuration maps an in-application stream and an external destination.\n You can use one of the output configurations to deliver data from your\nin-application error stream to an external destination so that you can analyze\nthe errors.\n Any configuration update, including adding a streaming source using this\noperation, results in a new version of the application. You can use the\nDescribeApplication operation to find the current application version." ([add-application-output-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-add-application-output-request add-application-output-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "AddApplicationOutput", :http.request.configuration/output-deser-fn response-add-application-output-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef add-application-output :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/add-application-output-response))

(clojure.core/defn discover-input-schema "Infers a schema for an SQL-based Amazon Kinesis Data Analytics application by\nevaluating sample records on the specified streaming source (Kinesis data stream\nor Kinesis Data Firehose delivery stream) or Amazon S3 object. In the response,\nthe operation returns the inferred schema and also the sample records that the\noperation used to infer the schema.\n You can use the inferred schema when configuring a streaming source for your\napplication. When you create an application using the Kinesis Data Analytics\nconsole, the console uses this operation to infer a schema and show it in the\nconsole user interface." ([discover-input-schema-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-discover-input-schema-request discover-input-schema-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DiscoverInputSchema", :http.request.configuration/output-deser-fn response-discover-input-schema-response, :http.request.spec/error-spec {"InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "UnableToDetectSchemaException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/unable-to-detect-schema-exception, "ResourceProvisionedThroughputExceededException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-provisioned-throughput-exceeded-exception, "ServiceUnavailableException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/service-unavailable-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef discover-input-schema :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/discover-input-schema-response))

(clojure.core/defn start-application "Starts the specified Amazon Kinesis Data Analytics application. After creating\nan application, you must exclusively call this operation to start your\napplication.\n SQL is not enabled for this private beta. Using SQL parameters (such as\nRunConfiguration$SqlRunConfigurations) will result in an error." ([start-application-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-start-application-request start-application-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StartApplication", :http.request.configuration/output-deser-fn response-start-application-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "InvalidApplicationConfigurationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-application-configuration-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef start-application :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/start-application-response))

(clojure.core/defn create-application-snapshot "Creates a snapshot of the application's state data." ([create-application-snapshot-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-create-application-snapshot-request create-application-snapshot-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CreateApplicationSnapshot", :http.request.configuration/output-deser-fn response-create-application-snapshot-response, :http.request.spec/error-spec {"ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "LimitExceededException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "UnsupportedOperationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/unsupported-operation-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef create-application-snapshot :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/create-application-snapshot-response))

(clojure.core/defn delete-application-input-processing-configuration "Deletes an InputProcessingConfiguration from an input." ([delete-application-input-processing-configuration-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-delete-application-input-processing-configuration-request delete-application-input-processing-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeleteApplicationInputProcessingConfiguration", :http.request.configuration/output-deser-fn response-delete-application-input-processing-configuration-response, :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/resource-in-use-exception, "InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "ConcurrentModificationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/concurrent-modification-exception, "InvalidRequestException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-request-exception}})))))
(clojure.spec.alpha/fdef delete-application-input-processing-configuration :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/delete-application-input-processing-configuration-response))

(clojure.core/defn list-application-snapshots "Lists information about the current application snapshots." ([list-application-snapshots-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-list-application-snapshots-request list-application-snapshots-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisanalyticsv2.-2018-05-23/endpoints, :http.request.configuration/target-prefix "KinesisAnalytics_20180523", :http.request.spec/output-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-05-23", :http.request.configuration/service-id "Kinesis Analytics V2", :http.request.spec/input-spec :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListApplicationSnapshots", :http.request.configuration/output-deser-fn response-list-application-snapshots-response, :http.request.spec/error-spec {"InvalidArgumentException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/invalid-argument-exception, "UnsupportedOperationException" :portkey.aws.kinesisanalyticsv2.-2018-05-23/unsupported-operation-exception}})))))
(clojure.spec.alpha/fdef list-application-snapshots :args (clojure.spec.alpha/tuple :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-request) :ret (clojure.spec.alpha/and :portkey.aws.kinesisanalyticsv2.-2018-05-23/list-application-snapshots-response))
