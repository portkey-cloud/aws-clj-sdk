...
(clojure.core/defn- response-delete-delivery-stream-output ([input] (response-delete-delivery-stream-output nil input)) ([resultWrapper963807 input] (clojure.core/let [rawinput963806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963808 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-delivery-stream-encryption-output ([input] (response-start-delivery-stream-encryption-output nil input)) ([resultWrapper963810 input] (clojure.core/let [rawinput963809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963811 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-destination-output ([input] (response-update-destination-output nil input)) ([resultWrapper963813 input] (clojure.core/let [rawinput963812 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963814 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-delivery-stream-output ([input] (response-create-delivery-stream-output nil input)) ([resultWrapper963816 input] (clojure.core/let [rawinput963815 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963817 {"DeliveryStreamARN" (rawinput963815 "DeliveryStreamARN")}] (clojure.core/cond-> {} (letvar963817 "DeliveryStreamARN") (clojure.core/assoc :delivery-stream-arn (deser-delivery-stream-arn (clojure.core/get-in letvar963817 ["DeliveryStreamARN"])))))))

(clojure.core/defn- response-untag-delivery-stream-output ([input] (response-untag-delivery-stream-output nil input)) ([resultWrapper963819 input] (clojure.core/let [rawinput963818 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963820 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-delivery-stream-output ([input] (response-tag-delivery-stream-output nil input)) ([resultWrapper963822 input] (clojure.core/let [rawinput963821 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963823 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-delivery-stream-encryption-output ([input] (response-stop-delivery-stream-encryption-output nil input)) ([resultWrapper963825 input] (clojure.core/let [rawinput963824 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963826 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper963828 input] (clojure.core/let [rawinput963827 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963829 {"message" (rawinput963827 "message")}] (clojure.core/cond-> {} (letvar963829 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963829 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper963831 input] (clojure.core/let [rawinput963830 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963832 {"message" (rawinput963830 "message")}] (clojure.core/cond-> {} (letvar963832 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963832 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper963834 input] (clojure.core/let [rawinput963833 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963835 {"message" (rawinput963833 "message")}] (clojure.core/cond-> {} (letvar963835 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963835 ["message"])))))))

(clojure.core/defn- response-put-record-batch-output ([input] (response-put-record-batch-output nil input)) ([resultWrapper963837 input] (clojure.core/let [rawinput963836 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963838 {"FailedPutCount" (rawinput963836 "FailedPutCount"), "Encrypted" (rawinput963836 "Encrypted"), "RequestResponses" (rawinput963836 "RequestResponses")}] (clojure.core/cond-> {:failed-put-count (deser-non-negative-integer-object (clojure.core/get-in letvar963838 ["FailedPutCount"])), :request-responses (deser-put-record-batch-response-entry-list (clojure.core/get-in letvar963838 ["RequestResponses"]))} (letvar963838 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar963838 ["Encrypted"])))))))

(clojure.core/defn- response-describe-delivery-stream-output ([input] (response-describe-delivery-stream-output nil input)) ([resultWrapper963840 input] (clojure.core/let [rawinput963839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963841 {"DeliveryStreamDescription" (rawinput963839 "DeliveryStreamDescription")}] (clojure.core/cond-> {:delivery-stream-description (deser-delivery-stream-description (clojure.core/get-in letvar963841 ["DeliveryStreamDescription"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper963843 input] (clojure.core/let [rawinput963842 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963844 {"message" (rawinput963842 "message")}] (clojure.core/cond-> {} (letvar963844 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963844 ["message"])))))))

(clojure.core/defn- response-list-delivery-streams-output ([input] (response-list-delivery-streams-output nil input)) ([resultWrapper963846 input] (clojure.core/let [rawinput963845 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963847 {"DeliveryStreamNames" (rawinput963845 "DeliveryStreamNames"), "HasMoreDeliveryStreams" (rawinput963845 "HasMoreDeliveryStreams")}] (clojure.core/cond-> {:delivery-stream-names (deser-delivery-stream-name-list (clojure.core/get-in letvar963847 ["DeliveryStreamNames"])), :has-more-delivery-streams (deser-boolean-object (clojure.core/get-in letvar963847 ["HasMoreDeliveryStreams"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper963849 input] (clojure.core/let [rawinput963848 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963850 {"message" (rawinput963848 "message")}] (clojure.core/cond-> {} (letvar963850 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963850 ["message"])))))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper963852 input] (clojure.core/let [rawinput963851 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963853 {"RecordId" (rawinput963851 "RecordId"), "Encrypted" (rawinput963851 "Encrypted")}] (clojure.core/cond-> {:record-id (deser-put-response-record-id (clojure.core/get-in letvar963853 ["RecordId"]))} (letvar963853 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar963853 ["Encrypted"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper963855 input] (clojure.core/let [rawinput963854 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963856 {"message" (rawinput963854 "message")}] (clojure.core/cond-> {} (letvar963856 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar963856 ["message"])))))))

(clojure.core/defn- response-list-tags-for-delivery-stream-output ([input] (response-list-tags-for-delivery-stream-output nil input)) ([resultWrapper963858 input] (clojure.core/let [rawinput963857 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar963859 {"Tags" (rawinput963857 "Tags"), "HasMoreTags" (rawinput963857 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-list-tags-for-delivery-stream-output-tag-list (clojure.core/get-in letvar963859 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar963859 ["HasMoreTags"]))}))))

(clojure.spec.alpha/def :portkey.aws.firehose/processor-list (clojure.spec.alpha/coll-of :portkey.aws.firehose/processor))

(clojure.spec.alpha/def :portkey.aws.firehose/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/start-delivery-stream-encryption-input (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose/delivery-stream-name] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.firehose/start-delivery-stream-encryption-output (clojure.spec.alpha/keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(?!\s*$).+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string-without-whitespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/kinesis-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.firehose/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 6 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-index-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 80))))

(clojure.spec.alpha/def :portkey.aws.firehose/data-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/stop-delivery-stream-encryption-output (clojure.spec.alpha/keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-version-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.put-record-batch-output/encrypted (clojure.spec.alpha/and :portkey.aws.firehose/boolean-object))
...
(clojure.spec.alpha/def :portkey.aws.firehose/put-record-batch-output (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose.put-record-batch-output/failed-put-count :portkey.aws.firehose.put-record-batch-output/request-responses] :opt-un [:portkey.aws.firehose.put-record-batch-output/encrypted]))

(clojure.spec.alpha/def :portkey.aws.firehose/destination-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/cluster-jdbcurl (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"jdbc:(redshift|postgresql)://((?!-)[A-Za-z0-9-]{1,63}(?<!-)\.)+redshift\.amazonaws\.com:\d{1,5}/[a-zA-Z0-9_$]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.create-delivery-stream-input/tags (clojure.spec.alpha/and :portkey.aws.firehose/tag-delivery-stream-input-tag-list))
(clojure.spec.alpha/def :portkey.aws.firehose/create-delivery-stream-input (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose/delivery-stream-name] :opt-un [:portkey.aws.firehose/redshift-destination-configuration :portkey.aws.firehose/extended-s-3-destination-configuration :portkey.aws.firehose/s-3-destination-configuration :portkey.aws.firehose/delivery-stream-type :portkey.aws.firehose/kinesis-stream-source-configuration :portkey.aws.firehose/elasticsearch-destination-configuration :portkey.aws.firehose.create-delivery-stream-input/tags :portkey.aws.firehose/splunk-destination-configuration]))
...
(clojure.spec.alpha/def :portkey.aws.firehose/error-output-prefix (clojure.spec.alpha/and clojure.core/string?))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-encryption-status #{"DISABLED" :disabled "DISABLING" "ENABLING" :disabling :enabling "ENABLED" :enabled})
...
(clojure.spec.alpha/def :portkey.aws.firehose/awskms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.put-record-output/encrypted (clojure.spec.alpha/and :portkey.aws.firehose/boolean-object))
(clojure.spec.alpha/def :portkey.aws.firehose/put-record-output (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose.put-record-output/record-id] :opt-un [:portkey.aws.firehose.put-record-output/encrypted]))
...
(clojure.spec.alpha/def :portkey.aws.firehose.delivery-stream-encryption-configuration/status (clojure.spec.alpha/and :portkey.aws.firehose/delivery-stream-encryption-status))
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-encryption-configuration (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.firehose.delivery-stream-encryption-configuration/status]))
...
(clojure.spec.alpha/def :portkey.aws.firehose/processor-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/s-3-destination-description (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose/role-arn :portkey.aws.firehose/bucket-arn :portkey.aws.firehose/buffering-hints :portkey.aws.firehose/compression-format :portkey.aws.firehose/encryption-configuration] :opt-un [:portkey.aws.firehose/prefix :portkey.aws.firehose/error-output-prefix :portkey.aws.firehose/cloud-watch-logging-options]))
...
(clojure.spec.alpha/def :portkey.aws.firehose/stop-delivery-stream-encryption-input (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose/delivery-stream-name] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.firehose/put-response-record-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-type-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-description (clojure.spec.alpha/keys :req-un [:portkey.aws.firehose/delivery-stream-name :portkey.aws.firehose/delivery-stream-arn :portkey.aws.firehose/delivery-stream-status :portkey.aws.firehose/delivery-stream-type :portkey.aws.firehose.delivery-stream-description/version-id :portkey.aws.firehose.delivery-stream-description/destinations :portkey.aws.firehose.delivery-stream-description/has-more-destinations] :opt-un [:portkey.aws.firehose.delivery-stream-description/create-timestamp :portkey.aws.firehose.delivery-stream-description/last-update-timestamp :portkey.aws.firehose.delivery-stream-description/source :portkey.aws.firehose/delivery-stream-encryption-configuration]))
