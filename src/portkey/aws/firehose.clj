...
(clojure.core/defn- response-delete-delivery-stream-output ([input] (response-delete-delivery-stream-output nil input)) ([resultWrapper1744861 input] (clojure.core/let [rawinput1744860 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744862 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-delivery-stream-encryption-output ([input] (response-start-delivery-stream-encryption-output nil input)) ([resultWrapper1744864 input] (clojure.core/let [rawinput1744863 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744865 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-destination-output ([input] (response-update-destination-output nil input)) ([resultWrapper1744867 input] (clojure.core/let [rawinput1744866 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744868 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-delivery-stream-output ([input] (response-create-delivery-stream-output nil input)) ([resultWrapper1744870 input] (clojure.core/let [rawinput1744869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744871 {"DeliveryStreamARN" (rawinput1744869 "DeliveryStreamARN")}] (clojure.core/cond-> {} (letvar1744871 "DeliveryStreamARN") (clojure.core/assoc :delivery-stream-arn (deser-delivery-stream-arn (clojure.core/get-in letvar1744871 ["DeliveryStreamARN"])))))))

(clojure.core/defn- response-untag-delivery-stream-output ([input] (response-untag-delivery-stream-output nil input)) ([resultWrapper1744873 input] (clojure.core/let [rawinput1744872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744874 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-delivery-stream-output ([input] (response-tag-delivery-stream-output nil input)) ([resultWrapper1744876 input] (clojure.core/let [rawinput1744875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744877 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-delivery-stream-encryption-output ([input] (response-stop-delivery-stream-encryption-output nil input)) ([resultWrapper1744879 input] (clojure.core/let [rawinput1744878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744880 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1744882 input] (clojure.core/let [rawinput1744881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744883 {"message" (rawinput1744881 "message")}] (clojure.core/cond-> {} (letvar1744883 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744883 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1744885 input] (clojure.core/let [rawinput1744884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744886 {"message" (rawinput1744884 "message")}] (clojure.core/cond-> {} (letvar1744886 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744886 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1744888 input] (clojure.core/let [rawinput1744887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744889 {"message" (rawinput1744887 "message")}] (clojure.core/cond-> {} (letvar1744889 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744889 ["message"])))))))

(clojure.core/defn- response-put-record-batch-output ([input] (response-put-record-batch-output nil input)) ([resultWrapper1744891 input] (clojure.core/let [rawinput1744890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744892 {"FailedPutCount" (rawinput1744890 "FailedPutCount"), "Encrypted" (rawinput1744890 "Encrypted"), "RequestResponses" (rawinput1744890 "RequestResponses")}] (clojure.core/cond-> {:failed-put-count (deser-non-negative-integer-object (clojure.core/get-in letvar1744892 ["FailedPutCount"])), :request-responses (deser-put-record-batch-response-entry-list (clojure.core/get-in letvar1744892 ["RequestResponses"]))} (letvar1744892 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar1744892 ["Encrypted"])))))))

(clojure.core/defn- response-describe-delivery-stream-output ([input] (response-describe-delivery-stream-output nil input)) ([resultWrapper1744894 input] (clojure.core/let [rawinput1744893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744895 {"DeliveryStreamDescription" (rawinput1744893 "DeliveryStreamDescription")}] (clojure.core/cond-> {:delivery-stream-description (deser-delivery-stream-description (clojure.core/get-in letvar1744895 ["DeliveryStreamDescription"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1744897 input] (clojure.core/let [rawinput1744896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744898 {"message" (rawinput1744896 "message")}] (clojure.core/cond-> {} (letvar1744898 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744898 ["message"])))))))

(clojure.core/defn- response-list-delivery-streams-output ([input] (response-list-delivery-streams-output nil input)) ([resultWrapper1744900 input] (clojure.core/let [rawinput1744899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744901 {"DeliveryStreamNames" (rawinput1744899 "DeliveryStreamNames"), "HasMoreDeliveryStreams" (rawinput1744899 "HasMoreDeliveryStreams")}] (clojure.core/cond-> {:delivery-stream-names (deser-delivery-stream-name-list (clojure.core/get-in letvar1744901 ["DeliveryStreamNames"])), :has-more-delivery-streams (deser-boolean-object (clojure.core/get-in letvar1744901 ["HasMoreDeliveryStreams"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1744903 input] (clojure.core/let [rawinput1744902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744904 {"message" (rawinput1744902 "message")}] (clojure.core/cond-> {} (letvar1744904 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744904 ["message"])))))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper1744906 input] (clojure.core/let [rawinput1744905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744907 {"RecordId" (rawinput1744905 "RecordId"), "Encrypted" (rawinput1744905 "Encrypted")}] (clojure.core/cond-> {:record-id (deser-put-response-record-id (clojure.core/get-in letvar1744907 ["RecordId"]))} (letvar1744907 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar1744907 ["Encrypted"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1744909 input] (clojure.core/let [rawinput1744908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744910 {"message" (rawinput1744908 "message")}] (clojure.core/cond-> {} (letvar1744910 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1744910 ["message"])))))))

(clojure.core/defn- response-list-tags-for-delivery-stream-output ([input] (response-list-tags-for-delivery-stream-output nil input)) ([resultWrapper1744912 input] (clojure.core/let [rawinput1744911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1744913 {"Tags" (rawinput1744911 "Tags"), "HasMoreTags" (rawinput1744911 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-list-tags-for-delivery-stream-output-tag-list (clojure.core/get-in letvar1744913 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar1744913 ["HasMoreTags"]))}))))

(clojure.spec.alpha/def :portkey.aws.firehose/processor-list (clojure.spec.alpha/coll-of :portkey.aws.firehose/processor))

(clojure.spec.alpha/def :portkey.aws.firehose/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(?!\s*$).+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string-without-whitespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/kinesis-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.firehose/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-index-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 80))))

(clojure.spec.alpha/def :portkey.aws.firehose/data-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-version-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/destination-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/cluster-jdbcurl (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"jdbc:(redshift|postgresql)://((?!-)[A-Za-z0-9-]{1,63}(?<!-)\.)+redshift\.amazonaws\.com:\d{1,5}/[a-zA-Z0-9_$]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-domain-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/awskms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/processor-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/put-response-record-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-type-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
