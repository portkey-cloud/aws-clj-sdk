...
(clojure.core/defn- response-delete-delivery-stream-output ([input] (response-delete-delivery-stream-output nil input)) ([resultWrapper1774419 input] (clojure.core/let [rawinput1774418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774420 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-delivery-stream-encryption-output ([input] (response-start-delivery-stream-encryption-output nil input)) ([resultWrapper1774422 input] (clojure.core/let [rawinput1774421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-destination-output ([input] (response-update-destination-output nil input)) ([resultWrapper1774425 input] (clojure.core/let [rawinput1774424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774426 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-delivery-stream-output ([input] (response-create-delivery-stream-output nil input)) ([resultWrapper1774428 input] (clojure.core/let [rawinput1774427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774429 {"DeliveryStreamARN" (rawinput1774427 "DeliveryStreamARN")}] (clojure.core/cond-> {} (letvar1774429 "DeliveryStreamARN") (clojure.core/assoc :delivery-stream-arn (deser-delivery-stream-arn (clojure.core/get-in letvar1774429 ["DeliveryStreamARN"])))))))

(clojure.core/defn- response-untag-delivery-stream-output ([input] (response-untag-delivery-stream-output nil input)) ([resultWrapper1774431 input] (clojure.core/let [rawinput1774430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774432 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-delivery-stream-output ([input] (response-tag-delivery-stream-output nil input)) ([resultWrapper1774434 input] (clojure.core/let [rawinput1774433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774435 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-delivery-stream-encryption-output ([input] (response-stop-delivery-stream-encryption-output nil input)) ([resultWrapper1774437 input] (clojure.core/let [rawinput1774436 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774438 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1774440 input] (clojure.core/let [rawinput1774439 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774441 {"message" (rawinput1774439 "message")}] (clojure.core/cond-> {} (letvar1774441 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774441 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1774443 input] (clojure.core/let [rawinput1774442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774444 {"message" (rawinput1774442 "message")}] (clojure.core/cond-> {} (letvar1774444 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774444 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1774446 input] (clojure.core/let [rawinput1774445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774447 {"message" (rawinput1774445 "message")}] (clojure.core/cond-> {} (letvar1774447 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774447 ["message"])))))))

(clojure.core/defn- response-put-record-batch-output ([input] (response-put-record-batch-output nil input)) ([resultWrapper1774449 input] (clojure.core/let [rawinput1774448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774450 {"FailedPutCount" (rawinput1774448 "FailedPutCount"), "Encrypted" (rawinput1774448 "Encrypted"), "RequestResponses" (rawinput1774448 "RequestResponses")}] (clojure.core/cond-> {:failed-put-count (deser-non-negative-integer-object (clojure.core/get-in letvar1774450 ["FailedPutCount"])), :request-responses (deser-put-record-batch-response-entry-list (clojure.core/get-in letvar1774450 ["RequestResponses"]))} (letvar1774450 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar1774450 ["Encrypted"])))))))

(clojure.core/defn- response-describe-delivery-stream-output ([input] (response-describe-delivery-stream-output nil input)) ([resultWrapper1774452 input] (clojure.core/let [rawinput1774451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774453 {"DeliveryStreamDescription" (rawinput1774451 "DeliveryStreamDescription")}] (clojure.core/cond-> {:delivery-stream-description (deser-delivery-stream-description (clojure.core/get-in letvar1774453 ["DeliveryStreamDescription"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1774455 input] (clojure.core/let [rawinput1774454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774456 {"message" (rawinput1774454 "message")}] (clojure.core/cond-> {} (letvar1774456 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774456 ["message"])))))))

(clojure.core/defn- response-list-delivery-streams-output ([input] (response-list-delivery-streams-output nil input)) ([resultWrapper1774458 input] (clojure.core/let [rawinput1774457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774459 {"DeliveryStreamNames" (rawinput1774457 "DeliveryStreamNames"), "HasMoreDeliveryStreams" (rawinput1774457 "HasMoreDeliveryStreams")}] (clojure.core/cond-> {:delivery-stream-names (deser-delivery-stream-name-list (clojure.core/get-in letvar1774459 ["DeliveryStreamNames"])), :has-more-delivery-streams (deser-boolean-object (clojure.core/get-in letvar1774459 ["HasMoreDeliveryStreams"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1774461 input] (clojure.core/let [rawinput1774460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774462 {"message" (rawinput1774460 "message")}] (clojure.core/cond-> {} (letvar1774462 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774462 ["message"])))))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper1774464 input] (clojure.core/let [rawinput1774463 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774465 {"RecordId" (rawinput1774463 "RecordId"), "Encrypted" (rawinput1774463 "Encrypted")}] (clojure.core/cond-> {:record-id (deser-put-response-record-id (clojure.core/get-in letvar1774465 ["RecordId"]))} (letvar1774465 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar1774465 ["Encrypted"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1774467 input] (clojure.core/let [rawinput1774466 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774468 {"message" (rawinput1774466 "message")}] (clojure.core/cond-> {} (letvar1774468 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1774468 ["message"])))))))

(clojure.core/defn- response-list-tags-for-delivery-stream-output ([input] (response-list-tags-for-delivery-stream-output nil input)) ([resultWrapper1774470 input] (clojure.core/let [rawinput1774469 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1774471 {"Tags" (rawinput1774469 "Tags"), "HasMoreTags" (rawinput1774469 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-list-tags-for-delivery-stream-output-tag-list (clojure.core/get-in letvar1774471 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar1774471 ["HasMoreTags"]))}))))

(clojure.spec.alpha/def :portkey.aws.firehose/processor-list (clojure.spec.alpha/coll-of :portkey.aws.firehose/processor))

(clojure.spec.alpha/def :portkey.aws.firehose/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^(?!\s*$).+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/non-empty-string-without-whitespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^\S+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/kinesis-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.firehose/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 6 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-index-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 80))))

(clojure.spec.alpha/def :portkey.aws.firehose/data-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-version-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 50)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/destination-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/cluster-jdbcurl (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"jdbc:(redshift|postgresql)://((?!-)[A-Za-z0-9-]{1,63}(?<!-)\.)+redshift\.amazonaws\.com:\d{1,5}/[a-zA-Z0-9_$]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-domain-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/delivery-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/awskms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/processor-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/put-response-record-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose/elasticsearch-type-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
