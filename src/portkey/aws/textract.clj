...
(clojure.core/defn- response-invalid-s-3-object-exception ([input] (response-invalid-s-3-object-exception nil input)) ([resultWrapper2121609 input] (clojure.core/let [rawinput2121608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121610 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-analysis-response ([input] (response-get-document-analysis-response nil input)) ([resultWrapper2121612 input] (clojure.core/let [rawinput2121611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121613 {"DocumentMetadata" (rawinput2121611 "DocumentMetadata"), "JobStatus" (rawinput2121611 "JobStatus"), "NextToken" (rawinput2121611 "NextToken"), "Blocks" (rawinput2121611 "Blocks"), "Warnings" (rawinput2121611 "Warnings"), "StatusMessage" (rawinput2121611 "StatusMessage")}] (clojure.core/cond-> {} (letvar2121613 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2121613 ["DocumentMetadata"]))) (letvar2121613 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar2121613 ["JobStatus"]))) (letvar2121613 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2121613 ["NextToken"]))) (letvar2121613 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2121613 ["Blocks"]))) (letvar2121613 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar2121613 ["Warnings"]))) (letvar2121613 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar2121613 ["StatusMessage"])))))))

(clojure.core/defn- response-analyze-document-response ([input] (response-analyze-document-response nil input)) ([resultWrapper2121615 input] (clojure.core/let [rawinput2121614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121616 {"DocumentMetadata" (rawinput2121614 "DocumentMetadata"), "Blocks" (rawinput2121614 "Blocks")}] (clojure.core/cond-> {} (letvar2121616 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2121616 ["DocumentMetadata"]))) (letvar2121616 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2121616 ["Blocks"])))))))

(clojure.core/defn- response-document-too-large-exception ([input] (response-document-too-large-exception nil input)) ([resultWrapper2121618 input] (clojure.core/let [rawinput2121617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121619 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2121621 input] (clojure.core/let [rawinput2121620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121622 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-job-id-exception ([input] (response-invalid-job-id-exception nil input)) ([resultWrapper2121624 input] (clojure.core/let [rawinput2121623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121625 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-document-exception ([input] (response-bad-document-exception nil input)) ([resultWrapper2121627 input] (clojure.core/let [rawinput2121626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121628 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-analysis-response ([input] (response-start-document-analysis-response nil input)) ([resultWrapper2121630 input] (clojure.core/let [rawinput2121629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121631 {"JobId" (rawinput2121629 "JobId")}] (clojure.core/cond-> {} (letvar2121631 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar2121631 ["JobId"])))))))

(clojure.core/defn- response-detect-document-text-response ([input] (response-detect-document-text-response nil input)) ([resultWrapper2121633 input] (clojure.core/let [rawinput2121632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121634 {"DocumentMetadata" (rawinput2121632 "DocumentMetadata"), "Blocks" (rawinput2121632 "Blocks")}] (clojure.core/cond-> {} (letvar2121634 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2121634 ["DocumentMetadata"]))) (letvar2121634 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2121634 ["Blocks"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper2121636 input] (clojure.core/let [rawinput2121635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121637 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2121639 input] (clojure.core/let [rawinput2121638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121640 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-text-detection-response ([input] (response-start-document-text-detection-response nil input)) ([resultWrapper2121642 input] (clojure.core/let [rawinput2121641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121643 {"JobId" (rawinput2121641 "JobId")}] (clojure.core/cond-> {} (letvar2121643 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar2121643 ["JobId"])))))))

(clojure.core/defn- response-unsupported-document-exception ([input] (response-unsupported-document-exception nil input)) ([resultWrapper2121645 input] (clojure.core/let [rawinput2121644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121646 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper2121648 input] (clojure.core/let [rawinput2121647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121649 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2121651 input] (clojure.core/let [rawinput2121650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121652 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2121654 input] (clojure.core/let [rawinput2121653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121655 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-text-detection-response ([input] (response-get-document-text-detection-response nil input)) ([resultWrapper2121657 input] (clojure.core/let [rawinput2121656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121658 {"DocumentMetadata" (rawinput2121656 "DocumentMetadata"), "JobStatus" (rawinput2121656 "JobStatus"), "NextToken" (rawinput2121656 "NextToken"), "Blocks" (rawinput2121656 "Blocks"), "Warnings" (rawinput2121656 "Warnings"), "StatusMessage" (rawinput2121656 "StatusMessage")}] (clojure.core/cond-> {} (letvar2121658 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar2121658 ["DocumentMetadata"]))) (letvar2121658 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar2121658 ["JobStatus"]))) (letvar2121658 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2121658 ["NextToken"]))) (letvar2121658 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar2121658 ["Blocks"]))) (letvar2121658 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar2121658 ["Warnings"]))) (letvar2121658 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar2121658 ["StatusMessage"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper2121660 input] (clojure.core/let [rawinput2121659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2121661 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.textract/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract/id-list (clojure.spec.alpha/coll-of :portkey.aws.textract/non-empty-string))

(clojure.spec.alpha/def :portkey.aws.textract/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract/s-3-object-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #".*\S.*" s__1467903__auto__))))
