...
(clojure.core/defn- response-invalid-s-3-object-exception ([input] (response-invalid-s-3-object-exception nil input)) ([resultWrapper1847891 input] (clojure.core/let [rawinput1847890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847892 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-analysis-response ([input] (response-get-document-analysis-response nil input)) ([resultWrapper1847894 input] (clojure.core/let [rawinput1847893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847895 {"DocumentMetadata" (rawinput1847893 "DocumentMetadata"), "JobStatus" (rawinput1847893 "JobStatus"), "NextToken" (rawinput1847893 "NextToken"), "Blocks" (rawinput1847893 "Blocks"), "Warnings" (rawinput1847893 "Warnings"), "StatusMessage" (rawinput1847893 "StatusMessage")}] (clojure.core/cond-> {} (letvar1847895 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1847895 ["DocumentMetadata"]))) (letvar1847895 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar1847895 ["JobStatus"]))) (letvar1847895 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1847895 ["NextToken"]))) (letvar1847895 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1847895 ["Blocks"]))) (letvar1847895 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar1847895 ["Warnings"]))) (letvar1847895 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar1847895 ["StatusMessage"])))))))

(clojure.core/defn- response-analyze-document-response ([input] (response-analyze-document-response nil input)) ([resultWrapper1847897 input] (clojure.core/let [rawinput1847896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847898 {"DocumentMetadata" (rawinput1847896 "DocumentMetadata"), "Blocks" (rawinput1847896 "Blocks")}] (clojure.core/cond-> {} (letvar1847898 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1847898 ["DocumentMetadata"]))) (letvar1847898 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1847898 ["Blocks"])))))))

(clojure.core/defn- response-document-too-large-exception ([input] (response-document-too-large-exception nil input)) ([resultWrapper1847900 input] (clojure.core/let [rawinput1847899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847901 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1847903 input] (clojure.core/let [rawinput1847902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847904 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-job-id-exception ([input] (response-invalid-job-id-exception nil input)) ([resultWrapper1847906 input] (clojure.core/let [rawinput1847905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847907 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-document-exception ([input] (response-bad-document-exception nil input)) ([resultWrapper1847909 input] (clojure.core/let [rawinput1847908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847910 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-analysis-response ([input] (response-start-document-analysis-response nil input)) ([resultWrapper1847912 input] (clojure.core/let [rawinput1847911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847913 {"JobId" (rawinput1847911 "JobId")}] (clojure.core/cond-> {} (letvar1847913 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1847913 ["JobId"])))))))

(clojure.core/defn- response-detect-document-text-response ([input] (response-detect-document-text-response nil input)) ([resultWrapper1847915 input] (clojure.core/let [rawinput1847914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847916 {"DocumentMetadata" (rawinput1847914 "DocumentMetadata"), "Blocks" (rawinput1847914 "Blocks")}] (clojure.core/cond-> {} (letvar1847916 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1847916 ["DocumentMetadata"]))) (letvar1847916 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1847916 ["Blocks"])))))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper1847918 input] (clojure.core/let [rawinput1847917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847919 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1847921 input] (clojure.core/let [rawinput1847920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847922 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-document-text-detection-response ([input] (response-start-document-text-detection-response nil input)) ([resultWrapper1847924 input] (clojure.core/let [rawinput1847923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847925 {"JobId" (rawinput1847923 "JobId")}] (clojure.core/cond-> {} (letvar1847925 "JobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1847925 ["JobId"])))))))

(clojure.core/defn- response-unsupported-document-exception ([input] (response-unsupported-document-exception nil input)) ([resultWrapper1847927 input] (clojure.core/let [rawinput1847926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847928 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1847930 input] (clojure.core/let [rawinput1847929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847931 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1847933 input] (clojure.core/let [rawinput1847932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847934 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1847936 input] (clojure.core/let [rawinput1847935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847937 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-document-text-detection-response ([input] (response-get-document-text-detection-response nil input)) ([resultWrapper1847939 input] (clojure.core/let [rawinput1847938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847940 {"DocumentMetadata" (rawinput1847938 "DocumentMetadata"), "JobStatus" (rawinput1847938 "JobStatus"), "NextToken" (rawinput1847938 "NextToken"), "Blocks" (rawinput1847938 "Blocks"), "Warnings" (rawinput1847938 "Warnings"), "StatusMessage" (rawinput1847938 "StatusMessage")}] (clojure.core/cond-> {} (letvar1847940 "DocumentMetadata") (clojure.core/assoc :document-metadata (deser-document-metadata (clojure.core/get-in letvar1847940 ["DocumentMetadata"]))) (letvar1847940 "JobStatus") (clojure.core/assoc :job-status (deser-job-status (clojure.core/get-in letvar1847940 ["JobStatus"]))) (letvar1847940 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1847940 ["NextToken"]))) (letvar1847940 "Blocks") (clojure.core/assoc :blocks (deser-block-list (clojure.core/get-in letvar1847940 ["Blocks"]))) (letvar1847940 "Warnings") (clojure.core/assoc :warnings (deser-warnings (clojure.core/get-in letvar1847940 ["Warnings"]))) (letvar1847940 "StatusMessage") (clojure.core/assoc :status-message (deser-status-message (clojure.core/get-in letvar1847940 ["StatusMessage"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1847942 input] (clojure.core/let [rawinput1847941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1847943 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.textract/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9-_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract/id-list (clojure.spec.alpha/coll-of :portkey.aws.textract/non-empty-string))

(clojure.spec.alpha/def :portkey.aws.textract/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.textract/s-3-object-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*\S.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(^arn:([a-z\d-]+):sns:[a-zA-Z\d-]{1,20}:\w{12}:.+$)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.textract/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Za-z\.\-_]*" s__21078__auto__))))
