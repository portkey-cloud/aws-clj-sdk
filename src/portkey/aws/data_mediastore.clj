...
(clojure.core/defn delete-object ([delete-object-request] (portkey.aws/-rest-json-call portkey.aws.data-mediastore/endpoints "DELETE" "/{Path+}" delete-object-request :portkey.aws.data-mediastore/delete-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.data-mediastore/delete-object-response {"ContainerNotFoundException" :portkey.aws.data-mediastore/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.data-mediastore/object-not-found-exception, "InternalServerError" :portkey.aws.data-mediastore/internal-server-error})))
...
(clojure.core/defn describe-object ([describe-object-request] (portkey.aws/-rest-json-call portkey.aws.data-mediastore/endpoints "HEAD" "/{Path+}" describe-object-request :portkey.aws.data-mediastore/describe-object-request {:payload nil, :move {}, :headers {}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.data-mediastore/describe-object-response {"ContainerNotFoundException" :portkey.aws.data-mediastore/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.data-mediastore/object-not-found-exception, "InternalServerError" :portkey.aws.data-mediastore/internal-server-error})))
...
(clojure.core/defn get-object ([get-object-request] (portkey.aws/-rest-json-call portkey.aws.data-mediastore/endpoints "GET" "/{Path+}" get-object-request :portkey.aws.data-mediastore/get-object-request {:payload nil, :move {}, :headers {"Range" ["Range" nil]}, :uri {"Path" "Path"}, :querystring {}} nil :portkey.aws.data-mediastore/get-object-response {"ContainerNotFoundException" :portkey.aws.data-mediastore/container-not-found-exception, "ObjectNotFoundException" :portkey.aws.data-mediastore/object-not-found-exception, "RequestedRangeNotSatisfiableException" :portkey.aws.data-mediastore/requested-range-not-satisfiable-exception, "InternalServerError" :portkey.aws.data-mediastore/internal-server-error})))
