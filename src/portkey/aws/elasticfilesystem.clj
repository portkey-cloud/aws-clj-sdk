...
(clojure.core/defn describe-file-systems ([] (describe-file-systems {})) ([describe-file-systems-request] (portkey.aws/-rest-json-call portkey.aws.elasticfilesystem/endpoints "GET" "/2015-02-01/file-systems" describe-file-systems-request :portkey.aws.elasticfilesystem/describe-file-systems-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxItems" "MaxItems", "Marker" "Marker", "CreationToken" "CreationToken", "FileSystemId" "FileSystemId"}} 200 :portkey.aws.elasticfilesystem/describe-file-systems-response {"BadRequest" :portkey.aws.elasticfilesystem/bad-request, "InternalServerError" :portkey.aws.elasticfilesystem/internal-server-error, "FileSystemNotFound" :portkey.aws.elasticfilesystem/file-system-not-found})))
...
(clojure.core/defn create-mount-target ([create-mount-target-request] (portkey.aws/-rest-json-call portkey.aws.elasticfilesystem/endpoints "POST" "/2015-02-01/mount-targets" create-mount-target-request :portkey.aws.elasticfilesystem/create-mount-target-request {:payload nil, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.elasticfilesystem/mount-target-description {"UnsupportedAvailabilityZone" :portkey.aws.elasticfilesystem/unsupported-availability-zone, "BadRequest" :portkey.aws.elasticfilesystem/bad-request, "IpAddressInUse" :portkey.aws.elasticfilesystem/ip-address-in-use, "MountTargetConflict" :portkey.aws.elasticfilesystem/mount-target-conflict, "SecurityGroupLimitExceeded" :portkey.aws.elasticfilesystem/security-group-limit-exceeded, "SubnetNotFound" :portkey.aws.elasticfilesystem/subnet-not-found, "FileSystemNotFound" :portkey.aws.elasticfilesystem/file-system-not-found, "IncorrectFileSystemLifeCycleState" :portkey.aws.elasticfilesystem/incorrect-file-system-life-cycle-state, "SecurityGroupNotFound" :portkey.aws.elasticfilesystem/security-group-not-found, "NetworkInterfaceLimitExceeded" :portkey.aws.elasticfilesystem/network-interface-limit-exceeded, "InternalServerError" :portkey.aws.elasticfilesystem/internal-server-error, "NoFreeAddressesInSubnet" :portkey.aws.elasticfilesystem/no-free-addresses-in-subnet})))
...
(clojure.core/defn describe-mount-targets ([] (describe-mount-targets {})) ([describe-mount-targets-request] (portkey.aws/-rest-json-call portkey.aws.elasticfilesystem/endpoints "GET" "/2015-02-01/mount-targets" describe-mount-targets-request :portkey.aws.elasticfilesystem/describe-mount-targets-request {:payload nil, :headers {}, :uri {}, :querystring {"MaxItems" "MaxItems", "Marker" "Marker", "FileSystemId" "FileSystemId", "MountTargetId" "MountTargetId"}} 200 :portkey.aws.elasticfilesystem/describe-mount-targets-response {"BadRequest" :portkey.aws.elasticfilesystem/bad-request, "InternalServerError" :portkey.aws.elasticfilesystem/internal-server-error, "FileSystemNotFound" :portkey.aws.elasticfilesystem/file-system-not-found, "MountTargetNotFound" :portkey.aws.elasticfilesystem/mount-target-not-found})))
