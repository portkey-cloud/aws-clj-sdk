...
(clojure.core/defn- response-unsupported-availability-zone ([input] (response-unsupported-availability-zone nil input)) ([resultWrapper863177 input] (clojure.core/let [rawinput863176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863178 {"ErrorCode" (rawinput863176 "ErrorCode"), "Message" (rawinput863176 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863178 ["ErrorCode"]))} (letvar863178 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863178 ["Message"])))))))

(clojure.core/defn- response-describe-tags-response ([input] (response-describe-tags-response nil input)) ([resultWrapper863180 input] (clojure.core/let [rawinput863179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863181 {"Marker" (rawinput863179 "Marker"), "Tags" (rawinput863179 "Tags"), "NextMarker" (rawinput863179 "NextMarker")}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar863181 ["Tags"]))} (letvar863181 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar863181 ["Marker"]))) (letvar863181 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar863181 ["NextMarker"])))))))

(clojure.core/defn- response-bad-request ([input] (response-bad-request nil input)) ([resultWrapper863183 input] (clojure.core/let [rawinput863182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863184 {"ErrorCode" (rawinput863182 "ErrorCode"), "Message" (rawinput863182 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863184 ["ErrorCode"]))} (letvar863184 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863184 ["Message"])))))))

(clojure.core/defn- response-lifecycle-configuration-description ([input] (response-lifecycle-configuration-description nil input)) ([resultWrapper863186 input] (clojure.core/let [rawinput863185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863187 {"LifecyclePolicies" (rawinput863185 "LifecyclePolicies")}] (clojure.core/cond-> {} (letvar863187 "LifecyclePolicies") (clojure.core/assoc :lifecycle-policies (deser-lifecycle-policies (clojure.core/get-in letvar863187 ["LifecyclePolicies"])))))))

(clojure.core/defn- response-ip-address-in-use ([input] (response-ip-address-in-use nil input)) ([resultWrapper863189 input] (clojure.core/let [rawinput863188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863190 {"ErrorCode" (rawinput863188 "ErrorCode"), "Message" (rawinput863188 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863190 ["ErrorCode"]))} (letvar863190 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863190 ["Message"])))))))

(clojure.core/defn- response-file-system-limit-exceeded ([input] (response-file-system-limit-exceeded nil input)) ([resultWrapper863192 input] (clojure.core/let [rawinput863191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863193 {"ErrorCode" (rawinput863191 "ErrorCode"), "Message" (rawinput863191 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863193 ["ErrorCode"]))} (letvar863193 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863193 ["Message"])))))))

(clojure.core/defn- response-file-system-description ([input] (response-file-system-description nil input)) ([resultWrapper863195 input] (clojure.core/let [rawinput863194 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863196 {"ThroughputMode" (rawinput863194 "ThroughputMode"), "ProvisionedThroughputInMibps" (rawinput863194 "ProvisionedThroughputInMibps"), "LifeCycleState" (rawinput863194 "LifeCycleState"), "OwnerId" (rawinput863194 "OwnerId"), "Encrypted" (rawinput863194 "Encrypted"), "SizeInBytes" (rawinput863194 "SizeInBytes"), "Tags" (rawinput863194 "Tags"), "NumberOfMountTargets" (rawinput863194 "NumberOfMountTargets"), "FileSystemId" (rawinput863194 "FileSystemId"), "KmsKeyId" (rawinput863194 "KmsKeyId"), "CreationTime" (rawinput863194 "CreationTime"), "Name" (rawinput863194 "Name"), "CreationToken" (rawinput863194 "CreationToken"), "PerformanceMode" (rawinput863194 "PerformanceMode")}] (clojure.core/cond-> {:tags (deser-tags (clojure.core/get-in letvar863196 ["Tags"])), :creation-token (deser-creation-token (clojure.core/get-in letvar863196 ["CreationToken"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar863196 ["FileSystemId"])), :performance-mode (deser-performance-mode (clojure.core/get-in letvar863196 ["PerformanceMode"])), :size-in-bytes (deser-file-system-size (clojure.core/get-in letvar863196 ["SizeInBytes"])), :number-of-mount-targets (deser-mount-target-count (clojure.core/get-in letvar863196 ["NumberOfMountTargets"])), :owner-id (deser-aws-account-id (clojure.core/get-in letvar863196 ["OwnerId"])), :creation-time (deser-timestamp (clojure.core/get-in letvar863196 ["CreationTime"])), :life-cycle-state (deser-life-cycle-state (clojure.core/get-in letvar863196 ["LifeCycleState"]))} (letvar863196 "ThroughputMode") (clojure.core/assoc :throughput-mode (deser-throughput-mode (clojure.core/get-in letvar863196 ["ThroughputMode"]))) (letvar863196 "ProvisionedThroughputInMibps") (clojure.core/assoc :provisioned-throughput-in-mibps (deser-provisioned-throughput-in-mibps (clojure.core/get-in letvar863196 ["ProvisionedThroughputInMibps"]))) (letvar863196 "Encrypted") (clojure.core/assoc :encrypted (deser-encrypted (clojure.core/get-in letvar863196 ["Encrypted"]))) (letvar863196 "KmsKeyId") (clojure.core/assoc :kms-key-id (deser-kms-key-id (clojure.core/get-in letvar863196 ["KmsKeyId"]))) (letvar863196 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar863196 ["Name"])))))))

(clojure.core/defn- response-mount-target-conflict ([input] (response-mount-target-conflict nil input)) ([resultWrapper863198 input] (clojure.core/let [rawinput863197 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863199 {"ErrorCode" (rawinput863197 "ErrorCode"), "Message" (rawinput863197 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863199 ["ErrorCode"]))} (letvar863199 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863199 ["Message"])))))))

(clojure.core/defn- response-describe-file-systems-response ([input] (response-describe-file-systems-response nil input)) ([resultWrapper863201 input] (clojure.core/let [rawinput863200 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863202 {"Marker" (rawinput863200 "Marker"), "FileSystems" (rawinput863200 "FileSystems"), "NextMarker" (rawinput863200 "NextMarker")}] (clojure.core/cond-> {} (letvar863202 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar863202 ["Marker"]))) (letvar863202 "FileSystems") (clojure.core/assoc :file-systems (deser-file-system-descriptions (clojure.core/get-in letvar863202 ["FileSystems"]))) (letvar863202 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar863202 ["NextMarker"])))))))

(clojure.core/defn- response-security-group-limit-exceeded ([input] (response-security-group-limit-exceeded nil input)) ([resultWrapper863204 input] (clojure.core/let [rawinput863203 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863205 {"ErrorCode" (rawinput863203 "ErrorCode"), "Message" (rawinput863203 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863205 ["ErrorCode"]))} (letvar863205 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863205 ["Message"])))))))

(clojure.core/defn- response-mount-target-not-found ([input] (response-mount-target-not-found nil input)) ([resultWrapper863207 input] (clojure.core/let [rawinput863206 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863208 {"ErrorCode" (rawinput863206 "ErrorCode"), "Message" (rawinput863206 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863208 ["ErrorCode"]))} (letvar863208 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863208 ["Message"])))))))

(clojure.core/defn- response-incorrect-mount-target-state ([input] (response-incorrect-mount-target-state nil input)) ([resultWrapper863210 input] (clojure.core/let [rawinput863209 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863211 {"ErrorCode" (rawinput863209 "ErrorCode"), "Message" (rawinput863209 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863211 ["ErrorCode"]))} (letvar863211 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863211 ["Message"])))))))

(clojure.core/defn- response-subnet-not-found ([input] (response-subnet-not-found nil input)) ([resultWrapper863213 input] (clojure.core/let [rawinput863212 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863214 {"ErrorCode" (rawinput863212 "ErrorCode"), "Message" (rawinput863212 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863214 ["ErrorCode"]))} (letvar863214 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863214 ["Message"])))))))

(clojure.core/defn- response-describe-mount-targets-response ([input] (response-describe-mount-targets-response nil input)) ([resultWrapper863216 input] (clojure.core/let [rawinput863215 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863217 {"Marker" (rawinput863215 "Marker"), "MountTargets" (rawinput863215 "MountTargets"), "NextMarker" (rawinput863215 "NextMarker")}] (clojure.core/cond-> {} (letvar863217 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar863217 ["Marker"]))) (letvar863217 "MountTargets") (clojure.core/assoc :mount-targets (deser-mount-target-descriptions (clojure.core/get-in letvar863217 ["MountTargets"]))) (letvar863217 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar863217 ["NextMarker"])))))))

(clojure.core/defn- response-file-system-not-found ([input] (response-file-system-not-found nil input)) ([resultWrapper863219 input] (clojure.core/let [rawinput863218 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863220 {"ErrorCode" (rawinput863218 "ErrorCode"), "Message" (rawinput863218 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863220 ["ErrorCode"]))} (letvar863220 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863220 ["Message"])))))))

(clojure.core/defn- response-dependency-timeout ([input] (response-dependency-timeout nil input)) ([resultWrapper863222 input] (clojure.core/let [rawinput863221 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863223 {"ErrorCode" (rawinput863221 "ErrorCode"), "Message" (rawinput863221 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863223 ["ErrorCode"]))} (letvar863223 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863223 ["Message"])))))))

(clojure.core/defn- response-describe-mount-target-security-groups-response ([input] (response-describe-mount-target-security-groups-response nil input)) ([resultWrapper863225 input] (clojure.core/let [rawinput863224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863226 {"SecurityGroups" (rawinput863224 "SecurityGroups")}] (clojure.core/cond-> {:security-groups (deser-security-groups (clojure.core/get-in letvar863226 ["SecurityGroups"]))}))))

(clojure.core/defn- response-file-system-in-use ([input] (response-file-system-in-use nil input)) ([resultWrapper863228 input] (clojure.core/let [rawinput863227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863229 {"ErrorCode" (rawinput863227 "ErrorCode"), "Message" (rawinput863227 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863229 ["ErrorCode"]))} (letvar863229 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863229 ["Message"])))))))

(clojure.core/defn- response-insufficient-throughput-capacity ([input] (response-insufficient-throughput-capacity nil input)) ([resultWrapper863231 input] (clojure.core/let [rawinput863230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863232 {"ErrorCode" (rawinput863230 "ErrorCode"), "Message" (rawinput863230 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863232 ["ErrorCode"]))} (letvar863232 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863232 ["Message"])))))))

(clojure.core/defn- response-mount-target-description ([input] (response-mount-target-description nil input)) ([resultWrapper863234 input] (clojure.core/let [rawinput863233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863235 {"OwnerId" (rawinput863233 "OwnerId"), "MountTargetId" (rawinput863233 "MountTargetId"), "FileSystemId" (rawinput863233 "FileSystemId"), "SubnetId" (rawinput863233 "SubnetId"), "LifeCycleState" (rawinput863233 "LifeCycleState"), "IpAddress" (rawinput863233 "IpAddress"), "NetworkInterfaceId" (rawinput863233 "NetworkInterfaceId")}] (clojure.core/cond-> {:mount-target-id (deser-mount-target-id (clojure.core/get-in letvar863235 ["MountTargetId"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar863235 ["FileSystemId"])), :subnet-id (deser-subnet-id (clojure.core/get-in letvar863235 ["SubnetId"])), :life-cycle-state (deser-life-cycle-state (clojure.core/get-in letvar863235 ["LifeCycleState"]))} (letvar863235 "OwnerId") (clojure.core/assoc :owner-id (deser-aws-account-id (clojure.core/get-in letvar863235 ["OwnerId"]))) (letvar863235 "IpAddress") (clojure.core/assoc :ip-address (deser-ip-address (clojure.core/get-in letvar863235 ["IpAddress"]))) (letvar863235 "NetworkInterfaceId") (clojure.core/assoc :network-interface-id (deser-network-interface-id (clojure.core/get-in letvar863235 ["NetworkInterfaceId"])))))))

(clojure.core/defn- response-file-system-already-exists ([input] (response-file-system-already-exists nil input)) ([resultWrapper863237 input] (clojure.core/let [rawinput863236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863238 {"ErrorCode" (rawinput863236 "ErrorCode"), "Message" (rawinput863236 "Message"), "FileSystemId" (rawinput863236 "FileSystemId")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863238 ["ErrorCode"])), :file-system-id (deser-file-system-id (clojure.core/get-in letvar863238 ["FileSystemId"]))} (letvar863238 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863238 ["Message"])))))))

(clojure.core/defn- response-incorrect-file-system-life-cycle-state ([input] (response-incorrect-file-system-life-cycle-state nil input)) ([resultWrapper863240 input] (clojure.core/let [rawinput863239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863241 {"ErrorCode" (rawinput863239 "ErrorCode"), "Message" (rawinput863239 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863241 ["ErrorCode"]))} (letvar863241 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863241 ["Message"])))))))

(clojure.core/defn- response-too-many-requests ([input] (response-too-many-requests nil input)) ([resultWrapper863243 input] (clojure.core/let [rawinput863242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863244 {"ErrorCode" (rawinput863242 "ErrorCode"), "Message" (rawinput863242 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863244 ["ErrorCode"]))} (letvar863244 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863244 ["Message"])))))))

(clojure.core/defn- response-throughput-limit-exceeded ([input] (response-throughput-limit-exceeded nil input)) ([resultWrapper863246 input] (clojure.core/let [rawinput863245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863247 {"ErrorCode" (rawinput863245 "ErrorCode"), "Message" (rawinput863245 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863247 ["ErrorCode"]))} (letvar863247 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863247 ["Message"])))))))

(clojure.core/defn- response-security-group-not-found ([input] (response-security-group-not-found nil input)) ([resultWrapper863249 input] (clojure.core/let [rawinput863248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863250 {"ErrorCode" (rawinput863248 "ErrorCode"), "Message" (rawinput863248 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863250 ["ErrorCode"]))} (letvar863250 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863250 ["Message"])))))))

(clojure.core/defn- response-network-interface-limit-exceeded ([input] (response-network-interface-limit-exceeded nil input)) ([resultWrapper863252 input] (clojure.core/let [rawinput863251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863253 {"ErrorCode" (rawinput863251 "ErrorCode"), "Message" (rawinput863251 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863253 ["ErrorCode"]))} (letvar863253 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863253 ["Message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper863255 input] (clojure.core/let [rawinput863254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863256 {"ErrorCode" (rawinput863254 "ErrorCode"), "Message" (rawinput863254 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863256 ["ErrorCode"]))} (letvar863256 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863256 ["Message"])))))))

(clojure.core/defn- response-no-free-addresses-in-subnet ([input] (response-no-free-addresses-in-subnet nil input)) ([resultWrapper863258 input] (clojure.core/let [rawinput863257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar863259 {"ErrorCode" (rawinput863257 "ErrorCode"), "Message" (rawinput863257 "Message")}] (clojure.core/cond-> {:error-code (deser-error-code (clojure.core/get-in letvar863259 ["ErrorCode"]))} (letvar863259 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar863259 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.elasticfilesystem/creation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
