...
(clojure.core/defn- response-update-webhook-output ([input] (response-update-webhook-output nil input)) ([resultWrapper1548365 input] (clojure.core/let [rawinput1548364 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548366 {"webhook" (rawinput1548364 "webhook")}] (clojure.core/cond-> {} (letvar1548366 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1548366 ["webhook"])))))))

(clojure.core/defn- response-start-build-output ([input] (response-start-build-output nil input)) ([resultWrapper1548368 input] (clojure.core/let [rawinput1548367 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548369 {"build" (rawinput1548367 "build")}] (clojure.core/cond-> {} (letvar1548369 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1548369 ["build"])))))))

(clojure.core/defn- response-create-project-output ([input] (response-create-project-output nil input)) ([resultWrapper1548371 input] (clojure.core/let [rawinput1548370 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548372 {"project" (rawinput1548370 "project")}] (clojure.core/cond-> {} (letvar1548372 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1548372 ["project"])))))))

(clojure.core/defn- response-list-curated-environment-images-output ([input] (response-list-curated-environment-images-output nil input)) ([resultWrapper1548374 input] (clojure.core/let [rawinput1548373 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548375 {"platforms" (rawinput1548373 "platforms")}] (clojure.core/cond-> {} (letvar1548375 "platforms") (clojure.core/assoc :platforms (deser-environment-platforms (clojure.core/get-in letvar1548375 ["platforms"])))))))

(clojure.core/defn- response-invalidate-project-cache-output ([input] (response-invalidate-project-cache-output nil input)) ([resultWrapper1548377 input] (clojure.core/let [rawinput1548376 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548378 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-delete-builds-output ([input] (response-batch-delete-builds-output nil input)) ([resultWrapper1548380 input] (clojure.core/let [rawinput1548379 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548381 {"buildsDeleted" (rawinput1548379 "buildsDeleted"), "buildsNotDeleted" (rawinput1548379 "buildsNotDeleted")}] (clojure.core/cond-> {} (letvar1548381 "buildsDeleted") (clojure.core/assoc :builds-deleted (deser-build-ids (clojure.core/get-in letvar1548381 ["buildsDeleted"]))) (letvar1548381 "buildsNotDeleted") (clojure.core/assoc :builds-not-deleted (deser-builds-not-deleted (clojure.core/get-in letvar1548381 ["buildsNotDeleted"])))))))

(clojure.core/defn- response-account-limit-exceeded-exception ([input] (response-account-limit-exceeded-exception nil input)) ([resultWrapper1548383 input] (clojure.core/let [rawinput1548382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548384 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-projects-output ([input] (response-batch-get-projects-output nil input)) ([resultWrapper1548386 input] (clojure.core/let [rawinput1548385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548387 {"projects" (rawinput1548385 "projects"), "projectsNotFound" (rawinput1548385 "projectsNotFound")}] (clojure.core/cond-> {} (letvar1548387 "projects") (clojure.core/assoc :projects (deser-projects (clojure.core/get-in letvar1548387 ["projects"]))) (letvar1548387 "projectsNotFound") (clojure.core/assoc :projects-not-found (deser-project-names (clojure.core/get-in letvar1548387 ["projectsNotFound"])))))))

(clojure.core/defn- response-list-source-credentials-output ([input] (response-list-source-credentials-output nil input)) ([resultWrapper1548389 input] (clojure.core/let [rawinput1548388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548390 {"sourceCredentialsInfos" (rawinput1548388 "sourceCredentialsInfos")}] (clojure.core/cond-> {} (letvar1548390 "sourceCredentialsInfos") (clojure.core/assoc :source-credentials-infos (deser-source-credentials-infos (clojure.core/get-in letvar1548390 ["sourceCredentialsInfos"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1548392 input] (clojure.core/let [rawinput1548391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548393 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-source-credentials-output ([input] (response-delete-source-credentials-output nil input)) ([resultWrapper1548395 input] (clojure.core/let [rawinput1548394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548396 {"arn" (rawinput1548394 "arn")}] (clojure.core/cond-> {} (letvar1548396 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1548396 ["arn"])))))))

(clojure.core/defn- response-batch-get-builds-output ([input] (response-batch-get-builds-output nil input)) ([resultWrapper1548398 input] (clojure.core/let [rawinput1548397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548399 {"builds" (rawinput1548397 "builds"), "buildsNotFound" (rawinput1548397 "buildsNotFound")}] (clojure.core/cond-> {} (letvar1548399 "builds") (clojure.core/assoc :builds (deser-builds (clojure.core/get-in letvar1548399 ["builds"]))) (letvar1548399 "buildsNotFound") (clojure.core/assoc :builds-not-found (deser-build-ids (clojure.core/get-in letvar1548399 ["buildsNotFound"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper1548401 input] (clojure.core/let [rawinput1548400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548402 {"ids" (rawinput1548400 "ids"), "nextToken" (rawinput1548400 "nextToken")}] (clojure.core/cond-> {} (letvar1548402 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1548402 ["ids"]))) (letvar1548402 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1548402 ["nextToken"])))))))

(clojure.core/defn- response-list-projects-output ([input] (response-list-projects-output nil input)) ([resultWrapper1548404 input] (clojure.core/let [rawinput1548403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548405 {"nextToken" (rawinput1548403 "nextToken"), "projects" (rawinput1548403 "projects")}] (clojure.core/cond-> {} (letvar1548405 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1548405 ["nextToken"]))) (letvar1548405 "projects") (clojure.core/assoc :projects (deser-project-names (clojure.core/get-in letvar1548405 ["projects"])))))))

(clojure.core/defn- response-import-source-credentials-output ([input] (response-import-source-credentials-output nil input)) ([resultWrapper1548407 input] (clojure.core/let [rawinput1548406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548408 {"arn" (rawinput1548406 "arn")}] (clojure.core/cond-> {} (letvar1548408 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar1548408 ["arn"])))))))

(clojure.core/defn- response-o-auth-provider-exception ([input] (response-o-auth-provider-exception nil input)) ([resultWrapper1548410 input] (clojure.core/let [rawinput1548409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548411 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1548413 input] (clojure.core/let [rawinput1548412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548414 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-webhook-output ([input] (response-delete-webhook-output nil input)) ([resultWrapper1548416 input] (clojure.core/let [rawinput1548415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548417 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1548419 input] (clojure.core/let [rawinput1548418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548420 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-output ([input] (response-delete-project-output nil input)) ([resultWrapper1548422 input] (clojure.core/let [rawinput1548421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-webhook-output ([input] (response-create-webhook-output nil input)) ([resultWrapper1548425 input] (clojure.core/let [rawinput1548424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548426 {"webhook" (rawinput1548424 "webhook")}] (clojure.core/cond-> {} (letvar1548426 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar1548426 ["webhook"])))))))

(clojure.core/defn- response-list-builds-for-project-output ([input] (response-list-builds-for-project-output nil input)) ([resultWrapper1548428 input] (clojure.core/let [rawinput1548427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548429 {"ids" (rawinput1548427 "ids"), "nextToken" (rawinput1548427 "nextToken")}] (clojure.core/cond-> {} (letvar1548429 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar1548429 ["ids"]))) (letvar1548429 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1548429 ["nextToken"])))))))

(clojure.core/defn- response-update-project-output ([input] (response-update-project-output nil input)) ([resultWrapper1548431 input] (clojure.core/let [rawinput1548430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548432 {"project" (rawinput1548430 "project")}] (clojure.core/cond-> {} (letvar1548432 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar1548432 ["project"])))))))

(clojure.core/defn- response-stop-build-output ([input] (response-stop-build-output nil input)) ([resultWrapper1548434 input] (clojure.core/let [rawinput1548433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1548435 {"build" (rawinput1548433 "build")}] (clojure.core/cond-> {} (letvar1548435 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar1548435 ["build"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/sensitive-non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
