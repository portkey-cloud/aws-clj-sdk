...
(clojure.core/defn- response-update-webhook-output ([input] (response-update-webhook-output nil input)) ([resultWrapper384996 input] (clojure.core/let [rawinput384995 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar384997 {"webhook" (rawinput384995 "webhook")}] (clojure.core/cond-> {} (letvar384997 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar384997 ["webhook"])))))))

(clojure.core/defn- response-start-build-output ([input] (response-start-build-output nil input)) ([resultWrapper384999 input] (clojure.core/let [rawinput384998 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385000 {"build" (rawinput384998 "build")}] (clojure.core/cond-> {} (letvar385000 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar385000 ["build"])))))))

(clojure.core/defn- response-create-project-output ([input] (response-create-project-output nil input)) ([resultWrapper385002 input] (clojure.core/let [rawinput385001 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385003 {"project" (rawinput385001 "project")}] (clojure.core/cond-> {} (letvar385003 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar385003 ["project"])))))))

(clojure.core/defn- response-list-curated-environment-images-output ([input] (response-list-curated-environment-images-output nil input)) ([resultWrapper385005 input] (clojure.core/let [rawinput385004 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385006 {"platforms" (rawinput385004 "platforms")}] (clojure.core/cond-> {} (letvar385006 "platforms") (clojure.core/assoc :platforms (deser-environment-platforms (clojure.core/get-in letvar385006 ["platforms"])))))))

(clojure.core/defn- response-invalidate-project-cache-output ([input] (response-invalidate-project-cache-output nil input)) ([resultWrapper385008 input] (clojure.core/let [rawinput385007 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385009 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-delete-builds-output ([input] (response-batch-delete-builds-output nil input)) ([resultWrapper385011 input] (clojure.core/let [rawinput385010 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385012 {"buildsDeleted" (rawinput385010 "buildsDeleted"), "buildsNotDeleted" (rawinput385010 "buildsNotDeleted")}] (clojure.core/cond-> {} (letvar385012 "buildsDeleted") (clojure.core/assoc :builds-deleted (deser-build-ids (clojure.core/get-in letvar385012 ["buildsDeleted"]))) (letvar385012 "buildsNotDeleted") (clojure.core/assoc :builds-not-deleted (deser-builds-not-deleted (clojure.core/get-in letvar385012 ["buildsNotDeleted"])))))))

(clojure.core/defn- response-account-limit-exceeded-exception ([input] (response-account-limit-exceeded-exception nil input)) ([resultWrapper385014 input] (clojure.core/let [rawinput385013 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385015 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-projects-output ([input] (response-batch-get-projects-output nil input)) ([resultWrapper385017 input] (clojure.core/let [rawinput385016 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385018 {"projects" (rawinput385016 "projects"), "projectsNotFound" (rawinput385016 "projectsNotFound")}] (clojure.core/cond-> {} (letvar385018 "projects") (clojure.core/assoc :projects (deser-projects (clojure.core/get-in letvar385018 ["projects"]))) (letvar385018 "projectsNotFound") (clojure.core/assoc :projects-not-found (deser-project-names (clojure.core/get-in letvar385018 ["projectsNotFound"])))))))

(clojure.core/defn- response-list-source-credentials-output ([input] (response-list-source-credentials-output nil input)) ([resultWrapper385020 input] (clojure.core/let [rawinput385019 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385021 {"sourceCredentialsInfos" (rawinput385019 "sourceCredentialsInfos")}] (clojure.core/cond-> {} (letvar385021 "sourceCredentialsInfos") (clojure.core/assoc :source-credentials-infos (deser-source-credentials-infos (clojure.core/get-in letvar385021 ["sourceCredentialsInfos"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper385023 input] (clojure.core/let [rawinput385022 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385024 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-source-credentials-output ([input] (response-delete-source-credentials-output nil input)) ([resultWrapper385026 input] (clojure.core/let [rawinput385025 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385027 {"arn" (rawinput385025 "arn")}] (clojure.core/cond-> {} (letvar385027 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar385027 ["arn"])))))))

(clojure.core/defn- response-batch-get-builds-output ([input] (response-batch-get-builds-output nil input)) ([resultWrapper385029 input] (clojure.core/let [rawinput385028 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385030 {"builds" (rawinput385028 "builds"), "buildsNotFound" (rawinput385028 "buildsNotFound")}] (clojure.core/cond-> {} (letvar385030 "builds") (clojure.core/assoc :builds (deser-builds (clojure.core/get-in letvar385030 ["builds"]))) (letvar385030 "buildsNotFound") (clojure.core/assoc :builds-not-found (deser-build-ids (clojure.core/get-in letvar385030 ["buildsNotFound"])))))))

(clojure.core/defn- response-list-builds-output ([input] (response-list-builds-output nil input)) ([resultWrapper385032 input] (clojure.core/let [rawinput385031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385033 {"ids" (rawinput385031 "ids"), "nextToken" (rawinput385031 "nextToken")}] (clojure.core/cond-> {} (letvar385033 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar385033 ["ids"]))) (letvar385033 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar385033 ["nextToken"])))))))

(clojure.core/defn- response-list-projects-output ([input] (response-list-projects-output nil input)) ([resultWrapper385035 input] (clojure.core/let [rawinput385034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385036 {"nextToken" (rawinput385034 "nextToken"), "projects" (rawinput385034 "projects")}] (clojure.core/cond-> {} (letvar385036 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar385036 ["nextToken"]))) (letvar385036 "projects") (clojure.core/assoc :projects (deser-project-names (clojure.core/get-in letvar385036 ["projects"])))))))

(clojure.core/defn- response-import-source-credentials-output ([input] (response-import-source-credentials-output nil input)) ([resultWrapper385038 input] (clojure.core/let [rawinput385037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385039 {"arn" (rawinput385037 "arn")}] (clojure.core/cond-> {} (letvar385039 "arn") (clojure.core/assoc :arn (deser-non-empty-string (clojure.core/get-in letvar385039 ["arn"])))))))

(clojure.core/defn- response-o-auth-provider-exception ([input] (response-o-auth-provider-exception nil input)) ([resultWrapper385041 input] (clojure.core/let [rawinput385040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385042 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper385044 input] (clojure.core/let [rawinput385043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385045 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-webhook-output ([input] (response-delete-webhook-output nil input)) ([resultWrapper385047 input] (clojure.core/let [rawinput385046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385048 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper385050 input] (clojure.core/let [rawinput385049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385051 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-output ([input] (response-delete-project-output nil input)) ([resultWrapper385053 input] (clojure.core/let [rawinput385052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385054 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-webhook-output ([input] (response-create-webhook-output nil input)) ([resultWrapper385056 input] (clojure.core/let [rawinput385055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385057 {"webhook" (rawinput385055 "webhook")}] (clojure.core/cond-> {} (letvar385057 "webhook") (clojure.core/assoc :webhook (deser-webhook (clojure.core/get-in letvar385057 ["webhook"])))))))

(clojure.core/defn- response-list-builds-for-project-output ([input] (response-list-builds-for-project-output nil input)) ([resultWrapper385059 input] (clojure.core/let [rawinput385058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385060 {"ids" (rawinput385058 "ids"), "nextToken" (rawinput385058 "nextToken")}] (clojure.core/cond-> {} (letvar385060 "ids") (clojure.core/assoc :ids (deser-build-ids (clojure.core/get-in letvar385060 ["ids"]))) (letvar385060 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar385060 ["nextToken"])))))))

(clojure.core/defn- response-update-project-output ([input] (response-update-project-output nil input)) ([resultWrapper385062 input] (clojure.core/let [rawinput385061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385063 {"project" (rawinput385061 "project")}] (clojure.core/cond-> {} (letvar385063 "project") (clojure.core/assoc :project (deser-project (clojure.core/get-in letvar385063 ["project"])))))))

(clojure.core/defn- response-stop-build-output ([input] (response-stop-build-output nil input)) ([resultWrapper385065 input] (clojure.core/let [rawinput385064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385066 {"build" (rawinput385064 "build")}] (clojure.core/cond-> {} (letvar385066 "build") (clojure.core/assoc :build (deser-build (clojure.core/get-in letvar385066 ["build"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/value-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/sensitive-non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/key-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 127)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\\p{L}\\p{Z}\\p{N}_.:/=@+\\-]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.codebuild.-2016-10-06/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z0-9][A-Za-z0-9\-_]{1,254}" s__21078__auto__))))
