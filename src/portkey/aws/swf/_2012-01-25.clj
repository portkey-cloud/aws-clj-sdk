...
(clojure.core/defn- response-workflow-type-detail ([input] (response-workflow-type-detail nil input)) ([resultWrapper2118933 input] (clojure.core/let [rawinput2118932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118934 {"typeInfo" (rawinput2118932 "typeInfo"), "configuration" (rawinput2118932 "configuration")}] (clojure.core/cond-> {:type-info (deser-workflow-type-info (clojure.core/get-in letvar2118934 ["typeInfo"])), :configuration (deser-workflow-type-configuration (clojure.core/get-in letvar2118934 ["configuration"]))}))))

(clojure.core/defn- response-run ([input] (response-run nil input)) ([resultWrapper2118936 input] (clojure.core/let [rawinput2118935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118937 {"runId" (rawinput2118935 "runId")}] (clojure.core/cond-> {} (letvar2118937 "runId") (clojure.core/assoc :run-id (deser-workflow-run-id (clojure.core/get-in letvar2118937 ["runId"])))))))

(clojure.core/defn- response-workflow-type-infos ([input] (response-workflow-type-infos nil input)) ([resultWrapper2118939 input] (clojure.core/let [rawinput2118938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118940 {"typeInfos" (rawinput2118938 "typeInfos"), "nextPageToken" (rawinput2118938 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-workflow-type-info-list (clojure.core/get-in letvar2118940 ["typeInfos"]))} (letvar2118940 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118940 ["nextPageToken"])))))))

(clojure.core/defn- response-operation-not-permitted-fault ([input] (response-operation-not-permitted-fault nil input)) ([resultWrapper2118942 input] (clojure.core/let [rawinput2118941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118943 {"message" (rawinput2118941 "message")}] (clojure.core/cond-> {} (letvar2118943 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118943 ["message"])))))))

(clojure.core/defn- response-default-undefined-fault ([input] (response-default-undefined-fault nil input)) ([resultWrapper2118945 input] (clojure.core/let [rawinput2118944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118946 {"message" (rawinput2118944 "message")}] (clojure.core/cond-> {} (letvar2118946 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118946 ["message"])))))))

(clojure.core/defn- response-activity-task ([input] (response-activity-task nil input)) ([resultWrapper2118948 input] (clojure.core/let [rawinput2118947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118949 {"taskToken" (rawinput2118947 "taskToken"), "activityId" (rawinput2118947 "activityId"), "startedEventId" (rawinput2118947 "startedEventId"), "workflowExecution" (rawinput2118947 "workflowExecution"), "activityType" (rawinput2118947 "activityType"), "input" (rawinput2118947 "input")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar2118949 ["taskToken"])), :activity-id (deser-activity-id (clojure.core/get-in letvar2118949 ["activityId"])), :started-event-id (deser-event-id (clojure.core/get-in letvar2118949 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar2118949 ["workflowExecution"])), :activity-type (deser-activity-type (clojure.core/get-in letvar2118949 ["activityType"]))} (letvar2118949 "input") (clojure.core/assoc :input (deser-data (clojure.core/get-in letvar2118949 ["input"])))))))

(clojure.core/defn- response-decision-task ([input] (response-decision-task nil input)) ([resultWrapper2118951 input] (clojure.core/let [rawinput2118950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118952 {"taskToken" (rawinput2118950 "taskToken"), "startedEventId" (rawinput2118950 "startedEventId"), "workflowExecution" (rawinput2118950 "workflowExecution"), "workflowType" (rawinput2118950 "workflowType"), "events" (rawinput2118950 "events"), "nextPageToken" (rawinput2118950 "nextPageToken"), "previousStartedEventId" (rawinput2118950 "previousStartedEventId")}] (clojure.core/cond-> {:task-token (deser-task-token (clojure.core/get-in letvar2118952 ["taskToken"])), :started-event-id (deser-event-id (clojure.core/get-in letvar2118952 ["startedEventId"])), :workflow-execution (deser-workflow-execution (clojure.core/get-in letvar2118952 ["workflowExecution"])), :workflow-type (deser-workflow-type (clojure.core/get-in letvar2118952 ["workflowType"])), :events (deser-history-event-list (clojure.core/get-in letvar2118952 ["events"]))} (letvar2118952 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118952 ["nextPageToken"]))) (letvar2118952 "previousStartedEventId") (clojure.core/assoc :previous-started-event-id (deser-event-id (clojure.core/get-in letvar2118952 ["previousStartedEventId"])))))))

(clojure.core/defn- response-domain-infos ([input] (response-domain-infos nil input)) ([resultWrapper2118954 input] (clojure.core/let [rawinput2118953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118955 {"domainInfos" (rawinput2118953 "domainInfos"), "nextPageToken" (rawinput2118953 "nextPageToken")}] (clojure.core/cond-> {:domain-infos (deser-domain-info-list (clojure.core/get-in letvar2118955 ["domainInfos"]))} (letvar2118955 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118955 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-deprecated-fault ([input] (response-domain-deprecated-fault nil input)) ([resultWrapper2118957 input] (clojure.core/let [rawinput2118956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118958 {"message" (rawinput2118956 "message")}] (clojure.core/cond-> {} (letvar2118958 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118958 ["message"])))))))

(clojure.core/defn- response-history ([input] (response-history nil input)) ([resultWrapper2118960 input] (clojure.core/let [rawinput2118959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118961 {"events" (rawinput2118959 "events"), "nextPageToken" (rawinput2118959 "nextPageToken")}] (clojure.core/cond-> {:events (deser-history-event-list (clojure.core/get-in letvar2118961 ["events"]))} (letvar2118961 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118961 ["nextPageToken"])))))))

(clojure.core/defn- response-pending-task-count ([input] (response-pending-task-count nil input)) ([resultWrapper2118963 input] (clojure.core/let [rawinput2118962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118964 {"count" (rawinput2118962 "count"), "truncated" (rawinput2118962 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar2118964 ["count"]))} (letvar2118964 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar2118964 ["truncated"])))))))

(clojure.core/defn- response-workflow-execution-count ([input] (response-workflow-execution-count nil input)) ([resultWrapper2118966 input] (clojure.core/let [rawinput2118965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118967 {"count" (rawinput2118965 "count"), "truncated" (rawinput2118965 "truncated")}] (clojure.core/cond-> {:count (deser-count (clojure.core/get-in letvar2118967 ["count"]))} (letvar2118967 "truncated") (clojure.core/assoc :truncated (deser-truncated (clojure.core/get-in letvar2118967 ["truncated"])))))))

(clojure.core/defn- response-limit-exceeded-fault ([input] (response-limit-exceeded-fault nil input)) ([resultWrapper2118969 input] (clojure.core/let [rawinput2118968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118970 {"message" (rawinput2118968 "message")}] (clojure.core/cond-> {} (letvar2118970 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118970 ["message"])))))))

(clojure.core/defn- response-type-already-exists-fault ([input] (response-type-already-exists-fault nil input)) ([resultWrapper2118972 input] (clojure.core/let [rawinput2118971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118973 {"message" (rawinput2118971 "message")}] (clojure.core/cond-> {} (letvar2118973 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118973 ["message"])))))))

(clojure.core/defn- response-activity-type-detail ([input] (response-activity-type-detail nil input)) ([resultWrapper2118975 input] (clojure.core/let [rawinput2118974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118976 {"typeInfo" (rawinput2118974 "typeInfo"), "configuration" (rawinput2118974 "configuration")}] (clojure.core/cond-> {:type-info (deser-activity-type-info (clojure.core/get-in letvar2118976 ["typeInfo"])), :configuration (deser-activity-type-configuration (clojure.core/get-in letvar2118976 ["configuration"]))}))))

(clojure.core/defn- response-unknown-resource-fault ([input] (response-unknown-resource-fault nil input)) ([resultWrapper2118978 input] (clojure.core/let [rawinput2118977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118979 {"message" (rawinput2118977 "message")}] (clojure.core/cond-> {} (letvar2118979 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118979 ["message"])))))))

(clojure.core/defn- response-workflow-execution-detail ([input] (response-workflow-execution-detail nil input)) ([resultWrapper2118981 input] (clojure.core/let [rawinput2118980 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118982 {"executionInfo" (rawinput2118980 "executionInfo"), "executionConfiguration" (rawinput2118980 "executionConfiguration"), "openCounts" (rawinput2118980 "openCounts"), "latestActivityTaskTimestamp" (rawinput2118980 "latestActivityTaskTimestamp"), "latestExecutionContext" (rawinput2118980 "latestExecutionContext")}] (clojure.core/cond-> {:execution-info (deser-workflow-execution-info (clojure.core/get-in letvar2118982 ["executionInfo"])), :execution-configuration (deser-workflow-execution-configuration (clojure.core/get-in letvar2118982 ["executionConfiguration"])), :open-counts (deser-workflow-execution-open-counts (clojure.core/get-in letvar2118982 ["openCounts"]))} (letvar2118982 "latestActivityTaskTimestamp") (clojure.core/assoc :latest-activity-task-timestamp (deser-timestamp (clojure.core/get-in letvar2118982 ["latestActivityTaskTimestamp"]))) (letvar2118982 "latestExecutionContext") (clojure.core/assoc :latest-execution-context (deser-data (clojure.core/get-in letvar2118982 ["latestExecutionContext"])))))))

(clojure.core/defn- response-workflow-execution-already-started-fault ([input] (response-workflow-execution-already-started-fault nil input)) ([resultWrapper2118984 input] (clojure.core/let [rawinput2118983 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118985 {"message" (rawinput2118983 "message")}] (clojure.core/cond-> {} (letvar2118985 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118985 ["message"])))))))

(clojure.core/defn- response-domain-detail ([input] (response-domain-detail nil input)) ([resultWrapper2118987 input] (clojure.core/let [rawinput2118986 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118988 {"domainInfo" (rawinput2118986 "domainInfo"), "configuration" (rawinput2118986 "configuration")}] (clojure.core/cond-> {:domain-info (deser-domain-info (clojure.core/get-in letvar2118988 ["domainInfo"])), :configuration (deser-domain-configuration (clojure.core/get-in letvar2118988 ["configuration"]))}))))

(clojure.core/defn- response-workflow-execution-infos ([input] (response-workflow-execution-infos nil input)) ([resultWrapper2118990 input] (clojure.core/let [rawinput2118989 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118991 {"executionInfos" (rawinput2118989 "executionInfos"), "nextPageToken" (rawinput2118989 "nextPageToken")}] (clojure.core/cond-> {:execution-infos (deser-workflow-execution-info-list (clojure.core/get-in letvar2118991 ["executionInfos"]))} (letvar2118991 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2118991 ["nextPageToken"])))))))

(clojure.core/defn- response-domain-already-exists-fault ([input] (response-domain-already-exists-fault nil input)) ([resultWrapper2118993 input] (clojure.core/let [rawinput2118992 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118994 {"message" (rawinput2118992 "message")}] (clojure.core/cond-> {} (letvar2118994 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118994 ["message"])))))))

(clojure.core/defn- response-type-deprecated-fault ([input] (response-type-deprecated-fault nil input)) ([resultWrapper2118996 input] (clojure.core/let [rawinput2118995 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2118997 {"message" (rawinput2118995 "message")}] (clojure.core/cond-> {} (letvar2118997 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2118997 ["message"])))))))

(clojure.core/defn- response-activity-task-status ([input] (response-activity-task-status nil input)) ([resultWrapper2118999 input] (clojure.core/let [rawinput2118998 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2119000 {"cancelRequested" (rawinput2118998 "cancelRequested")}] (clojure.core/cond-> {:cancel-requested (deser-canceled (clojure.core/get-in letvar2119000 ["cancelRequested"]))}))))

(clojure.core/defn- response-activity-type-infos ([input] (response-activity-type-infos nil input)) ([resultWrapper2119002 input] (clojure.core/let [rawinput2119001 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2119003 {"typeInfos" (rawinput2119001 "typeInfos"), "nextPageToken" (rawinput2119001 "nextPageToken")}] (clojure.core/cond-> {:type-infos (deser-activity-type-info-list (clojure.core/get-in letvar2119003 ["typeInfos"]))} (letvar2119003 "nextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2119003 ["nextPageToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/workflow-run-id-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/limited-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/cause-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1728))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/duration-in-days (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/workflow-run-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/duration-in-seconds (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/duration-in-seconds-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/activity-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/failure-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/version-optional (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/marker-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/canceled clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/function-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/timer-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/identity (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/tag (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/task-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/function-input (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/signal-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/terminate-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/workflow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.swf.-2012-01-25/page-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.core/defn list-open-workflow-executions ([list-open-workflow-executions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-open-workflow-executions-input list-open-workflow-executions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-execution-infos, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/list-open-workflow-executions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListOpenWorkflowExecutions", :http.request.configuration/output-deser-fn response-workflow-execution-infos, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn register-domain ([register-domain-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-register-domain-input register-domain-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/register-domain-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "RegisterDomain", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"DomainAlreadyExistsFault" :portkey.aws.swf.-2012-01-25/domain-already-exists-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn count-pending-decision-tasks ([count-pending-decision-tasks-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-count-pending-decision-tasks-input count-pending-decision-tasks-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/pending-task-count, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/count-pending-decision-tasks-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CountPendingDecisionTasks", :http.request.configuration/output-deser-fn response-pending-task-count, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn poll-for-decision-task ([poll-for-decision-task-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-poll-for-decision-task-input poll-for-decision-task-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/decision-task, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/poll-for-decision-task-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "PollForDecisionTask", :http.request.configuration/output-deser-fn response-decision-task, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault}})))))
...
(clojure.core/defn list-closed-workflow-executions ([list-closed-workflow-executions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-closed-workflow-executions-input list-closed-workflow-executions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-execution-infos, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/list-closed-workflow-executions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListClosedWorkflowExecutions", :http.request.configuration/output-deser-fn response-workflow-execution-infos, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn list-domains ([list-domains-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-domains-input list-domains-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/domain-infos, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/list-domains-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListDomains", :http.request.configuration/output-deser-fn response-domain-infos, :http.request.spec/error-spec {"OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn describe-domain ([describe-domain-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-domain-input describe-domain-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/domain-detail, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/describe-domain-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeDomain", :http.request.configuration/output-deser-fn response-domain-detail, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn get-workflow-execution-history ([get-workflow-execution-history-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-get-workflow-execution-history-input get-workflow-execution-history-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/history, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/get-workflow-execution-history-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetWorkflowExecutionHistory", :http.request.configuration/output-deser-fn response-history, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn start-workflow-execution ([start-workflow-execution-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-start-workflow-execution-input start-workflow-execution-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/run, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/start-workflow-execution-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "StartWorkflowExecution", :http.request.configuration/output-deser-fn response-run, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "TypeDeprecatedFault" :portkey.aws.swf.-2012-01-25/type-deprecated-fault, "WorkflowExecutionAlreadyStartedFault" :portkey.aws.swf.-2012-01-25/workflow-execution-already-started-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault, "DefaultUndefinedFault" :portkey.aws.swf.-2012-01-25/default-undefined-fault}})))))
...
(clojure.core/defn register-activity-type ([register-activity-type-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-register-activity-type-input register-activity-type-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/register-activity-type-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "RegisterActivityType", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"TypeAlreadyExistsFault" :portkey.aws.swf.-2012-01-25/type-already-exists-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault, "UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn register-workflow-type ([register-workflow-type-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-register-workflow-type-input register-workflow-type-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/register-workflow-type-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "RegisterWorkflowType", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"TypeAlreadyExistsFault" :portkey.aws.swf.-2012-01-25/type-already-exists-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault, "UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn describe-workflow-type ([describe-workflow-type-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-workflow-type-input describe-workflow-type-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-type-detail, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/describe-workflow-type-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeWorkflowType", :http.request.configuration/output-deser-fn response-workflow-type-detail, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn poll-for-activity-task ([poll-for-activity-task-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-poll-for-activity-task-input poll-for-activity-task-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/activity-task, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/poll-for-activity-task-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "PollForActivityTask", :http.request.configuration/output-deser-fn response-activity-task, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault, "LimitExceededFault" :portkey.aws.swf.-2012-01-25/limit-exceeded-fault}})))))
...
(clojure.core/defn list-workflow-types ([list-workflow-types-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-workflow-types-input list-workflow-types-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-type-infos, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/list-workflow-types-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListWorkflowTypes", :http.request.configuration/output-deser-fn response-workflow-type-infos, :http.request.spec/error-spec {"OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault, "UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault}})))))
...
(clojure.core/defn deprecate-domain ([deprecate-domain-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-deprecate-domain-input deprecate-domain-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/deprecate-domain-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeprecateDomain", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "DomainDeprecatedFault" :portkey.aws.swf.-2012-01-25/domain-deprecated-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn describe-workflow-execution ([describe-workflow-execution-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-workflow-execution-input describe-workflow-execution-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-execution-detail, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/describe-workflow-execution-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeWorkflowExecution", :http.request.configuration/output-deser-fn response-workflow-execution-detail, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn count-open-workflow-executions ([count-open-workflow-executions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-count-open-workflow-executions-input count-open-workflow-executions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-execution-count, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/count-open-workflow-executions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CountOpenWorkflowExecutions", :http.request.configuration/output-deser-fn response-workflow-execution-count, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn list-activity-types ([list-activity-types-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-list-activity-types-input list-activity-types-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/activity-type-infos, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/list-activity-types-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "ListActivityTypes", :http.request.configuration/output-deser-fn response-activity-type-infos, :http.request.spec/error-spec {"OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault, "UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault}})))))
...
(clojure.core/defn describe-activity-type ([describe-activity-type-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-describe-activity-type-input describe-activity-type-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/activity-type-detail, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/describe-activity-type-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DescribeActivityType", :http.request.configuration/output-deser-fn response-activity-type-detail, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn count-closed-workflow-executions ([count-closed-workflow-executions-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-count-closed-workflow-executions-input count-closed-workflow-executions-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/workflow-execution-count, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/count-closed-workflow-executions-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CountClosedWorkflowExecutions", :http.request.configuration/output-deser-fn response-workflow-execution-count, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn count-pending-activity-tasks ([count-pending-activity-tasks-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-count-pending-activity-tasks-input count-pending-activity-tasks-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec :portkey.aws.swf.-2012-01-25/pending-task-count, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/count-pending-activity-tasks-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "CountPendingActivityTasks", :http.request.configuration/output-deser-fn response-pending-task-count, :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
...
(clojure.core/defn deprecate-workflow-type ([deprecate-workflow-type-inputinput] (clojure.core/let [request-function-result__1468878__auto__ (req-deprecate-workflow-type-input deprecate-workflow-type-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1468878__auto__ {:http.request.configuration/endpoints portkey.aws.swf.-2012-01-25/endpoints, :http.request.configuration/target-prefix "SimpleWorkflowService", :http.request.spec/output-spec nil, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.0"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2012-01-25", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.swf.-2012-01-25/deprecate-workflow-type-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "DeprecateWorkflowType", :http.request.configuration/output-deser-fn (clojure.core/fn [& args__1468877__auto__] {}), :http.request.spec/error-spec {"UnknownResourceFault" :portkey.aws.swf.-2012-01-25/unknown-resource-fault, "TypeDeprecatedFault" :portkey.aws.swf.-2012-01-25/type-deprecated-fault, "OperationNotPermittedFault" :portkey.aws.swf.-2012-01-25/operation-not-permitted-fault}})))))
