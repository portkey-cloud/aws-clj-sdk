...
(clojure.core/defn- response-list-service-actions-output ([input] (response-list-service-actions-output nil input)) ([resultWrapper2017685 input] (clojure.core/let [rawinput2017684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017686 {"ServiceActionSummaries" (rawinput2017684 "ServiceActionSummaries"), "NextPageToken" (rawinput2017684 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017686 "ServiceActionSummaries") (clojure.core/assoc :service-action-summaries (deser-service-action-summaries (clojure.core/get-in letvar2017686 ["ServiceActionSummaries"]))) (letvar2017686 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017686 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-view-output ([input] (response-describe-product-view-output nil input)) ([resultWrapper2017688 input] (clojure.core/let [rawinput2017687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017689 {"ProductViewSummary" (rawinput2017687 "ProductViewSummary"), "ProvisioningArtifacts" (rawinput2017687 "ProvisioningArtifacts")}] (clojure.core/cond-> {} (letvar2017689 "ProductViewSummary") (clojure.core/assoc :product-view-summary (deser-product-view-summary (clojure.core/get-in letvar2017689 ["ProductViewSummary"]))) (letvar2017689 "ProvisioningArtifacts") (clojure.core/assoc :provisioning-artifacts (deser-provisioning-artifacts (clojure.core/get-in letvar2017689 ["ProvisioningArtifacts"])))))))

(clojure.core/defn- response-execute-provisioned-product-plan-output ([input] (response-execute-provisioned-product-plan-output nil input)) ([resultWrapper2017691 input] (clojure.core/let [rawinput2017690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017692 {"RecordDetail" (rawinput2017690 "RecordDetail")}] (clojure.core/cond-> {} (letvar2017692 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017692 ["RecordDetail"])))))))

(clojure.core/defn- response-describe-provisioned-product-plan-output ([input] (response-describe-provisioned-product-plan-output nil input)) ([resultWrapper2017694 input] (clojure.core/let [rawinput2017693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017695 {"ProvisionedProductPlanDetails" (rawinput2017693 "ProvisionedProductPlanDetails"), "ResourceChanges" (rawinput2017693 "ResourceChanges"), "NextPageToken" (rawinput2017693 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017695 "ProvisionedProductPlanDetails") (clojure.core/assoc :provisioned-product-plan-details (deser-provisioned-product-plan-details (clojure.core/get-in letvar2017695 ["ProvisionedProductPlanDetails"]))) (letvar2017695 "ResourceChanges") (clojure.core/assoc :resource-changes (deser-resource-changes (clojure.core/get-in letvar2017695 ["ResourceChanges"]))) (letvar2017695 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017695 ["NextPageToken"])))))))

(clojure.core/defn- response-update-provisioned-product-output ([input] (response-update-provisioned-product-output nil input)) ([resultWrapper2017697 input] (clojure.core/let [rawinput2017696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017698 {"RecordDetail" (rawinput2017696 "RecordDetail")}] (clojure.core/cond-> {} (letvar2017698 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017698 ["RecordDetail"])))))))

(clojure.core/defn- response-associate-product-with-portfolio-output ([input] (response-associate-product-with-portfolio-output nil input)) ([resultWrapper2017700 input] (clojure.core/let [rawinput2017699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017701 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-tag-option-from-resource-output ([input] (response-disassociate-tag-option-from-resource-output nil input)) ([resultWrapper2017703 input] (clojure.core/let [rawinput2017702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017704 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-provision-product-output ([input] (response-provision-product-output nil input)) ([resultWrapper2017706 input] (clojure.core/let [rawinput2017705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017707 {"RecordDetail" (rawinput2017705 "RecordDetail")}] (clojure.core/cond-> {} (letvar2017707 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017707 ["RecordDetail"])))))))

(clojure.core/defn- response-accept-portfolio-share-output ([input] (response-accept-portfolio-share-output nil input)) ([resultWrapper2017709 input] (clojure.core/let [rawinput2017708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017710 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-portfolios-output ([input] (response-list-portfolios-output nil input)) ([resultWrapper2017712 input] (clojure.core/let [rawinput2017711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017713 {"PortfolioDetails" (rawinput2017711 "PortfolioDetails"), "NextPageToken" (rawinput2017711 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017713 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2017713 ["PortfolioDetails"]))) (letvar2017713 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017713 ["NextPageToken"])))))))

(clojure.core/defn- response-create-tag-option-output ([input] (response-create-tag-option-output nil input)) ([resultWrapper2017715 input] (clojure.core/let [rawinput2017714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017716 {"TagOptionDetail" (rawinput2017714 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2017716 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2017716 ["TagOptionDetail"])))))))

(clojure.core/defn- response-disassociate-product-from-portfolio-output ([input] (response-disassociate-product-from-portfolio-output nil input)) ([resultWrapper2017718 input] (clojure.core/let [rawinput2017717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017719 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-terminate-provisioned-product-output ([input] (response-terminate-provisioned-product-output nil input)) ([resultWrapper2017721 input] (clojure.core/let [rawinput2017720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017722 {"RecordDetail" (rawinput2017720 "RecordDetail")}] (clojure.core/cond-> {} (letvar2017722 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017722 ["RecordDetail"])))))))

(clojure.core/defn- response-search-provisioned-products-output ([input] (response-search-provisioned-products-output nil input)) ([resultWrapper2017724 input] (clojure.core/let [rawinput2017723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017725 {"ProvisionedProducts" (rawinput2017723 "ProvisionedProducts"), "TotalResultsCount" (rawinput2017723 "TotalResultsCount"), "NextPageToken" (rawinput2017723 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017725 "ProvisionedProducts") (clojure.core/assoc :provisioned-products (deser-provisioned-product-attributes (clojure.core/get-in letvar2017725 ["ProvisionedProducts"]))) (letvar2017725 "TotalResultsCount") (clojure.core/assoc :total-results-count (deser-total-results-count (clojure.core/get-in letvar2017725 ["TotalResultsCount"]))) (letvar2017725 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017725 ["NextPageToken"])))))))

(clojure.core/defn- response-create-portfolio-share-output ([input] (response-create-portfolio-share-output nil input)) ([resultWrapper2017727 input] (clojure.core/let [rawinput2017726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017728 {"PortfolioShareToken" (rawinput2017726 "PortfolioShareToken")}] (clojure.core/cond-> {} (letvar2017728 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2017728 ["PortfolioShareToken"])))))))

(clojure.core/defn- response-update-tag-option-output ([input] (response-update-tag-option-output nil input)) ([resultWrapper2017730 input] (clojure.core/let [rawinput2017729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017731 {"TagOptionDetail" (rawinput2017729 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2017731 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2017731 ["TagOptionDetail"])))))))

(clojure.core/defn- response-get-aws-organizations-access-status-output ([input] (response-get-aws-organizations-access-status-output nil input)) ([resultWrapper2017733 input] (clojure.core/let [rawinput2017732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017734 {"AccessStatus" (rawinput2017732 "AccessStatus")}] (clojure.core/cond-> {} (letvar2017734 "AccessStatus") (clojure.core/assoc :access-status (deser-access-status (clojure.core/get-in letvar2017734 ["AccessStatus"])))))))

(clojure.core/defn- response-delete-product-output ([input] (response-delete-product-output nil input)) ([resultWrapper2017736 input] (clojure.core/let [rawinput2017735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017737 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-constraint-output ([input] (response-update-constraint-output nil input)) ([resultWrapper2017739 input] (clojure.core/let [rawinput2017738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017740 {"ConstraintDetail" (rawinput2017738 "ConstraintDetail"), "ConstraintParameters" (rawinput2017738 "ConstraintParameters"), "Status" (rawinput2017738 "Status")}] (clojure.core/cond-> {} (letvar2017740 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2017740 ["ConstraintDetail"]))) (letvar2017740 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2017740 ["ConstraintParameters"]))) (letvar2017740 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017740 ["Status"])))))))

(clojure.core/defn- response-list-constraints-for-portfolio-output ([input] (response-list-constraints-for-portfolio-output nil input)) ([resultWrapper2017742 input] (clojure.core/let [rawinput2017741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017743 {"ConstraintDetails" (rawinput2017741 "ConstraintDetails"), "NextPageToken" (rawinput2017741 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017743 "ConstraintDetails") (clojure.core/assoc :constraint-details (deser-constraint-details (clojure.core/get-in letvar2017743 ["ConstraintDetails"]))) (letvar2017743 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017743 ["NextPageToken"])))))))

(clojure.core/defn- response-list-tag-options-output ([input] (response-list-tag-options-output nil input)) ([resultWrapper2017745 input] (clojure.core/let [rawinput2017744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017746 {"TagOptionDetails" (rawinput2017744 "TagOptionDetails"), "PageToken" (rawinput2017744 "PageToken")}] (clojure.core/cond-> {} (letvar2017746 "TagOptionDetails") (clojure.core/assoc :tag-option-details (deser-tag-option-details (clojure.core/get-in letvar2017746 ["TagOptionDetails"]))) (letvar2017746 "PageToken") (clojure.core/assoc :page-token (deser-page-token (clojure.core/get-in letvar2017746 ["PageToken"])))))))

(clojure.core/defn- response-list-accepted-portfolio-shares-output ([input] (response-list-accepted-portfolio-shares-output nil input)) ([resultWrapper2017748 input] (clojure.core/let [rawinput2017747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017749 {"PortfolioDetails" (rawinput2017747 "PortfolioDetails"), "NextPageToken" (rawinput2017747 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017749 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2017749 ["PortfolioDetails"]))) (letvar2017749 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017749 ["NextPageToken"])))))))

(clojure.core/defn- response-delete-service-action-output ([input] (response-delete-service-action-output nil input)) ([resultWrapper2017751 input] (clojure.core/let [rawinput2017750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017752 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-principals-for-portfolio-output ([input] (response-list-principals-for-portfolio-output nil input)) ([resultWrapper2017754 input] (clojure.core/let [rawinput2017753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017755 {"Principals" (rawinput2017753 "Principals"), "NextPageToken" (rawinput2017753 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017755 "Principals") (clojure.core/assoc :principals (deser-principals (clojure.core/get-in letvar2017755 ["Principals"]))) (letvar2017755 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017755 ["NextPageToken"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper2017757 input] (clojure.core/let [rawinput2017756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017758 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-principal-from-portfolio-output ([input] (response-disassociate-principal-from-portfolio-output nil input)) ([resultWrapper2017760 input] (clojure.core/let [rawinput2017759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017761 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2017763 input] (clojure.core/let [rawinput2017762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017764 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-provisioning-artifacts-for-service-action-output ([input] (response-list-provisioning-artifacts-for-service-action-output nil input)) ([resultWrapper2017766 input] (clojure.core/let [rawinput2017765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017767 {"ProvisioningArtifactViews" (rawinput2017765 "ProvisioningArtifactViews"), "NextPageToken" (rawinput2017765 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017767 "ProvisioningArtifactViews") (clojure.core/assoc :provisioning-artifact-views (deser-provisioning-artifact-views (clojure.core/get-in letvar2017767 ["ProvisioningArtifactViews"]))) (letvar2017767 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017767 ["NextPageToken"])))))))

(clojure.core/defn- response-search-products-as-admin-output ([input] (response-search-products-as-admin-output nil input)) ([resultWrapper2017769 input] (clojure.core/let [rawinput2017768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017770 {"ProductViewDetails" (rawinput2017768 "ProductViewDetails"), "NextPageToken" (rawinput2017768 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017770 "ProductViewDetails") (clojure.core/assoc :product-view-details (deser-product-view-details (clojure.core/get-in letvar2017770 ["ProductViewDetails"]))) (letvar2017770 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017770 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-tag-option-output ([input] (response-describe-tag-option-output nil input)) ([resultWrapper2017772 input] (clojure.core/let [rawinput2017771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017773 {"TagOptionDetail" (rawinput2017771 "TagOptionDetail")}] (clojure.core/cond-> {} (letvar2017773 "TagOptionDetail") (clojure.core/assoc :tag-option-detail (deser-tag-option-detail (clojure.core/get-in letvar2017773 ["TagOptionDetail"])))))))

(clojure.core/defn- response-delete-tag-option-output ([input] (response-delete-tag-option-output nil input)) ([resultWrapper2017775 input] (clojure.core/let [rawinput2017774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017776 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-principal-with-portfolio-output ([input] (response-associate-principal-with-portfolio-output nil input)) ([resultWrapper2017778 input] (clojure.core/let [rawinput2017777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017779 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disable-aws-organizations-access-output ([input] (response-disable-aws-organizations-access-output nil input)) ([resultWrapper2017781 input] (clojure.core/let [rawinput2017780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017782 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-provisioning-artifact-output ([input] (response-update-provisioning-artifact-output nil input)) ([resultWrapper2017784 input] (clojure.core/let [rawinput2017783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017785 {"ProvisioningArtifactDetail" (rawinput2017783 "ProvisioningArtifactDetail"), "Info" (rawinput2017783 "Info"), "Status" (rawinput2017783 "Status")}] (clojure.core/cond-> {} (letvar2017785 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2017785 ["ProvisioningArtifactDetail"]))) (letvar2017785 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2017785 ["Info"]))) (letvar2017785 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017785 ["Status"])))))))

(clojure.core/defn- response-invalid-parameters-exception ([input] (response-invalid-parameters-exception nil input)) ([resultWrapper2017787 input] (clojure.core/let [rawinput2017786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017788 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-service-action-with-provisioning-artifact-output ([input] (response-associate-service-action-with-provisioning-artifact-output nil input)) ([resultWrapper2017790 input] (clojure.core/let [rawinput2017789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017791 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-provisioned-product-plan-output ([input] (response-create-provisioned-product-plan-output nil input)) ([resultWrapper2017793 input] (clojure.core/let [rawinput2017792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017794 {"PlanName" (rawinput2017792 "PlanName"), "PlanId" (rawinput2017792 "PlanId"), "ProvisionProductId" (rawinput2017792 "ProvisionProductId"), "ProvisionedProductName" (rawinput2017792 "ProvisionedProductName"), "ProvisioningArtifactId" (rawinput2017792 "ProvisioningArtifactId")}] (clojure.core/cond-> {} (letvar2017794 "PlanName") (clojure.core/assoc :plan-name (deser-provisioned-product-plan-name (clojure.core/get-in letvar2017794 ["PlanName"]))) (letvar2017794 "PlanId") (clojure.core/assoc :plan-id (deser-id (clojure.core/get-in letvar2017794 ["PlanId"]))) (letvar2017794 "ProvisionProductId") (clojure.core/assoc :provision-product-id (deser-id (clojure.core/get-in letvar2017794 ["ProvisionProductId"]))) (letvar2017794 "ProvisionedProductName") (clojure.core/assoc :provisioned-product-name (deser-provisioned-product-name (clojure.core/get-in letvar2017794 ["ProvisionedProductName"]))) (letvar2017794 "ProvisioningArtifactId") (clojure.core/assoc :provisioning-artifact-id (deser-id (clojure.core/get-in letvar2017794 ["ProvisioningArtifactId"])))))))

(clojure.core/defn- response-create-product-output ([input] (response-create-product-output nil input)) ([resultWrapper2017796 input] (clojure.core/let [rawinput2017795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017797 {"ProductViewDetail" (rawinput2017795 "ProductViewDetail"), "ProvisioningArtifactDetail" (rawinput2017795 "ProvisioningArtifactDetail"), "Tags" (rawinput2017795 "Tags")}] (clojure.core/cond-> {} (letvar2017797 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2017797 ["ProductViewDetail"]))) (letvar2017797 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2017797 ["ProvisioningArtifactDetail"]))) (letvar2017797 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017797 ["Tags"])))))))

(clojure.core/defn- response-list-record-history-output ([input] (response-list-record-history-output nil input)) ([resultWrapper2017799 input] (clojure.core/let [rawinput2017798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017800 {"RecordDetails" (rawinput2017798 "RecordDetails"), "NextPageToken" (rawinput2017798 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017800 "RecordDetails") (clojure.core/assoc :record-details (deser-record-details (clojure.core/get-in letvar2017800 ["RecordDetails"]))) (letvar2017800 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017800 ["NextPageToken"])))))))

(clojure.core/defn- response-delete-portfolio-output ([input] (response-delete-portfolio-output nil input)) ([resultWrapper2017802 input] (clojure.core/let [rawinput2017801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017803 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-service-action-output ([input] (response-describe-service-action-output nil input)) ([resultWrapper2017805 input] (clojure.core/let [rawinput2017804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017806 {"ServiceActionDetail" (rawinput2017804 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2017806 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2017806 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-delete-portfolio-share-output ([input] (response-delete-portfolio-share-output nil input)) ([resultWrapper2017808 input] (clojure.core/let [rawinput2017807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017809 {"PortfolioShareToken" (rawinput2017807 "PortfolioShareToken")}] (clojure.core/cond-> {} (letvar2017809 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2017809 ["PortfolioShareToken"])))))))

(clojure.core/defn- response-describe-provisioning-artifact-output ([input] (response-describe-provisioning-artifact-output nil input)) ([resultWrapper2017811 input] (clojure.core/let [rawinput2017810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017812 {"ProvisioningArtifactDetail" (rawinput2017810 "ProvisioningArtifactDetail"), "Info" (rawinput2017810 "Info"), "Status" (rawinput2017810 "Status")}] (clojure.core/cond-> {} (letvar2017812 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2017812 ["ProvisioningArtifactDetail"]))) (letvar2017812 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2017812 ["Info"]))) (letvar2017812 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017812 ["Status"])))))))

(clojure.core/defn- response-enable-aws-organizations-access-output ([input] (response-enable-aws-organizations-access-output nil input)) ([resultWrapper2017814 input] (clojure.core/let [rawinput2017813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017815 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-portfolio-output ([input] (response-create-portfolio-output nil input)) ([resultWrapper2017817 input] (clojure.core/let [rawinput2017816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017818 {"PortfolioDetail" (rawinput2017816 "PortfolioDetail"), "Tags" (rawinput2017816 "Tags")}] (clojure.core/cond-> {} (letvar2017818 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2017818 ["PortfolioDetail"]))) (letvar2017818 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017818 ["Tags"])))))))

(clojure.core/defn- response-describe-copy-product-status-output ([input] (response-describe-copy-product-status-output nil input)) ([resultWrapper2017820 input] (clojure.core/let [rawinput2017819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017821 {"CopyProductStatus" (rawinput2017819 "CopyProductStatus"), "TargetProductId" (rawinput2017819 "TargetProductId"), "StatusDetail" (rawinput2017819 "StatusDetail")}] (clojure.core/cond-> {} (letvar2017821 "CopyProductStatus") (clojure.core/assoc :copy-product-status (deser-copy-product-status (clojure.core/get-in letvar2017821 ["CopyProductStatus"]))) (letvar2017821 "TargetProductId") (clojure.core/assoc :target-product-id (deser-id (clojure.core/get-in letvar2017821 ["TargetProductId"]))) (letvar2017821 "StatusDetail") (clojure.core/assoc :status-detail (deser-status-detail (clojure.core/get-in letvar2017821 ["StatusDetail"])))))))

(clojure.core/defn- response-delete-constraint-output ([input] (response-delete-constraint-output nil input)) ([resultWrapper2017823 input] (clojure.core/let [rawinput2017822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017824 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-service-actions-for-provisioning-artifact-output ([input] (response-list-service-actions-for-provisioning-artifact-output nil input)) ([resultWrapper2017826 input] (clojure.core/let [rawinput2017825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017827 {"ServiceActionSummaries" (rawinput2017825 "ServiceActionSummaries"), "NextPageToken" (rawinput2017825 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017827 "ServiceActionSummaries") (clojure.core/assoc :service-action-summaries (deser-service-action-summaries (clojure.core/get-in letvar2017827 ["ServiceActionSummaries"]))) (letvar2017827 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017827 ["NextPageToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2017829 input] (clojure.core/let [rawinput2017828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017830 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-product-output ([input] (response-update-product-output nil input)) ([resultWrapper2017832 input] (clojure.core/let [rawinput2017831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017833 {"ProductViewDetail" (rawinput2017831 "ProductViewDetail"), "Tags" (rawinput2017831 "Tags")}] (clojure.core/cond-> {} (letvar2017833 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2017833 ["ProductViewDetail"]))) (letvar2017833 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017833 ["Tags"])))))))

(clojure.core/defn- response-delete-provisioning-artifact-output ([input] (response-delete-provisioning-artifact-output nil input)) ([resultWrapper2017835 input] (clojure.core/let [rawinput2017834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017836 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resources-for-tag-option-output ([input] (response-list-resources-for-tag-option-output nil input)) ([resultWrapper2017838 input] (clojure.core/let [rawinput2017837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017839 {"ResourceDetails" (rawinput2017837 "ResourceDetails"), "PageToken" (rawinput2017837 "PageToken")}] (clojure.core/cond-> {} (letvar2017839 "ResourceDetails") (clojure.core/assoc :resource-details (deser-resource-details (clojure.core/get-in letvar2017839 ["ResourceDetails"]))) (letvar2017839 "PageToken") (clojure.core/assoc :page-token (deser-page-token (clojure.core/get-in letvar2017839 ["PageToken"])))))))

(clojure.core/defn- response-list-portfolio-access-output ([input] (response-list-portfolio-access-output nil input)) ([resultWrapper2017841 input] (clojure.core/let [rawinput2017840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017842 {"AccountIds" (rawinput2017840 "AccountIds"), "NextPageToken" (rawinput2017840 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017842 "AccountIds") (clojure.core/assoc :account-ids (deser-account-ids (clojure.core/get-in letvar2017842 ["AccountIds"]))) (letvar2017842 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017842 ["NextPageToken"])))))))

(clojure.core/defn- response-list-provisioned-product-plans-output ([input] (response-list-provisioned-product-plans-output nil input)) ([resultWrapper2017844 input] (clojure.core/let [rawinput2017843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017845 {"ProvisionedProductPlans" (rawinput2017843 "ProvisionedProductPlans"), "NextPageToken" (rawinput2017843 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017845 "ProvisionedProductPlans") (clojure.core/assoc :provisioned-product-plans (deser-provisioned-product-plans (clojure.core/get-in letvar2017845 ["ProvisionedProductPlans"]))) (letvar2017845 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017845 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-portfolio-share-status-output ([input] (response-describe-portfolio-share-status-output nil input)) ([resultWrapper2017847 input] (clojure.core/let [rawinput2017846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017848 {"PortfolioShareToken" (rawinput2017846 "PortfolioShareToken"), "PortfolioId" (rawinput2017846 "PortfolioId"), "OrganizationNodeValue" (rawinput2017846 "OrganizationNodeValue"), "Status" (rawinput2017846 "Status"), "ShareDetails" (rawinput2017846 "ShareDetails")}] (clojure.core/cond-> {} (letvar2017848 "PortfolioShareToken") (clojure.core/assoc :portfolio-share-token (deser-portfolio-share-token (clojure.core/get-in letvar2017848 ["PortfolioShareToken"]))) (letvar2017848 "PortfolioId") (clojure.core/assoc :portfolio-id (deser-id (clojure.core/get-in letvar2017848 ["PortfolioId"]))) (letvar2017848 "OrganizationNodeValue") (clojure.core/assoc :organization-node-value (deser-organization-node-value (clojure.core/get-in letvar2017848 ["OrganizationNodeValue"]))) (letvar2017848 "Status") (clojure.core/assoc :status (deser-share-status (clojure.core/get-in letvar2017848 ["Status"]))) (letvar2017848 "ShareDetails") (clojure.core/assoc :share-details (deser-share-details (clojure.core/get-in letvar2017848 ["ShareDetails"])))))))

(clojure.core/defn- response-reject-portfolio-share-output ([input] (response-reject-portfolio-share-output nil input)) ([resultWrapper2017850 input] (clojure.core/let [rawinput2017849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017851 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-constraint-output ([input] (response-create-constraint-output nil input)) ([resultWrapper2017853 input] (clojure.core/let [rawinput2017852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017854 {"ConstraintDetail" (rawinput2017852 "ConstraintDetail"), "ConstraintParameters" (rawinput2017852 "ConstraintParameters"), "Status" (rawinput2017852 "Status")}] (clojure.core/cond-> {} (letvar2017854 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2017854 ["ConstraintDetail"]))) (letvar2017854 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2017854 ["ConstraintParameters"]))) (letvar2017854 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017854 ["Status"])))))))

(clojure.core/defn- response-batch-associate-service-action-with-provisioning-artifact-output ([input] (response-batch-associate-service-action-with-provisioning-artifact-output nil input)) ([resultWrapper2017856 input] (clojure.core/let [rawinput2017855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017857 {"FailedServiceActionAssociations" (rawinput2017855 "FailedServiceActionAssociations")}] (clojure.core/cond-> {} (letvar2017857 "FailedServiceActionAssociations") (clojure.core/assoc :failed-service-action-associations (deser-failed-service-action-associations (clojure.core/get-in letvar2017857 ["FailedServiceActionAssociations"])))))))

(clojure.core/defn- response-operation-not-supported-exception ([input] (response-operation-not-supported-exception nil input)) ([resultWrapper2017859 input] (clojure.core/let [rawinput2017858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017860 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-portfolios-for-product-output ([input] (response-list-portfolios-for-product-output nil input)) ([resultWrapper2017862 input] (clojure.core/let [rawinput2017861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017863 {"PortfolioDetails" (rawinput2017861 "PortfolioDetails"), "NextPageToken" (rawinput2017861 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017863 "PortfolioDetails") (clojure.core/assoc :portfolio-details (deser-portfolio-details (clojure.core/get-in letvar2017863 ["PortfolioDetails"]))) (letvar2017863 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017863 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-provisioning-parameters-output ([input] (response-describe-provisioning-parameters-output nil input)) ([resultWrapper2017865 input] (clojure.core/let [rawinput2017864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017866 {"ProvisioningArtifactParameters" (rawinput2017864 "ProvisioningArtifactParameters"), "ConstraintSummaries" (rawinput2017864 "ConstraintSummaries"), "UsageInstructions" (rawinput2017864 "UsageInstructions"), "TagOptions" (rawinput2017864 "TagOptions"), "ProvisioningArtifactPreferences" (rawinput2017864 "ProvisioningArtifactPreferences")}] (clojure.core/cond-> {} (letvar2017866 "ProvisioningArtifactParameters") (clojure.core/assoc :provisioning-artifact-parameters (deser-provisioning-artifact-parameters (clojure.core/get-in letvar2017866 ["ProvisioningArtifactParameters"]))) (letvar2017866 "ConstraintSummaries") (clojure.core/assoc :constraint-summaries (deser-constraint-summaries (clojure.core/get-in letvar2017866 ["ConstraintSummaries"]))) (letvar2017866 "UsageInstructions") (clojure.core/assoc :usage-instructions (deser-usage-instructions (clojure.core/get-in letvar2017866 ["UsageInstructions"]))) (letvar2017866 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-summaries (clojure.core/get-in letvar2017866 ["TagOptions"]))) (letvar2017866 "ProvisioningArtifactPreferences") (clojure.core/assoc :provisioning-artifact-preferences (deser-provisioning-artifact-preferences (clojure.core/get-in letvar2017866 ["ProvisioningArtifactPreferences"])))))))

(clojure.core/defn- response-execute-provisioned-product-service-action-output ([input] (response-execute-provisioned-product-service-action-output nil input)) ([resultWrapper2017868 input] (clojure.core/let [rawinput2017867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017869 {"RecordDetail" (rawinput2017867 "RecordDetail")}] (clojure.core/cond-> {} (letvar2017869 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017869 ["RecordDetail"])))))))

(clojure.core/defn- response-list-launch-paths-output ([input] (response-list-launch-paths-output nil input)) ([resultWrapper2017871 input] (clojure.core/let [rawinput2017870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017872 {"LaunchPathSummaries" (rawinput2017870 "LaunchPathSummaries"), "NextPageToken" (rawinput2017870 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017872 "LaunchPathSummaries") (clojure.core/assoc :launch-path-summaries (deser-launch-path-summaries (clojure.core/get-in letvar2017872 ["LaunchPathSummaries"]))) (letvar2017872 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017872 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-as-admin-output ([input] (response-describe-product-as-admin-output nil input)) ([resultWrapper2017874 input] (clojure.core/let [rawinput2017873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017875 {"ProductViewDetail" (rawinput2017873 "ProductViewDetail"), "ProvisioningArtifactSummaries" (rawinput2017873 "ProvisioningArtifactSummaries"), "Tags" (rawinput2017873 "Tags"), "TagOptions" (rawinput2017873 "TagOptions")}] (clojure.core/cond-> {} (letvar2017875 "ProductViewDetail") (clojure.core/assoc :product-view-detail (deser-product-view-detail (clojure.core/get-in letvar2017875 ["ProductViewDetail"]))) (letvar2017875 "ProvisioningArtifactSummaries") (clojure.core/assoc :provisioning-artifact-summaries (deser-provisioning-artifact-summaries (clojure.core/get-in letvar2017875 ["ProvisioningArtifactSummaries"]))) (letvar2017875 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017875 ["Tags"]))) (letvar2017875 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-details (clojure.core/get-in letvar2017875 ["TagOptions"])))))))

(clojure.core/defn- response-copy-product-output ([input] (response-copy-product-output nil input)) ([resultWrapper2017877 input] (clojure.core/let [rawinput2017876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017878 {"CopyProductToken" (rawinput2017876 "CopyProductToken")}] (clojure.core/cond-> {} (letvar2017878 "CopyProductToken") (clojure.core/assoc :copy-product-token (deser-id (clojure.core/get-in letvar2017878 ["CopyProductToken"])))))))

(clojure.core/defn- response-describe-portfolio-output ([input] (response-describe-portfolio-output nil input)) ([resultWrapper2017880 input] (clojure.core/let [rawinput2017879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017881 {"PortfolioDetail" (rawinput2017879 "PortfolioDetail"), "Tags" (rawinput2017879 "Tags"), "TagOptions" (rawinput2017879 "TagOptions")}] (clojure.core/cond-> {} (letvar2017881 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2017881 ["PortfolioDetail"]))) (letvar2017881 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017881 ["Tags"]))) (letvar2017881 "TagOptions") (clojure.core/assoc :tag-options (deser-tag-option-details (clojure.core/get-in letvar2017881 ["TagOptions"])))))))

(clojure.core/defn- response-describe-provisioned-product-output ([input] (response-describe-provisioned-product-output nil input)) ([resultWrapper2017883 input] (clojure.core/let [rawinput2017882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017884 {"ProvisionedProductDetail" (rawinput2017882 "ProvisionedProductDetail"), "CloudWatchDashboards" (rawinput2017882 "CloudWatchDashboards")}] (clojure.core/cond-> {} (letvar2017884 "ProvisionedProductDetail") (clojure.core/assoc :provisioned-product-detail (deser-provisioned-product-detail (clojure.core/get-in letvar2017884 ["ProvisionedProductDetail"]))) (letvar2017884 "CloudWatchDashboards") (clojure.core/assoc :cloud-watch-dashboards (deser-cloud-watch-dashboards (clojure.core/get-in letvar2017884 ["CloudWatchDashboards"])))))))

(clojure.core/defn- response-batch-disassociate-service-action-from-provisioning-artifact-output ([input] (response-batch-disassociate-service-action-from-provisioning-artifact-output nil input)) ([resultWrapper2017886 input] (clojure.core/let [rawinput2017885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017887 {"FailedServiceActionAssociations" (rawinput2017885 "FailedServiceActionAssociations")}] (clojure.core/cond-> {} (letvar2017887 "FailedServiceActionAssociations") (clojure.core/assoc :failed-service-action-associations (deser-failed-service-action-associations (clojure.core/get-in letvar2017887 ["FailedServiceActionAssociations"])))))))

(clojure.core/defn- response-list-organization-portfolio-access-output ([input] (response-list-organization-portfolio-access-output nil input)) ([resultWrapper2017889 input] (clojure.core/let [rawinput2017888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017890 {"OrganizationNodes" (rawinput2017888 "OrganizationNodes"), "NextPageToken" (rawinput2017888 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017890 "OrganizationNodes") (clojure.core/assoc :organization-nodes (deser-organization-nodes (clojure.core/get-in letvar2017890 ["OrganizationNodes"]))) (letvar2017890 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017890 ["NextPageToken"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper2017892 input] (clojure.core/let [rawinput2017891 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017893 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-tag-option-with-resource-output ([input] (response-associate-tag-option-with-resource-output nil input)) ([resultWrapper2017895 input] (clojure.core/let [rawinput2017894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017896 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-service-action-output ([input] (response-update-service-action-output nil input)) ([resultWrapper2017898 input] (clojure.core/let [rawinput2017897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017899 {"ServiceActionDetail" (rawinput2017897 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2017899 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2017899 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-delete-provisioned-product-plan-output ([input] (response-delete-provisioned-product-plan-output nil input)) ([resultWrapper2017901 input] (clojure.core/let [rawinput2017900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017902 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-record-output ([input] (response-describe-record-output nil input)) ([resultWrapper2017904 input] (clojure.core/let [rawinput2017903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017905 {"RecordDetail" (rawinput2017903 "RecordDetail"), "RecordOutputs" (rawinput2017903 "RecordOutputs"), "NextPageToken" (rawinput2017903 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017905 "RecordDetail") (clojure.core/assoc :record-detail (deser-record-detail (clojure.core/get-in letvar2017905 ["RecordDetail"]))) (letvar2017905 "RecordOutputs") (clojure.core/assoc :record-outputs (deser-record-outputs (clojure.core/get-in letvar2017905 ["RecordOutputs"]))) (letvar2017905 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017905 ["NextPageToken"])))))))

(clojure.core/defn- response-describe-product-output ([input] (response-describe-product-output nil input)) ([resultWrapper2017907 input] (clojure.core/let [rawinput2017906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017908 {"ProductViewSummary" (rawinput2017906 "ProductViewSummary"), "ProvisioningArtifacts" (rawinput2017906 "ProvisioningArtifacts")}] (clojure.core/cond-> {} (letvar2017908 "ProductViewSummary") (clojure.core/assoc :product-view-summary (deser-product-view-summary (clojure.core/get-in letvar2017908 ["ProductViewSummary"]))) (letvar2017908 "ProvisioningArtifacts") (clojure.core/assoc :provisioning-artifacts (deser-provisioning-artifacts (clojure.core/get-in letvar2017908 ["ProvisioningArtifacts"])))))))

(clojure.core/defn- response-search-products-output ([input] (response-search-products-output nil input)) ([resultWrapper2017910 input] (clojure.core/let [rawinput2017909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017911 {"ProductViewSummaries" (rawinput2017909 "ProductViewSummaries"), "ProductViewAggregations" (rawinput2017909 "ProductViewAggregations"), "NextPageToken" (rawinput2017909 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017911 "ProductViewSummaries") (clojure.core/assoc :product-view-summaries (deser-product-view-summaries (clojure.core/get-in letvar2017911 ["ProductViewSummaries"]))) (letvar2017911 "ProductViewAggregations") (clojure.core/assoc :product-view-aggregations (deser-product-view-aggregations (clojure.core/get-in letvar2017911 ["ProductViewAggregations"]))) (letvar2017911 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017911 ["NextPageToken"])))))))

(clojure.core/defn- response-create-provisioning-artifact-output ([input] (response-create-provisioning-artifact-output nil input)) ([resultWrapper2017913 input] (clojure.core/let [rawinput2017912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017914 {"ProvisioningArtifactDetail" (rawinput2017912 "ProvisioningArtifactDetail"), "Info" (rawinput2017912 "Info"), "Status" (rawinput2017912 "Status")}] (clojure.core/cond-> {} (letvar2017914 "ProvisioningArtifactDetail") (clojure.core/assoc :provisioning-artifact-detail (deser-provisioning-artifact-detail (clojure.core/get-in letvar2017914 ["ProvisioningArtifactDetail"]))) (letvar2017914 "Info") (clojure.core/assoc :info (deser-provisioning-artifact-info (clojure.core/get-in letvar2017914 ["Info"]))) (letvar2017914 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017914 ["Status"])))))))

(clojure.core/defn- response-disassociate-service-action-from-provisioning-artifact-output ([input] (response-disassociate-service-action-from-provisioning-artifact-output nil input)) ([resultWrapper2017916 input] (clojure.core/let [rawinput2017915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017917 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-provisioning-artifacts-output ([input] (response-list-provisioning-artifacts-output nil input)) ([resultWrapper2017919 input] (clojure.core/let [rawinput2017918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017920 {"ProvisioningArtifactDetails" (rawinput2017918 "ProvisioningArtifactDetails"), "NextPageToken" (rawinput2017918 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017920 "ProvisioningArtifactDetails") (clojure.core/assoc :provisioning-artifact-details (deser-provisioning-artifact-details (clojure.core/get-in letvar2017920 ["ProvisioningArtifactDetails"]))) (letvar2017920 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017920 ["NextPageToken"])))))))

(clojure.core/defn- response-create-service-action-output ([input] (response-create-service-action-output nil input)) ([resultWrapper2017922 input] (clojure.core/let [rawinput2017921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017923 {"ServiceActionDetail" (rawinput2017921 "ServiceActionDetail")}] (clojure.core/cond-> {} (letvar2017923 "ServiceActionDetail") (clojure.core/assoc :service-action-detail (deser-service-action-detail (clojure.core/get-in letvar2017923 ["ServiceActionDetail"])))))))

(clojure.core/defn- response-update-portfolio-output ([input] (response-update-portfolio-output nil input)) ([resultWrapper2017925 input] (clojure.core/let [rawinput2017924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017926 {"PortfolioDetail" (rawinput2017924 "PortfolioDetail"), "Tags" (rawinput2017924 "Tags")}] (clojure.core/cond-> {} (letvar2017926 "PortfolioDetail") (clojure.core/assoc :portfolio-detail (deser-portfolio-detail (clojure.core/get-in letvar2017926 ["PortfolioDetail"]))) (letvar2017926 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2017926 ["Tags"])))))))

(clojure.core/defn- response-tag-option-not-migrated-exception ([input] (response-tag-option-not-migrated-exception nil input)) ([resultWrapper2017928 input] (clojure.core/let [rawinput2017927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017929 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-scan-provisioned-products-output ([input] (response-scan-provisioned-products-output nil input)) ([resultWrapper2017931 input] (clojure.core/let [rawinput2017930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017932 {"ProvisionedProducts" (rawinput2017930 "ProvisionedProducts"), "NextPageToken" (rawinput2017930 "NextPageToken")}] (clojure.core/cond-> {} (letvar2017932 "ProvisionedProducts") (clojure.core/assoc :provisioned-products (deser-provisioned-product-details (clojure.core/get-in letvar2017932 ["ProvisionedProducts"]))) (letvar2017932 "NextPageToken") (clojure.core/assoc :next-page-token (deser-page-token (clojure.core/get-in letvar2017932 ["NextPageToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper2017934 input] (clojure.core/let [rawinput2017933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017935 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-constraint-output ([input] (response-describe-constraint-output nil input)) ([resultWrapper2017937 input] (clojure.core/let [rawinput2017936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2017938 {"ConstraintDetail" (rawinput2017936 "ConstraintDetail"), "ConstraintParameters" (rawinput2017936 "ConstraintParameters"), "Status" (rawinput2017936 "Status")}] (clojure.core/cond-> {} (letvar2017938 "ConstraintDetail") (clojure.core/assoc :constraint-detail (deser-constraint-detail (clojure.core/get-in letvar2017938 ["ConstraintDetail"]))) (letvar2017938 "ConstraintParameters") (clojure.core/assoc :constraint-parameters (deser-constraint-parameters (clojure.core/get-in letvar2017938 ["ConstraintParameters"]))) (letvar2017938 "Status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar2017938 ["Status"])))))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/support-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/product-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/provisioned-product-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9][a-zA-Z0-9._-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/product-view-short-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/status-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000a\u000d\u0020-\uD7FF\uE000-\uFFFD]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/tag-option-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/organization-node-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(^[0-9]{12}$)|(^arn:aws:organizations::\d{12}:organization\/o-[a-z0-9]{10,32})|(^o-[a-z0-9]{10,32}$)|(^arn:aws:organizations::\d{12}:ou\/o-[a-z0-9]{10,32}\/ou-[0-9a-z]{4,32}-[0-9a-z]{8,32}$)|(^ou-[0-9a-z]{4,32}-[a-z0-9]{8,32}$)" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/principal-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/tag-option-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/access-level-filter-key #{:role "User" "Role" :account "Account" :user})

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/service-action-association-error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/accept-language (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/service-action-definition-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/portfolio-display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/provider-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/product-view-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/record-tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-%@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/portfolio-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/service-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-.]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-9]{12}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/notification-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/tag-option-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/product-view-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8191))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/provisioned-product-name-or-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1224)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9][a-zA-Z0-9._-]{0,127}|arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[a-z0-9-\.]{0,63}:[^/].{0,1023}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/constraint-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/support-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2083))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/plan-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 150))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/service-action-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/page-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000a\u000d\u0020-\uD7FF\uE000-\uFFFD]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/region (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/support-email (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 254))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/constraint-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/record-tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-%@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.servicecatalog.-2015-12-10/parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096))))
