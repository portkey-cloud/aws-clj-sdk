...
(clojure.core/defn- response-list-graphql-apis-response ([input] (response-list-graphql-apis-response nil input)) ([resultWrapper58588 input] (clojure.core/let [rawinput58587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58589 {"graphqlApis" (rawinput58587 "graphqlApis"), "nextToken" (rawinput58587 "nextToken")}] (clojure.core/cond-> {} (letvar58589 "graphqlApis") (clojure.core/assoc :graphql-apis (deser-graphql-apis (clojure.core/get-in letvar58589 ["graphqlApis"]))) (letvar58589 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58589 ["nextToken"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper58591 input] (clojure.core/let [rawinput58590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58592 {"message" (rawinput58590 "message")}] (clojure.core/cond-> {} (letvar58592 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58592 ["message"])))))))

(clojure.core/defn- response-delete-type-response ([input] (response-delete-type-response nil input)) ([resultWrapper58594 input] (clojure.core/let [rawinput58593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58595 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-graphql-api-response ([input] (response-delete-graphql-api-response nil input)) ([resultWrapper58597 input] (clojure.core/let [rawinput58596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58598 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper58600 input] (clojure.core/let [rawinput58599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58601 {"message" (rawinput58599 "message")}] (clojure.core/cond-> {} (letvar58601 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar58601 ["message"])))))))

(clojure.core/defn- response-update-function-response ([input] (response-update-function-response nil input)) ([resultWrapper58603 input] (clojure.core/let [rawinput58602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58604 {"functionConfiguration" (rawinput58602 "functionConfiguration")}] (clojure.core/cond-> {} (letvar58604 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar58604 ["functionConfiguration"])))))))

(clojure.core/defn- response-api-limit-exceeded-exception ([input] (response-api-limit-exceeded-exception nil input)) ([resultWrapper58606 input] (clojure.core/let [rawinput58605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58607 {"message" (rawinput58605 "message")}] (clojure.core/cond-> {} (letvar58607 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58607 ["message"])))))))

(clojure.core/defn- response-create-function-response ([input] (response-create-function-response nil input)) ([resultWrapper58609 input] (clojure.core/let [rawinput58608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58610 {"functionConfiguration" (rawinput58608 "functionConfiguration")}] (clojure.core/cond-> {} (letvar58610 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar58610 ["functionConfiguration"])))))))

(clojure.core/defn- response-list-resolvers-by-function-response ([input] (response-list-resolvers-by-function-response nil input)) ([resultWrapper58612 input] (clojure.core/let [rawinput58611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58613 {"resolvers" (rawinput58611 "resolvers"), "nextToken" (rawinput58611 "nextToken")}] (clojure.core/cond-> {} (letvar58613 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar58613 ["resolvers"]))) (letvar58613 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58613 ["nextToken"])))))))

(clojure.core/defn- response-update-resolver-response ([input] (response-update-resolver-response nil input)) ([resultWrapper58615 input] (clojure.core/let [rawinput58614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58616 {"resolver" (rawinput58614 "resolver")}] (clojure.core/cond-> {} (letvar58616 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar58616 ["resolver"])))))))

(clojure.core/defn- response-list-api-keys-response ([input] (response-list-api-keys-response nil input)) ([resultWrapper58618 input] (clojure.core/let [rawinput58617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58619 {"apiKeys" (rawinput58617 "apiKeys"), "nextToken" (rawinput58617 "nextToken")}] (clojure.core/cond-> {} (letvar58619 "apiKeys") (clojure.core/assoc :api-keys (deser-api-keys (clojure.core/get-in letvar58619 ["apiKeys"]))) (letvar58619 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58619 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper58621 input] (clojure.core/let [rawinput58620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58622 {"message" (rawinput58620 "message")}] (clojure.core/cond-> {} (letvar58622 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58622 ["message"])))))))

(clojure.core/defn- response-list-types-response ([input] (response-list-types-response nil input)) ([resultWrapper58624 input] (clojure.core/let [rawinput58623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58625 {"types" (rawinput58623 "types"), "nextToken" (rawinput58623 "nextToken")}] (clojure.core/cond-> {} (letvar58625 "types") (clojure.core/assoc :types (deser-type-list (clojure.core/get-in letvar58625 ["types"]))) (letvar58625 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58625 ["nextToken"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper58627 input] (clojure.core/let [rawinput58626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58628 {"functions" (rawinput58626 "functions"), "nextToken" (rawinput58626 "nextToken")}] (clojure.core/cond-> {} (letvar58628 "functions") (clojure.core/assoc :functions (deser-functions (clojure.core/get-in letvar58628 ["functions"]))) (letvar58628 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58628 ["nextToken"])))))))

(clojure.core/defn- response-delete-resolver-response ([input] (response-delete-resolver-response nil input)) ([resultWrapper58630 input] (clojure.core/let [rawinput58629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58631 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resolvers-response ([input] (response-list-resolvers-response nil input)) ([resultWrapper58633 input] (clojure.core/let [rawinput58632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58634 {"resolvers" (rawinput58632 "resolvers"), "nextToken" (rawinput58632 "nextToken")}] (clojure.core/cond-> {} (letvar58634 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar58634 ["resolvers"]))) (letvar58634 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58634 ["nextToken"])))))))

(clojure.core/defn- response-graph-ql-schema-exception ([input] (response-graph-ql-schema-exception nil input)) ([resultWrapper58636 input] (clojure.core/let [rawinput58635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58637 {"message" (rawinput58635 "message")}] (clojure.core/cond-> {} (letvar58637 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar58637 ["message"])))))))

(clojure.core/defn- response-create-data-source-response ([input] (response-create-data-source-response nil input)) ([resultWrapper58639 input] (clojure.core/let [rawinput58638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58640 {"dataSource" (rawinput58638 "dataSource")}] (clojure.core/cond-> {} (letvar58640 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar58640 ["dataSource"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper58642 input] (clojure.core/let [rawinput58641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58643 {"functionConfiguration" (rawinput58641 "functionConfiguration")}] (clojure.core/cond-> {} (letvar58643 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar58643 ["functionConfiguration"])))))))

(clojure.core/defn- response-create-api-key-response ([input] (response-create-api-key-response nil input)) ([resultWrapper58645 input] (clojure.core/let [rawinput58644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58646 {"apiKey" (rawinput58644 "apiKey")}] (clojure.core/cond-> {} (letvar58646 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar58646 ["apiKey"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper58648 input] (clojure.core/let [rawinput58647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58649 {"message" (rawinput58647 "message")}] (clojure.core/cond-> {} (letvar58649 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58649 ["message"])))))))

(clojure.core/defn- response-delete-api-key-response ([input] (response-delete-api-key-response nil input)) ([resultWrapper58651 input] (clojure.core/let [rawinput58650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58652 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-function-response ([input] (response-delete-function-response nil input)) ([resultWrapper58654 input] (clojure.core/let [rawinput58653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58655 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-data-source-response ([input] (response-update-data-source-response nil input)) ([resultWrapper58657 input] (clojure.core/let [rawinput58656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58658 {"dataSource" (rawinput58656 "dataSource")}] (clojure.core/cond-> {} (letvar58658 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar58658 ["dataSource"])))))))

(clojure.core/defn- response-get-introspection-schema-response ([input] (response-get-introspection-schema-response nil input)) ([resultWrapper58660 input] (clojure.core/let [rawinput58659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58661 {"schema" (rawinput58659 "schema")}] (clojure.core/cond-> {} (letvar58661 "schema") (clojure.core/assoc :schema (deser-blob (clojure.core/get-in letvar58661 ["schema"])))))))

(clojure.core/defn- response-get-graphql-api-response ([input] (response-get-graphql-api-response nil input)) ([resultWrapper58663 input] (clojure.core/let [rawinput58662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58664 {"graphqlApi" (rawinput58662 "graphqlApi")}] (clojure.core/cond-> {} (letvar58664 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar58664 ["graphqlApi"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper58666 input] (clojure.core/let [rawinput58665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58667 {"message" (rawinput58665 "message")}] (clojure.core/cond-> {} (letvar58667 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58667 ["message"])))))))

(clojure.core/defn- response-update-api-key-response ([input] (response-update-api-key-response nil input)) ([resultWrapper58669 input] (clojure.core/let [rawinput58668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58670 {"apiKey" (rawinput58668 "apiKey")}] (clojure.core/cond-> {} (letvar58670 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar58670 ["apiKey"])))))))

(clojure.core/defn- response-api-key-limit-exceeded-exception ([input] (response-api-key-limit-exceeded-exception nil input)) ([resultWrapper58672 input] (clojure.core/let [rawinput58671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58673 {"message" (rawinput58671 "message")}] (clojure.core/cond-> {} (letvar58673 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58673 ["message"])))))))

(clojure.core/defn- response-get-resolver-response ([input] (response-get-resolver-response nil input)) ([resultWrapper58675 input] (clojure.core/let [rawinput58674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58676 {"resolver" (rawinput58674 "resolver")}] (clojure.core/cond-> {} (letvar58676 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar58676 ["resolver"])))))))

(clojure.core/defn- response-start-schema-creation-response ([input] (response-start-schema-creation-response nil input)) ([resultWrapper58678 input] (clojure.core/let [rawinput58677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58679 {"status" (rawinput58677 "status")}] (clojure.core/cond-> {} (letvar58679 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar58679 ["status"])))))))

(clojure.core/defn- response-create-graphql-api-response ([input] (response-create-graphql-api-response nil input)) ([resultWrapper58681 input] (clojure.core/let [rawinput58680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58682 {"graphqlApi" (rawinput58680 "graphqlApi")}] (clojure.core/cond-> {} (letvar58682 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar58682 ["graphqlApi"])))))))

(clojure.core/defn- response-create-resolver-response ([input] (response-create-resolver-response nil input)) ([resultWrapper58684 input] (clojure.core/let [rawinput58683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58685 {"resolver" (rawinput58683 "resolver")}] (clojure.core/cond-> {} (letvar58685 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar58685 ["resolver"])))))))

(clojure.core/defn- response-create-type-response ([input] (response-create-type-response nil input)) ([resultWrapper58687 input] (clojure.core/let [rawinput58686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58688 {"type" (rawinput58686 "type")}] (clojure.core/cond-> {} (letvar58688 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar58688 ["type"])))))))

(clojure.core/defn- response-delete-data-source-response ([input] (response-delete-data-source-response nil input)) ([resultWrapper58690 input] (clojure.core/let [rawinput58689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58691 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-api-key-validity-out-of-bounds-exception ([input] (response-api-key-validity-out-of-bounds-exception nil input)) ([resultWrapper58693 input] (clojure.core/let [rawinput58692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58694 {"message" (rawinput58692 "message")}] (clojure.core/cond-> {} (letvar58694 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar58694 ["message"])))))))

(clojure.core/defn- response-list-data-sources-response ([input] (response-list-data-sources-response nil input)) ([resultWrapper58696 input] (clojure.core/let [rawinput58695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58697 {"dataSources" (rawinput58695 "dataSources"), "nextToken" (rawinput58695 "nextToken")}] (clojure.core/cond-> {} (letvar58697 "dataSources") (clojure.core/assoc :data-sources (deser-data-sources (clojure.core/get-in letvar58697 ["dataSources"]))) (letvar58697 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar58697 ["nextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper58699 input] (clojure.core/let [rawinput58698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58700 {"message" (rawinput58698 "message")}] (clojure.core/cond-> {} (letvar58700 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar58700 ["message"])))))))

(clojure.core/defn- response-get-schema-creation-status-response ([input] (response-get-schema-creation-status-response nil input)) ([resultWrapper58702 input] (clojure.core/let [rawinput58701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58703 {"status" (rawinput58701 "status"), "details" (rawinput58701 "details")}] (clojure.core/cond-> {} (letvar58703 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar58703 ["status"]))) (letvar58703 "details") (clojure.core/assoc :details (deser-string (clojure.core/get-in letvar58703 ["details"])))))))

(clojure.core/defn- response-get-data-source-response ([input] (response-get-data-source-response nil input)) ([resultWrapper58705 input] (clojure.core/let [rawinput58704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58706 {"dataSource" (rawinput58704 "dataSource")}] (clojure.core/cond-> {} (letvar58706 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar58706 ["dataSource"])))))))

(clojure.core/defn- response-update-type-response ([input] (response-update-type-response nil input)) ([resultWrapper58708 input] (clojure.core/let [rawinput58707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58709 {"type" (rawinput58707 "type")}] (clojure.core/cond-> {} (letvar58709 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar58709 ["type"])))))))

(clojure.core/defn- response-get-type-response ([input] (response-get-type-response nil input)) ([resultWrapper58711 input] (clojure.core/let [rawinput58710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58712 {"type" (rawinput58710 "type")}] (clojure.core/cond-> {} (letvar58712 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar58712 ["type"])))))))

(clojure.core/defn- response-update-graphql-api-response ([input] (response-update-graphql-api-response nil input)) ([resultWrapper58714 input] (clojure.core/let [rawinput58713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar58715 {"graphqlApi" (rawinput58713 "graphqlApi")}] (clojure.core/cond-> {} (letvar58715 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar58715 ["graphqlApi"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\\S]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[_A-Za-z][_0-9A-Za-z]*" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/mapping-template (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 65536))))
