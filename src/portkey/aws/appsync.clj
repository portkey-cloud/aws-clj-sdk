...
(clojure.core/defn- response-list-graphql-apis-response ([input] (response-list-graphql-apis-response nil input)) ([resultWrapper1051585 input] (clojure.core/let [rawinput1051584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051586 {"graphqlApis" (rawinput1051584 "graphqlApis"), "nextToken" (rawinput1051584 "nextToken")}] (clojure.core/cond-> {} (letvar1051586 "graphqlApis") (clojure.core/assoc :graphql-apis (deser-graphql-apis (clojure.core/get-in letvar1051586 ["graphqlApis"]))) (letvar1051586 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051586 ["nextToken"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1051588 input] (clojure.core/let [rawinput1051587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051589 {"message" (rawinput1051587 "message")}] (clojure.core/cond-> {} (letvar1051589 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051589 ["message"])))))))

(clojure.core/defn- response-delete-type-response ([input] (response-delete-type-response nil input)) ([resultWrapper1051591 input] (clojure.core/let [rawinput1051590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051592 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-graphql-api-response ([input] (response-delete-graphql-api-response nil input)) ([resultWrapper1051594 input] (clojure.core/let [rawinput1051593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051595 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1051597 input] (clojure.core/let [rawinput1051596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051598 {"message" (rawinput1051596 "message")}] (clojure.core/cond-> {} (letvar1051598 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1051598 ["message"])))))))

(clojure.core/defn- response-update-function-response ([input] (response-update-function-response nil input)) ([resultWrapper1051600 input] (clojure.core/let [rawinput1051599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051601 {"functionConfiguration" (rawinput1051599 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1051601 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1051601 ["functionConfiguration"])))))))

(clojure.core/defn- response-api-limit-exceeded-exception ([input] (response-api-limit-exceeded-exception nil input)) ([resultWrapper1051603 input] (clojure.core/let [rawinput1051602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051604 {"message" (rawinput1051602 "message")}] (clojure.core/cond-> {} (letvar1051604 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051604 ["message"])))))))

(clojure.core/defn- response-create-function-response ([input] (response-create-function-response nil input)) ([resultWrapper1051606 input] (clojure.core/let [rawinput1051605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051607 {"functionConfiguration" (rawinput1051605 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1051607 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1051607 ["functionConfiguration"])))))))

(clojure.core/defn- response-list-resolvers-by-function-response ([input] (response-list-resolvers-by-function-response nil input)) ([resultWrapper1051609 input] (clojure.core/let [rawinput1051608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051610 {"resolvers" (rawinput1051608 "resolvers"), "nextToken" (rawinput1051608 "nextToken")}] (clojure.core/cond-> {} (letvar1051610 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar1051610 ["resolvers"]))) (letvar1051610 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051610 ["nextToken"])))))))

(clojure.core/defn- response-update-resolver-response ([input] (response-update-resolver-response nil input)) ([resultWrapper1051612 input] (clojure.core/let [rawinput1051611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051613 {"resolver" (rawinput1051611 "resolver")}] (clojure.core/cond-> {} (letvar1051613 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1051613 ["resolver"])))))))

(clojure.core/defn- response-list-api-keys-response ([input] (response-list-api-keys-response nil input)) ([resultWrapper1051615 input] (clojure.core/let [rawinput1051614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051616 {"apiKeys" (rawinput1051614 "apiKeys"), "nextToken" (rawinput1051614 "nextToken")}] (clojure.core/cond-> {} (letvar1051616 "apiKeys") (clojure.core/assoc :api-keys (deser-api-keys (clojure.core/get-in letvar1051616 ["apiKeys"]))) (letvar1051616 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051616 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1051618 input] (clojure.core/let [rawinput1051617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051619 {"message" (rawinput1051617 "message")}] (clojure.core/cond-> {} (letvar1051619 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051619 ["message"])))))))

(clojure.core/defn- response-list-types-response ([input] (response-list-types-response nil input)) ([resultWrapper1051621 input] (clojure.core/let [rawinput1051620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051622 {"types" (rawinput1051620 "types"), "nextToken" (rawinput1051620 "nextToken")}] (clojure.core/cond-> {} (letvar1051622 "types") (clojure.core/assoc :types (deser-type-list (clojure.core/get-in letvar1051622 ["types"]))) (letvar1051622 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051622 ["nextToken"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1051624 input] (clojure.core/let [rawinput1051623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051625 {"functions" (rawinput1051623 "functions"), "nextToken" (rawinput1051623 "nextToken")}] (clojure.core/cond-> {} (letvar1051625 "functions") (clojure.core/assoc :functions (deser-functions (clojure.core/get-in letvar1051625 ["functions"]))) (letvar1051625 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051625 ["nextToken"])))))))

(clojure.core/defn- response-delete-resolver-response ([input] (response-delete-resolver-response nil input)) ([resultWrapper1051627 input] (clojure.core/let [rawinput1051626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051628 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resolvers-response ([input] (response-list-resolvers-response nil input)) ([resultWrapper1051630 input] (clojure.core/let [rawinput1051629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051631 {"resolvers" (rawinput1051629 "resolvers"), "nextToken" (rawinput1051629 "nextToken")}] (clojure.core/cond-> {} (letvar1051631 "resolvers") (clojure.core/assoc :resolvers (deser-resolvers (clojure.core/get-in letvar1051631 ["resolvers"]))) (letvar1051631 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051631 ["nextToken"])))))))

(clojure.core/defn- response-graph-ql-schema-exception ([input] (response-graph-ql-schema-exception nil input)) ([resultWrapper1051633 input] (clojure.core/let [rawinput1051632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051634 {"message" (rawinput1051632 "message")}] (clojure.core/cond-> {} (letvar1051634 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1051634 ["message"])))))))

(clojure.core/defn- response-create-data-source-response ([input] (response-create-data-source-response nil input)) ([resultWrapper1051636 input] (clojure.core/let [rawinput1051635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051637 {"dataSource" (rawinput1051635 "dataSource")}] (clojure.core/cond-> {} (letvar1051637 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1051637 ["dataSource"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1051639 input] (clojure.core/let [rawinput1051638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051640 {"functionConfiguration" (rawinput1051638 "functionConfiguration")}] (clojure.core/cond-> {} (letvar1051640 "functionConfiguration") (clojure.core/assoc :function-configuration (deser-function-configuration (clojure.core/get-in letvar1051640 ["functionConfiguration"])))))))

(clojure.core/defn- response-create-api-key-response ([input] (response-create-api-key-response nil input)) ([resultWrapper1051642 input] (clojure.core/let [rawinput1051641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051643 {"apiKey" (rawinput1051641 "apiKey")}] (clojure.core/cond-> {} (letvar1051643 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar1051643 ["apiKey"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1051645 input] (clojure.core/let [rawinput1051644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051646 {"message" (rawinput1051644 "message")}] (clojure.core/cond-> {} (letvar1051646 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051646 ["message"])))))))

(clojure.core/defn- response-delete-api-key-response ([input] (response-delete-api-key-response nil input)) ([resultWrapper1051648 input] (clojure.core/let [rawinput1051647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051649 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-function-response ([input] (response-delete-function-response nil input)) ([resultWrapper1051651 input] (clojure.core/let [rawinput1051650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051652 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-data-source-response ([input] (response-update-data-source-response nil input)) ([resultWrapper1051654 input] (clojure.core/let [rawinput1051653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051655 {"dataSource" (rawinput1051653 "dataSource")}] (clojure.core/cond-> {} (letvar1051655 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1051655 ["dataSource"])))))))

(clojure.core/defn- response-get-introspection-schema-response ([input] (response-get-introspection-schema-response nil input)) ([resultWrapper1051657 input] (clojure.core/let [rawinput1051656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051658 {"schema" (rawinput1051656 "schema")}] (clojure.core/cond-> {} (letvar1051658 "schema") (clojure.core/assoc :schema (deser-blob (clojure.core/get-in letvar1051658 ["schema"])))))))

(clojure.core/defn- response-get-graphql-api-response ([input] (response-get-graphql-api-response nil input)) ([resultWrapper1051660 input] (clojure.core/let [rawinput1051659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051661 {"graphqlApi" (rawinput1051659 "graphqlApi")}] (clojure.core/cond-> {} (letvar1051661 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1051661 ["graphqlApi"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1051663 input] (clojure.core/let [rawinput1051662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051664 {"message" (rawinput1051662 "message")}] (clojure.core/cond-> {} (letvar1051664 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051664 ["message"])))))))

(clojure.core/defn- response-update-api-key-response ([input] (response-update-api-key-response nil input)) ([resultWrapper1051666 input] (clojure.core/let [rawinput1051665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051667 {"apiKey" (rawinput1051665 "apiKey")}] (clojure.core/cond-> {} (letvar1051667 "apiKey") (clojure.core/assoc :api-key (deser-api-key (clojure.core/get-in letvar1051667 ["apiKey"])))))))

(clojure.core/defn- response-api-key-limit-exceeded-exception ([input] (response-api-key-limit-exceeded-exception nil input)) ([resultWrapper1051669 input] (clojure.core/let [rawinput1051668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051670 {"message" (rawinput1051668 "message")}] (clojure.core/cond-> {} (letvar1051670 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051670 ["message"])))))))

(clojure.core/defn- response-get-resolver-response ([input] (response-get-resolver-response nil input)) ([resultWrapper1051672 input] (clojure.core/let [rawinput1051671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051673 {"resolver" (rawinput1051671 "resolver")}] (clojure.core/cond-> {} (letvar1051673 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1051673 ["resolver"])))))))

(clojure.core/defn- response-start-schema-creation-response ([input] (response-start-schema-creation-response nil input)) ([resultWrapper1051675 input] (clojure.core/let [rawinput1051674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051676 {"status" (rawinput1051674 "status")}] (clojure.core/cond-> {} (letvar1051676 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar1051676 ["status"])))))))

(clojure.core/defn- response-create-graphql-api-response ([input] (response-create-graphql-api-response nil input)) ([resultWrapper1051678 input] (clojure.core/let [rawinput1051677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051679 {"graphqlApi" (rawinput1051677 "graphqlApi")}] (clojure.core/cond-> {} (letvar1051679 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1051679 ["graphqlApi"])))))))

(clojure.core/defn- response-create-resolver-response ([input] (response-create-resolver-response nil input)) ([resultWrapper1051681 input] (clojure.core/let [rawinput1051680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051682 {"resolver" (rawinput1051680 "resolver")}] (clojure.core/cond-> {} (letvar1051682 "resolver") (clojure.core/assoc :resolver (deser-resolver (clojure.core/get-in letvar1051682 ["resolver"])))))))

(clojure.core/defn- response-create-type-response ([input] (response-create-type-response nil input)) ([resultWrapper1051684 input] (clojure.core/let [rawinput1051683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051685 {"type" (rawinput1051683 "type")}] (clojure.core/cond-> {} (letvar1051685 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1051685 ["type"])))))))

(clojure.core/defn- response-delete-data-source-response ([input] (response-delete-data-source-response nil input)) ([resultWrapper1051687 input] (clojure.core/let [rawinput1051686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051688 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-api-key-validity-out-of-bounds-exception ([input] (response-api-key-validity-out-of-bounds-exception nil input)) ([resultWrapper1051690 input] (clojure.core/let [rawinput1051689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051691 {"message" (rawinput1051689 "message")}] (clojure.core/cond-> {} (letvar1051691 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1051691 ["message"])))))))

(clojure.core/defn- response-list-data-sources-response ([input] (response-list-data-sources-response nil input)) ([resultWrapper1051693 input] (clojure.core/let [rawinput1051692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051694 {"dataSources" (rawinput1051692 "dataSources"), "nextToken" (rawinput1051692 "nextToken")}] (clojure.core/cond-> {} (letvar1051694 "dataSources") (clojure.core/assoc :data-sources (deser-data-sources (clojure.core/get-in letvar1051694 ["dataSources"]))) (letvar1051694 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1051694 ["nextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1051696 input] (clojure.core/let [rawinput1051695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051697 {"message" (rawinput1051695 "message")}] (clojure.core/cond-> {} (letvar1051697 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1051697 ["message"])))))))

(clojure.core/defn- response-get-schema-creation-status-response ([input] (response-get-schema-creation-status-response nil input)) ([resultWrapper1051699 input] (clojure.core/let [rawinput1051698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051700 {"status" (rawinput1051698 "status"), "details" (rawinput1051698 "details")}] (clojure.core/cond-> {} (letvar1051700 "status") (clojure.core/assoc :status (deser-schema-status (clojure.core/get-in letvar1051700 ["status"]))) (letvar1051700 "details") (clojure.core/assoc :details (deser-string (clojure.core/get-in letvar1051700 ["details"])))))))

(clojure.core/defn- response-get-data-source-response ([input] (response-get-data-source-response nil input)) ([resultWrapper1051702 input] (clojure.core/let [rawinput1051701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051703 {"dataSource" (rawinput1051701 "dataSource")}] (clojure.core/cond-> {} (letvar1051703 "dataSource") (clojure.core/assoc :data-source (deser-data-source (clojure.core/get-in letvar1051703 ["dataSource"])))))))

(clojure.core/defn- response-update-type-response ([input] (response-update-type-response nil input)) ([resultWrapper1051705 input] (clojure.core/let [rawinput1051704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051706 {"type" (rawinput1051704 "type")}] (clojure.core/cond-> {} (letvar1051706 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1051706 ["type"])))))))

(clojure.core/defn- response-get-type-response ([input] (response-get-type-response nil input)) ([resultWrapper1051708 input] (clojure.core/let [rawinput1051707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051709 {"type" (rawinput1051707 "type")}] (clojure.core/cond-> {} (letvar1051709 "type") (clojure.core/assoc :type (deser-type (clojure.core/get-in letvar1051709 ["type"])))))))

(clojure.core/defn- response-update-graphql-api-response ([input] (response-update-graphql-api-response nil input)) ([resultWrapper1051711 input] (clojure.core/let [rawinput1051710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1051712 {"graphqlApi" (rawinput1051710 "graphqlApi")}] (clojure.core/cond-> {} (letvar1051712 "graphqlApi") (clojure.core/assoc :graphql-api (deser-graphql-api (clojure.core/get-in letvar1051712 ["graphqlApi"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\\S]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[_A-Za-z][_0-9A-Za-z]*" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appsync/mapping-template (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 65536))))
