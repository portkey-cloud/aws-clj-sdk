...
(clojure.core/defn- response-describe-account-result ([input] (response-describe-account-result nil input)) ([resultWrapper2185790 input] (clojure.core/let [rawinput2185789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185791 {"DedicatedTenancySupport" (rawinput2185789 "DedicatedTenancySupport"), "DedicatedTenancyManagementCidrRange" (rawinput2185789 "DedicatedTenancyManagementCidrRange")}] (clojure.core/cond-> {} (letvar2185791 "DedicatedTenancySupport") (clojure.core/assoc :dedicated-tenancy-support (deser-dedicated-tenancy-support-result-enum (clojure.core/get-in letvar2185791 ["DedicatedTenancySupport"]))) (letvar2185791 "DedicatedTenancyManagementCidrRange") (clojure.core/assoc :dedicated-tenancy-management-cidr-range (deser-dedicated-tenancy-management-cidr-range (clojure.core/get-in letvar2185791 ["DedicatedTenancyManagementCidrRange"])))))))

(clojure.core/defn- response-update-rules-of-ip-group-result ([input] (response-update-rules-of-ip-group-result nil input)) ([resultWrapper2185793 input] (clojure.core/let [rawinput2185792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185794 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-values-exception ([input] (response-invalid-parameter-values-exception nil input)) ([resultWrapper2185796 input] (clojure.core/let [rawinput2185795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185797 {"message" (rawinput2185795 "message")}] (clojure.core/cond-> {} (letvar2185797 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185797 ["message"])))))))

(clojure.core/defn- response-delete-tags-result ([input] (response-delete-tags-result nil input)) ([resultWrapper2185799 input] (clojure.core/let [rawinput2185798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185800 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-workspaces-connection-status-result ([input] (response-describe-workspaces-connection-status-result nil input)) ([resultWrapper2185802 input] (clojure.core/let [rawinput2185801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185803 {"WorkspacesConnectionStatus" (rawinput2185801 "WorkspacesConnectionStatus"), "NextToken" (rawinput2185801 "NextToken")}] (clojure.core/cond-> {} (letvar2185803 "WorkspacesConnectionStatus") (clojure.core/assoc :workspaces-connection-status (deser-workspace-connection-status-list (clojure.core/get-in letvar2185803 ["WorkspacesConnectionStatus"]))) (letvar2185803 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185803 ["NextToken"])))))))

(clojure.core/defn- response-associate-ip-groups-result ([input] (response-associate-ip-groups-result nil input)) ([resultWrapper2185805 input] (clojure.core/let [rawinput2185804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185806 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-terminate-workspaces-result ([input] (response-terminate-workspaces-result nil input)) ([resultWrapper2185808 input] (clojure.core/let [rawinput2185807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185809 {"FailedRequests" (rawinput2185807 "FailedRequests")}] (clojure.core/cond-> {} (letvar2185809 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-terminate-workspace-requests (clojure.core/get-in letvar2185809 ["FailedRequests"])))))))

(clojure.core/defn- response-resource-creation-failed-exception ([input] (response-resource-creation-failed-exception nil input)) ([resultWrapper2185811 input] (clojure.core/let [rawinput2185810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185812 {"message" (rawinput2185810 "message")}] (clojure.core/cond-> {} (letvar2185812 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185812 ["message"])))))))

(clojure.core/defn- response-describe-workspace-bundles-result ([input] (response-describe-workspace-bundles-result nil input)) ([resultWrapper2185814 input] (clojure.core/let [rawinput2185813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185815 {"Bundles" (rawinput2185813 "Bundles"), "NextToken" (rawinput2185813 "NextToken")}] (clojure.core/cond-> {} (letvar2185815 "Bundles") (clojure.core/assoc :bundles (deser-bundle-list (clojure.core/get-in letvar2185815 ["Bundles"]))) (letvar2185815 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185815 ["NextToken"])))))))

(clojure.core/defn- response-operation-in-progress-exception ([input] (response-operation-in-progress-exception nil input)) ([resultWrapper2185817 input] (clojure.core/let [rawinput2185816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185818 {"message" (rawinput2185816 "message")}] (clojure.core/cond-> {} (letvar2185818 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185818 ["message"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper2185820 input] (clojure.core/let [rawinput2185819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185821 {"message" (rawinput2185819 "message")}] (clojure.core/cond-> {} (letvar2185821 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185821 ["message"])))))))

(clojure.core/defn- response-delete-ip-group-result ([input] (response-delete-ip-group-result nil input)) ([resultWrapper2185823 input] (clojure.core/let [rawinput2185822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185824 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-revoke-ip-rules-result ([input] (response-revoke-ip-rules-result nil input)) ([resultWrapper2185826 input] (clojure.core/let [rawinput2185825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185827 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-workspace-image-result ([input] (response-import-workspace-image-result nil input)) ([resultWrapper2185829 input] (clojure.core/let [rawinput2185828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185830 {"ImageId" (rawinput2185828 "ImageId")}] (clojure.core/cond-> {} (letvar2185830 "ImageId") (clojure.core/assoc :image-id (deser-workspace-image-id (clojure.core/get-in letvar2185830 ["ImageId"])))))))

(clojure.core/defn- response-describe-tags-result ([input] (response-describe-tags-result nil input)) ([resultWrapper2185832 input] (clojure.core/let [rawinput2185831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185833 {"TagList" (rawinput2185831 "TagList")}] (clojure.core/cond-> {} (letvar2185833 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar2185833 ["TagList"])))))))

(clojure.core/defn- response-rebuild-workspaces-result ([input] (response-rebuild-workspaces-result nil input)) ([resultWrapper2185835 input] (clojure.core/let [rawinput2185834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185836 {"FailedRequests" (rawinput2185834 "FailedRequests")}] (clojure.core/cond-> {} (letvar2185836 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-rebuild-workspace-requests (clojure.core/get-in letvar2185836 ["FailedRequests"])))))))

(clojure.core/defn- response-describe-account-modifications-result ([input] (response-describe-account-modifications-result nil input)) ([resultWrapper2185838 input] (clojure.core/let [rawinput2185837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185839 {"AccountModifications" (rawinput2185837 "AccountModifications"), "NextToken" (rawinput2185837 "NextToken")}] (clojure.core/cond-> {} (letvar2185839 "AccountModifications") (clojure.core/assoc :account-modifications (deser-account-modification-list (clojure.core/get-in letvar2185839 ["AccountModifications"]))) (letvar2185839 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185839 ["NextToken"])))))))

(clojure.core/defn- response-stop-workspaces-result ([input] (response-stop-workspaces-result nil input)) ([resultWrapper2185841 input] (clojure.core/let [rawinput2185840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185842 {"FailedRequests" (rawinput2185840 "FailedRequests")}] (clojure.core/cond-> {} (letvar2185842 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-stop-workspace-requests (clojure.core/get-in letvar2185842 ["FailedRequests"])))))))

(clojure.core/defn- response-modify-client-properties-result ([input] (response-modify-client-properties-result nil input)) ([resultWrapper2185844 input] (clojure.core/let [rawinput2185843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185845 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-associated-exception ([input] (response-resource-associated-exception nil input)) ([resultWrapper2185847 input] (clojure.core/let [rawinput2185846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185848 {"message" (rawinput2185846 "message")}] (clojure.core/cond-> {} (letvar2185848 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185848 ["message"])))))))

(clojure.core/defn- response-describe-workspace-images-result ([input] (response-describe-workspace-images-result nil input)) ([resultWrapper2185850 input] (clojure.core/let [rawinput2185849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185851 {"Images" (rawinput2185849 "Images"), "NextToken" (rawinput2185849 "NextToken")}] (clojure.core/cond-> {} (letvar2185851 "Images") (clojure.core/assoc :images (deser-workspace-image-list (clojure.core/get-in letvar2185851 ["Images"]))) (letvar2185851 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185851 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2185853 input] (clojure.core/let [rawinput2185852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185854 {"message" (rawinput2185852 "message"), "ResourceId" (rawinput2185852 "ResourceId")}] (clojure.core/cond-> {} (letvar2185854 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185854 ["message"]))) (letvar2185854 "ResourceId") (clojure.core/assoc :resource-id (deser-non-empty-string (clojure.core/get-in letvar2185854 ["ResourceId"])))))))

(clojure.core/defn- response-delete-workspace-image-result ([input] (response-delete-workspace-image-result nil input)) ([resultWrapper2185856 input] (clojure.core/let [rawinput2185855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185857 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reboot-workspaces-result ([input] (response-reboot-workspaces-result nil input)) ([resultWrapper2185859 input] (clojure.core/let [rawinput2185858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185860 {"FailedRequests" (rawinput2185858 "FailedRequests")}] (clojure.core/cond-> {} (letvar2185860 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-reboot-workspace-requests (clojure.core/get-in letvar2185860 ["FailedRequests"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2185862 input] (clojure.core/let [rawinput2185861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185863 {"message" (rawinput2185861 "message")}] (clojure.core/cond-> {} (letvar2185863 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185863 ["message"])))))))

(clojure.core/defn- response-operation-not-supported-exception ([input] (response-operation-not-supported-exception nil input)) ([resultWrapper2185865 input] (clojure.core/let [rawinput2185864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185866 {"message" (rawinput2185864 "message")}] (clojure.core/cond-> {} (letvar2185866 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185866 ["message"])))))))

(clojure.core/defn- response-create-tags-result ([input] (response-create-tags-result nil input)) ([resultWrapper2185868 input] (clojure.core/let [rawinput2185867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185869 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-workspaces-result ([input] (response-start-workspaces-result nil input)) ([resultWrapper2185871 input] (clojure.core/let [rawinput2185870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185872 {"FailedRequests" (rawinput2185870 "FailedRequests")}] (clojure.core/cond-> {} (letvar2185872 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-start-workspace-requests (clojure.core/get-in letvar2185872 ["FailedRequests"])))))))

(clojure.core/defn- response-create-workspaces-result ([input] (response-create-workspaces-result nil input)) ([resultWrapper2185874 input] (clojure.core/let [rawinput2185873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185875 {"FailedRequests" (rawinput2185873 "FailedRequests"), "PendingRequests" (rawinput2185873 "PendingRequests")}] (clojure.core/cond-> {} (letvar2185875 "FailedRequests") (clojure.core/assoc :failed-requests (deser-failed-create-workspace-requests (clojure.core/get-in letvar2185875 ["FailedRequests"]))) (letvar2185875 "PendingRequests") (clojure.core/assoc :pending-requests (deser-workspace-list (clojure.core/get-in letvar2185875 ["PendingRequests"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper2185877 input] (clojure.core/let [rawinput2185876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185878 {"message" (rawinput2185876 "message")}] (clojure.core/cond-> {} (letvar2185878 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185878 ["message"])))))))

(clojure.core/defn- response-describe-workspace-directories-result ([input] (response-describe-workspace-directories-result nil input)) ([resultWrapper2185880 input] (clojure.core/let [rawinput2185879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185881 {"Directories" (rawinput2185879 "Directories"), "NextToken" (rawinput2185879 "NextToken")}] (clojure.core/cond-> {} (letvar2185881 "Directories") (clojure.core/assoc :directories (deser-directory-list (clojure.core/get-in letvar2185881 ["Directories"]))) (letvar2185881 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185881 ["NextToken"])))))))

(clojure.core/defn- response-invalid-resource-state-exception ([input] (response-invalid-resource-state-exception nil input)) ([resultWrapper2185883 input] (clojure.core/let [rawinput2185882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185884 {"message" (rawinput2185882 "message")}] (clojure.core/cond-> {} (letvar2185884 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185884 ["message"])))))))

(clojure.core/defn- response-create-ip-group-result ([input] (response-create-ip-group-result nil input)) ([resultWrapper2185886 input] (clojure.core/let [rawinput2185885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185887 {"GroupId" (rawinput2185885 "GroupId")}] (clojure.core/cond-> {} (letvar2185887 "GroupId") (clojure.core/assoc :group-id (deser-ip-group-id (clojure.core/get-in letvar2185887 ["GroupId"])))))))

(clojure.core/defn- response-describe-client-properties-result ([input] (response-describe-client-properties-result nil input)) ([resultWrapper2185889 input] (clojure.core/let [rawinput2185888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185890 {"ClientPropertiesList" (rawinput2185888 "ClientPropertiesList")}] (clojure.core/cond-> {} (letvar2185890 "ClientPropertiesList") (clojure.core/assoc :client-properties-list (deser-client-properties-list (clojure.core/get-in letvar2185890 ["ClientPropertiesList"])))))))

(clojure.core/defn- response-disassociate-ip-groups-result ([input] (response-disassociate-ip-groups-result nil input)) ([resultWrapper2185892 input] (clojure.core/let [rawinput2185891 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185893 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-available-management-cidr-ranges-result ([input] (response-list-available-management-cidr-ranges-result nil input)) ([resultWrapper2185895 input] (clojure.core/let [rawinput2185894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185896 {"ManagementCidrRanges" (rawinput2185894 "ManagementCidrRanges"), "NextToken" (rawinput2185894 "NextToken")}] (clojure.core/cond-> {} (letvar2185896 "ManagementCidrRanges") (clojure.core/assoc :management-cidr-ranges (deser-dedicated-tenancy-cidr-range-list (clojure.core/get-in letvar2185896 ["ManagementCidrRanges"]))) (letvar2185896 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185896 ["NextToken"])))))))

(clojure.core/defn- response-describe-workspaces-result ([input] (response-describe-workspaces-result nil input)) ([resultWrapper2185898 input] (clojure.core/let [rawinput2185897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185899 {"Workspaces" (rawinput2185897 "Workspaces"), "NextToken" (rawinput2185897 "NextToken")}] (clojure.core/cond-> {} (letvar2185899 "Workspaces") (clojure.core/assoc :workspaces (deser-workspace-list (clojure.core/get-in letvar2185899 ["Workspaces"]))) (letvar2185899 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185899 ["NextToken"])))))))

(clojure.core/defn- response-unsupported-workspace-configuration-exception ([input] (response-unsupported-workspace-configuration-exception nil input)) ([resultWrapper2185901 input] (clojure.core/let [rawinput2185900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185902 {"message" (rawinput2185900 "message")}] (clojure.core/cond-> {} (letvar2185902 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185902 ["message"])))))))

(clojure.core/defn- response-modify-workspace-properties-result ([input] (response-modify-workspace-properties-result nil input)) ([resultWrapper2185904 input] (clojure.core/let [rawinput2185903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185905 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-unavailable-exception ([input] (response-resource-unavailable-exception nil input)) ([resultWrapper2185907 input] (clojure.core/let [rawinput2185906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185908 {"message" (rawinput2185906 "message"), "ResourceId" (rawinput2185906 "ResourceId")}] (clojure.core/cond-> {} (letvar2185908 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar2185908 ["message"]))) (letvar2185908 "ResourceId") (clojure.core/assoc :resource-id (deser-non-empty-string (clojure.core/get-in letvar2185908 ["ResourceId"])))))))

(clojure.core/defn- response-modify-account-result ([input] (response-modify-account-result nil input)) ([resultWrapper2185910 input] (clojure.core/let [rawinput2185909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185911 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-ip-groups-result ([input] (response-describe-ip-groups-result nil input)) ([resultWrapper2185913 input] (clojure.core/let [rawinput2185912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185914 {"Result" (rawinput2185912 "Result"), "NextToken" (rawinput2185912 "NextToken")}] (clojure.core/cond-> {} (letvar2185914 "Result") (clojure.core/assoc :result (deser-workspaces-ip-groups-list (clojure.core/get-in letvar2185914 ["Result"]))) (letvar2185914 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar2185914 ["NextToken"])))))))

(clojure.core/defn- response-authorize-ip-rules-result ([input] (response-authorize-ip-rules-result nil input)) ([resultWrapper2185916 input] (clojure.core/let [rawinput2185915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185917 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-modify-workspace-state-result ([input] (response-modify-workspace-state-result nil input)) ([resultWrapper2185919 input] (clojure.core/let [rawinput2185918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2185920 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/workspace-image-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"wsi-[0-9a-z]{9,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/management-cidr-range-constraint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/(3[0-2]|[1-2][0-9]|[0-9]))$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/workspace-image-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_./() -]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63))))

(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/ec-2-image-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^ami\-([a-f0-9]{8}|[a-f0-9]{17})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-za-z0-9_/.-]{0,62}:[A-za-z0-9_/.-]{0,63}:[A-za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-za-z0-9_/.-]{0,127}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/workspace-image-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_./()\\-]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/bundle-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^wsb-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/ip-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"wsipg-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/dedicated-tenancy-management-cidr-range (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(^([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.0\.0)(\/(16$))$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/workspace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^ws-[0-9a-z]{8,63}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/registration-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20))))
