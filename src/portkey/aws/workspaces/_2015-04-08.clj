...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8})$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-za-z0-9_/.-]{0,62}:[A-za-z0-9_/.-]{0,63}:[A-za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-za-z0-9_/.-]{0,127}$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8})$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/bundle-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^wsb-[0-9a-z]{8,63}$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/ip-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"wsipg-[0-9a-z]{8,63}$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{8,63}$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/workspace-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^ws-[0-9a-z]{8,63}$" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.workspaces.-2015-04-08/registration-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 20))))
