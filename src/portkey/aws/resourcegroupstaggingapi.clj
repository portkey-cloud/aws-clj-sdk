...
(clojure.core/defn- response-tag-resources-output ([input] (response-tag-resources-output nil input)) ([resultWrapper1950553 input] (clojure.core/let [rawinput1950552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950554 {"FailedResourcesMap" (rawinput1950552 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1950554 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1950554 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-values-output ([input] (response-get-tag-values-output nil input)) ([resultWrapper1950556 input] (clojure.core/let [rawinput1950555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950557 {"PaginationToken" (rawinput1950555 "PaginationToken"), "TagValues" (rawinput1950555 "TagValues")}] (clojure.core/cond-> {} (letvar1950557 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1950557 ["PaginationToken"]))) (letvar1950557 "TagValues") (clojure.core/assoc :tag-values (deser-tag-values-output-list (clojure.core/get-in letvar1950557 ["TagValues"])))))))

(clojure.core/defn- response-pagination-token-expired-exception ([input] (response-pagination-token-expired-exception nil input)) ([resultWrapper1950559 input] (clojure.core/let [rawinput1950558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950560 {"Message" (rawinput1950558 "Message")}] (clojure.core/cond-> {} (letvar1950560 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1950560 ["Message"])))))))

(clojure.core/defn- response-untag-resources-output ([input] (response-untag-resources-output nil input)) ([resultWrapper1950562 input] (clojure.core/let [rawinput1950561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950563 {"FailedResourcesMap" (rawinput1950561 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1950563 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1950563 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-keys-output ([input] (response-get-tag-keys-output nil input)) ([resultWrapper1950565 input] (clojure.core/let [rawinput1950564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950566 {"PaginationToken" (rawinput1950564 "PaginationToken"), "TagKeys" (rawinput1950564 "TagKeys")}] (clojure.core/cond-> {} (letvar1950566 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1950566 ["PaginationToken"]))) (letvar1950566 "TagKeys") (clojure.core/assoc :tag-keys (deser-tag-key-list (clojure.core/get-in letvar1950566 ["TagKeys"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1950568 input] (clojure.core/let [rawinput1950567 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950569 {"Message" (rawinput1950567 "Message")}] (clojure.core/cond-> {} (letvar1950569 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1950569 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1950571 input] (clojure.core/let [rawinput1950570 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950572 {"Message" (rawinput1950570 "Message")}] (clojure.core/cond-> {} (letvar1950572 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1950572 ["Message"])))))))

(clojure.core/defn- response-get-resources-output ([input] (response-get-resources-output nil input)) ([resultWrapper1950574 input] (clojure.core/let [rawinput1950573 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950575 {"PaginationToken" (rawinput1950573 "PaginationToken"), "ResourceTagMappingList" (rawinput1950573 "ResourceTagMappingList")}] (clojure.core/cond-> {} (letvar1950575 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1950575 ["PaginationToken"]))) (letvar1950575 "ResourceTagMappingList") (clojure.core/assoc :resource-tag-mapping-list (deser-resource-tag-mapping-list (clojure.core/get-in letvar1950575 ["ResourceTagMappingList"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1950577 input] (clojure.core/let [rawinput1950576 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1950578 {"Message" (rawinput1950576 "Message")}] (clojure.core/cond-> {} (letvar1950578 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1950578 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/amazon-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1600))))
...
(clojure.core/defn get-resources "Returns all the tagged resources that are associated with the specified tags\n(keys and values) located in the specified region for the AWS account. The tags\nand the resource types that you specify in the request are known as filters. The\nresponse includes all tags that are associated with the requested resources. If\nno filter is provided, this action returns a paginated resource list with the\nassociated tags." ([] (get-resources {})) ([get-resources-inputinput] (clojure.core/let [request-function-result__1411981__auto__ (req-get-resources-input get-resources-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.resourcegroupstaggingapi/endpoints, :http.request.configuration/target-prefix "ResourceGroupsTaggingAPI_20170126", :http.request.spec/output-spec :portkey.aws.resourcegroupstaggingapi/get-resources-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-26", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.resourcegroupstaggingapi/get-resources-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetResources", :http.request.configuration/output-deser-fn response-get-resources-output, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.resourcegroupstaggingapi/invalid-parameter-exception, "ThrottledException" :portkey.aws.resourcegroupstaggingapi/throttled-exception, "InternalServiceException" :portkey.aws.resourcegroupstaggingapi/internal-service-exception, "PaginationTokenExpiredException" :portkey.aws.resourcegroupstaggingapi/pagination-token-expired-exception}})))))
...
(clojure.core/defn get-tag-keys "Returns all tag keys in the specified region for the AWS account." ([] (get-tag-keys {})) ([get-tag-keys-inputinput] (clojure.core/let [request-function-result__1411981__auto__ (req-get-tag-keys-input get-tag-keys-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.resourcegroupstaggingapi/endpoints, :http.request.configuration/target-prefix "ResourceGroupsTaggingAPI_20170126", :http.request.spec/output-spec :portkey.aws.resourcegroupstaggingapi/get-tag-keys-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-26", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.resourcegroupstaggingapi/get-tag-keys-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetTagKeys", :http.request.configuration/output-deser-fn response-get-tag-keys-output, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.resourcegroupstaggingapi/invalid-parameter-exception, "ThrottledException" :portkey.aws.resourcegroupstaggingapi/throttled-exception, "InternalServiceException" :portkey.aws.resourcegroupstaggingapi/internal-service-exception, "PaginationTokenExpiredException" :portkey.aws.resourcegroupstaggingapi/pagination-token-expired-exception}})))))
...
(clojure.core/defn get-tag-values "Returns all tag values for the specified key in the specified region for the AWS\naccount." ([get-tag-values-inputinput] (clojure.core/let [request-function-result__1411981__auto__ (req-get-tag-values-input get-tag-values-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.resourcegroupstaggingapi/endpoints, :http.request.configuration/target-prefix "ResourceGroupsTaggingAPI_20170126", :http.request.spec/output-spec :portkey.aws.resourcegroupstaggingapi/get-tag-values-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-26", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.resourcegroupstaggingapi/get-tag-values-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetTagValues", :http.request.configuration/output-deser-fn response-get-tag-values-output, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.resourcegroupstaggingapi/invalid-parameter-exception, "ThrottledException" :portkey.aws.resourcegroupstaggingapi/throttled-exception, "InternalServiceException" :portkey.aws.resourcegroupstaggingapi/internal-service-exception, "PaginationTokenExpiredException" :portkey.aws.resourcegroupstaggingapi/pagination-token-expired-exception}})))))
...
(clojure.core/defn tag-resources "Applies one or more tags to the specified resources. Note the following:\n * Not all resources can have tags. For a list of resources that support\ntagging, see Supported Resources\n(http://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/supported-resources.html)\nin the AWS Resource Groups and Tag Editor User Guide.\n * Each resource can have up to 50 tags. For other limits, see Tag Restrictions\n(http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-restrictions)\nin the Amazon EC2 User Guide for Linux Instances.\n * You can only tag resources that are located in the specified region for the\nAWS account.\n * To add tags to a resource, you need the necessary permissions for the service\nthat the resource belongs to as well as permissions for adding tags. For more\ninformation, see Obtaining Permissions for Tagging\n(http://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/obtaining-permissions-for-tagging.html)\nin the AWS Resource Groups and Tag Editor User Guide." ([tag-resources-inputinput] (clojure.core/let [request-function-result__1411981__auto__ (req-tag-resources-input tag-resources-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.resourcegroupstaggingapi/endpoints, :http.request.configuration/target-prefix "ResourceGroupsTaggingAPI_20170126", :http.request.spec/output-spec :portkey.aws.resourcegroupstaggingapi/tag-resources-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-26", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.resourcegroupstaggingapi/tag-resources-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "TagResources", :http.request.configuration/output-deser-fn response-tag-resources-output, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.resourcegroupstaggingapi/invalid-parameter-exception, "ThrottledException" :portkey.aws.resourcegroupstaggingapi/throttled-exception, "InternalServiceException" :portkey.aws.resourcegroupstaggingapi/internal-service-exception}})))))
...
(clojure.core/defn untag-resources "Removes the specified tags from the specified resources. When you specify a tag\nkey, the action removes both that key and its associated value. The operation\nsucceeds even if you attempt to remove tags from a resource that were already\nremoved. Note the following:\n * To remove tags from a resource, you need the necessary permissions for the\nservice that the resource belongs to as well as permissions for removing tags.\nFor more information, see Obtaining Permissions for Tagging\n(http://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/obtaining-permissions-for-tagging.html)\nin the AWS Resource Groups and Tag Editor User Guide.\n * You can only tag resources that are located in the specified region for the\nAWS account." ([untag-resources-inputinput] (clojure.core/let [request-function-result__1411981__auto__ (req-untag-resources-input untag-resources-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.resourcegroupstaggingapi/endpoints, :http.request.configuration/target-prefix "ResourceGroupsTaggingAPI_20170126", :http.request.spec/output-spec :portkey.aws.resourcegroupstaggingapi/untag-resources-output, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-26", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.resourcegroupstaggingapi/untag-resources-input, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UntagResources", :http.request.configuration/output-deser-fn response-untag-resources-output, :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.resourcegroupstaggingapi/invalid-parameter-exception, "ThrottledException" :portkey.aws.resourcegroupstaggingapi/throttled-exception, "InternalServiceException" :portkey.aws.resourcegroupstaggingapi/internal-service-exception}})))))
