...
(clojure.core/defn- response-tag-resources-output ([input] (response-tag-resources-output nil input)) ([resultWrapper1563581 input] (clojure.core/let [rawinput1563580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563582 {"FailedResourcesMap" (rawinput1563580 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1563582 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1563582 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-values-output ([input] (response-get-tag-values-output nil input)) ([resultWrapper1563584 input] (clojure.core/let [rawinput1563583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563585 {"PaginationToken" (rawinput1563583 "PaginationToken"), "TagValues" (rawinput1563583 "TagValues")}] (clojure.core/cond-> {} (letvar1563585 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1563585 ["PaginationToken"]))) (letvar1563585 "TagValues") (clojure.core/assoc :tag-values (deser-tag-values-output-list (clojure.core/get-in letvar1563585 ["TagValues"])))))))

(clojure.core/defn- response-pagination-token-expired-exception ([input] (response-pagination-token-expired-exception nil input)) ([resultWrapper1563587 input] (clojure.core/let [rawinput1563586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563588 {"Message" (rawinput1563586 "Message")}] (clojure.core/cond-> {} (letvar1563588 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1563588 ["Message"])))))))

(clojure.core/defn- response-untag-resources-output ([input] (response-untag-resources-output nil input)) ([resultWrapper1563590 input] (clojure.core/let [rawinput1563589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563591 {"FailedResourcesMap" (rawinput1563589 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1563591 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1563591 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-keys-output ([input] (response-get-tag-keys-output nil input)) ([resultWrapper1563593 input] (clojure.core/let [rawinput1563592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563594 {"PaginationToken" (rawinput1563592 "PaginationToken"), "TagKeys" (rawinput1563592 "TagKeys")}] (clojure.core/cond-> {} (letvar1563594 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1563594 ["PaginationToken"]))) (letvar1563594 "TagKeys") (clojure.core/assoc :tag-keys (deser-tag-key-list (clojure.core/get-in letvar1563594 ["TagKeys"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1563596 input] (clojure.core/let [rawinput1563595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563597 {"Message" (rawinput1563595 "Message")}] (clojure.core/cond-> {} (letvar1563597 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1563597 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1563599 input] (clojure.core/let [rawinput1563598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563600 {"Message" (rawinput1563598 "Message")}] (clojure.core/cond-> {} (letvar1563600 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1563600 ["Message"])))))))

(clojure.core/defn- response-get-resources-output ([input] (response-get-resources-output nil input)) ([resultWrapper1563602 input] (clojure.core/let [rawinput1563601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563603 {"PaginationToken" (rawinput1563601 "PaginationToken"), "ResourceTagMappingList" (rawinput1563601 "ResourceTagMappingList")}] (clojure.core/cond-> {} (letvar1563603 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1563603 ["PaginationToken"]))) (letvar1563603 "ResourceTagMappingList") (clojure.core/assoc :resource-tag-mapping-list (deser-resource-tag-mapping-list (clojure.core/get-in letvar1563603 ["ResourceTagMappingList"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1563605 input] (clojure.core/let [rawinput1563604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1563606 {"Message" (rawinput1563604 "Message")}] (clojure.core/cond-> {} (letvar1563606 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1563606 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/amazon-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
