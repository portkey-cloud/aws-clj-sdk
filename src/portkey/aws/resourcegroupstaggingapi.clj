...
(clojure.core/defn- response-tag-resources-output ([input] (response-tag-resources-output nil input)) ([resultWrapper1960211 input] (clojure.core/let [rawinput1960210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960212 {"FailedResourcesMap" (rawinput1960210 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1960212 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1960212 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-values-output ([input] (response-get-tag-values-output nil input)) ([resultWrapper1960214 input] (clojure.core/let [rawinput1960213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960215 {"PaginationToken" (rawinput1960213 "PaginationToken"), "TagValues" (rawinput1960213 "TagValues")}] (clojure.core/cond-> {} (letvar1960215 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1960215 ["PaginationToken"]))) (letvar1960215 "TagValues") (clojure.core/assoc :tag-values (deser-tag-values-output-list (clojure.core/get-in letvar1960215 ["TagValues"])))))))

(clojure.core/defn- response-pagination-token-expired-exception ([input] (response-pagination-token-expired-exception nil input)) ([resultWrapper1960217 input] (clojure.core/let [rawinput1960216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960218 {"Message" (rawinput1960216 "Message")}] (clojure.core/cond-> {} (letvar1960218 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1960218 ["Message"])))))))

(clojure.core/defn- response-untag-resources-output ([input] (response-untag-resources-output nil input)) ([resultWrapper1960220 input] (clojure.core/let [rawinput1960219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960221 {"FailedResourcesMap" (rawinput1960219 "FailedResourcesMap")}] (clojure.core/cond-> {} (letvar1960221 "FailedResourcesMap") (clojure.core/assoc :failed-resources-map (deser-failed-resources-map (clojure.core/get-in letvar1960221 ["FailedResourcesMap"])))))))

(clojure.core/defn- response-get-tag-keys-output ([input] (response-get-tag-keys-output nil input)) ([resultWrapper1960223 input] (clojure.core/let [rawinput1960222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960224 {"PaginationToken" (rawinput1960222 "PaginationToken"), "TagKeys" (rawinput1960222 "TagKeys")}] (clojure.core/cond-> {} (letvar1960224 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1960224 ["PaginationToken"]))) (letvar1960224 "TagKeys") (clojure.core/assoc :tag-keys (deser-tag-key-list (clojure.core/get-in letvar1960224 ["TagKeys"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1960226 input] (clojure.core/let [rawinput1960225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960227 {"Message" (rawinput1960225 "Message")}] (clojure.core/cond-> {} (letvar1960227 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1960227 ["Message"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1960229 input] (clojure.core/let [rawinput1960228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960230 {"Message" (rawinput1960228 "Message")}] (clojure.core/cond-> {} (letvar1960230 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1960230 ["Message"])))))))

(clojure.core/defn- response-get-resources-output ([input] (response-get-resources-output nil input)) ([resultWrapper1960232 input] (clojure.core/let [rawinput1960231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960233 {"PaginationToken" (rawinput1960231 "PaginationToken"), "ResourceTagMappingList" (rawinput1960231 "ResourceTagMappingList")}] (clojure.core/cond-> {} (letvar1960233 "PaginationToken") (clojure.core/assoc :pagination-token (deser-pagination-token (clojure.core/get-in letvar1960233 ["PaginationToken"]))) (letvar1960233 "ResourceTagMappingList") (clojure.core/assoc :resource-tag-mapping-list (deser-resource-tag-mapping-list (clojure.core/get-in letvar1960233 ["ResourceTagMappingList"])))))))

(clojure.core/defn- response-throttled-exception ([input] (response-throttled-exception nil input)) ([resultWrapper1960235 input] (clojure.core/let [rawinput1960234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1960236 {"Message" (rawinput1960234 "Message")}] (clojure.core/cond-> {} (letvar1960236 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1960236 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/amazon-resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.resourcegroupstaggingapi/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1600))))
