...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1277054 input] (clojure.core/let [rawinput1277053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277055 {"message" (rawinput1277053 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277055 ["message"]))}))))

(clojure.core/defn- response-remove-flow-output-response ([input] (response-remove-flow-output-response nil input)) ([resultWrapper1277057 input] (clojure.core/let [rawinput1277056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277058 {"flowArn" (rawinput1277056 "flowArn"), "outputArn" (rawinput1277056 "outputArn")}] (clojure.core/cond-> {} (letvar1277058 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277058 ["flowArn"]))) (letvar1277058 "outputArn") (clojure.core/assoc :output-arn (deser-string (clojure.core/get-in letvar1277058 ["outputArn"])))))))

(clojure.core/defn- response-add-flow-outputs-response ([input] (response-add-flow-outputs-response nil input)) ([resultWrapper1277060 input] (clojure.core/let [rawinput1277059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277061 {"flowArn" (rawinput1277059 "flowArn"), "outputs" (rawinput1277059 "outputs")}] (clojure.core/cond-> {} (letvar1277061 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277061 ["flowArn"]))) (letvar1277061 "outputs") (clojure.core/assoc :outputs (deser-list-of-output (clojure.core/get-in letvar1277061 ["outputs"])))))))

(clojure.core/defn- response-list-flows-response ([input] (response-list-flows-response nil input)) ([resultWrapper1277063 input] (clojure.core/let [rawinput1277062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277064 {"flows" (rawinput1277062 "flows"), "nextToken" (rawinput1277062 "nextToken")}] (clojure.core/cond-> {} (letvar1277064 "flows") (clojure.core/assoc :flows (deser-list-of-listed-flow (clojure.core/get-in letvar1277064 ["flows"]))) (letvar1277064 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1277064 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1277066 input] (clojure.core/let [rawinput1277065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277067 {"message" (rawinput1277065 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277067 ["message"]))}))))

(clojure.core/defn- response-update-flow-source-response ([input] (response-update-flow-source-response nil input)) ([resultWrapper1277069 input] (clojure.core/let [rawinput1277068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277070 {"flowArn" (rawinput1277068 "flowArn"), "source" (rawinput1277068 "source")}] (clojure.core/cond-> {} (letvar1277070 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277070 ["flowArn"]))) (letvar1277070 "source") (clojure.core/assoc :source (deser-source (clojure.core/get-in letvar1277070 ["source"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1277072 input] (clojure.core/let [rawinput1277071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277073 {"tags" (rawinput1277071 "tags")}] (clojure.core/cond-> {} (letvar1277073 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar1277073 ["tags"])))))))

(clojure.core/defn- response-create-flow-response ([input] (response-create-flow-response nil input)) ([resultWrapper1277075 input] (clojure.core/let [rawinput1277074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277076 {"flow" (rawinput1277074 "flow")}] (clojure.core/cond-> {} (letvar1277076 "flow") (clojure.core/assoc :flow (deser-flow (clojure.core/get-in letvar1277076 ["flow"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1277078 input] (clojure.core/let [rawinput1277077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277079 {"message" (rawinput1277077 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277079 ["message"]))}))))

(clojure.core/defn- response-describe-flow-response ([input] (response-describe-flow-response nil input)) ([resultWrapper1277081 input] (clojure.core/let [rawinput1277080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277082 {"flow" (rawinput1277080 "flow"), "messages" (rawinput1277080 "messages")}] (clojure.core/cond-> {} (letvar1277082 "flow") (clojure.core/assoc :flow (deser-flow (clojure.core/get-in letvar1277082 ["flow"]))) (letvar1277082 "messages") (clojure.core/assoc :messages (deser-messages (clojure.core/get-in letvar1277082 ["messages"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1277084 input] (clojure.core/let [rawinput1277083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277085 {"message" (rawinput1277083 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277085 ["message"]))}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1277087 input] (clojure.core/let [rawinput1277086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277088 {"message" (rawinput1277086 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277088 ["message"]))}))))

(clojure.core/defn- response-delete-flow-response ([input] (response-delete-flow-response nil input)) ([resultWrapper1277090 input] (clojure.core/let [rawinput1277089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277091 {"flowArn" (rawinput1277089 "flowArn"), "status" (rawinput1277089 "status")}] (clojure.core/cond-> {} (letvar1277091 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277091 ["flowArn"]))) (letvar1277091 "status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar1277091 ["status"])))))))

(clojure.core/defn- response-update-flow-entitlement-response ([input] (response-update-flow-entitlement-response nil input)) ([resultWrapper1277093 input] (clojure.core/let [rawinput1277092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277094 {"entitlement" (rawinput1277092 "entitlement"), "flowArn" (rawinput1277092 "flowArn")}] (clojure.core/cond-> {} (letvar1277094 "entitlement") (clojure.core/assoc :entitlement (deser-entitlement (clojure.core/get-in letvar1277094 ["entitlement"]))) (letvar1277094 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277094 ["flowArn"])))))))

(clojure.core/defn- response-stop-flow-response ([input] (response-stop-flow-response nil input)) ([resultWrapper1277096 input] (clojure.core/let [rawinput1277095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277097 {"flowArn" (rawinput1277095 "flowArn"), "status" (rawinput1277095 "status")}] (clojure.core/cond-> {} (letvar1277097 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277097 ["flowArn"]))) (letvar1277097 "status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar1277097 ["status"])))))))

(clojure.core/defn- response-grant-flow-entitlements-response ([input] (response-grant-flow-entitlements-response nil input)) ([resultWrapper1277099 input] (clojure.core/let [rawinput1277098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277100 {"entitlements" (rawinput1277098 "entitlements"), "flowArn" (rawinput1277098 "flowArn")}] (clojure.core/cond-> {} (letvar1277100 "entitlements") (clojure.core/assoc :entitlements (deser-list-of-entitlement (clojure.core/get-in letvar1277100 ["entitlements"]))) (letvar1277100 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277100 ["flowArn"])))))))

(clojure.core/defn- response-create-flow-420-exception ([input] (response-create-flow-420-exception nil input)) ([resultWrapper1277102 input] (clojure.core/let [rawinput1277101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277103 {"message" (rawinput1277101 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277103 ["message"]))}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1277105 input] (clojure.core/let [rawinput1277104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277106 {"message" (rawinput1277104 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277106 ["message"]))}))))

(clojure.core/defn- response-update-flow-output-response ([input] (response-update-flow-output-response nil input)) ([resultWrapper1277108 input] (clojure.core/let [rawinput1277107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277109 {"flowArn" (rawinput1277107 "flowArn"), "output" (rawinput1277107 "output")}] (clojure.core/cond-> {} (letvar1277109 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277109 ["flowArn"]))) (letvar1277109 "output") (clojure.core/assoc :output (deser-output (clojure.core/get-in letvar1277109 ["output"])))))))

(clojure.core/defn- response-list-entitlements-response ([input] (response-list-entitlements-response nil input)) ([resultWrapper1277111 input] (clojure.core/let [rawinput1277110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277112 {"entitlements" (rawinput1277110 "entitlements"), "nextToken" (rawinput1277110 "nextToken")}] (clojure.core/cond-> {} (letvar1277112 "entitlements") (clojure.core/assoc :entitlements (deser-list-of-listed-entitlement (clojure.core/get-in letvar1277112 ["entitlements"]))) (letvar1277112 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1277112 ["nextToken"])))))))

(clojure.core/defn- response-revoke-flow-entitlement-response ([input] (response-revoke-flow-entitlement-response nil input)) ([resultWrapper1277114 input] (clojure.core/let [rawinput1277113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277115 {"entitlementArn" (rawinput1277113 "entitlementArn"), "flowArn" (rawinput1277113 "flowArn")}] (clojure.core/cond-> {} (letvar1277115 "entitlementArn") (clojure.core/assoc :entitlement-arn (deser-string (clojure.core/get-in letvar1277115 ["entitlementArn"]))) (letvar1277115 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277115 ["flowArn"])))))))

(clojure.core/defn- response-grant-flow-entitlements-420-exception ([input] (response-grant-flow-entitlements-420-exception nil input)) ([resultWrapper1277117 input] (clojure.core/let [rawinput1277116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277118 {"message" (rawinput1277116 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277118 ["message"]))}))))

(clojure.core/defn- response-start-flow-response ([input] (response-start-flow-response nil input)) ([resultWrapper1277120 input] (clojure.core/let [rawinput1277119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277121 {"flowArn" (rawinput1277119 "flowArn"), "status" (rawinput1277119 "status")}] (clojure.core/cond-> {} (letvar1277121 "flowArn") (clojure.core/assoc :flow-arn (deser-string (clojure.core/get-in letvar1277121 ["flowArn"]))) (letvar1277121 "status") (clojure.core/assoc :status (deser-status (clojure.core/get-in letvar1277121 ["status"])))))))

(clojure.core/defn- response-add-flow-outputs-420-exception ([input] (response-add-flow-outputs-420-exception nil input)) ([resultWrapper1277123 input] (clojure.core/let [rawinput1277122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1277124 {"message" (rawinput1277122 "message")}] (clojure.core/cond-> {:message (deser-string (clojure.core/get-in letvar1277124 ["message"]))}))))
