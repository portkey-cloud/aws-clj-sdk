...
(clojure.core/defn- response-report-limit-reached-exception ([input] (response-report-limit-reached-exception nil input)) ([resultWrapper502443 input] (clojure.core/let [rawinput502442 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502444 {"Message" (rawinput502442 "Message")}] (clojure.core/cond-> {} (letvar502444 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar502444 ["Message"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper502446 input] (clojure.core/let [rawinput502445 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502447 {"Message" (rawinput502445 "Message")}] (clojure.core/cond-> {} (letvar502447 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar502447 ["Message"])))))))

(clojure.core/defn- response-put-report-definition-response ([input] (response-put-report-definition-response nil input)) ([resultWrapper502449 input] (clojure.core/let [rawinput502448 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502450 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-report-definitions-response ([input] (response-describe-report-definitions-response nil input)) ([resultWrapper502452 input] (clojure.core/let [rawinput502451 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502453 {"ReportDefinitions" (rawinput502451 "ReportDefinitions"), "NextToken" (rawinput502451 "NextToken")}] (clojure.core/cond-> {} (letvar502453 "ReportDefinitions") (clojure.core/assoc :report-definitions (deser-report-definition-list (clojure.core/get-in letvar502453 ["ReportDefinitions"]))) (letvar502453 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar502453 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper502455 input] (clojure.core/let [rawinput502454 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502456 {"Message" (rawinput502454 "Message")}] (clojure.core/cond-> {} (letvar502456 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar502456 ["Message"])))))))

(clojure.core/defn- response-duplicate-report-name-exception ([input] (response-duplicate-report-name-exception nil input)) ([resultWrapper502458 input] (clojure.core/let [rawinput502457 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502459 {"Message" (rawinput502457 "Message")}] (clojure.core/cond-> {} (letvar502459 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar502459 ["Message"])))))))

(clojure.core/defn- response-delete-report-definition-response ([input] (response-delete-report-definition-response nil input)) ([resultWrapper502461 input] (clojure.core/let [rawinput502460 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar502462 {"ResponseMessage" (rawinput502460 "ResponseMessage")}] (clojure.core/cond-> {} (letvar502462 "ResponseMessage") (clojure.core/assoc :response-message (deser-delete-response-message (clojure.core/get-in letvar502462 ["ResponseMessage"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__21078__auto__))))
