...
(clojure.core/defn- response-report-limit-reached-exception ([input] (response-report-limit-reached-exception nil input)) ([resultWrapper1645128 input] (clojure.core/let [rawinput1645127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645129 {"Message" (rawinput1645127 "Message")}] (clojure.core/cond-> {} (letvar1645129 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1645129 ["Message"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1645131 input] (clojure.core/let [rawinput1645130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645132 {"Message" (rawinput1645130 "Message")}] (clojure.core/cond-> {} (letvar1645132 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1645132 ["Message"])))))))

(clojure.core/defn- response-put-report-definition-response ([input] (response-put-report-definition-response nil input)) ([resultWrapper1645134 input] (clojure.core/let [rawinput1645133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645135 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-report-definitions-response ([input] (response-describe-report-definitions-response nil input)) ([resultWrapper1645137 input] (clojure.core/let [rawinput1645136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645138 {"ReportDefinitions" (rawinput1645136 "ReportDefinitions"), "NextToken" (rawinput1645136 "NextToken")}] (clojure.core/cond-> {} (letvar1645138 "ReportDefinitions") (clojure.core/assoc :report-definitions (deser-report-definition-list (clojure.core/get-in letvar1645138 ["ReportDefinitions"]))) (letvar1645138 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1645138 ["NextToken"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1645140 input] (clojure.core/let [rawinput1645139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645141 {"Message" (rawinput1645139 "Message")}] (clojure.core/cond-> {} (letvar1645141 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1645141 ["Message"])))))))

(clojure.core/defn- response-duplicate-report-name-exception ([input] (response-duplicate-report-name-exception nil input)) ([resultWrapper1645143 input] (clojure.core/let [rawinput1645142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645144 {"Message" (rawinput1645142 "Message")}] (clojure.core/cond-> {} (letvar1645144 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1645144 ["Message"])))))))

(clojure.core/defn- response-delete-report-definition-response ([input] (response-delete-report-definition-response nil input)) ([resultWrapper1645146 input] (clojure.core/let [rawinput1645145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1645147 {"ResponseMessage" (rawinput1645145 "ResponseMessage")}] (clojure.core/cond-> {} (letvar1645147 "ResponseMessage") (clojure.core/assoc :response-message (deser-delete-response-message (clojure.core/get-in letvar1645147 ["ResponseMessage"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__1467903__auto__))))
