...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/report-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()]+" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.cur.-2017-01-06/s-3-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[0-9A-Za-z!\-_.*\'()/]*" s__27881__auto__))))
...
(clojure.core/defn delete-report-definition ([] (delete-report-definition {})) ([delete-report-definition-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-delete-report-definition-request delete-report-definition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cur.-2017-01-06/endpoints, :http.request.configuration/target-prefix "AWSOrigamiServiceGatewayService", :http.request.spec/output-spec :portkey.aws.cur.-2017-01-06/delete-report-definition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-06", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cur.-2017-01-06/delete-report-definition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteReportDefinition", :http.request.configuration/output-deser-fn deser-delete-report-definition-response, :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.cur.-2017-01-06/internal-error-exception, "ValidationException" :portkey.aws.cur.-2017-01-06/validation-exception}})))))
...
(clojure.core/defn describe-report-definitions ([] (describe-report-definitions {})) ([describe-report-definitions-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-describe-report-definitions-request describe-report-definitions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cur.-2017-01-06/endpoints, :http.request.configuration/target-prefix "AWSOrigamiServiceGatewayService", :http.request.spec/output-spec :portkey.aws.cur.-2017-01-06/describe-report-definitions-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-06", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cur.-2017-01-06/describe-report-definitions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeReportDefinitions", :http.request.configuration/output-deser-fn deser-describe-report-definitions-response, :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.cur.-2017-01-06/internal-error-exception}})))))
...
(clojure.core/defn put-report-definition ([put-report-definition-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-put-report-definition-request put-report-definition-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.cur.-2017-01-06/endpoints, :http.request.configuration/target-prefix "AWSOrigamiServiceGatewayService", :http.request.spec/output-spec :portkey.aws.cur.-2017-01-06/put-report-definition-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-01-06", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.cur.-2017-01-06/put-report-definition-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "PutReportDefinition", :http.request.configuration/output-deser-fn deser-put-report-definition-response, :http.request.spec/error-spec {"DuplicateReportNameException" :portkey.aws.cur.-2017-01-06/duplicate-report-name-exception, "ReportLimitReachedException" :portkey.aws.cur.-2017-01-06/report-limit-reached-exception, "InternalErrorException" :portkey.aws.cur.-2017-01-06/internal-error-exception, "ValidationException" :portkey.aws.cur.-2017-01-06/validation-exception}})))))
