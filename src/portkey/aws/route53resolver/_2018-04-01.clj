...
(clojure.core/defn- response-delete-resolver-endpoint-response ([input] (response-delete-resolver-endpoint-response nil input)) ([resultWrapper1596158 input] (clojure.core/let [rawinput1596157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596159 {"ResolverEndpoint" (rawinput1596157 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596159 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596159 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-associate-resolver-endpoint-ip-address-response ([input] (response-associate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1596161 input] (clojure.core/let [rawinput1596160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596162 {"ResolverEndpoint" (rawinput1596160 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596162 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596162 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1596164 input] (clojure.core/let [rawinput1596163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596165 {"Message" (rawinput1596163 "Message")}] (clojure.core/cond-> {} (letvar1596165 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596165 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1596167 input] (clojure.core/let [rawinput1596166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596168 {"Tags" (rawinput1596166 "Tags"), "NextToken" (rawinput1596166 "NextToken")}] (clojure.core/cond-> {} (letvar1596168 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1596168 ["Tags"]))) (letvar1596168 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1596168 ["NextToken"])))))))

(clojure.core/defn- response-create-resolver-endpoint-response ([input] (response-create-resolver-endpoint-response nil input)) ([resultWrapper1596170 input] (clojure.core/let [rawinput1596169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596171 {"ResolverEndpoint" (rawinput1596169 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596171 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596171 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-update-resolver-rule-response ([input] (response-update-resolver-rule-response nil input)) ([resultWrapper1596173 input] (clojure.core/let [rawinput1596172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596174 {"ResolverRule" (rawinput1596172 "ResolverRule")}] (clojure.core/cond-> {} (letvar1596174 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1596174 ["ResolverRule"])))))))

(clojure.core/defn- response-unknown-resource-exception ([input] (response-unknown-resource-exception nil input)) ([resultWrapper1596176 input] (clojure.core/let [rawinput1596175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596177 {"Message" (rawinput1596175 "Message")}] (clojure.core/cond-> {} (letvar1596177 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596177 ["Message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1596179 input] (clojure.core/let [rawinput1596178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596180 {"Message" (rawinput1596178 "Message")}] (clojure.core/cond-> {} (letvar1596180 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596180 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1596182 input] (clojure.core/let [rawinput1596181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596183 {"Message" (rawinput1596181 "Message"), "ResourceType" (rawinput1596181 "ResourceType")}] (clojure.core/cond-> {} (letvar1596183 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596183 ["Message"]))) (letvar1596183 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1596183 ["ResourceType"])))))))

(clojure.core/defn- response-list-resolver-endpoint-ip-addresses-response ([input] (response-list-resolver-endpoint-ip-addresses-response nil input)) ([resultWrapper1596185 input] (clojure.core/let [rawinput1596184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596186 {"NextToken" (rawinput1596184 "NextToken"), "MaxResults" (rawinput1596184 "MaxResults"), "IpAddresses" (rawinput1596184 "IpAddresses")}] (clojure.core/cond-> {} (letvar1596186 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1596186 ["NextToken"]))) (letvar1596186 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1596186 ["MaxResults"]))) (letvar1596186 "IpAddresses") (clojure.core/assoc :ip-addresses (deser-ip-addresses-response (clojure.core/get-in letvar1596186 ["IpAddresses"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1596188 input] (clojure.core/let [rawinput1596187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596189 {"Message" (rawinput1596187 "Message"), "ResourceType" (rawinput1596187 "ResourceType")}] (clojure.core/cond-> {} (letvar1596189 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596189 ["Message"]))) (letvar1596189 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1596189 ["ResourceType"])))))))

(clojure.core/defn- response-resource-exists-exception ([input] (response-resource-exists-exception nil input)) ([resultWrapper1596191 input] (clojure.core/let [rawinput1596190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596192 {"Message" (rawinput1596190 "Message"), "ResourceType" (rawinput1596190 "ResourceType")}] (clojure.core/cond-> {} (letvar1596192 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596192 ["Message"]))) (letvar1596192 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1596192 ["ResourceType"])))))))

(clojure.core/defn- response-associate-resolver-rule-response ([input] (response-associate-resolver-rule-response nil input)) ([resultWrapper1596194 input] (clojure.core/let [rawinput1596193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596195 {"ResolverRuleAssociation" (rawinput1596193 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1596195 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1596195 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1596197 input] (clojure.core/let [rawinput1596196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596198 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1596200 input] (clojure.core/let [rawinput1596199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596201 {"Message" (rawinput1596199 "Message")}] (clojure.core/cond-> {} (letvar1596201 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596201 ["Message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1596203 input] (clojure.core/let [rawinput1596202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596204 {"Message" (rawinput1596202 "Message")}] (clojure.core/cond-> {} (letvar1596204 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596204 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1596206 input] (clojure.core/let [rawinput1596205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596207 {"Message" (rawinput1596205 "Message"), "ResourceType" (rawinput1596205 "ResourceType")}] (clojure.core/cond-> {} (letvar1596207 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596207 ["Message"]))) (letvar1596207 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1596207 ["ResourceType"])))))))

(clojure.core/defn- response-create-resolver-rule-response ([input] (response-create-resolver-rule-response nil input)) ([resultWrapper1596209 input] (clojure.core/let [rawinput1596208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596210 {"ResolverRule" (rawinput1596208 "ResolverRule")}] (clojure.core/cond-> {} (letvar1596210 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1596210 ["ResolverRule"])))))))

(clojure.core/defn- response-list-resolver-endpoints-response ([input] (response-list-resolver-endpoints-response nil input)) ([resultWrapper1596212 input] (clojure.core/let [rawinput1596211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596213 {"NextToken" (rawinput1596211 "NextToken"), "MaxResults" (rawinput1596211 "MaxResults"), "ResolverEndpoints" (rawinput1596211 "ResolverEndpoints")}] (clojure.core/cond-> {} (letvar1596213 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1596213 ["NextToken"]))) (letvar1596213 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1596213 ["MaxResults"]))) (letvar1596213 "ResolverEndpoints") (clojure.core/assoc :resolver-endpoints (deser-resolver-endpoints (clojure.core/get-in letvar1596213 ["ResolverEndpoints"])))))))

(clojure.core/defn- response-get-resolver-rule-response ([input] (response-get-resolver-rule-response nil input)) ([resultWrapper1596215 input] (clojure.core/let [rawinput1596214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596216 {"ResolverRule" (rawinput1596214 "ResolverRule")}] (clojure.core/cond-> {} (letvar1596216 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1596216 ["ResolverRule"])))))))

(clojure.core/defn- response-update-resolver-endpoint-response ([input] (response-update-resolver-endpoint-response nil input)) ([resultWrapper1596218 input] (clojure.core/let [rawinput1596217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596219 {"ResolverEndpoint" (rawinput1596217 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596219 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596219 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-list-resolver-rules-response ([input] (response-list-resolver-rules-response nil input)) ([resultWrapper1596221 input] (clojure.core/let [rawinput1596220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596222 {"NextToken" (rawinput1596220 "NextToken"), "MaxResults" (rawinput1596220 "MaxResults"), "ResolverRules" (rawinput1596220 "ResolverRules")}] (clojure.core/cond-> {} (letvar1596222 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1596222 ["NextToken"]))) (letvar1596222 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1596222 ["MaxResults"]))) (letvar1596222 "ResolverRules") (clojure.core/assoc :resolver-rules (deser-resolver-rules (clojure.core/get-in letvar1596222 ["ResolverRules"])))))))

(clojure.core/defn- response-disassociate-resolver-rule-response ([input] (response-disassociate-resolver-rule-response nil input)) ([resultWrapper1596224 input] (clojure.core/let [rawinput1596223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596225 {"ResolverRuleAssociation" (rawinput1596223 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1596225 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1596225 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-list-resolver-rule-associations-response ([input] (response-list-resolver-rule-associations-response nil input)) ([resultWrapper1596227 input] (clojure.core/let [rawinput1596226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596228 {"NextToken" (rawinput1596226 "NextToken"), "MaxResults" (rawinput1596226 "MaxResults"), "ResolverRuleAssociations" (rawinput1596226 "ResolverRuleAssociations")}] (clojure.core/cond-> {} (letvar1596228 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1596228 ["NextToken"]))) (letvar1596228 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1596228 ["MaxResults"]))) (letvar1596228 "ResolverRuleAssociations") (clojure.core/assoc :resolver-rule-associations (deser-resolver-rule-associations (clojure.core/get-in letvar1596228 ["ResolverRuleAssociations"])))))))

(clojure.core/defn- response-delete-resolver-rule-response ([input] (response-delete-resolver-rule-response nil input)) ([resultWrapper1596230 input] (clojure.core/let [rawinput1596229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596231 {"ResolverRule" (rawinput1596229 "ResolverRule")}] (clojure.core/cond-> {} (letvar1596231 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1596231 ["ResolverRule"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1596233 input] (clojure.core/let [rawinput1596232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596234 {"Message" (rawinput1596232 "Message")}] (clojure.core/cond-> {} (letvar1596234 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596234 ["Message"])))))))

(clojure.core/defn- response-put-resolver-rule-policy-response ([input] (response-put-resolver-rule-policy-response nil input)) ([resultWrapper1596236 input] (clojure.core/let [rawinput1596235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596237 {"ReturnValue" (rawinput1596235 "ReturnValue")}] (clojure.core/cond-> {} (letvar1596237 "ReturnValue") (clojure.core/assoc :return-value (deser-boolean (clojure.core/get-in letvar1596237 ["ReturnValue"])))))))

(clojure.core/defn- response-get-resolver-endpoint-response ([input] (response-get-resolver-endpoint-response nil input)) ([resultWrapper1596239 input] (clojure.core/let [rawinput1596238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596240 {"ResolverEndpoint" (rawinput1596238 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596240 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596240 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1596242 input] (clojure.core/let [rawinput1596241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596243 {"Message" (rawinput1596241 "Message"), "FieldName" (rawinput1596241 "FieldName")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1596243 ["Message"]))} (letvar1596243 "FieldName") (clojure.core/assoc :field-name (deser-string (clojure.core/get-in letvar1596243 ["FieldName"])))))))

(clojure.core/defn- response-disassociate-resolver-endpoint-ip-address-response ([input] (response-disassociate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1596245 input] (clojure.core/let [rawinput1596244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596246 {"ResolverEndpoint" (rawinput1596244 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1596246 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1596246 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-resource-unavailable-exception ([input] (response-resource-unavailable-exception nil input)) ([resultWrapper1596248 input] (clojure.core/let [rawinput1596247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596249 {"Message" (rawinput1596247 "Message"), "ResourceType" (rawinput1596247 "ResourceType")}] (clojure.core/cond-> {} (letvar1596249 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1596249 ["Message"]))) (letvar1596249 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1596249 ["ResourceType"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1596251 input] (clojure.core/let [rawinput1596250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596252 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-resolver-rule-association-response ([input] (response-get-resolver-rule-association-response nil input)) ([resultWrapper1596254 input] (clojure.core/let [rawinput1596253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596255 {"ResolverRuleAssociation" (rawinput1596253 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1596255 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1596255 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-invalid-policy-document ([input] (response-invalid-policy-document nil input)) ([resultWrapper1596257 input] (clojure.core/let [rawinput1596256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596258 {"Message" (rawinput1596256 "Message")}] (clojure.core/cond-> {} (letvar1596258 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1596258 ["Message"])))))))

(clojure.core/defn- response-get-resolver-rule-policy-response ([input] (response-get-resolver-rule-policy-response nil input)) ([resultWrapper1596260 input] (clojure.core/let [rawinput1596259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1596261 {"ResolverRulePolicy" (rawinput1596259 "ResolverRulePolicy")}] (clojure.core/cond-> {} (letvar1596261 "ResolverRulePolicy") (clojure.core/assoc :resolver-rule-policy (deser-resolver-rule-policy (clojure.core/get-in letvar1596261 ["ResolverRulePolicy"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/status-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/creator-request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/rfc-3339-time-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 12 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 7 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/resolver-rule-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5000))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_' ']+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver.-2018-04-01/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
