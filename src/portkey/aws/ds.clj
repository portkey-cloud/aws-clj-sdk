...
(clojure.core/defn- response-list-tags-for-resource-result ([input] (response-list-tags-for-resource-result nil input)) ([resultWrapper1654970 input] (clojure.core/let [rawinput1654969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654971 {"Tags" (rawinput1654969 "Tags"), "NextToken" (rawinput1654969 "NextToken")}] (clojure.core/cond-> {} (letvar1654971 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1654971 ["Tags"]))) (letvar1654971 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1654971 ["NextToken"])))))))

(clojure.core/defn- response-update-radius-result ([input] (response-update-radius-result nil input)) ([resultWrapper1654973 input] (clojure.core/let [rawinput1654972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654974 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-event-topics-result ([input] (response-describe-event-topics-result nil input)) ([resultWrapper1654976 input] (clojure.core/let [rawinput1654975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654977 {"EventTopics" (rawinput1654975 "EventTopics")}] (clojure.core/cond-> {} (letvar1654977 "EventTopics") (clojure.core/assoc :event-topics (deser-event-topics (clojure.core/get-in letvar1654977 ["EventTopics"])))))))

(clojure.core/defn- response-organizations-exception ([input] (response-organizations-exception nil input)) ([resultWrapper1654979 input] (clojure.core/let [rawinput1654978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654980 {"Message" (rawinput1654978 "Message"), "RequestId" (rawinput1654978 "RequestId")}] (clojure.core/cond-> {} (letvar1654980 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1654980 ["Message"]))) (letvar1654980 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1654980 ["RequestId"])))))))

(clojure.core/defn- response-create-conditional-forwarder-result ([input] (response-create-conditional-forwarder-result nil input)) ([resultWrapper1654982 input] (clojure.core/let [rawinput1654981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654983 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-conditional-forwarder-result ([input] (response-update-conditional-forwarder-result nil input)) ([resultWrapper1654985 input] (clojure.core/let [rawinput1654984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654986 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-entity-does-not-exist-exception ([input] (response-entity-does-not-exist-exception nil input)) ([resultWrapper1654988 input] (clojure.core/let [rawinput1654987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654989 {"Message" (rawinput1654987 "Message"), "RequestId" (rawinput1654987 "RequestId")}] (clojure.core/cond-> {} (letvar1654989 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1654989 ["Message"]))) (letvar1654989 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1654989 ["RequestId"])))))))

(clojure.core/defn- response-directory-already-shared-exception ([input] (response-directory-already-shared-exception nil input)) ([resultWrapper1654991 input] (clojure.core/let [rawinput1654990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654992 {"Message" (rawinput1654990 "Message"), "RequestId" (rawinput1654990 "RequestId")}] (clojure.core/cond-> {} (letvar1654992 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1654992 ["Message"]))) (letvar1654992 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1654992 ["RequestId"])))))))

(clojure.core/defn- response-describe-conditional-forwarders-result ([input] (response-describe-conditional-forwarders-result nil input)) ([resultWrapper1654994 input] (clojure.core/let [rawinput1654993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654995 {"ConditionalForwarders" (rawinput1654993 "ConditionalForwarders")}] (clojure.core/cond-> {} (letvar1654995 "ConditionalForwarders") (clojure.core/assoc :conditional-forwarders (deser-conditional-forwarders (clojure.core/get-in letvar1654995 ["ConditionalForwarders"])))))))

(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper1654997 input] (clojure.core/let [rawinput1654996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1654998 {"Message" (rawinput1654996 "Message"), "RequestId" (rawinput1654996 "RequestId")}] (clojure.core/cond-> {} (letvar1654998 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1654998 ["Message"]))) (letvar1654998 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1654998 ["RequestId"])))))))

(clojure.core/defn- response-ip-route-limit-exceeded-exception ([input] (response-ip-route-limit-exceeded-exception nil input)) ([resultWrapper1655000 input] (clojure.core/let [rawinput1654999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655001 {"Message" (rawinput1654999 "Message"), "RequestId" (rawinput1654999 "RequestId")}] (clojure.core/cond-> {} (letvar1655001 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655001 ["Message"]))) (letvar1655001 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655001 ["RequestId"])))))))

(clojure.core/defn- response-enable-radius-result ([input] (response-enable-radius-result nil input)) ([resultWrapper1655003 input] (clojure.core/let [rawinput1655002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655004 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-ip-routes-result ([input] (response-list-ip-routes-result nil input)) ([resultWrapper1655006 input] (clojure.core/let [rawinput1655005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655007 {"IpRoutesInfo" (rawinput1655005 "IpRoutesInfo"), "NextToken" (rawinput1655005 "NextToken")}] (clojure.core/cond-> {} (letvar1655007 "IpRoutesInfo") (clojure.core/assoc :ip-routes-info (deser-ip-routes-info (clojure.core/get-in letvar1655007 ["IpRoutesInfo"]))) (letvar1655007 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655007 ["NextToken"])))))))

(clojure.core/defn- response-create-alias-result ([input] (response-create-alias-result nil input)) ([resultWrapper1655009 input] (clojure.core/let [rawinput1655008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655010 {"DirectoryId" (rawinput1655008 "DirectoryId"), "Alias" (rawinput1655008 "Alias")}] (clojure.core/cond-> {} (letvar1655010 "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (clojure.core/get-in letvar1655010 ["DirectoryId"]))) (letvar1655010 "Alias") (clojure.core/assoc :alias (deser-alias-name (clojure.core/get-in letvar1655010 ["Alias"])))))))

(clojure.core/defn- response-share-directory-result ([input] (response-share-directory-result nil input)) ([resultWrapper1655012 input] (clojure.core/let [rawinput1655011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655013 {"SharedDirectoryId" (rawinput1655011 "SharedDirectoryId")}] (clojure.core/cond-> {} (letvar1655013 "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (clojure.core/get-in letvar1655013 ["SharedDirectoryId"])))))))

(clojure.core/defn- response-describe-trusts-result ([input] (response-describe-trusts-result nil input)) ([resultWrapper1655015 input] (clojure.core/let [rawinput1655014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655016 {"Trusts" (rawinput1655014 "Trusts"), "NextToken" (rawinput1655014 "NextToken")}] (clojure.core/cond-> {} (letvar1655016 "Trusts") (clojure.core/assoc :trusts (deser-trusts (clojure.core/get-in letvar1655016 ["Trusts"]))) (letvar1655016 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655016 ["NextToken"])))))))

(clojure.core/defn- response-directory-limit-exceeded-exception ([input] (response-directory-limit-exceeded-exception nil input)) ([resultWrapper1655018 input] (clojure.core/let [rawinput1655017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655019 {"Message" (rawinput1655017 "Message"), "RequestId" (rawinput1655017 "RequestId")}] (clojure.core/cond-> {} (letvar1655019 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655019 ["Message"]))) (letvar1655019 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655019 ["RequestId"])))))))

(clojure.core/defn- response-invalid-target-exception ([input] (response-invalid-target-exception nil input)) ([resultWrapper1655021 input] (clojure.core/let [rawinput1655020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655022 {"Message" (rawinput1655020 "Message"), "RequestId" (rawinput1655020 "RequestId")}] (clojure.core/cond-> {} (letvar1655022 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655022 ["Message"]))) (letvar1655022 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655022 ["RequestId"])))))))

(clojure.core/defn- response-describe-directories-result ([input] (response-describe-directories-result nil input)) ([resultWrapper1655024 input] (clojure.core/let [rawinput1655023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655025 {"DirectoryDescriptions" (rawinput1655023 "DirectoryDescriptions"), "NextToken" (rawinput1655023 "NextToken")}] (clojure.core/cond-> {} (letvar1655025 "DirectoryDescriptions") (clojure.core/assoc :directory-descriptions (deser-directory-descriptions (clojure.core/get-in letvar1655025 ["DirectoryDescriptions"]))) (letvar1655025 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655025 ["NextToken"])))))))

(clojure.core/defn- response-list-schema-extensions-result ([input] (response-list-schema-extensions-result nil input)) ([resultWrapper1655027 input] (clojure.core/let [rawinput1655026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655028 {"SchemaExtensionsInfo" (rawinput1655026 "SchemaExtensionsInfo"), "NextToken" (rawinput1655026 "NextToken")}] (clojure.core/cond-> {} (letvar1655028 "SchemaExtensionsInfo") (clojure.core/assoc :schema-extensions-info (deser-schema-extensions-info (clojure.core/get-in letvar1655028 ["SchemaExtensionsInfo"]))) (letvar1655028 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655028 ["NextToken"])))))))

(clojure.core/defn- response-register-event-topic-result ([input] (response-register-event-topic-result nil input)) ([resultWrapper1655030 input] (clojure.core/let [rawinput1655029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655031 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-share-limit-exceeded-exception ([input] (response-share-limit-exceeded-exception nil input)) ([resultWrapper1655033 input] (clojure.core/let [rawinput1655032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655034 {"Message" (rawinput1655032 "Message"), "RequestId" (rawinput1655032 "RequestId")}] (clojure.core/cond-> {} (letvar1655034 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655034 ["Message"]))) (letvar1655034 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655034 ["RequestId"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1655036 input] (clojure.core/let [rawinput1655035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655037 {"Message" (rawinput1655035 "Message"), "RequestId" (rawinput1655035 "RequestId")}] (clojure.core/cond-> {} (letvar1655037 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655037 ["Message"]))) (letvar1655037 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655037 ["RequestId"])))))))

(clojure.core/defn- response-remove-ip-routes-result ([input] (response-remove-ip-routes-result nil input)) ([resultWrapper1655039 input] (clojure.core/let [rawinput1655038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655040 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-trust-result ([input] (response-create-trust-result nil input)) ([resultWrapper1655042 input] (clojure.core/let [rawinput1655041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655043 {"TrustId" (rawinput1655041 "TrustId")}] (clojure.core/cond-> {} (letvar1655043 "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (clojure.core/get-in letvar1655043 ["TrustId"])))))))

(clojure.core/defn- response-disable-sso-result ([input] (response-disable-sso-result nil input)) ([resultWrapper1655045 input] (clojure.core/let [rawinput1655044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655046 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-shared-directories-result ([input] (response-describe-shared-directories-result nil input)) ([resultWrapper1655048 input] (clojure.core/let [rawinput1655047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655049 {"SharedDirectories" (rawinput1655047 "SharedDirectories"), "NextToken" (rawinput1655047 "NextToken")}] (clojure.core/cond-> {} (letvar1655049 "SharedDirectories") (clojure.core/assoc :shared-directories (deser-shared-directories (clojure.core/get-in letvar1655049 ["SharedDirectories"]))) (letvar1655049 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655049 ["NextToken"])))))))

(clojure.core/defn- response-deregister-event-topic-result ([input] (response-deregister-event-topic-result nil input)) ([resultWrapper1655051 input] (clojure.core/let [rawinput1655050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655052 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-directory-limits-result ([input] (response-get-directory-limits-result nil input)) ([resultWrapper1655054 input] (clojure.core/let [rawinput1655053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655055 {"DirectoryLimits" (rawinput1655053 "DirectoryLimits")}] (clojure.core/cond-> {} (letvar1655055 "DirectoryLimits") (clojure.core/assoc :directory-limits (deser-directory-limits (clojure.core/get-in letvar1655055 ["DirectoryLimits"])))))))

(clojure.core/defn- response-tag-limit-exceeded-exception ([input] (response-tag-limit-exceeded-exception nil input)) ([resultWrapper1655057 input] (clojure.core/let [rawinput1655056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655058 {"Message" (rawinput1655056 "Message"), "RequestId" (rawinput1655056 "RequestId")}] (clojure.core/cond-> {} (letvar1655058 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655058 ["Message"]))) (letvar1655058 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655058 ["RequestId"])))))))

(clojure.core/defn- response-invalid-password-exception ([input] (response-invalid-password-exception nil input)) ([resultWrapper1655060 input] (clojure.core/let [rawinput1655059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655061 {"Message" (rawinput1655059 "Message"), "RequestId" (rawinput1655059 "RequestId")}] (clojure.core/cond-> {} (letvar1655061 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655061 ["Message"]))) (letvar1655061 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655061 ["RequestId"])))))))

(clojure.core/defn- response-update-trust-result ([input] (response-update-trust-result nil input)) ([resultWrapper1655063 input] (clojure.core/let [rawinput1655062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655064 {"RequestId" (rawinput1655062 "RequestId"), "TrustId" (rawinput1655062 "TrustId")}] (clojure.core/cond-> {} (letvar1655064 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655064 ["RequestId"]))) (letvar1655064 "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (clojure.core/get-in letvar1655064 ["TrustId"])))))))

(clojure.core/defn- response-delete-conditional-forwarder-result ([input] (response-delete-conditional-forwarder-result nil input)) ([resultWrapper1655066 input] (clojure.core/let [rawinput1655065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655067 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-entity-already-exists-exception ([input] (response-entity-already-exists-exception nil input)) ([resultWrapper1655069 input] (clojure.core/let [rawinput1655068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655070 {"Message" (rawinput1655068 "Message"), "RequestId" (rawinput1655068 "RequestId")}] (clojure.core/cond-> {} (letvar1655070 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655070 ["Message"]))) (letvar1655070 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655070 ["RequestId"])))))))

(clojure.core/defn- response-create-microsoft-ad-result ([input] (response-create-microsoft-ad-result nil input)) ([resultWrapper1655072 input] (clojure.core/let [rawinput1655071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655073 {"DirectoryId" (rawinput1655071 "DirectoryId")}] (clojure.core/cond-> {} (letvar1655073 "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (clojure.core/get-in letvar1655073 ["DirectoryId"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1655075 input] (clojure.core/let [rawinput1655074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655076 {"Message" (rawinput1655074 "Message"), "RequestId" (rawinput1655074 "RequestId")}] (clojure.core/cond-> {} (letvar1655076 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655076 ["Message"]))) (letvar1655076 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655076 ["RequestId"])))))))

(clojure.core/defn- response-delete-snapshot-result ([input] (response-delete-snapshot-result nil input)) ([resultWrapper1655078 input] (clojure.core/let [rawinput1655077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655079 {"SnapshotId" (rawinput1655077 "SnapshotId")}] (clojure.core/cond-> {} (letvar1655079 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1655079 ["SnapshotId"])))))))

(clojure.core/defn- response-reject-shared-directory-result ([input] (response-reject-shared-directory-result nil input)) ([resultWrapper1655081 input] (clojure.core/let [rawinput1655080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655082 {"SharedDirectoryId" (rawinput1655080 "SharedDirectoryId")}] (clojure.core/cond-> {} (letvar1655082 "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (clojure.core/get-in letvar1655082 ["SharedDirectoryId"])))))))

(clojure.core/defn- response-domain-controller-limit-exceeded-exception ([input] (response-domain-controller-limit-exceeded-exception nil input)) ([resultWrapper1655084 input] (clojure.core/let [rawinput1655083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655085 {"Message" (rawinput1655083 "Message"), "RequestId" (rawinput1655083 "RequestId")}] (clojure.core/cond-> {} (letvar1655085 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655085 ["Message"]))) (letvar1655085 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655085 ["RequestId"])))))))

(clojure.core/defn- response-directory-unavailable-exception ([input] (response-directory-unavailable-exception nil input)) ([resultWrapper1655087 input] (clojure.core/let [rawinput1655086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655088 {"Message" (rawinput1655086 "Message"), "RequestId" (rawinput1655086 "RequestId")}] (clojure.core/cond-> {} (letvar1655088 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655088 ["Message"]))) (letvar1655088 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655088 ["RequestId"])))))))

(clojure.core/defn- response-create-snapshot-result ([input] (response-create-snapshot-result nil input)) ([resultWrapper1655090 input] (clojure.core/let [rawinput1655089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655091 {"SnapshotId" (rawinput1655089 "SnapshotId")}] (clojure.core/cond-> {} (letvar1655091 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1655091 ["SnapshotId"])))))))

(clojure.core/defn- response-directory-not-shared-exception ([input] (response-directory-not-shared-exception nil input)) ([resultWrapper1655093 input] (clojure.core/let [rawinput1655092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655094 {"Message" (rawinput1655092 "Message"), "RequestId" (rawinput1655092 "RequestId")}] (clojure.core/cond-> {} (letvar1655094 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655094 ["Message"]))) (letvar1655094 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655094 ["RequestId"])))))))

(clojure.core/defn- response-update-number-of-domain-controllers-result ([input] (response-update-number-of-domain-controllers-result nil input)) ([resultWrapper1655096 input] (clojure.core/let [rawinput1655095 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655097 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unsupported-operation-exception ([input] (response-unsupported-operation-exception nil input)) ([resultWrapper1655099 input] (clojure.core/let [rawinput1655098 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655100 {"Message" (rawinput1655098 "Message"), "RequestId" (rawinput1655098 "RequestId")}] (clojure.core/cond-> {} (letvar1655100 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655100 ["Message"]))) (letvar1655100 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655100 ["RequestId"])))))))

(clojure.core/defn- response-describe-domain-controllers-result ([input] (response-describe-domain-controllers-result nil input)) ([resultWrapper1655102 input] (clojure.core/let [rawinput1655101 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655103 {"DomainControllers" (rawinput1655101 "DomainControllers"), "NextToken" (rawinput1655101 "NextToken")}] (clojure.core/cond-> {} (letvar1655103 "DomainControllers") (clojure.core/assoc :domain-controllers (deser-domain-controllers (clojure.core/get-in letvar1655103 ["DomainControllers"]))) (letvar1655103 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655103 ["NextToken"])))))))

(clojure.core/defn- response-verify-trust-result ([input] (response-verify-trust-result nil input)) ([resultWrapper1655105 input] (clojure.core/let [rawinput1655104 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655106 {"TrustId" (rawinput1655104 "TrustId")}] (clojure.core/cond-> {} (letvar1655106 "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (clojure.core/get-in letvar1655106 ["TrustId"])))))))

(clojure.core/defn- response-restore-from-snapshot-result ([input] (response-restore-from-snapshot-result nil input)) ([resultWrapper1655108 input] (clojure.core/let [rawinput1655107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655109 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-unshare-directory-result ([input] (response-unshare-directory-result nil input)) ([resultWrapper1655111 input] (clojure.core/let [rawinput1655110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655112 {"SharedDirectoryId" (rawinput1655110 "SharedDirectoryId")}] (clojure.core/cond-> {} (letvar1655112 "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (clojure.core/get-in letvar1655112 ["SharedDirectoryId"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1655114 input] (clojure.core/let [rawinput1655113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655115 {"Message" (rawinput1655113 "Message"), "RequestId" (rawinput1655113 "RequestId")}] (clojure.core/cond-> {} (letvar1655115 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655115 ["Message"]))) (letvar1655115 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655115 ["RequestId"])))))))

(clojure.core/defn- response-describe-snapshots-result ([input] (response-describe-snapshots-result nil input)) ([resultWrapper1655117 input] (clojure.core/let [rawinput1655116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655118 {"Snapshots" (rawinput1655116 "Snapshots"), "NextToken" (rawinput1655116 "NextToken")}] (clojure.core/cond-> {} (letvar1655118 "Snapshots") (clojure.core/assoc :snapshots (deser-snapshots (clojure.core/get-in letvar1655118 ["Snapshots"]))) (letvar1655118 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655118 ["NextToken"])))))))

(clojure.core/defn- response-create-log-subscription-result ([input] (response-create-log-subscription-result nil input)) ([resultWrapper1655120 input] (clojure.core/let [rawinput1655119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655121 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-log-subscriptions-result ([input] (response-list-log-subscriptions-result nil input)) ([resultWrapper1655123 input] (clojure.core/let [rawinput1655122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655124 {"LogSubscriptions" (rawinput1655122 "LogSubscriptions"), "NextToken" (rawinput1655122 "NextToken")}] (clojure.core/cond-> {} (letvar1655124 "LogSubscriptions") (clojure.core/assoc :log-subscriptions (deser-log-subscriptions (clojure.core/get-in letvar1655124 ["LogSubscriptions"]))) (letvar1655124 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1655124 ["NextToken"])))))))

(clojure.core/defn- response-cancel-schema-extension-result ([input] (response-cancel-schema-extension-result nil input)) ([resultWrapper1655126 input] (clojure.core/let [rawinput1655125 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655127 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-remove-tags-from-resource-result ([input] (response-remove-tags-from-resource-result nil input)) ([resultWrapper1655129 input] (clojure.core/let [rawinput1655128 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655130 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-user-does-not-exist-exception ([input] (response-user-does-not-exist-exception nil input)) ([resultWrapper1655132 input] (clojure.core/let [rawinput1655131 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655133 {"Message" (rawinput1655131 "Message"), "RequestId" (rawinput1655131 "RequestId")}] (clojure.core/cond-> {} (letvar1655133 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655133 ["Message"]))) (letvar1655133 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655133 ["RequestId"])))))))

(clojure.core/defn- response-get-snapshot-limits-result ([input] (response-get-snapshot-limits-result nil input)) ([resultWrapper1655135 input] (clojure.core/let [rawinput1655134 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655136 {"SnapshotLimits" (rawinput1655134 "SnapshotLimits")}] (clojure.core/cond-> {} (letvar1655136 "SnapshotLimits") (clojure.core/assoc :snapshot-limits (deser-snapshot-limits (clojure.core/get-in letvar1655136 ["SnapshotLimits"])))))))

(clojure.core/defn- response-create-directory-result ([input] (response-create-directory-result nil input)) ([resultWrapper1655138 input] (clojure.core/let [rawinput1655137 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655139 {"DirectoryId" (rawinput1655137 "DirectoryId")}] (clojure.core/cond-> {} (letvar1655139 "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (clojure.core/get-in letvar1655139 ["DirectoryId"])))))))

(clojure.core/defn- response-create-computer-result ([input] (response-create-computer-result nil input)) ([resultWrapper1655141 input] (clojure.core/let [rawinput1655140 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655142 {"Computer" (rawinput1655140 "Computer")}] (clojure.core/cond-> {} (letvar1655142 "Computer") (clojure.core/assoc :computer (deser-computer (clojure.core/get-in letvar1655142 ["Computer"])))))))

(clojure.core/defn- response-delete-log-subscription-result ([input] (response-delete-log-subscription-result nil input)) ([resultWrapper1655144 input] (clojure.core/let [rawinput1655143 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655145 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-enable-sso-result ([input] (response-enable-sso-result nil input)) ([resultWrapper1655147 input] (clojure.core/let [rawinput1655146 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655148 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-add-ip-routes-result ([input] (response-add-ip-routes-result nil input)) ([resultWrapper1655150 input] (clojure.core/let [rawinput1655149 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655151 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-directory-result ([input] (response-delete-directory-result nil input)) ([resultWrapper1655153 input] (clojure.core/let [rawinput1655152 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655154 {"DirectoryId" (rawinput1655152 "DirectoryId")}] (clojure.core/cond-> {} (letvar1655154 "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (clojure.core/get-in letvar1655154 ["DirectoryId"])))))))

(clojure.core/defn- response-insufficient-permissions-exception ([input] (response-insufficient-permissions-exception nil input)) ([resultWrapper1655156 input] (clojure.core/let [rawinput1655155 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655157 {"Message" (rawinput1655155 "Message"), "RequestId" (rawinput1655155 "RequestId")}] (clojure.core/cond-> {} (letvar1655157 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655157 ["Message"]))) (letvar1655157 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655157 ["RequestId"])))))))

(clojure.core/defn- response-start-schema-extension-result ([input] (response-start-schema-extension-result nil input)) ([resultWrapper1655159 input] (clojure.core/let [rawinput1655158 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655160 {"SchemaExtensionId" (rawinput1655158 "SchemaExtensionId")}] (clojure.core/cond-> {} (letvar1655160 "SchemaExtensionId") (clojure.core/assoc :schema-extension-id (deser-schema-extension-id (clojure.core/get-in letvar1655160 ["SchemaExtensionId"])))))))

(clojure.core/defn- response-connect-directory-result ([input] (response-connect-directory-result nil input)) ([resultWrapper1655162 input] (clojure.core/let [rawinput1655161 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655163 {"DirectoryId" (rawinput1655161 "DirectoryId")}] (clojure.core/cond-> {} (letvar1655163 "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (clojure.core/get-in letvar1655163 ["DirectoryId"])))))))

(clojure.core/defn- response-delete-trust-result ([input] (response-delete-trust-result nil input)) ([resultWrapper1655165 input] (clojure.core/let [rawinput1655164 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655166 {"TrustId" (rawinput1655164 "TrustId")}] (clojure.core/cond-> {} (letvar1655166 "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (clojure.core/get-in letvar1655166 ["TrustId"])))))))

(clojure.core/defn- response-authentication-failed-exception ([input] (response-authentication-failed-exception nil input)) ([resultWrapper1655168 input] (clojure.core/let [rawinput1655167 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655169 {"Message" (rawinput1655167 "Message"), "RequestId" (rawinput1655167 "RequestId")}] (clojure.core/cond-> {} (letvar1655169 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655169 ["Message"]))) (letvar1655169 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655169 ["RequestId"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1655171 input] (clojure.core/let [rawinput1655170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655172 {"Message" (rawinput1655170 "Message"), "RequestId" (rawinput1655170 "RequestId")}] (clojure.core/cond-> {} (letvar1655172 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655172 ["Message"]))) (letvar1655172 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655172 ["RequestId"])))))))

(clojure.core/defn- response-snapshot-limit-exceeded-exception ([input] (response-snapshot-limit-exceeded-exception nil input)) ([resultWrapper1655174 input] (clojure.core/let [rawinput1655173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655175 {"Message" (rawinput1655173 "Message"), "RequestId" (rawinput1655173 "RequestId")}] (clojure.core/cond-> {} (letvar1655175 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1655175 ["Message"]))) (letvar1655175 "RequestId") (clojure.core/assoc :request-id (deser-request-id (clojure.core/get-in letvar1655175 ["RequestId"])))))))

(clojure.core/defn- response-disable-radius-result ([input] (response-disable-radius-result nil input)) ([resultWrapper1655177 input] (clojure.core/let [rawinput1655176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655178 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-accept-shared-directory-result ([input] (response-accept-shared-directory-result nil input)) ([resultWrapper1655180 input] (clojure.core/let [rawinput1655179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655181 {"SharedDirectory" (rawinput1655179 "SharedDirectory")}] (clojure.core/cond-> {} (letvar1655181 "SharedDirectory") (clojure.core/assoc :shared-directory (deser-shared-directory (clojure.core/get-in letvar1655181 ["SharedDirectory"])))))))

(clojure.core/defn- response-add-tags-to-resource-result ([input] (response-add-tags-to-resource-result nil input)) ([resultWrapper1655183 input] (clojure.core/let [rawinput1655182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655184 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-reset-user-password-result ([input] (response-reset-user-password-result nil input)) ([resultWrapper1655186 input] (clojure.core/let [rawinput1655185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1655187 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.ds/ip-addr (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/radius-display-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.ds/connect-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.ds/request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/customer-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(\d{12})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/trust-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(.|\s)*\S(.|\s)*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(?=^.{8,64}$)((?=.*\d)(?=.*[A-Z])(?=.*[a-z])|(?=.*\d)(?=.*[^A-Za-z0-9\s])(?=.*[a-z])|(?=.*[^A-Za-z0-9\s])(?=.*[A-Z])(?=.*[a-z])|(?=.*\d)(?=.*[A-Z])(?=.*[^A-Za-z0-9\s]))^.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.ds/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8}|subnet-[0-9a-f]{17})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/ldif-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500000))))
...
(clojure.spec.alpha/def :portkey.aws.ds/topic-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/radius-shared-secret (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 8 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.ds/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/organizational-unit-dn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.ds/domain-controller-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^dc-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[d]-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-short-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[^\\/:*?\"\<\>|.]+[^\\/:*?\"<>|]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/target-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.ds/trust-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^t-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9_])[\\a-zA-Z0-9_@#%*+=:?./!\s-]*$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8}|sg-[0-9a-f]{17})$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/exception-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.ds/schema-extension-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^e-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/vpc-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(vpc-[0-9a-f]{8}|vpc-[0-9a-f]{17})$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/customer-user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(?!.*\\|.*\"|.*\/|.*\[|.*\]|.*:|.*;|.*\||.*=|.*,|.*\+|.*\*|.*\?|.*<|.*>|.*@).*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/log-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[-._/#A-Za-z0-9]+" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/dns-ip-addrs (clojure.spec.alpha/coll-of :portkey.aws.ds/ip-addr))

(clojure.spec.alpha/def :portkey.aws.ds/access-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.ds/server (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.ds/computer-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 8 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{10}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/remote-domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9]+[\\.-])+([a-zA-Z0-9])+[.]?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9]+[\\.-])+([a-zA-Z0-9])+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/user-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.ds/notes (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.ds/disable-radius-result (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.ds/computer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15))))
...
(clojure.spec.alpha/def :portkey.aws.ds/snapshot-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9_])[\\a-zA-Z0-9_@#%*+=:?./!\s-]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/cidr-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([1-9]|[1-2][0-9]|3[0-2]))$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/snapshot-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^s-[0-9a-f]{10}$" s__1410940__auto__))))
