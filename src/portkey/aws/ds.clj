...
(clojure.core/defn- deser-list-tags-for-resource-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Tags") (clojure.core/assoc :tags (deser-tags (input "Tags"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-update-radius-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-event-topics-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "EventTopics") (clojure.core/assoc :event-topics (deser-event-topics (input "EventTopics")))))

(clojure.core/defn- deser-organizations-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-create-conditional-forwarder-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-conditional-forwarder-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-entity-does-not-exist-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-directory-already-shared-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-describe-conditional-forwarders-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ConditionalForwarders") (clojure.core/assoc :conditional-forwarders (deser-conditional-forwarders (input "ConditionalForwarders")))))

(clojure.core/defn- deser-client-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-ip-route-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-enable-radius-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-ip-routes-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "IpRoutesInfo") (clojure.core/assoc :ip-routes-info (deser-ip-routes-info (input "IpRoutesInfo"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-create-alias-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (input "DirectoryId"))) (clojure.core/contains? input "Alias") (clojure.core/assoc :alias (deser-alias-name (input "Alias")))))

(clojure.core/defn- deser-share-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (input "SharedDirectoryId")))))

(clojure.core/defn- deser-describe-trusts-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Trusts") (clojure.core/assoc :trusts (deser-trusts (input "Trusts"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-directory-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-invalid-target-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-describe-directories-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryDescriptions") (clojure.core/assoc :directory-descriptions (deser-directory-descriptions (input "DirectoryDescriptions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-list-schema-extensions-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SchemaExtensionsInfo") (clojure.core/assoc :schema-extensions-info (deser-schema-extensions-info (input "SchemaExtensionsInfo"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-register-event-topic-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-share-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-service-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-remove-ip-routes-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-trust-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (input "TrustId")))))

(clojure.core/defn- deser-disable-sso-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-shared-directories-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SharedDirectories") (clojure.core/assoc :shared-directories (deser-shared-directories (input "SharedDirectories"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-deregister-event-topic-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-get-directory-limits-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryLimits") (clojure.core/assoc :directory-limits (deser-directory-limits (input "DirectoryLimits")))))

(clojure.core/defn- deser-tag-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-invalid-password-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-update-trust-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId"))) (clojure.core/contains? input "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (input "TrustId")))))

(clojure.core/defn- deser-delete-conditional-forwarder-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-entity-already-exists-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-create-microsoft-ad-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (input "DirectoryId")))))

(clojure.core/defn- deser-invalid-next-token-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-delete-snapshot-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (input "SnapshotId")))))

(clojure.core/defn- deser-reject-shared-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (input "SharedDirectoryId")))))

(clojure.core/defn- deser-domain-controller-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-directory-unavailable-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-create-snapshot-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (input "SnapshotId")))))

(clojure.core/defn- deser-directory-not-shared-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-update-number-of-domain-controllers-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-unsupported-operation-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-describe-domain-controllers-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DomainControllers") (clojure.core/assoc :domain-controllers (deser-domain-controllers (input "DomainControllers"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-verify-trust-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (input "TrustId")))))

(clojure.core/defn- deser-restore-from-snapshot-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-unshare-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SharedDirectoryId") (clojure.core/assoc :shared-directory-id (deser-directory-id (input "SharedDirectoryId")))))

(clojure.core/defn- deser-access-denied-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-describe-snapshots-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Snapshots") (clojure.core/assoc :snapshots (deser-snapshots (input "Snapshots"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-create-log-subscription-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-log-subscriptions-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "LogSubscriptions") (clojure.core/assoc :log-subscriptions (deser-log-subscriptions (input "LogSubscriptions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-next-token (input "NextToken")))))

(clojure.core/defn- deser-cancel-schema-extension-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-remove-tags-from-resource-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-user-does-not-exist-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-get-snapshot-limits-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SnapshotLimits") (clojure.core/assoc :snapshot-limits (deser-snapshot-limits (input "SnapshotLimits")))))

(clojure.core/defn- deser-create-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (input "DirectoryId")))))

(clojure.core/defn- deser-create-computer-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Computer") (clojure.core/assoc :computer (deser-computer (input "Computer")))))

(clojure.core/defn- deser-delete-log-subscription-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-enable-sso-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-add-ip-routes-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (input "DirectoryId")))))

(clojure.core/defn- deser-insufficient-permissions-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-start-schema-extension-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SchemaExtensionId") (clojure.core/assoc :schema-extension-id (deser-schema-extension-id (input "SchemaExtensionId")))))

(clojure.core/defn- deser-connect-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryId") (clojure.core/assoc :directory-id (deser-directory-id (input "DirectoryId")))))

(clojure.core/defn- deser-delete-trust-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "TrustId") (clojure.core/assoc :trust-id (deser-trust-id (input "TrustId")))))

(clojure.core/defn- deser-authentication-failed-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-invalid-parameter-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-snapshot-limit-exceeded-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-exception-message (input "Message"))) (clojure.core/contains? input "RequestId") (clojure.core/assoc :request-id (deser-request-id (input "RequestId")))))

(clojure.core/defn- deser-disable-radius-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-accept-shared-directory-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "SharedDirectory") (clojure.core/assoc :shared-directory (deser-shared-directory (input "SharedDirectory")))))

(clojure.core/defn- deser-add-tags-to-resource-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-reset-user-password-result [input] (clojure.core/cond-> {}))
...
(clojure.spec.alpha/def :portkey.aws.ds/ip-addr (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/radius-display-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.ds/connect-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.ds/request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/customer-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(\d{12})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/trust-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"(.|\s)*\S(.|\s)*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"(?=^.{8,64}$)((?=.*\d)(?=.*[A-Z])(?=.*[a-z])|(?=.*\d)(?=.*[^A-Za-z0-9\s])(?=.*[a-z])|(?=.*[^A-Za-z0-9\s])(?=.*[A-Z])(?=.*[a-z])|(?=.*\d)(?=.*[A-Z])(?=.*[^A-Za-z0-9\s]))^.*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.ds/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(subnet-[0-9a-f]{8}|subnet-[0-9a-f]{17})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/ldif-content (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 500000))))
...
(clojure.spec.alpha/def :portkey.aws.ds/topic-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/radius-shared-secret (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 8 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.ds/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/organizational-unit-dn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.ds/domain-controller-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^dc-[0-9a-f]{10}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[d]-[0-9a-f]{10}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._-]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-short-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[^\\/:*?\"\<\>|.]+[^\\/:*?\"<>|]*$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/target-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.ds/trust-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^t-[0-9a-f]{10}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9_])[\\a-zA-Z0-9_@#%*+=:?./!\s-]*$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/security-group-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(sg-[0-9a-f]{8}|sg-[0-9a-f]{17})$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/exception-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.ds/schema-extension-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^e-[0-9a-f]{10}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/vpc-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(vpc-[0-9a-f]{8}|vpc-[0-9a-f]{17})$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/customer-user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(?!.*\\|.*\"|.*\/|.*\[|.*\]|.*:|.*;|.*\||.*=|.*,|.*\+|.*\*|.*\?|.*<|.*>|.*@).*$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/log-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 512)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[-._/#A-Za-z0-9]+" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/dns-ip-addrs (clojure.spec.alpha/coll-of :portkey.aws.ds/ip-addr))

(clojure.spec.alpha/def :portkey.aws.ds/access-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.ds/server (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.ds/computer-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 8 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\u0020-\u00FF]+" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^d-[0-9a-f]{10}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/remote-domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9]+[\\.-])+([a-zA-Z0-9])+[.]?$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/directory-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9]+[\\.-])+([a-zA-Z0-9])+$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/user-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.ds/alias-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 62)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(?!d-)([\da-zA-Z]+)([-]*[\da-zA-Z])*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/notes (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.ds/disable-radius-result (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.ds/computer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 15))))
...
(clojure.spec.alpha/def :portkey.aws.ds/snapshot-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([a-zA-Z0-9_])[\\a-zA-Z0-9_@#%*+=:?./!\s-]*$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.ds/cidr-ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([1-9]|[1-2][0-9]|3[0-2]))$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.ds/snapshot-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^s-[0-9a-f]{10}$" s__27881__auto__))))
