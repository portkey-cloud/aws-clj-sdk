...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1531181 input] (clojure.core/let [rawinput1531180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531182 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-environments-result ([input] (response-list-environments-result nil input)) ([resultWrapper1531184 input] (clojure.core/let [rawinput1531183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531185 {"nextToken" (rawinput1531183 "nextToken"), "environmentIds" (rawinput1531183 "environmentIds")}] (clojure.core/cond-> {} (letvar1531185 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1531185 ["nextToken"]))) (letvar1531185 "environmentIds") (clojure.core/assoc :environment-ids (deser-environment-id-list (clojure.core/get-in letvar1531185 ["environmentIds"])))))))

(clojure.core/defn- response-describe-environment-memberships-result ([input] (response-describe-environment-memberships-result nil input)) ([resultWrapper1531187 input] (clojure.core/let [rawinput1531186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531188 {"memberships" (rawinput1531186 "memberships"), "nextToken" (rawinput1531186 "nextToken")}] (clojure.core/cond-> {} (letvar1531188 "memberships") (clojure.core/assoc :memberships (deser-environment-members-list (clojure.core/get-in letvar1531188 ["memberships"]))) (letvar1531188 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1531188 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1531190 input] (clojure.core/let [rawinput1531189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531191 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-environment-result ([input] (response-delete-environment-result nil input)) ([resultWrapper1531193 input] (clojure.core/let [rawinput1531192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531194 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-ec-2-result ([input] (response-create-environment-ec-2-result nil input)) ([resultWrapper1531196 input] (clojure.core/let [rawinput1531195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531197 {"environmentId" (rawinput1531195 "environmentId")}] (clojure.core/cond-> {} (letvar1531197 "environmentId") (clojure.core/assoc :environment-id (deser-environment-id (clojure.core/get-in letvar1531197 ["environmentId"])))))))

(clojure.core/defn- response-update-environment-result ([input] (response-update-environment-result nil input)) ([resultWrapper1531199 input] (clojure.core/let [rawinput1531198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531200 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1531202 input] (clojure.core/let [rawinput1531201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531203 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1531205 input] (clojure.core/let [rawinput1531204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531206 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environment-status-result ([input] (response-describe-environment-status-result nil input)) ([resultWrapper1531208 input] (clojure.core/let [rawinput1531207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531209 {"status" (rawinput1531207 "status"), "message" (rawinput1531207 "message")}] (clojure.core/cond-> {} (letvar1531209 "status") (clojure.core/assoc :status (deser-environment-status (clojure.core/get-in letvar1531209 ["status"]))) (letvar1531209 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1531209 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1531211 input] (clojure.core/let [rawinput1531210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531212 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-environment-membership-result ([input] (response-update-environment-membership-result nil input)) ([resultWrapper1531214 input] (clojure.core/let [rawinput1531213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531215 {"membership" (rawinput1531213 "membership")}] (clojure.core/cond-> {} (letvar1531215 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1531215 ["membership"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1531217 input] (clojure.core/let [rawinput1531216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531218 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1531220 input] (clojure.core/let [rawinput1531219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531221 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-membership-result ([input] (response-create-environment-membership-result nil input)) ([resultWrapper1531223 input] (clojure.core/let [rawinput1531222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531224 {"membership" (rawinput1531222 "membership")}] (clojure.core/cond-> {} (letvar1531224 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1531224 ["membership"])))))))

(clojure.core/defn- response-delete-environment-membership-result ([input] (response-delete-environment-membership-result nil input)) ([resultWrapper1531226 input] (clojure.core/let [rawinput1531225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531227 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environments-result ([input] (response-describe-environments-result nil input)) ([resultWrapper1531229 input] (clojure.core/let [rawinput1531228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1531230 {"environments" (rawinput1531228 "environments")}] (clojure.core/cond-> {} (letvar1531230 "environments") (clojure.core/assoc :environments (deser-environment-list (clojure.core/get-in letvar1531230 ["environments"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 5 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:(root|user|federated-user|assumed-role)\/?\S*" s__1467903__auto__))))
