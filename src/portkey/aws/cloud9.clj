...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1475163 input] (clojure.core/let [rawinput1475162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475164 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-environments-result ([input] (response-list-environments-result nil input)) ([resultWrapper1475166 input] (clojure.core/let [rawinput1475165 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475167 {"nextToken" (rawinput1475165 "nextToken"), "environmentIds" (rawinput1475165 "environmentIds")}] (clojure.core/cond-> {} (letvar1475167 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1475167 ["nextToken"]))) (letvar1475167 "environmentIds") (clojure.core/assoc :environment-ids (deser-environment-id-list (clojure.core/get-in letvar1475167 ["environmentIds"])))))))

(clojure.core/defn- response-describe-environment-memberships-result ([input] (response-describe-environment-memberships-result nil input)) ([resultWrapper1475169 input] (clojure.core/let [rawinput1475168 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475170 {"memberships" (rawinput1475168 "memberships"), "nextToken" (rawinput1475168 "nextToken")}] (clojure.core/cond-> {} (letvar1475170 "memberships") (clojure.core/assoc :memberships (deser-environment-members-list (clojure.core/get-in letvar1475170 ["memberships"]))) (letvar1475170 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1475170 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1475172 input] (clojure.core/let [rawinput1475171 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475173 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-environment-result ([input] (response-delete-environment-result nil input)) ([resultWrapper1475175 input] (clojure.core/let [rawinput1475174 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475176 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-ec-2-result ([input] (response-create-environment-ec-2-result nil input)) ([resultWrapper1475178 input] (clojure.core/let [rawinput1475177 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475179 {"environmentId" (rawinput1475177 "environmentId")}] (clojure.core/cond-> {} (letvar1475179 "environmentId") (clojure.core/assoc :environment-id (deser-environment-id (clojure.core/get-in letvar1475179 ["environmentId"])))))))

(clojure.core/defn- response-update-environment-result ([input] (response-update-environment-result nil input)) ([resultWrapper1475181 input] (clojure.core/let [rawinput1475180 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475182 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1475184 input] (clojure.core/let [rawinput1475183 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475185 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1475187 input] (clojure.core/let [rawinput1475186 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475188 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environment-status-result ([input] (response-describe-environment-status-result nil input)) ([resultWrapper1475190 input] (clojure.core/let [rawinput1475189 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475191 {"status" (rawinput1475189 "status"), "message" (rawinput1475189 "message")}] (clojure.core/cond-> {} (letvar1475191 "status") (clojure.core/assoc :status (deser-environment-status (clojure.core/get-in letvar1475191 ["status"]))) (letvar1475191 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1475191 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1475193 input] (clojure.core/let [rawinput1475192 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475194 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-environment-membership-result ([input] (response-update-environment-membership-result nil input)) ([resultWrapper1475196 input] (clojure.core/let [rawinput1475195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475197 {"membership" (rawinput1475195 "membership")}] (clojure.core/cond-> {} (letvar1475197 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1475197 ["membership"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1475199 input] (clojure.core/let [rawinput1475198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475200 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1475202 input] (clojure.core/let [rawinput1475201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475203 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-environment-membership-result ([input] (response-create-environment-membership-result nil input)) ([resultWrapper1475205 input] (clojure.core/let [rawinput1475204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475206 {"membership" (rawinput1475204 "membership")}] (clojure.core/cond-> {} (letvar1475206 "membership") (clojure.core/assoc :membership (deser-environment-member (clojure.core/get-in letvar1475206 ["membership"])))))))

(clojure.core/defn- response-delete-environment-membership-result ([input] (response-delete-environment-membership-result nil input)) ([resultWrapper1475208 input] (clojure.core/let [rawinput1475207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475209 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-environments-result ([input] (response-describe-environments-result nil input)) ([resultWrapper1475211 input] (clojure.core/let [rawinput1475210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1475212 {"environments" (rawinput1475210 "environments")}] (clojure.core/cond-> {} (letvar1475212 "environments") (clojure.core/assoc :environments (deser-environment-list (clojure.core/get-in letvar1475212 ["environments"])))))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:(root|user|federated-user|assumed-role)\/?\S*" s__1410940__auto__))))
