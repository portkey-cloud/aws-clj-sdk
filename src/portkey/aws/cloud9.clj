...
(clojure.spec.alpha/def :portkey.aws.cloud9/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[\x20-\x7E]{10,128}" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 5 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/<= 1 (clojure.core/count s__27880__auto__))) (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 60))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/environment-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9]{8,32}$" s__27882__auto__))))

(clojure.spec.alpha/def :portkey.aws.cloud9/environment-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.cloud9/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"arn:aws:(iam|sts)::\d+:\S+" s__27882__auto__))))
