...
(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1139887 input] (clojure.core/let [rawinput1139886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139888 {"message" (rawinput1139886 "message")}] (clojure.core/cond-> {} (letvar1139888 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139888 ["message"])))))))

(clojure.core/defn- response-certificate-validation-exception ([input] (response-certificate-validation-exception nil input)) ([resultWrapper1139890 input] (clojure.core/let [rawinput1139889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139891 {"message" (rawinput1139889 "message")}] (clojure.core/cond-> {} (letvar1139891 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139891 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1139893 input] (clojure.core/let [rawinput1139892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139894 {"message" (rawinput1139892 "message")}] (clojure.core/cond-> {} (letvar1139894 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139894 ["message"])))))))

(clojure.core/defn- response-get-pending-job-executions-response ([input] (response-get-pending-job-executions-response nil input)) ([resultWrapper1139896 input] (clojure.core/let [rawinput1139895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139897 {"inProgressJobs" (rawinput1139895 "inProgressJobs"), "queuedJobs" (rawinput1139895 "queuedJobs")}] (clojure.core/cond-> {} (letvar1139897 "inProgressJobs") (clojure.core/assoc :in-progress-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar1139897 ["inProgressJobs"]))) (letvar1139897 "queuedJobs") (clojure.core/assoc :queued-jobs (deser-job-execution-summary-list (clojure.core/get-in letvar1139897 ["queuedJobs"])))))))

(clojure.core/defn- response-terminal-state-exception ([input] (response-terminal-state-exception nil input)) ([resultWrapper1139899 input] (clojure.core/let [rawinput1139898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139900 {"message" (rawinput1139898 "message")}] (clojure.core/cond-> {} (letvar1139900 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139900 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1139902 input] (clojure.core/let [rawinput1139901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139903 {"message" (rawinput1139901 "message")}] (clojure.core/cond-> {} (letvar1139903 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139903 ["message"])))))))

(clojure.core/defn- response-describe-job-execution-response ([input] (response-describe-job-execution-response nil input)) ([resultWrapper1139905 input] (clojure.core/let [rawinput1139904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139906 {"execution" (rawinput1139904 "execution")}] (clojure.core/cond-> {} (letvar1139906 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar1139906 ["execution"])))))))

(clojure.core/defn- response-invalid-state-transition-exception ([input] (response-invalid-state-transition-exception nil input)) ([resultWrapper1139908 input] (clojure.core/let [rawinput1139907 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139909 {"message" (rawinput1139907 "message")}] (clojure.core/cond-> {} (letvar1139909 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139909 ["message"])))))))

(clojure.core/defn- response-update-job-execution-response ([input] (response-update-job-execution-response nil input)) ([resultWrapper1139911 input] (clojure.core/let [rawinput1139910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139912 {"executionState" (rawinput1139910 "executionState"), "jobDocument" (rawinput1139910 "jobDocument")}] (clojure.core/cond-> {} (letvar1139912 "executionState") (clojure.core/assoc :execution-state (deser-job-execution-state (clojure.core/get-in letvar1139912 ["executionState"]))) (letvar1139912 "jobDocument") (clojure.core/assoc :job-document (deser-job-document (clojure.core/get-in letvar1139912 ["jobDocument"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1139914 input] (clojure.core/let [rawinput1139913 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139915 {"message" (rawinput1139913 "message"), "payload" (rawinput1139913 "payload")}] (clojure.core/cond-> {} (letvar1139915 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1139915 ["message"]))) (letvar1139915 "payload") (clojure.core/assoc :payload (deser-binary-blob (clojure.core/get-in letvar1139915 ["payload"])))))))

(clojure.core/defn- response-start-next-pending-job-execution-response ([input] (response-start-next-pending-job-execution-response nil input)) ([resultWrapper1139917 input] (clojure.core/let [rawinput1139916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1139918 {"execution" (rawinput1139916 "execution")}] (clojure.core/cond-> {} (letvar1139918 "execution") (clojure.core/assoc :execution (deser-job-execution (clojure.core/get-in letvar1139918 ["execution"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data/job-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32768))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data/thing-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot-jobs-data/details-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9:_-]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.iot-jobs-data/describe-job-execution-job-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_-]+|^\$next" s__21078__auto__))))
