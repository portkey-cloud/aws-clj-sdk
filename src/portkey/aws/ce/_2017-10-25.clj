...
(clojure.spec.alpha/def :portkey.aws.ce.-2017-10-25/year-month-day (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"\d{4}-\d{2}-\d{2}" s__27882__auto__))))
