...
(clojure.core/defn- response-stop-query-execution-output ([input] (response-stop-query-execution-output nil input)) ([resultWrapper1453758 input] (clojure.core/let [rawinput1453757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453759 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1453761 input] (clojure.core/let [rawinput1453760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453762 {"AthenaErrorCode" (rawinput1453760 "AthenaErrorCode"), "Message" (rawinput1453760 "Message")}] (clojure.core/cond-> {} (letvar1453762 "AthenaErrorCode") (clojure.core/assoc :athena-error-code (deser-error-code (clojure.core/get-in letvar1453762 ["AthenaErrorCode"]))) (letvar1453762 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1453762 ["Message"])))))))

(clojure.core/defn- response-get-query-execution-output ([input] (response-get-query-execution-output nil input)) ([resultWrapper1453764 input] (clojure.core/let [rawinput1453763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453765 {"QueryExecution" (rawinput1453763 "QueryExecution")}] (clojure.core/cond-> {} (letvar1453765 "QueryExecution") (clojure.core/assoc :query-execution (deser-query-execution (clojure.core/get-in letvar1453765 ["QueryExecution"])))))))

(clojure.core/defn- response-update-work-group-output ([input] (response-update-work-group-output nil input)) ([resultWrapper1453767 input] (clojure.core/let [rawinput1453766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453768 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-work-group-output ([input] (response-create-work-group-output nil input)) ([resultWrapper1453770 input] (clojure.core/let [rawinput1453769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453771 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-output ([input] (response-tag-resource-output nil input)) ([resultWrapper1453773 input] (clojure.core/let [rawinput1453772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453774 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-named-queries-output ([input] (response-list-named-queries-output nil input)) ([resultWrapper1453776 input] (clojure.core/let [rawinput1453775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453777 {"NamedQueryIds" (rawinput1453775 "NamedQueryIds"), "NextToken" (rawinput1453775 "NextToken")}] (clojure.core/cond-> {} (letvar1453777 "NamedQueryIds") (clojure.core/assoc :named-query-ids (deser-named-query-id-list (clojure.core/get-in letvar1453777 ["NamedQueryIds"]))) (letvar1453777 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1453777 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1453779 input] (clojure.core/let [rawinput1453778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453780 {"Message" (rawinput1453778 "Message"), "Reason" (rawinput1453778 "Reason")}] (clojure.core/cond-> {} (letvar1453780 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1453780 ["Message"]))) (letvar1453780 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1453780 ["Reason"])))))))

(clojure.core/defn- response-batch-get-named-query-output ([input] (response-batch-get-named-query-output nil input)) ([resultWrapper1453782 input] (clojure.core/let [rawinput1453781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453783 {"NamedQueries" (rawinput1453781 "NamedQueries"), "UnprocessedNamedQueryIds" (rawinput1453781 "UnprocessedNamedQueryIds")}] (clojure.core/cond-> {} (letvar1453783 "NamedQueries") (clojure.core/assoc :named-queries (deser-named-query-list (clojure.core/get-in letvar1453783 ["NamedQueries"]))) (letvar1453783 "UnprocessedNamedQueryIds") (clojure.core/assoc :unprocessed-named-query-ids (deser-unprocessed-named-query-id-list (clojure.core/get-in letvar1453783 ["UnprocessedNamedQueryIds"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1453785 input] (clojure.core/let [rawinput1453784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453786 {"Message" (rawinput1453784 "Message"), "ResourceName" (rawinput1453784 "ResourceName")}] (clojure.core/cond-> {} (letvar1453786 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1453786 ["Message"]))) (letvar1453786 "ResourceName") (clojure.core/assoc :resource-name (deser-amazon-resource-name (clojure.core/get-in letvar1453786 ["ResourceName"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1453788 input] (clojure.core/let [rawinput1453787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453789 {"Message" (rawinput1453787 "Message")}] (clojure.core/cond-> {} (letvar1453789 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1453789 ["Message"])))))))

(clojure.core/defn- response-create-named-query-output ([input] (response-create-named-query-output nil input)) ([resultWrapper1453791 input] (clojure.core/let [rawinput1453790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453792 {"NamedQueryId" (rawinput1453790 "NamedQueryId")}] (clojure.core/cond-> {} (letvar1453792 "NamedQueryId") (clojure.core/assoc :named-query-id (deser-named-query-id (clojure.core/get-in letvar1453792 ["NamedQueryId"])))))))

(clojure.core/defn- response-start-query-execution-output ([input] (response-start-query-execution-output nil input)) ([resultWrapper1453794 input] (clojure.core/let [rawinput1453793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453795 {"QueryExecutionId" (rawinput1453793 "QueryExecutionId")}] (clojure.core/cond-> {} (letvar1453795 "QueryExecutionId") (clojure.core/assoc :query-execution-id (deser-query-execution-id (clojure.core/get-in letvar1453795 ["QueryExecutionId"])))))))

(clojure.core/defn- response-get-named-query-output ([input] (response-get-named-query-output nil input)) ([resultWrapper1453797 input] (clojure.core/let [rawinput1453796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453798 {"NamedQuery" (rawinput1453796 "NamedQuery")}] (clojure.core/cond-> {} (letvar1453798 "NamedQuery") (clojure.core/assoc :named-query (deser-named-query (clojure.core/get-in letvar1453798 ["NamedQuery"])))))))

(clojure.core/defn- response-delete-named-query-output ([input] (response-delete-named-query-output nil input)) ([resultWrapper1453800 input] (clojure.core/let [rawinput1453799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453801 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-query-execution-output ([input] (response-batch-get-query-execution-output nil input)) ([resultWrapper1453803 input] (clojure.core/let [rawinput1453802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453804 {"QueryExecutions" (rawinput1453802 "QueryExecutions"), "UnprocessedQueryExecutionIds" (rawinput1453802 "UnprocessedQueryExecutionIds")}] (clojure.core/cond-> {} (letvar1453804 "QueryExecutions") (clojure.core/assoc :query-executions (deser-query-execution-list (clojure.core/get-in letvar1453804 ["QueryExecutions"]))) (letvar1453804 "UnprocessedQueryExecutionIds") (clojure.core/assoc :unprocessed-query-execution-ids (deser-unprocessed-query-execution-id-list (clojure.core/get-in letvar1453804 ["UnprocessedQueryExecutionIds"])))))))

(clojure.core/defn- response-list-work-groups-output ([input] (response-list-work-groups-output nil input)) ([resultWrapper1453806 input] (clojure.core/let [rawinput1453805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453807 {"WorkGroups" (rawinput1453805 "WorkGroups"), "NextToken" (rawinput1453805 "NextToken")}] (clojure.core/cond-> {} (letvar1453807 "WorkGroups") (clojure.core/assoc :work-groups (deser-work-groups-list (clojure.core/get-in letvar1453807 ["WorkGroups"]))) (letvar1453807 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1453807 ["NextToken"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper1453809 input] (clojure.core/let [rawinput1453808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453810 {"Tags" (rawinput1453808 "Tags"), "NextToken" (rawinput1453808 "NextToken")}] (clojure.core/cond-> {} (letvar1453810 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1453810 ["Tags"]))) (letvar1453810 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1453810 ["NextToken"])))))))

(clojure.core/defn- response-delete-work-group-output ([input] (response-delete-work-group-output nil input)) ([resultWrapper1453812 input] (clojure.core/let [rawinput1453811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453813 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-output ([input] (response-untag-resource-output nil input)) ([resultWrapper1453815 input] (clojure.core/let [rawinput1453814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453816 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-work-group-output ([input] (response-get-work-group-output nil input)) ([resultWrapper1453818 input] (clojure.core/let [rawinput1453817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453819 {"WorkGroup" (rawinput1453817 "WorkGroup")}] (clojure.core/cond-> {} (letvar1453819 "WorkGroup") (clojure.core/assoc :work-group (deser-work-group (clojure.core/get-in letvar1453819 ["WorkGroup"])))))))

(clojure.core/defn- response-get-query-results-output ([input] (response-get-query-results-output nil input)) ([resultWrapper1453821 input] (clojure.core/let [rawinput1453820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453822 {"UpdateCount" (rawinput1453820 "UpdateCount"), "ResultSet" (rawinput1453820 "ResultSet"), "NextToken" (rawinput1453820 "NextToken")}] (clojure.core/cond-> {} (letvar1453822 "UpdateCount") (clojure.core/assoc :update-count (deser-long (clojure.core/get-in letvar1453822 ["UpdateCount"]))) (letvar1453822 "ResultSet") (clojure.core/assoc :result-set (deser-result-set (clojure.core/get-in letvar1453822 ["ResultSet"]))) (letvar1453822 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1453822 ["NextToken"])))))))

(clojure.core/defn- response-list-query-executions-output ([input] (response-list-query-executions-output nil input)) ([resultWrapper1453824 input] (clojure.core/let [rawinput1453823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1453825 {"QueryExecutionIds" (rawinput1453823 "QueryExecutionIds"), "NextToken" (rawinput1453823 "NextToken")}] (clojure.core/cond-> {} (letvar1453825 "QueryExecutionIds") (clojure.core/assoc :query-execution-ids (deser-query-execution-id-list (clojure.core/get-in letvar1453825 ["QueryExecutionIds"]))) (letvar1453825 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1453825 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.athena/work-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-z0-9._-]{1,128}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.athena/work-group-description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena/amazon-resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1011))))

(clojure.spec.alpha/def :portkey.aws.athena/tag-resource-output (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.athena/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/database-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.athena/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 262144))))
...
(clojure.spec.alpha/def :portkey.aws.athena/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 32 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
