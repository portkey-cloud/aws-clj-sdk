...
(clojure.core/defn- response-stop-query-execution-output ([input] (response-stop-query-execution-output nil input)) ([resultWrapper1512196 input] (clojure.core/let [rawinput1512195 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512197 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1512199 input] (clojure.core/let [rawinput1512198 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512200 {"AthenaErrorCode" (rawinput1512198 "AthenaErrorCode"), "Message" (rawinput1512198 "Message")}] (clojure.core/cond-> {} (letvar1512200 "AthenaErrorCode") (clojure.core/assoc :athena-error-code (deser-error-code (clojure.core/get-in letvar1512200 ["AthenaErrorCode"]))) (letvar1512200 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1512200 ["Message"])))))))

(clojure.core/defn- response-get-query-execution-output ([input] (response-get-query-execution-output nil input)) ([resultWrapper1512202 input] (clojure.core/let [rawinput1512201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512203 {"QueryExecution" (rawinput1512201 "QueryExecution")}] (clojure.core/cond-> {} (letvar1512203 "QueryExecution") (clojure.core/assoc :query-execution (deser-query-execution (clojure.core/get-in letvar1512203 ["QueryExecution"])))))))

(clojure.core/defn- response-update-work-group-output ([input] (response-update-work-group-output nil input)) ([resultWrapper1512205 input] (clojure.core/let [rawinput1512204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512206 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-work-group-output ([input] (response-create-work-group-output nil input)) ([resultWrapper1512208 input] (clojure.core/let [rawinput1512207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512209 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-output ([input] (response-tag-resource-output nil input)) ([resultWrapper1512211 input] (clojure.core/let [rawinput1512210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512212 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-named-queries-output ([input] (response-list-named-queries-output nil input)) ([resultWrapper1512214 input] (clojure.core/let [rawinput1512213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512215 {"NamedQueryIds" (rawinput1512213 "NamedQueryIds"), "NextToken" (rawinput1512213 "NextToken")}] (clojure.core/cond-> {} (letvar1512215 "NamedQueryIds") (clojure.core/assoc :named-query-ids (deser-named-query-id-list (clojure.core/get-in letvar1512215 ["NamedQueryIds"]))) (letvar1512215 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1512215 ["NextToken"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1512217 input] (clojure.core/let [rawinput1512216 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512218 {"Message" (rawinput1512216 "Message"), "Reason" (rawinput1512216 "Reason")}] (clojure.core/cond-> {} (letvar1512218 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1512218 ["Message"]))) (letvar1512218 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1512218 ["Reason"])))))))

(clojure.core/defn- response-batch-get-named-query-output ([input] (response-batch-get-named-query-output nil input)) ([resultWrapper1512220 input] (clojure.core/let [rawinput1512219 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512221 {"NamedQueries" (rawinput1512219 "NamedQueries"), "UnprocessedNamedQueryIds" (rawinput1512219 "UnprocessedNamedQueryIds")}] (clojure.core/cond-> {} (letvar1512221 "NamedQueries") (clojure.core/assoc :named-queries (deser-named-query-list (clojure.core/get-in letvar1512221 ["NamedQueries"]))) (letvar1512221 "UnprocessedNamedQueryIds") (clojure.core/assoc :unprocessed-named-query-ids (deser-unprocessed-named-query-id-list (clojure.core/get-in letvar1512221 ["UnprocessedNamedQueryIds"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1512223 input] (clojure.core/let [rawinput1512222 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512224 {"Message" (rawinput1512222 "Message"), "ResourceName" (rawinput1512222 "ResourceName")}] (clojure.core/cond-> {} (letvar1512224 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1512224 ["Message"]))) (letvar1512224 "ResourceName") (clojure.core/assoc :resource-name (deser-amazon-resource-name (clojure.core/get-in letvar1512224 ["ResourceName"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1512226 input] (clojure.core/let [rawinput1512225 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512227 {"Message" (rawinput1512225 "Message")}] (clojure.core/cond-> {} (letvar1512227 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1512227 ["Message"])))))))

(clojure.core/defn- response-create-named-query-output ([input] (response-create-named-query-output nil input)) ([resultWrapper1512229 input] (clojure.core/let [rawinput1512228 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512230 {"NamedQueryId" (rawinput1512228 "NamedQueryId")}] (clojure.core/cond-> {} (letvar1512230 "NamedQueryId") (clojure.core/assoc :named-query-id (deser-named-query-id (clojure.core/get-in letvar1512230 ["NamedQueryId"])))))))

(clojure.core/defn- response-start-query-execution-output ([input] (response-start-query-execution-output nil input)) ([resultWrapper1512232 input] (clojure.core/let [rawinput1512231 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512233 {"QueryExecutionId" (rawinput1512231 "QueryExecutionId")}] (clojure.core/cond-> {} (letvar1512233 "QueryExecutionId") (clojure.core/assoc :query-execution-id (deser-query-execution-id (clojure.core/get-in letvar1512233 ["QueryExecutionId"])))))))

(clojure.core/defn- response-get-named-query-output ([input] (response-get-named-query-output nil input)) ([resultWrapper1512235 input] (clojure.core/let [rawinput1512234 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512236 {"NamedQuery" (rawinput1512234 "NamedQuery")}] (clojure.core/cond-> {} (letvar1512236 "NamedQuery") (clojure.core/assoc :named-query (deser-named-query (clojure.core/get-in letvar1512236 ["NamedQuery"])))))))

(clojure.core/defn- response-delete-named-query-output ([input] (response-delete-named-query-output nil input)) ([resultWrapper1512238 input] (clojure.core/let [rawinput1512237 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512239 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-query-execution-output ([input] (response-batch-get-query-execution-output nil input)) ([resultWrapper1512241 input] (clojure.core/let [rawinput1512240 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512242 {"QueryExecutions" (rawinput1512240 "QueryExecutions"), "UnprocessedQueryExecutionIds" (rawinput1512240 "UnprocessedQueryExecutionIds")}] (clojure.core/cond-> {} (letvar1512242 "QueryExecutions") (clojure.core/assoc :query-executions (deser-query-execution-list (clojure.core/get-in letvar1512242 ["QueryExecutions"]))) (letvar1512242 "UnprocessedQueryExecutionIds") (clojure.core/assoc :unprocessed-query-execution-ids (deser-unprocessed-query-execution-id-list (clojure.core/get-in letvar1512242 ["UnprocessedQueryExecutionIds"])))))))

(clojure.core/defn- response-list-work-groups-output ([input] (response-list-work-groups-output nil input)) ([resultWrapper1512244 input] (clojure.core/let [rawinput1512243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512245 {"WorkGroups" (rawinput1512243 "WorkGroups"), "NextToken" (rawinput1512243 "NextToken")}] (clojure.core/cond-> {} (letvar1512245 "WorkGroups") (clojure.core/assoc :work-groups (deser-work-groups-list (clojure.core/get-in letvar1512245 ["WorkGroups"]))) (letvar1512245 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1512245 ["NextToken"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper1512247 input] (clojure.core/let [rawinput1512246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512248 {"Tags" (rawinput1512246 "Tags"), "NextToken" (rawinput1512246 "NextToken")}] (clojure.core/cond-> {} (letvar1512248 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1512248 ["Tags"]))) (letvar1512248 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1512248 ["NextToken"])))))))

(clojure.core/defn- response-delete-work-group-output ([input] (response-delete-work-group-output nil input)) ([resultWrapper1512250 input] (clojure.core/let [rawinput1512249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512251 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-output ([input] (response-untag-resource-output nil input)) ([resultWrapper1512253 input] (clojure.core/let [rawinput1512252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512254 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-work-group-output ([input] (response-get-work-group-output nil input)) ([resultWrapper1512256 input] (clojure.core/let [rawinput1512255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512257 {"WorkGroup" (rawinput1512255 "WorkGroup")}] (clojure.core/cond-> {} (letvar1512257 "WorkGroup") (clojure.core/assoc :work-group (deser-work-group (clojure.core/get-in letvar1512257 ["WorkGroup"])))))))

(clojure.core/defn- response-get-query-results-output ([input] (response-get-query-results-output nil input)) ([resultWrapper1512259 input] (clojure.core/let [rawinput1512258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512260 {"UpdateCount" (rawinput1512258 "UpdateCount"), "ResultSet" (rawinput1512258 "ResultSet"), "NextToken" (rawinput1512258 "NextToken")}] (clojure.core/cond-> {} (letvar1512260 "UpdateCount") (clojure.core/assoc :update-count (deser-long (clojure.core/get-in letvar1512260 ["UpdateCount"]))) (letvar1512260 "ResultSet") (clojure.core/assoc :result-set (deser-result-set (clojure.core/get-in letvar1512260 ["ResultSet"]))) (letvar1512260 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1512260 ["NextToken"])))))))

(clojure.core/defn- response-list-query-executions-output ([input] (response-list-query-executions-output nil input)) ([resultWrapper1512262 input] (clojure.core/let [rawinput1512261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1512263 {"QueryExecutionIds" (rawinput1512261 "QueryExecutionIds"), "NextToken" (rawinput1512261 "NextToken")}] (clojure.core/cond-> {} (letvar1512263 "QueryExecutionIds") (clojure.core/assoc :query-execution-ids (deser-query-execution-id-list (clojure.core/get-in letvar1512263 ["QueryExecutionIds"]))) (letvar1512263 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1512263 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.athena/work-group-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-zA-z0-9._-]{1,128}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.athena/work-group-description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena/amazon-resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1011))))

(clojure.spec.alpha/def :portkey.aws.athena/tag-resource-output (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.athena/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/database-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.athena/query-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 262144))))
...
(clojure.spec.alpha/def :portkey.aws.athena/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.athena/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.athena/idempotency-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 32 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.athena/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1024))))
