...
(clojure.core/defn- response-update-table-response ([input] (response-update-table-response nil input)) ([resultWrapper1789897 input] (clojure.core/let [rawinput1789896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789898 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-job-response ([input] (response-get-job-response nil input)) ([resultWrapper1789900 input] (clojure.core/let [rawinput1789899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789901 {"Job" (rawinput1789899 "Job")}] (clojure.core/cond-> {} (letvar1789901 "Job") (clojure.core/assoc :job (deser-job (clojure.core/get-in letvar1789901 ["Job"])))))))

(clojure.core/defn- response-get-table-response ([input] (response-get-table-response nil input)) ([resultWrapper1789903 input] (clojure.core/let [rawinput1789902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789904 {"Table" (rawinput1789902 "Table")}] (clojure.core/cond-> {} (letvar1789904 "Table") (clojure.core/assoc :table (deser-table (clojure.core/get-in letvar1789904 ["Table"])))))))

(clojure.core/defn- response-get-partitions-response ([input] (response-get-partitions-response nil input)) ([resultWrapper1789906 input] (clojure.core/let [rawinput1789905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789907 {"Partitions" (rawinput1789905 "Partitions"), "NextToken" (rawinput1789905 "NextToken")}] (clojure.core/cond-> {} (letvar1789907 "Partitions") (clojure.core/assoc :partitions (deser-partition-list (clojure.core/get-in letvar1789907 ["Partitions"]))) (letvar1789907 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1789907 ["NextToken"])))))))

(clojure.core/defn- response-crawler-running-exception ([input] (response-crawler-running-exception nil input)) ([resultWrapper1789909 input] (clojure.core/let [rawinput1789908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789910 {"Message" (rawinput1789908 "Message")}] (clojure.core/cond-> {} (letvar1789910 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789910 ["Message"])))))))

(clojure.core/defn- response-delete-database-response ([input] (response-delete-database-response nil input)) ([resultWrapper1789912 input] (clojure.core/let [rawinput1789911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789913 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper1789915 input] (clojure.core/let [rawinput1789914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789916 {"Message" (rawinput1789914 "Message")}] (clojure.core/cond-> {} (letvar1789916 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789916 ["Message"])))))))

(clojure.core/defn- response-no-schedule-exception ([input] (response-no-schedule-exception nil input)) ([resultWrapper1789918 input] (clojure.core/let [rawinput1789917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789919 {"Message" (rawinput1789917 "Message")}] (clojure.core/cond-> {} (letvar1789919 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789919 ["Message"])))))))

(clojure.core/defn- response-list-triggers-response ([input] (response-list-triggers-response nil input)) ([resultWrapper1789921 input] (clojure.core/let [rawinput1789920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789922 {"TriggerNames" (rawinput1789920 "TriggerNames"), "NextToken" (rawinput1789920 "NextToken")}] (clojure.core/cond-> {} (letvar1789922 "TriggerNames") (clojure.core/assoc :trigger-names (deser-trigger-name-list (clojure.core/get-in letvar1789922 ["TriggerNames"]))) (letvar1789922 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1789922 ["NextToken"])))))))

(clojure.core/defn- response-delete-crawler-response ([input] (response-delete-crawler-response nil input)) ([resultWrapper1789924 input] (clojure.core/let [rawinput1789923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789925 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1789927 input] (clojure.core/let [rawinput1789926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789928 {"Message" (rawinput1789926 "Message")}] (clojure.core/cond-> {} (letvar1789928 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789928 ["Message"])))))))

(clojure.core/defn- response-update-classifier-response ([input] (response-update-classifier-response nil input)) ([resultWrapper1789930 input] (clojure.core/let [rawinput1789929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789931 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-version-mismatch-exception ([input] (response-version-mismatch-exception nil input)) ([resultWrapper1789933 input] (clojure.core/let [rawinput1789932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789934 {"Message" (rawinput1789932 "Message")}] (clojure.core/cond-> {} (letvar1789934 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789934 ["Message"])))))))

(clojure.core/defn- response-list-dev-endpoints-response ([input] (response-list-dev-endpoints-response nil input)) ([resultWrapper1789936 input] (clojure.core/let [rawinput1789935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789937 {"DevEndpointNames" (rawinput1789935 "DevEndpointNames"), "NextToken" (rawinput1789935 "NextToken")}] (clojure.core/cond-> {} (letvar1789937 "DevEndpointNames") (clojure.core/assoc :dev-endpoint-names (deser-dev-endpoint-name-list (clojure.core/get-in letvar1789937 ["DevEndpointNames"]))) (letvar1789937 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1789937 ["NextToken"])))))))

(clojure.core/defn- response-delete-connection-response ([input] (response-delete-connection-response nil input)) ([resultWrapper1789939 input] (clojure.core/let [rawinput1789938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789940 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-get-triggers-response ([input] (response-batch-get-triggers-response nil input)) ([resultWrapper1789942 input] (clojure.core/let [rawinput1789941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789943 {"Triggers" (rawinput1789941 "Triggers"), "TriggersNotFound" (rawinput1789941 "TriggersNotFound")}] (clojure.core/cond-> {} (letvar1789943 "Triggers") (clojure.core/assoc :triggers (deser-trigger-list (clojure.core/get-in letvar1789943 ["Triggers"]))) (letvar1789943 "TriggersNotFound") (clojure.core/assoc :triggers-not-found (deser-trigger-name-list (clojure.core/get-in letvar1789943 ["TriggersNotFound"])))))))

(clojure.core/defn- response-get-user-defined-functions-response ([input] (response-get-user-defined-functions-response nil input)) ([resultWrapper1789945 input] (clojure.core/let [rawinput1789944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789946 {"UserDefinedFunctions" (rawinput1789944 "UserDefinedFunctions"), "NextToken" (rawinput1789944 "NextToken")}] (clojure.core/cond-> {} (letvar1789946 "UserDefinedFunctions") (clojure.core/assoc :user-defined-functions (deser-user-defined-function-list (clojure.core/get-in letvar1789946 ["UserDefinedFunctions"]))) (letvar1789946 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1789946 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-jobs-response ([input] (response-batch-get-jobs-response nil input)) ([resultWrapper1789948 input] (clojure.core/let [rawinput1789947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789949 {"Jobs" (rawinput1789947 "Jobs"), "JobsNotFound" (rawinput1789947 "JobsNotFound")}] (clojure.core/cond-> {} (letvar1789949 "Jobs") (clojure.core/assoc :jobs (deser-job-list (clojure.core/get-in letvar1789949 ["Jobs"]))) (letvar1789949 "JobsNotFound") (clojure.core/assoc :jobs-not-found (deser-job-name-list (clojure.core/get-in letvar1789949 ["JobsNotFound"])))))))

(clojure.core/defn- response-batch-get-partition-response ([input] (response-batch-get-partition-response nil input)) ([resultWrapper1789951 input] (clojure.core/let [rawinput1789950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789952 {"Partitions" (rawinput1789950 "Partitions"), "UnprocessedKeys" (rawinput1789950 "UnprocessedKeys")}] (clojure.core/cond-> {} (letvar1789952 "Partitions") (clojure.core/assoc :partitions (deser-partition-list (clojure.core/get-in letvar1789952 ["Partitions"]))) (letvar1789952 "UnprocessedKeys") (clojure.core/assoc :unprocessed-keys (deser-batch-get-partition-value-list (clojure.core/get-in letvar1789952 ["UnprocessedKeys"])))))))

(clojure.core/defn- response-update-job-response ([input] (response-update-job-response nil input)) ([resultWrapper1789954 input] (clojure.core/let [rawinput1789953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789955 {"JobName" (rawinput1789953 "JobName")}] (clojure.core/cond-> {} (letvar1789955 "JobName") (clojure.core/assoc :job-name (deser-name-string (clojure.core/get-in letvar1789955 ["JobName"])))))))

(clojure.core/defn- response-reset-job-bookmark-response ([input] (response-reset-job-bookmark-response nil input)) ([resultWrapper1789957 input] (clojure.core/let [rawinput1789956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789958 {"JobBookmarkEntry" (rawinput1789956 "JobBookmarkEntry")}] (clojure.core/cond-> {} (letvar1789958 "JobBookmarkEntry") (clojure.core/assoc :job-bookmark-entry (deser-job-bookmark-entry (clojure.core/get-in letvar1789958 ["JobBookmarkEntry"])))))))

(clojure.core/defn- response-delete-dev-endpoint-response ([input] (response-delete-dev-endpoint-response nil input)) ([resultWrapper1789960 input] (clojure.core/let [rawinput1789959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789961 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-partition-response ([input] (response-create-partition-response nil input)) ([resultWrapper1789963 input] (clojure.core/let [rawinput1789962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789964 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-job-runs-response ([input] (response-get-job-runs-response nil input)) ([resultWrapper1789966 input] (clojure.core/let [rawinput1789965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789967 {"JobRuns" (rawinput1789965 "JobRuns"), "NextToken" (rawinput1789965 "NextToken")}] (clojure.core/cond-> {} (letvar1789967 "JobRuns") (clojure.core/assoc :job-runs (deser-job-run-list (clojure.core/get-in letvar1789967 ["JobRuns"]))) (letvar1789967 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1789967 ["NextToken"])))))))

(clojure.core/defn- response-get-mapping-response ([input] (response-get-mapping-response nil input)) ([resultWrapper1789969 input] (clojure.core/let [rawinput1789968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789970 {"Mapping" (rawinput1789968 "Mapping")}] (clojure.core/cond-> {:mapping (deser-mapping-list (clojure.core/get-in letvar1789970 ["Mapping"]))}))))

(clojure.core/defn- response-batch-delete-partition-response ([input] (response-batch-delete-partition-response nil input)) ([resultWrapper1789972 input] (clojure.core/let [rawinput1789971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789973 {"Errors" (rawinput1789971 "Errors")}] (clojure.core/cond-> {} (letvar1789973 "Errors") (clojure.core/assoc :errors (deser-partition-errors (clojure.core/get-in letvar1789973 ["Errors"])))))))

(clojure.core/defn- response-create-job-response ([input] (response-create-job-response nil input)) ([resultWrapper1789975 input] (clojure.core/let [rawinput1789974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789976 {"Name" (rawinput1789974 "Name")}] (clojure.core/cond-> {} (letvar1789976 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1789976 ["Name"])))))))

(clojure.core/defn- response-batch-create-partition-response ([input] (response-batch-create-partition-response nil input)) ([resultWrapper1789978 input] (clojure.core/let [rawinput1789977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789979 {"Errors" (rawinput1789977 "Errors")}] (clojure.core/cond-> {} (letvar1789979 "Errors") (clojure.core/assoc :errors (deser-partition-errors (clojure.core/get-in letvar1789979 ["Errors"])))))))

(clojure.core/defn- response-batch-delete-connection-response ([input] (response-batch-delete-connection-response nil input)) ([resultWrapper1789981 input] (clojure.core/let [rawinput1789980 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789982 {"Succeeded" (rawinput1789980 "Succeeded"), "Errors" (rawinput1789980 "Errors")}] (clojure.core/cond-> {} (letvar1789982 "Succeeded") (clojure.core/assoc :succeeded (deser-name-string-list (clojure.core/get-in letvar1789982 ["Succeeded"]))) (letvar1789982 "Errors") (clojure.core/assoc :errors (deser-error-by-name (clojure.core/get-in letvar1789982 ["Errors"])))))))

(clojure.core/defn- response-import-catalog-to-glue-response ([input] (response-import-catalog-to-glue-response nil input)) ([resultWrapper1789984 input] (clojure.core/let [rawinput1789983 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789985 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-dev-endpoints-response ([input] (response-get-dev-endpoints-response nil input)) ([resultWrapper1789987 input] (clojure.core/let [rawinput1789986 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789988 {"DevEndpoints" (rawinput1789986 "DevEndpoints"), "NextToken" (rawinput1789986 "NextToken")}] (clojure.core/cond-> {} (letvar1789988 "DevEndpoints") (clojure.core/assoc :dev-endpoints (deser-dev-endpoint-list (clojure.core/get-in letvar1789988 ["DevEndpoints"]))) (letvar1789988 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1789988 ["NextToken"])))))))

(clojure.core/defn- response-condition-check-failure-exception ([input] (response-condition-check-failure-exception nil input)) ([resultWrapper1789990 input] (clojure.core/let [rawinput1789989 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789991 {"Message" (rawinput1789989 "Message")}] (clojure.core/cond-> {} (letvar1789991 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1789991 ["Message"])))))))

(clojure.core/defn- response-get-crawlers-response ([input] (response-get-crawlers-response nil input)) ([resultWrapper1789993 input] (clojure.core/let [rawinput1789992 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789994 {"Crawlers" (rawinput1789992 "Crawlers"), "NextToken" (rawinput1789992 "NextToken")}] (clojure.core/cond-> {} (letvar1789994 "Crawlers") (clojure.core/assoc :crawlers (deser-crawler-list (clojure.core/get-in letvar1789994 ["Crawlers"]))) (letvar1789994 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1789994 ["NextToken"])))))))

(clojure.core/defn- response-stop-trigger-response ([input] (response-stop-trigger-response nil input)) ([resultWrapper1789996 input] (clojure.core/let [rawinput1789995 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1789997 {"Name" (rawinput1789995 "Name")}] (clojure.core/cond-> {} (letvar1789997 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1789997 ["Name"])))))))

(clojure.core/defn- response-batch-get-crawlers-response ([input] (response-batch-get-crawlers-response nil input)) ([resultWrapper1789999 input] (clojure.core/let [rawinput1789998 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790000 {"Crawlers" (rawinput1789998 "Crawlers"), "CrawlersNotFound" (rawinput1789998 "CrawlersNotFound")}] (clojure.core/cond-> {} (letvar1790000 "Crawlers") (clojure.core/assoc :crawlers (deser-crawler-list (clojure.core/get-in letvar1790000 ["Crawlers"]))) (letvar1790000 "CrawlersNotFound") (clojure.core/assoc :crawlers-not-found (deser-crawler-name-list (clojure.core/get-in letvar1790000 ["CrawlersNotFound"])))))))

(clojure.core/defn- response-get-database-response ([input] (response-get-database-response nil input)) ([resultWrapper1790002 input] (clojure.core/let [rawinput1790001 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790003 {"Database" (rawinput1790001 "Database")}] (clojure.core/cond-> {} (letvar1790003 "Database") (clojure.core/assoc :database (deser-database (clojure.core/get-in letvar1790003 ["Database"])))))))

(clojure.core/defn- response-get-classifiers-response ([input] (response-get-classifiers-response nil input)) ([resultWrapper1790005 input] (clojure.core/let [rawinput1790004 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790006 {"Classifiers" (rawinput1790004 "Classifiers"), "NextToken" (rawinput1790004 "NextToken")}] (clojure.core/cond-> {} (letvar1790006 "Classifiers") (clojure.core/assoc :classifiers (deser-classifier-list (clojure.core/get-in letvar1790006 ["Classifiers"]))) (letvar1790006 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790006 ["NextToken"])))))))

(clojure.core/defn- response-list-crawlers-response ([input] (response-list-crawlers-response nil input)) ([resultWrapper1790008 input] (clojure.core/let [rawinput1790007 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790009 {"CrawlerNames" (rawinput1790007 "CrawlerNames"), "NextToken" (rawinput1790007 "NextToken")}] (clojure.core/cond-> {} (letvar1790009 "CrawlerNames") (clojure.core/assoc :crawler-names (deser-crawler-name-list (clojure.core/get-in letvar1790009 ["CrawlerNames"]))) (letvar1790009 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790009 ["NextToken"])))))))

(clojure.core/defn- response-get-connection-response ([input] (response-get-connection-response nil input)) ([resultWrapper1790011 input] (clojure.core/let [rawinput1790010 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790012 {"Connection" (rawinput1790010 "Connection")}] (clojure.core/cond-> {} (letvar1790012 "Connection") (clojure.core/assoc :connection (deser-connection (clojure.core/get-in letvar1790012 ["Connection"])))))))

(clojure.core/defn- response-get-dev-endpoint-response ([input] (response-get-dev-endpoint-response nil input)) ([resultWrapper1790014 input] (clojure.core/let [rawinput1790013 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790015 {"DevEndpoint" (rawinput1790013 "DevEndpoint")}] (clojure.core/cond-> {} (letvar1790015 "DevEndpoint") (clojure.core/assoc :dev-endpoint (deser-dev-endpoint (clojure.core/get-in letvar1790015 ["DevEndpoint"])))))))

(clojure.core/defn- response-batch-delete-table-version-response ([input] (response-batch-delete-table-version-response nil input)) ([resultWrapper1790017 input] (clojure.core/let [rawinput1790016 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790018 {"Errors" (rawinput1790016 "Errors")}] (clojure.core/cond-> {} (letvar1790018 "Errors") (clojure.core/assoc :errors (deser-table-version-errors (clojure.core/get-in letvar1790018 ["Errors"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1790020 input] (clojure.core/let [rawinput1790019 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790021 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-triggers-response ([input] (response-get-triggers-response nil input)) ([resultWrapper1790023 input] (clojure.core/let [rawinput1790022 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790024 {"Triggers" (rawinput1790022 "Triggers"), "NextToken" (rawinput1790022 "NextToken")}] (clojure.core/cond-> {} (letvar1790024 "Triggers") (clojure.core/assoc :triggers (deser-trigger-list (clojure.core/get-in letvar1790024 ["Triggers"]))) (letvar1790024 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1790024 ["NextToken"])))))))

(clojure.core/defn- response-get-job-run-response ([input] (response-get-job-run-response nil input)) ([resultWrapper1790026 input] (clojure.core/let [rawinput1790025 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790027 {"JobRun" (rawinput1790025 "JobRun")}] (clojure.core/cond-> {} (letvar1790027 "JobRun") (clojure.core/assoc :job-run (deser-job-run (clojure.core/get-in letvar1790027 ["JobRun"])))))))

(clojure.core/defn- response-create-script-response ([input] (response-create-script-response nil input)) ([resultWrapper1790029 input] (clojure.core/let [rawinput1790028 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790030 {"PythonScript" (rawinput1790028 "PythonScript"), "ScalaCode" (rawinput1790028 "ScalaCode")}] (clojure.core/cond-> {} (letvar1790030 "PythonScript") (clojure.core/assoc :python-script (deser-python-script (clojure.core/get-in letvar1790030 ["PythonScript"]))) (letvar1790030 "ScalaCode") (clojure.core/assoc :scala-code (deser-scala-code (clojure.core/get-in letvar1790030 ["ScalaCode"])))))))

(clojure.core/defn- response-get-security-configurations-response ([input] (response-get-security-configurations-response nil input)) ([resultWrapper1790032 input] (clojure.core/let [rawinput1790031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790033 {"SecurityConfigurations" (rawinput1790031 "SecurityConfigurations"), "NextToken" (rawinput1790031 "NextToken")}] (clojure.core/cond-> {} (letvar1790033 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar1790033 ["SecurityConfigurations"]))) (letvar1790033 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1790033 ["NextToken"])))))))

(clojure.core/defn- response-batch-delete-table-response ([input] (response-batch-delete-table-response nil input)) ([resultWrapper1790035 input] (clojure.core/let [rawinput1790034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790036 {"Errors" (rawinput1790034 "Errors")}] (clojure.core/cond-> {} (letvar1790036 "Errors") (clojure.core/assoc :errors (deser-table-errors (clojure.core/get-in letvar1790036 ["Errors"])))))))

(clojure.core/defn- response-update-connection-response ([input] (response-update-connection-response nil input)) ([resultWrapper1790038 input] (clojure.core/let [rawinput1790037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790039 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-table-response ([input] (response-create-table-response nil input)) ([resultWrapper1790041 input] (clojure.core/let [rawinput1790040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790042 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-classifier-response ([input] (response-create-classifier-response nil input)) ([resultWrapper1790044 input] (clojure.core/let [rawinput1790043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790045 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-partition-response ([input] (response-get-partition-response nil input)) ([resultWrapper1790047 input] (clojure.core/let [rawinput1790046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790048 {"Partition" (rawinput1790046 "Partition")}] (clojure.core/cond-> {} (letvar1790048 "Partition") (clojure.core/assoc :partition (deser-partition (clojure.core/get-in letvar1790048 ["Partition"])))))))

(clojure.core/defn- response-get-tables-response ([input] (response-get-tables-response nil input)) ([resultWrapper1790050 input] (clojure.core/let [rawinput1790049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790051 {"TableList" (rawinput1790049 "TableList"), "NextToken" (rawinput1790049 "NextToken")}] (clojure.core/cond-> {} (letvar1790051 "TableList") (clojure.core/assoc :table-list (deser-table-list (clojure.core/get-in letvar1790051 ["TableList"]))) (letvar1790051 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790051 ["NextToken"])))))))

(clojure.core/defn- response-scheduler-not-running-exception ([input] (response-scheduler-not-running-exception nil input)) ([resultWrapper1790053 input] (clojure.core/let [rawinput1790052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790054 {"Message" (rawinput1790052 "Message")}] (clojure.core/cond-> {} (letvar1790054 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790054 ["Message"])))))))

(clojure.core/defn- response-crawler-not-running-exception ([input] (response-crawler-not-running-exception nil input)) ([resultWrapper1790056 input] (clojure.core/let [rawinput1790055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790057 {"Message" (rawinput1790055 "Message")}] (clojure.core/cond-> {} (letvar1790057 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790057 ["Message"])))))))

(clojure.core/defn- response-get-crawler-response ([input] (response-get-crawler-response nil input)) ([resultWrapper1790059 input] (clojure.core/let [rawinput1790058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790060 {"Crawler" (rawinput1790058 "Crawler")}] (clojure.core/cond-> {} (letvar1790060 "Crawler") (clojure.core/assoc :crawler (deser-crawler (clojure.core/get-in letvar1790060 ["Crawler"])))))))

(clojure.core/defn- response-scheduler-transitioning-exception ([input] (response-scheduler-transitioning-exception nil input)) ([resultWrapper1790062 input] (clojure.core/let [rawinput1790061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790063 {"Message" (rawinput1790061 "Message")}] (clojure.core/cond-> {} (letvar1790063 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790063 ["Message"])))))))

(clojure.core/defn- response-update-user-defined-function-response ([input] (response-update-user-defined-function-response nil input)) ([resultWrapper1790065 input] (clojure.core/let [rawinput1790064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790066 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-user-defined-function-response ([input] (response-create-user-defined-function-response nil input)) ([resultWrapper1790068 input] (clojure.core/let [rawinput1790067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790069 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-idempotent-parameter-mismatch-exception ([input] (response-idempotent-parameter-mismatch-exception nil input)) ([resultWrapper1790071 input] (clojure.core/let [rawinput1790070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790072 {"Message" (rawinput1790070 "Message")}] (clojure.core/cond-> {} (letvar1790072 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790072 ["Message"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1790074 input] (clojure.core/let [rawinput1790073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790075 {"Message" (rawinput1790073 "Message")}] (clojure.core/cond-> {} (letvar1790075 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790075 ["Message"])))))))

(clojure.core/defn- response-update-partition-response ([input] (response-update-partition-response nil input)) ([resultWrapper1790077 input] (clojure.core/let [rawinput1790076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790078 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-tags-response ([input] (response-get-tags-response nil input)) ([resultWrapper1790080 input] (clojure.core/let [rawinput1790079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790081 {"Tags" (rawinput1790079 "Tags")}] (clojure.core/cond-> {} (letvar1790081 "Tags") (clojure.core/assoc :tags (deser-tags-map (clojure.core/get-in letvar1790081 ["Tags"])))))))

(clojure.core/defn- response-get-user-defined-function-response ([input] (response-get-user-defined-function-response nil input)) ([resultWrapper1790083 input] (clojure.core/let [rawinput1790082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790084 {"UserDefinedFunction" (rawinput1790082 "UserDefinedFunction")}] (clojure.core/cond-> {} (letvar1790084 "UserDefinedFunction") (clojure.core/assoc :user-defined-function (deser-user-defined-function (clojure.core/get-in letvar1790084 ["UserDefinedFunction"])))))))

(clojure.core/defn- response-stop-crawler-response ([input] (response-stop-crawler-response nil input)) ([resultWrapper1790086 input] (clojure.core/let [rawinput1790085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790087 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-crawler-metrics-response ([input] (response-get-crawler-metrics-response nil input)) ([resultWrapper1790089 input] (clojure.core/let [rawinput1790088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790090 {"CrawlerMetricsList" (rawinput1790088 "CrawlerMetricsList"), "NextToken" (rawinput1790088 "NextToken")}] (clojure.core/cond-> {} (letvar1790090 "CrawlerMetricsList") (clojure.core/assoc :crawler-metrics-list (deser-crawler-metrics-list (clojure.core/get-in letvar1790090 ["CrawlerMetricsList"]))) (letvar1790090 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790090 ["NextToken"])))))))

(clojure.core/defn- response-resource-number-limit-exceeded-exception ([input] (response-resource-number-limit-exceeded-exception nil input)) ([resultWrapper1790092 input] (clojure.core/let [rawinput1790091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790093 {"Message" (rawinput1790091 "Message")}] (clojure.core/cond-> {} (letvar1790093 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790093 ["Message"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1790095 input] (clojure.core/let [rawinput1790094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790096 {"Message" (rawinput1790094 "Message")}] (clojure.core/cond-> {} (letvar1790096 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790096 ["Message"])))))))

(clojure.core/defn- response-update-database-response ([input] (response-update-database-response nil input)) ([resultWrapper1790098 input] (clojure.core/let [rawinput1790097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790099 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-classifier-response ([input] (response-get-classifier-response nil input)) ([resultWrapper1790101 input] (clojure.core/let [rawinput1790100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790102 {"Classifier" (rawinput1790100 "Classifier")}] (clojure.core/cond-> {} (letvar1790102 "Classifier") (clojure.core/assoc :classifier (deser-classifier (clojure.core/get-in letvar1790102 ["Classifier"])))))))

(clojure.core/defn- response-create-security-configuration-response ([input] (response-create-security-configuration-response nil input)) ([resultWrapper1790104 input] (clojure.core/let [rawinput1790103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790105 {"Name" (rawinput1790103 "Name"), "CreatedTimestamp" (rawinput1790103 "CreatedTimestamp")}] (clojure.core/cond-> {} (letvar1790105 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1790105 ["Name"]))) (letvar1790105 "CreatedTimestamp") (clojure.core/assoc :created-timestamp (deser-timestamp-value (clojure.core/get-in letvar1790105 ["CreatedTimestamp"])))))))

(clojure.core/defn- response-update-dev-endpoint-response ([input] (response-update-dev-endpoint-response nil input)) ([resultWrapper1790107 input] (clojure.core/let [rawinput1790106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790108 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-trigger-response ([input] (response-start-trigger-response nil input)) ([resultWrapper1790110 input] (clojure.core/let [rawinput1790109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790111 {"Name" (rawinput1790109 "Name")}] (clojure.core/cond-> {} (letvar1790111 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1790111 ["Name"])))))))

(clojure.core/defn- response-get-table-version-response ([input] (response-get-table-version-response nil input)) ([resultWrapper1790113 input] (clojure.core/let [rawinput1790112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790114 {"TableVersion" (rawinput1790112 "TableVersion")}] (clojure.core/cond-> {} (letvar1790114 "TableVersion") (clojure.core/assoc :table-version (deser-table-version (clojure.core/get-in letvar1790114 ["TableVersion"])))))))

(clojure.core/defn- response-update-trigger-response ([input] (response-update-trigger-response nil input)) ([resultWrapper1790116 input] (clojure.core/let [rawinput1790115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790117 {"Trigger" (rawinput1790115 "Trigger")}] (clojure.core/cond-> {} (letvar1790117 "Trigger") (clojure.core/assoc :trigger (deser-trigger (clojure.core/get-in letvar1790117 ["Trigger"])))))))

(clojure.core/defn- response-get-jobs-response ([input] (response-get-jobs-response nil input)) ([resultWrapper1790119 input] (clojure.core/let [rawinput1790118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790120 {"Jobs" (rawinput1790118 "Jobs"), "NextToken" (rawinput1790118 "NextToken")}] (clojure.core/cond-> {} (letvar1790120 "Jobs") (clojure.core/assoc :jobs (deser-job-list (clojure.core/get-in letvar1790120 ["Jobs"]))) (letvar1790120 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1790120 ["NextToken"])))))))

(clojure.core/defn- response-delete-job-response ([input] (response-delete-job-response nil input)) ([resultWrapper1790122 input] (clojure.core/let [rawinput1790121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790123 {"JobName" (rawinput1790121 "JobName")}] (clojure.core/cond-> {} (letvar1790123 "JobName") (clojure.core/assoc :job-name (deser-name-string (clojure.core/get-in letvar1790123 ["JobName"])))))))

(clojure.core/defn- response-start-job-run-response ([input] (response-start-job-run-response nil input)) ([resultWrapper1790125 input] (clojure.core/let [rawinput1790124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790126 {"JobRunId" (rawinput1790124 "JobRunId")}] (clojure.core/cond-> {} (letvar1790126 "JobRunId") (clojure.core/assoc :job-run-id (deser-id-string (clojure.core/get-in letvar1790126 ["JobRunId"])))))))

(clojure.core/defn- response-delete-resource-policy-response ([input] (response-delete-resource-policy-response nil input)) ([resultWrapper1790128 input] (clojure.core/let [rawinput1790127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790129 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-dev-endpoint-response ([input] (response-create-dev-endpoint-response nil input)) ([resultWrapper1790131 input] (clojure.core/let [rawinput1790130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790132 {"ZeppelinRemoteSparkInterpreterPort" (rawinput1790130 "ZeppelinRemoteSparkInterpreterPort"), "CreatedTimestamp" (rawinput1790130 "CreatedTimestamp"), "SecurityGroupIds" (rawinput1790130 "SecurityGroupIds"), "YarnEndpointAddress" (rawinput1790130 "YarnEndpointAddress"), "SubnetId" (rawinput1790130 "SubnetId"), "ExtraJarsS3Path" (rawinput1790130 "ExtraJarsS3Path"), "RoleArn" (rawinput1790130 "RoleArn"), "NumberOfNodes" (rawinput1790130 "NumberOfNodes"), "AvailabilityZone" (rawinput1790130 "AvailabilityZone"), "Status" (rawinput1790130 "Status"), "EndpointName" (rawinput1790130 "EndpointName"), "VpcId" (rawinput1790130 "VpcId"), "FailureReason" (rawinput1790130 "FailureReason"), "SecurityConfiguration" (rawinput1790130 "SecurityConfiguration"), "ExtraPythonLibsS3Path" (rawinput1790130 "ExtraPythonLibsS3Path")}] (clojure.core/cond-> {} (letvar1790132 "ZeppelinRemoteSparkInterpreterPort") (clojure.core/assoc :zeppelin-remote-spark-interpreter-port (deser-integer-value (clojure.core/get-in letvar1790132 ["ZeppelinRemoteSparkInterpreterPort"]))) (letvar1790132 "CreatedTimestamp") (clojure.core/assoc :created-timestamp (deser-timestamp-value (clojure.core/get-in letvar1790132 ["CreatedTimestamp"]))) (letvar1790132 "SecurityGroupIds") (clojure.core/assoc :security-group-ids (deser-string-list (clojure.core/get-in letvar1790132 ["SecurityGroupIds"]))) (letvar1790132 "YarnEndpointAddress") (clojure.core/assoc :yarn-endpoint-address (deser-generic-string (clojure.core/get-in letvar1790132 ["YarnEndpointAddress"]))) (letvar1790132 "SubnetId") (clojure.core/assoc :subnet-id (deser-generic-string (clojure.core/get-in letvar1790132 ["SubnetId"]))) (letvar1790132 "ExtraJarsS3Path") (clojure.core/assoc :extra-jars-s-3-path (deser-generic-string (clojure.core/get-in letvar1790132 ["ExtraJarsS3Path"]))) (letvar1790132 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1790132 ["RoleArn"]))) (letvar1790132 "NumberOfNodes") (clojure.core/assoc :number-of-nodes (deser-integer-value (clojure.core/get-in letvar1790132 ["NumberOfNodes"]))) (letvar1790132 "AvailabilityZone") (clojure.core/assoc :availability-zone (deser-generic-string (clojure.core/get-in letvar1790132 ["AvailabilityZone"]))) (letvar1790132 "Status") (clojure.core/assoc :status (deser-generic-string (clojure.core/get-in letvar1790132 ["Status"]))) (letvar1790132 "EndpointName") (clojure.core/assoc :endpoint-name (deser-generic-string (clojure.core/get-in letvar1790132 ["EndpointName"]))) (letvar1790132 "VpcId") (clojure.core/assoc :vpc-id (deser-generic-string (clojure.core/get-in letvar1790132 ["VpcId"]))) (letvar1790132 "FailureReason") (clojure.core/assoc :failure-reason (deser-generic-string (clojure.core/get-in letvar1790132 ["FailureReason"]))) (letvar1790132 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-name-string (clojure.core/get-in letvar1790132 ["SecurityConfiguration"]))) (letvar1790132 "ExtraPythonLibsS3Path") (clojure.core/assoc :extra-python-libs-s-3-path (deser-generic-string (clojure.core/get-in letvar1790132 ["ExtraPythonLibsS3Path"])))))))

(clojure.core/defn- response-put-resource-policy-response ([input] (response-put-resource-policy-response nil input)) ([resultWrapper1790134 input] (clojure.core/let [rawinput1790133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790135 {"PolicyHash" (rawinput1790133 "PolicyHash")}] (clojure.core/cond-> {} (letvar1790135 "PolicyHash") (clojure.core/assoc :policy-hash (deser-hash-string (clojure.core/get-in letvar1790135 ["PolicyHash"])))))))

(clojure.core/defn- response-update-crawler-response ([input] (response-update-crawler-response nil input)) ([resultWrapper1790137 input] (clojure.core/let [rawinput1790136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790138 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-table-response ([input] (response-delete-table-response nil input)) ([resultWrapper1790140 input] (clojure.core/let [rawinput1790139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790141 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-security-configuration-response ([input] (response-delete-security-configuration-response nil input)) ([resultWrapper1790143 input] (clojure.core/let [rawinput1790142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790144 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-trigger-response ([input] (response-create-trigger-response nil input)) ([resultWrapper1790146 input] (clojure.core/let [rawinput1790145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790147 {"Name" (rawinput1790145 "Name")}] (clojure.core/cond-> {} (letvar1790147 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1790147 ["Name"])))))))

(clojure.core/defn- response-get-data-catalog-encryption-settings-response ([input] (response-get-data-catalog-encryption-settings-response nil input)) ([resultWrapper1790149 input] (clojure.core/let [rawinput1790148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790150 {"DataCatalogEncryptionSettings" (rawinput1790148 "DataCatalogEncryptionSettings")}] (clojure.core/cond-> {} (letvar1790150 "DataCatalogEncryptionSettings") (clojure.core/assoc :data-catalog-encryption-settings (deser-data-catalog-encryption-settings (clojure.core/get-in letvar1790150 ["DataCatalogEncryptionSettings"])))))))

(clojure.core/defn- response-create-crawler-response ([input] (response-create-crawler-response nil input)) ([resultWrapper1790152 input] (clojure.core/let [rawinput1790151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790153 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-timeout-exception ([input] (response-operation-timeout-exception nil input)) ([resultWrapper1790155 input] (clojure.core/let [rawinput1790154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790156 {"Message" (rawinput1790154 "Message")}] (clojure.core/cond-> {} (letvar1790156 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790156 ["Message"])))))))

(clojure.core/defn- response-get-databases-response ([input] (response-get-databases-response nil input)) ([resultWrapper1790158 input] (clojure.core/let [rawinput1790157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790159 {"DatabaseList" (rawinput1790157 "DatabaseList"), "NextToken" (rawinput1790157 "NextToken")}] (clojure.core/cond-> {:database-list (deser-database-list (clojure.core/get-in letvar1790159 ["DatabaseList"]))} (letvar1790159 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790159 ["NextToken"])))))))

(clojure.core/defn- response-delete-table-version-response ([input] (response-delete-table-version-response nil input)) ([resultWrapper1790161 input] (clojure.core/let [rawinput1790160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790162 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-defined-function-response ([input] (response-delete-user-defined-function-response nil input)) ([resultWrapper1790164 input] (clojure.core/let [rawinput1790163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790165 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-crawler-schedule-response ([input] (response-update-crawler-schedule-response nil input)) ([resultWrapper1790167 input] (clojure.core/let [rawinput1790166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790168 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-plan-response ([input] (response-get-plan-response nil input)) ([resultWrapper1790170 input] (clojure.core/let [rawinput1790169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790171 {"PythonScript" (rawinput1790169 "PythonScript"), "ScalaCode" (rawinput1790169 "ScalaCode")}] (clojure.core/cond-> {} (letvar1790171 "PythonScript") (clojure.core/assoc :python-script (deser-python-script (clojure.core/get-in letvar1790171 ["PythonScript"]))) (letvar1790171 "ScalaCode") (clojure.core/assoc :scala-code (deser-scala-code (clojure.core/get-in letvar1790171 ["ScalaCode"])))))))

(clojure.core/defn- response-get-resource-policy-response ([input] (response-get-resource-policy-response nil input)) ([resultWrapper1790173 input] (clojure.core/let [rawinput1790172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790174 {"PolicyInJson" (rawinput1790172 "PolicyInJson"), "PolicyHash" (rawinput1790172 "PolicyHash"), "CreateTime" (rawinput1790172 "CreateTime"), "UpdateTime" (rawinput1790172 "UpdateTime")}] (clojure.core/cond-> {} (letvar1790174 "PolicyInJson") (clojure.core/assoc :policy-in-json (deser-policy-json-string (clojure.core/get-in letvar1790174 ["PolicyInJson"]))) (letvar1790174 "PolicyHash") (clojure.core/assoc :policy-hash (deser-hash-string (clojure.core/get-in letvar1790174 ["PolicyHash"]))) (letvar1790174 "CreateTime") (clojure.core/assoc :create-time (deser-timestamp (clojure.core/get-in letvar1790174 ["CreateTime"]))) (letvar1790174 "UpdateTime") (clojure.core/assoc :update-time (deser-timestamp (clojure.core/get-in letvar1790174 ["UpdateTime"])))))))

(clojure.core/defn- response-get-security-configuration-response ([input] (response-get-security-configuration-response nil input)) ([resultWrapper1790176 input] (clojure.core/let [rawinput1790175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790177 {"SecurityConfiguration" (rawinput1790175 "SecurityConfiguration")}] (clojure.core/cond-> {} (letvar1790177 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-security-configuration (clojure.core/get-in letvar1790177 ["SecurityConfiguration"])))))))

(clojure.core/defn- response-delete-classifier-response ([input] (response-delete-classifier-response nil input)) ([resultWrapper1790179 input] (clojure.core/let [rawinput1790178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790180 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-connection-response ([input] (response-create-connection-response nil input)) ([resultWrapper1790182 input] (clojure.core/let [rawinput1790181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790183 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-trigger-response ([input] (response-delete-trigger-response nil input)) ([resultWrapper1790185 input] (clojure.core/let [rawinput1790184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790186 {"Name" (rawinput1790184 "Name")}] (clojure.core/cond-> {} (letvar1790186 "Name") (clojure.core/assoc :name (deser-name-string (clojure.core/get-in letvar1790186 ["Name"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1790188 input] (clojure.core/let [rawinput1790187 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790189 {"Message" (rawinput1790187 "Message")}] (clojure.core/cond-> {} (letvar1790189 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790189 ["Message"])))))))

(clojure.core/defn- response-get-trigger-response ([input] (response-get-trigger-response nil input)) ([resultWrapper1790191 input] (clojure.core/let [rawinput1790190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790192 {"Trigger" (rawinput1790190 "Trigger")}] (clojure.core/cond-> {} (letvar1790192 "Trigger") (clojure.core/assoc :trigger (deser-trigger (clojure.core/get-in letvar1790192 ["Trigger"])))))))

(clojure.core/defn- response-get-dataflow-graph-response ([input] (response-get-dataflow-graph-response nil input)) ([resultWrapper1790194 input] (clojure.core/let [rawinput1790193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790195 {"DagNodes" (rawinput1790193 "DagNodes"), "DagEdges" (rawinput1790193 "DagEdges")}] (clojure.core/cond-> {} (letvar1790195 "DagNodes") (clojure.core/assoc :dag-nodes (deser-dag-nodes (clojure.core/get-in letvar1790195 ["DagNodes"]))) (letvar1790195 "DagEdges") (clojure.core/assoc :dag-edges (deser-dag-edges (clojure.core/get-in letvar1790195 ["DagEdges"])))))))

(clojure.core/defn- response-create-database-response ([input] (response-create-database-response nil input)) ([resultWrapper1790197 input] (clojure.core/let [rawinput1790196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790198 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-runs-exceeded-exception ([input] (response-concurrent-runs-exceeded-exception nil input)) ([resultWrapper1790200 input] (clojure.core/let [rawinput1790199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790201 {"Message" (rawinput1790199 "Message")}] (clojure.core/cond-> {} (letvar1790201 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790201 ["Message"])))))))

(clojure.core/defn- response-crawler-stopping-exception ([input] (response-crawler-stopping-exception nil input)) ([resultWrapper1790203 input] (clojure.core/let [rawinput1790202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790204 {"Message" (rawinput1790202 "Message")}] (clojure.core/cond-> {} (letvar1790204 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790204 ["Message"])))))))

(clojure.core/defn- response-put-data-catalog-encryption-settings-response ([input] (response-put-data-catalog-encryption-settings-response nil input)) ([resultWrapper1790206 input] (clojure.core/let [rawinput1790205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790207 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-jobs-response ([input] (response-list-jobs-response nil input)) ([resultWrapper1790209 input] (clojure.core/let [rawinput1790208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790210 {"JobNames" (rawinput1790208 "JobNames"), "NextToken" (rawinput1790208 "NextToken")}] (clojure.core/cond-> {} (letvar1790210 "JobNames") (clojure.core/assoc :job-names (deser-job-name-list (clojure.core/get-in letvar1790210 ["JobNames"]))) (letvar1790210 "NextToken") (clojure.core/assoc :next-token (deser-generic-string (clojure.core/get-in letvar1790210 ["NextToken"])))))))

(clojure.core/defn- response-batch-get-dev-endpoints-response ([input] (response-batch-get-dev-endpoints-response nil input)) ([resultWrapper1790212 input] (clojure.core/let [rawinput1790211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790213 {"DevEndpoints" (rawinput1790211 "DevEndpoints"), "DevEndpointsNotFound" (rawinput1790211 "DevEndpointsNotFound")}] (clojure.core/cond-> {} (letvar1790213 "DevEndpoints") (clojure.core/assoc :dev-endpoints (deser-dev-endpoint-list (clojure.core/get-in letvar1790213 ["DevEndpoints"]))) (letvar1790213 "DevEndpointsNotFound") (clojure.core/assoc :dev-endpoints-not-found (deser-dev-endpoint-names (clojure.core/get-in letvar1790213 ["DevEndpointsNotFound"])))))))

(clojure.core/defn- response-get-catalog-import-status-response ([input] (response-get-catalog-import-status-response nil input)) ([resultWrapper1790215 input] (clojure.core/let [rawinput1790214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790216 {"ImportStatus" (rawinput1790214 "ImportStatus")}] (clojure.core/cond-> {} (letvar1790216 "ImportStatus") (clojure.core/assoc :import-status (deser-catalog-import-status (clojure.core/get-in letvar1790216 ["ImportStatus"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1790218 input] (clojure.core/let [rawinput1790217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790219 {"Message" (rawinput1790217 "Message")}] (clojure.core/cond-> {} (letvar1790219 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790219 ["Message"])))))))

(clojure.core/defn- response-entity-not-found-exception ([input] (response-entity-not-found-exception nil input)) ([resultWrapper1790221 input] (clojure.core/let [rawinput1790220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790222 {"Message" (rawinput1790220 "Message")}] (clojure.core/cond-> {} (letvar1790222 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790222 ["Message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1790224 input] (clojure.core/let [rawinput1790223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790225 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-table-versions-response ([input] (response-get-table-versions-response nil input)) ([resultWrapper1790227 input] (clojure.core/let [rawinput1790226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790228 {"TableVersions" (rawinput1790226 "TableVersions"), "NextToken" (rawinput1790226 "NextToken")}] (clojure.core/cond-> {} (letvar1790228 "TableVersions") (clojure.core/assoc :table-versions (deser-get-table-versions-list (clojure.core/get-in letvar1790228 ["TableVersions"]))) (letvar1790228 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790228 ["NextToken"])))))))

(clojure.core/defn- response-scheduler-running-exception ([input] (response-scheduler-running-exception nil input)) ([resultWrapper1790230 input] (clojure.core/let [rawinput1790229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790231 {"Message" (rawinput1790229 "Message")}] (clojure.core/cond-> {} (letvar1790231 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790231 ["Message"])))))))

(clojure.core/defn- response-glue-encryption-exception ([input] (response-glue-encryption-exception nil input)) ([resultWrapper1790233 input] (clojure.core/let [rawinput1790232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790234 {"Message" (rawinput1790232 "Message")}] (clojure.core/cond-> {} (letvar1790234 "Message") (clojure.core/assoc :message (deser-message-string (clojure.core/get-in letvar1790234 ["Message"])))))))

(clojure.core/defn- response-get-connections-response ([input] (response-get-connections-response nil input)) ([resultWrapper1790236 input] (clojure.core/let [rawinput1790235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790237 {"ConnectionList" (rawinput1790235 "ConnectionList"), "NextToken" (rawinput1790235 "NextToken")}] (clojure.core/cond-> {} (letvar1790237 "ConnectionList") (clojure.core/assoc :connection-list (deser-connection-list (clojure.core/get-in letvar1790237 ["ConnectionList"]))) (letvar1790237 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1790237 ["NextToken"])))))))

(clojure.core/defn- response-start-crawler-schedule-response ([input] (response-start-crawler-schedule-response nil input)) ([resultWrapper1790239 input] (clojure.core/let [rawinput1790238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790240 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-crawler-schedule-response ([input] (response-stop-crawler-schedule-response nil input)) ([resultWrapper1790242 input] (clojure.core/let [rawinput1790241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790243 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-partition-response ([input] (response-delete-partition-response nil input)) ([resultWrapper1790245 input] (clojure.core/let [rawinput1790244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790246 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-crawler-response ([input] (response-start-crawler-response nil input)) ([resultWrapper1790248 input] (clojure.core/let [rawinput1790247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790249 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-batch-stop-job-run-response ([input] (response-batch-stop-job-run-response nil input)) ([resultWrapper1790251 input] (clojure.core/let [rawinput1790250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1790252 {"SuccessfulSubmissions" (rawinput1790250 "SuccessfulSubmissions"), "Errors" (rawinput1790250 "Errors")}] (clojure.core/cond-> {} (letvar1790252 "SuccessfulSubmissions") (clojure.core/assoc :successful-submissions (deser-batch-stop-job-run-successful-submission-list (clojure.core/get-in letvar1790252 ["SuccessfulSubmissions"]))) (letvar1790252 "Errors") (clojure.core/assoc :errors (deser-batch-stop-job-run-error-list (clojure.core/get-in letvar1790252 ["Errors"])))))))

(clojure.spec.alpha/def :portkey.aws.glue/message-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/parameters-map-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512000))))
...
(clojure.spec.alpha/def :portkey.aws.glue/code-gen-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[A-Za-z_][A-Za-z0-9_]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/location-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2056)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/glue-resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:glue:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/format-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/view-text-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 409600))))
...
(clojure.spec.alpha/def :portkey.aws.glue/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/predicate-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.glue/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:kms:.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/crawler-security-configuration (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.glue/version-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/value-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.glue/comment-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.glue/key-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/filter-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/catalog-id-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/description-string-removable (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/table-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.glue/id-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.glue/log-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\.\-_/#A-Za-z0-9]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/log-stream (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[^:*]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/name-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.glue/hash-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/custom-patterns (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 16000)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/table-type-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.glue/description-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/column-type-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 131072)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/grok-pattern (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.glue/policy-json-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10240))))
