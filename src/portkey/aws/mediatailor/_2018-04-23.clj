...
(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper385553 input] (clojure.core/let [rawinput385552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385554 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper385556 input] (clojure.core/let [rawinput385555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385557 {"tags" (rawinput385555 "tags")}] (clojure.core/cond-> {} (letvar385557 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar385557 ["tags"])))))))

(clojure.core/defn- response-list-playback-configurations-response ([input] (response-list-playback-configurations-response nil input)) ([resultWrapper385559 input] (clojure.core/let [rawinput385558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385560 {"Items" (rawinput385558 "Items"), "NextToken" (rawinput385558 "NextToken")}] (clojure.core/cond-> {} (letvar385560 "Items") (clojure.core/assoc :items (deser-list-of-playback-configurations (clojure.core/get-in letvar385560 ["Items"]))) (letvar385560 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar385560 ["NextToken"])))))))

(clojure.core/defn- response-put-playback-configuration-response ([input] (response-put-playback-configuration-response nil input)) ([resultWrapper385562 input] (clojure.core/let [rawinput385561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385563 {"HlsConfiguration" (rawinput385561 "HlsConfiguration"), "tags" (rawinput385561 "tags"), "DashConfiguration" (rawinput385561 "DashConfiguration"), "CdnConfiguration" (rawinput385561 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput385561 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput385561 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput385561 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput385561 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput385561 "SlateAdUrl"), "Name" (rawinput385561 "Name"), "SessionInitializationEndpointPrefix" (rawinput385561 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput385561 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar385563 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar385563 ["HlsConfiguration"]))) (letvar385563 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar385563 ["tags"]))) (letvar385563 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar385563 ["DashConfiguration"]))) (letvar385563 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar385563 ["CdnConfiguration"]))) (letvar385563 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar385563 ["VideoContentSourceUrl"]))) (letvar385563 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar385563 ["PlaybackEndpointPrefix"]))) (letvar385563 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar385563 ["AdDecisionServerUrl"]))) (letvar385563 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar385563 ["PlaybackConfigurationArn"]))) (letvar385563 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar385563 ["SlateAdUrl"]))) (letvar385563 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar385563 ["Name"]))) (letvar385563 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar385563 ["SessionInitializationEndpointPrefix"]))) (letvar385563 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar385563 ["TranscodeProfileName"])))))))

(clojure.core/defn- response-get-playback-configuration-response ([input] (response-get-playback-configuration-response nil input)) ([resultWrapper385565 input] (clojure.core/let [rawinput385564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar385566 {"HlsConfiguration" (rawinput385564 "HlsConfiguration"), "tags" (rawinput385564 "tags"), "DashConfiguration" (rawinput385564 "DashConfiguration"), "CdnConfiguration" (rawinput385564 "CdnConfiguration"), "VideoContentSourceUrl" (rawinput385564 "VideoContentSourceUrl"), "PlaybackEndpointPrefix" (rawinput385564 "PlaybackEndpointPrefix"), "AdDecisionServerUrl" (rawinput385564 "AdDecisionServerUrl"), "PlaybackConfigurationArn" (rawinput385564 "PlaybackConfigurationArn"), "SlateAdUrl" (rawinput385564 "SlateAdUrl"), "Name" (rawinput385564 "Name"), "SessionInitializationEndpointPrefix" (rawinput385564 "SessionInitializationEndpointPrefix"), "TranscodeProfileName" (rawinput385564 "TranscodeProfileName")}] (clojure.core/cond-> {} (letvar385566 "HlsConfiguration") (clojure.core/assoc :hls-configuration (deser-hls-configuration (clojure.core/get-in letvar385566 ["HlsConfiguration"]))) (letvar385566 "tags") (clojure.core/assoc :tags (deser-map-of-string (clojure.core/get-in letvar385566 ["tags"]))) (letvar385566 "DashConfiguration") (clojure.core/assoc :dash-configuration (deser-dash-configuration (clojure.core/get-in letvar385566 ["DashConfiguration"]))) (letvar385566 "CdnConfiguration") (clojure.core/assoc :cdn-configuration (deser-cdn-configuration (clojure.core/get-in letvar385566 ["CdnConfiguration"]))) (letvar385566 "VideoContentSourceUrl") (clojure.core/assoc :video-content-source-url (deser-string (clojure.core/get-in letvar385566 ["VideoContentSourceUrl"]))) (letvar385566 "PlaybackEndpointPrefix") (clojure.core/assoc :playback-endpoint-prefix (deser-string (clojure.core/get-in letvar385566 ["PlaybackEndpointPrefix"]))) (letvar385566 "AdDecisionServerUrl") (clojure.core/assoc :ad-decision-server-url (deser-string (clojure.core/get-in letvar385566 ["AdDecisionServerUrl"]))) (letvar385566 "PlaybackConfigurationArn") (clojure.core/assoc :playback-configuration-arn (deser-string (clojure.core/get-in letvar385566 ["PlaybackConfigurationArn"]))) (letvar385566 "SlateAdUrl") (clojure.core/assoc :slate-ad-url (deser-string (clojure.core/get-in letvar385566 ["SlateAdUrl"]))) (letvar385566 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar385566 ["Name"]))) (letvar385566 "SessionInitializationEndpointPrefix") (clojure.core/assoc :session-initialization-endpoint-prefix (deser-string (clojure.core/get-in letvar385566 ["SessionInitializationEndpointPrefix"]))) (letvar385566 "TranscodeProfileName") (clojure.core/assoc :transcode-profile-name (deser-string (clojure.core/get-in letvar385566 ["TranscodeProfileName"])))))))
