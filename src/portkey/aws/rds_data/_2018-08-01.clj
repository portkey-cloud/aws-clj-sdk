...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1431231 input] (clojure.core/let [rawinput1431230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1431232 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1431234 input] (clojure.core/let [rawinput1431233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1431235 {"message" (rawinput1431233 "message")}] (clojure.core/cond-> {} (letvar1431235 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1431235 ["message"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1431237 input] (clojure.core/let [rawinput1431236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1431238 {"message" (rawinput1431236 "message")}] (clojure.core/cond-> {} (letvar1431238 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1431238 ["message"])))))))

(clojure.core/defn- response-service-unavailable-error ([input] (response-service-unavailable-error nil input)) ([resultWrapper1431240 input] (clojure.core/let [rawinput1431239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1431241 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-execute-sql-response ([input] (response-execute-sql-response nil input)) ([resultWrapper1431243 input] (clojure.core/let [rawinput1431242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1431244 {"sqlStatementResults" (rawinput1431242 "sqlStatementResults")}] (clojure.core/cond-> {:sql-statement-results (deser-sql-statement-results (clojure.core/get-in letvar1431244 ["sqlStatementResults"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data.-2018-08-01/db-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data.-2018-08-01/sql-statement (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 65536))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data.-2018-08-01/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
