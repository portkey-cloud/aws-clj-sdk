...
(clojure.core/defn- response-list-containers-output ([input] (response-list-containers-output nil input)) ([resultWrapper1903231 input] (clojure.core/let [rawinput1903230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903232 {"Containers" (rawinput1903230 "Containers"), "NextToken" (rawinput1903230 "NextToken")}] (clojure.core/cond-> {:containers (deser-container-list (clojure.core/get-in letvar1903232 ["Containers"]))} (letvar1903232 "NextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar1903232 ["NextToken"])))))))

(clojure.core/defn- response-delete-cors-policy-output ([input] (response-delete-cors-policy-output nil input)) ([resultWrapper1903234 input] (clojure.core/let [rawinput1903233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903235 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-lifecycle-policy-output ([input] (response-delete-lifecycle-policy-output nil input)) ([resultWrapper1903237 input] (clojure.core/let [rawinput1903236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903238 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-cors-policy-output ([input] (response-get-cors-policy-output nil input)) ([resultWrapper1903240 input] (clojure.core/let [rawinput1903239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903241 {"CorsPolicy" (rawinput1903239 "CorsPolicy")}] (clojure.core/cond-> {:cors-policy (deser-cors-policy (clojure.core/get-in letvar1903241 ["CorsPolicy"]))}))))

(clojure.core/defn- response-container-not-found-exception ([input] (response-container-not-found-exception nil input)) ([resultWrapper1903243 input] (clojure.core/let [rawinput1903242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903244 {"Message" (rawinput1903242 "Message")}] (clojure.core/cond-> {} (letvar1903244 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903244 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1903246 input] (clojure.core/let [rawinput1903245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903247 {"Message" (rawinput1903245 "Message")}] (clojure.core/cond-> {} (letvar1903247 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903247 ["Message"])))))))

(clojure.core/defn- response-get-container-policy-output ([input] (response-get-container-policy-output nil input)) ([resultWrapper1903249 input] (clojure.core/let [rawinput1903248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903250 {"Policy" (rawinput1903248 "Policy")}] (clojure.core/cond-> {:policy (deser-container-policy (clojure.core/get-in letvar1903250 ["Policy"]))}))))

(clojure.core/defn- response-container-in-use-exception ([input] (response-container-in-use-exception nil input)) ([resultWrapper1903252 input] (clojure.core/let [rawinput1903251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903253 {"Message" (rawinput1903251 "Message")}] (clojure.core/cond-> {} (letvar1903253 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903253 ["Message"])))))))

(clojure.core/defn- response-delete-container-policy-output ([input] (response-delete-container-policy-output nil input)) ([resultWrapper1903255 input] (clojure.core/let [rawinput1903254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903256 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-access-logging-output ([input] (response-stop-access-logging-output nil input)) ([resultWrapper1903258 input] (clojure.core/let [rawinput1903257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903259 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-container-policy-output ([input] (response-put-container-policy-output nil input)) ([resultWrapper1903261 input] (clojure.core/let [rawinput1903260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903262 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-container-output ([input] (response-create-container-output nil input)) ([resultWrapper1903264 input] (clojure.core/let [rawinput1903263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903265 {"Container" (rawinput1903263 "Container")}] (clojure.core/cond-> {:container (deser-container (clojure.core/get-in letvar1903265 ["Container"]))}))))

(clojure.core/defn- response-put-cors-policy-output ([input] (response-put-cors-policy-output nil input)) ([resultWrapper1903267 input] (clojure.core/let [rawinput1903266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903268 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-policy-not-found-exception ([input] (response-policy-not-found-exception nil input)) ([resultWrapper1903270 input] (clojure.core/let [rawinput1903269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903271 {"Message" (rawinput1903269 "Message")}] (clojure.core/cond-> {} (letvar1903271 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903271 ["Message"])))))))

(clojure.core/defn- response-get-lifecycle-policy-output ([input] (response-get-lifecycle-policy-output nil input)) ([resultWrapper1903273 input] (clojure.core/let [rawinput1903272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903274 {"LifecyclePolicy" (rawinput1903272 "LifecyclePolicy")}] (clojure.core/cond-> {:lifecycle-policy (deser-lifecycle-policy (clojure.core/get-in letvar1903274 ["LifecyclePolicy"]))}))))

(clojure.core/defn- response-start-access-logging-output ([input] (response-start-access-logging-output nil input)) ([resultWrapper1903276 input] (clojure.core/let [rawinput1903275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903277 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-cors-policy-not-found-exception ([input] (response-cors-policy-not-found-exception nil input)) ([resultWrapper1903279 input] (clojure.core/let [rawinput1903278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903280 {"Message" (rawinput1903278 "Message")}] (clojure.core/cond-> {} (letvar1903280 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903280 ["Message"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1903282 input] (clojure.core/let [rawinput1903281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903283 {"Message" (rawinput1903281 "Message")}] (clojure.core/cond-> {} (letvar1903283 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1903283 ["Message"])))))))

(clojure.core/defn- response-delete-container-output ([input] (response-delete-container-output nil input)) ([resultWrapper1903285 input] (clojure.core/let [rawinput1903284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903286 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-container-output ([input] (response-describe-container-output nil input)) ([resultWrapper1903288 input] (clojure.core/let [rawinput1903287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903289 {"Container" (rawinput1903287 "Container")}] (clojure.core/cond-> {} (letvar1903289 "Container") (clojure.core/assoc :container (deser-container (clojure.core/get-in letvar1903289 ["Container"])))))))

(clojure.core/defn- response-put-lifecycle-policy-output ([input] (response-put-lifecycle-policy-output nil input)) ([resultWrapper1903291 input] (clojure.core/let [rawinput1903290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1903292 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/header (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9A-Za-z=/+]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/origin (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[ \w:\.\?-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/container-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/endpoint (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/container-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws:mediastore:[a-z]+-[a-z]+-\d:\d{12}:container/\w{1,255}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/container-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.mediastore.-2017-09-01/lifecycle-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 8192)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0009\u000A\u000D\u0020-\u00FF]+" s__1410940__auto__))))
