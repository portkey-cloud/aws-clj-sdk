...
(clojure.core/defn- response-disable-user-result ([input] (response-disable-user-result nil input)) ([resultWrapper1504321 input] (clojure.core/let [rawinput1504320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504322 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-directory-config-result ([input] (response-delete-directory-config-result nil input)) ([resultWrapper1504324 input] (clojure.core/let [rawinput1504323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504325 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-directory-config-result ([input] (response-update-directory-config-result nil input)) ([resultWrapper1504327 input] (clojure.core/let [rawinput1504326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504328 {"DirectoryConfig" (rawinput1504326 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1504328 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1504328 ["DirectoryConfig"])))))))

(clojure.core/defn- response-enable-user-result ([input] (response-enable-user-result nil input)) ([resultWrapper1504330 input] (clojure.core/let [rawinput1504329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504331 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-sessions-result ([input] (response-describe-sessions-result nil input)) ([resultWrapper1504333 input] (clojure.core/let [rawinput1504332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504334 {"Sessions" (rawinput1504332 "Sessions"), "NextToken" (rawinput1504332 "NextToken")}] (clojure.core/cond-> {} (letvar1504334 "Sessions") (clojure.core/assoc :sessions (deser-session-list (clojure.core/get-in letvar1504334 ["Sessions"]))) (letvar1504334 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504334 ["NextToken"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1504336 input] (clojure.core/let [rawinput1504335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504337 {"Message" (rawinput1504335 "Message")}] (clojure.core/cond-> {} (letvar1504337 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504337 ["Message"])))))))

(clojure.core/defn- response-describe-directory-configs-result ([input] (response-describe-directory-configs-result nil input)) ([resultWrapper1504339 input] (clojure.core/let [rawinput1504338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504340 {"DirectoryConfigs" (rawinput1504338 "DirectoryConfigs"), "NextToken" (rawinput1504338 "NextToken")}] (clojure.core/cond-> {} (letvar1504340 "DirectoryConfigs") (clojure.core/assoc :directory-configs (deser-directory-config-list (clojure.core/get-in letvar1504340 ["DirectoryConfigs"]))) (letvar1504340 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504340 ["NextToken"])))))))

(clojure.core/defn- response-invalid-role-exception ([input] (response-invalid-role-exception nil input)) ([resultWrapper1504342 input] (clojure.core/let [rawinput1504341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504343 {"Message" (rawinput1504341 "Message")}] (clojure.core/cond-> {} (letvar1504343 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504343 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1504345 input] (clojure.core/let [rawinput1504344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504346 {"Tags" (rawinput1504344 "Tags")}] (clojure.core/cond-> {} (letvar1504346 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1504346 ["Tags"])))))))

(clojure.core/defn- response-disassociate-fleet-result ([input] (response-disassociate-fleet-result nil input)) ([resultWrapper1504348 input] (clojure.core/let [rawinput1504347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504349 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-result ([input] (response-delete-user-result nil input)) ([resultWrapper1504351 input] (clojure.core/let [rawinput1504350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504352 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-fleets-result ([input] (response-describe-fleets-result nil input)) ([resultWrapper1504354 input] (clojure.core/let [rawinput1504353 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504355 {"Fleets" (rawinput1504353 "Fleets"), "NextToken" (rawinput1504353 "NextToken")}] (clojure.core/cond-> {} (letvar1504355 "Fleets") (clojure.core/assoc :fleets (deser-fleet-list (clojure.core/get-in letvar1504355 ["Fleets"]))) (letvar1504355 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504355 ["NextToken"])))))))

(clojure.core/defn- response-stop-fleet-result ([input] (response-stop-fleet-result nil input)) ([resultWrapper1504357 input] (clojure.core/let [rawinput1504356 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504358 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1504360 input] (clojure.core/let [rawinput1504359 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504361 {"Message" (rawinput1504359 "Message")}] (clojure.core/cond-> {} (letvar1504361 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504361 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1504363 input] (clojure.core/let [rawinput1504362 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504364 {"Message" (rawinput1504362 "Message")}] (clojure.core/cond-> {} (letvar1504364 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504364 ["Message"])))))))

(clojure.core/defn- response-start-image-builder-result ([input] (response-start-image-builder-result nil input)) ([resultWrapper1504366 input] (clojure.core/let [rawinput1504365 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504367 {"ImageBuilder" (rawinput1504365 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1504367 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1504367 ["ImageBuilder"])))))))

(clojure.core/defn- response-describe-image-permissions-result ([input] (response-describe-image-permissions-result nil input)) ([resultWrapper1504369 input] (clojure.core/let [rawinput1504368 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504370 {"Name" (rawinput1504368 "Name"), "SharedImagePermissionsList" (rawinput1504368 "SharedImagePermissionsList"), "NextToken" (rawinput1504368 "NextToken")}] (clojure.core/cond-> {} (letvar1504370 "Name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1504370 ["Name"]))) (letvar1504370 "SharedImagePermissionsList") (clojure.core/assoc :shared-image-permissions-list (deser-shared-image-permissions-list (clojure.core/get-in letvar1504370 ["SharedImagePermissionsList"]))) (letvar1504370 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504370 ["NextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1504372 input] (clojure.core/let [rawinput1504371 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504373 {"Message" (rawinput1504371 "Message")}] (clojure.core/cond-> {} (letvar1504373 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504373 ["Message"])))))))

(clojure.core/defn- response-invalid-account-status-exception ([input] (response-invalid-account-status-exception nil input)) ([resultWrapper1504375 input] (clojure.core/let [rawinput1504374 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504376 {"Message" (rawinput1504374 "Message")}] (clojure.core/cond-> {} (letvar1504376 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504376 ["Message"])))))))

(clojure.core/defn- response-start-fleet-result ([input] (response-start-fleet-result nil input)) ([resultWrapper1504378 input] (clojure.core/let [rawinput1504377 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504379 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1504381 input] (clojure.core/let [rawinput1504380 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504382 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-stack-result ([input] (response-create-stack-result nil input)) ([resultWrapper1504384 input] (clojure.core/let [rawinput1504383 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504385 {"Stack" (rawinput1504383 "Stack")}] (clojure.core/cond-> {} (letvar1504385 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1504385 ["Stack"])))))))

(clojure.core/defn- response-describe-images-result ([input] (response-describe-images-result nil input)) ([resultWrapper1504387 input] (clojure.core/let [rawinput1504386 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504388 {"Images" (rawinput1504386 "Images"), "NextToken" (rawinput1504386 "NextToken")}] (clojure.core/cond-> {} (letvar1504388 "Images") (clojure.core/assoc :images (deser-image-list (clojure.core/get-in letvar1504388 ["Images"]))) (letvar1504388 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504388 ["NextToken"])))))))

(clojure.core/defn- response-associate-fleet-result ([input] (response-associate-fleet-result nil input)) ([resultWrapper1504390 input] (clojure.core/let [rawinput1504389 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504391 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-image-permissions-result ([input] (response-update-image-permissions-result nil input)) ([resultWrapper1504393 input] (clojure.core/let [rawinput1504392 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504394 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-image-builder-result ([input] (response-delete-image-builder-result nil input)) ([resultWrapper1504396 input] (clojure.core/let [rawinput1504395 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504397 {"ImageBuilder" (rawinput1504395 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1504397 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1504397 ["ImageBuilder"])))))))

(clojure.core/defn- response-create-image-builder-result ([input] (response-create-image-builder-result nil input)) ([resultWrapper1504399 input] (clojure.core/let [rawinput1504398 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504400 {"ImageBuilder" (rawinput1504398 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1504400 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1504400 ["ImageBuilder"])))))))

(clojure.core/defn- response-batch-associate-user-stack-result ([input] (response-batch-associate-user-stack-result nil input)) ([resultWrapper1504402 input] (clojure.core/let [rawinput1504401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504403 {"errors" (rawinput1504401 "errors")}] (clojure.core/cond-> {} (letvar1504403 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1504403 ["errors"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1504405 input] (clojure.core/let [rawinput1504404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504406 {"Message" (rawinput1504404 "Message")}] (clojure.core/cond-> {} (letvar1504406 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504406 ["Message"])))))))

(clojure.core/defn- response-delete-stack-result ([input] (response-delete-stack-result nil input)) ([resultWrapper1504408 input] (clojure.core/let [rawinput1504407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504409 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-associated-fleets-result ([input] (response-list-associated-fleets-result nil input)) ([resultWrapper1504411 input] (clojure.core/let [rawinput1504410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504412 {"Names" (rawinput1504410 "Names"), "NextToken" (rawinput1504410 "NextToken")}] (clojure.core/cond-> {} (letvar1504412 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1504412 ["Names"]))) (letvar1504412 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504412 ["NextToken"])))))))

(clojure.core/defn- response-create-image-builder-streaming-url-result ([input] (response-create-image-builder-streaming-url-result nil input)) ([resultWrapper1504414 input] (clojure.core/let [rawinput1504413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504415 {"StreamingURL" (rawinput1504413 "StreamingURL"), "Expires" (rawinput1504413 "Expires")}] (clojure.core/cond-> {} (letvar1504415 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1504415 ["StreamingURL"]))) (letvar1504415 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1504415 ["Expires"])))))))

(clojure.core/defn- response-resource-not-available-exception ([input] (response-resource-not-available-exception nil input)) ([resultWrapper1504417 input] (clojure.core/let [rawinput1504416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504418 {"Message" (rawinput1504416 "Message")}] (clojure.core/cond-> {} (letvar1504418 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504418 ["Message"])))))))

(clojure.core/defn- response-describe-image-builders-result ([input] (response-describe-image-builders-result nil input)) ([resultWrapper1504420 input] (clojure.core/let [rawinput1504419 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504421 {"ImageBuilders" (rawinput1504419 "ImageBuilders"), "NextToken" (rawinput1504419 "NextToken")}] (clojure.core/cond-> {} (letvar1504421 "ImageBuilders") (clojure.core/assoc :image-builders (deser-image-builder-list (clojure.core/get-in letvar1504421 ["ImageBuilders"]))) (letvar1504421 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504421 ["NextToken"])))))))

(clojure.core/defn- response-batch-disassociate-user-stack-result ([input] (response-batch-disassociate-user-stack-result nil input)) ([resultWrapper1504423 input] (clojure.core/let [rawinput1504422 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504424 {"errors" (rawinput1504422 "errors")}] (clojure.core/cond-> {} (letvar1504424 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1504424 ["errors"])))))))

(clojure.core/defn- response-delete-image-permissions-result ([input] (response-delete-image-permissions-result nil input)) ([resultWrapper1504426 input] (clojure.core/let [rawinput1504425 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504427 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper1504429 input] (clojure.core/let [rawinput1504428 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504430 {"Message" (rawinput1504428 "Message")}] (clojure.core/cond-> {} (letvar1504430 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504430 ["Message"])))))))

(clojure.core/defn- response-update-fleet-result ([input] (response-update-fleet-result nil input)) ([resultWrapper1504432 input] (clojure.core/let [rawinput1504431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504433 {"Fleet" (rawinput1504431 "Fleet")}] (clojure.core/cond-> {} (letvar1504433 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1504433 ["Fleet"])))))))

(clojure.core/defn- response-describe-user-stack-associations-result ([input] (response-describe-user-stack-associations-result nil input)) ([resultWrapper1504435 input] (clojure.core/let [rawinput1504434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504436 {"UserStackAssociations" (rawinput1504434 "UserStackAssociations"), "NextToken" (rawinput1504434 "NextToken")}] (clojure.core/cond-> {} (letvar1504436 "UserStackAssociations") (clojure.core/assoc :user-stack-associations (deser-user-stack-association-list (clojure.core/get-in letvar1504436 ["UserStackAssociations"]))) (letvar1504436 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504436 ["NextToken"])))))))

(clojure.core/defn- response-stop-image-builder-result ([input] (response-stop-image-builder-result nil input)) ([resultWrapper1504438 input] (clojure.core/let [rawinput1504437 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504439 {"ImageBuilder" (rawinput1504437 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1504439 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1504439 ["ImageBuilder"])))))))

(clojure.core/defn- response-update-stack-result ([input] (response-update-stack-result nil input)) ([resultWrapper1504441 input] (clojure.core/let [rawinput1504440 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504442 {"Stack" (rawinput1504440 "Stack")}] (clojure.core/cond-> {} (letvar1504442 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1504442 ["Stack"])))))))

(clojure.core/defn- response-create-user-result ([input] (response-create-user-result nil input)) ([resultWrapper1504444 input] (clojure.core/let [rawinput1504443 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504445 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-streaming-url-result ([input] (response-create-streaming-url-result nil input)) ([resultWrapper1504447 input] (clojure.core/let [rawinput1504446 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504448 {"StreamingURL" (rawinput1504446 "StreamingURL"), "Expires" (rawinput1504446 "Expires")}] (clojure.core/cond-> {} (letvar1504448 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1504448 ["StreamingURL"]))) (letvar1504448 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1504448 ["Expires"])))))))

(clojure.core/defn- response-create-fleet-result ([input] (response-create-fleet-result nil input)) ([resultWrapper1504450 input] (clojure.core/let [rawinput1504449 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504451 {"Fleet" (rawinput1504449 "Fleet")}] (clojure.core/cond-> {} (letvar1504451 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1504451 ["Fleet"])))))))

(clojure.core/defn- response-incompatible-image-exception ([input] (response-incompatible-image-exception nil input)) ([resultWrapper1504453 input] (clojure.core/let [rawinput1504452 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504454 {"Message" (rawinput1504452 "Message")}] (clojure.core/cond-> {} (letvar1504454 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504454 ["Message"])))))))

(clojure.core/defn- response-describe-users-result ([input] (response-describe-users-result nil input)) ([resultWrapper1504456 input] (clojure.core/let [rawinput1504455 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504457 {"Users" (rawinput1504455 "Users"), "NextToken" (rawinput1504455 "NextToken")}] (clojure.core/cond-> {} (letvar1504457 "Users") (clojure.core/assoc :users (deser-user-list (clojure.core/get-in letvar1504457 ["Users"]))) (letvar1504457 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504457 ["NextToken"])))))))

(clojure.core/defn- response-create-directory-config-result ([input] (response-create-directory-config-result nil input)) ([resultWrapper1504459 input] (clojure.core/let [rawinput1504458 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504460 {"DirectoryConfig" (rawinput1504458 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1504460 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1504460 ["DirectoryConfig"])))))))

(clojure.core/defn- response-describe-stacks-result ([input] (response-describe-stacks-result nil input)) ([resultWrapper1504462 input] (clojure.core/let [rawinput1504461 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504463 {"Stacks" (rawinput1504461 "Stacks"), "NextToken" (rawinput1504461 "NextToken")}] (clojure.core/cond-> {} (letvar1504463 "Stacks") (clojure.core/assoc :stacks (deser-stack-list (clojure.core/get-in letvar1504463 ["Stacks"]))) (letvar1504463 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504463 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1504465 input] (clojure.core/let [rawinput1504464 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504466 {"Message" (rawinput1504464 "Message")}] (clojure.core/cond-> {} (letvar1504466 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1504466 ["Message"])))))))

(clojure.core/defn- response-delete-image-result ([input] (response-delete-image-result nil input)) ([resultWrapper1504468 input] (clojure.core/let [rawinput1504467 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504469 {"Image" (rawinput1504467 "Image")}] (clojure.core/cond-> {} (letvar1504469 "Image") (clojure.core/assoc :image (deser-image (clojure.core/get-in letvar1504469 ["Image"])))))))

(clojure.core/defn- response-delete-fleet-result ([input] (response-delete-fleet-result nil input)) ([resultWrapper1504471 input] (clojure.core/let [rawinput1504470 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504472 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1504474 input] (clojure.core/let [rawinput1504473 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504475 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-expire-session-result ([input] (response-expire-session-result nil input)) ([resultWrapper1504477 input] (clojure.core/let [rawinput1504476 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504478 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-copy-image-response ([input] (response-copy-image-response nil input)) ([resultWrapper1504480 input] (clojure.core/let [rawinput1504479 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504481 {"DestinationImageName" (rawinput1504479 "DestinationImageName")}] (clojure.core/cond-> {} (letvar1504481 "DestinationImageName") (clojure.core/assoc :destination-image-name (deser-name (clojure.core/get-in letvar1504481 ["DestinationImageName"])))))))

(clojure.core/defn- response-list-associated-stacks-result ([input] (response-list-associated-stacks-result nil input)) ([resultWrapper1504483 input] (clojure.core/let [rawinput1504482 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1504484 {"Names" (rawinput1504482 "Names"), "NextToken" (rawinput1504482 "NextToken")}] (clojure.core/cond-> {} (letvar1504484 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1504484 ["Names"]))) (letvar1504484 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1504484 ["NextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.appstream/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/subnet-id-list (clojure.spec.alpha/coll-of :portkey.aws.appstream/string))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 128)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^(^(?!aws:).[\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/region-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/stack-errors (clojure.spec.alpha/coll-of :portkey.aws.appstream/stack-error))

(clojure.spec.alpha/def :portkey.aws.appstream/domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/user-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2048)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[A-Za-z0-9_\-\s]+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/appstream-agent-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^\d+$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/resource-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-Za-z0-9_/.-]{0,62}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-Za-z0-9:_/+=,@.-]{0,1023}$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.appstream/feedback-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))

(clojure.spec.alpha/def :portkey.aws.appstream/long clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.appstream/streaming-url-user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/settings-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/organizational-unit-distinguished-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/redirect-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1000))))
