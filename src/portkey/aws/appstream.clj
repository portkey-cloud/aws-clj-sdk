...
(clojure.core/defn- deser-session [input] (clojure.core/cond-> {:id (deser-string (input "Id")), :user-id (deser-user-id (input "UserId")), :stack-name (deser-string (input "StackName")), :fleet-name (deser-string (input "FleetName")), :state (deser-session-state (input "State"))} (clojure.core/contains? input "AuthenticationType") (clojure.core/assoc :authentication-type (deser-authentication-type (input "AuthenticationType"))) (clojure.core/contains? input "NetworkAccessConfiguration") (clojure.core/assoc :network-access-configuration (deser-network-access-configuration (input "NetworkAccessConfiguration")))))
...
(clojure.core/defn- deser-delete-directory-config-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-directory-config-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (input "DirectoryConfig")))))

(clojure.core/defn- deser-describe-sessions-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Sessions") (clojure.core/assoc :sessions (deser-session-list (input "Sessions"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-operation-not-permitted-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-describe-directory-configs-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryConfigs") (clojure.core/assoc :directory-configs (deser-directory-config-list (input "DirectoryConfigs"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-invalid-role-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-list-tags-for-resource-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "Tags") (clojure.core/assoc :tags (deser-tags (input "Tags")))))

(clojure.core/defn- deser-disassociate-fleet-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-describe-fleets-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Fleets") (clojure.core/assoc :fleets (deser-fleet-list (input "Fleets"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-stop-fleet-result [input] (clojure.core/cond-> {}))
...
(clojure.core/defn- deser-start-image-builder-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (input "ImageBuilder")))))

(clojure.core/defn- deser-describe-image-permissions-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Name") (clojure.core/assoc :name (deser-name (input "Name"))) (clojure.core/contains? input "SharedImagePermissionsList") (clojure.core/assoc :shared-image-permissions-list (deser-shared-image-permissions-list (input "SharedImagePermissionsList"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-resource-already-exists-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-invalid-account-status-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-start-fleet-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-tag-resource-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-create-stack-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Stack") (clojure.core/assoc :stack (deser-stack (input "Stack")))))

(clojure.core/defn- deser-describe-images-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Images") (clojure.core/assoc :images (deser-image-list (input "Images"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-associate-fleet-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-update-image-permissions-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-delete-image-builder-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (input "ImageBuilder")))))

(clojure.core/defn- deser-create-image-builder-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (input "ImageBuilder")))))
...
(clojure.core/defn- deser-delete-stack-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-list-associated-fleets-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Names") (clojure.core/assoc :names (deser-string-list (input "Names"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-create-image-builder-streaming-url-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (input "StreamingURL"))) (clojure.core/contains? input "Expires") (clojure.core/assoc :expires (deser-timestamp (input "Expires")))))

(clojure.core/defn- deser-resource-not-available-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-describe-image-builders-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImageBuilders") (clojure.core/assoc :image-builders (deser-image-builder-list (input "ImageBuilders"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))

(clojure.core/defn- deser-delete-image-permissions-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-invalid-parameter-combination-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-update-fleet-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Fleet") (clojure.core/assoc :fleet (deser-fleet (input "Fleet")))))

(clojure.core/defn- deser-stop-image-builder-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (input "ImageBuilder")))))

(clojure.core/defn- deser-update-stack-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Stack") (clojure.core/assoc :stack (deser-stack (input "Stack")))))

(clojure.core/defn- deser-create-streaming-url-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (input "StreamingURL"))) (clojure.core/contains? input "Expires") (clojure.core/assoc :expires (deser-timestamp (input "Expires")))))

(clojure.core/defn- deser-create-fleet-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Fleet") (clojure.core/assoc :fleet (deser-fleet (input "Fleet")))))

(clojure.core/defn- deser-incompatible-image-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "Message") (clojure.core/assoc :message (deser-error-message (input "Message")))))

(clojure.core/defn- deser-create-directory-config-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (input "DirectoryConfig")))))

(clojure.core/defn- deser-describe-stacks-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Stacks") (clojure.core/assoc :stacks (deser-stack-list (input "Stacks"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))
...
(clojure.core/defn- deser-delete-image-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Image") (clojure.core/assoc :image (deser-image (input "Image")))))

(clojure.core/defn- deser-delete-fleet-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-untag-resource-response [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-expire-session-result [input] (clojure.core/cond-> {}))

(clojure.core/defn- deser-copy-image-response [input] (clojure.core/cond-> {} (clojure.core/contains? input "DestinationImageName") (clojure.core/assoc :destination-image-name (deser-name (input "DestinationImageName")))))

(clojure.core/defn- deser-list-associated-stacks-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "Names") (clojure.core/assoc :names (deser-string-list (input "Names"))) (clojure.core/contains? input "NextToken") (clojure.core/assoc :next-token (deser-string (input "NextToken")))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/create-stack-request (clojure.spec.alpha/keys :req-un [:portkey.aws.appstream/name] :opt-un [:portkey.aws.appstream/description :portkey.aws.appstream/display-name :portkey.aws.appstream.create-stack-request/storage-connectors :portkey.aws.appstream/redirect-url :portkey.aws.appstream/feedback-url :portkey.aws.appstream.create-stack-request/user-settings :portkey.aws.appstream/application-settings]))
...
(clojure.spec.alpha/def :portkey.aws.appstream/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 2 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/subnet-id-list (clojure.spec.alpha/coll-of :portkey.aws.appstream/string))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 128)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^(^(?!aws:).[\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/create-image-builder-request (clojure.spec.alpha/keys :req-un [:portkey.aws.appstream/name :portkey.aws.appstream.create-image-builder-request/instance-type] :opt-un [:portkey.aws.appstream/domain-join-info :portkey.aws.appstream.create-image-builder-request/image-name :portkey.aws.appstream.create-image-builder-request/enable-default-internet-access :portkey.aws.appstream/display-name :portkey.aws.appstream.create-image-builder-request/image-arn :portkey.aws.appstream/appstream-agent-version :portkey.aws.appstream/description :portkey.aws.appstream/vpc-config]))
...
(clojure.spec.alpha/def :portkey.aws.appstream/region-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/stack-errors (clojure.spec.alpha/coll-of :portkey.aws.appstream/stack-error))

(clojure.spec.alpha/def :portkey.aws.appstream/domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/appstream-agent-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 0 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 256)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^\d+$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/resource-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-Za-z0-9_/.-]{0,62}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-Za-z0-9:_/+=,@.-]{0,1023}$" s__27881__auto__))))

(clojure.spec.alpha/def :portkey.aws.appstream/feedback-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))

(clojure.spec.alpha/def :portkey.aws.appstream/long clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.appstream/streaming-url-user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 2 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 32)) (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/settings-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$" s__27881__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/create-fleet-request (clojure.spec.alpha/keys :req-un [:portkey.aws.appstream/name :portkey.aws.appstream.create-fleet-request/instance-type :portkey.aws.appstream/compute-capacity] :opt-un [:portkey.aws.appstream/domain-join-info :portkey.aws.appstream.create-fleet-request/image-name :portkey.aws.appstream.create-fleet-request/disconnect-timeout-in-seconds :portkey.aws.appstream/fleet-type :portkey.aws.appstream.create-fleet-request/enable-default-internet-access :portkey.aws.appstream/display-name :portkey.aws.appstream.create-fleet-request/image-arn :portkey.aws.appstream/description :portkey.aws.appstream/vpc-config :portkey.aws.appstream.create-fleet-request/max-user-duration-in-seconds]))
...
(clojure.spec.alpha/def :portkey.aws.appstream/session (clojure.spec.alpha/keys :req-un [:portkey.aws.appstream.session/id :portkey.aws.appstream/user-id :portkey.aws.appstream.session/stack-name :portkey.aws.appstream.session/fleet-name :portkey.aws.appstream.session/state] :opt-un [:portkey.aws.appstream/authentication-type :portkey.aws.appstream/network-access-configuration]))

(clojure.spec.alpha/def :portkey.aws.appstream/organizational-unit-distinguished-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/redirect-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 1000))))
...
(clojure.core/defn update-fleet ([] (update-fleet {})) ([update-fleet-requestinput] (clojure.core/let [request-function-result__28581__auto__ (req-update-fleet-request update-fleet-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28581__auto__ {:http.request.configuration/endpoints portkey.aws.appstream/endpoints, :http.request.configuration/target-prefix "PhotonAdminProxyService", :http.request.spec/output-spec :portkey.aws.appstream/update-fleet-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2016-12-01", :http.request.configuration/service-id "AppStream", :http.request.spec/input-spec :portkey.aws.appstream/update-fleet-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateFleet", :http.request.configuration/output-deser-fn deser-update-fleet-result, :http.request.spec/error-spec {"OperationNotPermittedException" :portkey.aws.appstream/operation-not-permitted-exception, "InvalidRoleException" :portkey.aws.appstream/invalid-role-exception, "ResourceInUseException" :portkey.aws.appstream/resource-in-use-exception, "LimitExceededException" :portkey.aws.appstream/limit-exceeded-exception, "InvalidAccountStatusException" :portkey.aws.appstream/invalid-account-status-exception, "ResourceNotFoundException" :portkey.aws.appstream/resource-not-found-exception, "ResourceNotAvailableException" :portkey.aws.appstream/resource-not-available-exception, "InvalidParameterCombinationException" :portkey.aws.appstream/invalid-parameter-combination-exception, "IncompatibleImageException" :portkey.aws.appstream/incompatible-image-exception, "ConcurrentModificationException" :portkey.aws.appstream/concurrent-modification-exception}})))))
