...
(clojure.core/defn- response-disable-user-result ([input] (response-disable-user-result nil input)) ([resultWrapper1445023 input] (clojure.core/let [rawinput1445022 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445024 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-directory-config-result ([input] (response-delete-directory-config-result nil input)) ([resultWrapper1445026 input] (clojure.core/let [rawinput1445025 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445027 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-directory-config-result ([input] (response-update-directory-config-result nil input)) ([resultWrapper1445029 input] (clojure.core/let [rawinput1445028 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445030 {"DirectoryConfig" (rawinput1445028 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1445030 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1445030 ["DirectoryConfig"])))))))

(clojure.core/defn- response-enable-user-result ([input] (response-enable-user-result nil input)) ([resultWrapper1445032 input] (clojure.core/let [rawinput1445031 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445033 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-sessions-result ([input] (response-describe-sessions-result nil input)) ([resultWrapper1445035 input] (clojure.core/let [rawinput1445034 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445036 {"Sessions" (rawinput1445034 "Sessions"), "NextToken" (rawinput1445034 "NextToken")}] (clojure.core/cond-> {} (letvar1445036 "Sessions") (clojure.core/assoc :sessions (deser-session-list (clojure.core/get-in letvar1445036 ["Sessions"]))) (letvar1445036 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445036 ["NextToken"])))))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper1445038 input] (clojure.core/let [rawinput1445037 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445039 {"Message" (rawinput1445037 "Message")}] (clojure.core/cond-> {} (letvar1445039 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445039 ["Message"])))))))

(clojure.core/defn- response-describe-directory-configs-result ([input] (response-describe-directory-configs-result nil input)) ([resultWrapper1445041 input] (clojure.core/let [rawinput1445040 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445042 {"DirectoryConfigs" (rawinput1445040 "DirectoryConfigs"), "NextToken" (rawinput1445040 "NextToken")}] (clojure.core/cond-> {} (letvar1445042 "DirectoryConfigs") (clojure.core/assoc :directory-configs (deser-directory-config-list (clojure.core/get-in letvar1445042 ["DirectoryConfigs"]))) (letvar1445042 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445042 ["NextToken"])))))))

(clojure.core/defn- response-invalid-role-exception ([input] (response-invalid-role-exception nil input)) ([resultWrapper1445044 input] (clojure.core/let [rawinput1445043 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445045 {"Message" (rawinput1445043 "Message")}] (clojure.core/cond-> {} (letvar1445045 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445045 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1445047 input] (clojure.core/let [rawinput1445046 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445048 {"Tags" (rawinput1445046 "Tags")}] (clojure.core/cond-> {} (letvar1445048 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1445048 ["Tags"])))))))

(clojure.core/defn- response-disassociate-fleet-result ([input] (response-disassociate-fleet-result nil input)) ([resultWrapper1445050 input] (clojure.core/let [rawinput1445049 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445051 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-result ([input] (response-delete-user-result nil input)) ([resultWrapper1445053 input] (clojure.core/let [rawinput1445052 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445054 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-fleets-result ([input] (response-describe-fleets-result nil input)) ([resultWrapper1445056 input] (clojure.core/let [rawinput1445055 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445057 {"Fleets" (rawinput1445055 "Fleets"), "NextToken" (rawinput1445055 "NextToken")}] (clojure.core/cond-> {} (letvar1445057 "Fleets") (clojure.core/assoc :fleets (deser-fleet-list (clojure.core/get-in letvar1445057 ["Fleets"]))) (letvar1445057 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445057 ["NextToken"])))))))

(clojure.core/defn- response-stop-fleet-result ([input] (response-stop-fleet-result nil input)) ([resultWrapper1445059 input] (clojure.core/let [rawinput1445058 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445060 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1445062 input] (clojure.core/let [rawinput1445061 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445063 {"Message" (rawinput1445061 "Message")}] (clojure.core/cond-> {} (letvar1445063 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445063 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1445065 input] (clojure.core/let [rawinput1445064 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445066 {"Message" (rawinput1445064 "Message")}] (clojure.core/cond-> {} (letvar1445066 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445066 ["Message"])))))))

(clojure.core/defn- response-start-image-builder-result ([input] (response-start-image-builder-result nil input)) ([resultWrapper1445068 input] (clojure.core/let [rawinput1445067 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445069 {"ImageBuilder" (rawinput1445067 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1445069 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1445069 ["ImageBuilder"])))))))

(clojure.core/defn- response-describe-image-permissions-result ([input] (response-describe-image-permissions-result nil input)) ([resultWrapper1445071 input] (clojure.core/let [rawinput1445070 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445072 {"Name" (rawinput1445070 "Name"), "SharedImagePermissionsList" (rawinput1445070 "SharedImagePermissionsList"), "NextToken" (rawinput1445070 "NextToken")}] (clojure.core/cond-> {} (letvar1445072 "Name") (clojure.core/assoc :name (deser-name (clojure.core/get-in letvar1445072 ["Name"]))) (letvar1445072 "SharedImagePermissionsList") (clojure.core/assoc :shared-image-permissions-list (deser-shared-image-permissions-list (clojure.core/get-in letvar1445072 ["SharedImagePermissionsList"]))) (letvar1445072 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445072 ["NextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1445074 input] (clojure.core/let [rawinput1445073 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445075 {"Message" (rawinput1445073 "Message")}] (clojure.core/cond-> {} (letvar1445075 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445075 ["Message"])))))))

(clojure.core/defn- response-invalid-account-status-exception ([input] (response-invalid-account-status-exception nil input)) ([resultWrapper1445077 input] (clojure.core/let [rawinput1445076 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445078 {"Message" (rawinput1445076 "Message")}] (clojure.core/cond-> {} (letvar1445078 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445078 ["Message"])))))))

(clojure.core/defn- response-start-fleet-result ([input] (response-start-fleet-result nil input)) ([resultWrapper1445080 input] (clojure.core/let [rawinput1445079 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445081 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1445083 input] (clojure.core/let [rawinput1445082 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445084 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-stack-result ([input] (response-create-stack-result nil input)) ([resultWrapper1445086 input] (clojure.core/let [rawinput1445085 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445087 {"Stack" (rawinput1445085 "Stack")}] (clojure.core/cond-> {} (letvar1445087 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1445087 ["Stack"])))))))

(clojure.core/defn- response-describe-images-result ([input] (response-describe-images-result nil input)) ([resultWrapper1445089 input] (clojure.core/let [rawinput1445088 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445090 {"Images" (rawinput1445088 "Images"), "NextToken" (rawinput1445088 "NextToken")}] (clojure.core/cond-> {} (letvar1445090 "Images") (clojure.core/assoc :images (deser-image-list (clojure.core/get-in letvar1445090 ["Images"]))) (letvar1445090 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445090 ["NextToken"])))))))

(clojure.core/defn- response-associate-fleet-result ([input] (response-associate-fleet-result nil input)) ([resultWrapper1445092 input] (clojure.core/let [rawinput1445091 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445093 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-image-permissions-result ([input] (response-update-image-permissions-result nil input)) ([resultWrapper1445095 input] (clojure.core/let [rawinput1445094 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445096 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-image-builder-result ([input] (response-delete-image-builder-result nil input)) ([resultWrapper1445098 input] (clojure.core/let [rawinput1445097 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445099 {"ImageBuilder" (rawinput1445097 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1445099 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1445099 ["ImageBuilder"])))))))

(clojure.core/defn- response-create-image-builder-result ([input] (response-create-image-builder-result nil input)) ([resultWrapper1445101 input] (clojure.core/let [rawinput1445100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445102 {"ImageBuilder" (rawinput1445100 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1445102 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1445102 ["ImageBuilder"])))))))

(clojure.core/defn- response-batch-associate-user-stack-result ([input] (response-batch-associate-user-stack-result nil input)) ([resultWrapper1445104 input] (clojure.core/let [rawinput1445103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445105 {"errors" (rawinput1445103 "errors")}] (clojure.core/cond-> {} (letvar1445105 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1445105 ["errors"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1445107 input] (clojure.core/let [rawinput1445106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445108 {"Message" (rawinput1445106 "Message")}] (clojure.core/cond-> {} (letvar1445108 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445108 ["Message"])))))))

(clojure.core/defn- response-delete-stack-result ([input] (response-delete-stack-result nil input)) ([resultWrapper1445110 input] (clojure.core/let [rawinput1445109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445111 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-associated-fleets-result ([input] (response-list-associated-fleets-result nil input)) ([resultWrapper1445113 input] (clojure.core/let [rawinput1445112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445114 {"Names" (rawinput1445112 "Names"), "NextToken" (rawinput1445112 "NextToken")}] (clojure.core/cond-> {} (letvar1445114 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1445114 ["Names"]))) (letvar1445114 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445114 ["NextToken"])))))))

(clojure.core/defn- response-create-image-builder-streaming-url-result ([input] (response-create-image-builder-streaming-url-result nil input)) ([resultWrapper1445116 input] (clojure.core/let [rawinput1445115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445117 {"StreamingURL" (rawinput1445115 "StreamingURL"), "Expires" (rawinput1445115 "Expires")}] (clojure.core/cond-> {} (letvar1445117 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1445117 ["StreamingURL"]))) (letvar1445117 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1445117 ["Expires"])))))))

(clojure.core/defn- response-resource-not-available-exception ([input] (response-resource-not-available-exception nil input)) ([resultWrapper1445119 input] (clojure.core/let [rawinput1445118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445120 {"Message" (rawinput1445118 "Message")}] (clojure.core/cond-> {} (letvar1445120 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445120 ["Message"])))))))

(clojure.core/defn- response-describe-image-builders-result ([input] (response-describe-image-builders-result nil input)) ([resultWrapper1445122 input] (clojure.core/let [rawinput1445121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445123 {"ImageBuilders" (rawinput1445121 "ImageBuilders"), "NextToken" (rawinput1445121 "NextToken")}] (clojure.core/cond-> {} (letvar1445123 "ImageBuilders") (clojure.core/assoc :image-builders (deser-image-builder-list (clojure.core/get-in letvar1445123 ["ImageBuilders"]))) (letvar1445123 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445123 ["NextToken"])))))))

(clojure.core/defn- response-batch-disassociate-user-stack-result ([input] (response-batch-disassociate-user-stack-result nil input)) ([resultWrapper1445125 input] (clojure.core/let [rawinput1445124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445126 {"errors" (rawinput1445124 "errors")}] (clojure.core/cond-> {} (letvar1445126 "errors") (clojure.core/assoc :errors (deser-user-stack-association-error-list (clojure.core/get-in letvar1445126 ["errors"])))))))

(clojure.core/defn- response-delete-image-permissions-result ([input] (response-delete-image-permissions-result nil input)) ([resultWrapper1445128 input] (clojure.core/let [rawinput1445127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445129 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-combination-exception ([input] (response-invalid-parameter-combination-exception nil input)) ([resultWrapper1445131 input] (clojure.core/let [rawinput1445130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445132 {"Message" (rawinput1445130 "Message")}] (clojure.core/cond-> {} (letvar1445132 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445132 ["Message"])))))))

(clojure.core/defn- response-update-fleet-result ([input] (response-update-fleet-result nil input)) ([resultWrapper1445134 input] (clojure.core/let [rawinput1445133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445135 {"Fleet" (rawinput1445133 "Fleet")}] (clojure.core/cond-> {} (letvar1445135 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1445135 ["Fleet"])))))))

(clojure.core/defn- response-describe-user-stack-associations-result ([input] (response-describe-user-stack-associations-result nil input)) ([resultWrapper1445137 input] (clojure.core/let [rawinput1445136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445138 {"UserStackAssociations" (rawinput1445136 "UserStackAssociations"), "NextToken" (rawinput1445136 "NextToken")}] (clojure.core/cond-> {} (letvar1445138 "UserStackAssociations") (clojure.core/assoc :user-stack-associations (deser-user-stack-association-list (clojure.core/get-in letvar1445138 ["UserStackAssociations"]))) (letvar1445138 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445138 ["NextToken"])))))))

(clojure.core/defn- response-stop-image-builder-result ([input] (response-stop-image-builder-result nil input)) ([resultWrapper1445140 input] (clojure.core/let [rawinput1445139 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445141 {"ImageBuilder" (rawinput1445139 "ImageBuilder")}] (clojure.core/cond-> {} (letvar1445141 "ImageBuilder") (clojure.core/assoc :image-builder (deser-image-builder (clojure.core/get-in letvar1445141 ["ImageBuilder"])))))))

(clojure.core/defn- response-update-stack-result ([input] (response-update-stack-result nil input)) ([resultWrapper1445143 input] (clojure.core/let [rawinput1445142 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445144 {"Stack" (rawinput1445142 "Stack")}] (clojure.core/cond-> {} (letvar1445144 "Stack") (clojure.core/assoc :stack (deser-stack (clojure.core/get-in letvar1445144 ["Stack"])))))))

(clojure.core/defn- response-create-user-result ([input] (response-create-user-result nil input)) ([resultWrapper1445146 input] (clojure.core/let [rawinput1445145 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445147 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-streaming-url-result ([input] (response-create-streaming-url-result nil input)) ([resultWrapper1445149 input] (clojure.core/let [rawinput1445148 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445150 {"StreamingURL" (rawinput1445148 "StreamingURL"), "Expires" (rawinput1445148 "Expires")}] (clojure.core/cond-> {} (letvar1445150 "StreamingURL") (clojure.core/assoc :streaming-url (deser-string (clojure.core/get-in letvar1445150 ["StreamingURL"]))) (letvar1445150 "Expires") (clojure.core/assoc :expires (deser-timestamp (clojure.core/get-in letvar1445150 ["Expires"])))))))

(clojure.core/defn- response-create-fleet-result ([input] (response-create-fleet-result nil input)) ([resultWrapper1445152 input] (clojure.core/let [rawinput1445151 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445153 {"Fleet" (rawinput1445151 "Fleet")}] (clojure.core/cond-> {} (letvar1445153 "Fleet") (clojure.core/assoc :fleet (deser-fleet (clojure.core/get-in letvar1445153 ["Fleet"])))))))

(clojure.core/defn- response-incompatible-image-exception ([input] (response-incompatible-image-exception nil input)) ([resultWrapper1445155 input] (clojure.core/let [rawinput1445154 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445156 {"Message" (rawinput1445154 "Message")}] (clojure.core/cond-> {} (letvar1445156 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445156 ["Message"])))))))

(clojure.core/defn- response-describe-users-result ([input] (response-describe-users-result nil input)) ([resultWrapper1445158 input] (clojure.core/let [rawinput1445157 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445159 {"Users" (rawinput1445157 "Users"), "NextToken" (rawinput1445157 "NextToken")}] (clojure.core/cond-> {} (letvar1445159 "Users") (clojure.core/assoc :users (deser-user-list (clojure.core/get-in letvar1445159 ["Users"]))) (letvar1445159 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445159 ["NextToken"])))))))

(clojure.core/defn- response-create-directory-config-result ([input] (response-create-directory-config-result nil input)) ([resultWrapper1445161 input] (clojure.core/let [rawinput1445160 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445162 {"DirectoryConfig" (rawinput1445160 "DirectoryConfig")}] (clojure.core/cond-> {} (letvar1445162 "DirectoryConfig") (clojure.core/assoc :directory-config (deser-directory-config (clojure.core/get-in letvar1445162 ["DirectoryConfig"])))))))

(clojure.core/defn- response-describe-stacks-result ([input] (response-describe-stacks-result nil input)) ([resultWrapper1445164 input] (clojure.core/let [rawinput1445163 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445165 {"Stacks" (rawinput1445163 "Stacks"), "NextToken" (rawinput1445163 "NextToken")}] (clojure.core/cond-> {} (letvar1445165 "Stacks") (clojure.core/assoc :stacks (deser-stack-list (clojure.core/get-in letvar1445165 ["Stacks"]))) (letvar1445165 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445165 ["NextToken"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper1445167 input] (clojure.core/let [rawinput1445166 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445168 {"Message" (rawinput1445166 "Message")}] (clojure.core/cond-> {} (letvar1445168 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1445168 ["Message"])))))))

(clojure.core/defn- response-delete-image-result ([input] (response-delete-image-result nil input)) ([resultWrapper1445170 input] (clojure.core/let [rawinput1445169 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445171 {"Image" (rawinput1445169 "Image")}] (clojure.core/cond-> {} (letvar1445171 "Image") (clojure.core/assoc :image (deser-image (clojure.core/get-in letvar1445171 ["Image"])))))))

(clojure.core/defn- response-delete-fleet-result ([input] (response-delete-fleet-result nil input)) ([resultWrapper1445173 input] (clojure.core/let [rawinput1445172 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445174 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1445176 input] (clojure.core/let [rawinput1445175 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445177 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-expire-session-result ([input] (response-expire-session-result nil input)) ([resultWrapper1445179 input] (clojure.core/let [rawinput1445178 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445180 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-copy-image-response ([input] (response-copy-image-response nil input)) ([resultWrapper1445182 input] (clojure.core/let [rawinput1445181 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445183 {"DestinationImageName" (rawinput1445181 "DestinationImageName")}] (clojure.core/cond-> {} (letvar1445183 "DestinationImageName") (clojure.core/assoc :destination-image-name (deser-name (clojure.core/get-in letvar1445183 ["DestinationImageName"])))))))

(clojure.core/defn- response-list-associated-stacks-result ([input] (response-list-associated-stacks-result nil input)) ([resultWrapper1445185 input] (clojure.core/let [rawinput1445184 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1445186 {"Names" (rawinput1445184 "Names"), "NextToken" (rawinput1445184 "NextToken")}] (clojure.core/cond-> {} (letvar1445186 "Names") (clojure.core/assoc :names (deser-string-list (clojure.core/get-in letvar1445186 ["Names"]))) (letvar1445186 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1445186 ["NextToken"])))))))

(clojure.spec.alpha/def :portkey.aws.appstream/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{L}\p{M}\p{S}\p{N}\p{P}]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/subnet-id-list (clojure.spec.alpha/coll-of :portkey.aws.appstream/string))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(^(?!aws:).[\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/region-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.appstream/stack-errors (clojure.spec.alpha/coll-of :portkey.aws.appstream/stack-error))

(clojure.spec.alpha/def :portkey.aws.appstream/domain (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 127))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/user-attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[A-Za-z0-9_\-\s]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/appstream-agent-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.appstream/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\d+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/resource-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws:[A-Za-z0-9][A-Za-z0-9_/.-]{0,62}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-Za-z0-9:_/+=,@.-]{0,1023}$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.appstream/feedback-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/account-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.appstream/long clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.appstream/streaming-url-user-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\w+=,.@-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/settings-group (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9][a-zA-Z0-9_.-]{0,100}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/organizational-unit-distinguished-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.appstream/redirect-url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
