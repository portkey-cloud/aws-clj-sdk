...
(clojure.spec.alpha/def :portkey.aws.devicefarm/update-device-pool-request (clojure.spec.alpha/keys :req-un [:portkey.aws.devicefarm.update-device-pool-request/arn] :opt-un [:portkey.aws.devicefarm.update-device-pool-request/name :portkey.aws.devicefarm.update-device-pool-request/description :portkey.aws.devicefarm.update-device-pool-request/rules]))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/url (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/vpce-configuration-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.devicefarm/double clojure.core/double?)

(clojure.spec.alpha/def :portkey.aws.devicefarm/vpce-configuration-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/filter (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/run (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.devicefarm.run/message :portkey.aws.devicefarm.run/created :portkey.aws.devicefarm.run/skip-app-resign :portkey.aws.devicefarm.run/network-profile :portkey.aws.devicefarm.run/started :portkey.aws.devicefarm.run/parsing-result-url :portkey.aws.devicefarm.run/arn :portkey.aws.devicefarm.run/app-upload :portkey.aws.devicefarm.run/result-code :portkey.aws.devicefarm.run/job-timeout-minutes :portkey.aws.devicefarm.run/completed-jobs :portkey.aws.devicefarm.run/customer-artifact-paths :portkey.aws.devicefarm.run/counters :portkey.aws.devicefarm.run/name :portkey.aws.devicefarm.run/locale :portkey.aws.devicefarm.run/location :portkey.aws.devicefarm.run/seed :portkey.aws.devicefarm.run/radios :portkey.aws.devicefarm.run/status :portkey.aws.devicefarm.run/event-count :portkey.aws.devicefarm.run/stopped :portkey.aws.devicefarm.run/type :portkey.aws.devicefarm.run/device-pool-arn :portkey.aws.devicefarm.run/billing-method :portkey.aws.devicefarm.run/test-spec-arn :portkey.aws.devicefarm.run/platform :portkey.aws.devicefarm.run/device-minutes :portkey.aws.devicefarm.run/web-url :portkey.aws.devicefarm.run/total-jobs :portkey.aws.devicefarm.run/result]))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/vpce-service-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/transaction-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 32 (clojure.core/count s__27965__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/schedule-run-request (clojure.spec.alpha/keys :req-un [:portkey.aws.devicefarm.schedule-run-request/project-arn :portkey.aws.devicefarm.schedule-run-request/device-pool-arn :portkey.aws.devicefarm.schedule-run-request/test] :opt-un [:portkey.aws.devicefarm.schedule-run-request/app-arn :portkey.aws.devicefarm.schedule-run-request/name :portkey.aws.devicefarm.schedule-run-request/configuration :portkey.aws.devicefarm.schedule-run-request/execution-configuration]))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/create-device-pool-request (clojure.spec.alpha/keys :req-un [:portkey.aws.devicefarm.create-device-pool-request/project-arn :portkey.aws.devicefarm.create-device-pool-request/name :portkey.aws.devicefarm.create-device-pool-request/rules] :opt-un [:portkey.aws.devicefarm.create-device-pool-request/description]))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/host-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/ssh-public-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/amazon-resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 32 (clojure.core/count s__27965__auto__)))))

(clojure.spec.alpha/def :portkey.aws.devicefarm/rule-operator #{"NOT_IN" "GREATER_THAN" :less-than :contains "CONTAINS" :greater-than "LESS_THAN" :equals :not-in "EQUALS" "IN" :in})
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/offering-promotion-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 4 (clojure.core/count s__27965__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 4 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/offering-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 32 (clojure.core/count s__27965__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 16384))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/aws-account-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 2 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 16))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/service-dns-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/device-pool (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.devicefarm.device-pool/arn :portkey.aws.devicefarm.device-pool/name :portkey.aws.devicefarm.device-pool/description :portkey.aws.devicefarm.device-pool/type :portkey.aws.devicefarm.device-pool/rules]))

(clojure.spec.alpha/def :portkey.aws.devicefarm/client-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/metadata (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/list-devices-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.devicefarm.list-devices-request/arn :portkey.aws.devicefarm.list-devices-request/next-token]))
...
(clojure.spec.alpha/def :portkey.aws.devicefarm/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27965__auto__] (clojure.core/<= 0 (clojure.core/count s__27965__auto__))) (clojure.core/fn [s__27966__auto__] (clojure.core/< (clojure.core/count s__27966__auto__) 256))))
...
(clojure.core/defn list-suites ([list-suites-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-suites-request list-suites-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-suites-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-suites-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListSuites", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-device ([get-device-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-device-request get-device-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-device-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-device-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDevice", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-vpce-configuration ([update-vpce-configuration-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-vpce-configuration-request update-vpce-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-vpce-configuration-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-vpce-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateVPCEConfiguration", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception, "InvalidOperationException" :portkey.aws.devicefarm/invalid-operation-exception}})))))
...
(clojure.core/defn delete-upload ([delete-upload-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-upload-request delete-upload-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-upload-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-upload-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteUpload", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-device-pool ([create-device-pool-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-device-pool-request create-device-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-device-pool-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-device-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateDevicePool", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-instance-profile ([delete-instance-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-instance-profile-request delete-instance-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-instance-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-instance-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteInstanceProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-projects ([] (list-projects {})) ([list-projects-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-projects-request list-projects-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-projects-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-projects-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListProjects", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-account-settings ([] (get-account-settings {})) ([get-account-settings-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-account-settings-request get-account-settings-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-account-settings-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-account-settings-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetAccountSettings", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn stop-remote-access-session ([stop-remote-access-session-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-stop-remote-access-session-request stop-remote-access-session-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/stop-remote-access-session-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/stop-remote-access-session-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "StopRemoteAccessSession", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-device-pool ([delete-device-pool-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-device-pool-request delete-device-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-device-pool-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-device-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteDevicePool", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-project ([update-project-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-project-request update-project-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-project-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-project-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateProject", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn renew-offering ([] (renew-offering {})) ([renew-offering-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-renew-offering-request renew-offering-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/renew-offering-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/renew-offering-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "RenewOffering", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-vpce-configuration ([create-vpce-configuration-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-vpce-configuration-request create-vpce-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-vpce-configuration-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-vpce-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateVPCEConfiguration", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-network-profile ([create-network-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-network-profile-request create-network-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-network-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-network-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateNetworkProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-instance-profile ([create-instance-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-instance-profile-request create-instance-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-instance-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-instance-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateInstanceProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-offering-transactions ([] (list-offering-transactions {})) ([list-offering-transactions-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-offering-transactions-request list-offering-transactions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-offering-transactions-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-offering-transactions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListOfferingTransactions", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-tests ([list-tests-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-tests-request list-tests-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-tests-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-tests-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListTests", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-test ([get-test-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-test-request get-test-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-test-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-test-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetTest", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn schedule-run ([schedule-run-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-schedule-run-request schedule-run-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/schedule-run-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/schedule-run-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ScheduleRun", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "IdempotencyException" :portkey.aws.devicefarm/idempotency-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-samples ([list-samples-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-samples-request list-samples-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-samples-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-samples-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListSamples", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-network-profile ([update-network-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-network-profile-request update-network-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-network-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-network-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateNetworkProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-upload ([create-upload-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-upload-request create-upload-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-upload-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-upload-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateUpload", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-remote-access-session ([delete-remote-access-session-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-remote-access-session-request delete-remote-access-session-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-remote-access-session-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-remote-access-session-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteRemoteAccessSession", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-device-instance ([get-device-instance-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-device-instance-request get-device-instance-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-device-instance-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-device-instance-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDeviceInstance", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-remote-access-sessions ([list-remote-access-sessions-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-remote-access-sessions-request list-remote-access-sessions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-remote-access-sessions-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-remote-access-sessions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListRemoteAccessSessions", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-offering-promotions ([] (list-offering-promotions {})) ([list-offering-promotions-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-offering-promotions-request list-offering-promotions-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-offering-promotions-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-offering-promotions-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListOfferingPromotions", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-device-pool ([update-device-pool-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-device-pool-request update-device-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-device-pool-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-device-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDevicePool", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn stop-run ([stop-run-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-stop-run-request stop-run-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/stop-run-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/stop-run-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "StopRun", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-device-instance ([update-device-instance-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-device-instance-request update-device-instance-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-device-instance-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-device-instance-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDeviceInstance", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-offering-status ([] (get-offering-status {})) ([get-offering-status-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-offering-status-request get-offering-status-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-offering-status-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-offering-status-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetOfferingStatus", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-uploads ([list-uploads-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-uploads-request list-uploads-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-uploads-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-uploads-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListUploads", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn update-upload ([update-upload-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-upload-request update-upload-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-upload-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-upload-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateUpload", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-devices ([] (list-devices {})) ([list-devices-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-devices-request list-devices-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-devices-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-devices-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListDevices", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-suite ([get-suite-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-suite-request get-suite-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-suite-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-suite-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetSuite", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn stop-job ([stop-job-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-stop-job-request stop-job-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/stop-job-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/stop-job-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "StopJob", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-project ([delete-project-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-project-request delete-project-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-project-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-project-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteProject", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-vpce-configuration ([delete-vpce-configuration-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-vpce-configuration-request delete-vpce-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-vpce-configuration-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-vpce-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteVPCEConfiguration", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception, "InvalidOperationException" :portkey.aws.devicefarm/invalid-operation-exception}})))))
...
(clojure.core/defn update-instance-profile ([update-instance-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-update-instance-profile-request update-instance-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/update-instance-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/update-instance-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateInstanceProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-device-pools ([list-device-pools-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-device-pools-request list-device-pools-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-device-pools-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-device-pools-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListDevicePools", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-project ([get-project-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-project-request get-project-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-project-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-project-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetProject", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-network-profile ([delete-network-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-network-profile-request delete-network-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-network-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-network-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteNetworkProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-job ([get-job-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-job-request get-job-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-job-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-job-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetJob", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-device-pool ([get-device-pool-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-device-pool-request get-device-pool-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-device-pool-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-device-pool-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDevicePool", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn delete-run ([delete-run-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-delete-run-request delete-run-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/delete-run-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/delete-run-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "DeleteRun", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn purchase-offering ([] (purchase-offering {})) ([purchase-offering-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-purchase-offering-request purchase-offering-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/purchase-offering-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/purchase-offering-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "PurchaseOffering", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-offerings ([] (list-offerings {})) ([list-offerings-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-offerings-request list-offerings-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-offerings-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-offerings-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListOfferings", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "NotEligibleException" :portkey.aws.devicefarm/not-eligible-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-vpce-configuration ([get-vpce-configuration-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-vpce-configuration-request get-vpce-configuration-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-vpce-configuration-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-vpce-configuration-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetVPCEConfiguration", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-vpce-configurations ([] (list-vpce-configurations {})) ([list-vpce-configurations-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-vpce-configurations-request list-vpce-configurations-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-vpce-configurations-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-vpce-configurations-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListVPCEConfigurations", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-network-profile ([get-network-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-network-profile-request get-network-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-network-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-network-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetNetworkProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-upload ([get-upload-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-upload-request get-upload-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-upload-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-upload-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetUpload", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-instance-profile ([get-instance-profile-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-instance-profile-request get-instance-profile-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-instance-profile-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-instance-profile-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetInstanceProfile", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-run ([get-run-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-run-request get-run-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-run-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-run-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetRun", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn get-remote-access-session ([get-remote-access-session-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-remote-access-session-request get-remote-access-session-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/get-remote-access-session-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/get-remote-access-session-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetRemoteAccessSession", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn create-project ([create-project-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-create-project-request create-project-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/create-project-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/create-project-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "CreateProject", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
...
(clojure.core/defn list-jobs ([list-jobs-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-list-jobs-request list-jobs-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.devicefarm/endpoints, :http.request.spec/output-spec :portkey.aws.devicefarm/list-jobs-result, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2015-06-23", :http.request.configuration/service-id "Device Farm", :http.request.spec/input-spec :portkey.aws.devicefarm/list-jobs-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListJobs", :http.request.spec/error-spec {"ArgumentException" :portkey.aws.devicefarm/argument-exception, "NotFoundException" :portkey.aws.devicefarm/not-found-exception, "LimitExceededException" :portkey.aws.devicefarm/limit-exceeded-exception, "ServiceAccountException" :portkey.aws.devicefarm/service-account-exception}})))))
