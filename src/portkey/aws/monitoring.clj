...
(clojure.core/defn req<-delete-dashboards-input [action-name61415 input61414] {:body {"DashboardNames" (ser-dashboard-names (input61414 :dashboard-names)), "Version" "2010-08-01", "Action" action-name61415}})
(clojure.core/defn req<-delete-alarms-input [action-name61417 input61416] {:body {"AlarmNames" (ser-alarm-names (input61416 :alarm-names)), "Version" "2010-08-01", "Action" action-name61417}})
(clojure.core/defn req<-describe-alarms-input [action-name61419 input61418] (clojure.core/cond-> {:body {"Version" "2010-08-01", "Action" action-name61419}} (clojure.core/contains? input61418 :alarm-names) (clojure.core/assoc-in [:body "AlarmNames"] (ser-alarm-names (input61418 :alarm-names))) (clojure.core/contains? input61418 :alarm-name-prefix) (clojure.core/assoc-in [:body "AlarmNamePrefix"] (ser-alarm-name-prefix (input61418 :alarm-name-prefix))) (clojure.core/contains? input61418 :state-value) (clojure.core/assoc-in [:body "StateValue"] (ser-state-value (input61418 :state-value))) (clojure.core/contains? input61418 :action-prefix) (clojure.core/assoc-in [:body "ActionPrefix"] (ser-action-prefix (input61418 :action-prefix))) (clojure.core/contains? input61418 :max-records) (clojure.core/assoc-in [:body "MaxRecords"] (ser-max-records (input61418 :max-records))) (clojure.core/contains? input61418 :next-token) (clojure.core/assoc-in [:body "NextToken"] (ser-next-token (input61418 :next-token)))))
(clojure.core/defn req<-get-metric-statistics-input [action-name61421 input61420] (clojure.core/let [input61422 {:body {"EndTime" (ser-timestamp (input61420 :end-time)), "Period" (ser-period (input61420 :period)), "StartTime" (ser-timestamp (input61420 :start-time)), "Namespace" (ser-namespace (input61420 :namespace)), "MetricName" (ser-metric-name (input61420 :metric-name)), "Version" "2010-08-01", "Action" action-name61421}}] (clojure.core/cond-> input61422 (clojure.core/contains? input61420 :unit) (clojure.core/assoc-in [:body "Unit"] (ser-standard-unit (input61420 :unit))) (clojure.core/contains? input61420 :extended-statistics) (clojure.core/assoc-in [:body "ExtendedStatistics"] (ser-extended-statistics (input61420 :extended-statistics))) (clojure.core/contains? input61420 :dimensions) (clojure.core/assoc-in [:body "Dimensions"] (ser-dimensions (input61420 :dimensions))) (clojure.core/contains? input61420 :statistics) (clojure.core/assoc-in [:body "Statistics"] (ser-statistics (input61420 :statistics))))))
(clojure.core/defn req<-list-dashboards-input [action-name61424 input61423] (clojure.core/cond-> {:body {"Version" "2010-08-01", "Action" action-name61424}} (clojure.core/contains? input61423 :dashboard-name-prefix) (clojure.core/assoc-in [:body "DashboardNamePrefix"] (ser-dashboard-name-prefix (input61423 :dashboard-name-prefix))) (clojure.core/contains? input61423 :next-token) (clojure.core/assoc-in [:body "NextToken"] (ser-next-token (input61423 :next-token)))))
(clojure.core/defn req<-put-dashboard-input [action-name61426 input61425] {:body {"DashboardName" (ser-dashboard-name (input61425 :dashboard-name)), "DashboardBody" (ser-dashboard-body (input61425 :dashboard-body)), "Version" "2010-08-01", "Action" action-name61426}})
(clojure.core/defn req<-enable-alarm-actions-input [action-name61428 input61427] {:body {"AlarmNames" (ser-alarm-names (input61427 :alarm-names)), "Version" "2010-08-01", "Action" action-name61428}})
(clojure.core/defn req<-list-metrics-input [action-name61430 input61429] (clojure.core/cond-> {:body {"Version" "2010-08-01", "Action" action-name61430}} (clojure.core/contains? input61429 :namespace) (clojure.core/assoc-in [:body "Namespace"] (ser-namespace (input61429 :namespace))) (clojure.core/contains? input61429 :metric-name) (clojure.core/assoc-in [:body "MetricName"] (ser-metric-name (input61429 :metric-name))) (clojure.core/contains? input61429 :dimensions) (clojure.core/assoc-in [:body "Dimensions"] (ser-dimension-filters (input61429 :dimensions))) (clojure.core/contains? input61429 :next-token) (clojure.core/assoc-in [:body "NextToken"] (ser-next-token (input61429 :next-token)))))
(clojure.core/defn req<-put-metric-data-input [action-name61432 input61431] {:body {"Namespace" (ser-namespace (input61431 :namespace)), "MetricData" (ser-metric-data (input61431 :metric-data)), "Version" "2010-08-01", "Action" action-name61432}})
(clojure.core/defn req<-describe-alarms-for-metric-input [action-name61434 input61433] (clojure.core/let [input61435 {:body {"MetricName" (ser-metric-name (input61433 :metric-name)), "Namespace" (ser-namespace (input61433 :namespace)), "Version" "2010-08-01", "Action" action-name61434}}] (clojure.core/cond-> input61435 (clojure.core/contains? input61433 :statistic) (clojure.core/assoc-in [:body "Statistic"] (ser-statistic (input61433 :statistic))) (clojure.core/contains? input61433 :extended-statistic) (clojure.core/assoc-in [:body "ExtendedStatistic"] (ser-extended-statistic (input61433 :extended-statistic))) (clojure.core/contains? input61433 :dimensions) (clojure.core/assoc-in [:body "Dimensions"] (ser-dimensions (input61433 :dimensions))) (clojure.core/contains? input61433 :period) (clojure.core/assoc-in [:body "Period"] (ser-period (input61433 :period))) (clojure.core/contains? input61433 :unit) (clojure.core/assoc-in [:body "Unit"] (ser-standard-unit (input61433 :unit))))))
(clojure.core/defn req<-set-alarm-state-input [action-name61437 input61436] (clojure.core/let [input61438 {:body {"AlarmName" (ser-alarm-name (input61436 :alarm-name)), "StateValue" (ser-state-value (input61436 :state-value)), "StateReason" (ser-state-reason (input61436 :state-reason)), "Version" "2010-08-01", "Action" action-name61437}}] (clojure.core/cond-> input61438 (clojure.core/contains? input61436 :state-reason-data) (clojure.core/assoc-in [:body "StateReasonData"] (ser-state-reason-data (input61436 :state-reason-data))))))
(clojure.core/defn req<-put-metric-alarm-input [action-name61440 input61439] (clojure.core/let [input61441 {:body {"Period" (ser-period (input61439 :period)), "Threshold" (ser-threshold (input61439 :threshold)), "ComparisonOperator" (ser-comparison-operator (input61439 :comparison-operator)), "Namespace" (ser-namespace (input61439 :namespace)), "AlarmName" (ser-alarm-name (input61439 :alarm-name)), "MetricName" (ser-metric-name (input61439 :metric-name)), "EvaluationPeriods" (ser-evaluation-periods (input61439 :evaluation-periods)), "Version" "2010-08-01", "Action" action-name61440}}] (clojure.core/cond-> input61441 (clojure.core/contains? input61439 :unit) (clojure.core/assoc-in [:body "Unit"] (ser-standard-unit (input61439 :unit))) (clojure.core/contains? input61439 :treat-missing-data) (clojure.core/assoc-in [:body "TreatMissingData"] (ser-treat-missing-data (input61439 :treat-missing-data))) (clojure.core/contains? input61439 :okactions) (clojure.core/assoc-in [:body "OKActions"] (ser-resource-list (input61439 :okactions))) (clojure.core/contains? input61439 :insufficient-data-actions) (clojure.core/assoc-in [:body "InsufficientDataActions"] (ser-resource-list (input61439 :insufficient-data-actions))) (clojure.core/contains? input61439 :dimensions) (clojure.core/assoc-in [:body "Dimensions"] (ser-dimensions (input61439 :dimensions))) (clojure.core/contains? input61439 :datapoints-to-alarm) (clojure.core/assoc-in [:body "DatapointsToAlarm"] (ser-datapoints-to-alarm (input61439 :datapoints-to-alarm))) (clojure.core/contains? input61439 :alarm-actions) (clojure.core/assoc-in [:body "AlarmActions"] (ser-resource-list (input61439 :alarm-actions))) (clojure.core/contains? input61439 :evaluate-low-sample-count-percentile) (clojure.core/assoc-in [:body "EvaluateLowSampleCountPercentile"] (ser-evaluate-low-sample-count-percentile (input61439 :evaluate-low-sample-count-percentile))) (clojure.core/contains? input61439 :alarm-description) (clojure.core/assoc-in [:body "AlarmDescription"] (ser-alarm-description (input61439 :alarm-description))) (clojure.core/contains? input61439 :extended-statistic) (clojure.core/assoc-in [:body "ExtendedStatistic"] (ser-extended-statistic (input61439 :extended-statistic))) (clojure.core/contains? input61439 :statistic) (clojure.core/assoc-in [:body "Statistic"] (ser-statistic (input61439 :statistic))) (clojure.core/contains? input61439 :actions-enabled) (clojure.core/assoc-in [:body "ActionsEnabled"] (ser-actions-enabled (input61439 :actions-enabled))))))
(clojure.core/defn req<-get-dashboard-input [action-name61443 input61442] {:body {"DashboardName" (ser-dashboard-name (input61442 :dashboard-name)), "Version" "2010-08-01", "Action" action-name61443}})
(clojure.core/defn req<-get-metric-data-input [action-name61445 input61444] (clojure.core/let [input61446 {:body {"MetricDataQueries" (ser-metric-data-queries (input61444 :metric-data-queries)), "StartTime" (ser-timestamp (input61444 :start-time)), "EndTime" (ser-timestamp (input61444 :end-time)), "Version" "2010-08-01", "Action" action-name61445}}] (clojure.core/cond-> input61446 (clojure.core/contains? input61444 :next-token) (clojure.core/assoc-in [:body "NextToken"] (ser-next-token (input61444 :next-token))) (clojure.core/contains? input61444 :scan-by) (clojure.core/assoc-in [:body "ScanBy"] (ser-scan-by (input61444 :scan-by))) (clojure.core/contains? input61444 :max-datapoints) (clojure.core/assoc-in [:body "MaxDatapoints"] (ser-get-metric-data-max-datapoints (input61444 :max-datapoints))))))
(clojure.core/defn req<-disable-alarm-actions-input [action-name61448 input61447] {:body {"AlarmNames" (ser-alarm-names (input61447 :alarm-names)), "Version" "2010-08-01", "Action" action-name61448}})
(clojure.core/defn req<-describe-alarm-history-input [action-name61450 input61449] (clojure.core/cond-> {:body {"Version" "2010-08-01", "Action" action-name61450}} (clojure.core/contains? input61449 :alarm-name) (clojure.core/assoc-in [:body "AlarmName"] (ser-alarm-name (input61449 :alarm-name))) (clojure.core/contains? input61449 :history-item-type) (clojure.core/assoc-in [:body "HistoryItemType"] (ser-history-item-type (input61449 :history-item-type))) (clojure.core/contains? input61449 :start-date) (clojure.core/assoc-in [:body "StartDate"] (ser-timestamp (input61449 :start-date))) (clojure.core/contains? input61449 :end-date) (clojure.core/assoc-in [:body "EndDate"] (ser-timestamp (input61449 :end-date))) (clojure.core/contains? input61449 :max-records) (clojure.core/assoc-in [:body "MaxRecords"] (ser-max-records (input61449 :max-records))) (clojure.core/contains? input61449 :next-token) (clojure.core/assoc-in [:body "NextToken"] (ser-next-token (input61449 :next-token)))))

(clojure.spec.alpha/def :portkey.aws.monitoring/standard-unit {:kilobytes/second "Kilobytes/Second", :megabits "Megabits", "Terabytes" "Terabytes", :kilobits/second "Kilobits/Second", :bits/second "Bits/Second", :terabits/second "Terabits/Second", :kilobits "Kilobits", "Kilobits/Second" "Kilobits/Second", :gigabits/second "Gigabits/Second", "Count" "Count", "Bits" "Bits", "Percent" "Percent", "Gigabits/Second" "Gigabits/Second", :terabytes "Terabytes", :megabytes/second "Megabytes/Second", "None" "None", :seconds "Seconds", :megabits/second "Megabits/Second", :bits "Bits", :terabits "Terabits", :kilobytes "Kilobytes", :microseconds "Microseconds", "Count/Second" "Count/Second", "Bytes" "Bytes", "Gigabytes/Second" "Gigabytes/Second", "Megabits/Second" "Megabits/Second", :gigabits "Gigabits", "Kilobytes/Second" "Kilobytes/Second", :megabytes "Megabytes", "Terabytes/Second" "Terabytes/Second", "Bits/Second" "Bits/Second", "Bytes/Second" "Bytes/Second", "Milliseconds" "Milliseconds", :count "Count", "Kilobytes" "Kilobytes", :bytes "Bytes", :milliseconds "Milliseconds", "Microseconds" "Microseconds", :percent "Percent", "Terabits" "Terabits", :count/second "Count/Second", :gigabytes/second "Gigabytes/Second", :gigabytes "Gigabytes", "Megabytes/Second" "Megabytes/Second", "Gigabytes" "Gigabytes", "Gigabits" "Gigabits", "Megabits" "Megabits", :none "None", "Kilobits" "Kilobits", "Terabits/Second" "Terabits/Second", "Megabytes" "Megabytes", "Seconds" "Seconds", :terabytes/second "Terabytes/Second", :bytes/second "Bytes/Second"})

(clojure.spec.alpha/def :portkey.aws.monitoring/storage-resolution (clojure.spec.alpha/int-in 1 Long/MAX_VALUE))

(clojure.spec.alpha/def :portkey.aws.monitoring/dimension-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/get-metric-data-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/MetricDataQueries :portkey.aws.monitoring.get-metric-data-input/StartTime :portkey.aws.monitoring.get-metric-data-input/EndTime] :opt-un [:portkey.aws.monitoring/NextToken :portkey.aws.monitoring/ScanBy :portkey.aws.monitoring.get-metric-data-input/MaxDatapoints] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/treat-missing-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/history-item-type {"ConfigurationUpdate" "ConfigurationUpdate", :configuration-update "ConfigurationUpdate", "StateUpdate" "StateUpdate", :state-update "StateUpdate", "Action" "Action", :action "Action"})
...
(clojure.spec.alpha/def :portkey.aws.monitoring/message-data (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.message-data/Code :portkey.aws.monitoring.message-data/Value] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/missing-required-parameter-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.missing-required-parameter-exception/message] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/set-alarm-state-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/AlarmName :portkey.aws.monitoring/StateValue :portkey.aws.monitoring/StateReason] :opt-un [:portkey.aws.monitoring/StateReasonData] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/status-code {"Complete" "Complete", :complete "Complete", "InternalError" "InternalError", :internal-error "InternalError", "PartialData" "PartialData", :partial-data "PartialData"})
...
(clojure.spec.alpha/def :portkey.aws.monitoring/dimension-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarms-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/MetricAlarms :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/put-metric-data-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/Namespace :portkey.aws.monitoring/MetricData] :opt-un [] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/disable-alarm-actions-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/AlarmNames] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/metric-stat (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/Metric :portkey.aws.monitoring/Period :portkey.aws.monitoring/Stat] :opt-un [:portkey.aws.monitoring.metric-stat/Unit] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarms-input (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/AlarmNames :portkey.aws.monitoring/AlarmNamePrefix :portkey.aws.monitoring/StateValue :portkey.aws.monitoring/ActionPrefix :portkey.aws.monitoring/MaxRecords :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/state-value {"OK" "OK", :ok "OK", "ALARM" "ALARM", :alarm "ALARM", "INSUFFICIENT_DATA" "INSUFFICIENT_DATA", :insufficient-data "INSUFFICIENT_DATA"})

(clojure.spec.alpha/def :portkey.aws.monitoring/get-metric-data-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/MetricDataResults :portkey.aws.monitoring/NextToken] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/list-metrics-input (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/Namespace :portkey.aws.monitoring/MetricName :portkey.aws.monitoring.list-metrics-input/Dimensions :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/put-dashboard-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DashboardValidationMessages] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/dimension (portkey.aws/json-keys :req-un [:portkey.aws.monitoring.dimension/Name :portkey.aws.monitoring.dimension/Value] :opt-un [] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/comparison-operator {"GreaterThanOrEqualToThreshold" "GreaterThanOrEqualToThreshold", :greater-than-or-equal-to-threshold "GreaterThanOrEqualToThreshold", "GreaterThanThreshold" "GreaterThanThreshold", :greater-than-threshold "GreaterThanThreshold", "LessThanThreshold" "LessThanThreshold", :less-than-threshold "LessThanThreshold", "LessThanOrEqualToThreshold" "LessThanOrEqualToThreshold", :less-than-or-equal-to-threshold "LessThanOrEqualToThreshold"})

(clojure.spec.alpha/def :portkey.aws.monitoring/dashboard-arn (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.monitoring/history-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 4095))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/get-metric-statistics-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.get-metric-statistics-output/Label :portkey.aws.monitoring/Datapoints] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/get-metric-statistics-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/Namespace :portkey.aws.monitoring/MetricName :portkey.aws.monitoring.get-metric-statistics-input/StartTime :portkey.aws.monitoring.get-metric-statistics-input/EndTime :portkey.aws.monitoring/Period] :opt-un [:portkey.aws.monitoring.get-metric-statistics-input/Unit :portkey.aws.monitoring/ExtendedStatistics :portkey.aws.monitoring/Dimensions :portkey.aws.monitoring/Statistics] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/datapoint (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/Timestamp :portkey.aws.monitoring.datapoint/SampleCount :portkey.aws.monitoring.datapoint/Average :portkey.aws.monitoring.datapoint/Sum :portkey.aws.monitoring.datapoint/Minimum :portkey.aws.monitoring.datapoint/Maximum :portkey.aws.monitoring.datapoint/Unit :portkey.aws.monitoring.datapoint/ExtendedStatistics] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/metric-data-result (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.metric-data-result/Id :portkey.aws.monitoring.metric-data-result/Label :portkey.aws.monitoring/Timestamps :portkey.aws.monitoring.metric-data-result/Values :portkey.aws.monitoring/StatusCode :portkey.aws.monitoring.metric-data-result/Messages] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/alarm-name-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 0 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.monitoring/error-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/delete-dashboards-output (portkey.aws/json-keys :req-un [] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/internal-service-fault (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.internal-service-fault/Message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/dashboard-validation-message (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DataPath :portkey.aws.monitoring/Message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/dashboard-entry (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DashboardName :portkey.aws.monitoring/DashboardArn :portkey.aws.monitoring/LastModified :portkey.aws.monitoring/Size] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/dashboard-not-found-error (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.dashboard-not-found-error/message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarms-for-metric-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/MetricAlarms] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/history-summary (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/state-reason-data (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 0 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring.metric-alarm/okactions (clojure.spec.alpha/and :portkey.aws.monitoring/resource-list))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/metric-alarm (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.metric-alarm/Unit :portkey.aws.monitoring/TreatMissingData :portkey.aws.monitoring/Period :portkey.aws.monitoring/Threshold :portkey.aws.monitoring.metric-alarm/OKActions :portkey.aws.monitoring/StateValue :portkey.aws.monitoring.metric-alarm/StateUpdatedTimestamp :portkey.aws.monitoring.metric-alarm/InsufficientDataActions :portkey.aws.monitoring/ComparisonOperator :portkey.aws.monitoring/StateReasonData :portkey.aws.monitoring/Dimensions :portkey.aws.monitoring/DatapointsToAlarm :portkey.aws.monitoring/Namespace :portkey.aws.monitoring.metric-alarm/AlarmActions :portkey.aws.monitoring/EvaluateLowSampleCountPercentile :portkey.aws.monitoring/AlarmDescription :portkey.aws.monitoring/AlarmName :portkey.aws.monitoring/ExtendedStatistic :portkey.aws.monitoring/MetricName :portkey.aws.monitoring/AlarmArn :portkey.aws.monitoring.metric-alarm/AlarmConfigurationUpdatedTimestamp :portkey.aws.monitoring/EvaluationPeriods :portkey.aws.monitoring/StateReason :portkey.aws.monitoring/Statistic :portkey.aws.monitoring/ActionsEnabled] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/delete-dashboards-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/DashboardNames] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/limit-exceeded-fault (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.limit-exceeded-fault/message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/alarm-history-item (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/AlarmName :portkey.aws.monitoring/Timestamp :portkey.aws.monitoring/HistoryItemType :portkey.aws.monitoring/HistorySummary :portkey.aws.monitoring/HistoryData] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/get-dashboard-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/DashboardName] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/dashboard-invalid-input-error (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.dashboard-invalid-input-error/message :portkey.aws.monitoring.dashboard-invalid-input-error/dashboardValidationMessages] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255)) (clojure.core/fn [s__36228__auto__] (clojure.core/re-matches #"[^:].*" s__36228__auto__))))

(clojure.spec.alpha/def :portkey.aws.monitoring/put-dashboard-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/DashboardName :portkey.aws.monitoring/DashboardBody] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/statistic-set (portkey.aws/json-keys :req-un [:portkey.aws.monitoring.statistic-set/SampleCount :portkey.aws.monitoring.statistic-set/Sum :portkey.aws.monitoring.statistic-set/Minimum :portkey.aws.monitoring.statistic-set/Maximum] :opt-un [] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/action-prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.monitoring/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.monitoring/get-dashboard-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DashboardArn :portkey.aws.monitoring/DashboardBody :portkey.aws.monitoring/DashboardName] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring.put-metric-alarm-input/okactions (clojure.spec.alpha/and :portkey.aws.monitoring/resource-list))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/put-metric-alarm-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/AlarmName :portkey.aws.monitoring/MetricName :portkey.aws.monitoring/Namespace :portkey.aws.monitoring/Period :portkey.aws.monitoring/EvaluationPeriods :portkey.aws.monitoring/Threshold :portkey.aws.monitoring/ComparisonOperator] :opt-un [:portkey.aws.monitoring.put-metric-alarm-input/Unit :portkey.aws.monitoring/TreatMissingData :portkey.aws.monitoring.put-metric-alarm-input/OKActions :portkey.aws.monitoring.put-metric-alarm-input/InsufficientDataActions :portkey.aws.monitoring/Dimensions :portkey.aws.monitoring/DatapointsToAlarm :portkey.aws.monitoring.put-metric-alarm-input/AlarmActions :portkey.aws.monitoring/EvaluateLowSampleCountPercentile :portkey.aws.monitoring/AlarmDescription :portkey.aws.monitoring/ExtendedStatistic :portkey.aws.monitoring/Statistic :portkey.aws.monitoring/ActionsEnabled] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarm-history-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/AlarmHistoryItems :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/size clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.monitoring/evaluate-low-sample-count-percentile (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/return-data clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.monitoring/enable-alarm-actions-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/AlarmNames] :opt-un [] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/alarm-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 0 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.monitoring/metric-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/alarm-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.monitoring/metric (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/Namespace :portkey.aws.monitoring/MetricName :portkey.aws.monitoring/Dimensions] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/dimension-filter (portkey.aws/json-keys :req-un [:portkey.aws.monitoring.dimension-filter/Name] :opt-un [:portkey.aws.monitoring.dimension-filter/Value] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/invalid-parameter-combination-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.invalid-parameter-combination-exception/message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/extended-statistic (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36228__auto__] (clojure.core/re-matches #"p(\d{1,2}(\.\d{0,2})?|100)" s__36228__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/metric-datum (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/MetricName] :opt-un [:portkey.aws.monitoring/Dimensions :portkey.aws.monitoring/Timestamp :portkey.aws.monitoring.metric-datum/Value :portkey.aws.monitoring.metric-datum/StatisticValues :portkey.aws.monitoring.metric-datum/Unit :portkey.aws.monitoring/StorageResolution] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/metric-data-query (portkey.aws/json-keys :req-un [:portkey.aws.monitoring.metric-data-query/Id] :opt-un [:portkey.aws.monitoring/MetricStat :portkey.aws.monitoring.metric-data-query/Expression :portkey.aws.monitoring.metric-data-query/Label :portkey.aws.monitoring/ReturnData] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarms-for-metric-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/MetricName :portkey.aws.monitoring/Namespace] :opt-un [:portkey.aws.monitoring/Statistic :portkey.aws.monitoring/ExtendedStatistic :portkey.aws.monitoring/Dimensions :portkey.aws.monitoring/Period :portkey.aws.monitoring.describe-alarms-for-metric-input/Unit] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/list-dashboards-input (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DashboardNamePrefix :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/list-dashboards-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/DashboardEntries :portkey.aws.monitoring/NextToken] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/invalid-format-fault (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.invalid-format-fault/message] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/alarm-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1600))))

(clojure.spec.alpha/def :portkey.aws.monitoring/delete-alarms-input (portkey.aws/json-keys :req-un [:portkey.aws.monitoring/AlarmNames] :opt-un [] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/resource-not-found (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.resource-not-found/message] :locations {}))

(clojure.spec.alpha/def :portkey.aws.monitoring/metric-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 1 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/invalid-parameter-value-exception (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.invalid-parameter-value-exception/message] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/state-reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__36226__auto__] (clojure.core/<= 0 (clojure.core/count s__36226__auto__))) (clojure.core/fn [s__36227__auto__] (clojure.core/< (clojure.core/count s__36227__auto__) 1023))))

(clojure.spec.alpha/def :portkey.aws.monitoring/scan-by {"TimestampDescending" "TimestampDescending", :timestamp-descending "TimestampDescending", "TimestampAscending" "TimestampAscending", :timestamp-ascending "TimestampAscending"})

(clojure.spec.alpha/def :portkey.aws.monitoring/statistic {"Sum" "Sum", "Average" "Average", :maximum "Maximum", "SampleCount" "SampleCount", "Minimum" "Minimum", :sample-count "SampleCount", :minimum "Minimum", :average "Average", :sum "Sum", "Maximum" "Maximum"})

(clojure.spec.alpha/def :portkey.aws.monitoring/list-metrics-output (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/Metrics :portkey.aws.monitoring/NextToken] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/invalid-next-token (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring.invalid-next-token/message] :locations {}))
...
(clojure.spec.alpha/def :portkey.aws.monitoring/describe-alarm-history-input (portkey.aws/json-keys :req-un [] :opt-un [:portkey.aws.monitoring/AlarmName :portkey.aws.monitoring/HistoryItemType :portkey.aws.monitoring.describe-alarm-history-input/StartDate :portkey.aws.monitoring.describe-alarm-history-input/EndDate :portkey.aws.monitoring/MaxRecords :portkey.aws.monitoring/NextToken] :locations {}))
...
(clojure.core/defn delete-alarms "Deletes the specified alarms. In the event of an error, no alarms are deleted." ([delete-alarms-input] (clojure.core/let [req<-input__36755__auto__ (req<-delete-alarms-input "DeleteAlarms" delete-alarms-input)] (portkey.aws/-query-call portkey.aws.monitoring/endpoints "POST" "/" req<-input__36755__auto__ :portkey.aws.monitoring/delete-alarms-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil nil {"ResourceNotFound" :portkey.aws.monitoring/resource-not-found}))))
...
(clojure.core/defn enable-alarm-actions "Enables the actions for the specified alarms." ([enable-alarm-actions-input] (clojure.core/let [req<-input__36755__auto__ (req<-enable-alarm-actions-input "EnableAlarmActions" enable-alarm-actions-input)] (portkey.aws/-query-call portkey.aws.monitoring/endpoints "POST" "/" req<-input__36755__auto__ :portkey.aws.monitoring/enable-alarm-actions-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil nil {}))))
...
(clojure.core/defn describe-alarms-for-metric "Retrieves the alarms for the specified metric. To filter the results, specify a\nstatistic, period, or unit." ([describe-alarms-for-metric-input] (clojure.core/let [req<-input__36755__auto__ (req<-describe-alarms-for-metric-input "DescribeAlarmsForMetric" describe-alarms-for-metric-input)] (portkey.aws/-query-call portkey.aws.monitoring/endpoints "POST" "/" req<-input__36755__auto__ :portkey.aws.monitoring/describe-alarms-for-metric-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.monitoring/describe-alarms-for-metric-output {}))))
...
(clojure.core/defn disable-alarm-actions "Disables the actions for the specified alarms. When an alarm's actions are\ndisabled, the alarm actions do not execute when the alarm state changes." ([disable-alarm-actions-input] (clojure.core/let [req<-input__36755__auto__ (req<-disable-alarm-actions-input "DisableAlarmActions" disable-alarm-actions-input)] (portkey.aws/-query-call portkey.aws.monitoring/endpoints "POST" "/" req<-input__36755__auto__ :portkey.aws.monitoring/disable-alarm-actions-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil nil {}))))
