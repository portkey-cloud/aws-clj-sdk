...
(clojure.core/defn- response-get-products-response ([input] (response-get-products-response nil input)) ([resultWrapper1937206 input] (clojure.core/let [rawinput1937205 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937207 {"FormatVersion" (rawinput1937205 "FormatVersion"), "PriceList" (rawinput1937205 "PriceList"), "NextToken" (rawinput1937205 "NextToken")}] (clojure.core/cond-> {} (letvar1937207 "FormatVersion") (clojure.core/assoc :format-version (deser-string (clojure.core/get-in letvar1937207 ["FormatVersion"]))) (letvar1937207 "PriceList") (clojure.core/assoc :price-list (deser-price-list (clojure.core/get-in letvar1937207 ["PriceList"]))) (letvar1937207 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1937207 ["NextToken"])))))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1937209 input] (clojure.core/let [rawinput1937208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937210 {"Message" (rawinput1937208 "Message")}] (clojure.core/cond-> {} (letvar1937210 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1937210 ["Message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1937212 input] (clojure.core/let [rawinput1937211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937213 {"Message" (rawinput1937211 "Message")}] (clojure.core/cond-> {} (letvar1937213 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1937213 ["Message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1937215 input] (clojure.core/let [rawinput1937214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937216 {"Message" (rawinput1937214 "Message")}] (clojure.core/cond-> {} (letvar1937216 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1937216 ["Message"])))))))

(clojure.core/defn- response-describe-services-response ([input] (response-describe-services-response nil input)) ([resultWrapper1937218 input] (clojure.core/let [rawinput1937217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937219 {"Services" (rawinput1937217 "Services"), "FormatVersion" (rawinput1937217 "FormatVersion"), "NextToken" (rawinput1937217 "NextToken")}] (clojure.core/cond-> {} (letvar1937219 "Services") (clojure.core/assoc :services (deser-service-list (clojure.core/get-in letvar1937219 ["Services"]))) (letvar1937219 "FormatVersion") (clojure.core/assoc :format-version (deser-string (clojure.core/get-in letvar1937219 ["FormatVersion"]))) (letvar1937219 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1937219 ["NextToken"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1937221 input] (clojure.core/let [rawinput1937220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937222 {"Message" (rawinput1937220 "Message")}] (clojure.core/cond-> {} (letvar1937222 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1937222 ["Message"])))))))

(clojure.core/defn- response-get-attribute-values-response ([input] (response-get-attribute-values-response nil input)) ([resultWrapper1937224 input] (clojure.core/let [rawinput1937223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937225 {"AttributeValues" (rawinput1937223 "AttributeValues"), "NextToken" (rawinput1937223 "NextToken")}] (clojure.core/cond-> {} (letvar1937225 "AttributeValues") (clojure.core/assoc :attribute-values (deser-attribute-value-list (clojure.core/get-in letvar1937225 ["AttributeValues"]))) (letvar1937225 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1937225 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1937227 input] (clojure.core/let [rawinput1937226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1937228 {"Message" (rawinput1937226 "Message")}] (clojure.core/cond-> {} (letvar1937228 "Message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1937228 ["Message"])))))))
