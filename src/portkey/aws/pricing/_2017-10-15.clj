...
(clojure.core/defn get-attribute-values ([get-attribute-values-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-attribute-values-request get-attribute-values-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.pricing.-2017-10-15/endpoints, :http.request.spec/output-spec :portkey.aws.pricing.-2017-10-15/get-attribute-values-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-10-15", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.pricing.-2017-10-15/get-attribute-values-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetAttributeValues", :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.pricing.-2017-10-15/internal-error-exception, "InvalidParameterException" :portkey.aws.pricing.-2017-10-15/invalid-parameter-exception, "NotFoundException" :portkey.aws.pricing.-2017-10-15/not-found-exception, "InvalidNextTokenException" :portkey.aws.pricing.-2017-10-15/invalid-next-token-exception, "ExpiredNextTokenException" :portkey.aws.pricing.-2017-10-15/expired-next-token-exception}})))))
...
(clojure.core/defn get-products ([] (get-products {})) ([get-products-requestinput] (clojure.core/let [request-function-result__28606__auto__ (req-get-products-request get-products-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__28606__auto__ {:http.request.configuration/endpoints portkey.aws.pricing.-2017-10-15/endpoints, :http.request.spec/output-spec :portkey.aws.pricing.-2017-10-15/get-products-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2017-10-15", :http.request.configuration/service-id nil, :http.request.spec/input-spec :portkey.aws.pricing.-2017-10-15/get-products-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetProducts", :http.request.spec/error-spec {"InternalErrorException" :portkey.aws.pricing.-2017-10-15/internal-error-exception, "InvalidParameterException" :portkey.aws.pricing.-2017-10-15/invalid-parameter-exception, "NotFoundException" :portkey.aws.pricing.-2017-10-15/not-found-exception, "InvalidNextTokenException" :portkey.aws.pricing.-2017-10-15/invalid-next-token-exception, "ExpiredNextTokenException" :portkey.aws.pricing.-2017-10-15/expired-next-token-exception}})))))
