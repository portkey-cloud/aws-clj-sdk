...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper1526538 input] (clojure.core/let [rawinput1526537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1526539 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1526541 input] (clojure.core/let [rawinput1526540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1526542 {"message" (rawinput1526540 "message")}] (clojure.core/cond-> {} (letvar1526542 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1526542 ["message"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper1526544 input] (clojure.core/let [rawinput1526543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1526545 {"message" (rawinput1526543 "message")}] (clojure.core/cond-> {} (letvar1526545 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1526545 ["message"])))))))

(clojure.core/defn- response-service-unavailable-error ([input] (response-service-unavailable-error nil input)) ([resultWrapper1526547 input] (clojure.core/let [rawinput1526546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1526548 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-execute-sql-response ([input] (response-execute-sql-response nil input)) ([resultWrapper1526550 input] (clojure.core/let [rawinput1526549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1526551 {"sqlStatementResults" (rawinput1526549 "sqlStatementResults")}] (clojure.core/cond-> {:sql-statement-results (deser-sql-statement-results (clojure.core/get-in letvar1526551 ["sqlStatementResults"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data/db-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data/sql-statement (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 65536))))
...
(clojure.spec.alpha/def :portkey.aws.rds-data/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
