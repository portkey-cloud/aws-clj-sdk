...
(clojure.core/defn- response-missing-codec-private-data-exception ([input] (response-missing-codec-private-data-exception nil input)) ([resultWrapper1171511 input] (clojure.core/let [rawinput1171510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171512 {"Message" (rawinput1171510 "Message")}] (clojure.core/cond-> {} (letvar1171512 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171512 ["Message"])))))))

(clojure.core/defn- response-unsupported-stream-media-type-exception ([input] (response-unsupported-stream-media-type-exception nil input)) ([resultWrapper1171514 input] (clojure.core/let [rawinput1171513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171515 {"Message" (rawinput1171513 "Message")}] (clojure.core/cond-> {} (letvar1171515 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171515 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1171517 input] (clojure.core/let [rawinput1171516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171518 {"Message" (rawinput1171516 "Message")}] (clojure.core/cond-> {} (letvar1171518 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171518 ["Message"])))))))

(clojure.core/defn- response-no-data-retention-exception ([input] (response-no-data-retention-exception nil input)) ([resultWrapper1171520 input] (clojure.core/let [rawinput1171519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171521 {"Message" (rawinput1171519 "Message")}] (clojure.core/cond-> {} (letvar1171521 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171521 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1171523 input] (clojure.core/let [rawinput1171522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171524 {"Message" (rawinput1171522 "Message")}] (clojure.core/cond-> {} (letvar1171524 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171524 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper1171526 input] (clojure.core/let [rawinput1171525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171527 {"Message" (rawinput1171525 "Message")}] (clojure.core/cond-> {} (letvar1171527 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171527 ["Message"])))))))

(clojure.core/defn- response-invalid-codec-private-data-exception ([input] (response-invalid-codec-private-data-exception nil input)) ([resultWrapper1171529 input] (clojure.core/let [rawinput1171528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171530 {"Message" (rawinput1171528 "Message")}] (clojure.core/cond-> {} (letvar1171530 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171530 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1171532 input] (clojure.core/let [rawinput1171531 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171533 {"Message" (rawinput1171531 "Message")}] (clojure.core/cond-> {} (letvar1171533 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1171533 ["Message"])))))))

(clojure.core/defn- response-list-fragments-output ([input] (response-list-fragments-output nil input)) ([resultWrapper1171535 input] (clojure.core/let [rawinput1171534 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171536 {"Fragments" (rawinput1171534 "Fragments"), "NextToken" (rawinput1171534 "NextToken")}] (clojure.core/cond-> {} (letvar1171536 "Fragments") (clojure.core/assoc :fragments (deser-fragment-list (clojure.core/get-in letvar1171536 ["Fragments"]))) (letvar1171536 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1171536 ["NextToken"])))))))

(clojure.core/defn- response-get-media-for-fragment-list-output ([input] (response-get-media-for-fragment-list-output nil input)) ([resultWrapper1171538 input] (clojure.core/let [rawinput1171537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171539 {"Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "Payload" (rawinput1171537 "Payload")}] (clojure.core/cond-> {} (letvar1171539 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar1171539 ["Content-Type"]))) (letvar1171539 "Payload") (clojure.core/assoc :payload (deser-payload (clojure.core/get-in letvar1171539 ["Payload"])))))))

(clojure.core/defn- response-get-hls-streaming-session-url-output ([input] (response-get-hls-streaming-session-url-output nil input)) ([resultWrapper1171541 input] (clojure.core/let [rawinput1171540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1171542 {"HLSStreamingSessionURL" (rawinput1171540 "HLSStreamingSessionURL")}] (clojure.core/cond-> {} (letvar1171542 "HLSStreamingSessionURL") (clojure.core/assoc :hls-streaming-session-url (deser-hls-streaming-session-url (clojure.core/get-in letvar1171542 ["HLSStreamingSessionURL"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media/fragment-number-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media/content-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\.\-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis-video-archived-media/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
