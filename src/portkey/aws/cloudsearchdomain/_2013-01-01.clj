...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain.-2013-01-01/query-parser (clojure.spec.alpha/conformer (clojure.core/let [m__56599__auto__ {"simple" "simple", :simple "simple", "structured" "structured", :structured "structured", "lucene" "lucene", :lucene "lucene", "dismax" "dismax", :dismax "dismax"}] (clojure.core/fn [s__56600__auto__] (m__56599__auto__ s__56600__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain.-2013-01-01/content-type (clojure.spec.alpha/conformer (clojure.core/let [m__56599__auto__ {"application/json" "application/json", :application/json "application/json", "application/xml" "application/xml", :application/xml "application/xml"}] (clojure.core/fn [s__56600__auto__] (m__56599__auto__ s__56600__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.core/defn search ([input__56767__auto__] (search input__56767__auto__ portkey.aws/*http-client*)) ([input57888 http-client__56768__auto__] (clojure.core/let [endpoint__56769__auto__ (portkey.aws.cloudsearchdomain.-2013-01-01/endpoints portkey.aws/*region*) sig-opts__56770__auto__ (clojure.core/into (:credential-scope endpoint__56769__auto__) portkey.aws/*credentials*)] (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/search?format=sdk&pretty=true"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SearchRequest input57888)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"partial" "partial", "expr" "expr", "fq" "filterQuery", "q" "query", "return" "return", "sort" "sort", "q.options" "queryOptions", "start" "start", "cursor" "cursor", "q.parser" "queryParser", "facet" "facet", "size" "size", "highlight" "highlight", "stats" "stats"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__56766__56771__auto__] (clojure.core/some-> p1__56766__56771__auto__ cheshire.core/generate-string))) (portkey.aws/sign-v4 sig-opts__56770__auto__) (http-client__56768__auto__ (clojure.core/fn [response57887] (clojure.core/let [errors__56772__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response57887)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/search-response (:body response57887)) (clojure.core/if-some [[type__56773__auto__ spec__56774__auto__] (clojure.core/find errors__56772__auto__ (clojure.core/get-in response57887 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__56775__auto__ (clojure.spec.alpha/unform spec__56774__auto__ (cheshire.core/parse-string (:body response57887)))] (throw (clojure.core/ex-info (clojure.core/str type__56773__auto__ ": " (:message m__56775__auto__)) m__56775__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response57887})))))))))))

(clojure.core/defn suggest ([input__56767__auto__] (suggest input__56767__auto__ portkey.aws/*http-client*)) ([input57890 http-client__56768__auto__] (clojure.core/let [endpoint__56769__auto__ (portkey.aws.cloudsearchdomain.-2013-01-01/endpoints portkey.aws/*region*) sig-opts__56770__auto__ (clojure.core/into (:credential-scope endpoint__56769__auto__) portkey.aws/*credentials*)] (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/suggest?format=sdk&pretty=true"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SuggestRequest input57890)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"q" "query", "suggester" "suggester", "size" "size"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__56766__56771__auto__] (clojure.core/some-> p1__56766__56771__auto__ cheshire.core/generate-string))) (portkey.aws/sign-v4 sig-opts__56770__auto__) (http-client__56768__auto__ (clojure.core/fn [response57889] (clojure.core/let [errors__56772__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response57889)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/suggest-response (:body response57889)) (clojure.core/if-some [[type__56773__auto__ spec__56774__auto__] (clojure.core/find errors__56772__auto__ (clojure.core/get-in response57889 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__56775__auto__ (clojure.spec.alpha/unform spec__56774__auto__ (cheshire.core/parse-string (:body response57889)))] (throw (clojure.core/ex-info (clojure.core/str type__56773__auto__ ": " (:message m__56775__auto__)) m__56775__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response57889})))))))))))

(clojure.core/defn upload-documents ([input__56767__auto__] (upload-documents input__56767__auto__ portkey.aws/*http-client*)) ([input57892 http-client__56768__auto__] (clojure.core/let [endpoint__56769__auto__ (portkey.aws.cloudsearchdomain.-2013-01-01/endpoints portkey.aws/*region*) sig-opts__56770__auto__ (clojure.core/into (:credential-scope endpoint__56769__auto__) portkey.aws/*credentials*)] (clojure.core/-> {:method "POST", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/documents/batch?format=sdk"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/UploadDocumentsRequest input57892)} (portkey.awsgen/params-to-header {"contentType" ["Content-Type" nil]}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {}) (portkey.awsgen/params-to-payload "documents") (clojure.core/update :body (fn* [p1__56766__56771__auto__] (clojure.core/some-> p1__56766__56771__auto__ cheshire.core/generate-string))) (portkey.aws/sign-v4 sig-opts__56770__auto__) (http-client__56768__auto__ (clojure.core/fn [response57891] (clojure.core/let [errors__56772__auto__ {"DocumentServiceException" :portkey.aws.cloudsearchdomain.-2013-01-01/document-service-exception}] (if (clojure.core/= nil (:status response57891)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/upload-documents-response (:body response57891)) (clojure.core/if-some [[type__56773__auto__ spec__56774__auto__] (clojure.core/find errors__56772__auto__ (clojure.core/get-in response57891 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__56775__auto__ (clojure.spec.alpha/unform spec__56774__auto__ (cheshire.core/parse-string (:body response57891)))] (throw (clojure.core/ex-info (clojure.core/str type__56773__auto__ ": " (:message m__56775__auto__)) m__56775__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response57891})))))))))))
