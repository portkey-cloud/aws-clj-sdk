...
(clojure.core/defn suggest [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.cloudsearchdomain.-2013-01-01/endpoints "GET" "/2013-01-01/suggest?format=sdk&pretty=true" input__8278__auto__ :portkey.aws.cloudsearchdomain.-2013-01-01/suggest-request {:payload nil, :headers {}, :uri {}, :querystring {"q" "query", "suggester" "suggester", "size" "size"}} nil :portkey.aws.cloudsearchdomain.-2013-01-01/suggest-response {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}))
...
(clojure.core/defn upload-documents [input__8278__auto__] (portkey.aws/-rest-json-call portkey.aws.cloudsearchdomain.-2013-01-01/endpoints "POST" "/2013-01-01/documents/batch?format=sdk" input__8278__auto__ :portkey.aws.cloudsearchdomain.-2013-01-01/upload-documents-request {:payload "documents", :headers {"contentType" ["Content-Type" nil]}, :uri {}, :querystring {}} nil :portkey.aws.cloudsearchdomain.-2013-01-01/upload-documents-response {"DocumentServiceException" :portkey.aws.cloudsearchdomain.-2013-01-01/document-service-exception}))
