...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain.-2013-01-01/query-parser (clojure.spec.alpha/conformer (clojure.core/let [m__44496__auto__ {"simple" "simple", :simple "simple", "structured" "structured", :structured "structured", "lucene" "lucene", :lucene "lucene", "dismax" "dismax", :dismax "dismax"}] (clojure.core/fn [s__44497__auto__] (m__44496__auto__ s__44497__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.core/defn search ([input__47307__auto__] (search input__47307__auto__ portkey.aws/*http-client*)) ([input48163 http-client__47308__auto__] (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/search?format=sdk&pretty=true"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SearchRequest input48163)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"partial" "partial", "expr" "expr", "fq" "filterQuery", "q" "query", "return" "return", "sort" "sort", "q.options" "queryOptions", "start" "start", "cursor" "cursor", "q.parser" "queryParser", "facet" "facet", "size" "size", "highlight" "highlight", "stats" "stats"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__47306__47309__auto__] (clojure.core/some-> p1__47306__47309__auto__ cheshire.core/generate-string))) (http-client__47308__auto__ (clojure.core/fn [response48162] (clojure.core/let [errors__47310__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response48162)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/search-response (:body response48162)) (clojure.core/if-some [[type__47311__auto__ spec__47312__auto__] (clojure.core/find errors__47310__auto__ (clojure.core/get-in response48162 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__47313__auto__ (clojure.spec.alpha/unform spec__47312__auto__ (cheshire.core/parse-string (:body response48162)))] (throw (clojure.core/ex-info (clojure.core/str type__47311__auto__ ": " (:message m__47313__auto__)) m__47313__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response48162}))))))))))

(clojure.core/defn suggest ([input__47307__auto__] (suggest input__47307__auto__ portkey.aws/*http-client*)) ([input48165 http-client__47308__auto__] (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/suggest?format=sdk&pretty=true"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SuggestRequest input48165)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"q" "query", "suggester" "suggester", "size" "size"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__47306__47309__auto__] (clojure.core/some-> p1__47306__47309__auto__ cheshire.core/generate-string))) (http-client__47308__auto__ (clojure.core/fn [response48164] (clojure.core/let [errors__47310__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response48164)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/suggest-response (:body response48164)) (clojure.core/if-some [[type__47311__auto__ spec__47312__auto__] (clojure.core/find errors__47310__auto__ (clojure.core/get-in response48164 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__47313__auto__ (clojure.spec.alpha/unform spec__47312__auto__ (cheshire.core/parse-string (:body response48164)))] (throw (clojure.core/ex-info (clojure.core/str type__47311__auto__ ": " (:message m__47313__auto__)) m__47313__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response48164}))))))))))

(clojure.core/defn upload-documents ([input__47307__auto__] (upload-documents input__47307__auto__ portkey.aws/*http-client*)) ([input48167 http-client__47308__auto__] (clojure.core/-> {:method "POST", :headers {"content-type" "application/json"}, :url (clojure.core/str (:endpoint (endpoints portkey.aws/*region*)) "/2013-01-01/documents/batch?format=sdk"), :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/UploadDocumentsRequest input48167)} (portkey.awsgen/params-to-header {"contentType" ["Content-Type" nil]}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {}) (portkey.awsgen/params-to-payload "documents") (clojure.core/update :body (fn* [p1__47306__47309__auto__] (clojure.core/some-> p1__47306__47309__auto__ cheshire.core/generate-string))) (http-client__47308__auto__ (clojure.core/fn [response48166] (clojure.core/let [errors__47310__auto__ {"DocumentServiceException" :portkey.aws.cloudsearchdomain.-2013-01-01/document-service-exception}] (if (clojure.core/= nil (:status response48166)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/upload-documents-response (:body response48166)) (clojure.core/if-some [[type__47311__auto__ spec__47312__auto__] (clojure.core/find errors__47310__auto__ (clojure.core/get-in response48166 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__47313__auto__ (clojure.spec.alpha/unform spec__47312__auto__ (cheshire.core/parse-string (:body response48166)))] (throw (clojure.core/ex-info (clojure.core/str type__47311__auto__ ": " (:message m__47313__auto__)) m__47313__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response48166}))))))))))
