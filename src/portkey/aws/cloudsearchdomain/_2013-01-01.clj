...
(clojure.core/defn- response-document-service-exception ([input] (response-document-service-exception nil input)) ([resultWrapper371829 input] (clojure.core/let [rawinput371828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar371830 {"status" (rawinput371828 "status"), "message" (rawinput371828 "message")}] (clojure.core/cond-> {} (letvar371830 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar371830 ["status"]))) (letvar371830 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar371830 ["message"])))))))

(clojure.core/defn- response-suggest-response ([input] (response-suggest-response nil input)) ([resultWrapper371832 input] (clojure.core/let [rawinput371831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar371833 {"status" (rawinput371831 "status"), "suggest" (rawinput371831 "suggest")}] (clojure.core/cond-> {} (letvar371833 "status") (clojure.core/assoc :status (deser-suggest-status (clojure.core/get-in letvar371833 ["status"]))) (letvar371833 "suggest") (clojure.core/assoc :suggest (deser-suggest-model (clojure.core/get-in letvar371833 ["suggest"])))))))

(clojure.core/defn- response-search-exception ([input] (response-search-exception nil input)) ([resultWrapper371835 input] (clojure.core/let [rawinput371834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar371836 {"message" (rawinput371834 "message")}] (clojure.core/cond-> {} (letvar371836 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar371836 ["message"])))))))

(clojure.core/defn- response-upload-documents-response ([input] (response-upload-documents-response nil input)) ([resultWrapper371838 input] (clojure.core/let [rawinput371837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar371839 {"status" (rawinput371837 "status"), "adds" (rawinput371837 "adds"), "deletes" (rawinput371837 "deletes"), "warnings" (rawinput371837 "warnings")}] (clojure.core/cond-> {} (letvar371839 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar371839 ["status"]))) (letvar371839 "adds") (clojure.core/assoc :adds (deser-adds (clojure.core/get-in letvar371839 ["adds"]))) (letvar371839 "deletes") (clojure.core/assoc :deletes (deser-deletes (clojure.core/get-in letvar371839 ["deletes"]))) (letvar371839 "warnings") (clojure.core/assoc :warnings (deser-document-service-warnings (clojure.core/get-in letvar371839 ["warnings"])))))))

(clojure.core/defn- response-search-response ([input] (response-search-response nil input)) ([resultWrapper371841 input] (clojure.core/let [rawinput371840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar371842 {"status" (rawinput371840 "status"), "hits" (rawinput371840 "hits"), "facets" (rawinput371840 "facets"), "stats" (rawinput371840 "stats")}] (clojure.core/cond-> {} (letvar371842 "status") (clojure.core/assoc :status (deser-search-status (clojure.core/get-in letvar371842 ["status"]))) (letvar371842 "hits") (clojure.core/assoc :hits (deser-hits (clojure.core/get-in letvar371842 ["hits"]))) (letvar371842 "facets") (clojure.core/assoc :facets (deser-facets (clojure.core/get-in letvar371842 ["facets"]))) (letvar371842 "stats") (clojure.core/assoc :stats (deser-stats (clojure.core/get-in letvar371842 ["stats"])))))))
