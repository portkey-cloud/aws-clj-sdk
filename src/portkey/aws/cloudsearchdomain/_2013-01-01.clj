...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain.-2013-01-01/query-parser (clojure.spec.alpha/conformer (clojure.core/let [m__36525__auto__ {"simple" "simple", :simple "simple", "structured" "structured", :structured "structured", "lucene" "lucene", :lucene "lucene", "dismax" "dismax", :dismax "dismax"}] (clojure.core/fn [s__36526__auto__] (m__36525__auto__ s__36526__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.cloudsearchdomain.-2013-01-01/content-type (clojure.spec.alpha/conformer (clojure.core/let [m__36525__auto__ {"application/json" "application/json", :application/json "application/json", "application/xml" "application/xml", :application/xml "application/xml"}] (clojure.core/fn [s__36526__auto__] (m__36525__auto__ s__36526__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.awsgen/dashed)))
...
(clojure.core/defn search ([input__36693__auto__] (search input__36693__auto__ portkey.aws/*http-client*)) ([input37725 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/search?format=sdk&pretty=true", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SearchRequest input37725)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"partial" "partial", "expr" "expr", "fq" "filterQuery", "q" "query", "return" "return", "sort" "sort", "q.options" "queryOptions", "start" "start", "cursor" "cursor", "q.parser" "queryParser", "facet" "facet", "size" "size", "highlight" "highlight", "stats" "stats"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/search?format=sdk&pretty=true", :body body__36697__auto__} (clojure.core/fn [response37724] (clojure.core/let [errors__36698__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response37724)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/search-response (:body response37724)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37724 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37724)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37724}))))))))))

(clojure.core/defn suggest ([input__36693__auto__] (suggest input__36693__auto__ portkey.aws/*http-client*)) ([input37727 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/suggest?format=sdk&pretty=true", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/SuggestRequest input37727)} (portkey.awsgen/params-to-header {}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {"q" "query", "suggester" "suggester", "size" "size"}) (portkey.awsgen/params-to-payload nil) (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "GET", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/suggest?format=sdk&pretty=true", :body body__36697__auto__} (clojure.core/fn [response37726] (clojure.core/let [errors__36698__auto__ {"SearchException" :portkey.aws.cloudsearchdomain.-2013-01-01/search-exception}] (if (clojure.core/= nil (:status response37726)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/suggest-response (:body response37726)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37726 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37726)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37726}))))))))))

(clojure.core/defn upload-documents ([input__36693__auto__] (upload-documents input__36693__auto__ portkey.aws/*http-client*)) ([input37729 http-client__36694__auto__] (clojure.core/let [req__36695__auto__ (clojure.core/-> {:method "POST", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/documents/batch?format=sdk", :body (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/UploadDocumentsRequest input37729)} (portkey.awsgen/params-to-header {"contentType" ["Content-Type" nil]}) (portkey.awsgen/params-to-uri {}) (portkey.awsgen/params-to-querystring {}) (portkey.awsgen/params-to-payload "documents") (clojure.core/update :body (fn* [p1__36692__36696__auto__] (clojure.core/some-> p1__36692__36696__auto__ cheshire.core/generate-string))))] (http-client__36694__auto__ {:method "POST", :headers {"content-type" "application/json"}, :url "https://lambda.eu-central-1.amazonaws.com/2013-01-01/documents/batch?format=sdk", :body body__36697__auto__} (clojure.core/fn [response37728] (clojure.core/let [errors__36698__auto__ {"DocumentServiceException" :portkey.aws.cloudsearchdomain.-2013-01-01/document-service-exception}] (if (clojure.core/= nil (:status response37728)) (clojure.spec.alpha/unform :portkey.aws.cloudsearchdomain.-2013-01-01/upload-documents-response (:body response37728)) (clojure.core/if-some [[type__36699__auto__ spec__36700__auto__] (clojure.core/find errors__36698__auto__ (clojure.core/get-in response37728 [:headers "x-amzn-ErrorType"]))] (clojure.core/let [m__36701__auto__ (clojure.spec.alpha/unform spec__36700__auto__ (cheshire.core/parse-string (:body response37728)))] (throw (clojure.core/ex-info (clojure.core/str type__36699__auto__ ": " (:message m__36701__auto__)) m__36701__auto__))) (throw (clojure.core/ex-info "Unexpected response" {:response response37728}))))))))))
