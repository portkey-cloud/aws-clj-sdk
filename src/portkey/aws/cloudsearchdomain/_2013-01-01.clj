...
(clojure.core/defn- response-document-service-exception ([input] (response-document-service-exception nil input)) ([resultWrapper1112651 input] (clojure.core/let [rawinput1112650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1112652 {"status" (rawinput1112650 "status"), "message" (rawinput1112650 "message")}] (clojure.core/cond-> {} (letvar1112652 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar1112652 ["status"]))) (letvar1112652 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1112652 ["message"])))))))

(clojure.core/defn- response-suggest-response ([input] (response-suggest-response nil input)) ([resultWrapper1112654 input] (clojure.core/let [rawinput1112653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1112655 {"status" (rawinput1112653 "status"), "suggest" (rawinput1112653 "suggest")}] (clojure.core/cond-> {} (letvar1112655 "status") (clojure.core/assoc :status (deser-suggest-status (clojure.core/get-in letvar1112655 ["status"]))) (letvar1112655 "suggest") (clojure.core/assoc :suggest (deser-suggest-model (clojure.core/get-in letvar1112655 ["suggest"])))))))

(clojure.core/defn- response-search-exception ([input] (response-search-exception nil input)) ([resultWrapper1112657 input] (clojure.core/let [rawinput1112656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1112658 {"message" (rawinput1112656 "message")}] (clojure.core/cond-> {} (letvar1112658 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1112658 ["message"])))))))

(clojure.core/defn- response-upload-documents-response ([input] (response-upload-documents-response nil input)) ([resultWrapper1112660 input] (clojure.core/let [rawinput1112659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1112661 {"status" (rawinput1112659 "status"), "adds" (rawinput1112659 "adds"), "deletes" (rawinput1112659 "deletes"), "warnings" (rawinput1112659 "warnings")}] (clojure.core/cond-> {} (letvar1112661 "status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar1112661 ["status"]))) (letvar1112661 "adds") (clojure.core/assoc :adds (deser-adds (clojure.core/get-in letvar1112661 ["adds"]))) (letvar1112661 "deletes") (clojure.core/assoc :deletes (deser-deletes (clojure.core/get-in letvar1112661 ["deletes"]))) (letvar1112661 "warnings") (clojure.core/assoc :warnings (deser-document-service-warnings (clojure.core/get-in letvar1112661 ["warnings"])))))))

(clojure.core/defn- response-search-response ([input] (response-search-response nil input)) ([resultWrapper1112663 input] (clojure.core/let [rawinput1112662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1112664 {"status" (rawinput1112662 "status"), "hits" (rawinput1112662 "hits"), "facets" (rawinput1112662 "facets"), "stats" (rawinput1112662 "stats")}] (clojure.core/cond-> {} (letvar1112664 "status") (clojure.core/assoc :status (deser-search-status (clojure.core/get-in letvar1112664 ["status"]))) (letvar1112664 "hits") (clojure.core/assoc :hits (deser-hits (clojure.core/get-in letvar1112664 ["hits"]))) (letvar1112664 "facets") (clojure.core/assoc :facets (deser-facets (clojure.core/get-in letvar1112664 ["facets"]))) (letvar1112664 "stats") (clojure.core/assoc :stats (deser-stats (clojure.core/get-in letvar1112664 ["stats"])))))))
