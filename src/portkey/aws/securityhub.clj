...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper1450994 input] (clojure.core/let [rawinput1450993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450995 {"UnprocessedAccounts" (rawinput1450993 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1450995 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1450995 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper1450997 input] (clojure.core/let [rawinput1450996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1450998 {"Master" (rawinput1450996 "Master")}] (clojure.core/cond-> {} (letvar1450998 "Master") (clojure.core/assoc :master (deser-invitation (clojure.core/get-in letvar1450998 ["Master"])))))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper1451000 input] (clojure.core/let [rawinput1450999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451001 {"UnprocessedAccounts" (rawinput1450999 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1451001 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1451001 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disable-import-findings-for-product-response ([input] (response-disable-import-findings-for-product-response nil input)) ([resultWrapper1451003 input] (clojure.core/let [rawinput1451002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451004 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper1451006 input] (clojure.core/let [rawinput1451005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451007 {"UnprocessedAccounts" (rawinput1451005 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1451007 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1451007 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper1451009 input] (clojure.core/let [rawinput1451008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451010 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper1451012 input] (clojure.core/let [rawinput1451011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451013 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper1451015 input] (clojure.core/let [rawinput1451014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451016 {"Members" (rawinput1451014 "Members"), "UnprocessedAccounts" (rawinput1451014 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1451016 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar1451016 ["Members"]))) (letvar1451016 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1451016 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-batch-enable-standards-response ([input] (response-batch-enable-standards-response nil input)) ([resultWrapper1451018 input] (clojure.core/let [rawinput1451017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451019 {"StandardsSubscriptions" (rawinput1451017 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar1451019 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1451019 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-enabled-standards-response ([input] (response-get-enabled-standards-response nil input)) ([resultWrapper1451021 input] (clojure.core/let [rawinput1451020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451022 {"StandardsSubscriptions" (rawinput1451020 "StandardsSubscriptions"), "NextToken" (rawinput1451020 "NextToken")}] (clojure.core/cond-> {} (letvar1451022 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1451022 ["StandardsSubscriptions"]))) (letvar1451022 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1451022 ["NextToken"])))))))

(clojure.core/defn- response-get-insight-results-response ([input] (response-get-insight-results-response nil input)) ([resultWrapper1451024 input] (clojure.core/let [rawinput1451023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451025 {"InsightResults" (rawinput1451023 "InsightResults")}] (clojure.core/cond-> {:insight-results (deser-insight-results (clojure.core/get-in letvar1451025 ["InsightResults"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1451027 input] (clojure.core/let [rawinput1451026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451028 {"Message" (rawinput1451026 "Message"), "Code" (rawinput1451026 "Code")}] (clojure.core/cond-> {} (letvar1451028 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1451028 ["Message"]))) (letvar1451028 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1451028 ["Code"])))))))

(clojure.core/defn- response-batch-import-findings-response ([input] (response-batch-import-findings-response nil input)) ([resultWrapper1451030 input] (clojure.core/let [rawinput1451029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451031 {"FailedCount" (rawinput1451029 "FailedCount"), "SuccessCount" (rawinput1451029 "SuccessCount"), "FailedFindings" (rawinput1451029 "FailedFindings")}] (clojure.core/cond-> {:failed-count (deser-integer (clojure.core/get-in letvar1451031 ["FailedCount"])), :success-count (deser-integer (clojure.core/get-in letvar1451031 ["SuccessCount"]))} (letvar1451031 "FailedFindings") (clojure.core/assoc :failed-findings (deser-import-findings-error-list (clojure.core/get-in letvar1451031 ["FailedFindings"])))))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper1451033 input] (clojure.core/let [rawinput1451032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451034 {"Invitations" (rawinput1451032 "Invitations"), "NextToken" (rawinput1451032 "NextToken")}] (clojure.core/cond-> {} (letvar1451034 "Invitations") (clojure.core/assoc :invitations (deser-invitation-list (clojure.core/get-in letvar1451034 ["Invitations"]))) (letvar1451034 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1451034 ["NextToken"])))))))

(clojure.core/defn- response-enable-import-findings-for-product-response ([input] (response-enable-import-findings-for-product-response nil input)) ([resultWrapper1451036 input] (clojure.core/let [rawinput1451035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451037 {"ProductSubscriptionArn" (rawinput1451035 "ProductSubscriptionArn")}] (clojure.core/cond-> {} (letvar1451037 "ProductSubscriptionArn") (clojure.core/assoc :product-subscription-arn (deser-non-empty-string (clojure.core/get-in letvar1451037 ["ProductSubscriptionArn"])))))))

(clojure.core/defn- response-batch-disable-standards-response ([input] (response-batch-disable-standards-response nil input)) ([resultWrapper1451039 input] (clojure.core/let [rawinput1451038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451040 {"StandardsSubscriptions" (rawinput1451038 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar1451040 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar1451040 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-insights-response ([input] (response-get-insights-response nil input)) ([resultWrapper1451042 input] (clojure.core/let [rawinput1451041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451043 {"Insights" (rawinput1451041 "Insights"), "NextToken" (rawinput1451041 "NextToken")}] (clojure.core/cond-> {:insights (deser-insight-list (clojure.core/get-in letvar1451043 ["Insights"]))} (letvar1451043 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1451043 ["NextToken"])))))))

(clojure.core/defn- response-disable-security-hub-response ([input] (response-disable-security-hub-response nil input)) ([resultWrapper1451045 input] (clojure.core/let [rawinput1451044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451046 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-enable-security-hub-response ([input] (response-enable-security-hub-response nil input)) ([resultWrapper1451048 input] (clojure.core/let [rawinput1451047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451049 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-response ([input] (response-update-findings-response nil input)) ([resultWrapper1451051 input] (clojure.core/let [rawinput1451050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451052 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1451054 input] (clojure.core/let [rawinput1451053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451055 {"Message" (rawinput1451053 "Message"), "Code" (rawinput1451053 "Code")}] (clojure.core/cond-> {} (letvar1451055 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1451055 ["Message"]))) (letvar1451055 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1451055 ["Code"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1451057 input] (clojure.core/let [rawinput1451056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451058 {"Message" (rawinput1451056 "Message"), "Code" (rawinput1451056 "Code")}] (clojure.core/cond-> {} (letvar1451058 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1451058 ["Message"]))) (letvar1451058 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1451058 ["Code"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1451060 input] (clojure.core/let [rawinput1451059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451061 {"Message" (rawinput1451059 "Message"), "Code" (rawinput1451059 "Code")}] (clojure.core/cond-> {} (letvar1451061 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar1451061 ["Message"]))) (letvar1451061 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar1451061 ["Code"])))))))

(clojure.core/defn- response-delete-insight-response ([input] (response-delete-insight-response nil input)) ([resultWrapper1451063 input] (clojure.core/let [rawinput1451062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451064 {"InsightArn" (rawinput1451062 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar1451064 ["InsightArn"]))}))))

(clojure.core/defn- response-list-enabled-products-for-import-response ([input] (response-list-enabled-products-for-import-response nil input)) ([resultWrapper1451066 input] (clojure.core/let [rawinput1451065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451067 {"ProductSubscriptions" (rawinput1451065 "ProductSubscriptions"), "NextToken" (rawinput1451065 "NextToken")}] (clojure.core/cond-> {} (letvar1451067 "ProductSubscriptions") (clojure.core/assoc :product-subscriptions (deser-product-subscription-arn-list (clojure.core/get-in letvar1451067 ["ProductSubscriptions"]))) (letvar1451067 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1451067 ["NextToken"])))))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper1451069 input] (clojure.core/let [rawinput1451068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451070 {"InvitationsCount" (rawinput1451068 "InvitationsCount")}] (clojure.core/cond-> {} (letvar1451070 "InvitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar1451070 ["InvitationsCount"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper1451072 input] (clojure.core/let [rawinput1451071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451073 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper1451075 input] (clojure.core/let [rawinput1451074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451076 {"Findings" (rawinput1451074 "Findings"), "NextToken" (rawinput1451074 "NextToken")}] (clojure.core/cond-> {:findings (deser-aws-security-finding-list (clojure.core/get-in letvar1451076 ["Findings"]))} (letvar1451076 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1451076 ["NextToken"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper1451078 input] (clojure.core/let [rawinput1451077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451079 {"UnprocessedAccounts" (rawinput1451077 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1451079 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1451079 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper1451081 input] (clojure.core/let [rawinput1451080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451082 {"UnprocessedAccounts" (rawinput1451080 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar1451082 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar1451082 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-update-insight-response ([input] (response-update-insight-response nil input)) ([resultWrapper1451084 input] (clojure.core/let [rawinput1451083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451085 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-insight-response ([input] (response-create-insight-response nil input)) ([resultWrapper1451087 input] (clojure.core/let [rawinput1451086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451088 {"InsightArn" (rawinput1451086 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar1451088 ["InsightArn"]))}))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper1451090 input] (clojure.core/let [rawinput1451089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1451091 {"Members" (rawinput1451089 "Members"), "NextToken" (rawinput1451089 "NextToken")}] (clojure.core/cond-> {} (letvar1451091 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar1451091 ["Members"]))) (letvar1451091 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar1451091 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.securityhub/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #".*\S.*" s__1012854__auto__))))
