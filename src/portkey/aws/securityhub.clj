...
(clojure.core/defn- response-create-members-response ([input] (response-create-members-response nil input)) ([resultWrapper457997 input] (clojure.core/let [rawinput457996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar457998 {"UnprocessedAccounts" (rawinput457996 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar457998 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar457998 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-get-master-account-response ([input] (response-get-master-account-response nil input)) ([resultWrapper458000 input] (clojure.core/let [rawinput457999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458001 {"Master" (rawinput457999 "Master")}] (clojure.core/cond-> {} (letvar458001 "Master") (clojure.core/assoc :master (deser-invitation (clojure.core/get-in letvar458001 ["Master"])))))))

(clojure.core/defn- response-delete-invitations-response ([input] (response-delete-invitations-response nil input)) ([resultWrapper458003 input] (clojure.core/let [rawinput458002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458004 {"UnprocessedAccounts" (rawinput458002 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar458004 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar458004 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disable-import-findings-for-product-response ([input] (response-disable-import-findings-for-product-response nil input)) ([resultWrapper458006 input] (clojure.core/let [rawinput458005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458007 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-decline-invitations-response ([input] (response-decline-invitations-response nil input)) ([resultWrapper458009 input] (clojure.core/let [rawinput458008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458010 {"UnprocessedAccounts" (rawinput458008 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar458010 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar458010 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-disassociate-members-response ([input] (response-disassociate-members-response nil input)) ([resultWrapper458012 input] (clojure.core/let [rawinput458011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458013 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-from-master-account-response ([input] (response-disassociate-from-master-account-response nil input)) ([resultWrapper458015 input] (clojure.core/let [rawinput458014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458016 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-members-response ([input] (response-get-members-response nil input)) ([resultWrapper458018 input] (clojure.core/let [rawinput458017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458019 {"Members" (rawinput458017 "Members"), "UnprocessedAccounts" (rawinput458017 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar458019 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar458019 ["Members"]))) (letvar458019 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar458019 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-batch-enable-standards-response ([input] (response-batch-enable-standards-response nil input)) ([resultWrapper458021 input] (clojure.core/let [rawinput458020 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458022 {"StandardsSubscriptions" (rawinput458020 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar458022 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar458022 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-enabled-standards-response ([input] (response-get-enabled-standards-response nil input)) ([resultWrapper458024 input] (clojure.core/let [rawinput458023 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458025 {"StandardsSubscriptions" (rawinput458023 "StandardsSubscriptions"), "NextToken" (rawinput458023 "NextToken")}] (clojure.core/cond-> {} (letvar458025 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar458025 ["StandardsSubscriptions"]))) (letvar458025 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar458025 ["NextToken"])))))))

(clojure.core/defn- response-get-insight-results-response ([input] (response-get-insight-results-response nil input)) ([resultWrapper458027 input] (clojure.core/let [rawinput458026 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458028 {"InsightResults" (rawinput458026 "InsightResults")}] (clojure.core/cond-> {:insight-results (deser-insight-results (clojure.core/get-in letvar458028 ["InsightResults"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper458030 input] (clojure.core/let [rawinput458029 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458031 {"Message" (rawinput458029 "Message"), "Code" (rawinput458029 "Code")}] (clojure.core/cond-> {} (letvar458031 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar458031 ["Message"]))) (letvar458031 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar458031 ["Code"])))))))

(clojure.core/defn- response-batch-import-findings-response ([input] (response-batch-import-findings-response nil input)) ([resultWrapper458033 input] (clojure.core/let [rawinput458032 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458034 {"FailedCount" (rawinput458032 "FailedCount"), "SuccessCount" (rawinput458032 "SuccessCount"), "FailedFindings" (rawinput458032 "FailedFindings")}] (clojure.core/cond-> {:failed-count (deser-integer (clojure.core/get-in letvar458034 ["FailedCount"])), :success-count (deser-integer (clojure.core/get-in letvar458034 ["SuccessCount"]))} (letvar458034 "FailedFindings") (clojure.core/assoc :failed-findings (deser-import-findings-error-list (clojure.core/get-in letvar458034 ["FailedFindings"])))))))

(clojure.core/defn- response-list-invitations-response ([input] (response-list-invitations-response nil input)) ([resultWrapper458036 input] (clojure.core/let [rawinput458035 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458037 {"Invitations" (rawinput458035 "Invitations"), "NextToken" (rawinput458035 "NextToken")}] (clojure.core/cond-> {} (letvar458037 "Invitations") (clojure.core/assoc :invitations (deser-invitation-list (clojure.core/get-in letvar458037 ["Invitations"]))) (letvar458037 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar458037 ["NextToken"])))))))

(clojure.core/defn- response-enable-import-findings-for-product-response ([input] (response-enable-import-findings-for-product-response nil input)) ([resultWrapper458039 input] (clojure.core/let [rawinput458038 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458040 {"ProductSubscriptionArn" (rawinput458038 "ProductSubscriptionArn")}] (clojure.core/cond-> {} (letvar458040 "ProductSubscriptionArn") (clojure.core/assoc :product-subscription-arn (deser-non-empty-string (clojure.core/get-in letvar458040 ["ProductSubscriptionArn"])))))))

(clojure.core/defn- response-batch-disable-standards-response ([input] (response-batch-disable-standards-response nil input)) ([resultWrapper458042 input] (clojure.core/let [rawinput458041 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458043 {"StandardsSubscriptions" (rawinput458041 "StandardsSubscriptions")}] (clojure.core/cond-> {} (letvar458043 "StandardsSubscriptions") (clojure.core/assoc :standards-subscriptions (deser-standards-subscriptions (clojure.core/get-in letvar458043 ["StandardsSubscriptions"])))))))

(clojure.core/defn- response-get-insights-response ([input] (response-get-insights-response nil input)) ([resultWrapper458045 input] (clojure.core/let [rawinput458044 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458046 {"Insights" (rawinput458044 "Insights"), "NextToken" (rawinput458044 "NextToken")}] (clojure.core/cond-> {:insights (deser-insight-list (clojure.core/get-in letvar458046 ["Insights"]))} (letvar458046 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar458046 ["NextToken"])))))))

(clojure.core/defn- response-disable-security-hub-response ([input] (response-disable-security-hub-response nil input)) ([resultWrapper458048 input] (clojure.core/let [rawinput458047 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458049 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-enable-security-hub-response ([input] (response-enable-security-hub-response nil input)) ([resultWrapper458051 input] (clojure.core/let [rawinput458050 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458052 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-findings-response ([input] (response-update-findings-response nil input)) ([resultWrapper458054 input] (clojure.core/let [rawinput458053 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458055 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper458057 input] (clojure.core/let [rawinput458056 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458058 {"Message" (rawinput458056 "Message"), "Code" (rawinput458056 "Code")}] (clojure.core/cond-> {} (letvar458058 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar458058 ["Message"]))) (letvar458058 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar458058 ["Code"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper458060 input] (clojure.core/let [rawinput458059 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458061 {"Message" (rawinput458059 "Message"), "Code" (rawinput458059 "Code")}] (clojure.core/cond-> {} (letvar458061 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar458061 ["Message"]))) (letvar458061 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar458061 ["Code"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper458063 input] (clojure.core/let [rawinput458062 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458064 {"Message" (rawinput458062 "Message"), "Code" (rawinput458062 "Code")}] (clojure.core/cond-> {} (letvar458064 "Message") (clojure.core/assoc :message (deser-non-empty-string (clojure.core/get-in letvar458064 ["Message"]))) (letvar458064 "Code") (clojure.core/assoc :code (deser-non-empty-string (clojure.core/get-in letvar458064 ["Code"])))))))

(clojure.core/defn- response-delete-insight-response ([input] (response-delete-insight-response nil input)) ([resultWrapper458066 input] (clojure.core/let [rawinput458065 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458067 {"InsightArn" (rawinput458065 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar458067 ["InsightArn"]))}))))

(clojure.core/defn- response-list-enabled-products-for-import-response ([input] (response-list-enabled-products-for-import-response nil input)) ([resultWrapper458069 input] (clojure.core/let [rawinput458068 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458070 {"ProductSubscriptions" (rawinput458068 "ProductSubscriptions"), "NextToken" (rawinput458068 "NextToken")}] (clojure.core/cond-> {} (letvar458070 "ProductSubscriptions") (clojure.core/assoc :product-subscriptions (deser-product-subscription-arn-list (clojure.core/get-in letvar458070 ["ProductSubscriptions"]))) (letvar458070 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar458070 ["NextToken"])))))))

(clojure.core/defn- response-get-invitations-count-response ([input] (response-get-invitations-count-response nil input)) ([resultWrapper458072 input] (clojure.core/let [rawinput458071 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458073 {"InvitationsCount" (rawinput458071 "InvitationsCount")}] (clojure.core/cond-> {} (letvar458073 "InvitationsCount") (clojure.core/assoc :invitations-count (deser-integer (clojure.core/get-in letvar458073 ["InvitationsCount"])))))))

(clojure.core/defn- response-accept-invitation-response ([input] (response-accept-invitation-response nil input)) ([resultWrapper458075 input] (clojure.core/let [rawinput458074 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458076 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-findings-response ([input] (response-get-findings-response nil input)) ([resultWrapper458078 input] (clojure.core/let [rawinput458077 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458079 {"Findings" (rawinput458077 "Findings"), "NextToken" (rawinput458077 "NextToken")}] (clojure.core/cond-> {:findings (deser-aws-security-finding-list (clojure.core/get-in letvar458079 ["Findings"]))} (letvar458079 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar458079 ["NextToken"])))))))

(clojure.core/defn- response-delete-members-response ([input] (response-delete-members-response nil input)) ([resultWrapper458081 input] (clojure.core/let [rawinput458080 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458082 {"UnprocessedAccounts" (rawinput458080 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar458082 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar458082 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-invite-members-response ([input] (response-invite-members-response nil input)) ([resultWrapper458084 input] (clojure.core/let [rawinput458083 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458085 {"UnprocessedAccounts" (rawinput458083 "UnprocessedAccounts")}] (clojure.core/cond-> {} (letvar458085 "UnprocessedAccounts") (clojure.core/assoc :unprocessed-accounts (deser-result-list (clojure.core/get-in letvar458085 ["UnprocessedAccounts"])))))))

(clojure.core/defn- response-update-insight-response ([input] (response-update-insight-response nil input)) ([resultWrapper458087 input] (clojure.core/let [rawinput458086 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458088 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-insight-response ([input] (response-create-insight-response nil input)) ([resultWrapper458090 input] (clojure.core/let [rawinput458089 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458091 {"InsightArn" (rawinput458089 "InsightArn")}] (clojure.core/cond-> {:insight-arn (deser-non-empty-string (clojure.core/get-in letvar458091 ["InsightArn"]))}))))

(clojure.core/defn- response-list-members-response ([input] (response-list-members-response nil input)) ([resultWrapper458093 input] (clojure.core/let [rawinput458092 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar458094 {"Members" (rawinput458092 "Members"), "NextToken" (rawinput458092 "NextToken")}] (clojure.core/cond-> {} (letvar458094 "Members") (clojure.core/assoc :members (deser-member-list (clojure.core/get-in letvar458094 ["Members"]))) (letvar458094 "NextToken") (clojure.core/assoc :next-token (deser-non-empty-string (clojure.core/get-in letvar458094 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.securityhub/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #".*\S.*" s__21112__auto__))))
