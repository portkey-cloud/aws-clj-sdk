...
(clojure.core/defn- response-list-vocabularies-response ([input] (response-list-vocabularies-response nil input)) ([resultWrapper2123938 input] (clojure.core/let [rawinput2123937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123939 {"Status" (rawinput2123937 "Status"), "NextToken" (rawinput2123937 "NextToken"), "Vocabularies" (rawinput2123937 "Vocabularies")}] (clojure.core/cond-> {} (letvar2123939 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar2123939 ["Status"]))) (letvar2123939 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2123939 ["NextToken"]))) (letvar2123939 "Vocabularies") (clojure.core/assoc :vocabularies (deser-vocabularies (clojure.core/get-in letvar2123939 ["Vocabularies"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper2123941 input] (clojure.core/let [rawinput2123940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123942 {"Message" (rawinput2123940 "Message")}] (clojure.core/cond-> {} (letvar2123942 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar2123942 ["Message"])))))))

(clojure.core/defn- response-get-transcription-job-response ([input] (response-get-transcription-job-response nil input)) ([resultWrapper2123944 input] (clojure.core/let [rawinput2123943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123945 {"TranscriptionJob" (rawinput2123943 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar2123945 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar2123945 ["TranscriptionJob"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2123947 input] (clojure.core/let [rawinput2123946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123948 {"Message" (rawinput2123946 "Message")}] (clojure.core/cond-> {} (letvar2123948 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2123948 ["Message"])))))))

(clojure.core/defn- response-get-vocabulary-response ([input] (response-get-vocabulary-response nil input)) ([resultWrapper2123950 input] (clojure.core/let [rawinput2123949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123951 {"VocabularyName" (rawinput2123949 "VocabularyName"), "LanguageCode" (rawinput2123949 "LanguageCode"), "VocabularyState" (rawinput2123949 "VocabularyState"), "LastModifiedTime" (rawinput2123949 "LastModifiedTime"), "FailureReason" (rawinput2123949 "FailureReason"), "DownloadUri" (rawinput2123949 "DownloadUri")}] (clojure.core/cond-> {} (letvar2123951 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2123951 ["VocabularyName"]))) (letvar2123951 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2123951 ["LanguageCode"]))) (letvar2123951 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2123951 ["VocabularyState"]))) (letvar2123951 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2123951 ["LastModifiedTime"]))) (letvar2123951 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar2123951 ["FailureReason"]))) (letvar2123951 "DownloadUri") (clojure.core/assoc :download-uri (deser-uri (clojure.core/get-in letvar2123951 ["DownloadUri"])))))))

(clojure.core/defn- response-update-vocabulary-response ([input] (response-update-vocabulary-response nil input)) ([resultWrapper2123953 input] (clojure.core/let [rawinput2123952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123954 {"VocabularyName" (rawinput2123952 "VocabularyName"), "LanguageCode" (rawinput2123952 "LanguageCode"), "LastModifiedTime" (rawinput2123952 "LastModifiedTime"), "VocabularyState" (rawinput2123952 "VocabularyState")}] (clojure.core/cond-> {} (letvar2123954 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2123954 ["VocabularyName"]))) (letvar2123954 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2123954 ["LanguageCode"]))) (letvar2123954 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2123954 ["LastModifiedTime"]))) (letvar2123954 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2123954 ["VocabularyState"])))))))

(clojure.core/defn- response-list-transcription-jobs-response ([input] (response-list-transcription-jobs-response nil input)) ([resultWrapper2123956 input] (clojure.core/let [rawinput2123955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123957 {"Status" (rawinput2123955 "Status"), "NextToken" (rawinput2123955 "NextToken"), "TranscriptionJobSummaries" (rawinput2123955 "TranscriptionJobSummaries")}] (clojure.core/cond-> {} (letvar2123957 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar2123957 ["Status"]))) (letvar2123957 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2123957 ["NextToken"]))) (letvar2123957 "TranscriptionJobSummaries") (clojure.core/assoc :transcription-job-summaries (deser-transcription-job-summaries (clojure.core/get-in letvar2123957 ["TranscriptionJobSummaries"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper2123959 input] (clojure.core/let [rawinput2123958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123960 {"Message" (rawinput2123958 "Message")}] (clojure.core/cond-> {} (letvar2123960 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2123960 ["Message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper2123962 input] (clojure.core/let [rawinput2123961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123963 {"Message" (rawinput2123961 "Message")}] (clojure.core/cond-> {} (letvar2123963 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2123963 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper2123965 input] (clojure.core/let [rawinput2123964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123966 {"Message" (rawinput2123964 "Message")}] (clojure.core/cond-> {} (letvar2123966 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2123966 ["Message"])))))))

(clojure.core/defn- response-create-vocabulary-response ([input] (response-create-vocabulary-response nil input)) ([resultWrapper2123968 input] (clojure.core/let [rawinput2123967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123969 {"VocabularyName" (rawinput2123967 "VocabularyName"), "LanguageCode" (rawinput2123967 "LanguageCode"), "VocabularyState" (rawinput2123967 "VocabularyState"), "LastModifiedTime" (rawinput2123967 "LastModifiedTime"), "FailureReason" (rawinput2123967 "FailureReason")}] (clojure.core/cond-> {} (letvar2123969 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar2123969 ["VocabularyName"]))) (letvar2123969 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar2123969 ["LanguageCode"]))) (letvar2123969 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar2123969 ["VocabularyState"]))) (letvar2123969 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar2123969 ["LastModifiedTime"]))) (letvar2123969 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar2123969 ["FailureReason"])))))))

(clojure.core/defn- response-start-transcription-job-response ([input] (response-start-transcription-job-response nil input)) ([resultWrapper2123971 input] (clojure.core/let [rawinput2123970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2123972 {"TranscriptionJob" (rawinput2123970 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar2123972 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar2123972 ["TranscriptionJob"])))))))

(clojure.spec.alpha/def :portkey.aws.transcribe/media-sample-rate-hertz (clojure.spec.alpha/int-in 8000 48000))

(clojure.spec.alpha/def :portkey.aws.transcribe/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 200)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__1467903__auto__))))
