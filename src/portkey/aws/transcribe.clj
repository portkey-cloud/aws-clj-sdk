...
(clojure.core/defn- response-list-vocabularies-response ([input] (response-list-vocabularies-response nil input)) ([resultWrapper1850480 input] (clojure.core/let [rawinput1850479 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850481 {"Status" (rawinput1850479 "Status"), "NextToken" (rawinput1850479 "NextToken"), "Vocabularies" (rawinput1850479 "Vocabularies")}] (clojure.core/cond-> {} (letvar1850481 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar1850481 ["Status"]))) (letvar1850481 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1850481 ["NextToken"]))) (letvar1850481 "Vocabularies") (clojure.core/assoc :vocabularies (deser-vocabularies (clojure.core/get-in letvar1850481 ["Vocabularies"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1850483 input] (clojure.core/let [rawinput1850482 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850484 {"Message" (rawinput1850482 "Message")}] (clojure.core/cond-> {} (letvar1850484 "Message") (clojure.core/assoc :message (deser-failure-reason (clojure.core/get-in letvar1850484 ["Message"])))))))

(clojure.core/defn- response-get-transcription-job-response ([input] (response-get-transcription-job-response nil input)) ([resultWrapper1850486 input] (clojure.core/let [rawinput1850485 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850487 {"TranscriptionJob" (rawinput1850485 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar1850487 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar1850487 ["TranscriptionJob"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1850489 input] (clojure.core/let [rawinput1850488 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850490 {"Message" (rawinput1850488 "Message")}] (clojure.core/cond-> {} (letvar1850490 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1850490 ["Message"])))))))

(clojure.core/defn- response-get-vocabulary-response ([input] (response-get-vocabulary-response nil input)) ([resultWrapper1850492 input] (clojure.core/let [rawinput1850491 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850493 {"VocabularyName" (rawinput1850491 "VocabularyName"), "LanguageCode" (rawinput1850491 "LanguageCode"), "VocabularyState" (rawinput1850491 "VocabularyState"), "LastModifiedTime" (rawinput1850491 "LastModifiedTime"), "FailureReason" (rawinput1850491 "FailureReason"), "DownloadUri" (rawinput1850491 "DownloadUri")}] (clojure.core/cond-> {} (letvar1850493 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1850493 ["VocabularyName"]))) (letvar1850493 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1850493 ["LanguageCode"]))) (letvar1850493 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1850493 ["VocabularyState"]))) (letvar1850493 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1850493 ["LastModifiedTime"]))) (letvar1850493 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1850493 ["FailureReason"]))) (letvar1850493 "DownloadUri") (clojure.core/assoc :download-uri (deser-uri (clojure.core/get-in letvar1850493 ["DownloadUri"])))))))

(clojure.core/defn- response-update-vocabulary-response ([input] (response-update-vocabulary-response nil input)) ([resultWrapper1850495 input] (clojure.core/let [rawinput1850494 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850496 {"VocabularyName" (rawinput1850494 "VocabularyName"), "LanguageCode" (rawinput1850494 "LanguageCode"), "LastModifiedTime" (rawinput1850494 "LastModifiedTime"), "VocabularyState" (rawinput1850494 "VocabularyState")}] (clojure.core/cond-> {} (letvar1850496 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1850496 ["VocabularyName"]))) (letvar1850496 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1850496 ["LanguageCode"]))) (letvar1850496 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1850496 ["LastModifiedTime"]))) (letvar1850496 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1850496 ["VocabularyState"])))))))

(clojure.core/defn- response-list-transcription-jobs-response ([input] (response-list-transcription-jobs-response nil input)) ([resultWrapper1850498 input] (clojure.core/let [rawinput1850497 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850499 {"Status" (rawinput1850497 "Status"), "NextToken" (rawinput1850497 "NextToken"), "TranscriptionJobSummaries" (rawinput1850497 "TranscriptionJobSummaries")}] (clojure.core/cond-> {} (letvar1850499 "Status") (clojure.core/assoc :status (deser-transcription-job-status (clojure.core/get-in letvar1850499 ["Status"]))) (letvar1850499 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1850499 ["NextToken"]))) (letvar1850499 "TranscriptionJobSummaries") (clojure.core/assoc :transcription-job-summaries (deser-transcription-job-summaries (clojure.core/get-in letvar1850499 ["TranscriptionJobSummaries"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1850501 input] (clojure.core/let [rawinput1850500 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850502 {"Message" (rawinput1850500 "Message")}] (clojure.core/cond-> {} (letvar1850502 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1850502 ["Message"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper1850504 input] (clojure.core/let [rawinput1850503 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850505 {"Message" (rawinput1850503 "Message")}] (clojure.core/cond-> {} (letvar1850505 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1850505 ["Message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1850507 input] (clojure.core/let [rawinput1850506 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850508 {"Message" (rawinput1850506 "Message")}] (clojure.core/cond-> {} (letvar1850508 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1850508 ["Message"])))))))

(clojure.core/defn- response-create-vocabulary-response ([input] (response-create-vocabulary-response nil input)) ([resultWrapper1850510 input] (clojure.core/let [rawinput1850509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850511 {"VocabularyName" (rawinput1850509 "VocabularyName"), "LanguageCode" (rawinput1850509 "LanguageCode"), "VocabularyState" (rawinput1850509 "VocabularyState"), "LastModifiedTime" (rawinput1850509 "LastModifiedTime"), "FailureReason" (rawinput1850509 "FailureReason")}] (clojure.core/cond-> {} (letvar1850511 "VocabularyName") (clojure.core/assoc :vocabulary-name (deser-vocabulary-name (clojure.core/get-in letvar1850511 ["VocabularyName"]))) (letvar1850511 "LanguageCode") (clojure.core/assoc :language-code (deser-language-code (clojure.core/get-in letvar1850511 ["LanguageCode"]))) (letvar1850511 "VocabularyState") (clojure.core/assoc :vocabulary-state (deser-vocabulary-state (clojure.core/get-in letvar1850511 ["VocabularyState"]))) (letvar1850511 "LastModifiedTime") (clojure.core/assoc :last-modified-time (deser-date-time (clojure.core/get-in letvar1850511 ["LastModifiedTime"]))) (letvar1850511 "FailureReason") (clojure.core/assoc :failure-reason (deser-failure-reason (clojure.core/get-in letvar1850511 ["FailureReason"])))))))

(clojure.core/defn- response-start-transcription-job-response ([input] (response-start-transcription-job-response nil input)) ([resultWrapper1850513 input] (clojure.core/let [rawinput1850512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1850514 {"TranscriptionJob" (rawinput1850512 "TranscriptionJob")}] (clojure.core/cond-> {} (letvar1850514 "TranscriptionJob") (clojure.core/assoc :transcription-job (deser-transcription-job (clojure.core/get-in letvar1850514 ["TranscriptionJob"])))))))

(clojure.spec.alpha/def :portkey.aws.transcribe/media-sample-rate-hertz (clojure.spec.alpha/int-in 8000 48000))

(clojure.spec.alpha/def :portkey.aws.transcribe/output-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9][\.\-a-z0-9]{1,61}[a-z0-9]" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2000))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/phrase (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8192))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/vocabulary-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transcribe/transcription-job-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9a-zA-Z._-]+" s__21078__auto__))))
