...
(clojure.core/defn- response-delete-server-catalog-response ([input] (response-delete-server-catalog-response nil input)) ([resultWrapper2037237 input] (clojure.core/let [rawinput2037236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037238 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-app-response ([input] (response-create-app-response nil input)) ([resultWrapper2037240 input] (clojure.core/let [rawinput2037239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037241 {"appSummary" (rawinput2037239 "appSummary"), "serverGroups" (rawinput2037239 "serverGroups"), "tags" (rawinput2037239 "tags")}] (clojure.core/cond-> {} (letvar2037241 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2037241 ["appSummary"]))) (letvar2037241 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2037241 ["serverGroups"]))) (letvar2037241 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2037241 ["tags"])))))))

(clojure.core/defn- response-put-app-replication-configuration-response ([input] (response-put-app-replication-configuration-response nil input)) ([resultWrapper2037243 input] (clojure.core/let [rawinput2037242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037244 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper2037246 input] (clojure.core/let [rawinput2037245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037247 {"message" (rawinput2037245 "message")}] (clojure.core/cond-> {} (letvar2037247 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037247 ["message"])))))))

(clojure.core/defn- response-missing-required-parameter-exception ([input] (response-missing-required-parameter-exception nil input)) ([resultWrapper2037249 input] (clojure.core/let [rawinput2037248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037250 {"message" (rawinput2037248 "message")}] (clojure.core/cond-> {} (letvar2037250 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037250 ["message"])))))))

(clojure.core/defn- response-disassociate-connector-response ([input] (response-disassociate-connector-response nil input)) ([resultWrapper2037252 input] (clojure.core/let [rawinput2037251 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037253 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-replication-configuration-response ([input] (response-delete-app-replication-configuration-response nil input)) ([resultWrapper2037255 input] (clojure.core/let [rawinput2037254 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037256 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-app-response ([input] (response-get-app-response nil input)) ([resultWrapper2037258 input] (clojure.core/let [rawinput2037257 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037259 {"appSummary" (rawinput2037257 "appSummary"), "serverGroups" (rawinput2037257 "serverGroups"), "tags" (rawinput2037257 "tags")}] (clojure.core/cond-> {} (letvar2037259 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2037259 ["appSummary"]))) (letvar2037259 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2037259 ["serverGroups"]))) (letvar2037259 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2037259 ["tags"])))))))

(clojure.core/defn- response-launch-app-response ([input] (response-launch-app-response nil input)) ([resultWrapper2037261 input] (clojure.core/let [rawinput2037260 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037262 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-servers-response ([input] (response-get-servers-response nil input)) ([resultWrapper2037264 input] (clojure.core/let [rawinput2037263 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037265 {"lastModifiedOn" (rawinput2037263 "lastModifiedOn"), "serverCatalogStatus" (rawinput2037263 "serverCatalogStatus"), "serverList" (rawinput2037263 "serverList"), "nextToken" (rawinput2037263 "nextToken")}] (clojure.core/cond-> {} (letvar2037265 "lastModifiedOn") (clojure.core/assoc :last-modified-on (deser-timestamp (clojure.core/get-in letvar2037265 ["lastModifiedOn"]))) (letvar2037265 "serverCatalogStatus") (clojure.core/assoc :server-catalog-status (deser-server-catalog-status (clojure.core/get-in letvar2037265 ["serverCatalogStatus"]))) (letvar2037265 "serverList") (clojure.core/assoc :server-list (deser-server-list (clojure.core/get-in letvar2037265 ["serverList"]))) (letvar2037265 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2037265 ["nextToken"])))))))

(clojure.core/defn- response-internal-error ([input] (response-internal-error nil input)) ([resultWrapper2037267 input] (clojure.core/let [rawinput2037266 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037268 {"message" (rawinput2037266 "message")}] (clojure.core/cond-> {} (letvar2037268 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037268 ["message"])))))))

(clojure.core/defn- response-generate-change-set-response ([input] (response-generate-change-set-response nil input)) ([resultWrapper2037270 input] (clojure.core/let [rawinput2037269 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037271 {"s3Location" (rawinput2037269 "s3Location")}] (clojure.core/cond-> {} (letvar2037271 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2037271 ["s3Location"])))))))

(clojure.core/defn- response-list-apps-response ([input] (response-list-apps-response nil input)) ([resultWrapper2037273 input] (clojure.core/let [rawinput2037272 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037274 {"apps" (rawinput2037272 "apps"), "nextToken" (rawinput2037272 "nextToken")}] (clojure.core/cond-> {} (letvar2037274 "apps") (clojure.core/assoc :apps (deser-apps (clojure.core/get-in letvar2037274 ["apps"]))) (letvar2037274 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2037274 ["nextToken"])))))))

(clojure.core/defn- response-start-on-demand-replication-run-response ([input] (response-start-on-demand-replication-run-response nil input)) ([resultWrapper2037276 input] (clojure.core/let [rawinput2037275 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037277 {"replicationRunId" (rawinput2037275 "replicationRunId")}] (clojure.core/cond-> {} (letvar2037277 "replicationRunId") (clojure.core/assoc :replication-run-id (deser-replication-run-id (clojure.core/get-in letvar2037277 ["replicationRunId"])))))))

(clojure.core/defn- response-start-app-replication-response ([input] (response-start-app-replication-response nil input)) ([resultWrapper2037279 input] (clojure.core/let [rawinput2037278 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037280 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-generate-template-response ([input] (response-generate-template-response nil input)) ([resultWrapper2037282 input] (clojure.core/let [rawinput2037281 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037283 {"s3Location" (rawinput2037281 "s3Location")}] (clojure.core/cond-> {} (letvar2037283 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2037283 ["s3Location"])))))))

(clojure.core/defn- response-update-app-response ([input] (response-update-app-response nil input)) ([resultWrapper2037285 input] (clojure.core/let [rawinput2037284 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037286 {"appSummary" (rawinput2037284 "appSummary"), "serverGroups" (rawinput2037284 "serverGroups"), "tags" (rawinput2037284 "tags")}] (clojure.core/cond-> {} (letvar2037286 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2037286 ["appSummary"]))) (letvar2037286 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2037286 ["serverGroups"]))) (letvar2037286 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2037286 ["tags"])))))))

(clojure.core/defn- response-update-replication-job-response ([input] (response-update-replication-job-response nil input)) ([resultWrapper2037288 input] (clojure.core/let [rawinput2037287 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037289 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-server-catalog-response ([input] (response-import-server-catalog-response nil input)) ([resultWrapper2037291 input] (clojure.core/let [rawinput2037290 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037292 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-server-cannot-be-replicated-exception ([input] (response-server-cannot-be-replicated-exception nil input)) ([resultWrapper2037294 input] (clojure.core/let [rawinput2037293 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037295 {"message" (rawinput2037293 "message")}] (clojure.core/cond-> {} (letvar2037295 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037295 ["message"])))))))

(clojure.core/defn- response-temporarily-unavailable-exception ([input] (response-temporarily-unavailable-exception nil input)) ([resultWrapper2037297 input] (clojure.core/let [rawinput2037296 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037298 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-response ([input] (response-delete-app-response nil input)) ([resultWrapper2037300 input] (clojure.core/let [rawinput2037299 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037301 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-replication-job-response ([input] (response-delete-replication-job-response nil input)) ([resultWrapper2037303 input] (clojure.core/let [rawinput2037302 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037304 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-replication-job-response ([input] (response-create-replication-job-response nil input)) ([resultWrapper2037306 input] (clojure.core/let [rawinput2037305 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037307 {"replicationJobId" (rawinput2037305 "replicationJobId")}] (clojure.core/cond-> {} (letvar2037307 "replicationJobId") (clojure.core/assoc :replication-job-id (deser-replication-job-id (clojure.core/get-in letvar2037307 ["replicationJobId"])))))))

(clojure.core/defn- response-no-connectors-available-exception ([input] (response-no-connectors-available-exception nil input)) ([resultWrapper2037309 input] (clojure.core/let [rawinput2037308 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037310 {"message" (rawinput2037308 "message")}] (clojure.core/cond-> {} (letvar2037310 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037310 ["message"])))))))

(clojure.core/defn- response-get-app-replication-configuration-response ([input] (response-get-app-replication-configuration-response nil input)) ([resultWrapper2037312 input] (clojure.core/let [rawinput2037311 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037313 {"serverGroupReplicationConfigurations" (rawinput2037311 "serverGroupReplicationConfigurations")}] (clojure.core/cond-> {} (letvar2037313 "serverGroupReplicationConfigurations") (clojure.core/assoc :server-group-replication-configurations (deser-server-group-replication-configurations (clojure.core/get-in letvar2037313 ["serverGroupReplicationConfigurations"])))))))

(clojure.core/defn- response-unauthorized-operation-exception ([input] (response-unauthorized-operation-exception nil input)) ([resultWrapper2037315 input] (clojure.core/let [rawinput2037314 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037316 {"message" (rawinput2037314 "message")}] (clojure.core/cond-> {} (letvar2037316 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037316 ["message"])))))))

(clojure.core/defn- response-replication-job-already-exists-exception ([input] (response-replication-job-already-exists-exception nil input)) ([resultWrapper2037318 input] (clojure.core/let [rawinput2037317 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037319 {"message" (rawinput2037317 "message")}] (clojure.core/cond-> {} (letvar2037319 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037319 ["message"])))))))

(clojure.core/defn- response-put-app-launch-configuration-response ([input] (response-put-app-launch-configuration-response nil input)) ([resultWrapper2037321 input] (clojure.core/let [rawinput2037320 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037322 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-launch-configuration-response ([input] (response-delete-app-launch-configuration-response nil input)) ([resultWrapper2037324 input] (clojure.core/let [rawinput2037323 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037325 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-replication-jobs-response ([input] (response-get-replication-jobs-response nil input)) ([resultWrapper2037327 input] (clojure.core/let [rawinput2037326 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037328 {"replicationJobList" (rawinput2037326 "replicationJobList"), "nextToken" (rawinput2037326 "nextToken")}] (clojure.core/cond-> {} (letvar2037328 "replicationJobList") (clojure.core/assoc :replication-job-list (deser-replication-job-list (clojure.core/get-in letvar2037328 ["replicationJobList"]))) (letvar2037328 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2037328 ["nextToken"])))))))

(clojure.core/defn- response-get-replication-runs-response ([input] (response-get-replication-runs-response nil input)) ([resultWrapper2037330 input] (clojure.core/let [rawinput2037329 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037331 {"replicationJob" (rawinput2037329 "replicationJob"), "replicationRunList" (rawinput2037329 "replicationRunList"), "nextToken" (rawinput2037329 "nextToken")}] (clojure.core/cond-> {} (letvar2037331 "replicationJob") (clojure.core/assoc :replication-job (deser-replication-job (clojure.core/get-in letvar2037331 ["replicationJob"]))) (letvar2037331 "replicationRunList") (clojure.core/assoc :replication-run-list (deser-replication-run-list (clojure.core/get-in letvar2037331 ["replicationRunList"]))) (letvar2037331 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2037331 ["nextToken"])))))))

(clojure.core/defn- response-terminate-app-response ([input] (response-terminate-app-response nil input)) ([resultWrapper2037333 input] (clojure.core/let [rawinput2037332 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037334 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-connectors-response ([input] (response-get-connectors-response nil input)) ([resultWrapper2037336 input] (clojure.core/let [rawinput2037335 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037337 {"connectorList" (rawinput2037335 "connectorList"), "nextToken" (rawinput2037335 "nextToken")}] (clojure.core/cond-> {} (letvar2037337 "connectorList") (clojure.core/assoc :connector-list (deser-connector-list (clojure.core/get-in letvar2037337 ["connectorList"]))) (letvar2037337 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2037337 ["nextToken"])))))))

(clojure.core/defn- response-replication-run-limit-exceeded-exception ([input] (response-replication-run-limit-exceeded-exception nil input)) ([resultWrapper2037339 input] (clojure.core/let [rawinput2037338 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037340 {"message" (rawinput2037338 "message")}] (clojure.core/cond-> {} (letvar2037340 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037340 ["message"])))))))

(clojure.core/defn- response-stop-app-replication-response ([input] (response-stop-app-replication-response nil input)) ([resultWrapper2037342 input] (clojure.core/let [rawinput2037341 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037343 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2037345 input] (clojure.core/let [rawinput2037344 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037346 {"message" (rawinput2037344 "message")}] (clojure.core/cond-> {} (letvar2037346 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037346 ["message"])))))))

(clojure.core/defn- response-replication-job-not-found-exception ([input] (response-replication-job-not-found-exception nil input)) ([resultWrapper2037348 input] (clojure.core/let [rawinput2037347 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037349 {"message" (rawinput2037347 "message")}] (clojure.core/cond-> {} (letvar2037349 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2037349 ["message"])))))))

(clojure.core/defn- response-get-app-launch-configuration-response ([input] (response-get-app-launch-configuration-response nil input)) ([resultWrapper2037351 input] (clojure.core/let [rawinput2037350 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2037352 {"appId" (rawinput2037350 "appId"), "roleName" (rawinput2037350 "roleName"), "serverGroupLaunchConfigurations" (rawinput2037350 "serverGroupLaunchConfigurations")}] (clojure.core/cond-> {} (letvar2037352 "appId") (clojure.core/assoc :app-id (deser-app-id (clojure.core/get-in letvar2037352 ["appId"]))) (letvar2037352 "roleName") (clojure.core/assoc :role-name (deser-role-name (clojure.core/get-in letvar2037352 ["roleName"]))) (letvar2037352 "serverGroupLaunchConfigurations") (clojure.core/assoc :server-group-launch-configurations (deser-server-group-launch-configurations (clojure.core/get-in letvar2037352 ["serverGroupLaunchConfigurations"])))))))
