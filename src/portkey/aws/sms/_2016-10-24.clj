...
(clojure.core/defn- response-delete-server-catalog-response ([input] (response-delete-server-catalog-response nil input)) ([resultWrapper2038595 input] (clojure.core/let [rawinput2038594 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038596 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-app-response ([input] (response-create-app-response nil input)) ([resultWrapper2038598 input] (clojure.core/let [rawinput2038597 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038599 {"appSummary" (rawinput2038597 "appSummary"), "serverGroups" (rawinput2038597 "serverGroups"), "tags" (rawinput2038597 "tags")}] (clojure.core/cond-> {} (letvar2038599 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2038599 ["appSummary"]))) (letvar2038599 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2038599 ["serverGroups"]))) (letvar2038599 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2038599 ["tags"])))))))

(clojure.core/defn- response-put-app-replication-configuration-response ([input] (response-put-app-replication-configuration-response nil input)) ([resultWrapper2038601 input] (clojure.core/let [rawinput2038600 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038602 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-operation-not-permitted-exception ([input] (response-operation-not-permitted-exception nil input)) ([resultWrapper2038604 input] (clojure.core/let [rawinput2038603 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038605 {"message" (rawinput2038603 "message")}] (clojure.core/cond-> {} (letvar2038605 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038605 ["message"])))))))

(clojure.core/defn- response-missing-required-parameter-exception ([input] (response-missing-required-parameter-exception nil input)) ([resultWrapper2038607 input] (clojure.core/let [rawinput2038606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038608 {"message" (rawinput2038606 "message")}] (clojure.core/cond-> {} (letvar2038608 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038608 ["message"])))))))

(clojure.core/defn- response-disassociate-connector-response ([input] (response-disassociate-connector-response nil input)) ([resultWrapper2038610 input] (clojure.core/let [rawinput2038609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038611 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-replication-configuration-response ([input] (response-delete-app-replication-configuration-response nil input)) ([resultWrapper2038613 input] (clojure.core/let [rawinput2038612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038614 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-app-response ([input] (response-get-app-response nil input)) ([resultWrapper2038616 input] (clojure.core/let [rawinput2038615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038617 {"appSummary" (rawinput2038615 "appSummary"), "serverGroups" (rawinput2038615 "serverGroups"), "tags" (rawinput2038615 "tags")}] (clojure.core/cond-> {} (letvar2038617 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2038617 ["appSummary"]))) (letvar2038617 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2038617 ["serverGroups"]))) (letvar2038617 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2038617 ["tags"])))))))

(clojure.core/defn- response-launch-app-response ([input] (response-launch-app-response nil input)) ([resultWrapper2038619 input] (clojure.core/let [rawinput2038618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038620 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-servers-response ([input] (response-get-servers-response nil input)) ([resultWrapper2038622 input] (clojure.core/let [rawinput2038621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038623 {"lastModifiedOn" (rawinput2038621 "lastModifiedOn"), "serverCatalogStatus" (rawinput2038621 "serverCatalogStatus"), "serverList" (rawinput2038621 "serverList"), "nextToken" (rawinput2038621 "nextToken")}] (clojure.core/cond-> {} (letvar2038623 "lastModifiedOn") (clojure.core/assoc :last-modified-on (deser-timestamp (clojure.core/get-in letvar2038623 ["lastModifiedOn"]))) (letvar2038623 "serverCatalogStatus") (clojure.core/assoc :server-catalog-status (deser-server-catalog-status (clojure.core/get-in letvar2038623 ["serverCatalogStatus"]))) (letvar2038623 "serverList") (clojure.core/assoc :server-list (deser-server-list (clojure.core/get-in letvar2038623 ["serverList"]))) (letvar2038623 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2038623 ["nextToken"])))))))

(clojure.core/defn- response-internal-error ([input] (response-internal-error nil input)) ([resultWrapper2038625 input] (clojure.core/let [rawinput2038624 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038626 {"message" (rawinput2038624 "message")}] (clojure.core/cond-> {} (letvar2038626 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038626 ["message"])))))))

(clojure.core/defn- response-generate-change-set-response ([input] (response-generate-change-set-response nil input)) ([resultWrapper2038628 input] (clojure.core/let [rawinput2038627 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038629 {"s3Location" (rawinput2038627 "s3Location")}] (clojure.core/cond-> {} (letvar2038629 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2038629 ["s3Location"])))))))

(clojure.core/defn- response-list-apps-response ([input] (response-list-apps-response nil input)) ([resultWrapper2038631 input] (clojure.core/let [rawinput2038630 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038632 {"apps" (rawinput2038630 "apps"), "nextToken" (rawinput2038630 "nextToken")}] (clojure.core/cond-> {} (letvar2038632 "apps") (clojure.core/assoc :apps (deser-apps (clojure.core/get-in letvar2038632 ["apps"]))) (letvar2038632 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2038632 ["nextToken"])))))))

(clojure.core/defn- response-start-on-demand-replication-run-response ([input] (response-start-on-demand-replication-run-response nil input)) ([resultWrapper2038634 input] (clojure.core/let [rawinput2038633 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038635 {"replicationRunId" (rawinput2038633 "replicationRunId")}] (clojure.core/cond-> {} (letvar2038635 "replicationRunId") (clojure.core/assoc :replication-run-id (deser-replication-run-id (clojure.core/get-in letvar2038635 ["replicationRunId"])))))))

(clojure.core/defn- response-start-app-replication-response ([input] (response-start-app-replication-response nil input)) ([resultWrapper2038637 input] (clojure.core/let [rawinput2038636 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038638 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-generate-template-response ([input] (response-generate-template-response nil input)) ([resultWrapper2038640 input] (clojure.core/let [rawinput2038639 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038641 {"s3Location" (rawinput2038639 "s3Location")}] (clojure.core/cond-> {} (letvar2038641 "s3Location") (clojure.core/assoc :s-3-location (deser-s-3-location (clojure.core/get-in letvar2038641 ["s3Location"])))))))

(clojure.core/defn- response-update-app-response ([input] (response-update-app-response nil input)) ([resultWrapper2038643 input] (clojure.core/let [rawinput2038642 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038644 {"appSummary" (rawinput2038642 "appSummary"), "serverGroups" (rawinput2038642 "serverGroups"), "tags" (rawinput2038642 "tags")}] (clojure.core/cond-> {} (letvar2038644 "appSummary") (clojure.core/assoc :app-summary (deser-app-summary (clojure.core/get-in letvar2038644 ["appSummary"]))) (letvar2038644 "serverGroups") (clojure.core/assoc :server-groups (deser-server-groups (clojure.core/get-in letvar2038644 ["serverGroups"]))) (letvar2038644 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2038644 ["tags"])))))))

(clojure.core/defn- response-update-replication-job-response ([input] (response-update-replication-job-response nil input)) ([resultWrapper2038646 input] (clojure.core/let [rawinput2038645 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038647 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-import-server-catalog-response ([input] (response-import-server-catalog-response nil input)) ([resultWrapper2038649 input] (clojure.core/let [rawinput2038648 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038650 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-server-cannot-be-replicated-exception ([input] (response-server-cannot-be-replicated-exception nil input)) ([resultWrapper2038652 input] (clojure.core/let [rawinput2038651 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038653 {"message" (rawinput2038651 "message")}] (clojure.core/cond-> {} (letvar2038653 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038653 ["message"])))))))

(clojure.core/defn- response-temporarily-unavailable-exception ([input] (response-temporarily-unavailable-exception nil input)) ([resultWrapper2038655 input] (clojure.core/let [rawinput2038654 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038656 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-response ([input] (response-delete-app-response nil input)) ([resultWrapper2038658 input] (clojure.core/let [rawinput2038657 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038659 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-replication-job-response ([input] (response-delete-replication-job-response nil input)) ([resultWrapper2038661 input] (clojure.core/let [rawinput2038660 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038662 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-replication-job-response ([input] (response-create-replication-job-response nil input)) ([resultWrapper2038664 input] (clojure.core/let [rawinput2038663 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038665 {"replicationJobId" (rawinput2038663 "replicationJobId")}] (clojure.core/cond-> {} (letvar2038665 "replicationJobId") (clojure.core/assoc :replication-job-id (deser-replication-job-id (clojure.core/get-in letvar2038665 ["replicationJobId"])))))))

(clojure.core/defn- response-no-connectors-available-exception ([input] (response-no-connectors-available-exception nil input)) ([resultWrapper2038667 input] (clojure.core/let [rawinput2038666 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038668 {"message" (rawinput2038666 "message")}] (clojure.core/cond-> {} (letvar2038668 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038668 ["message"])))))))

(clojure.core/defn- response-get-app-replication-configuration-response ([input] (response-get-app-replication-configuration-response nil input)) ([resultWrapper2038670 input] (clojure.core/let [rawinput2038669 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038671 {"serverGroupReplicationConfigurations" (rawinput2038669 "serverGroupReplicationConfigurations")}] (clojure.core/cond-> {} (letvar2038671 "serverGroupReplicationConfigurations") (clojure.core/assoc :server-group-replication-configurations (deser-server-group-replication-configurations (clojure.core/get-in letvar2038671 ["serverGroupReplicationConfigurations"])))))))

(clojure.core/defn- response-unauthorized-operation-exception ([input] (response-unauthorized-operation-exception nil input)) ([resultWrapper2038673 input] (clojure.core/let [rawinput2038672 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038674 {"message" (rawinput2038672 "message")}] (clojure.core/cond-> {} (letvar2038674 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038674 ["message"])))))))

(clojure.core/defn- response-replication-job-already-exists-exception ([input] (response-replication-job-already-exists-exception nil input)) ([resultWrapper2038676 input] (clojure.core/let [rawinput2038675 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038677 {"message" (rawinput2038675 "message")}] (clojure.core/cond-> {} (letvar2038677 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038677 ["message"])))))))

(clojure.core/defn- response-put-app-launch-configuration-response ([input] (response-put-app-launch-configuration-response nil input)) ([resultWrapper2038679 input] (clojure.core/let [rawinput2038678 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038680 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-app-launch-configuration-response ([input] (response-delete-app-launch-configuration-response nil input)) ([resultWrapper2038682 input] (clojure.core/let [rawinput2038681 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038683 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-replication-jobs-response ([input] (response-get-replication-jobs-response nil input)) ([resultWrapper2038685 input] (clojure.core/let [rawinput2038684 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038686 {"replicationJobList" (rawinput2038684 "replicationJobList"), "nextToken" (rawinput2038684 "nextToken")}] (clojure.core/cond-> {} (letvar2038686 "replicationJobList") (clojure.core/assoc :replication-job-list (deser-replication-job-list (clojure.core/get-in letvar2038686 ["replicationJobList"]))) (letvar2038686 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2038686 ["nextToken"])))))))

(clojure.core/defn- response-get-replication-runs-response ([input] (response-get-replication-runs-response nil input)) ([resultWrapper2038688 input] (clojure.core/let [rawinput2038687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038689 {"replicationJob" (rawinput2038687 "replicationJob"), "replicationRunList" (rawinput2038687 "replicationRunList"), "nextToken" (rawinput2038687 "nextToken")}] (clojure.core/cond-> {} (letvar2038689 "replicationJob") (clojure.core/assoc :replication-job (deser-replication-job (clojure.core/get-in letvar2038689 ["replicationJob"]))) (letvar2038689 "replicationRunList") (clojure.core/assoc :replication-run-list (deser-replication-run-list (clojure.core/get-in letvar2038689 ["replicationRunList"]))) (letvar2038689 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2038689 ["nextToken"])))))))

(clojure.core/defn- response-terminate-app-response ([input] (response-terminate-app-response nil input)) ([resultWrapper2038691 input] (clojure.core/let [rawinput2038690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038692 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-connectors-response ([input] (response-get-connectors-response nil input)) ([resultWrapper2038694 input] (clojure.core/let [rawinput2038693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038695 {"connectorList" (rawinput2038693 "connectorList"), "nextToken" (rawinput2038693 "nextToken")}] (clojure.core/cond-> {} (letvar2038695 "connectorList") (clojure.core/assoc :connector-list (deser-connector-list (clojure.core/get-in letvar2038695 ["connectorList"]))) (letvar2038695 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2038695 ["nextToken"])))))))

(clojure.core/defn- response-replication-run-limit-exceeded-exception ([input] (response-replication-run-limit-exceeded-exception nil input)) ([resultWrapper2038697 input] (clojure.core/let [rawinput2038696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038698 {"message" (rawinput2038696 "message")}] (clojure.core/cond-> {} (letvar2038698 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038698 ["message"])))))))

(clojure.core/defn- response-stop-app-replication-response ([input] (response-stop-app-replication-response nil input)) ([resultWrapper2038700 input] (clojure.core/let [rawinput2038699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038701 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2038703 input] (clojure.core/let [rawinput2038702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038704 {"message" (rawinput2038702 "message")}] (clojure.core/cond-> {} (letvar2038704 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038704 ["message"])))))))

(clojure.core/defn- response-replication-job-not-found-exception ([input] (response-replication-job-not-found-exception nil input)) ([resultWrapper2038706 input] (clojure.core/let [rawinput2038705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038707 {"message" (rawinput2038705 "message")}] (clojure.core/cond-> {} (letvar2038707 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar2038707 ["message"])))))))

(clojure.core/defn- response-get-app-launch-configuration-response ([input] (response-get-app-launch-configuration-response nil input)) ([resultWrapper2038709 input] (clojure.core/let [rawinput2038708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2038710 {"appId" (rawinput2038708 "appId"), "roleName" (rawinput2038708 "roleName"), "serverGroupLaunchConfigurations" (rawinput2038708 "serverGroupLaunchConfigurations")}] (clojure.core/cond-> {} (letvar2038710 "appId") (clojure.core/assoc :app-id (deser-app-id (clojure.core/get-in letvar2038710 ["appId"]))) (letvar2038710 "roleName") (clojure.core/assoc :role-name (deser-role-name (clojure.core/get-in letvar2038710 ["roleName"]))) (letvar2038710 "serverGroupLaunchConfigurations") (clojure.core/assoc :server-group-launch-configurations (deser-server-group-launch-configurations (clojure.core/get-in letvar2038710 ["serverGroupLaunchConfigurations"])))))))
