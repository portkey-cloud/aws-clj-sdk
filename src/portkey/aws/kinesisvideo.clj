...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 1 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 0 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 512))))

(clojure.spec.alpha/def :portkey.aws.kinesisvideo/error-message (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.kinesisvideo/create-stream-input (clojure.spec.alpha/keys :req-un [:portkey.aws.kinesisvideo/stream-name] :opt-un [:portkey.aws.kinesisvideo/device-name :portkey.aws.kinesisvideo/media-type :portkey.aws.kinesisvideo/kms-key-id :portkey.aws.kinesisvideo/data-retention-in-hours]))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 0 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 1 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 2048))))
...
(clojure.core/defn get-data-endpoint ([get-data-endpoint-inputinput] (clojure.core/let [request-function-result__43533__auto__ (req-get-data-endpoint-input get-data-endpoint-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisvideo/endpoints, :http.request.spec/output-spec :portkey.aws.kinesisvideo/get-data-endpoint-output, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/getDataEndpoint", :http.request.configuration/version "2017-09-30", :http.request.configuration/service-id "Kinesis Video", :http.request.spec/input-spec :portkey.aws.kinesisvideo/get-data-endpoint-input, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "GetDataEndpoint", :http.request.spec/error-spec {"InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception, "ResourceNotFoundException" :portkey.aws.kinesisvideo/resource-not-found-exception, "ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "NotAuthorizedException" :portkey.aws.kinesisvideo/not-authorized-exception}})))))
...
(clojure.core/defn list-streams ([] (list-streams {})) ([list-streams-inputinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-streams-input list-streams-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisvideo/endpoints, :http.request.spec/output-spec :portkey.aws.kinesisvideo/list-streams-output, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/listStreams", :http.request.configuration/version "2017-09-30", :http.request.configuration/service-id "Kinesis Video", :http.request.spec/input-spec :portkey.aws.kinesisvideo/list-streams-input, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "ListStreams", :http.request.spec/error-spec {"ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception}})))))
...
(clojure.core/defn update-data-retention ([update-data-retention-inputinput] (clojure.core/let [request-function-result__43533__auto__ (req-update-data-retention-input update-data-retention-inputinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.kinesisvideo/endpoints, :http.request.spec/output-spec :portkey.aws.kinesisvideo/update-data-retention-output, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/updateDataRetention", :http.request.configuration/version "2017-09-30", :http.request.configuration/service-id "Kinesis Video", :http.request.spec/input-spec :portkey.aws.kinesisvideo/update-data-retention-input, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/action "UpdateDataRetention", :http.request.spec/error-spec {"ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception, "ResourceNotFoundException" :portkey.aws.kinesisvideo/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisvideo/resource-in-use-exception, "NotAuthorizedException" :portkey.aws.kinesisvideo/not-authorized-exception, "VersionMismatchException" :portkey.aws.kinesisvideo/version-mismatch-exception}})))))
