...
(clojure.core/defn- response-tags-per-resource-exceeded-limit-exception ([input] (response-tags-per-resource-exceeded-limit-exception nil input)) ([resultWrapper1258209 input] (clojure.core/let [rawinput1258208 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258210 {"Message" (rawinput1258208 "Message")}] (clojure.core/cond-> {} (letvar1258210 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258210 ["Message"])))))))

(clojure.core/defn- response-version-mismatch-exception ([input] (response-version-mismatch-exception nil input)) ([resultWrapper1258212 input] (clojure.core/let [rawinput1258211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258213 {"Message" (rawinput1258211 "Message")}] (clojure.core/cond-> {} (letvar1258213 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258213 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1258215 input] (clojure.core/let [rawinput1258214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258216 {"NextToken" (rawinput1258214 "NextToken"), "Tags" (rawinput1258214 "Tags")}] (clojure.core/cond-> {} (letvar1258216 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1258216 ["NextToken"]))) (letvar1258216 "Tags") (clojure.core/assoc :tags (deser-resource-tags (clojure.core/get-in letvar1258216 ["Tags"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1258218 input] (clojure.core/let [rawinput1258217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258219 {"Message" (rawinput1258217 "Message")}] (clojure.core/cond-> {} (letvar1258219 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258219 ["Message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1258221 input] (clojure.core/let [rawinput1258220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258222 {"StreamInfo" (rawinput1258220 "StreamInfo")}] (clojure.core/cond-> {} (letvar1258222 "StreamInfo") (clojure.core/assoc :stream-info (deser-stream-info (clojure.core/get-in letvar1258222 ["StreamInfo"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1258224 input] (clojure.core/let [rawinput1258223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258225 {"Message" (rawinput1258223 "Message")}] (clojure.core/cond-> {} (letvar1258225 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258225 ["Message"])))))))

(clojure.core/defn- response-tag-stream-output ([input] (response-tag-stream-output nil input)) ([resultWrapper1258227 input] (clojure.core/let [rawinput1258226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258228 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-stream-output ([input] (response-delete-stream-output nil input)) ([resultWrapper1258230 input] (clojure.core/let [rawinput1258229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258231 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-stream-output ([input] (response-untag-stream-output nil input)) ([resultWrapper1258233 input] (clojure.core/let [rawinput1258232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258234 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1258236 input] (clojure.core/let [rawinput1258235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258237 {"Message" (rawinput1258235 "Message")}] (clojure.core/cond-> {} (letvar1258237 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258237 ["Message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1258239 input] (clojure.core/let [rawinput1258238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258240 {"StreamInfoList" (rawinput1258238 "StreamInfoList"), "NextToken" (rawinput1258238 "NextToken")}] (clojure.core/cond-> {} (letvar1258240 "StreamInfoList") (clojure.core/assoc :stream-info-list (deser-stream-info-list (clojure.core/get-in letvar1258240 ["StreamInfoList"]))) (letvar1258240 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1258240 ["NextToken"])))))))

(clojure.core/defn- response-invalid-device-exception ([input] (response-invalid-device-exception nil input)) ([resultWrapper1258242 input] (clojure.core/let [rawinput1258241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258243 {"Message" (rawinput1258241 "Message")}] (clojure.core/cond-> {} (letvar1258243 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258243 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper1258245 input] (clojure.core/let [rawinput1258244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258246 {"Message" (rawinput1258244 "Message")}] (clojure.core/cond-> {} (letvar1258246 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258246 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1258248 input] (clojure.core/let [rawinput1258247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258249 {"Message" (rawinput1258247 "Message")}] (clojure.core/cond-> {} (letvar1258249 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258249 ["Message"])))))))

(clojure.core/defn- response-device-stream-limit-exceeded-exception ([input] (response-device-stream-limit-exceeded-exception nil input)) ([resultWrapper1258251 input] (clojure.core/let [rawinput1258250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258252 {"Message" (rawinput1258250 "Message")}] (clojure.core/cond-> {} (letvar1258252 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258252 ["Message"])))))))

(clojure.core/defn- response-get-data-endpoint-output ([input] (response-get-data-endpoint-output nil input)) ([resultWrapper1258254 input] (clojure.core/let [rawinput1258253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258255 {"DataEndpoint" (rawinput1258253 "DataEndpoint")}] (clojure.core/cond-> {} (letvar1258255 "DataEndpoint") (clojure.core/assoc :data-endpoint (deser-data-endpoint (clojure.core/get-in letvar1258255 ["DataEndpoint"])))))))

(clojure.core/defn- response-create-stream-output ([input] (response-create-stream-output nil input)) ([resultWrapper1258257 input] (clojure.core/let [rawinput1258256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258258 {"StreamARN" (rawinput1258256 "StreamARN")}] (clojure.core/cond-> {} (letvar1258258 "StreamARN") (clojure.core/assoc :stream-arn (deser-resource-arn (clojure.core/get-in letvar1258258 ["StreamARN"])))))))

(clojure.core/defn- response-invalid-resource-format-exception ([input] (response-invalid-resource-format-exception nil input)) ([resultWrapper1258260 input] (clojure.core/let [rawinput1258259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258261 {"Message" (rawinput1258259 "Message")}] (clojure.core/cond-> {} (letvar1258261 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258261 ["Message"])))))))

(clojure.core/defn- response-update-data-retention-output ([input] (response-update-data-retention-output nil input)) ([resultWrapper1258263 input] (clojure.core/let [rawinput1258262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258264 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-account-stream-limit-exceeded-exception ([input] (response-account-stream-limit-exceeded-exception nil input)) ([resultWrapper1258266 input] (clojure.core/let [rawinput1258265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258267 {"Message" (rawinput1258265 "Message")}] (clojure.core/cond-> {} (letvar1258267 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258267 ["Message"])))))))

(clojure.core/defn- response-update-stream-output ([input] (response-update-stream-output nil input)) ([resultWrapper1258269 input] (clojure.core/let [rawinput1258268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258270 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/media-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w\-\.\+]+/[\w\-\.\+]+(,[\w\-\.\+]+/[\w\-\.\+]+)*" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__1012854__auto__))))
