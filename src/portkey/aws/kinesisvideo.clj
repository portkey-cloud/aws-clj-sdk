...
(clojure.core/defn- response-tags-per-resource-exceeded-limit-exception ([input] (response-tags-per-resource-exceeded-limit-exception nil input)) ([resultWrapper265212 input] (clojure.core/let [rawinput265211 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265213 {"Message" (rawinput265211 "Message")}] (clojure.core/cond-> {} (letvar265213 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265213 ["Message"])))))))

(clojure.core/defn- response-version-mismatch-exception ([input] (response-version-mismatch-exception nil input)) ([resultWrapper265215 input] (clojure.core/let [rawinput265214 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265216 {"Message" (rawinput265214 "Message")}] (clojure.core/cond-> {} (letvar265216 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265216 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper265218 input] (clojure.core/let [rawinput265217 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265219 {"NextToken" (rawinput265217 "NextToken"), "Tags" (rawinput265217 "Tags")}] (clojure.core/cond-> {} (letvar265219 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar265219 ["NextToken"]))) (letvar265219 "Tags") (clojure.core/assoc :tags (deser-resource-tags (clojure.core/get-in letvar265219 ["Tags"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper265221 input] (clojure.core/let [rawinput265220 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265222 {"Message" (rawinput265220 "Message")}] (clojure.core/cond-> {} (letvar265222 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265222 ["Message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper265224 input] (clojure.core/let [rawinput265223 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265225 {"StreamInfo" (rawinput265223 "StreamInfo")}] (clojure.core/cond-> {} (letvar265225 "StreamInfo") (clojure.core/assoc :stream-info (deser-stream-info (clojure.core/get-in letvar265225 ["StreamInfo"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper265227 input] (clojure.core/let [rawinput265226 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265228 {"Message" (rawinput265226 "Message")}] (clojure.core/cond-> {} (letvar265228 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265228 ["Message"])))))))

(clojure.core/defn- response-tag-stream-output ([input] (response-tag-stream-output nil input)) ([resultWrapper265230 input] (clojure.core/let [rawinput265229 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265231 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-stream-output ([input] (response-delete-stream-output nil input)) ([resultWrapper265233 input] (clojure.core/let [rawinput265232 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265234 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-stream-output ([input] (response-untag-stream-output nil input)) ([resultWrapper265236 input] (clojure.core/let [rawinput265235 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265237 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper265239 input] (clojure.core/let [rawinput265238 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265240 {"Message" (rawinput265238 "Message")}] (clojure.core/cond-> {} (letvar265240 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265240 ["Message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper265242 input] (clojure.core/let [rawinput265241 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265243 {"StreamInfoList" (rawinput265241 "StreamInfoList"), "NextToken" (rawinput265241 "NextToken")}] (clojure.core/cond-> {} (letvar265243 "StreamInfoList") (clojure.core/assoc :stream-info-list (deser-stream-info-list (clojure.core/get-in letvar265243 ["StreamInfoList"]))) (letvar265243 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar265243 ["NextToken"])))))))

(clojure.core/defn- response-invalid-device-exception ([input] (response-invalid-device-exception nil input)) ([resultWrapper265245 input] (clojure.core/let [rawinput265244 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265246 {"Message" (rawinput265244 "Message")}] (clojure.core/cond-> {} (letvar265246 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265246 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper265248 input] (clojure.core/let [rawinput265247 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265249 {"Message" (rawinput265247 "Message")}] (clojure.core/cond-> {} (letvar265249 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265249 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper265251 input] (clojure.core/let [rawinput265250 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265252 {"Message" (rawinput265250 "Message")}] (clojure.core/cond-> {} (letvar265252 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265252 ["Message"])))))))

(clojure.core/defn- response-device-stream-limit-exceeded-exception ([input] (response-device-stream-limit-exceeded-exception nil input)) ([resultWrapper265254 input] (clojure.core/let [rawinput265253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265255 {"Message" (rawinput265253 "Message")}] (clojure.core/cond-> {} (letvar265255 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265255 ["Message"])))))))

(clojure.core/defn- response-get-data-endpoint-output ([input] (response-get-data-endpoint-output nil input)) ([resultWrapper265257 input] (clojure.core/let [rawinput265256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265258 {"DataEndpoint" (rawinput265256 "DataEndpoint")}] (clojure.core/cond-> {} (letvar265258 "DataEndpoint") (clojure.core/assoc :data-endpoint (deser-data-endpoint (clojure.core/get-in letvar265258 ["DataEndpoint"])))))))

(clojure.core/defn- response-create-stream-output ([input] (response-create-stream-output nil input)) ([resultWrapper265260 input] (clojure.core/let [rawinput265259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265261 {"StreamARN" (rawinput265259 "StreamARN")}] (clojure.core/cond-> {} (letvar265261 "StreamARN") (clojure.core/assoc :stream-arn (deser-resource-arn (clojure.core/get-in letvar265261 ["StreamARN"])))))))

(clojure.core/defn- response-invalid-resource-format-exception ([input] (response-invalid-resource-format-exception nil input)) ([resultWrapper265263 input] (clojure.core/let [rawinput265262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265264 {"Message" (rawinput265262 "Message")}] (clojure.core/cond-> {} (letvar265264 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265264 ["Message"])))))))

(clojure.core/defn- response-update-data-retention-output ([input] (response-update-data-retention-output nil input)) ([resultWrapper265266 input] (clojure.core/let [rawinput265265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265267 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-account-stream-limit-exceeded-exception ([input] (response-account-stream-limit-exceeded-exception nil input)) ([resultWrapper265269 input] (clojure.core/let [rawinput265268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265270 {"Message" (rawinput265268 "Message")}] (clojure.core/cond-> {} (letvar265270 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar265270 ["Message"])))))))

(clojure.core/defn- response-update-stream-output ([input] (response-update-stream-output nil input)) ([resultWrapper265272 input] (clojure.core/let [rawinput265271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar265273 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/media-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w\-\.\+]+/[\w\-\.\+]+(,[\w\-\.\+]+/[\w\-\.\+]+)*" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__21112__auto__))))
