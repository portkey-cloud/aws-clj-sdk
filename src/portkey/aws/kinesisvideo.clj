...
(clojure.core/defn get-data-endpoint ([get-data-endpoint-input] (portkey.aws/-rest-json-call portkey.aws.kinesisvideo/endpoints "POST" "/getDataEndpoint" get-data-endpoint-input :portkey.aws.kinesisvideo/get-data-endpoint-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.kinesisvideo/get-data-endpoint-output {"InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception, "ResourceNotFoundException" :portkey.aws.kinesisvideo/resource-not-found-exception, "ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "NotAuthorizedException" :portkey.aws.kinesisvideo/not-authorized-exception})))
...
(clojure.core/defn list-streams ([] (list-streams {})) ([list-streams-input] (portkey.aws/-rest-json-call portkey.aws.kinesisvideo/endpoints "POST" "/listStreams" list-streams-input :portkey.aws.kinesisvideo/list-streams-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.kinesisvideo/list-streams-output {"ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception})))
...
(clojure.core/defn update-data-retention ([update-data-retention-input] (portkey.aws/-rest-json-call portkey.aws.kinesisvideo/endpoints "POST" "/updateDataRetention" update-data-retention-input :portkey.aws.kinesisvideo/update-data-retention-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.kinesisvideo/update-data-retention-output {"ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception, "ResourceNotFoundException" :portkey.aws.kinesisvideo/resource-not-found-exception, "ResourceInUseException" :portkey.aws.kinesisvideo/resource-in-use-exception, "NotAuthorizedException" :portkey.aws.kinesisvideo/not-authorized-exception, "VersionMismatchException" :portkey.aws.kinesisvideo/version-mismatch-exception})))
...
(clojure.core/defn untag-stream ([untag-stream-input] (portkey.aws/-rest-json-call portkey.aws.kinesisvideo/endpoints "POST" "/untagStream" untag-stream-input :portkey.aws.kinesisvideo/untag-stream-input {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} nil :portkey.aws.kinesisvideo/untag-stream-output {"ClientLimitExceededException" :portkey.aws.kinesisvideo/client-limit-exceeded-exception, "InvalidArgumentException" :portkey.aws.kinesisvideo/invalid-argument-exception, "ResourceNotFoundException" :portkey.aws.kinesisvideo/resource-not-found-exception, "NotAuthorizedException" :portkey.aws.kinesisvideo/not-authorized-exception, "InvalidResourceFormatException" :portkey.aws.kinesisvideo/invalid-resource-format-exception})))
