...
(clojure.core/defn- response-create-placement-response ([input] (response-create-placement-response nil input)) ([resultWrapper1236457 input] (clojure.core/let [rawinput1236456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236458 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1236460 input] (clojure.core/let [rawinput1236459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236461 {"code" (rawinput1236459 "code"), "message" (rawinput1236459 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1236461 ["code"])), :message (deser-message (clojure.core/get-in letvar1236461 ["message"]))}))))

(clojure.core/defn- response-list-placements-response ([input] (response-list-placements-response nil input)) ([resultWrapper1236463 input] (clojure.core/let [rawinput1236462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236464 {"placements" (rawinput1236462 "placements"), "nextToken" (rawinput1236462 "nextToken")}] (clojure.core/cond-> {:placements (deser-placement-summary-list (clojure.core/get-in letvar1236464 ["placements"]))} (letvar1236464 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1236464 ["nextToken"])))))))

(clojure.core/defn- response-delete-placement-response ([input] (response-delete-placement-response nil input)) ([resultWrapper1236466 input] (clojure.core/let [rawinput1236465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236467 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-placement-response ([input] (response-describe-placement-response nil input)) ([resultWrapper1236469 input] (clojure.core/let [rawinput1236468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236470 {"placement" (rawinput1236468 "placement")}] (clojure.core/cond-> {:placement (deser-placement-description (clojure.core/get-in letvar1236470 ["placement"]))}))))

(clojure.core/defn- response-describe-project-response ([input] (response-describe-project-response nil input)) ([resultWrapper1236472 input] (clojure.core/let [rawinput1236471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236473 {"project" (rawinput1236471 "project")}] (clojure.core/cond-> {:project (deser-project-description (clojure.core/get-in letvar1236473 ["project"]))}))))

(clojure.core/defn- response-disassociate-device-from-placement-response ([input] (response-disassociate-device-from-placement-response nil input)) ([resultWrapper1236475 input] (clojure.core/let [rawinput1236474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236476 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-device-with-placement-response ([input] (response-associate-device-with-placement-response nil input)) ([resultWrapper1236478 input] (clojure.core/let [rawinput1236477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236479 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1236481 input] (clojure.core/let [rawinput1236480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236482 {"code" (rawinput1236480 "code"), "message" (rawinput1236480 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1236482 ["code"])), :message (deser-message (clojure.core/get-in letvar1236482 ["message"]))}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1236484 input] (clojure.core/let [rawinput1236483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236485 {"code" (rawinput1236483 "code"), "message" (rawinput1236483 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1236485 ["code"])), :message (deser-message (clojure.core/get-in letvar1236485 ["message"]))}))))

(clojure.core/defn- response-list-projects-response ([input] (response-list-projects-response nil input)) ([resultWrapper1236487 input] (clojure.core/let [rawinput1236486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236488 {"projects" (rawinput1236486 "projects"), "nextToken" (rawinput1236486 "nextToken")}] (clojure.core/cond-> {:projects (deser-project-summary-list (clojure.core/get-in letvar1236488 ["projects"]))} (letvar1236488 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1236488 ["nextToken"])))))))

(clojure.core/defn- response-get-devices-in-placement-response ([input] (response-get-devices-in-placement-response nil input)) ([resultWrapper1236490 input] (clojure.core/let [rawinput1236489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236491 {"devices" (rawinput1236489 "devices")}] (clojure.core/cond-> {:devices (deser-device-map (clojure.core/get-in letvar1236491 ["devices"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1236493 input] (clojure.core/let [rawinput1236492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236494 {"code" (rawinput1236492 "code"), "message" (rawinput1236492 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1236494 ["code"])), :message (deser-message (clojure.core/get-in letvar1236494 ["message"]))}))))

(clojure.core/defn- response-create-project-response ([input] (response-create-project-response nil input)) ([resultWrapper1236496 input] (clojure.core/let [rawinput1236495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236497 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-project-response ([input] (response-update-project-response nil input)) ([resultWrapper1236499 input] (clojure.core/let [rawinput1236498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236500 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1236502 input] (clojure.core/let [rawinput1236501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236503 {"code" (rawinput1236501 "code"), "message" (rawinput1236501 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1236503 ["code"])), :message (deser-message (clojure.core/get-in letvar1236503 ["message"]))}))))

(clojure.core/defn- response-update-placement-response ([input] (response-update-placement-response nil input)) ([resultWrapper1236505 input] (clojure.core/let [rawinput1236504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236506 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-response ([input] (response-delete-project-response nil input)) ([resultWrapper1236508 input] (clojure.core/let [rawinput1236507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1236509 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-callback-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-callback-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 800))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-template-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/placement-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-default-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[0-9A-Za-z_-]+$" s__1012854__auto__))))
