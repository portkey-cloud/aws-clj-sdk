...
(clojure.core/defn- response-create-placement-response ([input] (response-create-placement-response nil input)) ([resultWrapper243460 input] (clojure.core/let [rawinput243459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243461 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper243463 input] (clojure.core/let [rawinput243462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243464 {"code" (rawinput243462 "code"), "message" (rawinput243462 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar243464 ["code"])), :message (deser-message (clojure.core/get-in letvar243464 ["message"]))}))))

(clojure.core/defn- response-list-placements-response ([input] (response-list-placements-response nil input)) ([resultWrapper243466 input] (clojure.core/let [rawinput243465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243467 {"placements" (rawinput243465 "placements"), "nextToken" (rawinput243465 "nextToken")}] (clojure.core/cond-> {:placements (deser-placement-summary-list (clojure.core/get-in letvar243467 ["placements"]))} (letvar243467 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar243467 ["nextToken"])))))))

(clojure.core/defn- response-delete-placement-response ([input] (response-delete-placement-response nil input)) ([resultWrapper243469 input] (clojure.core/let [rawinput243468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243470 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-placement-response ([input] (response-describe-placement-response nil input)) ([resultWrapper243472 input] (clojure.core/let [rawinput243471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243473 {"placement" (rawinput243471 "placement")}] (clojure.core/cond-> {:placement (deser-placement-description (clojure.core/get-in letvar243473 ["placement"]))}))))

(clojure.core/defn- response-describe-project-response ([input] (response-describe-project-response nil input)) ([resultWrapper243475 input] (clojure.core/let [rawinput243474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243476 {"project" (rawinput243474 "project")}] (clojure.core/cond-> {:project (deser-project-description (clojure.core/get-in letvar243476 ["project"]))}))))

(clojure.core/defn- response-disassociate-device-from-placement-response ([input] (response-disassociate-device-from-placement-response nil input)) ([resultWrapper243478 input] (clojure.core/let [rawinput243477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243479 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-device-with-placement-response ([input] (response-associate-device-with-placement-response nil input)) ([resultWrapper243481 input] (clojure.core/let [rawinput243480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243482 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper243484 input] (clojure.core/let [rawinput243483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243485 {"code" (rawinput243483 "code"), "message" (rawinput243483 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar243485 ["code"])), :message (deser-message (clojure.core/get-in letvar243485 ["message"]))}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper243487 input] (clojure.core/let [rawinput243486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243488 {"code" (rawinput243486 "code"), "message" (rawinput243486 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar243488 ["code"])), :message (deser-message (clojure.core/get-in letvar243488 ["message"]))}))))

(clojure.core/defn- response-list-projects-response ([input] (response-list-projects-response nil input)) ([resultWrapper243490 input] (clojure.core/let [rawinput243489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243491 {"projects" (rawinput243489 "projects"), "nextToken" (rawinput243489 "nextToken")}] (clojure.core/cond-> {:projects (deser-project-summary-list (clojure.core/get-in letvar243491 ["projects"]))} (letvar243491 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar243491 ["nextToken"])))))))

(clojure.core/defn- response-get-devices-in-placement-response ([input] (response-get-devices-in-placement-response nil input)) ([resultWrapper243493 input] (clojure.core/let [rawinput243492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243494 {"devices" (rawinput243492 "devices")}] (clojure.core/cond-> {:devices (deser-device-map (clojure.core/get-in letvar243494 ["devices"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper243496 input] (clojure.core/let [rawinput243495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243497 {"code" (rawinput243495 "code"), "message" (rawinput243495 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar243497 ["code"])), :message (deser-message (clojure.core/get-in letvar243497 ["message"]))}))))

(clojure.core/defn- response-create-project-response ([input] (response-create-project-response nil input)) ([resultWrapper243499 input] (clojure.core/let [rawinput243498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243500 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-project-response ([input] (response-update-project-response nil input)) ([resultWrapper243502 input] (clojure.core/let [rawinput243501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243503 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper243505 input] (clojure.core/let [rawinput243504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243506 {"code" (rawinput243504 "code"), "message" (rawinput243504 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar243506 ["code"])), :message (deser-message (clojure.core/get-in letvar243506 ["message"]))}))))

(clojure.core/defn- response-update-placement-response ([input] (response-update-placement-response nil input)) ([resultWrapper243508 input] (clojure.core/let [rawinput243507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243509 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-response ([input] (response-delete-project-response nil input)) ([resultWrapper243511 input] (clojure.core/let [rawinput243510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar243512 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-callback-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-callback-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 800))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-template-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/placement-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/attribute-default-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects.-2018-05-14/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9A-Za-z_-]+$" s__21112__auto__))))
