...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper1854292 input] (clojure.core/let [rawinput1854291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854293 {"ServerId" (rawinput1854291 "ServerId"), "UserName" (rawinput1854291 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854293 ["ServerId"])), :user-name (deser-user-name (clojure.core/get-in letvar1854293 ["UserName"]))}))))

(clojure.core/defn- response-list-servers-response ([input] (response-list-servers-response nil input)) ([resultWrapper1854295 input] (clojure.core/let [rawinput1854294 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854296 {"NextToken" (rawinput1854294 "NextToken"), "Servers" (rawinput1854294 "Servers")}] (clojure.core/cond-> {:servers (deser-listed-servers (clojure.core/get-in letvar1854296 ["Servers"]))} (letvar1854296 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1854296 ["NextToken"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1854298 input] (clojure.core/let [rawinput1854297 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854299 {"Message" (rawinput1854297 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1854299 ["Message"]))}))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1854301 input] (clojure.core/let [rawinput1854300 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854302 {"Arn" (rawinput1854300 "Arn"), "NextToken" (rawinput1854300 "NextToken"), "Tags" (rawinput1854300 "Tags")}] (clojure.core/cond-> {} (letvar1854302 "Arn") (clojure.core/assoc :arn (deser-arn (clojure.core/get-in letvar1854302 ["Arn"]))) (letvar1854302 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1854302 ["NextToken"]))) (letvar1854302 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1854302 ["Tags"])))))))

(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1854304 input] (clojure.core/let [rawinput1854303 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854305 {"Message" (rawinput1854303 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1854305 ["Message"]))}))))

(clojure.core/defn- response-resource-exists-exception ([input] (response-resource-exists-exception nil input)) ([resultWrapper1854307 input] (clojure.core/let [rawinput1854306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854308 {"Message" (rawinput1854306 "Message"), "Resource" (rawinput1854306 "Resource"), "ResourceType" (rawinput1854306 "ResourceType")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1854308 ["Message"])), :resource (deser-resource (clojure.core/get-in letvar1854308 ["Resource"])), :resource-type (deser-resource-type (clojure.core/get-in letvar1854308 ["ResourceType"]))}))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1854310 input] (clojure.core/let [rawinput1854309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854311 {"Message" (rawinput1854309 "Message")}] (clojure.core/cond-> {} (letvar1854311 "Message") (clojure.core/assoc :message (deser-service-error-message (clojure.core/get-in letvar1854311 ["Message"])))))))

(clojure.core/defn- response-update-user-response ([input] (response-update-user-response nil input)) ([resultWrapper1854313 input] (clojure.core/let [rawinput1854312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854314 {"ServerId" (rawinput1854312 "ServerId"), "UserName" (rawinput1854312 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854314 ["ServerId"])), :user-name (deser-user-name (clojure.core/get-in letvar1854314 ["UserName"]))}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1854316 input] (clojure.core/let [rawinput1854315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854317 {"Message" (rawinput1854315 "Message")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1854317 ["Message"]))}))))

(clojure.core/defn- response-update-server-response ([input] (response-update-server-response nil input)) ([resultWrapper1854319 input] (clojure.core/let [rawinput1854318 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854320 {"ServerId" (rawinput1854318 "ServerId")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854320 ["ServerId"]))}))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper1854322 input] (clojure.core/let [rawinput1854321 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854323 {"ServerId" (rawinput1854321 "ServerId"), "User" (rawinput1854321 "User")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854323 ["ServerId"])), :user (deser-described-user (clojure.core/get-in letvar1854323 ["User"]))}))))

(clojure.core/defn- response-import-ssh-public-key-response ([input] (response-import-ssh-public-key-response nil input)) ([resultWrapper1854325 input] (clojure.core/let [rawinput1854324 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854326 {"ServerId" (rawinput1854324 "ServerId"), "SshPublicKeyId" (rawinput1854324 "SshPublicKeyId"), "UserName" (rawinput1854324 "UserName")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854326 ["ServerId"])), :ssh-public-key-id (deser-ssh-public-key-id (clojure.core/get-in letvar1854326 ["SshPublicKeyId"])), :user-name (deser-user-name (clojure.core/get-in letvar1854326 ["UserName"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1854328 input] (clojure.core/let [rawinput1854327 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854329 {"Message" (rawinput1854327 "Message"), "Resource" (rawinput1854327 "Resource"), "ResourceType" (rawinput1854327 "ResourceType")}] (clojure.core/cond-> {:message (deser-message (clojure.core/get-in letvar1854329 ["Message"])), :resource (deser-resource (clojure.core/get-in letvar1854329 ["Resource"])), :resource-type (deser-resource-type (clojure.core/get-in letvar1854329 ["ResourceType"]))}))))

(clojure.core/defn- response-describe-server-response ([input] (response-describe-server-response nil input)) ([resultWrapper1854331 input] (clojure.core/let [rawinput1854330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854332 {"Server" (rawinput1854330 "Server")}] (clojure.core/cond-> {:server (deser-described-server (clojure.core/get-in letvar1854332 ["Server"]))}))))

(clojure.core/defn- response-create-server-response ([input] (response-create-server-response nil input)) ([resultWrapper1854334 input] (clojure.core/let [rawinput1854333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854335 {"ServerId" (rawinput1854333 "ServerId")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854335 ["ServerId"]))}))))

(clojure.core/defn- response-test-identity-provider-response ([input] (response-test-identity-provider-response nil input)) ([resultWrapper1854337 input] (clojure.core/let [rawinput1854336 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854338 {"Message" (rawinput1854336 "Message"), "StatusCode" (rawinput1854336 "StatusCode"), "Url" (rawinput1854336 "Url")}] (clojure.core/cond-> {:status-code (deser-status-code (clojure.core/get-in letvar1854338 ["StatusCode"])), :url (deser-url (clojure.core/get-in letvar1854338 ["Url"]))} (letvar1854338 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1854338 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1854340 input] (clojure.core/let [rawinput1854339 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1854341 {"NextToken" (rawinput1854339 "NextToken"), "ServerId" (rawinput1854339 "ServerId"), "Users" (rawinput1854339 "Users")}] (clojure.core/cond-> {:server-id (deser-server-id (clojure.core/get-in letvar1854341 ["ServerId"])), :users (deser-listed-users (clojure.core/get-in letvar1854341 ["Users"]))} (letvar1854341 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1854341 ["NextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/ssh-public-key-body (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^ssh-rsa\s+[A-Za-z0-9+/]+[=]{0,3}(\s+.+)?\s*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/nullable-role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|arn:.*role/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/home-directory (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 6144))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-z0-9]{3,32}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/ssh-public-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^key-[0-9a-f]{17}$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*role/.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1600))))
...
(clojure.spec.alpha/def :portkey.aws.transfer.-2018-11-05/server-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^s-([0-9a-f]{17})$" s__21078__auto__))))
