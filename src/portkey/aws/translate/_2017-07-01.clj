...
(clojure.core/defn- response-import-terminology-response ([input] (response-import-terminology-response nil input)) ([resultWrapper1856526 input] (clojure.core/let [rawinput1856525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856527 {"TerminologyProperties" (rawinput1856525 "TerminologyProperties")}] (clojure.core/cond-> {} (letvar1856527 "TerminologyProperties") (clojure.core/assoc :terminology-properties (deser-terminology-properties (clojure.core/get-in letvar1856527 ["TerminologyProperties"])))))))

(clojure.core/defn- response-list-terminologies-response ([input] (response-list-terminologies-response nil input)) ([resultWrapper1856529 input] (clojure.core/let [rawinput1856528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856530 {"TerminologyPropertiesList" (rawinput1856528 "TerminologyPropertiesList"), "NextToken" (rawinput1856528 "NextToken")}] (clojure.core/cond-> {} (letvar1856530 "TerminologyPropertiesList") (clojure.core/assoc :terminology-properties-list (deser-terminology-properties-list (clojure.core/get-in letvar1856530 ["TerminologyPropertiesList"]))) (letvar1856530 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1856530 ["NextToken"])))))))

(clojure.core/defn- response-detected-language-low-confidence-exception ([input] (response-detected-language-low-confidence-exception nil input)) ([resultWrapper1856532 input] (clojure.core/let [rawinput1856531 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856533 {"Message" (rawinput1856531 "Message"), "DetectedLanguageCode" (rawinput1856531 "DetectedLanguageCode")}] (clojure.core/cond-> {} (letvar1856533 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856533 ["Message"]))) (letvar1856533 "DetectedLanguageCode") (clojure.core/assoc :detected-language-code (deser-language-code-string (clojure.core/get-in letvar1856533 ["DetectedLanguageCode"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1856535 input] (clojure.core/let [rawinput1856534 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856536 {"Message" (rawinput1856534 "Message")}] (clojure.core/cond-> {} (letvar1856536 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856536 ["Message"])))))))

(clojure.core/defn- response-get-terminology-response ([input] (response-get-terminology-response nil input)) ([resultWrapper1856538 input] (clojure.core/let [rawinput1856537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856539 {"TerminologyProperties" (rawinput1856537 "TerminologyProperties"), "TerminologyDataLocation" (rawinput1856537 "TerminologyDataLocation")}] (clojure.core/cond-> {} (letvar1856539 "TerminologyProperties") (clojure.core/assoc :terminology-properties (deser-terminology-properties (clojure.core/get-in letvar1856539 ["TerminologyProperties"]))) (letvar1856539 "TerminologyDataLocation") (clojure.core/assoc :terminology-data-location (deser-terminology-data-location (clojure.core/get-in letvar1856539 ["TerminologyDataLocation"])))))))

(clojure.core/defn- response-text-size-limit-exceeded-exception ([input] (response-text-size-limit-exceeded-exception nil input)) ([resultWrapper1856541 input] (clojure.core/let [rawinput1856540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856542 {"Message" (rawinput1856540 "Message")}] (clojure.core/cond-> {} (letvar1856542 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856542 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1856544 input] (clojure.core/let [rawinput1856543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856545 {"Message" (rawinput1856543 "Message")}] (clojure.core/cond-> {} (letvar1856545 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856545 ["Message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1856547 input] (clojure.core/let [rawinput1856546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856548 {"Message" (rawinput1856546 "Message")}] (clojure.core/cond-> {} (letvar1856548 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856548 ["Message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1856550 input] (clojure.core/let [rawinput1856549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856551 {"Message" (rawinput1856549 "Message")}] (clojure.core/cond-> {} (letvar1856551 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856551 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1856553 input] (clojure.core/let [rawinput1856552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856554 {"Message" (rawinput1856552 "Message")}] (clojure.core/cond-> {} (letvar1856554 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856554 ["Message"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1856556 input] (clojure.core/let [rawinput1856555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856557 {"Message" (rawinput1856555 "Message")}] (clojure.core/cond-> {} (letvar1856557 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856557 ["Message"])))))))

(clojure.core/defn- response-translate-text-response ([input] (response-translate-text-response nil input)) ([resultWrapper1856559 input] (clojure.core/let [rawinput1856558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856560 {"TranslatedText" (rawinput1856558 "TranslatedText"), "SourceLanguageCode" (rawinput1856558 "SourceLanguageCode"), "TargetLanguageCode" (rawinput1856558 "TargetLanguageCode"), "AppliedTerminologies" (rawinput1856558 "AppliedTerminologies")}] (clojure.core/cond-> {:translated-text (deser-string (clojure.core/get-in letvar1856560 ["TranslatedText"])), :source-language-code (deser-language-code-string (clojure.core/get-in letvar1856560 ["SourceLanguageCode"])), :target-language-code (deser-language-code-string (clojure.core/get-in letvar1856560 ["TargetLanguageCode"]))} (letvar1856560 "AppliedTerminologies") (clojure.core/assoc :applied-terminologies (deser-applied-terminology-list (clojure.core/get-in letvar1856560 ["AppliedTerminologies"])))))))

(clojure.core/defn- response-unsupported-language-pair-exception ([input] (response-unsupported-language-pair-exception nil input)) ([resultWrapper1856562 input] (clojure.core/let [rawinput1856561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856563 {"Message" (rawinput1856561 "Message"), "SourceLanguageCode" (rawinput1856561 "SourceLanguageCode"), "TargetLanguageCode" (rawinput1856561 "TargetLanguageCode")}] (clojure.core/cond-> {} (letvar1856563 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856563 ["Message"]))) (letvar1856563 "SourceLanguageCode") (clojure.core/assoc :source-language-code (deser-language-code-string (clojure.core/get-in letvar1856563 ["SourceLanguageCode"]))) (letvar1856563 "TargetLanguageCode") (clojure.core/assoc :target-language-code (deser-language-code-string (clojure.core/get-in letvar1856563 ["TargetLanguageCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1856565 input] (clojure.core/let [rawinput1856564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1856566 {"Message" (rawinput1856564 "Message")}] (clojure.core/cond-> {} (letvar1856566 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1856566 ["Message"])))))))

(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/merge-strategy #{"OVERWRITE" :overwrite})

(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/terminology-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws((-us-gov)|(-cn))?:translate:[a-zA-Z0-9-]+:[0-9]{12}:terminology/.+?/.+?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/language-code-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 8192)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\p{ASCII}{0,8192}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\P{M}\p{M}]{0,256}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([A-Za-z0-9-]_?)+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/integer clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10000)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\P{M}\p{M}]{0,10000}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/encryption-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 400)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:aws((-us-gov)|(-cn))?:kms:)?([a-z]{2}-[a-z]+-\d:)?(\d{12}:)?(((key/)?[a-zA-Z0-9-_]+)|(alias/[a-zA-Z0-9:/_-]+))" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate.-2017-07-01/bounded-length-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5000)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\P{M}\p{M}]{1,5000}" s__21078__auto__))))
