...
(clojure.core/defn- response-delete-resolver-endpoint-response ([input] (response-delete-resolver-endpoint-response nil input)) ([resultWrapper1966638 input] (clojure.core/let [rawinput1966637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966639 {"ResolverEndpoint" (rawinput1966637 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966639 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966639 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-associate-resolver-endpoint-ip-address-response ([input] (response-associate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1966641 input] (clojure.core/let [rawinput1966640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966642 {"ResolverEndpoint" (rawinput1966640 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966642 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966642 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1966644 input] (clojure.core/let [rawinput1966643 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966645 {"Message" (rawinput1966643 "Message")}] (clojure.core/cond-> {} (letvar1966645 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966645 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1966647 input] (clojure.core/let [rawinput1966646 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966648 {"Tags" (rawinput1966646 "Tags"), "NextToken" (rawinput1966646 "NextToken")}] (clojure.core/cond-> {} (letvar1966648 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1966648 ["Tags"]))) (letvar1966648 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1966648 ["NextToken"])))))))

(clojure.core/defn- response-create-resolver-endpoint-response ([input] (response-create-resolver-endpoint-response nil input)) ([resultWrapper1966650 input] (clojure.core/let [rawinput1966649 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966651 {"ResolverEndpoint" (rawinput1966649 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966651 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966651 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-update-resolver-rule-response ([input] (response-update-resolver-rule-response nil input)) ([resultWrapper1966653 input] (clojure.core/let [rawinput1966652 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966654 {"ResolverRule" (rawinput1966652 "ResolverRule")}] (clojure.core/cond-> {} (letvar1966654 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1966654 ["ResolverRule"])))))))

(clojure.core/defn- response-unknown-resource-exception ([input] (response-unknown-resource-exception nil input)) ([resultWrapper1966656 input] (clojure.core/let [rawinput1966655 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966657 {"Message" (rawinput1966655 "Message")}] (clojure.core/cond-> {} (letvar1966657 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966657 ["Message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1966659 input] (clojure.core/let [rawinput1966658 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966660 {"Message" (rawinput1966658 "Message")}] (clojure.core/cond-> {} (letvar1966660 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966660 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1966662 input] (clojure.core/let [rawinput1966661 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966663 {"Message" (rawinput1966661 "Message"), "ResourceType" (rawinput1966661 "ResourceType")}] (clojure.core/cond-> {} (letvar1966663 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966663 ["Message"]))) (letvar1966663 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1966663 ["ResourceType"])))))))

(clojure.core/defn- response-list-resolver-endpoint-ip-addresses-response ([input] (response-list-resolver-endpoint-ip-addresses-response nil input)) ([resultWrapper1966665 input] (clojure.core/let [rawinput1966664 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966666 {"NextToken" (rawinput1966664 "NextToken"), "MaxResults" (rawinput1966664 "MaxResults"), "IpAddresses" (rawinput1966664 "IpAddresses")}] (clojure.core/cond-> {} (letvar1966666 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1966666 ["NextToken"]))) (letvar1966666 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1966666 ["MaxResults"]))) (letvar1966666 "IpAddresses") (clojure.core/assoc :ip-addresses (deser-ip-addresses-response (clojure.core/get-in letvar1966666 ["IpAddresses"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1966668 input] (clojure.core/let [rawinput1966667 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966669 {"Message" (rawinput1966667 "Message"), "ResourceType" (rawinput1966667 "ResourceType")}] (clojure.core/cond-> {} (letvar1966669 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966669 ["Message"]))) (letvar1966669 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1966669 ["ResourceType"])))))))

(clojure.core/defn- response-resource-exists-exception ([input] (response-resource-exists-exception nil input)) ([resultWrapper1966671 input] (clojure.core/let [rawinput1966670 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966672 {"Message" (rawinput1966670 "Message"), "ResourceType" (rawinput1966670 "ResourceType")}] (clojure.core/cond-> {} (letvar1966672 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966672 ["Message"]))) (letvar1966672 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1966672 ["ResourceType"])))))))

(clojure.core/defn- response-associate-resolver-rule-response ([input] (response-associate-resolver-rule-response nil input)) ([resultWrapper1966674 input] (clojure.core/let [rawinput1966673 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966675 {"ResolverRuleAssociation" (rawinput1966673 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1966675 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1966675 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1966677 input] (clojure.core/let [rawinput1966676 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966678 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1966680 input] (clojure.core/let [rawinput1966679 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966681 {"Message" (rawinput1966679 "Message")}] (clojure.core/cond-> {} (letvar1966681 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966681 ["Message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1966683 input] (clojure.core/let [rawinput1966682 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966684 {"Message" (rawinput1966682 "Message")}] (clojure.core/cond-> {} (letvar1966684 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966684 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1966686 input] (clojure.core/let [rawinput1966685 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966687 {"Message" (rawinput1966685 "Message"), "ResourceType" (rawinput1966685 "ResourceType")}] (clojure.core/cond-> {} (letvar1966687 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966687 ["Message"]))) (letvar1966687 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1966687 ["ResourceType"])))))))

(clojure.core/defn- response-create-resolver-rule-response ([input] (response-create-resolver-rule-response nil input)) ([resultWrapper1966689 input] (clojure.core/let [rawinput1966688 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966690 {"ResolverRule" (rawinput1966688 "ResolverRule")}] (clojure.core/cond-> {} (letvar1966690 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1966690 ["ResolverRule"])))))))

(clojure.core/defn- response-list-resolver-endpoints-response ([input] (response-list-resolver-endpoints-response nil input)) ([resultWrapper1966692 input] (clojure.core/let [rawinput1966691 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966693 {"NextToken" (rawinput1966691 "NextToken"), "MaxResults" (rawinput1966691 "MaxResults"), "ResolverEndpoints" (rawinput1966691 "ResolverEndpoints")}] (clojure.core/cond-> {} (letvar1966693 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1966693 ["NextToken"]))) (letvar1966693 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1966693 ["MaxResults"]))) (letvar1966693 "ResolverEndpoints") (clojure.core/assoc :resolver-endpoints (deser-resolver-endpoints (clojure.core/get-in letvar1966693 ["ResolverEndpoints"])))))))

(clojure.core/defn- response-get-resolver-rule-response ([input] (response-get-resolver-rule-response nil input)) ([resultWrapper1966695 input] (clojure.core/let [rawinput1966694 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966696 {"ResolverRule" (rawinput1966694 "ResolverRule")}] (clojure.core/cond-> {} (letvar1966696 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1966696 ["ResolverRule"])))))))

(clojure.core/defn- response-update-resolver-endpoint-response ([input] (response-update-resolver-endpoint-response nil input)) ([resultWrapper1966698 input] (clojure.core/let [rawinput1966697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966699 {"ResolverEndpoint" (rawinput1966697 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966699 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966699 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-list-resolver-rules-response ([input] (response-list-resolver-rules-response nil input)) ([resultWrapper1966701 input] (clojure.core/let [rawinput1966700 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966702 {"NextToken" (rawinput1966700 "NextToken"), "MaxResults" (rawinput1966700 "MaxResults"), "ResolverRules" (rawinput1966700 "ResolverRules")}] (clojure.core/cond-> {} (letvar1966702 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1966702 ["NextToken"]))) (letvar1966702 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1966702 ["MaxResults"]))) (letvar1966702 "ResolverRules") (clojure.core/assoc :resolver-rules (deser-resolver-rules (clojure.core/get-in letvar1966702 ["ResolverRules"])))))))

(clojure.core/defn- response-disassociate-resolver-rule-response ([input] (response-disassociate-resolver-rule-response nil input)) ([resultWrapper1966704 input] (clojure.core/let [rawinput1966703 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966705 {"ResolverRuleAssociation" (rawinput1966703 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1966705 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1966705 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-list-resolver-rule-associations-response ([input] (response-list-resolver-rule-associations-response nil input)) ([resultWrapper1966707 input] (clojure.core/let [rawinput1966706 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966708 {"NextToken" (rawinput1966706 "NextToken"), "MaxResults" (rawinput1966706 "MaxResults"), "ResolverRuleAssociations" (rawinput1966706 "ResolverRuleAssociations")}] (clojure.core/cond-> {} (letvar1966708 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1966708 ["NextToken"]))) (letvar1966708 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1966708 ["MaxResults"]))) (letvar1966708 "ResolverRuleAssociations") (clojure.core/assoc :resolver-rule-associations (deser-resolver-rule-associations (clojure.core/get-in letvar1966708 ["ResolverRuleAssociations"])))))))

(clojure.core/defn- response-delete-resolver-rule-response ([input] (response-delete-resolver-rule-response nil input)) ([resultWrapper1966710 input] (clojure.core/let [rawinput1966709 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966711 {"ResolverRule" (rawinput1966709 "ResolverRule")}] (clojure.core/cond-> {} (letvar1966711 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1966711 ["ResolverRule"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1966713 input] (clojure.core/let [rawinput1966712 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966714 {"Message" (rawinput1966712 "Message")}] (clojure.core/cond-> {} (letvar1966714 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966714 ["Message"])))))))

(clojure.core/defn- response-put-resolver-rule-policy-response ([input] (response-put-resolver-rule-policy-response nil input)) ([resultWrapper1966716 input] (clojure.core/let [rawinput1966715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966717 {"ReturnValue" (rawinput1966715 "ReturnValue")}] (clojure.core/cond-> {} (letvar1966717 "ReturnValue") (clojure.core/assoc :return-value (deser-boolean (clojure.core/get-in letvar1966717 ["ReturnValue"])))))))

(clojure.core/defn- response-get-resolver-endpoint-response ([input] (response-get-resolver-endpoint-response nil input)) ([resultWrapper1966719 input] (clojure.core/let [rawinput1966718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966720 {"ResolverEndpoint" (rawinput1966718 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966720 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966720 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1966722 input] (clojure.core/let [rawinput1966721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966723 {"Message" (rawinput1966721 "Message"), "FieldName" (rawinput1966721 "FieldName")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1966723 ["Message"]))} (letvar1966723 "FieldName") (clojure.core/assoc :field-name (deser-string (clojure.core/get-in letvar1966723 ["FieldName"])))))))

(clojure.core/defn- response-disassociate-resolver-endpoint-ip-address-response ([input] (response-disassociate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1966725 input] (clojure.core/let [rawinput1966724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966726 {"ResolverEndpoint" (rawinput1966724 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1966726 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1966726 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-resource-unavailable-exception ([input] (response-resource-unavailable-exception nil input)) ([resultWrapper1966728 input] (clojure.core/let [rawinput1966727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966729 {"Message" (rawinput1966727 "Message"), "ResourceType" (rawinput1966727 "ResourceType")}] (clojure.core/cond-> {} (letvar1966729 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1966729 ["Message"]))) (letvar1966729 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1966729 ["ResourceType"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1966731 input] (clojure.core/let [rawinput1966730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966732 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-resolver-rule-association-response ([input] (response-get-resolver-rule-association-response nil input)) ([resultWrapper1966734 input] (clojure.core/let [rawinput1966733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966735 {"ResolverRuleAssociation" (rawinput1966733 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1966735 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1966735 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-invalid-policy-document ([input] (response-invalid-policy-document nil input)) ([resultWrapper1966737 input] (clojure.core/let [rawinput1966736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966738 {"Message" (rawinput1966736 "Message")}] (clojure.core/cond-> {} (letvar1966738 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1966738 ["Message"])))))))

(clojure.core/defn- response-get-resolver-rule-policy-response ([input] (response-get-resolver-rule-policy-response nil input)) ([resultWrapper1966740 input] (clojure.core/let [rawinput1966739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1966741 {"ResolverRulePolicy" (rawinput1966739 "ResolverRulePolicy")}] (clojure.core/cond-> {} (letvar1966741 "ResolverRulePolicy") (clojure.core/assoc :resolver-rule-policy (deser-resolver-rule-policy (clojure.core/get-in letvar1966741 ["ResolverRulePolicy"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/rule-type-option #{"SYSTEM" :system :forward :recursive "FORWARD" "RECURSIVE"})

(clojure.spec.alpha/def :portkey.aws.route53resolver/status-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/creator-request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/rfc-3339-time-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 20 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 12 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 7 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/resolver-rule-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 5000))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_' ']+)" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 64))))
