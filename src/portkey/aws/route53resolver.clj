...
(clojure.core/defn- response-delete-resolver-endpoint-response ([input] (response-delete-resolver-endpoint-response nil input)) ([resultWrapper1957520 input] (clojure.core/let [rawinput1957519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957521 {"ResolverEndpoint" (rawinput1957519 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957521 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957521 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-associate-resolver-endpoint-ip-address-response ([input] (response-associate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1957523 input] (clojure.core/let [rawinput1957522 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957524 {"ResolverEndpoint" (rawinput1957522 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957524 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957524 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1957526 input] (clojure.core/let [rawinput1957525 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957527 {"Message" (rawinput1957525 "Message")}] (clojure.core/cond-> {} (letvar1957527 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957527 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1957529 input] (clojure.core/let [rawinput1957528 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957530 {"Tags" (rawinput1957528 "Tags"), "NextToken" (rawinput1957528 "NextToken")}] (clojure.core/cond-> {} (letvar1957530 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1957530 ["Tags"]))) (letvar1957530 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1957530 ["NextToken"])))))))

(clojure.core/defn- response-create-resolver-endpoint-response ([input] (response-create-resolver-endpoint-response nil input)) ([resultWrapper1957532 input] (clojure.core/let [rawinput1957531 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957533 {"ResolverEndpoint" (rawinput1957531 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957533 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957533 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-update-resolver-rule-response ([input] (response-update-resolver-rule-response nil input)) ([resultWrapper1957535 input] (clojure.core/let [rawinput1957534 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957536 {"ResolverRule" (rawinput1957534 "ResolverRule")}] (clojure.core/cond-> {} (letvar1957536 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1957536 ["ResolverRule"])))))))

(clojure.core/defn- response-unknown-resource-exception ([input] (response-unknown-resource-exception nil input)) ([resultWrapper1957538 input] (clojure.core/let [rawinput1957537 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957539 {"Message" (rawinput1957537 "Message")}] (clojure.core/cond-> {} (letvar1957539 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957539 ["Message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1957541 input] (clojure.core/let [rawinput1957540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957542 {"Message" (rawinput1957540 "Message")}] (clojure.core/cond-> {} (letvar1957542 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957542 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1957544 input] (clojure.core/let [rawinput1957543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957545 {"Message" (rawinput1957543 "Message"), "ResourceType" (rawinput1957543 "ResourceType")}] (clojure.core/cond-> {} (letvar1957545 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957545 ["Message"]))) (letvar1957545 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1957545 ["ResourceType"])))))))

(clojure.core/defn- response-list-resolver-endpoint-ip-addresses-response ([input] (response-list-resolver-endpoint-ip-addresses-response nil input)) ([resultWrapper1957547 input] (clojure.core/let [rawinput1957546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957548 {"NextToken" (rawinput1957546 "NextToken"), "MaxResults" (rawinput1957546 "MaxResults"), "IpAddresses" (rawinput1957546 "IpAddresses")}] (clojure.core/cond-> {} (letvar1957548 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1957548 ["NextToken"]))) (letvar1957548 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1957548 ["MaxResults"]))) (letvar1957548 "IpAddresses") (clojure.core/assoc :ip-addresses (deser-ip-addresses-response (clojure.core/get-in letvar1957548 ["IpAddresses"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1957550 input] (clojure.core/let [rawinput1957549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957551 {"Message" (rawinput1957549 "Message"), "ResourceType" (rawinput1957549 "ResourceType")}] (clojure.core/cond-> {} (letvar1957551 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957551 ["Message"]))) (letvar1957551 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1957551 ["ResourceType"])))))))

(clojure.core/defn- response-resource-exists-exception ([input] (response-resource-exists-exception nil input)) ([resultWrapper1957553 input] (clojure.core/let [rawinput1957552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957554 {"Message" (rawinput1957552 "Message"), "ResourceType" (rawinput1957552 "ResourceType")}] (clojure.core/cond-> {} (letvar1957554 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957554 ["Message"]))) (letvar1957554 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1957554 ["ResourceType"])))))))

(clojure.core/defn- response-associate-resolver-rule-response ([input] (response-associate-resolver-rule-response nil input)) ([resultWrapper1957556 input] (clojure.core/let [rawinput1957555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957557 {"ResolverRuleAssociation" (rawinput1957555 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1957557 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1957557 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1957559 input] (clojure.core/let [rawinput1957558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957560 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1957562 input] (clojure.core/let [rawinput1957561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957563 {"Message" (rawinput1957561 "Message")}] (clojure.core/cond-> {} (letvar1957563 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957563 ["Message"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper1957565 input] (clojure.core/let [rawinput1957564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957566 {"Message" (rawinput1957564 "Message")}] (clojure.core/cond-> {} (letvar1957566 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957566 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1957568 input] (clojure.core/let [rawinput1957567 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957569 {"Message" (rawinput1957567 "Message"), "ResourceType" (rawinput1957567 "ResourceType")}] (clojure.core/cond-> {} (letvar1957569 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957569 ["Message"]))) (letvar1957569 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1957569 ["ResourceType"])))))))

(clojure.core/defn- response-create-resolver-rule-response ([input] (response-create-resolver-rule-response nil input)) ([resultWrapper1957571 input] (clojure.core/let [rawinput1957570 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957572 {"ResolverRule" (rawinput1957570 "ResolverRule")}] (clojure.core/cond-> {} (letvar1957572 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1957572 ["ResolverRule"])))))))

(clojure.core/defn- response-list-resolver-endpoints-response ([input] (response-list-resolver-endpoints-response nil input)) ([resultWrapper1957574 input] (clojure.core/let [rawinput1957573 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957575 {"NextToken" (rawinput1957573 "NextToken"), "MaxResults" (rawinput1957573 "MaxResults"), "ResolverEndpoints" (rawinput1957573 "ResolverEndpoints")}] (clojure.core/cond-> {} (letvar1957575 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1957575 ["NextToken"]))) (letvar1957575 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1957575 ["MaxResults"]))) (letvar1957575 "ResolverEndpoints") (clojure.core/assoc :resolver-endpoints (deser-resolver-endpoints (clojure.core/get-in letvar1957575 ["ResolverEndpoints"])))))))

(clojure.core/defn- response-get-resolver-rule-response ([input] (response-get-resolver-rule-response nil input)) ([resultWrapper1957577 input] (clojure.core/let [rawinput1957576 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957578 {"ResolverRule" (rawinput1957576 "ResolverRule")}] (clojure.core/cond-> {} (letvar1957578 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1957578 ["ResolverRule"])))))))

(clojure.core/defn- response-update-resolver-endpoint-response ([input] (response-update-resolver-endpoint-response nil input)) ([resultWrapper1957580 input] (clojure.core/let [rawinput1957579 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957581 {"ResolverEndpoint" (rawinput1957579 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957581 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957581 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-list-resolver-rules-response ([input] (response-list-resolver-rules-response nil input)) ([resultWrapper1957583 input] (clojure.core/let [rawinput1957582 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957584 {"NextToken" (rawinput1957582 "NextToken"), "MaxResults" (rawinput1957582 "MaxResults"), "ResolverRules" (rawinput1957582 "ResolverRules")}] (clojure.core/cond-> {} (letvar1957584 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1957584 ["NextToken"]))) (letvar1957584 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1957584 ["MaxResults"]))) (letvar1957584 "ResolverRules") (clojure.core/assoc :resolver-rules (deser-resolver-rules (clojure.core/get-in letvar1957584 ["ResolverRules"])))))))

(clojure.core/defn- response-disassociate-resolver-rule-response ([input] (response-disassociate-resolver-rule-response nil input)) ([resultWrapper1957586 input] (clojure.core/let [rawinput1957585 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957587 {"ResolverRuleAssociation" (rawinput1957585 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1957587 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1957587 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-list-resolver-rule-associations-response ([input] (response-list-resolver-rule-associations-response nil input)) ([resultWrapper1957589 input] (clojure.core/let [rawinput1957588 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957590 {"NextToken" (rawinput1957588 "NextToken"), "MaxResults" (rawinput1957588 "MaxResults"), "ResolverRuleAssociations" (rawinput1957588 "ResolverRuleAssociations")}] (clojure.core/cond-> {} (letvar1957590 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1957590 ["NextToken"]))) (letvar1957590 "MaxResults") (clojure.core/assoc :max-results (deser-max-results (clojure.core/get-in letvar1957590 ["MaxResults"]))) (letvar1957590 "ResolverRuleAssociations") (clojure.core/assoc :resolver-rule-associations (deser-resolver-rule-associations (clojure.core/get-in letvar1957590 ["ResolverRuleAssociations"])))))))

(clojure.core/defn- response-delete-resolver-rule-response ([input] (response-delete-resolver-rule-response nil input)) ([resultWrapper1957592 input] (clojure.core/let [rawinput1957591 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957593 {"ResolverRule" (rawinput1957591 "ResolverRule")}] (clojure.core/cond-> {} (letvar1957593 "ResolverRule") (clojure.core/assoc :resolver-rule (deser-resolver-rule (clojure.core/get-in letvar1957593 ["ResolverRule"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1957595 input] (clojure.core/let [rawinput1957594 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957596 {"Message" (rawinput1957594 "Message")}] (clojure.core/cond-> {} (letvar1957596 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957596 ["Message"])))))))

(clojure.core/defn- response-put-resolver-rule-policy-response ([input] (response-put-resolver-rule-policy-response nil input)) ([resultWrapper1957598 input] (clojure.core/let [rawinput1957597 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957599 {"ReturnValue" (rawinput1957597 "ReturnValue")}] (clojure.core/cond-> {} (letvar1957599 "ReturnValue") (clojure.core/assoc :return-value (deser-boolean (clojure.core/get-in letvar1957599 ["ReturnValue"])))))))

(clojure.core/defn- response-get-resolver-endpoint-response ([input] (response-get-resolver-endpoint-response nil input)) ([resultWrapper1957601 input] (clojure.core/let [rawinput1957600 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957602 {"ResolverEndpoint" (rawinput1957600 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957602 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957602 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1957604 input] (clojure.core/let [rawinput1957603 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957605 {"Message" (rawinput1957603 "Message"), "FieldName" (rawinput1957603 "FieldName")}] (clojure.core/cond-> {:message (deser-exception-message (clojure.core/get-in letvar1957605 ["Message"]))} (letvar1957605 "FieldName") (clojure.core/assoc :field-name (deser-string (clojure.core/get-in letvar1957605 ["FieldName"])))))))

(clojure.core/defn- response-disassociate-resolver-endpoint-ip-address-response ([input] (response-disassociate-resolver-endpoint-ip-address-response nil input)) ([resultWrapper1957607 input] (clojure.core/let [rawinput1957606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957608 {"ResolverEndpoint" (rawinput1957606 "ResolverEndpoint")}] (clojure.core/cond-> {} (letvar1957608 "ResolverEndpoint") (clojure.core/assoc :resolver-endpoint (deser-resolver-endpoint (clojure.core/get-in letvar1957608 ["ResolverEndpoint"])))))))

(clojure.core/defn- response-resource-unavailable-exception ([input] (response-resource-unavailable-exception nil input)) ([resultWrapper1957610 input] (clojure.core/let [rawinput1957609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957611 {"Message" (rawinput1957609 "Message"), "ResourceType" (rawinput1957609 "ResourceType")}] (clojure.core/cond-> {} (letvar1957611 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1957611 ["Message"]))) (letvar1957611 "ResourceType") (clojure.core/assoc :resource-type (deser-string (clojure.core/get-in letvar1957611 ["ResourceType"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1957613 input] (clojure.core/let [rawinput1957612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957614 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-resolver-rule-association-response ([input] (response-get-resolver-rule-association-response nil input)) ([resultWrapper1957616 input] (clojure.core/let [rawinput1957615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957617 {"ResolverRuleAssociation" (rawinput1957615 "ResolverRuleAssociation")}] (clojure.core/cond-> {} (letvar1957617 "ResolverRuleAssociation") (clojure.core/assoc :resolver-rule-association (deser-resolver-rule-association (clojure.core/get-in letvar1957617 ["ResolverRuleAssociation"])))))))

(clojure.core/defn- response-invalid-policy-document ([input] (response-invalid-policy-document nil input)) ([resultWrapper1957619 input] (clojure.core/let [rawinput1957618 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957620 {"Message" (rawinput1957618 "Message")}] (clojure.core/cond-> {} (letvar1957620 "Message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1957620 ["Message"])))))))

(clojure.core/defn- response-get-resolver-rule-policy-response ([input] (response-get-resolver-rule-policy-response nil input)) ([resultWrapper1957622 input] (clojure.core/let [rawinput1957621 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1957623 {"ResolverRulePolicy" (rawinput1957621 "ResolverRulePolicy")}] (clojure.core/cond-> {} (letvar1957623 "ResolverRulePolicy") (clojure.core/assoc :resolver-rule-policy (deser-resolver-rule-policy (clojure.core/get-in letvar1957623 ["ResolverRulePolicy"])))))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/subnet-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/rule-type-option #{"SYSTEM" :system :forward :recursive "FORWARD" "RECURSIVE"})

(clojure.spec.alpha/def :portkey.aws.route53resolver/status-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/creator-request-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/rfc-3339-time-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/ip (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 7 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.route53resolver/resolver-rule-policy (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 5000))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_' ']+)" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/filter-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53resolver/filter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
