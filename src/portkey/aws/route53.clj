...
(clojure.spec.alpha/def :portkey.aws.route53/geo-location-subdivision-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53/delegation-set-name-servers (clojure.spec.alpha/coll-of :portkey.aws.route53/dnsname :min-count 1))
...
(clojure.spec.alpha/def :portkey.aws.route53/health-check-nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-policy-request/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-policy-request/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/search-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53/hosted-zonerrset-count clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.route53.lastvpcassociation/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/lastvpcassociation (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.lastvpcassociation/message]))
...
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/record-name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/record-type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/resolverip (clojure.spec.alpha/and :portkey.aws.route53/ipaddress))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/edns0-client-subnetip (clojure.spec.alpha/and :portkey.aws.route53/ipaddress))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-request/edns0-client-subnet-mask (clojure.spec.alpha/and :portkey.aws.route53/subnet-mask))
(clojure.spec.alpha/def :portkey.aws.route53/testdnsanswer-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.testdnsanswer-request/hosted-zone-id :portkey.aws.route53.testdnsanswer-request/record-name :portkey.aws.route53.testdnsanswer-request/record-type] :opt-un [:portkey.aws.route53.testdnsanswer-request/resolverip :portkey.aws.route53.testdnsanswer-request/edns0-client-subnetip :portkey.aws.route53.testdnsanswer-request/edns0-client-subnet-mask]))
...
(clojure.spec.alpha/def :portkey.aws.route53/rrtype #{:soa "CAA" :naptr "CNAME" :txt :ns "TXT" "SRV" :srv "AAAA" :caa "NS" "PTR" :mx :cname "NAPTR" "A" "SPF" :spf :ptr :aaaa :a "SOA" "MX"})
...
(clojure.spec.alpha/def :portkey.aws.route53/alias-target (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.alias-target/hosted-zone-id :portkey.aws.route53/dnsname :portkey.aws.route53.alias-target/evaluate-target-health] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-resource-record-sets-request/start-record-name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-resource-record-sets-request/start-record-type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/geo-location-country-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 2))))

(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-version-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 4))))

(clojure.spec.alpha/def :portkey.aws.route53/subnet-mask (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 0 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-hosted-zones-by-name-response/nextdnsname (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.spec.alpha/def :portkey.aws.route53/list-hosted-zones-by-name-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53/hosted-zones :portkey.aws.route53.list-hosted-zones-by-name-response/is-truncated :portkey.aws.route53.list-hosted-zones-by-name-response/max-items] :opt-un [:portkey.aws.route53/dnsname :portkey.aws.route53.list-hosted-zones-by-name-response/hosted-zone-id :portkey.aws.route53.list-hosted-zones-by-name-response/nextdnsname :portkey.aws.route53.list-hosted-zones-by-name-response/next-hosted-zone-id]))
...
(clojure.spec.alpha/def :portkey.aws.route53.createvpcassociation-authorization-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53/createvpcassociation-authorization-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.createvpcassociation-authorization-request/hosted-zone-id :portkey.aws.route53/vpc] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53/associatevpccomment (clojure.spec.alpha/and clojure.core/string?))
...
(clojure.spec.alpha/def :portkey.aws.route53/dimension-field (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53/get-hosted-zone-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53/hosted-zone] :opt-un [:portkey.aws.route53/delegation-set :portkey.aws.route53/vpcs]))

(clojure.spec.alpha/def :portkey.aws.route53/nameserver (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 0 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53/resource-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.route53.deletevpcassociation-authorization-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53/deletevpcassociation-authorization-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.deletevpcassociation-authorization-request/hosted-zone-id :portkey.aws.route53/vpc] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53/resource-record-set-region #{:ap-northeast-1 :ap-northeast-2 "ap-northeast-1" :ca-central-1 "eu-west-1" :us-east-2 "ap-northeast-3" "us-east-2" "ap-southeast-2" "cn-north-1" :eu-west-2 "sa-east-1" :us-west-1 "ap-southeast-1" "cn-northwest-1" "ap-northeast-2" "eu-west-3" :ap-southeast-1 :us-west-2 :eu-central-1 :us-east-1 :ap-northeast-3 :eu-west-1 "ca-central-1" "eu-central-1" "eu-west-2" :eu-west-3 "us-west-2" "us-east-1" "us-west-1" :ap-southeast-2 "ap-south-1" :ap-south-1 :sa-east-1 :cn-northwest-1 :cn-north-1})
...
(clojure.spec.alpha/def :portkey.aws.route53.listvpcassociation-authorizations-response/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53.listvpcassociation-authorizations-response/next-token (clojure.spec.alpha/and :portkey.aws.route53/pagination-token))
(clojure.spec.alpha/def :portkey.aws.route53/listvpcassociation-authorizations-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.listvpcassociation-authorizations-response/hosted-zone-id :portkey.aws.route53/vpcs] :opt-un [:portkey.aws.route53.listvpcassociation-authorizations-response/next-token]))
...
(clojure.spec.alpha/def :portkey.aws.route53.public-zonevpcassociation/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/public-zonevpcassociation (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.public-zonevpcassociation/message]))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-traffic-policy-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 512))))

(clojure.spec.alpha/def :portkey.aws.route53.too-manyvpcassociation-authorizations/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/too-manyvpcassociation-authorizations (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.too-manyvpcassociation-authorizations/message]))
...
(clojure.spec.alpha/def :portkey.aws.route53.traffic-policy/type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-request/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-request/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-traffic-policy-version-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53/vpcregion #{:ap-northeast-1 :ap-northeast-2 "ap-northeast-1" :ca-central-1 "eu-west-1" :us-east-2 "ap-northeast-3" "us-east-2" "ap-southeast-2" "cn-north-1" :eu-west-2 "sa-east-1" :us-west-1 "ap-southeast-1" "ap-northeast-2" "eu-west-3" :ap-southeast-1 :us-west-2 :eu-central-1 :us-east-1 :ap-northeast-3 :eu-west-1 "ca-central-1" "eu-central-1" "eu-west-2" :eu-west-3 "us-west-2" "us-east-1" "us-west-1" :ap-southeast-2 "ap-south-1" :ap-south-1 :sa-east-1 :cn-north-1})
...
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-response/record-name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-response/record-type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-response/response-code (clojure.spec.alpha/and :portkey.aws.route53/dnsrcode))
(clojure.spec.alpha/def :portkey.aws.route53.testdnsanswer-response/protocol (clojure.spec.alpha/and :portkey.aws.route53/transport-protocol))
(clojure.spec.alpha/def :portkey.aws.route53/testdnsanswer-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53/nameserver :portkey.aws.route53.testdnsanswer-response/record-name :portkey.aws.route53.testdnsanswer-response/record-type :portkey.aws.route53/record-data :portkey.aws.route53.testdnsanswer-response/response-code :portkey.aws.route53.testdnsanswer-response/protocol] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.route53/health-checks (clojure.spec.alpha/coll-of :portkey.aws.route53/health-check))

(clojure.spec.alpha/def :portkey.aws.route53/health-check-region #{:ap-northeast-1 "ap-northeast-1" "eu-west-1" "ap-southeast-2" "sa-east-1" :us-west-1 "ap-southeast-1" :ap-southeast-1 :us-west-2 :us-east-1 :eu-west-1 "us-west-2" "us-east-1" "us-west-1" :ap-southeast-2 :sa-east-1})

(clojure.spec.alpha/def :portkey.aws.route53/geo-location-continent-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 2 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 2))))
...
(clojure.spec.alpha/def :portkey.aws.route53/list-hosted-zones-by-name-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53/dnsname :portkey.aws.route53.list-hosted-zones-by-name-request/hosted-zone-id :portkey.aws.route53.list-hosted-zones-by-name-request/max-items]))
...
(clojure.spec.alpha/def :portkey.aws.route53/checker-ip-ranges (clojure.spec.alpha/coll-of :portkey.aws.route53/ipaddress-cidr))

(clojure.spec.alpha/def :portkey.aws.route53.createvpcassociation-authorization-response/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53/createvpcassociation-authorization-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.createvpcassociation-authorization-response/hosted-zone-id :portkey.aws.route53/vpc] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53/vpcs (clojure.spec.alpha/coll-of :portkey.aws.route53/vpc :min-count 1))
...
(clojure.spec.alpha/def :portkey.aws.route53/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53/associatevpcwith-hosted-zone-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53/change-info] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.route53.create-traffic-policy-instance-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-hosted-zone-request/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-hosted-zone-request/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/geo-location-continent-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53.hosted-zone/name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.spec.alpha/def :portkey.aws.route53.hosted-zone/resource-record-set-count (clojure.spec.alpha/and :portkey.aws.route53/hosted-zonerrset-count))
...
(clojure.spec.alpha/def :portkey.aws.route53/tag-resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53/ipaddress-cidr (clojure.spec.alpha/and clojure.core/string?))
...
(clojure.spec.alpha/def :portkey.aws.route53/service-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53/dnsrcode (clojure.spec.alpha/and clojure.core/string?))
...
(clojure.spec.alpha/def :portkey.aws.route53/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.route53.invalidvpcid/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/invalidvpcid (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.invalidvpcid/message]))
...
(clojure.spec.alpha/def :portkey.aws.route53/disassociatevpcfrom-hosted-zone-response (clojure.spec.alpha/keys :req-un [:portkey.aws.route53/change-info] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53/record-data-entry (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 0 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.route53.listvpcassociation-authorizations-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53.listvpcassociation-authorizations-request/next-token (clojure.spec.alpha/and :portkey.aws.route53/pagination-token))
(clojure.spec.alpha/def :portkey.aws.route53/listvpcassociation-authorizations-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.listvpcassociation-authorizations-request/hosted-zone-id] :opt-un [:portkey.aws.route53.listvpcassociation-authorizations-request/next-token :portkey.aws.route53/max-results]))
...
(clojure.spec.alpha/def :portkey.aws.route53/health-check-observation (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.health-check-observation/region :portkey.aws.route53/ipaddress :portkey.aws.route53/status-report]))

(clojure.spec.alpha/def :portkey.aws.route53/health-check-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.route53/dnsname (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-document (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 102400))))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-traffic-policy-instance-request/name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.spec.alpha/def :portkey.aws.route53/resourceuri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53/query-logging-config-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.route53.create-hosted-zone-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53/namespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.route53/message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.route53/resource-record-set-identifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53/geo-location-subdivision-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 3))))

(clojure.spec.alpha/def :portkey.aws.route53/ipaddress (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 45)) (clojure.core/fn [s__25970__auto__] (clojure.core/re-matches #"(^((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))$|^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$)" s__25970__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-query-logging-config-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.route53.traffic-policy-summary/type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-reusable-delegation-set-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53.traffic-policy-instance/traffic-policy-type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.traffic-policy-instance/name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-resource-record-sets-response/next-record-name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-resource-record-sets-response/next-record-type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/geo-location-country-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.route53.resource-record/value (clojure.spec.alpha/and :portkey.aws.route53/rdata))
...
(clojure.spec.alpha/def :portkey.aws.route53/alarm-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.route53.associatevpcwith-hosted-zone-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53.associatevpcwith-hosted-zone-request/comment (clojure.spec.alpha/and :portkey.aws.route53/associatevpccomment))
(clojure.spec.alpha/def :portkey.aws.route53/associatevpcwith-hosted-zone-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.associatevpcwith-hosted-zone-request/hosted-zone-id :portkey.aws.route53/vpc] :opt-un [:portkey.aws.route53.associatevpcwith-hosted-zone-request/comment]))
...
(clojure.spec.alpha/def :portkey.aws.route53/resource-path (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53.vpcassociation-not-found/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/vpcassociation-not-found (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.vpcassociation-not-found/message]))

(clojure.spec.alpha/def :portkey.aws.route53/traffic-policy-comment (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.route53/enablesni clojure.core/boolean?)
...
(clojure.spec.alpha/def :portkey.aws.route53/rdata (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 4000))))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-response/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-response/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/disassociatevpccomment (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.route53/page-marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.route53/metric-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53/deletevpcassociation-authorization-response (clojure.spec.alpha/keys :req-un [] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.route53.disassociatevpcfrom-hosted-zone-request/hosted-zone-id (clojure.spec.alpha/and :portkey.aws.route53/resource-id))
(clojure.spec.alpha/def :portkey.aws.route53.disassociatevpcfrom-hosted-zone-request/comment (clojure.spec.alpha/and :portkey.aws.route53/disassociatevpccomment))
(clojure.spec.alpha/def :portkey.aws.route53/disassociatevpcfrom-hosted-zone-request (clojure.spec.alpha/keys :req-un [:portkey.aws.route53.disassociatevpcfrom-hosted-zone-request/hosted-zone-id :portkey.aws.route53/vpc] :opt-un [:portkey.aws.route53.disassociatevpcfrom-hosted-zone-request/comment]))

(clojure.spec.alpha/def :portkey.aws.route53/nonce (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25968__auto__] (clojure.core/<= 1 (clojure.core/count s__25968__auto__))) (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.route53.vpcassociation-authorization-not-found/message (clojure.spec.alpha/and :portkey.aws.route53/error-message))
(clojure.spec.alpha/def :portkey.aws.route53/vpcassociation-authorization-not-found (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53.vpcassociation-authorization-not-found/message]))
...
(clojure.spec.alpha/def :portkey.aws.route53.resource-record-set/type (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.resource-record-set/name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-hosted-zone-response/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-hosted-zone-response/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53/vpcid (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-policy-response/traffic-policy-instance-name-marker (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
(clojure.spec.alpha/def :portkey.aws.route53.list-traffic-policy-instances-by-policy-response/traffic-policy-instance-type-marker (clojure.spec.alpha/and :portkey.aws.route53/rrtype))
...
(clojure.spec.alpha/def :portkey.aws.route53.create-health-check-response/location (clojure.spec.alpha/and :portkey.aws.route53/resourceuri))
...
(clojure.spec.alpha/def :portkey.aws.route53/fully-qualified-domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__25969__auto__] (clojure.core/< (clojure.core/count s__25969__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.route53/vpc (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.route53/vpcregion :portkey.aws.route53/vpcid]))
...
(clojure.spec.alpha/def :portkey.aws.route53/cloud-watch-region #{:ap-northeast-1 :ap-northeast-2 "ap-northeast-1" :ca-central-1 "eu-west-1" :us-east-2 "ap-northeast-3" "us-east-2" "ap-southeast-2" :eu-west-2 "sa-east-1" :us-west-1 "ap-southeast-1" "ap-northeast-2" "eu-west-3" :ap-southeast-1 :us-west-2 :eu-central-1 :us-east-1 :ap-northeast-3 :eu-west-1 "ca-central-1" "eu-central-1" "eu-west-2" :eu-west-3 "us-west-2" "us-east-1" "us-west-1" :ap-southeast-2 "ap-south-1" :ap-south-1 :sa-east-1})

(clojure.spec.alpha/def :portkey.aws.route53.create-hosted-zone-request/name (clojure.spec.alpha/and :portkey.aws.route53/dnsname))
...
(clojure.core/defn get-reusable-delegation-set-limit ([get-reusable-delegation-set-limit-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-reusable-delegation-set-limit-request get-reusable-delegation-set-limit-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-reusable-delegation-set-limit-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/reusabledelegationsetlimit/{Id}/{Type}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-reusable-delegation-set-limit-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchDelegationSet" :portkey.aws.route53/no-such-delegation-set}})))))
...
(clojure.core/defn list-tags-for-resources ([list-tags-for-resources-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-tags-for-resources-request list-tags-for-resources-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-tags-for-resources-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/tags/{ResourceType}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-tags-for-resources-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete, "ThrottlingException" :portkey.aws.route53/throttling-exception}})))))
...
(clojure.core/defn delete-traffic-policy-instance ([delete-traffic-policy-instance-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-delete-traffic-policy-instance-request delete-traffic-policy-instance-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/delete-traffic-policy-instance-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstance/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/delete-traffic-policy-instance-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance, "InvalidInput" :portkey.aws.route53/invalid-input, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete}})))))
...
(clojure.core/defn list-geo-locations ([] (list-geo-locations {})) ([list-geo-locations-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-geo-locations-request list-geo-locations-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-geo-locations-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/geolocations", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-geo-locations-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn disassociatevpcfrom-hosted-zone ([disassociatevpcfrom-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-disassociatevpcfrom-hosted-zone-request disassociatevpcfrom-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/disassociatevpcfrom-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/disassociatevpc", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/disassociatevpcfrom-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidVPCId" :portkey.aws.route53/invalidvpcid, "VPCAssociationNotFound" :portkey.aws.route53/vpcassociation-not-found, "LastVPCAssociation" :portkey.aws.route53/lastvpcassociation, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
(clojure.spec.alpha/fdef disassociatevpcfrom-hosted-zone :args (clojure.spec.alpha/tuple :portkey.aws.route53/disassociatevpcfrom-hosted-zone-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/disassociatevpcfrom-hosted-zone-response))

(clojure.core/defn delete-query-logging-config ([delete-query-logging-config-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-delete-query-logging-config-request delete-query-logging-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/delete-query-logging-config-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/queryloggingconfig/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/delete-query-logging-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"ConcurrentModification" :portkey.aws.route53/concurrent-modification, "NoSuchQueryLoggingConfig" :portkey.aws.route53/no-such-query-logging-config, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn get-traffic-policy-instance ([get-traffic-policy-instance-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-traffic-policy-instance-request get-traffic-policy-instance-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-traffic-policy-instance-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstance/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-traffic-policy-instance-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn create-traffic-policy ([create-traffic-policy-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-create-traffic-policy-request create-traffic-policy-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/create-traffic-policy-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicy", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/create-traffic-policy-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "TooManyTrafficPolicies" :portkey.aws.route53/too-many-traffic-policies, "TrafficPolicyAlreadyExists" :portkey.aws.route53/traffic-policy-already-exists, "InvalidTrafficPolicyDocument" :portkey.aws.route53/invalid-traffic-policy-document}})))))
...
(clojure.core/defn createvpcassociation-authorization ([createvpcassociation-authorization-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-createvpcassociation-authorization-request createvpcassociation-authorization-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/createvpcassociation-authorization-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/createvpcassociation-authorization-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"ConcurrentModification" :portkey.aws.route53/concurrent-modification, "TooManyVPCAssociationAuthorizations" :portkey.aws.route53/too-manyvpcassociation-authorizations, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidVPCId" :portkey.aws.route53/invalidvpcid, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
(clojure.spec.alpha/fdef createvpcassociation-authorization :args (clojure.spec.alpha/tuple :portkey.aws.route53/createvpcassociation-authorization-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/createvpcassociation-authorization-response))

(clojure.core/defn get-account-limit ([get-account-limit-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-account-limit-request get-account-limit-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-account-limit-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/accountlimit/{Type}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-account-limit-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn get-reusable-delegation-set ([get-reusable-delegation-set-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-reusable-delegation-set-request get-reusable-delegation-set-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-reusable-delegation-set-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/delegationset/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-reusable-delegation-set-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchDelegationSet" :portkey.aws.route53/no-such-delegation-set, "DelegationSetNotReusable" :portkey.aws.route53/delegation-set-not-reusable, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn get-traffic-policy ([get-traffic-policy-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-traffic-policy-request get-traffic-policy-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-traffic-policy-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicy/{Id}/{Version}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-traffic-policy-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn list-traffic-policy-instances ([] (list-traffic-policy-instances {})) ([list-traffic-policy-instances-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-traffic-policy-instances-request list-traffic-policy-instances-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-traffic-policy-instances-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstances", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-traffic-policy-instances-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance}})))))
...
(clojure.core/defn create-traffic-policy-version ([create-traffic-policy-version-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-create-traffic-policy-version-request create-traffic-policy-version-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/create-traffic-policy-version-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicy/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/create-traffic-policy-version-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy, "InvalidInput" :portkey.aws.route53/invalid-input, "TooManyTrafficPolicyVersionsForCurrentPolicy" :portkey.aws.route53/too-many-traffic-policy-versions-for-current-policy, "ConcurrentModification" :portkey.aws.route53/concurrent-modification, "InvalidTrafficPolicyDocument" :portkey.aws.route53/invalid-traffic-policy-document}})))))
...
(clojure.core/defn list-hosted-zones-by-name ([] (list-hosted-zones-by-name {})) ([list-hosted-zones-by-name-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-hosted-zones-by-name-request list-hosted-zones-by-name-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-hosted-zones-by-name-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzonesbyname", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-hosted-zones-by-name-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "InvalidDomainName" :portkey.aws.route53/invalid-domain-name}})))))
...
(clojure.core/defn delete-health-check ([delete-health-check-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-delete-health-check-request delete-health-check-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/delete-health-check-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheck/{HealthCheckId}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/delete-health-check-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "HealthCheckInUse" :portkey.aws.route53/health-check-in-use, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn list-traffic-policy-versions ([list-traffic-policy-versions-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-traffic-policy-versions-request list-traffic-policy-versions-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-traffic-policy-versions-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicies/{Id}/versions", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-traffic-policy-versions-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy}})))))
...
(clojure.core/defn list-tags-for-resource ([list-tags-for-resource-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-tags-for-resource-request list-tags-for-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-tags-for-resource-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/tags/{ResourceType}/{ResourceId}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-tags-for-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete, "ThrottlingException" :portkey.aws.route53/throttling-exception}})))))
...
(clojure.core/defn list-hosted-zones ([] (list-hosted-zones {})) ([list-hosted-zones-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-hosted-zones-request list-hosted-zones-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-hosted-zones-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-hosted-zones-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchDelegationSet" :portkey.aws.route53/no-such-delegation-set, "DelegationSetNotReusable" :portkey.aws.route53/delegation-set-not-reusable}})))))
...
(clojure.core/defn get-hosted-zone-limit ([get-hosted-zone-limit-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-hosted-zone-limit-request get-hosted-zone-limit-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-hosted-zone-limit-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzonelimit/{Id}/{Type}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-hosted-zone-limit-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidInput" :portkey.aws.route53/invalid-input, "HostedZoneNotPrivate" :portkey.aws.route53/hosted-zone-not-private}})))))
...
(clojure.core/defn get-geo-location ([] (get-geo-location {})) ([get-geo-location-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-geo-location-request get-geo-location-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-geo-location-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/geolocation", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-geo-location-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchGeoLocation" :portkey.aws.route53/no-such-geo-location, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn update-traffic-policy-comment ([update-traffic-policy-comment-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-update-traffic-policy-comment-request update-traffic-policy-comment-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/update-traffic-policy-comment-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicy/{Id}/{Version}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/update-traffic-policy-comment-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy, "ConcurrentModification" :portkey.aws.route53/concurrent-modification}})))))
...
(clojure.core/defn get-traffic-policy-instance-count ([] (get-traffic-policy-instance-count {})) ([get-traffic-policy-instance-count-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-traffic-policy-instance-count-request get-traffic-policy-instance-count-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-traffic-policy-instance-count-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstancecount", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-traffic-policy-instance-count-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {}})))))
...
(clojure.core/defn get-hosted-zone ([get-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-hosted-zone-request get-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn listvpcassociation-authorizations ([listvpcassociation-authorizations-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-listvpcassociation-authorizations-request listvpcassociation-authorizations-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/listvpcassociation-authorizations-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/listvpcassociation-authorizations-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidInput" :portkey.aws.route53/invalid-input, "InvalidPaginationToken" :portkey.aws.route53/invalid-pagination-token}})))))
(clojure.spec.alpha/fdef listvpcassociation-authorizations :args (clojure.spec.alpha/tuple :portkey.aws.route53/listvpcassociation-authorizations-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/listvpcassociation-authorizations-response))

(clojure.core/defn list-traffic-policies ([] (list-traffic-policies {})) ([list-traffic-policies-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-traffic-policies-request list-traffic-policies-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-traffic-policies-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicies", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-traffic-policies-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn create-hosted-zone ([create-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-create-hosted-zone-request create-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/create-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/create-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"DelegationSetNotReusable" :portkey.aws.route53/delegation-set-not-reusable, "InvalidDomainName" :portkey.aws.route53/invalid-domain-name, "InvalidInput" :portkey.aws.route53/invalid-input, "InvalidVPCId" :portkey.aws.route53/invalidvpcid, "NoSuchDelegationSet" :portkey.aws.route53/no-such-delegation-set, "ConflictingDomainExists" :portkey.aws.route53/conflicting-domain-exists, "HostedZoneAlreadyExists" :portkey.aws.route53/hosted-zone-already-exists, "TooManyHostedZones" :portkey.aws.route53/too-many-hosted-zones, "DelegationSetNotAvailable" :portkey.aws.route53/delegation-set-not-available}})))))
...
(clojure.core/defn list-health-checks ([] (list-health-checks {})) ([list-health-checks-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-health-checks-request list-health-checks-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-health-checks-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheck", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-health-checks-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "IncompatibleVersion" :portkey.aws.route53/incompatible-version}})))))
...
(clojure.core/defn deletevpcassociation-authorization ([deletevpcassociation-authorization-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-deletevpcassociation-authorization-request deletevpcassociation-authorization-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/deletevpcassociation-authorization-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/deletevpcassociation-authorization-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"ConcurrentModification" :portkey.aws.route53/concurrent-modification, "VPCAssociationAuthorizationNotFound" :portkey.aws.route53/vpcassociation-authorization-not-found, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidVPCId" :portkey.aws.route53/invalidvpcid, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
(clojure.spec.alpha/fdef deletevpcassociation-authorization :args (clojure.spec.alpha/tuple :portkey.aws.route53/deletevpcassociation-authorization-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/deletevpcassociation-authorization-response))

(clojure.core/defn get-health-check ([get-health-check-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-health-check-request get-health-check-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-health-check-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheck/{HealthCheckId}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-health-check-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "InvalidInput" :portkey.aws.route53/invalid-input, "IncompatibleVersion" :portkey.aws.route53/incompatible-version}})))))
...
(clojure.core/defn list-traffic-policy-instances-by-policy ([list-traffic-policy-instances-by-policy-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-traffic-policy-instances-by-policy-request list-traffic-policy-instances-by-policy-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-traffic-policy-instances-by-policy-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstances/trafficpolicy", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-traffic-policy-instances-by-policy-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance, "NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy}})))))
...
(clojure.core/defn change-tags-for-resource ([change-tags-for-resource-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-change-tags-for-resource-request change-tags-for-resource-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/change-tags-for-resource-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/tags/{ResourceType}/{ResourceId}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/change-tags-for-resource-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete, "ThrottlingException" :portkey.aws.route53/throttling-exception}})))))
...
(clojure.core/defn delete-traffic-policy ([delete-traffic-policy-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-delete-traffic-policy-request delete-traffic-policy-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/delete-traffic-policy-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicy/{Id}/{Version}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/delete-traffic-policy-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy, "InvalidInput" :portkey.aws.route53/invalid-input, "TrafficPolicyInUse" :portkey.aws.route53/traffic-policy-in-use, "ConcurrentModification" :portkey.aws.route53/concurrent-modification}})))))
...
(clojure.core/defn get-health-check-count ([] (get-health-check-count {})) ([get-health-check-count-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-health-check-count-request get-health-check-count-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-health-check-count-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheckcount", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-health-check-count-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {}})))))
...
(clojure.core/defn testdnsanswer ([testdnsanswer-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-testdnsanswer-request testdnsanswer-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/testdnsanswer-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/testdnsanswer", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/testdnsanswer-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
(clojure.spec.alpha/fdef testdnsanswer :args (clojure.spec.alpha/tuple :portkey.aws.route53/testdnsanswer-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/testdnsanswer-response))

(clojure.core/defn update-traffic-policy-instance ([update-traffic-policy-instance-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-update-traffic-policy-instance-request update-traffic-policy-instance-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/update-traffic-policy-instance-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstance/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/update-traffic-policy-instance-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicy" :portkey.aws.route53/no-such-traffic-policy, "NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete, "ConflictingTypes" :portkey.aws.route53/conflicting-types}})))))
...
(clojure.core/defn list-traffic-policy-instances-by-hosted-zone ([list-traffic-policy-instances-by-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-traffic-policy-instances-by-hosted-zone-request list-traffic-policy-instances-by-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-traffic-policy-instances-by-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/trafficpolicyinstances/hostedzone", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-traffic-policy-instances-by-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "NoSuchTrafficPolicyInstance" :portkey.aws.route53/no-such-traffic-policy-instance, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone}})))))
...
(clojure.core/defn get-change ([get-change-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-change-request get-change-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-change-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/change/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-change-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchChange" :portkey.aws.route53/no-such-change, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn list-query-logging-configs ([] (list-query-logging-configs {})) ([list-query-logging-configs-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-query-logging-configs-request list-query-logging-configs-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-query-logging-configs-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/queryloggingconfig", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-query-logging-configs-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input, "InvalidPaginationToken" :portkey.aws.route53/invalid-pagination-token, "NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone}})))))
...
(clojure.core/defn create-health-check ([create-health-check-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-create-health-check-request create-health-check-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/create-health-check-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheck", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/create-health-check-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.spec/error-spec {"TooManyHealthChecks" :portkey.aws.route53/too-many-health-checks, "HealthCheckAlreadyExists" :portkey.aws.route53/health-check-already-exists, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn associatevpcwith-hosted-zone ([associatevpcwith-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-associatevpcwith-hosted-zone-request associatevpcwith-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/associatevpcwith-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/associatevpc", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/associatevpcwith-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "NotAuthorizedException" :portkey.aws.route53/not-authorized-exception, "InvalidVPCId" :portkey.aws.route53/invalidvpcid, "InvalidInput" :portkey.aws.route53/invalid-input, "PublicZoneVPCAssociation" :portkey.aws.route53/public-zonevpcassociation, "ConflictingDomainExists" :portkey.aws.route53/conflicting-domain-exists, "LimitsExceeded" :portkey.aws.route53/limits-exceeded}})))))
(clojure.spec.alpha/fdef associatevpcwith-hosted-zone :args (clojure.spec.alpha/tuple :portkey.aws.route53/associatevpcwith-hosted-zone-request) :ret (clojure.spec.alpha/and :portkey.aws.route53/associatevpcwith-hosted-zone-response))

(clojure.core/defn change-resource-record-sets ([change-resource-record-sets-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-change-resource-record-sets-request change-resource-record-sets-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/change-resource-record-sets-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/rrset/", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/change-resource-record-sets-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "InvalidChangeBatch" :portkey.aws.route53/invalid-change-batch, "InvalidInput" :portkey.aws.route53/invalid-input, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete}})))))
...
(clojure.core/defn list-resource-record-sets ([list-resource-record-sets-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-resource-record-sets-request list-resource-record-sets-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-resource-record-sets-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}/rrset", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-resource-record-sets-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn get-hosted-zone-count ([] (get-hosted-zone-count {})) ([get-hosted-zone-count-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-hosted-zone-count-request get-hosted-zone-count-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-hosted-zone-count-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzonecount", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-hosted-zone-count-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn get-health-check-last-failure-reason ([get-health-check-last-failure-reason-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-health-check-last-failure-reason-request get-health-check-last-failure-reason-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-health-check-last-failure-reason-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/healthcheck/{HealthCheckId}/lastfailurereason", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-health-check-last-failure-reason-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHealthCheck" :portkey.aws.route53/no-such-health-check, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn list-reusable-delegation-sets ([] (list-reusable-delegation-sets {})) ([list-reusable-delegation-sets-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-list-reusable-delegation-sets-request list-reusable-delegation-sets-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/list-reusable-delegation-sets-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/delegationset", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/list-reusable-delegation-sets-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"InvalidInput" :portkey.aws.route53/invalid-input}})))))
...
(clojure.core/defn delete-hosted-zone ([delete-hosted-zone-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-delete-hosted-zone-request delete-hosted-zone-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/delete-hosted-zone-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/hostedzone/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/delete-hosted-zone-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :delete, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchHostedZone" :portkey.aws.route53/no-such-hosted-zone, "HostedZoneNotEmpty" :portkey.aws.route53/hosted-zone-not-empty, "PriorRequestNotComplete" :portkey.aws.route53/prior-request-not-complete, "InvalidInput" :portkey.aws.route53/invalid-input, "InvalidDomainName" :portkey.aws.route53/invalid-domain-name}})))))
...
(clojure.core/defn get-query-logging-config ([get-query-logging-config-request-input] (clojure.core/let [request-function-result__26422__auto__ (req<-get-query-logging-config-request get-query-logging-config-request-input)] (portkey.aws/-call-http (clojure.core/into request-function-result__26422__auto__ {:http.request.configuration/endpoints portkey.aws.route53/endpoints, :http.request.spec/output-spec :portkey.aws.route53/get-query-logging-config-response, :http.request.configuration/mime-type {"content-type" "application/x-www-form-urlencoded; charset=utf-8"}, :http.request.configuration/request-uri "/2013-04-01/queryloggingconfig/{Id}", :http.request.configuration/service-id "Route 53", :http.request.spec/input-spec :portkey.aws.route53/get-query-logging-config-request, :http.request.configuration/protocol "rest-xml", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.spec/error-spec {"NoSuchQueryLoggingConfig" :portkey.aws.route53/no-such-query-logging-config, "InvalidInput" :portkey.aws.route53/invalid-input}})))))
