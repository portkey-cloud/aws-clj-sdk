...
(clojure.core/defn- response-marketplace-commerce-analytics-exception ([input] (response-marketplace-commerce-analytics-exception nil input)) ([resultWrapper1263408 input] (clojure.core/let [rawinput1263407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1263409 {"message" (rawinput1263407 "message")}] (clojure.core/cond-> {} (letvar1263409 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1263409 ["message"])))))))

(clojure.core/defn- response-generate-data-set-result ([input] (response-generate-data-set-result nil input)) ([resultWrapper1263411 input] (clojure.core/let [rawinput1263410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1263412 {"dataSetRequestId" (rawinput1263410 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1263412 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1263412 ["dataSetRequestId"])))))))

(clojure.core/defn- response-start-support-data-export-result ([input] (response-start-support-data-export-result nil input)) ([resultWrapper1263414 input] (clojure.core/let [rawinput1263413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1263415 {"dataSetRequestId" (rawinput1263413 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1263415 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1263415 ["dataSetRequestId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/optional-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/role-name-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/destination-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
