...
(clojure.core/defn- deser-marketplace-commerce-analytics-exception [input] (clojure.core/cond-> {} (clojure.core/contains? input "message") (clojure.core/assoc :message (deser-exception-message (input "message")))))

(clojure.core/defn- deser-generate-data-set-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (input "dataSetRequestId")))))

(clojure.core/defn- deser-start-support-data-export-result [input] (clojure.core/cond-> {} (clojure.core/contains? input "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (input "dataSetRequestId")))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/optional-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/optional-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__))) (clojure.core/fn [s__27880__auto__] (clojure.core/< (clojure.core/count s__27880__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/role-name-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/destination-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27879__auto__] (clojure.core/<= 1 (clojure.core/count s__27879__auto__)))))
