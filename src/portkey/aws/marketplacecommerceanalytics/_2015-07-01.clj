...
(clojure.core/defn- response-marketplace-commerce-analytics-exception ([input] (response-marketplace-commerce-analytics-exception nil input)) ([resultWrapper1901581 input] (clojure.core/let [rawinput1901580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901582 {"message" (rawinput1901580 "message")}] (clojure.core/cond-> {} (letvar1901582 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901582 ["message"])))))))

(clojure.core/defn- response-generate-data-set-result ([input] (response-generate-data-set-result nil input)) ([resultWrapper1901584 input] (clojure.core/let [rawinput1901583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901585 {"dataSetRequestId" (rawinput1901583 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1901585 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1901585 ["dataSetRequestId"])))))))

(clojure.core/defn- response-start-support-data-export-result ([input] (response-start-support-data-export-result nil input)) ([resultWrapper1901587 input] (clojure.core/let [rawinput1901586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901588 {"dataSetRequestId" (rawinput1901586 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1901588 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1901588 ["dataSetRequestId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/optional-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/role-name-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics.-2015-07-01/destination-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
