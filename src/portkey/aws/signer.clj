...
(clojure.core/defn- response-list-signing-platforms-response ([input] (response-list-signing-platforms-response nil input)) ([resultWrapper470936 input] (clojure.core/let [rawinput470935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470937 {"platforms" (rawinput470935 "platforms"), "nextToken" (rawinput470935 "nextToken")}] (clojure.core/cond-> {} (letvar470937 "platforms") (clojure.core/assoc :platforms (deser-signing-platforms (clojure.core/get-in letvar470937 ["platforms"]))) (letvar470937 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar470937 ["nextToken"])))))))

(clojure.core/defn- response-put-signing-profile-response ([input] (response-put-signing-profile-response nil input)) ([resultWrapper470939 input] (clojure.core/let [rawinput470938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470940 {"arn" (rawinput470938 "arn")}] (clojure.core/cond-> {} (letvar470940 "arn") (clojure.core/assoc :arn (deserstring (clojure.core/get-in letvar470940 ["arn"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper470942 input] (clojure.core/let [rawinput470941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470943 {"message" (rawinput470941 "message")}] (clojure.core/cond-> {} (letvar470943 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar470943 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper470945 input] (clojure.core/let [rawinput470944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470946 {"message" (rawinput470944 "message")}] (clojure.core/cond-> {} (letvar470946 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar470946 ["message"])))))))

(clojure.core/defn- response-start-signing-job-response ([input] (response-start-signing-job-response nil input)) ([resultWrapper470948 input] (clojure.core/let [rawinput470947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470949 {"jobId" (rawinput470947 "jobId")}] (clojure.core/cond-> {} (letvar470949 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar470949 ["jobId"])))))))

(clojure.core/defn- response-get-signing-profile-response ([input] (response-get-signing-profile-response nil input)) ([resultWrapper470951 input] (clojure.core/let [rawinput470950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470952 {"profileName" (rawinput470950 "profileName"), "signingMaterial" (rawinput470950 "signingMaterial"), "platformId" (rawinput470950 "platformId"), "overrides" (rawinput470950 "overrides"), "signingParameters" (rawinput470950 "signingParameters"), "status" (rawinput470950 "status")}] (clojure.core/cond-> {} (letvar470952 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar470952 ["profileName"]))) (letvar470952 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar470952 ["signingMaterial"]))) (letvar470952 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar470952 ["platformId"]))) (letvar470952 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar470952 ["overrides"]))) (letvar470952 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar470952 ["signingParameters"]))) (letvar470952 "status") (clojure.core/assoc :status (deser-signing-profile-status (clojure.core/get-in letvar470952 ["status"])))))))

(clojure.core/defn- response-list-signing-profiles-response ([input] (response-list-signing-profiles-response nil input)) ([resultWrapper470954 input] (clojure.core/let [rawinput470953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470955 {"profiles" (rawinput470953 "profiles"), "nextToken" (rawinput470953 "nextToken")}] (clojure.core/cond-> {} (letvar470955 "profiles") (clojure.core/assoc :profiles (deser-signing-profiles (clojure.core/get-in letvar470955 ["profiles"]))) (letvar470955 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar470955 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper470957 input] (clojure.core/let [rawinput470956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470958 {"message" (rawinput470956 "message")}] (clojure.core/cond-> {} (letvar470958 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar470958 ["message"])))))))

(clojure.core/defn- response-get-signing-platform-response ([input] (response-get-signing-platform-response nil input)) ([resultWrapper470960 input] (clojure.core/let [rawinput470959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470961 {"platformId" (rawinput470959 "platformId"), "displayName" (rawinput470959 "displayName"), "partner" (rawinput470959 "partner"), "target" (rawinput470959 "target"), "category" (rawinput470959 "category"), "signingConfiguration" (rawinput470959 "signingConfiguration"), "signingImageFormat" (rawinput470959 "signingImageFormat"), "maxSizeInMB" (rawinput470959 "maxSizeInMB")}] (clojure.core/cond-> {} (letvar470961 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar470961 ["platformId"]))) (letvar470961 "displayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar470961 ["displayName"]))) (letvar470961 "partner") (clojure.core/assoc :partner (deser-string (clojure.core/get-in letvar470961 ["partner"]))) (letvar470961 "target") (clojure.core/assoc :target (deser-string (clojure.core/get-in letvar470961 ["target"]))) (letvar470961 "category") (clojure.core/assoc :category (deser-category (clojure.core/get-in letvar470961 ["category"]))) (letvar470961 "signingConfiguration") (clojure.core/assoc :signing-configuration (deser-signing-configuration (clojure.core/get-in letvar470961 ["signingConfiguration"]))) (letvar470961 "signingImageFormat") (clojure.core/assoc :signing-image-format (deser-signing-image-format (clojure.core/get-in letvar470961 ["signingImageFormat"]))) (letvar470961 "maxSizeInMB") (clojure.core/assoc :max-size-in-mb (deser-max-size-in-mb (clojure.core/get-in letvar470961 ["maxSizeInMB"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper470963 input] (clojure.core/let [rawinput470962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470964 {"message" (rawinput470962 "message")}] (clojure.core/cond-> {} (letvar470964 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar470964 ["message"])))))))

(clojure.core/defn- response-describe-signing-job-response ([input] (response-describe-signing-job-response nil input)) ([resultWrapper470966 input] (clojure.core/let [rawinput470965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470967 {"overrides" (rawinput470965 "overrides"), "signingParameters" (rawinput470965 "signingParameters"), "createdAt" (rawinput470965 "createdAt"), "completedAt" (rawinput470965 "completedAt"), "signingMaterial" (rawinput470965 "signingMaterial"), "status" (rawinput470965 "status"), "requestedBy" (rawinput470965 "requestedBy"), "source" (rawinput470965 "source"), "signedObject" (rawinput470965 "signedObject"), "profileName" (rawinput470965 "profileName"), "statusReason" (rawinput470965 "statusReason"), "platformId" (rawinput470965 "platformId"), "jobId" (rawinput470965 "jobId")}] (clojure.core/cond-> {} (letvar470967 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar470967 ["overrides"]))) (letvar470967 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar470967 ["signingParameters"]))) (letvar470967 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar470967 ["createdAt"]))) (letvar470967 "completedAt") (clojure.core/assoc :completed-at (deser-completed-at (clojure.core/get-in letvar470967 ["completedAt"]))) (letvar470967 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar470967 ["signingMaterial"]))) (letvar470967 "status") (clojure.core/assoc :status (deser-signing-status (clojure.core/get-in letvar470967 ["status"]))) (letvar470967 "requestedBy") (clojure.core/assoc :requested-by (deser-requested-by (clojure.core/get-in letvar470967 ["requestedBy"]))) (letvar470967 "source") (clojure.core/assoc :source (deser-source (clojure.core/get-in letvar470967 ["source"]))) (letvar470967 "signedObject") (clojure.core/assoc :signed-object (deser-signed-object (clojure.core/get-in letvar470967 ["signedObject"]))) (letvar470967 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar470967 ["profileName"]))) (letvar470967 "statusReason") (clojure.core/assoc :status-reason (deser-status-reason (clojure.core/get-in letvar470967 ["statusReason"]))) (letvar470967 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar470967 ["platformId"]))) (letvar470967 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar470967 ["jobId"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper470969 input] (clojure.core/let [rawinput470968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470970 {"message" (rawinput470968 "message")}] (clojure.core/cond-> {} (letvar470970 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar470970 ["message"])))))))

(clojure.core/defn- response-list-signing-jobs-response ([input] (response-list-signing-jobs-response nil input)) ([resultWrapper470972 input] (clojure.core/let [rawinput470971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar470973 {"jobs" (rawinput470971 "jobs"), "nextToken" (rawinput470971 "nextToken")}] (clojure.core/cond-> {} (letvar470973 "jobs") (clojure.core/assoc :jobs (deser-signing-jobs (clojure.core/get-in letvar470973 ["jobs"]))) (letvar470973 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar470973 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.signer/profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 2 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 20)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]{2,}" s__21112__auto__))))
