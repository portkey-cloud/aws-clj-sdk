...
(clojure.core/defn- response-list-signing-platforms-response ([input] (response-list-signing-platforms-response nil input)) ([resultWrapper1733101 input] (clojure.core/let [rawinput1733100 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733102 {"platforms" (rawinput1733100 "platforms"), "nextToken" (rawinput1733100 "nextToken")}] (clojure.core/cond-> {} (letvar1733102 "platforms") (clojure.core/assoc :platforms (deser-signing-platforms (clojure.core/get-in letvar1733102 ["platforms"]))) (letvar1733102 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1733102 ["nextToken"])))))))

(clojure.core/defn- response-put-signing-profile-response ([input] (response-put-signing-profile-response nil input)) ([resultWrapper1733104 input] (clojure.core/let [rawinput1733103 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733105 {"arn" (rawinput1733103 "arn")}] (clojure.core/cond-> {} (letvar1733105 "arn") (clojure.core/assoc :arn (deserstring (clojure.core/get-in letvar1733105 ["arn"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1733107 input] (clojure.core/let [rawinput1733106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733108 {"message" (rawinput1733106 "message")}] (clojure.core/cond-> {} (letvar1733108 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1733108 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1733110 input] (clojure.core/let [rawinput1733109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733111 {"message" (rawinput1733109 "message")}] (clojure.core/cond-> {} (letvar1733111 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1733111 ["message"])))))))

(clojure.core/defn- response-start-signing-job-response ([input] (response-start-signing-job-response nil input)) ([resultWrapper1733113 input] (clojure.core/let [rawinput1733112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733114 {"jobId" (rawinput1733112 "jobId")}] (clojure.core/cond-> {} (letvar1733114 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1733114 ["jobId"])))))))

(clojure.core/defn- response-get-signing-profile-response ([input] (response-get-signing-profile-response nil input)) ([resultWrapper1733116 input] (clojure.core/let [rawinput1733115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733117 {"profileName" (rawinput1733115 "profileName"), "signingMaterial" (rawinput1733115 "signingMaterial"), "platformId" (rawinput1733115 "platformId"), "overrides" (rawinput1733115 "overrides"), "signingParameters" (rawinput1733115 "signingParameters"), "status" (rawinput1733115 "status")}] (clojure.core/cond-> {} (letvar1733117 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar1733117 ["profileName"]))) (letvar1733117 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar1733117 ["signingMaterial"]))) (letvar1733117 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1733117 ["platformId"]))) (letvar1733117 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar1733117 ["overrides"]))) (letvar1733117 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar1733117 ["signingParameters"]))) (letvar1733117 "status") (clojure.core/assoc :status (deser-signing-profile-status (clojure.core/get-in letvar1733117 ["status"])))))))

(clojure.core/defn- response-list-signing-profiles-response ([input] (response-list-signing-profiles-response nil input)) ([resultWrapper1733119 input] (clojure.core/let [rawinput1733118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733120 {"profiles" (rawinput1733118 "profiles"), "nextToken" (rawinput1733118 "nextToken")}] (clojure.core/cond-> {} (letvar1733120 "profiles") (clojure.core/assoc :profiles (deser-signing-profiles (clojure.core/get-in letvar1733120 ["profiles"]))) (letvar1733120 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1733120 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1733122 input] (clojure.core/let [rawinput1733121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733123 {"message" (rawinput1733121 "message")}] (clojure.core/cond-> {} (letvar1733123 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1733123 ["message"])))))))

(clojure.core/defn- response-get-signing-platform-response ([input] (response-get-signing-platform-response nil input)) ([resultWrapper1733125 input] (clojure.core/let [rawinput1733124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733126 {"platformId" (rawinput1733124 "platformId"), "displayName" (rawinput1733124 "displayName"), "partner" (rawinput1733124 "partner"), "target" (rawinput1733124 "target"), "category" (rawinput1733124 "category"), "signingConfiguration" (rawinput1733124 "signingConfiguration"), "signingImageFormat" (rawinput1733124 "signingImageFormat"), "maxSizeInMB" (rawinput1733124 "maxSizeInMB")}] (clojure.core/cond-> {} (letvar1733126 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1733126 ["platformId"]))) (letvar1733126 "displayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar1733126 ["displayName"]))) (letvar1733126 "partner") (clojure.core/assoc :partner (deser-string (clojure.core/get-in letvar1733126 ["partner"]))) (letvar1733126 "target") (clojure.core/assoc :target (deser-string (clojure.core/get-in letvar1733126 ["target"]))) (letvar1733126 "category") (clojure.core/assoc :category (deser-category (clojure.core/get-in letvar1733126 ["category"]))) (letvar1733126 "signingConfiguration") (clojure.core/assoc :signing-configuration (deser-signing-configuration (clojure.core/get-in letvar1733126 ["signingConfiguration"]))) (letvar1733126 "signingImageFormat") (clojure.core/assoc :signing-image-format (deser-signing-image-format (clojure.core/get-in letvar1733126 ["signingImageFormat"]))) (letvar1733126 "maxSizeInMB") (clojure.core/assoc :max-size-in-mb (deser-max-size-in-mb (clojure.core/get-in letvar1733126 ["maxSizeInMB"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1733128 input] (clojure.core/let [rawinput1733127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733129 {"message" (rawinput1733127 "message")}] (clojure.core/cond-> {} (letvar1733129 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1733129 ["message"])))))))

(clojure.core/defn- response-describe-signing-job-response ([input] (response-describe-signing-job-response nil input)) ([resultWrapper1733131 input] (clojure.core/let [rawinput1733130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733132 {"overrides" (rawinput1733130 "overrides"), "signingParameters" (rawinput1733130 "signingParameters"), "createdAt" (rawinput1733130 "createdAt"), "completedAt" (rawinput1733130 "completedAt"), "signingMaterial" (rawinput1733130 "signingMaterial"), "status" (rawinput1733130 "status"), "requestedBy" (rawinput1733130 "requestedBy"), "source" (rawinput1733130 "source"), "signedObject" (rawinput1733130 "signedObject"), "profileName" (rawinput1733130 "profileName"), "statusReason" (rawinput1733130 "statusReason"), "platformId" (rawinput1733130 "platformId"), "jobId" (rawinput1733130 "jobId")}] (clojure.core/cond-> {} (letvar1733132 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar1733132 ["overrides"]))) (letvar1733132 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar1733132 ["signingParameters"]))) (letvar1733132 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar1733132 ["createdAt"]))) (letvar1733132 "completedAt") (clojure.core/assoc :completed-at (deser-completed-at (clojure.core/get-in letvar1733132 ["completedAt"]))) (letvar1733132 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar1733132 ["signingMaterial"]))) (letvar1733132 "status") (clojure.core/assoc :status (deser-signing-status (clojure.core/get-in letvar1733132 ["status"]))) (letvar1733132 "requestedBy") (clojure.core/assoc :requested-by (deser-requested-by (clojure.core/get-in letvar1733132 ["requestedBy"]))) (letvar1733132 "source") (clojure.core/assoc :source (deser-source (clojure.core/get-in letvar1733132 ["source"]))) (letvar1733132 "signedObject") (clojure.core/assoc :signed-object (deser-signed-object (clojure.core/get-in letvar1733132 ["signedObject"]))) (letvar1733132 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar1733132 ["profileName"]))) (letvar1733132 "statusReason") (clojure.core/assoc :status-reason (deser-status-reason (clojure.core/get-in letvar1733132 ["statusReason"]))) (letvar1733132 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1733132 ["platformId"]))) (letvar1733132 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1733132 ["jobId"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1733134 input] (clojure.core/let [rawinput1733133 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733135 {"message" (rawinput1733133 "message")}] (clojure.core/cond-> {} (letvar1733135 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1733135 ["message"])))))))

(clojure.core/defn- response-list-signing-jobs-response ([input] (response-list-signing-jobs-response nil input)) ([resultWrapper1733137 input] (clojure.core/let [rawinput1733136 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1733138 {"jobs" (rawinput1733136 "jobs"), "nextToken" (rawinput1733136 "nextToken")}] (clojure.core/cond-> {} (letvar1733138 "jobs") (clojure.core/assoc :jobs (deser-signing-jobs (clojure.core/get-in letvar1733138 ["jobs"]))) (letvar1733138 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1733138 ["nextToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.signer/profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]{2,}" s__21078__auto__))))
