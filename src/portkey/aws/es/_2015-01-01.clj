...
(clojure.core/defn- response-delete-elasticsearch-domain-response ([input] (response-delete-elasticsearch-domain-response nil input)) ([resultWrapper949927 input] (clojure.core/let [rawinput949926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949928 {"DomainStatus" (rawinput949926 "DomainStatus")}] (clojure.core/cond-> {} (letvar949928 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar949928 ["DomainStatus"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper949930 input] (clojure.core/let [rawinput949929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949931 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-elasticsearch-domain-response ([input] (response-describe-elasticsearch-domain-response nil input)) ([resultWrapper949933 input] (clojure.core/let [rawinput949932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949934 {"DomainStatus" (rawinput949932 "DomainStatus")}] (clojure.core/cond-> {:domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar949934 ["DomainStatus"]))}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper949936 input] (clojure.core/let [rawinput949935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949937 {"TagList" (rawinput949935 "TagList")}] (clojure.core/cond-> {} (letvar949937 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar949937 ["TagList"])))))))

(clojure.core/defn- response-get-compatible-elasticsearch-versions-response ([input] (response-get-compatible-elasticsearch-versions-response nil input)) ([resultWrapper949939 input] (clojure.core/let [rawinput949938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949940 {"CompatibleElasticsearchVersions" (rawinput949938 "CompatibleElasticsearchVersions")}] (clojure.core/cond-> {} (letvar949940 "CompatibleElasticsearchVersions") (clojure.core/assoc :compatible-elasticsearch-versions (deser-compatible-elasticsearch-versions-list (clojure.core/get-in letvar949940 ["CompatibleElasticsearchVersions"])))))))

(clojure.core/defn- response-list-elasticsearch-versions-response ([input] (response-list-elasticsearch-versions-response nil input)) ([resultWrapper949942 input] (clojure.core/let [rawinput949941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949943 {"ElasticsearchVersions" (rawinput949941 "ElasticsearchVersions"), "NextToken" (rawinput949941 "NextToken")}] (clojure.core/cond-> {} (letvar949943 "ElasticsearchVersions") (clojure.core/assoc :elasticsearch-versions (deser-elasticsearch-version-list (clojure.core/get-in letvar949943 ["ElasticsearchVersions"]))) (letvar949943 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar949943 ["NextToken"])))))))

(clojure.core/defn- response-cancel-elasticsearch-service-software-update-response ([input] (response-cancel-elasticsearch-service-software-update-response nil input)) ([resultWrapper949945 input] (clojure.core/let [rawinput949944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949946 {"ServiceSoftwareOptions" (rawinput949944 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar949946 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar949946 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-start-elasticsearch-service-software-update-response ([input] (response-start-elasticsearch-service-software-update-response nil input)) ([resultWrapper949948 input] (clojure.core/let [rawinput949947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949949 {"ServiceSoftwareOptions" (rawinput949947 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar949949 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar949949 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper949951 input] (clojure.core/let [rawinput949950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949952 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper949954 input] (clojure.core/let [rawinput949953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949955 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper949957 input] (clojure.core/let [rawinput949956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949958 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-upgrade-status-response ([input] (response-get-upgrade-status-response nil input)) ([resultWrapper949960 input] (clojure.core/let [rawinput949959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949961 {"UpgradeStep" (rawinput949959 "UpgradeStep"), "StepStatus" (rawinput949959 "StepStatus"), "UpgradeName" (rawinput949959 "UpgradeName")}] (clojure.core/cond-> {} (letvar949961 "UpgradeStep") (clojure.core/assoc :upgrade-step (deser-upgrade-step (clojure.core/get-in letvar949961 ["UpgradeStep"]))) (letvar949961 "StepStatus") (clojure.core/assoc :step-status (deser-upgrade-status (clojure.core/get-in letvar949961 ["StepStatus"]))) (letvar949961 "UpgradeName") (clojure.core/assoc :upgrade-name (deser-upgrade-name (clojure.core/get-in letvar949961 ["UpgradeName"])))))))

(clojure.core/defn- response-update-elasticsearch-domain-config-response ([input] (response-update-elasticsearch-domain-config-response nil input)) ([resultWrapper949963 input] (clojure.core/let [rawinput949962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949964 {"DomainConfig" (rawinput949962 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar949964 ["DomainConfig"]))}))))

(clojure.core/defn- response-disabled-operation-exception ([input] (response-disabled-operation-exception nil input)) ([resultWrapper949966 input] (clojure.core/let [rawinput949965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949967 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-domain-names-response ([input] (response-list-domain-names-response nil input)) ([resultWrapper949969 input] (clojure.core/let [rawinput949968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949970 {"DomainNames" (rawinput949968 "DomainNames")}] (clojure.core/cond-> {} (letvar949970 "DomainNames") (clojure.core/assoc :domain-names (deser-domain-info-list (clojure.core/get-in letvar949970 ["DomainNames"])))))))

(clojure.core/defn- response-purchase-reserved-elasticsearch-instance-offering-response ([input] (response-purchase-reserved-elasticsearch-instance-offering-response nil input)) ([resultWrapper949972 input] (clojure.core/let [rawinput949971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949973 {"ReservedElasticsearchInstanceId" (rawinput949971 "ReservedElasticsearchInstanceId"), "ReservationName" (rawinput949971 "ReservationName")}] (clojure.core/cond-> {} (letvar949973 "ReservedElasticsearchInstanceId") (clojure.core/assoc :reserved-elasticsearch-instance-id (deser-guid (clojure.core/get-in letvar949973 ["ReservedElasticsearchInstanceId"]))) (letvar949973 "ReservationName") (clojure.core/assoc :reservation-name (deser-reservation-token (clojure.core/get-in letvar949973 ["ReservationName"])))))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instances-response ([input] (response-describe-reserved-elasticsearch-instances-response nil input)) ([resultWrapper949975 input] (clojure.core/let [rawinput949974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949976 {"NextToken" (rawinput949974 "NextToken"), "ReservedElasticsearchInstances" (rawinput949974 "ReservedElasticsearchInstances")}] (clojure.core/cond-> {} (letvar949976 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar949976 ["NextToken"]))) (letvar949976 "ReservedElasticsearchInstances") (clojure.core/assoc :reserved-elasticsearch-instances (deser-reserved-elasticsearch-instance-list (clojure.core/get-in letvar949976 ["ReservedElasticsearchInstances"])))))))

(clojure.core/defn- response-list-elasticsearch-instance-types-response ([input] (response-list-elasticsearch-instance-types-response nil input)) ([resultWrapper949978 input] (clojure.core/let [rawinput949977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949979 {"ElasticsearchInstanceTypes" (rawinput949977 "ElasticsearchInstanceTypes"), "NextToken" (rawinput949977 "NextToken")}] (clojure.core/cond-> {} (letvar949979 "ElasticsearchInstanceTypes") (clojure.core/assoc :elasticsearch-instance-types (deser-elasticsearch-instance-type-list (clojure.core/get-in letvar949979 ["ElasticsearchInstanceTypes"]))) (letvar949979 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar949979 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper949981 input] (clojure.core/let [rawinput949980 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949982 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instance-offerings-response ([input] (response-describe-reserved-elasticsearch-instance-offerings-response nil input)) ([resultWrapper949984 input] (clojure.core/let [rawinput949983 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949985 {"NextToken" (rawinput949983 "NextToken"), "ReservedElasticsearchInstanceOfferings" (rawinput949983 "ReservedElasticsearchInstanceOfferings")}] (clojure.core/cond-> {} (letvar949985 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar949985 ["NextToken"]))) (letvar949985 "ReservedElasticsearchInstanceOfferings") (clojure.core/assoc :reserved-elasticsearch-instance-offerings (deser-reserved-elasticsearch-instance-offering-list (clojure.core/get-in letvar949985 ["ReservedElasticsearchInstanceOfferings"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper949987 input] (clojure.core/let [rawinput949986 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949988 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-upgrade-elasticsearch-domain-response ([input] (response-upgrade-elasticsearch-domain-response nil input)) ([resultWrapper949990 input] (clojure.core/let [rawinput949989 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949991 {"DomainName" (rawinput949989 "DomainName"), "TargetVersion" (rawinput949989 "TargetVersion"), "PerformCheckOnly" (rawinput949989 "PerformCheckOnly")}] (clojure.core/cond-> {} (letvar949991 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar949991 ["DomainName"]))) (letvar949991 "TargetVersion") (clojure.core/assoc :target-version (deser-elasticsearch-version-string (clojure.core/get-in letvar949991 ["TargetVersion"]))) (letvar949991 "PerformCheckOnly") (clojure.core/assoc :perform-check-only (deser-boolean (clojure.core/get-in letvar949991 ["PerformCheckOnly"])))))))

(clojure.core/defn- response-describe-elasticsearch-domains-response ([input] (response-describe-elasticsearch-domains-response nil input)) ([resultWrapper949993 input] (clojure.core/let [rawinput949992 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949994 {"DomainStatusList" (rawinput949992 "DomainStatusList")}] (clojure.core/cond-> {:domain-status-list (deser-elasticsearch-domain-status-list (clojure.core/get-in letvar949994 ["DomainStatusList"]))}))))

(clojure.core/defn- response-base-exception ([input] (response-base-exception nil input)) ([resultWrapper949996 input] (clojure.core/let [rawinput949995 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar949997 {"message" (rawinput949995 "message")}] (clojure.core/cond-> {} (letvar949997 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar949997 ["message"])))))))

(clojure.core/defn- response-describe-elasticsearch-instance-type-limits-response ([input] (response-describe-elasticsearch-instance-type-limits-response nil input)) ([resultWrapper949999 input] (clojure.core/let [rawinput949998 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar950000 {"LimitsByRole" (rawinput949998 "LimitsByRole")}] (clojure.core/cond-> {} (letvar950000 "LimitsByRole") (clojure.core/assoc :limits-by-role (deser-limits-by-role (clojure.core/get-in letvar950000 ["LimitsByRole"])))))))

(clojure.core/defn- response-create-elasticsearch-domain-response ([input] (response-create-elasticsearch-domain-response nil input)) ([resultWrapper950002 input] (clojure.core/let [rawinput950001 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar950003 {"DomainStatus" (rawinput950001 "DomainStatus")}] (clojure.core/cond-> {} (letvar950003 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar950003 ["DomainStatus"])))))))

(clojure.core/defn- response-get-upgrade-history-response ([input] (response-get-upgrade-history-response nil input)) ([resultWrapper950005 input] (clojure.core/let [rawinput950004 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar950006 {"UpgradeHistories" (rawinput950004 "UpgradeHistories"), "NextToken" (rawinput950004 "NextToken")}] (clojure.core/cond-> {} (letvar950006 "UpgradeHistories") (clojure.core/assoc :upgrade-histories (deser-upgrade-history-list (clojure.core/get-in letvar950006 ["UpgradeHistories"]))) (letvar950006 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar950006 ["NextToken"])))))))

(clojure.core/defn- response-describe-elasticsearch-domain-config-response ([input] (response-describe-elasticsearch-domain-config-response nil input)) ([resultWrapper950008 input] (clojure.core/let [rawinput950007 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar950009 {"DomainConfig" (rawinput950007 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar950009 ["DomainConfig"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/reservation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/user-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 55)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/domain-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 28)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z][a-z0-9\-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/guid (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\p{XDigit}{8}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{12}" s__21078__auto__))))
