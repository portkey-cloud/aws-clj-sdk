...
(clojure.core/defn- response-delete-elasticsearch-domain-response ([input] (response-delete-elasticsearch-domain-response nil input)) ([resultWrapper160491 input] (clojure.core/let [rawinput160490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160492 {"DomainStatus" (rawinput160490 "DomainStatus")}] (clojure.core/cond-> {} (letvar160492 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar160492 ["DomainStatus"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper160494 input] (clojure.core/let [rawinput160493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160495 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-elasticsearch-domain-response ([input] (response-describe-elasticsearch-domain-response nil input)) ([resultWrapper160497 input] (clojure.core/let [rawinput160496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160498 {"DomainStatus" (rawinput160496 "DomainStatus")}] (clojure.core/cond-> {:domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar160498 ["DomainStatus"]))}))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper160500 input] (clojure.core/let [rawinput160499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160501 {"TagList" (rawinput160499 "TagList")}] (clojure.core/cond-> {} (letvar160501 "TagList") (clojure.core/assoc :tag-list (deser-tag-list (clojure.core/get-in letvar160501 ["TagList"])))))))

(clojure.core/defn- response-get-compatible-elasticsearch-versions-response ([input] (response-get-compatible-elasticsearch-versions-response nil input)) ([resultWrapper160503 input] (clojure.core/let [rawinput160502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160504 {"CompatibleElasticsearchVersions" (rawinput160502 "CompatibleElasticsearchVersions")}] (clojure.core/cond-> {} (letvar160504 "CompatibleElasticsearchVersions") (clojure.core/assoc :compatible-elasticsearch-versions (deser-compatible-elasticsearch-versions-list (clojure.core/get-in letvar160504 ["CompatibleElasticsearchVersions"])))))))

(clojure.core/defn- response-list-elasticsearch-versions-response ([input] (response-list-elasticsearch-versions-response nil input)) ([resultWrapper160506 input] (clojure.core/let [rawinput160505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160507 {"ElasticsearchVersions" (rawinput160505 "ElasticsearchVersions"), "NextToken" (rawinput160505 "NextToken")}] (clojure.core/cond-> {} (letvar160507 "ElasticsearchVersions") (clojure.core/assoc :elasticsearch-versions (deser-elasticsearch-version-list (clojure.core/get-in letvar160507 ["ElasticsearchVersions"]))) (letvar160507 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar160507 ["NextToken"])))))))

(clojure.core/defn- response-cancel-elasticsearch-service-software-update-response ([input] (response-cancel-elasticsearch-service-software-update-response nil input)) ([resultWrapper160509 input] (clojure.core/let [rawinput160508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160510 {"ServiceSoftwareOptions" (rawinput160508 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar160510 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar160510 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-start-elasticsearch-service-software-update-response ([input] (response-start-elasticsearch-service-software-update-response nil input)) ([resultWrapper160512 input] (clojure.core/let [rawinput160511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160513 {"ServiceSoftwareOptions" (rawinput160511 "ServiceSoftwareOptions")}] (clojure.core/cond-> {} (letvar160513 "ServiceSoftwareOptions") (clojure.core/assoc :service-software-options (deser-service-software-options (clojure.core/get-in letvar160513 ["ServiceSoftwareOptions"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper160515 input] (clojure.core/let [rawinput160514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160516 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper160518 input] (clojure.core/let [rawinput160517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160519 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-type-exception ([input] (response-invalid-type-exception nil input)) ([resultWrapper160521 input] (clojure.core/let [rawinput160520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160522 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-upgrade-status-response ([input] (response-get-upgrade-status-response nil input)) ([resultWrapper160524 input] (clojure.core/let [rawinput160523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160525 {"UpgradeStep" (rawinput160523 "UpgradeStep"), "StepStatus" (rawinput160523 "StepStatus"), "UpgradeName" (rawinput160523 "UpgradeName")}] (clojure.core/cond-> {} (letvar160525 "UpgradeStep") (clojure.core/assoc :upgrade-step (deser-upgrade-step (clojure.core/get-in letvar160525 ["UpgradeStep"]))) (letvar160525 "StepStatus") (clojure.core/assoc :step-status (deser-upgrade-status (clojure.core/get-in letvar160525 ["StepStatus"]))) (letvar160525 "UpgradeName") (clojure.core/assoc :upgrade-name (deser-upgrade-name (clojure.core/get-in letvar160525 ["UpgradeName"])))))))

(clojure.core/defn- response-update-elasticsearch-domain-config-response ([input] (response-update-elasticsearch-domain-config-response nil input)) ([resultWrapper160527 input] (clojure.core/let [rawinput160526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160528 {"DomainConfig" (rawinput160526 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar160528 ["DomainConfig"]))}))))

(clojure.core/defn- response-disabled-operation-exception ([input] (response-disabled-operation-exception nil input)) ([resultWrapper160530 input] (clojure.core/let [rawinput160529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160531 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-domain-names-response ([input] (response-list-domain-names-response nil input)) ([resultWrapper160533 input] (clojure.core/let [rawinput160532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160534 {"DomainNames" (rawinput160532 "DomainNames")}] (clojure.core/cond-> {} (letvar160534 "DomainNames") (clojure.core/assoc :domain-names (deser-domain-info-list (clojure.core/get-in letvar160534 ["DomainNames"])))))))

(clojure.core/defn- response-purchase-reserved-elasticsearch-instance-offering-response ([input] (response-purchase-reserved-elasticsearch-instance-offering-response nil input)) ([resultWrapper160536 input] (clojure.core/let [rawinput160535 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160537 {"ReservedElasticsearchInstanceId" (rawinput160535 "ReservedElasticsearchInstanceId"), "ReservationName" (rawinput160535 "ReservationName")}] (clojure.core/cond-> {} (letvar160537 "ReservedElasticsearchInstanceId") (clojure.core/assoc :reserved-elasticsearch-instance-id (deser-guid (clojure.core/get-in letvar160537 ["ReservedElasticsearchInstanceId"]))) (letvar160537 "ReservationName") (clojure.core/assoc :reservation-name (deser-reservation-token (clojure.core/get-in letvar160537 ["ReservationName"])))))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instances-response ([input] (response-describe-reserved-elasticsearch-instances-response nil input)) ([resultWrapper160539 input] (clojure.core/let [rawinput160538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160540 {"NextToken" (rawinput160538 "NextToken"), "ReservedElasticsearchInstances" (rawinput160538 "ReservedElasticsearchInstances")}] (clojure.core/cond-> {} (letvar160540 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar160540 ["NextToken"]))) (letvar160540 "ReservedElasticsearchInstances") (clojure.core/assoc :reserved-elasticsearch-instances (deser-reserved-elasticsearch-instance-list (clojure.core/get-in letvar160540 ["ReservedElasticsearchInstances"])))))))

(clojure.core/defn- response-list-elasticsearch-instance-types-response ([input] (response-list-elasticsearch-instance-types-response nil input)) ([resultWrapper160542 input] (clojure.core/let [rawinput160541 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160543 {"ElasticsearchInstanceTypes" (rawinput160541 "ElasticsearchInstanceTypes"), "NextToken" (rawinput160541 "NextToken")}] (clojure.core/cond-> {} (letvar160543 "ElasticsearchInstanceTypes") (clojure.core/assoc :elasticsearch-instance-types (deser-elasticsearch-instance-type-list (clojure.core/get-in letvar160543 ["ElasticsearchInstanceTypes"]))) (letvar160543 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar160543 ["NextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper160545 input] (clojure.core/let [rawinput160544 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160546 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-reserved-elasticsearch-instance-offerings-response ([input] (response-describe-reserved-elasticsearch-instance-offerings-response nil input)) ([resultWrapper160548 input] (clojure.core/let [rawinput160547 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160549 {"NextToken" (rawinput160547 "NextToken"), "ReservedElasticsearchInstanceOfferings" (rawinput160547 "ReservedElasticsearchInstanceOfferings")}] (clojure.core/cond-> {} (letvar160549 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar160549 ["NextToken"]))) (letvar160549 "ReservedElasticsearchInstanceOfferings") (clojure.core/assoc :reserved-elasticsearch-instance-offerings (deser-reserved-elasticsearch-instance-offering-list (clojure.core/get-in letvar160549 ["ReservedElasticsearchInstanceOfferings"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper160551 input] (clojure.core/let [rawinput160550 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160552 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-upgrade-elasticsearch-domain-response ([input] (response-upgrade-elasticsearch-domain-response nil input)) ([resultWrapper160554 input] (clojure.core/let [rawinput160553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160555 {"DomainName" (rawinput160553 "DomainName"), "TargetVersion" (rawinput160553 "TargetVersion"), "PerformCheckOnly" (rawinput160553 "PerformCheckOnly")}] (clojure.core/cond-> {} (letvar160555 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar160555 ["DomainName"]))) (letvar160555 "TargetVersion") (clojure.core/assoc :target-version (deser-elasticsearch-version-string (clojure.core/get-in letvar160555 ["TargetVersion"]))) (letvar160555 "PerformCheckOnly") (clojure.core/assoc :perform-check-only (deser-boolean (clojure.core/get-in letvar160555 ["PerformCheckOnly"])))))))

(clojure.core/defn- response-describe-elasticsearch-domains-response ([input] (response-describe-elasticsearch-domains-response nil input)) ([resultWrapper160557 input] (clojure.core/let [rawinput160556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160558 {"DomainStatusList" (rawinput160556 "DomainStatusList")}] (clojure.core/cond-> {:domain-status-list (deser-elasticsearch-domain-status-list (clojure.core/get-in letvar160558 ["DomainStatusList"]))}))))

(clojure.core/defn- response-base-exception ([input] (response-base-exception nil input)) ([resultWrapper160560 input] (clojure.core/let [rawinput160559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160561 {"message" (rawinput160559 "message")}] (clojure.core/cond-> {} (letvar160561 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar160561 ["message"])))))))

(clojure.core/defn- response-describe-elasticsearch-instance-type-limits-response ([input] (response-describe-elasticsearch-instance-type-limits-response nil input)) ([resultWrapper160563 input] (clojure.core/let [rawinput160562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160564 {"LimitsByRole" (rawinput160562 "LimitsByRole")}] (clojure.core/cond-> {} (letvar160564 "LimitsByRole") (clojure.core/assoc :limits-by-role (deser-limits-by-role (clojure.core/get-in letvar160564 ["LimitsByRole"])))))))

(clojure.core/defn- response-create-elasticsearch-domain-response ([input] (response-create-elasticsearch-domain-response nil input)) ([resultWrapper160566 input] (clojure.core/let [rawinput160565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160567 {"DomainStatus" (rawinput160565 "DomainStatus")}] (clojure.core/cond-> {} (letvar160567 "DomainStatus") (clojure.core/assoc :domain-status (deser-elasticsearch-domain-status (clojure.core/get-in letvar160567 ["DomainStatus"])))))))

(clojure.core/defn- response-get-upgrade-history-response ([input] (response-get-upgrade-history-response nil input)) ([resultWrapper160569 input] (clojure.core/let [rawinput160568 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160570 {"UpgradeHistories" (rawinput160568 "UpgradeHistories"), "NextToken" (rawinput160568 "NextToken")}] (clojure.core/cond-> {} (letvar160570 "UpgradeHistories") (clojure.core/assoc :upgrade-histories (deser-upgrade-history-list (clojure.core/get-in letvar160570 ["UpgradeHistories"]))) (letvar160570 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar160570 ["NextToken"])))))))

(clojure.core/defn- response-describe-elasticsearch-domain-config-response ([input] (response-describe-elasticsearch-domain-config-response nil input)) ([resultWrapper160572 input] (clojure.core/let [rawinput160571 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar160573 {"DomainConfig" (rawinput160571 "DomainConfig")}] (clojure.core/cond-> {:domain-config (deser-elasticsearch-domain-config (clojure.core/get-in letvar160573 ["DomainConfig"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/reservation-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 5 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 20 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/user-pool-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 55)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[\w-]+_[0-9a-zA-Z]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/domain-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/domain-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 3 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 28)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"[a-z][a-z0-9\-]+" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.es.-2015-01-01/guid (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"\p{XDigit}{8}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{12}" s__21112__auto__))))
