...
(clojure.core/defn- response-import-terminology-response ([input] (response-import-terminology-response nil input)) ([resultWrapper2128481 input] (clojure.core/let [rawinput2128480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128482 {"TerminologyProperties" (rawinput2128480 "TerminologyProperties")}] (clojure.core/cond-> {} (letvar2128482 "TerminologyProperties") (clojure.core/assoc :terminology-properties (deser-terminology-properties (clojure.core/get-in letvar2128482 ["TerminologyProperties"])))))))

(clojure.core/defn- response-list-terminologies-response ([input] (response-list-terminologies-response nil input)) ([resultWrapper2128484 input] (clojure.core/let [rawinput2128483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128485 {"TerminologyPropertiesList" (rawinput2128483 "TerminologyPropertiesList"), "NextToken" (rawinput2128483 "NextToken")}] (clojure.core/cond-> {} (letvar2128485 "TerminologyPropertiesList") (clojure.core/assoc :terminology-properties-list (deser-terminology-properties-list (clojure.core/get-in letvar2128485 ["TerminologyPropertiesList"]))) (letvar2128485 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar2128485 ["NextToken"])))))))

(clojure.core/defn- response-detected-language-low-confidence-exception ([input] (response-detected-language-low-confidence-exception nil input)) ([resultWrapper2128487 input] (clojure.core/let [rawinput2128486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128488 {"Message" (rawinput2128486 "Message"), "DetectedLanguageCode" (rawinput2128486 "DetectedLanguageCode")}] (clojure.core/cond-> {} (letvar2128488 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128488 ["Message"]))) (letvar2128488 "DetectedLanguageCode") (clojure.core/assoc :detected-language-code (deser-language-code-string (clojure.core/get-in letvar2128488 ["DetectedLanguageCode"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper2128490 input] (clojure.core/let [rawinput2128489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128491 {"Message" (rawinput2128489 "Message")}] (clojure.core/cond-> {} (letvar2128491 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128491 ["Message"])))))))

(clojure.core/defn- response-get-terminology-response ([input] (response-get-terminology-response nil input)) ([resultWrapper2128493 input] (clojure.core/let [rawinput2128492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128494 {"TerminologyProperties" (rawinput2128492 "TerminologyProperties"), "TerminologyDataLocation" (rawinput2128492 "TerminologyDataLocation")}] (clojure.core/cond-> {} (letvar2128494 "TerminologyProperties") (clojure.core/assoc :terminology-properties (deser-terminology-properties (clojure.core/get-in letvar2128494 ["TerminologyProperties"]))) (letvar2128494 "TerminologyDataLocation") (clojure.core/assoc :terminology-data-location (deser-terminology-data-location (clojure.core/get-in letvar2128494 ["TerminologyDataLocation"])))))))

(clojure.core/defn- response-text-size-limit-exceeded-exception ([input] (response-text-size-limit-exceeded-exception nil input)) ([resultWrapper2128496 input] (clojure.core/let [rawinput2128495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128497 {"Message" (rawinput2128495 "Message")}] (clojure.core/cond-> {} (letvar2128497 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128497 ["Message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper2128499 input] (clojure.core/let [rawinput2128498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128500 {"Message" (rawinput2128498 "Message")}] (clojure.core/cond-> {} (letvar2128500 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128500 ["Message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper2128502 input] (clojure.core/let [rawinput2128501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128503 {"Message" (rawinput2128501 "Message")}] (clojure.core/cond-> {} (letvar2128503 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128503 ["Message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper2128505 input] (clojure.core/let [rawinput2128504 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128506 {"Message" (rawinput2128504 "Message")}] (clojure.core/cond-> {} (letvar2128506 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128506 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2128508 input] (clojure.core/let [rawinput2128507 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128509 {"Message" (rawinput2128507 "Message")}] (clojure.core/cond-> {} (letvar2128509 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128509 ["Message"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper2128511 input] (clojure.core/let [rawinput2128510 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128512 {"Message" (rawinput2128510 "Message")}] (clojure.core/cond-> {} (letvar2128512 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128512 ["Message"])))))))

(clojure.core/defn- response-translate-text-response ([input] (response-translate-text-response nil input)) ([resultWrapper2128514 input] (clojure.core/let [rawinput2128513 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128515 {"TranslatedText" (rawinput2128513 "TranslatedText"), "SourceLanguageCode" (rawinput2128513 "SourceLanguageCode"), "TargetLanguageCode" (rawinput2128513 "TargetLanguageCode"), "AppliedTerminologies" (rawinput2128513 "AppliedTerminologies")}] (clojure.core/cond-> {:translated-text (deser-string (clojure.core/get-in letvar2128515 ["TranslatedText"])), :source-language-code (deser-language-code-string (clojure.core/get-in letvar2128515 ["SourceLanguageCode"])), :target-language-code (deser-language-code-string (clojure.core/get-in letvar2128515 ["TargetLanguageCode"]))} (letvar2128515 "AppliedTerminologies") (clojure.core/assoc :applied-terminologies (deser-applied-terminology-list (clojure.core/get-in letvar2128515 ["AppliedTerminologies"])))))))

(clojure.core/defn- response-unsupported-language-pair-exception ([input] (response-unsupported-language-pair-exception nil input)) ([resultWrapper2128517 input] (clojure.core/let [rawinput2128516 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128518 {"Message" (rawinput2128516 "Message"), "SourceLanguageCode" (rawinput2128516 "SourceLanguageCode"), "TargetLanguageCode" (rawinput2128516 "TargetLanguageCode")}] (clojure.core/cond-> {} (letvar2128518 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128518 ["Message"]))) (letvar2128518 "SourceLanguageCode") (clojure.core/assoc :source-language-code (deser-language-code-string (clojure.core/get-in letvar2128518 ["SourceLanguageCode"]))) (letvar2128518 "TargetLanguageCode") (clojure.core/assoc :target-language-code (deser-language-code-string (clojure.core/get-in letvar2128518 ["TargetLanguageCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper2128520 input] (clojure.core/let [rawinput2128519 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2128521 {"Message" (rawinput2128519 "Message")}] (clojure.core/cond-> {} (letvar2128521 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar2128521 ["Message"])))))))

(clojure.spec.alpha/def :portkey.aws.translate/merge-strategy #{"OVERWRITE" :overwrite})

(clojure.spec.alpha/def :portkey.aws.translate/terminology-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^arn:aws((-us-gov)|(-cn))?:translate:[a-zA-Z0-9-]+:[0-9]{12}:terminology/.+?/.+?$" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate/language-code-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 2 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 5))))
...
(clojure.spec.alpha/def :portkey.aws.translate/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 8192)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"\p{ASCII}{0,8192}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\P{M}\p{M}]{0,256}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.translate/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"^([A-Za-z0-9-]_?)+$" s__1467903__auto__))))

(clojure.spec.alpha/def :portkey.aws.translate/integer clojure.core/int?)

(clojure.spec.alpha/def :portkey.aws.translate/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10000)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\P{M}\p{M}]{0,10000}" s__1467903__auto__))))
