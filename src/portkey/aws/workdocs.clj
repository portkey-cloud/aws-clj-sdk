...
(clojure.core/defn get-folder-path "Retrieves the path information (the hierarchy from the root folder) for the specified folder.\n By default, Amazon WorkDocs returns a maximum of 100 levels upwards from the requested folder and only includes the IDs of the parent folders in the path. You can limit the maximum number of levels. You can also request the parent folder names.\n" ([get-folder-path-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/folders/{FolderId}/path" get-folder-path-request :portkey.aws.workdocs/get-folder-path-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"FolderId" "FolderId"}, :querystring {"limit" "Limit", "fields" "Fields", "marker" "Marker"}} 200 :portkey.aws.workdocs/get-folder-path-response {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn get-document "Retrieves details of a document.\n" ([get-document-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/documents/{DocumentId}" get-document-request :portkey.aws.workdocs/get-document-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"DocumentId" "DocumentId"}, :querystring {"includeCustomMetadata" "IncludeCustomMetadata"}} 200 :portkey.aws.workdocs/get-document-response {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "InvalidArgumentException" :portkey.aws.workdocs/invalid-argument-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception, "InvalidPasswordException" :portkey.aws.workdocs/invalid-password-exception})))
...
(clojure.core/defn describe-root-folders "Describes the current user's special folders; the RootFolder and the RecycleBin. RootFolder is the root of user's files and folders and RecycleBin is the root of recycled items. This is not a valid action for SigV4 (administrative API) clients.\n" ([describe-root-folders-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/me/root" describe-root-folders-request :portkey.aws.workdocs/describe-root-folders-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {}, :querystring {"limit" "Limit", "marker" "Marker"}} 200 :portkey.aws.workdocs/describe-root-folders-response {"UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "InvalidArgumentException" :portkey.aws.workdocs/invalid-argument-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn add-resource-permissions "Creates a set of permissions for the specified folder or document. The resource permissions are overwritten if the principals already have different permissions.\n" ([add-resource-permissions-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "POST" "/api/v1/resources/{ResourceId}/permissions" add-resource-permissions-request :portkey.aws.workdocs/add-resource-permissions-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"ResourceId" "ResourceId"}, :querystring {}} 201 :portkey.aws.workdocs/add-resource-permissions-response {"UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn create-user "Creates a user in a Simple AD or Microsoft AD directory. The status of a newly created user is \"ACTIVE\". New users can access Amazon WorkDocs.\n" ([create-user-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "POST" "/api/v1/users" create-user-request :portkey.aws.workdocs/create-user-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {}, :querystring {}} 201 :portkey.aws.workdocs/create-user-response {"EntityAlreadyExistsException" :portkey.aws.workdocs/entity-already-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn describe-users "Describes the specified users. You can describe all users or filter the results (for example, by status or organization).\n By default, Amazon WorkDocs returns the first 24 active or pending users. If there are more results, the response includes a marker that you can use to request the next set of results.\n" ([] (describe-users {})) ([describe-users-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/users" describe-users-request :portkey.aws.workdocs/describe-users-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {}, :querystring {"userIds" "UserIds", "query" "Query", "sort" "Sort", "limit" "Limit", "include" "Include", "order" "Order", "organizationId" "OrganizationId", "fields" "Fields", "marker" "Marker"}} 200 :portkey.aws.workdocs/describe-users-response {"UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception, "InvalidArgumentException" :portkey.aws.workdocs/invalid-argument-exception})))
...
(clojure.core/defn get-document-path "Retrieves the path information (the hierarchy from the root folder) for the requested document.\n By default, Amazon WorkDocs returns a maximum of 100 levels upwards from the requested document and only includes the IDs of the parent folders in the path. You can limit the maximum number of levels. You can also request the names of the parent folders.\n" ([get-document-path-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/documents/{DocumentId}/path" get-document-path-request :portkey.aws.workdocs/get-document-path-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"DocumentId" "DocumentId"}, :querystring {"limit" "Limit", "fields" "Fields", "marker" "Marker"}} 200 :portkey.aws.workdocs/get-document-path-response {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn delete-notification-subscription "Deletes the specified subscription from the specified organization.\n" ([delete-notification-subscription-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "DELETE" "/api/v1/organizations/{OrganizationId}/subscriptions/{SubscriptionId}" delete-notification-subscription-request :portkey.aws.workdocs/delete-notification-subscription-request {:payload nil, :move {}, :headers {}, :uri {"SubscriptionId" "SubscriptionId", "OrganizationId" "OrganizationId"}, :querystring {}} 200 nil {"UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception, "ProhibitedStateException" :portkey.aws.workdocs/prohibited-state-exception})))
...
(clojure.core/defn get-current-user "Retrieves details of the current user for whom the authentication token was generated. This is not a valid action for SigV4 (administrative API) clients.\n" ([get-current-user-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/me" get-current-user-request :portkey.aws.workdocs/get-current-user-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {}, :querystring {}} 200 :portkey.aws.workdocs/get-current-user-response {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn activate-user "Activates the specified user. Only active users can access Amazon WorkDocs.\n" ([activate-user-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "POST" "/api/v1/users/{UserId}/activation" activate-user-request :portkey.aws.workdocs/activate-user-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"UserId" "UserId"}, :querystring {}} 200 :portkey.aws.workdocs/activate-user-response {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn deactivate-user "Deactivates the specified user, which revokes the user's access to Amazon WorkDocs.\n" ([deactivate-user-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "DELETE" "/api/v1/users/{UserId}/activation" deactivate-user-request :portkey.aws.workdocs/deactivate-user-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"UserId" "UserId"}, :querystring {}} 204 nil {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn update-document "Updates the specified attributes of a document. The user must have access to both the document and its parent folder, if applicable.\n" ([update-document-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "PATCH" "/api/v1/documents/{DocumentId}" update-document-request :portkey.aws.workdocs/update-document-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"DocumentId" "DocumentId"}, :querystring {}} 200 nil {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "LimitExceededException" :portkey.aws.workdocs/limit-exceeded-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception, "EntityAlreadyExistsException" :portkey.aws.workdocs/entity-already-exists-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "ProhibitedStateException" :portkey.aws.workdocs/prohibited-state-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "ConcurrentModificationException" :portkey.aws.workdocs/concurrent-modification-exception})))
...
(clojure.core/defn delete-document "Permanently deletes the specified document and its associated metadata.\n" ([delete-document-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "DELETE" "/api/v1/documents/{DocumentId}" delete-document-request :portkey.aws.workdocs/delete-document-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"DocumentId" "DocumentId"}, :querystring {}} 204 nil {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "ProhibitedStateException" :portkey.aws.workdocs/prohibited-state-exception, "ConcurrentModificationException" :portkey.aws.workdocs/concurrent-modification-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
...
(clojure.core/defn update-folder "Updates the specified attributes of the specified folder. The user must have access to both the folder and its parent folder, if applicable.\n" ([update-folder-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "PATCH" "/api/v1/folders/{FolderId}" update-folder-request :portkey.aws.workdocs/update-folder-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {"FolderId" "FolderId"}, :querystring {}} 200 nil {"EntityNotExistsException" :portkey.aws.workdocs/entity-not-exists-exception, "LimitExceededException" :portkey.aws.workdocs/limit-exceeded-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception, "EntityAlreadyExistsException" :portkey.aws.workdocs/entity-already-exists-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "ProhibitedStateException" :portkey.aws.workdocs/prohibited-state-exception, "UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "ConcurrentModificationException" :portkey.aws.workdocs/concurrent-modification-exception})))
...
(clojure.core/defn describe-activities "Describes the user activities in a specified time period.\n" ([] (describe-activities {})) ([describe-activities-request] (portkey.aws/-rest-json-call portkey.aws.workdocs/endpoints "GET" "/api/v1/activities" describe-activities-request :portkey.aws.workdocs/describe-activities-request {:payload nil, :move {}, :headers {"AuthenticationToken" ["Authentication" nil]}, :uri {}, :querystring {"startTime" "StartTime", "endTime" "EndTime", "organizationId" "OrganizationId", "userId" "UserId", "limit" "Limit", "marker" "Marker"}} 200 :portkey.aws.workdocs/describe-activities-response {"UnauthorizedOperationException" :portkey.aws.workdocs/unauthorized-operation-exception, "UnauthorizedResourceAccessException" :portkey.aws.workdocs/unauthorized-resource-access-exception, "InvalidArgumentException" :portkey.aws.workdocs/invalid-argument-exception, "FailedDependencyException" :portkey.aws.workdocs/failed-dependency-exception, "ServiceUnavailableException" :portkey.aws.workdocs/service-unavailable-exception})))
