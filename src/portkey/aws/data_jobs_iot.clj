...
(clojure.core/defn get-pending-job-executions ([get-pending-job-executions-request] (portkey.aws/-rest-json-call portkey.aws.data-jobs-iot/endpoints "GET" "/things/{thingName}/jobs" get-pending-job-executions-request :portkey.aws.data-jobs-iot/get-pending-job-executions-request {:payload nil, :move {}, :headers {}, :uri {"thingName" "thingName"}, :querystring {}} nil :portkey.aws.data-jobs-iot/get-pending-job-executions-response {"InvalidRequestException" :portkey.aws.data-jobs-iot/invalid-request-exception, "ResourceNotFoundException" :portkey.aws.data-jobs-iot/resource-not-found-exception, "ThrottlingException" :portkey.aws.data-jobs-iot/throttling-exception, "ServiceUnavailableException" :portkey.aws.data-jobs-iot/service-unavailable-exception, "CertificateValidationException" :portkey.aws.data-jobs-iot/certificate-validation-exception})))
