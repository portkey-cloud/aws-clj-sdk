...
(clojure.core/defn- response-get-certificate-response ([input] (response-get-certificate-response nil input)) ([resultWrapper37541 input] (clojure.core/let [rawinput37540 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37542 {"Certificate" (rawinput37540 "Certificate"), "CertificateChain" (rawinput37540 "CertificateChain")}] (clojure.core/cond-> {} (letvar37542 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar37542 ["Certificate"]))) (letvar37542 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar37542 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-audit-report-response ([input] (response-create-certificate-authority-audit-report-response nil input)) ([resultWrapper37544 input] (clojure.core/let [rawinput37543 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37545 {"AuditReportId" (rawinput37543 "AuditReportId"), "S3Key" (rawinput37543 "S3Key")}] (clojure.core/cond-> {} (letvar37545 "AuditReportId") (clojure.core/assoc :audit-report-id (deser-audit-report-id (clojure.core/get-in letvar37545 ["AuditReportId"]))) (letvar37545 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar37545 ["S3Key"])))))))

(clojure.core/defn- response-describe-certificate-authority-audit-report-response ([input] (response-describe-certificate-authority-audit-report-response nil input)) ([resultWrapper37547 input] (clojure.core/let [rawinput37546 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37548 {"AuditReportStatus" (rawinput37546 "AuditReportStatus"), "S3BucketName" (rawinput37546 "S3BucketName"), "S3Key" (rawinput37546 "S3Key"), "CreatedAt" (rawinput37546 "CreatedAt")}] (clojure.core/cond-> {} (letvar37548 "AuditReportStatus") (clojure.core/assoc :audit-report-status (deser-audit-report-status (clojure.core/get-in letvar37548 ["AuditReportStatus"]))) (letvar37548 "S3BucketName") (clojure.core/assoc :s-3-bucket-name (deser-string (clojure.core/get-in letvar37548 ["S3BucketName"]))) (letvar37548 "S3Key") (clojure.core/assoc :s-3-key (deser-string (clojure.core/get-in letvar37548 ["S3Key"]))) (letvar37548 "CreatedAt") (clojure.core/assoc :created-at (deser-t-stamp (clojure.core/get-in letvar37548 ["CreatedAt"])))))))

(clojure.core/defn- response-malformed-csr-exception ([input] (response-malformed-csr-exception nil input)) ([resultWrapper37550 input] (clojure.core/let [rawinput37549 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37551 {"message" (rawinput37549 "message")}] (clojure.core/cond-> {} (letvar37551 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37551 ["message"])))))))

(clojure.core/defn- response-get-certificate-authority-certificate-response ([input] (response-get-certificate-authority-certificate-response nil input)) ([resultWrapper37553 input] (clojure.core/let [rawinput37552 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37554 {"Certificate" (rawinput37552 "Certificate"), "CertificateChain" (rawinput37552 "CertificateChain")}] (clojure.core/cond-> {} (letvar37554 "Certificate") (clojure.core/assoc :certificate (deser-certificate-body (clojure.core/get-in letvar37554 ["Certificate"]))) (letvar37554 "CertificateChain") (clojure.core/assoc :certificate-chain (deser-certificate-chain (clojure.core/get-in letvar37554 ["CertificateChain"])))))))

(clojure.core/defn- response-create-certificate-authority-response ([input] (response-create-certificate-authority-response nil input)) ([resultWrapper37556 input] (clojure.core/let [rawinput37555 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37557 {"CertificateAuthorityArn" (rawinput37555 "CertificateAuthorityArn")}] (clojure.core/cond-> {} (letvar37557 "CertificateAuthorityArn") (clojure.core/assoc :certificate-authority-arn (deser-arn (clojure.core/get-in letvar37557 ["CertificateAuthorityArn"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper37559 input] (clojure.core/let [rawinput37558 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37560 {"Tags" (rawinput37558 "Tags"), "NextToken" (rawinput37558 "NextToken")}] (clojure.core/cond-> {} (letvar37560 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar37560 ["Tags"]))) (letvar37560 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar37560 ["NextToken"])))))))

(clojure.core/defn- response-malformed-certificate-exception ([input] (response-malformed-certificate-exception nil input)) ([resultWrapper37562 input] (clojure.core/let [rawinput37561 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37563 {"message" (rawinput37561 "message")}] (clojure.core/cond-> {} (letvar37563 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37563 ["message"])))))))

(clojure.core/defn- response-list-certificate-authorities-response ([input] (response-list-certificate-authorities-response nil input)) ([resultWrapper37565 input] (clojure.core/let [rawinput37564 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37566 {"CertificateAuthorities" (rawinput37564 "CertificateAuthorities"), "NextToken" (rawinput37564 "NextToken")}] (clojure.core/cond-> {} (letvar37566 "CertificateAuthorities") (clojure.core/assoc :certificate-authorities (deser-certificate-authorities (clojure.core/get-in letvar37566 ["CertificateAuthorities"]))) (letvar37566 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar37566 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper37568 input] (clojure.core/let [rawinput37567 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37569 {"message" (rawinput37567 "message")}] (clojure.core/cond-> {} (letvar37569 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37569 ["message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper37571 input] (clojure.core/let [rawinput37570 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37572 {"message" (rawinput37570 "message")}] (clojure.core/cond-> {} (letvar37572 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37572 ["message"])))))))

(clojure.core/defn- response-certificate-mismatch-exception ([input] (response-certificate-mismatch-exception nil input)) ([resultWrapper37574 input] (clojure.core/let [rawinput37573 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37575 {"message" (rawinput37573 "message")}] (clojure.core/cond-> {} (letvar37575 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37575 ["message"])))))))

(clojure.core/defn- response-invalid-arn-exception ([input] (response-invalid-arn-exception nil input)) ([resultWrapper37577 input] (clojure.core/let [rawinput37576 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37578 {"message" (rawinput37576 "message")}] (clojure.core/cond-> {} (letvar37578 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37578 ["message"])))))))

(clojure.core/defn- response-describe-certificate-authority-response ([input] (response-describe-certificate-authority-response nil input)) ([resultWrapper37580 input] (clojure.core/let [rawinput37579 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37581 {"CertificateAuthority" (rawinput37579 "CertificateAuthority")}] (clojure.core/cond-> {} (letvar37581 "CertificateAuthority") (clojure.core/assoc :certificate-authority (deser-certificate-authority (clojure.core/get-in letvar37581 ["CertificateAuthority"])))))))

(clojure.core/defn- response-get-certificate-authority-csr-response ([input] (response-get-certificate-authority-csr-response nil input)) ([resultWrapper37583 input] (clojure.core/let [rawinput37582 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37584 {"Csr" (rawinput37582 "Csr")}] (clojure.core/cond-> {} (letvar37584 "Csr") (clojure.core/assoc :csr (deser-csr-body (clojure.core/get-in letvar37584 ["Csr"])))))))

(clojure.core/defn- response-invalid-tag-exception ([input] (response-invalid-tag-exception nil input)) ([resultWrapper37586 input] (clojure.core/let [rawinput37585 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37587 {"message" (rawinput37585 "message")}] (clojure.core/cond-> {} (letvar37587 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37587 ["message"])))))))

(clojure.core/defn- response-request-in-progress-exception ([input] (response-request-in-progress-exception nil input)) ([resultWrapper37589 input] (clojure.core/let [rawinput37588 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37590 {"message" (rawinput37588 "message")}] (clojure.core/cond-> {} (letvar37590 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37590 ["message"])))))))

(clojure.core/defn- response-invalid-args-exception ([input] (response-invalid-args-exception nil input)) ([resultWrapper37592 input] (clojure.core/let [rawinput37591 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37593 {"message" (rawinput37591 "message")}] (clojure.core/cond-> {} (letvar37593 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37593 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper37595 input] (clojure.core/let [rawinput37594 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37596 {"message" (rawinput37594 "message")}] (clojure.core/cond-> {} (letvar37596 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37596 ["message"])))))))

(clojure.core/defn- response-issue-certificate-response ([input] (response-issue-certificate-response nil input)) ([resultWrapper37598 input] (clojure.core/let [rawinput37597 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37599 {"CertificateArn" (rawinput37597 "CertificateArn")}] (clojure.core/cond-> {} (letvar37599 "CertificateArn") (clojure.core/assoc :certificate-arn (deser-arn (clojure.core/get-in letvar37599 ["CertificateArn"])))))))

(clojure.core/defn- response-too-many-tags-exception ([input] (response-too-many-tags-exception nil input)) ([resultWrapper37601 input] (clojure.core/let [rawinput37600 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37602 {"message" (rawinput37600 "message")}] (clojure.core/cond-> {} (letvar37602 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37602 ["message"])))))))

(clojure.core/defn- response-invalid-policy-exception ([input] (response-invalid-policy-exception nil input)) ([resultWrapper37604 input] (clojure.core/let [rawinput37603 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37605 {"message" (rawinput37603 "message")}] (clojure.core/cond-> {} (letvar37605 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37605 ["message"])))))))

(clojure.core/defn- response-invalid-state-exception ([input] (response-invalid-state-exception nil input)) ([resultWrapper37607 input] (clojure.core/let [rawinput37606 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37608 {"message" (rawinput37606 "message")}] (clojure.core/cond-> {} (letvar37608 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37608 ["message"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper37610 input] (clojure.core/let [rawinput37609 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37611 {"message" (rawinput37609 "message")}] (clojure.core/cond-> {} (letvar37611 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37611 ["message"])))))))

(clojure.core/defn- response-request-failed-exception ([input] (response-request-failed-exception nil input)) ([resultWrapper37613 input] (clojure.core/let [rawinput37612 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37614 {"message" (rawinput37612 "message")}] (clojure.core/cond-> {} (letvar37614 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37614 ["message"])))))))

(clojure.core/defn- response-request-already-processed-exception ([input] (response-request-already-processed-exception nil input)) ([resultWrapper37616 input] (clojure.core/let [rawinput37615 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar37617 {"message" (rawinput37615 "message")}] (clojure.core/cond-> {} (letvar37617 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar37617 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-3-to-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/audit-report-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 36 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/distinguished-name-qualifier-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9'()+-.?:/= ]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))

(clojure.spec.alpha/def :portkey.aws.acm-pca/string-3 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-64 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.acm-pca/string-40 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 40))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/country-code-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Za-z]{2}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-253 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 253))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-5 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 5))))

(clojure.spec.alpha/def :portkey.aws.acm-pca/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 5 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[\w+=/,.@-]+:[\w+=/,.@-]+:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=/,.@-]+)*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.acm-pca/string-16 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16))))
