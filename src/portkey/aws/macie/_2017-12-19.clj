...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27882__auto__] (clojure.core/re-matches #"[0-9]{12}" s__27882__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/field-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27881__auto__] (clojure.core/< (clojure.core/count s__27881__auto__) 500))))
