...
(clojure.core/defn- response-list-s-3-resources-result ([input] (response-list-s-3-resources-result nil input)) ([resultWrapper1901107 input] (clojure.core/let [rawinput1901106 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901108 {"s3Resources" (rawinput1901106 "s3Resources"), "nextToken" (rawinput1901106 "nextToken")}] (clojure.core/cond-> {} (letvar1901108 "s3Resources") (clojure.core/assoc :s-3-resources (deser-s-3-resources-classification (clojure.core/get-in letvar1901108 ["s3Resources"]))) (letvar1901108 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1901108 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1901110 input] (clojure.core/let [rawinput1901109 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901111 {"errorCode" (rawinput1901109 "errorCode"), "message" (rawinput1901109 "message"), "resourceType" (rawinput1901109 "resourceType")}] (clojure.core/cond-> {} (letvar1901111 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1901111 ["errorCode"]))) (letvar1901111 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901111 ["message"]))) (letvar1901111 "resourceType") (clojure.core/assoc :resource-type (deser-resource-type (clojure.core/get-in letvar1901111 ["resourceType"])))))))

(clojure.core/defn- response-list-member-accounts-result ([input] (response-list-member-accounts-result nil input)) ([resultWrapper1901113 input] (clojure.core/let [rawinput1901112 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901114 {"memberAccounts" (rawinput1901112 "memberAccounts"), "nextToken" (rawinput1901112 "nextToken")}] (clojure.core/cond-> {} (letvar1901114 "memberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar1901114 ["memberAccounts"]))) (letvar1901114 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1901114 ["nextToken"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1901116 input] (clojure.core/let [rawinput1901115 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901117 {"errorCode" (rawinput1901115 "errorCode"), "message" (rawinput1901115 "message"), "fieldName" (rawinput1901115 "fieldName")}] (clojure.core/cond-> {} (letvar1901117 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1901117 ["errorCode"]))) (letvar1901117 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901117 ["message"]))) (letvar1901117 "fieldName") (clojure.core/assoc :field-name (deser-field-name (clojure.core/get-in letvar1901117 ["fieldName"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1901119 input] (clojure.core/let [rawinput1901118 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901120 {"errorCode" (rawinput1901118 "errorCode"), "message" (rawinput1901118 "message")}] (clojure.core/cond-> {} (letvar1901120 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1901120 ["errorCode"]))) (letvar1901120 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901120 ["message"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1901122 input] (clojure.core/let [rawinput1901121 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901123 {"message" (rawinput1901121 "message"), "resourceType" (rawinput1901121 "resourceType")}] (clojure.core/cond-> {} (letvar1901123 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901123 ["message"]))) (letvar1901123 "resourceType") (clojure.core/assoc :resource-type (deser-resource-type (clojure.core/get-in letvar1901123 ["resourceType"])))))))

(clojure.core/defn- response-associate-s-3-resources-result ([input] (response-associate-s-3-resources-result nil input)) ([resultWrapper1901125 input] (clojure.core/let [rawinput1901124 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901126 {"failedS3Resources" (rawinput1901124 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1901126 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1901126 ["failedS3Resources"])))))))

(clojure.core/defn- response-update-s-3-resources-result ([input] (response-update-s-3-resources-result nil input)) ([resultWrapper1901128 input] (clojure.core/let [rawinput1901127 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901129 {"failedS3Resources" (rawinput1901127 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1901129 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1901129 ["failedS3Resources"])))))))

(clojure.core/defn- response-disassociate-s-3-resources-result ([input] (response-disassociate-s-3-resources-result nil input)) ([resultWrapper1901131 input] (clojure.core/let [rawinput1901130 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901132 {"failedS3Resources" (rawinput1901130 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1901132 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1901132 ["failedS3Resources"])))))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9]{12}" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/field-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
