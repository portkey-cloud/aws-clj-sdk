...
(clojure.core/defn- response-list-s-3-resources-result ([input] (response-list-s-3-resources-result nil input)) ([resultWrapper1916225 input] (clojure.core/let [rawinput1916224 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916226 {"s3Resources" (rawinput1916224 "s3Resources"), "nextToken" (rawinput1916224 "nextToken")}] (clojure.core/cond-> {} (letvar1916226 "s3Resources") (clojure.core/assoc :s-3-resources (deser-s-3-resources-classification (clojure.core/get-in letvar1916226 ["s3Resources"]))) (letvar1916226 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1916226 ["nextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1916228 input] (clojure.core/let [rawinput1916227 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916229 {"errorCode" (rawinput1916227 "errorCode"), "message" (rawinput1916227 "message"), "resourceType" (rawinput1916227 "resourceType")}] (clojure.core/cond-> {} (letvar1916229 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1916229 ["errorCode"]))) (letvar1916229 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1916229 ["message"]))) (letvar1916229 "resourceType") (clojure.core/assoc :resource-type (deser-resource-type (clojure.core/get-in letvar1916229 ["resourceType"])))))))

(clojure.core/defn- response-list-member-accounts-result ([input] (response-list-member-accounts-result nil input)) ([resultWrapper1916231 input] (clojure.core/let [rawinput1916230 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916232 {"memberAccounts" (rawinput1916230 "memberAccounts"), "nextToken" (rawinput1916230 "nextToken")}] (clojure.core/cond-> {} (letvar1916232 "memberAccounts") (clojure.core/assoc :member-accounts (deser-member-accounts (clojure.core/get-in letvar1916232 ["memberAccounts"]))) (letvar1916232 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1916232 ["nextToken"])))))))

(clojure.core/defn- response-invalid-input-exception ([input] (response-invalid-input-exception nil input)) ([resultWrapper1916234 input] (clojure.core/let [rawinput1916233 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916235 {"errorCode" (rawinput1916233 "errorCode"), "message" (rawinput1916233 "message"), "fieldName" (rawinput1916233 "fieldName")}] (clojure.core/cond-> {} (letvar1916235 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1916235 ["errorCode"]))) (letvar1916235 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1916235 ["message"]))) (letvar1916235 "fieldName") (clojure.core/assoc :field-name (deser-field-name (clojure.core/get-in letvar1916235 ["fieldName"])))))))

(clojure.core/defn- response-internal-exception ([input] (response-internal-exception nil input)) ([resultWrapper1916237 input] (clojure.core/let [rawinput1916236 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916238 {"errorCode" (rawinput1916236 "errorCode"), "message" (rawinput1916236 "message")}] (clojure.core/cond-> {} (letvar1916238 "errorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1916238 ["errorCode"]))) (letvar1916238 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1916238 ["message"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1916240 input] (clojure.core/let [rawinput1916239 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916241 {"message" (rawinput1916239 "message"), "resourceType" (rawinput1916239 "resourceType")}] (clojure.core/cond-> {} (letvar1916241 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1916241 ["message"]))) (letvar1916241 "resourceType") (clojure.core/assoc :resource-type (deser-resource-type (clojure.core/get-in letvar1916241 ["resourceType"])))))))

(clojure.core/defn- response-associate-s-3-resources-result ([input] (response-associate-s-3-resources-result nil input)) ([resultWrapper1916243 input] (clojure.core/let [rawinput1916242 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916244 {"failedS3Resources" (rawinput1916242 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1916244 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1916244 ["failedS3Resources"])))))))

(clojure.core/defn- response-update-s-3-resources-result ([input] (response-update-s-3-resources-result nil input)) ([resultWrapper1916246 input] (clojure.core/let [rawinput1916245 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916247 {"failedS3Resources" (rawinput1916245 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1916247 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1916247 ["failedS3Resources"])))))))

(clojure.core/defn- response-disassociate-s-3-resources-result ([input] (response-disassociate-s-3-resources-result nil input)) ([resultWrapper1916249 input] (clojure.core/let [rawinput1916248 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916250 {"failedS3Resources" (rawinput1916248 "failedS3Resources")}] (clojure.core/cond-> {} (letvar1916250 "failedS3Resources") (clojure.core/assoc :failed-s-3-resources (deser-failed-s-3-resources (clojure.core/get-in letvar1916250 ["failedS3Resources"])))))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/prefix (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/aws-account-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[0-9]{12}" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/exception-message (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/field-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/resource-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.macie.-2017-12-19/bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 500))))
