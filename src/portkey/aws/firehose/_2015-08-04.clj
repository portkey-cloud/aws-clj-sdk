...
(clojure.core/defn- response-delete-delivery-stream-output ([input] (response-delete-delivery-stream-output nil input)) ([resultWrapper970759 input] (clojure.core/let [rawinput970758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970760 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-delivery-stream-encryption-output ([input] (response-start-delivery-stream-encryption-output nil input)) ([resultWrapper970762 input] (clojure.core/let [rawinput970761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970763 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-destination-output ([input] (response-update-destination-output nil input)) ([resultWrapper970765 input] (clojure.core/let [rawinput970764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970766 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-delivery-stream-output ([input] (response-create-delivery-stream-output nil input)) ([resultWrapper970768 input] (clojure.core/let [rawinput970767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970769 {"DeliveryStreamARN" (rawinput970767 "DeliveryStreamARN")}] (clojure.core/cond-> {} (letvar970769 "DeliveryStreamARN") (clojure.core/assoc :delivery-stream-arn (deser-delivery-stream-arn (clojure.core/get-in letvar970769 ["DeliveryStreamARN"])))))))

(clojure.core/defn- response-untag-delivery-stream-output ([input] (response-untag-delivery-stream-output nil input)) ([resultWrapper970771 input] (clojure.core/let [rawinput970770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970772 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-delivery-stream-output ([input] (response-tag-delivery-stream-output nil input)) ([resultWrapper970774 input] (clojure.core/let [rawinput970773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970775 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-stop-delivery-stream-encryption-output ([input] (response-stop-delivery-stream-encryption-output nil input)) ([resultWrapper970777 input] (clojure.core/let [rawinput970776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970778 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper970780 input] (clojure.core/let [rawinput970779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970781 {"message" (rawinput970779 "message")}] (clojure.core/cond-> {} (letvar970781 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970781 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper970783 input] (clojure.core/let [rawinput970782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970784 {"message" (rawinput970782 "message")}] (clojure.core/cond-> {} (letvar970784 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970784 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper970786 input] (clojure.core/let [rawinput970785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970787 {"message" (rawinput970785 "message")}] (clojure.core/cond-> {} (letvar970787 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970787 ["message"])))))))

(clojure.core/defn- response-put-record-batch-output ([input] (response-put-record-batch-output nil input)) ([resultWrapper970789 input] (clojure.core/let [rawinput970788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970790 {"FailedPutCount" (rawinput970788 "FailedPutCount"), "Encrypted" (rawinput970788 "Encrypted"), "RequestResponses" (rawinput970788 "RequestResponses")}] (clojure.core/cond-> {:failed-put-count (deser-non-negative-integer-object (clojure.core/get-in letvar970790 ["FailedPutCount"])), :request-responses (deser-put-record-batch-response-entry-list (clojure.core/get-in letvar970790 ["RequestResponses"]))} (letvar970790 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar970790 ["Encrypted"])))))))

(clojure.core/defn- response-describe-delivery-stream-output ([input] (response-describe-delivery-stream-output nil input)) ([resultWrapper970792 input] (clojure.core/let [rawinput970791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970793 {"DeliveryStreamDescription" (rawinput970791 "DeliveryStreamDescription")}] (clojure.core/cond-> {:delivery-stream-description (deser-delivery-stream-description (clojure.core/get-in letvar970793 ["DeliveryStreamDescription"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper970795 input] (clojure.core/let [rawinput970794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970796 {"message" (rawinput970794 "message")}] (clojure.core/cond-> {} (letvar970796 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970796 ["message"])))))))

(clojure.core/defn- response-list-delivery-streams-output ([input] (response-list-delivery-streams-output nil input)) ([resultWrapper970798 input] (clojure.core/let [rawinput970797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970799 {"DeliveryStreamNames" (rawinput970797 "DeliveryStreamNames"), "HasMoreDeliveryStreams" (rawinput970797 "HasMoreDeliveryStreams")}] (clojure.core/cond-> {:delivery-stream-names (deser-delivery-stream-name-list (clojure.core/get-in letvar970799 ["DeliveryStreamNames"])), :has-more-delivery-streams (deser-boolean-object (clojure.core/get-in letvar970799 ["HasMoreDeliveryStreams"]))}))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper970801 input] (clojure.core/let [rawinput970800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970802 {"message" (rawinput970800 "message")}] (clojure.core/cond-> {} (letvar970802 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970802 ["message"])))))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper970804 input] (clojure.core/let [rawinput970803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970805 {"RecordId" (rawinput970803 "RecordId"), "Encrypted" (rawinput970803 "Encrypted")}] (clojure.core/cond-> {:record-id (deser-put-response-record-id (clojure.core/get-in letvar970805 ["RecordId"]))} (letvar970805 "Encrypted") (clojure.core/assoc :encrypted (deser-boolean-object (clojure.core/get-in letvar970805 ["Encrypted"])))))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper970807 input] (clojure.core/let [rawinput970806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970808 {"message" (rawinput970806 "message")}] (clojure.core/cond-> {} (letvar970808 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar970808 ["message"])))))))

(clojure.core/defn- response-list-tags-for-delivery-stream-output ([input] (response-list-tags-for-delivery-stream-output nil input)) ([resultWrapper970810 input] (clojure.core/let [rawinput970809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar970811 {"Tags" (rawinput970809 "Tags"), "HasMoreTags" (rawinput970809 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-list-tags-for-delivery-stream-output-tag-list (clojure.core/get-in letvar970811 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar970811 ["HasMoreTags"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/non-empty-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(?!\s*$).+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/non-empty-string-without-whitespace (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/kinesis-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 6 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/elasticsearch-index-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 80))))

(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/data-table-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/delivery-stream-version-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 50)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/destination-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/cluster-jdbcurl (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"jdbc:(redshift|postgresql)://((?!-)[A-Za-z0-9-]{1,63}(?<!-)\.)+redshift\.amazonaws\.com:\d{1,5}/[a-zA-Z0-9_$]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/elasticsearch-domain-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/delivery-stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/delivery-stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/awskms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/processor-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/put-response-record-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.firehose.-2015-08-04/elasticsearch-type-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
