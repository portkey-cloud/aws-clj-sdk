...
(clojure.core/defn- response-invalid-resource-exception ([input] (response-invalid-resource-exception nil input)) ([resultWrapper1728473 input] (clojure.core/let [rawinput1728472 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728474 {"message" (rawinput1728472 "message")}] (clojure.core/cond-> {} (letvar1728474 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728474 ["message"])))))))

(clojure.core/defn- response-disassociate-drt-role-response ([input] (response-disassociate-drt-role-response nil input)) ([resultWrapper1728476 input] (clojure.core/let [rawinput1728475 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728477 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-subscription-response ([input] (response-create-subscription-response nil input)) ([resultWrapper1728479 input] (clojure.core/let [rawinput1728478 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728480 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-protection-response ([input] (response-delete-protection-response nil input)) ([resultWrapper1728482 input] (clojure.core/let [rawinput1728481 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728483 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-drt-log-bucket-response ([input] (response-disassociate-drt-log-bucket-response nil input)) ([resultWrapper1728485 input] (clojure.core/let [rawinput1728484 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728486 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1728488 input] (clojure.core/let [rawinput1728487 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728489 {"message" (rawinput1728487 "message")}] (clojure.core/cond-> {} (letvar1728489 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728489 ["message"])))))))

(clojure.core/defn- response-limits-exceeded-exception ([input] (response-limits-exceeded-exception nil input)) ([resultWrapper1728491 input] (clojure.core/let [rawinput1728490 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728492 {"message" (rawinput1728490 "message"), "Type" (rawinput1728490 "Type"), "Limit" (rawinput1728490 "Limit")}] (clojure.core/cond-> {} (letvar1728492 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728492 ["message"]))) (letvar1728492 "Type") (clojure.core/assoc :type (deser-limit-type (clojure.core/get-in letvar1728492 ["Type"]))) (letvar1728492 "Limit") (clojure.core/assoc :limit (deser-limit-number (clojure.core/get-in letvar1728492 ["Limit"])))))))

(clojure.core/defn- response-associate-drt-log-bucket-response ([input] (response-associate-drt-log-bucket-response nil input)) ([resultWrapper1728494 input] (clojure.core/let [rawinput1728493 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728495 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-emergency-contact-settings-response ([input] (response-describe-emergency-contact-settings-response nil input)) ([resultWrapper1728497 input] (clojure.core/let [rawinput1728496 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728498 {"EmergencyContactList" (rawinput1728496 "EmergencyContactList")}] (clojure.core/cond-> {} (letvar1728498 "EmergencyContactList") (clojure.core/assoc :emergency-contact-list (deser-emergency-contact-list (clojure.core/get-in letvar1728498 ["EmergencyContactList"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper1728500 input] (clojure.core/let [rawinput1728499 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728501 {"message" (rawinput1728499 "message")}] (clojure.core/cond-> {} (letvar1728501 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728501 ["message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper1728503 input] (clojure.core/let [rawinput1728502 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728504 {"message" (rawinput1728502 "message")}] (clojure.core/cond-> {} (letvar1728504 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728504 ["message"])))))))

(clojure.core/defn- response-locked-subscription-exception ([input] (response-locked-subscription-exception nil input)) ([resultWrapper1728506 input] (clojure.core/let [rawinput1728505 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728507 {"message" (rawinput1728505 "message")}] (clojure.core/cond-> {} (letvar1728507 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728507 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1728509 input] (clojure.core/let [rawinput1728508 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728510 {"message" (rawinput1728508 "message")}] (clojure.core/cond-> {} (letvar1728510 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728510 ["message"])))))))

(clojure.core/defn- response-no-associated-role-exception ([input] (response-no-associated-role-exception nil input)) ([resultWrapper1728512 input] (clojure.core/let [rawinput1728511 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728513 {"message" (rawinput1728511 "message")}] (clojure.core/cond-> {} (letvar1728513 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728513 ["message"])))))))

(clojure.core/defn- response-describe-drt-access-response ([input] (response-describe-drt-access-response nil input)) ([resultWrapper1728515 input] (clojure.core/let [rawinput1728514 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728516 {"RoleArn" (rawinput1728514 "RoleArn"), "LogBucketList" (rawinput1728514 "LogBucketList")}] (clojure.core/cond-> {} (letvar1728516 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar1728516 ["RoleArn"]))) (letvar1728516 "LogBucketList") (clojure.core/assoc :log-bucket-list (deser-log-bucket-list (clojure.core/get-in letvar1728516 ["LogBucketList"])))))))

(clojure.core/defn- response-describe-protection-response ([input] (response-describe-protection-response nil input)) ([resultWrapper1728518 input] (clojure.core/let [rawinput1728517 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728519 {"Protection" (rawinput1728517 "Protection")}] (clojure.core/cond-> {} (letvar1728519 "Protection") (clojure.core/assoc :protection (deser-protection (clojure.core/get-in letvar1728519 ["Protection"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1728521 input] (clojure.core/let [rawinput1728520 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728522 {"message" (rawinput1728520 "message")}] (clojure.core/cond-> {} (letvar1728522 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728522 ["message"])))))))

(clojure.core/defn- response-list-attacks-response ([input] (response-list-attacks-response nil input)) ([resultWrapper1728524 input] (clojure.core/let [rawinput1728523 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728525 {"AttackSummaries" (rawinput1728523 "AttackSummaries"), "NextToken" (rawinput1728523 "NextToken")}] (clojure.core/cond-> {} (letvar1728525 "AttackSummaries") (clojure.core/assoc :attack-summaries (deser-attack-summaries (clojure.core/get-in letvar1728525 ["AttackSummaries"]))) (letvar1728525 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1728525 ["NextToken"])))))))

(clojure.core/defn- response-get-subscription-state-response ([input] (response-get-subscription-state-response nil input)) ([resultWrapper1728527 input] (clojure.core/let [rawinput1728526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728528 {"SubscriptionState" (rawinput1728526 "SubscriptionState")}] (clojure.core/cond-> {:subscription-state (deser-subscription-state (clojure.core/get-in letvar1728528 ["SubscriptionState"]))}))))

(clojure.core/defn- response-update-subscription-response ([input] (response-update-subscription-response nil input)) ([resultWrapper1728530 input] (clojure.core/let [rawinput1728529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728531 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-emergency-contact-settings-response ([input] (response-update-emergency-contact-settings-response nil input)) ([resultWrapper1728533 input] (clojure.core/let [rawinput1728532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728534 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-attack-response ([input] (response-describe-attack-response nil input)) ([resultWrapper1728536 input] (clojure.core/let [rawinput1728535 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728537 {"Attack" (rawinput1728535 "Attack")}] (clojure.core/cond-> {} (letvar1728537 "Attack") (clojure.core/assoc :attack (deser-attack-detail (clojure.core/get-in letvar1728537 ["Attack"])))))))

(clojure.core/defn- response-access-denied-for-dependency-exception ([input] (response-access-denied-for-dependency-exception nil input)) ([resultWrapper1728539 input] (clojure.core/let [rawinput1728538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728540 {"message" (rawinput1728538 "message")}] (clojure.core/cond-> {} (letvar1728540 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728540 ["message"])))))))

(clojure.core/defn- response-describe-subscription-response ([input] (response-describe-subscription-response nil input)) ([resultWrapper1728542 input] (clojure.core/let [rawinput1728541 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728543 {"Subscription" (rawinput1728541 "Subscription")}] (clojure.core/cond-> {} (letvar1728543 "Subscription") (clojure.core/assoc :subscription (deser-subscription (clojure.core/get-in letvar1728543 ["Subscription"])))))))

(clojure.core/defn- response-optimistic-lock-exception ([input] (response-optimistic-lock-exception nil input)) ([resultWrapper1728545 input] (clojure.core/let [rawinput1728544 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728546 {"message" (rawinput1728544 "message")}] (clojure.core/cond-> {} (letvar1728546 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728546 ["message"])))))))

(clojure.core/defn- response-create-protection-response ([input] (response-create-protection-response nil input)) ([resultWrapper1728548 input] (clojure.core/let [rawinput1728547 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728549 {"ProtectionId" (rawinput1728547 "ProtectionId")}] (clojure.core/cond-> {} (letvar1728549 "ProtectionId") (clojure.core/assoc :protection-id (deser-protection-id (clojure.core/get-in letvar1728549 ["ProtectionId"])))))))

(clojure.core/defn- response-associate-drt-role-response ([input] (response-associate-drt-role-response nil input)) ([resultWrapper1728551 input] (clojure.core/let [rawinput1728550 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728552 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1728554 input] (clojure.core/let [rawinput1728553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728555 {"message" (rawinput1728553 "message")}] (clojure.core/cond-> {} (letvar1728555 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728555 ["message"])))))))

(clojure.core/defn- response-delete-subscription-response ([input] (response-delete-subscription-response nil input)) ([resultWrapper1728557 input] (clojure.core/let [rawinput1728556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728558 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-protections-response ([input] (response-list-protections-response nil input)) ([resultWrapper1728560 input] (clojure.core/let [rawinput1728559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728561 {"Protections" (rawinput1728559 "Protections"), "NextToken" (rawinput1728559 "NextToken")}] (clojure.core/cond-> {} (letvar1728561 "Protections") (clojure.core/assoc :protections (deser-protections (clojure.core/get-in letvar1728561 ["Protections"]))) (letvar1728561 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar1728561 ["NextToken"])))))))

(clojure.core/defn- response-invalid-pagination-token-exception ([input] (response-invalid-pagination-token-exception nil input)) ([resultWrapper1728563 input] (clojure.core/let [rawinput1728562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1728564 {"message" (rawinput1728562 "message")}] (clojure.core/cond-> {} (letvar1728564 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1728564 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.shield/protection-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[ a-zA-Z0-9_\\.\\-]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield/attack-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\\-]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws.*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield/log-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([a-z]|(\d(?!\d{0,2}\.\d{1,3}\.\d{1,3}\.\d{1,3})))([a-z\d]|(\.(?!(\.|-)))|(-(?!\.))){1,61}[a-z\d]$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield/email-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 150)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S+@\S+\.\S+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.shield/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 4096)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^.*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield/protection-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\\-]*" s__21078__auto__))))
