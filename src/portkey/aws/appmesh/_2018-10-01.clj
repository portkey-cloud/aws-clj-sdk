...
(clojure.core/defn- response-internal-server-error-exception ([input] (response-internal-server-error-exception nil input)) ([resultWrapper90421 input] (clojure.core/let [rawinput90420 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90422 {"message" (rawinput90420 "message")}] (clojure.core/cond-> {} (letvar90422 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90422 ["message"])))))))

(clojure.core/defn- response-list-routes-output ([input] (response-list-routes-output nil input)) ([resultWrapper90424 input] (clojure.core/let [rawinput90423 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90425 {"nextToken" (rawinput90423 "nextToken"), "routes" (rawinput90423 "routes")}] (clojure.core/cond-> {:routes (deser-route-list (clojure.core/get-in letvar90425 ["routes"]))} (letvar90425 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar90425 ["nextToken"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper90427 input] (clojure.core/let [rawinput90426 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90428 {"message" (rawinput90426 "message")}] (clojure.core/cond-> {} (letvar90428 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90428 ["message"])))))))

(clojure.core/defn- response-list-meshes-output ([input] (response-list-meshes-output nil input)) ([resultWrapper90430 input] (clojure.core/let [rawinput90429 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90431 {"meshes" (rawinput90429 "meshes"), "nextToken" (rawinput90429 "nextToken")}] (clojure.core/cond-> {:meshes (deser-mesh-list (clojure.core/get-in letvar90431 ["meshes"]))} (letvar90431 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar90431 ["nextToken"])))))))

(clojure.core/defn- response-update-route-output ([input] (response-update-route-output nil input)) ([resultWrapper90433 input] (clojure.core/let [rawinput90432 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90434 {"route" (rawinput90432 "route")}] (clojure.core/cond-> {} (letvar90434 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar90434 ["route"])))))))

(clojure.core/defn- response-create-virtual-router-output ([input] (response-create-virtual-router-output nil input)) ([resultWrapper90436 input] (clojure.core/let [rawinput90435 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90437 {"virtualRouter" (rawinput90435 "virtualRouter")}] (clojure.core/cond-> {} (letvar90437 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar90437 ["virtualRouter"])))))))

(clojure.core/defn- response-delete-virtual-node-output ([input] (response-delete-virtual-node-output nil input)) ([resultWrapper90439 input] (clojure.core/let [rawinput90438 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90440 {"virtualNode" (rawinput90438 "virtualNode")}] (clojure.core/cond-> {} (letvar90440 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar90440 ["virtualNode"])))))))

(clojure.core/defn- response-delete-route-output ([input] (response-delete-route-output nil input)) ([resultWrapper90442 input] (clojure.core/let [rawinput90441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90443 {"route" (rawinput90441 "route")}] (clojure.core/cond-> {} (letvar90443 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar90443 ["route"])))))))

(clojure.core/defn- response-forbidden-exception ([input] (response-forbidden-exception nil input)) ([resultWrapper90445 input] (clojure.core/let [rawinput90444 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90446 {"message" (rawinput90444 "message")}] (clojure.core/cond-> {} (letvar90446 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90446 ["message"])))))))

(clojure.core/defn- response-describe-route-output ([input] (response-describe-route-output nil input)) ([resultWrapper90448 input] (clojure.core/let [rawinput90447 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90449 {"route" (rawinput90447 "route")}] (clojure.core/cond-> {} (letvar90449 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar90449 ["route"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper90451 input] (clojure.core/let [rawinput90450 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90452 {"message" (rawinput90450 "message")}] (clojure.core/cond-> {} (letvar90452 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90452 ["message"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper90454 input] (clojure.core/let [rawinput90453 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90455 {"message" (rawinput90453 "message")}] (clojure.core/cond-> {} (letvar90455 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90455 ["message"])))))))

(clojure.core/defn- response-update-virtual-node-output ([input] (response-update-virtual-node-output nil input)) ([resultWrapper90457 input] (clojure.core/let [rawinput90456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90458 {"virtualNode" (rawinput90456 "virtualNode")}] (clojure.core/cond-> {} (letvar90458 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar90458 ["virtualNode"])))))))

(clojure.core/defn- response-update-virtual-router-output ([input] (response-update-virtual-router-output nil input)) ([resultWrapper90460 input] (clojure.core/let [rawinput90459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90461 {"virtualRouter" (rawinput90459 "virtualRouter")}] (clojure.core/cond-> {} (letvar90461 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar90461 ["virtualRouter"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper90463 input] (clojure.core/let [rawinput90462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90464 {"message" (rawinput90462 "message")}] (clojure.core/cond-> {} (letvar90464 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90464 ["message"])))))))

(clojure.core/defn- response-list-virtual-routers-output ([input] (response-list-virtual-routers-output nil input)) ([resultWrapper90466 input] (clojure.core/let [rawinput90465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90467 {"nextToken" (rawinput90465 "nextToken"), "virtualRouters" (rawinput90465 "virtualRouters")}] (clojure.core/cond-> {:virtual-routers (deser-virtual-router-list (clojure.core/get-in letvar90467 ["virtualRouters"]))} (letvar90467 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar90467 ["nextToken"])))))))

(clojure.core/defn- response-create-route-output ([input] (response-create-route-output nil input)) ([resultWrapper90469 input] (clojure.core/let [rawinput90468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90470 {"route" (rawinput90468 "route")}] (clojure.core/cond-> {} (letvar90470 "route") (clojure.core/assoc :route (deser-route-data (clojure.core/get-in letvar90470 ["route"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper90472 input] (clojure.core/let [rawinput90471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90473 {"message" (rawinput90471 "message")}] (clojure.core/cond-> {} (letvar90473 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90473 ["message"])))))))

(clojure.core/defn- response-describe-virtual-node-output ([input] (response-describe-virtual-node-output nil input)) ([resultWrapper90475 input] (clojure.core/let [rawinput90474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90476 {"virtualNode" (rawinput90474 "virtualNode")}] (clojure.core/cond-> {} (letvar90476 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar90476 ["virtualNode"])))))))

(clojure.core/defn- response-describe-virtual-router-output ([input] (response-describe-virtual-router-output nil input)) ([resultWrapper90478 input] (clojure.core/let [rawinput90477 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90479 {"virtualRouter" (rawinput90477 "virtualRouter")}] (clojure.core/cond-> {} (letvar90479 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar90479 ["virtualRouter"])))))))

(clojure.core/defn- response-conflict-exception ([input] (response-conflict-exception nil input)) ([resultWrapper90481 input] (clojure.core/let [rawinput90480 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90482 {"message" (rawinput90480 "message")}] (clojure.core/cond-> {} (letvar90482 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90482 ["message"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper90484 input] (clojure.core/let [rawinput90483 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90485 {"message" (rawinput90483 "message")}] (clojure.core/cond-> {} (letvar90485 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar90485 ["message"])))))))

(clojure.core/defn- response-list-virtual-nodes-output ([input] (response-list-virtual-nodes-output nil input)) ([resultWrapper90487 input] (clojure.core/let [rawinput90486 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90488 {"nextToken" (rawinput90486 "nextToken"), "virtualNodes" (rawinput90486 "virtualNodes")}] (clojure.core/cond-> {:virtual-nodes (deser-virtual-node-list (clojure.core/get-in letvar90488 ["virtualNodes"]))} (letvar90488 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar90488 ["nextToken"])))))))

(clojure.core/defn- response-create-mesh-output ([input] (response-create-mesh-output nil input)) ([resultWrapper90490 input] (clojure.core/let [rawinput90489 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90491 {"mesh" (rawinput90489 "mesh")}] (clojure.core/cond-> {} (letvar90491 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar90491 ["mesh"])))))))

(clojure.core/defn- response-create-virtual-node-output ([input] (response-create-virtual-node-output nil input)) ([resultWrapper90493 input] (clojure.core/let [rawinput90492 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90494 {"virtualNode" (rawinput90492 "virtualNode")}] (clojure.core/cond-> {} (letvar90494 "virtualNode") (clojure.core/assoc :virtual-node (deser-virtual-node-data (clojure.core/get-in letvar90494 ["virtualNode"])))))))

(clojure.core/defn- response-describe-mesh-output ([input] (response-describe-mesh-output nil input)) ([resultWrapper90496 input] (clojure.core/let [rawinput90495 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90497 {"mesh" (rawinput90495 "mesh")}] (clojure.core/cond-> {} (letvar90497 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar90497 ["mesh"])))))))

(clojure.core/defn- response-delete-virtual-router-output ([input] (response-delete-virtual-router-output nil input)) ([resultWrapper90499 input] (clojure.core/let [rawinput90498 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90500 {"virtualRouter" (rawinput90498 "virtualRouter")}] (clojure.core/cond-> {} (letvar90500 "virtualRouter") (clojure.core/assoc :virtual-router (deser-virtual-router-data (clojure.core/get-in letvar90500 ["virtualRouter"])))))))

(clojure.core/defn- response-delete-mesh-output ([input] (response-delete-mesh-output nil input)) ([resultWrapper90502 input] (clojure.core/let [rawinput90501 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar90503 {"mesh" (rawinput90501 "mesh")}] (clojure.core/cond-> {} (letvar90503 "mesh") (clojure.core/assoc :mesh (deser-mesh-data (clojure.core/get-in letvar90503 ["mesh"])))))))
...
(clojure.spec.alpha/def :portkey.aws.appmesh.-2018-10-01/resource-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
