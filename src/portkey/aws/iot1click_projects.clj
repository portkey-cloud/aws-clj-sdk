...
(clojure.core/defn- response-create-placement-response ([input] (response-create-placement-response nil input)) ([resultWrapper241945 input] (clojure.core/let [rawinput241944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241946 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper241948 input] (clojure.core/let [rawinput241947 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241949 {"code" (rawinput241947 "code"), "message" (rawinput241947 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar241949 ["code"])), :message (deser-message (clojure.core/get-in letvar241949 ["message"]))}))))

(clojure.core/defn- response-list-placements-response ([input] (response-list-placements-response nil input)) ([resultWrapper241951 input] (clojure.core/let [rawinput241950 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241952 {"placements" (rawinput241950 "placements"), "nextToken" (rawinput241950 "nextToken")}] (clojure.core/cond-> {:placements (deser-placement-summary-list (clojure.core/get-in letvar241952 ["placements"]))} (letvar241952 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar241952 ["nextToken"])))))))

(clojure.core/defn- response-delete-placement-response ([input] (response-delete-placement-response nil input)) ([resultWrapper241954 input] (clojure.core/let [rawinput241953 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241955 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-placement-response ([input] (response-describe-placement-response nil input)) ([resultWrapper241957 input] (clojure.core/let [rawinput241956 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241958 {"placement" (rawinput241956 "placement")}] (clojure.core/cond-> {:placement (deser-placement-description (clojure.core/get-in letvar241958 ["placement"]))}))))

(clojure.core/defn- response-describe-project-response ([input] (response-describe-project-response nil input)) ([resultWrapper241960 input] (clojure.core/let [rawinput241959 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241961 {"project" (rawinput241959 "project")}] (clojure.core/cond-> {:project (deser-project-description (clojure.core/get-in letvar241961 ["project"]))}))))

(clojure.core/defn- response-disassociate-device-from-placement-response ([input] (response-disassociate-device-from-placement-response nil input)) ([resultWrapper241963 input] (clojure.core/let [rawinput241962 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241964 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-device-with-placement-response ([input] (response-associate-device-with-placement-response nil input)) ([resultWrapper241966 input] (clojure.core/let [rawinput241965 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241967 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper241969 input] (clojure.core/let [rawinput241968 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241970 {"code" (rawinput241968 "code"), "message" (rawinput241968 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar241970 ["code"])), :message (deser-message (clojure.core/get-in letvar241970 ["message"]))}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper241972 input] (clojure.core/let [rawinput241971 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241973 {"code" (rawinput241971 "code"), "message" (rawinput241971 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar241973 ["code"])), :message (deser-message (clojure.core/get-in letvar241973 ["message"]))}))))

(clojure.core/defn- response-list-projects-response ([input] (response-list-projects-response nil input)) ([resultWrapper241975 input] (clojure.core/let [rawinput241974 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241976 {"projects" (rawinput241974 "projects"), "nextToken" (rawinput241974 "nextToken")}] (clojure.core/cond-> {:projects (deser-project-summary-list (clojure.core/get-in letvar241976 ["projects"]))} (letvar241976 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar241976 ["nextToken"])))))))

(clojure.core/defn- response-get-devices-in-placement-response ([input] (response-get-devices-in-placement-response nil input)) ([resultWrapper241978 input] (clojure.core/let [rawinput241977 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241979 {"devices" (rawinput241977 "devices")}] (clojure.core/cond-> {:devices (deser-device-map (clojure.core/get-in letvar241979 ["devices"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper241981 input] (clojure.core/let [rawinput241980 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241982 {"code" (rawinput241980 "code"), "message" (rawinput241980 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar241982 ["code"])), :message (deser-message (clojure.core/get-in letvar241982 ["message"]))}))))

(clojure.core/defn- response-create-project-response ([input] (response-create-project-response nil input)) ([resultWrapper241984 input] (clojure.core/let [rawinput241983 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241985 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-project-response ([input] (response-update-project-response nil input)) ([resultWrapper241987 input] (clojure.core/let [rawinput241986 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241988 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper241990 input] (clojure.core/let [rawinput241989 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241991 {"code" (rawinput241989 "code"), "message" (rawinput241989 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar241991 ["code"])), :message (deser-message (clojure.core/get-in letvar241991 ["message"]))}))))

(clojure.core/defn- response-update-placement-response ([input] (response-update-placement-response nil input)) ([resultWrapper241993 input] (clojure.core/let [rawinput241992 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241994 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-response ([input] (response-delete-project-response nil input)) ([resultWrapper241996 input] (clojure.core/let [rawinput241995 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar241997 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-callback-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-callback-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 800))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-template-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 0 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/placement-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21112__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-default-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 128)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9A-Za-z_-]+$" s__21112__auto__))))
