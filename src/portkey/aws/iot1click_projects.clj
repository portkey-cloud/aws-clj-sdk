...
(clojure.core/defn- response-create-placement-response ([input] (response-create-placement-response nil input)) ([resultWrapper1143383 input] (clojure.core/let [rawinput1143382 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143384 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1143386 input] (clojure.core/let [rawinput1143385 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143387 {"code" (rawinput1143385 "code"), "message" (rawinput1143385 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1143387 ["code"])), :message (deser-message (clojure.core/get-in letvar1143387 ["message"]))}))))

(clojure.core/defn- response-list-placements-response ([input] (response-list-placements-response nil input)) ([resultWrapper1143389 input] (clojure.core/let [rawinput1143388 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143390 {"placements" (rawinput1143388 "placements"), "nextToken" (rawinput1143388 "nextToken")}] (clojure.core/cond-> {:placements (deser-placement-summary-list (clojure.core/get-in letvar1143390 ["placements"]))} (letvar1143390 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1143390 ["nextToken"])))))))

(clojure.core/defn- response-delete-placement-response ([input] (response-delete-placement-response nil input)) ([resultWrapper1143392 input] (clojure.core/let [rawinput1143391 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143393 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-placement-response ([input] (response-describe-placement-response nil input)) ([resultWrapper1143395 input] (clojure.core/let [rawinput1143394 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143396 {"placement" (rawinput1143394 "placement")}] (clojure.core/cond-> {:placement (deser-placement-description (clojure.core/get-in letvar1143396 ["placement"]))}))))

(clojure.core/defn- response-describe-project-response ([input] (response-describe-project-response nil input)) ([resultWrapper1143398 input] (clojure.core/let [rawinput1143397 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143399 {"project" (rawinput1143397 "project")}] (clojure.core/cond-> {:project (deser-project-description (clojure.core/get-in letvar1143399 ["project"]))}))))

(clojure.core/defn- response-disassociate-device-from-placement-response ([input] (response-disassociate-device-from-placement-response nil input)) ([resultWrapper1143401 input] (clojure.core/let [rawinput1143400 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143402 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-associate-device-with-placement-response ([input] (response-associate-device-with-placement-response nil input)) ([resultWrapper1143404 input] (clojure.core/let [rawinput1143403 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143405 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1143407 input] (clojure.core/let [rawinput1143406 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143408 {"code" (rawinput1143406 "code"), "message" (rawinput1143406 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1143408 ["code"])), :message (deser-message (clojure.core/get-in letvar1143408 ["message"]))}))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1143410 input] (clojure.core/let [rawinput1143409 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143411 {"code" (rawinput1143409 "code"), "message" (rawinput1143409 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1143411 ["code"])), :message (deser-message (clojure.core/get-in letvar1143411 ["message"]))}))))

(clojure.core/defn- response-list-projects-response ([input] (response-list-projects-response nil input)) ([resultWrapper1143413 input] (clojure.core/let [rawinput1143412 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143414 {"projects" (rawinput1143412 "projects"), "nextToken" (rawinput1143412 "nextToken")}] (clojure.core/cond-> {:projects (deser-project-summary-list (clojure.core/get-in letvar1143414 ["projects"]))} (letvar1143414 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1143414 ["nextToken"])))))))

(clojure.core/defn- response-get-devices-in-placement-response ([input] (response-get-devices-in-placement-response nil input)) ([resultWrapper1143416 input] (clojure.core/let [rawinput1143415 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143417 {"devices" (rawinput1143415 "devices")}] (clojure.core/cond-> {:devices (deser-device-map (clojure.core/get-in letvar1143417 ["devices"]))}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1143419 input] (clojure.core/let [rawinput1143418 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143420 {"code" (rawinput1143418 "code"), "message" (rawinput1143418 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1143420 ["code"])), :message (deser-message (clojure.core/get-in letvar1143420 ["message"]))}))))

(clojure.core/defn- response-create-project-response ([input] (response-create-project-response nil input)) ([resultWrapper1143422 input] (clojure.core/let [rawinput1143421 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143423 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-project-response ([input] (response-update-project-response nil input)) ([resultWrapper1143425 input] (clojure.core/let [rawinput1143424 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143426 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1143428 input] (clojure.core/let [rawinput1143427 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143429 {"code" (rawinput1143427 "code"), "message" (rawinput1143427 "message")}] (clojure.core/cond-> {:code (deser-code (clojure.core/get-in letvar1143429 ["code"])), :message (deser-message (clojure.core/get-in letvar1143429 ["message"]))}))))

(clojure.core/defn- response-update-placement-response ([input] (response-update-placement-response nil input)) ([resultWrapper1143431 input] (clojure.core/let [rawinput1143430 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143432 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-project-response ([input] (response-delete-project-response nil input)) ([resultWrapper1143434 input] (clojure.core/let [rawinput1143433 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1143435 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-callback-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 200))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-callback-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 800))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-template-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/placement-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/device-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/attribute-default-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.iot1click-projects/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9A-Za-z_-]+$" s__21078__auto__))))
