...
(clojure.core/defn describe-project "<p> Gets details about a project in AWS Mobile Hub. </p>" ([describe-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "GET" "/project" describe-project-request :portkey.aws.mobile/describe-project-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"projectId" "projectId", "syncFromResources" "syncFromResources"}} nil :portkey.aws.mobile/describe-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn export-bundle "<p> Generates customized software development kit (SDK) and or tool packages used to integrate mobile web or mobile app clients with backend AWS resources. </p>" ([export-bundle-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "POST" "/bundles/{bundleId}" export-bundle-request :portkey.aws.mobile/export-bundle-request {:payload nil, :move {}, :headers {}, :uri {"bundleId" "bundleId"}, :querystring {"projectId" "projectId", "platform" "platform"}} nil :portkey.aws.mobile/export-bundle-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn delete-project "<p> Delets a project in AWS Mobile Hub. </p>" ([delete-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "DELETE" "/projects/{projectId}" delete-project-request :portkey.aws.mobile/delete-project-request {:payload nil, :move {}, :headers {}, :uri {"projectId" "projectId"}, :querystring {}} nil :portkey.aws.mobile/delete-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn export-project "<p> Exports project configuration to a snapshot which can be downloaded and shared. Note that mobile app push credentials are encrypted in exported projects, so they can only be shared successfully within the same AWS account. </p>" ([export-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "POST" "/exports/{projectId}" export-project-request :portkey.aws.mobile/export-project-request {:payload nil, :move {}, :headers {}, :uri {"projectId" "projectId"}, :querystring {}} nil :portkey.aws.mobile/export-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
