...
(clojure.spec.alpha/def :portkey.aws.mobile/platform (clojure.spec.alpha/conformer (clojure.core/let [m__15964__auto__ {"JAVASCRIPT" "JAVASCRIPT", :javascript "JAVASCRIPT", :windows "WINDOWS", "OSX" "OSX", :osx "OSX", "WINDOWS" "WINDOWS", :swift "SWIFT", "LINUX" "LINUX", "OBJC" "OBJC", :android "ANDROID", :linux "LINUX", "ANDROID" "ANDROID", "SWIFT" "SWIFT", :objc "OBJC"}] (clojure.core/fn [s__15965__auto__] (m__15964__auto__ s__15965__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mobile/project-state (clojure.spec.alpha/conformer (clojure.core/let [m__15964__auto__ {"NORMAL" "NORMAL", :normal "NORMAL", "SYNCING" "SYNCING", :syncing "SYNCING", "IMPORTING" "IMPORTING", :importing "IMPORTING"}] (clojure.core/fn [s__15965__auto__] (m__15964__auto__ s__15965__auto__ :clojure.spec.alpha/invalid))) (clojure.core/comp clojure.core/keyword portkey.aws/dashed)))
...
(clojure.spec.alpha/def :portkey.aws.mobile/bundle-list (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.mobile/bundle-details) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__15885__15886__auto__] (if (clojure.core/sequential? p1__15885__15886__auto__) p1__15885__15886__auto__ [p1__15885__15886__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.mobile/resources (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.mobile/resource) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__15885__15886__auto__] (if (clojure.core/sequential? p1__15885__15886__auto__) p1__15885__15886__auto__ [p1__15885__15886__auto__])))))
...
(clojure.spec.alpha/def :portkey.aws.mobile/platforms (clojure.spec.alpha/and (clojure.spec.alpha/coll-of :portkey.aws.mobile/platform) (clojure.spec.alpha/conformer clojure.core/identity (fn* [p1__15885__15886__auto__] (if (clojure.core/sequential? p1__15885__15886__auto__) p1__15885__15886__auto__ [p1__15885__15886__auto__])))))

(clojure.spec.alpha/def :portkey.aws.mobile/boolean clojure.core/boolean?)

(clojure.core/defn describe-bundle " Get the bundle details for the requested bundle id. \n" ([describe-bundle-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "GET" "/bundles/{bundleId}" describe-bundle-request :portkey.aws.mobile/describe-bundle-request {:payload nil, :move {}, :headers {}, :uri {"bundleId" "bundleId"}, :querystring {}} nil :portkey.aws.mobile/describe-bundle-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn describe-project " Gets details about a project in AWS Mobile Hub. \n" ([describe-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "GET" "/project" describe-project-request :portkey.aws.mobile/describe-project-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"projectId" "projectId", "syncFromResources" "syncFromResources"}} nil :portkey.aws.mobile/describe-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn export-bundle " Generates customized software development kit (SDK) and or tool packages used to integrate mobile web or mobile app clients with backend AWS resources. \n" ([export-bundle-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "POST" "/bundles/{bundleId}" export-bundle-request :portkey.aws.mobile/export-bundle-request {:payload nil, :move {}, :headers {}, :uri {"bundleId" "bundleId"}, :querystring {"projectId" "projectId", "platform" "platform"}} nil :portkey.aws.mobile/export-bundle-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn delete-project " Delets a project in AWS Mobile Hub. \n" ([delete-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "DELETE" "/projects/{projectId}" delete-project-request :portkey.aws.mobile/delete-project-request {:payload nil, :move {}, :headers {}, :uri {"projectId" "projectId"}, :querystring {}} nil :portkey.aws.mobile/delete-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
...
(clojure.core/defn export-project " Exports project configuration to a snapshot which can be downloaded and shared. Note that mobile app push credentials are encrypted in exported projects, so they can only be shared successfully within the same AWS account. \n" ([export-project-request] (portkey.aws/-rest-json-call portkey.aws.mobile/endpoints "POST" "/exports/{projectId}" export-project-request :portkey.aws.mobile/export-project-request {:payload nil, :move {}, :headers {}, :uri {"projectId" "projectId"}, :querystring {}} nil :portkey.aws.mobile/export-project-result {"InternalFailureException" :portkey.aws.mobile/internal-failure-exception, "ServiceUnavailableException" :portkey.aws.mobile/service-unavailable-exception, "UnauthorizedException" :portkey.aws.mobile/unauthorized-exception, "TooManyRequestsException" :portkey.aws.mobile/too-many-requests-exception, "BadRequestException" :portkey.aws.mobile/bad-request-exception, "NotFoundException" :portkey.aws.mobile/not-found-exception})))
