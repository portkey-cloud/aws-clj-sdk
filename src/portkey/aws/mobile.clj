...
(clojure.core/defn- response-describe-project-result ([input] (response-describe-project-result nil input)) ([resultWrapper1379254 input] (clojure.core/let [rawinput1379253 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379255 {"details" (rawinput1379253 "details")}] (clojure.core/cond-> {} (letvar1379255 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1379255 ["details"])))))))

(clojure.core/defn- response-list-projects-result ([input] (response-list-projects-result nil input)) ([resultWrapper1379257 input] (clojure.core/let [rawinput1379256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379258 {"projects" (rawinput1379256 "projects"), "nextToken" (rawinput1379256 "nextToken")}] (clojure.core/cond-> {} (letvar1379258 "projects") (clojure.core/assoc :projects (deser-project-summaries (clojure.core/get-in letvar1379258 ["projects"]))) (letvar1379258 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1379258 ["nextToken"])))))))

(clojure.core/defn- response-update-project-result ([input] (response-update-project-result nil input)) ([resultWrapper1379260 input] (clojure.core/let [rawinput1379259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379261 {"details" (rawinput1379259 "details")}] (clojure.core/cond-> {} (letvar1379261 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1379261 ["details"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper1379263 input] (clojure.core/let [rawinput1379262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379264 {"message" (rawinput1379262 "message")}] (clojure.core/cond-> {} (letvar1379264 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379264 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper1379266 input] (clojure.core/let [rawinput1379265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379267 {"message" (rawinput1379265 "message")}] (clojure.core/cond-> {} (letvar1379267 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379267 ["message"])))))))

(clojure.core/defn- response-export-bundle-result ([input] (response-export-bundle-result nil input)) ([resultWrapper1379269 input] (clojure.core/let [rawinput1379268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379270 {"downloadUrl" (rawinput1379268 "downloadUrl")}] (clojure.core/cond-> {} (letvar1379270 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar1379270 ["downloadUrl"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1379272 input] (clojure.core/let [rawinput1379271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379273 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1379271 "message")}] (clojure.core/cond-> {} (letvar1379273 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1379273 ["Retry-After"]))) (letvar1379273 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379273 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1379275 input] (clojure.core/let [rawinput1379274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379276 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1379274 "message")}] (clojure.core/cond-> {} (letvar1379276 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1379276 ["Retry-After"]))) (letvar1379276 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379276 ["message"])))))))

(clojure.core/defn- response-describe-bundle-result ([input] (response-describe-bundle-result nil input)) ([resultWrapper1379278 input] (clojure.core/let [rawinput1379277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379279 {"details" (rawinput1379277 "details")}] (clojure.core/cond-> {} (letvar1379279 "details") (clojure.core/assoc :details (deser-bundle-details (clojure.core/get-in letvar1379279 ["details"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1379281 input] (clojure.core/let [rawinput1379280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379282 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput1379280 "message")}] (clojure.core/cond-> {} (letvar1379282 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar1379282 ["Retry-After"]))) (letvar1379282 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379282 ["message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1379284 input] (clojure.core/let [rawinput1379283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379285 {"message" (rawinput1379283 "message")}] (clojure.core/cond-> {} (letvar1379285 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379285 ["message"])))))))

(clojure.core/defn- response-create-project-result ([input] (response-create-project-result nil input)) ([resultWrapper1379287 input] (clojure.core/let [rawinput1379286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379288 {"details" (rawinput1379286 "details")}] (clojure.core/cond-> {} (letvar1379288 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar1379288 ["details"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper1379290 input] (clojure.core/let [rawinput1379289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379291 {"message" (rawinput1379289 "message")}] (clojure.core/cond-> {} (letvar1379291 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379291 ["message"])))))))

(clojure.core/defn- response-delete-project-result ([input] (response-delete-project-result nil input)) ([resultWrapper1379293 input] (clojure.core/let [rawinput1379292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379294 {"deletedResources" (rawinput1379292 "deletedResources"), "orphanedResources" (rawinput1379292 "orphanedResources")}] (clojure.core/cond-> {} (letvar1379294 "deletedResources") (clojure.core/assoc :deleted-resources (deser-resources (clojure.core/get-in letvar1379294 ["deletedResources"]))) (letvar1379294 "orphanedResources") (clojure.core/assoc :orphaned-resources (deser-resources (clojure.core/get-in letvar1379294 ["orphanedResources"])))))))

(clojure.core/defn- response-export-project-result ([input] (response-export-project-result nil input)) ([resultWrapper1379296 input] (clojure.core/let [rawinput1379295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379297 {"downloadUrl" (rawinput1379295 "downloadUrl"), "shareUrl" (rawinput1379295 "shareUrl"), "snapshotId" (rawinput1379295 "snapshotId")}] (clojure.core/cond-> {} (letvar1379297 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar1379297 ["downloadUrl"]))) (letvar1379297 "shareUrl") (clojure.core/assoc :share-url (deser-share-url (clojure.core/get-in letvar1379297 ["shareUrl"]))) (letvar1379297 "snapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar1379297 ["snapshotId"])))))))

(clojure.core/defn- response-account-action-required-exception ([input] (response-account-action-required-exception nil input)) ([resultWrapper1379299 input] (clojure.core/let [rawinput1379298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379300 {"message" (rawinput1379298 "message")}] (clojure.core/cond-> {} (letvar1379300 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1379300 ["message"])))))))

(clojure.core/defn- response-list-bundles-result ([input] (response-list-bundles-result nil input)) ([resultWrapper1379302 input] (clojure.core/let [rawinput1379301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1379303 {"bundleList" (rawinput1379301 "bundleList"), "nextToken" (rawinput1379301 "nextToken")}] (clojure.core/cond-> {} (letvar1379303 "bundleList") (clojure.core/assoc :bundle-list (deser-bundle-list (clojure.core/get-in letvar1379303 ["bundleList"]))) (letvar1379303 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1379303 ["nextToken"])))))))
