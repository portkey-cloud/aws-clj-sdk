...
(clojure.core/defn- response-describe-project-result ([input] (response-describe-project-result nil input)) ([resultWrapper386257 input] (clojure.core/let [rawinput386256 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386258 {"details" (rawinput386256 "details")}] (clojure.core/cond-> {} (letvar386258 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar386258 ["details"])))))))

(clojure.core/defn- response-list-projects-result ([input] (response-list-projects-result nil input)) ([resultWrapper386260 input] (clojure.core/let [rawinput386259 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386261 {"projects" (rawinput386259 "projects"), "nextToken" (rawinput386259 "nextToken")}] (clojure.core/cond-> {} (letvar386261 "projects") (clojure.core/assoc :projects (deser-project-summaries (clojure.core/get-in letvar386261 ["projects"]))) (letvar386261 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar386261 ["nextToken"])))))))

(clojure.core/defn- response-update-project-result ([input] (response-update-project-result nil input)) ([resultWrapper386263 input] (clojure.core/let [rawinput386262 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386264 {"details" (rawinput386262 "details")}] (clojure.core/cond-> {} (letvar386264 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar386264 ["details"])))))))

(clojure.core/defn- response-unauthorized-exception ([input] (response-unauthorized-exception nil input)) ([resultWrapper386266 input] (clojure.core/let [rawinput386265 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386267 {"message" (rawinput386265 "message")}] (clojure.core/cond-> {} (letvar386267 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386267 ["message"])))))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper386269 input] (clojure.core/let [rawinput386268 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386270 {"message" (rawinput386268 "message")}] (clojure.core/cond-> {} (letvar386270 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386270 ["message"])))))))

(clojure.core/defn- response-export-bundle-result ([input] (response-export-bundle-result nil input)) ([resultWrapper386272 input] (clojure.core/let [rawinput386271 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386273 {"downloadUrl" (rawinput386271 "downloadUrl")}] (clojure.core/cond-> {} (letvar386273 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar386273 ["downloadUrl"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper386275 input] (clojure.core/let [rawinput386274 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386276 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput386274 "message")}] (clojure.core/cond-> {} (letvar386276 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar386276 ["Retry-After"]))) (letvar386276 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386276 ["message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper386278 input] (clojure.core/let [rawinput386277 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386279 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput386277 "message")}] (clojure.core/cond-> {} (letvar386279 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar386279 ["Retry-After"]))) (letvar386279 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386279 ["message"])))))))

(clojure.core/defn- response-describe-bundle-result ([input] (response-describe-bundle-result nil input)) ([resultWrapper386281 input] (clojure.core/let [rawinput386280 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386282 {"details" (rawinput386280 "details")}] (clojure.core/cond-> {} (letvar386282 "details") (clojure.core/assoc :details (deser-bundle-details (clojure.core/get-in letvar386282 ["details"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper386284 input] (clojure.core/let [rawinput386283 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386285 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "message" (rawinput386283 "message")}] (clojure.core/cond-> {} (letvar386285 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-error-message (clojure.core/get-in letvar386285 ["Retry-After"]))) (letvar386285 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386285 ["message"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper386287 input] (clojure.core/let [rawinput386286 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386288 {"message" (rawinput386286 "message")}] (clojure.core/cond-> {} (letvar386288 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386288 ["message"])))))))

(clojure.core/defn- response-create-project-result ([input] (response-create-project-result nil input)) ([resultWrapper386290 input] (clojure.core/let [rawinput386289 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386291 {"details" (rawinput386289 "details")}] (clojure.core/cond-> {} (letvar386291 "details") (clojure.core/assoc :details (deser-project-details (clojure.core/get-in letvar386291 ["details"])))))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper386293 input] (clojure.core/let [rawinput386292 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386294 {"message" (rawinput386292 "message")}] (clojure.core/cond-> {} (letvar386294 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386294 ["message"])))))))

(clojure.core/defn- response-delete-project-result ([input] (response-delete-project-result nil input)) ([resultWrapper386296 input] (clojure.core/let [rawinput386295 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386297 {"deletedResources" (rawinput386295 "deletedResources"), "orphanedResources" (rawinput386295 "orphanedResources")}] (clojure.core/cond-> {} (letvar386297 "deletedResources") (clojure.core/assoc :deleted-resources (deser-resources (clojure.core/get-in letvar386297 ["deletedResources"]))) (letvar386297 "orphanedResources") (clojure.core/assoc :orphaned-resources (deser-resources (clojure.core/get-in letvar386297 ["orphanedResources"])))))))

(clojure.core/defn- response-export-project-result ([input] (response-export-project-result nil input)) ([resultWrapper386299 input] (clojure.core/let [rawinput386298 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386300 {"downloadUrl" (rawinput386298 "downloadUrl"), "shareUrl" (rawinput386298 "shareUrl"), "snapshotId" (rawinput386298 "snapshotId")}] (clojure.core/cond-> {} (letvar386300 "downloadUrl") (clojure.core/assoc :download-url (deser-download-url (clojure.core/get-in letvar386300 ["downloadUrl"]))) (letvar386300 "shareUrl") (clojure.core/assoc :share-url (deser-share-url (clojure.core/get-in letvar386300 ["shareUrl"]))) (letvar386300 "snapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar386300 ["snapshotId"])))))))

(clojure.core/defn- response-account-action-required-exception ([input] (response-account-action-required-exception nil input)) ([resultWrapper386302 input] (clojure.core/let [rawinput386301 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386303 {"message" (rawinput386301 "message")}] (clojure.core/cond-> {} (letvar386303 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar386303 ["message"])))))))

(clojure.core/defn- response-list-bundles-result ([input] (response-list-bundles-result nil input)) ([resultWrapper386305 input] (clojure.core/let [rawinput386304 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar386306 {"bundleList" (rawinput386304 "bundleList"), "nextToken" (rawinput386304 "nextToken")}] (clojure.core/cond-> {} (letvar386306 "bundleList") (clojure.core/assoc :bundle-list (deser-bundle-list (clojure.core/get-in letvar386306 ["bundleList"]))) (letvar386306 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar386306 ["nextToken"])))))))
