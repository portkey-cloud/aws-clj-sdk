...
(clojure.core/defn- response-list-tasks-response ([input] (response-list-tasks-response nil input)) ([resultWrapper509855 input] (clojure.core/let [rawinput509854 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509856 {"Tasks" (rawinput509854 "Tasks"), "NextToken" (rawinput509854 "NextToken")}] (clojure.core/cond-> {} (letvar509856 "Tasks") (clojure.core/assoc :tasks (deser-task-list (clojure.core/get-in letvar509856 ["Tasks"]))) (letvar509856 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar509856 ["NextToken"])))))))

(clojure.core/defn- response-describe-task-response ([input] (response-describe-task-response nil input)) ([resultWrapper509858 input] (clojure.core/let [rawinput509857 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509859 {"CloudWatchLogGroupArn" (rawinput509857 "CloudWatchLogGroupArn"), "CurrentTaskExecutionArn" (rawinput509857 "CurrentTaskExecutionArn"), "Status" (rawinput509857 "Status"), "ErrorDetail" (rawinput509857 "ErrorDetail"), "TaskArn" (rawinput509857 "TaskArn"), "ErrorCode" (rawinput509857 "ErrorCode"), "CreationTime" (rawinput509857 "CreationTime"), "SourceLocationArn" (rawinput509857 "SourceLocationArn"), "DestinationLocationArn" (rawinput509857 "DestinationLocationArn"), "Name" (rawinput509857 "Name"), "Options" (rawinput509857 "Options")}] (clojure.core/cond-> {} (letvar509859 "CloudWatchLogGroupArn") (clojure.core/assoc :cloud-watch-log-group-arn (deser-log-group-arn (clojure.core/get-in letvar509859 ["CloudWatchLogGroupArn"]))) (letvar509859 "CurrentTaskExecutionArn") (clojure.core/assoc :current-task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar509859 ["CurrentTaskExecutionArn"]))) (letvar509859 "Status") (clojure.core/assoc :status (deser-task-status (clojure.core/get-in letvar509859 ["Status"]))) (letvar509859 "ErrorDetail") (clojure.core/assoc :error-detail (deserstring (clojure.core/get-in letvar509859 ["ErrorDetail"]))) (letvar509859 "TaskArn") (clojure.core/assoc :task-arn (deser-task-arn (clojure.core/get-in letvar509859 ["TaskArn"]))) (letvar509859 "ErrorCode") (clojure.core/assoc :error-code (deserstring (clojure.core/get-in letvar509859 ["ErrorCode"]))) (letvar509859 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar509859 ["CreationTime"]))) (letvar509859 "SourceLocationArn") (clojure.core/assoc :source-location-arn (deser-location-arn (clojure.core/get-in letvar509859 ["SourceLocationArn"]))) (letvar509859 "DestinationLocationArn") (clojure.core/assoc :destination-location-arn (deser-location-arn (clojure.core/get-in letvar509859 ["DestinationLocationArn"]))) (letvar509859 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar509859 ["Name"]))) (letvar509859 "Options") (clojure.core/assoc :options (deser-options (clojure.core/get-in letvar509859 ["Options"])))))))

(clojure.core/defn- response-describe-agent-response ([input] (response-describe-agent-response nil input)) ([resultWrapper509861 input] (clojure.core/let [rawinput509860 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509862 {"AgentArn" (rawinput509860 "AgentArn"), "Name" (rawinput509860 "Name"), "Status" (rawinput509860 "Status"), "LastConnectionTime" (rawinput509860 "LastConnectionTime"), "CreationTime" (rawinput509860 "CreationTime")}] (clojure.core/cond-> {} (letvar509862 "AgentArn") (clojure.core/assoc :agent-arn (deser-agent-arn (clojure.core/get-in letvar509862 ["AgentArn"]))) (letvar509862 "Name") (clojure.core/assoc :name (deser-tag-value (clojure.core/get-in letvar509862 ["Name"]))) (letvar509862 "Status") (clojure.core/assoc :status (deser-agent-status (clojure.core/get-in letvar509862 ["Status"]))) (letvar509862 "LastConnectionTime") (clojure.core/assoc :last-connection-time (deser-time (clojure.core/get-in letvar509862 ["LastConnectionTime"]))) (letvar509862 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar509862 ["CreationTime"])))))))

(clojure.core/defn- response-cancel-task-execution-response ([input] (response-cancel-task-execution-response nil input)) ([resultWrapper509864 input] (clojure.core/let [rawinput509863 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509865 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-task-execution-response ([input] (response-describe-task-execution-response nil input)) ([resultWrapper509867 input] (clojure.core/let [rawinput509866 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509868 {"BytesTransferred" (rawinput509866 "BytesTransferred"), "StartTime" (rawinput509866 "StartTime"), "TaskExecutionArn" (rawinput509866 "TaskExecutionArn"), "Result" (rawinput509866 "Result"), "Status" (rawinput509866 "Status"), "BytesWritten" (rawinput509866 "BytesWritten"), "EstimatedFilesToTransfer" (rawinput509866 "EstimatedFilesToTransfer"), "EstimatedBytesToTransfer" (rawinput509866 "EstimatedBytesToTransfer"), "FilesTransferred" (rawinput509866 "FilesTransferred"), "Options" (rawinput509866 "Options")}] (clojure.core/cond-> {} (letvar509868 "BytesTransferred") (clojure.core/assoc :bytes-transferred (deserlong (clojure.core/get-in letvar509868 ["BytesTransferred"]))) (letvar509868 "StartTime") (clojure.core/assoc :start-time (deser-time (clojure.core/get-in letvar509868 ["StartTime"]))) (letvar509868 "TaskExecutionArn") (clojure.core/assoc :task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar509868 ["TaskExecutionArn"]))) (letvar509868 "Result") (clojure.core/assoc :result (deser-task-execution-result-detail (clojure.core/get-in letvar509868 ["Result"]))) (letvar509868 "Status") (clojure.core/assoc :status (deser-task-execution-status (clojure.core/get-in letvar509868 ["Status"]))) (letvar509868 "BytesWritten") (clojure.core/assoc :bytes-written (deserlong (clojure.core/get-in letvar509868 ["BytesWritten"]))) (letvar509868 "EstimatedFilesToTransfer") (clojure.core/assoc :estimated-files-to-transfer (deserlong (clojure.core/get-in letvar509868 ["EstimatedFilesToTransfer"]))) (letvar509868 "EstimatedBytesToTransfer") (clojure.core/assoc :estimated-bytes-to-transfer (deserlong (clojure.core/get-in letvar509868 ["EstimatedBytesToTransfer"]))) (letvar509868 "FilesTransferred") (clojure.core/assoc :files-transferred (deserlong (clojure.core/get-in letvar509868 ["FilesTransferred"]))) (letvar509868 "Options") (clojure.core/assoc :options (deser-options (clojure.core/get-in letvar509868 ["Options"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper509870 input] (clojure.core/let [rawinput509869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509871 {"message" (rawinput509869 "message"), "errorCode" (rawinput509869 "errorCode")}] (clojure.core/cond-> {} (letvar509871 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar509871 ["message"]))) (letvar509871 "errorCode") (clojure.core/assoc :error-code (deserstring (clojure.core/get-in letvar509871 ["errorCode"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper509873 input] (clojure.core/let [rawinput509872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509874 {"Tags" (rawinput509872 "Tags"), "NextToken" (rawinput509872 "NextToken")}] (clojure.core/cond-> {} (letvar509874 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar509874 ["Tags"]))) (letvar509874 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar509874 ["NextToken"])))))))

(clojure.core/defn- response-describe-location-efs-response ([input] (response-describe-location-efs-response nil input)) ([resultWrapper509876 input] (clojure.core/let [rawinput509875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509877 {"LocationArn" (rawinput509875 "LocationArn"), "LocationUri" (rawinput509875 "LocationUri"), "Ec2Config" (rawinput509875 "Ec2Config"), "CreationTime" (rawinput509875 "CreationTime")}] (clojure.core/cond-> {} (letvar509877 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509877 ["LocationArn"]))) (letvar509877 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar509877 ["LocationUri"]))) (letvar509877 "Ec2Config") (clojure.core/assoc :ec-2-config (deser-ec-2-config (clojure.core/get-in letvar509877 ["Ec2Config"]))) (letvar509877 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar509877 ["CreationTime"])))))))

(clojure.core/defn- response-create-agent-response ([input] (response-create-agent-response nil input)) ([resultWrapper509879 input] (clojure.core/let [rawinput509878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509880 {"AgentArn" (rawinput509878 "AgentArn")}] (clojure.core/cond-> {} (letvar509880 "AgentArn") (clojure.core/assoc :agent-arn (deser-agent-arn (clojure.core/get-in letvar509880 ["AgentArn"])))))))

(clojure.core/defn- response-list-locations-response ([input] (response-list-locations-response nil input)) ([resultWrapper509882 input] (clojure.core/let [rawinput509881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509883 {"Locations" (rawinput509881 "Locations"), "NextToken" (rawinput509881 "NextToken")}] (clojure.core/cond-> {} (letvar509883 "Locations") (clojure.core/assoc :locations (deser-location-list (clojure.core/get-in letvar509883 ["Locations"]))) (letvar509883 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar509883 ["NextToken"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper509885 input] (clojure.core/let [rawinput509884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509886 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-location-s-3-response ([input] (response-describe-location-s-3-response nil input)) ([resultWrapper509888 input] (clojure.core/let [rawinput509887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509889 {"LocationArn" (rawinput509887 "LocationArn"), "LocationUri" (rawinput509887 "LocationUri"), "S3Config" (rawinput509887 "S3Config"), "CreationTime" (rawinput509887 "CreationTime")}] (clojure.core/cond-> {} (letvar509889 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509889 ["LocationArn"]))) (letvar509889 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar509889 ["LocationUri"]))) (letvar509889 "S3Config") (clojure.core/assoc :s-3-config (deser-s-3-config (clojure.core/get-in letvar509889 ["S3Config"]))) (letvar509889 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar509889 ["CreationTime"])))))))

(clojure.core/defn- response-update-agent-response ([input] (response-update-agent-response nil input)) ([resultWrapper509891 input] (clojure.core/let [rawinput509890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509892 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-task-response ([input] (response-update-task-response nil input)) ([resultWrapper509894 input] (clojure.core/let [rawinput509893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509895 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-start-task-execution-response ([input] (response-start-task-execution-response nil input)) ([resultWrapper509897 input] (clojure.core/let [rawinput509896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509898 {"TaskExecutionArn" (rawinput509896 "TaskExecutionArn")}] (clojure.core/cond-> {} (letvar509898 "TaskExecutionArn") (clojure.core/assoc :task-execution-arn (deser-task-execution-arn (clojure.core/get-in letvar509898 ["TaskExecutionArn"])))))))

(clojure.core/defn- response-create-task-response ([input] (response-create-task-response nil input)) ([resultWrapper509900 input] (clojure.core/let [rawinput509899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509901 {"TaskArn" (rawinput509899 "TaskArn")}] (clojure.core/cond-> {} (letvar509901 "TaskArn") (clojure.core/assoc :task-arn (deser-task-arn (clojure.core/get-in letvar509901 ["TaskArn"])))))))

(clojure.core/defn- response-delete-agent-response ([input] (response-delete-agent-response nil input)) ([resultWrapper509903 input] (clojure.core/let [rawinput509902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509904 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-location-response ([input] (response-delete-location-response nil input)) ([resultWrapper509906 input] (clojure.core/let [rawinput509905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509907 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-task-executions-response ([input] (response-list-task-executions-response nil input)) ([resultWrapper509909 input] (clojure.core/let [rawinput509908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509910 {"TaskExecutions" (rawinput509908 "TaskExecutions"), "NextToken" (rawinput509908 "NextToken")}] (clojure.core/cond-> {} (letvar509910 "TaskExecutions") (clojure.core/assoc :task-executions (deser-task-execution-list (clojure.core/get-in letvar509910 ["TaskExecutions"]))) (letvar509910 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar509910 ["NextToken"])))))))

(clojure.core/defn- response-delete-task-response ([input] (response-delete-task-response nil input)) ([resultWrapper509912 input] (clojure.core/let [rawinput509911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509913 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-agents-response ([input] (response-list-agents-response nil input)) ([resultWrapper509915 input] (clojure.core/let [rawinput509914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509916 {"Agents" (rawinput509914 "Agents"), "NextToken" (rawinput509914 "NextToken")}] (clojure.core/cond-> {} (letvar509916 "Agents") (clojure.core/assoc :agents (deser-agent-list (clojure.core/get-in letvar509916 ["Agents"]))) (letvar509916 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar509916 ["NextToken"])))))))

(clojure.core/defn- response-create-location-s-3-response ([input] (response-create-location-s-3-response nil input)) ([resultWrapper509918 input] (clojure.core/let [rawinput509917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509919 {"LocationArn" (rawinput509917 "LocationArn")}] (clojure.core/cond-> {} (letvar509919 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509919 ["LocationArn"])))))))

(clojure.core/defn- response-describe-location-nfs-response ([input] (response-describe-location-nfs-response nil input)) ([resultWrapper509921 input] (clojure.core/let [rawinput509920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509922 {"LocationArn" (rawinput509920 "LocationArn"), "LocationUri" (rawinput509920 "LocationUri"), "OnPremConfig" (rawinput509920 "OnPremConfig"), "CreationTime" (rawinput509920 "CreationTime")}] (clojure.core/cond-> {} (letvar509922 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509922 ["LocationArn"]))) (letvar509922 "LocationUri") (clojure.core/assoc :location-uri (deser-location-uri (clojure.core/get-in letvar509922 ["LocationUri"]))) (letvar509922 "OnPremConfig") (clojure.core/assoc :on-prem-config (deser-on-prem-config (clojure.core/get-in letvar509922 ["OnPremConfig"]))) (letvar509922 "CreationTime") (clojure.core/assoc :creation-time (deser-time (clojure.core/get-in letvar509922 ["CreationTime"])))))))

(clojure.core/defn- response-create-location-nfs-response ([input] (response-create-location-nfs-response nil input)) ([resultWrapper509924 input] (clojure.core/let [rawinput509923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509925 {"LocationArn" (rawinput509923 "LocationArn")}] (clojure.core/cond-> {} (letvar509925 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509925 ["LocationArn"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper509927 input] (clojure.core/let [rawinput509926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509928 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-location-efs-response ([input] (response-create-location-efs-response nil input)) ([resultWrapper509930 input] (clojure.core/let [rawinput509929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar509931 {"LocationArn" (rawinput509929 "LocationArn")}] (clojure.core/cond-> {} (letvar509931 "LocationArn") (clojure.core/assoc :location-arn (deser-location-arn (clojure.core/get-in letvar509931 ["LocationArn"])))))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/location-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):datasync:[a-z\-0-9]+:[0-9]{12}:location/loc-[0-9a-z]{17}$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.datasync/subdirectory (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 4096)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_\-\./]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 93)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9=_-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/iam-role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):iam::[0-9]{12}:role/.*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/activation-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 29)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[A-Z0-9]{5}(-[A-Z0-9]{5}){4}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9\s+=._:/-]{1,256}$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/s-3-bucket-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 76)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn):s3:::([^/]*)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.datasync/location-uri (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(efs|nfs|s3)://[a-zA-Z0-9.\-]+" s__21078__auto__))))
