...
(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1230828 input] (clojure.core/let [rawinput1230827 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230829 {"Tags" (rawinput1230827 "Tags")}] (clojure.core/cond-> {} (letvar1230829 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1230829 ["Tags"])))))))

(clojure.core/defn- response-update-license-specifications-for-resource-response ([input] (response-update-license-specifications-for-resource-response nil input)) ([resultWrapper1230831 input] (clojure.core/let [rawinput1230830 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230832 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-authorization-exception ([input] (response-authorization-exception nil input)) ([resultWrapper1230834 input] (clojure.core/let [rawinput1230833 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230835 {"Message" (rawinput1230833 "Message")}] (clojure.core/cond-> {} (letvar1230835 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230835 ["Message"])))))))

(clojure.core/defn- response-list-associations-for-license-configuration-response ([input] (response-list-associations-for-license-configuration-response nil input)) ([resultWrapper1230837 input] (clojure.core/let [rawinput1230836 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230838 {"LicenseConfigurationAssociations" (rawinput1230836 "LicenseConfigurationAssociations"), "NextToken" (rawinput1230836 "NextToken")}] (clojure.core/cond-> {} (letvar1230838 "LicenseConfigurationAssociations") (clojure.core/assoc :license-configuration-associations (deser-license-configuration-associations (clojure.core/get-in letvar1230838 ["LicenseConfigurationAssociations"]))) (letvar1230838 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1230838 ["NextToken"])))))))

(clojure.core/defn- response-failed-dependency-exception ([input] (response-failed-dependency-exception nil input)) ([resultWrapper1230840 input] (clojure.core/let [rawinput1230839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230841 {"Message" (rawinput1230839 "Message")}] (clojure.core/cond-> {} (letvar1230841 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230841 ["Message"])))))))

(clojure.core/defn- response-get-service-settings-response ([input] (response-get-service-settings-response nil input)) ([resultWrapper1230843 input] (clojure.core/let [rawinput1230842 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230844 {"S3BucketArn" (rawinput1230842 "S3BucketArn"), "SnsTopicArn" (rawinput1230842 "SnsTopicArn"), "OrganizationConfiguration" (rawinput1230842 "OrganizationConfiguration"), "EnableCrossAccountsDiscovery" (rawinput1230842 "EnableCrossAccountsDiscovery")}] (clojure.core/cond-> {} (letvar1230844 "S3BucketArn") (clojure.core/assoc :s-3-bucket-arn (deser-string (clojure.core/get-in letvar1230844 ["S3BucketArn"]))) (letvar1230844 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-string (clojure.core/get-in letvar1230844 ["SnsTopicArn"]))) (letvar1230844 "OrganizationConfiguration") (clojure.core/assoc :organization-configuration (deser-organization-configuration (clojure.core/get-in letvar1230844 ["OrganizationConfiguration"]))) (letvar1230844 "EnableCrossAccountsDiscovery") (clojure.core/assoc :enable-cross-accounts-discovery (deser-box-boolean (clojure.core/get-in letvar1230844 ["EnableCrossAccountsDiscovery"])))))))

(clojure.core/defn- response-list-license-configurations-response ([input] (response-list-license-configurations-response nil input)) ([resultWrapper1230846 input] (clojure.core/let [rawinput1230845 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230847 {"LicenseConfigurations" (rawinput1230845 "LicenseConfigurations"), "NextToken" (rawinput1230845 "NextToken")}] (clojure.core/cond-> {} (letvar1230847 "LicenseConfigurations") (clojure.core/assoc :license-configurations (deser-license-configurations (clojure.core/get-in letvar1230847 ["LicenseConfigurations"]))) (letvar1230847 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1230847 ["NextToken"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1230849 input] (clojure.core/let [rawinput1230848 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230850 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-filter-limit-exceeded-exception ([input] (response-filter-limit-exceeded-exception nil input)) ([resultWrapper1230852 input] (clojure.core/let [rawinput1230851 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230853 {"Message" (rawinput1230851 "Message")}] (clojure.core/cond-> {} (letvar1230853 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230853 ["Message"])))))))

(clojure.core/defn- response-get-license-configuration-response ([input] (response-get-license-configuration-response nil input)) ([resultWrapper1230855 input] (clojure.core/let [rawinput1230854 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230856 {"LicenseCount" (rawinput1230854 "LicenseCount"), "OwnerAccountId" (rawinput1230854 "OwnerAccountId"), "ManagedResourceSummaryList" (rawinput1230854 "ManagedResourceSummaryList"), "Tags" (rawinput1230854 "Tags"), "Status" (rawinput1230854 "Status"), "ConsumedLicenseSummaryList" (rawinput1230854 "ConsumedLicenseSummaryList"), "Description" (rawinput1230854 "Description"), "LicenseCountHardLimit" (rawinput1230854 "LicenseCountHardLimit"), "LicenseConfigurationArn" (rawinput1230854 "LicenseConfigurationArn"), "LicenseCountingType" (rawinput1230854 "LicenseCountingType"), "Name" (rawinput1230854 "Name"), "LicenseConfigurationId" (rawinput1230854 "LicenseConfigurationId"), "LicenseRules" (rawinput1230854 "LicenseRules"), "ConsumedLicenses" (rawinput1230854 "ConsumedLicenses")}] (clojure.core/cond-> {} (letvar1230856 "LicenseCount") (clojure.core/assoc :license-count (deser-box-long (clojure.core/get-in letvar1230856 ["LicenseCount"]))) (letvar1230856 "OwnerAccountId") (clojure.core/assoc :owner-account-id (deser-string (clojure.core/get-in letvar1230856 ["OwnerAccountId"]))) (letvar1230856 "ManagedResourceSummaryList") (clojure.core/assoc :managed-resource-summary-list (deser-managed-resource-summary-list (clojure.core/get-in letvar1230856 ["ManagedResourceSummaryList"]))) (letvar1230856 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1230856 ["Tags"]))) (letvar1230856 "Status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar1230856 ["Status"]))) (letvar1230856 "ConsumedLicenseSummaryList") (clojure.core/assoc :consumed-license-summary-list (deser-consumed-license-summary-list (clojure.core/get-in letvar1230856 ["ConsumedLicenseSummaryList"]))) (letvar1230856 "Description") (clojure.core/assoc :description (deser-string (clojure.core/get-in letvar1230856 ["Description"]))) (letvar1230856 "LicenseCountHardLimit") (clojure.core/assoc :license-count-hard-limit (deser-box-boolean (clojure.core/get-in letvar1230856 ["LicenseCountHardLimit"]))) (letvar1230856 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1230856 ["LicenseConfigurationArn"]))) (letvar1230856 "LicenseCountingType") (clojure.core/assoc :license-counting-type (deser-license-counting-type (clojure.core/get-in letvar1230856 ["LicenseCountingType"]))) (letvar1230856 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1230856 ["Name"]))) (letvar1230856 "LicenseConfigurationId") (clojure.core/assoc :license-configuration-id (deser-string (clojure.core/get-in letvar1230856 ["LicenseConfigurationId"]))) (letvar1230856 "LicenseRules") (clojure.core/assoc :license-rules (deser-string-list (clojure.core/get-in letvar1230856 ["LicenseRules"]))) (letvar1230856 "ConsumedLicenses") (clojure.core/assoc :consumed-licenses (deser-box-long (clojure.core/get-in letvar1230856 ["ConsumedLicenses"])))))))

(clojure.core/defn- response-rate-limit-exceeded-exception ([input] (response-rate-limit-exceeded-exception nil input)) ([resultWrapper1230858 input] (clojure.core/let [rawinput1230857 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230859 {"Message" (rawinput1230857 "Message")}] (clojure.core/cond-> {} (letvar1230859 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230859 ["Message"])))))))

(clojure.core/defn- response-update-service-settings-response ([input] (response-update-service-settings-response nil input)) ([resultWrapper1230861 input] (clojure.core/let [rawinput1230860 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230862 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1230864 input] (clojure.core/let [rawinput1230863 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230865 {"Message" (rawinput1230863 "Message")}] (clojure.core/cond-> {} (letvar1230865 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230865 ["Message"])))))))

(clojure.core/defn- response-create-license-configuration-response ([input] (response-create-license-configuration-response nil input)) ([resultWrapper1230867 input] (clojure.core/let [rawinput1230866 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230868 {"LicenseConfigurationArn" (rawinput1230866 "LicenseConfigurationArn")}] (clojure.core/cond-> {} (letvar1230868 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1230868 ["LicenseConfigurationArn"])))))))

(clojure.core/defn- response-delete-license-configuration-response ([input] (response-delete-license-configuration-response nil input)) ([resultWrapper1230870 input] (clojure.core/let [rawinput1230869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230871 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-usage-for-license-configuration-response ([input] (response-list-usage-for-license-configuration-response nil input)) ([resultWrapper1230873 input] (clojure.core/let [rawinput1230872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230874 {"LicenseConfigurationUsageList" (rawinput1230872 "LicenseConfigurationUsageList"), "NextToken" (rawinput1230872 "NextToken")}] (clojure.core/cond-> {} (letvar1230874 "LicenseConfigurationUsageList") (clojure.core/assoc :license-configuration-usage-list (deser-license-configuration-usage-list (clojure.core/get-in letvar1230874 ["LicenseConfigurationUsageList"]))) (letvar1230874 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1230874 ["NextToken"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper1230876 input] (clojure.core/let [rawinput1230875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230877 {"Message" (rawinput1230875 "Message")}] (clojure.core/cond-> {} (letvar1230877 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230877 ["Message"])))))))

(clojure.core/defn- response-invalid-resource-state-exception ([input] (response-invalid-resource-state-exception nil input)) ([resultWrapper1230879 input] (clojure.core/let [rawinput1230878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230880 {"Message" (rawinput1230878 "Message")}] (clojure.core/cond-> {} (letvar1230880 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230880 ["Message"])))))))

(clojure.core/defn- response-list-license-specifications-for-resource-response ([input] (response-list-license-specifications-for-resource-response nil input)) ([resultWrapper1230882 input] (clojure.core/let [rawinput1230881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230883 {"LicenseSpecifications" (rawinput1230881 "LicenseSpecifications"), "NextToken" (rawinput1230881 "NextToken")}] (clojure.core/cond-> {} (letvar1230883 "LicenseSpecifications") (clojure.core/assoc :license-specifications (deser-license-specifications (clojure.core/get-in letvar1230883 ["LicenseSpecifications"]))) (letvar1230883 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1230883 ["NextToken"])))))))

(clojure.core/defn- response-license-usage-exception ([input] (response-license-usage-exception nil input)) ([resultWrapper1230885 input] (clojure.core/let [rawinput1230884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230886 {"Message" (rawinput1230884 "Message")}] (clojure.core/cond-> {} (letvar1230886 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230886 ["Message"])))))))

(clojure.core/defn- response-server-internal-exception ([input] (response-server-internal-exception nil input)) ([resultWrapper1230888 input] (clojure.core/let [rawinput1230887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230889 {"Message" (rawinput1230887 "Message")}] (clojure.core/cond-> {} (letvar1230889 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230889 ["Message"])))))))

(clojure.core/defn- response-update-license-configuration-response ([input] (response-update-license-configuration-response nil input)) ([resultWrapper1230891 input] (clojure.core/let [rawinput1230890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230892 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1230894 input] (clojure.core/let [rawinput1230893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230895 {"Message" (rawinput1230893 "Message")}] (clojure.core/cond-> {} (letvar1230895 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1230895 ["Message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1230897 input] (clojure.core/let [rawinput1230896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230898 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resource-inventory-response ([input] (response-list-resource-inventory-response nil input)) ([resultWrapper1230900 input] (clojure.core/let [rawinput1230899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1230901 {"ResourceInventoryList" (rawinput1230899 "ResourceInventoryList"), "NextToken" (rawinput1230899 "NextToken")}] (clojure.core/cond-> {} (letvar1230901 "ResourceInventoryList") (clojure.core/assoc :resource-inventory-list (deser-resource-inventory-list (clojure.core/get-in letvar1230901 ["ResourceInventoryList"]))) (letvar1230901 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1230901 ["NextToken"])))))))
