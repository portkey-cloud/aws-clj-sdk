...
(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1887639 input] (clojure.core/let [rawinput1887638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887640 {"Tags" (rawinput1887638 "Tags")}] (clojure.core/cond-> {} (letvar1887640 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1887640 ["Tags"])))))))

(clojure.core/defn- response-update-license-specifications-for-resource-response ([input] (response-update-license-specifications-for-resource-response nil input)) ([resultWrapper1887642 input] (clojure.core/let [rawinput1887641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887643 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-authorization-exception ([input] (response-authorization-exception nil input)) ([resultWrapper1887645 input] (clojure.core/let [rawinput1887644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887646 {"Message" (rawinput1887644 "Message")}] (clojure.core/cond-> {} (letvar1887646 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887646 ["Message"])))))))

(clojure.core/defn- response-list-associations-for-license-configuration-response ([input] (response-list-associations-for-license-configuration-response nil input)) ([resultWrapper1887648 input] (clojure.core/let [rawinput1887647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887649 {"LicenseConfigurationAssociations" (rawinput1887647 "LicenseConfigurationAssociations"), "NextToken" (rawinput1887647 "NextToken")}] (clojure.core/cond-> {} (letvar1887649 "LicenseConfigurationAssociations") (clojure.core/assoc :license-configuration-associations (deser-license-configuration-associations (clojure.core/get-in letvar1887649 ["LicenseConfigurationAssociations"]))) (letvar1887649 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1887649 ["NextToken"])))))))

(clojure.core/defn- response-failed-dependency-exception ([input] (response-failed-dependency-exception nil input)) ([resultWrapper1887651 input] (clojure.core/let [rawinput1887650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887652 {"Message" (rawinput1887650 "Message")}] (clojure.core/cond-> {} (letvar1887652 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887652 ["Message"])))))))

(clojure.core/defn- response-get-service-settings-response ([input] (response-get-service-settings-response nil input)) ([resultWrapper1887654 input] (clojure.core/let [rawinput1887653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887655 {"S3BucketArn" (rawinput1887653 "S3BucketArn"), "SnsTopicArn" (rawinput1887653 "SnsTopicArn"), "OrganizationConfiguration" (rawinput1887653 "OrganizationConfiguration"), "EnableCrossAccountsDiscovery" (rawinput1887653 "EnableCrossAccountsDiscovery")}] (clojure.core/cond-> {} (letvar1887655 "S3BucketArn") (clojure.core/assoc :s-3-bucket-arn (deser-string (clojure.core/get-in letvar1887655 ["S3BucketArn"]))) (letvar1887655 "SnsTopicArn") (clojure.core/assoc :sns-topic-arn (deser-string (clojure.core/get-in letvar1887655 ["SnsTopicArn"]))) (letvar1887655 "OrganizationConfiguration") (clojure.core/assoc :organization-configuration (deser-organization-configuration (clojure.core/get-in letvar1887655 ["OrganizationConfiguration"]))) (letvar1887655 "EnableCrossAccountsDiscovery") (clojure.core/assoc :enable-cross-accounts-discovery (deser-box-boolean (clojure.core/get-in letvar1887655 ["EnableCrossAccountsDiscovery"])))))))

(clojure.core/defn- response-list-license-configurations-response ([input] (response-list-license-configurations-response nil input)) ([resultWrapper1887657 input] (clojure.core/let [rawinput1887656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887658 {"LicenseConfigurations" (rawinput1887656 "LicenseConfigurations"), "NextToken" (rawinput1887656 "NextToken")}] (clojure.core/cond-> {} (letvar1887658 "LicenseConfigurations") (clojure.core/assoc :license-configurations (deser-license-configurations (clojure.core/get-in letvar1887658 ["LicenseConfigurations"]))) (letvar1887658 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1887658 ["NextToken"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1887660 input] (clojure.core/let [rawinput1887659 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887661 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-filter-limit-exceeded-exception ([input] (response-filter-limit-exceeded-exception nil input)) ([resultWrapper1887663 input] (clojure.core/let [rawinput1887662 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887664 {"Message" (rawinput1887662 "Message")}] (clojure.core/cond-> {} (letvar1887664 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887664 ["Message"])))))))

(clojure.core/defn- response-get-license-configuration-response ([input] (response-get-license-configuration-response nil input)) ([resultWrapper1887666 input] (clojure.core/let [rawinput1887665 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887667 {"LicenseCount" (rawinput1887665 "LicenseCount"), "OwnerAccountId" (rawinput1887665 "OwnerAccountId"), "ManagedResourceSummaryList" (rawinput1887665 "ManagedResourceSummaryList"), "Tags" (rawinput1887665 "Tags"), "Status" (rawinput1887665 "Status"), "ConsumedLicenseSummaryList" (rawinput1887665 "ConsumedLicenseSummaryList"), "Description" (rawinput1887665 "Description"), "LicenseCountHardLimit" (rawinput1887665 "LicenseCountHardLimit"), "LicenseConfigurationArn" (rawinput1887665 "LicenseConfigurationArn"), "LicenseCountingType" (rawinput1887665 "LicenseCountingType"), "Name" (rawinput1887665 "Name"), "LicenseConfigurationId" (rawinput1887665 "LicenseConfigurationId"), "LicenseRules" (rawinput1887665 "LicenseRules"), "ConsumedLicenses" (rawinput1887665 "ConsumedLicenses")}] (clojure.core/cond-> {} (letvar1887667 "LicenseCount") (clojure.core/assoc :license-count (deser-box-long (clojure.core/get-in letvar1887667 ["LicenseCount"]))) (letvar1887667 "OwnerAccountId") (clojure.core/assoc :owner-account-id (deser-string (clojure.core/get-in letvar1887667 ["OwnerAccountId"]))) (letvar1887667 "ManagedResourceSummaryList") (clojure.core/assoc :managed-resource-summary-list (deser-managed-resource-summary-list (clojure.core/get-in letvar1887667 ["ManagedResourceSummaryList"]))) (letvar1887667 "Tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1887667 ["Tags"]))) (letvar1887667 "Status") (clojure.core/assoc :status (deser-string (clojure.core/get-in letvar1887667 ["Status"]))) (letvar1887667 "ConsumedLicenseSummaryList") (clojure.core/assoc :consumed-license-summary-list (deser-consumed-license-summary-list (clojure.core/get-in letvar1887667 ["ConsumedLicenseSummaryList"]))) (letvar1887667 "Description") (clojure.core/assoc :description (deser-string (clojure.core/get-in letvar1887667 ["Description"]))) (letvar1887667 "LicenseCountHardLimit") (clojure.core/assoc :license-count-hard-limit (deser-box-boolean (clojure.core/get-in letvar1887667 ["LicenseCountHardLimit"]))) (letvar1887667 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1887667 ["LicenseConfigurationArn"]))) (letvar1887667 "LicenseCountingType") (clojure.core/assoc :license-counting-type (deser-license-counting-type (clojure.core/get-in letvar1887667 ["LicenseCountingType"]))) (letvar1887667 "Name") (clojure.core/assoc :name (deser-string (clojure.core/get-in letvar1887667 ["Name"]))) (letvar1887667 "LicenseConfigurationId") (clojure.core/assoc :license-configuration-id (deser-string (clojure.core/get-in letvar1887667 ["LicenseConfigurationId"]))) (letvar1887667 "LicenseRules") (clojure.core/assoc :license-rules (deser-string-list (clojure.core/get-in letvar1887667 ["LicenseRules"]))) (letvar1887667 "ConsumedLicenses") (clojure.core/assoc :consumed-licenses (deser-box-long (clojure.core/get-in letvar1887667 ["ConsumedLicenses"])))))))

(clojure.core/defn- response-rate-limit-exceeded-exception ([input] (response-rate-limit-exceeded-exception nil input)) ([resultWrapper1887669 input] (clojure.core/let [rawinput1887668 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887670 {"Message" (rawinput1887668 "Message")}] (clojure.core/cond-> {} (letvar1887670 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887670 ["Message"])))))))

(clojure.core/defn- response-update-service-settings-response ([input] (response-update-service-settings-response nil input)) ([resultWrapper1887672 input] (clojure.core/let [rawinput1887671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887673 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1887675 input] (clojure.core/let [rawinput1887674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887676 {"Message" (rawinput1887674 "Message")}] (clojure.core/cond-> {} (letvar1887676 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887676 ["Message"])))))))

(clojure.core/defn- response-create-license-configuration-response ([input] (response-create-license-configuration-response nil input)) ([resultWrapper1887678 input] (clojure.core/let [rawinput1887677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887679 {"LicenseConfigurationArn" (rawinput1887677 "LicenseConfigurationArn")}] (clojure.core/cond-> {} (letvar1887679 "LicenseConfigurationArn") (clojure.core/assoc :license-configuration-arn (deser-string (clojure.core/get-in letvar1887679 ["LicenseConfigurationArn"])))))))

(clojure.core/defn- response-delete-license-configuration-response ([input] (response-delete-license-configuration-response nil input)) ([resultWrapper1887681 input] (clojure.core/let [rawinput1887680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887682 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-usage-for-license-configuration-response ([input] (response-list-usage-for-license-configuration-response nil input)) ([resultWrapper1887684 input] (clojure.core/let [rawinput1887683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887685 {"LicenseConfigurationUsageList" (rawinput1887683 "LicenseConfigurationUsageList"), "NextToken" (rawinput1887683 "NextToken")}] (clojure.core/cond-> {} (letvar1887685 "LicenseConfigurationUsageList") (clojure.core/assoc :license-configuration-usage-list (deser-license-configuration-usage-list (clojure.core/get-in letvar1887685 ["LicenseConfigurationUsageList"]))) (letvar1887685 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1887685 ["NextToken"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper1887687 input] (clojure.core/let [rawinput1887686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887688 {"Message" (rawinput1887686 "Message")}] (clojure.core/cond-> {} (letvar1887688 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887688 ["Message"])))))))

(clojure.core/defn- response-invalid-resource-state-exception ([input] (response-invalid-resource-state-exception nil input)) ([resultWrapper1887690 input] (clojure.core/let [rawinput1887689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887691 {"Message" (rawinput1887689 "Message")}] (clojure.core/cond-> {} (letvar1887691 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887691 ["Message"])))))))

(clojure.core/defn- response-list-license-specifications-for-resource-response ([input] (response-list-license-specifications-for-resource-response nil input)) ([resultWrapper1887693 input] (clojure.core/let [rawinput1887692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887694 {"LicenseSpecifications" (rawinput1887692 "LicenseSpecifications"), "NextToken" (rawinput1887692 "NextToken")}] (clojure.core/cond-> {} (letvar1887694 "LicenseSpecifications") (clojure.core/assoc :license-specifications (deser-license-specifications (clojure.core/get-in letvar1887694 ["LicenseSpecifications"]))) (letvar1887694 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1887694 ["NextToken"])))))))

(clojure.core/defn- response-license-usage-exception ([input] (response-license-usage-exception nil input)) ([resultWrapper1887696 input] (clojure.core/let [rawinput1887695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887697 {"Message" (rawinput1887695 "Message")}] (clojure.core/cond-> {} (letvar1887697 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887697 ["Message"])))))))

(clojure.core/defn- response-server-internal-exception ([input] (response-server-internal-exception nil input)) ([resultWrapper1887699 input] (clojure.core/let [rawinput1887698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887700 {"Message" (rawinput1887698 "Message")}] (clojure.core/cond-> {} (letvar1887700 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887700 ["Message"])))))))

(clojure.core/defn- response-update-license-configuration-response ([input] (response-update-license-configuration-response nil input)) ([resultWrapper1887702 input] (clojure.core/let [rawinput1887701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887703 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1887705 input] (clojure.core/let [rawinput1887704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887706 {"Message" (rawinput1887704 "Message")}] (clojure.core/cond-> {} (letvar1887706 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1887706 ["Message"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1887708 input] (clojure.core/let [rawinput1887707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887709 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resource-inventory-response ([input] (response-list-resource-inventory-response nil input)) ([resultWrapper1887711 input] (clojure.core/let [rawinput1887710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1887712 {"ResourceInventoryList" (rawinput1887710 "ResourceInventoryList"), "NextToken" (rawinput1887710 "NextToken")}] (clojure.core/cond-> {} (letvar1887712 "ResourceInventoryList") (clojure.core/assoc :resource-inventory-list (deser-resource-inventory-list (clojure.core/get-in letvar1887712 ["ResourceInventoryList"]))) (letvar1887712 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1887712 ["NextToken"])))))))
