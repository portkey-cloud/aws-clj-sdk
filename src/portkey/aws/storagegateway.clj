...
(clojure.core/defn- response-join-domain-output ([input] (response-join-domain-output nil input)) ([resultWrapper2096638 input] (clojure.core/let [rawinput2096637 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096639 {"GatewayARN" (rawinput2096637 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096639 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096639 ["GatewayARN"])))))))

(clojure.core/defn- response-activate-gateway-output ([input] (response-activate-gateway-output nil input)) ([resultWrapper2096641 input] (clojure.core/let [rawinput2096640 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096642 {"GatewayARN" (rawinput2096640 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096642 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096642 ["GatewayARN"])))))))

(clojure.core/defn- response-list-volume-initiators-output ([input] (response-list-volume-initiators-output nil input)) ([resultWrapper2096644 input] (clojure.core/let [rawinput2096643 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096645 {"Initiators" (rawinput2096643 "Initiators")}] (clojure.core/cond-> {} (letvar2096645 "Initiators") (clojure.core/assoc :initiators (deser-initiators (clojure.core/get-in letvar2096645 ["Initiators"])))))))

(clojure.core/defn- response-describe-bandwidth-rate-limit-output ([input] (response-describe-bandwidth-rate-limit-output nil input)) ([resultWrapper2096647 input] (clojure.core/let [rawinput2096646 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096648 {"GatewayARN" (rawinput2096646 "GatewayARN"), "AverageUploadRateLimitInBitsPerSec" (rawinput2096646 "AverageUploadRateLimitInBitsPerSec"), "AverageDownloadRateLimitInBitsPerSec" (rawinput2096646 "AverageDownloadRateLimitInBitsPerSec")}] (clojure.core/cond-> {} (letvar2096648 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096648 ["GatewayARN"]))) (letvar2096648 "AverageUploadRateLimitInBitsPerSec") (clojure.core/assoc :average-upload-rate-limit-in-bits-per-sec (deser-bandwidth-upload-rate-limit (clojure.core/get-in letvar2096648 ["AverageUploadRateLimitInBitsPerSec"]))) (letvar2096648 "AverageDownloadRateLimitInBitsPerSec") (clojure.core/assoc :average-download-rate-limit-in-bits-per-sec (deser-bandwidth-download-rate-limit (clojure.core/get-in letvar2096648 ["AverageDownloadRateLimitInBitsPerSec"])))))))

(clojure.core/defn- response-list-volume-recovery-points-output ([input] (response-list-volume-recovery-points-output nil input)) ([resultWrapper2096650 input] (clojure.core/let [rawinput2096649 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096651 {"GatewayARN" (rawinput2096649 "GatewayARN"), "VolumeRecoveryPointInfos" (rawinput2096649 "VolumeRecoveryPointInfos")}] (clojure.core/cond-> {} (letvar2096651 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096651 ["GatewayARN"]))) (letvar2096651 "VolumeRecoveryPointInfos") (clojure.core/assoc :volume-recovery-point-infos (deser-volume-recovery-point-infos (clojure.core/get-in letvar2096651 ["VolumeRecoveryPointInfos"])))))))

(clojure.core/defn- response-describe-tape-recovery-points-output ([input] (response-describe-tape-recovery-points-output nil input)) ([resultWrapper2096653 input] (clojure.core/let [rawinput2096652 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096654 {"GatewayARN" (rawinput2096652 "GatewayARN"), "TapeRecoveryPointInfos" (rawinput2096652 "TapeRecoveryPointInfos"), "Marker" (rawinput2096652 "Marker")}] (clojure.core/cond-> {} (letvar2096654 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096654 ["GatewayARN"]))) (letvar2096654 "TapeRecoveryPointInfos") (clojure.core/assoc :tape-recovery-point-infos (deser-tape-recovery-point-infos (clojure.core/get-in letvar2096654 ["TapeRecoveryPointInfos"]))) (letvar2096654 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096654 ["Marker"])))))))

(clojure.core/defn- response-update-gateway-software-now-output ([input] (response-update-gateway-software-now-output nil input)) ([resultWrapper2096656 input] (clojure.core/let [rawinput2096655 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096657 {"GatewayARN" (rawinput2096655 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096657 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096657 ["GatewayARN"])))))))

(clojure.core/defn- response-start-gateway-output ([input] (response-start-gateway-output nil input)) ([resultWrapper2096659 input] (clojure.core/let [rawinput2096658 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096660 {"GatewayARN" (rawinput2096658 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096660 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096660 ["GatewayARN"])))))))

(clojure.core/defn- response-create-storedi-scsi-volume-output ([input] (response-create-storedi-scsi-volume-output nil input)) ([resultWrapper2096662 input] (clojure.core/let [rawinput2096661 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096663 {"VolumeARN" (rawinput2096661 "VolumeARN"), "VolumeSizeInBytes" (rawinput2096661 "VolumeSizeInBytes"), "TargetARN" (rawinput2096661 "TargetARN")}] (clojure.core/cond-> {} (letvar2096663 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096663 ["VolumeARN"]))) (letvar2096663 "VolumeSizeInBytes") (clojure.core/assoc :volume-size-in-bytes (deserlong (clojure.core/get-in letvar2096663 ["VolumeSizeInBytes"]))) (letvar2096663 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096663 ["TargetARN"])))))))

(clojure.core/defn- response-delete-tape-archive-output ([input] (response-delete-tape-archive-output nil input)) ([resultWrapper2096665 input] (clojure.core/let [rawinput2096664 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096666 {"TapeARN" (rawinput2096664 "TapeARN")}] (clojure.core/cond-> {} (letvar2096666 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096666 ["TapeARN"])))))))

(clojure.core/defn- response-describe-cache-output ([input] (response-describe-cache-output nil input)) ([resultWrapper2096668 input] (clojure.core/let [rawinput2096667 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096669 {"GatewayARN" (rawinput2096667 "GatewayARN"), "DiskIds" (rawinput2096667 "DiskIds"), "CacheAllocatedInBytes" (rawinput2096667 "CacheAllocatedInBytes"), "CacheUsedPercentage" (rawinput2096667 "CacheUsedPercentage"), "CacheDirtyPercentage" (rawinput2096667 "CacheDirtyPercentage"), "CacheHitPercentage" (rawinput2096667 "CacheHitPercentage"), "CacheMissPercentage" (rawinput2096667 "CacheMissPercentage")}] (clojure.core/cond-> {} (letvar2096669 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096669 ["GatewayARN"]))) (letvar2096669 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096669 ["DiskIds"]))) (letvar2096669 "CacheAllocatedInBytes") (clojure.core/assoc :cache-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096669 ["CacheAllocatedInBytes"]))) (letvar2096669 "CacheUsedPercentage") (clojure.core/assoc :cache-used-percentage (deserdouble (clojure.core/get-in letvar2096669 ["CacheUsedPercentage"]))) (letvar2096669 "CacheDirtyPercentage") (clojure.core/assoc :cache-dirty-percentage (deserdouble (clojure.core/get-in letvar2096669 ["CacheDirtyPercentage"]))) (letvar2096669 "CacheHitPercentage") (clojure.core/assoc :cache-hit-percentage (deserdouble (clojure.core/get-in letvar2096669 ["CacheHitPercentage"]))) (letvar2096669 "CacheMissPercentage") (clojure.core/assoc :cache-miss-percentage (deserdouble (clojure.core/get-in letvar2096669 ["CacheMissPercentage"])))))))

(clojure.core/defn- response-describe-upload-buffer-output ([input] (response-describe-upload-buffer-output nil input)) ([resultWrapper2096671 input] (clojure.core/let [rawinput2096670 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096672 {"GatewayARN" (rawinput2096670 "GatewayARN"), "DiskIds" (rawinput2096670 "DiskIds"), "UploadBufferUsedInBytes" (rawinput2096670 "UploadBufferUsedInBytes"), "UploadBufferAllocatedInBytes" (rawinput2096670 "UploadBufferAllocatedInBytes")}] (clojure.core/cond-> {} (letvar2096672 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096672 ["GatewayARN"]))) (letvar2096672 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096672 ["DiskIds"]))) (letvar2096672 "UploadBufferUsedInBytes") (clojure.core/assoc :upload-buffer-used-in-bytes (deserlong (clojure.core/get-in letvar2096672 ["UploadBufferUsedInBytes"]))) (letvar2096672 "UploadBufferAllocatedInBytes") (clojure.core/assoc :upload-buffer-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096672 ["UploadBufferAllocatedInBytes"])))))))

(clojure.core/defn- response-describe-tape-archives-output ([input] (response-describe-tape-archives-output nil input)) ([resultWrapper2096674 input] (clojure.core/let [rawinput2096673 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096675 {"TapeArchives" (rawinput2096673 "TapeArchives"), "Marker" (rawinput2096673 "Marker")}] (clojure.core/cond-> {} (letvar2096675 "TapeArchives") (clojure.core/assoc :tape-archives (deser-tape-archives (clojure.core/get-in letvar2096675 ["TapeArchives"]))) (letvar2096675 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096675 ["Marker"])))))))

(clojure.core/defn- response-cancel-archival-output ([input] (response-cancel-archival-output nil input)) ([resultWrapper2096677 input] (clojure.core/let [rawinput2096676 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096678 {"TapeARN" (rawinput2096676 "TapeARN")}] (clojure.core/cond-> {} (letvar2096678 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096678 ["TapeARN"])))))))

(clojure.core/defn- response-shutdown-gateway-output ([input] (response-shutdown-gateway-output nil input)) ([resultWrapper2096680 input] (clojure.core/let [rawinput2096679 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096681 {"GatewayARN" (rawinput2096679 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096681 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096681 ["GatewayARN"])))))))

(clojure.core/defn- response-update-vtl-device-type-output ([input] (response-update-vtl-device-type-output nil input)) ([resultWrapper2096683 input] (clojure.core/let [rawinput2096682 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096684 {"VTLDeviceARN" (rawinput2096682 "VTLDeviceARN")}] (clojure.core/cond-> {} (letvar2096684 "VTLDeviceARN") (clojure.core/assoc :vtl-device-arn (deser-vtl-device-arn (clojure.core/get-in letvar2096684 ["VTLDeviceARN"])))))))

(clojure.core/defn- response-update-bandwidth-rate-limit-output ([input] (response-update-bandwidth-rate-limit-output nil input)) ([resultWrapper2096686 input] (clojure.core/let [rawinput2096685 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096687 {"GatewayARN" (rawinput2096685 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096687 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096687 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-chap-credentials-output ([input] (response-delete-chap-credentials-output nil input)) ([resultWrapper2096689 input] (clojure.core/let [rawinput2096688 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096690 {"TargetARN" (rawinput2096688 "TargetARN"), "InitiatorName" (rawinput2096688 "InitiatorName")}] (clojure.core/cond-> {} (letvar2096690 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096690 ["TargetARN"]))) (letvar2096690 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar2096690 ["InitiatorName"])))))))

(clojure.core/defn- response-describe-chap-credentials-output ([input] (response-describe-chap-credentials-output nil input)) ([resultWrapper2096692 input] (clojure.core/let [rawinput2096691 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096693 {"ChapCredentials" (rawinput2096691 "ChapCredentials")}] (clojure.core/cond-> {} (letvar2096693 "ChapCredentials") (clojure.core/assoc :chap-credentials (deser-chap-credentials (clojure.core/get-in letvar2096693 ["ChapCredentials"])))))))

(clojure.core/defn- response-refresh-cache-output ([input] (response-refresh-cache-output nil input)) ([resultWrapper2096695 input] (clojure.core/let [rawinput2096694 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096696 {"FileShareARN" (rawinput2096694 "FileShareARN"), "NotificationId" (rawinput2096694 "NotificationId")}] (clojure.core/cond-> {} (letvar2096696 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096696 ["FileShareARN"]))) (letvar2096696 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar2096696 ["NotificationId"])))))))

(clojure.core/defn- response-add-cache-output ([input] (response-add-cache-output nil input)) ([resultWrapper2096698 input] (clojure.core/let [rawinput2096697 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096699 {"GatewayARN" (rawinput2096697 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096699 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096699 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-maintenance-start-time-output ([input] (response-describe-maintenance-start-time-output nil input)) ([resultWrapper2096701 input] (clojure.core/let [rawinput2096700 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096702 {"GatewayARN" (rawinput2096700 "GatewayARN"), "HourOfDay" (rawinput2096700 "HourOfDay"), "MinuteOfHour" (rawinput2096700 "MinuteOfHour"), "DayOfWeek" (rawinput2096700 "DayOfWeek"), "Timezone" (rawinput2096700 "Timezone")}] (clojure.core/cond-> {} (letvar2096702 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096702 ["GatewayARN"]))) (letvar2096702 "HourOfDay") (clojure.core/assoc :hour-of-day (deser-hour-of-day (clojure.core/get-in letvar2096702 ["HourOfDay"]))) (letvar2096702 "MinuteOfHour") (clojure.core/assoc :minute-of-hour (deser-minute-of-hour (clojure.core/get-in letvar2096702 ["MinuteOfHour"]))) (letvar2096702 "DayOfWeek") (clojure.core/assoc :day-of-week (deser-day-of-week (clojure.core/get-in letvar2096702 ["DayOfWeek"]))) (letvar2096702 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar2096702 ["Timezone"])))))))

(clojure.core/defn- response-create-tapes-output ([input] (response-create-tapes-output nil input)) ([resultWrapper2096704 input] (clojure.core/let [rawinput2096703 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096705 {"TapeARNs" (rawinput2096703 "TapeARNs")}] (clojure.core/cond-> {} (letvar2096705 "TapeARNs") (clojure.core/assoc :tape-ar-ns (deser-tape-ar-ns (clojure.core/get-in letvar2096705 ["TapeARNs"])))))))

(clojure.core/defn- response-set-smb-guest-password-output ([input] (response-set-smb-guest-password-output nil input)) ([resultWrapper2096707 input] (clojure.core/let [rawinput2096706 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096708 {"GatewayARN" (rawinput2096706 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096708 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096708 ["GatewayARN"])))))))

(clojure.core/defn- response-create-snapshot-from-volume-recovery-point-output ([input] (response-create-snapshot-from-volume-recovery-point-output nil input)) ([resultWrapper2096710 input] (clojure.core/let [rawinput2096709 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096711 {"SnapshotId" (rawinput2096709 "SnapshotId"), "VolumeARN" (rawinput2096709 "VolumeARN"), "VolumeRecoveryPointTime" (rawinput2096709 "VolumeRecoveryPointTime")}] (clojure.core/cond-> {} (letvar2096711 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar2096711 ["SnapshotId"]))) (letvar2096711 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096711 ["VolumeARN"]))) (letvar2096711 "VolumeRecoveryPointTime") (clojure.core/assoc :volume-recovery-point-time (deserstring (clojure.core/get-in letvar2096711 ["VolumeRecoveryPointTime"])))))))

(clojure.core/defn- response-cancel-retrieval-output ([input] (response-cancel-retrieval-output nil input)) ([resultWrapper2096713 input] (clojure.core/let [rawinput2096712 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096714 {"TapeARN" (rawinput2096712 "TapeARN")}] (clojure.core/cond-> {} (letvar2096714 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096714 ["TapeARN"])))))))

(clojure.core/defn- response-list-local-disks-output ([input] (response-list-local-disks-output nil input)) ([resultWrapper2096716 input] (clojure.core/let [rawinput2096715 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096717 {"GatewayARN" (rawinput2096715 "GatewayARN"), "Disks" (rawinput2096715 "Disks")}] (clojure.core/cond-> {} (letvar2096717 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096717 ["GatewayARN"]))) (letvar2096717 "Disks") (clojure.core/assoc :disks (deser-disks (clojure.core/get-in letvar2096717 ["Disks"])))))))

(clojure.core/defn- response-create-snapshot-output ([input] (response-create-snapshot-output nil input)) ([resultWrapper2096719 input] (clojure.core/let [rawinput2096718 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096720 {"VolumeARN" (rawinput2096718 "VolumeARN"), "SnapshotId" (rawinput2096718 "SnapshotId")}] (clojure.core/cond-> {} (letvar2096720 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096720 ["VolumeARN"]))) (letvar2096720 "SnapshotId") (clojure.core/assoc :snapshot-id (deser-snapshot-id (clojure.core/get-in letvar2096720 ["SnapshotId"])))))))

(clojure.core/defn- response-describe-gateway-information-output ([input] (response-describe-gateway-information-output nil input)) ([resultWrapper2096722 input] (clojure.core/let [rawinput2096721 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096723 {"LastSoftwareUpdate" (rawinput2096721 "LastSoftwareUpdate"), "NextUpdateAvailabilityDate" (rawinput2096721 "NextUpdateAvailabilityDate"), "GatewayNetworkInterfaces" (rawinput2096721 "GatewayNetworkInterfaces"), "Tags" (rawinput2096721 "Tags"), "GatewayName" (rawinput2096721 "GatewayName"), "GatewayId" (rawinput2096721 "GatewayId"), "GatewayState" (rawinput2096721 "GatewayState"), "GatewayType" (rawinput2096721 "GatewayType"), "GatewayTimezone" (rawinput2096721 "GatewayTimezone"), "GatewayARN" (rawinput2096721 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096723 "LastSoftwareUpdate") (clojure.core/assoc :last-software-update (deser-last-software-update (clojure.core/get-in letvar2096723 ["LastSoftwareUpdate"]))) (letvar2096723 "NextUpdateAvailabilityDate") (clojure.core/assoc :next-update-availability-date (deser-next-update-availability-date (clojure.core/get-in letvar2096723 ["NextUpdateAvailabilityDate"]))) (letvar2096723 "GatewayNetworkInterfaces") (clojure.core/assoc :gateway-network-interfaces (deser-gateway-network-interfaces (clojure.core/get-in letvar2096723 ["GatewayNetworkInterfaces"]))) (letvar2096723 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2096723 ["Tags"]))) (letvar2096723 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar2096723 ["GatewayName"]))) (letvar2096723 "GatewayId") (clojure.core/assoc :gateway-id (deser-gateway-id (clojure.core/get-in letvar2096723 ["GatewayId"]))) (letvar2096723 "GatewayState") (clojure.core/assoc :gateway-state (deser-gateway-state (clojure.core/get-in letvar2096723 ["GatewayState"]))) (letvar2096723 "GatewayType") (clojure.core/assoc :gateway-type (deser-gateway-type (clojure.core/get-in letvar2096723 ["GatewayType"]))) (letvar2096723 "GatewayTimezone") (clojure.core/assoc :gateway-timezone (deser-gateway-timezone (clojure.core/get-in letvar2096723 ["GatewayTimezone"]))) (letvar2096723 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096723 ["GatewayARN"])))))))

(clojure.core/defn- response-create-smb-file-share-output ([input] (response-create-smb-file-share-output nil input)) ([resultWrapper2096725 input] (clojure.core/let [rawinput2096724 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096726 {"FileShareARN" (rawinput2096724 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096726 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096726 ["FileShareARN"])))))))

(clojure.core/defn- response-add-upload-buffer-output ([input] (response-add-upload-buffer-output nil input)) ([resultWrapper2096728 input] (clojure.core/let [rawinput2096727 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096729 {"GatewayARN" (rawinput2096727 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096729 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096729 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-storedi-scsi-volumes-output ([input] (response-describe-storedi-scsi-volumes-output nil input)) ([resultWrapper2096731 input] (clojure.core/let [rawinput2096730 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096732 {"StorediSCSIVolumes" (rawinput2096730 "StorediSCSIVolumes")}] (clojure.core/cond-> {} (letvar2096732 "StorediSCSIVolumes") (clojure.core/assoc :storedi-scsi-volumes (deser-storedi-scsi-volumes (clojure.core/get-in letvar2096732 ["StorediSCSIVolumes"])))))))

(clojure.core/defn- response-list-volumes-output ([input] (response-list-volumes-output nil input)) ([resultWrapper2096734 input] (clojure.core/let [rawinput2096733 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096735 {"GatewayARN" (rawinput2096733 "GatewayARN"), "Marker" (rawinput2096733 "Marker"), "VolumeInfos" (rawinput2096733 "VolumeInfos")}] (clojure.core/cond-> {} (letvar2096735 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096735 ["GatewayARN"]))) (letvar2096735 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096735 ["Marker"]))) (letvar2096735 "VolumeInfos") (clojure.core/assoc :volume-infos (deser-volume-infos (clojure.core/get-in letvar2096735 ["VolumeInfos"])))))))

(clojure.core/defn- response-disable-gateway-output ([input] (response-disable-gateway-output nil input)) ([resultWrapper2096737 input] (clojure.core/let [rawinput2096736 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096738 {"GatewayARN" (rawinput2096736 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096738 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096738 ["GatewayARN"])))))))

(clojure.core/defn- response-list-file-shares-output ([input] (response-list-file-shares-output nil input)) ([resultWrapper2096740 input] (clojure.core/let [rawinput2096739 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096741 {"Marker" (rawinput2096739 "Marker"), "NextMarker" (rawinput2096739 "NextMarker"), "FileShareInfoList" (rawinput2096739 "FileShareInfoList")}] (clojure.core/cond-> {} (letvar2096741 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096741 ["Marker"]))) (letvar2096741 "NextMarker") (clojure.core/assoc :next-marker (deser-marker (clojure.core/get-in letvar2096741 ["NextMarker"]))) (letvar2096741 "FileShareInfoList") (clojure.core/assoc :file-share-info-list (deser-file-share-info-list (clojure.core/get-in letvar2096741 ["FileShareInfoList"])))))))

(clojure.core/defn- response-remove-tags-from-resource-output ([input] (response-remove-tags-from-resource-output nil input)) ([resultWrapper2096743 input] (clojure.core/let [rawinput2096742 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096744 {"ResourceARN" (rawinput2096742 "ResourceARN")}] (clojure.core/cond-> {} (letvar2096744 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096744 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-snapshot-schedule-output ([input] (response-delete-snapshot-schedule-output nil input)) ([resultWrapper2096746 input] (clojure.core/let [rawinput2096745 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096747 {"VolumeARN" (rawinput2096745 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096747 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096747 ["VolumeARN"])))))))

(clojure.core/defn- response-describe-smb-settings-output ([input] (response-describe-smb-settings-output nil input)) ([resultWrapper2096749 input] (clojure.core/let [rawinput2096748 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096750 {"GatewayARN" (rawinput2096748 "GatewayARN"), "DomainName" (rawinput2096748 "DomainName"), "SMBGuestPasswordSet" (rawinput2096748 "SMBGuestPasswordSet")}] (clojure.core/cond-> {} (letvar2096750 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096750 ["GatewayARN"]))) (letvar2096750 "DomainName") (clojure.core/assoc :domain-name (deser-domain-name (clojure.core/get-in letvar2096750 ["DomainName"]))) (letvar2096750 "SMBGuestPasswordSet") (clojure.core/assoc :smb-guest-password-set (deser-boolean (clojure.core/get-in letvar2096750 ["SMBGuestPasswordSet"])))))))

(clojure.core/defn- response-delete-bandwidth-rate-limit-output ([input] (response-delete-bandwidth-rate-limit-output nil input)) ([resultWrapper2096752 input] (clojure.core/let [rawinput2096751 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096753 {"GatewayARN" (rawinput2096751 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096753 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096753 ["GatewayARN"])))))))

(clojure.core/defn- response-update-maintenance-start-time-output ([input] (response-update-maintenance-start-time-output nil input)) ([resultWrapper2096755 input] (clojure.core/let [rawinput2096754 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096756 {"GatewayARN" (rawinput2096754 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096756 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096756 ["GatewayARN"])))))))

(clojure.core/defn- response-delete-gateway-output ([input] (response-delete-gateway-output nil input)) ([resultWrapper2096758 input] (clojure.core/let [rawinput2096757 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096759 {"GatewayARN" (rawinput2096757 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096759 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096759 ["GatewayARN"])))))))

(clojure.core/defn- response-list-gateways-output ([input] (response-list-gateways-output nil input)) ([resultWrapper2096761 input] (clojure.core/let [rawinput2096760 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096762 {"Gateways" (rawinput2096760 "Gateways"), "Marker" (rawinput2096760 "Marker")}] (clojure.core/cond-> {} (letvar2096762 "Gateways") (clojure.core/assoc :gateways (deser-gateways (clojure.core/get-in letvar2096762 ["Gateways"]))) (letvar2096762 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096762 ["Marker"])))))))

(clojure.core/defn- response-update-nfs-file-share-output ([input] (response-update-nfs-file-share-output nil input)) ([resultWrapper2096764 input] (clojure.core/let [rawinput2096763 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096765 {"FileShareARN" (rawinput2096763 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096765 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096765 ["FileShareARN"])))))))

(clojure.core/defn- response-update-gateway-information-output ([input] (response-update-gateway-information-output nil input)) ([resultWrapper2096767 input] (clojure.core/let [rawinput2096766 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096768 {"GatewayARN" (rawinput2096766 "GatewayARN"), "GatewayName" (rawinput2096766 "GatewayName")}] (clojure.core/cond-> {} (letvar2096768 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096768 ["GatewayARN"]))) (letvar2096768 "GatewayName") (clojure.core/assoc :gateway-name (deserstring (clojure.core/get-in letvar2096768 ["GatewayName"])))))))

(clojure.core/defn- response-service-unavailable-error ([input] (response-service-unavailable-error nil input)) ([resultWrapper2096770 input] (clojure.core/let [rawinput2096769 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096771 {"message" (rawinput2096769 "message"), "error" (rawinput2096769 "error")}] (clojure.core/cond-> {} (letvar2096771 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096771 ["message"]))) (letvar2096771 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096771 ["error"])))))))

(clojure.core/defn- response-describe-nfs-file-shares-output ([input] (response-describe-nfs-file-shares-output nil input)) ([resultWrapper2096773 input] (clojure.core/let [rawinput2096772 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096774 {"NFSFileShareInfoList" (rawinput2096772 "NFSFileShareInfoList")}] (clojure.core/cond-> {} (letvar2096774 "NFSFileShareInfoList") (clojure.core/assoc :nfs-file-share-info-list (deser-nfs-file-share-info-list (clojure.core/get-in letvar2096774 ["NFSFileShareInfoList"])))))))

(clojure.core/defn- response-list-tags-for-resource-output ([input] (response-list-tags-for-resource-output nil input)) ([resultWrapper2096776 input] (clojure.core/let [rawinput2096775 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096777 {"ResourceARN" (rawinput2096775 "ResourceARN"), "Marker" (rawinput2096775 "Marker"), "Tags" (rawinput2096775 "Tags")}] (clojure.core/cond-> {} (letvar2096777 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096777 ["ResourceARN"]))) (letvar2096777 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096777 ["Marker"]))) (letvar2096777 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar2096777 ["Tags"])))))))

(clojure.core/defn- response-attach-volume-output ([input] (response-attach-volume-output nil input)) ([resultWrapper2096779 input] (clojure.core/let [rawinput2096778 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096780 {"VolumeARN" (rawinput2096778 "VolumeARN"), "TargetARN" (rawinput2096778 "TargetARN")}] (clojure.core/cond-> {} (letvar2096780 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096780 ["VolumeARN"]))) (letvar2096780 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096780 ["TargetARN"])))))))

(clojure.core/defn- response-reset-cache-output ([input] (response-reset-cache-output nil input)) ([resultWrapper2096782 input] (clojure.core/let [rawinput2096781 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096783 {"GatewayARN" (rawinput2096781 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096783 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096783 ["GatewayARN"])))))))

(clojure.core/defn- response-describe-snapshot-schedule-output ([input] (response-describe-snapshot-schedule-output nil input)) ([resultWrapper2096785 input] (clojure.core/let [rawinput2096784 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096786 {"VolumeARN" (rawinput2096784 "VolumeARN"), "StartAt" (rawinput2096784 "StartAt"), "RecurrenceInHours" (rawinput2096784 "RecurrenceInHours"), "Description" (rawinput2096784 "Description"), "Timezone" (rawinput2096784 "Timezone")}] (clojure.core/cond-> {} (letvar2096786 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096786 ["VolumeARN"]))) (letvar2096786 "StartAt") (clojure.core/assoc :start-at (deser-hour-of-day (clojure.core/get-in letvar2096786 ["StartAt"]))) (letvar2096786 "RecurrenceInHours") (clojure.core/assoc :recurrence-in-hours (deser-recurrence-in-hours (clojure.core/get-in letvar2096786 ["RecurrenceInHours"]))) (letvar2096786 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar2096786 ["Description"]))) (letvar2096786 "Timezone") (clojure.core/assoc :timezone (deser-gateway-timezone (clojure.core/get-in letvar2096786 ["Timezone"])))))))

(clojure.core/defn- response-retrieve-tape-archive-output ([input] (response-retrieve-tape-archive-output nil input)) ([resultWrapper2096788 input] (clojure.core/let [rawinput2096787 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096789 {"TapeARN" (rawinput2096787 "TapeARN")}] (clojure.core/cond-> {} (letvar2096789 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096789 ["TapeARN"])))))))

(clojure.core/defn- response-describe-vtl-devices-output ([input] (response-describe-vtl-devices-output nil input)) ([resultWrapper2096791 input] (clojure.core/let [rawinput2096790 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096792 {"GatewayARN" (rawinput2096790 "GatewayARN"), "VTLDevices" (rawinput2096790 "VTLDevices"), "Marker" (rawinput2096790 "Marker")}] (clojure.core/cond-> {} (letvar2096792 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096792 ["GatewayARN"]))) (letvar2096792 "VTLDevices") (clojure.core/assoc :vtl-devices (deser-vtl-devices (clojure.core/get-in letvar2096792 ["VTLDevices"]))) (letvar2096792 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096792 ["Marker"])))))))

(clojure.core/defn- response-add-tags-to-resource-output ([input] (response-add-tags-to-resource-output nil input)) ([resultWrapper2096794 input] (clojure.core/let [rawinput2096793 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096795 {"ResourceARN" (rawinput2096793 "ResourceARN")}] (clojure.core/cond-> {} (letvar2096795 "ResourceARN") (clojure.core/assoc :resource-arn (deser-resource-arn (clojure.core/get-in letvar2096795 ["ResourceARN"])))))))

(clojure.core/defn- response-delete-tape-output ([input] (response-delete-tape-output nil input)) ([resultWrapper2096797 input] (clojure.core/let [rawinput2096796 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096798 {"TapeARN" (rawinput2096796 "TapeARN")}] (clojure.core/cond-> {} (letvar2096798 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096798 ["TapeARN"])))))))

(clojure.core/defn- response-retrieve-tape-recovery-point-output ([input] (response-retrieve-tape-recovery-point-output nil input)) ([resultWrapper2096800 input] (clojure.core/let [rawinput2096799 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096801 {"TapeARN" (rawinput2096799 "TapeARN")}] (clojure.core/cond-> {} (letvar2096801 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096801 ["TapeARN"])))))))

(clojure.core/defn- response-notify-when-uploaded-output ([input] (response-notify-when-uploaded-output nil input)) ([resultWrapper2096803 input] (clojure.core/let [rawinput2096802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096804 {"FileShareARN" (rawinput2096802 "FileShareARN"), "NotificationId" (rawinput2096802 "NotificationId")}] (clojure.core/cond-> {} (letvar2096804 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096804 ["FileShareARN"]))) (letvar2096804 "NotificationId") (clojure.core/assoc :notification-id (deser-notification-id (clojure.core/get-in letvar2096804 ["NotificationId"])))))))

(clojure.core/defn- response-delete-file-share-output ([input] (response-delete-file-share-output nil input)) ([resultWrapper2096806 input] (clojure.core/let [rawinput2096805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096807 {"FileShareARN" (rawinput2096805 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096807 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096807 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-cachedi-scsi-volumes-output ([input] (response-describe-cachedi-scsi-volumes-output nil input)) ([resultWrapper2096809 input] (clojure.core/let [rawinput2096808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096810 {"CachediSCSIVolumes" (rawinput2096808 "CachediSCSIVolumes")}] (clojure.core/cond-> {} (letvar2096810 "CachediSCSIVolumes") (clojure.core/assoc :cachedi-scsi-volumes (deser-cachedi-scsi-volumes (clojure.core/get-in letvar2096810 ["CachediSCSIVolumes"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper2096812 input] (clojure.core/let [rawinput2096811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096813 {"message" (rawinput2096811 "message"), "error" (rawinput2096811 "error")}] (clojure.core/cond-> {} (letvar2096813 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096813 ["message"]))) (letvar2096813 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096813 ["error"])))))))

(clojure.core/defn- response-list-tapes-output ([input] (response-list-tapes-output nil input)) ([resultWrapper2096815 input] (clojure.core/let [rawinput2096814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096816 {"TapeInfos" (rawinput2096814 "TapeInfos"), "Marker" (rawinput2096814 "Marker")}] (clojure.core/cond-> {} (letvar2096816 "TapeInfos") (clojure.core/assoc :tape-infos (deser-tape-infos (clojure.core/get-in letvar2096816 ["TapeInfos"]))) (letvar2096816 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096816 ["Marker"])))))))

(clojure.core/defn- response-update-smb-file-share-output ([input] (response-update-smb-file-share-output nil input)) ([resultWrapper2096818 input] (clojure.core/let [rawinput2096817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096819 {"FileShareARN" (rawinput2096817 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096819 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096819 ["FileShareARN"])))))))

(clojure.core/defn- response-update-chap-credentials-output ([input] (response-update-chap-credentials-output nil input)) ([resultWrapper2096821 input] (clojure.core/let [rawinput2096820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096822 {"TargetARN" (rawinput2096820 "TargetARN"), "InitiatorName" (rawinput2096820 "InitiatorName")}] (clojure.core/cond-> {} (letvar2096822 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096822 ["TargetARN"]))) (letvar2096822 "InitiatorName") (clojure.core/assoc :initiator-name (deser-iqn-name (clojure.core/get-in letvar2096822 ["InitiatorName"])))))))

(clojure.core/defn- response-update-snapshot-schedule-output ([input] (response-update-snapshot-schedule-output nil input)) ([resultWrapper2096824 input] (clojure.core/let [rawinput2096823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096825 {"VolumeARN" (rawinput2096823 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096825 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096825 ["VolumeARN"])))))))

(clojure.core/defn- response-delete-volume-output ([input] (response-delete-volume-output nil input)) ([resultWrapper2096827 input] (clojure.core/let [rawinput2096826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096828 {"VolumeARN" (rawinput2096826 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096828 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096828 ["VolumeARN"])))))))

(clojure.core/defn- response-add-working-storage-output ([input] (response-add-working-storage-output nil input)) ([resultWrapper2096830 input] (clojure.core/let [rawinput2096829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096831 {"GatewayARN" (rawinput2096829 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096831 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096831 ["GatewayARN"])))))))

(clojure.core/defn- response-create-tape-with-barcode-output ([input] (response-create-tape-with-barcode-output nil input)) ([resultWrapper2096833 input] (clojure.core/let [rawinput2096832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096834 {"TapeARN" (rawinput2096832 "TapeARN")}] (clojure.core/cond-> {} (letvar2096834 "TapeARN") (clojure.core/assoc :tape-arn (deser-tape-arn (clojure.core/get-in letvar2096834 ["TapeARN"])))))))

(clojure.core/defn- response-invalid-gateway-request-exception ([input] (response-invalid-gateway-request-exception nil input)) ([resultWrapper2096836 input] (clojure.core/let [rawinput2096835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096837 {"message" (rawinput2096835 "message"), "error" (rawinput2096835 "error")}] (clojure.core/cond-> {} (letvar2096837 "message") (clojure.core/assoc :message (deserstring (clojure.core/get-in letvar2096837 ["message"]))) (letvar2096837 "error") (clojure.core/assoc :error (deser-storage-gateway-error (clojure.core/get-in letvar2096837 ["error"])))))))

(clojure.core/defn- response-describe-smb-file-shares-output ([input] (response-describe-smb-file-shares-output nil input)) ([resultWrapper2096839 input] (clojure.core/let [rawinput2096838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096840 {"SMBFileShareInfoList" (rawinput2096838 "SMBFileShareInfoList")}] (clojure.core/cond-> {} (letvar2096840 "SMBFileShareInfoList") (clojure.core/assoc :smb-file-share-info-list (deser-smb-file-share-info-list (clojure.core/get-in letvar2096840 ["SMBFileShareInfoList"])))))))

(clojure.core/defn- response-describe-tapes-output ([input] (response-describe-tapes-output nil input)) ([resultWrapper2096842 input] (clojure.core/let [rawinput2096841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096843 {"Tapes" (rawinput2096841 "Tapes"), "Marker" (rawinput2096841 "Marker")}] (clojure.core/cond-> {} (letvar2096843 "Tapes") (clojure.core/assoc :tapes (deser-tapes (clojure.core/get-in letvar2096843 ["Tapes"]))) (letvar2096843 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar2096843 ["Marker"])))))))

(clojure.core/defn- response-create-cachedi-scsi-volume-output ([input] (response-create-cachedi-scsi-volume-output nil input)) ([resultWrapper2096845 input] (clojure.core/let [rawinput2096844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096846 {"VolumeARN" (rawinput2096844 "VolumeARN"), "TargetARN" (rawinput2096844 "TargetARN")}] (clojure.core/cond-> {} (letvar2096846 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096846 ["VolumeARN"]))) (letvar2096846 "TargetARN") (clojure.core/assoc :target-arn (deser-target-arn (clojure.core/get-in letvar2096846 ["TargetARN"])))))))

(clojure.core/defn- response-set-local-console-password-output ([input] (response-set-local-console-password-output nil input)) ([resultWrapper2096848 input] (clojure.core/let [rawinput2096847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096849 {"GatewayARN" (rawinput2096847 "GatewayARN")}] (clojure.core/cond-> {} (letvar2096849 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096849 ["GatewayARN"])))))))

(clojure.core/defn- response-create-nfs-file-share-output ([input] (response-create-nfs-file-share-output nil input)) ([resultWrapper2096851 input] (clojure.core/let [rawinput2096850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096852 {"FileShareARN" (rawinput2096850 "FileShareARN")}] (clojure.core/cond-> {} (letvar2096852 "FileShareARN") (clojure.core/assoc :file-share-arn (deser-file-share-arn (clojure.core/get-in letvar2096852 ["FileShareARN"])))))))

(clojure.core/defn- response-describe-working-storage-output ([input] (response-describe-working-storage-output nil input)) ([resultWrapper2096854 input] (clojure.core/let [rawinput2096853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096855 {"GatewayARN" (rawinput2096853 "GatewayARN"), "DiskIds" (rawinput2096853 "DiskIds"), "WorkingStorageUsedInBytes" (rawinput2096853 "WorkingStorageUsedInBytes"), "WorkingStorageAllocatedInBytes" (rawinput2096853 "WorkingStorageAllocatedInBytes")}] (clojure.core/cond-> {} (letvar2096855 "GatewayARN") (clojure.core/assoc :gateway-arn (deser-gateway-arn (clojure.core/get-in letvar2096855 ["GatewayARN"]))) (letvar2096855 "DiskIds") (clojure.core/assoc :disk-ids (deser-disk-ids (clojure.core/get-in letvar2096855 ["DiskIds"]))) (letvar2096855 "WorkingStorageUsedInBytes") (clojure.core/assoc :working-storage-used-in-bytes (deserlong (clojure.core/get-in letvar2096855 ["WorkingStorageUsedInBytes"]))) (letvar2096855 "WorkingStorageAllocatedInBytes") (clojure.core/assoc :working-storage-allocated-in-bytes (deserlong (clojure.core/get-in letvar2096855 ["WorkingStorageAllocatedInBytes"])))))))

(clojure.core/defn- response-detach-volume-output ([input] (response-detach-volume-output nil input)) ([resultWrapper2096857 input] (clojure.core/let [rawinput2096856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2096858 {"VolumeARN" (rawinput2096856 "VolumeARN")}] (clojure.core/cond-> {} (letvar2096858 "VolumeARN") (clojure.core/assoc :volume-arn (deser-volume-arn (clojure.core/get-in letvar2096858 ["VolumeARN"])))))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/disk-allocation-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/notification-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/last-software-update (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/bandwidth-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/volume-attachment-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/location-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 16 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 310))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/next-update-availability-date (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/folder (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/file-share-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/marker (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1000))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/network-interface-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\A(25[0-5]|2[0-4]\d|[0-1]?\d?\d)(\.(25[0-5]|2[0-4]\d|[0-1]?\d?\d)){3}\z" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/target-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 800))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/disk-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 300))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/medium-changer-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/permission-mode (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[0-7]{4}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/snapshot-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/kms-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 7 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/tape-status (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.storagegateway/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 20 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/activation-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[ -\.0-\[\]-~]*[!-\.0-\[\]-~][ -\.0-\[\]-~]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/volume-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/ipv-4-address-cidr (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([0-9]|[1-2][0-9]|3[0-2]))?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/device-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/tape-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:(aws|aws-cn|aws-us-gov):storagegateway:[a-z\-0-9]+:[0-9]+:tape\/[0-9A-Z]{7,16}$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/file-share-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-operational-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/iqn-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[0-9a-z:.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/tape-drive-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/tape-barcode (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 7 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 16)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[A-Z0-9]*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/chap-secret (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/volume-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/volume-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/authentication (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/region-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/target-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 200)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[-\.;a-z0-9]+$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/local-console-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 12 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 30))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/vtl-device-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 25))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 2 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/storage-class (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 20))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/file-share-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-timezone (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/file-share-user (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/domain-user-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/initiator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/volume-status (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 50))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/organizational-unit (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/gateway-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 50 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/smb-guest-password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 6 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^[ -~]+$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/host (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(([a-zA-Z0-9\-]*[a-zA-Z0-9])\.)*([A-Za-z0-9\-]*[A-Za-z0-9])(:(\d+))?$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/disk-attribute (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 64))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/domain-user-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1024)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\w[\w\.\- ]*$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.storagegateway/snapshot-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\Asnap-([0-9A-Fa-f]{8}|[0-9A-Fa-f]{17})\z" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.storagegateway/squash (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 5 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 15))))
