...
(clojure.core/defn- response-client-exception ([input] (response-client-exception nil input)) ([resultWrapper133973 input] (clojure.core/let [rawinput133972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133974 {"clusterName" (rawinput133972 "clusterName"), "message" (rawinput133972 "message")}] (clojure.core/cond-> {} (letvar133974 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar133974 ["clusterName"]))) (letvar133974 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar133974 ["message"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper133976 input] (clojure.core/let [rawinput133975 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133977 {"clusterName" (rawinput133975 "clusterName"), "message" (rawinput133975 "message")}] (clojure.core/cond-> {} (letvar133977 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar133977 ["clusterName"]))) (letvar133977 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar133977 ["message"])))))))

(clojure.core/defn- response-list-clusters-response ([input] (response-list-clusters-response nil input)) ([resultWrapper133979 input] (clojure.core/let [rawinput133978 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133980 {"clusters" (rawinput133978 "clusters"), "nextToken" (rawinput133978 "nextToken")}] (clojure.core/cond-> {} (letvar133980 "clusters") (clojure.core/assoc :clusters (deser-string-list (clojure.core/get-in letvar133980 ["clusters"]))) (letvar133980 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar133980 ["nextToken"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper133982 input] (clojure.core/let [rawinput133981 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133983 {"clusterName" (rawinput133981 "clusterName"), "message" (rawinput133981 "message")}] (clojure.core/cond-> {} (letvar133983 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar133983 ["clusterName"]))) (letvar133983 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar133983 ["message"])))))))

(clojure.core/defn- response-describe-cluster-response ([input] (response-describe-cluster-response nil input)) ([resultWrapper133985 input] (clojure.core/let [rawinput133984 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133986 {"cluster" (rawinput133984 "cluster")}] (clojure.core/cond-> {} (letvar133986 "cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar133986 ["cluster"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper133988 input] (clojure.core/let [rawinput133987 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133989 {"message" (rawinput133987 "message")}] (clojure.core/cond-> {} (letvar133989 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar133989 ["message"])))))))

(clojure.core/defn- response-delete-cluster-response ([input] (response-delete-cluster-response nil input)) ([resultWrapper133991 input] (clojure.core/let [rawinput133990 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133992 {"cluster" (rawinput133990 "cluster")}] (clojure.core/cond-> {} (letvar133992 "cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar133992 ["cluster"])))))))

(clojure.core/defn- response-create-cluster-response ([input] (response-create-cluster-response nil input)) ([resultWrapper133994 input] (clojure.core/let [rawinput133993 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133995 {"cluster" (rawinput133993 "cluster")}] (clojure.core/cond-> {} (letvar133995 "cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar133995 ["cluster"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper133997 input] (clojure.core/let [rawinput133996 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar133998 {"clusterName" (rawinput133996 "clusterName"), "message" (rawinput133996 "message")}] (clojure.core/cond-> {} (letvar133998 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar133998 ["clusterName"]))) (letvar133998 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar133998 ["message"])))))))

(clojure.core/defn- response-unsupported-availability-zone-exception ([input] (response-unsupported-availability-zone-exception nil input)) ([resultWrapper134000 input] (clojure.core/let [rawinput133999 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134001 {"message" (rawinput133999 "message"), "clusterName" (rawinput133999 "clusterName"), "validZones" (rawinput133999 "validZones")}] (clojure.core/cond-> {} (letvar134001 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar134001 ["message"]))) (letvar134001 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar134001 ["clusterName"]))) (letvar134001 "validZones") (clojure.core/assoc :valid-zones (deser-string-list (clojure.core/get-in letvar134001 ["validZones"])))))))

(clojure.core/defn- response-list-updates-response ([input] (response-list-updates-response nil input)) ([resultWrapper134003 input] (clojure.core/let [rawinput134002 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134004 {"updateIds" (rawinput134002 "updateIds"), "nextToken" (rawinput134002 "nextToken")}] (clojure.core/cond-> {} (letvar134004 "updateIds") (clojure.core/assoc :update-ids (deser-string-list (clojure.core/get-in letvar134004 ["updateIds"]))) (letvar134004 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar134004 ["nextToken"])))))))

(clojure.core/defn- response-server-exception ([input] (response-server-exception nil input)) ([resultWrapper134006 input] (clojure.core/let [rawinput134005 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134007 {"clusterName" (rawinput134005 "clusterName"), "message" (rawinput134005 "message")}] (clojure.core/cond-> {} (letvar134007 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar134007 ["clusterName"]))) (letvar134007 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar134007 ["message"])))))))

(clojure.core/defn- response-resource-limit-exceeded-exception ([input] (response-resource-limit-exceeded-exception nil input)) ([resultWrapper134009 input] (clojure.core/let [rawinput134008 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134010 {"clusterName" (rawinput134008 "clusterName"), "message" (rawinput134008 "message")}] (clojure.core/cond-> {} (letvar134010 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar134010 ["clusterName"]))) (letvar134010 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar134010 ["message"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper134012 input] (clojure.core/let [rawinput134011 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134013 {"clusterName" (rawinput134011 "clusterName"), "message" (rawinput134011 "message")}] (clojure.core/cond-> {} (letvar134013 "clusterName") (clojure.core/assoc :cluster-name (deser-string (clojure.core/get-in letvar134013 ["clusterName"]))) (letvar134013 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar134013 ["message"])))))))

(clojure.core/defn- response-describe-update-response ([input] (response-describe-update-response nil input)) ([resultWrapper134015 input] (clojure.core/let [rawinput134014 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134016 {"update" (rawinput134014 "update")}] (clojure.core/cond-> {} (letvar134016 "update") (clojure.core/assoc :update (deser-update (clojure.core/get-in letvar134016 ["update"])))))))

(clojure.core/defn- response-update-cluster-version-response ([input] (response-update-cluster-version-response nil input)) ([resultWrapper134018 input] (clojure.core/let [rawinput134017 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar134019 {"update" (rawinput134017 "update")}] (clojure.core/cond-> {} (letvar134019 "update") (clojure.core/assoc :update (deser-update (clojure.core/get-in letvar134019 ["update"])))))))
...
(clojure.spec.alpha/def :portkey.aws.eks/cluster-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21110__auto__] (clojure.core/<= 1 (clojure.core/count s__21110__auto__))) (clojure.core/fn [s__21111__auto__] (clojure.core/< (clojure.core/count s__21111__auto__) 100)) (clojure.core/fn [s__21112__auto__] (clojure.core/re-matches #"^[0-9A-Za-z][A-Za-z0-9\-_]*" s__21112__auto__))))
