...
(clojure.core/defn- response-put-configuration-set-delivery-options-response ([input] (response-put-configuration-set-delivery-options-response nil input)) ([resultWrapper428510 input] (clojure.core/let [rawinput428509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428511 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-dedicated-ip-pools-response ([input] (response-list-dedicated-ip-pools-response nil input)) ([resultWrapper428513 input] (clojure.core/let [rawinput428512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428514 {"DedicatedIpPools" (rawinput428512 "DedicatedIpPools"), "NextToken" (rawinput428512 "NextToken")}] (clojure.core/cond-> {} (letvar428514 "DedicatedIpPools") (clojure.core/assoc :dedicated-ip-pools (deser-list-of-dedicated-ip-pools (clojure.core/get-in letvar428514 ["DedicatedIpPools"]))) (letvar428514 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar428514 ["NextToken"])))))))

(clojure.core/defn- response-list-deliverability-test-reports-response ([input] (response-list-deliverability-test-reports-response nil input)) ([resultWrapper428516 input] (clojure.core/let [rawinput428515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428517 {"DeliverabilityTestReports" (rawinput428515 "DeliverabilityTestReports"), "NextToken" (rawinput428515 "NextToken")}] (clojure.core/cond-> {:deliverability-test-reports (deser-deliverability-test-reports (clojure.core/get-in letvar428517 ["DeliverabilityTestReports"]))} (letvar428517 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar428517 ["NextToken"])))))))

(clojure.core/defn- response-delete-dedicated-ip-pool-response ([input] (response-delete-dedicated-ip-pool-response nil input)) ([resultWrapper428519 input] (clojure.core/let [rawinput428518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428520 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper428522 input] (clojure.core/let [rawinput428521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428523 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-reputation-options-response ([input] (response-put-configuration-set-reputation-options-response nil input)) ([resultWrapper428525 input] (clojure.core/let [rawinput428524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428526 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper428528 input] (clojure.core/let [rawinput428527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428529 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-email-identity-response ([input] (response-get-email-identity-response nil input)) ([resultWrapper428531 input] (clojure.core/let [rawinput428530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428532 {"IdentityType" (rawinput428530 "IdentityType"), "FeedbackForwardingStatus" (rawinput428530 "FeedbackForwardingStatus"), "VerifiedForSendingStatus" (rawinput428530 "VerifiedForSendingStatus"), "DkimAttributes" (rawinput428530 "DkimAttributes"), "MailFromAttributes" (rawinput428530 "MailFromAttributes")}] (clojure.core/cond-> {} (letvar428532 "IdentityType") (clojure.core/assoc :identity-type (deser-identity-type (clojure.core/get-in letvar428532 ["IdentityType"]))) (letvar428532 "FeedbackForwardingStatus") (clojure.core/assoc :feedback-forwarding-status (deser-enabled (clojure.core/get-in letvar428532 ["FeedbackForwardingStatus"]))) (letvar428532 "VerifiedForSendingStatus") (clojure.core/assoc :verified-for-sending-status (deser-enabled (clojure.core/get-in letvar428532 ["VerifiedForSendingStatus"]))) (letvar428532 "DkimAttributes") (clojure.core/assoc :dkim-attributes (deser-dkim-attributes (clojure.core/get-in letvar428532 ["DkimAttributes"]))) (letvar428532 "MailFromAttributes") (clojure.core/assoc :mail-from-attributes (deser-mail-from-attributes (clojure.core/get-in letvar428532 ["MailFromAttributes"])))))))

(clojure.core/defn- response-get-domain-statistics-report-response ([input] (response-get-domain-statistics-report-response nil input)) ([resultWrapper428534 input] (clojure.core/let [rawinput428533 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428535 {"OverallVolume" (rawinput428533 "OverallVolume"), "DailyVolumes" (rawinput428533 "DailyVolumes")}] (clojure.core/cond-> {:overall-volume (deser-overall-volume (clojure.core/get-in letvar428535 ["OverallVolume"])), :daily-volumes (deser-daily-volumes (clojure.core/get-in letvar428535 ["DailyVolumes"]))}))))

(clojure.core/defn- response-mail-from-domain-not-verified-exception ([input] (response-mail-from-domain-not-verified-exception nil input)) ([resultWrapper428537 input] (clojure.core/let [rawinput428536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428538 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper428540 input] (clojure.core/let [rawinput428539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428541 {"EventDestinations" (rawinput428539 "EventDestinations")}] (clojure.core/cond-> {} (letvar428541 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar428541 ["EventDestinations"])))))))

(clojure.core/defn- response-get-account-response ([input] (response-get-account-response nil input)) ([resultWrapper428543 input] (clojure.core/let [rawinput428542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428544 {"SendQuota" (rawinput428542 "SendQuota"), "SendingEnabled" (rawinput428542 "SendingEnabled"), "DedicatedIpAutoWarmupEnabled" (rawinput428542 "DedicatedIpAutoWarmupEnabled"), "EnforcementStatus" (rawinput428542 "EnforcementStatus"), "ProductionAccessEnabled" (rawinput428542 "ProductionAccessEnabled")}] (clojure.core/cond-> {} (letvar428544 "SendQuota") (clojure.core/assoc :send-quota (deser-send-quota (clojure.core/get-in letvar428544 ["SendQuota"]))) (letvar428544 "SendingEnabled") (clojure.core/assoc :sending-enabled (deser-enabled (clojure.core/get-in letvar428544 ["SendingEnabled"]))) (letvar428544 "DedicatedIpAutoWarmupEnabled") (clojure.core/assoc :dedicated-ip-auto-warmup-enabled (deser-enabled (clojure.core/get-in letvar428544 ["DedicatedIpAutoWarmupEnabled"]))) (letvar428544 "EnforcementStatus") (clojure.core/assoc :enforcement-status (deser-general-enforcement-status (clojure.core/get-in letvar428544 ["EnforcementStatus"]))) (letvar428544 "ProductionAccessEnabled") (clojure.core/assoc :production-access-enabled (deser-enabled (clojure.core/get-in letvar428544 ["ProductionAccessEnabled"])))))))

(clojure.core/defn- response-put-email-identity-dkim-attributes-response ([input] (response-put-email-identity-dkim-attributes-response nil input)) ([resultWrapper428546 input] (clojure.core/let [rawinput428545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428547 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-tracking-options-response ([input] (response-put-configuration-set-tracking-options-response nil input)) ([resultWrapper428549 input] (clojure.core/let [rawinput428548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428550 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-sending-options-response ([input] (response-put-configuration-set-sending-options-response nil input)) ([resultWrapper428552 input] (clojure.core/let [rawinput428551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428553 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-account-dedicated-ip-warmup-attributes-response ([input] (response-put-account-dedicated-ip-warmup-attributes-response nil input)) ([resultWrapper428555 input] (clojure.core/let [rawinput428554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428556 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper428558 input] (clojure.core/let [rawinput428557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428559 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-email-identities-response ([input] (response-list-email-identities-response nil input)) ([resultWrapper428561 input] (clojure.core/let [rawinput428560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428562 {"EmailIdentities" (rawinput428560 "EmailIdentities"), "NextToken" (rawinput428560 "NextToken")}] (clojure.core/cond-> {} (letvar428562 "EmailIdentities") (clojure.core/assoc :email-identities (deser-identity-info-list (clojure.core/get-in letvar428562 ["EmailIdentities"]))) (letvar428562 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar428562 ["NextToken"])))))))

(clojure.core/defn- response-send-email-response ([input] (response-send-email-response nil input)) ([resultWrapper428564 input] (clojure.core/let [rawinput428563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428565 {"MessageId" (rawinput428563 "MessageId")}] (clojure.core/cond-> {} (letvar428565 "MessageId") (clojure.core/assoc :message-id (deser-outbound-message-id (clojure.core/get-in letvar428565 ["MessageId"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper428567 input] (clojure.core/let [rawinput428566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428568 {"ConfigurationSets" (rawinput428566 "ConfigurationSets"), "NextToken" (rawinput428566 "NextToken")}] (clojure.core/cond-> {} (letvar428568 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-set-name-list (clojure.core/get-in letvar428568 ["ConfigurationSets"]))) (letvar428568 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar428568 ["NextToken"])))))))

(clojure.core/defn- response-create-dedicated-ip-pool-response ([input] (response-create-dedicated-ip-pool-response nil input)) ([resultWrapper428570 input] (clojure.core/let [rawinput428569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428571 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper428573 input] (clojure.core/let [rawinput428572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428574 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper428576 input] (clojure.core/let [rawinput428575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428577 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-message-rejected ([input] (response-message-rejected nil input)) ([resultWrapper428579 input] (clojure.core/let [rawinput428578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428580 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-account-sending-attributes-response ([input] (response-put-account-sending-attributes-response nil input)) ([resultWrapper428582 input] (clojure.core/let [rawinput428581 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428583 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-email-identity-feedback-attributes-response ([input] (response-put-email-identity-feedback-attributes-response nil input)) ([resultWrapper428585 input] (clojure.core/let [rawinput428584 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428586 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper428588 input] (clojure.core/let [rawinput428587 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428589 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper428591 input] (clojure.core/let [rawinput428590 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428592 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-dedicated-ip-in-pool-response ([input] (response-put-dedicated-ip-in-pool-response nil input)) ([resultWrapper428594 input] (clojure.core/let [rawinput428593 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428595 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper428597 input] (clojure.core/let [rawinput428596 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428598 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-dedicated-ip-response ([input] (response-get-dedicated-ip-response nil input)) ([resultWrapper428600 input] (clojure.core/let [rawinput428599 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428601 {"DedicatedIp" (rawinput428599 "DedicatedIp")}] (clojure.core/cond-> {} (letvar428601 "DedicatedIp") (clojure.core/assoc :dedicated-ip (deser-dedicated-ip (clojure.core/get-in letvar428601 ["DedicatedIp"])))))))

(clojure.core/defn- response-create-deliverability-test-report-response ([input] (response-create-deliverability-test-report-response nil input)) ([resultWrapper428603 input] (clojure.core/let [rawinput428602 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428604 {"ReportId" (rawinput428602 "ReportId"), "DeliverabilityTestStatus" (rawinput428602 "DeliverabilityTestStatus")}] (clojure.core/cond-> {:report-id (deser-report-id (clojure.core/get-in letvar428604 ["ReportId"])), :deliverability-test-status (deser-deliverability-test-status (clojure.core/get-in letvar428604 ["DeliverabilityTestStatus"]))}))))

(clojure.core/defn- response-account-suspended-exception ([input] (response-account-suspended-exception nil input)) ([resultWrapper428606 input] (clojure.core/let [rawinput428605 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428607 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-email-identity-response ([input] (response-delete-email-identity-response nil input)) ([resultWrapper428609 input] (clojure.core/let [rawinput428608 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428610 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper428612 input] (clojure.core/let [rawinput428611 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428613 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-deliverability-dashboard-option-response ([input] (response-put-deliverability-dashboard-option-response nil input)) ([resultWrapper428615 input] (clojure.core/let [rawinput428614 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428616 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-configuration-set-response ([input] (response-get-configuration-set-response nil input)) ([resultWrapper428618 input] (clojure.core/let [rawinput428617 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428619 {"ConfigurationSetName" (rawinput428617 "ConfigurationSetName"), "TrackingOptions" (rawinput428617 "TrackingOptions"), "DeliveryOptions" (rawinput428617 "DeliveryOptions"), "ReputationOptions" (rawinput428617 "ReputationOptions"), "SendingOptions" (rawinput428617 "SendingOptions")}] (clojure.core/cond-> {} (letvar428619 "ConfigurationSetName") (clojure.core/assoc :configuration-set-name (deser-configuration-set-name (clojure.core/get-in letvar428619 ["ConfigurationSetName"]))) (letvar428619 "TrackingOptions") (clojure.core/assoc :tracking-options (deser-tracking-options (clojure.core/get-in letvar428619 ["TrackingOptions"]))) (letvar428619 "DeliveryOptions") (clojure.core/assoc :delivery-options (deser-delivery-options (clojure.core/get-in letvar428619 ["DeliveryOptions"]))) (letvar428619 "ReputationOptions") (clojure.core/assoc :reputation-options (deser-reputation-options (clojure.core/get-in letvar428619 ["ReputationOptions"]))) (letvar428619 "SendingOptions") (clojure.core/assoc :sending-options (deser-sending-options (clojure.core/get-in letvar428619 ["SendingOptions"])))))))

(clojure.core/defn- response-put-dedicated-ip-warmup-attributes-response ([input] (response-put-dedicated-ip-warmup-attributes-response nil input)) ([resultWrapper428621 input] (clojure.core/let [rawinput428620 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428622 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-dedicated-ips-response ([input] (response-get-dedicated-ips-response nil input)) ([resultWrapper428624 input] (clojure.core/let [rawinput428623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428625 {"DedicatedIps" (rawinput428623 "DedicatedIps"), "NextToken" (rawinput428623 "NextToken")}] (clojure.core/cond-> {} (letvar428625 "DedicatedIps") (clojure.core/assoc :dedicated-ips (deser-dedicated-ip-list (clojure.core/get-in letvar428625 ["DedicatedIps"]))) (letvar428625 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar428625 ["NextToken"])))))))

(clojure.core/defn- response-put-email-identity-mail-from-attributes-response ([input] (response-put-email-identity-mail-from-attributes-response nil input)) ([resultWrapper428627 input] (clojure.core/let [rawinput428626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428628 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-sending-paused-exception ([input] (response-sending-paused-exception nil input)) ([resultWrapper428630 input] (clojure.core/let [rawinput428629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428631 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper428633 input] (clojure.core/let [rawinput428632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428634 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-deliverability-test-report-response ([input] (response-get-deliverability-test-report-response nil input)) ([resultWrapper428636 input] (clojure.core/let [rawinput428635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428637 {"DeliverabilityTestReport" (rawinput428635 "DeliverabilityTestReport"), "OverallPlacement" (rawinput428635 "OverallPlacement"), "IspPlacements" (rawinput428635 "IspPlacements"), "Message" (rawinput428635 "Message")}] (clojure.core/cond-> {:deliverability-test-report (deser-deliverability-test-report (clojure.core/get-in letvar428637 ["DeliverabilityTestReport"])), :overall-placement (deser-placement-statistics (clojure.core/get-in letvar428637 ["OverallPlacement"])), :isp-placements (deser-isp-placements (clojure.core/get-in letvar428637 ["IspPlacements"]))} (letvar428637 "Message") (clojure.core/assoc :message (deser-message-content (clojure.core/get-in letvar428637 ["Message"])))))))

(clojure.core/defn- response-create-email-identity-response ([input] (response-create-email-identity-response nil input)) ([resultWrapper428639 input] (clojure.core/let [rawinput428638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428640 {"IdentityType" (rawinput428638 "IdentityType"), "VerifiedForSendingStatus" (rawinput428638 "VerifiedForSendingStatus"), "DkimAttributes" (rawinput428638 "DkimAttributes")}] (clojure.core/cond-> {} (letvar428640 "IdentityType") (clojure.core/assoc :identity-type (deser-identity-type (clojure.core/get-in letvar428640 ["IdentityType"]))) (letvar428640 "VerifiedForSendingStatus") (clojure.core/assoc :verified-for-sending-status (deser-enabled (clojure.core/get-in letvar428640 ["VerifiedForSendingStatus"]))) (letvar428640 "DkimAttributes") (clojure.core/assoc :dkim-attributes (deser-dkim-attributes (clojure.core/get-in letvar428640 ["DkimAttributes"])))))))

(clojure.core/defn- response-get-deliverability-dashboard-options-response ([input] (response-get-deliverability-dashboard-options-response nil input)) ([resultWrapper428642 input] (clojure.core/let [rawinput428641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428643 {"DashboardEnabled" (rawinput428641 "DashboardEnabled")}] (clojure.core/cond-> {:dashboard-enabled (deser-enabled (clojure.core/get-in letvar428643 ["DashboardEnabled"]))}))))

(clojure.core/defn- response-get-blacklist-reports-response ([input] (response-get-blacklist-reports-response nil input)) ([resultWrapper428645 input] (clojure.core/let [rawinput428644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar428646 {"BlacklistReport" (rawinput428644 "BlacklistReport")}] (clojure.core/cond-> {:blacklist-report (deser-blacklist-report (clojure.core/get-in letvar428646 ["BlacklistReport"]))}))))
