...
(clojure.core/defn- response-list-signing-platforms-response ([input] (response-list-signing-platforms-response nil input)) ([resultWrapper1735402 input] (clojure.core/let [rawinput1735401 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735403 {"platforms" (rawinput1735401 "platforms"), "nextToken" (rawinput1735401 "nextToken")}] (clojure.core/cond-> {} (letvar1735403 "platforms") (clojure.core/assoc :platforms (deser-signing-platforms (clojure.core/get-in letvar1735403 ["platforms"]))) (letvar1735403 "nextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1735403 ["nextToken"])))))))

(clojure.core/defn- response-put-signing-profile-response ([input] (response-put-signing-profile-response nil input)) ([resultWrapper1735405 input] (clojure.core/let [rawinput1735404 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735406 {"arn" (rawinput1735404 "arn")}] (clojure.core/cond-> {} (letvar1735406 "arn") (clojure.core/assoc :arn (deserstring (clojure.core/get-in letvar1735406 ["arn"])))))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1735408 input] (clojure.core/let [rawinput1735407 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735409 {"message" (rawinput1735407 "message")}] (clojure.core/cond-> {} (letvar1735409 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1735409 ["message"])))))))

(clojure.core/defn- response-internal-service-error-exception ([input] (response-internal-service-error-exception nil input)) ([resultWrapper1735411 input] (clojure.core/let [rawinput1735410 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735412 {"message" (rawinput1735410 "message")}] (clojure.core/cond-> {} (letvar1735412 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1735412 ["message"])))))))

(clojure.core/defn- response-start-signing-job-response ([input] (response-start-signing-job-response nil input)) ([resultWrapper1735414 input] (clojure.core/let [rawinput1735413 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735415 {"jobId" (rawinput1735413 "jobId")}] (clojure.core/cond-> {} (letvar1735415 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1735415 ["jobId"])))))))

(clojure.core/defn- response-get-signing-profile-response ([input] (response-get-signing-profile-response nil input)) ([resultWrapper1735417 input] (clojure.core/let [rawinput1735416 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735418 {"profileName" (rawinput1735416 "profileName"), "signingMaterial" (rawinput1735416 "signingMaterial"), "platformId" (rawinput1735416 "platformId"), "overrides" (rawinput1735416 "overrides"), "signingParameters" (rawinput1735416 "signingParameters"), "status" (rawinput1735416 "status")}] (clojure.core/cond-> {} (letvar1735418 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar1735418 ["profileName"]))) (letvar1735418 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar1735418 ["signingMaterial"]))) (letvar1735418 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1735418 ["platformId"]))) (letvar1735418 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar1735418 ["overrides"]))) (letvar1735418 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar1735418 ["signingParameters"]))) (letvar1735418 "status") (clojure.core/assoc :status (deser-signing-profile-status (clojure.core/get-in letvar1735418 ["status"])))))))

(clojure.core/defn- response-list-signing-profiles-response ([input] (response-list-signing-profiles-response nil input)) ([resultWrapper1735420 input] (clojure.core/let [rawinput1735419 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735421 {"profiles" (rawinput1735419 "profiles"), "nextToken" (rawinput1735419 "nextToken")}] (clojure.core/cond-> {} (letvar1735421 "profiles") (clojure.core/assoc :profiles (deser-signing-profiles (clojure.core/get-in letvar1735421 ["profiles"]))) (letvar1735421 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1735421 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1735423 input] (clojure.core/let [rawinput1735422 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735424 {"message" (rawinput1735422 "message")}] (clojure.core/cond-> {} (letvar1735424 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1735424 ["message"])))))))

(clojure.core/defn- response-get-signing-platform-response ([input] (response-get-signing-platform-response nil input)) ([resultWrapper1735426 input] (clojure.core/let [rawinput1735425 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735427 {"platformId" (rawinput1735425 "platformId"), "displayName" (rawinput1735425 "displayName"), "partner" (rawinput1735425 "partner"), "target" (rawinput1735425 "target"), "category" (rawinput1735425 "category"), "signingConfiguration" (rawinput1735425 "signingConfiguration"), "signingImageFormat" (rawinput1735425 "signingImageFormat"), "maxSizeInMB" (rawinput1735425 "maxSizeInMB")}] (clojure.core/cond-> {} (letvar1735427 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1735427 ["platformId"]))) (letvar1735427 "displayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar1735427 ["displayName"]))) (letvar1735427 "partner") (clojure.core/assoc :partner (deser-string (clojure.core/get-in letvar1735427 ["partner"]))) (letvar1735427 "target") (clojure.core/assoc :target (deser-string (clojure.core/get-in letvar1735427 ["target"]))) (letvar1735427 "category") (clojure.core/assoc :category (deser-category (clojure.core/get-in letvar1735427 ["category"]))) (letvar1735427 "signingConfiguration") (clojure.core/assoc :signing-configuration (deser-signing-configuration (clojure.core/get-in letvar1735427 ["signingConfiguration"]))) (letvar1735427 "signingImageFormat") (clojure.core/assoc :signing-image-format (deser-signing-image-format (clojure.core/get-in letvar1735427 ["signingImageFormat"]))) (letvar1735427 "maxSizeInMB") (clojure.core/assoc :max-size-in-mb (deser-max-size-in-mb (clojure.core/get-in letvar1735427 ["maxSizeInMB"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper1735429 input] (clojure.core/let [rawinput1735428 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735430 {"message" (rawinput1735428 "message")}] (clojure.core/cond-> {} (letvar1735430 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1735430 ["message"])))))))

(clojure.core/defn- response-describe-signing-job-response ([input] (response-describe-signing-job-response nil input)) ([resultWrapper1735432 input] (clojure.core/let [rawinput1735431 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735433 {"overrides" (rawinput1735431 "overrides"), "signingParameters" (rawinput1735431 "signingParameters"), "createdAt" (rawinput1735431 "createdAt"), "completedAt" (rawinput1735431 "completedAt"), "signingMaterial" (rawinput1735431 "signingMaterial"), "status" (rawinput1735431 "status"), "requestedBy" (rawinput1735431 "requestedBy"), "source" (rawinput1735431 "source"), "signedObject" (rawinput1735431 "signedObject"), "profileName" (rawinput1735431 "profileName"), "statusReason" (rawinput1735431 "statusReason"), "platformId" (rawinput1735431 "platformId"), "jobId" (rawinput1735431 "jobId")}] (clojure.core/cond-> {} (letvar1735433 "overrides") (clojure.core/assoc :overrides (deser-signing-platform-overrides (clojure.core/get-in letvar1735433 ["overrides"]))) (letvar1735433 "signingParameters") (clojure.core/assoc :signing-parameters (deser-signing-parameters (clojure.core/get-in letvar1735433 ["signingParameters"]))) (letvar1735433 "createdAt") (clojure.core/assoc :created-at (deser-created-at (clojure.core/get-in letvar1735433 ["createdAt"]))) (letvar1735433 "completedAt") (clojure.core/assoc :completed-at (deser-completed-at (clojure.core/get-in letvar1735433 ["completedAt"]))) (letvar1735433 "signingMaterial") (clojure.core/assoc :signing-material (deser-signing-material (clojure.core/get-in letvar1735433 ["signingMaterial"]))) (letvar1735433 "status") (clojure.core/assoc :status (deser-signing-status (clojure.core/get-in letvar1735433 ["status"]))) (letvar1735433 "requestedBy") (clojure.core/assoc :requested-by (deser-requested-by (clojure.core/get-in letvar1735433 ["requestedBy"]))) (letvar1735433 "source") (clojure.core/assoc :source (deser-source (clojure.core/get-in letvar1735433 ["source"]))) (letvar1735433 "signedObject") (clojure.core/assoc :signed-object (deser-signed-object (clojure.core/get-in letvar1735433 ["signedObject"]))) (letvar1735433 "profileName") (clojure.core/assoc :profile-name (deser-profile-name (clojure.core/get-in letvar1735433 ["profileName"]))) (letvar1735433 "statusReason") (clojure.core/assoc :status-reason (deser-status-reason (clojure.core/get-in letvar1735433 ["statusReason"]))) (letvar1735433 "platformId") (clojure.core/assoc :platform-id (deser-platform-id (clojure.core/get-in letvar1735433 ["platformId"]))) (letvar1735433 "jobId") (clojure.core/assoc :job-id (deser-job-id (clojure.core/get-in letvar1735433 ["jobId"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1735435 input] (clojure.core/let [rawinput1735434 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735436 {"message" (rawinput1735434 "message")}] (clojure.core/cond-> {} (letvar1735436 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1735436 ["message"])))))))

(clojure.core/defn- response-list-signing-jobs-response ([input] (response-list-signing-jobs-response nil input)) ([resultWrapper1735438 input] (clojure.core/let [rawinput1735437 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1735439 {"jobs" (rawinput1735437 "jobs"), "nextToken" (rawinput1735437 "nextToken")}] (clojure.core/cond-> {} (letvar1735439 "jobs") (clojure.core/assoc :jobs (deser-signing-jobs (clojure.core/get-in letvar1735439 ["jobs"]))) (letvar1735439 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1735439 ["nextToken"])))))))
