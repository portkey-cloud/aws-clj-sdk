...
(clojure.core/defn- response-tags-per-resource-exceeded-limit-exception ([input] (response-tags-per-resource-exceeded-limit-exception nil input)) ([resultWrapper1206079 input] (clojure.core/let [rawinput1206078 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206080 {"Message" (rawinput1206078 "Message")}] (clojure.core/cond-> {} (letvar1206080 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206080 ["Message"])))))))

(clojure.core/defn- response-version-mismatch-exception ([input] (response-version-mismatch-exception nil input)) ([resultWrapper1206082 input] (clojure.core/let [rawinput1206081 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206083 {"Message" (rawinput1206081 "Message")}] (clojure.core/cond-> {} (letvar1206083 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206083 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1206085 input] (clojure.core/let [rawinput1206084 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206086 {"NextToken" (rawinput1206084 "NextToken"), "Tags" (rawinput1206084 "Tags")}] (clojure.core/cond-> {} (letvar1206086 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1206086 ["NextToken"]))) (letvar1206086 "Tags") (clojure.core/assoc :tags (deser-resource-tags (clojure.core/get-in letvar1206086 ["Tags"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1206088 input] (clojure.core/let [rawinput1206087 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206089 {"Message" (rawinput1206087 "Message")}] (clojure.core/cond-> {} (letvar1206089 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206089 ["Message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1206091 input] (clojure.core/let [rawinput1206090 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206092 {"StreamInfo" (rawinput1206090 "StreamInfo")}] (clojure.core/cond-> {} (letvar1206092 "StreamInfo") (clojure.core/assoc :stream-info (deser-stream-info (clojure.core/get-in letvar1206092 ["StreamInfo"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1206094 input] (clojure.core/let [rawinput1206093 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206095 {"Message" (rawinput1206093 "Message")}] (clojure.core/cond-> {} (letvar1206095 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206095 ["Message"])))))))

(clojure.core/defn- response-tag-stream-output ([input] (response-tag-stream-output nil input)) ([resultWrapper1206097 input] (clojure.core/let [rawinput1206096 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206098 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-stream-output ([input] (response-delete-stream-output nil input)) ([resultWrapper1206100 input] (clojure.core/let [rawinput1206099 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206101 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-stream-output ([input] (response-untag-stream-output nil input)) ([resultWrapper1206103 input] (clojure.core/let [rawinput1206102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206104 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1206106 input] (clojure.core/let [rawinput1206105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206107 {"Message" (rawinput1206105 "Message")}] (clojure.core/cond-> {} (letvar1206107 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206107 ["Message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1206109 input] (clojure.core/let [rawinput1206108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206110 {"StreamInfoList" (rawinput1206108 "StreamInfoList"), "NextToken" (rawinput1206108 "NextToken")}] (clojure.core/cond-> {} (letvar1206110 "StreamInfoList") (clojure.core/assoc :stream-info-list (deser-stream-info-list (clojure.core/get-in letvar1206110 ["StreamInfoList"]))) (letvar1206110 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1206110 ["NextToken"])))))))

(clojure.core/defn- response-invalid-device-exception ([input] (response-invalid-device-exception nil input)) ([resultWrapper1206112 input] (clojure.core/let [rawinput1206111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206113 {"Message" (rawinput1206111 "Message")}] (clojure.core/cond-> {} (letvar1206113 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206113 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper1206115 input] (clojure.core/let [rawinput1206114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206116 {"Message" (rawinput1206114 "Message")}] (clojure.core/cond-> {} (letvar1206116 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206116 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1206118 input] (clojure.core/let [rawinput1206117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206119 {"Message" (rawinput1206117 "Message")}] (clojure.core/cond-> {} (letvar1206119 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206119 ["Message"])))))))

(clojure.core/defn- response-device-stream-limit-exceeded-exception ([input] (response-device-stream-limit-exceeded-exception nil input)) ([resultWrapper1206121 input] (clojure.core/let [rawinput1206120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206122 {"Message" (rawinput1206120 "Message")}] (clojure.core/cond-> {} (letvar1206122 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206122 ["Message"])))))))

(clojure.core/defn- response-get-data-endpoint-output ([input] (response-get-data-endpoint-output nil input)) ([resultWrapper1206124 input] (clojure.core/let [rawinput1206123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206125 {"DataEndpoint" (rawinput1206123 "DataEndpoint")}] (clojure.core/cond-> {} (letvar1206125 "DataEndpoint") (clojure.core/assoc :data-endpoint (deser-data-endpoint (clojure.core/get-in letvar1206125 ["DataEndpoint"])))))))

(clojure.core/defn- response-create-stream-output ([input] (response-create-stream-output nil input)) ([resultWrapper1206127 input] (clojure.core/let [rawinput1206126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206128 {"StreamARN" (rawinput1206126 "StreamARN")}] (clojure.core/cond-> {} (letvar1206128 "StreamARN") (clojure.core/assoc :stream-arn (deser-resource-arn (clojure.core/get-in letvar1206128 ["StreamARN"])))))))

(clojure.core/defn- response-invalid-resource-format-exception ([input] (response-invalid-resource-format-exception nil input)) ([resultWrapper1206130 input] (clojure.core/let [rawinput1206129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206131 {"Message" (rawinput1206129 "Message")}] (clojure.core/cond-> {} (letvar1206131 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206131 ["Message"])))))))

(clojure.core/defn- response-update-data-retention-output ([input] (response-update-data-retention-output nil input)) ([resultWrapper1206133 input] (clojure.core/let [rawinput1206132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206134 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-account-stream-limit-exceeded-exception ([input] (response-account-stream-limit-exceeded-exception nil input)) ([resultWrapper1206136 input] (clojure.core/let [rawinput1206135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206137 {"Message" (rawinput1206135 "Message")}] (clojure.core/cond-> {} (letvar1206137 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1206137 ["Message"])))))))

(clojure.core/defn- response-update-stream-output ([input] (response-update-stream-output nil input)) ([resultWrapper1206139 input] (clojure.core/let [rawinput1206138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1206140 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/media-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w\-\.\+]+/[\w\-\.\+]+(,[\w\-\.\+]+/[\w\-\.\+]+)*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/device-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__21078__auto__))))
