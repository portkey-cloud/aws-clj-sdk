...
(clojure.core/defn- response-tags-per-resource-exceeded-limit-exception ([input] (response-tags-per-resource-exceeded-limit-exception nil input)) ([resultWrapper1258920 input] (clojure.core/let [rawinput1258919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258921 {"Message" (rawinput1258919 "Message")}] (clojure.core/cond-> {} (letvar1258921 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258921 ["Message"])))))))

(clojure.core/defn- response-version-mismatch-exception ([input] (response-version-mismatch-exception nil input)) ([resultWrapper1258923 input] (clojure.core/let [rawinput1258922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258924 {"Message" (rawinput1258922 "Message")}] (clojure.core/cond-> {} (letvar1258924 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258924 ["Message"])))))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1258926 input] (clojure.core/let [rawinput1258925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258927 {"NextToken" (rawinput1258925 "NextToken"), "Tags" (rawinput1258925 "Tags")}] (clojure.core/cond-> {} (letvar1258927 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1258927 ["NextToken"]))) (letvar1258927 "Tags") (clojure.core/assoc :tags (deser-resource-tags (clojure.core/get-in letvar1258927 ["Tags"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1258929 input] (clojure.core/let [rawinput1258928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258930 {"Message" (rawinput1258928 "Message")}] (clojure.core/cond-> {} (letvar1258930 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258930 ["Message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1258932 input] (clojure.core/let [rawinput1258931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258933 {"StreamInfo" (rawinput1258931 "StreamInfo")}] (clojure.core/cond-> {} (letvar1258933 "StreamInfo") (clojure.core/assoc :stream-info (deser-stream-info (clojure.core/get-in letvar1258933 ["StreamInfo"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1258935 input] (clojure.core/let [rawinput1258934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258936 {"Message" (rawinput1258934 "Message")}] (clojure.core/cond-> {} (letvar1258936 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258936 ["Message"])))))))

(clojure.core/defn- response-tag-stream-output ([input] (response-tag-stream-output nil input)) ([resultWrapper1258938 input] (clojure.core/let [rawinput1258937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258939 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-stream-output ([input] (response-delete-stream-output nil input)) ([resultWrapper1258941 input] (clojure.core/let [rawinput1258940 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258942 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-untag-stream-output ([input] (response-untag-stream-output nil input)) ([resultWrapper1258944 input] (clojure.core/let [rawinput1258943 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258945 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1258947 input] (clojure.core/let [rawinput1258946 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258948 {"Message" (rawinput1258946 "Message")}] (clojure.core/cond-> {} (letvar1258948 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258948 ["Message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1258950 input] (clojure.core/let [rawinput1258949 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258951 {"StreamInfoList" (rawinput1258949 "StreamInfoList"), "NextToken" (rawinput1258949 "NextToken")}] (clojure.core/cond-> {} (letvar1258951 "StreamInfoList") (clojure.core/assoc :stream-info-list (deser-stream-info-list (clojure.core/get-in letvar1258951 ["StreamInfoList"]))) (letvar1258951 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1258951 ["NextToken"])))))))

(clojure.core/defn- response-invalid-device-exception ([input] (response-invalid-device-exception nil input)) ([resultWrapper1258953 input] (clojure.core/let [rawinput1258952 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258954 {"Message" (rawinput1258952 "Message")}] (clojure.core/cond-> {} (letvar1258954 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258954 ["Message"])))))))

(clojure.core/defn- response-client-limit-exceeded-exception ([input] (response-client-limit-exceeded-exception nil input)) ([resultWrapper1258956 input] (clojure.core/let [rawinput1258955 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258957 {"Message" (rawinput1258955 "Message")}] (clojure.core/cond-> {} (letvar1258957 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258957 ["Message"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1258959 input] (clojure.core/let [rawinput1258958 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258960 {"Message" (rawinput1258958 "Message")}] (clojure.core/cond-> {} (letvar1258960 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258960 ["Message"])))))))

(clojure.core/defn- response-device-stream-limit-exceeded-exception ([input] (response-device-stream-limit-exceeded-exception nil input)) ([resultWrapper1258962 input] (clojure.core/let [rawinput1258961 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258963 {"Message" (rawinput1258961 "Message")}] (clojure.core/cond-> {} (letvar1258963 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258963 ["Message"])))))))

(clojure.core/defn- response-get-data-endpoint-output ([input] (response-get-data-endpoint-output nil input)) ([resultWrapper1258965 input] (clojure.core/let [rawinput1258964 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258966 {"DataEndpoint" (rawinput1258964 "DataEndpoint")}] (clojure.core/cond-> {} (letvar1258966 "DataEndpoint") (clojure.core/assoc :data-endpoint (deser-data-endpoint (clojure.core/get-in letvar1258966 ["DataEndpoint"])))))))

(clojure.core/defn- response-create-stream-output ([input] (response-create-stream-output nil input)) ([resultWrapper1258968 input] (clojure.core/let [rawinput1258967 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258969 {"StreamARN" (rawinput1258967 "StreamARN")}] (clojure.core/cond-> {} (letvar1258969 "StreamARN") (clojure.core/assoc :stream-arn (deser-resource-arn (clojure.core/get-in letvar1258969 ["StreamARN"])))))))

(clojure.core/defn- response-invalid-resource-format-exception ([input] (response-invalid-resource-format-exception nil input)) ([resultWrapper1258971 input] (clojure.core/let [rawinput1258970 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258972 {"Message" (rawinput1258970 "Message")}] (clojure.core/cond-> {} (letvar1258972 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258972 ["Message"])))))))

(clojure.core/defn- response-update-data-retention-output ([input] (response-update-data-retention-output nil input)) ([resultWrapper1258974 input] (clojure.core/let [rawinput1258973 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258975 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-account-stream-limit-exceeded-exception ([input] (response-account-stream-limit-exceeded-exception nil input)) ([resultWrapper1258977 input] (clojure.core/let [rawinput1258976 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258978 {"Message" (rawinput1258976 "Message")}] (clojure.core/cond-> {} (letvar1258978 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1258978 ["Message"])))))))

(clojure.core/defn- response-update-stream-output ([input] (response-update-stream-output nil input)) ([resultWrapper1258980 input] (clojure.core/let [rawinput1258979 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1258981 {}] (clojure.core/cond-> {}))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/media-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w\-\.\+]+/[\w\-\.\+]+(,[\w\-\.\+]+/[\w\-\.\+]+)*" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/kms-key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/device-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesisvideo.-2017-09-30/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"arn:aws:kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+" s__1012854__auto__))))
