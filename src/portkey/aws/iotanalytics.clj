...
(clojure.core/defn- response-cancel-pipeline-reprocessing-response ([input] (response-cancel-pipeline-reprocessing-response nil input)) ([resultWrapper1152244 input] (clojure.core/let [rawinput1152243 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152245 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-pipeline-response ([input] (response-create-pipeline-response nil input)) ([resultWrapper1152247 input] (clojure.core/let [rawinput1152246 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152248 {"pipelineName" (rawinput1152246 "pipelineName"), "pipelineArn" (rawinput1152246 "pipelineArn")}] (clojure.core/cond-> {} (letvar1152248 "pipelineName") (clojure.core/assoc :pipeline-name (deser-pipeline-name (clojure.core/get-in letvar1152248 ["pipelineName"]))) (letvar1152248 "pipelineArn") (clojure.core/assoc :pipeline-arn (deser-pipeline-arn (clojure.core/get-in letvar1152248 ["pipelineArn"])))))))

(clojure.core/defn- response-create-datastore-response ([input] (response-create-datastore-response nil input)) ([resultWrapper1152250 input] (clojure.core/let [rawinput1152249 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152251 {"datastoreName" (rawinput1152249 "datastoreName"), "datastoreArn" (rawinput1152249 "datastoreArn"), "retentionPeriod" (rawinput1152249 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1152251 "datastoreName") (clojure.core/assoc :datastore-name (deser-datastore-name (clojure.core/get-in letvar1152251 ["datastoreName"]))) (letvar1152251 "datastoreArn") (clojure.core/assoc :datastore-arn (deser-datastore-arn (clojure.core/get-in letvar1152251 ["datastoreArn"]))) (letvar1152251 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1152251 ["retentionPeriod"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1152253 input] (clojure.core/let [rawinput1152252 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152254 {"message" (rawinput1152252 "message")}] (clojure.core/cond-> {} (letvar1152254 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152254 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1152256 input] (clojure.core/let [rawinput1152255 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152257 {"tags" (rawinput1152255 "tags")}] (clojure.core/cond-> {} (letvar1152257 "tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1152257 ["tags"])))))))

(clojure.core/defn- response-start-pipeline-reprocessing-response ([input] (response-start-pipeline-reprocessing-response nil input)) ([resultWrapper1152259 input] (clojure.core/let [rawinput1152258 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152260 {"reprocessingId" (rawinput1152258 "reprocessingId")}] (clojure.core/cond-> {} (letvar1152260 "reprocessingId") (clojure.core/assoc :reprocessing-id (deser-reprocessing-id (clojure.core/get-in letvar1152260 ["reprocessingId"])))))))

(clojure.core/defn- response-run-pipeline-activity-response ([input] (response-run-pipeline-activity-response nil input)) ([resultWrapper1152262 input] (clojure.core/let [rawinput1152261 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152263 {"payloads" (rawinput1152261 "payloads"), "logResult" (rawinput1152261 "logResult")}] (clojure.core/cond-> {} (letvar1152263 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1152263 ["payloads"]))) (letvar1152263 "logResult") (clojure.core/assoc :log-result (deser-log-result (clojure.core/get-in letvar1152263 ["logResult"])))))))

(clojure.core/defn- response-list-datastores-response ([input] (response-list-datastores-response nil input)) ([resultWrapper1152265 input] (clojure.core/let [rawinput1152264 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152266 {"datastoreSummaries" (rawinput1152264 "datastoreSummaries"), "nextToken" (rawinput1152264 "nextToken")}] (clojure.core/cond-> {} (letvar1152266 "datastoreSummaries") (clojure.core/assoc :datastore-summaries (deser-datastore-summaries (clojure.core/get-in letvar1152266 ["datastoreSummaries"]))) (letvar1152266 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1152266 ["nextToken"])))))))

(clojure.core/defn- response-create-dataset-content-response ([input] (response-create-dataset-content-response nil input)) ([resultWrapper1152268 input] (clojure.core/let [rawinput1152267 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152269 {"versionId" (rawinput1152267 "versionId")}] (clojure.core/cond-> {} (letvar1152269 "versionId") (clojure.core/assoc :version-id (deser-dataset-content-version (clojure.core/get-in letvar1152269 ["versionId"])))))))

(clojure.core/defn- response-create-channel-response ([input] (response-create-channel-response nil input)) ([resultWrapper1152271 input] (clojure.core/let [rawinput1152270 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152272 {"channelName" (rawinput1152270 "channelName"), "channelArn" (rawinput1152270 "channelArn"), "retentionPeriod" (rawinput1152270 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1152272 "channelName") (clojure.core/assoc :channel-name (deser-channel-name (clojure.core/get-in letvar1152272 ["channelName"]))) (letvar1152272 "channelArn") (clojure.core/assoc :channel-arn (deser-channel-arn (clojure.core/get-in letvar1152272 ["channelArn"]))) (letvar1152272 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1152272 ["retentionPeriod"])))))))

(clojure.core/defn- response-describe-datastore-response ([input] (response-describe-datastore-response nil input)) ([resultWrapper1152274 input] (clojure.core/let [rawinput1152273 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152275 {"datastore" (rawinput1152273 "datastore"), "statistics" (rawinput1152273 "statistics")}] (clojure.core/cond-> {} (letvar1152275 "datastore") (clojure.core/assoc :datastore (deser-datastore (clojure.core/get-in letvar1152275 ["datastore"]))) (letvar1152275 "statistics") (clojure.core/assoc :statistics (deser-datastore-statistics (clojure.core/get-in letvar1152275 ["statistics"])))))))

(clojure.core/defn- response-describe-channel-response ([input] (response-describe-channel-response nil input)) ([resultWrapper1152277 input] (clojure.core/let [rawinput1152276 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152278 {"channel" (rawinput1152276 "channel"), "statistics" (rawinput1152276 "statistics")}] (clojure.core/cond-> {} (letvar1152278 "channel") (clojure.core/assoc :channel (deser-channel (clojure.core/get-in letvar1152278 ["channel"]))) (letvar1152278 "statistics") (clojure.core/assoc :statistics (deser-channel-statistics (clojure.core/get-in letvar1152278 ["statistics"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1152280 input] (clojure.core/let [rawinput1152279 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152281 {"message" (rawinput1152279 "message")}] (clojure.core/cond-> {} (letvar1152281 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152281 ["message"])))))))

(clojure.core/defn- response-list-dataset-contents-response ([input] (response-list-dataset-contents-response nil input)) ([resultWrapper1152283 input] (clojure.core/let [rawinput1152282 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152284 {"datasetContentSummaries" (rawinput1152282 "datasetContentSummaries"), "nextToken" (rawinput1152282 "nextToken")}] (clojure.core/cond-> {} (letvar1152284 "datasetContentSummaries") (clojure.core/assoc :dataset-content-summaries (deser-dataset-content-summaries (clojure.core/get-in letvar1152284 ["datasetContentSummaries"]))) (letvar1152284 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1152284 ["nextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1152286 input] (clojure.core/let [rawinput1152285 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152287 {"message" (rawinput1152285 "message"), "resourceId" (rawinput1152285 "resourceId"), "resourceArn" (rawinput1152285 "resourceArn")}] (clojure.core/cond-> {} (letvar1152287 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152287 ["message"]))) (letvar1152287 "resourceId") (clojure.core/assoc :resource-id (deserresource-id (clojure.core/get-in letvar1152287 ["resourceId"]))) (letvar1152287 "resourceArn") (clojure.core/assoc :resource-arn (deserresource-arn (clojure.core/get-in letvar1152287 ["resourceArn"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1152289 input] (clojure.core/let [rawinput1152288 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152290 {"message" (rawinput1152288 "message")}] (clojure.core/cond-> {} (letvar1152290 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152290 ["message"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1152292 input] (clojure.core/let [rawinput1152291 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152293 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-dataset-response ([input] (response-create-dataset-response nil input)) ([resultWrapper1152295 input] (clojure.core/let [rawinput1152294 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152296 {"datasetName" (rawinput1152294 "datasetName"), "datasetArn" (rawinput1152294 "datasetArn"), "retentionPeriod" (rawinput1152294 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1152296 "datasetName") (clojure.core/assoc :dataset-name (deser-dataset-name (clojure.core/get-in letvar1152296 ["datasetName"]))) (letvar1152296 "datasetArn") (clojure.core/assoc :dataset-arn (deser-dataset-arn (clojure.core/get-in letvar1152296 ["datasetArn"]))) (letvar1152296 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1152296 ["retentionPeriod"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1152298 input] (clojure.core/let [rawinput1152297 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152299 {"message" (rawinput1152297 "message")}] (clojure.core/cond-> {} (letvar1152299 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152299 ["message"])))))))

(clojure.core/defn- response-list-channels-response ([input] (response-list-channels-response nil input)) ([resultWrapper1152301 input] (clojure.core/let [rawinput1152300 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152302 {"channelSummaries" (rawinput1152300 "channelSummaries"), "nextToken" (rawinput1152300 "nextToken")}] (clojure.core/cond-> {} (letvar1152302 "channelSummaries") (clojure.core/assoc :channel-summaries (deser-channel-summaries (clojure.core/get-in letvar1152302 ["channelSummaries"]))) (letvar1152302 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1152302 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1152304 input] (clojure.core/let [rawinput1152303 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152305 {"message" (rawinput1152303 "message")}] (clojure.core/cond-> {} (letvar1152305 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152305 ["message"])))))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper1152307 input] (clojure.core/let [rawinput1152306 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152308 {"dataset" (rawinput1152306 "dataset")}] (clojure.core/cond-> {} (letvar1152308 "dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar1152308 ["dataset"])))))))

(clojure.core/defn- response-describe-logging-options-response ([input] (response-describe-logging-options-response nil input)) ([resultWrapper1152310 input] (clojure.core/let [rawinput1152309 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152311 {"loggingOptions" (rawinput1152309 "loggingOptions")}] (clojure.core/cond-> {} (letvar1152311 "loggingOptions") (clojure.core/assoc :logging-options (deser-logging-options (clojure.core/get-in letvar1152311 ["loggingOptions"])))))))

(clojure.core/defn- response-describe-pipeline-response ([input] (response-describe-pipeline-response nil input)) ([resultWrapper1152313 input] (clojure.core/let [rawinput1152312 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152314 {"pipeline" (rawinput1152312 "pipeline")}] (clojure.core/cond-> {} (letvar1152314 "pipeline") (clojure.core/assoc :pipeline (deser-pipeline (clojure.core/get-in letvar1152314 ["pipeline"])))))))

(clojure.core/defn- response-list-pipelines-response ([input] (response-list-pipelines-response nil input)) ([resultWrapper1152316 input] (clojure.core/let [rawinput1152315 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152317 {"pipelineSummaries" (rawinput1152315 "pipelineSummaries"), "nextToken" (rawinput1152315 "nextToken")}] (clojure.core/cond-> {} (letvar1152317 "pipelineSummaries") (clojure.core/assoc :pipeline-summaries (deser-pipeline-summaries (clojure.core/get-in letvar1152317 ["pipelineSummaries"]))) (letvar1152317 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1152317 ["nextToken"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1152319 input] (clojure.core/let [rawinput1152318 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152320 {"message" (rawinput1152318 "message")}] (clojure.core/cond-> {} (letvar1152320 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1152320 ["message"])))))))

(clojure.core/defn- response-get-dataset-content-response ([input] (response-get-dataset-content-response nil input)) ([resultWrapper1152322 input] (clojure.core/let [rawinput1152321 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152323 {"entries" (rawinput1152321 "entries"), "timestamp" (rawinput1152321 "timestamp"), "status" (rawinput1152321 "status")}] (clojure.core/cond-> {} (letvar1152323 "entries") (clojure.core/assoc :entries (deser-dataset-entries (clojure.core/get-in letvar1152323 ["entries"]))) (letvar1152323 "timestamp") (clojure.core/assoc :timestamp (deser-timestamp (clojure.core/get-in letvar1152323 ["timestamp"]))) (letvar1152323 "status") (clojure.core/assoc :status (deser-dataset-content-status (clojure.core/get-in letvar1152323 ["status"])))))))

(clojure.core/defn- response-sample-channel-data-response ([input] (response-sample-channel-data-response nil input)) ([resultWrapper1152325 input] (clojure.core/let [rawinput1152324 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152326 {"payloads" (rawinput1152324 "payloads")}] (clojure.core/cond-> {} (letvar1152326 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1152326 ["payloads"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1152328 input] (clojure.core/let [rawinput1152327 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152329 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper1152331 input] (clojure.core/let [rawinput1152330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152332 {"datasetSummaries" (rawinput1152330 "datasetSummaries"), "nextToken" (rawinput1152330 "nextToken")}] (clojure.core/cond-> {} (letvar1152332 "datasetSummaries") (clojure.core/assoc :dataset-summaries (deser-dataset-summaries (clojure.core/get-in letvar1152332 ["datasetSummaries"]))) (letvar1152332 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1152332 ["nextToken"])))))))

(clojure.core/defn- response-batch-put-message-response ([input] (response-batch-put-message-response nil input)) ([resultWrapper1152334 input] (clojure.core/let [rawinput1152333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1152335 {"batchPutMessageErrorEntries" (rawinput1152333 "batchPutMessageErrorEntries")}] (clojure.core/cond-> {} (letvar1152335 "batchPutMessageErrorEntries") (clojure.core/assoc :batch-put-message-error-entries (deser-batch-put-message-error-entries (clojure.core/get-in letvar1152335 ["batchPutMessageErrorEntries"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-content-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 7 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/message-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/pipeline-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/output-file-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\w\.-]{1,255}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/datastore-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/iot-events-input-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z][a-zA-Z0-9_]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/lambda-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 20 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/math-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/activity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
