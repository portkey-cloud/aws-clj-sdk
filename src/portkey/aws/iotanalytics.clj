...
(clojure.core/defn- response-cancel-pipeline-reprocessing-response ([input] (response-cancel-pipeline-reprocessing-response nil input)) ([resultWrapper1243803 input] (clojure.core/let [rawinput1243802 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243804 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-pipeline-response ([input] (response-create-pipeline-response nil input)) ([resultWrapper1243806 input] (clojure.core/let [rawinput1243805 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243807 {"pipelineName" (rawinput1243805 "pipelineName"), "pipelineArn" (rawinput1243805 "pipelineArn")}] (clojure.core/cond-> {} (letvar1243807 "pipelineName") (clojure.core/assoc :pipeline-name (deser-pipeline-name (clojure.core/get-in letvar1243807 ["pipelineName"]))) (letvar1243807 "pipelineArn") (clojure.core/assoc :pipeline-arn (deser-pipeline-arn (clojure.core/get-in letvar1243807 ["pipelineArn"])))))))

(clojure.core/defn- response-create-datastore-response ([input] (response-create-datastore-response nil input)) ([resultWrapper1243809 input] (clojure.core/let [rawinput1243808 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243810 {"datastoreName" (rawinput1243808 "datastoreName"), "datastoreArn" (rawinput1243808 "datastoreArn"), "retentionPeriod" (rawinput1243808 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1243810 "datastoreName") (clojure.core/assoc :datastore-name (deser-datastore-name (clojure.core/get-in letvar1243810 ["datastoreName"]))) (letvar1243810 "datastoreArn") (clojure.core/assoc :datastore-arn (deser-datastore-arn (clojure.core/get-in letvar1243810 ["datastoreArn"]))) (letvar1243810 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1243810 ["retentionPeriod"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1243812 input] (clojure.core/let [rawinput1243811 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243813 {"message" (rawinput1243811 "message")}] (clojure.core/cond-> {} (letvar1243813 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243813 ["message"])))))))

(clojure.core/defn- response-list-tags-for-resource-response ([input] (response-list-tags-for-resource-response nil input)) ([resultWrapper1243815 input] (clojure.core/let [rawinput1243814 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243816 {"tags" (rawinput1243814 "tags")}] (clojure.core/cond-> {} (letvar1243816 "tags") (clojure.core/assoc :tags (deser-tag-list (clojure.core/get-in letvar1243816 ["tags"])))))))

(clojure.core/defn- response-start-pipeline-reprocessing-response ([input] (response-start-pipeline-reprocessing-response nil input)) ([resultWrapper1243818 input] (clojure.core/let [rawinput1243817 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243819 {"reprocessingId" (rawinput1243817 "reprocessingId")}] (clojure.core/cond-> {} (letvar1243819 "reprocessingId") (clojure.core/assoc :reprocessing-id (deser-reprocessing-id (clojure.core/get-in letvar1243819 ["reprocessingId"])))))))

(clojure.core/defn- response-run-pipeline-activity-response ([input] (response-run-pipeline-activity-response nil input)) ([resultWrapper1243821 input] (clojure.core/let [rawinput1243820 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243822 {"payloads" (rawinput1243820 "payloads"), "logResult" (rawinput1243820 "logResult")}] (clojure.core/cond-> {} (letvar1243822 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1243822 ["payloads"]))) (letvar1243822 "logResult") (clojure.core/assoc :log-result (deser-log-result (clojure.core/get-in letvar1243822 ["logResult"])))))))

(clojure.core/defn- response-list-datastores-response ([input] (response-list-datastores-response nil input)) ([resultWrapper1243824 input] (clojure.core/let [rawinput1243823 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243825 {"datastoreSummaries" (rawinput1243823 "datastoreSummaries"), "nextToken" (rawinput1243823 "nextToken")}] (clojure.core/cond-> {} (letvar1243825 "datastoreSummaries") (clojure.core/assoc :datastore-summaries (deser-datastore-summaries (clojure.core/get-in letvar1243825 ["datastoreSummaries"]))) (letvar1243825 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1243825 ["nextToken"])))))))

(clojure.core/defn- response-create-dataset-content-response ([input] (response-create-dataset-content-response nil input)) ([resultWrapper1243827 input] (clojure.core/let [rawinput1243826 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243828 {"versionId" (rawinput1243826 "versionId")}] (clojure.core/cond-> {} (letvar1243828 "versionId") (clojure.core/assoc :version-id (deser-dataset-content-version (clojure.core/get-in letvar1243828 ["versionId"])))))))

(clojure.core/defn- response-create-channel-response ([input] (response-create-channel-response nil input)) ([resultWrapper1243830 input] (clojure.core/let [rawinput1243829 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243831 {"channelName" (rawinput1243829 "channelName"), "channelArn" (rawinput1243829 "channelArn"), "retentionPeriod" (rawinput1243829 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1243831 "channelName") (clojure.core/assoc :channel-name (deser-channel-name (clojure.core/get-in letvar1243831 ["channelName"]))) (letvar1243831 "channelArn") (clojure.core/assoc :channel-arn (deser-channel-arn (clojure.core/get-in letvar1243831 ["channelArn"]))) (letvar1243831 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1243831 ["retentionPeriod"])))))))

(clojure.core/defn- response-describe-datastore-response ([input] (response-describe-datastore-response nil input)) ([resultWrapper1243833 input] (clojure.core/let [rawinput1243832 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243834 {"datastore" (rawinput1243832 "datastore"), "statistics" (rawinput1243832 "statistics")}] (clojure.core/cond-> {} (letvar1243834 "datastore") (clojure.core/assoc :datastore (deser-datastore (clojure.core/get-in letvar1243834 ["datastore"]))) (letvar1243834 "statistics") (clojure.core/assoc :statistics (deser-datastore-statistics (clojure.core/get-in letvar1243834 ["statistics"])))))))

(clojure.core/defn- response-describe-channel-response ([input] (response-describe-channel-response nil input)) ([resultWrapper1243836 input] (clojure.core/let [rawinput1243835 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243837 {"channel" (rawinput1243835 "channel"), "statistics" (rawinput1243835 "statistics")}] (clojure.core/cond-> {} (letvar1243837 "channel") (clojure.core/assoc :channel (deser-channel (clojure.core/get-in letvar1243837 ["channel"]))) (letvar1243837 "statistics") (clojure.core/assoc :statistics (deser-channel-statistics (clojure.core/get-in letvar1243837 ["statistics"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1243839 input] (clojure.core/let [rawinput1243838 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243840 {"message" (rawinput1243838 "message")}] (clojure.core/cond-> {} (letvar1243840 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243840 ["message"])))))))

(clojure.core/defn- response-list-dataset-contents-response ([input] (response-list-dataset-contents-response nil input)) ([resultWrapper1243842 input] (clojure.core/let [rawinput1243841 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243843 {"datasetContentSummaries" (rawinput1243841 "datasetContentSummaries"), "nextToken" (rawinput1243841 "nextToken")}] (clojure.core/cond-> {} (letvar1243843 "datasetContentSummaries") (clojure.core/assoc :dataset-content-summaries (deser-dataset-content-summaries (clojure.core/get-in letvar1243843 ["datasetContentSummaries"]))) (letvar1243843 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1243843 ["nextToken"])))))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper1243845 input] (clojure.core/let [rawinput1243844 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243846 {"message" (rawinput1243844 "message"), "resourceId" (rawinput1243844 "resourceId"), "resourceArn" (rawinput1243844 "resourceArn")}] (clojure.core/cond-> {} (letvar1243846 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243846 ["message"]))) (letvar1243846 "resourceId") (clojure.core/assoc :resource-id (deserresource-id (clojure.core/get-in letvar1243846 ["resourceId"]))) (letvar1243846 "resourceArn") (clojure.core/assoc :resource-arn (deserresource-arn (clojure.core/get-in letvar1243846 ["resourceArn"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper1243848 input] (clojure.core/let [rawinput1243847 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243849 {"message" (rawinput1243847 "message")}] (clojure.core/cond-> {} (letvar1243849 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243849 ["message"])))))))

(clojure.core/defn- response-tag-resource-response ([input] (response-tag-resource-response nil input)) ([resultWrapper1243851 input] (clojure.core/let [rawinput1243850 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243852 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-dataset-response ([input] (response-create-dataset-response nil input)) ([resultWrapper1243854 input] (clojure.core/let [rawinput1243853 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243855 {"datasetName" (rawinput1243853 "datasetName"), "datasetArn" (rawinput1243853 "datasetArn"), "retentionPeriod" (rawinput1243853 "retentionPeriod")}] (clojure.core/cond-> {} (letvar1243855 "datasetName") (clojure.core/assoc :dataset-name (deser-dataset-name (clojure.core/get-in letvar1243855 ["datasetName"]))) (letvar1243855 "datasetArn") (clojure.core/assoc :dataset-arn (deser-dataset-arn (clojure.core/get-in letvar1243855 ["datasetArn"]))) (letvar1243855 "retentionPeriod") (clojure.core/assoc :retention-period (deser-retention-period (clojure.core/get-in letvar1243855 ["retentionPeriod"])))))))

(clojure.core/defn- response-internal-failure-exception ([input] (response-internal-failure-exception nil input)) ([resultWrapper1243857 input] (clojure.core/let [rawinput1243856 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243858 {"message" (rawinput1243856 "message")}] (clojure.core/cond-> {} (letvar1243858 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243858 ["message"])))))))

(clojure.core/defn- response-list-channels-response ([input] (response-list-channels-response nil input)) ([resultWrapper1243860 input] (clojure.core/let [rawinput1243859 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243861 {"channelSummaries" (rawinput1243859 "channelSummaries"), "nextToken" (rawinput1243859 "nextToken")}] (clojure.core/cond-> {} (letvar1243861 "channelSummaries") (clojure.core/assoc :channel-summaries (deser-channel-summaries (clojure.core/get-in letvar1243861 ["channelSummaries"]))) (letvar1243861 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1243861 ["nextToken"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1243863 input] (clojure.core/let [rawinput1243862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243864 {"message" (rawinput1243862 "message")}] (clojure.core/cond-> {} (letvar1243864 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243864 ["message"])))))))

(clojure.core/defn- response-describe-dataset-response ([input] (response-describe-dataset-response nil input)) ([resultWrapper1243866 input] (clojure.core/let [rawinput1243865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243867 {"dataset" (rawinput1243865 "dataset")}] (clojure.core/cond-> {} (letvar1243867 "dataset") (clojure.core/assoc :dataset (deser-dataset (clojure.core/get-in letvar1243867 ["dataset"])))))))

(clojure.core/defn- response-describe-logging-options-response ([input] (response-describe-logging-options-response nil input)) ([resultWrapper1243869 input] (clojure.core/let [rawinput1243868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243870 {"loggingOptions" (rawinput1243868 "loggingOptions")}] (clojure.core/cond-> {} (letvar1243870 "loggingOptions") (clojure.core/assoc :logging-options (deser-logging-options (clojure.core/get-in letvar1243870 ["loggingOptions"])))))))

(clojure.core/defn- response-describe-pipeline-response ([input] (response-describe-pipeline-response nil input)) ([resultWrapper1243872 input] (clojure.core/let [rawinput1243871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243873 {"pipeline" (rawinput1243871 "pipeline")}] (clojure.core/cond-> {} (letvar1243873 "pipeline") (clojure.core/assoc :pipeline (deser-pipeline (clojure.core/get-in letvar1243873 ["pipeline"])))))))

(clojure.core/defn- response-list-pipelines-response ([input] (response-list-pipelines-response nil input)) ([resultWrapper1243875 input] (clojure.core/let [rawinput1243874 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243876 {"pipelineSummaries" (rawinput1243874 "pipelineSummaries"), "nextToken" (rawinput1243874 "nextToken")}] (clojure.core/cond-> {} (letvar1243876 "pipelineSummaries") (clojure.core/assoc :pipeline-summaries (deser-pipeline-summaries (clojure.core/get-in letvar1243876 ["pipelineSummaries"]))) (letvar1243876 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1243876 ["nextToken"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1243878 input] (clojure.core/let [rawinput1243877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243879 {"message" (rawinput1243877 "message")}] (clojure.core/cond-> {} (letvar1243879 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar1243879 ["message"])))))))

(clojure.core/defn- response-get-dataset-content-response ([input] (response-get-dataset-content-response nil input)) ([resultWrapper1243881 input] (clojure.core/let [rawinput1243880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243882 {"entries" (rawinput1243880 "entries"), "timestamp" (rawinput1243880 "timestamp"), "status" (rawinput1243880 "status")}] (clojure.core/cond-> {} (letvar1243882 "entries") (clojure.core/assoc :entries (deser-dataset-entries (clojure.core/get-in letvar1243882 ["entries"]))) (letvar1243882 "timestamp") (clojure.core/assoc :timestamp (deser-timestamp (clojure.core/get-in letvar1243882 ["timestamp"]))) (letvar1243882 "status") (clojure.core/assoc :status (deser-dataset-content-status (clojure.core/get-in letvar1243882 ["status"])))))))

(clojure.core/defn- response-sample-channel-data-response ([input] (response-sample-channel-data-response nil input)) ([resultWrapper1243884 input] (clojure.core/let [rawinput1243883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243885 {"payloads" (rawinput1243883 "payloads")}] (clojure.core/cond-> {} (letvar1243885 "payloads") (clojure.core/assoc :payloads (deser-message-payloads (clojure.core/get-in letvar1243885 ["payloads"])))))))

(clojure.core/defn- response-untag-resource-response ([input] (response-untag-resource-response nil input)) ([resultWrapper1243887 input] (clojure.core/let [rawinput1243886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243888 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-datasets-response ([input] (response-list-datasets-response nil input)) ([resultWrapper1243890 input] (clojure.core/let [rawinput1243889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243891 {"datasetSummaries" (rawinput1243889 "datasetSummaries"), "nextToken" (rawinput1243889 "nextToken")}] (clojure.core/cond-> {} (letvar1243891 "datasetSummaries") (clojure.core/assoc :dataset-summaries (deser-dataset-summaries (clojure.core/get-in letvar1243891 ["datasetSummaries"]))) (letvar1243891 "nextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1243891 ["nextToken"])))))))

(clojure.core/defn- response-batch-put-message-response ([input] (response-batch-put-message-response nil input)) ([resultWrapper1243893 input] (clojure.core/let [rawinput1243892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1243894 {"batchPutMessageErrorEntries" (rawinput1243892 "batchPutMessageErrorEntries")}] (clojure.core/cond-> {} (letvar1243894 "batchPutMessageErrorEntries") (clojure.core/assoc :batch-put-message-error-entries (deser-batch-put-message-error-entries (clojure.core/get-in letvar1243894 ["batchPutMessageErrorEntries"])))))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-content-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 7 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 36))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/message-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/pipeline-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/output-file-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[\w\.-]{1,255}" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/datastore-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 20 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/iot-events-input-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z][a-zA-Z0-9_]*$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/dataset-action-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/filter-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/lambda-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 64)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_-]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/channel-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"^[a-zA-Z0-9_]+$" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 20 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/image (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/string-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.iotanalytics/math-expression (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.iotanalytics/activity-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 128))))
