...
(clojure.core/defn- response-describe-project-result ([input] (response-describe-project-result nil input)) ([resultWrapper433489 input] (clojure.core/let [rawinput433488 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433490 {"stackId" (rawinput433488 "stackId"), "arn" (rawinput433488 "arn"), "projectTemplateId" (rawinput433488 "projectTemplateId"), "createdTimeStamp" (rawinput433488 "createdTimeStamp"), "id" (rawinput433488 "id"), "clientRequestToken" (rawinput433488 "clientRequestToken"), "name" (rawinput433488 "name"), "status" (rawinput433488 "status"), "description" (rawinput433488 "description")}] (clojure.core/cond-> {} (letvar433490 "stackId") (clojure.core/assoc :stack-id (deser-stack-id (clojure.core/get-in letvar433490 ["stackId"]))) (letvar433490 "arn") (clojure.core/assoc :arn (deser-project-arn (clojure.core/get-in letvar433490 ["arn"]))) (letvar433490 "projectTemplateId") (clojure.core/assoc :project-template-id (deser-project-template-id (clojure.core/get-in letvar433490 ["projectTemplateId"]))) (letvar433490 "createdTimeStamp") (clojure.core/assoc :created-time-stamp (deser-created-timestamp (clojure.core/get-in letvar433490 ["createdTimeStamp"]))) (letvar433490 "id") (clojure.core/assoc :id (deser-project-id (clojure.core/get-in letvar433490 ["id"]))) (letvar433490 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar433490 ["clientRequestToken"]))) (letvar433490 "name") (clojure.core/assoc :name (deser-project-name (clojure.core/get-in letvar433490 ["name"]))) (letvar433490 "status") (clojure.core/assoc :status (deser-project-status (clojure.core/get-in letvar433490 ["status"]))) (letvar433490 "description") (clojure.core/assoc :description (deser-project-description (clojure.core/get-in letvar433490 ["description"])))))))

(clojure.core/defn- response-list-projects-result ([input] (response-list-projects-result nil input)) ([resultWrapper433492 input] (clojure.core/let [rawinput433491 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433493 {"projects" (rawinput433491 "projects"), "nextToken" (rawinput433491 "nextToken")}] (clojure.core/cond-> {:projects (deser-projects-list (clojure.core/get-in letvar433493 ["projects"]))} (letvar433493 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar433493 ["nextToken"])))))))

(clojure.core/defn- response-update-project-result ([input] (response-update-project-result nil input)) ([resultWrapper433495 input] (clojure.core/let [rawinput433494 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433496 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper433498 input] (clojure.core/let [rawinput433497 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433499 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-project-creation-failed-exception ([input] (response-project-creation-failed-exception nil input)) ([resultWrapper433501 input] (clojure.core/let [rawinput433500 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433502 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-team-member-already-associated-exception ([input] (response-team-member-already-associated-exception nil input)) ([resultWrapper433504 input] (clojure.core/let [rawinput433503 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433505 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-profiles-result ([input] (response-list-user-profiles-result nil input)) ([resultWrapper433507 input] (clojure.core/let [rawinput433506 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433508 {"userProfiles" (rawinput433506 "userProfiles"), "nextToken" (rawinput433506 "nextToken")}] (clojure.core/cond-> {:user-profiles (deser-user-profiles-list (clojure.core/get-in letvar433508 ["userProfiles"]))} (letvar433508 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar433508 ["nextToken"])))))))

(clojure.core/defn- response-user-profile-not-found-exception ([input] (response-user-profile-not-found-exception nil input)) ([resultWrapper433510 input] (clojure.core/let [rawinput433509 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433511 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper433513 input] (clojure.core/let [rawinput433512 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433514 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-service-role-exception ([input] (response-invalid-service-role-exception nil input)) ([resultWrapper433516 input] (clojure.core/let [rawinput433515 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433517 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-team-member-result ([input] (response-disassociate-team-member-result nil input)) ([resultWrapper433519 input] (clojure.core/let [rawinput433518 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433520 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper433522 input] (clojure.core/let [rawinput433521 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433523 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-tag-project-result ([input] (response-tag-project-result nil input)) ([resultWrapper433525 input] (clojure.core/let [rawinput433524 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433526 {"tags" (rawinput433524 "tags")}] (clojure.core/cond-> {} (letvar433526 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar433526 ["tags"])))))))

(clojure.core/defn- response-untag-project-result ([input] (response-untag-project-result nil input)) ([resultWrapper433528 input] (clojure.core/let [rawinput433527 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433529 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-project-result ([input] (response-create-project-result nil input)) ([resultWrapper433531 input] (clojure.core/let [rawinput433530 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433532 {"id" (rawinput433530 "id"), "arn" (rawinput433530 "arn"), "clientRequestToken" (rawinput433530 "clientRequestToken"), "projectTemplateId" (rawinput433530 "projectTemplateId")}] (clojure.core/cond-> {:id (deser-project-id (clojure.core/get-in letvar433532 ["id"])), :arn (deser-project-arn (clojure.core/get-in letvar433532 ["arn"]))} (letvar433532 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar433532 ["clientRequestToken"]))) (letvar433532 "projectTemplateId") (clojure.core/assoc :project-template-id (deser-project-template-id (clojure.core/get-in letvar433532 ["projectTemplateId"])))))))

(clojure.core/defn- response-user-profile-already-exists-exception ([input] (response-user-profile-already-exists-exception nil input)) ([resultWrapper433534 input] (clojure.core/let [rawinput433533 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433535 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-resources-result ([input] (response-list-resources-result nil input)) ([resultWrapper433537 input] (clojure.core/let [rawinput433536 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433538 {"resources" (rawinput433536 "resources"), "nextToken" (rawinput433536 "nextToken")}] (clojure.core/cond-> {} (letvar433538 "resources") (clojure.core/assoc :resources (deser-resources-result (clojure.core/get-in letvar433538 ["resources"]))) (letvar433538 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar433538 ["nextToken"])))))))

(clojure.core/defn- response-project-already-exists-exception ([input] (response-project-already-exists-exception nil input)) ([resultWrapper433540 input] (clojure.core/let [rawinput433539 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433541 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-team-member-not-found-exception ([input] (response-team-member-not-found-exception nil input)) ([resultWrapper433543 input] (clojure.core/let [rawinput433542 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433544 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-profile-result ([input] (response-describe-user-profile-result nil input)) ([resultWrapper433546 input] (clojure.core/let [rawinput433545 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433547 {"userArn" (rawinput433545 "userArn"), "displayName" (rawinput433545 "displayName"), "emailAddress" (rawinput433545 "emailAddress"), "sshPublicKey" (rawinput433545 "sshPublicKey"), "createdTimestamp" (rawinput433545 "createdTimestamp"), "lastModifiedTimestamp" (rawinput433545 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar433547 ["userArn"])), :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar433547 ["createdTimestamp"])), :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar433547 ["lastModifiedTimestamp"]))} (letvar433547 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar433547 ["displayName"]))) (letvar433547 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar433547 ["emailAddress"]))) (letvar433547 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar433547 ["sshPublicKey"])))))))

(clojure.core/defn- response-delete-project-result ([input] (response-delete-project-result nil input)) ([resultWrapper433549 input] (clojure.core/let [rawinput433548 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433550 {"stackId" (rawinput433548 "stackId"), "projectArn" (rawinput433548 "projectArn")}] (clojure.core/cond-> {} (letvar433550 "stackId") (clojure.core/assoc :stack-id (deser-stack-id (clojure.core/get-in letvar433550 ["stackId"]))) (letvar433550 "projectArn") (clojure.core/assoc :project-arn (deser-project-arn (clojure.core/get-in letvar433550 ["projectArn"])))))))

(clojure.core/defn- response-associate-team-member-result ([input] (response-associate-team-member-result nil input)) ([resultWrapper433552 input] (clojure.core/let [rawinput433551 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433553 {"clientRequestToken" (rawinput433551 "clientRequestToken")}] (clojure.core/cond-> {} (letvar433553 "clientRequestToken") (clojure.core/assoc :client-request-token (deser-client-request-token (clojure.core/get-in letvar433553 ["clientRequestToken"])))))))

(clojure.core/defn- response-update-team-member-result ([input] (response-update-team-member-result nil input)) ([resultWrapper433555 input] (clojure.core/let [rawinput433554 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433556 {"userArn" (rawinput433554 "userArn"), "projectRole" (rawinput433554 "projectRole"), "remoteAccessAllowed" (rawinput433554 "remoteAccessAllowed")}] (clojure.core/cond-> {} (letvar433556 "userArn") (clojure.core/assoc :user-arn (deser-user-arn (clojure.core/get-in letvar433556 ["userArn"]))) (letvar433556 "projectRole") (clojure.core/assoc :project-role (deser-role (clojure.core/get-in letvar433556 ["projectRole"]))) (letvar433556 "remoteAccessAllowed") (clojure.core/assoc :remote-access-allowed (deser-remote-access-allowed (clojure.core/get-in letvar433556 ["remoteAccessAllowed"])))))))

(clojure.core/defn- response-create-user-profile-result ([input] (response-create-user-profile-result nil input)) ([resultWrapper433558 input] (clojure.core/let [rawinput433557 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433559 {"userArn" (rawinput433557 "userArn"), "displayName" (rawinput433557 "displayName"), "emailAddress" (rawinput433557 "emailAddress"), "sshPublicKey" (rawinput433557 "sshPublicKey"), "createdTimestamp" (rawinput433557 "createdTimestamp"), "lastModifiedTimestamp" (rawinput433557 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar433559 ["userArn"]))} (letvar433559 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar433559 ["displayName"]))) (letvar433559 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar433559 ["emailAddress"]))) (letvar433559 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar433559 ["sshPublicKey"]))) (letvar433559 "createdTimestamp") (clojure.core/assoc :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar433559 ["createdTimestamp"]))) (letvar433559 "lastModifiedTimestamp") (clojure.core/assoc :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar433559 ["lastModifiedTimestamp"])))))))

(clojure.core/defn- response-list-tags-for-project-result ([input] (response-list-tags-for-project-result nil input)) ([resultWrapper433561 input] (clojure.core/let [rawinput433560 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433562 {"tags" (rawinput433560 "tags"), "nextToken" (rawinput433560 "nextToken")}] (clojure.core/cond-> {} (letvar433562 "tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar433562 ["tags"]))) (letvar433562 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar433562 ["nextToken"])))))))

(clojure.core/defn- response-list-team-members-result ([input] (response-list-team-members-result nil input)) ([resultWrapper433564 input] (clojure.core/let [rawinput433563 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433565 {"teamMembers" (rawinput433563 "teamMembers"), "nextToken" (rawinput433563 "nextToken")}] (clojure.core/cond-> {:team-members (deser-team-member-result (clojure.core/get-in letvar433565 ["teamMembers"]))} (letvar433565 "nextToken") (clojure.core/assoc :next-token (deser-pagination-token (clojure.core/get-in letvar433565 ["nextToken"])))))))

(clojure.core/defn- response-project-not-found-exception ([input] (response-project-not-found-exception nil input)) ([resultWrapper433567 input] (clojure.core/let [rawinput433566 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433568 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-concurrent-modification-exception ([input] (response-concurrent-modification-exception nil input)) ([resultWrapper433570 input] (clojure.core/let [rawinput433569 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433571 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-project-configuration-exception ([input] (response-project-configuration-exception nil input)) ([resultWrapper433573 input] (clojure.core/let [rawinput433572 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433574 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-user-profile-result ([input] (response-delete-user-profile-result nil input)) ([resultWrapper433576 input] (clojure.core/let [rawinput433575 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433577 {"userArn" (rawinput433575 "userArn")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar433577 ["userArn"]))}))))

(clojure.core/defn- response-update-user-profile-result ([input] (response-update-user-profile-result nil input)) ([resultWrapper433579 input] (clojure.core/let [rawinput433578 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar433580 {"userArn" (rawinput433578 "userArn"), "displayName" (rawinput433578 "displayName"), "emailAddress" (rawinput433578 "emailAddress"), "sshPublicKey" (rawinput433578 "sshPublicKey"), "createdTimestamp" (rawinput433578 "createdTimestamp"), "lastModifiedTimestamp" (rawinput433578 "lastModifiedTimestamp")}] (clojure.core/cond-> {:user-arn (deser-user-arn (clojure.core/get-in letvar433580 ["userArn"]))} (letvar433580 "displayName") (clojure.core/assoc :display-name (deser-user-profile-display-name (clojure.core/get-in letvar433580 ["displayName"]))) (letvar433580 "emailAddress") (clojure.core/assoc :email-address (deser-email (clojure.core/get-in letvar433580 ["emailAddress"]))) (letvar433580 "sshPublicKey") (clojure.core/assoc :ssh-public-key (deser-ssh-public-key (clojure.core/get-in letvar433580 ["sshPublicKey"]))) (letvar433580 "createdTimestamp") (clojure.core/assoc :created-timestamp (deser-created-timestamp (clojure.core/get-in letvar433580 ["createdTimestamp"]))) (letvar433580 "lastModifiedTimestamp") (clojure.core/assoc :last-modified-timestamp (deser-last-modified-timestamp (clojure.core/get-in letvar433580 ["lastModifiedTimestamp"])))))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/repository-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/template-parameter-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 30)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/client-request-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[\w:/-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/project-template-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]{0,5}:codestar:[^:\s]+::project-template(\/(github|codecommit))?\/[a-z0-9-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/repository-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S[\w.-]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/ssh-public-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 16384)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[\t\r\n\u0020-\u00FF]*$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/user-profile-display-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 64)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/repository-type (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(user|organization|User|Organization)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1224))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/pagination-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[\w/+=]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/project-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]*:codestar:[^:\s]+:[0-9]{12}:project\/[a-z]([a-z0-9|-])+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/resource-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 11 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn\:aws\:\S.*\:.*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/untag-project-result (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.codestar/role (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(Owner|Viewer|Contributor)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/team-member-not-found-exception (clojure.spec.alpha/keys :req-un [] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.codestar/git-hub-personal-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/stack-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws[^:\s]*:cloudformation:[^:\s]+:[0-9]{12}:stack\/[^:\s]+\/[^:\s]+$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/project-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|^\S(.*\S)?$" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.codestar/template-parameter-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/repository-description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1000)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/project-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 2 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 15)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[a-z][a-z0-9-]+$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/state (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(CreateInProgress|CreateComplete|CreateFailed|DeleteComplete|DeleteFailed|DeleteInProgress|UpdateComplete|UpdateInProgress|UpdateFailed|Unknown)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/reason (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^$|^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/project-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^\S(.*\S)?$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63))))
...
(clojure.spec.alpha/def :portkey.aws.codestar/user-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 32 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 95)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^arn:aws:iam::\d{12}:user(?:(\u002F)|(\u002F[\u0021-\u007E]+\u002F))[\w+=,.@-]+$" s__21078__auto__))))
