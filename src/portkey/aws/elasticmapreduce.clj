...
(clojure.core/defn- response-add-job-flow-steps-output ([input] (response-add-job-flow-steps-output nil input)) ([resultWrapper1719873 input] (clojure.core/let [rawinput1719872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719874 {"StepIds" (rawinput1719872 "StepIds")}] (clojure.core/cond-> {} (letvar1719874 "StepIds") (clojure.core/assoc :step-ids (deser-step-ids-list (clojure.core/get-in letvar1719874 ["StepIds"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1719876 input] (clojure.core/let [rawinput1719875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719877 {"ErrorCode" (rawinput1719875 "ErrorCode"), "Message" (rawinput1719875 "Message")}] (clojure.core/cond-> {} (letvar1719877 "ErrorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1719877 ["ErrorCode"]))) (letvar1719877 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1719877 ["Message"])))))))

(clojure.core/defn- response-describe-security-configuration-output ([input] (response-describe-security-configuration-output nil input)) ([resultWrapper1719879 input] (clojure.core/let [rawinput1719878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719880 {"Name" (rawinput1719878 "Name"), "SecurityConfiguration" (rawinput1719878 "SecurityConfiguration"), "CreationDateTime" (rawinput1719878 "CreationDateTime")}] (clojure.core/cond-> {} (letvar1719880 "Name") (clojure.core/assoc :name (deser-xml-string (clojure.core/get-in letvar1719880 ["Name"]))) (letvar1719880 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-string (clojure.core/get-in letvar1719880 ["SecurityConfiguration"]))) (letvar1719880 "CreationDateTime") (clojure.core/assoc :creation-date-time (deser-date (clojure.core/get-in letvar1719880 ["CreationDateTime"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1719882 input] (clojure.core/let [rawinput1719881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719883 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-security-configurations-output ([input] (response-list-security-configurations-output nil input)) ([resultWrapper1719885 input] (clojure.core/let [rawinput1719884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719886 {"SecurityConfigurations" (rawinput1719884 "SecurityConfigurations"), "Marker" (rawinput1719884 "Marker")}] (clojure.core/cond-> {} (letvar1719886 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar1719886 ["SecurityConfigurations"]))) (letvar1719886 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719886 ["Marker"])))))))

(clojure.core/defn- response-create-security-configuration-output ([input] (response-create-security-configuration-output nil input)) ([resultWrapper1719888 input] (clojure.core/let [rawinput1719887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719889 {"Name" (rawinput1719887 "Name"), "CreationDateTime" (rawinput1719887 "CreationDateTime")}] (clojure.core/cond-> {:name (deser-xml-string (clojure.core/get-in letvar1719889 ["Name"])), :creation-date-time (deser-date (clojure.core/get-in letvar1719889 ["CreationDateTime"]))}))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1719891 input] (clojure.core/let [rawinput1719890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719892 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-bootstrap-actions-output ([input] (response-list-bootstrap-actions-output nil input)) ([resultWrapper1719894 input] (clojure.core/let [rawinput1719893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719895 {"BootstrapActions" (rawinput1719893 "BootstrapActions"), "Marker" (rawinput1719893 "Marker")}] (clojure.core/cond-> {} (letvar1719895 "BootstrapActions") (clojure.core/assoc :bootstrap-actions (deser-command-list (clojure.core/get-in letvar1719895 ["BootstrapActions"]))) (letvar1719895 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719895 ["Marker"])))))))

(clojure.core/defn- response-list-steps-output ([input] (response-list-steps-output nil input)) ([resultWrapper1719897 input] (clojure.core/let [rawinput1719896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719898 {"Steps" (rawinput1719896 "Steps"), "Marker" (rawinput1719896 "Marker")}] (clojure.core/cond-> {} (letvar1719898 "Steps") (clojure.core/assoc :steps (deser-step-summary-list (clojure.core/get-in letvar1719898 ["Steps"]))) (letvar1719898 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719898 ["Marker"])))))))

(clojure.core/defn- response-describe-step-output ([input] (response-describe-step-output nil input)) ([resultWrapper1719900 input] (clojure.core/let [rawinput1719899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719901 {"Step" (rawinput1719899 "Step")}] (clojure.core/cond-> {} (letvar1719901 "Step") (clojure.core/assoc :step (deser-step (clojure.core/get-in letvar1719901 ["Step"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1719903 input] (clojure.core/let [rawinput1719902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719904 {"Message" (rawinput1719902 "Message")}] (clojure.core/cond-> {} (letvar1719904 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1719904 ["Message"])))))))

(clojure.core/defn- response-run-job-flow-output ([input] (response-run-job-flow-output nil input)) ([resultWrapper1719906 input] (clojure.core/let [rawinput1719905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719907 {"JobFlowId" (rawinput1719905 "JobFlowId")}] (clojure.core/cond-> {} (letvar1719907 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1719907 ["JobFlowId"])))))))

(clojure.core/defn- response-list-instances-output ([input] (response-list-instances-output nil input)) ([resultWrapper1719909 input] (clojure.core/let [rawinput1719908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719910 {"Instances" (rawinput1719908 "Instances"), "Marker" (rawinput1719908 "Marker")}] (clojure.core/cond-> {} (letvar1719910 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar1719910 ["Instances"]))) (letvar1719910 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719910 ["Marker"])))))))

(clojure.core/defn- response-add-instance-fleet-output ([input] (response-add-instance-fleet-output nil input)) ([resultWrapper1719912 input] (clojure.core/let [rawinput1719911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719913 {"ClusterId" (rawinput1719911 "ClusterId"), "InstanceFleetId" (rawinput1719911 "InstanceFleetId")}] (clojure.core/cond-> {} (letvar1719913 "ClusterId") (clojure.core/assoc :cluster-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1719913 ["ClusterId"]))) (letvar1719913 "InstanceFleetId") (clojure.core/assoc :instance-fleet-id (deser-instance-fleet-id (clojure.core/get-in letvar1719913 ["InstanceFleetId"])))))))

(clojure.core/defn- response-delete-security-configuration-output ([input] (response-delete-security-configuration-output nil input)) ([resultWrapper1719915 input] (clojure.core/let [rawinput1719914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719916 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-instance-fleets-output ([input] (response-list-instance-fleets-output nil input)) ([resultWrapper1719918 input] (clojure.core/let [rawinput1719917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719919 {"InstanceFleets" (rawinput1719917 "InstanceFleets"), "Marker" (rawinput1719917 "Marker")}] (clojure.core/cond-> {} (letvar1719919 "InstanceFleets") (clojure.core/assoc :instance-fleets (deser-instance-fleet-list (clojure.core/get-in letvar1719919 ["InstanceFleets"]))) (letvar1719919 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719919 ["Marker"])))))))

(clojure.core/defn- response-list-instance-groups-output ([input] (response-list-instance-groups-output nil input)) ([resultWrapper1719921 input] (clojure.core/let [rawinput1719920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719922 {"InstanceGroups" (rawinput1719920 "InstanceGroups"), "Marker" (rawinput1719920 "Marker")}] (clojure.core/cond-> {} (letvar1719922 "InstanceGroups") (clojure.core/assoc :instance-groups (deser-instance-group-list (clojure.core/get-in letvar1719922 ["InstanceGroups"]))) (letvar1719922 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719922 ["Marker"])))))))

(clojure.core/defn- response-add-instance-groups-output ([input] (response-add-instance-groups-output nil input)) ([resultWrapper1719924 input] (clojure.core/let [rawinput1719923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719925 {"JobFlowId" (rawinput1719923 "JobFlowId"), "InstanceGroupIds" (rawinput1719923 "InstanceGroupIds")}] (clojure.core/cond-> {} (letvar1719925 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1719925 ["JobFlowId"]))) (letvar1719925 "InstanceGroupIds") (clojure.core/assoc :instance-group-ids (deser-instance-group-ids-list (clojure.core/get-in letvar1719925 ["InstanceGroupIds"])))))))

(clojure.core/defn- response-cancel-steps-output ([input] (response-cancel-steps-output nil input)) ([resultWrapper1719927 input] (clojure.core/let [rawinput1719926 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719928 {"CancelStepsInfoList" (rawinput1719926 "CancelStepsInfoList")}] (clojure.core/cond-> {} (letvar1719928 "CancelStepsInfoList") (clojure.core/assoc :cancel-steps-info-list (deser-cancel-steps-info-list (clojure.core/get-in letvar1719928 ["CancelStepsInfoList"])))))))

(clojure.core/defn- response-describe-cluster-output ([input] (response-describe-cluster-output nil input)) ([resultWrapper1719930 input] (clojure.core/let [rawinput1719929 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719931 {"Cluster" (rawinput1719929 "Cluster")}] (clojure.core/cond-> {} (letvar1719931 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1719931 ["Cluster"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1719933 input] (clojure.core/let [rawinput1719932 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719934 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-clusters-output ([input] (response-list-clusters-output nil input)) ([resultWrapper1719936 input] (clojure.core/let [rawinput1719935 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719937 {"Clusters" (rawinput1719935 "Clusters"), "Marker" (rawinput1719935 "Marker")}] (clojure.core/cond-> {} (letvar1719937 "Clusters") (clojure.core/assoc :clusters (deser-cluster-summary-list (clojure.core/get-in letvar1719937 ["Clusters"]))) (letvar1719937 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1719937 ["Marker"])))))))

(clojure.core/defn- response-put-auto-scaling-policy-output ([input] (response-put-auto-scaling-policy-output nil input)) ([resultWrapper1719939 input] (clojure.core/let [rawinput1719938 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719940 {"ClusterId" (rawinput1719938 "ClusterId"), "InstanceGroupId" (rawinput1719938 "InstanceGroupId"), "AutoScalingPolicy" (rawinput1719938 "AutoScalingPolicy")}] (clojure.core/cond-> {} (letvar1719940 "ClusterId") (clojure.core/assoc :cluster-id (deser-cluster-id (clojure.core/get-in letvar1719940 ["ClusterId"]))) (letvar1719940 "InstanceGroupId") (clojure.core/assoc :instance-group-id (deser-instance-group-id (clojure.core/get-in letvar1719940 ["InstanceGroupId"]))) (letvar1719940 "AutoScalingPolicy") (clojure.core/assoc :auto-scaling-policy (deser-auto-scaling-policy-description (clojure.core/get-in letvar1719940 ["AutoScalingPolicy"])))))))

(clojure.core/defn- response-remove-auto-scaling-policy-output ([input] (response-remove-auto-scaling-policy-output nil input)) ([resultWrapper1719942 input] (clojure.core/let [rawinput1719941 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719943 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-flows-output ([input] (response-describe-job-flows-output nil input)) ([resultWrapper1719945 input] (clojure.core/let [rawinput1719944 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1719946 {"JobFlows" (rawinput1719944 "JobFlows")}] (clojure.core/cond-> {} (letvar1719946 "JobFlows") (clojure.core/assoc :job-flows (deser-job-flow-detail-list (clojure.core/get-in letvar1719946 ["JobFlows"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 10280)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
