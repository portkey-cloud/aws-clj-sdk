...
(clojure.core/defn- response-add-job-flow-steps-output ([input] (response-add-job-flow-steps-output nil input)) ([resultWrapper898539 input] (clojure.core/let [rawinput898538 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898540 {"StepIds" (rawinput898538 "StepIds")}] (clojure.core/cond-> {} (letvar898540 "StepIds") (clojure.core/assoc :step-ids (deser-step-ids-list (clojure.core/get-in letvar898540 ["StepIds"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper898542 input] (clojure.core/let [rawinput898541 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898543 {"ErrorCode" (rawinput898541 "ErrorCode"), "Message" (rawinput898541 "Message")}] (clojure.core/cond-> {} (letvar898543 "ErrorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar898543 ["ErrorCode"]))) (letvar898543 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar898543 ["Message"])))))))

(clojure.core/defn- response-describe-security-configuration-output ([input] (response-describe-security-configuration-output nil input)) ([resultWrapper898545 input] (clojure.core/let [rawinput898544 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898546 {"Name" (rawinput898544 "Name"), "SecurityConfiguration" (rawinput898544 "SecurityConfiguration"), "CreationDateTime" (rawinput898544 "CreationDateTime")}] (clojure.core/cond-> {} (letvar898546 "Name") (clojure.core/assoc :name (deser-xml-string (clojure.core/get-in letvar898546 ["Name"]))) (letvar898546 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-string (clojure.core/get-in letvar898546 ["SecurityConfiguration"]))) (letvar898546 "CreationDateTime") (clojure.core/assoc :creation-date-time (deser-date (clojure.core/get-in letvar898546 ["CreationDateTime"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper898548 input] (clojure.core/let [rawinput898547 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898549 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-security-configurations-output ([input] (response-list-security-configurations-output nil input)) ([resultWrapper898551 input] (clojure.core/let [rawinput898550 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898552 {"SecurityConfigurations" (rawinput898550 "SecurityConfigurations"), "Marker" (rawinput898550 "Marker")}] (clojure.core/cond-> {} (letvar898552 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar898552 ["SecurityConfigurations"]))) (letvar898552 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898552 ["Marker"])))))))

(clojure.core/defn- response-create-security-configuration-output ([input] (response-create-security-configuration-output nil input)) ([resultWrapper898554 input] (clojure.core/let [rawinput898553 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898555 {"Name" (rawinput898553 "Name"), "CreationDateTime" (rawinput898553 "CreationDateTime")}] (clojure.core/cond-> {:name (deser-xml-string (clojure.core/get-in letvar898555 ["Name"])), :creation-date-time (deser-date (clojure.core/get-in letvar898555 ["CreationDateTime"]))}))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper898557 input] (clojure.core/let [rawinput898556 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898558 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-bootstrap-actions-output ([input] (response-list-bootstrap-actions-output nil input)) ([resultWrapper898560 input] (clojure.core/let [rawinput898559 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898561 {"BootstrapActions" (rawinput898559 "BootstrapActions"), "Marker" (rawinput898559 "Marker")}] (clojure.core/cond-> {} (letvar898561 "BootstrapActions") (clojure.core/assoc :bootstrap-actions (deser-command-list (clojure.core/get-in letvar898561 ["BootstrapActions"]))) (letvar898561 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898561 ["Marker"])))))))

(clojure.core/defn- response-list-steps-output ([input] (response-list-steps-output nil input)) ([resultWrapper898563 input] (clojure.core/let [rawinput898562 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898564 {"Steps" (rawinput898562 "Steps"), "Marker" (rawinput898562 "Marker")}] (clojure.core/cond-> {} (letvar898564 "Steps") (clojure.core/assoc :steps (deser-step-summary-list (clojure.core/get-in letvar898564 ["Steps"]))) (letvar898564 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898564 ["Marker"])))))))

(clojure.core/defn- response-describe-step-output ([input] (response-describe-step-output nil input)) ([resultWrapper898566 input] (clojure.core/let [rawinput898565 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898567 {"Step" (rawinput898565 "Step")}] (clojure.core/cond-> {} (letvar898567 "Step") (clojure.core/assoc :step (deser-step (clojure.core/get-in letvar898567 ["Step"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper898569 input] (clojure.core/let [rawinput898568 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898570 {"Message" (rawinput898568 "Message")}] (clojure.core/cond-> {} (letvar898570 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar898570 ["Message"])))))))

(clojure.core/defn- response-run-job-flow-output ([input] (response-run-job-flow-output nil input)) ([resultWrapper898572 input] (clojure.core/let [rawinput898571 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898573 {"JobFlowId" (rawinput898571 "JobFlowId")}] (clojure.core/cond-> {} (letvar898573 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar898573 ["JobFlowId"])))))))

(clojure.core/defn- response-list-instances-output ([input] (response-list-instances-output nil input)) ([resultWrapper898575 input] (clojure.core/let [rawinput898574 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898576 {"Instances" (rawinput898574 "Instances"), "Marker" (rawinput898574 "Marker")}] (clojure.core/cond-> {} (letvar898576 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar898576 ["Instances"]))) (letvar898576 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898576 ["Marker"])))))))

(clojure.core/defn- response-add-instance-fleet-output ([input] (response-add-instance-fleet-output nil input)) ([resultWrapper898578 input] (clojure.core/let [rawinput898577 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898579 {"ClusterId" (rawinput898577 "ClusterId"), "InstanceFleetId" (rawinput898577 "InstanceFleetId")}] (clojure.core/cond-> {} (letvar898579 "ClusterId") (clojure.core/assoc :cluster-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar898579 ["ClusterId"]))) (letvar898579 "InstanceFleetId") (clojure.core/assoc :instance-fleet-id (deser-instance-fleet-id (clojure.core/get-in letvar898579 ["InstanceFleetId"])))))))

(clojure.core/defn- response-delete-security-configuration-output ([input] (response-delete-security-configuration-output nil input)) ([resultWrapper898581 input] (clojure.core/let [rawinput898580 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898582 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-instance-fleets-output ([input] (response-list-instance-fleets-output nil input)) ([resultWrapper898584 input] (clojure.core/let [rawinput898583 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898585 {"InstanceFleets" (rawinput898583 "InstanceFleets"), "Marker" (rawinput898583 "Marker")}] (clojure.core/cond-> {} (letvar898585 "InstanceFleets") (clojure.core/assoc :instance-fleets (deser-instance-fleet-list (clojure.core/get-in letvar898585 ["InstanceFleets"]))) (letvar898585 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898585 ["Marker"])))))))

(clojure.core/defn- response-list-instance-groups-output ([input] (response-list-instance-groups-output nil input)) ([resultWrapper898587 input] (clojure.core/let [rawinput898586 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898588 {"InstanceGroups" (rawinput898586 "InstanceGroups"), "Marker" (rawinput898586 "Marker")}] (clojure.core/cond-> {} (letvar898588 "InstanceGroups") (clojure.core/assoc :instance-groups (deser-instance-group-list (clojure.core/get-in letvar898588 ["InstanceGroups"]))) (letvar898588 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898588 ["Marker"])))))))

(clojure.core/defn- response-add-instance-groups-output ([input] (response-add-instance-groups-output nil input)) ([resultWrapper898590 input] (clojure.core/let [rawinput898589 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898591 {"JobFlowId" (rawinput898589 "JobFlowId"), "InstanceGroupIds" (rawinput898589 "InstanceGroupIds")}] (clojure.core/cond-> {} (letvar898591 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar898591 ["JobFlowId"]))) (letvar898591 "InstanceGroupIds") (clojure.core/assoc :instance-group-ids (deser-instance-group-ids-list (clojure.core/get-in letvar898591 ["InstanceGroupIds"])))))))

(clojure.core/defn- response-cancel-steps-output ([input] (response-cancel-steps-output nil input)) ([resultWrapper898593 input] (clojure.core/let [rawinput898592 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898594 {"CancelStepsInfoList" (rawinput898592 "CancelStepsInfoList")}] (clojure.core/cond-> {} (letvar898594 "CancelStepsInfoList") (clojure.core/assoc :cancel-steps-info-list (deser-cancel-steps-info-list (clojure.core/get-in letvar898594 ["CancelStepsInfoList"])))))))

(clojure.core/defn- response-describe-cluster-output ([input] (response-describe-cluster-output nil input)) ([resultWrapper898596 input] (clojure.core/let [rawinput898595 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898597 {"Cluster" (rawinput898595 "Cluster")}] (clojure.core/cond-> {} (letvar898597 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar898597 ["Cluster"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper898599 input] (clojure.core/let [rawinput898598 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898600 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-clusters-output ([input] (response-list-clusters-output nil input)) ([resultWrapper898602 input] (clojure.core/let [rawinput898601 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898603 {"Clusters" (rawinput898601 "Clusters"), "Marker" (rawinput898601 "Marker")}] (clojure.core/cond-> {} (letvar898603 "Clusters") (clojure.core/assoc :clusters (deser-cluster-summary-list (clojure.core/get-in letvar898603 ["Clusters"]))) (letvar898603 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar898603 ["Marker"])))))))

(clojure.core/defn- response-put-auto-scaling-policy-output ([input] (response-put-auto-scaling-policy-output nil input)) ([resultWrapper898605 input] (clojure.core/let [rawinput898604 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898606 {"ClusterId" (rawinput898604 "ClusterId"), "InstanceGroupId" (rawinput898604 "InstanceGroupId"), "AutoScalingPolicy" (rawinput898604 "AutoScalingPolicy")}] (clojure.core/cond-> {} (letvar898606 "ClusterId") (clojure.core/assoc :cluster-id (deser-cluster-id (clojure.core/get-in letvar898606 ["ClusterId"]))) (letvar898606 "InstanceGroupId") (clojure.core/assoc :instance-group-id (deser-instance-group-id (clojure.core/get-in letvar898606 ["InstanceGroupId"]))) (letvar898606 "AutoScalingPolicy") (clojure.core/assoc :auto-scaling-policy (deser-auto-scaling-policy-description (clojure.core/get-in letvar898606 ["AutoScalingPolicy"])))))))

(clojure.core/defn- response-remove-auto-scaling-policy-output ([input] (response-remove-auto-scaling-policy-output nil input)) ([resultWrapper898608 input] (clojure.core/let [rawinput898607 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898609 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-flows-output ([input] (response-describe-job-flows-output nil input)) ([resultWrapper898611 input] (clojure.core/let [rawinput898610 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar898612 {"JobFlows" (rawinput898610 "JobFlows")}] (clojure.core/cond-> {} (letvar898612 "JobFlows") (clojure.core/assoc :job-flows (deser-job-flow-detail-list (clojure.core/get-in letvar898612 ["JobFlows"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 10280)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
