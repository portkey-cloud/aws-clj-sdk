...
(clojure.core/defn- response-add-job-flow-steps-output ([input] (response-add-job-flow-steps-output nil input)) ([resultWrapper1752091 input] (clojure.core/let [rawinput1752090 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752092 {"StepIds" (rawinput1752090 "StepIds")}] (clojure.core/cond-> {} (letvar1752092 "StepIds") (clojure.core/assoc :step-ids (deser-step-ids-list (clojure.core/get-in letvar1752092 ["StepIds"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1752094 input] (clojure.core/let [rawinput1752093 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752095 {"ErrorCode" (rawinput1752093 "ErrorCode"), "Message" (rawinput1752093 "Message")}] (clojure.core/cond-> {} (letvar1752095 "ErrorCode") (clojure.core/assoc :error-code (deser-error-code (clojure.core/get-in letvar1752095 ["ErrorCode"]))) (letvar1752095 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1752095 ["Message"])))))))

(clojure.core/defn- response-describe-security-configuration-output ([input] (response-describe-security-configuration-output nil input)) ([resultWrapper1752097 input] (clojure.core/let [rawinput1752096 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752098 {"Name" (rawinput1752096 "Name"), "SecurityConfiguration" (rawinput1752096 "SecurityConfiguration"), "CreationDateTime" (rawinput1752096 "CreationDateTime")}] (clojure.core/cond-> {} (letvar1752098 "Name") (clojure.core/assoc :name (deser-xml-string (clojure.core/get-in letvar1752098 ["Name"]))) (letvar1752098 "SecurityConfiguration") (clojure.core/assoc :security-configuration (deser-string (clojure.core/get-in letvar1752098 ["SecurityConfiguration"]))) (letvar1752098 "CreationDateTime") (clojure.core/assoc :creation-date-time (deser-date (clojure.core/get-in letvar1752098 ["CreationDateTime"])))))))

(clojure.core/defn- response-add-tags-output ([input] (response-add-tags-output nil input)) ([resultWrapper1752100 input] (clojure.core/let [rawinput1752099 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752101 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-security-configurations-output ([input] (response-list-security-configurations-output nil input)) ([resultWrapper1752103 input] (clojure.core/let [rawinput1752102 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752104 {"SecurityConfigurations" (rawinput1752102 "SecurityConfigurations"), "Marker" (rawinput1752102 "Marker")}] (clojure.core/cond-> {} (letvar1752104 "SecurityConfigurations") (clojure.core/assoc :security-configurations (deser-security-configuration-list (clojure.core/get-in letvar1752104 ["SecurityConfigurations"]))) (letvar1752104 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752104 ["Marker"])))))))

(clojure.core/defn- response-create-security-configuration-output ([input] (response-create-security-configuration-output nil input)) ([resultWrapper1752106 input] (clojure.core/let [rawinput1752105 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752107 {"Name" (rawinput1752105 "Name"), "CreationDateTime" (rawinput1752105 "CreationDateTime")}] (clojure.core/cond-> {:name (deser-xml-string (clojure.core/get-in letvar1752107 ["Name"])), :creation-date-time (deser-date (clojure.core/get-in letvar1752107 ["CreationDateTime"]))}))))

(clojure.core/defn- response-remove-tags-output ([input] (response-remove-tags-output nil input)) ([resultWrapper1752109 input] (clojure.core/let [rawinput1752108 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752110 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-bootstrap-actions-output ([input] (response-list-bootstrap-actions-output nil input)) ([resultWrapper1752112 input] (clojure.core/let [rawinput1752111 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752113 {"BootstrapActions" (rawinput1752111 "BootstrapActions"), "Marker" (rawinput1752111 "Marker")}] (clojure.core/cond-> {} (letvar1752113 "BootstrapActions") (clojure.core/assoc :bootstrap-actions (deser-command-list (clojure.core/get-in letvar1752113 ["BootstrapActions"]))) (letvar1752113 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752113 ["Marker"])))))))

(clojure.core/defn- response-list-steps-output ([input] (response-list-steps-output nil input)) ([resultWrapper1752115 input] (clojure.core/let [rawinput1752114 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752116 {"Steps" (rawinput1752114 "Steps"), "Marker" (rawinput1752114 "Marker")}] (clojure.core/cond-> {} (letvar1752116 "Steps") (clojure.core/assoc :steps (deser-step-summary-list (clojure.core/get-in letvar1752116 ["Steps"]))) (letvar1752116 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752116 ["Marker"])))))))

(clojure.core/defn- response-describe-step-output ([input] (response-describe-step-output nil input)) ([resultWrapper1752118 input] (clojure.core/let [rawinput1752117 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752119 {"Step" (rawinput1752117 "Step")}] (clojure.core/cond-> {} (letvar1752119 "Step") (clojure.core/assoc :step (deser-step (clojure.core/get-in letvar1752119 ["Step"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper1752121 input] (clojure.core/let [rawinput1752120 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752122 {"Message" (rawinput1752120 "Message")}] (clojure.core/cond-> {} (letvar1752122 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1752122 ["Message"])))))))

(clojure.core/defn- response-run-job-flow-output ([input] (response-run-job-flow-output nil input)) ([resultWrapper1752124 input] (clojure.core/let [rawinput1752123 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752125 {"JobFlowId" (rawinput1752123 "JobFlowId")}] (clojure.core/cond-> {} (letvar1752125 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1752125 ["JobFlowId"])))))))

(clojure.core/defn- response-list-instances-output ([input] (response-list-instances-output nil input)) ([resultWrapper1752127 input] (clojure.core/let [rawinput1752126 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752128 {"Instances" (rawinput1752126 "Instances"), "Marker" (rawinput1752126 "Marker")}] (clojure.core/cond-> {} (letvar1752128 "Instances") (clojure.core/assoc :instances (deser-instance-list (clojure.core/get-in letvar1752128 ["Instances"]))) (letvar1752128 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752128 ["Marker"])))))))

(clojure.core/defn- response-add-instance-fleet-output ([input] (response-add-instance-fleet-output nil input)) ([resultWrapper1752130 input] (clojure.core/let [rawinput1752129 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752131 {"ClusterId" (rawinput1752129 "ClusterId"), "InstanceFleetId" (rawinput1752129 "InstanceFleetId")}] (clojure.core/cond-> {} (letvar1752131 "ClusterId") (clojure.core/assoc :cluster-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1752131 ["ClusterId"]))) (letvar1752131 "InstanceFleetId") (clojure.core/assoc :instance-fleet-id (deser-instance-fleet-id (clojure.core/get-in letvar1752131 ["InstanceFleetId"])))))))

(clojure.core/defn- response-delete-security-configuration-output ([input] (response-delete-security-configuration-output nil input)) ([resultWrapper1752133 input] (clojure.core/let [rawinput1752132 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752134 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-instance-fleets-output ([input] (response-list-instance-fleets-output nil input)) ([resultWrapper1752136 input] (clojure.core/let [rawinput1752135 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752137 {"InstanceFleets" (rawinput1752135 "InstanceFleets"), "Marker" (rawinput1752135 "Marker")}] (clojure.core/cond-> {} (letvar1752137 "InstanceFleets") (clojure.core/assoc :instance-fleets (deser-instance-fleet-list (clojure.core/get-in letvar1752137 ["InstanceFleets"]))) (letvar1752137 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752137 ["Marker"])))))))

(clojure.core/defn- response-list-instance-groups-output ([input] (response-list-instance-groups-output nil input)) ([resultWrapper1752139 input] (clojure.core/let [rawinput1752138 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752140 {"InstanceGroups" (rawinput1752138 "InstanceGroups"), "Marker" (rawinput1752138 "Marker")}] (clojure.core/cond-> {} (letvar1752140 "InstanceGroups") (clojure.core/assoc :instance-groups (deser-instance-group-list (clojure.core/get-in letvar1752140 ["InstanceGroups"]))) (letvar1752140 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752140 ["Marker"])))))))

(clojure.core/defn- response-add-instance-groups-output ([input] (response-add-instance-groups-output nil input)) ([resultWrapper1752142 input] (clojure.core/let [rawinput1752141 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752143 {"JobFlowId" (rawinput1752141 "JobFlowId"), "InstanceGroupIds" (rawinput1752141 "InstanceGroupIds")}] (clojure.core/cond-> {} (letvar1752143 "JobFlowId") (clojure.core/assoc :job-flow-id (deser-xml-string-max-len-256 (clojure.core/get-in letvar1752143 ["JobFlowId"]))) (letvar1752143 "InstanceGroupIds") (clojure.core/assoc :instance-group-ids (deser-instance-group-ids-list (clojure.core/get-in letvar1752143 ["InstanceGroupIds"])))))))

(clojure.core/defn- response-cancel-steps-output ([input] (response-cancel-steps-output nil input)) ([resultWrapper1752145 input] (clojure.core/let [rawinput1752144 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752146 {"CancelStepsInfoList" (rawinput1752144 "CancelStepsInfoList")}] (clojure.core/cond-> {} (letvar1752146 "CancelStepsInfoList") (clojure.core/assoc :cancel-steps-info-list (deser-cancel-steps-info-list (clojure.core/get-in letvar1752146 ["CancelStepsInfoList"])))))))

(clojure.core/defn- response-describe-cluster-output ([input] (response-describe-cluster-output nil input)) ([resultWrapper1752148 input] (clojure.core/let [rawinput1752147 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752149 {"Cluster" (rawinput1752147 "Cluster")}] (clojure.core/cond-> {} (letvar1752149 "Cluster") (clojure.core/assoc :cluster (deser-cluster (clojure.core/get-in letvar1752149 ["Cluster"])))))))

(clojure.core/defn- response-internal-server-error ([input] (response-internal-server-error nil input)) ([resultWrapper1752151 input] (clojure.core/let [rawinput1752150 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752152 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-clusters-output ([input] (response-list-clusters-output nil input)) ([resultWrapper1752154 input] (clojure.core/let [rawinput1752153 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752155 {"Clusters" (rawinput1752153 "Clusters"), "Marker" (rawinput1752153 "Marker")}] (clojure.core/cond-> {} (letvar1752155 "Clusters") (clojure.core/assoc :clusters (deser-cluster-summary-list (clojure.core/get-in letvar1752155 ["Clusters"]))) (letvar1752155 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar1752155 ["Marker"])))))))

(clojure.core/defn- response-put-auto-scaling-policy-output ([input] (response-put-auto-scaling-policy-output nil input)) ([resultWrapper1752157 input] (clojure.core/let [rawinput1752156 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752158 {"ClusterId" (rawinput1752156 "ClusterId"), "InstanceGroupId" (rawinput1752156 "InstanceGroupId"), "AutoScalingPolicy" (rawinput1752156 "AutoScalingPolicy")}] (clojure.core/cond-> {} (letvar1752158 "ClusterId") (clojure.core/assoc :cluster-id (deser-cluster-id (clojure.core/get-in letvar1752158 ["ClusterId"]))) (letvar1752158 "InstanceGroupId") (clojure.core/assoc :instance-group-id (deser-instance-group-id (clojure.core/get-in letvar1752158 ["InstanceGroupId"]))) (letvar1752158 "AutoScalingPolicy") (clojure.core/assoc :auto-scaling-policy (deser-auto-scaling-policy-description (clojure.core/get-in letvar1752158 ["AutoScalingPolicy"])))))))

(clojure.core/defn- response-remove-auto-scaling-policy-output ([input] (response-remove-auto-scaling-policy-output nil input)) ([resultWrapper1752160 input] (clojure.core/let [rawinput1752159 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752161 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-job-flows-output ([input] (response-describe-job-flows-output nil input)) ([resultWrapper1752163 input] (clojure.core/let [rawinput1752162 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1752164 {"JobFlows" (rawinput1752162 "JobFlows")}] (clojure.core/cond-> {} (letvar1752164 "JobFlows") (clojure.core/assoc :job-flows (deser-job-flow-detail-list (clojure.core/get-in letvar1752164 ["JobFlows"])))))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 0 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 10280)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.elasticmapreduce/error-code (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256))))
