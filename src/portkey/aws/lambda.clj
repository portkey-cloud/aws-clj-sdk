...
(clojure.core/defn req<-tag-resource-request [resp-input59891] {:uri {"Resource" (portkey.awsgen/ser-name (resp-input59891 :resource))}, :body {"Tags" (portkey.awsgen/ser-name (resp-input59891 :tags))}})
(clojure.core/defn req<-create-alias-request [resp-input59892] (clojure.core/let [input59893 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59892 :function-name))}, :body {"Name" (portkey.awsgen/ser-name (resp-input59892 :name)), "FunctionVersion" (portkey.awsgen/ser-name (resp-input59892 :function-version))}}] (clojure.core/cond-> input59893 (clojure.core/contains? resp-input59892 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input59892 :description))) (clojure.core/contains? resp-input59892 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (resp-input59892 :routing-config))))))
(clojure.core/defn req<-delete-function-request [resp-input59894] (clojure.core/let [input59895 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59894 :function-name))}}] (clojure.core/cond-> input59895 (clojure.core/contains? resp-input59894 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59894 :qualifier))))))
(clojure.core/defn req<-list-event-source-mappings-request [resp-input59896] (clojure.core/cond-> {} (clojure.core/contains? resp-input59896 :event-source-arn) (clojure.core/assoc-in [:query-string "EventSourceArn"] (ser-arn (resp-input59896 :event-source-arn))) (clojure.core/contains? resp-input59896 :function-name) (clojure.core/assoc-in [:query-string "FunctionName"] (ser-function-name (resp-input59896 :function-name))) (clojure.core/contains? resp-input59896 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input59896 :marker))) (clojure.core/contains? resp-input59896 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input59896 :max-items)))))
(clojure.core/defn req<-delete-function-concurrency-request [resp-input59897] {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59897 :function-name))}})
(clojure.core/defn req<-delete-event-source-mapping-request [resp-input59898] {:uri {"UUID" (portkey.awsgen/ser-name (resp-input59898 :uuid))}})
(clojure.core/defn req<-invocation-request [resp-input59899] (clojure.core/let [input59900 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59899 :function-name))}}] (clojure.core/cond-> input59900 (clojure.core/contains? resp-input59899 :invocation-type) (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type (resp-input59899 :invocation-type))) (clojure.core/contains? resp-input59899 :log-type) (clojure.core/assoc-in [:headers "LogType"] (ser-log-type (resp-input59899 :log-type))) (clojure.core/contains? resp-input59899 :client-context) (clojure.core/assoc-in [:headers "ClientContext"] (ser-string (resp-input59899 :client-context))) (clojure.core/contains? resp-input59899 :payload) (clojure.core/assoc-in [:body "Payload"] (ser-blob (resp-input59899 :payload))) (clojure.core/contains? resp-input59899 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59899 :qualifier))))))
(clojure.core/defn req<-get-account-settings-request [resp-input59901] nil)
(clojure.core/defn req<-invoke-async-request [resp-input59902] {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59902 :function-name))}, :body {"InvokeArgs" (portkey.awsgen/ser-name (resp-input59902 :invoke-args))}})
(clojure.core/defn req<-get-function-configuration-request [resp-input59903] (clojure.core/let [input59904 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59903 :function-name))}}] (clojure.core/cond-> input59904 (clojure.core/contains? resp-input59903 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59903 :qualifier))))))
(clojure.core/defn req<-update-function-code-request [resp-input59905] (clojure.core/let [input59906 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59905 :function-name))}}] (clojure.core/cond-> input59906 (clojure.core/contains? resp-input59905 :zip-file) (clojure.core/assoc-in [:body "ZipFile"] (ser-blob (resp-input59905 :zip-file))) (clojure.core/contains? resp-input59905 :s3-bucket) (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket (resp-input59905 :s3-bucket))) (clojure.core/contains? resp-input59905 :s3-key) (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key (resp-input59905 :s3-key))) (clojure.core/contains? resp-input59905 :s3-object-version) (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version (resp-input59905 :s3-object-version))) (clojure.core/contains? resp-input59905 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (resp-input59905 :publish))) (clojure.core/contains? resp-input59905 :dry-run) (clojure.core/assoc-in [:body "DryRun"] (ser-boolean (resp-input59905 :dry-run))) (clojure.core/contains? resp-input59905 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input59905 :revision-id))))))
(clojure.core/defn req<-list-versions-by-function-request [resp-input59907] (clojure.core/let [input59908 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59907 :function-name))}}] (clojure.core/cond-> input59908 (clojure.core/contains? resp-input59907 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input59907 :marker))) (clojure.core/contains? resp-input59907 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input59907 :max-items))))))
(clojure.core/defn req<-update-event-source-mapping-request [resp-input59909] (clojure.core/let [input59910 {:uri {"UUID" (portkey.awsgen/ser-name (resp-input59909 :uuid))}}] (clojure.core/cond-> input59910 (clojure.core/contains? resp-input59909 :function-name) (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name (resp-input59909 :function-name))) (clojure.core/contains? resp-input59909 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (resp-input59909 :enabled))) (clojure.core/contains? resp-input59909 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (resp-input59909 :batch-size))))))
(clojure.core/defn req<-list-tags-request [resp-input59911] {:uri {"Resource" (portkey.awsgen/ser-name (resp-input59911 :resource))}})
(clojure.core/defn req<-update-alias-request [resp-input59912] (clojure.core/let [input59913 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59912 :function-name)), "Name" (portkey.awsgen/ser-name (resp-input59912 :name))}}] (clojure.core/cond-> input59913 (clojure.core/contains? resp-input59912 :function-version) (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version (resp-input59912 :function-version))) (clojure.core/contains? resp-input59912 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input59912 :description))) (clojure.core/contains? resp-input59912 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (resp-input59912 :routing-config))) (clojure.core/contains? resp-input59912 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input59912 :revision-id))))))
(clojure.core/defn req<-get-event-source-mapping-request [resp-input59914] {:uri {"UUID" (portkey.awsgen/ser-name (resp-input59914 :uuid))}})
(clojure.core/defn req<-get-function-request [resp-input59915] (clojure.core/let [input59916 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59915 :function-name))}}] (clojure.core/cond-> input59916 (clojure.core/contains? resp-input59915 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59915 :qualifier))))))
(clojure.core/defn req<-get-policy-request [resp-input59917] (clojure.core/let [input59918 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59917 :function-name))}}] (clojure.core/cond-> input59918 (clojure.core/contains? resp-input59917 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59917 :qualifier))))))
(clojure.core/defn req<-add-permission-request [resp-input59919] (clojure.core/let [input59920 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59919 :function-name))}, :body {"StatementId" (portkey.awsgen/ser-name (resp-input59919 :statement-id)), "Principal" (portkey.awsgen/ser-name (resp-input59919 :principal)), "Action" (portkey.awsgen/ser-name (resp-input59919 :action))}}] (clojure.core/cond-> input59920 (clojure.core/contains? resp-input59919 :source-account) (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner (resp-input59919 :source-account))) (clojure.core/contains? resp-input59919 :source-arn) (clojure.core/assoc-in [:body "SourceArn"] (ser-arn (resp-input59919 :source-arn))) (clojure.core/contains? resp-input59919 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input59919 :revision-id))) (clojure.core/contains? resp-input59919 :event-source-token) (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token (resp-input59919 :event-source-token))) (clojure.core/contains? resp-input59919 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59919 :qualifier))))))
(clojure.core/defn req<-create-event-source-mapping-request [resp-input59921] (clojure.core/let [input59922 {:body {"EventSourceArn" (portkey.awsgen/ser-name (resp-input59921 :event-source-arn)), "FunctionName" (portkey.awsgen/ser-name (resp-input59921 :function-name)), "StartingPosition" (portkey.awsgen/ser-name (resp-input59921 :starting-position))}}] (clojure.core/cond-> input59922 (clojure.core/contains? resp-input59921 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (resp-input59921 :enabled))) (clojure.core/contains? resp-input59921 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (resp-input59921 :batch-size))) (clojure.core/contains? resp-input59921 :starting-position-timestamp) (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date (resp-input59921 :starting-position-timestamp))))))
(clojure.core/defn req<-get-alias-request [resp-input59923] {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59923 :function-name)), "Name" (portkey.awsgen/ser-name (resp-input59923 :name))}})
(clojure.core/defn req<-list-aliases-request [resp-input59924] (clojure.core/let [input59925 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59924 :function-name))}}] (clojure.core/cond-> input59925 (clojure.core/contains? resp-input59924 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version (resp-input59924 :function-version))) (clojure.core/contains? resp-input59924 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input59924 :marker))) (clojure.core/contains? resp-input59924 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input59924 :max-items))))))
(clojure.core/defn req<-list-functions-request [resp-input59926] (clojure.core/cond-> {} (clojure.core/contains? resp-input59926 :master-region) (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region (resp-input59926 :master-region))) (clojure.core/contains? resp-input59926 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version (resp-input59926 :function-version))) (clojure.core/contains? resp-input59926 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input59926 :marker))) (clojure.core/contains? resp-input59926 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input59926 :max-items)))))
(clojure.core/defn req<-remove-permission-request [resp-input59927] (clojure.core/let [input59928 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59927 :function-name)), "StatementId" (portkey.awsgen/ser-name (resp-input59927 :statement-id))}}] (clojure.core/cond-> input59928 (clojure.core/contains? resp-input59927 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input59927 :qualifier))) (clojure.core/contains? resp-input59927 :revision-id) (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string (resp-input59927 :revision-id))))))
(clojure.core/defn req<-delete-alias-request [resp-input59929] {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59929 :function-name)), "Name" (portkey.awsgen/ser-name (resp-input59929 :name))}})
(clojure.core/defn req<-create-function-request [resp-input59930] (clojure.core/let [input59931 {:body {"FunctionName" (portkey.awsgen/ser-name (resp-input59930 :function-name)), "Handler" (portkey.awsgen/ser-name (resp-input59930 :handler)), "Runtime" (portkey.awsgen/ser-name (resp-input59930 :runtime)), "Role" (portkey.awsgen/ser-name (resp-input59930 :role)), "Code" (portkey.awsgen/ser-name (resp-input59930 :code))}}] (clojure.core/cond-> input59931 (clojure.core/contains? resp-input59930 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (resp-input59930 :tracing-config))) (clojure.core/contains? resp-input59930 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (resp-input59930 :timeout))) (clojure.core/contains? resp-input59930 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (resp-input59930 :dead-letter-config))) (clojure.core/contains? resp-input59930 :tags) (clojure.core/assoc-in [:body "Tags"] (ser-tags (resp-input59930 :tags))) (clojure.core/contains? resp-input59930 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (resp-input59930 :memory-size))) (clojure.core/contains? resp-input59930 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (resp-input59930 :kmskey-arn))) (clojure.core/contains? resp-input59930 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input59930 :description))) (clojure.core/contains? resp-input59930 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (resp-input59930 :environment))) (clojure.core/contains? resp-input59930 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (resp-input59930 :vpc-config))) (clojure.core/contains? resp-input59930 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (resp-input59930 :publish))))))
(clojure.core/defn req<-untag-resource-request [resp-input59932] {:uri {"Resource" (portkey.awsgen/ser-name (resp-input59932 :resource))}, :query-string {"TagKeys" (portkey.awsgen/ser-name (resp-input59932 :tag-keys))}})
(clojure.core/defn req<-publish-version-request [resp-input59933] (clojure.core/let [input59934 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59933 :function-name))}}] (clojure.core/cond-> input59934 (clojure.core/contains? resp-input59933 :code-sha256) (clojure.core/assoc-in [:body "CodeSha256"] (ser-string (resp-input59933 :code-sha256))) (clojure.core/contains? resp-input59933 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input59933 :description))) (clojure.core/contains? resp-input59933 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input59933 :revision-id))))))
(clojure.core/defn req<-put-function-concurrency-request [resp-input59935] {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59935 :function-name))}, :body {"ReservedConcurrentExecutions" (portkey.awsgen/ser-name (resp-input59935 :reserved-concurrent-executions))}})
(clojure.core/defn req<-update-function-configuration-request [resp-input59936] (clojure.core/let [input59937 {:uri {"FunctionName" (portkey.awsgen/ser-name (resp-input59936 :function-name))}}] (clojure.core/cond-> input59937 (clojure.core/contains? resp-input59936 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (resp-input59936 :tracing-config))) (clojure.core/contains? resp-input59936 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (resp-input59936 :timeout))) (clojure.core/contains? resp-input59936 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (resp-input59936 :dead-letter-config))) (clojure.core/contains? resp-input59936 :handler) (clojure.core/assoc-in [:body "Handler"] (ser-handler (resp-input59936 :handler))) (clojure.core/contains? resp-input59936 :runtime) (clojure.core/assoc-in [:body "Runtime"] (ser-runtime (resp-input59936 :runtime))) (clojure.core/contains? resp-input59936 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (resp-input59936 :memory-size))) (clojure.core/contains? resp-input59936 :role) (clojure.core/assoc-in [:body "Role"] (ser-role-arn (resp-input59936 :role))) (clojure.core/contains? resp-input59936 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (resp-input59936 :kmskey-arn))) (clojure.core/contains? resp-input59936 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input59936 :description))) (clojure.core/contains? resp-input59936 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (resp-input59936 :environment))) (clojure.core/contains? resp-input59936 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (resp-input59936 :vpc-config))) (clojure.core/contains? resp-input59936 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input59936 :revision-id))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 0 p1__59186__59187__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 1 p1__59186__59187__auto__)) (fn* [p1__59188__59189__auto__] (clojure.core/<= p1__59188__59189__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 140)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 0 p1__59186__59187__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 1 p1__59186__59187__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 128)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"[^\s]+" s__59133__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 170)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"\d{12}" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 100)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 128)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 1024)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"[0-9]+" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 128 p1__59186__59187__auto__)) (fn* [p1__59188__59189__auto__] (clojure.core/<= p1__59188__59189__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 100)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__59133__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 0 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__59186__59187__auto__] (clojure.core/<= 1 p1__59186__59187__auto__)) (fn* [p1__59188__59189__auto__] (clojure.core/<= p1__59188__59189__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 3 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 63)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 128)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__59133__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 0 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 256)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__59133__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59131__auto__] (clojure.core/<= 1 (clojure.core/count s__59131__auto__))) (clojure.core/fn [s__59132__auto__] (clojure.core/< (clojure.core/count s__59132__auto__) 1024)) (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #".*" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__59133__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__59133__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__59133__auto__))))
