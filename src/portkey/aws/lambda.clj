...
(clojure.core/defn- response-list-layers-response ([input] (response-list-layers-response nil input)) ([resultWrapper1535688 input] (clojure.core/let [rawinput1535687 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535689 {"NextMarker" (rawinput1535687 "NextMarker"), "Layers" (rawinput1535687 "Layers")}] (clojure.core/cond-> {} (letvar1535689 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535689 ["NextMarker"]))) (letvar1535689 "Layers") (clojure.core/assoc :layers (deser-layers-list (clojure.core/get-in letvar1535689 ["Layers"])))))))

(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper1535691 input] (clojure.core/let [rawinput1535690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535692 {"Type" (rawinput1535690 "Type"), "message" (rawinput1535690 "message")}] (clojure.core/cond-> {} (letvar1535692 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535692 ["Type"]))) (letvar1535692 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535692 ["message"])))))))

(clojure.core/defn- response-request-too-large-exception ([input] (response-request-too-large-exception nil input)) ([resultWrapper1535694 input] (clojure.core/let [rawinput1535693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535695 {"Type" (rawinput1535693 "Type"), "message" (rawinput1535693 "message")}] (clojure.core/cond-> {} (letvar1535695 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535695 ["Type"]))) (letvar1535695 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535695 ["message"])))))))

(clojure.core/defn- response-invalid-subnet-id-exception ([input] (response-invalid-subnet-id-exception nil input)) ([resultWrapper1535697 input] (clojure.core/let [rawinput1535696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535698 {"Type" (rawinput1535696 "Type"), "Message" (rawinput1535696 "Message")}] (clojure.core/cond-> {} (letvar1535698 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535698 ["Type"]))) (letvar1535698 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535698 ["Message"])))))))

(clojure.core/defn- response-list-layer-versions-response ([input] (response-list-layer-versions-response nil input)) ([resultWrapper1535700 input] (clojure.core/let [rawinput1535699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535701 {"NextMarker" (rawinput1535699 "NextMarker"), "LayerVersions" (rawinput1535699 "LayerVersions")}] (clojure.core/cond-> {} (letvar1535701 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535701 ["NextMarker"]))) (letvar1535701 "LayerVersions") (clojure.core/assoc :layer-versions (deser-layer-versions-list (clojure.core/get-in letvar1535701 ["LayerVersions"])))))))

(clojure.core/defn- response-subnet-ip-address-limit-reached-exception ([input] (response-subnet-ip-address-limit-reached-exception nil input)) ([resultWrapper1535703 input] (clojure.core/let [rawinput1535702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535704 {"Type" (rawinput1535702 "Type"), "Message" (rawinput1535702 "Message")}] (clojure.core/cond-> {} (letvar1535704 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535704 ["Type"]))) (letvar1535704 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535704 ["Message"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper1535706 input] (clojure.core/let [rawinput1535705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535707 {"Type" (rawinput1535705 "Type"), "message" (rawinput1535705 "message")}] (clojure.core/cond-> {} (letvar1535707 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535707 ["Type"]))) (letvar1535707 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535707 ["message"])))))))

(clojure.core/defn- response-list-versions-by-function-response ([input] (response-list-versions-by-function-response nil input)) ([resultWrapper1535709 input] (clojure.core/let [rawinput1535708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535710 {"NextMarker" (rawinput1535708 "NextMarker"), "Versions" (rawinput1535708 "Versions")}] (clojure.core/cond-> {} (letvar1535710 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535710 ["NextMarker"]))) (letvar1535710 "Versions") (clojure.core/assoc :versions (deser-function-list (clojure.core/get-in letvar1535710 ["Versions"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1535712 input] (clojure.core/let [rawinput1535711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535713 {"Tags" (rawinput1535711 "Tags")}] (clojure.core/cond-> {} (letvar1535713 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1535713 ["Tags"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1535715 input] (clojure.core/let [rawinput1535714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535716 {"Type" (rawinput1535714 "Type"), "Message" (rawinput1535714 "Message")}] (clojure.core/cond-> {} (letvar1535716 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535716 ["Type"]))) (letvar1535716 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535716 ["Message"])))))))

(clojure.core/defn- response-list-event-source-mappings-response ([input] (response-list-event-source-mappings-response nil input)) ([resultWrapper1535718 input] (clojure.core/let [rawinput1535717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535719 {"NextMarker" (rawinput1535717 "NextMarker"), "EventSourceMappings" (rawinput1535717 "EventSourceMappings")}] (clojure.core/cond-> {} (letvar1535719 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535719 ["NextMarker"]))) (letvar1535719 "EventSourceMappings") (clojure.core/assoc :event-source-mappings (deser-event-source-mappings-list (clojure.core/get-in letvar1535719 ["EventSourceMappings"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1535721 input] (clojure.core/let [rawinput1535720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535722 {"Type" (rawinput1535720 "Type"), "Message" (rawinput1535720 "Message")}] (clojure.core/cond-> {} (letvar1535722 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535722 ["Type"]))) (letvar1535722 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535722 ["Message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1535724 input] (clojure.core/let [rawinput1535723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535725 {"Type" (rawinput1535723 "Type"), "Message" (rawinput1535723 "Message")}] (clojure.core/cond-> {} (letvar1535725 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535725 ["Type"]))) (letvar1535725 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535725 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1535727 input] (clojure.core/let [rawinput1535726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535728 {"Type" (rawinput1535726 "Type"), "Message" (rawinput1535726 "Message")}] (clojure.core/cond-> {} (letvar1535728 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535728 ["Type"]))) (letvar1535728 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535728 ["Message"])))))))

(clojure.core/defn- response-invalid-runtime-exception ([input] (response-invalid-runtime-exception nil input)) ([resultWrapper1535730 input] (clojure.core/let [rawinput1535729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535731 {"Type" (rawinput1535729 "Type"), "Message" (rawinput1535729 "Message")}] (clojure.core/cond-> {} (letvar1535731 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535731 ["Type"]))) (letvar1535731 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535731 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-response ([input] (response-get-layer-version-response nil input)) ([resultWrapper1535733 input] (clojure.core/let [rawinput1535732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535734 {"Content" (rawinput1535732 "Content"), "LayerArn" (rawinput1535732 "LayerArn"), "LayerVersionArn" (rawinput1535732 "LayerVersionArn"), "Description" (rawinput1535732 "Description"), "CreatedDate" (rawinput1535732 "CreatedDate"), "Version" (rawinput1535732 "Version"), "CompatibleRuntimes" (rawinput1535732 "CompatibleRuntimes"), "LicenseInfo" (rawinput1535732 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1535734 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1535734 ["Content"]))) (letvar1535734 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1535734 ["LayerArn"]))) (letvar1535734 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1535734 ["LayerVersionArn"]))) (letvar1535734 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1535734 ["Description"]))) (letvar1535734 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1535734 ["CreatedDate"]))) (letvar1535734 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1535734 ["Version"]))) (letvar1535734 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1535734 ["CompatibleRuntimes"]))) (letvar1535734 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1535734 ["LicenseInfo"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1535736 input] (clojure.core/let [rawinput1535735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535737 {"NextMarker" (rawinput1535735 "NextMarker"), "Functions" (rawinput1535735 "Functions")}] (clojure.core/cond-> {} (letvar1535737 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535737 ["NextMarker"]))) (letvar1535737 "Functions") (clojure.core/assoc :functions (deser-function-list (clojure.core/get-in letvar1535737 ["Functions"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1535739 input] (clojure.core/let [rawinput1535738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535740 {"Type" (rawinput1535738 "Type"), "Message" (rawinput1535738 "Message")}] (clojure.core/cond-> {} (letvar1535740 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535740 ["Type"]))) (letvar1535740 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535740 ["Message"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1535742 input] (clojure.core/let [rawinput1535741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535743 {"Configuration" (rawinput1535741 "Configuration"), "Code" (rawinput1535741 "Code"), "Tags" (rawinput1535741 "Tags"), "Concurrency" (rawinput1535741 "Concurrency")}] (clojure.core/cond-> {} (letvar1535743 "Configuration") (clojure.core/assoc :configuration (deser-function-configuration (clojure.core/get-in letvar1535743 ["Configuration"]))) (letvar1535743 "Code") (clojure.core/assoc :code (deser-function-code-location (clojure.core/get-in letvar1535743 ["Code"]))) (letvar1535743 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1535743 ["Tags"]))) (letvar1535743 "Concurrency") (clojure.core/assoc :concurrency (deser-concurrency (clojure.core/get-in letvar1535743 ["Concurrency"])))))))

(clojure.core/defn- response-code-storage-exceeded-exception ([input] (response-code-storage-exceeded-exception nil input)) ([resultWrapper1535745 input] (clojure.core/let [rawinput1535744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535746 {"Type" (rawinput1535744 "Type"), "message" (rawinput1535744 "message")}] (clojure.core/cond-> {} (letvar1535746 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535746 ["Type"]))) (letvar1535746 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535746 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1535748 input] (clojure.core/let [rawinput1535747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535749 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "Type" (rawinput1535747 "Type"), "message" (rawinput1535747 "message"), "Reason" (rawinput1535747 "Reason")}] (clojure.core/cond-> {} (letvar1535749 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar1535749 ["Retry-After"]))) (letvar1535749 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535749 ["Type"]))) (letvar1535749 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535749 ["message"]))) (letvar1535749 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1535749 ["Reason"])))))))

(clojure.core/defn- response-invalid-request-content-exception ([input] (response-invalid-request-content-exception nil input)) ([resultWrapper1535751 input] (clojure.core/let [rawinput1535750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535752 {"Type" (rawinput1535750 "Type"), "message" (rawinput1535750 "message")}] (clojure.core/cond-> {} (letvar1535752 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535752 ["Type"]))) (letvar1535752 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535752 ["message"])))))))

(clojure.core/defn- response-add-layer-version-permission-response ([input] (response-add-layer-version-permission-response nil input)) ([resultWrapper1535754 input] (clojure.core/let [rawinput1535753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535755 {"Statement" (rawinput1535753 "Statement"), "RevisionId" (rawinput1535753 "RevisionId")}] (clojure.core/cond-> {} (letvar1535755 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1535755 ["Statement"]))) (letvar1535755 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1535755 ["RevisionId"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1535757 input] (clojure.core/let [rawinput1535756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535758 {"Type" (rawinput1535756 "Type"), "Message" (rawinput1535756 "Message")}] (clojure.core/cond-> {} (letvar1535758 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535758 ["Type"]))) (letvar1535758 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535758 ["Message"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper1535760 input] (clojure.core/let [rawinput1535759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535761 {"AccountLimit" (rawinput1535759 "AccountLimit"), "AccountUsage" (rawinput1535759 "AccountUsage")}] (clojure.core/cond-> {} (letvar1535761 "AccountLimit") (clojure.core/assoc :account-limit (deser-account-limit (clojure.core/get-in letvar1535761 ["AccountLimit"]))) (letvar1535761 "AccountUsage") (clojure.core/assoc :account-usage (deser-account-usage (clojure.core/get-in letvar1535761 ["AccountUsage"])))))))

(clojure.core/defn- response-eni-limit-reached-exception ([input] (response-eni-limit-reached-exception nil input)) ([resultWrapper1535763 input] (clojure.core/let [rawinput1535762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535764 {"Type" (rawinput1535762 "Type"), "Message" (rawinput1535762 "Message")}] (clojure.core/cond-> {} (letvar1535764 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535764 ["Type"]))) (letvar1535764 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535764 ["Message"])))))))

(clojure.core/defn- response-concurrency ([input] (response-concurrency nil input)) ([resultWrapper1535766 input] (clojure.core/let [rawinput1535765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535767 {"ReservedConcurrentExecutions" (rawinput1535765 "ReservedConcurrentExecutions")}] (clojure.core/cond-> {} (letvar1535767 "ReservedConcurrentExecutions") (clojure.core/assoc :reserved-concurrent-executions (deser-reserved-concurrent-executions (clojure.core/get-in letvar1535767 ["ReservedConcurrentExecutions"])))))))

(clojure.core/defn- response-add-permission-response ([input] (response-add-permission-response nil input)) ([resultWrapper1535769 input] (clojure.core/let [rawinput1535768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535770 {"Statement" (rawinput1535768 "Statement")}] (clojure.core/cond-> {} (letvar1535770 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1535770 ["Statement"])))))))

(clojure.core/defn- response-invocation-response ([input] (response-invocation-response nil input)) ([resultWrapper1535772 input] (clojure.core/let [rawinput1535771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535773 {"StatusCode" (clojure.core/get-in input [:status "StatusCode"]), "X-Amz-Function-Error" (clojure.core/get-in input [:headers "X-Amz-Function-Error"]), "X-Amz-Log-Result" (clojure.core/get-in input [:headers "X-Amz-Log-Result"]), "Payload" (rawinput1535771 "Payload"), "X-Amz-Executed-Version" (clojure.core/get-in input [:headers "X-Amz-Executed-Version"])}] (clojure.core/cond-> {} (letvar1535773 "StatusCode") (clojure.core/assoc :status-code (deser-integer (clojure.core/get-in letvar1535773 ["StatusCode"]))) (letvar1535773 "X-Amz-Function-Error") (clojure.core/assoc :function-error (deser-string (clojure.core/get-in letvar1535773 ["X-Amz-Function-Error"]))) (letvar1535773 "X-Amz-Log-Result") (clojure.core/assoc :log-result (deser-string (clojure.core/get-in letvar1535773 ["X-Amz-Log-Result"]))) (letvar1535773 "Payload") (clojure.core/assoc :payload (deser-blob (clojure.core/get-in letvar1535773 ["Payload"]))) (letvar1535773 "X-Amz-Executed-Version") (clojure.core/assoc :executed-version (deser-version (clojure.core/get-in letvar1535773 ["X-Amz-Executed-Version"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1535775 input] (clojure.core/let [rawinput1535774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535776 {"Type" (rawinput1535774 "Type"), "Message" (rawinput1535774 "Message")}] (clojure.core/cond-> {} (letvar1535776 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535776 ["Type"]))) (letvar1535776 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535776 ["Message"])))))))

(clojure.core/defn- response-publish-layer-version-response ([input] (response-publish-layer-version-response nil input)) ([resultWrapper1535778 input] (clojure.core/let [rawinput1535777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535779 {"Content" (rawinput1535777 "Content"), "LayerArn" (rawinput1535777 "LayerArn"), "LayerVersionArn" (rawinput1535777 "LayerVersionArn"), "Description" (rawinput1535777 "Description"), "CreatedDate" (rawinput1535777 "CreatedDate"), "Version" (rawinput1535777 "Version"), "CompatibleRuntimes" (rawinput1535777 "CompatibleRuntimes"), "LicenseInfo" (rawinput1535777 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1535779 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1535779 ["Content"]))) (letvar1535779 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1535779 ["LayerArn"]))) (letvar1535779 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1535779 ["LayerVersionArn"]))) (letvar1535779 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1535779 ["Description"]))) (letvar1535779 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1535779 ["CreatedDate"]))) (letvar1535779 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1535779 ["Version"]))) (letvar1535779 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1535779 ["CompatibleRuntimes"]))) (letvar1535779 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1535779 ["LicenseInfo"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1535781 input] (clojure.core/let [rawinput1535780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535782 {"Policy" (rawinput1535780 "Policy"), "RevisionId" (rawinput1535780 "RevisionId")}] (clojure.core/cond-> {} (letvar1535782 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1535782 ["Policy"]))) (letvar1535782 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1535782 ["RevisionId"])))))))

(clojure.core/defn- response-invoke-async-response ([input] (response-invoke-async-response nil input)) ([resultWrapper1535784 input] (clojure.core/let [rawinput1535783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535785 {"Status" (clojure.core/get-in input [:status "Status"])}] (clojure.core/cond-> {} (letvar1535785 "Status") (clojure.core/assoc :status (deser-http-status (clojure.core/get-in letvar1535785 ["Status"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1535787 input] (clojure.core/let [rawinput1535786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535788 {"Type" (rawinput1535786 "Type"), "message" (rawinput1535786 "message")}] (clojure.core/cond-> {} (letvar1535788 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535788 ["Type"]))) (letvar1535788 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535788 ["message"])))))))

(clojure.core/defn- response-invalid-zip-file-exception ([input] (response-invalid-zip-file-exception nil input)) ([resultWrapper1535790 input] (clojure.core/let [rawinput1535789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535791 {"Type" (rawinput1535789 "Type"), "Message" (rawinput1535789 "Message")}] (clojure.core/cond-> {} (letvar1535791 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535791 ["Type"]))) (letvar1535791 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535791 ["Message"])))))))

(clojure.core/defn- response-list-aliases-response ([input] (response-list-aliases-response nil input)) ([resultWrapper1535793 input] (clojure.core/let [rawinput1535792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535794 {"NextMarker" (rawinput1535792 "NextMarker"), "Aliases" (rawinput1535792 "Aliases")}] (clojure.core/cond-> {} (letvar1535794 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1535794 ["NextMarker"]))) (letvar1535794 "Aliases") (clojure.core/assoc :aliases (deser-alias-list (clojure.core/get-in letvar1535794 ["Aliases"])))))))

(clojure.core/defn- response-function-configuration ([input] (response-function-configuration nil input)) ([resultWrapper1535796 input] (clojure.core/let [rawinput1535795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535797 {"TracingConfig" (rawinput1535795 "TracingConfig"), "FunctionArn" (rawinput1535795 "FunctionArn"), "FunctionName" (rawinput1535795 "FunctionName"), "Timeout" (rawinput1535795 "Timeout"), "Layers" (rawinput1535795 "Layers"), "DeadLetterConfig" (rawinput1535795 "DeadLetterConfig"), "Handler" (rawinput1535795 "Handler"), "Runtime" (rawinput1535795 "Runtime"), "MemorySize" (rawinput1535795 "MemorySize"), "Role" (rawinput1535795 "Role"), "KMSKeyArn" (rawinput1535795 "KMSKeyArn"), "Description" (rawinput1535795 "Description"), "LastModified" (rawinput1535795 "LastModified"), "Environment" (rawinput1535795 "Environment"), "CodeSize" (rawinput1535795 "CodeSize"), "VpcConfig" (rawinput1535795 "VpcConfig"), "RevisionId" (rawinput1535795 "RevisionId"), "Version" (rawinput1535795 "Version"), "CodeSha256" (rawinput1535795 "CodeSha256"), "MasterArn" (rawinput1535795 "MasterArn")}] (clojure.core/cond-> {} (letvar1535797 "TracingConfig") (clojure.core/assoc :tracing-config (deser-tracing-config-response (clojure.core/get-in letvar1535797 ["TracingConfig"]))) (letvar1535797 "FunctionArn") (clojure.core/assoc :function-arn (deser-name-spaced-function-arn (clojure.core/get-in letvar1535797 ["FunctionArn"]))) (letvar1535797 "FunctionName") (clojure.core/assoc :function-name (deser-namespaced-function-name (clojure.core/get-in letvar1535797 ["FunctionName"]))) (letvar1535797 "Timeout") (clojure.core/assoc :timeout (deser-timeout (clojure.core/get-in letvar1535797 ["Timeout"]))) (letvar1535797 "Layers") (clojure.core/assoc :layers (deser-layers-reference-list (clojure.core/get-in letvar1535797 ["Layers"]))) (letvar1535797 "DeadLetterConfig") (clojure.core/assoc :dead-letter-config (deser-dead-letter-config (clojure.core/get-in letvar1535797 ["DeadLetterConfig"]))) (letvar1535797 "Handler") (clojure.core/assoc :handler (deser-handler (clojure.core/get-in letvar1535797 ["Handler"]))) (letvar1535797 "Runtime") (clojure.core/assoc :runtime (deser-runtime (clojure.core/get-in letvar1535797 ["Runtime"]))) (letvar1535797 "MemorySize") (clojure.core/assoc :memory-size (deser-memory-size (clojure.core/get-in letvar1535797 ["MemorySize"]))) (letvar1535797 "Role") (clojure.core/assoc :role (deser-role-arn (clojure.core/get-in letvar1535797 ["Role"]))) (letvar1535797 "KMSKeyArn") (clojure.core/assoc :kms-key-arn (deser-kms-key-arn (clojure.core/get-in letvar1535797 ["KMSKeyArn"]))) (letvar1535797 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1535797 ["Description"]))) (letvar1535797 "LastModified") (clojure.core/assoc :last-modified (deser-timestamp (clojure.core/get-in letvar1535797 ["LastModified"]))) (letvar1535797 "Environment") (clojure.core/assoc :environment (deser-environment-response (clojure.core/get-in letvar1535797 ["Environment"]))) (letvar1535797 "CodeSize") (clojure.core/assoc :code-size (deser-long (clojure.core/get-in letvar1535797 ["CodeSize"]))) (letvar1535797 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config-response (clojure.core/get-in letvar1535797 ["VpcConfig"]))) (letvar1535797 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1535797 ["RevisionId"]))) (letvar1535797 "Version") (clojure.core/assoc :version (deser-version (clojure.core/get-in letvar1535797 ["Version"]))) (letvar1535797 "CodeSha256") (clojure.core/assoc :code-sha-256 (deser-string (clojure.core/get-in letvar1535797 ["CodeSha256"]))) (letvar1535797 "MasterArn") (clojure.core/assoc :master-arn (deser-function-arn (clojure.core/get-in letvar1535797 ["MasterArn"])))))))

(clojure.core/defn- response-policy-length-exceeded-exception ([input] (response-policy-length-exceeded-exception nil input)) ([resultWrapper1535799 input] (clojure.core/let [rawinput1535798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535800 {"Type" (rawinput1535798 "Type"), "message" (rawinput1535798 "message")}] (clojure.core/cond-> {} (letvar1535800 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535800 ["Type"]))) (letvar1535800 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535800 ["message"])))))))

(clojure.core/defn- response-alias-configuration ([input] (response-alias-configuration nil input)) ([resultWrapper1535802 input] (clojure.core/let [rawinput1535801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535803 {"AliasArn" (rawinput1535801 "AliasArn"), "Name" (rawinput1535801 "Name"), "FunctionVersion" (rawinput1535801 "FunctionVersion"), "Description" (rawinput1535801 "Description"), "RoutingConfig" (rawinput1535801 "RoutingConfig"), "RevisionId" (rawinput1535801 "RevisionId")}] (clojure.core/cond-> {} (letvar1535803 "AliasArn") (clojure.core/assoc :alias-arn (deser-function-arn (clojure.core/get-in letvar1535803 ["AliasArn"]))) (letvar1535803 "Name") (clojure.core/assoc :name (deser-alias (clojure.core/get-in letvar1535803 ["Name"]))) (letvar1535803 "FunctionVersion") (clojure.core/assoc :function-version (deser-version (clojure.core/get-in letvar1535803 ["FunctionVersion"]))) (letvar1535803 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1535803 ["Description"]))) (letvar1535803 "RoutingConfig") (clojure.core/assoc :routing-config (deser-alias-routing-configuration (clojure.core/get-in letvar1535803 ["RoutingConfig"]))) (letvar1535803 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1535803 ["RevisionId"])))))))

(clojure.core/defn- response-ec-2-throttled-exception ([input] (response-ec-2-throttled-exception nil input)) ([resultWrapper1535805 input] (clojure.core/let [rawinput1535804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535806 {"Type" (rawinput1535804 "Type"), "Message" (rawinput1535804 "Message")}] (clojure.core/cond-> {} (letvar1535806 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535806 ["Type"]))) (letvar1535806 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535806 ["Message"])))))))

(clojure.core/defn- response-ec-2-access-denied-exception ([input] (response-ec-2-access-denied-exception nil input)) ([resultWrapper1535808 input] (clojure.core/let [rawinput1535807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535809 {"Type" (rawinput1535807 "Type"), "Message" (rawinput1535807 "Message")}] (clojure.core/cond-> {} (letvar1535809 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535809 ["Type"]))) (letvar1535809 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535809 ["Message"])))))))

(clojure.core/defn- response-event-source-mapping-configuration ([input] (response-event-source-mapping-configuration nil input)) ([resultWrapper1535811 input] (clojure.core/let [rawinput1535810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535812 {"UUID" (rawinput1535810 "UUID"), "BatchSize" (rawinput1535810 "BatchSize"), "EventSourceArn" (rawinput1535810 "EventSourceArn"), "FunctionArn" (rawinput1535810 "FunctionArn"), "LastModified" (rawinput1535810 "LastModified"), "LastProcessingResult" (rawinput1535810 "LastProcessingResult"), "State" (rawinput1535810 "State"), "StateTransitionReason" (rawinput1535810 "StateTransitionReason")}] (clojure.core/cond-> {} (letvar1535812 "UUID") (clojure.core/assoc :uuid (deser-string (clojure.core/get-in letvar1535812 ["UUID"]))) (letvar1535812 "BatchSize") (clojure.core/assoc :batch-size (deser-batch-size (clojure.core/get-in letvar1535812 ["BatchSize"]))) (letvar1535812 "EventSourceArn") (clojure.core/assoc :event-source-arn (deser-arn (clojure.core/get-in letvar1535812 ["EventSourceArn"]))) (letvar1535812 "FunctionArn") (clojure.core/assoc :function-arn (deser-function-arn (clojure.core/get-in letvar1535812 ["FunctionArn"]))) (letvar1535812 "LastModified") (clojure.core/assoc :last-modified (deser-date (clojure.core/get-in letvar1535812 ["LastModified"]))) (letvar1535812 "LastProcessingResult") (clojure.core/assoc :last-processing-result (deser-string (clojure.core/get-in letvar1535812 ["LastProcessingResult"]))) (letvar1535812 "State") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1535812 ["State"]))) (letvar1535812 "StateTransitionReason") (clojure.core/assoc :state-transition-reason (deser-string (clojure.core/get-in letvar1535812 ["StateTransitionReason"])))))))

(clojure.core/defn- response-ec-2-unexpected-exception ([input] (response-ec-2-unexpected-exception nil input)) ([resultWrapper1535814 input] (clojure.core/let [rawinput1535813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535815 {"Type" (rawinput1535813 "Type"), "Message" (rawinput1535813 "Message"), "EC2ErrorCode" (rawinput1535813 "EC2ErrorCode")}] (clojure.core/cond-> {} (letvar1535815 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535815 ["Type"]))) (letvar1535815 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535815 ["Message"]))) (letvar1535815 "EC2ErrorCode") (clojure.core/assoc :ec-2-error-code (deser-string (clojure.core/get-in letvar1535815 ["EC2ErrorCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1535817 input] (clojure.core/let [rawinput1535816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535818 {"Type" (rawinput1535816 "Type"), "message" (rawinput1535816 "message")}] (clojure.core/cond-> {} (letvar1535818 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535818 ["Type"]))) (letvar1535818 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535818 ["message"])))))))

(clojure.core/defn- response-invalid-security-group-id-exception ([input] (response-invalid-security-group-id-exception nil input)) ([resultWrapper1535820 input] (clojure.core/let [rawinput1535819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535821 {"Type" (rawinput1535819 "Type"), "Message" (rawinput1535819 "Message")}] (clojure.core/cond-> {} (letvar1535821 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1535821 ["Type"]))) (letvar1535821 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1535821 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-policy-response ([input] (response-get-layer-version-policy-response nil input)) ([resultWrapper1535823 input] (clojure.core/let [rawinput1535822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1535824 {"Policy" (rawinput1535822 "Policy"), "RevisionId" (rawinput1535822 "RevisionId")}] (clojure.core/cond-> {} (letvar1535824 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1535824 ["Policy"]))) (letvar1535824 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1535824 ["RevisionId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-permission-allowed-action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"lambda:GetLayerVersion" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[^\s]+" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 170)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"\d{12}" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 100)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"o-[a-z0-9]{10,32}" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[0-9]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 100)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/license-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 0 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.lambda/tag-value (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.lambda/layer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+)|[a-zA-Z0-9-_]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/layer-version-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+:[0-9]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z0-9-]*):([a-zA-Z0-9\-])+:([a-z]{2}(-gov)?-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 3 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 63)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 128)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 0 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 256)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__1531357__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 1024)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531355__auto__] (clojure.core/<= 1 (clojure.core/count s__1531355__auto__))) (clojure.core/fn [s__1531356__auto__] (clojure.core/< (clojure.core/count s__1531356__auto__) 140)) (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #".*" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__1531357__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-permission-allowed-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1531357__auto__] (clojure.core/re-matches #"\d{12}|\*|arn:(aws[a-zA-Z-]*):iam::\d{12}:root" s__1531357__auto__))))
