...
(clojure.core/defn- response-list-layers-response ([input] (response-list-layers-response nil input)) ([resultWrapper1213691 input] (clojure.core/let [rawinput1213690 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213692 {"NextMarker" (rawinput1213690 "NextMarker"), "Layers" (rawinput1213690 "Layers")}] (clojure.core/cond-> {} (letvar1213692 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213692 ["NextMarker"]))) (letvar1213692 "Layers") (clojure.core/assoc :layers (deser-layers-list (clojure.core/get-in letvar1213692 ["Layers"])))))))

(clojure.core/defn- response-unsupported-media-type-exception ([input] (response-unsupported-media-type-exception nil input)) ([resultWrapper1213694 input] (clojure.core/let [rawinput1213693 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213695 {"Type" (rawinput1213693 "Type"), "message" (rawinput1213693 "message")}] (clojure.core/cond-> {} (letvar1213695 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213695 ["Type"]))) (letvar1213695 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213695 ["message"])))))))

(clojure.core/defn- response-request-too-large-exception ([input] (response-request-too-large-exception nil input)) ([resultWrapper1213697 input] (clojure.core/let [rawinput1213696 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213698 {"Type" (rawinput1213696 "Type"), "message" (rawinput1213696 "message")}] (clojure.core/cond-> {} (letvar1213698 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213698 ["Type"]))) (letvar1213698 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213698 ["message"])))))))

(clojure.core/defn- response-invalid-subnet-id-exception ([input] (response-invalid-subnet-id-exception nil input)) ([resultWrapper1213700 input] (clojure.core/let [rawinput1213699 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213701 {"Type" (rawinput1213699 "Type"), "Message" (rawinput1213699 "Message")}] (clojure.core/cond-> {} (letvar1213701 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213701 ["Type"]))) (letvar1213701 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213701 ["Message"])))))))

(clojure.core/defn- response-list-layer-versions-response ([input] (response-list-layer-versions-response nil input)) ([resultWrapper1213703 input] (clojure.core/let [rawinput1213702 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213704 {"NextMarker" (rawinput1213702 "NextMarker"), "LayerVersions" (rawinput1213702 "LayerVersions")}] (clojure.core/cond-> {} (letvar1213704 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213704 ["NextMarker"]))) (letvar1213704 "LayerVersions") (clojure.core/assoc :layer-versions (deser-layer-versions-list (clojure.core/get-in letvar1213704 ["LayerVersions"])))))))

(clojure.core/defn- response-subnet-ip-address-limit-reached-exception ([input] (response-subnet-ip-address-limit-reached-exception nil input)) ([resultWrapper1213706 input] (clojure.core/let [rawinput1213705 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213707 {"Type" (rawinput1213705 "Type"), "Message" (rawinput1213705 "Message")}] (clojure.core/cond-> {} (letvar1213707 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213707 ["Type"]))) (letvar1213707 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213707 ["Message"])))))))

(clojure.core/defn- response-precondition-failed-exception ([input] (response-precondition-failed-exception nil input)) ([resultWrapper1213709 input] (clojure.core/let [rawinput1213708 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213710 {"Type" (rawinput1213708 "Type"), "message" (rawinput1213708 "message")}] (clojure.core/cond-> {} (letvar1213710 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213710 ["Type"]))) (letvar1213710 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213710 ["message"])))))))

(clojure.core/defn- response-list-versions-by-function-response ([input] (response-list-versions-by-function-response nil input)) ([resultWrapper1213712 input] (clojure.core/let [rawinput1213711 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213713 {"NextMarker" (rawinput1213711 "NextMarker"), "Versions" (rawinput1213711 "Versions")}] (clojure.core/cond-> {} (letvar1213713 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213713 ["NextMarker"]))) (letvar1213713 "Versions") (clojure.core/assoc :versions (deser-function-list (clojure.core/get-in letvar1213713 ["Versions"])))))))

(clojure.core/defn- response-list-tags-response ([input] (response-list-tags-response nil input)) ([resultWrapper1213715 input] (clojure.core/let [rawinput1213714 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213716 {"Tags" (rawinput1213714 "Tags")}] (clojure.core/cond-> {} (letvar1213716 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1213716 ["Tags"])))))))

(clojure.core/defn- response-service-exception ([input] (response-service-exception nil input)) ([resultWrapper1213718 input] (clojure.core/let [rawinput1213717 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213719 {"Type" (rawinput1213717 "Type"), "Message" (rawinput1213717 "Message")}] (clojure.core/cond-> {} (letvar1213719 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213719 ["Type"]))) (letvar1213719 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213719 ["Message"])))))))

(clojure.core/defn- response-list-event-source-mappings-response ([input] (response-list-event-source-mappings-response nil input)) ([resultWrapper1213721 input] (clojure.core/let [rawinput1213720 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213722 {"NextMarker" (rawinput1213720 "NextMarker"), "EventSourceMappings" (rawinput1213720 "EventSourceMappings")}] (clojure.core/cond-> {} (letvar1213722 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213722 ["NextMarker"]))) (letvar1213722 "EventSourceMappings") (clojure.core/assoc :event-source-mappings (deser-event-source-mappings-list (clojure.core/get-in letvar1213722 ["EventSourceMappings"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1213724 input] (clojure.core/let [rawinput1213723 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213725 {"Type" (rawinput1213723 "Type"), "Message" (rawinput1213723 "Message")}] (clojure.core/cond-> {} (letvar1213725 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213725 ["Type"]))) (letvar1213725 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213725 ["Message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1213727 input] (clojure.core/let [rawinput1213726 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213728 {"Type" (rawinput1213726 "Type"), "Message" (rawinput1213726 "Message")}] (clojure.core/cond-> {} (letvar1213728 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213728 ["Type"]))) (letvar1213728 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213728 ["Message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1213730 input] (clojure.core/let [rawinput1213729 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213731 {"Type" (rawinput1213729 "Type"), "Message" (rawinput1213729 "Message")}] (clojure.core/cond-> {} (letvar1213731 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213731 ["Type"]))) (letvar1213731 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213731 ["Message"])))))))

(clojure.core/defn- response-invalid-runtime-exception ([input] (response-invalid-runtime-exception nil input)) ([resultWrapper1213733 input] (clojure.core/let [rawinput1213732 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213734 {"Type" (rawinput1213732 "Type"), "Message" (rawinput1213732 "Message")}] (clojure.core/cond-> {} (letvar1213734 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213734 ["Type"]))) (letvar1213734 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213734 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-response ([input] (response-get-layer-version-response nil input)) ([resultWrapper1213736 input] (clojure.core/let [rawinput1213735 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213737 {"Content" (rawinput1213735 "Content"), "LayerArn" (rawinput1213735 "LayerArn"), "LayerVersionArn" (rawinput1213735 "LayerVersionArn"), "Description" (rawinput1213735 "Description"), "CreatedDate" (rawinput1213735 "CreatedDate"), "Version" (rawinput1213735 "Version"), "CompatibleRuntimes" (rawinput1213735 "CompatibleRuntimes"), "LicenseInfo" (rawinput1213735 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1213737 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1213737 ["Content"]))) (letvar1213737 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1213737 ["LayerArn"]))) (letvar1213737 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1213737 ["LayerVersionArn"]))) (letvar1213737 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1213737 ["Description"]))) (letvar1213737 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1213737 ["CreatedDate"]))) (letvar1213737 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1213737 ["Version"]))) (letvar1213737 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1213737 ["CompatibleRuntimes"]))) (letvar1213737 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1213737 ["LicenseInfo"])))))))

(clojure.core/defn- response-list-functions-response ([input] (response-list-functions-response nil input)) ([resultWrapper1213739 input] (clojure.core/let [rawinput1213738 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213740 {"NextMarker" (rawinput1213738 "NextMarker"), "Functions" (rawinput1213738 "Functions")}] (clojure.core/cond-> {} (letvar1213740 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213740 ["NextMarker"]))) (letvar1213740 "Functions") (clojure.core/assoc :functions (deser-function-list (clojure.core/get-in letvar1213740 ["Functions"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1213742 input] (clojure.core/let [rawinput1213741 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213743 {"Type" (rawinput1213741 "Type"), "Message" (rawinput1213741 "Message")}] (clojure.core/cond-> {} (letvar1213743 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213743 ["Type"]))) (letvar1213743 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213743 ["Message"])))))))

(clojure.core/defn- response-get-function-response ([input] (response-get-function-response nil input)) ([resultWrapper1213745 input] (clojure.core/let [rawinput1213744 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213746 {"Configuration" (rawinput1213744 "Configuration"), "Code" (rawinput1213744 "Code"), "Tags" (rawinput1213744 "Tags"), "Concurrency" (rawinput1213744 "Concurrency")}] (clojure.core/cond-> {} (letvar1213746 "Configuration") (clojure.core/assoc :configuration (deser-function-configuration (clojure.core/get-in letvar1213746 ["Configuration"]))) (letvar1213746 "Code") (clojure.core/assoc :code (deser-function-code-location (clojure.core/get-in letvar1213746 ["Code"]))) (letvar1213746 "Tags") (clojure.core/assoc :tags (deser-tags (clojure.core/get-in letvar1213746 ["Tags"]))) (letvar1213746 "Concurrency") (clojure.core/assoc :concurrency (deser-concurrency (clojure.core/get-in letvar1213746 ["Concurrency"])))))))

(clojure.core/defn- response-code-storage-exceeded-exception ([input] (response-code-storage-exceeded-exception nil input)) ([resultWrapper1213748 input] (clojure.core/let [rawinput1213747 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213749 {"Type" (rawinput1213747 "Type"), "message" (rawinput1213747 "message")}] (clojure.core/cond-> {} (letvar1213749 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213749 ["Type"]))) (letvar1213749 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213749 ["message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper1213751 input] (clojure.core/let [rawinput1213750 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213752 {"Retry-After" (clojure.core/get-in input [:headers "Retry-After"]), "Type" (rawinput1213750 "Type"), "message" (rawinput1213750 "message"), "Reason" (rawinput1213750 "Reason")}] (clojure.core/cond-> {} (letvar1213752 "Retry-After") (clojure.core/assoc :retry-after-seconds (deser-string (clojure.core/get-in letvar1213752 ["Retry-After"]))) (letvar1213752 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213752 ["Type"]))) (letvar1213752 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213752 ["message"]))) (letvar1213752 "Reason") (clojure.core/assoc :reason (deser-throttle-reason (clojure.core/get-in letvar1213752 ["Reason"])))))))

(clojure.core/defn- response-invalid-request-content-exception ([input] (response-invalid-request-content-exception nil input)) ([resultWrapper1213754 input] (clojure.core/let [rawinput1213753 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213755 {"Type" (rawinput1213753 "Type"), "message" (rawinput1213753 "message")}] (clojure.core/cond-> {} (letvar1213755 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213755 ["Type"]))) (letvar1213755 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213755 ["message"])))))))

(clojure.core/defn- response-add-layer-version-permission-response ([input] (response-add-layer-version-permission-response nil input)) ([resultWrapper1213757 input] (clojure.core/let [rawinput1213756 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213758 {"Statement" (rawinput1213756 "Statement"), "RevisionId" (rawinput1213756 "RevisionId")}] (clojure.core/cond-> {} (letvar1213758 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1213758 ["Statement"]))) (letvar1213758 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1213758 ["RevisionId"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1213760 input] (clojure.core/let [rawinput1213759 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213761 {"Type" (rawinput1213759 "Type"), "Message" (rawinput1213759 "Message")}] (clojure.core/cond-> {} (letvar1213761 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213761 ["Type"]))) (letvar1213761 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213761 ["Message"])))))))

(clojure.core/defn- response-get-account-settings-response ([input] (response-get-account-settings-response nil input)) ([resultWrapper1213763 input] (clojure.core/let [rawinput1213762 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213764 {"AccountLimit" (rawinput1213762 "AccountLimit"), "AccountUsage" (rawinput1213762 "AccountUsage")}] (clojure.core/cond-> {} (letvar1213764 "AccountLimit") (clojure.core/assoc :account-limit (deser-account-limit (clojure.core/get-in letvar1213764 ["AccountLimit"]))) (letvar1213764 "AccountUsage") (clojure.core/assoc :account-usage (deser-account-usage (clojure.core/get-in letvar1213764 ["AccountUsage"])))))))

(clojure.core/defn- response-eni-limit-reached-exception ([input] (response-eni-limit-reached-exception nil input)) ([resultWrapper1213766 input] (clojure.core/let [rawinput1213765 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213767 {"Type" (rawinput1213765 "Type"), "Message" (rawinput1213765 "Message")}] (clojure.core/cond-> {} (letvar1213767 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213767 ["Type"]))) (letvar1213767 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213767 ["Message"])))))))

(clojure.core/defn- response-concurrency ([input] (response-concurrency nil input)) ([resultWrapper1213769 input] (clojure.core/let [rawinput1213768 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213770 {"ReservedConcurrentExecutions" (rawinput1213768 "ReservedConcurrentExecutions")}] (clojure.core/cond-> {} (letvar1213770 "ReservedConcurrentExecutions") (clojure.core/assoc :reserved-concurrent-executions (deser-reserved-concurrent-executions (clojure.core/get-in letvar1213770 ["ReservedConcurrentExecutions"])))))))

(clojure.core/defn- response-add-permission-response ([input] (response-add-permission-response nil input)) ([resultWrapper1213772 input] (clojure.core/let [rawinput1213771 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213773 {"Statement" (rawinput1213771 "Statement")}] (clojure.core/cond-> {} (letvar1213773 "Statement") (clojure.core/assoc :statement (deser-string (clojure.core/get-in letvar1213773 ["Statement"])))))))

(clojure.core/defn- response-invocation-response ([input] (response-invocation-response nil input)) ([resultWrapper1213775 input] (clojure.core/let [rawinput1213774 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213776 {"StatusCode" (clojure.core/get-in input [:status "StatusCode"]), "X-Amz-Function-Error" (clojure.core/get-in input [:headers "X-Amz-Function-Error"]), "X-Amz-Log-Result" (clojure.core/get-in input [:headers "X-Amz-Log-Result"]), "Payload" (rawinput1213774 "Payload"), "X-Amz-Executed-Version" (clojure.core/get-in input [:headers "X-Amz-Executed-Version"])}] (clojure.core/cond-> {} (letvar1213776 "StatusCode") (clojure.core/assoc :status-code (deser-integer (clojure.core/get-in letvar1213776 ["StatusCode"]))) (letvar1213776 "X-Amz-Function-Error") (clojure.core/assoc :function-error (deser-string (clojure.core/get-in letvar1213776 ["X-Amz-Function-Error"]))) (letvar1213776 "X-Amz-Log-Result") (clojure.core/assoc :log-result (deser-string (clojure.core/get-in letvar1213776 ["X-Amz-Log-Result"]))) (letvar1213776 "Payload") (clojure.core/assoc :payload (deser-blob (clojure.core/get-in letvar1213776 ["Payload"]))) (letvar1213776 "X-Amz-Executed-Version") (clojure.core/assoc :executed-version (deser-version (clojure.core/get-in letvar1213776 ["X-Amz-Executed-Version"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1213778 input] (clojure.core/let [rawinput1213777 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213779 {"Type" (rawinput1213777 "Type"), "Message" (rawinput1213777 "Message")}] (clojure.core/cond-> {} (letvar1213779 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213779 ["Type"]))) (letvar1213779 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213779 ["Message"])))))))

(clojure.core/defn- response-publish-layer-version-response ([input] (response-publish-layer-version-response nil input)) ([resultWrapper1213781 input] (clojure.core/let [rawinput1213780 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213782 {"Content" (rawinput1213780 "Content"), "LayerArn" (rawinput1213780 "LayerArn"), "LayerVersionArn" (rawinput1213780 "LayerVersionArn"), "Description" (rawinput1213780 "Description"), "CreatedDate" (rawinput1213780 "CreatedDate"), "Version" (rawinput1213780 "Version"), "CompatibleRuntimes" (rawinput1213780 "CompatibleRuntimes"), "LicenseInfo" (rawinput1213780 "LicenseInfo")}] (clojure.core/cond-> {} (letvar1213782 "Content") (clojure.core/assoc :content (deser-layer-version-content-output (clojure.core/get-in letvar1213782 ["Content"]))) (letvar1213782 "LayerArn") (clojure.core/assoc :layer-arn (deser-layer-arn (clojure.core/get-in letvar1213782 ["LayerArn"]))) (letvar1213782 "LayerVersionArn") (clojure.core/assoc :layer-version-arn (deser-layer-version-arn (clojure.core/get-in letvar1213782 ["LayerVersionArn"]))) (letvar1213782 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1213782 ["Description"]))) (letvar1213782 "CreatedDate") (clojure.core/assoc :created-date (deser-timestamp (clojure.core/get-in letvar1213782 ["CreatedDate"]))) (letvar1213782 "Version") (clojure.core/assoc :version (deser-layer-version-number (clojure.core/get-in letvar1213782 ["Version"]))) (letvar1213782 "CompatibleRuntimes") (clojure.core/assoc :compatible-runtimes (deser-compatible-runtimes (clojure.core/get-in letvar1213782 ["CompatibleRuntimes"]))) (letvar1213782 "LicenseInfo") (clojure.core/assoc :license-info (deser-license-info (clojure.core/get-in letvar1213782 ["LicenseInfo"])))))))

(clojure.core/defn- response-get-policy-response ([input] (response-get-policy-response nil input)) ([resultWrapper1213784 input] (clojure.core/let [rawinput1213783 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213785 {"Policy" (rawinput1213783 "Policy"), "RevisionId" (rawinput1213783 "RevisionId")}] (clojure.core/cond-> {} (letvar1213785 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1213785 ["Policy"]))) (letvar1213785 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1213785 ["RevisionId"])))))))

(clojure.core/defn- response-invoke-async-response ([input] (response-invoke-async-response nil input)) ([resultWrapper1213787 input] (clojure.core/let [rawinput1213786 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213788 {"Status" (clojure.core/get-in input [:status "Status"])}] (clojure.core/cond-> {} (letvar1213788 "Status") (clojure.core/assoc :status (deser-http-status (clojure.core/get-in letvar1213788 ["Status"])))))))

(clojure.core/defn- response-resource-conflict-exception ([input] (response-resource-conflict-exception nil input)) ([resultWrapper1213790 input] (clojure.core/let [rawinput1213789 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213791 {"Type" (rawinput1213789 "Type"), "message" (rawinput1213789 "message")}] (clojure.core/cond-> {} (letvar1213791 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213791 ["Type"]))) (letvar1213791 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213791 ["message"])))))))

(clojure.core/defn- response-invalid-zip-file-exception ([input] (response-invalid-zip-file-exception nil input)) ([resultWrapper1213793 input] (clojure.core/let [rawinput1213792 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213794 {"Type" (rawinput1213792 "Type"), "Message" (rawinput1213792 "Message")}] (clojure.core/cond-> {} (letvar1213794 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213794 ["Type"]))) (letvar1213794 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213794 ["Message"])))))))

(clojure.core/defn- response-list-aliases-response ([input] (response-list-aliases-response nil input)) ([resultWrapper1213796 input] (clojure.core/let [rawinput1213795 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213797 {"NextMarker" (rawinput1213795 "NextMarker"), "Aliases" (rawinput1213795 "Aliases")}] (clojure.core/cond-> {} (letvar1213797 "NextMarker") (clojure.core/assoc :next-marker (deser-string (clojure.core/get-in letvar1213797 ["NextMarker"]))) (letvar1213797 "Aliases") (clojure.core/assoc :aliases (deser-alias-list (clojure.core/get-in letvar1213797 ["Aliases"])))))))

(clojure.core/defn- response-function-configuration ([input] (response-function-configuration nil input)) ([resultWrapper1213799 input] (clojure.core/let [rawinput1213798 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213800 {"TracingConfig" (rawinput1213798 "TracingConfig"), "FunctionArn" (rawinput1213798 "FunctionArn"), "FunctionName" (rawinput1213798 "FunctionName"), "Timeout" (rawinput1213798 "Timeout"), "Layers" (rawinput1213798 "Layers"), "DeadLetterConfig" (rawinput1213798 "DeadLetterConfig"), "Handler" (rawinput1213798 "Handler"), "Runtime" (rawinput1213798 "Runtime"), "MemorySize" (rawinput1213798 "MemorySize"), "Role" (rawinput1213798 "Role"), "KMSKeyArn" (rawinput1213798 "KMSKeyArn"), "Description" (rawinput1213798 "Description"), "LastModified" (rawinput1213798 "LastModified"), "Environment" (rawinput1213798 "Environment"), "CodeSize" (rawinput1213798 "CodeSize"), "VpcConfig" (rawinput1213798 "VpcConfig"), "RevisionId" (rawinput1213798 "RevisionId"), "Version" (rawinput1213798 "Version"), "CodeSha256" (rawinput1213798 "CodeSha256"), "MasterArn" (rawinput1213798 "MasterArn")}] (clojure.core/cond-> {} (letvar1213800 "TracingConfig") (clojure.core/assoc :tracing-config (deser-tracing-config-response (clojure.core/get-in letvar1213800 ["TracingConfig"]))) (letvar1213800 "FunctionArn") (clojure.core/assoc :function-arn (deser-name-spaced-function-arn (clojure.core/get-in letvar1213800 ["FunctionArn"]))) (letvar1213800 "FunctionName") (clojure.core/assoc :function-name (deser-namespaced-function-name (clojure.core/get-in letvar1213800 ["FunctionName"]))) (letvar1213800 "Timeout") (clojure.core/assoc :timeout (deser-timeout (clojure.core/get-in letvar1213800 ["Timeout"]))) (letvar1213800 "Layers") (clojure.core/assoc :layers (deser-layers-reference-list (clojure.core/get-in letvar1213800 ["Layers"]))) (letvar1213800 "DeadLetterConfig") (clojure.core/assoc :dead-letter-config (deser-dead-letter-config (clojure.core/get-in letvar1213800 ["DeadLetterConfig"]))) (letvar1213800 "Handler") (clojure.core/assoc :handler (deser-handler (clojure.core/get-in letvar1213800 ["Handler"]))) (letvar1213800 "Runtime") (clojure.core/assoc :runtime (deser-runtime (clojure.core/get-in letvar1213800 ["Runtime"]))) (letvar1213800 "MemorySize") (clojure.core/assoc :memory-size (deser-memory-size (clojure.core/get-in letvar1213800 ["MemorySize"]))) (letvar1213800 "Role") (clojure.core/assoc :role (deser-role-arn (clojure.core/get-in letvar1213800 ["Role"]))) (letvar1213800 "KMSKeyArn") (clojure.core/assoc :kms-key-arn (deser-kms-key-arn (clojure.core/get-in letvar1213800 ["KMSKeyArn"]))) (letvar1213800 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1213800 ["Description"]))) (letvar1213800 "LastModified") (clojure.core/assoc :last-modified (deser-timestamp (clojure.core/get-in letvar1213800 ["LastModified"]))) (letvar1213800 "Environment") (clojure.core/assoc :environment (deser-environment-response (clojure.core/get-in letvar1213800 ["Environment"]))) (letvar1213800 "CodeSize") (clojure.core/assoc :code-size (deser-long (clojure.core/get-in letvar1213800 ["CodeSize"]))) (letvar1213800 "VpcConfig") (clojure.core/assoc :vpc-config (deser-vpc-config-response (clojure.core/get-in letvar1213800 ["VpcConfig"]))) (letvar1213800 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1213800 ["RevisionId"]))) (letvar1213800 "Version") (clojure.core/assoc :version (deser-version (clojure.core/get-in letvar1213800 ["Version"]))) (letvar1213800 "CodeSha256") (clojure.core/assoc :code-sha-256 (deser-string (clojure.core/get-in letvar1213800 ["CodeSha256"]))) (letvar1213800 "MasterArn") (clojure.core/assoc :master-arn (deser-function-arn (clojure.core/get-in letvar1213800 ["MasterArn"])))))))

(clojure.core/defn- response-policy-length-exceeded-exception ([input] (response-policy-length-exceeded-exception nil input)) ([resultWrapper1213802 input] (clojure.core/let [rawinput1213801 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213803 {"Type" (rawinput1213801 "Type"), "message" (rawinput1213801 "message")}] (clojure.core/cond-> {} (letvar1213803 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213803 ["Type"]))) (letvar1213803 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213803 ["message"])))))))

(clojure.core/defn- response-alias-configuration ([input] (response-alias-configuration nil input)) ([resultWrapper1213805 input] (clojure.core/let [rawinput1213804 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213806 {"AliasArn" (rawinput1213804 "AliasArn"), "Name" (rawinput1213804 "Name"), "FunctionVersion" (rawinput1213804 "FunctionVersion"), "Description" (rawinput1213804 "Description"), "RoutingConfig" (rawinput1213804 "RoutingConfig"), "RevisionId" (rawinput1213804 "RevisionId")}] (clojure.core/cond-> {} (letvar1213806 "AliasArn") (clojure.core/assoc :alias-arn (deser-function-arn (clojure.core/get-in letvar1213806 ["AliasArn"]))) (letvar1213806 "Name") (clojure.core/assoc :name (deser-alias (clojure.core/get-in letvar1213806 ["Name"]))) (letvar1213806 "FunctionVersion") (clojure.core/assoc :function-version (deser-version (clojure.core/get-in letvar1213806 ["FunctionVersion"]))) (letvar1213806 "Description") (clojure.core/assoc :description (deser-description (clojure.core/get-in letvar1213806 ["Description"]))) (letvar1213806 "RoutingConfig") (clojure.core/assoc :routing-config (deser-alias-routing-configuration (clojure.core/get-in letvar1213806 ["RoutingConfig"]))) (letvar1213806 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1213806 ["RevisionId"])))))))

(clojure.core/defn- response-ec-2-throttled-exception ([input] (response-ec-2-throttled-exception nil input)) ([resultWrapper1213808 input] (clojure.core/let [rawinput1213807 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213809 {"Type" (rawinput1213807 "Type"), "Message" (rawinput1213807 "Message")}] (clojure.core/cond-> {} (letvar1213809 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213809 ["Type"]))) (letvar1213809 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213809 ["Message"])))))))

(clojure.core/defn- response-ec-2-access-denied-exception ([input] (response-ec-2-access-denied-exception nil input)) ([resultWrapper1213811 input] (clojure.core/let [rawinput1213810 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213812 {"Type" (rawinput1213810 "Type"), "Message" (rawinput1213810 "Message")}] (clojure.core/cond-> {} (letvar1213812 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213812 ["Type"]))) (letvar1213812 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213812 ["Message"])))))))

(clojure.core/defn- response-event-source-mapping-configuration ([input] (response-event-source-mapping-configuration nil input)) ([resultWrapper1213814 input] (clojure.core/let [rawinput1213813 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213815 {"UUID" (rawinput1213813 "UUID"), "BatchSize" (rawinput1213813 "BatchSize"), "EventSourceArn" (rawinput1213813 "EventSourceArn"), "FunctionArn" (rawinput1213813 "FunctionArn"), "LastModified" (rawinput1213813 "LastModified"), "LastProcessingResult" (rawinput1213813 "LastProcessingResult"), "State" (rawinput1213813 "State"), "StateTransitionReason" (rawinput1213813 "StateTransitionReason")}] (clojure.core/cond-> {} (letvar1213815 "UUID") (clojure.core/assoc :uuid (deser-string (clojure.core/get-in letvar1213815 ["UUID"]))) (letvar1213815 "BatchSize") (clojure.core/assoc :batch-size (deser-batch-size (clojure.core/get-in letvar1213815 ["BatchSize"]))) (letvar1213815 "EventSourceArn") (clojure.core/assoc :event-source-arn (deser-arn (clojure.core/get-in letvar1213815 ["EventSourceArn"]))) (letvar1213815 "FunctionArn") (clojure.core/assoc :function-arn (deser-function-arn (clojure.core/get-in letvar1213815 ["FunctionArn"]))) (letvar1213815 "LastModified") (clojure.core/assoc :last-modified (deser-date (clojure.core/get-in letvar1213815 ["LastModified"]))) (letvar1213815 "LastProcessingResult") (clojure.core/assoc :last-processing-result (deser-string (clojure.core/get-in letvar1213815 ["LastProcessingResult"]))) (letvar1213815 "State") (clojure.core/assoc :state (deser-string (clojure.core/get-in letvar1213815 ["State"]))) (letvar1213815 "StateTransitionReason") (clojure.core/assoc :state-transition-reason (deser-string (clojure.core/get-in letvar1213815 ["StateTransitionReason"])))))))

(clojure.core/defn- response-ec-2-unexpected-exception ([input] (response-ec-2-unexpected-exception nil input)) ([resultWrapper1213817 input] (clojure.core/let [rawinput1213816 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213818 {"Type" (rawinput1213816 "Type"), "Message" (rawinput1213816 "Message"), "EC2ErrorCode" (rawinput1213816 "EC2ErrorCode")}] (clojure.core/cond-> {} (letvar1213818 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213818 ["Type"]))) (letvar1213818 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213818 ["Message"]))) (letvar1213818 "EC2ErrorCode") (clojure.core/assoc :ec-2-error-code (deser-string (clojure.core/get-in letvar1213818 ["EC2ErrorCode"])))))))

(clojure.core/defn- response-invalid-parameter-value-exception ([input] (response-invalid-parameter-value-exception nil input)) ([resultWrapper1213820 input] (clojure.core/let [rawinput1213819 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213821 {"Type" (rawinput1213819 "Type"), "message" (rawinput1213819 "message")}] (clojure.core/cond-> {} (letvar1213821 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213821 ["Type"]))) (letvar1213821 "message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213821 ["message"])))))))

(clojure.core/defn- response-invalid-security-group-id-exception ([input] (response-invalid-security-group-id-exception nil input)) ([resultWrapper1213823 input] (clojure.core/let [rawinput1213822 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213824 {"Type" (rawinput1213822 "Type"), "Message" (rawinput1213822 "Message")}] (clojure.core/cond-> {} (letvar1213824 "Type") (clojure.core/assoc :type (deser-string (clojure.core/get-in letvar1213824 ["Type"]))) (letvar1213824 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1213824 ["Message"])))))))

(clojure.core/defn- response-get-layer-version-policy-response ([input] (response-get-layer-version-policy-response nil input)) ([resultWrapper1213826 input] (clojure.core/let [rawinput1213825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1213827 {"Policy" (rawinput1213825 "Policy"), "RevisionId" (rawinput1213825 "RevisionId")}] (clojure.core/cond-> {} (letvar1213827 "Policy") (clojure.core/assoc :policy (deser-string (clojure.core/get-in letvar1213827 ["Policy"]))) (letvar1213827 "RevisionId") (clojure.core/assoc :revision-id (deser-string (clojure.core/get-in letvar1213827 ["RevisionId"])))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-permission-allowed-action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"lambda:GetLayerVersion" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[^\s]+" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 170)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:lambda:)?([a-z]{2}(-gov)?-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{12}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/organization-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"o-[a-z0-9]{10,32}" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/license-info (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kms-key-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))

(clojure.spec.alpha/def :portkey.aws.lambda/tag-value (clojure.spec.alpha/and clojure.core/string?))

(clojure.spec.alpha/def :portkey.aws.lambda/layer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+)|[a-zA-Z0-9-_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/layer-version-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+:[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z0-9-]*):([a-zA-Z0-9\-])+:([a-z]{2}(-gov)?-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s-3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 3 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 63)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(arn:(aws[a-zA-Z-]*)?:[a-z0-9-.]+:.*)|()" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1024)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 140)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:[a-zA-Z0-9-]+:lambda:[a-zA-Z0-9-]+:\d{12}:layer:[a-zA-Z0-9-_]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #".*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}(-gov)?-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/layer-permission-allowed-principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\d{12}|\*|arn:(aws[a-zA-Z-]*):iam::\d{12}:root" s__21078__auto__))))
