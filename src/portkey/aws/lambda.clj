...
(clojure.core/defn req<-tag-resource-request [resp-input63294] {:uri {"Resource" (ser-function-arn (resp-input63294 :resource))}, :body {"Tags" (ser-tags (resp-input63294 :tags))}})
(clojure.core/defn req<-create-alias-request [resp-input63295] (clojure.core/let [input63296 {:uri {"FunctionName" (ser-function-name (resp-input63295 :function-name))}, :body {"Name" (ser-alias (resp-input63295 :name)), "FunctionVersion" (ser-version (resp-input63295 :function-version))}}] (clojure.core/cond-> input63296 (clojure.core/contains? resp-input63295 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input63295 :description))) (clojure.core/contains? resp-input63295 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (resp-input63295 :routing-config))))))
(clojure.core/defn req<-delete-function-request [resp-input63297] (clojure.core/let [input63298 {:uri {"FunctionName" (ser-function-name (resp-input63297 :function-name))}}] (clojure.core/cond-> input63298 (clojure.core/contains? resp-input63297 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63297 :qualifier))))))
(clojure.core/defn req<-list-event-source-mappings-request [resp-input63299] (clojure.core/cond-> {} (clojure.core/contains? resp-input63299 :event-source-arn) (clojure.core/assoc-in [:query-string "EventSourceArn"] (ser-arn (resp-input63299 :event-source-arn))) (clojure.core/contains? resp-input63299 :function-name) (clojure.core/assoc-in [:query-string "FunctionName"] (ser-function-name (resp-input63299 :function-name))) (clojure.core/contains? resp-input63299 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input63299 :marker))) (clojure.core/contains? resp-input63299 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input63299 :max-items)))))
(clojure.core/defn req<-delete-function-concurrency-request [resp-input63300] {:uri {"FunctionName" (ser-function-name (resp-input63300 :function-name))}})
(clojure.core/defn req<-delete-event-source-mapping-request [resp-input63301] {:uri {"UUID" (ser-string (resp-input63301 :uuid))}})
(clojure.core/defn req<-invocation-request [resp-input63302] (clojure.core/let [input63303 {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63302 :function-name))}}] (clojure.core/cond-> input63303 (clojure.core/contains? resp-input63302 :invocation-type) (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type (resp-input63302 :invocation-type))) (clojure.core/contains? resp-input63302 :log-type) (clojure.core/assoc-in [:headers "LogType"] (ser-log-type (resp-input63302 :log-type))) (clojure.core/contains? resp-input63302 :client-context) (clojure.core/assoc-in [:headers "ClientContext"] (ser-string (resp-input63302 :client-context))) (clojure.core/contains? resp-input63302 :payload) (clojure.core/assoc-in [:body "Payload"] (ser-blob (resp-input63302 :payload))) (clojure.core/contains? resp-input63302 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63302 :qualifier))))))
(clojure.core/defn req<-get-account-settings-request [resp-input63304] nil)
(clojure.core/defn req<-invoke-async-request [resp-input63305] {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63305 :function-name))}, :body {"InvokeArgs" (ser-blob-stream (resp-input63305 :invoke-args))}})
(clojure.core/defn req<-get-function-configuration-request [resp-input63306] (clojure.core/let [input63307 {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63306 :function-name))}}] (clojure.core/cond-> input63307 (clojure.core/contains? resp-input63306 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63306 :qualifier))))))
(clojure.core/defn req<-update-function-code-request [resp-input63308] (clojure.core/let [input63309 {:uri {"FunctionName" (ser-function-name (resp-input63308 :function-name))}}] (clojure.core/cond-> input63309 (clojure.core/contains? resp-input63308 :zip-file) (clojure.core/assoc-in [:body "ZipFile"] (ser-blob (resp-input63308 :zip-file))) (clojure.core/contains? resp-input63308 :s3-bucket) (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket (resp-input63308 :s3-bucket))) (clojure.core/contains? resp-input63308 :s3-key) (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key (resp-input63308 :s3-key))) (clojure.core/contains? resp-input63308 :s3-object-version) (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version (resp-input63308 :s3-object-version))) (clojure.core/contains? resp-input63308 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (resp-input63308 :publish))) (clojure.core/contains? resp-input63308 :dry-run) (clojure.core/assoc-in [:body "DryRun"] (ser-boolean (resp-input63308 :dry-run))) (clojure.core/contains? resp-input63308 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input63308 :revision-id))))))
(clojure.core/defn req<-list-versions-by-function-request [resp-input63310] (clojure.core/let [input63311 {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63310 :function-name))}}] (clojure.core/cond-> input63311 (clojure.core/contains? resp-input63310 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input63310 :marker))) (clojure.core/contains? resp-input63310 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input63310 :max-items))))))
(clojure.core/defn req<-update-event-source-mapping-request [resp-input63312] (clojure.core/let [input63313 {:uri {"UUID" (ser-string (resp-input63312 :uuid))}}] (clojure.core/cond-> input63313 (clojure.core/contains? resp-input63312 :function-name) (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name (resp-input63312 :function-name))) (clojure.core/contains? resp-input63312 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (resp-input63312 :enabled))) (clojure.core/contains? resp-input63312 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (resp-input63312 :batch-size))))))
(clojure.core/defn req<-list-tags-request [resp-input63314] {:uri {"Resource" (ser-function-arn (resp-input63314 :resource))}})
(clojure.core/defn req<-update-alias-request [resp-input63315] (clojure.core/let [input63316 {:uri {"FunctionName" (ser-function-name (resp-input63315 :function-name)), "Name" (ser-alias (resp-input63315 :name))}}] (clojure.core/cond-> input63316 (clojure.core/contains? resp-input63315 :function-version) (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version (resp-input63315 :function-version))) (clojure.core/contains? resp-input63315 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input63315 :description))) (clojure.core/contains? resp-input63315 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (resp-input63315 :routing-config))) (clojure.core/contains? resp-input63315 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input63315 :revision-id))))))
(clojure.core/defn req<-get-event-source-mapping-request [resp-input63317] {:uri {"UUID" (ser-string (resp-input63317 :uuid))}})
(clojure.core/defn req<-get-function-request [resp-input63318] (clojure.core/let [input63319 {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63318 :function-name))}}] (clojure.core/cond-> input63319 (clojure.core/contains? resp-input63318 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63318 :qualifier))))))
(clojure.core/defn req<-get-policy-request [resp-input63320] (clojure.core/let [input63321 {:uri {"FunctionName" (ser-namespaced-function-name (resp-input63320 :function-name))}}] (clojure.core/cond-> input63321 (clojure.core/contains? resp-input63320 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63320 :qualifier))))))
(clojure.core/defn req<-add-permission-request [resp-input63322] (clojure.core/let [input63323 {:uri {"FunctionName" (ser-function-name (resp-input63322 :function-name))}, :body {"StatementId" (ser-statement-id (resp-input63322 :statement-id)), "Principal" (ser-principal (resp-input63322 :principal)), "Action" (ser-action (resp-input63322 :action))}}] (clojure.core/cond-> input63323 (clojure.core/contains? resp-input63322 :source-account) (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner (resp-input63322 :source-account))) (clojure.core/contains? resp-input63322 :source-arn) (clojure.core/assoc-in [:body "SourceArn"] (ser-arn (resp-input63322 :source-arn))) (clojure.core/contains? resp-input63322 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input63322 :revision-id))) (clojure.core/contains? resp-input63322 :event-source-token) (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token (resp-input63322 :event-source-token))) (clojure.core/contains? resp-input63322 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63322 :qualifier))))))
(clojure.core/defn req<-create-event-source-mapping-request [resp-input63324] (clojure.core/let [input63325 {:body {"EventSourceArn" (ser-arn (resp-input63324 :event-source-arn)), "FunctionName" (ser-function-name (resp-input63324 :function-name)), "StartingPosition" (ser-event-source-position (resp-input63324 :starting-position))}}] (clojure.core/cond-> input63325 (clojure.core/contains? resp-input63324 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (resp-input63324 :enabled))) (clojure.core/contains? resp-input63324 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (resp-input63324 :batch-size))) (clojure.core/contains? resp-input63324 :starting-position-timestamp) (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date (resp-input63324 :starting-position-timestamp))))))
(clojure.core/defn req<-get-alias-request [resp-input63326] {:uri {"FunctionName" (ser-function-name (resp-input63326 :function-name)), "Name" (ser-alias (resp-input63326 :name))}})
(clojure.core/defn req<-list-aliases-request [resp-input63327] (clojure.core/let [input63328 {:uri {"FunctionName" (ser-function-name (resp-input63327 :function-name))}}] (clojure.core/cond-> input63328 (clojure.core/contains? resp-input63327 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version (resp-input63327 :function-version))) (clojure.core/contains? resp-input63327 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input63327 :marker))) (clojure.core/contains? resp-input63327 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input63327 :max-items))))))
(clojure.core/defn req<-list-functions-request [resp-input63329] (clojure.core/cond-> {} (clojure.core/contains? resp-input63329 :master-region) (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region (resp-input63329 :master-region))) (clojure.core/contains? resp-input63329 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version (resp-input63329 :function-version))) (clojure.core/contains? resp-input63329 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (resp-input63329 :marker))) (clojure.core/contains? resp-input63329 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (resp-input63329 :max-items)))))
(clojure.core/defn req<-remove-permission-request [resp-input63330] (clojure.core/let [input63331 {:uri {"FunctionName" (ser-function-name (resp-input63330 :function-name)), "StatementId" (ser-namespaced-statement-id (resp-input63330 :statement-id))}}] (clojure.core/cond-> input63331 (clojure.core/contains? resp-input63330 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (resp-input63330 :qualifier))) (clojure.core/contains? resp-input63330 :revision-id) (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string (resp-input63330 :revision-id))))))
(clojure.core/defn req<-delete-alias-request [resp-input63332] {:uri {"FunctionName" (ser-function-name (resp-input63332 :function-name)), "Name" (ser-alias (resp-input63332 :name))}})
(clojure.core/defn req<-create-function-request [resp-input63333] (clojure.core/let [input63334 {:body {"FunctionName" (ser-function-name (resp-input63333 :function-name)), "Handler" (ser-handler (resp-input63333 :handler)), "Runtime" (ser-runtime (resp-input63333 :runtime)), "Role" (ser-role-arn (resp-input63333 :role)), "Code" (ser-function-code (resp-input63333 :code))}}] (clojure.core/cond-> input63334 (clojure.core/contains? resp-input63333 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (resp-input63333 :tracing-config))) (clojure.core/contains? resp-input63333 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (resp-input63333 :timeout))) (clojure.core/contains? resp-input63333 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (resp-input63333 :dead-letter-config))) (clojure.core/contains? resp-input63333 :tags) (clojure.core/assoc-in [:body "Tags"] (ser-tags (resp-input63333 :tags))) (clojure.core/contains? resp-input63333 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (resp-input63333 :memory-size))) (clojure.core/contains? resp-input63333 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (resp-input63333 :kmskey-arn))) (clojure.core/contains? resp-input63333 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input63333 :description))) (clojure.core/contains? resp-input63333 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (resp-input63333 :environment))) (clojure.core/contains? resp-input63333 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (resp-input63333 :vpc-config))) (clojure.core/contains? resp-input63333 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (resp-input63333 :publish))))))
(clojure.core/defn req<-untag-resource-request [resp-input63335] {:uri {"Resource" (ser-function-arn (resp-input63335 :resource))}, :query-string {"TagKeys" (ser-tag-key-list (resp-input63335 :tag-keys))}})
(clojure.core/defn req<-publish-version-request [resp-input63336] (clojure.core/let [input63337 {:uri {"FunctionName" (ser-function-name (resp-input63336 :function-name))}}] (clojure.core/cond-> input63337 (clojure.core/contains? resp-input63336 :code-sha256) (clojure.core/assoc-in [:body "CodeSha256"] (ser-string (resp-input63336 :code-sha256))) (clojure.core/contains? resp-input63336 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input63336 :description))) (clojure.core/contains? resp-input63336 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input63336 :revision-id))))))
(clojure.core/defn req<-put-function-concurrency-request [resp-input63338] {:uri {"FunctionName" (ser-function-name (resp-input63338 :function-name))}, :body {"ReservedConcurrentExecutions" (ser-reserved-concurrent-executions (resp-input63338 :reserved-concurrent-executions))}})
(clojure.core/defn req<-update-function-configuration-request [resp-input63339] (clojure.core/let [input63340 {:uri {"FunctionName" (ser-function-name (resp-input63339 :function-name))}}] (clojure.core/cond-> input63340 (clojure.core/contains? resp-input63339 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (resp-input63339 :tracing-config))) (clojure.core/contains? resp-input63339 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (resp-input63339 :timeout))) (clojure.core/contains? resp-input63339 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (resp-input63339 :dead-letter-config))) (clojure.core/contains? resp-input63339 :handler) (clojure.core/assoc-in [:body "Handler"] (ser-handler (resp-input63339 :handler))) (clojure.core/contains? resp-input63339 :runtime) (clojure.core/assoc-in [:body "Runtime"] (ser-runtime (resp-input63339 :runtime))) (clojure.core/contains? resp-input63339 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (resp-input63339 :memory-size))) (clojure.core/contains? resp-input63339 :role) (clojure.core/assoc-in [:body "Role"] (ser-role-arn (resp-input63339 :role))) (clojure.core/contains? resp-input63339 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (resp-input63339 :kmskey-arn))) (clojure.core/contains? resp-input63339 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (resp-input63339 :description))) (clojure.core/contains? resp-input63339 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (resp-input63339 :environment))) (clojure.core/contains? resp-input63339 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (resp-input63339 :vpc-config))) (clojure.core/contains? resp-input63339 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (resp-input63339 :revision-id))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 0 p1__62593__62594__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 1 p1__62593__62594__auto__)) (fn* [p1__62595__62596__auto__] (clojure.core/<= p1__62595__62596__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 140)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 0 p1__62593__62594__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 1 p1__62593__62594__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 128)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"[^\s]+" s__62540__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 170)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"\d{12}" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 100)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 128)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 1024)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"[0-9]+" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 128 p1__62593__62594__auto__)) (fn* [p1__62595__62596__auto__] (clojure.core/<= p1__62595__62596__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 100)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__62540__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 0 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__62593__62594__auto__] (clojure.core/<= 1 p1__62593__62594__auto__)) (fn* [p1__62595__62596__auto__] (clojure.core/<= p1__62595__62596__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 3 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 63)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 128)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__62540__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 0 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 256)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__62540__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62538__auto__] (clojure.core/<= 1 (clojure.core/count s__62538__auto__))) (clojure.core/fn [s__62539__auto__] (clojure.core/< (clojure.core/count s__62539__auto__) 1024)) (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #".*" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__62540__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__62540__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__62540__auto__))))
