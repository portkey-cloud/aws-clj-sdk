...
(clojure.core/defn req<-tag-resource-request [input31373] {:uri {"Resource" (ser-function-arn (input31373 :resource))}, :body {"Tags" (ser-tags (input31373 :tags))}})
(clojure.core/defn req<-create-alias-request [input31374] (clojure.core/let [input31375 {:uri {"FunctionName" (ser-function-name (input31374 :function-name))}, :body {"Name" (ser-alias (input31374 :name)), "FunctionVersion" (ser-version (input31374 :function-version))}}] (clojure.core/cond-> input31375 (clojure.core/contains? input31374 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input31374 :description))) (clojure.core/contains? input31374 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (input31374 :routing-config))))))
(clojure.core/defn req<-delete-function-request [input31376] (clojure.core/let [input31377 {:uri {"FunctionName" (ser-function-name (input31376 :function-name))}}] (clojure.core/cond-> input31377 (clojure.core/contains? input31376 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31376 :qualifier))))))
(clojure.core/defn req<-list-event-source-mappings-request [input31378] (clojure.core/cond-> {} (clojure.core/contains? input31378 :event-source-arn) (clojure.core/assoc-in [:query-string "EventSourceArn"] (ser-arn (input31378 :event-source-arn))) (clojure.core/contains? input31378 :function-name) (clojure.core/assoc-in [:query-string "FunctionName"] (ser-function-name (input31378 :function-name))) (clojure.core/contains? input31378 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input31378 :marker))) (clojure.core/contains? input31378 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input31378 :max-items)))))
(clojure.core/defn req<-delete-function-concurrency-request [input31379] {:uri {"FunctionName" (ser-function-name (input31379 :function-name))}})
(clojure.core/defn req<-delete-event-source-mapping-request [input31380] {:uri {"UUID" (ser-string (input31380 :uuid))}})
(clojure.core/defn req<-invocation-request [input31381] (clojure.core/let [input31382 {:uri {"FunctionName" (ser-namespaced-function-name (input31381 :function-name))}}] (clojure.core/cond-> input31382 (clojure.core/contains? input31381 :invocation-type) (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type (input31381 :invocation-type))) (clojure.core/contains? input31381 :log-type) (clojure.core/assoc-in [:headers "LogType"] (ser-log-type (input31381 :log-type))) (clojure.core/contains? input31381 :client-context) (clojure.core/assoc-in [:headers "ClientContext"] (ser-string (input31381 :client-context))) (clojure.core/contains? input31381 :payload) (clojure.core/assoc-in [:body "Payload"] (ser-blob (input31381 :payload))) (clojure.core/contains? input31381 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31381 :qualifier))))))
(clojure.core/defn req<-get-account-settings-request [input31383] nil)
(clojure.core/defn req<-invoke-async-request [input31384] {:uri {"FunctionName" (ser-namespaced-function-name (input31384 :function-name))}, :body {"InvokeArgs" (ser-blob-stream (input31384 :invoke-args))}})
(clojure.core/defn req<-get-function-configuration-request [input31385] (clojure.core/let [input31386 {:uri {"FunctionName" (ser-namespaced-function-name (input31385 :function-name))}}] (clojure.core/cond-> input31386 (clojure.core/contains? input31385 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31385 :qualifier))))))
(clojure.core/defn req<-update-function-code-request [input31387] (clojure.core/let [input31388 {:uri {"FunctionName" (ser-function-name (input31387 :function-name))}}] (clojure.core/cond-> input31388 (clojure.core/contains? input31387 :zip-file) (clojure.core/assoc-in [:body "ZipFile"] (ser-blob (input31387 :zip-file))) (clojure.core/contains? input31387 :s3-bucket) (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket (input31387 :s3-bucket))) (clojure.core/contains? input31387 :s3-key) (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key (input31387 :s3-key))) (clojure.core/contains? input31387 :s3-object-version) (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version (input31387 :s3-object-version))) (clojure.core/contains? input31387 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (input31387 :publish))) (clojure.core/contains? input31387 :dry-run) (clojure.core/assoc-in [:body "DryRun"] (ser-boolean (input31387 :dry-run))) (clojure.core/contains? input31387 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input31387 :revision-id))))))
(clojure.core/defn req<-list-versions-by-function-request [input31389] (clojure.core/let [input31390 {:uri {"FunctionName" (ser-namespaced-function-name (input31389 :function-name))}}] (clojure.core/cond-> input31390 (clojure.core/contains? input31389 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input31389 :marker))) (clojure.core/contains? input31389 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input31389 :max-items))))))
(clojure.core/defn req<-update-event-source-mapping-request [input31391] (clojure.core/let [input31392 {:uri {"UUID" (ser-string (input31391 :uuid))}}] (clojure.core/cond-> input31392 (clojure.core/contains? input31391 :function-name) (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name (input31391 :function-name))) (clojure.core/contains? input31391 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (input31391 :enabled))) (clojure.core/contains? input31391 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (input31391 :batch-size))))))
(clojure.core/defn req<-list-tags-request [input31393] {:uri {"Resource" (ser-function-arn (input31393 :resource))}})
(clojure.core/defn req<-update-alias-request [input31394] (clojure.core/let [input31395 {:uri {"FunctionName" (ser-function-name (input31394 :function-name)), "Name" (ser-alias (input31394 :name))}}] (clojure.core/cond-> input31395 (clojure.core/contains? input31394 :function-version) (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version (input31394 :function-version))) (clojure.core/contains? input31394 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input31394 :description))) (clojure.core/contains? input31394 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (input31394 :routing-config))) (clojure.core/contains? input31394 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input31394 :revision-id))))))
(clojure.core/defn req<-get-event-source-mapping-request [input31396] {:uri {"UUID" (ser-string (input31396 :uuid))}})
(clojure.core/defn req<-get-function-request [input31397] (clojure.core/let [input31398 {:uri {"FunctionName" (ser-namespaced-function-name (input31397 :function-name))}}] (clojure.core/cond-> input31398 (clojure.core/contains? input31397 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31397 :qualifier))))))
(clojure.core/defn req<-get-policy-request [input31399] (clojure.core/let [input31400 {:uri {"FunctionName" (ser-namespaced-function-name (input31399 :function-name))}}] (clojure.core/cond-> input31400 (clojure.core/contains? input31399 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31399 :qualifier))))))
(clojure.core/defn req<-add-permission-request [input31401] (clojure.core/let [input31402 {:uri {"FunctionName" (ser-function-name (input31401 :function-name))}, :body {"StatementId" (ser-statement-id (input31401 :statement-id)), "Principal" (ser-principal (input31401 :principal)), "Action" (ser-action (input31401 :action))}}] (clojure.core/cond-> input31402 (clojure.core/contains? input31401 :source-account) (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner (input31401 :source-account))) (clojure.core/contains? input31401 :source-arn) (clojure.core/assoc-in [:body "SourceArn"] (ser-arn (input31401 :source-arn))) (clojure.core/contains? input31401 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input31401 :revision-id))) (clojure.core/contains? input31401 :event-source-token) (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token (input31401 :event-source-token))) (clojure.core/contains? input31401 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31401 :qualifier))))))
(clojure.core/defn req<-create-event-source-mapping-request [input31403] (clojure.core/let [input31404 {:body {"EventSourceArn" (ser-arn (input31403 :event-source-arn)), "FunctionName" (ser-function-name (input31403 :function-name)), "StartingPosition" (ser-event-source-position (input31403 :starting-position))}}] (clojure.core/cond-> input31404 (clojure.core/contains? input31403 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (input31403 :enabled))) (clojure.core/contains? input31403 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (input31403 :batch-size))) (clojure.core/contains? input31403 :starting-position-timestamp) (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date (input31403 :starting-position-timestamp))))))
(clojure.core/defn req<-get-alias-request [input31405] {:uri {"FunctionName" (ser-function-name (input31405 :function-name)), "Name" (ser-alias (input31405 :name))}})
(clojure.core/defn req<-list-aliases-request [input31406] (clojure.core/let [input31407 {:uri {"FunctionName" (ser-function-name (input31406 :function-name))}}] (clojure.core/cond-> input31407 (clojure.core/contains? input31406 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version (input31406 :function-version))) (clojure.core/contains? input31406 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input31406 :marker))) (clojure.core/contains? input31406 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input31406 :max-items))))))
(clojure.core/defn req<-list-functions-request [input31408] (clojure.core/cond-> {} (clojure.core/contains? input31408 :master-region) (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region (input31408 :master-region))) (clojure.core/contains? input31408 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version (input31408 :function-version))) (clojure.core/contains? input31408 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input31408 :marker))) (clojure.core/contains? input31408 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input31408 :max-items)))))
(clojure.core/defn req<-remove-permission-request [input31409] (clojure.core/let [input31410 {:uri {"FunctionName" (ser-function-name (input31409 :function-name)), "StatementId" (ser-namespaced-statement-id (input31409 :statement-id))}}] (clojure.core/cond-> input31410 (clojure.core/contains? input31409 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input31409 :qualifier))) (clojure.core/contains? input31409 :revision-id) (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string (input31409 :revision-id))))))
(clojure.core/defn req<-delete-alias-request [input31411] {:uri {"FunctionName" (ser-function-name (input31411 :function-name)), "Name" (ser-alias (input31411 :name))}})
(clojure.core/defn req<-create-function-request [input31412] (clojure.core/let [input31413 {:body {"FunctionName" (ser-function-name (input31412 :function-name)), "Handler" (ser-handler (input31412 :handler)), "Runtime" (ser-runtime (input31412 :runtime)), "Role" (ser-role-arn (input31412 :role)), "Code" (ser-function-code (input31412 :code))}}] (clojure.core/cond-> input31413 (clojure.core/contains? input31412 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (input31412 :tracing-config))) (clojure.core/contains? input31412 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (input31412 :timeout))) (clojure.core/contains? input31412 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (input31412 :dead-letter-config))) (clojure.core/contains? input31412 :tags) (clojure.core/assoc-in [:body "Tags"] (ser-tags (input31412 :tags))) (clojure.core/contains? input31412 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (input31412 :memory-size))) (clojure.core/contains? input31412 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (input31412 :kmskey-arn))) (clojure.core/contains? input31412 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input31412 :description))) (clojure.core/contains? input31412 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (input31412 :environment))) (clojure.core/contains? input31412 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (input31412 :vpc-config))) (clojure.core/contains? input31412 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (input31412 :publish))))))
(clojure.core/defn req<-untag-resource-request [input31414] {:uri {"Resource" (ser-function-arn (input31414 :resource))}, :query-string {"TagKeys" (ser-tag-key-list (input31414 :tag-keys))}})
(clojure.core/defn req<-publish-version-request [input31415] (clojure.core/let [input31416 {:uri {"FunctionName" (ser-function-name (input31415 :function-name))}}] (clojure.core/cond-> input31416 (clojure.core/contains? input31415 :code-sha256) (clojure.core/assoc-in [:body "CodeSha256"] (ser-string (input31415 :code-sha256))) (clojure.core/contains? input31415 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input31415 :description))) (clojure.core/contains? input31415 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input31415 :revision-id))))))
(clojure.core/defn req<-put-function-concurrency-request [input31417] {:uri {"FunctionName" (ser-function-name (input31417 :function-name))}, :body {"ReservedConcurrentExecutions" (ser-reserved-concurrent-executions (input31417 :reserved-concurrent-executions))}})
(clojure.core/defn req<-update-function-configuration-request [input31418] (clojure.core/let [input31419 {:uri {"FunctionName" (ser-function-name (input31418 :function-name))}}] (clojure.core/cond-> input31419 (clojure.core/contains? input31418 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (input31418 :tracing-config))) (clojure.core/contains? input31418 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (input31418 :timeout))) (clojure.core/contains? input31418 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (input31418 :dead-letter-config))) (clojure.core/contains? input31418 :handler) (clojure.core/assoc-in [:body "Handler"] (ser-handler (input31418 :handler))) (clojure.core/contains? input31418 :runtime) (clojure.core/assoc-in [:body "Runtime"] (ser-runtime (input31418 :runtime))) (clojure.core/contains? input31418 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (input31418 :memory-size))) (clojure.core/contains? input31418 :role) (clojure.core/assoc-in [:body "Role"] (ser-role-arn (input31418 :role))) (clojure.core/contains? input31418 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (input31418 :kmskey-arn))) (clojure.core/contains? input31418 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input31418 :description))) (clojure.core/contains? input31418 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (input31418 :environment))) (clojure.core/contains? input31418 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (input31418 :vpc-config))) (clojure.core/contains? input31418 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input31418 :revision-id))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 0 p1__30666__30667__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 1 p1__30666__30667__auto__)) (fn* [p1__30668__30669__auto__] (clojure.core/<= p1__30668__30669__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 140)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 0 p1__30666__30667__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 1 p1__30666__30667__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 128)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"[^\s]+" s__30613__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 170)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"\d{12}" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 100)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 128)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 1024)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"[0-9]+" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 128 p1__30666__30667__auto__)) (fn* [p1__30668__30669__auto__] (clojure.core/<= p1__30668__30669__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 100)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__30613__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 0 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__30666__30667__auto__] (clojure.core/<= 1 p1__30666__30667__auto__)) (fn* [p1__30668__30669__auto__] (clojure.core/<= p1__30668__30669__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 3 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 63)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 128)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__30613__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 0 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 256)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__30613__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30611__auto__] (clojure.core/<= 1 (clojure.core/count s__30611__auto__))) (clojure.core/fn [s__30612__auto__] (clojure.core/< (clojure.core/count s__30612__auto__) 1024)) (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #".*" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__30613__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__30613__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__30613__auto__))))
...
(clojure.core/defn delete-event-source-mapping "Removes an event source mapping. This means AWS Lambda will no longer invoke the\nfunction for events in the associated source.\n This operation requires permission for the lambda:DeleteEventSourceMapping\naction." ([delete-event-source-mapping-request] (clojure.core/let [req<-input__30940__auto__ (req<-delete-event-source-mapping-request delete-event-source-mapping-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "DELETE" "/2015-03-31/event-source-mappings/{UUID}" req<-input__30940__auto__ :portkey.aws.lambda/delete-event-source-mapping-request {:payload nil, :move {}, :headers {}, :uri {"UUID" "UUID"}, :querystring {}} 202 :portkey.aws.lambda/event-source-mapping-configuration {"ServiceException" :portkey.aws.lambda/service-exception, "ResourceNotFoundException" :portkey.aws.lambda/resource-not-found-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
...
(clojure.core/defn get-account-settings "Returns a customer's account settings.\n You can use this operation to retrieve Lambda limits information, such as code\nsize and concurrency limits. For more information about limits, see AWS Lambda\nLimits (http://docs.aws.amazon.com/lambda/latest/dg/limits.html). You can also\nretrieve resource usage statistics, such as code storage usage and function\ncount." ([] (get-account-settings {})) ([get-account-settings-request] (clojure.core/let [req<-input__30940__auto__ (req<-get-account-settings-request get-account-settings-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2016-08-19/account-settings/" req<-input__30940__auto__ :portkey.aws.lambda/get-account-settings-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {}} 200 :portkey.aws.lambda/get-account-settings-response {"TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception, "ServiceException" :portkey.aws.lambda/service-exception}))))
...
(clojure.core/defn list-versions-by-function "List all versions of a function. For information about the versioning feature,\nsee AWS Lambda Function Versioning and Aliases\n(http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html)." ([list-versions-by-function-request] (clojure.core/let [req<-input__30940__auto__ (req<-list-versions-by-function-request list-versions-by-function-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2015-03-31/functions/{FunctionName}/versions" req<-input__30940__auto__ :portkey.aws.lambda/list-versions-by-function-request {:payload nil, :move {}, :headers {}, :uri {"FunctionName" "FunctionName"}, :querystring {"Marker" "Marker", "MaxItems" "MaxItems"}} 200 :portkey.aws.lambda/list-versions-by-function-response {"ServiceException" :portkey.aws.lambda/service-exception, "ResourceNotFoundException" :portkey.aws.lambda/resource-not-found-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
...
(clojure.core/defn list-tags "Returns a list of tags assigned to a function when supplied the function ARN\n(Amazon Resource Name). For more information on Tagging, see Tagging Lambda\nFunctions (http://docs.aws.amazon.com/lambda/latest/dg/tagging.html) in the AWS\nLambda Developer Guide." ([list-tags-request] (clojure.core/let [req<-input__30940__auto__ (req<-list-tags-request list-tags-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2017-03-31/tags/{ARN}" req<-input__30940__auto__ :portkey.aws.lambda/list-tags-request {:payload nil, :move {}, :headers {}, :uri {"ARN" "Resource"}, :querystring {}} nil :portkey.aws.lambda/list-tags-response {"ServiceException" :portkey.aws.lambda/service-exception, "ResourceNotFoundException" :portkey.aws.lambda/resource-not-found-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
...
(clojure.core/defn get-event-source-mapping "Returns configuration information for the specified event source mapping (see\nCreateEventSourceMapping).\n This operation requires permission for the lambda:GetEventSourceMapping action." ([get-event-source-mapping-request] (clojure.core/let [req<-input__30940__auto__ (req<-get-event-source-mapping-request get-event-source-mapping-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2015-03-31/event-source-mappings/{UUID}" req<-input__30940__auto__ :portkey.aws.lambda/get-event-source-mapping-request {:payload nil, :move {}, :headers {}, :uri {"UUID" "UUID"}, :querystring {}} 200 :portkey.aws.lambda/event-source-mapping-configuration {"ServiceException" :portkey.aws.lambda/service-exception, "ResourceNotFoundException" :portkey.aws.lambda/resource-not-found-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
...
(clojure.core/defn get-alias "Returns the specified alias information such as the alias ARN, description, and\nfunction version it is pointing to. For more information, see Introduction to\nAWS Lambda Aliases\n(http://docs.aws.amazon.com/lambda/latest/dg/aliases-intro.html).\n This requires permission for the lambda:GetAlias action." ([get-alias-request] (clojure.core/let [req<-input__30940__auto__ (req<-get-alias-request get-alias-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2015-03-31/functions/{FunctionName}/aliases/{Name}" req<-input__30940__auto__ :portkey.aws.lambda/get-alias-request {:payload nil, :move {}, :headers {}, :uri {"FunctionName" "FunctionName", "Name" "Name"}, :querystring {}} 200 :portkey.aws.lambda/alias-configuration {"ServiceException" :portkey.aws.lambda/service-exception, "ResourceNotFoundException" :portkey.aws.lambda/resource-not-found-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
...
(clojure.core/defn list-functions "Returns a list of your Lambda functions. For each function, the response\nincludes the function configuration information. You must use GetFunction to\nretrieve the code for your function.\n This operation requires permission for the lambda:ListFunctions action.\n If you are using the versioning feature, you can list all of your functions or\nonly $LATEST versions. For information about the versioning feature, see AWS\nLambda Function Versioning and Aliases\n(http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html)." ([] (list-functions {})) ([list-functions-request] (clojure.core/let [req<-input__30940__auto__ (req<-list-functions-request list-functions-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "GET" "/2015-03-31/functions/" req<-input__30940__auto__ :portkey.aws.lambda/list-functions-request {:payload nil, :move {}, :headers {}, :uri {}, :querystring {"MasterRegion" "MasterRegion", "FunctionVersion" "FunctionVersion", "Marker" "Marker", "MaxItems" "MaxItems"}} 200 :portkey.aws.lambda/list-functions-response {"ServiceException" :portkey.aws.lambda/service-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception}))))
...
(clojure.core/defn delete-alias "Deletes the specified Lambda function alias. For more information, see\nIntroduction to AWS Lambda Aliases\n(http://docs.aws.amazon.com/lambda/latest/dg/aliases-intro.html).\n This requires permission for the lambda:DeleteAlias action." ([delete-alias-request] (clojure.core/let [req<-input__30940__auto__ (req<-delete-alias-request delete-alias-request)] (portkey.aws/-rest-json-call portkey.aws.lambda/endpoints "DELETE" "/2015-03-31/functions/{FunctionName}/aliases/{Name}" req<-input__30940__auto__ :portkey.aws.lambda/delete-alias-request {:payload nil, :move {}, :headers {}, :uri {"FunctionName" "FunctionName", "Name" "Name"}, :querystring {}} 204 nil {"ServiceException" :portkey.aws.lambda/service-exception, "InvalidParameterValueException" :portkey.aws.lambda/invalid-parameter-value-exception, "TooManyRequestsException" :portkey.aws.lambda/too-many-requests-exception}))))
