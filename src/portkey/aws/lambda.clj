...
(clojure.core/defn resp-tag-resource-request [resp-input48909] {:uri {"Resource" (ser-function-arn resp-input48909)}, :body {"Tags" (ser-tags resp-input48909)}})
(clojure.core/defn resp-create-alias-request [resp-input48910] (clojure.core/let [input48911 {:uri {"FunctionName" (ser-function-name resp-input48910)}, :body {"Name" (ser-alias resp-input48910), "FunctionVersion" (ser-version resp-input48910)}}] (clojure.core/cond-> input48911 (clojure.core/contains? resp-input48910 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input48910)) (clojure.core/contains? resp-input48910 "RoutingConfig") (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration resp-input48910)))))
(clojure.core/defn resp-delete-function-request [resp-input48912] (clojure.core/let [input48913 {:uri {"FunctionName" (ser-function-name resp-input48912)}}] (clojure.core/cond-> input48913 (clojure.core/contains? resp-input48912 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48912)))))
...
(clojure.core/defn resp-delete-function-concurrency-request [resp-input48915] {:uri {"FunctionName" (ser-function-name resp-input48915)}})
(clojure.core/defn resp-delete-event-source-mapping-request [resp-input48916] {:uri {"UUID" (ser-string resp-input48916)}})
(clojure.core/defn resp-invocation-request [resp-input48917] (clojure.core/let [input48918 {:uri {"FunctionName" (ser-namespaced-function-name resp-input48917)}}] (clojure.core/cond-> input48918 (clojure.core/contains? resp-input48917 "InvocationType") (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type resp-input48917)) (clojure.core/contains? resp-input48917 "LogType") (clojure.core/assoc-in [:headers "LogType"] (ser-log-type resp-input48917)) (clojure.core/contains? resp-input48917 "ClientContext") (clojure.core/assoc-in [:headers "ClientContext"] (ser-string resp-input48917)) (clojure.core/contains? resp-input48917 "Payload") (clojure.core/assoc-in [:body "Payload"] (ser-blob resp-input48917)) (clojure.core/contains? resp-input48917 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48917)))))
(clojure.core/defn resp-get-account-settings-request [resp-input48919] nil)
(clojure.core/defn resp-invoke-async-request [resp-input48920] {:uri {"FunctionName" (ser-namespaced-function-name resp-input48920)}, :body {"InvokeArgs" (ser-blob-stream resp-input48920)}})
(clojure.core/defn resp-get-function-configuration-request [resp-input48921] (clojure.core/let [input48922 {:uri {"FunctionName" (ser-namespaced-function-name resp-input48921)}}] (clojure.core/cond-> input48922 (clojure.core/contains? resp-input48921 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48921)))))
(clojure.core/defn resp-update-function-code-request [resp-input48923] (clojure.core/let [input48924 {:uri {"FunctionName" (ser-function-name resp-input48923)}}] (clojure.core/cond-> input48924 (clojure.core/contains? resp-input48923 "ZipFile") (clojure.core/assoc-in [:body "ZipFile"] (ser-blob resp-input48923)) (clojure.core/contains? resp-input48923 "S3Bucket") (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket resp-input48923)) (clojure.core/contains? resp-input48923 "S3Key") (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key resp-input48923)) (clojure.core/contains? resp-input48923 "S3ObjectVersion") (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version resp-input48923)) (clojure.core/contains? resp-input48923 "Publish") (clojure.core/assoc-in [:body "Publish"] (ser-boolean resp-input48923)) (clojure.core/contains? resp-input48923 "DryRun") (clojure.core/assoc-in [:body "DryRun"] (ser-boolean resp-input48923)) (clojure.core/contains? resp-input48923 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input48923)))))
(clojure.core/defn resp-list-versions-by-function-request [resp-input48925] (clojure.core/let [input48926 {:uri {"FunctionName" (ser-namespaced-function-name resp-input48925)}}] (clojure.core/cond-> input48926 (clojure.core/contains? resp-input48925 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input48925)) (clojure.core/contains? resp-input48925 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input48925)))))
(clojure.core/defn resp-update-event-source-mapping-request [resp-input48927] (clojure.core/let [input48928 {:uri {"UUID" (ser-string resp-input48927)}}] (clojure.core/cond-> input48928 (clojure.core/contains? resp-input48927 "FunctionName") (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name resp-input48927)) (clojure.core/contains? resp-input48927 "Enabled") (clojure.core/assoc-in [:body "Enabled"] (ser-enabled resp-input48927)) (clojure.core/contains? resp-input48927 "BatchSize") (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size resp-input48927)))))
(clojure.core/defn resp-list-tags-request [resp-input48929] {:uri {"Resource" (ser-function-arn resp-input48929)}})
(clojure.core/defn resp-update-alias-request [resp-input48930] (clojure.core/let [input48931 {:uri {"FunctionName" (ser-function-name resp-input48930), "Name" (ser-alias resp-input48930)}}] (clojure.core/cond-> input48931 (clojure.core/contains? resp-input48930 "FunctionVersion") (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version resp-input48930)) (clojure.core/contains? resp-input48930 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input48930)) (clojure.core/contains? resp-input48930 "RoutingConfig") (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration resp-input48930)) (clojure.core/contains? resp-input48930 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input48930)))))
(clojure.core/defn resp-get-event-source-mapping-request [resp-input48932] {:uri {"UUID" (ser-string resp-input48932)}})
(clojure.core/defn resp-get-function-request [resp-input48933] (clojure.core/let [input48934 {:uri {"FunctionName" (ser-namespaced-function-name resp-input48933)}}] (clojure.core/cond-> input48934 (clojure.core/contains? resp-input48933 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48933)))))
(clojure.core/defn resp-get-policy-request [resp-input48935] (clojure.core/let [input48936 {:uri {"FunctionName" (ser-namespaced-function-name resp-input48935)}}] (clojure.core/cond-> input48936 (clojure.core/contains? resp-input48935 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48935)))))
(clojure.core/defn resp-add-permission-request [resp-input48937] (clojure.core/let [input48938 {:uri {"FunctionName" (ser-function-name resp-input48937)}, :body {"StatementId" (ser-statement-id resp-input48937), "Principal" (ser-principal resp-input48937), "Action" (ser-action resp-input48937)}}] (clojure.core/cond-> input48938 (clojure.core/contains? resp-input48937 "SourceAccount") (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner resp-input48937)) (clojure.core/contains? resp-input48937 "SourceArn") (clojure.core/assoc-in [:body "SourceArn"] (ser-arn resp-input48937)) (clojure.core/contains? resp-input48937 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input48937)) (clojure.core/contains? resp-input48937 "EventSourceToken") (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token resp-input48937)) (clojure.core/contains? resp-input48937 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48937)))))
(clojure.core/defn resp-create-event-source-mapping-request [resp-input48939] (clojure.core/let [input48940 {:body {"EventSourceArn" (ser-arn resp-input48939), "FunctionName" (ser-function-name resp-input48939), "StartingPosition" (ser-event-source-position resp-input48939)}}] (clojure.core/cond-> input48940 (clojure.core/contains? resp-input48939 "Enabled") (clojure.core/assoc-in [:body "Enabled"] (ser-enabled resp-input48939)) (clojure.core/contains? resp-input48939 "BatchSize") (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size resp-input48939)) (clojure.core/contains? resp-input48939 "StartingPositionTimestamp") (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date resp-input48939)))))
(clojure.core/defn resp-get-alias-request [resp-input48941] {:uri {"FunctionName" (ser-function-name resp-input48941), "Name" (ser-alias resp-input48941)}})
(clojure.core/defn resp-list-aliases-request [resp-input48942] (clojure.core/let [input48943 {:uri {"FunctionName" (ser-function-name resp-input48942)}}] (clojure.core/cond-> input48943 (clojure.core/contains? resp-input48942 "FunctionVersion") (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version resp-input48942)) (clojure.core/contains? resp-input48942 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input48942)) (clojure.core/contains? resp-input48942 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input48942)))))
(clojure.core/defn resp-list-functions-request [resp-input48944] (clojure.core/cond-> {} (clojure.core/contains? resp-input48944 "MasterRegion") (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region resp-input48944)) (clojure.core/contains? resp-input48944 "FunctionVersion") (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version resp-input48944)) (clojure.core/contains? resp-input48944 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input48944)) (clojure.core/contains? resp-input48944 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input48944))))
(clojure.core/defn resp-remove-permission-request [resp-input48945] (clojure.core/let [input48946 {:uri {"FunctionName" (ser-function-name resp-input48945), "StatementId" (ser-namespaced-statement-id resp-input48945)}}] (clojure.core/cond-> input48946 (clojure.core/contains? resp-input48945 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input48945)) (clojure.core/contains? resp-input48945 "RevisionId") (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string resp-input48945)))))
(clojure.core/defn resp-delete-alias-request [resp-input48947] {:uri {"FunctionName" (ser-function-name resp-input48947), "Name" (ser-alias resp-input48947)}})
(clojure.core/defn resp-create-function-request [resp-input48948] (clojure.core/let [input48949 {:body {"FunctionName" (ser-function-name resp-input48948), "Handler" (ser-handler resp-input48948), "Runtime" (ser-runtime resp-input48948), "Role" (ser-role-arn resp-input48948), "Code" (ser-function-code resp-input48948)}}] (clojure.core/cond-> input48949 (clojure.core/contains? resp-input48948 "TracingConfig") (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config resp-input48948)) (clojure.core/contains? resp-input48948 "Timeout") (clojure.core/assoc-in [:body "Timeout"] (ser-timeout resp-input48948)) (clojure.core/contains? resp-input48948 "DeadLetterConfig") (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config resp-input48948)) (clojure.core/contains? resp-input48948 "Tags") (clojure.core/assoc-in [:body "Tags"] (ser-tags resp-input48948)) (clojure.core/contains? resp-input48948 "MemorySize") (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size resp-input48948)) (clojure.core/contains? resp-input48948 "KMSKeyArn") (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn resp-input48948)) (clojure.core/contains? resp-input48948 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input48948)) (clojure.core/contains? resp-input48948 "Environment") (clojure.core/assoc-in [:body "Environment"] (ser-environment resp-input48948)) (clojure.core/contains? resp-input48948 "VpcConfig") (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config resp-input48948)) (clojure.core/contains? resp-input48948 "Publish") (clojure.core/assoc-in [:body "Publish"] (ser-boolean resp-input48948)))))
(clojure.core/defn resp-untag-resource-request [resp-input48950] {:uri {"Resource" (ser-function-arn resp-input48950)}, :query-string {"TagKeys" (ser-tag-key-list resp-input48950)}})
(clojure.core/defn resp-publish-version-request [resp-input48951] (clojure.core/let [input48952 {:uri {"FunctionName" (ser-function-name resp-input48951)}}] (clojure.core/cond-> input48952 (clojure.core/contains? resp-input48951 "CodeSha256") (clojure.core/assoc-in [:body "CodeSha256"] (ser-string resp-input48951)) (clojure.core/contains? resp-input48951 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input48951)) (clojure.core/contains? resp-input48951 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input48951)))))
(clojure.core/defn resp-put-function-concurrency-request [resp-input48953] {:uri {"FunctionName" (ser-function-name resp-input48953)}, :body {"ReservedConcurrentExecutions" (ser-reserved-concurrent-executions resp-input48953)}})
(clojure.core/defn resp-update-function-configuration-request [resp-input48954] (clojure.core/let [input48955 {:uri {"FunctionName" (ser-function-name resp-input48954)}}] (clojure.core/cond-> input48955 (clojure.core/contains? resp-input48954 "TracingConfig") (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config resp-input48954)) (clojure.core/contains? resp-input48954 "Timeout") (clojure.core/assoc-in [:body "Timeout"] (ser-timeout resp-input48954)) (clojure.core/contains? resp-input48954 "DeadLetterConfig") (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config resp-input48954)) (clojure.core/contains? resp-input48954 "Handler") (clojure.core/assoc-in [:body "Handler"] (ser-handler resp-input48954)) (clojure.core/contains? resp-input48954 "Runtime") (clojure.core/assoc-in [:body "Runtime"] (ser-runtime resp-input48954)) (clojure.core/contains? resp-input48954 "MemorySize") (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size resp-input48954)) (clojure.core/contains? resp-input48954 "Role") (clojure.core/assoc-in [:body "Role"] (ser-role-arn resp-input48954)) (clojure.core/contains? resp-input48954 "KMSKeyArn") (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn resp-input48954)) (clojure.core/contains? resp-input48954 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input48954)) (clojure.core/contains? resp-input48954 "Environment") (clojure.core/assoc-in [:body "Environment"] (ser-environment resp-input48954)) (clojure.core/contains? resp-input48954 "VpcConfig") (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config resp-input48954)) (clojure.core/contains? resp-input48954 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input48954)))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 0 p1__48208__48209__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 1 p1__48208__48209__auto__)) (fn* [p1__48210__48211__auto__] (clojure.core/<= p1__48210__48211__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 140)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 0 p1__48208__48209__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 1 p1__48208__48209__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 128)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"[^\s]+" s__48155__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 170)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"\d{12}" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 100)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 128)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 1024)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"[0-9]+" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 128 p1__48208__48209__auto__)) (fn* [p1__48210__48211__auto__] (clojure.core/<= p1__48210__48211__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 100)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__48155__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 0 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__48208__48209__auto__] (clojure.core/<= 1 p1__48208__48209__auto__)) (fn* [p1__48210__48211__auto__] (clojure.core/<= p1__48210__48211__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 3 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 63)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 128)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__48155__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 0 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 256)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__48155__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48153__auto__] (clojure.core/<= 1 (clojure.core/count s__48153__auto__))) (clojure.core/fn [s__48154__auto__] (clojure.core/< (clojure.core/count s__48154__auto__) 1024)) (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #".*" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__48155__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__48155__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__48155__auto__))))
