...
(clojure.core/defn req<-tag-resource-request [resp-input52594] {:uri {"Resource" (ser-function-arn resp-input52594)}, :body {"Tags" (ser-tags resp-input52594)}})
(clojure.core/defn req<-create-alias-request [resp-input52595] (clojure.core/let [input52596 {:uri {"FunctionName" (ser-function-name resp-input52595)}, :body {"Name" (ser-alias resp-input52595), "FunctionVersion" (ser-version resp-input52595)}}] (clojure.core/cond-> input52596 (clojure.core/contains? resp-input52595 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input52595)) (clojure.core/contains? resp-input52595 "RoutingConfig") (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration resp-input52595)))))
(clojure.core/defn req<-delete-function-request [resp-input52597] (clojure.core/let [input52598 {:uri {"FunctionName" (ser-function-name resp-input52597)}}] (clojure.core/cond-> input52598 (clojure.core/contains? resp-input52597 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52597)))))
(clojure.core/defn req<-list-event-source-mappings-request [resp-input52599] (clojure.core/cond-> {} (clojure.core/contains? resp-input52599 "EventSourceArn") (clojure.core/assoc-in [:query-string "EventSourceArn"] (ser-arn resp-input52599)) (clojure.core/contains? resp-input52599 "FunctionName") (clojure.core/assoc-in [:query-string "FunctionName"] (ser-function-name resp-input52599)) (clojure.core/contains? resp-input52599 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input52599)) (clojure.core/contains? resp-input52599 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input52599))))
(clojure.core/defn req<-delete-function-concurrency-request [resp-input52600] {:uri {"FunctionName" (ser-function-name resp-input52600)}})
(clojure.core/defn req<-delete-event-source-mapping-request [resp-input52601] {:uri {"UUID" (ser-string resp-input52601)}})
(clojure.core/defn req<-invocation-request [resp-input52602] (clojure.core/let [input52603 {:uri {"FunctionName" (ser-namespaced-function-name resp-input52602)}}] (clojure.core/cond-> input52603 (clojure.core/contains? resp-input52602 "InvocationType") (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type resp-input52602)) (clojure.core/contains? resp-input52602 "LogType") (clojure.core/assoc-in [:headers "LogType"] (ser-log-type resp-input52602)) (clojure.core/contains? resp-input52602 "ClientContext") (clojure.core/assoc-in [:headers "ClientContext"] (ser-string resp-input52602)) (clojure.core/contains? resp-input52602 "Payload") (clojure.core/assoc-in [:body "Payload"] (ser-blob resp-input52602)) (clojure.core/contains? resp-input52602 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52602)))))
(clojure.core/defn req<-get-account-settings-request [resp-input52604] nil)
(clojure.core/defn req<-invoke-async-request [resp-input52605] {:uri {"FunctionName" (ser-namespaced-function-name resp-input52605)}, :body {"InvokeArgs" (ser-blob-stream resp-input52605)}})
(clojure.core/defn req<-get-function-configuration-request [resp-input52606] (clojure.core/let [input52607 {:uri {"FunctionName" (ser-namespaced-function-name resp-input52606)}}] (clojure.core/cond-> input52607 (clojure.core/contains? resp-input52606 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52606)))))
(clojure.core/defn req<-update-function-code-request [resp-input52608] (clojure.core/let [input52609 {:uri {"FunctionName" (ser-function-name resp-input52608)}}] (clojure.core/cond-> input52609 (clojure.core/contains? resp-input52608 "ZipFile") (clojure.core/assoc-in [:body "ZipFile"] (ser-blob resp-input52608)) (clojure.core/contains? resp-input52608 "S3Bucket") (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket resp-input52608)) (clojure.core/contains? resp-input52608 "S3Key") (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key resp-input52608)) (clojure.core/contains? resp-input52608 "S3ObjectVersion") (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version resp-input52608)) (clojure.core/contains? resp-input52608 "Publish") (clojure.core/assoc-in [:body "Publish"] (ser-boolean resp-input52608)) (clojure.core/contains? resp-input52608 "DryRun") (clojure.core/assoc-in [:body "DryRun"] (ser-boolean resp-input52608)) (clojure.core/contains? resp-input52608 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input52608)))))
(clojure.core/defn req<-list-versions-by-function-request [resp-input52610] (clojure.core/let [input52611 {:uri {"FunctionName" (ser-namespaced-function-name resp-input52610)}}] (clojure.core/cond-> input52611 (clojure.core/contains? resp-input52610 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input52610)) (clojure.core/contains? resp-input52610 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input52610)))))
(clojure.core/defn req<-update-event-source-mapping-request [resp-input52612] (clojure.core/let [input52613 {:uri {"UUID" (ser-string resp-input52612)}}] (clojure.core/cond-> input52613 (clojure.core/contains? resp-input52612 "FunctionName") (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name resp-input52612)) (clojure.core/contains? resp-input52612 "Enabled") (clojure.core/assoc-in [:body "Enabled"] (ser-enabled resp-input52612)) (clojure.core/contains? resp-input52612 "BatchSize") (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size resp-input52612)))))
(clojure.core/defn req<-list-tags-request [resp-input52614] {:uri {"Resource" (ser-function-arn resp-input52614)}})
(clojure.core/defn req<-update-alias-request [resp-input52615] (clojure.core/let [input52616 {:uri {"FunctionName" (ser-function-name resp-input52615), "Name" (ser-alias resp-input52615)}}] (clojure.core/cond-> input52616 (clojure.core/contains? resp-input52615 "FunctionVersion") (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version resp-input52615)) (clojure.core/contains? resp-input52615 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input52615)) (clojure.core/contains? resp-input52615 "RoutingConfig") (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration resp-input52615)) (clojure.core/contains? resp-input52615 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input52615)))))
(clojure.core/defn req<-get-event-source-mapping-request [resp-input52617] {:uri {"UUID" (ser-string resp-input52617)}})
(clojure.core/defn req<-get-function-request [resp-input52618] (clojure.core/let [input52619 {:uri {"FunctionName" (ser-namespaced-function-name resp-input52618)}}] (clojure.core/cond-> input52619 (clojure.core/contains? resp-input52618 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52618)))))
(clojure.core/defn req<-get-policy-request [resp-input52620] (clojure.core/let [input52621 {:uri {"FunctionName" (ser-namespaced-function-name resp-input52620)}}] (clojure.core/cond-> input52621 (clojure.core/contains? resp-input52620 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52620)))))
(clojure.core/defn req<-add-permission-request [resp-input52622] (clojure.core/let [input52623 {:uri {"FunctionName" (ser-function-name resp-input52622)}, :body {"StatementId" (ser-statement-id resp-input52622), "Principal" (ser-principal resp-input52622), "Action" (ser-action resp-input52622)}}] (clojure.core/cond-> input52623 (clojure.core/contains? resp-input52622 "SourceAccount") (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner resp-input52622)) (clojure.core/contains? resp-input52622 "SourceArn") (clojure.core/assoc-in [:body "SourceArn"] (ser-arn resp-input52622)) (clojure.core/contains? resp-input52622 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input52622)) (clojure.core/contains? resp-input52622 "EventSourceToken") (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token resp-input52622)) (clojure.core/contains? resp-input52622 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52622)))))
(clojure.core/defn req<-create-event-source-mapping-request [resp-input52624] (clojure.core/let [input52625 {:body {"EventSourceArn" (ser-arn resp-input52624), "FunctionName" (ser-function-name resp-input52624), "StartingPosition" (ser-event-source-position resp-input52624)}}] (clojure.core/cond-> input52625 (clojure.core/contains? resp-input52624 "Enabled") (clojure.core/assoc-in [:body "Enabled"] (ser-enabled resp-input52624)) (clojure.core/contains? resp-input52624 "BatchSize") (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size resp-input52624)) (clojure.core/contains? resp-input52624 "StartingPositionTimestamp") (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date resp-input52624)))))
(clojure.core/defn req<-get-alias-request [resp-input52626] {:uri {"FunctionName" (ser-function-name resp-input52626), "Name" (ser-alias resp-input52626)}})
(clojure.core/defn req<-list-aliases-request [resp-input52627] (clojure.core/let [input52628 {:uri {"FunctionName" (ser-function-name resp-input52627)}}] (clojure.core/cond-> input52628 (clojure.core/contains? resp-input52627 "FunctionVersion") (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version resp-input52627)) (clojure.core/contains? resp-input52627 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input52627)) (clojure.core/contains? resp-input52627 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input52627)))))
(clojure.core/defn req<-list-functions-request [resp-input52629] (clojure.core/cond-> {} (clojure.core/contains? resp-input52629 "MasterRegion") (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region resp-input52629)) (clojure.core/contains? resp-input52629 "FunctionVersion") (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version resp-input52629)) (clojure.core/contains? resp-input52629 "Marker") (clojure.core/assoc-in [:query-string "Marker"] (ser-string resp-input52629)) (clojure.core/contains? resp-input52629 "MaxItems") (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items resp-input52629))))
(clojure.core/defn req<-remove-permission-request [resp-input52630] (clojure.core/let [input52631 {:uri {"FunctionName" (ser-function-name resp-input52630), "StatementId" (ser-namespaced-statement-id resp-input52630)}}] (clojure.core/cond-> input52631 (clojure.core/contains? resp-input52630 "Qualifier") (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier resp-input52630)) (clojure.core/contains? resp-input52630 "RevisionId") (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string resp-input52630)))))
(clojure.core/defn req<-delete-alias-request [resp-input52632] {:uri {"FunctionName" (ser-function-name resp-input52632), "Name" (ser-alias resp-input52632)}})
(clojure.core/defn req<-create-function-request [resp-input52633] (clojure.core/let [input52634 {:body {"FunctionName" (ser-function-name resp-input52633), "Handler" (ser-handler resp-input52633), "Runtime" (ser-runtime resp-input52633), "Role" (ser-role-arn resp-input52633), "Code" (ser-function-code resp-input52633)}}] (clojure.core/cond-> input52634 (clojure.core/contains? resp-input52633 "TracingConfig") (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config resp-input52633)) (clojure.core/contains? resp-input52633 "Timeout") (clojure.core/assoc-in [:body "Timeout"] (ser-timeout resp-input52633)) (clojure.core/contains? resp-input52633 "DeadLetterConfig") (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config resp-input52633)) (clojure.core/contains? resp-input52633 "Tags") (clojure.core/assoc-in [:body "Tags"] (ser-tags resp-input52633)) (clojure.core/contains? resp-input52633 "MemorySize") (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size resp-input52633)) (clojure.core/contains? resp-input52633 "KMSKeyArn") (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn resp-input52633)) (clojure.core/contains? resp-input52633 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input52633)) (clojure.core/contains? resp-input52633 "Environment") (clojure.core/assoc-in [:body "Environment"] (ser-environment resp-input52633)) (clojure.core/contains? resp-input52633 "VpcConfig") (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config resp-input52633)) (clojure.core/contains? resp-input52633 "Publish") (clojure.core/assoc-in [:body "Publish"] (ser-boolean resp-input52633)))))
(clojure.core/defn req<-untag-resource-request [resp-input52635] {:uri {"Resource" (ser-function-arn resp-input52635)}, :query-string {"TagKeys" (ser-tag-key-list resp-input52635)}})
(clojure.core/defn req<-publish-version-request [resp-input52636] (clojure.core/let [input52637 {:uri {"FunctionName" (ser-function-name resp-input52636)}}] (clojure.core/cond-> input52637 (clojure.core/contains? resp-input52636 "CodeSha256") (clojure.core/assoc-in [:body "CodeSha256"] (ser-string resp-input52636)) (clojure.core/contains? resp-input52636 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input52636)) (clojure.core/contains? resp-input52636 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input52636)))))
(clojure.core/defn req<-put-function-concurrency-request [resp-input52638] {:uri {"FunctionName" (ser-function-name resp-input52638)}, :body {"ReservedConcurrentExecutions" (ser-reserved-concurrent-executions resp-input52638)}})
(clojure.core/defn req<-update-function-configuration-request [resp-input52639] (clojure.core/let [input52640 {:uri {"FunctionName" (ser-function-name resp-input52639)}}] (clojure.core/cond-> input52640 (clojure.core/contains? resp-input52639 "TracingConfig") (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config resp-input52639)) (clojure.core/contains? resp-input52639 "Timeout") (clojure.core/assoc-in [:body "Timeout"] (ser-timeout resp-input52639)) (clojure.core/contains? resp-input52639 "DeadLetterConfig") (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config resp-input52639)) (clojure.core/contains? resp-input52639 "Handler") (clojure.core/assoc-in [:body "Handler"] (ser-handler resp-input52639)) (clojure.core/contains? resp-input52639 "Runtime") (clojure.core/assoc-in [:body "Runtime"] (ser-runtime resp-input52639)) (clojure.core/contains? resp-input52639 "MemorySize") (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size resp-input52639)) (clojure.core/contains? resp-input52639 "Role") (clojure.core/assoc-in [:body "Role"] (ser-role-arn resp-input52639)) (clojure.core/contains? resp-input52639 "KMSKeyArn") (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn resp-input52639)) (clojure.core/contains? resp-input52639 "Description") (clojure.core/assoc-in [:body "Description"] (ser-description resp-input52639)) (clojure.core/contains? resp-input52639 "Environment") (clojure.core/assoc-in [:body "Environment"] (ser-environment resp-input52639)) (clojure.core/contains? resp-input52639 "VpcConfig") (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config resp-input52639)) (clojure.core/contains? resp-input52639 "RevisionId") (clojure.core/assoc-in [:body "RevisionId"] (ser-string resp-input52639)))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 0 p1__51893__51894__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 1 p1__51893__51894__auto__)) (fn* [p1__51895__51896__auto__] (clojure.core/<= p1__51895__51896__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 140)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 0 p1__51893__51894__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 1 p1__51893__51894__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 128)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"[^\s]+" s__51840__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 170)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"\d{12}" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 100)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 128)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 1024)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"[0-9]+" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 128 p1__51893__51894__auto__)) (fn* [p1__51895__51896__auto__] (clojure.core/<= p1__51895__51896__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 100)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__51840__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 0 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__51893__51894__auto__] (clojure.core/<= 1 p1__51893__51894__auto__)) (fn* [p1__51895__51896__auto__] (clojure.core/<= p1__51895__51896__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 3 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 63)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 128)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__51840__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/event-source-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 0 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 256)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"[a-zA-Z0-9._\-]+" s__51840__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51838__auto__] (clojure.core/<= 1 (clojure.core/count s__51838__auto__))) (clojure.core/fn [s__51839__auto__] (clojure.core/< (clojure.core/count s__51839__auto__) 1024)) (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #".*" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__51840__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__51840__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__51840__auto__))))
