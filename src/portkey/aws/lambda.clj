...
(clojure.core/defn req<-tag-resource-request [input92360] {:uri {"Resource" (ser-function-arn (input92360 :resource))}, :body {"Tags" (ser-tags (input92360 :tags))}})
(clojure.core/defn req<-create-alias-request [input92361] (clojure.core/let [input92362 {:uri {"FunctionName" (ser-function-name (input92361 :function-name))}, :body {"Name" (ser-alias (input92361 :name)), "FunctionVersion" (ser-version (input92361 :function-version))}}] (clojure.core/cond-> input92362 (clojure.core/contains? input92361 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input92361 :description))) (clojure.core/contains? input92361 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (input92361 :routing-config))))))
(clojure.core/defn req<-delete-function-request [input92363] (clojure.core/let [input92364 {:uri {"FunctionName" (ser-function-name (input92363 :function-name))}}] (clojure.core/cond-> input92364 (clojure.core/contains? input92363 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92363 :qualifier))))))
(clojure.core/defn req<-list-event-source-mappings-request [input92365] (clojure.core/cond-> {} (clojure.core/contains? input92365 :event-source-arn) (clojure.core/assoc-in [:query-string "EventSourceArn"] (ser-arn (input92365 :event-source-arn))) (clojure.core/contains? input92365 :function-name) (clojure.core/assoc-in [:query-string "FunctionName"] (ser-function-name (input92365 :function-name))) (clojure.core/contains? input92365 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input92365 :marker))) (clojure.core/contains? input92365 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input92365 :max-items)))))
(clojure.core/defn req<-delete-function-concurrency-request [input92366] {:uri {"FunctionName" (ser-function-name (input92366 :function-name))}})
(clojure.core/defn req<-delete-event-source-mapping-request [input92367] {:uri {"UUID" (ser-string (input92367 :uuid))}})
(clojure.core/defn req<-invocation-request [input92368] (clojure.core/let [input92369 {:uri {"FunctionName" (ser-namespaced-function-name (input92368 :function-name))}}] (clojure.core/cond-> input92369 (clojure.core/contains? input92368 :invocation-type) (clojure.core/assoc-in [:headers "InvocationType"] (ser-invocation-type (input92368 :invocation-type))) (clojure.core/contains? input92368 :log-type) (clojure.core/assoc-in [:headers "LogType"] (ser-log-type (input92368 :log-type))) (clojure.core/contains? input92368 :client-context) (clojure.core/assoc-in [:headers "ClientContext"] (ser-string (input92368 :client-context))) (clojure.core/contains? input92368 :payload) (clojure.core/assoc-in [:body "Payload"] (ser-blob (input92368 :payload))) (clojure.core/contains? input92368 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92368 :qualifier))))))
(clojure.core/defn req<-get-account-settings-request [input92370] nil)
(clojure.core/defn req<-invoke-async-request [input92371] {:uri {"FunctionName" (ser-namespaced-function-name (input92371 :function-name))}, :body {"InvokeArgs" (ser-blob-stream (input92371 :invoke-args))}})
(clojure.core/defn req<-get-function-configuration-request [input92372] (clojure.core/let [input92373 {:uri {"FunctionName" (ser-namespaced-function-name (input92372 :function-name))}}] (clojure.core/cond-> input92373 (clojure.core/contains? input92372 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92372 :qualifier))))))
(clojure.core/defn req<-update-function-code-request [input92374] (clojure.core/let [input92375 {:uri {"FunctionName" (ser-function-name (input92374 :function-name))}}] (clojure.core/cond-> input92375 (clojure.core/contains? input92374 :zip-file) (clojure.core/assoc-in [:body "ZipFile"] (ser-blob (input92374 :zip-file))) (clojure.core/contains? input92374 :s3-bucket) (clojure.core/assoc-in [:body "S3Bucket"] (ser-s3-bucket (input92374 :s3-bucket))) (clojure.core/contains? input92374 :s3-key) (clojure.core/assoc-in [:body "S3Key"] (ser-s3-key (input92374 :s3-key))) (clojure.core/contains? input92374 :s3-object-version) (clojure.core/assoc-in [:body "S3ObjectVersion"] (ser-s3-object-version (input92374 :s3-object-version))) (clojure.core/contains? input92374 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (input92374 :publish))) (clojure.core/contains? input92374 :dry-run) (clojure.core/assoc-in [:body "DryRun"] (ser-boolean (input92374 :dry-run))) (clojure.core/contains? input92374 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input92374 :revision-id))))))
(clojure.core/defn req<-list-versions-by-function-request [input92376] (clojure.core/let [input92377 {:uri {"FunctionName" (ser-namespaced-function-name (input92376 :function-name))}}] (clojure.core/cond-> input92377 (clojure.core/contains? input92376 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input92376 :marker))) (clojure.core/contains? input92376 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input92376 :max-items))))))
(clojure.core/defn req<-update-event-source-mapping-request [input92378] (clojure.core/let [input92379 {:uri {"UUID" (ser-string (input92378 :uuid))}}] (clojure.core/cond-> input92379 (clojure.core/contains? input92378 :function-name) (clojure.core/assoc-in [:body "FunctionName"] (ser-function-name (input92378 :function-name))) (clojure.core/contains? input92378 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (input92378 :enabled))) (clojure.core/contains? input92378 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (input92378 :batch-size))))))
(clojure.core/defn req<-list-tags-request [input92380] {:uri {"Resource" (ser-function-arn (input92380 :resource))}})
(clojure.core/defn req<-update-alias-request [input92381] (clojure.core/let [input92382 {:uri {"FunctionName" (ser-function-name (input92381 :function-name)), "Name" (ser-alias (input92381 :name))}}] (clojure.core/cond-> input92382 (clojure.core/contains? input92381 :function-version) (clojure.core/assoc-in [:body "FunctionVersion"] (ser-version (input92381 :function-version))) (clojure.core/contains? input92381 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input92381 :description))) (clojure.core/contains? input92381 :routing-config) (clojure.core/assoc-in [:body "RoutingConfig"] (ser-alias-routing-configuration (input92381 :routing-config))) (clojure.core/contains? input92381 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input92381 :revision-id))))))
(clojure.core/defn req<-get-event-source-mapping-request [input92383] {:uri {"UUID" (ser-string (input92383 :uuid))}})
(clojure.core/defn req<-get-function-request [input92384] (clojure.core/let [input92385 {:uri {"FunctionName" (ser-namespaced-function-name (input92384 :function-name))}}] (clojure.core/cond-> input92385 (clojure.core/contains? input92384 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92384 :qualifier))))))
(clojure.core/defn req<-get-policy-request [input92386] (clojure.core/let [input92387 {:uri {"FunctionName" (ser-namespaced-function-name (input92386 :function-name))}}] (clojure.core/cond-> input92387 (clojure.core/contains? input92386 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92386 :qualifier))))))
(clojure.core/defn req<-add-permission-request [input92388] (clojure.core/let [input92389 {:uri {"FunctionName" (ser-function-name (input92388 :function-name))}, :body {"StatementId" (ser-statement-id (input92388 :statement-id)), "Principal" (ser-principal (input92388 :principal)), "Action" (ser-action (input92388 :action))}}] (clojure.core/cond-> input92389 (clojure.core/contains? input92388 :source-account) (clojure.core/assoc-in [:body "SourceAccount"] (ser-source-owner (input92388 :source-account))) (clojure.core/contains? input92388 :source-arn) (clojure.core/assoc-in [:body "SourceArn"] (ser-arn (input92388 :source-arn))) (clojure.core/contains? input92388 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input92388 :revision-id))) (clojure.core/contains? input92388 :event-source-token) (clojure.core/assoc-in [:body "EventSourceToken"] (ser-event-source-token (input92388 :event-source-token))) (clojure.core/contains? input92388 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92388 :qualifier))))))
(clojure.core/defn req<-create-event-source-mapping-request [input92390] (clojure.core/let [input92391 {:body {"EventSourceArn" (ser-arn (input92390 :event-source-arn)), "FunctionName" (ser-function-name (input92390 :function-name)), "StartingPosition" (ser-event-source-position (input92390 :starting-position))}}] (clojure.core/cond-> input92391 (clojure.core/contains? input92390 :enabled) (clojure.core/assoc-in [:body "Enabled"] (ser-enabled (input92390 :enabled))) (clojure.core/contains? input92390 :batch-size) (clojure.core/assoc-in [:body "BatchSize"] (ser-batch-size (input92390 :batch-size))) (clojure.core/contains? input92390 :starting-position-timestamp) (clojure.core/assoc-in [:body "StartingPositionTimestamp"] (ser-date (input92390 :starting-position-timestamp))))))
(clojure.core/defn req<-get-alias-request [input92392] {:uri {"FunctionName" (ser-function-name (input92392 :function-name)), "Name" (ser-alias (input92392 :name))}})
(clojure.core/defn req<-list-aliases-request [input92393] (clojure.core/let [input92394 {:uri {"FunctionName" (ser-function-name (input92393 :function-name))}}] (clojure.core/cond-> input92394 (clojure.core/contains? input92393 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-version (input92393 :function-version))) (clojure.core/contains? input92393 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input92393 :marker))) (clojure.core/contains? input92393 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input92393 :max-items))))))
(clojure.core/defn req<-list-functions-request [input92395] (clojure.core/cond-> {} (clojure.core/contains? input92395 :master-region) (clojure.core/assoc-in [:query-string "MasterRegion"] (ser-master-region (input92395 :master-region))) (clojure.core/contains? input92395 :function-version) (clojure.core/assoc-in [:query-string "FunctionVersion"] (ser-function-version (input92395 :function-version))) (clojure.core/contains? input92395 :marker) (clojure.core/assoc-in [:query-string "Marker"] (ser-string (input92395 :marker))) (clojure.core/contains? input92395 :max-items) (clojure.core/assoc-in [:query-string "MaxItems"] (ser-max-list-items (input92395 :max-items)))))
(clojure.core/defn req<-remove-permission-request [input92396] (clojure.core/let [input92397 {:uri {"FunctionName" (ser-function-name (input92396 :function-name)), "StatementId" (ser-namespaced-statement-id (input92396 :statement-id))}}] (clojure.core/cond-> input92397 (clojure.core/contains? input92396 :qualifier) (clojure.core/assoc-in [:query-string "Qualifier"] (ser-qualifier (input92396 :qualifier))) (clojure.core/contains? input92396 :revision-id) (clojure.core/assoc-in [:query-string "RevisionId"] (ser-string (input92396 :revision-id))))))
(clojure.core/defn req<-delete-alias-request [input92398] {:uri {"FunctionName" (ser-function-name (input92398 :function-name)), "Name" (ser-alias (input92398 :name))}})
(clojure.core/defn req<-create-function-request [input92399] (clojure.core/let [input92400 {:body {"FunctionName" (ser-function-name (input92399 :function-name)), "Handler" (ser-handler (input92399 :handler)), "Runtime" (ser-runtime (input92399 :runtime)), "Role" (ser-role-arn (input92399 :role)), "Code" (ser-function-code (input92399 :code))}}] (clojure.core/cond-> input92400 (clojure.core/contains? input92399 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (input92399 :tracing-config))) (clojure.core/contains? input92399 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (input92399 :timeout))) (clojure.core/contains? input92399 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (input92399 :dead-letter-config))) (clojure.core/contains? input92399 :tags) (clojure.core/assoc-in [:body "Tags"] (ser-tags (input92399 :tags))) (clojure.core/contains? input92399 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (input92399 :memory-size))) (clojure.core/contains? input92399 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (input92399 :kmskey-arn))) (clojure.core/contains? input92399 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input92399 :description))) (clojure.core/contains? input92399 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (input92399 :environment))) (clojure.core/contains? input92399 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (input92399 :vpc-config))) (clojure.core/contains? input92399 :publish) (clojure.core/assoc-in [:body "Publish"] (ser-boolean (input92399 :publish))))))
(clojure.core/defn req<-untag-resource-request [input92401] {:uri {"Resource" (ser-function-arn (input92401 :resource))}, :query-string {"TagKeys" (ser-tag-key-list (input92401 :tag-keys))}})
(clojure.core/defn req<-publish-version-request [input92402] (clojure.core/let [input92403 {:uri {"FunctionName" (ser-function-name (input92402 :function-name))}}] (clojure.core/cond-> input92403 (clojure.core/contains? input92402 :code-sha256) (clojure.core/assoc-in [:body "CodeSha256"] (ser-string (input92402 :code-sha256))) (clojure.core/contains? input92402 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input92402 :description))) (clojure.core/contains? input92402 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input92402 :revision-id))))))
(clojure.core/defn req<-put-function-concurrency-request [input92404] {:uri {"FunctionName" (ser-function-name (input92404 :function-name))}, :body {"ReservedConcurrentExecutions" (ser-reserved-concurrent-executions (input92404 :reserved-concurrent-executions))}})
(clojure.core/defn req<-update-function-configuration-request [input92405] (clojure.core/let [input92406 {:uri {"FunctionName" (ser-function-name (input92405 :function-name))}}] (clojure.core/cond-> input92406 (clojure.core/contains? input92405 :tracing-config) (clojure.core/assoc-in [:body "TracingConfig"] (ser-tracing-config (input92405 :tracing-config))) (clojure.core/contains? input92405 :timeout) (clojure.core/assoc-in [:body "Timeout"] (ser-timeout (input92405 :timeout))) (clojure.core/contains? input92405 :dead-letter-config) (clojure.core/assoc-in [:body "DeadLetterConfig"] (ser-dead-letter-config (input92405 :dead-letter-config))) (clojure.core/contains? input92405 :handler) (clojure.core/assoc-in [:body "Handler"] (ser-handler (input92405 :handler))) (clojure.core/contains? input92405 :runtime) (clojure.core/assoc-in [:body "Runtime"] (ser-runtime (input92405 :runtime))) (clojure.core/contains? input92405 :memory-size) (clojure.core/assoc-in [:body "MemorySize"] (ser-memory-size (input92405 :memory-size))) (clojure.core/contains? input92405 :role) (clojure.core/assoc-in [:body "Role"] (ser-role-arn (input92405 :role))) (clojure.core/contains? input92405 :kmskey-arn) (clojure.core/assoc-in [:body "KMSKeyArn"] (ser-kmskey-arn (input92405 :kmskey-arn))) (clojure.core/contains? input92405 :description) (clojure.core/assoc-in [:body "Description"] (ser-description (input92405 :description))) (clojure.core/contains? input92405 :environment) (clojure.core/assoc-in [:body "Environment"] (ser-environment (input92405 :environment))) (clojure.core/contains? input92405 :vpc-config) (clojure.core/assoc-in [:body "VpcConfig"] (ser-vpc-config (input92405 :vpc-config))) (clojure.core/contains? input92405 :revision-id) (clojure.core/assoc-in [:body "RevisionId"] (ser-string (input92405 :revision-id))))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/reserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 0 p1__91659__91660__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-object-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 1024))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/batch-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 1 p1__91659__91660__auto__)) (fn* [p1__91661__91662__auto__] (clojure.core/<= p1__91661__91662__auto__ 10000))))

(clojure.spec.alpha/def :portkey.aws.lambda/function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 140)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/unreserved-concurrent-executions (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 0 p1__91659__91660__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/timeout (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 1 p1__91659__91660__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/handler (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 128)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"[^\s]+" s__91606__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-function-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 170)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(arn:aws:lambda:)?([a-z]{2}-[a-z]+-\d{1}:)?(\d{12}:)?(function:)?([a-zA-Z0-9-_\.]+)(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/role-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"arn:aws:iam::\d{12}:role/?[a-zA-Z_0-9+=,.@\-_/]+" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/source-owner (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"\d{12}" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 100)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_]+)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/alias (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 128)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(?!^[0-9]+$)([a-zA-Z0-9-_]+)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/additional-version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 1024)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"[0-9]+" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/memory-size (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 128 p1__91659__91660__auto__)) (fn* [p1__91661__91662__auto__] (clojure.core/<= p1__91661__91662__auto__ 3008))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/namespaced-statement-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 100)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"([a-zA-Z0-9-_.]+)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/kmskey-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__91606__auto__))))

(clojure.spec.alpha/def :portkey.aws.lambda/description (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 0 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/max-list-items (clojure.spec.alpha/and clojure.core/int? (fn* [p1__91659__91660__auto__] (clojure.core/<= 1 p1__91659__91660__auto__)) (fn* [p1__91661__91662__auto__] (clojure.core/<= p1__91661__91662__auto__ 10000))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 1024))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/master-region (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"ALL|[a-z]{2}(-gov)?-[a-z]+-\d{1}" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"arn:aws:([a-zA-Z0-9\-])+:([a-z]{2}-[a-z]+-\d{1})?:(\d{12})?:(.*)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/environment-variable-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"[a-zA-Z]([a-zA-Z0-9_])+" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/s3-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 3 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 63)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"^[0-9A-Za-z\.\-_]*(?<!\.)$" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/qualifier (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 128)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(|[a-zA-Z0-9$_-]+)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(arn:aws:[a-z0-9-.]+:.*)|()" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/version (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91604__auto__] (clojure.core/<= 1 (clojure.core/count s__91604__auto__))) (clojure.core/fn [s__91605__auto__] (clojure.core/< (clojure.core/count s__91605__auto__) 1024)) (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(\$LATEST|[0-9]+)" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/principal (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #".*" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/action (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"(lambda:[*]|lambda:[a-zA-Z]+|[*])" s__91606__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.lambda/name-spaced-function-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__91606__auto__] (clojure.core/re-matches #"arn:aws:lambda:[a-z]{2}-[a-z]+-\d{1}:\d{12}:function:[a-zA-Z0-9-_\.]+(:(\$LATEST|[a-zA-Z0-9-_]+))?" s__91606__auto__))))
