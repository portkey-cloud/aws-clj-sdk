...
(clojure.core/defn- response-describe-stream-consumer-output ([input] (response-describe-stream-consumer-output nil input)) ([resultWrapper1170108 input] (clojure.core/let [rawinput1170107 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170109 {"ConsumerDescription" (rawinput1170107 "ConsumerDescription")}] (clojure.core/cond-> {:consumer-description (deser-consumer-description (clojure.core/get-in letvar1170109 ["ConsumerDescription"]))}))))

(clojure.core/defn- response-update-shard-count-output ([input] (response-update-shard-count-output nil input)) ([resultWrapper1170111 input] (clojure.core/let [rawinput1170110 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170112 {"StreamName" (rawinput1170110 "StreamName"), "CurrentShardCount" (rawinput1170110 "CurrentShardCount"), "TargetShardCount" (rawinput1170110 "TargetShardCount")}] (clojure.core/cond-> {} (letvar1170112 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1170112 ["StreamName"]))) (letvar1170112 "CurrentShardCount") (clojure.core/assoc :current-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1170112 ["CurrentShardCount"]))) (letvar1170112 "TargetShardCount") (clojure.core/assoc :target-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1170112 ["TargetShardCount"])))))))

(clojure.core/defn- response-list-stream-consumers-output ([input] (response-list-stream-consumers-output nil input)) ([resultWrapper1170114 input] (clojure.core/let [rawinput1170113 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170115 {"Consumers" (rawinput1170113 "Consumers"), "NextToken" (rawinput1170113 "NextToken")}] (clojure.core/cond-> {} (letvar1170115 "Consumers") (clojure.core/assoc :consumers (deser-consumer-list (clojure.core/get-in letvar1170115 ["Consumers"]))) (letvar1170115 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1170115 ["NextToken"])))))))

(clojure.core/defn- response-enhanced-monitoring-output ([input] (response-enhanced-monitoring-output nil input)) ([resultWrapper1170117 input] (clojure.core/let [rawinput1170116 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170118 {"StreamName" (rawinput1170116 "StreamName"), "CurrentShardLevelMetrics" (rawinput1170116 "CurrentShardLevelMetrics"), "DesiredShardLevelMetrics" (rawinput1170116 "DesiredShardLevelMetrics")}] (clojure.core/cond-> {} (letvar1170118 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1170118 ["StreamName"]))) (letvar1170118 "CurrentShardLevelMetrics") (clojure.core/assoc :current-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1170118 ["CurrentShardLevelMetrics"]))) (letvar1170118 "DesiredShardLevelMetrics") (clojure.core/assoc :desired-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1170118 ["DesiredShardLevelMetrics"])))))))

(clojure.core/defn- response-describe-stream-summary-output ([input] (response-describe-stream-summary-output nil input)) ([resultWrapper1170120 input] (clojure.core/let [rawinput1170119 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170121 {"StreamDescriptionSummary" (rawinput1170119 "StreamDescriptionSummary")}] (clojure.core/cond-> {:stream-description-summary (deser-stream-description-summary (clojure.core/get-in letvar1170121 ["StreamDescriptionSummary"]))}))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1170123 input] (clojure.core/let [rawinput1170122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170124 {"Tags" (rawinput1170122 "Tags"), "HasMoreTags" (rawinput1170122 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-tag-list (clojure.core/get-in letvar1170124 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar1170124 ["HasMoreTags"]))}))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1170126 input] (clojure.core/let [rawinput1170125 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170127 {"message" (rawinput1170125 "message")}] (clojure.core/cond-> {} (letvar1170127 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170127 ["message"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1170129 input] (clojure.core/let [rawinput1170128 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170130 {"message" (rawinput1170128 "message")}] (clojure.core/cond-> {} (letvar1170130 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170130 ["message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1170132 input] (clojure.core/let [rawinput1170131 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170133 {"message" (rawinput1170131 "message")}] (clojure.core/cond-> {} (letvar1170133 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170133 ["message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1170135 input] (clojure.core/let [rawinput1170134 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170136 {"message" (rawinput1170134 "message")}] (clojure.core/cond-> {} (letvar1170136 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170136 ["message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1170138 input] (clojure.core/let [rawinput1170137 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170139 {"StreamDescription" (rawinput1170137 "StreamDescription")}] (clojure.core/cond-> {:stream-description (deser-stream-description (clojure.core/get-in letvar1170139 ["StreamDescription"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1170141 input] (clojure.core/let [rawinput1170140 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170142 {"message" (rawinput1170140 "message")}] (clojure.core/cond-> {} (letvar1170142 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170142 ["message"])))))))

(clojure.core/defn- response-put-records-output ([input] (response-put-records-output nil input)) ([resultWrapper1170144 input] (clojure.core/let [rawinput1170143 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170145 {"FailedRecordCount" (rawinput1170143 "FailedRecordCount"), "Records" (rawinput1170143 "Records"), "EncryptionType" (rawinput1170143 "EncryptionType")}] (clojure.core/cond-> {:records (deser-put-records-result-entry-list (clojure.core/get-in letvar1170145 ["Records"]))} (letvar1170145 "FailedRecordCount") (clojure.core/assoc :failed-record-count (deser-positive-integer-object (clojure.core/get-in letvar1170145 ["FailedRecordCount"]))) (letvar1170145 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1170145 ["EncryptionType"])))))))

(clojure.core/defn- response-subscribe-to-shard-output ([input] (response-subscribe-to-shard-output nil input)) ([resultWrapper1170147 input] (clojure.core/let [rawinput1170146 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170148 {"EventStream" (rawinput1170146 "EventStream")}] (clojure.core/cond-> {:event-stream (deser-subscribe-to-shard-event-stream (clojure.core/get-in letvar1170148 ["EventStream"]))}))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper1170150 input] (clojure.core/let [rawinput1170149 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170151 {"message" (rawinput1170149 "message")}] (clojure.core/cond-> {} (letvar1170151 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170151 ["message"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1170153 input] (clojure.core/let [rawinput1170152 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170154 {"message" (rawinput1170152 "message")}] (clojure.core/cond-> {} (letvar1170154 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170154 ["message"])))))))

(clojure.core/defn- response-describe-limits-output ([input] (response-describe-limits-output nil input)) ([resultWrapper1170156 input] (clojure.core/let [rawinput1170155 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170157 {"ShardLimit" (rawinput1170155 "ShardLimit"), "OpenShardCount" (rawinput1170155 "OpenShardCount")}] (clojure.core/cond-> {:shard-limit (deser-shard-count-object (clojure.core/get-in letvar1170157 ["ShardLimit"])), :open-shard-count (deser-shard-count-object (clojure.core/get-in letvar1170157 ["OpenShardCount"]))}))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper1170159 input] (clojure.core/let [rawinput1170158 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170160 {"Records" (rawinput1170158 "Records"), "NextShardIterator" (rawinput1170158 "NextShardIterator"), "MillisBehindLatest" (rawinput1170158 "MillisBehindLatest")}] (clojure.core/cond-> {:records (deser-record-list (clojure.core/get-in letvar1170160 ["Records"]))} (letvar1170160 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1170160 ["NextShardIterator"]))) (letvar1170160 "MillisBehindLatest") (clojure.core/assoc :millis-behind-latest (deser-millis-behind-latest (clojure.core/get-in letvar1170160 ["MillisBehindLatest"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1170162 input] (clojure.core/let [rawinput1170161 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170163 {"message" (rawinput1170161 "message")}] (clojure.core/cond-> {} (letvar1170163 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170163 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1170165 input] (clojure.core/let [rawinput1170164 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170166 {"message" (rawinput1170164 "message")}] (clojure.core/cond-> {} (letvar1170166 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170166 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1170168 input] (clojure.core/let [rawinput1170167 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170169 {"StreamNames" (rawinput1170167 "StreamNames"), "HasMoreStreams" (rawinput1170167 "HasMoreStreams")}] (clojure.core/cond-> {:stream-names (deser-stream-name-list (clojure.core/get-in letvar1170169 ["StreamNames"])), :has-more-streams (deser-boolean-object (clojure.core/get-in letvar1170169 ["HasMoreStreams"]))}))))

(clojure.core/defn- response-list-shards-output ([input] (response-list-shards-output nil input)) ([resultWrapper1170171 input] (clojure.core/let [rawinput1170170 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170172 {"Shards" (rawinput1170170 "Shards"), "NextToken" (rawinput1170170 "NextToken")}] (clojure.core/cond-> {} (letvar1170172 "Shards") (clojure.core/assoc :shards (deser-shard-list (clojure.core/get-in letvar1170172 ["Shards"]))) (letvar1170172 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1170172 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1170174 input] (clojure.core/let [rawinput1170173 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170175 {"message" (rawinput1170173 "message")}] (clojure.core/cond-> {} (letvar1170175 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170175 ["message"])))))))

(clojure.core/defn- response-kms-throttling-exception ([input] (response-kms-throttling-exception nil input)) ([resultWrapper1170177 input] (clojure.core/let [rawinput1170176 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170178 {"message" (rawinput1170176 "message")}] (clojure.core/cond-> {} (letvar1170178 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170178 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper1170180 input] (clojure.core/let [rawinput1170179 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170181 {"ShardIterator" (rawinput1170179 "ShardIterator")}] (clojure.core/cond-> {} (letvar1170181 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1170181 ["ShardIterator"])))))))

(clojure.core/defn- response-register-stream-consumer-output ([input] (response-register-stream-consumer-output nil input)) ([resultWrapper1170183 input] (clojure.core/let [rawinput1170182 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170184 {"Consumer" (rawinput1170182 "Consumer")}] (clojure.core/cond-> {:consumer (deser-consumer (clojure.core/get-in letvar1170184 ["Consumer"]))}))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper1170186 input] (clojure.core/let [rawinput1170185 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170187 {"ShardId" (rawinput1170185 "ShardId"), "SequenceNumber" (rawinput1170185 "SequenceNumber"), "EncryptionType" (rawinput1170185 "EncryptionType")}] (clojure.core/cond-> {:shard-id (deser-shard-id (clojure.core/get-in letvar1170187 ["ShardId"])), :sequence-number (deser-sequence-number (clojure.core/get-in letvar1170187 ["SequenceNumber"]))} (letvar1170187 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1170187 ["EncryptionType"])))))))

(clojure.core/defn- response-kms-opt-in-required ([input] (response-kms-opt-in-required nil input)) ([resultWrapper1170189 input] (clojure.core/let [rawinput1170188 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170190 {"message" (rawinput1170188 "message")}] (clojure.core/cond-> {} (letvar1170190 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170190 ["message"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1170192 input] (clojure.core/let [rawinput1170191 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1170193 {"message" (rawinput1170191 "message")}] (clojure.core/cond-> {} (letvar1170193 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1170193 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/consumer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/consumer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(arn):aws.*:kinesis:.*:\d{12}:.*stream\/[a-zA-Z0-9_.-]+\/consumer\/[a-zA-Z0-9_.-]+:[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/partition-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1048576))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,128})" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/hash-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,38})" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis.-2013-12-02/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws.*:kinesis:.*:\d{12}:stream/.*" s__21078__auto__))))
