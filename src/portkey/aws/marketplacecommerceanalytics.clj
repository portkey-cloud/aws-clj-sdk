...
(clojure.core/defn- response-marketplace-commerce-analytics-exception ([input] (response-marketplace-commerce-analytics-exception nil input)) ([resultWrapper1901409 input] (clojure.core/let [rawinput1901408 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901410 {"message" (rawinput1901408 "message")}] (clojure.core/cond-> {} (letvar1901410 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1901410 ["message"])))))))

(clojure.core/defn- response-generate-data-set-result ([input] (response-generate-data-set-result nil input)) ([resultWrapper1901412 input] (clojure.core/let [rawinput1901411 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901413 {"dataSetRequestId" (rawinput1901411 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1901413 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1901413 ["dataSetRequestId"])))))))

(clojure.core/defn- response-start-support-data-export-result ([input] (response-start-support-data-export-result nil input)) ([resultWrapper1901415 input] (clojure.core/let [rawinput1901414 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1901416 {"dataSetRequestId" (rawinput1901414 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1901416 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1901416 ["dataSetRequestId"])))))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/optional-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/optional-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/role-name-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/destination-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__)))))
