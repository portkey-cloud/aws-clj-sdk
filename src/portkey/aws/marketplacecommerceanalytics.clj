...
(clojure.core/defn- response-marketplace-commerce-analytics-exception ([input] (response-marketplace-commerce-analytics-exception nil input)) ([resultWrapper1916527 input] (clojure.core/let [rawinput1916526 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916528 {"message" (rawinput1916526 "message")}] (clojure.core/cond-> {} (letvar1916528 "message") (clojure.core/assoc :message (deser-exception-message (clojure.core/get-in letvar1916528 ["message"])))))))

(clojure.core/defn- response-generate-data-set-result ([input] (response-generate-data-set-result nil input)) ([resultWrapper1916530 input] (clojure.core/let [rawinput1916529 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916531 {"dataSetRequestId" (rawinput1916529 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1916531 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1916531 ["dataSetRequestId"])))))))

(clojure.core/defn- response-start-support-data-export-result ([input] (response-start-support-data-export-result nil input)) ([resultWrapper1916533 input] (clojure.core/let [rawinput1916532 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1916534 {"dataSetRequestId" (rawinput1916532 "dataSetRequestId")}] (clojure.core/cond-> {} (letvar1916534 "dataSetRequestId") (clojure.core/assoc :data-set-request-id (deser-data-set-request-id (clojure.core/get-in letvar1916534 ["dataSetRequestId"])))))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/optional-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/optional-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 255))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/role-name-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/sns-topic-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))

(clojure.spec.alpha/def :portkey.aws.marketplacecommerceanalytics/destination-s-3-bucket-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__)))))
