...
(clojure.core/defn describe-cluster ([describe-cluster-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-cluster-request describe-cluster-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.eks.-2017-11-01/endpoints, :http.request.spec/output-spec :portkey.aws.eks.-2017-11-01/describe-cluster-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/clusters/{name}", :http.request.configuration/version "2017-11-01", :http.request.configuration/service-id "EKS", :http.request.spec/input-spec :portkey.aws.eks.-2017-11-01/describe-cluster-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.configuration/action "DescribeCluster", :http.request.spec/error-spec {"ResourceNotFoundException" :portkey.aws.eks.-2017-11-01/resource-not-found-exception, "ClientException" :portkey.aws.eks.-2017-11-01/client-exception, "ServerException" :portkey.aws.eks.-2017-11-01/server-exception, "ServiceUnavailableException" :portkey.aws.eks.-2017-11-01/service-unavailable-exception}})))))
...
(clojure.core/defn list-clusters ([] (list-clusters {})) ([list-clusters-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-clusters-request list-clusters-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.eks.-2017-11-01/endpoints, :http.request.spec/output-spec :portkey.aws.eks.-2017-11-01/list-clusters-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/clusters", :http.request.configuration/version "2017-11-01", :http.request.configuration/service-id "EKS", :http.request.spec/input-spec :portkey.aws.eks.-2017-11-01/list-clusters-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code nil, :http.request.configuration/action "ListClusters", :http.request.spec/error-spec {"InvalidParameterException" :portkey.aws.eks.-2017-11-01/invalid-parameter-exception, "ClientException" :portkey.aws.eks.-2017-11-01/client-exception, "ServerException" :portkey.aws.eks.-2017-11-01/server-exception, "ServiceUnavailableException" :portkey.aws.eks.-2017-11-01/service-unavailable-exception}})))))
