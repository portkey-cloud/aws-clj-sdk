...
(clojure.spec.alpha/def :portkey.aws.medialive/update-input-security-group-request (clojure.spec.alpha/keys :req-un [:portkey.aws.medialive.update-input-security-group-request/input-security-group-id] :opt-un [:portkey.aws.medialive.update-input-security-group-request/whitelist-rules]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/fixed-mode-schedule-action-start-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.fixed-mode-schedule-action-start-settings/time]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-6-max-6 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 6 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 6))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input-type #{:rtmp-pull :url-pull :rtmp-push "RTMP_PULL" "UDP_PUSH" "URL_PULL" :rtp-push :udp-push "RTP_PUSH" "RTMP_PUSH"})
...
(clojure.spec.alpha/def :portkey.aws.medialive/h-264-rate-control-mode #{"VBR" :cbr :vbr "CBR"})
...
(clojure.spec.alpha/def :portkey.aws.medialive/channel-summary (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.channel-summary/input-attachments :portkey.aws.medialive.channel-summary/pipelines-running-count :portkey.aws.medialive/log-level :portkey.aws.medialive.channel-summary/role-arn :portkey.aws.medialive.channel-summary/egress-endpoints :portkey.aws.medialive.channel-summary/arn :portkey.aws.medialive/input-specification :portkey.aws.medialive.channel-summary/state :portkey.aws.medialive.channel-summary/destinations :portkey.aws.medialive.channel-summary/name :portkey.aws.medialive.channel-summary/id]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/schedule-action-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.schedule-action-settings/scte-35-return-to-network-settings :portkey.aws.medialive.schedule-action-settings/scte-35-splice-insert-settings :portkey.aws.medialive.schedule-action-settings/scte-35-time-signal-settings :portkey.aws.medialive.schedule-action-settings/static-image-activate-settings :portkey.aws.medialive.schedule-action-settings/static-image-deactivate-settings]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input-security-group (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.input-security-group/arn :portkey.aws.medialive.input-security-group/id :portkey.aws.medialive.input-security-group/inputs :portkey.aws.medialive.input-security-group/state :portkey.aws.medialive.input-security-group/whitelist-rules]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/output-group-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive/archive-group-settings :portkey.aws.medialive/hls-group-settings :portkey.aws.medialive/ms-smooth-group-settings :portkey.aws.medialive/rtmp-group-settings :portkey.aws.medialive/udp-group-settings]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/create-input (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.create-input/destinations :portkey.aws.medialive.create-input/input-security-groups :portkey.aws.medialive.create-input/name :portkey.aws.medialive.create-input/request-id :portkey.aws.medialive.create-input/sources :portkey.aws.medialive.create-input/type]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.input/type :portkey.aws.medialive.input/security-groups :portkey.aws.medialive.input/arn :portkey.aws.medialive.input/state :portkey.aws.medialive.input/destinations :portkey.aws.medialive.input/name :portkey.aws.medialive.input/sources :portkey.aws.medialive.input/attached-channels :portkey.aws.medialive.input/id]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/purchase-offering-request (clojure.spec.alpha/keys :req-un [:portkey.aws.medialive.purchase-offering-request/offering-id] :opt-un [:portkey.aws.medialive.purchase-offering-request/count :portkey.aws.medialive.purchase-offering-request/name :portkey.aws.medialive.purchase-offering-request/request-id]))

(clojure.spec.alpha/def :portkey.aws.medialive/string-min-1-max-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 1 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/video-codec-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive/h-264-settings]))

(clojure.spec.alpha/def :portkey.aws.medialive/string-max-32 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input-destination (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.input-destination/ip :portkey.aws.medialive.input-destination/port :portkey.aws.medialive.input-destination/url]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/output-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive/archive-output-settings :portkey.aws.medialive/hls-output-settings :portkey.aws.medialive/ms-smooth-output-settings :portkey.aws.medialive/rtmp-output-settings :portkey.aws.medialive/udp-output-settings]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/schedule-action-start-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive/fixed-mode-schedule-action-start-settings]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/static-key-settings (clojure.spec.alpha/keys :req-un [:portkey.aws.medialive.static-key-settings/key-provider-server :portkey.aws.medialive.static-key-settings/static-key-value] :opt-un []))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input-security-group-whitelist-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.input-security-group-whitelist-request/whitelist-rules]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/input-attachment (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.input-attachment/input-id :portkey.aws.medialive/input-settings]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-3-max-3 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 3 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 3))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/describe-input-response (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.describe-input-response/type :portkey.aws.medialive.describe-input-response/security-groups :portkey.aws.medialive.describe-input-response/arn :portkey.aws.medialive.describe-input-response/state :portkey.aws.medialive.describe-input-response/destinations :portkey.aws.medialive.describe-input-response/name :portkey.aws.medialive.describe-input-response/sources :portkey.aws.medialive.describe-input-response/attached-channels :portkey.aws.medialive.describe-input-response/id]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/channel (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.channel/input-attachments :portkey.aws.medialive.channel/pipelines-running-count :portkey.aws.medialive/log-level :portkey.aws.medialive.channel/role-arn :portkey.aws.medialive.channel/egress-endpoints :portkey.aws.medialive/encoder-settings :portkey.aws.medialive.channel/arn :portkey.aws.medialive/input-specification :portkey.aws.medialive.channel/state :portkey.aws.medialive.channel/destinations :portkey.aws.medialive.channel/name :portkey.aws.medialive.channel/id]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-1 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 1 (clojure.core/count s__42947__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/purchase-offering (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.purchase-offering/count :portkey.aws.medialive.purchase-offering/name :portkey.aws.medialive.purchase-offering/request-id]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/rtmp-group-settings (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive/authentication-scheme :portkey.aws.medialive.rtmp-group-settings/cache-full-behavior :portkey.aws.medialive.rtmp-group-settings/cache-length :portkey.aws.medialive.rtmp-group-settings/caption-data :portkey.aws.medialive.rtmp-group-settings/restart-delay]))
...
(clojure.spec.alpha/def :portkey.aws.medialive.caption-selector/name (clojure.spec.alpha/and :portkey.aws.medialive/string))
...
(clojure.spec.alpha/def :portkey.aws.medialive/create-input-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.create-input-request/destinations :portkey.aws.medialive.create-input-request/input-security-groups :portkey.aws.medialive.create-input-request/name :portkey.aws.medialive.create-input-request/request-id :portkey.aws.medialive.create-input-request/sources :portkey.aws.medialive.create-input-request/type]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/update-input (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.update-input/destinations :portkey.aws.medialive.update-input/input-security-groups :portkey.aws.medialive.update-input/name :portkey.aws.medialive.update-input/sources]))
...
(clojure.spec.alpha/def :portkey.aws.medialive/create-input-security-group-request (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.medialive.create-input-security-group-request/whitelist-rules]))
...
(clojure.spec.alpha/def :portkey.aws.medialive.h-264-settings/framerate-denominator (clojure.spec.alpha/and :portkey.aws.medialive/integer))
...
(clojure.spec.alpha/def :portkey.aws.medialive.h-264-settings/framerate-numerator (clojure.spec.alpha/and :portkey.aws.medialive/integer))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-1-max-255 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 1 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 255))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-32-max-32 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 32 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 32))))
...
(clojure.spec.alpha/def :portkey.aws.medialive/string-min-34-max-34 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__42947__auto__] (clojure.core/<= 34 (clojure.core/count s__42947__auto__))) (clojure.core/fn [s__42948__auto__] (clojure.core/< (clojure.core/count s__42948__auto__) 34))))

(clojure.spec.alpha/def :portkey.aws.medialive.audio-selector/name (clojure.spec.alpha/and :portkey.aws.medialive/string))
...
(clojure.core/defn describe-input ([describe-input-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-input-request describe-input-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/describe-input-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputs/{inputId}", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/describe-input-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "DescribeInput", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn list-inputs ([] (list-inputs {})) ([list-inputs-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-inputs-request list-inputs-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/list-inputs-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputs", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/list-inputs-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "ListInputs", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn create-input ([] (create-input {})) ([create-input-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-create-input-request create-input-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/create-input-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputs", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/create-input-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.configuration/action "CreateInput", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn create-channel ([] (create-channel {})) ([create-channel-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-create-channel-request create-channel-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/create-channel-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/channels", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/create-channel-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code 201, :http.request.configuration/action "CreateChannel", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "UnprocessableEntityException" :portkey.aws.medialive/unprocessable-entity-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception, "ConflictException" :portkey.aws.medialive/conflict-exception}})))))
...
(clojure.core/defn describe-channel ([describe-channel-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-channel-request describe-channel-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/describe-channel-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/channels/{channelId}", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/describe-channel-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "DescribeChannel", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn list-channels ([] (list-channels {})) ([list-channels-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-channels-request list-channels-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/list-channels-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/channels", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/list-channels-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "ListChannels", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn describe-reservation ([describe-reservation-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-reservation-request describe-reservation-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/describe-reservation-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/reservations/{reservationId}", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/describe-reservation-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "DescribeReservation", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn describe-input-security-group ([describe-input-security-group-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-input-security-group-request describe-input-security-group-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/describe-input-security-group-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputSecurityGroups/{inputSecurityGroupId}", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/describe-input-security-group-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "DescribeInputSecurityGroup", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn list-input-security-groups ([] (list-input-security-groups {})) ([list-input-security-groups-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-input-security-groups-request list-input-security-groups-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/list-input-security-groups-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputSecurityGroups", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/list-input-security-groups-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "ListInputSecurityGroups", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn list-offerings ([] (list-offerings {})) ([list-offerings-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-list-offerings-request list-offerings-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/list-offerings-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/offerings", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/list-offerings-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "ListOfferings", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn create-input-security-group ([] (create-input-security-group {})) ([create-input-security-group-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-create-input-security-group-request create-input-security-group-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/create-input-security-group-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/inputSecurityGroups", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/create-input-security-group-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code 200, :http.request.configuration/action "CreateInputSecurityGroup", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
...
(clojure.core/defn start-channel ([start-channel-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-start-channel-request start-channel-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/start-channel-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/channels/{channelId}/start", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/start-channel-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :post, :http.request.configuration/response-code 200, :http.request.configuration/action "StartChannel", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception, "ConflictException" :portkey.aws.medialive/conflict-exception}})))))
...
(clojure.core/defn describe-schedule ([describe-schedule-requestinput] (clojure.core/let [request-function-result__43533__auto__ (req-describe-schedule-request describe-schedule-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__43533__auto__ {:http.request.configuration/endpoints portkey.aws.medialive/endpoints, :http.request.spec/output-spec :portkey.aws.medialive/describe-schedule-response, :http.request.configuration/mime-type {"content-type" "application/json"}, :http.request.configuration/request-uri "/prod/channels/{channelId}/schedule", :http.request.configuration/version "2017-10-14", :http.request.configuration/service-id "MediaLive", :http.request.spec/input-spec :portkey.aws.medialive/describe-schedule-request, :http.request.configuration/protocol "rest-json", :http.request.configuration/method :get, :http.request.configuration/response-code 200, :http.request.configuration/action "DescribeSchedule", :http.request.spec/error-spec {"BadRequestException" :portkey.aws.medialive/bad-request-exception, "InternalServerErrorException" :portkey.aws.medialive/internal-server-error-exception, "ForbiddenException" :portkey.aws.medialive/forbidden-exception, "BadGatewayException" :portkey.aws.medialive/bad-gateway-exception, "NotFoundException" :portkey.aws.medialive/not-found-exception, "GatewayTimeoutException" :portkey.aws.medialive/gateway-timeout-exception, "TooManyRequestsException" :portkey.aws.medialive/too-many-requests-exception}})))))
