...
(clojure.core/defn- response-detect-phi-response ([input] (response-detect-phi-response nil input)) ([resultWrapper478952 input] (clojure.core/let [rawinput478951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478953 {"Entities" (rawinput478951 "Entities"), "PaginationToken" (rawinput478951 "PaginationToken")}] (clojure.core/cond-> {:entities (deser-entity-list (clojure.core/get-in letvar478953 ["Entities"]))} (letvar478953 "PaginationToken") (clojure.core/assoc :pagination-token (deser-string (clojure.core/get-in letvar478953 ["PaginationToken"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper478955 input] (clojure.core/let [rawinput478954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478956 {"Message" (rawinput478954 "Message")}] (clojure.core/cond-> {} (letvar478956 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478956 ["Message"])))))))

(clojure.core/defn- response-text-size-limit-exceeded-exception ([input] (response-text-size-limit-exceeded-exception nil input)) ([resultWrapper478958 input] (clojure.core/let [rawinput478957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478959 {"Message" (rawinput478957 "Message")}] (clojure.core/cond-> {} (letvar478959 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478959 ["Message"])))))))

(clojure.core/defn- response-service-unavailable-exception ([input] (response-service-unavailable-exception nil input)) ([resultWrapper478961 input] (clojure.core/let [rawinput478960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478962 {"Message" (rawinput478960 "Message")}] (clojure.core/cond-> {} (letvar478962 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478962 ["Message"])))))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper478964 input] (clojure.core/let [rawinput478963 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478965 {"Message" (rawinput478963 "Message")}] (clojure.core/cond-> {} (letvar478965 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478965 ["Message"])))))))

(clojure.core/defn- response-internal-server-exception ([input] (response-internal-server-exception nil input)) ([resultWrapper478967 input] (clojure.core/let [rawinput478966 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478968 {"Message" (rawinput478966 "Message")}] (clojure.core/cond-> {} (letvar478968 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478968 ["Message"])))))))

(clojure.core/defn- response-invalid-encoding-exception ([input] (response-invalid-encoding-exception nil input)) ([resultWrapper478970 input] (clojure.core/let [rawinput478969 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478971 {"Message" (rawinput478969 "Message")}] (clojure.core/cond-> {} (letvar478971 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar478971 ["Message"])))))))

(clojure.core/defn- response-detect-entities-response ([input] (response-detect-entities-response nil input)) ([resultWrapper478973 input] (clojure.core/let [rawinput478972 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar478974 {"Entities" (rawinput478972 "Entities"), "UnmappedAttributes" (rawinput478972 "UnmappedAttributes"), "PaginationToken" (rawinput478972 "PaginationToken")}] (clojure.core/cond-> {:entities (deser-entity-list (clojure.core/get-in letvar478974 ["Entities"]))} (letvar478974 "UnmappedAttributes") (clojure.core/assoc :unmapped-attributes (deser-unmapped-attribute-list (clojure.core/get-in letvar478974 ["UnmappedAttributes"]))) (letvar478974 "PaginationToken") (clojure.core/assoc :pagination-token (deser-string (clojure.core/get-in letvar478974 ["PaginationToken"])))))))
...
(clojure.spec.alpha/def :portkey.aws.comprehendmedical/string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.comprehendmedical/bounded-length-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20000))))
