...
(clojure.core/defn- deser-bucket [input] (clojure.core/let [letvar166351 {"Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "CreationDate" (portkey.aws/search-for-tag input "CreationDate" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar166351 "Name") (clojure.core/assoc :name (deser-bucket-name (clojure.core/get-in letvar166351 ["Name" :content]))) (letvar166351 "CreationDate") (clojure.core/assoc :creation-date (deser-creation-date (clojure.core/get-in letvar166351 ["CreationDate" :content]))))))

(clojure.core/defn- deser-metrics-configuration [input] (clojure.core/let [letvar166447 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-metrics-id (clojure.core/get-in letvar166447 ["Id" :content]))} (letvar166447 "Filter") (clojure.core/assoc :filter (deser-metrics-filter (clojure.core/get-in letvar166447 ["Filter" :content]))))))
...
(clojure.core/defn- deser-expired-object-delete-marker [input] (clojure.core/when-let [boolstr__23442__auto__ (if (clojure.core/seq? input) (clojure.core/first input) input)] (clojure.core/cond (clojure.core/= "true" boolstr__23442__auto__) true (clojure.core/= "false" boolstr__23442__auto__) false)))
...
(clojure.core/defn- deser-continuation-event [input] (clojure.core/let [letvar166659 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-access-control-translation [input] (clojure.core/let [letvar166787 {"Owner" (portkey.aws/search-for-tag input "Owner" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:owner (deser-owner-override (clojure.core/get-in letvar166787 ["Owner" :content]))})))

(clojure.core/defn- deser-topic-configuration-deprecated [input] (clojure.core/let [letvar166883 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? false :xmlAttribute? nil), "Topic" (portkey.aws/search-for-tag input "Topic" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar166883 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar166883 ["Id" :content]))) (letvar166883 "Event") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar166883 ["Event"]))) (letvar166883 "Event") (clojure.core/assoc :event (deser-event (clojure.core/get-in letvar166883 ["Event" :content]))) (letvar166883 "Topic") (clojure.core/assoc :topic (deser-topic-arn (clojure.core/get-in letvar166883 ["Topic" :content]))))))
...
(clojure.core/defn- deser-encryption-configuration [input] (clojure.core/let [letvar167019 {"ReplicaKmsKeyID" (portkey.aws/search-for-tag input "ReplicaKmsKeyID" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167019 "ReplicaKmsKeyID") (clojure.core/assoc :replica-kms-key-id (deser-replica-kms-key-id (clojure.core/get-in letvar167019 ["ReplicaKmsKeyID" :content]))))))

(clojure.core/defn- deser-inventory-filter [input] (clojure.core/let [letvar167115 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:prefix (deser-prefix (clojure.core/get-in letvar167115 ["Prefix" :content]))})))

(clojure.core/defn- deser-cloud-function-configuration [input] (clojure.core/let [letvar167211 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? true :xmlAttribute? nil), "CloudFunction" (portkey.aws/search-for-tag input "CloudFunction" :flattened? false :xmlAttribute? nil), "InvocationRole" (portkey.aws/search-for-tag input "InvocationRole" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167211 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar167211 ["Id" :content]))) (letvar167211 "Event") (clojure.core/assoc :event (deser-event (clojure.core/get-in letvar167211 ["Event" :content]))) (letvar167211 "Event") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar167211 ["Event"]))) (letvar167211 "CloudFunction") (clojure.core/assoc :cloud-function (deser-cloud-function (clojure.core/get-in letvar167211 ["CloudFunction" :content]))) (letvar167211 "InvocationRole") (clojure.core/assoc :invocation-role (deser-cloud-function-invocation-role (clojure.core/get-in letvar167211 ["InvocationRole" :content]))))))
...
(clojure.core/defn- deser-select-object-content-event-stream [input] (clojure.core/let [letvar167317 {"Records" (portkey.aws/search-for-tag input "Records" :flattened? false :xmlAttribute? nil), "Stats" (portkey.aws/search-for-tag input "Stats" :flattened? false :xmlAttribute? nil), "Progress" (portkey.aws/search-for-tag input "Progress" :flattened? false :xmlAttribute? nil), "Cont" (portkey.aws/search-for-tag input "Cont" :flattened? false :xmlAttribute? nil), "End" (portkey.aws/search-for-tag input "End" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167317 "Records") (clojure.core/assoc :records (deser-records-event (clojure.core/get-in letvar167317 ["Records" :content]))) (letvar167317 "Stats") (clojure.core/assoc :stats (deser-stats-event (clojure.core/get-in letvar167317 ["Stats" :content]))) (letvar167317 "Progress") (clojure.core/assoc :progress (deser-progress-event (clojure.core/get-in letvar167317 ["Progress" :content]))) (letvar167317 "Cont") (clojure.core/assoc :cont (deser-continuation-event (clojure.core/get-in letvar167317 ["Cont" :content]))) (letvar167317 "End") (clojure.core/assoc :end (deser-end-event (clojure.core/get-in letvar167317 ["End" :content]))))))

(clojure.core/defn- deser-server-side-encryption-configuration [input] (clojure.core/let [letvar167413 {"Rule" (portkey.aws/search-for-tag input "Rule" :flattened? true :xmlAttribute? nil)}] (clojure.core/cond-> {:rules (deser-server-side-encryption-rules (clojure.core/get-in letvar167413 ["Rule"]))})))

(clojure.core/defn- deser-target-grant [input] (clojure.core/let [letvar167509 {"Grantee" (portkey.aws/search-for-tag input "Grantee" :flattened? false :xmlAttribute? nil), "Permission" (portkey.aws/search-for-tag input "Permission" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167509 "Grantee") (clojure.core/assoc :grantee (deser-grantee (clojure.core/get-in letvar167509 ["Grantee" :content]))) (letvar167509 "Permission") (clojure.core/assoc :permission (deser-bucket-logs-permission (clojure.core/get-in letvar167509 ["Permission" :content]))))))

(clojure.core/defn- deser-replication-configuration [input] (clojure.core/let [letvar167605 {"Role" (portkey.aws/search-for-tag input "Role" :flattened? false :xmlAttribute? nil), "Rule" (portkey.aws/search-for-tag input "Rule" :flattened? true :xmlAttribute? nil)}] (clojure.core/cond-> {:role (deser-role (clojure.core/get-in letvar167605 ["Role" :content])), :rules (deser-replication-rules (clojure.core/get-in letvar167605 ["Rule"]))})))

(clojure.core/defn- deser-sse-customer-algorithm [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-inventory-schedule [input] (clojure.core/let [letvar167706 {"Frequency" (portkey.aws/search-for-tag input "Frequency" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:frequency (deser-inventory-frequency (clojure.core/get-in letvar167706 ["Frequency" :content]))})))

(clojure.core/defn- deser-transition [input] (clojure.core/let [letvar167802 {"Date" (portkey.aws/search-for-tag input "Date" :flattened? false :xmlAttribute? nil), "Days" (portkey.aws/search-for-tag input "Days" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167802 "Date") (clojure.core/assoc :date (deser-date (clojure.core/get-in letvar167802 ["Date" :content]))) (letvar167802 "Days") (clojure.core/assoc :days (deser-days (clojure.core/get-in letvar167802 ["Days" :content]))) (letvar167802 "StorageClass") (clojure.core/assoc :storage-class (deser-transition-storage-class (clojure.core/get-in letvar167802 ["StorageClass" :content]))))))

(clojure.core/defn- deser-multipart-upload [input] (clojure.core/let [letvar167898 {"UploadId" (portkey.aws/search-for-tag input "UploadId" :flattened? false :xmlAttribute? nil), "Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Initiated" (portkey.aws/search-for-tag input "Initiated" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil), "Owner" (portkey.aws/search-for-tag input "Owner" :flattened? false :xmlAttribute? nil), "Initiator" (portkey.aws/search-for-tag input "Initiator" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar167898 "UploadId") (clojure.core/assoc :upload-id (deser-multipart-upload-id (clojure.core/get-in letvar167898 ["UploadId" :content]))) (letvar167898 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar167898 ["Key" :content]))) (letvar167898 "Initiated") (clojure.core/assoc :initiated (deser-initiated (clojure.core/get-in letvar167898 ["Initiated" :content]))) (letvar167898 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar167898 ["StorageClass" :content]))) (letvar167898 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar167898 ["Owner" :content]))) (letvar167898 "Initiator") (clojure.core/assoc :initiator (deser-initiator (clojure.core/get-in letvar167898 ["Initiator" :content]))))))

(clojure.core/defn- deser-analytics-export-destination [input] (clojure.core/let [letvar167994 {"S3BucketDestination" (portkey.aws/search-for-tag input "S3BucketDestination" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:s-3-bucket-destination (deser-analytics-s-3-bucket-destination (clojure.core/get-in letvar167994 ["S3BucketDestination" :content]))})))

(clojure.core/defn- deser-storage-class-analysis [input] (clojure.core/let [letvar168090 {"DataExport" (portkey.aws/search-for-tag input "DataExport" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168090 "DataExport") (clojure.core/assoc :data-export (deser-storage-class-analysis-data-export (clojure.core/get-in letvar168090 ["DataExport" :content]))))))
...
(clojure.core/defn- deser-object [input] (clojure.core/let [letvar168198 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil), "ETag" (portkey.aws/search-for-tag input "ETag" :flattened? false :xmlAttribute? nil), "Size" (portkey.aws/search-for-tag input "Size" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil), "Owner" (portkey.aws/search-for-tag input "Owner" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168198 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar168198 ["Key" :content]))) (letvar168198 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar168198 ["LastModified" :content]))) (letvar168198 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar168198 ["ETag" :content]))) (letvar168198 "Size") (clojure.core/assoc :size (deser-size (clojure.core/get-in letvar168198 ["Size" :content]))) (letvar168198 "StorageClass") (clojure.core/assoc :storage-class (deser-object-storage-class (clojure.core/get-in letvar168198 ["StorageClass" :content]))) (letvar168198 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar168198 ["Owner" :content]))))))
...
(clojure.core/defn- deser-lifecycle-rule-filter [input] (clojure.core/let [letvar168316 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil), "And" (portkey.aws/search-for-tag input "And" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168316 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar168316 ["Prefix" :content]))) (letvar168316 "Tag") (clojure.core/assoc :tag (deser-tag (clojure.core/get-in letvar168316 ["Tag" :content]))) (letvar168316 "And") (clojure.core/assoc :and (deser-lifecycle-rule-and-operator (clojure.core/get-in letvar168316 ["And" :content]))))))
...
(clojure.core/defn- deser-metrics-filter [input] (clojure.core/let [letvar168417 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil), "And" (portkey.aws/search-for-tag input "And" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168417 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar168417 ["Prefix" :content]))) (letvar168417 "Tag") (clojure.core/assoc :tag (deser-tag (clojure.core/get-in letvar168417 ["Tag" :content]))) (letvar168417 "And") (clojure.core/assoc :and (deser-metrics-and-operator (clojure.core/get-in letvar168417 ["And" :content]))))))

(clojure.core/defn- deser-inventory-destination [input] (clojure.core/let [letvar168513 {"S3BucketDestination" (portkey.aws/search-for-tag input "S3BucketDestination" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:s-3-bucket-destination (deser-inventory-s-3-bucket-destination (clojure.core/get-in letvar168513 ["S3BucketDestination" :content]))})))
...
(clojure.core/defn- deser-copy-part-result [input] (clojure.core/let [letvar168616 {"ETag" (portkey.aws/search-for-tag input "ETag" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168616 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar168616 ["ETag" :content]))) (letvar168616 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar168616 ["LastModified" :content]))))))

(clojure.core/defn- deser-replication-rule-filter [input] (clojure.core/let [letvar168712 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil), "And" (portkey.aws/search-for-tag input "And" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168712 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar168712 ["Prefix" :content]))) (letvar168712 "Tag") (clojure.core/assoc :tag (deser-tag (clojure.core/get-in letvar168712 ["Tag" :content]))) (letvar168712 "And") (clojure.core/assoc :and (deser-replication-rule-and-operator (clojure.core/get-in letvar168712 ["And" :content]))))))
...
(clojure.core/defn- deser-inventory-encryption [input] (clojure.core/let [letvar168830 {"SSE-S3" (portkey.aws/search-for-tag input "SSE-S3" :flattened? false :xmlAttribute? nil), "SSE-KMS" (portkey.aws/search-for-tag input "SSE-KMS" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168830 "SSE-S3") (clojure.core/assoc :sses-3 (deser-sses-3 (clojure.core/get-in letvar168830 ["SSE-S3" :content]))) (letvar168830 "SSE-KMS") (clojure.core/assoc :ssekms (deser-ssekms (clojure.core/get-in letvar168830 ["SSE-KMS" :content]))))))
...
(clojure.core/defn- deser-metrics-and-operator [input] (clojure.core/let [letvar168936 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar168936 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar168936 ["Prefix" :content]))) (letvar168936 "Tag") (clojure.core/assoc :tags (deser-tag-set (clojure.core/get-in letvar168936 ["Tag" :content]))))))

(clojure.core/defn- deser-lifecycle-rule [input] (clojure.core/let [letvar169032 {"Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Transition" (portkey.aws/search-for-tag input "Transition" :flattened? true :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil), "NoncurrentVersionExpiration" (portkey.aws/search-for-tag input "NoncurrentVersionExpiration" :flattened? false :xmlAttribute? nil), "AbortIncompleteMultipartUpload" (portkey.aws/search-for-tag input "AbortIncompleteMultipartUpload" :flattened? false :xmlAttribute? nil), "NoncurrentVersionTransition" (portkey.aws/search-for-tag input "NoncurrentVersionTransition" :flattened? true :xmlAttribute? nil), "Expiration" (portkey.aws/search-for-tag input "Expiration" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:status (deser-expiration-status (clojure.core/get-in letvar169032 ["Status" :content]))} (letvar169032 "Filter") (clojure.core/assoc :filter (deser-lifecycle-rule-filter (clojure.core/get-in letvar169032 ["Filter" :content]))) (letvar169032 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar169032 ["Prefix" :content]))) (letvar169032 "Transition") (clojure.core/assoc :transitions (deser-transition-list (clojure.core/get-in letvar169032 ["Transition"]))) (letvar169032 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar169032 ["ID" :content]))) (letvar169032 "NoncurrentVersionExpiration") (clojure.core/assoc :noncurrent-version-expiration (deser-noncurrent-version-expiration (clojure.core/get-in letvar169032 ["NoncurrentVersionExpiration" :content]))) (letvar169032 "AbortIncompleteMultipartUpload") (clojure.core/assoc :abort-incomplete-multipart-upload (deser-abort-incomplete-multipart-upload (clojure.core/get-in letvar169032 ["AbortIncompleteMultipartUpload" :content]))) (letvar169032 "NoncurrentVersionTransition") (clojure.core/assoc :noncurrent-version-transitions (deser-noncurrent-version-transition-list (clojure.core/get-in letvar169032 ["NoncurrentVersionTransition"]))) (letvar169032 "Expiration") (clojure.core/assoc :expiration (deser-lifecycle-expiration (clojure.core/get-in letvar169032 ["Expiration" :content]))))))
...
(clojure.core/defn- deser-analytics-and-operator [input] (clojure.core/let [letvar169162 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar169162 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar169162 ["Prefix" :content]))) (letvar169162 "Tag") (clojure.core/assoc :tags (deser-tag-set (clojure.core/get-in letvar169162 ["Tag" :content]))))))
...
(clojure.core/defn- deser-source-selection-criteria [input] (clojure.core/let [letvar169275 {"SseKmsEncryptedObjects" (portkey.aws/search-for-tag input "SseKmsEncryptedObjects" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar169275 "SseKmsEncryptedObjects") (clojure.core/assoc :sse-kms-encrypted-objects (deser-sse-kms-encrypted-objects (clojure.core/get-in letvar169275 ["SseKmsEncryptedObjects" :content]))))))

(clojure.core/defn- deser-destination [input] (clojure.core/let [letvar169371 {"Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Account" (portkey.aws/search-for-tag input "Account" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil), "AccessControlTranslation" (portkey.aws/search-for-tag input "AccessControlTranslation" :flattened? false :xmlAttribute? nil), "EncryptionConfiguration" (portkey.aws/search-for-tag input "EncryptionConfiguration" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:bucket (deser-bucket-name (clojure.core/get-in letvar169371 ["Bucket" :content]))} (letvar169371 "Account") (clojure.core/assoc :account (deser-account-id (clojure.core/get-in letvar169371 ["Account" :content]))) (letvar169371 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar169371 ["StorageClass" :content]))) (letvar169371 "AccessControlTranslation") (clojure.core/assoc :access-control-translation (deser-access-control-translation (clojure.core/get-in letvar169371 ["AccessControlTranslation" :content]))) (letvar169371 "EncryptionConfiguration") (clojure.core/assoc :encryption-configuration (deser-encryption-configuration (clojure.core/get-in letvar169371 ["EncryptionConfiguration" :content]))))))
...
(clojure.core/defn- deser-analytics-s-3-bucket-destination [input] (clojure.core/let [letvar169525 {"Format" (portkey.aws/search-for-tag input "Format" :flattened? false :xmlAttribute? nil), "BucketAccountId" (portkey.aws/search-for-tag input "BucketAccountId" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:format (deser-analytics-s-3-export-file-format (clojure.core/get-in letvar169525 ["Format" :content])), :bucket (deser-bucket-name (clojure.core/get-in letvar169525 ["Bucket" :content]))} (letvar169525 "BucketAccountId") (clojure.core/assoc :bucket-account-id (deser-account-id (clojure.core/get-in letvar169525 ["BucketAccountId" :content]))) (letvar169525 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar169525 ["Prefix" :content]))))))
...
(clojure.core/defn- deser-end-event [input] (clojure.core/let [letvar169684 {}] (clojure.core/cond-> {})))

(clojure.core/defn- deser-content-disposition [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-error-document [input] (clojure.core/let [letvar169785 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-object-key (clojure.core/get-in letvar169785 ["Key" :content]))})))

(clojure.core/defn- deser-redirect [input] (clojure.core/let [letvar169881 {"HostName" (portkey.aws/search-for-tag input "HostName" :flattened? false :xmlAttribute? nil), "HttpRedirectCode" (portkey.aws/search-for-tag input "HttpRedirectCode" :flattened? false :xmlAttribute? nil), "Protocol" (portkey.aws/search-for-tag input "Protocol" :flattened? false :xmlAttribute? nil), "ReplaceKeyPrefixWith" (portkey.aws/search-for-tag input "ReplaceKeyPrefixWith" :flattened? false :xmlAttribute? nil), "ReplaceKeyWith" (portkey.aws/search-for-tag input "ReplaceKeyWith" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar169881 "HostName") (clojure.core/assoc :host-name (deser-host-name (clojure.core/get-in letvar169881 ["HostName" :content]))) (letvar169881 "HttpRedirectCode") (clojure.core/assoc :http-redirect-code (deser-http-redirect-code (clojure.core/get-in letvar169881 ["HttpRedirectCode" :content]))) (letvar169881 "Protocol") (clojure.core/assoc :protocol (deser-protocol (clojure.core/get-in letvar169881 ["Protocol" :content]))) (letvar169881 "ReplaceKeyPrefixWith") (clojure.core/assoc :replace-key-prefix-with (deser-replace-key-prefix-with (clojure.core/get-in letvar169881 ["ReplaceKeyPrefixWith" :content]))) (letvar169881 "ReplaceKeyWith") (clojure.core/assoc :replace-key-with (deser-replace-key-with (clojure.core/get-in letvar169881 ["ReplaceKeyWith" :content]))))))

(clojure.core/defn- deser-progress [input] (clojure.core/let [letvar169977 {"BytesScanned" (portkey.aws/search-for-tag input "BytesScanned" :flattened? false :xmlAttribute? nil), "BytesProcessed" (portkey.aws/search-for-tag input "BytesProcessed" :flattened? false :xmlAttribute? nil), "BytesReturned" (portkey.aws/search-for-tag input "BytesReturned" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar169977 "BytesScanned") (clojure.core/assoc :bytes-scanned (deser-bytes-scanned (clojure.core/get-in letvar169977 ["BytesScanned" :content]))) (letvar169977 "BytesProcessed") (clojure.core/assoc :bytes-processed (deser-bytes-processed (clojure.core/get-in letvar169977 ["BytesProcessed" :content]))) (letvar169977 "BytesReturned") (clojure.core/assoc :bytes-returned (deser-bytes-returned (clojure.core/get-in letvar169977 ["BytesReturned" :content]))))))
...
(clojure.core/defn- deser-logging-enabled [input] (clojure.core/let [letvar170102 {"TargetBucket" (portkey.aws/search-for-tag input "TargetBucket" :flattened? false :xmlAttribute? nil), "TargetGrants" (portkey.aws/search-for-tag input "TargetGrants" :flattened? false :xmlAttribute? nil), "TargetPrefix" (portkey.aws/search-for-tag input "TargetPrefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:target-bucket (deser-target-bucket (clojure.core/get-in letvar170102 ["TargetBucket" :content])), :target-prefix (deser-target-prefix (clojure.core/get-in letvar170102 ["TargetPrefix" :content]))} (letvar170102 "TargetGrants") (clojure.core/assoc :target-grants (deser-target-grants (clojure.core/get-in letvar170102 ["TargetGrants" :content]))))))

(clojure.core/defn- deser-date [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-inventory-configuration [input] (clojure.core/let [letvar170200 {"Destination" (portkey.aws/search-for-tag input "Destination" :flattened? false :xmlAttribute? nil), "IsEnabled" (portkey.aws/search-for-tag input "IsEnabled" :flattened? false :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil), "Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "IncludedObjectVersions" (portkey.aws/search-for-tag input "IncludedObjectVersions" :flattened? false :xmlAttribute? nil), "OptionalFields" (portkey.aws/search-for-tag input "OptionalFields" :flattened? false :xmlAttribute? nil), "Schedule" (portkey.aws/search-for-tag input "Schedule" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:destination (deser-inventory-destination (clojure.core/get-in letvar170200 ["Destination" :content])), :is-enabled (deser-is-enabled (clojure.core/get-in letvar170200 ["IsEnabled" :content])), :id (deser-inventory-id (clojure.core/get-in letvar170200 ["Id" :content])), :included-object-versions (deser-inventory-included-object-versions (clojure.core/get-in letvar170200 ["IncludedObjectVersions" :content])), :schedule (deser-inventory-schedule (clojure.core/get-in letvar170200 ["Schedule" :content]))} (letvar170200 "Filter") (clojure.core/assoc :filter (deser-inventory-filter (clojure.core/get-in letvar170200 ["Filter" :content]))) (letvar170200 "OptionalFields") (clojure.core/assoc :optional-fields (deser-inventory-optional-fields (clojure.core/get-in letvar170200 ["OptionalFields" :content]))))))
...
(clojure.core/defn- deser-replication-rule-and-operator [input] (clojure.core/let [letvar170325 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar170325 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar170325 ["Prefix" :content]))) (letvar170325 "Tag") (clojure.core/assoc :tags (deser-tag-set (clojure.core/get-in letvar170325 ["Tag" :content]))))))
...
(clojure.core/defn- deser-stats-event [input] (clojure.core/let [letvar170441 {"Details" (portkey.aws/search-for-tag input "Details" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar170441 "Details") (clojure.core/assoc :details (deser-stats (clojure.core/get-in letvar170441 ["Details" :content]))))))
...
(clojure.core/defn- deser-is-truncated [input] (clojure.core/when-let [boolstr__23442__auto__ (if (clojure.core/seq? input) (clojure.core/first input) input)] (clojure.core/cond (clojure.core/= "true" boolstr__23442__auto__) true (clojure.core/= "false" boolstr__23442__auto__) false)))
...
(clojure.core/defn- deser-server-side-encryption-by-default [input] (clojure.core/let [letvar170566 {"SSEAlgorithm" (portkey.aws/search-for-tag input "SSEAlgorithm" :flattened? false :xmlAttribute? nil), "KMSMasterKeyID" (portkey.aws/search-for-tag input "KMSMasterKeyID" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:sse-algorithm (deser-server-side-encryption (clojure.core/get-in letvar170566 ["SSEAlgorithm" :content]))} (letvar170566 "KMSMasterKeyID") (clojure.core/assoc :kms-master-key-id (deser-ssekms-key-id (clojure.core/get-in letvar170566 ["KMSMasterKeyID" :content]))))))

(clojure.core/defn- deser-display-name [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-records-event [input] (clojure.core/let [letvar170667 {"Payload" (portkey.aws/search-for-tag input "Payload" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar170667 "Payload") (clojure.core/assoc :payload (deser-body (clojure.core/get-in letvar170667 ["Payload" :content]))))))

(clojure.core/defn- deser-cors-rule [input] (clojure.core/let [letvar170763 {"AllowedHeader" (portkey.aws/search-for-tag input "AllowedHeader" :flattened? true :xmlAttribute? nil), "AllowedMethod" (portkey.aws/search-for-tag input "AllowedMethod" :flattened? true :xmlAttribute? nil), "AllowedOrigin" (portkey.aws/search-for-tag input "AllowedOrigin" :flattened? true :xmlAttribute? nil), "ExposeHeader" (portkey.aws/search-for-tag input "ExposeHeader" :flattened? true :xmlAttribute? nil), "MaxAgeSeconds" (portkey.aws/search-for-tag input "MaxAgeSeconds" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:allowed-methods (deser-allowed-methods (clojure.core/get-in letvar170763 ["AllowedMethod"])), :allowed-origins (deser-allowed-origins (clojure.core/get-in letvar170763 ["AllowedOrigin"]))} (letvar170763 "AllowedHeader") (clojure.core/assoc :allowed-headers (deser-allowed-headers (clojure.core/get-in letvar170763 ["AllowedHeader"]))) (letvar170763 "ExposeHeader") (clojure.core/assoc :expose-headers (deser-expose-headers (clojure.core/get-in letvar170763 ["ExposeHeader"]))) (letvar170763 "MaxAgeSeconds") (clojure.core/assoc :max-age-seconds (deser-max-age-seconds (clojure.core/get-in letvar170763 ["MaxAgeSeconds" :content]))))))

(clojure.core/defn- deser-grant [input] (clojure.core/let [letvar170859 {"Grantee" (portkey.aws/search-for-tag input "Grantee" :flattened? false :xmlAttribute? nil), "Permission" (portkey.aws/search-for-tag input "Permission" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar170859 "Grantee") (clojure.core/assoc :grantee (deser-grantee (clojure.core/get-in letvar170859 ["Grantee" :content]))) (letvar170859 "Permission") (clojure.core/assoc :permission (deser-permission (clojure.core/get-in letvar170859 ["Permission" :content]))))))
...
(clojure.core/defn- deser-topic-configuration [input] (clojure.core/let [letvar170959 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Topic" (portkey.aws/search-for-tag input "Topic" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? true :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:topic-arn (deser-topic-arn (clojure.core/get-in letvar170959 ["Topic" :content])), :events (deser-event-list (clojure.core/get-in letvar170959 ["Event"]))} (letvar170959 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar170959 ["Id" :content]))) (letvar170959 "Filter") (clojure.core/assoc :filter (deser-notification-configuration-filter (clojure.core/get-in letvar170959 ["Filter" :content]))))))

(clojure.core/defn- deser-is-enabled [input] (clojure.core/when-let [boolstr__23442__auto__ (if (clojure.core/seq? input) (clojure.core/first input) input)] (clojure.core/cond (clojure.core/= "true" boolstr__23442__auto__) true (clojure.core/= "false" boolstr__23442__auto__) false)))

(clojure.core/defn- deser-progress-event [input] (clojure.core/let [letvar171057 {"Details" (portkey.aws/search-for-tag input "Details" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171057 "Details") (clojure.core/assoc :details (deser-progress (clojure.core/get-in letvar171057 ["Details" :content]))))))

(clojure.core/defn- deser-inventory-s-3-bucket-destination [input] (clojure.core/let [letvar171153 {"AccountId" (portkey.aws/search-for-tag input "AccountId" :flattened? false :xmlAttribute? nil), "Bucket" (portkey.aws/search-for-tag input "Bucket" :flattened? false :xmlAttribute? nil), "Format" (portkey.aws/search-for-tag input "Format" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Encryption" (portkey.aws/search-for-tag input "Encryption" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:bucket (deser-bucket-name (clojure.core/get-in letvar171153 ["Bucket" :content])), :format (deser-inventory-format (clojure.core/get-in letvar171153 ["Format" :content]))} (letvar171153 "AccountId") (clojure.core/assoc :account-id (deser-account-id (clojure.core/get-in letvar171153 ["AccountId" :content]))) (letvar171153 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar171153 ["Prefix" :content]))) (letvar171153 "Encryption") (clojure.core/assoc :encryption (deser-inventory-encryption (clojure.core/get-in letvar171153 ["Encryption" :content]))))))

(clojure.core/defn- deser-copy-object-result [input] (clojure.core/let [letvar171249 {"ETag" (portkey.aws/search-for-tag input "ETag" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171249 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar171249 ["ETag" :content]))) (letvar171249 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar171249 ["LastModified" :content]))))))
...
(clojure.core/defn- deser-analytics-filter [input] (clojure.core/let [letvar171394 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil), "And" (portkey.aws/search-for-tag input "And" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171394 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar171394 ["Prefix" :content]))) (letvar171394 "Tag") (clojure.core/assoc :tag (deser-tag (clojure.core/get-in letvar171394 ["Tag" :content]))) (letvar171394 "And") (clojure.core/assoc :and (deser-analytics-and-operator (clojure.core/get-in letvar171394 ["And" :content]))))))
...
(clojure.core/defn- deser-replication-rule [input] (clojure.core/let [letvar171530 {"ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil), "Priority" (portkey.aws/search-for-tag input "Priority" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "SourceSelectionCriteria" (portkey.aws/search-for-tag input "SourceSelectionCriteria" :flattened? false :xmlAttribute? nil), "Destination" (portkey.aws/search-for-tag input "Destination" :flattened? false :xmlAttribute? nil), "DeleteMarkerReplication" (portkey.aws/search-for-tag input "DeleteMarkerReplication" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:status (deser-replication-rule-status (clojure.core/get-in letvar171530 ["Status" :content])), :destination (deser-destination (clojure.core/get-in letvar171530 ["Destination" :content]))} (letvar171530 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar171530 ["ID" :content]))) (letvar171530 "Priority") (clojure.core/assoc :priority (deser-priority (clojure.core/get-in letvar171530 ["Priority" :content]))) (letvar171530 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar171530 ["Prefix" :content]))) (letvar171530 "Filter") (clojure.core/assoc :filter (deser-replication-rule-filter (clojure.core/get-in letvar171530 ["Filter" :content]))) (letvar171530 "SourceSelectionCriteria") (clojure.core/assoc :source-selection-criteria (deser-source-selection-criteria (clojure.core/get-in letvar171530 ["SourceSelectionCriteria" :content]))) (letvar171530 "DeleteMarkerReplication") (clojure.core/assoc :delete-marker-replication (deser-delete-marker-replication (clojure.core/get-in letvar171530 ["DeleteMarkerReplication" :content]))))))

(clojure.core/defn- deser-redirect-all-requests-to [input] (clojure.core/let [letvar171626 {"HostName" (portkey.aws/search-for-tag input "HostName" :flattened? false :xmlAttribute? nil), "Protocol" (portkey.aws/search-for-tag input "Protocol" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:host-name (deser-host-name (clojure.core/get-in letvar171626 ["HostName" :content]))} (letvar171626 "Protocol") (clojure.core/assoc :protocol (deser-protocol (clojure.core/get-in letvar171626 ["Protocol" :content]))))))
...
(clojure.core/defn- deser-filter-rule [input] (clojure.core/let [letvar171758 {"Name" (portkey.aws/search-for-tag input "Name" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171758 "Name") (clojure.core/assoc :name (deser-filter-rule-name (clojure.core/get-in letvar171758 ["Name" :content]))) (letvar171758 "Value") (clojure.core/assoc :value (deser-filter-rule-value (clojure.core/get-in letvar171758 ["Value" :content]))))))
...
(clojure.core/defn- deser-s-3-key-filter [input] (clojure.core/let [letvar171871 {"FilterRule" (portkey.aws/search-for-tag input "FilterRule" :flattened? true :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171871 "FilterRule") (clojure.core/assoc :filter-rules (deser-filter-rule-list (clojure.core/get-in letvar171871 ["FilterRule"]))))))
...
(clojure.core/defn- deser-part [input] (clojure.core/let [letvar171986 {"PartNumber" (portkey.aws/search-for-tag input "PartNumber" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil), "ETag" (portkey.aws/search-for-tag input "ETag" :flattened? false :xmlAttribute? nil), "Size" (portkey.aws/search-for-tag input "Size" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar171986 "PartNumber") (clojure.core/assoc :part-number (deser-part-number (clojure.core/get-in letvar171986 ["PartNumber" :content]))) (letvar171986 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar171986 ["LastModified" :content]))) (letvar171986 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar171986 ["ETag" :content]))) (letvar171986 "Size") (clojure.core/assoc :size (deser-size (clojure.core/get-in letvar171986 ["Size" :content]))))))
...
(clojure.core/defn- deser-notification-configuration-filter [input] (clojure.core/let [letvar172089 {"S3Key" (portkey.aws/search-for-tag input "S3Key" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172089 "S3Key") (clojure.core/assoc :key (deser-s-3-key-filter (clojure.core/get-in letvar172089 ["S3Key" :content]))))))
...
(clojure.core/defn- deser-lifecycle-rule-and-operator [input] (clojure.core/let [letvar172195 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Tag" (portkey.aws/search-for-tag input "Tag" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172195 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar172195 ["Prefix" :content]))) (letvar172195 "Tag") (clojure.core/assoc :tags (deser-tag-set (clojure.core/get-in letvar172195 ["Tag" :content]))))))

(clojure.core/defn- deser-allowed-header [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-rule [input] (clojure.core/let [letvar172296 {"Expiration" (portkey.aws/search-for-tag input "Expiration" :flattened? false :xmlAttribute? nil), "ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil), "Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil), "Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil), "Transition" (portkey.aws/search-for-tag input "Transition" :flattened? false :xmlAttribute? nil), "NoncurrentVersionTransition" (portkey.aws/search-for-tag input "NoncurrentVersionTransition" :flattened? false :xmlAttribute? nil), "NoncurrentVersionExpiration" (portkey.aws/search-for-tag input "NoncurrentVersionExpiration" :flattened? false :xmlAttribute? nil), "AbortIncompleteMultipartUpload" (portkey.aws/search-for-tag input "AbortIncompleteMultipartUpload" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:prefix (deser-prefix (clojure.core/get-in letvar172296 ["Prefix" :content])), :status (deser-expiration-status (clojure.core/get-in letvar172296 ["Status" :content]))} (letvar172296 "Expiration") (clojure.core/assoc :expiration (deser-lifecycle-expiration (clojure.core/get-in letvar172296 ["Expiration" :content]))) (letvar172296 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar172296 ["ID" :content]))) (letvar172296 "Transition") (clojure.core/assoc :transition (deser-transition (clojure.core/get-in letvar172296 ["Transition" :content]))) (letvar172296 "NoncurrentVersionTransition") (clojure.core/assoc :noncurrent-version-transition (deser-noncurrent-version-transition (clojure.core/get-in letvar172296 ["NoncurrentVersionTransition" :content]))) (letvar172296 "NoncurrentVersionExpiration") (clojure.core/assoc :noncurrent-version-expiration (deser-noncurrent-version-expiration (clojure.core/get-in letvar172296 ["NoncurrentVersionExpiration" :content]))) (letvar172296 "AbortIncompleteMultipartUpload") (clojure.core/assoc :abort-incomplete-multipart-upload (deser-abort-incomplete-multipart-upload (clojure.core/get-in letvar172296 ["AbortIncompleteMultipartUpload" :content]))))))

(clojure.core/defn- deser-routing-rule [input] (clojure.core/let [letvar172392 {"Condition" (portkey.aws/search-for-tag input "Condition" :flattened? false :xmlAttribute? nil), "Redirect" (portkey.aws/search-for-tag input "Redirect" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:redirect (deser-redirect (clojure.core/get-in letvar172392 ["Redirect" :content]))} (letvar172392 "Condition") (clojure.core/assoc :condition (deser-condition (clojure.core/get-in letvar172392 ["Condition" :content]))))))

(clojure.core/defn- deser-noncurrent-version-expiration [input] (clojure.core/let [letvar172488 {"NoncurrentDays" (portkey.aws/search-for-tag input "NoncurrentDays" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172488 "NoncurrentDays") (clojure.core/assoc :noncurrent-days (deser-days (clojure.core/get-in letvar172488 ["NoncurrentDays" :content]))))))

(clojure.core/defn- deser-delete-marker-replication [input] (clojure.core/let [letvar172584 {"Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172584 "Status") (clojure.core/assoc :status (deser-delete-marker-replication-status (clojure.core/get-in letvar172584 ["Status" :content]))))))

(clojure.core/defn- deser-next-version-id-marker [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-ssekms [input] (clojure.core/let [letvar172685 {"KeyId" (portkey.aws/search-for-tag input "KeyId" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key-id (deser-ssekms-key-id (clojure.core/get-in letvar172685 ["KeyId" :content]))})))

(clojure.core/defn- deser-deleted-object [input] (clojure.core/let [letvar172781 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "VersionId" (portkey.aws/search-for-tag input "VersionId" :flattened? false :xmlAttribute? nil), "DeleteMarker" (portkey.aws/search-for-tag input "DeleteMarker" :flattened? false :xmlAttribute? nil), "DeleteMarkerVersionId" (portkey.aws/search-for-tag input "DeleteMarkerVersionId" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172781 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar172781 ["Key" :content]))) (letvar172781 "VersionId") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar172781 ["VersionId" :content]))) (letvar172781 "DeleteMarker") (clojure.core/assoc :delete-marker (deser-delete-marker (clojure.core/get-in letvar172781 ["DeleteMarker" :content]))) (letvar172781 "DeleteMarkerVersionId") (clojure.core/assoc :delete-marker-version-id (deser-delete-marker-version-id (clojure.core/get-in letvar172781 ["DeleteMarkerVersionId" :content]))))))

(clojure.core/defn- deser-abort-incomplete-multipart-upload [input] (clojure.core/let [letvar172877 {"DaysAfterInitiation" (portkey.aws/search-for-tag input "DaysAfterInitiation" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar172877 "DaysAfterInitiation") (clojure.core/assoc :days-after-initiation (deser-days-after-initiation (clojure.core/get-in letvar172877 ["DaysAfterInitiation" :content]))))))
...
(clojure.core/defn- deser-owner [input] (clojure.core/let [letvar173000 {"DisplayName" (portkey.aws/search-for-tag input "DisplayName" :flattened? false :xmlAttribute? nil), "ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173000 "DisplayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar173000 ["DisplayName" :content]))) (letvar173000 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar173000 ["ID" :content]))))))
...
(clojure.core/defn- deser-storage-class-analysis-data-export [input] (clojure.core/let [letvar173108 {"OutputSchemaVersion" (portkey.aws/search-for-tag input "OutputSchemaVersion" :flattened? false :xmlAttribute? nil), "Destination" (portkey.aws/search-for-tag input "Destination" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:output-schema-version (deser-storage-class-analysis-schema-version (clojure.core/get-in letvar173108 ["OutputSchemaVersion" :content])), :destination (deser-analytics-export-destination (clojure.core/get-in letvar173108 ["Destination" :content]))})))
...
(clojure.core/defn- deser-stats [input] (clojure.core/let [letvar173210 {"BytesScanned" (portkey.aws/search-for-tag input "BytesScanned" :flattened? false :xmlAttribute? nil), "BytesProcessed" (portkey.aws/search-for-tag input "BytesProcessed" :flattened? false :xmlAttribute? nil), "BytesReturned" (portkey.aws/search-for-tag input "BytesReturned" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173210 "BytesScanned") (clojure.core/assoc :bytes-scanned (deser-bytes-scanned (clojure.core/get-in letvar173210 ["BytesScanned" :content]))) (letvar173210 "BytesProcessed") (clojure.core/assoc :bytes-processed (deser-bytes-processed (clojure.core/get-in letvar173210 ["BytesProcessed" :content]))) (letvar173210 "BytesReturned") (clojure.core/assoc :bytes-returned (deser-bytes-returned (clojure.core/get-in letvar173210 ["BytesReturned" :content]))))))
...
(clojure.core/defn- deser-tag [input] (clojure.core/let [letvar173383 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "Value" (portkey.aws/search-for-tag input "Value" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:key (deser-object-key (clojure.core/get-in letvar173383 ["Key" :content])), :value (deser-value (clojure.core/get-in letvar173383 ["Value" :content]))})))

(clojure.core/defn- deser-condition [input] (clojure.core/let [letvar173479 {"HttpErrorCodeReturnedEquals" (portkey.aws/search-for-tag input "HttpErrorCodeReturnedEquals" :flattened? false :xmlAttribute? nil), "KeyPrefixEquals" (portkey.aws/search-for-tag input "KeyPrefixEquals" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173479 "HttpErrorCodeReturnedEquals") (clojure.core/assoc :http-error-code-returned-equals (deser-http-error-code-returned-equals (clojure.core/get-in letvar173479 ["HttpErrorCodeReturnedEquals" :content]))) (letvar173479 "KeyPrefixEquals") (clojure.core/assoc :key-prefix-equals (deser-key-prefix-equals (clojure.core/get-in letvar173479 ["KeyPrefixEquals" :content]))))))

(clojure.core/defn- deser-error [input] (clojure.core/let [letvar173575 {"Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "VersionId" (portkey.aws/search-for-tag input "VersionId" :flattened? false :xmlAttribute? nil), "Code" (portkey.aws/search-for-tag input "Code" :flattened? false :xmlAttribute? nil), "Message" (portkey.aws/search-for-tag input "Message" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173575 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar173575 ["Key" :content]))) (letvar173575 "VersionId") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar173575 ["VersionId" :content]))) (letvar173575 "Code") (clojure.core/assoc :code (deser-code (clojure.core/get-in letvar173575 ["Code" :content]))) (letvar173575 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar173575 ["Message" :content]))))))

(clojure.core/defn- deser-queue-arn [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-object-version [input] (clojure.core/let [letvar173676 {"ETag" (portkey.aws/search-for-tag input "ETag" :flattened? false :xmlAttribute? nil), "Size" (portkey.aws/search-for-tag input "Size" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil), "Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "VersionId" (portkey.aws/search-for-tag input "VersionId" :flattened? false :xmlAttribute? nil), "IsLatest" (portkey.aws/search-for-tag input "IsLatest" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil), "Owner" (portkey.aws/search-for-tag input "Owner" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173676 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar173676 ["ETag" :content]))) (letvar173676 "Size") (clojure.core/assoc :size (deser-size (clojure.core/get-in letvar173676 ["Size" :content]))) (letvar173676 "StorageClass") (clojure.core/assoc :storage-class (deser-object-version-storage-class (clojure.core/get-in letvar173676 ["StorageClass" :content]))) (letvar173676 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar173676 ["Key" :content]))) (letvar173676 "VersionId") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar173676 ["VersionId" :content]))) (letvar173676 "IsLatest") (clojure.core/assoc :is-latest (deser-is-latest (clojure.core/get-in letvar173676 ["IsLatest" :content]))) (letvar173676 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar173676 ["LastModified" :content]))) (letvar173676 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar173676 ["Owner" :content]))))))
...
(clojure.core/defn- deser-delete-marker-entry [input] (clojure.core/let [letvar173782 {"Owner" (portkey.aws/search-for-tag input "Owner" :flattened? false :xmlAttribute? nil), "Key" (portkey.aws/search-for-tag input "Key" :flattened? false :xmlAttribute? nil), "VersionId" (portkey.aws/search-for-tag input "VersionId" :flattened? false :xmlAttribute? nil), "IsLatest" (portkey.aws/search-for-tag input "IsLatest" :flattened? false :xmlAttribute? nil), "LastModified" (portkey.aws/search-for-tag input "LastModified" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar173782 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar173782 ["Owner" :content]))) (letvar173782 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar173782 ["Key" :content]))) (letvar173782 "VersionId") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar173782 ["VersionId" :content]))) (letvar173782 "IsLatest") (clojure.core/assoc :is-latest (deser-is-latest (clojure.core/get-in letvar173782 ["IsLatest" :content]))) (letvar173782 "LastModified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar173782 ["LastModified" :content]))))))
...
(clojure.core/defn- deser-queue-configuration [input] (clojure.core/let [letvar173895 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Queue" (portkey.aws/search-for-tag input "Queue" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? true :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:queue-arn (deser-queue-arn (clojure.core/get-in letvar173895 ["Queue" :content])), :events (deser-event-list (clojure.core/get-in letvar173895 ["Event"]))} (letvar173895 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar173895 ["Id" :content]))) (letvar173895 "Filter") (clojure.core/assoc :filter (deser-notification-configuration-filter (clojure.core/get-in letvar173895 ["Filter" :content]))))))
...
(clojure.core/defn- deser-server-side-encryption-rule [input] (clojure.core/let [letvar174011 {"ApplyServerSideEncryptionByDefault" (portkey.aws/search-for-tag input "ApplyServerSideEncryptionByDefault" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar174011 "ApplyServerSideEncryptionByDefault") (clojure.core/assoc :apply-server-side-encryption-by-default (deser-server-side-encryption-by-default (clojure.core/get-in letvar174011 ["ApplyServerSideEncryptionByDefault" :content]))))))
...
(clojure.core/defn- deser-lifecycle-expiration [input] (clojure.core/let [letvar174124 {"Date" (portkey.aws/search-for-tag input "Date" :flattened? false :xmlAttribute? nil), "Days" (portkey.aws/search-for-tag input "Days" :flattened? false :xmlAttribute? nil), "ExpiredObjectDeleteMarker" (portkey.aws/search-for-tag input "ExpiredObjectDeleteMarker" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar174124 "Date") (clojure.core/assoc :date (deser-date (clojure.core/get-in letvar174124 ["Date" :content]))) (letvar174124 "Days") (clojure.core/assoc :days (deser-days (clojure.core/get-in letvar174124 ["Days" :content]))) (letvar174124 "ExpiredObjectDeleteMarker") (clojure.core/assoc :expired-object-delete-marker (deser-expired-object-delete-marker (clojure.core/get-in letvar174124 ["ExpiredObjectDeleteMarker" :content]))))))
...
(clojure.core/defn- deser-grantee [input] (clojure.core/let [letvar174259 {"DisplayName" (portkey.aws/search-for-tag input "DisplayName" :flattened? false :xmlAttribute? nil), "EmailAddress" (portkey.aws/search-for-tag input "EmailAddress" :flattened? false :xmlAttribute? nil), "ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil), "xsi:type" (portkey.aws/search-for-tag input "xsi:type" :flattened? false :xmlAttribute? true), "URI" (portkey.aws/search-for-tag input "URI" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:type (deser-type (clojure.core/get-in letvar174259 ["xsi:type"]))} (letvar174259 "DisplayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar174259 ["DisplayName" :content]))) (letvar174259 "EmailAddress") (clojure.core/assoc :email-address (deser-email-address (clojure.core/get-in letvar174259 ["EmailAddress" :content]))) (letvar174259 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar174259 ["ID" :content]))) (letvar174259 "URI") (clojure.core/assoc :uri (deser-uri (clojure.core/get-in letvar174259 ["URI" :content]))))))
...
(clojure.core/defn- deser-delete-marker [input] (clojure.core/when-let [boolstr__23442__auto__ (if (clojure.core/seq? input) (clojure.core/first input) input)] (clojure.core/cond (clojure.core/= "true" boolstr__23442__auto__) true (clojure.core/= "false" boolstr__23442__auto__) false)))
...
(clojure.core/defn- deser-queue-configuration-deprecated [input] (clojure.core/let [letvar174401 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? true :xmlAttribute? nil), "Queue" (portkey.aws/search-for-tag input "Queue" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar174401 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar174401 ["Id" :content]))) (letvar174401 "Event") (clojure.core/assoc :event (deser-event (clojure.core/get-in letvar174401 ["Event" :content]))) (letvar174401 "Event") (clojure.core/assoc :events (deser-event-list (clojure.core/get-in letvar174401 ["Event"]))) (letvar174401 "Queue") (clojure.core/assoc :queue (deser-queue-arn (clojure.core/get-in letvar174401 ["Queue" :content]))))))
...
(clojure.core/defn- deser-initiator [input] (clojure.core/let [letvar174523 {"ID" (portkey.aws/search-for-tag input "ID" :flattened? false :xmlAttribute? nil), "DisplayName" (portkey.aws/search-for-tag input "DisplayName" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar174523 "ID") (clojure.core/assoc :id (deser-id (clojure.core/get-in letvar174523 ["ID" :content]))) (letvar174523 "DisplayName") (clojure.core/assoc :display-name (deser-display-name (clojure.core/get-in letvar174523 ["DisplayName" :content]))))))

(clojure.core/defn- deser-sses-3 [input] (clojure.core/let [letvar174619 {}] (clojure.core/cond-> {})))
...
(clojure.core/defn- deser-lambda-function-configuration [input] (clojure.core/let [letvar174742 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "CloudFunction" (portkey.aws/search-for-tag input "CloudFunction" :flattened? false :xmlAttribute? nil), "Event" (portkey.aws/search-for-tag input "Event" :flattened? true :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:lambda-function-arn (deser-lambda-function-arn (clojure.core/get-in letvar174742 ["CloudFunction" :content])), :events (deser-event-list (clojure.core/get-in letvar174742 ["Event"]))} (letvar174742 "Id") (clojure.core/assoc :id (deser-notification-id (clojure.core/get-in letvar174742 ["Id" :content]))) (letvar174742 "Filter") (clojure.core/assoc :filter (deser-notification-configuration-filter (clojure.core/get-in letvar174742 ["Filter" :content]))))))

(clojure.core/defn- deser-delete-marker-version-id [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-is-latest [input] (clojure.core/when-let [boolstr__23442__auto__ (if (clojure.core/seq? input) (clojure.core/first input) input)] (clojure.core/cond (clojure.core/= "true" boolstr__23442__auto__) true (clojure.core/= "false" boolstr__23442__auto__) false)))

(clojure.core/defn- deser-noncurrent-version-transition [input] (clojure.core/let [letvar174845 {"NoncurrentDays" (portkey.aws/search-for-tag input "NoncurrentDays" :flattened? false :xmlAttribute? nil), "StorageClass" (portkey.aws/search-for-tag input "StorageClass" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar174845 "NoncurrentDays") (clojure.core/assoc :noncurrent-days (deser-days (clojure.core/get-in letvar174845 ["NoncurrentDays" :content]))) (letvar174845 "StorageClass") (clojure.core/assoc :storage-class (deser-transition-storage-class (clojure.core/get-in letvar174845 ["StorageClass" :content]))))))

(clojure.core/defn- deser-index-document [input] (clojure.core/let [letvar174941 {"Suffix" (portkey.aws/search-for-tag input "Suffix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:suffix (deser-suffix (clojure.core/get-in letvar174941 ["Suffix" :content]))})))

(clojure.core/defn- deser-key-marker [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-common-prefix [input] (clojure.core/let [letvar175042 {"Prefix" (portkey.aws/search-for-tag input "Prefix" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {} (letvar175042 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar175042 ["Prefix" :content]))))))

(clojure.core/defn- deser-next-upload-id-marker [input] (if (clojure.core/seq? input) (clojure.core/first input) input))

(clojure.core/defn- deser-analytics-configuration [input] (clojure.core/let [letvar175143 {"Id" (portkey.aws/search-for-tag input "Id" :flattened? false :xmlAttribute? nil), "Filter" (portkey.aws/search-for-tag input "Filter" :flattened? false :xmlAttribute? nil), "StorageClassAnalysis" (portkey.aws/search-for-tag input "StorageClassAnalysis" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:id (deser-analytics-id (clojure.core/get-in letvar175143 ["Id" :content])), :storage-class-analysis (deser-storage-class-analysis (clojure.core/get-in letvar175143 ["StorageClassAnalysis" :content]))} (letvar175143 "Filter") (clojure.core/assoc :filter (deser-analytics-filter (clojure.core/get-in letvar175143 ["Filter" :content]))))))
...
(clojure.core/defn- deser-sse-kms-encrypted-objects [input] (clojure.core/let [letvar175266 {"Status" (portkey.aws/search-for-tag input "Status" :flattened? false :xmlAttribute? nil)}] (clojure.core/cond-> {:status (deser-sse-kms-encrypted-objects-status (clojure.core/get-in letvar175266 ["Status" :content]))})))
...
(clojure.core/defn- response-put-object-tagging-output [input] (clojure.core/let [rawinput175284 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175285 {"x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"])}] (clojure.core/cond-> {} (letvar175285 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175285 ["x-amz-version-id"]))))))

(clojure.core/defn- response-get-object-tagging-output [input] (clojure.core/let [rawinput175286 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175287 {"x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "TagSet" (portkey.aws/search-for-tag rawinput175286 "TagSet" :flattened? false)}] (clojure.core/cond-> {:tag-set (deser-tag-set (clojure.core/get-in letvar175287 ["TagSet" :content]))} (letvar175287 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175287 ["x-amz-version-id"]))))))

(clojure.core/defn- response-list-object-versions-output [input] (clojure.core/let [rawinput175288 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175289 {"Prefix" (portkey.aws/search-for-tag rawinput175288 "Prefix" :flattened? false), "EncodingType" (portkey.aws/search-for-tag rawinput175288 "EncodingType" :flattened? false), "NextKeyMarker" (portkey.aws/search-for-tag rawinput175288 "NextKeyMarker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput175288 "IsTruncated" :flattened? false), "CommonPrefixes" (portkey.aws/search-for-tag rawinput175288 "CommonPrefixes" :flattened? true), "VersionIdMarker" (portkey.aws/search-for-tag rawinput175288 "VersionIdMarker" :flattened? false), "NextVersionIdMarker" (portkey.aws/search-for-tag rawinput175288 "NextVersionIdMarker" :flattened? false), "Delimiter" (portkey.aws/search-for-tag rawinput175288 "Delimiter" :flattened? false), "Version" (portkey.aws/search-for-tag rawinput175288 "Version" :flattened? true), "Name" (portkey.aws/search-for-tag rawinput175288 "Name" :flattened? false), "DeleteMarker" (portkey.aws/search-for-tag rawinput175288 "DeleteMarker" :flattened? true), "MaxKeys" (portkey.aws/search-for-tag rawinput175288 "MaxKeys" :flattened? false), "KeyMarker" (portkey.aws/search-for-tag rawinput175288 "KeyMarker" :flattened? false)}] (clojure.core/cond-> {} (letvar175289 "Version") (clojure.core/assoc :versions (deser-object-version-list (clojure.core/get-in letvar175289 ["Version"]))) (letvar175289 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar175289 ["Prefix" :content]))) (letvar175289 "EncodingType") (clojure.core/assoc :encoding-type (deser-encoding-type (clojure.core/get-in letvar175289 ["EncodingType" :content]))) (letvar175289 "NextKeyMarker") (clojure.core/assoc :next-key-marker (deser-next-key-marker (clojure.core/get-in letvar175289 ["NextKeyMarker" :content]))) (letvar175289 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175289 ["IsTruncated" :content]))) (letvar175289 "CommonPrefixes") (clojure.core/assoc :common-prefixes (deser-common-prefix-list (clojure.core/get-in letvar175289 ["CommonPrefixes"]))) (letvar175289 "VersionIdMarker") (clojure.core/assoc :version-id-marker (deser-version-id-marker (clojure.core/get-in letvar175289 ["VersionIdMarker" :content]))) (letvar175289 "NextVersionIdMarker") (clojure.core/assoc :next-version-id-marker (deser-next-version-id-marker (clojure.core/get-in letvar175289 ["NextVersionIdMarker" :content]))) (letvar175289 "Delimiter") (clojure.core/assoc :delimiter (deser-delimiter (clojure.core/get-in letvar175289 ["Delimiter" :content]))) (letvar175289 "Name") (clojure.core/assoc :name (deser-bucket-name (clojure.core/get-in letvar175289 ["Name" :content]))) (letvar175289 "MaxKeys") (clojure.core/assoc :max-keys (deser-max-keys (clojure.core/get-in letvar175289 ["MaxKeys" :content]))) (letvar175289 "KeyMarker") (clojure.core/assoc :key-marker (deser-key-marker (clojure.core/get-in letvar175289 ["KeyMarker" :content]))) (letvar175289 "DeleteMarker") (clojure.core/assoc :delete-markers (deser-delete-markers (clojure.core/get-in letvar175289 ["DeleteMarker"]))))))

(clojure.core/defn- response-bucket-already-owned-by-you [input] (clojure.core/let [rawinput175290 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175291 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-object-torrent-output [input] (clojure.core/let [rawinput175292 (:body input) letvar175293 {"Body" rawinput175292, "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175293 "Body") (clojure.core/assoc :body (deser-body (clojure.core/get-in letvar175293 ["Body"]))) (letvar175293 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175293 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-get-bucket-analytics-configuration-output [input] (clojure.core/let [rawinput175294 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175295 {"AnalyticsConfiguration" (portkey.aws/search-for-tag rawinput175294 "AnalyticsConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175295 "AnalyticsConfiguration") (clojure.core/assoc :analytics-configuration (deser-analytics-configuration (clojure.core/get-in letvar175295 ["AnalyticsConfiguration" :content]))))))

(clojure.core/defn- response-get-bucket-encryption-output [input] (clojure.core/let [rawinput175296 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175297 {"ServerSideEncryptionConfiguration" (portkey.aws/search-for-tag rawinput175296 "ServerSideEncryptionConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175297 "ServerSideEncryptionConfiguration") (clojure.core/assoc :server-side-encryption-configuration (deser-server-side-encryption-configuration (clojure.core/get-in letvar175297 ["ServerSideEncryptionConfiguration" :content]))))))

(clojure.core/defn- response-get-bucket-lifecycle-output [input] (clojure.core/let [rawinput175298 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175299 {"Rule" (portkey.aws/search-for-tag rawinput175298 "Rule" :flattened? true)}] (clojure.core/cond-> {} (letvar175299 "Rule") (clojure.core/assoc :rules (deser-rules (clojure.core/get-in letvar175299 ["Rule"]))))))

(clojure.core/defn- response-get-bucket-logging-output [input] (clojure.core/let [rawinput175300 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175301 {"LoggingEnabled" (portkey.aws/search-for-tag rawinput175300 "LoggingEnabled" :flattened? false)}] (clojure.core/cond-> {} (letvar175301 "LoggingEnabled") (clojure.core/assoc :logging-enabled (deser-logging-enabled (clojure.core/get-in letvar175301 ["LoggingEnabled" :content]))))))

(clojure.core/defn- response-delete-objects-output [input] (clojure.core/let [rawinput175302 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175303 {"Deleted" (portkey.aws/search-for-tag rawinput175302 "Deleted" :flattened? true), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "Error" (portkey.aws/search-for-tag rawinput175302 "Error" :flattened? true)}] (clojure.core/cond-> {} (letvar175303 "Deleted") (clojure.core/assoc :deleted (deser-deleted-objects (clojure.core/get-in letvar175303 ["Deleted"]))) (letvar175303 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175303 ["x-amz-request-charged"]))) (letvar175303 "Error") (clojure.core/assoc :errors (deser-errors (clojure.core/get-in letvar175303 ["Error"]))))))

(clojure.core/defn- response-create-multipart-upload-output [input] (clojure.core/let [rawinput175304 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175305 {"Bucket" (portkey.aws/search-for-tag rawinput175304 "Bucket" :flattened? false), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-abort-date" (clojure.core/get-in input [:headers "x-amz-abort-date"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "x-amz-abort-rule-id" (clojure.core/get-in input [:headers "x-amz-abort-rule-id"]), "Key" (portkey.aws/search-for-tag rawinput175304 "Key" :flattened? false), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "UploadId" (portkey.aws/search-for-tag rawinput175304 "UploadId" :flattened? false)}] (clojure.core/cond-> {} (letvar175305 "Bucket") (clojure.core/assoc :bucket (deser-bucket-name (clojure.core/get-in letvar175305 ["Bucket" :content]))) (letvar175305 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175305 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175305 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175305 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175305 "x-amz-abort-date") (clojure.core/assoc :abort-date (deser-abort-date (clojure.core/get-in letvar175305 ["x-amz-abort-date"]))) (letvar175305 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175305 ["x-amz-server-side-encryption"]))) (letvar175305 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar175305 ["Key" :content]))) (letvar175305 "x-amz-abort-rule-id") (clojure.core/assoc :abort-rule-id (deser-abort-rule-id (clojure.core/get-in letvar175305 ["x-amz-abort-rule-id"]))) (letvar175305 "UploadId") (clojure.core/assoc :upload-id (deser-multipart-upload-id (clojure.core/get-in letvar175305 ["UploadId" :content]))) (letvar175305 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175305 ["x-amz-request-charged"]))) (letvar175305 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175305 ["x-amz-server-side-encryption-aws-kms-key-id"]))))))

(clojure.core/defn- response-list-multipart-uploads-output [input] (clojure.core/let [rawinput175306 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175307 {"Bucket" (portkey.aws/search-for-tag rawinput175306 "Bucket" :flattened? false), "Prefix" (portkey.aws/search-for-tag rawinput175306 "Prefix" :flattened? false), "EncodingType" (portkey.aws/search-for-tag rawinput175306 "EncodingType" :flattened? false), "NextKeyMarker" (portkey.aws/search-for-tag rawinput175306 "NextKeyMarker" :flattened? false), "Upload" (portkey.aws/search-for-tag rawinput175306 "Upload" :flattened? true), "UploadIdMarker" (portkey.aws/search-for-tag rawinput175306 "UploadIdMarker" :flattened? false), "MaxUploads" (portkey.aws/search-for-tag rawinput175306 "MaxUploads" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput175306 "IsTruncated" :flattened? false), "CommonPrefixes" (portkey.aws/search-for-tag rawinput175306 "CommonPrefixes" :flattened? true), "Delimiter" (portkey.aws/search-for-tag rawinput175306 "Delimiter" :flattened? false), "KeyMarker" (portkey.aws/search-for-tag rawinput175306 "KeyMarker" :flattened? false), "NextUploadIdMarker" (portkey.aws/search-for-tag rawinput175306 "NextUploadIdMarker" :flattened? false)}] (clojure.core/cond-> {} (letvar175307 "Bucket") (clojure.core/assoc :bucket (deser-bucket-name (clojure.core/get-in letvar175307 ["Bucket" :content]))) (letvar175307 "Upload") (clojure.core/assoc :uploads (deser-multipart-upload-list (clojure.core/get-in letvar175307 ["Upload"]))) (letvar175307 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar175307 ["Prefix" :content]))) (letvar175307 "EncodingType") (clojure.core/assoc :encoding-type (deser-encoding-type (clojure.core/get-in letvar175307 ["EncodingType" :content]))) (letvar175307 "NextKeyMarker") (clojure.core/assoc :next-key-marker (deser-next-key-marker (clojure.core/get-in letvar175307 ["NextKeyMarker" :content]))) (letvar175307 "UploadIdMarker") (clojure.core/assoc :upload-id-marker (deser-upload-id-marker (clojure.core/get-in letvar175307 ["UploadIdMarker" :content]))) (letvar175307 "MaxUploads") (clojure.core/assoc :max-uploads (deser-max-uploads (clojure.core/get-in letvar175307 ["MaxUploads" :content]))) (letvar175307 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175307 ["IsTruncated" :content]))) (letvar175307 "CommonPrefixes") (clojure.core/assoc :common-prefixes (deser-common-prefix-list (clojure.core/get-in letvar175307 ["CommonPrefixes"]))) (letvar175307 "Delimiter") (clojure.core/assoc :delimiter (deser-delimiter (clojure.core/get-in letvar175307 ["Delimiter" :content]))) (letvar175307 "KeyMarker") (clojure.core/assoc :key-marker (deser-key-marker (clojure.core/get-in letvar175307 ["KeyMarker" :content]))) (letvar175307 "NextUploadIdMarker") (clojure.core/assoc :next-upload-id-marker (deser-next-upload-id-marker (clojure.core/get-in letvar175307 ["NextUploadIdMarker" :content]))))))

(clojure.core/defn- response-list-bucket-metrics-configurations-output [input] (clojure.core/let [rawinput175308 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175309 {"IsTruncated" (portkey.aws/search-for-tag rawinput175308 "IsTruncated" :flattened? false), "ContinuationToken" (portkey.aws/search-for-tag rawinput175308 "ContinuationToken" :flattened? false), "NextContinuationToken" (portkey.aws/search-for-tag rawinput175308 "NextContinuationToken" :flattened? false), "MetricsConfiguration" (portkey.aws/search-for-tag rawinput175308 "MetricsConfiguration" :flattened? true)}] (clojure.core/cond-> {} (letvar175309 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175309 ["IsTruncated" :content]))) (letvar175309 "ContinuationToken") (clojure.core/assoc :continuation-token (deser-token (clojure.core/get-in letvar175309 ["ContinuationToken" :content]))) (letvar175309 "NextContinuationToken") (clojure.core/assoc :next-continuation-token (deser-next-token (clojure.core/get-in letvar175309 ["NextContinuationToken" :content]))) (letvar175309 "MetricsConfiguration") (clojure.core/assoc :metrics-configuration-list (deser-metrics-configuration-list (clojure.core/get-in letvar175309 ["MetricsConfiguration"]))))))

(clojure.core/defn- response-create-bucket-output [input] (clojure.core/let [rawinput175310 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175311 {"Location" (clojure.core/get-in input [:headers "Location"])}] (clojure.core/cond-> {} (letvar175311 "Location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar175311 ["Location"]))))))

(clojure.core/defn- response-delete-object-output [input] (clojure.core/let [rawinput175312 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175313 {"x-amz-delete-marker" (clojure.core/get-in input [:headers "x-amz-delete-marker"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175313 "x-amz-delete-marker") (clojure.core/assoc :delete-marker (deser-delete-marker (clojure.core/get-in letvar175313 ["x-amz-delete-marker"]))) (letvar175313 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175313 ["x-amz-version-id"]))) (letvar175313 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175313 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-list-objects-output [input] (clojure.core/let [rawinput175314 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175315 {"Prefix" (portkey.aws/search-for-tag rawinput175314 "Prefix" :flattened? false), "EncodingType" (portkey.aws/search-for-tag rawinput175314 "EncodingType" :flattened? false), "Marker" (portkey.aws/search-for-tag rawinput175314 "Marker" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput175314 "IsTruncated" :flattened? false), "CommonPrefixes" (portkey.aws/search-for-tag rawinput175314 "CommonPrefixes" :flattened? true), "Contents" (portkey.aws/search-for-tag rawinput175314 "Contents" :flattened? true), "NextMarker" (portkey.aws/search-for-tag rawinput175314 "NextMarker" :flattened? false), "Delimiter" (portkey.aws/search-for-tag rawinput175314 "Delimiter" :flattened? false), "Name" (portkey.aws/search-for-tag rawinput175314 "Name" :flattened? false), "MaxKeys" (portkey.aws/search-for-tag rawinput175314 "MaxKeys" :flattened? false)}] (clojure.core/cond-> {} (letvar175315 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar175315 ["Prefix" :content]))) (letvar175315 "EncodingType") (clojure.core/assoc :encoding-type (deser-encoding-type (clojure.core/get-in letvar175315 ["EncodingType" :content]))) (letvar175315 "Marker") (clojure.core/assoc :marker (deser-marker (clojure.core/get-in letvar175315 ["Marker" :content]))) (letvar175315 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175315 ["IsTruncated" :content]))) (letvar175315 "CommonPrefixes") (clojure.core/assoc :common-prefixes (deser-common-prefix-list (clojure.core/get-in letvar175315 ["CommonPrefixes"]))) (letvar175315 "Contents") (clojure.core/assoc :contents (deser-object-list (clojure.core/get-in letvar175315 ["Contents"]))) (letvar175315 "NextMarker") (clojure.core/assoc :next-marker (deser-next-marker (clojure.core/get-in letvar175315 ["NextMarker" :content]))) (letvar175315 "Delimiter") (clojure.core/assoc :delimiter (deser-delimiter (clojure.core/get-in letvar175315 ["Delimiter" :content]))) (letvar175315 "Name") (clojure.core/assoc :name (deser-bucket-name (clojure.core/get-in letvar175315 ["Name" :content]))) (letvar175315 "MaxKeys") (clojure.core/assoc :max-keys (deser-max-keys (clojure.core/get-in letvar175315 ["MaxKeys" :content]))))))

(clojure.core/defn- response-list-bucket-inventory-configurations-output [input] (clojure.core/let [rawinput175316 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175317 {"ContinuationToken" (portkey.aws/search-for-tag rawinput175316 "ContinuationToken" :flattened? false), "InventoryConfiguration" (portkey.aws/search-for-tag rawinput175316 "InventoryConfiguration" :flattened? true), "IsTruncated" (portkey.aws/search-for-tag rawinput175316 "IsTruncated" :flattened? false), "NextContinuationToken" (portkey.aws/search-for-tag rawinput175316 "NextContinuationToken" :flattened? false)}] (clojure.core/cond-> {} (letvar175317 "ContinuationToken") (clojure.core/assoc :continuation-token (deser-token (clojure.core/get-in letvar175317 ["ContinuationToken" :content]))) (letvar175317 "InventoryConfiguration") (clojure.core/assoc :inventory-configuration-list (deser-inventory-configuration-list (clojure.core/get-in letvar175317 ["InventoryConfiguration"]))) (letvar175317 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175317 ["IsTruncated" :content]))) (letvar175317 "NextContinuationToken") (clojure.core/assoc :next-continuation-token (deser-next-token (clojure.core/get-in letvar175317 ["NextContinuationToken" :content]))))))

(clojure.core/defn- response-list-parts-output [input] (clojure.core/let [rawinput175318 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175319 {"Bucket" (portkey.aws/search-for-tag rawinput175318 "Bucket" :flattened? false), "MaxParts" (portkey.aws/search-for-tag rawinput175318 "MaxParts" :flattened? false), "x-amz-abort-date" (clojure.core/get-in input [:headers "x-amz-abort-date"]), "NextPartNumberMarker" (portkey.aws/search-for-tag rawinput175318 "NextPartNumberMarker" :flattened? false), "x-amz-abort-rule-id" (clojure.core/get-in input [:headers "x-amz-abort-rule-id"]), "Key" (portkey.aws/search-for-tag rawinput175318 "Key" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput175318 "IsTruncated" :flattened? false), "Part" (portkey.aws/search-for-tag rawinput175318 "Part" :flattened? true), "PartNumberMarker" (portkey.aws/search-for-tag rawinput175318 "PartNumberMarker" :flattened? false), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "Owner" (portkey.aws/search-for-tag rawinput175318 "Owner" :flattened? false), "UploadId" (portkey.aws/search-for-tag rawinput175318 "UploadId" :flattened? false), "StorageClass" (portkey.aws/search-for-tag rawinput175318 "StorageClass" :flattened? false), "Initiator" (portkey.aws/search-for-tag rawinput175318 "Initiator" :flattened? false)}] (clojure.core/cond-> {} (letvar175319 "Bucket") (clojure.core/assoc :bucket (deser-bucket-name (clojure.core/get-in letvar175319 ["Bucket" :content]))) (letvar175319 "Part") (clojure.core/assoc :parts (deser-parts (clojure.core/get-in letvar175319 ["Part"]))) (letvar175319 "x-amz-abort-date") (clojure.core/assoc :abort-date (deser-abort-date (clojure.core/get-in letvar175319 ["x-amz-abort-date"]))) (letvar175319 "MaxParts") (clojure.core/assoc :max-parts (deser-max-parts (clojure.core/get-in letvar175319 ["MaxParts" :content]))) (letvar175319 "NextPartNumberMarker") (clojure.core/assoc :next-part-number-marker (deser-next-part-number-marker (clojure.core/get-in letvar175319 ["NextPartNumberMarker" :content]))) (letvar175319 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar175319 ["Key" :content]))) (letvar175319 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175319 ["IsTruncated" :content]))) (letvar175319 "x-amz-abort-rule-id") (clojure.core/assoc :abort-rule-id (deser-abort-rule-id (clojure.core/get-in letvar175319 ["x-amz-abort-rule-id"]))) (letvar175319 "PartNumberMarker") (clojure.core/assoc :part-number-marker (deser-part-number-marker (clojure.core/get-in letvar175319 ["PartNumberMarker" :content]))) (letvar175319 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar175319 ["Owner" :content]))) (letvar175319 "UploadId") (clojure.core/assoc :upload-id (deser-multipart-upload-id (clojure.core/get-in letvar175319 ["UploadId" :content]))) (letvar175319 "StorageClass") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar175319 ["StorageClass" :content]))) (letvar175319 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175319 ["x-amz-request-charged"]))) (letvar175319 "Initiator") (clojure.core/assoc :initiator (deser-initiator (clojure.core/get-in letvar175319 ["Initiator" :content]))))))

(clojure.core/defn- response-abort-multipart-upload-output [input] (clojure.core/let [rawinput175320 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175321 {"x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175321 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175321 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-head-object-output [input] (clojure.core/let [rawinput175322 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175323 {"x-amz-expiration" (clojure.core/get-in input [:headers "x-amz-expiration"]), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-meta-" (clojure.core/get-in input [:headers "x-amz-meta-"]), "x-amz-restore" (clojure.core/get-in input [:headers "x-amz-restore"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "x-amz-replication-status" (clojure.core/get-in input [:headers "x-amz-replication-status"]), "Content-Disposition" (clojure.core/get-in input [:headers "Content-Disposition"]), "x-amz-missing-meta" (clojure.core/get-in input [:headers "x-amz-missing-meta"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "accept-ranges" (clojure.core/get-in input [:headers "accept-ranges"]), "x-amz-website-redirect-location" (clojure.core/get-in input [:headers "x-amz-website-redirect-location"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Content-Language" (clojure.core/get-in input [:headers "Content-Language"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "x-amz-mp-parts-count" (clojure.core/get-in input [:headers "x-amz-mp-parts-count"]), "Content-Encoding" (clojure.core/get-in input [:headers "Content-Encoding"]), "x-amz-delete-marker" (clojure.core/get-in input [:headers "x-amz-delete-marker"]), "x-amz-storage-class" (clojure.core/get-in input [:headers "x-amz-storage-class"]), "Expires" (clojure.core/get-in input [:headers "Expires"])}] (clojure.core/cond-> {} (letvar175323 "x-amz-missing-meta") (clojure.core/assoc :missing-meta (deser-missing-meta (clojure.core/get-in letvar175323 ["x-amz-missing-meta"]))) (letvar175323 "Content-Encoding") (clojure.core/assoc :content-encoding (deser-content-encoding (clojure.core/get-in letvar175323 ["Content-Encoding"]))) (letvar175323 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175323 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175323 "x-amz-website-redirect-location") (clojure.core/assoc :website-redirect-location (deser-website-redirect-location (clojure.core/get-in letvar175323 ["x-amz-website-redirect-location"]))) (letvar175323 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175323 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175323 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175323 ["x-amz-version-id"]))) (letvar175323 "accept-ranges") (clojure.core/assoc :accept-ranges (deser-accept-ranges (clojure.core/get-in letvar175323 ["accept-ranges"]))) (letvar175323 "x-amz-replication-status") (clojure.core/assoc :replication-status (deser-replication-status (clojure.core/get-in letvar175323 ["x-amz-replication-status"]))) (letvar175323 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175323 ["x-amz-server-side-encryption"]))) (letvar175323 "Content-Disposition") (clojure.core/assoc :content-disposition (deser-content-disposition (clojure.core/get-in letvar175323 ["Content-Disposition"]))) (letvar175323 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar175323 ["ETag"]))) (letvar175323 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar175323 ["Content-Type"]))) (letvar175323 "x-amz-restore") (clojure.core/assoc :restore (deser-restore (clojure.core/get-in letvar175323 ["x-amz-restore"]))) (letvar175323 "Content-Length") (clojure.core/assoc :content-length (deser-content-length (clojure.core/get-in letvar175323 ["Content-Length"]))) (letvar175323 "Last-Modified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar175323 ["Last-Modified"]))) (letvar175323 "x-amz-mp-parts-count") (clojure.core/assoc :parts-count (deser-parts-count (clojure.core/get-in letvar175323 ["x-amz-mp-parts-count"]))) (letvar175323 "x-amz-meta-") (clojure.core/assoc :metadata (deser-metadata (clojure.core/get-in letvar175323 ["x-amz-meta-" :content]))) (letvar175323 "Cache-Control") (clojure.core/assoc :cache-control (deser-cache-control (clojure.core/get-in letvar175323 ["Cache-Control"]))) (letvar175323 "Content-Language") (clojure.core/assoc :content-language (deser-content-language (clojure.core/get-in letvar175323 ["Content-Language"]))) (letvar175323 "x-amz-storage-class") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar175323 ["x-amz-storage-class"]))) (letvar175323 "x-amz-delete-marker") (clojure.core/assoc :delete-marker (deser-delete-marker (clojure.core/get-in letvar175323 ["x-amz-delete-marker"]))) (letvar175323 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175323 ["x-amz-request-charged"]))) (letvar175323 "Expires") (clojure.core/assoc :expires (deser-expires (clojure.core/get-in letvar175323 ["Expires"]))) (letvar175323 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175323 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175323 "x-amz-expiration") (clojure.core/assoc :expiration (deser-expiration (clojure.core/get-in letvar175323 ["x-amz-expiration"]))))))

(clojure.core/defn- response-get-bucket-cors-output [input] (clojure.core/let [rawinput175324 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175325 {"CORSRule" (portkey.aws/search-for-tag rawinput175324 "CORSRule" :flattened? true)}] (clojure.core/cond-> {} (letvar175325 "CORSRule") (clojure.core/assoc :cors-rules (deser-cors-rules (clojure.core/get-in letvar175325 ["CORSRule"]))))))

(clojure.core/defn- response-get-bucket-website-output [input] (clojure.core/let [rawinput175326 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175327 {"RedirectAllRequestsTo" (portkey.aws/search-for-tag rawinput175326 "RedirectAllRequestsTo" :flattened? false), "IndexDocument" (portkey.aws/search-for-tag rawinput175326 "IndexDocument" :flattened? false), "ErrorDocument" (portkey.aws/search-for-tag rawinput175326 "ErrorDocument" :flattened? false), "RoutingRules" (portkey.aws/search-for-tag rawinput175326 "RoutingRules" :flattened? false)}] (clojure.core/cond-> {} (letvar175327 "RedirectAllRequestsTo") (clojure.core/assoc :redirect-all-requests-to (deser-redirect-all-requests-to (clojure.core/get-in letvar175327 ["RedirectAllRequestsTo" :content]))) (letvar175327 "IndexDocument") (clojure.core/assoc :index-document (deser-index-document (clojure.core/get-in letvar175327 ["IndexDocument" :content]))) (letvar175327 "ErrorDocument") (clojure.core/assoc :error-document (deser-error-document (clojure.core/get-in letvar175327 ["ErrorDocument" :content]))) (letvar175327 "RoutingRules") (clojure.core/assoc :routing-rules (deser-routing-rules (clojure.core/get-in letvar175327 ["RoutingRules" :content]))))))

(clojure.core/defn- response-bucket-already-exists [input] (clojure.core/let [rawinput175328 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175329 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-list-objects-v-2-output [input] (clojure.core/let [rawinput175330 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175331 {"KeyCount" (portkey.aws/search-for-tag rawinput175330 "KeyCount" :flattened? false), "Prefix" (portkey.aws/search-for-tag rawinput175330 "Prefix" :flattened? false), "EncodingType" (portkey.aws/search-for-tag rawinput175330 "EncodingType" :flattened? false), "StartAfter" (portkey.aws/search-for-tag rawinput175330 "StartAfter" :flattened? false), "IsTruncated" (portkey.aws/search-for-tag rawinput175330 "IsTruncated" :flattened? false), "CommonPrefixes" (portkey.aws/search-for-tag rawinput175330 "CommonPrefixes" :flattened? true), "Contents" (portkey.aws/search-for-tag rawinput175330 "Contents" :flattened? true), "ContinuationToken" (portkey.aws/search-for-tag rawinput175330 "ContinuationToken" :flattened? false), "Delimiter" (portkey.aws/search-for-tag rawinput175330 "Delimiter" :flattened? false), "NextContinuationToken" (portkey.aws/search-for-tag rawinput175330 "NextContinuationToken" :flattened? false), "Name" (portkey.aws/search-for-tag rawinput175330 "Name" :flattened? false), "MaxKeys" (portkey.aws/search-for-tag rawinput175330 "MaxKeys" :flattened? false)}] (clojure.core/cond-> {} (letvar175331 "KeyCount") (clojure.core/assoc :key-count (deser-key-count (clojure.core/get-in letvar175331 ["KeyCount" :content]))) (letvar175331 "Prefix") (clojure.core/assoc :prefix (deser-prefix (clojure.core/get-in letvar175331 ["Prefix" :content]))) (letvar175331 "EncodingType") (clojure.core/assoc :encoding-type (deser-encoding-type (clojure.core/get-in letvar175331 ["EncodingType" :content]))) (letvar175331 "StartAfter") (clojure.core/assoc :start-after (deser-start-after (clojure.core/get-in letvar175331 ["StartAfter" :content]))) (letvar175331 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175331 ["IsTruncated" :content]))) (letvar175331 "CommonPrefixes") (clojure.core/assoc :common-prefixes (deser-common-prefix-list (clojure.core/get-in letvar175331 ["CommonPrefixes"]))) (letvar175331 "Contents") (clojure.core/assoc :contents (deser-object-list (clojure.core/get-in letvar175331 ["Contents"]))) (letvar175331 "ContinuationToken") (clojure.core/assoc :continuation-token (deser-token (clojure.core/get-in letvar175331 ["ContinuationToken" :content]))) (letvar175331 "Delimiter") (clojure.core/assoc :delimiter (deser-delimiter (clojure.core/get-in letvar175331 ["Delimiter" :content]))) (letvar175331 "NextContinuationToken") (clojure.core/assoc :next-continuation-token (deser-next-token (clojure.core/get-in letvar175331 ["NextContinuationToken" :content]))) (letvar175331 "Name") (clojure.core/assoc :name (deser-bucket-name (clojure.core/get-in letvar175331 ["Name" :content]))) (letvar175331 "MaxKeys") (clojure.core/assoc :max-keys (deser-max-keys (clojure.core/get-in letvar175331 ["MaxKeys" :content]))))))

(clojure.core/defn- response-select-object-content-output [input] (clojure.core/let [rawinput175332 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175333 {"Payload" (portkey.aws/search-for-tag rawinput175332 "Payload" :flattened? false)}] (clojure.core/cond-> {} (letvar175333 "Payload") (clojure.core/assoc :payload (deser-select-object-content-event-stream (clojure.core/get-in letvar175333 ["Payload" :content]))))))

(clojure.core/defn- response-no-such-upload [input] (clojure.core/let [rawinput175334 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175335 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-no-such-bucket [input] (clojure.core/let [rawinput175336 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175337 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-bucket-accelerate-configuration-output [input] (clojure.core/let [rawinput175338 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175339 {"Status" (portkey.aws/search-for-tag rawinput175338 "Status" :flattened? false)}] (clojure.core/cond-> {} (letvar175339 "Status") (clojure.core/assoc :status (deser-bucket-accelerate-status (clojure.core/get-in letvar175339 ["Status" :content]))))))

(clojure.core/defn- response-restore-object-output [input] (clojure.core/let [rawinput175340 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175341 {"x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "x-amz-restore-output-path" (clojure.core/get-in input [:headers "x-amz-restore-output-path"])}] (clojure.core/cond-> {} (letvar175341 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175341 ["x-amz-request-charged"]))) (letvar175341 "x-amz-restore-output-path") (clojure.core/assoc :restore-output-path (deser-restore-output-path (clojure.core/get-in letvar175341 ["x-amz-restore-output-path"]))))))

(clojure.core/defn- response-get-object-output [input] (clojure.core/let [rawinput175342 (:body input) letvar175343 {"x-amz-expiration" (clojure.core/get-in input [:headers "x-amz-expiration"]), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-tagging-count" (clojure.core/get-in input [:headers "x-amz-tagging-count"]), "Body" rawinput175342, "Content-Range" (clojure.core/get-in input [:headers "Content-Range"]), "Last-Modified" (clojure.core/get-in input [:headers "Last-Modified"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-meta-" (clojure.core/get-in input [:headers "x-amz-meta-"]), "x-amz-restore" (clojure.core/get-in input [:headers "x-amz-restore"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "x-amz-replication-status" (clojure.core/get-in input [:headers "x-amz-replication-status"]), "Content-Disposition" (clojure.core/get-in input [:headers "Content-Disposition"]), "x-amz-missing-meta" (clojure.core/get-in input [:headers "x-amz-missing-meta"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "Cache-Control" (clojure.core/get-in input [:headers "Cache-Control"]), "accept-ranges" (clojure.core/get-in input [:headers "accept-ranges"]), "x-amz-website-redirect-location" (clojure.core/get-in input [:headers "x-amz-website-redirect-location"]), "Content-Length" (clojure.core/get-in input [:headers "Content-Length"]), "Content-Language" (clojure.core/get-in input [:headers "Content-Language"]), "Content-Type" (clojure.core/get-in input [:headers "Content-Type"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"]), "x-amz-mp-parts-count" (clojure.core/get-in input [:headers "x-amz-mp-parts-count"]), "Content-Encoding" (clojure.core/get-in input [:headers "Content-Encoding"]), "x-amz-delete-marker" (clojure.core/get-in input [:headers "x-amz-delete-marker"]), "x-amz-storage-class" (clojure.core/get-in input [:headers "x-amz-storage-class"]), "Expires" (clojure.core/get-in input [:headers "Expires"])}] (clojure.core/cond-> {} (letvar175343 "x-amz-missing-meta") (clojure.core/assoc :missing-meta (deser-missing-meta (clojure.core/get-in letvar175343 ["x-amz-missing-meta"]))) (letvar175343 "Content-Encoding") (clojure.core/assoc :content-encoding (deser-content-encoding (clojure.core/get-in letvar175343 ["Content-Encoding"]))) (letvar175343 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175343 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175343 "x-amz-website-redirect-location") (clojure.core/assoc :website-redirect-location (deser-website-redirect-location (clojure.core/get-in letvar175343 ["x-amz-website-redirect-location"]))) (letvar175343 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175343 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175343 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175343 ["x-amz-version-id"]))) (letvar175343 "Body") (clojure.core/assoc :body (deser-body (clojure.core/get-in letvar175343 ["Body"]))) (letvar175343 "Content-Range") (clojure.core/assoc :content-range (deser-content-range (clojure.core/get-in letvar175343 ["Content-Range"]))) (letvar175343 "accept-ranges") (clojure.core/assoc :accept-ranges (deser-accept-ranges (clojure.core/get-in letvar175343 ["accept-ranges"]))) (letvar175343 "x-amz-replication-status") (clojure.core/assoc :replication-status (deser-replication-status (clojure.core/get-in letvar175343 ["x-amz-replication-status"]))) (letvar175343 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175343 ["x-amz-server-side-encryption"]))) (letvar175343 "Content-Disposition") (clojure.core/assoc :content-disposition (deser-content-disposition (clojure.core/get-in letvar175343 ["Content-Disposition"]))) (letvar175343 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar175343 ["ETag"]))) (letvar175343 "Content-Type") (clojure.core/assoc :content-type (deser-content-type (clojure.core/get-in letvar175343 ["Content-Type"]))) (letvar175343 "x-amz-restore") (clojure.core/assoc :restore (deser-restore (clojure.core/get-in letvar175343 ["x-amz-restore"]))) (letvar175343 "x-amz-tagging-count") (clojure.core/assoc :tag-count (deser-tag-count (clojure.core/get-in letvar175343 ["x-amz-tagging-count"]))) (letvar175343 "Content-Length") (clojure.core/assoc :content-length (deser-content-length (clojure.core/get-in letvar175343 ["Content-Length"]))) (letvar175343 "Last-Modified") (clojure.core/assoc :last-modified (deser-last-modified (clojure.core/get-in letvar175343 ["Last-Modified"]))) (letvar175343 "x-amz-mp-parts-count") (clojure.core/assoc :parts-count (deser-parts-count (clojure.core/get-in letvar175343 ["x-amz-mp-parts-count"]))) (letvar175343 "x-amz-meta-") (clojure.core/assoc :metadata (deser-metadata (clojure.core/get-in letvar175343 ["x-amz-meta-" :content]))) (letvar175343 "Cache-Control") (clojure.core/assoc :cache-control (deser-cache-control (clojure.core/get-in letvar175343 ["Cache-Control"]))) (letvar175343 "Content-Language") (clojure.core/assoc :content-language (deser-content-language (clojure.core/get-in letvar175343 ["Content-Language"]))) (letvar175343 "x-amz-storage-class") (clojure.core/assoc :storage-class (deser-storage-class (clojure.core/get-in letvar175343 ["x-amz-storage-class"]))) (letvar175343 "x-amz-delete-marker") (clojure.core/assoc :delete-marker (deser-delete-marker (clojure.core/get-in letvar175343 ["x-amz-delete-marker"]))) (letvar175343 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175343 ["x-amz-request-charged"]))) (letvar175343 "Expires") (clojure.core/assoc :expires (deser-expires (clojure.core/get-in letvar175343 ["Expires"]))) (letvar175343 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175343 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175343 "x-amz-expiration") (clojure.core/assoc :expiration (deser-expiration (clojure.core/get-in letvar175343 ["x-amz-expiration"]))))))

(clojure.core/defn- response-complete-multipart-upload-output [input] (clojure.core/let [rawinput175344 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175345 {"Bucket" (portkey.aws/search-for-tag rawinput175344 "Bucket" :flattened? false), "x-amz-expiration" (clojure.core/get-in input [:headers "x-amz-expiration"]), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "Location" (portkey.aws/search-for-tag rawinput175344 "Location" :flattened? false), "ETag" (portkey.aws/search-for-tag rawinput175344 "ETag" :flattened? false), "Key" (portkey.aws/search-for-tag rawinput175344 "Key" :flattened? false), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175345 "Bucket") (clojure.core/assoc :bucket (deser-bucket-name (clojure.core/get-in letvar175345 ["Bucket" :content]))) (letvar175345 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175345 ["x-amz-version-id"]))) (letvar175345 "Location") (clojure.core/assoc :location (deser-location (clojure.core/get-in letvar175345 ["Location" :content]))) (letvar175345 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175345 ["x-amz-server-side-encryption"]))) (letvar175345 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar175345 ["ETag" :content]))) (letvar175345 "Key") (clojure.core/assoc :key (deser-object-key (clojure.core/get-in letvar175345 ["Key" :content]))) (letvar175345 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175345 ["x-amz-request-charged"]))) (letvar175345 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175345 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175345 "x-amz-expiration") (clojure.core/assoc :expiration (deser-expiration (clojure.core/get-in letvar175345 ["x-amz-expiration"]))))))

(clojure.core/defn- response-notification-configuration-deprecated [input] (clojure.core/let [rawinput175346 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175347 {"TopicConfiguration" (portkey.aws/search-for-tag rawinput175346 "TopicConfiguration" :flattened? false), "QueueConfiguration" (portkey.aws/search-for-tag rawinput175346 "QueueConfiguration" :flattened? false), "CloudFunctionConfiguration" (portkey.aws/search-for-tag rawinput175346 "CloudFunctionConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175347 "TopicConfiguration") (clojure.core/assoc :topic-configuration (deser-topic-configuration-deprecated (clojure.core/get-in letvar175347 ["TopicConfiguration" :content]))) (letvar175347 "QueueConfiguration") (clojure.core/assoc :queue-configuration (deser-queue-configuration-deprecated (clojure.core/get-in letvar175347 ["QueueConfiguration" :content]))) (letvar175347 "CloudFunctionConfiguration") (clojure.core/assoc :cloud-function-configuration (deser-cloud-function-configuration (clojure.core/get-in letvar175347 ["CloudFunctionConfiguration" :content]))))))

(clojure.core/defn- response-delete-object-tagging-output [input] (clojure.core/let [rawinput175348 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175349 {"x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"])}] (clojure.core/cond-> {} (letvar175349 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175349 ["x-amz-version-id"]))))))

(clojure.core/defn- response-upload-part-output [input] (clojure.core/let [rawinput175350 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175351 {"x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175351 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175351 ["x-amz-server-side-encryption"]))) (letvar175351 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar175351 ["ETag"]))) (letvar175351 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175351 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175351 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175351 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175351 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175351 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175351 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175351 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-get-bucket-acl-output [input] (clojure.core/let [rawinput175352 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175353 {"Owner" (portkey.aws/search-for-tag rawinput175352 "Owner" :flattened? false), "AccessControlList" (portkey.aws/search-for-tag rawinput175352 "AccessControlList" :flattened? false)}] (clojure.core/cond-> {} (letvar175353 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar175353 ["Owner" :content]))) (letvar175353 "AccessControlList") (clojure.core/assoc :grants (deser-grants (clojure.core/get-in letvar175353 ["AccessControlList" :content]))))))

(clojure.core/defn- response-get-bucket-request-payment-output [input] (clojure.core/let [rawinput175354 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175355 {"Payer" (portkey.aws/search-for-tag rawinput175354 "Payer" :flattened? false)}] (clojure.core/cond-> {} (letvar175355 "Payer") (clojure.core/assoc :payer (deser-payer (clojure.core/get-in letvar175355 ["Payer" :content]))))))

(clojure.core/defn- response-get-bucket-tagging-output [input] (clojure.core/let [rawinput175356 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175357 {"TagSet" (portkey.aws/search-for-tag rawinput175356 "TagSet" :flattened? false)}] (clojure.core/cond-> {:tag-set (deser-tag-set (clojure.core/get-in letvar175357 ["TagSet" :content]))})))

(clojure.core/defn- response-get-bucket-lifecycle-configuration-output [input] (clojure.core/let [rawinput175358 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175359 {"Rule" (portkey.aws/search-for-tag rawinput175358 "Rule" :flattened? true)}] (clojure.core/cond-> {} (letvar175359 "Rule") (clojure.core/assoc :rules (deser-lifecycle-rules (clojure.core/get-in letvar175359 ["Rule"]))))))

(clojure.core/defn- response-get-bucket-location-output [input] (clojure.core/let [rawinput175360 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175361 {"LocationConstraint" (portkey.aws/search-for-tag rawinput175360 "LocationConstraint" :flattened? false)}] (clojure.core/cond-> {} (letvar175361 "LocationConstraint") (clojure.core/assoc :location-constraint (deser-bucket-location-constraint (clojure.core/get-in letvar175361 ["LocationConstraint" :content]))))))

(clojure.core/defn- response-get-bucket-inventory-configuration-output [input] (clojure.core/let [rawinput175362 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175363 {"InventoryConfiguration" (portkey.aws/search-for-tag rawinput175362 "InventoryConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175363 "InventoryConfiguration") (clojure.core/assoc :inventory-configuration (deser-inventory-configuration (clojure.core/get-in letvar175363 ["InventoryConfiguration" :content]))))))

(clojure.core/defn- response-get-bucket-versioning-output [input] (clojure.core/let [rawinput175364 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175365 {"Status" (portkey.aws/search-for-tag rawinput175364 "Status" :flattened? false), "MfaDelete" (portkey.aws/search-for-tag rawinput175364 "MfaDelete" :flattened? false)}] (clojure.core/cond-> {} (letvar175365 "Status") (clojure.core/assoc :status (deser-bucket-versioning-status (clojure.core/get-in letvar175365 ["Status" :content]))) (letvar175365 "MfaDelete") (clojure.core/assoc :mfa-delete (deser-mfa-delete-status (clojure.core/get-in letvar175365 ["MfaDelete" :content]))))))

(clojure.core/defn- response-put-object-acl-output [input] (clojure.core/let [rawinput175366 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175367 {"x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175367 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175367 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-upload-part-copy-output [input] (clojure.core/let [rawinput175368 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175369 {"x-amz-copy-source-version-id" (clojure.core/get-in input [:headers "x-amz-copy-source-version-id"]), "CopyPartResult" (portkey.aws/search-for-tag rawinput175368 "CopyPartResult" :flattened? false), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175369 "x-amz-copy-source-version-id") (clojure.core/assoc :copy-source-version-id (deser-copy-source-version-id (clojure.core/get-in letvar175369 ["x-amz-copy-source-version-id"]))) (letvar175369 "CopyPartResult") (clojure.core/assoc :copy-part-result (deser-copy-part-result (clojure.core/get-in letvar175369 ["CopyPartResult" :content]))) (letvar175369 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175369 ["x-amz-server-side-encryption"]))) (letvar175369 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175369 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175369 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175369 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175369 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175369 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175369 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175369 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-list-buckets-output [input] (clojure.core/let [rawinput175370 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175371 {"Buckets" (portkey.aws/search-for-tag rawinput175370 "Buckets" :flattened? false), "Owner" (portkey.aws/search-for-tag rawinput175370 "Owner" :flattened? false)}] (clojure.core/cond-> {} (letvar175371 "Buckets") (clojure.core/assoc :buckets (deser-buckets (clojure.core/get-in letvar175371 ["Buckets" :content]))) (letvar175371 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar175371 ["Owner" :content]))))))

(clojure.core/defn- response-put-object-output [input] (clojure.core/let [rawinput175372 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175373 {"x-amz-expiration" (clojure.core/get-in input [:headers "x-amz-expiration"]), "ETag" (clojure.core/get-in input [:headers "ETag"]), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175373 "x-amz-expiration") (clojure.core/assoc :expiration (deser-expiration (clojure.core/get-in letvar175373 ["x-amz-expiration"]))) (letvar175373 "ETag") (clojure.core/assoc :e-tag (deser-e-tag (clojure.core/get-in letvar175373 ["ETag"]))) (letvar175373 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175373 ["x-amz-server-side-encryption"]))) (letvar175373 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175373 ["x-amz-version-id"]))) (letvar175373 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175373 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175373 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175373 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175373 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175373 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175373 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175373 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-get-object-acl-output [input] (clojure.core/let [rawinput175374 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175375 {"Owner" (portkey.aws/search-for-tag rawinput175374 "Owner" :flattened? false), "AccessControlList" (portkey.aws/search-for-tag rawinput175374 "AccessControlList" :flattened? false), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175375 "Owner") (clojure.core/assoc :owner (deser-owner (clojure.core/get-in letvar175375 ["Owner" :content]))) (letvar175375 "AccessControlList") (clojure.core/assoc :grants (deser-grants (clojure.core/get-in letvar175375 ["AccessControlList" :content]))) (letvar175375 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175375 ["x-amz-request-charged"]))))))

(clojure.core/defn- response-list-bucket-analytics-configurations-output [input] (clojure.core/let [rawinput175376 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175377 {"IsTruncated" (portkey.aws/search-for-tag rawinput175376 "IsTruncated" :flattened? false), "ContinuationToken" (portkey.aws/search-for-tag rawinput175376 "ContinuationToken" :flattened? false), "NextContinuationToken" (portkey.aws/search-for-tag rawinput175376 "NextContinuationToken" :flattened? false), "AnalyticsConfiguration" (portkey.aws/search-for-tag rawinput175376 "AnalyticsConfiguration" :flattened? true)}] (clojure.core/cond-> {} (letvar175377 "IsTruncated") (clojure.core/assoc :is-truncated (deser-is-truncated (clojure.core/get-in letvar175377 ["IsTruncated" :content]))) (letvar175377 "ContinuationToken") (clojure.core/assoc :continuation-token (deser-token (clojure.core/get-in letvar175377 ["ContinuationToken" :content]))) (letvar175377 "NextContinuationToken") (clojure.core/assoc :next-continuation-token (deser-next-token (clojure.core/get-in letvar175377 ["NextContinuationToken" :content]))) (letvar175377 "AnalyticsConfiguration") (clojure.core/assoc :analytics-configuration-list (deser-analytics-configuration-list (clojure.core/get-in letvar175377 ["AnalyticsConfiguration"]))))))

(clojure.core/defn- response-object-already-in-active-tier-error [input] (clojure.core/let [rawinput175378 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175379 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-bucket-policy-output [input] (clojure.core/let [rawinput175380 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175381 {"Policy" (portkey.aws/search-for-tag rawinput175380 "Policy" :flattened? false)}] (clojure.core/cond-> {} (letvar175381 "Policy") (clojure.core/assoc :policy (deser-policy (clojure.core/get-in letvar175381 ["Policy" :content]))))))

(clojure.core/defn- response-notification-configuration [input] (clojure.core/let [rawinput175382 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175383 {"TopicConfiguration" (portkey.aws/search-for-tag rawinput175382 "TopicConfiguration" :flattened? true), "QueueConfiguration" (portkey.aws/search-for-tag rawinput175382 "QueueConfiguration" :flattened? true), "CloudFunctionConfiguration" (portkey.aws/search-for-tag rawinput175382 "CloudFunctionConfiguration" :flattened? true)}] (clojure.core/cond-> {} (letvar175383 "TopicConfiguration") (clojure.core/assoc :topic-configurations (deser-topic-configuration-list (clojure.core/get-in letvar175383 ["TopicConfiguration"]))) (letvar175383 "QueueConfiguration") (clojure.core/assoc :queue-configurations (deser-queue-configuration-list (clojure.core/get-in letvar175383 ["QueueConfiguration"]))) (letvar175383 "CloudFunctionConfiguration") (clojure.core/assoc :lambda-function-configurations (deser-lambda-function-configuration-list (clojure.core/get-in letvar175383 ["CloudFunctionConfiguration"]))))))

(clojure.core/defn- response-no-such-key [input] (clojure.core/let [rawinput175384 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175385 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-copy-object-output [input] (clojure.core/let [rawinput175386 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175387 {"x-amz-expiration" (clojure.core/get-in input [:headers "x-amz-expiration"]), "x-amz-server-side-encryption" (clojure.core/get-in input [:headers "x-amz-server-side-encryption"]), "x-amz-copy-source-version-id" (clojure.core/get-in input [:headers "x-amz-copy-source-version-id"]), "x-amz-version-id" (clojure.core/get-in input [:headers "x-amz-version-id"]), "x-amz-server-side-encryption-aws-kms-key-id" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-aws-kms-key-id"]), "x-amz-server-side-encryption-customer-key-MD5" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-key-MD5"]), "x-amz-server-side-encryption-customer-algorithm" (clojure.core/get-in input [:headers "x-amz-server-side-encryption-customer-algorithm"]), "CopyObjectResult" (portkey.aws/search-for-tag rawinput175386 "CopyObjectResult" :flattened? false), "x-amz-request-charged" (clojure.core/get-in input [:headers "x-amz-request-charged"])}] (clojure.core/cond-> {} (letvar175387 "x-amz-server-side-encryption-customer-key-MD5") (clojure.core/assoc :sse-customer-key-md-5 (deser-sse-customer-key-md-5 (clojure.core/get-in letvar175387 ["x-amz-server-side-encryption-customer-key-MD5"]))) (letvar175387 "x-amz-copy-source-version-id") (clojure.core/assoc :copy-source-version-id (deser-copy-source-version-id (clojure.core/get-in letvar175387 ["x-amz-copy-source-version-id"]))) (letvar175387 "x-amz-server-side-encryption-customer-algorithm") (clojure.core/assoc :sse-customer-algorithm (deser-sse-customer-algorithm (clojure.core/get-in letvar175387 ["x-amz-server-side-encryption-customer-algorithm"]))) (letvar175387 "x-amz-version-id") (clojure.core/assoc :version-id (deser-object-version-id (clojure.core/get-in letvar175387 ["x-amz-version-id"]))) (letvar175387 "x-amz-server-side-encryption") (clojure.core/assoc :server-side-encryption (deser-server-side-encryption (clojure.core/get-in letvar175387 ["x-amz-server-side-encryption"]))) (letvar175387 "CopyObjectResult") (clojure.core/assoc :copy-object-result (deser-copy-object-result (clojure.core/get-in letvar175387 ["CopyObjectResult" :content]))) (letvar175387 "x-amz-request-charged") (clojure.core/assoc :request-charged (deser-request-charged (clojure.core/get-in letvar175387 ["x-amz-request-charged"]))) (letvar175387 "x-amz-server-side-encryption-aws-kms-key-id") (clojure.core/assoc :ssekms-key-id (deser-ssekms-key-id (clojure.core/get-in letvar175387 ["x-amz-server-side-encryption-aws-kms-key-id"]))) (letvar175387 "x-amz-expiration") (clojure.core/assoc :expiration (deser-expiration (clojure.core/get-in letvar175387 ["x-amz-expiration"]))))))

(clojure.core/defn- response-get-bucket-metrics-configuration-output [input] (clojure.core/let [rawinput175388 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175389 {"MetricsConfiguration" (portkey.aws/search-for-tag rawinput175388 "MetricsConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175389 "MetricsConfiguration") (clojure.core/assoc :metrics-configuration (deser-metrics-configuration (clojure.core/get-in letvar175389 ["MetricsConfiguration" :content]))))))

(clojure.core/defn- response-object-not-in-active-tier-error [input] (clojure.core/let [rawinput175390 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175391 {}] (clojure.core/cond-> {})))

(clojure.core/defn- response-get-bucket-replication-output [input] (clojure.core/let [rawinput175392 (clojure.core/some-> input :body portkey.aws/parse-xml-body) letvar175393 {"ReplicationConfiguration" (portkey.aws/search-for-tag rawinput175392 "ReplicationConfiguration" :flattened? false)}] (clojure.core/cond-> {} (letvar175393 "ReplicationConfiguration") (clojure.core/assoc :replication-configuration (deser-replication-configuration (clojure.core/get-in letvar175393 ["ReplicationConfiguration" :content]))))))
...
(clojure.spec.alpha/def :portkey.aws.s3/put-object-request (clojure.spec.alpha/keys :req-un [:portkey.aws.s3.put-object-request/bucket :portkey.aws.s3.put-object-request/key] :opt-un [:portkey.aws.s3/content-encoding :portkey.aws.s3/sse-customer-key-md-5 :portkey.aws.s3/website-redirect-location :portkey.aws.s3/sse-customer-algorithm :portkey.aws.s3/sse-customer-key :portkey.aws.s3/content-md-5 :portkey.aws.s3/body :portkey.aws.s3/grant-read-acp :portkey.aws.s3/grant-read :portkey.aws.s3/server-side-encryption :portkey.aws.s3/content-disposition :portkey.aws.s3/content-type :portkey.aws.s3.put-object-request/acl :portkey.aws.s3/content-length :portkey.aws.s3/metadata :portkey.aws.s3/cache-control :portkey.aws.s3/content-language :portkey.aws.s3/grant-write-acp :portkey.aws.s3/grant-full-control :portkey.aws.s3.put-object-request/tagging :portkey.aws.s3/storage-class :portkey.aws.s3/expires :portkey.aws.s3/ssekms-key-id :portkey.aws.s3/request-payer]))
...
(clojure.spec.alpha/def :portkey.aws.s3/inventory-optional-field #{"LastModifiedDate" :storage-class "ReplicationStatus" "EncryptionStatus" "ETag" :size :replication-status "Size" "IsMultipartUploaded" "StorageClass" :encryption-status :is-multipart-uploaded :last-modified-date :e-tag})
...
(clojure.spec.alpha/def :portkey.aws.s3/transition-storage-class #{:standard-ia "GLACIER" :glacier "ONEZONE_IA" "STANDARD_IA" :onezone-ia})
...
(clojure.spec.alpha/def :portkey.aws.s3/object-storage-class #{:standard-ia "GLACIER" :glacier "ONEZONE_IA" :reduced-redundancy "STANDARD_IA" "STANDARD" :standard "REDUCED_REDUNDANCY" :onezone-ia})
...
(clojure.spec.alpha/def :portkey.aws.s3/object-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22927__auto__] (clojure.core/<= 1 (clojure.core/count s__22927__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.s3/create-bucket-request (clojure.spec.alpha/keys :req-un [:portkey.aws.s3.create-bucket-request/bucket] :opt-un [:portkey.aws.s3.create-bucket-request/acl :portkey.aws.s3/create-bucket-configuration :portkey.aws.s3/grant-full-control :portkey.aws.s3/grant-read :portkey.aws.s3/grant-read-acp :portkey.aws.s3/grant-write :portkey.aws.s3/grant-write-acp]))
...
(clojure.spec.alpha/def :portkey.aws.s3/storage-class #{:standard-ia "ONEZONE_IA" :reduced-redundancy "STANDARD_IA" "STANDARD" :standard "REDUCED_REDUNDANCY" :onezone-ia})
...
(clojure.spec.alpha/def :portkey.aws.s3/inventory-format #{"CSV" :csv :orc "ORC"})
...
(clojure.spec.alpha/def :portkey.aws.s3/copy-source (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__22929__auto__] (clojure.core/re-matches #"\/.+\/.+" s__22929__auto__))))
