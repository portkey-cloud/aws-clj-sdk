...
(clojure.core/defn- response-describe-stream-consumer-output ([input] (response-describe-stream-consumer-output nil input)) ([resultWrapper1166840 input] (clojure.core/let [rawinput1166839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166841 {"ConsumerDescription" (rawinput1166839 "ConsumerDescription")}] (clojure.core/cond-> {:consumer-description (deser-consumer-description (clojure.core/get-in letvar1166841 ["ConsumerDescription"]))}))))

(clojure.core/defn- response-update-shard-count-output ([input] (response-update-shard-count-output nil input)) ([resultWrapper1166843 input] (clojure.core/let [rawinput1166842 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166844 {"StreamName" (rawinput1166842 "StreamName"), "CurrentShardCount" (rawinput1166842 "CurrentShardCount"), "TargetShardCount" (rawinput1166842 "TargetShardCount")}] (clojure.core/cond-> {} (letvar1166844 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1166844 ["StreamName"]))) (letvar1166844 "CurrentShardCount") (clojure.core/assoc :current-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1166844 ["CurrentShardCount"]))) (letvar1166844 "TargetShardCount") (clojure.core/assoc :target-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1166844 ["TargetShardCount"])))))))

(clojure.core/defn- response-list-stream-consumers-output ([input] (response-list-stream-consumers-output nil input)) ([resultWrapper1166846 input] (clojure.core/let [rawinput1166845 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166847 {"Consumers" (rawinput1166845 "Consumers"), "NextToken" (rawinput1166845 "NextToken")}] (clojure.core/cond-> {} (letvar1166847 "Consumers") (clojure.core/assoc :consumers (deser-consumer-list (clojure.core/get-in letvar1166847 ["Consumers"]))) (letvar1166847 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1166847 ["NextToken"])))))))

(clojure.core/defn- response-enhanced-monitoring-output ([input] (response-enhanced-monitoring-output nil input)) ([resultWrapper1166849 input] (clojure.core/let [rawinput1166848 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166850 {"StreamName" (rawinput1166848 "StreamName"), "CurrentShardLevelMetrics" (rawinput1166848 "CurrentShardLevelMetrics"), "DesiredShardLevelMetrics" (rawinput1166848 "DesiredShardLevelMetrics")}] (clojure.core/cond-> {} (letvar1166850 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1166850 ["StreamName"]))) (letvar1166850 "CurrentShardLevelMetrics") (clojure.core/assoc :current-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1166850 ["CurrentShardLevelMetrics"]))) (letvar1166850 "DesiredShardLevelMetrics") (clojure.core/assoc :desired-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1166850 ["DesiredShardLevelMetrics"])))))))

(clojure.core/defn- response-describe-stream-summary-output ([input] (response-describe-stream-summary-output nil input)) ([resultWrapper1166852 input] (clojure.core/let [rawinput1166851 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166853 {"StreamDescriptionSummary" (rawinput1166851 "StreamDescriptionSummary")}] (clojure.core/cond-> {:stream-description-summary (deser-stream-description-summary (clojure.core/get-in letvar1166853 ["StreamDescriptionSummary"]))}))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1166855 input] (clojure.core/let [rawinput1166854 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166856 {"Tags" (rawinput1166854 "Tags"), "HasMoreTags" (rawinput1166854 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-tag-list (clojure.core/get-in letvar1166856 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar1166856 ["HasMoreTags"]))}))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1166858 input] (clojure.core/let [rawinput1166857 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166859 {"message" (rawinput1166857 "message")}] (clojure.core/cond-> {} (letvar1166859 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166859 ["message"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1166861 input] (clojure.core/let [rawinput1166860 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166862 {"message" (rawinput1166860 "message")}] (clojure.core/cond-> {} (letvar1166862 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166862 ["message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1166864 input] (clojure.core/let [rawinput1166863 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166865 {"message" (rawinput1166863 "message")}] (clojure.core/cond-> {} (letvar1166865 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166865 ["message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1166867 input] (clojure.core/let [rawinput1166866 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166868 {"message" (rawinput1166866 "message")}] (clojure.core/cond-> {} (letvar1166868 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166868 ["message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1166870 input] (clojure.core/let [rawinput1166869 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166871 {"StreamDescription" (rawinput1166869 "StreamDescription")}] (clojure.core/cond-> {:stream-description (deser-stream-description (clojure.core/get-in letvar1166871 ["StreamDescription"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1166873 input] (clojure.core/let [rawinput1166872 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166874 {"message" (rawinput1166872 "message")}] (clojure.core/cond-> {} (letvar1166874 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166874 ["message"])))))))

(clojure.core/defn- response-put-records-output ([input] (response-put-records-output nil input)) ([resultWrapper1166876 input] (clojure.core/let [rawinput1166875 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166877 {"FailedRecordCount" (rawinput1166875 "FailedRecordCount"), "Records" (rawinput1166875 "Records"), "EncryptionType" (rawinput1166875 "EncryptionType")}] (clojure.core/cond-> {:records (deser-put-records-result-entry-list (clojure.core/get-in letvar1166877 ["Records"]))} (letvar1166877 "FailedRecordCount") (clojure.core/assoc :failed-record-count (deser-positive-integer-object (clojure.core/get-in letvar1166877 ["FailedRecordCount"]))) (letvar1166877 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1166877 ["EncryptionType"])))))))

(clojure.core/defn- response-subscribe-to-shard-output ([input] (response-subscribe-to-shard-output nil input)) ([resultWrapper1166879 input] (clojure.core/let [rawinput1166878 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166880 {"EventStream" (rawinput1166878 "EventStream")}] (clojure.core/cond-> {:event-stream (deser-subscribe-to-shard-event-stream (clojure.core/get-in letvar1166880 ["EventStream"]))}))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper1166882 input] (clojure.core/let [rawinput1166881 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166883 {"message" (rawinput1166881 "message")}] (clojure.core/cond-> {} (letvar1166883 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166883 ["message"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1166885 input] (clojure.core/let [rawinput1166884 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166886 {"message" (rawinput1166884 "message")}] (clojure.core/cond-> {} (letvar1166886 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166886 ["message"])))))))

(clojure.core/defn- response-describe-limits-output ([input] (response-describe-limits-output nil input)) ([resultWrapper1166888 input] (clojure.core/let [rawinput1166887 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166889 {"ShardLimit" (rawinput1166887 "ShardLimit"), "OpenShardCount" (rawinput1166887 "OpenShardCount")}] (clojure.core/cond-> {:shard-limit (deser-shard-count-object (clojure.core/get-in letvar1166889 ["ShardLimit"])), :open-shard-count (deser-shard-count-object (clojure.core/get-in letvar1166889 ["OpenShardCount"]))}))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper1166891 input] (clojure.core/let [rawinput1166890 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166892 {"Records" (rawinput1166890 "Records"), "NextShardIterator" (rawinput1166890 "NextShardIterator"), "MillisBehindLatest" (rawinput1166890 "MillisBehindLatest")}] (clojure.core/cond-> {:records (deser-record-list (clojure.core/get-in letvar1166892 ["Records"]))} (letvar1166892 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1166892 ["NextShardIterator"]))) (letvar1166892 "MillisBehindLatest") (clojure.core/assoc :millis-behind-latest (deser-millis-behind-latest (clojure.core/get-in letvar1166892 ["MillisBehindLatest"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1166894 input] (clojure.core/let [rawinput1166893 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166895 {"message" (rawinput1166893 "message")}] (clojure.core/cond-> {} (letvar1166895 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166895 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1166897 input] (clojure.core/let [rawinput1166896 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166898 {"message" (rawinput1166896 "message")}] (clojure.core/cond-> {} (letvar1166898 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166898 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1166900 input] (clojure.core/let [rawinput1166899 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166901 {"StreamNames" (rawinput1166899 "StreamNames"), "HasMoreStreams" (rawinput1166899 "HasMoreStreams")}] (clojure.core/cond-> {:stream-names (deser-stream-name-list (clojure.core/get-in letvar1166901 ["StreamNames"])), :has-more-streams (deser-boolean-object (clojure.core/get-in letvar1166901 ["HasMoreStreams"]))}))))

(clojure.core/defn- response-list-shards-output ([input] (response-list-shards-output nil input)) ([resultWrapper1166903 input] (clojure.core/let [rawinput1166902 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166904 {"Shards" (rawinput1166902 "Shards"), "NextToken" (rawinput1166902 "NextToken")}] (clojure.core/cond-> {} (letvar1166904 "Shards") (clojure.core/assoc :shards (deser-shard-list (clojure.core/get-in letvar1166904 ["Shards"]))) (letvar1166904 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1166904 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1166906 input] (clojure.core/let [rawinput1166905 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166907 {"message" (rawinput1166905 "message")}] (clojure.core/cond-> {} (letvar1166907 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166907 ["message"])))))))

(clojure.core/defn- response-kms-throttling-exception ([input] (response-kms-throttling-exception nil input)) ([resultWrapper1166909 input] (clojure.core/let [rawinput1166908 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166910 {"message" (rawinput1166908 "message")}] (clojure.core/cond-> {} (letvar1166910 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166910 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper1166912 input] (clojure.core/let [rawinput1166911 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166913 {"ShardIterator" (rawinput1166911 "ShardIterator")}] (clojure.core/cond-> {} (letvar1166913 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1166913 ["ShardIterator"])))))))

(clojure.core/defn- response-register-stream-consumer-output ([input] (response-register-stream-consumer-output nil input)) ([resultWrapper1166915 input] (clojure.core/let [rawinput1166914 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166916 {"Consumer" (rawinput1166914 "Consumer")}] (clojure.core/cond-> {:consumer (deser-consumer (clojure.core/get-in letvar1166916 ["Consumer"]))}))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper1166918 input] (clojure.core/let [rawinput1166917 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166919 {"ShardId" (rawinput1166917 "ShardId"), "SequenceNumber" (rawinput1166917 "SequenceNumber"), "EncryptionType" (rawinput1166917 "EncryptionType")}] (clojure.core/cond-> {:shard-id (deser-shard-id (clojure.core/get-in letvar1166919 ["ShardId"])), :sequence-number (deser-sequence-number (clojure.core/get-in letvar1166919 ["SequenceNumber"]))} (letvar1166919 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1166919 ["EncryptionType"])))))))

(clojure.core/defn- response-kms-opt-in-required ([input] (response-kms-opt-in-required nil input)) ([resultWrapper1166921 input] (clojure.core/let [rawinput1166920 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166922 {"message" (rawinput1166920 "message")}] (clojure.core/cond-> {} (letvar1166922 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166922 ["message"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1166924 input] (clojure.core/let [rawinput1166923 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1166925 {"message" (rawinput1166923 "message")}] (clojure.core/cond-> {} (letvar1166925 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1166925 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/consumer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/consumer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"^(arn):aws.*:kinesis:.*:\d{12}:.*stream\/[a-zA-Z0-9_.-]+\/consumer\/[a-zA-Z0-9_.-]+:[0-9]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/partition-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1048576))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,128})" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/hash-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,38})" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 2048)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"arn:aws.*:kinesis:.*:\d{12}:stream/.*" s__21078__auto__))))
