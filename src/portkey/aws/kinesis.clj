...
(clojure.core/defn- response-describe-stream-consumer-output ([input] (response-describe-stream-consumer-output nil input)) ([resultWrapper1824672 input] (clojure.core/let [rawinput1824671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824673 {"ConsumerDescription" (rawinput1824671 "ConsumerDescription")}] (clojure.core/cond-> {:consumer-description (deser-consumer-description (clojure.core/get-in letvar1824673 ["ConsumerDescription"]))}))))

(clojure.core/defn- response-update-shard-count-output ([input] (response-update-shard-count-output nil input)) ([resultWrapper1824675 input] (clojure.core/let [rawinput1824674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824676 {"StreamName" (rawinput1824674 "StreamName"), "CurrentShardCount" (rawinput1824674 "CurrentShardCount"), "TargetShardCount" (rawinput1824674 "TargetShardCount")}] (clojure.core/cond-> {} (letvar1824676 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1824676 ["StreamName"]))) (letvar1824676 "CurrentShardCount") (clojure.core/assoc :current-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1824676 ["CurrentShardCount"]))) (letvar1824676 "TargetShardCount") (clojure.core/assoc :target-shard-count (deser-positive-integer-object (clojure.core/get-in letvar1824676 ["TargetShardCount"])))))))

(clojure.core/defn- response-list-stream-consumers-output ([input] (response-list-stream-consumers-output nil input)) ([resultWrapper1824678 input] (clojure.core/let [rawinput1824677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824679 {"Consumers" (rawinput1824677 "Consumers"), "NextToken" (rawinput1824677 "NextToken")}] (clojure.core/cond-> {} (letvar1824679 "Consumers") (clojure.core/assoc :consumers (deser-consumer-list (clojure.core/get-in letvar1824679 ["Consumers"]))) (letvar1824679 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1824679 ["NextToken"])))))))

(clojure.core/defn- response-enhanced-monitoring-output ([input] (response-enhanced-monitoring-output nil input)) ([resultWrapper1824681 input] (clojure.core/let [rawinput1824680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824682 {"StreamName" (rawinput1824680 "StreamName"), "CurrentShardLevelMetrics" (rawinput1824680 "CurrentShardLevelMetrics"), "DesiredShardLevelMetrics" (rawinput1824680 "DesiredShardLevelMetrics")}] (clojure.core/cond-> {} (letvar1824682 "StreamName") (clojure.core/assoc :stream-name (deser-stream-name (clojure.core/get-in letvar1824682 ["StreamName"]))) (letvar1824682 "CurrentShardLevelMetrics") (clojure.core/assoc :current-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1824682 ["CurrentShardLevelMetrics"]))) (letvar1824682 "DesiredShardLevelMetrics") (clojure.core/assoc :desired-shard-level-metrics (deser-metrics-name-list (clojure.core/get-in letvar1824682 ["DesiredShardLevelMetrics"])))))))

(clojure.core/defn- response-describe-stream-summary-output ([input] (response-describe-stream-summary-output nil input)) ([resultWrapper1824684 input] (clojure.core/let [rawinput1824683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824685 {"StreamDescriptionSummary" (rawinput1824683 "StreamDescriptionSummary")}] (clojure.core/cond-> {:stream-description-summary (deser-stream-description-summary (clojure.core/get-in letvar1824685 ["StreamDescriptionSummary"]))}))))

(clojure.core/defn- response-list-tags-for-stream-output ([input] (response-list-tags-for-stream-output nil input)) ([resultWrapper1824687 input] (clojure.core/let [rawinput1824686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824688 {"Tags" (rawinput1824686 "Tags"), "HasMoreTags" (rawinput1824686 "HasMoreTags")}] (clojure.core/cond-> {:tags (deser-tag-list (clojure.core/get-in letvar1824688 ["Tags"])), :has-more-tags (deser-boolean-object (clojure.core/get-in letvar1824688 ["HasMoreTags"]))}))))

(clojure.core/defn- response-expired-next-token-exception ([input] (response-expired-next-token-exception nil input)) ([resultWrapper1824690 input] (clojure.core/let [rawinput1824689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824691 {"message" (rawinput1824689 "message")}] (clojure.core/cond-> {} (letvar1824691 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824691 ["message"])))))))

(clojure.core/defn- response-kms-not-found-exception ([input] (response-kms-not-found-exception nil input)) ([resultWrapper1824693 input] (clojure.core/let [rawinput1824692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824694 {"message" (rawinput1824692 "message")}] (clojure.core/cond-> {} (letvar1824694 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824694 ["message"])))))))

(clojure.core/defn- response-kms-invalid-state-exception ([input] (response-kms-invalid-state-exception nil input)) ([resultWrapper1824696 input] (clojure.core/let [rawinput1824695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824697 {"message" (rawinput1824695 "message")}] (clojure.core/cond-> {} (letvar1824697 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824697 ["message"])))))))

(clojure.core/defn- response-resource-in-use-exception ([input] (response-resource-in-use-exception nil input)) ([resultWrapper1824699 input] (clojure.core/let [rawinput1824698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824700 {"message" (rawinput1824698 "message")}] (clojure.core/cond-> {} (letvar1824700 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824700 ["message"])))))))

(clojure.core/defn- response-describe-stream-output ([input] (response-describe-stream-output nil input)) ([resultWrapper1824702 input] (clojure.core/let [rawinput1824701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824703 {"StreamDescription" (rawinput1824701 "StreamDescription")}] (clojure.core/cond-> {:stream-description (deser-stream-description (clojure.core/get-in letvar1824703 ["StreamDescription"]))}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1824705 input] (clojure.core/let [rawinput1824704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824706 {"message" (rawinput1824704 "message")}] (clojure.core/cond-> {} (letvar1824706 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824706 ["message"])))))))

(clojure.core/defn- response-put-records-output ([input] (response-put-records-output nil input)) ([resultWrapper1824708 input] (clojure.core/let [rawinput1824707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824709 {"FailedRecordCount" (rawinput1824707 "FailedRecordCount"), "Records" (rawinput1824707 "Records"), "EncryptionType" (rawinput1824707 "EncryptionType")}] (clojure.core/cond-> {:records (deser-put-records-result-entry-list (clojure.core/get-in letvar1824709 ["Records"]))} (letvar1824709 "FailedRecordCount") (clojure.core/assoc :failed-record-count (deser-positive-integer-object (clojure.core/get-in letvar1824709 ["FailedRecordCount"]))) (letvar1824709 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1824709 ["EncryptionType"])))))))

(clojure.core/defn- response-subscribe-to-shard-output ([input] (response-subscribe-to-shard-output nil input)) ([resultWrapper1824711 input] (clojure.core/let [rawinput1824710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824712 {"EventStream" (rawinput1824710 "EventStream")}] (clojure.core/cond-> {:event-stream (deser-subscribe-to-shard-event-stream (clojure.core/get-in letvar1824712 ["EventStream"]))}))))

(clojure.core/defn- response-expired-iterator-exception ([input] (response-expired-iterator-exception nil input)) ([resultWrapper1824714 input] (clojure.core/let [rawinput1824713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824715 {"message" (rawinput1824713 "message")}] (clojure.core/cond-> {} (letvar1824715 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824715 ["message"])))))))

(clojure.core/defn- response-kms-disabled-exception ([input] (response-kms-disabled-exception nil input)) ([resultWrapper1824717 input] (clojure.core/let [rawinput1824716 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824718 {"message" (rawinput1824716 "message")}] (clojure.core/cond-> {} (letvar1824718 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824718 ["message"])))))))

(clojure.core/defn- response-describe-limits-output ([input] (response-describe-limits-output nil input)) ([resultWrapper1824720 input] (clojure.core/let [rawinput1824719 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824721 {"ShardLimit" (rawinput1824719 "ShardLimit"), "OpenShardCount" (rawinput1824719 "OpenShardCount")}] (clojure.core/cond-> {:shard-limit (deser-shard-count-object (clojure.core/get-in letvar1824721 ["ShardLimit"])), :open-shard-count (deser-shard-count-object (clojure.core/get-in letvar1824721 ["OpenShardCount"]))}))))

(clojure.core/defn- response-get-records-output ([input] (response-get-records-output nil input)) ([resultWrapper1824723 input] (clojure.core/let [rawinput1824722 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824724 {"Records" (rawinput1824722 "Records"), "NextShardIterator" (rawinput1824722 "NextShardIterator"), "MillisBehindLatest" (rawinput1824722 "MillisBehindLatest")}] (clojure.core/cond-> {:records (deser-record-list (clojure.core/get-in letvar1824724 ["Records"]))} (letvar1824724 "NextShardIterator") (clojure.core/assoc :next-shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1824724 ["NextShardIterator"]))) (letvar1824724 "MillisBehindLatest") (clojure.core/assoc :millis-behind-latest (deser-millis-behind-latest (clojure.core/get-in letvar1824724 ["MillisBehindLatest"])))))))

(clojure.core/defn- response-kms-access-denied-exception ([input] (response-kms-access-denied-exception nil input)) ([resultWrapper1824726 input] (clojure.core/let [rawinput1824725 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824727 {"message" (rawinput1824725 "message")}] (clojure.core/cond-> {} (letvar1824727 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824727 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1824729 input] (clojure.core/let [rawinput1824728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824730 {"message" (rawinput1824728 "message")}] (clojure.core/cond-> {} (letvar1824730 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824730 ["message"])))))))

(clojure.core/defn- response-list-streams-output ([input] (response-list-streams-output nil input)) ([resultWrapper1824732 input] (clojure.core/let [rawinput1824731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824733 {"StreamNames" (rawinput1824731 "StreamNames"), "HasMoreStreams" (rawinput1824731 "HasMoreStreams")}] (clojure.core/cond-> {:stream-names (deser-stream-name-list (clojure.core/get-in letvar1824733 ["StreamNames"])), :has-more-streams (deser-boolean-object (clojure.core/get-in letvar1824733 ["HasMoreStreams"]))}))))

(clojure.core/defn- response-list-shards-output ([input] (response-list-shards-output nil input)) ([resultWrapper1824735 input] (clojure.core/let [rawinput1824734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824736 {"Shards" (rawinput1824734 "Shards"), "NextToken" (rawinput1824734 "NextToken")}] (clojure.core/cond-> {} (letvar1824736 "Shards") (clojure.core/assoc :shards (deser-shard-list (clojure.core/get-in letvar1824736 ["Shards"]))) (letvar1824736 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1824736 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1824738 input] (clojure.core/let [rawinput1824737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824739 {"message" (rawinput1824737 "message")}] (clojure.core/cond-> {} (letvar1824739 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824739 ["message"])))))))

(clojure.core/defn- response-kms-throttling-exception ([input] (response-kms-throttling-exception nil input)) ([resultWrapper1824741 input] (clojure.core/let [rawinput1824740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824742 {"message" (rawinput1824740 "message")}] (clojure.core/cond-> {} (letvar1824742 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824742 ["message"])))))))

(clojure.core/defn- response-get-shard-iterator-output ([input] (response-get-shard-iterator-output nil input)) ([resultWrapper1824744 input] (clojure.core/let [rawinput1824743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824745 {"ShardIterator" (rawinput1824743 "ShardIterator")}] (clojure.core/cond-> {} (letvar1824745 "ShardIterator") (clojure.core/assoc :shard-iterator (deser-shard-iterator (clojure.core/get-in letvar1824745 ["ShardIterator"])))))))

(clojure.core/defn- response-register-stream-consumer-output ([input] (response-register-stream-consumer-output nil input)) ([resultWrapper1824747 input] (clojure.core/let [rawinput1824746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824748 {"Consumer" (rawinput1824746 "Consumer")}] (clojure.core/cond-> {:consumer (deser-consumer (clojure.core/get-in letvar1824748 ["Consumer"]))}))))

(clojure.core/defn- response-put-record-output ([input] (response-put-record-output nil input)) ([resultWrapper1824750 input] (clojure.core/let [rawinput1824749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824751 {"ShardId" (rawinput1824749 "ShardId"), "SequenceNumber" (rawinput1824749 "SequenceNumber"), "EncryptionType" (rawinput1824749 "EncryptionType")}] (clojure.core/cond-> {:shard-id (deser-shard-id (clojure.core/get-in letvar1824751 ["ShardId"])), :sequence-number (deser-sequence-number (clojure.core/get-in letvar1824751 ["SequenceNumber"]))} (letvar1824751 "EncryptionType") (clojure.core/assoc :encryption-type (deser-encryption-type (clojure.core/get-in letvar1824751 ["EncryptionType"])))))))

(clojure.core/defn- response-kms-opt-in-required ([input] (response-kms-opt-in-required nil input)) ([resultWrapper1824753 input] (clojure.core/let [rawinput1824752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824754 {"message" (rawinput1824752 "message")}] (clojure.core/cond-> {} (letvar1824754 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824754 ["message"])))))))

(clojure.core/defn- response-provisioned-throughput-exceeded-exception ([input] (response-provisioned-throughput-exceeded-exception nil input)) ([resultWrapper1824756 input] (clojure.core/let [rawinput1824755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1824757 {"message" (rawinput1824755 "message")}] (clojure.core/cond-> {} (letvar1824757 "message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1824757 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/stream-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/consumer-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/shard-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9_.-]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/consumer-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^(arn):aws.*:kinesis:.*:\d{12}:.*stream\/[a-zA-Z0-9_.-]+\/consumer\/[a-zA-Z0-9_.-]+:[0-9]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/partition-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/tag-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/key-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/shard-iterator (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 512))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/next-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1048576))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/sequence-number (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,128})" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/tag-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 0 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/hash-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"0|([1-9]\d{0,38})" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.kinesis/stream-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"arn:aws.*:kinesis:.*:\d{12}:stream/.*" s__1410940__auto__))))
