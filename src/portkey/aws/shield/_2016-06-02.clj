...
(clojure.core/defn- response-invalid-resource-exception ([input] (response-invalid-resource-exception nil input)) ([resultWrapper2031750 input] (clojure.core/let [rawinput2031749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031751 {"message" (rawinput2031749 "message")}] (clojure.core/cond-> {} (letvar2031751 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031751 ["message"])))))))

(clojure.core/defn- response-disassociate-drt-role-response ([input] (response-disassociate-drt-role-response nil input)) ([resultWrapper2031753 input] (clojure.core/let [rawinput2031752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031754 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-subscription-response ([input] (response-create-subscription-response nil input)) ([resultWrapper2031756 input] (clojure.core/let [rawinput2031755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031757 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-protection-response ([input] (response-delete-protection-response nil input)) ([resultWrapper2031759 input] (clojure.core/let [rawinput2031758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031760 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-drt-log-bucket-response ([input] (response-disassociate-drt-log-bucket-response nil input)) ([resultWrapper2031762 input] (clojure.core/let [rawinput2031761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031763 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper2031765 input] (clojure.core/let [rawinput2031764 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031766 {"message" (rawinput2031764 "message")}] (clojure.core/cond-> {} (letvar2031766 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031766 ["message"])))))))

(clojure.core/defn- response-limits-exceeded-exception ([input] (response-limits-exceeded-exception nil input)) ([resultWrapper2031768 input] (clojure.core/let [rawinput2031767 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031769 {"message" (rawinput2031767 "message"), "Type" (rawinput2031767 "Type"), "Limit" (rawinput2031767 "Limit")}] (clojure.core/cond-> {} (letvar2031769 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031769 ["message"]))) (letvar2031769 "Type") (clojure.core/assoc :type (deser-limit-type (clojure.core/get-in letvar2031769 ["Type"]))) (letvar2031769 "Limit") (clojure.core/assoc :limit (deser-limit-number (clojure.core/get-in letvar2031769 ["Limit"])))))))

(clojure.core/defn- response-associate-drt-log-bucket-response ([input] (response-associate-drt-log-bucket-response nil input)) ([resultWrapper2031771 input] (clojure.core/let [rawinput2031770 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031772 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-emergency-contact-settings-response ([input] (response-describe-emergency-contact-settings-response nil input)) ([resultWrapper2031774 input] (clojure.core/let [rawinput2031773 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031775 {"EmergencyContactList" (rawinput2031773 "EmergencyContactList")}] (clojure.core/cond-> {} (letvar2031775 "EmergencyContactList") (clojure.core/assoc :emergency-contact-list (deser-emergency-contact-list (clojure.core/get-in letvar2031775 ["EmergencyContactList"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper2031777 input] (clojure.core/let [rawinput2031776 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031778 {"message" (rawinput2031776 "message")}] (clojure.core/cond-> {} (letvar2031778 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031778 ["message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper2031780 input] (clojure.core/let [rawinput2031779 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031781 {"message" (rawinput2031779 "message")}] (clojure.core/cond-> {} (letvar2031781 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031781 ["message"])))))))

(clojure.core/defn- response-locked-subscription-exception ([input] (response-locked-subscription-exception nil input)) ([resultWrapper2031783 input] (clojure.core/let [rawinput2031782 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031784 {"message" (rawinput2031782 "message")}] (clojure.core/cond-> {} (letvar2031784 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031784 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2031786 input] (clojure.core/let [rawinput2031785 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031787 {"message" (rawinput2031785 "message")}] (clojure.core/cond-> {} (letvar2031787 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031787 ["message"])))))))

(clojure.core/defn- response-no-associated-role-exception ([input] (response-no-associated-role-exception nil input)) ([resultWrapper2031789 input] (clojure.core/let [rawinput2031788 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031790 {"message" (rawinput2031788 "message")}] (clojure.core/cond-> {} (letvar2031790 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031790 ["message"])))))))

(clojure.core/defn- response-describe-drt-access-response ([input] (response-describe-drt-access-response nil input)) ([resultWrapper2031792 input] (clojure.core/let [rawinput2031791 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031793 {"RoleArn" (rawinput2031791 "RoleArn"), "LogBucketList" (rawinput2031791 "LogBucketList")}] (clojure.core/cond-> {} (letvar2031793 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar2031793 ["RoleArn"]))) (letvar2031793 "LogBucketList") (clojure.core/assoc :log-bucket-list (deser-log-bucket-list (clojure.core/get-in letvar2031793 ["LogBucketList"])))))))

(clojure.core/defn- response-describe-protection-response ([input] (response-describe-protection-response nil input)) ([resultWrapper2031795 input] (clojure.core/let [rawinput2031794 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031796 {"Protection" (rawinput2031794 "Protection")}] (clojure.core/cond-> {} (letvar2031796 "Protection") (clojure.core/assoc :protection (deser-protection (clojure.core/get-in letvar2031796 ["Protection"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2031798 input] (clojure.core/let [rawinput2031797 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031799 {"message" (rawinput2031797 "message")}] (clojure.core/cond-> {} (letvar2031799 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031799 ["message"])))))))

(clojure.core/defn- response-list-attacks-response ([input] (response-list-attacks-response nil input)) ([resultWrapper2031801 input] (clojure.core/let [rawinput2031800 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031802 {"AttackSummaries" (rawinput2031800 "AttackSummaries"), "NextToken" (rawinput2031800 "NextToken")}] (clojure.core/cond-> {} (letvar2031802 "AttackSummaries") (clojure.core/assoc :attack-summaries (deser-attack-summaries (clojure.core/get-in letvar2031802 ["AttackSummaries"]))) (letvar2031802 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar2031802 ["NextToken"])))))))

(clojure.core/defn- response-get-subscription-state-response ([input] (response-get-subscription-state-response nil input)) ([resultWrapper2031804 input] (clojure.core/let [rawinput2031803 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031805 {"SubscriptionState" (rawinput2031803 "SubscriptionState")}] (clojure.core/cond-> {:subscription-state (deser-subscription-state (clojure.core/get-in letvar2031805 ["SubscriptionState"]))}))))

(clojure.core/defn- response-update-subscription-response ([input] (response-update-subscription-response nil input)) ([resultWrapper2031807 input] (clojure.core/let [rawinput2031806 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031808 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-emergency-contact-settings-response ([input] (response-update-emergency-contact-settings-response nil input)) ([resultWrapper2031810 input] (clojure.core/let [rawinput2031809 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031811 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-attack-response ([input] (response-describe-attack-response nil input)) ([resultWrapper2031813 input] (clojure.core/let [rawinput2031812 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031814 {"Attack" (rawinput2031812 "Attack")}] (clojure.core/cond-> {} (letvar2031814 "Attack") (clojure.core/assoc :attack (deser-attack-detail (clojure.core/get-in letvar2031814 ["Attack"])))))))

(clojure.core/defn- response-access-denied-for-dependency-exception ([input] (response-access-denied-for-dependency-exception nil input)) ([resultWrapper2031816 input] (clojure.core/let [rawinput2031815 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031817 {"message" (rawinput2031815 "message")}] (clojure.core/cond-> {} (letvar2031817 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031817 ["message"])))))))

(clojure.core/defn- response-describe-subscription-response ([input] (response-describe-subscription-response nil input)) ([resultWrapper2031819 input] (clojure.core/let [rawinput2031818 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031820 {"Subscription" (rawinput2031818 "Subscription")}] (clojure.core/cond-> {} (letvar2031820 "Subscription") (clojure.core/assoc :subscription (deser-subscription (clojure.core/get-in letvar2031820 ["Subscription"])))))))

(clojure.core/defn- response-optimistic-lock-exception ([input] (response-optimistic-lock-exception nil input)) ([resultWrapper2031822 input] (clojure.core/let [rawinput2031821 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031823 {"message" (rawinput2031821 "message")}] (clojure.core/cond-> {} (letvar2031823 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031823 ["message"])))))))

(clojure.core/defn- response-create-protection-response ([input] (response-create-protection-response nil input)) ([resultWrapper2031825 input] (clojure.core/let [rawinput2031824 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031826 {"ProtectionId" (rawinput2031824 "ProtectionId")}] (clojure.core/cond-> {} (letvar2031826 "ProtectionId") (clojure.core/assoc :protection-id (deser-protection-id (clojure.core/get-in letvar2031826 ["ProtectionId"])))))))

(clojure.core/defn- response-associate-drt-role-response ([input] (response-associate-drt-role-response nil input)) ([resultWrapper2031828 input] (clojure.core/let [rawinput2031827 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031829 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2031831 input] (clojure.core/let [rawinput2031830 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031832 {"message" (rawinput2031830 "message")}] (clojure.core/cond-> {} (letvar2031832 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031832 ["message"])))))))

(clojure.core/defn- response-delete-subscription-response ([input] (response-delete-subscription-response nil input)) ([resultWrapper2031834 input] (clojure.core/let [rawinput2031833 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031835 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-protections-response ([input] (response-list-protections-response nil input)) ([resultWrapper2031837 input] (clojure.core/let [rawinput2031836 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031838 {"Protections" (rawinput2031836 "Protections"), "NextToken" (rawinput2031836 "NextToken")}] (clojure.core/cond-> {} (letvar2031838 "Protections") (clojure.core/assoc :protections (deser-protections (clojure.core/get-in letvar2031838 ["Protections"]))) (letvar2031838 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar2031838 ["NextToken"])))))))

(clojure.core/defn- response-invalid-pagination-token-exception ([input] (response-invalid-pagination-token-exception nil input)) ([resultWrapper2031840 input] (clojure.core/let [rawinput2031839 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2031841 {"message" (rawinput2031839 "message")}] (clojure.core/cond-> {} (letvar2031841 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2031841 ["message"])))))))
