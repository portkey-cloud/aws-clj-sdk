...
(clojure.core/defn- response-invalid-resource-exception ([input] (response-invalid-resource-exception nil input)) ([resultWrapper2029672 input] (clojure.core/let [rawinput2029671 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029673 {"message" (rawinput2029671 "message")}] (clojure.core/cond-> {} (letvar2029673 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029673 ["message"])))))))

(clojure.core/defn- response-disassociate-drt-role-response ([input] (response-disassociate-drt-role-response nil input)) ([resultWrapper2029675 input] (clojure.core/let [rawinput2029674 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029676 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-subscription-response ([input] (response-create-subscription-response nil input)) ([resultWrapper2029678 input] (clojure.core/let [rawinput2029677 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029679 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-protection-response ([input] (response-delete-protection-response nil input)) ([resultWrapper2029681 input] (clojure.core/let [rawinput2029680 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029682 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-disassociate-drt-log-bucket-response ([input] (response-disassociate-drt-log-bucket-response nil input)) ([resultWrapper2029684 input] (clojure.core/let [rawinput2029683 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029685 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-resource-already-exists-exception ([input] (response-resource-already-exists-exception nil input)) ([resultWrapper2029687 input] (clojure.core/let [rawinput2029686 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029688 {"message" (rawinput2029686 "message")}] (clojure.core/cond-> {} (letvar2029688 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029688 ["message"])))))))

(clojure.core/defn- response-limits-exceeded-exception ([input] (response-limits-exceeded-exception nil input)) ([resultWrapper2029690 input] (clojure.core/let [rawinput2029689 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029691 {"message" (rawinput2029689 "message"), "Type" (rawinput2029689 "Type"), "Limit" (rawinput2029689 "Limit")}] (clojure.core/cond-> {} (letvar2029691 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029691 ["message"]))) (letvar2029691 "Type") (clojure.core/assoc :type (deser-limit-type (clojure.core/get-in letvar2029691 ["Type"]))) (letvar2029691 "Limit") (clojure.core/assoc :limit (deser-limit-number (clojure.core/get-in letvar2029691 ["Limit"])))))))

(clojure.core/defn- response-associate-drt-log-bucket-response ([input] (response-associate-drt-log-bucket-response nil input)) ([resultWrapper2029693 input] (clojure.core/let [rawinput2029692 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029694 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-emergency-contact-settings-response ([input] (response-describe-emergency-contact-settings-response nil input)) ([resultWrapper2029696 input] (clojure.core/let [rawinput2029695 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029697 {"EmergencyContactList" (rawinput2029695 "EmergencyContactList")}] (clojure.core/cond-> {} (letvar2029697 "EmergencyContactList") (clojure.core/assoc :emergency-contact-list (deser-emergency-contact-list (clojure.core/get-in letvar2029697 ["EmergencyContactList"])))))))

(clojure.core/defn- response-invalid-operation-exception ([input] (response-invalid-operation-exception nil input)) ([resultWrapper2029699 input] (clojure.core/let [rawinput2029698 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029700 {"message" (rawinput2029698 "message")}] (clojure.core/cond-> {} (letvar2029700 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029700 ["message"])))))))

(clojure.core/defn- response-internal-error-exception ([input] (response-internal-error-exception nil input)) ([resultWrapper2029702 input] (clojure.core/let [rawinput2029701 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029703 {"message" (rawinput2029701 "message")}] (clojure.core/cond-> {} (letvar2029703 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029703 ["message"])))))))

(clojure.core/defn- response-locked-subscription-exception ([input] (response-locked-subscription-exception nil input)) ([resultWrapper2029705 input] (clojure.core/let [rawinput2029704 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029706 {"message" (rawinput2029704 "message")}] (clojure.core/cond-> {} (letvar2029706 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029706 ["message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper2029708 input] (clojure.core/let [rawinput2029707 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029709 {"message" (rawinput2029707 "message")}] (clojure.core/cond-> {} (letvar2029709 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029709 ["message"])))))))

(clojure.core/defn- response-no-associated-role-exception ([input] (response-no-associated-role-exception nil input)) ([resultWrapper2029711 input] (clojure.core/let [rawinput2029710 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029712 {"message" (rawinput2029710 "message")}] (clojure.core/cond-> {} (letvar2029712 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029712 ["message"])))))))

(clojure.core/defn- response-describe-drt-access-response ([input] (response-describe-drt-access-response nil input)) ([resultWrapper2029714 input] (clojure.core/let [rawinput2029713 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029715 {"RoleArn" (rawinput2029713 "RoleArn"), "LogBucketList" (rawinput2029713 "LogBucketList")}] (clojure.core/cond-> {} (letvar2029715 "RoleArn") (clojure.core/assoc :role-arn (deser-role-arn (clojure.core/get-in letvar2029715 ["RoleArn"]))) (letvar2029715 "LogBucketList") (clojure.core/assoc :log-bucket-list (deser-log-bucket-list (clojure.core/get-in letvar2029715 ["LogBucketList"])))))))

(clojure.core/defn- response-describe-protection-response ([input] (response-describe-protection-response nil input)) ([resultWrapper2029717 input] (clojure.core/let [rawinput2029716 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029718 {"Protection" (rawinput2029716 "Protection")}] (clojure.core/cond-> {} (letvar2029718 "Protection") (clojure.core/assoc :protection (deser-protection (clojure.core/get-in letvar2029718 ["Protection"])))))))

(clojure.core/defn- response-access-denied-exception ([input] (response-access-denied-exception nil input)) ([resultWrapper2029720 input] (clojure.core/let [rawinput2029719 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029721 {"message" (rawinput2029719 "message")}] (clojure.core/cond-> {} (letvar2029721 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029721 ["message"])))))))

(clojure.core/defn- response-list-attacks-response ([input] (response-list-attacks-response nil input)) ([resultWrapper2029723 input] (clojure.core/let [rawinput2029722 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029724 {"AttackSummaries" (rawinput2029722 "AttackSummaries"), "NextToken" (rawinput2029722 "NextToken")}] (clojure.core/cond-> {} (letvar2029724 "AttackSummaries") (clojure.core/assoc :attack-summaries (deser-attack-summaries (clojure.core/get-in letvar2029724 ["AttackSummaries"]))) (letvar2029724 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar2029724 ["NextToken"])))))))

(clojure.core/defn- response-get-subscription-state-response ([input] (response-get-subscription-state-response nil input)) ([resultWrapper2029726 input] (clojure.core/let [rawinput2029725 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029727 {"SubscriptionState" (rawinput2029725 "SubscriptionState")}] (clojure.core/cond-> {:subscription-state (deser-subscription-state (clojure.core/get-in letvar2029727 ["SubscriptionState"]))}))))

(clojure.core/defn- response-update-subscription-response ([input] (response-update-subscription-response nil input)) ([resultWrapper2029729 input] (clojure.core/let [rawinput2029728 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029730 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-emergency-contact-settings-response ([input] (response-update-emergency-contact-settings-response nil input)) ([resultWrapper2029732 input] (clojure.core/let [rawinput2029731 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029733 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-attack-response ([input] (response-describe-attack-response nil input)) ([resultWrapper2029735 input] (clojure.core/let [rawinput2029734 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029736 {"Attack" (rawinput2029734 "Attack")}] (clojure.core/cond-> {} (letvar2029736 "Attack") (clojure.core/assoc :attack (deser-attack-detail (clojure.core/get-in letvar2029736 ["Attack"])))))))

(clojure.core/defn- response-access-denied-for-dependency-exception ([input] (response-access-denied-for-dependency-exception nil input)) ([resultWrapper2029738 input] (clojure.core/let [rawinput2029737 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029739 {"message" (rawinput2029737 "message")}] (clojure.core/cond-> {} (letvar2029739 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029739 ["message"])))))))

(clojure.core/defn- response-describe-subscription-response ([input] (response-describe-subscription-response nil input)) ([resultWrapper2029741 input] (clojure.core/let [rawinput2029740 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029742 {"Subscription" (rawinput2029740 "Subscription")}] (clojure.core/cond-> {} (letvar2029742 "Subscription") (clojure.core/assoc :subscription (deser-subscription (clojure.core/get-in letvar2029742 ["Subscription"])))))))

(clojure.core/defn- response-optimistic-lock-exception ([input] (response-optimistic-lock-exception nil input)) ([resultWrapper2029744 input] (clojure.core/let [rawinput2029743 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029745 {"message" (rawinput2029743 "message")}] (clojure.core/cond-> {} (letvar2029745 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029745 ["message"])))))))

(clojure.core/defn- response-create-protection-response ([input] (response-create-protection-response nil input)) ([resultWrapper2029747 input] (clojure.core/let [rawinput2029746 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029748 {"ProtectionId" (rawinput2029746 "ProtectionId")}] (clojure.core/cond-> {} (letvar2029748 "ProtectionId") (clojure.core/assoc :protection-id (deser-protection-id (clojure.core/get-in letvar2029748 ["ProtectionId"])))))))

(clojure.core/defn- response-associate-drt-role-response ([input] (response-associate-drt-role-response nil input)) ([resultWrapper2029750 input] (clojure.core/let [rawinput2029749 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029751 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper2029753 input] (clojure.core/let [rawinput2029752 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029754 {"message" (rawinput2029752 "message")}] (clojure.core/cond-> {} (letvar2029754 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029754 ["message"])))))))

(clojure.core/defn- response-delete-subscription-response ([input] (response-delete-subscription-response nil input)) ([resultWrapper2029756 input] (clojure.core/let [rawinput2029755 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029757 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-protections-response ([input] (response-list-protections-response nil input)) ([resultWrapper2029759 input] (clojure.core/let [rawinput2029758 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029760 {"Protections" (rawinput2029758 "Protections"), "NextToken" (rawinput2029758 "NextToken")}] (clojure.core/cond-> {} (letvar2029760 "Protections") (clojure.core/assoc :protections (deser-protections (clojure.core/get-in letvar2029760 ["Protections"]))) (letvar2029760 "NextToken") (clojure.core/assoc :next-token (deser-token (clojure.core/get-in letvar2029760 ["NextToken"])))))))

(clojure.core/defn- response-invalid-pagination-token-exception ([input] (response-invalid-pagination-token-exception nil input)) ([resultWrapper2029762 input] (clojure.core/let [rawinput2029761 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar2029763 {"message" (rawinput2029761 "message")}] (clojure.core/cond-> {} (letvar2029763 "message") (clojure.core/assoc :message (desererror-message (clojure.core/get-in letvar2029763 ["message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/protection-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[ a-zA-Z0-9_\\.\\-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/attack-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\\-]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/resource-arn (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 2048)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^arn:aws.*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/log-bucket (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 3 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 63)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^([a-z]|(\d(?!\d{0,2}\.\d{1,3}\.\d{1,3}\.\d{1,3})))([a-z\d]|(\.(?!(\.|-)))|(-(?!\.))){1,61}[a-z\d]$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/email-address (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 150)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^\S+@\S+\.\S+$" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 4096)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"^.*$" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.shield.-2016-06-02/protection-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 36)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\\-]*" s__1410940__auto__))))
