...
(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1947829 input] (clojure.core/let [rawinput1947828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1947830 {"Message" (rawinput1947828 "Message")}] (clojure.core/cond-> {} (letvar1947830 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1947830 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1947832 input] (clojure.core/let [rawinput1947831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1947833 {"Message" (rawinput1947831 "Message")}] (clojure.core/cond-> {} (letvar1947833 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1947833 ["Message"])))))))

(clojure.core/defn- response-describe-dimension-keys-response ([input] (response-describe-dimension-keys-response nil input)) ([resultWrapper1947835 input] (clojure.core/let [rawinput1947834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1947836 {"AlignedStartTime" (rawinput1947834 "AlignedStartTime"), "AlignedEndTime" (rawinput1947834 "AlignedEndTime"), "PartitionKeys" (rawinput1947834 "PartitionKeys"), "Keys" (rawinput1947834 "Keys"), "NextToken" (rawinput1947834 "NextToken")}] (clojure.core/cond-> {} (letvar1947836 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1947836 ["AlignedStartTime"]))) (letvar1947836 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1947836 ["AlignedEndTime"]))) (letvar1947836 "PartitionKeys") (clojure.core/assoc :partition-keys (deser-response-partition-key-list (clojure.core/get-in letvar1947836 ["PartitionKeys"]))) (letvar1947836 "Keys") (clojure.core/assoc :keys (deser-dimension-key-description-list (clojure.core/get-in letvar1947836 ["Keys"]))) (letvar1947836 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1947836 ["NextToken"])))))))

(clojure.core/defn- response-get-resource-metrics-response ([input] (response-get-resource-metrics-response nil input)) ([resultWrapper1947838 input] (clojure.core/let [rawinput1947837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1947839 {"AlignedStartTime" (rawinput1947837 "AlignedStartTime"), "AlignedEndTime" (rawinput1947837 "AlignedEndTime"), "Identifier" (rawinput1947837 "Identifier"), "MetricList" (rawinput1947837 "MetricList"), "NextToken" (rawinput1947837 "NextToken")}] (clojure.core/cond-> {} (letvar1947839 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1947839 ["AlignedStartTime"]))) (letvar1947839 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1947839 ["AlignedEndTime"]))) (letvar1947839 "Identifier") (clojure.core/assoc :identifier (deser-string (clojure.core/get-in letvar1947839 ["Identifier"]))) (letvar1947839 "MetricList") (clojure.core/assoc :metric-list (deser-metric-key-data-points-list (clojure.core/get-in letvar1947839 ["MetricList"]))) (letvar1947839 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1947839 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1947841 input] (clojure.core/let [rawinput1947840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1947842 {"Message" (rawinput1947840 "Message")}] (clojure.core/cond-> {} (letvar1947842 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1947842 ["Message"])))))))
