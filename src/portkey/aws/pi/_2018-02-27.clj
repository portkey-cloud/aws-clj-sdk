...
(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1428202 input] (clojure.core/let [rawinput1428201 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1428203 {"Message" (rawinput1428201 "Message")}] (clojure.core/cond-> {} (letvar1428203 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1428203 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1428205 input] (clojure.core/let [rawinput1428204 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1428206 {"Message" (rawinput1428204 "Message")}] (clojure.core/cond-> {} (letvar1428206 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1428206 ["Message"])))))))

(clojure.core/defn- response-describe-dimension-keys-response ([input] (response-describe-dimension-keys-response nil input)) ([resultWrapper1428208 input] (clojure.core/let [rawinput1428207 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1428209 {"AlignedStartTime" (rawinput1428207 "AlignedStartTime"), "AlignedEndTime" (rawinput1428207 "AlignedEndTime"), "PartitionKeys" (rawinput1428207 "PartitionKeys"), "Keys" (rawinput1428207 "Keys"), "NextToken" (rawinput1428207 "NextToken")}] (clojure.core/cond-> {} (letvar1428209 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1428209 ["AlignedStartTime"]))) (letvar1428209 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1428209 ["AlignedEndTime"]))) (letvar1428209 "PartitionKeys") (clojure.core/assoc :partition-keys (deser-response-partition-key-list (clojure.core/get-in letvar1428209 ["PartitionKeys"]))) (letvar1428209 "Keys") (clojure.core/assoc :keys (deser-dimension-key-description-list (clojure.core/get-in letvar1428209 ["Keys"]))) (letvar1428209 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1428209 ["NextToken"])))))))

(clojure.core/defn- response-get-resource-metrics-response ([input] (response-get-resource-metrics-response nil input)) ([resultWrapper1428211 input] (clojure.core/let [rawinput1428210 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1428212 {"AlignedStartTime" (rawinput1428210 "AlignedStartTime"), "AlignedEndTime" (rawinput1428210 "AlignedEndTime"), "Identifier" (rawinput1428210 "Identifier"), "MetricList" (rawinput1428210 "MetricList"), "NextToken" (rawinput1428210 "NextToken")}] (clojure.core/cond-> {} (letvar1428212 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1428212 ["AlignedStartTime"]))) (letvar1428212 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1428212 ["AlignedEndTime"]))) (letvar1428212 "Identifier") (clojure.core/assoc :identifier (deser-string (clojure.core/get-in letvar1428212 ["Identifier"]))) (letvar1428212 "MetricList") (clojure.core/assoc :metric-list (deser-metric-key-data-points-list (clojure.core/get-in letvar1428212 ["MetricList"]))) (letvar1428212 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1428212 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1428214 input] (clojure.core/let [rawinput1428213 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1428215 {"Message" (rawinput1428213 "Message")}] (clojure.core/cond-> {} (letvar1428215 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1428215 ["Message"])))))))
