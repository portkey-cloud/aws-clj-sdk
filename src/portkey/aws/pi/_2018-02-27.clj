...
(clojure.core/defn- response-internal-service-error ([input] (response-internal-service-error nil input)) ([resultWrapper1936191 input] (clojure.core/let [rawinput1936190 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1936192 {"Message" (rawinput1936190 "Message")}] (clojure.core/cond-> {} (letvar1936192 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1936192 ["Message"])))))))

(clojure.core/defn- response-not-authorized-exception ([input] (response-not-authorized-exception nil input)) ([resultWrapper1936194 input] (clojure.core/let [rawinput1936193 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1936195 {"Message" (rawinput1936193 "Message")}] (clojure.core/cond-> {} (letvar1936195 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1936195 ["Message"])))))))

(clojure.core/defn- response-describe-dimension-keys-response ([input] (response-describe-dimension-keys-response nil input)) ([resultWrapper1936197 input] (clojure.core/let [rawinput1936196 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1936198 {"AlignedStartTime" (rawinput1936196 "AlignedStartTime"), "AlignedEndTime" (rawinput1936196 "AlignedEndTime"), "PartitionKeys" (rawinput1936196 "PartitionKeys"), "Keys" (rawinput1936196 "Keys"), "NextToken" (rawinput1936196 "NextToken")}] (clojure.core/cond-> {} (letvar1936198 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1936198 ["AlignedStartTime"]))) (letvar1936198 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1936198 ["AlignedEndTime"]))) (letvar1936198 "PartitionKeys") (clojure.core/assoc :partition-keys (deser-response-partition-key-list (clojure.core/get-in letvar1936198 ["PartitionKeys"]))) (letvar1936198 "Keys") (clojure.core/assoc :keys (deser-dimension-key-description-list (clojure.core/get-in letvar1936198 ["Keys"]))) (letvar1936198 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1936198 ["NextToken"])))))))

(clojure.core/defn- response-get-resource-metrics-response ([input] (response-get-resource-metrics-response nil input)) ([resultWrapper1936200 input] (clojure.core/let [rawinput1936199 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1936201 {"AlignedStartTime" (rawinput1936199 "AlignedStartTime"), "AlignedEndTime" (rawinput1936199 "AlignedEndTime"), "Identifier" (rawinput1936199 "Identifier"), "MetricList" (rawinput1936199 "MetricList"), "NextToken" (rawinput1936199 "NextToken")}] (clojure.core/cond-> {} (letvar1936201 "AlignedStartTime") (clojure.core/assoc :aligned-start-time (deser-iso-timestamp (clojure.core/get-in letvar1936201 ["AlignedStartTime"]))) (letvar1936201 "AlignedEndTime") (clojure.core/assoc :aligned-end-time (deser-iso-timestamp (clojure.core/get-in letvar1936201 ["AlignedEndTime"]))) (letvar1936201 "Identifier") (clojure.core/assoc :identifier (deser-string (clojure.core/get-in letvar1936201 ["Identifier"]))) (letvar1936201 "MetricList") (clojure.core/assoc :metric-list (deser-metric-key-data-points-list (clojure.core/get-in letvar1936201 ["MetricList"]))) (letvar1936201 "NextToken") (clojure.core/assoc :next-token (deser-string (clojure.core/get-in letvar1936201 ["NextToken"])))))))

(clojure.core/defn- response-invalid-argument-exception ([input] (response-invalid-argument-exception nil input)) ([resultWrapper1936203 input] (clojure.core/let [rawinput1936202 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1936204 {"Message" (rawinput1936202 "Message")}] (clojure.core/cond-> {} (letvar1936204 "Message") (clojure.core/assoc :message (deser-string (clojure.core/get-in letvar1936204 ["Message"])))))))
