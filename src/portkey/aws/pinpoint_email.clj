...
(clojure.core/defn- response-put-configuration-set-delivery-options-response ([input] (response-put-configuration-set-delivery-options-response nil input)) ([resultWrapper423826 input] (clojure.core/let [rawinput423825 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423827 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-dedicated-ip-pools-response ([input] (response-list-dedicated-ip-pools-response nil input)) ([resultWrapper423829 input] (clojure.core/let [rawinput423828 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423830 {"DedicatedIpPools" (rawinput423828 "DedicatedIpPools"), "NextToken" (rawinput423828 "NextToken")}] (clojure.core/cond-> {} (letvar423830 "DedicatedIpPools") (clojure.core/assoc :dedicated-ip-pools (deser-list-of-dedicated-ip-pools (clojure.core/get-in letvar423830 ["DedicatedIpPools"]))) (letvar423830 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar423830 ["NextToken"])))))))

(clojure.core/defn- response-list-deliverability-test-reports-response ([input] (response-list-deliverability-test-reports-response nil input)) ([resultWrapper423832 input] (clojure.core/let [rawinput423831 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423833 {"DeliverabilityTestReports" (rawinput423831 "DeliverabilityTestReports"), "NextToken" (rawinput423831 "NextToken")}] (clojure.core/cond-> {:deliverability-test-reports (deser-deliverability-test-reports (clojure.core/get-in letvar423833 ["DeliverabilityTestReports"]))} (letvar423833 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar423833 ["NextToken"])))))))

(clojure.core/defn- response-delete-dedicated-ip-pool-response ([input] (response-delete-dedicated-ip-pool-response nil input)) ([resultWrapper423835 input] (clojure.core/let [rawinput423834 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423836 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-already-exists-exception ([input] (response-already-exists-exception nil input)) ([resultWrapper423838 input] (clojure.core/let [rawinput423837 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423839 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-reputation-options-response ([input] (response-put-configuration-set-reputation-options-response nil input)) ([resultWrapper423841 input] (clojure.core/let [rawinput423840 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423842 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-bad-request-exception ([input] (response-bad-request-exception nil input)) ([resultWrapper423844 input] (clojure.core/let [rawinput423843 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423845 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-email-identity-response ([input] (response-get-email-identity-response nil input)) ([resultWrapper423847 input] (clojure.core/let [rawinput423846 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423848 {"IdentityType" (rawinput423846 "IdentityType"), "FeedbackForwardingStatus" (rawinput423846 "FeedbackForwardingStatus"), "VerifiedForSendingStatus" (rawinput423846 "VerifiedForSendingStatus"), "DkimAttributes" (rawinput423846 "DkimAttributes"), "MailFromAttributes" (rawinput423846 "MailFromAttributes")}] (clojure.core/cond-> {} (letvar423848 "IdentityType") (clojure.core/assoc :identity-type (deser-identity-type (clojure.core/get-in letvar423848 ["IdentityType"]))) (letvar423848 "FeedbackForwardingStatus") (clojure.core/assoc :feedback-forwarding-status (deser-enabled (clojure.core/get-in letvar423848 ["FeedbackForwardingStatus"]))) (letvar423848 "VerifiedForSendingStatus") (clojure.core/assoc :verified-for-sending-status (deser-enabled (clojure.core/get-in letvar423848 ["VerifiedForSendingStatus"]))) (letvar423848 "DkimAttributes") (clojure.core/assoc :dkim-attributes (deser-dkim-attributes (clojure.core/get-in letvar423848 ["DkimAttributes"]))) (letvar423848 "MailFromAttributes") (clojure.core/assoc :mail-from-attributes (deser-mail-from-attributes (clojure.core/get-in letvar423848 ["MailFromAttributes"])))))))

(clojure.core/defn- response-get-domain-statistics-report-response ([input] (response-get-domain-statistics-report-response nil input)) ([resultWrapper423850 input] (clojure.core/let [rawinput423849 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423851 {"OverallVolume" (rawinput423849 "OverallVolume"), "DailyVolumes" (rawinput423849 "DailyVolumes")}] (clojure.core/cond-> {:overall-volume (deser-overall-volume (clojure.core/get-in letvar423851 ["OverallVolume"])), :daily-volumes (deser-daily-volumes (clojure.core/get-in letvar423851 ["DailyVolumes"]))}))))

(clojure.core/defn- response-mail-from-domain-not-verified-exception ([input] (response-mail-from-domain-not-verified-exception nil input)) ([resultWrapper423853 input] (clojure.core/let [rawinput423852 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423854 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-configuration-set-event-destinations-response ([input] (response-get-configuration-set-event-destinations-response nil input)) ([resultWrapper423856 input] (clojure.core/let [rawinput423855 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423857 {"EventDestinations" (rawinput423855 "EventDestinations")}] (clojure.core/cond-> {} (letvar423857 "EventDestinations") (clojure.core/assoc :event-destinations (deser-event-destinations (clojure.core/get-in letvar423857 ["EventDestinations"])))))))

(clojure.core/defn- response-get-account-response ([input] (response-get-account-response nil input)) ([resultWrapper423859 input] (clojure.core/let [rawinput423858 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423860 {"SendQuota" (rawinput423858 "SendQuota"), "SendingEnabled" (rawinput423858 "SendingEnabled"), "DedicatedIpAutoWarmupEnabled" (rawinput423858 "DedicatedIpAutoWarmupEnabled"), "EnforcementStatus" (rawinput423858 "EnforcementStatus"), "ProductionAccessEnabled" (rawinput423858 "ProductionAccessEnabled")}] (clojure.core/cond-> {} (letvar423860 "SendQuota") (clojure.core/assoc :send-quota (deser-send-quota (clojure.core/get-in letvar423860 ["SendQuota"]))) (letvar423860 "SendingEnabled") (clojure.core/assoc :sending-enabled (deser-enabled (clojure.core/get-in letvar423860 ["SendingEnabled"]))) (letvar423860 "DedicatedIpAutoWarmupEnabled") (clojure.core/assoc :dedicated-ip-auto-warmup-enabled (deser-enabled (clojure.core/get-in letvar423860 ["DedicatedIpAutoWarmupEnabled"]))) (letvar423860 "EnforcementStatus") (clojure.core/assoc :enforcement-status (deser-general-enforcement-status (clojure.core/get-in letvar423860 ["EnforcementStatus"]))) (letvar423860 "ProductionAccessEnabled") (clojure.core/assoc :production-access-enabled (deser-enabled (clojure.core/get-in letvar423860 ["ProductionAccessEnabled"])))))))

(clojure.core/defn- response-put-email-identity-dkim-attributes-response ([input] (response-put-email-identity-dkim-attributes-response nil input)) ([resultWrapper423862 input] (clojure.core/let [rawinput423861 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423863 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-tracking-options-response ([input] (response-put-configuration-set-tracking-options-response nil input)) ([resultWrapper423865 input] (clojure.core/let [rawinput423864 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423866 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-configuration-set-sending-options-response ([input] (response-put-configuration-set-sending-options-response nil input)) ([resultWrapper423868 input] (clojure.core/let [rawinput423867 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423869 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-account-dedicated-ip-warmup-attributes-response ([input] (response-put-account-dedicated-ip-warmup-attributes-response nil input)) ([resultWrapper423871 input] (clojure.core/let [rawinput423870 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423872 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper423874 input] (clojure.core/let [rawinput423873 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423875 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-email-identities-response ([input] (response-list-email-identities-response nil input)) ([resultWrapper423877 input] (clojure.core/let [rawinput423876 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423878 {"EmailIdentities" (rawinput423876 "EmailIdentities"), "NextToken" (rawinput423876 "NextToken")}] (clojure.core/cond-> {} (letvar423878 "EmailIdentities") (clojure.core/assoc :email-identities (deser-identity-info-list (clojure.core/get-in letvar423878 ["EmailIdentities"]))) (letvar423878 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar423878 ["NextToken"])))))))

(clojure.core/defn- response-send-email-response ([input] (response-send-email-response nil input)) ([resultWrapper423880 input] (clojure.core/let [rawinput423879 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423881 {"MessageId" (rawinput423879 "MessageId")}] (clojure.core/cond-> {} (letvar423881 "MessageId") (clojure.core/assoc :message-id (deser-outbound-message-id (clojure.core/get-in letvar423881 ["MessageId"])))))))

(clojure.core/defn- response-list-configuration-sets-response ([input] (response-list-configuration-sets-response nil input)) ([resultWrapper423883 input] (clojure.core/let [rawinput423882 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423884 {"ConfigurationSets" (rawinput423882 "ConfigurationSets"), "NextToken" (rawinput423882 "NextToken")}] (clojure.core/cond-> {} (letvar423884 "ConfigurationSets") (clojure.core/assoc :configuration-sets (deser-configuration-set-name-list (clojure.core/get-in letvar423884 ["ConfigurationSets"]))) (letvar423884 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar423884 ["NextToken"])))))))

(clojure.core/defn- response-create-dedicated-ip-pool-response ([input] (response-create-dedicated-ip-pool-response nil input)) ([resultWrapper423886 input] (clojure.core/let [rawinput423885 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423887 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-response ([input] (response-create-configuration-set-response nil input)) ([resultWrapper423889 input] (clojure.core/let [rawinput423888 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423890 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-too-many-requests-exception ([input] (response-too-many-requests-exception nil input)) ([resultWrapper423892 input] (clojure.core/let [rawinput423891 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423893 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-message-rejected ([input] (response-message-rejected nil input)) ([resultWrapper423895 input] (clojure.core/let [rawinput423894 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423896 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-account-sending-attributes-response ([input] (response-put-account-sending-attributes-response nil input)) ([resultWrapper423898 input] (clojure.core/let [rawinput423897 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423899 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-email-identity-feedback-attributes-response ([input] (response-put-email-identity-feedback-attributes-response nil input)) ([resultWrapper423901 input] (clojure.core/let [rawinput423900 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423902 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-update-configuration-set-event-destination-response ([input] (response-update-configuration-set-event-destination-response nil input)) ([resultWrapper423904 input] (clojure.core/let [rawinput423903 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423905 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-not-found-exception ([input] (response-not-found-exception nil input)) ([resultWrapper423907 input] (clojure.core/let [rawinput423906 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423908 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-dedicated-ip-in-pool-response ([input] (response-put-dedicated-ip-in-pool-response nil input)) ([resultWrapper423910 input] (clojure.core/let [rawinput423909 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423911 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-configuration-set-response ([input] (response-delete-configuration-set-response nil input)) ([resultWrapper423913 input] (clojure.core/let [rawinput423912 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423914 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-dedicated-ip-response ([input] (response-get-dedicated-ip-response nil input)) ([resultWrapper423916 input] (clojure.core/let [rawinput423915 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423917 {"DedicatedIp" (rawinput423915 "DedicatedIp")}] (clojure.core/cond-> {} (letvar423917 "DedicatedIp") (clojure.core/assoc :dedicated-ip (deser-dedicated-ip (clojure.core/get-in letvar423917 ["DedicatedIp"])))))))

(clojure.core/defn- response-create-deliverability-test-report-response ([input] (response-create-deliverability-test-report-response nil input)) ([resultWrapper423919 input] (clojure.core/let [rawinput423918 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423920 {"ReportId" (rawinput423918 "ReportId"), "DeliverabilityTestStatus" (rawinput423918 "DeliverabilityTestStatus")}] (clojure.core/cond-> {:report-id (deser-report-id (clojure.core/get-in letvar423920 ["ReportId"])), :deliverability-test-status (deser-deliverability-test-status (clojure.core/get-in letvar423920 ["DeliverabilityTestStatus"]))}))))

(clojure.core/defn- response-account-suspended-exception ([input] (response-account-suspended-exception nil input)) ([resultWrapper423922 input] (clojure.core/let [rawinput423921 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423923 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-email-identity-response ([input] (response-delete-email-identity-response nil input)) ([resultWrapper423925 input] (clojure.core/let [rawinput423924 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423926 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-delete-configuration-set-event-destination-response ([input] (response-delete-configuration-set-event-destination-response nil input)) ([resultWrapper423928 input] (clojure.core/let [rawinput423927 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423929 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-put-deliverability-dashboard-option-response ([input] (response-put-deliverability-dashboard-option-response nil input)) ([resultWrapper423931 input] (clojure.core/let [rawinput423930 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423932 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-configuration-set-response ([input] (response-get-configuration-set-response nil input)) ([resultWrapper423934 input] (clojure.core/let [rawinput423933 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423935 {"ConfigurationSetName" (rawinput423933 "ConfigurationSetName"), "TrackingOptions" (rawinput423933 "TrackingOptions"), "DeliveryOptions" (rawinput423933 "DeliveryOptions"), "ReputationOptions" (rawinput423933 "ReputationOptions"), "SendingOptions" (rawinput423933 "SendingOptions")}] (clojure.core/cond-> {} (letvar423935 "ConfigurationSetName") (clojure.core/assoc :configuration-set-name (deser-configuration-set-name (clojure.core/get-in letvar423935 ["ConfigurationSetName"]))) (letvar423935 "TrackingOptions") (clojure.core/assoc :tracking-options (deser-tracking-options (clojure.core/get-in letvar423935 ["TrackingOptions"]))) (letvar423935 "DeliveryOptions") (clojure.core/assoc :delivery-options (deser-delivery-options (clojure.core/get-in letvar423935 ["DeliveryOptions"]))) (letvar423935 "ReputationOptions") (clojure.core/assoc :reputation-options (deser-reputation-options (clojure.core/get-in letvar423935 ["ReputationOptions"]))) (letvar423935 "SendingOptions") (clojure.core/assoc :sending-options (deser-sending-options (clojure.core/get-in letvar423935 ["SendingOptions"])))))))

(clojure.core/defn- response-put-dedicated-ip-warmup-attributes-response ([input] (response-put-dedicated-ip-warmup-attributes-response nil input)) ([resultWrapper423937 input] (clojure.core/let [rawinput423936 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423938 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-dedicated-ips-response ([input] (response-get-dedicated-ips-response nil input)) ([resultWrapper423940 input] (clojure.core/let [rawinput423939 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423941 {"DedicatedIps" (rawinput423939 "DedicatedIps"), "NextToken" (rawinput423939 "NextToken")}] (clojure.core/cond-> {} (letvar423941 "DedicatedIps") (clojure.core/assoc :dedicated-ips (deser-dedicated-ip-list (clojure.core/get-in letvar423941 ["DedicatedIps"]))) (letvar423941 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar423941 ["NextToken"])))))))

(clojure.core/defn- response-put-email-identity-mail-from-attributes-response ([input] (response-put-email-identity-mail-from-attributes-response nil input)) ([resultWrapper423943 input] (clojure.core/let [rawinput423942 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423944 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-sending-paused-exception ([input] (response-sending-paused-exception nil input)) ([resultWrapper423946 input] (clojure.core/let [rawinput423945 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423947 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-create-configuration-set-event-destination-response ([input] (response-create-configuration-set-event-destination-response nil input)) ([resultWrapper423949 input] (clojure.core/let [rawinput423948 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423950 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-get-deliverability-test-report-response ([input] (response-get-deliverability-test-report-response nil input)) ([resultWrapper423952 input] (clojure.core/let [rawinput423951 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423953 {"DeliverabilityTestReport" (rawinput423951 "DeliverabilityTestReport"), "OverallPlacement" (rawinput423951 "OverallPlacement"), "IspPlacements" (rawinput423951 "IspPlacements"), "Message" (rawinput423951 "Message")}] (clojure.core/cond-> {:deliverability-test-report (deser-deliverability-test-report (clojure.core/get-in letvar423953 ["DeliverabilityTestReport"])), :overall-placement (deser-placement-statistics (clojure.core/get-in letvar423953 ["OverallPlacement"])), :isp-placements (deser-isp-placements (clojure.core/get-in letvar423953 ["IspPlacements"]))} (letvar423953 "Message") (clojure.core/assoc :message (deser-message-content (clojure.core/get-in letvar423953 ["Message"])))))))

(clojure.core/defn- response-create-email-identity-response ([input] (response-create-email-identity-response nil input)) ([resultWrapper423955 input] (clojure.core/let [rawinput423954 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423956 {"IdentityType" (rawinput423954 "IdentityType"), "VerifiedForSendingStatus" (rawinput423954 "VerifiedForSendingStatus"), "DkimAttributes" (rawinput423954 "DkimAttributes")}] (clojure.core/cond-> {} (letvar423956 "IdentityType") (clojure.core/assoc :identity-type (deser-identity-type (clojure.core/get-in letvar423956 ["IdentityType"]))) (letvar423956 "VerifiedForSendingStatus") (clojure.core/assoc :verified-for-sending-status (deser-enabled (clojure.core/get-in letvar423956 ["VerifiedForSendingStatus"]))) (letvar423956 "DkimAttributes") (clojure.core/assoc :dkim-attributes (deser-dkim-attributes (clojure.core/get-in letvar423956 ["DkimAttributes"])))))))

(clojure.core/defn- response-get-deliverability-dashboard-options-response ([input] (response-get-deliverability-dashboard-options-response nil input)) ([resultWrapper423958 input] (clojure.core/let [rawinput423957 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423959 {"DashboardEnabled" (rawinput423957 "DashboardEnabled")}] (clojure.core/cond-> {:dashboard-enabled (deser-enabled (clojure.core/get-in letvar423959 ["DashboardEnabled"]))}))))

(clojure.core/defn- response-get-blacklist-reports-response ([input] (response-get-blacklist-reports-response nil input)) ([resultWrapper423961 input] (clojure.core/let [rawinput423960 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar423962 {"BlacklistReport" (rawinput423960 "BlacklistReport")}] (clojure.core/cond-> {:blacklist-report (deser-blacklist-report (clojure.core/get-in letvar423962 ["BlacklistReport"]))}))))
