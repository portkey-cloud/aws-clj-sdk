...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper1122331 input] (clojure.core/let [rawinput1122330 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122332 {"UserId" (rawinput1122330 "UserId"), "UserArn" (rawinput1122330 "UserArn")}] (clojure.core/cond-> {} (letvar1122332 "UserId") (clojure.core/assoc :user-id (deser-user-id (clojure.core/get-in letvar1122332 ["UserId"]))) (letvar1122332 "UserArn") (clojure.core/assoc :user-arn (deser-arn (clojure.core/get-in letvar1122332 ["UserArn"])))))))

(clojure.core/defn- response-get-current-metric-data-response ([input] (response-get-current-metric-data-response nil input)) ([resultWrapper1122334 input] (clojure.core/let [rawinput1122333 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122335 {"NextToken" (rawinput1122333 "NextToken"), "MetricResults" (rawinput1122333 "MetricResults"), "DataSnapshotTime" (rawinput1122333 "DataSnapshotTime")}] (clojure.core/cond-> {} (letvar1122335 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122335 ["NextToken"]))) (letvar1122335 "MetricResults") (clojure.core/assoc :metric-results (deser-current-metric-results (clojure.core/get-in letvar1122335 ["MetricResults"]))) (letvar1122335 "DataSnapshotTime") (clojure.core/assoc :data-snapshot-time (desertimestamp (clojure.core/get-in letvar1122335 ["DataSnapshotTime"])))))))

(clojure.core/defn- response-get-metric-data-response ([input] (response-get-metric-data-response nil input)) ([resultWrapper1122337 input] (clojure.core/let [rawinput1122336 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122338 {"NextToken" (rawinput1122336 "NextToken"), "MetricResults" (rawinput1122336 "MetricResults")}] (clojure.core/cond-> {} (letvar1122338 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122338 ["NextToken"]))) (letvar1122338 "MetricResults") (clojure.core/assoc :metric-results (deser-historical-metric-results (clojure.core/get-in letvar1122338 ["MetricResults"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper1122340 input] (clojure.core/let [rawinput1122339 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122341 {"Message" (rawinput1122339 "Message")}] (clojure.core/cond-> {} (letvar1122341 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122341 ["Message"])))))))

(clojure.core/defn- response-update-contact-attributes-response ([input] (response-update-contact-attributes-response nil input)) ([resultWrapper1122343 input] (clojure.core/let [rawinput1122342 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122344 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-hierarchy-structure-response ([input] (response-describe-user-hierarchy-structure-response nil input)) ([resultWrapper1122346 input] (clojure.core/let [rawinput1122345 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122347 {"HierarchyStructure" (rawinput1122345 "HierarchyStructure")}] (clojure.core/cond-> {} (letvar1122347 "HierarchyStructure") (clojure.core/assoc :hierarchy-structure (deser-hierarchy-structure (clojure.core/get-in letvar1122347 ["HierarchyStructure"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1122349 input] (clojure.core/let [rawinput1122348 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122350 {"Message" (rawinput1122348 "Message")}] (clojure.core/cond-> {} (letvar1122350 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122350 ["Message"])))))))

(clojure.core/defn- response-destination-not-allowed-exception ([input] (response-destination-not-allowed-exception nil input)) ([resultWrapper1122352 input] (clojure.core/let [rawinput1122351 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122353 {"Message" (rawinput1122351 "Message")}] (clojure.core/cond-> {} (letvar1122353 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122353 ["Message"])))))))

(clojure.core/defn- response-list-security-profiles-response ([input] (response-list-security-profiles-response nil input)) ([resultWrapper1122355 input] (clojure.core/let [rawinput1122354 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122356 {"SecurityProfileSummaryList" (rawinput1122354 "SecurityProfileSummaryList"), "NextToken" (rawinput1122354 "NextToken")}] (clojure.core/cond-> {} (letvar1122356 "SecurityProfileSummaryList") (clojure.core/assoc :security-profile-summary-list (deser-security-profile-summary-list (clojure.core/get-in letvar1122356 ["SecurityProfileSummaryList"]))) (letvar1122356 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122356 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper1122358 input] (clojure.core/let [rawinput1122357 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122359 {"User" (rawinput1122357 "User")}] (clojure.core/cond-> {} (letvar1122359 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar1122359 ["User"])))))))

(clojure.core/defn- response-outbound-contact-not-permitted-exception ([input] (response-outbound-contact-not-permitted-exception nil input)) ([resultWrapper1122361 input] (clojure.core/let [rawinput1122360 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122362 {"Message" (rawinput1122360 "Message")}] (clojure.core/cond-> {} (letvar1122362 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122362 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper1122364 input] (clojure.core/let [rawinput1122363 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122365 {"Message" (rawinput1122363 "Message")}] (clojure.core/cond-> {} (letvar1122365 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122365 ["Message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper1122367 input] (clojure.core/let [rawinput1122366 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122368 {"Message" (rawinput1122366 "Message")}] (clojure.core/cond-> {} (letvar1122368 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122368 ["Message"])))))))

(clojure.core/defn- response-get-federation-token-response ([input] (response-get-federation-token-response nil input)) ([resultWrapper1122370 input] (clojure.core/let [rawinput1122369 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122371 {"Credentials" (rawinput1122369 "Credentials")}] (clojure.core/cond-> {} (letvar1122371 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar1122371 ["Credentials"])))))))

(clojure.core/defn- response-contact-not-found-exception ([input] (response-contact-not-found-exception nil input)) ([resultWrapper1122373 input] (clojure.core/let [rawinput1122372 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122374 {"Message" (rawinput1122372 "Message")}] (clojure.core/cond-> {} (letvar1122374 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122374 ["Message"])))))))

(clojure.core/defn- response-get-contact-attributes-response ([input] (response-get-contact-attributes-response nil input)) ([resultWrapper1122376 input] (clojure.core/let [rawinput1122375 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122377 {"Attributes" (rawinput1122375 "Attributes")}] (clojure.core/cond-> {} (letvar1122377 "Attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar1122377 ["Attributes"])))))))

(clojure.core/defn- response-list-routing-profiles-response ([input] (response-list-routing-profiles-response nil input)) ([resultWrapper1122379 input] (clojure.core/let [rawinput1122378 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122380 {"RoutingProfileSummaryList" (rawinput1122378 "RoutingProfileSummaryList"), "NextToken" (rawinput1122378 "NextToken")}] (clojure.core/cond-> {} (letvar1122380 "RoutingProfileSummaryList") (clojure.core/assoc :routing-profile-summary-list (deser-routing-profile-summary-list (clojure.core/get-in letvar1122380 ["RoutingProfileSummaryList"]))) (letvar1122380 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122380 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-hierarchy-group-response ([input] (response-describe-user-hierarchy-group-response nil input)) ([resultWrapper1122382 input] (clojure.core/let [rawinput1122381 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122383 {"HierarchyGroup" (rawinput1122381 "HierarchyGroup")}] (clojure.core/cond-> {} (letvar1122383 "HierarchyGroup") (clojure.core/assoc :hierarchy-group (deser-hierarchy-group (clojure.core/get-in letvar1122383 ["HierarchyGroup"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper1122385 input] (clojure.core/let [rawinput1122384 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122386 {"Message" (rawinput1122384 "Message")}] (clojure.core/cond-> {} (letvar1122386 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122386 ["Message"])))))))

(clojure.core/defn- response-stop-contact-response ([input] (response-stop-contact-response nil input)) ([resultWrapper1122388 input] (clojure.core/let [rawinput1122387 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122389 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-hierarchy-groups-response ([input] (response-list-user-hierarchy-groups-response nil input)) ([resultWrapper1122391 input] (clojure.core/let [rawinput1122390 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122392 {"UserHierarchyGroupSummaryList" (rawinput1122390 "UserHierarchyGroupSummaryList"), "NextToken" (rawinput1122390 "NextToken")}] (clojure.core/cond-> {} (letvar1122392 "UserHierarchyGroupSummaryList") (clojure.core/assoc :user-hierarchy-group-summary-list (deser-hierarchy-group-summary-list (clojure.core/get-in letvar1122392 ["UserHierarchyGroupSummaryList"]))) (letvar1122392 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122392 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper1122394 input] (clojure.core/let [rawinput1122393 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122395 {"Message" (rawinput1122393 "Message")}] (clojure.core/cond-> {} (letvar1122395 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122395 ["Message"])))))))

(clojure.core/defn- response-start-outbound-voice-contact-response ([input] (response-start-outbound-voice-contact-response nil input)) ([resultWrapper1122397 input] (clojure.core/let [rawinput1122396 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122398 {"ContactId" (rawinput1122396 "ContactId")}] (clojure.core/cond-> {} (letvar1122398 "ContactId") (clojure.core/assoc :contact-id (deser-contact-id (clojure.core/get-in letvar1122398 ["ContactId"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1122400 input] (clojure.core/let [rawinput1122399 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122401 {"Message" (rawinput1122399 "Message")}] (clojure.core/cond-> {} (letvar1122401 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122401 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper1122403 input] (clojure.core/let [rawinput1122402 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122404 {"UserSummaryList" (rawinput1122402 "UserSummaryList"), "NextToken" (rawinput1122402 "NextToken")}] (clojure.core/cond-> {} (letvar1122404 "UserSummaryList") (clojure.core/assoc :user-summary-list (deser-user-summary-list (clojure.core/get-in letvar1122404 ["UserSummaryList"]))) (letvar1122404 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1122404 ["NextToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper1122406 input] (clojure.core/let [rawinput1122405 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1122407 {"Message" (rawinput1122405 "Message")}] (clojure.core/cond-> {} (letvar1122407 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar1122407 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/contact-flow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\S]{8,64}$/" s__1012854__auto__))))

(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-first-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-last-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/routing-profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/contact-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 0 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012852__auto__] (clojure.core/<= 1 (clojure.core/count s__1012852__auto__))) (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 20)) (clojure.core/fn [s__1012854__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\_\-\.]+" s__1012854__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1012853__auto__] (clojure.core/< (clojure.core/count s__1012853__auto__) 500))))
