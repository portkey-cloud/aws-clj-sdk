...
(clojure.core/defn- response-create-user-response ([input] (response-create-user-response nil input)) ([resultWrapper500863 input] (clojure.core/let [rawinput500862 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500864 {"UserId" (rawinput500862 "UserId"), "UserArn" (rawinput500862 "UserArn")}] (clojure.core/cond-> {} (letvar500864 "UserId") (clojure.core/assoc :user-id (deser-user-id (clojure.core/get-in letvar500864 ["UserId"]))) (letvar500864 "UserArn") (clojure.core/assoc :user-arn (deser-arn (clojure.core/get-in letvar500864 ["UserArn"])))))))

(clojure.core/defn- response-get-current-metric-data-response ([input] (response-get-current-metric-data-response nil input)) ([resultWrapper500866 input] (clojure.core/let [rawinput500865 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500867 {"NextToken" (rawinput500865 "NextToken"), "MetricResults" (rawinput500865 "MetricResults"), "DataSnapshotTime" (rawinput500865 "DataSnapshotTime")}] (clojure.core/cond-> {} (letvar500867 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500867 ["NextToken"]))) (letvar500867 "MetricResults") (clojure.core/assoc :metric-results (deser-current-metric-results (clojure.core/get-in letvar500867 ["MetricResults"]))) (letvar500867 "DataSnapshotTime") (clojure.core/assoc :data-snapshot-time (desertimestamp (clojure.core/get-in letvar500867 ["DataSnapshotTime"])))))))

(clojure.core/defn- response-get-metric-data-response ([input] (response-get-metric-data-response nil input)) ([resultWrapper500869 input] (clojure.core/let [rawinput500868 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500870 {"NextToken" (rawinput500868 "NextToken"), "MetricResults" (rawinput500868 "MetricResults")}] (clojure.core/cond-> {} (letvar500870 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500870 ["NextToken"]))) (letvar500870 "MetricResults") (clojure.core/assoc :metric-results (deser-historical-metric-results (clojure.core/get-in letvar500870 ["MetricResults"])))))))

(clojure.core/defn- response-invalid-request-exception ([input] (response-invalid-request-exception nil input)) ([resultWrapper500872 input] (clojure.core/let [rawinput500871 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500873 {"Message" (rawinput500871 "Message")}] (clojure.core/cond-> {} (letvar500873 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500873 ["Message"])))))))

(clojure.core/defn- response-update-contact-attributes-response ([input] (response-update-contact-attributes-response nil input)) ([resultWrapper500875 input] (clojure.core/let [rawinput500874 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500876 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-user-hierarchy-structure-response ([input] (response-describe-user-hierarchy-structure-response nil input)) ([resultWrapper500878 input] (clojure.core/let [rawinput500877 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500879 {"HierarchyStructure" (rawinput500877 "HierarchyStructure")}] (clojure.core/cond-> {} (letvar500879 "HierarchyStructure") (clojure.core/assoc :hierarchy-structure (deser-hierarchy-structure (clojure.core/get-in letvar500879 ["HierarchyStructure"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper500881 input] (clojure.core/let [rawinput500880 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500882 {"Message" (rawinput500880 "Message")}] (clojure.core/cond-> {} (letvar500882 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500882 ["Message"])))))))

(clojure.core/defn- response-destination-not-allowed-exception ([input] (response-destination-not-allowed-exception nil input)) ([resultWrapper500884 input] (clojure.core/let [rawinput500883 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500885 {"Message" (rawinput500883 "Message")}] (clojure.core/cond-> {} (letvar500885 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500885 ["Message"])))))))

(clojure.core/defn- response-list-security-profiles-response ([input] (response-list-security-profiles-response nil input)) ([resultWrapper500887 input] (clojure.core/let [rawinput500886 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500888 {"SecurityProfileSummaryList" (rawinput500886 "SecurityProfileSummaryList"), "NextToken" (rawinput500886 "NextToken")}] (clojure.core/cond-> {} (letvar500888 "SecurityProfileSummaryList") (clojure.core/assoc :security-profile-summary-list (deser-security-profile-summary-list (clojure.core/get-in letvar500888 ["SecurityProfileSummaryList"]))) (letvar500888 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500888 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-response ([input] (response-describe-user-response nil input)) ([resultWrapper500890 input] (clojure.core/let [rawinput500889 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500891 {"User" (rawinput500889 "User")}] (clojure.core/cond-> {} (letvar500891 "User") (clojure.core/assoc :user (deser-user (clojure.core/get-in letvar500891 ["User"])))))))

(clojure.core/defn- response-outbound-contact-not-permitted-exception ([input] (response-outbound-contact-not-permitted-exception nil input)) ([resultWrapper500893 input] (clojure.core/let [rawinput500892 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500894 {"Message" (rawinput500892 "Message")}] (clojure.core/cond-> {} (letvar500894 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500894 ["Message"])))))))

(clojure.core/defn- response-resource-not-found-exception ([input] (response-resource-not-found-exception nil input)) ([resultWrapper500896 input] (clojure.core/let [rawinput500895 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500897 {"Message" (rawinput500895 "Message")}] (clojure.core/cond-> {} (letvar500897 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500897 ["Message"])))))))

(clojure.core/defn- response-user-not-found-exception ([input] (response-user-not-found-exception nil input)) ([resultWrapper500899 input] (clojure.core/let [rawinput500898 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500900 {"Message" (rawinput500898 "Message")}] (clojure.core/cond-> {} (letvar500900 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500900 ["Message"])))))))

(clojure.core/defn- response-get-federation-token-response ([input] (response-get-federation-token-response nil input)) ([resultWrapper500902 input] (clojure.core/let [rawinput500901 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500903 {"Credentials" (rawinput500901 "Credentials")}] (clojure.core/cond-> {} (letvar500903 "Credentials") (clojure.core/assoc :credentials (deser-credentials (clojure.core/get-in letvar500903 ["Credentials"])))))))

(clojure.core/defn- response-contact-not-found-exception ([input] (response-contact-not-found-exception nil input)) ([resultWrapper500905 input] (clojure.core/let [rawinput500904 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500906 {"Message" (rawinput500904 "Message")}] (clojure.core/cond-> {} (letvar500906 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500906 ["Message"])))))))

(clojure.core/defn- response-get-contact-attributes-response ([input] (response-get-contact-attributes-response nil input)) ([resultWrapper500908 input] (clojure.core/let [rawinput500907 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500909 {"Attributes" (rawinput500907 "Attributes")}] (clojure.core/cond-> {} (letvar500909 "Attributes") (clojure.core/assoc :attributes (deser-attributes (clojure.core/get-in letvar500909 ["Attributes"])))))))

(clojure.core/defn- response-list-routing-profiles-response ([input] (response-list-routing-profiles-response nil input)) ([resultWrapper500911 input] (clojure.core/let [rawinput500910 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500912 {"RoutingProfileSummaryList" (rawinput500910 "RoutingProfileSummaryList"), "NextToken" (rawinput500910 "NextToken")}] (clojure.core/cond-> {} (letvar500912 "RoutingProfileSummaryList") (clojure.core/assoc :routing-profile-summary-list (deser-routing-profile-summary-list (clojure.core/get-in letvar500912 ["RoutingProfileSummaryList"]))) (letvar500912 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500912 ["NextToken"])))))))

(clojure.core/defn- response-describe-user-hierarchy-group-response ([input] (response-describe-user-hierarchy-group-response nil input)) ([resultWrapper500914 input] (clojure.core/let [rawinput500913 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500915 {"HierarchyGroup" (rawinput500913 "HierarchyGroup")}] (clojure.core/cond-> {} (letvar500915 "HierarchyGroup") (clojure.core/assoc :hierarchy-group (deser-hierarchy-group (clojure.core/get-in letvar500915 ["HierarchyGroup"])))))))

(clojure.core/defn- response-throttling-exception ([input] (response-throttling-exception nil input)) ([resultWrapper500917 input] (clojure.core/let [rawinput500916 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500918 {"Message" (rawinput500916 "Message")}] (clojure.core/cond-> {} (letvar500918 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500918 ["Message"])))))))

(clojure.core/defn- response-stop-contact-response ([input] (response-stop-contact-response nil input)) ([resultWrapper500920 input] (clojure.core/let [rawinput500919 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500921 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-list-user-hierarchy-groups-response ([input] (response-list-user-hierarchy-groups-response nil input)) ([resultWrapper500923 input] (clojure.core/let [rawinput500922 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500924 {"UserHierarchyGroupSummaryList" (rawinput500922 "UserHierarchyGroupSummaryList"), "NextToken" (rawinput500922 "NextToken")}] (clojure.core/cond-> {} (letvar500924 "UserHierarchyGroupSummaryList") (clojure.core/assoc :user-hierarchy-group-summary-list (deser-hierarchy-group-summary-list (clojure.core/get-in letvar500924 ["UserHierarchyGroupSummaryList"]))) (letvar500924 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500924 ["NextToken"])))))))

(clojure.core/defn- response-invalid-parameter-exception ([input] (response-invalid-parameter-exception nil input)) ([resultWrapper500926 input] (clojure.core/let [rawinput500925 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500927 {"Message" (rawinput500925 "Message")}] (clojure.core/cond-> {} (letvar500927 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500927 ["Message"])))))))

(clojure.core/defn- response-start-outbound-voice-contact-response ([input] (response-start-outbound-voice-contact-response nil input)) ([resultWrapper500929 input] (clojure.core/let [rawinput500928 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500930 {"ContactId" (rawinput500928 "ContactId")}] (clojure.core/cond-> {} (letvar500930 "ContactId") (clojure.core/assoc :contact-id (deser-contact-id (clojure.core/get-in letvar500930 ["ContactId"])))))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper500932 input] (clojure.core/let [rawinput500931 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500933 {"Message" (rawinput500931 "Message")}] (clojure.core/cond-> {} (letvar500933 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500933 ["Message"])))))))

(clojure.core/defn- response-list-users-response ([input] (response-list-users-response nil input)) ([resultWrapper500935 input] (clojure.core/let [rawinput500934 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500936 {"UserSummaryList" (rawinput500934 "UserSummaryList"), "NextToken" (rawinput500934 "NextToken")}] (clojure.core/cond-> {} (letvar500936 "UserSummaryList") (clojure.core/assoc :user-summary-list (deser-user-summary-list (clojure.core/get-in letvar500936 ["UserSummaryList"]))) (letvar500936 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar500936 ["NextToken"])))))))

(clojure.core/defn- response-duplicate-resource-exception ([input] (response-duplicate-resource-exception nil input)) ([resultWrapper500938 input] (clojure.core/let [rawinput500937 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar500939 {"Message" (rawinput500937 "Message")}] (clojure.core/cond-> {} (letvar500939 "Message") (clojure.core/assoc :message (deser-message (clojure.core/get-in letvar500939 ["Message"])))))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/instance-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/contact-flow-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/password (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\S]{8,64}$/" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-first-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))

(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/attribute-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-last-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/routing-profile-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 100))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/contact-id (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/attribute-value (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 0 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 32767))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/agent-username (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 20)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[a-zA-Z0-9\_\-\.]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.connect.-2017-08-08/client-token (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 500))))
