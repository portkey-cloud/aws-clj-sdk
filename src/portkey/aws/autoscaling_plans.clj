...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1517442 input] (clojure.core/let [rawinput1517441 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517443 {"Message" (rawinput1517441 "Message")}] (clojure.core/cond-> {} (letvar1517443 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517443 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-plan-response ([input] (response-delete-scaling-plan-response nil input)) ([resultWrapper1517445 input] (clojure.core/let [rawinput1517444 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517446 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-plans-response ([input] (response-describe-scaling-plans-response nil input)) ([resultWrapper1517448 input] (clojure.core/let [rawinput1517447 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517449 {"ScalingPlans" (rawinput1517447 "ScalingPlans"), "NextToken" (rawinput1517447 "NextToken")}] (clojure.core/cond-> {} (letvar1517449 "ScalingPlans") (clojure.core/assoc :scaling-plans (deser-scaling-plans (clojure.core/get-in letvar1517449 ["ScalingPlans"]))) (letvar1517449 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1517449 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1517451 input] (clojure.core/let [rawinput1517450 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517452 {"Message" (rawinput1517450 "Message")}] (clojure.core/cond-> {} (letvar1517452 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517452 ["Message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1517454 input] (clojure.core/let [rawinput1517453 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517455 {"Message" (rawinput1517453 "Message")}] (clojure.core/cond-> {} (letvar1517455 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517455 ["Message"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper1517457 input] (clojure.core/let [rawinput1517456 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517458 {"Message" (rawinput1517456 "Message")}] (clojure.core/cond-> {} (letvar1517458 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517458 ["Message"])))))))

(clojure.core/defn- response-describe-scaling-plan-resources-response ([input] (response-describe-scaling-plan-resources-response nil input)) ([resultWrapper1517460 input] (clojure.core/let [rawinput1517459 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517461 {"ScalingPlanResources" (rawinput1517459 "ScalingPlanResources"), "NextToken" (rawinput1517459 "NextToken")}] (clojure.core/cond-> {} (letvar1517461 "ScalingPlanResources") (clojure.core/assoc :scaling-plan-resources (deser-scaling-plan-resources (clojure.core/get-in letvar1517461 ["ScalingPlanResources"]))) (letvar1517461 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1517461 ["NextToken"])))))))

(clojure.core/defn- response-create-scaling-plan-response ([input] (response-create-scaling-plan-response nil input)) ([resultWrapper1517463 input] (clojure.core/let [rawinput1517462 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517464 {"ScalingPlanVersion" (rawinput1517462 "ScalingPlanVersion")}] (clojure.core/cond-> {:scaling-plan-version (deser-scaling-plan-version (clojure.core/get-in letvar1517464 ["ScalingPlanVersion"]))}))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1517466 input] (clojure.core/let [rawinput1517465 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517467 {"Message" (rawinput1517465 "Message")}] (clojure.core/cond-> {} (letvar1517467 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517467 ["Message"])))))))

(clojure.core/defn- response-update-scaling-plan-response ([input] (response-update-scaling-plan-response nil input)) ([resultWrapper1517469 input] (clojure.core/let [rawinput1517468 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517470 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1517472 input] (clojure.core/let [rawinput1517471 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517473 {"Message" (rawinput1517471 "Message")}] (clojure.core/cond-> {} (letvar1517473 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1517473 ["Message"])))))))

(clojure.core/defn- response-get-scaling-plan-resource-forecast-data-response ([input] (response-get-scaling-plan-resource-forecast-data-response nil input)) ([resultWrapper1517475 input] (clojure.core/let [rawinput1517474 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1517476 {"Datapoints" (rawinput1517474 "Datapoints")}] (clojure.core/cond-> {:datapoints (deser-datapoints (clojure.core/get-in letvar1517476 ["Datapoints"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 256)) (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467903__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1467903__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1467901__auto__] (clojure.core/<= 1 (clojure.core/count s__1467901__auto__))) (clojure.core/fn [s__1467902__auto__] (clojure.core/< (clojure.core/count s__1467902__auto__) 1023))))
