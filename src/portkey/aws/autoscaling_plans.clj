...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper132123 input] (clojure.core/let [rawinput132122 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132124 {"Message" (rawinput132122 "Message")}] (clojure.core/cond-> {} (letvar132124 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132124 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-plan-response ([input] (response-delete-scaling-plan-response nil input)) ([resultWrapper132126 input] (clojure.core/let [rawinput132125 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132127 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-plans-response ([input] (response-describe-scaling-plans-response nil input)) ([resultWrapper132129 input] (clojure.core/let [rawinput132128 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132130 {"ScalingPlans" (rawinput132128 "ScalingPlans"), "NextToken" (rawinput132128 "NextToken")}] (clojure.core/cond-> {} (letvar132130 "ScalingPlans") (clojure.core/assoc :scaling-plans (deser-scaling-plans (clojure.core/get-in letvar132130 ["ScalingPlans"]))) (letvar132130 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar132130 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper132132 input] (clojure.core/let [rawinput132131 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132133 {"Message" (rawinput132131 "Message")}] (clojure.core/cond-> {} (letvar132133 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132133 ["Message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper132135 input] (clojure.core/let [rawinput132134 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132136 {"Message" (rawinput132134 "Message")}] (clojure.core/cond-> {} (letvar132136 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132136 ["Message"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper132138 input] (clojure.core/let [rawinput132137 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132139 {"Message" (rawinput132137 "Message")}] (clojure.core/cond-> {} (letvar132139 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132139 ["Message"])))))))

(clojure.core/defn- response-describe-scaling-plan-resources-response ([input] (response-describe-scaling-plan-resources-response nil input)) ([resultWrapper132141 input] (clojure.core/let [rawinput132140 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132142 {"ScalingPlanResources" (rawinput132140 "ScalingPlanResources"), "NextToken" (rawinput132140 "NextToken")}] (clojure.core/cond-> {} (letvar132142 "ScalingPlanResources") (clojure.core/assoc :scaling-plan-resources (deser-scaling-plan-resources (clojure.core/get-in letvar132142 ["ScalingPlanResources"]))) (letvar132142 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar132142 ["NextToken"])))))))

(clojure.core/defn- response-create-scaling-plan-response ([input] (response-create-scaling-plan-response nil input)) ([resultWrapper132144 input] (clojure.core/let [rawinput132143 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132145 {"ScalingPlanVersion" (rawinput132143 "ScalingPlanVersion")}] (clojure.core/cond-> {:scaling-plan-version (deser-scaling-plan-version (clojure.core/get-in letvar132145 ["ScalingPlanVersion"]))}))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper132147 input] (clojure.core/let [rawinput132146 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132148 {"Message" (rawinput132146 "Message")}] (clojure.core/cond-> {} (letvar132148 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132148 ["Message"])))))))

(clojure.core/defn- response-update-scaling-plan-response ([input] (response-update-scaling-plan-response nil input)) ([resultWrapper132150 input] (clojure.core/let [rawinput132149 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132151 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper132153 input] (clojure.core/let [rawinput132152 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132154 {"Message" (rawinput132152 "Message")}] (clojure.core/cond-> {} (letvar132154 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar132154 ["Message"])))))))

(clojure.core/defn- response-get-scaling-plan-resource-forecast-data-response ([input] (response-get-scaling-plan-resource-forecast-data-response nil input)) ([resultWrapper132156 input] (clojure.core/let [rawinput132155 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar132157 {"Datapoints" (rawinput132155 "Datapoints")}] (clojure.core/cond-> {:datapoints (deser-datapoints (clojure.core/get-in letvar132157 ["Datapoints"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string-max-len-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__21078__auto__))))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/scaling-plan-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 128)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\p{Print}&&[^|:/]]+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"\p{Print}+" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 256)) (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21078__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__21078__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__21076__auto__] (clojure.core/<= 1 (clojure.core/count s__21076__auto__))) (clojure.core/fn [s__21077__auto__] (clojure.core/< (clojure.core/count s__21077__auto__) 1023))))
