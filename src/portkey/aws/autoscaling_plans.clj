...
(clojure.core/defn- response-validation-exception ([input] (response-validation-exception nil input)) ([resultWrapper1459624 input] (clojure.core/let [rawinput1459623 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459625 {"Message" (rawinput1459623 "Message")}] (clojure.core/cond-> {} (letvar1459625 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459625 ["Message"])))))))

(clojure.core/defn- response-delete-scaling-plan-response ([input] (response-delete-scaling-plan-response nil input)) ([resultWrapper1459627 input] (clojure.core/let [rawinput1459626 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459628 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-describe-scaling-plans-response ([input] (response-describe-scaling-plans-response nil input)) ([resultWrapper1459630 input] (clojure.core/let [rawinput1459629 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459631 {"ScalingPlans" (rawinput1459629 "ScalingPlans"), "NextToken" (rawinput1459629 "NextToken")}] (clojure.core/cond-> {} (letvar1459631 "ScalingPlans") (clojure.core/assoc :scaling-plans (deser-scaling-plans (clojure.core/get-in letvar1459631 ["ScalingPlans"]))) (letvar1459631 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1459631 ["NextToken"])))))))

(clojure.core/defn- response-limit-exceeded-exception ([input] (response-limit-exceeded-exception nil input)) ([resultWrapper1459633 input] (clojure.core/let [rawinput1459632 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459634 {"Message" (rawinput1459632 "Message")}] (clojure.core/cond-> {} (letvar1459634 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459634 ["Message"])))))))

(clojure.core/defn- response-invalid-next-token-exception ([input] (response-invalid-next-token-exception nil input)) ([resultWrapper1459636 input] (clojure.core/let [rawinput1459635 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459637 {"Message" (rawinput1459635 "Message")}] (clojure.core/cond-> {} (letvar1459637 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459637 ["Message"])))))))

(clojure.core/defn- response-concurrent-update-exception ([input] (response-concurrent-update-exception nil input)) ([resultWrapper1459639 input] (clojure.core/let [rawinput1459638 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459640 {"Message" (rawinput1459638 "Message")}] (clojure.core/cond-> {} (letvar1459640 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459640 ["Message"])))))))

(clojure.core/defn- response-describe-scaling-plan-resources-response ([input] (response-describe-scaling-plan-resources-response nil input)) ([resultWrapper1459642 input] (clojure.core/let [rawinput1459641 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459643 {"ScalingPlanResources" (rawinput1459641 "ScalingPlanResources"), "NextToken" (rawinput1459641 "NextToken")}] (clojure.core/cond-> {} (letvar1459643 "ScalingPlanResources") (clojure.core/assoc :scaling-plan-resources (deser-scaling-plan-resources (clojure.core/get-in letvar1459643 ["ScalingPlanResources"]))) (letvar1459643 "NextToken") (clojure.core/assoc :next-token (deser-next-token (clojure.core/get-in letvar1459643 ["NextToken"])))))))

(clojure.core/defn- response-create-scaling-plan-response ([input] (response-create-scaling-plan-response nil input)) ([resultWrapper1459645 input] (clojure.core/let [rawinput1459644 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459646 {"ScalingPlanVersion" (rawinput1459644 "ScalingPlanVersion")}] (clojure.core/cond-> {:scaling-plan-version (deser-scaling-plan-version (clojure.core/get-in letvar1459646 ["ScalingPlanVersion"]))}))))

(clojure.core/defn- response-object-not-found-exception ([input] (response-object-not-found-exception nil input)) ([resultWrapper1459648 input] (clojure.core/let [rawinput1459647 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459649 {"Message" (rawinput1459647 "Message")}] (clojure.core/cond-> {} (letvar1459649 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459649 ["Message"])))))))

(clojure.core/defn- response-update-scaling-plan-response ([input] (response-update-scaling-plan-response nil input)) ([resultWrapper1459651 input] (clojure.core/let [rawinput1459650 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459652 {}] (clojure.core/cond-> {}))))

(clojure.core/defn- response-internal-service-exception ([input] (response-internal-service-exception nil input)) ([resultWrapper1459654 input] (clojure.core/let [rawinput1459653 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459655 {"Message" (rawinput1459653 "Message")}] (clojure.core/cond-> {} (letvar1459655 "Message") (clojure.core/assoc :message (deser-error-message (clojure.core/get-in letvar1459655 ["Message"])))))))

(clojure.core/defn- response-get-scaling-plan-resource-forecast-data-response ([input] (response-get-scaling-plan-resource-forecast-data-response nil input)) ([resultWrapper1459657 input] (clojure.core/let [rawinput1459656 (clojure.core/some-> input :body portkey.aws/parse-json-body) letvar1459658 {"Datapoints" (rawinput1459656 "Datapoints")}] (clojure.core/cond-> {:datapoints (deser-datapoints (clojure.core/get-in letvar1459658 ["Datapoints"]))}))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.customized-load-metric-specification/namespace (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/metric-namespace))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.customized-load-metric-specification/dimensions (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/metric-dimensions))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.customized-load-metric-specification/statistic (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/metric-statistic))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.customized-load-metric-specification/unit (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/metric-unit))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/customized-load-metric-specification (clojure.spec.alpha/keys :req-un [:portkey.aws.autoscaling-plans/metric-name :portkey.aws.autoscaling-plans.customized-load-metric-specification/namespace :portkey.aws.autoscaling-plans.customized-load-metric-specification/statistic] :opt-un [:portkey.aws.autoscaling-plans.customized-load-metric-specification/dimensions :portkey.aws.autoscaling-plans.customized-load-metric-specification/unit]))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string-max-len-128 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/scaling-plan-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 128)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\p{Print}&&[^|:/]]+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/load-metric-type #{:asg-total-network-in "ASGTotalCPUUtilization" "ASGTotalNetworkOut" "ASGTotalNetworkIn" :asg-total-network-out :asg-total-cpu-utilization :alb-target-group-request-count "ALBTargetGroupRequestCount"})
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/policy-name (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"\p{Print}+" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string-max-len-256 (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 256)) (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.datapoint/timestamp (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/timestamp-type))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.datapoint/value (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/metric-scale))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/datapoint (clojure.spec.alpha/keys :req-un [] :opt-un [:portkey.aws.autoscaling-plans.datapoint/timestamp :portkey.aws.autoscaling-plans.datapoint/value]))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/scheduled-action-buffer-time (clojure.spec.alpha/int-in 0 Long/MAX_VALUE))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/disable-dynamic-scaling clojure.core/boolean?)

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/xml-string (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410940__auto__] (clojure.core/re-matches #"[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*" s__1410940__auto__))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/resource-label (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__1410938__auto__] (clojure.core/<= 1 (clojure.core/count s__1410938__auto__))) (clojure.core/fn [s__1410939__auto__] (clojure.core/< (clojure.core/count s__1410939__auto__) 1023))))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.predefined-load-metric-specification/predefined-load-metric-type (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/load-metric-type))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/predefined-load-metric-specification (clojure.spec.alpha/keys :req-un [:portkey.aws.autoscaling-plans.predefined-load-metric-specification/predefined-load-metric-type] :opt-un [:portkey.aws.autoscaling-plans/resource-label]))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/scaling-policy-update-behavior #{"KeepExternalPolicies" :keep-external-policies "ReplaceExternalPolicies" :replace-external-policies})
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/datapoints (clojure.spec.alpha/coll-of :portkey.aws.autoscaling-plans/datapoint))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/resource-id (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/xml-string))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/start-time (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/timestamp-type))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/end-time (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/timestamp-type))
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-request (clojure.spec.alpha/keys :req-un [:portkey.aws.autoscaling-plans/scaling-plan-name :portkey.aws.autoscaling-plans/scaling-plan-version :portkey.aws.autoscaling-plans/service-namespace :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/resource-id :portkey.aws.autoscaling-plans/scalable-dimension :portkey.aws.autoscaling-plans/forecast-data-type :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/start-time :portkey.aws.autoscaling-plans.get-scaling-plan-resource-forecast-data-request/end-time] :opt-un []))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/predictive-scaling-mode #{"ForecastOnly" "ForecastAndScale" :forecast-and-scale :forecast-only})
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans.scaling-instruction/predictive-scaling-max-capacity-buffer (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/resource-capacity))
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/scaling-instruction (clojure.spec.alpha/keys :req-un [:portkey.aws.autoscaling-plans/service-namespace :portkey.aws.autoscaling-plans.scaling-instruction/resource-id :portkey.aws.autoscaling-plans/scalable-dimension :portkey.aws.autoscaling-plans.scaling-instruction/min-capacity :portkey.aws.autoscaling-plans.scaling-instruction/max-capacity :portkey.aws.autoscaling-plans/target-tracking-configurations] :opt-un [:portkey.aws.autoscaling-plans/customized-load-metric-specification :portkey.aws.autoscaling-plans/predictive-scaling-max-capacity-behavior :portkey.aws.autoscaling-plans/scheduled-action-buffer-time :portkey.aws.autoscaling-plans.scaling-instruction/predictive-scaling-max-capacity-buffer :portkey.aws.autoscaling-plans/disable-dynamic-scaling :portkey.aws.autoscaling-plans/predefined-load-metric-specification :portkey.aws.autoscaling-plans/scaling-policy-update-behavior :portkey.aws.autoscaling-plans/predictive-scaling-mode]))

(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/forecast-data-type #{:scheduled-action-min-capacity "ScheduledActionMinCapacity" :capacity-forecast "ScheduledActionMaxCapacity" "LoadForecast" "CapacityForecast" :scheduled-action-max-capacity :load-forecast})
...
(clojure.spec.alpha/def :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-response (clojure.spec.alpha/keys :req-un [:portkey.aws.autoscaling-plans/datapoints] :opt-un []))
...
(clojure.core/defn get-scaling-plan-resource-forecast-data "Retrieves the forecast data for a scalable resource.\n Capacity forecasts are represented as predicted values, or data points, that\nare calculated using historical data points from a specified CloudWatch load\nmetric. Data points are available for up to 56 days." ([get-scaling-plan-resource-forecast-data-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-get-scaling-plan-resource-forecast-data-request get-scaling-plan-resource-forecast-data-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.autoscaling-plans/endpoints, :http.request.configuration/target-prefix "AnyScaleScalingPlannerFrontendService", :http.request.spec/output-spec :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-01-06", :http.request.configuration/service-id "Auto Scaling Plans", :http.request.spec/input-spec :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "GetScalingPlanResourceForecastData", :http.request.configuration/output-deser-fn response-get-scaling-plan-resource-forecast-data-response, :http.request.spec/error-spec {"ValidationException" :portkey.aws.autoscaling-plans/validation-exception, "InternalServiceException" :portkey.aws.autoscaling-plans/internal-service-exception}})))))
(clojure.spec.alpha/fdef get-scaling-plan-resource-forecast-data :args (clojure.spec.alpha/tuple :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-request) :ret (clojure.spec.alpha/and :portkey.aws.autoscaling-plans/get-scaling-plan-resource-forecast-data-response))

(clojure.core/defn update-scaling-plan "Updates the specified scaling plan.\n You cannot update a scaling plan if it is in the process of being created,\nupdated, or deleted." ([update-scaling-plan-requestinput] (clojure.core/let [request-function-result__1411981__auto__ (req-update-scaling-plan-request update-scaling-plan-requestinput)] (portkey.aws/-call-http (clojure.core/into request-function-result__1411981__auto__ {:http.request.configuration/endpoints portkey.aws.autoscaling-plans/endpoints, :http.request.configuration/target-prefix "AnyScaleScalingPlannerFrontendService", :http.request.spec/output-spec :portkey.aws.autoscaling-plans/update-scaling-plan-response, :http.request.configuration/mime-type {"content-type" "application/x-amz-json-1.1"}, :http.request.configuration/request-uri "/", :http.request.configuration/version "2018-01-06", :http.request.configuration/service-id "Auto Scaling Plans", :http.request.spec/input-spec :portkey.aws.autoscaling-plans/update-scaling-plan-request, :http.request.configuration/protocol "json", :http.request.configuration/method :post, :http.request.configuration/response-code nil, :http.request.configuration/result-wrapper nil, :http.request.configuration/action "UpdateScalingPlan", :http.request.configuration/output-deser-fn response-update-scaling-plan-response, :http.request.spec/error-spec {"ValidationException" :portkey.aws.autoscaling-plans/validation-exception, "ConcurrentUpdateException" :portkey.aws.autoscaling-plans/concurrent-update-exception, "InternalServiceException" :portkey.aws.autoscaling-plans/internal-service-exception, "ObjectNotFoundException" :portkey.aws.autoscaling-plans/object-not-found-exception}})))))
