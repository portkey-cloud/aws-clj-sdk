...
(clojure.spec.alpha/def :portkey.aws.s3.-2006-03-01/object-key (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27035__auto__] (clojure.core/<= 1 (clojure.core/count s__27035__auto__)))))
...
(clojure.spec.alpha/def :portkey.aws.s3.-2006-03-01/copy-source (clojure.spec.alpha/and clojure.core/string? (clojure.core/fn [s__27037__auto__] (clojure.core/re-matches #"\/.+\/.+" s__27037__auto__))))
